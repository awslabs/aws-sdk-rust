...
impl ListGatewayRoutes {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_gateway_routes::ListGatewayRoutesInput,
                    ) -> ::std::result::Result<crate::operation::list_gateway_routes::ListGatewayRoutesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_gateway_routes::ListGatewayRoutesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_gateway_routes::ListGatewayRoutesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_gateway_routes::ListGatewayRoutesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListGatewayRoutes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListGatewayRoutes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListGatewayRoutesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListGatewayRoutesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListGatewayRoutes")
...
.with_interceptor(ListGatewayRoutesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_gateway_routes::ListGatewayRoutesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_gateway_routes::ListGatewayRoutesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_gateway_routes::ListGatewayRoutesError>::new());
...
#[derive(Debug)]
            struct ListGatewayRoutesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGatewayRoutesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_gateway_routes::de_list_gateway_routes_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListGatewayRoutesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGatewayRoutesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_gateway_routes::ListGatewayRoutesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_gateway_routes::ListGatewayRoutesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::list_gateway_routes::ListGatewayRoutesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_5) = &_input.mesh_owner {
         {
            query.push_kv("meshOwner", &::aws_smithy_http::query::fmt_string(inner_5));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ListGatewayRoutesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListGatewayRoutesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListGatewayRoutesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListGatewayRoutesInput>()
                        .ok_or("failed to downcast to ListGatewayRoutesInput")?;
...
pub enum ListGatewayRoutesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListGatewayRoutesError) for what information is available for the error.")]
...
impl ListGatewayRoutesError {
    /// Creates the `ListGatewayRoutesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListGatewayRoutesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListGatewayRoutesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_gateway_routes::ListGatewayRoutesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_gateway_routes::_list_gateway_routes_output::ListGatewayRoutesOutput;

pub use crate::operation::list_gateway_routes::_list_gateway_routes_input::ListGatewayRoutesInput;

mod _list_gateway_routes_input;

mod _list_gateway_routes_output;
