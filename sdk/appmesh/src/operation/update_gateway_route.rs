...
impl UpdateGatewayRouteInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGatewayRoute`](crate::operation::update_gateway_route::UpdateGatewayRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_gateway_route::UpdateGatewayRoute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_gateway_route::UpdateGatewayRouteInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("gateway_route_name", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::update_gateway_route::UpdateGatewayRouteInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGatewayRoute {
                type Output = std::result::Result<crate::operation::update_gateway_route::UpdateGatewayRouteOutput, crate::operation::update_gateway_route::UpdateGatewayRouteError>;
