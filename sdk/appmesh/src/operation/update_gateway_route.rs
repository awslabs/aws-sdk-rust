...
impl UpdateGatewayRoute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_gateway_route::UpdateGatewayRouteError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_gateway_route::UpdateGatewayRouteOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("App Mesh", "UpdateGatewayRoute", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "App Mesh.UpdateGatewayRoute",
                "rpc.service" = "App Mesh",
                "rpc.method" = "UpdateGatewayRoute",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateGatewayRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateGatewayRouteRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateGatewayRouteResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateGatewayRoute")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateGatewayRoute")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateGatewayRouteTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateGatewayRouteTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateGatewayRouteTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateGatewayRouteInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateGatewayRouteResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_gateway_route::de_update_gateway_route_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_gateway_route::de_update_gateway_route_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateGatewayRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_gateway_route::UpdateGatewayRouteInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field("gateway_route_name", "cannot be empty or unset")
                })?;
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_gateway_route::ser_update_gateway_route_input(&input)?);
