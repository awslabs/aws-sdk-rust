...
impl DescribeMeshFluentBuilder  {
    /// Creates a new `DescribeMesh`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_mesh::DescribeMeshOutput, aws_smithy_http::result::SdkError<crate::operation::describe_mesh::DescribeMeshError>>
                     {
