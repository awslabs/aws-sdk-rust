...
/// Orchestration and serialization glue logic for `UpdateVirtualGateway`.
...
impl UpdateVirtualGateway {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput,
                    ) -> ::std::result::Result<crate::operation::update_virtual_gateway::UpdateVirtualGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_virtual_gateway::UpdateVirtualGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_virtual_gateway::UpdateVirtualGatewayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_virtual_gateway::UpdateVirtualGatewayOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateVirtualGateway {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateVirtualGateway");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateVirtualGatewayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateVirtualGatewayResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateVirtualGateway")
...
.with_interceptor(UpdateVirtualGatewayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_virtual_gateway::UpdateVirtualGatewayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_virtual_gateway::UpdateVirtualGatewayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_virtual_gateway::UpdateVirtualGatewayError>::new());
...
#[derive(Debug)]
            struct UpdateVirtualGatewayResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateVirtualGatewayResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_virtual_gateway::de_update_virtual_gateway_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_virtual_gateway::de_update_virtual_gateway_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateVirtualGatewayRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateVirtualGatewayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("virtual_gateway_name", "cannot be empty or unset"))?;
    ...
    if virtual_gateway_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("virtual_gateway_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v20190125/meshes/{meshName}/virtualGateways/{virtualGatewayName}", meshName = mesh_name, virtualGatewayName = virtual_gateway_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_virtual_gateway::ser_update_virtual_gateway_input(&input)?);
...
#[derive(Debug)]
            struct UpdateVirtualGatewayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateVirtualGatewayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateVirtualGatewayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateVirtualGatewayInput>()
                        .ok_or("failed to downcast to UpdateVirtualGatewayInput")?;
...
pub enum UpdateVirtualGatewayError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateVirtualGatewayError) for what information is available for the error.")]
...
impl UpdateVirtualGatewayError {
    /// Creates the `UpdateVirtualGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateVirtualGatewayError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateVirtualGatewayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_virtual_gateway::UpdateVirtualGatewayError {
...
mod _update_virtual_gateway_output;
