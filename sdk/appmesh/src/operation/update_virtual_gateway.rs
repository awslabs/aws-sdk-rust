...
impl UpdateVirtualGatewayInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVirtualGateway`](crate::operation::update_virtual_gateway::UpdateVirtualGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_virtual_gateway::UpdateVirtualGateway, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_virtual_gateway::ser_update_virtual_gateway_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_virtual_gateway::UpdateVirtualGateway::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVirtualGateway {
                type Output = std::result::Result<crate::operation::update_virtual_gateway::UpdateVirtualGatewayOutput, crate::operation::update_virtual_gateway::UpdateVirtualGatewayError>;
