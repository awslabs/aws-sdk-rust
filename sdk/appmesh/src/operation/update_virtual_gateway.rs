...
impl UpdateVirtualGatewayInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_virtual_gateway::ser_update_virtual_gateway_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_virtual_gateway::UpdateVirtualGateway::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_virtual_gateway::UpdateVirtualGatewayError
{
