...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_virtual_service::DescribeVirtualServiceOutput,
                    crate::operation::describe_virtual_service::DescribeVirtualServiceError,
                > for DescribeVirtualServiceFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeVirtualServiceFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::describe_virtual_service::builders::DescribeVirtualServiceInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_virtual_service::DescribeVirtualServiceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_virtual_service::DescribeVirtualServiceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_virtual_service::DescribeVirtualService::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_virtual_service::DescribeVirtualService::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_virtual_service::DescribeVirtualServiceOutput, crate::operation::describe_virtual_service::DescribeVirtualServiceError, Self> {
