...
/// Flattened paginator for `ListTagsForResourcePaginator`
                ...
                impl  ListTagsForResourcePaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::TagRef, aws_smithy_http::result::SdkError<crate::operation::list_tags_for_resource::ListTagsForResourceError>>> + Unpin
                     {
