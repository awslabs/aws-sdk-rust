...
impl UpdateMeshInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_mesh::UpdateMesh, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_mesh::ser_update_mesh_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMesh {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_mesh::de_update_mesh_http_response_with_props(status, headers, body)
        }
    }
}
