...
impl UpdateMeshInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMesh`](crate::operation::update_mesh::UpdateMesh)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_mesh::UpdateMesh, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_mesh::UpdateMeshInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_mesh::ser_update_mesh_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_mesh::UpdateMesh::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMesh {
                type Output = std::result::Result<crate::operation::update_mesh::UpdateMeshOutput, crate::operation::update_mesh::UpdateMeshError>;
