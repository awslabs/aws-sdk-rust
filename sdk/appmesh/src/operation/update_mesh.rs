    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v20190125/meshes/{meshName}", meshName = mesh_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_mesh::UpdateMesh::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMesh {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_mesh::de_update_mesh_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_mesh::de_update_mesh_http_response_with_props(
                status, headers, body,
            )
        }
    }
