...
impl DeleteVirtualServiceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVirtualService`](crate::operation::delete_virtual_service::DeleteVirtualService)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_virtual_service::DeleteVirtualService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_virtual_service::DeleteVirtualServiceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_virtual_service::DeleteVirtualServiceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_virtual_service::DeleteVirtualService::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVirtualService {
                type Output = std::result::Result<crate::operation::delete_virtual_service::DeleteVirtualServiceOutput, crate::operation::delete_virtual_service::DeleteVirtualServiceError>;
