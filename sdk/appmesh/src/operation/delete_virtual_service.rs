...
/// Orchestration and serialization glue logic for `DeleteVirtualService`.
...
impl DeleteVirtualService {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_virtual_service::DeleteVirtualServiceInput,
                    ) -> ::std::result::Result<crate::operation::delete_virtual_service::DeleteVirtualServiceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_virtual_service::DeleteVirtualServiceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_virtual_service::DeleteVirtualServiceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_virtual_service::DeleteVirtualServiceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVirtualService {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVirtualService");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVirtualServiceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVirtualServiceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVirtualService")
...
.with_interceptor(DeleteVirtualServiceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_virtual_service::DeleteVirtualServiceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_virtual_service::DeleteVirtualServiceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_virtual_service::DeleteVirtualServiceError>::new());
...
#[derive(Debug)]
            struct DeleteVirtualServiceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVirtualServiceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_virtual_service::de_delete_virtual_service_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteVirtualServiceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVirtualServiceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_virtual_service::DeleteVirtualServiceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_virtual_service::DeleteVirtualServiceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::delete_virtual_service::DeleteVirtualServiceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteVirtualServiceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVirtualServiceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteVirtualServiceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVirtualServiceInput>()
                        .ok_or("failed to downcast to DeleteVirtualServiceInput")?;
...
pub enum DeleteVirtualServiceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVirtualServiceError) for what information is available for the error.")]
...
impl DeleteVirtualServiceError {
    /// Creates the `DeleteVirtualServiceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVirtualServiceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVirtualServiceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_virtual_service::DeleteVirtualServiceError {
...
mod _delete_virtual_service_output;
