...
impl DescribeVirtualRouterInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVirtualRouter`](crate::operation::describe_virtual_router::DescribeVirtualRouter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_virtual_router::DescribeVirtualRouter, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_virtual_router::DescribeVirtualRouterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_virtual_router::DescribeVirtualRouterInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_router::DescribeVirtualRouter::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeVirtualRouter {
                type Output = std::result::Result<crate::operation::describe_virtual_router::DescribeVirtualRouterOutput, crate::operation::describe_virtual_router::DescribeVirtualRouterError>;
