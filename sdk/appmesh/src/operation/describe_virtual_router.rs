...
impl DescribeVirtualRouterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_virtual_router::DescribeVirtualRouter,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVirtualRouter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_virtual_router::de_describe_virtual_router_http_response_with_props(status, headers, body)
        }
    }
}
