...
impl CreateGatewayRouteInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_gateway_route::ser_create_gateway_route_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_gateway_route::CreateGatewayRoute::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_gateway_route::CreateGatewayRouteError
{
