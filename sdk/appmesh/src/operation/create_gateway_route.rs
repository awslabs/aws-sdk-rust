...
impl CreateGatewayRouteInput {
    /// Consumes the builder and constructs an Operation<[`CreateGatewayRoute`](crate::operation::create_gateway_route::CreateGatewayRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_gateway_route::CreateGatewayRoute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_gateway_route::CreateGatewayRouteInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_gateway_route::CreateGatewayRouteInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_gateway_route::ser_create_gateway_route_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_gateway_route::CreateGatewayRoute::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGatewayRoute {
                type Output = std::result::Result<crate::operation::create_gateway_route::CreateGatewayRouteOutput, crate::operation::create_gateway_route::CreateGatewayRouteError>;
