...
impl ListRoutesFluentBuilder  {
    /// Creates a new `ListRoutes`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_routes::ListRoutesOutput, aws_smithy_http::result::SdkError<crate::operation::list_routes::ListRoutesError>>
                     {
    ...
    /// Create a paginator for this request
                        ///
                        /// Paginators are used by calling [`send().await`](crate::operation::list_routes::paginator::ListRoutesPaginator::send) which returns a `Stream`.
