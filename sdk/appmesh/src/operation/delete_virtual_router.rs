...
impl DeleteVirtualRouterInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVirtualRouter`](crate::operation::delete_virtual_router::DeleteVirtualRouter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_virtual_router::DeleteVirtualRouter, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_virtual_router::DeleteVirtualRouterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_virtual_router::DeleteVirtualRouterInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_virtual_router::DeleteVirtualRouter::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVirtualRouter {
                type Output = std::result::Result<crate::operation::delete_virtual_router::DeleteVirtualRouterOutput, crate::operation::delete_virtual_router::DeleteVirtualRouterError>;
