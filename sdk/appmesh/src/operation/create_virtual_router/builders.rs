...
impl CreateVirtualRouterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_virtual_router::CreateVirtualRouterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_virtual_router::CreateVirtualRouterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_virtual_router::CreateVirtualRouterOutput, crate::operation::create_virtual_router::CreateVirtualRouterError, Self> {
