...
impl CreateVirtualServiceInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_virtual_service::CreateVirtualService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_virtual_service::CreateVirtualServiceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_virtual_service::CreateVirtualServiceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
