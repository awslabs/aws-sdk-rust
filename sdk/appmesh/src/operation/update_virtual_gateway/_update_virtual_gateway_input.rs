...
impl UpdateVirtualGatewayInputBuilder {
    ...
    /// - [`virtual_gateway_name`](crate::operation::update_virtual_gateway::builders::UpdateVirtualGatewayInputBuilder::virtual_gateway_name)
    /// - [`mesh_name`](crate::operation::update_virtual_gateway::builders::UpdateVirtualGatewayInputBuilder::mesh_name)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::update_virtual_gateway::UpdateVirtualGatewayInput {
            virtual_gateway_name: self.virtual_gateway_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    ...
                    "virtual_gateway_name was not specified but it is required when building UpdateVirtualGatewayInput",
                )
            })?,
            mesh_name: self.mesh_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "mesh_name",
                    "mesh_name was not specified but it is required when building UpdateVirtualGatewayInput",
                )
            })?,
            spec: self.spec,
