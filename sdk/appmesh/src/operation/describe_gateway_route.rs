...
/// Orchestration and serialization glue logic for `DescribeGatewayRoute`.
...
impl DescribeGatewayRoute {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_gateway_route::DescribeGatewayRouteInput,
                    ) -> ::std::result::Result<crate::operation::describe_gateway_route::DescribeGatewayRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_gateway_route::DescribeGatewayRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_gateway_route::DescribeGatewayRouteError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_gateway_route::DescribeGatewayRouteOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeGatewayRoute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeGatewayRoute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeGatewayRouteRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeGatewayRouteResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeGatewayRoute")
...
.with_interceptor(DescribeGatewayRouteEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_gateway_route::DescribeGatewayRouteError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_gateway_route::DescribeGatewayRouteError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_gateway_route::DescribeGatewayRouteError>::new());
...
#[derive(Debug)]
            struct DescribeGatewayRouteResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGatewayRouteResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_gateway_route::de_describe_gateway_route_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_gateway_route::de_describe_gateway_route_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeGatewayRouteRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeGatewayRouteRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_gateway_route::DescribeGatewayRouteInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_gateway_route::DescribeGatewayRouteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::describe_gateway_route::DescribeGatewayRouteInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeGatewayRouteEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeGatewayRouteEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeGatewayRouteEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeGatewayRouteInput>()
                        .ok_or("failed to downcast to DescribeGatewayRouteInput")?;
...
pub enum DescribeGatewayRouteError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeGatewayRouteError) for what information is available for the error.")]
...
impl DescribeGatewayRouteError {
    /// Creates the `DescribeGatewayRouteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeGatewayRouteError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeGatewayRouteError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_gateway_route::DescribeGatewayRouteError {
...
mod _describe_gateway_route_output;
