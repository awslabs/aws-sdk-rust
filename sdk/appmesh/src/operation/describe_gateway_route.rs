...
impl DescribeGatewayRouteInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGatewayRoute`](crate::operation::describe_gateway_route::DescribeGatewayRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_gateway_route::DescribeGatewayRoute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_gateway_route::DescribeGatewayRouteInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_gateway_route::DescribeGatewayRouteInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_gateway_route::DescribeGatewayRoute::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGatewayRoute {
                type Output = std::result::Result<crate::operation::describe_gateway_route::DescribeGatewayRouteOutput, crate::operation::describe_gateway_route::DescribeGatewayRouteError>;
