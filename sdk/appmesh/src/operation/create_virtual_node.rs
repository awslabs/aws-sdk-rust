...
impl CreateVirtualNodeInput {
    /// Consumes the builder and constructs an Operation<[`CreateVirtualNode`](crate::operation::create_virtual_node::CreateVirtualNode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_virtual_node::CreateVirtualNode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_virtual_node::CreateVirtualNodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_virtual_node::CreateVirtualNodeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_virtual_node::ser_create_virtual_node_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_virtual_node::CreateVirtualNode::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVirtualNode {
                type Output = std::result::Result<crate::operation::create_virtual_node::CreateVirtualNodeOutput, crate::operation::create_virtual_node::CreateVirtualNodeError>;
