...
impl CreateVirtualNodeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_virtual_node::ser_create_virtual_node_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVirtualNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_virtual_node::de_create_virtual_node_http_response_with_props(status, headers, body)
        }
    }
}
