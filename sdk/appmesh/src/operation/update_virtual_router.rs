...
impl UpdateVirtualRouterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_virtual_router::ser_update_virtual_router_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_virtual_router::UpdateVirtualRouter::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVirtualRouter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_virtual_router::de_update_virtual_router_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_virtual_router::UpdateVirtualRouterError
{
