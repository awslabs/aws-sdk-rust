...
impl CreateRouteInput {
    /// Consumes the builder and constructs an Operation<[`CreateRoute`](crate::operation::create_route::CreateRoute)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_route::CreateRoute, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_route::ser_create_route_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_route::CreateRoute::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRoute {
    type Output = ::std::result::Result<crate::operation::create_route::CreateRouteOutput, crate::operation::create_route::CreateRouteError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_route::de_create_route_http_response_with_props(status, headers, body)
        }
    }
}
