...
pub use crate::operation::update_virtual_service::_update_virtual_service_output::UpdateVirtualServiceOutputBuilder;
...
pub struct UpdateVirtualServiceFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::update_virtual_service::builders::UpdateVirtualServiceInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_virtual_service::UpdateVirtualServiceOutput,
                    crate::operation::update_virtual_service::UpdateVirtualServiceError,
                > for UpdateVirtualServiceFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateVirtualServiceFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::update_virtual_service::builders::UpdateVirtualServiceInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_virtual_service::UpdateVirtualServiceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_virtual_service::UpdateVirtualServiceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_virtual_service::UpdateVirtualService::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_virtual_service::UpdateVirtualService::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_virtual_service::UpdateVirtualServiceOutput, crate::operation::update_virtual_service::UpdateVirtualServiceError, Self> {
