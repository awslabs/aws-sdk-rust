...
impl CreateVirtualRouterInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_virtual_router::ser_create_virtual_router_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_virtual_router::CreateVirtualRouter::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVirtualRouter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_virtual_router::de_create_virtual_router_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_virtual_router::CreateVirtualRouterError
{
