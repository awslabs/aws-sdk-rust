...
impl CreateVirtualRouterInput {
    /// Consumes the builder and constructs an Operation<[`CreateVirtualRouter`](crate::operation::create_virtual_router::CreateVirtualRouter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_virtual_router::CreateVirtualRouter, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_virtual_router::CreateVirtualRouterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_virtual_router::CreateVirtualRouterInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.mesh_owner {
                     {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_virtual_router::ser_create_virtual_router_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_virtual_router::CreateVirtualRouter::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVirtualRouter {
                type Output = std::result::Result<crate::operation::create_virtual_router::CreateVirtualRouterOutput, crate::operation::create_virtual_router::CreateVirtualRouterError>;
