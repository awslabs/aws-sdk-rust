...
impl CreateVirtualGatewayInputBuilder {
    ...
    /// - [`virtual_gateway_name`](crate::operation::create_virtual_gateway::builders::CreateVirtualGatewayInputBuilder::virtual_gateway_name)
    /// - [`mesh_name`](crate::operation::create_virtual_gateway::builders::CreateVirtualGatewayInputBuilder::mesh_name)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::create_virtual_gateway::CreateVirtualGatewayInput {
            virtual_gateway_name: self.virtual_gateway_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    ...
                    "virtual_gateway_name was not specified but it is required when building CreateVirtualGatewayInput",
                )
            })?,
            mesh_name: self.mesh_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "mesh_name",
                    "mesh_name was not specified but it is required when building CreateVirtualGatewayInput",
                )
            })?,
            spec: self.spec,
            tags: self.tags,
