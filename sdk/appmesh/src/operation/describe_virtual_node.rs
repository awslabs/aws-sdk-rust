...
impl DescribeVirtualNodeInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVirtualNode`](crate::operation::describe_virtual_node::DescribeVirtualNode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_virtual_node::DescribeVirtualNode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_virtual_node::DescribeVirtualNodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_virtual_node::DescribeVirtualNodeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_node::DescribeVirtualNode::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeVirtualNode {
                type Output = std::result::Result<crate::operation::describe_virtual_node::DescribeVirtualNodeOutput, crate::operation::describe_virtual_node::DescribeVirtualNodeError>;
