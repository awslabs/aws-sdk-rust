...
impl ListVirtualNodesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_virtual_nodes::ListVirtualNodes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVirtualNodes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_virtual_nodes::de_list_virtual_nodes_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_virtual_nodes::ListVirtualNodesError
{
