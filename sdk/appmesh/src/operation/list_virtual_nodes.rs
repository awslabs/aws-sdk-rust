...
/// Orchestration and serialization glue logic for `ListVirtualNodes`.
...
impl ListVirtualNodes {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_virtual_nodes::ListVirtualNodesInput,
                    ) -> ::std::result::Result<crate::operation::list_virtual_nodes::ListVirtualNodesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_virtual_nodes::ListVirtualNodesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_virtual_nodes::ListVirtualNodesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_virtual_nodes::ListVirtualNodesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVirtualNodes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVirtualNodes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVirtualNodesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVirtualNodesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVirtualNodes")
...
.with_interceptor(ListVirtualNodesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_virtual_nodes::ListVirtualNodesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_virtual_nodes::ListVirtualNodesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_virtual_nodes::ListVirtualNodesError>::new());
...
#[derive(Debug)]
            struct ListVirtualNodesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVirtualNodesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_virtual_nodes::de_list_virtual_nodes_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_virtual_nodes::de_list_virtual_nodes_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListVirtualNodesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVirtualNodesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_virtual_nodes::ListVirtualNodesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_virtual_nodes::ListVirtualNodesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v20190125/meshes/{meshName}/virtualNodes", meshName = mesh_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_virtual_nodes::ListVirtualNodesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListVirtualNodesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVirtualNodesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListVirtualNodesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVirtualNodesInput>()
                        .ok_or("failed to downcast to ListVirtualNodesInput")?;
...
pub enum ListVirtualNodesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVirtualNodesError) for what information is available for the error.")]
...
impl ListVirtualNodesError {
    /// Creates the `ListVirtualNodesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVirtualNodesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVirtualNodesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_virtual_nodes::ListVirtualNodesError {
...
mod _list_virtual_nodes_output;
