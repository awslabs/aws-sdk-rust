...
impl DescribeRouteInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRoute`](crate::operation::describe_route::DescribeRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_route::DescribeRoute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_route::DescribeRouteInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("route_name", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::describe_route::DescribeRouteInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_4) = &_input.mesh_owner {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_route::DescribeRoute::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRoute {
                type Output = std::result::Result<crate::operation::describe_route::DescribeRouteOutput, crate::operation::describe_route::DescribeRouteError>;
