...
impl DescribeRouteInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_route::DescribeRoute,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_route::DescribeRoute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRoute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_route::de_describe_route_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_route::de_describe_route_http_response_with_props(
                status, headers, body,
            )
        }
    }
