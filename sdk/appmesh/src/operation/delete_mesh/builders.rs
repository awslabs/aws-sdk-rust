...
impl DeleteMeshFluentBuilder  {
    /// Creates a new `DeleteMesh`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_mesh::DeleteMeshOutput, aws_smithy_http::result::SdkError<crate::operation::delete_mesh::DeleteMeshError>>
                     {
