...
impl CreateVirtualGateway {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_virtual_gateway::CreateVirtualGatewayInput,
                    ) -> ::std::result::Result<crate::operation::create_virtual_gateway::CreateVirtualGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_virtual_gateway::CreateVirtualGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_virtual_gateway::CreateVirtualGatewayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_virtual_gateway::CreateVirtualGatewayOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_virtual_gateway::CreateVirtualGatewayInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateVirtualGateway {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateVirtualGateway");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateVirtualGatewayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateVirtualGatewayResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateVirtualGateway")
...
.with_interceptor(CreateVirtualGatewayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_virtual_gateway::CreateVirtualGatewayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_virtual_gateway::CreateVirtualGatewayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_virtual_gateway::CreateVirtualGatewayError>::new());
...
#[derive(Debug)]
            struct CreateVirtualGatewayResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateVirtualGatewayResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_virtual_gateway::de_create_virtual_gateway_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_virtual_gateway::de_create_virtual_gateway_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateVirtualGatewayRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateVirtualGatewayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_virtual_gateway::CreateVirtualGatewayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_virtual_gateway::CreateVirtualGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v20190125/meshes/{meshName}/virtualGateways", meshName = mesh_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::create_virtual_gateway::CreateVirtualGatewayInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_virtual_gateway::ser_create_virtual_gateway_input(&input)?);
...
#[derive(Debug)]
            struct CreateVirtualGatewayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateVirtualGatewayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateVirtualGatewayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateVirtualGatewayInput>()
                        .ok_or("failed to downcast to CreateVirtualGatewayInput")?;
...
pub enum CreateVirtualGatewayError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateVirtualGatewayError) for what information is available for the error.")]
...
impl CreateVirtualGatewayError {
    /// Creates the `CreateVirtualGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVirtualGatewayError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateVirtualGatewayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_virtual_gateway::CreateVirtualGatewayError {
...
mod _create_virtual_gateway_output;
