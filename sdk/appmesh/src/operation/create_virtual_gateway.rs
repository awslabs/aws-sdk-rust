...
impl CreateVirtualGatewayInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_virtual_gateway::ser_create_virtual_gateway_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_virtual_gateway::CreateVirtualGateway::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_virtual_gateway::CreateVirtualGatewayError
{
