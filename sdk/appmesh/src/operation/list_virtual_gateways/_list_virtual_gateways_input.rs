...
impl ListVirtualGatewaysInputBuilder {
    ...
    /// - [`mesh_name`](crate::operation::list_virtual_gateways::builders::ListVirtualGatewaysInputBuilder::mesh_name)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_virtual_gateways::ListVirtualGatewaysInput {
            mesh_name: self.mesh_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "mesh_name",
                    "mesh_name was not specified but it is required when building ListVirtualGatewaysInput",
                )
            })?,
