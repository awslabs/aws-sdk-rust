...
impl ListVirtualGatewaysFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_virtual_gateways::ListVirtualGatewaysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_virtual_gateways::ListVirtualGatewaysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_virtual_gateways::ListVirtualGatewaysOutput, crate::operation::list_virtual_gateways::ListVirtualGatewaysError, Self> {
