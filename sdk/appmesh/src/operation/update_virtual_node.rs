...
impl UpdateVirtualNodeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_virtual_node::UpdateVirtualNode::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVirtualNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_virtual_node::de_update_virtual_node_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_virtual_node::UpdateVirtualNodeError
{
