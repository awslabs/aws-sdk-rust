...
impl UpdateVirtualNodeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVirtualNode`](crate::operation::update_virtual_node::UpdateVirtualNode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_virtual_node::UpdateVirtualNode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_virtual_node::UpdateVirtualNodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("virtual_node_name", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::update_virtual_node::UpdateVirtualNodeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_virtual_node::ser_update_virtual_node_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_virtual_node::UpdateVirtualNode::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVirtualNode {
                type Output = std::result::Result<crate::operation::update_virtual_node::UpdateVirtualNodeOutput, crate::operation::update_virtual_node::UpdateVirtualNodeError>;
