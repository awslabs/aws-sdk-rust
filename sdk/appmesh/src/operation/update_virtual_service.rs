...
impl UpdateVirtualServiceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_virtual_service::ser_update_virtual_service_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_virtual_service::UpdateVirtualService::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_virtual_service::UpdateVirtualServiceError
{
