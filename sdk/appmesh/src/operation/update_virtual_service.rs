...
impl UpdateVirtualServiceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_virtual_service::UpdateVirtualService,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVirtualService {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_virtual_service::de_update_virtual_service_http_response_with_props(status, headers, body)
        }
    }
}
