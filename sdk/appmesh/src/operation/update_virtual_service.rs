...
/// Orchestration and serialization glue logic for `UpdateVirtualService`.
...
impl UpdateVirtualService {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_virtual_service::UpdateVirtualServiceInput,
                    ) -> ::std::result::Result<crate::operation::update_virtual_service::UpdateVirtualServiceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_virtual_service::UpdateVirtualServiceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_virtual_service::UpdateVirtualServiceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_virtual_service::UpdateVirtualServiceOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_virtual_service::UpdateVirtualServiceInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateVirtualService {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateVirtualService");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateVirtualServiceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateVirtualServiceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateVirtualService")
...
.with_interceptor(UpdateVirtualServiceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_virtual_service::UpdateVirtualServiceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_virtual_service::UpdateVirtualServiceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_virtual_service::UpdateVirtualServiceError>::new());
...
#[derive(Debug)]
            struct UpdateVirtualServiceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateVirtualServiceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_virtual_service::de_update_virtual_service_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_virtual_service::de_update_virtual_service_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateVirtualServiceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateVirtualServiceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_virtual_service::UpdateVirtualServiceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_virtual_service::UpdateVirtualServiceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.mesh_name;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("mesh_name", "cannot be empty or unset"))?;
    let mesh_name = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if mesh_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("mesh_name", "cannot be empty or unset"))
                }
    let input_2 = &_input.virtual_service_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("virtual_service_name", "cannot be empty or unset"))?;
    let virtual_service_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if virtual_service_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("virtual_service_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v20190125/meshes/{meshName}/virtualServices/{virtualServiceName}", meshName = mesh_name, virtualServiceName = virtual_service_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::update_virtual_service::UpdateVirtualServiceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_3) = &_input.mesh_owner {
         {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_virtual_service::ser_update_virtual_service_input(&input)?);
...
#[derive(Debug)]
            struct UpdateVirtualServiceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateVirtualServiceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateVirtualServiceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateVirtualServiceInput>()
                        .ok_or("failed to downcast to UpdateVirtualServiceInput")?;
...
pub enum UpdateVirtualServiceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateVirtualServiceError) for what information is available for the error.")]
...
impl UpdateVirtualServiceError {
    /// Creates the `UpdateVirtualServiceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateVirtualServiceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateVirtualServiceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_virtual_service::UpdateVirtualServiceError {
...
mod _update_virtual_service_output;
