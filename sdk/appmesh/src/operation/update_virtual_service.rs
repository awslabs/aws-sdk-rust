...
impl UpdateVirtualServiceInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVirtualService`](crate::operation::update_virtual_service::UpdateVirtualService)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_virtual_service::UpdateVirtualService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_virtual_service::UpdateVirtualServiceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("virtual_service_name", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::update_virtual_service::UpdateVirtualServiceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_virtual_service::ser_update_virtual_service_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_virtual_service::UpdateVirtualService::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVirtualService {
                type Output = std::result::Result<crate::operation::update_virtual_service::UpdateVirtualServiceOutput, crate::operation::update_virtual_service::UpdateVirtualServiceError>;
