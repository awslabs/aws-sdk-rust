...
impl Builder {
    ...
    /// use aws_sdk_appmesh::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_appmesh::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
