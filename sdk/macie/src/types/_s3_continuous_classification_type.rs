...
impl ::std::convert::From<&str> for S3ContinuousClassificationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => S3ContinuousClassificationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for S3ContinuousClassificationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(S3ContinuousClassificationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for S3ContinuousClassificationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
