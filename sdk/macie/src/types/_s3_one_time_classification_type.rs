...
impl ::std::convert::From<&str> for S3OneTimeClassificationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => S3OneTimeClassificationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for S3OneTimeClassificationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(S3OneTimeClassificationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for S3OneTimeClassificationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
