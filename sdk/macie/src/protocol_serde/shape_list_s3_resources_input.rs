...
pub fn ser_list_s3_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListS3ResourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
