...
pub fn ser_s3_resource_classification_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3ResourceClassificationUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
