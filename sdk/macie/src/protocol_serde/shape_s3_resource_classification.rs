...
pub fn ser_s3_resource_classification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3ResourceClassification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_s3_resource_classification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::S3ResourceClassification>, aws_smithy_json::deserialize::error::DeserializeError>
