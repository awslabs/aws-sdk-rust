...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_member_accounts::builders::ListMemberAccountsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_member_accounts::builders::ListMemberAccountsFluentBuilder::set_next_token): <p>(Discontinued) Use this parameter when paginating results. Set the value of this parameter to null on your first call to the <code>ListMemberAccounts</code> action. Subsequent calls to the action fill <code>nextToken</code> in the request with the value of <code>nextToken</code> from the previous response to continue listing data.</p>
