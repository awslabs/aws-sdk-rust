...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_member_accounts::builders::ListMemberAccountsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_member_accounts::builders::ListMemberAccountsFluentBuilder::set_next_token):<br>required: **false**<br><p>(Discontinued) Use this parameter when paginating results. Set the value of this parameter to null on your first call to the <code>ListMemberAccounts</code> action. Subsequent calls to the action fill <code>nextToken</code> in the request with the value of <code>nextToken</code> from the previous response to continue listing data.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_member_accounts::builders::ListMemberAccountsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_member_accounts::builders::ListMemberAccountsFluentBuilder::set_max_results):<br>required: **false**<br><p>(Discontinued) Use this parameter to indicate the maximum number of items that you want in the response. The default value is 250.</p><br>
