...
pub fn serialize_structure_associate_member_account_input(
...
pub fn serialize_structure_associate_s3_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_5 in var_3 {
            {
                ...
                crate::json_ser::serialize_structure_s3_resource_classification(
                    &mut object_6,
                    item_5,
                );
                object_6.finish();
...
pub fn serialize_structure_disassociate_member_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_s3_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_11 in var_9 {
            {
                ...
                crate::json_ser::serialize_structure_s3_resource(&mut object_12, item_11);
                object_12.finish();
            }
        }
        array_10.finish();
...
pub fn serialize_structure_list_s3_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_s3_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_21 in var_19 {
            {
                ...
                crate::json_ser::serialize_structure_s3_resource_classification_update(
                    &mut object_22,
                    item_21,
                );
                object_22.finish();
...
pub fn serialize_structure_s3_resource_classification(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_25) = &input.classification_type {
        ...
        crate::json_ser::serialize_structure_classification_type(&mut object_26, var_25);
        object_26.finish();
    }
}
...
pub fn serialize_structure_s3_resource_classification_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_31) = &input.classification_type_update {
        ...
        crate::json_ser::serialize_structure_classification_type_update(&mut object_32, var_31);
        object_32.finish();
    }
}

pub fn serialize_structure_classification_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_classification_type_update(
    object: &mut smithy_json::serialize::JsonObjectWriter,
