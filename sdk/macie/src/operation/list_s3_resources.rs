...
impl ListS3ResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_s3_resources::ListS3Resources, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_s3_resources::ser_list_s3_resources_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListS3Resources {
    type Output =
        ::std::result::Result<crate::operation::list_s3_resources::ListS3ResourcesOutput, crate::operation::list_s3_resources::ListS3ResourcesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_s3_resources::de_list_s3_resources_http_response_with_props(status, headers, body)
        }
    }
}
