...
/// Orchestration and serialization glue logic for `ListS3Resources`.
...
impl ListS3Resources {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_s3_resources::ListS3ResourcesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_s3_resources::ListS3ResourcesOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("macie", "ListS3Resources", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListS3Resources {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListS3Resources");
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListS3Resources", "macie"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListS3Resources")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListS3ResourcesEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
#[derive(Debug)]
struct ListS3ResourcesResponseDeserializer;
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListS3ResourcesResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_list_s3_resources::de_list_s3_resources_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_list_s3_resources::de_list_s3_resources_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ListS3ResourcesRequestSerializer;
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListS3ResourcesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_s3_resources::ListS3ResourcesInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_s3_resources::ListS3ResourcesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_s3_resources::ser_list_s3_resources_input(&input)?);
...
#[derive(Debug)]
struct ListS3ResourcesEndpointParamsInterceptor;

impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListS3ResourcesEndpointParamsInterceptor {
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListS3ResourcesInput>()
            .ok_or("failed to downcast to ListS3ResourcesInput")?;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_s3_resources::ListS3ResourcesError {
...
pub use crate::operation::list_s3_resources::_list_s3_resources_output::ListS3ResourcesOutput;

pub use crate::operation::list_s3_resources::_list_s3_resources_input::ListS3ResourcesInput;

mod _list_s3_resources_input;

mod _list_s3_resources_output;
