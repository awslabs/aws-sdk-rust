...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_s3_resources::ListS3ResourcesOutput,
        crate::operation::list_s3_resources::ListS3ResourcesError,
    > for ListS3ResourcesFluentBuilder
{
    fn send(
        self,
...
impl ListS3ResourcesFluentBuilder {
    ...
    > {
        ...
        crate::operation::list_s3_resources::ListS3Resources::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_s3_resources::paginator::ListS3ResourcesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
