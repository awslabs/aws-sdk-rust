...
pub struct FailedS3Resource  {
    ...
    #[doc(hidden)]pub failed_item: std::option::Option<crate::model::S3Resource>,
...
pub struct S3ResourceClassificationUpdate  {
    ...
    #[doc(hidden)]pub classification_type_update: std::option::Option<crate::model::ClassificationTypeUpdate>,
}
...
impl  std::fmt::Debug for S3ResourceClassificationUpdate  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("bucket_name", &self.bucket_name);
        formatter.field("prefix", &self.prefix);
        formatter.field("classification_type_update", &self.classification_type_update);
        formatter.finish()
    }
}
...
pub struct ClassificationTypeUpdate  {
    ...
    #[doc(hidden)]pub one_time: std::option::Option<crate::model::S3OneTimeClassificationType>,
    ...
    #[doc(hidden)]pub continuous: std::option::Option<crate::model::S3ContinuousClassificationType>,
}
...
pub struct S3ResourceClassification  {
    ...
    #[doc(hidden)]pub classification_type: std::option::Option<crate::model::ClassificationType>,
}
