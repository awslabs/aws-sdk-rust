    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/sdk-media-concatenation-pipelines")
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMediaConcatenationPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_media_concatenation_pipeline::de_create_media_concatenation_pipeline_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateMediaConcatenationPipelineError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_media_concatenation_pipeline::CreateMediaConcatenationPipelineError
{
