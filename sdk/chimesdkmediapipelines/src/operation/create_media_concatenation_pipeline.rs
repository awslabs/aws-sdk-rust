...
impl CreateMediaConcatenationPipeline {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_media_concatenation_pipeline::CreateMediaConcatenationPipelineOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateMediaConcatenationPipelineResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateMediaConcatenationPipelineRequestSerializer {
