...
impl CreateMediaConcatenationPipelineInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_media_concatenation_pipeline::CreateMediaConcatenationPipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMediaConcatenationPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_media_concatenation_pipeline::de_create_media_concatenation_pipeline_http_response_with_props(
                status, headers, body,
            )
        }
    }
