...
#[non_exhaustive]
pub struct GetMediaInsightsPipelineConfiguration;
impl GetMediaInsightsPipelineConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMediaInsightsPipelineConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMediaInsightsPipelineConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMediaInsightsPipelineConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMediaInsightsPipelineConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMediaInsightsPipelineConfiguration")
...
.with_interceptor(GetMediaInsightsPipelineConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_media_insights_pipeline_configuration::de_get_media_insights_pipeline_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_media_insights_pipeline_configuration::de_get_media_insights_pipeline_configuration_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMediaInsightsPipelineConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/media-insights-pipeline-configurations/{Identifier}", Identifier = identifier).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMediaInsightsPipelineConfigurationEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMediaInsightsPipelineConfigurationInput>()
                        .ok_or("failed to downcast to GetMediaInsightsPipelineConfigurationInput")?;
...
/// Error type for the `GetMediaInsightsPipelineConfigurationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetMediaInsightsPipelineConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMediaInsightsPipelineConfigurationError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetMediaInsightsPipelineConfigurationError {
    /// Creates the `GetMediaInsightsPipelineConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMediaInsightsPipelineConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(self, Self::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::ThrottledClientException`.
    pub fn is_throttled_client_exception(&self) -> bool {
        matches!(self, Self::ThrottledClientException(_))
    }
    /// Returns `true` if the error kind is `GetMediaInsightsPipelineConfigurationError::UnauthorizedClientException`.
    pub fn is_unauthorized_client_exception(&self) -> bool {
        matches!(self, Self::UnauthorizedClientException(_))
    }
}
impl ::std::error::Error for GetMediaInsightsPipelineConfigurationError {
...
impl ::std::fmt::Display for GetMediaInsightsPipelineConfigurationError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetMediaInsightsPipelineConfigurationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetMediaInsightsPipelineConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMediaInsightsPipelineConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError {
...
mod _get_media_insights_pipeline_configuration_output;
