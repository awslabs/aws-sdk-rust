...
impl CreateMediaCapturePipeline {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Media Pipelines.CreateMediaCapturePipeline",
            "rpc.service" = "Chime SDK Media Pipelines",
            "rpc.method" = "CreateMediaCapturePipeline",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMediaCapturePipeline {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateMediaCapturePipelineRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateMediaCapturePipelineResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateMediaCapturePipeline")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMediaCapturePipelineResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_media_capture_pipeline::de_create_media_capture_pipeline_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_media_capture_pipeline::de_create_media_capture_pipeline_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMediaCapturePipelineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_media_capture_pipeline::ser_create_media_capture_pipeline_input(&input)?,
        );
