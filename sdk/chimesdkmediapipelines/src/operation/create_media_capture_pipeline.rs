    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/sdk-media-capture-pipelines")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_media_capture_pipeline::CreateMediaCapturePipeline::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineError
{
