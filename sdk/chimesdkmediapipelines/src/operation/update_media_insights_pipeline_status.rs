...
impl UpdateMediaInsightsPipelineStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_media_insights_pipeline_status::UpdateMediaInsightsPipelineStatus,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_media_insights_pipeline_status::UpdateMediaInsightsPipelineStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMediaInsightsPipelineStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_media_insights_pipeline_status::de_update_media_insights_pipeline_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
