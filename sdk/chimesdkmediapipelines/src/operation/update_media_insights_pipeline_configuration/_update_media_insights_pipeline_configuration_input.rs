...
impl UpdateMediaInsightsPipelineConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_media_insights_pipeline_configuration::UpdateMediaInsightsPipelineConfigurationInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
