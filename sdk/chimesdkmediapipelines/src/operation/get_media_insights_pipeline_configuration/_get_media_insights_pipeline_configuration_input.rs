...
impl GetMediaInsightsPipelineConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
