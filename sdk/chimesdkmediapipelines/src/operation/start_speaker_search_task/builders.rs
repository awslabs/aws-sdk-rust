...
impl StartSpeakerSearchTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskOutput, crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError, Self> {
