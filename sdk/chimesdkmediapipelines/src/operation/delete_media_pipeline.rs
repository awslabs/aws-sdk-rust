...
impl DeleteMediaPipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_media_pipeline::DeleteMediaPipeline,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_media_pipeline::DeleteMediaPipeline::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("DeleteMediaPipeline", "chimesdkmediapipelines"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMediaPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_media_pipeline::de_delete_media_pipeline_http_response_with_props(status, headers, body)
        }
    }
}
