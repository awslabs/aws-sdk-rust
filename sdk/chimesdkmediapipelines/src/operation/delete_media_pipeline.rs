...
/// Orchestration and serialization glue logic for `DeleteMediaPipeline`.
...
impl DeleteMediaPipeline {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_media_pipeline::DeleteMediaPipelineInput,
                    ) -> ::std::result::Result<crate::operation::delete_media_pipeline::DeleteMediaPipelineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_media_pipeline::DeleteMediaPipelineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_media_pipeline::DeleteMediaPipelineError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_media_pipeline::DeleteMediaPipelineOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteMediaPipeline {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteMediaPipeline");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteMediaPipelineRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteMediaPipelineResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteMediaPipeline")
...
.with_interceptor(DeleteMediaPipelineEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_media_pipeline::DeleteMediaPipelineError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_media_pipeline::DeleteMediaPipelineError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_media_pipeline::DeleteMediaPipelineError>::new());
...
#[derive(Debug)]
            struct DeleteMediaPipelineResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMediaPipelineResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_media_pipeline::de_delete_media_pipeline_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_media_pipeline::de_delete_media_pipeline_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteMediaPipelineRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMediaPipelineRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_media_pipeline::DeleteMediaPipelineInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_media_pipeline::DeleteMediaPipelineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/sdk-media-pipelines/{MediaPipelineId}", MediaPipelineId = media_pipeline_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteMediaPipelineEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteMediaPipelineEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteMediaPipelineEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteMediaPipelineInput>()
                        .ok_or("failed to downcast to DeleteMediaPipelineInput")?;
...
pub enum DeleteMediaPipelineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteMediaPipelineError) for what information is available for the error.")]
...
impl DeleteMediaPipelineError {
    /// Creates the `DeleteMediaPipelineError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteMediaPipelineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteMediaPipelineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_media_pipeline::DeleteMediaPipelineError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_media_pipeline::_delete_media_pipeline_output::DeleteMediaPipelineOutput;

pub use crate::operation::delete_media_pipeline::_delete_media_pipeline_input::DeleteMediaPipelineInput;

mod _delete_media_pipeline_input;

mod _delete_media_pipeline_output;
