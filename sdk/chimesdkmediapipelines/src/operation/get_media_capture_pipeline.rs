...
/// Orchestration and serialization glue logic for `GetMediaCapturePipeline`.
...
impl GetMediaCapturePipeline {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineInput,
                    ) -> ::std::result::Result<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMediaCapturePipeline {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMediaCapturePipeline");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMediaCapturePipelineRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMediaCapturePipelineResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMediaCapturePipeline")
...
.with_interceptor(GetMediaCapturePipelineEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError>::new());
...
#[derive(Debug)]
            struct GetMediaCapturePipelineResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMediaCapturePipelineResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_media_capture_pipeline::de_get_media_capture_pipeline_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_media_capture_pipeline::de_get_media_capture_pipeline_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetMediaCapturePipelineRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMediaCapturePipelineRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.media_pipeline_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("media_pipeline_id", "cannot be empty or unset"))?;
    ...
    if media_pipeline_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("media_pipeline_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/sdk-media-capture-pipelines/{MediaPipelineId}", MediaPipelineId = media_pipeline_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetMediaCapturePipelineEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMediaCapturePipelineEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetMediaCapturePipelineEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMediaCapturePipelineInput>()
                        .ok_or("failed to downcast to GetMediaCapturePipelineInput")?;
...
pub enum GetMediaCapturePipelineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMediaCapturePipelineError) for what information is available for the error.")]
...
impl GetMediaCapturePipelineError {
    /// Creates the `GetMediaCapturePipelineError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMediaCapturePipelineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMediaCapturePipelineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError {
...
mod _get_media_capture_pipeline_output;
