...
impl GetMediaCapturePipeline {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Media Pipelines.GetMediaCapturePipeline",
            "rpc.service" = "Chime SDK Media Pipelines",
            "rpc.method" = "GetMediaCapturePipeline",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMediaCapturePipeline {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetMediaCapturePipelineRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetMediaCapturePipelineResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetMediaCapturePipeline")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMediaCapturePipeline")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetMediaCapturePipelineTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetMediaCapturePipelineTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMediaCapturePipelineTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetMediaCapturePipelineInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("MediaPipelineId") {
            if let ::std::option::Option::Some(value) = input.media_pipeline_id.as_deref() {
                captured.insert("MediaPipelineId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMediaCapturePipelineResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_media_capture_pipeline::de_get_media_capture_pipeline_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_media_capture_pipeline::de_get_media_capture_pipeline_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMediaCapturePipelineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.media_pipeline_id;
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field("media_pipeline_id", "cannot be empty or unset")
                })?;
