...
impl ListMediaPipelinesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_media_pipelines::ListMediaPipelines::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListMediaPipelines", "chimesdkmediapipelines"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMediaPipelines {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_media_pipelines::de_list_media_pipelines_http_response_with_props(status, headers, body)
        }
    }
}
