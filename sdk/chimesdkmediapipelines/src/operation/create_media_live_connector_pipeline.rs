...
impl CreateMediaLiveConnectorPipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipeline,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMediaLiveConnectorPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_media_live_connector_pipeline::de_create_media_live_connector_pipeline_http_response_with_props(
                status, headers, body,
            )
        }
    }
