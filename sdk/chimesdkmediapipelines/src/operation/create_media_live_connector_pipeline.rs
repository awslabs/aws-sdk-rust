...
impl CreateMediaLiveConnectorPipeline {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Media Pipelines.CreateMediaLiveConnectorPipeline",
            "rpc.service" = "Chime SDK Media Pipelines",
            "rpc.method" = "CreateMediaLiveConnectorPipeline",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMediaLiveConnectorPipeline {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateMediaLiveConnectorPipelineRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateMediaLiveConnectorPipelineResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateMediaLiveConnectorPipeline")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMediaLiveConnectorPipelineResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_media_live_connector_pipeline::de_create_media_live_connector_pipeline_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_media_live_connector_pipeline::de_create_media_live_connector_pipeline_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMediaLiveConnectorPipelineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_media_live_connector_pipeline::ser_create_media_live_connector_pipeline_input(&input)?,
        );
