...
impl ListMediaCapturePipelinesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesInput, ::aws_smithy_types::error::operation::BuildError> {
