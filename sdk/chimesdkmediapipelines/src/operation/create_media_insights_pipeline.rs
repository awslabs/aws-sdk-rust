...
impl CreateMediaInsightsPipelineInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMediaInsightsPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_media_insights_pipeline::de_create_media_insights_pipeline_http_response_with_props(
                status, headers, body,
            )
        }
    }
