    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMediaInsightsPipeline {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateMediaInsightsPipeline")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateMediaInsightsPipelineResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateMediaInsightsPipelineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateMediaInsightsPipelineEndpointParamsInterceptor {
...
pub type CreateMediaInsightsPipelineErrorKind = CreateMediaInsightsPipelineError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateMediaInsightsPipelineError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineError {
...
impl CreateMediaInsightsPipelineError {
    ...
    /// Creates the `CreateMediaInsightsPipelineError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
