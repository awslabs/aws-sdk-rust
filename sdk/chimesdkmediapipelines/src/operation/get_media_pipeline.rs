...
impl GetMediaPipelineInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_media_pipeline::GetMediaPipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMediaPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_media_pipeline::de_get_media_pipeline_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_media_pipeline::GetMediaPipelineError
{
