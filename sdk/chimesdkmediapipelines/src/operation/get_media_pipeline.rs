...
impl GetMediaPipeline {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_media_pipeline::GetMediaPipelineInput,
                    ) -> ::std::result::Result<crate::operation::get_media_pipeline::GetMediaPipelineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_media_pipeline::GetMediaPipelineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_media_pipeline::GetMediaPipelineError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_media_pipeline::GetMediaPipelineOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMediaPipeline {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMediaPipeline");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMediaPipelineRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMediaPipelineResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMediaPipeline")
...
.with_interceptor(GetMediaPipelineEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_media_pipeline::GetMediaPipelineError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_media_pipeline::GetMediaPipelineError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_media_pipeline::GetMediaPipelineError>::new());
...
#[derive(Debug)]
            struct GetMediaPipelineResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMediaPipelineResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_media_pipeline::de_get_media_pipeline_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetMediaPipelineRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMediaPipelineRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_media_pipeline::GetMediaPipelineInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_media_pipeline::GetMediaPipelineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetMediaPipelineEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMediaPipelineEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetMediaPipelineEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMediaPipelineInput>()
                        .ok_or("failed to downcast to GetMediaPipelineInput")?;
...
pub enum GetMediaPipelineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMediaPipelineError) for what information is available for the error.")]
...
impl GetMediaPipelineError {
    /// Creates the `GetMediaPipelineError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMediaPipelineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMediaPipelineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_media_pipeline::GetMediaPipelineError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_media_pipeline::_get_media_pipeline_output::GetMediaPipelineOutput;

pub use crate::operation::get_media_pipeline::_get_media_pipeline_input::GetMediaPipelineInput;

mod _get_media_pipeline_input;

mod _get_media_pipeline_output;
