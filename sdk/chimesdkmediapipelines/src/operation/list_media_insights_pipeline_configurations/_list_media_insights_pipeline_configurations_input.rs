...
impl ListMediaInsightsPipelineConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_media_insights_pipeline_configurations::ListMediaInsightsPipelineConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
