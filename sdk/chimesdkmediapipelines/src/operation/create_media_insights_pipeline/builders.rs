...
impl CreateMediaInsightsPipelineFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipeline, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineOutput, aws_smithy_http::result::SdkError<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineError>>
                     {
