...
pub fn ser_live_connector_source_configuration(
    ...
    if let Some(var_1) = &input.chime_sdk_meeting_live_connector_configuration {
        ...
        crate::protocol_serde::shape_chime_sdk_meeting_live_connector_configuration::ser_chime_sdk_meeting_live_connector_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
...
pub(crate) fn de_live_connector_source_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LiveConnectorSourceConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::live_connector_source_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
