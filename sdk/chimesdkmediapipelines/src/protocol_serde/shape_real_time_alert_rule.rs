...
pub fn ser_real_time_alert_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RealTimeAlertRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_real_time_alert_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::RealTimeAlertRule>, aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RealTimeAlertRuleType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
