...
pub fn ser_chime_sdk_meeting_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChimeSdkMeetingConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_chime_sdk_meeting_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ChimeSdkMeetingConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
