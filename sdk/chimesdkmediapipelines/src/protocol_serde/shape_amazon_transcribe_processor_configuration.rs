...
pub fn ser_amazon_transcribe_processor_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AmazonTranscribeProcessorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_amazon_transcribe_processor_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AmazonTranscribeProcessorConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ShowSpeakerLabel" => {
                                builder = builder.set_show_speaker_label(
                                    aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "EnablePartialResultsStabilization" => {
                                builder = builder.set_enable_partial_results_stabilization(
                                    aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "PartialResultsStability" => {
                                builder = builder.set_partial_results_stability(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::PartialResultsStability::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "FilterPartialResults" => {
                                builder = builder.set_filter_partial_results(
                                    aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
