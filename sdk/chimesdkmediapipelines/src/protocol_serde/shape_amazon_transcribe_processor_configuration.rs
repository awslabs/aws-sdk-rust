...
pub fn ser_amazon_transcribe_processor_configuration(
    ...
    if input.show_speaker_label {
        object
            ...
            .boolean(input.show_speaker_label);
    }
...
pub(crate) fn de_amazon_transcribe_processor_configuration<'a, I>(
    ...
    Option<crate::types::AmazonTranscribeProcessorConfiguration>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_language_code(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::types::CallAnalyticsLanguageCode::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
                            ...
                            "ContentIdentificationType" => {
                                builder = builder.set_content_identification_type(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::ContentType::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
