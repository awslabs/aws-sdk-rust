...
pub fn de_get_media_insights_pipeline_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(_response_body, output).map_err(
                        crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::unhandled,
                    )?;
        ...
        "ForbiddenException" => {
            crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::ForbiddenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_media_insights_pipeline_configuration_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_media_insights_pipeline_configuration::de_get_media_insights_pipeline_configuration(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_media_insights_pipeline_configuration::GetMediaInsightsPipelineConfigurationError::unhandled)?;
