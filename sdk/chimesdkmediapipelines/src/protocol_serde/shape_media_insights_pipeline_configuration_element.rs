...
pub fn ser_media_insights_pipeline_configuration_element(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::MediaInsightsPipelineConfigurationElement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
