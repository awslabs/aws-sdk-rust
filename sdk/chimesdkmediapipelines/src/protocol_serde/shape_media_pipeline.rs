...
) -> Result<Option<crate::types::MediaPipeline>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "MediaCapturePipeline" => {
                            builder = builder
                                .set_media_capture_pipeline(crate::protocol_serde::shape_media_capture_pipeline::de_media_capture_pipeline(tokens)?);
                        }
