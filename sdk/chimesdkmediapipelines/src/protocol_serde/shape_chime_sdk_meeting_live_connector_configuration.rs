...
pub fn ser_chime_sdk_meeting_live_connector_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChimeSdkMeetingLiveConnectorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_chime_sdk_meeting_live_connector_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ChimeSdkMeetingLiveConnectorConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
