...
pub fn ser_chime_sdk_meeting_live_connector_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ChimeSdkMeetingLiveConnectorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_chime_sdk_meeting_live_connector_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ChimeSdkMeetingLiveConnectorConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "MuxType" => {
                                builder = builder.set_mux_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::LiveConnectorMuxType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
