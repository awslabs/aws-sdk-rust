...
pub fn ser_amazon_transcribe_call_analytics_processor_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AmazonTranscribeCallAnalyticsProcessorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
