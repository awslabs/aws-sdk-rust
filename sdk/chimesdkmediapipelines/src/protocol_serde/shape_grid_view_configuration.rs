...
pub fn ser_grid_view_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GridViewConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_grid_view_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GridViewConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
