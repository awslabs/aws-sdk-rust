...
pub fn ser_create_media_capture_pipeline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateMediaCapturePipelineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
