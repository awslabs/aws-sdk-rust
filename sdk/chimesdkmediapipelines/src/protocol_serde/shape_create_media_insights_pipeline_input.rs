...
pub fn ser_create_media_insights_pipeline_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
