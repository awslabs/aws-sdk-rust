...
pub fn ser_artifacts_concatenation_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ArtifactsConcatenationConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_artifacts_concatenation_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ArtifactsConcatenationConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
