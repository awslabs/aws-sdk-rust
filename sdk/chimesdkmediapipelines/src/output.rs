...
pub struct ListMediaPipelinesOutput  {
    ...
    #[doc(hidden)]pub media_pipelines: std::option::Option<std::vec::Vec<crate::model::MediaPipelineSummary>>,
...
pub struct ListMediaCapturePipelinesOutput  {
    /// <p>The media pipeline objects in the list.</p>
    #[doc(hidden)]pub media_capture_pipelines: std::option::Option<std::vec::Vec<crate::model::MediaCapturePipelineSummary>>,
    /// <p>The token used to retrieve the next page of results. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetMediaPipelineOutput  {
    ...
    #[doc(hidden)]pub media_pipeline: std::option::Option<crate::model::MediaPipeline>,
}
...
pub struct GetMediaCapturePipelineOutput  {
    /// <p>The media pipeline object.</p>
    #[doc(hidden)]pub media_capture_pipeline: std::option::Option<crate::model::MediaCapturePipeline>,
}
...
pub struct CreateMediaLiveConnectorPipelineOutput  {
    ...
    #[doc(hidden)]pub media_live_connector_pipeline: std::option::Option<crate::model::MediaLiveConnectorPipeline>,
}
...
impl  std::fmt::Debug for CreateMediaLiveConnectorPipelineOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("media_live_connector_pipeline", &self.media_live_connector_pipeline);
        formatter.finish()
    }
}
...
pub struct CreateMediaConcatenationPipelineOutput  {
    ...
    #[doc(hidden)]pub media_concatenation_pipeline: std::option::Option<crate::model::MediaConcatenationPipeline>,
}
...
impl  std::fmt::Debug for CreateMediaConcatenationPipelineOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("media_concatenation_pipeline", &self.media_concatenation_pipeline);
        formatter.finish()
    }
}
