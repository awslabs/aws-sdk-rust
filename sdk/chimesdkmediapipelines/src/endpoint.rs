...
mod test {
    ...
    fn test_1() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.us-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
    ...
    fn test_2() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime-fips.us-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_3() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.us-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_4() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime-fips.us-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_5() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.eu-central-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_6() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.ap-southeast-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_7() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime-fips.us-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_8() {
        ...
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://media-pipelines-chime.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_9() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime-fips.us-gov-east-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime-fips.us-gov-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_10() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime-fips.us-gov-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_11() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://media-pipelines-chime.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime.us-gov-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_12() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.us-gov-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime.us-gov-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_13() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime-fips.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
    ...
    fn test_14() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.us-isob-east-1.sc2s.sgov.gov",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
    ...
    fn test_15() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime-fips.cn-north-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_16() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime-fips.cn-north-1.amazonaws.com.cn")
                .build()
        );
    }
    ...
    fn test_17() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime.cn-north-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_18() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.cn-north-1.amazonaws.com.cn",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime.cn-north-1.amazonaws.com.cn")
                .build()
        );
    }
    ...
    fn test_19() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime-fips.us-iso-east-1.c2s.ic.gov",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime-fips.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_20() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://media-pipelines-chime.us-iso-east-1.c2s.ic.gov",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://media-pipelines-chime.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
