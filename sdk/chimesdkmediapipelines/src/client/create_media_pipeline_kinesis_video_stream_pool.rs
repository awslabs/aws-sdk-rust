...
impl super::Client {
    ...
    ///   - [`stream_configuration(KinesisVideoStreamConfiguration)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::stream_configuration) / [`set_stream_configuration(Option<KinesisVideoStreamConfiguration>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_stream_configuration): <p>The configuration settings for the video stream.</p>
    ///   - [`pool_name(impl Into<String>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::pool_name) / [`set_pool_name(Option<String>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_pool_name): <p>The name of the video stream pool.</p>
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_client_request_token): <p>The token assigned to the client making the request.</p>
    ///   - [`tags(Tag)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_tags): <p>The tags assigned to the video stream pool.</p>
