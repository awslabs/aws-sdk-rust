...
impl super::Client {
    ...
    ///   - [`stream_configuration(KinesisVideoStreamConfiguration)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::stream_configuration) / [`set_stream_configuration(Option<KinesisVideoStreamConfiguration>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_stream_configuration):<br>required: **true**<br><p>The configuration settings for the stream.</p><br>
    ///   - [`pool_name(impl Into<String>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::pool_name) / [`set_pool_name(Option<String>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_pool_name):<br>required: **true**<br><p>The name of the pool.</p><br>
    ...
    ///   - [`tags(Tag)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::builders::CreateMediaPipelineKinesisVideoStreamPoolFluentBuilder::set_tags):<br>required: **false**<br><p>The tags assigned to the stream pool.</p><br>
    ...
    ///   - [`kinesis_video_stream_pool_configuration(Option<KinesisVideoStreamPoolConfiguration>)`](crate::operation::create_media_pipeline_kinesis_video_stream_pool::CreateMediaPipelineKinesisVideoStreamPoolOutput::kinesis_video_stream_pool_configuration): <p>The configuration for applying the streams to the pool.</p><note>  <p></p> </note>
