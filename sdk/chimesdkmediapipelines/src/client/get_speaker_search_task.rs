...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::get_speaker_search_task::builders::GetSpeakerSearchTaskFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_speaker_search_task::builders::GetSpeakerSearchTaskFluentBuilder::set_identifier): <p>The unique identifier of the resource to be updated. Valid values include the ID and ARN of the media insights pipeline.</p>
