...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_media_pipeline_kinesis_video_stream_pools::builders::ListMediaPipelineKinesisVideoStreamPoolsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_media_pipeline_kinesis_video_stream_pools::builders::ListMediaPipelineKinesisVideoStreamPoolsFluentBuilder::set_next_token): <p>The token used to return the next page of results. </p>
