...
impl super::Client {
    ...
    ///   - [`media_pipeline_id(impl Into<String>)`](crate::operation::get_media_pipeline::builders::GetMediaPipelineFluentBuilder::media_pipeline_id) / [`set_media_pipeline_id(Option<String>)`](crate::operation::get_media_pipeline::builders::GetMediaPipelineFluentBuilder::set_media_pipeline_id):<br>required: **true**<br><p>The ID of the pipeline that you want to get.</p><br>
