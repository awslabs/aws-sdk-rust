...
//! ```
//!
use aws_sdk_directory::{config, Client};
/// Smoke tests for the `describe_directories` operation
#[::tokio::test]
async fn test_describe_directories_success() {
    ...
    let res = client.describe_directories().send().await;
