...
pub(crate) fn de_certificate_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CertificateInfo>, aws_smithy_json::deserialize::error::DeserializeError>
