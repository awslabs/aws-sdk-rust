...
pub fn ser_update_conditional_forwarder_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_conditional_forwarder::UpdateConditionalForwarderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
