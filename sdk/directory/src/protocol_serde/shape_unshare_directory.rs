...
pub fn ser_unshare_directory_input(
    ...
    crate::protocol_serde::shape_unshare_directory_input::ser_unshare_directory_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::unshare_directory::UnshareDirectoryError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "ClientException" => {
            crate::operation::unshare_directory::UnshareDirectoryError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DirectoryNotSharedException" => {
            crate::operation::unshare_directory::UnshareDirectoryError::DirectoryNotSharedException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "EntityDoesNotExistException" => {
            crate::operation::unshare_directory::UnshareDirectoryError::EntityDoesNotExistException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "InvalidTargetException" => {
            crate::operation::unshare_directory::UnshareDirectoryError::InvalidTargetException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceException" => {
            crate::operation::unshare_directory::UnshareDirectoryError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_unshare_directory::de_unshare_directory(
            _response_body,
            output,
        )
        .map_err(crate::operation::unshare_directory::UnshareDirectoryError::unhandled)?;
