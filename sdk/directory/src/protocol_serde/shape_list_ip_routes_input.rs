...
pub fn ser_list_ip_routes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListIpRoutesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
