...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_invalid_parameter_exception::de_invalid_parameter_exception_json_err(_response_body, output)
                            .map_err(
                                crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "ServiceException" => {
            crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_client_authentication_settings::de_describe_client_authentication_settings(_response_body, output)
                .map_err(crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError::unhandled)?;
...
pub fn ser_describe_client_authentication_settings_input(
    ...
    crate::protocol_serde::shape_describe_client_authentication_settings_input::ser_describe_client_authentication_settings_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ClientAuthenticationSettingsInfo" => {
                    builder = builder.set_client_authentication_settings_info(
                        crate::protocol_serde::shape_client_authentication_settings_info::de_client_authentication_settings_info(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
