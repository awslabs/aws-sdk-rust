...
pub fn ser_describe_client_authentication_settings_input(
    ...
    crate::protocol_serde::shape_describe_client_authentication_settings_input::ser_describe_client_authentication_settings_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_client_authentication_settings_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
