...
pub fn ser_enable_sso_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EnableSsoInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
