    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::HybridUpdateInfoEntryBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "NewValue" => {
                            builder = builder.set_new_value(crate::protocol_serde::shape_hybrid_update_value::de_hybrid_update_value(tokens)?);
                        }
                        "PreviousValue" => {
                            builder = builder.set_previous_value(crate::protocol_serde::shape_hybrid_update_value::de_hybrid_update_value(tokens)?);
                        }
                        "StartTime" => {
