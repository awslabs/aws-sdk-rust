...
> {
    ...
    Err(match error_code {
        "ClientException" => {
            crate::operation::delete_snapshot::DeleteSnapshotError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_client_exception::de_client_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_snapshot::DeleteSnapshotError::unhandled)?;
        ...
        "EntityDoesNotExistException" => {
            crate::operation::delete_snapshot::DeleteSnapshotError::EntityDoesNotExistException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_entity_does_not_exist_exception::de_entity_does_not_exist_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_snapshot::DeleteSnapshotError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidParameterException" => {
            crate::operation::delete_snapshot::DeleteSnapshotError::InvalidParameterException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_parameter_exception::de_invalid_parameter_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_snapshot::DeleteSnapshotError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "ServiceException" => {
            crate::operation::delete_snapshot::DeleteSnapshotError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_exception::de_service_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_snapshot::DeleteSnapshotError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
