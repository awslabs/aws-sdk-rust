...
pub fn ser_create_conditional_forwarder_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConditionalForwarderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
