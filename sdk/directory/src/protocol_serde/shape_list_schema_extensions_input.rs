...
pub fn ser_list_schema_extensions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSchemaExtensionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
