...
pub fn ser_describe_client_authentication_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeClientAuthenticationSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
