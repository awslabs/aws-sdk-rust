...
pub fn ser_disable_sso_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisableSsoInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
