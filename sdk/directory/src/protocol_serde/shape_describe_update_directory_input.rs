...
pub fn ser_describe_update_directory_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeUpdateDirectoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
