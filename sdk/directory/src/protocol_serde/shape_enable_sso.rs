...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::enable_sso::EnableSsoError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AuthenticationFailedException" => {
            crate::operation::enable_sso::EnableSsoError::AuthenticationFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ClientException" => {
            crate::operation::enable_sso::EnableSsoError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "EntityDoesNotExistException" => {
            crate::operation::enable_sso::EnableSsoError::EntityDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceException" => {
            crate::operation::enable_sso::EnableSsoError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
