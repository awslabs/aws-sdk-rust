...
pub fn ser_describe_ldaps_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_ldaps_settings::DescribeLdapsSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
