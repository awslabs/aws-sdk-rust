...
pub fn ser_create_directory_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDirectoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
