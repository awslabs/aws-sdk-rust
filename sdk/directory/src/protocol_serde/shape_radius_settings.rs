...
pub fn ser_radius_settings(
    ...
    if let Some(var_4) = &input.radius_port {
        object.key("RadiusPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.radius_timeout {
        object.key("RadiusTimeout").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
