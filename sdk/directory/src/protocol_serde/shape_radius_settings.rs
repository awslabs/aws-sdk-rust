...
pub fn ser_radius_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RadiusSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_radius_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RadiusSettings>, aws_smithy_json::deserialize::error::DeserializeError>
