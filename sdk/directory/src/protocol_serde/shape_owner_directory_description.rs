...
pub(crate) fn de_owner_directory_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OwnerDirectoryDescription>, aws_smithy_json::deserialize::error::DeserializeError>
