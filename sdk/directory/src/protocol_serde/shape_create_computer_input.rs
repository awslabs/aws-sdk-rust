...
pub fn ser_create_computer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateComputerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
