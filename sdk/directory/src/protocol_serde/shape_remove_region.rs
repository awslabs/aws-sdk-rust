...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::remove_region::RemoveRegionError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ClientException" => {
            crate::operation::remove_region::RemoveRegionError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceException" => {
            crate::operation::remove_region::RemoveRegionError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
