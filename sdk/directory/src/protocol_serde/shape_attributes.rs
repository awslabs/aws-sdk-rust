...
pub(crate) fn de_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Attribute>>, aws_smithy_json::deserialize::error::DeserializeError>
