...
pub fn ser_connect_directory_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConnectDirectoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
