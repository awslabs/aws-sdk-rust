...
pub struct SchemaExtensionInfo {
    ...
    pub start_date_time: std::option::Option<smithy_types::Instant>,
...
pub mod schema_extension_info {
    ...
    impl Builder {
        ...
        /// <p>The date and time that the schema extension started being applied to the directory.</p>
        pub fn start_date_time(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// <p>The date and time that the schema extension was completed.</p>
        pub fn end_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct LogSubscription {
    ...
    pub subscription_created_date_time: std::option::Option<smithy_types::Instant>,
}
...
pub mod log_subscription {
    ...
    pub struct Builder {
        ...
        pub(crate) subscription_created_date_time: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>Identifier (ID) of the directory that you want to associate with the log
        /// subscription.</p>
        ...
        /// <p>The date and time that the log subscription was created.</p>
        pub fn subscription_created_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct IpRouteInfo {
    ...
    pub added_date_time: std::option::Option<smithy_types::Instant>,
...
pub mod ip_route_info {
    ...
    pub struct Builder {
        ...
        pub(crate) added_date_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date and time the address block was added to the directory.</p>
        pub fn added_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct CertificateInfo {
    ...
    pub expiry_date_time: std::option::Option<smithy_types::Instant>,
...
pub mod certificate_info {
    ...
    pub struct Builder {
        ...
        pub(crate) expiry_date_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date and time when the certificate will expire.</p>
        pub fn expiry_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct Trust {
    ...
    pub created_date_time: std::option::Option<smithy_types::Instant>,
    ...
    pub state_last_updated_date_time: std::option::Option<smithy_types::Instant>,
...
pub mod trust {
    ...
    pub struct Builder {
        ...
        pub(crate) created_date_time: std::option::Option<smithy_types::Instant>,
        pub(crate) last_updated_date_time: std::option::Option<smithy_types::Instant>,
        pub(crate) state_last_updated_date_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date and time that the trust relationship was created.</p>
        pub fn created_date_time(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// <p>The date and time that the TrustState was last updated.</p>
        pub fn state_last_updated_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct RegionDescription {
    ...
    pub status_last_updated_date_time: std::option::Option<smithy_types::Instant>,
...
pub mod region_description {
    ...
    pub struct Builder {
        ...
        pub(crate) status_last_updated_date_time: std::option::Option<smithy_types::Instant>,
        pub(crate) last_updated_date_time: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The identifier of the directory.</p>
        ...
        /// <p>The date and time that the Region status was last updated.</p>
        pub fn status_last_updated_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct DirectoryDescription {
    ...
    pub stage_last_updated_date_time: std::option::Option<smithy_types::Instant>,
    /// <p>The directory size.</p>
...
pub mod directory_description {
    ...
    pub struct Builder {
        ...
        pub(crate) share_notes: std::option::Option<std::string::String>,
        pub(crate) launch_time: std::option::Option<smithy_types::Instant>,
        pub(crate) stage_last_updated_date_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The date and time that the stage was last updated.</p>
        pub fn stage_last_updated_date_time(mut self, input: smithy_types::Instant) -> Self {
...
pub struct Certificate {
    ...
    pub registered_date_time: std::option::Option<smithy_types::Instant>,
    /// <p>The date and time when the certificate will expire.</p>
    pub expiry_date_time: std::option::Option<smithy_types::Instant>,
    /// <p>The function that the registered certificate performs. Valid values include <code>ClientLDAPS</code> or <code>ClientCertAuth</code>. The default value is <code>ClientLDAPS</code>.</p>
    pub r#type: std::option::Option<crate::model::CertificateType>,
...
pub mod certificate {
    ...
    pub struct Builder {
        ...
        pub(crate) common_name: std::option::Option<std::string::String>,
        pub(crate) registered_date_time: std::option::Option<smithy_types::Instant>,
        pub(crate) expiry_date_time: std::option::Option<smithy_types::Instant>,
        pub(crate) r#type: std::option::Option<crate::model::CertificateType>,
    ...
    impl Builder {
        ...
        /// <p>The date and time that the certificate was registered.</p>
        pub fn registered_date_time(mut self, input: smithy_types::Instant) -> Self {
