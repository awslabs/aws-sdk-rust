...
pub struct RadiusSettings  {
    ...
    #[doc(hidden)]pub radius_servers: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub radius_port: i32,
    /// <p>The amount of time, in seconds, to wait for the RADIUS server to respond.</p>
    #[doc(hidden)]pub radius_timeout: i32,
    /// <p>The maximum number of times that communication with the RADIUS server is attempted.</p>
    #[doc(hidden)]pub radius_retries: i32,
    /// <p>Required for enabling RADIUS on the directory.</p>
    #[doc(hidden)]pub shared_secret: std::option::Option<std::string::String>,
    /// <p>The protocol specified for your RADIUS endpoints.</p>
    #[doc(hidden)]pub authentication_protocol: std::option::Option<crate::model::RadiusAuthenticationProtocol>,
    /// <p>Not currently used.</p>
    #[doc(hidden)]pub display_label: std::option::Option<std::string::String>,
    /// <p>Not currently used.</p>
    #[doc(hidden)]pub use_same_username: bool,
}
impl RadiusSettings {
    /// <p>An array of strings that contains the fully qualified domain name (FQDN) or IP addresses of the RADIUS server endpoints, or the FQDN or IP addresses of your RADIUS server load balancer.</p>
...
pub struct ClientCertAuthSettings  {
    ...
    #[doc(hidden)]pub ocsp_url: std::option::Option<std::string::String>,
}
...
pub struct SchemaExtensionInfo  {
    ...
    #[doc(hidden)]pub schema_extension_status: std::option::Option<crate::model::SchemaExtensionStatus>,
    /// <p>The reason for the <code>SchemaExtensionStatus</code>.</p>
    #[doc(hidden)]pub schema_extension_status_reason: std::option::Option<std::string::String>,
    /// <p>The date and time that the schema extension started being applied to the directory.</p>
    #[doc(hidden)]pub start_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time that the schema extension was completed.</p>
    #[doc(hidden)]pub end_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
impl  std::fmt::Debug for SchemaExtensionInfo  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("schema_extension_status_reason", &self.schema_extension_status_reason);
...
pub struct LogSubscription  {
    ...
    #[doc(hidden)]pub subscription_created_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
impl  std::fmt::Debug for LogSubscription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("subscription_created_date_time", &self.subscription_created_date_time);
        formatter.finish()
    }
}
...
pub struct IpRouteInfo  {
    ...
    #[doc(hidden)]pub cidr_ip: std::option::Option<std::string::String>,
    /// <p>The status of the IP address block.</p>
    #[doc(hidden)]pub ip_route_status_msg: std::option::Option<crate::model::IpRouteStatusMsg>,
    /// <p>The date and time the address block was added to the directory.</p>
    #[doc(hidden)]pub added_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The reason for the IpRouteStatusMsg.</p>
    #[doc(hidden)]pub ip_route_status_reason: std::option::Option<std::string::String>,
...
pub struct CertificateInfo  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::CertificateState>,
    /// <p>The date and time when the certificate will expire.</p>
    #[doc(hidden)]pub expiry_date_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct SnapshotLimits  {
    ...
    #[doc(hidden)]pub manual_snapshots_limit: std::option::Option<i32>,
    /// <p>The current number of manual snapshots of the directory.</p>
    #[doc(hidden)]pub manual_snapshots_current_count: std::option::Option<i32>,
    /// <p>Indicates if the manual snapshot limit has been reached.</p>
    #[doc(hidden)]pub manual_snapshots_limit_reached: bool,
}
impl SnapshotLimits {
    /// <p>The maximum number of manual snapshots allowed.</p>
...
impl  std::fmt::Debug for SnapshotLimits  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("manual_snapshots_current_count", &self.manual_snapshots_current_count);
        formatter.field("manual_snapshots_limit_reached", &self.manual_snapshots_limit_reached);
        formatter.finish()
    }
}
...
pub struct DirectoryLimits  {
    ...
    #[doc(hidden)]pub cloud_only_directories_limit: std::option::Option<i32>,
    /// <p>The current number of cloud directories in the Region.</p>
    #[doc(hidden)]pub cloud_only_directories_current_count: std::option::Option<i32>,
    /// <p>Indicates if the cloud directory limit has been reached.</p>
    #[doc(hidden)]pub cloud_only_directories_limit_reached: bool,
    /// <p>The maximum number of Managed Microsoft AD directories allowed in the region.</p>
    #[doc(hidden)]pub cloud_only_microsoft_ad_limit: std::option::Option<i32>,
    /// <p>The current number of Managed Microsoft AD directories in the region.</p>
    #[doc(hidden)]pub cloud_only_microsoft_ad_current_count: std::option::Option<i32>,
    /// <p>Indicates if the Managed Microsoft AD directory limit has been reached.</p>
    #[doc(hidden)]pub cloud_only_microsoft_ad_limit_reached: bool,
    /// <p>The maximum number of connected directories allowed in the Region.</p>
    #[doc(hidden)]pub connected_directories_limit: std::option::Option<i32>,
    /// <p>The current number of connected directories in the Region.</p>
    #[doc(hidden)]pub connected_directories_current_count: std::option::Option<i32>,
    /// <p>Indicates if the connected directory limit has been reached.</p>
    #[doc(hidden)]pub connected_directories_limit_reached: bool,
}
...
impl  std::fmt::Debug for DirectoryLimits  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("cloud_only_directories_limit", &self.cloud_only_directories_limit);
        formatter.field("cloud_only_directories_current_count", &self.cloud_only_directories_current_count);
        formatter.field("cloud_only_directories_limit_reached", &self.cloud_only_directories_limit_reached);
        formatter.field("cloud_only_microsoft_ad_limit", &self.cloud_only_microsoft_ad_limit);
        formatter.field("cloud_only_microsoft_ad_current_count", &self.cloud_only_microsoft_ad_current_count);
        formatter.field("cloud_only_microsoft_ad_limit_reached", &self.cloud_only_microsoft_ad_limit_reached);
        formatter.field("connected_directories_limit", &self.connected_directories_limit);
        formatter.field("connected_directories_current_count", &self.connected_directories_current_count);
        formatter.field("connected_directories_limit_reached", &self.connected_directories_limit_reached);
        formatter.finish()
    }
}
...
pub struct Trust  {
    ...
    #[doc(hidden)]pub trust_state: std::option::Option<crate::model::TrustState>,
    /// <p>The date and time that the trust relationship was created.</p>
    #[doc(hidden)]pub created_date_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub state_last_updated_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The reason for the TrustState.</p>
    #[doc(hidden)]pub trust_state_reason: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for Trust  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("state_last_updated_date_time", &self.state_last_updated_date_time);
...
pub struct Snapshot  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::SnapshotType>,
    /// <p>The descriptive name of the snapshot.</p>
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The snapshot status.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::SnapshotStatus>,
...
pub struct SettingEntry  {
    ...
    #[doc(hidden)]pub applied_value: std::option::Option<std::string::String>,
    /// <p>The value that was last requested for the directory setting.</p>
    #[doc(hidden)]pub requested_value: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub request_status: std::option::Option<crate::model::DirectoryConfigurationStatus>,
    ...
    #[doc(hidden)]pub request_detailed_status: std::option::Option<std::collections::HashMap<std::string::String, crate::model::DirectoryConfigurationStatus>>,
    /// <p>The last status message for the directory status request.</p>
    #[doc(hidden)]pub request_status_message: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_requested_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl SettingEntry {
    /// <p>The type of directory setting. For example, <code>Protocol</code> or <code>Cipher</code>.</p>
...
pub struct RegionDescription  {
    ...
    #[doc(hidden)]pub region_type: std::option::Option<crate::model::RegionType>,
    /// <p>The status of the replication process for the specified Region.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::DirectoryStage>,
    ...
    #[doc(hidden)]pub desired_number_of_domain_controllers: i32,
    /// <p>Specifies when the Region replication began.</p>
    #[doc(hidden)]pub launch_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time that the Region status was last updated.</p>
    #[doc(hidden)]pub status_last_updated_date_time: std::option::Option<aws_smithy_types::DateTime>,
...
impl  std::fmt::Debug for RegionDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("status_last_updated_date_time", &self.status_last_updated_date_time);
        formatter.field("last_updated_date_time", &self.last_updated_date_time);
        formatter.finish()
    }
}
...
pub struct LdapsSettingInfo  {
    ...
    #[doc(hidden)]pub ldaps_status: std::option::Option<crate::model::LdapsStatus>,
    /// <p>Describes a state change for LDAPS.</p>
    #[doc(hidden)]pub ldaps_status_reason: std::option::Option<std::string::String>,
...
pub struct EventTopic  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::TopicStatus>,
}
impl EventTopic {
    /// <p>The Directory ID of an Directory Service directory that will publish status messages to an Amazon SNS topic.</p>
    pub fn directory_id(&self) -> std::option::Option<& str> {
...
pub struct DomainController  {
    ...
    #[doc(hidden)]pub domain_controller_id: std::option::Option<std::string::String>,
    /// <p>The IP address of the domain controller.</p>
    #[doc(hidden)]pub dns_ip_addr: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::DomainControllerStatus>,
...
pub struct DirectoryDescription  {
    ...
    #[doc(hidden)]pub access_url: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub stage: std::option::Option<crate::model::DirectoryStage>,
    /// <p>Current directory status of the shared Managed Microsoft AD directory.</p>
    #[doc(hidden)]pub share_status: std::option::Option<crate::model::ShareStatus>,
    /// <p>The method used when sharing a directory to determine whether the directory should be shared within your Amazon Web Services organization (<code>ORGANIZATIONS</code>) or with any Amazon Web Services account by sending a shared directory request (<code>HANDSHAKE</code>).</p>
    #[doc(hidden)]pub share_method: std::option::Option<crate::model::ShareMethod>,
    ...
    #[doc(hidden)]pub stage_last_updated_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The directory size.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::DirectoryType>,
    ...
    #[doc(hidden)]pub vpc_settings: std::option::Option<crate::model::DirectoryVpcSettingsDescription>,
    ...
    #[doc(hidden)]pub connect_settings: std::option::Option<crate::model::DirectoryConnectSettingsDescription>,
    ...
    #[doc(hidden)]pub radius_status: std::option::Option<crate::model::RadiusStatus>,
    /// <p>Additional information about the directory stage.</p>
    #[doc(hidden)]pub stage_reason: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub sso_enabled: bool,
    ...
    #[doc(hidden)]pub owner_directory_description: std::option::Option<crate::model::OwnerDirectoryDescription>,
    /// <p>Lists the Regions where the directory has replicated.</p>
    #[doc(hidden)]pub regions_info: std::option::Option<crate::model::RegionsInfo>,
}
...
pub struct RegionsInfo  {
    ...
    #[doc(hidden)]pub additional_regions: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl RegionsInfo {
    /// <p>The Region where the Managed Microsoft AD directory was originally created.</p>
...
pub struct DirectoryConnectSettingsDescription  {
    ...
    #[doc(hidden)]pub connect_ips: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct ConditionalForwarder  {
    ...
    #[doc(hidden)]pub replication_scope: std::option::Option<crate::model::ReplicationScope>,
}
...
pub struct ClientAuthenticationSettingInfo  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ClientAuthenticationStatus>,
...
pub struct Certificate  {
    ...
    #[doc(hidden)]pub registered_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time when the certificate will expire.</p>
    #[doc(hidden)]pub expiry_date_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The function that the registered certificate performs. Valid values include <code>ClientLDAPS</code> or <code>ClientCertAuth</code>. The default value is <code>ClientLDAPS</code>.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::CertificateType>,
...
pub struct Computer  {
    ...
    #[doc(hidden)]pub computer_id: std::option::Option<std::string::String>,
...
pub struct DirectoryConnectSettings  {
    ...
    #[doc(hidden)]pub customer_dns_ips: std::option::Option<std::vec::Vec<std::string::String>>,
