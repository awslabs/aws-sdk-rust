...
impl ::std::convert::From<&str> for ClientAuthenticationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ClientAuthenticationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ClientAuthenticationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientAuthenticationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ClientAuthenticationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
