...
impl ::std::convert::From<&str> for NetworkType {
    fn from(s: &str) -> Self {
        match s {
            "Dual-stack" => NetworkType::DualStack,
            "IPv4" => NetworkType::Ipv4Only,
            "IPv6" => NetworkType::Ipv6Only,
...
impl NetworkType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            NetworkType::DualStack => "Dual-stack",
            NetworkType::Ipv4Only => "IPv4",
            NetworkType::Ipv6Only => "IPv6",
