...
impl ListLogSubscriptionsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_log_subscriptions::ser_list_log_subscriptions_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl RegisterEventTopicInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_event_topic::ser_register_event_topic_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl RestoreFromSnapshotInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_from_snapshot::ser_restore_from_snapshot_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl StartSchemaExtensionInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_schema_extension::ser_start_schema_extension_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateDirectorySetupInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_directory_setup::ser_update_directory_setup_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
