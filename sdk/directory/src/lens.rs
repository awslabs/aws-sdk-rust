...
pub(crate) fn reflens_describe_client_authentication_settings_output_output_next_token(
...
pub(crate) fn reflens_describe_directories_output_output_next_token(
...
pub(crate) fn reflens_describe_domain_controllers_output_output_next_token(
    input: &crate::operation::describe_domain_controllers::DescribeDomainControllersOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_describe_ldaps_settings_output_output_next_token(
...
pub(crate) fn reflens_describe_regions_output_output_next_token(
...
pub(crate) fn reflens_describe_shared_directories_output_output_next_token(
...
pub(crate) fn reflens_describe_trusts_output_output_next_token(
...
pub(crate) fn reflens_describe_update_directory_output_output_next_token(
...
pub(crate) fn reflens_list_ad_assessments_output_output_next_token(
    input: &crate::operation::list_ad_assessments::ListAdAssessmentsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_ip_routes_output_output_next_token(
...
pub(crate) fn reflens_list_log_subscriptions_output_output_next_token(
...
pub(crate) fn reflens_list_schema_extensions_output_output_next_token(
...
pub(crate) fn lens_list_ad_assessments_output_output_assessments(
    input: crate::operation::list_ad_assessments::ListAdAssessmentsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AssessmentSummary>> {
    let input = input.assessments?;
    ::std::option::Option::Some(input)
}
