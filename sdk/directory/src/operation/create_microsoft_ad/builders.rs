...
impl CreateMicrosoftADFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_microsoft_ad::CreateMicrosoftAdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_microsoft_ad::CreateMicrosoftADError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_microsoft_ad::CreateMicrosoftAdOutput, crate::operation::create_microsoft_ad::CreateMicrosoftADError, Self> {
