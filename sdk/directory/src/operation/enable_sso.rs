...
impl EnableSsoInput {
    /// Consumes the builder and constructs an Operation<[`EnableSso`](crate::operation::enable_sso::EnableSso)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_sso::EnableSso, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_sso::EnableSsoInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_sso::EnableSso::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EnableSso {
                type Output = std::result::Result<crate::operation::enable_sso::EnableSsoOutput, crate::operation::enable_sso::EnableSsoError>;
