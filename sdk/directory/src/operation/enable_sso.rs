...
impl EnableSsoInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::enable_sso::EnableSso, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enable_sso::ser_enable_sso_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableSso {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_sso::de_enable_sso_http_response_with_props(status, headers, body)
        }
    }
}
