...
impl ConnectDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`ConnectDirectory`](crate::operation::connect_directory::ConnectDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::connect_directory::ConnectDirectory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::connect_directory::ConnectDirectoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::connect_directory::ConnectDirectory::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ConnectDirectory {
                type Output = std::result::Result<crate::operation::connect_directory::ConnectDirectoryOutput, crate::operation::connect_directory::ConnectDirectoryError>;
