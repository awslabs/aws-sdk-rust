...
impl ConnectDirectoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::connect_directory::ConnectDirectory, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_connect_directory::ser_connect_directory_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConnectDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_connect_directory::de_connect_directory_http_response_with_props(status, headers, body)
        }
    }
}
