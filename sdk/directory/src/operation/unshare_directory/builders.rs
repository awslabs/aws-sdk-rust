...
impl UnshareDirectoryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::unshare_directory::UnshareDirectoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::unshare_directory::UnshareDirectoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::unshare_directory::UnshareDirectoryOutput, crate::operation::unshare_directory::UnshareDirectoryError, Self> {
