...
impl UpdateDirectorySetupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_directory_setup::UpdateDirectorySetupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_directory_setup::UpdateDirectorySetupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_directory_setup::UpdateDirectorySetupOutput, crate::operation::update_directory_setup::UpdateDirectorySetupError, Self> {
