...
impl UpdateRadiusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_radius::UpdateRadius, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_radius::ser_update_radius_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRadius {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_radius::de_update_radius_http_response_with_props(status, headers, body)
        }
    }
}
