...
impl ListIpRoutesInput {
    /// Consumes the builder and constructs an Operation<[`ListIpRoutes`](crate::operation::list_ip_routes::ListIpRoutes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_ip_routes::ListIpRoutes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_ip_routes::ListIpRoutesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_ip_routes::ser_list_ip_routes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_ip_routes::ListIpRoutes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListIpRoutes {
                type Output = std::result::Result<crate::operation::list_ip_routes::ListIpRoutesOutput, crate::operation::list_ip_routes::ListIpRoutesError>;
