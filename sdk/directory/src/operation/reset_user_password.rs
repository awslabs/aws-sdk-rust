...
impl ResetUserPasswordInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reset_user_password::ser_reset_user_password_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetUserPassword {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reset_user_password::de_reset_user_password_http_response_with_props(status, headers, body)
        }
    }
}
