...
/// Orchestration and serialization glue logic for `DeleteConditionalForwarder`.
...
impl DeleteConditionalForwarder {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderInput,
                    ) -> ::std::result::Result<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteConditionalForwarder {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteConditionalForwarder");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteConditionalForwarderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteConditionalForwarderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteConditionalForwarder")
...
.with_interceptor(DeleteConditionalForwarderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError>::new());
...
#[derive(Debug)]
            struct DeleteConditionalForwarderResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteConditionalForwarderResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_conditional_forwarder::de_delete_conditional_forwarder_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_conditional_forwarder::de_delete_conditional_forwarder_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteConditionalForwarderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteConditionalForwarderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_conditional_forwarder::ser_delete_conditional_forwarder_input(&input)?);
...
#[derive(Debug)]
            struct DeleteConditionalForwarderEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteConditionalForwarderEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteConditionalForwarderEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteConditionalForwarderInput>()
                        .ok_or("failed to downcast to DeleteConditionalForwarderInput")?;
...
pub enum DeleteConditionalForwarderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteConditionalForwarderError) for what information is available for the error.")]
...
impl DeleteConditionalForwarderError {
    /// Creates the `DeleteConditionalForwarderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteConditionalForwarderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteConditionalForwarderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError {
...
mod _delete_conditional_forwarder_output;
