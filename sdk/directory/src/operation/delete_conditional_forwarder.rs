...
impl DeleteConditionalForwarderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteConditionalForwarder`](crate::operation::delete_conditional_forwarder::DeleteConditionalForwarder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarder, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_conditional_forwarder::ser_delete_conditional_forwarder_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_conditional_forwarder::DeleteConditionalForwarder::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteConditionalForwarder {
                type Output = std::result::Result<crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderOutput, crate::operation::delete_conditional_forwarder::DeleteConditionalForwarderError>;
