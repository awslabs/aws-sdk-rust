...
impl RegisterEventTopicInput {
    /// Consumes the builder and constructs an Operation<[`RegisterEventTopic`](crate::operation::register_event_topic::RegisterEventTopic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_event_topic::RegisterEventTopic, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_event_topic::RegisterEventTopicInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_event_topic::RegisterEventTopic::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterEventTopic {
                type Output = std::result::Result<crate::operation::register_event_topic::RegisterEventTopicOutput, crate::operation::register_event_topic::RegisterEventTopicError>;
