...
impl DeregisterCertificate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::deregister_certificate::DeregisterCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::deregister_certificate::DeregisterCertificateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Directory Service.DeregisterCertificate",
            "rpc.service" = "Directory Service",
            "rpc.method" = "DeregisterCertificate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterCertificate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeregisterCertificateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeregisterCertificateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeregisterCertificate")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterCertificate")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeregisterCertificateTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeregisterCertificateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterCertificateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeregisterCertificateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_deregister_certificate::de_deregister_certificate_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_deregister_certificate::de_deregister_certificate_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::deregister_certificate::DeregisterCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::deregister_certificate::DeregisterCertificateInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deregister_certificate::ser_deregister_certificate_input(
            &input,
        )?);
...
impl ::std::error::Error for DeregisterCertificateError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::CertificateDoesNotExistException(_inner) => ::std::option::Option::Some(_inner),
            Self::CertificateInUseException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeregisterCertificateError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CertificateDoesNotExistException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::CertificateInUseException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
