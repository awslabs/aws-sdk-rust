...
impl DeregisterCertificateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_certificate::ser_deregister_certificate_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_certificate::DeregisterCertificate::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deregister_certificate::DeregisterCertificateError
{
