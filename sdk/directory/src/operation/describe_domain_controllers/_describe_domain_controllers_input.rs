...
impl DescribeDomainControllersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_domain_controllers::DescribeDomainControllersInput, ::aws_smithy_types::error::operation::BuildError> {
