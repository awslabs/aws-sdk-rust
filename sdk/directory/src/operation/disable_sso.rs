...
impl DisableSsoInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_sso::DisableSso::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableSso {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_disable_sso::de_disable_sso_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_disable_sso::de_disable_sso_http_response_with_props(
                status, headers, body,
            )
        }
    }
