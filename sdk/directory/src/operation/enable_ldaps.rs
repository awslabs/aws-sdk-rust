...
impl EnableLdapsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_ldaps::EnableLDAPS::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableLDAPS {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_ldaps::de_enable_ldaps_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enable_ldaps::de_enable_ldaps_http_response_with_props(
                status, headers, body,
            )
        }
    }
