...
impl DeleteSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_snapshot::DeleteSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_snapshot::ser_delete_snapshot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSnapshot {
    type Output =
        ::std::result::Result<crate::operation::delete_snapshot::DeleteSnapshotOutput, crate::operation::delete_snapshot::DeleteSnapshotError>;
