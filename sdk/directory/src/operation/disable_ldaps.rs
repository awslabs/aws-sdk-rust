...
impl DisableLdapsInput {
    /// Consumes the builder and constructs an Operation<[`DisableLDAPS`](crate::operation::disable_ldaps::DisableLDAPS)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::disable_ldaps::DisableLDAPS, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disable_ldaps::ser_disable_ldaps_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_ldaps::DisableLDAPS::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableLDAPS {
    type Output = ::std::result::Result<crate::operation::disable_ldaps::DisableLdapsOutput, crate::operation::disable_ldaps::DisableLDAPSError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_ldaps::de_disable_ldaps_http_response_with_props(status, headers, body)
        }
    }
}
