...
impl CreateComputerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_computer::CreateComputer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_computer::ser_create_computer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateComputer {
    type Output =
        ::std::result::Result<crate::operation::create_computer::CreateComputerOutput, crate::operation::create_computer::CreateComputerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_computer::de_create_computer_http_response_with_props(status, headers, body)
        }
    }
}
