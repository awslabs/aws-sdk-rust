...
impl ConnectDirectoryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::connect_directory::ConnectDirectoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::connect_directory::ConnectDirectoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::connect_directory::ConnectDirectoryOutput, crate::operation::connect_directory::ConnectDirectoryError, Self> {
