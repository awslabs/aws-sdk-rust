...
impl VerifyTrustInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::verify_trust::VerifyTrust, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_verify_trust::ser_verify_trust_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyTrust {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_verify_trust::de_verify_trust_http_response_with_props(status, headers, body)
        }
    }
}
