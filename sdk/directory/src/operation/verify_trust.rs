...
impl VerifyTrustInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::verify_trust::VerifyTrust::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyTrust {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_verify_trust::de_verify_trust_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_verify_trust::de_verify_trust_http_response_with_props(
                status, headers, body,
            )
        }
    }
