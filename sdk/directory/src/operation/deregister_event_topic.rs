...
impl DeregisterEventTopicInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_event_topic::ser_deregister_event_topic_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_event_topic::DeregisterEventTopic::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deregister_event_topic::DeregisterEventTopicError
{
