...
impl DeregisterEventTopicInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_event_topic::DeregisterEventTopic,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterEventTopic {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_event_topic::de_deregister_event_topic_http_response_with_props(status, headers, body)
        }
    }
}
