...
impl DeregisterEventTopicInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterEventTopic`](crate::operation::deregister_event_topic::DeregisterEventTopic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_event_topic::DeregisterEventTopic, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_event_topic::DeregisterEventTopicInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_event_topic::ser_deregister_event_topic_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_event_topic::DeregisterEventTopic::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterEventTopic {
                type Output = std::result::Result<crate::operation::deregister_event_topic::DeregisterEventTopicOutput, crate::operation::deregister_event_topic::DeregisterEventTopicError>;
