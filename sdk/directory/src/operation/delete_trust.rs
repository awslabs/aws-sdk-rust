...
impl DeleteTrustInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_trust::DeleteTrust, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_trust::ser_delete_trust_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrust {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_trust::de_delete_trust_http_response_with_props(status, headers, body)
        }
    }
}
