...
impl EnableClientAuthenticationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_client_authentication::EnableClientAuthentication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableClientAuthentication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_client_authentication::de_enable_client_authentication_http_response_with_props(status, headers, body)
        }
    }
}
