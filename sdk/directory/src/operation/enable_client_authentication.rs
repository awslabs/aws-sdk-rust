...
impl EnableClientAuthenticationInput {
    /// Consumes the builder and constructs an Operation<[`EnableClientAuthentication`](crate::operation::enable_client_authentication::EnableClientAuthentication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_client_authentication::EnableClientAuthentication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_client_authentication::EnableClientAuthenticationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_client_authentication::ser_enable_client_authentication_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_client_authentication::EnableClientAuthentication::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EnableClientAuthentication {
                type Output = std::result::Result<crate::operation::enable_client_authentication::EnableClientAuthenticationOutput, crate::operation::enable_client_authentication::EnableClientAuthenticationError>;
