...
impl EnableClientAuthenticationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_client_authentication::EnableClientAuthentication::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::enable_client_authentication::EnableClientAuthenticationError
{
