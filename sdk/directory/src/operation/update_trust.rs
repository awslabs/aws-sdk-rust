...
impl UpdateTrustInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_trust::UpdateTrust, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_trust::ser_update_trust_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrust {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_trust::de_update_trust_http_response_with_props(status, headers, body)
        }
    }
}
