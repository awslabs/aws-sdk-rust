...
impl CreateLogSubscriptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_log_subscription::CreateLogSubscription,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLogSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_log_subscription::de_create_log_subscription_http_response_with_props(status, headers, body)
        }
    }
}
