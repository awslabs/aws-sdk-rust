...
impl ListSchemaExtensionsInput {
    /// Consumes the builder and constructs an Operation<[`ListSchemaExtensions`](crate::operation::list_schema_extensions::ListSchemaExtensions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_schema_extensions::ListSchemaExtensions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_schema_extensions::ListSchemaExtensionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_schema_extensions::ser_list_schema_extensions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_schema_extensions::ListSchemaExtensions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSchemaExtensions {
                type Output = std::result::Result<crate::operation::list_schema_extensions::ListSchemaExtensionsOutput, crate::operation::list_schema_extensions::ListSchemaExtensionsError>;
