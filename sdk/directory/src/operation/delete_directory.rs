...
impl DeleteDirectoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_directory::DeleteDirectory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_directory::de_delete_directory_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_directory::DeleteDirectoryError
{
