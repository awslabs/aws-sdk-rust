...
impl DeleteDirectoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_directory::DeleteDirectory, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_directory::ser_delete_directory_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDirectory {
    type Output =
        ::std::result::Result<crate::operation::delete_directory::DeleteDirectoryOutput, crate::operation::delete_directory::DeleteDirectoryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_directory::de_delete_directory_http_response_with_props(status, headers, body)
        }
    }
}
