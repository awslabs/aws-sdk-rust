...
impl DescribeSharedDirectories {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Directory Service.DescribeSharedDirectories",
            "rpc.service" = "Directory Service",
            "rpc.method" = "DescribeSharedDirectories",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSharedDirectories {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeSharedDirectoriesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeSharedDirectoriesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeSharedDirectories")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSharedDirectories")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribeSharedDirectoriesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeSharedDirectoriesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeSharedDirectoriesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeSharedDirectoriesInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("OwnerDirectoryId") {
            if let ::std::option::Option::Some(value) = input.owner_directory_id.as_deref() {
                captured.insert("OwnerDirectoryId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeSharedDirectoriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_shared_directories::de_describe_shared_directories_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_shared_directories::de_describe_shared_directories_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeSharedDirectoriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::describe_shared_directories::DescribeSharedDirectoriesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_describe_shared_directories::ser_describe_shared_directories_input(&input)?,
        );
