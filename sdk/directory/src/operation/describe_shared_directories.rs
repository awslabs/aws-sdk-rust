...
impl DescribeSharedDirectoriesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_shared_directories::DescribeSharedDirectories::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSharedDirectories {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_shared_directories::de_describe_shared_directories_http_response_with_props(status, headers, body)
        }
    }
