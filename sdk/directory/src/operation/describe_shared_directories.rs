...
impl DescribeSharedDirectories {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_shared_directories::DescribeSharedDirectoriesInput,
                    ) -> ::std::result::Result<crate::operation::describe_shared_directories::DescribeSharedDirectoriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_shared_directories::DescribeSharedDirectoriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSharedDirectories {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeSharedDirectories");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeSharedDirectoriesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeSharedDirectoriesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSharedDirectories")
...
.with_interceptor(DescribeSharedDirectoriesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesError>::new());
...
#[derive(Debug)]
            struct DescribeSharedDirectoriesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeSharedDirectoriesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_shared_directories::de_describe_shared_directories_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_shared_directories::de_describe_shared_directories_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeSharedDirectoriesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeSharedDirectoriesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_shared_directories::DescribeSharedDirectoriesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_shared_directories::DescribeSharedDirectoriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_shared_directories::ser_describe_shared_directories_input(&input)?);
...
#[derive(Debug)]
            struct DescribeSharedDirectoriesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeSharedDirectoriesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeSharedDirectoriesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeSharedDirectoriesInput>()
                        .ok_or("failed to downcast to DescribeSharedDirectoriesInput")?;
...
pub enum DescribeSharedDirectoriesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeSharedDirectoriesError) for what information is available for the error.")]
...
impl DescribeSharedDirectoriesError {
    /// Creates the `DescribeSharedDirectoriesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSharedDirectoriesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeSharedDirectoriesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_shared_directories::DescribeSharedDirectoriesError {
...
mod _describe_shared_directories_output;
