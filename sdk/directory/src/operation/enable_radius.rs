...
impl EnableRadiusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::enable_radius::EnableRadius, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enable_radius::ser_enable_radius_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableRadius {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_radius::de_enable_radius_http_response_with_props(status, headers, body)
        }
    }
}
