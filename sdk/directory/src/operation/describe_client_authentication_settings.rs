...
impl DescribeClientAuthenticationSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettings,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClientAuthenticationSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_client_authentication_settings::de_describe_client_authentication_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
