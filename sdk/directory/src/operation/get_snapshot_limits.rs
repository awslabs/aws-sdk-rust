...
impl GetSnapshotLimitsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_snapshot_limits::GetSnapshotLimits,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_snapshot_limits::ser_get_snapshot_limits_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSnapshotLimits {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_snapshot_limits::de_get_snapshot_limits_http_response_with_props(status, headers, body)
        }
    }
}
