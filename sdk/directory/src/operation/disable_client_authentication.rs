...
impl DisableClientAuthenticationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_client_authentication::DisableClientAuthentication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableClientAuthentication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_client_authentication::de_disable_client_authentication_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DisableClientAuthenticationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disable_client_authentication::DisableClientAuthenticationError
{
