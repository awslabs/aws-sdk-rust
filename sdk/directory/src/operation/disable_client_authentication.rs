...
/// Orchestration and serialization glue logic for `DisableClientAuthentication`.
...
impl DisableClientAuthentication {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disable_client_authentication::DisableClientAuthenticationInput,
                    ) -> ::std::result::Result<crate::operation::disable_client_authentication::DisableClientAuthenticationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_client_authentication::DisableClientAuthenticationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_client_authentication::DisableClientAuthenticationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_client_authentication::DisableClientAuthenticationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableClientAuthentication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableClientAuthentication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableClientAuthenticationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableClientAuthenticationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableClientAuthentication")
...
.with_interceptor(DisableClientAuthenticationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_client_authentication::DisableClientAuthenticationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_client_authentication::DisableClientAuthenticationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_client_authentication::DisableClientAuthenticationError>::new());
...
#[derive(Debug)]
            struct DisableClientAuthenticationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableClientAuthenticationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_client_authentication::de_disable_client_authentication_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disable_client_authentication::de_disable_client_authentication_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisableClientAuthenticationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableClientAuthenticationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_client_authentication::DisableClientAuthenticationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_client_authentication::DisableClientAuthenticationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_client_authentication::ser_disable_client_authentication_input(&input)?);
...
#[derive(Debug)]
            struct DisableClientAuthenticationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableClientAuthenticationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableClientAuthenticationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableClientAuthenticationInput>()
                        .ok_or("failed to downcast to DisableClientAuthenticationInput")?;
...
pub enum DisableClientAuthenticationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableClientAuthenticationError) for what information is available for the error.")]
...
impl DisableClientAuthenticationError {
    /// Creates the `DisableClientAuthenticationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableClientAuthenticationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableClientAuthenticationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_client_authentication::DisableClientAuthenticationError {
...
mod _disable_client_authentication_output;
