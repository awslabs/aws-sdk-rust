...
impl DisableClientAuthenticationInput {
    /// Consumes the builder and constructs an Operation<[`DisableClientAuthentication`](crate::operation::disable_client_authentication::DisableClientAuthentication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_client_authentication::DisableClientAuthentication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_client_authentication::DisableClientAuthenticationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_client_authentication::ser_disable_client_authentication_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_client_authentication::DisableClientAuthentication::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisableClientAuthentication {
                type Output = std::result::Result<crate::operation::disable_client_authentication::DisableClientAuthenticationOutput, crate::operation::disable_client_authentication::DisableClientAuthenticationError>;
