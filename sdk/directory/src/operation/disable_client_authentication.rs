...
impl DisableClientAuthentication {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disable_client_authentication::DisableClientAuthenticationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disable_client_authentication::DisableClientAuthenticationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Directory Service.DisableClientAuthentication",
            "rpc.service" = "Directory Service",
            "rpc.method" = "DisableClientAuthentication",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableClientAuthentication {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisableClientAuthenticationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisableClientAuthenticationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisableClientAuthentication")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableClientAuthentication")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisableClientAuthenticationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisableClientAuthenticationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableClientAuthenticationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisableClientAuthenticationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableClientAuthenticationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disable_client_authentication::de_disable_client_authentication_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_disable_client_authentication::de_disable_client_authentication_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableClientAuthenticationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disable_client_authentication::DisableClientAuthenticationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disable_client_authentication::DisableClientAuthenticationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disable_client_authentication::ser_disable_client_authentication_input(&input)?,
        );
