...
impl DescribeConditionalForwardersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_conditional_forwarders::DescribeConditionalForwarders::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConditionalForwarders {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_conditional_forwarders::de_describe_conditional_forwarders_http_response_with_props(
                status, headers, body,
            )
        }
    }
