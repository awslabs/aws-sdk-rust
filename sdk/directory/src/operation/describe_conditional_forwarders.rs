...
impl DescribeConditionalForwarders {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeConditionalForwarders {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeConditionalForwarders");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeConditionalForwardersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeConditionalForwardersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeConditionalForwarders")
...
.with_interceptor(DescribeConditionalForwardersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersError>::new());
...
#[derive(Debug)]
            struct DescribeConditionalForwardersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConditionalForwardersResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeConditionalForwardersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConditionalForwardersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_conditional_forwarders::ser_describe_conditional_forwarders_input(&input)?);
...
#[derive(Debug)]
            struct DescribeConditionalForwardersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeConditionalForwardersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeConditionalForwardersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeConditionalForwardersInput>()
                        .ok_or("failed to downcast to DescribeConditionalForwardersInput")?;
...
pub enum DescribeConditionalForwardersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeConditionalForwardersError) for what information is available for the error.")]
...
impl DescribeConditionalForwardersError {
    /// Creates the `DescribeConditionalForwardersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeConditionalForwardersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeConditionalForwardersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_conditional_forwarders::DescribeConditionalForwardersError {
