...
impl CancelSchemaExtensionInput {
    /// Consumes the builder and constructs an Operation<[`CancelSchemaExtension`](crate::operation::cancel_schema_extension::CancelSchemaExtension)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_schema_extension::CancelSchemaExtension, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_schema_extension::CancelSchemaExtensionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_schema_extension::ser_cancel_schema_extension_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_schema_extension::CancelSchemaExtension::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CancelSchemaExtension {
                type Output = std::result::Result<crate::operation::cancel_schema_extension::CancelSchemaExtensionOutput, crate::operation::cancel_schema_extension::CancelSchemaExtensionError>;
