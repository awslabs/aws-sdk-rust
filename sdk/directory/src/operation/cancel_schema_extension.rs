...
/// Orchestration and serialization glue logic for `CancelSchemaExtension`.
...
impl CancelSchemaExtension {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::cancel_schema_extension::CancelSchemaExtensionInput,
                    ) -> ::std::result::Result<crate::operation::cancel_schema_extension::CancelSchemaExtensionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_schema_extension::CancelSchemaExtensionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_schema_extension::CancelSchemaExtensionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_schema_extension::CancelSchemaExtensionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelSchemaExtension {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelSchemaExtension");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelSchemaExtensionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelSchemaExtensionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelSchemaExtension")
...
.with_interceptor(CancelSchemaExtensionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_schema_extension::CancelSchemaExtensionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_schema_extension::CancelSchemaExtensionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_schema_extension::CancelSchemaExtensionError>::new());
...
#[derive(Debug)]
            struct CancelSchemaExtensionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelSchemaExtensionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_schema_extension::de_cancel_schema_extension_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_cancel_schema_extension::de_cancel_schema_extension_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CancelSchemaExtensionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelSchemaExtensionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_schema_extension::CancelSchemaExtensionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_schema_extension::CancelSchemaExtensionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_schema_extension::ser_cancel_schema_extension_input(&input)?);
...
#[derive(Debug)]
            struct CancelSchemaExtensionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelSchemaExtensionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelSchemaExtensionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelSchemaExtensionInput>()
                        .ok_or("failed to downcast to CancelSchemaExtensionInput")?;
...
pub enum CancelSchemaExtensionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelSchemaExtensionError) for what information is available for the error.")]
...
impl CancelSchemaExtensionError {
    /// Creates the `CancelSchemaExtensionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelSchemaExtensionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelSchemaExtensionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_schema_extension::CancelSchemaExtensionError {
...
mod _cancel_schema_extension_output;
