...
impl DescribeEventTopics {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_event_topics::DescribeEventTopicsInput,
                    ) -> ::std::result::Result<crate::operation::describe_event_topics::DescribeEventTopicsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_event_topics::DescribeEventTopicsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_event_topics::DescribeEventTopicsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_event_topics::DescribeEventTopicsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeEventTopics {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeEventTopics");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeEventTopicsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeEventTopicsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeEventTopics")
...
.with_interceptor(DescribeEventTopicsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_event_topics::DescribeEventTopicsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_event_topics::DescribeEventTopicsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_event_topics::DescribeEventTopicsError>::new());
...
#[derive(Debug)]
            struct DescribeEventTopicsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeEventTopicsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_event_topics::de_describe_event_topics_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeEventTopicsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeEventTopicsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_event_topics::DescribeEventTopicsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_event_topics::DescribeEventTopicsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_event_topics::ser_describe_event_topics_input(&input)?);
...
#[derive(Debug)]
            struct DescribeEventTopicsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeEventTopicsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeEventTopicsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeEventTopicsInput>()
                        .ok_or("failed to downcast to DescribeEventTopicsInput")?;
...
pub enum DescribeEventTopicsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeEventTopicsError) for what information is available for the error.")]
...
impl DescribeEventTopicsError {
    /// Creates the `DescribeEventTopicsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeEventTopicsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeEventTopicsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_event_topics::DescribeEventTopicsError {
...
mod _describe_event_topics_output;
