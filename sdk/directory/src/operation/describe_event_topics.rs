...
impl DescribeEventTopicsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_event_topics::ser_describe_event_topics_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_event_topics::DescribeEventTopics::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_event_topics::DescribeEventTopicsError
{
