...
impl DescribeEventTopicsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEventTopics`](crate::operation::describe_event_topics::DescribeEventTopics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_event_topics::DescribeEventTopics, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_event_topics::DescribeEventTopicsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_event_topics::ser_describe_event_topics_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_event_topics::DescribeEventTopics::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeEventTopics {
                type Output = std::result::Result<crate::operation::describe_event_topics::DescribeEventTopicsOutput, crate::operation::describe_event_topics::DescribeEventTopicsError>;
