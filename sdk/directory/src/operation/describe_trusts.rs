...
impl DescribeTrustsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_trusts::DescribeTrusts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_trusts::ser_describe_trusts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrusts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_trusts::de_describe_trusts_http_response_with_props(status, headers, body)
        }
    }
}
