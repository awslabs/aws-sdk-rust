...
impl AcceptSharedDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`AcceptSharedDirectory`](crate::operation::accept_shared_directory::AcceptSharedDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::accept_shared_directory::AcceptSharedDirectory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::accept_shared_directory::AcceptSharedDirectoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::accept_shared_directory::AcceptSharedDirectory::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AcceptSharedDirectory {
                type Output = std::result::Result<crate::operation::accept_shared_directory::AcceptSharedDirectoryOutput, crate::operation::accept_shared_directory::AcceptSharedDirectoryError>;
