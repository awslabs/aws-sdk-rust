...
/// Orchestration and serialization glue logic for `AcceptSharedDirectory`.
...
impl AcceptSharedDirectory {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::accept_shared_directory::AcceptSharedDirectoryInput,
                    ) -> ::std::result::Result<crate::operation::accept_shared_directory::AcceptSharedDirectoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_shared_directory::AcceptSharedDirectoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_shared_directory::AcceptSharedDirectoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_shared_directory::AcceptSharedDirectoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptSharedDirectory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptSharedDirectory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptSharedDirectoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptSharedDirectoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptSharedDirectory")
...
.with_interceptor(AcceptSharedDirectoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_shared_directory::AcceptSharedDirectoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_shared_directory::AcceptSharedDirectoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_shared_directory::AcceptSharedDirectoryError>::new());
...
#[derive(Debug)]
            struct AcceptSharedDirectoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptSharedDirectoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_shared_directory::de_accept_shared_directory_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_accept_shared_directory::de_accept_shared_directory_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AcceptSharedDirectoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptSharedDirectoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_shared_directory::AcceptSharedDirectoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_shared_directory::AcceptSharedDirectoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_accept_shared_directory::ser_accept_shared_directory_input(&input)?);
...
#[derive(Debug)]
            struct AcceptSharedDirectoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptSharedDirectoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AcceptSharedDirectoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptSharedDirectoryInput>()
                        .ok_or("failed to downcast to AcceptSharedDirectoryInput")?;
...
pub enum AcceptSharedDirectoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptSharedDirectoryError) for what information is available for the error.")]
...
impl AcceptSharedDirectoryError {
    /// Creates the `AcceptSharedDirectoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptSharedDirectoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DirectoryAlreadySharedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptSharedDirectoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_shared_directory::AcceptSharedDirectoryError {
...
mod _accept_shared_directory_output;
