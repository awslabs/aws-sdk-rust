...
impl DescribeUpdateDirectoryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_update_directory::DescribeUpdateDirectoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_update_directory::DescribeUpdateDirectoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_update_directory::DescribeUpdateDirectoryOutput, crate::operation::describe_update_directory::DescribeUpdateDirectoryError, Self> {
