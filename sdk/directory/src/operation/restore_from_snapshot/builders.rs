...
impl RestoreFromSnapshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restore_from_snapshot::RestoreFromSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_from_snapshot::RestoreFromSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restore_from_snapshot::RestoreFromSnapshotOutput, crate::operation::restore_from_snapshot::RestoreFromSnapshotError, Self> {
