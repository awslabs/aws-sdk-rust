...
impl RemoveIpRoutesInput {
    /// Consumes the builder and constructs an Operation<[`RemoveIpRoutes`](crate::operation::remove_ip_routes::RemoveIpRoutes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_ip_routes::RemoveIpRoutes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_ip_routes::RemoveIpRoutesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_remove_ip_routes::ser_remove_ip_routes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_ip_routes::RemoveIpRoutes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveIpRoutes {
                type Output = std::result::Result<crate::operation::remove_ip_routes::RemoveIpRoutesOutput, crate::operation::remove_ip_routes::RemoveIpRoutesError>;
