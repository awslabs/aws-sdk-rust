...
impl RemoveIpRoutesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::remove_ip_routes::RemoveIpRoutes, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_ip_routes::ser_remove_ip_routes_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveIpRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_ip_routes::de_remove_ip_routes_http_response_with_props(status, headers, body)
        }
    }
}
