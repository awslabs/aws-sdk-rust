...
impl ListIpRoutesFluentBuilder  {
    /// Creates a new `ListIpRoutes`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_ip_routes::ListIpRoutesOutput, aws_smithy_http::result::SdkError<crate::operation::list_ip_routes::ListIpRoutesError>>
                     {
