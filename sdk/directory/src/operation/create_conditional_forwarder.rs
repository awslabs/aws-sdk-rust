...
impl CreateConditionalForwarderInput {
    /// Consumes the builder and constructs an Operation<[`CreateConditionalForwarder`](crate::operation::create_conditional_forwarder::CreateConditionalForwarder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_conditional_forwarder::CreateConditionalForwarder, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_conditional_forwarder::CreateConditionalForwarderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_conditional_forwarder::ser_create_conditional_forwarder_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_conditional_forwarder::CreateConditionalForwarder::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateConditionalForwarder {
                type Output = std::result::Result<crate::operation::create_conditional_forwarder::CreateConditionalForwarderOutput, crate::operation::create_conditional_forwarder::CreateConditionalForwarderError>;
