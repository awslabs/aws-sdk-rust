...
/// Orchestration and serialization glue logic for `CreateConditionalForwarder`.
...
impl CreateConditionalForwarder {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_conditional_forwarder::CreateConditionalForwarderInput,
                    ) -> ::std::result::Result<crate::operation::create_conditional_forwarder::CreateConditionalForwarderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_conditional_forwarder::CreateConditionalForwarderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_conditional_forwarder::CreateConditionalForwarderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_conditional_forwarder::CreateConditionalForwarderOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateConditionalForwarder {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateConditionalForwarder");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateConditionalForwarderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateConditionalForwarderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateConditionalForwarder")
...
.with_interceptor(CreateConditionalForwarderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_conditional_forwarder::CreateConditionalForwarderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_conditional_forwarder::CreateConditionalForwarderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_conditional_forwarder::CreateConditionalForwarderError>::new());
...
#[derive(Debug)]
            struct CreateConditionalForwarderResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateConditionalForwarderResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_conditional_forwarder::de_create_conditional_forwarder_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_conditional_forwarder::de_create_conditional_forwarder_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateConditionalForwarderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateConditionalForwarderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_conditional_forwarder::CreateConditionalForwarderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_conditional_forwarder::CreateConditionalForwarderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_conditional_forwarder::ser_create_conditional_forwarder_input(&input)?);
...
#[derive(Debug)]
            struct CreateConditionalForwarderEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateConditionalForwarderEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateConditionalForwarderEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateConditionalForwarderInput>()
                        .ok_or("failed to downcast to CreateConditionalForwarderInput")?;
...
pub enum CreateConditionalForwarderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateConditionalForwarderError) for what information is available for the error.")]
...
impl CreateConditionalForwarderError {
    /// Creates the `CreateConditionalForwarderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateConditionalForwarderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateConditionalForwarderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_conditional_forwarder::CreateConditionalForwarderError {
...
mod _create_conditional_forwarder_output;
