...
impl DeleteLogSubscriptionFluentBuilder  {
    /// Creates a new `DeleteLogSubscription`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_log_subscription::DeleteLogSubscriptionOutput, aws_smithy_http::result::SdkError<crate::operation::delete_log_subscription::DeleteLogSubscriptionError>>
                     {
