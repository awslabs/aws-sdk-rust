...
impl AddIpRoutesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_ip_routes::AddIpRoutes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddIpRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_add_ip_routes::de_add_ip_routes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_add_ip_routes::de_add_ip_routes_http_response_with_props(
                status, headers, body,
            )
        }
    }
