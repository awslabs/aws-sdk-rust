...
impl AddIpRoutesInput {
    /// Consumes the builder and constructs an Operation<[`AddIpRoutes`](crate::operation::add_ip_routes::AddIpRoutes)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_ip_routes::AddIpRoutes, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_ip_routes::ser_add_ip_routes_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_ip_routes::AddIpRoutes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddIpRoutes {
    type Output = ::std::result::Result<crate::operation::add_ip_routes::AddIpRoutesOutput, crate::operation::add_ip_routes::AddIpRoutesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_ip_routes::de_add_ip_routes_http_response_with_props(status, headers, body)
        }
    }
}
