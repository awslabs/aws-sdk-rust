...
impl GetDirectoryLimitsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_directory_limits::ser_get_directory_limits_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_directory_limits::GetDirectoryLimits::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_directory_limits::GetDirectoryLimitsError
{
