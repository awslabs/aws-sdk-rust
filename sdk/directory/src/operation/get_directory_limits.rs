...
impl GetDirectoryLimitsInput {
    /// Consumes the builder and constructs an Operation<[`GetDirectoryLimits`](crate::operation::get_directory_limits::GetDirectoryLimits)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_directory_limits::GetDirectoryLimits, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_directory_limits::GetDirectoryLimitsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_directory_limits::ser_get_directory_limits_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_directory_limits::GetDirectoryLimits::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDirectoryLimits {
                type Output = std::result::Result<crate::operation::get_directory_limits::GetDirectoryLimitsOutput, crate::operation::get_directory_limits::GetDirectoryLimitsError>;
