...
impl GetDirectoryLimitsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_directory_limits::GetDirectoryLimits,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_directory_limits::ser_get_directory_limits_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDirectoryLimits {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_directory_limits::de_get_directory_limits_http_response_with_props(status, headers, body)
        }
    }
}
