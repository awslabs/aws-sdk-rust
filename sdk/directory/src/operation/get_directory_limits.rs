...
/// Orchestration and serialization glue logic for `GetDirectoryLimits`.
...
impl GetDirectoryLimits {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_directory_limits::GetDirectoryLimitsInput,
                    ) -> ::std::result::Result<crate::operation::get_directory_limits::GetDirectoryLimitsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_directory_limits::GetDirectoryLimitsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_directory_limits::GetDirectoryLimitsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_directory_limits::GetDirectoryLimitsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDirectoryLimits {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDirectoryLimits");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDirectoryLimitsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDirectoryLimitsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDirectoryLimits")
...
.with_interceptor(GetDirectoryLimitsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_directory_limits::GetDirectoryLimitsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_directory_limits::GetDirectoryLimitsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_directory_limits::GetDirectoryLimitsError>::new());
...
#[derive(Debug)]
            struct GetDirectoryLimitsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDirectoryLimitsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_directory_limits::de_get_directory_limits_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_directory_limits::de_get_directory_limits_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDirectoryLimitsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDirectoryLimitsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_directory_limits::GetDirectoryLimitsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_directory_limits::GetDirectoryLimitsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_directory_limits::ser_get_directory_limits_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct GetDirectoryLimitsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDirectoryLimitsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDirectoryLimitsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDirectoryLimitsInput>()
                        .ok_or("failed to downcast to GetDirectoryLimitsInput")?;
...
pub enum GetDirectoryLimitsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDirectoryLimitsError) for what information is available for the error.")]
...
impl GetDirectoryLimitsError {
    /// Creates the `GetDirectoryLimitsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDirectoryLimitsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDirectoryLimitsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_directory_limits::GetDirectoryLimitsError {
...
mod _get_directory_limits_output;
