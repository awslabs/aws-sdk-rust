...
impl DescribeDirectoriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_directories::ser_describe_directories_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDirectories {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_directories::de_describe_directories_http_response_with_props(status, headers, body)
        }
    }
