...
impl DescribeDirectoriesInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_directories::ser_describe_directories_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_directories::DescribeDirectories::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_directories::DescribeDirectoriesError
{
