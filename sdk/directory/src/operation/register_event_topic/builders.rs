...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::register_event_topic::RegisterEventTopicOutput,
                    crate::operation::register_event_topic::RegisterEventTopicError,
                > for RegisterEventTopicFluentBuilder
            {
                fn send(
                    self,
...
impl RegisterEventTopicFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::register_event_topic::builders::RegisterEventTopicInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_event_topic::RegisterEventTopicOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_event_topic::RegisterEventTopicError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::register_event_topic::RegisterEventTopic::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::register_event_topic::RegisterEventTopic::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_event_topic::RegisterEventTopicOutput, crate::operation::register_event_topic::RegisterEventTopicError, Self> {
