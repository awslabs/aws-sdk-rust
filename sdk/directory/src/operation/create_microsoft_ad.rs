...
impl CreateMicrosoftAdInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_microsoft_ad::ser_create_microsoft_ad_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMicrosoftAD {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_microsoft_ad::de_create_microsoft_ad_http_response_with_props(status, headers, body)
        }
    }
}
