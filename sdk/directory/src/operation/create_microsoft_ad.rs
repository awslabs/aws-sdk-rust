...
impl CreateMicrosoftAD {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_microsoft_ad::CreateMicrosoftADError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_microsoft_ad::CreateMicrosoftAdOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Directory Service.CreateMicrosoftAD",
            "rpc.service" = "Directory Service",
            "rpc.method" = "CreateMicrosoftAD",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMicrosoftAD {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateMicrosoftADRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateMicrosoftADResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateMicrosoftAD")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateMicrosoftAD")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateMicrosoftADTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateMicrosoftADTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMicrosoftADTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateMicrosoftAdInput>() else {
        ...
        if requested.should_capture("ShortName") {
            if let ::std::option::Option::Some(value) = input.short_name.as_deref() {
                captured.insert("ShortName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateMicrosoftADResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_microsoft_ad::de_create_microsoft_ad_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_microsoft_ad::de_create_microsoft_ad_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMicrosoftADRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_microsoft_ad::CreateMicrosoftAdInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_microsoft_ad::CreateMicrosoftAdInput,
...
impl ::std::error::Error for CreateMicrosoftADError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::DirectoryLimitExceededException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateMicrosoftADError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DirectoryLimitExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
