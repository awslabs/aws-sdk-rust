...
impl EnableRadiusFluentBuilder  {
    /// Creates a new `EnableRadius`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::enable_radius::EnableRadiusOutput, aws_smithy_http::result::SdkError<crate::operation::enable_radius::EnableRadiusError>>
                     {
