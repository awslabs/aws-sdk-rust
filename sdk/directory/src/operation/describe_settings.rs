...
impl DescribeSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_settings::DescribeSettings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_settings::ser_describe_settings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_settings::de_describe_settings_http_response_with_props(status, headers, body)
        }
    }
}
