...
impl DescribeSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSettings`](crate::operation::describe_settings::DescribeSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_settings::DescribeSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_settings::DescribeSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_settings::ser_describe_settings_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_settings::DescribeSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSettings {
                type Output = std::result::Result<crate::operation::describe_settings::DescribeSettingsOutput, crate::operation::describe_settings::DescribeSettingsError>;
