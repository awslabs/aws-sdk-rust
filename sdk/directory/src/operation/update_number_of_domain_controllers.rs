...
impl UpdateNumberOfDomainControllers {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateNumberOfDomainControllers {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateNumberOfDomainControllers");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateNumberOfDomainControllersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateNumberOfDomainControllersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateNumberOfDomainControllers")
...
.with_interceptor(UpdateNumberOfDomainControllersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError>::new());
...
#[derive(Debug)]
            struct UpdateNumberOfDomainControllersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateNumberOfDomainControllersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_number_of_domain_controllers::de_update_number_of_domain_controllers_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_number_of_domain_controllers::de_update_number_of_domain_controllers_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateNumberOfDomainControllersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateNumberOfDomainControllersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_number_of_domain_controllers::ser_update_number_of_domain_controllers_input(&input)?);
...
#[derive(Debug)]
            struct UpdateNumberOfDomainControllersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateNumberOfDomainControllersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateNumberOfDomainControllersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateNumberOfDomainControllersInput>()
                        .ok_or("failed to downcast to UpdateNumberOfDomainControllersInput")?;
...
pub enum UpdateNumberOfDomainControllersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateNumberOfDomainControllersError) for what information is available for the error.")]
...
impl UpdateNumberOfDomainControllersError {
    /// Creates the `UpdateNumberOfDomainControllersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateNumberOfDomainControllersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DomainControllerLimitExceededException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateNumberOfDomainControllersError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateNumberOfDomainControllersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError {
...
mod _update_number_of_domain_controllers_output;
