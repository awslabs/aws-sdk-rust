...
impl UpdateNumberOfDomainControllersInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNumberOfDomainControllers`](crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_number_of_domain_controllers::ser_update_number_of_domain_controllers_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllers::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNumberOfDomainControllers {
                type Output = std::result::Result<crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersOutput, crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllersError>;
