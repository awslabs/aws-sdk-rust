...
impl UpdateNumberOfDomainControllersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllers,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_number_of_domain_controllers::UpdateNumberOfDomainControllers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNumberOfDomainControllers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_number_of_domain_controllers::de_update_number_of_domain_controllers_http_response_with_props(
                status, headers, body,
            )
        }
    }
