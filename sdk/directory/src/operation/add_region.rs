...
impl AddRegionInput {
    /// Consumes the builder and constructs an Operation<[`AddRegion`](crate::operation::add_region::AddRegion)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::add_region::AddRegion, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_region::ser_add_region_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_region::AddRegion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddRegion {
    type Output = ::std::result::Result<crate::operation::add_region::AddRegionOutput, crate::operation::add_region::AddRegionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_region::de_add_region_http_response_with_props(status, headers, body)
        }
    }
}
