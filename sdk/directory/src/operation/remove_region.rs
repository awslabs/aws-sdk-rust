...
impl RemoveRegionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_region::RemoveRegion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveRegion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_remove_region::de_remove_region_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_remove_region::de_remove_region_http_response_with_props(
                status, headers, body,
            )
        }
    }
