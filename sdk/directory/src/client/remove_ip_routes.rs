...
impl super::Client {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::remove_ip_routes::builders::RemoveIpRoutesFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::remove_ip_routes::builders::RemoveIpRoutesFluentBuilder::set_directory_id): <p>Identifier (ID) of the directory from which you want to remove the IP addresses.</p>
