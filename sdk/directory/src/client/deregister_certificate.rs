...
impl super::Client {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::deregister_certificate::builders::DeregisterCertificateFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::deregister_certificate::builders::DeregisterCertificateFluentBuilder::set_directory_id): <p>The identifier of the directory.</p>
