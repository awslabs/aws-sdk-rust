...
impl super::Client {
    ...
    pub fn cancel_schema_extension(
        &self,
    ) -> crate::operation::cancel_schema_extension::builders::CancelSchemaExtensionFluentBuilder
    {
        crate::operation::cancel_schema_extension::builders::CancelSchemaExtensionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
