...
impl super::Client {
    ...
    ///   - [`settings(Setting)`](crate::operation::update_settings::builders::UpdateSettingsFluentBuilder::settings) / [`set_settings(Option<Vec<Setting>>)`](crate::operation::update_settings::builders::UpdateSettingsFluentBuilder::set_settings): <p>The list of <code>Setting</code> objects.</p>
