...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::set_name): <p>The fully qualified name for the directory, such as <code>corp.example.com</code>.</p>
    ///   - [`short_name(impl Into<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::short_name) / [`set_short_name(Option<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::set_short_name): <p>The NetBIOS name of the directory, such as <code>CORP</code>.</p>
    ///   - [`password(impl Into<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::password) / [`set_password(Option<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::set_password): <p>The password for the directory administrator. The directory creation process creates a directory administrator account with the user name <code>Administrator</code> and this password.</p>  <p>If you need to change the password for the administrator account, you can use the <code>ResetUserPassword</code> API call.</p>  <p>The regex pattern for this string is made up of the following conditions:</p>  <ul>   <li> <p>Length (?=^.{8,64}$) – Must be between 8 and 64 characters</p> </li>  </ul>  <p>AND any 3 of the following password complexity rules required by Active Directory:</p>  <ul>   <li> <p>Numbers and upper case and lowercase (?=.*\d)(?=.*[A-Z])(?=.*[a-z])</p> </li>   <li> <p>Numbers and special characters and lower case (?=.*\d)(?=.*[^A-Za-z0-9\s])(?=.*[a-z])</p> </li>   <li> <p>Special characters and upper case and lower case (?=.*[^A-Za-z0-9\s])(?=.*[A-Z])(?=.*[a-z])</p> </li>   <li> <p>Numbers and upper case and special characters (?=.*\d)(?=.*[A-Z])(?=.*[^A-Za-z0-9\s])</p> </li>  </ul>  <p>For additional information about how Active Directory passwords are enforced, see <a href="https://docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/password-must-meet-complexity-requirements">Password must meet complexity requirements</a> on the Microsoft website.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::set_description): <p>A description for the directory.</p>
