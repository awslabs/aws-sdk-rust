...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::list_ip_routes::builders::ListIpRoutesFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::list_ip_routes::builders::ListIpRoutesFluentBuilder::set_directory_id):<br>required: **true**<br><p>Identifier (ID) of the directory for which you want to retrieve the IP addresses.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_ip_routes::builders::ListIpRoutesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_ip_routes::builders::ListIpRoutesFluentBuilder::set_next_token):<br>required: **false**<br><p>The <i>ListIpRoutes.NextToken</i> value from a previous call to <code>ListIpRoutes</code>. Pass null if this is the first call.</p><br>
    ///   - [`limit(i32)`](crate::operation::list_ip_routes::builders::ListIpRoutesFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_ip_routes::builders::ListIpRoutesFluentBuilder::set_limit):<br>required: **false**<br><p>Maximum number of items to return. If this value is zero, the maximum number of items is specified by the limitations of the operation.</p><br>
