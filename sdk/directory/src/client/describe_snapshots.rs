...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::set_directory_id):<br>required: **false**<br><p>The identifier of the directory for which to retrieve snapshot information.</p><br>
    ///   - [`snapshot_ids(impl Into<String>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::snapshot_ids) / [`set_snapshot_ids(Option<Vec::<String>>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::set_snapshot_ids):<br>required: **false**<br><p>A list of identifiers of the snapshots to obtain the information for. If this member is null or empty, all snapshots are returned using the <i>Limit</i> and <i>NextToken</i> members.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::set_next_token):<br>required: **false**<br><p>The <i>DescribeSnapshotsResult.NextToken</i> value from a previous call to <code>DescribeSnapshots</code>. Pass null if this is the first call.</p><br>
    ///   - [`limit(i32)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of objects to return.</p><br>
