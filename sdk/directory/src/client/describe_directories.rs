...
impl super::Client {
    ...
    ///   - [`directory_descriptions(Option<Vec::<DirectoryDescription>>)`](crate::operation::describe_directories::DescribeDirectoriesOutput::directory_descriptions): <p>The list of available <code>DirectoryDescription</code> objects that were retrieved.</p> <p>It is possible that this list contains less than the number of items specified in the <code>Limit</code> member of the request. This occurs if there are less than the requested number of items left to retrieve, or if the limitations of the operation have been exceeded.</p>
