...
impl super::Client {
    ...
    ///   - [`resource_id(impl Into<String>)`](crate::operation::remove_tags_from_resource::builders::RemoveTagsFromResourceFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::remove_tags_from_resource::builders::RemoveTagsFromResourceFluentBuilder::set_resource_id):<br>required: **true**<br><p>Identifier (ID) of the directory from which to remove the tag.</p><br>
