...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::set_name): <p>The fully qualified domain name for the Managed Microsoft AD directory, such as <code>corp.example.com</code>. This name will resolve inside your VPC only. It does not need to be publicly resolvable.</p>
    ///   - [`short_name(impl Into<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::short_name) / [`set_short_name(Option<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::set_short_name): <p>The NetBIOS name for your domain, such as <code>CORP</code>. If you don't specify a NetBIOS name, it will default to the first part of your directory DNS. For example, <code>CORP</code> for the directory DNS <code>corp.example.com</code>. </p>
    ///   - [`password(impl Into<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::password) / [`set_password(Option<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::set_password): <p>The password for the default administrative user named <code>Admin</code>.</p>  <p>If you need to change the password for the administrator account, you can use the <code>ResetUserPassword</code> API call.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_microsoft_ad::builders::CreateMicrosoftADFluentBuilder::set_description): <p>A description for the directory. This label will appear on the Amazon Web Services console <code>Directory Details</code> page after the directory is created.</p>
