...
impl super::Client {
    ...
    ///   - [`trust_id(impl Into<String>)`](crate::operation::delete_trust::builders::DeleteTrustFluentBuilder::trust_id) / [`set_trust_id(Option<String>)`](crate::operation::delete_trust::builders::DeleteTrustFluentBuilder::set_trust_id):<br>required: **true**<br><p>The Trust ID of the trust relationship to be deleted.</p><br>
    ///   - [`delete_associated_conditional_forwarder(bool)`](crate::operation::delete_trust::builders::DeleteTrustFluentBuilder::delete_associated_conditional_forwarder) / [`set_delete_associated_conditional_forwarder(Option<bool>)`](crate::operation::delete_trust::builders::DeleteTrustFluentBuilder::set_delete_associated_conditional_forwarder):<br>required: **false**<br><p>Delete a conditional forwarder as part of a DeleteTrustRequest.</p><br>
