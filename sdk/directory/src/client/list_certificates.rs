...
impl super::Client {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::list_certificates::builders::ListCertificatesFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::list_certificates::builders::ListCertificatesFluentBuilder::set_directory_id): <p>The identifier of the directory.</p>
