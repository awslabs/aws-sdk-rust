...
impl super::Client {
    ...
    ///   - [`snapshot_id(impl Into<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::set_snapshot_id):<br>required: **true**<br><p>The identifier of the directory snapshot to be deleted.</p><br>
