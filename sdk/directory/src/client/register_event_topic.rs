...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::register_event_topic::builders::RegisterEventTopicFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::register_event_topic::builders::RegisterEventTopicFluentBuilder::set_directory_id):<br>required: **true**<br><p>The Directory ID that will publish status messages to the Amazon SNS topic.</p><br>
    ///   - [`topic_name(impl Into<String>)`](crate::operation::register_event_topic::builders::RegisterEventTopicFluentBuilder::topic_name) / [`set_topic_name(Option<String>)`](crate::operation::register_event_topic::builders::RegisterEventTopicFluentBuilder::set_topic_name):<br>required: **true**<br><p>The Amazon SNS topic name to which the directory will publish status messages. This Amazon SNS topic must be in the same region as the specified Directory ID.</p><br>
