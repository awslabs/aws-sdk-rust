...
impl super::Client {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::set_directory_id): <p>The identifier of the directory.</p>
    ///   - [`region_name(impl ::std::convert::Into<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::region_name) / [`set_region_name(Option<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::set_region_name): <p>The name of the Region. For example, <code>us-east-1</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::set_next_token): <p>The <code>DescribeRegionsResult.NextToken</code> value from a previous call to <code>DescribeRegions</code>. Pass null if this is the first call.</p>
