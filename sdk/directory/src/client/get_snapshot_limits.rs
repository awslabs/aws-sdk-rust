...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::get_snapshot_limits::builders::GetSnapshotLimitsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::get_snapshot_limits::builders::GetSnapshotLimitsFluentBuilder::set_directory_id):<br>required: **true**<br><p>Contains the identifier of the directory to obtain the limits for.</p><br>
