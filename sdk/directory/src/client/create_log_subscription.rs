...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::create_log_subscription::builders::CreateLogSubscriptionFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::create_log_subscription::builders::CreateLogSubscriptionFluentBuilder::set_directory_id):<br>required: **true**<br><p>Identifier of the directory to which you want to subscribe and receive real-time logs to your specified CloudWatch log group.</p><br>
    ///   - [`log_group_name(impl Into<String>)`](crate::operation::create_log_subscription::builders::CreateLogSubscriptionFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::create_log_subscription::builders::CreateLogSubscriptionFluentBuilder::set_log_group_name):<br>required: **true**<br><p>The name of the CloudWatch log group where the real-time domain controller logs are forwarded.</p><br>
