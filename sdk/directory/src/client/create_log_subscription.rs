...
impl super::Client {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::create_log_subscription::builders::CreateLogSubscriptionFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::create_log_subscription::builders::CreateLogSubscriptionFluentBuilder::set_directory_id): <p>Identifier of the directory to which you want to subscribe and receive real-time logs to your specified CloudWatch log group.</p>
