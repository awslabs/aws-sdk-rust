...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::set_directory_id):<br>required: **true**<br><p>The identifier of the directory for which to retrieve information.</p><br>
    ///   - [`r#type(ClientAuthenticationType)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::type) / [`set_type(Option<ClientAuthenticationType>)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::set_type):<br>required: **false**<br><p>The type of client authentication for which to retrieve information. If no type is specified, a list of all client authentication types that are supported for the specified directory is retrieved.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::set_next_token):<br>required: **false**<br><p>The <i>DescribeClientAuthenticationSettingsResult.NextToken</i> value from a previous call to <code>DescribeClientAuthenticationSettings</code>. Pass null if this is the first call.</p><br>
    ///   - [`limit(i32)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_client_authentication_settings::builders::DescribeClientAuthenticationSettingsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of items to return. If this value is zero, the maximum number of items is specified by the limitations of the operation.</p><br>
