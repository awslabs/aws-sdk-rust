...
impl super::Client {
    ...
    ///   - [`shared_directory_ids(impl Into<String>)`](crate::operation::describe_shared_directories::builders::DescribeSharedDirectoriesFluentBuilder::shared_directory_ids) / [`set_shared_directory_ids(Option<Vec<String>>)`](crate::operation::describe_shared_directories::builders::DescribeSharedDirectoriesFluentBuilder::set_shared_directory_ids): <p>A list of identifiers of all shared directories in your account. </p>
