...
impl super::Client {
    ...
    ///   - [`trust_id(impl Into<String>)`](crate::operation::verify_trust::builders::VerifyTrustFluentBuilder::trust_id) / [`set_trust_id(Option<String>)`](crate::operation::verify_trust::builders::VerifyTrustFluentBuilder::set_trust_id):<br>required: **true**<br><p>The unique Trust ID of the trust relationship to verify.</p><br>
