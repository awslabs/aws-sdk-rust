...
impl super::Client {
    ...
    ///   - [`snapshot_id(impl Into<String>)`](crate::operation::restore_from_snapshot::builders::RestoreFromSnapshotFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::restore_from_snapshot::builders::RestoreFromSnapshotFluentBuilder::set_snapshot_id):<br>required: **true**<br><p>The identifier of the snapshot to restore from.</p><br>
