...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::describe_conditional_forwarders::builders::DescribeConditionalForwardersFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_conditional_forwarders::builders::DescribeConditionalForwardersFluentBuilder::set_directory_id):<br>required: **true**<br><p>The directory ID for which to get the list of associated conditional forwarders.</p><br>
    ///   - [`remote_domain_names(impl Into<String>)`](crate::operation::describe_conditional_forwarders::builders::DescribeConditionalForwardersFluentBuilder::remote_domain_names) / [`set_remote_domain_names(Option<Vec::<String>>)`](crate::operation::describe_conditional_forwarders::builders::DescribeConditionalForwardersFluentBuilder::set_remote_domain_names):<br>required: **false**<br><p>The fully qualified domain names (FQDN) of the remote domains for which to get the list of associated conditional forwarders. If this member is null, all conditional forwarders are returned.</p><br>
