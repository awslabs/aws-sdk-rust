...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::list_log_subscriptions::builders::ListLogSubscriptionsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::list_log_subscriptions::builders::ListLogSubscriptionsFluentBuilder::set_directory_id):<br>required: **false**<br><p>If a <i>DirectoryID</i> is provided, lists only the log subscription associated with that directory. If no <i>DirectoryId</i> is provided, lists all log subscriptions associated with your Amazon Web Services account. If there are no log subscriptions for the Amazon Web Services account or the directory, an empty list will be returned.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_log_subscriptions::builders::ListLogSubscriptionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_log_subscriptions::builders::ListLogSubscriptionsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of items to return.</p><br>
    ///   - [`limit(i32)`](crate::operation::list_log_subscriptions::builders::ListLogSubscriptionsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_log_subscriptions::builders::ListLogSubscriptionsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of items returned.</p><br>
