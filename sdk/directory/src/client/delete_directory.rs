...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::delete_directory::builders::DeleteDirectoryFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::delete_directory::builders::DeleteDirectoryFluentBuilder::set_directory_id):<br>required: **true**<br><p>The identifier of the directory to delete.</p><br>
