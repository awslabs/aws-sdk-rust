...
impl super::Client {
    ...
    ///   - [`directory_id(impl Into<String>)`](crate::operation::describe_settings::builders::DescribeSettingsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_settings::builders::DescribeSettingsFluentBuilder::set_directory_id):<br>required: **true**<br><p>The identifier of the directory for which to retrieve information.</p><br>
    ///   - [`status(DirectoryConfigurationStatus)`](crate::operation::describe_settings::builders::DescribeSettingsFluentBuilder::status) / [`set_status(Option<DirectoryConfigurationStatus>)`](crate::operation::describe_settings::builders::DescribeSettingsFluentBuilder::set_status):<br>required: **false**<br><p>The status of the directory settings for which to retrieve information.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_settings::builders::DescribeSettingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_settings::builders::DescribeSettingsFluentBuilder::set_next_token):<br>required: **false**<br><p>The <code>DescribeSettingsResult.NextToken</code> value from a previous call to <code>DescribeSettings</code>. Pass null if this is the first call.</p><br>
