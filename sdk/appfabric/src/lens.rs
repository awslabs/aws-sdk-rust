...
pub(crate) fn reflens_list_app_authorizations_output_output_next_token(
...
pub(crate) fn reflens_list_app_bundles_output_output_next_token(
...
pub(crate) fn reflens_list_ingestion_destinations_output_output_next_token(
...
pub(crate) fn lens_list_app_authorizations_output_output_app_authorization_summary_list(
    input: crate::operation::list_app_authorizations::ListAppAuthorizationsOutput,
...
pub(crate) fn lens_list_app_bundles_output_output_app_bundle_summary_list(
    input: crate::operation::list_app_bundles::ListAppBundlesOutput,
...
pub(crate) fn lens_list_ingestion_destinations_output_output_ingestion_destinations(
    input: crate::operation::list_ingestion_destinations::ListIngestionDestinationsOutput,
