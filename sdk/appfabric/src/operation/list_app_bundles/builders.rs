...
impl ListAppBundlesFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_app_bundles::builders::ListAppBundlesInputBuilder {
        &self.inner
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_app_bundles::paginator::ListAppBundlesPaginator::send) which returns a `Stream`.
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_app_bundles::paginator::ListAppBundlesPaginator {
        crate::operation::list_app_bundles::paginator::ListAppBundlesPaginator::new(
            self.handle,
            self.inner,
        )
    }
