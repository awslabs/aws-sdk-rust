...
impl crate::operation::create_ingestion_destination::builders::CreateIngestionDestinationInputBuilder {
...
impl CreateIngestionDestinationFluentBuilder {
    /// Creates a new `CreateIngestionDestinationFluentBuilder`.
