...
impl ListIngestionDestinationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_ingestion_destinations::ListIngestionDestinationsInput, ::aws_smithy_types::error::operation::BuildError> {
