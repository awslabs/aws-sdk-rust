...
impl UpdateAppAuthorizationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_app_authorization::UpdateAppAuthorizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_app_authorization::UpdateAppAuthorizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_app_authorization::UpdateAppAuthorizationOutput, crate::operation::update_app_authorization::UpdateAppAuthorizationError, Self> {
