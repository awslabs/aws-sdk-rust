...
impl CreateIngestionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_ingestion::ser_create_ingestion_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_ingestion::CreateIngestion::new(),
        )
...
/// `ParseStrictResponse` impl for `CreateIngestion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIngestion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_ingestion::de_create_ingestion_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_ingestion::CreateIngestionError
{
