...
impl crate::operation::update_ingestion_destination::builders::UpdateIngestionDestinationInputBuilder {
...
impl UpdateIngestionDestinationFluentBuilder {
    /// Creates a new `UpdateIngestionDestinationFluentBuilder`.
