...
pub use crate::operation::delete_ingestion_destination::_delete_ingestion_destination_output::DeleteIngestionDestinationOutputBuilder;

pub use crate::operation::delete_ingestion_destination::_delete_ingestion_destination_input::DeleteIngestionDestinationInputBuilder;
...
impl DeleteIngestionDestinationInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_ingestion_destination();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
}
/// Fluent builder constructing a request to `DeleteIngestionDestination`.
/// 
/// <p>Deletes an ingestion destination.</p>
/// <p>This deletes the association between an ingestion and it's destination. It doesn't delete previously ingested data or the storage destination, such as the Amazon S3 bucket where the data is delivered. If the ingestion destination is deleted while the associated ingestion is enabled, the ingestion will fail and is eventually disabled.</p>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_ingestion_destination::DeleteIngestionDestinationOutput,
                    crate::operation::delete_ingestion_destination::DeleteIngestionDestinationError,
                > for DeleteIngestionDestinationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteIngestionDestinationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_ingestion_destination::DeleteIngestionDestinationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_ingestion_destination::DeleteIngestionDestinationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_ingestion_destination::DeleteIngestionDestination::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_ingestion_destination::DeleteIngestionDestination::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_ingestion_destination::DeleteIngestionDestinationOutput, crate::operation::delete_ingestion_destination::DeleteIngestionDestinationError, Self> {
