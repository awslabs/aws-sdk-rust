...
impl Builder {
    ...
    /// use aws_sdk_appfabric::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    ///
    /// ```no_run
    /// use aws_sdk_appfabric::config::{AsyncSleep, Sleep, Config};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_appfabric::config::{AsyncSleep, Sleep, Builder, Config};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
