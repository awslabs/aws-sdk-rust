...
impl super::Client {
    ...
    ///   - [`ingestion_identifier(impl Into<String>)`](crate::operation::start_ingestion::builders::StartIngestionFluentBuilder::ingestion_identifier) / [`set_ingestion_identifier(Option<String>)`](crate::operation::start_ingestion::builders::StartIngestionFluentBuilder::set_ingestion_identifier): <p>The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the ingestion to use for the request.</p>
