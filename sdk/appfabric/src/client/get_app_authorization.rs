...
impl super::Client {
    ...
    ///   - [`app_authorization_identifier(impl Into<String>)`](crate::operation::get_app_authorization::builders::GetAppAuthorizationFluentBuilder::app_authorization_identifier) / [`set_app_authorization_identifier(Option<String>)`](crate::operation::get_app_authorization::builders::GetAppAuthorizationFluentBuilder::set_app_authorization_identifier): <p>The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the app authorization to use for the request.</p>
