...
pub fn ser_create_ingestion_destination_input(
    ...
    crate::protocol_serde::shape_create_ingestion_destination_input::ser_create_ingestion_destination_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_http::body::SdkBody::from(out))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_create_ingestion_destination_http_error(
...
> {
    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::create_ingestion_destination::CreateIngestionDestinationError::unhandled(
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_ingestion_destination::CreateIngestionDestinationError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_ingestion_destination_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_create_ingestion_destination(
    value: &[u8],
