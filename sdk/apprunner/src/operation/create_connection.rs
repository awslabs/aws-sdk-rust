...
impl CreateConnectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_connection::CreateConnection, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_connection::ser_create_connection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_connection::de_create_connection_http_response_with_props(status, headers, body)
        }
    }
}
