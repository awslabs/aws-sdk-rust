...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcIngressConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_ingress_connection::de_delete_vpc_ingress_connection_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_vpc_ingress_connection::DeleteVpcIngressConnectionError
{
