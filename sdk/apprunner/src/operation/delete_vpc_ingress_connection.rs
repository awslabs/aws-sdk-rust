...
impl DeleteVpcIngressConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_vpc_ingress_connection::DeleteVpcIngressConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcIngressConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_ingress_connection::de_delete_vpc_ingress_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
