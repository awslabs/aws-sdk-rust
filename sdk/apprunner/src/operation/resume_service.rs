...
impl ResumeServiceInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resume_service::ResumeService::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ResumeService {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resume_service::de_resume_service_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_resume_service::de_resume_service_http_response_with_props(
                status, headers, body,
            )
        }
    }
