...
impl ResumeServiceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::resume_service::ResumeService, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resume_service::ser_resume_service_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeService {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resume_service::de_resume_service_http_response_with_props(status, headers, body)
        }
    }
