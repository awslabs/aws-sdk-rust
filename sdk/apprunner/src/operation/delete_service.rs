...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteService {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_service::de_delete_service_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_service::de_delete_service_http_response_with_props(
                status, headers, body,
            )
        }
    }
