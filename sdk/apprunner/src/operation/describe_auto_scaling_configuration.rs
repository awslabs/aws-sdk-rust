...
impl DescribeAutoScalingConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_auto_scaling_configuration::DescribeAutoScalingConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAutoScalingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_auto_scaling_configuration::de_describe_auto_scaling_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
