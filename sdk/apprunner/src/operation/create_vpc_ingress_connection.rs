...
impl CreateVpcIngressConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_vpc_ingress_connection::CreateVpcIngressConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcIngressConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vpc_ingress_connection::de_create_vpc_ingress_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
