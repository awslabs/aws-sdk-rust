...
impl DescribeObservabilityConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_observability_configuration::DescribeObservabilityConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_observability_configuration::DescribeObservabilityConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeObservabilityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_observability_configuration::de_describe_observability_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
