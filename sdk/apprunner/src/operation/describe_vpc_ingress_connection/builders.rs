...
impl crate::operation::describe_vpc_ingress_connection::builders::DescribeVpcIngressConnectionInputBuilder {
...
impl DescribeVpcIngressConnectionFluentBuilder {
    /// Creates a new `DescribeVpcIngressConnectionFluentBuilder`.
