...
impl ListAutoScalingConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_auto_scaling_configurations::ListAutoScalingConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAutoScalingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_auto_scaling_configurations::de_list_auto_scaling_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
