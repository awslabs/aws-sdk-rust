...
impl crate::operation::create_auto_scaling_configuration::builders::CreateAutoScalingConfigurationInputBuilder {
...
impl CreateAutoScalingConfigurationFluentBuilder {
    /// Creates a new `CreateAutoScalingConfigurationFluentBuilder`.
