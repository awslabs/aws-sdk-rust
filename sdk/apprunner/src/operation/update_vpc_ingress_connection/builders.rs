...
impl UpdateVpcIngressConnectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_vpc_ingress_connection::UpdateVpcIngressConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_vpc_ingress_connection::UpdateVpcIngressConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_vpc_ingress_connection::UpdateVpcIngressConnectionOutput, crate::operation::update_vpc_ingress_connection::UpdateVpcIngressConnectionError, Self> {
