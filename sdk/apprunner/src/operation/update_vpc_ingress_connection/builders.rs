...
impl crate::operation::update_vpc_ingress_connection::builders::UpdateVpcIngressConnectionInputBuilder {
...
impl UpdateVpcIngressConnectionFluentBuilder {
    /// Creates a new `UpdateVpcIngressConnectionFluentBuilder`.
