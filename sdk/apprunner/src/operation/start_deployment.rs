...
impl StartDeploymentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_deployment::StartDeployment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_deployment::ser_start_deployment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDeployment {
    type Output =
        ::std::result::Result<crate::operation::start_deployment::StartDeploymentOutput, crate::operation::start_deployment::StartDeploymentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_deployment::de_start_deployment_http_response_with_props(status, headers, body)
        }
    }
}
