...
impl StartDeploymentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_deployment::StartDeployment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_deployment::de_start_deployment_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_deployment::StartDeploymentError
{
