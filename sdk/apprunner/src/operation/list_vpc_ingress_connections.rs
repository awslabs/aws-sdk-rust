...
impl ListVpcIngressConnectionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_vpc_ingress_connections::ListVpcIngressConnections,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_vpc_ingress_connections::ListVpcIngressConnections::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVpcIngressConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_vpc_ingress_connections::de_list_vpc_ingress_connections_http_response_with_props(status, headers, body)
        }
    }
}
