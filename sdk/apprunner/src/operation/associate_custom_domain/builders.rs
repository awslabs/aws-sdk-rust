...
impl AssociateCustomDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_custom_domain::AssociateCustomDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_custom_domain::AssociateCustomDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_custom_domain::AssociateCustomDomainOutput, crate::operation::associate_custom_domain::AssociateCustomDomainError, Self> {
