...
impl DeleteObservabilityConfigurationInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::delete_observability_configuration::DeleteObservabilityConfigurationInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
