...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVpcIngressConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_vpc_ingress_connection::de_update_vpc_ingress_connection_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_vpc_ingress_connection::UpdateVpcIngressConnectionError
{
