...
impl DescribeObservabilityConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_observability_configuration::DescribeObservabilityConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_observability_configuration::DescribeObservabilityConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_observability_configuration::DescribeObservabilityConfigurationOutput, crate::operation::describe_observability_configuration::DescribeObservabilityConfigurationError, Self> {
