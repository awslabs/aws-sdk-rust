...
impl DeleteVpcConnectorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_vpc_connector::DeleteVpcConnector,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_vpc_connector::ser_delete_vpc_connector_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcConnector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_connector::de_delete_vpc_connector_http_response_with_props(status, headers, body)
        }
    }
}
