...
impl DeleteVpcConnectorFluentBuilder  {
    /// Creates a new `DeleteVpcConnector`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_vpc_connector::DeleteVpcConnectorOutput, aws_smithy_http::result::SdkError<crate::operation::delete_vpc_connector::DeleteVpcConnectorError>>
                     {
