...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAutoScalingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_auto_scaling_configuration::de_create_auto_scaling_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateAutoScalingConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_auto_scaling_configuration::CreateAutoScalingConfigurationError
{
