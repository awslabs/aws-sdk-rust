...
impl DescribeVpcIngressConnectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_vpc_ingress_connection::DescribeVpcIngressConnection,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_vpc_ingress_connection::DescribeVpcIngressConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVpcIngressConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vpc_ingress_connection::de_describe_vpc_ingress_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
