...
impl PauseServiceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::pause_service::PauseService, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_pause_service::ser_pause_service_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PauseService {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_pause_service::de_pause_service_http_response_with_props(status, headers, body)
        }
    }
