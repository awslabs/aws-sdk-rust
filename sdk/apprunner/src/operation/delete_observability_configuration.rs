...
impl DeleteObservabilityConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_observability_configuration::DeleteObservabilityConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteObservabilityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_observability_configuration::de_delete_observability_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
