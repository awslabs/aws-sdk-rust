...
impl crate::operation::delete_vpc_ingress_connection::builders::DeleteVpcIngressConnectionInputBuilder {
...
impl DeleteVpcIngressConnectionFluentBuilder {
    /// Creates a new `DeleteVpcIngressConnectionFluentBuilder`.
