...
impl DeleteVpcIngressConnectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_vpc_ingress_connection::DeleteVpcIngressConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_vpc_ingress_connection::DeleteVpcIngressConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_vpc_ingress_connection::DeleteVpcIngressConnectionOutput, crate::operation::delete_vpc_ingress_connection::DeleteVpcIngressConnectionError, Self> {
