...
pub struct ListVpcConnectorsOutput  {
    ...
    #[doc(hidden)]pub vpc_connectors: std::option::Option<std::vec::Vec<crate::model::VpcConnector>>,
...
pub struct ListServicesOutput  {
    ...
    #[doc(hidden)]pub service_summary_list: std::option::Option<std::vec::Vec<crate::model::ServiceSummary>>,
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListOperationsOutput  {
    ...
    #[doc(hidden)]pub operation_summary_list: std::option::Option<std::vec::Vec<crate::model::OperationSummary>>,
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListObservabilityConfigurationsOutput  {
    ...
    #[doc(hidden)]pub observability_configuration_summary_list: std::option::Option<std::vec::Vec<crate::model::ObservabilityConfigurationSummary>>,
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListObservabilityConfigurationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("observability_configuration_summary_list", &self.observability_configuration_summary_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListConnectionsOutput  {
    ...
    #[doc(hidden)]pub connection_summary_list: std::option::Option<std::vec::Vec<crate::model::ConnectionSummary>>,
...
pub struct ListAutoScalingConfigurationsOutput  {
    ...
    #[doc(hidden)]pub auto_scaling_configuration_summary_list: std::option::Option<std::vec::Vec<crate::model::AutoScalingConfigurationSummary>>,
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListAutoScalingConfigurationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("auto_scaling_configuration_summary_list", &self.auto_scaling_configuration_summary_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct DisassociateCustomDomainOutput  {
    ...
    #[doc(hidden)]pub dns_target: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub custom_domain: std::option::Option<crate::model::CustomDomain>,
}
...
pub struct DescribeVpcConnectorOutput  {
    ...
    #[doc(hidden)]pub vpc_connector: std::option::Option<crate::model::VpcConnector>,
}
...
pub struct DescribeObservabilityConfigurationOutput  {
    ...
    #[doc(hidden)]pub observability_configuration: std::option::Option<crate::model::ObservabilityConfiguration>,
}
...
pub struct DescribeCustomDomainsOutput  {
    ...
    #[doc(hidden)]pub custom_domains: std::option::Option<std::vec::Vec<crate::model::CustomDomain>>,
    /// <p>The token that you can pass in a subsequent request to get the next result page. It's returned in a paginated request.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeAutoScalingConfigurationOutput  {
    ...
    #[doc(hidden)]pub auto_scaling_configuration: std::option::Option<crate::model::AutoScalingConfiguration>,
}
...
impl  std::fmt::Debug for DescribeAutoScalingConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("auto_scaling_configuration", &self.auto_scaling_configuration);
        formatter.finish()
    }
}
...
pub struct DeleteConnectionOutput  {
    ...
    #[doc(hidden)]pub connection: std::option::Option<crate::model::Connection>,
}
