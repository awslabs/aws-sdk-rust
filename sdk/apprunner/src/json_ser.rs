...
pub fn serialize_structure_associate_custom_domain_input(
...
pub fn serialize_structure_create_auto_scaling_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_service_input(
    ...
    if let Some(var_19) = &input.source_configuration {
        ...
        crate::json_ser::serialize_structure_source_configuration(&mut object_20, var_19);
        object_20.finish();
    }
    if let Some(var_21) = &input.instance_configuration {
        let mut object_22 = object.key("InstanceConfiguration").start_object();
        crate::json_ser::serialize_structure_instance_configuration(&mut object_22, var_21);
        object_22.finish();
    }
    ...
    if let Some(var_27) = &input.encryption_configuration {
        ...
        crate::json_ser::serialize_structure_encryption_configuration(&mut object_28, var_27);
        object_28.finish();
    }
    if let Some(var_29) = &input.health_check_configuration {
        let mut object_30 = object.key("HealthCheckConfiguration").start_object();
        crate::json_ser::serialize_structure_health_check_configuration(&mut object_30, var_29);
        object_30.finish();
    }
...
pub fn serialize_structure_delete_auto_scaling_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_auto_scaling_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_custom_domains_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_service_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_custom_domain_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_auto_scaling_configurations_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_pause_service_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_resume_service_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_service_input(
    ...
    if let Some(var_67) = &input.source_configuration {
        ...
        crate::json_ser::serialize_structure_source_configuration(&mut object_68, var_67);
        object_68.finish();
    }
    if let Some(var_69) = &input.instance_configuration {
        let mut object_70 = object.key("InstanceConfiguration").start_object();
        crate::json_ser::serialize_structure_instance_configuration(&mut object_70, var_69);
        object_70.finish();
    }
    ...
    if let Some(var_72) = &input.health_check_configuration {
        ...
        crate::json_ser::serialize_structure_health_check_configuration(&mut object_73, var_72);
        object_73.finish();
    }
}
...
pub fn serialize_structure_source_configuration(
    ...
    if let Some(var_76) = &input.code_repository {
        ...
        crate::json_ser::serialize_structure_code_repository(&mut object_77, var_76);
        object_77.finish();
    }
    if let Some(var_78) = &input.image_repository {
        let mut object_79 = object.key("ImageRepository").start_object();
        crate::json_ser::serialize_structure_image_repository(&mut object_79, var_78);
        object_79.finish();
    }
    ...
    if let Some(var_81) = &input.authentication_configuration {
        ...
        crate::json_ser::serialize_structure_authentication_configuration(&mut object_82, var_81);
        object_82.finish();
    }
}
...
pub fn serialize_structure_health_check_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_code_repository(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_94) = &input.source_code_version {
        ...
        crate::json_ser::serialize_structure_source_code_version(&mut object_95, var_94);
        object_95.finish();
    }
    if let Some(var_96) = &input.code_configuration {
        let mut object_97 = object.key("CodeConfiguration").start_object();
        crate::json_ser::serialize_structure_code_configuration(&mut object_97, var_96);
        object_97.finish();
    }
}

pub fn serialize_structure_image_repository(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_99) = &input.image_configuration {
        ...
        crate::json_ser::serialize_structure_image_configuration(&mut object_100, var_99);
        object_100.finish();
    }
...
pub fn serialize_structure_source_code_version(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_code_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_107) = &input.code_configuration_values {
        ...
        crate::json_ser::serialize_structure_code_configuration_values(&mut object_108, var_107);
        object_108.finish();
    }
}

pub fn serialize_structure_image_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_code_configuration_values(
    object: &mut smithy_json::serialize::JsonObjectWriter,
