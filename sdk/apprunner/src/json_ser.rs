...
pub fn serialize_structure_crate_input_create_vpc_ingress_connection_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_56) = &input.ingress_vpc_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_ingress_vpc_configuration(
            &mut object_57,
            var_56,
        )?;
        object_57.finish();
...
pub fn serialize_structure_crate_input_delete_vpc_ingress_connection_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_describe_vpc_ingress_connection_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_list_vpc_ingress_connections_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_95) = &input.filter {
        ...
        crate::json_ser::serialize_structure_crate_model_list_vpc_ingress_connections_filter(
            &mut object_96,
            var_95,
        )?;
        object_96.finish();
...
pub fn serialize_structure_crate_input_update_vpc_ingress_connection_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_network_configuration(
    ...
    if let Some(var_148) = &input.ingress_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_ingress_configuration(
            &mut object_149,
            var_148,
        )?;
        object_149.finish();
...
pub fn serialize_structure_crate_model_ingress_vpc_configuration(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_list_vpc_ingress_connections_filter(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_model_ingress_configuration(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::IngressConfiguration,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.is_publicly_accessible {
        object
            .key("IsPubliclyAccessible")
            .boolean(input.is_publicly_accessible);
    }
    Ok(())
}
