...
impl CreateVpcConnectorInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpc_connector::ser_create_vpc_connector_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl DeleteVpcConnectorInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_vpc_connector::ser_delete_vpc_connector_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl DescribeVpcConnectorInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpc_connector::ser_describe_vpc_connector_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
