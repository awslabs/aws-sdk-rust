...
pub(crate) fn de_service_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServiceSummary>, aws_smithy_json::deserialize::error::DeserializeError>
