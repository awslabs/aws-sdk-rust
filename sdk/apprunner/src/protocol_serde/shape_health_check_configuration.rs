...
pub(crate) fn de_health_check_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::HealthCheckConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "Protocol" => {
                            builder = builder.set_protocol(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HealthCheckProtocol::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Path" => {
