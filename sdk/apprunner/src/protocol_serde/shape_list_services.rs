...
pub fn de_list_services_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_services_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_services::ListServicesError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ServiceSummaryList" => {
                    builder = builder.set_service_summary_list(crate::protocol_serde::shape_service_summary_list::de_service_summary_list(tokens)?);
                }
                "NextToken" => {
