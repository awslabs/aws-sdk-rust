...
pub fn ser_describe_custom_domains_input(
    ...
    crate::protocol_serde::shape_describe_custom_domains_input::ser_describe_custom_domains_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::describe_custom_domains::DescribeCustomDomainsError::unhandled(
                    generic,
                ),
            ),
        };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_custom_domains_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_custom_domains::de_describe_custom_domains(
            _response_body,
            output,
        )
        .map_err(
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "CustomDomains" => {
                        builder = builder.set_custom_domains(
                            crate::protocol_serde::shape_custom_domain_list::de_custom_domain_list(
                                tokens,
                            )?,
                        );
                    }
