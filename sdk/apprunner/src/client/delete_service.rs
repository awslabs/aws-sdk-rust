...
impl super::Client {
    ...
    ///   - [`service_arn(impl Into<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::service_arn) / [`set_service_arn(Option<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::set_service_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the App Runner service that you want to delete.</p><br>
    ...
    ///   - [`operation_id(String)`](crate::operation::delete_service::DeleteServiceOutput::operation_id): <p>The unique ID of the asynchronous operation that this request started. You can use it combined with the <code>ListOperations</code> call to track the operation's progress.</p>
