...
impl super::Client {
    ...
    ///   - [`service_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_service::builders::DescribeServiceFluentBuilder::service_arn) / [`set_service_arn(Option<String>)`](crate::operation::describe_service::builders::DescribeServiceFluentBuilder::set_service_arn): <p>The Amazon Resource Name (ARN) of the App Runner service that you want a description for.</p>
