...
impl super::Client {
    ...
    ///   - [`subnets(impl Into<String>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::subnets) / [`set_subnets(Option<Vec::<String>>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::set_subnets):<br>required: **true**<br><p>A list of IDs of subnets that App Runner should use when it associates your service with a custom Amazon VPC. Specify IDs of subnets of a single Amazon VPC. App Runner determines the Amazon VPC from the subnets you specify.</p><note>  <p>App Runner currently only provides support for IPv4.</p> </note><br>
