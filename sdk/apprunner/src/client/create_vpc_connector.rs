...
impl super::Client {
    ...
    ///   - [`vpc_connector_name(impl Into<String>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::vpc_connector_name) / [`set_vpc_connector_name(Option<String>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::set_vpc_connector_name):<br>required: **true**<br><p>A name for the VPC connector.</p><br>
    ///   - [`subnets(impl Into<String>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::subnets) / [`set_subnets(Option<Vec::<String>>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::set_subnets):<br>required: **true**<br><p>A list of IDs of subnets that App Runner should use when it associates your service with a custom Amazon VPC. Specify IDs of subnets of a single Amazon VPC. App Runner determines the Amazon VPC from the subnets you specify.</p><note>  <p>App Runner only supports subnets of IP address type <i>IPv4</i> and <i>dual stack</i> (IPv4 and IPv6).</p> </note><br>
    ///   - [`security_groups(impl Into<String>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::security_groups) / [`set_security_groups(Option<Vec::<String>>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::set_security_groups):<br>required: **false**<br><p>A list of IDs of security groups that App Runner should use for access to Amazon Web Services resources under the specified subnets. If not specified, App Runner uses the default security group of the Amazon VPC. The default security group allows all outbound traffic.</p><br>
    ///   - [`tags(Tag)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_vpc_connector::builders::CreateVpcConnectorFluentBuilder::set_tags):<br>required: **false**<br><p>A list of metadata items that you can associate with your VPC connector resource. A tag is a key-value pair.</p><br>
