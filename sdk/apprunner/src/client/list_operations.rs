...
impl super::Client {
    ...
    ///   - [`service_arn(impl Into<String>)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::service_arn) / [`set_service_arn(Option<String>)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::set_service_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the App Runner service that you want a list of operations for.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token from a previous result page. It's used for a paginated request. The request retrieves the next result page. All other parameter values must be identical to the ones specified in the initial request.</p> <p>If you don't specify <code>NextToken</code>, the request retrieves the first result page.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to include in each response (result page). It's used for a paginated request.</p> <p>If you don't specify <code>MaxResults</code>, the request retrieves all available results in a single response.</p><br>
