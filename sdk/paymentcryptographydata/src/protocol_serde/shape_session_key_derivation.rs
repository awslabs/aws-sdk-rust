...
pub fn ser_session_key_derivation(
    ...
    match input {
        crate::types::SessionKeyDerivation::EmvCommon(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_4.key("EmvCommon").start_object();
        ...
        crate::types::SessionKeyDerivation::Mastercard(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_4.key("Mastercard").start_object();
        ...
        crate::types::SessionKeyDerivation::Emv2000(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_4.key("Emv2000").start_object();
        ...
        crate::types::SessionKeyDerivation::Amex(inner) => {
            #[allow(unused_mut)]
            let mut object_4 = object_4.key("Amex").start_object();
        ...
        crate::types::SessionKeyDerivation::Visa(inner) => {
            #[allow(unused_mut)]
            let mut object_5 = object_4.key("Visa").start_object();
