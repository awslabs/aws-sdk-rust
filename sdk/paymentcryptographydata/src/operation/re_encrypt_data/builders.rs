...
///
/// <p>Re-encrypts ciphertext using DUKPT, symmetric, or asymmetric data encryption keys.</p>
...
/// <p>Amazon Web Services Payment Cryptography supports the following encryption key schemes:</p>
/// <ul>
/// <li>
/// <p><b>DUKPT</b>: <code>TDES</code> and <code>AES</code> algorithms. To encrypt using DUKPT, a DUKPT key must already exist within your account with <code>KeyModesOfUse</code> set to <code>DeriveKey</code> or a new DUKPT can be generated by calling <a href="https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html">CreateKey</a>.</p></li>
/// <li>
/// <p><b>Symmetric</b>: <code>TDES</code> and <code>AES</code> algorithms.</p></li>
/// <li>
/// <p><b>Asymmetric</b>: <code>RSA</code>. You can use an <code>RSA</code> key on either the incoming or the outgoing side, paired with a symmetric key on the other side.</p></li>
/// </ul>
