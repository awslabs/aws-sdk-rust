...
impl VerifyAuthRequestCryptogramOutputBuilder {
    ...
    pub fn set_auth_response_value(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.auth_response_value = input; self
    }
    /// <p>The result for ARQC verification or ARPC generation within Amazon Web Services Payment Cryptography.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::verify_auth_request_cryptogram::VerifyAuthRequestCryptogramOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::verify_auth_request_cryptogram::VerifyAuthRequestCryptogramOutput {
                key_arn: self.key_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("key_arn", "key_arn was not specified but it is required when building VerifyAuthRequestCryptogramOutput")
                    )?
                ,
                key_check_value: self.key_check_value
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("key_check_value", "key_check_value was not specified but it is required when building VerifyAuthRequestCryptogramOutput")
                    )?
                ,
