...
impl GenerateMacInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::generate_mac::GenerateMac, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_generate_mac::ser_generate_mac_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_mac::GenerateMac::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GenerateMac", "paymentcryptographydata"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateMac {
    type Output = ::std::result::Result<crate::operation::generate_mac::GenerateMacOutput, crate::operation::generate_mac::GenerateMacError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_mac::de_generate_mac_http_response_with_props(status, headers, body)
        }
    }
}
