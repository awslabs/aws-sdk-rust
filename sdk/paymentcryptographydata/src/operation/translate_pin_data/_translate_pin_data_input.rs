...
pub struct TranslatePinDataInputBuilder {
    ...
    pub(crate) incoming_translation_attributes:
        ::std::option::Option<crate::types::TranslationIsoFormats>,
    pub(crate) outgoing_translation_attributes:
        ::std::option::Option<crate::types::TranslationIsoFormats>,
    pub(crate) encrypted_pin_block: ::std::option::Option<::std::string::String>,
    pub(crate) incoming_dukpt_attributes:
        ::std::option::Option<crate::types::DukptDerivationAttributes>,
    pub(crate) outgoing_dukpt_attributes:
        ::std::option::Option<crate::types::DukptDerivationAttributes>,
}
