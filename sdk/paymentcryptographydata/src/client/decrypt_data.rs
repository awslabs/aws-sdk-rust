...
impl super::Client {
    ...
    ///   - [`cipher_text(impl Into<String>)`](crate::operation::decrypt_data::builders::DecryptDataFluentBuilder::cipher_text) / [`set_cipher_text(Option<String>)`](crate::operation::decrypt_data::builders::DecryptDataFluentBuilder::set_cipher_text): <p>The ciphertext to decrypt.</p>
