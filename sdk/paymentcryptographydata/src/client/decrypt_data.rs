...
impl super::Client {
    ...
    ///   - [`plain_text(String)`](crate::operation::decrypt_data::DecryptDataOutput::plain_text): <p>The decrypted plaintext data in hexBinary format.</p>
