...
impl super::Client {
    ...
    ///   - [`message_data(impl Into<String>)`](crate::operation::generate_mac::builders::GenerateMacFluentBuilder::message_data) / [`set_message_data(Option<String>)`](crate::operation::generate_mac::builders::GenerateMacFluentBuilder::set_message_data):<br>required: **true**<br><p>The data for which a MAC is under generation. This value must be hexBinary.</p><br>
