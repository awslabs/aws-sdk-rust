...
impl super::Client {
    ...
    ///   - [`key_identifier(impl Into<String>)`](crate::operation::generate_mac::builders::GenerateMacFluentBuilder::key_identifier) / [`set_key_identifier(Option<String>)`](crate::operation::generate_mac::builders::GenerateMacFluentBuilder::set_key_identifier): <p>The <code>keyARN</code> of the MAC generation encryption key.</p>
    ///   - [`message_data(impl Into<String>)`](crate::operation::generate_mac::builders::GenerateMacFluentBuilder::message_data) / [`set_message_data(Option<String>)`](crate::operation::generate_mac::builders::GenerateMacFluentBuilder::set_message_data): <p>The data for which a MAC is under generation.</p>
