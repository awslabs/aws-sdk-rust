...
impl super::Client {
    ...
    ///   - [`key_identifier(impl ::std::convert::Into<String>)`](crate::operation::encrypt_data::builders::EncryptDataFluentBuilder::key_identifier) / [`set_key_identifier(Option<String>)`](crate::operation::encrypt_data::builders::EncryptDataFluentBuilder::set_key_identifier): <p>The <code>keyARN</code> of the encryption key that Amazon Web Services Payment Cryptography uses for plaintext encryption.</p>
    ///   - [`plain_text(impl ::std::convert::Into<String>)`](crate::operation::encrypt_data::builders::EncryptDataFluentBuilder::plain_text) / [`set_plain_text(Option<String>)`](crate::operation::encrypt_data::builders::EncryptDataFluentBuilder::set_plain_text): <p>The plaintext to be encrypted.</p>
    ///   - [`encryption_attributes(EncryptionDecryptionAttributes)`](crate::operation::encrypt_data::builders::EncryptDataFluentBuilder::encryption_attributes) / [`set_encryption_attributes(Option<EncryptionDecryptionAttributes>)`](crate::operation::encrypt_data::builders::EncryptDataFluentBuilder::set_encryption_attributes): <p>The encryption key type and attributes for plaintext encryption.</p>
    /// - On success, responds with [`EncryptDataOutput`](crate::operation::encrypt_data::EncryptDataOutput) with field(s):
    ///   - [`key_arn(Option<String>)`](crate::operation::encrypt_data::EncryptDataOutput::key_arn): <p>The <code>keyARN</code> of the encryption key that Amazon Web Services Payment Cryptography uses for plaintext encryption.</p>
    ...
    ///   - [`cipher_text(Option<String>)`](crate::operation::encrypt_data::EncryptDataOutput::cipher_text): <p>The encrypted ciphertext.</p>
