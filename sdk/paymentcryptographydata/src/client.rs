...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_paymentcryptographydata::Error> {
/// # let client: aws_sdk_paymentcryptographydata::Client = unimplemented!();
...
mod verify_card_validation_data;
