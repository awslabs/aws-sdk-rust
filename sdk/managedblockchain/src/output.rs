...
pub struct ListProposalVotesOutput  {
    ...
    #[doc(hidden)]pub proposal_votes: std::option::Option<std::vec::Vec<crate::model::VoteSummary>>,
...
pub struct ListProposalsOutput  {
    ...
    #[doc(hidden)]pub proposals: std::option::Option<std::vec::Vec<crate::model::ProposalSummary>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListNodesOutput  {
    ...
    #[doc(hidden)]pub nodes: std::option::Option<std::vec::Vec<crate::model::NodeSummary>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListNetworksOutput  {
    ...
    #[doc(hidden)]pub networks: std::option::Option<std::vec::Vec<crate::model::NetworkSummary>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListMembersOutput  {
    ...
    #[doc(hidden)]pub members: std::option::Option<std::vec::Vec<crate::model::MemberSummary>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetProposalOutput  {
    ...
    #[doc(hidden)]pub proposal: std::option::Option<crate::model::Proposal>,
}
...
pub struct GetNodeOutput  {
    ...
    #[doc(hidden)]pub node: std::option::Option<crate::model::Node>,
}
impl GetNodeOutput {
    /// <p>Properties of the node configuration.</p>
