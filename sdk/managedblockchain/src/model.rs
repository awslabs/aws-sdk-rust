...
pub struct NodeLogPublishingConfiguration  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::NodeFabricLogPublishingConfiguration>,
}
...
pub struct NodeFabricLogPublishingConfiguration  {
    ...
    #[doc(hidden)]pub chaincode_logs: std::option::Option<crate::model::LogConfigurations>,
    ...
    #[doc(hidden)]pub peer_logs: std::option::Option<crate::model::LogConfigurations>,
}
...
pub struct LogConfigurations  {
    ...
    #[doc(hidden)]pub cloudwatch: std::option::Option<crate::model::LogConfiguration>,
}
...
pub struct MemberLogPublishingConfiguration  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::MemberFabricLogPublishingConfiguration>,
}
...
pub struct MemberFabricLogPublishingConfiguration  {
    ...
    #[doc(hidden)]pub ca_logs: std::option::Option<crate::model::LogConfigurations>,
}
...
pub struct VoteSummary  {
    ...
    #[doc(hidden)]pub member_name: std::option::Option<std::string::String>,
...
pub struct ProposalSummary  {
    ...
    #[doc(hidden)]pub proposed_by_member_id: std::option::Option<std::string::String>,
    /// <p> The name of the member that created the proposal. </p>
    #[doc(hidden)]pub proposed_by_member_name: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ProposalStatus>,
    /// <p> The date and time that the proposal was created. </p>
    #[doc(hidden)]pub creation_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub expiration_date: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct Invitation  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::InvitationStatus>,
    /// <p>A summary of network configuration properties.</p>
    #[doc(hidden)]pub network_summary: std::option::Option<crate::model::NetworkSummary>,
...
pub struct Proposal  {
    ...
    #[doc(hidden)]pub yes_vote_count: std::option::Option<i32>,
    /// <p> The current total of <code>NO</code> votes cast on the proposal by members. </p>
    #[doc(hidden)]pub no_vote_count: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub outstanding_vote_count: std::option::Option<i32>,
...
pub struct ProposalActions  {
    ...
    #[doc(hidden)]pub invitations: std::option::Option<std::vec::Vec<crate::model::InviteAction>>,
    ...
    #[doc(hidden)]pub removals: std::option::Option<std::vec::Vec<crate::model::RemoveAction>>,
}
...
pub struct Node  {
    ...
    #[doc(hidden)]pub framework_attributes: std::option::Option<crate::model::NodeFrameworkAttributes>,
    /// <p>Configuration properties for logging events associated with a peer node on a Hyperledger Fabric network on Managed Blockchain.</p>
    ...
    /// <p>Applies only to Hyperledger Fabric.</p>
    #[doc(hidden)]pub state_db: std::option::Option<crate::model::StateDbType>,
    /// <p>The status of the node.</p> 
    /// <ul> 
...
pub struct NodeFrameworkAttributes  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::NodeFabricAttributes>,
    /// <p>Attributes of Ethereum for a node on a Managed Blockchain network that uses Ethereum. </p>
    #[doc(hidden)]pub ethereum: std::option::Option<crate::model::NodeEthereumAttributes>,
}
...
pub struct NodeEthereumAttributes  {
    ...
    #[doc(hidden)]pub http_endpoint: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub web_socket_endpoint: std::option::Option<std::string::String>,
}
...
pub struct NodeFabricAttributes  {
    ...
    #[doc(hidden)]pub peer_endpoint: std::option::Option<std::string::String>,
    /// <p>The endpoint that identifies the peer node for peer channel-based event services.</p>
    #[doc(hidden)]pub peer_event_endpoint: std::option::Option<std::string::String>,
}
...
pub struct Network  {
    ...
    #[doc(hidden)]pub framework_attributes: std::option::Option<crate::model::NetworkFrameworkAttributes>,
    ...
    #[doc(hidden)]pub vpc_endpoint_service_name: std::option::Option<std::string::String>,
...
pub struct VotingPolicy  {
    ...
    #[doc(hidden)]pub approval_threshold_policy: std::option::Option<crate::model::ApprovalThresholdPolicy>,
}
impl VotingPolicy {
    /// <p>Defines the rules for the network for voting on proposals, such as the percentage of <code>YES</code> votes required for the proposal to be approved and the duration of the proposal. The policy applies to all proposals and is specified when the network is created.</p>
...
pub struct ApprovalThresholdPolicy  {
    ...
    #[doc(hidden)]pub threshold_percentage: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub proposal_duration_in_hours: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub threshold_comparator: std::option::Option<crate::model::ThresholdComparator>,
}
...
impl  std::fmt::Debug for ApprovalThresholdPolicy  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("proposal_duration_in_hours", &self.proposal_duration_in_hours);
...
pub struct NetworkFrameworkAttributes  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::NetworkFabricAttributes>,
    /// <p>Attributes of an Ethereum network for Managed Blockchain resources participating in an Ethereum network. </p>
    #[doc(hidden)]pub ethereum: std::option::Option<crate::model::NetworkEthereumAttributes>,
}
...
pub struct NetworkEthereumAttributes  {
    ...
    /// </ul>
    #[doc(hidden)]pub chain_id: std::option::Option<std::string::String>,
}
...
pub struct NetworkFabricAttributes  {
    ...
    #[doc(hidden)]pub ordering_service_endpoint: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub edition: std::option::Option<crate::model::Edition>,
}
...
pub struct Member  {
    ...
    #[doc(hidden)]pub framework_attributes: std::option::Option<crate::model::MemberFrameworkAttributes>,
...
pub struct MemberFrameworkAttributes  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::MemberFabricAttributes>,
}
...
pub struct MemberFabricAttributes  {
    ...
    #[doc(hidden)]pub admin_username: std::option::Option<std::string::String>,
    /// <p>The endpoint used to access the member's certificate authority.</p>
    #[doc(hidden)]pub ca_endpoint: std::option::Option<std::string::String>,
}
...
pub struct MemberConfiguration  {
    ...
    #[doc(hidden)]pub framework_configuration: std::option::Option<crate::model::MemberFrameworkConfiguration>,
    /// <p>Configuration properties for logging events associated with a member of a Managed Blockchain network.</p>
    #[doc(hidden)]pub log_publishing_configuration: std::option::Option<crate::model::MemberLogPublishingConfiguration>,
    /// <p>Tags assigned to the member. Tags consist of a key and optional value. For more information about tags, see <a href="https://docs.aws.amazon.com/managed-blockchain/latest/hyperledger-fabric-dev/tagging-resources.html">Tagging Resources</a> in the <i>Amazon Managed Blockchain Hyperledger Fabric Developer Guide</i>.</p> 
...
pub struct MemberFrameworkConfiguration  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::MemberFabricConfiguration>,
}
...
pub struct MemberFabricConfiguration  {
    ...
    #[doc(hidden)]pub admin_password: std::option::Option<std::string::String>,
}
...
pub struct NetworkFrameworkConfiguration  {
    ...
    #[doc(hidden)]pub fabric: std::option::Option<crate::model::NetworkFabricConfiguration>,
}
