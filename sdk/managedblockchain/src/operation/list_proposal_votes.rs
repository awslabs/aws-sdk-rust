...
impl ListProposalVotesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_proposal_votes::ListProposalVotes,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProposalVotes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_proposal_votes::de_list_proposal_votes_http_response_with_props(status, headers, body)
        }
    }
}
