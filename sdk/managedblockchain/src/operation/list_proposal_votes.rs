...
impl ListProposalVotesInput {
    /// Consumes the builder and constructs an Operation<[`ListProposalVotes`](crate::operation::list_proposal_votes::ListProposalVotes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_proposal_votes::ListProposalVotes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_proposal_votes::ListProposalVotesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_proposal_votes::ListProposalVotesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_proposal_votes::ListProposalVotes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListProposalVotes {
                type Output = std::result::Result<crate::operation::list_proposal_votes::ListProposalVotesOutput, crate::operation::list_proposal_votes::ListProposalVotesError>;
