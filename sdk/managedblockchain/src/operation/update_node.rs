...
impl UpdateNodeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_node::UpdateNode,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_node::UpdateNode::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_node::de_update_node_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_node::de_update_node_http_response_with_props(
                status, headers, body,
            )
        }
    }
