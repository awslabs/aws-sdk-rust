...
impl CreateNodeInput {
    /// Consumes the builder and constructs an Operation<[`CreateNode`](crate::operation::create_node::CreateNode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_node::CreateNode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_node::CreateNodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_node::CreateNode::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNode {
                type Output = std::result::Result<crate::operation::create_node::CreateNodeOutput, crate::operation::create_node::CreateNodeError>;
