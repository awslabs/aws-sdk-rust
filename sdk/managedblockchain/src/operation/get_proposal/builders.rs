...
impl GetProposalFluentBuilder  {
    /// Creates a new `GetProposal`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_proposal::GetProposalOutput, aws_smithy_http::result::SdkError<crate::operation::get_proposal::GetProposalError>>
                     {
