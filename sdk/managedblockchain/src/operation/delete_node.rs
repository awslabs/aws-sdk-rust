...
impl DeleteNodeInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNode`](crate::operation::delete_node::DeleteNode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_node::DeleteNode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_node::DeleteNodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("node_id", "cannot be empty or unset"))?;
            ...
            fn uri_query(_input: &crate::operation::delete_node::DeleteNodeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_3) = &_input.member_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_node::DeleteNode::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteNode {
                type Output = std::result::Result<crate::operation::delete_node::DeleteNodeOutput, crate::operation::delete_node::DeleteNodeError>;
