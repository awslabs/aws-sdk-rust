...
impl GetProposalInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_proposal::GetProposal::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProposal {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_proposal::de_get_proposal_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_proposal::de_get_proposal_http_response_with_props(
                status, headers, body,
            )
        }
    }
