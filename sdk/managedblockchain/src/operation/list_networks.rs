...
impl ListNetworksInput {
    /// Consumes the builder and constructs an Operation<[`ListNetworks`](crate::operation::list_networks::ListNetworks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_networks::ListNetworks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_networks::ListNetworksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/networks").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_networks::ListNetworksInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_2) = &_input.framework {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_networks::ListNetworks::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListNetworks {
                type Output = std::result::Result<crate::operation::list_networks::ListNetworksOutput, crate::operation::list_networks::ListNetworksError>;
