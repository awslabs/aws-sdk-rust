...
impl CreateProposalInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_proposal::CreateProposal,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_proposal::CreateProposal::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProposal {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_proposal::de_create_proposal_http_error(
                status, headers, body,
            )
        } else {
