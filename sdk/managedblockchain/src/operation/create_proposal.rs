...
impl CreateProposalInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_proposal::CreateProposal, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_proposal::ser_create_proposal_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProposal {
    type Output =
        ::std::result::Result<crate::operation::create_proposal::CreateProposalOutput, crate::operation::create_proposal::CreateProposalError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_proposal::de_create_proposal_http_response_with_props(status, headers, body)
        }
    }
}
