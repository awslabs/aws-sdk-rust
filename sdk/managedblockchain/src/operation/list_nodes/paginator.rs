...
/// Paginator for [`ListNodes`](crate::operation::list_nodes::ListNodes)
pub struct ListNodesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_nodes::builders::ListNodesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListNodesPaginator {
    /// Create a new paginator-wrapper
    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_nodes::builders::ListNodesInputBuilder) -> Self {
        Self {
            handle,
            builder,
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_nodes::ListNodes::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_nodes_output_output_next_token(resp);
