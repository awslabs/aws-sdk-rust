...
impl CreateMemberInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_member::CreateMember, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_member::ser_create_member_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMember {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_member::de_create_member_http_response_with_props(status, headers, body)
        }
    }
}
