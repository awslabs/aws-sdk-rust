...
impl CreateNetworkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_network::CreateNetwork, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_network::ser_create_network_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNetwork {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_network::de_create_network_http_response_with_props(status, headers, body)
        }
    }
}
