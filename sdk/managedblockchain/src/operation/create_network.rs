...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateNetworkTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("FrameworkVersion") {
            if let ::std::option::Option::Some(value) = input.framework_version.as_deref() {
                captured.insert("FrameworkVersion", value);
            }
        }
