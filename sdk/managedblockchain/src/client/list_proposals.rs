...
impl super::Client {
    ...
    ///   - [`network_id(impl ::std::convert::Into<String>)`](crate::operation::list_proposals::builders::ListProposalsFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::list_proposals::builders::ListProposalsFluentBuilder::set_network_id): <p> The unique identifier of the network. </p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_proposals::builders::ListProposalsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_proposals::builders::ListProposalsFluentBuilder::set_next_token): <p> The pagination token that indicates the next set of results to retrieve. </p>
