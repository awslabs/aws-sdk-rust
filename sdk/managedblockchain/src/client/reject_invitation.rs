...
impl super::Client {
    ...
    ///   - [`invitation_id(impl Into<String>)`](crate::operation::reject_invitation::builders::RejectInvitationFluentBuilder::invitation_id) / [`set_invitation_id(Option<String>)`](crate::operation::reject_invitation::builders::RejectInvitationFluentBuilder::set_invitation_id):<br>required: **true**<br><p>The unique identifier of the invitation to reject.</p><br>
