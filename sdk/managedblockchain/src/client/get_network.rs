...
impl super::Client {
    ...
    ///   - [`network_id(impl ::std::convert::Into<String>)`](crate::operation::get_network::builders::GetNetworkFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::get_network::builders::GetNetworkFluentBuilder::set_network_id): <p>The unique identifier of the network to get information about.</p>
