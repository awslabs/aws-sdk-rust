...
impl super::Client {
    ...
    ///   - [`network_id(impl Into<String>)`](crate::operation::get_network::builders::GetNetworkFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::get_network::builders::GetNetworkFluentBuilder::set_network_id):<br>required: **true**<br><p>The unique identifier of the network to get information about.</p><br>
