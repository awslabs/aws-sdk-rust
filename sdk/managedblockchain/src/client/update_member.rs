...
impl super::Client {
    ...
    ///   - [`network_id(impl ::std::convert::Into<String>)`](crate::operation::update_member::builders::UpdateMemberFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::update_member::builders::UpdateMemberFluentBuilder::set_network_id): <p>The unique identifier of the Managed Blockchain network to which the member belongs.</p>
    ///   - [`member_id(impl ::std::convert::Into<String>)`](crate::operation::update_member::builders::UpdateMemberFluentBuilder::member_id) / [`set_member_id(Option<String>)`](crate::operation::update_member::builders::UpdateMemberFluentBuilder::set_member_id): <p>The unique identifier of the member.</p>
