...
impl super::Client {
    ...
    ///   - [`network_id(impl Into<String>)`](crate::operation::list_proposal_votes::builders::ListProposalVotesFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::list_proposal_votes::builders::ListProposalVotesFluentBuilder::set_network_id):<br>required: **true**<br><p>The unique identifier of the network.</p><br>
    ///   - [`proposal_id(impl Into<String>)`](crate::operation::list_proposal_votes::builders::ListProposalVotesFluentBuilder::proposal_id) / [`set_proposal_id(Option<String>)`](crate::operation::list_proposal_votes::builders::ListProposalVotesFluentBuilder::set_proposal_id):<br>required: **true**<br><p>The unique identifier of the proposal.</p><br>
