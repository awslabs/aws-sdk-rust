...
impl super::Client {
    ...
    ///   - [`network_id(impl ::std::convert::Into<String>)`](crate::operation::get_proposal::builders::GetProposalFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::get_proposal::builders::GetProposalFluentBuilder::set_network_id): <p>The unique identifier of the network for which the proposal is made.</p>
    ///   - [`proposal_id(impl ::std::convert::Into<String>)`](crate::operation::get_proposal::builders::GetProposalFluentBuilder::proposal_id) / [`set_proposal_id(Option<String>)`](crate::operation::get_proposal::builders::GetProposalFluentBuilder::set_proposal_id): <p>The unique identifier of the proposal.</p>
