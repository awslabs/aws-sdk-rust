...
impl super::Client {
    ...
    ///   - [`network_id(impl Into<String>)`](crate::operation::list_nodes::builders::ListNodesFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::list_nodes::builders::ListNodesFluentBuilder::set_network_id):<br>required: **true**<br><p>The unique identifier of the network for which to list nodes.</p><br>
    ///   - [`member_id(impl Into<String>)`](crate::operation::list_nodes::builders::ListNodesFluentBuilder::member_id) / [`set_member_id(Option<String>)`](crate::operation::list_nodes::builders::ListNodesFluentBuilder::set_member_id):<br>required: **false**<br><p>The unique identifier of the member who owns the nodes to list.</p> <p>Applies only to Hyperledger Fabric and is required for Hyperledger Fabric.</p><br>
    ///   - [`status(NodeStatus)`](crate::operation::list_nodes::builders::ListNodesFluentBuilder::status) / [`set_status(Option<NodeStatus>)`](crate::operation::list_nodes::builders::ListNodesFluentBuilder::set_status):<br>required: **false**<br><p>An optional status specifier. If provided, only nodes currently in this status are listed.</p><br>
