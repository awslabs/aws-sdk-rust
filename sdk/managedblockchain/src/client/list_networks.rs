...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::set_name):<br>required: **false**<br><p>The name of the network.</p><br>
    ///   - [`framework(Framework)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::framework) / [`set_framework(Option<Framework>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::set_framework):<br>required: **false**<br><p>An optional framework specifier. If provided, only networks of this framework type are listed.</p><br>
    ///   - [`status(NetworkStatus)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::status) / [`set_status(Option<NetworkStatus>)`](crate::operation::list_networks::builders::ListNetworksFluentBuilder::set_status):<br>required: **false**<br><p>An optional status specifier. If provided, only networks currently in this status are listed.</p> <p>Applies only to Hyperledger Fabric.</p><br>
