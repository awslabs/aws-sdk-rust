...
impl super::Client {
    ...
    ///   - [`network_id(impl ::std::convert::Into<String>)`](crate::operation::delete_member::builders::DeleteMemberFluentBuilder::network_id) / [`set_network_id(Option<String>)`](crate::operation::delete_member::builders::DeleteMemberFluentBuilder::set_network_id): <p>The unique identifier of the network from which the member is removed.</p>
