...
impl super::Client {
    ...
    ///   - [`accessor_id(impl Into<String>)`](crate::operation::get_accessor::builders::GetAccessorFluentBuilder::accessor_id) / [`set_accessor_id(Option<String>)`](crate::operation::get_accessor::builders::GetAccessorFluentBuilder::set_accessor_id):<br>required: **true**<br><p>The unique identifier of the accessor.</p><br>
