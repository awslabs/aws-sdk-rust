                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "FrameworkAttributes" => {
                            builder = builder.set_framework_attributes(
                                crate::protocol_serde::shape_node_framework_attributes::de_node_framework_attributes(tokens, _value, depth + 1)?,
                            );
                        }
                        "LogPublishingConfiguration" => {
                            builder = builder.set_log_publishing_configuration(
                                crate::protocol_serde::shape_node_log_publishing_configuration::de_node_log_publishing_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
