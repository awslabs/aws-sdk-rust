...
pub fn de_list_proposal_votes_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_proposal_votes::ListProposalVotesOutput, crate::operation::list_proposal_votes::ListProposalVotesError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::list_proposal_votes::ListProposalVotesOutput, crate::operation::list_proposal_votes::ListProposalVotesError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_list_proposal_votes::de_list_proposal_votes(_response_body, output)
            .map_err(crate::operation::list_proposal_votes::ListProposalVotesError::unhandled)?;
...
) -> Result<crate::operation::list_proposal_votes::builders::ListProposalVotesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ProposalVotes" => {
                    builder = builder.set_proposal_votes(crate::protocol_serde::shape_proposal_vote_list::de_proposal_vote_list(tokens)?);
                }
