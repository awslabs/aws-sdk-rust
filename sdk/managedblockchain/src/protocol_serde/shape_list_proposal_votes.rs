...
pub fn de_list_proposal_votes_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_proposal_votes::ListProposalVotesOutput, crate::operation::list_proposal_votes::ListProposalVotesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_proposal_votes::ListProposalVotesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_proposal_votes_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_proposal_votes::ListProposalVotesOutput, crate::operation::list_proposal_votes::ListProposalVotesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_proposal_votes::builders::ListProposalVotesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_proposal_votes::de_list_proposal_votes(response.body().as_ref(), output).map_err(crate::operation::list_proposal_votes::ListProposalVotesError::unhandled)?;
