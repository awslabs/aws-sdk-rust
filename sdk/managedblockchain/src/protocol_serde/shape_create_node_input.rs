...
pub fn ser_create_node_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNodeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
