...
pub fn ser_approval_threshold_policy(
...
pub(crate) fn de_approval_threshold_policy<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ApprovalThresholdPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "ThresholdComparator" => {
                            builder = builder.set_threshold_comparator(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ThresholdComparator::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
