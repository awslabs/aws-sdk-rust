...
impl super::Client {
    ...
    ///   - [`validate_request_body(bool)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::validate_request_body) / [`set_validate_request_body(Option<bool>)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::set_validate_request_body): <p>A Boolean flag to indicate whether to validate request body according to the configured model schema for the method (<code>true</code>) or not (<code>false</code>).</p>
    ///   - [`validate_request_parameters(bool)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::validate_request_parameters) / [`set_validate_request_parameters(Option<bool>)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::set_validate_request_parameters): <p>A Boolean flag to indicate whether to validate request parameters, <code>true</code>, or not <code>false</code>.</p>
