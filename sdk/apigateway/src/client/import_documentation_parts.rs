...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::import_documentation_parts::builders::ImportDocumentationPartsFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::import_documentation_parts::builders::ImportDocumentationPartsFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
