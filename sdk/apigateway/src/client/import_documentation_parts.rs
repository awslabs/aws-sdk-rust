...
impl super::Client {
    ...
    ///   - [`fail_on_warnings(bool)`](crate::operation::import_documentation_parts::builders::ImportDocumentationPartsFluentBuilder::fail_on_warnings) / [`set_fail_on_warnings(Option<bool>)`](crate::operation::import_documentation_parts::builders::ImportDocumentationPartsFluentBuilder::set_fail_on_warnings): <p>A query parameter to specify whether to rollback the documentation importation (<code>true</code>) or not (<code>false</code>) when a warning is encountered. The default value is <code>false</code>.</p>
