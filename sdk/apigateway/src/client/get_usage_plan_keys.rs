...
impl super::Client {
    ...
    ///   - [`usage_plan_id(impl ::std::convert::Into<String>)`](crate::operation::get_usage_plan_keys::builders::GetUsagePlanKeysFluentBuilder::usage_plan_id) / [`set_usage_plan_id(Option<String>)`](crate::operation::get_usage_plan_keys::builders::GetUsagePlanKeysFluentBuilder::set_usage_plan_id): <p>The Id of the UsagePlan resource representing the usage plan containing the to-be-retrieved UsagePlanKey resource representing a plan customer.</p>
    ///   - [`position(impl ::std::convert::Into<String>)`](crate::operation::get_usage_plan_keys::builders::GetUsagePlanKeysFluentBuilder::position) / [`set_position(Option<String>)`](crate::operation::get_usage_plan_keys::builders::GetUsagePlanKeysFluentBuilder::set_position): <p>The current pagination position in the paged result set.</p>
    ...
    pub fn get_usage_plan_keys(
        &self,
    ) -> crate::operation::get_usage_plan_keys::builders::GetUsagePlanKeysFluentBuilder {
        crate::operation::get_usage_plan_keys::builders::GetUsagePlanKeysFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
