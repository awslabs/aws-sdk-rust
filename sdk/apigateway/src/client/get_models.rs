...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::get_models::builders::GetModelsFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_models::builders::GetModelsFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`position(impl ::std::convert::Into<String>)`](crate::operation::get_models::builders::GetModelsFluentBuilder::position) / [`set_position(Option<String>)`](crate::operation::get_models::builders::GetModelsFluentBuilder::set_position): <p>The current pagination position in the paged result set.</p>
