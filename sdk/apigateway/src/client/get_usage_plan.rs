...
impl super::Client {
    ...
    ///   - [`usage_plan_id(impl Into<String>)`](crate::operation::get_usage_plan::builders::GetUsagePlanFluentBuilder::usage_plan_id) / [`set_usage_plan_id(Option<String>)`](crate::operation::get_usage_plan::builders::GetUsagePlanFluentBuilder::set_usage_plan_id):<br>required: **true**<br><p>The identifier of the UsagePlan resource to be retrieved.</p><br>
