...
impl super::Client {
    ...
    ///   - [`client_certificate_id(impl Into<String>)`](crate::operation::get_client_certificate::builders::GetClientCertificateFluentBuilder::client_certificate_id) / [`set_client_certificate_id(Option<String>)`](crate::operation::get_client_certificate::builders::GetClientCertificateFluentBuilder::set_client_certificate_id):<br>required: **true**<br><p>The identifier of the ClientCertificate resource to be described.</p><br>
