...
impl super::Client {
    ...
    ///   - [`patch_operations(PatchOperation)`](crate::operation::update_base_path_mapping::builders::UpdateBasePathMappingFluentBuilder::patch_operations) / [`set_patch_operations(Option<Vec<PatchOperation>>)`](crate::operation::update_base_path_mapping::builders::UpdateBasePathMappingFluentBuilder::set_patch_operations): <p>For more information about supported patch operations, see <a href="https://docs.aws.amazon.com/apigateway/latest/api/patch-operations.html">Patch Operations</a>.</p>
