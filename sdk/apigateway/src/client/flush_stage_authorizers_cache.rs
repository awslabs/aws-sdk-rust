...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::flush_stage_authorizers_cache::builders::FlushStageAuthorizersCacheFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::flush_stage_authorizers_cache::builders::FlushStageAuthorizersCacheFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
