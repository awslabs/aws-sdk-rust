...
impl super::Client {
    ...
    ///   - [`client_certificate_id(impl Into<String>)`](crate::operation::update_client_certificate::builders::UpdateClientCertificateFluentBuilder::client_certificate_id) / [`set_client_certificate_id(Option<String>)`](crate::operation::update_client_certificate::builders::UpdateClientCertificateFluentBuilder::set_client_certificate_id):<br>required: **true**<br><p>The identifier of the ClientCertificate resource to be updated.</p><br>
    ///   - [`patch_operations(PatchOperation)`](crate::operation::update_client_certificate::builders::UpdateClientCertificateFluentBuilder::patch_operations) / [`set_patch_operations(Option<Vec::<PatchOperation>>)`](crate::operation::update_client_certificate::builders::UpdateClientCertificateFluentBuilder::set_patch_operations):<br>required: **false**<br><p>For more information about supported patch operations, see <a href="https://docs.aws.amazon.com/apigateway/latest/api/patch-operations.html">Patch Operations</a>.</p><br>
