...
impl super::Client {
    ...
    ///   - [`api_key(impl Into<String>)`](crate::operation::delete_api_key::builders::DeleteApiKeyFluentBuilder::api_key) / [`set_api_key(Option<String>)`](crate::operation::delete_api_key::builders::DeleteApiKeyFluentBuilder::set_api_key):<br>required: **true**<br><p>The identifier of the ApiKey resource to be deleted.</p><br>
