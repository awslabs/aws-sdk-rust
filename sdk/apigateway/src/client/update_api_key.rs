...
impl super::Client {
    ...
    ///   - [`patch_operations(PatchOperation)`](crate::operation::update_api_key::builders::UpdateApiKeyFluentBuilder::patch_operations) / [`set_patch_operations(Option<Vec<PatchOperation>>)`](crate::operation::update_api_key::builders::UpdateApiKeyFluentBuilder::set_patch_operations): <p>For more information about supported patch operations, see <a href="https://docs.aws.amazon.com/apigateway/latest/api/patch-operations.html">Patch Operations</a>.</p>
    ...
    ///   - [`customer_id(Option<String>)`](crate::operation::update_api_key::UpdateApiKeyOutput::customer_id): <p>An Amazon Web Services Marketplace customer identifier, when integrating with the Amazon Web Services SaaS Marketplace.</p>
