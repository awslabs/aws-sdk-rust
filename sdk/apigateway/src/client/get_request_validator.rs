...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::get_request_validator::builders::GetRequestValidatorFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_request_validator::builders::GetRequestValidatorFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`request_validator_id(impl ::std::convert::Into<String>)`](crate::operation::get_request_validator::builders::GetRequestValidatorFluentBuilder::request_validator_id) / [`set_request_validator_id(Option<String>)`](crate::operation::get_request_validator::builders::GetRequestValidatorFluentBuilder::set_request_validator_id): <p>The identifier of the RequestValidator to be retrieved.</p>
