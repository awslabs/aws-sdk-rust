...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl Into<String>)`](crate::operation::get_authorizers::builders::GetAuthorizersFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_authorizers::builders::GetAuthorizersFluentBuilder::set_rest_api_id):<br>required: **true**<br><p>The string identifier of the associated RestApi.</p><br>
