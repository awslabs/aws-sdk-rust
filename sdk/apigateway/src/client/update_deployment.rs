...
impl super::Client {
    ...
    ///   - [`patch_operations(PatchOperation)`](crate::operation::update_deployment::builders::UpdateDeploymentFluentBuilder::patch_operations) / [`set_patch_operations(Option<Vec<PatchOperation>>)`](crate::operation::update_deployment::builders::UpdateDeploymentFluentBuilder::set_patch_operations): <p>For more information about supported patch operations, see <a href="https://docs.aws.amazon.com/apigateway/latest/api/patch-operations.html">Patch Operations</a>.</p>
