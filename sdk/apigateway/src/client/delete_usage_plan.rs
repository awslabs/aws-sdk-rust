...
impl super::Client {
    ...
    ///   - [`usage_plan_id(impl Into<String>)`](crate::operation::delete_usage_plan::builders::DeleteUsagePlanFluentBuilder::usage_plan_id) / [`set_usage_plan_id(Option<String>)`](crate::operation::delete_usage_plan::builders::DeleteUsagePlanFluentBuilder::set_usage_plan_id):<br>required: **true**<br><p>The Id of the to-be-deleted usage plan.</p><br>
