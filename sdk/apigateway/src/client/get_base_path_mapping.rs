...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::get_base_path_mapping::builders::GetBasePathMappingFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_base_path_mapping::builders::GetBasePathMappingFluentBuilder::set_domain_name):<br>required: **true**<br><p>The domain name of the BasePathMapping resource to be described.</p><br>
    ///   - [`domain_name_id(impl Into<String>)`](crate::operation::get_base_path_mapping::builders::GetBasePathMappingFluentBuilder::domain_name_id) / [`set_domain_name_id(Option<String>)`](crate::operation::get_base_path_mapping::builders::GetBasePathMappingFluentBuilder::set_domain_name_id):<br>required: **false**<br><p>The identifier for the domain name resource. Supported only for private custom domain names.</p><br>
