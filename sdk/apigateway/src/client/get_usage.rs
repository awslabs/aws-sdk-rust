...
impl super::Client {
    ...
    ///   - [`usage_plan_id(impl ::std::convert::Into<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::usage_plan_id) / [`set_usage_plan_id(Option<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::set_usage_plan_id): <p>The Id of the usage plan associated with the usage data.</p>
    ///   - [`key_id(impl ::std::convert::Into<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::key_id) / [`set_key_id(Option<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::set_key_id): <p>The Id of the API key associated with the resultant usage data.</p>
    ///   - [`start_date(impl ::std::convert::Into<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::start_date) / [`set_start_date(Option<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::set_start_date): <p>The starting date (e.g., 2016-01-01) of the usage data.</p>
    ///   - [`end_date(impl ::std::convert::Into<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::end_date) / [`set_end_date(Option<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::set_end_date): <p>The ending date (e.g., 2016-12-31) of the usage data.</p>
    ///   - [`position(impl ::std::convert::Into<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::position) / [`set_position(Option<String>)`](crate::operation::get_usage::builders::GetUsageFluentBuilder::set_position): <p>The current pagination position in the paged result set.</p>
