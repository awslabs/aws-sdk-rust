...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::put_gateway_response::builders::PutGatewayResponseFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::put_gateway_response::builders::PutGatewayResponseFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ...
    ///   - [`status_code(impl ::std::convert::Into<String>)`](crate::operation::put_gateway_response::builders::PutGatewayResponseFluentBuilder::status_code) / [`set_status_code(Option<String>)`](crate::operation::put_gateway_response::builders::PutGatewayResponseFluentBuilder::set_status_code): <p>The HTTP status code of the GatewayResponse.</p>
