...
impl super::Client {
    ...
    pub fn put_gateway_response(
        &self,
    ) -> crate::operation::put_gateway_response::builders::PutGatewayResponseFluentBuilder {
        crate::operation::put_gateway_response::builders::PutGatewayResponseFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
