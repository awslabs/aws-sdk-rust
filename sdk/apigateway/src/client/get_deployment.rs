...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`deployment_id(impl ::std::convert::Into<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::set_deployment_id): <p>The identifier of the Deployment resource to get information about.</p>
