...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_integration::builders::DeleteIntegrationFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::delete_integration::builders::DeleteIntegrationFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::delete_integration::builders::DeleteIntegrationFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::delete_integration::builders::DeleteIntegrationFluentBuilder::set_resource_id): <p>Specifies a delete integration request's resource identifier.</p>
