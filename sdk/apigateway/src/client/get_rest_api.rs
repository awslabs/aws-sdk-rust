...
impl super::Client {
    ...
    ///   - [`rest_api_id(impl Into<String>)`](crate::operation::get_rest_api::builders::GetRestApiFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_rest_api::builders::GetRestApiFluentBuilder::set_rest_api_id):<br>required: **true**<br><p>The string identifier of the associated RestApi.</p><br>
    ...
    ///   - [`endpoint_configuration(Option<EndpointConfiguration>)`](crate::operation::get_rest_api::GetRestApiOutput::endpoint_configuration): <p>The endpoint configuration of this RestApi showing the endpoint types and IP address types of the API.</p>
