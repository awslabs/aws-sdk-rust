...
impl super::Client {
    ...
    ///   - [`vpc_link_id(impl Into<String>)`](crate::operation::delete_vpc_link::builders::DeleteVpcLinkFluentBuilder::vpc_link_id) / [`set_vpc_link_id(Option<String>)`](crate::operation::delete_vpc_link::builders::DeleteVpcLinkFluentBuilder::set_vpc_link_id):<br>required: **true**<br><p>The identifier of the VpcLink. It is used in an Integration to reference this VpcLink.</p><br>
