...
impl super::Client {
    ...
    ///   - [`domain_name_id(impl Into<String>)`](crate::operation::get_base_path_mappings::builders::GetBasePathMappingsFluentBuilder::domain_name_id) / [`set_domain_name_id(Option<String>)`](crate::operation::get_base_path_mappings::builders::GetBasePathMappingsFluentBuilder::set_domain_name_id):<br>required: **false**<br><p>The identifier for the domain name resource. Supported only for private custom domain names.</p><br>
