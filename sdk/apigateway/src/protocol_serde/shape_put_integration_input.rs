...
pub fn ser_put_integration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutIntegrationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
