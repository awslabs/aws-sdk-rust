                    ...
                    match crate::protocol_serde::shape_too_many_requests_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::test_invoke_authorizer::TestInvokeAuthorizerError::unhandled(
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "authorization" => {
                    builder = builder.set_authorization(crate::protocol_serde::shape_map_of_string_to_list::de_map_of_string_to_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "claims" => {
                    builder = builder.set_claims(crate::protocol_serde::shape_map_of_string_to_string::de_map_of_string_to_string(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
