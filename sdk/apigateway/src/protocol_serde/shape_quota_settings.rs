...
) -> ::std::result::Result<Option<crate::types::QuotaSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "period" => {
                            builder = builder.set_period(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::QuotaPeriodType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
