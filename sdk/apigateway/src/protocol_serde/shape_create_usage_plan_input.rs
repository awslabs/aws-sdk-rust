...
pub fn ser_create_usage_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUsagePlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
