...
pub(crate) fn de_rest_api<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::RestApi>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "binaryMediaTypes" => {
                            builder = builder.set_binary_media_types(crate::protocol_serde::shape_list_of_string::de_list_of_string(tokens, _value)?);
                        }
                        ...
                        "apiKeySource" => {
                            builder = builder.set_api_key_source(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ApiKeySourceType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "endpointConfiguration" => {
                            builder = builder.set_endpoint_configuration(
                                crate::protocol_serde::shape_endpoint_configuration::de_endpoint_configuration(tokens, _value)?,
                            );
                        }
                        "policy" => {
