...
pub fn de_get_documentation_versions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_documentation_versions::GetDocumentationVersionsOutput, crate::operation::get_documentation_versions::GetDocumentationVersionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_documentation_versions::GetDocumentationVersionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_documentation_versions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_documentation_versions::GetDocumentationVersionsOutput, crate::operation::get_documentation_versions::GetDocumentationVersionsError> {
    Ok({
        #[allow(unused_mut)]
