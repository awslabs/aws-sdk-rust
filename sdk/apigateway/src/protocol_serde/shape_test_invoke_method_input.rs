...
pub fn ser_test_invoke_method_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TestInvokeMethodInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
