...
pub(crate) fn de_gateway_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::GatewayResponse>, aws_smithy_json::deserialize::error::DeserializeError>
