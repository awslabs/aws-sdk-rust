...
pub fn de_get_domain_name_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_domain_name::GetDomainNameOutput, crate::operation::get_domain_name::GetDomainNameError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_too_many_requests_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::get_domain_name::GetDomainNameError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
                output.build()
...
pub fn de_get_domain_name_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_domain_name::de_get_domain_name(_response_body, output)
            .map_err(crate::operation::get_domain_name::GetDomainNameError::unhandled)?;
...
) -> Result<crate::operation::get_domain_name::builders::GetDomainNameOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
