...
pub fn ser_update_usage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUsageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
