...
pub(crate) fn de_integration_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IntegrationResponse>, aws_smithy_json::deserialize::error::DeserializeError>
