...
pub fn ser_create_rest_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRestApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
