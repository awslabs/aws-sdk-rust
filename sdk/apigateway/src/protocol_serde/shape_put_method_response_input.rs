...
pub fn ser_put_method_response_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutMethodResponseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
