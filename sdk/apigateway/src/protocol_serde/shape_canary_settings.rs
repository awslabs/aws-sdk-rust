...
pub(crate) fn de_canary_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CanarySettings>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_canary_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CanarySettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
