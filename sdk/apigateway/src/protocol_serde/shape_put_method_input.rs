...
pub fn ser_put_method_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutMethodInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
