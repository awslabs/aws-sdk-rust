...
pub fn ser_update_stage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateStageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
