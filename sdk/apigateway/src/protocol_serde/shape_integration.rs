...
pub(crate) fn de_integration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Integration>, aws_smithy_json::deserialize::error::DeserializeError>
