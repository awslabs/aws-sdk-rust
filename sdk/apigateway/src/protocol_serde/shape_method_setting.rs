...
pub(crate) fn de_method_setting<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MethodSetting>, aws_smithy_json::deserialize::error::DeserializeError>
