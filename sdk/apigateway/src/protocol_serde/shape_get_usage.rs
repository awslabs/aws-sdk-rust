...
pub fn de_get_usage_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_usage::GetUsageOutput, crate::operation::get_usage::GetUsageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_usage::GetUsageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_usage_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_usage::GetUsageOutput, crate::operation::get_usage::GetUsageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_usage::builders::GetUsageOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_usage::de_get_usage(response.body().as_ref(), output).map_err(crate::operation::get_usage::GetUsageError::unhandled)?;
