...
pub fn de_get_usage_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_usage::GetUsageOutput, crate::operation::get_usage::GetUsageError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_too_many_requests_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::get_usage::GetUsageError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
                output.build()
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_usage_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_usage::GetUsageOutput, crate::operation::get_usage::GetUsageError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_usage::de_get_usage(_response_body, output)
            .map_err(crate::operation::get_usage::GetUsageError::unhandled)?;
...
) -> Result<crate::operation::get_usage::builders::GetUsageOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
