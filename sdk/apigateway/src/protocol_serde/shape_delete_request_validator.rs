...
pub fn de_delete_request_validator_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_request_validator::DeleteRequestValidatorOutput, crate::operation::delete_request_validator::DeleteRequestValidatorError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_request_validator_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_request_validator::DeleteRequestValidatorOutput, crate::operation::delete_request_validator::DeleteRequestValidatorError> {
    Ok({
        #[allow(unused_mut)]
