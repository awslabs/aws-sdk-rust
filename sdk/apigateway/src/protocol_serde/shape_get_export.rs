...
pub fn de_get_export_http_response(
    ...
    Ok({
        ...
        output = output.set_content_disposition(
            match crate::protocol_serde::shape_get_export_output::de_content_disposition_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_get_export_output::de_content_type_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
