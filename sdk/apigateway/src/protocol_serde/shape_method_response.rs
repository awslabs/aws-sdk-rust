...
pub(crate) fn de_method_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MethodResponse>, aws_smithy_json::deserialize::error::DeserializeError>
