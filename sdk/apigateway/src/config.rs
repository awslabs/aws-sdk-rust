...
impl Builder {
    ...
    /// use aws_sdk_apigateway::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_apigateway::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
