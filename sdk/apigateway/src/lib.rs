...
//!
//! # Examples
//! Examples can be found [here](https://github.com/awslabs/aws-sdk-rust/tree/main/examples/apigateway).
...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("apigateway", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon API Gateway.
pub mod client;
