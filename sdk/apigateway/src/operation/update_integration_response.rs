...
impl UpdateIntegrationResponseInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_integration_response::UpdateIntegrationResponse::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIntegrationResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_integration_response::de_update_integration_response_http_response_with_props(status, headers, body)
        }
    }
}
