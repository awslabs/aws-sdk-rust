...
impl DeleteGatewayResponseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_gateway_response::DeleteGatewayResponse,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGatewayResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_gateway_response::de_delete_gateway_response_http_response_with_props(status, headers, body)
        }
    }
}
