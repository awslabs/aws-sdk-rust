...
impl DeleteIntegrationResponseInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIntegrationResponse`](crate::operation::delete_integration_response::DeleteIntegrationResponse)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_integration_response::DeleteIntegrationResponse,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_integration_response::DeleteIntegrationResponse::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteIntegrationResponse", "apigateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIntegrationResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_integration_response::de_delete_integration_response_http_response_with_props(status, headers, body)
        }
    }
}
