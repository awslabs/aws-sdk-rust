    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::flush_stage_authorizers_cache::FlushStageAuthorizersCacheError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::flush_stage_authorizers_cache::FlushStageAuthorizersCacheOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for FlushStageAuthorizersCacheResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for FlushStageAuthorizersCacheRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::flush_stage_authorizers_cache::FlushStageAuthorizersCacheInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for FlushStageAuthorizersCacheEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::flush_stage_authorizers_cache::FlushStageAuthorizersCacheError {
