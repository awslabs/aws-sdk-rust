...
impl GetBasePathMappings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_base_path_mappings::GetBasePathMappingsInput,
                    ) -> ::std::result::Result<crate::operation::get_base_path_mappings::GetBasePathMappingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_base_path_mappings::GetBasePathMappingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_base_path_mappings::GetBasePathMappingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_base_path_mappings::GetBasePathMappingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBasePathMappings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBasePathMappings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBasePathMappingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBasePathMappingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBasePathMappings")
...
.with_interceptor(GetBasePathMappingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_base_path_mappings::GetBasePathMappingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_base_path_mappings::GetBasePathMappingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_base_path_mappings::GetBasePathMappingsError>::new());
...
#[derive(Debug)]
            struct GetBasePathMappingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBasePathMappingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_base_path_mappings::de_get_base_path_mappings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_base_path_mappings::de_get_base_path_mappings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBasePathMappingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBasePathMappingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_base_path_mappings::GetBasePathMappingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_base_path_mappings::GetBasePathMappingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::get_base_path_mappings::GetBasePathMappingsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetBasePathMappingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBasePathMappingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBasePathMappingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBasePathMappingsInput>()
                        .ok_or("failed to downcast to GetBasePathMappingsInput")?;
...
pub enum GetBasePathMappingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBasePathMappingsError) for what information is available for the error.")]
...
impl GetBasePathMappingsError {
    /// Creates the `GetBasePathMappingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBasePathMappingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBasePathMappingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_base_path_mappings::GetBasePathMappingsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_base_path_mappings::_get_base_path_mappings_output::GetBasePathMappingsOutput;

pub use crate::operation::get_base_path_mappings::_get_base_path_mappings_input::GetBasePathMappingsInput;

mod _get_base_path_mappings_input;

mod _get_base_path_mappings_output;
