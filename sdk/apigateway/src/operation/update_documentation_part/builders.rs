...
impl UpdateDocumentationPartInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.update_documentation_part();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_documentation_part::UpdateDocumentationPartOutput,
                    crate::operation::update_documentation_part::UpdateDocumentationPartError,
                > for UpdateDocumentationPartFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateDocumentationPartFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_documentation_part::UpdateDocumentationPartOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_documentation_part::UpdateDocumentationPartError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_documentation_part::UpdateDocumentationPart::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_documentation_part::UpdateDocumentationPart::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_documentation_part::UpdateDocumentationPartOutput, crate::operation::update_documentation_part::UpdateDocumentationPartError, Self> {
