...
impl UpdateRestApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_rest_api::UpdateRestApi,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/restapis/{restApiId}", restApiId = rest_api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_rest_api::UpdateRestApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRestApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_rest_api::de_update_rest_api_http_error(
                status, headers, body,
            )
        } else {
