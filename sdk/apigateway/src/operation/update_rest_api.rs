...
impl UpdateRestApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_rest_api::UpdateRestApi, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_rest_api::ser_update_rest_api_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRestApi {
    type Output =
        ::std::result::Result<crate::operation::update_rest_api::UpdateRestApiOutput, crate::operation::update_rest_api::UpdateRestApiError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_rest_api::de_update_rest_api_http_response_with_props(status, headers, body)
        }
    }
}
