        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_resource::CreateResourceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if parent_id.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("parent_id", "cannot be empty or unset"))
                            }
                write!(output, "/restapis/{restApiId}/resources/{parentId}", restApiId = rest_api_id, parentId = parent_id).expect("formatting should succeed");
                Ok(())
            }
