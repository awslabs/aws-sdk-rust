...
impl CreateApiKey {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("API Gateway", "CreateApiKey", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "API Gateway.CreateApiKey",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateApiKeyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("customerId") {
            if let ::std::option::Option::Some(value) = input.customer_id.as_deref() {
                captured.insert("customerId", value);
            }
        }
