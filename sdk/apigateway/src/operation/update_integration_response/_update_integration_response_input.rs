...
impl UpdateIntegrationResponseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_integration_response::UpdateIntegrationResponseInput, ::aws_smithy_types::error::operation::BuildError> {
