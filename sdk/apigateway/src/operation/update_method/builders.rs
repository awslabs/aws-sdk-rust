...
pub use crate::operation::update_method::_update_method_output::UpdateMethodOutputBuilder;

pub use crate::operation::update_method::_update_method_input::UpdateMethodInputBuilder;
...
impl UpdateMethodInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.update_method();
...
pub struct UpdateMethodFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::update_method::builders::UpdateMethodInputBuilder,
...
impl UpdateMethodFluentBuilder {
    ...
    /// Access the UpdateMethod as a reference.
    pub fn as_input(&self) -> &crate::operation::update_method::builders::UpdateMethodInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_method::UpdateMethodOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_method::UpdateMethodError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_method::UpdateMethod::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_method::UpdateMethod::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_method::UpdateMethodOutput, crate::operation::update_method::UpdateMethodError, Self> {
