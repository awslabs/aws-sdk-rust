...
impl GetMethodInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_method::GetMethod,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_method::GetMethod::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMethod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_method::de_get_method_http_response_with_props(
                status, headers, body,
            )
        }
    }
