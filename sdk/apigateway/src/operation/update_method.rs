...
impl UpdateMethodInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_method::UpdateMethod, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_method::ser_update_method_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMethod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_method::de_update_method_http_response_with_props(status, headers, body)
        }
    }
}
