...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportDocumentationParts {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ImportDocumentationParts", "apigateway"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportDocumentationParts")
