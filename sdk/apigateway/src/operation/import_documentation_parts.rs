...
impl ImportDocumentationParts {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::import_documentation_parts::ImportDocumentationPartsInput,
                    ) -> ::std::result::Result<crate::operation::import_documentation_parts::ImportDocumentationPartsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_documentation_parts::ImportDocumentationPartsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::import_documentation_parts::ImportDocumentationPartsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::import_documentation_parts::ImportDocumentationPartsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportDocumentationParts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ImportDocumentationParts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ImportDocumentationPartsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ImportDocumentationPartsResponseDeserializer));
...
.with_interceptor(ImportDocumentationPartsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::import_documentation_parts::ImportDocumentationPartsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::import_documentation_parts::ImportDocumentationPartsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::import_documentation_parts::ImportDocumentationPartsError>::new());
...
#[derive(Debug)]
            struct ImportDocumentationPartsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportDocumentationPartsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_import_documentation_parts::de_import_documentation_parts_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_import_documentation_parts::de_import_documentation_parts_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ImportDocumentationPartsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportDocumentationPartsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::import_documentation_parts::ImportDocumentationPartsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::import_documentation_parts::ImportDocumentationPartsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::import_documentation_parts::ImportDocumentationPartsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_documentation_parts_input::ser_body_http_payload( input.body)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportDocumentationPartsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ImportDocumentationPartsInput>()
                        .ok_or("failed to downcast to ImportDocumentationPartsInput")?;
...
pub enum ImportDocumentationPartsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ImportDocumentationPartsError) for what information is available for the error.")]
...
impl ImportDocumentationPartsError {
    /// Creates the `ImportDocumentationPartsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ImportDocumentationPartsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ImportDocumentationPartsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::import_documentation_parts::ImportDocumentationPartsError {
...
mod _import_documentation_parts_output;
