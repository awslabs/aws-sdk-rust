...
impl crate::operation::get_api_key::builders::GetApiKeyInputBuilder {
    ...
    > for GetApiKeyFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_api_key::GetApiKeyOutput, crate::operation::get_api_key::GetApiKeyError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetApiKeyFluentBuilder {
    /// Creates a new `GetApiKeyFluentBuilder`.
