        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::get_client_certificates::GetClientCertificates::orchestrate(&runtime_plugins, input.clone()).await;
...
impl GetClientCertificatesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_client_certificates_output_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
