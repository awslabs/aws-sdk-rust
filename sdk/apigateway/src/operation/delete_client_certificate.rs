...
impl DeleteClientCertificateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_client_certificate::DeleteClientCertificate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClientCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_client_certificate::de_delete_client_certificate_http_response_with_props(status, headers, body)
        }
    }
}
