...
impl DeleteRestApiInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_rest_api::DeleteRestApi::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRestApi {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_rest_api::de_delete_rest_api_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_rest_api::de_delete_rest_api_http_response(
                status, headers, body,
            )
        }
    }
