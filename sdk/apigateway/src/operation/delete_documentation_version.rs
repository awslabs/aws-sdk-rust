...
impl DeleteDocumentationVersionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_documentation_version::DeleteDocumentationVersion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDocumentationVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_documentation_version::de_delete_documentation_version_http_response_with_props(status, headers, body)
        }
    }
}
