...
impl UpdateUsageInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::update_usage::UpdateUsage,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_usage::UpdateUsage::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateUsage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_usage::de_update_usage_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_usage::de_update_usage_http_response_with_props(
                status, headers, body,
            )
        }
    }
