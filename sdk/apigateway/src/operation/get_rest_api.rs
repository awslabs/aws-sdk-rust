...
impl GetRestApiInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_rest_api::GetRestApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRestApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_rest_api::de_get_rest_api_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_rest_api::de_get_rest_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
