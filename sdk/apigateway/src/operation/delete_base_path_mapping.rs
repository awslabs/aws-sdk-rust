...
impl DeleteBasePathMappingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_base_path_mapping::DeleteBasePathMapping,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBasePathMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_base_path_mapping::de_delete_base_path_mapping_http_response_with_props(status, headers, body)
        }
    }
}
