...
impl DeleteBasePathMappingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_base_path_mapping::DeleteBasePathMappingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_base_path_mapping::DeleteBasePathMappingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_base_path_mapping::DeleteBasePathMappingOutput, crate::operation::delete_base_path_mapping::DeleteBasePathMappingError, Self> {
