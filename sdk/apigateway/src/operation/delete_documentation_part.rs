...
impl DeleteDocumentationPartInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_documentation_part::DeleteDocumentationPart,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDocumentationPart {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_documentation_part::de_delete_documentation_part_http_response_with_props(status, headers, body)
        }
    }
}
