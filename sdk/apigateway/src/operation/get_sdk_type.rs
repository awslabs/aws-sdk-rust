    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/sdktypes/{id}", id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_sdk_type::GetSdkType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSdkType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_sdk_type::de_get_sdk_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_sdk_type::de_get_sdk_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
