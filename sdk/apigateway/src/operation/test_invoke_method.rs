...
impl TestInvokeMethodInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_test_invoke_method::ser_test_invoke_method_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestInvokeMethod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_test_invoke_method::de_test_invoke_method_http_response_with_props(status, headers, body)
        }
    }
}
