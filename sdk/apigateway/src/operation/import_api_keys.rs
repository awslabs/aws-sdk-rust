...
impl ImportApiKeysInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::import_api_keys::ImportApiKeys, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_api_keys_input::ser_body_http_payload(self.body)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportApiKeys {
    type Output =
        ::std::result::Result<crate::operation::import_api_keys::ImportApiKeysOutput, crate::operation::import_api_keys::ImportApiKeysError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_import_api_keys::de_import_api_keys_http_response_with_props(status, headers, body)
        }
    }
}
