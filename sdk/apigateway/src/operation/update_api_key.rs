...
impl UpdateApiKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_api_key::UpdateApiKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_api_key::ser_update_api_key_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApiKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_api_key::de_update_api_key_http_response_with_props(status, headers, body)
        }
    }
}
