...
impl UpdateApiKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_api_key::UpdateApiKey,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/apikeys/{apiKey}", apiKey = api_key)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_api_key::UpdateApiKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApiKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_api_key::de_update_api_key_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_api_key::de_update_api_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
