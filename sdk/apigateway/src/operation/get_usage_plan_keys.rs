...
/// Orchestration and serialization glue logic for `GetUsagePlanKeys`.
...
impl GetUsagePlanKeys {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_usage_plan_keys::GetUsagePlanKeysInput,
                    ) -> ::std::result::Result<crate::operation::get_usage_plan_keys::GetUsagePlanKeysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_usage_plan_keys::GetUsagePlanKeysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_usage_plan_keys::GetUsagePlanKeysError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_usage_plan_keys::GetUsagePlanKeysOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUsagePlanKeys {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetUsagePlanKeys");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetUsagePlanKeysRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetUsagePlanKeysResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetUsagePlanKeys")
...
.with_interceptor(GetUsagePlanKeysEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_usage_plan_keys::GetUsagePlanKeysError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_usage_plan_keys::GetUsagePlanKeysError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_usage_plan_keys::GetUsagePlanKeysError>::new());
...
#[derive(Debug)]
            struct GetUsagePlanKeysResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUsagePlanKeysResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_usage_plan_keys::de_get_usage_plan_keys_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetUsagePlanKeysRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUsagePlanKeysRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_usage_plan_keys::GetUsagePlanKeysInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_usage_plan_keys::GetUsagePlanKeysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::get_usage_plan_keys::GetUsagePlanKeysInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.name_query {
         {
...
#[derive(Debug)]
            struct GetUsagePlanKeysEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUsagePlanKeysEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetUsagePlanKeysEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetUsagePlanKeysInput>()
                        .ok_or("failed to downcast to GetUsagePlanKeysInput")?;
...
pub enum GetUsagePlanKeysError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetUsagePlanKeysError) for what information is available for the error.")]
...
impl GetUsagePlanKeysError {
    /// Creates the `GetUsagePlanKeysError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetUsagePlanKeysError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetUsagePlanKeysError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_usage_plan_keys::GetUsagePlanKeysError {
...
mod _get_usage_plan_keys_output;
