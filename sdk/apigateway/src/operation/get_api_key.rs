...
impl GetApiKeyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_api_key::GetApiKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApiKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_api_key::de_get_api_key_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_api_key::de_get_api_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
