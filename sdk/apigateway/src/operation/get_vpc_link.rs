...
impl GetVpcLinkInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_vpc_link::GetVpcLink::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVpcLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_vpc_link::de_get_vpc_link_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_vpc_link::de_get_vpc_link_http_response_with_props(
                status, headers, body,
            )
        }
    }
