...
impl GetRestApisPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::RestApi, ::aws_smithy_http::result::SdkError<crate::operation::get_rest_apis::GetRestApisError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_rest_apis_output_items(page).unwrap_or_default().into_iter())
    }
}
