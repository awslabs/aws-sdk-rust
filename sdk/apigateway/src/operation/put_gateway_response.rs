...
impl PutGatewayResponseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_gateway_response::PutGatewayResponse,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_gateway_response::ser_put_gateway_response_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutGatewayResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_put_gateway_response::de_put_gateway_response_http_response_with_props(status, headers, body)
        }
    }
}
