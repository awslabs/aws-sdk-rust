...
impl GetVpcLinksPaginator {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<
            ...
            ::aws_smithy_http::result::SdkError<crate::operation::get_vpc_links::GetVpcLinksError>,
        >,
    > + ::std::marker::Unpin {
...
impl GetVpcLinksPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::VpcLink, ::aws_smithy_http::result::SdkError<crate::operation::get_vpc_links::GetVpcLinksError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_vpc_links_output_items(page).unwrap_or_default().into_iter())
    }
}
