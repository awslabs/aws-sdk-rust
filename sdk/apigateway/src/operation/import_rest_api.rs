...
impl ImportRestApi {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("API Gateway", "ImportRestApi", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "API Gateway.ImportRestApi",
                "rpc.service" = "API Gateway",
                "rpc.method" = "ImportRestApi",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportRestApi {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportRestApi")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportRestApiResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_import_rest_api::de_import_rest_api_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_import_rest_api::de_import_rest_api_http_response(status, headers, body, _cfg)
        };
