...
impl ImportRestApiInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_rest_api::ImportRestApi::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ImportRestApi {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_import_rest_api::de_import_rest_api_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_import_rest_api::de_import_rest_api_http_response(
                status, headers, body,
            )
        }
    }
