...
impl CreateRestApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_rest_api::CreateRestApi,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_rest_api::CreateRestApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRestApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_rest_api::de_create_rest_api_http_error(
                status, headers, body,
            )
        } else {
