...
impl CreateRestApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_rest_api::CreateRestApi, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_rest_api::ser_create_rest_api_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRestApi {
    type Output =
        ::std::result::Result<crate::operation::create_rest_api::CreateRestApiOutput, crate::operation::create_rest_api::CreateRestApiError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_rest_api::de_create_rest_api_http_response_with_props(status, headers, body)
        }
    }
}
