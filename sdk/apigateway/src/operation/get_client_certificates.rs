...
impl GetClientCertificatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_client_certificates::GetClientCertificates,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClientCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_client_certificates::de_get_client_certificates_http_response_with_props(status, headers, body)
        }
    }
}
