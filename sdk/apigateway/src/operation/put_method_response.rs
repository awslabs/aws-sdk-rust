...
impl PutMethodResponseInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_method_response::ser_put_method_response_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMethodResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_put_method_response::de_put_method_response_http_response_with_props(status, headers, body)
        }
    }
}
