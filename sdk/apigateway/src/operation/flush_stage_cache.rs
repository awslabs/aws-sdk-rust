...
/// Orchestration and serialization glue logic for `FlushStageCache`.
...
impl FlushStageCache {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::flush_stage_cache::FlushStageCacheInput,
                    ) -> ::std::result::Result<crate::operation::flush_stage_cache::FlushStageCacheOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::flush_stage_cache::FlushStageCacheError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::flush_stage_cache::FlushStageCacheError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::flush_stage_cache::FlushStageCacheOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for FlushStageCache {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("FlushStageCache");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(FlushStageCacheRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(FlushStageCacheResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("FlushStageCache")
...
.with_interceptor(FlushStageCacheEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::flush_stage_cache::FlushStageCacheError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::flush_stage_cache::FlushStageCacheError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::flush_stage_cache::FlushStageCacheError>::new());
...
#[derive(Debug)]
            struct FlushStageCacheResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for FlushStageCacheResponseDeserializer {
...
#[derive(Debug)]
            struct FlushStageCacheRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for FlushStageCacheRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::flush_stage_cache::FlushStageCacheInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::flush_stage_cache::FlushStageCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/restapis/{restApiId}/stages/{stageName}/cache/data", restApiId = rest_api_id, stageName = stage_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct FlushStageCacheEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for FlushStageCacheEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "FlushStageCacheEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<FlushStageCacheInput>()
                        .ok_or("failed to downcast to FlushStageCacheInput")?;
...
pub enum FlushStageCacheError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-FlushStageCacheError) for what information is available for the error.")]
...
impl FlushStageCacheError {
    /// Creates the `FlushStageCacheError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `FlushStageCacheError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for FlushStageCacheError {
...
impl ::aws_types::request_id::RequestId for crate::operation::flush_stage_cache::FlushStageCacheError {
