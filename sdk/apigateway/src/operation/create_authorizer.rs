...
impl CreateAuthorizerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_authorizer::CreateAuthorizer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_authorizer::ser_create_authorizer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAuthorizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_authorizer::de_create_authorizer_http_response_with_props(status, headers, body)
        }
    }
}
