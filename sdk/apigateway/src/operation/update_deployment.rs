...
impl UpdateDeploymentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_deployment::UpdateDeployment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_deployment::ser_update_deployment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_deployment::de_update_deployment_http_response_with_props(status, headers, body)
        }
    }
}
