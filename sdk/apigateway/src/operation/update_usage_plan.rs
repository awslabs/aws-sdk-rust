...
impl UpdateUsagePlanInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_usage_plan::UpdateUsagePlan, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_usage_plan::ser_update_usage_plan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUsagePlan {
    type Output =
        ::std::result::Result<crate::operation::update_usage_plan::UpdateUsagePlanOutput, crate::operation::update_usage_plan::UpdateUsagePlanError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_usage_plan::de_update_usage_plan_http_response_with_props(status, headers, body)
        }
    }
}
