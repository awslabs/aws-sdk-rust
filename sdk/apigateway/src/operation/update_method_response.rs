...
impl UpdateMethodResponseInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_method_response::ser_update_method_response_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_method_response::UpdateMethodResponse::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMethodResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_update_method_response::de_update_method_response_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_method_response::UpdateMethodResponseError
{
