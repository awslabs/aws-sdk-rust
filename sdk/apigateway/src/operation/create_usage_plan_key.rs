...
impl CreateUsagePlanKeyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_usage_plan_key::ser_create_usage_plan_key_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_usage_plan_key::CreateUsagePlanKey::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_usage_plan_key::CreateUsagePlanKeyError
{
