...
impl CreateUsagePlanKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_usage_plan_key::CreateUsagePlanKey,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUsagePlanKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_usage_plan_key::de_create_usage_plan_key_http_response_with_props(status, headers, body)
        }
    }
}
