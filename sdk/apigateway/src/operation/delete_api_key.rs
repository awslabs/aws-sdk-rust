...
impl DeleteApiKeyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteApiKey`](crate::operation::delete_api_key::DeleteApiKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_api_key::DeleteApiKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_api_key::DeleteApiKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_api_key::DeleteApiKey::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteApiKey", "apigateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteApiKey {
                type Output = std::result::Result<crate::operation::delete_api_key::DeleteApiKeyOutput, crate::operation::delete_api_key::DeleteApiKeyError>;
