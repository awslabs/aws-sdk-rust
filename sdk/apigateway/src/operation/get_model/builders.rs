...
impl crate::operation::get_model::builders::GetModelInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_model::GetModelOutput, crate::operation::get_model::GetModelError>
    for GetModelFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_model::GetModelOutput, crate::operation::get_model::GetModelError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetModelFluentBuilder {
    /// Creates a new `GetModelFluentBuilder`.
