...
impl GetStagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_stages::GetStages,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_stages::GetStages::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_stages::de_get_stages_http_response_with_props(
                status, headers, body,
            )
        }
    }
