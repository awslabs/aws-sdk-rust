...
impl PutRestApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_rest_api::PutRestApi, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_rest_api_input::ser_body_http_payload(self.body)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRestApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_rest_api::de_put_rest_api_http_response_with_props(status, headers, body)
        }
    }
}
