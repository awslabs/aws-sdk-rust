...
impl GetDocumentationVersionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_documentation_versions::GetDocumentationVersions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocumentationVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_documentation_versions::de_get_documentation_versions_http_response_with_props(status, headers, body)
        }
    }
}
