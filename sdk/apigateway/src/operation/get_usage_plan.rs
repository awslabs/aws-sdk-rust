...
impl GetUsagePlanInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_usage_plan::GetUsagePlan::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetUsagePlan {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_usage_plan::de_get_usage_plan_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_usage_plan::de_get_usage_plan_http_response_with_props(
                status, headers, body,
            )
        }
    }
