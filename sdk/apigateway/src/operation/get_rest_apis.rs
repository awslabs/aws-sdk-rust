...
impl GetRestApisInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_rest_apis::GetRestApis::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRestApis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_rest_apis::de_get_rest_apis_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_rest_apis::de_get_rest_apis_http_response_with_props(
                status, headers, body,
            )
        }
    }
