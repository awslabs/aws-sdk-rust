...
impl DeleteStageInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_stage::DeleteStage::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteStage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_stage::de_delete_stage_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_stage::de_delete_stage_http_response_with_props(
                status, headers, body,
            )
        }
    }
