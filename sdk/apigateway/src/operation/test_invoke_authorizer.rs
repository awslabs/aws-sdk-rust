...
#[derive(Debug)]
    ...
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("authorizer_id", "cannot be empty or unset"))?;
    ...
    if authorizer_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("authorizer_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/restapis/{restApiId}/authorizers/{authorizerId}", restApiId = rest_api_id, authorizerId = authorizer_id).expect("formatting should succeed");
