...
impl GetResourceInput {
    /// Consumes the builder and constructs an Operation<[`GetResource`](crate::operation::get_resource::GetResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_resource::GetResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource::GetResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/restapis/{restApiId}/resources/{resourceId}", restApiId = rest_api_id, resourceId = resource_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_resource::GetResourceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_3) = &_input.embed {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource::GetResource::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetResource", "apigateway"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetResource {
                type Output = std::result::Result<crate::operation::get_resource::GetResourceOutput, crate::operation::get_resource::GetResourceError>;
