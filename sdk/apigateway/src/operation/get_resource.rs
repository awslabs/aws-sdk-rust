...
impl GetResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource::GetResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_resource::de_get_resource_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_resource::de_get_resource_http_response_with_props(
                status, headers, body,
            )
        }
    }
