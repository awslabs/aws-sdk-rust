...
pub use crate::operation::get_method_response::_get_method_response_output::GetMethodResponseOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_method_response::GetMethodResponseOutput,
                    crate::operation::get_method_response::GetMethodResponseError,
                > for GetMethodResponseFluentBuilder
            {
                fn send(
                    self,
...
impl GetMethodResponseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_method_response::GetMethodResponseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_method_response::GetMethodResponseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_method_response::GetMethodResponse::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_method_response::GetMethodResponse::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_method_response::GetMethodResponseOutput, crate::operation::get_method_response::GetMethodResponseError, Self> {
