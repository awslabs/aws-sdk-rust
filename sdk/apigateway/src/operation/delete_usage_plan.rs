...
impl DeleteUsagePlanInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_usage_plan::DeleteUsagePlan, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUsagePlan {
    type Output =
        ::std::result::Result<crate::operation::delete_usage_plan::DeleteUsagePlanOutput, crate::operation::delete_usage_plan::DeleteUsagePlanError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_usage_plan::de_delete_usage_plan_http_response_with_props(status, headers, body)
        }
    }
}
