...
impl GetUsagePlanKeysOutput {
    ...
    pub fn items(&self) -> &[crate::types::UsagePlanKey] {
...
impl ::aws_types::request_id::RequestId for GetUsagePlanKeysOutput {
...
impl GetUsagePlanKeysOutputBuilder {
    ...
    /// <p>The current page of elements from this collection.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::UsagePlanKey>> {
        &self.items
    }
    /// <p>The current pagination position in the paged result set.</p>
