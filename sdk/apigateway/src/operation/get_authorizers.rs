...
impl GetAuthorizersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_authorizers::GetAuthorizers,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_authorizers::GetAuthorizers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAuthorizers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_authorizers::de_get_authorizers_http_error(
                status, headers, body,
            )
        } else {
