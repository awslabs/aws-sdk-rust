...
impl GetUsagePlansInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_usage_plans::GetUsagePlans, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUsagePlans {
    type Output =
        ::std::result::Result<crate::operation::get_usage_plans::GetUsagePlansOutput, crate::operation::get_usage_plans::GetUsagePlansError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_usage_plans::de_get_usage_plans_http_response_with_props(status, headers, body)
        }
    }
}
