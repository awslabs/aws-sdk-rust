...
impl GetUsagePlansInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_usage_plans::GetUsagePlans,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_usage_plans::GetUsagePlans::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUsagePlans {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_usage_plans::de_get_usage_plans_http_error(
                status, headers, body,
            )
        } else {
