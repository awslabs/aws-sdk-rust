...
pub use crate::operation::delete_method_response::_delete_method_response_output::DeleteMethodResponseOutputBuilder;

pub use crate::operation::delete_method_response::_delete_method_response_input::DeleteMethodResponseInputBuilder;
...
impl DeleteMethodResponseInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_method_response();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_method_response::DeleteMethodResponseOutput,
                    crate::operation::delete_method_response::DeleteMethodResponseError,
                > for DeleteMethodResponseFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteMethodResponseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_method_response::DeleteMethodResponseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_method_response::DeleteMethodResponseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_method_response::DeleteMethodResponse::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_method_response::DeleteMethodResponse::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_method_response::DeleteMethodResponseOutput, crate::operation::delete_method_response::DeleteMethodResponseError, Self> {
