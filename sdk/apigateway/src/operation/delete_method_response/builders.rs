...
impl DeleteMethodResponseFluentBuilder  {
    /// Creates a new `DeleteMethodResponse`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_method_response::DeleteMethodResponseOutput, aws_smithy_http::result::SdkError<crate::operation::delete_method_response::DeleteMethodResponseError>>
                     {
