...
impl crate::operation::delete_documentation_version::builders::DeleteDocumentationVersionInputBuilder {
...
impl DeleteDocumentationVersionFluentBuilder {
    /// Creates a new `DeleteDocumentationVersionFluentBuilder`.
