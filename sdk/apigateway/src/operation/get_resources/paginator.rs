...
impl GetResourcesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Resource, ::aws_smithy_http::result::SdkError<crate::operation::get_resources::GetResourcesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_resources_output_items(page).unwrap_or_default().into_iter())
    }
}
