...
impl CreateDeployment {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("API Gateway", "CreateDeployment", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDeploymentTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("stageDescription") {
            if let ::std::option::Option::Some(value) = input.stage_description.as_deref() {
                captured.insert("stageDescription", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/restapis/{restApiId}/deployments", restApiId = rest_api_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
