...
impl GetApiKeysInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_api_keys::GetApiKeys::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetApiKeys {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_api_keys::de_get_api_keys_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_api_keys::de_get_api_keys_http_response_with_props(
                status, headers, body,
            )
        }
    }
