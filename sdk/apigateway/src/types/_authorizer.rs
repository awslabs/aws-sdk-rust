...
impl Authorizer {
    /// Creates a new builder-style object to manufacture [`Authorizer`](crate::types::Authorizer).
    pub fn builder() -> crate::types::builders::AuthorizerBuilder {
        crate::types::builders::AuthorizerBuilder::default()
    }
}

/// A builder for [`Authorizer`](crate::types::Authorizer).
#[non_exhaustive]
...
impl AuthorizerBuilder {
    ...
    /// Consumes the builder and constructs a [`Authorizer`](crate::types::Authorizer).
    pub fn build(self) -> crate::types::Authorizer {
        crate::types::Authorizer {
            id: self.id
            ,
            name: self.name
            ,
