...
pub struct Method {
    ...
    pub method_responses: ::std::option::Option<
        ::std::collections::HashMap<::std::string::String, crate::types::MethodResponse>,
    >,
...
impl MethodBuilder {
    ...
    pub fn set_method_integration(
        mut self,
        input: ::std::option::Option<crate::types::Integration>,
    ) -> Self {
