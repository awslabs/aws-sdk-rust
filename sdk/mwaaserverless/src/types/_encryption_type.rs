...
impl ::std::convert::From<&str> for EncryptionType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_MANAGED_KEY" => EncryptionType::AwsManagedKey,
            "CUSTOMER_MANAGED_KEY" => EncryptionType::CustomerManagedKey,
...
impl EncryptionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EncryptionType::AwsManagedKey => "AWS_MANAGED_KEY",
            EncryptionType::CustomerManagedKey => "CUSTOMER_MANAGED_KEY",
...
impl ::std::fmt::Display for EncryptionType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EncryptionType::AwsManagedKey => write!(f, "AWS_MANAGED_KEY"),
            EncryptionType::CustomerManagedKey => write!(f, "CUSTOMER_MANAGED_KEY"),
