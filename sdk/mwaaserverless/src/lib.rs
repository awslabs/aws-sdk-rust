...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-mwaaserverless/latest/aws_sdk_mwaaserverless/client/struct.Client.html)
...
//! offered by AmazonMWAAServerless. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AmazonMWAAServerless.
...
/// For example, the [`CreateWorkflow`](crate::operation::create_workflow) operation has
...
/// Configuration for AmazonMWAAServerless.
pub mod config;
