...
impl UntagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MWAA Serverless", "UntagResource", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "MWAA Serverless.UntagResource",
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                for inner_2 in inner_1 {
                    query.push_kv("tagKeys", &::aws_smithy_http::query::fmt_string(inner_2));
                }
                ::std::result::Result::Ok(())
            }
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonMWAAServerless.UntagResource",
            );
            builder
        };
...
impl UntagResourceError {
    ...
    /// Returns `true` if the error kind is `UntagResourceError::OperationTimeoutException`.
