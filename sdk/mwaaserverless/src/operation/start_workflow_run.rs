...
impl StartWorkflowRun {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MWAA Serverless", "StartWorkflowRun", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "MWAA Serverless.StartWorkflowRun",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonMWAAServerless.StartWorkflowRun",
            );
            builder
        };
...
impl StartWorkflowRunError {
    ...
    /// Returns `true` if the error kind is `StartWorkflowRunError::InternalServerException`.
