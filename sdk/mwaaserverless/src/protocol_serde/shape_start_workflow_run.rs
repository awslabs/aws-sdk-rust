...
pub fn de_start_workflow_run_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::start_workflow_run::StartWorkflowRunError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "OperationTimeoutException" => crate::operation::start_workflow_run::StartWorkflowRunError::OperationTimeoutException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
