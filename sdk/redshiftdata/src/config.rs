...
impl Builder {
    ...
    /// use aws_sdk_redshiftdata::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_redshiftdata::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
