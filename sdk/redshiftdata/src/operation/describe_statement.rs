...
impl DescribeStatementInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_statement::ser_describe_statement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_statement::de_describe_statement_http_response_with_props(status, headers, body)
        }
    }
}
