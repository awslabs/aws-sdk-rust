...
impl ListTables {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift Data", "ListTables", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTablesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("TablePattern") {
            if let ::std::option::Option::Some(value) = input.table_pattern.as_deref() {
                captured.insert("TablePattern", value);
            }
        }
...
impl ListTablesError {
    ...
    /// Returns `true` if the error kind is `ListTablesError::QueryTimeoutException`.
