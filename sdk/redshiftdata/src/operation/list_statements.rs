...
impl ListStatementsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_statements::ListStatements, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_statements::ser_list_statements_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStatements {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_statements::de_list_statements_http_response_with_props(status, headers, body)
        }
    }
}
