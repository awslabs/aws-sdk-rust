...
impl  GetStatementResultOutput  {
    ...
    pub fn records(&self) -> & [::std::vec::Vec::<crate::types::Field>] {
        use std::ops::Deref; self.records.deref()
    }
    /// <p>The properties (metadata) of a column.</p>
    /// 
...
impl GetStatementResultOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_statement_result::GetStatementResultOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_statement_result::GetStatementResultOutput {
                records: self.records
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("records", "records was not specified but it is required when building GetStatementResultOutput")
                    )?
                ,
