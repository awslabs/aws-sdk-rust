...
impl GetStatementResultInputBuilder {
    ...
    /// - [`id`](crate::operation::get_statement_result::builders::GetStatementResultInputBuilder::id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::get_statement_result::GetStatementResultInput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetStatementResultInput",
                )
            })?,
