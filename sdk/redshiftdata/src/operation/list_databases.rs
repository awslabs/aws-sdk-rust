...
impl ListDatabasesInput {
    /// Consumes the builder and constructs an Operation<[`ListDatabases`](crate::operation::list_databases::ListDatabases)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_databases::ListDatabases, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_databases::ser_list_databases_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_databases::ListDatabases::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDatabases {
    type Output = ::std::result::Result<crate::operation::list_databases::ListDatabasesOutput, crate::operation::list_databases::ListDatabasesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_databases::de_list_databases_http_response_with_props(status, headers, body)
        }
    }
}
