...
impl GetStatementResultInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_statement_result::ser_get_statement_result_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStatementResult {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_statement_result::de_get_statement_result_http_response_with_props(status, headers, body)
        }
    }
}
