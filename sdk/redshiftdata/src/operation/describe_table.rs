...
impl DescribeTable {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift Data", "DescribeTable", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeTableTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("Table") {
            if let ::std::option::Option::Some(value) = input.table.as_deref() {
                captured.insert("Table", value);
            }
        }
...
impl DescribeTableError {
    ...
    /// Returns `true` if the error kind is `DescribeTableError::QueryTimeoutException`.
