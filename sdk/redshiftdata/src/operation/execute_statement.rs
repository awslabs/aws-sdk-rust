...
impl ExecuteStatement {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Redshift Data", "ExecuteStatement", input, runtime_plugins, stop_point)
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::execute_statement::ExecuteStatementInput = input.downcast_mut().expect("correct type");
...
impl ExecuteStatementError {
    ...
    /// Returns `true` if the error kind is `ExecuteStatementError::ActiveSessionsExceededException`.
    ...
    /// Returns `true` if the error kind is `ExecuteStatementError::InternalServerException`.
