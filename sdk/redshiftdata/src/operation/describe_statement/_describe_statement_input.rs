...
impl DescribeStatementInputBuilder {
    ...
    /// - [`id`](crate::operation::describe_statement::builders::DescribeStatementInputBuilder::id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::describe_statement::DescribeStatementInput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building DescribeStatementInput",
                )
            })?,
        })
    }
