...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::cancel_statement::builders::CancelStatementFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::cancel_statement::builders::CancelStatementFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the SQL statement to cancel. This value is a universally unique identifier (UUID) generated by Amazon Redshift Data API. This identifier is returned by <code>BatchExecuteStatment</code>, <code>ExecuteStatment</code>, and <code>ListStatements</code>. </p><br>
