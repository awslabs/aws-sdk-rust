    ...
    Err(match error_code {
        ...
        "ActiveStatementsExceededException" => crate::operation::execute_statement::ExecuteStatementError::ActiveStatementsExceededException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_active_statements_exceeded_exception::de_active_statements_exceeded_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::execute_statement::ExecuteStatementError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "DbGroups" => {
                    builder = builder.set_db_groups(crate::protocol_serde::shape_db_group_list::de_db_group_list(tokens, _value, depth + 1)?);
                }
                "Database" => {
