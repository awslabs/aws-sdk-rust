...
pub fn de_describe_statement_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_statement::DescribeStatementOutput, crate::operation::describe_statement::DescribeStatementError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::describe_statement::DescribeStatementOutput, crate::operation::describe_statement::DescribeStatementError>
{
    Ok({
        ...
        crate::serde_util::describe_statement_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_statement::DescribeStatementError::unhandled)?
    })
}
...
) -> Result<crate::operation::describe_statement::builders::DescribeStatementOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::StatusString::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "CreatedAt" => {
