...
> {
    ...
    Err(match error_code {
        "ActiveWaitingRequestsExceededException" => {
            crate::operation::get_statement_result_v2::GetStatementResultV2Error::ActiveWaitingRequestsExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ActiveWaitingRequestsExceededExceptionBuilder::default();
                    output = crate::protocol_serde::shape_active_waiting_requests_exceeded_exception::de_active_waiting_requests_exceeded_exception_json_err(_response_body, output).map_err(crate::operation::get_statement_result_v2::GetStatementResultV2Error::unhandled)?;
