...
/// For example, the [`BatchGetTraces`](crate::operation) operation has
...
mod get_sampling_statistic_summaries;

mod get_sampling_targets;

mod get_service_graph;

mod get_time_series_service_statistics;
...
mod put_encryption_config;

mod put_resource_policy;

mod put_telemetry_records;
