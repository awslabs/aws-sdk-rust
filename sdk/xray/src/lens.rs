...
pub(crate) fn reflens_batch_get_traces_output_output_next_token(
...
pub(crate) fn reflens_get_groups_output_output_next_token(
...
pub(crate) fn reflens_get_insight_events_output_output_next_token(
...
pub(crate) fn reflens_get_insight_summaries_output_output_next_token(
...
pub(crate) fn reflens_get_sampling_rules_output_output_next_token(
...
pub(crate) fn reflens_get_sampling_statistic_summaries_output_output_next_token(
...
pub(crate) fn reflens_get_service_graph_output_output_next_token(
...
pub(crate) fn reflens_get_time_series_service_statistics_output_output_next_token(
...
pub(crate) fn reflens_get_trace_graph_output_output_next_token(
...
pub(crate) fn reflens_get_trace_summaries_output_output_next_token(
...
pub(crate) fn lens_batch_get_traces_output_output_traces(
    input: crate::operation::batch_get_traces::BatchGetTracesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::Trace>> {
    let input = input.traces?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_get_groups_output_output_groups(
    input: crate::operation::get_groups::GetGroupsOutput,
...
pub(crate) fn lens_get_sampling_rules_output_output_sampling_rule_records(
    input: crate::operation::get_sampling_rules::GetSamplingRulesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::SamplingRuleRecord>> {
    let input = input.sampling_rule_records?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_get_sampling_statistic_summaries_output_output_sampling_statistic_summaries(
    input: crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::SamplingStatisticSummary>> {
    let input = input.sampling_statistic_summaries?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_get_service_graph_output_output_services(
    input: crate::operation::get_service_graph::GetServiceGraphOutput,
...
pub(crate) fn lens_get_time_series_service_statistics_output_output_time_series_service_statistics(
    input: crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatisticsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::TimeSeriesServiceStatistics>> {
    let input = input.time_series_service_statistics?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_get_trace_graph_output_output_services(
    input: crate::operation::get_trace_graph::GetTraceGraphOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::Service>> {
    let input = input.services?;
    ::std::option::Option::Some(input)
...
pub(crate) fn lens_get_trace_summaries_output_output_trace_summaries(
    input: crate::operation::get_trace_summaries::GetTraceSummariesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::TraceSummary>> {
    let input = input.trace_summaries?;
    ::std::option::Option::Some(input)
}
