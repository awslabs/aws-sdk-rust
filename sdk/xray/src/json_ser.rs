...
pub fn serialize_structure_crate_input_batch_get_traces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchGetTracesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_sampling_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSamplingRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_sampling_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteSamplingRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_groups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetGroupsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_insight_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetInsightInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_insight_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetInsightEventsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_insight_impact_graph_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetInsightImpactGraphInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_30) = &input.end_time {
        object.key("EndTime").date_time(var_30, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_33) = &input.start_time {
        object.key("StartTime").date_time(var_33, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}

pub fn serialize_structure_crate_input_get_insight_summaries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetInsightSummariesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_34) = &input.end_time {
        object.key("EndTime").date_time(var_34, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_39) = &input.start_time {
        object.key("StartTime").date_time(var_39, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_get_sampling_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSamplingRulesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_sampling_statistic_summaries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSamplingStatisticSummariesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_sampling_targets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSamplingTargetsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_47 in var_45 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_sampling_statistics_document(&mut object_48, item_47)?;
                object_48.finish();
            }
        }
        array_46.finish();
...
pub fn serialize_structure_crate_input_get_service_graph_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetServiceGraphInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_53) = &input.start_time {
        object.key("StartTime").date_time(var_53, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}

pub fn serialize_structure_crate_input_get_time_series_service_statistics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTimeSeriesServiceStatisticsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_55) = &input.entity_selector_expression {
        object.key("EntitySelectorExpression").string(var_55.as_str());
    }
    ...
    if let Some(var_60) = &input.period {
        object.key("Period").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_60).into()));
    }
    if let Some(var_61) = &input.start_time {
        object.key("StartTime").date_time(var_61, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}

pub fn serialize_structure_crate_input_get_trace_graph_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTraceGraphInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_trace_summaries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTraceSummariesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_encryption_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutEncryptionConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_telemetry_records_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutTelemetryRecordsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_83 in var_81 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_telemetry_record(&mut object_84, item_83)?;
                object_84.finish();
            }
        }
        array_82.finish();
...
pub fn serialize_structure_crate_input_put_trace_segments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutTraceSegmentsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_100) = &input.insights_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_insights_configuration(&mut object_101, var_100)?;
        object_101.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_input_update_sampling_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSamplingRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_102) = &input.sampling_rule_update {
        let mut object_103 = object.key("SamplingRuleUpdate").start_object();
        crate::json_ser::serialize_structure_crate_model_sampling_rule_update(&mut object_103, var_102)?;
        object_103.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_insights_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InsightsConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sampling_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamplingRule) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sampling_statistics_document(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamplingStatisticsDocument) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_122) = &input.timestamp {
        object.key("Timestamp").date_time(var_122, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
     {
...
pub fn serialize_structure_crate_model_sampling_strategy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamplingStrategy) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_123) = &input.name {
        object.key("Name").string(var_123.as_str());
    }
    if let Some(var_124) = &input.value {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_124).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_telemetry_record(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TelemetryRecord) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_125) = &input.timestamp {
        object.key("Timestamp").date_time(var_125, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_126) = &input.segments_received_count {
        object.key("SegmentsReceivedCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_126).into()));
    }
    if let Some(var_127) = &input.segments_sent_count {
        object.key("SegmentsSentCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_127).into()));
    }
    if let Some(var_128) = &input.segments_spillover_count {
        object.key("SegmentsSpilloverCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_128).into()));
    }
    if let Some(var_129) = &input.segments_rejected_count {
        object.key("SegmentsRejectedCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_129).into()));
    }
    if let Some(var_130) = &input.backend_connection_errors {
        let mut object_131 = object.key("BackendConnectionErrors").start_object();
        crate::json_ser::serialize_structure_crate_model_backend_connection_errors(&mut object_131, var_130)?;
        object_131.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_sampling_rule_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamplingRuleUpdate) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_135) = &input.priority {
        object.key("Priority").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_135).into()));
    }
    if let Some(var_136) = &input.fixed_rate {
        object.key("FixedRate").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_136).into()));
    }
    if let Some(var_137) = &input.reservoir_size {
        object.key("ReservoirSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_137).into()));
    }
...
pub fn serialize_structure_crate_model_backend_connection_errors(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BackendConnectionErrors) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_147) = &input.timeout_count {
        object.key("TimeoutCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_147).into()));
    }
    if let Some(var_148) = &input.connection_refused_count {
        object.key("ConnectionRefusedCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_148).into()));
    }
    if let Some(var_149) = &input.http_code4_xx_count {
        object.key("HTTPCode4XXCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_149).into()));
    }
    if let Some(var_150) = &input.http_code5_xx_count {
        object.key("HTTPCode5XXCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_150).into()));
    }
    if let Some(var_151) = &input.unknown_host_count {
        object.key("UnknownHostCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_151).into()));
    }
    if let Some(var_152) = &input.other_count {
        object.key("OtherCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_152).into()));
    }
    Ok(())
}
