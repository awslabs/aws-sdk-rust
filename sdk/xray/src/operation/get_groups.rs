...
impl GetGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_groups::GetGroups,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_groups::GetGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_groups::de_get_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
