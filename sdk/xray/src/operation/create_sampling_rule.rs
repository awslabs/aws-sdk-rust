...
impl CreateSamplingRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_sampling_rule::ser_create_sampling_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSamplingRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_sampling_rule::de_create_sampling_rule_http_response_with_props(status, headers, body)
        }
    }
}
