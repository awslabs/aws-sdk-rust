...
impl CreateSamplingRuleInput {
    /// Consumes the builder and constructs an Operation<[`CreateSamplingRule`](crate::operation::create_sampling_rule::CreateSamplingRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_sampling_rule::CreateSamplingRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_sampling_rule::CreateSamplingRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_sampling_rule::ser_create_sampling_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_sampling_rule::CreateSamplingRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSamplingRule {
                type Output = std::result::Result<crate::operation::create_sampling_rule::CreateSamplingRuleOutput, crate::operation::create_sampling_rule::CreateSamplingRuleError>;
