...
impl GetInsightEventsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_insight_events::ser_get_insight_events_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInsightEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_insight_events::de_get_insight_events_http_response_with_props(status, headers, body)
        }
    }
}
