...
impl GetServiceGraphInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_service_graph::GetServiceGraph, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_graph::ser_get_service_graph_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceGraph {
    type Output =
        ::std::result::Result<crate::operation::get_service_graph::GetServiceGraphOutput, crate::operation::get_service_graph::GetServiceGraphError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_graph::de_get_service_graph_http_response_with_props(status, headers, body)
        }
    }
}
