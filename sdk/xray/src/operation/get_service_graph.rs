...
impl aws_smithy_http::response::ParseStrictResponse for GetServiceGraph {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_service_graph::de_get_service_graph_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_service_graph::de_get_service_graph_http_response(response)
                     }
                }
            }
