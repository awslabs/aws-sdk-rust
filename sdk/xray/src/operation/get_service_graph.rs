...
impl GetServiceGraphInput {
    /// Consumes the builder and constructs an Operation<[`GetServiceGraph`](crate::operation::get_service_graph::GetServiceGraph)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_service_graph::GetServiceGraph, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_service_graph::GetServiceGraphInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_service_graph::ser_get_service_graph_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_service_graph::GetServiceGraph::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetServiceGraph", "xray"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetServiceGraph`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetServiceGraph {
                type Output = std::result::Result<crate::operation::get_service_graph::GetServiceGraphOutput, crate::operation::get_service_graph::GetServiceGraphError>;
