...
impl GetServiceGraphInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_service_graph::GetServiceGraph::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceGraph {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_service_graph::de_get_service_graph_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_service_graph::GetServiceGraphError
{
