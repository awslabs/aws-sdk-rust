...
impl GetTraceSummariesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_trace_summaries::ser_get_trace_summaries_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTraceSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_trace_summaries::de_get_trace_summaries_http_response_with_props(status, headers, body)
        }
    }
}
