...
impl GetInsightImpactGraphFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_insight_impact_graph::GetInsightImpactGraphOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_insight_impact_graph::GetInsightImpactGraphError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_insight_impact_graph::GetInsightImpactGraphOutput, crate::operation::get_insight_impact_graph::GetInsightImpactGraphError, Self> {
