...
impl ListResourcePoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListResourcePolicies`](crate::operation::list_resource_policies::ListResourcePolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_resource_policies::ListResourcePolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_policies::ListResourcePoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resource_policies::ser_list_resource_policies_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_policies::ListResourcePolicies::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListResourcePolicies {
                type Output = std::result::Result<crate::operation::list_resource_policies::ListResourcePoliciesOutput, crate::operation::list_resource_policies::ListResourcePoliciesError>;
