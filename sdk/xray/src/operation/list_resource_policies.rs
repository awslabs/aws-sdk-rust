...
impl ListResourcePoliciesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resource_policies::ser_list_resource_policies_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resource_policies::ListResourcePolicies::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_resource_policies::ListResourcePoliciesError
{
