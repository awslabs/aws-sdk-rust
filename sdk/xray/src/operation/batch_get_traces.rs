...
impl BatchGetTracesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_get_traces::BatchGetTraces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_traces::BatchGetTracesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetTraces {
                type Output = std::result::Result<crate::operation::batch_get_traces::BatchGetTracesOutput, crate::operation::batch_get_traces::BatchGetTracesError>;
