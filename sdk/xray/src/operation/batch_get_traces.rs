...
impl BatchGetTracesInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetTraces`](crate::operation::batch_get_traces::BatchGetTraces)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_get_traces::BatchGetTraces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_traces::ser_batch_get_traces_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_traces::BatchGetTraces::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetTraces {
    type Output =
        ::std::result::Result<crate::operation::batch_get_traces::BatchGetTracesOutput, crate::operation::batch_get_traces::BatchGetTracesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_traces::de_batch_get_traces_http_response_with_props(status, headers, body)
        }
    }
}
