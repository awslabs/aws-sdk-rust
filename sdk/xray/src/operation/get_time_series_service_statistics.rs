    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/TimeSeriesServiceStatistics")
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTimeSeriesServiceStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_time_series_service_statistics::de_get_time_series_service_statistics_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatisticsError
{
