...
impl GetTimeSeriesServiceStatisticsInput {
    /// Consumes the builder and constructs an Operation<[`GetTimeSeriesServiceStatistics`](crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatistics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatistics, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatisticsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_time_series_service_statistics::ser_get_time_series_service_statistics_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatistics::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTimeSeriesServiceStatistics", "xray"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetTimeSeriesServiceStatistics`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetTimeSeriesServiceStatistics {
                type Output = std::result::Result<crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatisticsOutput, crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatisticsError>;
