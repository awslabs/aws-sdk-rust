...
impl GetTimeSeriesServiceStatisticsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatistics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTimeSeriesServiceStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_time_series_service_statistics::de_get_time_series_service_statistics_http_response_with_props(
                status, headers, body,
            )
        }
    }
