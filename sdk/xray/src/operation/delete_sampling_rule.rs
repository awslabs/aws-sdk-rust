...
impl DeleteSamplingRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_sampling_rule::ser_delete_sampling_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSamplingRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_sampling_rule::de_delete_sampling_rule_http_response_with_props(status, headers, body)
        }
    }
}
