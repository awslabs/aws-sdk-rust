...
impl GetSamplingStatisticSummariesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummaries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSamplingStatisticSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sampling_statistic_summaries::de_get_sampling_statistic_summaries_http_response_with_props(
                status, headers, body,
            )
        }
    }
