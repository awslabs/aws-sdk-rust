...
/// Orchestration and serialization glue logic for `GetSamplingStatisticSummaries`.
...
impl GetSamplingStatisticSummaries {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSamplingStatisticSummaries {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSamplingStatisticSummaries");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSamplingStatisticSummariesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSamplingStatisticSummariesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSamplingStatisticSummaries")
...
.with_interceptor(GetSamplingStatisticSummariesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesError>::new());
...
#[derive(Debug)]
            struct GetSamplingStatisticSummariesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSamplingStatisticSummariesResponseDeserializer {
...
#[derive(Debug)]
            struct GetSamplingStatisticSummariesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSamplingStatisticSummariesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/SamplingStatisticSummaries").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_sampling_statistic_summaries::ser_get_sampling_statistic_summaries_input(&input)?);
...
#[derive(Debug)]
            struct GetSamplingStatisticSummariesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSamplingStatisticSummariesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSamplingStatisticSummariesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSamplingStatisticSummariesInput>()
                        .ok_or("failed to downcast to GetSamplingStatisticSummariesInput")?;
...
pub enum GetSamplingStatisticSummariesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSamplingStatisticSummariesError) for what information is available for the error.")]
...
impl GetSamplingStatisticSummariesError {
    /// Creates the `GetSamplingStatisticSummariesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSamplingStatisticSummariesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSamplingStatisticSummariesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_sampling_statistic_summaries::GetSamplingStatisticSummariesError {
...
mod _get_sampling_statistic_summaries_output;
