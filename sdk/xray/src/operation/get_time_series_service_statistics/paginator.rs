        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatistics::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl GetTimeSeriesServiceStatisticsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_time_series_service_statistics_output_output_time_series_service_statistics(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
