...
impl GetSamplingRulesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_sampling_rules::GetSamplingRules,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_sampling_rules::ser_get_sampling_rules_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSamplingRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sampling_rules::de_get_sampling_rules_http_response_with_props(status, headers, body)
        }
    }
}
