...
impl GetInsightInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_insight::GetInsight::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetInsight {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_insight::de_get_insight_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_insight::de_get_insight_http_response_with_props(
                status, headers, body,
            )
        }
    }
