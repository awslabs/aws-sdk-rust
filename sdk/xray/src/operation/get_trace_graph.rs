...
impl GetTraceGraphInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_trace_graph::GetTraceGraph, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_trace_graph::ser_get_trace_graph_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTraceGraph {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_trace_graph::de_get_trace_graph_http_response_with_props(status, headers, body)
        }
    }
}
