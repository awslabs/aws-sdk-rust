...
impl GetSamplingTargetsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_sampling_targets::ser_get_sampling_targets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSamplingTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sampling_targets::de_get_sampling_targets_http_response_with_props(status, headers, body)
        }
    }
}
