...
impl GetSamplingTargetsInput {
    /// Consumes the builder and constructs an Operation<[`GetSamplingTargets`](crate::operation::get_sampling_targets::GetSamplingTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_sampling_targets::GetSamplingTargets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_sampling_targets::GetSamplingTargetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_sampling_targets::GetSamplingTargets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetSamplingTargets {
                type Output = std::result::Result<crate::operation::get_sampling_targets::GetSamplingTargetsOutput, crate::operation::get_sampling_targets::GetSamplingTargetsError>;
