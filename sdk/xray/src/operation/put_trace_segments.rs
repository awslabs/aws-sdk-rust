...
impl PutTraceSegmentsInput {
    /// Consumes the builder and constructs an Operation<[`PutTraceSegments`](crate::operation::put_trace_segments::PutTraceSegments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_trace_segments::PutTraceSegments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_trace_segments::PutTraceSegmentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_trace_segments::ser_put_trace_segments_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_trace_segments::PutTraceSegments::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutTraceSegments {
                type Output = std::result::Result<crate::operation::put_trace_segments::PutTraceSegmentsOutput, crate::operation::put_trace_segments::PutTraceSegmentsError>;
