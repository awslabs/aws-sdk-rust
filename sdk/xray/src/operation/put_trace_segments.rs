...
impl PutTraceSegmentsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_trace_segments::ser_put_trace_segments_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutTraceSegments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_trace_segments::de_put_trace_segments_http_response_with_props(status, headers, body)
        }
    }
}
