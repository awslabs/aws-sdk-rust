...
pub(crate) fn de_insight_event<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InsightEvent>, aws_smithy_json::deserialize::error::DeserializeError>
