...
pub fn ser_create_sampling_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_sampling_rule::CreateSamplingRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
