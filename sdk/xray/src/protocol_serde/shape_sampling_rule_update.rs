...
pub fn ser_sampling_rule_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamplingRuleUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
