...
pub(crate) fn de_trace_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TraceSummary>, aws_smithy_json::deserialize::error::DeserializeError>
