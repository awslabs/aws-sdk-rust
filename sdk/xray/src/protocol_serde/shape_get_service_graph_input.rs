...
pub fn ser_get_service_graph_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetServiceGraphInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
