...
pub fn ser_sampling_statistics_document(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SamplingStatisticsDocument) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
