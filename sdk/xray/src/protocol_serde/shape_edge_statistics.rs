...
pub(crate) fn de_edge_statistics<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EdgeStatistics>, aws_smithy_json::deserialize::error::DeserializeError>
