    ...
    Err(match error_code {
        ...
        "LockoutPreventionException" => crate::operation::put_resource_policy::PutResourcePolicyError::LockoutPreventionException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_lockout_prevention_exception::de_lockout_prevention_exception_json_err(_response_body, output)
                    .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "PolicyCountLimitExceededException" => crate::operation::put_resource_policy::PutResourcePolicyError::PolicyCountLimitExceededException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_policy_count_limit_exceeded_exception::de_policy_count_limit_exceeded_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
