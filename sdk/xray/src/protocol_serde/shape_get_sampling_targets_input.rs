...
pub fn ser_get_sampling_targets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSamplingTargetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
