...
pub fn ser_get_time_series_service_statistics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTimeSeriesServiceStatisticsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
