...
impl DeleteSamplingRuleInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_sampling_rule::ser_delete_sampling_rule_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl GetInsightSummariesInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_insight_summaries::ser_get_insight_summaries_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl GetSamplingTargetsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_sampling_targets::ser_get_sampling_targets_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl ListResourcePoliciesInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::input::ListResourcePoliciesInput,
                output: &mut String,
            ) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::ListResourcePolicies::new(),
        )
        .with_metadata(aws_smithy_http::operation::Metadata::new(
...
impl PutEncryptionConfigInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_encryption_config::ser_put_encryption_config_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl PutTelemetryRecordsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_telemetry_records::ser_put_telemetry_records_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateSamplingRuleInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_sampling_rule::ser_update_sampling_rule_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
pub mod list_resource_policies_input {
    ...
    impl Builder {
        ...
        pub fn build(
            ...
            aws_smithy_http::operation::error::BuildError,
        > {
            Ok(crate::input::ListResourcePoliciesInput {
                next_token: self.next_token,
            })
        }
    }
...
pub mod get_trace_graph_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetTraceGraphInput, aws_smithy_http::operation::error::BuildError>
        {
...
pub mod get_service_graph_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetServiceGraphInput, aws_smithy_http::operation::error::BuildError>
        {
...
pub mod get_insight_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetInsightInput, aws_smithy_http::operation::error::BuildError>
        {
...
pub mod get_groups_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::GetGroupsInput, aws_smithy_http::operation::error::BuildError>
        {
...
pub mod batch_get_traces_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::BatchGetTracesInput, aws_smithy_http::operation::error::BuildError>
        {
