...
pub struct GetTraceSummariesOutput {
    ...
    pub approximate_time: std::option::Option<smithy_types::Instant>,
...
pub mod get_trace_summaries_output {
    ...
    pub struct Builder {
        ...
        pub(crate) approximate_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The start time of this page of results.</p>
        pub fn approximate_time(mut self, input: smithy_types::Instant) -> Self {
...
pub mod get_sampling_targets_output {
    ...
    pub struct Builder {
        pub(crate) sampling_target_documents:
            std::option::Option<std::vec::Vec<crate::model::SamplingTargetDocument>>,
        pub(crate) last_rule_modification: std::option::Option<smithy_types::Instant>,
...
pub mod get_insight_impact_graph_output {
    ...
    pub struct Builder {
        ...
        pub(crate) start_time: std::option::Option<smithy_types::Instant>,
        pub(crate) end_time: std::option::Option<smithy_types::Instant>,
        pub(crate) service_graph_start_time: std::option::Option<smithy_types::Instant>,
        pub(crate) service_graph_end_time: std::option::Option<smithy_types::Instant>,
        pub(crate) services:
    ...
    impl Builder {
        ...
        /// <p>The time, in Unix seconds, at which the service graph started.</p>
        pub fn service_graph_start_time(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// <p>The time, in Unix seconds, at which the service graph ended.</p>
        pub fn service_graph_end_time(mut self, input: smithy_types::Instant) -> Self {
