...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_resource_policies::builders::ListResourcePoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_resource_policies::builders::ListResourcePoliciesFluentBuilder::set_next_token): <p>Not currently supported.</p>
