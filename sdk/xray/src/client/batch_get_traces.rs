...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::batch_get_traces::builders::BatchGetTracesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::batch_get_traces::builders::BatchGetTracesFluentBuilder::set_next_token): <p>Pagination token.</p>
