...
impl super::Client {
    ...
    ///   - [`sampling_rule_update(SamplingRuleUpdate)`](crate::operation::update_sampling_rule::builders::UpdateSamplingRuleFluentBuilder::sampling_rule_update) / [`set_sampling_rule_update(Option<SamplingRuleUpdate>)`](crate::operation::update_sampling_rule::builders::UpdateSamplingRuleFluentBuilder::set_sampling_rule_update):<br>required: **true**<br><p>The rule and fields to change.</p><br>
