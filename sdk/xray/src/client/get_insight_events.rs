...
impl super::Client {
    ...
    ///   - [`insight_id(impl ::std::convert::Into<String>)`](crate::operation::get_insight_events::builders::GetInsightEventsFluentBuilder::insight_id) / [`set_insight_id(Option<String>)`](crate::operation::get_insight_events::builders::GetInsightEventsFluentBuilder::set_insight_id): <p>The insight's unique identifier. Use the GetInsightSummaries action to retrieve an InsightId.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_insight_events::builders::GetInsightEventsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_insight_events::builders::GetInsightEventsFluentBuilder::set_next_token): <p>Specify the pagination token returned by a previous request to retrieve the next page of events. </p>
