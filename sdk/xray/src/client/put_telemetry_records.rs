...
impl super::Client {
    ...
    ///   - [`telemetry_records(TelemetryRecord)`](crate::operation::put_telemetry_records::builders::PutTelemetryRecordsFluentBuilder::telemetry_records) / [`set_telemetry_records(Option<Vec<TelemetryRecord>>)`](crate::operation::put_telemetry_records::builders::PutTelemetryRecordsFluentBuilder::set_telemetry_records): <p></p>
