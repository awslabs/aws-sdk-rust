...
impl super::Client {
    ...
    ///   - [`trace_segment_documents(impl Into<String>)`](crate::operation::put_trace_segments::builders::PutTraceSegmentsFluentBuilder::trace_segment_documents) / [`set_trace_segment_documents(Option<Vec::<String>>)`](crate::operation::put_trace_segments::builders::PutTraceSegmentsFluentBuilder::set_trace_segment_documents):<br>required: **true**<br><p>A string containing a JSON document defining one or more segments or subsegments.</p><br>
