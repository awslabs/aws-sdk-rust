...
impl super::Client {
    ...
    ///   - [`states(InsightState)`](crate::operation::get_insight_summaries::builders::GetInsightSummariesFluentBuilder::states) / [`set_states(Option<Vec<InsightState>>)`](crate::operation::get_insight_summaries::builders::GetInsightSummariesFluentBuilder::set_states): <p>The list of insight states. </p>
