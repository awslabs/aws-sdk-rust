...
impl super::Client {
    ...
    ///   - [`start_time(DateTime)`](crate::operation::get_insight_summaries::builders::GetInsightSummariesFluentBuilder::start_time) / [`set_start_time(Option<DateTime>)`](crate::operation::get_insight_summaries::builders::GetInsightSummariesFluentBuilder::set_start_time):<br>required: **true**<br><p>The beginning of the time frame in which the insights started. The start time can't be more than 30 days old.</p><br>
