...
impl super::Client {
    ...
    ///   - [`sampling_boost_statistics_documents(SamplingBoostStatisticsDocument)`](crate::operation::get_sampling_targets::builders::GetSamplingTargetsFluentBuilder::sampling_boost_statistics_documents) / [`set_sampling_boost_statistics_documents(Option<Vec::<SamplingBoostStatisticsDocument>>)`](crate::operation::get_sampling_targets::builders::GetSamplingTargetsFluentBuilder::set_sampling_boost_statistics_documents):<br>required: **false**<br><p>Information about rules that the service is using to boost sampling rate.</p><br>
    ...
    ///   - [`unprocessed_boost_statistics(Option<Vec::<UnprocessedStatistics>>)`](crate::operation::get_sampling_targets::GetSamplingTargetsOutput::unprocessed_boost_statistics): <p>Information about <a href="https://docs.aws.amazon.com/xray/latest/api/API_SamplingBoostStatisticsDocument.html">SamplingBoostStatisticsDocument</a> that X-Ray could not process.</p>
