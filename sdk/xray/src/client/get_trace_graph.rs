...
impl super::Client {
    ...
    ///   - [`trace_ids(impl Into<String>)`](crate::operation::get_trace_graph::builders::GetTraceGraphFluentBuilder::trace_ids) / [`set_trace_ids(Option<Vec<String>>)`](crate::operation::get_trace_graph::builders::GetTraceGraphFluentBuilder::set_trace_ids): <p>Trace IDs of requests for which to generate a service graph.</p>
