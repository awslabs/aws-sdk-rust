...
impl super::Client {
    ...
    ///   - [`start_time(DateTime)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::start_time) / [`set_start_time(Option<DateTime>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::set_start_time):<br>required: **true**<br><p>The start of the time frame for which to generate a graph.</p><br>
    ///   - [`end_time(DateTime)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::end_time) / [`set_end_time(Option<DateTime>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::set_end_time):<br>required: **true**<br><p>The end of the timeframe for which to generate a graph.</p><br>
    ///   - [`group_name(impl Into<String>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::set_group_name):<br>required: **false**<br><p>The name of a group based on which you want to generate a graph.</p><br>
    ///   - [`group_arn(impl Into<String>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::group_arn) / [`set_group_arn(Option<String>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::set_group_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of a group based on which you want to generate a graph.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_service_graph::builders::GetServiceGraphFluentBuilder::set_next_token):<br>required: **false**<br><p>Pagination token.</p><br>
