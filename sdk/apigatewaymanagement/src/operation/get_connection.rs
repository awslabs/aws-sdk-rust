...
impl GetConnectionInput {
    /// Consumes the builder and constructs an Operation<[`GetConnection`](crate::operation::get_connection::GetConnection)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_connection::GetConnection, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_connection::GetConnection::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConnection {
    type Output = ::std::result::Result<crate::operation::get_connection::GetConnectionOutput, crate::operation::get_connection::GetConnectionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_connection::de_get_connection_http_response_with_props(status, headers, body)
        }
    }
}
