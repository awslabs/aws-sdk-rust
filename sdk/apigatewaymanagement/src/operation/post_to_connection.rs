...
impl PostToConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::post_to_connection::PostToConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PostToConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_post_to_connection::de_post_to_connection_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::post_to_connection::PostToConnectionError
{
