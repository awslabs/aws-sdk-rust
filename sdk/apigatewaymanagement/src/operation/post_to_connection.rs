...
impl PostToConnectionInput {
    /// Consumes the builder and constructs an Operation<[`PostToConnection`](crate::operation::post_to_connection::PostToConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::post_to_connection::PostToConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::post_to_connection::PostToConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::post_to_connection::PostToConnection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PostToConnection {
                type Output = std::result::Result<crate::operation::post_to_connection::PostToConnectionOutput, crate::operation::post_to_connection::PostToConnectionError>;
