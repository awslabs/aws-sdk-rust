...
impl PostToConnectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_post_to_connection_input::ser_data_http_payload(self.data)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PostToConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_post_to_connection::de_post_to_connection_http_response_with_props(status, headers, body)
        }
    }
}
