...
pub struct GetConnectionOutput {
    ...
    pub connected_at: std::option::Option<smithy_types::Instant>,
    ...
    pub last_active_at: std::option::Option<smithy_types::Instant>,
}
...
pub mod get_connection_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug)]
    pub struct Builder {
        pub(crate) connected_at: std::option::Option<smithy_types::Instant>,
        pub(crate) identity: std::option::Option<crate::model::Identity>,
        pub(crate) last_active_at: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The time in ISO 8601 format for when the connection was established.</p>
        pub fn connected_at(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// <p>The time in ISO 8601 format for when the connection was last active.</p>
        pub fn last_active_at(mut self, input: smithy_types::Instant) -> Self {
