...
pub fn serialize_structure_create_application_version_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_cloud_formation_change_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_33 in var_31 {
            {
                ...
                crate::json_ser::serialize_structure_parameter_value(&mut object_34, item_33);
                object_34.finish();
            }
        }
        array_32.finish();
    ...
    if let Some(var_38) = &input.rollback_configuration {
        ...
        crate::json_ser::serialize_structure_rollback_configuration(&mut object_39, var_38);
        object_39.finish();
    }
...
pub fn serialize_structure_create_cloud_formation_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_application_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_50 in var_48 {
            {
                ...
                crate::json_ser::serialize_structure_application_policy_statement(
                    &mut object_51,
                    item_50,
                );
                object_51.finish();
...
pub fn serialize_structure_unshare_application_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_rollback_configuration(
    ...
    if input.monitoring_time_in_minutes != 0 {
        object.key("monitoringTimeInMinutes").number(
            ...
            smithy_types::Number::NegInt((input.monitoring_time_in_minutes).into()),
        );
    }
        ...
        for item_65 in var_63 {
            {
                ...
                crate::json_ser::serialize_structure_rollback_trigger(&mut object_66, item_65);
                object_66.finish();
            }
        }
        array_64.finish();
...
pub fn serialize_structure_application_policy_statement(
    object: &mut smithy_json::serialize::JsonObjectWriter,
