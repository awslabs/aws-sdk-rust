...
impl CreateApplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_application::CreateApplication::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("CreateApplication", "serverlessapplicationrepository"),
        );
