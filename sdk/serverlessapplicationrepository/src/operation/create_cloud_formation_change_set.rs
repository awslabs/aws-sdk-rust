...
impl CreateCloudFormationChangeSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_cloud_formation_change_set::CreateCloudFormationChangeSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCloudFormationChangeSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_cloud_formation_change_set::de_create_cloud_formation_change_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
