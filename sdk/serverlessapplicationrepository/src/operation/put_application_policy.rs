...
impl PutApplicationPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_application_policy::PutApplicationPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutApplicationPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_application_policy::de_put_application_policy_http_response_with_props(status, headers, body)
        }
    }
}
