...
impl ::aws_smithy_http::response::ParseStrictResponse for ListApplicationDependencies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_application_dependencies::de_list_application_dependencies_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListApplicationDependenciesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_application_dependencies::ListApplicationDependenciesError
{
