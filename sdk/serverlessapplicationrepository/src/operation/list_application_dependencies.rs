...
impl ListApplicationDependencies {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_application_dependencies::ListApplicationDependenciesInput,
                    ) -> ::std::result::Result<crate::operation::list_application_dependencies::ListApplicationDependenciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_application_dependencies::ListApplicationDependenciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_application_dependencies::ListApplicationDependenciesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_application_dependencies::ListApplicationDependenciesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListApplicationDependencies {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListApplicationDependencies");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListApplicationDependenciesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListApplicationDependenciesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListApplicationDependencies")
...
.with_interceptor(ListApplicationDependenciesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_application_dependencies::ListApplicationDependenciesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_application_dependencies::ListApplicationDependenciesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_application_dependencies::ListApplicationDependenciesError>::new());
...
#[derive(Debug)]
            struct ListApplicationDependenciesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListApplicationDependenciesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_application_dependencies::de_list_application_dependencies_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_application_dependencies::de_list_application_dependencies_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListApplicationDependenciesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListApplicationDependenciesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_application_dependencies::ListApplicationDependenciesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_application_dependencies::ListApplicationDependenciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/applications/{ApplicationId}/dependencies", ApplicationId = application_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_application_dependencies::ListApplicationDependenciesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.semantic_version {
         {
            query.push_kv("semanticVersion", &::aws_smithy_http::query::fmt_string(inner_4));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ListApplicationDependenciesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListApplicationDependenciesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListApplicationDependenciesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListApplicationDependenciesInput>()
                        .ok_or("failed to downcast to ListApplicationDependenciesInput")?;
...
pub enum ListApplicationDependenciesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListApplicationDependenciesError) for what information is available for the error.")]
...
impl ListApplicationDependenciesError {
    /// Creates the `ListApplicationDependenciesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListApplicationDependenciesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListApplicationDependenciesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_application_dependencies::ListApplicationDependenciesError {
...
mod _list_application_dependencies_output;
