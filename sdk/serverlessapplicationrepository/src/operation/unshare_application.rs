...
impl UnshareApplicationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_unshare_application::ser_unshare_application_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::unshare_application::UnshareApplication::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("UnshareApplication", "serverlessapplicationrepository"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnshareApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_unshare_application::de_unshare_application_http_response_with_props(status, headers, body)
        }
    }
}
