...
impl GetApplicationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_application::GetApplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::get_application::GetApplicationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_2) = &_input.semantic_version {
                     {
                        query.push_kv("semanticVersion", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_application::GetApplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetApplication", "serverlessapplicationrepository"));
