...
impl GetCloudFormationTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_cloud_formation_template::GetCloudFormationTemplate,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cloud_formation_template::GetCloudFormationTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCloudFormationTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cloud_formation_template::de_get_cloud_formation_template_http_response_with_props(status, headers, body)
        }
    }
}
