...
impl CreateCloudFormationTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_cloud_formation_template::CreateCloudFormationTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cloud_formation_template::CreateCloudFormationTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_cloud_formation_template::CreateCloudFormationTemplateOutput, crate::operation::create_cloud_formation_template::CreateCloudFormationTemplateError, Self> {
