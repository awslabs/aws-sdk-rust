...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCloudFormationTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_cloud_formation_template::de_create_cloud_formation_template_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateCloudFormationTemplateError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_cloud_formation_template::CreateCloudFormationTemplateError
{
