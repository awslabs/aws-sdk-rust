...
impl CreateApplicationVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreateApplicationVersion`](crate::operation::create_application_version::CreateApplicationVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_application_version::CreateApplicationVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_application_version::CreateApplicationVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("semantic_version", "cannot be empty or unset"))?;
                ...
                if semantic_version.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("semantic_version", "cannot be empty or unset"))
                            }
                write!(output, "/applications/{ApplicationId}/versions/{SemanticVersion}", ApplicationId = application_id, SemanticVersion = semantic_version).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_application_version::ser_create_application_version_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_application_version::CreateApplicationVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateApplicationVersion", "serverlessapplicationrepository"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateApplicationVersion {
                type Output = std::result::Result<crate::operation::create_application_version::CreateApplicationVersionOutput, crate::operation::create_application_version::CreateApplicationVersionError>;
