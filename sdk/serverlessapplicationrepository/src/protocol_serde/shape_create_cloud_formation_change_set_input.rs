...
pub fn ser_create_cloud_formation_change_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCloudFormationChangeSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
