...
pub fn ser_create_application_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateApplicationVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
