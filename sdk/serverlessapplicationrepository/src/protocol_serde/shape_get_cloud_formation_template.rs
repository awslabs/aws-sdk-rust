...
pub fn de_get_cloud_formation_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetCloudFormationTemplateOutput, crate::error::GetCloudFormationTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetCloudFormationTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_cloud_formation_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetCloudFormationTemplateOutput, crate::error::GetCloudFormationTemplateError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_cloud_formation_template(value: &[u8], mut builder: crate::output::get_cloud_formation_template_output::Builder) -> Result<crate::output::get_cloud_formation_template_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
