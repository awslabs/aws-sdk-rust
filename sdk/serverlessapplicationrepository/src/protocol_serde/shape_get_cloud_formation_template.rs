...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_cloud_formation_template::GetCloudFormationTemplateError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_cloud_formation_template::GetCloudFormationTemplateError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::get_cloud_formation_template::GetCloudFormationTemplateError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_cloud_formation_template_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_cloud_formation_template::de_get_cloud_formation_template(_response_body, output)
            .map_err(crate::operation::get_cloud_formation_template::GetCloudFormationTemplateError::unhandled)?;
...
pub(crate) fn de_get_cloud_formation_template(
    value: &[u8],
    mut builder: crate::operation::get_cloud_formation_template::builders::GetCloudFormationTemplateOutputBuilder,
) -> Result<
    crate::operation::get_cloud_formation_template::builders::GetCloudFormationTemplateOutputBuilder,
