...
pub fn ser_application_policy_statement(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ApplicationPolicyStatement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_application_policy_statement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ApplicationPolicyStatement>, aws_smithy_json::deserialize::error::DeserializeError>
