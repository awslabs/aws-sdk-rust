...
pub(crate) fn reflens_list_application_dependencies_output_output_next_token(
    input: &crate::operation::list_application_dependencies::ListApplicationDependenciesOutput,
