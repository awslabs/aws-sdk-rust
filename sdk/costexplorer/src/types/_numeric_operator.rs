...
impl ::std::convert::From<&str> for NumericOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NumericOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NumericOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NumericOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NumericOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
