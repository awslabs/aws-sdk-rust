...
pub fn ser_get_anomalies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAnomaliesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
