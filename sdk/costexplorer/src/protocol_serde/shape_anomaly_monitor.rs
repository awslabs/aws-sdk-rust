...
pub fn ser_anomaly_monitor(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnomalyMonitor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_anomaly_monitor<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AnomalyMonitor>, aws_smithy_json::deserialize::error::DeserializeError>
