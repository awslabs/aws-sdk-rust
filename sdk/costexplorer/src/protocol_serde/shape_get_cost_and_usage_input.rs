...
pub fn ser_get_cost_and_usage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCostAndUsageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
