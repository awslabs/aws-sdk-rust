...
pub fn ser_total_impact_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TotalImpactFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
