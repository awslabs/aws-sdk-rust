...
pub fn ser_update_anomaly_subscription_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAnomalySubscriptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
