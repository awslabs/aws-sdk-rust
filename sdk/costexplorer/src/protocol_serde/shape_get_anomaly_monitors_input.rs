...
pub fn ser_get_anomaly_monitors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_anomaly_monitors::GetAnomalyMonitorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
