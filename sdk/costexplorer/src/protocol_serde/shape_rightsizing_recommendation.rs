                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CurrentInstance" => {
                                builder = builder.set_current_instance(crate::protocol_serde::shape_current_instance::de_current_instance(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ModifyRecommendationDetail" => {
                                builder = builder.set_modify_recommendation_detail(
                                    crate::protocol_serde::shape_modify_recommendation_detail::de_modify_recommendation_detail(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "TerminateRecommendationDetail" => {
                                builder = builder.set_terminate_recommendation_detail(
                                    crate::protocol_serde::shape_terminate_recommendation_detail::de_terminate_recommendation_detail(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "FindingReasonCodes" => {
                                builder = builder.set_finding_reason_codes(
                                    crate::protocol_serde::shape_finding_reason_codes::de_finding_reason_codes(tokens, _value, depth + 1)?,
                                );
                            }
