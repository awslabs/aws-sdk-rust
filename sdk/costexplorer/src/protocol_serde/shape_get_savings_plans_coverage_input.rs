...
pub fn ser_get_savings_plans_coverage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSavingsPlansCoverageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
