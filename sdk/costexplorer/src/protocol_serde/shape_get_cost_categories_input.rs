...
pub fn ser_get_cost_categories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCostCategoriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
