...
pub fn ser_cost_category_split_charge_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CostCategorySplitChargeRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cost_category_split_charge_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CostCategorySplitChargeRule>, aws_smithy_json::deserialize::error::DeserializeError>
