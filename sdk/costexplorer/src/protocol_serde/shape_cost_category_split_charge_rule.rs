        ...
        for item_5 in var_3 {
             {
                ...
                crate::protocol_serde::shape_cost_category_split_charge_rule_parameter::ser_cost_category_split_charge_rule_parameter(&mut object_6, item_5)?;
                object_6.finish();
            }
        }
        array_4.finish();
...
pub(crate) fn de_cost_category_split_charge_rule<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CostCategorySplitChargeRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::cost_category_split_charge_rule_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
