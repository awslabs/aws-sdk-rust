...
pub fn ser_get_reservation_utilization_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetReservationUtilizationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
