...
pub fn ser_anomaly_subscription(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnomalySubscription) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_anomaly_subscription<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AnomalySubscription>, aws_smithy_json::deserialize::error::DeserializeError>
