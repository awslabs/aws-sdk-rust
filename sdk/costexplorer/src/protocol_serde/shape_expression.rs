...
pub fn ser_expression(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Expression) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_expression<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Expression>, aws_smithy_json::deserialize::error::DeserializeError>
