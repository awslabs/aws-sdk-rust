...
pub fn ser_get_reservation_purchase_recommendation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetReservationPurchaseRecommendationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
