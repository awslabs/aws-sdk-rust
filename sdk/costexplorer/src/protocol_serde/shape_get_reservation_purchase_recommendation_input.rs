...
pub fn ser_get_reservation_purchase_recommendation_input_input(
    ...
    if let Some(var_11) = &input.page_size {
        object.key("PageSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
