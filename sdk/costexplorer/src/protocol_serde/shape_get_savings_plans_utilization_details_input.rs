...
pub fn ser_get_savings_plans_utilization_details_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSavingsPlansUtilizationDetailsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
