...
pub fn ser_list_cost_allocation_tags_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_cost_allocation_tags::ListCostAllocationTagsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
