...
pub fn ser_list_cost_allocation_tags_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCostAllocationTagsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
