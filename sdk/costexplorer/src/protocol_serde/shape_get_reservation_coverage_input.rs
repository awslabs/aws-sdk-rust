...
pub fn ser_get_reservation_coverage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_reservation_coverage::GetReservationCoverageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_14) = &input.sort_by {
        #[allow(unused_mut)]
        let mut object_15 = object.key("SortBy").start_object();
        crate::protocol_serde::shape_sort_definition::ser_sort_definition(&mut object_15, var_14)?;
        object_15.finish();
    }
