...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_rightsizing_recommendation::GetRightsizingRecommendationError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidNextTokenException" => {
            crate::operation::get_rightsizing_recommendation::GetRightsizingRecommendationError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_rightsizing_recommendation::de_get_rightsizing_recommendation(_response_body, output)
            .map_err(crate::operation::get_rightsizing_recommendation::GetRightsizingRecommendationError::unhandled)?;
