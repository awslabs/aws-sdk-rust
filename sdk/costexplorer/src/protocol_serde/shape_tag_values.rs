...
pub fn ser_tag_values(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TagValues) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_tag_values<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TagValues>, aws_smithy_json::deserialize::error::DeserializeError>
