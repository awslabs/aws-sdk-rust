...
pub fn ser_tag_values(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::TagValues) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
