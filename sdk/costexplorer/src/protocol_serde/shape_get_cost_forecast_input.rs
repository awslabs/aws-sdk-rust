...
pub fn ser_get_cost_forecast_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCostForecastInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
