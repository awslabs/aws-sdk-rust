...
impl super::Client {
    ...
    ///   - [`recommendation_detail_id(impl ::std::convert::Into<String>)`](crate::operation::get_savings_plan_purchase_recommendation_details::builders::GetSavingsPlanPurchaseRecommendationDetailsFluentBuilder::recommendation_detail_id) / [`set_recommendation_detail_id(Option<String>)`](crate::operation::get_savings_plan_purchase_recommendation_details::builders::GetSavingsPlanPurchaseRecommendationDetailsFluentBuilder::set_recommendation_detail_id): <p>The ID that is associated with the Savings Plan recommendation.</p>
