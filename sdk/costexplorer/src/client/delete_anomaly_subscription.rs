...
impl super::Client {
    ...
    ///   - [`subscription_arn(impl Into<String>)`](crate::operation::delete_anomaly_subscription::builders::DeleteAnomalySubscriptionFluentBuilder::subscription_arn) / [`set_subscription_arn(Option<String>)`](crate::operation::delete_anomaly_subscription::builders::DeleteAnomalySubscriptionFluentBuilder::set_subscription_arn):<br>required: **true**<br><p>The unique identifier of the cost anomaly subscription that you want to delete.</p><br>
