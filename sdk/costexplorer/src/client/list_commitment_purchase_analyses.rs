...
impl super::Client {
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_commitment_purchase_analyses::builders::ListCommitmentPurchaseAnalysesFluentBuilder::into_paginator).
    ///
