...
impl super::Client {
    ...
    ///   - [`cost_category_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_cost_category_definition::builders::DescribeCostCategoryDefinitionFluentBuilder::cost_category_arn) / [`set_cost_category_arn(Option<String>)`](crate::operation::describe_cost_category_definition::builders::DescribeCostCategoryDefinitionFluentBuilder::set_cost_category_arn): <p>The unique identifier for your Cost Category. </p>
    ///   - [`effective_on(impl ::std::convert::Into<String>)`](crate::operation::describe_cost_category_definition::builders::DescribeCostCategoryDefinitionFluentBuilder::effective_on) / [`set_effective_on(Option<String>)`](crate::operation::describe_cost_category_definition::builders::DescribeCostCategoryDefinitionFluentBuilder::set_effective_on): <p>The date when the Cost Category was effective. </p>
