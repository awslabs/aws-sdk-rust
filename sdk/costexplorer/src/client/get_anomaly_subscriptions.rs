...
impl super::Client {
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::get_anomaly_subscriptions::builders::GetAnomalySubscriptionsFluentBuilder::into_paginator).
    ///
