...
impl super::Client {
    ...
    ///   - [`monitor_arn_list(impl Into<String>)`](crate::operation::get_anomaly_monitors::builders::GetAnomalyMonitorsFluentBuilder::monitor_arn_list) / [`set_monitor_arn_list(Option<Vec<String>>)`](crate::operation::get_anomaly_monitors::builders::GetAnomalyMonitorsFluentBuilder::set_monitor_arn_list): <p>A list of cost anomaly monitor ARNs. </p>
