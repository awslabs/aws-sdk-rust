...
impl super::Client  {
    ...
    pub fn list_savings_plans_purchase_recommendation_generation(&self) -> crate::client::fluent_builders::ListSavingsPlansPurchaseRecommendationGeneration {
                                crate::client::fluent_builders::ListSavingsPlansPurchaseRecommendationGeneration::new(self.handle.clone())
                            }
}
