...
pub struct CostCategorySplitChargeRule  {
    ...
    #[doc(hidden)]pub method: std::option::Option<crate::model::CostCategorySplitChargeMethod>,
    /// <p>The parameters for a split charge method. This is only required for the <code>FIXED</code> method. </p>
    #[doc(hidden)]pub parameters: std::option::Option<std::vec::Vec<crate::model::CostCategorySplitChargeRuleParameter>>,
}
...
pub struct CostCategorySplitChargeRuleParameter  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::CostCategorySplitChargeRuleParameterType>,
...
pub struct CostCategoryRule  {
    ...
    #[doc(hidden)]pub rule: std::option::Option<crate::model::Expression>,
    /// <p>The value the line item is categorized as if the line item contains the matched dimension.</p>
    #[doc(hidden)]pub inherited_value: std::option::Option<crate::model::CostCategoryInheritedValueDimension>,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::CostCategoryRuleType>,
}
...
pub struct CostCategoryInheritedValueDimension  {
    ...
    #[doc(hidden)]pub dimension_name: std::option::Option<crate::model::CostCategoryInheritedValueDimensionName>,
    /// <p>The key to extract cost category values.</p>
    #[doc(hidden)]pub dimension_key: std::option::Option<std::string::String>,
}
...
pub struct Expression  {
    ...
    #[doc(hidden)]pub or: std::option::Option<std::vec::Vec<crate::model::Expression>>,
    /// <p>Return results that match both <code>Dimension</code> objects.</p>
    #[doc(hidden)]pub and: std::option::Option<std::vec::Vec<crate::model::Expression>>,
    /// <p>Return results that don't match a <code>Dimension</code> object.</p>
    #[doc(hidden)]pub not: std::option::Option<std::boxed::Box<crate::model::Expression>>,
    /// <p>The specific <code>Dimension</code> to use for <code>Expression</code>.</p>
    #[doc(hidden)]pub dimensions: std::option::Option<crate::model::DimensionValues>,
    /// <p>The specific <code>Tag</code> to use for <code>Expression</code>.</p>
    #[doc(hidden)]pub tags: std::option::Option<crate::model::TagValues>,
    /// <p>The filter that's based on <code>CostCategory</code> values.</p>
    #[doc(hidden)]pub cost_categories: std::option::Option<crate::model::CostCategoryValues>,
}
impl Expression {
    /// <p>Return results that match either <code>Dimension</code> object.</p>
...
pub struct CostCategoryValues  {
    ...
    #[doc(hidden)]pub match_options: std::option::Option<std::vec::Vec<crate::model::MatchOption>>,
}
...
pub struct DimensionValues  {
    ...
    #[doc(hidden)]pub key: std::option::Option<crate::model::Dimension>,
...
impl Dimension {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "AGREEMENT_END_DATE_TIME_AFTER", "AGREEMENT_END_DATE_TIME_BEFORE", "AZ", "BILLING_ENTITY", "CACHE_ENGINE", "DATABASE_ENGINE", "DEPLOYMENT_OPTION", "INSTANCE_TYPE", "INSTANCE_TYPE_FAMILY", "INVOICING_ENTITY", "LEGAL_ENTITY_NAME", "LINKED_ACCOUNT", "LINKED_ACCOUNT_NAME", "OPERATING_SYSTEM", "OPERATION", "PAYMENT_OPTION", "PLATFORM", "PURCHASE_TYPE", "RECORD_TYPE", "REGION", "RESERVATION_ID", "RESOURCE_ID", "RIGHTSIZING_TYPE", "SAVINGS_PLANS_TYPE", "SAVINGS_PLAN_ARN", "SCOPE", "SERVICE", "SERVICE_CODE", "SUBSCRIPTION_ID", "TENANCY", "USAGE_TYPE", "USAGE_TYPE_GROUP"
        ]
    }
}
...
pub struct Subscriber  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::SubscriberType>,
    /// <p>Indicates if the subscriber accepts the notifications. </p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::SubscriberStatus>,
}
impl Subscriber {
    /// <p>The email address or SNS Amazon Resource Name (ARN). This depends on the <code>Type</code>. </p>
...
pub struct CostCategoryReference  {
    ...
    #[doc(hidden)]pub effective_end: std::option::Option<std::string::String>,
    /// <p>The number of rules that are associated with a specific Cost Category. </p>
    #[doc(hidden)]pub number_of_rules: i32,
    /// <p>The list of processing statuses for Cost Management products for a specific cost category. </p>
    #[doc(hidden)]pub processing_status: std::option::Option<std::vec::Vec<crate::model::CostCategoryProcessingStatus>>,
...
pub struct CostCategoryProcessingStatus  {
    ...
    #[doc(hidden)]pub component: std::option::Option<crate::model::CostCategoryStatusComponent>,
    /// <p>The process status for a specific cost category. </p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::CostCategoryStatus>,
}
...
pub struct ForecastResult  {
    ...
    #[doc(hidden)]pub mean_value: std::option::Option<std::string::String>,
    /// <p>The lower limit for the prediction interval. </p>
    #[doc(hidden)]pub prediction_interval_lower_bound: std::option::Option<std::string::String>,
    /// <p>The upper limit for the prediction interval. </p>
    #[doc(hidden)]pub prediction_interval_upper_bound: std::option::Option<std::string::String>,
}
impl ForecastResult {
    /// <p>The period of time that the forecast covers.</p>
...
impl  std::fmt::Debug for ForecastResult  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("prediction_interval_lower_bound", &self.prediction_interval_lower_bound);
        formatter.field("prediction_interval_upper_bound", &self.prediction_interval_upper_bound);
        formatter.finish()
    }
}
...
pub struct SavingsPlansUtilizationAggregates  {
    ...
    #[doc(hidden)]pub utilization: std::option::Option<crate::model::SavingsPlansUtilization>,
    ...
    #[doc(hidden)]pub savings: std::option::Option<crate::model::SavingsPlansSavings>,
    ...
    #[doc(hidden)]pub amortized_commitment: std::option::Option<crate::model::SavingsPlansAmortizedCommitment>,
}
...
pub struct SavingsPlansAmortizedCommitment  {
    ...
    #[doc(hidden)]pub amortized_recurring_commitment: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub amortized_upfront_commitment: std::option::Option<std::string::String>,
    /// <p>The total amortized amount of your Savings Plans commitment, regardless of your Savings Plans purchase method. </p>
    #[doc(hidden)]pub total_amortized_commitment: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for SavingsPlansAmortizedCommitment  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("amortized_recurring_commitment", &self.amortized_recurring_commitment);
        formatter.field("amortized_upfront_commitment", &self.amortized_upfront_commitment);
        formatter.field("total_amortized_commitment", &self.total_amortized_commitment);
        formatter.finish()
    }
}
...
pub struct SavingsPlansSavings  {
    ...
    #[doc(hidden)]pub net_savings: std::option::Option<std::string::String>,
    /// <p>How much the amount that the usage would have cost if it was accrued at the On-Demand rate.</p>
    #[doc(hidden)]pub on_demand_cost_equivalent: std::option::Option<std::string::String>,
}
...
pub struct SavingsPlansUtilization  {
    ...
    #[doc(hidden)]pub total_commitment: std::option::Option<std::string::String>,
    /// <p>The amount of your Savings Plans commitment that was consumed from Savings Plans eligible usage in a specific period.</p>
    #[doc(hidden)]pub used_commitment: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub unused_commitment: std::option::Option<std::string::String>,
    /// <p>The amount of <code>UsedCommitment</code> divided by the <code>TotalCommitment</code> for your Savings Plans.</p>
    #[doc(hidden)]pub utilization_percentage: std::option::Option<std::string::String>,
}
...
pub struct SavingsPlansUtilizationDetail  {
    ...
    #[doc(hidden)]pub savings_plan_arn: std::option::Option<std::string::String>,
...
pub struct SavingsPlansPurchaseRecommendation  {
    ...
    #[doc(hidden)]pub savings_plans_purchase_recommendation_details: std::option::Option<std::vec::Vec<crate::model::SavingsPlansPurchaseRecommendationDetail>>,
    /// <p>Summary metrics for your Savings Plans Recommendations. </p>
    #[doc(hidden)]pub savings_plans_purchase_recommendation_summary: std::option::Option<crate::model::SavingsPlansPurchaseRecommendationSummary>,
}
...
impl  std::fmt::Debug for SavingsPlansPurchaseRecommendation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("savings_plans_purchase_recommendation_details", &self.savings_plans_purchase_recommendation_details);
        formatter.field("savings_plans_purchase_recommendation_summary", &self.savings_plans_purchase_recommendation_summary);
        formatter.finish()
    }
}
...
pub struct SavingsPlansPurchaseRecommendationSummary  {
    ...
    #[doc(hidden)]pub estimated_roi: std::option::Option<std::string::String>,
    /// <p>The currency code that Amazon Web Services used to generate the recommendations and present potential savings.</p>
    #[doc(hidden)]pub currency_code: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_total_cost: std::option::Option<std::string::String>,
    /// <p>The current total on demand spend of the applicable usage types over the lookback period.</p>
    #[doc(hidden)]pub current_on_demand_spend: std::option::Option<std::string::String>,
    /// <p>The estimated total savings over the lookback period, based on the purchase of the recommended Savings Plans.</p>
    #[doc(hidden)]pub estimated_savings_amount: std::option::Option<std::string::String>,
    /// <p>The aggregate number of Savings Plans recommendations that exist for your account.</p>
    #[doc(hidden)]pub total_recommendation_count: std::option::Option<std::string::String>,
    /// <p>The recommended Savings Plans cost on a daily (24 hourly) basis.</p>
    #[doc(hidden)]pub daily_commitment_to_purchase: std::option::Option<std::string::String>,
    /// <p>The recommended hourly commitment that's based on the recommendation parameters.</p>
    #[doc(hidden)]pub hourly_commitment_to_purchase: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_savings_percentage: std::option::Option<std::string::String>,
    /// <p>The estimated monthly savings amount that's based on the recommended Savings Plans purchase.</p>
    #[doc(hidden)]pub estimated_monthly_savings_amount: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_on_demand_cost_with_current_commitment: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for SavingsPlansPurchaseRecommendationSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_recommendation_count", &self.total_recommendation_count);
        formatter.field("daily_commitment_to_purchase", &self.daily_commitment_to_purchase);
        formatter.field("hourly_commitment_to_purchase", &self.hourly_commitment_to_purchase);
        formatter.field("estimated_savings_percentage", &self.estimated_savings_percentage);
        formatter.field("estimated_monthly_savings_amount", &self.estimated_monthly_savings_amount);
        formatter.field("estimated_on_demand_cost_with_current_commitment", &self.estimated_on_demand_cost_with_current_commitment);
        formatter.finish()
    }
}
...
pub struct SavingsPlansPurchaseRecommendationDetail  {
    /// <p>Details for your recommended Savings Plans.</p>
    #[doc(hidden)]pub savings_plans_details: std::option::Option<crate::model::SavingsPlansDetails>,
    ...
    #[doc(hidden)]pub upfront_cost: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_sp_cost: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_on_demand_cost: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_average_utilization: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub current_minimum_hourly_on_demand_spend: std::option::Option<std::string::String>,
    /// <p>The highest value of hourly On-Demand spend over the lookback period of the applicable usage type.</p>
    #[doc(hidden)]pub current_maximum_hourly_on_demand_spend: std::option::Option<std::string::String>,
    /// <p>The average value of hourly On-Demand spend over the lookback period of the applicable usage type.</p>
    #[doc(hidden)]pub current_average_hourly_on_demand_spend: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for SavingsPlansPurchaseRecommendationDetail  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("estimated_savings_percentage", &self.estimated_savings_percentage);
        formatter.field("hourly_commitment_to_purchase", &self.hourly_commitment_to_purchase);
        formatter.field("estimated_average_utilization", &self.estimated_average_utilization);
        formatter.field("estimated_monthly_savings_amount", &self.estimated_monthly_savings_amount);
        formatter.field("current_minimum_hourly_on_demand_spend", &self.current_minimum_hourly_on_demand_spend);
        formatter.field("current_maximum_hourly_on_demand_spend", &self.current_maximum_hourly_on_demand_spend);
        formatter.field("current_average_hourly_on_demand_spend", &self.current_average_hourly_on_demand_spend);
        formatter.finish()
    }
}
...
pub struct SavingsPlansDetails  {
    ...
    #[doc(hidden)]pub instance_family: std::option::Option<std::string::String>,
...
pub struct SavingsPlansPurchaseRecommendationMetadata  {
    ...
    #[doc(hidden)]pub generation_timestamp: std::option::Option<std::string::String>,
    /// <p>Additional metadata that might be applicable to the recommendation.</p>
    #[doc(hidden)]pub additional_metadata: std::option::Option<std::string::String>,
}
...
pub struct SavingsPlansCoverage  {
    ...
    #[doc(hidden)]pub coverage: std::option::Option<crate::model::SavingsPlansCoverageData>,
    /// <p>The time period of the request. </p>
    #[doc(hidden)]pub time_period: std::option::Option<crate::model::DateInterval>,
}
...
pub struct SavingsPlansCoverageData  {
    ...
    #[doc(hidden)]pub spend_covered_by_savings_plans: std::option::Option<std::string::String>,
    /// <p>The cost of your Amazon Web Services usage at the public On-Demand rate.</p>
    #[doc(hidden)]pub on_demand_cost: std::option::Option<std::string::String>,
    /// <p>The total cost of your Amazon Web Services usage, regardless of your purchase option.</p>
    #[doc(hidden)]pub total_cost: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub coverage_percentage: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for SavingsPlansCoverageData  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("spend_covered_by_savings_plans", &self.spend_covered_by_savings_plans);
...
pub struct GroupDefinition  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::GroupDefinitionType>,
...
pub struct RightsizingRecommendationConfiguration  {
    ...
    #[doc(hidden)]pub recommendation_target: std::option::Option<crate::model::RecommendationTarget>,
    ...
    #[doc(hidden)]pub benefits_considered: bool,
}
...
pub struct RightsizingRecommendation  {
    ...
    #[doc(hidden)]pub current_instance: std::option::Option<crate::model::CurrentInstance>,
    /// <p>A recommendation to either terminate or modify the resource.</p>
    #[doc(hidden)]pub rightsizing_type: std::option::Option<crate::model::RightsizingType>,
    /// <p>The details for the modification recommendations. </p>
    #[doc(hidden)]pub modify_recommendation_detail: std::option::Option<crate::model::ModifyRecommendationDetail>,
    /// <p>The details for termination recommendations.</p>
    #[doc(hidden)]pub terminate_recommendation_detail: std::option::Option<crate::model::TerminateRecommendationDetail>,
    ...
    #[doc(hidden)]pub finding_reason_codes: std::option::Option<std::vec::Vec<crate::model::FindingReasonCode>>,
}
...
impl  std::fmt::Debug for RightsizingRecommendation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("modify_recommendation_detail", &self.modify_recommendation_detail);
        formatter.field("terminate_recommendation_detail", &self.terminate_recommendation_detail);
...
pub struct TerminateRecommendationDetail  {
    ...
    #[doc(hidden)]pub estimated_monthly_savings: std::option::Option<std::string::String>,
...
pub struct ModifyRecommendationDetail  {
    ...
    #[doc(hidden)]pub target_instances: std::option::Option<std::vec::Vec<crate::model::TargetInstance>>,
}
...
pub struct TargetInstance  {
    ...
    #[doc(hidden)]pub estimated_monthly_cost: std::option::Option<std::string::String>,
    /// <p>The estimated savings that result from modification, on a monthly basis.</p>
    #[doc(hidden)]pub estimated_monthly_savings: std::option::Option<std::string::String>,
    /// <p>The currency code that Amazon Web Services used to calculate the costs for this instance.</p>
    #[doc(hidden)]pub currency_code: std::option::Option<std::string::String>,
    /// <p>Determines whether this recommendation is the defaulted Amazon Web Services recommendation.</p>
    #[doc(hidden)]pub default_target_instance: bool,
    ...
    #[doc(hidden)]pub expected_resource_utilization: std::option::Option<crate::model::ResourceUtilization>,
    ...
    #[doc(hidden)]pub platform_differences: std::option::Option<std::vec::Vec<crate::model::PlatformDifference>>,
}
impl TargetInstance {
    /// <p>The expected cost to operate this instance type on a monthly basis.</p>
...
impl  std::fmt::Debug for TargetInstance  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("expected_resource_utilization", &self.expected_resource_utilization);
...
pub struct ResourceUtilization  {
    ...
    #[doc(hidden)]pub ec2_resource_utilization: std::option::Option<crate::model::Ec2ResourceUtilization>,
}
...
pub struct Ec2ResourceUtilization  {
    ...
    #[doc(hidden)]pub max_cpu_utilization_percentage: std::option::Option<std::string::String>,
    /// <p>The maximum observed or expected memory utilization of the instance.</p>
    #[doc(hidden)]pub max_memory_utilization_percentage: std::option::Option<std::string::String>,
    /// <p>The maximum observed or expected storage utilization of the instance. This doesn't include EBS storage.</p>
    #[doc(hidden)]pub max_storage_utilization_percentage: std::option::Option<std::string::String>,
    /// <p>The EBS field that contains a list of EBS metrics that are associated with the current instance. </p>
    #[doc(hidden)]pub ebs_resource_utilization: std::option::Option<crate::model::EbsResourceUtilization>,
    /// <p>The field that contains a list of disk (local storage) metrics that are associated with the current instance. </p>
    #[doc(hidden)]pub disk_resource_utilization: std::option::Option<crate::model::DiskResourceUtilization>,
    /// <p>The network field that contains a list of network metrics that are associated with the current instance. </p>
    #[doc(hidden)]pub network_resource_utilization: std::option::Option<crate::model::NetworkResourceUtilization>,
}
...
impl  std::fmt::Debug for Ec2ResourceUtilization  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("max_cpu_utilization_percentage", &self.max_cpu_utilization_percentage);
        formatter.field("max_memory_utilization_percentage", &self.max_memory_utilization_percentage);
        formatter.field("max_storage_utilization_percentage", &self.max_storage_utilization_percentage);
        ...
        formatter.field("network_resource_utilization", &self.network_resource_utilization);
        formatter.finish()
    }
}
...
pub struct NetworkResourceUtilization  {
    ...
    #[doc(hidden)]pub network_in_bytes_per_second: std::option::Option<std::string::String>,
    /// <p>The network outbound throughput utilization measured in Bytes per second (Bps). </p>
    #[doc(hidden)]pub network_out_bytes_per_second: std::option::Option<std::string::String>,
    /// <p>The network inbound packets that are measured in packets per second. </p>
    #[doc(hidden)]pub network_packets_in_per_second: std::option::Option<std::string::String>,
    /// <p>The network outbound packets that are measured in packets per second. </p>
    #[doc(hidden)]pub network_packets_out_per_second: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for NetworkResourceUtilization  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("network_in_bytes_per_second", &self.network_in_bytes_per_second);
        formatter.field("network_out_bytes_per_second", &self.network_out_bytes_per_second);
        formatter.field("network_packets_in_per_second", &self.network_packets_in_per_second);
        formatter.field("network_packets_out_per_second", &self.network_packets_out_per_second);
        formatter.finish()
    }
}
...
pub struct DiskResourceUtilization  {
    ...
    #[doc(hidden)]pub disk_read_ops_per_second: std::option::Option<std::string::String>,
    /// <p>The maximum number of write operations per second. </p>
    #[doc(hidden)]pub disk_write_ops_per_second: std::option::Option<std::string::String>,
    /// <p>The maximum read throughput operations per second. </p>
    #[doc(hidden)]pub disk_read_bytes_per_second: std::option::Option<std::string::String>,
    /// <p>The maximum write throughput operations per second. </p>
    #[doc(hidden)]pub disk_write_bytes_per_second: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DiskResourceUtilization  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("disk_read_bytes_per_second", &self.disk_read_bytes_per_second);
        formatter.field("disk_write_bytes_per_second", &self.disk_write_bytes_per_second);
        formatter.finish()
    }
}
...
pub struct EbsResourceUtilization  {
    /// <p>The maximum number of read operations per second. </p>
    #[doc(hidden)]pub ebs_read_ops_per_second: std::option::Option<std::string::String>,
    /// <p>The maximum number of write operations per second. </p>
    #[doc(hidden)]pub ebs_write_ops_per_second: std::option::Option<std::string::String>,
    /// <p>The maximum size of read operations per second </p>
    #[doc(hidden)]pub ebs_read_bytes_per_second: std::option::Option<std::string::String>,
    /// <p>The maximum size of write operations per second. </p>
    #[doc(hidden)]pub ebs_write_bytes_per_second: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for EbsResourceUtilization  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("ebs_write_bytes_per_second", &self.ebs_write_bytes_per_second);
        formatter.finish()
    }
}
...
pub struct ResourceDetails  {
    ...
    #[doc(hidden)]pub ec2_resource_details: std::option::Option<crate::model::Ec2ResourceDetails>,
}
...
pub struct Ec2ResourceDetails  {
    ...
    #[doc(hidden)]pub hourly_on_demand_rate: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub sku: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub network_performance: std::option::Option<std::string::String>,
    /// <p>The disk storage of the Amazon Web Services instance. This doesn't include EBS storage.</p>
    #[doc(hidden)]pub storage: std::option::Option<std::string::String>,
    /// <p>The number of VCPU cores in the Amazon Web Services instance type.</p>
    #[doc(hidden)]pub vcpu: std::option::Option<std::string::String>,
}
...
pub struct CurrentInstance  {
    ...
    #[doc(hidden)]pub tags: std::option::Option<std::vec::Vec<crate::model::TagValues>>,
    ...
    #[doc(hidden)]pub resource_utilization: std::option::Option<crate::model::ResourceUtilization>,
    /// <p>The number of hours during the lookback period that's covered by reservations.</p>
    #[doc(hidden)]pub reservation_covered_hours_in_lookback_period: std::option::Option<std::string::String>,
    /// <p>The number of hours during the lookback period that's covered by Savings Plans.</p>
    #[doc(hidden)]pub savings_plans_covered_hours_in_lookback_period: std::option::Option<std::string::String>,
    /// <p>The number of hours during the lookback period that's billed at On-Demand rates.</p>
    #[doc(hidden)]pub on_demand_hours_in_lookback_period: std::option::Option<std::string::String>,
    /// <p>The total number of hours that the instance ran during the lookback period.</p>
    #[doc(hidden)]pub total_running_hours_in_lookback_period: std::option::Option<std::string::String>,
    /// <p>The current On-Demand cost of operating this instance on a monthly basis.</p>
    #[doc(hidden)]pub monthly_cost: std::option::Option<std::string::String>,
    /// <p>The currency code that Amazon Web Services used to calculate the costs for this instance.</p>
    #[doc(hidden)]pub currency_code: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for CurrentInstance  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("reservation_covered_hours_in_lookback_period", &self.reservation_covered_hours_in_lookback_period);
        formatter.field("savings_plans_covered_hours_in_lookback_period", &self.savings_plans_covered_hours_in_lookback_period);
        formatter.field("on_demand_hours_in_lookback_period", &self.on_demand_hours_in_lookback_period);
        formatter.field("total_running_hours_in_lookback_period", &self.total_running_hours_in_lookback_period);
...
pub struct RightsizingRecommendationSummary  {
    ...
    #[doc(hidden)]pub estimated_total_monthly_savings_amount: std::option::Option<std::string::String>,
    /// <p>The currency code that Amazon Web Services used to calculate the savings.</p>
    #[doc(hidden)]pub savings_currency_code: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub savings_percentage: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for RightsizingRecommendationSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_recommendation_count", &self.total_recommendation_count);
        formatter.field("estimated_total_monthly_savings_amount", &self.estimated_total_monthly_savings_amount);
...
pub struct ReservationAggregates  {
    ...
    #[doc(hidden)]pub utilization_percentage_in_units: std::option::Option<std::string::String>,
    /// <p>How many reservation hours that you purchased.</p>
    #[doc(hidden)]pub purchased_hours: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub purchased_units: std::option::Option<std::string::String>,
    /// <p>The total number of reservation hours that you used.</p>
    #[doc(hidden)]pub total_actual_hours: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub total_actual_units: std::option::Option<std::string::String>,
    /// <p>The number of reservation hours that you didn't use.</p>
    #[doc(hidden)]pub unused_hours: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub unused_units: std::option::Option<std::string::String>,
    /// <p>How much your reservation costs if charged On-Demand rates.</p>
    #[doc(hidden)]pub on_demand_cost_of_ri_hours_used: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub net_ri_savings: std::option::Option<std::string::String>,
    /// <p>How much you might save if you use your entire reservation.</p>
    #[doc(hidden)]pub total_potential_ri_savings: std::option::Option<std::string::String>,
    /// <p>The upfront cost of your reservation. It's amortized over the reservation period.</p>
    #[doc(hidden)]pub amortized_upfront_fee: std::option::Option<std::string::String>,
    /// <p>The monthly cost of your reservation. It's amortized over the reservation period.</p>
    #[doc(hidden)]pub amortized_recurring_fee: std::option::Option<std::string::String>,
    /// <p>The total cost of your reservation. It's amortized over the reservation period.</p>
    #[doc(hidden)]pub total_amortized_fee: std::option::Option<std::string::String>,
    /// <p>The cost of unused hours for your reservation.</p>
    #[doc(hidden)]pub ri_cost_for_unused_hours: std::option::Option<std::string::String>,
    /// <p>The realized savings because of purchasing and using a reservation.</p>
    #[doc(hidden)]pub realized_savings: std::option::Option<std::string::String>,
    /// <p>The unrealized savings because of purchasing and using a reservation.</p>
    #[doc(hidden)]pub unrealized_savings: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ReservationAggregates  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("utilization_percentage", &self.utilization_percentage);
        formatter.field("utilization_percentage_in_units", &self.utilization_percentage_in_units);
        ...
        formatter.field("on_demand_cost_of_ri_hours_used", &self.on_demand_cost_of_ri_hours_used);
        formatter.field("net_ri_savings", &self.net_ri_savings);
        formatter.field("total_potential_ri_savings", &self.total_potential_ri_savings);
...
pub struct UtilizationByTime  {
    ...
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::ReservationUtilizationGroup>>,
    /// <p>The total number of reservation hours that were used.</p>
    #[doc(hidden)]pub total: std::option::Option<crate::model::ReservationAggregates>,
}
...
pub struct ReservationUtilizationGroup  {
    ...
    #[doc(hidden)]pub utilization: std::option::Option<crate::model::ReservationAggregates>,
}
...
pub struct ReservationPurchaseRecommendation  {
    ...
    #[doc(hidden)]pub recommendation_details: std::option::Option<std::vec::Vec<crate::model::ReservationPurchaseRecommendationDetail>>,
    /// <p>A summary about the recommended purchase.</p>
    #[doc(hidden)]pub recommendation_summary: std::option::Option<crate::model::ReservationPurchaseRecommendationSummary>,
}
...
pub struct ReservationPurchaseRecommendationSummary  {
    ...
    #[doc(hidden)]pub total_estimated_monthly_savings_amount: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub total_estimated_monthly_savings_percentage: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for ReservationPurchaseRecommendationSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_estimated_monthly_savings_amount", &self.total_estimated_monthly_savings_amount);
        formatter.field("total_estimated_monthly_savings_percentage", &self.total_estimated_monthly_savings_percentage);
        formatter.field("currency_code", &self.currency_code);
        formatter.finish()
    }
}
...
pub struct ReservationPurchaseRecommendationDetail  {
    ...
    #[doc(hidden)]pub recommended_number_of_instances_to_purchase: std::option::Option<std::string::String>,
    /// <p>The number of normalized units that Amazon Web Services recommends that you purchase.</p>
    #[doc(hidden)]pub recommended_normalized_units_to_purchase: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub minimum_number_of_instances_used_per_hour: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub minimum_normalized_units_used_per_hour: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub maximum_number_of_instances_used_per_hour: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub maximum_normalized_units_used_per_hour: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub average_number_of_instances_used_per_hour: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub average_normalized_units_used_per_hour: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub average_utilization: std::option::Option<std::string::String>,
    /// <p>How long Amazon Web Services estimates that it takes for this instance to start saving you money, in months.</p>
    #[doc(hidden)]pub estimated_break_even_in_months: std::option::Option<std::string::String>,
    /// <p>The currency code that Amazon Web Services used to calculate the costs for this instance.</p>
    #[doc(hidden)]pub currency_code: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_monthly_savings_percentage: std::option::Option<std::string::String>,
    /// <p>How much Amazon Web Services estimates that you spend on On-Demand Instances in a month.</p>
    #[doc(hidden)]pub estimated_monthly_on_demand_cost: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub estimated_reservation_cost_for_lookback_period: std::option::Option<std::string::String>,
    /// <p>How much purchasing this instance costs you upfront.</p>
    #[doc(hidden)]pub upfront_cost: std::option::Option<std::string::String>,
    /// <p>How much purchasing this instance costs you on a monthly basis.</p>
    #[doc(hidden)]pub recurring_standard_monthly_cost: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ReservationPurchaseRecommendationDetail  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("recommended_number_of_instances_to_purchase", &self.recommended_number_of_instances_to_purchase);
        formatter.field("recommended_normalized_units_to_purchase", &self.recommended_normalized_units_to_purchase);
        formatter.field("minimum_number_of_instances_used_per_hour", &self.minimum_number_of_instances_used_per_hour);
        formatter.field("minimum_normalized_units_used_per_hour", &self.minimum_normalized_units_used_per_hour);
        formatter.field("maximum_number_of_instances_used_per_hour", &self.maximum_number_of_instances_used_per_hour);
        formatter.field("maximum_normalized_units_used_per_hour", &self.maximum_normalized_units_used_per_hour);
        formatter.field("average_number_of_instances_used_per_hour", &self.average_number_of_instances_used_per_hour);
        formatter.field("average_normalized_units_used_per_hour", &self.average_normalized_units_used_per_hour);
        formatter.field("average_utilization", &self.average_utilization);
        formatter.field("estimated_break_even_in_months", &self.estimated_break_even_in_months);
        formatter.field("currency_code", &self.currency_code);
        formatter.field("estimated_monthly_savings_amount", &self.estimated_monthly_savings_amount);
        formatter.field("estimated_monthly_savings_percentage", &self.estimated_monthly_savings_percentage);
        formatter.field("estimated_monthly_on_demand_cost", &self.estimated_monthly_on_demand_cost);
        formatter.field("estimated_reservation_cost_for_lookback_period", &self.estimated_reservation_cost_for_lookback_period);
        formatter.field("upfront_cost", &self.upfront_cost);
        formatter.field("recurring_standard_monthly_cost", &self.recurring_standard_monthly_cost);
        formatter.finish()
    }
}
...
pub struct InstanceDetails  {
    ...
    #[doc(hidden)]pub ec2_instance_details: std::option::Option<crate::model::Ec2InstanceDetails>,
    /// <p>The Amazon RDS instances that Amazon Web Services recommends that you purchase.</p>
    #[doc(hidden)]pub rds_instance_details: std::option::Option<crate::model::RdsInstanceDetails>,
    /// <p>The Amazon Redshift instances that Amazon Web Services recommends that you purchase.</p>
    #[doc(hidden)]pub redshift_instance_details: std::option::Option<crate::model::RedshiftInstanceDetails>,
    /// <p>The ElastiCache instances that Amazon Web Services recommends that you purchase.</p>
    #[doc(hidden)]pub elasti_cache_instance_details: std::option::Option<crate::model::ElastiCacheInstanceDetails>,
    /// <p>The Amazon OpenSearch Service instances that Amazon Web Services recommends that you purchase.</p>
    #[doc(hidden)]pub es_instance_details: std::option::Option<crate::model::EsInstanceDetails>,
}
...
impl  std::fmt::Debug for InstanceDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("elasti_cache_instance_details", &self.elasti_cache_instance_details);
...
pub struct EsInstanceDetails  {
    ...
    #[doc(hidden)]pub instance_class: std::option::Option<std::string::String>,
    /// <p>The size of instance that Amazon Web Services recommends.</p>
    #[doc(hidden)]pub instance_size: std::option::Option<std::string::String>,
    /// <p>The Amazon Web Services Region of the recommended reservation.</p>
    #[doc(hidden)]pub region: std::option::Option<std::string::String>,
    /// <p>Determines whether the recommendation is for a current-generation instance.</p>
    #[doc(hidden)]pub current_generation: bool,
    /// <p>Determines whether the recommended reservation is size flexible.</p>
    #[doc(hidden)]pub size_flex_eligible: bool,
}
...
pub struct ElastiCacheInstanceDetails  {
    ...
    #[doc(hidden)]pub product_description: std::option::Option<std::string::String>,
    /// <p>Determines whether the recommendation is for a current generation instance.</p>
    #[doc(hidden)]pub current_generation: bool,
    /// <p>Determines whether the recommended reservation is size flexible.</p>
    #[doc(hidden)]pub size_flex_eligible: bool,
...
pub struct RdsInstanceDetails  {
    ...
    #[doc(hidden)]pub database_engine: std::option::Option<std::string::String>,
    /// <p>The database edition that the recommended reservation supports.</p>
    #[doc(hidden)]pub database_edition: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub deployment_option: std::option::Option<std::string::String>,
...
pub struct ServiceSpecification  {
    ...
    #[doc(hidden)]pub ec2_specification: std::option::Option<crate::model::Ec2Specification>,
}
...
pub struct Ec2Specification  {
    ...
    #[doc(hidden)]pub offering_class: std::option::Option<crate::model::OfferingClass>,
}
...
pub struct Coverage  {
    ...
    #[doc(hidden)]pub coverage_hours: std::option::Option<crate::model::CoverageHours>,
    /// <p>The amount of instance usage that the reservation covered, in normalized units.</p>
    #[doc(hidden)]pub coverage_normalized_units: std::option::Option<crate::model::CoverageNormalizedUnits>,
    /// <p>The amount of cost that the reservation covered.</p>
    #[doc(hidden)]pub coverage_cost: std::option::Option<crate::model::CoverageCost>,
}
impl Coverage {
    /// <p>The amount of instance usage that the reservation covered, in hours.</p>
...
pub struct CoverageNormalizedUnits  {
    ...
    #[doc(hidden)]pub on_demand_normalized_units: std::option::Option<std::string::String>,
    /// <p>The number of normalized units that a reservation covers.</p>
    #[doc(hidden)]pub reserved_normalized_units: std::option::Option<std::string::String>,
    /// <p>The total number of normalized units that you used.</p>
    #[doc(hidden)]pub total_running_normalized_units: std::option::Option<std::string::String>,
    /// <p>The percentage of your used instance normalized units that a reservation covers.</p>
    #[doc(hidden)]pub coverage_normalized_units_percentage: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for CoverageNormalizedUnits  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("on_demand_normalized_units", &self.on_demand_normalized_units);
        formatter.field("reserved_normalized_units", &self.reserved_normalized_units);
        formatter.field("total_running_normalized_units", &self.total_running_normalized_units);
        formatter.field("coverage_normalized_units_percentage", &self.coverage_normalized_units_percentage);
        formatter.finish()
    }
}
...
pub struct CoverageHours  {
    ...
    #[doc(hidden)]pub on_demand_hours: std::option::Option<std::string::String>,
    /// <p>The number of instance running hours that reservations covered.</p>
    #[doc(hidden)]pub reserved_hours: std::option::Option<std::string::String>,
    /// <p>The total instance usage, in hours.</p>
    #[doc(hidden)]pub total_running_hours: std::option::Option<std::string::String>,
    /// <p>The percentage of instance hours that a reservation covered.</p>
    #[doc(hidden)]pub coverage_hours_percentage: std::option::Option<std::string::String>,
}
impl CoverageHours {
    /// <p>The number of instance running hours that On-Demand Instances covered.</p>
...
pub struct CoverageByTime  {
    ...
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::ReservationCoverageGroup>>,
    /// <p>The total reservation coverage, in hours.</p>
    #[doc(hidden)]pub total: std::option::Option<crate::model::Coverage>,
}
impl CoverageByTime {
    /// <p>The period that this coverage was used over.</p>
    pub fn time_period(&self) -> std::option::Option<& crate::model::DateInterval> {
...
pub struct ReservationCoverageGroup  {
    ...
    #[doc(hidden)]pub coverage: std::option::Option<crate::model::Coverage>,
}
...
pub struct ResultByTime  {
    ...
    #[doc(hidden)]pub total: std::option::Option<std::collections::HashMap<std::string::String, crate::model::MetricValue>>,
    /// <p>The groups that this time period includes.</p>
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::Group>>,
    /// <p>Determines whether the result is estimated.</p>
    #[doc(hidden)]pub estimated: bool,
}
impl ResultByTime {
    /// <p>The time period that the result covers.</p>
    pub fn time_period(&self) -> std::option::Option<& crate::model::DateInterval> {
...
pub struct Group  {
    ...
    #[doc(hidden)]pub metrics: std::option::Option<std::collections::HashMap<std::string::String, crate::model::MetricValue>>,
}
impl Group {
    /// <p>The keys that are included in this group.</p>
...
pub struct AnomalyMonitor  {
    ...
    #[doc(hidden)]pub last_updated_date: std::option::Option<std::string::String>,
    /// <p>The date when the monitor last evaluated for anomalies. </p>
    #[doc(hidden)]pub last_evaluated_date: std::option::Option<std::string::String>,
    /// <p>The possible type values. </p>
    #[doc(hidden)]pub monitor_type: std::option::Option<crate::model::MonitorType>,
    /// <p>The dimensions to evaluate. </p>
    #[doc(hidden)]pub monitor_dimension: std::option::Option<crate::model::MonitorDimension>,
    /// <p>Use <code>Expression</code> to filter by cost or by usage. There are two patterns: </p> 
    /// <ul> 
    /// <li> <p>Simple dimension values - You can set the dimension name and values for the filters that you plan to use. For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. For <code>GetRightsizingRecommendation</code>, the Region is a full name (for example, <code>REGION==US East (N. Virginia)</code>. The <code>Expression</code> example is as follows:</p> <p> <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }</code> </p> <p>The list of dimension values are OR'd together to retrieve cost or usage data. You can create <code>Expression</code> and <code>DimensionValues</code> objects using either <code>with*</code> methods or <code>set*</code> methods in multiple lines. </p> </li> 
    /// <li> <p>Compound dimension values with logical operations - You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. By doing this, you can filter on more advanced options. For example, you can filter on <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>. The <code>Expression</code> for that is as follows:</p> <p> <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> <note> 
    ...
    /// <p>For the <code>GetReservationPurchaseRecommendation</code> action, only NOT is supported. AND and OR aren't supported. Dimensions are limited to <code>LINKED_ACCOUNT</code>.</p> 
    /// </note>
    #[doc(hidden)]pub monitor_specification: std::option::Option<crate::model::Expression>,
    /// <p>The value for evaluated dimensions. </p>
    #[doc(hidden)]pub dimensional_value_count: i32,
}
impl AnomalyMonitor {
    /// <p>The Amazon Resource Name (ARN) value. </p>
...
pub struct Anomaly  {
    ...
    #[doc(hidden)]pub anomaly_start_date: std::option::Option<std::string::String>,
    /// <p>The last day the anomaly is detected. </p>
    #[doc(hidden)]pub anomaly_end_date: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub root_causes: std::option::Option<std::vec::Vec<crate::model::RootCause>>,
    /// <p>The latest and maximum score for the anomaly. </p>
    #[doc(hidden)]pub anomaly_score: std::option::Option<crate::model::AnomalyScore>,
    /// <p>The dollar impact for the anomaly. </p>
    #[doc(hidden)]pub impact: std::option::Option<crate::model::Impact>,
...
pub struct AnomalyScore  {
    ...
    #[doc(hidden)]pub max_score: f64,
    /// <p>The last observed score. </p>
    #[doc(hidden)]pub current_score: f64,
}
impl AnomalyScore {
    /// <p>The maximum score that's observed during the <code>AnomalyDateInterval</code>. </p>
...
pub struct RootCause  {
    ...
    #[doc(hidden)]pub linked_account: std::option::Option<std::string::String>,
    /// <p>The <code>UsageType</code> value that's associated with the cost anomaly. </p>
    #[doc(hidden)]pub usage_type: std::option::Option<std::string::String>,
}
impl RootCause {
    /// <p>The Amazon Web Service name that's associated with the cost anomaly. </p>
...
pub struct TotalImpactFilter  {
    ...
    #[doc(hidden)]pub numeric_operator: std::option::Option<crate::model::NumericOperator>,
    /// <p>The lower bound dollar value that's used in the filter. </p>
    #[doc(hidden)]pub start_value: f64,
    /// <p>The upper bound dollar value that's used in the filter. </p>
    #[doc(hidden)]pub end_value: f64,
}
