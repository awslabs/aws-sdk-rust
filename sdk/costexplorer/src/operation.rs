...
impl aws_smithy_http::response::ParseStrictResponse for GetAnomalyMonitors {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_anomaly_monitors::de_get_anomaly_monitors_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_anomaly_monitors::de_get_anomaly_monitors_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for GetCostCategories {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_cost_categories::de_get_cost_categories_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_cost_categories::de_get_cost_categories_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for GetCostForecast {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_cost_forecast::de_get_cost_forecast_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_cost_forecast::de_get_cost_forecast_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for GetUsageForecast {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_usage_forecast::de_get_usage_forecast_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_usage_forecast::de_get_usage_forecast_http_response(
                response,
            )
        }
    }
