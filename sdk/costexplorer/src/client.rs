    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CreateAnomalyMonitorInput`](crate::input::CreateAnomalyMonitorInput) with field(s):
    ///   - [`anomaly_monitor(Option<AnomalyMonitor>)`](crate::input::CreateAnomalyMonitorInput::anomaly_monitor): <p>The cost anomaly detection monitor object that you want to create.</p>
    ...
    ///
    /// - Takes [`CreateAnomalySubscriptionInput`](crate::input::CreateAnomalySubscriptionInput) with field(s):
    ///   - [`anomaly_subscription(Option<AnomalySubscription>)`](crate::input::CreateAnomalySubscriptionInput::anomaly_subscription): <p>The cost anomaly subscription object that you want to create. </p>
    ...
    ///
    /// - Takes [`CreateCostCategoryDefinitionInput`](crate::input::CreateCostCategoryDefinitionInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::CreateCostCategoryDefinitionInput::name): <p>The unique name of the Cost Category.</p>
    ///   - [`rule_version(Option<CostCategoryRuleVersion>)`](crate::input::CreateCostCategoryDefinitionInput::rule_version): <p>The rule schema version in this particular Cost Category.</p>
    ///   - [`rules(Option<Vec<CostCategoryRule>>)`](crate::input::CreateCostCategoryDefinitionInput::rules): <p>The Cost Category rules used to categorize costs. For more information, see <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_CostCategoryRule.html">CostCategoryRule</a>.</p>
    ///   - [`default_value(Option<String>)`](crate::input::CreateCostCategoryDefinitionInput::default_value): <p>The default value for the cost category.</p>
    ///   - [`split_charge_rules(Option<Vec<CostCategorySplitChargeRule>>)`](crate::input::CreateCostCategoryDefinitionInput::split_charge_rules): <p> The split charge rules used to allocate your charges between your Cost Category values. </p>
    ...
    ///
    /// - Takes [`DeleteAnomalyMonitorInput`](crate::input::DeleteAnomalyMonitorInput) with field(s):
    ///   - [`monitor_arn(Option<String>)`](crate::input::DeleteAnomalyMonitorInput::monitor_arn): <p>The unique identifier of the cost anomaly monitor that you want to delete. </p>
    ...
    ///
    /// - Takes [`DeleteAnomalySubscriptionInput`](crate::input::DeleteAnomalySubscriptionInput) with field(s):
    ///   - [`subscription_arn(Option<String>)`](crate::input::DeleteAnomalySubscriptionInput::subscription_arn): <p>The unique identifier of the cost anomaly subscription that you want to delete. </p>
    ...
    ///
    /// - Takes [`DeleteCostCategoryDefinitionInput`](crate::input::DeleteCostCategoryDefinitionInput) with field(s):
    ///   - [`cost_category_arn(Option<String>)`](crate::input::DeleteCostCategoryDefinitionInput::cost_category_arn): <p> The unique identifier for your Cost Category. </p>
    ...
    ///
    /// - Takes [`DescribeCostCategoryDefinitionInput`](crate::input::DescribeCostCategoryDefinitionInput) with field(s):
    ///   - [`cost_category_arn(Option<String>)`](crate::input::DescribeCostCategoryDefinitionInput::cost_category_arn): <p> The unique identifier for your Cost Category. </p>
    ///   - [`effective_on(Option<String>)`](crate::input::DescribeCostCategoryDefinitionInput::effective_on): <p> The date when the Cost Category was effective. </p>
    ...
    ///
    /// - Takes [`GetAnomaliesInput`](crate::input::GetAnomaliesInput) with field(s):
    ///   - [`monitor_arn(Option<String>)`](crate::input::GetAnomaliesInput::monitor_arn): <p>Retrieves all of the cost anomalies detected for a specific cost anomaly monitor Amazon Resource Name (ARN). </p>
    ///   - [`date_interval(Option<AnomalyDateInterval>)`](crate::input::GetAnomaliesInput::date_interval): <p>Assigns the start and end dates for retrieving cost anomalies. The returned anomaly object will have an <code>AnomalyEndDate</code> in the specified time range. </p>
    ///   - [`feedback(Option<AnomalyFeedbackType>)`](crate::input::GetAnomaliesInput::feedback): <p>Filters anomaly results by the feedback field on the anomaly object. </p>
    ///   - [`total_impact(Option<TotalImpactFilter>)`](crate::input::GetAnomaliesInput::total_impact): <p>Filters anomaly results by the total impact field on the anomaly object. For example, you can filter anomalies <code>GREATER_THAN 200.00</code> to retrieve anomalies, with an estimated dollar impact greater than 200. </p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetAnomaliesInput::next_page_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetAnomaliesInput::max_results): <p>The number of entries a paginated response contains. </p>
    ...
    ///
    /// - Takes [`GetAnomalyMonitorsInput`](crate::input::GetAnomalyMonitorsInput) with field(s):
    ///   - [`monitor_arn_list(Option<Vec<String>>)`](crate::input::GetAnomalyMonitorsInput::monitor_arn_list): <p>A list of cost anomaly monitor ARNs. </p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetAnomalyMonitorsInput::next_page_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetAnomalyMonitorsInput::max_results): <p>The number of entries that a paginated response contains. </p>
    ...
    ///
    /// - Takes [`GetAnomalySubscriptionsInput`](crate::input::GetAnomalySubscriptionsInput) with field(s):
    ///   - [`subscription_arn_list(Option<Vec<String>>)`](crate::input::GetAnomalySubscriptionsInput::subscription_arn_list): <p>A list of cost anomaly subscription ARNs. </p>
    ///   - [`monitor_arn(Option<String>)`](crate::input::GetAnomalySubscriptionsInput::monitor_arn): <p>Cost anomaly monitor ARNs. </p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetAnomalySubscriptionsInput::next_page_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetAnomalySubscriptionsInput::max_results): <p>The number of entries a paginated response contains. </p>
    ...
    ///
    /// - Takes [`GetReservationCoverageInput`](crate::input::GetReservationCoverageInput) with field(s):
    ///   - [`time_period(Option<DateInterval>)`](crate::input::GetReservationCoverageInput::time_period): <p>The start and end dates of the period that you want to retrieve data about reservation coverage for. You can retrieve data for a maximum of 13 months: the last 12 months and the current month. The start date is inclusive, but the end date is exclusive. For example, if <code>start</code> is <code>2017-01-01</code> and <code>end</code> is <code>2017-05-01</code>, then the cost and usage data is retrieved from <code>2017-01-01</code> up to and including <code>2017-04-30</code> but not including <code>2017-05-01</code>. </p>
    ///   - [`group_by(Option<Vec<GroupDefinition>>)`](crate::input::GetReservationCoverageInput::group_by): <p>You can group the data by the following attributes:</p>  <ul>   <li> <p>AZ</p> </li>   <li> <p>CACHE_ENGINE</p> </li>   <li> <p>DATABASE_ENGINE</p> </li>   <li> <p>DEPLOYMENT_OPTION</p> </li>   <li> <p>INSTANCE_TYPE</p> </li>   <li> <p>LINKED_ACCOUNT</p> </li>   <li> <p>OPERATING_SYSTEM</p> </li>   <li> <p>PLATFORM</p> </li>   <li> <p>REGION</p> </li>   <li> <p>TENANCY</p> </li>  </ul>
    ///   - [`granularity(Option<Granularity>)`](crate::input::GetReservationCoverageInput::granularity): <p>The granularity of the Amazon Web Services cost data for the reservation. Valid values are <code>MONTHLY</code> and <code>DAILY</code>.</p>  <p>If <code>GroupBy</code> is set, <code>Granularity</code> can't be set. If <code>Granularity</code> isn't set, the response object doesn't include <code>Granularity</code>, either <code>MONTHLY</code> or <code>DAILY</code>.</p>  <p>The <code>GetReservationCoverage</code> operation supports only <code>DAILY</code> and <code>MONTHLY</code> granularities.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetReservationCoverageInput::filter): <p>Filters utilization data by dimensions. You can filter by the following dimensions:</p>  <ul>   <li> <p>AZ</p> </li>   <li> <p>CACHE_ENGINE</p> </li>   <li> <p>DATABASE_ENGINE</p> </li>   <li> <p>DEPLOYMENT_OPTION</p> </li>   <li> <p>INSTANCE_TYPE</p> </li>   <li> <p>LINKED_ACCOUNT</p> </li>   <li> <p>OPERATING_SYSTEM</p> </li>   <li> <p>PLATFORM</p> </li>   <li> <p>REGION</p> </li>   <li> <p>SERVICE</p> </li>   <li> <p>TAG</p> </li>   <li> <p>TENANCY</p> </li>  </ul>  <p> <code>GetReservationCoverage</code> uses the same <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html">Expression</a> object as the other operations, but only <code>AND</code> is supported among each dimension. You can nest only one level deep. If there are multiple values for a dimension, they are OR'd together.</p>  <p>If you don't provide a <code>SERVICE</code> filter, Cost Explorer defaults to EC2.</p>  <p>Cost category is also supported.</p>
    ///   - [`metrics(Option<Vec<String>>)`](crate::input::GetReservationCoverageInput::metrics): <p>The measurement that you want your reservation coverage reported in.</p>  <p>Valid values are <code>Hour</code>, <code>Unit</code>, and <code>Cost</code>. You can use multiple values in a request.</p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetReservationCoverageInput::next_page_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    ///   - [`sort_by(Option<SortDefinition>)`](crate::input::GetReservationCoverageInput::sort_by): <p>The value by which you want to sort the data.</p>  <p>The following values are supported for <code>Key</code>:</p>  <ul>   <li> <p> <code>OnDemandCost</code> </p> </li>   <li> <p> <code>CoverageHoursPercentage</code> </p> </li>   <li> <p> <code>OnDemandHours</code> </p> </li>   <li> <p> <code>ReservedHours</code> </p> </li>   <li> <p> <code>TotalRunningHours</code> </p> </li>   <li> <p> <code>CoverageNormalizedUnitsPercentage</code> </p> </li>   <li> <p> <code>OnDemandNormalizedUnits</code> </p> </li>   <li> <p> <code>ReservedNormalizedUnits</code> </p> </li>   <li> <p> <code>TotalRunningNormalizedUnits</code> </p> </li>   <li> <p> <code>Time</code> </p> </li>  </ul>  <p>Supported values for <code>SortOrder</code> are <code>ASCENDING</code> or <code>DESCENDING</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetReservationCoverageInput::max_results): <p>The maximum number of objects that you returned for this request. If more objects are available, in the response, Amazon Web Services provides a NextPageToken value that you can use in a subsequent call to get the next batch of objects.</p>
    ...
    ///
    /// - Takes [`GetReservationPurchaseRecommendationInput`](crate::input::GetReservationPurchaseRecommendationInput) with field(s):
    ///   - [`account_id(Option<String>)`](crate::input::GetReservationPurchaseRecommendationInput::account_id): <p>The account ID that is associated with the recommendation. </p>
    ///   - [`service(Option<String>)`](crate::input::GetReservationPurchaseRecommendationInput::service): <p>The specific service that you want recommendations for.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetReservationPurchaseRecommendationInput::filter): <p>Use <code>Expression</code> to filter by cost or by usage. There are two patterns: </p>  <ul>   <li> <p>Simple dimension values - You can set the dimension name and values for the filters that you plan to use. For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. For <code>GetRightsizingRecommendation</code>, the Region is a full name (for example, <code>REGION==US East (N. Virginia)</code>. The <code>Expression</code> example is as follows:</p> <p> <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }</code> </p> <p>The list of dimension values are OR'd together to retrieve cost or usage data. You can create <code>Expression</code> and <code>DimensionValues</code> objects using either <code>with*</code> methods or <code>set*</code> methods in multiple lines. </p> </li>   <li> <p>Compound dimension values with logical operations - You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. By doing this, you can filter on more advanced options. For example, you can filter on <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>. The <code>Expression</code> for that is as follows:</p> <p> <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> <note>     <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error.</p>    </note> <p> <code> { "And": [ ... ], "DimensionValues": { "Dimension": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> </li>  </ul> <note>   <p>For the <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT isn't supported. OR isn't supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p>   <p>For the <code>GetReservationPurchaseRecommendation</code> action, only NOT is supported. AND and OR aren't supported. Dimensions are limited to <code>LINKED_ACCOUNT</code>.</p>  </note>
    ///   - [`account_scope(Option<AccountScope>)`](crate::input::GetReservationPurchaseRecommendationInput::account_scope): <p>The account scope that you want your recommendations for. Amazon Web Services calculates recommendations including the management account and member accounts if the value is set to <code>PAYER</code>. If the value is <code>LINKED</code>, recommendations are calculated for individual member accounts only.</p>
    ///   - [`lookback_period_in_days(Option<LookbackPeriodInDays>)`](crate::input::GetReservationPurchaseRecommendationInput::lookback_period_in_days): <p>The number of previous days that you want Amazon Web Services to consider when it calculates your recommendations.</p>
    ///   - [`term_in_years(Option<TermInYears>)`](crate::input::GetReservationPurchaseRecommendationInput::term_in_years): <p>The reservation term that you want recommendations for.</p>
    ///   - [`payment_option(Option<PaymentOption>)`](crate::input::GetReservationPurchaseRecommendationInput::payment_option): <p>The reservation purchase option that you want recommendations for.</p>
    ///   - [`service_specification(Option<ServiceSpecification>)`](crate::input::GetReservationPurchaseRecommendationInput::service_specification): <p>The hardware specifications for the service instances that you want recommendations for, such as standard or convertible Amazon EC2 instances.</p>
    ///   - [`page_size(i32)`](crate::input::GetReservationPurchaseRecommendationInput::page_size): <p>The number of recommendations that you want returned in a single response object.</p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetReservationPurchaseRecommendationInput::next_page_token): <p>The pagination token that indicates the next set of results that you want to retrieve.</p>
    ...
    ///
    /// - Takes [`GetRightsizingRecommendationInput`](crate::input::GetRightsizingRecommendationInput) with field(s):
    ///   - [`filter(Option<Expression>)`](crate::input::GetRightsizingRecommendationInput::filter): <p>Use <code>Expression</code> to filter by cost or by usage. There are two patterns: </p>  <ul>   <li> <p>Simple dimension values - You can set the dimension name and values for the filters that you plan to use. For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. For <code>GetRightsizingRecommendation</code>, the Region is a full name (for example, <code>REGION==US East (N. Virginia)</code>. The <code>Expression</code> example is as follows:</p> <p> <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }</code> </p> <p>The list of dimension values are OR'd together to retrieve cost or usage data. You can create <code>Expression</code> and <code>DimensionValues</code> objects using either <code>with*</code> methods or <code>set*</code> methods in multiple lines. </p> </li>   <li> <p>Compound dimension values with logical operations - You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. By doing this, you can filter on more advanced options. For example, you can filter on <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>. The <code>Expression</code> for that is as follows:</p> <p> <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> <note>     <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error.</p>    </note> <p> <code> { "And": [ ... ], "DimensionValues": { "Dimension": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> </li>  </ul> <note>   <p>For the <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT isn't supported. OR isn't supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p>   <p>For the <code>GetReservationPurchaseRecommendation</code> action, only NOT is supported. AND and OR aren't supported. Dimensions are limited to <code>LINKED_ACCOUNT</code>.</p>  </note>
    ///   - [`configuration(Option<RightsizingRecommendationConfiguration>)`](crate::input::GetRightsizingRecommendationInput::configuration): <p> Enables you to customize recommendations across two attributes. You can choose to view recommendations for instances within the same instance families or across different instance families. You can also choose to view your estimated savings associated with recommendations with consideration of existing Savings Plans or RI benefits, or neither. </p>
    ///   - [`service(Option<String>)`](crate::input::GetRightsizingRecommendationInput::service): <p>The specific service that you want recommendations for. The only valid value for <code>GetRightsizingRecommendation</code> is "<code>AmazonEC2</code>".</p>
    ///   - [`page_size(i32)`](crate::input::GetRightsizingRecommendationInput::page_size): <p>The number of recommendations that you want returned in a single response object.</p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetRightsizingRecommendationInput::next_page_token): <p>The pagination token that indicates the next set of results that you want to retrieve.</p>
    ...
    ///
    /// - Takes [`GetSavingsPlansCoverageInput`](crate::input::GetSavingsPlansCoverageInput) with field(s):
    ///   - [`time_period(Option<DateInterval>)`](crate::input::GetSavingsPlansCoverageInput::time_period): <p>The time period that you want the usage and costs for. The <code>Start</code> date must be within 13 months. The <code>End</code> date must be after the <code>Start</code> date, and before the current date. Future dates can't be used as an <code>End</code> date.</p>
    ///   - [`group_by(Option<Vec<GroupDefinition>>)`](crate::input::GetSavingsPlansCoverageInput::group_by): <p>You can group the data using the attributes <code>INSTANCE_FAMILY</code>, <code>REGION</code>, or <code>SERVICE</code>.</p>
    ///   - [`granularity(Option<Granularity>)`](crate::input::GetSavingsPlansCoverageInput::granularity): <p>The granularity of the Amazon Web Services cost data for your Savings Plans. <code>Granularity</code> can't be set if <code>GroupBy</code> is set.</p>  <p>The <code>GetSavingsPlansCoverage</code> operation supports only <code>DAILY</code> and <code>MONTHLY</code> granularities.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetSavingsPlansCoverageInput::filter): <p>Filters Savings Plans coverage data by dimensions. You can filter data for Savings Plans usage with the following dimensions:</p>  <ul>   <li> <p> <code>LINKED_ACCOUNT</code> </p> </li>   <li> <p> <code>REGION</code> </p> </li>   <li> <p> <code>SERVICE</code> </p> </li>   <li> <p> <code>INSTANCE_FAMILY</code> </p> </li>  </ul>  <p> <code>GetSavingsPlansCoverage</code> uses the same <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html">Expression</a> object as the other operations, but only <code>AND</code> is supported among each dimension. If there are multiple values for a dimension, they are OR'd together.</p>  <p>Cost category is also supported.</p>
    ///   - [`metrics(Option<Vec<String>>)`](crate::input::GetSavingsPlansCoverageInput::metrics): <p>The measurement that you want your Savings Plans coverage reported in. The only valid value is <code>SpendCoveredBySavingsPlans</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetSavingsPlansCoverageInput::next_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetSavingsPlansCoverageInput::max_results): <p>The number of items to be returned in a response. The default is <code>20</code>, with a minimum value of <code>1</code>.</p>
    ///   - [`sort_by(Option<SortDefinition>)`](crate::input::GetSavingsPlansCoverageInput::sort_by): <p>The value by which you want to sort the data.</p>  <p>The following values are supported for <code>Key</code>:</p>  <ul>   <li> <p> <code>SpendCoveredBySavingsPlan</code> </p> </li>   <li> <p> <code>OnDemandCost</code> </p> </li>   <li> <p> <code>CoveragePercentage</code> </p> </li>   <li> <p> <code>TotalCost</code> </p> </li>   <li> <p> <code>InstanceFamily</code> </p> </li>   <li> <p> <code>Region</code> </p> </li>   <li> <p> <code>Service</code> </p> </li>  </ul>  <p>Supported values for <code>SortOrder</code> are <code>ASCENDING</code> or <code>DESCENDING</code>.</p>
    ...
    ///
    /// - Takes [`GetSavingsPlansPurchaseRecommendationInput`](crate::input::GetSavingsPlansPurchaseRecommendationInput) with field(s):
    ///   - [`savings_plans_type(Option<SupportedSavingsPlansType>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::savings_plans_type): <p>The Savings Plans recommendation type requested.</p>
    ///   - [`term_in_years(Option<TermInYears>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::term_in_years): <p>The savings plan recommendation term used to generate these recommendations.</p>
    ///   - [`payment_option(Option<PaymentOption>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::payment_option): <p>The payment option used to generate these recommendations.</p>
    ///   - [`account_scope(Option<AccountScope>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::account_scope): <p>The account scope that you want your recommendations for. Amazon Web Services calculates recommendations including the management account and member accounts if the value is set to <code>PAYER</code>. If the value is <code>LINKED</code>, recommendations are calculated for individual member accounts only.</p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::next_page_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    ///   - [`page_size(i32)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::page_size): <p>The number of recommendations that you want returned in a single response object.</p>
    ///   - [`lookback_period_in_days(Option<LookbackPeriodInDays>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::lookback_period_in_days): <p>The lookback period used to generate the recommendation.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetSavingsPlansPurchaseRecommendationInput::filter): <p>You can filter your recommendations by Account ID with the <code>LINKED_ACCOUNT</code> dimension. To filter your recommendations by Account ID, specify <code>Key</code> as <code>LINKED_ACCOUNT</code> and <code>Value</code> as the comma-separated Acount ID(s) for which you want to see Savings Plans purchase recommendations.</p>  <p>For GetSavingsPlansPurchaseRecommendation, the <code>Filter</code> does not include <code>CostCategories</code> or <code>Tags</code>. It only includes <code>Dimensions</code>. With <code>Dimensions</code>, <code>Key</code> must be <code>LINKED_ACCOUNT</code> and <code>Value</code> can be a single Account ID or multiple comma-separated Account IDs for which you want to see Savings Plans Purchase Recommendations. <code>AND</code> and <code>OR</code> operators are not supported.</p>
    ...
    ///
    /// - Takes [`GetSavingsPlansUtilizationInput`](crate::input::GetSavingsPlansUtilizationInput) with field(s):
    ///   - [`time_period(Option<DateInterval>)`](crate::input::GetSavingsPlansUtilizationInput::time_period): <p>The time period that you want the usage and costs for. The <code>Start</code> date must be within 13 months. The <code>End</code> date must be after the <code>Start</code> date, and before the current date. Future dates can't be used as an <code>End</code> date.</p>
    ///   - [`granularity(Option<Granularity>)`](crate::input::GetSavingsPlansUtilizationInput::granularity): <p>The granularity of the Amazon Web Services utillization data for your Savings Plans.</p>  <p>The <code>GetSavingsPlansUtilization</code> operation supports only <code>DAILY</code> and <code>MONTHLY</code> granularities.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetSavingsPlansUtilizationInput::filter): <p>Filters Savings Plans utilization coverage data for active Savings Plans dimensions. You can filter data with the following dimensions:</p>  <ul>   <li> <p> <code>LINKED_ACCOUNT</code> </p> </li>   <li> <p> <code>SAVINGS_PLAN_ARN</code> </p> </li>   <li> <p> <code>SAVINGS_PLANS_TYPE</code> </p> </li>   <li> <p> <code>REGION</code> </p> </li>   <li> <p> <code>PAYMENT_OPTION</code> </p> </li>   <li> <p> <code>INSTANCE_TYPE_FAMILY</code> </p> </li>  </ul>  <p> <code>GetSavingsPlansUtilization</code> uses the same <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html">Expression</a> object as the other operations, but only <code>AND</code> is supported among each dimension.</p>
    ///   - [`sort_by(Option<SortDefinition>)`](crate::input::GetSavingsPlansUtilizationInput::sort_by): <p>The value by which you want to sort the data.</p>  <p>The following values are supported for <code>Key</code>:</p>  <ul>   <li> <p> <code>UtilizationPercentage</code> </p> </li>   <li> <p> <code>TotalCommitment</code> </p> </li>   <li> <p> <code>UsedCommitment</code> </p> </li>   <li> <p> <code>UnusedCommitment</code> </p> </li>   <li> <p> <code>NetSavings</code> </p> </li>  </ul>  <p>Supported values for <code>SortOrder</code> are <code>ASCENDING</code> or <code>DESCENDING</code>.</p>
    ...
    ///
    /// - Takes [`GetSavingsPlansUtilizationDetailsInput`](crate::input::GetSavingsPlansUtilizationDetailsInput) with field(s):
    ///   - [`time_period(Option<DateInterval>)`](crate::input::GetSavingsPlansUtilizationDetailsInput::time_period): <p>The time period that you want the usage and costs for. The <code>Start</code> date must be within 13 months. The <code>End</code> date must be after the <code>Start</code> date, and before the current date. Future dates can't be used as an <code>End</code> date.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetSavingsPlansUtilizationDetailsInput::filter): <p>Filters Savings Plans utilization coverage data for active Savings Plans dimensions. You can filter data with the following dimensions:</p>  <ul>   <li> <p> <code>LINKED_ACCOUNT</code> </p> </li>   <li> <p> <code>SAVINGS_PLAN_ARN</code> </p> </li>   <li> <p> <code>REGION</code> </p> </li>   <li> <p> <code>PAYMENT_OPTION</code> </p> </li>   <li> <p> <code>INSTANCE_TYPE_FAMILY</code> </p> </li>  </ul>  <p> <code>GetSavingsPlansUtilizationDetails</code> uses the same <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html">Expression</a> object as the other operations, but only <code>AND</code> is supported among each dimension.</p>
    ///   - [`data_type(Option<Vec<SavingsPlansDataType>>)`](crate::input::GetSavingsPlansUtilizationDetailsInput::data_type): <p>The data type.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetSavingsPlansUtilizationDetailsInput::next_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetSavingsPlansUtilizationDetailsInput::max_results): <p>The number of items to be returned in a response. The default is <code>20</code>, with a minimum value of <code>1</code>.</p>
    ///   - [`sort_by(Option<SortDefinition>)`](crate::input::GetSavingsPlansUtilizationDetailsInput::sort_by): <p>The value by which you want to sort the data.</p>  <p>The following values are supported for <code>Key</code>:</p>  <ul>   <li> <p> <code>UtilizationPercentage</code> </p> </li>   <li> <p> <code>TotalCommitment</code> </p> </li>   <li> <p> <code>UsedCommitment</code> </p> </li>   <li> <p> <code>UnusedCommitment</code> </p> </li>   <li> <p> <code>NetSavings</code> </p> </li>   <li> <p> <code>AmortizedRecurringCommitment</code> </p> </li>   <li> <p> <code>AmortizedUpfrontCommitment</code> </p> </li>  </ul>  <p>Supported values for <code>SortOrder</code> are <code>ASCENDING</code> or <code>DESCENDING</code>.</p>
    ...
    ///   - [`search_string(Option<String>)`](crate::input::GetTagsInput::search_string): <p>The value that you want to search for.</p>
    ///   - [`time_period(Option<DateInterval>)`](crate::input::GetTagsInput::time_period): <p>The start and end dates for retrieving the dimension values. The start date is inclusive, but the end date is exclusive. For example, if <code>start</code> is <code>2017-01-01</code> and <code>end</code> is <code>2017-05-01</code>, then the cost and usage data is retrieved from <code>2017-01-01</code> up to and including <code>2017-04-30</code> but not including <code>2017-05-01</code>.</p>
    ///   - [`tag_key(Option<String>)`](crate::input::GetTagsInput::tag_key): <p>The key of the tag that you want to return values for.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetTagsInput::filter): <p>Use <code>Expression</code> to filter by cost or by usage. There are two patterns: </p>  <ul>   <li> <p>Simple dimension values - You can set the dimension name and values for the filters that you plan to use. For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. For <code>GetRightsizingRecommendation</code>, the Region is a full name (for example, <code>REGION==US East (N. Virginia)</code>. The <code>Expression</code> example is as follows:</p> <p> <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }</code> </p> <p>The list of dimension values are OR'd together to retrieve cost or usage data. You can create <code>Expression</code> and <code>DimensionValues</code> objects using either <code>with*</code> methods or <code>set*</code> methods in multiple lines. </p> </li>   <li> <p>Compound dimension values with logical operations - You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. By doing this, you can filter on more advanced options. For example, you can filter on <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>. The <code>Expression</code> for that is as follows:</p> <p> <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> <note>     <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error.</p>    </note> <p> <code> { "And": [ ... ], "DimensionValues": { "Dimension": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> </li>  </ul> <note>   <p>For the <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT isn't supported. OR isn't supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p>   <p>For the <code>GetReservationPurchaseRecommendation</code> action, only NOT is supported. AND and OR aren't supported. Dimensions are limited to <code>LINKED_ACCOUNT</code>.</p>  </note>
    ///   - [`sort_by(Option<Vec<SortDefinition>>)`](crate::input::GetTagsInput::sort_by): <p>The value by which you want to sort the data.</p>  <p>The key represents cost and usage metrics. The following values are supported:</p>  <ul>   <li> <p> <code>BlendedCost</code> </p> </li>   <li> <p> <code>UnblendedCost</code> </p> </li>   <li> <p> <code>AmortizedCost</code> </p> </li>   <li> <p> <code>NetAmortizedCost</code> </p> </li>   <li> <p> <code>NetUnblendedCost</code> </p> </li>   <li> <p> <code>UsageQuantity</code> </p> </li>   <li> <p> <code>NormalizedUsageAmount</code> </p> </li>  </ul>  <p>Supported values for <code>SortOrder</code> are <code>ASCENDING</code> or <code>DESCENDING</code>.</p>  <p>When using <code>SortBy</code>, <code>NextPageToken</code> and <code>SearchString</code> are not supported.</p>
    ///   - [`max_results(i32)`](crate::input::GetTagsInput::max_results): <p>This field is only used when SortBy is provided in the request. The maximum number of objects that to be returned for this request. If MaxResults is not specified with SortBy, the request will return 1000 results as the default value for this parameter.</p>  <p>For <code>GetTags</code>, MaxResults has an upper limit of 1000.</p>
    ///   - [`next_page_token(Option<String>)`](crate::input::GetTagsInput::next_page_token): <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    ...
    ///
    /// - Takes [`GetUsageForecastInput`](crate::input::GetUsageForecastInput) with field(s):
    ///   - [`time_period(Option<DateInterval>)`](crate::input::GetUsageForecastInput::time_period): <p>The start and end dates of the period that you want to retrieve usage forecast for. The start date is inclusive, but the end date is exclusive. For example, if <code>start</code> is <code>2017-01-01</code> and <code>end</code> is <code>2017-05-01</code>, then the cost and usage data is retrieved from <code>2017-01-01</code> up to and including <code>2017-04-30</code> but not including <code>2017-05-01</code>. The start date must be equal to or later than the current date to avoid a validation error.</p>
    ///   - [`metric(Option<Metric>)`](crate::input::GetUsageForecastInput::metric): <p>Which metric Cost Explorer uses to create your forecast.</p>  <p>Valid values for a <code>GetUsageForecast</code> call are the following:</p>  <ul>   <li> <p>USAGE_QUANTITY</p> </li>   <li> <p>NORMALIZED_USAGE_AMOUNT</p> </li>  </ul>
    ///   - [`granularity(Option<Granularity>)`](crate::input::GetUsageForecastInput::granularity): <p>How granular you want the forecast to be. You can get 3 months of <code>DAILY</code> forecasts or 12 months of <code>MONTHLY</code> forecasts.</p>  <p>The <code>GetUsageForecast</code> operation supports only <code>DAILY</code> and <code>MONTHLY</code> granularities.</p>
    ///   - [`filter(Option<Expression>)`](crate::input::GetUsageForecastInput::filter): <p>The filters that you want to use to filter your forecast. The <code>GetUsageForecast</code> API supports filtering by the following dimensions:</p>  <ul>   <li> <p> <code>AZ</code> </p> </li>   <li> <p> <code>INSTANCE_TYPE</code> </p> </li>   <li> <p> <code>LINKED_ACCOUNT</code> </p> </li>   <li> <p> <code>LINKED_ACCOUNT_NAME</code> </p> </li>   <li> <p> <code>OPERATION</code> </p> </li>   <li> <p> <code>PURCHASE_TYPE</code> </p> </li>   <li> <p> <code>REGION</code> </p> </li>   <li> <p> <code>SERVICE</code> </p> </li>   <li> <p> <code>USAGE_TYPE</code> </p> </li>   <li> <p> <code>USAGE_TYPE_GROUP</code> </p> </li>   <li> <p> <code>RECORD_TYPE</code> </p> </li>   <li> <p> <code>OPERATING_SYSTEM</code> </p> </li>   <li> <p> <code>TENANCY</code> </p> </li>   <li> <p> <code>SCOPE</code> </p> </li>   <li> <p> <code>PLATFORM</code> </p> </li>   <li> <p> <code>SUBSCRIPTION_ID</code> </p> </li>   <li> <p> <code>LEGAL_ENTITY_NAME</code> </p> </li>   <li> <p> <code>DEPLOYMENT_OPTION</code> </p> </li>   <li> <p> <code>DATABASE_ENGINE</code> </p> </li>   <li> <p> <code>INSTANCE_TYPE_FAMILY</code> </p> </li>   <li> <p> <code>BILLING_ENTITY</code> </p> </li>   <li> <p> <code>RESERVATION_ID</code> </p> </li>   <li> <p> <code>SAVINGS_PLAN_ARN</code> </p> </li>  </ul>
    ///   - [`prediction_interval_level(Option<i32>)`](crate::input::GetUsageForecastInput::prediction_interval_level): <p>Cost Explorer always returns the mean forecast as a single point. You can request a prediction interval around the mean by specifying a confidence level. The higher the confidence level, the more confident Cost Explorer is about the actual value falling in the prediction interval. Higher confidence levels result in wider prediction intervals.</p>
    ...
    ///
    /// - Takes [`ListCostCategoryDefinitionsInput`](crate::input::ListCostCategoryDefinitionsInput) with field(s):
    ///   - [`effective_on(Option<String>)`](crate::input::ListCostCategoryDefinitionsInput::effective_on): <p> The date when the Cost Category was effective. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListCostCategoryDefinitionsInput::next_token): <p> The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListCostCategoryDefinitionsInput::max_results): <p> The number of entries a paginated response contains. </p>
    ...
    ///
    /// - Takes [`ProvideAnomalyFeedbackInput`](crate::input::ProvideAnomalyFeedbackInput) with field(s):
    ///   - [`anomaly_id(Option<String>)`](crate::input::ProvideAnomalyFeedbackInput::anomaly_id): <p>A cost anomaly ID. </p>
    ///   - [`feedback(Option<AnomalyFeedbackType>)`](crate::input::ProvideAnomalyFeedbackInput::feedback): <p>Describes whether the cost anomaly was a planned activity or you considered it an anomaly. </p>
    ...
    ///
    /// - Takes [`UpdateAnomalyMonitorInput`](crate::input::UpdateAnomalyMonitorInput) with field(s):
    ///   - [`monitor_arn(Option<String>)`](crate::input::UpdateAnomalyMonitorInput::monitor_arn): <p>Cost anomaly monitor Amazon Resource Names (ARNs). </p>
    ///   - [`monitor_name(Option<String>)`](crate::input::UpdateAnomalyMonitorInput::monitor_name): <p>The new name for the cost anomaly monitor. </p>
    ...
    ///
    /// - Takes [`UpdateAnomalySubscriptionInput`](crate::input::UpdateAnomalySubscriptionInput) with field(s):
    ///   - [`subscription_arn(Option<String>)`](crate::input::UpdateAnomalySubscriptionInput::subscription_arn): <p>A cost anomaly subscription Amazon Resource Name (ARN). </p>
    ///   - [`threshold(Option<f64>)`](crate::input::UpdateAnomalySubscriptionInput::threshold): <p>The update to the threshold value for receiving notifications. </p>
    ///   - [`frequency(Option<AnomalySubscriptionFrequency>)`](crate::input::UpdateAnomalySubscriptionInput::frequency): <p>The update to the frequency value that subscribers receive notifications. </p>
    ///   - [`monitor_arn_list(Option<Vec<String>>)`](crate::input::UpdateAnomalySubscriptionInput::monitor_arn_list): <p>A list of cost anomaly monitor ARNs. </p>
    ///   - [`subscribers(Option<Vec<Subscriber>>)`](crate::input::UpdateAnomalySubscriptionInput::subscribers): <p>The update to the subscriber list. </p>
    ///   - [`subscription_name(Option<String>)`](crate::input::UpdateAnomalySubscriptionInput::subscription_name): <p>The new name of the subscription. </p>
    ...
    ///
    /// - Takes [`UpdateCostCategoryDefinitionInput`](crate::input::UpdateCostCategoryDefinitionInput) with field(s):
    ///   - [`cost_category_arn(Option<String>)`](crate::input::UpdateCostCategoryDefinitionInput::cost_category_arn): <p>The unique identifier for your Cost Category.</p>
    ///   - [`rule_version(Option<CostCategoryRuleVersion>)`](crate::input::UpdateCostCategoryDefinitionInput::rule_version): <p>The rule schema version in this particular Cost Category.</p>
    ///   - [`rules(Option<Vec<CostCategoryRule>>)`](crate::input::UpdateCostCategoryDefinitionInput::rules): <p>The <code>Expression</code> object used to categorize costs. For more information, see <a href="https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_CostCategoryRule.html">CostCategoryRule </a>. </p>
    ///   - [`default_value(Option<String>)`](crate::input::UpdateCostCategoryDefinitionInput::default_value): <p>The default value for the cost category.</p>
    ///   - [`split_charge_rules(Option<Vec<CostCategorySplitChargeRule>>)`](crate::input::UpdateCostCategoryDefinitionInput::split_charge_rules): <p> The split charge rules used to allocate your charges between your Cost Category values. </p>
