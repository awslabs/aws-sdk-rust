...
/// For example, the [`CreateCostCategoryDefinition`](crate::operation) operation has
...
mod create_anomaly_monitor;

mod create_anomaly_subscription;

mod create_cost_category_definition;

mod delete_anomaly_monitor;

mod delete_anomaly_subscription;

mod delete_cost_category_definition;

mod describe_cost_category_definition;
...
mod get_dimension_values;

mod get_reservation_coverage;

mod get_reservation_purchase_recommendation;

mod get_reservation_utilization;
...
mod get_savings_plans_utilization;

mod get_savings_plans_utilization_details;
...
mod update_anomaly_monitor;

mod update_anomaly_subscription;

mod update_cost_allocation_tags_status;

mod update_cost_category_definition;
