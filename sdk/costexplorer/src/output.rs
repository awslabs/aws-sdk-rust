...
pub struct UpdateCostAllocationTagsStatusOutput  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<crate::model::UpdateCostAllocationTagsStatusError>>,
}
...
pub struct ListCostCategoryDefinitionsOutput  {
    ...
    #[doc(hidden)]pub cost_category_references: std::option::Option<std::vec::Vec<crate::model::CostCategoryReference>>,
...
pub struct ListCostAllocationTagsOutput  {
    ...
    #[doc(hidden)]pub cost_allocation_tags: std::option::Option<std::vec::Vec<crate::model::CostAllocationTag>>,
    /// <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetUsageForecastOutput  {
    ...
    #[doc(hidden)]pub total: std::option::Option<crate::model::MetricValue>,
    ...
    #[doc(hidden)]pub forecast_results_by_time: std::option::Option<std::vec::Vec<crate::model::ForecastResult>>,
}
...
pub struct GetTagsOutput  {
    ...
    #[doc(hidden)]pub return_size: std::option::Option<i32>,
    /// <p>The total number of query results.</p>
    #[doc(hidden)]pub total_size: std::option::Option<i32>,
}
impl GetTagsOutput {
    /// <p>The token for the next set of retrievable results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
...
pub struct GetSavingsPlansUtilizationDetailsOutput  {
    ...
    #[doc(hidden)]pub savings_plans_utilization_details: std::option::Option<std::vec::Vec<crate::model::SavingsPlansUtilizationDetail>>,
    /// <p>The total Savings Plans utilization, regardless of time period.</p>
    #[doc(hidden)]pub total: std::option::Option<crate::model::SavingsPlansUtilizationAggregates>,
...
impl  std::fmt::Debug for GetSavingsPlansUtilizationDetailsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("savings_plans_utilization_details", &self.savings_plans_utilization_details);
        formatter.field("total", &self.total);
...
pub struct GetSavingsPlansUtilizationOutput  {
    ...
    #[doc(hidden)]pub savings_plans_utilizations_by_time: std::option::Option<std::vec::Vec<crate::model::SavingsPlansUtilizationByTime>>,
...
impl  std::fmt::Debug for GetSavingsPlansUtilizationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("savings_plans_utilizations_by_time", &self.savings_plans_utilizations_by_time);
        formatter.field("total", &self.total);
        formatter.finish()
    }
}
...
pub struct GetSavingsPlansPurchaseRecommendationOutput  {
    ...
    #[doc(hidden)]pub metadata: std::option::Option<crate::model::SavingsPlansPurchaseRecommendationMetadata>,
    /// <p>Contains your request parameters, Savings Plan Recommendations Summary, and Details.</p>
    #[doc(hidden)]pub savings_plans_purchase_recommendation: std::option::Option<crate::model::SavingsPlansPurchaseRecommendation>,
    /// <p>The token for the next set of retrievable results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    #[doc(hidden)]pub next_page_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetSavingsPlansPurchaseRecommendationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("savings_plans_purchase_recommendation", &self.savings_plans_purchase_recommendation);
        formatter.field("next_page_token", &self.next_page_token);
        formatter.finish()
    }
}
...
pub struct GetSavingsPlansCoverageOutput  {
    ...
    #[doc(hidden)]pub savings_plans_coverages: std::option::Option<std::vec::Vec<crate::model::SavingsPlansCoverage>>,
    /// <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetRightsizingRecommendationOutput  {
    ...
    #[doc(hidden)]pub metadata: std::option::Option<crate::model::RightsizingRecommendationMetadata>,
    /// <p>Summary of this recommendation set.</p>
    #[doc(hidden)]pub summary: std::option::Option<crate::model::RightsizingRecommendationSummary>,
    /// <p>Recommendations to rightsize resources.</p>
    #[doc(hidden)]pub rightsizing_recommendations: std::option::Option<std::vec::Vec<crate::model::RightsizingRecommendation>>,
...
impl  std::fmt::Debug for GetRightsizingRecommendationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("rightsizing_recommendations", &self.rightsizing_recommendations);
        formatter.field("next_page_token", &self.next_page_token);
...
pub struct GetReservationUtilizationOutput  {
    ...
    #[doc(hidden)]pub utilizations_by_time: std::option::Option<std::vec::Vec<crate::model::UtilizationByTime>>,
...
pub struct GetReservationPurchaseRecommendationOutput  {
    ...
    #[doc(hidden)]pub metadata: std::option::Option<crate::model::ReservationPurchaseRecommendationMetadata>,
    /// <p>Recommendations for reservations to purchase.</p>
    #[doc(hidden)]pub recommendations: std::option::Option<std::vec::Vec<crate::model::ReservationPurchaseRecommendation>>,
...
pub struct GetReservationCoverageOutput  {
    ...
    #[doc(hidden)]pub coverages_by_time: std::option::Option<std::vec::Vec<crate::model::CoverageByTime>>,
...
pub struct GetDimensionValuesOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub dimension_values: std::option::Option<std::vec::Vec<crate::model::DimensionValuesWithAttributes>>,
...
pub struct GetCostCategoriesOutput  {
    ...
    #[doc(hidden)]pub cost_category_names: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub cost_category_values: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct GetCostAndUsageWithResourcesOutput  {
    ...
    #[doc(hidden)]pub group_definitions: std::option::Option<std::vec::Vec<crate::model::GroupDefinition>>,
    /// <p>The time period that's covered by the results in the response.</p>
    #[doc(hidden)]pub results_by_time: std::option::Option<std::vec::Vec<crate::model::ResultByTime>>,
    ...
    #[doc(hidden)]pub dimension_value_attributes: std::option::Option<std::vec::Vec<crate::model::DimensionValuesWithAttributes>>,
}
...
impl  std::fmt::Debug for GetCostAndUsageWithResourcesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("dimension_value_attributes", &self.dimension_value_attributes);
        formatter.finish()
    }
}
...
pub struct GetAnomalySubscriptionsOutput  {
    ...
    #[doc(hidden)]pub anomaly_subscriptions: std::option::Option<std::vec::Vec<crate::model::AnomalySubscription>>,
    /// <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    #[doc(hidden)]pub next_page_token: std::option::Option<std::string::String>,
}
...
pub struct GetAnomalyMonitorsOutput  {
    ...
    #[doc(hidden)]pub anomaly_monitors: std::option::Option<std::vec::Vec<crate::model::AnomalyMonitor>>,
    /// <p>The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size. </p>
    #[doc(hidden)]pub next_page_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeCostCategoryDefinitionOutput  {
    ...
    #[doc(hidden)]pub cost_category: std::option::Option<crate::model::CostCategory>,
}
