...
impl crate::operation::get_savings_plans_purchase_recommendation::builders::GetSavingsPlansPurchaseRecommendationInputBuilder {
...
impl GetSavingsPlansPurchaseRecommendationFluentBuilder {
    /// Creates a new `GetSavingsPlansPurchaseRecommendationFluentBuilder`.
