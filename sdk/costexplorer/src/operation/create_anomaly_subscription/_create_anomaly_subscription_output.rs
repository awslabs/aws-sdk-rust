...
impl  CreateAnomalySubscriptionOutput  {
    ...
    pub fn subscription_arn(&self) -> & str {
        use std::ops::Deref; self.subscription_arn.deref()
    }
}
...
impl CreateAnomalySubscriptionOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_anomaly_subscription::CreateAnomalySubscriptionOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_anomaly_subscription::CreateAnomalySubscriptionOutput {
                subscription_arn: self.subscription_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("subscription_arn", "subscription_arn was not specified but it is required when building CreateAnomalySubscriptionOutput")
                    )?
                ,
