...
impl GetReservationUtilizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_reservation_utilization::GetReservationUtilizationInput, ::aws_smithy_types::error::operation::BuildError> {
