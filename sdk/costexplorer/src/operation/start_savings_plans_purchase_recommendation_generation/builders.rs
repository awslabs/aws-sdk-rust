...
impl
    crate::operation::start_savings_plans_purchase_recommendation_generation::builders::StartSavingsPlansPurchaseRecommendationGenerationInputBuilder
{
...
impl StartSavingsPlansPurchaseRecommendationGenerationFluentBuilder {
    /// Creates a new `StartSavingsPlansPurchaseRecommendationGenerationFluentBuilder`.
