...
impl GetAnomalyMonitorsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_anomaly_monitors::GetAnomalyMonitorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_anomaly_monitors::GetAnomalyMonitorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_anomaly_monitors::GetAnomalyMonitorsOutput, crate::operation::get_anomaly_monitors::GetAnomalyMonitorsError, Self> {
