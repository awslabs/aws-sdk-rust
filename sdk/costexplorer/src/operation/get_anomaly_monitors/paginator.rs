...
/// Paginator for [`GetAnomalyMonitors`](crate::operation::get_anomaly_monitors::GetAnomalyMonitors)
pub struct GetAnomalyMonitorsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::get_anomaly_monitors::builders::GetAnomalyMonitorsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl GetAnomalyMonitorsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `anomaly_monitors`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::get_anomaly_monitors::paginator::GetAnomalyMonitorsPaginatorItems {
        crate::operation::get_anomaly_monitors::paginator::GetAnomalyMonitorsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_anomaly_monitors::GetAnomalyMonitors::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_get_anomaly_monitors_output_output_next_page_token(resp);
...
/// Flattened paginator for `GetAnomalyMonitorsPaginator`
///
/// This is created with [`.items()`](GetAnomalyMonitorsPaginator::items)
pub struct GetAnomalyMonitorsPaginatorItems(GetAnomalyMonitorsPaginator);

impl GetAnomalyMonitorsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_anomaly_monitors_output_output_anomaly_monitors(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
