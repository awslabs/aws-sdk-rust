...
impl GetCostAndUsageInput {
    /// Consumes the builder and constructs an Operation<[`GetCostAndUsage`](crate::operation::get_cost_and_usage::GetCostAndUsage)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_cost_and_usage::GetCostAndUsage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_cost_and_usage::ser_get_cost_and_usage_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cost_and_usage::GetCostAndUsage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCostAndUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cost_and_usage::de_get_cost_and_usage_http_response_with_props(status, headers, body)
        }
    }
}
