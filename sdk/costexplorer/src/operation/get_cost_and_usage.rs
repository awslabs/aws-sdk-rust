...
impl GetCostAndUsageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_cost_and_usage::GetCostAndUsage,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cost_and_usage::GetCostAndUsage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCostAndUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_cost_and_usage::de_get_cost_and_usage_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_cost_and_usage::GetCostAndUsageError
{
