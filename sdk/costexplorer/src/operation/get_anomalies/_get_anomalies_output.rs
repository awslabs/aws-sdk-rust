...
impl GetAnomaliesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_anomalies::GetAnomaliesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_anomalies::GetAnomaliesOutput {
                anomalies: self.anomalies
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("anomalies", "anomalies was not specified but it is required when building GetAnomaliesOutput")
                    )?
                ,
