...
/// Paginator for [`GetAnomalies`](crate::operation::get_anomalies::GetAnomalies)
pub struct GetAnomaliesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::get_anomalies::builders::GetAnomaliesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl GetAnomaliesPaginator {
    ...
    pub fn items(self) -> crate::operation::get_anomalies::paginator::GetAnomaliesPaginatorItems {
        crate::operation::get_anomalies::paginator::GetAnomaliesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_anomalies::GetAnomalies::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_get_anomalies_output_output_next_page_token(resp);
...
/// Flattened paginator for `GetAnomaliesPaginator`
///
/// This is created with [`.items()`](GetAnomaliesPaginator::items)
pub struct GetAnomaliesPaginatorItems(GetAnomaliesPaginator);

impl GetAnomaliesPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_anomalies_output_output_anomalies(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
