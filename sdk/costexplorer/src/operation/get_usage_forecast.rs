...
impl GetUsageForecastInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_usage_forecast::ser_get_usage_forecast_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUsageForecast {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_usage_forecast::de_get_usage_forecast_http_response_with_props(status, headers, body)
        }
    }
}
