...
impl crate::operation::get_reservation_purchase_recommendation::builders::GetReservationPurchaseRecommendationInputBuilder {
...
impl GetReservationPurchaseRecommendationFluentBuilder {
    /// Creates a new `GetReservationPurchaseRecommendationFluentBuilder`.
