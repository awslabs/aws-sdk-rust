...
impl GetReservationUtilizationInput {
    /// Consumes the builder and constructs an Operation<[`GetReservationUtilization`](crate::operation::get_reservation_utilization::GetReservationUtilization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_reservation_utilization::GetReservationUtilization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_reservation_utilization::GetReservationUtilization::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetReservationUtilization {
                type Output = std::result::Result<crate::operation::get_reservation_utilization::GetReservationUtilizationOutput, crate::operation::get_reservation_utilization::GetReservationUtilizationError>;
