...
impl GetReservationUtilizationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_reservation_utilization::GetReservationUtilization::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReservationUtilization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_reservation_utilization::de_get_reservation_utilization_http_response_with_props(status, headers, body)
        }
    }
}
