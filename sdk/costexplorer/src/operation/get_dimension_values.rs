...
impl GetDimensionValuesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_dimension_values::GetDimensionValues::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDimensionValues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_dimension_values::de_get_dimension_values_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_dimension_values::GetDimensionValuesError
{
