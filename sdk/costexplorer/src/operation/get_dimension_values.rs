...
impl GetDimensionValuesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_dimension_values::ser_get_dimension_values_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDimensionValues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_dimension_values::de_get_dimension_values_http_response_with_props(status, headers, body)
        }
    }
}
