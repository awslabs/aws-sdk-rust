...
impl GetCostAndUsageWithResourcesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cost_and_usage_with_resources::GetCostAndUsageWithResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCostAndUsageWithResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cost_and_usage_with_resources::de_get_cost_and_usage_with_resources_http_response_with_props(
                status, headers, body,
            )
        }
    }
