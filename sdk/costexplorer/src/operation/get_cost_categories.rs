...
impl GetCostCategoriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_cost_categories::ser_get_cost_categories_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCostCategories {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cost_categories::de_get_cost_categories_http_response_with_props(status, headers, body)
        }
    }
}
