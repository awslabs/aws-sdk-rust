...
impl DeleteCostCategoryDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_cost_category_definition::DeleteCostCategoryDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cost_category_definition::DeleteCostCategoryDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_cost_category_definition::DeleteCostCategoryDefinitionOutput, crate::operation::delete_cost_category_definition::DeleteCostCategoryDefinitionError, Self> {
