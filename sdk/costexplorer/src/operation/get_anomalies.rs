...
impl GetAnomaliesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_anomalies::GetAnomalies, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_anomalies::ser_get_anomalies_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAnomalies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_anomalies::de_get_anomalies_http_response_with_props(status, headers, body)
        }
    }
}
