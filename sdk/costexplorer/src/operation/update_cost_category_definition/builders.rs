...
impl UpdateCostCategoryDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_cost_category_definition::UpdateCostCategoryDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_cost_category_definition::UpdateCostCategoryDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_cost_category_definition::UpdateCostCategoryDefinitionOutput, crate::operation::update_cost_category_definition::UpdateCostCategoryDefinitionError, Self> {
