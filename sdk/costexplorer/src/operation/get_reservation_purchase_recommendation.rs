...
impl GetReservationPurchaseRecommendationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_reservation_purchase_recommendation::GetReservationPurchaseRecommendation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReservationPurchaseRecommendation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_reservation_purchase_recommendation::de_get_reservation_purchase_recommendation_http_response_with_props(
                status, headers, body,
            )
        }
    }
