...
impl  GetReservationCoverageOutput  {
    ...
    pub fn coverages_by_time(&self) -> & [crate::types::CoverageByTime] {
        use std::ops::Deref; self.coverages_by_time.deref()
    }
    /// <p>The total amount of instance usage that a reservation covered.</p>
...
impl GetReservationCoverageOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_reservation_coverage::GetReservationCoverageOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_reservation_coverage::GetReservationCoverageOutput {
                coverages_by_time: self.coverages_by_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("coverages_by_time", "coverages_by_time was not specified but it is required when building GetReservationCoverageOutput")
                    )?
                ,
                total: self.total
                ,
