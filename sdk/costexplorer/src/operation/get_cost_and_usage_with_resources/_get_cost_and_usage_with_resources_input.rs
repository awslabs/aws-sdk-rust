...
impl GetCostAndUsageWithResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_cost_and_usage_with_resources::GetCostAndUsageWithResourcesInput, ::aws_smithy_types::error::operation::BuildError> {
