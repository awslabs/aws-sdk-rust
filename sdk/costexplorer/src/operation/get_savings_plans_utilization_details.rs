...
impl GetSavingsPlansUtilizationDetailsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_savings_plans_utilization_details::GetSavingsPlansUtilizationDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSavingsPlansUtilizationDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_savings_plans_utilization_details::de_get_savings_plans_utilization_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
