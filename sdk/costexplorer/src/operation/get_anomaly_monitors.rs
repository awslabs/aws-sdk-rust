...
impl GetAnomalyMonitorsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_anomaly_monitors::ser_get_anomaly_monitors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAnomalyMonitors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_anomaly_monitors::de_get_anomaly_monitors_http_response_with_props(status, headers, body)
        }
    }
}
