...
impl CreateAnomalySubscriptionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_anomaly_subscription::CreateAnomalySubscription::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAnomalySubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_anomaly_subscription::de_create_anomaly_subscription_http_response_with_props(status, headers, body)
        }
    }
}
