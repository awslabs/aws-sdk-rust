...
impl DescribeCostCategoryDefinitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cost_category_definition::DescribeCostCategoryDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCostCategoryDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cost_category_definition::de_describe_cost_category_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
