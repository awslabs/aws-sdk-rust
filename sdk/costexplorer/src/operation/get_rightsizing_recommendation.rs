...
impl GetRightsizingRecommendationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_rightsizing_recommendation::GetRightsizingRecommendation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRightsizingRecommendation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_rightsizing_recommendation::de_get_rightsizing_recommendation_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetRightsizingRecommendationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_rightsizing_recommendation::GetRightsizingRecommendationError
{
