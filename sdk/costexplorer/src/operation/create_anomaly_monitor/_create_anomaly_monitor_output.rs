...
impl CreateAnomalyMonitorOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_anomaly_monitor::CreateAnomalyMonitorOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_anomaly_monitor::CreateAnomalyMonitorOutput {
                monitor_arn: self.monitor_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("monitor_arn", "monitor_arn was not specified but it is required when building CreateAnomalyMonitorOutput")
                    )?
                ,
