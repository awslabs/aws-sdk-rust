...
impl GetSavingsPlansCoverageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_savings_plans_coverage::GetSavingsPlansCoverageInput, ::aws_smithy_types::error::operation::BuildError> {
