...
impl UpdateCostCategoryDefinitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_cost_category_definition::UpdateCostCategoryDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCostCategoryDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_cost_category_definition::de_update_cost_category_definition_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateCostCategoryDefinitionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_cost_category_definition::UpdateCostCategoryDefinitionError
{
