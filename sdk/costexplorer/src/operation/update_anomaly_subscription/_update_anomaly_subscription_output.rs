...
impl UpdateAnomalySubscriptionOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_anomaly_subscription::UpdateAnomalySubscriptionOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_anomaly_subscription::UpdateAnomalySubscriptionOutput {
                subscription_arn: self.subscription_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("subscription_arn", "subscription_arn was not specified but it is required when building UpdateAnomalySubscriptionOutput")
                    )?
                ,
