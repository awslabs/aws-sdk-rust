...
impl UpdateCostAllocationTagsStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_cost_allocation_tags_status::UpdateCostAllocationTagsStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCostAllocationTagsStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_cost_allocation_tags_status::de_update_cost_allocation_tags_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
