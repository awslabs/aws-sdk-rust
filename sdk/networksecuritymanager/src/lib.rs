...
//! offered by AWS Network Security Manager Customer API. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Network Security Manager Customer API.
...
/// let config = aws_sdk_networksecuritymanager::config::Builder::from(&sdk_config)
/// # /*
...
/// Configuration for AWS Network Security Manager Customer API.
pub mod config;
