...
///     ValidationExceptionReason::AccountNotOnboarded => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "ACCOUNT_NOT_ONBOARDED" => ValidationExceptionReason::AccountNotOnboarded,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ValidationExceptionReason::AccountNotOnboarded => "ACCOUNT_NOT_ONBOARDED",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["ACCOUNT_NOT_ONBOARDED", "FIELD_VALIDATION_FAILED", "OTHER"]
    }
}
...
impl ::std::fmt::Display for ValidationExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ValidationExceptionReason::AccountNotOnboarded => write!(f, "ACCOUNT_NOT_ONBOARDED"),
