...
impl ::std::convert::From<&str> for RuleType {
    fn from(s: &str) -> Self {
        match s {
            "CONFIGURATION" => RuleType::Configuration,
            "INSPECTION" => RuleType::Inspection,
...
impl RuleType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RuleType::Configuration => "CONFIGURATION",
            RuleType::Inspection => "INSPECTION",
...
impl ::std::fmt::Display for RuleType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RuleType::Configuration => write!(f, "CONFIGURATION"),
            RuleType::Inspection => write!(f, "INSPECTION"),
