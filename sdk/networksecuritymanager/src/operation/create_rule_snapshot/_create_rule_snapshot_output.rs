...
pub struct CreateRuleSnapshotOutput {
...
impl ::aws_types::request_id::RequestId for CreateRuleSnapshotOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateRuleSnapshotOutput {
    /// Creates a new builder-style object to manufacture [`CreateRuleSnapshotOutput`](crate::operation::create_rule_snapshot::CreateRuleSnapshotOutput).
    pub fn builder() -> crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder {
        crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::default()
    }
}

/// A builder for [`CreateRuleSnapshotOutput`](crate::operation::create_rule_snapshot::CreateRuleSnapshotOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateRuleSnapshotOutputBuilder {
...
impl CreateRuleSnapshotOutputBuilder {
    /// <p>The service-generated id of the rule.</p>
    ...
    /// Consumes the builder and constructs a [`CreateRuleSnapshotOutput`](crate::operation::create_rule_snapshot::CreateRuleSnapshotOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`rule_id`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::rule_id)
    /// - [`rule_arn`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::rule_arn)
    /// - [`rule_name`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::rule_name)
    /// - [`firewall_type`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::firewall_type)
    /// - [`configuration`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::configuration)
    /// - [`status`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::status)
    /// - [`version`](crate::operation::create_rule_snapshot::builders::CreateRuleSnapshotOutputBuilder::version)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_rule_snapshot::CreateRuleSnapshotOutput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::create_rule_snapshot::CreateRuleSnapshotOutput {
            rule_id: self.rule_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "rule_id",
                    "rule_id was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
            rule_arn: self.rule_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "rule_arn",
                    "rule_arn was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
            rule_name: self.rule_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "rule_name",
                    "rule_name was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
            firewall_type: self.firewall_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "firewall_type",
                    "firewall_type was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
            ...
            configuration: self.configuration.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "configuration",
                    "configuration was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
            version: self.version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version",
                    "version was not specified but it is required when building CreateRuleSnapshotOutput",
                )
            })?,
