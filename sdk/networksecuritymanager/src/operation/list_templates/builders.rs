...
impl crate::operation::list_templates::builders::ListTemplatesInputBuilder {
...
impl ListTemplatesFluentBuilder {
    /// Creates a new `ListTemplatesFluentBuilder`.
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_templates::paginator::ListTemplatesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
