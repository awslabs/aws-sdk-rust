...
impl UpdateScopeOutputBuilder {
    ...
    /// - [`scope_name`](crate::operation::update_scope::builders::UpdateScopeOutputBuilder::scope_name)
    /// - [`status`](crate::operation::update_scope::builders::UpdateScopeOutputBuilder::status)
    /// - [`version`](crate::operation::update_scope::builders::UpdateScopeOutputBuilder::version)
    pub fn build(self) -> ::std::result::Result<crate::operation::update_scope::UpdateScopeOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_scope::UpdateScopeOutput {
            ...
            scope_name: self.scope_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "scope_name",
                    "scope_name was not specified but it is required when building UpdateScopeOutput",
                )
            })?,
            ...
            version: self.version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version",
                    "version was not specified but it is required when building UpdateScopeOutput",
                )
            })?,
