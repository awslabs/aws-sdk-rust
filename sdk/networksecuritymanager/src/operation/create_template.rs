...
impl CreateTemplateError {
    ...
    /// Returns `true` if the error kind is `CreateTemplateError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `CreateTemplateError::TagPolicyViolationException`.
