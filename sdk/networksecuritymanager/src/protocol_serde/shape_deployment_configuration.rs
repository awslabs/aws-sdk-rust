    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "enableCrossAccountVisibility" => {
                            builder = builder
                                .set_enable_cross_account_visibility(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
            ...
            Ok(Some(crate::serde_util::deployment_configuration_correct_errors(builder).build()))
        }
...
pub fn ser_deployment_configuration(
    ...
    {
        object.key("enableCrossAccountVisibility").boolean(input.enable_cross_account_visibility);
    }
    Ok(())
}
