...
pub struct UpdateSubnetGroupOutput  {
    ...
    #[doc(hidden)]pub subnet_group: std::option::Option<crate::model::SubnetGroup>,
}
...
pub struct UpdateParameterGroupOutput  {
    ...
    #[doc(hidden)]pub parameter_group: std::option::Option<crate::model::ParameterGroup>,
}
...
pub struct DescribeSubnetGroupsOutput  {
    ...
    #[doc(hidden)]pub subnet_groups: std::option::Option<std::vec::Vec<crate::model::SubnetGroup>>,
}
...
pub struct DescribeParameterGroupsOutput  {
    ...
    #[doc(hidden)]pub parameter_groups: std::option::Option<std::vec::Vec<crate::model::ParameterGroup>>,
}
...
pub struct DescribeClustersOutput  {
    ...
    #[doc(hidden)]pub clusters: std::option::Option<std::vec::Vec<crate::model::Cluster>>,
}
...
pub struct DeleteSubnetGroupOutput  {
    ...
    #[doc(hidden)]pub deletion_message: std::option::Option<std::string::String>,
}
