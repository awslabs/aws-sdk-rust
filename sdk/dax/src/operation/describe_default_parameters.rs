...
impl DescribeDefaultParametersInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_default_parameters::DescribeDefaultParameters::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDefaultParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_default_parameters::de_describe_default_parameters_http_response_with_props(status, headers, body)
        }
    }
}
