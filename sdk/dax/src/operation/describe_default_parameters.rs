...
/// Orchestration and serialization glue logic for `DescribeDefaultParameters`.
...
impl DescribeDefaultParameters {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_default_parameters::DescribeDefaultParametersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_default_parameters::DescribeDefaultParametersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_default_parameters::DescribeDefaultParametersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_default_parameters::DescribeDefaultParametersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDefaultParameters {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDefaultParameters");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDefaultParametersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDefaultParametersResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDefaultParameters")
...
.with_interceptor(DescribeDefaultParametersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_default_parameters::DescribeDefaultParametersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_default_parameters::DescribeDefaultParametersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_default_parameters::DescribeDefaultParametersError>::new());
...
#[derive(Debug)]
            struct DescribeDefaultParametersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDefaultParametersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_default_parameters::de_describe_default_parameters_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeDefaultParametersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDefaultParametersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_default_parameters::DescribeDefaultParametersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_default_parameters::DescribeDefaultParametersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_default_parameters::ser_describe_default_parameters_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDefaultParametersEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDefaultParametersEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDefaultParametersEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDefaultParametersInput>()
                        .ok_or("failed to downcast to DescribeDefaultParametersInput")?;
...
pub enum DescribeDefaultParametersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDefaultParametersError) for what information is available for the error.")]
...
impl DescribeDefaultParametersError {
    /// Creates the `DescribeDefaultParametersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDefaultParametersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDefaultParametersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_default_parameters::DescribeDefaultParametersError {
...
mod _describe_default_parameters_output;
