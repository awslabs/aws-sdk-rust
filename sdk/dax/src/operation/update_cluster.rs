...
impl UpdateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DAX", "UpdateCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateCluster", "DAX"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("NotificationTopicArn") {
            if let ::std::option::Option::Some(value) = input.notification_topic_arn.as_deref() {
                captured.insert("NotificationTopicArn", value);
            }
        }
        if requested.should_capture("NotificationTopicStatus") {
            if let ::std::option::Option::Some(value) = input.notification_topic_status.as_deref() {
                captured.insert("NotificationTopicStatus", value);
            }
        }
