...
impl RebootNodeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reboot_node::RebootNode,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reboot_node::RebootNode::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reboot_node::de_reboot_node_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_reboot_node::de_reboot_node_http_response_with_props(
                status, headers, body,
            )
        }
    }
