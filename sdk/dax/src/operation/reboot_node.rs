...
impl RebootNodeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reboot_node::RebootNode, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reboot_node::ser_reboot_node_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reboot_node::de_reboot_node_http_response_with_props(status, headers, body)
        }
    }
}
