...
impl DecreaseReplicationFactor {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DAX", "DecreaseReplicationFactor", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "DAX.DecreaseReplicationFactor",
                "rpc.service" = "DAX",
                "rpc.method" = "DecreaseReplicationFactor",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DecreaseReplicationFactor {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DecreaseReplicationFactorRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DecreaseReplicationFactorResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DecreaseReplicationFactor")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DecreaseReplicationFactor")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DecreaseReplicationFactorTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DecreaseReplicationFactorTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DecreaseReplicationFactorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DecreaseReplicationFactorInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DecreaseReplicationFactorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_decrease_replication_factor::de_decrease_replication_factor_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_decrease_replication_factor::de_decrease_replication_factor_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DecreaseReplicationFactorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_decrease_replication_factor::ser_decrease_replication_factor_input(&input)?,
        );
