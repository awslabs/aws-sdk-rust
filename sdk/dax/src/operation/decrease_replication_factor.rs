...
impl DecreaseReplicationFactorInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::decrease_replication_factor::DecreaseReplicationFactor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::decrease_replication_factor::DecreaseReplicationFactorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::decrease_replication_factor::DecreaseReplicationFactor::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DecreaseReplicationFactor {
                type Output = std::result::Result<crate::operation::decrease_replication_factor::DecreaseReplicationFactorOutput, crate::operation::decrease_replication_factor::DecreaseReplicationFactorError>;
