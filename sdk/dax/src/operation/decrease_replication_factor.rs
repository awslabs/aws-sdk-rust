...
impl DecreaseReplicationFactor {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::decrease_replication_factor::DecreaseReplicationFactorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::decrease_replication_factor::DecreaseReplicationFactorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DecreaseReplicationFactor {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DecreaseReplicationFactor");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DecreaseReplicationFactorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DecreaseReplicationFactorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DecreaseReplicationFactor")
...
.with_interceptor(DecreaseReplicationFactorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorError>::new());
...
#[derive(Debug)]
            struct DecreaseReplicationFactorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DecreaseReplicationFactorResponseDeserializer {
...
#[derive(Debug)]
            struct DecreaseReplicationFactorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DecreaseReplicationFactorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::decrease_replication_factor::DecreaseReplicationFactorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::decrease_replication_factor::DecreaseReplicationFactorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_decrease_replication_factor::ser_decrease_replication_factor_input(&input)?);
...
#[derive(Debug)]
            struct DecreaseReplicationFactorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DecreaseReplicationFactorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DecreaseReplicationFactorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DecreaseReplicationFactorInput>()
                        .ok_or("failed to downcast to DecreaseReplicationFactorInput")?;
...
pub enum DecreaseReplicationFactorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DecreaseReplicationFactorError) for what information is available for the error.")]
...
impl DecreaseReplicationFactorError {
    /// Creates the `DecreaseReplicationFactorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DecreaseReplicationFactorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DecreaseReplicationFactorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::decrease_replication_factor::DecreaseReplicationFactorError {
