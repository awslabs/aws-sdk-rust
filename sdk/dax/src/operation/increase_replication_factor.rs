...
impl IncreaseReplicationFactor {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::increase_replication_factor::IncreaseReplicationFactorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::increase_replication_factor::IncreaseReplicationFactorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IncreaseReplicationFactor {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("IncreaseReplicationFactor");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(IncreaseReplicationFactorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(IncreaseReplicationFactorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("IncreaseReplicationFactor")
...
.with_interceptor(IncreaseReplicationFactorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::increase_replication_factor::IncreaseReplicationFactorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::increase_replication_factor::IncreaseReplicationFactorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::increase_replication_factor::IncreaseReplicationFactorError>::new());
...
#[derive(Debug)]
            struct IncreaseReplicationFactorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for IncreaseReplicationFactorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_increase_replication_factor::de_increase_replication_factor_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct IncreaseReplicationFactorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IncreaseReplicationFactorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::increase_replication_factor::IncreaseReplicationFactorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::increase_replication_factor::IncreaseReplicationFactorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_increase_replication_factor::ser_increase_replication_factor_input(&input)?);
...
#[derive(Debug)]
            struct IncreaseReplicationFactorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for IncreaseReplicationFactorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "IncreaseReplicationFactorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<IncreaseReplicationFactorInput>()
                        .ok_or("failed to downcast to IncreaseReplicationFactorInput")?;
...
pub enum IncreaseReplicationFactorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-IncreaseReplicationFactorError) for what information is available for the error.")]
...
impl IncreaseReplicationFactorError {
    /// Creates the `IncreaseReplicationFactorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `IncreaseReplicationFactorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for IncreaseReplicationFactorError {
...
mod _increase_replication_factor_output;
