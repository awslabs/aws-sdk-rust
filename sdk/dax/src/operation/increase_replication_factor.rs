...
impl IncreaseReplicationFactorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::increase_replication_factor::IncreaseReplicationFactor::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for IncreaseReplicationFactor {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_increase_replication_factor::de_increase_replication_factor_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::increase_replication_factor::IncreaseReplicationFactorError
{
