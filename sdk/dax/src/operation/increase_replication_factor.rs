...
impl IncreaseReplicationFactorInput {
    /// Consumes the builder and constructs an Operation<[`IncreaseReplicationFactor`](crate::operation::increase_replication_factor::IncreaseReplicationFactor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::increase_replication_factor::IncreaseReplicationFactor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::increase_replication_factor::IncreaseReplicationFactorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::increase_replication_factor::IncreaseReplicationFactor::new())
...
impl aws_smithy_http::response::ParseStrictResponse for IncreaseReplicationFactor {
                type Output = std::result::Result<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput, crate::operation::increase_replication_factor::IncreaseReplicationFactorError>;
