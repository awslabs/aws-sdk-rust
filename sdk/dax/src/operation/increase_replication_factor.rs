...
impl IncreaseReplicationFactor {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::increase_replication_factor::IncreaseReplicationFactorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DAX", "IncreaseReplicationFactor", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "DAX.IncreaseReplicationFactor",
                "rpc.service" = "DAX",
                "rpc.method" = "IncreaseReplicationFactor",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IncreaseReplicationFactor {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            IncreaseReplicationFactorRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            IncreaseReplicationFactorResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("IncreaseReplicationFactor")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("IncreaseReplicationFactor")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                IncreaseReplicationFactorTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct IncreaseReplicationFactorTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for IncreaseReplicationFactorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<IncreaseReplicationFactorInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for IncreaseReplicationFactorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_increase_replication_factor::de_increase_replication_factor_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_increase_replication_factor::de_increase_replication_factor_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IncreaseReplicationFactorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::increase_replication_factor::IncreaseReplicationFactorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::increase_replication_factor::IncreaseReplicationFactorInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_increase_replication_factor::ser_increase_replication_factor_input(&input)?,
        );
