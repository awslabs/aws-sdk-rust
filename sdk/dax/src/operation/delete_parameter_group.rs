...
impl DeleteParameterGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_parameter_group::DeleteParameterGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_parameter_group::de_delete_parameter_group_http_response_with_props(status, headers, body)
        }
    }
}
