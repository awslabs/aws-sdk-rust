...
pub fn serialize_structure_create_cluster_input(
    ...
    }
    {
        object.key("ReplicationFactor").number(
            ...
            smithy_types::Number::NegInt((input.replication_factor).into()),
        );
    }
    ...
    if let Some(var_19) = &input.sse_specification {
        ...
        crate::json_ser::serialize_structure_sse_specification(&mut object_20, var_19);
        object_20.finish();
    }
...
pub fn serialize_structure_decrease_replication_factor_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    }
    {
        object.key("NewReplicationFactor").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.new_replication_factor).into()),
        );
    }
...
pub fn serialize_structure_describe_default_parameters_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_increase_replication_factor_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_reboot_node_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_78 in var_76 {
            {
                ...
                crate::json_ser::serialize_structure_tag(&mut object_79, item_78);
                object_79.finish();
            }
        }
        array_77.finish();
        ...
        for item_96 in var_94 {
            {
                ...
                crate::json_ser::serialize_structure_parameter_name_value(&mut object_97, item_96);
                object_97.finish();
            }
        }
        array_95.finish();
