...
impl super::Client {
    ...
    ///   - [`cluster_name(impl Into<String>)`](crate::operation::update_cluster::builders::UpdateClusterFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::update_cluster::builders::UpdateClusterFluentBuilder::set_cluster_name): <p>The name of the DAX cluster to be modified.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_cluster::builders::UpdateClusterFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_cluster::builders::UpdateClusterFluentBuilder::set_description): <p>A description of the changes being made to the cluster.</p>
    ...
    ///   - [`notification_topic_status(impl Into<String>)`](crate::operation::update_cluster::builders::UpdateClusterFluentBuilder::notification_topic_status) / [`set_notification_topic_status(Option<String>)`](crate::operation::update_cluster::builders::UpdateClusterFluentBuilder::set_notification_topic_status): <p>The current state of the topic. A value of “active” means that notifications will be sent to the topic. A value of “inactive” means that notifications will not be sent to the topic.</p>
