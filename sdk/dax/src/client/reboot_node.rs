...
impl super::Client {
    ...
    ///   - [`cluster_name(impl ::std::convert::Into<String>)`](crate::operation::reboot_node::builders::RebootNodeFluentBuilder::cluster_name) / [`set_cluster_name(Option<String>)`](crate::operation::reboot_node::builders::RebootNodeFluentBuilder::set_cluster_name): <p>The name of the DAX cluster containing the node to be rebooted.</p>
    ///   - [`node_id(impl ::std::convert::Into<String>)`](crate::operation::reboot_node::builders::RebootNodeFluentBuilder::node_id) / [`set_node_id(Option<String>)`](crate::operation::reboot_node::builders::RebootNodeFluentBuilder::set_node_id): <p>The system-assigned ID of the node to be rebooted.</p>
