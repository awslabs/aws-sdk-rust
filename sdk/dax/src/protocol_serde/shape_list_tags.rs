...
pub fn de_list_tags_http_error(
    ...
    Err(match error_code {
        ...
        "InvalidARNFault" => {
            crate::error::ListTagsError::InvalidArnFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterCombinationException" => {
            crate::error::ListTagsError::InvalidParameterCombinationException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_parameter_combination_exception::de_invalid_parameter_combination_exception_json_err(response.body().as_ref(), output).map_err(crate::error::ListTagsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
