    ...
    Err(match error_code {
        "ClusterNotFoundFault" => crate::operation::list_tags::ListTagsError::ClusterNotFoundFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_cluster_not_found_fault::de_cluster_not_found_fault_json_err(_response_body, output)
                    .map_err(crate::operation::list_tags::ListTagsError::unhandled)?;
        ...
        "InvalidARNFault" => crate::operation::list_tags::ListTagsError::InvalidArnFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_arn_fault::de_invalid_arn_fault_json_err(_response_body, output)
                    .map_err(crate::operation::list_tags::ListTagsError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidClusterStateFault" => crate::operation::list_tags::ListTagsError::InvalidClusterStateFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_cluster_state_fault::de_invalid_cluster_state_fault_json_err(_response_body, output)
                    .map_err(crate::operation::list_tags::ListTagsError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
