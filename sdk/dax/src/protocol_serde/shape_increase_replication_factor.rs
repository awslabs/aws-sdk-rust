...
pub fn de_increase_replication_factor_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput, crate::operation::increase_replication_factor::IncreaseReplicationFactorError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_increase_replication_factor_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput, crate::operation::increase_replication_factor::IncreaseReplicationFactorError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_increase_replication_factor_input(input: &crate::operation::increase_replication_factor::IncreaseReplicationFactorInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
