    ...
    Err(match error_code {
        "ClusterAlreadyExistsFault" => crate::operation::create_cluster::CreateClusterError::ClusterAlreadyExistsFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_cluster_already_exists_fault::de_cluster_already_exists_fault_json_err(_response_body, output)
                    .map_err(crate::operation::create_cluster::CreateClusterError::unhandled)?;
        ...
        "ClusterQuotaForCustomerExceededFault" => {
            crate::operation::create_cluster::CreateClusterError::ClusterQuotaForCustomerExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InsufficientClusterCapacityFault" => crate::operation::create_cluster::CreateClusterError::InsufficientClusterCapacityFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_insufficient_cluster_capacity_fault::de_insufficient_cluster_capacity_fault_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_cluster::CreateClusterError::unhandled)?;
