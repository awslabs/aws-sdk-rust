...
pub fn parse_disable_control_error(
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::error::DisableControlError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::error::DisableControlError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn parse_enable_control_error(
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::error::EnableControlError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::EnableControlError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
> {
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::error::GetControlOperationError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::GetControlOperationError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
> {
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::error::ListEnabledControlsError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::ListEnabledControlsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
