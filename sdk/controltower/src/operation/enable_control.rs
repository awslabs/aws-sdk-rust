...
impl EnableControlInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_control::EnableControl::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableControl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_control::de_enable_control_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enable_control::de_enable_control_http_response_with_props(
                status, headers, body,
            )
        }
    }
