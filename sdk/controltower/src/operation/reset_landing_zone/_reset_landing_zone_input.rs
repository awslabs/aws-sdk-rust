...
impl ResetLandingZoneInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reset_landing_zone::ResetLandingZoneInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::reset_landing_zone::ResetLandingZoneInput {
