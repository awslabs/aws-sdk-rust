...
impl CreateLandingZoneInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_landing_zone::CreateLandingZoneInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_landing_zone::CreateLandingZoneInput {
