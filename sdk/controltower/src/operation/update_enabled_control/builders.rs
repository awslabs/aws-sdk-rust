...
impl UpdateEnabledControlFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_enabled_control::UpdateEnabledControlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_enabled_control::UpdateEnabledControlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_enabled_control::UpdateEnabledControlOutput, crate::operation::update_enabled_control::UpdateEnabledControlError, Self> {
