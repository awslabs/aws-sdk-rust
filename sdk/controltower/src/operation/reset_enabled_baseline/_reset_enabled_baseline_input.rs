...
impl ResetEnabledBaselineInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reset_enabled_baseline::ResetEnabledBaselineInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::reset_enabled_baseline::ResetEnabledBaselineInput {
