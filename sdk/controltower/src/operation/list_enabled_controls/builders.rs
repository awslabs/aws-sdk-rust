...
impl ListEnabledControlsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_enabled_controls::ListEnabledControlsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_enabled_controls::ListEnabledControlsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_enabled_controls::ListEnabledControlsOutput, crate::operation::list_enabled_controls::ListEnabledControlsError, Self> {
