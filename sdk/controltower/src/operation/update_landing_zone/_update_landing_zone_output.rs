...
impl UpdateLandingZoneOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_landing_zone::UpdateLandingZoneOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_landing_zone::UpdateLandingZoneOutput {
                operation_identifier: self.operation_identifier
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("operation_identifier", "operation_identifier was not specified but it is required when building UpdateLandingZoneOutput")
                    )?
                ,
