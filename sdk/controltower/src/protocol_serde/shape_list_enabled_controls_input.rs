...
pub fn ser_list_enabled_controls_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEnabledControlsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
