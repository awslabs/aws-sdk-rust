...
pub fn ser_list_enabled_controls_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_enabled_controls::ListEnabledControlsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
