...
pub(crate) fn de_landing_zone_operation_detail<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::LandingZoneOperationDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
