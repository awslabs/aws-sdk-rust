...
impl super::Client {
    ...
    ///   - [`operation_identifier(String)`](crate::operation::reset_landing_zone::ResetLandingZoneOutput::operation_identifier): <p>A unique identifier assigned to a <code>ResetLandingZone</code> operation. You can use this identifier as an input of <code>GetLandingZoneOperation</code> to check the operation's status.</p>
