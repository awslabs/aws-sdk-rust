...
impl super::Client {
    ...
    ///   - [`manifest(Document)`](crate::operation::update_landing_zone::builders::UpdateLandingZoneFluentBuilder::manifest) / [`set_manifest(Option<Document>)`](crate::operation::update_landing_zone::builders::UpdateLandingZoneFluentBuilder::set_manifest):<br>required: **true**<br><p>The <code>manifest.yaml</code> file is a text file that describes your Amazon Web Services resources. For examples, review <a href="https://docs.aws.amazon.com/controltower/latest/userguide/the-manifest-file">The manifest file</a>.</p><br>
