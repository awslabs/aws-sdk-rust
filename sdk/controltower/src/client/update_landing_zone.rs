...
impl super::Client {
    ...
    ///   - [`version(impl Into<String>)`](crate::operation::update_landing_zone::builders::UpdateLandingZoneFluentBuilder::version) / [`set_version(Option<String>)`](crate::operation::update_landing_zone::builders::UpdateLandingZoneFluentBuilder::set_version):<br>required: **true**<br><p>The landing zone version. </p><br>
    ///   - [`manifest(Document)`](crate::operation::update_landing_zone::builders::UpdateLandingZoneFluentBuilder::manifest) / [`set_manifest(Option<Document>)`](crate::operation::update_landing_zone::builders::UpdateLandingZoneFluentBuilder::set_manifest):<br>required: **true**<br><p>The manifest.yaml file is a text file that describes your Amazon Web Services resources. For examples, review <a href="https://docs.aws.amazon.com/controltower/latest/userguide/the-manifest-file">The manifest file</a> </p><br>
