...
impl super::Client {
    ...
    ///   - [`control_identifier(impl ::std::convert::Into<String>)`](crate::operation::enable_control::builders::EnableControlFluentBuilder::control_identifier) / [`set_control_identifier(Option<String>)`](crate::operation::enable_control::builders::EnableControlFluentBuilder::set_control_identifier): <p>The ARN of the control. Only <b>Strongly recommended</b> and <b>Elective</b> controls are permitted, with the exception of the <b>Region deny</b> guardrail.</p>
    ///   - [`target_identifier(impl ::std::convert::Into<String>)`](crate::operation::enable_control::builders::EnableControlFluentBuilder::target_identifier) / [`set_target_identifier(Option<String>)`](crate::operation::enable_control::builders::EnableControlFluentBuilder::set_target_identifier): <p>The ARN of the organizational unit.</p>
