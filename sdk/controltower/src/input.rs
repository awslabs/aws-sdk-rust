...
pub mod disable_control_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DisableControlInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DisableControlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DisableControl, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DisableControlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod enable_control_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::EnableControlInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl EnableControlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::EnableControl, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::EnableControlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod get_control_operation_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetControlOperationInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
pub mod list_enabled_controls_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListEnabledControlsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListEnabledControlsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListEnabledControls, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListEnabledControlsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub struct ListEnabledControlsInput  {
    /// <p>The ARN of the organizational unit.</p>
    #[doc(hidden)]pub target_identifier: std::option::Option<std::string::String>,
    /// <p>The token to continue the list from a previous API call with the same parameters.</p>
