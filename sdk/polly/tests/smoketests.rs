...
//! ```
use aws_sdk_polly::{config, Client};
/// Smoke tests for the `describe_voices` operation
#[::tokio::test]
async fn test_describe_voices_success() {
    ...
    let res = client.describe_voices().send().await;
