...
) -> Result<Option<crate::types::Voice>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AdditionalLanguageCodes" => {
                            builder = builder
                                .set_additional_language_codes(crate::protocol_serde::shape_language_code_list::de_language_code_list(tokens)?);
                        }
                        "SupportedEngines" => {
                            builder = builder.set_supported_engines(crate::protocol_serde::shape_engine_list::de_engine_list(tokens)?);
                        }
