...
pub fn de_delete_lexicon_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_lexicon::DeleteLexiconOutput, crate::operation::delete_lexicon::DeleteLexiconError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_lexicon_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_lexicon::DeleteLexiconOutput, crate::operation::delete_lexicon::DeleteLexiconError> {
    Ok({
        #[allow(unused_mut)]
