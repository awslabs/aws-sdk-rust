...
pub fn de_list_speech_synthesis_tasks_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksOutput, crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_speech_synthesis_tasks_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksOutput, crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksError> {
    Ok({
        #[allow(unused_mut)]
