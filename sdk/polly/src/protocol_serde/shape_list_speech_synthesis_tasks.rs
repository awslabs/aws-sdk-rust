...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_speech_synthesis_tasks_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "SynthesisTasks" => {
                    builder = builder.set_synthesis_tasks(crate::protocol_serde::shape_synthesis_tasks::de_synthesis_tasks(tokens)?);
                }
