...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_voices_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_voices::DescribeVoicesOutput, crate::operation::describe_voices::DescribeVoicesError> {
...
) -> Result<crate::operation::describe_voices::builders::DescribeVoicesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Voices" => {
                    builder = builder.set_voices(crate::protocol_serde::shape_voice_list::de_voice_list(tokens)?);
                }
