...
pub fn ser_synthesize_speech_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SynthesizeSpeechInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
