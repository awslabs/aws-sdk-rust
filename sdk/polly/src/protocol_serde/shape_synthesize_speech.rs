...
pub fn de_synthesize_speech_http_response(
    ...
    Ok({
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_synthesize_speech_output::de_content_type_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::synthesize_speech::SynthesizeSpeechError::unhandled(
        ...
        output = output.set_request_characters(
            match crate::protocol_serde::shape_synthesize_speech_output::de_request_characters_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("x-amzn-RequestCharacters")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
