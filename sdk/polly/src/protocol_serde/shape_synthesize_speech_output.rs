...
pub fn de_audio_stream_payload(body: &mut aws_smithy_http::body::SdkBody) -> std::result::Result<aws_smithy_http::byte_stream::ByteStream, crate::error::SynthesizeSpeechError> {
