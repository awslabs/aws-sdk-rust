...
pub fn de_audio_stream_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<::aws_smithy_types::byte_stream::ByteStream, crate::operation::synthesize_speech::SynthesizeSpeechError> {
...
pub(crate) fn de_request_characters_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<i32>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amzn-RequestCharacters");
