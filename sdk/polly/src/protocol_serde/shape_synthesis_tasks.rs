...
pub(crate) fn de_synthesis_tasks<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::SynthesisTask>>, aws_smithy_json::deserialize::error::DeserializeError>
