...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_lexicons::builders::ListLexiconsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_lexicons::builders::ListLexiconsFluentBuilder::set_next_token):<br>required: **false**<br><p>An opaque pagination token returned from previous <code>ListLexicons</code> operation. If present, indicates where to continue the list of lexicons.</p><br>
