...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_lexicon::builders::GetLexiconFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_lexicon::builders::GetLexiconFluentBuilder::set_name): <p>Name of the lexicon.</p>
