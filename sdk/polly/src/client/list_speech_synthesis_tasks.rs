...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_speech_synthesis_tasks::builders::ListSpeechSynthesisTasksFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_speech_synthesis_tasks::builders::ListSpeechSynthesisTasksFluentBuilder::set_max_results):<br>required: **false**<br><p>Maximum number of speech synthesis tasks returned in a List operation.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_speech_synthesis_tasks::builders::ListSpeechSynthesisTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_speech_synthesis_tasks::builders::ListSpeechSynthesisTasksFluentBuilder::set_next_token):<br>required: **false**<br><p>The pagination token to use in the next request to continue the listing of speech synthesis tasks.</p><br>
    ///   - [`status(TaskStatus)`](crate::operation::list_speech_synthesis_tasks::builders::ListSpeechSynthesisTasksFluentBuilder::status) / [`set_status(Option<TaskStatus>)`](crate::operation::list_speech_synthesis_tasks::builders::ListSpeechSynthesisTasksFluentBuilder::set_status):<br>required: **false**<br><p>Status of the speech synthesis tasks returned in a List operation</p><br>
