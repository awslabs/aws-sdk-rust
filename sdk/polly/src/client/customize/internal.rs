...
pub trait CustomizablePresigned<E>: ::std::marker::Send + ::std::marker::Sync {
                    fn presign(self, config_override: crate::config::Builder, presigning_config: crate::presigning::PresigningConfig) -> BoxFuture<SendResult<crate::presigning::PresignedRequest, E>>;
                }
