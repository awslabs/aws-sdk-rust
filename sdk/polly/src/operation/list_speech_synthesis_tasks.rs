...
impl ListSpeechSynthesisTasks {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Polly", "ListSpeechSynthesisTasks", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Polly.ListSpeechSynthesisTasks",
                "rpc.service" = "Polly",
                "rpc.method" = "ListSpeechSynthesisTasks",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSpeechSynthesisTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListSpeechSynthesisTasksRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListSpeechSynthesisTasksResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListSpeechSynthesisTasks")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSpeechSynthesisTasks")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListSpeechSynthesisTasksTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListSpeechSynthesisTasksTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSpeechSynthesisTasksTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListSpeechSynthesisTasksInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSpeechSynthesisTasksResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_speech_synthesis_tasks::de_list_speech_synthesis_tasks_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_speech_synthesis_tasks::de_list_speech_synthesis_tasks_http_response(status, headers, body, _cfg)
        };
