...
impl StartSpeechSynthesisTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_speech_synthesis_task::StartSpeechSynthesisTaskInput, ::aws_smithy_types::error::operation::BuildError> {
