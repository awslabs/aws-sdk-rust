...
impl DeleteLexiconInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_lexicon();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_lexicon::DeleteLexiconOutput,
                    crate::operation::delete_lexicon::DeleteLexiconError,
                > for DeleteLexiconFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteLexiconFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_lexicon::builders::DeleteLexiconInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_lexicon::DeleteLexiconOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_lexicon::DeleteLexiconError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_lexicon::DeleteLexicon::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_lexicon::DeleteLexicon::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_lexicon::DeleteLexiconOutput, crate::operation::delete_lexicon::DeleteLexiconError, Self> {
