...
impl ListLexiconsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_lexicons::ListLexicons::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLexicons {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_lexicons::de_list_lexicons_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_lexicons::de_list_lexicons_http_response_with_props(
                status, headers, body,
            )
        }
    }
