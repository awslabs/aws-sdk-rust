    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/synthesisTasks/{TaskId}", TaskId = task_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_speech_synthesis_task::GetSpeechSynthesisTask::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_speech_synthesis_task::GetSpeechSynthesisTaskError
{
