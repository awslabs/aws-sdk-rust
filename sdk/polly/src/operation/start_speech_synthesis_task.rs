    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Polly", "StartSpeechSynthesisTask", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.service" = "Polly",
                "rpc.method" = "StartSpeechSynthesisTask",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartSpeechSynthesisTask")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartSpeechSynthesisTask")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartSpeechSynthesisTaskTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartSpeechSynthesisTaskTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartSpeechSynthesisTaskTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartSpeechSynthesisTaskInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartSpeechSynthesisTaskResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_speech_synthesis_task::de_start_speech_synthesis_task_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_speech_synthesis_task::de_start_speech_synthesis_task_http_response(status, headers, body, _cfg)
        };
