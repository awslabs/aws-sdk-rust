...
impl PutLexiconInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_lexicon::PutLexicon, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_lexicon::ser_put_lexicon_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutLexicon {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_lexicon::de_put_lexicon_http_response_with_props(status, headers, body)
        }
    }
}
