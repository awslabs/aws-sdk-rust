...
impl GetLexiconInput {
    /// Consumes the builder and constructs an Operation<[`GetLexicon`](crate::operation::get_lexicon::GetLexicon)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_lexicon::GetLexicon, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_lexicon::GetLexiconInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_lexicon::GetLexicon::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLexicon {
                type Output = std::result::Result<crate::operation::get_lexicon::GetLexiconOutput, crate::operation::get_lexicon::GetLexiconError>;
