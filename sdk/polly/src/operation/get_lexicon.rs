...
impl GetLexiconInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_lexicon::GetLexicon::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLexicon {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_lexicon::de_get_lexicon_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_lexicon::de_get_lexicon_http_response_with_props(
                status, headers, body,
            )
        }
    }
