...
impl VoiceId {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "Aditi", "Amy", "Aria", "Arlet", "Arthur", "Astrid", "Ayanda", "Bianca", "Brian", "Camila", "Carla", "Carmen", "Celine", "Chantal", "Conchita", "Cristiano", "Daniel", "Dora", "Emma", "Enrique", "Ewa", "Filiz", "Gabrielle", "Geraint", "Giorgio", "Gwyneth", "Hannah", "Hans", "Hiujin", "Ines", "Ivy", "Jacek", "Jan", "Joanna", "Joey", "Justin", "Kajal", "Karl", "Kendra", "Kevin", "Kimberly", "Lea", "Liam", "Liv", "Lotte", "Lucia", "Lupe", "Mads", "Maja", "Marlene", "Mathieu", "Matthew", "Maxim", "Mia", "Miguel", "Mizuki", "Naja", "Nicole", "Olivia", "Pedro", "Penelope", "Raveena", "Ricardo", "Ruben", "Russell", "Salli", "Seoyeon", "Takumi", "Tatyana", "Vicki", "Vitoria", "Zeina", "Zhiyu"
        ]
    }
}
...
impl LanguageCode {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "arb", "ca-ES", "cmn-CN", "cy-GB", "da-DK", "de-AT", "de-DE", "en-AU", "en-GB", "en-GB-WLS", "en-IN", "en-NZ", "en-US", "en-ZA", "es-ES", "es-MX", "es-US", "fr-CA", "fr-FR", "hi-IN", "is-IS", "it-IT", "ja-JP", "ko-KR", "nb-NO", "nl-NL", "pl-PL", "pt-BR", "pt-PT", "ro-RO", "ru-RU", "sv-SE", "tr-TR", "yue-CN"
        ]
    }
}
...
pub struct SynthesisTask  {
    ...
    #[doc(hidden)]pub task_status: std::option::Option<crate::model::TaskStatus>,
    /// <p>Reason for the current status of a specific speech synthesis task, including errors if the task has failed.</p>
    #[doc(hidden)]pub task_status_reason: std::option::Option<std::string::String>,
    /// <p>Pathway for the output speech file.</p>
    #[doc(hidden)]pub output_uri: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub request_characters: i32,
...
pub struct LexiconDescription  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<crate::model::LexiconAttributes>,
}
...
pub struct LexiconAttributes  {
    ...
    #[doc(hidden)]pub alphabet: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_modified: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Amazon Resource Name (ARN) of the lexicon.</p>
    #[doc(hidden)]pub lexicon_arn: std::option::Option<std::string::String>,
    /// <p>Number of lexemes in the lexicon.</p>
    #[doc(hidden)]pub lexemes_count: i32,
    /// <p>Total size of the lexicon, in characters.</p>
    #[doc(hidden)]pub size: i32,
}
...
pub struct Voice  {
    ...
    #[doc(hidden)]pub gender: std::option::Option<crate::model::Gender>,
    /// <p>Amazon Polly assigned voice ID. This is the ID that you specify when calling the <code>SynthesizeSpeech</code> operation.</p>
    #[doc(hidden)]pub id: std::option::Option<crate::model::VoiceId>,
    /// <p>Language code of the voice.</p>
    #[doc(hidden)]pub language_code: std::option::Option<crate::model::LanguageCode>,
    /// <p>Human readable name of the language in English.</p>
    #[doc(hidden)]pub language_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub additional_language_codes: std::option::Option<std::vec::Vec<crate::model::LanguageCode>>,
    /// <p>Specifies which engines (<code>standard</code> or <code>neural</code>) that are supported by a given voice.</p>
    #[doc(hidden)]pub supported_engines: std::option::Option<std::vec::Vec<crate::model::Engine>>,
}
impl Voice {
    /// <p>Gender of the voice.</p>
