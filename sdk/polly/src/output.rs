...
#[non_exhaustive]pub struct SynthesizeSpeechOutput  {
...
pub struct StartSpeechSynthesisTaskOutput  {
    ...
    #[doc(hidden)]pub synthesis_task: std::option::Option<crate::model::SynthesisTask>,
}
...
pub struct ListSpeechSynthesisTasksOutput  {
    ...
    #[doc(hidden)]pub synthesis_tasks: std::option::Option<std::vec::Vec<crate::model::SynthesisTask>>,
}
...
pub struct ListLexiconsOutput  {
    ...
    #[doc(hidden)]pub lexicons: std::option::Option<std::vec::Vec<crate::model::LexiconDescription>>,
...
pub mod list_lexicons_output {
    ...
    impl Builder {
        ...
        /// <p>A list of lexicon names and attributes.</p>
        pub fn set_lexicons(mut self, input: std::option::Option<std::vec::Vec<crate::model::LexiconDescription>>) -> Self {
...
pub struct GetLexiconOutput  {
    ...
    #[doc(hidden)]pub lexicon: std::option::Option<crate::model::Lexicon>,
    ...
    #[doc(hidden)]pub lexicon_attributes: std::option::Option<crate::model::LexiconAttributes>,
}
...
pub struct DescribeVoicesOutput  {
    ...
    #[doc(hidden)]pub voices: std::option::Option<std::vec::Vec<crate::model::Voice>>,
...
pub mod describe_voices_output {
    ...
    impl Builder {
        ...
        /// <p>A list of voices with their properties.</p>
        pub fn set_voices(mut self, input: std::option::Option<std::vec::Vec<crate::model::Voice>>) -> Self {
