...
pub fn ser_send_action(
    ...
    #[allow(unused)] input: &crate::types::SendAction,
...
pub(crate) fn de_send_action(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::SendAction, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        mut builder: crate::types::builders::SendActionBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<crate::types::builders::SendActionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    {
        return Ok(crate::serde_util::send_action_correct_errors(builder)
            .build()
