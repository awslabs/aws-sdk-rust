...
pub fn de_get_archive_search_http_error(
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::get_archive_search::GetArchiveSearchError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_archive_search::GetArchiveSearchError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::get_archive_search::GetArchiveSearchError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_archive_search::GetArchiveSearchError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::get_archive_search::GetArchiveSearchError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_archive_search_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_archive_search::GetArchiveSearchOutput, crate::operation::get_archive_search::GetArchiveSearchError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_archive_search::builders::GetArchiveSearchOutputBuilder::default();
        output = crate::protocol_serde::shape_get_archive_search::de_get_archive_search(_response_body, output)
            .map_err(crate::operation::get_archive_search::GetArchiveSearchError::unhandled)?;
...
) -> Result<crate::operation::get_archive_search::builders::GetArchiveSearchOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
