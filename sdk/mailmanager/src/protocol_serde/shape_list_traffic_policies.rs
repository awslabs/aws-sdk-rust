...
pub fn ser_list_traffic_policies_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_traffic_policies_input::ser_list_traffic_policies_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "TrafficPolicies" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(
                    builder.set_traffic_policies(Some(crate::protocol_serde::shape_traffic_policy_list::de_traffic_policy_list(
                        decoder,
                        depth + 1,
                    )?)),
                )
