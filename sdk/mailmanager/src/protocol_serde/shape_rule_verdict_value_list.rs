...
pub(crate) fn de_rule_verdict_value_list(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<::std::vec::Vec<crate::types::RuleVerdict>, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::RuleVerdict>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::RuleVerdict>, ::aws_smithy_cbor::decode::DeserializeError> {
