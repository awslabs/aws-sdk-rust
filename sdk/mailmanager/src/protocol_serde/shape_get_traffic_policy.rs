...
pub fn ser_get_traffic_policy_input(
    ...
    crate::protocol_serde::shape_get_traffic_policy_input::ser_get_traffic_policy_input_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::get_traffic_policy::builders::GetTrafficPolicyOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "TrafficPolicyArn" => {
                    builder = builder.set_traffic_policy_arn(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                            .transpose()?,
                    );
                ...
                "PolicyStatements" => {
                    builder = builder.set_policy_statements(crate::protocol_serde::shape_policy_statement_list::de_policy_statement_list(tokens)?);
                }
                "MaxMessageSizeBytes" => {
                    builder = builder.set_max_message_size_bytes(
