...
pub fn ser_ingress_string_expression(
    ...
    #[allow(unused)] input: &crate::types::IngressStringExpression,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    encoder.begin_map();
    if let Some(var_1) = &input.evaluate {
        encoder.str("Evaluate");
        crate::protocol_serde::shape_ingress_string_to_evaluate::ser_ingress_string_to_evaluate(encoder, var_1)?;
    }
    {
...
pub(crate) fn de_ingress_string_expression(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::IngressStringExpression, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        ...
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<crate::types::builders::IngressStringExpressionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    let mut builder = crate::types::builders::IngressStringExpressionBuilder::default();
    ...
    {
        return Ok(crate::serde_util::ingress_string_expression_correct_errors(builder)
            .build()
