...
pub fn ser_ingress_string_expression(
    ...
    if let Some(var_1) = &input.evaluate {
        ...
        crate::protocol_serde::shape_ingress_string_to_evaluate::ser_ingress_string_to_evaluate(&mut object_2, var_1)?;
        object_2.finish();
    }
    {
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Evaluate" => {
                            builder = builder.set_evaluate(crate::protocol_serde::shape_ingress_string_to_evaluate::de_ingress_string_to_evaluate(
                                tokens, _value,
                            )?);
                        }
                        "Operator" => {
                            builder = builder.set_operator(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::IngressStringOperator::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Values" => {
            ...
            Ok(Some(
                crate::serde_util::ingress_string_expression_correct_errors(builder)
                    .build()
