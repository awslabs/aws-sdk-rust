...
pub fn ser_rule_is_in_address_list(
    ...
    #[allow(unused)] input: &crate::types::RuleIsInAddressList,
...
pub(crate) fn de_rule_is_in_address_list(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::RuleIsInAddressList, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    {
        return Ok(crate::serde_util::rule_is_in_address_list_correct_errors(builder)
            .build()
