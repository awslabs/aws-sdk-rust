...
> {
    ...
    Err(match error_code {
        "ConflictException" => crate::operation::delete_traffic_policy::DeleteTrafficPolicyError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::delete_traffic_policy::DeleteTrafficPolicyError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::delete_traffic_policy::DeleteTrafficPolicyError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_delete_traffic_policy_input(
    input: &crate::operation::delete_traffic_policy::DeleteTrafficPolicyInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_delete_traffic_policy_input::ser_delete_traffic_policy_input_input(&mut object, input)?;
    object.finish();
