...
pub fn ser_ingress_ipv6_expression(
    ...
    input: &crate::types::IngressIpv6Expression,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.evaluate {
        #[allow(unused_mut)]
        let mut object_2 = object.key("Evaluate").start_object();
        crate::protocol_serde::shape_ingress_ipv6_to_evaluate::ser_ingress_ipv6_to_evaluate(&mut object_2, var_1)?;
        object_2.finish();
    }
    {
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(crate::serde_util::ingress_ipv6_expression_correct_errors(builder).build().map_err(
