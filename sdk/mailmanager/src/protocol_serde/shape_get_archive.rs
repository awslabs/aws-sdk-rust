...
pub fn ser_get_archive_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_get_archive_input::ser_get_archive_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::get_archive::builders::GetArchiveOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
