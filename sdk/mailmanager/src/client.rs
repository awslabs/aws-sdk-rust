...
/// For example, the [`CreateAddonInstance`](crate::operation::create_addon_instance) operation has
/// a [`Client::create_addon_instance`], function which returns a builder for that operation.
...
mod get_archive_export;

mod get_archive_message;

mod get_archive_message_content;

mod get_archive_search;

mod get_archive_search_results;
...
mod update_ingress_point;

mod update_relay;

mod update_rule_set;

mod update_traffic_policy;
