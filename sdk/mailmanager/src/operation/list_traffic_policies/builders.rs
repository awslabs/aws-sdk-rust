...
impl ListTrafficPoliciesFluentBuilder {
    /// Creates a new `ListTrafficPoliciesFluentBuilder`.
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_traffic_policies::paginator::ListTrafficPoliciesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_traffic_policies::paginator::ListTrafficPoliciesPaginator {
        crate::operation::list_traffic_policies::paginator::ListTrafficPoliciesPaginator::new(self.handle, self.inner)
    }
