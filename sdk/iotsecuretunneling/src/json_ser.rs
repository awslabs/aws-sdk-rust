...
pub fn serialize_structure_close_tunnel_input(
...
pub fn serialize_structure_describe_tunnel_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_tunnels_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_open_tunnel_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_13) = &input.destination_config {
        ...
        crate::json_ser::serialize_structure_destination_config(&mut object_14, var_13);
        object_14.finish();
    }
    if let Some(var_15) = &input.timeout_config {
        let mut object_16 = object.key("timeoutConfig").start_object();
        crate::json_ser::serialize_structure_timeout_config(&mut object_16, var_15);
        object_16.finish();
    }
}
