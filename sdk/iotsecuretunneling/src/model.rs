...
pub struct TimeoutConfig  {
    ...
    #[doc(hidden)]pub max_lifetime_timeout_minutes: std::option::Option<i32>,
}
impl TimeoutConfig {
    /// <p>The maximum amount of time (in minutes) a tunnel can remain open. If not specified, maxLifetimeTimeoutMinutes defaults to 720 minutes. Valid values are from 1 minute to 12 hours (720 minutes) </p>
...
impl  std::fmt::Debug for TimeoutConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("max_lifetime_timeout_minutes", &self.max_lifetime_timeout_minutes);
        formatter.finish()
    }
}
...
pub struct TunnelSummary  {
    ...
    #[doc(hidden)]pub tunnel_arn: std::option::Option<std::string::String>,
    /// <p>The status of a tunnel. Valid values are: Open and Closed.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::TunnelStatus>,
...
pub struct Tunnel  {
    ...
    #[doc(hidden)]pub source_connection_state: std::option::Option<crate::model::ConnectionState>,
    /// <p>The connection state of the destination application.</p>
    #[doc(hidden)]pub destination_connection_state: std::option::Option<crate::model::ConnectionState>,
    /// <p>A description of the tunnel.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for Tunnel  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("destination_connection_state", &self.destination_connection_state);
        formatter.field("description", &self.description);
