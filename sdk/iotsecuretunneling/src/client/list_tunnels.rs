...
impl super::Client {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::list_tunnels::builders::ListTunnelsFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::list_tunnels::builders::ListTunnelsFluentBuilder::set_thing_name): <p>The name of the IoT thing associated with the destination device.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_tunnels::builders::ListTunnelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_tunnels::builders::ListTunnelsFluentBuilder::set_next_token): <p>To retrieve the next set of results, the nextToken value from a previous response; otherwise null to receive the first set of results.</p>
