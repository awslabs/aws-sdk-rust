...
pub struct RotateTunnelAccessTokenOutput  {
    ...
    #[doc(hidden)]pub source_access_token: std::option::Option<std::string::String>,
    /// <p>The client access token that the destination local proxy uses to connect to IoT Secure Tunneling.</p>
    #[doc(hidden)]pub destination_access_token: std::option::Option<std::string::String>,
}
...
pub struct ListTunnelsOutput  {
    ...
    #[doc(hidden)]pub tunnel_summaries: std::option::Option<std::vec::Vec<crate::model::TunnelSummary>>,
...
pub mod list_tunnels_output {
    ...
    impl Builder {
        ...
        /// <p>A short description of the tunnels in an Amazon Web Services account.</p>
        pub fn set_tunnel_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::TunnelSummary>>) -> Self {
...
pub struct DescribeTunnelOutput  {
    ...
    #[doc(hidden)]pub tunnel: std::option::Option<crate::model::Tunnel>,
}
