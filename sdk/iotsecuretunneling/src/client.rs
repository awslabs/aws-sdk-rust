...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_iotsecuretunneling::Error> {
/// # let client: aws_sdk_iotsecuretunneling::Client = unimplemented!();
...
mod rotate_tunnel_access_token;
