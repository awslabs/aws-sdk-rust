...
impl RotateTunnelAccessTokenFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::rotate_tunnel_access_token::RotateTunnelAccessTokenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rotate_tunnel_access_token::RotateTunnelAccessTokenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::rotate_tunnel_access_token::RotateTunnelAccessTokenOutput, crate::operation::rotate_tunnel_access_token::RotateTunnelAccessTokenError, Self> {
