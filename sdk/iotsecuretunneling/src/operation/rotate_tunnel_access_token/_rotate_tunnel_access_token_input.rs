...
impl RotateTunnelAccessTokenInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::rotate_tunnel_access_token::RotateTunnelAccessTokenInput, ::aws_smithy_types::error::operation::BuildError> {
