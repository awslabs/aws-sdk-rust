...
impl DescribeTunnelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_tunnel::DescribeTunnel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_tunnel::ser_describe_tunnel_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTunnel {
    type Output =
        ::std::result::Result<crate::operation::describe_tunnel::DescribeTunnelOutput, crate::operation::describe_tunnel::DescribeTunnelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_tunnel::de_describe_tunnel_http_response_with_props(status, headers, body)
        }
    }
}
