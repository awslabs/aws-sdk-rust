...
impl ListTunnelsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_tunnels::ListTunnels, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tunnels::ser_list_tunnels_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTunnels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_tunnels::de_list_tunnels_http_response_with_props(status, headers, body)
        }
    }
}
