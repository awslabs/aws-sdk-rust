...
impl ListTunnelsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_tunnels::ListTunnels,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_tunnels::ListTunnels::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTunnels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_tunnels::de_list_tunnels_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_tunnels::de_list_tunnels_http_response_with_props(
                status, headers, body,
            )
        }
    }
