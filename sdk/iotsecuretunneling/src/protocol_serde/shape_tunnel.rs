                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "sourceConnectionState" => {
                                builder = builder.set_source_connection_state(crate::protocol_serde::shape_connection_state::de_connection_state(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "destinationConnectionState" => {
                                builder = builder.set_destination_connection_state(
                                    crate::protocol_serde::shape_connection_state::de_connection_state(tokens, _value, depth + 1)?,
                                );
                            }
                            "description" => {
