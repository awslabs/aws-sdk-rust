...
pub(crate) fn de_tunnel<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::Tunnel>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "status" => {
                                builder = builder.set_status(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::TunnelStatus::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
