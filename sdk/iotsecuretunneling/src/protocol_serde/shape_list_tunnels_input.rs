...
pub fn ser_list_tunnels_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTunnelsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
