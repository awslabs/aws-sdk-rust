...
impl Builder {
    ...
    /// use aws_sdk_emrserverless::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_emrserverless::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
