...
impl Builder {
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("aws_sdk_emrserverless::config::Config").freeze(),
                                    cloneable: layer,
...
#[derive(::std::fmt::Debug)]
            ...
            impl ServiceRuntimePlugin {
                pub fn new(_service_config: crate::config::Config) -> Self {
                    let config = { let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AwsToledoWebService");
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_emrserverless::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
