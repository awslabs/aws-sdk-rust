...
pub fn serialize_structure_crate_input_create_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateApplicationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_8, value_9) in var_6 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_initial_capacity_config(&mut object_10, value_9)?;
                object_10.finish();
            }
        }
        object_7.finish();
    ...
    if let Some(var_11) = &input.maximum_capacity {
        ...
        crate::json_ser::serialize_structure_crate_model_maximum_allowed_resources(&mut object_12, var_11)?;
        object_12.finish();
    }
...
pub fn serialize_structure_crate_input_start_job_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartJobRunInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_23) = &input.configuration_overrides {
        ...
        crate::json_ser::serialize_structure_crate_model_configuration_overrides(&mut object_24, var_23)?;
        object_24.finish();
    }
    ...
    if let Some(var_26) = &input.execution_timeout_minutes {
        object.key("executionTimeoutMinutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_26).into()));
    }
...
pub fn serialize_structure_crate_input_update_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateApplicationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_45, value_46) in var_43 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_initial_capacity_config(&mut object_47, value_46)?;
                object_47.finish();
            }
        }
        object_44.finish();
    ...
    if let Some(var_48) = &input.maximum_capacity {
        ...
        crate::json_ser::serialize_structure_crate_model_maximum_allowed_resources(&mut object_49, var_48)?;
        object_49.finish();
    }
    if let Some(var_50) = &input.network_configuration {
        let mut object_51 = object.key("networkConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_network_configuration(&mut object_51, var_50)?;
        object_51.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_auto_start_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoStartConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_auto_stop_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoStopConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_53) = &input.enabled {
        object.key("enabled").boolean(*var_53);
    }
    if let Some(var_54) = &input.idle_timeout_minutes {
        object.key("idleTimeoutMinutes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_54).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_model_initial_capacity_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InitialCapacityConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
     {
    ...
    if let Some(var_55) = &input.worker_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_worker_resource_config(&mut object_56, var_55)?;
        object_56.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_maximum_allowed_resources(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MaximumAllowedResources) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_union_crate_model_job_driver(object_28: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobDriver) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::JobDriver::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("JobDriver"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_worker_resource_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkerResourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_84 in var_82 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_configuration(&mut object_85, item_84)?;
                object_85.finish();
            }
        }
        array_83.finish();
...
pub fn serialize_structure_crate_model_monitoring_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MonitoringConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_86) = &input.s3_monitoring_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_s3_monitoring_configuration(&mut object_87, var_86)?;
        object_87.finish();
    }
    if let Some(var_88) = &input.managed_persistence_monitoring_configuration {
        let mut object_89 = object.key("managedPersistenceMonitoringConfiguration").start_object();
...
pub fn serialize_structure_crate_model_spark_submit(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SparkSubmit) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_hive(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Hive) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_managed_persistence_monitoring_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ManagedPersistenceMonitoringConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
