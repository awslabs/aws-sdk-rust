...
pub fn de_list_job_runs_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_job_runs::ListJobRunsOutput, crate::operation::list_job_runs::ListJobRunsError> {
    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "jobRuns" => {
                    builder = builder.set_job_runs(crate::protocol_serde::shape_job_runs::de_job_runs(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
