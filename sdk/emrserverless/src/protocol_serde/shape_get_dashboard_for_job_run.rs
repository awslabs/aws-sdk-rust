...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_dashboard_for_job_run::de_get_dashboard_for_job_run(_response_body, output)
            .map_err(crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunError::unhandled)?;
