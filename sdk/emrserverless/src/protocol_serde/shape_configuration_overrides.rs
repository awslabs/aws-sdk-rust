...
pub fn ser_configuration_overrides(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfigurationOverrides) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_configuration_overrides<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfigurationOverrides>, aws_smithy_json::deserialize::error::DeserializeError>
