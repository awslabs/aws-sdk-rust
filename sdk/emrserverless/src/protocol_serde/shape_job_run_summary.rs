...
pub(crate) fn de_job_run_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobRunSummary>, aws_smithy_json::deserialize::error::DeserializeError>
