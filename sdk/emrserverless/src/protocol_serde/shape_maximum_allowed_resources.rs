...
pub(crate) fn de_maximum_allowed_resources<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::MaximumAllowedResources>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
