                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "autoStartConfiguration" => {
                            builder =
                                builder.set_auto_start_configuration(crate::protocol_serde::shape_auto_start_config::de_auto_start_config(tokens)?);
                        }
                        "autoStopConfiguration" => {
                            builder =
                                builder.set_auto_stop_configuration(crate::protocol_serde::shape_auto_stop_config::de_auto_stop_config(tokens)?);
                        }
