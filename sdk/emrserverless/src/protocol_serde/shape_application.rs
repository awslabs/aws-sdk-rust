    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "initialCapacity" => {
                            builder = builder.set_initial_capacity(
                                crate::protocol_serde::shape_initial_capacity_config_map::de_initial_capacity_config_map(tokens, _value)?,
                            );
                        }
                        "maximumCapacity" => {
                            builder = builder.set_maximum_capacity(
                                crate::protocol_serde::shape_maximum_allowed_resources::de_maximum_allowed_resources(tokens, _value)?,
                            );
                        }
                        "createdAt" => {
                        ...
                        "autoStartConfiguration" => {
                            builder = builder
                                .set_auto_start_configuration(crate::protocol_serde::shape_auto_start_config::de_auto_start_config(tokens, _value)?);
                        }
                        "autoStopConfiguration" => {
                            builder = builder
                                .set_auto_stop_configuration(crate::protocol_serde::shape_auto_stop_config::de_auto_stop_config(tokens, _value)?);
                        }
                        ...
                        "workerTypeSpecifications" => {
                            builder = builder.set_worker_type_specifications(
                                crate::protocol_serde::shape_worker_type_specification_map::de_worker_type_specification_map(tokens, _value)?,
                            );
                        }
                        ...
                        "interactiveConfiguration" => {
                            builder = builder.set_interactive_configuration(
                                crate::protocol_serde::shape_interactive_configuration::de_interactive_configuration(tokens, _value)?,
                            );
                        }
                        "schedulerConfiguration" => {
                            builder = builder.set_scheduler_configuration(
                                crate::protocol_serde::shape_scheduler_configuration::de_scheduler_configuration(tokens, _value)?,
                            );
                        }
            ...
            Ok(Some(crate::serde_util::application_correct_errors(builder).build().map_err(|err| {
