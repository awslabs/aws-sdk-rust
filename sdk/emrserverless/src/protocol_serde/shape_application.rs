                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "initialCapacity" => {
                            builder = builder.set_initial_capacity(
                                crate::protocol_serde::shape_initial_capacity_config_map::de_initial_capacity_config_map(tokens, _value, depth + 1)?,
                            );
                        }
                        "maximumCapacity" => {
                            builder = builder.set_maximum_capacity(
                                crate::protocol_serde::shape_maximum_allowed_resources::de_maximum_allowed_resources(tokens, _value, depth + 1)?,
                            );
                        }
                        "createdAt" => {
                        ...
                        "autoStartConfiguration" => {
                            builder = builder.set_auto_start_configuration(crate::protocol_serde::shape_auto_start_config::de_auto_start_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "autoStopConfiguration" => {
                            builder = builder.set_auto_stop_configuration(crate::protocol_serde::shape_auto_stop_config::de_auto_stop_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "interactiveConfiguration" => {
                            builder = builder.set_interactive_configuration(
                                crate::protocol_serde::shape_interactive_configuration::de_interactive_configuration(tokens, _value, depth + 1)?,
                            );
                        }
