    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "executionIamPolicy" => {
                            builder = builder.set_execution_iam_policy(
                                crate::protocol_serde::shape_job_run_execution_iam_policy::de_job_run_execution_iam_policy(tokens, _value)?,
                            );
                        }
                        "state" => {
                        ...
                        "queuedDurationMilliseconds" => {
                            builder = builder.set_queued_duration_milliseconds(
                                ::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?
                                    .map(i64::try_from)
                                    .transpose()?,
                            );
            ...
            Ok(Some(crate::serde_util::job_run_correct_errors(builder).build().map_err(|err| {
