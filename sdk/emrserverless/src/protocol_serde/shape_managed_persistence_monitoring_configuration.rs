...
pub(crate) fn de_managed_persistence_monitoring_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ManagedPersistenceMonitoringConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
