...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::cancel_job_run::CancelJobRunError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_cancel_job_run::de_cancel_job_run(_response_body, output)
                .map_err(crate::operation::cancel_job_run::CancelJobRunError::unhandled)?;
