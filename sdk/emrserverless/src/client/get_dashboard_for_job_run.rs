...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::set_application_id):<br>required: **true**<br><p>The ID of the application.</p><br>
    ///   - [`job_run_id(impl Into<String>)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::job_run_id) / [`set_job_run_id(impl Into<String>)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::set_job_run_id):<br>required: **true**<br><p>The ID of the job run.</p><br>
