...
impl super::Client {
    ...
    ///   - [`attempt(i32)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::attempt) / [`set_attempt(Option<i32>)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::set_attempt):<br>required: **false**<br><p>An optimal parameter that indicates the amount of attempts for the job. If not specified, this value defaults to the attempt of the latest job.</p><br>
    ///   - [`access_system_profile_logs(bool)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::access_system_profile_logs) / [`set_access_system_profile_logs(Option<bool>)`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunFluentBuilder::set_access_system_profile_logs):<br>required: **false**<br><p>Allows access to system profile logs for Lake Formation-enabled jobs. Default is false.</p><br>
