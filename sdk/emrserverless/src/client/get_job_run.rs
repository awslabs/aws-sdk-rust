...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_job_run::builders::GetJobRunFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::get_job_run::builders::GetJobRunFluentBuilder::set_application_id):<br>required: **true**<br><p>The ID of the application on which the job run is submitted.</p><br>
    ///   - [`job_run_id(impl Into<String>)`](crate::operation::get_job_run::builders::GetJobRunFluentBuilder::job_run_id) / [`set_job_run_id(impl Into<String>)`](crate::operation::get_job_run::builders::GetJobRunFluentBuilder::set_job_run_id):<br>required: **true**<br><p>The ID of the job run.</p><br>
