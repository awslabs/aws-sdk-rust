...
impl GetDashboardForJobRunFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunOutput, crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunError, Self> {
