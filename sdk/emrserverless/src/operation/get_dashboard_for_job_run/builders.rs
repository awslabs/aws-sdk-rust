...
/// 
/// <p>Returns a URL to access the job run dashboard. The generated URL is valid for one hour, after which you must invoke the API again to generate a new URL.</p>
...
impl GetDashboardForJobRunFluentBuilder  {
    /// Creates a new `GetDashboardForJobRun`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_dashboard_for_job_run::GetDashboardForJobRun, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunOutput, aws_smithy_http::result::SdkError<crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunError>>
                     {
