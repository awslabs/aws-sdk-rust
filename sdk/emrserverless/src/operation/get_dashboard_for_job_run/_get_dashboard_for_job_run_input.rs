...
impl GetDashboardForJobRunInputBuilder {
    ...
    /// - [`application_id`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunInputBuilder::application_id)
    /// - [`job_run_id`](crate::operation::get_dashboard_for_job_run::builders::GetDashboardForJobRunInputBuilder::job_run_id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::get_dashboard_for_job_run::GetDashboardForJobRunInput {
            application_id: self.application_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "application_id",
                    "application_id was not specified but it is required when building GetDashboardForJobRunInput",
                )
            })?,
            job_run_id: self.job_run_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "job_run_id",
                    "job_run_id was not specified but it is required when building GetDashboardForJobRunInput",
                )
            })?,
        })
    }
