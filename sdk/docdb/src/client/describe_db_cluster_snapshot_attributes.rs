...
impl super::Client {
    ...
    ///   - [`db_cluster_snapshot_identifier(impl ::std::convert::Into<String>)`](crate::operation::describe_db_cluster_snapshot_attributes::builders::DescribeDBClusterSnapshotAttributesFluentBuilder::db_cluster_snapshot_identifier) / [`set_db_cluster_snapshot_identifier(Option<String>)`](crate::operation::describe_db_cluster_snapshot_attributes::builders::DescribeDBClusterSnapshotAttributesFluentBuilder::set_db_cluster_snapshot_identifier): <p>The identifier for the cluster snapshot to describe the attributes for.</p>
