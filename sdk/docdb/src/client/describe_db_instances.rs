...
impl super::Client {
    ...
    ///   - [`db_instance_identifier(impl ::std::convert::Into<String>)`](crate::operation::describe_db_instances::builders::DescribeDBInstancesFluentBuilder::db_instance_identifier) / [`set_db_instance_identifier(Option<String>)`](crate::operation::describe_db_instances::builders::DescribeDBInstancesFluentBuilder::set_db_instance_identifier): <p>The user-provided instance identifier. If this parameter is specified, information from only the specific instance is returned. This parameter isn't case sensitive.</p>  <p>Constraints:</p>  <ul>   <li> <p>If provided, must match the identifier of an existing <code>DBInstance</code>.</p> </li>  </ul>
