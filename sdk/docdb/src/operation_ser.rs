...
pub fn serialize_operation_copy_db_cluster_parameter_group(
    ...
    if let Some(var_25) = &input.tags {
        ...
        for item_26 in var_25 {
            ...
            crate::query_ser::serialize_structure_tag(entry_28, item_26);
        }
        list_27.finish();
    }
    writer.finish();
...
pub fn serialize_operation_copy_db_cluster_snapshot(
    ...
    if let Some(var_40) = &input.tags {
        ...
        for item_41 in var_40 {
            ...
            crate::query_ser::serialize_structure_tag(entry_43, item_41);
        }
        list_42.finish();
    }
    writer.finish();
...
pub fn serialize_operation_create_db_cluster_parameter_group(
    ...
    if let Some(var_103) = &input.tags {
        ...
        for item_104 in var_103 {
            ...
            crate::query_ser::serialize_structure_tag(entry_106, item_104);
        }
        list_105.finish();
    }
    writer.finish();
...
pub fn serialize_operation_create_db_subnet_group(
    ...
    if let Some(var_147) = &input.tags {
        ...
        for item_148 in var_147 {
            ...
            crate::query_ser::serialize_structure_tag(entry_150, item_148);
        }
        list_149.finish();
    }
    writer.finish();
...
pub fn serialize_operation_create_event_subscription(
    ...
    if let Some(var_170) = &input.tags {
        ...
        for item_171 in var_170 {
            ...
            crate::query_ser::serialize_structure_tag(entry_173, item_171);
        }
        list_172.finish();
    }
    writer.finish();
...
pub fn serialize_operation_describe_certificates(
    ...
    if let Some(var_208) = &input.filters {
        ...
        for item_209 in var_208 {
            ...
            crate::query_ser::serialize_structure_filter(entry_211, item_209);
        }
        list_210.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_cluster_parameter_groups(
    ...
    if let Some(var_219) = &input.filters {
        ...
        for item_220 in var_219 {
            ...
            crate::query_ser::serialize_structure_filter(entry_222, item_220);
        }
        list_221.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_cluster_parameters(
    ...
    if let Some(var_232) = &input.filters {
        ...
        for item_233 in var_232 {
            ...
            crate::query_ser::serialize_structure_filter(entry_235, item_233);
        }
        list_234.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_clusters(
    ...
    if let Some(var_243) = &input.filters {
        ...
        for item_244 in var_243 {
            ...
            crate::query_ser::serialize_structure_filter(entry_246, item_244);
        }
        list_245.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_cluster_snapshots(
    ...
    if let Some(var_260) = &input.filters {
        ...
        for item_261 in var_260 {
            ...
            crate::query_ser::serialize_structure_filter(entry_263, item_261);
        }
        list_262.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_engine_versions(
    ...
    if let Some(var_277) = &input.filters {
        ...
        for item_278 in var_277 {
            ...
            crate::query_ser::serialize_structure_filter(entry_280, item_278);
        }
        list_279.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_instances(
    ...
    if let Some(var_293) = &input.filters {
        ...
        for item_294 in var_293 {
            ...
            crate::query_ser::serialize_structure_filter(entry_296, item_294);
        }
        list_295.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_db_subnet_groups(
    ...
    if let Some(var_304) = &input.filters {
        ...
        for item_305 in var_304 {
            ...
            crate::query_ser::serialize_structure_filter(entry_307, item_305);
        }
        list_306.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_engine_default_cluster_parameters(
    ...
    if let Some(var_315) = &input.filters {
        ...
        for item_316 in var_315 {
            ...
            crate::query_ser::serialize_structure_filter(entry_318, item_316);
        }
        list_317.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_event_categories(
    ...
    if let Some(var_326) = &input.filters {
        ...
        for item_327 in var_326 {
            ...
            crate::query_ser::serialize_structure_filter(entry_329, item_327);
        }
        list_328.finish();
    }
    writer.finish();
...
pub fn serialize_operation_describe_events(
    ...
    if let Some(var_346) = &input.filters {
        ...
        for item_347 in var_346 {
            ...
            crate::query_ser::serialize_structure_filter(entry_349, item_347);
        }
        list_348.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_event_subscriptions(
    ...
    if let Some(var_357) = &input.filters {
        ...
        for item_358 in var_357 {
            ...
            crate::query_ser::serialize_structure_filter(entry_360, item_358);
        }
        list_359.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_global_clusters(
    ...
    if let Some(var_368) = &input.filters {
        ...
        for item_369 in var_368 {
            ...
            crate::query_ser::serialize_structure_filter(entry_371, item_369);
        }
        list_370.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_orderable_db_instance_options(
    ...
    if let Some(var_387) = &input.filters {
        ...
        for item_388 in var_387 {
            ...
            crate::query_ser::serialize_structure_filter(entry_390, item_388);
        }
        list_389.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_pending_maintenance_actions(
    ...
    if let Some(var_398) = &input.filters {
        ...
        for item_399 in var_398 {
            ...
            crate::query_ser::serialize_structure_filter(entry_401, item_399);
        }
        list_400.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_list_tags_for_resource(
    ...
    if let Some(var_413) = &input.filters {
        ...
        for item_414 in var_413 {
            ...
            crate::query_ser::serialize_structure_filter(entry_416, item_414);
        }
        list_415.finish();
    }
    writer.finish();
...
pub fn serialize_operation_modify_db_cluster_parameter_group(
    ...
    if let Some(var_448) = &input.parameters {
        ...
        for item_449 in var_448 {
            ...
            crate::query_ser::serialize_structure_parameter(entry_451, item_449);
        }
        list_450.finish();
    }
    writer.finish();
...
pub fn serialize_operation_reset_db_cluster_parameter_group(
    ...
    if let Some(var_532) = &input.parameters {
        ...
        for item_533 in var_532 {
            ...
            crate::query_ser::serialize_structure_parameter(entry_535, item_533);
        }
        list_534.finish();
    }
    writer.finish();
...
pub fn serialize_operation_restore_db_cluster_from_snapshot(
    ...
    if let Some(var_559) = &input.tags {
        ...
        for item_560 in var_559 {
            ...
            crate::query_ser::serialize_structure_tag(entry_562, item_560);
        }
        list_561.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_restore_db_cluster_to_point_in_time(
    ...
    if let Some(var_589) = &input.tags {
        ...
        for item_590 in var_589 {
            ...
            crate::query_ser::serialize_structure_tag(entry_592, item_590);
        }
        list_591.finish();
    }
    #[allow(unused_mut)]
