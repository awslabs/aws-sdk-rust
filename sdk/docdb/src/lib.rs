...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("docdb", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon DocumentDB with MongoDB compatibility.
pub mod client;
