...
pub fn de_global_cluster_member(
    ...
    depth: u32,
) -> ::std::result::Result<crate::types::GlobalClusterMember, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Readers") /* Readers com.amazonaws.docdb#GlobalClusterMember$Readers */ =>  {
                let var_2 =
                    Some(
                        crate::protocol_serde::shape_readers_arn_list::de_readers_arn_list(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            ,
            s if s.matches("SynchronizationStatus") /* SynchronizationStatus com.amazonaws.docdb#GlobalClusterMember$SynchronizationStatus */ =>  {
                let var_4 =
                    Some(
                ...
                ;
                builder = builder.set_synchronization_status(var_4);
            }
            ,
            _ => {}
        }
