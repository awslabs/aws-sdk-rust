...
pub fn de_modify_db_cluster_http_error(
    ...
    Err(match error_code {
        ...
        "DBClusterParameterGroupNotFound" => {
            crate::operation::modify_db_cluster::ModifyDBClusterError::DbClusterParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn de_modify_db_cluster_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_db_cluster::de_modify_db_cluster(_response_body, output)
            .map_err(crate::operation::modify_db_cluster::ModifyDBClusterError::unhandled)?;
...
pub fn de_modify_db_cluster(
...
) -> std::result::Result<crate::operation::modify_db_cluster::builders::ModifyDbClusterOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyDBClusterResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyDBClusterResult got {start_el:?}"
            )));
        }
