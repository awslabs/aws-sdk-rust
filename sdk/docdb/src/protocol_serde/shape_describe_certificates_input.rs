...
pub fn ser_describe_certificates_input_input_input(input: &crate::operation::describe_certificates::DescribeCertificatesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
