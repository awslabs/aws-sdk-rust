...
pub fn de_pending_maintenance_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PendingMaintenanceAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
