...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroupError::unhandled)?;
    ...
    Err(match error_code {
        "DBParameterGroupNotFound" => {
            crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroupError::DbParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidDBParameterGroupState" => {
            crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroupError::InvalidDbParameterGroupStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_reset_db_cluster_parameter_group::de_reset_db_cluster_parameter_group(_response_body, output)
            .map_err(crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroupError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ResetDBClusterParameterGroupResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ResetDBClusterParameterGroupResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ResetDBClusterParameterGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ResetDBClusterParameterGroupResult got {start_el:?}"
            )));
        }
