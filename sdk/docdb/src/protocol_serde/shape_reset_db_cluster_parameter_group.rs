...
pub fn de_reset_db_cluster_parameter_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ResetDbClusterParameterGroupOutput, crate::error::ResetDBClusterParameterGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ResetDBClusterParameterGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reset_db_cluster_parameter_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ResetDbClusterParameterGroupOutput, crate::error::ResetDBClusterParameterGroupError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_reset_db_cluster_parameter_group(inp: &[u8], mut builder: crate::output::reset_db_cluster_parameter_group_output::Builder) -> Result<crate::output::reset_db_cluster_parameter_group_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
