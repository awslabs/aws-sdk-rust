...
) -> std::result::Result<crate::operation::modify_db_subnet_group::builders::ModifyDbSubnetGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyDBSubnetGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyDBSubnetGroupResult got {start_el:?}"
            )));
        }
