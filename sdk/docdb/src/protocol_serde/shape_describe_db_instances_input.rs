...
pub fn ser_describe_db_instances_input_input_input(input: &crate::operation::describe_db_instances::DescribeDbInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
