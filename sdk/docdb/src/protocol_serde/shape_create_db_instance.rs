...
pub fn de_create_db_instance(
...
) -> std::result::Result<crate::operation::create_db_instance::builders::CreateDbInstanceOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateDBInstanceResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateDBInstanceResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateDBInstanceResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateDBInstanceResult got {start_el:?}"
            )));
        }
