...
pub fn de_remove_from_global_cluster_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterOutput, crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_from_global_cluster_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterOutput, crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError> {
    Ok({
        #[allow(unused_mut)]
