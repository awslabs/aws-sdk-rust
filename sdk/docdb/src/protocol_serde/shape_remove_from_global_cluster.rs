...
pub fn de_remove_from_global_cluster_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterOutput, crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_from_global_cluster_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterOutput, crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError> {
    Ok({
        #[allow(unused_mut)]
