...
#[allow(unused_mut)]
pub fn ser_cloudwatch_logs_export_configuration(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::CloudwatchLogsExportConfiguration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
