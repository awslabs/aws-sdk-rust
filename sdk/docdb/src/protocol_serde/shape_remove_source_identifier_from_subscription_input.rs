...
pub fn ser_remove_source_identifier_from_subscription_input_input(input: &crate::input::RemoveSourceIdentifierFromSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
