...
pub fn ser_describe_db_clusters_input_input(input: &crate::input::DescribeDbClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
