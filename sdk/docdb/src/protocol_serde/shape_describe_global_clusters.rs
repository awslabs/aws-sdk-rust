...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_global_clusters::DescribeGlobalClustersError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_global_clusters::de_describe_global_clusters(_response_body, output)
            .map_err(crate::operation::describe_global_clusters::DescribeGlobalClustersError::unhandled)?;
...
) -> Result<crate::operation::describe_global_clusters::builders::DescribeGlobalClustersOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
