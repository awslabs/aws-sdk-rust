...
pub fn de_pending_cloudwatch_logs_exports(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PendingCloudwatchLogsExports, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
