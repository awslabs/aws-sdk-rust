...
pub fn de_delete_db_instance_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_instance::DeleteDbInstanceOutput, crate::operation::delete_db_instance::DeleteDBInstanceError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_instance_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_instance::DeleteDbInstanceOutput, crate::operation::delete_db_instance::DeleteDBInstanceError> {
    Ok({
        #[allow(unused_mut)]
