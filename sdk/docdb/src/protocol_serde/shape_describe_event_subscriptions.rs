...
pub fn de_describe_event_subscriptions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeEventSubscriptionsOutput, crate::error::DescribeEventSubscriptionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeEventSubscriptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_event_subscriptions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeEventSubscriptionsOutput, crate::error::DescribeEventSubscriptionsError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_describe_event_subscriptions(inp: &[u8], mut builder: crate::output::describe_event_subscriptions_output::Builder) -> Result<crate::output::describe_event_subscriptions_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
