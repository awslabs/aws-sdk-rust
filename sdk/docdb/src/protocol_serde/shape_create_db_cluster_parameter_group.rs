...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_db_cluster_parameter_group::CreateDBClusterParameterGroupError::unhandled)?;
    ...
    Err(match error_code {
        "DBParameterGroupAlreadyExists" => {
            crate::operation::create_db_cluster_parameter_group::CreateDBClusterParameterGroupError::DbParameterGroupAlreadyExistsFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DBParameterGroupQuotaExceeded" => {
            crate::operation::create_db_cluster_parameter_group::CreateDBClusterParameterGroupError::DbParameterGroupQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_db_cluster_parameter_group::de_create_db_cluster_parameter_group(_response_body, output)
            .map_err(crate::operation::create_db_cluster_parameter_group::CreateDBClusterParameterGroupError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("CreateDBClusterParameterGroupResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateDBClusterParameterGroupResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateDBClusterParameterGroupResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateDBClusterParameterGroupResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("DBClusterParameterGroup") /* DBClusterParameterGroup com.amazonaws.docdb.synthetic#CreateDBClusterParameterGroupOutput$DBClusterParameterGroup */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_db_cluster_parameter_group::de_db_cluster_parameter_group(&mut tag, depth + 1)
                        ?
                    )
                ;
