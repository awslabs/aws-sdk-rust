...
pub fn de_delete_db_subnet_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteDbSubnetGroupOutput, crate::error::DeleteDBSubnetGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteDBSubnetGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_subnet_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteDbSubnetGroupOutput, crate::error::DeleteDBSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
