...
pub fn ser_describe_event_categories_input_input_input(input: &crate::operation::describe_event_categories::DescribeEventCategoriesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
