...
pub fn de_failover_db_cluster_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::FailoverDbClusterOutput, crate::error::FailoverDBClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::FailoverDBClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_failover_db_cluster_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::FailoverDbClusterOutput, crate::error::FailoverDBClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::failover_db_cluster_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_failover_db_cluster::de_failover_db_cluster(response.body().as_ref(), output).map_err(crate::error::FailoverDBClusterError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_failover_db_cluster(inp: &[u8], mut builder: crate::output::failover_db_cluster_output::Builder) -> Result<crate::output::failover_db_cluster_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
