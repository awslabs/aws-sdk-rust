...
pub fn de_failover_db_cluster_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::failover_db_cluster::FailoverDbClusterOutput, crate::operation::failover_db_cluster::FailoverDBClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::failover_db_cluster::FailoverDBClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_failover_db_cluster_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::failover_db_cluster::FailoverDbClusterOutput, crate::operation::failover_db_cluster::FailoverDBClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::failover_db_cluster::builders::FailoverDbClusterOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_failover_db_cluster::de_failover_db_cluster(response.body().as_ref(), output).map_err(crate::operation::failover_db_cluster::FailoverDBClusterError::unhandled)?;
