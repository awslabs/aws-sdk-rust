...
pub fn de_failover_db_cluster_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::failover_db_cluster::FailoverDbClusterOutput, crate::operation::failover_db_cluster::FailoverDBClusterError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::failover_db_cluster::FailoverDbClusterOutput, crate::operation::failover_db_cluster::FailoverDBClusterError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_failover_db_cluster::de_failover_db_cluster(_response_body, output)
            .map_err(crate::operation::failover_db_cluster::FailoverDBClusterError::unhandled)?;
...
) -> Result<crate::operation::failover_db_cluster::builders::FailoverDbClusterOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
