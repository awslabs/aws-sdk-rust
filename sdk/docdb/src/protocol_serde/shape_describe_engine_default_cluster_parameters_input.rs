...
pub fn ser_describe_engine_default_cluster_parameters_input_input(input: &crate::input::DescribeEngineDefaultClusterParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
