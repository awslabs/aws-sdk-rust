...
pub fn ser_stop_db_cluster_input_input(input: &crate::input::StopDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
