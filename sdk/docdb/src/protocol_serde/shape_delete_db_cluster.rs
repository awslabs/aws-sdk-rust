...
pub fn de_delete_db_cluster_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_db_cluster::DeleteDbClusterOutput, crate::operation::delete_db_cluster::DeleteDBClusterError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "DBClusterSnapshotAlreadyExistsFault" => crate::operation::delete_db_cluster::DeleteDBClusterError::DbClusterSnapshotAlreadyExistsFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_db_cluster_snapshot_already_exists_fault::de_db_cluster_snapshot_already_exists_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::delete_db_cluster::DeleteDBClusterError::unhandled)?;
        ...
        "InvalidDBClusterSnapshotStateFault" => crate::operation::delete_db_cluster::DeleteDBClusterError::InvalidDbClusterSnapshotStateFault({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_db_cluster_snapshot_state_fault::de_invalid_db_cluster_snapshot_state_fault_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::delete_db_cluster::DeleteDBClusterError::unhandled)?;
...
pub fn de_delete_db_cluster_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_db_cluster::de_delete_db_cluster(_response_body, output)
            .map_err(crate::operation::delete_db_cluster::DeleteDBClusterError::unhandled)?;
...
pub fn de_delete_db_cluster(
    ...
    if !(start_el.matches("DeleteDBClusterResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteDBClusterResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DeleteDBClusterResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DeleteDBClusterResult got {start_el:?}"
            )));
        }
