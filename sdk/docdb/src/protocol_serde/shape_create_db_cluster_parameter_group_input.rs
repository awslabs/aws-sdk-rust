...
pub fn ser_create_db_cluster_parameter_group_input_input_input(
    input: &crate::operation::create_db_cluster_parameter_group::CreateDbClusterParameterGroupInput,
