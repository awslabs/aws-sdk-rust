...
pub fn ser_create_db_cluster_parameter_group_input_input(input: &crate::input::CreateDbClusterParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
