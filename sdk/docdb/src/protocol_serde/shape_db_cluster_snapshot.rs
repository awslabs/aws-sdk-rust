...
pub fn de_db_cluster_snapshot(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbClusterSnapshot, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
