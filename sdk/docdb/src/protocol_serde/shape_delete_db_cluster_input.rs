...
pub fn ser_delete_db_cluster_input_input_input(input: &crate::operation::delete_db_cluster::DeleteDbClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
