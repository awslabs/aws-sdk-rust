...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBClusterSnapshotAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_cluster_snapshot_attributes::de_describe_db_cluster_snapshot_attributes_http_response_with_props(status, headers, body)
        }
    }
}
