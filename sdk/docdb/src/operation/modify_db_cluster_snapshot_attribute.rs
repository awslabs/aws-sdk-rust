...
impl ModifyDbClusterSnapshotAttributeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_db_cluster_snapshot_attribute::ModifyDBClusterSnapshotAttribute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyDBClusterSnapshotAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_db_cluster_snapshot_attribute::de_modify_db_cluster_snapshot_attribute_http_response_with_props(
                status, headers, body,
            )
        }
    }
