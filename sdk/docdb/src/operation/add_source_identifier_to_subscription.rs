...
impl AddSourceIdentifierToSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`AddSourceIdentifierToSubscription`](crate::operation::add_source_identifier_to_subscription::AddSourceIdentifierToSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_source_identifier_to_subscription::AddSourceIdentifierToSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_source_identifier_to_subscription::AddSourceIdentifierToSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_source_identifier_to_subscription::AddSourceIdentifierToSubscription::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AddSourceIdentifierToSubscription {
                type Output = std::result::Result<crate::operation::add_source_identifier_to_subscription::AddSourceIdentifierToSubscriptionOutput, crate::operation::add_source_identifier_to_subscription::AddSourceIdentifierToSubscriptionError>;
