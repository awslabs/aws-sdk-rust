...
impl CopyDbClusterSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_db_cluster_snapshot::CopyDBClusterSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyDBClusterSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_db_cluster_snapshot::de_copy_db_cluster_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::copy_db_cluster_snapshot::CopyDBClusterSnapshotError
{
