...
impl CopyDBClusterSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::copy_db_cluster_snapshot::CopyDBClusterSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::copy_db_cluster_snapshot::CopyDbClusterSnapshotOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DocDB", "CopyDBClusterSnapshot", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "DocDB.CopyDBClusterSnapshot",
                "rpc.service" = "DocDB",
                "rpc.method" = "CopyDBClusterSnapshot",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CopyDBClusterSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CopyDBClusterSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CopyDBClusterSnapshotResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CopyDBClusterSnapshot")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyDBClusterSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CopyDBClusterSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CopyDBClusterSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopyDBClusterSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CopyDbClusterSnapshotInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("SourceDBClusterSnapshotIdentifier") {
            if let ::std::option::Option::Some(value) = input.source_db_cluster_snapshot_identifier.as_deref() {
                captured.insert("SourceDBClusterSnapshotIdentifier", value);
            }
        }
        if requested.should_capture("TargetDBClusterSnapshotIdentifier") {
            if let ::std::option::Option::Some(value) = input.target_db_cluster_snapshot_identifier.as_deref() {
                captured.insert("TargetDBClusterSnapshotIdentifier", value);
            }
        }
        ...
        if requested.should_capture("PreSignedUrl") {
            if let ::std::option::Option::Some(value) = input.pre_signed_url.as_deref() {
                captured.insert("PreSignedUrl", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyDBClusterSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_copy_db_cluster_snapshot::de_copy_db_cluster_snapshot_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_copy_db_cluster_snapshot::de_copy_db_cluster_snapshot_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyDBClusterSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::copy_db_cluster_snapshot::CopyDbClusterSnapshotInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::copy_db_cluster_snapshot::CopyDbClusterSnapshotInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_copy_db_cluster_snapshot_input::ser_copy_db_cluster_snapshot_input_input_input(&input)?,
        );
