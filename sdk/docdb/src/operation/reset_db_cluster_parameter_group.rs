...
impl ResetDbClusterParameterGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetDBClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reset_db_cluster_parameter_group::de_reset_db_cluster_parameter_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
