...
impl ResetDbClusterParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`ResetDBClusterParameterGroup`](crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_db_cluster_parameter_group::ResetDbClusterParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ResetDBClusterParameterGroup {
                type Output = std::result::Result<crate::operation::reset_db_cluster_parameter_group::ResetDbClusterParameterGroupOutput, crate::operation::reset_db_cluster_parameter_group::ResetDBClusterParameterGroupError>;
