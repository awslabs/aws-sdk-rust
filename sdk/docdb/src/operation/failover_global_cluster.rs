...
impl FailoverGlobalCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("docdb", "FailoverGlobalCluster", input, runtime_plugins, stop_point).await
    }
