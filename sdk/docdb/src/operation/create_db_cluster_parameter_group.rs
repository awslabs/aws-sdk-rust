...
impl CreateDbClusterParameterGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_db_cluster_parameter_group::CreateDBClusterParameterGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDBClusterParameterGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_db_cluster_parameter_group::de_create_db_cluster_parameter_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
