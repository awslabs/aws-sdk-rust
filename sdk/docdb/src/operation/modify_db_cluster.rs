...
impl ModifyDbClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_db_cluster::ModifyDBCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyDBCluster {
    type Output =
        ::std::result::Result<crate::operation::modify_db_cluster::ModifyDbClusterOutput, crate::operation::modify_db_cluster::ModifyDBClusterError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_db_cluster::de_modify_db_cluster_http_response_with_props(status, headers, body)
        }
    }
}
