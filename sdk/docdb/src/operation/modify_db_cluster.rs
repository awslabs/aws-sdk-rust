...
impl ModifyDBCluster {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_db_cluster::ModifyDBClusterError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_db_cluster::ModifyDbClusterOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("docdb", "ModifyDBCluster", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyDBCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyDBClusterRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyDBClusterResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifyDBCluster", "docdb"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDBCluster")
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyDBClusterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_db_cluster::ModifyDbClusterInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::modify_db_cluster::ModifyDbClusterInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_db_cluster_input::ser_modify_db_cluster_input_input_input(&input)?,
        );
