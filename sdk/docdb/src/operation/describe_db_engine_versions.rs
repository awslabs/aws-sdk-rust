...
impl DescribeDbEngineVersionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_engine_versions::DescribeDBEngineVersions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBEngineVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_engine_versions::de_describe_db_engine_versions_http_response_with_props(status, headers, body)
        }
    }
}
