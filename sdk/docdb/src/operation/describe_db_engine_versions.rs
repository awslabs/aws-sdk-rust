...
impl DescribeDbEngineVersionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBEngineVersions`](crate::operation::describe_db_engine_versions::DescribeDBEngineVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_engine_versions::DescribeDBEngineVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_engine_versions::DescribeDbEngineVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_engine_versions::DescribeDBEngineVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBEngineVersions {
                type Output = std::result::Result<crate::operation::describe_db_engine_versions::DescribeDbEngineVersionsOutput, crate::operation::describe_db_engine_versions::DescribeDBEngineVersionsError>;
