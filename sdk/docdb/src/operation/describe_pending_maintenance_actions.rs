...
impl DescribePendingMaintenanceActionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_pending_maintenance_actions::DescribePendingMaintenanceActions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePendingMaintenanceActions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_pending_maintenance_actions::de_describe_pending_maintenance_actions_http_response_with_props(
                status, headers, body,
            )
        }
    }
