...
pub struct DbCluster  {
    ...
    #[doc(hidden)]pub deletion_protection: bool,
}
impl DbCluster {
    /// <p>Provides the list of Amazon EC2 Availability Zones that instances in the cluster can be created in.</p>
...
pub struct Certificate  {
    ...
    #[doc(hidden)]pub certificate_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub valid_from: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date-time after which the certificate is no longer valid.</p> 
    /// <p>Example: <code>2024-07-31T17:57:09Z</code> </p>
    #[doc(hidden)]pub valid_till: std::option::Option<aws_smithy_types::DateTime>,
