...
pub struct UsageAllocation  {
    ...
    #[doc(hidden)]pub allocated_usage_quantity: std::option::Option<i32>,
...
pub struct UsageRecord  {
    ...
    #[doc(hidden)]pub dimension: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub quantity: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub usage_allocations: std::option::Option<std::vec::Vec<crate::model::UsageAllocation>>,
}
impl UsageRecord {
    /// <p>Timestamp, in UTC, for which the usage is being reported.</p> 
    /// <p>Your application can meter usage for up to one hour in the past. Make sure the <code>timestamp</code> value is not before the start of the software usage.</p>
...
pub mod usage_record {
    ...
    pub struct Builder {
        ...
        pub(crate) usage_allocations: std::option::Option<std::vec::Vec<crate::model::UsageAllocation>>,
    }
    impl Builder {
        /// <p>Timestamp, in UTC, for which the usage is being reported.</p> 
        /// <p>Your application can meter usage for up to one hour in the past. Make sure the <code>timestamp</code> value is not before the start of the software usage.</p>
        ...
        /// <p>The set of <code>UsageAllocations</code> to submit. The sum of all <code>UsageAllocation</code> quantities must equal the Quantity of the <code>UsageRecord</code>.</p>
        pub fn set_usage_allocations(mut self, input: std::option::Option<std::vec::Vec<crate::model::UsageAllocation>>) -> Self {
...
pub struct UsageRecordResult  {
    ...
    #[doc(hidden)]pub usage_record: std::option::Option<crate::model::UsageRecord>,
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::UsageRecordResultStatus>,
}
...
pub mod usage_record_result {
    ...
    impl Builder {
        ...
        /// <p>The <code>UsageRecord</code> that was part of the <code>BatchMeterUsage</code> request.</p>
        pub fn set_usage_record(mut self, input: std::option::Option<crate::model::UsageRecord>) -> Self {
        ...
        /// <li> <p> <i>DuplicateRecord</i>- Indicates that the <code>UsageRecord</code> was invalid and not honored. A previously metered <code>UsageRecord</code> had the same customer, dimension, and time, but a different quantity.</p> </li> 
        /// </ul>
        pub fn set_status(mut self, input: std::option::Option<crate::model::UsageRecordResultStatus>) -> Self {
