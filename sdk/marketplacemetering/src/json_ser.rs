...
pub fn serialize_structure_batch_meter_usage_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_usage_record(&mut object_4, item_3);
                object_4.finish();
            }
        }
        array_2.finish();
...
pub fn serialize_structure_meter_usage_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_13 in var_11 {
            {
                ...
                crate::json_ser::serialize_structure_usage_allocation(&mut object_14, item_13);
                object_14.finish();
            }
        }
        array_12.finish();
...
pub fn serialize_structure_register_usage_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_resolve_customer_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_usage_record(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_25 in var_23 {
            {
                ...
                crate::json_ser::serialize_structure_usage_allocation(&mut object_26, item_25);
                object_26.finish();
            }
        }
        array_24.finish();
...
pub fn serialize_structure_usage_allocation(
    object: &mut smithy_json::serialize::JsonObjectWriter,
