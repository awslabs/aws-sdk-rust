...
impl super::Client {
    ...
    ///   - [`registration_token(impl ::std::convert::Into<String>)`](crate::operation::resolve_customer::builders::ResolveCustomerFluentBuilder::registration_token) / [`set_registration_token(Option<String>)`](crate::operation::resolve_customer::builders::ResolveCustomerFluentBuilder::set_registration_token): <p>When a buyer visits your website during the registration process, the buyer submits a registration token through the browser. The registration token is resolved to obtain a <code>CustomerIdentifier</code> along with the <code>CustomerAWSAccountId</code> and <code>ProductCode</code>.</p>
