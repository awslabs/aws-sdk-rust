...
impl super::Client {
    ...
    ///   - [`customer_aws_account_id(Option<String>)`](crate::operation::resolve_customer::ResolveCustomerOutput::customer_aws_account_id): <p>The <code>CustomerAWSAccountId</code> provides the Amazon Web Services account ID associated with the <code>CustomerIdentifier</code> for the individual customer. Calls to <code>BatchMeterUsage</code> require <code>CustomerAWSAccountId</code> for each <code>UsageRecord</code>.</p>
    ///   - [`license_arn(Option<String>)`](crate::operation::resolve_customer::ResolveCustomerOutput::license_arn): <p>The <code>LicenseArn</code> is a unique identifier for a specific granted license. These are typically used for software purchased through Amazon Web Services Marketplace. Calls to <code>BatchMeterUsage</code> require <code>LicenseArn</code> for each <code>UsageRecord</code>.</p><note>  <p>Once you receive the <code>CustomerAWSAccountId</code> and <code>LicenseArn</code> in the response, store that for future purposes/API calls/integrations.</p> </note>
