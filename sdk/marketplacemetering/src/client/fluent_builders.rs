...
impl BatchMeterUsage  {
    /// Creates a new `BatchMeterUsage`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::operation::customize::CustomizableOperation<crate::operation::BatchMeterUsage, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::output::BatchMeterUsageOutput, aws_smithy_http::result::SdkError<crate::error::BatchMeterUsageError>>
                     {
    ...
    /// <p>The set of <code>UsageRecords</code> to submit. <code>BatchMeterUsage</code> accepts up to 25 <code>UsageRecords</code> at a time.</p>
    pub fn set_usage_records(mut self, input: std::option::Option<std::vec::Vec<crate::model::UsageRecord>>) -> Self {
...
impl MeterUsage  {
    /// Creates a new `MeterUsage`.
                    ...
                    /// sent. The operation's inner [http::Request] can be modified as well.
                    pub async fn customize(self) -> std::result::Result<
                        crate::operation::customize::CustomizableOperation<crate::operation::MeterUsage, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                    /// set when configuring the client.
                    pub async fn send(self) -> std::result::Result<crate::output::MeterUsageOutput, aws_smithy_http::result::SdkError<crate::error::MeterUsageError>>
                     {
                        let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                            .make_operation(&self.handle.conf)
                            .await
...
impl RegisterUsage  {
    /// Creates a new `RegisterUsage`.
                    ...
                    /// sent. The operation's inner [http::Request] can be modified as well.
                    pub async fn customize(self) -> std::result::Result<
                        crate::operation::customize::CustomizableOperation<crate::operation::RegisterUsage, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                    /// set when configuring the client.
                    pub async fn send(self) -> std::result::Result<crate::output::RegisterUsageOutput, aws_smithy_http::result::SdkError<crate::error::RegisterUsageError>>
                     {
                        let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                            .make_operation(&self.handle.conf)
                            .await
...
impl ResolveCustomer  {
    /// Creates a new `ResolveCustomer`.
                    ...
                    /// sent. The operation's inner [http::Request] can be modified as well.
                    pub async fn customize(self) -> std::result::Result<
                        crate::operation::customize::CustomizableOperation<crate::operation::ResolveCustomer, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    /// is configurable with the [RetryConfig](aws_smithy_types::retry::RetryConfig), which can be
                    /// set when configuring the client.
                    pub async fn send(self) -> std::result::Result<crate::output::ResolveCustomerOutput, aws_smithy_http::result::SdkError<crate::error::ResolveCustomerError>>
                     {
                        let op = self.inner.build().map_err(aws_smithy_http::result::SdkError::construction_failure)?
                            .make_operation(&self.handle.conf)
                            .await
