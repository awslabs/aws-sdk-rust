...
pub fn ser_usage_record(
    ...
    if let Some(var_1) = &input.quantity {
        object.key("Quantity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
...
pub(crate) fn de_usage_record<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::UsageRecord>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::usage_record_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
