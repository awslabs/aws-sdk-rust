...
pub fn ser_usage_record(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UsageRecord) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
