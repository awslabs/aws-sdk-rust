...
pub struct ResolveCustomerOutput  {
    ...
    #[doc(hidden)]pub customer_identifier: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub product_code: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub customer_aws_account_id: std::option::Option<std::string::String>,
}
...
pub struct RegisterUsageOutput  {
    ...
    #[doc(hidden)]pub public_key_rotation_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>JWT Token</p>
    #[doc(hidden)]pub signature: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for RegisterUsageOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("public_key_rotation_timestamp", &self.public_key_rotation_timestamp);
...
pub struct MeterUsageOutput  {
    ...
    #[doc(hidden)]pub metering_record_id: std::option::Option<std::string::String>,
}
...
pub struct BatchMeterUsageOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::UsageRecordResult>>,
    ...
    #[doc(hidden)]pub unprocessed_records: std::option::Option<std::vec::Vec<crate::model::UsageRecord>>,
}
...
pub mod batch_meter_usage_output {
    ...
    impl Builder {
        ...
        /// <p>Contains all <code>UsageRecords</code> processed by <code>BatchMeterUsage</code>. These records were either honored by AWS Marketplace Metering Service or were invalid. Invalid records should be fixed before being resubmitted.</p>
        pub fn set_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::UsageRecordResult>>) -> Self {
