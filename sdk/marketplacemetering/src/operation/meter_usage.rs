...
impl MeterUsageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::meter_usage::MeterUsage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_meter_usage::ser_meter_usage_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for MeterUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_meter_usage::de_meter_usage_http_response_with_props(status, headers, body)
        }
    }
}
