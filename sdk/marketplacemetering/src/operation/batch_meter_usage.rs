...
impl BatchMeterUsageInput {
    /// Consumes the builder and constructs an Operation<[`BatchMeterUsage`](crate::operation::batch_meter_usage::BatchMeterUsage)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_meter_usage::BatchMeterUsage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_meter_usage::ser_batch_meter_usage_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_meter_usage::BatchMeterUsage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchMeterUsage", "marketplacemetering"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchMeterUsage {
    type Output =
        ::std::result::Result<crate::operation::batch_meter_usage::BatchMeterUsageOutput, crate::operation::batch_meter_usage::BatchMeterUsageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_meter_usage::de_batch_meter_usage_http_response_with_props(status, headers, body)
        }
    }
}
