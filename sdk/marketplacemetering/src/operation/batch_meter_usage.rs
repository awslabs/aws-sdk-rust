...
impl BatchMeterUsageInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_meter_usage::BatchMeterUsage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_meter_usage::BatchMeterUsageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_meter_usage::ser_batch_meter_usage_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for BatchMeterUsage {
                type Output = std::result::Result<crate::operation::batch_meter_usage::BatchMeterUsageOutput, crate::operation::batch_meter_usage::BatchMeterUsageError>;
