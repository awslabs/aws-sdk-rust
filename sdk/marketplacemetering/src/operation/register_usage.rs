...
impl RegisterUsageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_usage::RegisterUsage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_usage::ser_register_usage_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_usage::RegisterUsage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterUsage", "marketplacemetering"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterUsage {
    type Output = ::std::result::Result<crate::operation::register_usage::RegisterUsageOutput, crate::operation::register_usage::RegisterUsageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_usage::de_register_usage_http_response_with_props(status, headers, body)
        }
    }
}
