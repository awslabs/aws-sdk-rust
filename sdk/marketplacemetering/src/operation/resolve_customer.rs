...
impl ResolveCustomerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resolve_customer::ResolveCustomer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveCustomer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resolve_customer::de_resolve_customer_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::resolve_customer::ResolveCustomerError
{
