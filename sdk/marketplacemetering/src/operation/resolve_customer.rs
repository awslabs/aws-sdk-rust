...
impl ResolveCustomerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::resolve_customer::ResolveCustomer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resolve_customer::ser_resolve_customer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveCustomer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resolve_customer::de_resolve_customer_http_response_with_props(status, headers, body)
        }
    }
}
