...
mod test {
    ...
    .build().expect("invalid params");
                        ...
                        let error = endpoint.expect_err("expected error: Invalid Configuration: FIPS is not supported with CloudFront-KeyValueStore. [FIPS should error]");
                                    assert_eq!(format!("{}", error), "Invalid Configuration: FIPS is not supported with CloudFront-KeyValueStore.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: KVS ARN must be provided to use this service [KVS ARN must be provided to use this service]");
    ...
    .build().expect("invalid params");
                        ...
                        let error = endpoint.expect_err("expected error: Provided ARN is not a valid CloudFront Service ARN. Found: `notcloudfront` [Provided ARN was not a valid CloudFront Service ARN. Found: `notcloudfront`]");
                                    assert_eq!(format!("{}", error), "Provided ARN is not a valid CloudFront Service ARN. Found: `notcloudfront`")
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let error = endpoint.expect_err("expected error: ARN resource type is invalid. Expected `key-value-store`, found: `some-other-resource-type` [ARN resource type is invalid. Expected `key-value-store`, found: `some-other-resource-type`]");
                                    assert_eq!(format!("{}", error), "ARN resource type is invalid. Expected `key-value-store`, found: `some-other-resource-type`")
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let error = endpoint.expect_err("expected error: CloudFront-KeyValueStore is not supported in partition `aws-us-gov` [CloudFront-KeyValueStore is not supported in partition `aws-us-gov`]");
                                    assert_eq!(format!("{}", error), "CloudFront-KeyValueStore is not supported in partition `aws-us-gov`")
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://123456789012.cloudfront-kvs.global.api.aws");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://123456789012.cloudfront-kvs.global.api.aws")
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Client was configured for partition `aws-cn` but Kvs ARN has `aws` [Valid ARN, different partition, should error]");
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://123456789012.my-override.example.com");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://123456789012.my-override.example.com")
    .property("authSchemes", vec![::aws_smithy_types::Document::from( {
        let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
        out.insert("signingName".to_string(), "cloudfront-keyvaluestore".to_string().into());
        out.insert("name".to_string(), "sigv4a".to_string().into());
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: http://123456789012.my-override.example.com/custom-path");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("http://123456789012.my-override.example.com/custom-path")
    .property("authSchemes", vec![::aws_smithy_types::Document::from( {
        let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
        out.insert("signingName".to_string(), "cloudfront-keyvaluestore".to_string().into());
        out.insert("name".to_string(), "sigv4a".to_string().into());
    ...
    .build().expect("invalid params");
                        ...
                        let error = endpoint.expect_err("expected error: Client was configured for partition `aws-us-gov` but Kvs ARN has `aws` [Custom override with different partition should error]");
                                    assert_eq!(format!("{}", error), "Client was configured for partition `aws-us-gov` but Kvs ARN has `aws`")
                    }
