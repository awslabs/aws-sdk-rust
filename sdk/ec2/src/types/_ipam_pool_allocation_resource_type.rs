...
impl ::std::convert::From<&str> for IpamPoolAllocationResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IpamPoolAllocationResourceType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IpamPoolAllocationResourceType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IpamPoolAllocationResourceType::from(s))
    }
}
