...
///     IngestionStatus::IngestionComplete => { /* ... */ },
///     IngestionStatus::IngestionFailed => { /* ... */ },
///     IngestionStatus::InitialIngestionInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for IngestionStatus {
    fn from(s: &str) -> Self {
        match s {
            "ingestion-complete" => IngestionStatus::IngestionComplete,
            "ingestion-failed" => IngestionStatus::IngestionFailed,
            "initial-ingestion-in-progress" => IngestionStatus::InitialIngestionInProgress,
...
impl IngestionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            IngestionStatus::IngestionComplete => "ingestion-complete",
            IngestionStatus::IngestionFailed => "ingestion-failed",
            IngestionStatus::InitialIngestionInProgress => "initial-ingestion-in-progress",
