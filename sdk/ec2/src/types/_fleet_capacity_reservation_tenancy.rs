...
impl ::std::convert::From<&str> for FleetCapacityReservationTenancy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetCapacityReservationTenancy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetCapacityReservationTenancy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetCapacityReservationTenancy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FleetCapacityReservationTenancy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FleetCapacityReservationTenancy {
