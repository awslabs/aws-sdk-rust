...
impl ::std::convert::From<&str> for PlacementGroupState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PlacementGroupState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PlacementGroupState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PlacementGroupState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PlacementGroupState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
