...
impl ::std::convert::From<&str> for VerifiedAccessEndpointStatusCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VerifiedAccessEndpointStatusCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VerifiedAccessEndpointStatusCode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VerifiedAccessEndpointStatusCode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VerifiedAccessEndpointStatusCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
