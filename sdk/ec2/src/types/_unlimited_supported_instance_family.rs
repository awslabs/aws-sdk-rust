...
///     UnlimitedSupportedInstanceFamily::T8i => { /* ... */ },
...
impl ::std::convert::From<&str> for UnlimitedSupportedInstanceFamily {
    fn from(s: &str) -> Self {
        match s {
            ...
            "t8i" => UnlimitedSupportedInstanceFamily::T8i,
...
impl UnlimitedSupportedInstanceFamily {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            UnlimitedSupportedInstanceFamily::T8i => "t8i",
...
impl ::std::fmt::Display for UnlimitedSupportedInstanceFamily {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            UnlimitedSupportedInstanceFamily::T8i => write!(f, "t8i"),
