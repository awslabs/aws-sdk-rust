...
impl IpamPublicAddressAwsService {
    ...
    IpamPublicAddressAwsService::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["database-migration-service", "elastic-container-service", "global-accelerator", "load-balancer", "nat-gateway", "other", "redshift", "relational-database-service", "site-to-site-vpn"]
                }
            }
