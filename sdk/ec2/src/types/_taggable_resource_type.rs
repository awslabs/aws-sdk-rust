...
///     TaggableResourceType::AutoScalingGroup => { /* ... */ },
///     TaggableResourceType::Instance => { /* ... */ },
///     TaggableResourceType::NetworkInterface => { /* ... */ },
...
impl ::std::convert::From<&str> for TaggableResourceType {
    fn from(s: &str) -> Self {
        match s {
            "auto-scaling-group" => TaggableResourceType::AutoScalingGroup,
            "instance" => TaggableResourceType::Instance,
            "network-interface" => TaggableResourceType::NetworkInterface,
...
impl TaggableResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            TaggableResourceType::AutoScalingGroup => "auto-scaling-group",
            TaggableResourceType::Instance => "instance",
            TaggableResourceType::NetworkInterface => "network-interface",
            TaggableResourceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["auto-scaling-group", "instance", "network-interface"]
    }
}
...
impl ::std::fmt::Display for TaggableResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TaggableResourceType::AutoScalingGroup => write!(f, "auto-scaling-group"),
            TaggableResourceType::Instance => write!(f, "instance"),
            TaggableResourceType::NetworkInterface => write!(f, "network-interface"),
