...
impl ::std::convert::From<&str> for FleetOnDemandAllocationStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FleetOnDemandAllocationStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FleetOnDemandAllocationStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FleetOnDemandAllocationStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for FleetOnDemandAllocationStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
