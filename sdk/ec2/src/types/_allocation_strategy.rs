...
impl ::std::convert::From<&str> for AllocationStrategy {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AllocationStrategy::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AllocationStrategy {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AllocationStrategy::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AllocationStrategy {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
