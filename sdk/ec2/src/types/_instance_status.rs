...
/// <p>Describes the status of an instance, including system status, instance status, attached EBS status, and application status.</p>
#[non_exhaustive]
...
pub struct InstanceStatusBuilder {
    ...
    pub(crate) application_status: ::std::option::Option<crate::types::ApplicationStatusSummary>,
}
