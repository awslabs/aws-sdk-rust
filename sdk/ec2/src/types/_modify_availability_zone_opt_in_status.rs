...
impl ::std::convert::From<&str> for ModifyAvailabilityZoneOptInStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ModifyAvailabilityZoneOptInStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ModifyAvailabilityZoneOptInStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ModifyAvailabilityZoneOptInStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ModifyAvailabilityZoneOptInStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for ModifyAvailabilityZoneOptInStatus {
