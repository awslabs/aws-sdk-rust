...
impl ::std::convert::From<&str> for LocalGatewayRouteTableMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocalGatewayRouteTableMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocalGatewayRouteTableMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocalGatewayRouteTableMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocalGatewayRouteTableMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
