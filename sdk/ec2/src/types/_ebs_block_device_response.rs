...
pub struct EbsBlockDeviceResponse {
...
impl EbsBlockDeviceResponse {
    /// Creates a new builder-style object to manufacture [`EbsBlockDeviceResponse`](crate::types::EbsBlockDeviceResponse).
    pub fn builder() -> crate::types::builders::EbsBlockDeviceResponseBuilder {
        crate::types::builders::EbsBlockDeviceResponseBuilder::default()
    }
}

/// A builder for [`EbsBlockDeviceResponse`](crate::types::EbsBlockDeviceResponse).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct EbsBlockDeviceResponseBuilder {
...
impl EbsBlockDeviceResponseBuilder {
    /// <p>Indicates whether the volume is encrypted.</p>
    ...
    /// Consumes the builder and constructs a [`EbsBlockDeviceResponse`](crate::types::EbsBlockDeviceResponse).
    pub fn build(self) -> crate::types::EbsBlockDeviceResponse {
        crate::types::EbsBlockDeviceResponse {
