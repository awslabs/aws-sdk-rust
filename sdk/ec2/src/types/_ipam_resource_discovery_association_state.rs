...
impl IpamResourceDiscoveryAssociationState {
    ...
    IpamResourceDiscoveryAssociationState::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["associate-complete", "associate-failed", "associate-in-progress", "disassociate-complete", "disassociate-failed", "disassociate-in-progress", "isolate-complete", "isolate-in-progress", "restore-in-progress"]
                }
            }
