...
impl ::std::convert::From<&str> for DnsRecordIpType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DnsRecordIpType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DnsRecordIpType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DnsRecordIpType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DnsRecordIpType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
