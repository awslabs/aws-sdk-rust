...
other => UnsuccessfulInstanceCreditSpecificationErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
...
UnsuccessfulInstanceCreditSpecificationErrorCode::InstanceCreditSpecificationNotSupported => write!(f, "InstanceCreditSpecification.NotSupported"),
