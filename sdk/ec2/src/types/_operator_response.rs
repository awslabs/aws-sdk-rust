...
/// <p>Describes whether the resource is managed by an entity and, if so, describes the entity that manages it.</p>
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::fmt::Debug)]
pub struct OperatorResponse {
    /// <p>If <code>true</code>, the resource is managed by an entity.</p>
    pub managed: ::std::option::Option<bool>,
    /// <p>If <code>managed</code> is <code>true</code>, then the principal is returned. The principal is the entity that manages the resource.</p>
