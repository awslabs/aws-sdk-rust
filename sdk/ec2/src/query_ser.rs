...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_ena_srd_specification(
    mut writer: aws_smithy_query::QueryValueWriter,
    input: &crate::model::EnaSrdSpecification,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_34) = &input.ena_srd_udp_specification {
        crate::query_ser::serialize_structure_crate_model_ena_srd_udp_specification(
            scope_33, var_34,
        )?;
    }
    Ok(())
...
pub fn serialize_structure_crate_model_request_launch_template_data(
    ...
    if let Some(var_203) = &input.network_interfaces {
        let mut list_205 =
            scope_202.start_list(true, Some("InstanceNetworkInterfaceSpecification"));
    ...
    if let Some(var_226) = &input.tag_specifications {
        let mut list_228 =
            scope_225.start_list(true, Some("LaunchTemplateTagSpecificationRequest"));
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_create_verified_access_endpoint_load_balancer_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_create_verified_access_endpoint_eni_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_create_verified_access_trust_provider_oidc_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_create_verified_access_trust_provider_device_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
pub fn serialize_structure_crate_model_scheduled_instance_recurrence_request(
    ...
    if let Some(var_453) = &input.occurrence_days {
        ...
        for item_454 in var_453 {
            ...
            entry_456.number(
                #[allow(clippy::useless_conversion)]
                aws_smithy_types::Number::NegInt((*item_454).into()),
            );
        }
        list_455.finish();
    }
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_data_query(
    mut writer: aws_smithy_query::QueryValueWriter,
    input: &crate::model::DataQuery,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_client_data(
    ...
    if let Some(var_596) = &input.upload_size {
        scope_595.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_596).into()),
        );
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_modify_verified_access_endpoint_load_balancer_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_modify_verified_access_endpoint_eni_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_verified_access_log_options(
    mut writer: aws_smithy_query::QueryValueWriter,
    input: &crate::model::VerifiedAccessLogOptions,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_modify_verified_access_trust_provider_oidc_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
pub fn serialize_structure_crate_model_reserved_instance_limit_price(
    ...
    if let Some(var_878) = &input.amount {
        scope_877.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_878).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_spot_fleet_request_config_data(
    ...
    if let Some(var_903) = &input.fulfilled_capacity {
        scope_902.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_903).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_905) = &input.on_demand_fulfilled_capacity {
        scope_904.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_905).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_921) = &input.target_capacity {
        scope_920.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_921).into()),
        );
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_ena_srd_udp_specification(
    mut writer: aws_smithy_query::QueryValueWriter,
...
pub fn serialize_structure_crate_model_fleet_launch_template_overrides_request(
    ...
    if let Some(var_1222) = &input.weighted_capacity {
        scope_1221.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1222).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1224) = &input.priority {
        scope_1223.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1224).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_launch_template_instance_network_interface_specification_request(
    ...
    if let Some(var_1295) = &input.secondary_private_ip_address_count {
        scope_1294.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1295).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_launch_template_cpu_options_request(
    ...
    if let Some(var_1350) = &input.core_count {
        scope_1349.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1350).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_memory_gi_b_per_v_cpu_request(
    ...
    if let Some(var_1463) = &input.min {
        scope_1462.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1463).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_total_local_storage_gb_request(
    ...
    if let Some(var_1471) = &input.min {
        scope_1470.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1471).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1473) = &input.max {
        scope_1472.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1473).into()),
        );
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_network_bandwidth_gbps_request(
    ...
    if let Some(var_1487) = &input.min {
        scope_1486.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1487).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1489) = &input.max {
        scope_1488.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1489).into()),
        );
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_launch_template_overrides(
    ...
    if let Some(var_1551) = &input.weighted_capacity {
        scope_1550.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1551).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1553) = &input.priority {
        scope_1552.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1553).into()),
        );
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_verified_access_log_s3_destination_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_verified_access_log_cloud_watch_logs_destination_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_verified_access_log_kinesis_data_firehose_destination_options(
    mut writer: aws_smithy_query::QueryValueWriter,
...
pub fn serialize_structure_crate_model_phase1_dh_group_numbers_request_list_value(
    ...
    if let Some(var_1581) = &input.value {
        scope_1580.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1581).into()),
        );
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_spot_fleet_launch_specification(
    ...
    if let Some(var_1632) = &input.weighted_capacity {
        scope_1631.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1632).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_fleet_spot_capacity_rebalance_request(
    ...
    if let Some(var_1714) = &input.termination_delay {
        scope_1713.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1714).into()),
        );
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_instance_requirements(
    ...
    if let Some(var_1852) = &input.network_bandwidth_gbps {
        crate::query_ser::serialize_structure_crate_model_network_bandwidth_gbps(
            scope_1851, var_1852,
        )?;
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_scheduled_instances_ebs(
    ...
    if let Some(var_1896) = &input.iops {
        scope_1895.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1896).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1900) = &input.volume_size {
        scope_1899.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1900).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_memory_mi_b(
    ...
    if let Some(var_1914) = &input.min {
        scope_1913.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1914).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_memory_gi_b_per_v_cpu(
    ...
    if let Some(var_1918) = &input.min {
        scope_1917.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1918).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1920) = &input.max {
        scope_1919.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1920).into()),
        );
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_network_interface_count(
    ...
    if let Some(var_1922) = &input.min {
        scope_1921.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::NegInt((*var_1922).into()),
        );
    }
    #[allow(unused_mut)]
...
pub fn serialize_structure_crate_model_total_local_storage_gb(
    ...
    if let Some(var_1926) = &input.min {
        scope_1925.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1926).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1928) = &input.max {
        scope_1927.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1928).into()),
        );
    }
    Ok(())
}
...
#[allow(unused_mut)]
pub fn serialize_structure_crate_model_network_bandwidth_gbps(
    mut writer: aws_smithy_query::QueryValueWriter,
    ...
    if let Some(var_1942) = &input.min {
        scope_1941.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1942).into()),
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_1944) = &input.max {
        scope_1943.number(
            #[allow(clippy::useless_conversion)]
            aws_smithy_types::Number::Float((*var_1944).into()),
        );
    }
    Ok(())
}
