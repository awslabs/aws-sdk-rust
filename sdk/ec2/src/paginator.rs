            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_addresses_attribute_output_next_token(
                                    resp,
                                );
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_address_transfers_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
...
impl DescribeAwsNetworkPerformanceMetricSubscriptionsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::paginator::DescribeAwsNetworkPerformanceMetricSubscriptionsPaginatorItems {
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_byoip_cidrs_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_carrier_gateways_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_client_vpn_routes_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_coip_pools_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_dhcp_options_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_export_image_tasks_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_fleets_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_flow_logs_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_fpga_images_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_host_reservations_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_hosts_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_import_image_tasks_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_instances_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_instance_status_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_instance_types_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_internet_gateways_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_ipam_pools_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_ipam_scopes_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_ipv6_pools_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_launch_templates_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_local_gateways_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_moving_addresses_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_network_acls_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_network_interfaces_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_prefix_lists_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_principal_id_format_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_route_tables_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_scheduled_instances_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_security_groups_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_spot_fleet_requests_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_store_image_tasks_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
...
impl DescribeTransitGatewayRouteTableAnnouncementsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::paginator::DescribeTransitGatewayRouteTableAnnouncementsPaginatorItems {
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_transit_gateways_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
...
impl DescribeVerifiedAccessInstanceLoggingConfigurationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::paginator::DescribeVerifiedAccessInstanceLoggingConfigurationsPaginatorItems {
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_volume_status_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_vpc_endpoints_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_get_spot_placement_scores_output_next_token(
                                    resp,
                                );
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
...
impl DescribeAddressesAttributePaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_addresses_attribute_output_addresses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeAddressTransfersPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_address_transfers_output_address_transfers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeByoipCidrsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_byoip_cidrs_output_byoip_cidrs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeCapacityReservationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_capacity_reservations_output_capacity_reservations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeCarrierGatewaysPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_carrier_gateways_output_carrier_gateways(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeClientVpnAuthorizationRulesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_client_vpn_authorization_rules_output_authorization_rules(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeClientVpnConnectionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_client_vpn_connections_output_connections(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeClientVpnRoutesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_client_vpn_routes_output_routes(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeClientVpnTargetNetworksPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_client_vpn_target_networks_output_client_vpn_target_networks(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeCoipPoolsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_coip_pools_output_coip_pools(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeDhcpOptionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_dhcp_options_output_dhcp_options(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeExportImageTasksPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_export_image_tasks_output_export_image_tasks(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeFastSnapshotRestoresPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_fast_snapshot_restores_output_fast_snapshot_restores(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeFleetsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_fleets_output_fleets(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeFlowLogsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_flow_logs_output_flow_logs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeFpgaImagesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_fpga_images_output_fpga_images(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeHostReservationOfferingsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_host_reservation_offerings_output_offering_set(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeHostReservationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_host_reservations_output_host_reservation_set(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeHostsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_hosts_output_hosts(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeImagesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_images_output_images(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeImportImageTasksPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_import_image_tasks_output_import_image_tasks(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeImportSnapshotTasksPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_import_snapshot_tasks_output_import_snapshot_tasks(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeInstanceEventWindowsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_instance_event_windows_output_instance_event_windows(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeInstancesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_instances_output_reservations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeInstanceStatusPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_instance_status_output_instance_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeInternetGatewaysPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_internet_gateways_output_internet_gateways(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeIpamPoolsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_ipam_pools_output_ipam_pools(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeIpamScopesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_ipam_scopes_output_ipam_scopes(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeIpv6PoolsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_ipv6_pools_output_ipv6_pools(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeLaunchTemplatesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_launch_templates_output_launch_templates(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeLaunchTemplateVersionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_launch_template_versions_output_launch_template_versions(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeLocalGatewayRouteTablesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_local_gateway_route_tables_output_local_gateway_route_tables(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeLocalGatewaysPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_local_gateways_output_local_gateways(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeMovingAddressesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_moving_addresses_output_moving_address_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeNetworkAclsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_network_acls_output_network_acls(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeNetworkInsightsAnalysesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_network_insights_analyses_output_network_insights_analyses(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeNetworkInsightsPathsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_network_insights_paths_output_network_insights_paths(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeNetworkInterfacesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_network_interfaces_output_network_interfaces(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribePrefixListsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_prefix_lists_output_prefix_lists(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribePrincipalIdFormatPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_principal_id_format_output_principals(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeRouteTablesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_route_tables_output_route_tables(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeScheduledInstancesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_scheduled_instances_output_scheduled_instance_set(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeSecurityGroupRulesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_security_group_rules_output_security_group_rules(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeSecurityGroupsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_security_groups_output_security_groups(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeSnapshotsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_snapshots_output_snapshots(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeSnapshotTierStatusPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_snapshot_tier_status_output_snapshot_tier_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeSpotFleetRequestsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_spot_fleet_requests_output_spot_fleet_request_configs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeSpotInstanceRequestsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_spot_instance_requests_output_spot_instance_requests(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeStaleSecurityGroupsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_stale_security_groups_output_stale_security_group_set(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeStoreImageTasksPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_store_image_tasks_output_store_image_task_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeTrafficMirrorFiltersPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_traffic_mirror_filters_output_traffic_mirror_filters(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeTrafficMirrorSessionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_traffic_mirror_sessions_output_traffic_mirror_sessions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeTrafficMirrorTargetsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_traffic_mirror_targets_output_traffic_mirror_targets(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeTransitGatewayConnectsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_transit_gateway_connects_output_transit_gateway_connects(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
pub struct DescribeTransitGatewayPolicyTablesPaginatorItems(
...
pub struct DescribeTransitGatewayRouteTableAnnouncementsPaginatorItems(
...
impl DescribeTransitGatewaysPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_transit_gateways_output_transit_gateways(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeTrunkInterfaceAssociationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_trunk_interface_associations_output_interface_associations(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeVerifiedAccessEndpointsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_verified_access_endpoints_output_verified_access_endpoints(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeVerifiedAccessGroupsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_verified_access_groups_output_verified_access_groups(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeVerifiedAccessInstancesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_verified_access_instances_output_verified_access_instances(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
pub struct DescribeVerifiedAccessTrustProvidersPaginatorItems(
...
impl DescribeVolumesModificationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_volumes_modifications_output_volumes_modifications(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeVolumeStatusPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_volume_status_output_volume_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeVpcClassicLinkDnsSupportPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_vpc_classic_link_dns_support_output_vpcs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeVpcEndpointConnectionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_vpc_endpoint_connections_output_vpc_endpoint_connections(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeVpcEndpointsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_vpc_endpoints_output_vpc_endpoints(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl DescribeVpcEndpointServicePermissionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_vpc_endpoint_service_permissions_output_allowed_principals(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl DescribeVpcPeeringConnectionsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_vpc_peering_connections_output_vpc_peering_connections(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl GetAssociatedIpv6PoolCidrsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_associated_ipv6_pool_cidrs_output_ipv6_cidr_associations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl GetAwsNetworkPerformanceDataPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_aws_network_performance_data_output_data_responses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl GetManagedPrefixListAssociationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_managed_prefix_list_associations_output_prefix_list_associations(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl GetManagedPrefixListEntriesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_managed_prefix_list_entries_output_entries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl GetSpotPlacementScoresPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_spot_placement_scores_output_spot_placement_scores(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl GetTransitGatewayRouteTableAssociationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_transit_gateway_route_table_associations_output_associations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl GetVpnConnectionDeviceTypesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_vpn_connection_device_types_output_vpn_connection_device_types(
                page,
            )
            .unwrap_or_default()
            .into_iter()
...
impl ListImagesInRecycleBinPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_images_in_recycle_bin_output_images(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListSnapshotsInRecycleBinPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_snapshots_in_recycle_bin_output_snapshots(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl SearchTransitGatewayMulticastGroupsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_search_transit_gateway_multicast_groups_output_multicast_groups(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
