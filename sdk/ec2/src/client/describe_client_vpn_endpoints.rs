...
impl super::Client {
    ...
    pub fn describe_client_vpn_endpoints(
        &self,
    ) -> crate::operation::describe_client_vpn_endpoints::builders::DescribeClientVpnEndpointsFluentBuilder {
