...
impl super::Client {
    ...
    ///   - [`fpga_image_id(impl ::std::convert::Into<String>)`](crate::operation::describe_fpga_image_attribute::builders::DescribeFpgaImageAttributeFluentBuilder::fpga_image_id) / [`set_fpga_image_id(Option<String>)`](crate::operation::describe_fpga_image_attribute::builders::DescribeFpgaImageAttributeFluentBuilder::set_fpga_image_id): <p>The ID of the AFI.</p>
