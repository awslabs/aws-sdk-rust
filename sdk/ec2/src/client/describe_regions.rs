...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::set_filters): <p>The filters.</p>  <ul>   <li> <p> <code>endpoint</code> - The endpoint of the Region (for example, <code>ec2.us-east-1.amazonaws.com</code>).</p> </li>   <li> <p> <code>opt-in-status</code> - The opt-in status of the Region (<code>opt-in-not-required</code> | <code>opted-in</code> | <code>not-opted-in</code>).</p> </li>   <li> <p> <code>region-name</code> - The name of the Region (for example, <code>us-east-1</code>).</p> </li>  </ul>
    ///   - [`region_names(impl Into<String>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::region_names) / [`set_region_names(Option<Vec<String>>)`](crate::operation::describe_regions::builders::DescribeRegionsFluentBuilder::set_region_names): <p>The names of the Regions. You can specify any Regions, whether they are enabled and disabled for your account.</p>
