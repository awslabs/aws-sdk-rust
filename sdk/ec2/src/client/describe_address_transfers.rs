...
impl super::Client {
    ...
    ///   - [`allocation_ids(impl Into<String>)`](crate::operation::describe_address_transfers::builders::DescribeAddressTransfersFluentBuilder::allocation_ids) / [`set_allocation_ids(Option<Vec<String>>)`](crate::operation::describe_address_transfers::builders::DescribeAddressTransfersFluentBuilder::set_allocation_ids): <p>The allocation IDs of Elastic IP addresses.</p>
