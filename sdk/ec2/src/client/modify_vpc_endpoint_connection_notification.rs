...
impl super::Client  {
    ...
    pub fn modify_vpc_endpoint_connection_notification(&self) -> crate::client::fluent_builders::ModifyVpcEndpointConnectionNotification {
                                crate::client::fluent_builders::ModifyVpcEndpointConnectionNotification::new(self.handle.clone())
                            }
}
