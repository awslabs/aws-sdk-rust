...
impl super::Client {
    ...
    ///   - [`verified_access_group_ids(Vec<String>)`](crate::operation::describe_verified_access_groups::builders::DescribeVerifiedAccessGroupsFluentBuilder::verified_access_group_ids) / [`set_verified_access_group_ids(Option<Vec<String>>)`](crate::operation::describe_verified_access_groups::builders::DescribeVerifiedAccessGroupsFluentBuilder::set_verified_access_group_ids): <p>The ID of the Verified Access groups.</p>
    ///   - [`verified_access_instance_id(impl ::std::convert::Into<String>)`](crate::operation::describe_verified_access_groups::builders::DescribeVerifiedAccessGroupsFluentBuilder::verified_access_instance_id) / [`set_verified_access_instance_id(Option<String>)`](crate::operation::describe_verified_access_groups::builders::DescribeVerifiedAccessGroupsFluentBuilder::set_verified_access_instance_id): <p>The ID of the Verified Access instance.</p>
