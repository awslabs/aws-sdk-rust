...
impl super::Client  {
    ...
    pub fn describe_client_vpn_routes(&self) -> crate::client::fluent_builders::DescribeClientVpnRoutes {
                                crate::client::fluent_builders::DescribeClientVpnRoutes::new(self.handle.clone())
                            }
}
