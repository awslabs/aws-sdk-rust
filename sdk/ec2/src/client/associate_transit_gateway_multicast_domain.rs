...
impl super::Client {
    ...
    ///   - [`subnet_ids(Vec<String>)`](crate::operation::associate_transit_gateway_multicast_domain::builders::AssociateTransitGatewayMulticastDomainFluentBuilder::subnet_ids) / [`set_subnet_ids(Option<Vec<String>>)`](crate::operation::associate_transit_gateway_multicast_domain::builders::AssociateTransitGatewayMulticastDomainFluentBuilder::set_subnet_ids): <p>The IDs of the subnets to associate with the transit gateway multicast domain.</p>
