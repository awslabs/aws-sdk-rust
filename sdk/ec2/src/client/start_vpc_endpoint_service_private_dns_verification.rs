...
impl super::Client {
    ...
    pub fn start_vpc_endpoint_service_private_dns_verification(
        &self,
    ) -> crate::client::fluent_builders::StartVpcEndpointServicePrivateDnsVerification {
        crate::client::fluent_builders::StartVpcEndpointServicePrivateDnsVerification::new(
            self.handle.clone(),
        )
    }
}
