...
impl super::Client  {
    ...
    pub fn get_network_insights_access_scope_analysis_findings(&self) -> crate::client::fluent_builders::GetNetworkInsightsAccessScopeAnalysisFindings {
                                crate::client::fluent_builders::GetNetworkInsightsAccessScopeAnalysisFindings::new(self.handle.clone())
                            }
}
