...
impl super::Client {
    ...
    ///   - [`transit_gateway_policy_table_id(impl ::std::convert::Into<String>)`](crate::operation::get_transit_gateway_policy_table_entries::builders::GetTransitGatewayPolicyTableEntriesFluentBuilder::transit_gateway_policy_table_id) / [`set_transit_gateway_policy_table_id(Option<String>)`](crate::operation::get_transit_gateway_policy_table_entries::builders::GetTransitGatewayPolicyTableEntriesFluentBuilder::set_transit_gateway_policy_table_id): <p>The ID of the transit gateway policy table.</p>
    ///   - [`filters(Vec<Filter>)`](crate::operation::get_transit_gateway_policy_table_entries::builders::GetTransitGatewayPolicyTableEntriesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::get_transit_gateway_policy_table_entries::builders::GetTransitGatewayPolicyTableEntriesFluentBuilder::set_filters): <p>The filters associated with the transit gateway policy table.</p>
