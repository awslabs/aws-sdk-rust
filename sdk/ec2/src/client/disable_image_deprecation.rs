...
impl super::Client {
    ...
    ///   - [`image_id(impl ::std::convert::Into<String>)`](crate::operation::disable_image_deprecation::builders::DisableImageDeprecationFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::disable_image_deprecation::builders::DisableImageDeprecationFluentBuilder::set_image_id): <p>The ID of the AMI.</p>
