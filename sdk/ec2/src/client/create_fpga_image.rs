...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_fpga_image::builders::CreateFpgaImageFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_fpga_image::builders::CreateFpgaImageFluentBuilder::set_description): <p>A description for the AFI.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_fpga_image::builders::CreateFpgaImageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_fpga_image::builders::CreateFpgaImageFluentBuilder::set_name): <p>A name for the AFI.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_fpga_image::builders::CreateFpgaImageFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_fpga_image::builders::CreateFpgaImageFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Run_Instance_Idempotency.html">Ensuring Idempotency</a>.</p>
