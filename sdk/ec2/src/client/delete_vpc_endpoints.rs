...
impl super::Client {
    ...
    ///   - [`vpc_endpoint_ids(impl Into<String>)`](crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsFluentBuilder::vpc_endpoint_ids) / [`set_vpc_endpoint_ids(Option<Vec<String>>)`](crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsFluentBuilder::set_vpc_endpoint_ids): <p>The IDs of the VPC endpoints.</p>
