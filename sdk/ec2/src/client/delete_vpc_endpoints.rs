...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ///   - [`vpc_endpoint_ids(impl Into<String>)`](crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsFluentBuilder::vpc_endpoint_ids) / [`set_vpc_endpoint_ids(Option<Vec::<String>>)`](crate::operation::delete_vpc_endpoints::builders::DeleteVpcEndpointsFluentBuilder::set_vpc_endpoint_ids):<br>required: **true**<br><p>The IDs of the VPC endpoints.</p><br>
