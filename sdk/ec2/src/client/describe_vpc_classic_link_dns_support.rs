...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::set_next_token): <p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>
    ///   - [`vpc_ids(impl Into<String>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::vpc_ids) / [`set_vpc_ids(Option<Vec<String>>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::set_vpc_ids): <p>The IDs of the VPCs.</p>
