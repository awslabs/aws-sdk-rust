...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::set_max_results): <p>The maximum number of items to return for this request. To get the next page of items, make another request with the token returned in the output. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Query-Requests.html#api-pagination">Pagination</a>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::set_next_token): <p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>
    ///   - [`vpc_ids(Vec<String>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::vpc_ids) / [`set_vpc_ids(Option<Vec<String>>)`](crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportFluentBuilder::set_vpc_ids): <p>The IDs of the VPCs.</p>
