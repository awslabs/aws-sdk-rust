...
impl super::Client  {
    ...
    pub fn deregister_instance_event_notification_attributes(&self) -> crate::client::fluent_builders::DeregisterInstanceEventNotificationAttributes {
                                crate::client::fluent_builders::DeregisterInstanceEventNotificationAttributes::new(self.handle.clone())
                            }
}
