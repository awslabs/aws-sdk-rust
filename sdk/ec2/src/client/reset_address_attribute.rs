...
impl super::Client {
    ...
    ///   - [`allocation_id(impl ::std::convert::Into<String>)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::set_allocation_id): <p>[EC2-VPC] The allocation ID.</p>
