...
impl super::Client {
    ...
    ///   - [`allocation_id(impl Into<String>)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::set_allocation_id):<br>required: **true**<br><p>[EC2-VPC] The allocation ID.</p><br>
    ///   - [`attribute(AddressAttributeName)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::attribute) / [`set_attribute(Option<AddressAttributeName>)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::set_attribute):<br>required: **true**<br><p>The attribute of the IP address.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::reset_address_attribute::builders::ResetAddressAttributeFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
