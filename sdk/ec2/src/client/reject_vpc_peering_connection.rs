...
impl super::Client  {
    ...
    pub fn reject_vpc_peering_connection(&self) -> crate::client::fluent_builders::RejectVpcPeeringConnection {
                                crate::client::fluent_builders::RejectVpcPeeringConnection::new(self.handle.clone())
                            }
}
