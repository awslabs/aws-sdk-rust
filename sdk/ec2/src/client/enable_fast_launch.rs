...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::enable_fast_launch::builders::EnableFastLaunchFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::enable_fast_launch::builders::EnableFastLaunchFluentBuilder::set_dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ...
    ///   - [`max_parallel_launches(Option<i32>)`](crate::operation::enable_fast_launch::EnableFastLaunchOutput::max_parallel_launches): <p>The maximum number of parallel instances to launch for creating resources.</p>
