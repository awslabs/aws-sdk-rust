...
impl super::Client {
    ...
    ///   - [`branch_interface_id(impl ::std::convert::Into<String>)`](crate::operation::associate_trunk_interface::builders::AssociateTrunkInterfaceFluentBuilder::branch_interface_id) / [`set_branch_interface_id(Option<String>)`](crate::operation::associate_trunk_interface::builders::AssociateTrunkInterfaceFluentBuilder::set_branch_interface_id): <p>The ID of the branch network interface.</p>
    ///   - [`trunk_interface_id(impl ::std::convert::Into<String>)`](crate::operation::associate_trunk_interface::builders::AssociateTrunkInterfaceFluentBuilder::trunk_interface_id) / [`set_trunk_interface_id(Option<String>)`](crate::operation::associate_trunk_interface::builders::AssociateTrunkInterfaceFluentBuilder::set_trunk_interface_id): <p>The ID of the trunk network interface.</p>
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::associate_trunk_interface::builders::AssociateTrunkInterfaceFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::associate_trunk_interface::builders::AssociateTrunkInterfaceFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Run_Instance_Idempotency.html">How to Ensure Idempotency</a>.</p>
