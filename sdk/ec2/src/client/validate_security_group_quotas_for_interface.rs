...
impl super::Client {
    ...
    ///   - [`valid(Option<bool>)`](crate::operation::validate_security_group_quotas_for_interface::ValidateSecurityGroupQuotasForInterfaceOutput::valid): <p>Specifies whether the specified security groups can be associated with a single network interface without exceeding the quotas. If associating the security groups would exceed a quota, the operation returns an error.</p>
