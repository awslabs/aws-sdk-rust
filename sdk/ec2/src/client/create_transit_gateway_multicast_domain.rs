...
impl super::Client  {
    ...
    pub fn create_transit_gateway_multicast_domain(&self) -> crate::client::fluent_builders::CreateTransitGatewayMulticastDomain {
                                crate::client::fluent_builders::CreateTransitGatewayMulticastDomain::new(self.handle.clone())
                            }
}
