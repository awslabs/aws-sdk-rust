...
impl super::Client {
    ...
    ///   - [`transit_gateway_id(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::transit_gateway_id) / [`set_transit_gateway_id(Option<String>)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::set_transit_gateway_id): <p>The ID of the transit gateway.</p>
    ///   - [`options(CreateTransitGatewayMulticastDomainRequestOptions)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::options) / [`set_options(Option<CreateTransitGatewayMulticastDomainRequestOptions>)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::set_options): <p>The options for the transit gateway multicast domain.</p>
    ///   - [`tag_specifications(Vec<TagSpecification>)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::tag_specifications) / [`set_tag_specifications(Option<Vec<TagSpecification>>)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::set_tag_specifications): <p>The tags for the transit gateway multicast domain.</p>
    ///   - [`dry_run(bool)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::create_transit_gateway_multicast_domain::builders::CreateTransitGatewayMulticastDomainFluentBuilder::set_dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
