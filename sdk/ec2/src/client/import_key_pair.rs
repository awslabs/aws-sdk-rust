...
impl super::Client {
    ...
    ///   - [`key_name(impl ::std::convert::Into<String>)`](crate::operation::import_key_pair::builders::ImportKeyPairFluentBuilder::key_name) / [`set_key_name(Option<String>)`](crate::operation::import_key_pair::builders::ImportKeyPairFluentBuilder::set_key_name): <p>A unique name for the key pair.</p>
