...
impl super::Client {
    ...
    ///   - [`association_id(impl Into<String>)`](crate::operation::disassociate_iam_instance_profile::builders::DisassociateIamInstanceProfileFluentBuilder::association_id) / [`set_association_id(Option<String>)`](crate::operation::disassociate_iam_instance_profile::builders::DisassociateIamInstanceProfileFluentBuilder::set_association_id):<br>required: **true**<br><p>The ID of the IAM instance profile association.</p><br>
