...
impl super::Client  {
    ...
    pub fn disassociate_enclave_certificate_iam_role(&self) -> crate::client::fluent_builders::DisassociateEnclaveCertificateIamRole {
                                crate::client::fluent_builders::DisassociateEnclaveCertificateIamRole::new(self.handle.clone())
                            }
}
