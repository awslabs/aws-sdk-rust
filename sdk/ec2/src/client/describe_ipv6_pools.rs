...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_ipv6_pools::builders::DescribeIpv6PoolsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_ipv6_pools::builders::DescribeIpv6PoolsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
