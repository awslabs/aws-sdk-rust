...
impl super::Client {
    ...
    pub fn enable_vpc_classic_link(
        &self,
    ) -> crate::operation::enable_vpc_classic_link::builders::EnableVpcClassicLinkFluentBuilder
    {
        crate::operation::enable_vpc_classic_link::builders::EnableVpcClassicLinkFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
