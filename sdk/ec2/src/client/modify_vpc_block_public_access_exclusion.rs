...
impl super::Client {
    ...
    ///   - [`internet_gateway_exclusion_mode(InternetGatewayExclusionMode)`](crate::operation::modify_vpc_block_public_access_exclusion::builders::ModifyVpcBlockPublicAccessExclusionFluentBuilder::internet_gateway_exclusion_mode) / [`set_internet_gateway_exclusion_mode(Option<InternetGatewayExclusionMode>)`](crate::operation::modify_vpc_block_public_access_exclusion::builders::ModifyVpcBlockPublicAccessExclusionFluentBuilder::set_internet_gateway_exclusion_mode):<br>required: **true**<br><p>The exclusion mode for internet gateway traffic.</p> <ul>  <li>   <p><code>bidirectional-access-allowed</code>: Allow all internet traffic to and from the excluded VPCs and subnets.</p></li>  <li>   <p><code>egress-access-allowed</code>: Allow outbound internet traffic from the excluded VPCs and subnets. Block inbound internet traffic to the excluded VPCs and subnets. Only applies when VPC Block Public Access is set to Bidirectional.</p></li> </ul><br>
