...
impl super::Client  {
    ...
    pub fn delete_vpc_endpoint_service_configurations(&self) -> crate::client::fluent_builders::DeleteVpcEndpointServiceConfigurations {
                                crate::client::fluent_builders::DeleteVpcEndpointServiceConfigurations::new(self.handle.clone())
                            }
}
