...
impl super::Client {
    ...
    pub fn describe_local_gateway_route_table_vpc_associations(
        &self,
    ) -> crate::client::fluent_builders::DescribeLocalGatewayRouteTableVpcAssociations {
        crate::client::fluent_builders::DescribeLocalGatewayRouteTableVpcAssociations::new(
            self.handle.clone(),
        )
    }
}
