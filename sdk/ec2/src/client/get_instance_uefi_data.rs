...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::get_instance_uefi_data::builders::GetInstanceUefiDataFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::get_instance_uefi_data::builders::GetInstanceUefiDataFluentBuilder::set_instance_id):<br>required: **true**<br><p>The ID of the instance from which to retrieve the UEFI data.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::get_instance_uefi_data::builders::GetInstanceUefiDataFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::get_instance_uefi_data::builders::GetInstanceUefiDataFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the operation, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
