...
impl super::Client {
    ...
    ///   - [`verified_access_instance(Option<VerifiedAccessInstance>)`](crate::operation::create_verified_access_instance::CreateVerifiedAccessInstanceOutput::verified_access_instance): <p>Details about the Verified Access instance.</p>
