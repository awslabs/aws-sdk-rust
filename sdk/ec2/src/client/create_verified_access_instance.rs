...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::set_description): <p>A description for the Verified Access instance.</p>
    ...
    ///   - [`fips_enabled(bool)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::fips_enabled) / [`set_fips_enabled(Option<bool>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::set_fips_enabled): <p>Enable or disable support for Federal Information Processing Standards (FIPS) on the instance.</p>
