...
impl super::Client {
    ...
    pub fn describe_verified_access_instance_logging_configurations(
        &self,
    ) -> crate::client::fluent_builders::DescribeVerifiedAccessInstanceLoggingConfigurations {
        crate::client::fluent_builders::DescribeVerifiedAccessInstanceLoggingConfigurations::new(
            self.handle.clone(),
        )
    }
}
