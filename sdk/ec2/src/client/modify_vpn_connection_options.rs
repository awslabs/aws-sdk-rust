...
impl super::Client  {
    ...
    pub fn modify_vpn_connection_options(&self) -> crate::client::fluent_builders::ModifyVpnConnectionOptions {
                                crate::client::fluent_builders::ModifyVpnConnectionOptions::new(self.handle.clone())
                            }
}
