...
impl super::Client  {
    ...
    pub fn enable_aws_network_performance_metric_subscription(&self) -> crate::client::fluent_builders::EnableAwsNetworkPerformanceMetricSubscription {
                                crate::client::fluent_builders::EnableAwsNetworkPerformanceMetricSubscription::new(self.handle.clone())
                            }
}
