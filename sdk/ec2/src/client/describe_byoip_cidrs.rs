...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_byoip_cidrs::builders::DescribeByoipCidrsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_byoip_cidrs::builders::DescribeByoipCidrsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
    ...
    pub fn describe_byoip_cidrs(
        &self,
    ) -> crate::operation::describe_byoip_cidrs::builders::DescribeByoipCidrsFluentBuilder {
        crate::operation::describe_byoip_cidrs::builders::DescribeByoipCidrsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
