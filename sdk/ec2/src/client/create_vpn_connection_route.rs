...
impl super::Client {
    ...
    ///   - [`destination_cidr_block(impl ::std::convert::Into<String>)`](crate::operation::create_vpn_connection_route::builders::CreateVpnConnectionRouteFluentBuilder::destination_cidr_block) / [`set_destination_cidr_block(Option<String>)`](crate::operation::create_vpn_connection_route::builders::CreateVpnConnectionRouteFluentBuilder::set_destination_cidr_block): <p>The CIDR block associated with the local subnet of the customer network.</p>
