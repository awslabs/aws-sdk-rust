...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::enable_ebs_encryption_by_default::builders::EnableEbsEncryptionByDefaultFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::enable_ebs_encryption_by_default::builders::EnableEbsEncryptionByDefaultFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ...
    pub fn enable_ebs_encryption_by_default(
        &self,
    ) -> crate::operation::enable_ebs_encryption_by_default::builders::EnableEbsEncryptionByDefaultFluentBuilder {
