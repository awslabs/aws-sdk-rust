...
impl super::Client {
    ...
    ///   - [`service_id(impl ::std::convert::Into<String>)`](crate::operation::modify_vpc_endpoint_service_payer_responsibility::builders::ModifyVpcEndpointServicePayerResponsibilityFluentBuilder::service_id) / [`set_service_id(Option<String>)`](crate::operation::modify_vpc_endpoint_service_payer_responsibility::builders::ModifyVpcEndpointServicePayerResponsibilityFluentBuilder::set_service_id): <p>The ID of the service.</p>
