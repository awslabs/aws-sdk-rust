...
impl super::Client  {
    ...
    pub fn create_instance_export_task(&self) -> crate::client::fluent_builders::CreateInstanceExportTask {
                                crate::client::fluent_builders::CreateInstanceExportTask::new(self.handle.clone())
                            }
}
