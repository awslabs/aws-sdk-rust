...
impl super::Client {
    ...
    ///   - [`fleet_id(impl ::std::convert::Into<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_fleet_id): <p>The ID of the EC2 Fleet.</p>
    ...
    ///   - [`context(impl ::std::convert::Into<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::context) / [`set_context(Option<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_context): <p>Reserved.</p>
