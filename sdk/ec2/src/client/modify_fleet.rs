...
impl super::Client {
    ...
    ///   - [`excess_capacity_termination_policy(FleetExcessCapacityTerminationPolicy)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::excess_capacity_termination_policy) / [`set_excess_capacity_termination_policy(Option<FleetExcessCapacityTerminationPolicy>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_excess_capacity_termination_policy):<br>required: **false**<br><p>Indicates whether running instances should be terminated if the total target capacity of the EC2 Fleet is decreased below the current size of the EC2 Fleet.</p> <p>Supported only for fleets of type <code>maintain</code>.</p><br>
    ///   - [`launch_template_configs(FleetLaunchTemplateConfigRequest)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::launch_template_configs) / [`set_launch_template_configs(Option<Vec::<FleetLaunchTemplateConfigRequest>>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_launch_template_configs):<br>required: **false**<br><p>The launch template and overrides.</p><br>
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_fleet_id):<br>required: **true**<br><p>The ID of the EC2 Fleet.</p><br>
    ///   - [`target_capacity_specification(TargetCapacitySpecificationRequest)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::target_capacity_specification) / [`set_target_capacity_specification(Option<TargetCapacitySpecificationRequest>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_target_capacity_specification):<br>required: **false**<br><p>The size of the EC2 Fleet.</p><br>
    ///   - [`context(impl Into<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::context) / [`set_context(Option<String>)`](crate::operation::modify_fleet::builders::ModifyFleetFluentBuilder::set_context):<br>required: **false**<br><p>Reserved.</p><br>
