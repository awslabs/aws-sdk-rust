...
impl super::Client  {
    ...
    pub fn describe_instance_event_notification_attributes(&self) -> crate::client::fluent_builders::DescribeInstanceEventNotificationAttributes {
                                crate::client::fluent_builders::DescribeInstanceEventNotificationAttributes::new(self.handle.clone())
                            }
}
