...
impl super::Client {
    ...
    ///   - [`s3_object_tags(S3ObjectTag)`](crate::operation::create_store_image_task::builders::CreateStoreImageTaskFluentBuilder::s3_object_tags) / [`set_s3_object_tags(Option<Vec<S3ObjectTag>>)`](crate::operation::create_store_image_task::builders::CreateStoreImageTaskFluentBuilder::set_s3_object_tags): <p>The tags to apply to the AMI object that will be stored in the Amazon S3 bucket. </p>
