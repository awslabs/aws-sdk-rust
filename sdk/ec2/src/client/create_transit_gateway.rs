...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_transit_gateway::builders::CreateTransitGatewayFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_transit_gateway::builders::CreateTransitGatewayFluentBuilder::set_description):<br>required: **false**<br><p>A description of the transit gateway.</p><br>
