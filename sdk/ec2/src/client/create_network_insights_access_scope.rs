...
impl super::Client  {
    ...
    pub fn create_network_insights_access_scope(&self) -> crate::client::fluent_builders::CreateNetworkInsightsAccessScope {
                                crate::client::fluent_builders::CreateNetworkInsightsAccessScope::new(self.handle.clone())
                            }
}
