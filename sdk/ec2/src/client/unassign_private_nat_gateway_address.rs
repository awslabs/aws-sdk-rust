...
impl super::Client {
    ...
    ///   - [`nat_gateway_id(impl ::std::convert::Into<String>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::nat_gateway_id) / [`set_nat_gateway_id(Option<String>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::set_nat_gateway_id): <p>The ID of the NAT gateway.</p>
