...
impl super::Client {
    ...
    ///   - [`nat_gateway_id(impl Into<String>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::nat_gateway_id) / [`set_nat_gateway_id(Option<String>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::set_nat_gateway_id):<br>required: **true**<br><p>The ID of the NAT gateway.</p><br>
    ///   - [`private_ip_addresses(impl Into<String>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::private_ip_addresses) / [`set_private_ip_addresses(Option<Vec::<String>>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::set_private_ip_addresses):<br>required: **true**<br><p>The private IPv4 addresses you want to unassign.</p><br>
    ///   - [`max_drain_duration_seconds(i32)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::max_drain_duration_seconds) / [`set_max_drain_duration_seconds(Option<i32>)`](crate::operation::unassign_private_nat_gateway_address::builders::UnassignPrivateNatGatewayAddressFluentBuilder::set_max_drain_duration_seconds):<br>required: **false**<br><p>The maximum amount of time to wait (in seconds) before forcibly releasing the IP addresses if connections are still in progress. Default value is 350 seconds.</p><br>
