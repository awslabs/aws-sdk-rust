...
impl super::Client  {
    ...
    pub fn disable_transit_gateway_route_table_propagation(&self) -> crate::client::fluent_builders::DisableTransitGatewayRouteTablePropagation {
                                crate::client::fluent_builders::DisableTransitGatewayRouteTablePropagation::new(self.handle.clone())
                            }
}
