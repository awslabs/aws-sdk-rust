...
impl super::Client {
    ...
    ///   - [`add_network_services(TrafficMirrorNetworkService)`](crate::operation::modify_traffic_mirror_filter_network_services::builders::ModifyTrafficMirrorFilterNetworkServicesFluentBuilder::add_network_services) / [`set_add_network_services(Option<Vec::<TrafficMirrorNetworkService>>)`](crate::operation::modify_traffic_mirror_filter_network_services::builders::ModifyTrafficMirrorFilterNetworkServicesFluentBuilder::set_add_network_services):<br>required: **false**<br><p>The network service, for example Amazon DNS, that you want to mirror.</p><br>
    ///   - [`remove_network_services(TrafficMirrorNetworkService)`](crate::operation::modify_traffic_mirror_filter_network_services::builders::ModifyTrafficMirrorFilterNetworkServicesFluentBuilder::remove_network_services) / [`set_remove_network_services(Option<Vec::<TrafficMirrorNetworkService>>)`](crate::operation::modify_traffic_mirror_filter_network_services::builders::ModifyTrafficMirrorFilterNetworkServicesFluentBuilder::set_remove_network_services):<br>required: **false**<br><p>The network service, for example Amazon DNS, that you no longer want to mirror.</p><br>
