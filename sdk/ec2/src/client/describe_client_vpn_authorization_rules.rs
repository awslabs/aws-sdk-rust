...
impl super::Client {
    ...
    ///   - [`client_vpn_endpoint_id(impl Into<String>)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::client_vpn_endpoint_id) / [`set_client_vpn_endpoint_id(Option<String>)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::set_client_vpn_endpoint_id): <p>The ID of the Client VPN endpoint.</p>
    ///   - [`dry_run(bool)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::set_dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::set_filters): <p>One or more filters. Filter names and values are case-sensitive.</p>  <ul>   <li> <p> <code>description</code> - The description of the authorization rule.</p> </li>   <li> <p> <code>destination-cidr</code> - The CIDR of the network to which the authorization rule applies.</p> </li>   <li> <p> <code>group-id</code> - The ID of the Active Directory group to which the authorization rule grants access.</p> </li>  </ul>
    ///   - [`max_results(i32)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesFluentBuilder::set_max_results): <p>The maximum number of results to return for the request in a single page. The remaining results can be seen by sending another request with the nextToken value.</p>
