...
impl super::Client  {
    ...
    pub fn describe_client_vpn_authorization_rules(&self) -> crate::client::fluent_builders::DescribeClientVpnAuthorizationRules {
                                crate::client::fluent_builders::DescribeClientVpnAuthorizationRules::new(self.handle.clone())
                            }
}
