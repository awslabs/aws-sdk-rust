...
impl super::Client {
    ...
    ///   - [`public_ipv4_pool(impl Into<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::public_ipv4_pool) / [`set_public_ipv4_pool(Option<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::set_public_ipv4_pool):<br>required: **false**<br><p>The ID of a public IPv4 pool. A public IPv4 pool is a pool of IPv4 addresses that you've brought to Amazon Web Services with BYOIP.</p><br>
