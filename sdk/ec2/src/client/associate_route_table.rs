...
impl super::Client {
    ...
    ///   - [`route_table_id(impl ::std::convert::Into<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::route_table_id) / [`set_route_table_id(Option<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::set_route_table_id): <p>The ID of the route table.</p>
    ///   - [`subnet_id(impl ::std::convert::Into<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::subnet_id) / [`set_subnet_id(Option<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::set_subnet_id): <p>The ID of the subnet.</p>
    ///   - [`gateway_id(impl ::std::convert::Into<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::gateway_id) / [`set_gateway_id(Option<String>)`](crate::operation::associate_route_table::builders::AssociateRouteTableFluentBuilder::set_gateway_id): <p>The ID of the internet gateway or virtual private gateway.</p>
