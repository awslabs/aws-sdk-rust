...
impl super::Client {
    ...
    ///   - [`vpc_endpoint_ids(impl Into<String>)`](crate::operation::accept_vpc_endpoint_connections::builders::AcceptVpcEndpointConnectionsFluentBuilder::vpc_endpoint_ids) / [`set_vpc_endpoint_ids(Option<Vec<String>>)`](crate::operation::accept_vpc_endpoint_connections::builders::AcceptVpcEndpointConnectionsFluentBuilder::set_vpc_endpoint_ids): <p>The IDs of the interface VPC endpoints.</p>
