...
impl super::Client {
    ...
    pub fn reject_transit_gateway_multicast_domain_associations(
        &self,
    ) -> crate::client::fluent_builders::RejectTransitGatewayMulticastDomainAssociations {
        crate::client::fluent_builders::RejectTransitGatewayMulticastDomainAssociations::new(
            self.handle.clone(),
        )
    }
}
