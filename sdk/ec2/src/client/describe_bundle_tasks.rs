...
impl super::Client  {
    ...
    pub fn describe_bundle_tasks(&self) -> crate::client::fluent_builders::DescribeBundleTasks {
                                crate::client::fluent_builders::DescribeBundleTasks::new(self.handle.clone())
                            }
}
