...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::send_diagnostic_interrupt::builders::SendDiagnosticInterruptFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::send_diagnostic_interrupt::builders::SendDiagnosticInterruptFluentBuilder::set_instance_id): <p>The ID of the instance.</p>
