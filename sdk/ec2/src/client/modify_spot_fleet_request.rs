...
impl super::Client {
    ...
    ///   - [`context(impl Into<String>)`](crate::operation::modify_spot_fleet_request::builders::ModifySpotFleetRequestFluentBuilder::context) / [`set_context(Option<String>)`](crate::operation::modify_spot_fleet_request::builders::ModifySpotFleetRequestFluentBuilder::set_context): <p>Reserved.</p>
