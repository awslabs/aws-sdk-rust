...
impl super::Client {
    ...
    ///   - [`source_dest_check(impl Into<String>)`](crate::operation::reset_network_interface_attribute::builders::ResetNetworkInterfaceAttributeFluentBuilder::source_dest_check) / [`set_source_dest_check(Option<String>)`](crate::operation::reset_network_interface_attribute::builders::ResetNetworkInterfaceAttributeFluentBuilder::set_source_dest_check):<br>required: **false**<br><p>The source/destination checking attribute. Resets the value to <code>true</code>.</p><br>
