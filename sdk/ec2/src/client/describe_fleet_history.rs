...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::set_next_token): <p>The token returned from a previous paginated request. Pagination continues from the end of the items returned by the previous request.</p>
    ///   - [`fleet_id(impl ::std::convert::Into<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::set_fleet_id): <p>The ID of the EC2 Fleet.</p>
