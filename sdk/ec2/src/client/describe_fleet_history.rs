...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::describe_fleet_history::builders::DescribeFleetHistoryFluentBuilder::set_fleet_id): <p>The ID of the EC2 Fleet.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::describe_fleet_history::DescribeFleetHistoryOutput::next_token): <p>The token for the next set of results.</p>
