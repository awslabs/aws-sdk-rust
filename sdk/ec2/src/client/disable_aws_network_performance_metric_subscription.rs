...
impl super::Client  {
    ...
    pub fn disable_aws_network_performance_metric_subscription(&self) -> crate::client::fluent_builders::DisableAwsNetworkPerformanceMetricSubscription {
                                crate::client::fluent_builders::DisableAwsNetworkPerformanceMetricSubscription::new(self.handle.clone())
                            }
}
