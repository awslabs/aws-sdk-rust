...
impl super::Client {
    ...
    ///   - [`filters(Vec<Filter>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::set_filters): <p>One or more filters.</p>  <ul>   <li> <p> <code>moving-status</code> - The status of the Elastic IP address (<code>MovingToVpc</code> | <code>RestoringToClassic</code>).</p> </li>  </ul>
    ///   - [`dry_run(bool)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::set_dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::set_max_results): <p>The maximum number of results to return for the request in a single page. The remaining results of the initial request can be seen by sending another request with the returned <code>NextToken</code> value. This value can be between 5 and 1000; if <code>MaxResults</code> is given a value outside of this range, an error is returned.</p>  <p>Default: If no value is provided, the default is 1000.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
    ///   - [`public_ips(Vec<String>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::public_ips) / [`set_public_ips(Option<Vec<String>>)`](crate::operation::describe_moving_addresses::builders::DescribeMovingAddressesFluentBuilder::set_public_ips): <p>One or more Elastic IP addresses.</p>
