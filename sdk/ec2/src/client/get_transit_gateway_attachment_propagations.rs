...
impl super::Client  {
    ...
    pub fn get_transit_gateway_attachment_propagations(&self) -> crate::client::fluent_builders::GetTransitGatewayAttachmentPropagations {
                                crate::client::fluent_builders::GetTransitGatewayAttachmentPropagations::new(self.handle.clone())
                            }
}
