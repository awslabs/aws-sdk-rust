...
impl super::Client {
    ...
    ///   - [`allocation_id(impl ::std::convert::Into<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::set_allocation_id): <p>The allocation ID of an Elastic IP address.</p>
    ///   - [`transfer_account_id(impl ::std::convert::Into<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::transfer_account_id) / [`set_transfer_account_id(Option<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::set_transfer_account_id): <p>The ID of the account that you want to transfer the Elastic IP address to.</p>
