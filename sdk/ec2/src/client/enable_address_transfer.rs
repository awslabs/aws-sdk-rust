...
impl super::Client {
    ...
    ///   - [`allocation_id(impl Into<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::set_allocation_id):<br>required: **true**<br><p>The allocation ID of an Elastic IP address.</p><br>
    ///   - [`transfer_account_id(impl Into<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::transfer_account_id) / [`set_transfer_account_id(Option<String>)`](crate::operation::enable_address_transfer::builders::EnableAddressTransferFluentBuilder::set_transfer_account_id):<br>required: **true**<br><p>The ID of the account that you want to transfer the Elastic IP address to.</p><br>
