...
impl super::Client {
    ...
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::unmonitor_instances::builders::UnmonitorInstancesFluentBuilder::instance_ids) / [`set_instance_ids(Option<Vec<String>>)`](crate::operation::unmonitor_instances::builders::UnmonitorInstancesFluentBuilder::set_instance_ids): <p>The IDs of the instances.</p>
