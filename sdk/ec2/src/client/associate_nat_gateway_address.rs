...
impl super::Client {
    ...
    ///   - [`nat_gateway_id(Option<String>)`](crate::operation::associate_nat_gateway_address::AssociateNatGatewayAddressOutput::nat_gateway_id): <p>The NAT gateway ID.</p>
