...
impl super::Client {
    ...
    pub fn create_public_ipv4_pool(&self) -> crate::client::fluent_builders::CreatePublicIpv4Pool {
        crate::client::fluent_builders::CreatePublicIpv4Pool::new(self.handle.clone())
    }
}
