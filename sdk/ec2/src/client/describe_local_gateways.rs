...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_local_gateways::builders::DescribeLocalGatewaysFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_local_gateways::builders::DescribeLocalGatewaysFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
