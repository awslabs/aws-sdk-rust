...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::set_dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ///   - [`peer_owner_id(impl Into<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::peer_owner_id) / [`set_peer_owner_id(Option<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::set_peer_owner_id): <p>The Amazon Web Services account ID of the owner of the accepter VPC.</p>  <p>Default: Your Amazon Web Services account ID</p>
    ///   - [`peer_vpc_id(impl Into<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::peer_vpc_id) / [`set_peer_vpc_id(Option<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::set_peer_vpc_id): <p>The ID of the VPC with which you are creating the VPC peering connection. You must specify this parameter in the request.</p>
    ///   - [`vpc_id(impl Into<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::vpc_id) / [`set_vpc_id(Option<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::set_vpc_id): <p>The ID of the requester VPC. You must specify this parameter in the request.</p>
    ///   - [`peer_region(impl Into<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::peer_region) / [`set_peer_region(Option<String>)`](crate::operation::create_vpc_peering_connection::builders::CreateVpcPeeringConnectionFluentBuilder::set_peer_region): <p>The Region code for the accepter VPC, if the accepter VPC is located in a Region other than the Region in which you make the request.</p>  <p>Default: The Region in which you make the request.</p>
