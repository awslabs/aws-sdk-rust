...
impl super::Client {
    ...
    ///   - [`public_ip(impl ::std::convert::Into<String>)`](crate::operation::move_address_to_vpc::builders::MoveAddressToVpcFluentBuilder::public_ip) / [`set_public_ip(Option<String>)`](crate::operation::move_address_to_vpc::builders::MoveAddressToVpcFluentBuilder::set_public_ip): <p>The Elastic IP address.</p>
