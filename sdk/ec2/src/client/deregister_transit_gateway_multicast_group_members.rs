...
impl super::Client  {
    ...
    pub fn deregister_transit_gateway_multicast_group_members(&self) -> crate::client::fluent_builders::DeregisterTransitGatewayMulticastGroupMembers {
                                crate::client::fluent_builders::DeregisterTransitGatewayMulticastGroupMembers::new(self.handle.clone())
                            }
}
