...
impl super::Client {
    ...
    ///   - [`fpga_image_id(impl ::std::convert::Into<String>)`](crate::operation::reset_fpga_image_attribute::builders::ResetFpgaImageAttributeFluentBuilder::fpga_image_id) / [`set_fpga_image_id(Option<String>)`](crate::operation::reset_fpga_image_attribute::builders::ResetFpgaImageAttributeFluentBuilder::set_fpga_image_id): <p>The ID of the AFI.</p>
