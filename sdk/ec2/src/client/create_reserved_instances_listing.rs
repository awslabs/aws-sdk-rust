...
impl super::Client  {
    ...
    pub fn create_reserved_instances_listing(&self) -> crate::client::fluent_builders::CreateReservedInstancesListing {
                                crate::client::fluent_builders::CreateReservedInstancesListing::new(self.handle.clone())
                            }
}
