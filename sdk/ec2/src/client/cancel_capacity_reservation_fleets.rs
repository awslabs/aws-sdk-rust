...
impl super::Client {
    ...
    ///   - [`capacity_reservation_fleet_ids(impl Into<String>)`](crate::operation::cancel_capacity_reservation_fleets::builders::CancelCapacityReservationFleetsFluentBuilder::capacity_reservation_fleet_ids) / [`set_capacity_reservation_fleet_ids(Option<Vec<String>>)`](crate::operation::cancel_capacity_reservation_fleets::builders::CancelCapacityReservationFleetsFluentBuilder::set_capacity_reservation_fleet_ids): <p>The IDs of the Capacity Reservation Fleets to cancel.</p>
