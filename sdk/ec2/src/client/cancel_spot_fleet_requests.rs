...
impl super::Client {
    ...
    ///   - [`spot_fleet_request_ids(impl Into<String>)`](crate::operation::cancel_spot_fleet_requests::builders::CancelSpotFleetRequestsFluentBuilder::spot_fleet_request_ids) / [`set_spot_fleet_request_ids(Option<Vec<String>>)`](crate::operation::cancel_spot_fleet_requests::builders::CancelSpotFleetRequestsFluentBuilder::set_spot_fleet_request_ids): <p>The IDs of the Spot Fleet requests.</p>
    ///   - [`terminate_instances(bool)`](crate::operation::cancel_spot_fleet_requests::builders::CancelSpotFleetRequestsFluentBuilder::terminate_instances) / [`set_terminate_instances(Option<bool>)`](crate::operation::cancel_spot_fleet_requests::builders::CancelSpotFleetRequestsFluentBuilder::set_terminate_instances): <p>Indicates whether to terminate the associated instances when the Spot Fleet request is canceled. The default is to terminate the instances.</p>  <p>To let the instances continue to run after the Spot Fleet request is canceled, specify <code>no-terminate-instances</code>.</p>
