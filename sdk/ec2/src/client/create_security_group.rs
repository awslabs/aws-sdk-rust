...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_security_group::builders::CreateSecurityGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_security_group::builders::CreateSecurityGroupFluentBuilder::set_description): <p>A description for the security group.</p>  <p>Constraints: Up to 255 characters in length</p>  <p>Valid characters: a-z, A-Z, 0-9, spaces, and ._-:/()#,@[]+=&amp;;{}!$*</p>
    ...
    ///   - [`vpc_id(impl Into<String>)`](crate::operation::create_security_group::builders::CreateSecurityGroupFluentBuilder::vpc_id) / [`set_vpc_id(Option<String>)`](crate::operation::create_security_group::builders::CreateSecurityGroupFluentBuilder::set_vpc_id): <p>The ID of the VPC. Required for a nondefault VPC.</p>
