...
impl super::Client {
    ...
    ///   - [`group_name(impl Into<String>)`](crate::operation::create_security_group::builders::CreateSecurityGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::create_security_group::builders::CreateSecurityGroupFluentBuilder::set_group_name):<br>required: **true**<br><p>The name of the security group. Names are case-insensitive and must be unique within the VPC.</p> <p>Constraints: Up to 255 characters in length. Can't start with <code>sg-</code>.</p> <p>Valid characters: a-z, A-Z, 0-9, spaces, and ._-:/()#,@\[\]+=&amp;;{}!$*</p><br>
    ...
    ///   - [`security_group_arn(Option<String>)`](crate::operation::create_security_group::CreateSecurityGroupOutput::security_group_arn): <p>The security group ARN.</p>
