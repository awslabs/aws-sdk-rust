...
impl super::Client  {
    ...
    pub fn describe_aws_network_performance_metric_subscriptions(&self) -> crate::client::fluent_builders::DescribeAwsNetworkPerformanceMetricSubscriptions {
                                crate::client::fluent_builders::DescribeAwsNetworkPerformanceMetricSubscriptions::new(self.handle.clone())
                            }
}
