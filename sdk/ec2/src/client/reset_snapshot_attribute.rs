...
impl super::Client {
    ...
    ///   - [`snapshot_id(impl Into<String>)`](crate::operation::reset_snapshot_attribute::builders::ResetSnapshotAttributeFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::reset_snapshot_attribute::builders::ResetSnapshotAttributeFluentBuilder::set_snapshot_id):<br>required: **true**<br><p>The ID of the snapshot.</p><br>
