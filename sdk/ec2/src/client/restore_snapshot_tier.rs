...
impl super::Client {
    ...
    pub fn restore_snapshot_tier(&self) -> crate::client::fluent_builders::RestoreSnapshotTier {
        crate::client::fluent_builders::RestoreSnapshotTier::new(self.handle.clone())
    }
}
