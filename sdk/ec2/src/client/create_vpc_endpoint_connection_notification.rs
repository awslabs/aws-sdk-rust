...
impl super::Client  {
    ...
    pub fn create_vpc_endpoint_connection_notification(&self) -> crate::client::fluent_builders::CreateVpcEndpointConnectionNotification {
                                crate::client::fluent_builders::CreateVpcEndpointConnectionNotification::new(self.handle.clone())
                            }
}
