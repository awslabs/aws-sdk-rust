...
impl super::Client  {
    ...
    pub fn disassociate_transit_gateway_policy_table(&self) -> crate::client::fluent_builders::DisassociateTransitGatewayPolicyTable {
                                crate::client::fluent_builders::DisassociateTransitGatewayPolicyTable::new(self.handle.clone())
                            }
}
