...
impl super::Client {
    ...
    pub fn accept_transit_gateway_multicast_domain_associations(
        &self,
    ) -> crate::client::fluent_builders::AcceptTransitGatewayMulticastDomainAssociations {
        crate::client::fluent_builders::AcceptTransitGatewayMulticastDomainAssociations::new(
            self.handle.clone(),
        )
    }
}
