...
impl super::Client {
    ...
    ///   - [`verified_access_endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointFluentBuilder::verified_access_endpoint_id) / [`set_verified_access_endpoint_id(Option<String>)`](crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointFluentBuilder::set_verified_access_endpoint_id): <p>The ID of the Verified Access endpoint.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointFluentBuilder::set_client_token): <p>A unique, case-sensitive token that you provide to ensure idempotency of your modification request. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html">Ensuring Idempotency</a>.</p>
