...
impl super::Client  {
    ...
    ///   - [`verified_access_endpoint_id(impl Into<String>)`](crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointFluentBuilder::verified_access_endpoint_id) / [`set_verified_access_endpoint_id(Option<String>)`](crate::operation::delete_verified_access_endpoint::builders::DeleteVerifiedAccessEndpointFluentBuilder::set_verified_access_endpoint_id): <p>The ID of the Verified Access endpoint.</p>
