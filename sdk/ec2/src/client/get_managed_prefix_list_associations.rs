...
impl super::Client {
    ...
    ///   - [`prefix_list_id(impl ::std::convert::Into<String>)`](crate::operation::get_managed_prefix_list_associations::builders::GetManagedPrefixListAssociationsFluentBuilder::prefix_list_id) / [`set_prefix_list_id(Option<String>)`](crate::operation::get_managed_prefix_list_associations::builders::GetManagedPrefixListAssociationsFluentBuilder::set_prefix_list_id): <p>The ID of the prefix list.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_managed_prefix_list_associations::builders::GetManagedPrefixListAssociationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_managed_prefix_list_associations::builders::GetManagedPrefixListAssociationsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
