...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ///   - [`public_ip(impl Into<String>)`](crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicFluentBuilder::public_ip) / [`set_public_ip(Option<String>)`](crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicFluentBuilder::set_public_ip):<br>required: **true**<br><p>The Elastic IP address.</p><br>
