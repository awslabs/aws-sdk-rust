...
impl super::Client {
    ...
    pub fn import_client_vpn_client_certificate_revocation_list(
        &self,
    ) -> crate::client::fluent_builders::ImportClientVpnClientCertificateRevocationList {
        crate::client::fluent_builders::ImportClientVpnClientCertificateRevocationList::new(
            self.handle.clone(),
        )
    }
}
