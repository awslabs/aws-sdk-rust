...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_fleets::builders::DescribeFleetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_fleets::builders::DescribeFleetsFluentBuilder::set_max_results): <p>The maximum number of results to return in a single call. Specify a value between 1 and 1000. The default value is 1000. To retrieve the remaining results, make another call with the returned <code>NextToken</code> value.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_fleets::builders::DescribeFleetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_fleets::builders::DescribeFleetsFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::describe_fleets::DescribeFleetsOutput::next_token): <p>The token for the next set of results.</p>
