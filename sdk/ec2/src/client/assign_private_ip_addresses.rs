...
impl super::Client  {
    ...
    pub fn assign_private_ip_addresses(&self) -> crate::client::fluent_builders::AssignPrivateIpAddresses {
                                crate::client::fluent_builders::AssignPrivateIpAddresses::new(self.handle.clone())
                            }
}
