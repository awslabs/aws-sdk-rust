...
impl super::Client  {
    ...
    pub fn associate_client_vpn_target_network(&self) -> crate::client::fluent_builders::AssociateClientVpnTargetNetwork {
                                crate::client::fluent_builders::AssociateClientVpnTargetNetwork::new(self.handle.clone())
                            }
}
