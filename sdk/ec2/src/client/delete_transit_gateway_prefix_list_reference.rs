...
impl super::Client  {
    ...
    pub fn delete_transit_gateway_prefix_list_reference(&self) -> crate::client::fluent_builders::DeleteTransitGatewayPrefixListReference {
                                crate::client::fluent_builders::DeleteTransitGatewayPrefixListReference::new(self.handle.clone())
                            }
}
