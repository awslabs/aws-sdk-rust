...
impl super::Client {
    ...
    ///   - [`transit_gateway_route_table_id(impl ::std::convert::Into<String>)`](crate::operation::delete_transit_gateway_prefix_list_reference::builders::DeleteTransitGatewayPrefixListReferenceFluentBuilder::transit_gateway_route_table_id) / [`set_transit_gateway_route_table_id(Option<String>)`](crate::operation::delete_transit_gateway_prefix_list_reference::builders::DeleteTransitGatewayPrefixListReferenceFluentBuilder::set_transit_gateway_route_table_id): <p>The ID of the route table.</p>
    ///   - [`prefix_list_id(impl ::std::convert::Into<String>)`](crate::operation::delete_transit_gateway_prefix_list_reference::builders::DeleteTransitGatewayPrefixListReferenceFluentBuilder::prefix_list_id) / [`set_prefix_list_id(Option<String>)`](crate::operation::delete_transit_gateway_prefix_list_reference::builders::DeleteTransitGatewayPrefixListReferenceFluentBuilder::set_prefix_list_id): <p>The ID of the prefix list.</p>
