...
impl super::Client {
    ...
    ///   - [`instance_connect_endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::delete_instance_connect_endpoint::builders::DeleteInstanceConnectEndpointFluentBuilder::instance_connect_endpoint_id) / [`set_instance_connect_endpoint_id(Option<String>)`](crate::operation::delete_instance_connect_endpoint::builders::DeleteInstanceConnectEndpointFluentBuilder::set_instance_connect_endpoint_id): <p>The ID of the EC2 Instance Connect Endpoint to delete.</p>
