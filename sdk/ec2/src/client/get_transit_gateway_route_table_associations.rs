...
impl super::Client  {
    ...
    pub fn get_transit_gateway_route_table_associations(&self) -> crate::client::fluent_builders::GetTransitGatewayRouteTableAssociations {
                                crate::client::fluent_builders::GetTransitGatewayRouteTableAssociations::new(self.handle.clone())
                            }
}
