...
impl super::Client  {
    ...
    pub fn delete_local_gateway_route_table_virtual_interface_group_association(&self) -> crate::client::fluent_builders::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociation {
