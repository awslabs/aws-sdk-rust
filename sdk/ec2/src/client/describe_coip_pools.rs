...
impl super::Client {
    ...
    ///   - [`pool_ids(impl Into<String>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::pool_ids) / [`set_pool_ids(Option<Vec<String>>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::set_pool_ids): <p>The IDs of the address pools.</p>
