...
impl super::Client {
    ...
    ///   - [`associated_resource(Option<String>)`](crate::operation::detach_volume::DetachVolumeOutput::associated_resource): <p>The ARN of the Amazon Web Services-managed resource to which the volume is attached.</p>
    ///   - [`instance_owning_service(Option<String>)`](crate::operation::detach_volume::DetachVolumeOutput::instance_owning_service): <p>The service principal of the Amazon Web Services service that owns the underlying resource to which the volume is attached.</p> <p>This parameter is returned only for volumes that are attached to Amazon Web Services-managed resources.</p>
    ///   - [`volume_id(Option<String>)`](crate::operation::detach_volume::DetachVolumeOutput::volume_id): <p>The ID of the volume.</p>
    ///   - [`instance_id(Option<String>)`](crate::operation::detach_volume::DetachVolumeOutput::instance_id): <p>The ID of the instance.</p> <p>If the volume is attached to an Amazon Web Services-managed resource, this parameter returns <code>null</code>.</p>
    ///   - [`device(Option<String>)`](crate::operation::detach_volume::DetachVolumeOutput::device): <p>The device name.</p> <p>If the volume is attached to an Amazon Web Services-managed resource, this parameter returns <code>null</code>.</p>
