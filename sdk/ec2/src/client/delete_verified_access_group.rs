...
impl super::Client {
    ...
    ///   - [`verified_access_group_id(impl Into<String>)`](crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupFluentBuilder::verified_access_group_id) / [`set_verified_access_group_id(Option<String>)`](crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupFluentBuilder::set_verified_access_group_id): <p>The ID of the Verified Access group.</p>
