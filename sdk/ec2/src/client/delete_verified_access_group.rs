...
impl super::Client {
    ...
    ///   - [`verified_access_group_id(impl ::std::convert::Into<String>)`](crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupFluentBuilder::verified_access_group_id) / [`set_verified_access_group_id(Option<String>)`](crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupFluentBuilder::set_verified_access_group_id): <p>The ID of the Verified Access group.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_verified_access_group::builders::DeleteVerifiedAccessGroupFluentBuilder::set_client_token): <p>A unique, case-sensitive token that you provide to ensure idempotency of your modification request. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html">Ensuring Idempotency</a>.</p>
