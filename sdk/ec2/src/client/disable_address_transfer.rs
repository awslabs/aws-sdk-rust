...
impl super::Client {
    ...
    ///   - [`allocation_id(impl Into<String>)`](crate::operation::disable_address_transfer::builders::DisableAddressTransferFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::disable_address_transfer::builders::DisableAddressTransferFluentBuilder::set_allocation_id):<br>required: **true**<br><p>The allocation ID of an Elastic IP address.</p><br>
