...
impl super::Client {
    ...
    ///   - [`cidr(impl ::std::convert::Into<String>)`](crate::operation::delete_coip_cidr::builders::DeleteCoipCidrFluentBuilder::cidr) / [`set_cidr(Option<String>)`](crate::operation::delete_coip_cidr::builders::DeleteCoipCidrFluentBuilder::set_cidr): <p> A customer-owned IP address range that you want to delete. </p>
    ///   - [`coip_pool_id(impl ::std::convert::Into<String>)`](crate::operation::delete_coip_cidr::builders::DeleteCoipCidrFluentBuilder::coip_pool_id) / [`set_coip_pool_id(Option<String>)`](crate::operation::delete_coip_cidr::builders::DeleteCoipCidrFluentBuilder::set_coip_pool_id): <p> The ID of the customer-owned address pool. </p>
