...
impl super::Client  {
    ...
    pub fn modify_availability_zone_group(&self) -> crate::client::fluent_builders::ModifyAvailabilityZoneGroup {
                                crate::client::fluent_builders::ModifyAvailabilityZoneGroup::new(self.handle.clone())
                            }
}
