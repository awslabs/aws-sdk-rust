...
impl super::Client  {
    ...
    pub fn modify_identity_id_format(&self) -> crate::client::fluent_builders::ModifyIdentityIdFormat {
                                crate::client::fluent_builders::ModifyIdentityIdFormat::new(self.handle.clone())
                            }
}
