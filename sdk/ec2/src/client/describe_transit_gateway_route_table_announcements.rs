...
impl super::Client  {
    ...
    pub fn describe_transit_gateway_route_table_announcements(&self) -> crate::client::fluent_builders::DescribeTransitGatewayRouteTableAnnouncements {
                                crate::client::fluent_builders::DescribeTransitGatewayRouteTableAnnouncements::new(self.handle.clone())
                            }
}
