...
impl super::Client  {
    ...
    pub fn accept_transit_gateway_peering_attachment(&self) -> crate::client::fluent_builders::AcceptTransitGatewayPeeringAttachment {
                                crate::client::fluent_builders::AcceptTransitGatewayPeeringAttachment::new(self.handle.clone())
                            }
}
