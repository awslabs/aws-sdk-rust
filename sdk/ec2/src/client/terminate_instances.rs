...
impl super::Client {
    ...
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::instance_ids) / [`set_instance_ids(Option<Vec::<String>>)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::set_instance_ids):<br>required: **true**<br><p>The IDs of the instances.</p> <p>Constraints: Up to 1000 instance IDs. We recommend breaking up this request into smaller batches.</p><br>
    ///   - [`force(bool)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::force) / [`set_force(Option<bool>)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::set_force):<br>required: **false**<br><p>Forces the instances to terminate. The instance will first attempt a graceful shutdown, which includes flushing file system caches and metadata. If the graceful shutdown fails to complete within the timeout period, the instance shuts down forcibly without flushing the file system caches and metadata.</p><br>
    ///   - [`skip_os_shutdown(bool)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::skip_os_shutdown) / [`set_skip_os_shutdown(Option<bool>)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::set_skip_os_shutdown):<br>required: **false**<br><p>Specifies whether to bypass the graceful OS shutdown process when the instance is terminated.</p> <p>Default: <code>false</code></p><br>
