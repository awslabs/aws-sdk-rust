...
impl super::Client {
    ...
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::instance_ids) / [`set_instance_ids(Option<Vec<String>>)`](crate::operation::terminate_instances::builders::TerminateInstancesFluentBuilder::set_instance_ids): <p>The IDs of the instances.</p>  <p>Constraints: Up to 1000 instance IDs. We recommend breaking up this request into smaller batches.</p>
