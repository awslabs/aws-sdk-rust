...
impl super::Client {
    ...
    ///   - [`coip_pool_id(impl ::std::convert::Into<String>)`](crate::operation::delete_coip_pool::builders::DeleteCoipPoolFluentBuilder::coip_pool_id) / [`set_coip_pool_id(Option<String>)`](crate::operation::delete_coip_pool::builders::DeleteCoipPoolFluentBuilder::set_coip_pool_id): <p>The ID of the CoIP pool that you want to delete. </p>
