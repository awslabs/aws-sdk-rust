...
impl super::Client {
    ...
    ///   - [`coip_pool_id(impl Into<String>)`](crate::operation::delete_coip_pool::builders::DeleteCoipPoolFluentBuilder::coip_pool_id) / [`set_coip_pool_id(Option<String>)`](crate::operation::delete_coip_pool::builders::DeleteCoipPoolFluentBuilder::set_coip_pool_id):<br>required: **true**<br><p>The ID of the CoIP pool that you want to delete.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::delete_coip_pool::builders::DeleteCoipPoolFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::delete_coip_pool::builders::DeleteCoipPoolFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
