...
impl super::Client {
    ...
    ///   - [`ebs_card_index(i32)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::ebs_card_index) / [`set_ebs_card_index(Option<i32>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::set_ebs_card_index):<br>required: **false**<br><p>The index of the EBS card. Some instance types support multiple EBS cards. The default EBS card index is 0.</p><br>
    ...
    ///   - [`ebs_card_index(Option<i32>)`](crate::operation::attach_volume::AttachVolumeOutput::ebs_card_index): <p>The index of the EBS card. Some instance types support multiple EBS cards. The default EBS card index is 0.</p>
