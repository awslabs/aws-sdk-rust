...
impl super::Client {
    ...
    ///   - [`reserved_instances_id(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::reserved_instances_id) / [`set_reserved_instances_id(Option<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::set_reserved_instances_id): <p>One or more Reserved Instance IDs.</p>
    ///   - [`reserved_instances_listing_id(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::reserved_instances_listing_id) / [`set_reserved_instances_listing_id(Option<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::set_reserved_instances_listing_id): <p>One or more Reserved Instance listing IDs.</p>
