...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::filters) / [`set_filters(Option<Vec::<Filter>>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::set_filters):<br>required: **false**<br><p>One or more filters.</p> <ul>  <li>   <p><code>reserved-instances-id</code> - The ID of the Reserved Instances.</p></li>  <li>   <p><code>reserved-instances-listing-id</code> - The ID of the Reserved Instances listing.</p></li>  <li>   <p><code>status</code> - The status of the Reserved Instance listing (<code>pending</code> | <code>active</code> | <code>cancelled</code> | <code>closed</code>).</p></li>  <li>   <p><code>status-message</code> - The reason for the status.</p></li> </ul><br>
    ///   - [`reserved_instances_id(impl Into<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::reserved_instances_id) / [`set_reserved_instances_id(Option<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::set_reserved_instances_id):<br>required: **false**<br><p>One or more Reserved Instance IDs.</p><br>
    ///   - [`reserved_instances_listing_id(impl Into<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::reserved_instances_listing_id) / [`set_reserved_instances_listing_id(Option<String>)`](crate::operation::describe_reserved_instances_listings::builders::DescribeReservedInstancesListingsFluentBuilder::set_reserved_instances_listing_id):<br>required: **false**<br><p>One or more Reserved Instance listing IDs.</p><br>
