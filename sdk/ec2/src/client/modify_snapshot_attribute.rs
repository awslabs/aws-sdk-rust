...
impl super::Client {
    ...
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::modify_snapshot_attribute::builders::ModifySnapshotAttributeFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::modify_snapshot_attribute::builders::ModifySnapshotAttributeFluentBuilder::set_snapshot_id): <p>The ID of the snapshot.</p>
