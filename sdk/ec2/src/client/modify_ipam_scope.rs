...
impl super::Client {
    ...
    ///   - [`ipam_scope_id(impl Into<String>)`](crate::operation::modify_ipam_scope::builders::ModifyIpamScopeFluentBuilder::ipam_scope_id) / [`set_ipam_scope_id(Option<String>)`](crate::operation::modify_ipam_scope::builders::ModifyIpamScopeFluentBuilder::set_ipam_scope_id):<br>required: **true**<br><p>The ID of the scope you want to modify.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::modify_ipam_scope::builders::ModifyIpamScopeFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::modify_ipam_scope::builders::ModifyIpamScopeFluentBuilder::set_description):<br>required: **false**<br><p>The description of the scope you want to modify.</p><br>
