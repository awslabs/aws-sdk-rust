...
impl super::Client {
    ...
    ///   - [`vpc_id(impl ::std::convert::Into<String>)`](crate::operation::detach_vpn_gateway::builders::DetachVpnGatewayFluentBuilder::vpc_id) / [`set_vpc_id(Option<String>)`](crate::operation::detach_vpn_gateway::builders::DetachVpnGatewayFluentBuilder::set_vpc_id): <p>The ID of the VPC.</p>
    ///   - [`vpn_gateway_id(impl ::std::convert::Into<String>)`](crate::operation::detach_vpn_gateway::builders::DetachVpnGatewayFluentBuilder::vpn_gateway_id) / [`set_vpn_gateway_id(Option<String>)`](crate::operation::detach_vpn_gateway::builders::DetachVpnGatewayFluentBuilder::set_vpn_gateway_id): <p>The ID of the virtual private gateway.</p>
