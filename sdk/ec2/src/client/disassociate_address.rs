...
impl super::Client {
    ...
    ///   - [`association_id(impl Into<String>)`](crate::operation::disassociate_address::builders::DisassociateAddressFluentBuilder::association_id) / [`set_association_id(Option<String>)`](crate::operation::disassociate_address::builders::DisassociateAddressFluentBuilder::set_association_id): <p>The association ID. This parameter is required.</p>
    ///   - [`public_ip(impl Into<String>)`](crate::operation::disassociate_address::builders::DisassociateAddressFluentBuilder::public_ip) / [`set_public_ip(Option<String>)`](crate::operation::disassociate_address::builders::DisassociateAddressFluentBuilder::set_public_ip): <p>Deprecated.</p>
