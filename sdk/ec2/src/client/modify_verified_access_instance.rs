...
impl super::Client {
    ...
    ///   - [`cidr_endpoints_custom_sub_domain(impl Into<String>)`](crate::operation::modify_verified_access_instance::builders::ModifyVerifiedAccessInstanceFluentBuilder::cidr_endpoints_custom_sub_domain) / [`set_cidr_endpoints_custom_sub_domain(Option<String>)`](crate::operation::modify_verified_access_instance::builders::ModifyVerifiedAccessInstanceFluentBuilder::set_cidr_endpoints_custom_sub_domain):<br>required: **false**<br><p>The custom subdomain.</p><br>
