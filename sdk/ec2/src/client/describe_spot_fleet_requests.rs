...
impl super::Client  {
    ...
    pub fn describe_spot_fleet_requests(&self) -> crate::client::fluent_builders::DescribeSpotFleetRequests {
                                crate::client::fluent_builders::DescribeSpotFleetRequests::new(self.handle.clone())
                            }
}
