...
impl super::Client {
    ...
    ///   - [`transit_gateway_policy_table_ids(impl Into<String>)`](crate::operation::describe_transit_gateway_policy_tables::builders::DescribeTransitGatewayPolicyTablesFluentBuilder::transit_gateway_policy_table_ids) / [`set_transit_gateway_policy_table_ids(Option<Vec<String>>)`](crate::operation::describe_transit_gateway_policy_tables::builders::DescribeTransitGatewayPolicyTablesFluentBuilder::set_transit_gateway_policy_table_ids): <p>The IDs of the transit gateway policy tables.</p>
    ///   - [`filters(Filter)`](crate::operation::describe_transit_gateway_policy_tables::builders::DescribeTransitGatewayPolicyTablesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_transit_gateway_policy_tables::builders::DescribeTransitGatewayPolicyTablesFluentBuilder::set_filters): <p>The filters associated with the transit gateway policy table.</p>
