...
impl super::Client {
    ...
    ///   - [`gateway_id(impl ::std::convert::Into<String>)`](crate::operation::disable_vgw_route_propagation::builders::DisableVgwRoutePropagationFluentBuilder::gateway_id) / [`set_gateway_id(Option<String>)`](crate::operation::disable_vgw_route_propagation::builders::DisableVgwRoutePropagationFluentBuilder::set_gateway_id): <p>The ID of the virtual private gateway.</p>
    ///   - [`route_table_id(impl ::std::convert::Into<String>)`](crate::operation::disable_vgw_route_propagation::builders::DisableVgwRoutePropagationFluentBuilder::route_table_id) / [`set_route_table_id(Option<String>)`](crate::operation::disable_vgw_route_propagation::builders::DisableVgwRoutePropagationFluentBuilder::set_route_table_id): <p>The ID of the route table.</p>
