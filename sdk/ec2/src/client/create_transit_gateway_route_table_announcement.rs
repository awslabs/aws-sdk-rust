...
impl super::Client {
    ...
    ///   - [`transit_gateway_route_table_id(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementFluentBuilder::transit_gateway_route_table_id) / [`set_transit_gateway_route_table_id(Option<String>)`](crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementFluentBuilder::set_transit_gateway_route_table_id): <p>The ID of the transit gateway route table.</p>
    ///   - [`peering_attachment_id(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementFluentBuilder::peering_attachment_id) / [`set_peering_attachment_id(Option<String>)`](crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementFluentBuilder::set_peering_attachment_id): <p>The ID of the peering attachment.</p>
    ///   - [`tag_specifications(Vec<TagSpecification>)`](crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementFluentBuilder::tag_specifications) / [`set_tag_specifications(Option<Vec<TagSpecification>>)`](crate::operation::create_transit_gateway_route_table_announcement::builders::CreateTransitGatewayRouteTableAnnouncementFluentBuilder::set_tag_specifications): <p>The tags specifications applied to the transit gateway route table announcement.</p>
