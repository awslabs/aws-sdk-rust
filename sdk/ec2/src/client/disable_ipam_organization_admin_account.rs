...
impl super::Client  {
    ...
    pub fn disable_ipam_organization_admin_account(&self) -> crate::client::fluent_builders::DisableIpamOrganizationAdminAccount {
                                crate::client::fluent_builders::DisableIpamOrganizationAdminAccount::new(self.handle.clone())
                            }
}
