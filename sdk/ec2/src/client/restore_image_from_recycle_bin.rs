...
impl super::Client {
    ...
    ///   - [`image_id(impl ::std::convert::Into<String>)`](crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinFluentBuilder::set_image_id): <p>The ID of the AMI to restore.</p>
