...
impl super::Client {
    ...
    ///   - [`image_id(impl Into<String>)`](crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinFluentBuilder::set_image_id):<br>required: **true**<br><p>The ID of the AMI to restore.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::restore_image_from_recycle_bin::builders::RestoreImageFromRecycleBinFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
