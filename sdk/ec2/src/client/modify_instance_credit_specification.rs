...
impl super::Client {
    ...
    ///   - [`instance_credit_specifications(InstanceCreditSpecificationRequest)`](crate::operation::modify_instance_credit_specification::builders::ModifyInstanceCreditSpecificationFluentBuilder::instance_credit_specifications) / [`set_instance_credit_specifications(Option<Vec<InstanceCreditSpecificationRequest>>)`](crate::operation::modify_instance_credit_specification::builders::ModifyInstanceCreditSpecificationFluentBuilder::set_instance_credit_specifications): <p>Information about the credit option for CPU usage.</p>
