...
impl super::Client  {
    ...
    pub fn create_traffic_mirror_filter(&self) -> crate::client::fluent_builders::CreateTrafficMirrorFilter {
                                crate::client::fluent_builders::CreateTrafficMirrorFilter::new(self.handle.clone())
                            }
}
