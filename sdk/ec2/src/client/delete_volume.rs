...
impl super::Client {
    ...
    ///   - [`volume_id(impl Into<String>)`](crate::operation::delete_volume::builders::DeleteVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::delete_volume::builders::DeleteVolumeFluentBuilder::set_volume_id):<br>required: **true**<br><p>The ID of the volume.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::delete_volume::builders::DeleteVolumeFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::delete_volume::builders::DeleteVolumeFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
