...
impl super::Client  {
    ...
    pub fn describe_public_ipv4_pools(&self) -> crate::client::fluent_builders::DescribePublicIpv4Pools {
                                crate::client::fluent_builders::DescribePublicIpv4Pools::new(self.handle.clone())
                            }
}
