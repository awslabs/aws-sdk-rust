...
impl super::Client {
    ...
    ///   - [`filters(Vec<Filter>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_filters): <p>One or more filters for the request. For more information about filtering, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-filter.html">Filtering CLI output</a>.</p>
    ///   - [`max_results(i32)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_max_results): <p>The maximum number of results to return in the request.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
    ///   - [`ipam_scope_id(impl Into<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::ipam_scope_id) / [`set_ipam_scope_id(Option<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_ipam_scope_id): <p>The ID of the scope that the resource is in.</p>
    ///   - [`ipam_pool_id(impl Into<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::ipam_pool_id) / [`set_ipam_pool_id(Option<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_ipam_pool_id): <p>The ID of the IPAM pool that the resource is in.</p>
    ///   - [`resource_id(impl Into<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_resource_id): <p>The ID of the resource.</p>
    ///   - [`resource_type(IpamResourceType)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::resource_type) / [`set_resource_type(Option<IpamResourceType>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_resource_type): <p>The resource type.</p>
    ///   - [`resource_tag(RequestIpamResourceTag)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::resource_tag) / [`set_resource_tag(Option<RequestIpamResourceTag>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_resource_tag): <p>The resource tag.</p>
