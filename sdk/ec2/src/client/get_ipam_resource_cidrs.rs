...
impl super::Client {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::get_ipam_resource_cidrs::builders::GetIpamResourceCidrsFluentBuilder::set_resource_id): <p>The ID of the resource.</p>
