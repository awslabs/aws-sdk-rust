...
impl super::Client {
    ...
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::instance_ids) / [`set_instance_ids(Option<Vec::<String>>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::set_instance_ids):<br>required: **true**<br><p>The IDs of the instances.</p><br>
    ///   - [`additional_info(impl Into<String>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::additional_info) / [`set_additional_info(Option<String>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::set_additional_info):<br>required: **false**<br><p>Reserved.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the operation, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
