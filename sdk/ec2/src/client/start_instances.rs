...
impl super::Client {
    ...
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::instance_ids) / [`set_instance_ids(Option<Vec<String>>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::set_instance_ids): <p>The IDs of the instances.</p>
