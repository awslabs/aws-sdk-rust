...
impl super::Client  {
    ...
    pub fn delete_vpc_endpoint_connection_notifications(&self) -> crate::client::fluent_builders::DeleteVpcEndpointConnectionNotifications {
                                crate::client::fluent_builders::DeleteVpcEndpointConnectionNotifications::new(self.handle.clone())
                            }
}
