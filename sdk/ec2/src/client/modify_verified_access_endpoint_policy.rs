...
impl super::Client  {
    ...
    pub fn modify_verified_access_endpoint_policy(&self) -> crate::client::fluent_builders::ModifyVerifiedAccessEndpointPolicy {
                                crate::client::fluent_builders::ModifyVerifiedAccessEndpointPolicy::new(self.handle.clone())
                            }
}
