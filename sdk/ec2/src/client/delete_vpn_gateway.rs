...
impl super::Client {
    ...
    pub fn delete_vpn_gateway(
        &self,
    ) -> crate::operation::delete_vpn_gateway::builders::DeleteVpnGatewayFluentBuilder {
        crate::operation::delete_vpn_gateway::builders::DeleteVpnGatewayFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
