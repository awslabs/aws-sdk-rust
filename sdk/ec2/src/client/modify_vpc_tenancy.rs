...
impl super::Client {
    ...
    ///   - [`vpc_id(impl Into<String>)`](crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyFluentBuilder::vpc_id) / [`set_vpc_id(Option<String>)`](crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyFluentBuilder::set_vpc_id):<br>required: **true**<br><p>The ID of the VPC.</p><br>
    ///   - [`instance_tenancy(VpcTenancy)`](crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyFluentBuilder::instance_tenancy) / [`set_instance_tenancy(Option<VpcTenancy>)`](crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyFluentBuilder::set_instance_tenancy):<br>required: **true**<br><p>The instance tenancy attribute for the VPC.</p><br>
