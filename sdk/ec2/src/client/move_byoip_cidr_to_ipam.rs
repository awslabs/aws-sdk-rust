...
impl super::Client {
    ...
    ///   - [`cidr(impl ::std::convert::Into<String>)`](crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamFluentBuilder::cidr) / [`set_cidr(Option<String>)`](crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamFluentBuilder::set_cidr): <p>The BYOIP CIDR.</p>
    ///   - [`ipam_pool_id(impl ::std::convert::Into<String>)`](crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamFluentBuilder::ipam_pool_id) / [`set_ipam_pool_id(Option<String>)`](crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamFluentBuilder::set_ipam_pool_id): <p>The IPAM pool ID.</p>
    ///   - [`ipam_pool_owner(impl ::std::convert::Into<String>)`](crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamFluentBuilder::ipam_pool_owner) / [`set_ipam_pool_owner(Option<String>)`](crate::operation::move_byoip_cidr_to_ipam::builders::MoveByoipCidrToIpamFluentBuilder::set_ipam_pool_owner): <p>The Amazon Web Services account ID of the owner of the IPAM pool.</p>
