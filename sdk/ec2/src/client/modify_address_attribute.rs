...
impl super::Client {
    ...
    ///   - [`allocation_id(impl Into<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::set_allocation_id):<br>required: **true**<br><p>[EC2-VPC] The allocation ID.</p><br>
    ///   - [`domain_name(impl Into<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::set_domain_name):<br>required: **false**<br><p>The domain name to modify for the IP address.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
