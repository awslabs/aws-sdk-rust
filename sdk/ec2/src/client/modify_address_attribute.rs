...
impl super::Client {
    ...
    ///   - [`allocation_id(impl ::std::convert::Into<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::allocation_id) / [`set_allocation_id(Option<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::set_allocation_id): <p>[EC2-VPC] The allocation ID.</p>
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::modify_address_attribute::builders::ModifyAddressAttributeFluentBuilder::set_domain_name): <p>The domain name to modify for the IP address.</p>
