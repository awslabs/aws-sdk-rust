...
impl super::Client {
    ...
    ///   - [`unassigned_ipv6_prefixes(Option<Vec::<String>>)`](crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesOutput::unassigned_ipv6_prefixes): <p>The IPv6 prefixes that have been unassigned from the network interface.</p>
