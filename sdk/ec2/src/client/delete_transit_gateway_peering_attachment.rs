...
impl super::Client  {
    ...
    pub fn delete_transit_gateway_peering_attachment(&self) -> crate::client::fluent_builders::DeleteTransitGatewayPeeringAttachment {
                                crate::client::fluent_builders::DeleteTransitGatewayPeeringAttachment::new(self.handle.clone())
                            }
}
