...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_ipam_pools::builders::DescribeIpamPoolsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_ipam_pools::builders::DescribeIpamPoolsFluentBuilder::set_filters): <p>One or more filters for the request. For more information about filtering, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-filter.html">Filtering CLI output</a>.</p>
