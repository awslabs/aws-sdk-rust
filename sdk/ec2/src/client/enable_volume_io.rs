...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::enable_volume_io::builders::EnableVolumeIOFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::enable_volume_io::builders::EnableVolumeIOFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ///   - [`volume_id(impl Into<String>)`](crate::operation::enable_volume_io::builders::EnableVolumeIOFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::enable_volume_io::builders::EnableVolumeIOFluentBuilder::set_volume_id):<br>required: **true**<br><p>The ID of the volume.</p><br>
