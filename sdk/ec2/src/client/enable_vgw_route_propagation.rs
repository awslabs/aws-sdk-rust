...
impl super::Client {
    ...
    ///   - [`gateway_id(impl ::std::convert::Into<String>)`](crate::operation::enable_vgw_route_propagation::builders::EnableVgwRoutePropagationFluentBuilder::gateway_id) / [`set_gateway_id(Option<String>)`](crate::operation::enable_vgw_route_propagation::builders::EnableVgwRoutePropagationFluentBuilder::set_gateway_id): <p>The ID of the virtual private gateway that is attached to a VPC. The virtual private gateway must be attached to the same VPC that the routing tables are associated with. </p>
    ///   - [`route_table_id(impl ::std::convert::Into<String>)`](crate::operation::enable_vgw_route_propagation::builders::EnableVgwRoutePropagationFluentBuilder::route_table_id) / [`set_route_table_id(Option<String>)`](crate::operation::enable_vgw_route_propagation::builders::EnableVgwRoutePropagationFluentBuilder::set_route_table_id): <p>The ID of the route table. The routing table must be associated with the same VPC that the virtual private gateway is attached to. </p>
