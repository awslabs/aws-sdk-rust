...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::delete_placement_group::builders::DeletePlacementGroupFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::delete_placement_group::builders::DeletePlacementGroupFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ///   - [`group_name(impl Into<String>)`](crate::operation::delete_placement_group::builders::DeletePlacementGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::delete_placement_group::builders::DeletePlacementGroupFluentBuilder::set_group_name):<br>required: **true**<br><p>The name of the placement group.</p><br>
