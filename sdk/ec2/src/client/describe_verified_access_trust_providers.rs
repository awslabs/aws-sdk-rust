...
impl super::Client  {
    ...
    pub fn describe_verified_access_trust_providers(&self) -> crate::client::fluent_builders::DescribeVerifiedAccessTrustProviders {
                                crate::client::fluent_builders::DescribeVerifiedAccessTrustProviders::new(self.handle.clone())
                            }
}
