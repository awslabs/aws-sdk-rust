...
impl super::Client {
    ...
    ///   - [`verified_access_trust_providers(Option<Vec::<VerifiedAccessTrustProvider>>)`](crate::operation::describe_verified_access_trust_providers::DescribeVerifiedAccessTrustProvidersOutput::verified_access_trust_providers): <p>Details about the Verified Access trust providers.</p>
