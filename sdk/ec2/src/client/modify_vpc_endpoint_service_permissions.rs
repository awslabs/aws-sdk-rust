...
impl super::Client  {
    ...
    pub fn modify_vpc_endpoint_service_permissions(&self) -> crate::client::fluent_builders::ModifyVpcEndpointServicePermissions {
                                crate::client::fluent_builders::ModifyVpcEndpointServicePermissions::new(self.handle.clone())
                            }
}
