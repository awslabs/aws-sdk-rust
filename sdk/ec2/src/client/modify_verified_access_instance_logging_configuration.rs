...
impl super::Client  {
    ...
    pub fn modify_verified_access_instance_logging_configuration(&self) -> crate::client::fluent_builders::ModifyVerifiedAccessInstanceLoggingConfiguration {
                                crate::client::fluent_builders::ModifyVerifiedAccessInstanceLoggingConfiguration::new(self.handle.clone())
                            }
}
