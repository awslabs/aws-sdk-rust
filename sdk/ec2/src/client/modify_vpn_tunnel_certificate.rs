...
impl super::Client {
    ...
    ///   - [`vpn_connection_id(impl ::std::convert::Into<String>)`](crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateFluentBuilder::vpn_connection_id) / [`set_vpn_connection_id(Option<String>)`](crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateFluentBuilder::set_vpn_connection_id): <p>The ID of the Amazon Web Services Site-to-Site VPN connection.</p>
    ///   - [`vpn_tunnel_outside_ip_address(impl ::std::convert::Into<String>)`](crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateFluentBuilder::vpn_tunnel_outside_ip_address) / [`set_vpn_tunnel_outside_ip_address(Option<String>)`](crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateFluentBuilder::set_vpn_tunnel_outside_ip_address): <p>The external IP address of the VPN tunnel.</p>
