...
impl super::Client {
    ...
    pub fn enable_reachability_analyzer_organization_sharing(
        &self,
    ) -> crate::client::fluent_builders::EnableReachabilityAnalyzerOrganizationSharing {
        crate::client::fluent_builders::EnableReachabilityAnalyzerOrganizationSharing::new(
            self.handle.clone(),
        )
    }
}
