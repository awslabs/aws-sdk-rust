...
impl super::Client  {
    ...
    pub fn modify_transit_gateway(&self) -> crate::client::fluent_builders::ModifyTransitGateway {
                                crate::client::fluent_builders::ModifyTransitGateway::new(self.handle.clone())
                            }
}
