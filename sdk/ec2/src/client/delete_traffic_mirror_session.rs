...
impl super::Client {
    ...
    ///   - [`traffic_mirror_session_id(impl Into<String>)`](crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder::traffic_mirror_session_id) / [`set_traffic_mirror_session_id(Option<String>)`](crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder::set_traffic_mirror_session_id):<br>required: **true**<br><p>The ID of the Traffic Mirror session.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ...
    pub fn delete_traffic_mirror_session(
        &self,
    ) -> crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder {
