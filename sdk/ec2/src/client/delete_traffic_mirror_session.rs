...
impl super::Client {
    ...
    ///   - [`traffic_mirror_session_id(impl ::std::convert::Into<String>)`](crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder::traffic_mirror_session_id) / [`set_traffic_mirror_session_id(Option<String>)`](crate::operation::delete_traffic_mirror_session::builders::DeleteTrafficMirrorSessionFluentBuilder::set_traffic_mirror_session_id): <p>The ID of the Traffic Mirror session.</p>
