...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsFluentBuilder::set_filters): <p>One or more filters for the request. For more information about filtering, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-filter.html">Filtering CLI output</a>.</p>
