...
impl super::Client {
    ...
    ///   - [`ipam_pool_id(impl ::std::convert::Into<String>)`](crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsFluentBuilder::ipam_pool_id) / [`set_ipam_pool_id(Option<String>)`](crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsFluentBuilder::set_ipam_pool_id): <p>The ID of the IPAM pool you want the CIDR for.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
