...
impl super::Client  {
    ...
    pub fn enable_image_deprecation(&self) -> crate::client::fluent_builders::EnableImageDeprecation {
                                crate::client::fluent_builders::EnableImageDeprecation::new(self.handle.clone())
                            }
}
