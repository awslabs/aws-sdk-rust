...
impl super::Client {
    ...
    ///   - [`image_id(impl ::std::convert::Into<String>)`](crate::operation::enable_image_deprecation::builders::EnableImageDeprecationFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::enable_image_deprecation::builders::EnableImageDeprecationFluentBuilder::set_image_id): <p>The ID of the AMI.</p>
