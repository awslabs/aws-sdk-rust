...
impl super::Client  {
    ...
    pub fn detach_network_interface(&self) -> crate::client::fluent_builders::DetachNetworkInterface {
                                crate::client::fluent_builders::DetachNetworkInterface::new(self.handle.clone())
                            }
}
