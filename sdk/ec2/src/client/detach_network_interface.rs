...
impl super::Client {
    /// Constructs a fluent builder for the [`DetachNetworkInterface`](crate::operation::detach_network_interface::builders::DetachNetworkInterfaceFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`attachment_id(impl Into<String>)`](crate::operation::detach_network_interface::builders::DetachNetworkInterfaceFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::detach_network_interface::builders::DetachNetworkInterfaceFluentBuilder::set_attachment_id): <p>The ID of the attachment.</p>
    ///   - [`dry_run(bool)`](crate::operation::detach_network_interface::builders::DetachNetworkInterfaceFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::detach_network_interface::builders::DetachNetworkInterfaceFluentBuilder::set_dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
