...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::detach_classic_link_vpc::builders::DetachClassicLinkVpcFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::detach_classic_link_vpc::builders::DetachClassicLinkVpcFluentBuilder::set_instance_id): <p>The ID of the instance to unlink from the VPC.</p>
    ///   - [`vpc_id(impl ::std::convert::Into<String>)`](crate::operation::detach_classic_link_vpc::builders::DetachClassicLinkVpcFluentBuilder::vpc_id) / [`set_vpc_id(Option<String>)`](crate::operation::detach_classic_link_vpc::builders::DetachClassicLinkVpcFluentBuilder::set_vpc_id): <p>The ID of the VPC to which the instance is linked.</p>
