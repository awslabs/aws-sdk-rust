...
impl super::Client {
    ...
    ///   - [`instance_ids(impl Into<String>)`](crate::operation::stop_instances::builders::StopInstancesFluentBuilder::instance_ids) / [`set_instance_ids(Option<Vec<String>>)`](crate::operation::stop_instances::builders::StopInstancesFluentBuilder::set_instance_ids): <p>The IDs of the instances.</p>
