...
impl super::Client {
    ...
    pub fn get_snapshot_block_public_access_state(&self) -> crate::operation::get_snapshot_block_public_access_state::builders::GetSnapshotBlockPublicAccessStateFluentBuilder {
