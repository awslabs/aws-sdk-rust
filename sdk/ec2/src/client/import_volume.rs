...
impl super::Client {
    ...
    ///   - [`availability_zone(impl ::std::convert::Into<String>)`](crate::operation::import_volume::builders::ImportVolumeFluentBuilder::availability_zone) / [`set_availability_zone(Option<String>)`](crate::operation::import_volume::builders::ImportVolumeFluentBuilder::set_availability_zone): <p>The Availability Zone for the resulting EBS volume.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::import_volume::builders::ImportVolumeFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::import_volume::builders::ImportVolumeFluentBuilder::set_description): <p>A description of the volume.</p>
