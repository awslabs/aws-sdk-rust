...
impl super::Client {
    ...
    ///   - [`ipam_id(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam::builders::ModifyIpamFluentBuilder::ipam_id) / [`set_ipam_id(Option<String>)`](crate::operation::modify_ipam::builders::ModifyIpamFluentBuilder::set_ipam_id): <p>The ID of the IPAM you want to modify.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam::builders::ModifyIpamFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::modify_ipam::builders::ModifyIpamFluentBuilder::set_description): <p>The description of the IPAM you want to modify.</p>
