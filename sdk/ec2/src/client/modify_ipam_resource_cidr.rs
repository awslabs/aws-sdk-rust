...
impl super::Client {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::set_resource_id): <p>The ID of the resource you want to modify.</p>
    ///   - [`resource_cidr(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::resource_cidr) / [`set_resource_cidr(Option<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::set_resource_cidr): <p>The CIDR of the resource you want to modify.</p>
    ///   - [`resource_region(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::resource_region) / [`set_resource_region(Option<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::set_resource_region): <p>The Amazon Web Services Region of the resource you want to modify.</p>
    ///   - [`current_ipam_scope_id(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::current_ipam_scope_id) / [`set_current_ipam_scope_id(Option<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::set_current_ipam_scope_id): <p>The ID of the current scope that the resource CIDR is in.</p>
    ///   - [`destination_ipam_scope_id(impl ::std::convert::Into<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::destination_ipam_scope_id) / [`set_destination_ipam_scope_id(Option<String>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::set_destination_ipam_scope_id): <p>The ID of the scope you want to transfer the resource CIDR to.</p>
    ///   - [`monitored(bool)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::monitored) / [`set_monitored(Option<bool>)`](crate::operation::modify_ipam_resource_cidr::builders::ModifyIpamResourceCidrFluentBuilder::set_monitored): <p>Determines if the resource is monitored by IPAM. If a resource is monitored, the resource is discovered by IPAM and you can view details about the resource’s CIDR.</p>
