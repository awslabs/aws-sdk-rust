...
impl super::Client {
    ...
    ///   - [`cidr(impl ::std::convert::Into<String>)`](crate::operation::create_coip_cidr::builders::CreateCoipCidrFluentBuilder::cidr) / [`set_cidr(Option<String>)`](crate::operation::create_coip_cidr::builders::CreateCoipCidrFluentBuilder::set_cidr): <p> A customer-owned IP address range to create. </p>
    ///   - [`coip_pool_id(impl ::std::convert::Into<String>)`](crate::operation::create_coip_cidr::builders::CreateCoipCidrFluentBuilder::coip_pool_id) / [`set_coip_pool_id(Option<String>)`](crate::operation::create_coip_cidr::builders::CreateCoipCidrFluentBuilder::set_coip_pool_id): <p> The ID of the address pool. </p>
