...
impl super::Client {
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::describe_ipam_resource_discoveries::DescribeIpamResourceDiscoveriesOutput::next_token): <p>The token to use to retrieve the next page of results. This value is <code>null</code> when there are no more results to return.</p>
