...
impl super::Client {
    ...
    ///   - [`vpc_ids(Vec<String>)`](crate::operation::describe_vpc_classic_link::builders::DescribeVpcClassicLinkFluentBuilder::vpc_ids) / [`set_vpc_ids(Option<Vec<String>>)`](crate::operation::describe_vpc_classic_link::builders::DescribeVpcClassicLinkFluentBuilder::set_vpc_ids): <p>The VPCs for which you want to describe the ClassicLink status.</p>
