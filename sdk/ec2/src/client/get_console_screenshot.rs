...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::get_console_screenshot::builders::GetConsoleScreenshotFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::get_console_screenshot::builders::GetConsoleScreenshotFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
    ///   - [`instance_id(impl Into<String>)`](crate::operation::get_console_screenshot::builders::GetConsoleScreenshotFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::get_console_screenshot::builders::GetConsoleScreenshotFluentBuilder::set_instance_id):<br>required: **true**<br><p>The ID of the instance.</p><br>
    ///   - [`wake_up(bool)`](crate::operation::get_console_screenshot::builders::GetConsoleScreenshotFluentBuilder::wake_up) / [`set_wake_up(Option<bool>)`](crate::operation::get_console_screenshot::builders::GetConsoleScreenshotFluentBuilder::set_wake_up):<br>required: **false**<br><p>When set to <code>true</code>, acts as keystroke input and wakes up an instance that's in standby or "sleep" mode.</p><br>
