...
impl super::Client  {
    ...
    pub fn describe_identity_id_format(&self) -> crate::client::fluent_builders::DescribeIdentityIdFormat {
                                crate::client::fluent_builders::DescribeIdentityIdFormat::new(self.handle.clone())
                            }
}
