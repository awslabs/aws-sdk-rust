...
impl super::Client  {
    ...
    pub fn get_associated_enclave_certificate_iam_roles(&self) -> crate::client::fluent_builders::GetAssociatedEnclaveCertificateIamRoles {
                                crate::client::fluent_builders::GetAssociatedEnclaveCertificateIamRoles::new(self.handle.clone())
                            }
}
