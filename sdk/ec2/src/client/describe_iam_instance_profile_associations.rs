...
impl super::Client  {
    ...
    pub fn describe_iam_instance_profile_associations(&self) -> crate::client::fluent_builders::DescribeIamInstanceProfileAssociations {
                                crate::client::fluent_builders::DescribeIamInstanceProfileAssociations::new(self.handle.clone())
                            }
}
