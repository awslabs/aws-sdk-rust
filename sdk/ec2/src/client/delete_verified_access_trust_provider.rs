...
impl super::Client {
    ...
    ///   - [`verified_access_trust_provider_id(impl ::std::convert::Into<String>)`](crate::operation::delete_verified_access_trust_provider::builders::DeleteVerifiedAccessTrustProviderFluentBuilder::verified_access_trust_provider_id) / [`set_verified_access_trust_provider_id(Option<String>)`](crate::operation::delete_verified_access_trust_provider::builders::DeleteVerifiedAccessTrustProviderFluentBuilder::set_verified_access_trust_provider_id): <p>The ID of the Verified Access trust provider.</p>
