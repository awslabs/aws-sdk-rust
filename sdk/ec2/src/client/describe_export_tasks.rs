...
impl super::Client {
    ...
    ///   - [`export_task_ids(impl Into<String>)`](crate::operation::describe_export_tasks::builders::DescribeExportTasksFluentBuilder::export_task_ids) / [`set_export_task_ids(Option<Vec<String>>)`](crate::operation::describe_export_tasks::builders::DescribeExportTasksFluentBuilder::set_export_task_ids): <p>The export task IDs.</p>
    ///   - [`filters(Filter)`](crate::operation::describe_export_tasks::builders::DescribeExportTasksFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_export_tasks::builders::DescribeExportTasksFluentBuilder::set_filters): <p>the filters for the export tasks.</p>
