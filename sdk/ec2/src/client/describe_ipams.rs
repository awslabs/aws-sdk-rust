...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_ipams::builders::DescribeIpamsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_ipams::builders::DescribeIpamsFluentBuilder::set_filters): <p>One or more filters for the request. For more information about filtering, see <a href="https://docs.aws.amazon.com/cli/latest/userguide/cli-usage-filter.html">Filtering CLI output</a>.</p>
    ...
    ///   - [`ipam_ids(impl Into<String>)`](crate::operation::describe_ipams::builders::DescribeIpamsFluentBuilder::ipam_ids) / [`set_ipam_ids(Option<Vec<String>>)`](crate::operation::describe_ipams::builders::DescribeIpamsFluentBuilder::set_ipam_ids): <p>The IDs of the IPAMs you want information on.</p>
