...
impl super::Client {
    ...
    ///   - [`fpga_image_id(impl ::std::convert::Into<String>)`](crate::operation::delete_fpga_image::builders::DeleteFpgaImageFluentBuilder::fpga_image_id) / [`set_fpga_image_id(Option<String>)`](crate::operation::delete_fpga_image::builders::DeleteFpgaImageFluentBuilder::set_fpga_image_id): <p>The ID of the AFI.</p>
