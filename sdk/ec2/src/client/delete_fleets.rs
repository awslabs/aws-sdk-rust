...
impl super::Client {
    ...
    ///   - [`fleet_ids(impl Into<String>)`](crate::operation::delete_fleets::builders::DeleteFleetsFluentBuilder::fleet_ids) / [`set_fleet_ids(Option<Vec<String>>)`](crate::operation::delete_fleets::builders::DeleteFleetsFluentBuilder::set_fleet_ids): <p>The IDs of the EC2 Fleets.</p>
