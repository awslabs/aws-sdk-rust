...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksFluentBuilder::set_filters): <p>The filters.</p>
    ///   - [`import_task_ids(impl Into<String>)`](crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksFluentBuilder::import_task_ids) / [`set_import_task_ids(Option<Vec<String>>)`](crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksFluentBuilder::set_import_task_ids): <p>A list of import snapshot task IDs.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_import_snapshot_tasks::builders::DescribeImportSnapshotTasksFluentBuilder::set_next_token): <p>A token that indicates the next page of results.</p>
