...
impl super::Client  {
    ...
    pub fn enable_transit_gateway_route_table_propagation(&self) -> crate::client::fluent_builders::EnableTransitGatewayRouteTablePropagation {
                                crate::client::fluent_builders::EnableTransitGatewayRouteTablePropagation::new(self.handle.clone())
                            }
}
