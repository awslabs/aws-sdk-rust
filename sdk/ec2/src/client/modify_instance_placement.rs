...
impl super::Client  {
    ...
    pub fn modify_instance_placement(&self) -> crate::client::fluent_builders::ModifyInstancePlacement {
                                crate::client::fluent_builders::ModifyInstancePlacement::new(self.handle.clone())
                            }
}
