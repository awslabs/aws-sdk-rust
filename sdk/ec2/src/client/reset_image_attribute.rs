...
impl super::Client {
    ...
    ///   - [`attribute(ResetImageAttributeName)`](crate::operation::reset_image_attribute::builders::ResetImageAttributeFluentBuilder::attribute) / [`set_attribute(Option<ResetImageAttributeName>)`](crate::operation::reset_image_attribute::builders::ResetImageAttributeFluentBuilder::set_attribute):<br>required: **true**<br><p>The attribute to reset (currently you can only reset the launch permission attribute).</p><br>
    ///   - [`image_id(impl Into<String>)`](crate::operation::reset_image_attribute::builders::ResetImageAttributeFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::reset_image_attribute::builders::ResetImageAttributeFluentBuilder::set_image_id):<br>required: **true**<br><p>The ID of the AMI.</p><br>
