...
impl super::Client  {
    ...
    pub fn register_transit_gateway_multicast_group_members(&self) -> crate::client::fluent_builders::RegisterTransitGatewayMulticastGroupMembers {
                                crate::client::fluent_builders::RegisterTransitGatewayMulticastGroupMembers::new(self.handle.clone())
                            }
}
