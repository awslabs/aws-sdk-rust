...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::confirm_product_instance::builders::ConfirmProductInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::confirm_product_instance::builders::ConfirmProductInstanceFluentBuilder::set_instance_id):<br>required: **true**<br><p>The ID of the instance.</p><br>
    ///   - [`product_code(impl Into<String>)`](crate::operation::confirm_product_instance::builders::ConfirmProductInstanceFluentBuilder::product_code) / [`set_product_code(Option<String>)`](crate::operation::confirm_product_instance::builders::ConfirmProductInstanceFluentBuilder::set_product_code):<br>required: **true**<br><p>The product code. This must be a product code that you own.</p><br>
    ///   - [`dry_run(bool)`](crate::operation::confirm_product_instance::builders::ConfirmProductInstanceFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::confirm_product_instance::builders::ConfirmProductInstanceFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks whether you have the required permissions for the operation, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p><br>
