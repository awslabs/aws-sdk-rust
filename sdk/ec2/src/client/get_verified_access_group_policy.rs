...
impl super::Client {
    ...
    ///   - [`verified_access_group_id(impl Into<String>)`](crate::operation::get_verified_access_group_policy::builders::GetVerifiedAccessGroupPolicyFluentBuilder::verified_access_group_id) / [`set_verified_access_group_id(Option<String>)`](crate::operation::get_verified_access_group_policy::builders::GetVerifiedAccessGroupPolicyFluentBuilder::set_verified_access_group_id): <p>The ID of the Verified Access group.</p>
