...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_launch_template::builders::CreateLaunchTemplateFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_launch_template::builders::CreateLaunchTemplateFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier you provide to ensure the idempotency of the request. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html">Ensuring idempotency</a>.</p>  <p>Constraint: Maximum 128 ASCII characters.</p>
    ///   - [`launch_template_name(impl ::std::convert::Into<String>)`](crate::operation::create_launch_template::builders::CreateLaunchTemplateFluentBuilder::launch_template_name) / [`set_launch_template_name(Option<String>)`](crate::operation::create_launch_template::builders::CreateLaunchTemplateFluentBuilder::set_launch_template_name): <p>A name for the launch template.</p>
    ///   - [`version_description(impl ::std::convert::Into<String>)`](crate::operation::create_launch_template::builders::CreateLaunchTemplateFluentBuilder::version_description) / [`set_version_description(Option<String>)`](crate::operation::create_launch_template::builders::CreateLaunchTemplateFluentBuilder::set_version_description): <p>A description for the first version of the launch template.</p>
