...
impl super::Client  {
    ...
    pub fn disassociate_transit_gateway_multicast_domain(&self) -> crate::client::fluent_builders::DisassociateTransitGatewayMulticastDomain {
                                crate::client::fluent_builders::DisassociateTransitGatewayMulticastDomain::new(self.handle.clone())
                            }
}
