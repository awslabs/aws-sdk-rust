...
impl super::Client  {
    ...
    pub fn register_transit_gateway_multicast_group_sources(&self) -> crate::client::fluent_builders::RegisterTransitGatewayMulticastGroupSources {
                                crate::client::fluent_builders::RegisterTransitGatewayMulticastGroupSources::new(self.handle.clone())
                            }
}
