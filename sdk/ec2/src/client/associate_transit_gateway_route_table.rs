...
impl super::Client {
    ...
    ///   - [`transit_gateway_route_table_id(impl ::std::convert::Into<String>)`](crate::operation::associate_transit_gateway_route_table::builders::AssociateTransitGatewayRouteTableFluentBuilder::transit_gateway_route_table_id) / [`set_transit_gateway_route_table_id(Option<String>)`](crate::operation::associate_transit_gateway_route_table::builders::AssociateTransitGatewayRouteTableFluentBuilder::set_transit_gateway_route_table_id): <p>The ID of the transit gateway route table.</p>
    ///   - [`transit_gateway_attachment_id(impl ::std::convert::Into<String>)`](crate::operation::associate_transit_gateway_route_table::builders::AssociateTransitGatewayRouteTableFluentBuilder::transit_gateway_attachment_id) / [`set_transit_gateway_attachment_id(Option<String>)`](crate::operation::associate_transit_gateway_route_table::builders::AssociateTransitGatewayRouteTableFluentBuilder::set_transit_gateway_attachment_id): <p>The ID of the attachment.</p>
    ...
    pub fn associate_transit_gateway_route_table(
        &self,
    ) -> crate::operation::associate_transit_gateway_route_table::builders::AssociateTransitGatewayRouteTableFluentBuilder {
