...
impl super::Client  {
    ...
    pub fn associate_transit_gateway_route_table(&self) -> crate::client::fluent_builders::AssociateTransitGatewayRouteTable {
                                crate::client::fluent_builders::AssociateTransitGatewayRouteTable::new(self.handle.clone())
                            }
}
