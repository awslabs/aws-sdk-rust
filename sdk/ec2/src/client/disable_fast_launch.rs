...
impl super::Client {
    ...
    ///   - [`image_id(impl Into<String>)`](crate::operation::disable_fast_launch::builders::DisableFastLaunchFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::disable_fast_launch::builders::DisableFastLaunchFluentBuilder::set_image_id):<br>required: **true**<br><p>The ID of the image for which you’re turning off faster launching, and removing pre-provisioned snapshots.</p><br>
