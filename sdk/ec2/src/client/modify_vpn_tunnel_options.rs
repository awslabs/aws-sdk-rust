...
impl super::Client {
    ...
    ///   - [`skip_tunnel_replacement(bool)`](crate::operation::modify_vpn_tunnel_options::builders::ModifyVpnTunnelOptionsFluentBuilder::skip_tunnel_replacement) / [`set_skip_tunnel_replacement(Option<bool>)`](crate::operation::modify_vpn_tunnel_options::builders::ModifyVpnTunnelOptionsFluentBuilder::set_skip_tunnel_replacement): <p>Choose whether or not to trigger immediate tunnel replacement.</p>  <p>Valid values: <code>True</code> | <code>False</code> </p>
