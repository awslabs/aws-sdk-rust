...
impl super::Client {
    ...
    ///   - [`nat_gateway_id(impl ::std::convert::Into<String>)`](crate::operation::assign_private_nat_gateway_address::builders::AssignPrivateNatGatewayAddressFluentBuilder::nat_gateway_id) / [`set_nat_gateway_id(Option<String>)`](crate::operation::assign_private_nat_gateway_address::builders::AssignPrivateNatGatewayAddressFluentBuilder::set_nat_gateway_id): <p>The NAT gateway ID.</p>
    ...
    ///   - [`nat_gateway_id(Option<String>)`](crate::operation::assign_private_nat_gateway_address::AssignPrivateNatGatewayAddressOutput::nat_gateway_id): <p>The NAT gateway ID.</p>
    ...
    pub fn assign_private_nat_gateway_address(&self) -> crate::operation::assign_private_nat_gateway_address::builders::AssignPrivateNatGatewayAddressFluentBuilder{
