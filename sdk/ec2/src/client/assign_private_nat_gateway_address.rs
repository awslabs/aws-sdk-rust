...
impl super::Client {
    ...
    ///   - [`nat_gateway_id(impl Into<String>)`](crate::operation::assign_private_nat_gateway_address::builders::AssignPrivateNatGatewayAddressFluentBuilder::nat_gateway_id) / [`set_nat_gateway_id(Option<String>)`](crate::operation::assign_private_nat_gateway_address::builders::AssignPrivateNatGatewayAddressFluentBuilder::set_nat_gateway_id): <p>The NAT gateway ID.</p>
