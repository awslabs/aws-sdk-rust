...
impl super::Client  {
    ...
    pub fn delete_transit_gateway_multicast_domain(&self) -> crate::client::fluent_builders::DeleteTransitGatewayMulticastDomain {
                                crate::client::fluent_builders::DeleteTransitGatewayMulticastDomain::new(self.handle.clone())
                            }
}
