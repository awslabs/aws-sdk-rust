...
impl super::Client {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::delete_security_group::builders::DeleteSecurityGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::delete_security_group::builders::DeleteSecurityGroupFluentBuilder::set_group_id): <p>The ID of the security group. Required for a nondefault VPC.</p>
