...
impl super::Client {
    ...
    ///   - [`r#return(Option<bool>)`](crate::operation::delete_security_group::DeleteSecurityGroupOutput::return): <p>Returns <code>true</code> if the request succeeds; otherwise, returns an error.</p>
    ///   - [`group_id(Option<String>)`](crate::operation::delete_security_group::DeleteSecurityGroupOutput::group_id): <p>The ID of the deleted security group.</p>
