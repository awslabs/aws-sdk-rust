...
impl super::Client {
    ...
    pub fn export_client_vpn_client_certificate_revocation_list(
        &self,
    ) -> crate::client::fluent_builders::ExportClientVpnClientCertificateRevocationList {
        crate::client::fluent_builders::ExportClientVpnClientCertificateRevocationList::new(
            self.handle.clone(),
        )
    }
}
