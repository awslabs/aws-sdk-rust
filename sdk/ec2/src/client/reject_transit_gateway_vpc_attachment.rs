...
impl super::Client {
    ...
    ///   - [`transit_gateway_attachment_id(impl Into<String>)`](crate::operation::reject_transit_gateway_vpc_attachment::builders::RejectTransitGatewayVpcAttachmentFluentBuilder::transit_gateway_attachment_id) / [`set_transit_gateway_attachment_id(Option<String>)`](crate::operation::reject_transit_gateway_vpc_attachment::builders::RejectTransitGatewayVpcAttachmentFluentBuilder::set_transit_gateway_attachment_id):<br>required: **true**<br><p>The ID of the attachment.</p><br>
