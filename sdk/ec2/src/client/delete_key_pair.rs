...
impl super::Client {
    ...
    ///   - [`key_name(impl Into<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::key_name) / [`set_key_name(Option<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::set_key_name):<br>required: **false**<br><p>The name of the key pair.</p><br>
    ///   - [`key_pair_id(impl Into<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::key_pair_id) / [`set_key_pair_id(Option<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::set_key_pair_id):<br>required: **false**<br><p>The ID of the key pair.</p><br>
    ...
    ///   - [`r#return(Option<bool>)`](crate::operation::delete_key_pair::DeleteKeyPairOutput::return): <p>Is <code>true</code> if the request succeeds, and an error otherwise.</p>
    ///   - [`key_pair_id(Option<String>)`](crate::operation::delete_key_pair::DeleteKeyPairOutput::key_pair_id): <p>The ID of the key pair.</p>
