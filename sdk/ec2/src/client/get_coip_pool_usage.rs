...
impl super::Client {
    ...
    ///   - [`pool_id(impl ::std::convert::Into<String>)`](crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageFluentBuilder::pool_id) / [`set_pool_id(Option<String>)`](crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageFluentBuilder::set_pool_id): <p>The ID of the address pool.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
