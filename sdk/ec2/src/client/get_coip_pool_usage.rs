...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::get_coip_pool_usage::builders::GetCoipPoolUsageFluentBuilder::set_filters): <p>One or more filters.</p>  <ul>   <li> <p> <code>coip-address-usage.allocation-id</code> - The allocation ID of the address.</p> </li>   <li> <p> <code>coip-address-usage.aws-account-id</code> - The ID of the Amazon Web Services account that is using the customer-owned IP address.</p> </li>   <li> <p> <code>coip-address-usage.aws-service</code> - The Amazon Web Services service that is using the customer-owned IP address.</p> </li>   <li> <p> <code>coip-address-usage.co-ip</code> - The customer-owned IP address.</p> </li>  </ul>
