...
impl super::Client {
    ...
    ///   - [`attribute(SnapshotAttributeName)`](crate::operation::describe_snapshot_attribute::builders::DescribeSnapshotAttributeFluentBuilder::attribute) / [`set_attribute(Option<SnapshotAttributeName>)`](crate::operation::describe_snapshot_attribute::builders::DescribeSnapshotAttributeFluentBuilder::set_attribute):<br>required: **true**<br><p>The snapshot attribute you would like to view.</p><br>
