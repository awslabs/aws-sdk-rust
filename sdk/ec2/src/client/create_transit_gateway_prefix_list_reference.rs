...
impl super::Client  {
    ...
    pub fn create_transit_gateway_prefix_list_reference(&self) -> crate::client::fluent_builders::CreateTransitGatewayPrefixListReference {
                                crate::client::fluent_builders::CreateTransitGatewayPrefixListReference::new(self.handle.clone())
                            }
}
