...
impl super::Client {
    ...
    ///   - [`transit_gateway_route_table_id(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_prefix_list_reference::builders::CreateTransitGatewayPrefixListReferenceFluentBuilder::transit_gateway_route_table_id) / [`set_transit_gateway_route_table_id(Option<String>)`](crate::operation::create_transit_gateway_prefix_list_reference::builders::CreateTransitGatewayPrefixListReferenceFluentBuilder::set_transit_gateway_route_table_id): <p>The ID of the transit gateway route table.</p>
    ///   - [`prefix_list_id(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_prefix_list_reference::builders::CreateTransitGatewayPrefixListReferenceFluentBuilder::prefix_list_id) / [`set_prefix_list_id(Option<String>)`](crate::operation::create_transit_gateway_prefix_list_reference::builders::CreateTransitGatewayPrefixListReferenceFluentBuilder::set_prefix_list_id): <p>The ID of the prefix list that is used for destination matches.</p>
