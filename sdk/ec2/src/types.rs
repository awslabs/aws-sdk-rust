...
pub use crate::types::_transit_gateway_client_vpn_attachment::TransitGatewayClientVpnAttachment;
...
pub use crate::types::_transit_gateway_attachment_status_type::TransitGatewayAttachmentStatusType;
...
mod _transit_gateway_attachment_status_type;

mod _transit_gateway_client_vpn_attachment;

mod _transit_gateway_configuration_describe_endpoint_structure;

mod _transit_gateway_configuration_input_structure;
