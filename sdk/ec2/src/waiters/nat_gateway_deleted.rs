...
///
/// Fluent builder for the `nat_gateway_deleted` waiter.
///
...
pub struct NatGatewayDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_nat_gateways::builders::DescribeNatGatewaysInputBuilder,
}
impl NatGatewayDeletedFluentBuilder {
    /// Creates a new `NatGatewayDeletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::nat_gateway_deleted::NatGatewayDeletedFinalPoll,
        crate::waiters::nat_gateway_deleted::WaitUntilNatGatewayDeletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"NatGateways[].State","expected":"deleted","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_nat_gateways_943e6d2c961eea64d(result) {
...
/// Successful return type for the `nat_gateway_deleted` waiter.
pub type NatGatewayDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_nat_gateways::DescribeNatGatewaysOutput,
...
/// Error type for the `nat_gateway_deleted` waiter.
pub type WaitUntilNatGatewayDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_nat_gateways::DescribeNatGatewaysOutput,
    crate::operation::describe_nat_gateways::DescribeNatGatewaysError,
>;
