...
///
/// Fluent builder for the `system_status_ok` waiter.
///
...
pub struct SystemStatusOkFluentBuilder {
...
impl SystemStatusOkFluentBuilder {
    /// Creates a new `SystemStatusOkFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::system_status_ok::SystemStatusOkFinalPoll,
        crate::waiters::system_status_ok::WaitUntilSystemStatusOkError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"InstanceStatuses[].SystemStatus.Status","expected":"ok","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_instance_status_46ce6aca57818c04b(result) {
    ...
    /// <li>
    /// <p><code>application-status.status</code> - The application status of the instance (<code>ok</code> | <code>impaired</code> | <code>initializing</code> | <code>insufficient-data</code> | <code>not-applicable</code>).</p></li>
    /// </ul>
...
/// Successful return type for the `system_status_ok` waiter.
pub type SystemStatusOkFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_instance_status::DescribeInstanceStatusOutput,
...
/// Error type for the `system_status_ok` waiter.
pub type WaitUntilSystemStatusOkError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_instance_status::DescribeInstanceStatusOutput,
    crate::operation::describe_instance_status::DescribeInstanceStatusError,
>;
