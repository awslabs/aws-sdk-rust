...
///
/// Fluent builder for the `conversion_task_cancelled` waiter.
///
...
pub struct ConversionTaskCancelledFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_conversion_tasks::builders::DescribeConversionTasksInputBuilder,
}
impl ConversionTaskCancelledFluentBuilder {
    /// Creates a new `ConversionTaskCancelledFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::conversion_task_cancelled::ConversionTaskCancelledFinalPoll,
        crate::waiters::conversion_task_cancelled::WaitUntilConversionTaskCancelledError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"ConversionTasks[].State","expected":"cancelled","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_conversion_tasks_2eac53a9d845cd968(result) {
...
/// Successful return type for the `conversion_task_cancelled` waiter.
pub type ConversionTaskCancelledFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_conversion_tasks::DescribeConversionTasksOutput,
...
/// Error type for the `conversion_task_cancelled` waiter.
pub type WaitUntilConversionTaskCancelledError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_conversion_tasks::DescribeConversionTasksOutput,
    crate::operation::describe_conversion_tasks::DescribeConversionTasksError,
>;
