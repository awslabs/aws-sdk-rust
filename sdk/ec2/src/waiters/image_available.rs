...
///
/// Fluent builder for the `image_available` waiter.
///
...
pub struct ImageAvailableFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_images::builders::DescribeImagesInputBuilder,
}
impl ImageAvailableFluentBuilder {
    /// Creates a new `ImageAvailableFluentBuilder`.
    ...
    ) -> ::std::result::Result<crate::waiters::image_available::ImageAvailableFinalPoll, crate::waiters::image_available::WaitUntilImageAvailableError>
    {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"Images[].State","expected":"available","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_images_3acc318c83d8a4452(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Images[].State","expected":"failed","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_images_059a66e170d3df7a5(result) {
        ...
        let operation = move || {
            ...
            async move { crate::operation::describe_images::DescribeImages::orchestrate(&runtime_plugins, input).await }
        };
...
/// Successful return type for the `image_available` waiter.
pub type ImageAvailableFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_images::DescribeImagesOutput,
...
/// Error type for the `image_available` waiter.
pub type WaitUntilImageAvailableError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_images::DescribeImagesOutput,
    crate::operation::describe_images::DescribeImagesError,
>;
