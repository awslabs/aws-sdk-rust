...
///
/// Fluent builder for the `vpc_peering_connection_exists` waiter.
///
...
pub struct VpcPeeringConnectionExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_vpc_peering_connections::builders::DescribeVpcPeeringConnectionsInputBuilder,
}
impl VpcPeeringConnectionExistsFluentBuilder {
    /// Creates a new `VpcPeeringConnectionExistsFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::vpc_peering_connection_exists::VpcPeeringConnectionExistsFinalPoll,
        crate::waiters::vpc_peering_connection_exists::WaitUntilVpcPeeringConnectionExistsError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_vpc_peering_connections_c955e57777ec0d736(result) {
...
/// Successful return type for the `vpc_peering_connection_exists` waiter.
pub type VpcPeeringConnectionExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_vpc_peering_connections::DescribeVpcPeeringConnectionsOutput,
...
/// Error type for the `vpc_peering_connection_exists` waiter.
pub type WaitUntilVpcPeeringConnectionExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_vpc_peering_connections::DescribeVpcPeeringConnectionsOutput,
    crate::operation::describe_vpc_peering_connections::DescribeVpcPeeringConnectionsError,
>;
