...
///
/// Fluent builder for the `volume_deleted` waiter.
///
...
pub struct VolumeDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_volumes::builders::DescribeVolumesInputBuilder,
}
impl VolumeDeletedFluentBuilder {
    /// Creates a new `VolumeDeletedFluentBuilder`.
    ...
    ) -> ::std::result::Result<crate::waiters::volume_deleted::VolumeDeletedFinalPoll, crate::waiters::volume_deleted::WaitUntilVolumeDeletedError>
    {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"Volumes[].State","expected":"deleted","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_volumes_b4b8f2ef2f1069b9d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"InvalidVolume.NotFound"}
            if crate::waiters::matchers::match_describe_volumes_be0fc7d72f426dbae(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
...
/// Successful return type for the `volume_deleted` waiter.
pub type VolumeDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_volumes::DescribeVolumesOutput,
...
/// Error type for the `volume_deleted` waiter.
pub type WaitUntilVolumeDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_volumes::DescribeVolumesOutput,
    crate::operation::describe_volumes::DescribeVolumesError,
>;
