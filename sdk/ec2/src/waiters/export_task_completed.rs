...
///
/// Fluent builder for the `export_task_completed` waiter.
///
...
pub struct ExportTaskCompletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_export_tasks::builders::DescribeExportTasksInputBuilder,
}
impl ExportTaskCompletedFluentBuilder {
    /// Creates a new `ExportTaskCompletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::export_task_completed::ExportTaskCompletedFinalPoll,
        crate::waiters::export_task_completed::WaitUntilExportTaskCompletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"ExportTasks[].State","expected":"completed","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_export_tasks_3884d0b74d02d2b16(result) {
...
/// Successful return type for the `export_task_completed` waiter.
pub type ExportTaskCompletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_export_tasks::DescribeExportTasksOutput,
...
/// Error type for the `export_task_completed` waiter.
pub type WaitUntilExportTaskCompletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_export_tasks::DescribeExportTasksOutput,
    crate::operation::describe_export_tasks::DescribeExportTasksError,
>;
