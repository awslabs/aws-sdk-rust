...
///
/// Fluent builder for the `secondary_subnet_create_complete` waiter.
///
...
pub struct SecondarySubnetCreateCompleteFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_secondary_subnets::builders::DescribeSecondarySubnetsInputBuilder,
}
impl SecondarySubnetCreateCompleteFluentBuilder {
    /// Creates a new `SecondarySubnetCreateCompleteFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::secondary_subnet_create_complete::SecondarySubnetCreateCompleteFinalPoll,
        crate::waiters::secondary_subnet_create_complete::WaitUntilSecondarySubnetCreateCompleteError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"SecondarySubnets[].State","expected":"create-complete","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_secondary_subnets_41ae3e14ce55093fc(result) {
            ...
            // Matches: {"errorType":"InvalidSecondarySubnetId.NotFound"}
            if crate::waiters::matchers::match_describe_secondary_subnets_f0bec91760e0b51d6(result) {
...
/// Successful return type for the `secondary_subnet_create_complete` waiter.
pub type SecondarySubnetCreateCompleteFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_secondary_subnets::DescribeSecondarySubnetsOutput,
...
/// Error type for the `secondary_subnet_create_complete` waiter.
pub type WaitUntilSecondarySubnetCreateCompleteError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_secondary_subnets::DescribeSecondarySubnetsOutput,
    crate::operation::describe_secondary_subnets::DescribeSecondarySubnetsError,
>;
