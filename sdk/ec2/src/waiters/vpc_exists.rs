...
///
/// Fluent builder for the `vpc_exists` waiter.
///
...
pub struct VpcExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_vpcs::builders::DescribeVpcsInputBuilder,
}
impl VpcExistsFluentBuilder {
    /// Creates a new `VpcExistsFluentBuilder`.
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<crate::waiters::vpc_exists::VpcExistsFinalPoll, crate::waiters::vpc_exists::WaitUntilVpcExistsError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_vpcs_c955e57777ec0d736(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"InvalidVpcID.NotFound"}
            if crate::waiters::matchers::match_describe_vpcs_f51411a22e164d79b(result) {
...
/// Successful return type for the `vpc_exists` waiter.
pub type VpcExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_vpcs::DescribeVpcsOutput,
...
/// Error type for the `vpc_exists` waiter.
pub type WaitUntilVpcExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_vpcs::DescribeVpcsOutput,
    crate::operation::describe_vpcs::DescribeVpcsError,
>;
