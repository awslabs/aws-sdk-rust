...
///
/// Fluent builder for the `image_exists` waiter.
///
...
impl ImageExistsFluentBuilder {
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<crate::waiters::image_exists::ImageExistsFinalPoll, crate::waiters::image_exists::WaitUntilImageExistsError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"length(Images[]) > `0`","expected":"true","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_images_dce6e4d979f63dcae(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"errorType":"InvalidAMIID.NotFound"}
            if crate::waiters::matchers::match_describe_images_da0ba75c4a3b70507(result) {
...
/// Successful return type for the `image_exists` waiter.
pub type ImageExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_images::DescribeImagesOutput,
...
/// Error type for the `image_exists` waiter.
pub type WaitUntilImageExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_images::DescribeImagesOutput,
    crate::operation::describe_images::DescribeImagesError,
>;
