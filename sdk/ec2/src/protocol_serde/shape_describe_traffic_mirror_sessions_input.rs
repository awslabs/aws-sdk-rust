...
pub fn ser_describe_traffic_mirror_sessions_input_input(input: &crate::input::DescribeTrafficMirrorSessionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
