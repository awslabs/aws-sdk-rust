...
pub fn ser_describe_traffic_mirror_sessions_input_input_input(input: &crate::operation::describe_traffic_mirror_sessions::DescribeTrafficMirrorSessionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
