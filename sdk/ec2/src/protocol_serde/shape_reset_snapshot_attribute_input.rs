...
pub fn ser_reset_snapshot_attribute_input_input_input(input: &crate::operation::reset_snapshot_attribute::ResetSnapshotAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
