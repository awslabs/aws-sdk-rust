...
pub fn ser_reset_snapshot_attribute_input_input(input: &crate::input::ResetSnapshotAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
