...
pub fn ser_get_associated_enclave_certificate_iam_roles_input_input(input: &crate::input::GetAssociatedEnclaveCertificateIamRolesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
