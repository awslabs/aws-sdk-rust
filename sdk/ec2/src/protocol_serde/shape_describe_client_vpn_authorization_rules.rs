...
pub fn de_describe_client_vpn_authorization_rules_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_client_vpn_authorization_rules::DescribeClientVpnAuthorizationRulesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_client_vpn_authorization_rules_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_client_vpn_authorization_rules::de_describe_client_vpn_authorization_rules(_response_body, output)
                .map_err(crate::operation::describe_client_vpn_authorization_rules::DescribeClientVpnAuthorizationRulesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_client_vpn_authorization_rules(
    inp: &[u8],
    mut builder: crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeClientVpnAuthorizationRulesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeClientVpnAuthorizationRulesResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("authorizationRule") /* AuthorizationRules com.amazonaws.ec2.synthetic#DescribeClientVpnAuthorizationRulesOutput$AuthorizationRules */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_authorization_rule_set::de_authorization_rule_set(&mut tag, depth + 1)
                        ?
                    )
                ;
