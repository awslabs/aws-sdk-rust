...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_traffic_mirror_targets::de_describe_traffic_mirror_targets(_response_body, output)
            .map_err(crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_traffic_mirror_targets(
    inp: &[u8],
    mut builder: crate::operation::describe_traffic_mirror_targets::builders::DescribeTrafficMirrorTargetsOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_traffic_mirror_targets::builders::DescribeTrafficMirrorTargetsOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeTrafficMirrorTargetsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeTrafficMirrorTargetsResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("trafficMirrorTargetSet") /* TrafficMirrorTargets com.amazonaws.ec2.synthetic#DescribeTrafficMirrorTargetsOutput$TrafficMirrorTargets */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_traffic_mirror_target_set::de_traffic_mirror_target_set(&mut tag, depth + 1)
                        ?
                    )
                ;
