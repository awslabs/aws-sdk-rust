...
pub fn de_describe_traffic_mirror_targets_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsOutput, crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_traffic_mirror_targets_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsOutput, crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_describe_traffic_mirror_targets::de_describe_traffic_mirror_targets(_response_body, output).map_err(crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError::unhandled)?;
