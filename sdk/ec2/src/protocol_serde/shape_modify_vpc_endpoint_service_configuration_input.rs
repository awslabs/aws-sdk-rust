...
pub fn ser_modify_vpc_endpoint_service_configuration_input_input(input: &crate::input::ModifyVpcEndpointServiceConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
