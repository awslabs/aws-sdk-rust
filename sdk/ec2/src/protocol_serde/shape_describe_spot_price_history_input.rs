...
pub fn ser_describe_spot_price_history_input_input(input: &crate::input::DescribeSpotPriceHistoryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
