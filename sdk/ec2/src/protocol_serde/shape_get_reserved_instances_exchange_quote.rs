...
pub fn de_get_reserved_instances_exchange_quote_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteOutput, crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_reserved_instances_exchange_quote_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteOutput, crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError> {
    Ok({
        #[allow(unused_mut)]
