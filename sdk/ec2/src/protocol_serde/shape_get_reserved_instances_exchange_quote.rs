...
pub fn de_get_reserved_instances_exchange_quote_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_reserved_instances_exchange_quote_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_reserved_instances_exchange_quote::de_get_reserved_instances_exchange_quote(_response_body, output)
            .map_err(crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_reserved_instances_exchange_quote(
    inp: &[u8],
    mut builder: crate::operation::get_reserved_instances_exchange_quote::builders::GetReservedInstancesExchangeQuoteOutputBuilder,
) -> Result<
    crate::operation::get_reserved_instances_exchange_quote::builders::GetReservedInstancesExchangeQuoteOutputBuilder,
