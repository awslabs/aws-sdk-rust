...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_reserved_instances_exchange_quote_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteOutput, crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError>{
    Ok({
        #[allow(unused_mut)]
