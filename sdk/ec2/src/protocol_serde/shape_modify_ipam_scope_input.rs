...
pub fn ser_modify_ipam_scope_input_input(input: &crate::input::ModifyIpamScopeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
