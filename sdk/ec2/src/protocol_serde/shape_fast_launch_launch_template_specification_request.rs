...
#[allow(unused_mut)]
pub fn ser_fast_launch_launch_template_specification_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::FastLaunchLaunchTemplateSpecificationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
