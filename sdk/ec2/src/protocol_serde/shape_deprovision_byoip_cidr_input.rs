...
pub fn ser_deprovision_byoip_cidr_input_input(input: &crate::input::DeprovisionByoipCidrInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
