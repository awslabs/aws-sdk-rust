...
pub fn ser_deprovision_byoip_cidr_input_input_input(input: &crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
