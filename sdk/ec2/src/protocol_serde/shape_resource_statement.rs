...
pub fn de_resource_statement(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResourceStatement, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
