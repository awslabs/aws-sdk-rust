...
pub fn de_create_fleet_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CreateFleetInstance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
