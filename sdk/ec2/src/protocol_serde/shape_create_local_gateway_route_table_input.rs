...
pub fn ser_create_local_gateway_route_table_input_input_input(input: &crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
