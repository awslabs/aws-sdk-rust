...
pub fn de_instance_storage_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceStorageInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
