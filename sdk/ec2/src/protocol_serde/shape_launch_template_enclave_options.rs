...
pub fn de_launch_template_enclave_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateEnclaveOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
