...
pub fn de_peering_connection_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PeeringConnectionOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
