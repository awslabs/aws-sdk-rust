...
pub fn ser_modify_id_format_input_input(input: &crate::input::ModifyIdFormatInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
