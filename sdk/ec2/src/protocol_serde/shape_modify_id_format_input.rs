...
pub fn ser_modify_id_format_input_input_input(input: &crate::operation::modify_id_format::ModifyIdFormatInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
