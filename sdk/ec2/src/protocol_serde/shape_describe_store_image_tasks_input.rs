...
pub fn ser_describe_store_image_tasks_input_input_input(input: &crate::operation::describe_store_image_tasks::DescribeStoreImageTasksInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
