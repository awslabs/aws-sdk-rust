...
pub fn de_availability_zone_message(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AvailabilityZoneMessage, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
