...
pub fn de_cpu_options(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::CpuOptions, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("nestedVirtualization") /* NestedVirtualization com.amazonaws.ec2#CpuOptions$NestedVirtualization */ =>  {
                let var_4 =
                    Some(
