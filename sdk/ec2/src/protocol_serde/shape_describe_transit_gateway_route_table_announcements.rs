...
pub fn de_describe_transit_gateway_route_table_announcements_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_transit_gateway_route_table_announcements_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_transit_gateway_route_table_announcements::de_describe_transit_gateway_route_table_announcements(
                _response_body,
                output,
            )
            .map_err(
