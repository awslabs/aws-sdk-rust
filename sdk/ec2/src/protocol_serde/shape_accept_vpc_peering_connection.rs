...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_accept_vpc_peering_connection_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_accept_vpc_peering_connection::de_accept_vpc_peering_connection(_response_body, output)
            .map_err(crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError::unhandled)?;
...
pub fn de_accept_vpc_peering_connection(
    inp: &[u8],
    mut builder: crate::operation::accept_vpc_peering_connection::builders::AcceptVpcPeeringConnectionOutputBuilder,
) -> Result<
    crate::operation::accept_vpc_peering_connection::builders::AcceptVpcPeeringConnectionOutputBuilder,
