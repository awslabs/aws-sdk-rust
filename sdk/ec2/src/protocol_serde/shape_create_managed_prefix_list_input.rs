...
pub fn ser_create_managed_prefix_list_input_input_input(input: &crate::operation::create_managed_prefix_list::CreateManagedPrefixListInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
