...
pub fn de_fpga_device_info(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::FpgaDeviceInfo, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("memoryInfo") /* MemoryInfo com.amazonaws.ec2#FpgaDeviceInfo$MemoryInfo */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_fpga_device_memory_info::de_fpga_device_memory_info(&mut tag, depth + 1)
                        ?
                    )
                ;
