...
pub fn ser_get_ipam_pool_cidrs_input_input(input: &crate::input::GetIpamPoolCidrsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
