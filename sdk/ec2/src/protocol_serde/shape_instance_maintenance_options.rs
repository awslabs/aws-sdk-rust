...
pub fn de_instance_maintenance_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceMaintenanceOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
