...
pub fn de_provision_public_ipv4_pool_cidr_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::provision_public_ipv4_pool_cidr::ProvisionPublicIpv4PoolCidrOutput, crate::operation::provision_public_ipv4_pool_cidr::ProvisionPublicIpv4PoolCidrError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_provision_public_ipv4_pool_cidr_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::provision_public_ipv4_pool_cidr::ProvisionPublicIpv4PoolCidrOutput, crate::operation::provision_public_ipv4_pool_cidr::ProvisionPublicIpv4PoolCidrError> {
    Ok({
        #[allow(unused_mut)]
