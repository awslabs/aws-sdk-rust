...
pub fn ser_modify_ipam_resource_discovery_input_input(input: &crate::operation::modify_ipam_resource_discovery::ModifyIpamResourceDiscoveryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
