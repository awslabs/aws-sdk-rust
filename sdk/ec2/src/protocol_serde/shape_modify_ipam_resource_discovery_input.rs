...
pub fn ser_modify_ipam_resource_discovery_input_input_input(input: &crate::operation::modify_ipam_resource_discovery::ModifyIpamResourceDiscoveryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
