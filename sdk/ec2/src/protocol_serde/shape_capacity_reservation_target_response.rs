...
pub fn de_capacity_reservation_target_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CapacityReservationTargetResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
