...
#[allow(unused_mut)]
pub fn ser_deregister_instance_tag_attribute_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DeregisterInstanceTagAttributeRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
