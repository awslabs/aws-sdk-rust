...
pub fn de_describe_security_group_rules_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesOutput, crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_security_group_rules_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesOutput, crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_security_group_rules::builders::DescribeSecurityGroupRulesOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_security_group_rules::de_describe_security_group_rules(_response_body, output).map_err(crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError::unhandled)?;
