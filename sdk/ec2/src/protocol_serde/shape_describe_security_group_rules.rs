...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_security_group_rules_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_security_group_rules::de_describe_security_group_rules(_response_body, output)
            .map_err(crate::operation::describe_security_group_rules::DescribeSecurityGroupRulesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_security_group_rules(
    inp: &[u8],
    mut builder: crate::operation::describe_security_group_rules::builders::DescribeSecurityGroupRulesOutputBuilder,
) -> Result<
    crate::operation::describe_security_group_rules::builders::DescribeSecurityGroupRulesOutputBuilder,
