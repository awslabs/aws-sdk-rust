...
pub fn ser_describe_stale_security_groups_input_input(input: &crate::input::DescribeStaleSecurityGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
