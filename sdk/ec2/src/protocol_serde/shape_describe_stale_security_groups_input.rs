...
pub fn ser_describe_stale_security_groups_input_input_input(input: &crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
