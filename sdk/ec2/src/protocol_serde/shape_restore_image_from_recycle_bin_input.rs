...
pub fn ser_restore_image_from_recycle_bin_input_input(input: &crate::input::RestoreImageFromRecycleBinInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
