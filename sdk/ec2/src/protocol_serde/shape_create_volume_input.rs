...
pub fn ser_create_volume_input_input_input(input: &crate::operation::create_volume::CreateVolumeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
