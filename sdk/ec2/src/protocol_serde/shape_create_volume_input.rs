...
pub fn ser_create_volume_input_input(input: &crate::input::CreateVolumeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
