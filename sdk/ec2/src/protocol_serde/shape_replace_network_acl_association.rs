...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_replace_network_acl_association::de_replace_network_acl_association(_response_body, output)
            .map_err(crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError::unhandled)?;
