...
pub fn ser_describe_identity_id_format_input_input_input(input: &crate::operation::describe_identity_id_format::DescribeIdentityIdFormatInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
