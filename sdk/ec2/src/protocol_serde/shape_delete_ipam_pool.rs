...
pub fn de_delete_ipam_pool_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_ipam_pool_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_ipam_pool::DeleteIpamPoolOutput, crate::operation::delete_ipam_pool::DeleteIpamPoolError> {
...
pub fn de_delete_ipam_pool(
...
) -> std::result::Result<crate::operation::delete_ipam_pool::builders::DeleteIpamPoolOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DeleteIpamPoolResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteIpamPoolResponse got {start_el:?}"
        )));
    }
