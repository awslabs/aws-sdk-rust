...
pub fn ser_describe_ipam_scopes_input_input(input: &crate::operation::describe_ipam_scopes::DescribeIpamScopesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
