...
pub fn ser_describe_ipam_scopes_input_input_input(input: &crate::operation::describe_ipam_scopes::DescribeIpamScopesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_13) = &input.ipam_scope_ids {
