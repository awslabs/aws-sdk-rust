...
pub fn de_transit_gateway_policy_table_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayPolicyTableAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
