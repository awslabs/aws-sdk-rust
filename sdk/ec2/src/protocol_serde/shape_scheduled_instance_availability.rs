...
pub fn de_scheduled_instance_availability(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScheduledInstanceAvailability, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
