...
pub fn ser_describe_instance_sql_ha_states_input_input_input(
    input: &crate::operation::describe_instance_sql_ha_states::DescribeInstanceSqlHaStatesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeInstanceSqlHaStates", "2016-11-15");
    #[allow(unused_mut)]
