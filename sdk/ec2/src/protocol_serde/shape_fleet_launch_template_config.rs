...
pub fn de_fleet_launch_template_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FleetLaunchTemplateConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
