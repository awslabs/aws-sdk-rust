...
pub fn ser_create_dhcp_options_input_input_input(input: &crate::operation::create_dhcp_options::CreateDhcpOptionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
