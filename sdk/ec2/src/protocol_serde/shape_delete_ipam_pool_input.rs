...
pub fn ser_delete_ipam_pool_input_input_input(input: &crate::operation::delete_ipam_pool::DeleteIpamPoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
