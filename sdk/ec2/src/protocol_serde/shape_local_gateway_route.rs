...
pub fn de_local_gateway_route(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LocalGatewayRoute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
