...
pub fn de_transit_gateway_attachment_propagation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayAttachmentPropagation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
