...
pub fn de_volume_attachment(
...
) -> ::std::result::Result<crate::types::VolumeAttachment, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("ebsCardIndex") /* EbsCardIndex com.amazonaws.ec2#VolumeAttachment$EbsCardIndex */ =>  {
                let var_4 =
                    Some(
                         {
