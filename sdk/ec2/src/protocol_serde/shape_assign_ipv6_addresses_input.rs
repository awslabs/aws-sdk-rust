...
pub fn ser_assign_ipv6_addresses_input_input(input: &crate::input::AssignIpv6AddressesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
