...
pub fn ser_assign_ipv6_addresses_input_input_input(input: &crate::operation::assign_ipv6_addresses::AssignIpv6AddressesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
