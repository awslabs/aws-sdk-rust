...
pub fn ser_delete_client_vpn_endpoint_input_input_input(input: &crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
