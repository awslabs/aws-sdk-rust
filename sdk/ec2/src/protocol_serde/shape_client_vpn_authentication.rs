...
pub fn de_client_vpn_authentication(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnAuthentication, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
