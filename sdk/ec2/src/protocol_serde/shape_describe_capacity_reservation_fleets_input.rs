...
pub fn ser_describe_capacity_reservation_fleets_input_input_input(input: &crate::operation::describe_capacity_reservation_fleets::DescribeCapacityReservationFleetsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.capacity_reservation_fleet_ids {
