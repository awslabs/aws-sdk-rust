...
pub fn ser_describe_capacity_reservation_fleets_input_input(input: &crate::input::DescribeCapacityReservationFleetsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
