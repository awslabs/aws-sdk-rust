...
pub fn ser_describe_local_gateway_route_tables_input_input_input(
    input: &crate::operation::describe_local_gateway_route_tables::DescribeLocalGatewayRouteTablesInput,
