...
pub fn de_reject_transit_gateway_peering_attachment_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::reject_transit_gateway_peering_attachment::RejectTransitGatewayPeeringAttachmentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reject_transit_gateway_peering_attachment_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_reject_transit_gateway_peering_attachment::de_reject_transit_gateway_peering_attachment(
            _response_body,
            output,
        )
        .map_err(crate::operation::reject_transit_gateway_peering_attachment::RejectTransitGatewayPeeringAttachmentError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_reject_transit_gateway_peering_attachment(
    inp: &[u8],
    mut builder: crate::operation::reject_transit_gateway_peering_attachment::builders::RejectTransitGatewayPeeringAttachmentOutputBuilder,
) -> Result<
    crate::operation::reject_transit_gateway_peering_attachment::builders::RejectTransitGatewayPeeringAttachmentOutputBuilder,
