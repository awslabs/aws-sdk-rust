...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_fleet_instances::de_describe_fleet_instances(
                _response_body,
                output,
            )
            .map_err(
                crate::operation::describe_fleet_instances::DescribeFleetInstancesError::unhandled,
            )?;
