...
pub fn ser_describe_local_gateway_virtual_interfaces_input_input_input(input: &crate::operation::describe_local_gateway_virtual_interfaces::DescribeLocalGatewayVirtualInterfacesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeLocalGatewayVirtualInterfaces", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("LocalGatewayVirtualInterfaceId");
    if let Some(var_2) = &input.local_gateway_virtual_interface_ids {
