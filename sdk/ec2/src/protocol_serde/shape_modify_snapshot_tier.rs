...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_snapshot_tier::de_modify_snapshot_tier(_response_body, output)
            .map_err(crate::operation::modify_snapshot_tier::ModifySnapshotTierError::unhandled)?;
...
) -> std::result::Result<crate::operation::modify_snapshot_tier::builders::ModifySnapshotTierOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("ModifySnapshotTierResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifySnapshotTierResponse got {start_el:?}"
        )));
    }
