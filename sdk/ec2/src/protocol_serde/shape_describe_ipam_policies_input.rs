...
pub fn ser_describe_ipam_policies_input_input_input(
    input: &crate::operation::describe_ipam_policies::DescribeIpamPoliciesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeIpamPolicies", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("IpamPolicyId");
    if let Some(var_13) = &input.ipam_policy_ids {
        if !var_13.is_empty() {
