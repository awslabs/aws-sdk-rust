...
pub fn ser_modify_address_attribute_input_input_input(input: &crate::operation::modify_address_attribute::ModifyAddressAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
