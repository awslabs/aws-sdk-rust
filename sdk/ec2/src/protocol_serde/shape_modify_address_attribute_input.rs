...
pub fn ser_modify_address_attribute_input_input(input: &crate::input::ModifyAddressAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
