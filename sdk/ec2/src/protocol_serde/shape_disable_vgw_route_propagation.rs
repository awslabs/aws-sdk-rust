...
> {
    ...
    .map_err(
        crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError::unhandled,
    )?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(
        crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError::generic(
            generic,
        ),
    )
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_vgw_route_propagation_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
