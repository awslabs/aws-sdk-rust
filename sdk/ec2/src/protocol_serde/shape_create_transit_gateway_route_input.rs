...
pub fn ser_create_transit_gateway_route_input_input_input(input: &crate::operation::create_transit_gateway_route::CreateTransitGatewayRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("TransitGatewayRouteTableId");
    if let Some(var_4) = &input.transit_gateway_route_table_id {
