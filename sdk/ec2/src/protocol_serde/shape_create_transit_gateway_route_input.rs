...
pub fn ser_create_transit_gateway_route_input_input(input: &crate::operation::create_transit_gateway_route::CreateTransitGatewayRouteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
