...
pub fn ser_terminate_instances_input_input(input: &crate::input::TerminateInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
