...
pub fn ser_create_transit_gateway_multicast_domain_input_input(input: &crate::input::CreateTransitGatewayMulticastDomainInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
