...
pub fn ser_describe_moving_addresses_input_input(input: &crate::input::DescribeMovingAddressesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
