...
pub fn ser_describe_moving_addresses_input_input_input(input: &crate::operation::describe_moving_addresses::DescribeMovingAddressesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
