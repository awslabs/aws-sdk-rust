...
pub fn ser_revoke_client_vpn_ingress_input_input(input: &crate::input::RevokeClientVpnIngressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
