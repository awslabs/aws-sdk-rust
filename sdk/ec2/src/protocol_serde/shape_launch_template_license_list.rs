...
pub fn de_launch_template_license_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::LaunchTemplateLicenseConfiguration>, aws_smithy_xml::decode::XmlDecodeError> {
