...
pub fn ser_create_egress_only_internet_gateway_input_input(input: &crate::input::CreateEgressOnlyInternetGatewayInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
