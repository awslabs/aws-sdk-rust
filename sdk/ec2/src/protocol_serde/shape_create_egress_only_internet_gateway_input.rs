...
pub fn ser_create_egress_only_internet_gateway_input_input_input(input: &crate::operation::create_egress_only_internet_gateway::CreateEgressOnlyInternetGatewayInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
