...
pub fn ser_create_internet_gateway_input_input_input(input: &crate::operation::create_internet_gateway::CreateInternetGatewayInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
