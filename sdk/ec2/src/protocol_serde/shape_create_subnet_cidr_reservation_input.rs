...
pub fn ser_create_subnet_cidr_reservation_input_input_input(input: &crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
