...
pub fn de_transit_gateway_multicast_domain_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayMulticastDomainOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
