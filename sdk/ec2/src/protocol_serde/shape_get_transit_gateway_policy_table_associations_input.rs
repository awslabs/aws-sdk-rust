...
pub fn ser_get_transit_gateway_policy_table_associations_input_input(input: &crate::input::GetTransitGatewayPolicyTableAssociationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
