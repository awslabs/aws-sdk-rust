...
pub fn ser_describe_volumes_input_input(input: &crate::operation::describe_volumes::DescribeVolumesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
