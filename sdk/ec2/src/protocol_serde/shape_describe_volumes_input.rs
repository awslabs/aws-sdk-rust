...
pub fn ser_describe_volumes_input_input_input(input: &crate::operation::describe_volumes::DescribeVolumesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("VolumeId");
    if let Some(var_7) = &input.volume_ids {
        let mut list_9 = scope_6.start_list(true, Some("VolumeId"));
        for item_8 in var_7 {
            #[allow(unused_mut)]
