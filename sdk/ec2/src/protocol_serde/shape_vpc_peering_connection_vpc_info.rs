...
pub fn de_vpc_peering_connection_vpc_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcPeeringConnectionVpcInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
