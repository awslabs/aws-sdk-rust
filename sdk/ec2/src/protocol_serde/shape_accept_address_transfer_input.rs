...
pub fn ser_accept_address_transfer_input_input_input(input: &crate::operation::accept_address_transfer::AcceptAddressTransferInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
