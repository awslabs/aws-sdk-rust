...
pub fn ser_accept_address_transfer_input_input(input: &crate::input::AcceptAddressTransferInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
