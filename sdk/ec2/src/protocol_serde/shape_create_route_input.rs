...
pub fn ser_create_route_input_input(input: &crate::input::CreateRouteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
