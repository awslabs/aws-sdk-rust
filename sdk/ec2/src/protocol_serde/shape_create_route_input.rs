...
pub fn ser_create_route_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_15 = writer.prefix("RouteTableId");
    if let Some(var_16) = &input.route_table_id {
    ...
    #[allow(unused_mut)]
    let mut scope_19 = writer.prefix("GatewayId");
    if let Some(var_20) = &input.gateway_id {
        scope_19.string(var_20);
    }
    #[allow(unused_mut)]
    let mut scope_21 = writer.prefix("DestinationIpv6CidrBlock");
    if let Some(var_22) = &input.destination_ipv6_cidr_block {
        scope_21.string(var_22);
    }
    #[allow(unused_mut)]
    let mut scope_23 = writer.prefix("EgressOnlyInternetGatewayId");
    if let Some(var_24) = &input.egress_only_internet_gateway_id {
        scope_23.string(var_24);
    }
    #[allow(unused_mut)]
    let mut scope_25 = writer.prefix("InstanceId");
    if let Some(var_26) = &input.instance_id {
    ...
    #[allow(unused_mut)]
    let mut scope_31 = writer.prefix("NatGatewayId");
    if let Some(var_32) = &input.nat_gateway_id {
