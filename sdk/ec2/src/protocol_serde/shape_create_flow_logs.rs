...
pub fn de_create_flow_logs_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_flow_logs_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_flow_logs::CreateFlowLogsOutput, crate::operation::create_flow_logs::CreateFlowLogsError> {
...
) -> std::result::Result<crate::operation::create_flow_logs::builders::CreateFlowLogsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
