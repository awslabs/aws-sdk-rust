...
pub fn ser_describe_secondary_networks_input_input_input(
    input: &crate::operation::describe_secondary_networks::DescribeSecondaryNetworksInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeSecondaryNetworks", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("SecondaryNetworkId");
    if let Some(var_13) = &input.secondary_network_ids {
        if !var_13.is_empty() {
