...
pub fn de_local_gateway_route_table(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LocalGatewayRouteTable, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
