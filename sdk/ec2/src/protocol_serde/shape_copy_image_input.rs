...
pub fn ser_copy_image_input_input_input(input: &crate::operation::copy_image::CopyImageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
