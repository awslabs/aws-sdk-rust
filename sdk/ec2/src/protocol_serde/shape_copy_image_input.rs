...
pub fn ser_copy_image_input_input(input: &crate::input::CopyImageInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
