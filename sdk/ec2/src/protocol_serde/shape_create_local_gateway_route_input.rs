...
pub fn ser_create_local_gateway_route_input_input(input: &crate::input::CreateLocalGatewayRouteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
