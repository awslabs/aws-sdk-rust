...
pub fn ser_create_local_gateway_route_input_input_input(input: &crate::operation::create_local_gateway_route::CreateLocalGatewayRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
