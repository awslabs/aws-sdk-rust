...
pub fn de_transit_gateway_multicast_deregistered_group_sources(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TransitGatewayMulticastDeregisteredGroupSources, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
