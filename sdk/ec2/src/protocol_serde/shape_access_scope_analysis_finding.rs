...
pub fn de_access_scope_analysis_finding(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessScopeAnalysisFinding, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
