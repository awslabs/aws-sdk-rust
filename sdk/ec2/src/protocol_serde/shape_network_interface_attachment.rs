...
pub fn de_network_interface_attachment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::NetworkInterfaceAttachment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
