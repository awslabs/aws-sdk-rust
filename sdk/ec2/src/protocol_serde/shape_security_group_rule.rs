...
pub fn de_security_group_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SecurityGroupRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
