...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_egress_only_internet_gateway::DeleteEgressOnlyInternetGatewayError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_egress_only_internet_gateway::de_delete_egress_only_internet_gateway(_response_body, output)
            .map_err(crate::operation::delete_egress_only_internet_gateway::DeleteEgressOnlyInternetGatewayError::unhandled)?;
