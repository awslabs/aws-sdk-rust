...
pub fn ser_cancel_spot_fleet_requests_input_input_input(input: &crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
