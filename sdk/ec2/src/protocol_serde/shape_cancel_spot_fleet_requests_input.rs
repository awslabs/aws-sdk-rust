...
pub fn ser_cancel_spot_fleet_requests_input_input(input: &crate::input::CancelSpotFleetRequestsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
