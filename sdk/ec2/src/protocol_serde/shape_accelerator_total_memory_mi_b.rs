...
#[allow(unused_mut)]
pub fn ser_accelerator_total_memory_mi_b(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AcceleratorTotalMemoryMiB) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_accelerator_total_memory_mi_b(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AcceleratorTotalMemoryMiB, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
