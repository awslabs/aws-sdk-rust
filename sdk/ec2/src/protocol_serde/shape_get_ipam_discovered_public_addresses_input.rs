...
pub fn ser_get_ipam_discovered_public_addresses_input_input_input(
    input: &crate::operation::get_ipam_discovered_public_addresses::GetIpamDiscoveredPublicAddressesInput,
