...
pub fn ser_get_ipam_discovered_public_addresses_input_input_input(input: &crate::operation::get_ipam_discovered_public_addresses::GetIpamDiscoveredPublicAddressesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "GetIpamDiscoveredPublicAddresses", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_5 = writer.prefix("AddressRegion");
    if let Some(var_6) = &input.address_region {
