...
pub fn ser_get_aws_network_performance_data_input_input_input(input: &crate::operation::get_aws_network_performance_data::GetAwsNetworkPerformanceDataInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
