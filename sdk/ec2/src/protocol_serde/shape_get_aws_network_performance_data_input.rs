...
pub fn ser_get_aws_network_performance_data_input_input(input: &crate::input::GetAwsNetworkPerformanceDataInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
