...
pub fn ser_modify_traffic_mirror_filter_rule_input_input(input: &crate::input::ModifyTrafficMirrorFilterRuleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
