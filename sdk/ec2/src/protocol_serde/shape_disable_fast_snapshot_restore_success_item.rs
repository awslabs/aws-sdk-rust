...
pub fn de_disable_fast_snapshot_restore_success_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DisableFastSnapshotRestoreSuccessItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
