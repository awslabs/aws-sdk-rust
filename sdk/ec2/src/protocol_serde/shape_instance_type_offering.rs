...
pub fn de_instance_type_offering(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceTypeOffering, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
