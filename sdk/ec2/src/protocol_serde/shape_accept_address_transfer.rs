...
pub fn de_accept_address_transfer_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_accept_address_transfer_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::AcceptAddressTransferOutput,
    crate::error::AcceptAddressTransferError,
...
pub fn de_accept_address_transfer(
    inp: &[u8],
    mut builder: crate::output::accept_address_transfer_output::Builder,
) -> Result<
    crate::output::accept_address_transfer_output::Builder,
...
> {
    ...
    if !(start_el.matches("AcceptAddressTransferResponse")) {
        return Err(aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AcceptAddressTransferResponse got {:?}",
            start_el
        )));
    }
