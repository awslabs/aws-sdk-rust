...
pub fn ser_send_diagnostic_interrupt_input_input(input: &crate::input::SendDiagnosticInterruptInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
