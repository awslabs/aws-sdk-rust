...
pub fn ser_send_diagnostic_interrupt_input_input_input(input: &crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
