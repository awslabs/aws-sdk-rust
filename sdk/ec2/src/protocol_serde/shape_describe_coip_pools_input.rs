...
pub fn ser_describe_coip_pools_input_input_input(input: &crate::operation::describe_coip_pools::DescribeCoipPoolsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
