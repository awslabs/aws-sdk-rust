...
pub fn de_associate_iam_instance_profile_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileOutput, crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_iam_instance_profile_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileOutput, crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError> {
    Ok({
        #[allow(unused_mut)]
