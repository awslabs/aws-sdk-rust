...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_security_group_references::de_describe_security_group_references(_response_body, output)
            .map_err(crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesError::unhandled)?;
