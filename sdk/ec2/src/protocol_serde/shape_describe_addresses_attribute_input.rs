...
pub fn ser_describe_addresses_attribute_input_input_input(input: &crate::operation::describe_addresses_attribute::DescribeAddressesAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
