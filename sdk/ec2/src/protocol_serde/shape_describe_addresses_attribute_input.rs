...
pub fn ser_describe_addresses_attribute_input_input(input: &crate::input::DescribeAddressesAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
