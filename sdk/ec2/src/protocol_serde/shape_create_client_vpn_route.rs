...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_client_vpn_route_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_client_vpn_route::de_create_client_vpn_route(_response_body, output)
            .map_err(crate::operation::create_client_vpn_route::CreateClientVpnRouteError::unhandled)?;
...
) -> Result<crate::operation::create_client_vpn_route::builders::CreateClientVpnRouteOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
