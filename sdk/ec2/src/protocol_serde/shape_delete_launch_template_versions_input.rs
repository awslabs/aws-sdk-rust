...
pub fn ser_delete_launch_template_versions_input_input_input(input: &crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
