...
pub fn ser_delete_launch_template_versions_input_input(input: &crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
