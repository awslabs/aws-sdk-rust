...
pub fn de_reserved_instances_id(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedInstancesId, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
