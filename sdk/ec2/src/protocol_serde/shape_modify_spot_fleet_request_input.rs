...
pub fn ser_modify_spot_fleet_request_input_input(input: &crate::input::ModifySpotFleetRequestInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
