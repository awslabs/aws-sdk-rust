...
pub fn ser_modify_spot_fleet_request_input_input_input(input: &crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
