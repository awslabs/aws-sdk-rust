...
pub fn de_bundle_task_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::BundleTaskError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::BundleTaskError::builder();
