...
pub fn ser_describe_principal_id_format_input_input_input(input: &crate::operation::describe_principal_id_format::DescribePrincipalIdFormatInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
