...
pub fn ser_describe_principal_id_format_input_input(input: &crate::input::DescribePrincipalIdFormatInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
