...
pub fn ser_disable_fast_snapshot_restores_input_input(input: &crate::input::DisableFastSnapshotRestoresInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
