...
pub fn ser_describe_byoip_cidrs_input_input_input(input: &crate::operation::describe_byoip_cidrs::DescribeByoipCidrsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
