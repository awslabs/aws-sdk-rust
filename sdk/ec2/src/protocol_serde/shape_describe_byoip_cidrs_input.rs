...
pub fn ser_describe_byoip_cidrs_input_input(input: &crate::input::DescribeByoipCidrsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
