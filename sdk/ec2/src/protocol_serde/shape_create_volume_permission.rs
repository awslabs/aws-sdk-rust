...
#[allow(unused_mut)]
pub fn ser_create_volume_permission(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::CreateVolumePermission) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
