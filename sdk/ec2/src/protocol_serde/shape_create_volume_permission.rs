...
#[allow(unused_mut)]
pub fn ser_create_volume_permission(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::CreateVolumePermission) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_create_volume_permission(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CreateVolumePermission, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
