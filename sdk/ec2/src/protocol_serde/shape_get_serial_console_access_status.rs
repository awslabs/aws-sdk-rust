...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_serial_console_access_status::de_get_serial_console_access_status(_response_body, output)
            .map_err(crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusError::unhandled)?;
