...
pub fn de_client_vpn_connection(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnConnection, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
