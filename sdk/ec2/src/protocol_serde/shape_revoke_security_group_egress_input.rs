...
pub fn ser_revoke_security_group_egress_input_input(input: &crate::input::RevokeSecurityGroupEgressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
