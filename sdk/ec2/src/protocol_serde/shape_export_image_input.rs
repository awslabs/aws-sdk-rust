...
pub fn ser_export_image_input_input_input(input: &crate::operation::export_image::ExportImageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
