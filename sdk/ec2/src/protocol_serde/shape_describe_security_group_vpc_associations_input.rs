...
pub fn ser_describe_security_group_vpc_associations_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeSecurityGroupVpcAssociations", "2016-11-15");
    #[allow(unused_mut)]
