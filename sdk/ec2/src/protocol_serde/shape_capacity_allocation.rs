...
pub fn de_capacity_allocation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CapacityAllocation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
