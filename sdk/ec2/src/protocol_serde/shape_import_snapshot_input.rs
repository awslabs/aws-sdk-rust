...
pub fn ser_import_snapshot_input_input_input(input: &crate::operation::import_snapshot::ImportSnapshotInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
