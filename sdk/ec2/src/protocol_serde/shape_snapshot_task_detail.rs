...
pub fn de_snapshot_task_detail(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SnapshotTaskDetail, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
