...
pub fn ser_purchase_host_reservation_input_input(input: &crate::input::PurchaseHostReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
