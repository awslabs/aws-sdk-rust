...
pub fn de_media_accelerator_info(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MediaAcceleratorInfo, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
