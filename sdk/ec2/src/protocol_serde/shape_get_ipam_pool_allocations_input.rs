...
pub fn ser_get_ipam_pool_allocations_input_input_input(input: &crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
