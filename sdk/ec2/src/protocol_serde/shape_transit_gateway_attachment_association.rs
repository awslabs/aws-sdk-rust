...
pub fn de_transit_gateway_attachment_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayAttachmentAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
