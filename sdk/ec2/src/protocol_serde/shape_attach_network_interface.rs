...
pub fn de_attach_network_interface_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_network_interface_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    ...
    if !(start_el.matches("AttachNetworkInterfaceResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AttachNetworkInterfaceResponse got {start_el:?}"
        )));
    }
