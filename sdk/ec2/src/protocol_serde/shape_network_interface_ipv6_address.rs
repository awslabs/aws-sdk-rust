...
pub fn de_network_interface_ipv6_address(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NetworkInterfaceIpv6Address, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
