...
pub fn de_inference_accelerator_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InferenceAcceleratorInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
