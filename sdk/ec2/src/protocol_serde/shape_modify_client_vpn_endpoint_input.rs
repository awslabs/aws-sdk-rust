...
pub fn ser_modify_client_vpn_endpoint_input_input_input(input: &crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
