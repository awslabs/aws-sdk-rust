...
pub fn de_vpc_endpoint_connection(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcEndpointConnection, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
