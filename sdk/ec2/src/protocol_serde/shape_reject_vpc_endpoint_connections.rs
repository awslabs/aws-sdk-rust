...
pub fn de_reject_vpc_endpoint_connections_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::reject_vpc_endpoint_connections::RejectVpcEndpointConnectionsOutput, crate::operation::reject_vpc_endpoint_connections::RejectVpcEndpointConnectionsError> {
    #[allow(unused_mut)]
