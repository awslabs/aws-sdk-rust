...
pub fn ser_describe_mac_modification_tasks_input_input_input(
    input: &crate::operation::describe_mac_modification_tasks::DescribeMacModificationTasksInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeMacModificationTasks", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("MacModificationTaskId");
    if let Some(var_9) = &input.mac_modification_task_ids {
        if !var_9.is_empty() {
