...
pub fn ser_describe_local_gateways_input_input_input(input: &crate::operation::describe_local_gateways::DescribeLocalGatewaysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
