...
pub fn ser_describe_local_gateways_input_input(input: &crate::input::DescribeLocalGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
