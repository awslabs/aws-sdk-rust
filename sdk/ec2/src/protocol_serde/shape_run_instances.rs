...
pub fn de_run_instances_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RunInstancesOutput, crate::error::RunInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::RunInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_run_instances_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RunInstancesOutput, crate::error::RunInstancesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::run_instances_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_run_instances::de_run_instances(response.body().as_ref(), output).map_err(crate::error::RunInstancesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_run_instances(inp: &[u8], mut builder: crate::output::run_instances_output::Builder) -> Result<crate::output::run_instances_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
