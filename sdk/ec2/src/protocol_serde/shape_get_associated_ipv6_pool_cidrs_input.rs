...
pub fn ser_get_associated_ipv6_pool_cidrs_input_input(input: &crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
