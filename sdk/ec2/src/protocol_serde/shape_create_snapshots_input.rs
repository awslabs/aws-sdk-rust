...
pub fn ser_create_snapshots_input_input_input(input: &crate::operation::create_snapshots::CreateSnapshotsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
