...
pub fn ser_modify_launch_template_input_input_input(input: &crate::operation::modify_launch_template::ModifyLaunchTemplateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_9 = writer.prefix("SetDefaultVersion");
    if let Some(var_10) = &input.default_version {
