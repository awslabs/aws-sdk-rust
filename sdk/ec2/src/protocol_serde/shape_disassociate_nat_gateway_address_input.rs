...
pub fn ser_disassociate_nat_gateway_address_input_input(input: &crate::operation::disassociate_nat_gateway_address::DisassociateNatGatewayAddressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
