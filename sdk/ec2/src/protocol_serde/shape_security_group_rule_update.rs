...
#[allow(unused_mut)]
pub fn ser_security_group_rule_update(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SecurityGroupRuleUpdate) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
