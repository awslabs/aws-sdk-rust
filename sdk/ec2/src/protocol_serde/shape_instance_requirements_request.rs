...
#[allow(unused_mut)]
pub fn ser_instance_requirements_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::InstanceRequirementsRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
