...
pub fn de_snapshot_tier_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SnapshotTierStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
