...
pub fn ser_get_vpn_connection_device_types_input_input_input(input: &crate::operation::get_vpn_connection_device_types::GetVpnConnectionDeviceTypesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
