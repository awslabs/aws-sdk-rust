...
pub fn ser_detach_verified_access_trust_provider_input_input_input(input: &crate::operation::detach_verified_access_trust_provider::DetachVerifiedAccessTrustProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
