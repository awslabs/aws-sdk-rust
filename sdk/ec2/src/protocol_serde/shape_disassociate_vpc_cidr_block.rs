...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_vpc_cidr_block::DisassociateVpcCidrBlockError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::disassociate_vpc_cidr_block::DisassociateVpcCidrBlockError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_vpc_cidr_block::de_disassociate_vpc_cidr_block(_response_body, output)
            .map_err(crate::operation::disassociate_vpc_cidr_block::DisassociateVpcCidrBlockError::unhandled)?;
...
) -> Result<crate::operation::disassociate_vpc_cidr_block::builders::DisassociateVpcCidrBlockOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
