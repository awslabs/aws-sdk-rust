...
pub fn ser_describe_local_gateway_route_table_vpc_associations_input_input(input: &crate::input::DescribeLocalGatewayRouteTableVpcAssociationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
