...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_security_group_ingress_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressOutput, crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressError> {
    Ok({
        #[allow(unused_mut)]
