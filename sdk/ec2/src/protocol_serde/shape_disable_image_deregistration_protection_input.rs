...
pub fn ser_disable_image_deregistration_protection_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DisableImageDeregistrationProtection", "2016-11-15");
    #[allow(unused_mut)]
