...
pub fn ser_create_client_vpn_endpoint_input_input_input(input: &crate::operation::create_client_vpn_endpoint::CreateClientVpnEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
