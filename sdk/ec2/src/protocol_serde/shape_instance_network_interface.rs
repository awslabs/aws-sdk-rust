...
pub fn de_instance_network_interface(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceNetworkInterface, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
