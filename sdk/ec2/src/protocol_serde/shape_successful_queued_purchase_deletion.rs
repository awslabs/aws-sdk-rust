...
pub fn de_successful_queued_purchase_deletion(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SuccessfulQueuedPurchaseDeletion, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
