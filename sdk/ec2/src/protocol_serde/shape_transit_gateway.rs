...
pub fn de_transit_gateway(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::TransitGateway, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("options") /* Options com.amazonaws.ec2#TransitGateway$Options */ =>  {
                let var_7 =
                    Some(
                        crate::protocol_serde::shape_transit_gateway_options::de_transit_gateway_options(&mut tag, depth + 1)
                        ?
                    )
                ;
