...
pub fn ser_allocate_address_input_input_input(input: &crate::operation::allocate_address::AllocateAddressInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
