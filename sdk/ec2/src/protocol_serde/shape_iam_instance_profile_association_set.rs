...
pub fn de_iam_instance_profile_association_set(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<::std::vec::Vec<crate::types::IamInstanceProfileAssociation>, ::aws_smithy_xml::decode::XmlDecodeError> {
