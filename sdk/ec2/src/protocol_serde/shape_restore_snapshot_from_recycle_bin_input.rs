...
pub fn ser_restore_snapshot_from_recycle_bin_input_input(input: &crate::input::RestoreSnapshotFromRecycleBinInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
