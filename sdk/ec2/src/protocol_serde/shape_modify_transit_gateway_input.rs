...
pub fn ser_modify_transit_gateway_input_input(input: &crate::input::ModifyTransitGatewayInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
