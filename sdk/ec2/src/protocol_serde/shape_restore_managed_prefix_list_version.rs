...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::restore_managed_prefix_list_version::RestoreManagedPrefixListVersionError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_restore_managed_prefix_list_version::de_restore_managed_prefix_list_version(_response_body, output)
            .map_err(crate::operation::restore_managed_prefix_list_version::RestoreManagedPrefixListVersionError::unhandled)?;
