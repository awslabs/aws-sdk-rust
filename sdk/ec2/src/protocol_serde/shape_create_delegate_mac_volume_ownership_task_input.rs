...
pub fn ser_create_delegate_mac_volume_ownership_task_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateDelegateMacVolumeOwnershipTask", "2016-11-15");
    #[allow(unused_mut)]
