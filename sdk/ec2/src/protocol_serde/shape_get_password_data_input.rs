...
pub fn ser_get_password_data_input_input_input(input: &crate::operation::get_password_data::GetPasswordDataInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
