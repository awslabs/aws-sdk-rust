...
pub fn ser_get_password_data_input_input(input: &crate::input::GetPasswordDataInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
