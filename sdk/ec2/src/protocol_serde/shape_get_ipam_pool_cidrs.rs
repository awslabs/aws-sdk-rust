...
pub fn de_get_ipam_pool_cidrs_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ipam_pool_cidrs_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_ipam_pool_cidrs::GetIpamPoolCidrsOutput, crate::operation::get_ipam_pool_cidrs::GetIpamPoolCidrsError>
...
) -> std::result::Result<crate::operation::get_ipam_pool_cidrs::builders::GetIpamPoolCidrsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
