...
pub fn ser_reject_transit_gateway_peering_attachment_input_input_input(input: &crate::operation::reject_transit_gateway_peering_attachment::RejectTransitGatewayPeeringAttachmentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
