...
pub fn ser_reject_transit_gateway_peering_attachment_input_input(input: &crate::input::RejectTransitGatewayPeeringAttachmentInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
