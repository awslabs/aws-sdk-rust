...
pub fn de_scheduled_instance_recurrence(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScheduledInstanceRecurrence, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
