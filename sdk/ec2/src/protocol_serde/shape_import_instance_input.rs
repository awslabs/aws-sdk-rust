...
pub fn ser_import_instance_input_input(input: &crate::input::ImportInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
