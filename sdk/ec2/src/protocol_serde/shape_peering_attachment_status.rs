...
pub fn de_peering_attachment_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PeeringAttachmentStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
