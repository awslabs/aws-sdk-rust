...
pub fn ser_create_customer_gateway_input_input_input(input: &crate::operation::create_customer_gateway::CreateCustomerGatewayInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
