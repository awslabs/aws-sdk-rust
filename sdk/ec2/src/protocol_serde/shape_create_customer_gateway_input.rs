...
pub fn ser_create_customer_gateway_input_input(input: &crate::input::CreateCustomerGatewayInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
