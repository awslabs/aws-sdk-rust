...
pub fn ser_create_transit_gateway_route_table_announcement_input_input(input: &crate::input::CreateTransitGatewayRouteTableAnnouncementInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
