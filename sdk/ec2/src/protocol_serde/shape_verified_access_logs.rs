...
pub fn de_verified_access_logs(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VerifiedAccessLogs, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::model::VerifiedAccessLogs::builder();
