...
pub fn de_verified_access_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VerifiedAccessInstance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::model::VerifiedAccessInstance::builder();
