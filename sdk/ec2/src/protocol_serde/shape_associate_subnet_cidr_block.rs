...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_subnet_cidr_block_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_subnet_cidr_block::de_associate_subnet_cidr_block(_response_body, output)
            .map_err(crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockError::unhandled)?;
...
) -> Result<crate::operation::associate_subnet_cidr_block::builders::AssociateSubnetCidrBlockOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
