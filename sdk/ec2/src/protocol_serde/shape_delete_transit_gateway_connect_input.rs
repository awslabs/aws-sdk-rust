...
pub fn ser_delete_transit_gateway_connect_input_input(input: &crate::operation::delete_transit_gateway_connect::DeleteTransitGatewayConnectInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
