...
pub fn de_scheduled_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ScheduledInstance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
