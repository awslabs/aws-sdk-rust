...
pub fn ser_modify_verified_access_group_input_input(input: &crate::input::ModifyVerifiedAccessGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
