...
pub fn ser_create_network_acl_input_input(input: &crate::input::CreateNetworkAclInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
