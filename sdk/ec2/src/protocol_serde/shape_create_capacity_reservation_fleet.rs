...
pub fn de_create_capacity_reservation_fleet_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput, crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_capacity_reservation_fleet_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput, crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError> {
    Ok({
        #[allow(unused_mut)]
