...
pub fn de_create_capacity_reservation_fleet_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateCapacityReservationFleetOutput, crate::error::CreateCapacityReservationFleetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateCapacityReservationFleetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_capacity_reservation_fleet_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateCapacityReservationFleetOutput, crate::error::CreateCapacityReservationFleetError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_create_capacity_reservation_fleet(inp: &[u8], mut builder: crate::output::create_capacity_reservation_fleet_output::Builder) -> Result<crate::output::create_capacity_reservation_fleet_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
