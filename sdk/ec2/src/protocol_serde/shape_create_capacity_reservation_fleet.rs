...
pub fn de_create_capacity_reservation_fleet_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput, crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_capacity_reservation_fleet_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput, crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_create_capacity_reservation_fleet::de_create_capacity_reservation_fleet(_response_body, output).map_err(crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError::unhandled)?;
