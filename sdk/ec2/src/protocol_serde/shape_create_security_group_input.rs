...
pub fn ser_create_security_group_input_input_input(input: &crate::operation::create_security_group::CreateSecurityGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
