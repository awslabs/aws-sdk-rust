...
pub fn de_describe_instance_attribute_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeInstanceAttributeOutput, crate::error::DescribeInstanceAttributeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeInstanceAttributeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_instance_attribute_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeInstanceAttributeOutput, crate::error::DescribeInstanceAttributeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_instance_attribute_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_instance_attribute::de_describe_instance_attribute(response.body().as_ref(), output).map_err(crate::error::DescribeInstanceAttributeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_instance_attribute(inp: &[u8], mut builder: crate::output::describe_instance_attribute_output::Builder) -> Result<crate::output::describe_instance_attribute_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
