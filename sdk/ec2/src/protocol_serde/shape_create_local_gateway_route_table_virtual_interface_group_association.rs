...
pub fn de_create_local_gateway_route_table_virtual_interface_group_association_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput, crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_local_gateway_route_table_virtual_interface_group_association_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput, crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationError> {
    Ok({
        #[allow(unused_mut)]
        ...
        let _ = response;
        output = crate::protocol_serde::shape_create_local_gateway_route_table_virtual_interface_group_association::de_create_local_gateway_route_table_virtual_interface_group_association(response.body().as_ref(), output).map_err(crate::operation::create_local_gateway_route_table_virtual_interface_group_association::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationError::unhandled)?;
