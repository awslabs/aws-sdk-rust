...
pub fn ser_replace_route_input_input_input(input: &crate::operation::replace_route::ReplaceRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_17 = writer.prefix("LocalTarget");
    if let Some(var_18) = &input.local_target {
        scope_17.boolean(*var_18);
    }
    #[allow(unused_mut)]
    let mut scope_19 = writer.prefix("NatGatewayId");
    if let Some(var_20) = &input.nat_gateway_id {
        scope_19.string(var_20);
    }
    #[allow(unused_mut)]
    let mut scope_21 = writer.prefix("TransitGatewayId");
    if let Some(var_22) = &input.transit_gateway_id {
        scope_21.string(var_22);
    }
    #[allow(unused_mut)]
    let mut scope_23 = writer.prefix("LocalGatewayId");
    if let Some(var_24) = &input.local_gateway_id {
        scope_23.string(var_24);
    }
    #[allow(unused_mut)]
    let mut scope_25 = writer.prefix("CarrierGatewayId");
    if let Some(var_26) = &input.carrier_gateway_id {
        scope_25.string(var_26);
    }
    #[allow(unused_mut)]
    let mut scope_27 = writer.prefix("NetworkInterfaceId");
    if let Some(var_28) = &input.network_interface_id {
        scope_27.string(var_28);
    }
    #[allow(unused_mut)]
    let mut scope_29 = writer.prefix("RouteTableId");
    if let Some(var_30) = &input.route_table_id {
    ...
    #[allow(unused_mut)]
    let mut scope_33 = writer.prefix("CoreNetworkArn");
    if let Some(var_34) = &input.core_network_arn {
