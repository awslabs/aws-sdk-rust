...
pub fn ser_replace_route_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_5 = writer.prefix("LocalTarget");
    if let Some(var_6) = &input.local_target {
    ...
    #[allow(unused_mut)]
    let mut scope_9 = writer.prefix("LocalGatewayId");
    if let Some(var_10) = &input.local_gateway_id {
        scope_9.string(var_10);
    }
    #[allow(unused_mut)]
    let mut scope_11 = writer.prefix("CarrierGatewayId");
    if let Some(var_12) = &input.carrier_gateway_id {
        scope_11.string(var_12);
    }
    #[allow(unused_mut)]
    let mut scope_13 = writer.prefix("CoreNetworkArn");
    if let Some(var_14) = &input.core_network_arn {
