...
#[allow(unused_mut)]
pub fn ser_placement(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::Placement) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
