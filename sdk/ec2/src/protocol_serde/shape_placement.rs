...
#[allow(unused_mut)]
pub fn ser_placement(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Placement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_placement(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Placement, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
