...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_enable_serial_console_access::de_enable_serial_console_access(_response_body, output)
            .map_err(crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError::unhandled)?;
