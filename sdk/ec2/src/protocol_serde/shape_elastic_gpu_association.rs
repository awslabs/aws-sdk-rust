...
pub fn de_elastic_gpu_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ElasticGpuAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
