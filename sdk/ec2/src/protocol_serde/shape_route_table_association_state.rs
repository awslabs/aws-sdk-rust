...
pub fn de_route_table_association_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RouteTableAssociationState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
