...
#[allow(unused_mut)]
pub fn ser_s3_storage(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::S3Storage) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
