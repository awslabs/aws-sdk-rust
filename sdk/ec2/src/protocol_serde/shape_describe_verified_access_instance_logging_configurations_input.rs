...
pub fn ser_describe_verified_access_instance_logging_configurations_input_input(input: &crate::input::DescribeVerifiedAccessInstanceLoggingConfigurationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
