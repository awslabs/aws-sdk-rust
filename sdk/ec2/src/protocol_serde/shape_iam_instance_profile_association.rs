...
pub fn de_iam_instance_profile_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IamInstanceProfileAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
