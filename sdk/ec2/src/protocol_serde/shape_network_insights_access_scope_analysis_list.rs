...
pub fn de_network_insights_access_scope_analysis_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::NetworkInsightsAccessScopeAnalysis>, aws_smithy_xml::decode::XmlDecodeError> {
