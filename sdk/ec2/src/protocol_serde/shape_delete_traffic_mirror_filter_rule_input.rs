...
pub fn ser_delete_traffic_mirror_filter_rule_input_input(input: &crate::input::DeleteTrafficMirrorFilterRuleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
