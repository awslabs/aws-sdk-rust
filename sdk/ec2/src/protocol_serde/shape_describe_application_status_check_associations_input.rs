...
pub fn ser_describe_application_status_check_associations_input_input_input(
    input: &crate::operation::describe_application_status_check_associations::DescribeApplicationStatusCheckAssociationsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeApplicationStatusCheckAssociations", "2016-11-15");
    #[allow(unused_mut)]
