...
pub fn ser_create_placement_group_input_input(input: &crate::input::CreatePlacementGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
