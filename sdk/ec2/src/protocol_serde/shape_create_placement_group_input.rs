...
pub fn ser_create_placement_group_input_input_input(input: &crate::operation::create_placement_group::CreatePlacementGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
