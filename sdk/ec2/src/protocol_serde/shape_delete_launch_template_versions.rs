...
pub fn de_delete_launch_template_versions_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsOutput, crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_launch_template_versions_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsOutput, crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsError> {
    Ok({
        #[allow(unused_mut)]
