...
pub fn ser_describe_replace_root_volume_tasks_input_input_input(input: &crate::operation::describe_replace_root_volume_tasks::DescribeReplaceRootVolumeTasksInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeReplaceRootVolumeTasks", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("ReplaceRootVolumeTaskId");
    if let Some(var_2) = &input.replace_root_volume_task_ids {
        let mut list_4 = scope_1.start_list(true, Some("ReplaceRootVolumeTaskId"));
        for item_3 in var_2 {
            #[allow(unused_mut)]
