...
pub fn de_describe_ipams_http_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_describe_ipams::de_describe_ipams(
...
) -> Result<crate::output::describe_ipams_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
