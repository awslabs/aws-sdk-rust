...
pub fn ser_get_ipam_address_history_input_input_input(input: &crate::operation::get_ipam_address_history::GetIpamAddressHistoryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
