...
#[allow(unused_mut)]
pub fn ser_user_id_group_pair(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::UserIdGroupPair) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
