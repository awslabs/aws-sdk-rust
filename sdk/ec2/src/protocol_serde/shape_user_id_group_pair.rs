...
#[allow(unused_mut)]
pub fn ser_user_id_group_pair(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::UserIdGroupPair) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_user_id_group_pair(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::UserIdGroupPair, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
