...
pub fn de_verified_access_endpoint_load_balancer_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VerifiedAccessEndpointLoadBalancerOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
