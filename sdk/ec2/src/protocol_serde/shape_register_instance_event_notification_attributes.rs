...
pub fn de_register_instance_event_notification_attributes_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::register_instance_event_notification_attributes::RegisterInstanceEventNotificationAttributesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_instance_event_notification_attributes_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_register_instance_event_notification_attributes::de_register_instance_event_notification_attributes(
            _response_body,
            output,
        )
        .map_err(crate::operation::register_instance_event_notification_attributes::RegisterInstanceEventNotificationAttributesError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("RegisterInstanceEventNotificationAttributesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected RegisterInstanceEventNotificationAttributesResponse got {start_el:?}"
        )));
    }
