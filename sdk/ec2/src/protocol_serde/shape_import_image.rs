...
pub fn de_import_image_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ImportImageOutput, crate::error::ImportImageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ImportImageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_import_image_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ImportImageOutput, crate::error::ImportImageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::import_image_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_import_image::de_import_image(response.body().as_ref(), output).map_err(crate::error::ImportImageError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_import_image(inp: &[u8], mut builder: crate::output::import_image_output::Builder) -> Result<crate::output::import_image_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
