...
pub fn de_import_image_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::import_image::ImportImageOutput, crate::operation::import_image::ImportImageError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_import_image_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::import_image::ImportImageOutput, crate::operation::import_image::ImportImageError> {
    Ok({
        #[allow(unused_mut)]
