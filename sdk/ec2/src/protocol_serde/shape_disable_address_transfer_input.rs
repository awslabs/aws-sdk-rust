...
pub fn ser_disable_address_transfer_input_input_input(input: &crate::operation::disable_address_transfer::DisableAddressTransferInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
