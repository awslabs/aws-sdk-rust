...
pub fn ser_disassociate_security_group_vpc_input_input_input(
    input: &crate::operation::disassociate_security_group_vpc::DisassociateSecurityGroupVpcInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DisassociateSecurityGroupVpc", "2016-11-15");
    #[allow(unused_mut)]
