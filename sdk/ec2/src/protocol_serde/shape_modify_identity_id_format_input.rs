...
pub fn ser_modify_identity_id_format_input_input_input(input: &crate::operation::modify_identity_id_format::ModifyIdentityIdFormatInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
