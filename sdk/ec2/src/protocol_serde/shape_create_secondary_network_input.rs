...
pub fn ser_create_secondary_network_input_input_input(
    input: &crate::operation::create_secondary_network::CreateSecondaryNetworkInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateSecondaryNetwork", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_5 = writer.prefix("Ipv4CidrBlock");
    if let Some(var_6) = &input.ipv4_cidr_block {
        scope_5.string(var_6);
    }
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("NetworkType");
