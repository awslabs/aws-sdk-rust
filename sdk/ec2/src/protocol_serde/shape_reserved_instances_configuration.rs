...
#[allow(unused_mut)]
pub fn ser_reserved_instances_configuration(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ReservedInstancesConfiguration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
