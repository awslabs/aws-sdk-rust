...
pub fn ser_describe_network_insights_paths_input_input(input: &crate::input::DescribeNetworkInsightsPathsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
