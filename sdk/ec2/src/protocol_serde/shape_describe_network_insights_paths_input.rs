...
pub fn ser_describe_network_insights_paths_input_input_input(input: &crate::operation::describe_network_insights_paths::DescribeNetworkInsightsPathsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.network_insights_path_ids {
