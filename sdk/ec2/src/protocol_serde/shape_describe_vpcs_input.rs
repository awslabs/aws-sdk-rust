...
pub fn ser_describe_vpcs_input_input(input: &crate::operation::describe_vpcs::DescribeVpcsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
