...
pub fn ser_describe_vpcs_input_input_input(input: &crate::operation::describe_vpcs::DescribeVpcsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
