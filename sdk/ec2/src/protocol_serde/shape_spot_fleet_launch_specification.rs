...
#[allow(unused_mut)]
pub fn ser_spot_fleet_launch_specification(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SpotFleetLaunchSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_spot_fleet_launch_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotFleetLaunchSpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
