...
pub fn de_launch_template_ebs_block_device(
...
) -> ::std::result::Result<crate::types::LaunchTemplateEbsBlockDevice, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("ebsCardIndex") /* EbsCardIndex com.amazonaws.ec2#LaunchTemplateEbsBlockDevice$EbsCardIndex */ =>  {
                let var_10 =
                    Some(
                         {
                            <i32 as ::aws_smithy_types::primitive::Parse>::parse_smithy_primitive(
                ...
                ;
                builder = builder.set_ebs_card_index(var_10);
            }
            ,
            _ => {}
        }
