...
pub fn de_launch_template_ebs_block_device(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateEbsBlockDevice, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
