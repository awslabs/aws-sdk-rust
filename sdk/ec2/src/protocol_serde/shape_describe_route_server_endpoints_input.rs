...
pub fn ser_describe_route_server_endpoints_input_input_input(
    input: &crate::operation::describe_route_server_endpoints::DescribeRouteServerEndpointsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeRouteServerEndpoints", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("RouteServerEndpointId");
    if let Some(var_2) = &input.route_server_endpoint_ids {
        if !var_2.is_empty() {
