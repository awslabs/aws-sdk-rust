...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::restore_address_to_classic::RestoreAddressToClassicError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::restore_address_to_classic::RestoreAddressToClassicError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_restore_address_to_classic_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_restore_address_to_classic::de_restore_address_to_classic(_response_body, output)
            .map_err(crate::operation::restore_address_to_classic::RestoreAddressToClassicError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_restore_address_to_classic(
    inp: &[u8],
    mut builder: crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicOutputBuilder,
) -> Result<crate::operation::restore_address_to_classic::builders::RestoreAddressToClassicOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
