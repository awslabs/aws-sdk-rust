...
pub fn ser_enable_aws_network_performance_metric_subscription_input_input(input: &crate::input::EnableAwsNetworkPerformanceMetricSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
