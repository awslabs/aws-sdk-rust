...
pub fn ser_create_subnet_input_input(input: &crate::input::CreateSubnetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
