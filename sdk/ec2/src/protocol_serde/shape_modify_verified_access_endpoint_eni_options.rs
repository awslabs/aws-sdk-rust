...
#[allow(unused_mut)]
pub fn ser_modify_verified_access_endpoint_eni_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ModifyVerifiedAccessEndpointEniOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
