...
pub fn ser_create_vpn_gateway_input_input_input(input: &crate::operation::create_vpn_gateway::CreateVpnGatewayInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
