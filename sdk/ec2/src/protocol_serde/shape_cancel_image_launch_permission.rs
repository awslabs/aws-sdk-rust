...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_image_launch_permission::CancelImageLaunchPermissionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_image_launch_permission_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_image_launch_permission::de_cancel_image_launch_permission(_response_body, output)
            .map_err(crate::operation::cancel_image_launch_permission::CancelImageLaunchPermissionError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("CancelImageLaunchPermissionResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CancelImageLaunchPermissionResponse got {:?}",
            start_el
        )));
    }
