...
pub fn ser_disassociate_route_table_input_input(input: &crate::input::DisassociateRouteTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
