...
pub fn de_allocate_address_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::allocate_address::AllocateAddressOutput, crate::operation::allocate_address::AllocateAddressError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_allocate_address_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::allocate_address::AllocateAddressOutput, crate::operation::allocate_address::AllocateAddressError> {
    Ok({
        #[allow(unused_mut)]
