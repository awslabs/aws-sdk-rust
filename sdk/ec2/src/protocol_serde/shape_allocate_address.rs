...
pub fn de_allocate_address_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::allocate_address::AllocateAddressOutput, crate::operation::allocate_address::AllocateAddressError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::allocate_address::AllocateAddressError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_allocate_address_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::allocate_address::AllocateAddressOutput, crate::operation::allocate_address::AllocateAddressError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::allocate_address::builders::AllocateAddressOutputBuilder::default();
        output = crate::protocol_serde::shape_allocate_address::de_allocate_address(_response_body, output).map_err(crate::operation::allocate_address::AllocateAddressError::unhandled)?;
