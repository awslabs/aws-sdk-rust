...
#[allow(clippy::unnecessary_wraps)]
pub fn de_allocate_address_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::allocate_address::AllocateAddressOutput, crate::operation::allocate_address::AllocateAddressError> {
...
) -> Result<crate::operation::allocate_address::builders::AllocateAddressOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
