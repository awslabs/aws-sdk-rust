...
pub fn ser_modify_instance_event_window_input_input(input: &crate::input::ModifyInstanceEventWindowInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
