...
pub fn ser_modify_instance_event_window_input_input_input(input: &crate::operation::modify_instance_event_window::ModifyInstanceEventWindowInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
