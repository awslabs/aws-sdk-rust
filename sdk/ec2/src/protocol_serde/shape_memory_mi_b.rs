...
#[allow(unused_mut)]
pub fn ser_memory_mi_b(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MemoryMiB) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_memory_mi_b(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MemoryMiB, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
