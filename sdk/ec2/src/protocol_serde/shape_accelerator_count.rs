...
#[allow(unused_mut)]
pub fn ser_accelerator_count(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AcceleratorCount) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_accelerator_count(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AcceleratorCount, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::AcceleratorCount::builder();
