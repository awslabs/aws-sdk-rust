...
#[allow(unused_mut)]
pub fn ser_accelerator_count(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::AcceleratorCount) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
