...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_security_groups::de_describe_security_groups(
                _response_body,
                output,
            )
            .map_err(
                crate::operation::describe_security_groups::DescribeSecurityGroupsError::unhandled,
            )?;
