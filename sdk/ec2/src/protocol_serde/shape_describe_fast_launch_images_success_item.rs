...
pub fn de_describe_fast_launch_images_success_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DescribeFastLaunchImagesSuccessItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
