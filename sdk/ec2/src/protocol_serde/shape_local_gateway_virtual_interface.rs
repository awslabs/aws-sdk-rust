...
pub fn de_local_gateway_virtual_interface(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LocalGatewayVirtualInterface, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
