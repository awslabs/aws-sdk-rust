...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ipam_pool_allocations_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_ipam_pool_allocations::de_get_ipam_pool_allocations(_response_body, output)
            .map_err(crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsError::unhandled)?;
...
) -> Result<crate::operation::get_ipam_pool_allocations::builders::GetIpamPoolAllocationsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
