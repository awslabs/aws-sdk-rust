...
pub fn de_create_ipam_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_ipam_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_ipam::CreateIpamOutput, crate::operation::create_ipam::CreateIpamError> {
...
pub fn de_create_ipam(
...
) -> std::result::Result<crate::operation::create_ipam::builders::CreateIpamOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateIpamResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateIpamResponse got {start_el:?}"
        )));
    }
