...
pub fn de_launch_template_instance_metadata_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateInstanceMetadataOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
