...
pub fn ser_describe_fpga_image_attribute_input_input(input: &crate::input::DescribeFpgaImageAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
