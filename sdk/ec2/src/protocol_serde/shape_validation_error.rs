...
pub fn de_validation_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ValidationError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::ValidationError::builder();
