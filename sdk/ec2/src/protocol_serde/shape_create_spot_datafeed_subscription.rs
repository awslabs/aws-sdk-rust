...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_spot_datafeed_subscription::de_create_spot_datafeed_subscription(_response_body, output)
            .map_err(crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionError::unhandled)?;
