...
pub fn de_delete_vpc_block_public_access_exclusion_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_vpc_block_public_access_exclusion::DeleteVpcBlockPublicAccessExclusionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::delete_vpc_block_public_access_exclusion::DeleteVpcBlockPublicAccessExclusionError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_vpc_block_public_access_exclusion_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_vpc_block_public_access_exclusion::de_delete_vpc_block_public_access_exclusion(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_vpc_block_public_access_exclusion::DeleteVpcBlockPublicAccessExclusionError::unhandled)?;
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("vpcBlockPublicAccessExclusion") /* VpcBlockPublicAccessExclusion com.amazonaws.ec2.synthetic#DeleteVpcBlockPublicAccessExclusionOutput$VpcBlockPublicAccessExclusion */ =>  {
                ...
                ;
                builder = builder.set_vpc_block_public_access_exclusion(var_1);
            }
            ,
            _ => {}
        }
