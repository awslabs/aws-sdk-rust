...
pub fn de_instance_tag_notification_attribute(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceTagNotificationAttribute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
