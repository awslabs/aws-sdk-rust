...
pub fn de_spot_instance_request(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotInstanceRequest, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
