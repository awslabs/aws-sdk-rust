...
pub fn ser_describe_mac_hosts_input_input_input(input: &crate::operation::describe_mac_hosts::DescribeMacHostsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeMacHosts", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("HostId");
    if let Some(var_7) = &input.host_ids {
