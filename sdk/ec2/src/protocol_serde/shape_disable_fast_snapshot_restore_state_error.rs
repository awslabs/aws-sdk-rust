...
pub fn de_disable_fast_snapshot_restore_state_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DisableFastSnapshotRestoreStateError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
