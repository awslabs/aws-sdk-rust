...
pub fn ser_create_traffic_mirror_target_input_input(input: &crate::input::CreateTrafficMirrorTargetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
