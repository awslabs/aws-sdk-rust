...
#[allow(unused_mut)]
pub fn ser_peering_connection_options_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PeeringConnectionOptionsRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
