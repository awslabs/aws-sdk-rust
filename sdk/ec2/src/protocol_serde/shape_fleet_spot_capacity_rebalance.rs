...
pub fn de_fleet_spot_capacity_rebalance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FleetSpotCapacityRebalance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
