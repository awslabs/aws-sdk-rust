...
pub fn ser_request_spot_instances_input_input_input(input: &crate::operation::request_spot_instances::RequestSpotInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
