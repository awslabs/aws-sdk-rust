...
pub fn ser_request_spot_instances_input_input(input: &crate::input::RequestSpotInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
