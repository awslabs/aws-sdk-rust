...
pub fn ser_describe_carrier_gateways_input_input_input(input: &crate::operation::describe_carrier_gateways::DescribeCarrierGatewaysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.carrier_gateway_ids {
