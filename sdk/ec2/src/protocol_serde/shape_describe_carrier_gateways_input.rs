...
pub fn ser_describe_carrier_gateways_input_input(input: &crate::input::DescribeCarrierGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
