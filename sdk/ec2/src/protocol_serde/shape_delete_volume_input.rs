...
pub fn ser_delete_volume_input_input_input(input: &crate::operation::delete_volume::DeleteVolumeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
