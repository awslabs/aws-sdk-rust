...
pub fn ser_delete_volume_input_input(input: &crate::operation::delete_volume::DeleteVolumeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
