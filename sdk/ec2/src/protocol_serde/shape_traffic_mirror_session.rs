...
pub fn de_traffic_mirror_session(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrafficMirrorSession, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
