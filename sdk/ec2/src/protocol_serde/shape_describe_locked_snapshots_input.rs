...
pub fn ser_describe_locked_snapshots_input_input_input(input: &crate::operation::describe_locked_snapshots::DescribeLockedSnapshotsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeLockedSnapshots", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_10 = writer.prefix("SnapshotId");
    if let Some(var_11) = &input.snapshot_ids {
        let mut list_13 = scope_10.start_list(true, Some("SnapshotId"));
