...
pub fn ser_delete_traffic_mirror_session_input_input(input: &crate::operation::delete_traffic_mirror_session::DeleteTrafficMirrorSessionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
