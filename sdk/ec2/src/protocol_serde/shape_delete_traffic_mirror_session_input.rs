...
pub fn ser_delete_traffic_mirror_session_input_input_input(input: &crate::operation::delete_traffic_mirror_session::DeleteTrafficMirrorSessionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
