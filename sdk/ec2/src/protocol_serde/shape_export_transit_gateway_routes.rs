...
#[allow(clippy::unnecessary_wraps)]
pub fn de_export_transit_gateway_routes_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesOutput, crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError> {
    Ok({
        #[allow(unused_mut)]
