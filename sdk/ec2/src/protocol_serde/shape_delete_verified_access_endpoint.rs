...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_verified_access_endpoint::de_delete_verified_access_endpoint(_response_body, output)
            .map_err(crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError::unhandled)?;
