...
pub fn de_security_group_identifier(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::SecurityGroupIdentifier, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::SecurityGroupIdentifier::builder();
