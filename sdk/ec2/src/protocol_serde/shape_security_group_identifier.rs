...
pub fn de_security_group_identifier(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SecurityGroupIdentifier, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
