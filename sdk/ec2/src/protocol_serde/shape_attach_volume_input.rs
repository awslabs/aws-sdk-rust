...
pub fn ser_attach_volume_input_input(input: &crate::input::AttachVolumeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
