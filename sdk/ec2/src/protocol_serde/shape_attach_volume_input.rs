...
pub fn ser_attach_volume_input_input_input(input: &crate::operation::attach_volume::AttachVolumeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
