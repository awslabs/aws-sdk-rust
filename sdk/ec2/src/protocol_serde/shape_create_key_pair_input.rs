...
pub fn ser_create_key_pair_input_input_input(input: &crate::operation::create_key_pair::CreateKeyPairInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
