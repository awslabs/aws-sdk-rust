...
pub fn de_register_transit_gateway_multicast_group_members_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::register_transit_gateway_multicast_group_members::RegisterTransitGatewayMulticastGroupMembersError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_transit_gateway_multicast_group_members_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_register_transit_gateway_multicast_group_members::de_register_transit_gateway_multicast_group_members(
            _response_body,
            output,
        )
        .map_err(crate::operation::register_transit_gateway_multicast_group_members::RegisterTransitGatewayMulticastGroupMembersError::unhandled)?;
