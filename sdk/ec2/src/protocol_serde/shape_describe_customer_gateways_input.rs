...
pub fn ser_describe_customer_gateways_input_input_input(input: &crate::operation::describe_customer_gateways::DescribeCustomerGatewaysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.customer_gateway_ids {
        let mut list_4 = scope_1.start_list(true, Some("CustomerGatewayId"));
        for item_3 in var_2 {
            #[allow(unused_mut)]
