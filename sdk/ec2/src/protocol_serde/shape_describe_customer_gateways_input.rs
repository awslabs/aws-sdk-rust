...
pub fn ser_describe_customer_gateways_input_input(input: &crate::operation::describe_customer_gateways::DescribeCustomerGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
