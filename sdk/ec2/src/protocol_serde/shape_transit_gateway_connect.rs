...
pub fn de_transit_gateway_connect(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TransitGatewayConnect, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
