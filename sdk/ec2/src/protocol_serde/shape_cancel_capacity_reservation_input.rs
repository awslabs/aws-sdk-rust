...
pub fn ser_cancel_capacity_reservation_input_input(input: &crate::input::CancelCapacityReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
