...
pub fn ser_cancel_capacity_reservation_input_input(input: &crate::operation::cancel_capacity_reservation::CancelCapacityReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
