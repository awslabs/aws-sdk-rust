...
pub fn ser_cancel_capacity_reservation_input_input_input(input: &crate::operation::cancel_capacity_reservation::CancelCapacityReservationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
