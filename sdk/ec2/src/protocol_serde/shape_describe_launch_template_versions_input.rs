...
pub fn ser_describe_launch_template_versions_input_input(input: &crate::input::DescribeLaunchTemplateVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
