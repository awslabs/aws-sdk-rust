...
pub fn de_replace_route_table_association_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationOutput, crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError> {
    #[allow(unused_mut)]
