...
pub fn de_transit_gateway_multicast_registered_group_members(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayMulticastRegisteredGroupMembers, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
