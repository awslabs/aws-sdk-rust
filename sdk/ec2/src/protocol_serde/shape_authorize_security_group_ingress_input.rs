...
pub fn ser_authorize_security_group_ingress_input_input(input: &crate::input::AuthorizeSecurityGroupIngressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
