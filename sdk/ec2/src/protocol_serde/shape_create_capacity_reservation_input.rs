...
pub fn ser_create_capacity_reservation_input_input_input(input: &crate::operation::create_capacity_reservation::CreateCapacityReservationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
