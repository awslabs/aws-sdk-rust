...
pub fn ser_create_capacity_reservation_input_input(input: &crate::input::CreateCapacityReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
