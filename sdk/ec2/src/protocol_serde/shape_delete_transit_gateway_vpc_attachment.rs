...
pub fn de_delete_transit_gateway_vpc_attachment_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_transit_gateway_vpc_attachment_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_transit_gateway_vpc_attachment::de_delete_transit_gateway_vpc_attachment(_response_body, output)
            .map_err(crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DeleteTransitGatewayVpcAttachmentResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteTransitGatewayVpcAttachmentResponse got {start_el:?}"
        )));
    }
