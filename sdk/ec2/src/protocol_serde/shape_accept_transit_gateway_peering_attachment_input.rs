...
pub fn ser_accept_transit_gateway_peering_attachment_input_input(input: &crate::operation::accept_transit_gateway_peering_attachment::AcceptTransitGatewayPeeringAttachmentInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
