...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disable_ebs_encryption_by_default::de_disable_ebs_encryption_by_default(_response_body, output)
            .map_err(crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DisableEbsEncryptionByDefaultResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DisableEbsEncryptionByDefaultResponse got {start_el:?}"
        )));
    }
