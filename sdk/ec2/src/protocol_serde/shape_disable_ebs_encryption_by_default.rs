...
pub fn de_disable_ebs_encryption_by_default_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput, crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_ebs_encryption_by_default_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput, crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError> {
    Ok({
        #[allow(unused_mut)]
