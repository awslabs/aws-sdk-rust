...
pub fn ser_update_security_group_rule_descriptions_egress_input_input(input: &crate::input::UpdateSecurityGroupRuleDescriptionsEgressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
