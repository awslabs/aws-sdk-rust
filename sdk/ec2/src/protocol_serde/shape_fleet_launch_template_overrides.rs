...
pub fn de_fleet_launch_template_overrides(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FleetLaunchTemplateOverrides, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
