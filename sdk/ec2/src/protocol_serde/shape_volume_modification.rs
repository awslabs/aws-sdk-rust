...
pub fn de_volume_modification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VolumeModification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
