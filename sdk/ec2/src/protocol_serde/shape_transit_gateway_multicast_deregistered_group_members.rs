...
pub fn de_transit_gateway_multicast_deregistered_group_members(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayMulticastDeregisteredGroupMembers, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
