...
pub fn ser_modify_instance_placement_input_input(input: &crate::input::ModifyInstancePlacementInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
