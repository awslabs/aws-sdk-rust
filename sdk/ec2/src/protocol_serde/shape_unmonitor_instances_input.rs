...
pub fn ser_unmonitor_instances_input_input(input: &crate::operation::unmonitor_instances::UnmonitorInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
