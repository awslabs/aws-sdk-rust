...
pub fn ser_unmonitor_instances_input_input(input: &crate::input::UnmonitorInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
