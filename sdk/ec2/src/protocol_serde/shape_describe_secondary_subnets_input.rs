...
pub fn ser_describe_secondary_subnets_input_input_input(
    input: &crate::operation::describe_secondary_subnets::DescribeSecondarySubnetsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeSecondarySubnets", "2016-11-15");
    #[allow(unused_mut)]
    ...
    if let Some(var_13) = &input.secondary_subnet_ids {
        if !var_13.is_empty() {
