...
pub fn de_modify_vpc_tenancy_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_vpc_tenancy_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::modify_vpc_tenancy::ModifyVpcTenancyOutput, crate::operation::modify_vpc_tenancy::ModifyVpcTenancyError> {
...
pub fn de_modify_vpc_tenancy(
...
) -> std::result::Result<crate::operation::modify_vpc_tenancy::builders::ModifyVpcTenancyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ModifyVpcTenancyResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyVpcTenancyResponse got {start_el:?}"
        )));
    }
