...
pub fn ser_describe_ipam_pools_input_input(input: &crate::input::DescribeIpamPoolsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
