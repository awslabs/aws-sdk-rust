...
pub fn ser_describe_ipam_pools_input_input_input(input: &crate::operation::describe_ipam_pools::DescribeIpamPoolsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
