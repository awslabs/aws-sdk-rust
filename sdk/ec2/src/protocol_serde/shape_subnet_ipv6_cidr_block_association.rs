...
pub fn de_subnet_ipv6_cidr_block_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SubnetIpv6CidrBlockAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
