...
pub fn de_ipam_discovered_public_address(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::IpamDiscoveredPublicAddress, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
