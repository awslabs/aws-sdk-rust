...
pub fn de_terminate_connection_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TerminateConnectionStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
