...
pub fn ser_assign_private_ip_addresses_input_input_input(input: &crate::operation::assign_private_ip_addresses::AssignPrivateIpAddressesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
