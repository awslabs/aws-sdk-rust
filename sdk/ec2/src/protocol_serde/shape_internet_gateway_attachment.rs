...
pub fn de_internet_gateway_attachment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InternetGatewayAttachment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
