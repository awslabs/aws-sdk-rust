...
pub fn de_export_client_vpn_client_configuration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_export_client_vpn_client_configuration_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_export_client_vpn_client_configuration::de_export_client_vpn_client_configuration(_response_body, output)
                .map_err(crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError::unhandled)?;
