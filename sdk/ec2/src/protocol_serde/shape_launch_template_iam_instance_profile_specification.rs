...
pub fn de_launch_template_iam_instance_profile_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateIamInstanceProfileSpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
