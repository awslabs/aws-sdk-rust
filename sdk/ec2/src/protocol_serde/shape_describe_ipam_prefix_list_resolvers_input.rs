...
pub fn ser_describe_ipam_prefix_list_resolvers_input_input_input(
    input: &crate::operation::describe_ipam_prefix_list_resolvers::DescribeIpamPrefixListResolversInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeIpamPrefixListResolvers", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("IpamPrefixListResolverId");
    if let Some(var_13) = &input.ipam_prefix_list_resolver_ids {
        if !var_13.is_empty() {
