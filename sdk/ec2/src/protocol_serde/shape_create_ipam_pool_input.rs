...
pub fn ser_create_ipam_pool_input_input_input(input: &crate::operation::create_ipam_pool::CreateIpamPoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
