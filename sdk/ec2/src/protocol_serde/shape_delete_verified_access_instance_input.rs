...
pub fn ser_delete_verified_access_instance_input_input(input: &crate::input::DeleteVerifiedAccessInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
