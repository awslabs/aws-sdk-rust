...
pub fn ser_delete_verified_access_instance_input_input_input(input: &crate::operation::delete_verified_access_instance::DeleteVerifiedAccessInstanceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
