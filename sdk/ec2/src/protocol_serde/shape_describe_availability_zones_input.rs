...
pub fn ser_describe_availability_zones_input_input_input(input: &crate::operation::describe_availability_zones::DescribeAvailabilityZonesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
