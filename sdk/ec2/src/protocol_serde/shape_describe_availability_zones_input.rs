...
pub fn ser_describe_availability_zones_input_input(input: &crate::input::DescribeAvailabilityZonesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
