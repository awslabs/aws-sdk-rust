...
pub fn de_describe_image_attribute_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_image_attribute::DescribeImageAttributeOutput, crate::operation::describe_image_attribute::DescribeImageAttributeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_image_attribute::DescribeImageAttributeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_image_attribute_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_image_attribute::DescribeImageAttributeOutput, crate::operation::describe_image_attribute::DescribeImageAttributeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_image_attribute::builders::DescribeImageAttributeOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_image_attribute::de_describe_image_attribute(_response_body, output).map_err(crate::operation::describe_image_attribute::DescribeImageAttributeError::unhandled)?;
