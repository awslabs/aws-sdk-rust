...
pub fn de_describe_image_attribute_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_image_attribute::DescribeImageAttributeOutput, crate::operation::describe_image_attribute::DescribeImageAttributeError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_image_attribute_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_image_attribute::DescribeImageAttributeOutput, crate::operation::describe_image_attribute::DescribeImageAttributeError> {
    Ok({
        #[allow(unused_mut)]
