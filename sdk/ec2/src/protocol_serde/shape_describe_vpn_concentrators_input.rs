...
pub fn ser_describe_vpn_concentrators_input_input_input(
    input: &crate::operation::describe_vpn_concentrators::DescribeVpnConcentratorsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeVpnConcentrators", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("VpnConcentratorId");
    if let Some(var_2) = &input.vpn_concentrator_ids {
        if !var_2.is_empty() {
            let mut list_4 = scope_1.start_list(true, Some("VpnConcentratorId"));
            for item_3 in var_2 {
                #[allow(unused_mut)]
