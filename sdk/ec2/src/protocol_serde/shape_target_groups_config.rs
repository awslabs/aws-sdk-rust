...
#[allow(unused_mut)]
pub fn ser_target_groups_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetGroupsConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
