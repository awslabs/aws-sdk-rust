...
#[allow(unused_mut)]
pub fn ser_target_groups_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TargetGroupsConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_groups_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetGroupsConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
