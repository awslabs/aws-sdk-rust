...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnectionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnectionError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_vpc_peering_connection::de_delete_vpc_peering_connection(_response_body, output)
            .map_err(crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnectionError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DeleteVpcPeeringConnectionResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteVpcPeeringConnectionResponse got {start_el:?}"
        )));
    }
