...
pub fn de_analysis_load_balancer_listener(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisLoadBalancerListener, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
