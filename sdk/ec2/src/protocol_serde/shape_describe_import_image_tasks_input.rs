...
pub fn ser_describe_import_image_tasks_input_input_input(input: &crate::operation::describe_import_image_tasks::DescribeImportImageTasksInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
