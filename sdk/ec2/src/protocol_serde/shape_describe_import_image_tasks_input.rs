...
pub fn ser_describe_import_image_tasks_input_input(input: &crate::input::DescribeImportImageTasksInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
