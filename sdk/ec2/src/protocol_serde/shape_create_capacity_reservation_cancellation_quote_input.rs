...
pub fn ser_create_capacity_reservation_cancellation_quote_input_input_input(
    input: &crate::operation::create_capacity_reservation_cancellation_quote::CreateCapacityReservationCancellationQuoteInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateCapacityReservationCancellationQuote", "2016-11-15");
    #[allow(unused_mut)]
