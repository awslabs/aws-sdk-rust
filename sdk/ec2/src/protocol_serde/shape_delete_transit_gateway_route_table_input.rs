...
pub fn ser_delete_transit_gateway_route_table_input_input_input(input: &crate::operation::delete_transit_gateway_route_table::DeleteTransitGatewayRouteTableInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
