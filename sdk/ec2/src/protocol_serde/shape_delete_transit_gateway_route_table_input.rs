...
pub fn ser_delete_transit_gateway_route_table_input_input(input: &crate::input::DeleteTransitGatewayRouteTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
