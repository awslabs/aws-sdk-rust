...
pub fn de_delete_launch_template_versions_response_error_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeleteLaunchTemplateVersionsResponseErrorItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
