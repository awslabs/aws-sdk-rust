...
#[allow(unused_mut)]
pub fn ser_modify_vpn_tunnel_options_specification(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ModifyVpnTunnelOptionsSpecification) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
