...
pub fn ser_describe_ipam_resource_discoveries_input_input_input(
    input: &crate::operation::describe_ipam_resource_discoveries::DescribeIpamResourceDiscoveriesInput,
