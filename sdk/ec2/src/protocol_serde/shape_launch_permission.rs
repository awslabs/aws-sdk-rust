...
#[allow(unused_mut)]
pub fn ser_launch_permission(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LaunchPermission) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_launch_permission(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchPermission, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
