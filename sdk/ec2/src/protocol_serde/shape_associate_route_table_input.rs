...
pub fn ser_associate_route_table_input_input(input: &crate::input::AssociateRouteTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
