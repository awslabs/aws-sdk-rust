...
pub fn ser_associate_route_table_input_input_input(input: &crate::operation::associate_route_table::AssociateRouteTableInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
