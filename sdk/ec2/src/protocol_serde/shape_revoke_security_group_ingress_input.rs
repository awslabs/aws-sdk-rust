...
pub fn ser_revoke_security_group_ingress_input_input_input(input: &crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
