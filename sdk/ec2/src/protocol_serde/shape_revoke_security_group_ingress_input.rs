...
pub fn ser_revoke_security_group_ingress_input_input(input: &crate::input::RevokeSecurityGroupIngressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
