...
pub fn ser_describe_placement_groups_input_input_input(input: &crate::operation::describe_placement_groups::DescribePlacementGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
