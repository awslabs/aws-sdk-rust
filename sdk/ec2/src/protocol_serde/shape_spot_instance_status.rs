...
pub fn de_spot_instance_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotInstanceStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
