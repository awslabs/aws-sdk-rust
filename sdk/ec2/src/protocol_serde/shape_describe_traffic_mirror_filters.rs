...
pub fn de_describe_traffic_mirror_filters_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersOutput, crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_traffic_mirror_filters_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersOutput, crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersError> {
    Ok({
        #[allow(unused_mut)]
