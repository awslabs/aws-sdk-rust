...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_traffic_mirror_filters::de_describe_traffic_mirror_filters(_response_body, output)
            .map_err(crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersError::unhandled)?;
...
pub fn de_describe_traffic_mirror_filters(
    inp: &[u8],
    mut builder: crate::operation::describe_traffic_mirror_filters::builders::DescribeTrafficMirrorFiltersOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_traffic_mirror_filters::builders::DescribeTrafficMirrorFiltersOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeTrafficMirrorFiltersResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeTrafficMirrorFiltersResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("trafficMirrorFilterSet") /* TrafficMirrorFilters com.amazonaws.ec2.synthetic#DescribeTrafficMirrorFiltersOutput$TrafficMirrorFilters */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_traffic_mirror_filter_set::de_traffic_mirror_filter_set(&mut tag, depth + 1)
                        ?
                    )
                ;
