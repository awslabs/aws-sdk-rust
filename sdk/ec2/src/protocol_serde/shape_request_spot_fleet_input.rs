...
pub fn ser_request_spot_fleet_input_input(input: &crate::operation::request_spot_fleet::RequestSpotFleetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
