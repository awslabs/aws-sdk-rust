...
pub fn ser_request_spot_fleet_input_input(input: &crate::input::RequestSpotFleetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
