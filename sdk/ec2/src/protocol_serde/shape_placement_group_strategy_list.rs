...
pub fn de_placement_group_strategy_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PlacementGroupStrategy>, aws_smithy_xml::decode::XmlDecodeError> {
