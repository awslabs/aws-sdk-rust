...
pub fn ser_describe_transit_gateway_connects_input_input(input: &crate::input::DescribeTransitGatewayConnectsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
