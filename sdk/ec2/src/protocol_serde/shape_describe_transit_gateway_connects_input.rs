...
pub fn ser_describe_transit_gateway_connects_input_input_input(
    input: &crate::operation::describe_transit_gateway_connects::DescribeTransitGatewayConnectsInput,
