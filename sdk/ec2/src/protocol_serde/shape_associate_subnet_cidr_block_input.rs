...
pub fn ser_associate_subnet_cidr_block_input_input_input(input: &crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
