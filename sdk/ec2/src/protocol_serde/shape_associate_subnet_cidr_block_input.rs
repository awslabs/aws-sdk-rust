...
pub fn ser_associate_subnet_cidr_block_input_input(input: &crate::input::AssociateSubnetCidrBlockInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
