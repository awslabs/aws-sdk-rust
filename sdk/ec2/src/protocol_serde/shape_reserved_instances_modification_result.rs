...
pub fn de_reserved_instances_modification_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ReservedInstancesModificationResult, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
