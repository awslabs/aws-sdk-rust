...
pub fn ser_modify_volume_attribute_input_input_input(input: &crate::operation::modify_volume_attribute::ModifyVolumeAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
