...
pub fn ser_provision_ipam_byoasn_input_input_input(input: &crate::operation::provision_ipam_byoasn::ProvisionIpamByoasnInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
