...
pub fn de_trunk_interface_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrunkInterfaceAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
