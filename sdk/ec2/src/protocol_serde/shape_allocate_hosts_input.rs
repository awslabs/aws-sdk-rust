...
pub fn ser_allocate_hosts_input_input_input(input: &crate::operation::allocate_hosts::AllocateHostsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
