...
pub fn ser_modify_image_attribute_input_input_input(input: &crate::operation::modify_image_attribute::ModifyImageAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
