...
#[allow(unused_mut)]
pub fn ser_slot_date_time_range_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SlotDateTimeRangeRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
