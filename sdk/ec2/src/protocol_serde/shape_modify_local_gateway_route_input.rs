...
pub fn ser_modify_local_gateway_route_input_input(input: &crate::operation::modify_local_gateway_route::ModifyLocalGatewayRouteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
