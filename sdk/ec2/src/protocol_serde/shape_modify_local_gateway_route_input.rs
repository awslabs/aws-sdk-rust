...
pub fn ser_modify_local_gateway_route_input_input_input(input: &crate::operation::modify_local_gateway_route::ModifyLocalGatewayRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
