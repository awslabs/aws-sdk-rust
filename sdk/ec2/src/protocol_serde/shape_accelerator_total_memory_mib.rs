...
#[allow(unused_mut)]
pub fn ser_accelerator_total_memory_mib(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AcceleratorTotalMemoryMiB) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_accelerator_total_memory_mib(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AcceleratorTotalMemoryMiB, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
