...
pub fn ser_get_console_output_input_input_input(input: &crate::operation::get_console_output::GetConsoleOutputInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
