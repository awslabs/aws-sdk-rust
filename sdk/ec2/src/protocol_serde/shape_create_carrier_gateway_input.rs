...
pub fn ser_create_carrier_gateway_input_input_input(input: &crate::operation::create_carrier_gateway::CreateCarrierGatewayInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
