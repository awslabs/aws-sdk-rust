...
#[allow(unused_mut)]
pub fn ser_memory_gib_per_v_cpu(
    mut writer: ::aws_smithy_query::QueryValueWriter,
    input: &crate::types::MemoryGiBPerVCpu,
...
pub fn de_memory_gib_per_v_cpu(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::MemoryGiBPerVCpu, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
