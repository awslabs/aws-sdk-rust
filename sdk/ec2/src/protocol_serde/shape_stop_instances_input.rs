...
pub fn ser_stop_instances_input_input_input(input: &crate::operation::stop_instances::StopInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
