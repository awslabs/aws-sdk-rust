...
pub fn ser_describe_vpc_attribute_input_input(input: &crate::input::DescribeVpcAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
