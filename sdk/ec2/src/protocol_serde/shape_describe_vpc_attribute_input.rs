...
pub fn ser_describe_vpc_attribute_input_input_input(input: &crate::operation::describe_vpc_attribute::DescribeVpcAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
