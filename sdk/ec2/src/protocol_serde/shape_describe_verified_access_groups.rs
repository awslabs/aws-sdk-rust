...
pub fn de_describe_verified_access_groups_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsOutput, crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsError> {
    #[allow(unused_mut)]
