...
pub fn de_describe_verified_access_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsOutput, crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_verified_access_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsOutput, crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsError> {
    Ok({
        #[allow(unused_mut)]
