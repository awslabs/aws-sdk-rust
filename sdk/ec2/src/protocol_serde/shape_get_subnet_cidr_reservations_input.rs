...
pub fn ser_get_subnet_cidr_reservations_input_input(input: &crate::input::GetSubnetCidrReservationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
