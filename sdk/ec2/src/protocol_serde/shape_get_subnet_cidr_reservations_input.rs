...
pub fn ser_get_subnet_cidr_reservations_input_input_input(input: &crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
