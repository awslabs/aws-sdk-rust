...
pub fn ser_disable_vgw_route_propagation_input_input(input: &crate::input::DisableVgwRoutePropagationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
