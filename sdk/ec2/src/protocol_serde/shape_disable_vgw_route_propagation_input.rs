...
pub fn ser_disable_vgw_route_propagation_input_input_input(input: &crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
