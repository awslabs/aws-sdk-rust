...
pub fn ser_create_transit_gateway_route_table_input_input_input(input: &crate::operation::create_transit_gateway_route_table::CreateTransitGatewayRouteTableInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
