...
pub fn ser_create_transit_gateway_route_table_input_input_input(
    input: &crate::operation::create_transit_gateway_route_table::CreateTransitGatewayRouteTableInput,
