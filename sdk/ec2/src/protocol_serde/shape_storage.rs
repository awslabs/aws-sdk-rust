...
#[allow(unused_mut)]
pub fn ser_storage(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Storage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_storage(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Storage, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
