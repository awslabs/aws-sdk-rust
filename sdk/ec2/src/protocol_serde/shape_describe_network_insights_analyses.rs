...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalysesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_network_insights_analyses::de_describe_network_insights_analyses(_response_body, output)
            .map_err(crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalysesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_network_insights_analyses(
    inp: &[u8],
    mut builder: crate::operation::describe_network_insights_analyses::builders::DescribeNetworkInsightsAnalysesOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_network_insights_analyses::builders::DescribeNetworkInsightsAnalysesOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeNetworkInsightsAnalysesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeNetworkInsightsAnalysesResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("networkInsightsAnalysisSet") /* NetworkInsightsAnalyses com.amazonaws.ec2.synthetic#DescribeNetworkInsightsAnalysesOutput$NetworkInsightsAnalyses */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_network_insights_analysis_list::de_network_insights_analysis_list(&mut tag, depth + 1)
                        ?
                    )
                ;
