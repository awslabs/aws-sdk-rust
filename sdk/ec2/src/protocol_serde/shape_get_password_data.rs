...
pub fn de_get_password_data_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_password_data_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_password_data::GetPasswordDataOutput, crate::operation::get_password_data::GetPasswordDataError> {
...
pub fn de_get_password_data(
...
) -> std::result::Result<crate::operation::get_password_data::builders::GetPasswordDataOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("GetPasswordDataResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetPasswordDataResponse got {start_el:?}"
        )));
    }
