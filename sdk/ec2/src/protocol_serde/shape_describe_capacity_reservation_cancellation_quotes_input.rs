...
pub fn ser_describe_capacity_reservation_cancellation_quotes_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeCapacityReservationCancellationQuotes", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("CapacityReservationCancellationQuoteId");
    if let Some(var_2) = &input.capacity_reservation_cancellation_quote_ids {
        if !var_2.is_empty() {
