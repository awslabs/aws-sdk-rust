...
pub fn ser_describe_vpc_block_public_access_exclusions_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeVpcBlockPublicAccessExclusions", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("ExclusionId");
    if let Some(var_9) = &input.exclusion_ids {
        if !var_9.is_empty() {
