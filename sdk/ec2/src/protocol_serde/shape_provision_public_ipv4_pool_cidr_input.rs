...
pub fn ser_provision_public_ipv4_pool_cidr_input_input(input: &crate::input::ProvisionPublicIpv4PoolCidrInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
