...
pub fn ser_provision_public_ipv4_pool_cidr_input_input_input(input: &crate::operation::provision_public_ipv4_pool_cidr::ProvisionPublicIpv4PoolCidrInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
