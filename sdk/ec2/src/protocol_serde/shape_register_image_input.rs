...
pub fn ser_register_image_input_input_input(input: &crate::operation::register_image::RegisterImageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
