...
pub fn de_launch_template_version(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateVersion, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
