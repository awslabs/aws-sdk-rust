...
pub fn de_connection_notification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConnectionNotification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
