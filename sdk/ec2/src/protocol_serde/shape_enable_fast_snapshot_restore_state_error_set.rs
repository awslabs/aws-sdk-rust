...
pub fn de_enable_fast_snapshot_restore_state_error_set(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::EnableFastSnapshotRestoreStateErrorItem>, aws_smithy_xml::decode::XmlDecodeError> {
