...
pub fn de_transit_gateway_policy_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayPolicyRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
