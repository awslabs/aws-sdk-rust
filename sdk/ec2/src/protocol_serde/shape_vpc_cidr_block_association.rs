...
pub fn de_vpc_cidr_block_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcCidrBlockAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
