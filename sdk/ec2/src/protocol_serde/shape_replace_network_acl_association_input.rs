...
pub fn ser_replace_network_acl_association_input_input(input: &crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
