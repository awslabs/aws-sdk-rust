...
pub fn ser_describe_application_status_checks_input_input_input(
    input: &crate::operation::describe_application_status_checks::DescribeApplicationStatusChecksInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeApplicationStatusChecks", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("ApplicationStatusCheckId");
    if let Some(var_2) = &input.application_status_check_ids {
        if !var_2.is_empty() {
    ...
    #[allow(unused_mut)]
    let mut scope_15 = writer.prefix("IncludeAll");
    if let Some(var_16) = &input.include_all {
