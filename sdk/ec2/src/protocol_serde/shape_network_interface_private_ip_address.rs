...
pub fn de_network_interface_private_ip_address(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NetworkInterfacePrivateIpAddress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
