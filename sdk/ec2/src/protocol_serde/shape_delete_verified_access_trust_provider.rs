...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_verified_access_trust_provider::de_delete_verified_access_trust_provider(_response_body, output)
            .map_err(crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DeleteVerifiedAccessTrustProviderResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteVerifiedAccessTrustProviderResponse got {start_el:?}"
        )));
    }
