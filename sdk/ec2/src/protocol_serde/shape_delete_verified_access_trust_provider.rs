...
pub fn de_delete_verified_access_trust_provider_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_verified_access_trust_provider_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::DeleteVerifiedAccessTrustProviderOutput,
    crate::error::DeleteVerifiedAccessTrustProviderError,
...
pub fn de_delete_verified_access_trust_provider(
    inp: &[u8],
    mut builder: crate::output::delete_verified_access_trust_provider_output::Builder,
) -> Result<
    crate::output::delete_verified_access_trust_provider_output::Builder,
