...
pub fn ser_disable_aws_network_performance_metric_subscription_input_input(input: &crate::input::DisableAwsNetworkPerformanceMetricSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
