...
pub fn de_subnet_cidr_block_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SubnetCidrBlockState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
