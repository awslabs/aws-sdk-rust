...
pub fn ser_modify_verified_access_instance_input_input_input(input: &crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
