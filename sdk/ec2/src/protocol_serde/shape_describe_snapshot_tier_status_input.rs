...
pub fn ser_describe_snapshot_tier_status_input_input(input: &crate::input::DescribeSnapshotTierStatusInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
