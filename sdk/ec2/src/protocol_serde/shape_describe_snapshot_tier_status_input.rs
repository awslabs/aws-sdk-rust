...
pub fn ser_describe_snapshot_tier_status_input_input_input(input: &crate::operation::describe_snapshot_tier_status::DescribeSnapshotTierStatusInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
