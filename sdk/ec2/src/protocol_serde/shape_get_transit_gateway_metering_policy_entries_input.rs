...
pub fn ser_get_transit_gateway_metering_policy_entries_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "GetTransitGatewayMeteringPolicyEntries", "2016-11-15");
    #[allow(unused_mut)]
