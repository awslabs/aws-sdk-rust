...
#[allow(unused_mut)]
pub fn ser_instance_event_window_disassociation_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::InstanceEventWindowDisassociationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
