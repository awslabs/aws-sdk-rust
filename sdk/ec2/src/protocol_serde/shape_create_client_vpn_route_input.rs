...
pub fn ser_create_client_vpn_route_input_input_input(input: &crate::operation::create_client_vpn_route::CreateClientVpnRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
