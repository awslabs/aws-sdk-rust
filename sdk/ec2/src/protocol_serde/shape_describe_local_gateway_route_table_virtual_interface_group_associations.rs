...
pub fn de_describe_local_gateway_route_table_virtual_interface_group_associations_http_error(
...
> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_local_gateway_route_table_virtual_interface_group_associations_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsOutput,
    crate::error::DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsError,
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_describe_local_gateway_route_table_virtual_interface_group_associations::de_describe_local_gateway_route_table_virtual_interface_group_associations(response.body().as_ref(), output).map_err(crate::error::DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsError::unhandled)?;
