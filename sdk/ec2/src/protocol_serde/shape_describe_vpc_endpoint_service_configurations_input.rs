...
pub fn ser_describe_vpc_endpoint_service_configurations_input_input(input: &crate::input::DescribeVpcEndpointServiceConfigurationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
