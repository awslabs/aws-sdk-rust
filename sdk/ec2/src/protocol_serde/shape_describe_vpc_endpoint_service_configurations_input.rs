...
pub fn ser_describe_vpc_endpoint_service_configurations_input_input_input(input: &crate::operation::describe_vpc_endpoint_service_configurations::DescribeVpcEndpointServiceConfigurationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
