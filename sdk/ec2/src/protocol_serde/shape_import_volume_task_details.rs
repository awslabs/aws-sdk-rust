...
pub fn de_import_volume_task_details(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::ImportVolumeTaskDetails, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("availabilityZoneId") /* AvailabilityZoneId com.amazonaws.ec2#ImportVolumeTaskDetails$AvailabilityZoneId */ =>  {
                let var_2 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
            ...
            s if s.matches("image") /* Image com.amazonaws.ec2#ImportVolumeTaskDetails$Image */ =>  {
                let var_5 =
                    Some(
                        crate::protocol_serde::shape_disk_image_description::de_disk_image_description(&mut tag, depth + 1)
                        ?
                    )
                ;
            ...
            s if s.matches("volume") /* Volume com.amazonaws.ec2#ImportVolumeTaskDetails$Volume */ =>  {
                let var_6 =
                    Some(
                        crate::protocol_serde::shape_disk_image_volume_description::de_disk_image_volume_description(&mut tag, depth + 1)
                        ?
                    )
                ;
                builder = builder.set_volume(var_6);
            }
            ,
            _ => {}
        }
