...
pub fn ser_delete_traffic_mirror_filter_input_input(input: &crate::input::DeleteTrafficMirrorFilterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
