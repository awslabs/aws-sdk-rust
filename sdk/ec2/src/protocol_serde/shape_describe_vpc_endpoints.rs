...
#[allow(unused_mut)]
pub fn de_describe_vpc_endpoints(inp: &[u8], mut builder: crate::output::describe_vpc_endpoints_output::Builder) -> Result<crate::output::describe_vpc_endpoints_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
