...
pub fn de_reserved_instances_listing(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedInstancesListing, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
