...
pub fn de_disk_image_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DiskImageDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
