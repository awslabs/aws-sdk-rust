...
pub fn ser_provision_byoip_cidr_input_input_input(input: &crate::operation::provision_byoip_cidr::ProvisionByoipCidrInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
