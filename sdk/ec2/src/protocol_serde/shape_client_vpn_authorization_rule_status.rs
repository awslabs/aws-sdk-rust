...
pub fn de_client_vpn_authorization_rule_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnAuthorizationRuleStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
