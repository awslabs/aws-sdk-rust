...
pub fn de_launch_template_private_dns_name_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplatePrivateDnsNameOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
