...
pub fn ser_delete_subnet_input_input_input(input: &crate::operation::delete_subnet::DeleteSubnetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
