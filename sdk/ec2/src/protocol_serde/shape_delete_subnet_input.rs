...
pub fn ser_delete_subnet_input_input(input: &crate::input::DeleteSubnetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
