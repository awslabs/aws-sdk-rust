...
pub fn de_analysis_security_group_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisSecurityGroupRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
