...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_vpc_endpoint_connections::de_describe_vpc_endpoint_connections(_response_body, output)
            .map_err(crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsError::unhandled)?;
...
pub fn de_describe_vpc_endpoint_connections(
    inp: &[u8],
    mut builder: crate::operation::describe_vpc_endpoint_connections::builders::DescribeVpcEndpointConnectionsOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_vpc_endpoint_connections::builders::DescribeVpcEndpointConnectionsOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeVpcEndpointConnectionsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeVpcEndpointConnectionsResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("vpcEndpointConnectionSet") /* VpcEndpointConnections com.amazonaws.ec2.synthetic#DescribeVpcEndpointConnectionsOutput$VpcEndpointConnections */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_vpc_endpoint_connection_set::de_vpc_endpoint_connection_set(&mut tag, depth + 1)
                        ?
                    )
                ;
