...
pub fn de_describe_vpc_endpoint_connections_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsOutput, crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_vpc_endpoint_connections_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsOutput, crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsError> {
    Ok({
        #[allow(unused_mut)]
