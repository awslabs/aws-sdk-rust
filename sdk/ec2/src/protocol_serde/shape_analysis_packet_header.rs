...
pub fn de_analysis_packet_header(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisPacketHeader, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
