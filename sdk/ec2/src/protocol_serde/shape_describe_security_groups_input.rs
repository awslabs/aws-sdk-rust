...
pub fn ser_describe_security_groups_input_input(input: &crate::operation::describe_security_groups::DescribeSecurityGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
