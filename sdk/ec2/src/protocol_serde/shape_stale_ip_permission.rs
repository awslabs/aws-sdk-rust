...
pub fn de_stale_ip_permission(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StaleIpPermission, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
