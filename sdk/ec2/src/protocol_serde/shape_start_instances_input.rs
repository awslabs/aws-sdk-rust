...
pub fn ser_start_instances_input_input_input(input: &crate::operation::start_instances::StartInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
