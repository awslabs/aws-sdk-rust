...
pub fn ser_detach_classic_link_vpc_input_input_input(input: &crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
