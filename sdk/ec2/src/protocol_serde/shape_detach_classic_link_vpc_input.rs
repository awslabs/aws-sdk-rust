...
pub fn ser_detach_classic_link_vpc_input_input(input: &crate::input::DetachClassicLinkVpcInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
