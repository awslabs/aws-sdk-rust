...
pub fn de_transit_gateway_multicast_domain_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayMulticastDomainAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
