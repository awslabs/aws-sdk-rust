...
pub fn ser_describe_subnets_input_input(input: &crate::operation::describe_subnets::DescribeSubnetsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
