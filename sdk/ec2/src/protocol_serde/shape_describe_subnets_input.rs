...
pub fn ser_describe_subnets_input_input_input(input: &crate::operation::describe_subnets::DescribeSubnetsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_7) = &input.subnet_ids {
        let mut list_9 = scope_6.start_list(true, Some("SubnetId"));
        for item_8 in var_7 {
            #[allow(unused_mut)]
