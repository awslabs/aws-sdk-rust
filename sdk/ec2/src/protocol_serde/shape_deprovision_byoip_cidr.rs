...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_deprovision_byoip_cidr::de_deprovision_byoip_cidr(_response_body, output)
            .map_err(crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DeprovisionByoipCidrResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeprovisionByoipCidrResponse got {start_el:?}"
        )));
    }
