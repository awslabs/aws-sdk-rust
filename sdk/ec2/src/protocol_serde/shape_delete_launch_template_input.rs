...
pub fn ser_delete_launch_template_input_input(input: &crate::input::DeleteLaunchTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
