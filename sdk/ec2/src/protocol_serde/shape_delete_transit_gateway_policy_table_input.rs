...
pub fn ser_delete_transit_gateway_policy_table_input_input(input: &crate::input::DeleteTransitGatewayPolicyTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
