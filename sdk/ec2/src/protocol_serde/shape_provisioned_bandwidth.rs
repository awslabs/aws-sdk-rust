...
pub fn de_provisioned_bandwidth(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ProvisionedBandwidth, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
