...
pub fn de_delete_launch_template_versions_response_success_item(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::DeleteLaunchTemplateVersionsResponseSuccessItem, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
