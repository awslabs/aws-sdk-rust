...
pub fn de_instance_network_interface_attachment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceNetworkInterfaceAttachment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
