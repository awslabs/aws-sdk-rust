...
#[allow(unused_mut)]
pub fn ser_instance_requirements(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::InstanceRequirements) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_instance_requirements(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceRequirements, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
