...
pub fn ser_describe_network_interface_attribute_input_input(input: &crate::input::DescribeNetworkInterfaceAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
