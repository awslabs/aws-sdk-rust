...
pub fn ser_describe_network_interface_attribute_input_input_input(input: &crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
