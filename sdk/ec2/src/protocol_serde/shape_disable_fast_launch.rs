...
pub fn de_disable_fast_launch_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisableFastLaunchOutput, crate::error::DisableFastLaunchError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DisableFastLaunchError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_fast_launch_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisableFastLaunchOutput, crate::error::DisableFastLaunchError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::disable_fast_launch_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_disable_fast_launch::de_disable_fast_launch(response.body().as_ref(), output).map_err(crate::error::DisableFastLaunchError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_disable_fast_launch(inp: &[u8], mut builder: crate::output::disable_fast_launch_output::Builder) -> Result<crate::output::disable_fast_launch_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
