...
pub fn de_disable_fast_launch_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::disable_fast_launch::DisableFastLaunchOutput, crate::operation::disable_fast_launch::DisableFastLaunchError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::disable_fast_launch::DisableFastLaunchOutput, crate::operation::disable_fast_launch::DisableFastLaunchError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_disable_fast_launch::de_disable_fast_launch(_response_body, output)
            .map_err(crate::operation::disable_fast_launch::DisableFastLaunchError::unhandled)?;
...
pub fn de_disable_fast_launch(
    ...
    if !(start_el.matches("DisableFastLaunchResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DisableFastLaunchResponse got {start_el:?}"
        )));
    }
