...
pub fn de_disable_fast_launch_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_fast_launch::DisableFastLaunchOutput, crate::operation::disable_fast_launch::DisableFastLaunchError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::disable_fast_launch::DisableFastLaunchError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_fast_launch_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_fast_launch::DisableFastLaunchOutput, crate::operation::disable_fast_launch::DisableFastLaunchError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::disable_fast_launch::builders::DisableFastLaunchOutputBuilder::default();
        output = crate::protocol_serde::shape_disable_fast_launch::de_disable_fast_launch(_response_body, output).map_err(crate::operation::disable_fast_launch::DisableFastLaunchError::unhandled)?;
