...
pub fn de_disable_fast_launch_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_fast_launch::DisableFastLaunchOutput, crate::operation::disable_fast_launch::DisableFastLaunchError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_fast_launch_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disable_fast_launch::DisableFastLaunchOutput, crate::operation::disable_fast_launch::DisableFastLaunchError> {
    Ok({
        #[allow(unused_mut)]
