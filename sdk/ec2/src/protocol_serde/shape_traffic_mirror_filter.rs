...
pub fn de_traffic_mirror_filter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrafficMirrorFilter, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
