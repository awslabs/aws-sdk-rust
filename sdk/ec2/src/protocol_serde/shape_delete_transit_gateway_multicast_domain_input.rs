...
pub fn ser_delete_transit_gateway_multicast_domain_input_input(input: &crate::operation::delete_transit_gateway_multicast_domain::DeleteTransitGatewayMulticastDomainInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
