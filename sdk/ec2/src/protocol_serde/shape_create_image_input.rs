...
pub fn ser_create_image_input_input_input(input: &crate::operation::create_image::CreateImageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
