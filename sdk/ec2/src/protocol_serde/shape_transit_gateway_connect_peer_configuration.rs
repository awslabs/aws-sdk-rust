...
pub fn de_transit_gateway_connect_peer_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayConnectPeerConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
