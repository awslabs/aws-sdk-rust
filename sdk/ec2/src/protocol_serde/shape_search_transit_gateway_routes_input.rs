...
pub fn ser_search_transit_gateway_routes_input_input_input(input: &crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
