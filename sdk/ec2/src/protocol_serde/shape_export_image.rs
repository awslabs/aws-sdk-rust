...
pub fn de_export_image_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ExportImageOutput, crate::error::ExportImageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ExportImageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_export_image_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ExportImageOutput, crate::error::ExportImageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::export_image_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_export_image::de_export_image(response.body().as_ref(), output).map_err(crate::error::ExportImageError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_export_image(inp: &[u8], mut builder: crate::output::export_image_output::Builder) -> Result<crate::output::export_image_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
