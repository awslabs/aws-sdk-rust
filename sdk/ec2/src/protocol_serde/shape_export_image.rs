...
pub fn de_export_image_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::export_image::ExportImageOutput, crate::operation::export_image::ExportImageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::export_image::ExportImageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_export_image_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::export_image::ExportImageOutput, crate::operation::export_image::ExportImageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::export_image::builders::ExportImageOutputBuilder::default();
        output = crate::protocol_serde::shape_export_image::de_export_image(_response_body, output).map_err(crate::operation::export_image::ExportImageError::unhandled)?;
