...
pub fn de_export_image_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::export_image::ExportImageOutput, crate::operation::export_image::ExportImageError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_export_image_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::export_image::ExportImageOutput, crate::operation::export_image::ExportImageError> {
    Ok({
        #[allow(unused_mut)]
