...
pub fn ser_describe_network_acls_input_input(input: &crate::operation::describe_network_acls::DescribeNetworkAclsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
