...
pub fn ser_describe_network_acls_input_input_input(input: &crate::operation::describe_network_acls::DescribeNetworkAclsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("NetworkAclId");
    if let Some(var_9) = &input.network_acl_ids {
