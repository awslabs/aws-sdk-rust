...
pub fn de_transit_gateway_multicast_domain(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::TransitGatewayMulticastDomain, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("options") /* Options com.amazonaws.ec2#TransitGatewayMulticastDomain$Options */ =>  {
                let var_5 =
                    Some(
                        crate::protocol_serde::shape_transit_gateway_multicast_domain_options::de_transit_gateway_multicast_domain_options(&mut tag, depth + 1)
                        ?
                    )
                ;
