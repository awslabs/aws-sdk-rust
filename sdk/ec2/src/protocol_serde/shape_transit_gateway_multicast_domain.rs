...
pub fn de_transit_gateway_multicast_domain(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayMulticastDomain, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
