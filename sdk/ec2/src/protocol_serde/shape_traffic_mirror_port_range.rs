...
pub fn de_traffic_mirror_port_range(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrafficMirrorPortRange, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
