...
pub fn de_transit_gateway_attachment_bgp_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayAttachmentBgpConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
