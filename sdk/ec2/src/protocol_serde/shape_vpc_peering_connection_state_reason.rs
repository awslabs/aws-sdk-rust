...
pub fn de_vpc_peering_connection_state_reason(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcPeeringConnectionStateReason, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
