...
#[allow(unused_mut)]
pub fn ser_modify_verified_access_trust_provider_oidc_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ModifyVerifiedAccessTrustProviderOidcOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
