...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_aggregate_id_format_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_aggregate_id_format::de_describe_aggregate_id_format(_response_body, output)
            .map_err(crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_aggregate_id_format(
    inp: &[u8],
    mut builder: crate::operation::describe_aggregate_id_format::builders::DescribeAggregateIdFormatOutputBuilder,
) -> Result<crate::operation::describe_aggregate_id_format::builders::DescribeAggregateIdFormatOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
