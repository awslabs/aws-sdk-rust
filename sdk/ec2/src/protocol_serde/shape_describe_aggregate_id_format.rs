...
pub fn de_describe_aggregate_id_format(
    ...
    crate::operation::describe_aggregate_id_format::builders::DescribeAggregateIdFormatOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DescribeAggregateIdFormatResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeAggregateIdFormatResponse got {start_el:?}"
        )));
    }
