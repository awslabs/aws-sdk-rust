...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::purchase_host_reservation::PurchaseHostReservationError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::purchase_host_reservation::PurchaseHostReservationError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_purchase_host_reservation_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_purchase_host_reservation::de_purchase_host_reservation(_response_body, output)
            .map_err(crate::operation::purchase_host_reservation::PurchaseHostReservationError::unhandled)?;
...
) -> Result<crate::operation::purchase_host_reservation::builders::PurchaseHostReservationOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
