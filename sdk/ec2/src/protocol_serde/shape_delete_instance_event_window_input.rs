...
pub fn ser_delete_instance_event_window_input_input_input(input: &crate::operation::delete_instance_event_window::DeleteInstanceEventWindowInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
