...
pub fn ser_accept_transit_gateway_vpc_attachment_input_input_input(input: &crate::operation::accept_transit_gateway_vpc_attachment::AcceptTransitGatewayVpcAttachmentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
