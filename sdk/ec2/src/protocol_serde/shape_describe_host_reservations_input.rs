...
pub fn ser_describe_host_reservations_input_input(input: &crate::input::DescribeHostReservationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
