...
pub fn ser_describe_host_reservations_input_input_input(input: &crate::operation::describe_host_reservations::DescribeHostReservationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("HostReservationIdSet");
    if let Some(var_7) = &input.host_reservation_id_set {
