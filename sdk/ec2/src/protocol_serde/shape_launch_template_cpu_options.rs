...
pub fn de_launch_template_cpu_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LaunchTemplateCpuOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
