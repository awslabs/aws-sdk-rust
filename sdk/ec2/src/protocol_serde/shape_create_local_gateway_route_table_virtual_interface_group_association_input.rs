...
pub fn ser_create_local_gateway_route_table_virtual_interface_group_association_input_input(input: &crate::input::CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("LocalGatewayVirtualInterfaceGroupId");
    if let Some(var_4) = &input.local_gateway_virtual_interface_group_id {
