...
pub fn ser_modify_default_credit_specification_input_input(input: &crate::input::ModifyDefaultCreditSpecificationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
