...
pub fn de_reserved_instances_offering(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedInstancesOffering, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
