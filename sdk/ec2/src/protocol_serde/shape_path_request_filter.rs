...
#[allow(unused_mut)]
pub fn ser_path_request_filter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::PathRequestFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
