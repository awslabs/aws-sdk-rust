...
#[allow(unused_mut)]
pub fn ser_spot_capacity_rebalance(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SpotCapacityRebalance) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_spot_capacity_rebalance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotCapacityRebalance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
