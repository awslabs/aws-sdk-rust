...
pub fn de_verified_access_endpoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VerifiedAccessEndpoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::model::VerifiedAccessEndpoint::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("endpointType") /* EndpointType com.amazonaws.ec2#VerifiedAccessEndpoint$EndpointType */ =>  {
                let var_5 =
                    Some(
                        Result::<crate::model::VerifiedAccessEndpointType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            crate::model::VerifiedAccessEndpointType::from(
                                aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("attachmentType") /* AttachmentType com.amazonaws.ec2#VerifiedAccessEndpoint$AttachmentType */ =>  {
                let var_6 =
                    Some(
                        Result::<crate::model::VerifiedAccessEndpointAttachmentType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            crate::model::VerifiedAccessEndpointAttachmentType::from(
                                aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
