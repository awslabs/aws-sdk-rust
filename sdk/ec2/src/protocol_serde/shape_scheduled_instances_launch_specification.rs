...
#[allow(unused_mut)]
pub fn ser_scheduled_instances_launch_specification(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ScheduledInstancesLaunchSpecification) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
