...
pub fn ser_modify_hosts_input_input_input(input: &crate::operation::modify_hosts::ModifyHostsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
