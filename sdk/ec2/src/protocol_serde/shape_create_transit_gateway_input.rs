...
pub fn ser_create_transit_gateway_input_input_input(input: &crate::operation::create_transit_gateway::CreateTransitGatewayInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_4) = &input.options {
        crate::protocol_serde::shape_transit_gateway_request_options::ser_transit_gateway_request_options(scope_3, var_4)?;
    }
    #[allow(unused_mut)]
