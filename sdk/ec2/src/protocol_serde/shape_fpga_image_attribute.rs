...
pub fn de_fpga_image_attribute(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::FpgaImageAttribute, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("loadPermissions") /* LoadPermissions com.amazonaws.ec2#FpgaImageAttribute$LoadPermissions */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_load_permission_list::de_load_permission_list(&mut tag, depth + 1)
                        ?
                    )
                ;
