...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_unassign_ipv6_addresses_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_unassign_ipv6_addresses::de_unassign_ipv6_addresses(_response_body, output)
            .map_err(crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError::unhandled)?;
...
) -> Result<crate::operation::unassign_ipv6_addresses::builders::UnassignIpv6AddressesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
