...
pub fn de_import_instance_volume_detail_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ImportInstanceVolumeDetailItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
