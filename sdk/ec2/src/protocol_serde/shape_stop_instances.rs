...
pub fn de_stop_instances_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_instances_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::stop_instances::StopInstancesOutput, crate::operation::stop_instances::StopInstancesError> {
...
pub fn de_stop_instances(
...
) -> std::result::Result<crate::operation::stop_instances::builders::StopInstancesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("StopInstancesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected StopInstancesResponse got {start_el:?}"
        )));
    }
