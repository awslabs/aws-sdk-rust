...
pub fn de_modify_capacity_reservation_fleet_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetOutput, crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_capacity_reservation_fleet_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetOutput, crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetError> {
    Ok({
        #[allow(unused_mut)]
