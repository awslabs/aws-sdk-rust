...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_capacity_reservation_fleet_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_capacity_reservation_fleet::de_modify_capacity_reservation_fleet(_response_body, output)
            .map_err(crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_capacity_reservation_fleet(
    inp: &[u8],
    mut builder: crate::operation::modify_capacity_reservation_fleet::builders::ModifyCapacityReservationFleetOutputBuilder,
) -> std::result::Result<
    crate::operation::modify_capacity_reservation_fleet::builders::ModifyCapacityReservationFleetOutputBuilder,
...
> {
    ...
    if !(start_el.matches("ModifyCapacityReservationFleetResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyCapacityReservationFleetResponse got {start_el:?}"
        )));
    }
