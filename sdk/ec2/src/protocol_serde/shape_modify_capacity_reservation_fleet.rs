...
pub fn de_modify_capacity_reservation_fleet_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetOutput, crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleetError> {
    #[allow(unused_mut)]
