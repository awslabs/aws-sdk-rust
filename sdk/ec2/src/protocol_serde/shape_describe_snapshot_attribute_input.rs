...
pub fn ser_describe_snapshot_attribute_input_input(input: &crate::input::DescribeSnapshotAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
