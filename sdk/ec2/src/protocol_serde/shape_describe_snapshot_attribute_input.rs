...
pub fn ser_describe_snapshot_attribute_input_input(input: &crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
