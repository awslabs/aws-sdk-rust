...
pub fn ser_describe_transit_gateway_policy_tables_input_input(input: &crate::input::DescribeTransitGatewayPolicyTablesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
