...
pub fn ser_describe_transit_gateway_policy_tables_input_input_input(input: &crate::operation::describe_transit_gateway_policy_tables::DescribeTransitGatewayPolicyTablesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
