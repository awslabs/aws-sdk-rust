...
pub fn ser_describe_prefix_lists_input_input_input(input: &crate::operation::describe_prefix_lists::DescribePrefixListsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
