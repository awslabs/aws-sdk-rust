...
pub fn ser_describe_bundle_tasks_input_input(input: &crate::input::DescribeBundleTasksInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
