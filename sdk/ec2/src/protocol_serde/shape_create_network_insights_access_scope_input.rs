...
pub fn ser_create_network_insights_access_scope_input_input_input(input: &crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
