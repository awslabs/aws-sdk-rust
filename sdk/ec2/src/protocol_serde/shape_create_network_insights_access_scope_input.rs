...
pub fn ser_create_network_insights_access_scope_input_input(input: &crate::input::CreateNetworkInsightsAccessScopeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
