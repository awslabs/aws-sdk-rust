...
pub fn ser_get_groups_for_capacity_reservation_input_input(input: &crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
