...
pub fn ser_get_groups_for_capacity_reservation_input_input_input(
    input: &crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationInput,
