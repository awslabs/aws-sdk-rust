...
pub fn ser_get_groups_for_capacity_reservation_input_input(input: &crate::input::GetGroupsForCapacityReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
