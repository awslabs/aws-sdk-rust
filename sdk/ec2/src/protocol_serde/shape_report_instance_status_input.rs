...
pub fn ser_report_instance_status_input_input_input(input: &crate::operation::report_instance_status::ReportInstanceStatusInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
