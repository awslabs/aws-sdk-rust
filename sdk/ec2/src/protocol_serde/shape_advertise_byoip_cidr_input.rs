...
pub fn ser_advertise_byoip_cidr_input_input(input: &crate::input::AdvertiseByoipCidrInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
