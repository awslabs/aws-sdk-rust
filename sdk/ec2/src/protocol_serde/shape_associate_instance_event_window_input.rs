...
pub fn ser_associate_instance_event_window_input_input_input(input: &crate::operation::associate_instance_event_window::AssociateInstanceEventWindowInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
