...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
        crate::operation::disable_aws_network_performance_metric_subscription::DisableAwsNetworkPerformanceMetricSubscriptionError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_aws_network_performance_metric_subscription_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_disable_aws_network_performance_metric_subscription::de_disable_aws_network_performance_metric_subscription(
                _response_body,
                output,
            )
            .map_err(
