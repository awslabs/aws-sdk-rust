...
pub fn de_get_capacity_reservation_usage_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_capacity_reservation_usage::GetCapacityReservationUsageOutput, crate::operation::get_capacity_reservation_usage::GetCapacityReservationUsageError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_capacity_reservation_usage_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_capacity_reservation_usage::GetCapacityReservationUsageOutput, crate::operation::get_capacity_reservation_usage::GetCapacityReservationUsageError> {
    Ok({
        #[allow(unused_mut)]
