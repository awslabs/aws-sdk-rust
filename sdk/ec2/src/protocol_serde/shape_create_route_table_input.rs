...
pub fn ser_create_route_table_input_input(input: &crate::input::CreateRouteTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
