...
pub fn ser_create_route_table_input_input_input(input: &crate::operation::create_route_table::CreateRouteTableInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
