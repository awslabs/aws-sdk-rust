...
pub fn ser_describe_launch_templates_input_input(input: &crate::operation::describe_launch_templates::DescribeLaunchTemplatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
