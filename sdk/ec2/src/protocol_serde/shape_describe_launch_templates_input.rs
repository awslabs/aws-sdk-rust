...
pub fn ser_describe_launch_templates_input_input(input: &crate::input::DescribeLaunchTemplatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
