...
pub fn ser_accept_reserved_instances_exchange_quote_input_input(input: &crate::input::AcceptReservedInstancesExchangeQuoteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
