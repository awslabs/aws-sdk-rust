...
#[allow(unused_mut)]
pub fn ser_request_filter_port_range(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::RequestFilterPortRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
