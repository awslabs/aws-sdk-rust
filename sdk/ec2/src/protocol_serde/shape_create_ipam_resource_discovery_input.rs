...
pub fn ser_create_ipam_resource_discovery_input_input(input: &crate::operation::create_ipam_resource_discovery::CreateIpamResourceDiscoveryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
