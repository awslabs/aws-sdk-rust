...
pub fn de_ipam_pool_cidr_failure_reason(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IpamPoolCidrFailureReason, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
