...
pub fn ser_describe_fleet_history_input_input(input: &crate::input::DescribeFleetHistoryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
