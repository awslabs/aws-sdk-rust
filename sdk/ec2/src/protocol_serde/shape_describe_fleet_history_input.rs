...
pub fn ser_describe_fleet_history_input_input_input(input: &crate::operation::describe_fleet_history::DescribeFleetHistoryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
