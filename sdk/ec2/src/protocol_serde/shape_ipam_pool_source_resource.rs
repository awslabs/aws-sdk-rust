...
pub fn de_ipam_pool_source_resource(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::IpamPoolSourceResource, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
