...
pub fn ser_delete_vpc_input_input(input: &crate::operation::delete_vpc::DeleteVpcInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
