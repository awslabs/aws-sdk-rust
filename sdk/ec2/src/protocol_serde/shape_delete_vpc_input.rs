...
pub fn ser_delete_vpc_input_input_input(input: &crate::operation::delete_vpc::DeleteVpcInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
