...
pub fn ser_delete_verified_access_endpoint_input_input(input: &crate::input::DeleteVerifiedAccessEndpointInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
