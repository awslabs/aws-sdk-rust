...
pub fn de_cloud_watch_log_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CloudWatchLogOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
