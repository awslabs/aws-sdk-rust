...
pub fn de_instance_attachment_ena_srd_specification(
    ...
    depth: u32,
) -> ::std::result::Result<crate::types::InstanceAttachmentEnaSrdSpecification, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("enaSrdUdpSpecification") /* EnaSrdUdpSpecification com.amazonaws.ec2#InstanceAttachmentEnaSrdSpecification$EnaSrdUdpSpecification */ =>  {
                let var_2 =
                    Some(
                        crate::protocol_serde::shape_instance_attachment_ena_srd_udp_specification::de_instance_attachment_ena_srd_udp_specification(&mut tag, depth + 1)
                        ?
                    )
                ;
