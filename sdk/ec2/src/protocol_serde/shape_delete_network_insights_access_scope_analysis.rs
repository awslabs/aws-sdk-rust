...
pub fn de_delete_network_insights_access_scope_analysis_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_network_insights_access_scope_analysis::DeleteNetworkInsightsAccessScopeAnalysisError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_network_insights_access_scope_analysis_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_network_insights_access_scope_analysis::de_delete_network_insights_access_scope_analysis(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_network_insights_access_scope_analysis::DeleteNetworkInsightsAccessScopeAnalysisError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_network_insights_access_scope_analysis(
    inp: &[u8],
    mut builder: crate::operation::delete_network_insights_access_scope_analysis::builders::DeleteNetworkInsightsAccessScopeAnalysisOutputBuilder,
) -> std::result::Result<
...
> {
    ...
    if !(start_el.matches("DeleteNetworkInsightsAccessScopeAnalysisResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteNetworkInsightsAccessScopeAnalysisResponse got {start_el:?}"
        )));
    }
