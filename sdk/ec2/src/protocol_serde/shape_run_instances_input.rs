...
pub fn ser_run_instances_input_input_input(input: &crate::operation::run_instances::RunInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
