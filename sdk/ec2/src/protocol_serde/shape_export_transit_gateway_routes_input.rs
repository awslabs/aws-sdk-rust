...
pub fn ser_export_transit_gateway_routes_input_input_input(input: &crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
