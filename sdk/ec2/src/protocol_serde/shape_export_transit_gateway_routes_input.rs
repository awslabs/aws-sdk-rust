...
pub fn ser_export_transit_gateway_routes_input_input(input: &crate::input::ExportTransitGatewayRoutesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
