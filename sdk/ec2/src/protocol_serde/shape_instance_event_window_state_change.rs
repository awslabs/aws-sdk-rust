...
pub fn de_instance_event_window_state_change(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceEventWindowStateChange, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
