...
pub fn de_target_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
