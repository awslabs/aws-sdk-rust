...
pub fn ser_delete_queued_reserved_instances_input_input(input: &crate::input::DeleteQueuedReservedInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
