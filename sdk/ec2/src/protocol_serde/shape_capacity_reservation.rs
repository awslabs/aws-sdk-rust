...
pub fn de_capacity_reservation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CapacityReservation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
