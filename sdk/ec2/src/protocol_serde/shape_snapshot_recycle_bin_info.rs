...
pub fn de_snapshot_recycle_bin_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SnapshotRecycleBinInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
