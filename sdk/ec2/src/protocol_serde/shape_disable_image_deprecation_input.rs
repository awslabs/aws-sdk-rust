...
pub fn ser_disable_image_deprecation_input_input(input: &crate::input::DisableImageDeprecationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
