...
pub fn ser_disable_image_deprecation_input_input_input(input: &crate::operation::disable_image_deprecation::DisableImageDeprecationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
