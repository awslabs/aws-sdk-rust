...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_vpn_connection_options::de_modify_vpn_connection_options(_response_body, output)
            .map_err(crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyVpnConnectionOptionsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyVpnConnectionOptionsResponse got {start_el:?}"
        )));
    }
