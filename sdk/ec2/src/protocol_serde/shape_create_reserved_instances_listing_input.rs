...
pub fn ser_create_reserved_instances_listing_input_input(input: &crate::input::CreateReservedInstancesListingInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
