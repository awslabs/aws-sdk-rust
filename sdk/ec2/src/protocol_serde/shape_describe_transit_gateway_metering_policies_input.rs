...
pub fn ser_describe_transit_gateway_metering_policies_input_input_input(
    input: &crate::operation::describe_transit_gateway_metering_policies::DescribeTransitGatewayMeteringPoliciesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeTransitGatewayMeteringPolicies", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("TransitGatewayMeteringPolicyIds");
    if let Some(var_2) = &input.transit_gateway_metering_policy_ids {
        if !var_2.is_empty() {
