...
pub fn ser_get_coip_pool_usage_input_input_input(input: &crate::operation::get_coip_pool_usage::GetCoipPoolUsageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
