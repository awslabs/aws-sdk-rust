...
pub fn ser_create_transit_gateway_connect_peer_input_input(input: &crate::input::CreateTransitGatewayConnectPeerInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
