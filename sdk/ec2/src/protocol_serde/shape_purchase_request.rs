...
#[allow(unused_mut)]
pub fn ser_purchase_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PurchaseRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
