...
pub fn ser_modify_transit_gateway_prefix_list_reference_input_input(input: &crate::input::ModifyTransitGatewayPrefixListReferenceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
