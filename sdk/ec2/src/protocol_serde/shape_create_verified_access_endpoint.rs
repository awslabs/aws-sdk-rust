...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_verified_access_endpoint::CreateVerifiedAccessEndpointError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_verified_access_endpoint::de_create_verified_access_endpoint(_response_body, output)
            .map_err(crate::operation::create_verified_access_endpoint::CreateVerifiedAccessEndpointError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_verified_access_endpoint(
    inp: &[u8],
    mut builder: crate::operation::create_verified_access_endpoint::builders::CreateVerifiedAccessEndpointOutputBuilder,
) -> std::result::Result<
    crate::operation::create_verified_access_endpoint::builders::CreateVerifiedAccessEndpointOutputBuilder,
...
> {
    ...
    if !(start_el.matches("CreateVerifiedAccessEndpointResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateVerifiedAccessEndpointResponse got {start_el:?}"
        )));
    }
