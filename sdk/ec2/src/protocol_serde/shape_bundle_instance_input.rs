...
pub fn ser_bundle_instance_input_input_input(input: &crate::operation::bundle_instance::BundleInstanceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
