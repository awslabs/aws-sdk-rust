...
pub fn ser_bundle_instance_input_input(input: &crate::operation::bundle_instance::BundleInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
