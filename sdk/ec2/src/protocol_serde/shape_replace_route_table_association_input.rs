...
pub fn ser_replace_route_table_association_input_input(input: &crate::input::ReplaceRouteTableAssociationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
