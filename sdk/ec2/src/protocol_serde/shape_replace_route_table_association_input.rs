...
pub fn ser_replace_route_table_association_input_input_input(input: &crate::operation::replace_route_table_association::ReplaceRouteTableAssociationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
