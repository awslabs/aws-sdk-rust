...
#[allow(unused_mut)]
pub fn ser_scheduled_instances_block_device_mapping(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ScheduledInstancesBlockDeviceMapping) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
