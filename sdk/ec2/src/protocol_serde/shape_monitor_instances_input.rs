...
pub fn ser_monitor_instances_input_input(input: &crate::input::MonitorInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
