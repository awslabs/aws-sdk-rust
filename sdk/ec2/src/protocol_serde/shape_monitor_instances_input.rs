...
pub fn ser_monitor_instances_input_input_input(input: &crate::operation::monitor_instances::MonitorInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
