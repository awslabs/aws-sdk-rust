...
pub fn de_launch_template_spot_market_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateSpotMarketOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
