...
pub fn ser_delete_network_insights_access_scope_analysis_input_input(input: &crate::input::DeleteNetworkInsightsAccessScopeAnalysisInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
