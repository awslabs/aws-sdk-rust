...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_network_insights_analysis::de_start_network_insights_analysis(_response_body, output)
            .map_err(crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisError::unhandled)?;
