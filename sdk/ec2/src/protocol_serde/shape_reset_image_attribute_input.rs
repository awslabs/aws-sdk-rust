...
pub fn ser_reset_image_attribute_input_input_input(input: &crate::operation::reset_image_attribute::ResetImageAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
