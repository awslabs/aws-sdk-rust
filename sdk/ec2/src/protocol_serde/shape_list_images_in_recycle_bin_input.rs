...
pub fn ser_list_images_in_recycle_bin_input_input_input(input: &crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBinInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
