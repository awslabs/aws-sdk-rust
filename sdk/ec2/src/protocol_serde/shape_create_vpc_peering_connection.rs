...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_vpc_peering_connection::de_create_vpc_peering_connection(_response_body, output)
            .map_err(crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("CreateVpcPeeringConnectionResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateVpcPeeringConnectionResponse got {start_el:?}"
        )));
    }
