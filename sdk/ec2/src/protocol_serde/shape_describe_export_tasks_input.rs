...
pub fn ser_describe_export_tasks_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("ExportTaskId");
    if let Some(var_7) = &input.export_task_ids {
        if !var_7.is_empty() {
            let mut list_9 = scope_6.start_list(true, Some("ExportTaskId"));
            for item_8 in var_7 {
                #[allow(unused_mut)]
