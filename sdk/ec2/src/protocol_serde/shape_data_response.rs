...
pub fn de_data_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DataResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::model::DataResponse::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("statistic") /* Statistic com.amazonaws.ec2#DataResponse$Statistic */ =>  {
                let var_5 =
                    Some(
                        Result::<crate::model::StatisticType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            crate::model::StatisticType::from(
                                aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
            ...
            s if s.matches("period") /* Period com.amazonaws.ec2#DataResponse$Period */ =>  {
                let var_6 =
                    Some(
                        Result::<crate::model::PeriodType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            crate::model::PeriodType::from(
                                aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
