...
pub fn de_vpc_peering_connection_options_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcPeeringConnectionOptionsDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
