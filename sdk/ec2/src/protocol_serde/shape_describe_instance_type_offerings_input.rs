...
pub fn ser_describe_instance_type_offerings_input_input_input(input: &crate::operation::describe_instance_type_offerings::DescribeInstanceTypeOfferingsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
