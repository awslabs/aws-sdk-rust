...
pub fn ser_describe_instance_type_offerings_input_input(input: &crate::input::DescribeInstanceTypeOfferingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
