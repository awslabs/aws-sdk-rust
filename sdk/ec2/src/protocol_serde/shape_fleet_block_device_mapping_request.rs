...
#[allow(unused_mut)]
pub fn ser_fleet_block_device_mapping_request(
    mut writer: ::aws_smithy_query::QueryValueWriter,
    input: &crate::types::FleetBlockDeviceMappingRequest,
    ...
    if let Some(var_6) = &input.ebs {
        crate::protocol_serde::shape_fleet_ebs_block_device_request::ser_fleet_ebs_block_device_request(scope_5, var_6)?;
    }
    #[allow(unused_mut)]
