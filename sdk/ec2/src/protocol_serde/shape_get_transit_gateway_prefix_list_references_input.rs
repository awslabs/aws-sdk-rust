...
pub fn ser_get_transit_gateway_prefix_list_references_input_input(input: &crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
