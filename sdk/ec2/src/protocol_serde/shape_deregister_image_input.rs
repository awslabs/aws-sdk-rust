...
pub fn ser_deregister_image_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("DeleteAssociatedSnapshots");
    if let Some(var_4) = &input.delete_associated_snapshots {
