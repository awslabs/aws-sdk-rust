...
pub fn ser_deregister_image_input_input_input(input: &crate::operation::deregister_image::DeregisterImageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
