...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_local_gateway_route_table_virtual_interface_group_association_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8], _cfg: &::aws_smithy_types::config_bag::ConfigBag) -> std::result::Result<crate::operation::delete_local_gateway_route_table_virtual_interface_group_association::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput, crate::operation::delete_local_gateway_route_table_virtual_interface_group_association::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationError>{
    Ok({
        #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("localGatewayRouteTableVirtualInterfaceGroupAssociation") /* LocalGatewayRouteTableVirtualInterfaceGroupAssociation com.amazonaws.ec2.synthetic#DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput$LocalGatewayRouteTableVirtualInterfaceGroupAssociation */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_local_gateway_route_table_virtual_interface_group_association::de_local_gateway_route_table_virtual_interface_group_association(&mut tag, depth + 1)
                        ?
                    )
                ;
