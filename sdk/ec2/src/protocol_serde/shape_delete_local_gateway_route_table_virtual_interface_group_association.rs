...
pub fn de_delete_local_gateway_route_table_virtual_interface_group_association_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_local_gateway_route_table_virtual_interface_group_association_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput,
    crate::error::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationError,
