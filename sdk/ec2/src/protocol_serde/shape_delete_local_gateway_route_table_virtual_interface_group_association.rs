...
pub fn de_delete_local_gateway_route_table_virtual_interface_group_association_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput, crate::error::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationError::unhandled)?;
...
pub fn de_delete_local_gateway_route_table_virtual_interface_group_association_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOutput, crate::error::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_local_gateway_route_table_virtual_interface_group_association::de_delete_local_gateway_route_table_virtual_interface_group_association(response.body().as_ref(), output).map_err(crate::error::DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationError::unhandled)?;
