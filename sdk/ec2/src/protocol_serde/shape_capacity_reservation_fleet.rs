...
pub fn de_capacity_reservation_fleet(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CapacityReservationFleet, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
