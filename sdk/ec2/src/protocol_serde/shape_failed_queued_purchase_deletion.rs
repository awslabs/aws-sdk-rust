...
pub fn de_failed_queued_purchase_deletion(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FailedQueuedPurchaseDeletion, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
