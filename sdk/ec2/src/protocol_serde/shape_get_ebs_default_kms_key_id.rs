...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ebs_default_kms_key_id_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_ebs_default_kms_key_id::de_get_ebs_default_kms_key_id(
                _response_body,
                output,
            )
            .map_err(
                crate::operation::get_ebs_default_kms_key_id::GetEbsDefaultKmsKeyIdError::unhandled,
            )?;
...
pub fn de_get_ebs_default_kms_key_id(
    ...
    crate::operation::get_ebs_default_kms_key_id::builders::GetEbsDefaultKmsKeyIdOutputBuilder,
