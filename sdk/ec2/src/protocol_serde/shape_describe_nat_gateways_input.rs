...
pub fn ser_describe_nat_gateways_input_input(input: &crate::input::DescribeNatGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
