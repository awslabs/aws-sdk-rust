...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_elastic_gpus_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_elastic_gpus::de_describe_elastic_gpus(_response_body, output)
            .map_err(crate::operation::describe_elastic_gpus::DescribeElasticGpusError::unhandled)?;
...
) -> Result<crate::operation::describe_elastic_gpus::builders::DescribeElasticGpusOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
