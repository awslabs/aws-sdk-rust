...
pub fn ser_attach_network_interface_input_input(input: &crate::input::AttachNetworkInterfaceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
