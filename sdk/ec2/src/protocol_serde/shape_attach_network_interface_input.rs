...
pub fn ser_attach_network_interface_input_input_input(input: &crate::operation::attach_network_interface::AttachNetworkInterfaceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
