...
pub fn de_transit_gateway_attachment_bgp_configuration_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TransitGatewayAttachmentBgpConfiguration>, aws_smithy_xml::decode::XmlDecodeError> {
