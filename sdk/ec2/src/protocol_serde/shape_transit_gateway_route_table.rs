...
pub fn de_transit_gateway_route_table(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayRouteTable, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
