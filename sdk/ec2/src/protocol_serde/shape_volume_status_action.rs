...
pub fn de_volume_status_action(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VolumeStatusAction, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
