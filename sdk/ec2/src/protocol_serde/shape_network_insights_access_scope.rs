...
pub fn de_network_insights_access_scope(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NetworkInsightsAccessScope, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
