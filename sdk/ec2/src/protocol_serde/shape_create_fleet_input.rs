...
pub fn ser_create_fleet_input_input_input(input: &crate::operation::create_fleet::CreateFleetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
