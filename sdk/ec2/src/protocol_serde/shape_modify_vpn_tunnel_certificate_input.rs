...
pub fn ser_modify_vpn_tunnel_certificate_input_input_input(input: &crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
