...
pub fn ser_modify_vpn_tunnel_certificate_input_input(input: &crate::input::ModifyVpnTunnelCertificateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
