...
pub fn ser_describe_key_pairs_input_input_input(input: &crate::operation::describe_key_pairs::DescribeKeyPairsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
