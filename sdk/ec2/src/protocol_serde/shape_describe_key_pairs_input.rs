...
pub fn ser_describe_key_pairs_input_input(input: &crate::input::DescribeKeyPairsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
