...
pub fn de_delete_key_pair(
...
) -> std::result::Result<crate::operation::delete_key_pair::builders::DeleteKeyPairOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DeleteKeyPairResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteKeyPairResponse got {start_el:?}"
        )));
    }
