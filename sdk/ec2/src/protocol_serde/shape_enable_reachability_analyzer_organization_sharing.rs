...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_reachability_analyzer_organization_sharing_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_enable_reachability_analyzer_organization_sharing::de_enable_reachability_analyzer_organization_sharing(
                _response_body,
                output,
            )
            .map_err(
