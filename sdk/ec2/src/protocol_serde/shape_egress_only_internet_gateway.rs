...
pub fn de_egress_only_internet_gateway(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EgressOnlyInternetGateway, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
