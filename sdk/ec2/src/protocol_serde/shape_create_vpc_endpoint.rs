...
pub fn de_create_vpc_endpoint_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_vpc_endpoint::CreateVpcEndpointOutput, crate::operation::create_vpc_endpoint::CreateVpcEndpointError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_vpc_endpoint_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_vpc_endpoint::CreateVpcEndpointOutput, crate::operation::create_vpc_endpoint::CreateVpcEndpointError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_create_vpc_endpoint::de_create_vpc_endpoint(_response_body, output)
            .map_err(crate::operation::create_vpc_endpoint::CreateVpcEndpointError::unhandled)?;
...
pub fn de_create_vpc_endpoint(
    ...
    if !(start_el.matches("CreateVpcEndpointResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateVpcEndpointResponse got {start_el:?}"
        )));
    }
