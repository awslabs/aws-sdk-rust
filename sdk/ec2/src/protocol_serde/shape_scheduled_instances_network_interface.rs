...
#[allow(unused_mut)]
pub fn ser_scheduled_instances_network_interface(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ScheduledInstancesNetworkInterface) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
