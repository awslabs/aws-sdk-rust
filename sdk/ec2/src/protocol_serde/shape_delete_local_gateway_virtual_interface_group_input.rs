...
pub fn ser_delete_local_gateway_virtual_interface_group_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DeleteLocalGatewayVirtualInterfaceGroup", "2016-11-15");
    #[allow(unused_mut)]
