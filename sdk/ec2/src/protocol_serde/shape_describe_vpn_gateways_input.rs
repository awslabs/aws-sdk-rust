...
pub fn ser_describe_vpn_gateways_input_input(input: &crate::input::DescribeVpnGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
