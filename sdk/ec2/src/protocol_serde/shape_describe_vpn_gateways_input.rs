...
pub fn ser_describe_vpn_gateways_input_input_input(input: &crate::operation::describe_vpn_gateways::DescribeVpnGatewaysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("VpnGatewayId");
    if let Some(var_7) = &input.vpn_gateway_ids {
        let mut list_9 = scope_6.start_list(true, Some("VpnGatewayId"));
        for item_8 in var_7 {
            #[allow(unused_mut)]
