...
pub fn ser_describe_vpn_gateways_input_input(input: &crate::operation::describe_vpn_gateways::DescribeVpnGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
