...
pub fn ser_describe_spot_instance_requests_input_input(input: &crate::input::DescribeSpotInstanceRequestsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
