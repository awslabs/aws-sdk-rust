...
pub fn ser_describe_spot_instance_requests_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("SpotInstanceRequestId");
    if let Some(var_8) = &input.spot_instance_request_ids {
        if !var_8.is_empty() {
            let mut list_10 = scope_7.start_list(true, Some("SpotInstanceRequestId"));
            for item_9 in var_8 {
                #[allow(unused_mut)]
