...
pub fn ser_describe_spot_instance_requests_input_input_input(input: &crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
