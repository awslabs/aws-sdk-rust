...
pub fn ser_describe_network_interfaces_input_input_input(input: &crate::operation::describe_network_interfaces::DescribeNetworkInterfacesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
