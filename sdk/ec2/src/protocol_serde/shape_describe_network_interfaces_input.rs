...
pub fn ser_describe_network_interfaces_input_input(input: &crate::input::DescribeNetworkInterfacesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
