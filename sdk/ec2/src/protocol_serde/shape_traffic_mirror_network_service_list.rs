...
pub fn de_traffic_mirror_network_service_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TrafficMirrorNetworkService>, aws_smithy_xml::decode::XmlDecodeError> {
