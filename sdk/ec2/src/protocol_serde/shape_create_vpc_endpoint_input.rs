...
pub fn ser_create_vpc_endpoint_input_input_input(input: &crate::operation::create_vpc_endpoint::CreateVpcEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
