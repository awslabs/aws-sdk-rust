...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_revoke_security_group_ingress_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_revoke_security_group_ingress::de_revoke_security_group_ingress(_response_body, output)
            .map_err(crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressError::unhandled)?;
...
pub fn de_revoke_security_group_ingress(
    inp: &[u8],
    mut builder: crate::operation::revoke_security_group_ingress::builders::RevokeSecurityGroupIngressOutputBuilder,
) -> Result<
    crate::operation::revoke_security_group_ingress::builders::RevokeSecurityGroupIngressOutputBuilder,
