...
pub fn ser_create_instance_export_task_input_input(input: &crate::input::CreateInstanceExportTaskInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
