...
pub fn ser_create_instance_export_task_input_input_input(input: &crate::operation::create_instance_export_task::CreateInstanceExportTaskInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
