...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_associated_ipv6_pool_cidrs::de_get_associated_ipv6_pool_cidrs(_response_body, output)
            .map_err(crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError::unhandled)?;
