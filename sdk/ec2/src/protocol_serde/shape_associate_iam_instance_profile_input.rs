...
pub fn ser_associate_iam_instance_profile_input_input(input: &crate::input::AssociateIamInstanceProfileInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
