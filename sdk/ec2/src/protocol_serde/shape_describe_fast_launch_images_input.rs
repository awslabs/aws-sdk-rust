...
pub fn ser_describe_fast_launch_images_input_input(input: &crate::input::DescribeFastLaunchImagesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
