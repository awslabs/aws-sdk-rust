...
pub fn ser_describe_fast_launch_images_input_input_input(input: &crate::operation::describe_fast_launch_images::DescribeFastLaunchImagesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.image_ids {
        let mut list_4 = scope_1.start_list(true, Some("ImageId"));
        for item_3 in var_2 {
            #[allow(unused_mut)]
