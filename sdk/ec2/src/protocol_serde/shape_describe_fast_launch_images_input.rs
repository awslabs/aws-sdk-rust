...
pub fn ser_describe_fast_launch_images_input_input(input: &crate::operation::describe_fast_launch_images::DescribeFastLaunchImagesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
