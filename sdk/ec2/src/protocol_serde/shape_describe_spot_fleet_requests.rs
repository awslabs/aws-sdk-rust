...
pub fn de_describe_spot_fleet_requests_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsOutput, crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_spot_fleet_requests_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsOutput, crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsError> {
    Ok({
        #[allow(unused_mut)]
