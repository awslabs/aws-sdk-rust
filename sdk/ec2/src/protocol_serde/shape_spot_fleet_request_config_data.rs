...
#[allow(unused_mut)]
pub fn ser_spot_fleet_request_config_data(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SpotFleetRequestConfigData) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_spot_fleet_request_config_data(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::SpotFleetRequestConfigData, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::spot_fleet_request_config_data_correct_errors(builder).build())
}
