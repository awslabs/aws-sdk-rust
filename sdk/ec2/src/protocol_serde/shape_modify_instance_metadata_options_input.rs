...
pub fn ser_modify_instance_metadata_options_input_input(input: &crate::input::ModifyInstanceMetadataOptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
