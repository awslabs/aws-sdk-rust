...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_instance_placement::ModifyInstancePlacementError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::modify_instance_placement::ModifyInstancePlacementError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_instance_placement::de_modify_instance_placement(_response_body, output)
            .map_err(crate::operation::modify_instance_placement::ModifyInstancePlacementError::unhandled)?;
...
) -> Result<crate::operation::modify_instance_placement::builders::ModifyInstancePlacementOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
