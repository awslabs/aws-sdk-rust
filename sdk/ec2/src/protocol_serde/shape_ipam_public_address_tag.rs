...
pub fn de_ipam_public_address_tag(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::IpamPublicAddressTag, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
