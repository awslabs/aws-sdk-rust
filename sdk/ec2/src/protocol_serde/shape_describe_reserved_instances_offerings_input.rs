...
pub fn ser_describe_reserved_instances_offerings_input_input(input: &crate::input::DescribeReservedInstancesOfferingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
