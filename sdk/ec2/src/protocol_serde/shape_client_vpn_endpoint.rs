...
pub fn de_client_vpn_endpoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnEndpoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
