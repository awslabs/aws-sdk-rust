...
pub fn ser_authorize_client_vpn_ingress_input_input_input(input: &crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
