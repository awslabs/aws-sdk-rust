...
pub fn ser_deprovision_ipam_pool_cidr_input_input(input: &crate::input::DeprovisionIpamPoolCidrInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
