...
pub fn ser_deprovision_ipam_pool_cidr_input_input_input(input: &crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
