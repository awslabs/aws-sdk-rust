...
pub fn ser_describe_client_vpn_routes_input_input_input(input: &crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
