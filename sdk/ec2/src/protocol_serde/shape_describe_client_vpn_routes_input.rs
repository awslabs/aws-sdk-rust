...
pub fn ser_describe_client_vpn_routes_input_input(input: &crate::input::DescribeClientVpnRoutesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
