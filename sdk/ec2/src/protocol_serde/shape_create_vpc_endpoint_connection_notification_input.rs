...
pub fn ser_create_vpc_endpoint_connection_notification_input_input(input: &crate::input::CreateVpcEndpointConnectionNotificationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
