...
#[allow(unused_mut)]
pub fn ser_scheduled_instance_recurrence_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ScheduledInstanceRecurrenceRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
