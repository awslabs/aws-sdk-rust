...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_instance_type_offerings::DescribeInstanceTypeOfferingsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_instance_type_offerings::de_describe_instance_type_offerings(_response_body, output)
            .map_err(crate::operation::describe_instance_type_offerings::DescribeInstanceTypeOfferingsError::unhandled)?;
