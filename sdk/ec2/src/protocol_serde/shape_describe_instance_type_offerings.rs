...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_instance_type_offerings_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_instance_type_offerings::DescribeInstanceTypeOfferingsOutput, crate::operation::describe_instance_type_offerings::DescribeInstanceTypeOfferingsError> {
    Ok({
        #[allow(unused_mut)]
