...
pub fn ser_reject_transit_gateway_multicast_domain_associations_input_input(input: &crate::input::RejectTransitGatewayMulticastDomainAssociationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
