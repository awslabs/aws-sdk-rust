...
pub fn ser_list_snapshots_in_recycle_bin_input_input_input(input: &crate::operation::list_snapshots_in_recycle_bin::ListSnapshotsInRecycleBinInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
