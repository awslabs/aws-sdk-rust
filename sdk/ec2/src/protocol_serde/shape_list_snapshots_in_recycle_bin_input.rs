...
pub fn ser_list_snapshots_in_recycle_bin_input_input(input: &crate::input::ListSnapshotsInRecycleBinInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
