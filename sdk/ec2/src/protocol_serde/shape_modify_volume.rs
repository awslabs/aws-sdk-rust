...
> {
    ...
    Err(crate::operation::modify_volume::ModifyVolumeError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_volume_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_modify_volume::de_modify_volume(_response_body, output)
                .map_err(crate::operation::modify_volume::ModifyVolumeError::unhandled)?;
...
pub fn de_modify_volume(
    ...
    crate::operation::modify_volume::builders::ModifyVolumeOutputBuilder,
