...
pub fn ser_create_flow_logs_input_input(input: &crate::input::CreateFlowLogsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
