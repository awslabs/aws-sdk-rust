...
pub fn ser_create_flow_logs_input_input_input(input: &crate::operation::create_flow_logs::CreateFlowLogsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
