...
pub fn ser_create_launch_template_version_input_input(input: &crate::input::CreateLaunchTemplateVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
