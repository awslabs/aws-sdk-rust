...
pub fn de_describe_fast_snapshot_restore_success_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DescribeFastSnapshotRestoreSuccessItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
