...
pub fn ser_describe_account_attributes_input_input_input(input: &crate::operation::describe_account_attributes::DescribeAccountAttributesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
