...
pub fn de_placement_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PlacementResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
