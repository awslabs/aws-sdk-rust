...
pub fn de_accept_reserved_instances_exchange_quote_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_accept_reserved_instances_exchange_quote::de_accept_reserved_instances_exchange_quote(
            _response_body,
            output,
        )
        .map_err(crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError::unhandled)?;
