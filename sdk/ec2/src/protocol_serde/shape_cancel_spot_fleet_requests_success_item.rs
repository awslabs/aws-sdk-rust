...
pub fn de_cancel_spot_fleet_requests_success_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CancelSpotFleetRequestsSuccessItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
