...
pub fn de_cancel_spot_fleet_requests_success_item(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::CancelSpotFleetRequestsSuccessItem, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
