...
pub fn de_reserved_instances_modification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReservedInstancesModification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
