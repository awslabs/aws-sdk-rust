...
pub fn de_fast_launch_launch_template_specification_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FastLaunchLaunchTemplateSpecificationResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
