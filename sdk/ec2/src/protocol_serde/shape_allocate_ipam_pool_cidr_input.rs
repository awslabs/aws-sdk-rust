...
pub fn ser_allocate_ipam_pool_cidr_input_input_input(input: &crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
