...
pub fn ser_allocate_ipam_pool_cidr_input_input(input: &crate::input::AllocateIpamPoolCidrInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
