...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_vpc_classic_link_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disable_vpc_classic_link::de_disable_vpc_classic_link(_response_body, output)
            .map_err(crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError::unhandled)?;
...
) -> Result<crate::operation::disable_vpc_classic_link::builders::DisableVpcClassicLinkOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
