...
pub fn ser_disassociate_transit_gateway_route_table_input_input(input: &crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
