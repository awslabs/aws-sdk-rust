...
pub fn de_cancel_import_task(
...
) -> std::result::Result<crate::operation::cancel_import_task::builders::CancelImportTaskOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CancelImportTaskResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CancelImportTaskResponse got {start_el:?}"
        )));
    }
