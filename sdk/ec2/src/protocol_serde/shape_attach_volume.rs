...
pub fn de_attach_volume(
...
) -> std::result::Result<crate::operation::attach_volume::builders::AttachVolumeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("AttachVolumeResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AttachVolumeResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("ebsCardIndex") /* EbsCardIndex com.amazonaws.ec2.synthetic#AttachVolumeOutput$EbsCardIndex */ =>  {
                let var_4 =
                    Some(
                         {
