...
pub fn de_attach_volume_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AttachVolumeOutput, crate::error::AttachVolumeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AttachVolumeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_volume_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AttachVolumeOutput, crate::error::AttachVolumeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::attach_volume_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_attach_volume::de_attach_volume(response.body().as_ref(), output).map_err(crate::error::AttachVolumeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_attach_volume(inp: &[u8], mut builder: crate::output::attach_volume_output::Builder) -> Result<crate::output::attach_volume_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
