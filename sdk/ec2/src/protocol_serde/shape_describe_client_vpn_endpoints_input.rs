...
pub fn ser_describe_client_vpn_endpoints_input_input_input(input: &crate::operation::describe_client_vpn_endpoints::DescribeClientVpnEndpointsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.client_vpn_endpoint_ids {
