...
pub fn ser_describe_client_vpn_endpoints_input_input(input: &crate::operation::describe_client_vpn_endpoints::DescribeClientVpnEndpointsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
