...
pub fn de_get_transit_gateway_route_table_propagations_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsOutput, crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_transit_gateway_route_table_propagations_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsOutput, crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError> {
    Ok({
        #[allow(unused_mut)]
