...
pub fn de_get_transit_gateway_route_table_propagations_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_transit_gateway_route_table_propagations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_transit_gateway_route_table_propagations::de_get_transit_gateway_route_table_propagations(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_transit_gateway_route_table_propagations::GetTransitGatewayRouteTablePropagationsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_transit_gateway_route_table_propagations(
    inp: &[u8],
    mut builder: crate::operation::get_transit_gateway_route_table_propagations::builders::GetTransitGatewayRouteTablePropagationsOutputBuilder,
) -> std::result::Result<
    crate::operation::get_transit_gateway_route_table_propagations::builders::GetTransitGatewayRouteTablePropagationsOutputBuilder,
...
> {
    ...
    if !(start_el.matches("GetTransitGatewayRouteTablePropagationsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetTransitGatewayRouteTablePropagationsResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("transitGatewayRouteTablePropagations") /* TransitGatewayRouteTablePropagations com.amazonaws.ec2.synthetic#GetTransitGatewayRouteTablePropagationsOutput$TransitGatewayRouteTablePropagations */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_transit_gateway_route_table_propagation_list::de_transit_gateway_route_table_propagation_list(&mut tag, depth + 1)
                        ?
                    )
                ;
