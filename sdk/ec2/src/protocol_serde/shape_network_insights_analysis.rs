...
pub fn de_network_insights_analysis(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NetworkInsightsAnalysis, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
