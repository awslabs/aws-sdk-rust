...
#[allow(unused_mut)]
pub fn ser_create_transit_gateway_vpc_attachment_request_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::CreateTransitGatewayVpcAttachmentRequestOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
