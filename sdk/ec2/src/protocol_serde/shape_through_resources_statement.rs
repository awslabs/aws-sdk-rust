...
pub fn de_through_resources_statement(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ThroughResourcesStatement, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
