...
pub fn de_describe_aws_network_performance_metric_subscriptions_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
        crate::operation::describe_aws_network_performance_metric_subscriptions::DescribeAwsNetworkPerformanceMetricSubscriptionsError::unhandled,
    )?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(
        crate::operation::describe_aws_network_performance_metric_subscriptions::DescribeAwsNetworkPerformanceMetricSubscriptionsError::generic(
            generic,
        ),
    )
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_aws_network_performance_metric_subscriptions_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    ...
    if !(start_el.matches("DescribeAwsNetworkPerformanceMetricSubscriptionsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeAwsNetworkPerformanceMetricSubscriptionsResponse got {:?}",
            start_el
        )));
    }
