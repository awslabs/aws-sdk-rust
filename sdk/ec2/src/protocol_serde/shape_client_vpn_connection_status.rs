...
pub fn de_client_vpn_connection_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnConnectionStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
