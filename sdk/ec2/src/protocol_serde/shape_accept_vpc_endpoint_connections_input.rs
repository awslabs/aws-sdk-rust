...
pub fn ser_accept_vpc_endpoint_connections_input_input(input: &crate::input::AcceptVpcEndpointConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
