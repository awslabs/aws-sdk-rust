...
pub fn ser_accept_vpc_endpoint_connections_input_input_input(input: &crate::operation::accept_vpc_endpoint_connections::AcceptVpcEndpointConnectionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
