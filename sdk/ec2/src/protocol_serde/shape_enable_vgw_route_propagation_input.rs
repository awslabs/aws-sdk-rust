...
pub fn ser_enable_vgw_route_propagation_input_input_input(input: &crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
