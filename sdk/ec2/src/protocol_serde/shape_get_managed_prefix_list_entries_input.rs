...
pub fn ser_get_managed_prefix_list_entries_input_input_input(input: &crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_5 = writer.prefix("TargetVersion");
    if let Some(var_6) = &input.target_version {
