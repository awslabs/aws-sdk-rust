...
pub fn ser_describe_hosts_input_input_input(input: &crate::operation::describe_hosts::DescribeHostsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
