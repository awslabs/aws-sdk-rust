...
pub fn de_security_group_reference(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SecurityGroupReference, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
