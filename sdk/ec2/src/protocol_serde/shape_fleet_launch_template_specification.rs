...
#[allow(unused_mut)]
pub fn ser_fleet_launch_template_specification(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::FleetLaunchTemplateSpecification) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
