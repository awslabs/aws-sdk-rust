...
#[allow(unused_mut)]
pub fn ser_fleet_launch_template_specification(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::FleetLaunchTemplateSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_fleet_launch_template_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FleetLaunchTemplateSpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
