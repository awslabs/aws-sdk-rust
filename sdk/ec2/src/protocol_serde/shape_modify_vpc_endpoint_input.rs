...
pub fn ser_modify_vpc_endpoint_input_input_input(input: &crate::operation::modify_vpc_endpoint::ModifyVpcEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
