...
pub fn ser_create_spot_datafeed_subscription_input_input(input: &crate::input::CreateSpotDatafeedSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
