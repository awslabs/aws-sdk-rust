...
pub fn ser_create_spot_datafeed_subscription_input_input_input(input: &crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
