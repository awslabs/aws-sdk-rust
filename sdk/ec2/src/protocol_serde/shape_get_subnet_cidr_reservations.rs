...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_subnet_cidr_reservations::de_get_subnet_cidr_reservations(_response_body, output)
            .map_err(crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsError::unhandled)?;
