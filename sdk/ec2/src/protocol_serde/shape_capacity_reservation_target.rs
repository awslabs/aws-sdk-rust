...
#[allow(unused_mut)]
pub fn ser_capacity_reservation_target(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::CapacityReservationTarget) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
