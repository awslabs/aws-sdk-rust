...
pub fn ser_get_capacity_reservation_usage_input_input_input(input: &crate::operation::get_capacity_reservation_usage::GetCapacityReservationUsageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
