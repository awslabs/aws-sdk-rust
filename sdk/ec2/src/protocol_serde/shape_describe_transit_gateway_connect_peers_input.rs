...
pub fn ser_describe_transit_gateway_connect_peers_input_input(input: &crate::input::DescribeTransitGatewayConnectPeersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
