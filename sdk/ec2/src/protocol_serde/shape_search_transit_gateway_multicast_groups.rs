...
pub fn de_search_transit_gateway_multicast_groups_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::search_transit_gateway_multicast_groups::SearchTransitGatewayMulticastGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_search_transit_gateway_multicast_groups_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_search_transit_gateway_multicast_groups::de_search_transit_gateway_multicast_groups(_response_body, output)
                .map_err(crate::operation::search_transit_gateway_multicast_groups::SearchTransitGatewayMulticastGroupsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_search_transit_gateway_multicast_groups(
    inp: &[u8],
    mut builder: crate::operation::search_transit_gateway_multicast_groups::builders::SearchTransitGatewayMulticastGroupsOutputBuilder,
) -> Result<
    crate::operation::search_transit_gateway_multicast_groups::builders::SearchTransitGatewayMulticastGroupsOutputBuilder,
