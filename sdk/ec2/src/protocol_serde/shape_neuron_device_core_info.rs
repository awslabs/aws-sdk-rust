...
pub fn de_neuron_device_core_info(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::NeuronDeviceCoreInfo, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
