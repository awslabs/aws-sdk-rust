...
#[allow(unused_mut)]
pub fn ser_modify_verified_access_endpoint_load_balancer_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ModifyVerifiedAccessEndpointLoadBalancerOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
