...
#[allow(unused_mut)]
pub fn ser_modify_verified_access_endpoint_load_balancer_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ModifyVerifiedAccessEndpointLoadBalancerOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
