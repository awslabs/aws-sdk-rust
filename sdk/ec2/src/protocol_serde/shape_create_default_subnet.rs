...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_default_subnet_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_default_subnet::de_create_default_subnet(_response_body, output)
            .map_err(crate::operation::create_default_subnet::CreateDefaultSubnetError::unhandled)?;
...
) -> Result<crate::operation::create_default_subnet::builders::CreateDefaultSubnetOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
