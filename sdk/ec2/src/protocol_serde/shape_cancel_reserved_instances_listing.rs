...
pub fn de_cancel_reserved_instances_listing_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingOutput, crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_reserved_instances_listing_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingOutput, crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingError> {
    Ok({
        #[allow(unused_mut)]
