...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_reserved_instances_listing::de_cancel_reserved_instances_listing(_response_body, output)
            .map_err(crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("CancelReservedInstancesListingResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CancelReservedInstancesListingResponse got {start_el:?}"
        )));
    }
