...
pub fn ser_describe_ipam_pool_allocations_input_input_input(
    input: &crate::operation::describe_ipam_pool_allocations::DescribeIpamPoolAllocationsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeIpamPoolAllocations", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("IpamPoolAllocationId");
    if let Some(var_4) = &input.ipam_pool_allocation_ids {
        if !var_4.is_empty() {
