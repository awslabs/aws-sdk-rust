...
pub fn ser_delete_transit_gateway_vpc_attachment_input_input(input: &crate::input::DeleteTransitGatewayVpcAttachmentInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
