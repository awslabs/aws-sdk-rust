...
#[allow(unused_mut)]
pub fn ser_load_balancers_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LoadBalancersConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
