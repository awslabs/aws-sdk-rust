...
pub fn de_instance_state_change(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceStateChange, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
