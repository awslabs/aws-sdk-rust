...
pub fn de_network_interface_permission(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NetworkInterfacePermission, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
