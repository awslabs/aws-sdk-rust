...
pub fn de_route_table_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RouteTableAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
