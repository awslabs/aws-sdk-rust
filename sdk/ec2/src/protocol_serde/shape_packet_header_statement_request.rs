...
#[allow(unused_mut)]
pub fn ser_packet_header_statement_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PacketHeaderStatementRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
