...
pub fn de_cancel_spot_instance_requests_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsOutput, crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError> {
    #[allow(unused_mut)]
