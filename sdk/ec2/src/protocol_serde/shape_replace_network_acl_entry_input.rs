...
pub fn ser_replace_network_acl_entry_input_input(input: &crate::input::ReplaceNetworkAclEntryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
