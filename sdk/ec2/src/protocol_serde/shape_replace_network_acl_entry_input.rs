...
pub fn ser_replace_network_acl_entry_input_input_input(input: &crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
