...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_transit_gateway_policy_table_associations_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::GetTransitGatewayPolicyTableAssociationsOutput,
    crate::error::GetTransitGatewayPolicyTableAssociationsError,
...
pub fn de_get_transit_gateway_policy_table_associations(
    inp: &[u8],
    mut builder: crate::output::get_transit_gateway_policy_table_associations_output::Builder,
) -> Result<
    crate::output::get_transit_gateway_policy_table_associations_output::Builder,
