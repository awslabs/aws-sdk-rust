...
pub fn ser_create_network_interface_permission_input_input(input: &crate::input::CreateNetworkInterfacePermissionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
