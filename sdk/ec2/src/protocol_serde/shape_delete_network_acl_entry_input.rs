...
pub fn ser_delete_network_acl_entry_input_input_input(input: &crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
