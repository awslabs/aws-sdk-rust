...
pub fn ser_describe_route_tables_input_input_input(input: &crate::operation::describe_route_tables::DescribeRouteTablesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("RouteTableId");
