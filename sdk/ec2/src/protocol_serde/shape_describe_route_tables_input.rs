...
pub fn ser_describe_route_tables_input_input_input(
    input: &crate::operation::describe_route_tables::DescribeRouteTablesInput,
    ...
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("RouteTableId");
    if let Some(var_8) = &input.route_table_ids {
        if !var_8.is_empty() {
