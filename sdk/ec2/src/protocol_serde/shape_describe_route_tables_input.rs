...
pub fn ser_describe_route_tables_input_input(input: &crate::operation::describe_route_tables::DescribeRouteTablesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
