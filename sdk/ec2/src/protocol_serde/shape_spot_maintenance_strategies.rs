...
#[allow(unused_mut)]
pub fn ser_spot_maintenance_strategies(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SpotMaintenanceStrategies) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
