...
pub fn ser_modify_traffic_mirror_session_input_input(input: &crate::input::ModifyTrafficMirrorSessionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
