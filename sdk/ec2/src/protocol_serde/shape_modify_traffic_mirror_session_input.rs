...
pub fn ser_modify_traffic_mirror_session_input_input_input(input: &crate::operation::modify_traffic_mirror_session::ModifyTrafficMirrorSessionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
