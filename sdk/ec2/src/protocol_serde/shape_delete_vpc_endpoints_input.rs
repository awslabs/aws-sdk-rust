...
pub fn ser_delete_vpc_endpoints_input_input_input(input: &crate::operation::delete_vpc_endpoints::DeleteVpcEndpointsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
