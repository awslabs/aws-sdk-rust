...
pub fn ser_delete_vpc_endpoints_input_input(input: &crate::input::DeleteVpcEndpointsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
