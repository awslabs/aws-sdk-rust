...
pub fn de_associated_target_network(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AssociatedTargetNetwork, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
