...
#[allow(unused_mut)]
pub fn ser_fleet_capacity_reservation_target_request(
    mut writer: ::aws_smithy_query::QueryValueWriter,
    input: &crate::types::FleetCapacityReservationTargetRequest,
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("CapacityReservationResourceGroupArn");
