...
pub fn de_bundle_instance_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_bundle_instance::de_bundle_instance(_response_body, output)
            .map_err(crate::operation::bundle_instance::BundleInstanceError::unhandled)?;
...
) -> std::result::Result<crate::operation::bundle_instance::builders::BundleInstanceOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
