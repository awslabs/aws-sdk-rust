...
pub fn ser_describe_scheduled_instance_availability_input_input(input: &crate::input::DescribeScheduledInstanceAvailabilityInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
