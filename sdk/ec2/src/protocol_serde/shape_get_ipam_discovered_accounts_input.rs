...
pub fn ser_get_ipam_discovered_accounts_input_input_input(input: &crate::operation::get_ipam_discovered_accounts::GetIpamDiscoveredAccountsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
