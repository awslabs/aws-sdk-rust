...
pub fn ser_get_transit_gateway_attachment_propagations_input_input(input: &crate::input::GetTransitGatewayAttachmentPropagationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
