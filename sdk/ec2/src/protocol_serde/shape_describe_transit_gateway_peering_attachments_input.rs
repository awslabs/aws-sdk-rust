...
pub fn ser_describe_transit_gateway_peering_attachments_input_input(input: &crate::input::DescribeTransitGatewayPeeringAttachmentsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
