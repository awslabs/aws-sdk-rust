...
pub fn ser_describe_transit_gateway_peering_attachments_input_input_input(
    input: &crate::operation::describe_transit_gateway_peering_attachments::DescribeTransitGatewayPeeringAttachmentsInput,
