...
pub fn ser_terminate_client_vpn_connections_input_input(input: &crate::input::TerminateClientVpnConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
