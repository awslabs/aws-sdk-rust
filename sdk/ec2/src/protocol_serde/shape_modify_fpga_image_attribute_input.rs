...
pub fn ser_modify_fpga_image_attribute_input_input(input: &crate::input::ModifyFpgaImageAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
