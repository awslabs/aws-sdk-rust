...
pub fn ser_modify_fpga_image_attribute_input_input_input(input: &crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
