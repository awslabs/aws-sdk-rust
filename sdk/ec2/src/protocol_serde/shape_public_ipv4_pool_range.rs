...
pub fn de_public_ipv4_pool_range(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PublicIpv4PoolRange, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
