...
pub fn ser_describe_fast_snapshot_restores_input_input(input: &crate::input::DescribeFastSnapshotRestoresInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
