...
pub fn ser_describe_fast_snapshot_restores_input_input_input(input: &crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
