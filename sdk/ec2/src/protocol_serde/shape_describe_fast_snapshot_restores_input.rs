...
pub fn ser_describe_fast_snapshot_restores_input_input(input: &crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
