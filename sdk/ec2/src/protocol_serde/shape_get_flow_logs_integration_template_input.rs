...
pub fn ser_get_flow_logs_integration_template_input_input(input: &crate::input::GetFlowLogsIntegrationTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
