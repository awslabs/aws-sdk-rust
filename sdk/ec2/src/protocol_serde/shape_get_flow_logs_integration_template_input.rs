...
pub fn ser_get_flow_logs_integration_template_input_input_input(input: &crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
