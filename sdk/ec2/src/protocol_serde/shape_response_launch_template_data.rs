...
pub fn de_response_launch_template_data(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResponseLaunchTemplateData, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
