...
pub fn ser_delete_verified_access_group_input_input_input(input: &crate::operation::delete_verified_access_group::DeleteVerifiedAccessGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
