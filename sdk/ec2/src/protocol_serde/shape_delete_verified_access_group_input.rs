...
pub fn ser_delete_verified_access_group_input_input(input: &crate::input::DeleteVerifiedAccessGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
