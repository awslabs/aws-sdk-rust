...
pub fn de_transit_gateway_prefix_list_attachment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TransitGatewayPrefixListAttachment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::TransitGatewayPrefixListAttachment::builder();
