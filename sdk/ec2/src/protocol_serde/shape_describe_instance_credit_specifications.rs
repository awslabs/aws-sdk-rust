...
pub fn de_describe_instance_credit_specifications_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_instance_credit_specifications_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_instance_credit_specifications::de_describe_instance_credit_specifications(_response_body, output)
                .map_err(crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeInstanceCreditSpecificationsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeInstanceCreditSpecificationsResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("instanceCreditSpecificationSet") /* InstanceCreditSpecifications com.amazonaws.ec2.synthetic#DescribeInstanceCreditSpecificationsOutput$InstanceCreditSpecifications */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_instance_credit_specification_list::de_instance_credit_specification_list(&mut tag, depth + 1)
                        ?
                    )
                ;
