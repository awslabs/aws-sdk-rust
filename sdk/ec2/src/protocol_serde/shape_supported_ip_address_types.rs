...
pub fn de_supported_ip_address_types(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ServiceConnectivityType>, aws_smithy_xml::decode::XmlDecodeError> {
