...
#[allow(unused_mut)]
pub fn ser_memory_mib_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MemoryMiBRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
