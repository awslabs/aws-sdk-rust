...
pub fn ser_create_verified_access_trust_provider_input_input(input: &crate::input::CreateVerifiedAccessTrustProviderInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
