...
pub fn ser_describe_capacity_reservations_input_input(input: &crate::operation::describe_capacity_reservations::DescribeCapacityReservationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
