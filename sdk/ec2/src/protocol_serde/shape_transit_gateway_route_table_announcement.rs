...
pub fn de_transit_gateway_route_table_announcement(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayRouteTableAnnouncement, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
