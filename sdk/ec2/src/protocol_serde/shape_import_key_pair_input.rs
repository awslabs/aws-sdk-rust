...
pub fn ser_import_key_pair_input_input_input(input: &crate::operation::import_key_pair::ImportKeyPairInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
