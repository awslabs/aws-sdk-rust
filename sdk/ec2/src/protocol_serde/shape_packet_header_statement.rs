...
pub fn de_packet_header_statement(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PacketHeaderStatement, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
