...
pub fn ser_search_transit_gateway_multicast_groups_input_input(input: &crate::input::SearchTransitGatewayMulticastGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
