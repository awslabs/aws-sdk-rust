...
pub fn de_instance_type_info_from_instance_requirements(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceTypeInfoFromInstanceRequirements, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
