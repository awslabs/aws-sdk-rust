...
pub fn ser_run_scheduled_instances_input_input_input(input: &crate::operation::run_scheduled_instances::RunScheduledInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
