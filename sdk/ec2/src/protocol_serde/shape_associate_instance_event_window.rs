...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_instance_event_window::AssociateInstanceEventWindowError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_instance_event_window::de_associate_instance_event_window(_response_body, output)
            .map_err(crate::operation::associate_instance_event_window::AssociateInstanceEventWindowError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("AssociateInstanceEventWindowResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AssociateInstanceEventWindowResponse got {start_el:?}"
        )));
    }
