...
pub fn ser_create_verified_access_instance_input_input_input(input: &crate::operation::create_verified_access_instance::CreateVerifiedAccessInstanceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
