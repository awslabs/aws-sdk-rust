...
pub fn de_alternate_path_hint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AlternatePathHint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
