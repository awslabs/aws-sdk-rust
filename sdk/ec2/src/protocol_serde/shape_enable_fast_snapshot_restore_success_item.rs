...
pub fn de_enable_fast_snapshot_restore_success_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EnableFastSnapshotRestoreSuccessItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
