...
pub fn ser_detach_network_interface_input_input(input: &crate::input::DetachNetworkInterfaceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
