...
pub fn ser_detach_network_interface_input_input_input(input: &crate::operation::detach_network_interface::DetachNetworkInterfaceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
