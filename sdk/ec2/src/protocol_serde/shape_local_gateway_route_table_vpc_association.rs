...
pub fn de_local_gateway_route_table_vpc_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LocalGatewayRouteTableVpcAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
