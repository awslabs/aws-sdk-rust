...
pub fn ser_create_vpc_input_input_input(input: &crate::operation::create_vpc::CreateVpcInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
