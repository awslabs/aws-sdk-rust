...
pub fn de_history_record_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HistoryRecordEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
