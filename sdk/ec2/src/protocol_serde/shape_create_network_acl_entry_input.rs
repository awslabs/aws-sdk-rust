...
pub fn ser_create_network_acl_entry_input_input(input: &crate::input::CreateNetworkAclEntryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
