...
pub fn ser_describe_public_ipv4_pools_input_input_input(input: &crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
