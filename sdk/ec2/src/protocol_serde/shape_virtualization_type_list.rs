...
pub fn de_virtualization_type_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::VirtualizationType>, aws_smithy_xml::decode::XmlDecodeError> {
