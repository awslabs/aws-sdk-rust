...
pub fn de_connection_log_response_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConnectionLogResponseOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
