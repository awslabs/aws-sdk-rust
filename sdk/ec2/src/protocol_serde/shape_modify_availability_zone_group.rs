...
pub fn de_modify_availability_zone_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupOutput, crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_availability_zone_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupOutput, crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupError> {
    Ok({
        #[allow(unused_mut)]
