...
pub fn de_transit_gateway_peering_attachment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayPeeringAttachment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
