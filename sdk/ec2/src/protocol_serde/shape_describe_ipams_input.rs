...
pub fn ser_describe_ipams_input_input(input: &crate::input::DescribeIpamsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
