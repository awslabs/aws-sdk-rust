...
pub fn de_transit_gateway_peering_attachment_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayPeeringAttachmentOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
