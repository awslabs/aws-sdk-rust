...
pub fn de_spot_datafeed_subscription(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotDatafeedSubscription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
