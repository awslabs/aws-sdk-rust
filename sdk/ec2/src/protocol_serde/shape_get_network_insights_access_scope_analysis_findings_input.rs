...
pub fn ser_get_network_insights_access_scope_analysis_findings_input_input(input: &crate::input::GetNetworkInsightsAccessScopeAnalysisFindingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
