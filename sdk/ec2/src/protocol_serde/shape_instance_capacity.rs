...
pub fn de_instance_capacity(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::InstanceCapacity, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::InstanceCapacity::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("availableCapacity") /* AvailableCapacity com.amazonaws.ec2#InstanceCapacity$AvailableCapacity */ =>  {
                ...
                ;
                builder = builder.set_available_capacity(var_1);
            }
            ,
