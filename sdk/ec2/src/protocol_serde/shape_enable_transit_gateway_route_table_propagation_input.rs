...
pub fn ser_enable_transit_gateway_route_table_propagation_input_input(input: &crate::input::EnableTransitGatewayRouteTablePropagationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
