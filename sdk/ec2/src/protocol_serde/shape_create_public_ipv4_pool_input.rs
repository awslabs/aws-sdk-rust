...
pub fn ser_create_public_ipv4_pool_input_input(input: &crate::input::CreatePublicIpv4PoolInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
