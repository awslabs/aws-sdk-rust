...
pub fn ser_create_public_ipv4_pool_input_input_input(input: &crate::operation::create_public_ipv4_pool::CreatePublicIpv4PoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
