...
pub fn ser_create_network_insights_path_input_input(input: &crate::input::CreateNetworkInsightsPathInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
