...
pub fn de_transit_gateway_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
