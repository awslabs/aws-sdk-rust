...
pub fn ser_disassociate_transit_gateway_multicast_domain_input_input(input: &crate::input::DisassociateTransitGatewayMulticastDomainInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
