...
pub fn ser_describe_instance_image_metadata_input_input_input(
    input: &crate::operation::describe_instance_image_metadata::DescribeInstanceImageMetadataInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeInstanceImageMetadata", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("InstanceId");
    if let Some(var_7) = &input.instance_ids {
        if !var_7.is_empty() {
            let mut list_9 = scope_6.start_list(true, Some("InstanceId"));
            for item_8 in var_7 {
                #[allow(unused_mut)]
