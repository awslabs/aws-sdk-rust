...
pub fn de_classic_link_instance(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClassicLinkInstance, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
