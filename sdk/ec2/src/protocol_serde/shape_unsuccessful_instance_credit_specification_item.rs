...
pub fn de_unsuccessful_instance_credit_specification_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::UnsuccessfulInstanceCreditSpecificationItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
