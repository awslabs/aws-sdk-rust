...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::terminate_client_vpn_connections::TerminateClientVpnConnectionsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_terminate_client_vpn_connections::de_terminate_client_vpn_connections(_response_body, output)
            .map_err(crate::operation::terminate_client_vpn_connections::TerminateClientVpnConnectionsError::unhandled)?;
