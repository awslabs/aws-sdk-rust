...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_instance_event_window::DisassociateInstanceEventWindowError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_instance_event_window::de_disassociate_instance_event_window(_response_body, output)
            .map_err(crate::operation::disassociate_instance_event_window::DisassociateInstanceEventWindowError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DisassociateInstanceEventWindowResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DisassociateInstanceEventWindowResponse got {start_el:?}"
        )));
    }
