...
#[allow(unused_mut)]
pub fn ser_ebs_block_device(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::EbsBlockDevice) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
