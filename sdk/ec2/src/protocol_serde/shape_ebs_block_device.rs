...
#[allow(unused_mut)]
pub fn ser_ebs_block_device(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::EbsBlockDevice) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_ebs_block_device(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EbsBlockDevice, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
