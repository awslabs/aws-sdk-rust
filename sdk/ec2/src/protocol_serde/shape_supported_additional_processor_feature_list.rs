...
pub fn de_supported_additional_processor_feature_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<::std::vec::Vec::<crate::types::SupportedAdditionalProcessorFeature>, ::aws_smithy_xml::decode::XmlDecodeError> {
