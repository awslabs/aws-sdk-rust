...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_verified_access_group::ModifyVerifiedAccessGroupError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::modify_verified_access_group::ModifyVerifiedAccessGroupError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_verified_access_group::de_modify_verified_access_group(_response_body, output)
            .map_err(crate::operation::modify_verified_access_group::ModifyVerifiedAccessGroupError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyVerifiedAccessGroupResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyVerifiedAccessGroupResponse got {start_el:?}"
        )));
    }
