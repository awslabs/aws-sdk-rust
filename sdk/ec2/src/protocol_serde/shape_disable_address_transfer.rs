...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_disable_address_transfer::de_disable_address_transfer(
...
pub fn de_disable_address_transfer(
    inp: &[u8],
    mut builder: crate::output::disable_address_transfer_output::Builder,
) -> Result<
    crate::output::disable_address_transfer_output::Builder,
