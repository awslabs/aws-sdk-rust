...
pub fn de_instance_ipv4_prefix(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceIpv4Prefix, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
