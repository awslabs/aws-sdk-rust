...
pub fn ser_create_coip_pool_input_input_input(input: &crate::operation::create_coip_pool::CreateCoipPoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
