...
pub fn ser_create_coip_pool_input_input(input: &crate::input::CreateCoipPoolInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
