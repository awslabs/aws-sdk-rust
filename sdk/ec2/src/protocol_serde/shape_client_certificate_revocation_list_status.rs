...
pub fn de_client_certificate_revocation_list_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientCertificateRevocationListStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
