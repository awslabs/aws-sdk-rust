...
pub fn ser_modify_ipam_pool_input_input(input: &crate::input::ModifyIpamPoolInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
