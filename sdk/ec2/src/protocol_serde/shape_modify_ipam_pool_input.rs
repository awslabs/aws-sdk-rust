...
pub fn ser_modify_ipam_pool_input_input_input(input: &crate::operation::modify_ipam_pool::ModifyIpamPoolInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
