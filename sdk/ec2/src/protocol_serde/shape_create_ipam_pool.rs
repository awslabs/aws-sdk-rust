...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_ipam_pool_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_ipam_pool::de_create_ipam_pool(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_ipam_pool::CreateIpamPoolError::unhandled)?;
...
pub fn de_create_ipam_pool(
    ...
    crate::operation::create_ipam_pool::builders::CreateIpamPoolOutputBuilder,
