...
pub fn ser_describe_conversion_tasks_input_input_input(input: &crate::operation::describe_conversion_tasks::DescribeConversionTasksInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
