...
pub fn ser_replace_transit_gateway_route_input_input_input(input: &crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
