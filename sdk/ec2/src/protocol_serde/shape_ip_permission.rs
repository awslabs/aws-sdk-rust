...
#[allow(unused_mut)]
pub fn ser_ip_permission(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::IpPermission) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_ip_permission(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IpPermission, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
