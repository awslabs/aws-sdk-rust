...
#[allow(unused_mut)]
pub fn ser_ip_permission(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::IpPermission) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
