...
pub fn ser_modify_network_interface_attribute_input_input(input: &crate::input::ModifyNetworkInterfaceAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
