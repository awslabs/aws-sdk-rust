...
pub fn ser_delete_transit_gateway_input_input(input: &crate::input::DeleteTransitGatewayInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
