...
#[allow(unused_mut)]
pub fn ser_client_vpn_authentication_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ClientVpnAuthenticationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
