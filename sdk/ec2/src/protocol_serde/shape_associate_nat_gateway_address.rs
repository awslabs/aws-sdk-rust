...
> {
    ...
    .map_err(
        crate::operation::associate_nat_gateway_address::AssociateNatGatewayAddressError::unhandled,
    )?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(
        crate::operation::associate_nat_gateway_address::AssociateNatGatewayAddressError::generic(
            generic,
        ),
    )
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_nat_gateway_address_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
