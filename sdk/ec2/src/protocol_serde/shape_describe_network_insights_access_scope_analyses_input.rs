...
pub fn ser_describe_network_insights_access_scope_analyses_input_input(input: &crate::input::DescribeNetworkInsightsAccessScopeAnalysesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
