...
pub fn ser_create_restore_image_task_input_input_input(input: &crate::operation::create_restore_image_task::CreateRestoreImageTaskInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
