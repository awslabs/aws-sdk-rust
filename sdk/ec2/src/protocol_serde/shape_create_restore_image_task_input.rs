...
pub fn ser_create_restore_image_task_input_input(input: &crate::input::CreateRestoreImageTaskInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
