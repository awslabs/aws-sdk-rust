...
pub fn de_spot_placement_score(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotPlacementScore, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
