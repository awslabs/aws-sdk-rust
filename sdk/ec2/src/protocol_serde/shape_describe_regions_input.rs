...
pub fn ser_describe_regions_input_input(input: &crate::input::DescribeRegionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
