...
pub fn ser_describe_regions_input_input_input(input: &crate::operation::describe_regions::DescribeRegionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
