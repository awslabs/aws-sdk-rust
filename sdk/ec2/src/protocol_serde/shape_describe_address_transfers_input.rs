...
pub fn ser_describe_address_transfers_input_input_input(input: &crate::operation::describe_address_transfers::DescribeAddressTransfersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
