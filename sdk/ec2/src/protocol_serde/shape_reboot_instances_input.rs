...
pub fn ser_reboot_instances_input_input_input(input: &crate::operation::reboot_instances::RebootInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
