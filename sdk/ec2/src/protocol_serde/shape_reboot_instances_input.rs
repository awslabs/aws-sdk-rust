...
pub fn ser_reboot_instances_input_input(input: &crate::input::RebootInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
