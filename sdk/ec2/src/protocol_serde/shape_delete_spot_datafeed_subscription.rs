...
pub fn de_delete_spot_datafeed_subscription_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionOutput, crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError> {
    #[allow(unused_mut)]
