...
pub fn de_delete_spot_datafeed_subscription_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionOutput, crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_spot_datafeed_subscription_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionOutput, crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
