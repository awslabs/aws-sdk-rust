...
pub fn de_modify_ipam_pool_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::modify_ipam_pool::ModifyIpamPoolOutput, crate::operation::modify_ipam_pool::ModifyIpamPoolError> {
    #[allow(unused_mut)]
...
pub fn de_modify_ipam_pool_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_ipam_pool::de_modify_ipam_pool(_response_body, output)
            .map_err(crate::operation::modify_ipam_pool::ModifyIpamPoolError::unhandled)?;
...
pub fn de_modify_ipam_pool(
...
) -> std::result::Result<crate::operation::modify_ipam_pool::builders::ModifyIpamPoolOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ModifyIpamPoolResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyIpamPoolResponse got {start_el:?}"
        )));
    }
