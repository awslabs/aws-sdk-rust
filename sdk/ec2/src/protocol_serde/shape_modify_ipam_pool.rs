...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_ipam_pool_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::modify_ipam_pool::ModifyIpamPoolOutput, crate::operation::modify_ipam_pool::ModifyIpamPoolError> {
...
) -> Result<crate::operation::modify_ipam_pool::builders::ModifyIpamPoolOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
