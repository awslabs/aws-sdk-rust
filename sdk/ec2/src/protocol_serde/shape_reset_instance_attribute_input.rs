...
pub fn ser_reset_instance_attribute_input_input(input: &crate::input::ResetInstanceAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
