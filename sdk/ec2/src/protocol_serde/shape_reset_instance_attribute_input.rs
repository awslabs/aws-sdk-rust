...
pub fn ser_reset_instance_attribute_input_input_input(input: &crate::operation::reset_instance_attribute::ResetInstanceAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
