...
pub fn ser_withdraw_byoip_cidr_input_input(input: &crate::input::WithdrawByoipCidrInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
