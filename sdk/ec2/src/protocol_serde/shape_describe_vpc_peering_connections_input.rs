...
pub fn ser_describe_vpc_peering_connections_input_input(input: &crate::input::DescribeVpcPeeringConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
