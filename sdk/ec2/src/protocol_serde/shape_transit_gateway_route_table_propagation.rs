...
pub fn de_transit_gateway_route_table_propagation(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::TransitGatewayRouteTablePropagation, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
