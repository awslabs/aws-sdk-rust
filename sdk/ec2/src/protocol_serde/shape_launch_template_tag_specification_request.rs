...
#[allow(unused_mut)]
pub fn ser_launch_template_tag_specification_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LaunchTemplateTagSpecificationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
