...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_default_credit_specification::ModifyDefaultCreditSpecificationError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_default_credit_specification::de_modify_default_credit_specification(_response_body, output)
            .map_err(crate::operation::modify_default_credit_specification::ModifyDefaultCreditSpecificationError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyDefaultCreditSpecificationResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyDefaultCreditSpecificationResponse got {start_el:?}"
        )));
    }
