...
pub fn de_private_dns_name_options_on_launch(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrivateDnsNameOptionsOnLaunch, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
