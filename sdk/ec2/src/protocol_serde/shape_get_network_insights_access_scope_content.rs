...
pub fn de_get_network_insights_access_scope_content_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_network_insights_access_scope_content::GetNetworkInsightsAccessScopeContentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_network_insights_access_scope_content_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_network_insights_access_scope_content::de_get_network_insights_access_scope_content(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_network_insights_access_scope_content::GetNetworkInsightsAccessScopeContentError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("GetNetworkInsightsAccessScopeContentResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetNetworkInsightsAccessScopeContentResponse got {start_el:?}"
        )));
    }
