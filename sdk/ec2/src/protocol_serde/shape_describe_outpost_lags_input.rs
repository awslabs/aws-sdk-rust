...
pub fn ser_describe_outpost_lags_input_input_input(
    input: &crate::operation::describe_outpost_lags::DescribeOutpostLagsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeOutpostLags", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("OutpostLagId");
    if let Some(var_2) = &input.outpost_lag_ids {
        if !var_2.is_empty() {
