...
pub fn ser_get_transit_gateway_policy_table_entries_input_input(input: &crate::input::GetTransitGatewayPolicyTableEntriesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
