...
pub fn ser_get_transit_gateway_policy_table_entries_input_input_input(input: &crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
