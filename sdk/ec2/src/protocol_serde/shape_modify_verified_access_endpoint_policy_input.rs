...
pub fn ser_modify_verified_access_endpoint_policy_input_input(input: &crate::input::ModifyVerifiedAccessEndpointPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
