...
pub fn ser_describe_instance_status_input_input_input(input: &crate::operation::describe_instance_status::DescribeInstanceStatusInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
