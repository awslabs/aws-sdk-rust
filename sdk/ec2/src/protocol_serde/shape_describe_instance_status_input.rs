...
pub fn ser_describe_instance_status_input_input(input: &crate::input::DescribeInstanceStatusInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
