...
pub fn ser_delete_network_insights_analysis_input_input(input: &crate::input::DeleteNetworkInsightsAnalysisInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
