...
pub fn ser_authorize_security_group_egress_input_input(input: &crate::input::AuthorizeSecurityGroupEgressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
