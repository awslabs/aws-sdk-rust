...
pub fn de_instance_credit_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceCreditSpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
