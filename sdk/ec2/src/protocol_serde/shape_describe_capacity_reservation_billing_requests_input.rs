...
pub fn ser_describe_capacity_reservation_billing_requests_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeCapacityReservationBillingRequests", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_6 = writer.prefix("Role");
