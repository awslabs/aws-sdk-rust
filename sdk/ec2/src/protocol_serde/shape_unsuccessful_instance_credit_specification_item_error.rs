...
pub fn de_unsuccessful_instance_credit_specification_item_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::UnsuccessfulInstanceCreditSpecificationItemError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
