...
pub fn ser_modify_traffic_mirror_filter_network_services_input_input(input: &crate::input::ModifyTrafficMirrorFilterNetworkServicesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
