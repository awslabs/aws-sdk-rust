...
pub fn de_network_interface_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::NetworkInterfaceAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
