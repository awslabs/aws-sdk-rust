...
pub fn ser_delete_flow_logs_input_input(input: &crate::operation::delete_flow_logs::DeleteFlowLogsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
