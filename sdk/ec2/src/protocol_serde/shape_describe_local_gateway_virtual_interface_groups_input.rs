...
pub fn ser_describe_local_gateway_virtual_interface_groups_input_input_input(input: &crate::operation::describe_local_gateway_virtual_interface_groups::DescribeLocalGatewayVirtualInterfaceGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.local_gateway_virtual_interface_group_ids {
