...
pub fn ser_describe_local_gateway_virtual_interface_groups_input_input(input: &crate::input::DescribeLocalGatewayVirtualInterfaceGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
