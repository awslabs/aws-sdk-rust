...
pub fn de_move_address_to_vpc_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::move_address_to_vpc::MoveAddressToVpcOutput, crate::operation::move_address_to_vpc::MoveAddressToVpcError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_move_address_to_vpc_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::move_address_to_vpc::MoveAddressToVpcOutput, crate::operation::move_address_to_vpc::MoveAddressToVpcError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_move_address_to_vpc::de_move_address_to_vpc(_response_body, output)
            .map_err(crate::operation::move_address_to_vpc::MoveAddressToVpcError::unhandled)?;
...
) -> Result<crate::operation::move_address_to_vpc::builders::MoveAddressToVpcOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
