...
pub fn ser_describe_dhcp_options_input_input_input(input: &crate::operation::describe_dhcp_options::DescribeDhcpOptionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
