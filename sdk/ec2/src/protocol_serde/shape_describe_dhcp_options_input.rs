...
pub fn ser_describe_dhcp_options_input_input(input: &crate::input::DescribeDhcpOptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
