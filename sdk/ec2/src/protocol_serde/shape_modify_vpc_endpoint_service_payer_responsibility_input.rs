...
pub fn ser_modify_vpc_endpoint_service_payer_responsibility_input_input_input(
    input: &crate::operation::modify_vpc_endpoint_service_payer_responsibility::ModifyVpcEndpointServicePayerResponsibilityInput,
