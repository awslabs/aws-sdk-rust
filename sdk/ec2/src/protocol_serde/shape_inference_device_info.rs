...
pub fn de_inference_device_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InferenceDeviceInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
