...
pub fn ser_delete_fleets_input_input_input(input: &crate::operation::delete_fleets::DeleteFleetsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
