...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_vpn_tunnel_certificate::de_modify_vpn_tunnel_certificate(_response_body, output)
            .map_err(crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateError::unhandled)?;
