...
pub fn de_modify_vpn_tunnel_certificate_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateOutput, crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_vpn_tunnel_certificate_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateOutput, crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateError> {
    Ok({
        #[allow(unused_mut)]
