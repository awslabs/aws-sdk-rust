...
pub fn de_volume_status_event(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VolumeStatusEvent, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
