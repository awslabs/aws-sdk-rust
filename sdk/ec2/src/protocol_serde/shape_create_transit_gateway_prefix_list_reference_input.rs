...
pub fn ser_create_transit_gateway_prefix_list_reference_input_input_input(input: &crate::operation::create_transit_gateway_prefix_list_reference::CreateTransitGatewayPrefixListReferenceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
