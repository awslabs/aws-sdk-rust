...
pub fn ser_associate_trunk_interface_input_input_input(input: &crate::operation::associate_trunk_interface::AssociateTrunkInterfaceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
