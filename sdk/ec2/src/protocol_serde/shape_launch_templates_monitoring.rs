...
pub fn de_launch_templates_monitoring(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplatesMonitoring, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
