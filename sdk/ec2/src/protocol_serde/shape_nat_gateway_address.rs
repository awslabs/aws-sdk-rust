...
pub fn de_nat_gateway_address(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NatGatewayAddress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
