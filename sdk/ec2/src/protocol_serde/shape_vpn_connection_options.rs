...
pub fn de_vpn_connection_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpnConnectionOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
