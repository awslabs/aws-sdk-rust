...
pub fn ser_describe_vpc_endpoint_services_input_input_input(input: &crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
