...
pub fn de_instance_event_window(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceEventWindow, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
