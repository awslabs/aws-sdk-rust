...
pub fn de_restore_snapshot_from_recycle_bin_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RestoreSnapshotFromRecycleBinOutput, crate::error::RestoreSnapshotFromRecycleBinError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::RestoreSnapshotFromRecycleBinError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_restore_snapshot_from_recycle_bin_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RestoreSnapshotFromRecycleBinOutput, crate::error::RestoreSnapshotFromRecycleBinError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_restore_snapshot_from_recycle_bin(inp: &[u8], mut builder: crate::output::restore_snapshot_from_recycle_bin_output::Builder) -> Result<crate::output::restore_snapshot_from_recycle_bin_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
