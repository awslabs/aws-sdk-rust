...
pub fn ser_attach_verified_access_trust_provider_input_input_input(input: &crate::operation::attach_verified_access_trust_provider::AttachVerifiedAccessTrustProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
