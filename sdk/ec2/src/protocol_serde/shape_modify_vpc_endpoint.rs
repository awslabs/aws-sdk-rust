...
pub fn de_modify_vpc_endpoint_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_vpc_endpoint_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::modify_vpc_endpoint::ModifyVpcEndpointOutput, crate::operation::modify_vpc_endpoint::ModifyVpcEndpointError>
...
pub fn de_modify_vpc_endpoint(
...
) -> std::result::Result<crate::operation::modify_vpc_endpoint::builders::ModifyVpcEndpointOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ModifyVpcEndpointResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyVpcEndpointResponse got {start_el:?}"
        )));
    }
