...
pub fn ser_enable_fast_launch_input_input_input(input: &crate::operation::enable_fast_launch::EnableFastLaunchInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
