...
pub fn ser_enable_fast_launch_input_input(input: &crate::input::EnableFastLaunchInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
