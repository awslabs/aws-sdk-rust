...
#[allow(unused_mut)]
pub fn ser_target_capacity_specification_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetCapacitySpecificationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
