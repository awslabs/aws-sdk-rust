...
#[allow(unused_mut)]
pub fn de_detach_volume(inp: &[u8], mut builder: crate::output::detach_volume_output::Builder) -> Result<crate::output::detach_volume_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
