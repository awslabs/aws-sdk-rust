...
pub fn ser_describe_reserved_instances_listings_input_input(input: &crate::input::DescribeReservedInstancesListingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
