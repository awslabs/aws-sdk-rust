...
pub fn ser_describe_classic_link_instances_input_input(input: &crate::input::DescribeClassicLinkInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
