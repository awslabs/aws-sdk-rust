...
pub fn ser_describe_classic_link_instances_input_input_input(input: &crate::operation::describe_classic_link_instances::DescribeClassicLinkInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
