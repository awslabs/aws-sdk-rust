...
pub fn ser_create_capacity_reservation_by_splitting_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateCapacityReservationBySplitting", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("InstanceCount");
    if let Some(var_8) = &input.instance_count {
        scope_7.number(
