...
pub fn ser_modify_verified_access_group_policy_input_input(input: &crate::input::ModifyVerifiedAccessGroupPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
