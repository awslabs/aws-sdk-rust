...
pub fn de_spot_fleet_request_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotFleetRequestConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
