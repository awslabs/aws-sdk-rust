...
pub fn ser_describe_transit_gateway_multicast_domains_input_input_input(
    input: &crate::operation::describe_transit_gateway_multicast_domains::DescribeTransitGatewayMulticastDomainsInput,
