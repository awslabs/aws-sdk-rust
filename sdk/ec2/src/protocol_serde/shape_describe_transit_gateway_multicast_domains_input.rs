...
pub fn ser_describe_transit_gateway_multicast_domains_input_input(input: &crate::input::DescribeTransitGatewayMulticastDomainsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
