...
pub fn ser_describe_transit_gateway_multicast_domains_input_input_input(input: &crate::operation::describe_transit_gateway_multicast_domains::DescribeTransitGatewayMulticastDomainsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeTransitGatewayMulticastDomains", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("TransitGatewayMulticastDomainIds");
    if let Some(var_2) = &input.transit_gateway_multicast_domain_ids {
