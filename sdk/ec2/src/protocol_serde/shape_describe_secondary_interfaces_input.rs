...
pub fn ser_describe_secondary_interfaces_input_input_input(
    input: &crate::operation::describe_secondary_interfaces::DescribeSecondaryInterfacesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeSecondaryInterfaces", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("SecondaryInterfaceId");
    if let Some(var_13) = &input.secondary_interface_ids {
        if !var_13.is_empty() {
