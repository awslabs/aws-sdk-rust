...
pub fn de_delete_queued_reserved_instances_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeleteQueuedReservedInstancesError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
