...
pub fn de_spot_instance_state_fault(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotInstanceStateFault, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
