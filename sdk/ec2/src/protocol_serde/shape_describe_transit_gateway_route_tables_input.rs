...
pub fn ser_describe_transit_gateway_route_tables_input_input(input: &crate::input::DescribeTransitGatewayRouteTablesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
