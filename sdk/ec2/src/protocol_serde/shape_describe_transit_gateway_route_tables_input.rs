...
pub fn ser_describe_transit_gateway_route_tables_input_input_input(input: &crate::operation::describe_transit_gateway_route_tables::DescribeTransitGatewayRouteTablesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeTransitGatewayRouteTables", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("TransitGatewayRouteTableIds");
    if let Some(var_2) = &input.transit_gateway_route_table_ids {
