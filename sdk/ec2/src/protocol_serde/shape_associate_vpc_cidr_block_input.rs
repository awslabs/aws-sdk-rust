...
pub fn ser_associate_vpc_cidr_block_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("Ipv6CidrBlockNetworkBorderGroup");
    if let Some(var_4) = &input.ipv6_cidr_block_network_border_group {
    ...
    #[allow(unused_mut)]
    let mut scope_17 = writer.prefix("VpcId");
    if let Some(var_18) = &input.vpc_id {
        scope_17.string(var_18);
    }
    #[allow(unused_mut)]
    let mut scope_19 = writer.prefix("AmazonProvidedIpv6CidrBlock");
    if let Some(var_20) = &input.amazon_provided_ipv6_cidr_block {
