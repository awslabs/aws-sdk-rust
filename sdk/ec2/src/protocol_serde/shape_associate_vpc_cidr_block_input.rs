...
pub fn ser_associate_vpc_cidr_block_input_input_input(input: &crate::operation::associate_vpc_cidr_block::AssociateVpcCidrBlockInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
