...
pub fn de_delete_launch_template_versions_response_success_set(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::DeleteLaunchTemplateVersionsResponseSuccessItem>, aws_smithy_xml::decode::XmlDecodeError> {
