...
pub fn ser_modify_capacity_reservation_input_input_input(input: &crate::operation::modify_capacity_reservation::ModifyCapacityReservationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
