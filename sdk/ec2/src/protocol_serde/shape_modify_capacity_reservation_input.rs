...
pub fn ser_modify_capacity_reservation_input_input(input: &crate::input::ModifyCapacityReservationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
