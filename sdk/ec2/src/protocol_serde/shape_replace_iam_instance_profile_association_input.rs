...
pub fn ser_replace_iam_instance_profile_association_input_input(input: &crate::operation::replace_iam_instance_profile_association::ReplaceIamInstanceProfileAssociationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
