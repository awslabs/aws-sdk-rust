...
pub fn de_disassociate_client_vpn_target_network_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_client_vpn_target_network_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_disassociate_client_vpn_target_network::de_disassociate_client_vpn_target_network(_response_body, output)
                .map_err(crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError::unhandled)?;
