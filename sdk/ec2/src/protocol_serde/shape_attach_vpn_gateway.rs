...
pub fn de_attach_vpn_gateway_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_vpn_gateway_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<crate::output::AttachVpnGatewayOutput, crate::error::AttachVpnGatewayError>
{
    Ok({
...
) -> Result<crate::output::attach_vpn_gateway_output::Builder, aws_smithy_xml::decode::XmlDecodeError>
{
