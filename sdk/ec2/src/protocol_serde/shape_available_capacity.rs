...
pub fn de_available_capacity(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AvailableCapacity, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
