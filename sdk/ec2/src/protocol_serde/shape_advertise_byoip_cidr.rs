...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_advertise_byoip_cidr::de_advertise_byoip_cidr(_response_body, output)
            .map_err(crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrError::unhandled)?;
...
) -> std::result::Result<crate::operation::advertise_byoip_cidr::builders::AdvertiseByoipCidrOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("AdvertiseByoipCidrResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AdvertiseByoipCidrResponse got {start_el:?}"
        )));
    }
