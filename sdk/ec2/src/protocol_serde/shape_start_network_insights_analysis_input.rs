...
pub fn ser_start_network_insights_analysis_input_input_input(input: &crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
