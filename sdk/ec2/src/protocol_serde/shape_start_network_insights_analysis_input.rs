...
pub fn ser_start_network_insights_analysis_input_input(input: &crate::input::StartNetworkInsightsAnalysisInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
