...
#[allow(unused_mut)]
pub fn de_describe_verified_access_instance_logging_configurations(
    inp: &[u8],
    mut builder: crate::output::describe_verified_access_instance_logging_configurations_output::Builder,
) -> Result<
