...
pub fn ser_describe_instance_credit_specifications_input_input_input(input: &crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecificationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_9) = &input.instance_ids {
        let mut list_11 = scope_8.start_list(true, Some("InstanceId"));
