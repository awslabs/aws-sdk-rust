...
pub fn ser_describe_instance_credit_specifications_input_input(input: &crate::input::DescribeInstanceCreditSpecificationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
