...
pub fn ser_describe_transit_gateways_input_input(input: &crate::operation::describe_transit_gateways::DescribeTransitGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
