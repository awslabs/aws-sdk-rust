...
pub fn ser_describe_vpc_endpoint_service_permissions_input_input(input: &crate::input::DescribeVpcEndpointServicePermissionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
