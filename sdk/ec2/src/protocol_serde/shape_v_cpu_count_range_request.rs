...
#[allow(unused_mut)]
pub fn ser_v_cpu_count_range_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::VCpuCountRangeRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
