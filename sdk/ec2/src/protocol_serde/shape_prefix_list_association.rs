...
pub fn de_prefix_list_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrefixListAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
