...
pub fn ser_describe_volume_attribute_input_input_input(input: &crate::operation::describe_volume_attribute::DescribeVolumeAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
