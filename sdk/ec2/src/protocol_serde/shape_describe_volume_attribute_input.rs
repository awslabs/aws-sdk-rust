...
pub fn ser_describe_volume_attribute_input_input(input: &crate::input::DescribeVolumeAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
