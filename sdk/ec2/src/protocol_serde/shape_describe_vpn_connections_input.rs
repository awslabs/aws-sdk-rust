...
pub fn ser_describe_vpn_connections_input_input_input(input: &crate::operation::describe_vpn_connections::DescribeVpnConnectionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
