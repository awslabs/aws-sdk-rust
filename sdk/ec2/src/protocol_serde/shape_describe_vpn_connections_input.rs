...
pub fn ser_describe_vpn_connections_input_input(input: &crate::input::DescribeVpnConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
