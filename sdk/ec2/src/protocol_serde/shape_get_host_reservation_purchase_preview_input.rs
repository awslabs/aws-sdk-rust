...
pub fn ser_get_host_reservation_purchase_preview_input_input(input: &crate::input::GetHostReservationPurchasePreviewInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
