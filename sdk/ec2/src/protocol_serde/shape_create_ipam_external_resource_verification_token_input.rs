...
pub fn ser_create_ipam_external_resource_verification_token_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateIpamExternalResourceVerificationToken", "2016-11-15");
    #[allow(unused_mut)]
