...
pub fn de_transit_gateway_attachment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayAttachment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
