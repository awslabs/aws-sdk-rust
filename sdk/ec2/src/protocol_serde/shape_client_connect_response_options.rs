...
pub fn de_client_connect_response_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientConnectResponseOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
