...
pub fn de_transit_gateway_route_table_route(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayRouteTableRoute, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
