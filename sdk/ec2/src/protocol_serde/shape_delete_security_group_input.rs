...
pub fn ser_delete_security_group_input_input_input(input: &crate::operation::delete_security_group::DeleteSecurityGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
