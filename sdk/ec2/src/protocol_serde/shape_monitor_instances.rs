...
pub fn de_monitor_instances_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::monitor_instances::MonitorInstancesOutput, crate::operation::monitor_instances::MonitorInstancesError> {
    #[allow(unused_mut)]
...
pub fn de_monitor_instances_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_monitor_instances::de_monitor_instances(_response_body, output)
            .map_err(crate::operation::monitor_instances::MonitorInstancesError::unhandled)?;
...
pub fn de_monitor_instances(
...
) -> std::result::Result<crate::operation::monitor_instances::builders::MonitorInstancesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("MonitorInstancesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected MonitorInstancesResponse got {start_el:?}"
        )));
    }
