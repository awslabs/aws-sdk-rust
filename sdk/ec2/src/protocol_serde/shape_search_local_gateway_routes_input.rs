...
pub fn ser_search_local_gateway_routes_input_input(input: &crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
