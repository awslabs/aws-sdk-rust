...
pub fn de_delete_fleet_success_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeleteFleetSuccessItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
