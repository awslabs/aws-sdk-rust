...
pub fn ser_describe_fleet_instances_input_input_input(input: &crate::operation::describe_fleet_instances::DescribeFleetInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
