...
pub fn de_media_device_memory_info(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MediaDeviceMemoryInfo, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
