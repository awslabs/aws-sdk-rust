...
pub fn ser_reset_fpga_image_attribute_input_input(input: &crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
