...
pub fn de_transit_gateway_vpc_attachment_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayVpcAttachmentOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
