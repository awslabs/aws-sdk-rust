...
#[allow(unused_mut)]
pub fn ser_launch_permission_modifications(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LaunchPermissionModifications) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
