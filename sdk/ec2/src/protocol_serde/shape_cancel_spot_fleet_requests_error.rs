...
pub fn de_cancel_spot_fleet_requests_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CancelSpotFleetRequestsError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("code") /* Code com.amazonaws.ec2#CancelSpotFleetRequestsError$Code */ =>  {
                let var_1 =
                    Some(
                        Result::<crate::model::CancelBatchErrorCode, aws_smithy_xml::decode::XmlDecodeError>::Ok(
