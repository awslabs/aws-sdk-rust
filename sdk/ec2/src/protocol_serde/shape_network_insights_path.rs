...
pub fn de_network_insights_path(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NetworkInsightsPath, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
