...
pub fn de_instance_private_ip_address(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::InstancePrivateIpAddress, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
