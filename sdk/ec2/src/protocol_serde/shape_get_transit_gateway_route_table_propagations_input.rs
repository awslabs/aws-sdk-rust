...
pub fn ser_get_transit_gateway_route_table_propagations_input_input(input: &crate::input::GetTransitGatewayRouteTablePropagationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
