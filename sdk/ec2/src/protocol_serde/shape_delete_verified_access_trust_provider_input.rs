...
pub fn ser_delete_verified_access_trust_provider_input_input(input: &crate::input::DeleteVerifiedAccessTrustProviderInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
