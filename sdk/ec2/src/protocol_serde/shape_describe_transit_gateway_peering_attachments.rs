...
pub fn de_describe_transit_gateway_peering_attachments_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_transit_gateway_peering_attachments::DescribeTransitGatewayPeeringAttachmentsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_transit_gateway_peering_attachments_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_transit_gateway_peering_attachments::de_describe_transit_gateway_peering_attachments(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_transit_gateway_peering_attachments::DescribeTransitGatewayPeeringAttachmentsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeTransitGatewayPeeringAttachmentsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeTransitGatewayPeeringAttachmentsResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("transitGatewayPeeringAttachments") /* TransitGatewayPeeringAttachments com.amazonaws.ec2.synthetic#DescribeTransitGatewayPeeringAttachmentsOutput$TransitGatewayPeeringAttachments */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_transit_gateway_peering_attachment_list::de_transit_gateway_peering_attachment_list(&mut tag, depth + 1)
                        ?
                    )
                ;
