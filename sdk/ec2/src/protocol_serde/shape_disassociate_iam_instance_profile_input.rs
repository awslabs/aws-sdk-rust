...
pub fn ser_disassociate_iam_instance_profile_input_input_input(
    input: &crate::operation::disassociate_iam_instance_profile::DisassociateIamInstanceProfileInput,
