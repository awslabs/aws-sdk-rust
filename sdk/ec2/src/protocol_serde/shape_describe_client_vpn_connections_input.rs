...
pub fn ser_describe_client_vpn_connections_input_input(input: &crate::input::DescribeClientVpnConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
