...
pub fn ser_create_vpc_block_public_access_exclusion_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateVpcBlockPublicAccessExclusion", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("InternetGatewayExclusionMode");
    if let Some(var_8) = &input.internet_gateway_exclusion_mode {
