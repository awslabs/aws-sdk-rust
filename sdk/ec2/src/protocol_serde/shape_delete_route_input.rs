...
pub fn ser_delete_route_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut scope_7 = writer.prefix("DestinationCidrBlock");
    if let Some(var_8) = &input.destination_cidr_block {
        scope_7.string(var_8);
    }
    #[allow(unused_mut)]
    let mut scope_9 = writer.prefix("DestinationIpv6CidrBlock");
    if let Some(var_10) = &input.destination_ipv6_cidr_block {
