...
pub fn ser_delete_route_input_input_input(input: &crate::operation::delete_route::DeleteRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
