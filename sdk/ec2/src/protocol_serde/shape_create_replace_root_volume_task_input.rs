...
pub fn ser_create_replace_root_volume_task_input_input(input: &crate::input::CreateReplaceRootVolumeTaskInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
