...
pub fn ser_create_replace_root_volume_task_input_input_input(input: &crate::operation::create_replace_root_volume_task::CreateReplaceRootVolumeTaskInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
