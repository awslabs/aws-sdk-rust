...
pub fn de_group_identifier(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GroupIdentifier, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn ser_group_identifier(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::GroupIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
