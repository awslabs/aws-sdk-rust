...
#[allow(unused_mut)]
pub fn ser_group_identifier(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::GroupIdentifier) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
