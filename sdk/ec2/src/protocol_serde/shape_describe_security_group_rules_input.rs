...
pub fn ser_describe_security_group_rules_input_input(input: &crate::input::DescribeSecurityGroupRulesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
