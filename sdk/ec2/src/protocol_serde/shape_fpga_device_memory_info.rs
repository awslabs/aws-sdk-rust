...
pub fn de_fpga_device_memory_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FpgaDeviceMemoryInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
