...
pub fn de_ipam_address_history_record(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IpamAddressHistoryRecord, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
