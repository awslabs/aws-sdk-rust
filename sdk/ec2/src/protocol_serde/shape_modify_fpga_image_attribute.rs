...
> {
    ...
    .map_err(
        crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError::unhandled,
    )?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(
        crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError::generic(
            generic,
        ),
    )
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_fpga_image_attribute_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn de_modify_fpga_image_attribute(
    ...
    crate::operation::modify_fpga_image_attribute::builders::ModifyFpgaImageAttributeOutputBuilder,
