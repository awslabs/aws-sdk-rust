...
pub fn ser_move_byoip_cidr_to_ipam_input_input_input(input: &crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
