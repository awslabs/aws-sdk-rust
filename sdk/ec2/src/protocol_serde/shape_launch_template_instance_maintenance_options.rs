...
pub fn de_launch_template_instance_maintenance_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LaunchTemplateInstanceMaintenanceOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
