...
pub fn de_describe_snapshot_attribute_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeOutput, crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError> {
    #[allow(unused_mut)]
