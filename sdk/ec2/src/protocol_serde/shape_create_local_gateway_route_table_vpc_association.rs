...
pub fn de_create_local_gateway_route_table_vpc_association_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_local_gateway_route_table_vpc_association::CreateLocalGatewayRouteTableVpcAssociationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_local_gateway_route_table_vpc_association_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_local_gateway_route_table_vpc_association::de_create_local_gateway_route_table_vpc_association(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_local_gateway_route_table_vpc_association::CreateLocalGatewayRouteTableVpcAssociationError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_local_gateway_route_table_vpc_association(
    inp: &[u8],
    mut builder: crate::operation::create_local_gateway_route_table_vpc_association::builders::CreateLocalGatewayRouteTableVpcAssociationOutputBuilder,
) -> Result<
