...
pub fn ser_deregister_transit_gateway_multicast_group_members_input_input(input: &crate::input::DeregisterTransitGatewayMulticastGroupMembersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
