...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_subnet_cidr_reservation::de_create_subnet_cidr_reservation(_response_body, output)
            .map_err(crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("CreateSubnetCidrReservationResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateSubnetCidrReservationResponse got {start_el:?}"
        )));
    }
