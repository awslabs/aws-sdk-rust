...
#[allow(unused_mut)]
pub fn ser_launch_template_instance_network_interface_specification_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LaunchTemplateInstanceNetworkInterfaceSpecificationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
