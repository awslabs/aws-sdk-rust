...
#[allow(unused_mut)]
pub fn ser_launch_template_ebs_block_device_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LaunchTemplateEbsBlockDeviceRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
