...
pub fn de_capacity_reservation_fleet_cancellation_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CapacityReservationFleetCancellationState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
