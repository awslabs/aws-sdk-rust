...
pub fn ser_modify_instance_attribute_input_input_input(input: &crate::operation::modify_instance_attribute::ModifyInstanceAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
