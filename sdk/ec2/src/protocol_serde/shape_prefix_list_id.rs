...
#[allow(unused_mut)]
pub fn ser_prefix_list_id(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PrefixListId) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_prefix_list_id(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrefixListId, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
