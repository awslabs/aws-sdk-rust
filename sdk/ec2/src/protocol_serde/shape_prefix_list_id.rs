...
#[allow(unused_mut)]
pub fn ser_prefix_list_id(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PrefixListId) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
