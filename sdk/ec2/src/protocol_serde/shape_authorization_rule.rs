...
pub fn de_authorization_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AuthorizationRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
