...
pub fn ser_create_verified_access_endpoint_input_input(input: &crate::input::CreateVerifiedAccessEndpointInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
