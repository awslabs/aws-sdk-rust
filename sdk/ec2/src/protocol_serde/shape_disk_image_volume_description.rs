...
pub fn de_disk_image_volume_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DiskImageVolumeDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
