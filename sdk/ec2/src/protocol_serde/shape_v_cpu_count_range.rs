...
#[allow(unused_mut)]
pub fn ser_v_cpu_count_range(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::VCpuCountRange) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
