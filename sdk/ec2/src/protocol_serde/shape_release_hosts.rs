...
pub fn de_release_hosts_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_release_hosts_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::release_hosts::ReleaseHostsOutput, crate::operation::release_hosts::ReleaseHostsError> {
...
pub fn de_release_hosts(
...
) -> std::result::Result<crate::operation::release_hosts::builders::ReleaseHostsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ReleaseHostsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ReleaseHostsResponse got {start_el:?}"
        )));
    }
