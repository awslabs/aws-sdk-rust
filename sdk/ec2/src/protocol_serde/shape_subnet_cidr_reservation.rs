...
pub fn de_subnet_cidr_reservation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SubnetCidrReservation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
