...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_groups_for_capacity_reservation::de_get_groups_for_capacity_reservation(_response_body, output)
            .map_err(crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationError::unhandled)?;
