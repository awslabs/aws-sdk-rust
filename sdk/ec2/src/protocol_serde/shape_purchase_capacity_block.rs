...
pub fn de_purchase_capacity_block_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::purchase_capacity_block::PurchaseCapacityBlockError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_purchase_capacity_block_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_purchase_capacity_block::de_purchase_capacity_block(_response_body, output)
            .map_err(crate::operation::purchase_capacity_block::PurchaseCapacityBlockError::unhandled)?;
...
pub fn de_purchase_capacity_block(
    ...
    if !(start_el.matches("PurchaseCapacityBlockResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected PurchaseCapacityBlockResponse got {:?}",
            start_el
        )));
    }
