...
pub fn ser_create_transit_gateway_connect_input_input_input(
    ...
    if let Some(var_4) = &input.options {
        crate::protocol_serde::shape_create_transit_gateway_connect_request_options::ser_create_transit_gateway_connect_request_options(
            scope_3, var_4,
        )?;
    }
    #[allow(unused_mut)]
