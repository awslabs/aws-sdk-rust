...
pub fn de_create_verified_access_group(
    ...
    crate::operation::create_verified_access_group::builders::CreateVerifiedAccessGroupOutputBuilder,
...
> {
    ...
    if !(start_el.matches("CreateVerifiedAccessGroupResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateVerifiedAccessGroupResponse got {start_el:?}"
        )));
    }
