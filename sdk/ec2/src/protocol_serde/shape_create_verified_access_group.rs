...
pub fn de_create_verified_access_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_verified_access_group::CreateVerifiedAccessGroupOutput, crate::operation::create_verified_access_group::CreateVerifiedAccessGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_verified_access_group::CreateVerifiedAccessGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_verified_access_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_verified_access_group::CreateVerifiedAccessGroupOutput, crate::operation::create_verified_access_group::CreateVerifiedAccessGroupError> {
    Ok({
        #[allow(unused_mut)]
