...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_verified_access_group::CreateVerifiedAccessGroupError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::create_verified_access_group::CreateVerifiedAccessGroupError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_create_verified_access_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_verified_access_group::de_create_verified_access_group(_response_body, output)
            .map_err(crate::operation::create_verified_access_group::CreateVerifiedAccessGroupError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_verified_access_group(
    inp: &[u8],
    mut builder: crate::operation::create_verified_access_group::builders::CreateVerifiedAccessGroupOutputBuilder,
) -> Result<crate::operation::create_verified_access_group::builders::CreateVerifiedAccessGroupOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
