...
pub fn de_accelerator_manufacturer_set(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::AcceleratorManufacturer>, aws_smithy_xml::decode::XmlDecodeError> {
