...
pub fn ser_describe_transit_gateway_attachments_input_input_input(input: &crate::operation::describe_transit_gateway_attachments::DescribeTransitGatewayAttachmentsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
