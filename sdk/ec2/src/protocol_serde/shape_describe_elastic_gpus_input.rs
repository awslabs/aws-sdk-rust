...
pub fn ser_describe_elastic_gpus_input_input(input: &crate::input::DescribeElasticGpusInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
