...
pub fn ser_describe_elastic_gpus_input_input_input(input: &crate::operation::describe_elastic_gpus::DescribeElasticGpusInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeElasticGpus", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("ElasticGpuId");
    if let Some(var_2) = &input.elastic_gpu_ids {
