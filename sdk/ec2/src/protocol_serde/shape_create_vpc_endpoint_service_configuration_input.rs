...
pub fn ser_create_vpc_endpoint_service_configuration_input_input(input: &crate::input::CreateVpcEndpointServiceConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
