...
pub fn ser_associate_client_vpn_target_network_input_input_input(input: &crate::operation::associate_client_vpn_target_network::AssociateClientVpnTargetNetworkInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
