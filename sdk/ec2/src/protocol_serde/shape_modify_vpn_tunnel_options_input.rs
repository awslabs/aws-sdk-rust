...
pub fn ser_modify_vpn_tunnel_options_input_input(input: &crate::input::ModifyVpnTunnelOptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
