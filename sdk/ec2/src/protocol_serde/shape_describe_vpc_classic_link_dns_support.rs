...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_vpc_classic_link_dns_support::de_describe_vpc_classic_link_dns_support(_response_body, output)
            .map_err(crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError::unhandled)?;
