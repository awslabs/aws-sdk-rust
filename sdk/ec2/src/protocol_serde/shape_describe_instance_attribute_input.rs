...
pub fn ser_describe_instance_attribute_input_input_input(input: &crate::operation::describe_instance_attribute::DescribeInstanceAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
