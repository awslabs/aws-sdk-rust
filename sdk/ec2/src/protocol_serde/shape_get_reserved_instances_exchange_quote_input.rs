...
pub fn ser_get_reserved_instances_exchange_quote_input_input_input(input: &crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
