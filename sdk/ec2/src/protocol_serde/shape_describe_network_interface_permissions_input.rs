...
pub fn ser_describe_network_interface_permissions_input_input(input: &crate::input::DescribeNetworkInterfacePermissionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
