...
pub fn de_ike_versions_list_value(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IkeVersionsListValue, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
