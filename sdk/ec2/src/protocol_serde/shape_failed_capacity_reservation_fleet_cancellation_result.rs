...
pub fn de_failed_capacity_reservation_fleet_cancellation_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FailedCapacityReservationFleetCancellationResult, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
