...
pub fn ser_describe_verified_access_endpoints_input_input(input: &crate::input::DescribeVerifiedAccessEndpointsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
