...
pub fn ser_describe_trunk_interface_associations_input_input(input: &crate::input::DescribeTrunkInterfaceAssociationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
