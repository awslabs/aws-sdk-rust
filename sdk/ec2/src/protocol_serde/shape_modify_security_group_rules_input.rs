...
pub fn ser_modify_security_group_rules_input_input(input: &crate::input::ModifySecurityGroupRulesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
