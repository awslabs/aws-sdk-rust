...
pub fn de_vpc_ipv6_cidr_block_association(
    ...
    depth: u32,
) -> ::std::result::Result<crate::types::VpcIpv6CidrBlockAssociation, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("ipv6CidrBlockState") /* Ipv6CidrBlockState com.amazonaws.ec2#VpcIpv6CidrBlockAssociation$Ipv6CidrBlockState */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_vpc_cidr_block_state::de_vpc_cidr_block_state(&mut tag, depth + 1)
                        ?
                    )
                ;
