...
pub fn de_vpc_ipv6_cidr_block_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcIpv6CidrBlockAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
