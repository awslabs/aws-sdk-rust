...
pub fn ser_describe_verified_access_trust_providers_input_input_input(
    input: &crate::operation::describe_verified_access_trust_providers::DescribeVerifiedAccessTrustProvidersInput,
