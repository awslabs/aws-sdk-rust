...
pub fn ser_describe_verified_access_trust_providers_input_input_input(input: &crate::operation::describe_verified_access_trust_providers::DescribeVerifiedAccessTrustProvidersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.verified_access_trust_provider_ids {
