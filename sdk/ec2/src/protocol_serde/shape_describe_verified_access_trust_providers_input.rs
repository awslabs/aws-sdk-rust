...
pub fn ser_describe_verified_access_trust_providers_input_input(input: &crate::input::DescribeVerifiedAccessTrustProvidersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
