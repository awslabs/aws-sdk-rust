...
pub fn de_create_vpc_endpoint_connection_notification_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotificationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_vpc_endpoint_connection_notification_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_vpc_endpoint_connection_notification::de_create_vpc_endpoint_connection_notification(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotificationError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_vpc_endpoint_connection_notification(
    inp: &[u8],
    mut builder: crate::operation::create_vpc_endpoint_connection_notification::builders::CreateVpcEndpointConnectionNotificationOutputBuilder,
) -> Result<
    crate::operation::create_vpc_endpoint_connection_notification::builders::CreateVpcEndpointConnectionNotificationOutputBuilder,
