...
pub fn de_get_vpn_tunnel_replacement_status_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusOutput, crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_vpn_tunnel_replacement_status_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusOutput, crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError> {
    Ok({
        #[allow(unused_mut)]
        ...
        let _ = response;
        output = crate::protocol_serde::shape_get_vpn_tunnel_replacement_status::de_get_vpn_tunnel_replacement_status(response.body().as_ref(), output).map_err(crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError::unhandled)?;
