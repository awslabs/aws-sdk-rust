...
pub fn ser_detach_volume_input_input_input(input: &crate::operation::detach_volume::DetachVolumeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
