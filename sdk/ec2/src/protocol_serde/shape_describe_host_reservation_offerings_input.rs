...
pub fn ser_describe_host_reservation_offerings_input_input(input: &crate::input::DescribeHostReservationOfferingsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
