...
pub fn ser_create_store_image_task_input_input_input(input: &crate::operation::create_store_image_task::CreateStoreImageTaskInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
