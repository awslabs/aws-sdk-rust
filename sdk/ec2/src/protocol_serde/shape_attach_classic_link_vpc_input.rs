...
pub fn ser_attach_classic_link_vpc_input_input_input(input: &crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
