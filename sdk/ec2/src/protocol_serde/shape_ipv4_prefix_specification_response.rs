...
pub fn de_ipv4_prefix_specification_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Ipv4PrefixSpecificationResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
