...
pub fn ser_associate_enclave_certificate_iam_role_input_input(input: &crate::input::AssociateEnclaveCertificateIamRoleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
