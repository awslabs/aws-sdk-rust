...
pub fn de_client_vpn_endpoint_attribute_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnEndpointAttributeStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
