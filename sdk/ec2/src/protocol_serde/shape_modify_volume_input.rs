...
pub fn ser_modify_volume_input_input_input(input: &crate::operation::modify_volume::ModifyVolumeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
