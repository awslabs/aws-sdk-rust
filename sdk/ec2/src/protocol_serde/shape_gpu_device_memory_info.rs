...
pub fn de_gpu_device_memory_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::GpuDeviceMemoryInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
