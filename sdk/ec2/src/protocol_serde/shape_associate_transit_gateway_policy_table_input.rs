...
pub fn ser_associate_transit_gateway_policy_table_input_input(input: &crate::input::AssociateTransitGatewayPolicyTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
