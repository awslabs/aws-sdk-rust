...
pub fn ser_associate_transit_gateway_policy_table_input_input_input(input: &crate::operation::associate_transit_gateway_policy_table::AssociateTransitGatewayPolicyTableInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
