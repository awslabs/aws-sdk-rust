...
pub fn de_iam_instance_profile(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IamInstanceProfile, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
