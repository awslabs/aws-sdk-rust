...
pub fn de_destination_options_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DestinationOptionsResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
