...
pub fn de_delete_transit_gateway_peering_attachment_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_transit_gateway_peering_attachment::DeleteTransitGatewayPeeringAttachmentOutput, crate::operation::delete_transit_gateway_peering_attachment::DeleteTransitGatewayPeeringAttachmentError> {
    #[allow(unused_mut)]
