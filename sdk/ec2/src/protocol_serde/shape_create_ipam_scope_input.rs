...
pub fn ser_create_ipam_scope_input_input(input: &crate::operation::create_ipam_scope::CreateIpamScopeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
