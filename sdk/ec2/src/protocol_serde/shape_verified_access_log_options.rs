...
#[allow(unused_mut)]
pub fn ser_verified_access_log_options(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::VerifiedAccessLogOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
