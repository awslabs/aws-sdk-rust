...
#[allow(unused_mut)]
pub fn ser_verified_access_log_options(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::VerifiedAccessLogOptions) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
