...
pub fn de_volume_status_attachment_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VolumeStatusAttachmentStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
