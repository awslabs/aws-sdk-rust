...
pub fn ser_describe_reserved_instances_input_input_input(input: &crate::operation::describe_reserved_instances::DescribeReservedInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
