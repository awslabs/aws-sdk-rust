...
pub fn de_delete_client_vpn_route_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_client_vpn_route::DeleteClientVpnRouteError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_client_vpn_route_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_client_vpn_route::de_delete_client_vpn_route(_response_body, output)
            .map_err(crate::operation::delete_client_vpn_route::DeleteClientVpnRouteError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DeleteClientVpnRouteResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteClientVpnRouteResponse got {start_el:?}"
        )));
    }
