...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_vpn_tunnel_options::ModifyVpnTunnelOptionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_vpn_tunnel_options_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_vpn_tunnel_options::de_modify_vpn_tunnel_options(_response_body, output)
            .map_err(crate::operation::modify_vpn_tunnel_options::ModifyVpnTunnelOptionsError::unhandled)?;
...
) -> Result<crate::operation::modify_vpn_tunnel_options::builders::ModifyVpnTunnelOptionsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
