...
) -> std::result::Result<crate::operation::get_console_output::builders::GetConsoleOutputOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("output") /* Output com.amazonaws.ec2.synthetic#GetConsoleOutputOutput$Output */ =>  {
                ...
                ;
                builder = builder.set_output(var_3);
            }
            ,
            _ => {}
        }
