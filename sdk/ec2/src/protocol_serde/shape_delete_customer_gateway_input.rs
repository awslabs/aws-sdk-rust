...
pub fn ser_delete_customer_gateway_input_input(input: &crate::operation::delete_customer_gateway::DeleteCustomerGatewayInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
