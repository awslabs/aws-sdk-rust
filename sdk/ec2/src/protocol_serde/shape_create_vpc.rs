...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_vpc_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_vpc::CreateVpcOutput, crate::operation::create_vpc::CreateVpcError> {
...
pub fn de_create_vpc(
...
) -> std::result::Result<crate::operation::create_vpc::builders::CreateVpcOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateVpcResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateVpcResponse got {start_el:?}"
        )));
    }
