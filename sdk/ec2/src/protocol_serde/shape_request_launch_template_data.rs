...
#[allow(unused_mut)]
pub fn ser_request_launch_template_data(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::RequestLaunchTemplateData) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
