...
pub fn de_cancelled_spot_instance_request(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CancelledSpotInstanceRequest, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
