...
pub fn de_referenced_security_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReferencedSecurityGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
