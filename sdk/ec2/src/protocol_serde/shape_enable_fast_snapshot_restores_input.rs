...
pub fn ser_enable_fast_snapshot_restores_input_input_input(input: &crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
