...
pub fn ser_enable_fast_snapshot_restores_input_input(input: &crate::input::EnableFastSnapshotRestoresInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
