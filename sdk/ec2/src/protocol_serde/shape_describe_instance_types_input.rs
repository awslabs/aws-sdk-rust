...
pub fn ser_describe_instance_types_input_input(input: &crate::input::DescribeInstanceTypesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
