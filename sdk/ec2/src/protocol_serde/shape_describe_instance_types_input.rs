...
pub fn ser_describe_instance_types_input_input(input: &crate::operation::describe_instance_types::DescribeInstanceTypesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
