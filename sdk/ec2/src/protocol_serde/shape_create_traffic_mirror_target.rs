...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_traffic_mirror_target::de_create_traffic_mirror_target(_response_body, output)
            .map_err(crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError::unhandled)?;
