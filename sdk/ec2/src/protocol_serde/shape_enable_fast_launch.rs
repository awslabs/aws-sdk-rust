...
pub fn de_enable_fast_launch_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_fast_launch::EnableFastLaunchOutput, crate::operation::enable_fast_launch::EnableFastLaunchError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::enable_fast_launch::EnableFastLaunchError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::enable_fast_launch::EnableFastLaunchError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_fast_launch_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_fast_launch::EnableFastLaunchOutput, crate::operation::enable_fast_launch::EnableFastLaunchError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::enable_fast_launch::builders::EnableFastLaunchOutputBuilder::default();
        output = crate::protocol_serde::shape_enable_fast_launch::de_enable_fast_launch(_response_body, output).map_err(crate::operation::enable_fast_launch::EnableFastLaunchError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_enable_fast_launch(inp: &[u8], mut builder: crate::operation::enable_fast_launch::builders::EnableFastLaunchOutputBuilder) -> Result<crate::operation::enable_fast_launch::builders::EnableFastLaunchOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("EnableFastLaunchResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected EnableFastLaunchResponse got {:?}", start_el)))
                    }
