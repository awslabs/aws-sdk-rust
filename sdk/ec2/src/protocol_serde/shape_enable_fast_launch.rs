...
pub fn de_enable_fast_launch_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::EnableFastLaunchOutput, crate::error::EnableFastLaunchError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::EnableFastLaunchError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_fast_launch_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::EnableFastLaunchOutput, crate::error::EnableFastLaunchError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::enable_fast_launch_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_enable_fast_launch::de_enable_fast_launch(response.body().as_ref(), output).map_err(crate::error::EnableFastLaunchError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_enable_fast_launch(inp: &[u8], mut builder: crate::output::enable_fast_launch_output::Builder) -> Result<crate::output::enable_fast_launch_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
