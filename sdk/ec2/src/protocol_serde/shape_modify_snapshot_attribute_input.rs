...
pub fn ser_modify_snapshot_attribute_input_input_input(input: &crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
