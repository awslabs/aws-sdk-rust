...
pub fn ser_modify_snapshot_attribute_input_input(input: &crate::input::ModifySnapshotAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
