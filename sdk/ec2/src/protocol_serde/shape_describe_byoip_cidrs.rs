...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_byoip_cidrs_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_byoip_cidrs::de_describe_byoip_cidrs(_response_body, output)
            .map_err(crate::operation::describe_byoip_cidrs::DescribeByoipCidrsError::unhandled)?;
...
) -> Result<crate::operation::describe_byoip_cidrs::builders::DescribeByoipCidrsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
