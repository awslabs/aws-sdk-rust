...
#[allow(unused_mut)]
pub fn ser_spot_placement(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SpotPlacement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_spot_placement(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SpotPlacement, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
