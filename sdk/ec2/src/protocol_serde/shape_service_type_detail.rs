...
pub fn de_service_type_detail(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServiceTypeDetail, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
