...
pub fn ser_get_ipam_prefix_list_resolver_rules_input_input_input(
    input: &crate::operation::get_ipam_prefix_list_resolver_rules::GetIpamPrefixListResolverRulesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "GetIpamPrefixListResolverRules", "2016-11-15");
    #[allow(unused_mut)]
