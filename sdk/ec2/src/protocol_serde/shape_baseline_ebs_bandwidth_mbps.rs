...
#[allow(unused_mut)]
pub fn ser_baseline_ebs_bandwidth_mbps(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::BaselineEbsBandwidthMbps) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_baseline_ebs_bandwidth_mbps(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::BaselineEbsBandwidthMbps, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
