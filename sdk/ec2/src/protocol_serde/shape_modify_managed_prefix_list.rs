...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_managed_prefix_list::ModifyManagedPrefixListError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::modify_managed_prefix_list::ModifyManagedPrefixListError::generic(
        generic,
    ))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_managed_prefix_list_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_managed_prefix_list::de_modify_managed_prefix_list(_response_body, output)
            .map_err(crate::operation::modify_managed_prefix_list::ModifyManagedPrefixListError::unhandled)?;
...
) -> Result<crate::operation::modify_managed_prefix_list::builders::ModifyManagedPrefixListOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
