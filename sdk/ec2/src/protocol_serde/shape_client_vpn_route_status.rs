...
pub fn de_client_vpn_route_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientVpnRouteStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
