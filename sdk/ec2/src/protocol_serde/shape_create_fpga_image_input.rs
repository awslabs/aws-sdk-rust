...
pub fn ser_create_fpga_image_input_input_input(input: &crate::operation::create_fpga_image::CreateFpgaImageInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
