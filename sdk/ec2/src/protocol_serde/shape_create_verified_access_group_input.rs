...
pub fn ser_create_verified_access_group_input_input_input(input: &crate::operation::create_verified_access_group::CreateVerifiedAccessGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
