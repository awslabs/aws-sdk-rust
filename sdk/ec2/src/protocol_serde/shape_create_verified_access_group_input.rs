...
pub fn ser_create_verified_access_group_input_input(input: &crate::input::CreateVerifiedAccessGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
