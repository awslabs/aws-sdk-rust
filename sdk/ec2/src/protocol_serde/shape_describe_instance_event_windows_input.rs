...
pub fn ser_describe_instance_event_windows_input_input(input: &crate::input::DescribeInstanceEventWindowsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
