...
pub fn de_allocate_hosts_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::allocate_hosts::AllocateHostsOutput, crate::operation::allocate_hosts::AllocateHostsError> {
    #[allow(unused_mut)]
...
pub fn de_allocate_hosts_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_allocate_hosts::de_allocate_hosts(_response_body, output)
            .map_err(crate::operation::allocate_hosts::AllocateHostsError::unhandled)?;
...
pub fn de_allocate_hosts(
    ...
    if !(start_el.matches("AllocateHostsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected AllocateHostsResponse got {start_el:?}"
        )));
    }
