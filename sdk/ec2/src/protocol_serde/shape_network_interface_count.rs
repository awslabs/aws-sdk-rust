...
#[allow(unused_mut)]
pub fn ser_network_interface_count(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::NetworkInterfaceCount) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_network_interface_count(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::NetworkInterfaceCount, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::NetworkInterfaceCount::builder();
