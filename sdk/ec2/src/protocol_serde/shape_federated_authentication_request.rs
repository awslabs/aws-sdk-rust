...
#[allow(unused_mut)]
pub fn ser_federated_authentication_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::FederatedAuthenticationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
