...
#[allow(unused_mut)]
pub fn de_create_volume(inp: &[u8], mut builder: crate::output::create_volume_output::Builder) -> Result<crate::output::create_volume_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
