...
pub fn ser_get_verified_access_group_policy_input_input(input: &crate::input::GetVerifiedAccessGroupPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
