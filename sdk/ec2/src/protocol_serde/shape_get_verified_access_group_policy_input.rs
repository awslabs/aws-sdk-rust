...
pub fn ser_get_verified_access_group_policy_input_input_input(input: &crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
