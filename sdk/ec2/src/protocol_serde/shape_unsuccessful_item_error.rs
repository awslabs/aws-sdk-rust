...
pub fn de_unsuccessful_item_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::UnsuccessfulItemError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
