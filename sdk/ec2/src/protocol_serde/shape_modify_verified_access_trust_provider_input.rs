...
pub fn ser_modify_verified_access_trust_provider_input_input(input: &crate::input::ModifyVerifiedAccessTrustProviderInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
