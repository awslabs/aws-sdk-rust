...
pub fn ser_modify_verified_access_trust_provider_input_input_input(input: &crate::operation::modify_verified_access_trust_provider::ModifyVerifiedAccessTrustProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_6) = &input.device_options {
        crate::protocol_serde::shape_modify_verified_access_trust_provider_device_options::ser_modify_verified_access_trust_provider_device_options(scope_5, var_6)?;
    }
    #[allow(unused_mut)]
