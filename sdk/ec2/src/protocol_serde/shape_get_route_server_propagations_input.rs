...
pub fn ser_get_route_server_propagations_input_input_input(
    input: &crate::operation::get_route_server_propagations::GetRouteServerPropagationsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "GetRouteServerPropagations", "2016-11-15");
    #[allow(unused_mut)]
