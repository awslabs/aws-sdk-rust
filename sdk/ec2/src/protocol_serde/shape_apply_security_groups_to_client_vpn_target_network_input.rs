...
pub fn ser_apply_security_groups_to_client_vpn_target_network_input_input(input: &crate::input::ApplySecurityGroupsToClientVpnTargetNetworkInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
