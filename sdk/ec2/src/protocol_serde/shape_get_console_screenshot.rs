...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_console_screenshot::GetConsoleScreenshotError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_console_screenshot::de_get_console_screenshot(_response_body, output)
            .map_err(crate::operation::get_console_screenshot::GetConsoleScreenshotError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("GetConsoleScreenshotResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetConsoleScreenshotResponse got {start_el:?}"
        )));
    }
