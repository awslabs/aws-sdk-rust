...
pub fn ser_describe_fleets_input_input(input: &crate::input::DescribeFleetsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
