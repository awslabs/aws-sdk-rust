...
pub fn ser_describe_flow_logs_input_input_input(input: &crate::operation::describe_flow_logs::DescribeFlowLogsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
