...
pub fn de_image_recycle_bin_info(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ImageRecycleBinInfo, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
