...
pub fn de_analysis_component(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisComponent, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
