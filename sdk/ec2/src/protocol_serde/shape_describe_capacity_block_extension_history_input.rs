...
pub fn ser_describe_capacity_block_extension_history_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeCapacityBlockExtensionHistory", "2016-11-15");
    #[allow(unused_mut)]
