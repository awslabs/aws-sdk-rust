...
pub fn ser_create_interruptible_capacity_reservation_allocation_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "CreateInterruptibleCapacityReservationAllocation", "2016-11-15");
    #[allow(unused_mut)]
