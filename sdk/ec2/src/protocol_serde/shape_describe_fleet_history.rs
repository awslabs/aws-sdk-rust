...
pub fn de_describe_fleet_history_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_fleet_history::DescribeFleetHistoryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_fleet_history_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_fleet_history::de_describe_fleet_history(_response_body, output)
            .map_err(crate::operation::describe_fleet_history::DescribeFleetHistoryError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_fleet_history(
    inp: &[u8],
    mut builder: crate::operation::describe_fleet_history::builders::DescribeFleetHistoryOutputBuilder,
) -> Result<crate::operation::describe_fleet_history::builders::DescribeFleetHistoryOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
