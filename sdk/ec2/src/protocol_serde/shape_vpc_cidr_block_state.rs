...
pub fn de_vpc_cidr_block_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VpcCidrBlockState, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
