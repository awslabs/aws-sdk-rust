...
pub fn de_modify_vpc_endpoint_service_payer_responsibility_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_vpc_endpoint_service_payer_responsibility::ModifyVpcEndpointServicePayerResponsibilityError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_vpc_endpoint_service_payer_responsibility_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_vpc_endpoint_service_payer_responsibility::de_modify_vpc_endpoint_service_payer_responsibility(
            _response_body,
            output,
        )
        .map_err(crate::operation::modify_vpc_endpoint_service_payer_responsibility::ModifyVpcEndpointServicePayerResponsibilityError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyVpcEndpointServicePayerResponsibilityResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyVpcEndpointServicePayerResponsibilityResponse got {start_el:?}"
        )));
    }
