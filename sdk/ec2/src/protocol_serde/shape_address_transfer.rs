...
pub fn de_address_transfer(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AddressTransfer, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::model::AddressTransfer::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("addressTransferStatus") /* AddressTransferStatus com.amazonaws.ec2#AddressTransfer$AddressTransferStatus */ =>  {
                let var_6 =
                    Some(
                        Result::<crate::model::AddressTransferStatus, aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            crate::model::AddressTransferStatus::from(
                                aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
