...
pub fn ser_restore_managed_prefix_list_version_input_input_input(input: &crate::operation::restore_managed_prefix_list_version::RestoreManagedPrefixListVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
