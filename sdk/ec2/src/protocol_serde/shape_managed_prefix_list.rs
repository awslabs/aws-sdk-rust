...
pub fn de_managed_prefix_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ManagedPrefixList, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
