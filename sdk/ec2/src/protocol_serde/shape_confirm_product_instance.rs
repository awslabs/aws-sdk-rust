...
#[allow(clippy::unnecessary_wraps)]
pub fn de_confirm_product_instance_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_confirm_product_instance::de_confirm_product_instance(_response_body, output)
            .map_err(crate::operation::confirm_product_instance::ConfirmProductInstanceError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_confirm_product_instance(
    inp: &[u8],
    mut builder: crate::operation::confirm_product_instance::builders::ConfirmProductInstanceOutputBuilder,
) -> Result<crate::operation::confirm_product_instance::builders::ConfirmProductInstanceOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
