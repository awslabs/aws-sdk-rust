...
pub fn de_unmonitor_instances_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::unmonitor_instances::UnmonitorInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_unmonitor_instances_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_unmonitor_instances::de_unmonitor_instances(_response_body, output)
            .map_err(crate::operation::unmonitor_instances::UnmonitorInstancesError::unhandled)?;
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("instancesSet") /* InstanceMonitorings com.amazonaws.ec2.synthetic#UnmonitorInstancesOutput$InstanceMonitorings */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_instance_monitoring_list::de_instance_monitoring_list(&mut tag, depth + 1)
                        ?
                    )
                ;
