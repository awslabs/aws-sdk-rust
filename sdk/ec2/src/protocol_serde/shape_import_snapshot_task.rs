...
pub fn de_import_snapshot_task(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ImportSnapshotTask, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
