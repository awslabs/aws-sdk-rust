...
pub fn de_verified_access_trust_provider_condensed_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::VerifiedAccessTrustProviderCondensed>, aws_smithy_xml::decode::XmlDecodeError> {
