...
pub fn ser_get_spot_placement_scores_input_input_input(input: &crate::operation::get_spot_placement_scores::GetSpotPlacementScoresInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
