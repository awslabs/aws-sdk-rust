...
pub fn de_transit_gateway_connect_peer(
    ...
    depth: u32,
) -> ::std::result::Result<crate::types::TransitGatewayConnectPeer, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("connectPeerConfiguration") /* ConnectPeerConfiguration com.amazonaws.ec2#TransitGatewayConnectPeer$ConnectPeerConfiguration */ =>  {
                let var_5 =
                    Some(
                        crate::protocol_serde::shape_transit_gateway_connect_peer_configuration::de_transit_gateway_connect_peer_configuration(&mut tag, depth + 1)
                        ?
                    )
                ;
