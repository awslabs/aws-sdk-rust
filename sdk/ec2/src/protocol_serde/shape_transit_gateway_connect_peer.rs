...
pub fn de_transit_gateway_connect_peer(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayConnectPeer, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
