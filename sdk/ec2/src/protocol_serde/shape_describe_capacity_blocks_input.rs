...
pub fn ser_describe_capacity_blocks_input_input_input(
    input: &crate::operation::describe_capacity_blocks::DescribeCapacityBlocksInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeCapacityBlocks", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("CapacityBlockId");
    if let Some(var_2) = &input.capacity_block_ids {
        if !var_2.is_empty() {
