...
#[allow(unused_mut)]
pub fn ser_ip_range(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::IpRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_ip_range(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IpRange, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
