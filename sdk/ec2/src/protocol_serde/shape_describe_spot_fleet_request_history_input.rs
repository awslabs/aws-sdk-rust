...
pub fn ser_describe_spot_fleet_request_history_input_input_input(input: &crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistoryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
