...
pub fn de_create_fpga_image_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_fpga_image_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_fpga_image::CreateFpgaImageOutput, crate::operation::create_fpga_image::CreateFpgaImageError> {
...
pub fn de_create_fpga_image(
...
) -> std::result::Result<crate::operation::create_fpga_image::builders::CreateFpgaImageOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateFpgaImageResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected CreateFpgaImageResponse got {start_el:?}"
        )));
    }
