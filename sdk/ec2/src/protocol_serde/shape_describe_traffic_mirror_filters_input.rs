...
pub fn ser_describe_traffic_mirror_filters_input_input(input: &crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
