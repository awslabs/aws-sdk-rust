...
pub fn ser_describe_traffic_mirror_filters_input_input_input(input: &crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.traffic_mirror_filter_ids {
