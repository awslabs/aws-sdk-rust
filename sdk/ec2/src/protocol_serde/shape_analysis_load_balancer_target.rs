...
pub fn de_analysis_load_balancer_target(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalysisLoadBalancerTarget, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
