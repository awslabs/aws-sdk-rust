...
pub fn ser_delete_local_gateway_route_input_input(input: &crate::input::DeleteLocalGatewayRouteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
