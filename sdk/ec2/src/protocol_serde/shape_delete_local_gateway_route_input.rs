...
pub fn ser_delete_local_gateway_route_input_input(input: &crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
