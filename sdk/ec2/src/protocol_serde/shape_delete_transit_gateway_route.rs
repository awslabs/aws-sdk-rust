...
pub fn de_delete_transit_gateway_route_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_transit_gateway_route::DeleteTransitGatewayRouteOutput, crate::operation::delete_transit_gateway_route::DeleteTransitGatewayRouteError> {
    #[allow(unused_mut)]
