...
#[allow(unused_mut)]
pub fn ser_icmp_type_code(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::IcmpTypeCode) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
