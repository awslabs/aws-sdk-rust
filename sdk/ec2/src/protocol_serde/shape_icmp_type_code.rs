...
#[allow(unused_mut)]
pub fn ser_icmp_type_code(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::IcmpTypeCode) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_icmp_type_code(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IcmpTypeCode, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
