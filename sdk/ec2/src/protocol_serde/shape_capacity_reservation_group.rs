...
pub fn de_capacity_reservation_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CapacityReservationGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
