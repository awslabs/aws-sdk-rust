...
#[allow(clippy::unnecessary_wraps)]
pub fn de_import_snapshot_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::import_snapshot::ImportSnapshotOutput, crate::operation::import_snapshot::ImportSnapshotError> {
...
) -> Result<crate::operation::import_snapshot::builders::ImportSnapshotOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
