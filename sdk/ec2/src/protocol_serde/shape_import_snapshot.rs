...
pub fn de_import_snapshot_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::import_snapshot::ImportSnapshotOutput, crate::operation::import_snapshot::ImportSnapshotError> {
    #[allow(unused_mut)]
...
pub fn de_import_snapshot_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_import_snapshot::de_import_snapshot(_response_body, output)
            .map_err(crate::operation::import_snapshot::ImportSnapshotError::unhandled)?;
...
pub fn de_import_snapshot(
...
) -> std::result::Result<crate::operation::import_snapshot::builders::ImportSnapshotOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ImportSnapshotResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ImportSnapshotResponse got {start_el:?}"
        )));
    }
