...
pub fn ser_describe_instances_input_input_input(input: &crate::operation::describe_instances::DescribeInstancesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
