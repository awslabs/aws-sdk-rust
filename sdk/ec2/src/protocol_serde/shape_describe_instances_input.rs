...
pub fn ser_describe_instances_input_input(input: &crate::operation::describe_instances::DescribeInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
