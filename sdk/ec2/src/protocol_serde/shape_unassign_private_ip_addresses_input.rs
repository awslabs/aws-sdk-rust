...
pub fn ser_unassign_private_ip_addresses_input_input(input: &crate::input::UnassignPrivateIpAddressesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
