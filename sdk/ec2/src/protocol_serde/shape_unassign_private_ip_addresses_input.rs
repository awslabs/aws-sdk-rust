...
pub fn ser_unassign_private_ip_addresses_input_input_input(input: &crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
