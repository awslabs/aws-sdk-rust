...
#[allow(unused_mut)]
pub fn ser_target_configuration_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TargetConfigurationRequest) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
