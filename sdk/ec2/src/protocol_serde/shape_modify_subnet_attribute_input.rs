...
pub fn ser_modify_subnet_attribute_input_input(input: &crate::input::ModifySubnetAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
