...
pub fn ser_modify_subnet_attribute_input_input_input(input: &crate::operation::modify_subnet_attribute::ModifySubnetAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
