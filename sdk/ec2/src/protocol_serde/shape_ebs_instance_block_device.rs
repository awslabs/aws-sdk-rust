...
pub fn de_ebs_instance_block_device(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EbsInstanceBlockDevice, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
