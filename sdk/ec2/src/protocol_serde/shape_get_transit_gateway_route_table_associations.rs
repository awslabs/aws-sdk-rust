...
pub fn de_get_transit_gateway_route_table_associations_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_transit_gateway_route_table_associations::GetTransitGatewayRouteTableAssociationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_transit_gateway_route_table_associations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_transit_gateway_route_table_associations::de_get_transit_gateway_route_table_associations(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_transit_gateway_route_table_associations::GetTransitGatewayRouteTableAssociationsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("GetTransitGatewayRouteTableAssociationsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetTransitGatewayRouteTableAssociationsResponse got {start_el:?}"
        )));
    }
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("associations") /* Associations com.amazonaws.ec2.synthetic#GetTransitGatewayRouteTableAssociationsOutput$Associations */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_transit_gateway_route_table_association_list::de_transit_gateway_route_table_association_list(&mut tag, depth + 1)
                        ?
                    )
                ;
