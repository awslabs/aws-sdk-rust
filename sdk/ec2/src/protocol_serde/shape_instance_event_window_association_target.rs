...
pub fn de_instance_event_window_association_target(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceEventWindowAssociationTarget, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
