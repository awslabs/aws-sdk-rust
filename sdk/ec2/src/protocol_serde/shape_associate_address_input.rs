...
pub fn ser_associate_address_input_input_input(input: &crate::operation::associate_address::AssociateAddressInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
