...
pub fn ser_associate_address_input_input(input: &crate::input::AssociateAddressInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
