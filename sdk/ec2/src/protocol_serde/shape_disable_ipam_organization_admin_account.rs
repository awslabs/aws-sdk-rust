...
pub fn de_disable_ipam_organization_admin_account_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disable_ipam_organization_admin_account::DisableIpamOrganizationAdminAccountError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_ipam_organization_admin_account_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_disable_ipam_organization_admin_account::de_disable_ipam_organization_admin_account(_response_body, output)
                .map_err(crate::operation::disable_ipam_organization_admin_account::DisableIpamOrganizationAdminAccountError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DisableIpamOrganizationAdminAccountResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DisableIpamOrganizationAdminAccountResponse got {start_el:?}"
        )));
    }
