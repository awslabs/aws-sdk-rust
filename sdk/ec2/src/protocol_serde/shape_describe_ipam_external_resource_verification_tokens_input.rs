...
pub fn ser_describe_ipam_external_resource_verification_tokens_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeIpamExternalResourceVerificationTokens", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("IpamExternalResourceVerificationTokenId");
