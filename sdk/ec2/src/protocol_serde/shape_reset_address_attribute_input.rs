...
pub fn ser_reset_address_attribute_input_input_input(input: &crate::operation::reset_address_attribute::ResetAddressAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
