...
pub fn ser_reset_address_attribute_input_input(input: &crate::input::ResetAddressAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
