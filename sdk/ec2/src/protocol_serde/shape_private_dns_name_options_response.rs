...
pub fn de_private_dns_name_options_response(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrivateDnsNameOptionsResponse, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
