...
pub fn ser_cancel_image_launch_permission_input_input(input: &crate::operation::cancel_image_launch_permission::CancelImageLaunchPermissionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
