...
pub fn ser_describe_aws_network_performance_metric_subscriptions_input_input(input: &crate::input::DescribeAwsNetworkPerformanceMetricSubscriptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
