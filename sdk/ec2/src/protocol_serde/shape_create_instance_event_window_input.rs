...
pub fn ser_create_instance_event_window_input_input_input(input: &crate::operation::create_instance_event_window::CreateInstanceEventWindowInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
