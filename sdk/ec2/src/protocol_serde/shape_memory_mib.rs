...
#[allow(unused_mut)]
pub fn ser_memory_mib(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MemoryMiB) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_memory_mib(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MemoryMiB, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
