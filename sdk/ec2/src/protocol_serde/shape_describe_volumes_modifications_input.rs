...
pub fn ser_describe_volumes_modifications_input_input_input(input: &crate::operation::describe_volumes_modifications::DescribeVolumesModificationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_4) = &input.volume_ids {
        let mut list_6 = scope_3.start_list(true, Some("VolumeId"));
        for item_5 in var_4 {
            #[allow(unused_mut)]
