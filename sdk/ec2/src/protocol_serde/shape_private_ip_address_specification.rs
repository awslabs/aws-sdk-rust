...
#[allow(unused_mut)]
pub fn ser_private_ip_address_specification(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PrivateIpAddressSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_private_ip_address_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrivateIpAddressSpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
