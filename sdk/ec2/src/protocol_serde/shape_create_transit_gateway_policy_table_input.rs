...
pub fn ser_create_transit_gateway_policy_table_input_input(input: &crate::input::CreateTransitGatewayPolicyTableInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
