...
pub fn ser_export_client_vpn_client_configuration_input_input(input: &crate::input::ExportClientVpnClientConfigurationInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
