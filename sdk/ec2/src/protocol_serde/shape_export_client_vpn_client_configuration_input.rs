...
pub fn ser_export_client_vpn_client_configuration_input_input_input(input: &crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
