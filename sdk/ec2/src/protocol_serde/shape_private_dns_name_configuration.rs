...
pub fn de_private_dns_name_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PrivateDnsNameConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
