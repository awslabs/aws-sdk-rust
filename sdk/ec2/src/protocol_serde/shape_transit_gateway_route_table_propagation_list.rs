...
pub fn de_transit_gateway_route_table_propagation_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TransitGatewayRouteTablePropagation>, aws_smithy_xml::decode::XmlDecodeError> {
