...
pub fn de_verified_access_trust_provider_condensed(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::VerifiedAccessTrustProviderCondensed, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
