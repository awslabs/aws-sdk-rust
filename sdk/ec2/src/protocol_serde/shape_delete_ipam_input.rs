...
pub fn ser_delete_ipam_input_input_input(input: &crate::operation::delete_ipam::DeleteIpamInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
