...
pub fn ser_delete_ipam_input_input(input: &crate::operation::delete_ipam::DeleteIpamInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
