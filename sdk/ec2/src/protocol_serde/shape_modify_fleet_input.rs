...
pub fn ser_modify_fleet_input_input_input(input: &crate::operation::modify_fleet::ModifyFleetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
