...
pub fn ser_modify_fleet_input_input(input: &crate::input::ModifyFleetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
