...
pub fn ser_describe_route_server_peers_input_input_input(
    input: &crate::operation::describe_route_server_peers::DescribeRouteServerPeersInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeRouteServerPeers", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("RouteServerPeerId");
    if let Some(var_2) = &input.route_server_peer_ids {
        if !var_2.is_empty() {
