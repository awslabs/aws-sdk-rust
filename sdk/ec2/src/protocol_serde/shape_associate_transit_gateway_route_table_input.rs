...
pub fn ser_associate_transit_gateway_route_table_input_input_input(
    input: &crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableInput,
