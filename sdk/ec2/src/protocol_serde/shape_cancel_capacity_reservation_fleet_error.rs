...
pub fn de_cancel_capacity_reservation_fleet_error(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::CancelCapacityReservationFleetError, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
