...
pub fn ser_describe_vpc_endpoints_input_input(input: &crate::input::DescribeVpcEndpointsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
