...
pub fn ser_describe_vpc_endpoints_input_input_input(input: &crate::operation::describe_vpc_endpoints::DescribeVpcEndpointsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
