...
pub fn de_target_capacity_specification(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetCapacitySpecification, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
