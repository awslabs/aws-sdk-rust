...
pub fn de_traffic_mirror_filter_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrafficMirrorFilterRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
