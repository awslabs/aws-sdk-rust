...
pub fn de_client_login_banner_response_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ClientLoginBannerResponseOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
