...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::purchase_reserved_instances_offering::PurchaseReservedInstancesOfferingError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_purchase_reserved_instances_offering::de_purchase_reserved_instances_offering(_response_body, output)
            .map_err(crate::operation::purchase_reserved_instances_offering::PurchaseReservedInstancesOfferingError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("PurchaseReservedInstancesOfferingResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected PurchaseReservedInstancesOfferingResponse got {start_el:?}"
        )));
    }
