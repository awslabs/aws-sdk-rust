...
pub fn de_transit_gateway_multicast_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayMulticastGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
