...
pub fn de_subnet_association(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SubnetAssociation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
