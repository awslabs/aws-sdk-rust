...
pub fn de_describe_fleet_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DescribeFleetError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
