...
pub fn ser_describe_internet_gateways_input_input(input: &crate::input::DescribeInternetGatewaysInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
