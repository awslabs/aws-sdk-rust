...
pub fn ser_describe_internet_gateways_input_input_input(input: &crate::operation::describe_internet_gateways::DescribeInternetGatewaysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("InternetGatewayId");
    if let Some(var_9) = &input.internet_gateway_ids {
