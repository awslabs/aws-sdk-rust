...
pub fn de_deregister_instance_event_notification_attributes_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_instance_event_notification_attributes_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_deregister_instance_event_notification_attributes::de_deregister_instance_event_notification_attributes(
                _response_body,
                output,
            )
            .map_err(
...
#[allow(unused_mut)]
pub fn de_deregister_instance_event_notification_attributes(
    inp: &[u8],
    mut builder: crate::operation::deregister_instance_event_notification_attributes::builders::DeregisterInstanceEventNotificationAttributesOutputBuilder,
) -> Result<
