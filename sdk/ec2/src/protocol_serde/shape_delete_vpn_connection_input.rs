...
pub fn ser_delete_vpn_connection_input_input(input: &crate::operation::delete_vpn_connection::DeleteVpnConnectionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
