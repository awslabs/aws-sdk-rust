...
pub fn ser_delete_vpn_connection_input_input_input(input: &crate::operation::delete_vpn_connection::DeleteVpnConnectionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
