...
pub fn de_phase2_encryption_algorithms_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Phase2EncryptionAlgorithmsListValue>, aws_smithy_xml::decode::XmlDecodeError> {
