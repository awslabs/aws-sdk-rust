...
pub fn ser_describe_service_link_virtual_interfaces_input_input_input(
    ...
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeServiceLinkVirtualInterfaces", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("ServiceLinkVirtualInterfaceId");
    if let Some(var_2) = &input.service_link_virtual_interface_ids {
        if !var_2.is_empty() {
