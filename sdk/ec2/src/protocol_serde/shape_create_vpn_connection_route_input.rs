...
pub fn ser_create_vpn_connection_route_input_input_input(input: &crate::operation::create_vpn_connection_route::CreateVpnConnectionRouteInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
