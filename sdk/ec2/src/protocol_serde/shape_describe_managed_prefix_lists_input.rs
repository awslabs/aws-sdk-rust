...
pub fn ser_describe_managed_prefix_lists_input_input(input: &crate::operation::describe_managed_prefix_lists::DescribeManagedPrefixListsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
