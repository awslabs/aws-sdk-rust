...
pub fn ser_create_traffic_mirror_filter_input_input(input: &crate::input::CreateTrafficMirrorFilterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
