...
pub fn ser_create_traffic_mirror_filter_input_input_input(input: &crate::operation::create_traffic_mirror_filter::CreateTrafficMirrorFilterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
