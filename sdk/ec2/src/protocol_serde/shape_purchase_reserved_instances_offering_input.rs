...
pub fn ser_purchase_reserved_instances_offering_input_input(input: &crate::input::PurchaseReservedInstancesOfferingInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
