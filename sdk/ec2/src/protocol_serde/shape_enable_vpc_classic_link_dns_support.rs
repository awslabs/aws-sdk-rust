...
pub fn de_enable_vpc_classic_link_dns_support_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportOutput, crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_vpc_classic_link_dns_support_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportOutput, crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportError> {
    Ok({
        #[allow(unused_mut)]
