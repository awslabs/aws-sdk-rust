...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_enable_vpc_classic_link_dns_support::de_enable_vpc_classic_link_dns_support(_response_body, output)
            .map_err(crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportError::unhandled)?;
...
pub fn de_enable_vpc_classic_link_dns_support(
    inp: &[u8],
    mut builder: crate::operation::enable_vpc_classic_link_dns_support::builders::EnableVpcClassicLinkDnsSupportOutputBuilder,
) -> std::result::Result<
    crate::operation::enable_vpc_classic_link_dns_support::builders::EnableVpcClassicLinkDnsSupportOutputBuilder,
...
> {
    ...
    if !(start_el.matches("EnableVpcClassicLinkDnsSupportResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected EnableVpcClassicLinkDnsSupportResponse got {start_el:?}"
        )));
    }
