...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_ipam_resource_discovery::de_delete_ipam_resource_discovery(_response_body, output)
            .map_err(crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_ipam_resource_discovery(
    inp: &[u8],
    mut builder: crate::operation::delete_ipam_resource_discovery::builders::DeleteIpamResourceDiscoveryOutputBuilder,
) -> std::result::Result<
    crate::operation::delete_ipam_resource_discovery::builders::DeleteIpamResourceDiscoveryOutputBuilder,
...
> {
    ...
    if !(start_el.matches("DeleteIpamResourceDiscoveryResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DeleteIpamResourceDiscoveryResponse got {start_el:?}"
        )));
    }
