...
pub fn de_delete_ipam_resource_discovery_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryOutput, crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_ipam_resource_discovery_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryOutput, crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryError> {
    Ok({
        #[allow(unused_mut)]
