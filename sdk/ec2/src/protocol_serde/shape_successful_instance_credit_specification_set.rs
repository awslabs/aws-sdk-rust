...
pub fn de_successful_instance_credit_specification_set(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::SuccessfulInstanceCreditSpecificationItem>, aws_smithy_xml::decode::XmlDecodeError> {
