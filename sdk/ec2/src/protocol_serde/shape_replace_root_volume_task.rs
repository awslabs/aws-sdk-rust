...
pub fn de_replace_root_volume_task(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReplaceRootVolumeTask, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
