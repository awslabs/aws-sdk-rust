...
pub fn de_transit_gateway_prefix_list_reference(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TransitGatewayPrefixListReference, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
