...
pub fn ser_describe_vpc_classic_link_input_input(input: &crate::input::DescribeVpcClassicLinkInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
