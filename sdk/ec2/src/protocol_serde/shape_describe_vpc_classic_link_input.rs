...
pub fn ser_describe_vpc_classic_link_input_input_input(input: &crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("VpcId");
    if let Some(var_9) = &input.vpc_ids {
        let mut list_11 = scope_8.start_list(true, Some("VpcId"));
