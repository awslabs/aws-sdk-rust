...
pub fn ser_delete_network_interface_permission_input_input_input(
    input: &crate::operation::delete_network_interface_permission::DeleteNetworkInterfacePermissionInput,
