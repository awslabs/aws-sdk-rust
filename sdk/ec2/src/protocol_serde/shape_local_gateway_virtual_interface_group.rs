...
pub fn de_local_gateway_virtual_interface_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LocalGatewayVirtualInterfaceGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
