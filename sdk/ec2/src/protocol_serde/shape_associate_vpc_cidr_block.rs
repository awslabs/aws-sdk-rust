...
pub fn de_associate_vpc_cidr_block_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_vpc_cidr_block::AssociateVpcCidrBlockError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_vpc_cidr_block_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_vpc_cidr_block::de_associate_vpc_cidr_block(_response_body, output)
            .map_err(crate::operation::associate_vpc_cidr_block::AssociateVpcCidrBlockError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_associate_vpc_cidr_block(
    inp: &[u8],
    mut builder: crate::operation::associate_vpc_cidr_block::builders::AssociateVpcCidrBlockOutputBuilder,
) -> Result<crate::operation::associate_vpc_cidr_block::builders::AssociateVpcCidrBlockOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
