...
pub fn ser_describe_spot_fleet_requests_input_input(input: &crate::input::DescribeSpotFleetRequestsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
