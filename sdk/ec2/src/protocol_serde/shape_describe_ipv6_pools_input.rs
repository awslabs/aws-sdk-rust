...
pub fn ser_describe_ipv6_pools_input_input(input: &crate::input::DescribeIpv6PoolsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
