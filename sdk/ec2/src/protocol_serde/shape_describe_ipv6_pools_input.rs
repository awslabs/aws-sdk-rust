...
pub fn ser_describe_ipv6_pools_input_input_input(input: &crate::operation::describe_ipv6_pools::DescribeIpv6PoolsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
