...
pub fn ser_describe_image_attribute_input_input_input(input: &crate::operation::describe_image_attribute::DescribeImageAttributeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
