...
pub fn ser_reject_vpc_endpoint_connections_input_input(input: &crate::operation::reject_vpc_endpoint_connections::RejectVpcEndpointConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
