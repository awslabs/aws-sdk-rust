...
pub fn ser_reject_vpc_endpoint_connections_input_input(input: &crate::input::RejectVpcEndpointConnectionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
