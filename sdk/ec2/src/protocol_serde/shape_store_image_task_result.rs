...
pub fn de_store_image_task_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StoreImageTaskResult, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
