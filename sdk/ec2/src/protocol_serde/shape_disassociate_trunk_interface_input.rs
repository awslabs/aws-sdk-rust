...
pub fn ser_disassociate_trunk_interface_input_input(input: &crate::input::DisassociateTrunkInterfaceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
