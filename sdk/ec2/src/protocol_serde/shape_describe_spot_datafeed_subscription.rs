...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_spot_datafeed_subscription::de_describe_spot_datafeed_subscription(_response_body, output)
            .map_err(crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeSpotDatafeedSubscriptionResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeSpotDatafeedSubscriptionResponse got {start_el:?}"
        )));
    }
