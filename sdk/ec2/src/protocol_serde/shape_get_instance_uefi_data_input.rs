...
pub fn ser_get_instance_uefi_data_input_input_input(input: &crate::operation::get_instance_uefi_data::GetInstanceUefiDataInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
