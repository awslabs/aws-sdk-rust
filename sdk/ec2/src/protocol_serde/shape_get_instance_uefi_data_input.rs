...
pub fn ser_get_instance_uefi_data_input_input(input: &crate::input::GetInstanceUefiDataInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
