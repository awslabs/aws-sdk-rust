...
pub fn de_describe_vpc_endpoint_service_permissions_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_vpc_endpoint_service_permissions_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_vpc_endpoint_service_permissions::de_describe_vpc_endpoint_service_permissions(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_vpc_endpoint_service_permissions(
    inp: &[u8],
    mut builder: crate::operation::describe_vpc_endpoint_service_permissions::builders::DescribeVpcEndpointServicePermissionsOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_vpc_endpoint_service_permissions::builders::DescribeVpcEndpointServicePermissionsOutputBuilder,
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("allowedPrincipals") /* AllowedPrincipals com.amazonaws.ec2.synthetic#DescribeVpcEndpointServicePermissionsOutput$AllowedPrincipals */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_allowed_principal_set::de_allowed_principal_set(&mut tag, depth + 1)
                        ?
                    )
                ;
