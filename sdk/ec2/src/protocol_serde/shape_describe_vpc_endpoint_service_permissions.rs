...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_vpc_endpoint_service_permissions_http_response_with_props(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsOutput, crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError>{
    Ok({
        #[allow(unused_mut)]
