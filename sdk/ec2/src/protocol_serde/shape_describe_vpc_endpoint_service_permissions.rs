...
pub fn de_describe_vpc_endpoint_service_permissions_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsOutput, crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_vpc_endpoint_service_permissions_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsOutput, crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_describe_vpc_endpoint_service_permissions::de_describe_vpc_endpoint_service_permissions(_response_body, output).map_err(crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsError::unhandled)?;
