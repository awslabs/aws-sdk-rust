...
pub fn ser_describe_iam_instance_profile_associations_input_input_input(input: &crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    ...
    if let Some(var_2) = &input.association_ids {
        let mut list_4 = scope_1.start_list(true, Some("AssociationId"));
        for item_3 in var_2 {
            #[allow(unused_mut)]
