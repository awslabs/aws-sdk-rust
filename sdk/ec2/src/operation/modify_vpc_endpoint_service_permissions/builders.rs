...
impl ModifyVpcEndpointServicePermissionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissions::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissionsOutput, crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissionsError, Self> {
