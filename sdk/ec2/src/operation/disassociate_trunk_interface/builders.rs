...
impl DisassociateTrunkInterfaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_trunk_interface::DisassociateTrunkInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_trunk_interface::DisassociateTrunkInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_trunk_interface::DisassociateTrunkInterfaceOutput, crate::operation::disassociate_trunk_interface::DisassociateTrunkInterfaceError, Self> {
