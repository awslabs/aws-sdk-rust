...
impl DisassociateTrunkInterfaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_trunk_interface::DisassociateTrunkInterfaceInput, ::aws_smithy_types::error::operation::BuildError> {
