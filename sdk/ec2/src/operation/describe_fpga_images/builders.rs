...
impl DescribeFpgaImagesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_fpga_images::DescribeFpgaImagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fpga_images::DescribeFpgaImagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_fpga_images::DescribeFpgaImagesOutput, crate::operation::describe_fpga_images::DescribeFpgaImagesError, Self> {
