...
impl GetSecurityGroupsForVpc {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSecurityGroupsForVpc {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSecurityGroupsForVpc");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSecurityGroupsForVpcRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSecurityGroupsForVpcResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSecurityGroupsForVpc")
...
.with_interceptor(GetSecurityGroupsForVpcEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_security_groups_for_vpc::de_get_security_groups_for_vpc_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetSecurityGroupsForVpcRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSecurityGroupsForVpcRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_security_groups_for_vpc_input::ser_get_security_groups_for_vpc_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetSecurityGroupsForVpcEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSecurityGroupsForVpcEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSecurityGroupsForVpcEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSecurityGroupsForVpcInput>()
                        .ok_or("failed to downcast to GetSecurityGroupsForVpcInput")?;
...
/// Error type for the `GetSecurityGroupsForVpcError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetSecurityGroupsForVpcError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSecurityGroupsForVpcError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetSecurityGroupsForVpcError {
    /// Creates the `GetSecurityGroupsForVpcError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSecurityGroupsForVpcError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for GetSecurityGroupsForVpcError {
...
impl ::std::fmt::Display for GetSecurityGroupsForVpcError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetSecurityGroupsForVpcError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSecurityGroupsForVpcError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSecurityGroupsForVpcError {
