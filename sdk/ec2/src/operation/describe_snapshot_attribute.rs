...
impl DescribeSnapshotAttributeInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_snapshot_attribute::DescribeSnapshotAttribute::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSnapshotAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_snapshot_attribute::de_describe_snapshot_attribute_http_response_with_props(status, headers, body)
        }
    }
}
