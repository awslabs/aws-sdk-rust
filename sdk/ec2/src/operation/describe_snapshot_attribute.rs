...
impl DescribeSnapshotAttribute {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSnapshotAttribute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeSnapshotAttribute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeSnapshotAttributeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeSnapshotAttributeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSnapshotAttribute")
...
.with_interceptor(DescribeSnapshotAttributeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_snapshot_attribute::de_describe_snapshot_attribute_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeSnapshotAttributeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_snapshot_attribute_input::ser_describe_snapshot_attribute_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeSnapshotAttributeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeSnapshotAttributeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeSnapshotAttributeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeSnapshotAttributeInput>()
                        .ok_or("failed to downcast to DescribeSnapshotAttributeInput")?;
...
/// Error type for the `DescribeSnapshotAttributeError` operation.
#[non_exhaustive]
...
pub enum DescribeSnapshotAttributeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeSnapshotAttributeError) for what information is available for the error.")]
...
impl DescribeSnapshotAttributeError {
    /// Creates the `DescribeSnapshotAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSnapshotAttributeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeSnapshotAttributeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeSnapshotAttributeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_snapshot_attribute::_describe_snapshot_attribute_output::DescribeSnapshotAttributeOutput;

pub use crate::operation::describe_snapshot_attribute::_describe_snapshot_attribute_input::DescribeSnapshotAttributeInput;

mod _describe_snapshot_attribute_input;

mod _describe_snapshot_attribute_output;
