    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSnapshotAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSnapshotAttribute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSnapshotAttribute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSnapshotAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSnapshotAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_snapshot_attribute_input::ser_describe_snapshot_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSnapshotAttributeEndpointParamsInterceptor {
...
pub type DescribeSnapshotAttributeErrorKind = DescribeSnapshotAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSnapshotAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeError {
...
impl DescribeSnapshotAttributeError {
    ...
    /// Creates the `DescribeSnapshotAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
