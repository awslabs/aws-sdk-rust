...
impl ReleaseIpamPoolAllocation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReleaseIpamPoolAllocation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReleaseIpamPoolAllocation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReleaseIpamPoolAllocationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReleaseIpamPoolAllocationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReleaseIpamPoolAllocation")
...
.with_interceptor(ReleaseIpamPoolAllocationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_release_ipam_pool_allocation::de_release_ipam_pool_allocation_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ReleaseIpamPoolAllocationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReleaseIpamPoolAllocationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_release_ipam_pool_allocation_input::ser_release_ipam_pool_allocation_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReleaseIpamPoolAllocationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReleaseIpamPoolAllocationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReleaseIpamPoolAllocationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReleaseIpamPoolAllocationInput>()
                        .ok_or("failed to downcast to ReleaseIpamPoolAllocationInput")?;
...
/// Error type for the `ReleaseIpamPoolAllocationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ReleaseIpamPoolAllocationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReleaseIpamPoolAllocationError) for what information is available for the error.")]
...
impl ReleaseIpamPoolAllocationError {
    /// Creates the `ReleaseIpamPoolAllocationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReleaseIpamPoolAllocationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReleaseIpamPoolAllocationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReleaseIpamPoolAllocationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError {
...
mod _release_ipam_pool_allocation_output;
