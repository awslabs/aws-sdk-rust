    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReleaseIpamPoolAllocation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReleaseIpamPoolAllocation", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReleaseIpamPoolAllocation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReleaseIpamPoolAllocationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReleaseIpamPoolAllocationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_release_ipam_pool_allocation_input::ser_release_ipam_pool_allocation_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReleaseIpamPoolAllocationEndpointParamsInterceptor {
...
pub type ReleaseIpamPoolAllocationErrorKind = ReleaseIpamPoolAllocationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReleaseIpamPoolAllocationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationError {
...
impl ReleaseIpamPoolAllocationError {
    ...
    /// Creates the `ReleaseIpamPoolAllocationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
