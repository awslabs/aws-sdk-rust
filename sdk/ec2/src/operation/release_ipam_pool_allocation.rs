...
impl ReleaseIpamPoolAllocationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReleaseIpamPoolAllocation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_release_ipam_pool_allocation::de_release_ipam_pool_allocation_http_response_with_props(status, headers, body)
        }
    }
}
