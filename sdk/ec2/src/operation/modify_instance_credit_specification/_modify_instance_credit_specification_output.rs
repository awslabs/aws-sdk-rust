...
impl ModifyInstanceCreditSpecificationOutputBuilder {
    ...
    /// <p>Information about the instances whose credit option for CPU usage was successfully modified.</p>
    pub fn get_successful_instance_credit_specifications(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::SuccessfulInstanceCreditSpecificationItem>> {
    ...
    /// <p>Information about the instances whose credit option for CPU usage was not modified.</p>
    pub fn get_unsuccessful_instance_credit_specifications(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::UnsuccessfulInstanceCreditSpecificationItem>> {
