...
impl DeleteClientVpnRouteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_client_vpn_route::DeleteClientVpnRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_client_vpn_route::DeleteClientVpnRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::delete_client_vpn_route::DeleteClientVpnRoute::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_client_vpn_route::DeleteClientVpnRouteOutput, crate::operation::delete_client_vpn_route::DeleteClientVpnRouteError, Self> {
