...
impl GetVerifiedAccessEndpointPolicy {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_verified_access_endpoint_policy::GetVerifiedAccessEndpointPolicyOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetVerifiedAccessEndpointPolicyResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetVerifiedAccessEndpointPolicyRequestSerializer {
