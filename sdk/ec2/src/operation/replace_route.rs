...
impl ReplaceRoute {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EC2", "ReplaceRoute", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ReplaceRoute", "EC2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReplaceRouteResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_replace_route::de_replace_route_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_replace_route::de_replace_route_http_response(status, headers, body, _cfg)
        };
