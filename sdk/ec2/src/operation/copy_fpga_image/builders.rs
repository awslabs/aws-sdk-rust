...
impl CopyFpgaImageFluentBuilder  {
    /// Creates a new `CopyFpgaImage`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::copy_fpga_image::CopyFpgaImage, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::copy_fpga_image::CopyFpgaImageError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::copy_fpga_image::CopyFpgaImageOutput, aws_smithy_http::result::SdkError<crate::operation::copy_fpga_image::CopyFpgaImageError>>
                     {
