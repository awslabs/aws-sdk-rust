...
pub use crate::operation::copy_fpga_image::_copy_fpga_image_output::CopyFpgaImageOutputBuilder;
...
pub struct CopyFpgaImageFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::copy_fpga_image::builders::CopyFpgaImageInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::copy_fpga_image::CopyFpgaImageOutput,
                    crate::operation::copy_fpga_image::CopyFpgaImageError,
                > for CopyFpgaImageFluentBuilder
            {
                fn send(
                    self,
...
impl CopyFpgaImageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::copy_fpga_image::CopyFpgaImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::copy_fpga_image::CopyFpgaImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::copy_fpga_image::CopyFpgaImage::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::copy_fpga_image::CopyFpgaImage::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::copy_fpga_image::CopyFpgaImageOutput, crate::operation::copy_fpga_image::CopyFpgaImageError, Self> {
