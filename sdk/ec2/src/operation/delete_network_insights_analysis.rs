...
impl DeleteNetworkInsightsAnalysisInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_network_insights_analysis::DeleteNetworkInsightsAnalysis,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_network_insights_analysis::DeleteNetworkInsightsAnalysis::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNetworkInsightsAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_network_insights_analysis::de_delete_network_insights_analysis_http_response_with_props(
                status, headers, body,
            )
        }
    }
