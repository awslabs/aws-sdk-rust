    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_insights_analysis::DeleteNetworkInsightsAnalysisError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_insights_analysis::DeleteNetworkInsightsAnalysisOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteNetworkInsightsAnalysisResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteNetworkInsightsAnalysisRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteNetworkInsightsAnalysisEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteNetworkInsightsAnalysisError {
