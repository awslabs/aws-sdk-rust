    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_fleet_instances::DescribeSpotFleetInstancesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_fleet_instances::DescribeSpotFleetInstancesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSpotFleetInstances {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSpotFleetInstances", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSpotFleetInstances")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSpotFleetInstancesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSpotFleetInstancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_fleet_instances::DescribeSpotFleetInstancesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_fleet_instances_input::ser_describe_spot_fleet_instances_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSpotFleetInstancesEndpointParamsInterceptor {
...
pub type DescribeSpotFleetInstancesErrorKind = DescribeSpotFleetInstancesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSpotFleetInstancesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_spot_fleet_instances::DescribeSpotFleetInstancesError {
...
impl DescribeSpotFleetInstancesError {
    ...
    /// Creates the `DescribeSpotFleetInstancesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
