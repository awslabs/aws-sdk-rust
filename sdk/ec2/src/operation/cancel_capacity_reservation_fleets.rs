...
impl CancelCapacityReservationFleetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelCapacityReservationFleets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_capacity_reservation_fleets::de_cancel_capacity_reservation_fleets_http_response_with_props(
                status, headers, body,
            )
        }
    }
