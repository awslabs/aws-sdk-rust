...
impl CancelCapacityReservationFleets {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelCapacityReservationFleets {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelCapacityReservationFleets");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelCapacityReservationFleetsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelCapacityReservationFleetsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelCapacityReservationFleets")
...
.with_interceptor(CancelCapacityReservationFleetsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_cancel_capacity_reservation_fleets::de_cancel_capacity_reservation_fleets_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CancelCapacityReservationFleetsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelCapacityReservationFleetsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_capacity_reservation_fleets_input::ser_cancel_capacity_reservation_fleets_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CancelCapacityReservationFleetsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelCapacityReservationFleetsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelCapacityReservationFleetsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelCapacityReservationFleetsInput>()
                        .ok_or("failed to downcast to CancelCapacityReservationFleetsInput")?;
...
/// Error type for the `CancelCapacityReservationFleetsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CancelCapacityReservationFleetsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelCapacityReservationFleetsError) for what information is available for the error.")]
...
impl CancelCapacityReservationFleetsError {
    /// Creates the `CancelCapacityReservationFleetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelCapacityReservationFleetsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelCapacityReservationFleetsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelCapacityReservationFleetsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_capacity_reservation_fleets::CancelCapacityReservationFleetsError {
...
mod _cancel_capacity_reservation_fleets_output;
