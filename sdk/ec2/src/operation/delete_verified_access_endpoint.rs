...
impl DeleteVerifiedAccessEndpoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointInput,
                    ) -> ::std::result::Result<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVerifiedAccessEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVerifiedAccessEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVerifiedAccessEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVerifiedAccessEndpointResponseDeserializer));
...
.with_interceptor(DeleteVerifiedAccessEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointError>::new());
...
#[derive(Debug)]
            struct DeleteVerifiedAccessEndpointResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVerifiedAccessEndpointResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_verified_access_endpoint::de_delete_verified_access_endpoint_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_verified_access_endpoint::de_delete_verified_access_endpoint_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteVerifiedAccessEndpointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVerifiedAccessEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_verified_access_endpoint::DeleteVerifiedAccessEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_verified_access_endpoint_input::ser_delete_verified_access_endpoint_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVerifiedAccessEndpointEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVerifiedAccessEndpointInput>()
                        .ok_or("failed to downcast to DeleteVerifiedAccessEndpointInput")?;
...
/// Error type for the `DeleteVerifiedAccessEndpointError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteVerifiedAccessEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVerifiedAccessEndpointError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DeleteVerifiedAccessEndpointError {
    /// Creates the `DeleteVerifiedAccessEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVerifiedAccessEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for DeleteVerifiedAccessEndpointError {
...
impl ::std::fmt::Display for DeleteVerifiedAccessEndpointError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DeleteVerifiedAccessEndpointError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteVerifiedAccessEndpointError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVerifiedAccessEndpointError {
