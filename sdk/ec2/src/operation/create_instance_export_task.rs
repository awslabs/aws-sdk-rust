    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_instance_export_task::CreateInstanceExportTaskError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_instance_export_task::CreateInstanceExportTaskOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateInstanceExportTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateInstanceExportTask", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateInstanceExportTask")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateInstanceExportTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateInstanceExportTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_instance_export_task::CreateInstanceExportTaskInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_instance_export_task_input::ser_create_instance_export_task_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateInstanceExportTaskEndpointParamsInterceptor {
...
pub type CreateInstanceExportTaskErrorKind = CreateInstanceExportTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateInstanceExportTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_instance_export_task::CreateInstanceExportTaskError {
...
impl CreateInstanceExportTaskError {
    ...
    /// Creates the `CreateInstanceExportTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
