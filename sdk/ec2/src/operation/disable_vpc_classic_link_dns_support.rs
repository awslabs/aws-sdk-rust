...
impl DisableVpcClassicLinkDnsSupport {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_vpc_classic_link_dns_support::DisableVpcClassicLinkDnsSupportOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DisableVpcClassicLinkDnsSupportResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DisableVpcClassicLinkDnsSupportRequestSerializer {
