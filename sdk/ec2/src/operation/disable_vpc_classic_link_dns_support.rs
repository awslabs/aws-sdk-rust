...
impl DisableVpcClassicLinkDnsSupportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_vpc_classic_link_dns_support::DisableVpcClassicLinkDnsSupport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableVpcClassicLinkDnsSupport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_vpc_classic_link_dns_support::de_disable_vpc_classic_link_dns_support_http_response_with_props(
                status, headers, body,
            )
        }
    }
