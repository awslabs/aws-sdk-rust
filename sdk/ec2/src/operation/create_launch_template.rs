...
impl CreateLaunchTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_launch_template::CreateLaunchTemplateError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_launch_template::CreateLaunchTemplateOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateLaunchTemplate", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLaunchTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateLaunchTemplate", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLaunchTemplate")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateLaunchTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateLaunchTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_launch_template::CreateLaunchTemplateInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_launch_template_input::ser_create_launch_template_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateLaunchTemplateEndpointParamsInterceptor {
...
pub type CreateLaunchTemplateErrorKind = CreateLaunchTemplateError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateLaunchTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_launch_template::CreateLaunchTemplateError {
...
impl CreateLaunchTemplateError {
    ...
    /// Creates the `CreateLaunchTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
