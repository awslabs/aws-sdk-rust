...
impl crate::operation::get_groups_for_capacity_reservation::builders::GetGroupsForCapacityReservationInputBuilder {
...
impl GetGroupsForCapacityReservationFluentBuilder {
    /// Creates a new `GetGroupsForCapacityReservationFluentBuilder`.
