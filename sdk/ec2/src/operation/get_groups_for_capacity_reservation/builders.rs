...
impl GetGroupsForCapacityReservationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationOutput, crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservationError, Self> {
