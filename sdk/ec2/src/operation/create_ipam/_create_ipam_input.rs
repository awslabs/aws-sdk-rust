...
impl CreateIpamInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::create_ipam::CreateIpamInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
            crate::operation::create_ipam::CreateIpamInput {
