...
impl DescribeByoipCidrsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::describe_byoip_cidrs::paginator::DescribeByoipCidrsPaginator {
        crate::operation::describe_byoip_cidrs::paginator::DescribeByoipCidrsPaginator::new(
            self.handle,
            self.inner,
        )
    }
