...
impl CreateLaunchTemplateVersion {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_launch_template_version::CreateLaunchTemplateVersionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_launch_template_version::CreateLaunchTemplateVersionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateLaunchTemplateVersion", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLaunchTemplateVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            CreateLaunchTemplateVersionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            CreateLaunchTemplateVersionResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateLaunchTemplateVersion", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLaunchTemplateVersion")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateLaunchTemplateVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateLaunchTemplateVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_launch_template_version::CreateLaunchTemplateVersionInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_launch_template_version_input::ser_create_launch_template_version_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateLaunchTemplateVersionEndpointParamsInterceptor {
...
pub type CreateLaunchTemplateVersionErrorKind = CreateLaunchTemplateVersionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateLaunchTemplateVersionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_launch_template_version::CreateLaunchTemplateVersionError {
...
impl CreateLaunchTemplateVersionError {
    ...
    /// Creates the `CreateLaunchTemplateVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
