...
impl RestoreSnapshotTier {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_snapshot_tier::RestoreSnapshotTierError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_snapshot_tier::RestoreSnapshotTierOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "RestoreSnapshotTier", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreSnapshotTier {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RestoreSnapshotTier", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreSnapshotTier")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(RestoreSnapshotTierEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RestoreSnapshotTierResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RestoreSnapshotTierRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_snapshot_tier::RestoreSnapshotTierInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_snapshot_tier_input::ser_restore_snapshot_tier_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RestoreSnapshotTierEndpointParamsInterceptor {
...
pub type RestoreSnapshotTierErrorKind = RestoreSnapshotTierError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for RestoreSnapshotTierError {
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_snapshot_tier::RestoreSnapshotTierError {
...
impl RestoreSnapshotTierError {
    ...
    /// Creates the `RestoreSnapshotTierError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
