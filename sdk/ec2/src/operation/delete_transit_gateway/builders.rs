...
impl DeleteTransitGatewayFluentBuilder  {
    /// Creates a new `DeleteTransitGateway`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_transit_gateway::DeleteTransitGateway, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_transit_gateway::DeleteTransitGatewayError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_transit_gateway::DeleteTransitGatewayOutput, aws_smithy_http::result::SdkError<crate::operation::delete_transit_gateway::DeleteTransitGatewayError>>
                     {
