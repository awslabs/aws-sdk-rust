...
impl CancelSpotInstanceRequests {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelSpotInstanceRequests {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelSpotInstanceRequests");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelSpotInstanceRequestsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelSpotInstanceRequestsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelSpotInstanceRequests")
...
.with_interceptor(CancelSpotInstanceRequestsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_cancel_spot_instance_requests::de_cancel_spot_instance_requests_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelSpotInstanceRequestsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_spot_instance_requests_input::ser_cancel_spot_instance_requests_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CancelSpotInstanceRequestsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelSpotInstanceRequestsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelSpotInstanceRequestsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelSpotInstanceRequestsInput>()
                        .ok_or("failed to downcast to CancelSpotInstanceRequestsInput")?;
...
/// Error type for the `CancelSpotInstanceRequestsError` operation.
#[non_exhaustive]
...
pub enum CancelSpotInstanceRequestsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelSpotInstanceRequestsError) for what information is available for the error.")]
...
impl CancelSpotInstanceRequestsError {
    /// Creates the `CancelSpotInstanceRequestsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelSpotInstanceRequestsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelSpotInstanceRequestsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelSpotInstanceRequestsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::cancel_spot_instance_requests::_cancel_spot_instance_requests_output::CancelSpotInstanceRequestsOutput;

pub use crate::operation::cancel_spot_instance_requests::_cancel_spot_instance_requests_input::CancelSpotInstanceRequestsInput;

mod _cancel_spot_instance_requests_input;

mod _cancel_spot_instance_requests_output;
