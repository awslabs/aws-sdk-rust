...
impl CancelSpotInstanceRequests {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CancelSpotInstanceRequests", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelSpotInstanceRequests {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            CancelSpotInstanceRequestsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            CancelSpotInstanceRequestsResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CancelSpotInstanceRequests", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelSpotInstanceRequests")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CancelSpotInstanceRequestsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CancelSpotInstanceRequestsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_spot_instance_requests_input::ser_cancel_spot_instance_requests_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelSpotInstanceRequestsEndpointParamsInterceptor {
...
pub type CancelSpotInstanceRequestsErrorKind = CancelSpotInstanceRequestsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelSpotInstanceRequestsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError {
...
impl CancelSpotInstanceRequestsError {
    ...
    /// Creates the `CancelSpotInstanceRequestsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
