...
impl CreateSpotDatafeedSubscriptionFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionError>>
                     {
        let op = self
            .inner
            .build()
