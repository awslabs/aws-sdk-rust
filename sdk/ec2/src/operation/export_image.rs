...
impl ExportImageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::export_image::ExportImage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_export_image_input::ser_export_image_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_image::de_export_image_http_response_with_props(status, headers, body)
        }
    }
}
