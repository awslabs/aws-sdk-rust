...
impl DescribeTransitGatewayAttachmentsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_transit_gateway_attachments::DescribeTransitGatewayAttachmentsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
