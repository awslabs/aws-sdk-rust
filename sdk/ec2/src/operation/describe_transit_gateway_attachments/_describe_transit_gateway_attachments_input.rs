...
impl DescribeTransitGatewayAttachmentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_transit_gateway_attachments::DescribeTransitGatewayAttachmentsInput, ::aws_smithy_types::error::operation::BuildError> {
