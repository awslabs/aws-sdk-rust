...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachVolume {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AttachVolume", "ec2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachVolumeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_attach_volume_input::ser_attach_volume_input_input(&input)?);
