...
impl GetManagedPrefixListEntriesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetManagedPrefixListEntries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_managed_prefix_list_entries::de_get_managed_prefix_list_entries_http_response_with_props(
                status, headers, body,
            )
        }
    }
