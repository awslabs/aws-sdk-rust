...
impl ModifyInstanceCapacityReservationAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_instance_capacity_reservation_attributes::ModifyInstanceCapacityReservationAttributesInput, ::aws_smithy_types::error::operation::BuildError> {
