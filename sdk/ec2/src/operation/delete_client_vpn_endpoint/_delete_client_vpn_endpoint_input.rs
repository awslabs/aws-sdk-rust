...
impl DeleteClientVpnEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointInput, ::aws_smithy_types::error::operation::BuildError> {
