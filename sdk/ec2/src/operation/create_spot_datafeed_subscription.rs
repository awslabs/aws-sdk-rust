...
impl CreateSpotDatafeedSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSpotDatafeedSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_spot_datafeed_subscription::de_create_spot_datafeed_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
