...
impl GetManagedPrefixListAssociationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_managed_prefix_list_associations::GetManagedPrefixListAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetManagedPrefixListAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_managed_prefix_list_associations::de_get_managed_prefix_list_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
