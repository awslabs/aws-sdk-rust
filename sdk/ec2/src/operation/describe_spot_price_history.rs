...
impl DescribeSpotPriceHistoryInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_spot_price_history::DescribeSpotPriceHistory::new(),
        )
...
/// `ParseStrictResponse` impl for `DescribeSpotPriceHistory`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSpotPriceHistory {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_spot_price_history::de_describe_spot_price_history_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_spot_price_history::de_describe_spot_price_history_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_spot_price_history::DescribeSpotPriceHistoryError
{
