...
impl DescribeNetworkInsightsAccessScopesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_network_insights_access_scopes::DescribeNetworkInsightsAccessScopes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNetworkInsightsAccessScopes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_network_insights_access_scopes::de_describe_network_insights_access_scopes_http_response_with_props(
                status, headers, body,
            )
        }
    }
