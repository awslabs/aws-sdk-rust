    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVpcEndpointServiceConfigurations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVpcEndpointServiceConfigurations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVpcEndpointServiceConfigurationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVpcEndpointServiceConfigurationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVpcEndpointServiceConfigurations")
...
.with_interceptor(DeleteVpcEndpointServiceConfigurationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsError>::new());
...
#[derive(Debug)]
            struct DeleteVpcEndpointServiceConfigurationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVpcEndpointServiceConfigurationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_vpc_endpoint_service_configurations::de_delete_vpc_endpoint_service_configurations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_vpc_endpoint_service_configurations::de_delete_vpc_endpoint_service_configurations_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVpcEndpointServiceConfigurationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_vpc_endpoint_service_configurations_input::ser_delete_vpc_endpoint_service_configurations_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteVpcEndpointServiceConfigurationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVpcEndpointServiceConfigurationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteVpcEndpointServiceConfigurationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVpcEndpointServiceConfigurationsInput>()
                        .ok_or("failed to downcast to DeleteVpcEndpointServiceConfigurationsInput")?;
...
/// Error type for the `DeleteVpcEndpointServiceConfigurationsError` operation.
#[non_exhaustive]
...
pub enum DeleteVpcEndpointServiceConfigurationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVpcEndpointServiceConfigurationsError) for what information is available for the error.")]
...
impl DeleteVpcEndpointServiceConfigurationsError {
    /// Creates the `DeleteVpcEndpointServiceConfigurationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVpcEndpointServiceConfigurationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteVpcEndpointServiceConfigurationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVpcEndpointServiceConfigurationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_vpc_endpoint_service_configurations::DeleteVpcEndpointServiceConfigurationsError {
