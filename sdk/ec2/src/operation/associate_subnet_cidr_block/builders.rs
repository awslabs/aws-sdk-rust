...
impl AssociateSubnetCidrBlockFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockOutput, crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockError, Self> {
