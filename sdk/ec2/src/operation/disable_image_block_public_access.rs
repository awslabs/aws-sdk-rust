...
impl DisableImageBlockPublicAccess {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableImageBlockPublicAccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableImageBlockPublicAccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableImageBlockPublicAccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableImageBlockPublicAccessResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableImageBlockPublicAccess")
...
.with_interceptor(DisableImageBlockPublicAccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_disable_image_block_public_access::de_disable_image_block_public_access_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisableImageBlockPublicAccessRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableImageBlockPublicAccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_image_block_public_access::DisableImageBlockPublicAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_image_block_public_access_input::ser_disable_image_block_public_access_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableImageBlockPublicAccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableImageBlockPublicAccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableImageBlockPublicAccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableImageBlockPublicAccessInput>()
                        .ok_or("failed to downcast to DisableImageBlockPublicAccessInput")?;
...
/// Error type for the `DisableImageBlockPublicAccessError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DisableImageBlockPublicAccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableImageBlockPublicAccessError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DisableImageBlockPublicAccessError {
    /// Creates the `DisableImageBlockPublicAccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableImageBlockPublicAccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for DisableImageBlockPublicAccessError {
...
impl ::std::fmt::Display for DisableImageBlockPublicAccessError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DisableImageBlockPublicAccessError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisableImageBlockPublicAccessError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableImageBlockPublicAccessError {
