...
impl AllocateHostsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::allocate_hosts::AllocateHosts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_allocate_hosts_input::ser_allocate_hosts_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AllocateHosts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_allocate_hosts::de_allocate_hosts_http_response_with_props(status, headers, body)
        }
    }
}
