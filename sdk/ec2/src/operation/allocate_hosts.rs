...
impl AllocateHosts {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_hosts::AllocateHostsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_hosts::AllocateHostsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "AllocateHosts", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateHosts {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AllocateHosts", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocateHosts")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(AllocateHostsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AllocateHostsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AllocateHostsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_hosts::AllocateHostsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_allocate_hosts_input::ser_allocate_hosts_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AllocateHostsEndpointParamsInterceptor {
...
pub type AllocateHostsErrorKind = AllocateHostsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AllocateHostsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::allocate_hosts::AllocateHostsError {
...
impl AllocateHostsError {
    ...
    /// Creates the `AllocateHostsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
