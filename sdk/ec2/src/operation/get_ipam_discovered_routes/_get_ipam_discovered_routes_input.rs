...
pub struct GetIpamDiscoveredRoutesInput {
...
impl GetIpamDiscoveredRoutesInput {
    /// <p>Checks whether you have the required permissions for the operation, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
...
impl GetIpamDiscoveredRoutesInput {
    /// Creates a new builder-style object to manufacture [`GetIpamDiscoveredRoutesInput`](crate::operation::get_ipam_discovered_routes::GetIpamDiscoveredRoutesInput).
    pub fn builder() -> crate::operation::get_ipam_discovered_routes::builders::GetIpamDiscoveredRoutesInputBuilder {
        crate::operation::get_ipam_discovered_routes::builders::GetIpamDiscoveredRoutesInputBuilder::default()
    }
}

/// A builder for [`GetIpamDiscoveredRoutesInput`](crate::operation::get_ipam_discovered_routes::GetIpamDiscoveredRoutesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetIpamDiscoveredRoutesInputBuilder {
...
impl GetIpamDiscoveredRoutesInputBuilder {
    /// <p>Checks whether you have the required permissions for the operation, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ...
    /// Consumes the builder and constructs a [`GetIpamDiscoveredRoutesInput`](crate::operation::get_ipam_discovered_routes::GetIpamDiscoveredRoutesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::get_ipam_discovered_routes::GetIpamDiscoveredRoutesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::get_ipam_discovered_routes::GetIpamDiscoveredRoutesInput {
