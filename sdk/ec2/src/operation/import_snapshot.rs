...
impl ImportSnapshotInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_snapshot_input::ser_import_snapshot_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_snapshot::ImportSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_import_snapshot::de_import_snapshot_http_error(
                status, headers, body,
            )
        } else {
