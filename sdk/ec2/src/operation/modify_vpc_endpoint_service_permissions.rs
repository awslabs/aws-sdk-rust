...
impl ModifyVpcEndpointServicePermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_vpc_endpoint_service_permissions::ModifyVpcEndpointServicePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyVpcEndpointServicePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_vpc_endpoint_service_permissions::de_modify_vpc_endpoint_service_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
