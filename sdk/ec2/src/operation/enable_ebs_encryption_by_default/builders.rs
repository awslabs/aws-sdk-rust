...
impl EnableEbsEncryptionByDefaultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultOutput, crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultError, Self> {
