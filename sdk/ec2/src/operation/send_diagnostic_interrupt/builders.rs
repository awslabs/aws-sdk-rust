...
impl SendDiagnosticInterruptFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptOutput, crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptError, Self> {
