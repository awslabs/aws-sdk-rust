...
impl DescribeBundleTasks {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_bundle_tasks::DescribeBundleTasksError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_bundle_tasks::DescribeBundleTasksOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeBundleTasks", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBundleTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeBundleTasks", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBundleTasks")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DescribeBundleTasksEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeBundleTasksResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeBundleTasksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_bundle_tasks::DescribeBundleTasksInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_bundle_tasks::DescribeBundleTasksInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_bundle_tasks_input::ser_describe_bundle_tasks_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeBundleTasksEndpointParamsInterceptor {
...
pub type DescribeBundleTasksErrorKind = DescribeBundleTasksError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeBundleTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_bundle_tasks::DescribeBundleTasksError {
...
impl DescribeBundleTasksError {
    ...
    /// Creates the `DescribeBundleTasksError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
