...
/// Orchestration and serialization glue logic for `CreateTransitGatewayPeeringAttachment`.
...
impl CreateTransitGatewayPeeringAttachment {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentInput,
                    ) -> ::std::result::Result<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTransitGatewayPeeringAttachment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateTransitGatewayPeeringAttachment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateTransitGatewayPeeringAttachmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateTransitGatewayPeeringAttachmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTransitGatewayPeeringAttachment")
...
.with_interceptor(CreateTransitGatewayPeeringAttachmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentError>::new());
...
#[derive(Debug)]
            struct CreateTransitGatewayPeeringAttachmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTransitGatewayPeeringAttachmentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_transit_gateway_peering_attachment::de_create_transit_gateway_peering_attachment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_transit_gateway_peering_attachment::de_create_transit_gateway_peering_attachment_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTransitGatewayPeeringAttachmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_transit_gateway_peering_attachment::CreateTransitGatewayPeeringAttachmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_transit_gateway_peering_attachment_input::ser_create_transit_gateway_peering_attachment_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateTransitGatewayPeeringAttachmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTransitGatewayPeeringAttachmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateTransitGatewayPeeringAttachmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateTransitGatewayPeeringAttachmentInput>()
                        .ok_or("failed to downcast to CreateTransitGatewayPeeringAttachmentInput")?;
...
/// Error type for the `CreateTransitGatewayPeeringAttachmentError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateTransitGatewayPeeringAttachmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateTransitGatewayPeeringAttachmentError) for what information is available for the error.")]
...
impl CreateTransitGatewayPeeringAttachmentError {
    /// Creates the `CreateTransitGatewayPeeringAttachmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTransitGatewayPeeringAttachmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTransitGatewayPeeringAttachmentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateTransitGatewayPeeringAttachmentError {
