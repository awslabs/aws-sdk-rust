...
impl ModifyPrivateDnsNameOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptionsOutput, crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptionsError, Self> {
