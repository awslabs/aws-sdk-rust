...
impl ModifyPrivateDnsNameOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptionsInput, ::aws_smithy_types::error::operation::BuildError> {
