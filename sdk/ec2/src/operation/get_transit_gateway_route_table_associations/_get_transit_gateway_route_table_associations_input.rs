...
impl GetTransitGatewayRouteTableAssociationsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_transit_gateway_route_table_associations::GetTransitGatewayRouteTableAssociationsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
