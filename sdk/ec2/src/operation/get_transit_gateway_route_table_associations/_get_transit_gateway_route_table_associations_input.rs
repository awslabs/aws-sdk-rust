...
impl GetTransitGatewayRouteTableAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_transit_gateway_route_table_associations::GetTransitGatewayRouteTableAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
