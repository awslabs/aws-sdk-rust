...
impl CreateImageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_image_input::ser_create_image_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_image::CreateImage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateImage", "ec2"));
