...
impl DetachVolumeInput {
    /// Consumes the builder and constructs an Operation<[`DetachVolume`](crate::operation::detach_volume::DetachVolume)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_volume::DetachVolume, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_volume::DetachVolumeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_volume_input::ser_detach_volume_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_volume::DetachVolume::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachVolume", "ec2"));
...
impl aws_smithy_http::response::ParseStrictResponse for DetachVolume {
                type Output = std::result::Result<crate::operation::detach_volume::DetachVolumeOutput, crate::operation::detach_volume::DetachVolumeError>;
