...
impl DescribeFpgaImagesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fpga_images::DescribeFpgaImages::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFpgaImages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_fpga_images::de_describe_fpga_images_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_fpga_images::DescribeFpgaImagesError
{
