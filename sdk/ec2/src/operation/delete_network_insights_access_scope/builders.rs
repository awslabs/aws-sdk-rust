...
impl crate::operation::delete_network_insights_access_scope::builders::DeleteNetworkInsightsAccessScopeInputBuilder {
...
impl DeleteNetworkInsightsAccessScopeFluentBuilder {
    /// Creates a new `DeleteNetworkInsightsAccessScopeFluentBuilder`.
