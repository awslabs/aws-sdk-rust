...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpcClassicLinkDnsSupport {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeVpcClassicLinkDnsSupport", "ec2"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVpcClassicLinkDnsSupport")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeVpcClassicLinkDnsSupportResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeVpcClassicLinkDnsSupportRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpc_classic_link_dns_support_input::ser_describe_vpc_classic_link_dns_support_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeVpcClassicLinkDnsSupportEndpointParamsInterceptor {
...
pub type DescribeVpcClassicLinkDnsSupportErrorKind = DescribeVpcClassicLinkDnsSupportError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeVpcClassicLinkDnsSupportError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError {
...
impl DescribeVpcClassicLinkDnsSupportError {
    ...
    /// Creates the `DescribeVpcClassicLinkDnsSupportError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
