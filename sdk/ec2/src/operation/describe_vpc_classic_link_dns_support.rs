...
impl DescribeVpcClassicLinkDnsSupportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVpcClassicLinkDnsSupport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vpc_classic_link_dns_support::de_describe_vpc_classic_link_dns_support_http_response_with_props(
                status, headers, body,
            )
        }
    }
