...
impl EnableEbsEncryptionByDefault {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "EnableEbsEncryptionByDefault", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableEbsEncryptionByDefault {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            EnableEbsEncryptionByDefaultRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            EnableEbsEncryptionByDefaultResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("EnableEbsEncryptionByDefault", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableEbsEncryptionByDefault")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for EnableEbsEncryptionByDefaultResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for EnableEbsEncryptionByDefaultRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_ebs_encryption_by_default_input::ser_enable_ebs_encryption_by_default_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for EnableEbsEncryptionByDefaultEndpointParamsInterceptor {
...
pub type EnableEbsEncryptionByDefaultErrorKind = EnableEbsEncryptionByDefaultError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for EnableEbsEncryptionByDefaultError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_ebs_encryption_by_default::EnableEbsEncryptionByDefaultError {
...
impl EnableEbsEncryptionByDefaultError {
    ...
    /// Creates the `EnableEbsEncryptionByDefaultError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
