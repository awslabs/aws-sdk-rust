...
impl GetManagedPrefixListAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_managed_prefix_list_associations::GetManagedPrefixListAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
