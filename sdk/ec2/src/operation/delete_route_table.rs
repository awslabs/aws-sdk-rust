...
impl DeleteRouteTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_route_table::DeleteRouteTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRouteTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_route_table::de_delete_route_table_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_route_table::DeleteRouteTableError
{
