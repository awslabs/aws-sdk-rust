...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableOutput,
                    crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableError,
                > for AssociateTransitGatewayRouteTableFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateTransitGatewayRouteTableFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTable::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTable::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableOutput, crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableError, Self> {
