...
impl AssociateTransitGatewayRouteTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTableInput, ::aws_smithy_types::error::operation::BuildError> {
