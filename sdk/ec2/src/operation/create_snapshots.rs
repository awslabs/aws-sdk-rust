...
impl CreateSnapshotsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_snapshots::CreateSnapshots, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSnapshots {
    type Output =
        ::std::result::Result<crate::operation::create_snapshots::CreateSnapshotsOutput, crate::operation::create_snapshots::CreateSnapshotsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_snapshots::de_create_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
