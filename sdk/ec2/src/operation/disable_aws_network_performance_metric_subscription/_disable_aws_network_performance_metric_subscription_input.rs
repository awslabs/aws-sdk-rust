...
impl DisableAwsNetworkPerformanceMetricSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_aws_network_performance_metric_subscription::DisableAwsNetworkPerformanceMetricSubscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
