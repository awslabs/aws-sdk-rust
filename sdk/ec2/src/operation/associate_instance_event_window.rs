...
impl AssociateInstanceEventWindowInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_instance_event_window::AssociateInstanceEventWindow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateInstanceEventWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_instance_event_window::de_associate_instance_event_window_http_response_with_props(
                status, headers, body,
            )
        }
    }
