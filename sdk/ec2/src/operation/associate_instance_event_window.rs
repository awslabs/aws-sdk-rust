    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateInstanceEventWindow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AssociateInstanceEventWindow", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateInstanceEventWindow")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateInstanceEventWindowResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateInstanceEventWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_instance_event_window_input::ser_associate_instance_event_window_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateInstanceEventWindowEndpointParamsInterceptor {
...
pub type AssociateInstanceEventWindowErrorKind = AssociateInstanceEventWindowError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateInstanceEventWindowError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_instance_event_window::AssociateInstanceEventWindowError {
...
impl AssociateInstanceEventWindowError {
    ...
    /// Creates the `AssociateInstanceEventWindowError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
