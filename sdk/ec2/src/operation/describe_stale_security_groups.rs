    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroupsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroupsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeStaleSecurityGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeStaleSecurityGroups", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeStaleSecurityGroups")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeStaleSecurityGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeStaleSecurityGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroupsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_stale_security_groups_input::ser_describe_stale_security_groups_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeStaleSecurityGroupsEndpointParamsInterceptor {
...
pub type DescribeStaleSecurityGroupsErrorKind = DescribeStaleSecurityGroupsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeStaleSecurityGroupsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroupsError {
...
impl DescribeStaleSecurityGroupsError {
    ...
    /// Creates the `DescribeStaleSecurityGroupsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
