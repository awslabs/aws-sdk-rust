...
impl DescribeStaleSecurityGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStaleSecurityGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_stale_security_groups::de_describe_stale_security_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
