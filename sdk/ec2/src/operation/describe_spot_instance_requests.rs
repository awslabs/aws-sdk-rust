...
impl DescribeSpotInstanceRequestsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequests::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpotInstanceRequests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_spot_instance_requests::de_describe_spot_instance_requests_http_response_with_props(
                status, headers, body,
            )
        }
    }
