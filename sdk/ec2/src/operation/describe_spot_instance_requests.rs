...
impl DescribeSpotInstanceRequests {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeSpotInstanceRequests", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSpotInstanceRequests {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            DescribeSpotInstanceRequestsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            DescribeSpotInstanceRequestsResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSpotInstanceRequests", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSpotInstanceRequests")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSpotInstanceRequestsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSpotInstanceRequestsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_instance_requests_input::ser_describe_spot_instance_requests_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSpotInstanceRequestsEndpointParamsInterceptor {
...
pub type DescribeSpotInstanceRequestsErrorKind = DescribeSpotInstanceRequestsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSpotInstanceRequestsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsError {
...
impl DescribeSpotInstanceRequestsError {
    ...
    /// Creates the `DescribeSpotInstanceRequestsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
