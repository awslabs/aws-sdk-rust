...
impl DescribeRegionsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_regions_input::ser_describe_regions_input_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_regions::DescribeRegions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRegions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_regions::de_describe_regions_http_error(
                status, headers, body,
            )
        } else {
