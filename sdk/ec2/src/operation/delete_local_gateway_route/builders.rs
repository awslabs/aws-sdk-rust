...
impl DeleteLocalGatewayRouteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteOutput, crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteError, Self> {
