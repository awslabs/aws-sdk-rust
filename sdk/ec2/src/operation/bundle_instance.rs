...
impl BundleInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::bundle_instance::BundleInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for BundleInstance {
    type Output =
        ::std::result::Result<crate::operation::bundle_instance::BundleInstanceOutput, crate::operation::bundle_instance::BundleInstanceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_bundle_instance::de_bundle_instance_http_response_with_props(status, headers, body)
        }
    }
}
