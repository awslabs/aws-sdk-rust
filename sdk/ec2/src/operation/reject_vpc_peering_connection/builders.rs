...
impl crate::operation::reject_vpc_peering_connection::builders::RejectVpcPeeringConnectionInputBuilder {
...
impl RejectVpcPeeringConnectionFluentBuilder {
    /// Creates a new `RejectVpcPeeringConnectionFluentBuilder`.
