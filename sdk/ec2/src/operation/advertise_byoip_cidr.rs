...
impl AdvertiseByoipCidrInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidr, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_advertise_byoip_cidr_input::ser_advertise_byoip_cidr_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::advertise_byoip_cidr::AdvertiseByoipCidr::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdvertiseByoipCidr", "ec2"));
