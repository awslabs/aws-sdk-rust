...
impl DescribeHostReservationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_host_reservations::DescribeHostReservationsInput, ::aws_smithy_types::error::operation::BuildError> {
