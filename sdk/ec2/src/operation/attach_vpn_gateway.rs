...
impl AttachVpnGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::attach_vpn_gateway::AttachVpnGateway,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachVpnGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_vpn_gateway::de_attach_vpn_gateway_http_response_with_props(status, headers, body)
        }
    }
}
