...
impl AttachVpnGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::attach_vpn_gateway::AttachVpnGatewayError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::attach_vpn_gateway::AttachVpnGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "AttachVpnGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachVpnGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AttachVpnGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachVpnGateway")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(AttachVpnGatewayEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AttachVpnGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AttachVpnGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::attach_vpn_gateway::AttachVpnGatewayInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_attach_vpn_gateway_input::ser_attach_vpn_gateway_input_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AttachVpnGatewayEndpointParamsInterceptor {
...
pub type AttachVpnGatewayErrorKind = AttachVpnGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AttachVpnGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_vpn_gateway::AttachVpnGatewayError {
...
impl AttachVpnGatewayError {
    ...
    /// Creates the `AttachVpnGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
