...
/// <li>
/// <p><b>Application status checks</b> - Amazon EC2 reports application-level health status for instances, indicating whether applications running on the instance are functioning properly.</p></li>
/// <li>
