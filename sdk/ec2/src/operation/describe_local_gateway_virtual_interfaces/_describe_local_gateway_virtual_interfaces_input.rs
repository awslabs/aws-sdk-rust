...
impl DescribeLocalGatewayVirtualInterfacesInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_local_gateway_virtual_interfaces::DescribeLocalGatewayVirtualInterfacesInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
