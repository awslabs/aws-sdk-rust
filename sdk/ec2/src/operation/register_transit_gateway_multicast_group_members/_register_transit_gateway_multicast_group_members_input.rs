...
impl RegisterTransitGatewayMulticastGroupMembersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::register_transit_gateway_multicast_group_members::RegisterTransitGatewayMulticastGroupMembersInput, ::aws_smithy_http::operation::error::BuildError>{
