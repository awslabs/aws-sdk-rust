...
impl DescribeIdentityIdFormatInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_identity_id_format::DescribeIdentityIdFormatInput, ::aws_smithy_types::error::operation::BuildError> {
