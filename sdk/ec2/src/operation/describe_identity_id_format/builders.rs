...
impl DescribeIdentityIdFormatFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_identity_id_format::DescribeIdentityIdFormatOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_identity_id_format::DescribeIdentityIdFormatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_identity_id_format::DescribeIdentityIdFormatOutput, crate::operation::describe_identity_id_format::DescribeIdentityIdFormatError, Self> {
