...
/// Paginator for [`DescribePrincipalIdFormat`](crate::operation::describe_principal_id_format::DescribePrincipalIdFormat)
                ...
                impl DescribePrincipalIdFormatPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::describe_principal_id_format::builders::DescribePrincipalIdFormatInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::describe_principal_id_format::DescribePrincipalIdFormat::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `DescribePrincipalIdFormatPaginator`
                    ...
                    impl DescribePrincipalIdFormatPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::PrincipalIdFormat, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_principal_id_format_output_output_principals(page).unwrap_or_default().into_iter())
                        }
                    }
