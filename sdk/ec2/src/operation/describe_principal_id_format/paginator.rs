...
/// Paginator for [`DescribePrincipalIdFormat`](crate::operation::describe_principal_id_format::DescribePrincipalIdFormat)
            ...
            impl DescribePrincipalIdFormatPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatOutput, aws_smithy_http::result::SdkError<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribePrincipalIdFormatPaginator`
                ...
                impl  DescribePrincipalIdFormatPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::PrincipalIdFormat, aws_smithy_http::result::SdkError<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatError>>> + Unpin
                     {
