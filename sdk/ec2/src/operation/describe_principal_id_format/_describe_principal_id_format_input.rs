...
impl DescribePrincipalIdFormatInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_principal_id_format::DescribePrincipalIdFormatInput, ::aws_smithy_types::error::operation::BuildError> {
