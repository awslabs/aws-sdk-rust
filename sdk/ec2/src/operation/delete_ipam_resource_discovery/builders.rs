...
impl DeleteIpamResourceDiscoveryFluentBuilder  {
    /// Creates a new `DeleteIpamResourceDiscovery`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscovery, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryOutput, aws_smithy_http::result::SdkError<crate::operation::delete_ipam_resource_discovery::DeleteIpamResourceDiscoveryError>>
                     {
