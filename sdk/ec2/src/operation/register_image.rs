...
impl RegisterImageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_image::RegisterImage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_image_input::ser_register_image_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_image::de_register_image_http_response_with_props(status, headers, body)
        }
    }
}
