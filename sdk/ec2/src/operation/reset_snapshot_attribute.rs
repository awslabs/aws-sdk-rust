...
impl ResetSnapshotAttribute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_snapshot_attribute::ResetSnapshotAttributeError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_snapshot_attribute::ResetSnapshotAttributeOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ResetSnapshotAttribute", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetSnapshotAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ResetSnapshotAttribute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetSnapshotAttribute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ResetSnapshotAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ResetSnapshotAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_snapshot_attribute::ResetSnapshotAttributeInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_snapshot_attribute_input::ser_reset_snapshot_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ResetSnapshotAttributeEndpointParamsInterceptor {
...
pub type ResetSnapshotAttributeErrorKind = ResetSnapshotAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResetSnapshotAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_snapshot_attribute::ResetSnapshotAttributeError {
...
impl ResetSnapshotAttributeError {
    ...
    /// Creates the `ResetSnapshotAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
