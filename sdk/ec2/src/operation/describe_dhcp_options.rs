...
impl DescribeDhcpOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_dhcp_options::DescribeDhcpOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDhcpOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_dhcp_options::de_describe_dhcp_options_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_dhcp_options::DescribeDhcpOptionsError
{
