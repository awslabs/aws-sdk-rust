...
impl DeleteInternetGatewayFluentBuilder  {
    /// Creates a new `DeleteInternetGateway`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_internet_gateway::DeleteInternetGatewayOutput, aws_smithy_http::result::SdkError<crate::operation::delete_internet_gateway::DeleteInternetGatewayError>>
                     {
