...
impl DescribeSnapshotTierStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_snapshot_tier_status::DescribeSnapshotTierStatusInput, ::aws_smithy_types::error::operation::BuildError> {
