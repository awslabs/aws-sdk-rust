    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartNetworkInsightsAnalysis {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartNetworkInsightsAnalysis", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartNetworkInsightsAnalysis")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartNetworkInsightsAnalysisResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartNetworkInsightsAnalysisRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_network_insights_analysis_input::ser_start_network_insights_analysis_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartNetworkInsightsAnalysisEndpointParamsInterceptor {
...
pub type StartNetworkInsightsAnalysisErrorKind = StartNetworkInsightsAnalysisError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartNetworkInsightsAnalysisError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisError {
...
impl StartNetworkInsightsAnalysisError {
    ...
    /// Creates the `StartNetworkInsightsAnalysisError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
