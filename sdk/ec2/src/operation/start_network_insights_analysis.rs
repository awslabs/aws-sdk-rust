...
impl StartNetworkInsightsAnalysisInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysis::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartNetworkInsightsAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_network_insights_analysis::de_start_network_insights_analysis_http_response_with_props(
                status, headers, body,
            )
        }
    }
