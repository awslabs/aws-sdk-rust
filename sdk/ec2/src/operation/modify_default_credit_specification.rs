...
impl ModifyDefaultCreditSpecificationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_default_credit_specification::ModifyDefaultCreditSpecification::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyDefaultCreditSpecification {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_default_credit_specification::de_modify_default_credit_specification_http_response_with_props(
                status, headers, body,
            )
        }
    }
