...
impl DescribeSecurityGroups {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_security_groups::DescribeSecurityGroupsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_security_groups::DescribeSecurityGroupsOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeSecurityGroups", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSecurityGroups {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSecurityGroups", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSecurityGroups")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSecurityGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSecurityGroupsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_security_groups::DescribeSecurityGroupsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_security_groups_input::ser_describe_security_groups_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSecurityGroupsEndpointParamsInterceptor {
...
pub type DescribeSecurityGroupsErrorKind = DescribeSecurityGroupsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSecurityGroupsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_security_groups::DescribeSecurityGroupsError {
...
impl DescribeSecurityGroupsError {
    ...
    /// Creates the `DescribeSecurityGroupsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
