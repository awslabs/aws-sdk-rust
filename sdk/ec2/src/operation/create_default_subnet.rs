...
impl CreateDefaultSubnet {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_default_subnet::CreateDefaultSubnetError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_default_subnet::CreateDefaultSubnetOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateDefaultSubnet", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDefaultSubnet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateDefaultSubnet", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDefaultSubnet")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreateDefaultSubnetEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateDefaultSubnetResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateDefaultSubnetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_default_subnet::CreateDefaultSubnetInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_default_subnet_input::ser_create_default_subnet_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateDefaultSubnetEndpointParamsInterceptor {
...
pub type CreateDefaultSubnetErrorKind = CreateDefaultSubnetError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateDefaultSubnetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_default_subnet::CreateDefaultSubnetError {
...
impl CreateDefaultSubnetError {
    ...
    /// Creates the `CreateDefaultSubnetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
