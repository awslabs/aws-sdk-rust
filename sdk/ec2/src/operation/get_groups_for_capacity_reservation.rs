...
impl GetGroupsForCapacityReservationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_groups_for_capacity_reservation::GetGroupsForCapacityReservation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupsForCapacityReservation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_groups_for_capacity_reservation::de_get_groups_for_capacity_reservation_http_response_with_props(
                status, headers, body,
            )
        }
    }
