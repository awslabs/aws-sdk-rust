...
/// Orchestration and serialization glue logic for `AcceptReservedInstancesExchangeQuote`.
...
impl AcceptReservedInstancesExchangeQuote {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptReservedInstancesExchangeQuote {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptReservedInstancesExchangeQuote");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptReservedInstancesExchangeQuoteRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptReservedInstancesExchangeQuoteResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptReservedInstancesExchangeQuote")
...
.with_interceptor(AcceptReservedInstancesExchangeQuoteEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError>::new());
...
#[derive(Debug)]
            struct AcceptReservedInstancesExchangeQuoteResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptReservedInstancesExchangeQuoteResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_reserved_instances_exchange_quote::de_accept_reserved_instances_exchange_quote_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_accept_reserved_instances_exchange_quote::de_accept_reserved_instances_exchange_quote_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptReservedInstancesExchangeQuoteRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptReservedInstancesExchangeQuoteEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptReservedInstancesExchangeQuoteInput>()
                        .ok_or("failed to downcast to AcceptReservedInstancesExchangeQuoteInput")?;
...
pub enum AcceptReservedInstancesExchangeQuoteError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptReservedInstancesExchangeQuoteError) for what information is available for the error.")]
...
impl AcceptReservedInstancesExchangeQuoteError {
    /// Creates the `AcceptReservedInstancesExchangeQuoteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptReservedInstancesExchangeQuoteError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AcceptReservedInstancesExchangeQuoteError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptReservedInstancesExchangeQuoteError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::accept_reserved_instances_exchange_quote::_accept_reserved_instances_exchange_quote_output::AcceptReservedInstancesExchangeQuoteOutput;

pub use crate::operation::accept_reserved_instances_exchange_quote::_accept_reserved_instances_exchange_quote_input::AcceptReservedInstancesExchangeQuoteInput;

mod _accept_reserved_instances_exchange_quote_input;

mod _accept_reserved_instances_exchange_quote_output;
