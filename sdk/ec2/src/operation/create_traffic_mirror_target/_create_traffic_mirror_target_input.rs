...
impl CreateTrafficMirrorTargetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetInput, ::aws_smithy_types::error::operation::BuildError> {
