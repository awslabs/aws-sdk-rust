...
impl GetTransitGatewayPrefixListReferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesInput, ::aws_smithy_types::error::operation::BuildError> {
