...
impl ModifyEbsDefaultKmsKeyIdInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyId::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyEbsDefaultKmsKeyId {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_ebs_default_kms_key_id::de_modify_ebs_default_kms_key_id_http_response_with_props(
                status, headers, body,
            )
        }
    }
