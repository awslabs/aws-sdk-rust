...
impl ModifyEbsDefaultKmsKeyId {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyEbsDefaultKmsKeyId {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyEbsDefaultKmsKeyId");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyEbsDefaultKmsKeyIdRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyEbsDefaultKmsKeyIdResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyEbsDefaultKmsKeyId")
...
.with_interceptor(ModifyEbsDefaultKmsKeyIdEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_modify_ebs_default_kms_key_id::de_modify_ebs_default_kms_key_id_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyEbsDefaultKmsKeyIdRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_ebs_default_kms_key_id_input::ser_modify_ebs_default_kms_key_id_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyEbsDefaultKmsKeyIdEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyEbsDefaultKmsKeyIdEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyEbsDefaultKmsKeyIdEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyEbsDefaultKmsKeyIdInput>()
                        .ok_or("failed to downcast to ModifyEbsDefaultKmsKeyIdInput")?;
...
pub enum ModifyEbsDefaultKmsKeyIdError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyEbsDefaultKmsKeyIdError) for what information is available for the error.")]
...
impl ModifyEbsDefaultKmsKeyIdError {
    /// Creates the `ModifyEbsDefaultKmsKeyIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyEbsDefaultKmsKeyIdError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyEbsDefaultKmsKeyIdError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError {
