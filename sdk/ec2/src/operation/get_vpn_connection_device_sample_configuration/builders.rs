...
impl crate::operation::get_vpn_connection_device_sample_configuration::builders::GetVpnConnectionDeviceSampleConfigurationInputBuilder {
...
impl GetVpnConnectionDeviceSampleConfigurationFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_vpn_connection_device_sample_configuration::GetVpnConnectionDeviceSampleConfiguration::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::get_vpn_connection_device_sample_configuration::GetVpnConnectionDeviceSampleConfiguration::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
