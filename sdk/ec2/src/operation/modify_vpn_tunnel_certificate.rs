...
impl ModifyVpnTunnelCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyVpnTunnelCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_vpn_tunnel_certificate::de_modify_vpn_tunnel_certificate_http_response_with_props(
                status, headers, body,
            )
        }
    }
