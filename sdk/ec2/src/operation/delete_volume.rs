...
impl DeleteVolumeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_volume_input::ser_delete_volume_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_volume::DeleteVolume::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVolume", "ec2"));
