...
impl DescribeCustomerGatewaysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_customer_gateways::DescribeCustomerGatewaysInput, ::aws_smithy_types::error::operation::BuildError> {
