...
impl DescribeCustomerGatewaysFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_customer_gateways::DescribeCustomerGatewaysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_customer_gateways::DescribeCustomerGatewaysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_customer_gateways::DescribeCustomerGatewaysOutput, crate::operation::describe_customer_gateways::DescribeCustomerGatewaysError, Self> {
