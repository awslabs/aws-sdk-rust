...
impl CreateInstanceConnectEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_instance_connect_endpoint::CreateInstanceConnectEndpointInput, ::aws_smithy_types::error::operation::BuildError> {
