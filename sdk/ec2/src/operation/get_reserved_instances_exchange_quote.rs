...
impl GetReservedInstancesExchangeQuoteInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuote::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReservedInstancesExchangeQuote {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_reserved_instances_exchange_quote::de_get_reserved_instances_exchange_quote_http_response_with_props(
                status, headers, body,
            )
        }
    }
