    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_snapshot_tier_status::DescribeSnapshotTierStatusError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_snapshot_tier_status::DescribeSnapshotTierStatusOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSnapshotTierStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSnapshotTierStatus", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSnapshotTierStatus")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSnapshotTierStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSnapshotTierStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_snapshot_tier_status::DescribeSnapshotTierStatusInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_snapshot_tier_status_input::ser_describe_snapshot_tier_status_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSnapshotTierStatusEndpointParamsInterceptor {
...
pub type DescribeSnapshotTierStatusErrorKind = DescribeSnapshotTierStatusError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSnapshotTierStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_snapshot_tier_status::DescribeSnapshotTierStatusError {
...
impl DescribeSnapshotTierStatusError {
    ...
    /// Creates the `DescribeSnapshotTierStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
