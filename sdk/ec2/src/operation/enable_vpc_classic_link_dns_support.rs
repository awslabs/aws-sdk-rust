...
impl EnableVpcClassicLinkDnsSupportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableVpcClassicLinkDnsSupport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_vpc_classic_link_dns_support::de_enable_vpc_classic_link_dns_support_http_response_with_props(
                status, headers, body,
            )
        }
    }
