...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_capacity_reservation_input::ser_create_capacity_reservation_input_input_input(&input)?);
