...
impl crate::operation::describe_client_vpn_connections::builders::DescribeClientVpnConnectionsInputBuilder {
...
impl DescribeClientVpnConnectionsFluentBuilder {
    /// Creates a new `DescribeClientVpnConnectionsFluentBuilder`.
