...
impl DescribeClientVpnConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_client_vpn_connections::DescribeClientVpnConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
