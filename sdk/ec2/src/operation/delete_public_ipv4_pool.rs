...
impl DeletePublicIpv4Pool {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_public_ipv4_pool::DeletePublicIpv4PoolError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_public_ipv4_pool::DeletePublicIpv4PoolOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeletePublicIpv4Pool", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeletePublicIpv4Pool {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeletePublicIpv4Pool", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeletePublicIpv4Pool")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeletePublicIpv4PoolResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeletePublicIpv4PoolRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_public_ipv4_pool::DeletePublicIpv4PoolInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_public_ipv4_pool_input::ser_delete_public_ipv4_pool_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeletePublicIpv4PoolEndpointParamsInterceptor {
...
pub type DeletePublicIpv4PoolErrorKind = DeletePublicIpv4PoolError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeletePublicIpv4PoolError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_public_ipv4_pool::DeletePublicIpv4PoolError {
...
impl DeletePublicIpv4PoolError {
    ...
    /// Creates the `DeletePublicIpv4PoolError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
