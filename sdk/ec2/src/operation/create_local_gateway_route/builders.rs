...
impl CreateLocalGatewayRouteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteOutput, crate::operation::create_local_gateway_route::CreateLocalGatewayRouteError, Self> {
