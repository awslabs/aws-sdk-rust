...
pub use crate::operation::describe_client_vpn_routes::_describe_client_vpn_routes_output::DescribeClientVpnRoutesOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesOutput,
                    crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesError,
                > for DescribeClientVpnRoutesFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeClientVpnRoutesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::describe_client_vpn_routes::builders::DescribeClientVpnRoutesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutes::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutes::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesOutput, crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_client_vpn_routes::paginator::DescribeClientVpnRoutesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
