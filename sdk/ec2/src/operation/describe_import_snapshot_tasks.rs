    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_import_snapshot_tasks::DescribeImportSnapshotTasksError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_import_snapshot_tasks::DescribeImportSnapshotTasksOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeImportSnapshotTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeImportSnapshotTasks", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeImportSnapshotTasks")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeImportSnapshotTasksResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeImportSnapshotTasksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_import_snapshot_tasks::DescribeImportSnapshotTasksInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_import_snapshot_tasks_input::ser_describe_import_snapshot_tasks_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeImportSnapshotTasksEndpointParamsInterceptor {
...
pub type DescribeImportSnapshotTasksErrorKind = DescribeImportSnapshotTasksError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeImportSnapshotTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_import_snapshot_tasks::DescribeImportSnapshotTasksError {
...
impl DescribeImportSnapshotTasksError {
    ...
    /// Creates the `DescribeImportSnapshotTasksError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
