...
impl DescribeImportSnapshotTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_import_snapshot_tasks::DescribeImportSnapshotTasks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImportSnapshotTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_import_snapshot_tasks::de_describe_import_snapshot_tasks_http_response_with_props(
                status, headers, body,
            )
        }
    }
