...
impl DeleteSpotDatafeedSubscription {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSpotDatafeedSubscription {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSpotDatafeedSubscription");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSpotDatafeedSubscriptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSpotDatafeedSubscriptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSpotDatafeedSubscription")
...
.with_interceptor(DeleteSpotDatafeedSubscriptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_delete_spot_datafeed_subscription::de_delete_spot_datafeed_subscription_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSpotDatafeedSubscriptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_spot_datafeed_subscription_input::ser_delete_spot_datafeed_subscription_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteSpotDatafeedSubscriptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSpotDatafeedSubscriptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSpotDatafeedSubscriptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSpotDatafeedSubscriptionInput>()
                        .ok_or("failed to downcast to DeleteSpotDatafeedSubscriptionInput")?;
...
/// Error type for the `DeleteSpotDatafeedSubscriptionError` operation.
#[non_exhaustive]
...
pub enum DeleteSpotDatafeedSubscriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSpotDatafeedSubscriptionError) for what information is available for the error.")]
...
impl DeleteSpotDatafeedSubscriptionError {
    /// Creates the `DeleteSpotDatafeedSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSpotDatafeedSubscriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteSpotDatafeedSubscriptionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSpotDatafeedSubscriptionError {
