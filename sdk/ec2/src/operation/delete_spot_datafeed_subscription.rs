...
impl DeleteSpotDatafeedSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_spot_datafeed_subscription::DeleteSpotDatafeedSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSpotDatafeedSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_spot_datafeed_subscription::de_delete_spot_datafeed_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
