...
impl RejectVpcEndpointConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_vpc_endpoint_connections::RejectVpcEndpointConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
