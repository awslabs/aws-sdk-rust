...
impl GetEbsEncryptionByDefaultInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultInput, ::aws_smithy_types::error::operation::BuildError> {
