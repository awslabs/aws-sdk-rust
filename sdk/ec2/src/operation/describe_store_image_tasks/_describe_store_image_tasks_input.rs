...
impl DescribeStoreImageTasksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_store_image_tasks::DescribeStoreImageTasksInput, ::aws_smithy_types::error::operation::BuildError> {
