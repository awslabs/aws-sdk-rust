...
impl DeleteClientVpnEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteClientVpnEndpoint", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteClientVpnEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteClientVpnEndpoint", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteClientVpnEndpoint")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteClientVpnEndpointResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteClientVpnEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_client_vpn_endpoint_input::ser_delete_client_vpn_endpoint_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteClientVpnEndpointEndpointParamsInterceptor {
...
pub type DeleteClientVpnEndpointErrorKind = DeleteClientVpnEndpointError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteClientVpnEndpointError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointError {
...
impl DeleteClientVpnEndpointError {
    ...
    /// Creates the `DeleteClientVpnEndpointError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
