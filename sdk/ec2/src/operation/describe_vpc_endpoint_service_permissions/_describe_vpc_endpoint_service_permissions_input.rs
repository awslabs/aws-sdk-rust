...
impl DescribeVpcEndpointServicePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_vpc_endpoint_service_permissions::DescribeVpcEndpointServicePermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
