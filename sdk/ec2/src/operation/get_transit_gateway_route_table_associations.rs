...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTransitGatewayRouteTableAssociations {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTransitGatewayRouteTableAssociations")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetTransitGatewayRouteTableAssociationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetTransitGatewayRouteTableAssociationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_transit_gateway_route_table_associations_input::ser_get_transit_gateway_route_table_associations_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetTransitGatewayRouteTableAssociationsEndpointParamsInterceptor {
...
pub type GetTransitGatewayRouteTableAssociationsErrorKind = GetTransitGatewayRouteTableAssociationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetTransitGatewayRouteTableAssociationsError {
...
impl GetTransitGatewayRouteTableAssociationsError {
    ...
    /// Creates the `GetTransitGatewayRouteTableAssociationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
