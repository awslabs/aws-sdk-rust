...
impl DisassociateTrunkInterfaceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_trunk_interface::DisassociateTrunkInterface::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateTrunkInterface {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_trunk_interface::de_disassociate_trunk_interface_http_response_with_props(status, headers, body)
        }
    }
}
