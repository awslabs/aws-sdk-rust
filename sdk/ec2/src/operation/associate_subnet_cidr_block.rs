...
impl AssociateSubnetCidrBlockInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlock::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateSubnetCidrBlock {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_subnet_cidr_block::de_associate_subnet_cidr_block_http_response_with_props(status, headers, body)
        }
    }
}
