...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CreateLocalGatewayRouteTableVpcAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateLocalGatewayRouteTableVpcAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_local_gateway_route_table_vpc_association_input::ser_create_local_gateway_route_table_vpc_association_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateLocalGatewayRouteTableVpcAssociationEndpointParamsInterceptor {
...
pub type CreateLocalGatewayRouteTableVpcAssociationErrorKind = CreateLocalGatewayRouteTableVpcAssociationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateLocalGatewayRouteTableVpcAssociationError {
...
impl CreateLocalGatewayRouteTableVpcAssociationError {
    ...
    /// Creates the `CreateLocalGatewayRouteTableVpcAssociationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
