...
impl DeleteInstanceEventWindowFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_instance_event_window::DeleteInstanceEventWindowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_instance_event_window::DeleteInstanceEventWindowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_instance_event_window::DeleteInstanceEventWindowOutput, crate::operation::delete_instance_event_window::DeleteInstanceEventWindowError, Self> {
