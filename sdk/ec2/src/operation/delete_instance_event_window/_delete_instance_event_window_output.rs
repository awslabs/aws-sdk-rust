...
impl DeleteInstanceEventWindowOutputBuilder {
    ...
    pub fn instance_event_window_state(
        mut self,
        input: crate::types::InstanceEventWindowStateChange,
    ) -> Self {
        self.instance_event_window_state = ::std::option::Option::Some(input);
        self
    }
    /// <p>The state of the event window.</p>
    pub fn set_instance_event_window_state(
        mut self,
        input: ::std::option::Option<crate::types::InstanceEventWindowStateChange>,
    ) -> Self {
