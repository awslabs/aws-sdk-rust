...
impl GetDefaultCreditSpecification {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDefaultCreditSpecification {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDefaultCreditSpecification");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDefaultCreditSpecificationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDefaultCreditSpecificationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDefaultCreditSpecification")
...
.with_interceptor(GetDefaultCreditSpecificationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDefaultCreditSpecificationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_default_credit_specification_input::ser_get_default_credit_specification_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetDefaultCreditSpecificationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDefaultCreditSpecificationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDefaultCreditSpecificationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDefaultCreditSpecificationInput>()
                        .ok_or("failed to downcast to GetDefaultCreditSpecificationInput")?;
...
pub enum GetDefaultCreditSpecificationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDefaultCreditSpecificationError) for what information is available for the error.")]
...
impl GetDefaultCreditSpecificationError {
    /// Creates the `GetDefaultCreditSpecificationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDefaultCreditSpecificationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDefaultCreditSpecificationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError {
