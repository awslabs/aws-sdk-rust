...
impl AssociateTrunkInterfaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_trunk_interface::AssociateTrunkInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_trunk_interface::AssociateTrunkInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_trunk_interface::AssociateTrunkInterfaceOutput, crate::operation::associate_trunk_interface::AssociateTrunkInterfaceError, Self> {
