    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVpnConnectionRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteVpnConnectionRoute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVpnConnectionRoute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteVpnConnectionRouteResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteVpnConnectionRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_vpn_connection_route_input::ser_delete_vpn_connection_route_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteVpnConnectionRouteEndpointParamsInterceptor {
...
pub type DeleteVpnConnectionRouteErrorKind = DeleteVpnConnectionRouteError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteVpnConnectionRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError {
...
impl DeleteVpnConnectionRouteError {
    ...
    /// Creates the `DeleteVpnConnectionRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
