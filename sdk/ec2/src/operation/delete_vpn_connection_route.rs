...
impl DeleteVpnConnectionRouteInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRoute,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRoute::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpnConnectionRoute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpn_connection_route::de_delete_vpn_connection_route_http_response_with_props(status, headers, body)
        }
    }
}
