...
/// Orchestration and serialization glue logic for `DeleteVpnConnectionRoute`.
...
impl DeleteVpnConnectionRoute {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVpnConnectionRoute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVpnConnectionRoute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVpnConnectionRouteRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVpnConnectionRouteResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVpnConnectionRoute")
...
.with_interceptor(DeleteVpnConnectionRouteEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError>::new());
...
#[derive(Debug)]
            struct DeleteVpnConnectionRouteResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVpnConnectionRouteResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_vpn_connection_route::de_delete_vpn_connection_route_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_vpn_connection_route::de_delete_vpn_connection_route_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVpnConnectionRouteRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_vpn_connection_route_input::ser_delete_vpn_connection_route_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteVpnConnectionRouteEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVpnConnectionRouteEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteVpnConnectionRouteEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVpnConnectionRouteInput>()
                        .ok_or("failed to downcast to DeleteVpnConnectionRouteInput")?;
...
/// Error type for the `DeleteVpnConnectionRouteError` operation.
#[non_exhaustive]
...
pub enum DeleteVpnConnectionRouteError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVpnConnectionRouteError) for what information is available for the error.")]
...
impl DeleteVpnConnectionRouteError {
    /// Creates the `DeleteVpnConnectionRouteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVpnConnectionRouteError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteVpnConnectionRouteError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVpnConnectionRouteError {
