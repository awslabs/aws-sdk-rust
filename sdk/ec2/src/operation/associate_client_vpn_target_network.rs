...
impl AssociateClientVpnTargetNetworkInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_client_vpn_target_network::AssociateClientVpnTargetNetwork::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateClientVpnTargetNetwork {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_client_vpn_target_network::de_associate_client_vpn_target_network_http_response_with_props(
                status, headers, body,
            )
        }
    }
