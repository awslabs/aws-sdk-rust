...
impl GetVpnTunnelReplacementStatusFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusOutput, aws_smithy_http::result::SdkError<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError>>
                     {
