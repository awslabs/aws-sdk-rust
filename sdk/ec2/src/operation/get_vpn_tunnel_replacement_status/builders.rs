...
impl GetVpnTunnelReplacementStatusInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.get_vpn_tunnel_replacement_status();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusOutput,
                    crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError,
                > for GetVpnTunnelReplacementStatusFluentBuilder
            {
                fn send(
                    self,
...
impl GetVpnTunnelReplacementStatusFluentBuilder {
    ...
    /// Access the GetVpnTunnelReplacementStatus as a reference.
    pub fn as_input(&self) -> &crate::operation::get_vpn_tunnel_replacement_status::builders::GetVpnTunnelReplacementStatusInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatus::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatus::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusOutput, crate::operation::get_vpn_tunnel_replacement_status::GetVpnTunnelReplacementStatusError, Self> {
