...
impl ResetNetworkInterfaceAttribute {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetNetworkInterfaceAttribute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResetNetworkInterfaceAttribute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResetNetworkInterfaceAttributeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResetNetworkInterfaceAttributeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetNetworkInterfaceAttribute")
...
.with_interceptor(ResetNetworkInterfaceAttributeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_reset_network_interface_attribute::de_reset_network_interface_attribute_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResetNetworkInterfaceAttributeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reset_network_interface_attribute_input::ser_reset_network_interface_attribute_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ResetNetworkInterfaceAttributeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResetNetworkInterfaceAttributeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResetNetworkInterfaceAttributeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResetNetworkInterfaceAttributeInput>()
                        .ok_or("failed to downcast to ResetNetworkInterfaceAttributeInput")?;
...
pub enum ResetNetworkInterfaceAttributeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResetNetworkInterfaceAttributeError) for what information is available for the error.")]
...
impl ResetNetworkInterfaceAttributeError {
    /// Creates the `ResetNetworkInterfaceAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetNetworkInterfaceAttributeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResetNetworkInterfaceAttributeError {
