...
impl ResetNetworkInterfaceAttributeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttribute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetNetworkInterfaceAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reset_network_interface_attribute::de_reset_network_interface_attribute_http_response_with_props(
                status, headers, body,
            )
        }
    }
