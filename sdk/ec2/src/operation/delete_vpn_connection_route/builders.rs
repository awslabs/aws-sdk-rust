...
impl DeleteVpnConnectionRouteFluentBuilder  {
    /// Creates a new `DeleteVpnConnectionRoute`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteOutput, aws_smithy_http::result::SdkError<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteError>>
                     {
