...
impl DisassociateNatGatewayAddressInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::disassociate_nat_gateway_address::DisassociateNatGatewayAddressInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
