...
impl DescribeFleetInstancesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_fleet_instances::DescribeFleetInstances,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_instances::de_describe_fleet_instances_http_response_with_props(status, headers, body)
        }
    }
}
