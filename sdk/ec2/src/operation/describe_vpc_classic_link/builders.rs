...
impl DescribeVpcClassicLinkFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkOutput, crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkError, Self> {
