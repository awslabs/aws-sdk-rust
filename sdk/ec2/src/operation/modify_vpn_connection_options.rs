...
impl ModifyVpnConnectionOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyVpnConnectionOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_vpn_connection_options::de_modify_vpn_connection_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
