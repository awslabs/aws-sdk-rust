...
impl DescribeTransitGatewayConnectsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_transit_gateway_connects::DescribeTransitGatewayConnectsInput, ::aws_smithy_types::error::operation::BuildError> {
