...
impl DeleteSubnetCidrReservationFluentBuilder  {
    /// Creates a new `DeleteSubnetCidrReservation`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservation, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationOutput, aws_smithy_http::result::SdkError<crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationError>>
                     {
