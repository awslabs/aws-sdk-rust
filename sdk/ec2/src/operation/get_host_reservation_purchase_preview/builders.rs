...
impl GetHostReservationPurchasePreviewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_host_reservation_purchase_preview::GetHostReservationPurchasePreviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_host_reservation_purchase_preview::GetHostReservationPurchasePreviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_host_reservation_purchase_preview::GetHostReservationPurchasePreviewOutput, crate::operation::get_host_reservation_purchase_preview::GetHostReservationPurchasePreviewError, Self> {
