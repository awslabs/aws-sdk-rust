...
impl DescribeAvailabilityZonesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_availability_zones::DescribeAvailabilityZonesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_availability_zones::DescribeAvailabilityZonesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_availability_zones::DescribeAvailabilityZonesOutput, crate::operation::describe_availability_zones::DescribeAvailabilityZonesError, Self> {
