...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_vpc_peering_connection_input::ser_delete_vpc_peering_connection_input_input_input(&input)?);
