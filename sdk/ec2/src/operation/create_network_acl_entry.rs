...
impl CreateNetworkAclEntry {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_network_acl_entry::CreateNetworkAclEntryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_network_acl_entry::CreateNetworkAclEntryOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateNetworkAclEntry", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateNetworkAclEntry {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateNetworkAclEntry", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateNetworkAclEntry")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateNetworkAclEntryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateNetworkAclEntryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_network_acl_entry::CreateNetworkAclEntryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_network_acl_entry_input::ser_create_network_acl_entry_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateNetworkAclEntryEndpointParamsInterceptor {
...
pub type CreateNetworkAclEntryErrorKind = CreateNetworkAclEntryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateNetworkAclEntryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_network_acl_entry::CreateNetworkAclEntryError {
...
impl CreateNetworkAclEntryError {
    ...
    /// Creates the `CreateNetworkAclEntryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
