...
impl CreateRouteInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_route_input::ser_create_route_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_route::CreateRoute::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateRoute", "ec2"));
