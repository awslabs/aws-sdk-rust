...
impl DescribeClientVpnTargetNetworksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_client_vpn_target_networks::DescribeClientVpnTargetNetworks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClientVpnTargetNetworks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_client_vpn_target_networks::de_describe_client_vpn_target_networks_http_response_with_props(
                status, headers, body,
            )
        }
    }
