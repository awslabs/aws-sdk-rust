...
impl DescribeVerifiedAccessEndpointsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_verified_access_endpoints::DescribeVerifiedAccessEndpointsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
