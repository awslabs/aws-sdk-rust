...
impl DescribeVerifiedAccessEndpointsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_verified_access_endpoints::DescribeVerifiedAccessEndpointsInput, ::aws_smithy_types::error::operation::BuildError> {
