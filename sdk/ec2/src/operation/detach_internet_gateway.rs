...
impl DetachInternetGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::detach_internet_gateway::DetachInternetGatewayError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::detach_internet_gateway::DetachInternetGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DetachInternetGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachInternetGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DetachInternetGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachInternetGateway")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DetachInternetGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DetachInternetGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::detach_internet_gateway::DetachInternetGatewayInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_internet_gateway_input::ser_detach_internet_gateway_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DetachInternetGatewayEndpointParamsInterceptor {
...
pub type DetachInternetGatewayErrorKind = DetachInternetGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DetachInternetGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::detach_internet_gateway::DetachInternetGatewayError {
...
impl DetachInternetGatewayError {
    ...
    /// Creates the `DetachInternetGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
