...
impl CreateNetworkInsightsAccessScopeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeInput, ::aws_smithy_types::error::operation::BuildError> {
