    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_public_ipv4_pool::CreatePublicIpv4PoolError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_public_ipv4_pool::CreatePublicIpv4PoolOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreatePublicIpv4PoolResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreatePublicIpv4PoolRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_public_ipv4_pool::CreatePublicIpv4PoolInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_public_ipv4_pool_input::ser_create_public_ipv4_pool_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreatePublicIpv4PoolEndpointParamsInterceptor {
...
pub type CreatePublicIpv4PoolErrorKind = CreatePublicIpv4PoolError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreatePublicIpv4PoolError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_public_ipv4_pool::CreatePublicIpv4PoolError {
...
impl CreatePublicIpv4PoolError {
    ...
    /// Creates the `CreatePublicIpv4PoolError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
