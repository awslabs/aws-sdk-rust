...
impl DeleteQueuedReservedInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_queued_reserved_instances::DeleteQueuedReservedInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteQueuedReservedInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_queued_reserved_instances::de_delete_queued_reserved_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
