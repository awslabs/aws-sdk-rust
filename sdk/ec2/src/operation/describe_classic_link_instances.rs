...
impl DescribeClassicLinkInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_classic_link_instances::DescribeClassicLinkInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClassicLinkInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_classic_link_instances::de_describe_classic_link_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
