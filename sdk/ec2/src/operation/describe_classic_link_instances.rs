    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_classic_link_instances::DescribeClassicLinkInstancesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_classic_link_instances::DescribeClassicLinkInstancesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeClassicLinkInstances {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeClassicLinkInstances", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeClassicLinkInstances")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeClassicLinkInstancesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeClassicLinkInstancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_classic_link_instances::DescribeClassicLinkInstancesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_classic_link_instances_input::ser_describe_classic_link_instances_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeClassicLinkInstancesEndpointParamsInterceptor {
...
pub type DescribeClassicLinkInstancesErrorKind = DescribeClassicLinkInstancesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeClassicLinkInstancesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_classic_link_instances::DescribeClassicLinkInstancesError {
...
impl DescribeClassicLinkInstancesError {
    ...
    /// Creates the `DescribeClassicLinkInstancesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
