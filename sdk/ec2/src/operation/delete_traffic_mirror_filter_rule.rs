...
impl DeleteTrafficMirrorFilterRule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTrafficMirrorFilterRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteTrafficMirrorFilterRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteTrafficMirrorFilterRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteTrafficMirrorFilterRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTrafficMirrorFilterRule")
...
.with_interceptor(DeleteTrafficMirrorFilterRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_delete_traffic_mirror_filter_rule::de_delete_traffic_mirror_filter_rule_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTrafficMirrorFilterRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_traffic_mirror_filter_rule_input::ser_delete_traffic_mirror_filter_rule_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteTrafficMirrorFilterRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTrafficMirrorFilterRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteTrafficMirrorFilterRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteTrafficMirrorFilterRuleInput>()
                        .ok_or("failed to downcast to DeleteTrafficMirrorFilterRuleInput")?;
...
/// Error type for the `DeleteTrafficMirrorFilterRuleError` operation.
#[non_exhaustive]
...
pub enum DeleteTrafficMirrorFilterRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteTrafficMirrorFilterRuleError) for what information is available for the error.")]
...
impl DeleteTrafficMirrorFilterRuleError {
    /// Creates the `DeleteTrafficMirrorFilterRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteTrafficMirrorFilterRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteTrafficMirrorFilterRuleError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteTrafficMirrorFilterRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_traffic_mirror_filter_rule::_delete_traffic_mirror_filter_rule_output::DeleteTrafficMirrorFilterRuleOutput;

pub use crate::operation::delete_traffic_mirror_filter_rule::_delete_traffic_mirror_filter_rule_input::DeleteTrafficMirrorFilterRuleInput;

mod _delete_traffic_mirror_filter_rule_input;

mod _delete_traffic_mirror_filter_rule_output;
