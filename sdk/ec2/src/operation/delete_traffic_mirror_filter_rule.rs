...
impl DeleteTrafficMirrorFilterRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrafficMirrorFilterRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_traffic_mirror_filter_rule::de_delete_traffic_mirror_filter_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
