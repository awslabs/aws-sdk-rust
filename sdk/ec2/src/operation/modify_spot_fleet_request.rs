...
impl ModifySpotFleetRequest {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifySpotFleetRequest {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifySpotFleetRequest");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifySpotFleetRequestRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifySpotFleetRequestResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifySpotFleetRequest")
...
.with_interceptor(ModifySpotFleetRequestEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifySpotFleetRequestRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_spot_fleet_request_input::ser_modify_spot_fleet_request_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifySpotFleetRequestEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifySpotFleetRequestEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifySpotFleetRequestEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifySpotFleetRequestInput>()
                        .ok_or("failed to downcast to ModifySpotFleetRequestInput")?;
...
/// Error type for the `ModifySpotFleetRequestError` operation.
#[non_exhaustive]
...
pub enum ModifySpotFleetRequestError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifySpotFleetRequestError) for what information is available for the error.")]
...
impl ModifySpotFleetRequestError {
    /// Creates the `ModifySpotFleetRequestError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySpotFleetRequestError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifySpotFleetRequestError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifySpotFleetRequestError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_spot_fleet_request::_modify_spot_fleet_request_output::ModifySpotFleetRequestOutput;

pub use crate::operation::modify_spot_fleet_request::_modify_spot_fleet_request_input::ModifySpotFleetRequestInput;

mod _modify_spot_fleet_request_input;

mod _modify_spot_fleet_request_output;
