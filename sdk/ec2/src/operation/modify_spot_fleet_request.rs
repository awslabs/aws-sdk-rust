...
impl ModifySpotFleetRequest {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ModifySpotFleetRequest", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifySpotFleetRequest {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifySpotFleetRequest", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifySpotFleetRequest")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifySpotFleetRequestResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifySpotFleetRequestRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_spot_fleet_request_input::ser_modify_spot_fleet_request_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifySpotFleetRequestEndpointParamsInterceptor {
...
pub type ModifySpotFleetRequestErrorKind = ModifySpotFleetRequestError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifySpotFleetRequestError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError {
...
impl ModifySpotFleetRequestError {
    ...
    /// Creates the `ModifySpotFleetRequestError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
