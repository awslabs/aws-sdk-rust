    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_conversion_task::CancelConversionTaskError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_conversion_task::CancelConversionTaskOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CancelConversionTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CancelConversionTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_conversion_task::CancelConversionTaskInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_conversion_task_input::ser_cancel_conversion_task_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelConversionTaskEndpointParamsInterceptor {
...
pub type CancelConversionTaskErrorKind = CancelConversionTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelConversionTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_conversion_task::CancelConversionTaskError {
...
impl CancelConversionTaskError {
    ...
    /// Creates the `CancelConversionTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
