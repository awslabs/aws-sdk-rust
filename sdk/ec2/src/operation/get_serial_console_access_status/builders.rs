...
impl GetSerialConsoleAccessStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusOutput, crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusError, Self> {
