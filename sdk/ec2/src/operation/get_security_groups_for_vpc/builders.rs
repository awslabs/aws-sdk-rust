...
impl GetSecurityGroupsForVpcFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcOutput, crate::operation::get_security_groups_for_vpc::GetSecurityGroupsForVpcError, Self> {
