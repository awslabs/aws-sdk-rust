...
impl crate::operation::modify_vpn_connection_options::builders::ModifyVpnConnectionOptionsInputBuilder {
...
impl ModifyVpnConnectionOptionsFluentBuilder {
    /// Creates a new `ModifyVpnConnectionOptionsFluentBuilder`.
