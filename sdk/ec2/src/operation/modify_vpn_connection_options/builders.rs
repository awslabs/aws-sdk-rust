...
impl ModifyVpnConnectionOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsOutput, crate::operation::modify_vpn_connection_options::ModifyVpnConnectionOptionsError, Self> {
