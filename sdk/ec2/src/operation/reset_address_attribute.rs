...
impl ResetAddressAttribute {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::reset_address_attribute::ResetAddressAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reset_address_attribute::ResetAddressAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reset_address_attribute::ResetAddressAttributeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reset_address_attribute::ResetAddressAttributeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetAddressAttribute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResetAddressAttribute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResetAddressAttributeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResetAddressAttributeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetAddressAttribute")
...
.with_interceptor(ResetAddressAttributeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reset_address_attribute::ResetAddressAttributeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reset_address_attribute::ResetAddressAttributeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reset_address_attribute::ResetAddressAttributeError>::new());
...
#[derive(Debug)]
            struct ResetAddressAttributeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResetAddressAttributeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reset_address_attribute::ResetAddressAttributeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reset_address_attribute::ResetAddressAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reset_address_attribute_input::ser_reset_address_attribute_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ResetAddressAttributeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResetAddressAttributeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResetAddressAttributeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResetAddressAttributeInput>()
                        .ok_or("failed to downcast to ResetAddressAttributeInput")?;
...
/// Error type for the `ResetAddressAttributeError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ResetAddressAttributeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResetAddressAttributeError) for what information is available for the error.")]
...
impl ResetAddressAttributeError {
    /// Creates the `ResetAddressAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetAddressAttributeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ResetAddressAttributeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResetAddressAttributeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reset_address_attribute::ResetAddressAttributeError {
...
mod _reset_address_attribute_output;
