...
impl ResetAddressAttribute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_address_attribute::ResetAddressAttributeError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_address_attribute::ResetAddressAttributeOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ResetAddressAttribute", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetAddressAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ResetAddressAttribute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetAddressAttribute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ResetAddressAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ResetAddressAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_address_attribute::ResetAddressAttributeInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_address_attribute_input::ser_reset_address_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ResetAddressAttributeEndpointParamsInterceptor {
...
pub type ResetAddressAttributeErrorKind = ResetAddressAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResetAddressAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_address_attribute::ResetAddressAttributeError {
...
impl ResetAddressAttributeError {
    ...
    /// Creates the `ResetAddressAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
