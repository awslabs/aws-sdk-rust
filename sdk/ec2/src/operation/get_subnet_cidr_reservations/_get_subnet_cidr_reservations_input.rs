...
impl GetSubnetCidrReservationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsInput, ::aws_smithy_types::error::operation::BuildError> {
