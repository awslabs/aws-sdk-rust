...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeEgressOnlyInternetGateways {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeEgressOnlyInternetGateways", "ec2"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeEgressOnlyInternetGateways")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeEgressOnlyInternetGatewaysResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeEgressOnlyInternetGatewaysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_egress_only_internet_gateways_input::ser_describe_egress_only_internet_gateways_input_input(
                &input,
            )?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeEgressOnlyInternetGatewaysEndpointParamsInterceptor {
...
pub type DescribeEgressOnlyInternetGatewaysErrorKind = DescribeEgressOnlyInternetGatewaysError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeEgressOnlyInternetGatewaysError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_egress_only_internet_gateways::DescribeEgressOnlyInternetGatewaysError {
...
impl DescribeEgressOnlyInternetGatewaysError {
    ...
    /// Creates the `DescribeEgressOnlyInternetGatewaysError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
