...
impl DescribeEgressOnlyInternetGatewaysInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_egress_only_internet_gateways::DescribeEgressOnlyInternetGateways::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEgressOnlyInternetGateways {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_egress_only_internet_gateways::de_describe_egress_only_internet_gateways_http_response_with_props(
                status, headers, body,
            )
        }
    }
