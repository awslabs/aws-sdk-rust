...
/// Orchestration and serialization glue logic for `DeleteSecurityGroup`.
...
impl DeleteSecurityGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_security_group::DeleteSecurityGroupInput,
                    ) -> ::std::result::Result<crate::operation::delete_security_group::DeleteSecurityGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_security_group::DeleteSecurityGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_security_group::DeleteSecurityGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_security_group::DeleteSecurityGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSecurityGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSecurityGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSecurityGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSecurityGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSecurityGroup")
...
.with_interceptor(DeleteSecurityGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_security_group::DeleteSecurityGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_security_group::DeleteSecurityGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_security_group::DeleteSecurityGroupError>::new());
...
#[derive(Debug)]
            struct DeleteSecurityGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSecurityGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_security_group::de_delete_security_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_security_group::de_delete_security_group_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSecurityGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_security_group::DeleteSecurityGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_security_group::DeleteSecurityGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_security_group_input::ser_delete_security_group_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteSecurityGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSecurityGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSecurityGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSecurityGroupInput>()
                        .ok_or("failed to downcast to DeleteSecurityGroupInput")?;
...
/// Error type for the `DeleteSecurityGroupError` operation.
#[non_exhaustive]
...
pub enum DeleteSecurityGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSecurityGroupError) for what information is available for the error.")]
...
impl DeleteSecurityGroupError {
    /// Creates the `DeleteSecurityGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSecurityGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteSecurityGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSecurityGroupError {
