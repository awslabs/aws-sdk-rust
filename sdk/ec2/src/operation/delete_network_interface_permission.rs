...
impl DeleteNetworkInterfacePermissionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_network_interface_permission::DeleteNetworkInterfacePermission::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNetworkInterfacePermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_network_interface_permission::de_delete_network_interface_permission_http_response_with_props(
                status, headers, body,
            )
        }
    }
