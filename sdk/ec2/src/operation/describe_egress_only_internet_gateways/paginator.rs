...
impl DescribeEgressOnlyInternetGatewaysPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::describe_egress_only_internet_gateways::DescribeEgressOnlyInternetGateways::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_egress_only_internet_gateways::DescribeEgressOnlyInternetGateways::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl DescribeEgressOnlyInternetGatewaysPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_egress_only_internet_gateways_output_output_egress_only_internet_gateways(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
