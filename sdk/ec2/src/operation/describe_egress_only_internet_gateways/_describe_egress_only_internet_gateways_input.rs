...
impl DescribeEgressOnlyInternetGatewaysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_egress_only_internet_gateways::DescribeEgressOnlyInternetGatewaysInput, ::aws_smithy_types::error::operation::BuildError> {
