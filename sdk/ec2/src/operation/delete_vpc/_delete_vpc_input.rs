...
impl DeleteVpcInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::delete_vpc::DeleteVpcInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
            crate::operation::delete_vpc::DeleteVpcInput {
                vpc_id: self.vpc_id
                ,
