...
/// <p>If you created a flow log for the VPC that you are deleting, note that flow logs for deleted VPCs are eventually automatically removed.</p>
...
impl DeleteVpcFluentBuilder {
    /// Creates a new `DeleteVpcFluentBuilder`.
