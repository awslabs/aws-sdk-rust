...
impl DeleteVerifiedAccessTrustProviderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProvider::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVerifiedAccessTrustProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_verified_access_trust_provider::de_delete_verified_access_trust_provider_http_response_with_props(
                status, headers, body,
            )
        }
    }
