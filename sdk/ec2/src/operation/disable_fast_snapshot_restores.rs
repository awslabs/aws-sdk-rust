...
impl DisableFastSnapshotRestores {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DisableFastSnapshotRestores", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableFastSnapshotRestores {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            DisableFastSnapshotRestoresRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            DisableFastSnapshotRestoresResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DisableFastSnapshotRestores", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableFastSnapshotRestores")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DisableFastSnapshotRestoresResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DisableFastSnapshotRestoresRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_fast_snapshot_restores_input::ser_disable_fast_snapshot_restores_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisableFastSnapshotRestoresEndpointParamsInterceptor {
...
pub type DisableFastSnapshotRestoresErrorKind = DisableFastSnapshotRestoresError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisableFastSnapshotRestoresError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError {
...
impl DisableFastSnapshotRestoresError {
    ...
    /// Creates the `DisableFastSnapshotRestoresError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
