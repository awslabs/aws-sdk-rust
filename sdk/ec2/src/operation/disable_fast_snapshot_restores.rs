...
impl DisableFastSnapshotRestoresInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestores::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableFastSnapshotRestores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_fast_snapshot_restores::de_disable_fast_snapshot_restores_http_response_with_props(
                status, headers, body,
            )
        }
    }
