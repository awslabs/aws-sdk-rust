...
impl DisableFastSnapshotRestores {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableFastSnapshotRestores {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableFastSnapshotRestores");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableFastSnapshotRestoresRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableFastSnapshotRestoresResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableFastSnapshotRestores")
...
.with_interceptor(DisableFastSnapshotRestoresEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableFastSnapshotRestoresRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_fast_snapshot_restores_input::ser_disable_fast_snapshot_restores_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableFastSnapshotRestoresEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableFastSnapshotRestoresEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableFastSnapshotRestoresEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableFastSnapshotRestoresInput>()
                        .ok_or("failed to downcast to DisableFastSnapshotRestoresInput")?;
...
/// Error type for the `DisableFastSnapshotRestoresError` operation.
#[non_exhaustive]
...
pub enum DisableFastSnapshotRestoresError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableFastSnapshotRestoresError) for what information is available for the error.")]
...
impl DisableFastSnapshotRestoresError {
    /// Creates the `DisableFastSnapshotRestoresError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableFastSnapshotRestoresError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisableFastSnapshotRestoresError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableFastSnapshotRestoresError {
