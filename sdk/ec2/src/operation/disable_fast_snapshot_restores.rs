...
impl DisableFastSnapshotRestoresInput {
    /// Consumes the builder and constructs an Operation<[`DisableFastSnapshotRestores`](crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestores)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestores, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestoresInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_fast_snapshot_restores_input::ser_disable_fast_snapshot_restores_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_fast_snapshot_restores::DisableFastSnapshotRestores::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisableFastSnapshotRestores", "ec2"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DisableFastSnapshotRestores`.
