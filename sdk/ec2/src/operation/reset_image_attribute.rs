...
impl ResetImageAttributeInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reset_image_attribute::ResetImageAttribute::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ResetImageAttribute {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_reset_image_attribute::de_reset_image_attribute_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::reset_image_attribute::ResetImageAttributeError
{
