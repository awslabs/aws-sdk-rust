...
impl crate::operation::get_vpn_connection_device_types::builders::GetVpnConnectionDeviceTypesInputBuilder {
...
impl GetVpnConnectionDeviceTypesFluentBuilder {
    /// Creates a new `GetVpnConnectionDeviceTypesFluentBuilder`.
