...
pub struct DisableImageDeregistrationProtectionInput {
...
pub struct DisableImageDeregistrationProtectionInputBuilder {
    pub(crate) image_id: ::std::option::Option<::std::string::String>,
    pub(crate) dry_run: ::std::option::Option<bool>,
}
impl DisableImageDeregistrationProtectionInputBuilder {
    /// <p>The ID of the AMI.</p>
    ...
    /// Consumes the builder and constructs a [`DisableImageDeregistrationProtectionInput`](crate::operation::disable_image_deregistration_protection::DisableImageDeregistrationProtectionInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::disable_image_deregistration_protection::DisableImageDeregistrationProtectionInput,
