...
impl GetIpamPoolAllocations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetIpamPoolAllocations", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIpamPoolAllocations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetIpamPoolAllocations", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIpamPoolAllocations")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetIpamPoolAllocationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetIpamPoolAllocationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ipam_pool_allocations_input::ser_get_ipam_pool_allocations_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetIpamPoolAllocationsEndpointParamsInterceptor {
...
pub type GetIpamPoolAllocationsErrorKind = GetIpamPoolAllocationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetIpamPoolAllocationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ipam_pool_allocations::GetIpamPoolAllocationsError {
...
impl GetIpamPoolAllocationsError {
    ...
    /// Creates the `GetIpamPoolAllocationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
