...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTransitGatewayMulticastDomainAssociationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_transit_gateway_multicast_domain_associations_input::ser_get_transit_gateway_multicast_domain_associations_input_input(&input)?);
