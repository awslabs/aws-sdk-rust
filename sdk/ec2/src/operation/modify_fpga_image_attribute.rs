...
impl ModifyFpgaImageAttributeInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttribute::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyFpgaImageAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_fpga_image_attribute::de_modify_fpga_image_attribute_http_response_with_props(status, headers, body)
        }
    }
}
