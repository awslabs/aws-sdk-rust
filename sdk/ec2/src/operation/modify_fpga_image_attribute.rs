...
/// Orchestration and serialization glue logic for `ModifyFpgaImageAttribute`.
...
impl ModifyFpgaImageAttribute {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyFpgaImageAttribute {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyFpgaImageAttribute");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyFpgaImageAttributeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyFpgaImageAttributeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyFpgaImageAttribute")
...
.with_interceptor(ModifyFpgaImageAttributeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError>::new());
...
#[derive(Debug)]
            struct ModifyFpgaImageAttributeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyFpgaImageAttributeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_fpga_image_attribute::de_modify_fpga_image_attribute_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_fpga_image_attribute::de_modify_fpga_image_attribute_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyFpgaImageAttributeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_fpga_image_attribute_input::ser_modify_fpga_image_attribute_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyFpgaImageAttributeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyFpgaImageAttributeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyFpgaImageAttributeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyFpgaImageAttributeInput>()
                        .ok_or("failed to downcast to ModifyFpgaImageAttributeInput")?;
...
/// Error type for the `ModifyFpgaImageAttributeError` operation.
#[non_exhaustive]
...
pub enum ModifyFpgaImageAttributeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyFpgaImageAttributeError) for what information is available for the error.")]
...
impl ModifyFpgaImageAttributeError {
    /// Creates the `ModifyFpgaImageAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyFpgaImageAttributeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyFpgaImageAttributeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyFpgaImageAttributeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError {
...
mod _modify_fpga_image_attribute_output;
