    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyFpgaImageAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyFpgaImageAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_fpga_image_attribute_input::ser_modify_fpga_image_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyFpgaImageAttributeEndpointParamsInterceptor {
...
pub type ModifyFpgaImageAttributeErrorKind = ModifyFpgaImageAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyFpgaImageAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_fpga_image_attribute::ModifyFpgaImageAttributeError {
...
impl ModifyFpgaImageAttributeError {
    ...
    /// Creates the `ModifyFpgaImageAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
