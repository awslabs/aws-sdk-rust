    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpcEndpointServices {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeVpcEndpointServices", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVpcEndpointServices")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeVpcEndpointServicesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeVpcEndpointServicesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpc_endpoint_services_input::ser_describe_vpc_endpoint_services_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeVpcEndpointServicesEndpointParamsInterceptor {
...
pub type DescribeVpcEndpointServicesErrorKind = DescribeVpcEndpointServicesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeVpcEndpointServicesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError {
...
impl DescribeVpcEndpointServicesError {
    ...
    /// Creates the `DescribeVpcEndpointServicesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
