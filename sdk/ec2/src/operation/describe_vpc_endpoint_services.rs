...
impl DescribeVpcEndpointServices {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpcEndpointServices {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeVpcEndpointServices");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeVpcEndpointServicesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeVpcEndpointServicesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVpcEndpointServices")
...
.with_interceptor(DescribeVpcEndpointServicesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_vpc_endpoint_services::de_describe_vpc_endpoint_services_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeVpcEndpointServicesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_vpc_endpoint_services_input::ser_describe_vpc_endpoint_services_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeVpcEndpointServicesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeVpcEndpointServicesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeVpcEndpointServicesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeVpcEndpointServicesInput>()
                        .ok_or("failed to downcast to DescribeVpcEndpointServicesInput")?;
...
/// Error type for the `DescribeVpcEndpointServicesError` operation.
#[non_exhaustive]
...
pub enum DescribeVpcEndpointServicesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeVpcEndpointServicesError) for what information is available for the error.")]
...
impl DescribeVpcEndpointServicesError {
    /// Creates the `DescribeVpcEndpointServicesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeVpcEndpointServicesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeVpcEndpointServicesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeVpcEndpointServicesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesError {
...
mod _describe_vpc_endpoint_services_output;
