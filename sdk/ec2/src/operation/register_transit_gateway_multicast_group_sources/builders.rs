...
impl crate::operation::register_transit_gateway_multicast_group_sources::builders::RegisterTransitGatewayMulticastGroupSourcesInputBuilder {
...
impl RegisterTransitGatewayMulticastGroupSourcesFluentBuilder {
    /// Creates a new `RegisterTransitGatewayMulticastGroupSourcesFluentBuilder`.
