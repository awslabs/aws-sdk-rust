...
impl GetTransitGatewayMulticastDomainAssociationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_transit_gateway_multicast_domain_associations::paginator::GetTransitGatewayMulticastDomainAssociationsPaginatorItems
    {
        crate::operation::get_transit_gateway_multicast_domain_associations::paginator::GetTransitGatewayMulticastDomainAssociationsPaginatorItems(
            self,
        )
...
impl GetTransitGatewayMulticastDomainAssociationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_transit_gateway_multicast_domain_associations_output_output_multicast_domain_associations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
