...
impl DeleteLaunchTemplateVersionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLaunchTemplateVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_launch_template_versions::de_delete_launch_template_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
