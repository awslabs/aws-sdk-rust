    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLaunchTemplateVersions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteLaunchTemplateVersions", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteLaunchTemplateVersions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteLaunchTemplateVersionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteLaunchTemplateVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_launch_template_versions_input::ser_delete_launch_template_versions_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteLaunchTemplateVersionsEndpointParamsInterceptor {
...
pub type DeleteLaunchTemplateVersionsErrorKind = DeleteLaunchTemplateVersionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteLaunchTemplateVersionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsError {
...
impl DeleteLaunchTemplateVersionsError {
    ...
    /// Creates the `DeleteLaunchTemplateVersionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
