...
impl EnableImageBlockPublicAccess {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableImageBlockPublicAccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableImageBlockPublicAccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableImageBlockPublicAccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableImageBlockPublicAccessResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableImageBlockPublicAccess")
...
.with_interceptor(EnableImageBlockPublicAccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_enable_image_block_public_access::de_enable_image_block_public_access_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableImageBlockPublicAccessRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableImageBlockPublicAccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_image_block_public_access_input::ser_enable_image_block_public_access_input_input_input(&input)?);
...
#[derive(Debug)]
            struct EnableImageBlockPublicAccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableImageBlockPublicAccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableImageBlockPublicAccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableImageBlockPublicAccessInput>()
                        .ok_or("failed to downcast to EnableImageBlockPublicAccessInput")?;
...
/// Error type for the `EnableImageBlockPublicAccessError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum EnableImageBlockPublicAccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableImageBlockPublicAccessError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl EnableImageBlockPublicAccessError {
    /// Creates the `EnableImageBlockPublicAccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableImageBlockPublicAccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for EnableImageBlockPublicAccessError {
...
impl ::std::fmt::Display for EnableImageBlockPublicAccessError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for EnableImageBlockPublicAccessError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableImageBlockPublicAccessError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableImageBlockPublicAccessError {
