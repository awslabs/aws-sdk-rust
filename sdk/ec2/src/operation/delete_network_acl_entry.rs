...
impl DeleteNetworkAclEntry {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteNetworkAclEntry {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteNetworkAclEntry");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteNetworkAclEntryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteNetworkAclEntryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteNetworkAclEntry")
...
.with_interceptor(DeleteNetworkAclEntryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_delete_network_acl_entry::de_delete_network_acl_entry_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteNetworkAclEntryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_network_acl_entry_input::ser_delete_network_acl_entry_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteNetworkAclEntryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteNetworkAclEntryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteNetworkAclEntryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteNetworkAclEntryInput>()
                        .ok_or("failed to downcast to DeleteNetworkAclEntryInput")?;
...
/// Error type for the `DeleteNetworkAclEntryError` operation.
#[non_exhaustive]
...
pub enum DeleteNetworkAclEntryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteNetworkAclEntryError) for what information is available for the error.")]
...
impl DeleteNetworkAclEntryError {
    /// Creates the `DeleteNetworkAclEntryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteNetworkAclEntryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteNetworkAclEntryError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteNetworkAclEntryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_network_acl_entry::_delete_network_acl_entry_output::DeleteNetworkAclEntryOutput;

pub use crate::operation::delete_network_acl_entry::_delete_network_acl_entry_input::DeleteNetworkAclEntryInput;

mod _delete_network_acl_entry_input;

mod _delete_network_acl_entry_output;
