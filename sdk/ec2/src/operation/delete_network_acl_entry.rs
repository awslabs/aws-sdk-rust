...
impl DeleteNetworkAclEntry {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteNetworkAclEntry", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteNetworkAclEntry {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteNetworkAclEntry", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteNetworkAclEntry")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteNetworkAclEntryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteNetworkAclEntryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_network_acl_entry_input::ser_delete_network_acl_entry_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteNetworkAclEntryEndpointParamsInterceptor {
...
pub type DeleteNetworkAclEntryErrorKind = DeleteNetworkAclEntryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteNetworkAclEntryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_network_acl_entry::DeleteNetworkAclEntryError {
...
impl DeleteNetworkAclEntryError {
    ...
    /// Creates the `DeleteNetworkAclEntryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
