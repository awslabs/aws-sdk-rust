...
impl DescribeAggregateIdFormatInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatInput, ::aws_smithy_types::error::operation::BuildError> {
