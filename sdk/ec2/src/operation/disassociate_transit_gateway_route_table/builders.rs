...
impl crate::operation::disassociate_transit_gateway_route_table::builders::DisassociateTransitGatewayRouteTableInputBuilder {
...
impl DisassociateTransitGatewayRouteTableFluentBuilder {
    /// Creates a new `DisassociateTransitGatewayRouteTableFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::disassociate_transit_gateway_route_table::builders::DisassociateTransitGatewayRouteTableInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTable::operation_runtime_plugins(
