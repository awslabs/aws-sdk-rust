...
impl DescribeSnapshotAttributeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_snapshot_attribute::DescribeSnapshotAttributeInput, ::aws_smithy_types::error::operation::BuildError> {
