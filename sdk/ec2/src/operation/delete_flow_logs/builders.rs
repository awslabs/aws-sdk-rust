...
impl DeleteFlowLogsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_flow_logs::DeleteFlowLogsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_flow_logs::DeleteFlowLogsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_flow_logs::DeleteFlowLogsOutput, crate::operation::delete_flow_logs::DeleteFlowLogsError, Self> {
