...
impl TerminateInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::terminate_instances::TerminateInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_terminate_instances::de_terminate_instances_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::terminate_instances::TerminateInstancesError
{
