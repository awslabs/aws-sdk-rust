...
/// Orchestration and serialization glue logic for `DetachVpnGateway`.
...
impl DetachVpnGateway {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::detach_vpn_gateway::DetachVpnGatewayInput,
                    ) -> ::std::result::Result<crate::operation::detach_vpn_gateway::DetachVpnGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_vpn_gateway::DetachVpnGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detach_vpn_gateway::DetachVpnGatewayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detach_vpn_gateway::DetachVpnGatewayOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachVpnGateway {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetachVpnGateway");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetachVpnGatewayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetachVpnGatewayResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachVpnGateway")
...
.with_interceptor(DetachVpnGatewayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detach_vpn_gateway::DetachVpnGatewayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detach_vpn_gateway::DetachVpnGatewayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detach_vpn_gateway::DetachVpnGatewayError>::new());
...
#[derive(Debug)]
            struct DetachVpnGatewayResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachVpnGatewayResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detach_vpn_gateway::de_detach_vpn_gateway_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_detach_vpn_gateway::de_detach_vpn_gateway_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachVpnGatewayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detach_vpn_gateway::DetachVpnGatewayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detach_vpn_gateway::DetachVpnGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detach_vpn_gateway_input::ser_detach_vpn_gateway_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DetachVpnGatewayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetachVpnGatewayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetachVpnGatewayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetachVpnGatewayInput>()
                        .ok_or("failed to downcast to DetachVpnGatewayInput")?;
...
/// Error type for the `DetachVpnGatewayError` operation.
#[non_exhaustive]
...
pub enum DetachVpnGatewayError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetachVpnGatewayError) for what information is available for the error.")]
...
impl DetachVpnGatewayError {
    /// Creates the `DetachVpnGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetachVpnGatewayError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DetachVpnGatewayError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetachVpnGatewayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detach_vpn_gateway::DetachVpnGatewayError {
...
mod _detach_vpn_gateway_output;
