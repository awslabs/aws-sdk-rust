...
impl GetEbsDefaultKmsKeyId {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ebs_default_kms_key_id::GetEbsDefaultKmsKeyIdError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ebs_default_kms_key_id::GetEbsDefaultKmsKeyIdOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetEbsDefaultKmsKeyId", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetEbsDefaultKmsKeyId {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetEbsDefaultKmsKeyId", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetEbsDefaultKmsKeyId")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetEbsDefaultKmsKeyIdResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetEbsDefaultKmsKeyIdRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ebs_default_kms_key_id::GetEbsDefaultKmsKeyIdInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_ebs_default_kms_key_id::GetEbsDefaultKmsKeyIdInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ebs_default_kms_key_id_input::ser_get_ebs_default_kms_key_id_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetEbsDefaultKmsKeyIdEndpointParamsInterceptor {
...
pub type GetEbsDefaultKmsKeyIdErrorKind = GetEbsDefaultKmsKeyIdError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetEbsDefaultKmsKeyIdError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ebs_default_kms_key_id::GetEbsDefaultKmsKeyIdError {
...
impl GetEbsDefaultKmsKeyIdError {
    ...
    /// Creates the `GetEbsDefaultKmsKeyIdError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
