...
/// Paginator for [`DescribeVpcClassicLinkDnsSupport`](crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupport)
                ...
                impl DescribeVpcClassicLinkDnsSupportPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::describe_vpc_classic_link_dns_support::builders::DescribeVpcClassicLinkDnsSupportInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupport::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `DescribeVpcClassicLinkDnsSupportPaginator`
                    ...
                    impl DescribeVpcClassicLinkDnsSupportPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::ClassicLinkDnsSupport, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_vpc_classic_link_dns_support_output_output_vpcs(page).unwrap_or_default().into_iter())
                        }
                    }
