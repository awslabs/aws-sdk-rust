...
/// Paginator for [`DescribeVpcClassicLinkDnsSupport`](crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupport)
            ...
            impl DescribeVpcClassicLinkDnsSupportPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportOutput, aws_smithy_http::result::SdkError<crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeVpcClassicLinkDnsSupportPaginator`
                ...
                impl  DescribeVpcClassicLinkDnsSupportPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::ClassicLinkDnsSupport, aws_smithy_http::result::SdkError<crate::operation::describe_vpc_classic_link_dns_support::DescribeVpcClassicLinkDnsSupportError>>> + Unpin
                     {
