...
impl EnableSerialConsoleAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "EnableSerialConsoleAccess", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableSerialConsoleAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            EnableSerialConsoleAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            EnableSerialConsoleAccessResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("EnableSerialConsoleAccess", "ec2"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for EnableSerialConsoleAccessResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for EnableSerialConsoleAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::enable_serial_console_access::EnableSerialConsoleAccessInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_serial_console_access_input::ser_enable_serial_console_access_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for EnableSerialConsoleAccessEndpointParamsInterceptor {
...
pub type EnableSerialConsoleAccessErrorKind = EnableSerialConsoleAccessError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for EnableSerialConsoleAccessError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError {
...
impl EnableSerialConsoleAccessError {
    ...
    /// Creates the `EnableSerialConsoleAccessError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
