...
impl EnableSerialConsoleAccessInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_serial_console_access::EnableSerialConsoleAccess::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableSerialConsoleAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_serial_console_access::de_enable_serial_console_access_http_response_with_props(status, headers, body)
        }
    }
}
