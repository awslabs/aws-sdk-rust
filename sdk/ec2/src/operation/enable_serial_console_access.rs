...
impl EnableSerialConsoleAccess {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::enable_serial_console_access::EnableSerialConsoleAccessInput,
                    ) -> ::std::result::Result<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableSerialConsoleAccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableSerialConsoleAccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableSerialConsoleAccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableSerialConsoleAccessResponseDeserializer));
...
.with_interceptor(EnableSerialConsoleAccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessError>::new());
...
#[derive(Debug)]
            struct EnableSerialConsoleAccessResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableSerialConsoleAccessResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_serial_console_access::de_enable_serial_console_access_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_enable_serial_console_access::de_enable_serial_console_access_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableSerialConsoleAccessRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableSerialConsoleAccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_serial_console_access::EnableSerialConsoleAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_serial_console_access_input::ser_enable_serial_console_access_input_input_input(&input)?);
...
#[derive(Debug)]
            struct EnableSerialConsoleAccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableSerialConsoleAccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableSerialConsoleAccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableSerialConsoleAccessInput>()
                        .ok_or("failed to downcast to EnableSerialConsoleAccessInput")?;
...
/// Error type for the `EnableSerialConsoleAccessError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum EnableSerialConsoleAccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableSerialConsoleAccessError) for what information is available for the error.")]
...
impl EnableSerialConsoleAccessError {
    /// Creates the `EnableSerialConsoleAccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableSerialConsoleAccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableSerialConsoleAccessError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableSerialConsoleAccessError {
