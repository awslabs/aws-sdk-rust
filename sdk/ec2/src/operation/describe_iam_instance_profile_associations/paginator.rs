...
/// Paginator for [`DescribeIamInstanceProfileAssociations`](crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociations)
                ...
                impl DescribeIamInstanceProfileAssociationsPaginator {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociations::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `DescribeIamInstanceProfileAssociationsPaginator`
                    ...
                    impl DescribeIamInstanceProfileAssociationsPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::IamInstanceProfileAssociation, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_describe_iam_instance_profile_associations_output_output_iam_instance_profile_associations(page).unwrap_or_default().into_iter())
                        }
                    }
