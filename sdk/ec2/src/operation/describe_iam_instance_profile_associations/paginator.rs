...
/// Paginator for [`DescribeIamInstanceProfileAssociations`](crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociations)
            ...
            impl DescribeIamInstanceProfileAssociationsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::describe_iam_instance_profile_associations::builders::DescribeIamInstanceProfileAssociationsInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                /// Create a flattened paginator
                    ...
                    pub fn items(self) -> crate::operation::describe_iam_instance_profile_associations::paginator::DescribeIamInstanceProfileAssociationsPaginatorItems {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsOutput, aws_smithy_http::result::SdkError<crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeIamInstanceProfileAssociationsPaginator`
                ...
                impl  DescribeIamInstanceProfileAssociationsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::IamInstanceProfileAssociation, aws_smithy_http::result::SdkError<crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsError>>> + Unpin
                     {
