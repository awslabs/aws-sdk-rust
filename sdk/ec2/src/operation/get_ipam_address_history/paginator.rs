        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::get_ipam_address_history::GetIpamAddressHistory::orchestrate(&runtime_plugins, input.clone()).await;
...
impl GetIpamAddressHistoryPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_ipam_address_history_output_output_history_records(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
