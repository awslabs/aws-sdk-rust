...
impl CreateClientVpnRouteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_client_vpn_route::CreateClientVpnRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_client_vpn_route::CreateClientVpnRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_client_vpn_route::CreateClientVpnRouteOutput, crate::operation::create_client_vpn_route::CreateClientVpnRouteError, Self> {
