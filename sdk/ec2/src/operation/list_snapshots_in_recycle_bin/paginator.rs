        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_snapshots_in_recycle_bin::ListSnapshotsInRecycleBin::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl ListSnapshotsInRecycleBinPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_snapshots_in_recycle_bin_output_output_snapshots(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
