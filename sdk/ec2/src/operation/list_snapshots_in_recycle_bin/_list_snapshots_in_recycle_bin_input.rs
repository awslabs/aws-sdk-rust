...
impl ListSnapshotsInRecycleBinInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_snapshots_in_recycle_bin::ListSnapshotsInRecycleBinInput, ::aws_smithy_types::error::operation::BuildError> {
