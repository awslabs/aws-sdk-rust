    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_placement_group::CreatePlacementGroupError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_placement_group::CreatePlacementGroupOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreatePlacementGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreatePlacementGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_placement_group::CreatePlacementGroupInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_placement_group_input::ser_create_placement_group_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreatePlacementGroupEndpointParamsInterceptor {
...
pub type CreatePlacementGroupErrorKind = CreatePlacementGroupError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreatePlacementGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_placement_group::CreatePlacementGroupError {
...
impl CreatePlacementGroupError {
    ...
    /// Creates the `CreatePlacementGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
