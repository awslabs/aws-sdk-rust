...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ImportClientVpnClientCertificateRevocationListResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ImportClientVpnClientCertificateRevocationListRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_client_vpn_client_certificate_revocation_list_input::ser_import_client_vpn_client_certificate_revocation_list_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ImportClientVpnClientCertificateRevocationListEndpointParamsInterceptor {
