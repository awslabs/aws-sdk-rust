...
impl DeleteTrafficMirrorFilterRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleInput, ::aws_smithy_types::error::operation::BuildError> {
