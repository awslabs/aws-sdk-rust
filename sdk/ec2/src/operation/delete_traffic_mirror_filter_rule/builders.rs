...
impl DeleteTrafficMirrorFilterRuleFluentBuilder  {
    /// Creates a new `DeleteTrafficMirrorFilterRule`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleOutput, aws_smithy_http::result::SdkError<crate::operation::delete_traffic_mirror_filter_rule::DeleteTrafficMirrorFilterRuleError>>
                     {
