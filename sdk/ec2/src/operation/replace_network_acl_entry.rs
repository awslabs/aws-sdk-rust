...
impl ReplaceNetworkAclEntry {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ReplaceNetworkAclEntry", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceNetworkAclEntry {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReplaceNetworkAclEntry", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceNetworkAclEntry")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReplaceNetworkAclEntryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReplaceNetworkAclEntryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replace_network_acl_entry_input::ser_replace_network_acl_entry_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReplaceNetworkAclEntryEndpointParamsInterceptor {
...
pub type ReplaceNetworkAclEntryErrorKind = ReplaceNetworkAclEntryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReplaceNetworkAclEntryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError {
...
impl ReplaceNetworkAclEntryError {
    ...
    /// Creates the `ReplaceNetworkAclEntryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
