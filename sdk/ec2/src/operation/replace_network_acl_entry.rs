...
impl ReplaceNetworkAclEntry {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceNetworkAclEntry {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReplaceNetworkAclEntry");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReplaceNetworkAclEntryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReplaceNetworkAclEntryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceNetworkAclEntry")
...
.with_interceptor(ReplaceNetworkAclEntryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_replace_network_acl_entry::de_replace_network_acl_entry_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplaceNetworkAclEntryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_replace_network_acl_entry_input::ser_replace_network_acl_entry_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReplaceNetworkAclEntryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplaceNetworkAclEntryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReplaceNetworkAclEntryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReplaceNetworkAclEntryInput>()
                        .ok_or("failed to downcast to ReplaceNetworkAclEntryInput")?;
...
/// Error type for the `ReplaceNetworkAclEntryError` operation.
#[non_exhaustive]
...
pub enum ReplaceNetworkAclEntryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReplaceNetworkAclEntryError) for what information is available for the error.")]
...
impl ReplaceNetworkAclEntryError {
    /// Creates the `ReplaceNetworkAclEntryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceNetworkAclEntryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReplaceNetworkAclEntryError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReplaceNetworkAclEntryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::replace_network_acl_entry::ReplaceNetworkAclEntryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::replace_network_acl_entry::_replace_network_acl_entry_output::ReplaceNetworkAclEntryOutput;

pub use crate::operation::replace_network_acl_entry::_replace_network_acl_entry_input::ReplaceNetworkAclEntryInput;

mod _replace_network_acl_entry_input;

mod _replace_network_acl_entry_output;
