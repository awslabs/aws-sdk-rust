    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_transit_gateways::DescribeTransitGatewaysError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_transit_gateways::DescribeTransitGatewaysOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeTransitGatewaysResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeTransitGatewaysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_transit_gateways::DescribeTransitGatewaysInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_transit_gateways_input::ser_describe_transit_gateways_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeTransitGatewaysEndpointParamsInterceptor {
...
pub type DescribeTransitGatewaysErrorKind = DescribeTransitGatewaysError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeTransitGatewaysError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_transit_gateways::DescribeTransitGatewaysError {
...
impl DescribeTransitGatewaysError {
    ...
    /// Creates the `DescribeTransitGatewaysError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
