...
impl DescribeNetworkInterfacePermissionsOutputBuilder {
    ...
    /// <p>The network interface permissions.</p>
    pub fn set_network_interface_permissions(mut self, input: std::option::Option<std::vec::Vec<crate::types::NetworkInterfacePermission>>) -> Self {
        self.network_interface_permissions = input; self
    }
    /// <p>The token to use to retrieve the next page of results.</p>
