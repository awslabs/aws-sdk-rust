...
impl ModifyIdFormatInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_id_format::ModifyIdFormat, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyIdFormat {
    type Output =
        ::std::result::Result<crate::operation::modify_id_format::ModifyIdFormatOutput, crate::operation::modify_id_format::ModifyIdFormatError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_id_format::de_modify_id_format_http_response_with_props(status, headers, body)
        }
    }
}
