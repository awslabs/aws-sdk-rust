...
impl DescribeTransitGatewayRouteTablesInputBuilder {
    ...
    ///
    /// <p>The IDs of the transit gateway route tables.</p>
    pub fn transit_gateway_route_table_ids(mut self, input: impl Into<std::string::String>) -> Self {
    ...
    pub fn set_transit_gateway_route_table_ids(mut self, input: std::option::Option<std::vec::Vec<std::string::String>>) -> Self {
        self.transit_gateway_route_table_ids = input; self
    }
    ...
    pub fn build(self) -> Result<crate::operation::describe_transit_gateway_route_tables::DescribeTransitGatewayRouteTablesInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
