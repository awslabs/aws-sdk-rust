...
impl DeprovisionByoipCidrInput {
    /// Consumes the builder and constructs an Operation<[`DeprovisionByoipCidr`](crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidr)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidr, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deprovision_byoip_cidr_input::ser_deprovision_byoip_cidr_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidr::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeprovisionByoipCidr", "ec2"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeprovisionByoipCidr {
                type Output = std::result::Result<crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrOutput, crate::operation::deprovision_byoip_cidr::DeprovisionByoipCidrError>;
