...
impl CreateTransitGatewayRouteTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_transit_gateway_route_table::CreateTransitGatewayRouteTableInput, ::aws_smithy_types::error::operation::BuildError> {
