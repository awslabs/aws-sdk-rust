...
impl CreateTransitGatewayRouteTableInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::create_transit_gateway_route_table::CreateTransitGatewayRouteTableInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
