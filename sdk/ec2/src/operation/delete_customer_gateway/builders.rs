...
impl DeleteCustomerGatewayFluentBuilder  {
    /// Creates a new `DeleteCustomerGateway`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_customer_gateway::DeleteCustomerGateway, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_customer_gateway::DeleteCustomerGatewayError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_customer_gateway::DeleteCustomerGatewayOutput, aws_smithy_http::result::SdkError<crate::operation::delete_customer_gateway::DeleteCustomerGatewayError>>
                     {
