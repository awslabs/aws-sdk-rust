...
impl RevokeClientVpnIngressFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressOutput, crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError, Self> {
