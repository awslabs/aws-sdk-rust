...
impl CreateNetworkAclInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_network_acl::CreateNetworkAcl::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNetworkAcl {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_network_acl::de_create_network_acl_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::create_network_acl::CreateNetworkAclError
{
