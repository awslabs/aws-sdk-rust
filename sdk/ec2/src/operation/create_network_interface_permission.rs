...
impl CreateNetworkInterfacePermissionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_network_interface_permission::CreateNetworkInterfacePermission::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNetworkInterfacePermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_network_interface_permission::de_create_network_interface_permission_http_response_with_props(
                status, headers, body,
            )
        }
    }
