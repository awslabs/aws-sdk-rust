...
impl DeleteVpnConnectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_vpn_connection::DeleteVpnConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_vpn_connection::DeleteVpnConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_vpn_connection::DeleteVpnConnectionOutput, crate::operation::delete_vpn_connection::DeleteVpnConnectionError, Self> {
