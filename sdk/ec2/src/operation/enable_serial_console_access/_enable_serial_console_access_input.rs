...
impl EnableSerialConsoleAccessInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_serial_console_access::EnableSerialConsoleAccessInput, ::aws_smithy_types::error::operation::BuildError> {
