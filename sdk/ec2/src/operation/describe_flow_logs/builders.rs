...
impl DescribeFlowLogsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_flow_logs::DescribeFlowLogsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_flow_logs::DescribeFlowLogsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_flow_logs::DescribeFlowLogsOutput, crate::operation::describe_flow_logs::DescribeFlowLogsError, Self> {
