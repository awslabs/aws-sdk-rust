...
impl crate::operation::reject_transit_gateway_vpc_attachment::builders::RejectTransitGatewayVpcAttachmentInputBuilder {
...
impl RejectTransitGatewayVpcAttachmentFluentBuilder {
    /// Creates a new `RejectTransitGatewayVpcAttachmentFluentBuilder`.
