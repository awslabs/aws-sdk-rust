...
impl RejectTransitGatewayVpcAttachmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_transit_gateway_vpc_attachment::RejectTransitGatewayVpcAttachmentInput, ::aws_smithy_types::error::operation::BuildError> {
