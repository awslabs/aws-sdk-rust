    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_addresses_attribute::DescribeAddressesAttributeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_addresses_attribute::DescribeAddressesAttributeOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAddressesAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeAddressesAttribute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAddressesAttribute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeAddressesAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeAddressesAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_addresses_attribute::DescribeAddressesAttributeInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_addresses_attribute_input::ser_describe_addresses_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAddressesAttributeEndpointParamsInterceptor {
...
pub type DescribeAddressesAttributeErrorKind = DescribeAddressesAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeAddressesAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_addresses_attribute::DescribeAddressesAttributeError {
...
impl DescribeAddressesAttributeError {
    ...
    /// Creates the `DescribeAddressesAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
