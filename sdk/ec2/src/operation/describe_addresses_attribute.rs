...
impl DescribeAddressesAttributeInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_addresses_attribute::DescribeAddressesAttribute::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAddressesAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_addresses_attribute::de_describe_addresses_attribute_http_response_with_props(status, headers, body)
        }
    }
}
