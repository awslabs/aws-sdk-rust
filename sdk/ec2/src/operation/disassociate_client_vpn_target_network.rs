    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateClientVpnTargetNetwork {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateClientVpnTargetNetwork");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateClientVpnTargetNetworkRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateClientVpnTargetNetworkResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateClientVpnTargetNetwork")
...
.with_interceptor(DisassociateClientVpnTargetNetworkEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_client_vpn_target_network::de_disassociate_client_vpn_target_network_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateClientVpnTargetNetworkRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_client_vpn_target_network_input::ser_disassociate_client_vpn_target_network_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisassociateClientVpnTargetNetworkEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateClientVpnTargetNetworkEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateClientVpnTargetNetworkEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateClientVpnTargetNetworkInput>()
                        .ok_or("failed to downcast to DisassociateClientVpnTargetNetworkInput")?;
...
/// Error type for the `DisassociateClientVpnTargetNetworkError` operation.
#[non_exhaustive]
...
pub enum DisassociateClientVpnTargetNetworkError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateClientVpnTargetNetworkError) for what information is available for the error.")]
...
impl DisassociateClientVpnTargetNetworkError {
    /// Creates the `DisassociateClientVpnTargetNetworkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateClientVpnTargetNetworkError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateClientVpnTargetNetworkError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateClientVpnTargetNetworkError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_client_vpn_target_network::DisassociateClientVpnTargetNetworkError {
...
mod _disassociate_client_vpn_target_network_output;
