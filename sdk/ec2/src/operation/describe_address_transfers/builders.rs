...
impl DescribeAddressTransfersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_address_transfers::DescribeAddressTransfersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_address_transfers::DescribeAddressTransfersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_address_transfers::DescribeAddressTransfersOutput, crate::operation::describe_address_transfers::DescribeAddressTransfersError, Self> {
