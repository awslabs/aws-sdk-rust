...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationOutput,
                    crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationError,
                > for EnableVgwRoutePropagationFluentBuilder
            {
                fn send(
                    self,
...
impl EnableVgwRoutePropagationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationOutput, crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationError, Self> {
