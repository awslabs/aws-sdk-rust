...
impl EnableVgwRoutePropagationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_vgw_route_propagation::EnableVgwRoutePropagationInput, ::aws_smithy_types::error::operation::BuildError> {
