...
impl CreateTransitGatewayVpcAttachmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_transit_gateway_vpc_attachment::CreateTransitGatewayVpcAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_transit_gateway_vpc_attachment::CreateTransitGatewayVpcAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_transit_gateway_vpc_attachment::CreateTransitGatewayVpcAttachmentOutput, crate::operation::create_transit_gateway_vpc_attachment::CreateTransitGatewayVpcAttachmentError, Self> {
