...
impl GetFlowLogsIntegrationTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateOutput, crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError, Self> {
