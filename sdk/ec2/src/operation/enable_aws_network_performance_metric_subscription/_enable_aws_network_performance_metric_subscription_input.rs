...
impl EnableAwsNetworkPerformanceMetricSubscriptionInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::enable_aws_network_performance_metric_subscription::EnableAwsNetworkPerformanceMetricSubscriptionInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
