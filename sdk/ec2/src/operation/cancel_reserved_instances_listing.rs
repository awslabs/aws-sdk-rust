...
impl CancelReservedInstancesListingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListing::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelReservedInstancesListing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_reserved_instances_listing::de_cancel_reserved_instances_listing_http_response_with_props(
                status, headers, body,
            )
        }
    }
