        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargets::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl DescribeTrafficMirrorTargetsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_traffic_mirror_targets_output_output_traffic_mirror_targets(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
