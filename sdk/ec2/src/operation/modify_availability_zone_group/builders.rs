...
impl ModifyAvailabilityZoneGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupOutput, crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroupError, Self> {
