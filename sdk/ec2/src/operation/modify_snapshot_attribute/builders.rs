...
impl ModifySnapshotAttributeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeOutput, crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeError, Self> {
