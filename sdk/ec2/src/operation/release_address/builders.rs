...
impl crate::operation::release_address::builders::ReleaseAddressInputBuilder {
...
/// <p>\[Default VPC\] Releasing an Elastic IP address automatically disassociates it from any instance that it's associated with. Alternatively, you can disassociate an Elastic IP address without releasing it.</p>
/// <p>\[Nondefault VPC\] You must disassociate the Elastic IP address before you can release it. Otherwise, Amazon EC2 returns an error (InvalidIPAddress.InUse).</p>
...
/// <p>After you release an Elastic IP address, you might be able to recover it. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-instance-addressing-eips-releasing.html">Release an Elastic IP address</a>.</p>
...
impl ReleaseAddressFluentBuilder {
    /// Creates a new `ReleaseAddressFluentBuilder`.
