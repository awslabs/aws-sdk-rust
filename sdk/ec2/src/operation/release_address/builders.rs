...
impl ReleaseAddressFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::release_address::ReleaseAddressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::release_address::ReleaseAddressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::release_address::ReleaseAddressOutput, crate::operation::release_address::ReleaseAddressError, Self> {
