...
impl CopySnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_snapshot::CopySnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopySnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_copy_snapshot::de_copy_snapshot_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_copy_snapshot::de_copy_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
