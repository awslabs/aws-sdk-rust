...
impl CopySnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::copy_snapshot::CopySnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_copy_snapshot_input::ser_copy_snapshot_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopySnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_snapshot::de_copy_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
