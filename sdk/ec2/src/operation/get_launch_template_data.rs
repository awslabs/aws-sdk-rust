...
impl GetLaunchTemplateData {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_launch_template_data::GetLaunchTemplateDataError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_launch_template_data::GetLaunchTemplateDataOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetLaunchTemplateData", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLaunchTemplateData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetLaunchTemplateData", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLaunchTemplateData")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetLaunchTemplateDataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetLaunchTemplateDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_launch_template_data::GetLaunchTemplateDataInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_launch_template_data_input::ser_get_launch_template_data_input_input(&input)?,
        );
...
pub type GetLaunchTemplateDataErrorKind = GetLaunchTemplateDataError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetLaunchTemplateDataError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_launch_template_data::GetLaunchTemplateDataError {
...
impl GetLaunchTemplateDataError {
    ...
    /// Creates the `GetLaunchTemplateDataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
