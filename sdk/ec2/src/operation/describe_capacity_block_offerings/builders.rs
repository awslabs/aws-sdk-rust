...
impl DescribeCapacityBlockOfferingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_capacity_block_offerings::DescribeCapacityBlockOfferingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_capacity_block_offerings::DescribeCapacityBlockOfferingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_capacity_block_offerings::DescribeCapacityBlockOfferingsOutput, crate::operation::describe_capacity_block_offerings::DescribeCapacityBlockOfferingsError, Self> {
