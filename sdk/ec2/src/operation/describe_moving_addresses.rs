...
impl DescribeMovingAddresses {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_moving_addresses::DescribeMovingAddressesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_moving_addresses::DescribeMovingAddressesOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeMovingAddresses", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeMovingAddresses {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeMovingAddresses", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeMovingAddresses")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeMovingAddressesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeMovingAddressesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_moving_addresses::DescribeMovingAddressesInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_moving_addresses_input::ser_describe_moving_addresses_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeMovingAddressesEndpointParamsInterceptor {
...
pub type DescribeMovingAddressesErrorKind = DescribeMovingAddressesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeMovingAddressesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_moving_addresses::DescribeMovingAddressesError {
...
impl DescribeMovingAddressesError {
    ...
    /// Creates the `DescribeMovingAddressesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
