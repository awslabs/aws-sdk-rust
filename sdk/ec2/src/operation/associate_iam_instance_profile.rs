...
impl AssociateIamInstanceProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateIamInstanceProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_iam_instance_profile::de_associate_iam_instance_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
