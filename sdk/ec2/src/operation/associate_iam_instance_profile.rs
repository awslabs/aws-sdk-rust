...
/// Orchestration and serialization glue logic for `AssociateIamInstanceProfile`.
...
impl AssociateIamInstanceProfile {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateIamInstanceProfile {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateIamInstanceProfile");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateIamInstanceProfileRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateIamInstanceProfileResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateIamInstanceProfile")
...
.with_interceptor(AssociateIamInstanceProfileEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError>::new());
...
#[derive(Debug)]
            struct AssociateIamInstanceProfileResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateIamInstanceProfileResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_iam_instance_profile::de_associate_iam_instance_profile_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_iam_instance_profile::de_associate_iam_instance_profile_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateIamInstanceProfileRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_iam_instance_profile_input::ser_associate_iam_instance_profile_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AssociateIamInstanceProfileEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateIamInstanceProfileEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateIamInstanceProfileEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateIamInstanceProfileInput>()
                        .ok_or("failed to downcast to AssociateIamInstanceProfileInput")?;
...
/// Error type for the `AssociateIamInstanceProfileError` operation.
#[non_exhaustive]
...
pub enum AssociateIamInstanceProfileError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateIamInstanceProfileError) for what information is available for the error.")]
...
impl AssociateIamInstanceProfileError {
    /// Creates the `AssociateIamInstanceProfileError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateIamInstanceProfileError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateIamInstanceProfileError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateIamInstanceProfileError {
