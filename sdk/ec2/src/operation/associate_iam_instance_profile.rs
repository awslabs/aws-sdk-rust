    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateIamInstanceProfile {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AssociateIamInstanceProfile", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateIamInstanceProfile")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateIamInstanceProfileResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateIamInstanceProfileRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_iam_instance_profile_input::ser_associate_iam_instance_profile_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateIamInstanceProfileEndpointParamsInterceptor {
...
pub type AssociateIamInstanceProfileErrorKind = AssociateIamInstanceProfileError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateIamInstanceProfileError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileError {
...
impl AssociateIamInstanceProfileError {
    ...
    /// Creates the `AssociateIamInstanceProfileError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
