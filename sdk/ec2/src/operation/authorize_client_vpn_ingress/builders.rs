...
impl AuthorizeClientVpnIngressFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressOutput, crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressError, Self> {
