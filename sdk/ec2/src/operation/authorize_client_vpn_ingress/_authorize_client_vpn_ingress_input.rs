...
impl AuthorizeClientVpnIngressInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressInput, ::aws_smithy_types::error::operation::BuildError> {
