...
impl DescribeVpcEndpointConnectionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnections::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVpcEndpointConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vpc_endpoint_connections::de_describe_vpc_endpoint_connections_http_response_with_props(
                status, headers, body,
            )
        }
    }
