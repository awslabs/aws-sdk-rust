...
impl WithdrawByoipCidrInput {
    /// Consumes the builder and constructs an Operation<[`WithdrawByoipCidr`](crate::operation::withdraw_byoip_cidr::WithdrawByoipCidr)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidr, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_withdraw_byoip_cidr_input::ser_withdraw_byoip_cidr_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::withdraw_byoip_cidr::WithdrawByoipCidr::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("WithdrawByoipCidr", "ec2"));
...
impl aws_smithy_http::response::ParseStrictResponse for WithdrawByoipCidr {
                type Output = std::result::Result<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrOutput, crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError>;
