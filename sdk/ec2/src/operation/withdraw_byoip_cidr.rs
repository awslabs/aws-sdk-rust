...
impl WithdrawByoipCidr {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrInput,
                    ) -> ::std::result::Result<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for WithdrawByoipCidr {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("WithdrawByoipCidr");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(WithdrawByoipCidrRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(WithdrawByoipCidrResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("WithdrawByoipCidr")
...
.with_interceptor(WithdrawByoipCidrEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrError>::new());
...
#[derive(Debug)]
            struct WithdrawByoipCidrResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for WithdrawByoipCidrResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_withdraw_byoip_cidr::de_withdraw_byoip_cidr_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_withdraw_byoip_cidr::de_withdraw_byoip_cidr_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for WithdrawByoipCidrRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::withdraw_byoip_cidr::WithdrawByoipCidrInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_withdraw_byoip_cidr_input::ser_withdraw_byoip_cidr_input_input_input(&input)?);
...
#[derive(Debug)]
            struct WithdrawByoipCidrEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for WithdrawByoipCidrEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "WithdrawByoipCidrEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<WithdrawByoipCidrInput>()
                        .ok_or("failed to downcast to WithdrawByoipCidrInput")?;
...
pub enum WithdrawByoipCidrError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-WithdrawByoipCidrError) for what information is available for the error.")]
...
impl WithdrawByoipCidrError {
    /// Creates the `WithdrawByoipCidrError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `WithdrawByoipCidrError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for WithdrawByoipCidrError {
