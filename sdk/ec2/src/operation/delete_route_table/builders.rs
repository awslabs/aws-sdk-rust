...
impl DeleteRouteTableFluentBuilder  {
    /// Creates a new `DeleteRouteTable`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_route_table::DeleteRouteTableOutput, aws_smithy_http::result::SdkError<crate::operation::delete_route_table::DeleteRouteTableError>>
                     {
