...
impl AssignIpv6AddressesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::assign_ipv6_addresses::AssignIpv6AddressesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::assign_ipv6_addresses::AssignIpv6AddressesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::assign_ipv6_addresses::AssignIpv6AddressesOutput, crate::operation::assign_ipv6_addresses::AssignIpv6AddressesError, Self> {
