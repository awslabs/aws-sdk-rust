...
impl ResetEbsDefaultKmsKeyIdInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyIdInput, ::aws_smithy_types::error::operation::BuildError> {
