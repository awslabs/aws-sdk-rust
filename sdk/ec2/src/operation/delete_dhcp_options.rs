...
impl DeleteDhcpOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_dhcp_options::DeleteDhcpOptions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDhcpOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_dhcp_options::de_delete_dhcp_options_http_response_with_props(status, headers, body)
        }
    }
}
