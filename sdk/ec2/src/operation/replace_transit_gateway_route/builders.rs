...
impl crate::operation::replace_transit_gateway_route::builders::ReplaceTransitGatewayRouteInputBuilder {
...
impl ReplaceTransitGatewayRouteFluentBuilder {
    /// Creates a new `ReplaceTransitGatewayRouteFluentBuilder`.
