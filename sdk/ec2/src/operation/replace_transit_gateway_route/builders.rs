...
impl ReplaceTransitGatewayRouteInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.replace_transit_gateway_route();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput,
                    crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError,
                > for ReplaceTransitGatewayRouteFluentBuilder
            {
                fn send(
                    self,
...
impl ReplaceTransitGatewayRouteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRoute::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRoute::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput, crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError, Self> {
