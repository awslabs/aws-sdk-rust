...
impl ModifyInstanceEventWindowInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_instance_event_window::ModifyInstanceEventWindow::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyInstanceEventWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_instance_event_window::de_modify_instance_event_window_http_response_with_props(status, headers, body)
        }
    }
}
