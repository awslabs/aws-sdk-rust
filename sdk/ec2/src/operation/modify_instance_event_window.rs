...
impl ModifyInstanceEventWindow {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyInstanceEventWindow {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyInstanceEventWindow");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyInstanceEventWindowRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyInstanceEventWindowResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyInstanceEventWindow")
...
.with_interceptor(ModifyInstanceEventWindowEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError>::new());
...
#[derive(Debug)]
            struct ModifyInstanceEventWindowRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyInstanceEventWindowRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_instance_event_window::ModifyInstanceEventWindowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_instance_event_window_input::ser_modify_instance_event_window_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyInstanceEventWindowEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyInstanceEventWindowEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyInstanceEventWindowEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyInstanceEventWindowInput>()
                        .ok_or("failed to downcast to ModifyInstanceEventWindowInput")?;
...
/// Error type for the `ModifyInstanceEventWindowError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ModifyInstanceEventWindowError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyInstanceEventWindowError) for what information is available for the error.")]
...
impl ModifyInstanceEventWindowError {
    /// Creates the `ModifyInstanceEventWindowError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyInstanceEventWindowError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyInstanceEventWindowError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyInstanceEventWindowError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError {
...
mod _modify_instance_event_window_output;
