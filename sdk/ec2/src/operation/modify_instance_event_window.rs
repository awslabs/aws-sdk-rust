    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyInstanceEventWindow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifyInstanceEventWindow", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyInstanceEventWindow")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyInstanceEventWindowResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyInstanceEventWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_instance_event_window::ModifyInstanceEventWindowInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_instance_event_window_input::ser_modify_instance_event_window_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyInstanceEventWindowEndpointParamsInterceptor {
...
pub type ModifyInstanceEventWindowErrorKind = ModifyInstanceEventWindowError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyInstanceEventWindowError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_instance_event_window::ModifyInstanceEventWindowError {
...
impl ModifyInstanceEventWindowError {
    ...
    /// Creates the `ModifyInstanceEventWindowError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
