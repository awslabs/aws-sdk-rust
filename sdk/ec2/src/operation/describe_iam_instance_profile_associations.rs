...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeIamInstanceProfileAssociations {
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeIamInstanceProfileAssociations")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeIamInstanceProfileAssociationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeIamInstanceProfileAssociationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_iam_instance_profile_associations_input::ser_describe_iam_instance_profile_associations_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeIamInstanceProfileAssociationsEndpointParamsInterceptor {
...
pub type DescribeIamInstanceProfileAssociationsErrorKind = DescribeIamInstanceProfileAssociationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeIamInstanceProfileAssociationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_iam_instance_profile_associations::DescribeIamInstanceProfileAssociationsError {
...
impl DescribeIamInstanceProfileAssociationsError {
    ...
    /// Creates the `DescribeIamInstanceProfileAssociationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
