...
impl AllocateAddress {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EC2", "AllocateAddress", input, runtime_plugins, stop_point)
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllocateAddress")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("AllocateAddress", "EC2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllocateAddressResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_allocate_address::de_allocate_address_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_allocate_address::de_allocate_address_http_response(status, headers, body, _cfg)
        };
