...
impl DeleteLaunchTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_launch_template::DeleteLaunchTemplateError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_launch_template::DeleteLaunchTemplateOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteLaunchTemplate", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLaunchTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteLaunchTemplate", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteLaunchTemplate")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteLaunchTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteLaunchTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_launch_template::DeleteLaunchTemplateInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_launch_template_input::ser_delete_launch_template_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteLaunchTemplateEndpointParamsInterceptor {
...
pub type DeleteLaunchTemplateErrorKind = DeleteLaunchTemplateError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteLaunchTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_launch_template::DeleteLaunchTemplateError {
...
impl DeleteLaunchTemplateError {
    ...
    /// Creates the `DeleteLaunchTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
