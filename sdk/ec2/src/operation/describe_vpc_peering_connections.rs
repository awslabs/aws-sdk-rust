...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_vpc_peering_connections_input::ser_describe_vpc_peering_connections_input_input_input(&input)?);
