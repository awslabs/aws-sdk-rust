...
impl DisableVpcClassicLink {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableVpcClassicLink {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableVpcClassicLink");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableVpcClassicLinkRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableVpcClassicLinkResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableVpcClassicLink")
...
.with_interceptor(DisableVpcClassicLinkEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_disable_vpc_classic_link::de_disable_vpc_classic_link_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableVpcClassicLinkRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_vpc_classic_link_input::ser_disable_vpc_classic_link_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableVpcClassicLinkEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableVpcClassicLinkEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableVpcClassicLinkEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableVpcClassicLinkInput>()
                        .ok_or("failed to downcast to DisableVpcClassicLinkInput")?;
...
/// Error type for the `DisableVpcClassicLinkError` operation.
#[non_exhaustive]
...
pub enum DisableVpcClassicLinkError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableVpcClassicLinkError) for what information is available for the error.")]
...
impl DisableVpcClassicLinkError {
    /// Creates the `DisableVpcClassicLinkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableVpcClassicLinkError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisableVpcClassicLinkError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableVpcClassicLinkError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError {
...
mod _disable_vpc_classic_link_output;
