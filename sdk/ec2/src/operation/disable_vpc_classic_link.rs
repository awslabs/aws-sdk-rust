...
impl DisableVpcClassicLink {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DisableVpcClassicLink", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableVpcClassicLink {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DisableVpcClassicLink", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableVpcClassicLink")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DisableVpcClassicLinkResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DisableVpcClassicLinkRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_vpc_classic_link_input::ser_disable_vpc_classic_link_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisableVpcClassicLinkEndpointParamsInterceptor {
...
pub type DisableVpcClassicLinkErrorKind = DisableVpcClassicLinkError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisableVpcClassicLinkError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_vpc_classic_link::DisableVpcClassicLinkError {
...
impl DisableVpcClassicLinkError {
    ...
    /// Creates the `DisableVpcClassicLinkError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
