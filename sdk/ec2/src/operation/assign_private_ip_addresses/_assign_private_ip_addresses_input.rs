...
impl AssignPrivateIpAddressesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::assign_private_ip_addresses::AssignPrivateIpAddressesInput, ::aws_smithy_types::error::operation::BuildError> {
