...
impl CreateLocalGatewayRoute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateLocalGatewayRoute", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLocalGatewayRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateLocalGatewayRoute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLocalGatewayRoute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateLocalGatewayRouteResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateLocalGatewayRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_local_gateway_route_input::ser_create_local_gateway_route_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateLocalGatewayRouteEndpointParamsInterceptor {
...
pub type CreateLocalGatewayRouteErrorKind = CreateLocalGatewayRouteError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateLocalGatewayRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_local_gateway_route::CreateLocalGatewayRouteError {
...
impl CreateLocalGatewayRouteError {
    ...
    /// Creates the `CreateLocalGatewayRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
