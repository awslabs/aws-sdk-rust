    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_network_insights_paths::DescribeNetworkInsightsPathsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_network_insights_paths::DescribeNetworkInsightsPathsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeNetworkInsightsPaths {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeNetworkInsightsPaths", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeNetworkInsightsPaths")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeNetworkInsightsPathsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeNetworkInsightsPathsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_network_insights_paths::DescribeNetworkInsightsPathsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeNetworkInsightsPathsEndpointParamsInterceptor {
...
pub type DescribeNetworkInsightsPathsErrorKind = DescribeNetworkInsightsPathsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeNetworkInsightsPathsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_network_insights_paths::DescribeNetworkInsightsPathsError {
...
impl DescribeNetworkInsightsPathsError {
    ...
    /// Creates the `DescribeNetworkInsightsPathsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
