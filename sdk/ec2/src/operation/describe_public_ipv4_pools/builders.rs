...
impl DescribePublicIpv4PoolsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsOutput, crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsError, Self> {
