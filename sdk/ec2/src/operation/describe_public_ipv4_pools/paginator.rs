        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_public_ipv4_pools::DescribePublicIpv4Pools::orchestrate(&runtime_plugins, input.clone()).await;
...
impl DescribePublicIpv4PoolsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_public_ipv4_pools_output_output_public_ipv4_pools(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
