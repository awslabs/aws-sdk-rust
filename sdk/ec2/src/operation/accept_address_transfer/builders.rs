...
impl AcceptAddressTransferFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::accept_address_transfer::AcceptAddressTransferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_address_transfer::AcceptAddressTransferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::accept_address_transfer::AcceptAddressTransferOutput, crate::operation::accept_address_transfer::AcceptAddressTransferError, Self> {
