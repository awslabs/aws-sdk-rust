...
impl ModifyVpcAttribute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_vpc_attribute::ModifyVpcAttributeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_vpc_attribute::ModifyVpcAttributeOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ModifyVpcAttribute", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyVpcAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifyVpcAttribute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyVpcAttribute")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ModifyVpcAttributeEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyVpcAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyVpcAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_vpc_attribute::ModifyVpcAttributeInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_vpc_attribute_input::ser_modify_vpc_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyVpcAttributeEndpointParamsInterceptor {
...
pub type ModifyVpcAttributeErrorKind = ModifyVpcAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyVpcAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_vpc_attribute::ModifyVpcAttributeError {
...
impl ModifyVpcAttributeError {
    ...
    /// Creates the `ModifyVpcAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
