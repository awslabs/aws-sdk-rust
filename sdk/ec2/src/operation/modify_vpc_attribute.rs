...
impl ModifyVpcAttributeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_vpc_attribute::ModifyVpcAttribute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyVpcAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_modify_vpc_attribute::de_modify_vpc_attribute_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_vpc_attribute::ModifyVpcAttributeError
{
