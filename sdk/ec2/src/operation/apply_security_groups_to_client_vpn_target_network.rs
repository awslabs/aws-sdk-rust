...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ApplySecurityGroupsToClientVpnTargetNetwork {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ApplySecurityGroupsToClientVpnTargetNetworkRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ApplySecurityGroupsToClientVpnTargetNetworkResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ApplySecurityGroupsToClientVpnTargetNetwork")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ApplySecurityGroupsToClientVpnTargetNetwork")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    ApplySecurityGroupsToClientVpnTargetNetworkTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ApplySecurityGroupsToClientVpnTargetNetworkTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ApplySecurityGroupsToClientVpnTargetNetworkTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ApplySecurityGroupsToClientVpnTargetNetworkInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ApplySecurityGroupsToClientVpnTargetNetworkResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_apply_security_groups_to_client_vpn_target_network::de_apply_security_groups_to_client_vpn_target_network_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_apply_security_groups_to_client_vpn_target_network::de_apply_security_groups_to_client_vpn_target_network_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ApplySecurityGroupsToClientVpnTargetNetworkRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetworkInput,
