...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ApplySecurityGroupsToClientVpnTargetNetworkResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ApplySecurityGroupsToClientVpnTargetNetworkRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_apply_security_groups_to_client_vpn_target_network_input::ser_apply_security_groups_to_client_vpn_target_network_input_input(&input)?);
