    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchTransitGatewayRoutes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("SearchTransitGatewayRoutes", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchTransitGatewayRoutes")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SearchTransitGatewayRoutesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SearchTransitGatewayRoutesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_transit_gateway_routes_input::ser_search_transit_gateway_routes_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SearchTransitGatewayRoutesEndpointParamsInterceptor {
...
pub type SearchTransitGatewayRoutesErrorKind = SearchTransitGatewayRoutesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for SearchTransitGatewayRoutesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError {
...
impl SearchTransitGatewayRoutesError {
    ...
    /// Creates the `SearchTransitGatewayRoutesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
