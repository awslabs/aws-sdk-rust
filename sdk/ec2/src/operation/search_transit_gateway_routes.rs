...
impl SearchTransitGatewayRoutes {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchTransitGatewayRoutes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchTransitGatewayRoutes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchTransitGatewayRoutesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchTransitGatewayRoutesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchTransitGatewayRoutes")
...
.with_interceptor(SearchTransitGatewayRoutesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_search_transit_gateway_routes::de_search_transit_gateway_routes_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchTransitGatewayRoutesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_transit_gateway_routes_input::ser_search_transit_gateway_routes_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SearchTransitGatewayRoutesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchTransitGatewayRoutesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchTransitGatewayRoutesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchTransitGatewayRoutesInput>()
                        .ok_or("failed to downcast to SearchTransitGatewayRoutesInput")?;
...
/// Error type for the `SearchTransitGatewayRoutesError` operation.
#[non_exhaustive]
...
pub enum SearchTransitGatewayRoutesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchTransitGatewayRoutesError) for what information is available for the error.")]
...
impl SearchTransitGatewayRoutesError {
    /// Creates the `SearchTransitGatewayRoutesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchTransitGatewayRoutesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SearchTransitGatewayRoutesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchTransitGatewayRoutesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError {
...
mod _search_transit_gateway_routes_output;
