...
impl CreateInstanceConnectEndpointInput {
    /// Consumes the builder and constructs an Operation<[`CreateInstanceConnectEndpoint`](crate::operation::create_instance_connect_endpoint::CreateInstanceConnectEndpoint)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_instance_connect_endpoint_input::ser_create_instance_connect_endpoint_input_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_instance_connect_endpoint::CreateInstanceConnectEndpoint::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateInstanceConnectEndpoint", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInstanceConnectEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_instance_connect_endpoint::de_create_instance_connect_endpoint_http_response_with_props(
                status, headers, body,
            )
        }
    }
