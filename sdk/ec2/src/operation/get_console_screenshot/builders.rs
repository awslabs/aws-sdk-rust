...
impl GetConsoleScreenshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_console_screenshot::GetConsoleScreenshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_console_screenshot::GetConsoleScreenshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_console_screenshot::GetConsoleScreenshotOutput, crate::operation::get_console_screenshot::GetConsoleScreenshotError, Self> {
