...
impl crate::operation::describe_scheduled_instances::builders::DescribeScheduledInstancesInputBuilder {
...
impl DescribeScheduledInstancesFluentBuilder {
    /// Creates a new `DescribeScheduledInstancesFluentBuilder`.
