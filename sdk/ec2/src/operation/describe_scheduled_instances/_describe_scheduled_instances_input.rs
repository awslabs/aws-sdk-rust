...
impl DescribeScheduledInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_scheduled_instances::DescribeScheduledInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
