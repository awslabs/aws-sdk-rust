...
impl ModifyInstanceEventStartTime {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyInstanceEventStartTime {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyInstanceEventStartTime");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyInstanceEventStartTimeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyInstanceEventStartTimeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyInstanceEventStartTime")
...
.with_interceptor(ModifyInstanceEventStartTimeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_modify_instance_event_start_time::de_modify_instance_event_start_time_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyInstanceEventStartTimeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_instance_event_start_time_input::ser_modify_instance_event_start_time_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyInstanceEventStartTimeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyInstanceEventStartTimeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyInstanceEventStartTimeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyInstanceEventStartTimeInput>()
                        .ok_or("failed to downcast to ModifyInstanceEventStartTimeInput")?;
...
/// Error type for the `ModifyInstanceEventStartTimeError` operation.
#[non_exhaustive]
...
pub enum ModifyInstanceEventStartTimeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyInstanceEventStartTimeError) for what information is available for the error.")]
...
impl ModifyInstanceEventStartTimeError {
    /// Creates the `ModifyInstanceEventStartTimeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyInstanceEventStartTimeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyInstanceEventStartTimeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyInstanceEventStartTimeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError {
...
mod _modify_instance_event_start_time_output;
