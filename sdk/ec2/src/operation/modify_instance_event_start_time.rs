    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyInstanceEventStartTime {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifyInstanceEventStartTime", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyInstanceEventStartTime")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyInstanceEventStartTimeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyInstanceEventStartTimeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_instance_event_start_time_input::ser_modify_instance_event_start_time_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyInstanceEventStartTimeEndpointParamsInterceptor {
...
pub type ModifyInstanceEventStartTimeErrorKind = ModifyInstanceEventStartTimeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyInstanceEventStartTimeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_instance_event_start_time::ModifyInstanceEventStartTimeError {
...
impl ModifyInstanceEventStartTimeError {
    ...
    /// Creates the `ModifyInstanceEventStartTimeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
