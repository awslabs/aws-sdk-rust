...
impl DeleteTransitGatewayMulticastDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_transit_gateway_multicast_domain::DeleteTransitGatewayMulticastDomain,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_transit_gateway_multicast_domain::DeleteTransitGatewayMulticastDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTransitGatewayMulticastDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_transit_gateway_multicast_domain::de_delete_transit_gateway_multicast_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
