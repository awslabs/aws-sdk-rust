...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportClientVpnClientConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ExportClientVpnClientConfiguration", "ec2"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportClientVpnClientConfiguration")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ExportClientVpnClientConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ExportClientVpnClientConfigurationRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExportClientVpnClientConfigurationEndpointParamsInterceptor {
...
pub type ExportClientVpnClientConfigurationErrorKind = ExportClientVpnClientConfigurationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ExportClientVpnClientConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError {
...
impl ExportClientVpnClientConfigurationError {
    ...
    /// Creates the `ExportClientVpnClientConfigurationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
