...
impl ExportClientVpnClientConfiguration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportClientVpnClientConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportClientVpnClientConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExportClientVpnClientConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExportClientVpnClientConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportClientVpnClientConfiguration")
...
.with_interceptor(ExportClientVpnClientConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportClientVpnClientConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_export_client_vpn_client_configuration_input::ser_export_client_vpn_client_configuration_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ExportClientVpnClientConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExportClientVpnClientConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExportClientVpnClientConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExportClientVpnClientConfigurationInput>()
                        .ok_or("failed to downcast to ExportClientVpnClientConfigurationInput")?;
...
/// Error type for the `ExportClientVpnClientConfigurationError` operation.
#[non_exhaustive]
...
pub enum ExportClientVpnClientConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExportClientVpnClientConfigurationError) for what information is available for the error.")]
...
impl ExportClientVpnClientConfigurationError {
    /// Creates the `ExportClientVpnClientConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExportClientVpnClientConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ExportClientVpnClientConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExportClientVpnClientConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfigurationError {
...
mod _export_client_vpn_client_configuration_output;
