...
impl ExportClientVpnClientConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_client_vpn_client_configuration::ExportClientVpnClientConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportClientVpnClientConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_client_vpn_client_configuration::de_export_client_vpn_client_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
