...
impl DescribeBundleTasksFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_bundle_tasks::DescribeBundleTasksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_bundle_tasks::DescribeBundleTasksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_bundle_tasks::DescribeBundleTasksOutput, crate::operation::describe_bundle_tasks::DescribeBundleTasksError, Self> {
