...
/// Orchestration and serialization glue logic for `GetIpamAddressHistory`.
...
impl GetIpamAddressHistory {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_ipam_address_history::GetIpamAddressHistoryInput,
                    ) -> ::std::result::Result<crate::operation::get_ipam_address_history::GetIpamAddressHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_ipam_address_history::GetIpamAddressHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIpamAddressHistory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetIpamAddressHistory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetIpamAddressHistoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetIpamAddressHistoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIpamAddressHistory")
...
.with_interceptor(GetIpamAddressHistoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryError>::new());
...
#[derive(Debug)]
            struct GetIpamAddressHistoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetIpamAddressHistoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_ipam_address_history::de_get_ipam_address_history_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_ipam_address_history::de_get_ipam_address_history_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetIpamAddressHistoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetIpamAddressHistoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_ipam_address_history::GetIpamAddressHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_ipam_address_history_input::ser_get_ipam_address_history_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetIpamAddressHistoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetIpamAddressHistoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetIpamAddressHistoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetIpamAddressHistoryInput>()
                        .ok_or("failed to downcast to GetIpamAddressHistoryInput")?;
...
/// Error type for the `GetIpamAddressHistoryError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetIpamAddressHistoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetIpamAddressHistoryError) for what information is available for the error.")]
...
impl GetIpamAddressHistoryError {
    /// Creates the `GetIpamAddressHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetIpamAddressHistoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetIpamAddressHistoryError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetIpamAddressHistoryError {
