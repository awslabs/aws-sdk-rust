...
impl GetIpamAddressHistory {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetIpamAddressHistory", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIpamAddressHistory {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetIpamAddressHistory", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIpamAddressHistory")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetIpamAddressHistoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetIpamAddressHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_address_history::GetIpamAddressHistoryInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ipam_address_history_input::ser_get_ipam_address_history_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetIpamAddressHistoryEndpointParamsInterceptor {
...
pub type GetIpamAddressHistoryErrorKind = GetIpamAddressHistoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetIpamAddressHistoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ipam_address_history::GetIpamAddressHistoryError {
...
impl GetIpamAddressHistoryError {
    ...
    /// Creates the `GetIpamAddressHistoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
