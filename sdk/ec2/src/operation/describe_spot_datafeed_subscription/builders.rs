...
impl crate::operation::describe_spot_datafeed_subscription::builders::DescribeSpotDatafeedSubscriptionInputBuilder {
...
impl DescribeSpotDatafeedSubscriptionFluentBuilder {
    /// Creates a new `DescribeSpotDatafeedSubscriptionFluentBuilder`.
