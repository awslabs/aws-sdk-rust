...
impl DescribeSpotDatafeedSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
