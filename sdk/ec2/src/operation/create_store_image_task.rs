...
impl CreateStoreImageTask {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_store_image_task::CreateStoreImageTaskError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_store_image_task::CreateStoreImageTaskOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateStoreImageTask", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateStoreImageTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateStoreImageTask", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateStoreImageTask")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateStoreImageTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateStoreImageTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_store_image_task::CreateStoreImageTaskInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_store_image_task_input::ser_create_store_image_task_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateStoreImageTaskEndpointParamsInterceptor {
...
pub type CreateStoreImageTaskErrorKind = CreateStoreImageTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateStoreImageTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_store_image_task::CreateStoreImageTaskError {
...
impl CreateStoreImageTaskError {
    ...
    /// Creates the `CreateStoreImageTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
