...
impl DescribeVerifiedAccessTrustProvidersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_verified_access_trust_providers::DescribeVerifiedAccessTrustProvidersInput, ::aws_smithy_types::error::operation::BuildError> {
