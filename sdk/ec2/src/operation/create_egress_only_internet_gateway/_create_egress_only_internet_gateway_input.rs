...
impl CreateEgressOnlyInternetGatewayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_egress_only_internet_gateway::CreateEgressOnlyInternetGatewayInput, ::aws_smithy_types::error::operation::BuildError> {
