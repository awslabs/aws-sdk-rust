...
impl DeleteManagedPrefixList {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteManagedPrefixList {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteManagedPrefixList");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteManagedPrefixListRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteManagedPrefixListResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteManagedPrefixList")
...
.with_interceptor(DeleteManagedPrefixListEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_delete_managed_prefix_list::de_delete_managed_prefix_list_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteManagedPrefixListRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_managed_prefix_list_input::ser_delete_managed_prefix_list_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteManagedPrefixListEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteManagedPrefixListEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteManagedPrefixListEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteManagedPrefixListInput>()
                        .ok_or("failed to downcast to DeleteManagedPrefixListInput")?;
...
/// Error type for the `DeleteManagedPrefixListError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteManagedPrefixListError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteManagedPrefixListError) for what information is available for the error.")]
...
impl DeleteManagedPrefixListError {
    /// Creates the `DeleteManagedPrefixListError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteManagedPrefixListError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteManagedPrefixListError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteManagedPrefixListError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError {
...
mod _delete_managed_prefix_list_output;
