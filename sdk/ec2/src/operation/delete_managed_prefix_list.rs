...
impl DeleteManagedPrefixList {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteManagedPrefixList", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteManagedPrefixList {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteManagedPrefixList", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteManagedPrefixList")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteManagedPrefixListResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteManagedPrefixListRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_managed_prefix_list_input::ser_delete_managed_prefix_list_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteManagedPrefixListEndpointParamsInterceptor {
...
pub type DeleteManagedPrefixListErrorKind = DeleteManagedPrefixListError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteManagedPrefixListError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_managed_prefix_list::DeleteManagedPrefixListError {
...
impl DeleteManagedPrefixListError {
    ...
    /// Creates the `DeleteManagedPrefixListError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
