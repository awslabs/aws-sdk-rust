...
impl ModifyNetworkInterfaceAttributeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_network_interface_attribute::ModifyNetworkInterfaceAttribute,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_network_interface_attribute::ModifyNetworkInterfaceAttribute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyNetworkInterfaceAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_network_interface_attribute::de_modify_network_interface_attribute_http_response_with_props(
                status, headers, body,
            )
        }
    }
