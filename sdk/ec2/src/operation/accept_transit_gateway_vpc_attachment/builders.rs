...
impl crate::operation::accept_transit_gateway_vpc_attachment::builders::AcceptTransitGatewayVpcAttachmentInputBuilder {
...
impl AcceptTransitGatewayVpcAttachmentFluentBuilder {
    /// Creates a new `AcceptTransitGatewayVpcAttachmentFluentBuilder`.
