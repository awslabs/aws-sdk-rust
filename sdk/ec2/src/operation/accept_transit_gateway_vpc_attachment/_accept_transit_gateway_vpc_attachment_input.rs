...
impl AcceptTransitGatewayVpcAttachmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_transit_gateway_vpc_attachment::AcceptTransitGatewayVpcAttachmentInput, ::aws_smithy_types::error::operation::BuildError> {
