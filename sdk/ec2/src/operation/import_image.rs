...
impl ImportImageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_image::ImportImage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_import_image::de_import_image_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_import_image::de_import_image_http_response_with_props(
                status, headers, body,
            )
        }
    }
