...
impl MoveByoipCidrToIpamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamOutput, crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError, Self> {
