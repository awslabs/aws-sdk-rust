...
impl CreateIpamPoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_ipam_pool_input::ser_create_ipam_pool_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_ipam_pool::CreateIpamPool::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIpamPool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_ipam_pool::de_create_ipam_pool_http_error(
                status, headers, body,
            )
        } else {
