...
impl AcceptTransitGatewayPeeringAttachmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_transit_gateway_peering_attachment::AcceptTransitGatewayPeeringAttachmentInput, ::aws_smithy_http::operation::error::BuildError>{
