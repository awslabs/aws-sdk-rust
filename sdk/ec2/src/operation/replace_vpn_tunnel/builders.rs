...
impl ReplaceVpnTunnelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelOutput, crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError, Self> {
