...
impl DisableImageDeprecationInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.disable_image_deprecation();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::disable_image_deprecation::DisableImageDeprecationOutput,
                    crate::operation::disable_image_deprecation::DisableImageDeprecationError,
                > for DisableImageDeprecationFluentBuilder
            {
                fn send(
                    self,
...
impl DisableImageDeprecationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disable_image_deprecation::DisableImageDeprecationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_image_deprecation::DisableImageDeprecationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::disable_image_deprecation::DisableImageDeprecation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::disable_image_deprecation::DisableImageDeprecation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disable_image_deprecation::DisableImageDeprecationOutput, crate::operation::disable_image_deprecation::DisableImageDeprecationError, Self> {
