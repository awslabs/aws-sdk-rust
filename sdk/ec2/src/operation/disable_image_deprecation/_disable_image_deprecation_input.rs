...
impl DisableImageDeprecationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_image_deprecation::DisableImageDeprecationInput, ::aws_smithy_types::error::operation::BuildError> {
