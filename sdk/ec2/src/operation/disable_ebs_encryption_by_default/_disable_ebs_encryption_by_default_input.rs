...
impl DisableEbsEncryptionByDefaultInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultInput, ::aws_smithy_types::error::operation::BuildError> {
