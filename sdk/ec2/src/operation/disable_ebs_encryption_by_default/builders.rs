...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput,
                    crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError,
                > for DisableEbsEncryptionByDefaultFluentBuilder
            {
                fn send(
                    self,
...
impl DisableEbsEncryptionByDefaultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefault::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefault::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput, crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError, Self> {
