...
impl DescribeReservedInstancesListingsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::describe_reserved_instances_listings::DescribeReservedInstancesListingsOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_reserved_instances_listings::DescribeReservedInstancesListingsError, ::aws_smithy_http::operation::Response>>
