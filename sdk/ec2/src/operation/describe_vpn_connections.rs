...
impl DescribeVpnConnections {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpn_connections::DescribeVpnConnectionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpn_connections::DescribeVpnConnectionsOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeVpnConnections", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpnConnections {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeVpnConnections", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVpnConnections")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeVpnConnectionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeVpnConnectionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpn_connections::DescribeVpnConnectionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_vpn_connections::DescribeVpnConnectionsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpn_connections_input::ser_describe_vpn_connections_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeVpnConnectionsEndpointParamsInterceptor {
...
pub type DescribeVpnConnectionsErrorKind = DescribeVpnConnectionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeVpnConnectionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_vpn_connections::DescribeVpnConnectionsError {
...
impl DescribeVpnConnectionsError {
    ...
    /// Creates the `DescribeVpnConnectionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
