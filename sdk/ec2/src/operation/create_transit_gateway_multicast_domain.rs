...
impl CreateTransitGatewayMulticastDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_transit_gateway_multicast_domain::CreateTransitGatewayMulticastDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTransitGatewayMulticastDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_transit_gateway_multicast_domain::de_create_transit_gateway_multicast_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
