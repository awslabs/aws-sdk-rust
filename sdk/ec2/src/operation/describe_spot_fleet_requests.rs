    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSpotFleetRequests {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSpotFleetRequests", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSpotFleetRequests")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeSpotFleetRequestsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeSpotFleetRequestsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_fleet_requests_input::ser_describe_spot_fleet_requests_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSpotFleetRequestsEndpointParamsInterceptor {
...
pub type DescribeSpotFleetRequestsErrorKind = DescribeSpotFleetRequestsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSpotFleetRequestsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsError {
...
impl DescribeSpotFleetRequestsError {
    ...
    /// Creates the `DescribeSpotFleetRequestsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
