...
impl CreateTransitGatewayConnectFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_transit_gateway_connect::CreateTransitGatewayConnectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_transit_gateway_connect::CreateTransitGatewayConnectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_transit_gateway_connect::CreateTransitGatewayConnectOutput, crate::operation::create_transit_gateway_connect::CreateTransitGatewayConnectError, Self> {
