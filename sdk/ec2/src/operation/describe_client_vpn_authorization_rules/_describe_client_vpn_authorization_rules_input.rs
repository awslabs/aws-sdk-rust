...
impl DescribeClientVpnAuthorizationRulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_client_vpn_authorization_rules::DescribeClientVpnAuthorizationRulesInput, ::aws_smithy_types::error::operation::BuildError> {
