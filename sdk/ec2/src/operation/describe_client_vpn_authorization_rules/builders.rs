...
impl crate::operation::describe_client_vpn_authorization_rules::builders::DescribeClientVpnAuthorizationRulesInputBuilder {
...
impl DescribeClientVpnAuthorizationRulesFluentBuilder {
    /// Creates a new `DescribeClientVpnAuthorizationRulesFluentBuilder`.
