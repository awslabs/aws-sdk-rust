...
impl GetReservedInstancesExchangeQuoteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteInput, ::aws_smithy_types::error::operation::BuildError> {
