    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SendDiagnosticInterruptResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SendDiagnosticInterruptRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_send_diagnostic_interrupt_input::ser_send_diagnostic_interrupt_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SendDiagnosticInterruptEndpointParamsInterceptor {
...
pub type SendDiagnosticInterruptErrorKind = SendDiagnosticInterruptError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for SendDiagnosticInterruptError {
...
impl ::aws_http::request_id::RequestId for crate::operation::send_diagnostic_interrupt::SendDiagnosticInterruptError {
...
impl SendDiagnosticInterruptError {
    ...
    /// Creates the `SendDiagnosticInterruptError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
