...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::attach_vpn_gateway::AttachVpnGatewayOutput,
                    crate::operation::attach_vpn_gateway::AttachVpnGatewayError,
                > for AttachVpnGatewayFluentBuilder
            {
                fn send(
                    self,
...
impl AttachVpnGatewayFluentBuilder {
    ...
    /// Access the AttachVpnGateway as a reference.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::attach_vpn_gateway::AttachVpnGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_vpn_gateway::AttachVpnGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::attach_vpn_gateway::AttachVpnGateway::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::attach_vpn_gateway::AttachVpnGateway::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::attach_vpn_gateway::AttachVpnGatewayOutput, crate::operation::attach_vpn_gateway::AttachVpnGatewayError, Self> {
