...
impl crate::operation::describe_image_attribute::builders::DescribeImageAttributeInputBuilder {
...
impl DescribeImageAttributeFluentBuilder {
    ...
    /// <p><b>Note</b>: The <code>blockDeviceMapping</code> attribute is deprecated. Using this attribute returns the <code>Client.AuthFailure</code> error. To get information about the block device mappings for an AMI, describe the image instead.</p>
