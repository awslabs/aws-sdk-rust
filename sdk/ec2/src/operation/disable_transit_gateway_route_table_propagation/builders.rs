...
impl DisableTransitGatewayRouteTablePropagationFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::disable_transit_gateway_route_table_propagation::builders::DisableTransitGatewayRouteTablePropagationInputBuilder{
        &self.inner
    }
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagation, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationError>
    >{
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationOutput, ::aws_smithy_http::result::SdkError<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationError>>
                         {
        let op = self
            .inner
            .build()
    ...
    /// set when configuring the client.
                            pub async fn send(self) -> ::std::result::Result<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationOutput, ::aws_smithy_http::result::SdkError<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationError>>
                             {
