...
impl DisableTransitGatewayRouteTablePropagationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationOutput, crate::operation::disable_transit_gateway_route_table_propagation::DisableTransitGatewayRouteTablePropagationError, Self> {
