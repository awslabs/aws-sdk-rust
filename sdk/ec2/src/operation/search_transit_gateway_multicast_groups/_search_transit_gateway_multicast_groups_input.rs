...
impl SearchTransitGatewayMulticastGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_transit_gateway_multicast_groups::SearchTransitGatewayMulticastGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
