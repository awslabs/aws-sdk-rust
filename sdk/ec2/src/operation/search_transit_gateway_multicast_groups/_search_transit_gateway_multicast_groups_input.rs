...
impl SearchTransitGatewayMulticastGroupsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::search_transit_gateway_multicast_groups::SearchTransitGatewayMulticastGroupsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
