...
impl ::aws_types::request_id::RequestId for DetachInternetGatewayOutput {
...
impl DetachInternetGatewayOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`DetachInternetGatewayOutput`](crate::operation::detach_internet_gateway::DetachInternetGatewayOutput).
    pub fn build(self) -> crate::operation::detach_internet_gateway::DetachInternetGatewayOutput {
