...
impl DescribeMacHostsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_mac_hosts();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
}
/// Fluent builder constructing a request to `DescribeMacHosts`.
/// 
/// <p>Describes the specified EC2 Mac Dedicated Host or all of your EC2 Mac Dedicated Hosts.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct DescribeMacHostsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_mac_hosts::builders::DescribeMacHostsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_mac_hosts::DescribeMacHostsOutput,
                    crate::operation::describe_mac_hosts::DescribeMacHostsError,
                > for DescribeMacHostsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeMacHostsFluentBuilder {
    ...
    /// Access the DescribeMacHosts as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_mac_hosts::builders::DescribeMacHostsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_mac_hosts::DescribeMacHostsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_mac_hosts::DescribeMacHostsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_mac_hosts::DescribeMacHosts::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_mac_hosts::DescribeMacHosts::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_mac_hosts::DescribeMacHostsOutput, crate::operation::describe_mac_hosts::DescribeMacHostsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_mac_hosts::paginator::DescribeMacHostsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
