...
impl DeleteVerifiedAccessGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_verified_access_group::DeleteVerifiedAccessGroupInput, ::aws_smithy_types::error::operation::BuildError> {
