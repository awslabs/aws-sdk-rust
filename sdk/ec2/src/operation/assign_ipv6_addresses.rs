...
impl AssignIpv6Addresses {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::assign_ipv6_addresses::AssignIpv6AddressesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::assign_ipv6_addresses::AssignIpv6AddressesOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "AssignIpv6Addresses", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssignIpv6Addresses {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AssignIpv6Addresses", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssignIpv6Addresses")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(AssignIpv6AddressesEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssignIpv6AddressesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssignIpv6AddressesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::assign_ipv6_addresses::AssignIpv6AddressesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_assign_ipv6_addresses_input::ser_assign_ipv6_addresses_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssignIpv6AddressesEndpointParamsInterceptor {
...
pub type AssignIpv6AddressesErrorKind = AssignIpv6AddressesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssignIpv6AddressesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::assign_ipv6_addresses::AssignIpv6AddressesError {
...
impl AssignIpv6AddressesError {
    ...
    /// Creates the `AssignIpv6AddressesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
