...
impl AssignIpv6AddressesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::assign_ipv6_addresses::AssignIpv6Addresses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssignIpv6Addresses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_assign_ipv6_addresses::de_assign_ipv6_addresses_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::assign_ipv6_addresses::AssignIpv6AddressesError
{
