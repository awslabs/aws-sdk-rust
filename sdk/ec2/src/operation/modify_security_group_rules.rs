...
impl ModifySecurityGroupRules {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifySecurityGroupRules {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifySecurityGroupRules");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifySecurityGroupRulesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifySecurityGroupRulesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifySecurityGroupRules")
...
.with_interceptor(ModifySecurityGroupRulesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError>::new());
...
#[derive(Debug)]
            struct ModifySecurityGroupRulesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifySecurityGroupRulesResponseDeserializer {
...
#[derive(Debug)]
            struct ModifySecurityGroupRulesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifySecurityGroupRulesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_security_group_rules::ModifySecurityGroupRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_security_group_rules_input::ser_modify_security_group_rules_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifySecurityGroupRulesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifySecurityGroupRulesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifySecurityGroupRulesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifySecurityGroupRulesInput>()
                        .ok_or("failed to downcast to ModifySecurityGroupRulesInput")?;
...
pub enum ModifySecurityGroupRulesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifySecurityGroupRulesError) for what information is available for the error.")]
...
impl ModifySecurityGroupRulesError {
    /// Creates the `ModifySecurityGroupRulesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySecurityGroupRulesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifySecurityGroupRulesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError {
