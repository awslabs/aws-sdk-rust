...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::reboot_instances::RebootInstancesOutput,
                    crate::operation::reboot_instances::RebootInstancesError,
                > for RebootInstancesFluentBuilder
            {
                fn send(
                    self,
...
impl RebootInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reboot_instances::RebootInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reboot_instances::RebootInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::reboot_instances::RebootInstances::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::reboot_instances::RebootInstances::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reboot_instances::RebootInstancesOutput, crate::operation::reboot_instances::RebootInstancesError, Self> {
