...
impl DeprovisionPublicIpv4PoolCidrInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deprovision_public_ipv4_pool_cidr::DeprovisionPublicIpv4PoolCidr::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeprovisionPublicIpv4PoolCidr {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deprovision_public_ipv4_pool_cidr::de_deprovision_public_ipv4_pool_cidr_http_response_with_props(
                status, headers, body,
            )
        }
    }
