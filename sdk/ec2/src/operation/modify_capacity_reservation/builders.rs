...
/// <ul>
/// <li>
/// <p><code>assessing</code> or <code>scheduled</code> state - You can modify the tags only.</p></li>
/// <li>
/// <p><code>pending</code> state - You can't modify the Capacity Reservation in any way.</p></li>
/// <li>
/// <p><code>active</code> state but still within the commitment duration - You can't decrease the instance count or set an end date that is within the commitment duration. All other modifications are allowed.</p></li>
/// <li>
/// <p><code>active</code> state with no commitment duration or elapsed commitment duration - All modifications are allowed.</p></li>
/// <li>
/// <p><code>expired</code>, <code>cancelled</code>, <code>unsupported</code>, or <code>failed</code> state - You can't modify the Capacity Reservation in any way.</p></li>
/// </ul>
/// <p>For a future-dated Capacity Reservation that has not yet been delivered, pushing out the start date requires a quote generated by <code>CreateCapacityReservationDateChangeQuote</code>. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/capacity-reservations-modify.html">Modify an active Capacity Reservation</a> in the <i>Amazon EC2 User Guide</i>.</p>
...
impl ModifyCapacityReservationFluentBuilder {
    ...
    pub fn accept_modification_terms(mut self, input: bool) -> Self {
        self.inner = self.inner.accept_modification_terms(input);
        self
    }
    /// <p>Indicates that you accept the modification terms of the quote identified by <code>QuoteId</code>. To apply a quoted modification, set this parameter to <code>true</code>.</p>
    pub fn set_accept_modification_terms(mut self, input: ::std::option::Option<bool>) -> Self {
        self.inner = self.inner.set_accept_modification_terms(input);
        self
    }
    /// <p>Indicates that you accept the modification terms of the quote identified by <code>QuoteId</code>. To apply a quoted modification, set this parameter to <code>true</code>.</p>
    pub fn get_accept_modification_terms(&self) -> &::std::option::Option<bool> {
        self.inner.get_accept_modification_terms()
    }
