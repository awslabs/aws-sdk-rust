...
/// Orchestration and serialization glue logic for `ProvisionIpamPoolCidr`.
...
impl ProvisionIpamPoolCidr {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ProvisionIpamPoolCidr {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ProvisionIpamPoolCidr");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ProvisionIpamPoolCidrRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ProvisionIpamPoolCidrResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ProvisionIpamPoolCidr")
...
.with_interceptor(ProvisionIpamPoolCidrEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError>::new());
...
#[derive(Debug)]
            struct ProvisionIpamPoolCidrResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ProvisionIpamPoolCidrResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_provision_ipam_pool_cidr::de_provision_ipam_pool_cidr_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ProvisionIpamPoolCidrRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ProvisionIpamPoolCidrRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_provision_ipam_pool_cidr_input::ser_provision_ipam_pool_cidr_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ProvisionIpamPoolCidrEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ProvisionIpamPoolCidrInput>()
                        .ok_or("failed to downcast to ProvisionIpamPoolCidrInput")?;
...
/// Error type for the `ProvisionIpamPoolCidrError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ProvisionIpamPoolCidrError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ProvisionIpamPoolCidrError) for what information is available for the error.")]
...
impl ProvisionIpamPoolCidrError {
    /// Creates the `ProvisionIpamPoolCidrError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ProvisionIpamPoolCidrError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ProvisionIpamPoolCidrError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ProvisionIpamPoolCidrError {
...
impl ::aws_types::request_id::RequestId for crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::provision_ipam_pool_cidr::_provision_ipam_pool_cidr_output::ProvisionIpamPoolCidrOutput;

pub use crate::operation::provision_ipam_pool_cidr::_provision_ipam_pool_cidr_input::ProvisionIpamPoolCidrInput;

mod _provision_ipam_pool_cidr_input;

mod _provision_ipam_pool_cidr_output;
