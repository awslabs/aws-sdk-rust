...
impl ProvisionIpamPoolCidr {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ProvisionIpamPoolCidr", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ProvisionIpamPoolCidr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ProvisionIpamPoolCidr", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ProvisionIpamPoolCidr")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ProvisionIpamPoolCidrResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ProvisionIpamPoolCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ProvisionIpamPoolCidrEndpointParamsInterceptor {
...
pub type ProvisionIpamPoolCidrErrorKind = ProvisionIpamPoolCidrError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ProvisionIpamPoolCidrError {
...
impl ::aws_http::request_id::RequestId for crate::operation::provision_ipam_pool_cidr::ProvisionIpamPoolCidrError {
...
impl ProvisionIpamPoolCidrError {
    ...
    /// Creates the `ProvisionIpamPoolCidrError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
