...
impl DescribeSecurityGroupReferencesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_security_group_references::DescribeSecurityGroupReferences::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSecurityGroupReferences {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_security_group_references::de_describe_security_group_references_http_response_with_props(
                status, headers, body,
            )
        }
    }
