    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSecurityGroupReferences {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeSecurityGroupReferencesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeSecurityGroupReferencesResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSecurityGroupReferences", "ec2"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeSecurityGroupReferences")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeSecurityGroupReferencesResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_describe_security_group_references::de_describe_security_group_references_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeSecurityGroupReferencesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_security_group_references_input::ser_describe_security_group_references_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSecurityGroupReferencesEndpointParamsInterceptor {
...
pub type DescribeSecurityGroupReferencesErrorKind = DescribeSecurityGroupReferencesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSecurityGroupReferencesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_security_group_references::DescribeSecurityGroupReferencesError {
...
impl DescribeSecurityGroupReferencesError {
    ...
    /// Creates the `DescribeSecurityGroupReferencesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
