...
impl ExportTransitGatewayRoutesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportTransitGatewayRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_transit_gateway_routes::de_export_transit_gateway_routes_http_response_with_props(
                status, headers, body,
            )
        }
    }
