...
impl ExportTransitGatewayRoutes {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesInput,
                    ) -> ::std::result::Result<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportTransitGatewayRoutes {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportTransitGatewayRoutes");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExportTransitGatewayRoutesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExportTransitGatewayRoutesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportTransitGatewayRoutes")
...
.with_interceptor(ExportTransitGatewayRoutesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError>::new());
...
#[derive(Debug)]
            struct ExportTransitGatewayRoutesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExportTransitGatewayRoutesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_export_transit_gateway_routes::de_export_transit_gateway_routes_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportTransitGatewayRoutesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_export_transit_gateway_routes_input::ser_export_transit_gateway_routes_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ExportTransitGatewayRoutesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExportTransitGatewayRoutesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExportTransitGatewayRoutesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExportTransitGatewayRoutesInput>()
                        .ok_or("failed to downcast to ExportTransitGatewayRoutesInput")?;
...
/// Error type for the `ExportTransitGatewayRoutesError` operation.
#[non_exhaustive]
...
pub enum ExportTransitGatewayRoutesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExportTransitGatewayRoutesError) for what information is available for the error.")]
...
impl ExportTransitGatewayRoutesError {
    /// Creates the `ExportTransitGatewayRoutesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExportTransitGatewayRoutesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ExportTransitGatewayRoutesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExportTransitGatewayRoutesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError {
...
mod _export_transit_gateway_routes_output;
