    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportTransitGatewayRoutes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ExportTransitGatewayRoutes", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportTransitGatewayRoutes")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ExportTransitGatewayRoutesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ExportTransitGatewayRoutesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_export_transit_gateway_routes_input::ser_export_transit_gateway_routes_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExportTransitGatewayRoutesEndpointParamsInterceptor {
...
pub type ExportTransitGatewayRoutesErrorKind = ExportTransitGatewayRoutesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ExportTransitGatewayRoutesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesError {
...
impl ExportTransitGatewayRoutesError {
    ...
    /// Creates the `ExportTransitGatewayRoutesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
