...
impl DescribeReservedInstancesModificationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_reserved_instances_modifications::paginator::DescribeReservedInstancesModificationsPaginatorItems {
...
impl DescribeReservedInstancesModificationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_reserved_instances_modifications_output_output_reserved_instances_modifications(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
