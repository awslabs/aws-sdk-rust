...
impl DescribeReservedInstancesModificationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_reserved_instances_modifications::DescribeReservedInstancesModificationsInput, ::aws_smithy_types::error::operation::BuildError> {
