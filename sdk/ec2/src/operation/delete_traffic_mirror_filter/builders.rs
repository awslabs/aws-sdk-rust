...
impl DeleteTrafficMirrorFilterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterOutput, crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterError, Self> {
