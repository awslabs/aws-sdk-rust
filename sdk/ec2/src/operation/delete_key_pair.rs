...
impl DeleteKeyPairInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_key_pair_input::ser_delete_key_pair_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_key_pair::DeleteKeyPair::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteKeyPair {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_key_pair::de_delete_key_pair_http_error(
                status, headers, body,
            )
        } else {
