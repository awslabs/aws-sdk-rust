...
impl DeleteKeyPairInput {
    /// Consumes the builder and constructs an Operation<[`DeleteKeyPair`](crate::operation::delete_key_pair::DeleteKeyPair)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_key_pair::DeleteKeyPair, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_key_pair::DeleteKeyPairInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_key_pair_input::ser_delete_key_pair_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_key_pair::DeleteKeyPair::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteKeyPair", "ec2"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteKeyPair`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteKeyPair {
                type Output = std::result::Result<crate::operation::delete_key_pair::DeleteKeyPairOutput, crate::operation::delete_key_pair::DeleteKeyPairError>;
