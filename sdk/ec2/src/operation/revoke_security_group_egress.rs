    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeSecurityGroupEgress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RevokeSecurityGroupEgress", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeSecurityGroupEgress")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RevokeSecurityGroupEgressResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RevokeSecurityGroupEgressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_security_group_egress_input::ser_revoke_security_group_egress_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RevokeSecurityGroupEgressEndpointParamsInterceptor {
...
pub type RevokeSecurityGroupEgressErrorKind = RevokeSecurityGroupEgressError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for RevokeSecurityGroupEgressError {
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError {
...
impl RevokeSecurityGroupEgressError {
    ...
    /// Creates the `RevokeSecurityGroupEgressError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
