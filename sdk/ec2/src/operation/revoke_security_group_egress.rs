...
impl RevokeSecurityGroupEgressInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgress::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeSecurityGroupEgress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_security_group_egress::de_revoke_security_group_egress_http_response_with_props(status, headers, body)
        }
    }
}
