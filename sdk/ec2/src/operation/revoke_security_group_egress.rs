...
impl RevokeSecurityGroupEgress {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeSecurityGroupEgress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RevokeSecurityGroupEgress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RevokeSecurityGroupEgressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RevokeSecurityGroupEgressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeSecurityGroupEgress")
...
.with_interceptor(RevokeSecurityGroupEgressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_revoke_security_group_egress::de_revoke_security_group_egress_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeSecurityGroupEgressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::revoke_security_group_egress::RevokeSecurityGroupEgressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_revoke_security_group_egress_input::ser_revoke_security_group_egress_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RevokeSecurityGroupEgressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeSecurityGroupEgressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RevokeSecurityGroupEgressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RevokeSecurityGroupEgressInput>()
                        .ok_or("failed to downcast to RevokeSecurityGroupEgressInput")?;
...
/// Error type for the `RevokeSecurityGroupEgressError` operation.
#[non_exhaustive]
...
pub enum RevokeSecurityGroupEgressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RevokeSecurityGroupEgressError) for what information is available for the error.")]
...
impl RevokeSecurityGroupEgressError {
    /// Creates the `RevokeSecurityGroupEgressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeSecurityGroupEgressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RevokeSecurityGroupEgressError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RevokeSecurityGroupEgressError {
