...
impl DescribeInstanceEventWindowsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_instance_event_windows::DescribeInstanceEventWindows::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstanceEventWindows {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_instance_event_windows::de_describe_instance_event_windows_http_response_with_props(
                status, headers, body,
            )
        }
    }
