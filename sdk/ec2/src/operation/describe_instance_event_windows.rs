...
/// Orchestration and serialization glue logic for `DescribeInstanceEventWindows`.
...
impl DescribeInstanceEventWindows {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInstanceEventWindows {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeInstanceEventWindows");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeInstanceEventWindowsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeInstanceEventWindowsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInstanceEventWindows")
...
.with_interceptor(DescribeInstanceEventWindowsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError>::new());
...
#[derive(Debug)]
            struct DescribeInstanceEventWindowsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeInstanceEventWindowsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_instance_event_windows::de_describe_instance_event_windows_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeInstanceEventWindowsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeInstanceEventWindowsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_instance_event_windows_input::ser_describe_instance_event_windows_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeInstanceEventWindowsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeInstanceEventWindowsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeInstanceEventWindowsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeInstanceEventWindowsInput>()
                        .ok_or("failed to downcast to DescribeInstanceEventWindowsInput")?;
...
/// Error type for the `DescribeInstanceEventWindowsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeInstanceEventWindowsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeInstanceEventWindowsError) for what information is available for the error.")]
...
impl DescribeInstanceEventWindowsError {
    /// Creates the `DescribeInstanceEventWindowsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeInstanceEventWindowsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeInstanceEventWindowsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeInstanceEventWindowsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError {
...
mod _describe_instance_event_windows_output;
