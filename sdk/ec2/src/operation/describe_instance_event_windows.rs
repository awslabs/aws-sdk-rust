    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInstanceEventWindows {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeInstanceEventWindows", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInstanceEventWindows")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeInstanceEventWindowsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeInstanceEventWindowsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_instance_event_windows_input::ser_describe_instance_event_windows_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeInstanceEventWindowsEndpointParamsInterceptor {
...
pub type DescribeInstanceEventWindowsErrorKind = DescribeInstanceEventWindowsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeInstanceEventWindowsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_instance_event_windows::DescribeInstanceEventWindowsError {
...
impl DescribeInstanceEventWindowsError {
    ...
    /// Creates the `DescribeInstanceEventWindowsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
