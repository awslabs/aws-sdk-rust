...
impl CreateTransitGatewayPolicyTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_transit_gateway_policy_table::CreateTransitGatewayPolicyTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTransitGatewayPolicyTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_transit_gateway_policy_table::de_create_transit_gateway_policy_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
