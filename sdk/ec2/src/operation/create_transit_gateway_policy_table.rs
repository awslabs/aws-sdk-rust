...
impl CreateTransitGatewayPolicyTable {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_transit_gateway_policy_table::CreateTransitGatewayPolicyTableOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateTransitGatewayPolicyTableResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateTransitGatewayPolicyTableRequestSerializer {
