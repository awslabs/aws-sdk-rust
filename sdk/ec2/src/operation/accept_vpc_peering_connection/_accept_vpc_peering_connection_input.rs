...
impl AcceptVpcPeeringConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionInput, ::aws_smithy_types::error::operation::BuildError> {
