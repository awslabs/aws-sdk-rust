...
impl DeleteLocalGatewayRoute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteLocalGatewayRoute", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLocalGatewayRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteLocalGatewayRoute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteLocalGatewayRoute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteLocalGatewayRouteResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteLocalGatewayRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_local_gateway_route_input::ser_delete_local_gateway_route_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteLocalGatewayRouteEndpointParamsInterceptor {
...
pub type DeleteLocalGatewayRouteErrorKind = DeleteLocalGatewayRouteError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteLocalGatewayRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_local_gateway_route::DeleteLocalGatewayRouteError {
...
impl DeleteLocalGatewayRouteError {
    ...
    /// Creates the `DeleteLocalGatewayRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
