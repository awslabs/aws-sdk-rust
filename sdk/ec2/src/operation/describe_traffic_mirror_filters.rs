    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTrafficMirrorFilters {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeTrafficMirrorFilters", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTrafficMirrorFilters")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeTrafficMirrorFiltersResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeTrafficMirrorFiltersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_traffic_mirror_filters_input::ser_describe_traffic_mirror_filters_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeTrafficMirrorFiltersEndpointParamsInterceptor {
...
pub type DescribeTrafficMirrorFiltersErrorKind = DescribeTrafficMirrorFiltersError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeTrafficMirrorFiltersError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFiltersError {
...
impl DescribeTrafficMirrorFiltersError {
    ...
    /// Creates the `DescribeTrafficMirrorFiltersError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
