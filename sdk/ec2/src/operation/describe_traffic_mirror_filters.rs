...
impl DescribeTrafficMirrorFiltersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_traffic_mirror_filters::DescribeTrafficMirrorFilters::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrafficMirrorFilters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_traffic_mirror_filters::de_describe_traffic_mirror_filters_http_response_with_props(
                status, headers, body,
            )
        }
    }
