...
impl DescribePlacementGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_placement_groups::DescribePlacementGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_placement_groups::DescribePlacementGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_placement_groups::DescribePlacementGroupsOutput, crate::operation::describe_placement_groups::DescribePlacementGroupsError, Self> {
