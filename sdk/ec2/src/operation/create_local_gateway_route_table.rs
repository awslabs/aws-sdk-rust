...
impl CreateLocalGatewayRouteTable {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLocalGatewayRouteTable {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLocalGatewayRouteTable");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLocalGatewayRouteTableRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLocalGatewayRouteTableResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLocalGatewayRouteTable")
...
.with_interceptor(CreateLocalGatewayRouteTableEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_create_local_gateway_route_table::de_create_local_gateway_route_table_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLocalGatewayRouteTableRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLocalGatewayRouteTableRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTableInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_local_gateway_route_table_input::ser_create_local_gateway_route_table_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateLocalGatewayRouteTableEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLocalGatewayRouteTableEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLocalGatewayRouteTableEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLocalGatewayRouteTableInput>()
                        .ok_or("failed to downcast to CreateLocalGatewayRouteTableInput")?;
...
/// Error type for the `CreateLocalGatewayRouteTableError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateLocalGatewayRouteTableError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLocalGatewayRouteTableError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateLocalGatewayRouteTableError {
    /// Creates the `CreateLocalGatewayRouteTableError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLocalGatewayRouteTableError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for CreateLocalGatewayRouteTableError {
...
impl ::std::fmt::Display for CreateLocalGatewayRouteTableError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateLocalGatewayRouteTableError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateLocalGatewayRouteTableError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLocalGatewayRouteTableError {
