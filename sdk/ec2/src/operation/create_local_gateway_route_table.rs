...
impl CreateLocalGatewayRouteTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_local_gateway_route_table::CreateLocalGatewayRouteTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocalGatewayRouteTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_local_gateway_route_table::de_create_local_gateway_route_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
