...
impl DeregisterTransitGatewayMulticastGroupSourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_transit_gateway_multicast_group_sources::DeregisterTransitGatewayMulticastGroupSourcesInput, ::aws_smithy_types::error::operation::BuildError> {
