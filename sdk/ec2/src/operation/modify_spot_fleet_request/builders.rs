...
impl ModifySpotFleetRequestFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestOutput, crate::operation::modify_spot_fleet_request::ModifySpotFleetRequestError, Self> {
