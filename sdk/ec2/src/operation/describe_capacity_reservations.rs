...
/// Orchestration and serialization glue logic for `DescribeCapacityReservations`.
...
impl DescribeCapacityReservations {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_capacity_reservations::DescribeCapacityReservationsInput,
                    ) -> ::std::result::Result<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCapacityReservations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeCapacityReservations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeCapacityReservationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeCapacityReservationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCapacityReservations")
...
.with_interceptor(DescribeCapacityReservationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError>::new());
...
#[derive(Debug)]
            struct DescribeCapacityReservationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeCapacityReservationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_capacity_reservations::de_describe_capacity_reservations_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeCapacityReservationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_capacity_reservations::DescribeCapacityReservationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_capacity_reservations_input::ser_describe_capacity_reservations_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeCapacityReservationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeCapacityReservationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeCapacityReservationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeCapacityReservationsInput>()
                        .ok_or("failed to downcast to DescribeCapacityReservationsInput")?;
...
/// Error type for the `DescribeCapacityReservationsError` operation.
#[non_exhaustive]
...
pub enum DescribeCapacityReservationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeCapacityReservationsError) for what information is available for the error.")]
...
impl DescribeCapacityReservationsError {
    /// Creates the `DescribeCapacityReservationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCapacityReservationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeCapacityReservationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeCapacityReservationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError {
...
mod _describe_capacity_reservations_output;
