    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeCapacityReservations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeCapacityReservations", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeCapacityReservations")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeCapacityReservationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeCapacityReservationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_capacity_reservations::DescribeCapacityReservationsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_capacity_reservations_input::ser_describe_capacity_reservations_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeCapacityReservationsEndpointParamsInterceptor {
...
pub type DescribeCapacityReservationsErrorKind = DescribeCapacityReservationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeCapacityReservationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_capacity_reservations::DescribeCapacityReservationsError {
...
impl DescribeCapacityReservationsError {
    ...
    /// Creates the `DescribeCapacityReservationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
