...
impl DescribeCapacityReservationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_capacity_reservations::DescribeCapacityReservations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCapacityReservations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_capacity_reservations::de_describe_capacity_reservations_http_response_with_props(
                status, headers, body,
            )
        }
    }
