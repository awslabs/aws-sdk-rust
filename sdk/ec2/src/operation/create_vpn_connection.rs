...
impl CreateVpnConnection {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EC2", "CreateVpnConnection", input, runtime_plugins, stop_point)
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateVpnConnection")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateVpnConnectionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_vpn_connection::de_create_vpn_connection_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_vpn_connection::de_create_vpn_connection_http_response(status, headers, body, _cfg)
        };
