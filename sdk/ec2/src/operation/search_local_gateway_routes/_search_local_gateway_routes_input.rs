...
impl SearchLocalGatewayRoutesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutesInput, ::aws_smithy_types::error::operation::BuildError> {
