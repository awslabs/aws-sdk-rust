        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutes::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl SearchLocalGatewayRoutesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_search_local_gateway_routes_output_output_routes(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
