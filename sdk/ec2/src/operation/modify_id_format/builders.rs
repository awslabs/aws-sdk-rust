...
impl ModifyIdFormatFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_id_format::ModifyIdFormatOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_id_format::ModifyIdFormatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_id_format::ModifyIdFormatOutput, crate::operation::modify_id_format::ModifyIdFormatError, Self> {
