...
impl GetIpamDiscoveredPublicAddressesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_ipam_discovered_public_addresses::GetIpamDiscoveredPublicAddressesInput, ::aws_smithy_types::error::operation::BuildError> {
