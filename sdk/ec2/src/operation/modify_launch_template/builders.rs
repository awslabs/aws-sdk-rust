...
impl ModifyLaunchTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_launch_template::ModifyLaunchTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_launch_template::ModifyLaunchTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_launch_template::ModifyLaunchTemplateOutput, crate::operation::modify_launch_template::ModifyLaunchTemplateError, Self> {
