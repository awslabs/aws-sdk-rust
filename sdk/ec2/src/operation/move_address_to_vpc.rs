...
impl MoveAddressToVpc {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::move_address_to_vpc::MoveAddressToVpcError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::move_address_to_vpc::MoveAddressToVpcOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "MoveAddressToVpc", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MoveAddressToVpc {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("MoveAddressToVpc", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MoveAddressToVpc")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(MoveAddressToVpcEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for MoveAddressToVpcResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for MoveAddressToVpcRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::move_address_to_vpc::MoveAddressToVpcInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_move_address_to_vpc_input::ser_move_address_to_vpc_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for MoveAddressToVpcEndpointParamsInterceptor {
...
pub type MoveAddressToVpcErrorKind = MoveAddressToVpcError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for MoveAddressToVpcError {
...
impl ::aws_http::request_id::RequestId for crate::operation::move_address_to_vpc::MoveAddressToVpcError {
...
impl MoveAddressToVpcError {
    ...
    /// Creates the `MoveAddressToVpcError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
