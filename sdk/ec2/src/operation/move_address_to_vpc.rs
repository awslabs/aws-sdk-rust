...
impl MoveAddressToVpcInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::move_address_to_vpc::MoveAddressToVpc::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for MoveAddressToVpc {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_move_address_to_vpc::de_move_address_to_vpc_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::move_address_to_vpc::MoveAddressToVpcError
{
