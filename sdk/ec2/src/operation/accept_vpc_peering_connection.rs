...
/// Orchestration and serialization glue logic for `AcceptVpcPeeringConnection`.
...
impl AcceptVpcPeeringConnection {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptVpcPeeringConnection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptVpcPeeringConnection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptVpcPeeringConnectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptVpcPeeringConnectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptVpcPeeringConnection")
...
.with_interceptor(AcceptVpcPeeringConnectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError>::new());
...
#[derive(Debug)]
            struct AcceptVpcPeeringConnectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptVpcPeeringConnectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_vpc_peering_connection::de_accept_vpc_peering_connection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_accept_vpc_peering_connection::de_accept_vpc_peering_connection_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptVpcPeeringConnectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_accept_vpc_peering_connection_input::ser_accept_vpc_peering_connection_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AcceptVpcPeeringConnectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptVpcPeeringConnectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AcceptVpcPeeringConnectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptVpcPeeringConnectionInput>()
                        .ok_or("failed to downcast to AcceptVpcPeeringConnectionInput")?;
...
/// Error type for the `AcceptVpcPeeringConnectionError` operation.
#[non_exhaustive]
...
pub enum AcceptVpcPeeringConnectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptVpcPeeringConnectionError) for what information is available for the error.")]
...
impl AcceptVpcPeeringConnectionError {
    /// Creates the `AcceptVpcPeeringConnectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptVpcPeeringConnectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AcceptVpcPeeringConnectionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptVpcPeeringConnectionError {
