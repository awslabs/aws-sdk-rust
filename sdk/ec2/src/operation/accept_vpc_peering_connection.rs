    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptVpcPeeringConnection {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AcceptVpcPeeringConnection", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptVpcPeeringConnection")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AcceptVpcPeeringConnectionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AcceptVpcPeeringConnectionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_accept_vpc_peering_connection_input::ser_accept_vpc_peering_connection_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AcceptVpcPeeringConnectionEndpointParamsInterceptor {
...
pub type AcceptVpcPeeringConnectionErrorKind = AcceptVpcPeeringConnectionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AcceptVpcPeeringConnectionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnectionError {
...
impl AcceptVpcPeeringConnectionError {
    ...
    /// Creates the `AcceptVpcPeeringConnectionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
