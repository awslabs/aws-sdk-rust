...
impl AcceptVpcPeeringConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_vpc_peering_connection::AcceptVpcPeeringConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptVpcPeeringConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_vpc_peering_connection::de_accept_vpc_peering_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
