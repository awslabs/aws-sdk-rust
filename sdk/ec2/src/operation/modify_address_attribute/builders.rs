...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::modify_address_attribute::ModifyAddressAttributeOutput,
                    crate::operation::modify_address_attribute::ModifyAddressAttributeError,
                > for ModifyAddressAttributeFluentBuilder
            {
                fn send(
                    self,
...
impl ModifyAddressAttributeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_address_attribute::ModifyAddressAttributeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_address_attribute::ModifyAddressAttributeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::modify_address_attribute::ModifyAddressAttribute::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::modify_address_attribute::ModifyAddressAttribute::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_address_attribute::ModifyAddressAttributeOutput, crate::operation::modify_address_attribute::ModifyAddressAttributeError, Self> {
