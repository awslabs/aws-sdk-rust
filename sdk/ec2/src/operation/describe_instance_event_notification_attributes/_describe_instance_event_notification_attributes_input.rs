...
impl DescribeInstanceEventNotificationAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_instance_event_notification_attributes::DescribeInstanceEventNotificationAttributesInput, ::aws_smithy_types::error::operation::BuildError> {
