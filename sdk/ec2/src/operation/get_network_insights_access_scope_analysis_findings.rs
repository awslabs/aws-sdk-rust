...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetNetworkInsightsAccessScopeAnalysisFindingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetNetworkInsightsAccessScopeAnalysisFindingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_network_insights_access_scope_analysis_findings_input::ser_get_network_insights_access_scope_analysis_findings_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetNetworkInsightsAccessScopeAnalysisFindingsEndpointParamsInterceptor {
