...
impl CreateRestoreImageTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_restore_image_task::CreateRestoreImageTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_restore_image_task::CreateRestoreImageTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_restore_image_task::CreateRestoreImageTaskOutput, crate::operation::create_restore_image_task::CreateRestoreImageTaskError, Self> {
