...
impl AcceptReservedInstancesExchangeQuoteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_reserved_instances_exchange_quote::AcceptReservedInstancesExchangeQuoteInput, ::aws_smithy_types::error::operation::BuildError> {
