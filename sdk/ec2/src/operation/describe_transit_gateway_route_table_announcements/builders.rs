...
impl DescribeTransitGatewayRouteTableAnnouncementsFluentBuilder {
    ...
    pub fn get_transit_gateway_route_table_announcement_ids(
        ...
        self.inner
            .get_transit_gateway_route_table_announcement_ids()
    }
