...
impl DescribeTransitGatewayRouteTableAnnouncementsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_transit_gateway_route_table_announcements::DescribeTransitGatewayRouteTableAnnouncementsInput, ::aws_smithy_types::error::operation::BuildError> {
