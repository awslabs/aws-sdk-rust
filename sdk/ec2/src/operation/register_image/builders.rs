...
/// <ol>
/// <li>
/// <p>Launch an instance from an existing AMI with that billing product code.</p></li>
/// <li>
/// <p>Customize the instance.</p></li>
/// <li>
/// <p>Create an AMI from the instance using <code>CreateImage</code>.</p></li>
/// </ol>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::register_image::RegisterImageOutput,
                    crate::operation::register_image::RegisterImageError,
                > for RegisterImageFluentBuilder
            {
                fn send(
                    self,
...
impl RegisterImageFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::register_image::builders::RegisterImageInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_image::RegisterImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_image::RegisterImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::register_image::RegisterImage::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::register_image::RegisterImage::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_image::RegisterImageOutput, crate::operation::register_image::RegisterImageError, Self> {
