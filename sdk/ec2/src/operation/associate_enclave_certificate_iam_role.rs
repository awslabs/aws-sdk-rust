...
impl AssociateEnclaveCertificateIamRoleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_enclave_certificate_iam_role::AssociateEnclaveCertificateIamRole,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_enclave_certificate_iam_role::AssociateEnclaveCertificateIamRole::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateEnclaveCertificateIamRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_enclave_certificate_iam_role::de_associate_enclave_certificate_iam_role_http_response_with_props(
                status, headers, body,
            )
        }
    }
