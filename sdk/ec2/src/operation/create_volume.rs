...
impl CreateVolumeInput {
    /// Consumes the builder and constructs an Operation<[`CreateVolume`](crate::operation::create_volume::CreateVolume)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_volume::CreateVolume, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_volume::CreateVolumeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_volume_input::ser_create_volume_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_volume::CreateVolume::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateVolume", "ec2"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVolume {
                type Output = std::result::Result<crate::operation::create_volume::CreateVolumeOutput, crate::operation::create_volume::CreateVolumeError>;
