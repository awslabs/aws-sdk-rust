...
impl CreateVolumeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_volume::CreateVolume, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_volume_input::ser_create_volume_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVolume {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_volume::de_create_volume_http_response_with_props(status, headers, body)
        }
    }
}
