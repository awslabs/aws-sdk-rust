...
impl CreateStoreImageTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_store_image_task::CreateStoreImageTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_store_image_task::CreateStoreImageTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_store_image_task::CreateStoreImageTaskOutput, crate::operation::create_store_image_task::CreateStoreImageTaskError, Self> {
