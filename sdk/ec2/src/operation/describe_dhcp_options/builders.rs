...
impl DescribeDhcpOptionsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_dhcp_options();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_dhcp_options::DescribeDhcpOptionsOutput,
                    crate::operation::describe_dhcp_options::DescribeDhcpOptionsError,
                > for DescribeDhcpOptionsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeDhcpOptionsFluentBuilder {
    ...
    /// Access the DescribeDhcpOptions as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_dhcp_options::builders::DescribeDhcpOptionsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_dhcp_options::DescribeDhcpOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_dhcp_options::DescribeDhcpOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_dhcp_options::DescribeDhcpOptions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_dhcp_options::DescribeDhcpOptions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_dhcp_options::DescribeDhcpOptionsOutput, crate::operation::describe_dhcp_options::DescribeDhcpOptionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_dhcp_options::paginator::DescribeDhcpOptionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
