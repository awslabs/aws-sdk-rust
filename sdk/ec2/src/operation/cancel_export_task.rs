...
impl CancelExportTask {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EC2", "CancelExportTask", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelExportTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CancelExportTask", "EC2"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelExportTaskTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ExportTaskId") {
            if let ::std::option::Option::Some(value) = input.export_task_id.as_deref() {
                captured.insert("ExportTaskId", value);
            }
        }
