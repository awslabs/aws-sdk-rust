    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyIpamResourceCidrResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyIpamResourceCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_ipam_resource_cidr_input::ser_modify_ipam_resource_cidr_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyIpamResourceCidrEndpointParamsInterceptor {
...
pub type ModifyIpamResourceCidrErrorKind = ModifyIpamResourceCidrError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyIpamResourceCidrError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrError {
...
impl ModifyIpamResourceCidrError {
    ...
    /// Creates the `ModifyIpamResourceCidrError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
