...
pub use crate::operation::modify_verified_access_instance::_modify_verified_access_instance_output::ModifyVerifiedAccessInstanceOutputBuilder;
...
impl ModifyVerifiedAccessInstanceInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.modify_verified_access_instance();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceOutput,
                    crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceError,
                > for ModifyVerifiedAccessInstanceFluentBuilder
            {
                fn send(
                    self,
...
impl ModifyVerifiedAccessInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstance::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstance::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceOutput, crate::operation::modify_verified_access_instance::ModifyVerifiedAccessInstanceError, Self> {
