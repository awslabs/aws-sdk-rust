...
impl AdvertiseByoipCidrFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrOutput, crate::operation::advertise_byoip_cidr::AdvertiseByoipCidrError, Self> {
