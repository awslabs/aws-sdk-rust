...
impl CreateEgressOnlyInternetGatewayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_egress_only_internet_gateway::CreateEgressOnlyInternetGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEgressOnlyInternetGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_egress_only_internet_gateway::de_create_egress_only_internet_gateway_http_response_with_props(
                status, headers, body,
            )
        }
    }
