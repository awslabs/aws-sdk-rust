...
impl ModifyVerifiedAccessGroupPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_verified_access_group_policy::ModifyVerifiedAccessGroupPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
