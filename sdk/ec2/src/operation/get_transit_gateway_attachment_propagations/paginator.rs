...
impl GetTransitGatewayAttachmentPropagationsPaginatorItems {
    ...
    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::TransitGatewayAttachmentPropagation, ::aws_smithy_http::result::SdkError<crate::operation::get_transit_gateway_attachment_propagations::GetTransitGatewayAttachmentPropagationsError>>> + ::std::marker::Unpin
                     {
