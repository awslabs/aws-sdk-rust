    ...
    > + ::std::marker::Unpin {
        ...
        ::aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            ::std::boxed::Box::pin(async move {
                ...
                loop {
                    let resp = crate::operation::get_transit_gateway_attachment_propagations::GetTransitGatewayAttachmentPropagations::orchestrate(
                        &runtime_plugins,
                        input.clone(),
                    )
                    .await;
...
impl GetTransitGatewayAttachmentPropagationsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_transit_gateway_attachment_propagations_output_transit_gateway_attachment_propagations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
