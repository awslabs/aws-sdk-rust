...
impl CancelImageLaunchPermissionFluentBuilder  {
    /// Creates a new `CancelImageLaunchPermission`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::cancel_image_launch_permission::CancelImageLaunchPermission, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::cancel_image_launch_permission::CancelImageLaunchPermissionError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::cancel_image_launch_permission::CancelImageLaunchPermissionOutput, aws_smithy_http::result::SdkError<crate::operation::cancel_image_launch_permission::CancelImageLaunchPermissionError>>
                     {
