...
impl DeleteInternetGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_internet_gateway::DeleteInternetGatewayError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_internet_gateway::DeleteInternetGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteInternetGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteInternetGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteInternetGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteInternetGateway")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteInternetGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteInternetGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_internet_gateway::DeleteInternetGatewayInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_internet_gateway_input::ser_delete_internet_gateway_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteInternetGatewayEndpointParamsInterceptor {
...
pub type DeleteInternetGatewayErrorKind = DeleteInternetGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteInternetGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_internet_gateway::DeleteInternetGatewayError {
...
impl DeleteInternetGatewayError {
    ...
    /// Creates the `DeleteInternetGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
