...
impl ModifyTrafficMirrorFilterRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_traffic_mirror_filter_rule::ModifyTrafficMirrorFilterRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyTrafficMirrorFilterRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_traffic_mirror_filter_rule::de_modify_traffic_mirror_filter_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
