...
impl ::std::fmt::Debug for ModifyInstanceAttributeInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("kernel", &self.kernel);
        formatter.field("ramdisk", &self.ramdisk);
...
impl ::std::fmt::Debug for ModifyInstanceAttributeInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
