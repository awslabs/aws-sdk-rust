...
impl AttachNetworkInterface {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::attach_network_interface::AttachNetworkInterfaceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::attach_network_interface::AttachNetworkInterfaceOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "AttachNetworkInterface", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachNetworkInterface {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AttachNetworkInterface", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachNetworkInterface")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AttachNetworkInterfaceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AttachNetworkInterfaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::attach_network_interface::AttachNetworkInterfaceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_network_interface_input::ser_attach_network_interface_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AttachNetworkInterfaceEndpointParamsInterceptor {
...
pub type AttachNetworkInterfaceErrorKind = AttachNetworkInterfaceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AttachNetworkInterfaceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_network_interface::AttachNetworkInterfaceError {
...
impl AttachNetworkInterfaceError {
    ...
    /// Creates the `AttachNetworkInterfaceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
