    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_capacity_reservation::CancelCapacityReservationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_capacity_reservation::CancelCapacityReservationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelCapacityReservation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CancelCapacityReservation", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelCapacityReservation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CancelCapacityReservationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CancelCapacityReservationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_capacity_reservation::CancelCapacityReservationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_capacity_reservation_input::ser_cancel_capacity_reservation_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelCapacityReservationEndpointParamsInterceptor {
...
pub type CancelCapacityReservationErrorKind = CancelCapacityReservationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelCapacityReservationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_capacity_reservation::CancelCapacityReservationError {
...
impl CancelCapacityReservationError {
    ...
    /// Creates the `CancelCapacityReservationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
