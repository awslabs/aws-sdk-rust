...
impl DeleteTransitGatewayConnectPeerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_transit_gateway_connect_peer::DeleteTransitGatewayConnectPeerInput, ::aws_smithy_types::error::operation::BuildError> {
