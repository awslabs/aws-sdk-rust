...
impl CreateReplaceRootVolumeTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_replace_root_volume_task::CreateReplaceRootVolumeTaskInput, ::aws_smithy_types::error::operation::BuildError> {
