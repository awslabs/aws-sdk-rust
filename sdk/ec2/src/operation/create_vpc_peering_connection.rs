...
impl CreateVpcPeeringConnectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateVpcPeeringConnection`](crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpc_peering_connection_input::ser_create_vpc_peering_connection_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateVpcPeeringConnection", "ec2"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVpcPeeringConnection {
                type Output = std::result::Result<crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionOutput, crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionError>;
