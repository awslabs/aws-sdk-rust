...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcPeeringConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vpc_peering_connection::de_create_vpc_peering_connection_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionError
{
