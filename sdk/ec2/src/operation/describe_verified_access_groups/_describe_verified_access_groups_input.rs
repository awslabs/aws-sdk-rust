...
impl DescribeVerifiedAccessGroupsInputBuilder {
    ...
    pub fn set_verified_access_group_ids(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.verified_access_group_ids = input; self
    }
    /// <p>The ID of the Verified Access groups.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
