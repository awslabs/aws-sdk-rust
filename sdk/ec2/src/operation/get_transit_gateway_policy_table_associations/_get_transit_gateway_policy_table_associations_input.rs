...
impl GetTransitGatewayPolicyTableAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_transit_gateway_policy_table_associations::GetTransitGatewayPolicyTableAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
