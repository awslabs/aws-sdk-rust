...
impl DeleteCustomerGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_customer_gateway::DeleteCustomerGatewayError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_customer_gateway::DeleteCustomerGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteCustomerGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomerGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteCustomerGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCustomerGateway")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteCustomerGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteCustomerGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_customer_gateway::DeleteCustomerGatewayInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_customer_gateway_input::ser_delete_customer_gateway_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteCustomerGatewayEndpointParamsInterceptor {
...
pub type DeleteCustomerGatewayErrorKind = DeleteCustomerGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteCustomerGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_customer_gateway::DeleteCustomerGatewayError {
...
impl DeleteCustomerGatewayError {
    ...
    /// Creates the `DeleteCustomerGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
