...
impl DeleteCustomerGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_customer_gateway::DeleteCustomerGateway,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomerGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_customer_gateway::de_delete_customer_gateway_http_response_with_props(status, headers, body)
        }
    }
}
