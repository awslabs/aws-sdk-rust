...
impl DescribeTransitGatewayVpcAttachmentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_transit_gateway_vpc_attachments::DescribeTransitGatewayVpcAttachmentsInput, ::aws_smithy_types::error::operation::BuildError> {
