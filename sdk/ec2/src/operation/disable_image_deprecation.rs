...
impl DisableImageDeprecation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_image_deprecation::DisableImageDeprecationError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_image_deprecation::DisableImageDeprecationOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DisableImageDeprecation", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableImageDeprecation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DisableImageDeprecation", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableImageDeprecation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DisableImageDeprecationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DisableImageDeprecationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disable_image_deprecation::DisableImageDeprecationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_image_deprecation_input::ser_disable_image_deprecation_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisableImageDeprecationEndpointParamsInterceptor {
...
pub type DisableImageDeprecationErrorKind = DisableImageDeprecationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisableImageDeprecationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_image_deprecation::DisableImageDeprecationError {
...
impl DisableImageDeprecationError {
    ...
    /// Creates the `DisableImageDeprecationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
