...
impl AttachClassicLinkVpcFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcOutput, crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError, Self> {
