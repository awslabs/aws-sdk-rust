...
impl DescribeVpcClassicLink {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeVpcClassicLink", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpcClassicLink {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeVpcClassicLink", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVpcClassicLink")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeVpcClassicLinkResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeVpcClassicLinkRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpc_classic_link_input::ser_describe_vpc_classic_link_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeVpcClassicLinkEndpointParamsInterceptor {
...
pub type DescribeVpcClassicLinkErrorKind = DescribeVpcClassicLinkError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeVpcClassicLinkError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_vpc_classic_link::DescribeVpcClassicLinkError {
...
impl DescribeVpcClassicLinkError {
    ...
    /// Creates the `DescribeVpcClassicLinkError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
