...
impl CreateTransitGatewayConnectPeerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_transit_gateway_connect_peer::CreateTransitGatewayConnectPeer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTransitGatewayConnectPeer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_transit_gateway_connect_peer::de_create_transit_gateway_connect_peer_http_response_with_props(
                status, headers, body,
            )
        }
    }
