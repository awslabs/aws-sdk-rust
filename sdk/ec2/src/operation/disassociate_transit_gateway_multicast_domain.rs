    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateTransitGatewayMulticastDomain {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateTransitGatewayMulticastDomain");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateTransitGatewayMulticastDomainRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateTransitGatewayMulticastDomainResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateTransitGatewayMulticastDomain")
...
.with_interceptor(DisassociateTransitGatewayMulticastDomainEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_transit_gateway_multicast_domain::de_disassociate_transit_gateway_multicast_domain_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_transit_gateway_multicast_domain::de_disassociate_transit_gateway_multicast_domain_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateTransitGatewayMulticastDomainRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateTransitGatewayMulticastDomainEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateTransitGatewayMulticastDomainInput>()
                        .ok_or("failed to downcast to DisassociateTransitGatewayMulticastDomainInput")?;
...
/// Error type for the `DisassociateTransitGatewayMulticastDomainError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DisassociateTransitGatewayMulticastDomainError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateTransitGatewayMulticastDomainError) for what information is available for the error.")]
...
impl DisassociateTransitGatewayMulticastDomainError {
    /// Creates the `DisassociateTransitGatewayMulticastDomainError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateTransitGatewayMulticastDomainError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateTransitGatewayMulticastDomainError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateTransitGatewayMulticastDomainError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainError {
...
mod _disassociate_transit_gateway_multicast_domain_output;
