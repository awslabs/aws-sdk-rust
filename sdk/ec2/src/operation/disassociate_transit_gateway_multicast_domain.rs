...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateTransitGatewayMulticastDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_transit_gateway_multicast_domain_input::ser_disassociate_transit_gateway_multicast_domain_input_input(&input)?);
