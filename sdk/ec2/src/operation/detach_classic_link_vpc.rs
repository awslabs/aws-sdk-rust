...
impl DetachClassicLinkVpc {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DetachClassicLinkVpc", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachClassicLinkVpc {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DetachClassicLinkVpc", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachClassicLinkVpc")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DetachClassicLinkVpcResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DetachClassicLinkVpcRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_classic_link_vpc_input::ser_detach_classic_link_vpc_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DetachClassicLinkVpcEndpointParamsInterceptor {
...
pub type DetachClassicLinkVpcErrorKind = DetachClassicLinkVpcError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DetachClassicLinkVpcError {
...
impl ::aws_http::request_id::RequestId for crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcError {
...
impl DetachClassicLinkVpcError {
    ...
    /// Creates the `DetachClassicLinkVpcError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
