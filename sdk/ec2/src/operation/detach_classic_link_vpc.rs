...
impl DetachClassicLinkVpcInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::detach_classic_link_vpc::DetachClassicLinkVpc,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachClassicLinkVpc {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_classic_link_vpc::de_detach_classic_link_vpc_http_response_with_props(status, headers, body)
        }
    }
}
