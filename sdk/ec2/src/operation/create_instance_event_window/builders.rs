...
impl crate::operation::create_instance_event_window::builders::CreateInstanceEventWindowInputBuilder {
...
/// <ul>
/// <li>
/// <p>Expedited scheduled events and network maintenance events.</p></li>
/// <li>
...
impl CreateInstanceEventWindowFluentBuilder {
    /// Creates a new `CreateInstanceEventWindowFluentBuilder`.
