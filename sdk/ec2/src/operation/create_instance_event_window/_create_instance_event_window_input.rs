...
impl CreateInstanceEventWindowInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_instance_event_window::CreateInstanceEventWindowInput, ::aws_smithy_types::error::operation::BuildError> {
