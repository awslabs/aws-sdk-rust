...
impl PurchaseScheduledInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesOutput, crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError, Self> {
