...
impl AllocateIpamPoolCidr {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateIpamPoolCidr {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AllocateIpamPoolCidr");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AllocateIpamPoolCidrRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AllocateIpamPoolCidrResponseDeserializer));
...
.with_interceptor(AllocateIpamPoolCidrEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError>::new());
...
#[derive(Debug)]
            struct AllocateIpamPoolCidrRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocateIpamPoolCidrRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_allocate_ipam_pool_cidr_input::ser_allocate_ipam_pool_cidr_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocateIpamPoolCidrEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AllocateIpamPoolCidrInput>()
                        .ok_or("failed to downcast to AllocateIpamPoolCidrInput")?;
...
/// Error type for the `AllocateIpamPoolCidrError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum AllocateIpamPoolCidrError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AllocateIpamPoolCidrError) for what information is available for the error.")]
...
impl AllocateIpamPoolCidrError {
    /// Creates the `AllocateIpamPoolCidrError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AllocateIpamPoolCidrError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AllocateIpamPoolCidrError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AllocateIpamPoolCidrError {
