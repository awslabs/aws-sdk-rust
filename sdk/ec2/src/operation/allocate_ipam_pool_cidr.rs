...
impl AllocateIpamPoolCidr {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "AllocateIpamPoolCidr", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateIpamPoolCidr {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AllocateIpamPoolCidr", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocateIpamPoolCidr")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AllocateIpamPoolCidrResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AllocateIpamPoolCidrRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_ipam_pool_cidr_input::ser_allocate_ipam_pool_cidr_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AllocateIpamPoolCidrEndpointParamsInterceptor {
...
pub type AllocateIpamPoolCidrErrorKind = AllocateIpamPoolCidrError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AllocateIpamPoolCidrError {
...
impl ::aws_http::request_id::RequestId for crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrError {
...
impl AllocateIpamPoolCidrError {
    ...
    /// Creates the `AllocateIpamPoolCidrError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
