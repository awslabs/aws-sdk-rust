...
impl AllocateIpamPoolCidrInput {
    /// Consumes the builder and constructs an Operation<[`AllocateIpamPoolCidr`](crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidr)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidr, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidrInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_ipam_pool_cidr_input::ser_allocate_ipam_pool_cidr_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::allocate_ipam_pool_cidr::AllocateIpamPoolCidr::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AllocateIpamPoolCidr", "ec2"));
