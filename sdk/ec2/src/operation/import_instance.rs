...
impl ImportInstanceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_instance_input::ser_import_instance_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_instance::ImportInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_import_instance::de_import_instance_http_error(
                status, headers, body,
            )
        } else {
