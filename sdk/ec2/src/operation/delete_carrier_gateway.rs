...
impl DeleteCarrierGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_carrier_gateway::DeleteCarrierGatewayError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_carrier_gateway::DeleteCarrierGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DeleteCarrierGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCarrierGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteCarrierGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCarrierGateway")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteCarrierGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteCarrierGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_carrier_gateway::DeleteCarrierGatewayInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_carrier_gateway_input::ser_delete_carrier_gateway_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteCarrierGatewayEndpointParamsInterceptor {
...
pub type DeleteCarrierGatewayErrorKind = DeleteCarrierGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteCarrierGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_carrier_gateway::DeleteCarrierGatewayError {
...
impl DeleteCarrierGatewayError {
    ...
    /// Creates the `DeleteCarrierGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
