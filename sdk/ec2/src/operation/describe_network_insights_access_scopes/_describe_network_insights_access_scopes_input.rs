...
impl DescribeNetworkInsightsAccessScopesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_network_insights_access_scopes::DescribeNetworkInsightsAccessScopesInput, ::aws_smithy_types::error::operation::BuildError> {
