...
impl EnableFastSnapshotRestoresInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresInput, ::aws_smithy_types::error::operation::BuildError> {
