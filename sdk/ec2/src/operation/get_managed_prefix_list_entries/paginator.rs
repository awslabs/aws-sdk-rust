...
/// Paginator for [`GetManagedPrefixListEntries`](crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntries)
            ...
            impl GetManagedPrefixListEntriesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesOutput, aws_smithy_http::result::SdkError<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesError>>> + Unpin
                 {
...
/// Flattened paginator for `GetManagedPrefixListEntriesPaginator`
                ...
                impl  GetManagedPrefixListEntriesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::PrefixListEntry, aws_smithy_http::result::SdkError<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesError>>> + Unpin
                     {
