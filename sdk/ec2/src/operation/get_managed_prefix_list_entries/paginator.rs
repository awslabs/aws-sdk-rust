...
/// Paginator for [`GetManagedPrefixListEntries`](crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntries)
                ...
                impl GetManagedPrefixListEntriesPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::get_managed_prefix_list_entries::builders::GetManagedPrefixListEntriesInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntries::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `GetManagedPrefixListEntriesPaginator`
                    ...
                    impl GetManagedPrefixListEntriesPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::PrefixListEntry, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_get_managed_prefix_list_entries_output_output_entries(page).unwrap_or_default().into_iter())
                        }
                    }
