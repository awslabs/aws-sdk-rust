...
impl ModifySnapshotTierFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_snapshot_tier::ModifySnapshotTierOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_snapshot_tier::ModifySnapshotTierError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_snapshot_tier::ModifySnapshotTierOutput, crate::operation::modify_snapshot_tier::ModifySnapshotTierError, Self> {
