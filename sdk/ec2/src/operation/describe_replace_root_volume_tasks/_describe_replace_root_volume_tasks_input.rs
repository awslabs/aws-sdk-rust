...
impl DescribeReplaceRootVolumeTasksInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::describe_replace_root_volume_tasks::DescribeReplaceRootVolumeTasksInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
