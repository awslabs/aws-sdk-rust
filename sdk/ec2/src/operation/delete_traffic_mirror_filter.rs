...
impl DeleteTrafficMirrorFilterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilter,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilter::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrafficMirrorFilter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_traffic_mirror_filter::de_delete_traffic_mirror_filter_http_response_with_props(status, headers, body)
        }
    }
}
