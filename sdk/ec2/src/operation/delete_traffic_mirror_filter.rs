    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTrafficMirrorFilter {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteTrafficMirrorFilter", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTrafficMirrorFilter")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteTrafficMirrorFilterResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteTrafficMirrorFilterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_traffic_mirror_filter_input::ser_delete_traffic_mirror_filter_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteTrafficMirrorFilterEndpointParamsInterceptor {
...
pub type DeleteTrafficMirrorFilterErrorKind = DeleteTrafficMirrorFilterError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteTrafficMirrorFilterError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_traffic_mirror_filter::DeleteTrafficMirrorFilterError {
...
impl DeleteTrafficMirrorFilterError {
    ...
    /// Creates the `DeleteTrafficMirrorFilterError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
