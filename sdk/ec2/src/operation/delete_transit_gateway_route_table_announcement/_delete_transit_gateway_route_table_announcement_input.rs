...
impl DeleteTransitGatewayRouteTableAnnouncementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_transit_gateway_route_table_announcement::DeleteTransitGatewayRouteTableAnnouncementInput, ::aws_smithy_types::error::operation::BuildError> {
