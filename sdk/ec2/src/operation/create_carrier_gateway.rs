...
impl CreateCarrierGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_carrier_gateway::CreateCarrierGatewayError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_carrier_gateway::CreateCarrierGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateCarrierGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCarrierGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateCarrierGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCarrierGateway")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateCarrierGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateCarrierGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_carrier_gateway::CreateCarrierGatewayInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_carrier_gateway_input::ser_create_carrier_gateway_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateCarrierGatewayEndpointParamsInterceptor {
...
pub type CreateCarrierGatewayErrorKind = CreateCarrierGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateCarrierGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_carrier_gateway::CreateCarrierGatewayError {
...
impl CreateCarrierGatewayError {
    ...
    /// Creates the `CreateCarrierGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
