...
impl DisableEbsEncryptionByDefaultInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefault::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableEbsEncryptionByDefault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_ebs_encryption_by_default::de_disable_ebs_encryption_by_default_http_response_with_props(
                status, headers, body,
            )
        }
    }
