...
impl DisableEbsEncryptionByDefault {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultInput,
                    ) -> ::std::result::Result<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableEbsEncryptionByDefault {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableEbsEncryptionByDefault");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableEbsEncryptionByDefaultRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableEbsEncryptionByDefaultResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableEbsEncryptionByDefault")
...
.with_interceptor(DisableEbsEncryptionByDefaultEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultError>::new());
...
#[derive(Debug)]
            struct DisableEbsEncryptionByDefaultResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableEbsEncryptionByDefaultResponseDeserializer {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableEbsEncryptionByDefaultRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_ebs_encryption_by_default::DisableEbsEncryptionByDefaultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_ebs_encryption_by_default_input::ser_disable_ebs_encryption_by_default_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableEbsEncryptionByDefaultEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableEbsEncryptionByDefaultEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableEbsEncryptionByDefaultEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableEbsEncryptionByDefaultInput>()
                        .ok_or("failed to downcast to DisableEbsEncryptionByDefaultInput")?;
...
/// Error type for the `DisableEbsEncryptionByDefaultError` operation.
#[non_exhaustive]
...
pub enum DisableEbsEncryptionByDefaultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableEbsEncryptionByDefaultError) for what information is available for the error.")]
...
impl DisableEbsEncryptionByDefaultError {
    /// Creates the `DisableEbsEncryptionByDefaultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableEbsEncryptionByDefaultError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisableEbsEncryptionByDefaultError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableEbsEncryptionByDefaultError {
