...
impl CancelSpotFleetRequests {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CancelSpotFleetRequests", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelSpotFleetRequests {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CancelSpotFleetRequests", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelSpotFleetRequests")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CancelSpotFleetRequestsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CancelSpotFleetRequestsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_spot_fleet_requests_input::ser_cancel_spot_fleet_requests_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelSpotFleetRequestsEndpointParamsInterceptor {
...
pub type CancelSpotFleetRequestsErrorKind = CancelSpotFleetRequestsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelSpotFleetRequestsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError {
...
impl CancelSpotFleetRequestsError {
    ...
    /// Creates the `CancelSpotFleetRequestsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
