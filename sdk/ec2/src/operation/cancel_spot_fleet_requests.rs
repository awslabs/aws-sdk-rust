...
impl CancelSpotFleetRequests {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelSpotFleetRequests {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelSpotFleetRequests");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelSpotFleetRequestsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelSpotFleetRequestsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelSpotFleetRequests")
...
.with_interceptor(CancelSpotFleetRequestsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_cancel_spot_fleet_requests::de_cancel_spot_fleet_requests_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelSpotFleetRequestsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_spot_fleet_requests_input::ser_cancel_spot_fleet_requests_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CancelSpotFleetRequestsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelSpotFleetRequestsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelSpotFleetRequestsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelSpotFleetRequestsInput>()
                        .ok_or("failed to downcast to CancelSpotFleetRequestsInput")?;
...
/// Error type for the `CancelSpotFleetRequestsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CancelSpotFleetRequestsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelSpotFleetRequestsError) for what information is available for the error.")]
...
impl CancelSpotFleetRequestsError {
    /// Creates the `CancelSpotFleetRequestsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelSpotFleetRequestsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelSpotFleetRequestsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelSpotFleetRequestsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsError {
...
mod _cancel_spot_fleet_requests_output;
