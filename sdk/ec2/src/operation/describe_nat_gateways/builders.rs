...
impl DescribeNatGatewaysFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_nat_gateways::DescribeNatGatewaysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_nat_gateways::DescribeNatGatewaysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_nat_gateways::DescribeNatGatewaysOutput, crate::operation::describe_nat_gateways::DescribeNatGatewaysError, Self> {
