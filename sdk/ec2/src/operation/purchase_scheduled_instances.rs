    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseScheduledInstances {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PurchaseScheduledInstances", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PurchaseScheduledInstances")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PurchaseScheduledInstancesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PurchaseScheduledInstancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_purchase_scheduled_instances_input::ser_purchase_scheduled_instances_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PurchaseScheduledInstancesEndpointParamsInterceptor {
...
pub type PurchaseScheduledInstancesErrorKind = PurchaseScheduledInstancesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for PurchaseScheduledInstancesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError {
...
impl PurchaseScheduledInstancesError {
    ...
    /// Creates the `PurchaseScheduledInstancesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
