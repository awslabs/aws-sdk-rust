...
impl PurchaseScheduledInstancesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::purchase_scheduled_instances::PurchaseScheduledInstances::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseScheduledInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_purchase_scheduled_instances::de_purchase_scheduled_instances_http_response_with_props(status, headers, body)
        }
    }
}
