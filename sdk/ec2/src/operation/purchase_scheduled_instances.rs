...
impl PurchaseScheduledInstances {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesInput,
                    ) -> ::std::result::Result<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseScheduledInstances {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PurchaseScheduledInstances");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PurchaseScheduledInstancesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PurchaseScheduledInstancesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PurchaseScheduledInstances")
...
.with_interceptor(PurchaseScheduledInstancesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError>::new());
...
#[derive(Debug)]
            struct PurchaseScheduledInstancesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurchaseScheduledInstancesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_purchase_scheduled_instances::de_purchase_scheduled_instances_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_purchase_scheduled_instances::de_purchase_scheduled_instances_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurchaseScheduledInstancesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_purchase_scheduled_instances_input::ser_purchase_scheduled_instances_input_input_input(&input)?);
...
#[derive(Debug)]
            struct PurchaseScheduledInstancesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PurchaseScheduledInstancesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PurchaseScheduledInstancesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PurchaseScheduledInstancesInput>()
                        .ok_or("failed to downcast to PurchaseScheduledInstancesInput")?;
...
/// Error type for the `PurchaseScheduledInstancesError` operation.
#[non_exhaustive]
...
pub enum PurchaseScheduledInstancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PurchaseScheduledInstancesError) for what information is available for the error.")]
...
impl PurchaseScheduledInstancesError {
    /// Creates the `PurchaseScheduledInstancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PurchaseScheduledInstancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PurchaseScheduledInstancesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PurchaseScheduledInstancesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesError {
...
mod _purchase_scheduled_instances_output;
