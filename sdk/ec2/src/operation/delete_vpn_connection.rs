...
impl DeleteVpnConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_vpn_connection::DeleteVpnConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpnConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_vpn_connection::de_delete_vpn_connection_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_vpn_connection::DeleteVpnConnectionError
{
