...
impl GetCoipPoolUsage {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetCoipPoolUsage", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCoipPoolUsage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetCoipPoolUsage", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCoipPoolUsage")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetCoipPoolUsageEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetCoipPoolUsageResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetCoipPoolUsageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_coip_pool_usage_input::ser_get_coip_pool_usage_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetCoipPoolUsageEndpointParamsInterceptor {
...
pub type GetCoipPoolUsageErrorKind = GetCoipPoolUsageError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetCoipPoolUsageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_coip_pool_usage::GetCoipPoolUsageError {
...
impl GetCoipPoolUsageError {
    ...
    /// Creates the `GetCoipPoolUsageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
