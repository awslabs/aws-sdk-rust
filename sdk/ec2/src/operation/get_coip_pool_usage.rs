...
/// Orchestration and serialization glue logic for `GetCoipPoolUsage`.
...
impl GetCoipPoolUsage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_coip_pool_usage::GetCoipPoolUsageInput,
                    ) -> ::std::result::Result<crate::operation::get_coip_pool_usage::GetCoipPoolUsageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_coip_pool_usage::GetCoipPoolUsageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCoipPoolUsage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCoipPoolUsage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCoipPoolUsageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCoipPoolUsageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCoipPoolUsage")
...
.with_interceptor(GetCoipPoolUsageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageError>::new());
...
#[derive(Debug)]
            struct GetCoipPoolUsageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCoipPoolUsageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_coip_pool_usage::de_get_coip_pool_usage_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_coip_pool_usage::de_get_coip_pool_usage_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCoipPoolUsageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCoipPoolUsageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_coip_pool_usage::GetCoipPoolUsageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_coip_pool_usage::GetCoipPoolUsageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_coip_pool_usage_input::ser_get_coip_pool_usage_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetCoipPoolUsageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCoipPoolUsageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCoipPoolUsageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCoipPoolUsageInput>()
                        .ok_or("failed to downcast to GetCoipPoolUsageInput")?;
...
/// Error type for the `GetCoipPoolUsageError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetCoipPoolUsageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCoipPoolUsageError) for what information is available for the error.")]
...
impl GetCoipPoolUsageError {
    /// Creates the `GetCoipPoolUsageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCoipPoolUsageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCoipPoolUsageError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCoipPoolUsageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_coip_pool_usage::GetCoipPoolUsageError {
...
mod _get_coip_pool_usage_output;
