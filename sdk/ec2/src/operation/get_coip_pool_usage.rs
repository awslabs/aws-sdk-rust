...
impl GetCoipPoolUsageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_coip_pool_usage::GetCoipPoolUsage,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCoipPoolUsage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_coip_pool_usage::de_get_coip_pool_usage_http_response_with_props(status, headers, body)
        }
    }
}
