...
impl GetAwsNetworkPerformanceDataFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_aws_network_performance_data::GetAwsNetworkPerformanceDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_aws_network_performance_data::GetAwsNetworkPerformanceDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_aws_network_performance_data::GetAwsNetworkPerformanceDataOutput, crate::operation::get_aws_network_performance_data::GetAwsNetworkPerformanceDataError, Self> {
