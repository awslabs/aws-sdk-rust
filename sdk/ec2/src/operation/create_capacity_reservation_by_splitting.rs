...
impl CreateCapacityReservationBySplitting {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_capacity_reservation_by_splitting::CreateCapacityReservationBySplittingError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_capacity_reservation_by_splitting::CreateCapacityReservationBySplittingOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "EC2",
            "rpc.method" = "CreateCapacityReservationBySplitting",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateCapacityReservationBySplitting")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCapacityReservationBySplitting")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateCapacityReservationBySplittingTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateCapacityReservationBySplittingTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCapacityReservationBySplittingTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateCapacityReservationBySplittingInput>() else {
        ...
        if requested.should_capture("SourceCapacityReservationId") {
            if let ::std::option::Option::Some(value) = input.source_capacity_reservation_id.as_deref() {
                captured.insert("SourceCapacityReservationId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCapacityReservationBySplittingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_capacity_reservation_by_splitting::CreateCapacityReservationBySplittingInput>()
            .expect("correct type");
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCapacityReservationBySplittingEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateCapacityReservationBySplittingInput>()
