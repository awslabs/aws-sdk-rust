...
impl DescribeFpgaImageAttributeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttribute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFpgaImageAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fpga_image_attribute::de_describe_fpga_image_attribute_http_response_with_props(
                status, headers, body,
            )
        }
    }
