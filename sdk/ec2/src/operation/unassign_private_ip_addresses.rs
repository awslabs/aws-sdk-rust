...
impl UnassignPrivateIpAddresses {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UnassignPrivateIpAddresses {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UnassignPrivateIpAddresses");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UnassignPrivateIpAddressesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UnassignPrivateIpAddressesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UnassignPrivateIpAddresses")
...
.with_interceptor(UnassignPrivateIpAddressesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesError>::new());
...
#[derive(Debug)]
            struct UnassignPrivateIpAddressesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnassignPrivateIpAddressesResponseDeserializer {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UnassignPrivateIpAddressesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_unassign_private_ip_addresses_input::ser_unassign_private_ip_addresses_input_input_input(&input)?);
...
#[derive(Debug)]
            struct UnassignPrivateIpAddressesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UnassignPrivateIpAddressesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UnassignPrivateIpAddressesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UnassignPrivateIpAddressesInput>()
                        .ok_or("failed to downcast to UnassignPrivateIpAddressesInput")?;
...
pub enum UnassignPrivateIpAddressesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UnassignPrivateIpAddressesError) for what information is available for the error.")]
...
impl UnassignPrivateIpAddressesError {
    /// Creates the `UnassignPrivateIpAddressesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UnassignPrivateIpAddressesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UnassignPrivateIpAddressesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesError {
