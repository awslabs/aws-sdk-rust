...
impl UnassignPrivateIpAddressesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddresses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnassignPrivateIpAddresses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_unassign_private_ip_addresses::de_unassign_private_ip_addresses_http_response_with_props(
                status, headers, body,
            )
        }
    }
