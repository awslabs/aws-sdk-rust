...
impl DescribeVpcAttributeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_vpc_attribute::DescribeVpcAttribute,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVpcAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vpc_attribute::de_describe_vpc_attribute_http_response_with_props(status, headers, body)
        }
    }
}
