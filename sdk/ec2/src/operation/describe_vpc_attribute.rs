    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_attribute::DescribeVpcAttributeError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_attribute::DescribeVpcAttributeOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeVpcAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeVpcAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_attribute::DescribeVpcAttributeInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpc_attribute_input::ser_describe_vpc_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeVpcAttributeEndpointParamsInterceptor {
...
pub type DescribeVpcAttributeErrorKind = DescribeVpcAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeVpcAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_vpc_attribute::DescribeVpcAttributeError {
...
impl DescribeVpcAttributeError {
    ...
    /// Creates the `DescribeVpcAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
