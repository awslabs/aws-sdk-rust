...
impl ListSnapshotsInRecycleBinInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_snapshots_in_recycle_bin::ListSnapshotsInRecycleBin::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSnapshotsInRecycleBin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_snapshots_in_recycle_bin::de_list_snapshots_in_recycle_bin_http_response_with_props(
                status, headers, body,
            )
        }
    }
