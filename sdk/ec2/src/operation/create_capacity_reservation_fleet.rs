...
impl CreateCapacityReservationFleetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCapacityReservationFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_capacity_reservation_fleet::de_create_capacity_reservation_fleet_http_response_with_props(
                status, headers, body,
            )
        }
    }
