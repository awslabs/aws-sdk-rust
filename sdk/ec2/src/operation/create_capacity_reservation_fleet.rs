...
impl CreateCapacityReservationFleet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCapacityReservationFleet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCapacityReservationFleet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCapacityReservationFleetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCapacityReservationFleetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCapacityReservationFleet")
...
.with_interceptor(CreateCapacityReservationFleetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError>::new());
...
#[derive(Debug)]
            struct CreateCapacityReservationFleetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCapacityReservationFleetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_capacity_reservation_fleet_input::ser_create_capacity_reservation_fleet_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateCapacityReservationFleetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCapacityReservationFleetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCapacityReservationFleetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCapacityReservationFleetInput>()
                        .ok_or("failed to downcast to CreateCapacityReservationFleetInput")?;
...
/// Error type for the `CreateCapacityReservationFleetError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateCapacityReservationFleetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCapacityReservationFleetError) for what information is available for the error.")]
...
impl CreateCapacityReservationFleetError {
    /// Creates the `CreateCapacityReservationFleetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCapacityReservationFleetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateCapacityReservationFleetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCapacityReservationFleetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError {
...
mod _create_capacity_reservation_fleet_output;
