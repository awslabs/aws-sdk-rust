...
impl DescribeVpcEndpointConnectionsFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_vpc_endpoint_connections::DescribeVpcEndpointConnectionsError>>
                         {
        let op = self
            .inner
            .build()
