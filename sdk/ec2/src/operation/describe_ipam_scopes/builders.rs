...
impl DescribeIpamScopesFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::describe_ipam_scopes::paginator::DescribeIpamScopesPaginator {
        crate::operation::describe_ipam_scopes::paginator::DescribeIpamScopesPaginator::new(
            self.handle,
            self.inner,
        )
    }
