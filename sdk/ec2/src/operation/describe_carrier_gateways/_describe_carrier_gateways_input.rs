...
impl DescribeCarrierGatewaysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_carrier_gateways::DescribeCarrierGatewaysInput, ::aws_smithy_types::error::operation::BuildError> {
