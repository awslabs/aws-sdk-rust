...
impl AssociateTransitGatewayRouteTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_transit_gateway_route_table::AssociateTransitGatewayRouteTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateTransitGatewayRouteTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_transit_gateway_route_table::de_associate_transit_gateway_route_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
