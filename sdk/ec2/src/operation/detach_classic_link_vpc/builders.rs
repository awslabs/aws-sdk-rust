...
impl DetachClassicLinkVpcFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcOutput, crate::operation::detach_classic_link_vpc::DetachClassicLinkVpcError, Self> {
