...
impl DescribeKeyPairsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_key_pairs::DescribeKeyPairsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_key_pairs::DescribeKeyPairsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_key_pairs::DescribeKeyPairsOutput, crate::operation::describe_key_pairs::DescribeKeyPairsError, Self> {
