...
impl CreateSubnetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_subnet::CreateSubnet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_subnet_input::ser_create_subnet_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSubnet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_subnet::de_create_subnet_http_response_with_props(status, headers, body)
        }
    }
}
