...
impl DeleteTrafficMirrorTargetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_traffic_mirror_target::DeleteTrafficMirrorTargetInput, ::aws_smithy_types::error::operation::BuildError> {
