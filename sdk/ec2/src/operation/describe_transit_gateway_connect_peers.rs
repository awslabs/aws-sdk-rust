...
impl DescribeTransitGatewayConnectPeersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_transit_gateway_connect_peers::DescribeTransitGatewayConnectPeers,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_transit_gateway_connect_peers::DescribeTransitGatewayConnectPeers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTransitGatewayConnectPeers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_transit_gateway_connect_peers::de_describe_transit_gateway_connect_peers_http_response_with_props(
                status, headers, body,
            )
        }
    }
