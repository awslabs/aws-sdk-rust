...
impl DeleteCarrierGatewayFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_carrier_gateway::DeleteCarrierGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_carrier_gateway::DeleteCarrierGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_carrier_gateway::DeleteCarrierGatewayOutput, crate::operation::delete_carrier_gateway::DeleteCarrierGatewayError, Self> {
