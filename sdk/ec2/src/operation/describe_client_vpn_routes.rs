...
impl DescribeClientVpnRoutesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_client_vpn_routes::DescribeClientVpnRoutes,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClientVpnRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_client_vpn_routes::de_describe_client_vpn_routes_http_response_with_props(status, headers, body)
        }
    }
}
