...
impl DescribeAggregateIdFormat {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeAggregateIdFormat", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAggregateIdFormat {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            DescribeAggregateIdFormatRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            DescribeAggregateIdFormatResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeAggregateIdFormat", "ec2"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeAggregateIdFormatResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeAggregateIdFormatRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_aggregate_id_format_input::ser_describe_aggregate_id_format_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAggregateIdFormatEndpointParamsInterceptor {
