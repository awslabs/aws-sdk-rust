...
impl ModifyCapacityReservationFleetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_capacity_reservation_fleet::ModifyCapacityReservationFleet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyCapacityReservationFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_capacity_reservation_fleet::de_modify_capacity_reservation_fleet_http_response_with_props(
                status, headers, body,
            )
        }
    }
