...
impl DescribeNetworkInsightsAnalysesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalyses::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNetworkInsightsAnalyses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_network_insights_analyses::de_describe_network_insights_analyses_http_response_with_props(
                status, headers, body,
            )
        }
    }
