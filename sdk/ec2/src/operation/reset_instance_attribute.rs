...
impl ResetInstanceAttribute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_instance_attribute::ResetInstanceAttributeError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_instance_attribute::ResetInstanceAttributeOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ResetInstanceAttribute", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetInstanceAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ResetInstanceAttribute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetInstanceAttribute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ResetInstanceAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ResetInstanceAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reset_instance_attribute::ResetInstanceAttributeInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_instance_attribute_input::ser_reset_instance_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ResetInstanceAttributeEndpointParamsInterceptor {
...
pub type ResetInstanceAttributeErrorKind = ResetInstanceAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResetInstanceAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_instance_attribute::ResetInstanceAttributeError {
...
impl ResetInstanceAttributeError {
    ...
    /// Creates the `ResetInstanceAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
