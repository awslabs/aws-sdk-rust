...
impl CancelSpotInstanceRequestsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsOutput, crate::operation::cancel_spot_instance_requests::CancelSpotInstanceRequestsError, Self> {
