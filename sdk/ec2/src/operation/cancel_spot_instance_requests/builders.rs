...
impl crate::operation::cancel_spot_instance_requests::builders::CancelSpotInstanceRequestsInputBuilder {
...
impl CancelSpotInstanceRequestsFluentBuilder {
    /// Creates a new `CancelSpotInstanceRequestsFluentBuilder`.
