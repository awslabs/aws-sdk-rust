...
impl RunScheduledInstances {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::run_scheduled_instances::RunScheduledInstancesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::run_scheduled_instances::RunScheduledInstancesOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "RunScheduledInstances", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RunScheduledInstances {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RunScheduledInstances", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RunScheduledInstances")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RunScheduledInstancesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RunScheduledInstancesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::run_scheduled_instances::RunScheduledInstancesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_run_scheduled_instances_input::ser_run_scheduled_instances_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RunScheduledInstancesEndpointParamsInterceptor {
...
pub type RunScheduledInstancesErrorKind = RunScheduledInstancesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for RunScheduledInstancesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::run_scheduled_instances::RunScheduledInstancesError {
...
impl RunScheduledInstancesError {
    ...
    /// Creates the `RunScheduledInstancesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
