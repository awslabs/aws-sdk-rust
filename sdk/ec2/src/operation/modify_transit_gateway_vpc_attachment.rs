...
impl ModifyTransitGatewayVpcAttachmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_transit_gateway_vpc_attachment::ModifyTransitGatewayVpcAttachment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyTransitGatewayVpcAttachment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_transit_gateway_vpc_attachment::de_modify_transit_gateway_vpc_attachment_http_response_with_props(
                status, headers, body,
            )
        }
    }
