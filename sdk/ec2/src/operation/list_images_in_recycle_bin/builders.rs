...
impl ListImagesInRecycleBinFluentBuilder  {
    /// Creates a new `ListImagesInRecycleBin`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBin, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBinOutput, aws_smithy_http::result::SdkError<crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBinError>>
                     {
    ...
    /// Create a paginator for this request
                        ///
                        /// Paginators are used by calling [`send().await`](crate::operation::list_images_in_recycle_bin::paginator::ListImagesInRecycleBinPaginator::send) which returns a `Stream`.
