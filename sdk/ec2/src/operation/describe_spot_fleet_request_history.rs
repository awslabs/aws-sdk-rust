...
impl DescribeSpotFleetRequestHistoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpotFleetRequestHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_spot_fleet_request_history::de_describe_spot_fleet_request_history_http_response_with_props(
                status, headers, body,
            )
        }
    }
