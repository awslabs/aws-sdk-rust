...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeSpotFleetRequestHistory {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeSpotFleetRequestHistory", "ec2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeSpotFleetRequestHistoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeSpotFleetRequestHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_fleet_request_history_input::ser_describe_spot_fleet_request_history_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeSpotFleetRequestHistoryEndpointParamsInterceptor {
