...
impl AssociateInstanceEventWindowFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowOutput, crate::operation::associate_instance_event_window::AssociateInstanceEventWindowError, Self> {
