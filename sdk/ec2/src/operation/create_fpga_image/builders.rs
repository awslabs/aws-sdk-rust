...
impl crate::operation::create_fpga_image::builders::CreateFpgaImageInputBuilder {
...
/// <p>The create operation is asynchronous. To verify that the AFI was successfully created and is ready for use, check the output logs.</p>
