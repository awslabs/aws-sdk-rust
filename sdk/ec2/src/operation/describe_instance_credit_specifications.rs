...
impl DescribeInstanceCreditSpecificationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_instance_credit_specifications::DescribeInstanceCreditSpecifications::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstanceCreditSpecifications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_instance_credit_specifications::de_describe_instance_credit_specifications_http_response_with_props(
                status, headers, body,
            )
        }
    }
