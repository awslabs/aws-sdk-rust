...
/// Orchestration and serialization glue logic for `ReleaseHosts`.
...
impl ReleaseHosts {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::release_hosts::ReleaseHostsInput,
                    ) -> ::std::result::Result<crate::operation::release_hosts::ReleaseHostsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::release_hosts::ReleaseHostsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::release_hosts::ReleaseHostsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::release_hosts::ReleaseHostsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReleaseHosts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReleaseHosts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReleaseHostsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReleaseHostsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReleaseHosts")
...
.with_interceptor(ReleaseHostsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::release_hosts::ReleaseHostsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::release_hosts::ReleaseHostsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::release_hosts::ReleaseHostsError>::new());
...
#[derive(Debug)]
            struct ReleaseHostsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReleaseHostsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_release_hosts::de_release_hosts_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_release_hosts::de_release_hosts_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReleaseHostsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::release_hosts::ReleaseHostsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::release_hosts::ReleaseHostsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_release_hosts_input::ser_release_hosts_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReleaseHostsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReleaseHostsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReleaseHostsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReleaseHostsInput>()
                        .ok_or("failed to downcast to ReleaseHostsInput")?;
...
/// Error type for the `ReleaseHostsError` operation.
#[non_exhaustive]
...
pub enum ReleaseHostsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReleaseHostsError) for what information is available for the error.")]
...
impl ReleaseHostsError {
    /// Creates the `ReleaseHostsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReleaseHostsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReleaseHostsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReleaseHostsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::release_hosts::ReleaseHostsError {
