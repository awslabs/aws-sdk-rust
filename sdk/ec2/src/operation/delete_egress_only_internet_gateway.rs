...
impl DeleteEgressOnlyInternetGateway {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_egress_only_internet_gateway::DeleteEgressOnlyInternetGatewayOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteEgressOnlyInternetGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteEgressOnlyInternetGatewayRequestSerializer {
