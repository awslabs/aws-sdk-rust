...
impl DeleteEgressOnlyInternetGatewayInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_egress_only_internet_gateway::DeleteEgressOnlyInternetGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEgressOnlyInternetGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_egress_only_internet_gateway::de_delete_egress_only_internet_gateway_http_response_with_props(
                status, headers, body,
            )
        }
    }
