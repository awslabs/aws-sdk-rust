...
impl AuthorizeSecurityGroupEgressInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::authorize_security_group_egress::AuthorizeSecurityGroupEgressInput, ::aws_smithy_types::error::operation::BuildError> {
