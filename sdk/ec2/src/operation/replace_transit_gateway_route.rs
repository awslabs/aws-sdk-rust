...
impl ReplaceTransitGatewayRouteInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRoute::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplaceTransitGatewayRoute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replace_transit_gateway_route::de_replace_transit_gateway_route_http_response_with_props(
                status, headers, body,
            )
        }
    }
