    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceTransitGatewayRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReplaceTransitGatewayRoute", "ec2"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReplaceTransitGatewayRouteResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReplaceTransitGatewayRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replace_transit_gateway_route_input::ser_replace_transit_gateway_route_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReplaceTransitGatewayRouteEndpointParamsInterceptor {
