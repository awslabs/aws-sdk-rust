    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateDhcpOptionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateDhcpOptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_dhcp_options_input::ser_associate_dhcp_options_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateDhcpOptionsEndpointParamsInterceptor {
...
pub type AssociateDhcpOptionsErrorKind = AssociateDhcpOptionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateDhcpOptionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_dhcp_options::AssociateDhcpOptionsError {
...
impl AssociateDhcpOptionsError {
    ...
    /// Creates the `AssociateDhcpOptionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
