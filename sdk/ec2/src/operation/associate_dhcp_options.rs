...
impl AssociateDhcpOptions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_dhcp_options::AssociateDhcpOptionsInput,
                    ) -> ::std::result::Result<crate::operation::associate_dhcp_options::AssociateDhcpOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_dhcp_options::AssociateDhcpOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateDhcpOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateDhcpOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateDhcpOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateDhcpOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateDhcpOptions")
...
.with_interceptor(AssociateDhcpOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsError>::new());
...
#[derive(Debug)]
            struct AssociateDhcpOptionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateDhcpOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_dhcp_options::de_associate_dhcp_options_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_associate_dhcp_options::de_associate_dhcp_options_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateDhcpOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_dhcp_options::AssociateDhcpOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_dhcp_options::AssociateDhcpOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_dhcp_options_input::ser_associate_dhcp_options_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AssociateDhcpOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateDhcpOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateDhcpOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateDhcpOptionsInput>()
                        .ok_or("failed to downcast to AssociateDhcpOptionsInput")?;
...
/// Error type for the `AssociateDhcpOptionsError` operation.
#[non_exhaustive]
...
pub enum AssociateDhcpOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateDhcpOptionsError) for what information is available for the error.")]
...
impl AssociateDhcpOptionsError {
    /// Creates the `AssociateDhcpOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateDhcpOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateDhcpOptionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateDhcpOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_dhcp_options::AssociateDhcpOptionsError {
...
mod _associate_dhcp_options_output;
