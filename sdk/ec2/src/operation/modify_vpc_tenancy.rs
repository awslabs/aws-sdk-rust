...
impl ModifyVpcTenancyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_vpc_tenancy::ModifyVpcTenancy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyVpcTenancy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_vpc_tenancy::de_modify_vpc_tenancy_http_response_with_props(status, headers, body)
        }
    }
}
