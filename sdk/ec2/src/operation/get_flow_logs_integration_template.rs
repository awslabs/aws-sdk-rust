...
impl GetFlowLogsIntegrationTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFlowLogsIntegrationTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_flow_logs_integration_template::de_get_flow_logs_integration_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
