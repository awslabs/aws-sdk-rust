...
impl RestoreAddressToClassicInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.restore_address_to_classic();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::restore_address_to_classic::RestoreAddressToClassicOutput,
                    crate::operation::restore_address_to_classic::RestoreAddressToClassicError,
                > for RestoreAddressToClassicFluentBuilder
            {
                fn send(
                    self,
...
impl RestoreAddressToClassicFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restore_address_to_classic::RestoreAddressToClassicOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_address_to_classic::RestoreAddressToClassicError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::restore_address_to_classic::RestoreAddressToClassic::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::restore_address_to_classic::RestoreAddressToClassic::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restore_address_to_classic::RestoreAddressToClassicOutput, crate::operation::restore_address_to_classic::RestoreAddressToClassicError, Self> {
