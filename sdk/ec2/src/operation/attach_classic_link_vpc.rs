...
/// Orchestration and serialization glue logic for `AttachClassicLinkVpc`.
...
impl AttachClassicLinkVpc {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachClassicLinkVpc {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AttachClassicLinkVpc");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AttachClassicLinkVpcRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AttachClassicLinkVpcResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachClassicLinkVpc")
...
.with_interceptor(AttachClassicLinkVpcEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError>::new());
...
#[derive(Debug)]
            struct AttachClassicLinkVpcResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachClassicLinkVpcResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_attach_classic_link_vpc::de_attach_classic_link_vpc_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_attach_classic_link_vpc::de_attach_classic_link_vpc_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachClassicLinkVpcRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_attach_classic_link_vpc_input::ser_attach_classic_link_vpc_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AttachClassicLinkVpcEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachClassicLinkVpcEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AttachClassicLinkVpcEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AttachClassicLinkVpcInput>()
                        .ok_or("failed to downcast to AttachClassicLinkVpcInput")?;
...
/// Error type for the `AttachClassicLinkVpcError` operation.
#[non_exhaustive]
...
pub enum AttachClassicLinkVpcError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AttachClassicLinkVpcError) for what information is available for the error.")]
...
impl AttachClassicLinkVpcError {
    /// Creates the `AttachClassicLinkVpcError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AttachClassicLinkVpcError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AttachClassicLinkVpcError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AttachClassicLinkVpcError {
...
impl ::aws_types::request_id::RequestId for crate::operation::attach_classic_link_vpc::AttachClassicLinkVpcError {
...
mod _attach_classic_link_vpc_output;
