    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::authorize_security_group_egress::AuthorizeSecurityGroupEgressError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::authorize_security_group_egress::AuthorizeSecurityGroupEgressOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeSecurityGroupEgress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AuthorizeSecurityGroupEgress", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AuthorizeSecurityGroupEgress")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AuthorizeSecurityGroupEgressResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AuthorizeSecurityGroupEgressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::authorize_security_group_egress::AuthorizeSecurityGroupEgressInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_security_group_egress_input::ser_authorize_security_group_egress_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AuthorizeSecurityGroupEgressEndpointParamsInterceptor {
...
pub type AuthorizeSecurityGroupEgressErrorKind = AuthorizeSecurityGroupEgressError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AuthorizeSecurityGroupEgressError {
...
impl ::aws_http::request_id::RequestId for crate::operation::authorize_security_group_egress::AuthorizeSecurityGroupEgressError {
...
impl AuthorizeSecurityGroupEgressError {
    ...
    /// Creates the `AuthorizeSecurityGroupEgressError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
