...
impl ReplaceNetworkAclAssociation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceNetworkAclAssociation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReplaceNetworkAclAssociation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReplaceNetworkAclAssociationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReplaceNetworkAclAssociationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceNetworkAclAssociation")
...
.with_interceptor(ReplaceNetworkAclAssociationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_replace_network_acl_association::de_replace_network_acl_association_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplaceNetworkAclAssociationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_replace_network_acl_association_input::ser_replace_network_acl_association_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReplaceNetworkAclAssociationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplaceNetworkAclAssociationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReplaceNetworkAclAssociationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReplaceNetworkAclAssociationInput>()
                        .ok_or("failed to downcast to ReplaceNetworkAclAssociationInput")?;
...
/// Error type for the `ReplaceNetworkAclAssociationError` operation.
#[non_exhaustive]
...
pub enum ReplaceNetworkAclAssociationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReplaceNetworkAclAssociationError) for what information is available for the error.")]
...
impl ReplaceNetworkAclAssociationError {
    /// Creates the `ReplaceNetworkAclAssociationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceNetworkAclAssociationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReplaceNetworkAclAssociationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReplaceNetworkAclAssociationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError {
...
mod _replace_network_acl_association_output;
