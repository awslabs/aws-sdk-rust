...
impl ReplaceNetworkAclAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplaceNetworkAclAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replace_network_acl_association::de_replace_network_acl_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
