    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceNetworkAclAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReplaceNetworkAclAssociation", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceNetworkAclAssociation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReplaceNetworkAclAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReplaceNetworkAclAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replace_network_acl_association_input::ser_replace_network_acl_association_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReplaceNetworkAclAssociationEndpointParamsInterceptor {
...
pub type ReplaceNetworkAclAssociationErrorKind = ReplaceNetworkAclAssociationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReplaceNetworkAclAssociationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::replace_network_acl_association::ReplaceNetworkAclAssociationError {
...
impl ReplaceNetworkAclAssociationError {
    ...
    /// Creates the `ReplaceNetworkAclAssociationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
