...
impl ModifyIdentityIdFormatFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_identity_id_format::ModifyIdentityIdFormatOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_identity_id_format::ModifyIdentityIdFormatError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_identity_id_format::ModifyIdentityIdFormatOutput, crate::operation::modify_identity_id_format::ModifyIdentityIdFormatError, Self> {
