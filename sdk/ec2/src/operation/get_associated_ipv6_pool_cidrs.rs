    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAssociatedIpv6PoolCidrs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetAssociatedIpv6PoolCidrs", "ec2"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetAssociatedIpv6PoolCidrsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetAssociatedIpv6PoolCidrsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_associated_ipv6_pool_cidrs_input::ser_get_associated_ipv6_pool_cidrs_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetAssociatedIpv6PoolCidrsEndpointParamsInterceptor {
...
pub type GetAssociatedIpv6PoolCidrsErrorKind = GetAssociatedIpv6PoolCidrsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetAssociatedIpv6PoolCidrsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError {
...
impl GetAssociatedIpv6PoolCidrsError {
    ...
    /// Creates the `GetAssociatedIpv6PoolCidrsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
