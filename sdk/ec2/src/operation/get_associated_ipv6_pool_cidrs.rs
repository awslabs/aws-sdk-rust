...
impl GetAssociatedIpv6PoolCidrs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsInput,
                    ) -> ::std::result::Result<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAssociatedIpv6PoolCidrs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAssociatedIpv6PoolCidrs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAssociatedIpv6PoolCidrsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAssociatedIpv6PoolCidrsResponseDeserializer));
...
.with_interceptor(GetAssociatedIpv6PoolCidrsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError>::new());
...
#[derive(Debug)]
            struct GetAssociatedIpv6PoolCidrsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAssociatedIpv6PoolCidrsResponseDeserializer {
...
#[derive(Debug)]
            struct GetAssociatedIpv6PoolCidrsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAssociatedIpv6PoolCidrsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_associated_ipv6_pool_cidrs_input::ser_get_associated_ipv6_pool_cidrs_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetAssociatedIpv6PoolCidrsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAssociatedIpv6PoolCidrsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAssociatedIpv6PoolCidrsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAssociatedIpv6PoolCidrsInput>()
                        .ok_or("failed to downcast to GetAssociatedIpv6PoolCidrsInput")?;
...
/// Error type for the `GetAssociatedIpv6PoolCidrsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetAssociatedIpv6PoolCidrsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAssociatedIpv6PoolCidrsError) for what information is available for the error.")]
...
impl GetAssociatedIpv6PoolCidrsError {
    /// Creates the `GetAssociatedIpv6PoolCidrsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAssociatedIpv6PoolCidrsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetAssociatedIpv6PoolCidrsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAssociatedIpv6PoolCidrsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsError {
...
mod _get_associated_ipv6_pool_cidrs_output;
