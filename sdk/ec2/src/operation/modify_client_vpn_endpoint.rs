...
impl ModifyClientVpnEndpoint {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyClientVpnEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyClientVpnEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyClientVpnEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyClientVpnEndpointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyClientVpnEndpoint")
...
.with_interceptor(ModifyClientVpnEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyClientVpnEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_client_vpn_endpoint_input::ser_modify_client_vpn_endpoint_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyClientVpnEndpointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyClientVpnEndpointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyClientVpnEndpointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyClientVpnEndpointInput>()
                        .ok_or("failed to downcast to ModifyClientVpnEndpointInput")?;
...
/// Error type for the `ModifyClientVpnEndpointError` operation.
#[non_exhaustive]
...
pub enum ModifyClientVpnEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyClientVpnEndpointError) for what information is available for the error.")]
...
impl ModifyClientVpnEndpointError {
    /// Creates the `ModifyClientVpnEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyClientVpnEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyClientVpnEndpointError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyClientVpnEndpointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_client_vpn_endpoint::_modify_client_vpn_endpoint_output::ModifyClientVpnEndpointOutput;

pub use crate::operation::modify_client_vpn_endpoint::_modify_client_vpn_endpoint_input::ModifyClientVpnEndpointInput;

mod _modify_client_vpn_endpoint_input;

mod _modify_client_vpn_endpoint_output;
