...
impl ModifyClientVpnEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ModifyClientVpnEndpoint", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyClientVpnEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifyClientVpnEndpoint", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyClientVpnEndpoint")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyClientVpnEndpointResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyClientVpnEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_client_vpn_endpoint_input::ser_modify_client_vpn_endpoint_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyClientVpnEndpointEndpointParamsInterceptor {
...
pub type ModifyClientVpnEndpointErrorKind = ModifyClientVpnEndpointError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyClientVpnEndpointError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_client_vpn_endpoint::ModifyClientVpnEndpointError {
...
impl ModifyClientVpnEndpointError {
    ...
    /// Creates the `ModifyClientVpnEndpointError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
