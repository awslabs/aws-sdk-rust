...
impl DeleteRouteInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_route_input::ser_delete_route_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_route::DeleteRoute::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteRoute", "ec2"));
