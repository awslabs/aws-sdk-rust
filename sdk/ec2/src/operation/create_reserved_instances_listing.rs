...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateReservedInstancesListing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_reserved_instances_listing::de_create_reserved_instances_listing_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateReservedInstancesListingError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_reserved_instances_listing::CreateReservedInstancesListingError
{
