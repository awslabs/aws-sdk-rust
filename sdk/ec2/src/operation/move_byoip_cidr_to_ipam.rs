...
impl MoveByoipCidrToIpam {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "MoveByoipCidrToIpam", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MoveByoipCidrToIpam {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("MoveByoipCidrToIpam", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MoveByoipCidrToIpam")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(MoveByoipCidrToIpamEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for MoveByoipCidrToIpamResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for MoveByoipCidrToIpamRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_move_byoip_cidr_to_ipam_input::ser_move_byoip_cidr_to_ipam_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for MoveByoipCidrToIpamEndpointParamsInterceptor {
...
pub type MoveByoipCidrToIpamErrorKind = MoveByoipCidrToIpamError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for MoveByoipCidrToIpamError {
...
impl ::aws_http::request_id::RequestId for crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError {
...
impl MoveByoipCidrToIpamError {
    ...
    /// Creates the `MoveByoipCidrToIpamError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
