...
impl MoveByoipCidrToIpam {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MoveByoipCidrToIpam {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("MoveByoipCidrToIpam");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(MoveByoipCidrToIpamRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(MoveByoipCidrToIpamResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MoveByoipCidrToIpam")
...
.with_interceptor(MoveByoipCidrToIpamEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError>::new());
...
#[derive(Debug)]
            struct MoveByoipCidrToIpamRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MoveByoipCidrToIpamRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_move_byoip_cidr_to_ipam_input::ser_move_byoip_cidr_to_ipam_input_input_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MoveByoipCidrToIpamEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<MoveByoipCidrToIpamInput>()
                        .ok_or("failed to downcast to MoveByoipCidrToIpamInput")?;
...
/// Error type for the `MoveByoipCidrToIpamError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum MoveByoipCidrToIpamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-MoveByoipCidrToIpamError) for what information is available for the error.")]
...
impl MoveByoipCidrToIpamError {
    /// Creates the `MoveByoipCidrToIpamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `MoveByoipCidrToIpamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for MoveByoipCidrToIpamError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for MoveByoipCidrToIpamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::move_byoip_cidr_to_ipam::MoveByoipCidrToIpamError {
...
mod _move_byoip_cidr_to_ipam_output;
