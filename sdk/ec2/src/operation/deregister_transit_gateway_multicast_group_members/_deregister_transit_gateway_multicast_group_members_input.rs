...
impl DeregisterTransitGatewayMulticastGroupMembersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_transit_gateway_multicast_group_members::DeregisterTransitGatewayMulticastGroupMembersInput, ::aws_smithy_types::error::operation::BuildError> {
