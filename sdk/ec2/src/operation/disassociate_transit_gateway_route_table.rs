    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateTransitGatewayRouteTable {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociateTransitGatewayRouteTableRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateTransitGatewayRouteTableResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DisassociateTransitGatewayRouteTable", "ec2"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DisassociateTransitGatewayRouteTableResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 {
            crate::protocol_serde::shape_disassociate_transit_gateway_route_table::de_disassociate_transit_gateway_route_table_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_disassociate_transit_gateway_route_table::de_disassociate_transit_gateway_route_table_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DisassociateTransitGatewayRouteTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_transit_gateway_route_table::DisassociateTransitGatewayRouteTableInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_transit_gateway_route_table_input::ser_disassociate_transit_gateway_route_table_input_input(
                &input,
            )?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisassociateTransitGatewayRouteTableEndpointParamsInterceptor {
