...
impl DetachNetworkInterfaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detach_network_interface::DetachNetworkInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_network_interface::DetachNetworkInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detach_network_interface::DetachNetworkInterfaceOutput, crate::operation::detach_network_interface::DetachNetworkInterfaceError, Self> {
