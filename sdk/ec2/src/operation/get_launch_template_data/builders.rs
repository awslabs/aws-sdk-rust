...
impl GetLaunchTemplateDataFluentBuilder  {
    /// Creates a new `GetLaunchTemplateData`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_launch_template_data::GetLaunchTemplateDataOutput, aws_smithy_http::result::SdkError<crate::operation::get_launch_template_data::GetLaunchTemplateDataError>>
                     {
