...
impl DescribeSubnetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_subnets::DescribeSubnets, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSubnets {
    type Output =
        ::std::result::Result<crate::operation::describe_subnets::DescribeSubnetsOutput, crate::operation::describe_subnets::DescribeSubnetsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_subnets::de_describe_subnets_http_response_with_props(status, headers, body)
        }
    }
}
