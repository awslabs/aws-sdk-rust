...
impl CreateManagedPrefixList {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_managed_prefix_list::CreateManagedPrefixListError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_managed_prefix_list::CreateManagedPrefixListOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateManagedPrefixList", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateManagedPrefixList {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateManagedPrefixList", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateManagedPrefixList")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateManagedPrefixListResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateManagedPrefixListRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_managed_prefix_list::CreateManagedPrefixListInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_managed_prefix_list_input::ser_create_managed_prefix_list_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateManagedPrefixListEndpointParamsInterceptor {
...
pub type CreateManagedPrefixListErrorKind = CreateManagedPrefixListError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateManagedPrefixListError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_managed_prefix_list::CreateManagedPrefixListError {
...
impl CreateManagedPrefixListError {
    ...
    /// Creates the `CreateManagedPrefixListError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
