...
impl CreateCapacityReservationFleetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetInput, ::aws_smithy_types::error::operation::BuildError> {
