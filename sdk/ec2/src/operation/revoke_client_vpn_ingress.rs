...
impl RevokeClientVpnIngress {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "RevokeClientVpnIngress", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeClientVpnIngress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RevokeClientVpnIngress", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeClientVpnIngress")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RevokeClientVpnIngressResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RevokeClientVpnIngressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_client_vpn_ingress_input::ser_revoke_client_vpn_ingress_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RevokeClientVpnIngressEndpointParamsInterceptor {
...
pub type RevokeClientVpnIngressErrorKind = RevokeClientVpnIngressError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for RevokeClientVpnIngressError {
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError {
...
impl RevokeClientVpnIngressError {
    ...
    /// Creates the `RevokeClientVpnIngressError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
