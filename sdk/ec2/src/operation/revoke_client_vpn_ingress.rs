...
impl RevokeClientVpnIngress {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeClientVpnIngress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RevokeClientVpnIngress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RevokeClientVpnIngressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RevokeClientVpnIngressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeClientVpnIngress")
...
.with_interceptor(RevokeClientVpnIngressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeClientVpnIngressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::revoke_client_vpn_ingress::RevokeClientVpnIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_revoke_client_vpn_ingress_input::ser_revoke_client_vpn_ingress_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RevokeClientVpnIngressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeClientVpnIngressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RevokeClientVpnIngressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RevokeClientVpnIngressInput>()
                        .ok_or("failed to downcast to RevokeClientVpnIngressInput")?;
...
/// Error type for the `RevokeClientVpnIngressError` operation.
#[non_exhaustive]
...
pub enum RevokeClientVpnIngressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RevokeClientVpnIngressError) for what information is available for the error.")]
...
impl RevokeClientVpnIngressError {
    /// Creates the `RevokeClientVpnIngressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeClientVpnIngressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RevokeClientVpnIngressError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RevokeClientVpnIngressError {
