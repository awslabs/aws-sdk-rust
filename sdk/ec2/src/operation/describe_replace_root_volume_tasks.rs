...
impl DescribeReplaceRootVolumeTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_replace_root_volume_tasks::DescribeReplaceRootVolumeTasks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplaceRootVolumeTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replace_root_volume_tasks::de_describe_replace_root_volume_tasks_http_response_with_props(
                status, headers, body,
            )
        }
    }
