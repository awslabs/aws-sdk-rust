...
impl ReplaceRouteTableAssociation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceRouteTableAssociation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReplaceRouteTableAssociation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReplaceRouteTableAssociationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReplaceRouteTableAssociationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceRouteTableAssociation")
...
.with_interceptor(ReplaceRouteTableAssociationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplaceRouteTableAssociationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::replace_route_table_association::ReplaceRouteTableAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_replace_route_table_association_input::ser_replace_route_table_association_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReplaceRouteTableAssociationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplaceRouteTableAssociationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReplaceRouteTableAssociationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReplaceRouteTableAssociationInput>()
                        .ok_or("failed to downcast to ReplaceRouteTableAssociationInput")?;
...
/// Error type for the `ReplaceRouteTableAssociationError` operation.
#[non_exhaustive]
...
pub enum ReplaceRouteTableAssociationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReplaceRouteTableAssociationError) for what information is available for the error.")]
...
impl ReplaceRouteTableAssociationError {
    /// Creates the `ReplaceRouteTableAssociationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceRouteTableAssociationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReplaceRouteTableAssociationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReplaceRouteTableAssociationError {
...
mod _replace_route_table_association_output;
