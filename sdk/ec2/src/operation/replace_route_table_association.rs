    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceRouteTableAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReplaceRouteTableAssociation", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceRouteTableAssociation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReplaceRouteTableAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReplaceRouteTableAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_route_table_association::ReplaceRouteTableAssociationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replace_route_table_association_input::ser_replace_route_table_association_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReplaceRouteTableAssociationEndpointParamsInterceptor {
...
pub type ReplaceRouteTableAssociationErrorKind = ReplaceRouteTableAssociationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReplaceRouteTableAssociationError {
...
impl ReplaceRouteTableAssociationError {
    ...
    /// Creates the `ReplaceRouteTableAssociationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
