...
impl GetHostReservationPurchasePreviewInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_host_reservation_purchase_preview::GetHostReservationPurchasePreview::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHostReservationPurchasePreview {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_host_reservation_purchase_preview::de_get_host_reservation_purchase_preview_http_response_with_props(
                status, headers, body,
            )
        }
    }
