...
impl ModifyReservedInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_reserved_instances::ModifyReservedInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_reserved_instances::ModifyReservedInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_reserved_instances::ModifyReservedInstancesOutput, crate::operation::modify_reserved_instances::ModifyReservedInstancesError, Self> {
