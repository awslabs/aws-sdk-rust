...
impl DeleteNetworkInsightsPathInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_network_insights_path::DeleteNetworkInsightsPath::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNetworkInsightsPath {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_network_insights_path::de_delete_network_insights_path_http_response_with_props(status, headers, body)
        }
    }
}
