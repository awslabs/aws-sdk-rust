    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteNetworkInsightsPath {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteNetworkInsightsPath", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteNetworkInsightsPath")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteNetworkInsightsPathResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteNetworkInsightsPathRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_network_insights_path_input::ser_delete_network_insights_path_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteNetworkInsightsPathEndpointParamsInterceptor {
...
pub type DeleteNetworkInsightsPathErrorKind = DeleteNetworkInsightsPathError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteNetworkInsightsPathError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError {
...
impl DeleteNetworkInsightsPathError {
    ...
    /// Creates the `DeleteNetworkInsightsPathError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
