...
/// Orchestration and serialization glue logic for `DeleteNetworkInsightsPath`.
...
impl DeleteNetworkInsightsPath {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathInput,
                    ) -> ::std::result::Result<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteNetworkInsightsPath {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteNetworkInsightsPath");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteNetworkInsightsPathRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteNetworkInsightsPathResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteNetworkInsightsPath")
...
.with_interceptor(DeleteNetworkInsightsPathEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathError>::new());
...
#[derive(Debug)]
            struct DeleteNetworkInsightsPathResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteNetworkInsightsPathResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_network_insights_path::de_delete_network_insights_path_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_network_insights_path::de_delete_network_insights_path_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteNetworkInsightsPathRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_network_insights_path_input::ser_delete_network_insights_path_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteNetworkInsightsPathEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteNetworkInsightsPathEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteNetworkInsightsPathEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteNetworkInsightsPathInput>()
                        .ok_or("failed to downcast to DeleteNetworkInsightsPathInput")?;
...
/// Error type for the `DeleteNetworkInsightsPathError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteNetworkInsightsPathError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteNetworkInsightsPathError) for what information is available for the error.")]
...
impl DeleteNetworkInsightsPathError {
    /// Creates the `DeleteNetworkInsightsPathError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteNetworkInsightsPathError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteNetworkInsightsPathError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteNetworkInsightsPathError {
