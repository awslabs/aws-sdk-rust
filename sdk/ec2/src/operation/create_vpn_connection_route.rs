    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_vpn_connection_route::CreateVpnConnectionRouteError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_vpn_connection_route::CreateVpnConnectionRouteOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateVpnConnectionRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateVpnConnectionRoute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateVpnConnectionRoute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateVpnConnectionRouteResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateVpnConnectionRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_vpn_connection_route::CreateVpnConnectionRouteInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpn_connection_route_input::ser_create_vpn_connection_route_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateVpnConnectionRouteEndpointParamsInterceptor {
...
pub type CreateVpnConnectionRouteErrorKind = CreateVpnConnectionRouteError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateVpnConnectionRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_vpn_connection_route::CreateVpnConnectionRouteError {
...
impl CreateVpnConnectionRouteError {
    ...
    /// Creates the `CreateVpnConnectionRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
