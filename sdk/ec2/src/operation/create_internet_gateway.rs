...
impl CreateInternetGateway {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_internet_gateway::CreateInternetGatewayError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_internet_gateway::CreateInternetGatewayOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateInternetGateway", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateInternetGateway {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateInternetGateway", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateInternetGateway")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateInternetGatewayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateInternetGatewayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_internet_gateway::CreateInternetGatewayInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_internet_gateway_input::ser_create_internet_gateway_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateInternetGatewayEndpointParamsInterceptor {
...
pub type CreateInternetGatewayErrorKind = CreateInternetGatewayError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateInternetGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_internet_gateway::CreateInternetGatewayError {
...
impl CreateInternetGatewayError {
    ...
    /// Creates the `CreateInternetGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
