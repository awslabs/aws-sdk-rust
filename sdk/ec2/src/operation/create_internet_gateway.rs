...
impl CreateInternetGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_internet_gateway::CreateInternetGateway,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInternetGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_internet_gateway::de_create_internet_gateway_http_response_with_props(status, headers, body)
        }
    }
}
