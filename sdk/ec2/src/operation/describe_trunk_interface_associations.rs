...
impl DescribeTrunkInterfaceAssociationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_trunk_interface_associations::DescribeTrunkInterfaceAssociations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_trunk_interface_associations::DescribeTrunkInterfaceAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrunkInterfaceAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_trunk_interface_associations::de_describe_trunk_interface_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
