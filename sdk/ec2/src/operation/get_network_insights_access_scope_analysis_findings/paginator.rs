...
impl GetNetworkInsightsAccessScopeAnalysisFindingsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_network_insights_access_scope_analysis_findings::paginator::GetNetworkInsightsAccessScopeAnalysisFindingsPaginatorItems
    {
        crate::operation::get_network_insights_access_scope_analysis_findings::paginator::GetNetworkInsightsAccessScopeAnalysisFindingsPaginatorItems(
            self,
        )
                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_get_network_insights_access_scope_analysis_findings_output_output_next_token(resp);
...
impl GetNetworkInsightsAccessScopeAnalysisFindingsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_network_insights_access_scope_analysis_findings_output_output_analysis_findings(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
