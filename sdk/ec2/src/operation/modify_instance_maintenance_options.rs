...
impl ModifyInstanceMaintenanceOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_instance_maintenance_options::ModifyInstanceMaintenanceOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyInstanceMaintenanceOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_instance_maintenance_options::de_modify_instance_maintenance_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
