...
impl ModifyAvailabilityZoneGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_availability_zone_group::ModifyAvailabilityZoneGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyAvailabilityZoneGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_availability_zone_group::de_modify_availability_zone_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
