...
impl ModifyTrafficMirrorFilterRuleInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::modify_traffic_mirror_filter_rule::ModifyTrafficMirrorFilterRuleInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
