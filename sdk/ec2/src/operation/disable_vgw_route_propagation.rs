...
/// Orchestration and serialization glue logic for `DisableVgwRoutePropagation`.
...
impl DisableVgwRoutePropagation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableVgwRoutePropagation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableVgwRoutePropagation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableVgwRoutePropagationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableVgwRoutePropagationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableVgwRoutePropagation")
...
.with_interceptor(DisableVgwRoutePropagationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError>::new());
...
#[derive(Debug)]
            struct DisableVgwRoutePropagationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableVgwRoutePropagationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_vgw_route_propagation::de_disable_vgw_route_propagation_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disable_vgw_route_propagation::de_disable_vgw_route_propagation_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableVgwRoutePropagationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disable_vgw_route_propagation_input::ser_disable_vgw_route_propagation_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DisableVgwRoutePropagationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableVgwRoutePropagationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableVgwRoutePropagationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableVgwRoutePropagationInput>()
                        .ok_or("failed to downcast to DisableVgwRoutePropagationInput")?;
...
pub enum DisableVgwRoutePropagationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableVgwRoutePropagationError) for what information is available for the error.")]
...
impl DisableVgwRoutePropagationError {
    /// Creates the `DisableVgwRoutePropagationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableVgwRoutePropagationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableVgwRoutePropagationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationError {
