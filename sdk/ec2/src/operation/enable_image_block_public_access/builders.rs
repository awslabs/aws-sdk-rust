...
impl EnableImageBlockPublicAccessFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessOutput, crate::operation::enable_image_block_public_access::EnableImageBlockPublicAccessError, Self> {
