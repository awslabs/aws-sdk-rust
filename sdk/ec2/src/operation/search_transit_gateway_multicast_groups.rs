...
impl SearchTransitGatewayMulticastGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::search_transit_gateway_multicast_groups::SearchTransitGatewayMulticastGroups,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_transit_gateway_multicast_groups::SearchTransitGatewayMulticastGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchTransitGatewayMulticastGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_transit_gateway_multicast_groups::de_search_transit_gateway_multicast_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
