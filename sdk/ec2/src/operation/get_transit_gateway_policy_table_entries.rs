...
/// Orchestration and serialization glue logic for `GetTransitGatewayPolicyTableEntries`.
...
impl GetTransitGatewayPolicyTableEntries {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTransitGatewayPolicyTableEntries {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTransitGatewayPolicyTableEntries");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetTransitGatewayPolicyTableEntriesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetTransitGatewayPolicyTableEntriesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTransitGatewayPolicyTableEntries")
...
.with_interceptor(GetTransitGatewayPolicyTableEntriesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesError>::new());
...
#[derive(Debug)]
            struct GetTransitGatewayPolicyTableEntriesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTransitGatewayPolicyTableEntriesResponseDeserializer {
...
#[derive(Debug)]
            struct GetTransitGatewayPolicyTableEntriesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTransitGatewayPolicyTableEntriesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTransitGatewayPolicyTableEntriesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetTransitGatewayPolicyTableEntriesInput>()
                        .ok_or("failed to downcast to GetTransitGatewayPolicyTableEntriesInput")?;
...
pub enum GetTransitGatewayPolicyTableEntriesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTransitGatewayPolicyTableEntriesError) for what information is available for the error.")]
...
impl GetTransitGatewayPolicyTableEntriesError {
    /// Creates the `GetTransitGatewayPolicyTableEntriesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetTransitGatewayPolicyTableEntriesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTransitGatewayPolicyTableEntriesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTransitGatewayPolicyTableEntriesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_transit_gateway_policy_table_entries::GetTransitGatewayPolicyTableEntriesError {
...
mod _get_transit_gateway_policy_table_entries_output;
