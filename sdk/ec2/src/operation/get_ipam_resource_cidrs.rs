...
impl GetIpamResourceCidrs {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_resource_cidrs::GetIpamResourceCidrsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_resource_cidrs::GetIpamResourceCidrsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetIpamResourceCidrs", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIpamResourceCidrs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetIpamResourceCidrs", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIpamResourceCidrs")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetIpamResourceCidrsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetIpamResourceCidrsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ipam_resource_cidrs::GetIpamResourceCidrsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ipam_resource_cidrs_input::ser_get_ipam_resource_cidrs_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetIpamResourceCidrsEndpointParamsInterceptor {
...
pub type GetIpamResourceCidrsErrorKind = GetIpamResourceCidrsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetIpamResourceCidrsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ipam_resource_cidrs::GetIpamResourceCidrsError {
...
impl GetIpamResourceCidrsError {
    ...
    /// Creates the `GetIpamResourceCidrsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
