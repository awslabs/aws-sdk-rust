...
impl ModifyPrivateDnsNameOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_private_dns_name_options::ModifyPrivateDnsNameOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyPrivateDnsNameOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_private_dns_name_options::de_modify_private_dns_name_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
