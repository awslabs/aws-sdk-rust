...
impl CopyFpgaImageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::copy_fpga_image::CopyFpgaImage, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyFpgaImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_fpga_image::de_copy_fpga_image_http_response_with_props(status, headers, body)
        }
    }
}
