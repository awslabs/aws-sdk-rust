...
impl DisassociateEnclaveCertificateIamRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_enclave_certificate_iam_role::DisassociateEnclaveCertificateIamRoleInput, ::aws_smithy_types::error::operation::BuildError> {
