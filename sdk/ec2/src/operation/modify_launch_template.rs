...
/// Orchestration and serialization glue logic for `ModifyLaunchTemplate`.
...
impl ModifyLaunchTemplate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_launch_template::ModifyLaunchTemplateInput,
                    ) -> ::std::result::Result<crate::operation::modify_launch_template::ModifyLaunchTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_launch_template::ModifyLaunchTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_launch_template::ModifyLaunchTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_launch_template::ModifyLaunchTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyLaunchTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyLaunchTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyLaunchTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyLaunchTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyLaunchTemplate")
...
.with_interceptor(ModifyLaunchTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_launch_template::ModifyLaunchTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_launch_template::ModifyLaunchTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_launch_template::ModifyLaunchTemplateError>::new());
...
#[derive(Debug)]
            struct ModifyLaunchTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyLaunchTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_launch_template::de_modify_launch_template_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyLaunchTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_launch_template::ModifyLaunchTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_launch_template::ModifyLaunchTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_launch_template_input::ser_modify_launch_template_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyLaunchTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyLaunchTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyLaunchTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyLaunchTemplateInput>()
                        .ok_or("failed to downcast to ModifyLaunchTemplateInput")?;
...
/// Error type for the `ModifyLaunchTemplateError` operation.
#[non_exhaustive]
...
pub enum ModifyLaunchTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyLaunchTemplateError) for what information is available for the error.")]
...
impl ModifyLaunchTemplateError {
    /// Creates the `ModifyLaunchTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyLaunchTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyLaunchTemplateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyLaunchTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_launch_template::ModifyLaunchTemplateError {
...
mod _modify_launch_template_output;
