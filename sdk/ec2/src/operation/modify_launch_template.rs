...
impl ModifyLaunchTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_launch_template::ModifyLaunchTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyLaunchTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_launch_template::de_modify_launch_template_http_response_with_props(status, headers, body)
        }
    }
}
