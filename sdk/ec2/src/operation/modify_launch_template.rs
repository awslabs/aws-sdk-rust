    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_launch_template::ModifyLaunchTemplateError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_launch_template::ModifyLaunchTemplateOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyLaunchTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyLaunchTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_launch_template::ModifyLaunchTemplateInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_launch_template_input::ser_modify_launch_template_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyLaunchTemplateEndpointParamsInterceptor {
...
pub type ModifyLaunchTemplateErrorKind = ModifyLaunchTemplateError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyLaunchTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_launch_template::ModifyLaunchTemplateError {
...
impl ModifyLaunchTemplateError {
    ...
    /// Creates the `ModifyLaunchTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
