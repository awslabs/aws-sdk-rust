...
impl crate::operation::delete_transit_gateway_connect::builders::DeleteTransitGatewayConnectInputBuilder {
...
impl DeleteTransitGatewayConnectFluentBuilder {
    /// Creates a new `DeleteTransitGatewayConnectFluentBuilder`.
