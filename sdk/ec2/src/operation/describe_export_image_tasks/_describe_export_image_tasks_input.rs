...
impl DescribeExportImageTasksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_export_image_tasks::DescribeExportImageTasksInput, ::aws_smithy_types::error::operation::BuildError> {
