    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_transit_gateway_route::DeleteTransitGatewayRouteError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_transit_gateway_route::DeleteTransitGatewayRouteOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTransitGatewayRoute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteTransitGatewayRoute", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTransitGatewayRoute")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteTransitGatewayRouteResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteTransitGatewayRouteRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_transit_gateway_route::DeleteTransitGatewayRouteInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_transit_gateway_route_input::ser_delete_transit_gateway_route_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteTransitGatewayRouteEndpointParamsInterceptor {
...
pub type DeleteTransitGatewayRouteErrorKind = DeleteTransitGatewayRouteError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteTransitGatewayRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_transit_gateway_route::DeleteTransitGatewayRouteError {
...
impl DeleteTransitGatewayRouteError {
    ...
    /// Creates the `DeleteTransitGatewayRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
