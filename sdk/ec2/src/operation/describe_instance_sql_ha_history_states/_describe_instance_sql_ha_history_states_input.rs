...
pub struct DescribeInstanceSqlHaHistoryStatesInput {
...
impl DescribeInstanceSqlHaHistoryStatesInput {
    /// <p>The IDs of the SQL Server High Availability instances to describe. If omitted, the API returns historical states for all SQL Server High Availability instances.</p>
    ///
...
impl DescribeInstanceSqlHaHistoryStatesInput {
    /// Creates a new builder-style object to manufacture [`DescribeInstanceSqlHaHistoryStatesInput`](crate::operation::describe_instance_sql_ha_history_states::DescribeInstanceSqlHaHistoryStatesInput).
    pub fn builder() -> crate::operation::describe_instance_sql_ha_history_states::builders::DescribeInstanceSqlHaHistoryStatesInputBuilder {
        crate::operation::describe_instance_sql_ha_history_states::builders::DescribeInstanceSqlHaHistoryStatesInputBuilder::default()
    }
}

/// A builder for [`DescribeInstanceSqlHaHistoryStatesInput`](crate::operation::describe_instance_sql_ha_history_states::DescribeInstanceSqlHaHistoryStatesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeInstanceSqlHaHistoryStatesInputBuilder {
...
impl DescribeInstanceSqlHaHistoryStatesInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeInstanceSqlHaHistoryStatesInput`](crate::operation::describe_instance_sql_ha_history_states::DescribeInstanceSqlHaHistoryStatesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_instance_sql_ha_history_states::DescribeInstanceSqlHaHistoryStatesInput,
