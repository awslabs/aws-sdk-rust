...
impl crate::operation::get_verified_access_endpoint_policy::builders::GetVerifiedAccessEndpointPolicyInputBuilder {
...
impl GetVerifiedAccessEndpointPolicyFluentBuilder {
    /// Creates a new `GetVerifiedAccessEndpointPolicyFluentBuilder`.
