    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_volume_attribute::ModifyVolumeAttributeError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_volume_attribute::ModifyVolumeAttributeOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyVolumeAttributeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyVolumeAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_volume_attribute::ModifyVolumeAttributeInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_volume_attribute_input::ser_modify_volume_attribute_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyVolumeAttributeEndpointParamsInterceptor {
...
pub type ModifyVolumeAttributeErrorKind = ModifyVolumeAttributeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyVolumeAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_volume_attribute::ModifyVolumeAttributeError {
...
impl ModifyVolumeAttributeError {
    ...
    /// Creates the `ModifyVolumeAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
