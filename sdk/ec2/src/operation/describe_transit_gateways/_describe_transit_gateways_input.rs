...
impl DescribeTransitGatewaysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_transit_gateways::DescribeTransitGatewaysInput, ::aws_smithy_types::error::operation::BuildError> {
