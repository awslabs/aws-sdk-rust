...
impl DeleteTransitGatewayConnectPeer {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_transit_gateway_connect_peer::DeleteTransitGatewayConnectPeerOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteTransitGatewayConnectPeerResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteTransitGatewayConnectPeerRequestSerializer {
