...
impl DeleteTransitGatewayConnectPeerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_transit_gateway_connect_peer::DeleteTransitGatewayConnectPeer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTransitGatewayConnectPeer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_transit_gateway_connect_peer::de_delete_transit_gateway_connect_peer_http_response_with_props(
                status, headers, body,
            )
        }
    }
