...
impl RestoreSnapshotFromRecycleBinFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinOutput, crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinError, Self> {
