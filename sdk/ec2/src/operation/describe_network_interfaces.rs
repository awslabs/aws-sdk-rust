    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_network_interfaces::DescribeNetworkInterfacesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_network_interfaces::DescribeNetworkInterfacesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeNetworkInterfaces {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeNetworkInterfaces", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeNetworkInterfaces")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeNetworkInterfacesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeNetworkInterfacesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_network_interfaces::DescribeNetworkInterfacesInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_network_interfaces_input::ser_describe_network_interfaces_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeNetworkInterfacesEndpointParamsInterceptor {
...
pub type DescribeNetworkInterfacesErrorKind = DescribeNetworkInterfacesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeNetworkInterfacesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_network_interfaces::DescribeNetworkInterfacesError {
...
impl DescribeNetworkInterfacesError {
    ...
    /// Creates the `DescribeNetworkInterfacesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
