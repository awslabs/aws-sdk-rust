...
impl GetConsoleScreenshot {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_console_screenshot::GetConsoleScreenshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_console_screenshot::GetConsoleScreenshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_console_screenshot::GetConsoleScreenshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_console_screenshot::GetConsoleScreenshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetConsoleScreenshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetConsoleScreenshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetConsoleScreenshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetConsoleScreenshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetConsoleScreenshot")
...
.with_interceptor(GetConsoleScreenshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_console_screenshot::GetConsoleScreenshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_console_screenshot::GetConsoleScreenshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_console_screenshot::GetConsoleScreenshotError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetConsoleScreenshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_console_screenshot::GetConsoleScreenshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_console_screenshot::GetConsoleScreenshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_console_screenshot_input::ser_get_console_screenshot_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetConsoleScreenshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetConsoleScreenshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetConsoleScreenshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetConsoleScreenshotInput>()
                        .ok_or("failed to downcast to GetConsoleScreenshotInput")?;
...
/// Error type for the `GetConsoleScreenshotError` operation.
#[non_exhaustive]
...
pub enum GetConsoleScreenshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetConsoleScreenshotError) for what information is available for the error.")]
...
impl GetConsoleScreenshotError {
    /// Creates the `GetConsoleScreenshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetConsoleScreenshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetConsoleScreenshotError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetConsoleScreenshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_console_screenshot::GetConsoleScreenshotError {
...
mod _get_console_screenshot_output;
