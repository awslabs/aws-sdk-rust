...
impl GetConsoleScreenshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_console_screenshot::GetConsoleScreenshotError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_console_screenshot::GetConsoleScreenshotOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetConsoleScreenshot", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetConsoleScreenshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetConsoleScreenshot", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetConsoleScreenshot")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetConsoleScreenshotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetConsoleScreenshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_console_screenshot::GetConsoleScreenshotInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_console_screenshot_input::ser_get_console_screenshot_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetConsoleScreenshotEndpointParamsInterceptor {
...
pub type GetConsoleScreenshotErrorKind = GetConsoleScreenshotError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetConsoleScreenshotError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_console_screenshot::GetConsoleScreenshotError {
...
impl GetConsoleScreenshotError {
    ...
    /// Creates the `GetConsoleScreenshotError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
