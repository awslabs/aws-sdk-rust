...
impl ModifyIpamResourceCidrFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrOutput, crate::operation::modify_ipam_resource_cidr::ModifyIpamResourceCidrError, Self> {
