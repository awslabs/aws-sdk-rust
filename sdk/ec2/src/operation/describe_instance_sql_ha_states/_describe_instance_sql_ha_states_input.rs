...
pub struct DescribeInstanceSqlHaStatesInput {
...
impl DescribeInstanceSqlHaStatesInput {
    /// <p>The IDs of the SQL Server High Availability instances to describe. If omitted, the API returns SQL Server High Availability states for all SQL Server High Availability instances.</p>
    ///
...
impl DescribeInstanceSqlHaStatesInput {
    /// Creates a new builder-style object to manufacture [`DescribeInstanceSqlHaStatesInput`](crate::operation::describe_instance_sql_ha_states::DescribeInstanceSqlHaStatesInput).
    pub fn builder() -> crate::operation::describe_instance_sql_ha_states::builders::DescribeInstanceSqlHaStatesInputBuilder {
        crate::operation::describe_instance_sql_ha_states::builders::DescribeInstanceSqlHaStatesInputBuilder::default()
    }
}

/// A builder for [`DescribeInstanceSqlHaStatesInput`](crate::operation::describe_instance_sql_ha_states::DescribeInstanceSqlHaStatesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeInstanceSqlHaStatesInputBuilder {
...
impl DescribeInstanceSqlHaStatesInputBuilder {
    ...
    /// Consumes the builder and constructs a [`DescribeInstanceSqlHaStatesInput`](crate::operation::describe_instance_sql_ha_states::DescribeInstanceSqlHaStatesInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::describe_instance_sql_ha_states::DescribeInstanceSqlHaStatesInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::describe_instance_sql_ha_states::DescribeInstanceSqlHaStatesInput {
