    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateVpcEndpointServiceConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateVpcEndpointServiceConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateVpcEndpointServiceConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateVpcEndpointServiceConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateVpcEndpointServiceConfiguration")
...
.with_interceptor(CreateVpcEndpointServiceConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_vpc_endpoint_service_configuration::de_create_vpc_endpoint_service_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_vpc_endpoint_service_configuration::de_create_vpc_endpoint_service_configuration_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateVpcEndpointServiceConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_vpc_endpoint_service_configuration::CreateVpcEndpointServiceConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_vpc_endpoint_service_configuration_input::ser_create_vpc_endpoint_service_configuration_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateVpcEndpointServiceConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateVpcEndpointServiceConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateVpcEndpointServiceConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateVpcEndpointServiceConfigurationInput>()
                        .ok_or("failed to downcast to CreateVpcEndpointServiceConfigurationInput")?;
...
/// Error type for the `CreateVpcEndpointServiceConfigurationError` operation.
#[non_exhaustive]
...
pub enum CreateVpcEndpointServiceConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateVpcEndpointServiceConfigurationError) for what information is available for the error.")]
...
impl CreateVpcEndpointServiceConfigurationError {
    /// Creates the `CreateVpcEndpointServiceConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVpcEndpointServiceConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateVpcEndpointServiceConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateVpcEndpointServiceConfigurationError {
