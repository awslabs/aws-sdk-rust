...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetTransitGatewayRouteTablePropagationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetTransitGatewayRouteTablePropagationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_transit_gateway_route_table_propagations_input::ser_get_transit_gateway_route_table_propagations_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetTransitGatewayRouteTablePropagationsEndpointParamsInterceptor {
