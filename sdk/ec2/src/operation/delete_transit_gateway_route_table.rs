...
impl DeleteTransitGatewayRouteTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_transit_gateway_route_table::DeleteTransitGatewayRouteTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTransitGatewayRouteTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_transit_gateway_route_table::de_delete_transit_gateway_route_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
