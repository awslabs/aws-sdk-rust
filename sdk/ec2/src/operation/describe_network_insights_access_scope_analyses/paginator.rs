...
impl DescribeNetworkInsightsAccessScopeAnalysesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_network_insights_access_scope_analyses::paginator::DescribeNetworkInsightsAccessScopeAnalysesPaginatorItems {
...
impl DescribeNetworkInsightsAccessScopeAnalysesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_network_insights_access_scope_analyses_output_output_network_insights_access_scope_analyses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
