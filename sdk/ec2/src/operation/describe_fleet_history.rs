...
impl DescribeFleetHistoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_fleet_history::DescribeFleetHistory,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_history::de_describe_fleet_history_http_response_with_props(status, headers, body)
        }
    }
}
