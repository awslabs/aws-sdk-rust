...
impl DescribeLocalGateways {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_local_gateways::DescribeLocalGatewaysError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_local_gateways::DescribeLocalGatewaysOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "DescribeLocalGateways", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeLocalGateways {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeLocalGateways", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeLocalGateways")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeLocalGatewaysResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeLocalGatewaysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_local_gateways::DescribeLocalGatewaysInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_local_gateways_input::ser_describe_local_gateways_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeLocalGatewaysEndpointParamsInterceptor {
...
pub type DescribeLocalGatewaysErrorKind = DescribeLocalGatewaysError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeLocalGatewaysError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_local_gateways::DescribeLocalGatewaysError {
...
impl DescribeLocalGatewaysError {
    ...
    /// Creates the `DescribeLocalGatewaysError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
