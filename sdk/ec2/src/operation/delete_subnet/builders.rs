...
impl DeleteSubnetFluentBuilder  {
    /// Creates a new `DeleteSubnet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_subnet::DeleteSubnetOutput, aws_smithy_http::result::SdkError<crate::operation::delete_subnet::DeleteSubnetError>>
                     {
