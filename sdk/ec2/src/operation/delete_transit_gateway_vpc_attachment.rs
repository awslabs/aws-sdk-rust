...
/// Orchestration and serialization glue logic for `DeleteTransitGatewayVpcAttachment`.
...
impl DeleteTransitGatewayVpcAttachment {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentInput,
                    ) -> ::std::result::Result<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTransitGatewayVpcAttachment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteTransitGatewayVpcAttachment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteTransitGatewayVpcAttachmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteTransitGatewayVpcAttachmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTransitGatewayVpcAttachment")
...
.with_interceptor(DeleteTransitGatewayVpcAttachmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentError>::new());
...
#[derive(Debug)]
            struct DeleteTransitGatewayVpcAttachmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTransitGatewayVpcAttachmentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_transit_gateway_vpc_attachment::de_delete_transit_gateway_vpc_attachment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_transit_gateway_vpc_attachment::de_delete_transit_gateway_vpc_attachment_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTransitGatewayVpcAttachmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_transit_gateway_vpc_attachment_input::ser_delete_transit_gateway_vpc_attachment_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteTransitGatewayVpcAttachmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTransitGatewayVpcAttachmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteTransitGatewayVpcAttachmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteTransitGatewayVpcAttachmentInput>()
                        .ok_or("failed to downcast to DeleteTransitGatewayVpcAttachmentInput")?;
...
/// Error type for the `DeleteTransitGatewayVpcAttachmentError` operation.
#[non_exhaustive]
...
pub enum DeleteTransitGatewayVpcAttachmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteTransitGatewayVpcAttachmentError) for what information is available for the error.")]
...
impl DeleteTransitGatewayVpcAttachmentError {
    /// Creates the `DeleteTransitGatewayVpcAttachmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteTransitGatewayVpcAttachmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteTransitGatewayVpcAttachmentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteTransitGatewayVpcAttachmentError {
