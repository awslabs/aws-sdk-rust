...
impl DeleteTransitGatewayVpcAttachmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachment,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_transit_gateway_vpc_attachment::DeleteTransitGatewayVpcAttachment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTransitGatewayVpcAttachment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_transit_gateway_vpc_attachment::de_delete_transit_gateway_vpc_attachment_http_response_with_props(
                status, headers, body,
            )
        }
    }
