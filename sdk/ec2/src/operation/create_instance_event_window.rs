...
impl CreateInstanceEventWindow {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_instance_event_window::CreateInstanceEventWindowError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_instance_event_window::CreateInstanceEventWindowOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "CreateInstanceEventWindow", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateInstanceEventWindow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            CreateInstanceEventWindowRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            CreateInstanceEventWindowResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateInstanceEventWindow", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateInstanceEventWindow")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateInstanceEventWindowResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateInstanceEventWindowRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_instance_event_window::CreateInstanceEventWindowInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_instance_event_window_input::ser_create_instance_event_window_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateInstanceEventWindowEndpointParamsInterceptor {
...
pub type CreateInstanceEventWindowErrorKind = CreateInstanceEventWindowError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateInstanceEventWindowError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_instance_event_window::CreateInstanceEventWindowError {
...
impl CreateInstanceEventWindowError {
    ...
    /// Creates the `CreateInstanceEventWindowError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
