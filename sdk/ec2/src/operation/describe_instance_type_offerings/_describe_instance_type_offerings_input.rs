...
impl DescribeInstanceTypeOfferingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_instance_type_offerings::DescribeInstanceTypeOfferingsInput, ::aws_smithy_types::error::operation::BuildError> {
