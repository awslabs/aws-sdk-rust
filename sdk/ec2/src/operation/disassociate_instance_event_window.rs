...
impl DisassociateInstanceEventWindowInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_instance_event_window::DisassociateInstanceEventWindow::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateInstanceEventWindow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_instance_event_window::de_disassociate_instance_event_window_http_response_with_props(
                status, headers, body,
            )
        }
    }
