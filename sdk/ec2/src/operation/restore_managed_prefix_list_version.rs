...
impl RestoreManagedPrefixListVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_managed_prefix_list_version::RestoreManagedPrefixListVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreManagedPrefixListVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_managed_prefix_list_version::de_restore_managed_prefix_list_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
