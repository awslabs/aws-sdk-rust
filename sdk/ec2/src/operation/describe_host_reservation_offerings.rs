...
impl DescribeHostReservationOfferingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_host_reservation_offerings::DescribeHostReservationOfferings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHostReservationOfferings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_host_reservation_offerings::de_describe_host_reservation_offerings_http_response_with_props(
                status, headers, body,
            )
        }
    }
