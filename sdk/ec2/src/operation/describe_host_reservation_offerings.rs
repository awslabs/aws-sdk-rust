...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeHostReservationOfferings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeHostReservationOfferings", "ec2"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeHostReservationOfferings")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeHostReservationOfferingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeHostReservationOfferingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_host_reservation_offerings_input::ser_describe_host_reservation_offerings_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeHostReservationOfferingsEndpointParamsInterceptor {
...
pub type DescribeHostReservationOfferingsErrorKind = DescribeHostReservationOfferingsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeHostReservationOfferingsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_host_reservation_offerings::DescribeHostReservationOfferingsError {
...
impl DescribeHostReservationOfferingsError {
    ...
    /// Creates the `DescribeHostReservationOfferingsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
