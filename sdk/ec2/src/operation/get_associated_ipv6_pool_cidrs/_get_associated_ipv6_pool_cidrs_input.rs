...
impl GetAssociatedIpv6PoolCidrsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_associated_ipv6_pool_cidrs::GetAssociatedIpv6PoolCidrsInput, ::aws_smithy_types::error::operation::BuildError> {
