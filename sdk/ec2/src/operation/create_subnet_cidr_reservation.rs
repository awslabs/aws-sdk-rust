...
/// Orchestration and serialization glue logic for `CreateSubnetCidrReservation`.
...
impl CreateSubnetCidrReservation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSubnetCidrReservation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateSubnetCidrReservation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateSubnetCidrReservationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateSubnetCidrReservationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSubnetCidrReservation")
...
.with_interceptor(CreateSubnetCidrReservationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError>::new());
...
#[derive(Debug)]
            struct CreateSubnetCidrReservationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSubnetCidrReservationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_subnet_cidr_reservation::de_create_subnet_cidr_reservation_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_subnet_cidr_reservation::de_create_subnet_cidr_reservation_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateSubnetCidrReservationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSubnetCidrReservationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_subnet_cidr_reservation_input::ser_create_subnet_cidr_reservation_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateSubnetCidrReservationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateSubnetCidrReservationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateSubnetCidrReservationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateSubnetCidrReservationInput>()
                        .ok_or("failed to downcast to CreateSubnetCidrReservationInput")?;
...
/// Error type for the `CreateSubnetCidrReservationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateSubnetCidrReservationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateSubnetCidrReservationError) for what information is available for the error.")]
...
impl CreateSubnetCidrReservationError {
    /// Creates the `CreateSubnetCidrReservationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateSubnetCidrReservationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateSubnetCidrReservationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateSubnetCidrReservationError {
