...
impl CreateSubnetCidrReservationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSubnetCidrReservation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_subnet_cidr_reservation::de_create_subnet_cidr_reservation_http_response_with_props(
                status, headers, body,
            )
        }
    }
