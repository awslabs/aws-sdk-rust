    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSubnetCidrReservation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateSubnetCidrReservation", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSubnetCidrReservation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateSubnetCidrReservationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateSubnetCidrReservationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_subnet_cidr_reservation_input::ser_create_subnet_cidr_reservation_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateSubnetCidrReservationEndpointParamsInterceptor {
...
pub type CreateSubnetCidrReservationErrorKind = CreateSubnetCidrReservationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateSubnetCidrReservationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationError {
...
impl CreateSubnetCidrReservationError {
    ...
    /// Creates the `CreateSubnetCidrReservationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
