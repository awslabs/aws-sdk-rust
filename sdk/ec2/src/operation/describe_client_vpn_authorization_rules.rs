...
impl DescribeClientVpnAuthorizationRulesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_client_vpn_authorization_rules::DescribeClientVpnAuthorizationRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClientVpnAuthorizationRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_client_vpn_authorization_rules::de_describe_client_vpn_authorization_rules_http_response_with_props(
                status, headers, body,
            )
        }
    }
