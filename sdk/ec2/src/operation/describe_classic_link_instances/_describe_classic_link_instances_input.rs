...
impl DescribeClassicLinkInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_classic_link_instances::DescribeClassicLinkInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
