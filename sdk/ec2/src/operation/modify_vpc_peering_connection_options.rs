...
impl ModifyVpcPeeringConnectionOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_vpc_peering_connection_options::ModifyVpcPeeringConnectionOptions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_vpc_peering_connection_options::ModifyVpcPeeringConnectionOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyVpcPeeringConnectionOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_vpc_peering_connection_options::de_modify_vpc_peering_connection_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
