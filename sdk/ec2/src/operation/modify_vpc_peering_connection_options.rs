...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyVpcPeeringConnectionOptions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ModifyVpcPeeringConnectionOptions", "ec2"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyVpcPeeringConnectionOptions")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ModifyVpcPeeringConnectionOptionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ModifyVpcPeeringConnectionOptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_vpc_peering_connection_options_input::ser_modify_vpc_peering_connection_options_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyVpcPeeringConnectionOptionsEndpointParamsInterceptor {
...
pub type ModifyVpcPeeringConnectionOptionsErrorKind = ModifyVpcPeeringConnectionOptionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_vpc_peering_connection_options::ModifyVpcPeeringConnectionOptionsError {
...
impl ModifyVpcPeeringConnectionOptionsError {
    ...
    /// Creates the `ModifyVpcPeeringConnectionOptionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
