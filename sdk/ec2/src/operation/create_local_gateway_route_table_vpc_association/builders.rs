...
impl CreateLocalGatewayRouteTableVpcAssociationFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::create_local_gateway_route_table_vpc_association::CreateLocalGatewayRouteTableVpcAssociationOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_local_gateway_route_table_vpc_association::CreateLocalGatewayRouteTableVpcAssociationError>>
                         {
        let op = self
            .inner
            .build()
