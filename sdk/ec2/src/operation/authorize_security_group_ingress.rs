...
impl AuthorizeSecurityGroupIngressInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeSecurityGroupIngress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_authorize_security_group_ingress::de_authorize_security_group_ingress_http_response_with_props(
                status, headers, body,
            )
        }
    }
