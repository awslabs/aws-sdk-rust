    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AuthorizeSecurityGroupIngress {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AuthorizeSecurityGroupIngress", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AuthorizeSecurityGroupIngress")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AuthorizeSecurityGroupIngressResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AuthorizeSecurityGroupIngressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_security_group_ingress_input::ser_authorize_security_group_ingress_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AuthorizeSecurityGroupIngressEndpointParamsInterceptor {
...
pub type AuthorizeSecurityGroupIngressErrorKind = AuthorizeSecurityGroupIngressError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AuthorizeSecurityGroupIngressError {
...
impl ::aws_http::request_id::RequestId for crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressError {
...
impl AuthorizeSecurityGroupIngressError {
    ...
    /// Creates the `AuthorizeSecurityGroupIngressError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
