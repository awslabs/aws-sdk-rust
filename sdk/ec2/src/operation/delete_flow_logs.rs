...
impl DeleteFlowLogsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_flow_logs_input::ser_delete_flow_logs_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_flow_logs::DeleteFlowLogs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFlowLogs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_flow_logs::de_delete_flow_logs_http_error(
                status, headers, body,
            )
        } else {
