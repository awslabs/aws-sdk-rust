...
impl ReportInstanceStatus {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::report_instance_status::ReportInstanceStatusError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::report_instance_status::ReportInstanceStatusOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ReportInstanceStatus", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReportInstanceStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReportInstanceStatus", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReportInstanceStatus")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReportInstanceStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReportInstanceStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::report_instance_status::ReportInstanceStatusInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_report_instance_status_input::ser_report_instance_status_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReportInstanceStatusEndpointParamsInterceptor {
...
pub type ReportInstanceStatusErrorKind = ReportInstanceStatusError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReportInstanceStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::report_instance_status::ReportInstanceStatusError {
...
impl ReportInstanceStatusError {
    ...
    /// Creates the `ReportInstanceStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
