...
impl DescribeHostsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_hosts::DescribeHosts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_hosts_input::ser_describe_hosts_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHosts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_hosts::de_describe_hosts_http_response_with_props(status, headers, body)
        }
    }
}
