    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_host_reservations::DescribeHostReservationsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_host_reservations::DescribeHostReservationsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeHostReservations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeHostReservations", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeHostReservations")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeHostReservationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeHostReservationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_host_reservations::DescribeHostReservationsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_host_reservations_input::ser_describe_host_reservations_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeHostReservationsEndpointParamsInterceptor {
...
pub type DescribeHostReservationsErrorKind = DescribeHostReservationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeHostReservationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_host_reservations::DescribeHostReservationsError {
...
impl DescribeHostReservationsError {
    ...
    /// Creates the `DescribeHostReservationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
