    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTrafficMirrorTarget {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateTrafficMirrorTarget", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTrafficMirrorTarget")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateTrafficMirrorTargetResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateTrafficMirrorTargetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_traffic_mirror_target_input::ser_create_traffic_mirror_target_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateTrafficMirrorTargetEndpointParamsInterceptor {
...
pub type CreateTrafficMirrorTargetErrorKind = CreateTrafficMirrorTargetError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateTrafficMirrorTargetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError {
...
impl CreateTrafficMirrorTargetError {
    ...
    /// Creates the `CreateTrafficMirrorTargetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
