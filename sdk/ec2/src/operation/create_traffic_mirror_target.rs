...
impl CreateTrafficMirrorTargetInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTarget::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrafficMirrorTarget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_traffic_mirror_target::de_create_traffic_mirror_target_http_response_with_props(status, headers, body)
        }
    }
}
