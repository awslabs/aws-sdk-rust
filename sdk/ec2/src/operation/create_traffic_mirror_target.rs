...
/// Orchestration and serialization glue logic for `CreateTrafficMirrorTarget`.
...
impl CreateTrafficMirrorTarget {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTrafficMirrorTarget {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateTrafficMirrorTarget");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateTrafficMirrorTargetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateTrafficMirrorTargetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTrafficMirrorTarget")
...
.with_interceptor(CreateTrafficMirrorTargetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetError>::new());
...
#[derive(Debug)]
            struct CreateTrafficMirrorTargetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTrafficMirrorTargetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_traffic_mirror_target::de_create_traffic_mirror_target_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_traffic_mirror_target::de_create_traffic_mirror_target_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTrafficMirrorTargetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_traffic_mirror_target::CreateTrafficMirrorTargetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_traffic_mirror_target_input::ser_create_traffic_mirror_target_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateTrafficMirrorTargetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTrafficMirrorTargetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateTrafficMirrorTargetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateTrafficMirrorTargetInput>()
                        .ok_or("failed to downcast to CreateTrafficMirrorTargetInput")?;
...
/// Error type for the `CreateTrafficMirrorTargetError` operation.
#[non_exhaustive]
...
pub enum CreateTrafficMirrorTargetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateTrafficMirrorTargetError) for what information is available for the error.")]
...
impl CreateTrafficMirrorTargetError {
    /// Creates the `CreateTrafficMirrorTargetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTrafficMirrorTargetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTrafficMirrorTargetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateTrafficMirrorTargetError {
