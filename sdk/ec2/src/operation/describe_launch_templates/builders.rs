...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_launch_templates::DescribeLaunchTemplatesOutput,
                    crate::operation::describe_launch_templates::DescribeLaunchTemplatesError,
                > for DescribeLaunchTemplatesFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeLaunchTemplatesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_launch_templates::DescribeLaunchTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_launch_templates::DescribeLaunchTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_launch_templates::DescribeLaunchTemplates::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_launch_templates::DescribeLaunchTemplates::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_launch_templates::DescribeLaunchTemplatesOutput, crate::operation::describe_launch_templates::DescribeLaunchTemplatesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_launch_templates::paginator::DescribeLaunchTemplatesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
