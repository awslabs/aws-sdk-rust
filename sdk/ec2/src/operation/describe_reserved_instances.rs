...
impl DescribeReservedInstancesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_reserved_instances::DescribeReservedInstances::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_instances::de_describe_reserved_instances_http_response_with_props(status, headers, body)
        }
    }
}
