...
impl DescribeSpotDatafeedSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpotDatafeedSubscription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_spot_datafeed_subscription::de_describe_spot_datafeed_subscription_http_response_with_props(
                status, headers, body,
            )
        }
    }
