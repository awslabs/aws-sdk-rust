...
impl GetEbsEncryptionByDefault {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetEbsEncryptionByDefault", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetEbsEncryptionByDefault {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            GetEbsEncryptionByDefaultRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            GetEbsEncryptionByDefaultResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetEbsEncryptionByDefault", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetEbsEncryptionByDefault")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetEbsEncryptionByDefaultResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetEbsEncryptionByDefaultRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ebs_encryption_by_default_input::ser_get_ebs_encryption_by_default_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetEbsEncryptionByDefaultEndpointParamsInterceptor {
...
pub type GetEbsEncryptionByDefaultErrorKind = GetEbsEncryptionByDefaultError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetEbsEncryptionByDefaultError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError {
...
impl GetEbsEncryptionByDefaultError {
    ...
    /// Creates the `GetEbsEncryptionByDefaultError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
