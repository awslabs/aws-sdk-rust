...
impl GetEbsEncryptionByDefaultInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefault::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEbsEncryptionByDefault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ebs_encryption_by_default::de_get_ebs_encryption_by_default_http_response_with_props(
                status, headers, body,
            )
        }
    }
