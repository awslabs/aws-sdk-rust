...
impl GetEbsEncryptionByDefault {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetEbsEncryptionByDefault {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetEbsEncryptionByDefault");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetEbsEncryptionByDefaultRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetEbsEncryptionByDefaultResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetEbsEncryptionByDefault")
...
.with_interceptor(GetEbsEncryptionByDefaultEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_ebs_encryption_by_default::de_get_ebs_encryption_by_default_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetEbsEncryptionByDefaultRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_ebs_encryption_by_default_input::ser_get_ebs_encryption_by_default_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetEbsEncryptionByDefaultEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetEbsEncryptionByDefaultEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetEbsEncryptionByDefaultEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetEbsEncryptionByDefaultInput>()
                        .ok_or("failed to downcast to GetEbsEncryptionByDefaultInput")?;
...
/// Error type for the `GetEbsEncryptionByDefaultError` operation.
#[non_exhaustive]
...
pub enum GetEbsEncryptionByDefaultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetEbsEncryptionByDefaultError) for what information is available for the error.")]
...
impl GetEbsEncryptionByDefaultError {
    /// Creates the `GetEbsEncryptionByDefaultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetEbsEncryptionByDefaultError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetEbsEncryptionByDefaultError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetEbsEncryptionByDefaultError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_ebs_encryption_by_default::GetEbsEncryptionByDefaultError {
...
mod _get_ebs_encryption_by_default_output;
