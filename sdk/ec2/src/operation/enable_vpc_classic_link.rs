...
impl EnableVpcClassicLink {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableVpcClassicLink {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableVpcClassicLink");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableVpcClassicLinkRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableVpcClassicLinkResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableVpcClassicLink")
...
.with_interceptor(EnableVpcClassicLinkEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableVpcClassicLinkRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_vpc_classic_link_input::ser_enable_vpc_classic_link_input_input_input(&input)?);
...
#[derive(Debug)]
            struct EnableVpcClassicLinkEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableVpcClassicLinkEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableVpcClassicLinkEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableVpcClassicLinkInput>()
                        .ok_or("failed to downcast to EnableVpcClassicLinkInput")?;
...
/// Error type for the `EnableVpcClassicLinkError` operation.
#[non_exhaustive]
...
pub enum EnableVpcClassicLinkError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableVpcClassicLinkError) for what information is available for the error.")]
...
impl EnableVpcClassicLinkError {
    /// Creates the `EnableVpcClassicLinkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableVpcClassicLinkError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableVpcClassicLinkError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableVpcClassicLinkError {
