...
impl EnableVpcClassicLink {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "EnableVpcClassicLink", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableVpcClassicLink {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("EnableVpcClassicLink", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableVpcClassicLink")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for EnableVpcClassicLinkResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for EnableVpcClassicLinkRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_vpc_classic_link_input::ser_enable_vpc_classic_link_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for EnableVpcClassicLinkEndpointParamsInterceptor {
...
pub type EnableVpcClassicLinkErrorKind = EnableVpcClassicLinkError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for EnableVpcClassicLinkError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_vpc_classic_link::EnableVpcClassicLinkError {
...
impl EnableVpcClassicLinkError {
    ...
    /// Creates the `EnableVpcClassicLinkError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
