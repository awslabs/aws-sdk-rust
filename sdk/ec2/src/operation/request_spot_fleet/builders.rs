...
impl RequestSpotFleetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::request_spot_fleet::RequestSpotFleetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_spot_fleet::RequestSpotFleetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::request_spot_fleet::RequestSpotFleetOutput, crate::operation::request_spot_fleet::RequestSpotFleetError, Self> {
