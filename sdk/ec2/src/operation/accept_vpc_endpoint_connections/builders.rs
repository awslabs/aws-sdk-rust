...
impl crate::operation::accept_vpc_endpoint_connections::builders::AcceptVpcEndpointConnectionsInputBuilder {
...
impl AcceptVpcEndpointConnectionsFluentBuilder {
    /// Creates a new `AcceptVpcEndpointConnectionsFluentBuilder`.
