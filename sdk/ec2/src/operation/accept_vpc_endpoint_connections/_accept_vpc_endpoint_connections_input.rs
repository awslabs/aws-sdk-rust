...
impl AcceptVpcEndpointConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_vpc_endpoint_connections::AcceptVpcEndpointConnectionsInput, ::aws_smithy_types::error::operation::BuildError> {
