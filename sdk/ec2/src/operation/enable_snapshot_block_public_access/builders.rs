...
impl EnableSnapshotBlockPublicAccessFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_snapshot_block_public_access::EnableSnapshotBlockPublicAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_snapshot_block_public_access::EnableSnapshotBlockPublicAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_snapshot_block_public_access::EnableSnapshotBlockPublicAccessOutput, crate::operation::enable_snapshot_block_public_access::EnableSnapshotBlockPublicAccessError, Self> {
