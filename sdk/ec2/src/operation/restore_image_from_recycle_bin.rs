...
impl RestoreImageFromRecycleBin {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreImageFromRecycleBin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RestoreImageFromRecycleBin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RestoreImageFromRecycleBinRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RestoreImageFromRecycleBinResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreImageFromRecycleBin")
...
.with_interceptor(RestoreImageFromRecycleBinEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_restore_image_from_recycle_bin::de_restore_image_from_recycle_bin_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RestoreImageFromRecycleBinRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreImageFromRecycleBinRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_restore_image_from_recycle_bin_input::ser_restore_image_from_recycle_bin_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RestoreImageFromRecycleBinEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreImageFromRecycleBinEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RestoreImageFromRecycleBinEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RestoreImageFromRecycleBinInput>()
                        .ok_or("failed to downcast to RestoreImageFromRecycleBinInput")?;
...
/// Error type for the `RestoreImageFromRecycleBinError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum RestoreImageFromRecycleBinError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RestoreImageFromRecycleBinError) for what information is available for the error.")]
...
impl RestoreImageFromRecycleBinError {
    /// Creates the `RestoreImageFromRecycleBinError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreImageFromRecycleBinError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RestoreImageFromRecycleBinError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RestoreImageFromRecycleBinError {
