    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreImageFromRecycleBin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RestoreImageFromRecycleBin", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreImageFromRecycleBin")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RestoreImageFromRecycleBinResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RestoreImageFromRecycleBinRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_image_from_recycle_bin_input::ser_restore_image_from_recycle_bin_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RestoreImageFromRecycleBinEndpointParamsInterceptor {
...
pub type RestoreImageFromRecycleBinErrorKind = RestoreImageFromRecycleBinError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for RestoreImageFromRecycleBinError {
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinError {
...
impl RestoreImageFromRecycleBinError {
    ...
    /// Creates the `RestoreImageFromRecycleBinError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
