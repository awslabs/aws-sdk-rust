...
impl DisassociateTransitGatewayMulticastDomainInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_transit_gateway_multicast_domain::DisassociateTransitGatewayMulticastDomainInput, ::aws_smithy_types::error::operation::BuildError> {
