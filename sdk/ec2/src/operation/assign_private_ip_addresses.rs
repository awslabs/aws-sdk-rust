    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::assign_private_ip_addresses::AssignPrivateIpAddressesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::assign_private_ip_addresses::AssignPrivateIpAddressesOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssignPrivateIpAddresses {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AssignPrivateIpAddresses", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssignPrivateIpAddresses")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssignPrivateIpAddressesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssignPrivateIpAddressesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::assign_private_ip_addresses::AssignPrivateIpAddressesInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_assign_private_ip_addresses_input::ser_assign_private_ip_addresses_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssignPrivateIpAddressesEndpointParamsInterceptor {
...
pub type AssignPrivateIpAddressesErrorKind = AssignPrivateIpAddressesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssignPrivateIpAddressesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::assign_private_ip_addresses::AssignPrivateIpAddressesError {
...
impl AssignPrivateIpAddressesError {
    ...
    /// Creates the `AssignPrivateIpAddressesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
