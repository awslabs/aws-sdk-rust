...
impl AssignPrivateIpAddressesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::assign_private_ip_addresses::AssignPrivateIpAddresses::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssignPrivateIpAddresses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_assign_private_ip_addresses::de_assign_private_ip_addresses_http_response_with_props(status, headers, body)
        }
    }
}
