...
impl CancelImportTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_import_task::CancelImportTask,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelImportTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_import_task::de_cancel_import_task_http_response_with_props(status, headers, body)
        }
    }
}
