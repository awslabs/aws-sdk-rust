    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTransitGatewayPrefixListReferences {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTransitGatewayPrefixListReferences");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetTransitGatewayPrefixListReferencesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetTransitGatewayPrefixListReferencesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTransitGatewayPrefixListReferences")
...
.with_interceptor(GetTransitGatewayPrefixListReferencesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesError>::new());
...
#[derive(Debug)]
            struct GetTransitGatewayPrefixListReferencesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTransitGatewayPrefixListReferencesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_transit_gateway_prefix_list_references::de_get_transit_gateway_prefix_list_references_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetTransitGatewayPrefixListReferencesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTransitGatewayPrefixListReferencesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTransitGatewayPrefixListReferencesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetTransitGatewayPrefixListReferencesInput>()
                        .ok_or("failed to downcast to GetTransitGatewayPrefixListReferencesInput")?;
...
pub enum GetTransitGatewayPrefixListReferencesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTransitGatewayPrefixListReferencesError) for what information is available for the error.")]
...
impl GetTransitGatewayPrefixListReferencesError {
    /// Creates the `GetTransitGatewayPrefixListReferencesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetTransitGatewayPrefixListReferencesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetTransitGatewayPrefixListReferencesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTransitGatewayPrefixListReferencesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_transit_gateway_prefix_list_references::GetTransitGatewayPrefixListReferencesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_transit_gateway_prefix_list_references::_get_transit_gateway_prefix_list_references_output::GetTransitGatewayPrefixListReferencesOutput;

pub use crate::operation::get_transit_gateway_prefix_list_references::_get_transit_gateway_prefix_list_references_input::GetTransitGatewayPrefixListReferencesInput;

mod _get_transit_gateway_prefix_list_references_input;

mod _get_transit_gateway_prefix_list_references_output;
