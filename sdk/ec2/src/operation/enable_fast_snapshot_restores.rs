...
impl EnableFastSnapshotRestoresInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestores::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for EnableFastSnapshotRestores {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_enable_fast_snapshot_restores::de_enable_fast_snapshot_restores_http_error(response)
        } else {
            crate::protocol_serde::shape_enable_fast_snapshot_restores::de_enable_fast_snapshot_restores_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresError
{
