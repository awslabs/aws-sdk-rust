...
impl DeleteLaunchTemplateFluentBuilder  {
    /// Creates a new `DeleteLaunchTemplate`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_launch_template::DeleteLaunchTemplateOutput, aws_smithy_http::result::SdkError<crate::operation::delete_launch_template::DeleteLaunchTemplateError>>
                     {
