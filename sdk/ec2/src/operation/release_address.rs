...
impl ReleaseAddressInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_release_address_input::ser_release_address_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::release_address::ReleaseAddress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReleaseAddress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_release_address::de_release_address_http_error(
                status, headers, body,
            )
        } else {
