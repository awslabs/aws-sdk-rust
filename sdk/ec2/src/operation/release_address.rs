...
impl ReleaseAddressInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::release_address::ReleaseAddress, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReleaseAddress {
    type Output =
        ::std::result::Result<crate::operation::release_address::ReleaseAddressOutput, crate::operation::release_address::ReleaseAddressError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_release_address::de_release_address_http_response_with_props(status, headers, body)
        }
    }
}
