...
impl SearchTransitGatewayRoutesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesOutput, crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesError, Self> {
