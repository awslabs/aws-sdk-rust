...
impl DisableFastSnapshotRestoresOutput {
    ...
    pub fn successful(
        &self,
    ) -> ::std::option::Option<&[crate::types::DisableFastSnapshotRestoreSuccessItem]> {
        self.successful.as_deref()
    }
    /// <p>Information about the snapshots for which fast snapshot restores could not be disabled.</p>
    pub fn unsuccessful(
        &self,
    ) -> ::std::option::Option<&[crate::types::DisableFastSnapshotRestoreErrorItem]> {
...
impl DisableFastSnapshotRestoresOutputBuilder {
    ...
    pub fn successful(
        mut self,
        input: crate::types::DisableFastSnapshotRestoreSuccessItem,
    ) -> Self {
    ...
    pub fn set_successful(
        ...
        input: ::std::option::Option<
            ::std::vec::Vec<crate::types::DisableFastSnapshotRestoreSuccessItem>,
        >,
    ) -> Self {
    ...
    pub fn unsuccessful(
        mut self,
        input: crate::types::DisableFastSnapshotRestoreErrorItem,
    ) -> Self {
    ...
    pub fn set_unsuccessful(
        mut self,
        input: ::std::option::Option<
            ::std::vec::Vec<crate::types::DisableFastSnapshotRestoreErrorItem>,
        >,
    ) -> Self {
