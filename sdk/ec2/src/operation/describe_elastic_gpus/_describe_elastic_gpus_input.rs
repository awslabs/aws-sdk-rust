...
impl DescribeElasticGpusInputBuilder {
    ...
    pub fn set_elastic_gpu_ids(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.elastic_gpu_ids = input; self
    }
    /// <p>The Elastic Graphics accelerator IDs.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_elastic_gpus::DescribeElasticGpusInput, ::aws_smithy_types::error::operation::BuildError> {
