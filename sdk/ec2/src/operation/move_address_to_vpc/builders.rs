...
impl MoveAddressToVpcFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::move_address_to_vpc::MoveAddressToVpcOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::move_address_to_vpc::MoveAddressToVpcError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::move_address_to_vpc::MoveAddressToVpcOutput, crate::operation::move_address_to_vpc::MoveAddressToVpcError, Self> {
