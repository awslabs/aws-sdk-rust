...
impl DeleteTransitGatewayPolicyTable {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_transit_gateway_policy_table::DeleteTransitGatewayPolicyTableOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteTransitGatewayPolicyTableResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteTransitGatewayPolicyTableRequestSerializer {
