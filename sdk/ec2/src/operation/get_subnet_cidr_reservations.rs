...
impl GetSubnetCidrReservations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "GetSubnetCidrReservations", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSubnetCidrReservations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            GetSubnetCidrReservationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            GetSubnetCidrReservationsResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetSubnetCidrReservations", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSubnetCidrReservations")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetSubnetCidrReservationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetSubnetCidrReservationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_subnet_cidr_reservations_input::ser_get_subnet_cidr_reservations_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetSubnetCidrReservationsEndpointParamsInterceptor {
...
pub type GetSubnetCidrReservationsErrorKind = GetSubnetCidrReservationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetSubnetCidrReservationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_subnet_cidr_reservations::GetSubnetCidrReservationsError {
...
impl GetSubnetCidrReservationsError {
    ...
    /// Creates the `GetSubnetCidrReservationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
