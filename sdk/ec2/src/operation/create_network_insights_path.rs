...
impl CreateNetworkInsightsPathInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_network_insights_path::CreateNetworkInsightsPath::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNetworkInsightsPath {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_network_insights_path::de_create_network_insights_path_http_response_with_props(status, headers, body)
        }
    }
}
