    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_network_insights_path::CreateNetworkInsightsPathError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_network_insights_path::CreateNetworkInsightsPathOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateNetworkInsightsPath {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateNetworkInsightsPath", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateNetworkInsightsPath")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateNetworkInsightsPathResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateNetworkInsightsPathRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_network_insights_path::CreateNetworkInsightsPathInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_network_insights_path_input::ser_create_network_insights_path_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateNetworkInsightsPathEndpointParamsInterceptor {
...
pub type CreateNetworkInsightsPathErrorKind = CreateNetworkInsightsPathError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateNetworkInsightsPathError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_network_insights_path::CreateNetworkInsightsPathError {
...
impl CreateNetworkInsightsPathError {
    ...
    /// Creates the `CreateNetworkInsightsPathError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
