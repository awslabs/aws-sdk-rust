    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_internet_gateways::DescribeInternetGatewaysError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_internet_gateways::DescribeInternetGatewaysOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeInternetGateways {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeInternetGateways", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeInternetGateways")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeInternetGatewaysResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeInternetGatewaysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_internet_gateways::DescribeInternetGatewaysInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_internet_gateways_input::ser_describe_internet_gateways_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeInternetGatewaysEndpointParamsInterceptor {
...
pub type DescribeInternetGatewaysErrorKind = DescribeInternetGatewaysError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeInternetGatewaysError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_internet_gateways::DescribeInternetGatewaysError {
...
impl DescribeInternetGatewaysError {
    ...
    /// Creates the `DescribeInternetGatewaysError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
