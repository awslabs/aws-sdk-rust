...
impl ReplaceVpnTunnel {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ec2", "ReplaceVpnTunnel", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceVpnTunnel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ReplaceVpnTunnel", "ec2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceVpnTunnel")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ReplaceVpnTunnelEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ReplaceVpnTunnelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ReplaceVpnTunnelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_replace_vpn_tunnel_input::ser_replace_vpn_tunnel_input_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ReplaceVpnTunnelEndpointParamsInterceptor {
...
pub type ReplaceVpnTunnelErrorKind = ReplaceVpnTunnelError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReplaceVpnTunnelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError {
...
impl ReplaceVpnTunnelError {
    ...
    /// Creates the `ReplaceVpnTunnelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
