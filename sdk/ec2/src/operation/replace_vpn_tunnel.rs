...
impl ReplaceVpnTunnel {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReplaceVpnTunnel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReplaceVpnTunnel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReplaceVpnTunnelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReplaceVpnTunnelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReplaceVpnTunnel")
...
.with_interceptor(ReplaceVpnTunnelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_replace_vpn_tunnel::de_replace_vpn_tunnel_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ReplaceVpnTunnelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReplaceVpnTunnelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_replace_vpn_tunnel_input::ser_replace_vpn_tunnel_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ReplaceVpnTunnelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReplaceVpnTunnelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReplaceVpnTunnelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReplaceVpnTunnelInput>()
                        .ok_or("failed to downcast to ReplaceVpnTunnelInput")?;
...
/// Error type for the `ReplaceVpnTunnelError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ReplaceVpnTunnelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReplaceVpnTunnelError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ReplaceVpnTunnelError {
    /// Creates the `ReplaceVpnTunnelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceVpnTunnelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::std::error::Error for ReplaceVpnTunnelError {
...
impl ::std::fmt::Display for ReplaceVpnTunnelError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ReplaceVpnTunnelError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReplaceVpnTunnelError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReplaceVpnTunnelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::replace_vpn_tunnel::ReplaceVpnTunnelError {
...
mod _replace_vpn_tunnel_output;
