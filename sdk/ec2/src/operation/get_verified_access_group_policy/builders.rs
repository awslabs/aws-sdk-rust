...
pub use crate::operation::get_verified_access_group_policy::_get_verified_access_group_policy_output::GetVerifiedAccessGroupPolicyOutputBuilder;

pub use crate::operation::get_verified_access_group_policy::_get_verified_access_group_policy_input::GetVerifiedAccessGroupPolicyInputBuilder;
...
impl GetVerifiedAccessGroupPolicyInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.get_verified_access_group_policy();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyOutput,
                    crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyError,
                > for GetVerifiedAccessGroupPolicyFluentBuilder
            {
                fn send(
                    self,
...
impl GetVerifiedAccessGroupPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicy::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicy::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyOutput, crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyError, Self> {
