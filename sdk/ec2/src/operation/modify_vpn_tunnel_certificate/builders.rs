...
impl crate::operation::modify_vpn_tunnel_certificate::builders::ModifyVpnTunnelCertificateInputBuilder {
...
impl ModifyVpnTunnelCertificateFluentBuilder {
    /// Creates a new `ModifyVpnTunnelCertificateFluentBuilder`.
