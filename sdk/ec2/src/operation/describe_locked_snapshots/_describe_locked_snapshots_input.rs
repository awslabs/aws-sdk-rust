...
impl DescribeLockedSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_locked_snapshots::DescribeLockedSnapshotsInput, ::aws_smithy_types::error::operation::BuildError> {
