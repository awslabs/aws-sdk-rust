    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UnassignIpv6AddressesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UnassignIpv6AddressesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_unassign_ipv6_addresses_input::ser_unassign_ipv6_addresses_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UnassignIpv6AddressesEndpointParamsInterceptor {
...
pub type UnassignIpv6AddressesErrorKind = UnassignIpv6AddressesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UnassignIpv6AddressesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError {
...
impl UnassignIpv6AddressesError {
    ...
    /// Creates the `UnassignIpv6AddressesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
