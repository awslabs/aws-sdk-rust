...
impl UnassignIpv6Addresses {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UnassignIpv6Addresses {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UnassignIpv6Addresses");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UnassignIpv6AddressesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UnassignIpv6AddressesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UnassignIpv6Addresses")
...
.with_interceptor(UnassignIpv6AddressesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError>::new());
...
#[derive(Debug)]
            struct UnassignIpv6AddressesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnassignIpv6AddressesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_unassign_ipv6_addresses::de_unassign_ipv6_addresses_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_unassign_ipv6_addresses::de_unassign_ipv6_addresses_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UnassignIpv6AddressesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_unassign_ipv6_addresses_input::ser_unassign_ipv6_addresses_input_input_input(&input)?);
...
#[derive(Debug)]
            struct UnassignIpv6AddressesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UnassignIpv6AddressesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UnassignIpv6AddressesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UnassignIpv6AddressesInput>()
                        .ok_or("failed to downcast to UnassignIpv6AddressesInput")?;
...
/// Error type for the `UnassignIpv6AddressesError` operation.
#[non_exhaustive]
...
pub enum UnassignIpv6AddressesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UnassignIpv6AddressesError) for what information is available for the error.")]
...
impl UnassignIpv6AddressesError {
    /// Creates the `UnassignIpv6AddressesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UnassignIpv6AddressesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UnassignIpv6AddressesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UnassignIpv6AddressesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::unassign_ipv6_addresses::UnassignIpv6AddressesError {
...
mod _unassign_ipv6_addresses_output;
