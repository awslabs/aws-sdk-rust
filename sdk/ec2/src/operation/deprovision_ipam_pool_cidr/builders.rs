...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrOutput,
                    crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrError,
                > for DeprovisionIpamPoolCidrFluentBuilder
            {
                fn send(
                    self,
...
impl DeprovisionIpamPoolCidrFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidr::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidr::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrOutput, crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrError, Self> {
