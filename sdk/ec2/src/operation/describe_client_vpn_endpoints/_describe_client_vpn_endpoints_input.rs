...
impl DescribeClientVpnEndpointsInputBuilder {
    ...
    pub fn set_client_vpn_endpoint_ids(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.client_vpn_endpoint_ids = input; self
    }
    /// <p>The ID of the Client VPN endpoint.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_client_vpn_endpoints::DescribeClientVpnEndpointsInput, ::aws_smithy_types::error::operation::BuildError> {
