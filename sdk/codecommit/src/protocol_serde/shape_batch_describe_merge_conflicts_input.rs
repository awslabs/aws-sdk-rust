...
pub fn ser_batch_describe_merge_conflicts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchDescribeMergeConflictsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
