...
pub fn ser_create_pull_request_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePullRequestInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
