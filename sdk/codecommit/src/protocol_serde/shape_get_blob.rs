...
pub fn de_get_blob_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_blob::GetBlobOutput, crate::operation::get_blob::GetBlobError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "BlobIdDoesNotExistException" => crate::operation::get_blob::GetBlobError::BlobIdDoesNotExistException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_blob_id_does_not_exist_exception::de_blob_id_does_not_exist_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::get_blob::GetBlobError::unhandled)?;
        ...
        "BlobIdRequiredException" => crate::operation::get_blob::GetBlobError::BlobIdRequiredException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_blob_id_required_exception::de_blob_id_required_exception_json_err(_response_body, output)
                    .map_err(crate::operation::get_blob::GetBlobError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidBlobIdException" => crate::operation::get_blob::GetBlobError::InvalidBlobIdException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_blob_id_exception::de_invalid_blob_id_exception_json_err(_response_body, output)
                    .map_err(crate::operation::get_blob::GetBlobError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
pub fn de_get_blob_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_blob::de_get_blob(_response_body, output)
            .map_err(crate::operation::get_blob::GetBlobError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_blob_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_blob::GetBlobError::unhandled)?
    })
}
...
) -> ::std::result::Result<crate::operation::get_blob::builders::GetBlobOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
