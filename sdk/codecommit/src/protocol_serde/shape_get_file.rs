...
pub fn de_get_file_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_file::GetFileOutput, crate::operation::get_file::GetFileError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "FileTooLargeException" => crate::operation::get_file::GetFileError::FileTooLargeException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_file_too_large_exception::de_file_too_large_exception_json_err(_response_body, output)
                    .map_err(crate::operation::get_file::GetFileError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
pub fn de_get_file_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_file_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_file::GetFileError::unhandled)?
    })
}
...
) -> ::std::result::Result<crate::operation::get_file::builders::GetFileOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "fileContent" => {
                    builder = builder.set_file_content(::aws_smithy_json::deserialize::token::expect_blob_or_null(tokens.next())?);
                }
