...
pub fn ser_get_merge_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMergeCommitInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
