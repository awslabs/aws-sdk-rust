...
> {
    Ok({
        ...
        crate::serde_util::list_file_commit_history_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_file_commit_history::ListFileCommitHistoryError::unhandled)?
    })
}
...
pub fn ser_list_file_commit_history_input(
    ...
    crate::protocol_serde::shape_list_file_commit_history_input::ser_list_file_commit_history_input(&mut object, input)?;
    object.finish();
