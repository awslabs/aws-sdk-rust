...
pub fn de_list_file_commit_history_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_file_commit_history::ListFileCommitHistoryError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "EncryptionIntegrityChecksFailedException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::EncryptionIntegrityChecksFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "EncryptionKeyAccessDeniedException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::EncryptionKeyAccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "EncryptionKeyUnavailableException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::EncryptionKeyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidContinuationTokenException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::InvalidContinuationTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "RepositoryDoesNotExistException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::RepositoryDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "RepositoryNameRequiredException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::RepositoryNameRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TipsDivergenceExceededException" => {
            crate::operation::list_file_commit_history::ListFileCommitHistoryError::TipsDivergenceExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_file_commit_history_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_file_commit_history::de_list_file_commit_history(_response_body, output)
            .map_err(crate::operation::list_file_commit_history::ListFileCommitHistoryError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_file_commit_history_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_file_commit_history::ListFileCommitHistoryError::unhandled)?
    })
}

pub fn ser_list_file_commit_history_input(
...
pub(crate) fn de_list_file_commit_history(
    _value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "revisionDag" => {
                    builder = builder.set_revision_dag(crate::protocol_serde::shape_revision_dag::de_revision_dag(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
