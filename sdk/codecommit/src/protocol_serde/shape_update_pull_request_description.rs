...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidDescriptionException" => {
            crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::InvalidDescriptionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidPullRequestIdException" => {
            crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::InvalidPullRequestIdException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PullRequestAlreadyClosedException" => {
            crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::PullRequestAlreadyClosedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PullRequestDoesNotExistException" => {
            crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::PullRequestDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PullRequestIdRequiredException" => {
            crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::PullRequestIdRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_pull_request_description::de_update_pull_request_description(_response_body, output)
            .map_err(crate::operation::update_pull_request_description::UpdatePullRequestDescriptionError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::update_pull_request_description_output_correct_errors(output).build()
    })
}
