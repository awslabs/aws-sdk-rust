...
pub fn de_get_folder_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_folder_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_folder::GetFolderError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_folder::builders::GetFolderOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
