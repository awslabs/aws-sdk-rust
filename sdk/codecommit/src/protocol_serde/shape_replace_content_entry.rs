...
pub fn ser_replace_content_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplaceContentEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
