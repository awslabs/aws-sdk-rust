...
pub fn de_delete_branch_http_error(
    ...
    Err(match error_code {
        ...
        "DefaultBranchCannotBeDeletedException" => {
            crate::operation::delete_branch::DeleteBranchError::DefaultBranchCannotBeDeletedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "deletedBranch" => {
                    builder = builder.set_deleted_branch(crate::protocol_serde::shape_branch_info::de_branch_info(tokens, _value, depth + 1)?);
                }
