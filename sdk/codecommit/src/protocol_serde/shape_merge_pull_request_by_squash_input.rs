...
pub fn ser_merge_pull_request_by_squash_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergePullRequestBySquashInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
