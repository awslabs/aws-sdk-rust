...
pub fn ser_post_comment_for_compared_commit_input(input: &crate::operation::post_comment_for_compared_commit::PostCommentForComparedCommitInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
