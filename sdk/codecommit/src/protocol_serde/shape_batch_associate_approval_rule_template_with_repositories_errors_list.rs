        ...
        Some(::aws_smithy_json::deserialize::Token::StartArray { .. }) => {
            ...
            loop {
                match tokens.peek() {
                    ...
                    _ => {
                        let value =
                            crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories_error::de_batch_associate_approval_rule_template_with_repositories_error(tokens, _value)?
                        ;
