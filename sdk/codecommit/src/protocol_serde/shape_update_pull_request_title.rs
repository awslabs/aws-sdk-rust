...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_pull_request_title::UpdatePullRequestTitleError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "PullRequestAlreadyClosedException" => {
            crate::operation::update_pull_request_title::UpdatePullRequestTitleError::PullRequestAlreadyClosedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PullRequestDoesNotExistException" => {
            crate::operation::update_pull_request_title::UpdatePullRequestTitleError::PullRequestDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PullRequestIdRequiredException" => {
            crate::operation::update_pull_request_title::UpdatePullRequestTitleError::PullRequestIdRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
