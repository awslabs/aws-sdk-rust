...
pub fn de_create_pull_request_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_pull_request::CreatePullRequestOutput, crate::operation::create_pull_request::CreatePullRequestError>
{
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "ClientRequestTokenRequiredException" => {
            crate::operation::create_pull_request::CreatePullRequestError::ClientRequestTokenRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ClientRequestTokenRequiredExceptionBuilder::default();
                    output =
                        crate::protocol_serde::shape_client_request_token_required_exception::de_client_request_token_required_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "EncryptionIntegrityChecksFailedException" => {
            crate::operation::create_pull_request::CreatePullRequestError::EncryptionIntegrityChecksFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "IdempotencyParameterMismatchException" => {
            crate::operation::create_pull_request::CreatePullRequestError::IdempotencyParameterMismatchException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::IdempotencyParameterMismatchExceptionBuilder::default();
                    output =
                        crate::protocol_serde::shape_idempotency_parameter_mismatch_exception::de_idempotency_parameter_mismatch_exception_json_err(
                            _response_body,
                            output,
                        )
                        .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "InvalidClientRequestTokenException" => crate::operation::create_pull_request::CreatePullRequestError::InvalidClientRequestTokenException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_client_request_token_exception::de_invalid_client_request_token_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "InvalidDescriptionException" => crate::operation::create_pull_request::CreatePullRequestError::InvalidDescriptionException({
            ...
            let mut tmp = {
                ...
                output =
                    crate::protocol_serde::shape_invalid_description_exception::de_invalid_description_exception_json_err(_response_body, output)
                        .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidReferenceNameException" => crate::operation::create_pull_request::CreatePullRequestError::InvalidReferenceNameException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_reference_name_exception::de_invalid_reference_name_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "InvalidTargetException" => crate::operation::create_pull_request::CreatePullRequestError::InvalidTargetException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_target_exception::de_invalid_target_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidTargetsException" => crate::operation::create_pull_request::CreatePullRequestError::InvalidTargetsException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_targets_exception::de_invalid_targets_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "InvalidTitleException" => crate::operation::create_pull_request::CreatePullRequestError::InvalidTitleException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_title_exception::de_invalid_title_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "MaximumOpenPullRequestsExceededException" => {
            crate::operation::create_pull_request::CreatePullRequestError::MaximumOpenPullRequestsExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MultipleRepositoriesInPullRequestException" => {
            crate::operation::create_pull_request::CreatePullRequestError::MultipleRepositoriesInPullRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReferenceDoesNotExistException" => crate::operation::create_pull_request::CreatePullRequestError::ReferenceDoesNotExistException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_reference_does_not_exist_exception::de_reference_does_not_exist_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "ReferenceNameRequiredException" => crate::operation::create_pull_request::CreatePullRequestError::ReferenceNameRequiredException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_reference_name_required_exception::de_reference_name_required_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "ReferenceTypeNotSupportedException" => crate::operation::create_pull_request::CreatePullRequestError::ReferenceTypeNotSupportedException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_reference_type_not_supported_exception::de_reference_type_not_supported_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
        ...
        "SourceAndDestinationAreSameException" => {
            crate::operation::create_pull_request::CreatePullRequestError::SourceAndDestinationAreSameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TargetRequiredException" => crate::operation::create_pull_request::CreatePullRequestError::TargetRequiredException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_target_required_exception::de_target_required_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "TargetsRequiredException" => crate::operation::create_pull_request::CreatePullRequestError::TargetsRequiredException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_targets_required_exception::de_targets_required_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "TitleRequiredException" => crate::operation::create_pull_request::CreatePullRequestError::TitleRequiredException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_title_required_exception::de_title_required_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_pull_request::CreatePullRequestError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
) -> Result<crate::operation::create_pull_request::builders::CreatePullRequestOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
