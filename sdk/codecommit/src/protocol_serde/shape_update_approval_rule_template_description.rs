...
pub fn de_update_approval_rule_template_description_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionError::unhandled(generic))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_approval_rule_template_description_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_approval_rule_template_description::de_update_approval_rule_template_description(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionError::unhandled)?;
...
pub fn ser_update_approval_rule_template_description_input(
    ...
    crate::protocol_serde::shape_update_approval_rule_template_description_input::ser_update_approval_rule_template_description_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_update_approval_rule_template_description(
    value: &[u8],
