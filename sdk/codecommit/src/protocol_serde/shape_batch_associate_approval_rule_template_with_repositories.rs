                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "errors" => {
                        builder = builder.set_errors(
                            crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories_errors_list::de_batch_associate_approval_rule_template_with_repositories_errors_list(tokens, _value, depth + 1)?
                        );
                    }
