        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "associatedRepositoryNames" => {
                    builder = builder.set_associated_repository_names(crate::protocol_serde::shape_repository_name_list::de_repository_name_list(
                        tokens, _value,
                    )?);
                }
                "errors" => {
                    builder = builder.set_errors(
                            crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories_errors_list::de_batch_associate_approval_rule_template_with_repositories_errors_list(tokens, _value)?
                        );
                }
