...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_associate_approval_rule_template_with_repositories_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "associatedRepositoryNames" => {
                    builder =
                        builder.set_associated_repository_names(crate::protocol_serde::shape_repository_name_list::de_repository_name_list(tokens)?);
                }
                "errors" => {
