        ...
        Some(::aws_smithy_json::deserialize::Token::StartArray { .. }) => {
            ...
            loop {
                match tokens.peek() {
                    ...
                    _ => {
                        let value =
                            crate::protocol_serde::shape_batch_disassociate_approval_rule_template_from_repositories_error::de_batch_disassociate_approval_rule_template_from_repositories_error(tokens, _value)?
                        ;
