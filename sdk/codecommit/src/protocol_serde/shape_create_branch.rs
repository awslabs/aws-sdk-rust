...
pub fn de_create_branch_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_branch::CreateBranchOutput, crate::operation::create_branch::CreateBranchError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "BranchNameExistsException" => crate::operation::create_branch::CreateBranchError::BranchNameExistsException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_branch_name_exists_exception::de_branch_name_exists_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_branch::CreateBranchError::unhandled)?;
