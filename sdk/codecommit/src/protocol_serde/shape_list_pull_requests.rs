...
pub fn ser_list_pull_requests_input(
    ...
    crate::protocol_serde::shape_list_pull_requests_input::ser_list_pull_requests_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_pull_requests::ListPullRequestsError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_list_pull_requests::de_list_pull_requests(
