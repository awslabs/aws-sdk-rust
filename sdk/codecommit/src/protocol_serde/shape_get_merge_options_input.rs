...
pub fn ser_get_merge_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_merge_options::GetMergeOptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
