...
pub fn ser_get_file_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_file::GetFileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
