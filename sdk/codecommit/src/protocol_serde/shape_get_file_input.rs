...
pub fn ser_get_file_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetFileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
