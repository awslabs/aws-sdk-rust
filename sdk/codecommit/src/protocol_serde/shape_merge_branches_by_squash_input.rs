...
pub fn ser_merge_branches_by_squash_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergeBranchesBySquashInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
