...
pub fn ser_get_merge_conflicts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_merge_conflicts::GetMergeConflictsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
