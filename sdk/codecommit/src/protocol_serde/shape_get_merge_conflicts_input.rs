...
pub fn ser_get_merge_conflicts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMergeConflictsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
