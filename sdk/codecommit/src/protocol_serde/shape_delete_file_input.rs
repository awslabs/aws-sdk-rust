...
pub fn ser_delete_file_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteFileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
