...
pub fn ser_merge_branches_by_fast_forward_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergeBranchesByFastForwardInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
