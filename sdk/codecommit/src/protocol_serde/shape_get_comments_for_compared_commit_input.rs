...
pub fn ser_get_comments_for_compared_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCommentsForComparedCommitInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
