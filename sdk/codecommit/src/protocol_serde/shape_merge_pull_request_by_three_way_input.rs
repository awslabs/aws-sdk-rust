...
pub fn ser_merge_pull_request_by_three_way_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
