...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_comment::UpdateCommentError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_update_comment::de_update_comment(_response_body, output)
                .map_err(crate::operation::update_comment::UpdateCommentError::unhandled)?;
