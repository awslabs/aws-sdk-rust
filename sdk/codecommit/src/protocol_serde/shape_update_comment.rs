...
pub fn de_update_comment_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_comment::UpdateCommentOutput, crate::operation::update_comment::UpdateCommentError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_comment_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_comment::UpdateCommentOutput, crate::operation::update_comment::UpdateCommentError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_comment_input(input: &crate::operation::update_comment::UpdateCommentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_comment_input::ser_update_comment_input_input(&mut object, input)?;
    object.finish();
