...
pub fn ser_create_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCommitInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
