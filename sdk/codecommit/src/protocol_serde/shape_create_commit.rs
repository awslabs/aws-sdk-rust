...
pub fn de_create_commit_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_commit::CreateCommitOutput, crate::operation::create_commit::CreateCommitError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "DirectoryNameConflictsWithFileNameException" => {
            crate::operation::create_commit::CreateCommitError::DirectoryNameConflictsWithFileNameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "FileContentAndSourceFileSpecifiedException" => {
            crate::operation::create_commit::CreateCommitError::FileContentAndSourceFileSpecifiedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "FileContentSizeLimitExceededException" => {
            crate::operation::create_commit::CreateCommitError::FileContentSizeLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "FileEntryRequiredException" => crate::operation::create_commit::CreateCommitError::FileEntryRequiredException({
            ...
            let mut tmp = {
                ...
                output =
                    crate::protocol_serde::shape_file_entry_required_exception::de_file_entry_required_exception_json_err(_response_body, output)
                        .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "FileNameConflictsWithDirectoryNameException" => {
            crate::operation::create_commit::CreateCommitError::FileNameConflictsWithDirectoryNameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "FilePathConflictsWithSubmodulePathException" => {
            crate::operation::create_commit::CreateCommitError::FilePathConflictsWithSubmodulePathException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MaximumFileEntriesExceededException" => crate::operation::create_commit::CreateCommitError::MaximumFileEntriesExceededException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_maximum_file_entries_exceeded_exception::de_maximum_file_entries_exceeded_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
        ...
        "NoChangeException" => crate::operation::create_commit::CreateCommitError::NoChangeException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_no_change_exception::de_no_change_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "PutFileEntryConflictException" => crate::operation::create_commit::CreateCommitError::PutFileEntryConflictException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_put_file_entry_conflict_exception::de_put_file_entry_conflict_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
        ...
        "RestrictedSourceFileException" => crate::operation::create_commit::CreateCommitError::RestrictedSourceFileException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_restricted_source_file_exception::de_restricted_source_file_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
        ...
        "SamePathRequestException" => crate::operation::create_commit::CreateCommitError::SamePathRequestException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_same_path_request_exception::de_same_path_request_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "SourceFileOrContentRequiredException" => {
            crate::operation::create_commit::CreateCommitError::SourceFileOrContentRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn de_create_commit_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_commit::de_create_commit(_response_body, output)
            .map_err(crate::operation::create_commit::CreateCommitError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "filesAdded" => {
                    builder = builder.set_files_added(crate::protocol_serde::shape_files_metadata::de_files_metadata(tokens, _value, depth + 1)?);
                }
                "filesUpdated" => {
                    builder = builder.set_files_updated(crate::protocol_serde::shape_files_metadata::de_files_metadata(tokens, _value, depth + 1)?);
                }
                "filesDeleted" => {
                    builder = builder.set_files_deleted(crate::protocol_serde::shape_files_metadata::de_files_metadata(tokens, _value, depth + 1)?);
                }
