...
pub fn ser_create_unreferenced_merge_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUnreferencedMergeCommitInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
