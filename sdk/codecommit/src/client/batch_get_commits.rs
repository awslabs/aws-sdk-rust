...
impl super::Client {
    ...
    ///   - [`commit_ids(impl Into<String>)`](crate::operation::batch_get_commits::builders::BatchGetCommitsFluentBuilder::commit_ids) / [`set_commit_ids(Option<Vec<String>>)`](crate::operation::batch_get_commits::builders::BatchGetCommitsFluentBuilder::set_commit_ids): <p>The full commit IDs of the commits to get information about.</p> <note>   <p>You must supply the full SHA IDs of each commit. You cannot use shortened SHA IDs.</p>  </note>
