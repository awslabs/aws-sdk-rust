...
impl super::Client  {
    ...
    pub fn batch_disassociate_approval_rule_template_from_repositories(&self) -> crate::client::fluent_builders::BatchDisassociateApprovalRuleTemplateFromRepositories {
                                crate::client::fluent_builders::BatchDisassociateApprovalRuleTemplateFromRepositories::new(self.handle.clone())
                            }
}
