...
impl super::Client  {
    ...
    pub fn batch_associate_approval_rule_template_with_repositories(&self) -> crate::client::fluent_builders::BatchAssociateApprovalRuleTemplateWithRepositories {
                                crate::client::fluent_builders::BatchAssociateApprovalRuleTemplateWithRepositories::new(self.handle.clone())
                            }
}
