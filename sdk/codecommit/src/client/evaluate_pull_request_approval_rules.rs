...
impl super::Client {
    ...
    ///   - [`pull_request_id(impl ::std::convert::Into<String>)`](crate::operation::evaluate_pull_request_approval_rules::builders::EvaluatePullRequestApprovalRulesFluentBuilder::pull_request_id) / [`set_pull_request_id(Option<String>)`](crate::operation::evaluate_pull_request_approval_rules::builders::EvaluatePullRequestApprovalRulesFluentBuilder::set_pull_request_id): <p>The system-generated ID of the pull request you want to evaluate.</p>
    ///   - [`revision_id(impl ::std::convert::Into<String>)`](crate::operation::evaluate_pull_request_approval_rules::builders::EvaluatePullRequestApprovalRulesFluentBuilder::revision_id) / [`set_revision_id(Option<String>)`](crate::operation::evaluate_pull_request_approval_rules::builders::EvaluatePullRequestApprovalRulesFluentBuilder::set_revision_id): <p>The system-generated ID for the pull request revision. To retrieve the most recent revision ID for a pull request, use <code>GetPullRequest</code>.</p>
