...
impl super::Client {
    ...
    ///   - [`approval_rule_template_name(impl ::std::convert::Into<String>)`](crate::operation::disassociate_approval_rule_template_from_repository::builders::DisassociateApprovalRuleTemplateFromRepositoryFluentBuilder::approval_rule_template_name) / [`set_approval_rule_template_name(Option<String>)`](crate::operation::disassociate_approval_rule_template_from_repository::builders::DisassociateApprovalRuleTemplateFromRepositoryFluentBuilder::set_approval_rule_template_name): <p>The name of the approval rule template to disassociate from a specified repository.</p>
