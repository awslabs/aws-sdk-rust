...
impl super::Client {
    ...
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_repository_name): <p>The name of the repository where you want to get differences.</p>
    ///   - [`before_commit_specifier(impl ::std::convert::Into<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::before_commit_specifier) / [`set_before_commit_specifier(Option<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_before_commit_specifier): <p>The branch, tag, HEAD, or other fully qualified reference used to identify a commit (for example, the full commit ID). Optional. If not specified, all changes before the <code>afterCommitSpecifier</code> value are shown. If you do not use <code>beforeCommitSpecifier</code> in your request, consider limiting the results with <code>maxResults</code>.</p>
    ///   - [`after_commit_specifier(impl ::std::convert::Into<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::after_commit_specifier) / [`set_after_commit_specifier(Option<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_after_commit_specifier): <p>The branch, tag, HEAD, or other fully qualified reference used to identify a commit.</p>
    ///   - [`before_path(impl ::std::convert::Into<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::before_path) / [`set_before_path(Option<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_before_path): <p>The file path in which to check for differences. Limits the results to this path. Can also be used to specify the previous name of a directory or folder. If <code>beforePath</code> and <code>afterPath</code> are not specified, differences are shown for all paths.</p>
    ///   - [`after_path(impl ::std::convert::Into<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::after_path) / [`set_after_path(Option<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_after_path): <p>The file path in which to check differences. Limits the results to this path. Can also be used to specify the changed name of a directory or folder, if it has changed. If not specified, differences are shown for all paths.</p>
    ///   - [`max_results(i32)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_max_results): <p>A non-zero, non-negative integer used to limit the number of returned results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_differences::builders::GetDifferencesFluentBuilder::set_next_token): <p>An enumeration token that, when provided in a request, returns the next batch of the results.</p>
