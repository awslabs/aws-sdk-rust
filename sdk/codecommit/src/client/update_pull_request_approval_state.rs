...
impl super::Client {
    ...
    ///   - [`pull_request_id(impl ::std::convert::Into<String>)`](crate::operation::update_pull_request_approval_state::builders::UpdatePullRequestApprovalStateFluentBuilder::pull_request_id) / [`set_pull_request_id(Option<String>)`](crate::operation::update_pull_request_approval_state::builders::UpdatePullRequestApprovalStateFluentBuilder::set_pull_request_id): <p>The system-generated ID of the pull request.</p>
    ///   - [`revision_id(impl ::std::convert::Into<String>)`](crate::operation::update_pull_request_approval_state::builders::UpdatePullRequestApprovalStateFluentBuilder::revision_id) / [`set_revision_id(Option<String>)`](crate::operation::update_pull_request_approval_state::builders::UpdatePullRequestApprovalStateFluentBuilder::set_revision_id): <p>The system-generated ID of the revision.</p>
