...
impl super::Client {
    ...
    pub fn get_pull_request(
        &self,
    ) -> crate::operation::get_pull_request::builders::GetPullRequestFluentBuilder {
        crate::operation::get_pull_request::builders::GetPullRequestFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
