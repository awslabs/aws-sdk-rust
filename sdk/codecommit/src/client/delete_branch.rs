...
impl super::Client {
    ...
    ///   - [`repository_name(impl Into<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::set_repository_name):<br>required: **true**<br><p>The name of the repository that contains the branch to be deleted.</p><br>
    ///   - [`branch_name(impl Into<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::set_branch_name):<br>required: **true**<br><p>The name of the branch to delete.</p><br>
