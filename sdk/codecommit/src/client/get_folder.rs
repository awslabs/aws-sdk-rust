...
impl super::Client {
    ...
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_repository_name): <p>The name of the repository.</p>
    ///   - [`commit_specifier(impl ::std::convert::Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::commit_specifier) / [`set_commit_specifier(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_commit_specifier): <p>A fully qualified reference used to identify a commit that contains the version of the folder's content to return. A fully qualified reference can be a commit ID, branch name, tag, or reference such as HEAD. If no specifier is provided, the folder content is returned as it exists in the HEAD commit.</p>
    ///   - [`folder_path(impl ::std::convert::Into<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::folder_path) / [`set_folder_path(Option<String>)`](crate::operation::get_folder::builders::GetFolderFluentBuilder::set_folder_path): <p>The fully qualified path to the folder whose contents are returned, including the folder name. For example, /examples is a fully-qualified path to a folder named examples that was created off of the root directory (/) of a repository. </p>
