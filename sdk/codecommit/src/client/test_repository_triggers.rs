...
impl super::Client {
    ...
    ///   - [`triggers(RepositoryTrigger)`](crate::operation::test_repository_triggers::builders::TestRepositoryTriggersFluentBuilder::triggers) / [`set_triggers(Option<Vec<RepositoryTrigger>>)`](crate::operation::test_repository_triggers::builders::TestRepositoryTriggersFluentBuilder::set_triggers): <p>The list of triggers to test.</p>
