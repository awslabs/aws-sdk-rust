...
impl super::Client {
    ...
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::update_default_branch::builders::UpdateDefaultBranchFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::update_default_branch::builders::UpdateDefaultBranchFluentBuilder::set_repository_name): <p>The name of the repository to set or change the default branch for.</p>
