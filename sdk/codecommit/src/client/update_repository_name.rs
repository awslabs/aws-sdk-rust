...
impl super::Client {
    ...
    ///   - [`old_name(impl Into<String>)`](crate::operation::update_repository_name::builders::UpdateRepositoryNameFluentBuilder::old_name) / [`set_old_name(Option<String>)`](crate::operation::update_repository_name::builders::UpdateRepositoryNameFluentBuilder::set_old_name):<br>required: **true**<br><p>The current name of the repository.</p><br>
    ///   - [`new_name(impl Into<String>)`](crate::operation::update_repository_name::builders::UpdateRepositoryNameFluentBuilder::new_name) / [`set_new_name(Option<String>)`](crate::operation::update_repository_name::builders::UpdateRepositoryNameFluentBuilder::set_new_name):<br>required: **true**<br><p>The new name for the repository.</p><br>
