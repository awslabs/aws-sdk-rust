...
impl super::Client {
    ...
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::get_repository_triggers::builders::GetRepositoryTriggersFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::get_repository_triggers::builders::GetRepositoryTriggersFluentBuilder::set_repository_name): <p>The name of the repository for which the trigger is configured.</p>
