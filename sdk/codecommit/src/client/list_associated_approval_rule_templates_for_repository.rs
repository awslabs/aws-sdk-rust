...
impl super::Client  {
    ...
    pub fn list_associated_approval_rule_templates_for_repository(&self) -> crate::client::fluent_builders::ListAssociatedApprovalRuleTemplatesForRepository {
                                crate::client::fluent_builders::ListAssociatedApprovalRuleTemplatesForRepository::new(self.handle.clone())
                            }
}
