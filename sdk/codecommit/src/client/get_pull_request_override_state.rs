...
impl super::Client {
    ...
    ///   - [`pull_request_id(impl ::std::convert::Into<String>)`](crate::operation::get_pull_request_override_state::builders::GetPullRequestOverrideStateFluentBuilder::pull_request_id) / [`set_pull_request_id(Option<String>)`](crate::operation::get_pull_request_override_state::builders::GetPullRequestOverrideStateFluentBuilder::set_pull_request_id): <p>The ID of the pull request for which you want to get information about whether approval rules have been set aside (overridden).</p>
    ///   - [`revision_id(impl ::std::convert::Into<String>)`](crate::operation::get_pull_request_override_state::builders::GetPullRequestOverrideStateFluentBuilder::revision_id) / [`set_revision_id(Option<String>)`](crate::operation::get_pull_request_override_state::builders::GetPullRequestOverrideStateFluentBuilder::set_revision_id): <p>The system-generated ID of the revision for the pull request. To retrieve the most recent revision ID, use <code>GetPullRequest</code>.</p>
