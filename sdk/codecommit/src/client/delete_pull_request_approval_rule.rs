...
impl super::Client {
    ...
    ///   - [`pull_request_id(impl ::std::convert::Into<String>)`](crate::operation::delete_pull_request_approval_rule::builders::DeletePullRequestApprovalRuleFluentBuilder::pull_request_id) / [`set_pull_request_id(Option<String>)`](crate::operation::delete_pull_request_approval_rule::builders::DeletePullRequestApprovalRuleFluentBuilder::set_pull_request_id): <p>The system-generated ID of the pull request that contains the approval rule you want to delete.</p>
    ///   - [`approval_rule_name(impl ::std::convert::Into<String>)`](crate::operation::delete_pull_request_approval_rule::builders::DeletePullRequestApprovalRuleFluentBuilder::approval_rule_name) / [`set_approval_rule_name(Option<String>)`](crate::operation::delete_pull_request_approval_rule::builders::DeletePullRequestApprovalRuleFluentBuilder::set_approval_rule_name): <p>The name of the approval rule you want to delete.</p>
