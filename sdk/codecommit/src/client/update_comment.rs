...
impl super::Client {
    ...
    ///   - [`comment_id(impl Into<String>)`](crate::operation::update_comment::builders::UpdateCommentFluentBuilder::comment_id) / [`set_comment_id(Option<String>)`](crate::operation::update_comment::builders::UpdateCommentFluentBuilder::set_comment_id):<br>required: **true**<br><p>The system-generated ID of the comment you want to update. To get this ID, use <code>GetCommentsForComparedCommit</code> or <code>GetCommentsForPullRequest</code>.</p><br>
    ///   - [`content(impl Into<String>)`](crate::operation::update_comment::builders::UpdateCommentFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::update_comment::builders::UpdateCommentFluentBuilder::set_content):<br>required: **true**<br><p>The updated content to replace the existing content of the comment.</p><br>
