...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for AssociateApprovalRuleTemplateWithRepositoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for AssociateApprovalRuleTemplateWithRepositoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_approval_rule_template_with_repository::ser_associate_approval_rule_template_with_repository_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateApprovalRuleTemplateWithRepositoryEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateApprovalRuleTemplateWithRepositoryError {
