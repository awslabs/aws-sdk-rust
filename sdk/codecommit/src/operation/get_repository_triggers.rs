...
impl GetRepositoryTriggersInput {
    /// Consumes the builder and constructs an Operation<[`GetRepositoryTriggers`](crate::operation::get_repository_triggers::GetRepositoryTriggers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_repository_triggers::GetRepositoryTriggers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_repository_triggers::GetRepositoryTriggersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_repository_triggers::ser_get_repository_triggers_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_repository_triggers::GetRepositoryTriggers::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRepositoryTriggers", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRepositoryTriggers {
                type Output = std::result::Result<crate::operation::get_repository_triggers::GetRepositoryTriggersOutput, crate::operation::get_repository_triggers::GetRepositoryTriggersError>;
