...
impl GetPullRequestOverrideStateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_pull_request_override_state::GetPullRequestOverrideStateInput, ::aws_smithy_types::error::operation::BuildError> {
