...
impl CreateRepository {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeCommit", "CreateRepository", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRepositoryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("repositoryDescription") {
            if let ::std::option::Option::Some(value) = input.repository_description.as_deref() {
                captured.insert("repositoryDescription", value);
            }
        }
