...
impl MergePullRequestBySquashInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for MergePullRequestBySquash {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_merge_pull_request_by_squash::de_merge_pull_request_by_squash_http_response_with_props(status, headers, body)
        }
    }
}
