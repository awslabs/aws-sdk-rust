...
impl MergePullRequestBySquashInput {
    /// Consumes the builder and constructs an Operation<[`MergePullRequestBySquash`](crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_merge_pull_request_by_squash::ser_merge_pull_request_by_squash_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("MergePullRequestBySquash", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for MergePullRequestBySquash {
                type Output = std::result::Result<crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashOutput, crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashError>;
