...
impl MergePullRequestBySquashInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashError
{
