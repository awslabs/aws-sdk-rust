...
impl GetCommitInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_commit::GetCommit, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_commit::ser_get_commit_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCommit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_commit::de_get_commit_http_response_with_props(status, headers, body)
        }
    }
}
