...
impl PutCommentReactionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_comment_reaction::ser_put_comment_reaction_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_comment_reaction::PutCommentReaction::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_comment_reaction::PutCommentReactionError
{
