...
impl BatchGetCommitsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_commits::BatchGetCommitsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_commits::BatchGetCommitsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_commits::BatchGetCommitsOutput, crate::operation::batch_get_commits::BatchGetCommitsError, Self> {
