...
/// Orchestration and serialization glue logic for `ListRepositoriesForApprovalRuleTemplate`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRepositoriesForApprovalRuleTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRepositoriesForApprovalRuleTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRepositoriesForApprovalRuleTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRepositoriesForApprovalRuleTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRepositoriesForApprovalRuleTemplate")
...
.with_interceptor(ListRepositoriesForApprovalRuleTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError>::new());
...
#[derive(Debug)]
            struct ListRepositoriesForApprovalRuleTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRepositoriesForApprovalRuleTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_repositories_for_approval_rule_template::de_list_repositories_for_approval_rule_template_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_repositories_for_approval_rule_template::de_list_repositories_for_approval_rule_template_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRepositoriesForApprovalRuleTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRepositoriesForApprovalRuleTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_repositories_for_approval_rule_template::ser_list_repositories_for_approval_rule_template_input(&input)?);
...
#[derive(Debug)]
            struct ListRepositoriesForApprovalRuleTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRepositoriesForApprovalRuleTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRepositoriesForApprovalRuleTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRepositoriesForApprovalRuleTemplateInput>()
                        .ok_or("failed to downcast to ListRepositoriesForApprovalRuleTemplateInput")?;
...
pub enum ListRepositoriesForApprovalRuleTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRepositoriesForApprovalRuleTemplateError) for what information is available for the error.")]
...
impl ListRepositoriesForApprovalRuleTemplateError {
    /// Creates the `ListRepositoriesForApprovalRuleTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRepositoriesForApprovalRuleTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListRepositoriesForApprovalRuleTemplateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRepositoriesForApprovalRuleTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError {
...
mod _list_repositories_for_approval_rule_template_output;
