...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRepositoriesForApprovalRuleTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_repositories_for_approval_rule_template::de_list_repositories_for_approval_rule_template_http_response_with_props(status, headers, body)
        }
    }
}
