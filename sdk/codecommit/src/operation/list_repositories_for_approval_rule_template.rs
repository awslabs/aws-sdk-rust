...
impl ListRepositoriesForApprovalRuleTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListRepositoriesForApprovalRuleTemplate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRepositoriesForApprovalRuleTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListRepositoriesForApprovalRuleTemplateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListRepositoriesForApprovalRuleTemplateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListRepositoriesForApprovalRuleTemplate")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRepositoriesForApprovalRuleTemplate")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListRepositoriesForApprovalRuleTemplateTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListRepositoriesForApprovalRuleTemplateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRepositoriesForApprovalRuleTemplateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListRepositoriesForApprovalRuleTemplateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRepositoriesForApprovalRuleTemplateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_repositories_for_approval_rule_template::de_list_repositories_for_approval_rule_template_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_repositories_for_approval_rule_template::de_list_repositories_for_approval_rule_template_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRepositoriesForApprovalRuleTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_repositories_for_approval_rule_template::ser_list_repositories_for_approval_rule_template_input(
                &input,
            )?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_repositories_for_approval_rule_template::ListRepositoriesForApprovalRuleTemplateError
{
