...
impl ListApprovalRuleTemplatesInput {
    /// Consumes the builder and constructs an Operation<[`ListApprovalRuleTemplates`](crate::operation::list_approval_rule_templates::ListApprovalRuleTemplates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_approval_rule_templates::ser_list_approval_rule_templates_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_approval_rule_templates::ListApprovalRuleTemplates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListApprovalRuleTemplates", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListApprovalRuleTemplates {
                type Output = std::result::Result<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesOutput, crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError>;
