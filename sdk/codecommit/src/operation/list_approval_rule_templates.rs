...
impl ListApprovalRuleTemplatesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_approval_rule_templates::ListApprovalRuleTemplates::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListApprovalRuleTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_approval_rule_templates::de_list_approval_rule_templates_http_response_with_props(status, headers, body)
        }
    }
}
