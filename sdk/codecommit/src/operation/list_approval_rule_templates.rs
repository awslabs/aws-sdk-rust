...
/// Orchestration and serialization glue logic for `ListApprovalRuleTemplates`.
...
impl ListApprovalRuleTemplates {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesInput,
                    ) -> ::std::result::Result<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListApprovalRuleTemplates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListApprovalRuleTemplates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListApprovalRuleTemplatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListApprovalRuleTemplatesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListApprovalRuleTemplates")
...
.with_interceptor(ListApprovalRuleTemplatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError>::new());
...
#[derive(Debug)]
            struct ListApprovalRuleTemplatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListApprovalRuleTemplatesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_approval_rule_templates::de_list_approval_rule_templates_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_approval_rule_templates::de_list_approval_rule_templates_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListApprovalRuleTemplatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListApprovalRuleTemplatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_approval_rule_templates::ser_list_approval_rule_templates_input(&input)?);
...
#[derive(Debug)]
            struct ListApprovalRuleTemplatesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListApprovalRuleTemplatesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListApprovalRuleTemplatesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListApprovalRuleTemplatesInput>()
                        .ok_or("failed to downcast to ListApprovalRuleTemplatesInput")?;
...
pub enum ListApprovalRuleTemplatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListApprovalRuleTemplatesError) for what information is available for the error.")]
...
impl ListApprovalRuleTemplatesError {
    /// Creates the `ListApprovalRuleTemplatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListApprovalRuleTemplatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListApprovalRuleTemplatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_approval_rule_templates::ListApprovalRuleTemplatesError {
...
mod _list_approval_rule_templates_output;
