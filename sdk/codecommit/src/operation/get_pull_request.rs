...
impl GetPullRequestInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_pull_request::GetPullRequest, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_pull_request::ser_get_pull_request_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPullRequest {
    type Output =
        ::std::result::Result<crate::operation::get_pull_request::GetPullRequestOutput, crate::operation::get_pull_request::GetPullRequestError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_pull_request::de_get_pull_request_http_response_with_props(status, headers, body)
        }
    }
}
