...
impl GetPullRequestInput {
    /// Consumes the builder and constructs an Operation<[`GetPullRequest`](crate::operation::get_pull_request::GetPullRequest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_pull_request::GetPullRequest, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_pull_request::GetPullRequestInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_pull_request::ser_get_pull_request_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_pull_request::GetPullRequest::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPullRequest", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPullRequest {
                type Output = std::result::Result<crate::operation::get_pull_request::GetPullRequestOutput, crate::operation::get_pull_request::GetPullRequestError>;
