...
impl GetCommentsForPullRequestInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_comments_for_pull_request::GetCommentsForPullRequest::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestError
{
