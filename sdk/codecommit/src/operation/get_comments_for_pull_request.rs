...
impl GetCommentsForPullRequestInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_comments_for_pull_request::GetCommentsForPullRequest::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCommentsForPullRequest {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_comments_for_pull_request::de_get_comments_for_pull_request_http_response_with_props(
                status, headers, body,
            )
        }
    }
