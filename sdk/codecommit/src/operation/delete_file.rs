...
impl DeleteFileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_file::DeleteFile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_file::de_delete_file_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_file::de_delete_file_http_response_with_props(
                status, headers, body,
            )
        }
    }
