...
impl BatchDisassociateApprovalRuleTemplateFromRepositories {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "BatchDisassociateApprovalRuleTemplateFromRepositories",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDisassociateApprovalRuleTemplateFromRepositories {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchDisassociateApprovalRuleTemplateFromRepositories")
                .build()
    ...
    fn runtime_components(
        ...
        .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            BatchDisassociateApprovalRuleTemplateFromRepositoriesTelemetryInputCaptureInterceptor,
        ))
        .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchDisassociateApprovalRuleTemplateFromRepositoriesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for BatchDisassociateApprovalRuleTemplateFromRepositoriesTelemetryInputCaptureInterceptor
{
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDisassociateApprovalRuleTemplateFromRepositoriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_disassociate_approval_rule_template_from_repositories::de_batch_disassociate_approval_rule_template_from_repositories_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_disassociate_approval_rule_template_from_repositories::de_batch_disassociate_approval_rule_template_from_repositories_http_response(status, headers, body, _cfg)
        };
