...
impl DeleteApprovalRuleTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplate,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApprovalRuleTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_approval_rule_template::de_delete_approval_rule_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
