...
impl DeleteApprovalRuleTemplateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteApprovalRuleTemplate`](crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_approval_rule_template::ser_delete_approval_rule_template_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteApprovalRuleTemplate", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteApprovalRuleTemplate {
                type Output = std::result::Result<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateOutput, crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError>;
