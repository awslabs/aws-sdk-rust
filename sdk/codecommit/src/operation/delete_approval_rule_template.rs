...
/// Orchestration and serialization glue logic for `DeleteApprovalRuleTemplate`.
...
impl DeleteApprovalRuleTemplate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateInput,
                    ) -> ::std::result::Result<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteApprovalRuleTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteApprovalRuleTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteApprovalRuleTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteApprovalRuleTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteApprovalRuleTemplate")
...
.with_interceptor(DeleteApprovalRuleTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError>::new());
...
#[derive(Debug)]
            struct DeleteApprovalRuleTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteApprovalRuleTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_approval_rule_template::de_delete_approval_rule_template_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_approval_rule_template::de_delete_approval_rule_template_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteApprovalRuleTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteApprovalRuleTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_approval_rule_template::ser_delete_approval_rule_template_input(&input)?);
...
#[derive(Debug)]
            struct DeleteApprovalRuleTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteApprovalRuleTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteApprovalRuleTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteApprovalRuleTemplateInput>()
                        .ok_or("failed to downcast to DeleteApprovalRuleTemplateInput")?;
...
pub enum DeleteApprovalRuleTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteApprovalRuleTemplateError) for what information is available for the error.")]
...
impl DeleteApprovalRuleTemplateError {
    /// Creates the `DeleteApprovalRuleTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteApprovalRuleTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ApprovalRuleTemplateInUseException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteApprovalRuleTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_approval_rule_template::DeleteApprovalRuleTemplateError {
...
mod _delete_approval_rule_template_output;
