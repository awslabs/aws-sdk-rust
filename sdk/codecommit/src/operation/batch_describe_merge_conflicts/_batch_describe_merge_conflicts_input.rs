...
impl BatchDescribeMergeConflictsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsInput, ::aws_smithy_types::error::operation::BuildError> {
