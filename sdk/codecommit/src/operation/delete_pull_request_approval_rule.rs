...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePullRequestApprovalRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_pull_request_approval_rule::de_delete_pull_request_approval_rule_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError
{
