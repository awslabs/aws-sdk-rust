...
impl DeletePullRequestApprovalRule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeletePullRequestApprovalRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeletePullRequestApprovalRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeletePullRequestApprovalRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeletePullRequestApprovalRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeletePullRequestApprovalRule")
...
.with_interceptor(DeletePullRequestApprovalRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError>::new());
...
#[derive(Debug)]
            struct DeletePullRequestApprovalRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeletePullRequestApprovalRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_pull_request_approval_rule::de_delete_pull_request_approval_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_pull_request_approval_rule::de_delete_pull_request_approval_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeletePullRequestApprovalRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeletePullRequestApprovalRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_pull_request_approval_rule::ser_delete_pull_request_approval_rule_input(&input)?);
...
#[derive(Debug)]
            struct DeletePullRequestApprovalRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeletePullRequestApprovalRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeletePullRequestApprovalRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeletePullRequestApprovalRuleInput>()
                        .ok_or("failed to downcast to DeletePullRequestApprovalRuleInput")?;
...
pub enum DeletePullRequestApprovalRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeletePullRequestApprovalRuleError) for what information is available for the error.")]
...
impl DeletePullRequestApprovalRuleError {
    /// Creates the `DeletePullRequestApprovalRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeletePullRequestApprovalRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ApprovalRuleNameRequiredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::CannotDeleteApprovalRuleFromTemplateException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::InvalidApprovalRuleNameException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeletePullRequestApprovalRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleError {
