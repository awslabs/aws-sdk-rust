...
impl ListPullRequestsInput {
    /// Consumes the builder and constructs an Operation<[`ListPullRequests`](crate::operation::list_pull_requests::ListPullRequests)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_pull_requests::ser_list_pull_requests_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_pull_requests::ListPullRequests::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPullRequests", "codecommit"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPullRequests {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pull_requests::de_list_pull_requests_http_response_with_props(status, headers, body)
        }
    }
}
