...
impl ListPullRequestsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_pull_requests::ListPullRequests, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_pull_requests::ListPullRequestsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_pull_requests::ser_list_pull_requests_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for ListPullRequests {
                type Output = std::result::Result<crate::operation::list_pull_requests::ListPullRequestsOutput, crate::operation::list_pull_requests::ListPullRequestsError>;
