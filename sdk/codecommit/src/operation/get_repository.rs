...
impl GetRepositoryInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_repository::GetRepository, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_repository::GetRepositoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_repository::GetRepository::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRepository", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRepository {
                type Output = std::result::Result<crate::operation::get_repository::GetRepositoryOutput, crate::operation::get_repository::GetRepositoryError>;
