...
impl GetRepositoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_repository::GetRepository, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_repository::ser_get_repository_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRepository {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_repository::de_get_repository_http_response_with_props(status, headers, body)
        }
    }
}
