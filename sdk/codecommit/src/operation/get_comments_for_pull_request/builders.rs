...
impl GetCommentsForPullRequestFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestOutput, crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestError, Self> {
