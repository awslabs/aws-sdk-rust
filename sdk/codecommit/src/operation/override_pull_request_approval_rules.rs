...
impl OverridePullRequestApprovalRulesInput {
    /// Consumes the builder and constructs an Operation<[`OverridePullRequestApprovalRules`](crate::operation::override_pull_request_approval_rules::OverridePullRequestApprovalRules)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::override_pull_request_approval_rules::OverridePullRequestApprovalRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for OverridePullRequestApprovalRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_override_pull_request_approval_rules::de_override_pull_request_approval_rules_http_response_with_props(
                status, headers, body,
            )
        }
    }
