...
pub use crate::operation::merge_pull_request_by_squash::_merge_pull_request_by_squash_output::MergePullRequestBySquashOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashOutput,
                    crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashError,
                > for MergePullRequestBySquashFluentBuilder
            {
                fn send(
                    self,
...
impl MergePullRequestBySquashFluentBuilder {
    ...
    /// Access the MergePullRequestBySquash as a reference.
    pub fn as_input(&self) -> &crate::operation::merge_pull_request_by_squash::builders::MergePullRequestBySquashInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::merge_pull_request_by_squash::MergePullRequestBySquash::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashOutput, crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashError, Self> {
