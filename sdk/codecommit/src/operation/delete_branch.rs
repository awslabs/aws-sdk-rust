...
impl DeleteBranchInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBranch`](crate::operation::delete_branch::DeleteBranch)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_branch::DeleteBranch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_branch::ser_delete_branch_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_branch::DeleteBranch::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteBranch", "codecommit"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBranch {
    type Output = ::std::result::Result<crate::operation::delete_branch::DeleteBranchOutput, crate::operation::delete_branch::DeleteBranchError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_branch::de_delete_branch_http_response_with_props(status, headers, body)
        }
    }
}
