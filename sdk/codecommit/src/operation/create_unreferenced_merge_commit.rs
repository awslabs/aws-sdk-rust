...
impl CreateUnreferencedMergeCommit {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateUnreferencedMergeCommit",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUnreferencedMergeCommit {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateUnreferencedMergeCommitRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateUnreferencedMergeCommitResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateUnreferencedMergeCommit")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateUnreferencedMergeCommit")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateUnreferencedMergeCommitTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateUnreferencedMergeCommitTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateUnreferencedMergeCommitTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateUnreferencedMergeCommitInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateUnreferencedMergeCommitResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_unreferenced_merge_commit::de_create_unreferenced_merge_commit_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_unreferenced_merge_commit::de_create_unreferenced_merge_commit_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateUnreferencedMergeCommitRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_unreferenced_merge_commit::ser_create_unreferenced_merge_commit_input(&input)?,
        );
