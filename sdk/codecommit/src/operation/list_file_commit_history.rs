...
impl ListFileCommitHistory {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_file_commit_history::ListFileCommitHistoryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_file_commit_history::ListFileCommitHistoryOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeCommit", "ListFileCommitHistory", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CodeCommit.ListFileCommitHistory",
                "rpc.service" = "CodeCommit",
                "rpc.method" = "ListFileCommitHistory",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFileCommitHistory {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListFileCommitHistoryRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListFileCommitHistoryResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListFileCommitHistory")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListFileCommitHistory")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListFileCommitHistoryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListFileCommitHistoryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFileCommitHistoryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListFileCommitHistoryInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFileCommitHistoryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_file_commit_history::de_list_file_commit_history_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_file_commit_history::de_list_file_commit_history_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFileCommitHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_file_commit_history::ListFileCommitHistoryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_file_commit_history::ListFileCommitHistoryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_file_commit_history::ser_list_file_commit_history_input(&input)?,
        );
