...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListFileCommitHistoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListFileCommitHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_file_commit_history::ser_list_file_commit_history_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListFileCommitHistoryEndpointParamsInterceptor {
...
pub type ListFileCommitHistoryErrorKind = ListFileCommitHistoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListFileCommitHistoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_file_commit_history::ListFileCommitHistoryError {
...
impl ListFileCommitHistoryError {
    ...
    /// Creates the `ListFileCommitHistoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
