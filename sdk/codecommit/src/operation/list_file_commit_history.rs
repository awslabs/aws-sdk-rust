...
/// Orchestration and serialization glue logic for `ListFileCommitHistory`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListFileCommitHistory;
impl ListFileCommitHistory {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_file_commit_history::ListFileCommitHistoryInput,
                    ) -> ::std::result::Result<crate::operation::list_file_commit_history::ListFileCommitHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_file_commit_history::ListFileCommitHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_file_commit_history::ListFileCommitHistoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_file_commit_history::ListFileCommitHistoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListFileCommitHistory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListFileCommitHistory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListFileCommitHistoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListFileCommitHistoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListFileCommitHistory")
...
.with_interceptor(ListFileCommitHistoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_file_commit_history::ListFileCommitHistoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_file_commit_history::ListFileCommitHistoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_file_commit_history::ListFileCommitHistoryError>::new());
...
#[derive(Debug)]
            struct ListFileCommitHistoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListFileCommitHistoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_file_commit_history::de_list_file_commit_history_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_file_commit_history::de_list_file_commit_history_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListFileCommitHistoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListFileCommitHistoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_file_commit_history::ListFileCommitHistoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_file_commit_history::ListFileCommitHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                        ...
                        "CodeCommit_20150413.ListFileCommitHistory"
                    );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_file_commit_history::ser_list_file_commit_history_input(&input)?);
...
#[derive(Debug)]
            struct ListFileCommitHistoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListFileCommitHistoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListFileCommitHistoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListFileCommitHistoryInput>()
                        .ok_or("failed to downcast to ListFileCommitHistoryInput")?;
...
/// Error type for the `ListFileCommitHistoryError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListFileCommitHistoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListFileCommitHistoryError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListFileCommitHistoryError {
    /// Creates the `ListFileCommitHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListFileCommitHistoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListFileCommitHistoryError::CommitDoesNotExistException`.
    pub fn is_commit_does_not_exist_exception(&self) -> bool {
        matches!(self, Self::CommitDoesNotExistException(_))
    }
    /// Returns `true` if the error kind is `ListFileCommitHistoryError::CommitRequiredException`.
    pub fn is_commit_required_exception(&self) -> bool {
        matches!(self, Self::CommitRequiredException(_))
    }
    /// Returns `true` if the error kind is `ListFileCommitHistoryError::EncryptionIntegrityChecksFailedException`.
...
impl ::std::fmt::Display for ListFileCommitHistoryError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListFileCommitHistoryError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListFileCommitHistoryError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListFileCommitHistoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_file_commit_history::ListFileCommitHistoryError {
...
mod _list_file_commit_history_output;
