...
impl GetPullRequestApprovalStatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStatesInput, ::aws_smithy_types::error::operation::BuildError> {
