...
impl crate::operation::get_pull_request_approval_states::builders::GetPullRequestApprovalStatesInputBuilder {
...
impl GetPullRequestApprovalStatesFluentBuilder {
    /// Creates a new `GetPullRequestApprovalStatesFluentBuilder`.
