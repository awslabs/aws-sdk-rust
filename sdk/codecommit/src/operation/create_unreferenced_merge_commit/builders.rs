...
impl CreateUnreferencedMergeCommitFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitOutput, crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitError, Self> {
