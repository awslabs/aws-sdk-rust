...
impl CreateUnreferencedMergeCommitInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::create_unreferenced_merge_commit::CreateUnreferencedMergeCommitInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
