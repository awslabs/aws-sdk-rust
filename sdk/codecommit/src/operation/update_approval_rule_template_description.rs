...
impl UpdateApprovalRuleTemplateDescription {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateApprovalRuleTemplateDescription",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApprovalRuleTemplateDescription {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateApprovalRuleTemplateDescriptionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateApprovalRuleTemplateDescriptionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateApprovalRuleTemplateDescription")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateApprovalRuleTemplateDescription")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateApprovalRuleTemplateDescriptionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateApprovalRuleTemplateDescriptionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateApprovalRuleTemplateDescriptionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateApprovalRuleTemplateDescriptionInput>() else {
        ...
        if requested.should_capture("approvalRuleTemplateDescription") {
            if let ::std::option::Option::Some(value) = input.approval_rule_template_description.as_deref() {
                captured.insert("approvalRuleTemplateDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateApprovalRuleTemplateDescriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_approval_rule_template_description::de_update_approval_rule_template_description_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_approval_rule_template_description::de_update_approval_rule_template_description_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateApprovalRuleTemplateDescriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_approval_rule_template_description::ser_update_approval_rule_template_description_input(&input)?,
        );
