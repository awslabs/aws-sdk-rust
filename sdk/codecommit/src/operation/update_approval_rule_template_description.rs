...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApprovalRuleTemplateDescription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_approval_rule_template_description::de_update_approval_rule_template_description_http_response_with_props(status, headers, body)
        }
    }
}
