...
impl GetCommentReactionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_comment_reactions::GetCommentReactionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_comment_reactions::GetCommentReactionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_comment_reactions::GetCommentReactionsOutput, crate::operation::get_comment_reactions::GetCommentReactionsError, Self> {
