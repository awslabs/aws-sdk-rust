...
impl crate::operation::merge_branches_by_fast_forward::builders::MergeBranchesByFastForwardInputBuilder {
...
impl MergeBranchesByFastForwardFluentBuilder {
    /// Creates a new `MergeBranchesByFastForwardFluentBuilder`.
