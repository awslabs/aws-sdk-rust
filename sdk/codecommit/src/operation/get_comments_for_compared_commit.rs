...
impl GetCommentsForComparedCommit {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetCommentsForComparedCommit",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCommentsForComparedCommit {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetCommentsForComparedCommitRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetCommentsForComparedCommitResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetCommentsForComparedCommit")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCommentsForComparedCommit")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetCommentsForComparedCommitTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetCommentsForComparedCommitTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCommentsForComparedCommitTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetCommentsForComparedCommitInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCommentsForComparedCommitResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_comments_for_compared_commit::de_get_comments_for_compared_commit_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_comments_for_compared_commit::de_get_comments_for_compared_commit_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCommentsForComparedCommitRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_comments_for_compared_commit::ser_get_comments_for_compared_commit_input(&input)?,
        );
