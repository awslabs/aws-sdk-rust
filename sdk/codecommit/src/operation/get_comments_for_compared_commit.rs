...
impl GetCommentsForComparedCommit {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCommentsForComparedCommit {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCommentsForComparedCommit");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCommentsForComparedCommitRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCommentsForComparedCommitResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCommentsForComparedCommit")
...
.with_interceptor(GetCommentsForComparedCommitEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError>::new());
...
#[derive(Debug)]
            struct GetCommentsForComparedCommitResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCommentsForComparedCommitResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_comments_for_compared_commit::de_get_comments_for_compared_commit_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCommentsForComparedCommitRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCommentsForComparedCommitRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_comments_for_compared_commit::ser_get_comments_for_compared_commit_input(&input)?);
...
#[derive(Debug)]
            struct GetCommentsForComparedCommitEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCommentsForComparedCommitEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCommentsForComparedCommitEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCommentsForComparedCommitInput>()
                        .ok_or("failed to downcast to GetCommentsForComparedCommitInput")?;
...
pub enum GetCommentsForComparedCommitError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCommentsForComparedCommitError) for what information is available for the error.")]
...
impl GetCommentsForComparedCommitError {
    /// Creates the `GetCommentsForComparedCommitError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCommentsForComparedCommitError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCommentsForComparedCommitError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError {
