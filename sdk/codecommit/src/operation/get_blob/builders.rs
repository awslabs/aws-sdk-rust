...
impl crate::operation::get_blob::builders::GetBlobInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_blob::GetBlobOutput, crate::operation::get_blob::GetBlobError>
    for GetBlobFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::get_blob::GetBlobOutput, crate::operation::get_blob::GetBlobError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetBlobFluentBuilder {
    /// Creates a new `GetBlobFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_blob::GetBlob::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_blob::GetBlob::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_blob::GetBlobOutput, crate::operation::get_blob::GetBlobError, Self>
    {
