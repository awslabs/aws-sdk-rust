...
impl UpdateRepositoryNameInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRepositoryName`](crate::operation::update_repository_name::UpdateRepositoryName)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_repository_name::UpdateRepositoryName, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_repository_name::UpdateRepositoryNameInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_repository_name::ser_update_repository_name_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_repository_name::UpdateRepositoryName::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateRepositoryName", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateRepositoryName {
                type Output = std::result::Result<crate::operation::update_repository_name::UpdateRepositoryNameOutput, crate::operation::update_repository_name::UpdateRepositoryNameError>;
