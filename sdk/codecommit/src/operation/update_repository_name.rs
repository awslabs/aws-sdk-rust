...
impl UpdateRepositoryNameInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_repository_name::ser_update_repository_name_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_repository_name::UpdateRepositoryName::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_repository_name::UpdateRepositoryNameError
{
