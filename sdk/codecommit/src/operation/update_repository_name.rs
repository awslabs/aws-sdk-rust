...
/// Orchestration and serialization glue logic for `UpdateRepositoryName`.
...
impl UpdateRepositoryName {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_repository_name::UpdateRepositoryNameOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_repository_name::UpdateRepositoryNameError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_repository_name::UpdateRepositoryNameError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_repository_name::UpdateRepositoryNameOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRepositoryName {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateRepositoryName");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateRepositoryNameRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateRepositoryNameResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRepositoryName")
...
.with_interceptor(UpdateRepositoryNameEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_repository_name::UpdateRepositoryNameError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_repository_name::UpdateRepositoryNameError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_repository_name::UpdateRepositoryNameError>::new());
...
#[derive(Debug)]
            struct UpdateRepositoryNameResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRepositoryNameResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_repository_name::de_update_repository_name_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateRepositoryNameRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRepositoryNameRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_repository_name::UpdateRepositoryNameInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_repository_name::UpdateRepositoryNameInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_repository_name::ser_update_repository_name_input(&input)?);
...
#[derive(Debug)]
            struct UpdateRepositoryNameEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRepositoryNameEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateRepositoryNameEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateRepositoryNameInput>()
                        .ok_or("failed to downcast to UpdateRepositoryNameInput")?;
...
pub enum UpdateRepositoryNameError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateRepositoryNameError) for what information is available for the error.")]
...
impl UpdateRepositoryNameError {
    /// Creates the `UpdateRepositoryNameError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateRepositoryNameError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateRepositoryNameError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_repository_name::UpdateRepositoryNameError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_repository_name::_update_repository_name_output::UpdateRepositoryNameOutput;

pub use crate::operation::update_repository_name::_update_repository_name_input::UpdateRepositoryNameInput;

mod _update_repository_name_input;

mod _update_repository_name_output;
