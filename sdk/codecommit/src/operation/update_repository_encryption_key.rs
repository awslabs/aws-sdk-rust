...
/// Orchestration and serialization glue logic for `UpdateRepositoryEncryptionKey`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateRepositoryEncryptionKey;
impl UpdateRepositoryEncryptionKey {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRepositoryEncryptionKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateRepositoryEncryptionKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateRepositoryEncryptionKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateRepositoryEncryptionKeyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRepositoryEncryptionKey")
...
.with_interceptor(UpdateRepositoryEncryptionKeyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyError>::new());
...
#[derive(Debug)]
            struct UpdateRepositoryEncryptionKeyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRepositoryEncryptionKeyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_repository_encryption_key::de_update_repository_encryption_key_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_repository_encryption_key::de_update_repository_encryption_key_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateRepositoryEncryptionKeyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRepositoryEncryptionKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                        ...
                        "CodeCommit_20150413.UpdateRepositoryEncryptionKey"
                    );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_repository_encryption_key::ser_update_repository_encryption_key_input(&input)?);
...
#[derive(Debug)]
            struct UpdateRepositoryEncryptionKeyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRepositoryEncryptionKeyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateRepositoryEncryptionKeyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateRepositoryEncryptionKeyInput>()
                        .ok_or("failed to downcast to UpdateRepositoryEncryptionKeyInput")?;
...
/// Error type for the `UpdateRepositoryEncryptionKeyError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateRepositoryEncryptionKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateRepositoryEncryptionKeyError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateRepositoryEncryptionKeyError {
    /// Creates the `UpdateRepositoryEncryptionKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateRepositoryEncryptionKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::EncryptionKeyRequiredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionIntegrityChecksFailedException`.
    ...
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyAccessDeniedException`.
    pub fn is_encryption_key_access_denied_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyAccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyDisabledException`.
    pub fn is_encryption_key_disabled_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyDisabledException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyInvalidIdException`.
    pub fn is_encryption_key_invalid_id_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyInvalidIdException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyInvalidUsageException`.
    pub fn is_encryption_key_invalid_usage_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyInvalidUsageException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyNotFoundException`.
    pub fn is_encryption_key_not_found_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyRequiredException`.
    pub fn is_encryption_key_required_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyRequiredException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::EncryptionKeyUnavailableException`.
    pub fn is_encryption_key_unavailable_exception(&self) -> bool {
        matches!(self, Self::EncryptionKeyUnavailableException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::InvalidRepositoryNameException`.
    pub fn is_invalid_repository_name_exception(&self) -> bool {
        matches!(self, Self::InvalidRepositoryNameException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::RepositoryDoesNotExistException`.
    pub fn is_repository_does_not_exist_exception(&self) -> bool {
        matches!(self, Self::RepositoryDoesNotExistException(_))
    }
    /// Returns `true` if the error kind is `UpdateRepositoryEncryptionKeyError::RepositoryNameRequiredException`.
    pub fn is_repository_name_required_exception(&self) -> bool {
        matches!(self, Self::RepositoryNameRequiredException(_))
    }
}
impl ::std::error::Error for UpdateRepositoryEncryptionKeyError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::EncryptionKeyRequiredException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::std::fmt::Display for UpdateRepositoryEncryptionKeyError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateRepositoryEncryptionKeyError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateRepositoryEncryptionKeyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateRepositoryEncryptionKeyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_repository_encryption_key::UpdateRepositoryEncryptionKeyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_repository_encryption_key::_update_repository_encryption_key_output::UpdateRepositoryEncryptionKeyOutput;

pub use crate::operation::update_repository_encryption_key::_update_repository_encryption_key_input::UpdateRepositoryEncryptionKeyInput;

mod _update_repository_encryption_key_input;

mod _update_repository_encryption_key_output;
