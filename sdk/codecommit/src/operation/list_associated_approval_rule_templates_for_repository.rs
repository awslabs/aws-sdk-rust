    ...
    for ListAssociatedApprovalRuleTemplatesForRepository
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_associated_approval_rule_templates_for_repository::de_list_associated_approval_rule_templates_for_repository_http_response_with_props(status, headers, body)
        }
    }
}
