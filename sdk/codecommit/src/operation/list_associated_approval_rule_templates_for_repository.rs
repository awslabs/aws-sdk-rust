...
impl ListAssociatedApprovalRuleTemplatesForRepository {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListAssociatedApprovalRuleTemplatesForRepository",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssociatedApprovalRuleTemplatesForRepository {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAssociatedApprovalRuleTemplatesForRepositoryRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAssociatedApprovalRuleTemplatesForRepositoryResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAssociatedApprovalRuleTemplatesForRepository")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssociatedApprovalRuleTemplatesForRepository")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    ListAssociatedApprovalRuleTemplatesForRepositoryTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListAssociatedApprovalRuleTemplatesForRepositoryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssociatedApprovalRuleTemplatesForRepositoryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListAssociatedApprovalRuleTemplatesForRepositoryInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssociatedApprovalRuleTemplatesForRepositoryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_associated_approval_rule_templates_for_repository::de_list_associated_approval_rule_templates_for_repository_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_associated_approval_rule_templates_for_repository::de_list_associated_approval_rule_templates_for_repository_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssociatedApprovalRuleTemplatesForRepositoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryError
{
