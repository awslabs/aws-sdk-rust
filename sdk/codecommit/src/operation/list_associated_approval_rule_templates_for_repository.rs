    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssociatedApprovalRuleTemplatesForRepository {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssociatedApprovalRuleTemplatesForRepository");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssociatedApprovalRuleTemplatesForRepositoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssociatedApprovalRuleTemplatesForRepositoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssociatedApprovalRuleTemplatesForRepository")
...
.with_interceptor(ListAssociatedApprovalRuleTemplatesForRepositoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryError>::new());
...
#[derive(Debug)]
            struct ListAssociatedApprovalRuleTemplatesForRepositoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssociatedApprovalRuleTemplatesForRepositoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_associated_approval_rule_templates_for_repository::de_list_associated_approval_rule_templates_for_repository_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_associated_approval_rule_templates_for_repository::de_list_associated_approval_rule_templates_for_repository_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAssociatedApprovalRuleTemplatesForRepositoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssociatedApprovalRuleTemplatesForRepositoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_associated_approval_rule_templates_for_repository::ser_list_associated_approval_rule_templates_for_repository_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssociatedApprovalRuleTemplatesForRepositoryEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssociatedApprovalRuleTemplatesForRepositoryInput>()
                        .ok_or("failed to downcast to ListAssociatedApprovalRuleTemplatesForRepositoryInput")?;
...
pub enum ListAssociatedApprovalRuleTemplatesForRepositoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssociatedApprovalRuleTemplatesForRepositoryError) for what information is available for the error.")]
...
impl ListAssociatedApprovalRuleTemplatesForRepositoryError {
    /// Creates the `ListAssociatedApprovalRuleTemplatesForRepositoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssociatedApprovalRuleTemplatesForRepositoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListAssociatedApprovalRuleTemplatesForRepositoryError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAssociatedApprovalRuleTemplatesForRepositoryError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssociatedApprovalRuleTemplatesForRepositoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_associated_approval_rule_templates_for_repository::ListAssociatedApprovalRuleTemplatesForRepositoryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_associated_approval_rule_templates_for_repository::_list_associated_approval_rule_templates_for_repository_output::ListAssociatedApprovalRuleTemplatesForRepositoryOutput;

pub use crate::operation::list_associated_approval_rule_templates_for_repository::_list_associated_approval_rule_templates_for_repository_input::ListAssociatedApprovalRuleTemplatesForRepositoryInput;

mod _list_associated_approval_rule_templates_for_repository_input;

mod _list_associated_approval_rule_templates_for_repository_output;
