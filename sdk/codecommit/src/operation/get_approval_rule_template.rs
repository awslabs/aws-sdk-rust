...
impl GetApprovalRuleTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetApprovalRuleTemplate`](crate::operation::get_approval_rule_template::GetApprovalRuleTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_approval_rule_template::GetApprovalRuleTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_approval_rule_template::GetApprovalRuleTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_approval_rule_template::ser_get_approval_rule_template_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_approval_rule_template::GetApprovalRuleTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetApprovalRuleTemplate", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetApprovalRuleTemplate {
                type Output = std::result::Result<crate::operation::get_approval_rule_template::GetApprovalRuleTemplateOutput, crate::operation::get_approval_rule_template::GetApprovalRuleTemplateError>;
