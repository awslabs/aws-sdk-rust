...
impl GetDifferencesInput {
    /// Consumes the builder and constructs an Operation<[`GetDifferences`](crate::operation::get_differences::GetDifferences)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_differences::GetDifferences, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_differences::GetDifferencesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_differences::ser_get_differences_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_differences::GetDifferences::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDifferences", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDifferences {
                type Output = std::result::Result<crate::operation::get_differences::GetDifferencesOutput, crate::operation::get_differences::GetDifferencesError>;
