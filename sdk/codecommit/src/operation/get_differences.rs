...
impl GetDifferences {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_differences::GetDifferencesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_differences::GetDifferencesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeCommit", "GetDifferences", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CodeCommit.GetDifferences",
                "rpc.service" = "CodeCommit",
                "rpc.method" = "GetDifferences",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDifferences {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDifferencesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDifferencesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDifferences")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDifferences")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetDifferencesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetDifferencesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDifferencesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetDifferencesInput>() else {
        ...
        if requested.should_capture("beforeCommitSpecifier") {
            if let ::std::option::Option::Some(value) = input.before_commit_specifier.as_deref() {
                captured.insert("beforeCommitSpecifier", value);
            }
        }
        if requested.should_capture("afterCommitSpecifier") {
            if let ::std::option::Option::Some(value) = input.after_commit_specifier.as_deref() {
                captured.insert("afterCommitSpecifier", value);
            }
        }
        if requested.should_capture("beforePath") {
            if let ::std::option::Option::Some(value) = input.before_path.as_deref() {
                captured.insert("beforePath", value);
            }
        }
        if requested.should_capture("afterPath") {
            if let ::std::option::Option::Some(value) = input.after_path.as_deref() {
                captured.insert("afterPath", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDifferencesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_differences::de_get_differences_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_differences::de_get_differences_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDifferencesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_differences::GetDifferencesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_differences::GetDifferencesInput,
