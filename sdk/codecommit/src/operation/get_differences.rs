...
impl GetDifferencesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_differences::GetDifferences, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_differences::ser_get_differences_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDifferences {
    type Output =
        ::std::result::Result<crate::operation::get_differences::GetDifferencesOutput, crate::operation::get_differences::GetDifferencesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_differences::de_get_differences_http_response_with_props(status, headers, body)
        }
    }
}
