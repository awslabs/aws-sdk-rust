...
impl PostCommentForPullRequestFluentBuilder  {
    /// Creates a new `PostCommentForPullRequest`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::post_comment_for_pull_request::PostCommentForPullRequest, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::post_comment_for_pull_request::PostCommentForPullRequestError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::post_comment_for_pull_request::PostCommentForPullRequestOutput, aws_smithy_http::result::SdkError<crate::operation::post_comment_for_pull_request::PostCommentForPullRequestError>>
                     {
