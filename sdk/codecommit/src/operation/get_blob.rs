...
impl GetBlobInput {
    /// Consumes the builder and constructs an Operation<[`GetBlob`](crate::operation::get_blob::GetBlob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_blob::GetBlob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_blob::GetBlobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_blob::ser_get_blob_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_blob::GetBlob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBlob", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBlob {
                type Output = std::result::Result<crate::operation::get_blob::GetBlobOutput, crate::operation::get_blob::GetBlobError>;
