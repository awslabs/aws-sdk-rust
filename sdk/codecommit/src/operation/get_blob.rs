...
impl GetBlobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_blob::GetBlob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_blob::ser_get_blob_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_blob::de_get_blob_http_response_with_props(status, headers, body)
        }
    }
}
