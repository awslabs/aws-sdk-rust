...
impl BatchDescribeMergeConflicts {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDescribeMergeConflicts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDescribeMergeConflicts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDescribeMergeConflictsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDescribeMergeConflictsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDescribeMergeConflicts")
...
.with_interceptor(BatchDescribeMergeConflictsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError>::new());
...
#[derive(Debug)]
            struct BatchDescribeMergeConflictsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDescribeMergeConflictsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_describe_merge_conflicts::de_batch_describe_merge_conflicts_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_describe_merge_conflicts::de_batch_describe_merge_conflicts_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchDescribeMergeConflictsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDescribeMergeConflictsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_describe_merge_conflicts::ser_batch_describe_merge_conflicts_input(&input)?);
...
#[derive(Debug)]
            struct BatchDescribeMergeConflictsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDescribeMergeConflictsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchDescribeMergeConflictsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDescribeMergeConflictsInput>()
                        .ok_or("failed to downcast to BatchDescribeMergeConflictsInput")?;
...
pub enum BatchDescribeMergeConflictsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDescribeMergeConflictsError) for what information is available for the error.")]
...
impl BatchDescribeMergeConflictsError {
    /// Creates the `BatchDescribeMergeConflictsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDescribeMergeConflictsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDescribeMergeConflictsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::batch_describe_merge_conflicts::_batch_describe_merge_conflicts_output::BatchDescribeMergeConflictsOutput;

pub use crate::operation::batch_describe_merge_conflicts::_batch_describe_merge_conflicts_input::BatchDescribeMergeConflictsInput;

mod _batch_describe_merge_conflicts_input;

mod _batch_describe_merge_conflicts_output;
