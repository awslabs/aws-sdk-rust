...
impl BatchDescribeMergeConflictsInput {
    /// Consumes the builder and constructs an Operation<[`BatchDescribeMergeConflicts`](crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflicts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflicts, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_describe_merge_conflicts::ser_batch_describe_merge_conflicts_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflicts::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchDescribeMergeConflicts", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDescribeMergeConflicts {
                type Output = std::result::Result<crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsOutput, crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError>;
