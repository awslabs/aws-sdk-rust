...
impl BatchDescribeMergeConflictsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflicts,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflicts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDescribeMergeConflicts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_describe_merge_conflicts::de_batch_describe_merge_conflicts_http_response_with_props(
                status, headers, body,
            )
        }
    }
