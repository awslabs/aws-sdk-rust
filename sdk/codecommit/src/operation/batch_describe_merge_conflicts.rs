...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDescribeMergeConflicts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_describe_merge_conflicts::de_batch_describe_merge_conflicts_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for BatchDescribeMergeConflictsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_describe_merge_conflicts::BatchDescribeMergeConflictsError
{
