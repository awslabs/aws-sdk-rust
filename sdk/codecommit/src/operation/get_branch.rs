...
impl GetBranchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_branch::GetBranch,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_branch::GetBranch::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBranch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_branch::de_get_branch_http_response_with_props(
                status, headers, body,
            )
        }
    }
