...
impl GetBranchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_branch::GetBranch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_branch::ser_get_branch_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBranch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_branch::de_get_branch_http_response_with_props(status, headers, body)
        }
    }
}
