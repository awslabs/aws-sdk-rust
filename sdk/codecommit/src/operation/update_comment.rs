...
impl UpdateCommentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_comment::UpdateComment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_comment::ser_update_comment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateComment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_comment::de_update_comment_http_response_with_props(status, headers, body)
        }
    }
}
