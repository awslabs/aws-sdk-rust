...
impl DescribePullRequestEventsInput {
    /// Consumes the builder and constructs an Operation<[`DescribePullRequestEvents`](crate::operation::describe_pull_request_events::DescribePullRequestEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_pull_request_events::DescribePullRequestEvents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_pull_request_events::ser_describe_pull_request_events_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_pull_request_events::DescribePullRequestEvents::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePullRequestEvents", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePullRequestEvents {
                type Output = std::result::Result<crate::operation::describe_pull_request_events::DescribePullRequestEventsOutput, crate::operation::describe_pull_request_events::DescribePullRequestEventsError>;
