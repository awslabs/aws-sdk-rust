...
impl DescribePullRequestEventsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_pull_request_events::DescribePullRequestEvents::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_pull_request_events::DescribePullRequestEventsError
{
