...
impl DescribePullRequestEventsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_pull_request_events::DescribePullRequestEvents::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePullRequestEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_pull_request_events::de_describe_pull_request_events_http_response_with_props(status, headers, body)
        }
    }
}
