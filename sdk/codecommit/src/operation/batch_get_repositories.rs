...
impl BatchGetRepositories {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_get_repositories::BatchGetRepositoriesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_get_repositories::BatchGetRepositoriesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeCommit", "BatchGetRepositories", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CodeCommit.BatchGetRepositories",
                "rpc.service" = "CodeCommit",
                "rpc.method" = "BatchGetRepositories",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetRepositories {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchGetRepositoriesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchGetRepositoriesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchGetRepositories")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetRepositoriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_get_repositories::de_batch_get_repositories_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_get_repositories::de_batch_get_repositories_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetRepositoriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_get_repositories::BatchGetRepositoriesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_get_repositories::BatchGetRepositoriesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_get_repositories::ser_batch_get_repositories_input(
            &input,
        )?);
