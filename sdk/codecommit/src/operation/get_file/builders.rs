...
impl crate::operation::get_file::builders::GetFileInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_file::GetFileOutput, crate::operation::get_file::GetFileError>
    for GetFileFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_file::GetFileOutput, crate::operation::get_file::GetFileError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetFileFluentBuilder {
    /// Creates a new `GetFileFluentBuilder`.
