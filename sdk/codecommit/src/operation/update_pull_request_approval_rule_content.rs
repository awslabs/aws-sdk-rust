...
impl UpdatePullRequestApprovalRuleContentInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePullRequestApprovalRuleContent`](crate::operation::update_pull_request_approval_rule_content::UpdatePullRequestApprovalRuleContent)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_pull_request_approval_rule_content::ser_update_pull_request_approval_rule_content_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_pull_request_approval_rule_content::UpdatePullRequestApprovalRuleContent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePullRequestApprovalRuleContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_pull_request_approval_rule_content::de_update_pull_request_approval_rule_content_http_response_with_props(status, headers, body)
        }
    }
}
