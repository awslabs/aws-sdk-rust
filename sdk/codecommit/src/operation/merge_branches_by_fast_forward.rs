...
impl MergeBranchesByFastForward {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "MergeBranchesByFastForward",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("MergeBranchesByFastForward")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MergeBranchesByFastForward")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                MergeBranchesByFastForwardTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct MergeBranchesByFastForwardTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MergeBranchesByFastForwardTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<MergeBranchesByFastForwardInput>() else {
        ...
        if requested.should_capture("sourceCommitSpecifier") {
            if let ::std::option::Option::Some(value) = input.source_commit_specifier.as_deref() {
                captured.insert("sourceCommitSpecifier", value);
            }
        }
        if requested.should_capture("destinationCommitSpecifier") {
            if let ::std::option::Option::Some(value) = input.destination_commit_specifier.as_deref() {
                captured.insert("destinationCommitSpecifier", value);
            }
        }
        if requested.should_capture("targetBranch") {
            if let ::std::option::Option::Some(value) = input.target_branch.as_deref() {
                captured.insert("targetBranch", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MergeBranchesByFastForwardResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_merge_branches_by_fast_forward::de_merge_branches_by_fast_forward_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_merge_branches_by_fast_forward::de_merge_branches_by_fast_forward_http_response(status, headers, body, _cfg)
        };
