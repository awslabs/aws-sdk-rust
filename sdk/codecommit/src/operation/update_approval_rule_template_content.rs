...
impl UpdateApprovalRuleTemplateContentInput {
    /// Consumes the builder and constructs an Operation<[`UpdateApprovalRuleTemplateContent`](crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_approval_rule_template_content::ser_update_approval_rule_template_content_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContent::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateApprovalRuleTemplateContent", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateApprovalRuleTemplateContent {
                type Output = std::result::Result<crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentOutput, crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentError>;
