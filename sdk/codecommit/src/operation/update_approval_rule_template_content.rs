...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApprovalRuleTemplateContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_approval_rule_template_content::de_update_approval_rule_template_content_http_response_with_props(status, headers, body)
        }
    }
}
