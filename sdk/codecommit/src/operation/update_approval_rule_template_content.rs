...
impl UpdateApprovalRuleTemplateContentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContent,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApprovalRuleTemplateContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_approval_rule_template_content::de_update_approval_rule_template_content_http_response_with_props(
                status, headers, body,
            )
        }
    }
