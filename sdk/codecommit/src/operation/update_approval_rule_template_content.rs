...
impl UpdateApprovalRuleTemplateContent {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateApprovalRuleTemplateContent",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApprovalRuleTemplateContent {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateApprovalRuleTemplateContentRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateApprovalRuleTemplateContentResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateApprovalRuleTemplateContent")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateApprovalRuleTemplateContent")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateApprovalRuleTemplateContentTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateApprovalRuleTemplateContentTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateApprovalRuleTemplateContentTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateApprovalRuleTemplateContentInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("approvalRuleTemplateName") {
            if let ::std::option::Option::Some(value) = input.approval_rule_template_name.as_deref() {
                captured.insert("approvalRuleTemplateName", value);
            }
        }
        if requested.should_capture("newRuleContent") {
            if let ::std::option::Option::Some(value) = input.new_rule_content.as_deref() {
                captured.insert("newRuleContent", value);
            }
        }
        if requested.should_capture("existingRuleContentSha256") {
            if let ::std::option::Option::Some(value) = input.existing_rule_content_sha256.as_deref() {
                captured.insert("existingRuleContentSha256", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateApprovalRuleTemplateContentResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_approval_rule_template_content::de_update_approval_rule_template_content_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_approval_rule_template_content::de_update_approval_rule_template_content_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateApprovalRuleTemplateContentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_approval_rule_template_content::UpdateApprovalRuleTemplateContentInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_approval_rule_template_content::ser_update_approval_rule_template_content_input(&input)?,
        );
...
impl ::std::error::Error for UpdateApprovalRuleTemplateContentError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidRuleContentSha256Exception(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateApprovalRuleTemplateContentError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidRuleContentSha256Exception(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
