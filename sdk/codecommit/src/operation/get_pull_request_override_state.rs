...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPullRequestOverrideStateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_pull_request_override_state::de_get_pull_request_override_state_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_pull_request_override_state::de_get_pull_request_override_state_http_response(
