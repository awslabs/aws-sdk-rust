...
impl GetPullRequestOverrideStateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_pull_request_override_state::GetPullRequestOverrideState::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPullRequestOverrideState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_pull_request_override_state::de_get_pull_request_override_state_http_response_with_props(
                status, headers, body,
            )
        }
    }
