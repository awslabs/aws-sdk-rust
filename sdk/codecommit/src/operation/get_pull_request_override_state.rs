...
impl GetPullRequestOverrideStateInput {
    /// Consumes the builder and constructs an Operation<[`GetPullRequestOverrideState`](crate::operation::get_pull_request_override_state::GetPullRequestOverrideState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_pull_request_override_state::GetPullRequestOverrideState, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_pull_request_override_state::GetPullRequestOverrideStateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_pull_request_override_state::ser_get_pull_request_override_state_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_pull_request_override_state::GetPullRequestOverrideState::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPullRequestOverrideState", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPullRequestOverrideState {
                type Output = std::result::Result<crate::operation::get_pull_request_override_state::GetPullRequestOverrideStateOutput, crate::operation::get_pull_request_override_state::GetPullRequestOverrideStateError>;
