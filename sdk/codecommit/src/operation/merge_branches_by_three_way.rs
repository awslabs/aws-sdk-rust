...
impl MergeBranchesByThreeWayInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::merge_branches_by_three_way::MergeBranchesByThreeWay, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::merge_branches_by_three_way::MergeBranchesByThreeWayInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::merge_branches_by_three_way::MergeBranchesByThreeWay::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("MergeBranchesByThreeWay", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for MergeBranchesByThreeWay {
                type Output = std::result::Result<crate::operation::merge_branches_by_three_way::MergeBranchesByThreeWayOutput, crate::operation::merge_branches_by_three_way::MergeBranchesByThreeWayError>;
