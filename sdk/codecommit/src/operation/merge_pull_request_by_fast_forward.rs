...
impl MergePullRequestByFastForwardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::merge_pull_request_by_fast_forward::MergePullRequestByFastForward::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for MergePullRequestByFastForward {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_merge_pull_request_by_fast_forward::de_merge_pull_request_by_fast_forward_http_response_with_props(
                status, headers, body,
            )
        }
    }
