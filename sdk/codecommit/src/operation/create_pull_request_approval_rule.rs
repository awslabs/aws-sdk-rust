...
impl CreatePullRequestApprovalRule {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_pull_request_approval_rule::CreatePullRequestApprovalRuleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_pull_request_approval_rule::CreatePullRequestApprovalRuleOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreatePullRequestApprovalRule",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePullRequestApprovalRule {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreatePullRequestApprovalRuleRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreatePullRequestApprovalRuleResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreatePullRequestApprovalRule")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePullRequestApprovalRule")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreatePullRequestApprovalRuleTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreatePullRequestApprovalRuleTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePullRequestApprovalRuleTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreatePullRequestApprovalRuleInput>() else {
        ...
        if requested.should_capture("approvalRuleContent") {
            if let ::std::option::Option::Some(value) = input.approval_rule_content.as_deref() {
                captured.insert("approvalRuleContent", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePullRequestApprovalRuleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_pull_request_approval_rule::de_create_pull_request_approval_rule_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_create_pull_request_approval_rule::de_create_pull_request_approval_rule_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePullRequestApprovalRuleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_pull_request_approval_rule::CreatePullRequestApprovalRuleInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_pull_request_approval_rule::ser_create_pull_request_approval_rule_input(&input)?,
        );
...
impl ::std::error::Error for CreatePullRequestApprovalRuleError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::ApprovalRuleNameAlreadyExistsException(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::NumberOfRulesExceededException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreatePullRequestApprovalRuleError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ApprovalRuleNameAlreadyExistsException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::NumberOfRulesExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
