...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::merge_branches_by_squash::MergeBranchesBySquashOutput,
                    crate::operation::merge_branches_by_squash::MergeBranchesBySquashError,
                > for MergeBranchesBySquashFluentBuilder
            {
                fn send(
                    self,
...
impl MergeBranchesBySquashFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::merge_branches_by_squash::MergeBranchesBySquashOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::merge_branches_by_squash::MergeBranchesBySquashError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::merge_branches_by_squash::MergeBranchesBySquash::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::merge_branches_by_squash::MergeBranchesBySquash::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::merge_branches_by_squash::MergeBranchesBySquashOutput, crate::operation::merge_branches_by_squash::MergeBranchesBySquashError, Self> {
