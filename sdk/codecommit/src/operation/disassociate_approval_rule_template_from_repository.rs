...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DisassociateApprovalRuleTemplateFromRepositoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DisassociateApprovalRuleTemplateFromRepositoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_approval_rule_template_from_repository::ser_disassociate_approval_rule_template_from_repository_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisassociateApprovalRuleTemplateFromRepositoryEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisassociateApprovalRuleTemplateFromRepositoryError {
