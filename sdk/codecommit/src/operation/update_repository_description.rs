...
impl UpdateRepositoryDescriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_repository_description::UpdateRepositoryDescription::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRepositoryDescription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_repository_description::de_update_repository_description_http_response_with_props(
                status, headers, body,
            )
        }
    }
