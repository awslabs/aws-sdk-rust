...
/// Orchestration and serialization glue logic for `UpdateRepositoryDescription`.
...
impl UpdateRepositoryDescription {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_repository_description::UpdateRepositoryDescriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_repository_description::UpdateRepositoryDescriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_repository_description::UpdateRepositoryDescriptionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_repository_description::UpdateRepositoryDescriptionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRepositoryDescription {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateRepositoryDescription");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateRepositoryDescriptionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateRepositoryDescriptionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRepositoryDescription")
...
.with_interceptor(UpdateRepositoryDescriptionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_repository_description::UpdateRepositoryDescriptionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_repository_description::UpdateRepositoryDescriptionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_repository_description::UpdateRepositoryDescriptionError>::new());
...
#[derive(Debug)]
            struct UpdateRepositoryDescriptionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRepositoryDescriptionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_repository_description::de_update_repository_description_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_repository_description::de_update_repository_description_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateRepositoryDescriptionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRepositoryDescriptionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_repository_description::UpdateRepositoryDescriptionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_repository_description::UpdateRepositoryDescriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_repository_description::ser_update_repository_description_input(&input)?);
...
#[derive(Debug)]
            struct UpdateRepositoryDescriptionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRepositoryDescriptionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateRepositoryDescriptionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateRepositoryDescriptionInput>()
                        .ok_or("failed to downcast to UpdateRepositoryDescriptionInput")?;
...
pub enum UpdateRepositoryDescriptionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateRepositoryDescriptionError) for what information is available for the error.")]
...
impl UpdateRepositoryDescriptionError {
    /// Creates the `UpdateRepositoryDescriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateRepositoryDescriptionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateRepositoryDescriptionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_repository_description::UpdateRepositoryDescriptionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_repository_description::_update_repository_description_output::UpdateRepositoryDescriptionOutput;

pub use crate::operation::update_repository_description::_update_repository_description_input::UpdateRepositoryDescriptionInput;

mod _update_repository_description_input;

mod _update_repository_description_output;
