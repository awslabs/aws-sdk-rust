...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRepositoryDescription {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_repository_description::de_update_repository_description_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateRepositoryDescriptionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_repository_description::UpdateRepositoryDescriptionError
{
