...
impl BatchGetCommitsInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetCommits`](crate::operation::batch_get_commits::BatchGetCommits)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_get_commits::BatchGetCommits, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_commits::ser_batch_get_commits_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_commits::BatchGetCommits::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetCommits", "codecommit"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetCommits {
    type Output =
        ::std::result::Result<crate::operation::batch_get_commits::BatchGetCommitsOutput, crate::operation::batch_get_commits::BatchGetCommitsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_commits::de_batch_get_commits_http_response_with_props(status, headers, body)
        }
    }
}
