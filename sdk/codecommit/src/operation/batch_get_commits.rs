...
impl BatchGetCommitsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_get_commits::BatchGetCommits, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_commits::BatchGetCommitsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_commits::ser_batch_get_commits_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetCommits {
                type Output = std::result::Result<crate::operation::batch_get_commits::BatchGetCommitsOutput, crate::operation::batch_get_commits::BatchGetCommitsError>;
