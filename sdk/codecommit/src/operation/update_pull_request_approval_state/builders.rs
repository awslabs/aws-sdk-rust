...
impl crate::operation::update_pull_request_approval_state::builders::UpdatePullRequestApprovalStateInputBuilder {
...
impl UpdatePullRequestApprovalStateFluentBuilder {
    /// Creates a new `UpdatePullRequestApprovalStateFluentBuilder`.
