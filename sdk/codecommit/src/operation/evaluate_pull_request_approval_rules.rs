...
impl EvaluatePullRequestApprovalRulesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
