...
impl EvaluatePullRequestApprovalRules {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "EvaluatePullRequestApprovalRules",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EvaluatePullRequestApprovalRules {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            EvaluatePullRequestApprovalRulesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            EvaluatePullRequestApprovalRulesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EvaluatePullRequestApprovalRules")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EvaluatePullRequestApprovalRules")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EvaluatePullRequestApprovalRulesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct EvaluatePullRequestApprovalRulesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EvaluatePullRequestApprovalRulesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EvaluatePullRequestApprovalRulesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EvaluatePullRequestApprovalRulesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_evaluate_pull_request_approval_rules::de_evaluate_pull_request_approval_rules_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_evaluate_pull_request_approval_rules::de_evaluate_pull_request_approval_rules_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EvaluatePullRequestApprovalRulesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_evaluate_pull_request_approval_rules::ser_evaluate_pull_request_approval_rules_input(&input)?,
        );
