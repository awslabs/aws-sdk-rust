...
impl  GetMergeOptionsOutput  {
    ...
    pub fn merge_options(&self) -> & [crate::types::MergeOptionTypeEnum] {
        use std::ops::Deref; self.merge_options.deref()
    }
    /// <p>The commit ID of the source commit specifier that was used in the merge evaluation.</p>
    pub fn source_commit_id(&self) -> & str {
        use std::ops::Deref; self.source_commit_id.deref()
    }
    /// <p>The commit ID of the destination commit specifier that was used in the merge evaluation.</p>
    pub fn destination_commit_id(&self) -> & str {
        use std::ops::Deref; self.destination_commit_id.deref()
    }
    /// <p>The commit ID of the merge base.</p>
    pub fn base_commit_id(&self) -> & str {
        use std::ops::Deref; self.base_commit_id.deref()
    }
}
...
impl GetMergeOptionsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_merge_options::GetMergeOptionsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_merge_options::GetMergeOptionsOutput {
                merge_options: self.merge_options
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("merge_options", "merge_options was not specified but it is required when building GetMergeOptionsOutput")
                    )?
                ,
                source_commit_id: self.source_commit_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("source_commit_id", "source_commit_id was not specified but it is required when building GetMergeOptionsOutput")
                    )?
                ,
                destination_commit_id: self.destination_commit_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("destination_commit_id", "destination_commit_id was not specified but it is required when building GetMergeOptionsOutput")
                    )?
                ,
                base_commit_id: self.base_commit_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("base_commit_id", "base_commit_id was not specified but it is required when building GetMergeOptionsOutput")
                    )?
                ,
