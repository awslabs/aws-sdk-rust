...
impl GetMergeOptionsFluentBuilder  {
    /// Creates a new `GetMergeOptions`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_merge_options::GetMergeOptions, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_merge_options::GetMergeOptionsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_merge_options::GetMergeOptionsOutput, aws_smithy_http::result::SdkError<crate::operation::get_merge_options::GetMergeOptionsError>>
                     {
