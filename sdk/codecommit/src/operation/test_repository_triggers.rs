...
impl TestRepositoryTriggersInput {
    /// Consumes the builder and constructs an Operation<[`TestRepositoryTriggers`](crate::operation::test_repository_triggers::TestRepositoryTriggers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::test_repository_triggers::TestRepositoryTriggers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_repository_triggers::TestRepositoryTriggersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_test_repository_triggers::ser_test_repository_triggers_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::test_repository_triggers::TestRepositoryTriggers::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TestRepositoryTriggers", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for TestRepositoryTriggers {
                type Output = std::result::Result<crate::operation::test_repository_triggers::TestRepositoryTriggersOutput, crate::operation::test_repository_triggers::TestRepositoryTriggersError>;
