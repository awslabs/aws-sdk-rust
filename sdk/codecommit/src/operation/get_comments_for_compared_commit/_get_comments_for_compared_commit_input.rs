...
impl GetCommentsForComparedCommitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitInput, ::aws_smithy_types::error::operation::BuildError> {
