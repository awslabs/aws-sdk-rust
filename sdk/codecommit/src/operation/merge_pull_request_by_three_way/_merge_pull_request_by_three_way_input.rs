...
impl MergePullRequestByThreeWayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayInput, ::aws_smithy_types::error::operation::BuildError> {
