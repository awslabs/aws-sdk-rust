...
impl BatchAssociateApprovalRuleTemplateWithRepositoriesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_associate_approval_rule_template_with_repositories::BatchAssociateApprovalRuleTemplateWithRepositories,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_associate_approval_rule_template_with_repositories::BatchAssociateApprovalRuleTemplateWithRepositories::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchAssociateApprovalRuleTemplateWithRepositories {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories::de_batch_associate_approval_rule_template_with_repositories_http_response_with_props(status, headers, body)
        }
    }
}
