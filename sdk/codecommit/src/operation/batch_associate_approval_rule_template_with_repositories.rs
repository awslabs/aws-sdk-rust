...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for BatchAssociateApprovalRuleTemplateWithRepositoriesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for BatchAssociateApprovalRuleTemplateWithRepositoriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories::ser_batch_associate_approval_rule_template_with_repositories_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchAssociateApprovalRuleTemplateWithRepositoriesEndpointParamsInterceptor {
