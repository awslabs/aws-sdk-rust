    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_associate_approval_rule_template_with_repositories::BatchAssociateApprovalRuleTemplateWithRepositoriesError>::assume_from(err.into())
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchAssociateApprovalRuleTemplateWithRepositoriesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchAssociateApprovalRuleTemplateWithRepositoriesRequestSerializer {
