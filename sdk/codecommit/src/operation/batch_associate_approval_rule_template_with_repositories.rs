...
impl BatchAssociateApprovalRuleTemplateWithRepositories {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "BatchAssociateApprovalRuleTemplateWithRepositories",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchAssociateApprovalRuleTemplateWithRepositories {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchAssociateApprovalRuleTemplateWithRepositoriesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchAssociateApprovalRuleTemplateWithRepositoriesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchAssociateApprovalRuleTemplateWithRepositories")
                .build()
    ...
    fn runtime_components(
        ...
        .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            BatchAssociateApprovalRuleTemplateWithRepositoriesTelemetryInputCaptureInterceptor,
        ))
        .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchAssociateApprovalRuleTemplateWithRepositoriesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept
    for BatchAssociateApprovalRuleTemplateWithRepositoriesTelemetryInputCaptureInterceptor
{
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BatchAssociateApprovalRuleTemplateWithRepositoriesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchAssociateApprovalRuleTemplateWithRepositoriesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories::de_batch_associate_approval_rule_template_with_repositories_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_associate_approval_rule_template_with_repositories::de_batch_associate_approval_rule_template_with_repositories_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_types::request_id::RequestId
    for crate::operation::batch_associate_approval_rule_template_with_repositories::BatchAssociateApprovalRuleTemplateWithRepositoriesError
{
