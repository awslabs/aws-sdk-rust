...
impl GetMergeCommitInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_merge_commit::GetMergeCommit, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_merge_commit::ser_get_merge_commit_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMergeCommit {
    type Output =
        ::std::result::Result<crate::operation::get_merge_commit::GetMergeCommitOutput, crate::operation::get_merge_commit::GetMergeCommitError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_merge_commit::de_get_merge_commit_http_response_with_props(status, headers, body)
        }
    }
}
