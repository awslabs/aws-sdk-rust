...
impl GetFileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_file::GetFile, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_file::ser_get_file_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_file::de_get_file_http_response_with_props(status, headers, body)
        }
    }
}
