...
impl GetFileInput {
    /// Consumes the builder and constructs an Operation<[`GetFile`](crate::operation::get_file::GetFile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_file::GetFile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_file::GetFileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_file::ser_get_file_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_file::GetFile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetFile", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetFile {
                type Output = std::result::Result<crate::operation::get_file::GetFileOutput, crate::operation::get_file::GetFileError>;
