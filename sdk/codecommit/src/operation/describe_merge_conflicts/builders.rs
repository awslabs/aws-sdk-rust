...
impl DescribeMergeConflictsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_merge_conflicts::DescribeMergeConflictsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_merge_conflicts::DescribeMergeConflictsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_merge_conflicts::DescribeMergeConflictsOutput, crate::operation::describe_merge_conflicts::DescribeMergeConflictsError, Self> {
