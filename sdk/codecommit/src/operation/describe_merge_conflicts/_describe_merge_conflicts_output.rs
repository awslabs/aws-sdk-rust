...
impl  DescribeMergeConflictsOutput  {
    ...
    pub fn merge_hunks(&self) -> & [crate::types::MergeHunk] {
        use std::ops::Deref; self.merge_hunks.deref()
    }
    /// <p>An enumeration token that can be used in a request to return the next batch of the results.</p>
...
impl DescribeMergeConflictsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_merge_conflicts::DescribeMergeConflictsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_merge_conflicts::DescribeMergeConflictsOutput {
                ...
                merge_hunks: self.merge_hunks
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("merge_hunks", "merge_hunks was not specified but it is required when building DescribeMergeConflictsOutput")
                    )?
                ,
                ...
                destination_commit_id: self.destination_commit_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("destination_commit_id", "destination_commit_id was not specified but it is required when building DescribeMergeConflictsOutput")
                    )?
                ,
                source_commit_id: self.source_commit_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("source_commit_id", "source_commit_id was not specified but it is required when building DescribeMergeConflictsOutput")
                    )?
                ,
