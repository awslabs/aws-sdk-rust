...
impl GetCommentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_comment::GetComment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_comment::ser_get_comment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_comment::de_get_comment_http_response_with_props(status, headers, body)
        }
    }
}
