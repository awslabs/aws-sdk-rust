...
impl BatchAssociateApprovalRuleTemplateWithRepositoriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_associate_approval_rule_template_with_repositories::BatchAssociateApprovalRuleTemplateWithRepositoriesInput, ::aws_smithy_types::error::operation::BuildError> {
