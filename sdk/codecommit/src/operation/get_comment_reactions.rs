...
impl GetCommentReactionsInput {
    /// Consumes the builder and constructs an Operation<[`GetCommentReactions`](crate::operation::get_comment_reactions::GetCommentReactions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_comment_reactions::GetCommentReactions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_comment_reactions::GetCommentReactionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_comment_reactions::ser_get_comment_reactions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_comment_reactions::GetCommentReactions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetCommentReactions", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetCommentReactions {
                type Output = std::result::Result<crate::operation::get_comment_reactions::GetCommentReactionsOutput, crate::operation::get_comment_reactions::GetCommentReactionsError>;
