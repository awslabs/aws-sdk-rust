...
impl GetCommentReactionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_comment_reactions::ser_get_comment_reactions_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_comment_reactions::GetCommentReactions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_comment_reactions::GetCommentReactionsError
{
