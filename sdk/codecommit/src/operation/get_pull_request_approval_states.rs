...
impl GetPullRequestApprovalStatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPullRequestApprovalStates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_pull_request_approval_states::de_get_pull_request_approval_states_http_response_with_props(
                status, headers, body,
            )
        }
    }
