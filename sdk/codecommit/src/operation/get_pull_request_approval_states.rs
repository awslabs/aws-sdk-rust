...
impl GetPullRequestApprovalStatesInput {
    /// Consumes the builder and constructs an Operation<[`GetPullRequestApprovalStates`](crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_pull_request_approval_states::ser_get_pull_request_approval_states_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPullRequestApprovalStates", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPullRequestApprovalStates {
                type Output = std::result::Result<crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStatesOutput, crate::operation::get_pull_request_approval_states::GetPullRequestApprovalStatesError>;
