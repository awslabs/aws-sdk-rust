...
/// Orchestration and serialization glue logic for `UpdateApprovalRuleTemplateName`.
...
impl UpdateApprovalRuleTemplateName {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApprovalRuleTemplateName {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateApprovalRuleTemplateName");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateApprovalRuleTemplateNameRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateApprovalRuleTemplateNameResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateApprovalRuleTemplateName")
...
.with_interceptor(UpdateApprovalRuleTemplateNameEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError>::new());
...
#[derive(Debug)]
            struct UpdateApprovalRuleTemplateNameResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateApprovalRuleTemplateNameResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_approval_rule_template_name::de_update_approval_rule_template_name_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_approval_rule_template_name::de_update_approval_rule_template_name_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateApprovalRuleTemplateNameRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateApprovalRuleTemplateNameRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_approval_rule_template_name::ser_update_approval_rule_template_name_input(&input)?);
...
#[derive(Debug)]
            struct UpdateApprovalRuleTemplateNameEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateApprovalRuleTemplateNameEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateApprovalRuleTemplateNameEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateApprovalRuleTemplateNameInput>()
                        .ok_or("failed to downcast to UpdateApprovalRuleTemplateNameInput")?;
...
pub enum UpdateApprovalRuleTemplateNameError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateApprovalRuleTemplateNameError) for what information is available for the error.")]
...
impl UpdateApprovalRuleTemplateNameError {
    /// Creates the `UpdateApprovalRuleTemplateNameError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateApprovalRuleTemplateNameError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateApprovalRuleTemplateNameError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateApprovalRuleTemplateNameError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_approval_rule_template_name::_update_approval_rule_template_name_output::UpdateApprovalRuleTemplateNameOutput;

pub use crate::operation::update_approval_rule_template_name::_update_approval_rule_template_name_input::UpdateApprovalRuleTemplateNameInput;

mod _update_approval_rule_template_name_input;

mod _update_approval_rule_template_name_output;
