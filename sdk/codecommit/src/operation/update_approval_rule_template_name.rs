...
impl UpdateApprovalRuleTemplateName {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateApprovalRuleTemplateName",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApprovalRuleTemplateName {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateApprovalRuleTemplateNameRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateApprovalRuleTemplateNameResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateApprovalRuleTemplateName")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateApprovalRuleTemplateName")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateApprovalRuleTemplateNameTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateApprovalRuleTemplateNameTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateApprovalRuleTemplateNameTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateApprovalRuleTemplateNameInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("oldApprovalRuleTemplateName") {
            if let ::std::option::Option::Some(value) = input.old_approval_rule_template_name.as_deref() {
                captured.insert("oldApprovalRuleTemplateName", value);
            }
        }
        if requested.should_capture("newApprovalRuleTemplateName") {
            if let ::std::option::Option::Some(value) = input.new_approval_rule_template_name.as_deref() {
                captured.insert("newApprovalRuleTemplateName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateApprovalRuleTemplateNameResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_update_approval_rule_template_name::de_update_approval_rule_template_name_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateApprovalRuleTemplateNameRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_approval_rule_template_name::ser_update_approval_rule_template_name_input(&input)?,
        );
