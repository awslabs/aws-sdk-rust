...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApprovalRuleTemplateName {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_approval_rule_template_name::de_update_approval_rule_template_name_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameError
{
