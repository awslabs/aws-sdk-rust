...
impl GetMergeOptionsInput {
    /// Consumes the builder and constructs an Operation<[`GetMergeOptions`](crate::operation::get_merge_options::GetMergeOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_merge_options::GetMergeOptions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_merge_options::GetMergeOptionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_merge_options::ser_get_merge_options_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_merge_options::GetMergeOptions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetMergeOptions", "codecommit"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetMergeOptions {
                type Output = std::result::Result<crate::operation::get_merge_options::GetMergeOptionsOutput, crate::operation::get_merge_options::GetMergeOptionsError>;
