...
impl crate::operation::update_approval_rule_template_description::builders::UpdateApprovalRuleTemplateDescriptionInputBuilder {
...
impl UpdateApprovalRuleTemplateDescriptionFluentBuilder {
    /// Creates a new `UpdateApprovalRuleTemplateDescriptionFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::update_approval_rule_template_description::builders::UpdateApprovalRuleTemplateDescriptionInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescription::operation_runtime_plugins(
