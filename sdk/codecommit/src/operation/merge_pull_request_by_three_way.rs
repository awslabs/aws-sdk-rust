...
impl MergePullRequestByThreeWay {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "MergePullRequestByThreeWay",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("MergePullRequestByThreeWay")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MergePullRequestByThreeWayResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_merge_pull_request_by_three_way::de_merge_pull_request_by_three_way_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_merge_pull_request_by_three_way::de_merge_pull_request_by_three_way_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MergePullRequestByThreeWayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayInput>()
            .expect("correct type");
