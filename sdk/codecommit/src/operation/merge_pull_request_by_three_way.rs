...
impl MergePullRequestByThreeWay {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MergePullRequestByThreeWay {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("MergePullRequestByThreeWay");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(MergePullRequestByThreeWayRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(MergePullRequestByThreeWayResponseDeserializer));
...
.with_interceptor(MergePullRequestByThreeWayEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError>::new());
...
#[derive(Debug)]
            struct MergePullRequestByThreeWayRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MergePullRequestByThreeWayRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_merge_pull_request_by_three_way::ser_merge_pull_request_by_three_way_input(&input)?);
...
#[derive(Debug)]
            struct MergePullRequestByThreeWayEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MergePullRequestByThreeWayEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "MergePullRequestByThreeWayEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<MergePullRequestByThreeWayInput>()
                        .ok_or("failed to downcast to MergePullRequestByThreeWayInput")?;
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for MergePullRequestByThreeWayError {
...
impl ::aws_types::request_id::RequestId for crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError {
