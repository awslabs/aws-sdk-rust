    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MergePullRequestByThreeWay {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            MergePullRequestByThreeWayRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            MergePullRequestByThreeWayResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("MergePullRequestByThreeWay", "codecommit"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MergePullRequestByThreeWay")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for MergePullRequestByThreeWayResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for MergePullRequestByThreeWayRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::merge_pull_request_by_three_way::MergePullRequestByThreeWayInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_merge_pull_request_by_three_way::ser_merge_pull_request_by_three_way_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for MergePullRequestByThreeWayEndpointParamsInterceptor {
