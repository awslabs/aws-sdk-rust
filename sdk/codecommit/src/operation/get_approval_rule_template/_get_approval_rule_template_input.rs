...
impl GetApprovalRuleTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_approval_rule_template::GetApprovalRuleTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
