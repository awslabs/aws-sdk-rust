...
impl MergeBranchesBySquashInput {
    /// Consumes the builder and constructs an Operation<[`MergeBranchesBySquash`](crate::operation::merge_branches_by_squash::MergeBranchesBySquash)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::merge_branches_by_squash::MergeBranchesBySquash, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::merge_branches_by_squash::MergeBranchesBySquashInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for MergeBranchesBySquash {
                type Output = std::result::Result<crate::operation::merge_branches_by_squash::MergeBranchesBySquashOutput, crate::operation::merge_branches_by_squash::MergeBranchesBySquashError>;
