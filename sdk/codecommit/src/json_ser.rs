...
pub fn serialize_structure_associate_approval_rule_template_with_repository_input(
...
pub fn serialize_structure_batch_associate_approval_rule_template_with_repositories_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_describe_merge_conflicts_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_8) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_8);
    }
    if let Some(var_9) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_9);
    }
...
pub fn serialize_structure_batch_disassociate_approval_rule_template_from_repositories_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_commits_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_repositories_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_approval_rule_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_31) = &input.approval_rule_template_content {
        object.key("approvalRuleTemplateContent").string(var_31);
    }
...
pub fn serialize_structure_create_branch_input(
    ...
    if let Some(var_34) = &input.branch_name {
        object.key("branchName").string(var_34);
    }
...
pub fn serialize_structure_create_commit_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_38) = &input.parent_commit_id {
        object.key("parentCommitId").string(var_38);
    }
    if let Some(var_39) = &input.author_name {
        object.key("authorName").string(var_39);
    }
    if let Some(var_40) = &input.email {
        object.key("email").string(var_40);
    }
    if let Some(var_41) = &input.commit_message {
        object.key("commitMessage").string(var_41);
    }
        ...
        for item_44 in var_42 {
            {
                ...
                crate::json_ser::serialize_structure_put_file_entry(&mut object_45, item_44);
                object_45.finish();
            }
        }
        array_43.finish();
        ...
        for item_48 in var_46 {
            {
                ...
                crate::json_ser::serialize_structure_delete_file_entry(&mut object_49, item_48);
                object_49.finish();
            }
        }
        array_47.finish();
        ...
        for item_52 in var_50 {
            {
                ...
                crate::json_ser::serialize_structure_set_file_mode_entry(&mut object_53, item_52);
                object_53.finish();
            }
        }
        array_51.finish();
...
pub fn serialize_structure_create_pull_request_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_58 in var_56 {
            {
                ...
                crate::json_ser::serialize_structure_target(&mut object_59, item_58);
                object_59.finish();
            }
        }
        array_57.finish();
...
pub fn serialize_structure_create_pull_request_approval_rule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_62) = &input.approval_rule_name {
        object.key("approvalRuleName").string(var_62);
    }
...
pub fn serialize_structure_create_repository_input(
    ...
    if let Some(var_65) = &input.repository_description {
        object.key("repositoryDescription").string(var_65);
    }
...
pub fn serialize_structure_create_unreferenced_merge_commit_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_71) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_71);
    }
    if let Some(var_72) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_72);
    }
    ...
    if let Some(var_76) = &input.author_name {
        object.key("authorName").string(var_76);
    }
    if let Some(var_77) = &input.email {
        object.key("email").string(var_77);
    }
    if let Some(var_78) = &input.commit_message {
        object.key("commitMessage").string(var_78);
    }
    if input.keep_empty_folders {
        object
            .key("keepEmptyFolders")
    ...
    if let Some(var_79) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_conflict_resolution(&mut object_80, var_79);
        object_80.finish();
    }
}

pub fn serialize_structure_delete_approval_rule_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_branch_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_comment_content_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_file_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_86) = &input.branch_name {
        object.key("branchName").string(var_86);
    }
    if let Some(var_87) = &input.file_path {
        object.key("filePath").string(var_87);
    }
    if let Some(var_88) = &input.parent_commit_id {
        object.key("parentCommitId").string(var_88);
    }
    if input.keep_empty_folders {
        object
            .key("keepEmptyFolders")
    ...
    if let Some(var_89) = &input.commit_message {
        object.key("commitMessage").string(var_89);
    }
...
pub fn serialize_structure_delete_pull_request_approval_rule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_merge_conflicts_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_96) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_96);
    }
    if let Some(var_97) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_97);
    }
    ...
    if let Some(var_100) = &input.file_path {
        object.key("filePath").string(var_100);
    }
...
pub fn serialize_structure_describe_pull_request_events_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_106) = &input.actor_arn {
        object.key("actorArn").string(var_106);
    }
...
pub fn serialize_structure_disassociate_approval_rule_template_from_repository_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_evaluate_pull_request_approval_rules_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_approval_rule_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_blob_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_branch_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_comment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_comment_reactions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_120) = &input.reaction_user_arn {
        object.key("reactionUserArn").string(var_120);
    }
...
pub fn serialize_structure_get_comments_for_compared_commit_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_124) = &input.before_commit_id {
        object.key("beforeCommitId").string(var_124);
    }
    if let Some(var_125) = &input.after_commit_id {
        object.key("afterCommitId").string(var_125);
    }
...
pub fn serialize_structure_get_comments_for_pull_request_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_129) = &input.repository_name {
        object.key("repositoryName").string(var_129);
    }
    if let Some(var_130) = &input.before_commit_id {
        object.key("beforeCommitId").string(var_130);
    }
    if let Some(var_131) = &input.after_commit_id {
        object.key("afterCommitId").string(var_131);
    }
...
pub fn serialize_structure_get_commit_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_differences_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_137) = &input.before_commit_specifier {
        object.key("beforeCommitSpecifier").string(var_137);
    }
    if let Some(var_138) = &input.after_commit_specifier {
        object.key("afterCommitSpecifier").string(var_138);
    }
    if let Some(var_139) = &input.before_path {
        object.key("beforePath").string(var_139);
    }
    if let Some(var_140) = &input.after_path {
        object.key("afterPath").string(var_140);
    }
...
pub fn serialize_structure_get_file_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_144) = &input.commit_specifier {
        object.key("commitSpecifier").string(var_144);
    }
...
pub fn serialize_structure_get_folder_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_147) = &input.commit_specifier {
        object.key("commitSpecifier").string(var_147);
    }
...
pub fn serialize_structure_get_merge_commit_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_150) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_150);
    }
    if let Some(var_151) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_151);
    }
...
pub fn serialize_structure_get_merge_conflicts_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_155) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_155);
    }
    if let Some(var_156) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_156);
    }
...
pub fn serialize_structure_get_merge_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_163) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_163);
    }
    if let Some(var_164) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_164);
    }
...
pub fn serialize_structure_get_pull_request_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_pull_request_approval_states_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_pull_request_override_state_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_repository_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_repository_triggers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_approval_rule_templates_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_associated_approval_rule_templates_for_repository_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_branches_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_pull_requests_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_182) = &input.author_arn {
        object.key("authorArn").string(var_182);
    }
...
pub fn serialize_structure_list_repositories_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_repositories_for_approval_rule_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_merge_branches_by_fast_forward_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_195) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_195);
    }
    if let Some(var_196) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_196);
    }
...
pub fn serialize_structure_merge_branches_by_squash_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_199) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_199);
    }
    if let Some(var_200) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_200);
    }
    if let Some(var_201) = &input.target_branch {
        object.key("targetBranch").string(var_201);
    }
    ...
    if let Some(var_204) = &input.author_name {
        object.key("authorName").string(var_204);
    }
    if let Some(var_205) = &input.email {
        object.key("email").string(var_205);
    }
    if let Some(var_206) = &input.commit_message {
        object.key("commitMessage").string(var_206);
    }
    if input.keep_empty_folders {
        object
            .key("keepEmptyFolders")
    ...
    if let Some(var_207) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_conflict_resolution(&mut object_208, var_207);
        object_208.finish();
    }
}

pub fn serialize_structure_merge_branches_by_three_way_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_210) = &input.source_commit_specifier {
        object.key("sourceCommitSpecifier").string(var_210);
    }
    if let Some(var_211) = &input.destination_commit_specifier {
        object.key("destinationCommitSpecifier").string(var_211);
    }
    if let Some(var_212) = &input.target_branch {
        object.key("targetBranch").string(var_212);
    }
    ...
    if let Some(var_215) = &input.author_name {
        object.key("authorName").string(var_215);
    }
    if let Some(var_216) = &input.email {
        object.key("email").string(var_216);
    }
    if let Some(var_217) = &input.commit_message {
        object.key("commitMessage").string(var_217);
    }
    if input.keep_empty_folders {
        object
            .key("keepEmptyFolders")
    ...
    if let Some(var_218) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_conflict_resolution(&mut object_219, var_218);
        object_219.finish();
    }
}

pub fn serialize_structure_merge_pull_request_by_fast_forward_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_221) = &input.repository_name {
        object.key("repositoryName").string(var_221);
    }
...
pub fn serialize_structure_merge_pull_request_by_squash_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_224) = &input.repository_name {
        object.key("repositoryName").string(var_224);
    }
    if let Some(var_225) = &input.source_commit_id {
        object.key("sourceCommitId").string(var_225);
    }
    ...
    if let Some(var_228) = &input.commit_message {
        object.key("commitMessage").string(var_228);
    }
    if let Some(var_229) = &input.author_name {
        object.key("authorName").string(var_229);
    }
    if let Some(var_230) = &input.email {
        object.key("email").string(var_230);
    }
    if input.keep_empty_folders {
        object
            .key("keepEmptyFolders")
    ...
    if let Some(var_231) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_conflict_resolution(&mut object_232, var_231);
        object_232.finish();
    }
}

pub fn serialize_structure_merge_pull_request_by_three_way_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_234) = &input.repository_name {
        object.key("repositoryName").string(var_234);
    }
    if let Some(var_235) = &input.source_commit_id {
        object.key("sourceCommitId").string(var_235);
    }
    ...
    if let Some(var_238) = &input.commit_message {
        object.key("commitMessage").string(var_238);
    }
    if let Some(var_239) = &input.author_name {
        object.key("authorName").string(var_239);
    }
    if let Some(var_240) = &input.email {
        object.key("email").string(var_240);
    }
    if input.keep_empty_folders {
        object
            .key("keepEmptyFolders")
    ...
    if let Some(var_241) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_conflict_resolution(&mut object_242, var_241);
        object_242.finish();
    }
}

pub fn serialize_structure_override_pull_request_approval_rules_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_244) = &input.revision_id {
        object.key("revisionId").string(var_244);
    }
...
pub fn serialize_structure_post_comment_for_compared_commit_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_247) = &input.before_commit_id {
        object.key("beforeCommitId").string(var_247);
    }
    if let Some(var_248) = &input.after_commit_id {
        object.key("afterCommitId").string(var_248);
    }
    if let Some(var_249) = &input.location {
        let mut object_250 = object.key("location").start_object();
        crate::json_ser::serialize_structure_location(&mut object_250, var_249);
        object_250.finish();
    }
...
pub fn serialize_structure_post_comment_for_pull_request_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_254) = &input.repository_name {
        object.key("repositoryName").string(var_254);
    }
    if let Some(var_255) = &input.before_commit_id {
        object.key("beforeCommitId").string(var_255);
    }
    if let Some(var_256) = &input.after_commit_id {
        object.key("afterCommitId").string(var_256);
    }
    if let Some(var_257) = &input.location {
        let mut object_258 = object.key("location").start_object();
        crate::json_ser::serialize_structure_location(&mut object_258, var_257);
        object_258.finish();
    }
...
pub fn serialize_structure_post_comment_reply_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_comment_reaction_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_file_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_repository_triggers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_278 in var_276 {
            {
                ...
                crate::json_ser::serialize_structure_repository_trigger(&mut object_279, item_278);
                object_279.finish();
            }
        }
        array_277.finish();
...
pub fn serialize_structure_tag_resource_input(
    ...
    if let Some(var_281) = &input.tags {
        ...
        for (key_283, value_284) in var_281 {
            {
                object_282.key(key_283).string(value_284);
            }
        }
        object_282.finish();
    }
...
pub fn serialize_structure_test_repository_triggers_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_288 in var_286 {
            {
                ...
                crate::json_ser::serialize_structure_repository_trigger(&mut object_289, item_288);
                object_289.finish();
            }
        }
        array_287.finish();
...
pub fn serialize_structure_update_approval_rule_template_content_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_295) = &input.new_rule_content {
        object.key("newRuleContent").string(var_295);
    }
...
pub fn serialize_structure_update_approval_rule_template_description_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_approval_rule_template_name_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_comment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_default_branch_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_pull_request_approval_rule_content_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_306) = &input.approval_rule_name {
        object.key("approvalRuleName").string(var_306);
    }
    if let Some(var_307) = &input.existing_rule_content_sha256 {
        object.key("existingRuleContentSha256").string(var_307);
    }
...
pub fn serialize_structure_update_pull_request_approval_state_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_310) = &input.revision_id {
        object.key("revisionId").string(var_310);
    }
...
pub fn serialize_structure_update_pull_request_description_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_pull_request_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_pull_request_title_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_repository_description_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_repository_name_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_file_entry(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_324) = &input.file_content {
        object
            .key("fileContent")
            .string_unchecked(&smithy_types::base64::encode(var_324));
    }
    if let Some(var_325) = &input.source_file {
        let mut object_326 = object.key("sourceFile").start_object();
        crate::json_ser::serialize_structure_source_file_specifier(&mut object_326, var_325);
        object_326.finish();
    }
}

pub fn serialize_structure_delete_file_entry(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_set_file_mode_entry(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_target(
    ...
    if let Some(var_331) = &input.source_reference {
        object.key("sourceReference").string(var_331);
    }
...
pub fn serialize_structure_conflict_resolution(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_335 in var_333 {
            {
                ...
                crate::json_ser::serialize_structure_replace_content_entry(
                    &mut object_336,
                    item_335,
                );
                object_336.finish();
        ...
        for item_339 in var_337 {
            {
                ...
                crate::json_ser::serialize_structure_delete_file_entry(&mut object_340, item_339);
                object_340.finish();
            }
        }
        array_338.finish();
        ...
        for item_343 in var_341 {
            {
                ...
                crate::json_ser::serialize_structure_set_file_mode_entry(&mut object_344, item_343);
                object_344.finish();
            }
        }
        array_342.finish();
...
pub fn serialize_structure_repository_trigger(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_349) = &input.destination_arn {
        object.key("destinationArn").string(var_349);
    }
    if let Some(var_350) = &input.custom_data {
        object.key("customData").string(var_350);
    }
...
pub fn serialize_structure_source_file_specifier(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_replace_content_entry(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_360) = &input.content {
        object
            .key("content")
            .string_unchecked(&smithy_types::base64::encode(var_360));
    }
