...
pub fn serialize_structure_crate_input_associate_approval_rule_template_with_repository_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateApprovalRuleTemplateWithRepositoryInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_batch_associate_approval_rule_template_with_repositories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchAssociateApprovalRuleTemplateWithRepositoriesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_batch_describe_merge_conflicts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchDescribeMergeConflictsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_batch_disassociate_approval_rule_template_from_repositories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchDisassociateApprovalRuleTemplateFromRepositoriesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_batch_get_commits_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchGetCommitsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_batch_get_repositories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchGetRepositoriesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_approval_rule_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateApprovalRuleTemplateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCommitInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_pull_request_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePullRequestInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_pull_request_approval_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePullRequestApprovalRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_unreferenced_merge_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUnreferencedMergeCommitInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_approval_rule_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteApprovalRuleTemplateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_branch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteBranchInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_comment_content_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteCommentContentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_file_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteFileInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_pull_request_approval_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeletePullRequestApprovalRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_merge_conflicts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeMergeConflictsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_pull_request_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePullRequestEventsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_disassociate_approval_rule_template_from_repository_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateApprovalRuleTemplateFromRepositoryInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_evaluate_pull_request_approval_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EvaluatePullRequestApprovalRulesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_approval_rule_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetApprovalRuleTemplateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_blob_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetBlobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_branch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetBranchInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_comment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCommentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_comment_reactions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCommentReactionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_comments_for_compared_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCommentsForComparedCommitInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_comments_for_pull_request_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCommentsForPullRequestInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetCommitInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_differences_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetDifferencesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_file_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetFileInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_folder_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetFolderInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_merge_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMergeCommitInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_merge_conflicts_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMergeConflictsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_merge_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMergeOptionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_pull_request_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPullRequestInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_pull_request_approval_states_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPullRequestApprovalStatesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_pull_request_override_state_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPullRequestOverrideStateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_repository_triggers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetRepositoryTriggersInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_approval_rule_templates_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListApprovalRuleTemplatesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_associated_approval_rule_templates_for_repository_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAssociatedApprovalRuleTemplatesForRepositoryInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_branches_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListBranchesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_pull_requests_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPullRequestsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_repositories_for_approval_rule_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRepositoriesForApprovalRuleTemplateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_merge_branches_by_fast_forward_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergeBranchesByFastForwardInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_merge_branches_by_squash_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergeBranchesBySquashInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_merge_branches_by_three_way_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergeBranchesByThreeWayInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_merge_pull_request_by_fast_forward_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergePullRequestByFastForwardInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_merge_pull_request_by_squash_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergePullRequestBySquashInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_merge_pull_request_by_three_way_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MergePullRequestByThreeWayInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_override_pull_request_approval_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::OverridePullRequestApprovalRulesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_post_comment_for_compared_commit_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PostCommentForComparedCommitInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_post_comment_for_pull_request_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PostCommentForPullRequestInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_post_comment_reply_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PostCommentReplyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_comment_reaction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutCommentReactionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_file_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutFileInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_repository_triggers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutRepositoryTriggersInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_test_repository_triggers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TestRepositoryTriggersInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_approval_rule_template_content_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateApprovalRuleTemplateContentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_approval_rule_template_description_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateApprovalRuleTemplateDescriptionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_approval_rule_template_name_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateApprovalRuleTemplateNameInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_comment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCommentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_default_branch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDefaultBranchInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_pull_request_approval_rule_content_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePullRequestApprovalRuleContentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_pull_request_approval_state_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePullRequestApprovalStateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_pull_request_description_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePullRequestDescriptionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_pull_request_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePullRequestStatusInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_pull_request_title_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePullRequestTitleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_repository_description_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRepositoryDescriptionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_repository_name_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRepositoryNameInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_put_file_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PutFileEntry) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_delete_file_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeleteFileEntry) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_set_file_mode_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SetFileModeEntry) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_repository_trigger(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RepositoryTrigger) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_source_file_specifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceFileSpecifier) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_replace_content_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReplaceContentEntry) -> Result<(), aws_smithy_http::operation::SerializationError> {
