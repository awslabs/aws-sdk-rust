...
pub struct TestRepositoryTriggersOutput  {
    ...
    #[doc(hidden)]
    pub failed_executions: std::option::Option<std::vec::Vec<crate::model::RepositoryTriggerExecutionFailure>>,
}
...
pub struct GetCommentsForPullRequestOutput  {
    ...
    #[doc(hidden)]
    pub comments_for_pull_request_data: std::option::Option<std::vec::Vec<crate::model::CommentsForPullRequest>>,
    /// <p>An enumeration token that can be used in a request to return the next batch of the results.</p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetCommentsForComparedCommitOutput  {
    ...
    #[doc(hidden)]
    pub comments_for_compared_commit_data: std::option::Option<std::vec::Vec<crate::model::CommentsForComparedCommit>>,
    /// <p>An enumeration token that can be used in a request to return the next batch of the results.</p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
}
...
pub struct BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput  {
    ...
    #[doc(hidden)]
    pub errors: std::option::Option<std::vec::Vec<crate::model::BatchDisassociateApprovalRuleTemplateFromRepositoriesError>>,
}
...
pub struct BatchAssociateApprovalRuleTemplateWithRepositoriesOutput  {
    ...
    #[doc(hidden)]
    pub errors: std::option::Option<std::vec::Vec<crate::model::BatchAssociateApprovalRuleTemplateWithRepositoriesError>>,
}
