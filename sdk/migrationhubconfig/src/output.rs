...
pub struct DescribeHomeRegionControlsOutput  {
    ...
    #[doc(hidden)]pub home_region_controls: std::option::Option<std::vec::Vec<crate::model::HomeRegionControl>>,
...
pub mod describe_home_region_controls_output {
    ...
    impl Builder {
        ...
        /// <p>An array that contains your <code>HomeRegionControl</code> objects.</p>
        pub fn set_home_region_controls(mut self, input: std::option::Option<std::vec::Vec<crate::model::HomeRegionControl>>) -> Self {
...
pub struct CreateHomeRegionControlOutput  {
    ...
    #[doc(hidden)]pub home_region_control: std::option::Option<crate::model::HomeRegionControl>,
}
