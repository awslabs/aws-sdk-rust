...
impl DescribeHomeRegionControls {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeHomeRegionControls {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeHomeRegionControls");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeHomeRegionControlsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeHomeRegionControlsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeHomeRegionControls")
...
.with_interceptor(DescribeHomeRegionControlsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsError>::new());
...
#[derive(Debug)]
            struct DescribeHomeRegionControlsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeHomeRegionControlsResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeHomeRegionControlsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeHomeRegionControlsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_home_region_controls::DescribeHomeRegionControlsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_home_region_controls::DescribeHomeRegionControlsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_home_region_controls::ser_describe_home_region_controls_input(&input)?);
...
#[derive(Debug)]
            struct DescribeHomeRegionControlsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeHomeRegionControlsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeHomeRegionControlsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeHomeRegionControlsInput>()
                        .ok_or("failed to downcast to DescribeHomeRegionControlsInput")?;
...
pub enum DescribeHomeRegionControlsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeHomeRegionControlsError) for what information is available for the error.")]
...
impl DescribeHomeRegionControlsError {
    /// Creates the `DescribeHomeRegionControlsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeHomeRegionControlsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeHomeRegionControlsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_home_region_controls::DescribeHomeRegionControlsError {
