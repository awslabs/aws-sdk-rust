...
impl DescribeHomeRegionControlsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_home_region_controls::DescribeHomeRegionControls::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHomeRegionControls {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_home_region_controls::de_describe_home_region_controls_http_response_with_props(
                status, headers, body,
            )
        }
    }
