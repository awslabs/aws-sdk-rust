...
impl GetHomeRegionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_home_region::GetHomeRegion,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_home_region::GetHomeRegion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHomeRegion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_home_region::de_get_home_region_http_error(
                status, headers, body,
            )
        } else {
