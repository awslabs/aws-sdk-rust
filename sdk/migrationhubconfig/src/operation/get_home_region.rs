...
impl GetHomeRegionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_home_region::GetHomeRegion, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_home_region::ser_get_home_region_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHomeRegion {
    type Output =
        ::std::result::Result<crate::operation::get_home_region::GetHomeRegionOutput, crate::operation::get_home_region::GetHomeRegionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_home_region::de_get_home_region_http_response_with_props(status, headers, body)
        }
    }
}
