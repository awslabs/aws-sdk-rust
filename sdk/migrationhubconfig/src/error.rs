...
impl smithy_types::retry::ProvideErrorKind for CreateHomeRegionControlError {
...
impl CreateHomeRegionControlError {
    pub fn new(kind: CreateHomeRegionControlErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for DescribeHomeRegionControlsError {
    fn code(&self) -> Option<&str> {
...
impl DescribeHomeRegionControlsError {
    pub fn new(kind: DescribeHomeRegionControlsErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for GetHomeRegionError {
    fn code(&self) -> Option<&str> {
...
impl GetHomeRegionError {
    pub fn new(kind: GetHomeRegionErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
