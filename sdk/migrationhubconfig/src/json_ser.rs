...
pub fn serialize_structure_create_home_region_control_input(
    ...
    if let Some(var_2) = &input.target {
        ...
        crate::json_ser::serialize_structure_target(&mut object_3, var_2);
        object_3.finish();
    }
    if input.dry_run {
...
pub fn serialize_structure_describe_home_region_controls_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_6) = &input.target {
        ...
        crate::json_ser::serialize_structure_target(&mut object_7, var_6);
        object_7.finish();
    }
