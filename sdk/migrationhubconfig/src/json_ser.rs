...
pub fn serialize_structure_crate_input_create_home_region_control_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateHomeRegionControlInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_home_region_controls_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeHomeRegionControlsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
