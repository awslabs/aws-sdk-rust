...
pub fn ser_get_home_region_input(_input: &crate::operation::get_home_region::GetHomeRegionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
