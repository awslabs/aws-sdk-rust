...
impl BatchSnoozeAlarmInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_snooze_alarm::ser_batch_snooze_alarm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchSnoozeAlarm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_batch_snooze_alarm::de_batch_snooze_alarm_http_response_with_props(status, headers, body)
        }
    }
}
