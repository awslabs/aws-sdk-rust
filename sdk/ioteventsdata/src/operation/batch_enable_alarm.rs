...
impl BatchEnableAlarmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_enable_alarm::BatchEnableAlarm,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_enable_alarm::ser_batch_enable_alarm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchEnableAlarm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_batch_enable_alarm::de_batch_enable_alarm_http_response_with_props(status, headers, body)
        }
    }
}
