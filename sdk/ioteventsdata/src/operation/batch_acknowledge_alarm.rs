...
/// Orchestration and serialization glue logic for `BatchAcknowledgeAlarm`.
...
impl BatchAcknowledgeAlarm {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmInput,
                    ) -> ::std::result::Result<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchAcknowledgeAlarm {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchAcknowledgeAlarm");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchAcknowledgeAlarmRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchAcknowledgeAlarmResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchAcknowledgeAlarm")
...
.with_interceptor(BatchAcknowledgeAlarmEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmError>::new());
...
#[derive(Debug)]
            struct BatchAcknowledgeAlarmResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchAcknowledgeAlarmResponseDeserializer {
...
#[derive(Debug)]
            struct BatchAcknowledgeAlarmRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchAcknowledgeAlarmRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/alarms/acknowledge").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_acknowledge_alarm::ser_batch_acknowledge_alarm_input(&input)?);
...
#[derive(Debug)]
            struct BatchAcknowledgeAlarmEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchAcknowledgeAlarmEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchAcknowledgeAlarmEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchAcknowledgeAlarmInput>()
                        .ok_or("failed to downcast to BatchAcknowledgeAlarmInput")?;
...
pub enum BatchAcknowledgeAlarmError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchAcknowledgeAlarmError) for what information is available for the error.")]
...
impl BatchAcknowledgeAlarmError {
    /// Creates the `BatchAcknowledgeAlarmError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchAcknowledgeAlarmError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchAcknowledgeAlarmError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_acknowledge_alarm::BatchAcknowledgeAlarmError {
...
mod _batch_acknowledge_alarm_output;
