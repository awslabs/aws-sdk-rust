...
impl BatchDisableAlarmInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_disable_alarm::ser_batch_disable_alarm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisableAlarm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_batch_disable_alarm::de_batch_disable_alarm_http_response_with_props(status, headers, body)
        }
    }
}
