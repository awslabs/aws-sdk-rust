...
impl ListAlarmsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_alarms::ListAlarms,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_alarms::ListAlarms::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAlarms {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_alarms::de_list_alarms_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_alarms::de_list_alarms_http_response_with_props(
                status, headers, body,
            )
        }
    }
