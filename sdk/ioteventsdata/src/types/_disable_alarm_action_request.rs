...
impl DisableAlarmActionRequestBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::DisableAlarmActionRequest, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::DisableAlarmActionRequest {
                request_id: self.request_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("request_id", "request_id was not specified but it is required when building DisableAlarmActionRequest")
                    )?
                ,
                alarm_model_name: self.alarm_model_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("alarm_model_name", "alarm_model_name was not specified but it is required when building DisableAlarmActionRequest")
                    )?
                ,
