...
pub struct ListDetectorsOutput  {
    ...
    #[doc(hidden)]pub detector_summaries: std::option::Option<std::vec::Vec<crate::model::DetectorSummary>>,
...
pub mod list_detectors_output {
    ...
    impl Builder {
        ...
        /// <p>A list of summary information about the detectors (instances).</p>
        pub fn set_detector_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::DetectorSummary>>) -> Self {
...
pub struct ListAlarmsOutput  {
    ...
    #[doc(hidden)]pub alarm_summaries: std::option::Option<std::vec::Vec<crate::model::AlarmSummary>>,
    /// <p>The token that you can use to return the next set of results, or <code>null</code> if there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_alarms_output {
    ...
    impl Builder {
        ...
        /// <p>A list that summarizes each alarm.</p>
        pub fn set_alarm_summaries(mut self, input: std::option::Option<std::vec::Vec<crate::model::AlarmSummary>>) -> Self {
...
pub struct DescribeDetectorOutput  {
    ...
    #[doc(hidden)]pub detector: std::option::Option<crate::model::Detector>,
}
...
pub struct DescribeAlarmOutput  {
    ...
    #[doc(hidden)]pub alarm: std::option::Option<crate::model::Alarm>,
}
...
pub struct BatchUpdateDetectorOutput  {
    ...
    #[doc(hidden)]pub batch_update_detector_error_entries: std::option::Option<std::vec::Vec<crate::model::BatchUpdateDetectorErrorEntry>>,
}
impl BatchUpdateDetectorOutput {
    /// <p>A list of those detector updates that resulted in errors. (If an error is listed here, the specific update did not occur.)</p>
    pub fn batch_update_detector_error_entries(&self) -> std::option::Option<& [crate::model::BatchUpdateDetectorErrorEntry]> {
...
impl  std::fmt::Debug for BatchUpdateDetectorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("batch_update_detector_error_entries", &self.batch_update_detector_error_entries);
        formatter.finish()
    }
}
...
pub mod batch_update_detector_output {
    ...
    impl Builder {
        ...
        ///
        /// <p>A list of those detector updates that resulted in errors. (If an error is listed here, the specific update did not occur.)</p>
        pub fn batch_update_detector_error_entries(mut self, input: crate::model::BatchUpdateDetectorErrorEntry) -> Self {
...
pub struct BatchSnoozeAlarmOutput  {
    ...
    #[doc(hidden)]pub error_entries: std::option::Option<std::vec::Vec<crate::model::BatchAlarmActionErrorEntry>>,
}
impl BatchSnoozeAlarmOutput {
    /// <p>A list of errors associated with the request, or <code>null</code> if there are no errors. Each error entry contains an entry ID that helps you identify the entry that failed.</p>
    pub fn error_entries(&self) -> std::option::Option<& [crate::model::BatchAlarmActionErrorEntry]> {
...
pub struct BatchPutMessageOutput  {
    ...
    #[doc(hidden)]pub batch_put_message_error_entries: std::option::Option<std::vec::Vec<crate::model::BatchPutMessageErrorEntry>>,
}
...
impl  std::fmt::Debug for BatchPutMessageOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("batch_put_message_error_entries", &self.batch_put_message_error_entries);
        formatter.finish()
    }
}
...
pub struct BatchDeleteDetectorOutput  {
    ...
    #[doc(hidden)]pub batch_delete_detector_error_entries: std::option::Option<std::vec::Vec<crate::model::BatchDeleteDetectorErrorEntry>>,
}
impl BatchDeleteDetectorOutput {
    /// <p>A list of errors associated with the request, or an empty array (<code>[]</code>) if there are no errors. Each error entry contains a <code>messageId</code> that helps you identify the entry that failed.</p>
    pub fn batch_delete_detector_error_entries(&self) -> std::option::Option<& [crate::model::BatchDeleteDetectorErrorEntry]> {
...
impl  std::fmt::Debug for BatchDeleteDetectorOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("batch_delete_detector_error_entries", &self.batch_delete_detector_error_entries);
        formatter.finish()
    }
}
...
pub mod batch_delete_detector_output {
    ...
    impl Builder {
        ...
        ///
        /// <p>A list of errors associated with the request, or an empty array (<code>[]</code>) if there are no errors. Each error entry contains a <code>messageId</code> that helps you identify the entry that failed.</p>
        pub fn batch_delete_detector_error_entries(mut self, input: crate::model::BatchDeleteDetectorErrorEntry) -> Self {
