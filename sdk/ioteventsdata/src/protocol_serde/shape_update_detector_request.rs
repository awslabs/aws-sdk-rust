...
pub fn ser_update_detector_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateDetectorRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
