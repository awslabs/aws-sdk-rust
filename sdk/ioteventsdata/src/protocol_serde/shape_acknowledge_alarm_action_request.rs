...
pub fn ser_acknowledge_alarm_action_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AcknowledgeAlarmActionRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
