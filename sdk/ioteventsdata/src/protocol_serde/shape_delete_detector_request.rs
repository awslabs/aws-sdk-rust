...
pub fn ser_delete_detector_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeleteDetectorRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
