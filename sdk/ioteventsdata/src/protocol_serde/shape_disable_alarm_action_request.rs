...
pub fn ser_disable_alarm_action_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DisableAlarmActionRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
