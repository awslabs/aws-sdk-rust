...
impl super::Client {
    ...
    ///   - [`detector_model_name(impl Into<String>)`](crate::operation::list_detectors::builders::ListDetectorsFluentBuilder::detector_model_name) / [`set_detector_model_name(Option<String>)`](crate::operation::list_detectors::builders::ListDetectorsFluentBuilder::set_detector_model_name):<br>required: **true**<br><p>The name of the detector model whose detectors (instances) are listed.</p><br>
    ///   - [`state_name(impl Into<String>)`](crate::operation::list_detectors::builders::ListDetectorsFluentBuilder::state_name) / [`set_state_name(Option<String>)`](crate::operation::list_detectors::builders::ListDetectorsFluentBuilder::set_state_name):<br>required: **false**<br><p>A filter that limits results to those detectors (instances) in the given state.</p><br>
