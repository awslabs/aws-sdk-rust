...
impl super::Client {
    ...
    ///   - [`detectors(UpdateDetectorRequest)`](crate::operation::batch_update_detector::builders::BatchUpdateDetectorFluentBuilder::detectors) / [`set_detectors(Option<Vec::<UpdateDetectorRequest>>)`](crate::operation::batch_update_detector::builders::BatchUpdateDetectorFluentBuilder::set_detectors):<br>required: **true**<br><p>The list of detectors (instances) to update, along with the values to update.</p><br>
