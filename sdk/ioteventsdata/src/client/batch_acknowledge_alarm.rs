...
impl super::Client {
    ...
    ///   - [`acknowledge_action_requests(AcknowledgeAlarmActionRequest)`](crate::operation::batch_acknowledge_alarm::builders::BatchAcknowledgeAlarmFluentBuilder::acknowledge_action_requests) / [`set_acknowledge_action_requests(Option<Vec::<AcknowledgeAlarmActionRequest>>)`](crate::operation::batch_acknowledge_alarm::builders::BatchAcknowledgeAlarmFluentBuilder::set_acknowledge_action_requests):<br>required: **true**<br><p>The list of acknowledge action requests. You can specify up to 10 requests per operation.</p><br>
