...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("ioteventsdata", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS IoT Events Data.
pub mod client;
