...
pub fn serialize_structure_batch_acknowledge_alarm_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_acknowledge_alarm_action_request(
                    &mut object_4,
                    item_3,
                );
                object_4.finish();
...
pub fn serialize_structure_batch_disable_alarm_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_7 in var_5 {
            {
                ...
                crate::json_ser::serialize_structure_disable_alarm_action_request(
                    &mut object_8,
                    item_7,
                );
                object_8.finish();
...
pub fn serialize_structure_batch_enable_alarm_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_11 in var_9 {
            {
                ...
                crate::json_ser::serialize_structure_enable_alarm_action_request(
                    &mut object_12,
                    item_11,
                );
                object_12.finish();
        ...
        for item_15 in var_13 {
            {
                ...
                crate::json_ser::serialize_structure_message(&mut object_16, item_15);
                object_16.finish();
            }
        }
        array_14.finish();
...
pub fn serialize_structure_batch_reset_alarm_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_19 in var_17 {
            {
                ...
                crate::json_ser::serialize_structure_reset_alarm_action_request(
                    &mut object_20,
                    item_19,
                );
                object_20.finish();
...
pub fn serialize_structure_batch_snooze_alarm_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_23 in var_21 {
            {
                ...
                crate::json_ser::serialize_structure_snooze_alarm_action_request(
                    &mut object_24,
                    item_23,
                );
                object_24.finish();
...
pub fn serialize_structure_batch_update_detector_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_27 in var_25 {
            {
                ...
                crate::json_ser::serialize_structure_update_detector_request(
                    &mut object_28,
                    item_27,
                );
                object_28.finish();
...
pub fn serialize_structure_acknowledge_alarm_action_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disable_alarm_action_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_enable_alarm_action_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_message(
    ...
    if let Some(var_44) = &input.timestamp {
        ...
        crate::json_ser::serialize_structure_timestamp_value(&mut object_45, var_44);
        object_45.finish();
    }
}

pub fn serialize_structure_reset_alarm_action_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_snooze_alarm_action_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_detector_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_58) = &input.state {
        ...
        crate::json_ser::serialize_structure_detector_state_definition(&mut object_59, var_58);
        object_59.finish();
    }
}

pub fn serialize_structure_timestamp_value(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_detector_state_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_64 in var_62 {
            {
                ...
                crate::json_ser::serialize_structure_variable_definition(&mut object_65, item_64);
                object_65.finish();
            }
        }
        array_63.finish();
        ...
        for item_68 in var_66 {
            {
                ...
                crate::json_ser::serialize_structure_timer_definition(&mut object_69, item_68);
                object_69.finish();
            }
        }
        array_67.finish();
...
pub fn serialize_structure_variable_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_timer_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
