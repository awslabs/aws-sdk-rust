...
pub fn de_get_cluster_http_error(
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::operation::get_cluster::GetClusterError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_get_cluster_input(
    input: &crate::operation::get_cluster::GetClusterInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_get_cluster_input::ser_get_cluster_input_input(&mut object, input)?;
    object.finish();
