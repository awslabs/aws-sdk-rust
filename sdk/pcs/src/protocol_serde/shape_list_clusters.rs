...
pub fn de_list_clusters_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_clusters::ListClustersError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::list_clusters::ListClustersError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::list_clusters::ListClustersError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::list_clusters::ListClustersError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::list_clusters::ListClustersError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::list_clusters::ListClustersError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_clusters_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_clusters_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_clusters::ListClustersError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "clusters" => {
                    builder = builder.set_clusters(crate::protocol_serde::shape_cluster_list::de_cluster_list(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
