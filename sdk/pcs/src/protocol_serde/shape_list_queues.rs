...
pub fn de_list_queues_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_queues::ListQueuesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::list_queues::ListQueuesError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::list_queues::ListQueuesError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::list_queues::ListQueuesError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::list_queues::ListQueuesError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_list_queues_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_queues_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_queues::ListQueuesError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_queues::builders::ListQueuesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "queues" => {
                    builder = builder.set_queues(crate::protocol_serde::shape_queue_list::de_queue_list(tokens)?);
                }
                "nextToken" => {
