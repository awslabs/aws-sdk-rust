...
impl super::Client {
    ...
    ///   - [`cluster_identifier(impl Into<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::set_cluster_identifier):<br>required: **true**<br><p>The name or ID of the cluster to delete.</p><br>
