...
pub struct QueueSlurmConfigurationRequest {
...
impl QueueSlurmConfigurationRequest {
    /// <p>Additional Slurm-specific configuration that directly maps to Slurm settings.</p>
    ///
...
impl QueueSlurmConfigurationRequest {
    /// Creates a new builder-style object to manufacture [`QueueSlurmConfigurationRequest`](crate::types::QueueSlurmConfigurationRequest).
    pub fn builder() -> crate::types::builders::QueueSlurmConfigurationRequestBuilder {
        crate::types::builders::QueueSlurmConfigurationRequestBuilder::default()
    }
}

/// A builder for [`QueueSlurmConfigurationRequest`](crate::types::QueueSlurmConfigurationRequest).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct QueueSlurmConfigurationRequestBuilder {
    pub(crate) slurm_custom_settings: ::std::option::Option<::std::vec::Vec<crate::types::SlurmCustomSetting>>,
}
impl QueueSlurmConfigurationRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`QueueSlurmConfigurationRequest`](crate::types::QueueSlurmConfigurationRequest).
    pub fn build(self) -> crate::types::QueueSlurmConfigurationRequest {
        crate::types::QueueSlurmConfigurationRequest {
