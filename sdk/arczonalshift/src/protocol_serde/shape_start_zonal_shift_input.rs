...
pub fn ser_start_zonal_shift_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartZonalShiftInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
