...
impl ConflictExceptionReason {
    ...
    ConflictExceptionReason::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AutoShiftEnabled", "PracticeConfigurationAlreadyExists", "PracticeConfigurationDoesNotExist", "SimultaneousZonalShiftsConflict", "ZonalShiftAlreadyExists", "ZonalShiftStatusNotActive"]
                }
            }
