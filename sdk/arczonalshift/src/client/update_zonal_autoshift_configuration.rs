...
impl super::Client {
    ...
    pub fn update_zonal_autoshift_configuration(&self) -> crate::operation::update_zonal_autoshift_configuration::builders::UpdateZonalAutoshiftConfigurationFluentBuilder {
