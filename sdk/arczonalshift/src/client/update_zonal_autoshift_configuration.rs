...
impl super::Client {
    ...
    ///   - [`zonal_autoshift_status(ZonalAutoshiftStatus)`](crate::operation::update_zonal_autoshift_configuration::UpdateZonalAutoshiftConfigurationOutput::zonal_autoshift_status): <p>The updated zonal autoshift status for the resource.</p>
