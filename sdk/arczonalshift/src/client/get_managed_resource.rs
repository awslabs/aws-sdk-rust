...
impl super::Client {
    ...
    ///   - [`resource_identifier(impl Into<String>)`](crate::operation::get_managed_resource::builders::GetManagedResourceFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::get_managed_resource::builders::GetManagedResourceFluentBuilder::set_resource_identifier):<br>required: **true**<br><p>The identifier for the resource that Amazon Web Services shifts traffic for. The identifier is the Amazon Resource Name (ARN) for the resource.</p> <p>At this time, supported resources are Network Load Balancers and Application Load Balancers with cross-zone load balancing turned off.</p><br>
