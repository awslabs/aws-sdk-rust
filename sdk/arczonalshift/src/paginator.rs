...
impl ListManagedResourcesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_structure_crate_output_list_managed_resources_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListZonalShiftsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_structure_crate_output_list_zonal_shifts_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
