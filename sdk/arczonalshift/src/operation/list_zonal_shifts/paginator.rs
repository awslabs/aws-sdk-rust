...
impl ListZonalShiftsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_zonal_shifts::paginator::ListZonalShiftsPaginatorItems {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_zonal_shifts_output_next_token(resp);
...
impl ListZonalShiftsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_zonal_shifts_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
