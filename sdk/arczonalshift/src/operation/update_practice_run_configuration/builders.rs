...
impl UpdatePracticeRunConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_practice_run_configuration::UpdatePracticeRunConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_practice_run_configuration::UpdatePracticeRunConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_practice_run_configuration::UpdatePracticeRunConfigurationOutput, crate::operation::update_practice_run_configuration::UpdatePracticeRunConfigurationError, Self> {
