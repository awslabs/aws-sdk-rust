...
impl GetManagedResourceFluentBuilder  {
    /// Creates a new `GetManagedResource`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_managed_resource::GetManagedResourceOutput, aws_smithy_http::result::SdkError<crate::operation::get_managed_resource::GetManagedResourceError>>
                     {
