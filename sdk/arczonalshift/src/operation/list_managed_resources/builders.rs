...
impl ListManagedResourcesFluentBuilder  {
    /// Creates a new `ListManagedResources`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_managed_resources::ListManagedResourcesOutput, aws_smithy_http::result::SdkError<crate::operation::list_managed_resources::ListManagedResourcesError>>
                     {
