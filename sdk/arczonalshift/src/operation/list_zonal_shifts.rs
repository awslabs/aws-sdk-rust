...
impl ListZonalShiftsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_zonal_shifts::ListZonalShifts, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListZonalShifts {
    type Output =
        ::std::result::Result<crate::operation::list_zonal_shifts::ListZonalShiftsOutput, crate::operation::list_zonal_shifts::ListZonalShiftsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_zonal_shifts::de_list_zonal_shifts_http_response_with_props(status, headers, body)
        }
    }
}
