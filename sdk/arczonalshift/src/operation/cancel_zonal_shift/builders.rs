...
impl crate::operation::cancel_zonal_shift::builders::CancelZonalShiftInputBuilder {
...
///
/// <p>Cancel a zonal shift in Amazon Application Recovery Controller. To cancel the zonal shift, specify the zonal shift ID.</p>
...
impl CancelZonalShiftFluentBuilder {
    /// Creates a new `CancelZonalShiftFluentBuilder`.
