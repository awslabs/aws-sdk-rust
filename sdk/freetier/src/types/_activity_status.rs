...
impl ::std::convert::From<&str> for ActivityStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "EXPIRING" => ActivityStatus::Expiring,
            "IN_PROGRESS" => ActivityStatus::InProgress,
            "NOT_STARTED" => ActivityStatus::NotStarted,
...
impl ActivityStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ActivityStatus::Expiring => "EXPIRING",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["COMPLETED", "EXPIRING", "IN_PROGRESS", "NOT_STARTED"]
    }
}
