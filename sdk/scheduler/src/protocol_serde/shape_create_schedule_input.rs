...
pub fn ser_create_schedule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateScheduleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
