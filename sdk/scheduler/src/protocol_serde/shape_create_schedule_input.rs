...
pub fn ser_create_schedule_input_input(
    ...
    if let Some(var_4) = &input.end_date {
        object.key("EndDate").date_time(var_4, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_11) = &input.start_date {
        object.key("StartDate").date_time(var_11, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
