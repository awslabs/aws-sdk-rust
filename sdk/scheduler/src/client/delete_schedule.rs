...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_schedule::builders::DeleteScheduleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_schedule::builders::DeleteScheduleFluentBuilder::set_name): <p>The name of the schedule to delete.</p>
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_schedule::builders::DeleteScheduleFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::delete_schedule::builders::DeleteScheduleFluentBuilder::set_group_name): <p>The name of the schedule group associated with this schedule. If you omit this, the default schedule group is used.</p>
