...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_schedule::builders::DeleteScheduleFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::delete_schedule::builders::DeleteScheduleFluentBuilder::set_name):<br>required: **true**<br><p>The name of the schedule to delete.</p><br>
