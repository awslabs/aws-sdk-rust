...
impl super::Client {
    ...
    ///   - [`name_prefix(impl ::std::convert::Into<String>)`](crate::operation::list_schedule_groups::builders::ListScheduleGroupsFluentBuilder::name_prefix) / [`set_name_prefix(Option<String>)`](crate::operation::list_schedule_groups::builders::ListScheduleGroupsFluentBuilder::set_name_prefix): <p>The name prefix that you can use to return a filtered list of your schedule groups.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_schedule_groups::builders::ListScheduleGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_schedule_groups::builders::ListScheduleGroupsFluentBuilder::set_next_token): <p>The token returned by a previous call to retrieve the next set of results.</p>
