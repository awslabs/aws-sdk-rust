...
impl ListScheduleGroupsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_schedule_groups::paginator::ListScheduleGroupsPaginator {
        crate::operation::list_schedule_groups::paginator::ListScheduleGroupsPaginator::new(
            self.handle,
            self.inner,
        )
    }
