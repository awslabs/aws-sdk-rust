...
pub use crate::operation::create_schedule_group::_create_schedule_group_output::CreateScheduleGroupOutputBuilder;
...
pub struct CreateScheduleGroupFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_schedule_group::builders::CreateScheduleGroupInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_schedule_group::CreateScheduleGroupOutput,
                    crate::operation::create_schedule_group::CreateScheduleGroupError,
                > for CreateScheduleGroupFluentBuilder
            {
                fn send(
                    self,
...
impl CreateScheduleGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_schedule_group::CreateScheduleGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_schedule_group::CreateScheduleGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_schedule_group::CreateScheduleGroup::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_schedule_group::CreateScheduleGroup::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_schedule_group::CreateScheduleGroupOutput, crate::operation::create_schedule_group::CreateScheduleGroupError, Self> {
