...
impl ListScheduleGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_schedule_groups::ListScheduleGroups,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListScheduleGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_schedule_groups::de_list_schedule_groups_http_response_with_props(status, headers, body)
        }
    }
}
