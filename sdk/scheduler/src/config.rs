...
impl Builder {
    ...
    /// use aws_sdk_scheduler::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_scheduler::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
