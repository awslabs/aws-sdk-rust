...
impl NotifyApplicationStateInput {
    /// Consumes the builder and constructs an Operation<[`NotifyApplicationState`](crate::operation::notify_application_state::NotifyApplicationState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::notify_application_state::NotifyApplicationState, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::notify_application_state::NotifyApplicationStateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::notify_application_state::NotifyApplicationState::new())
...
impl aws_smithy_http::response::ParseStrictResponse for NotifyApplicationState {
                type Output = std::result::Result<crate::operation::notify_application_state::NotifyApplicationStateOutput, crate::operation::notify_application_state::NotifyApplicationStateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_notify_application_state::de_notify_application_state_http_error(response)
                     } else {
                        crate::protocol_serde::shape_notify_application_state::de_notify_application_state_http_response(response)
                     }
                }
            }
