...
/// Orchestration and serialization glue logic for `NotifyApplicationState`.
...
impl NotifyApplicationState {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::notify_application_state::NotifyApplicationStateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::notify_application_state::NotifyApplicationStateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::notify_application_state::NotifyApplicationStateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::notify_application_state::NotifyApplicationStateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for NotifyApplicationState {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("NotifyApplicationState");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(NotifyApplicationStateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(NotifyApplicationStateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("NotifyApplicationState")
...
.with_interceptor(NotifyApplicationStateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::notify_application_state::NotifyApplicationStateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::notify_application_state::NotifyApplicationStateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::notify_application_state::NotifyApplicationStateError>::new());
...
#[derive(Debug)]
            struct NotifyApplicationStateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for NotifyApplicationStateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_notify_application_state::de_notify_application_state_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct NotifyApplicationStateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for NotifyApplicationStateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::notify_application_state::NotifyApplicationStateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::notify_application_state::NotifyApplicationStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_notify_application_state::ser_notify_application_state_input(&input)?);
...
#[derive(Debug)]
            struct NotifyApplicationStateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for NotifyApplicationStateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "NotifyApplicationStateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<NotifyApplicationStateInput>()
                        .ok_or("failed to downcast to NotifyApplicationStateInput")?;
...
pub enum NotifyApplicationStateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-NotifyApplicationStateError) for what information is available for the error.")]
...
impl NotifyApplicationStateError {
    /// Creates the `NotifyApplicationStateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `NotifyApplicationStateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PolicyErrorException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for NotifyApplicationStateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::notify_application_state::NotifyApplicationStateError {
...
mod _notify_application_state_output;
