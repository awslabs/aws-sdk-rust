...
impl DeleteProgressUpdateStreamInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_progress_update_stream::DeleteProgressUpdateStream::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProgressUpdateStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_progress_update_stream::de_delete_progress_update_stream_http_response_with_props(
                status, headers, body,
            )
        }
    }
