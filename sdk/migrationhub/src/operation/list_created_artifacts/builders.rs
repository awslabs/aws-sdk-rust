...
pub use crate::operation::list_created_artifacts::_list_created_artifacts_output::ListCreatedArtifactsOutputBuilder;
...
pub struct ListCreatedArtifactsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_created_artifacts::builders::ListCreatedArtifactsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_created_artifacts::ListCreatedArtifactsOutput,
                    crate::operation::list_created_artifacts::ListCreatedArtifactsError,
                > for ListCreatedArtifactsFluentBuilder
            {
                fn send(
                    self,
...
impl ListCreatedArtifactsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_created_artifacts::ListCreatedArtifactsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_created_artifacts::ListCreatedArtifactsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_created_artifacts::ListCreatedArtifacts::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_created_artifacts::ListCreatedArtifactsOutput, crate::operation::list_created_artifacts::ListCreatedArtifactsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_created_artifacts::paginator::ListCreatedArtifactsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
