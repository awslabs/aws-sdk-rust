...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_progress_update_streams::ListProgressUpdateStreamsOutput,
                    crate::operation::list_progress_update_streams::ListProgressUpdateStreamsError,
                > for ListProgressUpdateStreamsFluentBuilder
            {
                fn send(
                    self,
...
impl ListProgressUpdateStreamsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_progress_update_streams::ListProgressUpdateStreamsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_progress_update_streams::ListProgressUpdateStreamsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_progress_update_streams::ListProgressUpdateStreams::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_progress_update_streams::ListProgressUpdateStreamsOutput, crate::operation::list_progress_update_streams::ListProgressUpdateStreamsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_progress_update_streams::paginator::ListProgressUpdateStreamsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
