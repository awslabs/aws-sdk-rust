...
impl CreateProgressUpdateStreamInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_progress_update_stream::CreateProgressUpdateStream::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProgressUpdateStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_progress_update_stream::de_create_progress_update_stream_http_response_with_props(
                status, headers, body,
            )
        }
    }
