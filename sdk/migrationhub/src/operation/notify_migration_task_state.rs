...
/// Orchestration and serialization glue logic for `NotifyMigrationTaskState`.
...
impl NotifyMigrationTaskState {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for NotifyMigrationTaskState {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("NotifyMigrationTaskState");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(NotifyMigrationTaskStateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(NotifyMigrationTaskStateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("NotifyMigrationTaskState")
...
.with_interceptor(NotifyMigrationTaskStateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError>::new());
...
#[derive(Debug)]
            struct NotifyMigrationTaskStateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for NotifyMigrationTaskStateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_notify_migration_task_state::de_notify_migration_task_state_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_notify_migration_task_state::de_notify_migration_task_state_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct NotifyMigrationTaskStateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for NotifyMigrationTaskStateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::notify_migration_task_state::NotifyMigrationTaskStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_notify_migration_task_state::ser_notify_migration_task_state_input(&input)?);
...
#[derive(Debug)]
            struct NotifyMigrationTaskStateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for NotifyMigrationTaskStateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "NotifyMigrationTaskStateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<NotifyMigrationTaskStateInput>()
                        .ok_or("failed to downcast to NotifyMigrationTaskStateInput")?;
...
pub enum NotifyMigrationTaskStateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-NotifyMigrationTaskStateError) for what information is available for the error.")]
...
impl NotifyMigrationTaskStateError {
    /// Creates the `NotifyMigrationTaskStateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `NotifyMigrationTaskStateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DryRunOperation(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for NotifyMigrationTaskStateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError {
...
mod _notify_migration_task_state_output;
