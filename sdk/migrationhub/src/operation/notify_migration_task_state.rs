...
impl NotifyMigrationTaskStateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::notify_migration_task_state::NotifyMigrationTaskState::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for NotifyMigrationTaskState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_notify_migration_task_state::de_notify_migration_task_state_http_response_with_props(status, headers, body)
        }
    }
}
