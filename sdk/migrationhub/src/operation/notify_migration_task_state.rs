...
impl NotifyMigrationTaskStateInput {
    /// Consumes the builder and constructs an Operation<[`NotifyMigrationTaskState`](crate::operation::notify_migration_task_state::NotifyMigrationTaskState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::notify_migration_task_state::NotifyMigrationTaskState, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::notify_migration_task_state::NotifyMigrationTaskStateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::notify_migration_task_state::NotifyMigrationTaskState::new())
...
impl aws_smithy_http::response::ParseStrictResponse for NotifyMigrationTaskState {
                type Output = std::result::Result<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateOutput, crate::operation::notify_migration_task_state::NotifyMigrationTaskStateError>;
