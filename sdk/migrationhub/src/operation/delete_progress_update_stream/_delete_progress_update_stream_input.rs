...
impl DeleteProgressUpdateStreamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_progress_update_stream::DeleteProgressUpdateStreamInput, ::aws_smithy_types::error::operation::BuildError> {
