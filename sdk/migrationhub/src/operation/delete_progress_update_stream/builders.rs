...
impl DeleteProgressUpdateStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_progress_update_stream::DeleteProgressUpdateStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_progress_update_stream::DeleteProgressUpdateStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_progress_update_stream::DeleteProgressUpdateStreamOutput, crate::operation::delete_progress_update_stream::DeleteProgressUpdateStreamError, Self> {
