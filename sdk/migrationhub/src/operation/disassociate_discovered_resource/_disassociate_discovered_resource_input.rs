...
impl DisassociateDiscoveredResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_discovered_resource::DisassociateDiscoveredResourceInput, ::aws_smithy_types::error::operation::BuildError> {
