...
impl NotifyMigrationTaskStateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::notify_migration_task_state::NotifyMigrationTaskStateInput, ::aws_smithy_types::error::operation::BuildError> {
