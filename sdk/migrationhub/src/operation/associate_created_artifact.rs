...
impl AssociateCreatedArtifactInput {
    /// Consumes the builder and constructs an Operation<[`AssociateCreatedArtifact`](crate::operation::associate_created_artifact::AssociateCreatedArtifact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_created_artifact::AssociateCreatedArtifact, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_created_artifact::AssociateCreatedArtifactInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_created_artifact::AssociateCreatedArtifact::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateCreatedArtifact {
                type Output = std::result::Result<crate::operation::associate_created_artifact::AssociateCreatedArtifactOutput, crate::operation::associate_created_artifact::AssociateCreatedArtifactError>;
