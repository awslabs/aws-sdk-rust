...
impl AssociateCreatedArtifactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_created_artifact::AssociateCreatedArtifactInput, ::aws_smithy_types::error::operation::BuildError> {
