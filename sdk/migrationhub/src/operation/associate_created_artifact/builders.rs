...
impl AssociateCreatedArtifactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_created_artifact::AssociateCreatedArtifactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_created_artifact::AssociateCreatedArtifactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_created_artifact::AssociateCreatedArtifactOutput, crate::operation::associate_created_artifact::AssociateCreatedArtifactError, Self> {
