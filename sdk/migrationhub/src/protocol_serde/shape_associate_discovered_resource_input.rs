...
pub fn ser_associate_discovered_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateDiscoveredResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
