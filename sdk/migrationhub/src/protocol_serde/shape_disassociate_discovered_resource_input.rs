...
pub fn ser_disassociate_discovered_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::disassociate_discovered_resource::DisassociateDiscoveredResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
