...
pub fn ser_disassociate_discovered_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateDiscoveredResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
