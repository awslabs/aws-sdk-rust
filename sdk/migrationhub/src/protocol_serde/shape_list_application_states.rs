...
pub fn ser_list_application_states_input(input: &crate::operation::list_application_states::ListApplicationStatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
