...
pub fn ser_disassociate_source_resource_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::disassociate_source_resource::DisassociateSourceResourceInput,
    ...
    if let Some(var_3) = &input.source_resource_name {
        object.key("SourceResourceName").string(var_3.as_str());
    }
