...
/// match updatetype {
///     UpdateType::MigrationTaskStateUpdated => { /* ... */ },
...
impl ::std::convert::From<&str> for UpdateType {
    fn from(s: &str) -> Self {
        match s {
            "MIGRATION_TASK_STATE_UPDATED" => UpdateType::MigrationTaskStateUpdated,
...
impl UpdateType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            UpdateType::MigrationTaskStateUpdated => "MIGRATION_TASK_STATE_UPDATED",
