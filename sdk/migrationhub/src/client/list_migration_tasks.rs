...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_migration_tasks::builders::ListMigrationTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_migration_tasks::builders::ListMigrationTasksFluentBuilder::set_next_token): <p>If a <code>NextToken</code> was returned by a previous call, there are more results available. To retrieve the next page of results, make the call again using the returned token in <code>NextToken</code>.</p>
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::list_migration_tasks::builders::ListMigrationTasksFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::list_migration_tasks::builders::ListMigrationTasksFluentBuilder::set_resource_name): <p>Filter migration tasks by discovered resource name.</p>
