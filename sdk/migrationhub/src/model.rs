...
pub struct ResourceAttribute  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ResourceAttributeType>,
...
pub mod resource_attribute {
    ...
    impl Builder {
        ...
        /// <p>Type of resource.</p>
        pub fn set_type(mut self, input: std::option::Option<crate::model::ResourceAttributeType>) -> Self {
...
pub struct Task  {
    ...
    #[doc(hidden)]pub progress_percent: std::option::Option<i32>,
}
impl Task {
    /// <p>Status of the task - Not Started, In-Progress, Complete.</p>
...
pub struct ProgressUpdateStreamSummary  {
    ...
    #[doc(hidden)]pub progress_update_stream_name: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ProgressUpdateStreamSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("progress_update_stream_name", &self.progress_update_stream_name);
        formatter.finish()
    }
}
...
pub struct MigrationTaskSummary  {
    ...
    #[doc(hidden)]pub progress_update_stream: std::option::Option<std::string::String>,
    /// <p>Unique identifier that references the migration task. <i>Do not store personal data in this field.</i> </p>
    #[doc(hidden)]pub migration_task_name: std::option::Option<std::string::String>,
...
pub struct MigrationTask  {
    ...
    #[doc(hidden)]pub resource_attribute_list: std::option::Option<std::vec::Vec<crate::model::ResourceAttribute>>,
}
impl MigrationTask {
    /// <p>A name that identifies the vendor of the migration tool being used.</p>
    pub fn progress_update_stream(&self) -> std::option::Option<& str> {
