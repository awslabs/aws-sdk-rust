...
/// [`associate_created_artifact`](crate::client::fluent_builders::AssociateCreatedArtifact).
///
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateCreatedArtifact {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_associate_created_artifact::de_associate_created_artifact_http_error(response)
        } else {
            crate::protocol_serde::shape_associate_created_artifact::de_associate_created_artifact_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`associate_discovered_resource`](crate::client::fluent_builders::AssociateDiscoveredResource).
///
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateDiscoveredResource {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_associate_discovered_resource::de_associate_discovered_resource_http_error(response)
        } else {
            crate::protocol_serde::shape_associate_discovered_resource::de_associate_discovered_resource_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`create_progress_update_stream`](crate::client::fluent_builders::CreateProgressUpdateStream).
///
...
impl aws_smithy_http::response::ParseStrictResponse for CreateProgressUpdateStream {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_progress_update_stream::de_create_progress_update_stream_http_error(response)
        } else {
            crate::protocol_serde::shape_create_progress_update_stream::de_create_progress_update_stream_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`delete_progress_update_stream`](crate::client::fluent_builders::DeleteProgressUpdateStream).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteProgressUpdateStream {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_progress_update_stream::de_delete_progress_update_stream_http_error(response)
        } else {
            crate::protocol_serde::shape_delete_progress_update_stream::de_delete_progress_update_stream_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`describe_application_state`](crate::client::fluent_builders::DescribeApplicationState).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeApplicationState {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_application_state::de_describe_application_state_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_application_state::de_describe_application_state_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`describe_migration_task`](crate::client::fluent_builders::DescribeMigrationTask).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMigrationTask {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_migration_task::de_describe_migration_task_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_migration_task::de_describe_migration_task_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`disassociate_created_artifact`](crate::client::fluent_builders::DisassociateCreatedArtifact).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateCreatedArtifact {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_disassociate_created_artifact::de_disassociate_created_artifact_http_error(response)
        } else {
            crate::protocol_serde::shape_disassociate_created_artifact::de_disassociate_created_artifact_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`disassociate_discovered_resource`](crate::client::fluent_builders::DisassociateDiscoveredResource).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateDiscoveredResource {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_disassociate_discovered_resource::de_disassociate_discovered_resource_http_error(response)
        } else {
            crate::protocol_serde::shape_disassociate_discovered_resource::de_disassociate_discovered_resource_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`import_migration_task`](crate::client::fluent_builders::ImportMigrationTask).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ImportMigrationTask {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_import_migration_task::de_import_migration_task_http_error(
                response,
            )
        } else {
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_application_states`](crate::client::fluent_builders::ListApplicationStates).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ListApplicationStates {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_application_states::de_list_application_states_http_error(response)
        } else {
            crate::protocol_serde::shape_list_application_states::de_list_application_states_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_created_artifacts`](crate::client::fluent_builders::ListCreatedArtifacts).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_migration_tasks`](crate::client::fluent_builders::ListMigrationTasks).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ListMigrationTasks {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_migration_tasks::de_list_migration_tasks_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_migration_tasks::de_list_migration_tasks_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_progress_update_streams`](crate::client::fluent_builders::ListProgressUpdateStreams).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ListProgressUpdateStreams {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_progress_update_streams::de_list_progress_update_streams_http_error(response)
        } else {
            crate::protocol_serde::shape_list_progress_update_streams::de_list_progress_update_streams_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`notify_application_state`](crate::client::fluent_builders::NotifyApplicationState).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`notify_migration_task_state`](crate::client::fluent_builders::NotifyMigrationTaskState).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`put_resource_attributes`](crate::client::fluent_builders::PutResourceAttributes).
///
