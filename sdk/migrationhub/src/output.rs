...
pub struct ListProgressUpdateStreamsOutput  {
    ...
    #[doc(hidden)]pub progress_update_stream_summary_list: std::option::Option<std::vec::Vec<crate::model::ProgressUpdateStreamSummary>>,
...
impl  std::fmt::Debug for ListProgressUpdateStreamsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("progress_update_stream_summary_list", &self.progress_update_stream_summary_list);
...
pub struct ListMigrationTasksOutput  {
    ...
    #[doc(hidden)]pub migration_task_summary_list: std::option::Option<std::vec::Vec<crate::model::MigrationTaskSummary>>,
}
...
impl  std::fmt::Debug for ListMigrationTasksOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("migration_task_summary_list", &self.migration_task_summary_list);
        formatter.finish()
    }
}
...
pub struct ListDiscoveredResourcesOutput  {
    ...
    #[doc(hidden)]pub discovered_resource_list: std::option::Option<std::vec::Vec<crate::model::DiscoveredResource>>,
}
...
pub struct ListCreatedArtifactsOutput  {
    ...
    #[doc(hidden)]pub created_artifact_list: std::option::Option<std::vec::Vec<crate::model::CreatedArtifact>>,
}
...
pub struct ListApplicationStatesOutput  {
    ...
    #[doc(hidden)]pub application_state_list: std::option::Option<std::vec::Vec<crate::model::ApplicationState>>,
...
pub struct DescribeMigrationTaskOutput  {
    ...
    #[doc(hidden)]pub migration_task: std::option::Option<crate::model::MigrationTask>,
}
