...
/// For example, the [`AssociateCreatedArtifact`](crate::operation) operation has
...
mod associate_created_artifact;

mod associate_discovered_resource;

mod create_progress_update_stream;

mod delete_progress_update_stream;

mod describe_application_state;

mod describe_migration_task;

mod disassociate_created_artifact;
...
mod notify_migration_task_state;

mod put_resource_attributes;
