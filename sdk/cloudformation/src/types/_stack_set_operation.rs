...
pub struct StackSetOperation {
    ...
    /// <p>The Amazon Resource Name (ARN) of the IAM role used to perform this StackSet operation.</p>
    ...
    /// <p>Use customized execution roles to control which stack resources users and groups can include in their StackSets.</p>
    ...
    /// <p>Detailed information about the drift status of the StackSet. This includes information about drift operations currently being performed on the StackSet.</p>
    /// <p>This information will only be present for StackSet operations whose <code>Action</code> type is <code>DETECT_DRIFT</code>.</p>
