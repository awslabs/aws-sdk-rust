...
pub struct StackEvent {
    ...
    pub hook_invocation_id: ::std::option::Option<::std::string::String>,
...
impl StackEvent {
    ...
    /// <p>The unique identifier of the Hook invocation.</p>
    pub fn hook_invocation_id(&self) -> ::std::option::Option<&str> {
        self.hook_invocation_id.as_deref()
    }
    /// <p>Specify the Hook failure mode for non-compliant resources in the followings ways.</p>
    /// <ul>
    /// <li>
...
pub struct StackEventBuilder {
    ...
    pub(crate) hook_invocation_id: ::std::option::Option<::std::string::String>,
...
impl StackEventBuilder {
    ...
    /// <p>The unique identifier of the Hook invocation.</p>
    pub fn hook_invocation_id(mut self, input: impl ::std::convert::Into<::std::string::String>) -> Self {
        self.hook_invocation_id = ::std::option::Option::Some(input.into());
        self
    }
    /// <p>The unique identifier of the Hook invocation.</p>
    pub fn set_hook_invocation_id(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.hook_invocation_id = input;
        self
    }
    /// <p>The unique identifier of the Hook invocation.</p>
    pub fn get_hook_invocation_id(&self) -> &::std::option::Option<::std::string::String> {
