...
pub struct StackSetSummary {
    ...
    /// <p>Status of the StackSet's actual configuration compared to its expected template and parameter configuration.</p>
    /// <ul>
    /// <li>
    /// <p><code>DRIFTED</code>: One or more of the stack instances belonging to the StackSet differs from the expected template and parameter configuration. A stack instance is considered to have drifted if one or more of the resources in the associated stack have drifted.</p></li>
    /// <li>
    /// <p><code>NOT_CHECKED</code>: CloudFormation hasn't checked the StackSet for drift.</p></li>
    /// <li>
    /// <p><code>IN_SYNC</code>: All the stack instances belonging to the StackSet match the expected template and parameter configuration.</p></li>
    /// <li>
