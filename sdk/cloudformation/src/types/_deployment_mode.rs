...
impl ::std::convert::From<&str> for DeploymentMode {
    fn from(s: &str) -> Self {
        match s {
            "REVERT_DRIFT" => DeploymentMode::RevertDrift,
...
impl DeploymentMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DeploymentMode::RevertDrift => "REVERT_DRIFT",
...
impl ::std::fmt::Display for DeploymentMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DeploymentMode::RevertDrift => write!(f, "REVERT_DRIFT"),
