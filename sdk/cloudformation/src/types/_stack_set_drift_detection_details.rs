...
/// <p>For StackSets, contains information about the last <i>completed</i> drift operation performed on the StackSet. Information about drift operations in-progress isn't included.</p>
/// <p>For StackSet operations, includes information about drift operations currently being performed on the StackSet.</p>
...
pub struct StackSetDriftDetectionDetails {
    ...
    /// <li>
    /// <p><code>IN_SYNC</code>: All of the stack instances belonging to the StackSet stack match the expected template and parameter configuration.</p></li>
    /// </ul>
    ...
    /// <ul>
    /// <li>
    /// <p>Stack instances that match the StackSet configuration.</p></li>
    /// <li>
    /// <p>Stack instances that have drifted from the StackSet configuration.</p></li>
    /// <li>
