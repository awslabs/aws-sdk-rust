...
impl super::Client {
    ...
    pub fn delete_stack_set(
        &self,
    ) -> crate::operation::delete_stack_set::builders::DeleteStackSetFluentBuilder {
        crate::operation::delete_stack_set::builders::DeleteStackSetFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
