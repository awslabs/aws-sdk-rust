...
impl super::Client {
    ...
    ///   - [`operation_id(impl ::std::convert::Into<String>)`](crate::operation::detect_stack_set_drift::builders::DetectStackSetDriftFluentBuilder::operation_id) / [`set_operation_id(Option<String>)`](crate::operation::detect_stack_set_drift::builders::DetectStackSetDriftFluentBuilder::set_operation_id): <p> <i>The ID of the stack set operation.</i> </p>
