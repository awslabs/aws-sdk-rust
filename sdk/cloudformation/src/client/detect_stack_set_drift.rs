...
impl super::Client {
    ...
    ///   - [`operation_id(impl Into<String>)`](crate::operation::detect_stack_set_drift::builders::DetectStackSetDriftFluentBuilder::operation_id) / [`set_operation_id(Option<String>)`](crate::operation::detect_stack_set_drift::builders::DetectStackSetDriftFluentBuilder::set_operation_id): <p> <i>The ID of the stack set operation.</i> </p>
    ...
    ///   - [`operation_id(Option<String>)`](crate::operation::detect_stack_set_drift::DetectStackSetDriftOutput::operation_id): <p>The ID of the drift detection stack set operation.</p>  <p>You can use this operation ID with <code> <code>DescribeStackSetOperation</code> </code> to monitor the progress of the drift detection operation.</p>
