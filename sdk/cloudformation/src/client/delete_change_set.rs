...
impl super::Client {
    ...
    ///   - [`stack_name(impl Into<String>)`](crate::operation::delete_change_set::builders::DeleteChangeSetFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::delete_change_set::builders::DeleteChangeSetFluentBuilder::set_stack_name):<br>required: **false**<br><p>If you specified the name of a change set to delete, specify the stack name or Amazon Resource Name (ARN) that's associated with it.</p><br>
