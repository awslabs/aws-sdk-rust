...
impl super::Client {
    ...
    ///   - [`stack_name(impl Into<String>)`](crate::operation::detect_stack_resource_drift::builders::DetectStackResourceDriftFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::detect_stack_resource_drift::builders::DetectStackResourceDriftFluentBuilder::set_stack_name):<br>required: **true**<br><p>The name of the stack to which the resource belongs.</p><br>
    ///   - [`logical_resource_id(impl Into<String>)`](crate::operation::detect_stack_resource_drift::builders::DetectStackResourceDriftFluentBuilder::logical_resource_id) / [`set_logical_resource_id(Option<String>)`](crate::operation::detect_stack_resource_drift::builders::DetectStackResourceDriftFluentBuilder::set_logical_resource_id):<br>required: **true**<br><p>The logical name of the resource for which to return drift information.</p><br>
