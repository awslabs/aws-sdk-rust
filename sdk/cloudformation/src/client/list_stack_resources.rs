...
impl super::Client {
    ...
    ///   - [`stack_name(impl ::std::convert::Into<String>)`](crate::operation::list_stack_resources::builders::ListStackResourcesFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::list_stack_resources::builders::ListStackResourcesFluentBuilder::set_stack_name): <p>The name or the unique stack ID that is associated with the stack, which aren't always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_stack_resources::builders::ListStackResourcesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_stack_resources::builders::ListStackResourcesFluentBuilder::set_next_token): <p>A string that identifies the next page of stack resources that you want to retrieve.</p>
