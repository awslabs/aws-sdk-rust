...
impl super::Client {
    ...
    ///   - [`template_body(impl Into<String>)`](crate::operation::estimate_template_cost::builders::EstimateTemplateCostFluentBuilder::template_body) / [`set_template_body(Option<String>)`](crate::operation::estimate_template_cost::builders::EstimateTemplateCostFluentBuilder::set_template_body):<br>required: **false**<br><p>Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes.</p> <p>Conditional: You must pass <code>TemplateBody</code> or <code>TemplateURL</code>. If both are passed, only <code>TemplateBody</code> is used.</p><br>
