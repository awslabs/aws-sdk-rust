...
impl super::Client {
    ...
    ///   - [`stack_resource_detail(Option<StackResourceDetail>)`](crate::operation::describe_stack_resource::DescribeStackResourceOutput::stack_resource_detail): <p>A <code>StackResourceDetail</code> structure that contains the description of the specified resource in the specified stack.</p>
