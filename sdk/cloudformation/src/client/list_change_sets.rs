...
impl super::Client {
    ...
    ///   - [`stack_name(impl Into<String>)`](crate::operation::list_change_sets::builders::ListChangeSetsFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::list_change_sets::builders::ListChangeSetsFluentBuilder::set_stack_name):<br>required: **true**<br><p>The name or the Amazon Resource Name (ARN) of the stack for which you want to list change sets.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_change_sets::builders::ListChangeSetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_change_sets::builders::ListChangeSetsFluentBuilder::set_next_token):<br>required: **false**<br><p>A string (provided by the <code>ListChangeSets</code> response output) that identifies the next page of change sets that you want to retrieve.</p><br>
