...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_stacks::builders::ListStacksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_stacks::builders::ListStacksFluentBuilder::set_next_token): <p>A string that identifies the next page of stacks that you want to retrieve.</p>
