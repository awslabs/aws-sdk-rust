...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_stacks::builders::ListStacksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_stacks::builders::ListStacksFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of items to return. (You received this token from a previous call.)</p><br>
    ...
    ///   - [`stack_summaries(Option<Vec::<StackSummary>>)`](crate::operation::list_stacks::ListStacksOutput::stack_summaries): <p>A list of <code>StackSummary</code> structures that contains information about the specified stacks.</p>
