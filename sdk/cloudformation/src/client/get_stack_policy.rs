...
impl super::Client {
    ...
    ///   - [`stack_name(impl ::std::convert::Into<String>)`](crate::operation::get_stack_policy::builders::GetStackPolicyFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::get_stack_policy::builders::GetStackPolicyFluentBuilder::set_stack_name): <p>The name or unique stack ID that's associated with the stack whose policy you want to get.</p>
