...
impl super::Client {
    ...
    ///   - [`stack_name(impl Into<String>)`](crate::operation::describe_stack_resources::builders::DescribeStackResourcesFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::describe_stack_resources::builders::DescribeStackResourcesFluentBuilder::set_stack_name): <p>The name or the unique stack ID that is associated with the stack, which aren't always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>  <p>Required: Conditional. If you don't specify <code>StackName</code>, you must specify <code>PhysicalResourceId</code>.</p>
    ///   - [`logical_resource_id(impl Into<String>)`](crate::operation::describe_stack_resources::builders::DescribeStackResourcesFluentBuilder::logical_resource_id) / [`set_logical_resource_id(Option<String>)`](crate::operation::describe_stack_resources::builders::DescribeStackResourcesFluentBuilder::set_logical_resource_id): <p>The logical name of the resource as specified in the template.</p>  <p>Default: There is no default value.</p>
