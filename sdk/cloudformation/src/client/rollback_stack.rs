...
impl super::Client {
    ...
    ///   - [`deployment_config(DeploymentConfig)`](crate::operation::rollback_stack::builders::RollbackStackFluentBuilder::deployment_config) / [`set_deployment_config(Option<DeploymentConfig>)`](crate::operation::rollback_stack::builders::RollbackStackFluentBuilder::set_deployment_config):<br>required: **false**<br><p>The deployment configuration for this stack operation, including the deployment mode.</p><br>
