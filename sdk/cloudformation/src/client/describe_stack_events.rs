...
impl super::Client {
    ...
    ///   - [`stack_name(impl Into<String>)`](crate::operation::describe_stack_events::builders::DescribeStackEventsFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::describe_stack_events::builders::DescribeStackEventsFluentBuilder::set_stack_name):<br>required: **true**<br><p>The name or the unique stack ID that's associated with the stack, which aren't always interchangeable:</p> <ul>  <li>   <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p></li>  <li>   <p>Deleted stacks: You must specify the unique stack ID.</p></li> </ul><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_stack_events::builders::DescribeStackEventsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_stack_events::builders::DescribeStackEventsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of items to return. (You received this token from a previous call.)</p><br>
