...
impl super::Client {
    ...
    ///   - [`stack_set_name(impl ::std::convert::Into<String>)`](crate::operation::describe_stack_instance::builders::DescribeStackInstanceFluentBuilder::stack_set_name) / [`set_stack_set_name(Option<String>)`](crate::operation::describe_stack_instance::builders::DescribeStackInstanceFluentBuilder::set_stack_set_name): <p>The name or the unique stack ID of the stack set that you want to get stack instance information for.</p>
    ///   - [`stack_instance_account(impl ::std::convert::Into<String>)`](crate::operation::describe_stack_instance::builders::DescribeStackInstanceFluentBuilder::stack_instance_account) / [`set_stack_instance_account(Option<String>)`](crate::operation::describe_stack_instance::builders::DescribeStackInstanceFluentBuilder::set_stack_instance_account): <p>The ID of an Amazon Web Services account that's associated with this stack instance.</p>
    ///   - [`stack_instance_region(impl ::std::convert::Into<String>)`](crate::operation::describe_stack_instance::builders::DescribeStackInstanceFluentBuilder::stack_instance_region) / [`set_stack_instance_region(Option<String>)`](crate::operation::describe_stack_instance::builders::DescribeStackInstanceFluentBuilder::set_stack_instance_region): <p>The name of a Region that's associated with this stack instance.</p>
