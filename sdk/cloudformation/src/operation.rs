...
impl aws_smithy_http::response::ParseStrictResponse for CancelUpdateStack {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_update_stack::de_cancel_update_stack_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_update_stack::de_cancel_update_stack_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateChangeSet {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_change_set::de_create_change_set_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_change_set::de_create_change_set_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeStackSet {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_stack_set::de_describe_stack_set_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_stack_set::de_describe_stack_set_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetTemplateSummary {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_template_summary::de_get_template_summary_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_template_summary::de_get_template_summary_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListTypeVersions {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_type_versions::de_list_type_versions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_type_versions::de_list_type_versions_http_response(response)
                     }
                }
            }
