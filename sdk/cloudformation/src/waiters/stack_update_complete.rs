...
///
/// Fluent builder for the `stack_update_complete` waiter.
///
...
pub struct StackUpdateCompleteFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_stacks::builders::DescribeStacksInputBuilder,
}
impl StackUpdateCompleteFluentBuilder {
    /// Creates a new `StackUpdateCompleteFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::stack_update_complete::StackUpdateCompleteFinalPoll,
        crate::waiters::stack_update_complete::WaitUntilStackUpdateCompleteError,
    > {
        let input = self
            .inner
            .build()
...
/// Successful return type for the `stack_update_complete` waiter.
pub type StackUpdateCompleteFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_stacks::DescribeStacksOutput,
...
/// Error type for the `stack_update_complete` waiter.
pub type WaitUntilStackUpdateCompleteError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_stacks::DescribeStacksOutput,
    crate::operation::describe_stacks::DescribeStacksError,
>;
