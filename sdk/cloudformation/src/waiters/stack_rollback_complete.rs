...
///
/// Fluent builder for the `stack_rollback_complete` waiter.
///
...
pub struct StackRollbackCompleteFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_stacks::builders::DescribeStacksInputBuilder,
}
impl StackRollbackCompleteFluentBuilder {
    /// Creates a new `StackRollbackCompleteFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::stack_rollback_complete::StackRollbackCompleteFinalPoll,
        crate::waiters::stack_rollback_complete::WaitUntilStackRollbackCompleteError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            // Matches: {"output":{"path":"Stacks[].StackStatus","expected":"UPDATE_FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_stacks_59ddbd273fc923fdf(result) {
...
/// Successful return type for the `stack_rollback_complete` waiter.
pub type StackRollbackCompleteFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_stacks::DescribeStacksOutput,
...
/// Error type for the `stack_rollback_complete` waiter.
pub type WaitUntilStackRollbackCompleteError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_stacks::DescribeStacksOutput,
    crate::operation::describe_stacks::DescribeStacksError,
>;
