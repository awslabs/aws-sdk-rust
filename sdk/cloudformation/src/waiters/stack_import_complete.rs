...
///
/// Fluent builder for the `stack_import_complete` waiter.
///
...
pub struct StackImportCompleteFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_stacks::builders::DescribeStacksInputBuilder,
}
impl StackImportCompleteFluentBuilder {
    /// Creates a new `StackImportCompleteFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::stack_import_complete::StackImportCompleteFinalPoll,
        crate::waiters::stack_import_complete::WaitUntilStackImportCompleteError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"Stacks[].StackStatus","expected":"IMPORT_COMPLETE","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_stacks_c3cc6842562f80831(result) {
            ...
            // Matches: {"output":{"path":"Stacks[].StackStatus","expected":"IMPORT_ROLLBACK_IN_PROGRESS","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_stacks_4e936bef118898d9e(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"Stacks[].StackStatus","expected":"IMPORT_ROLLBACK_FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_stacks_35c476527c6dc36ba(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"Stacks[].StackStatus","expected":"IMPORT_ROLLBACK_COMPLETE","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_stacks_8535e4f7e4074b6d9(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
...
/// Successful return type for the `stack_import_complete` waiter.
pub type StackImportCompleteFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_stacks::DescribeStacksOutput,
...
/// Error type for the `stack_import_complete` waiter.
pub type WaitUntilStackImportCompleteError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_stacks::DescribeStacksOutput,
    crate::operation::describe_stacks::DescribeStacksError,
>;
