...
pub fn de_describe_change_set_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_change_set::DescribeChangeSetOutput, crate::operation::describe_change_set::DescribeChangeSetError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_change_set_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_change_set::DescribeChangeSetOutput, crate::operation::describe_change_set::DescribeChangeSetError> {
    Ok({
        #[allow(unused_mut)]
