...
pub fn de_describe_change_set(
...
) -> std::result::Result<crate::operation::describe_change_set::builders::DescribeChangeSetOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeChangeSetResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeChangeSetResult got {start_el:?}"
            )));
        }
