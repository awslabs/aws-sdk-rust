...
pub fn de_describe_change_set_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeChangeSetOutput, crate::error::DescribeChangeSetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeChangeSetError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_change_set_not_found_exception::de_change_set_not_found_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::DescribeChangeSetError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_change_set_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeChangeSetOutput, crate::error::DescribeChangeSetError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_change_set_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_change_set::de_describe_change_set(response.body().as_ref(), output).map_err(crate::error::DescribeChangeSetError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_change_set(inp: &[u8], mut builder: crate::output::describe_change_set_output::Builder) -> Result<crate::output::describe_change_set_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
