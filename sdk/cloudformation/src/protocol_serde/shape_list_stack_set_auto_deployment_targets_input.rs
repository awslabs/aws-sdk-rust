...
pub fn ser_list_stack_set_auto_deployment_targets_input_input_input(input: &crate::operation::list_stack_set_auto_deployment_targets::ListStackSetAutoDeploymentTargetsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "ListStackSetAutoDeploymentTargets", "2010-05-15");
    #[allow(unused_mut)]
