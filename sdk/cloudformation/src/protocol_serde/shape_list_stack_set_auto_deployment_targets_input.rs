...
pub fn ser_list_stack_set_auto_deployment_targets_input_input_input(
    input: &crate::operation::list_stack_set_auto_deployment_targets::ListStackSetAutoDeploymentTargetsInput,
