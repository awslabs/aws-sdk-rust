...
pub fn ser_continue_update_rollback_input_input_input(input: &crate::operation::continue_update_rollback::ContinueUpdateRollbackInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
