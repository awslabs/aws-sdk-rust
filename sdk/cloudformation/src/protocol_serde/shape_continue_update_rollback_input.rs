...
pub fn ser_continue_update_rollback_input_input(input: &crate::input::ContinueUpdateRollbackInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
