...
#[allow(unused_mut)]
pub fn ser_stack_set_operation_preferences(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::StackSetOperationPreferences) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
