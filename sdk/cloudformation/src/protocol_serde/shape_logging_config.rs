...
#[allow(unused_mut)]
pub fn ser_logging_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LoggingConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
