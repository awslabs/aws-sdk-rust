...
#[allow(unused_mut)]
pub fn ser_logging_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LoggingConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
