...
pub fn ser_update_stack_input_input(input: &crate::input::UpdateStackInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
