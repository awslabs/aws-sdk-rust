...
pub fn ser_update_stack_input_input_input(input: &crate::operation::update_stack::UpdateStackInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
