...
pub fn de_batch_describe_type_configurations_error(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BatchDescribeTypeConfigurationsError, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
