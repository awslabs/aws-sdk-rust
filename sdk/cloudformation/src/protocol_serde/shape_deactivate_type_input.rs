...
pub fn ser_deactivate_type_input_input(input: &crate::input::DeactivateTypeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
