...
pub fn ser_deactivate_type_input_input_input(input: &crate::operation::deactivate_type::DeactivateTypeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
