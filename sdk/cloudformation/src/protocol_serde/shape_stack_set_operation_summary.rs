...
pub fn de_stack_set_operation_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackSetOperationSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
