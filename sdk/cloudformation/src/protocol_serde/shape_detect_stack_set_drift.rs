...
pub fn de_detect_stack_set_drift_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::detect_stack_set_drift::DetectStackSetDriftOutput, crate::operation::detect_stack_set_drift::DetectStackSetDriftError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_detect_stack_set_drift_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::detect_stack_set_drift::DetectStackSetDriftOutput, crate::operation::detect_stack_set_drift::DetectStackSetDriftError> {
    Ok({
        #[allow(unused_mut)]
