...
pub fn ser_test_type_input_input_input(input: &crate::operation::test_type::TestTypeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
