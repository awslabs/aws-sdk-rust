...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_type_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::register_type::RegisterTypeOutput, crate::operation::register_type::RegisterTypeError> {
...
) -> Result<crate::operation::register_type::builders::RegisterTypeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
