...
pub fn de_register_type_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::register_type::RegisterTypeOutput, crate::operation::register_type::RegisterTypeError> {
    #[allow(unused_mut)]
...
pub fn de_register_type_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_register_type::de_register_type(_response_body, output)
            .map_err(crate::operation::register_type::RegisterTypeError::unhandled)?;
...
pub fn de_register_type(
...
) -> std::result::Result<crate::operation::register_type::builders::RegisterTypeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("RegisterTypeResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected RegisterTypeResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("RegisterTypeResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected RegisterTypeResult got {start_el:?}"
            )));
        }
