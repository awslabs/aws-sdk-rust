...
pub fn ser_list_change_sets_input_input_input(input: &crate::operation::list_change_sets::ListChangeSetsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
