...
pub fn ser_describe_stack_drift_detection_status_input_input_input(
    input: &crate::operation::describe_stack_drift_detection_status::DescribeStackDriftDetectionStatusInput,
