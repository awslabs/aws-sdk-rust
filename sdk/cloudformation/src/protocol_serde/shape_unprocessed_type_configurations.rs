...
pub fn de_unprocessed_type_configurations(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TypeConfigurationIdentifier>, aws_smithy_xml::decode::XmlDecodeError> {
