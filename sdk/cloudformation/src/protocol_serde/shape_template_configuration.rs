...
#[allow(unused_mut)]
pub fn ser_template_configuration(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TemplateConfiguration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_template_configuration(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TemplateConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
