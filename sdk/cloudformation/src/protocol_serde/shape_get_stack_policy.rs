...
pub fn de_get_stack_policy_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_stack_policy_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_stack_policy::GetStackPolicyOutput, crate::operation::get_stack_policy::GetStackPolicyError> {
...
pub fn de_get_stack_policy(
...
) -> std::result::Result<crate::operation::get_stack_policy::builders::GetStackPolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("GetStackPolicyResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetStackPolicyResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetStackPolicyResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetStackPolicyResult got {start_el:?}"
            )));
        }
