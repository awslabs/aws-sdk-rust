...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_type_versions::ListTypeVersionsError::unhandled(generic),
            )
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_type_versions::de_list_type_versions(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_type_versions::ListTypeVersionsError::unhandled)?;
...
pub fn de_list_type_versions(
    ...
    crate::operation::list_type_versions::builders::ListTypeVersionsOutputBuilder,
