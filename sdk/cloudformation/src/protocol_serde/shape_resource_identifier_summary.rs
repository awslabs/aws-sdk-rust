...
pub fn de_resource_identifier_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResourceIdentifierSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
