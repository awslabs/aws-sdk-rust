...
pub fn de_get_template_summary_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetTemplateSummaryOutput, crate::error::GetTemplateSummaryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetTemplateSummaryError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_stack_set_not_found_exception::de_stack_set_not_found_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::GetTemplateSummaryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_template_summary_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetTemplateSummaryOutput, crate::error::GetTemplateSummaryError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_template_summary_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_template_summary::de_get_template_summary(response.body().as_ref(), output).map_err(crate::error::GetTemplateSummaryError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_template_summary(inp: &[u8], mut builder: crate::output::get_template_summary_output::Builder) -> Result<crate::output::get_template_summary_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
