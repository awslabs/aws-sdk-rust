...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_template_summary::de_get_template_summary(_response_body, output)
            .map_err(crate::operation::get_template_summary::GetTemplateSummaryError::unhandled)?;
...
) -> std::result::Result<crate::operation::get_template_summary::builders::GetTemplateSummaryOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetTemplateSummaryResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetTemplateSummaryResult got {start_el:?}"
            )));
        }
