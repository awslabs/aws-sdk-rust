...
pub fn de_get_template_summary_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_template_summary::GetTemplateSummaryOutput, crate::operation::get_template_summary::GetTemplateSummaryError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_template_summary_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_template_summary::GetTemplateSummaryOutput, crate::operation::get_template_summary::GetTemplateSummaryError> {
    Ok({
        #[allow(unused_mut)]
