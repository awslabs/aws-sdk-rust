...
pub fn ser_delete_stack_input_input_input(input: &crate::operation::delete_stack::DeleteStackInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
