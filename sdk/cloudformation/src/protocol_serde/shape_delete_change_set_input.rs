...
pub fn ser_delete_change_set_input_input_input(input: &crate::operation::delete_change_set::DeleteChangeSetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
