...
pub fn ser_delete_change_set_input_input(input: &crate::input::DeleteChangeSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
