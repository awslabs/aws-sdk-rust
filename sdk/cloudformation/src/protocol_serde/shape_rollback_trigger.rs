...
#[allow(unused_mut)]
pub fn ser_rollback_trigger(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::RollbackTrigger) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_rollback_trigger(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RollbackTrigger, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
