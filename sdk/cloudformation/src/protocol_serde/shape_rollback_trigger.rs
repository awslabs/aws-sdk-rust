...
#[allow(unused_mut)]
pub fn ser_rollback_trigger(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::RollbackTrigger) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
