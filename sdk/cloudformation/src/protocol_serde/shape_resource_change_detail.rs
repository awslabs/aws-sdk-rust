...
pub fn de_resource_change_detail(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResourceChangeDetail, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
