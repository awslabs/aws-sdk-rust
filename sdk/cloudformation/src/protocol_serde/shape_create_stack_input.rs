...
pub fn ser_create_stack_input_input(input: &crate::input::CreateStackInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
