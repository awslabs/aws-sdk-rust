...
pub fn ser_list_types_input_input(input: &crate::input::ListTypesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
