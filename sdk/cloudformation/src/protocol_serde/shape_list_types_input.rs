...
pub fn ser_list_types_input_input_input(input: &crate::operation::list_types::ListTypesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
