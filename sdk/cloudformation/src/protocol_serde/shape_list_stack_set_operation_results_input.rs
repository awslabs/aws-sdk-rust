...
pub fn ser_list_stack_set_operation_results_input_input_input(input: &crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
