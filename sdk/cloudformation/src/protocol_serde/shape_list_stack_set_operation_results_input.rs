...
pub fn ser_list_stack_set_operation_results_input_input(input: &crate::input::ListStackSetOperationResultsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
