...
pub fn de_stack_set_operation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackSetOperation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
