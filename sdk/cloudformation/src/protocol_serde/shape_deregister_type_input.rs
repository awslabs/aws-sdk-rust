...
pub fn ser_deregister_type_input_input_input(input: &crate::operation::deregister_type::DeregisterTypeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
