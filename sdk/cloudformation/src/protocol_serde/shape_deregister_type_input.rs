...
pub fn ser_deregister_type_input_input(input: &crate::operation::deregister_type::DeregisterTypeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
