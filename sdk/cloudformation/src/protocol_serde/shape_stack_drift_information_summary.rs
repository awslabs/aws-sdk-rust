...
pub fn de_stack_drift_information_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackDriftInformationSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
