...
pub fn de_account_gate_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccountGateResult, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
