...
pub fn de_template_parameter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TemplateParameter, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
