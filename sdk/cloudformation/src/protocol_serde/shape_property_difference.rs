...
pub fn de_property_difference(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PropertyDifference, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
