...
pub fn de_stack_instance_comprehensive_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackInstanceComprehensiveStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
