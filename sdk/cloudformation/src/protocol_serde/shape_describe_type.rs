...
pub fn de_describe_type_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type::DescribeTypeOutput, crate::operation::describe_type::DescribeTypeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_type::DescribeTypeError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cfn_registry_exception::de_cfn_registry_exception_xml_err(_response_body, output).map_err(crate::operation::describe_type::DescribeTypeError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_type_not_found_exception::de_type_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::describe_type::DescribeTypeError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_type_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type::DescribeTypeOutput, crate::operation::describe_type::DescribeTypeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_type::builders::DescribeTypeOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_type::de_describe_type(_response_body, output).map_err(crate::operation::describe_type::DescribeTypeError::unhandled)?;
