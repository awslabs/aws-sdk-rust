...
pub fn de_describe_type_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type::DescribeTypeOutput, crate::operation::describe_type::DescribeTypeError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_type_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type::DescribeTypeOutput, crate::operation::describe_type::DescribeTypeError> {
    Ok({
        #[allow(unused_mut)]
