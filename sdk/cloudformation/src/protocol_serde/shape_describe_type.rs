...
pub fn de_describe_type_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeTypeOutput, crate::error::DescribeTypeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeTypeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_type_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeTypeOutput, crate::error::DescribeTypeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_type_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_type::de_describe_type(response.body().as_ref(), output).map_err(crate::error::DescribeTypeError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_type(inp: &[u8], mut builder: crate::output::describe_type_output::Builder) -> Result<crate::output::describe_type_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
