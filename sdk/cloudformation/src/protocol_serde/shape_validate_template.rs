...
pub fn de_validate_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ValidateTemplateOutput, crate::error::ValidateTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ValidateTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_validate_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ValidateTemplateOutput, crate::error::ValidateTemplateError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::validate_template_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_validate_template::de_validate_template(response.body().as_ref(), output).map_err(crate::error::ValidateTemplateError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_validate_template(inp: &[u8], mut builder: crate::output::validate_template_output::Builder) -> Result<crate::output::validate_template_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
