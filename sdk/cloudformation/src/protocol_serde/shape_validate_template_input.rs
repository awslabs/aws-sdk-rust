...
pub fn ser_validate_template_input_input_input(input: &crate::operation::validate_template::ValidateTemplateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
