...
pub fn ser_estimate_template_cost_input_input(input: &crate::input::EstimateTemplateCostInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
