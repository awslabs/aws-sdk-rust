...
pub fn ser_estimate_template_cost_input_input_input(input: &crate::operation::estimate_template_cost::EstimateTemplateCostInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
