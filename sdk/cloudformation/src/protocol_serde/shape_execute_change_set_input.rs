...
pub fn ser_execute_change_set_input_input(input: &crate::input::ExecuteChangeSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
