...
#[allow(clippy::unnecessary_wraps)]
pub fn de_rollback_stack_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::rollback_stack::RollbackStackOutput, crate::operation::rollback_stack::RollbackStackError> {
...
) -> Result<crate::operation::rollback_stack::builders::RollbackStackOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
