...
pub fn de_cancel_update_stack_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::cancel_update_stack::CancelUpdateStackOutput, crate::operation::cancel_update_stack::CancelUpdateStackError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_update_stack_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::cancel_update_stack::CancelUpdateStackOutput, crate::operation::cancel_update_stack::CancelUpdateStackError>
