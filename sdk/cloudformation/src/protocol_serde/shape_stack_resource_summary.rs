...
pub fn de_stack_resource_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackResourceSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
