...
#[allow(clippy::unnecessary_wraps)]
pub fn de_detect_stack_drift_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::detect_stack_drift::DetectStackDriftOutput, crate::operation::detect_stack_drift::DetectStackDriftError> {
...
pub fn de_detect_stack_drift(
...
) -> std::result::Result<crate::operation::detect_stack_drift::builders::DetectStackDriftOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DetectStackDriftResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DetectStackDriftResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DetectStackDriftResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DetectStackDriftResult got {start_el:?}"
            )));
        }
