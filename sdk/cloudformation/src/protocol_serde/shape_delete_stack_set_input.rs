...
pub fn ser_delete_stack_set_input_input(input: &crate::input::DeleteStackSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
