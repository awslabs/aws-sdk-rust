...
pub fn ser_delete_stack_set_input_input_input(input: &crate::operation::delete_stack_set::DeleteStackSetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
