...
#[allow(clippy::unnecessary_wraps)]
pub fn de_publish_type_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::publish_type::PublishTypeOutput, crate::operation::publish_type::PublishTypeError> {
...
) -> Result<crate::operation::publish_type::builders::PublishTypeOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
