...
pub fn ser_publish_type_input_input_input(input: &crate::operation::publish_type::PublishTypeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
