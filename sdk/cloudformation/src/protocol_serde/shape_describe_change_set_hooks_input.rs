...
pub fn ser_describe_change_set_hooks_input_input(input: &crate::input::DescribeChangeSetHooksInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
