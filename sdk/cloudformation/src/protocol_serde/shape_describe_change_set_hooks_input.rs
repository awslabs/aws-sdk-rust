...
pub fn ser_describe_change_set_hooks_input_input_input(input: &crate::operation::describe_change_set_hooks::DescribeChangeSetHooksInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
