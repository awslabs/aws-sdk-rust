...
pub fn de_stack_drift_information(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackDriftInformation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
