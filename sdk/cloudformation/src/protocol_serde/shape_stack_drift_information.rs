...
pub fn de_stack_drift_information(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StackDriftInformation, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::StackDriftInformation::builder();
    ...
    Ok(crate::serde_util::stack_drift_information_correct_errors(builder).build())
}
