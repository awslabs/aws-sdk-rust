...
#[allow(unused_mut)]
pub fn ser_rollback_configuration(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::RollbackConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_rollback_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RollbackConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
