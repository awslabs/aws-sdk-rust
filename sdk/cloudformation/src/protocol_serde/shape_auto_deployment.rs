...
#[allow(unused_mut)]
pub fn ser_auto_deployment(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AutoDeployment) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
