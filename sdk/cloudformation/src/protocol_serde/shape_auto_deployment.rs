...
#[allow(unused_mut)]
pub fn ser_auto_deployment(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AutoDeployment) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_auto_deployment(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AutoDeployment, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
