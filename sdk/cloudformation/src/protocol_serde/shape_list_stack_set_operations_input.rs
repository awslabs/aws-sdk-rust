...
pub fn ser_list_stack_set_operations_input_input_input(input: &crate::operation::list_stack_set_operations::ListStackSetOperationsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
