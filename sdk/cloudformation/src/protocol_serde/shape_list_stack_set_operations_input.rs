...
pub fn ser_list_stack_set_operations_input_input(input: &crate::input::ListStackSetOperationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
