...
pub fn de_required_activated_type(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
    depth: u32,
) -> ::std::result::Result<crate::types::RequiredActivatedType, ::aws_smithy_xml::decode::XmlDecodeError> {
    if depth >= 128u32 {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("SupportedMajorVersions") /* SupportedMajorVersions com.amazonaws.cloudformation#RequiredActivatedType$SupportedMajorVersions */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_supported_major_versions::de_supported_major_versions(&mut tag, depth + 1)
                        ?
                    )
                ;
