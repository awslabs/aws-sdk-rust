...
pub fn de_stack_resource_drift(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackResourceDrift, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
