...
#[allow(unused_mut)]
pub fn ser_type_configuration_identifier(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::TypeConfigurationIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_type_configuration_identifier(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TypeConfigurationIdentifier, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
