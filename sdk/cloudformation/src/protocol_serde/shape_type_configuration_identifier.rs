...
#[allow(unused_mut)]
pub fn ser_type_configuration_identifier(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::TypeConfigurationIdentifier) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
