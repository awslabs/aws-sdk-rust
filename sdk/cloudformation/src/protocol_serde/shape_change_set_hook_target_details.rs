...
pub fn de_change_set_hook_target_details(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ChangeSetHookTargetDetails, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
