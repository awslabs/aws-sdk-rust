...
pub fn ser_rollback_stack_input_input(input: &crate::input::RollbackStackInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
