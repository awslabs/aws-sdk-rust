...
pub fn de_estimate_template_cost_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::estimate_template_cost::EstimateTemplateCostError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_estimate_template_cost_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_estimate_template_cost::de_estimate_template_cost(_response_body, output)
            .map_err(crate::operation::estimate_template_cost::EstimateTemplateCostError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("EstimateTemplateCostResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected EstimateTemplateCostResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("EstimateTemplateCostResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected EstimateTemplateCostResult got {start_el:?}"
            )));
        }
