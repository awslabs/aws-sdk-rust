...
pub fn de_create_stack_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateStackOutput, crate::error::CreateStackError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateStackError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_stack_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateStackOutput, crate::error::CreateStackError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_stack_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_stack::de_create_stack(response.body().as_ref(), output).map_err(crate::error::CreateStackError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_stack(inp: &[u8], mut builder: crate::output::create_stack_output::Builder) -> Result<crate::output::create_stack_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
