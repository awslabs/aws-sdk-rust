...
pub fn de_physical_resource_id_context_key_value_pair(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PhysicalResourceIdContextKeyValuePair, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
