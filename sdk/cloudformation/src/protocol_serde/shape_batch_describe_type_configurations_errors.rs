...
pub fn de_batch_describe_type_configurations_errors(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::BatchDescribeTypeConfigurationsError>, aws_smithy_xml::decode::XmlDecodeError> {
