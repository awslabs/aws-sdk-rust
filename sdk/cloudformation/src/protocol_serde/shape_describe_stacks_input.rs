...
pub fn ser_describe_stacks_input_input(input: &crate::input::DescribeStacksInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
