...
#[allow(unused_mut)]
pub fn ser_deployment_targets(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::DeploymentTargets) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_deployment_targets(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeploymentTargets, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
