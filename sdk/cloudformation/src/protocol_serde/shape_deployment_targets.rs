...
#[allow(unused_mut)]
pub fn ser_deployment_targets(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::DeploymentTargets) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
