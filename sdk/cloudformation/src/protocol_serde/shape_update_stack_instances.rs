...
> {
    ...
    Err(match error_code {
        ...
        "OperationIdAlreadyExistsException" => {
            crate::operation::update_stack_instances::UpdateStackInstancesError::OperationIdAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "StackInstanceNotFoundException" => crate::operation::update_stack_instances::UpdateStackInstancesError::StackInstanceNotFoundException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_stack_instance_not_found_exception::de_stack_instance_not_found_exception_xml_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::update_stack_instances::UpdateStackInstancesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_stack_instances::de_update_stack_instances(_response_body, output)
            .map_err(crate::operation::update_stack_instances::UpdateStackInstancesError::unhandled)?;
