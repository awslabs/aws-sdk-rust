...
pub fn de_update_stack_instances_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateStackInstancesOutput, crate::error::UpdateStackInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateStackInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_stack_instances_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateStackInstancesOutput, crate::error::UpdateStackInstancesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::update_stack_instances_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_stack_instances::de_update_stack_instances(response.body().as_ref(), output).map_err(crate::error::UpdateStackInstancesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_update_stack_instances(inp: &[u8], mut builder: crate::output::update_stack_instances_output::Builder) -> Result<crate::output::update_stack_instances_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
