...
pub fn de_update_stack_instances_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_stack_instances::UpdateStackInstancesOutput, crate::operation::update_stack_instances::UpdateStackInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::update_stack_instances::UpdateStackInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_stack_instances_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_stack_instances::UpdateStackInstancesOutput, crate::operation::update_stack_instances::UpdateStackInstancesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_stack_instances::builders::UpdateStackInstancesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_stack_instances::de_update_stack_instances(response.body().as_ref(), output).map_err(crate::operation::update_stack_instances::UpdateStackInstancesError::unhandled)?;
