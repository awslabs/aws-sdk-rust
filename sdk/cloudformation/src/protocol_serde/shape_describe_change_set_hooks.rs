...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_change_set_hooks::DescribeChangeSetHooksError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_change_set_hooks::de_describe_change_set_hooks(_response_body, output)
            .map_err(crate::operation::describe_change_set_hooks::DescribeChangeSetHooksError::unhandled)?;
...
) -> Result<crate::operation::describe_change_set_hooks::builders::DescribeChangeSetHooksOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
