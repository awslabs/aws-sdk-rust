...
pub fn de_describe_change_set_hooks_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeChangeSetHooksOutput, crate::error::DescribeChangeSetHooksError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeChangeSetHooksError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_change_set_hooks_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeChangeSetHooksOutput, crate::error::DescribeChangeSetHooksError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_change_set_hooks_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_change_set_hooks::de_describe_change_set_hooks(response.body().as_ref(), output).map_err(crate::error::DescribeChangeSetHooksError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_change_set_hooks(inp: &[u8], mut builder: crate::output::describe_change_set_hooks_output::Builder) -> Result<crate::output::describe_change_set_hooks_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
