...
pub fn de_update_stack_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_stack::UpdateStackOutput, crate::operation::update_stack::UpdateStackError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::update_stack::UpdateStackError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_stack_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_stack::UpdateStackOutput, crate::operation::update_stack::UpdateStackError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_stack::builders::UpdateStackOutputBuilder::default();
        output = crate::protocol_serde::shape_update_stack::de_update_stack(_response_body, output).map_err(crate::operation::update_stack::UpdateStackError::unhandled)?;
