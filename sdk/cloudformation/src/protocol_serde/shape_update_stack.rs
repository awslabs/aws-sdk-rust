...
pub fn de_update_stack_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateStackOutput, crate::error::UpdateStackError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateStackError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_stack_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateStackOutput, crate::error::UpdateStackError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::update_stack_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_stack::de_update_stack(response.body().as_ref(), output).map_err(crate::error::UpdateStackError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_update_stack(inp: &[u8], mut builder: crate::output::update_stack_output::Builder) -> Result<crate::output::update_stack_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
