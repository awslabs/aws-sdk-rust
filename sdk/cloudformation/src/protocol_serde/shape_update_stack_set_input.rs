...
pub fn ser_update_stack_set_input_input_input(input: &crate::operation::update_stack_set::UpdateStackSetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
