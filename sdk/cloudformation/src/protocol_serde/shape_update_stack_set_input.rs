...
pub fn ser_update_stack_set_input_input(input: &crate::input::UpdateStackSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
