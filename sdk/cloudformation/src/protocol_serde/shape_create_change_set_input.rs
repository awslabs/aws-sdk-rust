...
pub fn ser_create_change_set_input_input(input: &crate::input::CreateChangeSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
