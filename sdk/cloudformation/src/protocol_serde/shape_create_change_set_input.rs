...
pub fn ser_create_change_set_input_input_input(input: &crate::operation::create_change_set::CreateChangeSetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
