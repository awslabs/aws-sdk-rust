...
pub fn de_describe_resource_scan(
...
) -> Result<crate::operation::describe_resource_scan::builders::DescribeResourceScanOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DescribeResourceScanResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeResourceScanResponse got {:?}",
            start_el
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeResourceScanResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeResourceScanResult got {:?}",
                start_el
            )));
        }
