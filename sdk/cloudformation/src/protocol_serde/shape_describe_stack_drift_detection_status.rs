...
pub fn de_describe_stack_drift_detection_status_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_stack_drift_detection_status::DescribeStackDriftDetectionStatusOutput, crate::operation::describe_stack_drift_detection_status::DescribeStackDriftDetectionStatusError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_stack_drift_detection_status_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_stack_drift_detection_status::DescribeStackDriftDetectionStatusOutput, crate::operation::describe_stack_drift_detection_status::DescribeStackDriftDetectionStatusError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::describe_stack_drift_detection_status_output_output_correct_errors(output).build()
    })
}
