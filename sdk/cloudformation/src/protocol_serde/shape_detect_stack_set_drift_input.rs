...
pub fn ser_detect_stack_set_drift_input_input_input(input: &crate::operation::detect_stack_set_drift::DetectStackSetDriftInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
