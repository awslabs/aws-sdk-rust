...
pub fn de_parameter_constraints(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ParameterConstraints, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
