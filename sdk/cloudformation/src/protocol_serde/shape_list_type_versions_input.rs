...
pub fn ser_list_type_versions_input_input_input(input: &crate::operation::list_type_versions::ListTypeVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
