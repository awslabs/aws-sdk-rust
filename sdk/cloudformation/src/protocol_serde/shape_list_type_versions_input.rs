...
pub fn ser_list_type_versions_input_input(input: &crate::input::ListTypeVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
