...
pub fn de_resource_target_definition(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ResourceTargetDefinition, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
