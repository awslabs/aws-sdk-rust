...
pub fn de_stack_set_operation_status_details(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackSetOperationStatusDetails, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
