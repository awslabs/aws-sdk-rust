...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_describe_type_configurations_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::batch_describe_type_configurations::BatchDescribeTypeConfigurationsOutput, crate::operation::batch_describe_type_configurations::BatchDescribeTypeConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
