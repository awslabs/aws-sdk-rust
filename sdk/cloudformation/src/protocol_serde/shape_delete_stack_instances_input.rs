...
pub fn ser_delete_stack_instances_input_input(input: &crate::operation::delete_stack_instances::DeleteStackInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
