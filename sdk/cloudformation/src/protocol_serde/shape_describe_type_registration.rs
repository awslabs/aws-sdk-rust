...
pub fn de_describe_type_registration_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type_registration::DescribeTypeRegistrationOutput, crate::operation::describe_type_registration::DescribeTypeRegistrationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_type_registration_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type_registration::DescribeTypeRegistrationOutput, crate::operation::describe_type_registration::DescribeTypeRegistrationError> {
    Ok({
        #[allow(unused_mut)]
