...
pub fn ser_create_stack_set_input_input_input(input: &crate::operation::create_stack_set::CreateStackSetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
