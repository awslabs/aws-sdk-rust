...
pub fn de_parameter_declaration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ParameterDeclaration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
