...
pub fn de_change_set_hook_resource_target_details(
    decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder,
) -> ::std::result::Result<crate::types::ChangeSetHookResourceTargetDetails, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
