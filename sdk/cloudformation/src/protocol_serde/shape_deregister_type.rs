...
pub fn de_deregister_type_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::deregister_type::DeregisterTypeOutput, crate::operation::deregister_type::DeregisterTypeError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_type_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::deregister_type::DeregisterTypeOutput, crate::operation::deregister_type::DeregisterTypeError> {
