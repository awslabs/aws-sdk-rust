...
pub fn de_stack_resource_detail(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::StackResourceDetail, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
