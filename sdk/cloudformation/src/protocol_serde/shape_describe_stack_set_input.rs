...
pub fn ser_describe_stack_set_input_input(input: &crate::input::DescribeStackSetInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
