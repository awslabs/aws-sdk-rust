...
pub fn ser_describe_stack_set_input_input_input(input: &crate::operation::describe_stack_set::DescribeStackSetInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
