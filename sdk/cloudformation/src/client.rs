    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`ActivateTypeInput`](crate::input::ActivateTypeInput) with field(s):
    ///   - [`r#type(Option<ThirdPartyType>)`](crate::input::ActivateTypeInput::r#type): <p>The extension type.</p>  <p>Conditional: You must specify <code>PublicTypeArn</code>, or <code>TypeName</code>, <code>Type</code>, and <code>PublisherId</code>.</p>
    ///   - [`public_type_arn(Option<String>)`](crate::input::ActivateTypeInput::public_type_arn): <p>The Amazon Resource Number (ARN) of the public extension.</p>  <p>Conditional: You must specify <code>PublicTypeArn</code>, or <code>TypeName</code>, <code>Type</code>, and <code>PublisherId</code>.</p>
    ///   - [`publisher_id(Option<String>)`](crate::input::ActivateTypeInput::publisher_id): <p>The ID of the extension publisher.</p>  <p>Conditional: You must specify <code>PublicTypeArn</code>, or <code>TypeName</code>, <code>Type</code>, and <code>PublisherId</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::ActivateTypeInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify <code>PublicTypeArn</code>, or <code>TypeName</code>, <code>Type</code>, and <code>PublisherId</code>.</p>
    ///   - [`type_name_alias(Option<String>)`](crate::input::ActivateTypeInput::type_name_alias): <p>An alias to assign to the public extension, in this account and region. If you specify an alias for the extension, CloudFormation treats the alias as the extension type name within this account and region. You must use the alias to refer to the extension in your templates, API calls, and CloudFormation console.</p>  <p>An extension alias must be unique within a given account and region. You can activate the same public resource multiple times in the same account and region, using different type name aliases.</p>
    ///   - [`auto_update(Option<bool>)`](crate::input::ActivateTypeInput::auto_update): <p>Whether to automatically update the extension in this account and region when a new <i>minor</i> version is published by the extension publisher. Major versions released by the publisher must be manually updated.</p>  <p>The default is <code>true</code>.</p>
    ///   - [`logging_config(Option<LoggingConfig>)`](crate::input::ActivateTypeInput::logging_config): <p>Contains logging configuration information for an extension.</p>
    ///   - [`execution_role_arn(Option<String>)`](crate::input::ActivateTypeInput::execution_role_arn): <p>The name of the IAM execution role to use to activate the extension.</p>
    ///   - [`version_bump(Option<VersionBump>)`](crate::input::ActivateTypeInput::version_bump): <p>Manually updates a previously-activated type to a new major or minor version, if available. You can also use this parameter to update the value of <code>AutoUpdate</code>.</p>  <ul>   <li> <p> <code>MAJOR</code>: CloudFormation updates the extension to the newest major version, if one is available.</p> </li>   <li> <p> <code>MINOR</code>: CloudFormation updates the extension to the newest minor version, if one is available.</p> </li>  </ul>
    ///   - [`major_version(Option<i64>)`](crate::input::ActivateTypeInput::major_version): <p>The major version of this extension you want to activate, if multiple major versions are available. The default is the latest major version. CloudFormation uses the latest available <i>minor</i> version of the major version selected.</p>  <p>You can specify <code>MajorVersion</code> or <code>VersionBump</code>, but not both.</p>
    ...
    ///
    /// - Takes [`BatchDescribeTypeConfigurationsInput`](crate::input::BatchDescribeTypeConfigurationsInput) with field(s):
    ///   - [`type_configuration_identifiers(Option<Vec<TypeConfigurationIdentifier>>)`](crate::input::BatchDescribeTypeConfigurationsInput::type_configuration_identifiers): <p>The list of identifiers for the desired extension configurations.</p>
    ...
    ///
    /// - Takes [`CancelUpdateStackInput`](crate::input::CancelUpdateStackInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::CancelUpdateStackInput::stack_name): <p>The name or the unique stack ID that is associated with the stack.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CancelUpdateStackInput::client_request_token): <p>A unique identifier for this <code>CancelUpdateStack</code> request. Specify this token if you plan to retry requests so that CloudFormation knows that you're not attempting to cancel an update on a stack with the same name. You might retry <code>CancelUpdateStack</code> requests to ensure that CloudFormation successfully received them.</p>
    ...
    ///   - [`stack_name(Option<String>)`](crate::input::CreateStackInput::stack_name): <p>The name that is associated with the stack. The name must be unique in the Region in which you are creating the stack.</p> <note>   <p>A stack name can contain only alphanumeric characters (case sensitive) and hyphens. It must start with an alphabetical character and cannot be longer than 128 characters.</p>  </note>
    ///   - [`template_body(Option<String>)`](crate::input::CreateStackInput::template_body): <p>Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes. For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must specify either the <code>TemplateBody</code> or the <code>TemplateURL</code> parameter, but not both.</p>
    ///   - [`template_url(Option<String>)`](crate::input::CreateStackInput::template_url): <p>Location of file containing the template body. The URL must point to a template (max size: 460,800 bytes) that is located in an Amazon S3 bucket or a Systems Manager document. For more information, go to the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must specify either the <code>TemplateBody</code> or the <code>TemplateURL</code> parameter, but not both.</p>
    ///   - [`parameters(Option<Vec<Parameter>>)`](crate::input::CreateStackInput::parameters): <p>A list of <code>Parameter</code> structures that specify input parameters for the stack. For more information, see the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_Parameter.html">Parameter</a> data type.</p>
    ///   - [`disable_rollback(Option<bool>)`](crate::input::CreateStackInput::disable_rollback): <p>Set to <code>true</code> to disable rollback of the stack if stack creation failed. You can specify either <code>DisableRollback</code> or <code>OnFailure</code>, but not both.</p>  <p>Default: <code>false</code> </p>
    ///   - [`rollback_configuration(Option<RollbackConfiguration>)`](crate::input::CreateStackInput::rollback_configuration): <p>The rollback triggers for CloudFormation to monitor during stack creation and updating operations, and for the specified monitoring period afterwards.</p>
    ///   - [`timeout_in_minutes(Option<i32>)`](crate::input::CreateStackInput::timeout_in_minutes): <p>The amount of time that can pass before the stack status becomes CREATE_FAILED; if <code>DisableRollback</code> is not set or is set to <code>false</code>, the stack will be rolled back.</p>
    ///   - [`notification_ar_ns(Option<Vec<String>>)`](crate::input::CreateStackInput::notification_ar_ns): <p>The Simple Notification Service (SNS) topic ARNs to publish stack related events. You can find your SNS topic ARNs using the SNS console or your Command Line Interface (CLI).</p>
    ///   - [`capabilities(Option<Vec<Capability>>)`](crate::input::CreateStackInput::capabilities): <p>In some cases, you must explicitly acknowledge that your stack template contains certain capabilities in order for CloudFormation to create the stack.</p>  <ul>   <li> <p> <code>CAPABILITY_IAM</code> and <code>CAPABILITY_NAMED_IAM</code> </p> <p>Some stack templates might include resources that can affect permissions in your Amazon Web Services account; for example, by creating new Identity and Access Management (IAM) users. For those stacks, you must explicitly acknowledge this by specifying one of these capabilities.</p> <p>The following IAM resources require you to specify either the <code>CAPABILITY_IAM</code> or <code>CAPABILITY_NAMED_IAM</code> capability.</p>    <ul>     <li> <p>If you have IAM resources, you can specify either capability.</p> </li>     <li> <p>If you have IAM resources with custom names, you <i>must</i> specify <code>CAPABILITY_NAMED_IAM</code>.</p> </li>     <li> <p>If you don't specify either of these capabilities, CloudFormation returns an <code>InsufficientCapabilities</code> error.</p> </li>    </ul> <p>If your stack template contains these resources, we recommend that you review all permissions associated with them and edit their permissions if necessary.</p>    <ul>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-accesskey.html"> AWS::IAM::AccessKey</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-group.html"> AWS::IAM::Group</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-instanceprofile.html"> AWS::IAM::InstanceProfile</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-policy.html"> AWS::IAM::Policy</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-role.html"> AWS::IAM::Role</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-user.html"> AWS::IAM::User</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-addusertogroup.html"> AWS::IAM::UserToGroupAddition</a> </p> </li>    </ul> <p>For more information, see <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-iam-template.html#capabilities">Acknowledging IAM Resources in CloudFormation Templates</a>.</p> </li>   <li> <p> <code>CAPABILITY_AUTO_EXPAND</code> </p> <p>Some template contain macros. Macros perform custom processing on templates; this can include simple actions like find-and-replace operations, all the way to extensive transformations of entire templates. Because of this, users typically create a change set from the processed template, so that they can review the changes resulting from the macros before actually creating the stack. If your stack template contains one or more macros, and you choose to create a stack directly from the processed template, without first reviewing the resulting changes in a change set, you must acknowledge this capability. This includes the <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html">AWS::Include</a> and <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html">AWS::Serverless</a> transforms, which are macros hosted by CloudFormation.</p> <p>If you want to create a stack from a stack template that contains macros <i>and</i> nested stacks, you must create the stack directly from the template using this capability.</p> <important>     <p>You should only create stacks directly from a stack template that contains macros if you know what processing the macro performs.</p>     <p>Each macro relies on an underlying Lambda service function for processing stack templates. Be aware that the Lambda function owner can update the function operation without CloudFormation being notified.</p>    </important> <p>For more information, see <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html">Using CloudFormation Macros to Perform Custom Processing on Templates</a>.</p> </li>  </ul>
    ///   - [`resource_types(Option<Vec<String>>)`](crate::input::CreateStackInput::resource_types): <p>The template resource types that you have permissions to work with for this create stack action, such as <code>AWS::EC2::Instance</code>, <code>AWS::EC2::*</code>, or <code>Custom::MyCustomInstance</code>. Use the following syntax to describe template resource types: <code>AWS::*</code> (for all Amazon Web Services resources), <code>Custom::*</code> (for all custom resources), <code>Custom::<i>logical_ID</i> </code> (for a specific custom resource), <code>AWS::<i>service_name</i>::*</code> (for all resources of a particular Amazon Web Services service), and <code>AWS::<i>service_name</i>::<i>resource_logical_ID</i> </code> (for a specific Amazon Web Services resource).</p>  <p>If the list of resource types doesn't include a resource that you're creating, the stack creation fails. By default, CloudFormation grants permissions to all resource types. Identity and Access Management (IAM) uses this parameter for CloudFormation-specific condition keys in IAM policies. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-iam-template.html">Controlling Access with Identity and Access Management</a>.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::CreateStackInput::role_arn): <p>The Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that CloudFormation assumes to create the stack. CloudFormation uses the role's credentials to make calls on your behalf. CloudFormation always uses this role for all future operations on the stack. As long as users have permission to operate on the stack, CloudFormation uses this role even if the users don't have permission to pass it. Ensure that the role grants least privilege.</p>  <p>If you don't specify a value, CloudFormation uses the role that was previously associated with the stack. If no role is available, CloudFormation uses a temporary session that is generated from your user credentials.</p>
    ///   - [`on_failure(Option<OnFailure>)`](crate::input::CreateStackInput::on_failure): <p>Determines what action will be taken if stack creation fails. This must be one of: DO_NOTHING, ROLLBACK, or DELETE. You can specify either <code>OnFailure</code> or <code>DisableRollback</code>, but not both.</p>  <p>Default: <code>ROLLBACK</code> </p>
    ///   - [`stack_policy_body(Option<String>)`](crate::input::CreateStackInput::stack_policy_body): <p>Structure containing the stack policy body. For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/protect-stack-resources.html"> Prevent Updates to Stack Resources</a> in the <i>CloudFormation User Guide</i>. You can specify either the <code>StackPolicyBody</code> or the <code>StackPolicyURL</code> parameter, but not both.</p>
    ///   - [`stack_policy_url(Option<String>)`](crate::input::CreateStackInput::stack_policy_url): <p>Location of a file containing the stack policy. The URL must point to a policy (maximum size: 16 KB) located in an S3 bucket in the same Region as the stack. You can specify either the <code>StackPolicyBody</code> or the <code>StackPolicyURL</code> parameter, but not both.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateStackInput::tags): <p>Key-value pairs to associate with this stack. CloudFormation also propagates these tags to the resources created in the stack. A maximum number of 50 tags can be specified.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateStackInput::client_request_token): <p>A unique identifier for this <code>CreateStack</code> request. Specify this token if you plan to retry requests so that CloudFormation knows that you're not attempting to create a stack with the same name. You might retry <code>CreateStack</code> requests to ensure that CloudFormation successfully received them.</p>  <p>All events triggered by a given stack operation are assigned the same client request token, which you can use to track operations. For example, if you execute a <code>CreateStack</code> operation with the token <code>token1</code>, then all the <code>StackEvents</code> generated by that operation will have <code>ClientRequestToken</code> set as <code>token1</code>.</p>  <p>In the console, stack operations display the client request token on the Events tab. Stack operations that are initiated from the console use the token format <i>Console-StackOperation-ID</i>, which helps you easily identify the stack operation . For example, if you create a stack using the console, each stack event would be assigned the same token in the following format: <code>Console-CreateStack-7f59c3cf-00d2-40c7-b2ff-e75db0987002</code>. </p>
    ///   - [`enable_termination_protection(Option<bool>)`](crate::input::CreateStackInput::enable_termination_protection): <p>Whether to enable termination protection on the specified stack. If a user attempts to delete a stack with termination protection enabled, the operation fails and the stack remains unchanged. For more information, see <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-protect-stacks.html">Protecting a Stack From Being Deleted</a> in the <i>CloudFormation User Guide</i>. Termination protection is disabled on stacks by default.</p>  <p>For <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-nested-stacks.html">nested stacks</a>, termination protection is set on the root stack and cannot be changed directly on the nested stack.</p>
    ...
    ///
    /// - Takes [`CreateStackInstancesInput`](crate::input::CreateStackInstancesInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::CreateStackInstancesInput::stack_set_name): <p>The name or unique ID of the stack set that you want to create stack instances from.</p>
    ///   - [`accounts(Option<Vec<String>>)`](crate::input::CreateStackInstancesInput::accounts): <p>[Self-managed permissions] The names of one or more Amazon Web Services accounts that you want to create stack instances in the specified Region(s) for.</p>  <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>
    ///   - [`deployment_targets(Option<DeploymentTargets>)`](crate::input::CreateStackInstancesInput::deployment_targets): <p>[Service-managed permissions] The Organizations accounts for which to create stack instances in the specified Regions.</p>  <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>
    ///   - [`regions(Option<Vec<String>>)`](crate::input::CreateStackInstancesInput::regions): <p>The names of one or more Regions where you want to create stack instances using the specified Amazon Web Services accounts.</p>
    ///   - [`parameter_overrides(Option<Vec<Parameter>>)`](crate::input::CreateStackInstancesInput::parameter_overrides): <p>A list of stack set parameters whose values you want to override in the selected stack instances.</p>  <p>Any overridden parameter values will be applied to all stack instances in the specified accounts and Regions. When specifying parameters and their values, be aware of how CloudFormation sets parameter values during stack instance operations:</p>  <ul>   <li> <p>To override the current value for a parameter, include the parameter and specify its value.</p> </li>   <li> <p>To leave an overridden parameter set to its present value, include the parameter and specify <code>UsePreviousValue</code> as <code>true</code>. (You cannot specify both a value and set <code>UsePreviousValue</code> to <code>true</code>.)</p> </li>   <li> <p>To set an overridden parameter back to the value specified in the stack set, specify a parameter list but do not include the parameter in the list.</p> </li>   <li> <p>To leave all parameters set to their present values, do not specify this property at all.</p> </li>  </ul>  <p>During stack set updates, any parameter values overridden for a stack instance are not updated, but retain their overridden value.</p>  <p>You can only override the parameter <i>values</i> that are specified in the stack set; to add or delete a parameter itself, use <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_UpdateStackSet.html">UpdateStackSet</a> to update the stack set template.</p>
    ///   - [`operation_preferences(Option<StackSetOperationPreferences>)`](crate::input::CreateStackInstancesInput::operation_preferences): <p>Preferences for how CloudFormation performs this stack set operation.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::CreateStackInstancesInput::operation_id): <p>The unique identifier for this stack set operation.</p>  <p>The operation ID also functions as an idempotency token, to ensure that CloudFormation performs the stack set operation only once, even if you retry the request multiple times. You might retry stack set operation requests to ensure that CloudFormation successfully received them.</p>  <p>If you don't specify an operation ID, the SDK generates one automatically.</p>  <p>Repeating this stack set operation with a new operation ID retries all stack instances whose status is <code>OUTDATED</code>.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::CreateStackInstancesInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DeactivateTypeInput`](crate::input::DeactivateTypeInput) with field(s):
    ///   - [`type_name(Option<String>)`](crate::input::DeactivateTypeInput::type_name): <p>The type name of the extension, in this account and region. If you specified a type name alias when enabling the extension, use the type name alias.</p>  <p>Conditional: You must specify either <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`r#type(Option<ThirdPartyType>)`](crate::input::DeactivateTypeInput::r#type): <p>The extension type.</p>  <p>Conditional: You must specify either <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`arn(Option<String>)`](crate::input::DeactivateTypeInput::arn): <p>The Amazon Resource Name (ARN) for the extension, in this account and region.</p>  <p>Conditional: You must specify either <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ...
    ///
    /// - Takes [`DeleteChangeSetInput`](crate::input::DeleteChangeSetInput) with field(s):
    ///   - [`change_set_name(Option<String>)`](crate::input::DeleteChangeSetInput::change_set_name): <p>The name or Amazon Resource Name (ARN) of the change set that you want to delete.</p>
    ///   - [`stack_name(Option<String>)`](crate::input::DeleteChangeSetInput::stack_name): <p>If you specified the name of a change set to delete, specify the stack name or ID (ARN) that is associated with it.</p>
    ...
    ///   - [`stack_name(Option<String>)`](crate::input::DeleteStackInput::stack_name): <p>The name or the unique stack ID that is associated with the stack.</p>
    ///   - [`retain_resources(Option<Vec<String>>)`](crate::input::DeleteStackInput::retain_resources): <p>For stacks in the <code>DELETE_FAILED</code> state, a list of resource logical IDs that are associated with the resources you want to retain. During deletion, CloudFormation deletes the stack but does not delete the retained resources.</p>  <p>Retaining resources is useful when you cannot delete a resource, such as a non-empty S3 bucket, but you want to delete the stack.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::DeleteStackInput::role_arn): <p>The Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that CloudFormation assumes to delete the stack. CloudFormation uses the role's credentials to make calls on your behalf.</p>  <p>If you don't specify a value, CloudFormation uses the role that was previously associated with the stack. If no role is available, CloudFormation uses a temporary session that is generated from your user credentials.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteStackInput::client_request_token): <p>A unique identifier for this <code>DeleteStack</code> request. Specify this token if you plan to retry requests so that CloudFormation knows that you're not attempting to delete a stack with the same name. You might retry <code>DeleteStack</code> requests to ensure that CloudFormation successfully received them.</p>  <p>All events triggered by a given stack operation are assigned the same client request token, which you can use to track operations. For example, if you execute a <code>CreateStack</code> operation with the token <code>token1</code>, then all the <code>StackEvents</code> generated by that operation will have <code>ClientRequestToken</code> set as <code>token1</code>.</p>  <p>In the console, stack operations display the client request token on the Events tab. Stack operations that are initiated from the console use the token format <i>Console-StackOperation-ID</i>, which helps you easily identify the stack operation . For example, if you create a stack using the console, each stack event would be assigned the same token in the following format: <code>Console-CreateStack-7f59c3cf-00d2-40c7-b2ff-e75db0987002</code>.</p>
    ...
    ///
    /// - Takes [`DeleteStackInstancesInput`](crate::input::DeleteStackInstancesInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::DeleteStackInstancesInput::stack_set_name): <p>The name or unique ID of the stack set that you want to delete stack instances for.</p>
    ///   - [`accounts(Option<Vec<String>>)`](crate::input::DeleteStackInstancesInput::accounts): <p>[Self-managed permissions] The names of the Amazon Web Services accounts that you want to delete stack instances for.</p>  <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>
    ///   - [`deployment_targets(Option<DeploymentTargets>)`](crate::input::DeleteStackInstancesInput::deployment_targets): <p>[Service-managed permissions] The Organizations accounts from which to delete stack instances.</p>  <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>
    ///   - [`regions(Option<Vec<String>>)`](crate::input::DeleteStackInstancesInput::regions): <p>The Regions where you want to delete stack set instances.</p>
    ///   - [`operation_preferences(Option<StackSetOperationPreferences>)`](crate::input::DeleteStackInstancesInput::operation_preferences): <p>Preferences for how CloudFormation performs this stack set operation.</p>
    ///   - [`retain_stacks(bool)`](crate::input::DeleteStackInstancesInput::retain_stacks): <p>Removes the stack instances from the specified stack set, but doesn't delete the stacks. You can't reassociate a retained stack or add an existing, saved stack to a new stack set.</p>  <p>For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-concepts.html#stackset-ops-options">Stack set operation options</a>.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::DeleteStackInstancesInput::operation_id): <p>The unique identifier for this stack set operation.</p>  <p>If you don't specify an operation ID, the SDK generates one automatically.</p>  <p>The operation ID also functions as an idempotency token, to ensure that CloudFormation performs the stack set operation only once, even if you retry the request multiple times. You can retry stack set operation requests to ensure that CloudFormation successfully received them.</p>  <p>Repeating this stack set operation with a new operation ID retries all stack instances whose status is <code>OUTDATED</code>.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::DeleteStackInstancesInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DeleteStackSetInput`](crate::input::DeleteStackSetInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::DeleteStackSetInput::stack_set_name): <p>The name or unique ID of the stack set that you're deleting. You can obtain this value by running <code>ListStackSets</code>.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::DeleteStackSetInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DeregisterTypeInput`](crate::input::DeregisterTypeInput) with field(s):
    ///   - [`arn(Option<String>)`](crate::input::DeregisterTypeInput::arn): <p>The Amazon Resource Name (ARN) of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`r#type(Option<RegistryType>)`](crate::input::DeregisterTypeInput::r#type): <p>The kind of extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::DeregisterTypeInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`version_id(Option<String>)`](crate::input::DeregisterTypeInput::version_id): <p>The ID of a specific version of the extension. The version ID is the value at the end of the Amazon Resource Name (ARN) assigned to the extension version when it is registered.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::DescribeAccountLimitsInput::next_token): <p>A string that identifies the next page of limits that you want to retrieve.</p>
    ...
    ///   - [`change_set_name(Option<String>)`](crate::input::DescribeChangeSetInput::change_set_name): <p>The name or Amazon Resource Name (ARN) of the change set that you want to describe.</p>
    ///   - [`stack_name(Option<String>)`](crate::input::DescribeChangeSetInput::stack_name): <p>If you specified the name of a change set, specify the stack name or ID (ARN) of the change set you want to describe.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeChangeSetInput::next_token): <p>A string (provided by the <code>DescribeChangeSet</code> response output) that identifies the next page of information that you want to retrieve.</p>
    ...
    ///   - [`change_set_id(Option<String>)`](crate::output::DescribeChangeSetOutput::change_set_id): <p>The ARN of the change set.</p>
    ///   - [`stack_id(Option<String>)`](crate::output::DescribeChangeSetOutput::stack_id): <p>The ARN of the stack that is associated with the change set.</p>
    ///   - [`stack_name(Option<String>)`](crate::output::DescribeChangeSetOutput::stack_name): <p>The name of the stack that is associated with the change set.</p>
    ...
    ///
    /// - Takes [`DescribePublisherInput`](crate::input::DescribePublisherInput) with field(s):
    ///   - [`publisher_id(Option<String>)`](crate::input::DescribePublisherInput::publisher_id): <p>The ID of the extension publisher.</p>  <p>If you do not supply a <code>PublisherId</code>, and you have registered as an extension publisher, <code>DescribePublisher</code> returns information about your own publisher account.</p>
    ...
    ///
    /// - Takes [`DescribeStackDriftDetectionStatusInput`](crate::input::DescribeStackDriftDetectionStatusInput) with field(s):
    ///   - [`stack_drift_detection_id(Option<String>)`](crate::input::DescribeStackDriftDetectionStatusInput::stack_drift_detection_id): <p>The ID of the drift detection results of this operation.</p>  <p>CloudFormation generates new results, with a new drift detection ID, each time this operation is run. However, the number of drift results CloudFormation retains for any given stack, and for how long, may vary.</p>
    ...
    ///   - [`detection_status(Option<StackDriftDetectionStatus>)`](crate::output::DescribeStackDriftDetectionStatusOutput::detection_status): <p>The status of the stack drift detection operation.</p>  <ul>   <li> <p> <code>DETECTION_COMPLETE</code>: The stack drift detection operation has successfully completed for all resources in the stack that support drift detection. (Resources that do not currently support stack detection remain unchecked.)</p> <p>If you specified logical resource IDs for CloudFormation to use as a filter for the stack drift detection operation, only the resources with those logical IDs are checked for drift.</p> </li>   <li> <p> <code>DETECTION_FAILED</code>: The stack drift detection operation has failed for at least one resource in the stack. Results will be available for resources on which CloudFormation successfully completed drift detection.</p> </li>   <li> <p> <code>DETECTION_IN_PROGRESS</code>: The stack drift detection operation is currently in progress.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DescribeStackEventsInput`](crate::input::DescribeStackEventsInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::DescribeStackEventsInput::stack_name): <p>The name or the unique stack ID that is associated with the stack, which are not always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeStackEventsInput::next_token): <p>A string that identifies the next page of events that you want to retrieve.</p>
    ...
    ///
    /// - Takes [`DescribeStackInstanceInput`](crate::input::DescribeStackInstanceInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::DescribeStackInstanceInput::stack_set_name): <p>The name or the unique stack ID of the stack set that you want to get stack instance information for.</p>
    ///   - [`stack_instance_account(Option<String>)`](crate::input::DescribeStackInstanceInput::stack_instance_account): <p>The ID of an Amazon Web Services account that's associated with this stack instance.</p>
    ///   - [`stack_instance_region(Option<String>)`](crate::input::DescribeStackInstanceInput::stack_instance_region): <p>The name of a Region that's associated with this stack instance.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::DescribeStackInstanceInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DescribeStackResourceInput`](crate::input::DescribeStackResourceInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::DescribeStackResourceInput::stack_name): <p>The name or the unique stack ID that is associated with the stack, which are not always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>
    ///   - [`logical_resource_id(Option<String>)`](crate::input::DescribeStackResourceInput::logical_resource_id): <p>The logical name of the resource as specified in the template.</p>  <p>Default: There is no default value.</p>
    ...
    ///
    /// - Takes [`DescribeStackResourceDriftsInput`](crate::input::DescribeStackResourceDriftsInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::DescribeStackResourceDriftsInput::stack_name): <p>The name of the stack for which you want drift information.</p>
    ///   - [`stack_resource_drift_status_filters(Option<Vec<StackResourceDriftStatus>>)`](crate::input::DescribeStackResourceDriftsInput::stack_resource_drift_status_filters): <p>The resource drift status values to use as filters for the resource drift results returned.</p>  <ul>   <li> <p> <code>DELETED</code>: The resource differs from its expected template configuration in that the resource has been deleted.</p> </li>   <li> <p> <code>MODIFIED</code>: One or more resource properties differ from their expected template values.</p> </li>   <li> <p> <code>IN_SYNC</code>: The resources's actual configuration matches its expected template configuration.</p> </li>   <li> <p> <code>NOT_CHECKED</code>: CloudFormation does not currently return this value.</p> </li>  </ul>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeStackResourceDriftsInput::next_token): <p>A string that identifies the next page of stack resource drift results.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeStackResourceDriftsInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ...
    ///   - [`stack_name(Option<String>)`](crate::input::DescribeStacksInput::stack_name): <p>The name or the unique stack ID that is associated with the stack, which are not always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeStacksInput::next_token): <p>A string that identifies the next page of stacks that you want to retrieve.</p>
    ...
    ///
    /// - Takes [`DescribeStackSetInput`](crate::input::DescribeStackSetInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::DescribeStackSetInput::stack_set_name): <p>The name or unique ID of the stack set whose description you want.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::DescribeStackSetInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DescribeStackSetOperationInput`](crate::input::DescribeStackSetOperationInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::DescribeStackSetOperationInput::stack_set_name): <p>The name or the unique stack ID of the stack set for the stack operation.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::DescribeStackSetOperationInput::operation_id): <p>The unique ID of the stack set operation. </p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::DescribeStackSetOperationInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DescribeTypeInput`](crate::input::DescribeTypeInput) with field(s):
    ///   - [`r#type(Option<RegistryType>)`](crate::input::DescribeTypeInput::r#type): <p>The kind of extension. </p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::DescribeTypeInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`arn(Option<String>)`](crate::input::DescribeTypeInput::arn): <p>The Amazon Resource Name (ARN) of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`version_id(Option<String>)`](crate::input::DescribeTypeInput::version_id): <p>The ID of a specific version of the extension. The version ID is the value at the end of the Amazon Resource Name (ARN) assigned to the extension version when it is registered.</p>  <p>If you specify a <code>VersionId</code>, <code>DescribeType</code> returns information about that specific extension version. Otherwise, it returns information about the default extension version.</p>
    ///   - [`publisher_id(Option<String>)`](crate::input::DescribeTypeInput::publisher_id): <p>The publisher ID of the extension publisher.</p>  <p>Extensions provided by Amazon are not assigned a publisher ID.</p>
    ///   - [`public_version_number(Option<String>)`](crate::input::DescribeTypeInput::public_version_number): <p>The version number of a public third-party extension.</p>
    ...
    ///   - [`r#type(Option<RegistryType>)`](crate::output::DescribeTypeOutput::r#type): <p>The kind of extension. </p>
    ...
    ///   - [`publisher_id(Option<String>)`](crate::output::DescribeTypeOutput::publisher_id): <p>The publisher ID of the extension publisher.</p>  <p>This applies only to public third-party extensions. For private registered extensions, and extensions provided by Amazon, CloudFormation returns <code>null</code>.</p>
    ...
    ///   - [`latest_public_version(Option<String>)`](crate::output::DescribeTypeOutput::latest_public_version): <p>The latest version of a public extension <i>that is available</i> for use.</p>  <p>This only applies if you specify a public extension, and you do not specify a version. For all other requests, CloudFormation returns <code>null</code>.</p>
    ...
    ///
    /// - Takes [`DescribeTypeRegistrationInput`](crate::input::DescribeTypeRegistrationInput) with field(s):
    ///   - [`registration_token(Option<String>)`](crate::input::DescribeTypeRegistrationInput::registration_token): <p>The identifier for this registration request.</p>  <p>This registration token is generated by CloudFormation when you initiate a registration request using <code> <code>RegisterType</code> </code>.</p>
    ...
    ///
    /// - Takes [`DetectStackDriftInput`](crate::input::DetectStackDriftInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::DetectStackDriftInput::stack_name): <p>The name of the stack for which you want to detect drift.</p>
    ///   - [`logical_resource_ids(Option<Vec<String>>)`](crate::input::DetectStackDriftInput::logical_resource_ids): <p>The logical names of any resources you want to use as filters.</p>
    ...
    ///
    /// - Takes [`DetectStackResourceDriftInput`](crate::input::DetectStackResourceDriftInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::DetectStackResourceDriftInput::stack_name): <p>The name of the stack to which the resource belongs.</p>
    ///   - [`logical_resource_id(Option<String>)`](crate::input::DetectStackResourceDriftInput::logical_resource_id): <p>The logical name of the resource for which to return drift information.</p>
    ...
    ///
    /// - Takes [`DetectStackSetDriftInput`](crate::input::DetectStackSetDriftInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::DetectStackSetDriftInput::stack_set_name): <p>The name of the stack set on which to perform the drift detection operation.</p>
    ///   - [`operation_preferences(Option<StackSetOperationPreferences>)`](crate::input::DetectStackSetDriftInput::operation_preferences): <p>The user-specified preferences for how CloudFormation performs a stack set operation. </p>  <p>For more information on maximum concurrent accounts and failure tolerance, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-concepts.html#stackset-ops-options">Stack set operation options</a>.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::DetectStackSetDriftInput::operation_id): <p> <i>The ID of the stack set operation.</i> </p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::DetectStackSetDriftInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`ExecuteChangeSetInput`](crate::input::ExecuteChangeSetInput) with field(s):
    ///   - [`change_set_name(Option<String>)`](crate::input::ExecuteChangeSetInput::change_set_name): <p>The name or ARN of the change set that you want use to update the specified stack.</p>
    ///   - [`stack_name(Option<String>)`](crate::input::ExecuteChangeSetInput::stack_name): <p>If you specified the name of a change set, specify the stack name or ID (ARN) that is associated with the change set you want to execute.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::ExecuteChangeSetInput::client_request_token): <p>A unique identifier for this <code>ExecuteChangeSet</code> request. Specify this token if you plan to retry requests so that CloudFormation knows that you're not attempting to execute a change set to update a stack with the same name. You might retry <code>ExecuteChangeSet</code> requests to ensure that CloudFormation successfully received them.</p>
    ///   - [`disable_rollback(Option<bool>)`](crate::input::ExecuteChangeSetInput::disable_rollback): <p>Preserves the state of previously provisioned resources when an operation fails.</p>  <p>Default: <code>True</code> </p>
    ...
    ///
    /// - Takes [`GetStackPolicyInput`](crate::input::GetStackPolicyInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::GetStackPolicyInput::stack_name): <p>The name or unique stack ID that is associated with the stack whose policy you want to get.</p>
    ...
    ///
    /// - Takes [`GetTemplateInput`](crate::input::GetTemplateInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::GetTemplateInput::stack_name): <p>The name or the unique stack ID that is associated with the stack, which are not always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>
    ///   - [`change_set_name(Option<String>)`](crate::input::GetTemplateInput::change_set_name): <p>The name or Amazon Resource Name (ARN) of a change set for which CloudFormation returns the associated template. If you specify a name, you must also specify the <code>StackName</code>.</p>
    ///   - [`template_stage(Option<TemplateStage>)`](crate::input::GetTemplateInput::template_stage): <p>For templates that include transforms, the stage of the template that CloudFormation returns. To get the user-submitted template, specify <code>Original</code>. To get the template after CloudFormation has processed all transforms, specify <code>Processed</code>.</p>  <p>If the template doesn't include transforms, <code>Original</code> and <code>Processed</code> return the same template. By default, CloudFormation specifies <code>Processed</code>.</p>
    ...
    ///
    /// - Takes [`GetTemplateSummaryInput`](crate::input::GetTemplateSummaryInput) with field(s):
    ///   - [`template_body(Option<String>)`](crate::input::GetTemplateSummaryInput::template_body): <p>Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes. For more information about templates, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must specify only one of the following parameters: <code>StackName</code>, <code>StackSetName</code>, <code>TemplateBody</code>, or <code>TemplateURL</code>.</p>
    ///   - [`template_url(Option<String>)`](crate::input::GetTemplateSummaryInput::template_url): <p>Location of file containing the template body. The URL must point to a template (max size: 460,800 bytes) that is located in an Amazon S3 bucket or a Systems Manager document. For more information about templates, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must specify only one of the following parameters: <code>StackName</code>, <code>StackSetName</code>, <code>TemplateBody</code>, or <code>TemplateURL</code>.</p>
    ///   - [`stack_name(Option<String>)`](crate::input::GetTemplateSummaryInput::stack_name): <p>The name or the stack ID that is associated with the stack, which are not always interchangeable. For running stacks, you can specify either the stack's name or its unique stack ID. For deleted stack, you must specify the unique stack ID.</p>  <p>Conditional: You must specify only one of the following parameters: <code>StackName</code>, <code>StackSetName</code>, <code>TemplateBody</code>, or <code>TemplateURL</code>.</p>
    ///   - [`stack_set_name(Option<String>)`](crate::input::GetTemplateSummaryInput::stack_set_name): <p>The name or unique ID of the stack set from which the stack was created.</p>  <p>Conditional: You must specify only one of the following parameters: <code>StackName</code>, <code>StackSetName</code>, <code>TemplateBody</code>, or <code>TemplateURL</code>.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::GetTemplateSummaryInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///   - [`description(Option<String>)`](crate::output::GetTemplateSummaryOutput::description): <p>The value that is defined in the <code>Description</code> property of the template.</p>
    ...
    ///   - [`metadata(Option<String>)`](crate::output::GetTemplateSummaryOutput::metadata): <p>The value that is defined for the <code>Metadata</code> property of the template.</p>
    ...
    ///
    /// - Takes [`ImportStacksToStackSetInput`](crate::input::ImportStacksToStackSetInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::ImportStacksToStackSetInput::stack_set_name): <p>The name of the stack set. The name must be unique in the Region where you create your stack set.</p>
    ///   - [`stack_ids(Option<Vec<String>>)`](crate::input::ImportStacksToStackSetInput::stack_ids): <p>The IDs of the stacks you are importing into a stack set. You import up to 10 stacks per stack set at a time.</p>  <p>Specify either <code>StackIds</code> or <code>StackIdsUrl</code>.</p>
    ///   - [`stack_ids_url(Option<String>)`](crate::input::ImportStacksToStackSetInput::stack_ids_url): <p>The Amazon S3 URL which contains list of stack ids to be inputted.</p>  <p>Specify either <code>StackIds</code> or <code>StackIdsUrl</code>.</p>
    ///   - [`organizational_unit_ids(Option<Vec<String>>)`](crate::input::ImportStacksToStackSetInput::organizational_unit_ids): <p>The list of OU ID’s to which the stacks being imported has to be mapped as deployment target.</p>
    ///   - [`operation_preferences(Option<StackSetOperationPreferences>)`](crate::input::ImportStacksToStackSetInput::operation_preferences): <p>The user-specified preferences for how CloudFormation performs a stack set operation. </p>  <p>For more information on maximum concurrent accounts and failure tolerance, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-concepts.html#stackset-ops-options">Stack set operation options</a>.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::ImportStacksToStackSetInput::operation_id): <p>A unique, user defined, identifier for the stack set operation.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::ImportStacksToStackSetInput::call_as): <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>For service managed stack sets, specify <code>DELEGATED_ADMIN</code>.</p> </li>  </ul>
    ...
    ///   - [`stack_name(Option<String>)`](crate::input::ListChangeSetsInput::stack_name): <p>The name or the Amazon Resource Name (ARN) of the stack for which you want to list change sets.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListChangeSetsInput::next_token): <p>A string (provided by the <code>ListChangeSets</code> response output) that identifies the next page of change sets that you want to retrieve.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::output::ListChangeSetsOutput::next_token): <p>If the output exceeds 1 MB, a string that identifies the next page of change sets. If there is no additional page, this value is null.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListExportsInput::next_token): <p>A string (provided by the <code>ListExports</code> response output) that identifies the next page of exported output values that you asked to retrieve.</p>
    ...
    ///
    /// - Takes [`ListImportsInput`](crate::input::ListImportsInput) with field(s):
    ///   - [`export_name(Option<String>)`](crate::input::ListImportsInput::export_name): <p>The name of the exported output value. CloudFormation returns the stack names that are importing this value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListImportsInput::next_token): <p>A string (provided by the <code>ListImports</code> response output) that identifies the next page of stacks that are importing the specified exported output value.</p>
    ...
    ///
    /// - Takes [`ListStackInstancesInput`](crate::input::ListStackInstancesInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::ListStackInstancesInput::stack_set_name): <p>The name or unique ID of the stack set that you want to list stack instances for.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListStackInstancesInput::next_token): <p>If the previous request didn't return all of the remaining results, the response's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListStackInstances</code> again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListStackInstancesInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`filters(Option<Vec<StackInstanceFilter>>)`](crate::input::ListStackInstancesInput::filters): <p>The status that stack instances are filtered by.</p>
    ///   - [`stack_instance_account(Option<String>)`](crate::input::ListStackInstancesInput::stack_instance_account): <p>The name of the Amazon Web Services account that you want to list stack instances for.</p>
    ///   - [`stack_instance_region(Option<String>)`](crate::input::ListStackInstancesInput::stack_instance_region): <p>The name of the Region where you want to list stack instances. </p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::ListStackInstancesInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`ListStackResourcesInput`](crate::input::ListStackResourcesInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::ListStackResourcesInput::stack_name): <p>The name or the unique stack ID that is associated with the stack, which are not always interchangeable:</p>  <ul>   <li> <p>Running stacks: You can specify either the stack's name or its unique stack ID.</p> </li>   <li> <p>Deleted stacks: You must specify the unique stack ID.</p> </li>  </ul>  <p>Default: There is no default value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListStackResourcesInput::next_token): <p>A string that identifies the next page of stack resources that you want to retrieve.</p>
    ...
    ///
    /// - Takes [`ListStacksInput`](crate::input::ListStacksInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListStacksInput::next_token): <p>A string that identifies the next page of stacks that you want to retrieve.</p>
    ///   - [`stack_status_filter(Option<Vec<StackStatus>>)`](crate::input::ListStacksInput::stack_status_filter): <p>Stack status to use as a filter. Specify one or more stack status codes to list only stacks with the specified status codes. For a complete list of stack status codes, see the <code>StackStatus</code> parameter of the <code>Stack</code> data type.</p>
    ...
    ///
    /// - Takes [`ListStackSetOperationResultsInput`](crate::input::ListStackSetOperationResultsInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::ListStackSetOperationResultsInput::stack_set_name): <p>The name or unique ID of the stack set that you want to get operation results for.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::ListStackSetOperationResultsInput::operation_id): <p>The ID of the stack set operation.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListStackSetOperationResultsInput::next_token): <p>If the previous request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListStackSetOperationResults</code> again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListStackSetOperationResultsInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::ListStackSetOperationResultsInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    /// - On success, responds with [`ListStackSetOperationResultsOutput`](crate::output::ListStackSetOperationResultsOutput) with field(s):
    ///   - [`summaries(Option<Vec<StackSetOperationResultSummary>>)`](crate::output::ListStackSetOperationResultsOutput::summaries): <p>A list of <code>StackSetOperationResultSummary</code> structures that contain information about the specified operation results, for accounts and Regions that are included in the operation.</p>
    ...
    ///
    /// - Takes [`ListStackSetOperationsInput`](crate::input::ListStackSetOperationsInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::ListStackSetOperationsInput::stack_set_name): <p>The name or unique ID of the stack set that you want to get operation summaries for.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListStackSetOperationsInput::next_token): <p>If the previous paginated request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListStackSetOperations</code> again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListStackSetOperationsInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::ListStackSetOperationsInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`ListStackSetsInput`](crate::input::ListStackSetsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListStackSetsInput::next_token): <p>If the previous paginated request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListStackSets</code> again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListStackSetsInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`status(Option<StackSetStatus>)`](crate::input::ListStackSetsInput::status): <p>The status of the stack sets that you want to get summary information about.</p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::ListStackSetsInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`ListTypeRegistrationsInput`](crate::input::ListTypeRegistrationsInput) with field(s):
    ///   - [`r#type(Option<RegistryType>)`](crate::input::ListTypeRegistrationsInput::r#type): <p>The kind of extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::ListTypeRegistrationsInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`type_arn(Option<String>)`](crate::input::ListTypeRegistrationsInput::type_arn): <p>The Amazon Resource Name (ARN) of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`registration_status_filter(Option<RegistrationStatus>)`](crate::input::ListTypeRegistrationsInput::registration_status_filter): <p>The current status of the extension registration request.</p>  <p>The default is <code>IN_PROGRESS</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTypeRegistrationsInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTypeRegistrationsInput::next_token): <p>If the previous paginated request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call this action again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ...
    ///   - [`visibility(Option<Visibility>)`](crate::input::ListTypesInput::visibility): <p>The scope at which the extensions are visible and usable in CloudFormation operations.</p>  <p>Valid values include:</p>  <ul>   <li> <p> <code>PRIVATE</code>: Extensions that are visible and usable within this account and region. This includes:</p>    <ul>     <li> <p>Private extensions you have registered in this account and region.</p> </li>     <li> <p>Public extensions that you have activated in this account and region.</p> </li>    </ul> </li>   <li> <p> <code>PUBLIC</code>: Extensions that are publicly visible and available to be activated within any Amazon account. This includes extensions from Amazon, as well as third-party publishers.</p> </li>  </ul>  <p>The default is <code>PRIVATE</code>.</p>
    ///   - [`provisioning_type(Option<ProvisioningType>)`](crate::input::ListTypesInput::provisioning_type): <p>For resource types, the provisioning behavior of the resource type. CloudFormation determines the provisioning type during registration, based on the types of handlers in the schema handler package submitted.</p>  <p>Valid values include:</p>  <ul>   <li> <p> <code>FULLY_MUTABLE</code>: The resource type includes an update handler to process updates to the type during stack update operations.</p> </li>   <li> <p> <code>IMMUTABLE</code>: The resource type does not include an update handler, so the type cannot be updated and must instead be replaced during stack update operations.</p> </li>   <li> <p> <code>NON_PROVISIONABLE</code>: The resource type does not include create, read, and delete handlers, and therefore cannot actually be provisioned.</p> </li>  </ul>  <p>The default is <code>FULLY_MUTABLE</code>.</p>
    ///   - [`deprecated_status(Option<DeprecatedStatus>)`](crate::input::ListTypesInput::deprecated_status): <p>The deprecation status of the extension that you want to get summary information about.</p>  <p>Valid values include:</p>  <ul>   <li> <p> <code>LIVE</code>: The extension is registered for use in CloudFormation operations.</p> </li>   <li> <p> <code>DEPRECATED</code>: The extension has been deregistered and can no longer be used in CloudFormation operations. </p> </li>  </ul>
    ///   - [`r#type(Option<RegistryType>)`](crate::input::ListTypesInput::r#type): <p>The type of extension.</p>
    ///   - [`filters(Option<TypeFilters>)`](crate::input::ListTypesInput::filters): <p>Filter criteria to use in determining which extensions to return.</p>  <p>Filters must be compatible with <code>Visibility</code> to return valid results. For example, specifying <code>AWS_TYPES</code> for <code>Category</code> and <code>PRIVATE</code> for <code>Visibility</code> returns an empty list of types, but specifying <code>PUBLIC</code> for <code>Visibility</code> returns the desired list.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTypesInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTypesInput::next_token): <p>If the previous paginated request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call this action again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ...
    ///
    /// - Takes [`ListTypeVersionsInput`](crate::input::ListTypeVersionsInput) with field(s):
    ///   - [`r#type(Option<RegistryType>)`](crate::input::ListTypeVersionsInput::r#type): <p>The kind of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::ListTypeVersionsInput::type_name): <p>The name of the extension for which you want version summary information.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`arn(Option<String>)`](crate::input::ListTypeVersionsInput::arn): <p>The Amazon Resource Name (ARN) of the extension for which you want version summary information.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTypeVersionsInput::max_results): <p>The maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTypeVersionsInput::next_token): <p>If the previous paginated request didn't return all of the remaining results, the response object's <code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call this action again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`deprecated_status(Option<DeprecatedStatus>)`](crate::input::ListTypeVersionsInput::deprecated_status): <p>The deprecation status of the extension versions that you want to get summary information about.</p>  <p>Valid values include:</p>  <ul>   <li> <p> <code>LIVE</code>: The extension version is registered and can be used in CloudFormation operations, dependent on its provisioning behavior and visibility scope.</p> </li>   <li> <p> <code>DEPRECATED</code>: The extension version has been deregistered and can no longer be used in CloudFormation operations. </p> </li>  </ul>  <p>The default is <code>LIVE</code>.</p>
    ///   - [`publisher_id(Option<String>)`](crate::input::ListTypeVersionsInput::publisher_id): <p>The publisher ID of the extension publisher.</p>  <p>Extensions published by Amazon are not assigned a publisher ID.</p>
    ...
    ///
    /// - Takes [`PublishTypeInput`](crate::input::PublishTypeInput) with field(s):
    ///   - [`r#type(Option<ThirdPartyType>)`](crate::input::PublishTypeInput::r#type): <p>The type of the extension.</p>  <p>Conditional: You must specify <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`arn(Option<String>)`](crate::input::PublishTypeInput::arn): <p>The Amazon Resource Number (ARN) of the extension.</p>  <p>Conditional: You must specify <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::PublishTypeInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`public_version_number(Option<String>)`](crate::input::PublishTypeInput::public_version_number): <p>The version number to assign to this version of the extension.</p>  <p>Use the following format, and adhere to semantic versioning when assigning a version number to your extension: </p>  <p> <code>MAJOR.MINOR.PATCH</code> </p>  <p>For more information, see <a href="https://semver.org/">Semantic Versioning 2.0.0</a>.</p>  <p>If you do not specify a version number, CloudFormation increments the version number by one minor version release.</p>  <p>You cannot specify a version number the first time you publish a type. CloudFormation automatically sets the first version number to be <code>1.0.0</code>.</p>
    ...
    ///
    /// - Takes [`RecordHandlerProgressInput`](crate::input::RecordHandlerProgressInput) with field(s):
    ///   - [`bearer_token(Option<String>)`](crate::input::RecordHandlerProgressInput::bearer_token): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ///   - [`operation_status(Option<OperationStatus>)`](crate::input::RecordHandlerProgressInput::operation_status): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ///   - [`current_operation_status(Option<OperationStatus>)`](crate::input::RecordHandlerProgressInput::current_operation_status): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ///   - [`status_message(Option<String>)`](crate::input::RecordHandlerProgressInput::status_message): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ///   - [`error_code(Option<HandlerErrorCode>)`](crate::input::RecordHandlerProgressInput::error_code): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ///   - [`resource_model(Option<String>)`](crate::input::RecordHandlerProgressInput::resource_model): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::RecordHandlerProgressInput::client_request_token): <p>Reserved for use by the <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html">CloudFormation CLI</a>.</p>
    ...
    ///
    /// - Takes [`RollbackStackInput`](crate::input::RollbackStackInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::RollbackStackInput::stack_name): <p>The name that is associated with the stack.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::RollbackStackInput::role_arn): <p>The Amazon Resource Name (ARN) of an Identity and Access Management role that CloudFormation assumes to rollback the stack.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::RollbackStackInput::client_request_token): <p>A unique identifier for this <code>RollbackStack</code> request.</p>
    ...
    ///
    /// - Takes [`SetStackPolicyInput`](crate::input::SetStackPolicyInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::SetStackPolicyInput::stack_name): <p>The name or unique stack ID that you want to associate a policy with.</p>
    ///   - [`stack_policy_body(Option<String>)`](crate::input::SetStackPolicyInput::stack_policy_body): <p>Structure containing the stack policy body. For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/protect-stack-resources.html"> Prevent Updates to Stack Resources</a> in the CloudFormation User Guide. You can specify either the <code>StackPolicyBody</code> or the <code>StackPolicyURL</code> parameter, but not both.</p>
    ///   - [`stack_policy_url(Option<String>)`](crate::input::SetStackPolicyInput::stack_policy_url): <p>Location of a file containing the stack policy. The URL must point to a policy (maximum size: 16 KB) located in an S3 bucket in the same Region as the stack. You can specify either the <code>StackPolicyBody</code> or the <code>StackPolicyURL</code> parameter, but not both.</p>
    ...
    ///
    /// - Takes [`SetTypeConfigurationInput`](crate::input::SetTypeConfigurationInput) with field(s):
    ///   - [`type_arn(Option<String>)`](crate::input::SetTypeConfigurationInput::type_arn): <p>The Amazon Resource Name (ARN) for the extension, in this account and region.</p>  <p>For public extensions, this will be the ARN assigned when you <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_ActivateType.html">activate the type</a> in this account and region. For private extensions, this will be the ARN assigned when you <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_RegisterType.html">register the type</a> in this account and region. </p>  <p>Do not include the extension versions suffix at the end of the ARN. You can set the configuration for an extension, but not for a specific extension version.</p>
    ///   - [`configuration(Option<String>)`](crate::input::SetTypeConfigurationInput::configuration): <p>The configuration data for the extension, in this account and region. </p>  <p>The configuration data must be formatted as JSON, and validate against the schema returned in the <code>ConfigurationSchema</code> response element of <a href="AWSCloudFormation/latest/APIReference/API_DescribeType.html">API_DescribeType</a>. For more information, see <a href="https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/resource-type-model.html#resource-type-howto-configuration">Defining account-level configuration data for an extension</a> in the <i>CloudFormation CLI User Guide</i>.</p>
    ///   - [`configuration_alias(Option<String>)`](crate::input::SetTypeConfigurationInput::configuration_alias): <p>An alias by which to refer to this extension configuration data.</p>  <p>Conditional: Specifying a configuration alias is required when setting a configuration for a resource type extension.</p>
    ///   - [`type_name(Option<String>)`](crate::input::SetTypeConfigurationInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify <code>ConfigurationArn</code>, or <code>Type</code> and <code>TypeName</code>.</p>
    ///   - [`r#type(Option<ThirdPartyType>)`](crate::input::SetTypeConfigurationInput::r#type): <p>The type of extension.</p>  <p>Conditional: You must specify <code>ConfigurationArn</code>, or <code>Type</code> and <code>TypeName</code>.</p>
    ...
    ///
    /// - Takes [`SetTypeDefaultVersionInput`](crate::input::SetTypeDefaultVersionInput) with field(s):
    ///   - [`arn(Option<String>)`](crate::input::SetTypeDefaultVersionInput::arn): <p>The Amazon Resource Name (ARN) of the extension for which you want version summary information.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`r#type(Option<RegistryType>)`](crate::input::SetTypeDefaultVersionInput::r#type): <p>The kind of extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::SetTypeDefaultVersionInput::type_name): <p>The name of the extension.</p>  <p>Conditional: You must specify either <code>TypeName</code> and <code>Type</code>, or <code>Arn</code>.</p>
    ///   - [`version_id(Option<String>)`](crate::input::SetTypeDefaultVersionInput::version_id): <p>The ID of a specific version of the extension. The version ID is the value at the end of the Amazon Resource Name (ARN) assigned to the extension version when it is registered.</p>
    ...
    ///
    /// - Takes [`SignalResourceInput`](crate::input::SignalResourceInput) with field(s):
    ///   - [`stack_name(Option<String>)`](crate::input::SignalResourceInput::stack_name): <p>The stack name or unique stack ID that includes the resource that you want to signal.</p>
    ///   - [`logical_resource_id(Option<String>)`](crate::input::SignalResourceInput::logical_resource_id): <p>The logical ID of the resource that you want to signal. The logical ID is the name of the resource that given in the template.</p>
    ///   - [`unique_id(Option<String>)`](crate::input::SignalResourceInput::unique_id): <p>A unique ID of the signal. When you signal Amazon EC2 instances or Auto Scaling groups, specify the instance ID that you are signaling as the unique ID. If you send multiple signals to a single resource (such as signaling a wait condition), each signal requires a different unique ID.</p>
    ///   - [`status(Option<ResourceSignalStatus>)`](crate::input::SignalResourceInput::status): <p>The status of the signal, which is either success or failure. A failure signal causes CloudFormation to immediately fail the stack creation or update.</p>
    ...
    ///
    /// - Takes [`StopStackSetOperationInput`](crate::input::StopStackSetOperationInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::StopStackSetOperationInput::stack_set_name): <p>The name or unique ID of the stack set that you want to stop the operation for.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::StopStackSetOperationInput::operation_id): <p>The ID of the stack operation. </p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::StopStackSetOperationInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`TestTypeInput`](crate::input::TestTypeInput) with field(s):
    ///   - [`arn(Option<String>)`](crate::input::TestTypeInput::arn): <p>The Amazon Resource Number (ARN) of the extension.</p>  <p>Conditional: You must specify <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`r#type(Option<ThirdPartyType>)`](crate::input::TestTypeInput::r#type): <p>The type of the extension to test.</p>  <p>Conditional: You must specify <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`type_name(Option<String>)`](crate::input::TestTypeInput::type_name): <p>The name of the extension to test.</p>  <p>Conditional: You must specify <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
    ///   - [`version_id(Option<String>)`](crate::input::TestTypeInput::version_id): <p>The version of the extension to test.</p>  <p>You can specify the version id with either <code>Arn</code>, or with <code>TypeName</code> and <code>Type</code>.</p>  <p>If you do not specify a version, CloudFormation uses the default version of the extension in this account and region for testing.</p>
    ///   - [`log_delivery_bucket(Option<String>)`](crate::input::TestTypeInput::log_delivery_bucket): <p>The S3 bucket to which CloudFormation delivers the contract test execution logs.</p>  <p>CloudFormation delivers the logs by the time contract testing has completed and the extension has been assigned a test type status of <code>PASSED</code> or <code>FAILED</code>.</p>  <p>The user calling <code>TestType</code> must be able to access items in the specified S3 bucket. Specifically, the user needs the following permissions:</p>  <ul>   <li> <p>GetObject</p> </li>   <li> <p>PutObject</p> </li>  </ul>  <p>For more information, see <a href="https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html">Actions, Resources, and Condition Keys for Amazon S3</a> in the <i>Amazon Web Services Identity and Access Management User Guide</i>.</p>
    /// - On success, responds with [`TestTypeOutput`](crate::output::TestTypeOutput) with field(s):
    ///   - [`type_version_arn(Option<String>)`](crate::output::TestTypeOutput::type_version_arn): <p>The Amazon Resource Number (ARN) of the extension.</p>
    ...
    ///   - [`stack_name(Option<String>)`](crate::input::UpdateStackInput::stack_name): <p>The name or unique stack ID of the stack to update.</p>
    ///   - [`template_body(Option<String>)`](crate::input::UpdateStackInput::template_body): <p>Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes. (For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.)</p>  <p>Conditional: You must specify only one of the following parameters: <code>TemplateBody</code>, <code>TemplateURL</code>, or set the <code>UsePreviousTemplate</code> to <code>true</code>.</p>
    ///   - [`template_url(Option<String>)`](crate::input::UpdateStackInput::template_url): <p>Location of file containing the template body. The URL must point to a template that is located in an Amazon S3 bucket or a Systems Manager document. For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must specify only one of the following parameters: <code>TemplateBody</code>, <code>TemplateURL</code>, or set the <code>UsePreviousTemplate</code> to <code>true</code>.</p>
    ///   - [`use_previous_template(Option<bool>)`](crate::input::UpdateStackInput::use_previous_template): <p>Reuse the existing template that is associated with the stack that you are updating.</p>  <p>Conditional: You must specify only one of the following parameters: <code>TemplateBody</code>, <code>TemplateURL</code>, or set the <code>UsePreviousTemplate</code> to <code>true</code>.</p>
    ///   - [`stack_policy_during_update_body(Option<String>)`](crate::input::UpdateStackInput::stack_policy_during_update_body): <p>Structure containing the temporary overriding stack policy body. You can specify either the <code>StackPolicyDuringUpdateBody</code> or the <code>StackPolicyDuringUpdateURL</code> parameter, but not both.</p>  <p>If you want to update protected resources, specify a temporary overriding stack policy during this update. If you do not specify a stack policy, the current policy that is associated with the stack will be used.</p>
    ///   - [`stack_policy_during_update_url(Option<String>)`](crate::input::UpdateStackInput::stack_policy_during_update_url): <p>Location of a file containing the temporary overriding stack policy. The URL must point to a policy (max size: 16KB) located in an S3 bucket in the same Region as the stack. You can specify either the <code>StackPolicyDuringUpdateBody</code> or the <code>StackPolicyDuringUpdateURL</code> parameter, but not both.</p>  <p>If you want to update protected resources, specify a temporary overriding stack policy during this update. If you do not specify a stack policy, the current policy that is associated with the stack will be used.</p>
    ///   - [`parameters(Option<Vec<Parameter>>)`](crate::input::UpdateStackInput::parameters): <p>A list of <code>Parameter</code> structures that specify input parameters for the stack. For more information, see the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_Parameter.html">Parameter</a> data type.</p>
    ///   - [`capabilities(Option<Vec<Capability>>)`](crate::input::UpdateStackInput::capabilities): <p>In some cases, you must explicitly acknowledge that your stack template contains certain capabilities in order for CloudFormation to update the stack.</p>  <ul>   <li> <p> <code>CAPABILITY_IAM</code> and <code>CAPABILITY_NAMED_IAM</code> </p> <p>Some stack templates might include resources that can affect permissions in your Amazon Web Services account; for example, by creating new Identity and Access Management (IAM) users. For those stacks, you must explicitly acknowledge this by specifying one of these capabilities.</p> <p>The following IAM resources require you to specify either the <code>CAPABILITY_IAM</code> or <code>CAPABILITY_NAMED_IAM</code> capability.</p>    <ul>     <li> <p>If you have IAM resources, you can specify either capability.</p> </li>     <li> <p>If you have IAM resources with custom names, you <i>must</i> specify <code>CAPABILITY_NAMED_IAM</code>.</p> </li>     <li> <p>If you don't specify either of these capabilities, CloudFormation returns an <code>InsufficientCapabilities</code> error.</p> </li>    </ul> <p>If your stack template contains these resources, we recommend that you review all permissions associated with them and edit their permissions if necessary.</p>    <ul>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-accesskey.html"> AWS::IAM::AccessKey</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-group.html"> AWS::IAM::Group</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-instanceprofile.html"> AWS::IAM::InstanceProfile</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-policy.html"> AWS::IAM::Policy</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-role.html"> AWS::IAM::Role</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-user.html"> AWS::IAM::User</a> </p> </li>     <li> <p> <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-addusertogroup.html"> AWS::IAM::UserToGroupAddition</a> </p> </li>    </ul> <p>For more information, see <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-iam-template.html#capabilities">Acknowledging IAM Resources in CloudFormation Templates</a>.</p> </li>   <li> <p> <code>CAPABILITY_AUTO_EXPAND</code> </p> <p>Some template contain macros. Macros perform custom processing on templates; this can include simple actions like find-and-replace operations, all the way to extensive transformations of entire templates. Because of this, users typically create a change set from the processed template, so that they can review the changes resulting from the macros before actually updating the stack. If your stack template contains one or more macros, and you choose to update a stack directly from the processed template, without first reviewing the resulting changes in a change set, you must acknowledge this capability. This includes the <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html">AWS::Include</a> and <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html">AWS::Serverless</a> transforms, which are macros hosted by CloudFormation.</p> <p>If you want to update a stack from a stack template that contains macros <i>and</i> nested stacks, you must update the stack directly from the template using this capability.</p> <important>     <p>You should only update stacks directly from a stack template that contains macros if you know what processing the macro performs.</p>     <p>Each macro relies on an underlying Lambda service function for processing stack templates. Be aware that the Lambda function owner can update the function operation without CloudFormation being notified.</p>    </important> <p>For more information, see <a href="http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html">Using CloudFormation Macros to Perform Custom Processing on Templates</a>.</p> </li>  </ul>
    ///   - [`resource_types(Option<Vec<String>>)`](crate::input::UpdateStackInput::resource_types): <p>The template resource types that you have permissions to work with for this update stack action, such as <code>AWS::EC2::Instance</code>, <code>AWS::EC2::*</code>, or <code>Custom::MyCustomInstance</code>.</p>  <p>If the list of resource types doesn't include a resource that you're updating, the stack update fails. By default, CloudFormation grants permissions to all resource types. Identity and Access Management (IAM) uses this parameter for CloudFormation-specific condition keys in IAM policies. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-iam-template.html">Controlling Access with Identity and Access Management</a>.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::UpdateStackInput::role_arn): <p>The Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that CloudFormation assumes to update the stack. CloudFormation uses the role's credentials to make calls on your behalf. CloudFormation always uses this role for all future operations on the stack. As long as users have permission to operate on the stack, CloudFormation uses this role even if the users don't have permission to pass it. Ensure that the role grants least privilege.</p>  <p>If you don't specify a value, CloudFormation uses the role that was previously associated with the stack. If no role is available, CloudFormation uses a temporary session that is generated from your user credentials.</p>
    ///   - [`rollback_configuration(Option<RollbackConfiguration>)`](crate::input::UpdateStackInput::rollback_configuration): <p>The rollback triggers for CloudFormation to monitor during stack creation and updating operations, and for the specified monitoring period afterwards.</p>
    ///   - [`stack_policy_body(Option<String>)`](crate::input::UpdateStackInput::stack_policy_body): <p>Structure containing a new stack policy body. You can specify either the <code>StackPolicyBody</code> or the <code>StackPolicyURL</code> parameter, but not both.</p>  <p>You might update the stack policy, for example, in order to protect a new resource that you created during a stack update. If you do not specify a stack policy, the current policy that is associated with the stack is unchanged.</p>
    ///   - [`stack_policy_url(Option<String>)`](crate::input::UpdateStackInput::stack_policy_url): <p>Location of a file containing the updated stack policy. The URL must point to a policy (max size: 16KB) located in an S3 bucket in the same Region as the stack. You can specify either the <code>StackPolicyBody</code> or the <code>StackPolicyURL</code> parameter, but not both.</p>  <p>You might update the stack policy, for example, in order to protect a new resource that you created during a stack update. If you do not specify a stack policy, the current policy that is associated with the stack is unchanged.</p>
    ///   - [`notification_ar_ns(Option<Vec<String>>)`](crate::input::UpdateStackInput::notification_ar_ns): <p>Amazon Simple Notification Service topic Amazon Resource Names (ARNs) that CloudFormation associates with the stack. Specify an empty list to remove all notification topics.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::UpdateStackInput::tags): <p>Key-value pairs to associate with this stack. CloudFormation also propagates these tags to supported resources in the stack. You can specify a maximum number of 50 tags.</p>  <p>If you don't specify this parameter, CloudFormation doesn't modify the stack's tags. If you specify an empty value, CloudFormation removes all associated tags.</p>
    ///   - [`disable_rollback(Option<bool>)`](crate::input::UpdateStackInput::disable_rollback): <p>Preserve the state of previously provisioned resources when an operation fails.</p>  <p>Default: <code>False</code> </p>
    ///   - [`client_request_token(Option<String>)`](crate::input::UpdateStackInput::client_request_token): <p>A unique identifier for this <code>UpdateStack</code> request. Specify this token if you plan to retry requests so that CloudFormation knows that you're not attempting to update a stack with the same name. You might retry <code>UpdateStack</code> requests to ensure that CloudFormation successfully received them.</p>  <p>All events triggered by a given stack operation are assigned the same client request token, which you can use to track operations. For example, if you execute a <code>CreateStack</code> operation with the token <code>token1</code>, then all the <code>StackEvents</code> generated by that operation will have <code>ClientRequestToken</code> set as <code>token1</code>.</p>  <p>In the console, stack operations display the client request token on the Events tab. Stack operations that are initiated from the console use the token format <i>Console-StackOperation-ID</i>, which helps you easily identify the stack operation . For example, if you create a stack using the console, each stack event would be assigned the same token in the following format: <code>Console-CreateStack-7f59c3cf-00d2-40c7-b2ff-e75db0987002</code>.</p>
    ...
    ///
    /// - Takes [`UpdateStackInstancesInput`](crate::input::UpdateStackInstancesInput) with field(s):
    ///   - [`stack_set_name(Option<String>)`](crate::input::UpdateStackInstancesInput::stack_set_name): <p>The name or unique ID of the stack set associated with the stack instances.</p>
    ///   - [`accounts(Option<Vec<String>>)`](crate::input::UpdateStackInstancesInput::accounts): <p>[Self-managed permissions] The names of one or more Amazon Web Services accounts for which you want to update parameter values for stack instances. The overridden parameter values will be applied to all stack instances in the specified accounts and Regions.</p>  <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>
    ///   - [`deployment_targets(Option<DeploymentTargets>)`](crate::input::UpdateStackInstancesInput::deployment_targets): <p>[Service-managed permissions] The Organizations accounts for which you want to update parameter values for stack instances. If your update targets OUs, the overridden parameter values only apply to the accounts that are currently in the target OUs and their child OUs. Accounts added to the target OUs and their child OUs in the future won't use the overridden values.</p>  <p>You can specify <code>Accounts</code> or <code>DeploymentTargets</code>, but not both.</p>
    ///   - [`regions(Option<Vec<String>>)`](crate::input::UpdateStackInstancesInput::regions): <p>The names of one or more Regions in which you want to update parameter values for stack instances. The overridden parameter values will be applied to all stack instances in the specified accounts and Regions.</p>
    ///   - [`parameter_overrides(Option<Vec<Parameter>>)`](crate::input::UpdateStackInstancesInput::parameter_overrides): <p> A list of input parameters whose values you want to update for the specified stack instances. </p>  <p>Any overridden parameter values will be applied to all stack instances in the specified accounts and Regions. When specifying parameters and their values, be aware of how CloudFormation sets parameter values during stack instance update operations:</p>  <ul>   <li> <p>To override the current value for a parameter, include the parameter and specify its value.</p> </li>   <li> <p>To leave an overridden parameter set to its present value, include the parameter and specify <code>UsePreviousValue</code> as <code>true</code>. (You cannot specify both a value and set <code>UsePreviousValue</code> to <code>true</code>.)</p> </li>   <li> <p>To set an overridden parameter back to the value specified in the stack set, specify a parameter list but do not include the parameter in the list.</p> </li>   <li> <p>To leave all parameters set to their present values, do not specify this property at all.</p> </li>  </ul>  <p>During stack set updates, any parameter values overridden for a stack instance are not updated, but retain their overridden value.</p>  <p>You can only override the parameter <i>values</i> that are specified in the stack set; to add or delete a parameter itself, use <code>UpdateStackSet</code> to update the stack set template. If you add a parameter to a template, before you can override the parameter value specified in the stack set you must first use <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_UpdateStackSet.html">UpdateStackSet</a> to update all stack instances with the updated template and parameter value specified in the stack set. Once a stack instance has been updated with the new parameter, you can then override the parameter value using <code>UpdateStackInstances</code>.</p>
    ///   - [`operation_preferences(Option<StackSetOperationPreferences>)`](crate::input::UpdateStackInstancesInput::operation_preferences): <p>Preferences for how CloudFormation performs this stack set operation.</p>
    ///   - [`operation_id(Option<String>)`](crate::input::UpdateStackInstancesInput::operation_id): <p>The unique identifier for this stack set operation. </p>  <p>The operation ID also functions as an idempotency token, to ensure that CloudFormation performs the stack set operation only once, even if you retry the request multiple times. You might retry stack set operation requests to ensure that CloudFormation successfully received them.</p>  <p>If you don't specify an operation ID, the SDK generates one automatically. </p>
    ///   - [`call_as(Option<CallAs>)`](crate::input::UpdateStackInstancesInput::call_as): <p>[Service-managed permissions] Specifies whether you are acting as an account administrator in the organization's management account or as a delegated administrator in a member account.</p>  <p>By default, <code>SELF</code> is specified. Use <code>SELF</code> for stack sets with self-managed permissions.</p>  <ul>   <li> <p>If you are signed in to the management account, specify <code>SELF</code>.</p> </li>   <li> <p>If you are signed in to a delegated administrator account, specify <code>DELEGATED_ADMIN</code>.</p> <p>Your Amazon Web Services account must be registered as a delegated administrator in the management account. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-orgs-delegated-admin.html">Register a delegated administrator</a> in the <i>CloudFormation User Guide</i>.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`UpdateTerminationProtectionInput`](crate::input::UpdateTerminationProtectionInput) with field(s):
    ///   - [`enable_termination_protection(Option<bool>)`](crate::input::UpdateTerminationProtectionInput::enable_termination_protection): <p>Whether to enable termination protection on the specified stack.</p>
    ///   - [`stack_name(Option<String>)`](crate::input::UpdateTerminationProtectionInput::stack_name): <p>The name or unique ID of the stack for which you want to set termination protection.</p>
    ...
    ///
    /// - Takes [`ValidateTemplateInput`](crate::input::ValidateTemplateInput) with field(s):
    ///   - [`template_body(Option<String>)`](crate::input::ValidateTemplateInput::template_body): <p>Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes. For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must pass <code>TemplateURL</code> or <code>TemplateBody</code>. If both are passed, only <code>TemplateBody</code> is used.</p>
    ///   - [`template_url(Option<String>)`](crate::input::ValidateTemplateInput::template_url): <p>Location of file containing the template body. The URL must point to a template (max size: 460,800 bytes) that is located in an Amazon S3 bucket or a Systems Manager document. For more information, go to <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html">Template Anatomy</a> in the CloudFormation User Guide.</p>  <p>Conditional: You must pass <code>TemplateURL</code> or <code>TemplateBody</code>. If both are passed, only <code>TemplateBody</code> is used.</p>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeAccountLimitsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeStackEventsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::DescribeStackResourceDriftsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeStacksPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListImportsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListStackInstancesPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListStackResourcesPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListStacksPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::ListStackSetOperationResultsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListStackSetOperationsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListStackSetsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListTypeRegistrationsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListTypesPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListTypeVersionsPaginator<C, M, R> {
