...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_resource_scan_input::ser_start_resource_scan_input_input_input(&input)?);
...
impl ::std::error::Error for StartResourceScanError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ,
            Self::ResourceScanLimitExceededException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
