...
impl StopStackSetOperationInput {
    /// Consumes the builder and constructs an Operation<[`StopStackSetOperation`](crate::operation::stop_stack_set_operation::StopStackSetOperation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_stack_set_operation::StopStackSetOperation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_stack_set_operation::StopStackSetOperationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_stack_set_operation_input::ser_stop_stack_set_operation_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_stack_set_operation::StopStackSetOperation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopStackSetOperation", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopStackSetOperation {
                type Output = std::result::Result<crate::operation::stop_stack_set_operation::StopStackSetOperationOutput, crate::operation::stop_stack_set_operation::StopStackSetOperationError>;
