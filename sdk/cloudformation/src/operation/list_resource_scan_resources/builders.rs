...
impl ListResourceScanResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_resource_scan_resources::ListResourceScanResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_scan_resources::ListResourceScanResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_resource_scan_resources::ListResourceScanResourcesOutput, crate::operation::list_resource_scan_resources::ListResourceScanResourcesError, Self> {
