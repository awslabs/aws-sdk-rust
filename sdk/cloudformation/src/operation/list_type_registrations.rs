...
impl ListTypeRegistrationsInput {
    /// Consumes the builder and constructs an Operation<[`ListTypeRegistrations`](crate::operation::list_type_registrations::ListTypeRegistrations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_type_registrations::ListTypeRegistrations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_type_registrations::ListTypeRegistrationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_type_registrations_input::ser_list_type_registrations_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_type_registrations::ListTypeRegistrations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTypeRegistrations", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListTypeRegistrations {
                type Output = std::result::Result<crate::operation::list_type_registrations::ListTypeRegistrationsOutput, crate::operation::list_type_registrations::ListTypeRegistrationsError>;
