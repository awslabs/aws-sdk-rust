...
impl DescribeEventsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `operation_events`. Queries to the underlying service
...
impl DescribeEventsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_events_output_output_operation_events(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
