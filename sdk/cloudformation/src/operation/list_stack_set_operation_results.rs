...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStackSetOperationResults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stack_set_operation_results::de_list_stack_set_operation_results_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListStackSetOperationResultsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError
{
