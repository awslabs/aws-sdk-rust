...
impl ListStackSetOperationResultsInput {
    /// Consumes the builder and constructs an Operation<[`ListStackSetOperationResults`](crate::operation::list_stack_set_operation_results::ListStackSetOperationResults)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_stack_set_operation_results::ListStackSetOperationResults, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_stack_set_operation_results_input::ser_list_stack_set_operation_results_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_stack_set_operation_results::ListStackSetOperationResults::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListStackSetOperationResults", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListStackSetOperationResults {
                type Output = std::result::Result<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsOutput, crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError>;
