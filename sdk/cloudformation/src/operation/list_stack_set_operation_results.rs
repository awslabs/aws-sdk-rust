...
impl ListStackSetOperationResultsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_stack_set_operation_results::ListStackSetOperationResults::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStackSetOperationResults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stack_set_operation_results::de_list_stack_set_operation_results_http_response_with_props(
                status, headers, body,
            )
        }
    }
