...
/// Orchestration and serialization glue logic for `ListStackSetOperationResults`.
...
impl ListStackSetOperationResults {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsInput,
                    ) -> ::std::result::Result<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListStackSetOperationResults {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListStackSetOperationResults");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListStackSetOperationResultsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListStackSetOperationResultsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListStackSetOperationResults")
...
.with_interceptor(ListStackSetOperationResultsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListStackSetOperationResultsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_stack_set_operation_results::de_list_stack_set_operation_results_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_stack_set_operation_results::de_list_stack_set_operation_results_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListStackSetOperationResultsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_stack_set_operation_results_input::ser_list_stack_set_operation_results_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ListStackSetOperationResultsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListStackSetOperationResultsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListStackSetOperationResultsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListStackSetOperationResultsInput>()
                        .ok_or("failed to downcast to ListStackSetOperationResultsInput")?;
...
pub enum ListStackSetOperationResultsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListStackSetOperationResultsError) for what information is available for the error.")]
...
impl ListStackSetOperationResultsError {
    /// Creates the `ListStackSetOperationResultsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListStackSetOperationResultsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListStackSetOperationResultsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsError {
...
mod _list_stack_set_operation_results_output;
