...
impl DescribeStackSetOperationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_stack_set_operation::DescribeStackSetOperationInput, ::aws_smithy_types::error::operation::BuildError> {
