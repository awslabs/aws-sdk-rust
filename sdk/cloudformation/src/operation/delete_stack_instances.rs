...
impl DeleteStackInstancesInput {
    /// Consumes the builder and constructs an Operation<[`DeleteStackInstances`](crate::operation::delete_stack_instances::DeleteStackInstances)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        if self.operation_id.is_none() {
            self.operation_id = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_stack_instances_input::ser_delete_stack_instances_input_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_stack_instances::DeleteStackInstances::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteStackInstances", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStackInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_stack_instances::de_delete_stack_instances_http_response_with_props(status, headers, body)
        }
    }
}
