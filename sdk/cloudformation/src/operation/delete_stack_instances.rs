...
impl DeleteStackInstancesInput {
    ...
    > {
        ...
        if self.operation_id.is_none() {
            self.operation_id = ::std::option::Option::Some(
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_stack_instances::DeleteStackInstances::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_stack_instances::DeleteStackInstancesError
{
