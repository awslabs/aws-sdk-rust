...
impl DeleteStackInstancesInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_stack_instances::DeleteStackInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_stack_instances::DeleteStackInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteStackInstances {
                type Output = std::result::Result<crate::operation::delete_stack_instances::DeleteStackInstancesOutput, crate::operation::delete_stack_instances::DeleteStackInstancesError>;
