...
impl ListImports {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudFormation", "ListImports", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListImportsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ExportName") {
            if let ::std::option::Option::Some(value) = input.export_name.as_deref() {
                captured.insert("ExportName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListImportsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_imports_input::ser_list_imports_input_input_input(
            &input,
        )?);
