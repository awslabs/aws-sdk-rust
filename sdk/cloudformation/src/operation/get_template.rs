...
impl GetTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetTemplate`](crate::operation::get_template::GetTemplate)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_template::GetTemplate, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_template_input::ser_get_template_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_template::GetTemplate::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetTemplate", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTemplate {
    type Output = ::std::result::Result<crate::operation::get_template::GetTemplateOutput, crate::operation::get_template::GetTemplateError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_template::de_get_template_http_response_with_props(status, headers, body)
        }
    }
}
