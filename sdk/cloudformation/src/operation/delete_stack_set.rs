...
impl DeleteStackSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_stack_set_input::ser_delete_stack_set_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_stack_set::DeleteStackSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStackSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_stack_set::de_delete_stack_set_http_error(
                status, headers, body,
            )
        } else {
