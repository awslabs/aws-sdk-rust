...
impl DescribeStackDriftDetectionStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_stack_drift_detection_status::DescribeStackDriftDetectionStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStackDriftDetectionStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_stack_drift_detection_status::de_describe_stack_drift_detection_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
