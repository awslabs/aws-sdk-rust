...
impl ListChangeSetsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_change_sets_input::ser_list_change_sets_input_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_change_sets::ListChangeSets::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListChangeSets {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_change_sets::de_list_change_sets_http_error(
                status, headers, body,
            )
        } else {
