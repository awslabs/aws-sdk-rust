...
impl ListChangeSetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_change_sets::ListChangeSets, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListChangeSets {
    type Output =
        ::std::result::Result<crate::operation::list_change_sets::ListChangeSetsOutput, crate::operation::list_change_sets::ListChangeSetsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_change_sets::de_list_change_sets_http_response_with_props(status, headers, body)
        }
    }
}
