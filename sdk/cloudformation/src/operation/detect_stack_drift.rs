...
/// Orchestration and serialization glue logic for `DetectStackDrift`.
...
impl DetectStackDrift {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::detect_stack_drift::DetectStackDriftInput,
                    ) -> ::std::result::Result<crate::operation::detect_stack_drift::DetectStackDriftOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_stack_drift::DetectStackDriftError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detect_stack_drift::DetectStackDriftError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detect_stack_drift::DetectStackDriftOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetectStackDrift {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetectStackDrift");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetectStackDriftRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetectStackDriftResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetectStackDrift")
...
.with_interceptor(DetectStackDriftEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detect_stack_drift::DetectStackDriftError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detect_stack_drift::DetectStackDriftError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detect_stack_drift::DetectStackDriftError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetectStackDriftResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detect_stack_drift::de_detect_stack_drift_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_detect_stack_drift::de_detect_stack_drift_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetectStackDriftRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detect_stack_drift::DetectStackDriftInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detect_stack_drift::DetectStackDriftInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detect_stack_drift_input::ser_detect_stack_drift_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DetectStackDriftEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetectStackDriftEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetectStackDriftEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetectStackDriftInput>()
                        .ok_or("failed to downcast to DetectStackDriftInput")?;
...
pub enum DetectStackDriftError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetectStackDriftError) for what information is available for the error.")]
...
impl DetectStackDriftError {
    /// Creates the `DetectStackDriftError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetectStackDriftError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetectStackDriftError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detect_stack_drift::DetectStackDriftError {
...
mod _detect_stack_drift_output;
