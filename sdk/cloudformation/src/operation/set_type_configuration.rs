...
impl SetTypeConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`SetTypeConfiguration`](crate::operation::set_type_configuration::SetTypeConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_type_configuration::SetTypeConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_type_configuration::SetTypeConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_type_configuration_input::ser_set_type_configuration_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_type_configuration::SetTypeConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetTypeConfiguration", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetTypeConfiguration {
                type Output = std::result::Result<crate::operation::set_type_configuration::SetTypeConfigurationOutput, crate::operation::set_type_configuration::SetTypeConfigurationError>;
