...
impl crate::operation::detect_stack_drift::builders::DetectStackDriftInputBuilder {
...
/// <p>For a list of stack resources that currently support drift detection, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resource-import-supported-resources.html">Resource type support for imports and drift detection</a>.</p>
...
impl DetectStackDriftFluentBuilder {
    /// Creates a new `DetectStackDriftFluentBuilder`.
