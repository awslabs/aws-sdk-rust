...
impl DescribeStackResourceDriftsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_stack_resource_drifts::DescribeStackResourceDriftsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_stack_resource_drifts::DescribeStackResourceDriftsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_stack_resource_drifts::DescribeStackResourceDriftsOutput, crate::operation::describe_stack_resource_drifts::DescribeStackResourceDriftsError, Self> {
