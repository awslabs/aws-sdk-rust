...
impl ListStackResourcesInput {
    /// Consumes the builder and constructs an Operation<[`ListStackResources`](crate::operation::list_stack_resources::ListStackResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_stack_resources::ListStackResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_stack_resources::ListStackResourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_stack_resources_input::ser_list_stack_resources_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_stack_resources::ListStackResources::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListStackResources", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListStackResources {
                type Output = std::result::Result<crate::operation::list_stack_resources::ListStackResourcesOutput, crate::operation::list_stack_resources::ListStackResourcesError>;
