...
impl ListStackResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_stack_resources::ListStackResources,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStackResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stack_resources::de_list_stack_resources_http_response_with_props(status, headers, body)
        }
    }
}
