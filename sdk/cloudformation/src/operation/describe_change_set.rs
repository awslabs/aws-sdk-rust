...
impl DescribeChangeSetInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_change_set::DescribeChangeSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_change_set_input::ser_describe_change_set_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_change_set::DescribeChangeSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeChangeSet", "cloudformation"));
