...
impl DetectStackResourceDriftInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::detect_stack_resource_drift::DetectStackResourceDrift::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectStackResourceDrift {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_stack_resource_drift::de_detect_stack_resource_drift_http_response_with_props(status, headers, body)
        }
    }
}
