...
impl ValidateTemplateInput {
    /// Consumes the builder and constructs an Operation<[`ValidateTemplate`](crate::operation::validate_template::ValidateTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_template::ValidateTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_template::ValidateTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_validate_template_input::ser_validate_template_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_template::ValidateTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ValidateTemplate", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for ValidateTemplate {
                type Output = std::result::Result<crate::operation::validate_template::ValidateTemplateOutput, crate::operation::validate_template::ValidateTemplateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_validate_template::de_validate_template_http_error(response)
                     } else {
                        crate::protocol_serde::shape_validate_template::de_validate_template_http_response(response)
                     }
                }
            }
