...
impl TestTypeInput {
    /// Consumes the builder and constructs an Operation<[`TestType`](crate::operation::test_type::TestType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::test_type::TestType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_type::TestTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_test_type_input::ser_test_type_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::test_type::TestType::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TestType", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for TestType {
                type Output = std::result::Result<crate::operation::test_type::TestTypeOutput, crate::operation::test_type::TestTypeError>;
