...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_change_set::CreateChangeSetOutput,
        crate::operation::create_change_set::CreateChangeSetError,
    > for CreateChangeSetFluentBuilder
{
    fn send(
        self,
...
impl CreateChangeSetFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_change_set::builders::CreateChangeSetInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_change_set::CreateChangeSet::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_change_set::CreateChangeSet::orchestrate(&runtime_plugins, input).await
    }
    ...
    /// <li>
    /// <p><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-instanceprofile.html"> <code>AWS::IAM::InstanceProfile</code> </a></p></li>
    /// <li>
    /// <p><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-policy.html"> <code>AWS::IAM::Policy</code> </a></p></li>
    /// <li>
    /// <p><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-role.html"> <code>AWS::IAM::Role</code> </a></p></li>
    /// <li>
    /// <p><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-user.html"> <code>AWS::IAM::User</code> </a></p></li>
    /// <li>
    /// <p><a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-iam-addusertogroup.html"> <code>AWS::IAM::UserToGroupAddition</code> </a></p></li>
    /// </ul>
    ...
    /// </note>
    /// <p>For more information about macros, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html">Using CloudFormation macros to perform custom processing on templates</a>.</p></li>
    /// </ul><note>
    ...
    /// <li>
    /// <p><code>DO_NOTHING</code> - if the stack creation fails, do nothing. This is equivalent to specifying <code>true</code> for the <code>DisableRollback</code> parameter to the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_ExecuteChangeSet.html"> <code>ExecuteChangeSet</code> </a> API operation.</p></li>
    /// <li>
    ...
    pub fn on_stack_failure(mut self, input: crate::types::OnStackFailure) -> Self {
        self.inner = self.inner.on_stack_failure(input);
        self
    }
    /// <p>Determines what action will be taken if stack creation fails. If this parameter is specified, the <code>DisableRollback</code> parameter to the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_ExecuteChangeSet.html"> <code>ExecuteChangeSet</code> </a> API operation must not be specified. This must be one of these values:</p>
    /// <ul>
    ...
    pub fn import_existing_resources(mut self, input: bool) -> Self {
        self.inner = self.inner.import_existing_resources(input);
        self
    }
    /// <p>Indicates if the change set imports resources that already exist.</p><note>
    /// <p>This parameter can only import resources that have custom names in templates. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html">name type</a> in the <i>CloudFormation User Guide</i>. To import resources that do not accept custom names, such as EC2 instances, use the resource import feature instead. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resource-import.html">Bringing existing resources into CloudFormation management</a> in the <i>CloudFormation User Guide</i>.</p>
    ...
    pub fn set_import_existing_resources(mut self, input: ::std::option::Option<bool>) -> Self {
        self.inner = self.inner.set_import_existing_resources(input);
        self
    }
    /// <p>Indicates if the change set imports resources that already exist.</p><note>
    /// <p>This parameter can only import resources that have custom names in templates. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-name.html">name type</a> in the <i>CloudFormation User Guide</i>. To import resources that do not accept custom names, such as EC2 instances, use the resource import feature instead. For more information, see <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/resource-import.html">Bringing existing resources into CloudFormation management</a> in the <i>CloudFormation User Guide</i>.</p>
