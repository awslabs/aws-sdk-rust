...
impl ContinueUpdateRollback {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::continue_update_rollback::ContinueUpdateRollbackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::continue_update_rollback::ContinueUpdateRollbackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::continue_update_rollback::ContinueUpdateRollbackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::continue_update_rollback::ContinueUpdateRollbackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ContinueUpdateRollback {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ContinueUpdateRollback");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ContinueUpdateRollbackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ContinueUpdateRollbackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ContinueUpdateRollback")
...
.with_interceptor(ContinueUpdateRollbackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::continue_update_rollback::ContinueUpdateRollbackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::continue_update_rollback::ContinueUpdateRollbackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::continue_update_rollback::ContinueUpdateRollbackError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ContinueUpdateRollbackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_continue_update_rollback::de_continue_update_rollback_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_continue_update_rollback::de_continue_update_rollback_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ContinueUpdateRollbackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::continue_update_rollback::ContinueUpdateRollbackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::continue_update_rollback::ContinueUpdateRollbackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_continue_update_rollback_input::ser_continue_update_rollback_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ContinueUpdateRollbackEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ContinueUpdateRollbackEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ContinueUpdateRollbackEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ContinueUpdateRollbackInput>()
                        .ok_or("failed to downcast to ContinueUpdateRollbackInput")?;
...
pub enum ContinueUpdateRollbackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ContinueUpdateRollbackError) for what information is available for the error.")]
...
impl ContinueUpdateRollbackError {
    /// Creates the `ContinueUpdateRollbackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ContinueUpdateRollbackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ContinueUpdateRollbackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::continue_update_rollback::ContinueUpdateRollbackError {
...
mod _continue_update_rollback_output;
