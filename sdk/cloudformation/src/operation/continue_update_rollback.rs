...
impl ContinueUpdateRollbackInput {
    /// Consumes the builder and constructs an Operation<[`ContinueUpdateRollback`](crate::operation::continue_update_rollback::ContinueUpdateRollback)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::continue_update_rollback::ContinueUpdateRollback, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::continue_update_rollback::ContinueUpdateRollbackInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_continue_update_rollback_input::ser_continue_update_rollback_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::continue_update_rollback::ContinueUpdateRollback::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ContinueUpdateRollback", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for ContinueUpdateRollback {
                type Output = std::result::Result<crate::operation::continue_update_rollback::ContinueUpdateRollbackOutput, crate::operation::continue_update_rollback::ContinueUpdateRollbackError>;
