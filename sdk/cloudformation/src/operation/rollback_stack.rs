...
impl RollbackStack {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::rollback_stack::RollbackStackInput,
                    ) -> ::std::result::Result<crate::operation::rollback_stack::RollbackStackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rollback_stack::RollbackStackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::rollback_stack::RollbackStackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::rollback_stack::RollbackStackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RollbackStack {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RollbackStack");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RollbackStackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RollbackStackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RollbackStack")
...
.with_interceptor(RollbackStackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::rollback_stack::RollbackStackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::rollback_stack::RollbackStackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::rollback_stack::RollbackStackError>::new());
...
#[derive(Debug)]
            struct RollbackStackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RollbackStackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_rollback_stack::de_rollback_stack_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_rollback_stack::de_rollback_stack_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RollbackStackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RollbackStackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::rollback_stack::RollbackStackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::rollback_stack::RollbackStackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_rollback_stack_input::ser_rollback_stack_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RollbackStackEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RollbackStackEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RollbackStackEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RollbackStackInput>()
                        .ok_or("failed to downcast to RollbackStackInput")?;
...
pub enum RollbackStackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RollbackStackError) for what information is available for the error.")]
...
impl RollbackStackError {
    /// Creates the `RollbackStackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RollbackStackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::TokenAlreadyExistsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RollbackStackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::rollback_stack::RollbackStackError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::rollback_stack::_rollback_stack_output::RollbackStackOutput;

pub use crate::operation::rollback_stack::_rollback_stack_input::RollbackStackInput;

mod _rollback_stack_input;

mod _rollback_stack_output;
