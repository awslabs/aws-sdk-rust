...
impl RollbackStackInput {
    /// Consumes the builder and constructs an Operation<[`RollbackStack`](crate::operation::rollback_stack::RollbackStack)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::rollback_stack::RollbackStack, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_rollback_stack_input::ser_rollback_stack_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::rollback_stack::RollbackStack::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RollbackStack", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RollbackStack {
    type Output = ::std::result::Result<crate::operation::rollback_stack::RollbackStackOutput, crate::operation::rollback_stack::RollbackStackError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_rollback_stack::de_rollback_stack_http_response_with_props(status, headers, body)
        }
    }
}
