...
impl RollbackStackInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_rollback_stack_input::ser_rollback_stack_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rollback_stack::RollbackStack::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RollbackStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_rollback_stack::de_rollback_stack_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_rollback_stack::de_rollback_stack_http_response_with_props(
                status, headers, body,
            )
        }
    }
