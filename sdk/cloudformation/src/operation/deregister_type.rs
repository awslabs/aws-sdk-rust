...
impl DeregisterTypeInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_type_input::ser_deregister_type_input_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_type::DeregisterType::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterType {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_deregister_type::de_deregister_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_deregister_type::de_deregister_type_http_response(
                status, headers, body,
            )
        }
    }
