...
impl CreateStackSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateStackSet`](crate::operation::create_stack_set::CreateStackSet)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_stack_set::CreateStackSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_stack_set::CreateStackSet::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStackSet", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStackSet {
    type Output =
        ::std::result::Result<crate::operation::create_stack_set::CreateStackSetOutput, crate::operation::create_stack_set::CreateStackSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_stack_set::de_create_stack_set_http_response_with_props(status, headers, body)
        }
    }
}
