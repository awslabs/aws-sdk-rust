...
impl CreateStackSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_stack_set::CreateStackSet,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_stack_set_input::ser_create_stack_set_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_stack_set::CreateStackSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStackSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_stack_set::de_create_stack_set_http_error(
                status, headers, body,
            )
        } else {
