...
impl RegisterTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_type::RegisterType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_type::de_register_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_type::de_register_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
