...
impl RegisterTypeInput {
    /// Consumes the builder and constructs an Operation<[`RegisterType`](crate::operation::register_type::RegisterType)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_type::RegisterType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_type_input::ser_register_type_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_type::RegisterType::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterType", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterType {
    type Output = ::std::result::Result<crate::operation::register_type::RegisterTypeOutput, crate::operation::register_type::RegisterTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_type::de_register_type_http_response_with_props(status, headers, body)
        }
    }
}
