...
impl ListStackSetOperationResultsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_stack_set_operation_results::ListStackSetOperationResultsInput, ::aws_smithy_types::error::operation::BuildError> {
