...
impl UpdateTerminationProtectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_termination_protection::UpdateTerminationProtection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTerminationProtection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_termination_protection::de_update_termination_protection_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateTerminationProtectionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_termination_protection::UpdateTerminationProtectionError
{
