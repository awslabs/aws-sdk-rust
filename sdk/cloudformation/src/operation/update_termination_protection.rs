...
impl UpdateTerminationProtectionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTerminationProtection`](crate::operation::update_termination_protection::UpdateTerminationProtection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_termination_protection::UpdateTerminationProtection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_termination_protection::UpdateTerminationProtectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_termination_protection_input::ser_update_termination_protection_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_termination_protection::UpdateTerminationProtection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateTerminationProtection", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTerminationProtection {
                type Output = std::result::Result<crate::operation::update_termination_protection::UpdateTerminationProtectionOutput, crate::operation::update_termination_protection::UpdateTerminationProtectionError>;
