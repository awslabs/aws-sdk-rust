...
impl SetStackPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_stack_policy_input::ser_set_stack_policy_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_stack_policy::SetStackPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetStackPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_stack_policy::de_set_stack_policy_http_error(
                status, headers, body,
            )
        } else {
