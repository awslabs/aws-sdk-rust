...
impl ListStacksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_stacks::ListStacks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_stacks_input::ser_list_stacks_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStacks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stacks::de_list_stacks_http_response_with_props(status, headers, body)
        }
    }
}
