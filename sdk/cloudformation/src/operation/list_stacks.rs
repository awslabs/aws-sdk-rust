...
impl ListStacksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_stacks::ListStacks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStacks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_stacks::de_list_stacks_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_stacks::de_list_stacks_http_response_with_props(
                status, headers, body,
            )
        }
    }
