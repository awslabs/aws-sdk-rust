...
impl ImportStacksToStackSet {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::import_stacks_to_stack_set::ImportStacksToStackSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::import_stacks_to_stack_set::ImportStacksToStackSetOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ImportStacksToStackSet",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::import_stacks_to_stack_set::ImportStacksToStackSetInput =
                    input.downcast_mut().expect("correct type");
                if input.operation_id.is_none() {
                    input.operation_id = ::std::option::Option::Some(token_provider.make_idempotency_token());
                }
            },
        ));
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportStacksToStackSet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ImportStacksToStackSet");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ImportStacksToStackSetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ImportStacksToStackSetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ImportStacksToStackSet")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportStacksToStackSet")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ImportStacksToStackSetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ImportStacksToStackSetEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct ImportStacksToStackSetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportStacksToStackSetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ImportStacksToStackSetInput>() else {
        ...
        if requested.should_capture("StackIdsUrl") {
            if let ::std::option::Option::Some(value) = input.stack_ids_url.as_deref() {
                captured.insert("StackIdsUrl", value);
            }
        }
        if requested.should_capture("OperationId") {
            if let ::std::option::Option::Some(value) = input.operation_id.as_deref() {
                captured.insert("OperationId", value);
            }
        }
...
#[derive(Debug)]
struct ImportStacksToStackSetResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportStacksToStackSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_import_stacks_to_stack_set::de_import_stacks_to_stack_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_import_stacks_to_stack_set::de_import_stacks_to_stack_set_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ImportStacksToStackSetRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportStacksToStackSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::import_stacks_to_stack_set::ImportStacksToStackSetInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_import_stacks_to_stack_set_input::ser_import_stacks_to_stack_set_input_input_input(&input)?,
        );
...
#[derive(Debug)]
struct ImportStacksToStackSetEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportStacksToStackSetEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ImportStacksToStackSetEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ImportStacksToStackSetInput>()
            .ok_or("failed to downcast to ImportStacksToStackSetInput")?;
...
pub enum ImportStacksToStackSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ImportStacksToStackSetError) for what information is available for the error.")]
...
impl ImportStacksToStackSetError {
    ...
    /// Creates the `ImportStacksToStackSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OperationIdAlreadyExistsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::OperationInProgressException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::StackNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::StackSetNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::StaleRequestException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for ImportStacksToStackSetError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::OperationIdAlreadyExistsException(_inner) => ::std::option::Option::Some(_inner),
            Self::OperationInProgressException(_inner) => ::std::option::Option::Some(_inner),
            Self::StackNotFoundException(_inner) => ::std::option::Option::Some(_inner),
            Self::StackSetNotFoundException(_inner) => ::std::option::Option::Some(_inner),
            Self::StaleRequestException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ImportStacksToStackSetError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::OperationIdAlreadyExistsException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::OperationInProgressException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::StackNotFoundException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::StackSetNotFoundException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::StaleRequestException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ImportStacksToStackSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::import_stacks_to_stack_set::ImportStacksToStackSetError {
