...
impl ListExportsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Export, ::aws_smithy_http::result::SdkError<crate::operation::list_exports::ListExportsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_exports_output_exports(page).unwrap_or_default().into_iter())
    }
}
