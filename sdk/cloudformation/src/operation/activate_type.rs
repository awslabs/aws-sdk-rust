...
impl ActivateTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::activate_type::ActivateType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ActivateType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_activate_type::de_activate_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_activate_type::de_activate_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
