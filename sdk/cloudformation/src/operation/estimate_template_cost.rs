...
impl EstimateTemplateCostInput {
    /// Consumes the builder and constructs an Operation<[`EstimateTemplateCost`](crate::operation::estimate_template_cost::EstimateTemplateCost)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::estimate_template_cost::EstimateTemplateCost, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::estimate_template_cost::EstimateTemplateCostInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_estimate_template_cost_input::ser_estimate_template_cost_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::estimate_template_cost::EstimateTemplateCost::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EstimateTemplateCost", "cloudformation"));
