...
impl UpdateStackInstancesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_stack_instances::UpdateStackInstances,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStackInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_stack_instances::de_update_stack_instances_http_response_with_props(status, headers, body)
        }
    }
}
