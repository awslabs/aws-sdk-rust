...
impl UpdateStackInstancesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStackInstances`](crate::operation::update_stack_instances::UpdateStackInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_stack_instances::UpdateStackInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_stack_instances::UpdateStackInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_stack_instances_input::ser_update_stack_instances_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_stack_instances::UpdateStackInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateStackInstances", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateStackInstances {
                type Output = std::result::Result<crate::operation::update_stack_instances::UpdateStackInstancesOutput, crate::operation::update_stack_instances::UpdateStackInstancesError>;
