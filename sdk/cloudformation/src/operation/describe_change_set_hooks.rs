...
impl DescribeChangeSetHooksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeChangeSetHooks`](crate::operation::describe_change_set_hooks::DescribeChangeSetHooks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_change_set_hooks::DescribeChangeSetHooks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_change_set_hooks::DescribeChangeSetHooksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_change_set_hooks_input::ser_describe_change_set_hooks_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_change_set_hooks::DescribeChangeSetHooks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeChangeSetHooks", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeChangeSetHooks {
                type Output = std::result::Result<crate::operation::describe_change_set_hooks::DescribeChangeSetHooksOutput, crate::operation::describe_change_set_hooks::DescribeChangeSetHooksError>;
