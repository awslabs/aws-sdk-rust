...
impl DescribeTypeRegistrationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_type_registration::DescribeTypeRegistrationInput, ::aws_smithy_types::error::operation::BuildError> {
