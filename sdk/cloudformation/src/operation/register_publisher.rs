...
impl RegisterPublisherInput {
    /// Consumes the builder and constructs an Operation<[`RegisterPublisher`](crate::operation::register_publisher::RegisterPublisher)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_publisher::RegisterPublisher, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_publisher::RegisterPublisherInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_publisher_input::ser_register_publisher_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_publisher::RegisterPublisher::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterPublisher", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterPublisher {
                type Output = std::result::Result<crate::operation::register_publisher::RegisterPublisherOutput, crate::operation::register_publisher::RegisterPublisherError>;
