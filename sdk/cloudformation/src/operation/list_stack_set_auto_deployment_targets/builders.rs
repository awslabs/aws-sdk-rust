...
impl ListStackSetAutoDeploymentTargetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_stack_set_auto_deployment_targets::ListStackSetAutoDeploymentTargetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_stack_set_auto_deployment_targets::ListStackSetAutoDeploymentTargetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_stack_set_auto_deployment_targets::ListStackSetAutoDeploymentTargetsOutput, crate::operation::list_stack_set_auto_deployment_targets::ListStackSetAutoDeploymentTargetsError, Self> {
