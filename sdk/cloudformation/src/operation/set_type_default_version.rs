...
impl SetTypeDefaultVersionInput {
    /// Consumes the builder and constructs an Operation<[`SetTypeDefaultVersion`](crate::operation::set_type_default_version::SetTypeDefaultVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_type_default_version::SetTypeDefaultVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_type_default_version::SetTypeDefaultVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_type_default_version_input::ser_set_type_default_version_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_type_default_version::SetTypeDefaultVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetTypeDefaultVersion", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetTypeDefaultVersion {
                type Output = std::result::Result<crate::operation::set_type_default_version::SetTypeDefaultVersionOutput, crate::operation::set_type_default_version::SetTypeDefaultVersionError>;
