...
impl SetTypeDefaultVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::set_type_default_version::SetTypeDefaultVersion,
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetTypeDefaultVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_type_default_version::de_set_type_default_version_http_response_with_props(status, headers, body)
        }
    }
}
