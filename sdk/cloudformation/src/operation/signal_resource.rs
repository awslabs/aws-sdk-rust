...
impl SignalResourceInput {
    /// Consumes the builder and constructs an Operation<[`SignalResource`](crate::operation::signal_resource::SignalResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::signal_resource::SignalResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::signal_resource::SignalResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_signal_resource_input::ser_signal_resource_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::signal_resource::SignalResource::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SignalResource", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for SignalResource {
                type Output = std::result::Result<crate::operation::signal_resource::SignalResourceOutput, crate::operation::signal_resource::SignalResourceError>;
