...
impl SignalResourceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_signal_resource_input::ser_signal_resource_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::signal_resource::SignalResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SignalResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_signal_resource::de_signal_resource_http_error(
                status, headers, body,
            )
        } else {
