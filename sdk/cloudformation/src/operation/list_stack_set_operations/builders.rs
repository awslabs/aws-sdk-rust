...
impl ListStackSetOperationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_stack_set_operations::ListStackSetOperationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_stack_set_operations::ListStackSetOperationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_stack_set_operations::ListStackSetOperationsOutput, crate::operation::list_stack_set_operations::ListStackSetOperationsError, Self> {
