...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDescribeTypeConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_describe_type_configurations::de_batch_describe_type_configurations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_describe_type_configurations::BatchDescribeTypeConfigurationsError
{
