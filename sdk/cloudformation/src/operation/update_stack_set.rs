...
impl UpdateStackSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_stack_set::UpdateStackSet, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStackSet {
    type Output =
        ::std::result::Result<crate::operation::update_stack_set::UpdateStackSetOutput, crate::operation::update_stack_set::UpdateStackSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_stack_set::de_update_stack_set_http_response_with_props(status, headers, body)
        }
    }
}
