...
impl UpdateStackSetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStackSet`](crate::operation::update_stack_set::UpdateStackSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_stack_set::UpdateStackSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_stack_set::UpdateStackSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_stack_set_input::ser_update_stack_set_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_stack_set::UpdateStackSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateStackSet", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateStackSet {
                type Output = std::result::Result<crate::operation::update_stack_set::UpdateStackSetOutput, crate::operation::update_stack_set::UpdateStackSetError>;
