...
impl UpdateStackSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_stack_set::UpdateStackSet,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_stack_set_input::ser_update_stack_set_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_stack_set::UpdateStackSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStackSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_stack_set::de_update_stack_set_http_error(
                status, headers, body,
            )
        } else {
