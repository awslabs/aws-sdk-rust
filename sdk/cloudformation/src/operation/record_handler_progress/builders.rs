...
impl RecordHandlerProgressFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::record_handler_progress::RecordHandlerProgressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::record_handler_progress::RecordHandlerProgressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::record_handler_progress::RecordHandlerProgressOutput, crate::operation::record_handler_progress::RecordHandlerProgressError, Self> {
