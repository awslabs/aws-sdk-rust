...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::estimate_template_cost::EstimateTemplateCostOutput,
                    crate::operation::estimate_template_cost::EstimateTemplateCostError,
                > for EstimateTemplateCostFluentBuilder
            {
                fn send(
                    self,
...
impl EstimateTemplateCostFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::estimate_template_cost::EstimateTemplateCostOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::estimate_template_cost::EstimateTemplateCostError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::estimate_template_cost::EstimateTemplateCost::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::estimate_template_cost::EstimateTemplateCost::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::estimate_template_cost::EstimateTemplateCostOutput, crate::operation::estimate_template_cost::EstimateTemplateCostError, Self> {
