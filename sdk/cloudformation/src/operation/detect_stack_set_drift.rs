...
/// Orchestration and serialization glue logic for `DetectStackSetDrift`.
...
impl DetectStackSetDrift {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::detect_stack_set_drift::DetectStackSetDriftOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_stack_set_drift::DetectStackSetDriftError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detect_stack_set_drift::DetectStackSetDriftError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detect_stack_set_drift::DetectStackSetDriftOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::detect_stack_set_drift::DetectStackSetDriftInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetectStackSetDrift {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetectStackSetDrift");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetectStackSetDriftRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetectStackSetDriftResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetectStackSetDrift")
...
.with_interceptor(DetectStackSetDriftEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detect_stack_set_drift::DetectStackSetDriftError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detect_stack_set_drift::DetectStackSetDriftError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detect_stack_set_drift::DetectStackSetDriftError>::new());
...
#[derive(Debug)]
            struct DetectStackSetDriftResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetectStackSetDriftResponseDeserializer {
...
#[derive(Debug)]
            struct DetectStackSetDriftRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetectStackSetDriftRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detect_stack_set_drift::DetectStackSetDriftInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detect_stack_set_drift::DetectStackSetDriftInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detect_stack_set_drift_input::ser_detect_stack_set_drift_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DetectStackSetDriftEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetectStackSetDriftEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetectStackSetDriftEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetectStackSetDriftInput>()
                        .ok_or("failed to downcast to DetectStackSetDriftInput")?;
...
pub enum DetectStackSetDriftError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetectStackSetDriftError) for what information is available for the error.")]
...
impl DetectStackSetDriftError {
    /// Creates the `DetectStackSetDriftError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetectStackSetDriftError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetectStackSetDriftError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detect_stack_set_drift::DetectStackSetDriftError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::detect_stack_set_drift::_detect_stack_set_drift_output::DetectStackSetDriftOutput;

pub use crate::operation::detect_stack_set_drift::_detect_stack_set_drift_input::DetectStackSetDriftInput;

mod _detect_stack_set_drift_input;

mod _detect_stack_set_drift_output;
