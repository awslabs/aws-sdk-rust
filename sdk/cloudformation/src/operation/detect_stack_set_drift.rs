...
impl DetectStackSetDriftInput {
    /// Consumes the builder and constructs an Operation<[`DetectStackSetDrift`](crate::operation::detect_stack_set_drift::DetectStackSetDrift)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detect_stack_set_drift::DetectStackSetDrift, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_stack_set_drift::DetectStackSetDriftInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detect_stack_set_drift_input::ser_detect_stack_set_drift_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detect_stack_set_drift::DetectStackSetDrift::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetectStackSetDrift", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for DetectStackSetDrift {
                type Output = std::result::Result<crate::operation::detect_stack_set_drift::DetectStackSetDriftOutput, crate::operation::detect_stack_set_drift::DetectStackSetDriftError>;
