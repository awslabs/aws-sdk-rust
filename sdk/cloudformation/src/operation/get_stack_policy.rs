...
impl GetStackPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_stack_policy_input::ser_get_stack_policy_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_stack_policy::GetStackPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStackPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_stack_policy::de_get_stack_policy_http_error(
                status, headers, body,
            )
        } else {
