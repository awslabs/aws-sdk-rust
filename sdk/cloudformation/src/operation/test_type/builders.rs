...
impl TestTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::test_type::TestTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_type::TestTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
