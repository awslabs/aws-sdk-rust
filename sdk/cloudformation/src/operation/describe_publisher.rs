...
impl DescribePublisherInput {
    /// Consumes the builder and constructs an Operation<[`DescribePublisher`](crate::operation::describe_publisher::DescribePublisher)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_publisher::DescribePublisher, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_publisher::DescribePublisherInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_publisher_input::ser_describe_publisher_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_publisher::DescribePublisher::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePublisher", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePublisher {
                type Output = std::result::Result<crate::operation::describe_publisher::DescribePublisherOutput, crate::operation::describe_publisher::DescribePublisherError>;
