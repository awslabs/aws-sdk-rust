...
impl DescribePublisherInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_publisher::DescribePublisher,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePublisher {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_publisher::de_describe_publisher_http_response_with_props(status, headers, body)
        }
    }
}
