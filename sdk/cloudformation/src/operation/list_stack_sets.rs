...
impl ListStackSetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_stack_sets::ListStackSets,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_stack_sets_input::ser_list_stack_sets_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_stack_sets::ListStackSets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStackSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_stack_sets::de_list_stack_sets_http_error(
                status, headers, body,
            )
        } else {
