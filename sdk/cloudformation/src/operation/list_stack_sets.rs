...
impl ListStackSetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_stack_sets::ListStackSets, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStackSets {
    type Output =
        ::std::result::Result<crate::operation::list_stack_sets::ListStackSetsOutput, crate::operation::list_stack_sets::ListStackSetsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stack_sets::de_list_stack_sets_http_response_with_props(status, headers, body)
        }
    }
}
