...
impl PublishTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::publish_type::PublishType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_publish_type::de_publish_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_publish_type::de_publish_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
