...
impl PublishTypeInput {
    /// Consumes the builder and constructs an Operation<[`PublishType`](crate::operation::publish_type::PublishType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::publish_type::PublishType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::publish_type::PublishTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_publish_type_input::ser_publish_type_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::publish_type::PublishType::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PublishType", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for PublishType {
                type Output = std::result::Result<crate::operation::publish_type::PublishTypeOutput, crate::operation::publish_type::PublishTypeError>;
