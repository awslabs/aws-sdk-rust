...
impl CreateStackInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_stack::CreateStack, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_stack_input::ser_create_stack_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_stack::CreateStack::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStack", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_stack::de_create_stack_http_response_with_props(status, headers, body)
        }
    }
}
