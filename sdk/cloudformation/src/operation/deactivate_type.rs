...
impl DeactivateTypeInput {
    /// Consumes the builder and constructs an Operation<[`DeactivateType`](crate::operation::deactivate_type::DeactivateType)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::deactivate_type::DeactivateType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deactivate_type::DeactivateType::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeactivateType", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeactivateType {
    type Output =
        ::std::result::Result<crate::operation::deactivate_type::DeactivateTypeOutput, crate::operation::deactivate_type::DeactivateTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deactivate_type::de_deactivate_type_http_response_with_props(status, headers, body)
        }
    }
}
