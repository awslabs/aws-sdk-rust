...
impl DeactivateTypeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deactivate_type::DeactivateType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deactivate_type::DeactivateTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deactivate_type_input::ser_deactivate_type_input_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for DeactivateType {
                type Output = std::result::Result<crate::operation::deactivate_type::DeactivateTypeOutput, crate::operation::deactivate_type::DeactivateTypeError>;
