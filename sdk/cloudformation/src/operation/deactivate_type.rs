...
impl DeactivateTypeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deactivate_type_input::ser_deactivate_type_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deactivate_type::DeactivateType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeactivateType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_deactivate_type::de_deactivate_type_http_error(
                status, headers, body,
            )
        } else {
