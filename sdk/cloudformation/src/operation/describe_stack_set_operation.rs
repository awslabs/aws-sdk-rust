...
/// Orchestration and serialization glue logic for `DescribeStackSetOperation`.
...
impl DescribeStackSetOperation {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_stack_set_operation::DescribeStackSetOperationInput,
                    ) -> ::std::result::Result<crate::operation::describe_stack_set_operation::DescribeStackSetOperationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_stack_set_operation::DescribeStackSetOperationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_stack_set_operation::DescribeStackSetOperationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_stack_set_operation::DescribeStackSetOperationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeStackSetOperation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeStackSetOperation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeStackSetOperationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeStackSetOperationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeStackSetOperation")
...
.with_interceptor(DescribeStackSetOperationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_stack_set_operation::DescribeStackSetOperationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_stack_set_operation::DescribeStackSetOperationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_stack_set_operation::DescribeStackSetOperationError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeStackSetOperationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_stack_set_operation::de_describe_stack_set_operation_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_stack_set_operation::de_describe_stack_set_operation_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeStackSetOperationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_stack_set_operation::DescribeStackSetOperationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_stack_set_operation::DescribeStackSetOperationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_stack_set_operation_input::ser_describe_stack_set_operation_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeStackSetOperationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeStackSetOperationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeStackSetOperationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeStackSetOperationInput>()
                        .ok_or("failed to downcast to DescribeStackSetOperationInput")?;
...
pub enum DescribeStackSetOperationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeStackSetOperationError) for what information is available for the error.")]
...
impl DescribeStackSetOperationError {
    /// Creates the `DescribeStackSetOperationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeStackSetOperationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeStackSetOperationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_stack_set_operation::DescribeStackSetOperationError {
...
mod _describe_stack_set_operation_output;
