...
impl DescribeStackSetOperationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_stack_set_operation::DescribeStackSetOperation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStackSetOperation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_stack_set_operation::de_describe_stack_set_operation_http_response_with_props(status, headers, body)
        }
    }
}
