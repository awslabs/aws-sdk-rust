...
impl DescribeStackSetOperationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStackSetOperation`](crate::operation::describe_stack_set_operation::DescribeStackSetOperation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_stack_set_operation::DescribeStackSetOperation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_stack_set_operation::DescribeStackSetOperationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_stack_set_operation_input::ser_describe_stack_set_operation_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_stack_set_operation::DescribeStackSetOperation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeStackSetOperation", "cloudformation"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeStackSetOperation {
                type Output = std::result::Result<crate::operation::describe_stack_set_operation::DescribeStackSetOperationOutput, crate::operation::describe_stack_set_operation::DescribeStackSetOperationError>;
