...
impl DescribePublisherFluentBuilder  {
    /// Creates a new `DescribePublisher`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_publisher::DescribePublisherOutput, aws_smithy_http::result::SdkError<crate::operation::describe_publisher::DescribePublisherError>>
                     {
