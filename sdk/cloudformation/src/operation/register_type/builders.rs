...
/// <p>You can have a maximum of 50 resource extension versions registered at a time. This maximum is per account and per Region. Use <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_DeregisterType.html"> <code>DeregisterType</code> </a> to deregister specific extension versions if necessary.</p>
