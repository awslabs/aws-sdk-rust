...
#[allow(unused_mut)]
pub fn serialize_structure_type_configuration_identifier(
    mut writer: smithy_query::QueryValueWriter,
...
pub fn serialize_structure_rollback_configuration(
    ...
    if let Some(var_24) = &input.rollback_triggers {
        ...
        for item_25 in var_24 {
            ...
            crate::query_ser::serialize_structure_rollback_trigger(entry_27, item_25);
        }
        list_26.finish();
    }
    #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn serialize_structure_type_filters(
    mut writer: smithy_query::QueryValueWriter,
