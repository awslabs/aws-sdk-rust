...
pub fn serialize_structure_crate_input_add_layer_version_permission_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddLayerVersionPermissionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_add_permission_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddPermissionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_code_signing_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCodeSigningConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_event_source_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEventSourceMappingInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_function_url_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFunctionUrlConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_publish_layer_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PublishLayerVersionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_publish_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PublishVersionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_function_code_signing_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutFunctionCodeSigningConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_function_concurrency_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutFunctionConcurrencyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_function_event_invoke_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutFunctionEventInvokeConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_provisioned_concurrency_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutProvisionedConcurrencyConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_code_signing_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCodeSigningConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_event_source_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEventSourceMappingInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_function_code_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionCodeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_function_configuration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionConfigurationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_function_event_invoke_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionEventInvokeConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_function_url_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionUrlConfigInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_alias_routing_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AliasRoutingConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_197) = &input.additional_version_weights {
        ...
        for (key_199, value_200) in var_197 {
             {
                object_198.key(key_199).number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*value_200).into()));
            }
        }
        object_198.finish();
    }
...
pub fn serialize_structure_crate_model_allowed_publishers(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AllowedPublishers) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_code_signing_policies(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CodeSigningPolicies) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_amazon_managed_kafka_event_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AmazonManagedKafkaEventSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_self_managed_event_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SelfManagedEventSource) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_self_managed_kafka_event_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SelfManagedKafkaEventSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_source_access_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SourceAccessConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_function_code(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunctionCode) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_dead_letter_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeadLetterConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_tracing_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TracingConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_layer_version_content_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LayerVersionContentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_on_success(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OnSuccess) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_on_failure(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OnFailure) -> Result<(), aws_smithy_http::operation::SerializationError> {
