...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::send_durable_execution_callback_success::SendDurableExecutionCallbackSuccessError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                        ...
                        match crate::protocol_serde::shape_too_many_requests_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::send_durable_execution_callback_success::SendDurableExecutionCallbackSuccessError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
