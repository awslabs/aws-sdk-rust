...
pub fn de_get_function_code_signing_config_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetFunctionCodeSigningConfigOutput, crate::error::GetFunctionCodeSigningConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetFunctionCodeSigningConfigError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_function_code_signing_config_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetFunctionCodeSigningConfigOutput, crate::error::GetFunctionCodeSigningConfigError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_function_code_signing_config(value: &[u8], mut builder: crate::output::get_function_code_signing_config_output::Builder) -> Result<crate::output::get_function_code_signing_config_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
