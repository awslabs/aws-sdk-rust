...
pub(crate) fn de_layer_versions_list_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LayerVersionsListItem>, aws_smithy_json::deserialize::error::DeserializeError>
