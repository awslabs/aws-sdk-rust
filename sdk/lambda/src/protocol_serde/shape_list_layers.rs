...
pub fn de_list_layers_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_layers::ListLayersOutput, crate::operation::list_layers::ListLayersError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::list_layers::builders::ListLayersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Layers" => {
                    builder = builder.set_layers(crate::protocol_serde::shape_layers_list::de_layers_list(tokens)?);
                }
                "NextMarker" => {
