...
pub(crate) fn de_dead_letter_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::DeadLetterConfig>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DeadLetterConfigBuilder::default();
            loop {
                match tokens.next().transpose()? {
