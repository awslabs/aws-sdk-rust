...
) -> Result<Option<crate::types::ImageConfigResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Error" => {
                            builder = builder.set_error(crate::protocol_serde::shape_image_config_error::de_image_config_error(tokens)?);
                        }
