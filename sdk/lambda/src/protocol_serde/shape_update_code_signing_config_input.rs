...
pub fn ser_update_code_signing_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCodeSigningConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
