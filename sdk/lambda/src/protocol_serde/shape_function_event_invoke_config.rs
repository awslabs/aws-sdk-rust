...
pub(crate) fn de_function_event_invoke_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FunctionEventInvokeConfig>, aws_smithy_json::deserialize::error::DeserializeError>
