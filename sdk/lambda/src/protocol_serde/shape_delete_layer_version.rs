...
pub fn de_delete_layer_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_layer_version::DeleteLayerVersionOutput, crate::operation::delete_layer_version::DeleteLayerVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_layer_version::DeleteLayerVersionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_layer_version::DeleteLayerVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_layer_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_layer_version::DeleteLayerVersionOutput, crate::operation::delete_layer_version::DeleteLayerVersionError> {
    Ok({
        #[allow(unused_mut)]
