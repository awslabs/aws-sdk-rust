...
pub fn ser_update_function_url_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionUrlConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
