...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_event_source_mapping_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_event_source_mapping::GetEventSourceMappingOutput, crate::operation::get_event_source_mapping::GetEventSourceMappingError> {
    Ok({
        #[allow(unused_mut)]
