...
pub(crate) fn de_function_url_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FunctionUrlConfig>, aws_smithy_json::deserialize::error::DeserializeError>
