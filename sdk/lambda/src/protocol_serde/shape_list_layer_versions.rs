...
pub fn de_list_layer_versions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_layer_versions::ListLayerVersionsOutput, crate::operation::list_layer_versions::ListLayerVersionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_layer_versions::ListLayerVersionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_layer_versions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_layer_versions::ListLayerVersionsOutput, crate::operation::list_layer_versions::ListLayerVersionsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_layer_versions::builders::ListLayerVersionsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_layer_versions::de_list_layer_versions(response.body().as_ref(), output).map_err(crate::operation::list_layer_versions::ListLayerVersionsError::unhandled)?;
