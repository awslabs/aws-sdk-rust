...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_layer_version_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_layer_version::GetLayerVersionOutput, crate::operation::get_layer_version::GetLayerVersionError> {
...
) -> Result<crate::operation::get_layer_version::builders::GetLayerVersionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
