...
pub fn ser_update_function_code_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionCodeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
