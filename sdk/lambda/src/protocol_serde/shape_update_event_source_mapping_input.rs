...
pub fn ser_update_event_source_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateEventSourceMappingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
