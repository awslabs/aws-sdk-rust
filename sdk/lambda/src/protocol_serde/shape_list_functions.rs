        ...
        "TooManyRequestsException" => {
            crate::operation::list_functions::ListFunctionsError::TooManyRequestsException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(_response_body, output).map_err(crate::operation::list_functions::ListFunctionsError::unhandled)?;
        ...
        "ServiceException" => {
            crate::operation::list_functions::ListFunctionsError::ServiceException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_service_exception::de_service_exception_json_err(_response_body, output).map_err(crate::operation::list_functions::ListFunctionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidParameterValueException" => {
            crate::operation::list_functions::ListFunctionsError::InvalidParameterValueException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_json_err(_response_body, output).map_err(crate::operation::list_functions::ListFunctionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
