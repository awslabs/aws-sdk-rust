...
pub fn de_delete_event_source_mapping_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput, crate::operation::delete_event_source_mapping::DeleteEventSourceMappingError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_event_source_mapping_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput, crate::operation::delete_event_source_mapping::DeleteEventSourceMappingError> {
    Ok({
        #[allow(unused_mut)]
