...
pub fn ser_function_code(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunctionCode) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
