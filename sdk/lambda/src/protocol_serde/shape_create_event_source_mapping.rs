...
pub fn de_create_event_source_mapping_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_event_source_mapping::CreateEventSourceMappingOutput, crate::operation::create_event_source_mapping::CreateEventSourceMappingError> {
    #[allow(unused_mut)]
...
pub fn ser_create_event_source_mapping_input(input: &crate::operation::create_event_source_mapping::CreateEventSourceMappingInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
