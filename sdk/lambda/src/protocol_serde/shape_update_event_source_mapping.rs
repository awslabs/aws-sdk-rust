...
pub fn de_update_event_source_mapping_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_event_source_mapping::UpdateEventSourceMappingOutput, crate::operation::update_event_source_mapping::UpdateEventSourceMappingError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_event_source_mapping_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_event_source_mapping::UpdateEventSourceMappingOutput, crate::operation::update_event_source_mapping::UpdateEventSourceMappingError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_event_source_mapping_input(input: &crate::operation::update_event_source_mapping::UpdateEventSourceMappingInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
