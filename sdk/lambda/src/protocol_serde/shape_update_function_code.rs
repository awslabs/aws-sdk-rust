...
pub fn ser_update_function_code_input(input: &crate::operation::update_function_code::UpdateFunctionCodeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
