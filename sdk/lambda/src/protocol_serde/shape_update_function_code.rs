...
pub fn ser_update_function_code_input(
    ...
    crate::protocol_serde::shape_update_function_code_input::ser_update_function_code_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        ...
        "ServiceException" => {
            crate::error::UpdateFunctionCodeError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub(crate) fn de_update_function_code(
    ...
    crate::output::update_function_code_output::Builder,
