...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_function_code_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::update_function_code::builders::UpdateFunctionCodeOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
