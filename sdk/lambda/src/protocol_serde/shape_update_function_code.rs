...
pub fn de_update_function_code_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_function_code::UpdateFunctionCodeOutput, crate::operation::update_function_code::UpdateFunctionCodeError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        "CodeSigningConfigNotFoundException" => crate::operation::update_function_code::UpdateFunctionCodeError::CodeSigningConfigNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_function_code_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_function_code::UpdateFunctionCodeOutput, crate::operation::update_function_code::UpdateFunctionCodeError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_function_code_input(input: &crate::operation::update_function_code::UpdateFunctionCodeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_update_function_code(value: &[u8], mut builder: crate::operation::update_function_code::builders::UpdateFunctionCodeOutputBuilder) -> Result<crate::operation::update_function_code::builders::UpdateFunctionCodeOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
