        ...
        "TooManyRequestsException" => {
            crate::operation::create_alias::CreateAliasError::TooManyRequestsException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(_response_body, output).map_err(crate::operation::create_alias::CreateAliasError::unhandled)?;
        ...
        "ServiceException" => {
            crate::operation::create_alias::CreateAliasError::ServiceException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_service_exception::de_service_exception_json_err(_response_body, output).map_err(crate::operation::create_alias::CreateAliasError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "InvalidParameterValueException" => {
            crate::operation::create_alias::CreateAliasError::InvalidParameterValueException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_json_err(_response_body, output).map_err(crate::operation::create_alias::CreateAliasError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "ResourceConflictException" => {
            crate::operation::create_alias::CreateAliasError::ResourceConflictException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_resource_conflict_exception::de_resource_conflict_exception_json_err(_response_body, output).map_err(crate::operation::create_alias::CreateAliasError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
