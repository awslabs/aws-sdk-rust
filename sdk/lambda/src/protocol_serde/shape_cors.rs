            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AllowHeaders" => {
                            builder = builder.set_allow_headers(crate::protocol_serde::shape_headers_list::de_headers_list(tokens)?);
                        }
                        "AllowMethods" => {
                            builder = builder.set_allow_methods(crate::protocol_serde::shape_allow_methods_list::de_allow_methods_list(tokens)?);
                        }
                        "AllowOrigins" => {
                            builder = builder.set_allow_origins(crate::protocol_serde::shape_allow_origins_list::de_allow_origins_list(tokens)?);
                        }
                        "ExposeHeaders" => {
                            builder = builder.set_expose_headers(crate::protocol_serde::shape_headers_list::de_headers_list(tokens)?);
                        }
                        "MaxAge" => {
