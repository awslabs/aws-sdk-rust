...
pub fn ser_publish_version_input(input: &crate::input::PublishVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_publish_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PublishVersionOutput, crate::error::PublishVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PublishVersionError::unhandled)?;
    ...
    Err(match error_code {
        "CodeStorageExceededException" => crate::error::PublishVersionError::CodeStorageExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_code_storage_exceeded_exception::de_code_storage_exceeded_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
        ...
        "InvalidParameterValueException" => crate::error::PublishVersionError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "PreconditionFailedException" => crate::error::PublishVersionError::PreconditionFailedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_precondition_failed_exception::de_precondition_failed_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "ResourceConflictException" => crate::error::PublishVersionError::ResourceConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_conflict_exception::de_resource_conflict_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "ResourceNotFoundException" => crate::error::PublishVersionError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_exception::de_service_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "TooManyRequestsException" => crate::error::PublishVersionError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_publish_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PublishVersionOutput, crate::error::PublishVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::publish_version_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_publish_version::de_publish_version(response.body().as_ref(), output).map_err(crate::error::PublishVersionError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_publish_version(value: &[u8], mut builder: crate::output::publish_version_output::Builder) -> Result<crate::output::publish_version_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
