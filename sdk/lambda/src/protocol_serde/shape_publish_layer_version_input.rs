...
pub fn ser_publish_layer_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PublishLayerVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
