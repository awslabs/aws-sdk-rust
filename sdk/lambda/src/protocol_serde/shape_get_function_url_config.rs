...
pub fn de_get_function_url_config_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_function_url_config::GetFunctionUrlConfigOutput, crate::operation::get_function_url_config::GetFunctionUrlConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_function_url_config::GetFunctionUrlConfigError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_service_exception::de_service_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_function_url_config::GetFunctionUrlConfigError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_function_url_config_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_function_url_config::GetFunctionUrlConfigOutput, crate::operation::get_function_url_config::GetFunctionUrlConfigError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_function_url_config::builders::GetFunctionUrlConfigOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_function_url_config::de_get_function_url_config(response.body().as_ref(), output).map_err(crate::operation::get_function_url_config::GetFunctionUrlConfigError::unhandled)?;
