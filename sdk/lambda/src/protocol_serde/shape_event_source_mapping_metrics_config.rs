...
) -> Result<Option<crate::types::EventSourceMappingMetricsConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Metrics" => {
                            builder = builder.set_metrics(
                                crate::protocol_serde::shape_event_source_mapping_metric_list::de_event_source_mapping_metric_list(tokens)?,
                            );
                        }
