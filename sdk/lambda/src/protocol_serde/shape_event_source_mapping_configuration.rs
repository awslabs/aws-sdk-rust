...
pub(crate) fn de_event_source_mapping_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EventSourceMappingConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
