...
impl CreateEventSourceMappingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_event_source_mapping::CreateEventSourceMappingInput, ::aws_smithy_types::error::operation::BuildError> {
