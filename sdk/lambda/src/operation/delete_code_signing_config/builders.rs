...
impl DeleteCodeSigningConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_code_signing_config::DeleteCodeSigningConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_code_signing_config::DeleteCodeSigningConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_code_signing_config::DeleteCodeSigningConfigOutput, crate::operation::delete_code_signing_config::DeleteCodeSigningConfigError, Self> {
