...
impl CreateEventSourceMappingInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_event_source_mapping::CreateEventSourceMapping::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEventSourceMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_create_event_source_mapping::de_create_event_source_mapping_http_response_with_props(status, headers, body)
        }
    }
}
