...
impl CreateEventSourceMappingInput {
    /// Consumes the builder and constructs an Operation<[`CreateEventSourceMapping`](crate::operation::create_event_source_mapping::CreateEventSourceMapping)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_event_source_mapping::CreateEventSourceMapping, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_event_source_mapping::CreateEventSourceMappingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_event_source_mapping::CreateEventSourceMapping::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateEventSourceMapping {
                type Output = std::result::Result<crate::operation::create_event_source_mapping::CreateEventSourceMappingOutput, crate::operation::create_event_source_mapping::CreateEventSourceMappingError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 202 {
                        crate::protocol_serde::shape_create_event_source_mapping::de_create_event_source_mapping_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_event_source_mapping::de_create_event_source_mapping_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::create_event_source_mapping::CreateEventSourceMappingError {
