...
impl PutFunctionCodeSigningConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_function_code_signing_config::PutFunctionCodeSigningConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutFunctionCodeSigningConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_function_code_signing_config::de_put_function_code_signing_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
