...
impl PutFunctionCodeSigningConfigInput {
    /// Consumes the builder and constructs an Operation<[`PutFunctionCodeSigningConfig`](crate::operation::put_function_code_signing_config::PutFunctionCodeSigningConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_function_code_signing_config::PutFunctionCodeSigningConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_function_code_signing_config::PutFunctionCodeSigningConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutFunctionCodeSigningConfig {
                type Output = std::result::Result<crate::operation::put_function_code_signing_config::PutFunctionCodeSigningConfigOutput, crate::operation::put_function_code_signing_config::PutFunctionCodeSigningConfigError>;
