...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProvisionedConcurrencyConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_provisioned_concurrency_config::de_delete_provisioned_concurrency_config_http_response_with_props(status, headers, body)
        }
    }
}
