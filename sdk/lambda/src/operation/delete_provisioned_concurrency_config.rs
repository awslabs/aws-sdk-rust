...
impl DeleteProvisionedConcurrencyConfigInput {
    /// Consumes the builder and constructs an Operation<[`DeleteProvisionedConcurrencyConfig`](crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteProvisionedConcurrencyConfig {
                type Output = std::result::Result<crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigOutput, crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_provisioned_concurrency_config::DeleteProvisionedConcurrencyConfigError {
