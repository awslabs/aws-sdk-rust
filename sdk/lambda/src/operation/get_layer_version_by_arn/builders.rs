...
impl GetLayerVersionByArnFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_layer_version_by_arn::GetLayerVersionByArnOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_layer_version_by_arn::GetLayerVersionByArnError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_layer_version_by_arn::GetLayerVersionByArnOutput, crate::operation::get_layer_version_by_arn::GetLayerVersionByArnError, Self> {
