...
impl InvokeAsyncInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::invoke_async::InvokeAsync, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_invoke_async_input::ser_invoke_args_http_payload(self.invoke_args)?.into_inner(),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for InvokeAsync {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_invoke_async::de_invoke_async_http_response_with_props(status, headers, body)
        }
    }
}
