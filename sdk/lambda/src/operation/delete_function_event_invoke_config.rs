...
impl DeleteFunctionEventInvokeConfigInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_function_event_invoke_config::DeleteFunctionEventInvokeConfig,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFunctionEventInvokeConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_function_event_invoke_config::de_delete_function_event_invoke_config_http_response_with_props(status, headers, body)
        }
    }
}
