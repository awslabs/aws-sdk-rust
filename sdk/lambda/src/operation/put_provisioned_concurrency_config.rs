...
impl PutProvisionedConcurrencyConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_provisioned_concurrency_config::PutProvisionedConcurrencyConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutProvisionedConcurrencyConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_put_provisioned_concurrency_config::de_put_provisioned_concurrency_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
