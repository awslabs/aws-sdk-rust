...
impl ListLayersInput {
    /// Consumes the builder and constructs an Operation<[`ListLayers`](crate::operation::list_layers::ListLayers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_layers::ListLayers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_layers::ListLayersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2018-10-31/layers").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_layers::ListLayersInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.compatible_runtime {
                     {
                ...
                if let Some(inner_4) = &_input.compatible_architecture {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_layers::ListLayers::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListLayers {
                type Output = std::result::Result<crate::operation::list_layers::ListLayersOutput, crate::operation::list_layers::ListLayersError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_layers::de_list_layers_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_layers::de_list_layers_http_response(response)
                     }
                }
            }
