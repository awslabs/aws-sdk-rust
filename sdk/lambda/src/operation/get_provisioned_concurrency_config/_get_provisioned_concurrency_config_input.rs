...
impl GetProvisionedConcurrencyConfigInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_provisioned_concurrency_config::GetProvisionedConcurrencyConfigInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
