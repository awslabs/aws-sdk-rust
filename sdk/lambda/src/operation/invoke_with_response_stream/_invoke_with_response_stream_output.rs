...
pub struct InvokeWithResponseStreamOutput  {
    ...
    pub event_stream: crate::event_receiver::EventReceiver<crate::types::InvokeWithResponseStreamResponseEvent, crate::types::error::InvokeWithResponseStreamResponseEventError>,
...
impl  InvokeWithResponseStreamOutput  {
    ...
    /// <p>The stream of response payloads.</p>
    pub fn event_stream(&self) -> & crate::event_receiver::EventReceiver<crate::types::InvokeWithResponseStreamResponseEvent, crate::types::error::InvokeWithResponseStreamResponseEventError> {
        &self.event_stream
    }
    /// <p>The type of data the stream is returning.</p>
...
pub struct InvokeWithResponseStreamOutputBuilder {
    ...
    pub(crate) event_stream: ::std::option::Option<crate::event_receiver::EventReceiver<crate::types::InvokeWithResponseStreamResponseEvent, crate::types::error::InvokeWithResponseStreamResponseEventError>>,
...
impl InvokeWithResponseStreamOutputBuilder {
    ...
    /// <p>The stream of response payloads.</p>
    pub fn event_stream(mut self, input: crate::event_receiver::EventReceiver<crate::types::InvokeWithResponseStreamResponseEvent, crate::types::error::InvokeWithResponseStreamResponseEventError>) -> Self {
        self.event_stream = ::std::option::Option::Some(input);
        self
    }
    /// <p>The stream of response payloads.</p>
    pub fn set_event_stream(mut self, input: ::std::option::Option<crate::event_receiver::EventReceiver<crate::types::InvokeWithResponseStreamResponseEvent, crate::types::error::InvokeWithResponseStreamResponseEventError>>) -> Self {
        self.event_stream = input; self
    }
    /// <p>The stream of response payloads.</p>
    pub fn get_event_stream(&self) -> &::std::option::Option<crate::event_receiver::EventReceiver<crate::types::InvokeWithResponseStreamResponseEvent, crate::types::error::InvokeWithResponseStreamResponseEventError>> {
        &self.event_stream
    }
    /// <p>The type of data the stream is returning.</p>
    ...
    pub fn set_response_stream_content_type(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.response_stream_content_type = input; self
    }
    /// <p>The type of data the stream is returning.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::invoke_with_response_stream::InvokeWithResponseStreamOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::invoke_with_response_stream::InvokeWithResponseStreamOutput {
                ...
                event_stream: self.event_stream
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("event_stream", "event_stream was not specified but it is required when building InvokeWithResponseStreamOutput")
                    )?
                ,
