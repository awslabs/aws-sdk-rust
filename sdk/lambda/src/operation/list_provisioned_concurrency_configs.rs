...
impl ListProvisionedConcurrencyConfigsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProvisionedConcurrencyConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_provisioned_concurrency_configs::de_list_provisioned_concurrency_configs_http_response_with_props(
                status, headers, body,
            )
        }
    }
