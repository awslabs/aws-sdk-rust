...
impl ListFunctionsByCodeSigningConfigPaginator {
    ...
    /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfigOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfigError>>> + ::std::marker::Unpin
                 {
...
impl ListFunctionsByCodeSigningConfigPaginatorItems {
    ...
    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<::std::string::String, ::aws_smithy_http::result::SdkError<crate::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfigError>>> + ::std::marker::Unpin
                     {
