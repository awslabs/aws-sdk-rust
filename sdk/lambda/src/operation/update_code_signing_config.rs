...
impl UpdateCodeSigningConfigInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCodeSigningConfig`](crate::operation::update_code_signing_config::UpdateCodeSigningConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_code_signing_config::UpdateCodeSigningConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_code_signing_config::UpdateCodeSigningConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_code_signing_config::UpdateCodeSigningConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateCodeSigningConfig {
                type Output = std::result::Result<crate::operation::update_code_signing_config::UpdateCodeSigningConfigOutput, crate::operation::update_code_signing_config::UpdateCodeSigningConfigError>;
