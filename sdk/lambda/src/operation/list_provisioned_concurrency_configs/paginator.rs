...
/// Paginator for [`ListProvisionedConcurrencyConfigs`](crate::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigs)
            ...
            impl ListProvisionedConcurrencyConfigsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsOutput, aws_smithy_http::result::SdkError<crate::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListProvisionedConcurrencyConfigsPaginator`
                ...
                impl  ListProvisionedConcurrencyConfigsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::ProvisionedConcurrencyConfigListItem, aws_smithy_http::result::SdkError<crate::operation::list_provisioned_concurrency_configs::ListProvisionedConcurrencyConfigsError>>> + Unpin
                     {
