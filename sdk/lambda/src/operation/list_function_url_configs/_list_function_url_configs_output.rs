...
impl  ListFunctionUrlConfigsOutput  {
    ...
    pub fn function_url_configs(&self) -> & [crate::types::FunctionUrlConfig] {
        use std::ops::Deref; self.function_url_configs.deref()
    }
    /// <p>The pagination token that's included if more results are available.</p>
...
impl ListFunctionUrlConfigsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_function_url_configs::ListFunctionUrlConfigsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_function_url_configs::ListFunctionUrlConfigsOutput {
                function_url_configs: self.function_url_configs
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("function_url_configs", "function_url_configs was not specified but it is required when building ListFunctionUrlConfigsOutput")
                    )?
                ,
