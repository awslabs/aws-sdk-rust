...
impl DeleteFunctionCodeSigningConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFunctionCodeSigningConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_function_code_signing_config::de_delete_function_code_signing_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
