...
impl DeleteFunctionCodeSigningConfigInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFunctionCodeSigningConfig`](crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFunctionCodeSigningConfig {
                type Output = std::result::Result<crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfigOutput, crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfigError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_function_code_signing_config::DeleteFunctionCodeSigningConfigError {
