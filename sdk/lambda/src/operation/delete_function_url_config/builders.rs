...
impl DeleteFunctionUrlConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_function_url_config::DeleteFunctionUrlConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_function_url_config::DeleteFunctionUrlConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_function_url_config::DeleteFunctionUrlConfigOutput, crate::operation::delete_function_url_config::DeleteFunctionUrlConfigError, Self> {
