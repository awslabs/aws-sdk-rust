...
impl ListFunctionsByCodeSigningConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_functions_by_code_signing_config::ListFunctionsByCodeSigningConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFunctionsByCodeSigningConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_functions_by_code_signing_config::de_list_functions_by_code_signing_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
