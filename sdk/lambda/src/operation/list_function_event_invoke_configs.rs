...
impl ListFunctionEventInvokeConfigsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_function_event_invoke_configs::ListFunctionEventInvokeConfigs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFunctionEventInvokeConfigs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_function_event_invoke_configs::de_list_function_event_invoke_configs_http_response_with_props(
                status, headers, body,
            )
        }
    }
