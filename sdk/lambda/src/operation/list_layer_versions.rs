...
impl ListLayerVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListLayerVersions`](crate::operation::list_layer_versions::ListLayerVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_layer_versions::ListLayerVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_layer_versions::ListLayerVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_layer_versions::ListLayerVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_2) = &_input.compatible_runtime {
                     {
                ...
                if let Some(inner_5) = &_input.compatible_architecture {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_layer_versions::ListLayerVersions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListLayerVersions {
                type Output = std::result::Result<crate::operation::list_layer_versions::ListLayerVersionsOutput, crate::operation::list_layer_versions::ListLayerVersionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_layer_versions::de_list_layer_versions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_layer_versions::de_list_layer_versions_http_response(response)
                     }
                }
            }
