...
/// Paginator for [`ListFunctionEventInvokeConfigs`](crate::operation::list_function_event_invoke_configs::ListFunctionEventInvokeConfigs)
            ...
            impl ListFunctionEventInvokeConfigsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_function_event_invoke_configs::ListFunctionEventInvokeConfigsOutput, aws_smithy_http::result::SdkError<crate::operation::list_function_event_invoke_configs::ListFunctionEventInvokeConfigsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListFunctionEventInvokeConfigsPaginator`
                ...
                impl  ListFunctionEventInvokeConfigsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::FunctionEventInvokeConfig, aws_smithy_http::result::SdkError<crate::operation::list_function_event_invoke_configs::ListFunctionEventInvokeConfigsError>>> + Unpin
                     {
