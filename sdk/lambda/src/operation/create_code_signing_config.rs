...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCodeSigningConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_code_signing_config::de_create_code_signing_config_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_code_signing_config::de_create_code_signing_config_http_response(status, headers, body, _cfg)
        };
