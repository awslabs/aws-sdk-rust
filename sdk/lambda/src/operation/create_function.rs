...
impl CreateFunctionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_function::CreateFunction, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_function::ser_create_function_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFunction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_function::de_create_function_http_response_with_props(status, headers, body)
        }
    }
