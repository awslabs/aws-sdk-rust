...
impl UpdateFunctionEventInvokeConfigInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfigInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
