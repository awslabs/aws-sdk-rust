...
impl UpdateFunctionCodeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_function_code::ser_update_function_code_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFunctionCode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_function_code::de_update_function_code_http_response_with_props(status, headers, body)
        }
    }
