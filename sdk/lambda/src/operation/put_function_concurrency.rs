...
impl PutFunctionConcurrencyInput {
    /// Consumes the builder and constructs an Operation<[`PutFunctionConcurrency`](crate::operation::put_function_concurrency::PutFunctionConcurrency)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_function_concurrency::PutFunctionConcurrency, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_function_concurrency::PutFunctionConcurrencyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_function_concurrency::PutFunctionConcurrency::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutFunctionConcurrency {
                type Output = std::result::Result<crate::operation::put_function_concurrency::PutFunctionConcurrencyOutput, crate::operation::put_function_concurrency::PutFunctionConcurrencyError>;
