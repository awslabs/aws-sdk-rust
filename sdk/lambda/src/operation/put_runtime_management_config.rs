...
impl PutRuntimeManagementConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_runtime_management_config::PutRuntimeManagementConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRuntimeManagementConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_runtime_management_config::de_put_runtime_management_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
