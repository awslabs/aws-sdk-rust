...
impl PutRuntimeManagementConfigInput {
    /// Consumes the builder and constructs an Operation<[`PutRuntimeManagementConfig`](crate::operation::put_runtime_management_config::PutRuntimeManagementConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_runtime_management_config::PutRuntimeManagementConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_runtime_management_config::PutRuntimeManagementConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::put_runtime_management_config::PutRuntimeManagementConfigInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_runtime_management_config::PutRuntimeManagementConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutRuntimeManagementConfig {
                type Output = std::result::Result<crate::operation::put_runtime_management_config::PutRuntimeManagementConfigOutput, crate::operation::put_runtime_management_config::PutRuntimeManagementConfigError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_runtime_management_config::PutRuntimeManagementConfigError {
