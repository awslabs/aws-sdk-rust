...
impl UpdateFunctionEventInvokeConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFunctionEventInvokeConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_function_event_invoke_config::de_update_function_event_invoke_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
