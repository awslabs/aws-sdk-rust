...
impl UpdateFunctionEventInvokeConfigInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFunctionEventInvokeConfig`](crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfigInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFunctionEventInvokeConfig {
                type Output = std::result::Result<crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfigOutput, crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfigError>;
...
impl aws_http::request_id::RequestId for crate::operation::update_function_event_invoke_config::UpdateFunctionEventInvokeConfigError {
