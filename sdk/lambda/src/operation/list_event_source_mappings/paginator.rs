...
/// Paginator for [`ListEventSourceMappings`](crate::operation::list_event_source_mappings::ListEventSourceMappings)
            ...
            impl ListEventSourceMappingsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_event_source_mappings::ListEventSourceMappingsOutput, aws_smithy_http::result::SdkError<crate::operation::list_event_source_mappings::ListEventSourceMappingsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListEventSourceMappingsPaginator`
                ...
                impl  ListEventSourceMappingsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::EventSourceMappingConfiguration, aws_smithy_http::result::SdkError<crate::operation::list_event_source_mappings::ListEventSourceMappingsError>>> + Unpin
                     {
