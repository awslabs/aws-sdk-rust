...
impl ListVersionsByFunctionInput {
    /// Consumes the builder and constructs an Operation<[`ListVersionsByFunction`](crate::operation::list_versions_by_function::ListVersionsByFunction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_versions_by_function::ListVersionsByFunction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_versions_by_function::ListVersionsByFunctionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_versions_by_function::ListVersionsByFunctionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_versions_by_function::ListVersionsByFunction::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListVersionsByFunction {
                type Output = std::result::Result<crate::operation::list_versions_by_function::ListVersionsByFunctionOutput, crate::operation::list_versions_by_function::ListVersionsByFunctionError>;
...
impl aws_http::request_id::RequestId for crate::operation::list_versions_by_function::ListVersionsByFunctionError {
