...
impl RemoveLayerVersionPermissionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_layer_version_permission::RemoveLayerVersionPermission::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveLayerVersionPermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_remove_layer_version_permission::de_remove_layer_version_permission_http_response_with_props(
                status, headers, body,
            )
        }
    }
