...
impl GetLayerVersionByArnInput {
    /// Consumes the builder and constructs an Operation<[`GetLayerVersionByArn`](crate::operation::get_layer_version_by_arn::GetLayerVersionByArn)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_layer_version_by_arn::GetLayerVersionByArn, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_layer_version_by_arn::GetLayerVersionByArnInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2018-10-31/layers").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_layer_version_by_arn::GetLayerVersionByArnInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_layer_version_by_arn::GetLayerVersionByArn::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLayerVersionByArn {
                type Output = std::result::Result<crate::operation::get_layer_version_by_arn::GetLayerVersionByArnOutput, crate::operation::get_layer_version_by_arn::GetLayerVersionByArnError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_layer_version_by_arn::GetLayerVersionByArnError {
