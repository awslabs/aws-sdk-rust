...
impl InvokeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::invoke::Invoke, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_invoke_input::ser_payload_http_payload(self.payload)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for Invoke {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_invoke::de_invoke_http_response_with_props(status, headers, body)
        }
    }
