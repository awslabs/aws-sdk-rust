...
impl GetEventSourceMappingInput {
    /// Consumes the builder and constructs an Operation<[`GetEventSourceMapping`](crate::operation::get_event_source_mapping::GetEventSourceMapping)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_event_source_mapping::GetEventSourceMapping, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_event_source_mapping::GetEventSourceMappingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.uuid;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("uuid", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_event_source_mapping::GetEventSourceMapping::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetEventSourceMapping {
                type Output = std::result::Result<crate::operation::get_event_source_mapping::GetEventSourceMappingOutput, crate::operation::get_event_source_mapping::GetEventSourceMappingError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_event_source_mapping::GetEventSourceMappingError {
