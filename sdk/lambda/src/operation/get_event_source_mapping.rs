...
impl GetEventSourceMappingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_event_source_mapping::GetEventSourceMapping,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEventSourceMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_event_source_mapping::de_get_event_source_mapping_http_response_with_props(status, headers, body)
        }
    }
}
