...
impl DeleteFunctionEventInvokeConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_function_event_invoke_config::DeleteFunctionEventInvokeConfigInput, ::aws_smithy_types::error::operation::BuildError> {
