...
impl DeleteFunctionEventInvokeConfigInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::delete_function_event_invoke_config::DeleteFunctionEventInvokeConfigInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
