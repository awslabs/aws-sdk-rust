...
impl UpdateCodeSigningConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_code_signing_config::UpdateCodeSigningConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_code_signing_config::UpdateCodeSigningConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_code_signing_config::UpdateCodeSigningConfigOutput, crate::operation::update_code_signing_config::UpdateCodeSigningConfigError, Self> {
