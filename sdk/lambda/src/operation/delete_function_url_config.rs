...
impl DeleteFunctionUrlConfigInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFunctionUrlConfig`](crate::operation::delete_function_url_config::DeleteFunctionUrlConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_function_url_config::DeleteFunctionUrlConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_function_url_config::DeleteFunctionUrlConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_function_url_config::DeleteFunctionUrlConfigInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_function_url_config::DeleteFunctionUrlConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFunctionUrlConfig {
                type Output = std::result::Result<crate::operation::delete_function_url_config::DeleteFunctionUrlConfigOutput, crate::operation::delete_function_url_config::DeleteFunctionUrlConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_delete_function_url_config::de_delete_function_url_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_function_url_config::de_delete_function_url_config_http_response(response)
                     }
                }
            }
