...
impl GetAliasInput {
    /// Consumes the builder and constructs an Operation<[`GetAlias`](crate::operation::get_alias::GetAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_alias::GetAlias, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_alias::GetAliasInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2015-03-31/functions/{FunctionName}/aliases/{Name}", FunctionName = function_name, Name = name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_alias::GetAlias::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAlias", "lambda"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAlias {
                type Output = std::result::Result<crate::operation::get_alias::GetAliasOutput, crate::operation::get_alias::GetAliasError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_alias::de_get_alias_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_alias::de_get_alias_http_response(response)
                     }
                }
            }
