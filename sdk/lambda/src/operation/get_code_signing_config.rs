...
impl GetCodeSigningConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetCodeSigningConfig`](crate::operation::get_code_signing_config::GetCodeSigningConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_code_signing_config::GetCodeSigningConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_code_signing_config::GetCodeSigningConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.code_signing_config_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("code_signing_config_arn", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_code_signing_config::GetCodeSigningConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetCodeSigningConfig {
                type Output = std::result::Result<crate::operation::get_code_signing_config::GetCodeSigningConfigOutput, crate::operation::get_code_signing_config::GetCodeSigningConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_code_signing_config::de_get_code_signing_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_code_signing_config::de_get_code_signing_config_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::get_code_signing_config::GetCodeSigningConfigError {
