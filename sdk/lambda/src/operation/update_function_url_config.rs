...
impl UpdateFunctionUrlConfigInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFunctionUrlConfig`](crate::operation::update_function_url_config::UpdateFunctionUrlConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_function_url_config::UpdateFunctionUrlConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_function_url_config::UpdateFunctionUrlConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_function_url_config::UpdateFunctionUrlConfigInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_function_url_config::UpdateFunctionUrlConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFunctionUrlConfig {
                type Output = std::result::Result<crate::operation::update_function_url_config::UpdateFunctionUrlConfigOutput, crate::operation::update_function_url_config::UpdateFunctionUrlConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_function_url_config::de_update_function_url_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_function_url_config::de_update_function_url_config_http_response(response)
                     }
                }
            }
