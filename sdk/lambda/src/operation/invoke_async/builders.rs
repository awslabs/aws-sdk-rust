...
impl InvokeAsyncFluentBuilder  {
    /// Creates a new `InvokeAsync`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::invoke_async::InvokeAsyncOutput, aws_smithy_http::result::SdkError<crate::operation::invoke_async::InvokeAsyncError>>
                     {
