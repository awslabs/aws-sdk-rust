...
impl GetFunctionCodeSigningConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_function_code_signing_config::GetFunctionCodeSigningConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFunctionCodeSigningConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_function_code_signing_config::de_get_function_code_signing_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
