...
impl CreateFunctionUrlConfigInput {
    /// Consumes the builder and constructs an Operation<[`CreateFunctionUrlConfig`](crate::operation::create_function_url_config::CreateFunctionUrlConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_function_url_config::CreateFunctionUrlConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_function_url_config::CreateFunctionUrlConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_function_url_config::CreateFunctionUrlConfigInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_function_url_config::CreateFunctionUrlConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateFunctionUrlConfig {
                type Output = std::result::Result<crate::operation::create_function_url_config::CreateFunctionUrlConfigOutput, crate::operation::create_function_url_config::CreateFunctionUrlConfigError>;
...
impl aws_http::request_id::RequestId for crate::operation::create_function_url_config::CreateFunctionUrlConfigError {
