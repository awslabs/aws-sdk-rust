            ...
            "event" =>  {
                match response_headers.smithy_type.as_str() {
                    "PayloadChunk" =>  {
                        ...
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::InvokeWithResponseStreamResponseEvent::PayloadChunk(builder.build())))
                    }
                    "InvokeComplete" =>  {
                        let parsed =
                        ...
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::InvokeWithResponseStreamResponseEvent::InvokeComplete(parsed)))
                    }
                    _unknown_variant =>  {
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::InvokeWithResponseStreamResponseEvent::Unknown))
                    }
                }
            }
            "exception" =>  {
                let generic = match crate::protocol_serde::parse_event_stream_error_metadata(message.payload()) {
                                        ...
                                        Err(err) => return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(crate::types::error::InvokeWithResponseStreamResponseEventError::unhandled(err))),
                                    };
                Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(crate::types::error::InvokeWithResponseStreamResponseEventError::generic(generic)))
            }
            value =>  {
