...
pub struct StartConfigurationSessionOutput  {
    ...
    /// </important>
    #[doc(hidden)]pub initial_configuration_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for StartConfigurationSessionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("initial_configuration_token", &self.initial_configuration_token);
        formatter.finish()
    }
}
...
pub struct GetLatestConfigurationOutput  {
    ...
    #[doc(hidden)]pub next_poll_configuration_token: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub next_poll_interval_in_seconds: i32,
    ...
    #[doc(hidden)]pub configuration: std::option::Option<aws_smithy_types::Blob>,
}
