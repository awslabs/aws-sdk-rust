...
impl BadRequestDetails {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`InvalidParameters`](crate::model::BadRequestDetails::InvalidParameters), extracting the inner [`HashMap`](std::collections::HashMap).
...
pub struct InvalidParameterDetail  {
    ...
    #[doc(hidden)]pub problem: std::option::Option<crate::model::InvalidParameterProblem>,
}
