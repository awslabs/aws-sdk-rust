...
pub fn serialize_structure_crate_input_start_configuration_session_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartConfigurationSessionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
