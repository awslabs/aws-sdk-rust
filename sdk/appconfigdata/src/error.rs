...
impl aws_smithy_http::result::CreateUnhandledError for StartConfigurationSessionError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: StartConfigurationSessionErrorKind::Unhandled(crate::error::Unhandled::new(source)),
...
impl std::fmt::Display for StartConfigurationSessionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StartConfigurationSessionErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StartConfigurationSessionErrorKind::InternalServerException(_inner) =>
            _inner.fmt(f)
            ,
            StartConfigurationSessionErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StartConfigurationSessionErrorKind::ThrottlingException(_inner) =>
            _inner.fmt(f)
            ,
            StartConfigurationSessionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StartConfigurationSessionError {
    /// Creates a new `StartConfigurationSessionError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: StartConfigurationSessionErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, StartConfigurationSessionErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `StartConfigurationSessionErrorKind::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(&self.kind, StartConfigurationSessionErrorKind::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `StartConfigurationSessionErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, StartConfigurationSessionErrorKind::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartConfigurationSessionErrorKind::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(&self.kind, StartConfigurationSessionErrorKind::ThrottlingException(_))
    }
}
...
impl std::fmt::Display for GetLatestConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetLatestConfigurationErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetLatestConfigurationErrorKind::InternalServerException(_inner) =>
            _inner.fmt(f)
            ,
            GetLatestConfigurationErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetLatestConfigurationErrorKind::ThrottlingException(_inner) =>
            _inner.fmt(f)
            ,
            GetLatestConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetLatestConfigurationError {
    /// Creates a new `GetLatestConfigurationError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: GetLatestConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetLatestConfigurationErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetLatestConfigurationErrorKind::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(&self.kind, GetLatestConfigurationErrorKind::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `GetLatestConfigurationErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, GetLatestConfigurationErrorKind::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetLatestConfigurationErrorKind::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(&self.kind, GetLatestConfigurationErrorKind::ThrottlingException(_))
    }
}
