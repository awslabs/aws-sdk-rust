...
pub(crate) fn de_next_poll_configuration_token_header(
    ...
    let headers = header_map.get_all_bytes("Next-Poll-Configuration-Token");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
...
pub(crate) fn de_next_poll_interval_in_seconds_header(
    ...
    let headers = header_map.get_all_bytes("Next-Poll-Interval-In-Seconds");
...
pub(crate) fn de_version_label_header(
    ...
    let headers = header_map.get_all_bytes("Version-Label");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
