...
pub fn de_get_latest_configuration_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_latest_configuration::GetLatestConfigurationOutput, crate::operation::get_latest_configuration::GetLatestConfigurationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_latest_configuration::GetLatestConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_latest_configuration_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_latest_configuration::GetLatestConfigurationOutput, crate::operation::get_latest_configuration::GetLatestConfigurationError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_configuration(
            crate::protocol_serde::shape_get_latest_configuration_output::de_configuration_payload(_response_body)?
        );
        output = output.set_content_type(
            crate::protocol_serde::shape_get_latest_configuration_output::de_content_type_header(_response_headers)
        ...
        output = output.set_version_label(
            crate::protocol_serde::shape_get_latest_configuration_output::de_version_label_header(_response_headers)
                                        .map_err(|_|crate::operation::get_latest_configuration::GetLatestConfigurationError::unhandled("Failed to parse VersionLabel from header `Version-Label"))?
        );
