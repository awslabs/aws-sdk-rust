...
pub fn de_get_latest_configuration_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_latest_configuration::GetLatestConfigurationOutput, crate::operation::get_latest_configuration::GetLatestConfigurationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_latest_configuration_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_latest_configuration::GetLatestConfigurationOutput, crate::operation::get_latest_configuration::GetLatestConfigurationError> {
    Ok({
        #[allow(unused_mut)]
