...
pub fn ser_start_configuration_session_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartConfigurationSessionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
