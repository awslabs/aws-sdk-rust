...
pub(crate) fn de_bad_request_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BadRequestDetails>, aws_smithy_json::deserialize::error::DeserializeError>
