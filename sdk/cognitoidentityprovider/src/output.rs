...
pub struct UpdateUserAttributesOutput  {
    ...
    #[doc(hidden)]
    pub code_delivery_details_list: std::option::Option<std::vec::Vec<crate::model::CodeDeliveryDetailsType>>,
    _request_id: Option<String>,
}
...
pub struct SetUserPoolMfaConfigOutput  {
    ...
    #[doc(hidden)]
    pub software_token_mfa_configuration: std::option::Option<crate::model::SoftwareTokenMfaConfigType>,
...
pub struct ListUserPoolClientsOutput  {
    ...
    #[doc(hidden)]
    pub user_pool_clients: std::option::Option<std::vec::Vec<crate::model::UserPoolClientDescription>>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]
    pub next_token: std::option::Option<std::string::String>,
    _request_id: Option<String>,
...
impl aws_http::request_id::RequestId for DeleteUserPoolOutput {
                                fn request_id(&self) -> Option<&str> {
                                    self._request_id.as_deref()
                                }
                            }
...
impl aws_http::request_id::RequestId for AdminSetUserMfaPreferenceOutput {
                                fn request_id(&self) -> Option<&str> {
                                    self._request_id.as_deref()
                                }
                            }
