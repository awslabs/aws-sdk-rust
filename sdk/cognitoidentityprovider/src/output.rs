...
pub struct VerifySoftwareTokenOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::VerifySoftwareTokenResponseType>,
    /// <p>The session that should be passed both ways in challenge-response calls to the service.</p>
    #[doc(hidden)]pub session: std::option::Option<std::string::String>,
}
...
pub mod verify_software_token_output {
    ...
    impl Builder {
        ...
        /// <p>The status of the verify software token.</p>
        pub fn set_status(mut self, input: std::option::Option<crate::model::VerifySoftwareTokenResponseType>) -> Self {
...
pub struct UpdateUserPoolDomainOutput  {
    ...
    #[doc(hidden)]pub cloud_front_domain: std::option::Option<std::string::String>,
}
...
pub struct UpdateUserPoolClientOutput  {
    ...
    #[doc(hidden)]pub user_pool_client: std::option::Option<crate::model::UserPoolClientType>,
}
...
pub mod update_user_pool_client_output {
    ...
    impl Builder {
        ...
        /// <p>The user pool client value from the response from the server when you request to update the user pool client.</p>
        pub fn set_user_pool_client(mut self, input: std::option::Option<crate::model::UserPoolClientType>) -> Self {
...
pub struct UpdateUserAttributesOutput  {
    ...
    #[doc(hidden)]pub code_delivery_details_list: std::option::Option<std::vec::Vec<crate::model::CodeDeliveryDetailsType>>,
}
impl UpdateUserAttributesOutput {
    /// <p>The code delivery details list from the server for the request to update user attributes.</p>
    pub fn code_delivery_details_list(&self) -> std::option::Option<& [crate::model::CodeDeliveryDetailsType]> {
...
impl  std::fmt::Debug for UpdateUserAttributesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("code_delivery_details_list", &self.code_delivery_details_list);
        formatter.finish()
    }
}
...
pub mod update_user_attributes_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) code_delivery_details_list: std::option::Option<std::vec::Vec<crate::model::CodeDeliveryDetailsType>>,
    }
    impl Builder {
        ...
        ///
        /// <p>The code delivery details list from the server for the request to update user attributes.</p>
        pub fn code_delivery_details_list(mut self, input: crate::model::CodeDeliveryDetailsType) -> Self {
        ...
        /// <p>The code delivery details list from the server for the request to update user attributes.</p>
        pub fn set_code_delivery_details_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::CodeDeliveryDetailsType>>) -> Self {
...
pub struct UpdateResourceServerOutput  {
    ...
    #[doc(hidden)]pub resource_server: std::option::Option<crate::model::ResourceServerType>,
}
...
pub mod update_resource_server_output {
    ...
    impl Builder {
        ...
        /// <p>The resource server.</p>
        pub fn set_resource_server(mut self, input: std::option::Option<crate::model::ResourceServerType>) -> Self {
...
pub struct UpdateIdentityProviderOutput  {
    /// <p>The IdP object.</p>
    #[doc(hidden)]pub identity_provider: std::option::Option<crate::model::IdentityProviderType>,
}
...
pub mod update_identity_provider_output {
    ...
    impl Builder {
        ...
        /// <p>The IdP object.</p>
        pub fn set_identity_provider(mut self, input: std::option::Option<crate::model::IdentityProviderType>) -> Self {
...
pub struct UpdateGroupOutput  {
    ...
    #[doc(hidden)]pub group: std::option::Option<crate::model::GroupType>,
}
...
pub struct StopUserImportJobOutput  {
    ...
    #[doc(hidden)]pub user_import_job: std::option::Option<crate::model::UserImportJobType>,
}
...
pub mod stop_user_import_job_output {
    ...
    impl Builder {
        ...
        /// <p>The job object that represents the user import job.</p>
        pub fn set_user_import_job(mut self, input: std::option::Option<crate::model::UserImportJobType>) -> Self {
...
pub struct SignUpOutput  {
    ...
    #[doc(hidden)]pub user_confirmed: bool,
    /// <p>The code delivery details returned by the server response to the user registration request.</p>
    #[doc(hidden)]pub code_delivery_details: std::option::Option<crate::model::CodeDeliveryDetailsType>,
    /// <p>The UUID of the authenticated user. This isn't the same as <code>username</code>.</p>
    #[doc(hidden)]pub user_sub: std::option::Option<std::string::String>,
}
impl SignUpOutput {
    /// <p>A response from the server indicating that a user registration has been confirmed.</p>
    ...
    /// <p>The code delivery details returned by the server response to the user registration request.</p>
    pub fn code_delivery_details(&self) -> std::option::Option<& crate::model::CodeDeliveryDetailsType> {
...
pub mod sign_up_output {
    ...
    pub struct Builder {
        ...
        pub(crate) code_delivery_details: std::option::Option<crate::model::CodeDeliveryDetailsType>,
    ...
    impl Builder {
        ...
        /// <p>The code delivery details returned by the server response to the user registration request.</p>
        pub fn code_delivery_details(mut self, input: crate::model::CodeDeliveryDetailsType) -> Self {
            self.code_delivery_details = Some(input);
            self
        }
        /// <p>The code delivery details returned by the server response to the user registration request.</p>
        pub fn set_code_delivery_details(mut self, input: std::option::Option<crate::model::CodeDeliveryDetailsType>) -> Self {
...
pub struct SetUserPoolMfaConfigOutput  {
    ...
    #[doc(hidden)]pub sms_mfa_configuration: std::option::Option<crate::model::SmsMfaConfigType>,
    /// <p>The software token MFA configuration.</p>
    #[doc(hidden)]pub software_token_mfa_configuration: std::option::Option<crate::model::SoftwareTokenMfaConfigType>,
    ...
    /// </ul>
    #[doc(hidden)]pub mfa_configuration: std::option::Option<crate::model::UserPoolMfaType>,
}
impl SetUserPoolMfaConfigOutput {
    ...
    /// <p>The software token MFA configuration.</p>
    pub fn software_token_mfa_configuration(&self) -> std::option::Option<& crate::model::SoftwareTokenMfaConfigType> {
...
impl  std::fmt::Debug for SetUserPoolMfaConfigOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("software_token_mfa_configuration", &self.software_token_mfa_configuration);
...
pub mod set_user_pool_mfa_config_output {
    ...
    pub struct Builder {
        ...
        pub(crate) software_token_mfa_configuration: std::option::Option<crate::model::SoftwareTokenMfaConfigType>,
...
pub struct SetUiCustomizationOutput  {
    ...
    #[doc(hidden)]pub ui_customization: std::option::Option<crate::model::UiCustomizationType>,
}
...
pub mod set_ui_customization_output {
    ...
    impl Builder {
        ...
        /// <p>The UI customization information.</p>
        pub fn set_ui_customization(mut self, input: std::option::Option<crate::model::UiCustomizationType>) -> Self {
...
pub struct SetRiskConfigurationOutput  {
    ...
    #[doc(hidden)]pub risk_configuration: std::option::Option<crate::model::RiskConfigurationType>,
}
...
pub mod set_risk_configuration_output {
    ...
    impl Builder {
        ...
        /// <p>The risk configuration.</p>
        pub fn set_risk_configuration(mut self, input: std::option::Option<crate::model::RiskConfigurationType>) -> Self {
...
pub struct RespondToAuthChallengeOutput  {
    ...
    #[doc(hidden)]pub challenge_name: std::option::Option<crate::model::ChallengeNameType>,
    ...
    #[doc(hidden)]pub challenge_parameters: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The result returned by the server in response to the request to respond to the authentication challenge.</p>
    #[doc(hidden)]pub authentication_result: std::option::Option<crate::model::AuthenticationResultType>,
}
impl RespondToAuthChallengeOutput {
    ...
    /// <p>The result returned by the server in response to the request to respond to the authentication challenge.</p>
    pub fn authentication_result(&self) -> std::option::Option<& crate::model::AuthenticationResultType> {
...
pub mod respond_to_auth_challenge_output {
    ...
    pub struct Builder {
        ...
        pub(crate) authentication_result: std::option::Option<crate::model::AuthenticationResultType>,
    }
    impl Builder {
        /// <p>The challenge name. For more information, see <a href="https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_InitiateAuth.html">InitiateAuth</a>.</p>
        ...
        /// <p>The result returned by the server in response to the request to respond to the authentication challenge.</p>
        pub fn authentication_result(mut self, input: crate::model::AuthenticationResultType) -> Self {
            self.authentication_result = Some(input);
            self
        }
        /// <p>The result returned by the server in response to the request to respond to the authentication challenge.</p>
        pub fn set_authentication_result(mut self, input: std::option::Option<crate::model::AuthenticationResultType>) -> Self {
...
pub struct ListUsersInGroupOutput  {
    ...
    #[doc(hidden)]pub users: std::option::Option<std::vec::Vec<crate::model::UserType>>,
...
pub mod list_users_in_group_output {
    ...
    impl Builder {
        ...
        /// <p>The users returned in the request to list users.</p>
        pub fn set_users(mut self, input: std::option::Option<std::vec::Vec<crate::model::UserType>>) -> Self {
...
pub struct ListUserPoolsOutput  {
    ...
    #[doc(hidden)]pub user_pools: std::option::Option<std::vec::Vec<crate::model::UserPoolDescriptionType>>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_user_pools_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) user_pools: std::option::Option<std::vec::Vec<crate::model::UserPoolDescriptionType>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        /// <p>The user pools from the response to list users.</p>
        pub fn set_user_pools(mut self, input: std::option::Option<std::vec::Vec<crate::model::UserPoolDescriptionType>>) -> Self {
...
pub struct ListUserPoolClientsOutput  {
    ...
    #[doc(hidden)]pub user_pool_clients: std::option::Option<std::vec::Vec<crate::model::UserPoolClientDescription>>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
impl ListUserPoolClientsOutput {
    /// <p>The user pool clients in the response that lists user pool clients.</p>
    pub fn user_pool_clients(&self) -> std::option::Option<& [crate::model::UserPoolClientDescription]> {
...
pub mod list_user_pool_clients_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) user_pool_clients: std::option::Option<std::vec::Vec<crate::model::UserPoolClientDescription>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        /// <p>The user pool clients in the response that lists user pool clients.</p>
        pub fn set_user_pool_clients(mut self, input: std::option::Option<std::vec::Vec<crate::model::UserPoolClientDescription>>) -> Self {
...
pub struct ListUserImportJobsOutput  {
    ...
    #[doc(hidden)]pub user_import_jobs: std::option::Option<std::vec::Vec<crate::model::UserImportJobType>>,
...
pub mod list_user_import_jobs_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) user_import_jobs: std::option::Option<std::vec::Vec<crate::model::UserImportJobType>>,
        pub(crate) pagination_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        /// <p>The user import jobs.</p>
        pub fn set_user_import_jobs(mut self, input: std::option::Option<std::vec::Vec<crate::model::UserImportJobType>>) -> Self {
...
pub struct ListResourceServersOutput  {
    ...
    #[doc(hidden)]pub resource_servers: std::option::Option<std::vec::Vec<crate::model::ResourceServerType>>,
...
pub mod list_resource_servers_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) resource_servers: std::option::Option<std::vec::Vec<crate::model::ResourceServerType>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        /// <p>The resource servers.</p>
        pub fn set_resource_servers(mut self, input: std::option::Option<std::vec::Vec<crate::model::ResourceServerType>>) -> Self {
...
pub struct ListIdentityProvidersOutput  {
    ...
    #[doc(hidden)]pub providers: std::option::Option<std::vec::Vec<crate::model::ProviderDescription>>,
    /// <p>A pagination token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_identity_providers_output {
    ...
    impl Builder {
        ...
        /// <p>A list of IdP objects.</p>
        pub fn set_providers(mut self, input: std::option::Option<std::vec::Vec<crate::model::ProviderDescription>>) -> Self {
...
pub struct ListGroupsOutput  {
    ...
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::GroupType>>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod list_groups_output {
    ...
    impl Builder {
        ...
        /// <p>The group objects for the groups.</p>
        pub fn set_groups(mut self, input: std::option::Option<std::vec::Vec<crate::model::GroupType>>) -> Self {
...
pub struct ListDevicesOutput  {
    ...
    #[doc(hidden)]pub devices: std::option::Option<std::vec::Vec<crate::model::DeviceType>>,
...
pub mod list_devices_output {
    ...
    impl Builder {
        ...
        /// <p>The devices returned in the list devices response.</p>
        pub fn set_devices(mut self, input: std::option::Option<std::vec::Vec<crate::model::DeviceType>>) -> Self {
...
pub struct GetUserOutput  {
    ...
    #[doc(hidden)]pub user_attributes: std::option::Option<std::vec::Vec<crate::model::AttributeType>>,
    ...
    #[doc(hidden)]pub mfa_options: std::option::Option<std::vec::Vec<crate::model::MfaOptionType>>,
    /// <p>The user's preferred MFA setting.</p>
    #[doc(hidden)]pub preferred_mfa_setting: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub user_mfa_setting_list: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl GetUserOutput {
    /// <p>The user name of the user you want to retrieve from the get user request.</p>
...
pub struct GetDeviceOutput  {
    /// <p>The device.</p>
    #[doc(hidden)]pub device: std::option::Option<crate::model::DeviceType>,
}
...
pub struct GetCsvHeaderOutput  {
    ...
    #[doc(hidden)]pub csv_header: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct DescribeUserPoolDomainOutput  {
    ...
    #[doc(hidden)]pub domain_description: std::option::Option<crate::model::DomainDescriptionType>,
}
...
pub mod describe_user_pool_domain_output {
    ...
    impl Builder {
        ...
        /// <p>A domain description object containing information about the domain.</p>
        pub fn set_domain_description(mut self, input: std::option::Option<crate::model::DomainDescriptionType>) -> Self {
...
pub struct DescribeUserPoolOutput  {
    ...
    #[doc(hidden)]pub user_pool: std::option::Option<crate::model::UserPoolType>,
}
...
pub mod describe_user_pool_output {
    ...
    impl Builder {
        ...
        /// <p>The container of metadata returned by the server to describe the pool.</p>
        pub fn set_user_pool(mut self, input: std::option::Option<crate::model::UserPoolType>) -> Self {
...
pub struct ConfirmDeviceOutput  {
    ...
    #[doc(hidden)]pub user_confirmation_necessary: bool,
}
...
impl  std::fmt::Debug for ConfirmDeviceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("user_confirmation_necessary", &self.user_confirmation_necessary);
        formatter.finish()
    }
}
...
pub struct AssociateSoftwareTokenOutput  {
    ...
    #[doc(hidden)]pub secret_code: std::option::Option<std::string::String>,
...
pub struct AdminListUserAuthEventsOutput  {
    ...
    #[doc(hidden)]pub auth_events: std::option::Option<std::vec::Vec<crate::model::AuthEventType>>,
    /// <p>A pagination token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod admin_list_user_auth_events_output {
    ...
    impl Builder {
        ...
        /// <p>The response object. It includes the <code>EventID</code>, <code>EventType</code>, <code>CreationDate</code>, <code>EventRisk</code>, and <code>EventResponse</code>.</p>
        pub fn set_auth_events(mut self, input: std::option::Option<std::vec::Vec<crate::model::AuthEventType>>) -> Self {
...
pub struct AdminGetUserOutput  {
    ...
    #[doc(hidden)]pub user_create_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date the user was last modified.</p>
    #[doc(hidden)]pub user_last_modified_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// </ul>
    #[doc(hidden)]pub user_status: std::option::Option<crate::model::UserStatusType>,
    /// <p> <i>This response parameter is no longer supported.</i> It provides information only about SMS MFA configurations. It doesn't provide information about time-based one-time password (TOTP) software token MFA configurations. To look up information about either type of MFA configuration, use UserMFASettingList instead.</p>
    #[doc(hidden)]pub mfa_options: std::option::Option<std::vec::Vec<crate::model::MfaOptionType>>,
    /// <p>The user's preferred MFA setting.</p>
    #[doc(hidden)]pub preferred_mfa_setting: std::option::Option<std::string::String>,
...
pub mod admin_get_user_output {
    ...
    impl Builder {
        ...
        /// <li> <p>FORCE_CHANGE_PASSWORD - The user is confirmed and the user can sign in using a temporary password, but on first sign-in, the user must change their password to a new value before doing anything else. </p> </li> 
        /// </ul>
        pub fn set_user_status(mut self, input: std::option::Option<crate::model::UserStatusType>) -> Self {
...
pub struct AdminCreateUserOutput  {
    ...
    #[doc(hidden)]pub user: std::option::Option<crate::model::UserType>,
}
