...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::admin_get_user::AdminGetUserError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::get_csv_header::GetCSVHeaderError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::revoke_token::RevokeTokenError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::sign_up::SignUpError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
