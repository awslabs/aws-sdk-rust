...
pub fn ser_admin_update_user_attributes_input(input: &crate::input::AdminUpdateUserAttributesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_admin_update_user_attributes_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AdminUpdateUserAttributesOutput, crate::error::AdminUpdateUserAttributesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AdminUpdateUserAttributesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_admin_update_user_attributes_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AdminUpdateUserAttributesOutput, crate::error::AdminUpdateUserAttributesError> {
    Ok({
        #[allow(unused_mut)]
