...
pub fn de_associate_software_token_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::associate_software_token::AssociateSoftwareTokenOutput, crate::operation::associate_software_token::AssociateSoftwareTokenError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::associate_software_token::AssociateSoftwareTokenError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "ConcurrentModificationException" => crate::operation::associate_software_token::AssociateSoftwareTokenError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "SoftwareTokenMFANotFoundException" => crate::operation::associate_software_token::AssociateSoftwareTokenError::SoftwareTokenMfaNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_software_token_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::associate_software_token::AssociateSoftwareTokenOutput, crate::operation::associate_software_token::AssociateSoftwareTokenError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_associate_software_token_input(input: &crate::operation::associate_software_token::AssociateSoftwareTokenInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_associate_software_token(value: &[u8], mut builder: crate::operation::associate_software_token::builders::AssociateSoftwareTokenOutputBuilder) -> Result<crate::operation::associate_software_token::builders::AssociateSoftwareTokenOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
