...
pub fn ser_admin_list_groups_for_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::admin_list_groups_for_user::AdminListGroupsForUserInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
