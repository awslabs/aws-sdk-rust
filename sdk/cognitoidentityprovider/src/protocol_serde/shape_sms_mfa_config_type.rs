...
pub(crate) fn de_sms_mfa_config_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SmsMfaConfigType>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_sms_mfa_config_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SmsMfaConfigType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
