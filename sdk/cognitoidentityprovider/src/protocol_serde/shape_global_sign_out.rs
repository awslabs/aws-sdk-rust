...
pub fn de_global_sign_out_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::global_sign_out::GlobalSignOutOutput, crate::operation::global_sign_out::GlobalSignOutError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_global_sign_out_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::global_sign_out::GlobalSignOutOutput, crate::operation::global_sign_out::GlobalSignOutError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_global_sign_out_input(input: &crate::operation::global_sign_out::GlobalSignOutInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_global_sign_out_input::ser_global_sign_out_input_input(&mut object, input)?;
    object.finish();
