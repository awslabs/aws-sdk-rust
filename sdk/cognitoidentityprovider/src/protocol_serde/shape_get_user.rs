...
pub fn de_get_user_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_user_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_user::GetUserError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_user::builders::GetUserOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
