...
) -> Result<crate::operation::admin_get_device::builders::AdminGetDeviceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Device" => {
                    builder = builder.set_device(crate::protocol_serde::shape_device_type::de_device_type(tokens)?);
                }
