...
pub fn ser_revoke_token_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RevokeTokenInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
