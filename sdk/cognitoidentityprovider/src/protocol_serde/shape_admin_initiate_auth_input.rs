...
pub fn ser_admin_initiate_auth_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AdminInitiateAuthInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
