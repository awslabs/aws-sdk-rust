...
pub fn ser_confirm_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConfirmDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
