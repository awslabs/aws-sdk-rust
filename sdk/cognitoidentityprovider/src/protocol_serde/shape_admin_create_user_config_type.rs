...
pub fn ser_admin_create_user_config_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AdminCreateUserConfigType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_admin_create_user_config_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AdminCreateUserConfigType>, aws_smithy_json::deserialize::error::DeserializeError>
