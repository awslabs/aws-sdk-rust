                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AllowAdminCreateUserOnly" => {
                            builder =
                                builder.set_allow_admin_create_user_only(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        ...
                        "InviteMessageTemplate" => {
                            builder = builder
                                .set_invite_message_template(crate::protocol_serde::shape_message_template_type::de_message_template_type(tokens)?);
                        }
