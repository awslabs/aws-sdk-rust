...
pub fn ser_create_user_pool_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_user_pool_domain::CreateUserPoolDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
