...
pub fn de_confirm_sign_up_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::confirm_sign_up::ConfirmSignUpOutput, crate::operation::confirm_sign_up::ConfirmSignUpError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::confirm_sign_up::builders::ConfirmSignUpOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
