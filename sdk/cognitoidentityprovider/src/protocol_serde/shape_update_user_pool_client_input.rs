...
pub fn ser_update_user_pool_client_input_input(
    ...
    if let Some(var_4) = &input.refresh_token_validity {
        object.key("RefreshTokenValidity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.access_token_validity {
        object.key("AccessTokenValidity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.id_token_validity {
        object.key("IdTokenValidity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    ...
    if let Some(var_40) = &input.auth_session_validity {
        object.key("AuthSessionValidity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_40).into()));
    }
    Ok(())
}
