...
pub fn ser_update_user_pool_client_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUserPoolClientInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
