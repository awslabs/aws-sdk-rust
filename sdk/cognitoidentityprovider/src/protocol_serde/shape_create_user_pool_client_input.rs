...
pub fn ser_create_user_pool_client_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUserPoolClientInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
