            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Policies" => {
                            builder = builder.set_policies(crate::protocol_serde::shape_user_pool_policy_type::de_user_pool_policy_type(tokens)?);
                        }
                        "DeletionProtection" => {
                            builder = builder.set_deletion_protection(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::DeletionProtectionType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LambdaConfig" => {
                            builder = builder.set_lambda_config(crate::protocol_serde::shape_lambda_config_type::de_lambda_config_type(tokens)?);
                        }
                        "Status" => {
                        ...
                        "UserPoolTags" => {
                            builder = builder.set_user_pool_tags(crate::protocol_serde::shape_user_pool_tags_type::de_user_pool_tags_type(tokens)?);
                        }
                        ...
                        "UserPoolAddOns" => {
                            builder = builder
                                .set_user_pool_add_ons(crate::protocol_serde::shape_user_pool_add_ons_type::de_user_pool_add_ons_type(tokens)?);
                        }
