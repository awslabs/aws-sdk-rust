...
pub fn ser_sign_up_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SignUpInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
