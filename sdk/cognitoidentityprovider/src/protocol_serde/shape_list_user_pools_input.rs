...
pub fn ser_list_user_pools_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListUserPoolsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
