...
pub fn ser_update_auth_event_feedback_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAuthEventFeedbackInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
