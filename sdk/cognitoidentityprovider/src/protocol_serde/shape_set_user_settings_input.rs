...
pub fn ser_set_user_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetUserSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
