...
pub fn ser_admin_set_user_password_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AdminSetUserPasswordInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
