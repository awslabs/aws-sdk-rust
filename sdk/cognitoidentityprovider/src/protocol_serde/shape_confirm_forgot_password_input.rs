...
pub fn ser_confirm_forgot_password_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConfirmForgotPasswordInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
