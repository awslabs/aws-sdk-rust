...
pub fn de_initiate_auth_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::initiate_auth::InitiateAuthOutput, crate::operation::initiate_auth::InitiateAuthError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_initiate_auth_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::initiate_auth::InitiateAuthOutput, crate::operation::initiate_auth::InitiateAuthError> {
...
) -> Result<crate::operation::initiate_auth::builders::InitiateAuthOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
