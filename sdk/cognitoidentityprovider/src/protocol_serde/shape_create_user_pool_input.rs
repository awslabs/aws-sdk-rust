...
pub fn ser_create_user_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUserPoolInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
