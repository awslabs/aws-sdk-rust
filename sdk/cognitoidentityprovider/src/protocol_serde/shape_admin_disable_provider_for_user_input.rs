...
pub fn ser_admin_disable_provider_for_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AdminDisableProviderForUserInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
