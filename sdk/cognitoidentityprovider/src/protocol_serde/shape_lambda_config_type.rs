...
pub fn ser_lambda_config_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaConfigType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_lambda_config_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LambdaConfigType>, aws_smithy_json::deserialize::error::DeserializeError>
