...
pub fn ser_resend_confirmation_code_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ResendConfirmationCodeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
