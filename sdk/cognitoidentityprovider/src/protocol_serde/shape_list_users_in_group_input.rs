...
pub fn ser_list_users_in_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListUsersInGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
