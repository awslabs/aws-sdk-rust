...
pub fn ser_context_data_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContextDataType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
