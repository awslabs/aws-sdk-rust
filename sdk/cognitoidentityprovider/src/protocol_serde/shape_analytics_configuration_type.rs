...
pub fn ser_analytics_configuration_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnalyticsConfigurationType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_analytics_configuration_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AnalyticsConfigurationType>, aws_smithy_json::deserialize::error::DeserializeError>
