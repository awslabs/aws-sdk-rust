...
pub fn ser_schema_attribute_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SchemaAttributeType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_schema_attribute_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SchemaAttributeType>, aws_smithy_json::deserialize::error::DeserializeError>
