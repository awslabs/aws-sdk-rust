...
pub fn ser_confirm_sign_up_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConfirmSignUpInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
