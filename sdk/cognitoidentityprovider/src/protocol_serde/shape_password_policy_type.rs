...
pub fn ser_password_policy_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PasswordPolicyType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_password_policy_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PasswordPolicyType>, aws_smithy_json::deserialize::error::DeserializeError>
