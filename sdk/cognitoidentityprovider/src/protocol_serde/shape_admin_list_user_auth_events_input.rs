...
pub fn ser_admin_list_user_auth_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AdminListUserAuthEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
