                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CallbackURLs" => {
                                builder = builder.set_callback_urls(
                                    crate::protocol_serde::shape_callback_urls_list_type::de_callback_urls_list_type(tokens)?
                                );
                            }
                            "LogoutURLs" => {
                                builder = builder.set_logout_urls(
                                    crate::protocol_serde::shape_logout_urls_list_type::de_logout_urls_list_type(tokens)?
                                );
                            }
                            "DefaultRedirectURI" => {
