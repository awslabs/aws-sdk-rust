...
pub(crate) fn de_user_pool_client_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UserPoolClientType>, aws_smithy_json::deserialize::error::DeserializeError>
