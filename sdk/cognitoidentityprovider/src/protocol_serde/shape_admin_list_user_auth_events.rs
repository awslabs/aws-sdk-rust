...
pub fn de_admin_list_user_auth_events_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_admin_list_user_auth_events_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_admin_list_user_auth_events_input(input: &crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
