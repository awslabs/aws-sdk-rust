...
pub fn de_admin_list_devices_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::admin_list_devices::AdminListDevicesOutput, crate::operation::admin_list_devices::AdminListDevicesError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::admin_list_devices::builders::AdminListDevicesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Devices" => {
                    builder = builder.set_devices(crate::protocol_serde::shape_device_list_type::de_device_list_type(tokens)?);
                }
                "PaginationToken" => {
