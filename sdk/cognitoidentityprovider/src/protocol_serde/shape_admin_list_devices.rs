...
pub fn de_admin_list_devices_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::admin_list_devices::AdminListDevicesOutput, crate::operation::admin_list_devices::AdminListDevicesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::admin_list_devices::AdminListDevicesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_admin_list_devices_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::admin_list_devices::AdminListDevicesOutput, crate::operation::admin_list_devices::AdminListDevicesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::admin_list_devices::builders::AdminListDevicesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_admin_list_devices::de_admin_list_devices(response.body().as_ref(), output).map_err(crate::operation::admin_list_devices::AdminListDevicesError::unhandled)?;
