...
pub fn ser_respond_to_auth_challenge_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RespondToAuthChallengeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
