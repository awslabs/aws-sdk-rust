...
pub fn ser_admin_update_user_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AdminUpdateUserAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
