...
pub fn ser_admin_set_user_mfa_preference_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
