...
pub fn ser_admin_add_user_to_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AdminAddUserToGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
