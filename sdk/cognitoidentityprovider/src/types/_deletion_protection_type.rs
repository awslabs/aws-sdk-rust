...
impl ::std::convert::From<&str> for DeletionProtectionType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DeletionProtectionType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeletionProtectionType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeletionProtectionType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DeletionProtectionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
