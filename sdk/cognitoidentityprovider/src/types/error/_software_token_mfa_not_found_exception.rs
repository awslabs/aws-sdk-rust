...
impl std::fmt::Display for SoftwareTokenMfaNotFoundException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "SoftwareTokenMfaNotFoundException [SoftwareTokenMFANotFoundException]")?;
...
impl aws_http::request_id::RequestId for crate::types::error::SoftwareTokenMfaNotFoundException {
