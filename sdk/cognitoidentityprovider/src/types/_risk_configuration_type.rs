...
/// <p>The settings of risk configuration for threat protection with advanced security features in a user pool.</p>
...
pub struct RiskConfigurationType {
    ...
    /// <p>Settings for compromised-credentials actions and authentication types with advanced security features in full-function <code>ENFORCED</code> mode.</p>
