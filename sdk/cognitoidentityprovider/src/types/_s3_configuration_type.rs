...
/// <p>Configuration for the Amazon S3 bucket destination of user activity log export with advanced security features.</p>
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::fmt::Debug)]
pub struct S3ConfigurationType {
    /// <p>The ARN of an Amazon S3 bucket that's the destination for advanced security features log export.</p>
