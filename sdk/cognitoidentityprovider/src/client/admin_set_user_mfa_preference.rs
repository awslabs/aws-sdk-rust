...
impl super::Client {
    ...
    ///   - [`username(impl ::std::convert::Into<String>)`](crate::operation::admin_set_user_mfa_preference::builders::AdminSetUserMFAPreferenceFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_set_user_mfa_preference::builders::AdminSetUserMFAPreferenceFluentBuilder::set_username): <p>The user pool username or alias.</p>
