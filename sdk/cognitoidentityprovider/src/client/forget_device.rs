...
impl super::Client {
    ...
    ///   - [`access_token(impl ::std::convert::Into<String>)`](crate::operation::forget_device::builders::ForgetDeviceFluentBuilder::access_token) / [`set_access_token(Option<String>)`](crate::operation::forget_device::builders::ForgetDeviceFluentBuilder::set_access_token): <p>A valid access token that Amazon Cognito issued to the user whose registered device you want to forget.</p>
    ///   - [`device_key(impl ::std::convert::Into<String>)`](crate::operation::forget_device::builders::ForgetDeviceFluentBuilder::device_key) / [`set_device_key(Option<String>)`](crate::operation::forget_device::builders::ForgetDeviceFluentBuilder::set_device_key): <p>The device key.</p>
