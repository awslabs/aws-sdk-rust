...
impl super::Client {
    ...
    ///   - [`username(String)`](crate::operation::get_user_auth_factors::GetUserAuthFactorsOutput::username): <p>The username of the currently sign-in user.</p>
    ///   - [`preferred_mfa_setting(Option<String>)`](crate::operation::get_user_auth_factors::GetUserAuthFactorsOutput::preferred_mfa_setting): <p>The user's preferred MFA setting.</p>
    ...
    ///   - [`configured_user_auth_factors(Option<Vec::<AuthFactorType>>)`](crate::operation::get_user_auth_factors::GetUserAuthFactorsOutput::configured_user_auth_factors): <p>The authentication types that are available to the user with <code>USER_AUTH</code> sign-in.</p>
