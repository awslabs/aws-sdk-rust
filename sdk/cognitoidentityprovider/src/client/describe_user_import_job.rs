...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder::set_user_pool_id): <p>The user pool ID for the user pool that the users are being imported into.</p>
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_user_import_job::builders::DescribeUserImportJobFluentBuilder::set_job_id): <p>The job ID for the user import job.</p>
