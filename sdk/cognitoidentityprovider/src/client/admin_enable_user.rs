...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::admin_enable_user::builders::AdminEnableUserFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::admin_enable_user::builders::AdminEnableUserFluentBuilder::set_user_pool_id): <p>The user pool ID for the user pool where you want to enable the user.</p>
