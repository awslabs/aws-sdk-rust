...
impl super::Client {
    ...
    ///   - [`pagination_token(impl ::std::convert::Into<String>)`](crate::operation::list_devices::builders::ListDevicesFluentBuilder::pagination_token) / [`set_pagination_token(Option<String>)`](crate::operation::list_devices::builders::ListDevicesFluentBuilder::set_pagination_token): <p>The pagination token for the list request.</p>
