...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::set_user_pool_id): <p>The user pool ID for the user pool.</p>
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::set_identifier): <p>The identifier for the resource server.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_resource_server::builders::UpdateResourceServerFluentBuilder::set_name): <p>The name of the resource server.</p>
