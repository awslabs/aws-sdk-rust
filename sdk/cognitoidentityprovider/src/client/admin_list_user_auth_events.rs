...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::admin_list_user_auth_events::builders::AdminListUserAuthEventsFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_list_user_auth_events::builders::AdminListUserAuthEventsFluentBuilder::set_username):<br>required: **true**<br><p>The user pool username or an alias.</p><br>
