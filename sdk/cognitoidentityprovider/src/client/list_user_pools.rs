...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_user_pools::builders::ListUserPoolsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_user_pools::builders::ListUserPoolsFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    ///   - [`max_results(i32)`](crate::operation::list_user_pools::builders::ListUserPoolsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_user_pools::builders::ListUserPoolsFluentBuilder::set_max_results): <p>The maximum number of results you want the request to return when listing the user pools.</p>
    ...
    pub fn list_user_pools(
        &self,
    ) -> crate::operation::list_user_pools::builders::ListUserPoolsFluentBuilder {
        crate::operation::list_user_pools::builders::ListUserPoolsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
