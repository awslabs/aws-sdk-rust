...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_delete_user_attributes::builders::AdminDeleteUserAttributesFluentBuilder::set_username):<br>required: **true**<br><p>The user name of the user from which you would like to delete attributes.</p><br>
