...
impl super::Client {
    ...
    ///   - [`domain(impl Into<String>)`](crate::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::delete_user_pool_domain::builders::DeleteUserPoolDomainFluentBuilder::set_domain):<br>required: **true**<br><p>The domain that you want to delete. For custom domains, this is the fully-qualified domain name, such as <code>auth.example.com</code>. For Amazon Cognito prefix domains, this is the prefix alone, such as <code>auth</code>.</p><br>
