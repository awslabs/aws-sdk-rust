...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::set_user_pool_id): <p>The user pool ID. </p>
    ///   - [`client_id(impl ::std::convert::Into<String>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::client_id) / [`set_client_id(Option<String>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::set_client_id): <p>The app client ID. If <code>ClientId</code> is null, then the risk configuration is mapped to <code>userPoolId</code>. When the client ID is null, the same risk configuration is applied to all the clients in the userPool.</p>  <p>Otherwise, <code>ClientId</code> is mapped to the client. When the client ID isn't null, the user pool configuration is overridden and the risk configuration for the client is used instead.</p>
    ...
    ///   - [`risk_exception_configuration(RiskExceptionConfigurationType)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::risk_exception_configuration) / [`set_risk_exception_configuration(Option<RiskExceptionConfigurationType>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::set_risk_exception_configuration): <p>The configuration to override the risk decision.</p>
