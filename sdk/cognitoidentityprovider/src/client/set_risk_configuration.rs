...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::set_risk_configuration::builders::SetRiskConfigurationFluentBuilder::set_user_pool_id): <p>The user pool ID. </p>
