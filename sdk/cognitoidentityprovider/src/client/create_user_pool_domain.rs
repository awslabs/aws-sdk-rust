...
impl super::Client {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::create_user_pool_domain::builders::CreateUserPoolDomainFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::create_user_pool_domain::builders::CreateUserPoolDomainFluentBuilder::set_domain): <p>The domain string. For custom domains, this is the fully-qualified domain name, such as <code>auth.example.com</code>. For Amazon Cognito prefix domains, this is the prefix alone, such as <code>auth</code>.</p>
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::create_user_pool_domain::builders::CreateUserPoolDomainFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::create_user_pool_domain::builders::CreateUserPoolDomainFluentBuilder::set_user_pool_id): <p>The user pool ID.</p>
