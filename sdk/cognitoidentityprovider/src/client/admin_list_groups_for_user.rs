...
impl super::Client {
    ...
    ///   - [`username(impl Into<String>)`](crate::operation::admin_list_groups_for_user::builders::AdminListGroupsForUserFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_list_groups_for_user::builders::AdminListGroupsForUserFluentBuilder::set_username):<br>required: **true**<br><p>The username for the user.</p><br>
