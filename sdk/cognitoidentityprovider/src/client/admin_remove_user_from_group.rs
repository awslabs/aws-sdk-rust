...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupFluentBuilder::set_user_pool_id): <p>The user pool ID for the user pool.</p>
    ///   - [`username(impl ::std::convert::Into<String>)`](crate::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::admin_remove_user_from_group::builders::AdminRemoveUserFromGroupFluentBuilder::set_username): <p>The username for the user.</p>
