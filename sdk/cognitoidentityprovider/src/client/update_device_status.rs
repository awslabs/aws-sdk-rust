...
impl super::Client {
    ...
    ///   - [`access_token(impl ::std::convert::Into<String>)`](crate::operation::update_device_status::builders::UpdateDeviceStatusFluentBuilder::access_token) / [`set_access_token(Option<String>)`](crate::operation::update_device_status::builders::UpdateDeviceStatusFluentBuilder::set_access_token): <p>A valid access token that Amazon Cognito issued to the user whose device status you want to update.</p>
    ///   - [`device_key(impl ::std::convert::Into<String>)`](crate::operation::update_device_status::builders::UpdateDeviceStatusFluentBuilder::device_key) / [`set_device_key(Option<String>)`](crate::operation::update_device_status::builders::UpdateDeviceStatusFluentBuilder::set_device_key): <p>The device key.</p>
