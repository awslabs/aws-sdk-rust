...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationFluentBuilder::set_user_pool_id): <p>The ID of the user pool where you want to configure detailed activity logging .</p>
    ///   - [`log_configurations(LogConfigurationType)`](crate::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationFluentBuilder::log_configurations) / [`set_log_configurations(Option<Vec<LogConfigurationType>>)`](crate::operation::set_log_delivery_configuration::builders::SetLogDeliveryConfigurationFluentBuilder::set_log_configurations): <p>A collection of all of the detailed activity logging configurations for a user pool.</p>
