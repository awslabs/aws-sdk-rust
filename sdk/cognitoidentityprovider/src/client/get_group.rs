...
impl super::Client {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::set_group_name): <p>The name of the group.</p>
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::set_user_pool_id): <p>The user pool ID for the user pool.</p>
