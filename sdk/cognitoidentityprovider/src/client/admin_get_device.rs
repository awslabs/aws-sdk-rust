...
impl super::Client {
    ...
    ///   - [`device_key(impl Into<String>)`](crate::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::device_key) / [`set_device_key(Option<String>)`](crate::operation::admin_get_device::builders::AdminGetDeviceFluentBuilder::set_device_key):<br>required: **true**<br><p>The key of the device that you want to delete. You can get device IDs in the response to an <a href="https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_AdminListDevices.html">AdminListDevices</a> request.</p><br>
