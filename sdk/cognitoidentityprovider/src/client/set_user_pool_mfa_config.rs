...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl Into<String>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::set_user_pool_id): <p>The user pool ID.</p>
