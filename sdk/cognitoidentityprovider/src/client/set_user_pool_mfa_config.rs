...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::set_user_pool_id): <p>The user pool ID.</p>
    ///   - [`sms_mfa_configuration(SmsMfaConfigType)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::sms_mfa_configuration) / [`set_sms_mfa_configuration(Option<SmsMfaConfigType>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::set_sms_mfa_configuration): <p>The SMS text message MFA configuration.</p>
    ///   - [`software_token_mfa_configuration(SoftwareTokenMfaConfigType)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::software_token_mfa_configuration) / [`set_software_token_mfa_configuration(Option<SoftwareTokenMfaConfigType>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::set_software_token_mfa_configuration): <p>The software token MFA configuration.</p>
    ///   - [`mfa_configuration(UserPoolMfaType)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::mfa_configuration) / [`set_mfa_configuration(Option<UserPoolMfaType>)`](crate::operation::set_user_pool_mfa_config::builders::SetUserPoolMfaConfigFluentBuilder::set_mfa_configuration): <p>The MFA configuration. If you set the MfaConfiguration value to ‘ON’, only users who have set up an MFA factor can sign in. To learn more, see <a href="https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-mfa.html">Adding Multi-Factor Authentication (MFA) to a user pool</a>. Valid values include:</p>  <ul>   <li> <p> <code>OFF</code> MFA won't be used for any users.</p> </li>   <li> <p> <code>ON</code> MFA is required for all users to sign in.</p> </li>   <li> <p> <code>OPTIONAL</code> MFA will be required only for individual users who have an MFA factor activated.</p> </li>  </ul>
