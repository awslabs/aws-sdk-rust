...
impl super::Client {
    ...
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::describe_user_pool_client::builders::DescribeUserPoolClientFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::describe_user_pool_client::builders::DescribeUserPoolClientFluentBuilder::set_user_pool_id): <p>The user pool ID for the user pool you want to describe.</p>
    ///   - [`client_id(impl ::std::convert::Into<String>)`](crate::operation::describe_user_pool_client::builders::DescribeUserPoolClientFluentBuilder::client_id) / [`set_client_id(Option<String>)`](crate::operation::describe_user_pool_client::builders::DescribeUserPoolClientFluentBuilder::set_client_id): <p>The app client ID of the app associated with the user pool.</p>
