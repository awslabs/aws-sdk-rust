...
impl StartUserImportJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_user_import_job::StartUserImportJob::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("StartUserImportJob", "cognitoidentityprovider"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartUserImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_user_import_job::de_start_user_import_job_http_response_with_props(status, headers, body)
        }
    }
}
