...
impl StartUserImportJobInput {
    /// Consumes the builder and constructs an Operation<[`StartUserImportJob`](crate::operation::start_user_import_job::StartUserImportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_user_import_job::StartUserImportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_user_import_job::StartUserImportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_user_import_job::ser_start_user_import_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_user_import_job::StartUserImportJob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartUserImportJob", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartUserImportJob {
                type Output = std::result::Result<crate::operation::start_user_import_job::StartUserImportJobOutput, crate::operation::start_user_import_job::StartUserImportJobError>;
