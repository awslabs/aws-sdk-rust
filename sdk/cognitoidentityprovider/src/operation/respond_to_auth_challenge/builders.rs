...
impl RespondToAuthChallengeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::respond_to_auth_challenge::RespondToAuthChallengeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::respond_to_auth_challenge::RespondToAuthChallengeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::respond_to_auth_challenge::RespondToAuthChallengeOutput, crate::operation::respond_to_auth_challenge::RespondToAuthChallengeError, Self> {
