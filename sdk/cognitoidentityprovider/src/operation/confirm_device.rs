...
impl ConfirmDeviceInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmDevice`](crate::operation::confirm_device::ConfirmDevice)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::confirm_device::ConfirmDevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_confirm_device::ser_confirm_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_confirm_device::de_confirm_device_http_response_with_props(status, headers, body)
        }
    }
}
