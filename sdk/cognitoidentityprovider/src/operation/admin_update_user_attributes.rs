...
impl AdminUpdateUserAttributesInput {
    /// Consumes the builder and constructs an Operation<[`AdminUpdateUserAttributes`](crate::operation::admin_update_user_attributes::AdminUpdateUserAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_update_user_attributes::AdminUpdateUserAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_update_user_attributes::AdminUpdateUserAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_update_user_attributes::ser_admin_update_user_attributes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_update_user_attributes::AdminUpdateUserAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminUpdateUserAttributes", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminUpdateUserAttributes {
                type Output = std::result::Result<crate::operation::admin_update_user_attributes::AdminUpdateUserAttributesOutput, crate::operation::admin_update_user_attributes::AdminUpdateUserAttributesError>;
