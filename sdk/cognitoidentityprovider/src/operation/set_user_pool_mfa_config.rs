...
/// Orchestration and serialization glue logic for `SetUserPoolMfaConfig`.
...
impl SetUserPoolMfaConfig {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigInput,
                    ) -> ::std::result::Result<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetUserPoolMfaConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetUserPoolMfaConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetUserPoolMfaConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetUserPoolMfaConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetUserPoolMfaConfig")
...
.with_interceptor(SetUserPoolMfaConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_user_pool_mfa_config::de_set_user_pool_mfa_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_user_pool_mfa_config::de_set_user_pool_mfa_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetUserPoolMfaConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetUserPoolMfaConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_user_pool_mfa_config::ser_set_user_pool_mfa_config_input(&input)?);
...
#[derive(Debug)]
            struct SetUserPoolMfaConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetUserPoolMfaConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetUserPoolMfaConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetUserPoolMfaConfigInput>()
                        .ok_or("failed to downcast to SetUserPoolMfaConfigInput")?;
...
pub enum SetUserPoolMfaConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetUserPoolMfaConfigError) for what information is available for the error.")]
...
impl SetUserPoolMfaConfigError {
    /// Creates the `SetUserPoolMfaConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetUserPoolMfaConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `SetUserPoolMfaConfigError::ConcurrentModificationException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetUserPoolMfaConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError {
...
mod _set_user_pool_mfa_config_output;
