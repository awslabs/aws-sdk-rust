...
impl SetUserPoolMfaConfigInput {
    /// Consumes the builder and constructs an Operation<[`SetUserPoolMfaConfig`](crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_user_pool_mfa_config::ser_set_user_pool_mfa_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetUserPoolMfaConfig", "cognitoidentityprovider"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SetUserPoolMfaConfig`.
...
impl aws_smithy_http::response::ParseStrictResponse for SetUserPoolMfaConfig {
                type Output = std::result::Result<crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigOutput, crate::operation::set_user_pool_mfa_config::SetUserPoolMfaConfigError>;
