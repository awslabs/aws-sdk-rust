...
impl AdminAddUserToGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::admin_add_user_to_group::AdminAddUserToGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminAddUserToGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_add_user_to_group::de_admin_add_user_to_group_http_response_with_props(status, headers, body)
        }
    }
}
