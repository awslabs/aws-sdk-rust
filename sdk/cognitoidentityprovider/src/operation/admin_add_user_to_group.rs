...
impl AdminAddUserToGroupInput {
    /// Consumes the builder and constructs an Operation<[`AdminAddUserToGroup`](crate::operation::admin_add_user_to_group::AdminAddUserToGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_add_user_to_group::AdminAddUserToGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_add_user_to_group::AdminAddUserToGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_add_user_to_group::ser_admin_add_user_to_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_add_user_to_group::AdminAddUserToGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminAddUserToGroup", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminAddUserToGroup {
                type Output = std::result::Result<crate::operation::admin_add_user_to_group::AdminAddUserToGroupOutput, crate::operation::admin_add_user_to_group::AdminAddUserToGroupError>;
