...
impl RevokeTokenInput {
    /// Consumes the builder and constructs an Operation<[`RevokeToken`](crate::operation::revoke_token::RevokeToken)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::revoke_token::RevokeToken, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_revoke_token::ser_revoke_token_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_token::RevokeToken::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RevokeToken", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeToken {
    type Output = ::std::result::Result<crate::operation::revoke_token::RevokeTokenOutput, crate::operation::revoke_token::RevokeTokenError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_token::de_revoke_token_http_response_with_props(status, headers, body)
        }
    }
}
