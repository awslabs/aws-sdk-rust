...
impl RevokeTokenInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::revoke_token::RevokeToken::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_revoke_token::de_revoke_token_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_revoke_token::de_revoke_token_http_response_with_props(
                status, headers, body,
            )
        }
    }
