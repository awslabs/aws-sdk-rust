...
impl InitiateAuthInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::initiate_auth::InitiateAuth, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_initiate_auth::ser_initiate_auth_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for InitiateAuth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_initiate_auth::de_initiate_auth_http_response_with_props(status, headers, body)
        }
    }
