...
impl InitiateAuthInput {
    /// Consumes the builder and constructs an Operation<[`InitiateAuth`](crate::operation::initiate_auth::InitiateAuth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::initiate_auth::InitiateAuth, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::initiate_auth::InitiateAuthInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_initiate_auth::ser_initiate_auth_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::initiate_auth::InitiateAuth::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("InitiateAuth", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for InitiateAuth {
                type Output = std::result::Result<crate::operation::initiate_auth::InitiateAuthOutput, crate::operation::initiate_auth::InitiateAuthError>;
