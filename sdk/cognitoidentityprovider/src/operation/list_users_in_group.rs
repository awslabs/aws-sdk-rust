...
impl ListUsersInGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_users_in_group::ser_list_users_in_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUsersInGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_users_in_group::de_list_users_in_group_http_response_with_props(status, headers, body)
        }
    }
