...
impl ListUsersInGroupInput {
    /// Consumes the builder and constructs an Operation<[`ListUsersInGroup`](crate::operation::list_users_in_group::ListUsersInGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_users_in_group::ListUsersInGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_users_in_group::ListUsersInGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_users_in_group::ser_list_users_in_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_users_in_group::ListUsersInGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListUsersInGroup", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListUsersInGroup {
                type Output = std::result::Result<crate::operation::list_users_in_group::ListUsersInGroupOutput, crate::operation::list_users_in_group::ListUsersInGroupError>;
