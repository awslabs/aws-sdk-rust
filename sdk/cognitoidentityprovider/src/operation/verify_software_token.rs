...
impl VerifySoftwareTokenInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::verify_software_token::VerifySoftwareToken::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("VerifySoftwareToken", "cognitoidentityprovider"),
            );
