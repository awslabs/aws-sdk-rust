...
impl AdminUpdateAuthEventFeedback {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackInput,
                    ) -> ::std::result::Result<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminUpdateAuthEventFeedback {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AdminUpdateAuthEventFeedback");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AdminUpdateAuthEventFeedbackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AdminUpdateAuthEventFeedbackResponseDeserializer));
...
.with_interceptor(AdminUpdateAuthEventFeedbackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError>::new());
...
#[derive(Debug)]
            struct AdminUpdateAuthEventFeedbackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminUpdateAuthEventFeedbackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_admin_update_auth_event_feedback::de_admin_update_auth_event_feedback_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_admin_update_auth_event_feedback::de_admin_update_auth_event_feedback_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AdminUpdateAuthEventFeedbackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminUpdateAuthEventFeedbackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_admin_update_auth_event_feedback::ser_admin_update_auth_event_feedback_input(&input)?);
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminUpdateAuthEventFeedbackEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AdminUpdateAuthEventFeedbackInput>()
                        .ok_or("failed to downcast to AdminUpdateAuthEventFeedbackInput")?;
...
pub enum AdminUpdateAuthEventFeedbackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AdminUpdateAuthEventFeedbackError) for what information is available for the error.")]
...
impl AdminUpdateAuthEventFeedbackError {
    /// Creates the `AdminUpdateAuthEventFeedbackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AdminUpdateAuthEventFeedbackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AdminUpdateAuthEventFeedbackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::admin_update_auth_event_feedback::_admin_update_auth_event_feedback_output::AdminUpdateAuthEventFeedbackOutput;

pub use crate::operation::admin_update_auth_event_feedback::_admin_update_auth_event_feedback_input::AdminUpdateAuthEventFeedbackInput;

mod _admin_update_auth_event_feedback_input;

mod _admin_update_auth_event_feedback_output;
