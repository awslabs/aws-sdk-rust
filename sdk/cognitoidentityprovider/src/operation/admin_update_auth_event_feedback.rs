...
impl AdminUpdateAuthEventFeedbackInput {
    /// Consumes the builder and constructs an Operation<[`AdminUpdateAuthEventFeedback`](crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_update_auth_event_feedback::ser_admin_update_auth_event_feedback_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminUpdateAuthEventFeedback", "cognitoidentityprovider"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `AdminUpdateAuthEventFeedback`.
...
impl aws_smithy_http::response::ParseStrictResponse for AdminUpdateAuthEventFeedback {
                type Output = std::result::Result<crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackOutput, crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError {
