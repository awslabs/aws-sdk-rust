...
impl AdminUpdateAuthEventFeedbackInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedback::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminUpdateAuthEventFeedback {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_update_auth_event_feedback::de_admin_update_auth_event_feedback_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AdminUpdateAuthEventFeedbackError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::admin_update_auth_event_feedback::AdminUpdateAuthEventFeedbackError
{
