...
impl ForgetDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::forget_device::ForgetDevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_forget_device::ser_forget_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ForgetDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_forget_device::de_forget_device_http_response_with_props(status, headers, body)
        }
    }
}
