...
impl ForgetDeviceInput {
    /// Consumes the builder and constructs an Operation<[`ForgetDevice`](crate::operation::forget_device::ForgetDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::forget_device::ForgetDevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::forget_device::ForgetDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_forget_device::ser_forget_device_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::forget_device::ForgetDevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ForgetDevice", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for ForgetDevice {
                type Output = std::result::Result<crate::operation::forget_device::ForgetDeviceOutput, crate::operation::forget_device::ForgetDeviceError>;
