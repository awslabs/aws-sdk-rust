...
impl CreateUserPoolDomainInput {
    /// Consumes the builder and constructs an Operation<[`CreateUserPoolDomain`](crate::operation::create_user_pool_domain::CreateUserPoolDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_user_pool_domain::CreateUserPoolDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_user_pool_domain::CreateUserPoolDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_user_pool_domain::ser_create_user_pool_domain_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_user_pool_domain::CreateUserPoolDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateUserPoolDomain", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateUserPoolDomain {
                type Output = std::result::Result<crate::operation::create_user_pool_domain::CreateUserPoolDomainOutput, crate::operation::create_user_pool_domain::CreateUserPoolDomainError>;
