...
impl AdminListUserAuthEventsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError, Self> {
