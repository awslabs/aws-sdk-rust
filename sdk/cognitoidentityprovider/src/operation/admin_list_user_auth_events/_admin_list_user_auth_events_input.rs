...
impl AdminListUserAuthEventsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput, ::aws_smithy_types::error::operation::BuildError> {
