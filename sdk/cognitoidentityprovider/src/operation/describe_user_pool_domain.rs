...
/// Orchestration and serialization glue logic for `DescribeUserPoolDomain`.
...
impl DescribeUserPoolDomain {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeUserPoolDomain {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeUserPoolDomain");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeUserPoolDomainRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeUserPoolDomainResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeUserPoolDomain")
...
.with_interceptor(DescribeUserPoolDomainEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError>::new());
...
#[derive(Debug)]
            struct DescribeUserPoolDomainResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeUserPoolDomainResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_user_pool_domain::de_describe_user_pool_domain_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeUserPoolDomainRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeUserPoolDomainRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_user_pool_domain::DescribeUserPoolDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_user_pool_domain::ser_describe_user_pool_domain_input(&input)?);
...
#[derive(Debug)]
            struct DescribeUserPoolDomainEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeUserPoolDomainEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeUserPoolDomainEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeUserPoolDomainInput>()
                        .ok_or("failed to downcast to DescribeUserPoolDomainInput")?;
...
pub enum DescribeUserPoolDomainError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeUserPoolDomainError) for what information is available for the error.")]
...
impl DescribeUserPoolDomainError {
    /// Creates the `DescribeUserPoolDomainError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeUserPoolDomainError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeUserPoolDomainError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_user_pool_domain::_describe_user_pool_domain_output::DescribeUserPoolDomainOutput;

pub use crate::operation::describe_user_pool_domain::_describe_user_pool_domain_input::DescribeUserPoolDomainInput;

mod _describe_user_pool_domain_input;

mod _describe_user_pool_domain_output;
