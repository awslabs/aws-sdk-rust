...
impl DescribeUserPoolDomainInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUserPoolDomain`](crate::operation::describe_user_pool_domain::DescribeUserPoolDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_user_pool_domain::DescribeUserPoolDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_user_pool_domain::DescribeUserPoolDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_user_pool_domain::ser_describe_user_pool_domain_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_user_pool_domain::DescribeUserPoolDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeUserPoolDomain", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeUserPoolDomain {
                type Output = std::result::Result<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainOutput, crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError>;
