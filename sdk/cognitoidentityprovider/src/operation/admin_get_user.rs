...
impl AdminGetUserInput {
    /// Consumes the builder and constructs an Operation<[`AdminGetUser`](crate::operation::admin_get_user::AdminGetUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_get_user::AdminGetUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_get_user::AdminGetUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_get_user::ser_admin_get_user_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_get_user::AdminGetUser::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminGetUser", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminGetUser {
                type Output = std::result::Result<crate::operation::admin_get_user::AdminGetUserOutput, crate::operation::admin_get_user::AdminGetUserError>;
