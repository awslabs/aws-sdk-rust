...
impl DeleteUserPoolClientInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserPoolClient`](crate::operation::delete_user_pool_client::DeleteUserPoolClient)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_user_pool_client::DeleteUserPoolClient, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_pool_client::DeleteUserPoolClientInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_user_pool_client::ser_delete_user_pool_client_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_pool_client::DeleteUserPoolClient::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteUserPoolClient", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUserPoolClient {
                type Output = std::result::Result<crate::operation::delete_user_pool_client::DeleteUserPoolClientOutput, crate::operation::delete_user_pool_client::DeleteUserPoolClientError>;
