...
impl DeleteUserPoolClient {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_user_pool_client::DeleteUserPoolClientInput,
                    ) -> ::std::result::Result<crate::operation::delete_user_pool_client::DeleteUserPoolClientOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_user_pool_client::DeleteUserPoolClientError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_user_pool_client::DeleteUserPoolClientError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_user_pool_client::DeleteUserPoolClientOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteUserPoolClient {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteUserPoolClient");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteUserPoolClientRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteUserPoolClientResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteUserPoolClient")
...
.with_interceptor(DeleteUserPoolClientEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_user_pool_client::DeleteUserPoolClientError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_user_pool_client::DeleteUserPoolClientError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_user_pool_client::DeleteUserPoolClientError>::new());
...
#[derive(Debug)]
            struct DeleteUserPoolClientResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserPoolClientResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_user_pool_client::de_delete_user_pool_client_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_user_pool_client::de_delete_user_pool_client_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteUserPoolClientRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserPoolClientRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_user_pool_client::DeleteUserPoolClientInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_user_pool_client::DeleteUserPoolClientInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_user_pool_client::ser_delete_user_pool_client_input(&input)?);
...
#[derive(Debug)]
            struct DeleteUserPoolClientEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteUserPoolClientEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteUserPoolClientEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteUserPoolClientInput>()
                        .ok_or("failed to downcast to DeleteUserPoolClientInput")?;
...
pub enum DeleteUserPoolClientError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteUserPoolClientError) for what information is available for the error.")]
...
impl DeleteUserPoolClientError {
    /// Creates the `DeleteUserPoolClientError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteUserPoolClientError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteUserPoolClientError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_user_pool_client::DeleteUserPoolClientError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_user_pool_client::_delete_user_pool_client_output::DeleteUserPoolClientOutput;

pub use crate::operation::delete_user_pool_client::_delete_user_pool_client_input::DeleteUserPoolClientInput;

mod _delete_user_pool_client_input;

mod _delete_user_pool_client_output;
