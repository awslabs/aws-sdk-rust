...
impl DeleteUserPoolClientInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_user_pool_client::DeleteUserPoolClient,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserPoolClient {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_user_pool_client::de_delete_user_pool_client_http_response_with_props(status, headers, body)
        }
    }
}
