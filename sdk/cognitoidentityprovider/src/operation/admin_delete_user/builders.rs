...
impl AdminDeleteUserFluentBuilder  {
    /// Creates a new `AdminDeleteUser`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::admin_delete_user::AdminDeleteUserOutput, aws_smithy_http::result::SdkError<crate::operation::admin_delete_user::AdminDeleteUserError>>
                     {
