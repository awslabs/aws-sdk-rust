...
/// Orchestration and serialization glue logic for `AdminListUserAuthEvents`.
...
impl AdminListUserAuthEvents {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput,
                    ) -> ::std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AdminListUserAuthEvents {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AdminListUserAuthEvents");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AdminListUserAuthEventsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AdminListUserAuthEventsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AdminListUserAuthEvents")
...
.with_interceptor(AdminListUserAuthEventsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError>::new());
...
#[derive(Debug)]
            struct AdminListUserAuthEventsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AdminListUserAuthEventsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_admin_list_user_auth_events::de_admin_list_user_auth_events_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AdminListUserAuthEventsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AdminListUserAuthEventsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_admin_list_user_auth_events::ser_admin_list_user_auth_events_input(&input)?);
...
#[derive(Debug)]
            struct AdminListUserAuthEventsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AdminListUserAuthEventsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AdminListUserAuthEventsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AdminListUserAuthEventsInput>()
                        .ok_or("failed to downcast to AdminListUserAuthEventsInput")?;
...
pub enum AdminListUserAuthEventsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AdminListUserAuthEventsError) for what information is available for the error.")]
...
impl AdminListUserAuthEventsError {
    /// Creates the `AdminListUserAuthEventsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AdminListUserAuthEventsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AdminListUserAuthEventsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError {
...
mod _admin_list_user_auth_events_output;
