...
impl AdminListUserAuthEventsInput {
    /// Consumes the builder and constructs an Operation<[`AdminListUserAuthEvents`](crate::operation::admin_list_user_auth_events::AdminListUserAuthEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_list_user_auth_events::AdminListUserAuthEvents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_list_user_auth_events::ser_admin_list_user_auth_events_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_list_user_auth_events::AdminListUserAuthEvents::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminListUserAuthEvents", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminListUserAuthEvents {
                type Output = std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError>;
