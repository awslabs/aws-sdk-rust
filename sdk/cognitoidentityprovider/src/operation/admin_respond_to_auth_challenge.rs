...
impl AdminRespondToAuthChallengeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminRespondToAuthChallenge {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_respond_to_auth_challenge::de_admin_respond_to_auth_challenge_http_response_with_props(
                status, headers, body,
            )
        }
    }
