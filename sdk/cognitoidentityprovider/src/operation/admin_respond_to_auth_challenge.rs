...
impl AdminRespondToAuthChallengeInput {
    /// Consumes the builder and constructs an Operation<[`AdminRespondToAuthChallenge`](crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_respond_to_auth_challenge::ser_admin_respond_to_auth_challenge_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallenge::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminRespondToAuthChallenge", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminRespondToAuthChallenge {
                type Output = std::result::Result<crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeOutput, crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeError {
