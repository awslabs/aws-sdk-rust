...
impl AdminDeleteUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::admin_delete_user::AdminDeleteUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_admin_delete_user::ser_admin_delete_user_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminDeleteUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_delete_user::de_admin_delete_user_http_response_with_props(status, headers, body)
        }
    }
}
