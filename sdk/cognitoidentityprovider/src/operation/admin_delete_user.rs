...
impl AdminDeleteUserInput {
    /// Consumes the builder and constructs an Operation<[`AdminDeleteUser`](crate::operation::admin_delete_user::AdminDeleteUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_delete_user::AdminDeleteUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_delete_user::AdminDeleteUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_delete_user::ser_admin_delete_user_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_delete_user::AdminDeleteUser::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminDeleteUser", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminDeleteUser {
                type Output = std::result::Result<crate::operation::admin_delete_user::AdminDeleteUserOutput, crate::operation::admin_delete_user::AdminDeleteUserError>;
