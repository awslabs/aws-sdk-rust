...
impl AdminDisableProviderForUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminDisableProviderForUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_disable_provider_for_user::de_admin_disable_provider_for_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
