...
impl AdminUpdateUserAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_update_user_attributes::AdminUpdateUserAttributesInput, ::aws_smithy_types::error::operation::BuildError> {
