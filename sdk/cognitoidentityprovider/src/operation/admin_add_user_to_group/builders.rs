...
impl AdminAddUserToGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_add_user_to_group::AdminAddUserToGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_add_user_to_group::AdminAddUserToGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_add_user_to_group::AdminAddUserToGroupOutput, crate::operation::admin_add_user_to_group::AdminAddUserToGroupError, Self> {
