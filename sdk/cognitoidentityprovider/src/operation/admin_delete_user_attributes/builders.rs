...
impl AdminDeleteUserAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput, crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError, Self> {
