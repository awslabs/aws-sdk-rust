...
impl AssociateSoftwareTokenInput {
    /// Consumes the builder and constructs an Operation<[`AssociateSoftwareToken`](crate::operation::associate_software_token::AssociateSoftwareToken)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_software_token::AssociateSoftwareToken, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_software_token::AssociateSoftwareTokenInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_software_token::ser_associate_software_token_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_software_token::AssociateSoftwareToken::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateSoftwareToken", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateSoftwareToken {
                type Output = std::result::Result<crate::operation::associate_software_token::AssociateSoftwareTokenOutput, crate::operation::associate_software_token::AssociateSoftwareTokenError>;
