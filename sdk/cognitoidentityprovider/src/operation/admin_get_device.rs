...
impl AdminGetDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::admin_get_device::AdminGetDevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_admin_get_device::ser_admin_get_device_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminGetDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_get_device::de_admin_get_device_http_response_with_props(status, headers, body)
        }
    }
