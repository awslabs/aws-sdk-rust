...
impl AdminGetDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::admin_get_device::AdminGetDevice,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::admin_get_device::AdminGetDevice::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminGetDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_admin_get_device::de_admin_get_device_http_error(
                status, headers, body,
            )
        } else {
