...
impl AdminGetDeviceInput {
    /// Consumes the builder and constructs an Operation<[`AdminGetDevice`](crate::operation::admin_get_device::AdminGetDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_get_device::AdminGetDevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_get_device::AdminGetDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_get_device::ser_admin_get_device_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_get_device::AdminGetDevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminGetDevice", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminGetDevice {
                type Output = std::result::Result<crate::operation::admin_get_device::AdminGetDeviceOutput, crate::operation::admin_get_device::AdminGetDeviceError>;
