...
impl AdminConfirmSignUpInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_confirm_sign_up::AdminConfirmSignUp::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("AdminConfirmSignUp", "cognitoidentityprovider"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminConfirmSignUp {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_confirm_sign_up::de_admin_confirm_sign_up_http_response_with_props(status, headers, body)
        }
    }
}
