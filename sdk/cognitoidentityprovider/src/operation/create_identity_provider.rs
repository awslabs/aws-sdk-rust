...
impl CreateIdentityProviderInput {
    /// Consumes the builder and constructs an Operation<[`CreateIdentityProvider`](crate::operation::create_identity_provider::CreateIdentityProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_identity_provider::CreateIdentityProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_identity_provider::CreateIdentityProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_identity_provider::CreateIdentityProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateIdentityProvider", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateIdentityProvider {
                type Output = std::result::Result<crate::operation::create_identity_provider::CreateIdentityProviderOutput, crate::operation::create_identity_provider::CreateIdentityProviderError>;
