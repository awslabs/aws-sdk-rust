...
impl DescribeIdentityProviderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_identity_provider::DescribeIdentityProviderInput, ::aws_smithy_types::error::operation::BuildError> {
