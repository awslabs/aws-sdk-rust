...
impl AdminUpdateDeviceStatusInput {
    /// Consumes the builder and constructs an Operation<[`AdminUpdateDeviceStatus`](crate::operation::admin_update_device_status::AdminUpdateDeviceStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_update_device_status::AdminUpdateDeviceStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_update_device_status::AdminUpdateDeviceStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_update_device_status::ser_admin_update_device_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_update_device_status::AdminUpdateDeviceStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminUpdateDeviceStatus", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminUpdateDeviceStatus {
                type Output = std::result::Result<crate::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput, crate::operation::admin_update_device_status::AdminUpdateDeviceStatusError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_update_device_status::AdminUpdateDeviceStatusError {
