...
impl AdminResetUserPasswordInput {
    /// Consumes the builder and constructs an Operation<[`AdminResetUserPassword`](crate::operation::admin_reset_user_password::AdminResetUserPassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_reset_user_password::AdminResetUserPassword, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_reset_user_password::AdminResetUserPasswordInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_reset_user_password::ser_admin_reset_user_password_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_reset_user_password::AdminResetUserPassword::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminResetUserPassword", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminResetUserPassword {
                type Output = std::result::Result<crate::operation::admin_reset_user_password::AdminResetUserPasswordOutput, crate::operation::admin_reset_user_password::AdminResetUserPasswordError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_reset_user_password::AdminResetUserPasswordError {
