...
impl AdminUserGlobalSignOutFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput, crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError, Self> {
