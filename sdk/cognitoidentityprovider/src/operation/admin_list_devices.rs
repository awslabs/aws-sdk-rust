...
impl AdminListDevicesInput {
    /// Consumes the builder and constructs an Operation<[`AdminListDevices`](crate::operation::admin_list_devices::AdminListDevices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_list_devices::AdminListDevices, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_list_devices::AdminListDevicesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_list_devices::ser_admin_list_devices_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_list_devices::AdminListDevices::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminListDevices", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminListDevices {
                type Output = std::result::Result<crate::operation::admin_list_devices::AdminListDevicesOutput, crate::operation::admin_list_devices::AdminListDevicesError>;
