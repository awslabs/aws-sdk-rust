...
impl AdminListDevicesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::admin_list_devices::AdminListDevices,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_admin_list_devices::ser_admin_list_devices_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminListDevices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_list_devices::de_admin_list_devices_http_response_with_props(status, headers, body)
        }
    }
