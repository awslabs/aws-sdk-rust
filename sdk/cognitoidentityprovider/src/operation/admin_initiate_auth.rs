...
impl AdminInitiateAuthInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_admin_initiate_auth::ser_admin_initiate_auth_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_initiate_auth::AdminInitiateAuth::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("AdminInitiateAuth", "cognitoidentityprovider"),
            );
