...
impl DescribeUserPoolClientInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUserPoolClient`](crate::operation::describe_user_pool_client::DescribeUserPoolClient)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_user_pool_client::DescribeUserPoolClient, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_user_pool_client::DescribeUserPoolClientInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_user_pool_client::ser_describe_user_pool_client_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_user_pool_client::DescribeUserPoolClient::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeUserPoolClient", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeUserPoolClient {
                type Output = std::result::Result<crate::operation::describe_user_pool_client::DescribeUserPoolClientOutput, crate::operation::describe_user_pool_client::DescribeUserPoolClientError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_user_pool_client::DescribeUserPoolClientError {
