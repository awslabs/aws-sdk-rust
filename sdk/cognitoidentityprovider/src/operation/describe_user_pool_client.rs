...
impl DescribeUserPoolClientInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_user_pool_client::DescribeUserPoolClient,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUserPoolClient {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_user_pool_client::de_describe_user_pool_client_http_response_with_props(status, headers, body)
        }
    }
