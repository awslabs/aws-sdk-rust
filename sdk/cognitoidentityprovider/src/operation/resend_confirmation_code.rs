...
impl ResendConfirmationCode {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ResendConfirmationCode",
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResendConfirmationCodeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code_http_response(status, headers, body, _cfg)
        };
...
impl ResendConfirmationCodeError {
    ...
    /// Returns `true` if the error kind is `ResendConfirmationCodeError::OperationNotEnabledException`.
