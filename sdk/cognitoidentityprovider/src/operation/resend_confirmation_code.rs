...
impl ResendConfirmationCodeInput {
    /// Consumes the builder and constructs an Operation<[`ResendConfirmationCode`](crate::operation::resend_confirmation_code::ResendConfirmationCode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::resend_confirmation_code::ResendConfirmationCode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resend_confirmation_code::ResendConfirmationCodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resend_confirmation_code::ser_resend_confirmation_code_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::resend_confirmation_code::ResendConfirmationCode::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResendConfirmationCode", "cognitoidentityprovider"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ResendConfirmationCode`.
...
impl aws_smithy_http::response::ParseStrictResponse for ResendConfirmationCode {
                type Output = std::result::Result<crate::operation::resend_confirmation_code::ResendConfirmationCodeOutput, crate::operation::resend_confirmation_code::ResendConfirmationCodeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code_http_error(response)
                     } else {
                        crate::protocol_serde::shape_resend_confirmation_code::de_resend_confirmation_code_http_response(response)
                     }
                }
            }
...
impl aws_http::request_id::RequestId for crate::operation::resend_confirmation_code::ResendConfirmationCodeError {
