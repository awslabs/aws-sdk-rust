...
impl SetUiCustomizationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_ui_customization::ser_set_ui_customization_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_ui_customization::SetUICustomization::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("SetUICustomization", "cognitoidentityprovider"),
            );
