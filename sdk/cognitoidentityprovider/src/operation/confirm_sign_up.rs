...
impl ConfirmSignUpInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::confirm_sign_up::ConfirmSignUp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_confirm_sign_up::ser_confirm_sign_up_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmSignUp {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_confirm_sign_up::de_confirm_sign_up_http_response_with_props(status, headers, body)
        }
    }
}
