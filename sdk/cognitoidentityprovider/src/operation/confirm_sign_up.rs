...
impl ConfirmSignUpInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmSignUp`](crate::operation::confirm_sign_up::ConfirmSignUp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::confirm_sign_up::ConfirmSignUp, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::confirm_sign_up::ConfirmSignUpInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_confirm_sign_up::ser_confirm_sign_up_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::confirm_sign_up::ConfirmSignUp::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ConfirmSignUp", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for ConfirmSignUp {
                type Output = std::result::Result<crate::operation::confirm_sign_up::ConfirmSignUpOutput, crate::operation::confirm_sign_up::ConfirmSignUpError>;
