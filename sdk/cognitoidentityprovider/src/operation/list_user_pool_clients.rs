...
impl ListUserPoolClientsInput {
    /// Consumes the builder and constructs an Operation<[`ListUserPoolClients`](crate::operation::list_user_pool_clients::ListUserPoolClients)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_user_pool_clients::ListUserPoolClients, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_user_pool_clients::ListUserPoolClientsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_user_pool_clients::ser_list_user_pool_clients_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_pool_clients::ListUserPoolClients::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListUserPoolClients", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListUserPoolClients {
                type Output = std::result::Result<crate::operation::list_user_pool_clients::ListUserPoolClientsOutput, crate::operation::list_user_pool_clients::ListUserPoolClientsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_user_pool_clients::de_list_user_pool_clients_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_user_pool_clients::de_list_user_pool_clients_http_response(response)
                     }
                }
            }
