...
impl ListUserPoolClients {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_user_pool_clients::ListUserPoolClientsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_user_pool_clients::ListUserPoolClientsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_user_pool_clients::ListUserPoolClientsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_user_pool_clients::ListUserPoolClientsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListUserPoolClients {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListUserPoolClients");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListUserPoolClientsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListUserPoolClientsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListUserPoolClients")
...
.with_interceptor(ListUserPoolClientsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_user_pool_clients::ListUserPoolClientsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_user_pool_clients::ListUserPoolClientsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_user_pool_clients::ListUserPoolClientsError>::new());
...
#[derive(Debug)]
            struct ListUserPoolClientsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListUserPoolClientsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_user_pool_clients::de_list_user_pool_clients_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListUserPoolClientsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListUserPoolClientsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_user_pool_clients::ListUserPoolClientsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_user_pool_clients::ListUserPoolClientsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_user_pool_clients::ser_list_user_pool_clients_input(&input)?);
...
#[derive(Debug)]
            struct ListUserPoolClientsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListUserPoolClientsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListUserPoolClientsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListUserPoolClientsInput>()
                        .ok_or("failed to downcast to ListUserPoolClientsInput")?;
...
pub enum ListUserPoolClientsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListUserPoolClientsError) for what information is available for the error.")]
...
impl ListUserPoolClientsError {
    /// Creates the `ListUserPoolClientsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListUserPoolClientsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListUserPoolClientsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_user_pool_clients::ListUserPoolClientsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_user_pool_clients::_list_user_pool_clients_output::ListUserPoolClientsOutput;

pub use crate::operation::list_user_pool_clients::_list_user_pool_clients_input::ListUserPoolClientsInput;

mod _list_user_pool_clients_input;

mod _list_user_pool_clients_output;
