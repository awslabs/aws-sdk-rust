...
impl AddCustomAttributesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_custom_attributes::AddCustomAttributes::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("AddCustomAttributes", "cognitoidentityprovider"),
            );
