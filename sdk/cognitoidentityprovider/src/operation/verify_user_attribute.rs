...
impl VerifyUserAttributeInput {
    /// Consumes the builder and constructs an Operation<[`VerifyUserAttribute`](crate::operation::verify_user_attribute::VerifyUserAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_user_attribute::VerifyUserAttribute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_user_attribute::VerifyUserAttributeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_verify_user_attribute::ser_verify_user_attribute_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_user_attribute::VerifyUserAttribute::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifyUserAttribute", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for VerifyUserAttribute {
                type Output = std::result::Result<crate::operation::verify_user_attribute::VerifyUserAttributeOutput, crate::operation::verify_user_attribute::VerifyUserAttributeError>;
