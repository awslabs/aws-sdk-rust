...
impl VerifyUserAttributeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::verify_user_attribute::VerifyUserAttribute,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::verify_user_attribute::VerifyUserAttribute::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("VerifyUserAttribute", "cognitoidentityprovider"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyUserAttribute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_verify_user_attribute::de_verify_user_attribute_http_response_with_props(status, headers, body)
        }
    }
}
