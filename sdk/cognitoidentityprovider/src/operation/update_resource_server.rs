...
impl UpdateResourceServerInput {
    /// Consumes the builder and constructs an Operation<[`UpdateResourceServer`](crate::operation::update_resource_server::UpdateResourceServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_resource_server::UpdateResourceServer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_resource_server::UpdateResourceServerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_resource_server::ser_update_resource_server_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_resource_server::UpdateResourceServer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateResourceServer", "cognitoidentityprovider"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateResourceServer`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateResourceServer {
                type Output = std::result::Result<crate::operation::update_resource_server::UpdateResourceServerOutput, crate::operation::update_resource_server::UpdateResourceServerError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_resource_server::de_update_resource_server_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_resource_server::de_update_resource_server_http_response(response)
                     }
                }
            }
