...
impl DescribeResourceServerInput {
    /// Consumes the builder and constructs an Operation<[`DescribeResourceServer`](crate::operation::describe_resource_server::DescribeResourceServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_resource_server::DescribeResourceServer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_resource_server::DescribeResourceServerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_resource_server::ser_describe_resource_server_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_resource_server::DescribeResourceServer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeResourceServer", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeResourceServer {
                type Output = std::result::Result<crate::operation::describe_resource_server::DescribeResourceServerOutput, crate::operation::describe_resource_server::DescribeResourceServerError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_resource_server::DescribeResourceServerError {
