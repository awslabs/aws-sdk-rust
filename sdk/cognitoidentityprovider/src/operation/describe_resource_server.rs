...
impl DescribeResourceServerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_resource_server::DescribeResourceServer,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeResourceServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_resource_server::de_describe_resource_server_http_response_with_props(status, headers, body)
        }
    }
}
