...
impl AdminLinkProviderForUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_link_provider_for_user::AdminLinkProviderForUserInput, ::aws_smithy_types::error::operation::BuildError> {
