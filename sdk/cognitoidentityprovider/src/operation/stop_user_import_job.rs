...
impl StopUserImportJobInput {
    /// Consumes the builder and constructs an Operation<[`StopUserImportJob`](crate::operation::stop_user_import_job::StopUserImportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_user_import_job::StopUserImportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_user_import_job::StopUserImportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_user_import_job::ser_stop_user_import_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_user_import_job::StopUserImportJob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopUserImportJob", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopUserImportJob {
                type Output = std::result::Result<crate::operation::stop_user_import_job::StopUserImportJobOutput, crate::operation::stop_user_import_job::StopUserImportJobError>;
