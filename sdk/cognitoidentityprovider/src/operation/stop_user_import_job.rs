...
impl StopUserImportJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_user_import_job::ser_stop_user_import_job_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_user_import_job::StopUserImportJob::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("StopUserImportJob", "cognitoidentityprovider"),
            );
