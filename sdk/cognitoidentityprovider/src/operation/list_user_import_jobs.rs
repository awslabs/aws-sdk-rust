...
impl ListUserImportJobsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_import_jobs::ListUserImportJobs::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListUserImportJobs", "cognitoidentityprovider"),
            );
