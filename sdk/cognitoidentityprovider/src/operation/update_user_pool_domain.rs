...
impl UpdateUserPoolDomainInput {
    /// Consumes the builder and constructs an Operation<[`UpdateUserPoolDomain`](crate::operation::update_user_pool_domain::UpdateUserPoolDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_user_pool_domain::UpdateUserPoolDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_user_pool_domain::UpdateUserPoolDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_user_pool_domain::ser_update_user_pool_domain_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_pool_domain::UpdateUserPoolDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateUserPoolDomain", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateUserPoolDomain {
                type Output = std::result::Result<crate::operation::update_user_pool_domain::UpdateUserPoolDomainOutput, crate::operation::update_user_pool_domain::UpdateUserPoolDomainError>;
...
impl aws_http::request_id::RequestId for crate::operation::update_user_pool_domain::UpdateUserPoolDomainError {
