...
impl UpdateDeviceStatusInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_device_status::ser_update_device_status_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_device_status::UpdateDeviceStatus::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("UpdateDeviceStatus", "cognitoidentityprovider"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeviceStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_device_status::de_update_device_status_http_response_with_props(status, headers, body)
        }
    }
}
