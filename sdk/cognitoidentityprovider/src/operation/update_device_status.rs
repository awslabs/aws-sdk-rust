...
impl UpdateDeviceStatusInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDeviceStatus`](crate::operation::update_device_status::UpdateDeviceStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_device_status::UpdateDeviceStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_device_status::UpdateDeviceStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_device_status::ser_update_device_status_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_device_status::UpdateDeviceStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateDeviceStatus", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDeviceStatus {
                type Output = std::result::Result<crate::operation::update_device_status::UpdateDeviceStatusOutput, crate::operation::update_device_status::UpdateDeviceStatusError>;
