...
impl DescribeUserPoolDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_user_pool_domain::DescribeUserPoolDomainOutput, crate::operation::describe_user_pool_domain::DescribeUserPoolDomainError, Self> {
