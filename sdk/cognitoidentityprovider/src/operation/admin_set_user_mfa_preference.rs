...
impl AdminSetUserMfaPreferenceInput {
    /// Consumes the builder and constructs an Operation<[`AdminSetUserMFAPreference`](crate::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreference)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreference, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_set_user_mfa_preference::ser_admin_set_user_mfa_preference_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreference::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminSetUserMFAPreference", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminSetUserMFAPreference {
                type Output = std::result::Result<crate::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceOutput, crate::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreferenceError {
