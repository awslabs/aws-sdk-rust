...
impl AdminSetUserMfaPreferenceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::admin_set_user_mfa_preference::AdminSetUserMFAPreference::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminSetUserMFAPreference {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_admin_set_user_mfa_preference::de_admin_set_user_mfa_preference_http_response_with_props(status, headers, body)
        }
    }
}
