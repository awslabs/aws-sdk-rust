...
impl GetUiCustomizationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_ui_customization::ser_get_ui_customization_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_ui_customization::GetUICustomization::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetUICustomization", "cognitoidentityprovider"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUICustomization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ui_customization::de_get_ui_customization_http_response_with_props(status, headers, body)
        }
    }
