...
impl GetUiCustomizationInput {
    /// Consumes the builder and constructs an Operation<[`GetUICustomization`](crate::operation::get_ui_customization::GetUICustomization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_ui_customization::GetUICustomization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_ui_customization::GetUiCustomizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ui_customization::ser_get_ui_customization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_ui_customization::GetUICustomization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetUICustomization", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetUICustomization {
                type Output = std::result::Result<crate::operation::get_ui_customization::GetUiCustomizationOutput, crate::operation::get_ui_customization::GetUICustomizationError>;
