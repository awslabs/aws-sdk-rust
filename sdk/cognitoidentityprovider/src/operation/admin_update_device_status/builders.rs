...
impl AdminUpdateDeviceStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_update_device_status::AdminUpdateDeviceStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_update_device_status::AdminUpdateDeviceStatusOutput, crate::operation::admin_update_device_status::AdminUpdateDeviceStatusError, Self> {
