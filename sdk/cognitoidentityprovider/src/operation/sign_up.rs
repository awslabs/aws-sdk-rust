...
impl SignUpInput {
    /// Consumes the builder and constructs an Operation<[`SignUp`](crate::operation::sign_up::SignUp)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::sign_up::SignUp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_sign_up::ser_sign_up_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::sign_up::SignUp::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SignUp", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SignUp {
    type Output = ::std::result::Result<crate::operation::sign_up::SignUpOutput, crate::operation::sign_up::SignUpError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_sign_up::de_sign_up_http_response_with_props(status, headers, body)
        }
    }
}
