...
impl AdminListGroupsForUserFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_list_groups_for_user::AdminListGroupsForUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_list_groups_for_user::AdminListGroupsForUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_list_groups_for_user::AdminListGroupsForUserOutput, crate::operation::admin_list_groups_for_user::AdminListGroupsForUserError, Self> {
