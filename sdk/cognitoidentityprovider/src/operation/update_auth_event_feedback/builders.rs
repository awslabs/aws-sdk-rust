...
impl UpdateAuthEventFeedbackFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackOutput, crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackError, Self> {
