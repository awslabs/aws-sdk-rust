...
impl ListResourceServersInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_servers::ListResourceServers::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListResourceServers", "cognitoidentityprovider"),
            );
