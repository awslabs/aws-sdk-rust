...
impl AdminUserGlobalSignOutInput {
    /// Consumes the builder and constructs an Operation<[`AdminUserGlobalSignOut`](crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOut)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOut, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_user_global_sign_out::ser_admin_user_global_sign_out_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOut::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminUserGlobalSignOut", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminUserGlobalSignOut {
                type Output = std::result::Result<crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutOutput, crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_user_global_sign_out::AdminUserGlobalSignOutError {
