...
/// Orchestration and serialization glue logic for `GetUserPoolMfaConfig`.
...
impl GetUserPoolMfaConfig {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUserPoolMfaConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetUserPoolMfaConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetUserPoolMfaConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetUserPoolMfaConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetUserPoolMfaConfig")
...
.with_interceptor(GetUserPoolMfaConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError>::new());
...
#[derive(Debug)]
            struct GetUserPoolMfaConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUserPoolMfaConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_user_pool_mfa_config::de_get_user_pool_mfa_config_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetUserPoolMfaConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUserPoolMfaConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_user_pool_mfa_config::ser_get_user_pool_mfa_config_input(&input)?);
...
#[derive(Debug)]
            struct GetUserPoolMfaConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUserPoolMfaConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetUserPoolMfaConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetUserPoolMfaConfigInput>()
                        .ok_or("failed to downcast to GetUserPoolMfaConfigInput")?;
...
pub enum GetUserPoolMfaConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetUserPoolMfaConfigError) for what information is available for the error.")]
...
impl GetUserPoolMfaConfigError {
    /// Creates the `GetUserPoolMfaConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetUserPoolMfaConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetUserPoolMfaConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_user_pool_mfa_config::_get_user_pool_mfa_config_output::GetUserPoolMfaConfigOutput;

pub use crate::operation::get_user_pool_mfa_config::_get_user_pool_mfa_config_input::GetUserPoolMfaConfigInput;

mod _get_user_pool_mfa_config_input;

mod _get_user_pool_mfa_config_output;
