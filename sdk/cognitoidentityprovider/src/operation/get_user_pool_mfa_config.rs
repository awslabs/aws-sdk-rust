...
impl GetUserPoolMfaConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetUserPoolMfaConfig`](crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_user_pool_mfa_config::ser_get_user_pool_mfa_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetUserPoolMfaConfig", "cognitoidentityprovider"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetUserPoolMfaConfig`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetUserPoolMfaConfig {
                type Output = std::result::Result<crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigOutput, crate::operation::get_user_pool_mfa_config::GetUserPoolMfaConfigError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_user_pool_mfa_config::de_get_user_pool_mfa_config_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_user_pool_mfa_config::de_get_user_pool_mfa_config_http_response(response)
                     }
                }
            }
