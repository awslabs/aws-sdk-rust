...
impl CreateResourceServerInput {
    /// Consumes the builder and constructs an Operation<[`CreateResourceServer`](crate::operation::create_resource_server::CreateResourceServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_resource_server::CreateResourceServer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_resource_server::CreateResourceServerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_resource_server::ser_create_resource_server_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_resource_server::CreateResourceServer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateResourceServer", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateResourceServer {
                type Output = std::result::Result<crate::operation::create_resource_server::CreateResourceServerOutput, crate::operation::create_resource_server::CreateResourceServerError>;
...
impl aws_http::request_id::RequestId for crate::operation::create_resource_server::CreateResourceServerError {
