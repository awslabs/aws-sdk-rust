...
impl CreateResourceServerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_resource_server::CreateResourceServer,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResourceServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_resource_server::de_create_resource_server_http_response_with_props(status, headers, body)
        }
    }
}
