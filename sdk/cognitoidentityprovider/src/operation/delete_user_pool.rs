...
impl DeleteUserPoolInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserPool`](crate::operation::delete_user_pool::DeleteUserPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_user_pool::DeleteUserPool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_pool::DeleteUserPoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_user_pool::ser_delete_user_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_pool::DeleteUserPool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteUserPool", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUserPool {
                type Output = std::result::Result<crate::operation::delete_user_pool::DeleteUserPoolOutput, crate::operation::delete_user_pool::DeleteUserPoolError>;
