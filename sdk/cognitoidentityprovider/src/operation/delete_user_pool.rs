...
impl DeleteUserPoolInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_user_pool::DeleteUserPool, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_user_pool::ser_delete_user_pool_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserPool {
    type Output =
        ::std::result::Result<crate::operation::delete_user_pool::DeleteUserPoolOutput, crate::operation::delete_user_pool::DeleteUserPoolError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_user_pool::de_delete_user_pool_http_response_with_props(status, headers, body)
        }
    }
}
