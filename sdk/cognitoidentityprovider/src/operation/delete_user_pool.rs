...
impl DeleteUserPoolInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_user_pool::DeleteUserPool,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_user_pool::DeleteUserPool::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserPool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_user_pool::de_delete_user_pool_http_error(
                status, headers, body,
            )
        } else {
