...
impl CreateUserPoolInput {
    /// Consumes the builder and constructs an Operation<[`CreateUserPool`](crate::operation::create_user_pool::CreateUserPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_user_pool::CreateUserPool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_user_pool::CreateUserPoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_user_pool::ser_create_user_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_user_pool::CreateUserPool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateUserPool", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateUserPool {
                type Output = std::result::Result<crate::operation::create_user_pool::CreateUserPoolOutput, crate::operation::create_user_pool::CreateUserPoolError>;
