...
impl SetUserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`SetUserSettings`](crate::operation::set_user_settings::SetUserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_user_settings::SetUserSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_user_settings::SetUserSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_user_settings::ser_set_user_settings_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_user_settings::SetUserSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetUserSettings", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetUserSettings {
                type Output = std::result::Result<crate::operation::set_user_settings::SetUserSettingsOutput, crate::operation::set_user_settings::SetUserSettingsError>;
