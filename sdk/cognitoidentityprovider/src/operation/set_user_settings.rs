...
impl SetUserSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::set_user_settings::SetUserSettings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_user_settings::ser_set_user_settings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetUserSettings {
    type Output =
        ::std::result::Result<crate::operation::set_user_settings::SetUserSettingsOutput, crate::operation::set_user_settings::SetUserSettingsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_user_settings::de_set_user_settings_http_response_with_props(status, headers, body)
        }
    }
}
