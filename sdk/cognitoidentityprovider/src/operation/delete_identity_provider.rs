...
impl DeleteIdentityProviderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIdentityProvider`](crate::operation::delete_identity_provider::DeleteIdentityProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_identity_provider::DeleteIdentityProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_identity_provider::DeleteIdentityProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_identity_provider::ser_delete_identity_provider_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_identity_provider::DeleteIdentityProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteIdentityProvider", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteIdentityProvider {
                type Output = std::result::Result<crate::operation::delete_identity_provider::DeleteIdentityProviderOutput, crate::operation::delete_identity_provider::DeleteIdentityProviderError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_identity_provider::DeleteIdentityProviderError {
