...
impl AdminRemoveUserFromGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput, crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError, Self> {
