...
impl AdminDeleteUserAttributesInput {
    /// Consumes the builder and constructs an Operation<[`AdminDeleteUserAttributes`](crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_delete_user_attributes::ser_admin_delete_user_attributes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AdminDeleteUserAttributes", "cognitoidentityprovider"));
...
impl aws_smithy_http::response::ParseStrictResponse for AdminDeleteUserAttributes {
                type Output = std::result::Result<crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesOutput, crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError>;
...
impl aws_http::request_id::RequestId for crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesError {
