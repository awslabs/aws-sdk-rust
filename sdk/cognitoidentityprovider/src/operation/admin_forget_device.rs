...
impl AdminForgetDeviceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_admin_forget_device::ser_admin_forget_device_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_forget_device::AdminForgetDevice::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("AdminForgetDevice", "cognitoidentityprovider"),
            );
