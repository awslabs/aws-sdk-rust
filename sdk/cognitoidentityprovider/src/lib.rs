...
//! aws-sdk-cognitoidentityprovider = "0.58.0"
...
//!
//! # Examples
//! Examples can be found [here](https://github.com/awslabs/aws-sdk-rust/tree/main/examples/cognitoidentityprovider).
...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("cognitoidentityprovider", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Cognito Identity Provider.
pub mod client;
