...
impl AgentStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            AgentStatus::CreateFailed => "CREATE_FAILED",
            AgentStatus::Creating => "CREATING",
            AgentStatus::Deleting => "DELETING",
            AgentStatus::Ready => "READY",
            AgentStatus::UpdateFailed => "UPDATE_FAILED",
