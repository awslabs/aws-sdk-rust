...
impl ::std::convert::From<&str> for KeyType {
    fn from(s: &str) -> Self {
        match s {
            "CustomerManagedKey" => KeyType::CustomerManagedKey,
            "ServiceManagedKey" => KeyType::ServiceManagedKey,
...
impl KeyType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            KeyType::CustomerManagedKey => "CustomerManagedKey",
            KeyType::ServiceManagedKey => "ServiceManagedKey",
            KeyType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["CustomerManagedKey", "ServiceManagedKey"]
    }
}
