...
/// When writing a match expression against `OnlineEvaluationConfigStatus`, it is important to ensure
...
///
/// ```text
/// # let onlineevaluationconfigstatus = unimplemented!();
/// match onlineevaluationconfigstatus {
///     OnlineEvaluationConfigStatus::Active => { /* ... */ },
...
/// }
/// ```
/// The above code demonstrates that when `onlineevaluationconfigstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `OnlineEvaluationConfigStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `OnlineEvaluationConfigStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `OnlineEvaluationConfigStatus::NewFeature` is defined.
/// Specifically, when `onlineevaluationconfigstatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `OnlineEvaluationConfigStatus::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum OnlineEvaluationConfigStatus {
    #[allow(missing_docs)] // documentation missing in model
    Active,
    #[allow(missing_docs)] // documentation missing in model
    CreateFailed,
...
impl ::std::convert::From<&str> for OnlineEvaluationConfigStatus {
    fn from(s: &str) -> Self {
        match s {
            "ACTIVE" => OnlineEvaluationConfigStatus::Active,
...
impl ::std::str::FromStr for OnlineEvaluationConfigStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OnlineEvaluationConfigStatus::from(s))
    }
}
impl OnlineEvaluationConfigStatus {
    /// Returns the `&str` value of the enum member.
    pub fn as_str(&self) -> &str {
        match self {
            OnlineEvaluationConfigStatus::Active => "ACTIVE",
...
impl ::std::fmt::Display for OnlineEvaluationConfigStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OnlineEvaluationConfigStatus::Active => write!(f, "ACTIVE"),
