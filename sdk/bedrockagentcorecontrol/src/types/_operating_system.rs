...
impl ::std::convert::From<&str> for OperatingSystem {
    fn from(s: &str) -> Self {
        match s {
            "LINUX_ARM64" => OperatingSystem::LinuxArm64,
            "LINUX_X86_64" => OperatingSystem::LinuxX8664,
...
impl OperatingSystem {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            OperatingSystem::LinuxArm64 => "LINUX_ARM64",
            OperatingSystem::LinuxX8664 => "LINUX_X86_64",
...
impl ::std::fmt::Display for OperatingSystem {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            OperatingSystem::LinuxArm64 => write!(f, "LINUX_ARM64"),
            OperatingSystem::LinuxX8664 => write!(f, "LINUX_X86_64"),
