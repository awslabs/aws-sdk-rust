...
impl ::std::convert::From<&str> for ContentType {
    fn from(s: &str) -> Self {
        match s {
            "MEMORY_RECORDS" => ContentType::MemoryRecords,
...
impl ContentType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ContentType::MemoryRecords => "MEMORY_RECORDS",
...
impl ::std::fmt::Display for ContentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ContentType::MemoryRecords => write!(f, "MEMORY_RECORDS"),
