...
/// When writing a match expression against `ClientAuthenticationMethodType`, it is important to ensure
...
///
/// ```text
/// # let clientauthenticationmethodtype = unimplemented!();
/// match clientauthenticationmethodtype {
...
/// }
/// ```
/// The above code demonstrates that when `clientauthenticationmethodtype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ClientAuthenticationMethodType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ClientAuthenticationMethodType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ClientAuthenticationMethodType::NewFeature` is defined.
/// Specifically, when `clientauthenticationmethodtype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ClientAuthenticationMethodType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ClientAuthenticationMethodType {
    #[allow(missing_docs)] // documentation missing in model
    AwsIamIdTokenJwt,
    #[allow(missing_docs)] // documentation missing in model
    ClientSecretBasic,
...
impl ::std::convert::From<&str> for ClientAuthenticationMethodType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ClientAuthenticationMethodType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ClientAuthenticationMethodType::from(s))
    }
}
impl ClientAuthenticationMethodType {
...
impl ::std::fmt::Display for ClientAuthenticationMethodType {
