...
/// When writing a match expression against `OverrideType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `overridetype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `OverrideType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `OverrideType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `OverrideType::NewFeature` is defined.
/// Specifically, when `overridetype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `OverrideType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for OverrideType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => OverrideType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for OverrideType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(OverrideType::from(s))
    }
}
impl OverrideType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OverrideType::Unknown(value) => value.as_str(),
        }
    }
