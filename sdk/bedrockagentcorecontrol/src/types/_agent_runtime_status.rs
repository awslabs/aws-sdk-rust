...
/// When writing a match expression against `AgentRuntimeStatus`, it is important to ensure
...
///
/// ```text
/// # let agentruntimestatus = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `agentruntimestatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `AgentRuntimeStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `AgentRuntimeStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `AgentRuntimeStatus::NewFeature` is defined.
/// Specifically, when `agentruntimestatus` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `AgentRuntimeStatus::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for AgentRuntimeStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "UPDATING" => AgentRuntimeStatus::Updating,
            other => AgentRuntimeStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AgentRuntimeStatus {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AgentRuntimeStatus::from(s))
    }
}
impl AgentRuntimeStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AgentRuntimeStatus::Updating => "UPDATING",
            AgentRuntimeStatus::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::fmt::Display for AgentRuntimeStatus {
