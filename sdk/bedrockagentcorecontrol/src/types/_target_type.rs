...
impl ::std::convert::From<&str> for TargetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PASSTHROUGH" => TargetType::Passthrough,
            "PROVIDER" => TargetType::Provider,
            "SMITHY_MODEL" => TargetType::SmithyModel,
...
impl TargetType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            TargetType::Passthrough => "PASSTHROUGH",
            TargetType::Provider => "PROVIDER",
            TargetType::SmithyModel => "SMITHY_MODEL",
...
impl ::std::fmt::Display for TargetType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            TargetType::Passthrough => write!(f, "PASSTHROUGH"),
            TargetType::Provider => write!(f, "PROVIDER"),
            TargetType::SmithyModel => write!(f, "SMITHY_MODEL"),
