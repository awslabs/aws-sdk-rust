...
pub struct SummaryMemoryStrategyInput {
...
impl SummaryMemoryStrategyInput {
    /// <p>The name of the summary memory strategy.</p>
...
impl ::std::fmt::Debug for SummaryMemoryStrategyInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("SummaryMemoryStrategyInput");
...
impl SummaryMemoryStrategyInput {
    /// Creates a new builder-style object to manufacture [`SummaryMemoryStrategyInput`](crate::types::SummaryMemoryStrategyInput).
    pub fn builder() -> crate::types::builders::SummaryMemoryStrategyInputBuilder {
        crate::types::builders::SummaryMemoryStrategyInputBuilder::default()
    }
}

/// A builder for [`SummaryMemoryStrategyInput`](crate::types::SummaryMemoryStrategyInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct SummaryMemoryStrategyInputBuilder {
...
impl SummaryMemoryStrategyInputBuilder {
    /// <p>The name of the summary memory strategy.</p>
    ...
    /// Consumes the builder and constructs a [`SummaryMemoryStrategyInput`](crate::types::SummaryMemoryStrategyInput).
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](crate::types::builders::SummaryMemoryStrategyInputBuilder::name)
    pub fn build(self) -> ::std::result::Result<crate::types::SummaryMemoryStrategyInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::SummaryMemoryStrategyInput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building SummaryMemoryStrategyInput",
                )
            })?,
...
impl ::std::fmt::Debug for SummaryMemoryStrategyInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("SummaryMemoryStrategyInputBuilder");
        formatter.field("name", &self.name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("namespaces", &self.namespaces);
        formatter.field("namespace_templates", &self.namespace_templates);
