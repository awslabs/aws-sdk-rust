...
/// match findingtype {
///     FindingType::AllowAll => { /* ... */ },
///     FindingType::AllowNone => { /* ... */ },
///     FindingType::DenyAll => { /* ... */ },
///     FindingType::DenyNone => { /* ... */ },
///     FindingType::Invalid => { /* ... */ },
///     FindingType::NotTranslatable => { /* ... */ },
///     FindingType::Valid => { /* ... */ },
...
impl ::std::convert::From<&str> for FindingType {
    fn from(s: &str) -> Self {
        match s {
            "ALLOW_ALL" => FindingType::AllowAll,
            "ALLOW_NONE" => FindingType::AllowNone,
            "DENY_ALL" => FindingType::DenyAll,
            "DENY_NONE" => FindingType::DenyNone,
            "INVALID" => FindingType::Invalid,
            "NOT_TRANSLATABLE" => FindingType::NotTranslatable,
            "VALID" => FindingType::Valid,
...
impl FindingType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            FindingType::AllowAll => "ALLOW_ALL",
            FindingType::AllowNone => "ALLOW_NONE",
            FindingType::DenyAll => "DENY_ALL",
            FindingType::DenyNone => "DENY_NONE",
            FindingType::Invalid => "INVALID",
            FindingType::NotTranslatable => "NOT_TRANSLATABLE",
...
impl ::std::fmt::Display for FindingType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            FindingType::AllowAll => write!(f, "ALLOW_ALL"),
            FindingType::AllowNone => write!(f, "ALLOW_NONE"),
            FindingType::DenyAll => write!(f, "DENY_ALL"),
            FindingType::DenyNone => write!(f, "DENY_NONE"),
            FindingType::Invalid => write!(f, "INVALID"),
            FindingType::NotTranslatable => write!(f, "NOT_TRANSLATABLE"),
            FindingType::Valid => write!(f, "VALID"),
