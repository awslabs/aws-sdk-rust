...
pub struct GithubOauth2ProviderConfigOutput {
...
impl GithubOauth2ProviderConfigOutput {
    /// <p>The OAuth2 discovery information for the GitHub provider.</p>
...
impl GithubOauth2ProviderConfigOutput {
    /// Creates a new builder-style object to manufacture [`GithubOauth2ProviderConfigOutput`](crate::types::GithubOauth2ProviderConfigOutput).
    pub fn builder() -> crate::types::builders::GithubOauth2ProviderConfigOutputBuilder {
        crate::types::builders::GithubOauth2ProviderConfigOutputBuilder::default()
    }
}

/// A builder for [`GithubOauth2ProviderConfigOutput`](crate::types::GithubOauth2ProviderConfigOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GithubOauth2ProviderConfigOutputBuilder {
    pub(crate) oauth_discovery: ::std::option::Option<crate::types::Oauth2Discovery>,
    pub(crate) client_id: ::std::option::Option<::std::string::String>,
}
impl GithubOauth2ProviderConfigOutputBuilder {
    /// <p>The OAuth2 discovery information for the GitHub provider.</p>
    ...
    /// Consumes the builder and constructs a [`GithubOauth2ProviderConfigOutput`](crate::types::GithubOauth2ProviderConfigOutput).
    pub fn build(self) -> crate::types::GithubOauth2ProviderConfigOutput {
        crate::types::GithubOauth2ProviderConfigOutput {
