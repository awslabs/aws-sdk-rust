...
pub struct IncludedOauth2ProviderConfigOutput {
...
impl IncludedOauth2ProviderConfigOutput {
    /// <p>Contains the discovery information for an OAuth2 provider.</p>
...
impl IncludedOauth2ProviderConfigOutput {
    /// Creates a new builder-style object to manufacture [`IncludedOauth2ProviderConfigOutput`](crate::types::IncludedOauth2ProviderConfigOutput).
    pub fn builder() -> crate::types::builders::IncludedOauth2ProviderConfigOutputBuilder {
        crate::types::builders::IncludedOauth2ProviderConfigOutputBuilder::default()
    }
}

/// A builder for [`IncludedOauth2ProviderConfigOutput`](crate::types::IncludedOauth2ProviderConfigOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct IncludedOauth2ProviderConfigOutputBuilder {
    pub(crate) oauth_discovery: ::std::option::Option<crate::types::Oauth2Discovery>,
    pub(crate) client_id: ::std::option::Option<::std::string::String>,
}
impl IncludedOauth2ProviderConfigOutputBuilder {
    /// <p>Contains the discovery information for an OAuth2 provider.</p>
    ...
    /// Consumes the builder and constructs a [`IncludedOauth2ProviderConfigOutput`](crate::types::IncludedOauth2ProviderConfigOutput).
    pub fn build(self) -> crate::types::IncludedOauth2ProviderConfigOutput {
        crate::types::IncludedOauth2ProviderConfigOutput {
