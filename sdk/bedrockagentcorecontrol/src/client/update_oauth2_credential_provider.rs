...
impl super::Client {
    ...
    ///   - [`client_secret_json_key(Option<String>)`](crate::operation::update_oauth2_credential_provider::UpdateOauth2CredentialProviderOutput::client_secret_json_key): <p>The JSON key used to extract the client secret value from the AWS Secrets Manager secret.</p>
    ///   - [`client_secret_source(Option<SecretSourceType>)`](crate::operation::update_oauth2_credential_provider::UpdateOauth2CredentialProviderOutput::client_secret_source): <p>The source type of the client secret. Either <code>MANAGED</code> if the secret is managed by the service, or <code>EXTERNAL</code> if managed by the user in AWS Secrets Manager.</p>
