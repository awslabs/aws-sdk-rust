...
impl super::Client {
    ...
    ///   - [`api_key_secret_arn(Option<Secret>)`](crate::operation::get_api_key_credential_provider::GetApiKeyCredentialProviderOutput::api_key_secret_arn): <p>The Amazon Resource Name (ARN) of the API key secret in Amazon Web Services Secrets Manager.</p>
    ///   - [`api_key_secret_json_key(Option<String>)`](crate::operation::get_api_key_credential_provider::GetApiKeyCredentialProviderOutput::api_key_secret_json_key): <p>The JSON key used to extract the API key value from the Amazon Web Services Secrets Manager secret.</p>
    ///   - [`api_key_secret_source(Option<SecretSourceType>)`](crate::operation::get_api_key_credential_provider::GetApiKeyCredentialProviderOutput::api_key_secret_source): <p>The source type of the API key secret. Either <code>MANAGED</code> if the secret is managed by the service, or <code>EXTERNAL</code> if managed by the user in Amazon Web Services Secrets Manager.</p>
