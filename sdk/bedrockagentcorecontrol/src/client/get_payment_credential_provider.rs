...
impl super::Client {
    ...
    ///   - [`credential_provider_vendor(PaymentCredentialProviderVendorType)`](crate::operation::get_payment_credential_provider::GetPaymentCredentialProviderOutput::credential_provider_vendor): Supported vendor types for payment providers using non-standard auth protocols
    ///   - [`provider_configuration_output(Option<PaymentProviderConfigurationOutput>)`](crate::operation::get_payment_credential_provider::GetPaymentCredentialProviderOutput::provider_configuration_output): Output configuration (contains secret ARNs, excludes actual secret values)
