...
impl super::Client {
    ...
    ///   - [`description(UpdatedDescription)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::description) / [`set_description(Option<UpdatedDescription>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::set_description):<br>required: **false**<br><p>The new human-readable description for the policy. This optional field allows updating the policy's documentation while keeping the same policy logic.</p><br>
    ///   - [`definition(PolicyDefinition)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::definition) / [`set_definition(Option<PolicyDefinition>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::set_definition):<br>required: **false**<br><p>The new Cedar policy statement that defines the access control rules. This replaces the existing policy definition with new logic while maintaining the policy's identity.</p><br>
