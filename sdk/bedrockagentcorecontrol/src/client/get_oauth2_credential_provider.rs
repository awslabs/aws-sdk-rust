...
impl super::Client {
    ...
    ///   - [`client_secret_arn(Option<Secret>)`](crate::operation::get_oauth2_credential_provider::GetOauth2CredentialProviderOutput::client_secret_arn): <p>The Amazon Resource Name (ARN) of the client secret in Amazon Web Services Secrets Manager.</p>
    ///   - [`client_secret_json_key(Option<String>)`](crate::operation::get_oauth2_credential_provider::GetOauth2CredentialProviderOutput::client_secret_json_key): <p>The JSON key used to extract the client secret value from the Amazon Web Services Secrets Manager secret.</p>
    ///   - [`client_secret_source(Option<SecretSourceType>)`](crate::operation::get_oauth2_credential_provider::GetOauth2CredentialProviderOutput::client_secret_source): <p>The source type of the client secret. Either <code>MANAGED</code> if the secret is managed by the service, or <code>EXTERNAL</code> if managed by the user in Amazon Web Services Secrets Manager.</p>
    ...
    ///   - [`failure_reason(Option<String>)`](crate::operation::get_oauth2_credential_provider::GetOauth2CredentialProviderOutput::failure_reason): <p>The reason for failure if the OAuth2 credential provider is in a failed state.</p>
