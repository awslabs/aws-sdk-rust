...
impl super::Client {
    ...
    ///   - [`kms_key_arn(Option<String>)`](crate::operation::get_configuration_bundle_version::GetConfigurationBundleVersionOutput::kms_key_arn): <p>KMS key ARN used to encrypt component configurations, if CMK was provided.</p>
