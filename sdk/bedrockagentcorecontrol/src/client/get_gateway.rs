...
impl super::Client {
    ...
    ///   - [`custom_transform_configuration(Option<CustomTransformConfiguration>)`](crate::operation::get_gateway::GetGatewayOutput::custom_transform_configuration): <p>The custom transformation configuration for the gateway. This configuration defines how the gateway transforms requests and responses.</p>
    ...
    ///   - [`policy_engine_configuration(Option<GatewayPolicyEngineConfiguration>)`](crate::operation::get_gateway::GetGatewayOutput::policy_engine_configuration): <p>The policy engine configuration for the gateway.</p>
    ...
    ///   - [`web_acl_arn(Option<String>)`](crate::operation::get_gateway::GetGatewayOutput::web_acl_arn): <p>The Amazon Resource Name (ARN) of the Amazon Web Services WAF web ACL associated with the gateway.</p>
    ///   - [`waf_configuration(Option<WafConfiguration>)`](crate::operation::get_gateway::GetGatewayOutput::waf_configuration): <p>The Amazon Web Services WAF configuration for the gateway.</p>
