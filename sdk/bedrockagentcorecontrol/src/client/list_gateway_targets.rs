...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_gateway_targets::builders::ListGatewayTargetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_gateway_targets::builders::ListGatewayTargetsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in a single call. The default value is 10. The maximum value is 50.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_gateway_targets::builders::ListGatewayTargetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_gateway_targets::builders::ListGatewayTargetsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p><br>
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::list_gateway_targets::ListGatewayTargetsOutput::next_token): <p>Opaque continuation token for the next paginated response.</p>
