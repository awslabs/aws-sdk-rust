...
impl super::Client {
    ...
    ///   - [`policy(Option<String>)`](crate::operation::get_resource_policy::GetResourcePolicyOutput::policy): <p>The resource policy associated with the specified resource.</p>
