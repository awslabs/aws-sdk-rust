            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "inputSchema" => {
                            builder = builder.set_input_schema(crate::protocol_serde::shape_schema_definition::de_schema_definition(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "outputSchema" => {
                            builder = builder.set_output_schema(crate::protocol_serde::shape_schema_definition::de_schema_definition(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
