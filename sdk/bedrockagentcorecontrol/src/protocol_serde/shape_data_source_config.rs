...
pub fn ser_data_source_config(
    ...
    match input {
        crate::types::DataSourceConfig::CloudWatchLogs(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_5.key("cloudWatchLogs").start_object();
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "cloudWatchLogs" => Some(crate::types::DataSourceConfig::CloudWatchLogs(
                            crate::protocol_serde::shape_cloud_watch_logs_input_config::de_cloud_watch_logs_input_config(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
