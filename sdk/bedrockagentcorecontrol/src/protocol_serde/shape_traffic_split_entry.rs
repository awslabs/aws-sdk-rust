...
pub fn ser_traffic_split_entry(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::TrafficSplitEntry,
    ...
    if let Some(var_1) = &input.configuration_bundle {
        #[allow(unused_mut)]
        let mut object_2 = object.key("configurationBundle").start_object();
        crate::protocol_serde::shape_configuration_bundle_reference::ser_configuration_bundle_reference(&mut object_2, var_1)?;
        object_2.finish();
    }
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::TrafficSplitEntryBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(crate::serde_util::traffic_split_entry_correct_errors(builder).build().map_err(
