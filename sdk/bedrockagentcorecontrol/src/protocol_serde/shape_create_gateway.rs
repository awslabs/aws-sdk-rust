...
pub fn de_create_gateway_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_gateway::CreateGatewayOutput, crate::operation::create_gateway::CreateGatewayError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::create_gateway::CreateGatewayError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::create_gateway::CreateGatewayError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::create_gateway::CreateGatewayError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::create_gateway::CreateGatewayError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::create_gateway::CreateGatewayError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::create_gateway::CreateGatewayError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_gateway_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_gateway::CreateGatewayOutput, crate::operation::create_gateway::CreateGatewayError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_gateway::builders::CreateGatewayOutputBuilder::default();
        output = crate::protocol_serde::shape_create_gateway::de_create_gateway(_response_body, output)
            .map_err(crate::operation::create_gateway::CreateGatewayError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::create_gateway_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_gateway::CreateGatewayError::unhandled)?
    })
}
...
pub fn ser_create_gateway_input(
    ...
    crate::protocol_serde::shape_create_gateway_input::ser_create_gateway_input_input(&mut object, input)?;
    object.finish();
