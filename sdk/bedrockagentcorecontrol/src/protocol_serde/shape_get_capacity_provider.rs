...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_capacity_provider::GetCapacityProviderError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::get_capacity_provider::GetCapacityProviderError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::get_capacity_provider::GetCapacityProviderError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::get_capacity_provider::GetCapacityProviderError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "computeConfiguration" => {
                    builder = builder.set_compute_configuration(crate::protocol_serde::shape_compute_configuration::de_compute_configuration(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "permissionsConfiguration" => {
                    builder = builder.set_permissions_configuration(
                        crate::protocol_serde::shape_permissions_configuration::de_permissions_configuration(tokens, _value, depth + 1)?,
                    );
                }
                "status" => {
                ...
                "statusCode" => {
                    builder = builder.set_status_code(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::CapacityProviderStatusCode::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "statusReason" => {
