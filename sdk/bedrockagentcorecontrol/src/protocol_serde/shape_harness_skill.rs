...
pub fn ser_harness_skill(
    ...
    match input {
        crate::types::HarnessSkill::Path(inner) => {
            object_30.key("path").string(inner.as_str());
        }
        crate::types::HarnessSkill::S3(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_30.key("s3").start_object();
        ...
        crate::types::HarnessSkill::Git(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_30.key("git").start_object();
        ...
        crate::types::HarnessSkill::AwsSkills(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_30.key("awsSkills").start_object();
