...
pub fn ser_code(
    ...
    input: &crate::types::Code,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::Code::S3(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_2.key("s3").start_object();
            crate::protocol_serde::shape_s3_location::ser_s3_location(&mut object_1, inner)?;
            object_1.finish();
        }
        crate::types::Code::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("Code")),
    }
    Ok(())
}
