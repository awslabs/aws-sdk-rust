...
pub(crate) fn de_harness_bedrock_model_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::HarnessBedrockModelConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::HarnessBedrockModelConfigBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::harness_bedrock_model_config_correct_errors(builder)
                    .build()
