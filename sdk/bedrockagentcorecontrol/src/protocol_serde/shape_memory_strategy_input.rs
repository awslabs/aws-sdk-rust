...
pub fn ser_memory_strategy_input(
    ...
    match input {
        crate::types::MemoryStrategyInput::SemanticMemoryStrategy(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_13.key("semanticMemoryStrategy").start_object();
        ...
        crate::types::MemoryStrategyInput::SummaryMemoryStrategy(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_13.key("summaryMemoryStrategy").start_object();
        ...
        crate::types::MemoryStrategyInput::UserPreferenceMemoryStrategy(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_13.key("userPreferenceMemoryStrategy").start_object();
        ...
        crate::types::MemoryStrategyInput::CustomMemoryStrategy(inner) => {
            #[allow(unused_mut)]
            let mut object_4 = object_13.key("customMemoryStrategy").start_object();
        ...
        crate::types::MemoryStrategyInput::EpisodicMemoryStrategy(inner) => {
            #[allow(unused_mut)]
            let mut object_5 = object_13.key("episodicMemoryStrategy").start_object();
