...
pub fn ser_credentials_provider_configuration(
    object_5: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CredentialsProviderConfiguration,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::CredentialsProviderConfiguration::CoinbaseCdp(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_5.key("coinbaseCDP").start_object();
            crate::protocol_serde::shape_payment_credential_provider_configuration::ser_payment_credential_provider_configuration(
                &mut object_1,
                inner,
            )?;
            object_1.finish();
        }
        crate::types::CredentialsProviderConfiguration::StripePrivy(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_5.key("stripePrivy").start_object();
            crate::protocol_serde::shape_payment_credential_provider_configuration::ser_payment_credential_provider_configuration(
                &mut object_2,
                inner,
            )?;
        ...
        crate::types::CredentialsProviderConfiguration::Unknown => {
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::CredentialsProviderConfiguration::Unknown)
                        }
                    };
                }
                other => {
