...
pub fn ser_evaluator_model_config(
    ...
    match input {
        crate::types::EvaluatorModelConfig::BedrockEvaluatorModelConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_2.key("bedrockEvaluatorModelConfig").start_object();
        ...
        crate::types::EvaluatorModelConfig::ResponsesEvaluatorModelConfig(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_2.key("responsesEvaluatorModelConfig").start_object();
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "bedrockEvaluatorModelConfig" => Some(crate::types::EvaluatorModelConfig::BedrockEvaluatorModelConfig(
                            crate::protocol_serde::shape_bedrock_evaluator_model_config::de_bedrock_evaluator_model_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?
