...
///
/// <p>Creates or updates a resource-based policy for a resource with the specified resourceArn.</p><note>
/// <p>This feature is currently available only for AgentCore Runtime and Gateway.</p>
/// </note>
