...
impl UpdateGatewayOutputBuilder {
    ...
    /// - [`gateway_arn`](crate::operation::update_gateway::builders::UpdateGatewayOutputBuilder::gateway_arn)
    /// - [`gateway_id`](crate::operation::update_gateway::builders::UpdateGatewayOutputBuilder::gateway_id)
    /// - [`created_at`](crate::operation::update_gateway::builders::UpdateGatewayOutputBuilder::created_at)
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_gateway::UpdateGatewayOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_gateway::UpdateGatewayOutput {
            gateway_arn: self.gateway_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "gateway_arn",
                    "gateway_arn was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
            gateway_id: self.gateway_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "gateway_id",
                    "gateway_id was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
            ...
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
            ...
            authorizer_type: self.authorizer_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "authorizer_type",
                    "authorizer_type was not specified but it is required when building UpdateGatewayOutput",
                )
            })?,
...
impl ::std::fmt::Debug for UpdateGatewayOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateGatewayOutputBuilder");
        formatter.field("gateway_arn", &self.gateway_arn);
        formatter.field("gateway_id", &self.gateway_id);
        formatter.field("gateway_url", &self.gateway_url);
        formatter.field("created_at", &self.created_at);
