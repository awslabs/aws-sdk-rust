...
pub struct ListGatewaysOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::GatewaySummary>>,
...
impl ListGatewaysOutputBuilder {
    ...
    /// - [`items`](crate::operation::list_gateways::builders::ListGatewaysOutputBuilder::items)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_gateways::ListGatewaysOutput {
            items: self.items.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "items",
                    "items was not specified but it is required when building ListGatewaysOutput",
                )
            })?,
