...
impl CreatePolicyOutputBuilder {
    ...
    /// - [`name`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::name)
    /// - [`policy_engine_id`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::policy_engine_id)
    /// - [`created_at`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::updated_at)
    /// - [`policy_arn`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::policy_arn)
    /// - [`status`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::status)
    /// - [`status_reasons`](crate::operation::create_policy::builders::CreatePolicyOutputBuilder::status_reasons)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::create_policy::CreatePolicyOutput {
            ...
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreatePolicyOutput",
                )
            })?,
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building CreatePolicyOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building CreatePolicyOutput",
                )
            })?,
            policy_arn: self.policy_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "policy_arn",
                    "policy_arn was not specified but it is required when building CreatePolicyOutput",
                )
            })?,
            ...
            status_reasons: self.status_reasons.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status_reasons",
                    "status_reasons was not specified but it is required when building CreatePolicyOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreatePolicyOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreatePolicyOutputBuilder");
        formatter.field("policy_id", &self.policy_id);
        formatter.field("name", &self.name);
        formatter.field("policy_engine_id", &self.policy_engine_id);
        formatter.field("definition", &self.definition);
