...
impl CreateGatewayOutputBuilder {
    ...
    /// - [`created_at`](crate::operation::create_gateway::builders::CreateGatewayOutputBuilder::created_at)
    ...
    pub fn build(
        ...
        ::std::result::Result::Ok(crate::operation::create_gateway::CreateGatewayOutput {
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building CreateGatewayOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building CreateGatewayOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building CreateGatewayOutput",
                )
            })?,
            ...
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreateGatewayOutput",
                )
            })?,
            ...
            authorizer_type: self.authorizer_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "authorizer_type",
                    "authorizer_type was not specified but it is required when building CreateGatewayOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreateGatewayOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateGatewayOutputBuilder");
        formatter.field("gateway_arn", &self.gateway_arn);
        formatter.field("gateway_id", &self.gateway_id);
        formatter.field("gateway_url", &self.gateway_url);
        formatter.field("created_at", &self.created_at);
