    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_policy::CreatePolicyInput = input.downcast_mut().expect("correct type");
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/policy-engines/{policyEngineId}/policies", policyEngineId = policy_engine_id)
...
impl CreatePolicyError {
    ...
    /// Returns `true` if the error kind is `CreatePolicyError::ConflictException`.
