...
pub use crate::operation::create_browser::_create_browser_output::CreateBrowserOutputBuilder;

pub use crate::operation::create_browser::_create_browser_input::CreateBrowserInputBuilder;

impl crate::operation::create_browser::builders::CreateBrowserInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::create_browser::CreateBrowserOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::create_browser::CreateBrowserError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.create_browser();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `CreateBrowser`.
///
/// <p>Creates a custom browser.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct CreateBrowserFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::create_browser::builders::CreateBrowserInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_browser::CreateBrowserOutput,
        crate::operation::create_browser::CreateBrowserError,
    > for CreateBrowserFluentBuilder
{
    fn send(
        self,
...
impl CreateBrowserFluentBuilder {
    /// Creates a new `CreateBrowserFluentBuilder`.
    ...
    /// Access the CreateBrowser as a reference.
    pub fn as_input(&self) -> &crate::operation::create_browser::builders::CreateBrowserInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_browser::CreateBrowser::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_browser::CreateBrowser::orchestrate(&runtime_plugins, input).await
    }
