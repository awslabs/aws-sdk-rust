...
pub use crate::operation::create_agent_runtime_endpoint::_create_agent_runtime_endpoint_output::CreateAgentRuntimeEndpointOutputBuilder;

pub use crate::operation::create_agent_runtime_endpoint::_create_agent_runtime_endpoint_input::CreateAgentRuntimeEndpointInputBuilder;

impl crate::operation::create_agent_runtime_endpoint::builders::CreateAgentRuntimeEndpointInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::create_agent_runtime_endpoint::CreateAgentRuntimeEndpointError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.create_agent_runtime_endpoint();
...
pub struct CreateAgentRuntimeEndpointFluentBuilder {
    ...
    inner: crate::operation::create_agent_runtime_endpoint::builders::CreateAgentRuntimeEndpointInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_agent_runtime_endpoint::CreateAgentRuntimeEndpointOutput,
        crate::operation::create_agent_runtime_endpoint::CreateAgentRuntimeEndpointError,
    > for CreateAgentRuntimeEndpointFluentBuilder
{
    fn send(
        self,
...
impl CreateAgentRuntimeEndpointFluentBuilder {
    /// Creates a new `CreateAgentRuntimeEndpointFluentBuilder`.
    ...
    /// Access the CreateAgentRuntimeEndpoint as a reference.
    pub fn as_input(&self) -> &crate::operation::create_agent_runtime_endpoint::builders::CreateAgentRuntimeEndpointInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_agent_runtime_endpoint::CreateAgentRuntimeEndpoint::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_agent_runtime_endpoint::CreateAgentRuntimeEndpoint::orchestrate(&runtime_plugins, input).await
    }
