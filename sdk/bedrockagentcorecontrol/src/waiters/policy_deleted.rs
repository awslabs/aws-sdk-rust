...
///
/// Fluent builder for the `policy_deleted` waiter.
///
...
pub struct PolicyDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_policy::builders::GetPolicyInputBuilder,
}
impl PolicyDeletedFluentBuilder {
    /// Creates a new `PolicyDeletedFluentBuilder`.
    ...
    ) -> ::std::result::Result<crate::waiters::policy_deleted::PolicyDeletedFinalPoll, crate::waiters::policy_deleted::WaitUntilPolicyDeletedError>
    {
        let input = self
            .inner
            .build()
        ...
        let acceptor =
            move |result: ::std::result::Result<&crate::operation::get_policy::GetPolicyOutput, &crate::operation::get_policy::GetPolicyError>| {
                ...
                if crate::waiters::matchers::match_get_policy_1cce2c05524fb92d4(result) {
                    return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
                }
                // Matches: {"output":{"path":"status","expected":"DELETING","comparator":"stringEquals"}}
                if crate::waiters::matchers::match_get_policy_ac9cf40eec4f10ab5(result) {
...
/// Successful return type for the `policy_deleted` waiter.
pub type PolicyDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
...
/// Error type for the `policy_deleted` waiter.
pub type WaitUntilPolicyDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_policy::GetPolicyOutput,
    crate::operation::get_policy::GetPolicyError,
>;
