...
#[allow(clippy::unnecessary_wraps)]pub fn parse_list_shared_endpoints_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSharedEndpointsOutput, crate::error::ListSharedEndpointsError> {
...
#[allow(clippy::unnecessary_wraps)]pub fn parse_list_shared_endpoints_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSharedEndpointsOutput, crate::error::ListSharedEndpointsError> {
    Ok({
        #[allow(unused_mut)]let mut output = crate::output::list_shared_endpoints_output::Builder::default();
        let _ = response;
