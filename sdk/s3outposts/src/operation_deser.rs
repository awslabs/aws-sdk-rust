...
pub fn parse_create_endpoint_error(
    ...
    Err(match error_code {
        ...
        "ValidationException" => {
            crate::error::CreateEndpointError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn parse_delete_endpoint_error(
    ...
    Err(match error_code {
        ...
        "ValidationException" => {
            crate::error::DeleteEndpointError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
pub fn parse_list_endpoints_error(
    ...
    Err(match error_code {
        ...
        "ValidationException" => {
            crate::error::ListEndpointsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
#[allow(clippy::unnecessary_wraps)]
pub fn parse_list_shared_endpoints_error(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
...
> {
    ...
    Err(match error_code {
        ...
        "ValidationException" => {
            crate::error::ListSharedEndpointsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
#[allow(clippy::unnecessary_wraps)]
pub fn parse_list_shared_endpoints_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::output::ListSharedEndpointsOutput,
    crate::error::ListSharedEndpointsError,
> {
    Ok({
        ...
        let _ = response;
        output = crate::json_deser::deser_operation_crate_operation_list_shared_endpoints(
            response.body().as_ref(),
            output,
        )
        .map_err(crate::error::ListSharedEndpointsError::unhandled)?;
