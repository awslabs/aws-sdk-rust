...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_shared_endpoints::builders::ListSharedEndpointsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_shared_endpoints::builders::ListSharedEndpointsFluentBuilder::set_next_token): <p>If a previous response from this operation included a <code>NextToken</code> value, you can provide that value here to retrieve the next page of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_shared_endpoints::builders::ListSharedEndpointsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_shared_endpoints::builders::ListSharedEndpointsFluentBuilder::set_max_results): <p>The maximum number of endpoints that will be returned in the response.</p>
    ///   - [`outpost_id(impl ::std::convert::Into<String>)`](crate::operation::list_shared_endpoints::builders::ListSharedEndpointsFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::list_shared_endpoints::builders::ListSharedEndpointsFluentBuilder::set_outpost_id): <p>The ID of the Amazon Web Services Outpost.</p>
