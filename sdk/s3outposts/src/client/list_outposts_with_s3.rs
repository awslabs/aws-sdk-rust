...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_outposts_with_s3::builders::ListOutpostsWithS3FluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_outposts_with_s3::builders::ListOutpostsWithS3FluentBuilder::set_next_token): <p>When you can get additional results from the <code>ListOutpostsWithS3</code> call, a <code>NextToken</code> parameter is returned in the output. You can then pass in a subsequent command to the <code>NextToken</code> parameter to continue listing additional Outposts.</p>
    ///   - [`max_results(i32)`](crate::operation::list_outposts_with_s3::builders::ListOutpostsWithS3FluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_outposts_with_s3::builders::ListOutpostsWithS3FluentBuilder::set_max_results): <p>The maximum number of Outposts to return. The limit is 100.</p>
