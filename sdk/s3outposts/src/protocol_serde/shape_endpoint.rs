                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AccessType" => {
                            builder = builder.set_access_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::EndpointAccessType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "FailedReason" => {
                            builder = builder.set_failed_reason(crate::protocol_serde::shape_failed_reason::de_failed_reason(tokens)?);
                        }
