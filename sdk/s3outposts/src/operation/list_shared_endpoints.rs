    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/S3Outposts/ListSharedEndpoints")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_shared_endpoints::ListSharedEndpoints::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_shared_endpoints::ListSharedEndpointsError
{
