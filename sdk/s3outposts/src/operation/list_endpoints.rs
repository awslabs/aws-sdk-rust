    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/S3Outposts/ListEndpoints")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_endpoints::ListEndpoints::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_endpoints::de_list_endpoints_http_error(
                status, headers, body,
            )
        } else {
