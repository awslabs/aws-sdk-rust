...
/// For example, the [`CreateEndpoint`](crate::operation::create_endpoint) operation has
/// a [`Client::create_endpoint`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.create_endpoint()
///     .outpost_id("example")
///     .send()
///     .await;
/// ```
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_s3outposts::Error> {
/// # let client: aws_sdk_s3outposts::Client = unimplemented!();
