...
) -> std::result::Result<crate::output::cancel_key_deletion_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CancelKeyDeletionOutputBody = if input.is_empty() {
...
) -> std::result::Result<crate::output::create_custom_key_store_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::CreateCustomKeyStoreOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::create_grant_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CreateGrantOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::create_key_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::CreateKeyOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::decrypt_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DecryptOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::describe_custom_key_stores_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::DescribeCustomKeyStoresOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
    ...
    builder = builder.set_truncated(Some(parsed_body.truncated));
    Ok(builder)
}
...
) -> std::result::Result<crate::output::describe_key_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::DescribeKeyOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::encrypt_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::EncryptOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::generate_data_key_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GenerateDataKeyOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::generate_data_key_pair_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GenerateDataKeyPairOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::generate_random_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GenerateRandomOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::get_key_policy_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GetKeyPolicyOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::get_key_rotation_status_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::GetKeyRotationStatusOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
    ...
    builder = builder.set_key_rotation_enabled(Some(parsed_body.key_rotation_enabled));
    Ok(builder)
}
...
) -> std::result::Result<crate::output::get_parameters_for_import_output::Builder, serde_json::Error>
{
    let parsed_body: crate::serializer::GetParametersForImportOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::get_public_key_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::GetPublicKeyOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_grants_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListGrantsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_key_policies_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListKeyPoliciesOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_keys_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListKeysOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_resource_tags_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListResourceTagsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::list_retirable_grants_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ListRetirableGrantsOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::re_encrypt_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ReEncryptOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::schedule_key_deletion_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::ScheduleKeyDeletionOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
) -> std::result::Result<crate::output::sign_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::SignOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
...
pub fn verify_deser_operation(
...
) -> std::result::Result<crate::output::verify_output::Builder, serde_json::Error> {
    let parsed_body: crate::serializer::VerifyOutputBody = if input.is_empty() {
        // To enable JSON parsing to succeed, replace an empty body
        // with an empty JSON body. If a member was required, it will fail slightly later
        // during the operation construction phase when a required field was missing.
        serde_json::from_slice(b"{}")?
    ...
    builder = builder.set_key_id(parsed_body.key_id);
    builder = builder.set_signature_valid(Some(parsed_body.signature_valid));
    builder = builder.set_signing_algorithm(parsed_body.signing_algorithm);
    Ok(builder)
}
