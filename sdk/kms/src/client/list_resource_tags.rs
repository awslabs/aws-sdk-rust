...
impl super::Client {
    ...
    ///   - [`key_id(impl ::std::convert::Into<String>)`](crate::operation::list_resource_tags::builders::ListResourceTagsFluentBuilder::key_id) / [`set_key_id(Option<String>)`](crate::operation::list_resource_tags::builders::ListResourceTagsFluentBuilder::set_key_id): <p>Gets tags on the specified KMS key.</p>  <p>Specify the key ID or key ARN of the KMS key.</p>  <p>For example:</p>  <ul>   <li> <p>Key ID: <code>1234abcd-12ab-34cd-56ef-1234567890ab</code> </p> </li>   <li> <p>Key ARN: <code>arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</code> </p> </li>  </ul>  <p>To get the key ID and key ARN for a KMS key, use <code>ListKeys</code> or <code>DescribeKey</code>.</p>
    ///   - [`limit(i32)`](crate::operation::list_resource_tags::builders::ListResourceTagsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_resource_tags::builders::ListResourceTagsFluentBuilder::set_limit): <p>Use this parameter to specify the maximum number of items to return. When this value is present, KMS does not return more than the specified number of items, but it might return fewer.</p>  <p>This value is optional. If you include a value, it must be between 1 and 50, inclusive. If you do not include a value, it defaults to 50.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_resource_tags::builders::ListResourceTagsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_resource_tags::builders::ListResourceTagsFluentBuilder::set_marker): <p>Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of <code>NextMarker</code> from the truncated response you just received.</p>  <p>Do not attempt to construct this value. Use only the value of <code>NextMarker</code> from the truncated response you just received.</p>
