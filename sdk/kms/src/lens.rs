...
pub(crate) fn reflens_structure_crate_output_describe_custom_key_stores_output_next_marker(
...
pub(crate) fn reflens_structure_crate_output_list_resource_tags_output_next_marker(
...
pub(crate) fn reflens_structure_crate_output_list_retirable_grants_output_next_marker(
...
pub(crate) fn lens_structure_crate_output_describe_custom_key_stores_output_custom_key_stores(
    input: crate::output::DescribeCustomKeyStoresOutput,
...
pub(crate) fn lens_structure_crate_output_list_resource_tags_output_tags(
    input: crate::output::ListResourceTagsOutput,
...
pub(crate) fn lens_structure_crate_output_list_retirable_grants_output_grants(
    input: crate::output::ListRetirableGrantsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::GrantListEntry>> {
    let input = match input.grants {
        None => return None,
