...
pub struct VerifyOutput  {
    ...
    #[doc(hidden)]pub signature_valid: bool,
...
pub struct ReplicateKeyOutput  {
    ...
    #[doc(hidden)]pub replica_key_metadata: std::option::Option<crate::model::KeyMetadata>,
    /// <p>The key policy of the new replica key. The value is a key policy document in JSON format.</p>
    #[doc(hidden)]pub replica_policy: std::option::Option<std::string::String>,
    /// <p>The tags on the new replica key. The value is a list of tag key and tag value pairs.</p>
    #[doc(hidden)]pub replica_tags: std::option::Option<std::vec::Vec<crate::model::Tag>>,
}
...
pub mod replicate_key_output {
    ...
    impl Builder {
        ...
        /// <p>Displays details about the new replica key, including its Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN</a>) and <a href="https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html">Key states of KMS keys</a>. It also includes the ARN and Amazon Web Services Region of its primary key and other replica keys.</p>
        pub fn set_replica_key_metadata(mut self, input: std::option::Option<crate::model::KeyMetadata>) -> Self {
        ...
        /// <p>The tags on the new replica key. The value is a list of tag key and tag value pairs.</p>
        pub fn set_replica_tags(mut self, input: std::option::Option<std::vec::Vec<crate::model::Tag>>) -> Self {
...
pub struct ListRetirableGrantsOutput  {
    ...
    #[doc(hidden)]pub grants: std::option::Option<std::vec::Vec<crate::model::GrantListEntry>>,
...
pub mod list_retirable_grants_output {
    ...
    impl Builder {
        ...
        /// <p>A list of grants.</p>
        pub fn set_grants(mut self, input: std::option::Option<std::vec::Vec<crate::model::GrantListEntry>>) -> Self {
...
pub struct ListKeysOutput  {
    ...
    #[doc(hidden)]pub keys: std::option::Option<std::vec::Vec<crate::model::KeyListEntry>>,
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
    #[doc(hidden)]pub next_marker: std::option::Option<std::string::String>,
    /// <p>A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the <code>NextMarker</code> element in thisresponse to the <code>Marker</code> parameter in a subsequent request.</p>
    #[doc(hidden)]pub truncated: bool,
...
pub mod list_keys_output {
    ...
    impl Builder {
        ...
        /// <p>A list of KMS keys.</p>
        pub fn set_keys(mut self, input: std::option::Option<std::vec::Vec<crate::model::KeyListEntry>>) -> Self {
...
pub struct ListAliasesOutput  {
    ...
    #[doc(hidden)]pub aliases: std::option::Option<std::vec::Vec<crate::model::AliasListEntry>>,
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
    #[doc(hidden)]pub next_marker: std::option::Option<std::string::String>,
    /// <p>A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the <code>NextMarker</code> element in thisresponse to the <code>Marker</code> parameter in a subsequent request.</p>
    #[doc(hidden)]pub truncated: bool,
...
pub mod list_aliases_output {
    ...
    impl Builder {
        ...
        /// <p>A list of aliases.</p>
        pub fn set_aliases(mut self, input: std::option::Option<std::vec::Vec<crate::model::AliasListEntry>>) -> Self {
...
pub struct GetPublicKeyOutput  {
    ...
    /// <p></p>
    #[doc(hidden)]pub public_key: std::option::Option<aws_smithy_types::Blob>,
...
pub struct GetParametersForImportOutput  {
    ...
    #[doc(hidden)]pub parameters_valid_to: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct GetKeyRotationStatusOutput  {
    ...
    #[doc(hidden)]pub key_rotation_enabled: bool,
}
...
pub struct GenerateDataKeyPairWithoutPlaintextOutput  {
    ...
    #[doc(hidden)]pub private_key_ciphertext_blob: std::option::Option<aws_smithy_types::Blob>,
...
pub struct GenerateDataKeyPairOutput  {
    ...
    #[doc(hidden)]pub private_key_plaintext: std::option::Option<aws_smithy_types::Blob>,
    /// <p>The public key (in plaintext). When you use the HTTP API or the Amazon Web Services CLI, the value is Base64-encoded. Otherwise, it is not Base64-encoded.</p>
    #[doc(hidden)]pub public_key: std::option::Option<aws_smithy_types::Blob>,
    /// <p>The Amazon Resource Name (<a href="https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id-key-ARN">key ARN</a>) of the KMS key that encrypted the private key.</p>
    #[doc(hidden)]pub key_id: std::option::Option<std::string::String>,
...
pub struct DescribeKeyOutput  {
    ...
    #[doc(hidden)]pub key_metadata: std::option::Option<crate::model::KeyMetadata>,
}
...
pub mod describe_key_output {
    ...
    impl Builder {
        ...
        /// <p>Metadata associated with the key.</p>
        pub fn set_key_metadata(mut self, input: std::option::Option<crate::model::KeyMetadata>) -> Self {
...
pub struct DescribeCustomKeyStoresOutput  {
    ...
    #[doc(hidden)]pub custom_key_stores: std::option::Option<std::vec::Vec<crate::model::CustomKeyStoresListEntry>>,
    /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
    #[doc(hidden)]pub next_marker: std::option::Option<std::string::String>,
    /// <p>A flag that indicates whether there are more items in the list. When this value is true, the list in this response is truncated. To get more items, pass the value of the <code>NextMarker</code> element in thisresponse to the <code>Marker</code> parameter in a subsequent request.</p>
    #[doc(hidden)]pub truncated: bool,
...
impl DescribeCustomKeyStoresOutput {
    /// <p>Contains metadata about each custom key store.</p>
    pub fn custom_key_stores(&self) -> std::option::Option<& [crate::model::CustomKeyStoresListEntry]> {
...
pub mod describe_custom_key_stores_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) custom_key_stores: std::option::Option<std::vec::Vec<crate::model::CustomKeyStoresListEntry>>,
        pub(crate) next_marker: std::option::Option<std::string::String>,
        pub(crate) truncated: std::option::Option<bool>,
    }
    impl Builder {
        ...
        /// <p>Contains metadata about each custom key store.</p>
        pub fn set_custom_key_stores(mut self, input: std::option::Option<std::vec::Vec<crate::model::CustomKeyStoresListEntry>>) -> Self {
            self.custom_key_stores = input; self
        }
        /// <p>When <code>Truncated</code> is true, this element is present and contains the value to use for the <code>Marker</code> parameter in a subsequent request.</p>
        pub fn next_marker(mut self, input: impl Into<std::string::String>) -> Self {
            self.next_marker = Some(input.into());
