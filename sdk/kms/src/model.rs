...
pub struct KeyMetadata  {
    ...
    #[doc(hidden)]pub aws_account_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub key_usage: std::option::Option<crate::model::KeyUsageType>,
    ...
    #[doc(hidden)]pub key_state: std::option::Option<crate::model::KeyState>,
    ...
    #[doc(hidden)]pub deletion_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub valid_to: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub origin: std::option::Option<crate::model::OriginType>,
    ...
    #[doc(hidden)]pub custom_key_store_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub cloud_hsm_cluster_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub expiration_model: std::option::Option<crate::model::ExpirationModelType>,
    ...
    #[doc(hidden)]pub key_manager: std::option::Option<crate::model::KeyManagerType>,
    ...
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]#[doc(hidden)]pub customer_master_key_spec: std::option::Option<crate::model::CustomerMasterKeySpec>,
    /// <p>Describes the type of key material in the KMS key.</p>
    #[doc(hidden)]pub key_spec: std::option::Option<crate::model::KeySpec>,
    ...
    #[doc(hidden)]pub encryption_algorithms: std::option::Option<std::vec::Vec<crate::model::EncryptionAlgorithmSpec>>,
    ...
    #[doc(hidden)]pub signing_algorithms: std::option::Option<std::vec::Vec<crate::model::SigningAlgorithmSpec>>,
    ...
    #[doc(hidden)]pub multi_region: std::option::Option<bool>,
    ...
    /// </ul>
    #[doc(hidden)]pub multi_region_configuration: std::option::Option<crate::model::MultiRegionConfiguration>,
    ...
    #[doc(hidden)]pub pending_deletion_window_in_days: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub mac_algorithms: std::option::Option<std::vec::Vec<crate::model::MacAlgorithmSpec>>,
}
impl KeyMetadata {
    /// <p>The twelve-digit account ID of the Amazon Web Services account that owns the KMS key.</p>
    ...
    /// <p>Instead, use the <code>KeySpec</code> field.</p> 
    /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS will support both fields.</p>
    #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]pub fn customer_master_key_spec(&self) -> std::option::Option<& crate::model::CustomerMasterKeySpec> {
...
impl  std::fmt::Debug for KeyMetadata  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("multi_region_configuration", &self.multi_region_configuration);
        formatter.field("pending_deletion_window_in_days", &self.pending_deletion_window_in_days);
...
pub mod key_metadata {
    ...
    impl Builder {
        ...
        /// <p>Instead, use the <code>KeySpec</code> field.</p> 
        /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS will support both fields.</p>
        #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]pub fn customer_master_key_spec(mut self, input: crate::model::CustomerMasterKeySpec) -> Self {
            self.customer_master_key_spec = Some(input);
            self
        }
        /// <p>Instead, use the <code>KeySpec</code> field.</p> 
        /// <p>The <code>KeySpec</code> and <code>CustomerMasterKeySpec</code> fields have the same value. We recommend that you use the <code>KeySpec</code> field in your code. However, to avoid breaking changes, KMS will support both fields.</p>
        #[deprecated(note = "This field has been deprecated. Instead, use the KeySpec field.")]pub fn set_customer_master_key_spec(mut self, input: std::option::Option<crate::model::CustomerMasterKeySpec>) -> Self {
...
pub struct MultiRegionConfiguration  {
    ...
    #[doc(hidden)]pub multi_region_key_type: std::option::Option<crate::model::MultiRegionKeyType>,
    /// <p>Displays the key ARN and Region of the primary key. This field includes the current KMS key if it is the primary key.</p>
    #[doc(hidden)]pub primary_key: std::option::Option<crate::model::MultiRegionKey>,
    /// <p>displays the key ARNs and Regions of all replica keys. This field includes the current KMS key if it is a replica key.</p>
    #[doc(hidden)]pub replica_keys: std::option::Option<std::vec::Vec<crate::model::MultiRegionKey>>,
}
...
#[allow(missing_docs)] // documentation missing in model
#[deprecated(note = "This enum has been deprecated. Instead, use the KeySpec enum.")]#[non_exhaustive]#[derive(std::clone::Clone, std::cmp::Eq, std::cmp::Ord, std::cmp::PartialEq, std::cmp::PartialOrd, std::fmt::Debug, std::hash::Hash, )]
...
pub struct GrantListEntry  {
    ...
    #[doc(hidden)]pub grant_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub grantee_principal: std::option::Option<std::string::String>,
    /// <p>The principal that can retire the grant.</p>
    #[doc(hidden)]pub retiring_principal: std::option::Option<std::string::String>,
    /// <p>The Amazon Web Services account under which the grant was issued.</p>
    #[doc(hidden)]pub issuing_account: std::option::Option<std::string::String>,
    /// <p>The list of operations permitted by the grant.</p>
    #[doc(hidden)]pub operations: std::option::Option<std::vec::Vec<crate::model::GrantOperation>>,
    ...
    #[doc(hidden)]pub constraints: std::option::Option<crate::model::GrantConstraints>,
}
impl GrantListEntry {
    /// <p>The unique identifier for the KMS key to which the grant applies.</p>
    pub fn key_id(&self) -> std::option::Option<& str> {
...
pub struct GrantConstraints  {
    ...
    #[doc(hidden)]pub encryption_context_subset: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub encryption_context_equals: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct KeyListEntry  {
    ...
    #[doc(hidden)]pub key_id: std::option::Option<std::string::String>,
    /// <p>ARN of the key.</p>
    #[doc(hidden)]pub key_arn: std::option::Option<std::string::String>,
}
impl KeyListEntry {
    /// <p>Unique identifier of the key.</p>
    pub fn key_id(&self) -> std::option::Option<& str> {
...
pub struct AliasListEntry  {
    ...
    #[doc(hidden)]pub alias_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub target_key_id: std::option::Option<std::string::String>,
...
pub struct CustomKeyStoresListEntry  {
    ...
    #[doc(hidden)]pub custom_key_store_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub trust_anchor_certificate: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub connection_state: std::option::Option<crate::model::ConnectionStateType>,
    ...
    /// </ul>
    #[doc(hidden)]pub connection_error_code: std::option::Option<crate::model::ConnectionErrorCodeType>,
...
impl ConnectionErrorCodeType {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "CLUSTER_NOT_FOUND", "INSUFFICIENT_CLOUDHSM_HSMS", "INSUFFICIENT_FREE_ADDRESSES_IN_SUBNET", "INTERNAL_ERROR", "INVALID_CREDENTIALS", "NETWORK_ERRORS", "SUBNET_NOT_FOUND", "USER_LOCKED_OUT", "USER_LOGGED_IN", "USER_NOT_FOUND"
        ]
    }
}
