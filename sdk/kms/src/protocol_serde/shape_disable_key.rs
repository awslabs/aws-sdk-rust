...
pub fn de_disable_key_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_key::DisableKeyOutput, crate::operation::disable_key::DisableKeyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::disable_key::DisableKeyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_key_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_key::DisableKeyOutput, crate::operation::disable_key::DisableKeyError> {
    Ok({
        #[allow(unused_mut)]
