...
pub fn de_describe_custom_key_stores_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresOutput, crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_custom_key_stores_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresOutput, crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError> {
    Ok({
        #[allow(unused_mut)]
