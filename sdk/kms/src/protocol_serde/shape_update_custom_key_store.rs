...
pub fn de_update_custom_key_store_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_custom_key_store::UpdateCustomKeyStoreOutput, crate::operation::update_custom_key_store::UpdateCustomKeyStoreError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_custom_key_store_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_custom_key_store::UpdateCustomKeyStoreOutput, crate::operation::update_custom_key_store::UpdateCustomKeyStoreError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_custom_key_store_input(input: &crate::operation::update_custom_key_store::UpdateCustomKeyStoreInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
