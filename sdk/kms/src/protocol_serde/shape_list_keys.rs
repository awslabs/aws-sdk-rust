        ...
        "DependencyTimeoutException" => {
            crate::operation::list_keys::ListKeysError::DependencyTimeoutException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_dependency_timeout_exception::de_dependency_timeout_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_keys::ListKeysError::unhandled)?;
        ...
        "InvalidMarkerException" => {
            crate::operation::list_keys::ListKeysError::InvalidMarkerException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_marker_exception::de_invalid_marker_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_keys::ListKeysError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "KMSInternalException" => {
            crate::operation::list_keys::ListKeysError::KmsInternalException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_kms_internal_exception::de_kms_internal_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_keys::ListKeysError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        match tokens.next().transpose()? {
            ...
            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    "Keys" => {
                        builder = builder
                            .set_keys(crate::protocol_serde::shape_key_list::de_key_list(tokens)?);
                    }
                    "NextMarker" => {
