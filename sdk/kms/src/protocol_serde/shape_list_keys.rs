        ...
        "DependencyTimeoutException" => {
            crate::operation::list_keys::ListKeysError::DependencyTimeoutException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_dependency_timeout_exception::de_dependency_timeout_exception_json_err(_response_body, output).map_err(crate::operation::list_keys::ListKeysError::unhandled)?;
        ...
        "InvalidMarkerException" => {
            crate::operation::list_keys::ListKeysError::InvalidMarkerException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_invalid_marker_exception::de_invalid_marker_exception_json_err(_response_body, output).map_err(crate::operation::list_keys::ListKeysError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "KMSInternalException" => {
            crate::operation::list_keys::ListKeysError::KmsInternalException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_kms_internal_exception::de_kms_internal_exception_json_err(_response_body, output).map_err(crate::operation::list_keys::ListKeysError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
