...
pub fn ser_create_grant_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGrantInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
