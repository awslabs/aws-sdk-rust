...
pub fn ser_list_grants_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_grants::ListGrantsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
