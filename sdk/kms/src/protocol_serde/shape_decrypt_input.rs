...
pub fn ser_decrypt_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DecryptInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
