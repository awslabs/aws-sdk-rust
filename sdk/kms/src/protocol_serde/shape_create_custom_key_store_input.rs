...
pub fn ser_create_custom_key_store_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_custom_key_store::CreateCustomKeyStoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
