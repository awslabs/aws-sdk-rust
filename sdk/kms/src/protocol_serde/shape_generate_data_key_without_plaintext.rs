...
> {
    ...
    Err(match error_code {
        "DependencyTimeoutException" => {
            crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextError::DependencyTimeoutException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_generate_data_key_without_plaintext::de_generate_data_key_without_plaintext(_response_body, output)
            .map_err(crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextError::unhandled)?;
...
pub(crate) fn de_generate_data_key_without_plaintext(
    value: &[u8],
    mut builder: crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextOutputBuilder,
) -> ::std::result::Result<
    crate::operation::generate_data_key_without_plaintext::builders::GenerateDataKeyWithoutPlaintextOutputBuilder,
