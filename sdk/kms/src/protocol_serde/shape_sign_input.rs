...
pub fn ser_sign_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SignInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
