...
pub fn ser_update_custom_key_store_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_custom_key_store::UpdateCustomKeyStoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
