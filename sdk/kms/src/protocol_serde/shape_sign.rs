...
pub fn de_sign_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::sign::SignOutput, crate::operation::sign::SignError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::sign::SignError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_sign_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::sign::SignOutput, crate::operation::sign::SignError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::sign::builders::SignOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_sign::de_sign(response.body().as_ref(), output).map_err(crate::operation::sign::SignError::unhandled)?;
