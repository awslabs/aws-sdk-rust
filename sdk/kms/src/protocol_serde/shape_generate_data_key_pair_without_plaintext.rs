...
pub fn ser_generate_data_key_pair_without_plaintext_input(
    ...
    crate::protocol_serde::shape_generate_data_key_pair_without_plaintext_input::ser_generate_data_key_pair_without_plaintext_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_generate_data_key_pair_without_plaintext_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
