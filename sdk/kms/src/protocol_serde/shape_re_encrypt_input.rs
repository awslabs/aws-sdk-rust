...
pub fn ser_re_encrypt_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::re_encrypt::ReEncryptInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
