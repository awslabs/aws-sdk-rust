...
pub fn ser_generate_data_key_pair_without_plaintext_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
