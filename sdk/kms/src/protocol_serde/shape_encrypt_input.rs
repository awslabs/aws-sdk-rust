...
pub fn ser_encrypt_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::encrypt::EncryptInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
