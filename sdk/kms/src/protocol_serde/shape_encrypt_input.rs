...
pub fn ser_encrypt_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EncryptInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
