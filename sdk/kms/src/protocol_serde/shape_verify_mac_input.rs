...
pub fn ser_verify_mac_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::verify_mac::VerifyMacInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
