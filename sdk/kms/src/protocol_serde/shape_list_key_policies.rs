...
pub fn de_list_key_policies_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_key_policies::ListKeyPoliciesOutput, crate::operation::list_key_policies::ListKeyPoliciesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_key_policies::ListKeyPoliciesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_key_policies_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_key_policies::ListKeyPoliciesOutput, crate::operation::list_key_policies::ListKeyPoliciesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_key_policies::builders::ListKeyPoliciesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_key_policies::de_list_key_policies(response.body().as_ref(), output).map_err(crate::operation::list_key_policies::ListKeyPoliciesError::unhandled)?;
