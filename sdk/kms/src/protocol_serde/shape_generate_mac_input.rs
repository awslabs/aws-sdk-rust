...
pub fn ser_generate_mac_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::generate_mac::GenerateMacInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
