...
pub fn ser_generate_mac_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateMacInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
