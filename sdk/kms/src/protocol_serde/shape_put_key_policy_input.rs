...
pub fn ser_put_key_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::put_key_policy::PutKeyPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
