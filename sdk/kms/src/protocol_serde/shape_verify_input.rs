...
pub fn ser_verify_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::VerifyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
