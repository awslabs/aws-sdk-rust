...
pub fn ser_list_retirable_grants_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRetirableGrantsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
