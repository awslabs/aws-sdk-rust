...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_key_deletion_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_key_deletion::CancelKeyDeletionOutput, crate::operation::cancel_key_deletion::CancelKeyDeletionError> {
    Ok({
        #[allow(unused_mut)]
