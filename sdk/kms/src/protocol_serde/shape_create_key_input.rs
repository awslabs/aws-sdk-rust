...
pub fn ser_create_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_key::CreateKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
