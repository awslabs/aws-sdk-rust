...
pub fn ser_create_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
