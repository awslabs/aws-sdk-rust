...
pub fn ser_generate_data_key_without_plaintext_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateDataKeyWithoutPlaintextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
