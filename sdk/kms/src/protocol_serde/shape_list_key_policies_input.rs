...
pub fn ser_list_key_policies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListKeyPoliciesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
