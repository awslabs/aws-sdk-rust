...
pub fn ser_list_key_policies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_key_policies::ListKeyPoliciesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
