...
pub fn ser_generate_data_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateDataKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
