...
pub fn ser_grant_constraints(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GrantConstraints) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_grant_constraints<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GrantConstraints>, aws_smithy_json::deserialize::error::DeserializeError>
