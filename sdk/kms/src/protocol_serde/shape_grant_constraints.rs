...
pub fn ser_grant_constraints(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GrantConstraints) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
