...
pub fn ser_list_resource_tags_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_resource_tags::ListResourceTagsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
