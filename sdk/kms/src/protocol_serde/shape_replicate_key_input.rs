...
pub fn ser_replicate_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ReplicateKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
