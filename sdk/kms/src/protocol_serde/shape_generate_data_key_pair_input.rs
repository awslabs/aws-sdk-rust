...
pub fn ser_generate_data_key_pair_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::generate_data_key_pair::GenerateDataKeyPairInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
