...
pub(crate) fn de_custom_key_stores_list_entry<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CustomKeyStoresListEntry>, aws_smithy_json::deserialize::error::DeserializeError>
