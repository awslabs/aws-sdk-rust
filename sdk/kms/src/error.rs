...
impl aws_http::request_id::RequestId for crate::error::XksProxyVpcEndpointServiceInvalidConfigurationException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::XksProxyIncorrectAuthenticationCredentialException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::CloudHsmClusterInvalidConfigurationException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for GenerateDataKeyWithoutPlaintextError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DependencyTimeoutException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
