...
impl EnableKeyRotationInput {
    /// Consumes the builder and constructs an Operation<[`EnableKeyRotation`](crate::operation::enable_key_rotation::EnableKeyRotation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_key_rotation::EnableKeyRotation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_key_rotation::EnableKeyRotationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_key_rotation::EnableKeyRotation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EnableKeyRotation {
                type Output = std::result::Result<crate::operation::enable_key_rotation::EnableKeyRotationOutput, crate::operation::enable_key_rotation::EnableKeyRotationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_enable_key_rotation::de_enable_key_rotation_http_error(response)
                     } else {
                        crate::protocol_serde::shape_enable_key_rotation::de_enable_key_rotation_http_response(response)
                     }
                }
            }
