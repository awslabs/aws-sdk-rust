...
impl EnableKeyRotationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_enable_key_rotation::ser_enable_key_rotation_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableKeyRotation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_key_rotation::de_enable_key_rotation_http_response_with_props(status, headers, body)
        }
    }
}
