...
impl GetPublicKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_public_key::GetPublicKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_public_key::ser_get_public_key_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPublicKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_public_key::de_get_public_key_http_response_with_props(status, headers, body)
        }
    }
}
