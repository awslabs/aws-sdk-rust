...
impl GetPublicKeyInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_public_key::GetPublicKey,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_public_key::GetPublicKey::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetPublicKey {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_public_key::de_get_public_key_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_public_key::de_get_public_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
