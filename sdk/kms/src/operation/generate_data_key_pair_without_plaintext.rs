...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateDataKeyPairWithoutPlaintext {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_data_key_pair_without_plaintext::de_generate_data_key_pair_without_plaintext_http_response_with_props(status, headers, body)
        }
    }
}
