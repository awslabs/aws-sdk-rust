...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateDataKeyPairWithoutPlaintext {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GenerateDataKeyPairWithoutPlaintext", "kms"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateDataKeyPairWithoutPlaintext")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GenerateDataKeyPairWithoutPlaintextResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GenerateDataKeyPairWithoutPlaintextRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GenerateDataKeyPairWithoutPlaintextEndpointParamsInterceptor {
