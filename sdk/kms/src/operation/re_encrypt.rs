...
impl ReEncryptInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::re_encrypt::ReEncrypt, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_re_encrypt::ser_re_encrypt_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReEncrypt {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_re_encrypt::de_re_encrypt_http_response_with_props(status, headers, body)
        }
    }
}
