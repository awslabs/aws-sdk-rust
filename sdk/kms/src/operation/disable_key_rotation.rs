...
impl DisableKeyRotationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disable_key_rotation::ser_disable_key_rotation_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableKeyRotation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_key_rotation::de_disable_key_rotation_http_response_with_props(status, headers, body)
        }
    }
}
