...
impl DisableKeyRotationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_key_rotation::DisableKeyRotation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_key_rotation::DisableKeyRotationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_key_rotation::ser_disable_key_rotation_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_key_rotation::DisableKeyRotation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisableKeyRotation {
                type Output = std::result::Result<crate::operation::disable_key_rotation::DisableKeyRotationOutput, crate::operation::disable_key_rotation::DisableKeyRotationError>;
