...
impl ReplicateKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::replicate_key::ReplicateKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_replicate_key::ser_replicate_key_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplicateKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replicate_key::de_replicate_key_http_response_with_props(status, headers, body)
        }
    }
}
