...
impl ReplicateKeyFluentBuilder  {
    /// Creates a new `ReplicateKey`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::replicate_key::ReplicateKeyOutput, aws_smithy_http::result::SdkError<crate::operation::replicate_key::ReplicateKeyError>>
                     {
