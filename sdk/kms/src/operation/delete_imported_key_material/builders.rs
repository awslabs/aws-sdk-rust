...
impl DeleteImportedKeyMaterialFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_imported_key_material::DeleteImportedKeyMaterialOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_imported_key_material::DeleteImportedKeyMaterialError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_imported_key_material::DeleteImportedKeyMaterialOutput, crate::operation::delete_imported_key_material::DeleteImportedKeyMaterialError, Self> {
