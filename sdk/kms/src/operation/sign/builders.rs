...
impl SignInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::sign::SignError, ::aws_smithy_http::operation::Response>,
    > {
...
impl SignFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::sign::SignOutput, ::aws_smithy_http::result::SdkError<crate::operation::sign::SignError>> {
        let op = self
            .inner
            .build()
            .map_err(::aws_smithy_http::result::SdkError::construction_failure)?
