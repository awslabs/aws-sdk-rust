...
impl GenerateDataKeyWithoutPlaintextInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintextInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
