...
impl DeleteImportedKeyMaterialInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_imported_key_material::DeleteImportedKeyMaterial::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImportedKeyMaterial {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_imported_key_material::de_delete_imported_key_material_http_response_with_props(status, headers, body)
        }
    }
}
