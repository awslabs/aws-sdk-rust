...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeKey {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeKey", "kms"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeKeyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_key::ser_describe_key_input(&input)?);
