...
impl GenerateRandomInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::generate_random::GenerateRandom, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_generate_random::ser_generate_random_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateRandom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_random::de_generate_random_http_response_with_props(status, headers, body)
        }
    }
