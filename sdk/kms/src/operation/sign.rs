...
impl SignInput {
    /// Consumes the builder and constructs an Operation<[`Sign`](crate::operation::sign::Sign)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::sign::Sign, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::sign::SignInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::sign::Sign::new())
...
impl aws_smithy_http::response::ParseStrictResponse for Sign {
                type Output = std::result::Result<crate::operation::sign::SignOutput, crate::operation::sign::SignError>;
