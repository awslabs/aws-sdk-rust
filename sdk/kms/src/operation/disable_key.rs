...
impl DisableKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disable_key::DisableKey,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_key::DisableKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_disable_key::de_disable_key_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_disable_key::de_disable_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
