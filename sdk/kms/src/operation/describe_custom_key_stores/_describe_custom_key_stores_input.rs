...
impl DescribeCustomKeyStoresInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresInput, ::aws_smithy_types::error::operation::BuildError> {
