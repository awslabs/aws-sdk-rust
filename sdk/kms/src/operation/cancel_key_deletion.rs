...
impl CancelKeyDeletionInput {
    /// Consumes the builder and constructs an Operation<[`CancelKeyDeletion`](crate::operation::cancel_key_deletion::CancelKeyDeletion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_key_deletion::CancelKeyDeletion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_key_deletion::CancelKeyDeletionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_key_deletion::CancelKeyDeletion::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CancelKeyDeletion {
                type Output = std::result::Result<crate::operation::cancel_key_deletion::CancelKeyDeletionOutput, crate::operation::cancel_key_deletion::CancelKeyDeletionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_response(response)
                     }
                }
            }
