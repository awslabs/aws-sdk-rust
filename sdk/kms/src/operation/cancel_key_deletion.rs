...
impl CancelKeyDeletionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_key_deletion::ser_cancel_key_deletion_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelKeyDeletion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion_http_response_with_props(status, headers, body)
        }
    }
}
