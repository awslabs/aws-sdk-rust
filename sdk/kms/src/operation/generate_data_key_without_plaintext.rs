...
impl GenerateDataKeyWithoutPlaintextInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_data_key_without_plaintext::GenerateDataKeyWithoutPlaintext::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateDataKeyWithoutPlaintext {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_data_key_without_plaintext::de_generate_data_key_without_plaintext_http_response_with_props(
                status, headers, body,
            )
        }
    }
