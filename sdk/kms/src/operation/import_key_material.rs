...
impl ImportKeyMaterialInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::import_key_material::ImportKeyMaterial, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_key_material::ImportKeyMaterialInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::import_key_material::ImportKeyMaterial::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ImportKeyMaterial {
                type Output = std::result::Result<crate::operation::import_key_material::ImportKeyMaterialOutput, crate::operation::import_key_material::ImportKeyMaterialError>;
