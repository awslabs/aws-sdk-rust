...
impl EncryptInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::encrypt::Encrypt, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_encrypt::ser_encrypt_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for Encrypt {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_encrypt::de_encrypt_http_response_with_props(status, headers, body)
        }
    }
}
