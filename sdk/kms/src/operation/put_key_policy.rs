...
impl PutKeyPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_key_policy::PutKeyPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_key_policy::ser_put_key_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutKeyPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_key_policy::de_put_key_policy_http_response_with_props(status, headers, body)
        }
    }
}
