...
impl RevokeGrantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::revoke_grant::RevokeGrant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_revoke_grant::ser_revoke_grant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeGrant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_grant::de_revoke_grant_http_response_with_props(status, headers, body)
        }
    }
}
