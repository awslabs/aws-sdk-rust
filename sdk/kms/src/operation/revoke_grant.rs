...
impl RevokeGrantInput {
    /// Consumes the builder and constructs an Operation<[`RevokeGrant`](crate::operation::revoke_grant::RevokeGrant)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::revoke_grant::RevokeGrant, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_grant::RevokeGrantInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_grant::RevokeGrant::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RevokeGrant {
                type Output = std::result::Result<crate::operation::revoke_grant::RevokeGrantOutput, crate::operation::revoke_grant::RevokeGrantError>;
