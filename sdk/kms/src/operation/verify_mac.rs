...
impl VerifyMacInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::verify_mac::VerifyMac, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_verify_mac::ser_verify_mac_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyMac {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_verify_mac::de_verify_mac_http_response_with_props(status, headers, body)
        }
    }
}
