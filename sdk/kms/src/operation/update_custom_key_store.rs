...
impl UpdateCustomKeyStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_custom_key_store::UpdateCustomKeyStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCustomKeyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_custom_key_store::de_update_custom_key_store_http_response_with_props(status, headers, body)
        }
    }
}
