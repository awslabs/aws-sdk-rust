...
impl GenerateDataKeyPairWithoutPlaintextInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextInput, ::aws_smithy_types::error::operation::BuildError> {
