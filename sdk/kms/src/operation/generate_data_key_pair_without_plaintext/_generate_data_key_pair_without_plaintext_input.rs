...
impl GenerateDataKeyPairWithoutPlaintextInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::generate_data_key_pair_without_plaintext::GenerateDataKeyPairWithoutPlaintextInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
