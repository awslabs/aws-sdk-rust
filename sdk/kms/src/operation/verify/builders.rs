...
impl VerifyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::verify::VerifyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::verify::VerifyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
