...
impl DisconnectCustomKeyStoreInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStore::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisconnectCustomKeyStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disconnect_custom_key_store::de_disconnect_custom_key_store_http_response_with_props(status, headers, body)
        }
    }
}
