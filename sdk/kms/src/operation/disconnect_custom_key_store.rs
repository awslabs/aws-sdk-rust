...
impl DisconnectCustomKeyStore {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisconnectCustomKeyStore {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisconnectCustomKeyStore");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisconnectCustomKeyStoreRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisconnectCustomKeyStoreResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisconnectCustomKeyStore")
...
.with_interceptor(DisconnectCustomKeyStoreEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreError>::new());
...
#[derive(Debug)]
            struct DisconnectCustomKeyStoreResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisconnectCustomKeyStoreResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disconnect_custom_key_store::de_disconnect_custom_key_store_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disconnect_custom_key_store::de_disconnect_custom_key_store_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisconnectCustomKeyStoreRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisconnectCustomKeyStoreRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disconnect_custom_key_store::DisconnectCustomKeyStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disconnect_custom_key_store::ser_disconnect_custom_key_store_input(&input)?);
...
#[derive(Debug)]
            struct DisconnectCustomKeyStoreEndpointParamsInterceptor;
...
pub enum DisconnectCustomKeyStoreError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisconnectCustomKeyStoreError) for what information is available for the error.")]
...
impl DisconnectCustomKeyStoreError {
    /// Creates the `DisconnectCustomKeyStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisconnectCustomKeyStoreError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisconnectCustomKeyStoreError {
