...
impl DescribeCustomKeyStoresInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCustomKeyStores`](crate::operation::describe_custom_key_stores::DescribeCustomKeyStores)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_custom_key_stores::DescribeCustomKeyStores, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_custom_key_stores::DescribeCustomKeyStores::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCustomKeyStores {
                type Output = std::result::Result<crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresOutput, crate::operation::describe_custom_key_stores::DescribeCustomKeyStoresError>;
