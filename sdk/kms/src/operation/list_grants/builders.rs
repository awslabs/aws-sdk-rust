...
impl ListGrantsFluentBuilder  {
    /// Creates a new `ListGrants`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_grants::ListGrantsOutput, aws_smithy_http::result::SdkError<crate::operation::list_grants::ListGrantsError>>
                     {
