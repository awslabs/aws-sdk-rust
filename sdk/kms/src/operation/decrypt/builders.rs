...
impl DecryptInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::decrypt::DecryptError, ::aws_smithy_http::operation::Response>,
    > {
...
impl DecryptFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::decrypt::DecryptOutput, ::aws_smithy_http::result::SdkError<crate::operation::decrypt::DecryptError>>
    {
        let op = self
            .inner
            .build()
