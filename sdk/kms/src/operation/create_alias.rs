...
impl CreateAliasInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_alias::CreateAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_alias::de_create_alias_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_alias::de_create_alias_http_response_with_props(
                status, headers, body,
            )
        }
    }
