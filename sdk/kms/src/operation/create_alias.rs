...
impl CreateAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_alias::CreateAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_alias::ser_create_alias_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_alias::de_create_alias_http_response_with_props(status, headers, body)
        }
    }
}
