...
impl ListResourceTagsFluentBuilder  {
    /// Creates a new `ListResourceTags`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_resource_tags::ListResourceTagsOutput, aws_smithy_http::result::SdkError<crate::operation::list_resource_tags::ListResourceTagsError>>
                     {
