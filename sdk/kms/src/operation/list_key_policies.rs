...
impl ListKeyPoliciesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_key_policies::ListKeyPolicies, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_key_policies::ser_list_key_policies_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListKeyPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_key_policies::de_list_key_policies_http_response_with_props(status, headers, body)
        }
    }
}
