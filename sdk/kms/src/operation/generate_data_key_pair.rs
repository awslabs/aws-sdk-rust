...
impl GenerateDataKeyPairInput {
    /// Consumes the builder and constructs an Operation<[`GenerateDataKeyPair`](crate::operation::generate_data_key_pair::GenerateDataKeyPair)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_data_key_pair::GenerateDataKeyPair, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_data_key_pair::GenerateDataKeyPairInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_data_key_pair::ser_generate_data_key_pair_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_data_key_pair::GenerateDataKeyPair::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateDataKeyPair {
                type Output = std::result::Result<crate::operation::generate_data_key_pair::GenerateDataKeyPairOutput, crate::operation::generate_data_key_pair::GenerateDataKeyPairError>;
