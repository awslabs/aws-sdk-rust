    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AddTagsToStreamInput`](crate::input::AddTagsToStreamInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::AddTagsToStreamInput::stream_name): <p>The name of the stream.</p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::AddTagsToStreamInput::tags): <p>A set of up to 10 key-value pairs to use to create the tags.</p>
    ...
    ///   - [`stream_name(Option<String>)`](crate::input::CreateStreamInput::stream_name): <p>A name to identify the stream. The stream name is scoped to the Amazon Web Services account used by the application that creates the stream. It is also scoped by Amazon Web Services Region. That is, two streams in two different Amazon Web Services accounts can have the same name. Two streams in the same Amazon Web Services account but in two different Regions can also have the same name.</p>
    ///   - [`shard_count(Option<i32>)`](crate::input::CreateStreamInput::shard_count): <p>The number of shards that the stream will use. The throughput of the stream is a function of the number of shards; more shards are required for greater provisioned throughput.</p>
    ///   - [`stream_mode_details(Option<StreamModeDetails>)`](crate::input::CreateStreamInput::stream_mode_details): <p> Indicates the capacity mode of the data stream. Currently, in Kinesis Data Streams, you can choose between an <b>on-demand</b> capacity mode and a <b>provisioned</b> capacity mode for your data streams.</p>
    ...
    ///
    /// - Takes [`DecreaseStreamRetentionPeriodInput`](crate::input::DecreaseStreamRetentionPeriodInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::DecreaseStreamRetentionPeriodInput::stream_name): <p>The name of the stream to modify.</p>
    ///   - [`retention_period_hours(Option<i32>)`](crate::input::DecreaseStreamRetentionPeriodInput::retention_period_hours): <p>The new retention period of the stream, in hours. Must be less than the current retention period.</p>
    ...
    ///   - [`stream_name(Option<String>)`](crate::input::DeleteStreamInput::stream_name): <p>The name of the stream to delete.</p>
    ///   - [`enforce_consumer_deletion(Option<bool>)`](crate::input::DeleteStreamInput::enforce_consumer_deletion): <p>If this parameter is unset (<code>null</code>) or if you set it to <code>false</code>, and the stream has registered consumers, the call to <code>DeleteStream</code> fails with a <code>ResourceInUseException</code>. </p>
    ...
    ///
    /// - Takes [`DeregisterStreamConsumerInput`](crate::input::DeregisterStreamConsumerInput) with field(s):
    ///   - [`stream_arn(Option<String>)`](crate::input::DeregisterStreamConsumerInput::stream_arn): <p>The ARN of the Kinesis data stream that the consumer is registered with. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams">Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces</a>.</p>
    ///   - [`consumer_name(Option<String>)`](crate::input::DeregisterStreamConsumerInput::consumer_name): <p>The name that you gave to the consumer.</p>
    ///   - [`consumer_arn(Option<String>)`](crate::input::DeregisterStreamConsumerInput::consumer_arn): <p>The ARN returned by Kinesis Data Streams when you registered the consumer. If you don't know the ARN of the consumer that you want to deregister, you can use the ListStreamConsumers operation to get a list of the descriptions of all the consumers that are currently registered with a given data stream. The description of a consumer contains its ARN.</p>
    ...
    ///   - [`stream_name(Option<String>)`](crate::input::DescribeStreamInput::stream_name): <p>The name of the stream to describe.</p>
    ///   - [`limit(Option<i32>)`](crate::input::DescribeStreamInput::limit): <p>The maximum number of shards to return in a single call. The default value is 100. If you specify a value greater than 100, at most 100 results are returned.</p>
    ///   - [`exclusive_start_shard_id(Option<String>)`](crate::input::DescribeStreamInput::exclusive_start_shard_id): <p>The shard ID of the shard to start with.</p>  <p>Specify this parameter to indicate that you want to describe the stream starting with the shard whose ID immediately follows <code>ExclusiveStartShardId</code>.</p>  <p>If you don't specify this parameter, the default behavior for <code>DescribeStream</code> is to describe the stream starting with the first shard in the stream.</p>
    ...
    ///
    /// - Takes [`DescribeStreamConsumerInput`](crate::input::DescribeStreamConsumerInput) with field(s):
    ///   - [`stream_arn(Option<String>)`](crate::input::DescribeStreamConsumerInput::stream_arn): <p>The ARN of the Kinesis data stream that the consumer is registered with. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams">Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces</a>.</p>
    ///   - [`consumer_name(Option<String>)`](crate::input::DescribeStreamConsumerInput::consumer_name): <p>The name that you gave to the consumer.</p>
    ///   - [`consumer_arn(Option<String>)`](crate::input::DescribeStreamConsumerInput::consumer_arn): <p>The ARN returned by Kinesis Data Streams when you registered the consumer.</p>
    ...
    ///
    /// - Takes [`DescribeStreamSummaryInput`](crate::input::DescribeStreamSummaryInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::DescribeStreamSummaryInput::stream_name): <p>The name of the stream to describe.</p>
    ...
    ///
    /// - Takes [`EnableEnhancedMonitoringInput`](crate::input::EnableEnhancedMonitoringInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::EnableEnhancedMonitoringInput::stream_name): <p>The name of the stream for which to enable enhanced monitoring.</p>
    ///   - [`shard_level_metrics(Option<Vec<MetricsName>>)`](crate::input::EnableEnhancedMonitoringInput::shard_level_metrics): <p>List of shard-level metrics to enable.</p>  <p>The following are the valid shard-level metrics. The value "<code>ALL</code>" enables every metric.</p>  <ul>   <li> <p> <code>IncomingBytes</code> </p> </li>   <li> <p> <code>IncomingRecords</code> </p> </li>   <li> <p> <code>OutgoingBytes</code> </p> </li>   <li> <p> <code>OutgoingRecords</code> </p> </li>   <li> <p> <code>WriteProvisionedThroughputExceeded</code> </p> </li>   <li> <p> <code>ReadProvisionedThroughputExceeded</code> </p> </li>   <li> <p> <code>IteratorAgeMilliseconds</code> </p> </li>   <li> <p> <code>ALL</code> </p> </li>  </ul>  <p>For more information, see <a href="https://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html">Monitoring the Amazon Kinesis Data Streams Service with Amazon CloudWatch</a> in the <i>Amazon Kinesis Data Streams Developer Guide</i>.</p>
    ...
    ///
    /// - Takes [`GetRecordsInput`](crate::input::GetRecordsInput) with field(s):
    ///   - [`shard_iterator(Option<String>)`](crate::input::GetRecordsInput::shard_iterator): <p>The position in the shard from which you want to start sequentially reading data records. A shard iterator specifies this position using the sequence number of a data record in the shard.</p>
    ///   - [`limit(Option<i32>)`](crate::input::GetRecordsInput::limit): <p>The maximum number of records to return. Specify a value of up to 10,000. If you specify a value that is greater than 10,000, <code>GetRecords</code> throws <code>InvalidArgumentException</code>. The default value is 10,000.</p>
    ...
    ///
    /// - Takes [`IncreaseStreamRetentionPeriodInput`](crate::input::IncreaseStreamRetentionPeriodInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::IncreaseStreamRetentionPeriodInput::stream_name): <p>The name of the stream to modify.</p>
    ///   - [`retention_period_hours(Option<i32>)`](crate::input::IncreaseStreamRetentionPeriodInput::retention_period_hours): <p>The new retention period of the stream, in hours. Must be more than the current retention period.</p>
    ...
    ///   - [`limit(Option<i32>)`](crate::input::ListStreamsInput::limit): <p>The maximum number of streams to list. The default value is 100. If you specify a value greater than 100, at most 100 results are returned.</p>
    ///   - [`exclusive_start_stream_name(Option<String>)`](crate::input::ListStreamsInput::exclusive_start_stream_name): <p>The name of the stream to start the list with.</p>
    ...
    ///
    /// - Takes [`ListTagsForStreamInput`](crate::input::ListTagsForStreamInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::ListTagsForStreamInput::stream_name): <p>The name of the stream.</p>
    ///   - [`exclusive_start_tag_key(Option<String>)`](crate::input::ListTagsForStreamInput::exclusive_start_tag_key): <p>The key to use as the starting point for the list of tags. If this parameter is set, <code>ListTagsForStream</code> gets all tags that occur after <code>ExclusiveStartTagKey</code>. </p>
    ///   - [`limit(Option<i32>)`](crate::input::ListTagsForStreamInput::limit): <p>The number of tags to return. If this number is less than the total number of tags associated with the stream, <code>HasMoreTags</code> is set to <code>true</code>. To list additional tags, set <code>ExclusiveStartTagKey</code> to the last key in the response.</p>
    ...
    ///
    /// - Takes [`MergeShardsInput`](crate::input::MergeShardsInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::MergeShardsInput::stream_name): <p>The name of the stream for the merge.</p>
    ///   - [`shard_to_merge(Option<String>)`](crate::input::MergeShardsInput::shard_to_merge): <p>The shard ID of the shard to combine with the adjacent shard for the merge.</p>
    ///   - [`adjacent_shard_to_merge(Option<String>)`](crate::input::MergeShardsInput::adjacent_shard_to_merge): <p>The shard ID of the adjacent shard for the merge.</p>
    ...
    ///   - [`stream_name(Option<String>)`](crate::input::PutRecordInput::stream_name): <p>The name of the stream to put the data record into.</p>
    ///   - [`data(Option<Blob>)`](crate::input::PutRecordInput::data): <p>The data blob to put into the record, which is base64-encoded when the blob is serialized. When the data blob (the payload before base64-encoding) is added to the partition key size, the total size must not exceed the maximum record size (1 MiB).</p>
    ///   - [`partition_key(Option<String>)`](crate::input::PutRecordInput::partition_key): <p>Determines which shard in the stream the data record is assigned to. Partition keys are Unicode strings with a maximum length limit of 256 characters for each key. Amazon Kinesis Data Streams uses the partition key as input to a hash function that maps the partition key and associated data to a specific shard. Specifically, an MD5 hash function is used to map partition keys to 128-bit integer values and to map associated data records to shards. As a result of this hashing mechanism, all data records with the same partition key map to the same shard within the stream.</p>
    ///   - [`explicit_hash_key(Option<String>)`](crate::input::PutRecordInput::explicit_hash_key): <p>The hash value used to explicitly determine the shard the data record is assigned to by overriding the partition key hash.</p>
    ///   - [`sequence_number_for_ordering(Option<String>)`](crate::input::PutRecordInput::sequence_number_for_ordering): <p>Guarantees strictly increasing sequence numbers, for puts from the same client and to the same partition key. Usage: set the <code>SequenceNumberForOrdering</code> of record <i>n</i> to the sequence number of record <i>n-1</i> (as returned in the result when putting record <i>n-1</i>). If this parameter is not set, records are coarsely ordered based on arrival time.</p>
    ...
    ///
    /// - Takes [`PutRecordsInput`](crate::input::PutRecordsInput) with field(s):
    ///   - [`records(Option<Vec<PutRecordsRequestEntry>>)`](crate::input::PutRecordsInput::records): <p>The records associated with the request.</p>
    ///   - [`stream_name(Option<String>)`](crate::input::PutRecordsInput::stream_name): <p>The stream name associated with the request.</p>
    ...
    ///
    /// - Takes [`RegisterStreamConsumerInput`](crate::input::RegisterStreamConsumerInput) with field(s):
    ///   - [`stream_arn(Option<String>)`](crate::input::RegisterStreamConsumerInput::stream_arn): <p>The ARN of the Kinesis data stream that you want to register the consumer with. For more info, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams">Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces</a>.</p>
    ///   - [`consumer_name(Option<String>)`](crate::input::RegisterStreamConsumerInput::consumer_name): <p>For a given Kinesis data stream, each consumer must have a unique name. However, consumer names don't have to be unique across data streams.</p>
    ...
    ///
    /// - Takes [`RemoveTagsFromStreamInput`](crate::input::RemoveTagsFromStreamInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::RemoveTagsFromStreamInput::stream_name): <p>The name of the stream.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::RemoveTagsFromStreamInput::tag_keys): <p>A list of tag keys. Each corresponding tag is removed from the stream.</p>
    ...
    ///
    /// - Takes [`SplitShardInput`](crate::input::SplitShardInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::SplitShardInput::stream_name): <p>The name of the stream for the shard split.</p>
    ///   - [`shard_to_split(Option<String>)`](crate::input::SplitShardInput::shard_to_split): <p>The shard ID of the shard to split.</p>
    ///   - [`new_starting_hash_key(Option<String>)`](crate::input::SplitShardInput::new_starting_hash_key): <p>A hash key value for the starting hash key of one of the child shards created by the split. The hash key range for a given shard constitutes a set of ordered contiguous positive integers. The value for <code>NewStartingHashKey</code> must be in the range of hash keys being mapped into the shard. The <code>NewStartingHashKey</code> hash key value and all higher hash key values in hash key range are distributed to one of the child shards. All the lower hash key values in the range are distributed to the other child shard.</p>
    ...
    ///
    /// - Takes [`StopStreamEncryptionInput`](crate::input::StopStreamEncryptionInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::StopStreamEncryptionInput::stream_name): <p>The name of the stream on which to stop encrypting records.</p>
    ///   - [`encryption_type(Option<EncryptionType>)`](crate::input::StopStreamEncryptionInput::encryption_type): <p>The encryption type. The only valid value is <code>KMS</code>.</p>
    ///   - [`key_id(Option<String>)`](crate::input::StopStreamEncryptionInput::key_id): <p>The GUID for the customer-managed Amazon Web Services KMS key to use for encryption. This value can be a globally unique identifier, a fully specified Amazon Resource Name (ARN) to either an alias or a key, or an alias name prefixed by "alias/".You can also use a master key owned by Kinesis Data Streams by specifying the alias <code>aws/kinesis</code>.</p>  <ul>   <li> <p>Key ARN example: <code>arn:aws:kms:us-east-1:123456789012:key/12345678-1234-1234-1234-123456789012</code> </p> </li>   <li> <p>Alias ARN example: <code>arn:aws:kms:us-east-1:123456789012:alias/MyAliasName</code> </p> </li>   <li> <p>Globally unique key ID example: <code>12345678-1234-1234-1234-123456789012</code> </p> </li>   <li> <p>Alias name example: <code>alias/MyAliasName</code> </p> </li>   <li> <p>Master key owned by Kinesis Data Streams: <code>alias/aws/kinesis</code> </p> </li>  </ul>
    ...
    ///
    /// - Takes [`UpdateStreamModeInput`](crate::input::UpdateStreamModeInput) with field(s):
    ///   - [`stream_arn(Option<String>)`](crate::input::UpdateStreamModeInput::stream_arn): <p> Specifies the ARN of the data stream whose capacity mode you want to update. </p>
    ///   - [`stream_mode_details(Option<StreamModeDetails>)`](crate::input::UpdateStreamModeInput::stream_mode_details): <p> Specifies the capacity mode to which you want to set your data stream. Currently, in Kinesis Data Streams, you can choose between an <b>on-demand</b> capacity mode and a <b>provisioned</b> capacity mode for your data streams. </p>
