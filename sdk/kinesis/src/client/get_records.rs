...
impl super::Client  {
    ...
    ///   - [`stream_arn(impl Into<String>)`](crate::operation::get_records::builders::GetRecordsFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::get_records::builders::GetRecordsFluentBuilder::set_stream_arn): <p>The ARN of the stream.</p>
