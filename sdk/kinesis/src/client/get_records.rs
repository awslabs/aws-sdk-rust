...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::get_records::builders::GetRecordsFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::get_records::builders::GetRecordsFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks if your request will succeed. <code>DryRun</code> is an optional parameter.</p><br>
