...
impl super::Client  {
    ...
    ///   - [`stream_name(impl Into<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::set_stream_name): <p>The name of the stream to describe.</p>
    ...
    ///   - [`stream_arn(impl Into<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::set_stream_arn): <p>The ARN of the stream.</p>
