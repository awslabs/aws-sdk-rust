...
impl super::Client {
    ...
    ///   - [`limit(i32)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::set_limit): <p>The maximum number of streams to list. The default value is 100. If you specify a value greater than 100, at most 100 results are returned.</p>
    ///   - [`exclusive_start_stream_name(impl ::std::convert::Into<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::exclusive_start_stream_name) / [`set_exclusive_start_stream_name(Option<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::set_exclusive_start_stream_name): <p>The name of the stream to start the list with.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::set_next_token): <p></p>
    /// - On success, responds with [`ListStreamsOutput`](crate::operation::list_streams::ListStreamsOutput) with field(s):
    ///   - [`stream_names(Option<Vec<String>>)`](crate::operation::list_streams::ListStreamsOutput::stream_names): <p>The names of the streams that are associated with the Amazon Web Services account making the <code>ListStreams</code> request.</p>
    ///   - [`has_more_streams(Option<bool>)`](crate::operation::list_streams::ListStreamsOutput::has_more_streams): <p>If set to <code>true</code>, there are more streams available to list.</p>
