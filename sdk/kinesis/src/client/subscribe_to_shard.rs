...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::subscribe_to_shard::builders::SubscribeToShardFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::subscribe_to_shard::builders::SubscribeToShardFluentBuilder::set_dry_run):<br>required: **false**<br><p>Checks if your request will succeed. <code>DryRun</code> is an optional parameter.</p><br>
