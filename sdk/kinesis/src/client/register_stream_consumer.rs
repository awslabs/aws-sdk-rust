...
impl super::Client {
    ...
    pub fn register_stream_consumer(
        &self,
    ) -> crate::operation::register_stream_consumer::builders::RegisterStreamConsumerFluentBuilder
    {
