...
impl super::Client {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::update_shard_count::builders::UpdateShardCountFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::update_shard_count::builders::UpdateShardCountFluentBuilder::set_stream_name): <p>The name of the stream.</p>
    ...
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::update_shard_count::builders::UpdateShardCountFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::update_shard_count::builders::UpdateShardCountFluentBuilder::set_stream_arn): <p>The ARN of the stream.</p>
