...
impl super::Client {
    ...
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::deregister_stream_consumer::builders::DeregisterStreamConsumerFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::deregister_stream_consumer::builders::DeregisterStreamConsumerFluentBuilder::set_stream_arn): <p>The ARN of the Kinesis data stream that the consumer is registered with. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams">Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces</a>.</p>
    ///   - [`consumer_name(impl ::std::convert::Into<String>)`](crate::operation::deregister_stream_consumer::builders::DeregisterStreamConsumerFluentBuilder::consumer_name) / [`set_consumer_name(Option<String>)`](crate::operation::deregister_stream_consumer::builders::DeregisterStreamConsumerFluentBuilder::set_consumer_name): <p>The name that you gave to the consumer.</p>
