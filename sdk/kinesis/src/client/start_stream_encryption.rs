...
impl super::Client {
    ...
    ///   - [`stream_arn(impl Into<String>)`](crate::operation::start_stream_encryption::builders::StartStreamEncryptionFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::start_stream_encryption::builders::StartStreamEncryptionFluentBuilder::set_stream_arn): <p>The ARN of the stream.</p>
