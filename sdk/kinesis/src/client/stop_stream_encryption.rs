...
impl super::Client {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::stop_stream_encryption::builders::StopStreamEncryptionFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::stop_stream_encryption::builders::StopStreamEncryptionFluentBuilder::set_stream_name): <p>The name of the stream on which to stop encrypting records.</p>
