...
out.push_str("https://");
#[allow(clippy::needless_borrow)]out.push_str(&arn.account_id());
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&operation_type);
out.push_str("-kinesis-fips.");
#[allow(clippy::needless_borrow)]out.push_str(&region);
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&partition_result.dual_stack_dns_suffix());
out })
.build());
                                                                        }
...
#[allow(clippy::needless_borrow)]out.push_str(&region);
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&partition_result.dns_suffix());
out })
.build());
                                                                }
                                                                return Err(aws_smithy_http::endpoint::ResolveEndpointError::message("FIPS is enabled but this partition does not support FIPS"
...
#[allow(clippy::needless_borrow)]out.push_str(&arn.partition());
...
#[allow(clippy::needless_borrow)]out.push_str(&arn_type);
