...
pub struct StreamModeDetails  {
    /// <p> Specifies the capacity mode to which you want to set your data stream. Currently, in Kinesis Data Streams, you can choose between an <b>on-demand</b> capacity mode and a <b>provisioned</b> capacity mode for your data streams. </p>
    #[doc(hidden)]pub stream_mode: std::option::Option<crate::model::StreamMode>,
}
...
pub struct Consumer  {
    ...
    #[doc(hidden)]pub consumer_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub consumer_arn: std::option::Option<std::string::String>,
    /// <p>A consumer can't read data while in the <code>CREATING</code> or <code>DELETING</code> states.</p>
    #[doc(hidden)]pub consumer_status: std::option::Option<crate::model::ConsumerStatus>,
    /// <p></p>
    #[doc(hidden)]pub consumer_creation_timestamp: std::option::Option<aws_smithy_types::DateTime>,
}
impl Consumer {
    /// <p>The name of the consumer is something you choose when you register the consumer.</p>
...
impl  std::fmt::Debug for Consumer  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("consumer_creation_timestamp", &self.consumer_creation_timestamp);
        formatter.finish()
    }
}
...
pub struct PutRecordsRequestEntry  {
    ...
    #[doc(hidden)]pub explicit_hash_key: std::option::Option<std::string::String>,
    /// <p>Determines which shard in the stream the data record is assigned to. Partition keys are Unicode strings with a maximum length limit of 256 characters for each key. Amazon Kinesis Data Streams uses the partition key as input to a hash function that maps the partition key and associated data to a specific shard. Specifically, an MD5 hash function is used to map partition keys to 128-bit integer values and to map associated data records to shards. As a result of this hashing mechanism, all data records with the same partition key map to the same shard within the stream.</p>
    #[doc(hidden)]pub partition_key: std::option::Option<std::string::String>,
}
...
pub struct Shard  {
    ...
    #[doc(hidden)]pub parent_shard_id: std::option::Option<std::string::String>,
    /// <p>The shard ID of the shard adjacent to the shard's parent.</p>
    #[doc(hidden)]pub adjacent_parent_shard_id: std::option::Option<std::string::String>,
    /// <p>The range of possible hash key values for the shard, which is a set of ordered contiguous positive integers.</p>
    #[doc(hidden)]pub hash_key_range: std::option::Option<crate::model::HashKeyRange>,
    /// <p>The range of possible sequence numbers for the shard.</p>
    #[doc(hidden)]pub sequence_number_range: std::option::Option<crate::model::SequenceNumberRange>,
}
impl Shard {
    /// <p>The unique identifier of the shard within the stream.</p>
    pub fn shard_id(&self) -> std::option::Option<& str> {
...
pub struct SequenceNumberRange  {
    ...
    #[doc(hidden)]pub starting_sequence_number: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ending_sequence_number: std::option::Option<std::string::String>,
}
...
pub struct HashKeyRange  {
    ...
    #[doc(hidden)]pub starting_hash_key: std::option::Option<std::string::String>,
    /// <p>The ending hash key of the hash key range.</p>
    #[doc(hidden)]pub ending_hash_key: std::option::Option<std::string::String>,
}
impl HashKeyRange {
    /// <p>The starting hash key of the hash key range.</p>
...
pub struct ShardFilter  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ShardFilterType>,
    ...
    #[doc(hidden)]pub timestamp: std::option::Option<aws_smithy_types::DateTime>,
}
impl ShardFilter {
    /// <p>The shard type specified in the <code>ShardFilter</code> parameter. This is a required property of the <code>ShardFilter</code> parameter.</p> 
    /// <p>You can specify the following valid values: </p> 
...
pub struct ChildShard  {
    ...
    #[doc(hidden)]pub parent_shards: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The range of possible hash key values for the shard, which is a set of ordered contiguous positive integers.</p>
    #[doc(hidden)]pub hash_key_range: std::option::Option<crate::model::HashKeyRange>,
}
impl ChildShard {
...
pub struct Record  {
    ...
    #[doc(hidden)]pub approximate_arrival_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// </ul>
    #[doc(hidden)]pub encryption_type: std::option::Option<crate::model::EncryptionType>,
}
impl Record {
    /// <p>The unique identifier of the record within its shard.</p>
    pub fn sequence_number(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for Record  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("sequence_number", &self.sequence_number);
        formatter.field("approximate_arrival_timestamp", &self.approximate_arrival_timestamp);
        formatter.field("data", &self.data);
        formatter.field("partition_key", &self.partition_key);
...
pub struct StreamDescriptionSummary  {
    ...
    #[doc(hidden)]pub stream_name: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub stream_status: std::option::Option<crate::model::StreamStatus>,
    ...
    #[doc(hidden)]pub stream_mode_details: std::option::Option<crate::model::StreamModeDetails>,
    /// <p>The current retention period, in hours.</p>
    #[doc(hidden)]pub retention_period_hours: std::option::Option<i32>,
    /// <p>The approximate time that the stream was created.</p>
    #[doc(hidden)]pub stream_creation_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Represents the current enhanced monitoring settings of the stream.</p>
    #[doc(hidden)]pub enhanced_monitoring: std::option::Option<std::vec::Vec<crate::model::EnhancedMetrics>>,
    ...
    /// </ul>
    #[doc(hidden)]pub key_id: std::option::Option<std::string::String>,
    /// <p>The number of open shards in the stream.</p>
    #[doc(hidden)]pub open_shard_count: std::option::Option<i32>,
    /// <p>The number of enhanced fan-out consumers registered with the stream.</p>
    #[doc(hidden)]pub consumer_count: std::option::Option<i32>,
}
...
pub struct EnhancedMetrics  {
    ...
    #[doc(hidden)]pub shard_level_metrics: std::option::Option<std::vec::Vec<crate::model::MetricsName>>,
}
...
pub struct StreamDescription  {
    ...
    #[doc(hidden)]pub shards: std::option::Option<std::vec::Vec<crate::model::Shard>>,
    /// <p>If set to <code>true</code>, more shards in the stream are available to describe.</p>
    #[doc(hidden)]pub has_more_shards: std::option::Option<bool>,
