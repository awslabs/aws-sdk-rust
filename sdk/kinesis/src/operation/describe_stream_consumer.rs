...
impl DescribeStreamConsumerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_stream_consumer::DescribeStreamConsumer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStreamConsumer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_stream_consumer::de_describe_stream_consumer_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_stream_consumer::DescribeStreamConsumerError
{
