...
impl IncreaseStreamRetentionPeriodInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriod,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriod::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for IncreaseStreamRetentionPeriod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_increase_stream_retention_period::de_increase_stream_retention_period_http_response_with_props(
                status, headers, body,
            )
        }
    }
