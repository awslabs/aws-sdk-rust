...
impl IncreaseStreamRetentionPeriod {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IncreaseStreamRetentionPeriod {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("IncreaseStreamRetentionPeriod");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(IncreaseStreamRetentionPeriodRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(IncreaseStreamRetentionPeriodResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("IncreaseStreamRetentionPeriod")
...
.with_interceptor(IncreaseStreamRetentionPeriodEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodError>::new());
...
#[derive(Debug)]
            struct IncreaseStreamRetentionPeriodResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for IncreaseStreamRetentionPeriodResponseDeserializer {
...
#[derive(Debug)]
            struct IncreaseStreamRetentionPeriodRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IncreaseStreamRetentionPeriodRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_increase_stream_retention_period::ser_increase_stream_retention_period_input(&input)?);
...
#[derive(Debug)]
            struct IncreaseStreamRetentionPeriodEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for IncreaseStreamRetentionPeriodEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "IncreaseStreamRetentionPeriodEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<IncreaseStreamRetentionPeriodInput>()
                        .ok_or("failed to downcast to IncreaseStreamRetentionPeriodInput")?;
...
pub enum IncreaseStreamRetentionPeriodError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-IncreaseStreamRetentionPeriodError) for what information is available for the error.")]
...
impl IncreaseStreamRetentionPeriodError {
    /// Creates the `IncreaseStreamRetentionPeriodError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `IncreaseStreamRetentionPeriodError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for IncreaseStreamRetentionPeriodError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for IncreaseStreamRetentionPeriodError {
...
pub use crate::operation::increase_stream_retention_period::_increase_stream_retention_period_output::IncreaseStreamRetentionPeriodOutput;

pub use crate::operation::increase_stream_retention_period::_increase_stream_retention_period_input::IncreaseStreamRetentionPeriodInput;

mod _increase_stream_retention_period_input;

mod _increase_stream_retention_period_output;
