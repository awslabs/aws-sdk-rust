...
impl DecreaseStreamRetentionPeriodInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::decrease_stream_retention_period::DecreaseStreamRetentionPeriod::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DecreaseStreamRetentionPeriod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_decrease_stream_retention_period::de_decrease_stream_retention_period_http_response_with_props(
                status, headers, body,
            )
        }
    }
