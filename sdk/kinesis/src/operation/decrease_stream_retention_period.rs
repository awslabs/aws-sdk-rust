...
impl ::aws_smithy_http::response::ParseStrictResponse for DecreaseStreamRetentionPeriod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_decrease_stream_retention_period::de_decrease_stream_retention_period_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::decrease_stream_retention_period::DecreaseStreamRetentionPeriodError
{
