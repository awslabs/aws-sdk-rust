...
impl GetRecordsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_records::GetRecords, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_records::ser_get_records_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_records::de_get_records_http_response_with_props(status, headers, body)
        }
    }
}
