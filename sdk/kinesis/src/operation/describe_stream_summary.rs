...
impl DescribeStreamSummaryInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStreamSummary`](crate::operation::describe_stream_summary::DescribeStreamSummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_stream_summary::DescribeStreamSummary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_stream_summary::DescribeStreamSummaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_stream_summary::DescribeStreamSummary::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeStreamSummary {
                type Output = std::result::Result<crate::operation::describe_stream_summary::DescribeStreamSummaryOutput, crate::operation::describe_stream_summary::DescribeStreamSummaryError>;
...
impl aws_http::request_id::RequestId for crate::operation::describe_stream_summary::DescribeStreamSummaryError {
