...
impl MergeShardsInput {
    /// Consumes the builder and constructs an Operation<[`MergeShards`](crate::operation::merge_shards::MergeShards)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::merge_shards::MergeShards, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::merge_shards::MergeShardsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_merge_shards::ser_merge_shards_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::merge_shards::MergeShards::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("MergeShards", "kinesis"));
...
impl aws_smithy_http::response::ParseStrictResponse for MergeShards {
                type Output = std::result::Result<crate::operation::merge_shards::MergeShardsOutput, crate::operation::merge_shards::MergeShardsError>;
