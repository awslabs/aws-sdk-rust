...
impl MergeShardsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::merge_shards::MergeShards::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for MergeShards {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_merge_shards::de_merge_shards_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_merge_shards::de_merge_shards_http_response_with_props(
                status, headers, body,
            )
        }
    }
