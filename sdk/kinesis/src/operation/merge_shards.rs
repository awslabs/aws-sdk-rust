...
impl MergeShardsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::merge_shards::MergeShards, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_merge_shards::ser_merge_shards_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for MergeShards {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_merge_shards::de_merge_shards_http_response_with_props(status, headers, body)
        }
    }
}
