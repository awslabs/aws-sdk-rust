...
impl UpdateStreamModeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_stream_mode::UpdateStreamMode,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_stream_mode::ser_update_stream_mode_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStreamMode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_stream_mode::de_update_stream_mode_http_response_with_props(status, headers, body)
        }
    }
}
