...
impl UpdateStreamModeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStreamMode`](crate::operation::update_stream_mode::UpdateStreamMode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_stream_mode::UpdateStreamMode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_stream_mode::UpdateStreamModeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_stream_mode::ser_update_stream_mode_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_stream_mode::UpdateStreamMode::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateStreamMode", "kinesis"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateStreamMode {
                type Output = std::result::Result<crate::operation::update_stream_mode::UpdateStreamModeOutput, crate::operation::update_stream_mode::UpdateStreamModeError>;
