...
impl IncreaseStreamRetentionPeriodInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
