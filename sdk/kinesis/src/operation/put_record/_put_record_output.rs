        ...
        ::std::result::Result::Ok(
            crate::operation::put_record::PutRecordOutput {
                shard_id: self.shard_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("shard_id", "shard_id was not specified but it is required when building PutRecordOutput")
                    )?
                ,
                sequence_number: self.sequence_number
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("sequence_number", "sequence_number was not specified but it is required when building PutRecordOutput")
                    )?
                ,
