...
impl SplitShardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::split_shard::SplitShard::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SplitShard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_split_shard::de_split_shard_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_split_shard::de_split_shard_http_response_with_props(
                status, headers, body,
            )
        }
    }
