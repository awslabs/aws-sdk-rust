...
impl DecreaseStreamRetentionPeriodInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::decrease_stream_retention_period::DecreaseStreamRetentionPeriodInput, ::aws_smithy_types::error::operation::BuildError> {
