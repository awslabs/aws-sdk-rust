...
impl CreateStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_stream::CreateStream, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_stream::ser_create_stream_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_stream::de_create_stream_http_response_with_props(status, headers, body)
        }
    }
}
