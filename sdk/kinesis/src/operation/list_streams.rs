...
impl ListStreamsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_streams::ListStreams, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_streams::ser_list_streams_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStreams {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_streams::de_list_streams_http_response_with_props(status, headers, body)
        }
    }
}
