...
impl DeregisterStreamConsumerInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterStreamConsumer`](crate::operation::deregister_stream_consumer::DeregisterStreamConsumer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_stream_consumer::DeregisterStreamConsumer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_stream_consumer::ser_deregister_stream_consumer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_stream_consumer::DeregisterStreamConsumer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeregisterStreamConsumer", "kinesis"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterStreamConsumer {
                type Output = std::result::Result<crate::operation::deregister_stream_consumer::DeregisterStreamConsumerOutput, crate::operation::deregister_stream_consumer::DeregisterStreamConsumerError>;
