...
impl DeregisterStreamConsumerInput {
    ...
    > {
        ...
        let params_result = crate::endpoint::Params::builder()
            ...
            .set_operation_type(::std::option::Option::Some("control".to_string()))
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterStreamConsumer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_stream_consumer::de_deregister_stream_consumer_http_response_with_props(status, headers, body)
        }
    }
}
