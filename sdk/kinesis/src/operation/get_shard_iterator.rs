...
impl GetShardIteratorInput {
    /// Consumes the builder and constructs an Operation<[`GetShardIterator`](crate::operation::get_shard_iterator::GetShardIterator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_shard_iterator::GetShardIterator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_shard_iterator::GetShardIteratorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_shard_iterator::GetShardIterator::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetShardIterator", "kinesis"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetShardIterator {
                type Output = std::result::Result<crate::operation::get_shard_iterator::GetShardIteratorOutput, crate::operation::get_shard_iterator::GetShardIteratorError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_shard_iterator::GetShardIteratorError {
