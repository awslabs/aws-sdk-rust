...
impl GetShardIteratorInput {
    ...
    > {
        ...
        let params_result = crate::endpoint::Params::builder()
            ...
            .set_operation_type(::std::option::Option::Some("data".to_string()))
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_shard_iterator::ser_get_shard_iterator_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetShardIterator {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_shard_iterator::de_get_shard_iterator_http_response_with_props(status, headers, body)
        }
    }
}
