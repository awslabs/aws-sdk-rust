    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetShardIterator")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetShardIteratorTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetShardIteratorTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetShardIteratorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetShardIteratorInput>() else {
        ...
        if requested.should_capture("ShardId") {
            if let ::std::option::Option::Some(value) = input.shard_id.as_deref() {
                captured.insert("ShardId", value);
            }
        }
        if requested.should_capture("StartingSequenceNumber") {
            if let ::std::option::Option::Some(value) = input.starting_sequence_number.as_deref() {
                captured.insert("StartingSequenceNumber", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetShardIteratorResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_shard_iterator::de_get_shard_iterator_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_shard_iterator::de_get_shard_iterator_http_response(status, headers, body, _cfg)
        };
