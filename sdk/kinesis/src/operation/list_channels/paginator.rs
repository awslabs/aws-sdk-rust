...
impl ListChannelsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `channel_summaries`. Queries to the underlying service
...
impl ListChannelsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_channels_output_output_channel_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
