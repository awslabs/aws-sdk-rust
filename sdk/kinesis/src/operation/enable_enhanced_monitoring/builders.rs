...
impl EnableEnhancedMonitoringFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_enhanced_monitoring::EnableEnhancedMonitoringOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_enhanced_monitoring::EnableEnhancedMonitoringError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_enhanced_monitoring::EnableEnhancedMonitoringOutput, crate::operation::enable_enhanced_monitoring::EnableEnhancedMonitoringError, Self> {
