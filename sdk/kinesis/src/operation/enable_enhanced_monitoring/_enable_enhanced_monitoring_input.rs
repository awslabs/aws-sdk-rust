...
impl EnableEnhancedMonitoringInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_enhanced_monitoring::EnableEnhancedMonitoringInput, ::aws_smithy_types::error::operation::BuildError> {
