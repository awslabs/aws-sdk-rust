...
impl RemoveTagsFromStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_tags_from_stream::RemoveTagsFromStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_tags_from_stream::RemoveTagsFromStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_tags_from_stream::RemoveTagsFromStreamOutput, crate::operation::remove_tags_from_stream::RemoveTagsFromStreamError, Self> {
