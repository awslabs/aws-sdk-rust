...
impl DeregisterStreamConsumerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deregister_stream_consumer::DeregisterStreamConsumerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_stream_consumer::DeregisterStreamConsumerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deregister_stream_consumer::DeregisterStreamConsumerOutput, crate::operation::deregister_stream_consumer::DeregisterStreamConsumerError, Self> {
