...
impl DeregisterStreamConsumerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_stream_consumer::DeregisterStreamConsumerInput, ::aws_smithy_types::error::operation::BuildError> {
