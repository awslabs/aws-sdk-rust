...
impl ListShardsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_shards::ListShards,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_shards::ListShards::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListShards {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_shards::de_list_shards_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_shards::de_list_shards_http_response_with_props(
                status, headers, body,
            )
        }
    }
