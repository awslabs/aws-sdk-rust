...
impl ListShardsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_shards::ListShards, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_shards::ser_list_shards_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListShards {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_shards::de_list_shards_http_response_with_props(status, headers, body)
        }
    }
}
