...
impl ListShardsInput {
    /// Consumes the builder and constructs an Operation<[`ListShards`](crate::operation::list_shards::ListShards)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_shards::ListShards, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_shards::ListShardsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_shards::ser_list_shards_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_shards::ListShards::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListShards", "kinesis"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListShards {
                type Output = std::result::Result<crate::operation::list_shards::ListShardsOutput, crate::operation::list_shards::ListShardsError>;
