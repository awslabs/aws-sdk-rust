...
pub struct UpdateShardCountOutput  {
    ...
    #[doc(hidden)]pub current_shard_count: std::option::Option<i32>,
    /// <p>The updated number of shards.</p>
    #[doc(hidden)]pub target_shard_count: std::option::Option<i32>,
}
...
pub struct RegisterStreamConsumerOutput  {
    ...
    #[doc(hidden)]pub consumer: std::option::Option<crate::model::Consumer>,
}
...
pub struct PutRecordsOutput  {
    ...
    #[doc(hidden)]pub failed_record_count: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub records: std::option::Option<std::vec::Vec<crate::model::PutRecordsResultEntry>>,
...
pub mod put_records_output {
    ...
    impl Builder {
        ...
        /// <p>An array of successfully and unsuccessfully processed record results. A record that is successfully added to a stream includes <code>SequenceNumber</code> and <code>ShardId</code> in the result. A record that fails to be added to a stream includes <code>ErrorCode</code> and <code>ErrorMessage</code> in the result.</p>
        pub fn set_records(mut self, input: std::option::Option<std::vec::Vec<crate::model::PutRecordsResultEntry>>) -> Self {
...
pub struct ListTagsForStreamOutput  {
    ...
    #[doc(hidden)]pub has_more_tags: std::option::Option<bool>,
}
...
pub struct ListStreamsOutput  {
    ...
    #[doc(hidden)]pub stream_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>If set to <code>true</code>, there are more streams available to list.</p>
    #[doc(hidden)]pub has_more_streams: std::option::Option<bool>,
}
...
pub struct ListStreamConsumersOutput  {
    ...
    #[doc(hidden)]pub consumers: std::option::Option<std::vec::Vec<crate::model::Consumer>>,
...
pub mod list_stream_consumers_output {
    ...
    impl Builder {
        ...
        /// <p>An array of JSON objects. Each object represents one registered consumer.</p>
        pub fn set_consumers(mut self, input: std::option::Option<std::vec::Vec<crate::model::Consumer>>) -> Self {
...
pub struct GetRecordsOutput  {
    ...
    #[doc(hidden)]pub records: std::option::Option<std::vec::Vec<crate::model::Record>>,
    ...
    #[doc(hidden)]pub next_shard_iterator: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub millis_behind_latest: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub child_shards: std::option::Option<std::vec::Vec<crate::model::ChildShard>>,
}
...
pub mod get_records_output {
    ...
    impl Builder {
        ...
        /// <p>The list of the current shard's child shards, returned in the <code>GetRecords</code> API's response only when the end of the current shard is reached.</p>
        pub fn set_child_shards(mut self, input: std::option::Option<std::vec::Vec<crate::model::ChildShard>>) -> Self {
...
pub struct EnableEnhancedMonitoringOutput  {
    ...
    #[doc(hidden)]pub current_shard_level_metrics: std::option::Option<std::vec::Vec<crate::model::MetricsName>>,
    /// <p>Represents the list of all the metrics that would be in the enhanced state after the operation.</p>
    #[doc(hidden)]pub desired_shard_level_metrics: std::option::Option<std::vec::Vec<crate::model::MetricsName>>,
}
...
impl  std::fmt::Debug for EnableEnhancedMonitoringOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("stream_name", &self.stream_name);
        formatter.field("current_shard_level_metrics", &self.current_shard_level_metrics);
        formatter.field("desired_shard_level_metrics", &self.desired_shard_level_metrics);
        formatter.finish()
    }
}
...
pub mod enable_enhanced_monitoring_output {
    ...
    pub struct Builder {
        pub(crate) stream_name: std::option::Option<std::string::String>,
        pub(crate) current_shard_level_metrics: std::option::Option<std::vec::Vec<crate::model::MetricsName>>,
        pub(crate) desired_shard_level_metrics: std::option::Option<std::vec::Vec<crate::model::MetricsName>>,
    }
    impl Builder {
        /// <p>The name of the Kinesis data stream.</p>
        pub fn stream_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>Represents the current state of the metrics that are in the enhanced state before the operation.</p>
        pub fn set_current_shard_level_metrics(mut self, input: std::option::Option<std::vec::Vec<crate::model::MetricsName>>) -> Self {
            self.current_shard_level_metrics = input; self
        }
        ...
        /// <p>Represents the list of all the metrics that would be in the enhanced state after the operation.</p>
        pub fn set_desired_shard_level_metrics(mut self, input: std::option::Option<std::vec::Vec<crate::model::MetricsName>>) -> Self {
            self.desired_shard_level_metrics = input; self
        }
...
pub struct DescribeStreamSummaryOutput  {
    ...
    #[doc(hidden)]pub stream_description_summary: std::option::Option<crate::model::StreamDescriptionSummary>,
}
impl DescribeStreamSummaryOutput {
    /// <p>A <code>StreamDescriptionSummary</code> containing information about the stream.</p>
    pub fn stream_description_summary(&self) -> std::option::Option<& crate::model::StreamDescriptionSummary> {
...
impl  std::fmt::Debug for DescribeStreamSummaryOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("stream_description_summary", &self.stream_description_summary);
        formatter.finish()
    }
}
...
pub mod describe_stream_summary_output {
    ...
    impl Builder {
        /// <p>A <code>StreamDescriptionSummary</code> containing information about the stream.</p>
        pub fn stream_description_summary(mut self, input: crate::model::StreamDescriptionSummary) -> Self {
            self.stream_description_summary = Some(input);
            self
        }
        /// <p>A <code>StreamDescriptionSummary</code> containing information about the stream.</p>
        pub fn set_stream_description_summary(mut self, input: std::option::Option<crate::model::StreamDescriptionSummary>) -> Self {
...
pub struct DescribeStreamConsumerOutput  {
    ...
    #[doc(hidden)]pub consumer_description: std::option::Option<crate::model::ConsumerDescription>,
}
...
pub mod describe_stream_consumer_output {
    ...
    impl Builder {
        ...
        /// <p>An object that represents the details of the consumer.</p>
        pub fn set_consumer_description(mut self, input: std::option::Option<crate::model::ConsumerDescription>) -> Self {
...
pub struct DescribeStreamOutput  {
    ...
    #[doc(hidden)]pub stream_description: std::option::Option<crate::model::StreamDescription>,
}
...
pub struct DescribeLimitsOutput  {
    ...
    #[doc(hidden)]pub shard_limit: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub on_demand_stream_count: std::option::Option<i32>,
    /// <p> The maximum number of data streams with the on-demand capacity mode. </p>
    #[doc(hidden)]pub on_demand_stream_count_limit: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for DescribeLimitsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("on_demand_stream_count_limit", &self.on_demand_stream_count_limit);
        formatter.finish()
    }
}
