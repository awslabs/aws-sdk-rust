...
impl  StreamDescription  {
    ...
    pub fn shards(&self) -> & [crate::types::Shard] {
        use std::ops::Deref; self.shards.deref()
    }
    /// <p>If set to <code>true</code>, more shards in the stream are available to describe.</p>
    ...
    pub fn enhanced_monitoring(&self) -> & [crate::types::EnhancedMetrics] {
        use std::ops::Deref; self.enhanced_monitoring.deref()
    }
    /// <p>The server-side encryption type used on the stream. This parameter can be one of the following values:</p>
    /// <ul>
    /// <li>
        ...
        ::std::result::Result::Ok(
            crate::types::StreamDescription {
                stream_name: self.stream_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_name", "stream_name was not specified but it is required when building StreamDescription")
                    )?
                ,
                stream_arn: self.stream_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_arn", "stream_arn was not specified but it is required when building StreamDescription")
                    )?
                ,
                stream_status: self.stream_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_status", "stream_status was not specified but it is required when building StreamDescription")
                    )?
                ,
                ...
                shards: self.shards
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("shards", "shards was not specified but it is required when building StreamDescription")
                    )?
                ,
                has_more_shards: self.has_more_shards
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("has_more_shards", "has_more_shards was not specified but it is required when building StreamDescription")
                    )?
                ,
                retention_period_hours: self.retention_period_hours
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("retention_period_hours", "retention_period_hours was not specified but it is required when building StreamDescription")
                    )?
                ,
                stream_creation_timestamp: self.stream_creation_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_creation_timestamp", "stream_creation_timestamp was not specified but it is required when building StreamDescription")
                    )?
                ,
                enhanced_monitoring: self.enhanced_monitoring
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("enhanced_monitoring", "enhanced_monitoring was not specified but it is required when building StreamDescription")
                    )?
                ,
