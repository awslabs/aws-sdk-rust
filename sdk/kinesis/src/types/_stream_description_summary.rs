        ...
        ::std::result::Result::Ok(
            crate::types::StreamDescriptionSummary {
                stream_name: self.stream_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_name", "stream_name was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
                stream_arn: self.stream_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_arn", "stream_arn was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
                stream_status: self.stream_status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_status", "stream_status was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
                ...
                retention_period_hours: self.retention_period_hours
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("retention_period_hours", "retention_period_hours was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
                stream_creation_timestamp: self.stream_creation_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("stream_creation_timestamp", "stream_creation_timestamp was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
                enhanced_monitoring: self.enhanced_monitoring
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("enhanced_monitoring", "enhanced_monitoring was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
                ...
                open_shard_count: self.open_shard_count
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("open_shard_count", "open_shard_count was not specified but it is required when building StreamDescriptionSummary")
                    )?
                ,
