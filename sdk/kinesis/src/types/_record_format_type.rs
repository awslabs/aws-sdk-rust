...
///     RecordFormatType::ByteArray => { /* ... */ },
///     RecordFormatType::GsrJson => { /* ... */ },
...
impl ::std::convert::From<&str> for RecordFormatType {
    fn from(s: &str) -> Self {
        match s {
            "BYTE_ARRAY" => RecordFormatType::ByteArray,
            "GSR_JSON" => RecordFormatType::GsrJson,
            "JSON" => RecordFormatType::Json,
            "STRING" => RecordFormatType::String,
...
impl RecordFormatType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RecordFormatType::ByteArray => "BYTE_ARRAY",
            RecordFormatType::GsrJson => "GSR_JSON",
            RecordFormatType::Json => "JSON",
            RecordFormatType::String => "STRING",
            RecordFormatType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["BYTE_ARRAY", "GSR_JSON", "JSON", "STRING"]
    }
}
...
impl ::std::fmt::Display for RecordFormatType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RecordFormatType::ByteArray => write!(f, "BYTE_ARRAY"),
            RecordFormatType::GsrJson => write!(f, "GSR_JSON"),
            RecordFormatType::Json => write!(f, "JSON"),
            RecordFormatType::String => write!(f, "STRING"),
