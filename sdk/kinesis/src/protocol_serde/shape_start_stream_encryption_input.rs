...
pub fn ser_start_stream_encryption_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_stream_encryption::StartStreamEncryptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
