...
pub fn ser_stop_stream_encryption_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::stop_stream_encryption::StopStreamEncryptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
