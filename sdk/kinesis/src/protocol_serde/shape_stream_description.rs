...
) -> Result<Option<crate::types::StreamDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "StreamModeDetails" => {
                            builder =
                                builder.set_stream_mode_details(crate::protocol_serde::shape_stream_mode_details::de_stream_mode_details(tokens)?);
                        }
                        "Shards" => {
