...
pub fn ser_deregister_stream_consumer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeregisterStreamConsumerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
