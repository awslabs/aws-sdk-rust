...
pub fn ser_increase_stream_retention_period_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::increase_stream_retention_period::IncreaseStreamRetentionPeriodInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
