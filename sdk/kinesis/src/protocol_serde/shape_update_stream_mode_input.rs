...
pub fn ser_update_stream_mode_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateStreamModeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
