...
pub fn ser_put_records_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::put_records::PutRecordsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
