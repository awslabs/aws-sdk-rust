...
if let Some(partition_result) = partition_resolver.resolve_partition(region, _diagnostic_collector) { if !((partition_result.name()) == ("aws-iso")) {
...
#[allow(unused_variables)]
if let Some(resource_arn) = resource_arn { if !(endpoint.is_some()) {
                                #[allow(unused_variables)]
if let Some(region) = region { #[allow(unused_variables)]
if let Some(partition_result) = partition_resolver.resolve_partition(region, _diagnostic_collector) { if !((partition_result.name()) == ("aws-iso")) {
                                if !((partition_result.name()) == ("aws-iso-b")) {
                                #[allow(unused_variables)]
if let Some(arn) = crate::endpoint_lib::arn::parse_arn(resource_arn, _diagnostic_collector) { if crate::endpoint_lib::host::is_valid_host_label(arn.account_id()
,false, _diagnostic_collector) {
                                if crate::endpoint_lib::host::is_valid_host_label(arn.region()
,false, _diagnostic_collector) {
                                if (arn.service()) == ("kinesis") {
