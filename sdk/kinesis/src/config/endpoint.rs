...
mod test {
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Failed to parse ARN. [ResourceARN as StreamARN test: Invalid ARN: partition missing from ARN.]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Failed to parse ARN.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Invalid region. [ResourceARN as StreamARN test: Invalid ARN: Region is missing in ARN]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Invalid region.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Invalid region. [ResourceARN as StreamARN test: Invalid ARN: Region is empty string in ARN]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Invalid region.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Invalid account id. [ResourceARN as StreamARN test: Invalid ARN: Invalid account id]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Invalid account id.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Failed to parse ARN. [ResourceARN as ConsumerARN test: Invalid ARN: partition missing from ARN.]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Failed to parse ARN.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Invalid region. [ResourceARN as ConsumerARN test: Invalid ARN: Region is missing in ARN]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Invalid region.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Invalid region. [ResourceARN as ConsumerARN test: Invalid ARN: Region is empty string in ARN]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Invalid region.")
                    }
    ...
    .build().expect("invalid params");
                        let resolver = crate::config::endpoint::DefaultResolver::new();
                        let endpoint = resolver.resolve_endpoint(&params);
                        let error = endpoint.expect_err("expected error: Invalid ARN: Invalid account id. [ResourceARN as ConsumerARN test: Invalid ARN: Invalid account id]");
                                    assert_eq!(format!("{}", error), "Invalid ARN: Invalid account id.")
                    }
