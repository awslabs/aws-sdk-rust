...
impl InviteMembersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::invite_members::InviteMembers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_invite_members::ser_invite_members_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for InviteMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_invite_members::de_invite_members_http_response_with_props(status, headers, body)
        }
    }
}
