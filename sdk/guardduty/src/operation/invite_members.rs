...
impl InviteMembersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::invite_members::InviteMembers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InviteMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_invite_members::de_invite_members_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_invite_members::de_invite_members_http_response_with_props(
                status, headers, body,
            )
        }
    }
