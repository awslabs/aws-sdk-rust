    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/detector/{DetectorId}", DetectorId = detector_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_detector::DeleteDetector::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDetector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_detector::de_delete_detector_http_error(
                status, headers, body,
            )
        } else {
