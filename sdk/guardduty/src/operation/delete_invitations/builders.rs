...
impl DeleteInvitationsFluentBuilder  {
    /// Creates a new `DeleteInvitations`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_invitations::DeleteInvitationsOutput, aws_smithy_http::result::SdkError<crate::operation::delete_invitations::DeleteInvitationsError>>
                     {
