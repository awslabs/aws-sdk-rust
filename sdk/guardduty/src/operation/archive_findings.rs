...
impl ArchiveFindingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::archive_findings::ArchiveFindings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_archive_findings::ser_archive_findings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ArchiveFindings {
    type Output =
        ::std::result::Result<crate::operation::archive_findings::ArchiveFindingsOutput, crate::operation::archive_findings::ArchiveFindingsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_archive_findings::de_archive_findings_http_response_with_props(status, headers, body)
        }
    }
}
