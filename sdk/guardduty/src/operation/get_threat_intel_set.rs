...
impl GetThreatIntelSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_threat_intel_set::GetThreatIntelSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetThreatIntelSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_threat_intel_set::de_get_threat_intel_set_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_threat_intel_set::GetThreatIntelSetError
{
