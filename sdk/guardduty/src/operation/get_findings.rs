...
impl GetFindingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_findings::GetFindings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_findings::ser_get_findings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_findings::de_get_findings_http_response_with_props(status, headers, body)
        }
    }
}
