...
impl GetCoverageStatisticsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_coverage_statistics::GetCoverageStatisticsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
