...
impl GetRemainingFreeTrialDaysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_remaining_free_trial_days::GetRemainingFreeTrialDaysInput, ::aws_smithy_types::error::operation::BuildError> {
