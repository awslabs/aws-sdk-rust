...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePublishingDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_publishing_destination::de_describe_publishing_destination_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_publishing_destination::DescribePublishingDestinationError
{
