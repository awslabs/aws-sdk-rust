...
impl DescribePublishingDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_publishing_destination::DescribePublishingDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePublishingDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_publishing_destination::de_describe_publishing_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
