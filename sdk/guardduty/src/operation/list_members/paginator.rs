...
/// Paginator for [`ListMembers`](crate::operation::list_members::ListMembers)
pub struct ListMembersPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_members::builders::ListMembersInputBuilder,
...
impl ListMembersPaginator {
    ...
    pub fn items(self) -> crate::operation::list_members::paginator::ListMembersPaginatorItems {
        crate::operation::list_members::paginator::ListMembersPaginatorItems(self)
    }
...
impl ListMembersPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Member, ::aws_smithy_http::result::SdkError<crate::operation::list_members::ListMembersError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_members_output_members(page).unwrap_or_default().into_iter())
    }
}
