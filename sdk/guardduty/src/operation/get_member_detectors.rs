...
impl GetMemberDetectorsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_member_detectors::ser_get_member_detectors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMemberDetectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_member_detectors::de_get_member_detectors_http_response_with_props(status, headers, body)
        }
    }
}
