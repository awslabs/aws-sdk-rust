...
/// Orchestration and serialization glue logic for `GetMemberDetectors`.
...
impl GetMemberDetectors {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_member_detectors::GetMemberDetectorsInput,
                    ) -> ::std::result::Result<crate::operation::get_member_detectors::GetMemberDetectorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_member_detectors::GetMemberDetectorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_member_detectors::GetMemberDetectorsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_member_detectors::GetMemberDetectorsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMemberDetectors {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMemberDetectors");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMemberDetectorsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMemberDetectorsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMemberDetectors")
...
.with_interceptor(GetMemberDetectorsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_member_detectors::GetMemberDetectorsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_member_detectors::GetMemberDetectorsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_member_detectors::GetMemberDetectorsError>::new());
...
#[derive(Debug)]
            struct GetMemberDetectorsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMemberDetectorsResponseDeserializer {
...
#[derive(Debug)]
            struct GetMemberDetectorsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMemberDetectorsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_member_detectors::GetMemberDetectorsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_member_detectors::GetMemberDetectorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/detector/{DetectorId}/member/detector/get", DetectorId = detector_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_member_detectors::ser_get_member_detectors_input(&input)?);
...
#[derive(Debug)]
            struct GetMemberDetectorsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMemberDetectorsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetMemberDetectorsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMemberDetectorsInput>()
                        .ok_or("failed to downcast to GetMemberDetectorsInput")?;
...
pub enum GetMemberDetectorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMemberDetectorsError) for what information is available for the error.")]
...
impl GetMemberDetectorsError {
    /// Creates the `GetMemberDetectorsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMemberDetectorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMemberDetectorsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_member_detectors::GetMemberDetectorsError {
...
mod _get_member_detectors_output;
