...
impl ListFindingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_findings::ListFindings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_findings::ser_list_findings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_findings::de_list_findings_http_response_with_props(status, headers, body)
        }
    }
}
