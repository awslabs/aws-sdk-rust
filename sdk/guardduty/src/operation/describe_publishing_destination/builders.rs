...
impl DescribePublishingDestinationFluentBuilder  {
    /// Creates a new `DescribePublishingDestination`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_publishing_destination::DescribePublishingDestinationOutput, aws_smithy_http::result::SdkError<crate::operation::describe_publishing_destination::DescribePublishingDestinationError>>
                     {
