...
impl ListPublishingDestinationsFluentBuilder  {
    /// Creates a new `ListPublishingDestinations`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_publishing_destinations::ListPublishingDestinationsOutput, aws_smithy_http::result::SdkError<crate::operation::list_publishing_destinations::ListPublishingDestinationsError>>
                     {
