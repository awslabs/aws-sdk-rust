...
impl ListPublishingDestinationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_publishing_destinations::ListPublishingDestinationsInput, ::aws_smithy_types::error::operation::BuildError> {
