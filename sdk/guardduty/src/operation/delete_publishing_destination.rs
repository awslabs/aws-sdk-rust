...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePublishingDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_publishing_destination::de_delete_publishing_destination_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeletePublishingDestinationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_publishing_destination::DeletePublishingDestinationError
{
