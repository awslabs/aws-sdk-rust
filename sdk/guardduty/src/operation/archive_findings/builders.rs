...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::archive_findings::ArchiveFindingsOutput,
                    crate::operation::archive_findings::ArchiveFindingsError,
                > for ArchiveFindingsFluentBuilder
            {
                fn send(
                    self,
...
impl ArchiveFindingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::archive_findings::ArchiveFindingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::archive_findings::ArchiveFindingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::archive_findings::ArchiveFindingsOutput, crate::operation::archive_findings::ArchiveFindingsError, Self> {
