...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePublishingDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_publishing_destination::de_update_publishing_destination_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdatePublishingDestinationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_publishing_destination::UpdatePublishingDestinationError
{
