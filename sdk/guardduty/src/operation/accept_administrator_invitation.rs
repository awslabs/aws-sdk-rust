...
impl AcceptAdministratorInvitationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_administrator_invitation::AcceptAdministratorInvitation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptAdministratorInvitation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_administrator_invitation::de_accept_administrator_invitation_http_response_with_props(
                status, headers, body,
            )
        }
    }
