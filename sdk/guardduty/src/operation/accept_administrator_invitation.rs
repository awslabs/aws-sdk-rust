...
/// Orchestration and serialization glue logic for `AcceptAdministratorInvitation`.
...
impl AcceptAdministratorInvitation {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationInput,
                    ) -> ::std::result::Result<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptAdministratorInvitation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AcceptAdministratorInvitation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AcceptAdministratorInvitationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AcceptAdministratorInvitationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptAdministratorInvitation")
...
.with_interceptor(AcceptAdministratorInvitationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_accept_administrator_invitation::de_accept_administrator_invitation_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_accept_administrator_invitation::de_accept_administrator_invitation_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptAdministratorInvitationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/detector/{DetectorId}/administrator", DetectorId = detector_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_accept_administrator_invitation::ser_accept_administrator_invitation_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptAdministratorInvitationEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AcceptAdministratorInvitationInput>()
                        .ok_or("failed to downcast to AcceptAdministratorInvitationInput")?;
...
pub enum AcceptAdministratorInvitationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AcceptAdministratorInvitationError) for what information is available for the error.")]
...
impl AcceptAdministratorInvitationError {
    /// Creates the `AcceptAdministratorInvitationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AcceptAdministratorInvitationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AcceptAdministratorInvitationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AcceptAdministratorInvitationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError {
...
mod _accept_administrator_invitation_output;
