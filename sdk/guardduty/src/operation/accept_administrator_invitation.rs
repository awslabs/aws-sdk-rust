...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptAdministratorInvitation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_administrator_invitation::de_accept_administrator_invitation_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationError
{
