...
impl ListThreatIntelSetsFluentBuilder  {
    /// Creates a new `ListThreatIntelSets`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_threat_intel_sets::ListThreatIntelSetsOutput, aws_smithy_http::result::SdkError<crate::operation::list_threat_intel_sets::ListThreatIntelSetsError>>
                     {
