...
impl CreateDetectorInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_detector::CreateDetector::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDetector {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_detector::de_create_detector_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_detector::de_create_detector_http_response(
                status, headers, body,
            )
        }
    }
