...
impl CreateThreatIntelSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_threat_intel_set::CreateThreatIntelSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_threat_intel_set::CreateThreatIntelSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_threat_intel_set::CreateThreatIntelSetOutput, crate::operation::create_threat_intel_set::CreateThreatIntelSetError, Self> {
