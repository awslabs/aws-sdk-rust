...
impl DisassociateMembersInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_members::ser_disassociate_members_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_members::de_disassociate_members_http_response_with_props(status, headers, body)
        }
    }
}
