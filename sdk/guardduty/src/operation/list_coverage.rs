...
impl ListCoverageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_coverage::ListCoverage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCoverage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_coverage::de_list_coverage_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_coverage::de_list_coverage_http_response_with_props(
                status, headers, body,
            )
        }
    }
