...
impl ListCoverageInput {
    /// Consumes the builder and constructs an Operation<[`ListCoverage`](crate::operation::list_coverage::ListCoverage)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_coverage::ListCoverage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_coverage::ser_list_coverage_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_coverage::ListCoverage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListCoverage", "guardduty"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCoverage {
    type Output = ::std::result::Result<crate::operation::list_coverage::ListCoverageOutput, crate::operation::list_coverage::ListCoverageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_coverage::de_list_coverage_http_response_with_props(status, headers, body)
        }
    }
}
