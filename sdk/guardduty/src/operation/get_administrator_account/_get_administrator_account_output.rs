...
impl ::aws_types::request_id::RequestId for GetAdministratorAccountOutput {
...
impl GetAdministratorAccountOutputBuilder {
    ...
    pub fn administrator(mut self, input: crate::types::Administrator) -> Self {
        self.administrator = ::std::option::Option::Some(input);
        self
    }
    /// <p>The administrator account details.</p>
    ...
    /// <p>The administrator account details.</p>
    pub fn get_administrator(&self) -> &::std::option::Option<crate::types::Administrator> {
        &self.administrator
    }
