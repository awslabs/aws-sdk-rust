...
impl CreatePublishingDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_publishing_destination::CreatePublishingDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePublishingDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_publishing_destination::de_create_publishing_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
