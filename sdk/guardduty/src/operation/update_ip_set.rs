...
impl UpdateIpSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_ip_set::UpdateIPSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIPSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_ip_set::de_update_ip_set_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_ip_set::de_update_ip_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
