...
impl UnarchiveFindingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::unarchive_findings::UnarchiveFindings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnarchiveFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_unarchive_findings::de_unarchive_findings_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::unarchive_findings::UnarchiveFindingsError
{
