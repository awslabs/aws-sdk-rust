...
impl GetUsageStatisticsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_usage_statistics::ser_get_usage_statistics_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUsageStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_usage_statistics::de_get_usage_statistics_http_response_with_props(status, headers, body)
        }
    }
}
