...
impl GetFindingsStatisticsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_findings_statistics::GetFindingsStatisticsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_findings_statistics::GetFindingsStatisticsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_findings_statistics::GetFindingsStatisticsOutput, crate::operation::get_findings_statistics::GetFindingsStatisticsError, Self> {
