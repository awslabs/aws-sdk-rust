...
///
///
/// _Note: `Confidence::Unknown` has been renamed to `::UnknownValue`._
#[non_exhaustive]
#[derive(
...
impl ::std::convert::From<&str> for Confidence {
    fn from(s: &str) -> Self {
        match s {
            ...
            "Unknown" => Confidence::UnknownValue,
...
impl Confidence {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Confidence::UnknownValue => "Unknown",
...
impl ::std::fmt::Display for Confidence {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            Confidence::UnknownValue => write!(f, "Unknown"),
