...
impl ::std::str::FromStr for UsageStatisticType {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(UsageStatisticType::from(s))
                    }
                }
impl UsageStatisticType {
    ...
    UsageStatisticType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["SUM_BY_ACCOUNT", "SUM_BY_DATA_SOURCE", "SUM_BY_FEATURES", "SUM_BY_RESOURCE", "TOP_ACCOUNTS_BY_FEATURE", "TOP_RESOURCES"]
                }
            }
impl ::std::convert::AsRef<str> for UsageStatisticType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
