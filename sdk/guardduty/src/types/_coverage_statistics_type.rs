...
other => CoverageStatisticsType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
impl std::str::FromStr for CoverageStatisticsType {
                ...
                fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
                    Ok(CoverageStatisticsType::from(s))
                }
            }
...
impl AsRef<str> for CoverageStatisticsType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
