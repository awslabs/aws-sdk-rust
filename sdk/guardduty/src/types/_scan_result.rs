...
impl ::std::convert::From<&str> for ScanResult {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ScanResult::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ScanResult {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ScanResult::from(s))
    }
}
impl ScanResult {
...
impl ::std::convert::AsRef<str> for ScanResult {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
