...
impl CoverageFilterCriterionKey {
    ...
    CoverageFilterCriterionKey::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["ACCOUNT_ID", "ADDON_VERSION", "AGENT_VERSION", "CLUSTER_ARN", "CLUSTER_NAME", "COVERAGE_STATUS", "ECS_CLUSTER_NAME", "EKS_CLUSTER_NAME", "INSTANCE_ID", "MANAGEMENT_TYPE", "RESOURCE_TYPE"]
                }
            }
