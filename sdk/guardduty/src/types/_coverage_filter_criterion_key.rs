...
impl std::convert::From<&str> for CoverageFilterCriterionKey {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CoverageFilterCriterionKey::Unknown(crate::primitives::UnknownVariantValue(
                other.to_owned(),
            )),
        }
    }
...
impl std::str::FromStr for CoverageFilterCriterionKey {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Ok(CoverageFilterCriterionKey::from(s))
    }
}
...
impl AsRef<str> for CoverageFilterCriterionKey {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
