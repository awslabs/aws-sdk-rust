...
impl OrganizationFeatureStatisticsBuilder {
    ...
    /// <p>Name of the additional configuration.</p>
    pub fn set_additional_configuration(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::OrganizationFeatureStatisticsAdditionalConfiguration>>) -> Self {
        self.additional_configuration = input; self
    }
    /// <p>Name of the additional configuration.</p>
    pub fn get_additional_configuration(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::OrganizationFeatureStatisticsAdditionalConfiguration>> {
