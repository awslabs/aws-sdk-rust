...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::get_member_detectors::builders::GetMemberDetectorsFluentBuilder::account_ids) / [`set_account_ids(Option<Vec::<String>>)`](crate::operation::get_member_detectors::builders::GetMemberDetectorsFluentBuilder::set_account_ids):<br>required: **true**<br><p>The account ID of the member account.</p><br>
