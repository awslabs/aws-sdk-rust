...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::list_filters::builders::ListFiltersFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::list_filters::builders::ListFiltersFluentBuilder::set_detector_id):<br>required: **true**<br><p>The unique ID of the detector that the filter is associated with.</p><br>
