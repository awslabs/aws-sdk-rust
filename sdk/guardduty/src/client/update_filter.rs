...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::update_filter::builders::UpdateFilterFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::update_filter::builders::UpdateFilterFluentBuilder::set_detector_id): <p>The unique ID of the detector that specifies the GuardDuty service where you want to update a filter.</p>
    ///   - [`filter_name(impl ::std::convert::Into<String>)`](crate::operation::update_filter::builders::UpdateFilterFluentBuilder::filter_name) / [`set_filter_name(Option<String>)`](crate::operation::update_filter::builders::UpdateFilterFluentBuilder::set_filter_name): <p>The name of the filter.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_filter::builders::UpdateFilterFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_filter::builders::UpdateFilterFluentBuilder::set_description): <p>The description of the filter. Valid characters include alphanumeric characters, and special characters such as hyphen, period, colon, underscore, parentheses (<code>{ }</code>, <code>[ ]</code>, and <code>( )</code>), forward slash, horizontal tab, vertical tab, newline, form feed, return, and whitespace.</p>
