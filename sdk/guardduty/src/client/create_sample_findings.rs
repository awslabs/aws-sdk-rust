...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::create_sample_findings::builders::CreateSampleFindingsFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::create_sample_findings::builders::CreateSampleFindingsFluentBuilder::set_detector_id): <p>The ID of the detector to create sample findings for.</p>
