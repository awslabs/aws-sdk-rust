...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::get_threat_intel_set::builders::GetThreatIntelSetFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::get_threat_intel_set::builders::GetThreatIntelSetFluentBuilder::set_detector_id):<br>required: **true**<br><p>The unique ID of the detector that the threatIntelSet is associated with.</p><br>
