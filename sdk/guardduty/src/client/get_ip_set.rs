...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::get_ip_set::builders::GetIPSetFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::get_ip_set::builders::GetIPSetFluentBuilder::set_detector_id): <p>The unique ID of the detector that the IPSet is associated with.</p>
    ///   - [`ip_set_id(impl ::std::convert::Into<String>)`](crate::operation::get_ip_set::builders::GetIPSetFluentBuilder::ip_set_id) / [`set_ip_set_id(Option<String>)`](crate::operation::get_ip_set::builders::GetIPSetFluentBuilder::set_ip_set_id): <p>The unique ID of the IPSet to retrieve.</p>
