...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::archive_findings::builders::ArchiveFindingsFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::archive_findings::builders::ArchiveFindingsFluentBuilder::set_detector_id):<br>required: **true**<br><p>The ID of the detector that specifies the GuardDuty service whose findings you want to archive.</p> <p>To find the <code>detectorId</code> in the current Region, see the Settings page in the GuardDuty console, or run the <a href="https://docs.aws.amazon.com/guardduty/latest/APIReference/API_ListDetectors.html">ListDetectors</a> API.</p><br>
