...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::archive_findings::builders::ArchiveFindingsFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::archive_findings::builders::ArchiveFindingsFluentBuilder::set_detector_id): <p>The ID of the detector that specifies the GuardDuty service whose findings you want to archive.</p>
