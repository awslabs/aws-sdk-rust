...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::list_ip_sets::builders::ListIPSetsFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::list_ip_sets::builders::ListIPSetsFluentBuilder::set_detector_id): <p>The unique ID of the detector that the IPSet is associated with.</p>
