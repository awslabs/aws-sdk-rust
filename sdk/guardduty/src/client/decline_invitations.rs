...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::decline_invitations::builders::DeclineInvitationsFluentBuilder::account_ids) / [`set_account_ids(Option<Vec::<String>>)`](crate::operation::decline_invitations::builders::DeclineInvitationsFluentBuilder::set_account_ids):<br>required: **true**<br><p>A list of account IDs of the Amazon Web Services accounts that sent invitations to the current member account that you want to decline invitations from.</p><br>
