...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::update_ip_set::builders::UpdateIPSetFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::update_ip_set::builders::UpdateIPSetFluentBuilder::set_detector_id):<br>required: **true**<br><p>The detectorID that specifies the GuardDuty service whose IPSet you want to update.</p> <p>To find the <code>detectorId</code> in the current Region, see the Settings page in the GuardDuty console, or run the <a href="https://docs.aws.amazon.com/guardduty/latest/APIReference/API_ListDetectors.html">ListDetectors</a> API.</p><br>
    ...
    ///   - [`expected_bucket_owner(impl Into<String>)`](crate::operation::update_ip_set::builders::UpdateIPSetFluentBuilder::expected_bucket_owner) / [`set_expected_bucket_owner(Option<String>)`](crate::operation::update_ip_set::builders::UpdateIPSetFluentBuilder::set_expected_bucket_owner):<br>required: **false**<br><p>The Amazon Web Services account ID that owns the Amazon S3 bucket specified in the <b>location</b> parameter.</p><br>
