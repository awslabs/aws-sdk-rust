...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_tags): <p>The tags to be added to a new detector resource.</p>
