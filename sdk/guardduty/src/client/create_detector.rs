...
impl super::Client {
    ...
    ///   - [`enable(bool)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::enable) / [`set_enable(Option<bool>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_enable):<br>required: **true**<br><p>A Boolean value that specifies whether the detector is to be enabled.</p><br>
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_client_token):<br>required: **false**<br><p>The idempotency token for the create request.</p><br>
    ///   - [`finding_publishing_frequency(FindingPublishingFrequency)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::finding_publishing_frequency) / [`set_finding_publishing_frequency(Option<FindingPublishingFrequency>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_finding_publishing_frequency):<br>required: **false**<br><p>A value that specifies how frequently updated findings are exported.</p><br>
    ///   - [`data_sources(DataSourceConfigurations)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::data_sources) / [`set_data_sources(Option<DataSourceConfigurations>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_data_sources):<br>required: **false**<br><p>Describes which data sources will be enabled for the detector.</p> <p>There might be regional differences because some data sources might not be available in all the Amazon Web Services Regions where GuardDuty is presently supported. For more information, see <a href="https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_regions.html">Regions and endpoints</a>.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_tags):<br>required: **false**<br><p>The tags to be added to a new detector resource.</p><br>
    ///   - [`features(DetectorFeatureConfiguration)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::features) / [`set_features(Option<Vec::<DetectorFeatureConfiguration>>)`](crate::operation::create_detector::builders::CreateDetectorFluentBuilder::set_features):<br>required: **false**<br><p>A list of features that will be configured for the detector.</p><br>
