...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::delete_publishing_destination::builders::DeletePublishingDestinationFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::delete_publishing_destination::builders::DeletePublishingDestinationFluentBuilder::set_detector_id): <p>The unique ID of the detector associated with the publishing destination to delete.</p>
