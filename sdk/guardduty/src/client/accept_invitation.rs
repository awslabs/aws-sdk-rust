...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::set_detector_id): <p>The unique ID of the detector of the GuardDuty member account.</p>
    ///   - [`master_id(impl ::std::convert::Into<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::master_id) / [`set_master_id(Option<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::set_master_id): <p>The account ID of the GuardDuty administrator account whose invitation you're accepting.</p>
