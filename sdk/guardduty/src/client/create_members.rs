...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::create_members::builders::CreateMembersFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::create_members::builders::CreateMembersFluentBuilder::set_detector_id):<br>required: **true**<br><p>The unique ID of the detector of the GuardDuty account that you want to associate member accounts with.</p><br>
    ///   - [`account_details(AccountDetail)`](crate::operation::create_members::builders::CreateMembersFluentBuilder::account_details) / [`set_account_details(Option<Vec::<AccountDetail>>)`](crate::operation::create_members::builders::CreateMembersFluentBuilder::set_account_details):<br>required: **true**<br><p>A list of account ID and email address pairs of the accounts that you want to associate with the GuardDuty administrator account.</p><br>
