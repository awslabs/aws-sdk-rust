...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::unarchive_findings::builders::UnarchiveFindingsFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::unarchive_findings::builders::UnarchiveFindingsFluentBuilder::set_detector_id): <p>The ID of the detector associated with the findings to unarchive.</p>
