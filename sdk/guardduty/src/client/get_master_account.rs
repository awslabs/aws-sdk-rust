...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::get_master_account::builders::GetMasterAccountFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::get_master_account::builders::GetMasterAccountFluentBuilder::set_detector_id):<br>required: **true**<br><p>The unique ID of the detector of the GuardDuty member account.</p><br>
