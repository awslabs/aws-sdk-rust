...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::update_detector::builders::UpdateDetectorFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::update_detector::builders::UpdateDetectorFluentBuilder::set_detector_id): <p>The unique ID of the detector to update.</p>
    ///   - [`enable(bool)`](crate::operation::update_detector::builders::UpdateDetectorFluentBuilder::enable) / [`set_enable(Option<bool>)`](crate::operation::update_detector::builders::UpdateDetectorFluentBuilder::set_enable): <p>Specifies whether the detector is enabled or not enabled.</p>
