...
pub fn ser_create_detector_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDetectorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
