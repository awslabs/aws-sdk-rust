...
pub fn ser_filter_criterion(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilterCriterion) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
