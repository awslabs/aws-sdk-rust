...
pub fn ser_create_custom_detection_rule_association_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::create_custom_detection_rule_association::CreateCustomDetectionRuleAssociationInput,
