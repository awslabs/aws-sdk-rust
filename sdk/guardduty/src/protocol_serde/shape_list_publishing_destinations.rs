...
pub fn de_list_publishing_destinations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_publishing_destinations::ListPublishingDestinationsOutput, crate::operation::list_publishing_destinations::ListPublishingDestinationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_publishing_destinations::ListPublishingDestinationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_publishing_destinations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_publishing_destinations::ListPublishingDestinationsOutput, crate::operation::list_publishing_destinations::ListPublishingDestinationsError> {
    Ok({
        #[allow(unused_mut)]
