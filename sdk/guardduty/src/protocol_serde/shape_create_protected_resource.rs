...
pub fn ser_create_protected_resource(
    ...
    if let Some(var_1) = &input.s3_bucket {
        ...
        crate::protocol_serde::shape_create_s3_bucket_resource::ser_create_s3_bucket_resource(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::CreateProtectedResourceBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "s3Bucket" => {
                            builder = builder.set_s3_bucket(crate::protocol_serde::shape_create_s3_bucket_resource::de_create_s3_bucket_resource(
                                tokens,
                            )?);
                        }
