...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_publishing_destination::DeletePublishingDestinationError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::delete_publishing_destination::DeletePublishingDestinationError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
