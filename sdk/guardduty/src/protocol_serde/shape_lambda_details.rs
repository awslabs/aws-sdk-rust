...
pub(crate) fn de_lambda_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LambdaDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
