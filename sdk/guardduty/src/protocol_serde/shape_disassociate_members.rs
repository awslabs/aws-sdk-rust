            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DisassociateMembersError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_server_error_exception::de_internal_server_error_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DisassociateMembersError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
pub fn de_disassociate_members_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisassociateMembersOutput, crate::error::DisassociateMembersError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_disassociate_members::de_disassociate_members(response.body().as_ref(), output).map_err(crate::error::DisassociateMembersError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_disassociate_members(value: &[u8], mut builder: crate::output::disassociate_members_output::Builder) -> Result<crate::output::disassociate_members_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
