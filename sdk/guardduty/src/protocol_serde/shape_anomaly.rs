            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "profiles" => {
                            builder = builder.set_profiles(crate::protocol_serde::shape_anomaly_profiles::de_anomaly_profiles(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "unusual" => {
                            builder = builder.set_unusual(crate::protocol_serde::shape_anomaly_unusual::de_anomaly_unusual(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
