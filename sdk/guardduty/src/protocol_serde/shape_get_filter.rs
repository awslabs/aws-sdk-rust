...
pub fn de_get_filter_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_filter::GetFilterOutput, crate::operation::get_filter::GetFilterError> {
    #[allow(unused_mut)]
...
pub fn de_get_filter_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_filter::de_get_filter(_response_body, output)
            .map_err(crate::operation::get_filter::GetFilterError::unhandled)?;
...
) -> Result<crate::operation::get_filter::builders::GetFilterOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
