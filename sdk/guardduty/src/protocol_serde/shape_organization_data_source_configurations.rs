...
pub fn ser_organization_data_source_configurations(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OrganizationDataSourceConfigurations) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
