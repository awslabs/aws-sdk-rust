...
pub fn ser_usage_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UsageCriteria) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
