...
impl DeleteClusterPolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DSQL", "DeleteClusterPolicy", input, runtime_plugins, stop_point)
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::delete_cluster_policy::DeleteClusterPolicyInput = input.downcast_mut().expect("correct type");
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteClusterPolicy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteClusterPolicyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteClusterPolicyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteClusterPolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteClusterPolicyInput>() else {
        ...
        if requested.should_capture("expectedPolicyVersion") {
            if let ::std::option::Option::Some(value) = input.expected_policy_version.as_deref() {
                captured.insert("expectedPolicyVersion", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteClusterPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_cluster_policy::de_delete_cluster_policy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_cluster_policy::de_delete_cluster_policy_http_response(status, headers, body, _cfg)
        };
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.expected_policy_version {
                    {
                        query.push_kv("expected-policy-version", &::aws_smithy_http::query::fmt_string(inner_2));
                    }
                }
...
impl DeleteClusterPolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteClusterPolicyError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteClusterPolicyError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteClusterPolicyError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
    /// Returns `true` if the error kind is `DeleteClusterPolicyError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeleteClusterPolicyError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `DeleteClusterPolicyError::ThrottlingException`.
