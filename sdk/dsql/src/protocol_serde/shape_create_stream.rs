...
pub fn de_create_stream_http_error(
    ...
    Err(match error_code {
        "ConflictException" => crate::operation::create_stream::CreateStreamError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::create_stream::CreateStreamError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::create_stream::CreateStreamError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "AccessDeniedException" => crate::operation::create_stream::CreateStreamError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::create_stream::CreateStreamError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::create_stream::CreateStreamError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
        ...
        "ThrottlingException" => crate::operation::create_stream::CreateStreamError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_create_stream_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_stream_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_stream::CreateStreamError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "format" => {
                    builder = builder.set_format(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::StreamFormat::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "ordering" => {
                    builder = builder.set_ordering(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::StreamOrdering::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "status" => {
                ...
                "streamIdentifier" => {
                    builder = builder.set_stream_identifier(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                            .transpose()?,
                    );
