...
impl super::Client  {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::set_next_token): <p>The page token from the previous response output when you request subsequent pages.</p>
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::set_account_id): <p>The identifier for the AWS account that is assigned to the user.</p>
