...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::set_next_token): <p>The page token from the previous response output when you request subsequent pages.</p>
    ///   - [`max_results(i32)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::set_max_results): <p>The number of items that clients can request per page.</p>
    ///   - [`access_token(impl ::std::convert::Into<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::access_token) / [`set_access_token(Option<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::set_access_token): <p>The token issued by the <code>CreateToken</code> API call. For more information, see <a href="https://docs.aws.amazon.com/singlesignon/latest/OIDCAPIReference/API_CreateToken.html">CreateToken</a> in the <i>IAM Identity Center OIDC API Reference Guide</i>.</p>
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_account_roles::builders::ListAccountRolesFluentBuilder::set_account_id): <p>The identifier for the AWS account that is assigned to the user.</p>
