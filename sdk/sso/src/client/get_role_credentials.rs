...
impl super::Client  {
    ...
    ///   - [`role_name(impl Into<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::set_role_name): <p>The friendly name of the role that is assigned to the user.</p>
    ///   - [`account_id(impl Into<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::set_account_id): <p>The identifier for the AWS account that is assigned to the user.</p>
