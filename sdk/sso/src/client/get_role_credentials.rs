...
impl super::Client {
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::set_role_name): <p>The friendly name of the role that is assigned to the user.</p>
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::set_account_id): <p>The identifier for the AWS account that is assigned to the user.</p>
    ///   - [`access_token(impl ::std::convert::Into<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::access_token) / [`set_access_token(Option<String>)`](crate::operation::get_role_credentials::builders::GetRoleCredentialsFluentBuilder::set_access_token): <p>The token issued by the <code>CreateToken</code> API call. For more information, see <a href="https://docs.aws.amazon.com/singlesignon/latest/OIDCAPIReference/API_CreateToken.html">CreateToken</a> in the <i>IAM Identity Center OIDC API Reference Guide</i>.</p>
