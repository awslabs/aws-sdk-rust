...
pub(crate) fn de_role_credentials<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::RoleCredentials>, aws_smithy_json::deserialize::error::DeserializeError>
