            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_account_roles_output_next_token(resp);
...
impl ListAccountRolesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_account_roles_output_role_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListAccountsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_accounts_output_account_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
