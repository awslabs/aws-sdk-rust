...
pub(crate) fn reflens_list_account_roles_output_next_token(
...
pub(crate) fn lens_list_account_roles_output_role_list(
    input: crate::operation::list_account_roles::ListAccountRolesOutput,
...
pub(crate) fn lens_list_accounts_output_account_list(
    input: crate::operation::list_accounts::ListAccountsOutput,
