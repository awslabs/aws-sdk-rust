...
pub mod get_role_credentials_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetRoleCredentialsInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl GetRoleCredentialsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetRoleCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::GetRoleCredentialsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/federation/credentials").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::GetRoleCredentialsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_1 = &_input.role_name;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("role_name", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("role_name", "cannot be empty or unset"));
                }
                query.push_kv("role_name", &aws_smithy_http::query::fmt_string(&inner_1));
                let inner_2 = &_input.account_id;
                let inner_2 = inner_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("account_id", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetRoleCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRoleCredentials", "sso"));
...
pub mod list_account_roles_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListAccountRolesInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl ListAccountRolesInput {
    ...
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListAccountRoles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let params_result = crate::endpoint::Params::builder().set_region(_config.region.as_ref().map(|r|r.as_ref().to_owned()))
        .set_use_dual_stack(_config.use_dual_stack)
        .set_use_fips(_config.use_fips)
        .set_endpoint(_config.endpoint_url
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::ListAccountRolesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/assignment/roles").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListAccountRolesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_4) = &_input.max_results {
                    if *inner_4 != 0 {
                        query.push_kv("max_result", aws_smithy_types::primitive::Encoder::from(*inner_4).encode());
                    }
                }
                let inner_5 = &_input.account_id;
                let inner_5 = inner_5.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("account_id", "cannot be empty or unset"))?;
                if inner_5.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("account_id", "cannot be empty or unset"));
                }
        ...
        aws_http::auth::set_credentials_cache(&mut request.properties_mut(), _config.credentials_cache.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ListAccountRoles::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAccountRoles", "sso"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod list_accounts_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListAccountsInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl ListAccountsInput {
    ...
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListAccounts, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let params_result = crate::endpoint::Params::builder().set_region(_config.region.as_ref().map(|r|r.as_ref().to_owned()))
        .set_use_dual_stack(_config.use_dual_stack)
        .set_use_fips(_config.use_fips)
        .set_endpoint(_config.endpoint_url
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::ListAccountsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/assignment/accounts").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListAccountsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_7) = &_input.max_results {
                    if *inner_7 != 0 {
                        query.push_kv("max_result", aws_smithy_types::primitive::Encoder::from(*inner_7).encode());
                    }
                }
                Ok(())
            }
        ...
        aws_http::auth::set_credentials_cache(&mut request.properties_mut(), _config.credentials_cache.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ListAccounts::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAccounts", "sso"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod logout_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::LogoutInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
                crate::input::LogoutInput {
                    access_token: self.access_token
                    ,
                }
            )
...
impl LogoutInput {
    ...
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::Logout, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let params_result = crate::endpoint::Params::builder().set_region(_config.region.as_ref().map(|r|r.as_ref().to_owned()))
        .set_use_dual_stack(_config.use_dual_stack)
        .set_use_fips(_config.use_fips)
        .set_endpoint(_config.endpoint_url
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::LogoutInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        aws_http::auth::set_credentials_cache(&mut request.properties_mut(), _config.credentials_cache.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::Logout::new())
