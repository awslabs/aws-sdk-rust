...
pub struct ListAccountsOutput  {
    ...
    #[doc(hidden)]pub account_list: std::option::Option<std::vec::Vec<crate::model::AccountInfo>>,
}
...
pub struct ListAccountRolesOutput  {
    ...
    #[doc(hidden)]pub role_list: std::option::Option<std::vec::Vec<crate::model::RoleInfo>>,
}
...
pub struct GetRoleCredentialsOutput  {
    ...
    #[doc(hidden)]pub role_credentials: std::option::Option<crate::model::RoleCredentials>,
}
