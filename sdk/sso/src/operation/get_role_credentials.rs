...
impl GetRoleCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`GetRoleCredentials`](crate::operation::get_role_credentials::GetRoleCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_role_credentials::GetRoleCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_role_credentials::GetRoleCredentialsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/federation/credentials").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_role_credentials::GetRoleCredentialsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_role_credentials::GetRoleCredentials::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRoleCredentials {
                type Output = std::result::Result<crate::operation::get_role_credentials::GetRoleCredentialsOutput, crate::operation::get_role_credentials::GetRoleCredentialsError>;
