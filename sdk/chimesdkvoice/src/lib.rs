...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("chimesdkvoice", crate::PKG_VERSION);
...
/// Client and fluent builders for calling Amazon Chime SDK Voice.
pub mod client;
