...
pub fn ser_create_sip_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSipRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
