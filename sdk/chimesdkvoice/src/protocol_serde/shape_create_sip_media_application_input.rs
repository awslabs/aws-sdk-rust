...
pub fn ser_create_sip_media_application_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSipMediaApplicationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
