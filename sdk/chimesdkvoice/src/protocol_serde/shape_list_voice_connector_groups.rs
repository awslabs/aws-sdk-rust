...
pub fn de_list_voice_connector_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListVoiceConnectorGroupsOutput, crate::error::ListVoiceConnectorGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListVoiceConnectorGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_voice_connector_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListVoiceConnectorGroupsOutput, crate::error::ListVoiceConnectorGroupsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_list_voice_connector_groups(value: &[u8], mut builder: crate::output::list_voice_connector_groups_output::Builder) -> Result<crate::output::list_voice_connector_groups_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
