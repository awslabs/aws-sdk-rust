...
pub fn de_get_voice_connector_proxy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetVoiceConnectorProxyOutput, crate::error::GetVoiceConnectorProxyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetVoiceConnectorProxyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_voice_connector_proxy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetVoiceConnectorProxyOutput, crate::error::GetVoiceConnectorProxyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_voice_connector_proxy_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_voice_connector_proxy::de_get_voice_connector_proxy(response.body().as_ref(), output).map_err(crate::error::GetVoiceConnectorProxyError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_voice_connector_proxy(value: &[u8], mut builder: crate::output::get_voice_connector_proxy_output::Builder) -> Result<crate::output::get_voice_connector_proxy_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
