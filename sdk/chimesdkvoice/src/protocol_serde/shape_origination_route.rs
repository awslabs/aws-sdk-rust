...
pub fn ser_origination_route(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OriginationRoute) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_origination_route<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OriginationRoute>, aws_smithy_json::deserialize::error::DeserializeError>
