                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "StreamingNotificationTargets" => {
                            builder = builder.set_streaming_notification_targets(
                                crate::protocol_serde::shape_streaming_notification_target_list::de_streaming_notification_target_list(
                                    tokens, _value,
                                )?,
                            );
                        }
                        "MediaInsightsConfiguration" => {
                            builder = builder.set_media_insights_configuration(
                                crate::protocol_serde::shape_media_insights_configuration::de_media_insights_configuration(tokens, _value)?,
                            );
                        }
