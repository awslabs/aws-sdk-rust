...
pub(crate) fn de_streaming_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StreamingConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_streaming_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StreamingConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
