...
pub fn ser_create_voice_profile_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
