...
impl UpdateVoiceProfileDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainOutput, crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainError, Self> {
