...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for PutVoiceConnectorEmergencyCallingConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for PutVoiceConnectorEmergencyCallingConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_voice_connector_emergency_calling_configuration::ser_put_voice_connector_emergency_calling_configuration_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutVoiceConnectorEmergencyCallingConfigurationEndpointParamsInterceptor {
