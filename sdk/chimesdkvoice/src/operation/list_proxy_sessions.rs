...
impl aws_smithy_http::response::ParseStrictResponse for ListProxySessions {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_proxy_sessions::de_list_proxy_sessions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_proxy_sessions::de_list_proxy_sessions_http_response(response)
                     }
                }
            }
