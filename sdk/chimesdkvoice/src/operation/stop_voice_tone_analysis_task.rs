...
impl StopVoiceToneAnalysisTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_voice_tone_analysis_task::StopVoiceToneAnalysisTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopVoiceToneAnalysisTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_stop_voice_tone_analysis_task::de_stop_voice_tone_analysis_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
