...
impl GetProxySessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_proxy_session::GetProxySession, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProxySession {
    type Output =
        ::std::result::Result<crate::operation::get_proxy_session::GetProxySessionOutput, crate::operation::get_proxy_session::GetProxySessionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_proxy_session::de_get_proxy_session_http_response_with_props(status, headers, body)
        }
    }
