...
impl ListSupportedPhoneNumberCountriesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSupportedPhoneNumberCountries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_supported_phone_number_countries::de_list_supported_phone_number_countries_http_response_with_props(
                status, headers, body,
            )
        }
    }
