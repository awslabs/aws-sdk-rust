    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/phone-number-countries")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSupportedPhoneNumberCountries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_supported_phone_number_countries::de_list_supported_phone_number_countries_http_response_with_props(status, headers, body)
        }
    }
}
