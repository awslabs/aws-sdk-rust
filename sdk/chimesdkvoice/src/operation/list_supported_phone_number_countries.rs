...
impl ListSupportedPhoneNumberCountries {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.ListSupportedPhoneNumberCountries",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "ListSupportedPhoneNumberCountries",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSupportedPhoneNumberCountries {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListSupportedPhoneNumberCountriesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListSupportedPhoneNumberCountriesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListSupportedPhoneNumberCountries")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSupportedPhoneNumberCountriesResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_supported_phone_number_countries::de_list_supported_phone_number_countries_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_supported_phone_number_countries::de_list_supported_phone_number_countries_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSupportedPhoneNumberCountriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesInput,
