...
impl DeleteVoiceConnectorProxyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyOutput, crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError, Self> {
