...
impl CreateSipRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_sip_rule::CreateSipRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_sip_rule::ser_create_sip_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSipRule {
    type Output =
        ::std::result::Result<crate::operation::create_sip_rule::CreateSipRuleOutput, crate::operation::create_sip_rule::CreateSipRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_sip_rule::de_create_sip_rule_http_response_with_props(status, headers, body)
        }
    }
}
