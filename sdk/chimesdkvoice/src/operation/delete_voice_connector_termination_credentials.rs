...
impl DeleteVoiceConnectorTerminationCredentials {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.DeleteVoiceConnectorTerminationCredentials",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "DeleteVoiceConnectorTerminationCredentials",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteVoiceConnectorTerminationCredentials")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVoiceConnectorTerminationCredentials")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    DeleteVoiceConnectorTerminationCredentialsTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteVoiceConnectorTerminationCredentialsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVoiceConnectorTerminationCredentialsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteVoiceConnectorTerminationCredentialsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVoiceConnectorTerminationCredentialsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            ...
            crate::protocol_serde::shape_delete_voice_connector_termination_credentials::de_delete_voice_connector_termination_credentials_http_response(status, headers, body, _cfg)
        };
