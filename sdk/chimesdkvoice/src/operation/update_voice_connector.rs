...
impl UpdateVoiceConnectorInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVoiceConnector`](crate::operation::update_voice_connector::UpdateVoiceConnector)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_voice_connector::UpdateVoiceConnector, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_voice_connector::UpdateVoiceConnectorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_voice_connector::ser_update_voice_connector_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_voice_connector::UpdateVoiceConnector::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVoiceConnector {
                type Output = std::result::Result<crate::operation::update_voice_connector::UpdateVoiceConnectorOutput, crate::operation::update_voice_connector::UpdateVoiceConnectorError>;
