...
impl UpdateVoiceConnectorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_voice_connector::ser_update_voice_connector_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_voice_connector::UpdateVoiceConnector::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_voice_connector::UpdateVoiceConnectorError
{
