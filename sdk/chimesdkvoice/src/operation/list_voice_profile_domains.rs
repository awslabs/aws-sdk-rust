    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_voice_profile_domains::ListVoiceProfileDomainsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_voice_profile_domains::ListVoiceProfileDomainsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListVoiceProfileDomainsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListVoiceProfileDomainsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_voice_profile_domains::ListVoiceProfileDomainsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListVoiceProfileDomainsEndpointParamsInterceptor {
...
pub type ListVoiceProfileDomainsErrorKind = ListVoiceProfileDomainsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListVoiceProfileDomainsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_voice_profile_domains::ListVoiceProfileDomainsError {
...
impl ListVoiceProfileDomainsError {
    ...
    /// Creates the `ListVoiceProfileDomainsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
