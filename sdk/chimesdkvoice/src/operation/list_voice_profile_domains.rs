...
impl ListVoiceProfileDomainsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_voice_profile_domains::ListVoiceProfileDomains,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVoiceProfileDomains {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_voice_profile_domains::de_list_voice_profile_domains_http_response_with_props(status, headers, body)
        }
    }
