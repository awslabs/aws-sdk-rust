...
impl ListAvailableVoiceConnectorRegionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_available_voice_connector_regions::ListAvailableVoiceConnectorRegions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAvailableVoiceConnectorRegions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_available_voice_connector_regions::de_list_available_voice_connector_regions_http_response_with_props(
                status, headers, body,
            )
        }
    }
