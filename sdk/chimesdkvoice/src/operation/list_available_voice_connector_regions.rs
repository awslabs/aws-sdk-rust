...
impl ListAvailableVoiceConnectorRegions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_available_voice_connector_regions::ListAvailableVoiceConnectorRegionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_available_voice_connector_regions::ListAvailableVoiceConnectorRegionsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.ListAvailableVoiceConnectorRegions",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "ListAvailableVoiceConnectorRegions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAvailableVoiceConnectorRegions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAvailableVoiceConnectorRegionsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAvailableVoiceConnectorRegionsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAvailableVoiceConnectorRegions")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAvailableVoiceConnectorRegionsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_available_voice_connector_regions::de_list_available_voice_connector_regions_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_available_voice_connector_regions::de_list_available_voice_connector_regions_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAvailableVoiceConnectorRegionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_available_voice_connector_regions::ListAvailableVoiceConnectorRegionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_available_voice_connector_regions::ListAvailableVoiceConnectorRegionsInput,
