...
impl CreateVoiceProfileDomainInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_voice_profile_domain::CreateVoiceProfileDomain::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVoiceProfileDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_voice_profile_domain::de_create_voice_profile_domain_http_response_with_props(status, headers, body)
        }
    }
