    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateVoiceProfileDomainResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateVoiceProfileDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateVoiceProfileDomainEndpointParamsInterceptor {
...
pub type CreateVoiceProfileDomainErrorKind = CreateVoiceProfileDomainError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateVoiceProfileDomainError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainError {
...
impl CreateVoiceProfileDomainError {
    ...
    /// Creates the `CreateVoiceProfileDomainError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
