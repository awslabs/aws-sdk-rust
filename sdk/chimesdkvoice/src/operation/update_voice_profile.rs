...
impl UpdateVoiceProfileInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_voice_profile::ser_update_voice_profile_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVoiceProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_voice_profile::de_update_voice_profile_http_response_with_props(status, headers, body)
        }
    }
