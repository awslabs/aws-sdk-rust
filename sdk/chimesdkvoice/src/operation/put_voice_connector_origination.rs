...
impl PutVoiceConnectorOriginationInput {
    /// Consumes the builder and constructs an Operation<[`PutVoiceConnectorOrigination`](crate::operation::put_voice_connector_origination::PutVoiceConnectorOrigination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_voice_connector_origination::PutVoiceConnectorOrigination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_voice_connector_origination::PutVoiceConnectorOriginationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_voice_connector_origination::ser_put_voice_connector_origination_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_voice_connector_origination::PutVoiceConnectorOrigination::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutVoiceConnectorOrigination {
                type Output = std::result::Result<crate::operation::put_voice_connector_origination::PutVoiceConnectorOriginationOutput, crate::operation::put_voice_connector_origination::PutVoiceConnectorOriginationError>;
