...
impl DeleteSipRuleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSipRule`](crate::operation::delete_sip_rule::DeleteSipRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_sip_rule::DeleteSipRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_sip_rule::DeleteSipRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_sip_rule::DeleteSipRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteSipRule {
                type Output = std::result::Result<crate::operation::delete_sip_rule::DeleteSipRuleOutput, crate::operation::delete_sip_rule::DeleteSipRuleError>;
