...
impl DeleteSipRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_sip_rule::DeleteSipRule, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSipRule {
    type Output =
        ::std::result::Result<crate::operation::delete_sip_rule::DeleteSipRuleOutput, crate::operation::delete_sip_rule::DeleteSipRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_sip_rule::de_delete_sip_rule_http_response_with_props(status, headers, body)
        }
    }
}
