...
/// Orchestration and serialization glue logic for `DeleteVoiceConnectorTermination`.
...
impl DeleteVoiceConnectorTermination {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationInput,
                    ) -> ::std::result::Result<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVoiceConnectorTermination {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVoiceConnectorTermination");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVoiceConnectorTerminationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVoiceConnectorTerminationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVoiceConnectorTermination")
...
.with_interceptor(DeleteVoiceConnectorTerminationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError>::new());
...
#[derive(Debug)]
            struct DeleteVoiceConnectorTerminationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVoiceConnectorTerminationResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteVoiceConnectorTerminationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVoiceConnectorTerminationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteVoiceConnectorTerminationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVoiceConnectorTerminationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteVoiceConnectorTerminationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVoiceConnectorTerminationInput>()
                        .ok_or("failed to downcast to DeleteVoiceConnectorTerminationInput")?;
...
pub enum DeleteVoiceConnectorTerminationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVoiceConnectorTerminationError) for what information is available for the error.")]
...
impl DeleteVoiceConnectorTerminationError {
    /// Creates the `DeleteVoiceConnectorTerminationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVoiceConnectorTerminationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVoiceConnectorTerminationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_voice_connector_termination::_delete_voice_connector_termination_output::DeleteVoiceConnectorTerminationOutput;

pub use crate::operation::delete_voice_connector_termination::_delete_voice_connector_termination_input::DeleteVoiceConnectorTerminationInput;

mod _delete_voice_connector_termination_input;

mod _delete_voice_connector_termination_output;
