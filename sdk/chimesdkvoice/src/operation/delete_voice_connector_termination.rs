...
impl DeleteVoiceConnectorTerminationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVoiceConnectorTermination`](crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTermination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTermination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTermination::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnectorTermination {
                type Output = std::result::Result<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationOutput, crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError>;
