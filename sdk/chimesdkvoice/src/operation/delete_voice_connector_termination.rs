...
impl DeleteVoiceConnectorTerminationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTermination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnectorTermination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_voice_connector_termination::de_delete_voice_connector_termination_http_response_with_props(
                status, headers, body,
            )
        }
    }
