...
impl CreateProxySessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_proxy_session::ser_create_proxy_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProxySession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_proxy_session::de_create_proxy_session_http_response_with_props(status, headers, body)
        }
    }
