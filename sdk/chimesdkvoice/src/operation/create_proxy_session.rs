...
impl CreateProxySessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_proxy_session::ser_create_proxy_session_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_proxy_session::CreateProxySession::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_proxy_session::CreateProxySessionError
{
