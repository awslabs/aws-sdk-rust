...
impl DeleteVoiceConnectorProxyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnectorProxy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_voice_connector_proxy::de_delete_voice_connector_proxy_http_response_with_props(status, headers, body)
        }
    }
}
