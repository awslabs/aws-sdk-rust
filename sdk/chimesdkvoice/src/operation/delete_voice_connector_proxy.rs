...
/// Orchestration and serialization glue logic for `DeleteVoiceConnectorProxy`.
...
impl DeleteVoiceConnectorProxy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyInput,
                    ) -> ::std::result::Result<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVoiceConnectorProxy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteVoiceConnectorProxy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteVoiceConnectorProxyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteVoiceConnectorProxyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVoiceConnectorProxy")
...
.with_interceptor(DeleteVoiceConnectorProxyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError>::new());
...
#[derive(Debug)]
            struct DeleteVoiceConnectorProxyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVoiceConnectorProxyResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_voice_connector_proxy::de_delete_voice_connector_proxy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_voice_connector_proxy::de_delete_voice_connector_proxy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteVoiceConnectorProxyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVoiceConnectorProxyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/voice-connectors/{VoiceConnectorId}/programmable-numbers/proxy", VoiceConnectorId = voice_connector_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteVoiceConnectorProxyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVoiceConnectorProxyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteVoiceConnectorProxyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteVoiceConnectorProxyInput>()
                        .ok_or("failed to downcast to DeleteVoiceConnectorProxyInput")?;
...
pub enum DeleteVoiceConnectorProxyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteVoiceConnectorProxyError) for what information is available for the error.")]
...
impl DeleteVoiceConnectorProxyError {
    /// Creates the `DeleteVoiceConnectorProxyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVoiceConnectorProxyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteVoiceConnectorProxyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_voice_connector_proxy::_delete_voice_connector_proxy_output::DeleteVoiceConnectorProxyOutput;

pub use crate::operation::delete_voice_connector_proxy::_delete_voice_connector_proxy_input::DeleteVoiceConnectorProxyInput;

mod _delete_voice_connector_proxy_input;

mod _delete_voice_connector_proxy_output;
