...
impl UpdateProxySessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_proxy_session::ser_update_proxy_session_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_proxy_session::UpdateProxySession::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_proxy_session::UpdateProxySessionError
{
