    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartSpeakerSearchTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartSpeakerSearchTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartSpeakerSearchTaskEndpointParamsInterceptor {
...
pub type StartSpeakerSearchTaskErrorKind = StartSpeakerSearchTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartSpeakerSearchTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError {
...
impl StartSpeakerSearchTaskError {
    ...
    /// Creates the `StartSpeakerSearchTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
