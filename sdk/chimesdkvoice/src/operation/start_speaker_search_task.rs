...
impl StartSpeakerSearchTask {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StartSpeakerSearchTask",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartSpeakerSearchTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartSpeakerSearchTaskRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartSpeakerSearchTaskResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartSpeakerSearchTask")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartSpeakerSearchTask")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartSpeakerSearchTaskTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartSpeakerSearchTaskTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartSpeakerSearchTaskTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartSpeakerSearchTaskInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartSpeakerSearchTaskResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_start_speaker_search_task::de_start_speaker_search_task_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_speaker_search_task::de_start_speaker_search_task_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartSpeakerSearchTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_speaker_search_task::StartSpeakerSearchTaskInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_speaker_search_task::ser_start_speaker_search_task_input(&input)?,
        );
