...
/// Orchestration and serialization glue logic for `StartSpeakerSearchTask`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct StartSpeakerSearchTask;
impl StartSpeakerSearchTask {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartSpeakerSearchTask {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartSpeakerSearchTask");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartSpeakerSearchTaskRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartSpeakerSearchTaskResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartSpeakerSearchTask")
...
.with_interceptor(StartSpeakerSearchTaskEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError>::new());
...
#[derive(Debug)]
            struct StartSpeakerSearchTaskResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartSpeakerSearchTaskResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_start_speaker_search_task::de_start_speaker_search_task_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_speaker_search_task::de_start_speaker_search_task_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartSpeakerSearchTaskRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartSpeakerSearchTaskRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_speaker_search_task::StartSpeakerSearchTaskInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_speaker_search_task::StartSpeakerSearchTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/voice-connectors/{VoiceConnectorId}/speaker-search-tasks", VoiceConnectorId = voice_connector_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_speaker_search_task::ser_start_speaker_search_task_input(&input)?);
...
#[derive(Debug)]
            struct StartSpeakerSearchTaskEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartSpeakerSearchTaskEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartSpeakerSearchTaskEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartSpeakerSearchTaskInput>()
                        .ok_or("failed to downcast to StartSpeakerSearchTaskInput")?;
...
/// Error type for the `StartSpeakerSearchTaskError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartSpeakerSearchTaskError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartSpeakerSearchTaskError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartSpeakerSearchTaskError {
    /// Creates the `StartSpeakerSearchTaskError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartSpeakerSearchTaskError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::GoneException`.
    pub fn is_gone_exception(&self) -> bool {
        matches!(self, Self::GoneException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::ResourceLimitExceededException`.
    pub fn is_resource_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::ResourceLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(self, Self::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::ThrottledClientException`.
    pub fn is_throttled_client_exception(&self) -> bool {
        matches!(self, Self::ThrottledClientException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::UnauthorizedClientException`.
    pub fn is_unauthorized_client_exception(&self) -> bool {
        matches!(self, Self::UnauthorizedClientException(_))
    }
    /// Returns `true` if the error kind is `StartSpeakerSearchTaskError::UnprocessableEntityException`.
    pub fn is_unprocessable_entity_exception(&self) -> bool {
        matches!(self, Self::UnprocessableEntityException(_))
    }
}
impl ::std::error::Error for StartSpeakerSearchTaskError {
...
impl ::std::fmt::Display for StartSpeakerSearchTaskError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartSpeakerSearchTaskError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartSpeakerSearchTaskError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartSpeakerSearchTaskError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_speaker_search_task::StartSpeakerSearchTaskError {
...
mod _start_speaker_search_task_output;
