...
impl GetSipMediaApplicationLoggingConfiguration {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_sip_media_application_logging_configuration::GetSipMediaApplicationLoggingConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_sip_media_application_logging_configuration::GetSipMediaApplicationLoggingConfigurationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.GetSipMediaApplicationLoggingConfiguration",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "GetSipMediaApplicationLoggingConfiguration",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSipMediaApplicationLoggingConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetSipMediaApplicationLoggingConfigurationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetSipMediaApplicationLoggingConfigurationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetSipMediaApplicationLoggingConfiguration")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSipMediaApplicationLoggingConfiguration")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    GetSipMediaApplicationLoggingConfigurationTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetSipMediaApplicationLoggingConfigurationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSipMediaApplicationLoggingConfigurationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetSipMediaApplicationLoggingConfigurationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSipMediaApplicationLoggingConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_sip_media_application_logging_configuration::de_get_sip_media_application_logging_configuration_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_sip_media_application_logging_configuration::de_get_sip_media_application_logging_configuration_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSipMediaApplicationLoggingConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_sip_media_application_logging_configuration::GetSipMediaApplicationLoggingConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_sip_media_application_logging_configuration::GetSipMediaApplicationLoggingConfigurationInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_sip_media_application_logging_configuration::GetSipMediaApplicationLoggingConfigurationError
{
