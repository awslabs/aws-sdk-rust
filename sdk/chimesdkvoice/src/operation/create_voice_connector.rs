...
impl CreateVoiceConnectorInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_voice_connector::ser_create_voice_connector_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_voice_connector::CreateVoiceConnector::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_voice_connector::CreateVoiceConnectorError
{
