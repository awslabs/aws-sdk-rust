...
impl ListPhoneNumberOrders {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_phone_number_orders::ListPhoneNumberOrdersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_phone_number_orders::ListPhoneNumberOrdersOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.ListPhoneNumberOrders",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "ListPhoneNumberOrders",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListPhoneNumberOrders {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListPhoneNumberOrdersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListPhoneNumberOrdersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListPhoneNumberOrders")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListPhoneNumberOrders")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListPhoneNumberOrdersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListPhoneNumberOrdersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListPhoneNumberOrdersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListPhoneNumberOrdersInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPhoneNumberOrdersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_phone_number_orders::de_list_phone_number_orders_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_phone_number_orders::de_list_phone_number_orders_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPhoneNumberOrdersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_phone_number_orders::ListPhoneNumberOrdersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_phone_number_orders::ListPhoneNumberOrdersInput,
