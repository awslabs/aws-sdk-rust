...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainOutput,
                    crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainError,
                > for DeleteVoiceProfileDomainFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteVoiceProfileDomainFluentBuilder {
    ...
    /// Access the DeleteVoiceProfileDomain as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_voice_profile_domain::builders::DeleteVoiceProfileDomainInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomain::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomain::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainOutput, crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainError, Self> {
