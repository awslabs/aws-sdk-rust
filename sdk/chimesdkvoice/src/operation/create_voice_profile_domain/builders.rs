...
impl CreateVoiceProfileDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainOutput, crate::operation::create_voice_profile_domain::CreateVoiceProfileDomainError, Self> {
