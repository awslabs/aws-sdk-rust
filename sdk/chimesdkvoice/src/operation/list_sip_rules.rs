...
impl ListSipRulesInput {
    /// Consumes the builder and constructs an Operation<[`ListSipRules`](crate::operation::list_sip_rules::ListSipRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_sip_rules::ListSipRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_sip_rules::ListSipRulesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/sip-rules").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_sip_rules::ListSipRulesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.sip_media_application_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_sip_rules::ListSipRules::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSipRules {
                type Output = std::result::Result<crate::operation::list_sip_rules::ListSipRulesOutput, crate::operation::list_sip_rules::ListSipRulesError>;
