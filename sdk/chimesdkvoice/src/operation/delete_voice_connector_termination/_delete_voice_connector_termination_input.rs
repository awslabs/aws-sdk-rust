...
impl DeleteVoiceConnectorTerminationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationInput, ::aws_smithy_types::error::operation::BuildError> {
