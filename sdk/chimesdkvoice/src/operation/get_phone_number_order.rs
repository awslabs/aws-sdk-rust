...
/// Orchestration and serialization glue logic for `GetPhoneNumberOrder`.
...
impl GetPhoneNumberOrder {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_phone_number_order::GetPhoneNumberOrderInput,
                    ) -> ::std::result::Result<crate::operation::get_phone_number_order::GetPhoneNumberOrderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_phone_number_order::GetPhoneNumberOrderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_phone_number_order::GetPhoneNumberOrderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_phone_number_order::GetPhoneNumberOrderOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPhoneNumberOrder {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPhoneNumberOrder");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPhoneNumberOrderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPhoneNumberOrderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPhoneNumberOrder")
...
.with_interceptor(GetPhoneNumberOrderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_phone_number_order::GetPhoneNumberOrderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_phone_number_order::GetPhoneNumberOrderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_phone_number_order::GetPhoneNumberOrderError>::new());
...
#[derive(Debug)]
            struct GetPhoneNumberOrderResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPhoneNumberOrderResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_phone_number_order::de_get_phone_number_order_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_phone_number_order::de_get_phone_number_order_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetPhoneNumberOrderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPhoneNumberOrderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_phone_number_order::GetPhoneNumberOrderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_phone_number_order::GetPhoneNumberOrderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.phone_number_order_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("phone_number_order_id", "cannot be empty or unset"))?;
    let phone_number_order_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if phone_number_order_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("phone_number_order_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/phone-number-orders/{PhoneNumberOrderId}", PhoneNumberOrderId = phone_number_order_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetPhoneNumberOrderEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPhoneNumberOrderEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPhoneNumberOrderEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPhoneNumberOrderInput>()
                        .ok_or("failed to downcast to GetPhoneNumberOrderInput")?;
...
pub enum GetPhoneNumberOrderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPhoneNumberOrderError) for what information is available for the error.")]
...
impl GetPhoneNumberOrderError {
    /// Creates the `GetPhoneNumberOrderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPhoneNumberOrderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPhoneNumberOrderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_phone_number_order::GetPhoneNumberOrderError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_phone_number_order::_get_phone_number_order_output::GetPhoneNumberOrderOutput;

pub use crate::operation::get_phone_number_order::_get_phone_number_order_input::GetPhoneNumberOrderInput;

mod _get_phone_number_order_input;

mod _get_phone_number_order_output;
