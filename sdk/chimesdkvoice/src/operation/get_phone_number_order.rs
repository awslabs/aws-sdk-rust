...
impl GetPhoneNumberOrderInput {
    /// Consumes the builder and constructs an Operation<[`GetPhoneNumberOrder`](crate::operation::get_phone_number_order::GetPhoneNumberOrder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_phone_number_order::GetPhoneNumberOrder, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_phone_number_order::GetPhoneNumberOrderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.phone_number_order_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("phone_number_order_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_phone_number_order::GetPhoneNumberOrder::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetPhoneNumberOrder {
                type Output = std::result::Result<crate::operation::get_phone_number_order::GetPhoneNumberOrderOutput, crate::operation::get_phone_number_order::GetPhoneNumberOrderError>;
