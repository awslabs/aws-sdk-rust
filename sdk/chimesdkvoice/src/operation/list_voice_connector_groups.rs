    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/voice-connector-groups")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_voice_connector_groups::ListVoiceConnectorGroups::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError
{
