...
impl ListVoiceConnectorGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_voice_connector_groups::ListVoiceConnectorGroups,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_voice_connector_groups::ListVoiceConnectorGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVoiceConnectorGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_voice_connector_groups::de_list_voice_connector_groups_http_response_with_props(status, headers, body)
        }
    }
}
