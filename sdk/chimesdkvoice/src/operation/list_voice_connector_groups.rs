...
/// Orchestration and serialization glue logic for `ListVoiceConnectorGroups`.
...
impl ListVoiceConnectorGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput,
                    ) -> ::std::result::Result<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVoiceConnectorGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVoiceConnectorGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVoiceConnectorGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVoiceConnectorGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVoiceConnectorGroups")
...
.with_interceptor(ListVoiceConnectorGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError>::new());
...
#[derive(Debug)]
            struct ListVoiceConnectorGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVoiceConnectorGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_voice_connector_groups::de_list_voice_connector_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_voice_connector_groups::de_list_voice_connector_groups_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListVoiceConnectorGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVoiceConnectorGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/voice-connector-groups").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListVoiceConnectorGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVoiceConnectorGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListVoiceConnectorGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVoiceConnectorGroupsInput>()
                        .ok_or("failed to downcast to ListVoiceConnectorGroupsInput")?;
...
pub enum ListVoiceConnectorGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVoiceConnectorGroupsError) for what information is available for the error.")]
...
impl ListVoiceConnectorGroupsError {
    /// Creates the `ListVoiceConnectorGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVoiceConnectorGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVoiceConnectorGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError {
...
mod _list_voice_connector_groups_output;
