...
impl ListVoiceConnectorGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListVoiceConnectorGroups`](crate::operation::list_voice_connector_groups::ListVoiceConnectorGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/voice-connector-groups").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_voice_connector_groups::ListVoiceConnectorGroups::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListVoiceConnectorGroups {
                type Output = std::result::Result<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsOutput, crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsError>;
