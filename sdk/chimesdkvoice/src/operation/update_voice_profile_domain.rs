...
impl UpdateVoiceProfileDomainInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomain::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVoiceProfileDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_voice_profile_domain::de_update_voice_profile_domain_http_response_with_props(status, headers, body)
        }
    }
