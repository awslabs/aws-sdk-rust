    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateVoiceProfileDomainResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateVoiceProfileDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("voice_profile_domain_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateVoiceProfileDomainEndpointParamsInterceptor {
...
pub type UpdateVoiceProfileDomainErrorKind = UpdateVoiceProfileDomainError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateVoiceProfileDomainError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainError {
...
impl UpdateVoiceProfileDomainError {
    ...
    /// Creates the `UpdateVoiceProfileDomainError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
