...
impl CreateVoiceConnectorGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateVoiceConnectorGroup`](crate::operation::create_voice_connector_group::CreateVoiceConnectorGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_voice_connector_group::ser_create_voice_connector_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_voice_connector_group::CreateVoiceConnectorGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVoiceConnectorGroup {
                type Output = std::result::Result<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupOutput, crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError>;
