...
/// Orchestration and serialization glue logic for `CreateVoiceConnectorGroup`.
...
impl CreateVoiceConnectorGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateVoiceConnectorGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateVoiceConnectorGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateVoiceConnectorGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateVoiceConnectorGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateVoiceConnectorGroup")
...
.with_interceptor(CreateVoiceConnectorGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError>::new());
...
#[derive(Debug)]
            struct CreateVoiceConnectorGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateVoiceConnectorGroupResponseDeserializer {
...
#[derive(Debug)]
            struct CreateVoiceConnectorGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateVoiceConnectorGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_voice_connector_group::ser_create_voice_connector_group_input(&input)?);
...
#[derive(Debug)]
            struct CreateVoiceConnectorGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateVoiceConnectorGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateVoiceConnectorGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateVoiceConnectorGroupInput>()
                        .ok_or("failed to downcast to CreateVoiceConnectorGroupInput")?;
...
pub enum CreateVoiceConnectorGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateVoiceConnectorGroupError) for what information is available for the error.")]
...
impl CreateVoiceConnectorGroupError {
    /// Creates the `CreateVoiceConnectorGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVoiceConnectorGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateVoiceConnectorGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_voice_connector_group::CreateVoiceConnectorGroupError {
...
mod _create_voice_connector_group_output;
