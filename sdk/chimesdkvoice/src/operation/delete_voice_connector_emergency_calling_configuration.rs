...
impl DeleteVoiceConnectorEmergencyCallingConfiguration {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.DeleteVoiceConnectorEmergencyCallingConfiguration",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "DeleteVoiceConnectorEmergencyCallingConfiguration",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteVoiceConnectorEmergencyCallingConfiguration")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVoiceConnectorEmergencyCallingConfiguration")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    DeleteVoiceConnectorEmergencyCallingConfigurationTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteVoiceConnectorEmergencyCallingConfigurationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteVoiceConnectorEmergencyCallingConfigurationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteVoiceConnectorEmergencyCallingConfigurationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVoiceConnectorEmergencyCallingConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_voice_connector_emergency_calling_configuration::de_delete_voice_connector_emergency_calling_configuration_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_voice_connector_emergency_calling_configuration::de_delete_voice_connector_emergency_calling_configuration_http_response(status, headers, body, _cfg)
        };
