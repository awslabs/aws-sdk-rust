...
impl ListPhoneNumbersInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_phone_numbers::ListPhoneNumbers::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListPhoneNumbers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_phone_numbers::de_list_phone_numbers_http_response_with_props(status, headers, body)
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::list_phone_numbers::ListPhoneNumbersError
{
