...
/// Orchestration and serialization glue logic for `BatchDeletePhoneNumber`.
...
impl BatchDeletePhoneNumber {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDeletePhoneNumber {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDeletePhoneNumber");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDeletePhoneNumberRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDeletePhoneNumberResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDeletePhoneNumber")
...
.with_interceptor(BatchDeletePhoneNumberEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError>::new());
...
#[derive(Debug)]
            struct BatchDeletePhoneNumberResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDeletePhoneNumberResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_delete_phone_number::de_batch_delete_phone_number_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_delete_phone_number::de_batch_delete_phone_number_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchDeletePhoneNumberRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDeletePhoneNumberRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/phone-numbers").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_delete_phone_number::ser_batch_delete_phone_number_input(&input)?);
...
#[derive(Debug)]
            struct BatchDeletePhoneNumberEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDeletePhoneNumberEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchDeletePhoneNumberEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDeletePhoneNumberInput>()
                        .ok_or("failed to downcast to BatchDeletePhoneNumberInput")?;
...
pub enum BatchDeletePhoneNumberError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDeletePhoneNumberError) for what information is available for the error.")]
...
impl BatchDeletePhoneNumberError {
    /// Creates the `BatchDeletePhoneNumberError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDeletePhoneNumberError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDeletePhoneNumberError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError {
...
mod _batch_delete_phone_number_output;
