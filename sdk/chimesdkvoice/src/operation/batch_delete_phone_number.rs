...
impl BatchDeletePhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeletePhoneNumber`](crate::operation::batch_delete_phone_number::BatchDeletePhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/phone-numbers").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_delete_phone_number::ser_batch_delete_phone_number_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_phone_number::BatchDeletePhoneNumber::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDeletePhoneNumber {
                type Output = std::result::Result<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberOutput, crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberError>;
