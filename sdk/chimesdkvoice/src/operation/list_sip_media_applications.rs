...
impl ListSipMediaApplicationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_sip_media_applications::ListSipMediaApplications::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSipMediaApplications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sip_media_applications::de_list_sip_media_applications_http_response_with_props(status, headers, body)
        }
    }
