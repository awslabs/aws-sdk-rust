...
/// Orchestration and serialization glue logic for `ListSipMediaApplications`.
...
impl ListSipMediaApplications {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput,
                    ) -> ::std::result::Result<crate::operation::list_sip_media_applications::ListSipMediaApplicationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_sip_media_applications::ListSipMediaApplicationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_sip_media_applications::ListSipMediaApplicationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_sip_media_applications::ListSipMediaApplicationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSipMediaApplications {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListSipMediaApplications");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListSipMediaApplicationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListSipMediaApplicationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSipMediaApplications")
...
.with_interceptor(ListSipMediaApplicationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_sip_media_applications::ListSipMediaApplicationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_sip_media_applications::ListSipMediaApplicationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_sip_media_applications::ListSipMediaApplicationsError>::new());
...
#[derive(Debug)]
            struct ListSipMediaApplicationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSipMediaApplicationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_sip_media_applications::de_list_sip_media_applications_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_sip_media_applications::de_list_sip_media_applications_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListSipMediaApplicationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSipMediaApplicationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/sip-media-applications").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListSipMediaApplicationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSipMediaApplicationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListSipMediaApplicationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListSipMediaApplicationsInput>()
                        .ok_or("failed to downcast to ListSipMediaApplicationsInput")?;
...
pub enum ListSipMediaApplicationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSipMediaApplicationsError) for what information is available for the error.")]
...
impl ListSipMediaApplicationsError {
    /// Creates the `ListSipMediaApplicationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListSipMediaApplicationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSipMediaApplicationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_sip_media_applications::ListSipMediaApplicationsError {
...
mod _list_sip_media_applications_output;
