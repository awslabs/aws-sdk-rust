...
impl ListSipMediaApplicationsInput {
    /// Consumes the builder and constructs an Operation<[`ListSipMediaApplications`](crate::operation::list_sip_media_applications::ListSipMediaApplications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_sip_media_applications::ListSipMediaApplications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/sip-media-applications").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_sip_media_applications::ListSipMediaApplications::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSipMediaApplications {
                type Output = std::result::Result<crate::operation::list_sip_media_applications::ListSipMediaApplicationsOutput, crate::operation::list_sip_media_applications::ListSipMediaApplicationsError>;
