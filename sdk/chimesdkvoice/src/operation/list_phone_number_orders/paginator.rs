...
/// Paginator for [`ListPhoneNumberOrders`](crate::operation::list_phone_number_orders::ListPhoneNumberOrders)
            ...
            impl ListPhoneNumberOrdersPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_phone_number_orders::ListPhoneNumberOrdersOutput, aws_smithy_http::result::SdkError<crate::operation::list_phone_number_orders::ListPhoneNumberOrdersError>>> + Unpin
                 {
