...
impl ListVoiceProfilesFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_voice_profiles::ListVoiceProfiles, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_voice_profiles::ListVoiceProfilesError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_voice_profiles::ListVoiceProfilesOutput, aws_smithy_http::result::SdkError<crate::operation::list_voice_profiles::ListVoiceProfilesError>>
                     {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_voice_profiles::paginator::ListVoiceProfilesPaginator::send) which returns a `Stream`.
