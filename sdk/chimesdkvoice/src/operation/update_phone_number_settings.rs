...
/// Orchestration and serialization glue logic for `UpdatePhoneNumberSettings`.
...
impl UpdatePhoneNumberSettings {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdatePhoneNumberSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdatePhoneNumberSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdatePhoneNumberSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdatePhoneNumberSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdatePhoneNumberSettings")
...
.with_interceptor(UpdatePhoneNumberSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError>::new());
...
#[derive(Debug)]
            struct UpdatePhoneNumberSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdatePhoneNumberSettingsResponseDeserializer {
...
#[derive(Debug)]
            struct UpdatePhoneNumberSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdatePhoneNumberSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_phone_number_settings::ser_update_phone_number_settings_input(&input)?);
...
#[derive(Debug)]
            struct UpdatePhoneNumberSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdatePhoneNumberSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdatePhoneNumberSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdatePhoneNumberSettingsInput>()
                        .ok_or("failed to downcast to UpdatePhoneNumberSettingsInput")?;
...
pub enum UpdatePhoneNumberSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdatePhoneNumberSettingsError) for what information is available for the error.")]
...
impl UpdatePhoneNumberSettingsError {
    /// Creates the `UpdatePhoneNumberSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdatePhoneNumberSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdatePhoneNumberSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError {
...
mod _update_phone_number_settings_output;
