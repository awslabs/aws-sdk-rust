...
impl UpdatePhoneNumberSettings {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.UpdatePhoneNumberSettings",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "UpdatePhoneNumberSettings",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdatePhoneNumberSettings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdatePhoneNumberSettingsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdatePhoneNumberSettingsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdatePhoneNumberSettings")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdatePhoneNumberSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_update_phone_number_settings::de_update_phone_number_settings_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_phone_number_settings::de_update_phone_number_settings_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdatePhoneNumberSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_phone_number_settings::ser_update_phone_number_settings_input(&input)?,
        );
