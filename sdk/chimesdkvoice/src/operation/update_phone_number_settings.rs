...
impl UpdatePhoneNumberSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePhoneNumberSettings`](crate::operation::update_phone_number_settings::UpdatePhoneNumberSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_phone_number_settings::ser_update_phone_number_settings_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_phone_number_settings::UpdatePhoneNumberSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdatePhoneNumberSettings {
                type Output = std::result::Result<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsOutput, crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsError>;
