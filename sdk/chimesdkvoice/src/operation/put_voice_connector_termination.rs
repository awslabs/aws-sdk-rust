...
impl PutVoiceConnectorTerminationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_voice_connector_termination::PutVoiceConnectorTermination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutVoiceConnectorTermination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_voice_connector_termination::de_put_voice_connector_termination_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PutVoiceConnectorTerminationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_voice_connector_termination::PutVoiceConnectorTerminationError
{
