...
impl PutVoiceConnectorTerminationInput {
    /// Consumes the builder and constructs an Operation<[`PutVoiceConnectorTermination`](crate::operation::put_voice_connector_termination::PutVoiceConnectorTermination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_voice_connector_termination::PutVoiceConnectorTermination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_voice_connector_termination::PutVoiceConnectorTerminationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_voice_connector_termination::ser_put_voice_connector_termination_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_voice_connector_termination::PutVoiceConnectorTermination::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutVoiceConnectorTermination {
                type Output = std::result::Result<crate::operation::put_voice_connector_termination::PutVoiceConnectorTerminationOutput, crate::operation::put_voice_connector_termination::PutVoiceConnectorTerminationError>;
