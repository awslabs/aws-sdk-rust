...
impl CreatePhoneNumberOrder {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.CreatePhoneNumberOrder",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "CreatePhoneNumberOrder",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePhoneNumberOrder {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreatePhoneNumberOrderRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreatePhoneNumberOrderResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreatePhoneNumberOrder")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePhoneNumberOrderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_phone_number_order::de_create_phone_number_order_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_phone_number_order::de_create_phone_number_order_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePhoneNumberOrderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_phone_number_order::CreatePhoneNumberOrderInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_phone_number_order::ser_create_phone_number_order_input(&input)?,
        );
