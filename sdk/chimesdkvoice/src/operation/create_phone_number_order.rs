...
impl CreatePhoneNumberOrder {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_phone_number_order::CreatePhoneNumberOrderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_phone_number_order::CreatePhoneNumberOrderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePhoneNumberOrder {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreatePhoneNumberOrder");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreatePhoneNumberOrderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreatePhoneNumberOrderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePhoneNumberOrder")
...
.with_interceptor(CreatePhoneNumberOrderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderError>::new());
...
#[derive(Debug)]
            struct CreatePhoneNumberOrderResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePhoneNumberOrderResponseDeserializer {
...
#[derive(Debug)]
            struct CreatePhoneNumberOrderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePhoneNumberOrderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_phone_number_order::CreatePhoneNumberOrderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_phone_number_order::CreatePhoneNumberOrderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/phone-number-orders").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_phone_number_order::ser_create_phone_number_order_input(&input)?);
...
#[derive(Debug)]
            struct CreatePhoneNumberOrderEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePhoneNumberOrderEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreatePhoneNumberOrderEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreatePhoneNumberOrderInput>()
                        .ok_or("failed to downcast to CreatePhoneNumberOrderInput")?;
...
pub enum CreatePhoneNumberOrderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreatePhoneNumberOrderError) for what information is available for the error.")]
...
impl CreatePhoneNumberOrderError {
    /// Creates the `CreatePhoneNumberOrderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreatePhoneNumberOrderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreatePhoneNumberOrderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_phone_number_order::CreatePhoneNumberOrderError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_phone_number_order::_create_phone_number_order_output::CreatePhoneNumberOrderOutput;

pub use crate::operation::create_phone_number_order::_create_phone_number_order_input::CreatePhoneNumberOrderInput;

mod _create_phone_number_order_input;

mod _create_phone_number_order_output;
