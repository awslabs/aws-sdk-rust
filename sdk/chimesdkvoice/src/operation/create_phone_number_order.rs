...
impl CreatePhoneNumberOrderInput {
    /// Consumes the builder and constructs an Operation<[`CreatePhoneNumberOrder`](crate::operation::create_phone_number_order::CreatePhoneNumberOrder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_phone_number_order::CreatePhoneNumberOrder, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_phone_number_order::CreatePhoneNumberOrderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_phone_number_order::ser_create_phone_number_order_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_phone_number_order::CreatePhoneNumberOrder::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePhoneNumberOrder {
                type Output = std::result::Result<crate::operation::create_phone_number_order::CreatePhoneNumberOrderOutput, crate::operation::create_phone_number_order::CreatePhoneNumberOrderError>;
