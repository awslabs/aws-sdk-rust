...
impl UpdateSipRuleFluentBuilder  {
    /// Creates a new `UpdateSipRule`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_sip_rule::UpdateSipRuleOutput, aws_smithy_http::result::SdkError<crate::operation::update_sip_rule::UpdateSipRuleError>>
                     {
