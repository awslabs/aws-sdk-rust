    ...
    > {
        ...
        let mut request = {
            ...
            ) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError>
            {
                ...
                let speaker_search_task_id = aws_smithy_http::label::fmt_string(
                    input_2,
                    aws_smithy_http::label::EncodingStrategy::Default,
                );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_speaker_search_task::StopSpeakerSearchTask::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::stop_speaker_search_task::StopSpeakerSearchTaskError
{
