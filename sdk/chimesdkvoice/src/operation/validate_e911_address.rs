...
impl ValidateE911Address {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.ValidateE911Address",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "ValidateE911Address",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ValidateE911Address")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ValidateE911Address")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ValidateE911AddressTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ValidateE911AddressTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ValidateE911AddressTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ValidateE911AddressInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ValidateE911AddressResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            crate::protocol_serde::shape_validate_e911_address::de_validate_e911_address_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_validate_e911_address::de_validate_e911_address_http_response(status, headers, body, _cfg)
        };
