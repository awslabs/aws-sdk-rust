...
impl UpdateVoiceConnectorGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVoiceConnectorGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_voice_connector_group::de_update_voice_connector_group_http_response_with_props(status, headers, body)
        }
    }
}
