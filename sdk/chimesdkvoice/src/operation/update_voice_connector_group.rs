...
impl UpdateVoiceConnectorGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVoiceConnectorGroup`](crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_voice_connector_group::ser_update_voice_connector_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVoiceConnectorGroup {
                type Output = std::result::Result<crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroupOutput, crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroupError>;
