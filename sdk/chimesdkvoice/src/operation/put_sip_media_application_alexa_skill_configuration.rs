...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for PutSipMediaApplicationAlexaSkillConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for PutSipMediaApplicationAlexaSkillConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_sip_media_application_alexa_skill_configuration::ser_put_sip_media_application_alexa_skill_configuration_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutSipMediaApplicationAlexaSkillConfigurationEndpointParamsInterceptor {
