...
/// Orchestration and serialization glue logic for `GetSipMediaApplicationAlexaSkillConfiguration`.
...
impl GetSipMediaApplicationAlexaSkillConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSipMediaApplicationAlexaSkillConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSipMediaApplicationAlexaSkillConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSipMediaApplicationAlexaSkillConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSipMediaApplicationAlexaSkillConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSipMediaApplicationAlexaSkillConfiguration")
...
.with_interceptor(GetSipMediaApplicationAlexaSkillConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_sip_media_application_alexa_skill_configuration::de_get_sip_media_application_alexa_skill_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_sip_media_application_alexa_skill_configuration::de_get_sip_media_application_alexa_skill_configuration_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSipMediaApplicationAlexaSkillConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/sip-media-applications/{SipMediaApplicationId}/alexa-skill-configuration", SipMediaApplicationId = sip_media_application_id).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSipMediaApplicationAlexaSkillConfigurationEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSipMediaApplicationAlexaSkillConfigurationInput>()
                        .ok_or("failed to downcast to GetSipMediaApplicationAlexaSkillConfigurationInput")?;
...
pub enum GetSipMediaApplicationAlexaSkillConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSipMediaApplicationAlexaSkillConfigurationError) for what information is available for the error.")]
...
impl GetSipMediaApplicationAlexaSkillConfigurationError {
    /// Creates the `GetSipMediaApplicationAlexaSkillConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSipMediaApplicationAlexaSkillConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSipMediaApplicationAlexaSkillConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_sip_media_application_alexa_skill_configuration::GetSipMediaApplicationAlexaSkillConfigurationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_sip_media_application_alexa_skill_configuration::_get_sip_media_application_alexa_skill_configuration_output::GetSipMediaApplicationAlexaSkillConfigurationOutput;

pub use crate::operation::get_sip_media_application_alexa_skill_configuration::_get_sip_media_application_alexa_skill_configuration_input::GetSipMediaApplicationAlexaSkillConfigurationInput;

mod _get_sip_media_application_alexa_skill_configuration_input;

mod _get_sip_media_application_alexa_skill_configuration_output;
