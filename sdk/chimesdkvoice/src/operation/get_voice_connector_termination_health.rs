...
impl GetVoiceConnectorTerminationHealth {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_voice_connector_termination_health::GetVoiceConnectorTerminationHealthError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_voice_connector_termination_health::GetVoiceConnectorTerminationHealthOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.GetVoiceConnectorTerminationHealth",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "GetVoiceConnectorTerminationHealth",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVoiceConnectorTerminationHealth {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetVoiceConnectorTerminationHealthRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetVoiceConnectorTerminationHealthResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetVoiceConnectorTerminationHealth")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVoiceConnectorTerminationHealth")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetVoiceConnectorTerminationHealthTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetVoiceConnectorTerminationHealthTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVoiceConnectorTerminationHealthTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetVoiceConnectorTerminationHealthInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVoiceConnectorTerminationHealthResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_voice_connector_termination_health::de_get_voice_connector_termination_health_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_voice_connector_termination_health::de_get_voice_connector_termination_health_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetVoiceConnectorTerminationHealthRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_voice_connector_termination_health::GetVoiceConnectorTerminationHealthInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_voice_connector_termination_health::GetVoiceConnectorTerminationHealthInput,
