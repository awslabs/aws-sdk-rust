...
impl GetVoiceConnectorTerminationHealthInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_voice_connector_termination_health::GetVoiceConnectorTerminationHealth::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorTerminationHealth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_voice_connector_termination_health::de_get_voice_connector_termination_health_http_response_with_props(
                status, headers, body,
            )
        }
    }
