...
impl DeleteSipMediaApplicationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_sip_media_application::DeleteSipMediaApplication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSipMediaApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_sip_media_application::de_delete_sip_media_application_http_response_with_props(status, headers, body)
        }
    }
}
