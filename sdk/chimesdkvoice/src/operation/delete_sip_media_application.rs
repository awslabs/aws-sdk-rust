...
impl DeleteSipMediaApplication {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_sip_media_application::DeleteSipMediaApplicationInput,
                    ) -> ::std::result::Result<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteSipMediaApplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteSipMediaApplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteSipMediaApplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteSipMediaApplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteSipMediaApplication")
...
.with_interceptor(DeleteSipMediaApplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationError>::new());
...
#[derive(Debug)]
            struct DeleteSipMediaApplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteSipMediaApplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_sip_media_application::de_delete_sip_media_application_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_sip_media_application::de_delete_sip_media_application_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteSipMediaApplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteSipMediaApplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_sip_media_application::DeleteSipMediaApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/sip-media-applications/{SipMediaApplicationId}", SipMediaApplicationId = sip_media_application_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteSipMediaApplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteSipMediaApplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteSipMediaApplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteSipMediaApplicationInput>()
                        .ok_or("failed to downcast to DeleteSipMediaApplicationInput")?;
...
pub enum DeleteSipMediaApplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteSipMediaApplicationError) for what information is available for the error.")]
...
impl DeleteSipMediaApplicationError {
    /// Creates the `DeleteSipMediaApplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSipMediaApplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteSipMediaApplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_sip_media_application::DeleteSipMediaApplicationError {
...
mod _delete_sip_media_application_output;
