...
impl GetVoiceProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_voice_profile::GetVoiceProfile, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceProfile {
    type Output =
        ::std::result::Result<crate::operation::get_voice_profile::GetVoiceProfileOutput, crate::operation::get_voice_profile::GetVoiceProfileError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_voice_profile::de_get_voice_profile_http_response_with_props(status, headers, body)
        }
    }
