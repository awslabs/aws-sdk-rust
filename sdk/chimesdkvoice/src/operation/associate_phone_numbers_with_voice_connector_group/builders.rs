...
impl crate::operation::associate_phone_numbers_with_voice_connector_group::builders::AssociatePhoneNumbersWithVoiceConnectorGroupInputBuilder {
...
impl AssociatePhoneNumbersWithVoiceConnectorGroupFluentBuilder {
    /// Creates a new `AssociatePhoneNumbersWithVoiceConnectorGroupFluentBuilder`.
    ...
    > {
        ...
        crate::operation::associate_phone_numbers_with_voice_connector_group::AssociatePhoneNumbersWithVoiceConnectorGroup::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
