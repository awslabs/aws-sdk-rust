    ...
    for AssociatePhoneNumbersWithVoiceConnectorGroup
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_phone_numbers_with_voice_connector_group::de_associate_phone_numbers_with_voice_connector_group_http_response_with_props(status, headers, body)
        }
    }
