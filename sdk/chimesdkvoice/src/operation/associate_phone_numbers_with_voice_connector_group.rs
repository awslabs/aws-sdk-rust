...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for AssociatePhoneNumbersWithVoiceConnectorGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for AssociatePhoneNumbersWithVoiceConnectorGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_phone_numbers_with_voice_connector_group::ser_associate_phone_numbers_with_voice_connector_group_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociatePhoneNumbersWithVoiceConnectorGroupEndpointParamsInterceptor {
