...
impl ListVoiceConnectorTerminationCredentials {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_voice_connector_termination_credentials::ListVoiceConnectorTerminationCredentialsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_voice_connector_termination_credentials::ListVoiceConnectorTerminationCredentialsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.ListVoiceConnectorTerminationCredentials",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "ListVoiceConnectorTerminationCredentials",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVoiceConnectorTerminationCredentials {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListVoiceConnectorTerminationCredentialsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListVoiceConnectorTerminationCredentialsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListVoiceConnectorTerminationCredentials")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVoiceConnectorTerminationCredentials")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListVoiceConnectorTerminationCredentialsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListVoiceConnectorTerminationCredentialsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVoiceConnectorTerminationCredentialsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListVoiceConnectorTerminationCredentialsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVoiceConnectorTerminationCredentialsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_voice_connector_termination_credentials::de_list_voice_connector_termination_credentials_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_voice_connector_termination_credentials::de_list_voice_connector_termination_credentials_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVoiceConnectorTerminationCredentialsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_voice_connector_termination_credentials::ListVoiceConnectorTerminationCredentialsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_voice_connector_termination_credentials::ListVoiceConnectorTerminationCredentialsInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_voice_connector_termination_credentials::ListVoiceConnectorTerminationCredentialsError
{
