...
impl UpdateGlobalSettingsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_global_settings::ser_update_global_settings_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_global_settings::UpdateGlobalSettings::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_global_settings::UpdateGlobalSettingsError
{
