    ...
    for DisassociatePhoneNumbersFromVoiceConnectorGroup
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_phone_numbers_from_voice_connector_group::de_disassociate_phone_numbers_from_voice_connector_group_http_response_with_props(status, headers, body)
        }
    }
