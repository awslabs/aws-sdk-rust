...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DisassociatePhoneNumbersFromVoiceConnectorGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DisassociatePhoneNumbersFromVoiceConnectorGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("voice_connector_group_id", "cannot be empty or unset")
                })?;
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_phone_numbers_from_voice_connector_group::ser_disassociate_phone_numbers_from_voice_connector_group_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisassociatePhoneNumbersFromVoiceConnectorGroupEndpointParamsInterceptor {
