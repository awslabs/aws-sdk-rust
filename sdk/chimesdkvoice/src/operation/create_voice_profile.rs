...
impl CreateVoiceProfileInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_voice_profile::ser_create_voice_profile_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_voice_profile::CreateVoiceProfile::new(),
        )
...
/// `ParseStrictResponse` impl for `CreateVoiceProfile`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVoiceProfile {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::protocol_serde::shape_create_voice_profile::de_create_voice_profile_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_create_voice_profile::de_create_voice_profile_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::create_voice_profile::CreateVoiceProfileError
{
