...
impl PutSipMediaApplicationLoggingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_sip_media_application_logging_configuration::PutSipMediaApplicationLoggingConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
