...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for PutSipMediaApplicationLoggingConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for PutSipMediaApplicationLoggingConfigurationRequestSerializer {
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("sip_media_application_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutSipMediaApplicationLoggingConfigurationEndpointParamsInterceptor {
