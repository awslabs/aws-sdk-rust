...
impl CreateSipMediaApplicationCallInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_sip_media_application_call::CreateSipMediaApplicationCall::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSipMediaApplicationCall {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_sip_media_application_call::de_create_sip_media_application_call_http_response_with_props(
                status, headers, body,
            )
        }
    }
