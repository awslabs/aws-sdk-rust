...
impl GetSipRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_sip_rule::GetSipRule,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/sip-rules/{SipRuleId}", SipRuleId = sip_rule_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_sip_rule::GetSipRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSipRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_sip_rule::de_get_sip_rule_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_sip_rule::de_get_sip_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
