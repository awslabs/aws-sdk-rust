...
impl GetSipRuleInput {
    /// Consumes the builder and constructs an Operation<[`GetSipRule`](crate::operation::get_sip_rule::GetSipRule)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_sip_rule::GetSipRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_sip_rule::GetSipRule::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSipRule {
    type Output = ::std::result::Result<crate::operation::get_sip_rule::GetSipRuleOutput, crate::operation::get_sip_rule::GetSipRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_sip_rule::de_get_sip_rule_http_response_with_props(status, headers, body)
        }
    }
}
