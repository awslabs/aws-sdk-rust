...
impl PutVoiceConnectorProxy {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.PutVoiceConnectorProxy",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "PutVoiceConnectorProxy",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutVoiceConnectorProxy")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutVoiceConnectorProxy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutVoiceConnectorProxyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutVoiceConnectorProxyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutVoiceConnectorProxyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutVoiceConnectorProxyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutVoiceConnectorProxyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_voice_connector_proxy::de_put_voice_connector_proxy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_voice_connector_proxy::de_put_voice_connector_proxy_http_response(status, headers, body, _cfg)
        };
