...
pub type PutSipMediaApplicationAlexaSkillConfigurationErrorKind =
...
impl aws_http::request_id::RequestId
    for crate::error::PutSipMediaApplicationAlexaSkillConfigurationError
{
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListAvailableVoiceConnectorRegionsError
{
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BadRequestException(_inner) => {
...
pub type GetSipMediaApplicationAlexaSkillConfigurationErrorKind =
...
impl aws_http::request_id::RequestId
    for crate::error::GetSipMediaApplicationAlexaSkillConfigurationError
{
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
