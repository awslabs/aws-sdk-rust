...
impl super::Client  {
    ...
    ///   - [`phone_number_countries(Option<Vec<PhoneNumberCountry>>)`](crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesOutput::phone_number_countries): (undocumented)
