...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_voice_connector::builders::CreateVoiceConnectorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_voice_connector::builders::CreateVoiceConnectorFluentBuilder::set_name): <p>The name of the Voice Connector.</p>
    ...
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_voice_connector::builders::CreateVoiceConnectorFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_voice_connector::builders::CreateVoiceConnectorFluentBuilder::set_tags): <p>The tags assigned to the Voice Connector.</p>
