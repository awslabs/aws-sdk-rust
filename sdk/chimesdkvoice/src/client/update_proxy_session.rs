...
impl super::Client {
    ...
    ///   - [`capabilities(Capability)`](crate::operation::update_proxy_session::builders::UpdateProxySessionFluentBuilder::capabilities) / [`set_capabilities(Option<Vec<Capability>>)`](crate::operation::update_proxy_session::builders::UpdateProxySessionFluentBuilder::set_capabilities): <p>The proxy session capabilities.</p>
