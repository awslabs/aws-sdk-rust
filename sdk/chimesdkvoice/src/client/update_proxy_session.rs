...
impl super::Client {
    ...
    ///   - [`voice_connector_id(impl ::std::convert::Into<String>)`](crate::operation::update_proxy_session::builders::UpdateProxySessionFluentBuilder::voice_connector_id) / [`set_voice_connector_id(Option<String>)`](crate::operation::update_proxy_session::builders::UpdateProxySessionFluentBuilder::set_voice_connector_id): <p>The Voice Connector ID.</p>
    ///   - [`proxy_session_id(impl ::std::convert::Into<String>)`](crate::operation::update_proxy_session::builders::UpdateProxySessionFluentBuilder::proxy_session_id) / [`set_proxy_session_id(Option<String>)`](crate::operation::update_proxy_session::builders::UpdateProxySessionFluentBuilder::set_proxy_session_id): <p>The proxy session ID.</p>
