...
impl super::Client  {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_phone_number_orders::builders::ListPhoneNumberOrdersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_phone_number_orders::builders::ListPhoneNumberOrdersFluentBuilder::set_next_token): (undocumented)
    ///   - [`max_results(i32)`](crate::operation::list_phone_number_orders::builders::ListPhoneNumberOrdersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_phone_number_orders::builders::ListPhoneNumberOrdersFluentBuilder::set_max_results): (undocumented)
    ...
    ///   - [`phone_number_orders(Option<Vec<PhoneNumberOrder>>)`](crate::operation::list_phone_number_orders::ListPhoneNumberOrdersOutput::phone_number_orders): (undocumented)
    ///   - [`next_token(Option<String>)`](crate::operation::list_phone_number_orders::ListPhoneNumberOrdersOutput::next_token): (undocumented)
