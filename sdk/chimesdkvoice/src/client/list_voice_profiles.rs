...
impl super::Client {
    ...
    ///   - [`voice_profile_domain_id(impl ::std::convert::Into<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::voice_profile_domain_id) / [`set_voice_profile_domain_id(Option<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::set_voice_profile_domain_id): <p>The ID of the voice profile domain.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::set_next_token): <p>The token used to retrieve the next page of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::set_max_results): <p>The maximum number of results in the request.</p>
