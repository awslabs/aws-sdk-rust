...
impl super::Client  {
    ...
    ///   - [`voice_profile_domain_id(impl Into<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::voice_profile_domain_id) / [`set_voice_profile_domain_id(Option<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::set_voice_profile_domain_id): <p>The ID of the voice profile domain.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_voice_profiles::builders::ListVoiceProfilesFluentBuilder::set_next_token): <p>The token used to retrieve the next page of results.</p>
