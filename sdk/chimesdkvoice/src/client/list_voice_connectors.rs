...
impl super::Client  {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_voice_connectors::builders::ListVoiceConnectorsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_voice_connectors::builders::ListVoiceConnectorsFluentBuilder::set_next_token): (undocumented)
    ///   - [`max_results(i32)`](crate::operation::list_voice_connectors::builders::ListVoiceConnectorsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_voice_connectors::builders::ListVoiceConnectorsFluentBuilder::set_max_results): (undocumented)
    ...
    ///   - [`voice_connectors(Option<Vec<VoiceConnector>>)`](crate::operation::list_voice_connectors::ListVoiceConnectorsOutput::voice_connectors): (undocumented)
    ///   - [`next_token(Option<String>)`](crate::operation::list_voice_connectors::ListVoiceConnectorsOutput::next_token): (undocumented)
