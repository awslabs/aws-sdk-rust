...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_voice_connectors::builders::ListVoiceConnectorsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_voice_connectors::builders::ListVoiceConnectorsFluentBuilder::set_next_token): <p>The token used to return the next page of results.</p>
