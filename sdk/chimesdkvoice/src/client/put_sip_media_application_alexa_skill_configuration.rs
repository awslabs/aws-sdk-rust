...
impl super::Client {
    ...
    ///   - [`sip_media_application_id(impl ::std::convert::Into<String>)`](crate::operation::put_sip_media_application_alexa_skill_configuration::builders::PutSipMediaApplicationAlexaSkillConfigurationFluentBuilder::sip_media_application_id) / [`set_sip_media_application_id(Option<String>)`](crate::operation::put_sip_media_application_alexa_skill_configuration::builders::PutSipMediaApplicationAlexaSkillConfigurationFluentBuilder::set_sip_media_application_id): <p>The SIP media application ID.</p>
