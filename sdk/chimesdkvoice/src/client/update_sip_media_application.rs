...
impl super::Client  {
    ...
    ///   - [`sip_media_application(Option<SipMediaApplication>)`](crate::operation::update_sip_media_application::UpdateSipMediaApplicationOutput::sip_media_application): (undocumented)
