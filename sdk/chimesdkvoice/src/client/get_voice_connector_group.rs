...
impl super::Client {
    ...
    ///   - [`voice_connector_group_id(impl ::std::convert::Into<String>)`](crate::operation::get_voice_connector_group::builders::GetVoiceConnectorGroupFluentBuilder::voice_connector_group_id) / [`set_voice_connector_group_id(Option<String>)`](crate::operation::get_voice_connector_group::builders::GetVoiceConnectorGroupFluentBuilder::set_voice_connector_group_id): <p>The Voice Connector group ID.</p>
