...
impl super::Client {
    ...
    ///   - [`voice_connector_id(impl Into<String>)`](crate::operation::delete_proxy_session::builders::DeleteProxySessionFluentBuilder::voice_connector_id) / [`set_voice_connector_id(Option<String>)`](crate::operation::delete_proxy_session::builders::DeleteProxySessionFluentBuilder::set_voice_connector_id): <p>The Voice Connector ID.</p>
