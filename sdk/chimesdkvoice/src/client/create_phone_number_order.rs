...
impl super::Client {
    ...
    ///   - [`e164_phone_numbers(impl Into<String>)`](crate::operation::create_phone_number_order::builders::CreatePhoneNumberOrderFluentBuilder::e164_phone_numbers) / [`set_e164_phone_numbers(Option<Vec::<String>>)`](crate::operation::create_phone_number_order::builders::CreatePhoneNumberOrderFluentBuilder::set_e164_phone_numbers):<br>required: **true**<br><p>List of phone numbers, in E.164 format.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_phone_number_order::builders::CreatePhoneNumberOrderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_phone_number_order::builders::CreatePhoneNumberOrderFluentBuilder::set_name):<br>required: **false**<br><p>Specifies the name assigned to one or more phone numbers.</p><br>
