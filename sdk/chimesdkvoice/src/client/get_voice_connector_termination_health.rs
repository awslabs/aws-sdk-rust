...
impl super::Client  {
    ...
    ///   - [`termination_health(Option<TerminationHealth>)`](crate::operation::get_voice_connector_termination_health::GetVoiceConnectorTerminationHealthOutput::termination_health): (undocumented)
