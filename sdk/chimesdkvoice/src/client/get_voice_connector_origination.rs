...
impl super::Client {
    ...
    ///   - [`voice_connector_id(impl ::std::convert::Into<String>)`](crate::operation::get_voice_connector_origination::builders::GetVoiceConnectorOriginationFluentBuilder::voice_connector_id) / [`set_voice_connector_id(Option<String>)`](crate::operation::get_voice_connector_origination::builders::GetVoiceConnectorOriginationFluentBuilder::set_voice_connector_id): <p>The Voice Connector ID.</p>
