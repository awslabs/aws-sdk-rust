...
impl super::Client {
    ...
    ///   - [`voice_connector_id(impl Into<String>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::voice_connector_id) / [`set_voice_connector_id(Option<String>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::set_voice_connector_id): <p>The Voice Connector ID.</p>
    ...
    ///   - [`capabilities(Vec<Capability>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::capabilities) / [`set_capabilities(Option<Vec<Capability>>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::set_capabilities): <p>The proxy session's capabilities.</p>
