...
impl super::Client {
    ...
    ///   - [`capabilities(Capability)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::capabilities) / [`set_capabilities(Option<Vec<Capability>>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::set_capabilities): <p>The proxy session's capabilities.</p>
