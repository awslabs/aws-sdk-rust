...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_voice_connector_groups::builders::ListVoiceConnectorGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_voice_connector_groups::builders::ListVoiceConnectorGroupsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token used to return the next page of results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_voice_connector_groups::builders::ListVoiceConnectorGroupsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_voice_connector_groups::builders::ListVoiceConnectorGroupsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in a single call.</p><br>
