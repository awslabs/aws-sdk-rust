...
impl super::Client  {
    ...
    ///   - [`phone_number_id(impl Into<String>)`](crate::operation::delete_phone_number::builders::DeletePhoneNumberFluentBuilder::phone_number_id) / [`set_phone_number_id(Option<String>)`](crate::operation::delete_phone_number::builders::DeletePhoneNumberFluentBuilder::set_phone_number_id): (undocumented)
