...
impl super::Client  {
    ...
    ///   - [`sip_media_application_id(impl Into<String>)`](crate::operation::delete_sip_media_application::builders::DeleteSipMediaApplicationFluentBuilder::sip_media_application_id) / [`set_sip_media_application_id(Option<String>)`](crate::operation::delete_sip_media_application::builders::DeleteSipMediaApplicationFluentBuilder::set_sip_media_application_id): (undocumented)
