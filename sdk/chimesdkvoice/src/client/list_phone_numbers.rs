...
impl super::Client {
    ...
    ///   - [`status(impl Into<String>)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::status) / [`set_status(Option<String>)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::set_status):<br>required: **false**<br><p>The status of your organization's phone numbers.</p><br>
    ///   - [`product_type(PhoneNumberProductType)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::product_type) / [`set_product_type(Option<PhoneNumberProductType>)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::set_product_type):<br>required: **false**<br><p>The phone number product types.</p><br>
    ///   - [`filter_name(PhoneNumberAssociationName)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::filter_name) / [`set_filter_name(Option<PhoneNumberAssociationName>)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::set_filter_name):<br>required: **false**<br><p>The filter to limit the number of results.</p><br>
    ///   - [`filter_value(impl Into<String>)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::filter_value) / [`set_filter_value(Option<String>)`](crate::operation::list_phone_numbers::builders::ListPhoneNumbersFluentBuilder::set_filter_value):<br>required: **false**<br><p>The filter value.</p><br>
