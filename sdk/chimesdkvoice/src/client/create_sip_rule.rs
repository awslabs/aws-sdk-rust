...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_sip_rule::builders::CreateSipRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_sip_rule::builders::CreateSipRuleFluentBuilder::set_name): <p>The name of the SIP rule.</p>
    ...
    ///   - [`sip_rule(Option<SipRule>)`](crate::operation::create_sip_rule::CreateSipRuleOutput::sip_rule): <p>The SIP rule information, including the rule ID, triggers, and target applications.</p>
