...
impl ::std::convert::From<&str> for GeoMatchLevel {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => GeoMatchLevel::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for GeoMatchLevel {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(GeoMatchLevel::from(s))
    }
}
impl GeoMatchLevel {
...
impl ::std::convert::AsRef<str> for GeoMatchLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
