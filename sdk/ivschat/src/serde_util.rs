...
pub(crate) fn pending_verification_correct_errors(
...
pub(crate) fn list_logging_configurations_output_output_correct_errors(
    ...
    if builder.logging_configurations.is_none() {
        builder.logging_configurations = Some(Default::default())
    }
    builder
}
...
pub(crate) fn list_rooms_output_output_correct_errors(
    ...
    if builder.rooms.is_none() {
        builder.rooms = Some(Default::default())
    }
    builder
}
...
pub(crate) fn cloud_watch_logs_destination_configuration_correct_errors(
    mut builder: crate::types::builders::CloudWatchLogsDestinationConfigurationBuilder,
) -> crate::types::builders::CloudWatchLogsDestinationConfigurationBuilder {
...
pub(crate) fn firehose_destination_configuration_correct_errors(
    mut builder: crate::types::builders::FirehoseDestinationConfigurationBuilder,
) -> crate::types::builders::FirehoseDestinationConfigurationBuilder {
