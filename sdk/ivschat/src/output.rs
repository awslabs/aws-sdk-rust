...
pub struct UpdateRoomOutput  {
    ...
    #[doc(hidden)]pub maximum_message_rate_per_second: i32,
    /// <p>Maximum number of characters in a single message, from the request.</p>
    #[doc(hidden)]pub maximum_message_length: i32,
    /// <p>Configuration information for optional review of messages.</p>
    #[doc(hidden)]pub message_review_handler: std::option::Option<crate::model::MessageReviewHandler>,
...
impl  std::fmt::Debug for UpdateRoomOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("maximum_message_rate_per_second", &self.maximum_message_rate_per_second);
...
pub struct ListRoomsOutput  {
    ...
    #[doc(hidden)]pub rooms: std::option::Option<std::vec::Vec<crate::model::RoomSummary>>,
...
pub struct CreateChatTokenOutput  {
    ...
    #[doc(hidden)]pub token_expiration_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub session_expiration_time: std::option::Option<aws_smithy_types::DateTime>,
}
