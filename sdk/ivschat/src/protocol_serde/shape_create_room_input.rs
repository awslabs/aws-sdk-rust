...
pub fn ser_create_room_input_input(
    ...
    if let Some(var_4) = &input.maximum_message_length {
        object.key("maximumMessageLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.maximum_message_rate_per_second {
        object.key("maximumMessageRatePerSecond").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
