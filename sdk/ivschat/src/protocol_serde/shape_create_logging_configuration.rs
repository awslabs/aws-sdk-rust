...
> {
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_logging_configuration::CreateLoggingConfigurationError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "state" => {
                    builder = builder.set_state(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::CreateLoggingConfigurationState::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "tags" => {
