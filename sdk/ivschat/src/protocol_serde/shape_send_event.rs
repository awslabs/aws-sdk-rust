...
> {
    ...
    Err(match error_code {
        ...
        "PendingVerification" => {
            crate::operation::send_event::SendEventError::PendingVerification({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_pending_verification::de_pending_verification_json_err(response.body().as_ref(), output).map_err(crate::operation::send_event::SendEventError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_send_event::de_send_event(
...
pub(crate) fn de_send_event(
    ...
    crate::operation::send_event::builders::SendEventOutputBuilder,
