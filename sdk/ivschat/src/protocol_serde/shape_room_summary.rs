...
pub(crate) fn de_room_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::RoomSummary>, aws_smithy_json::deserialize::error::DeserializeError>
