...
pub fn ser_create_chat_token_input_input(
    ...
    if let Some(var_9) = &input.session_duration_in_minutes {
        object.key("sessionDurationInMinutes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
