...
pub fn ser_create_chat_token_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateChatTokenInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
