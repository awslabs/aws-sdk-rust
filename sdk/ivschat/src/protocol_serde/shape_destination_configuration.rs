...
pub(crate) fn de_destination_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DestinationConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_destination_configuration(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DestinationConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
