            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "s3" => Some(crate::types::DestinationConfiguration::S3(
                        ...
                        "cloudWatchLogs" => Some(crate::types::DestinationConfiguration::CloudWatchLogs(
                            crate::protocol_serde::shape_cloud_watch_logs_destination_configuration::de_cloud_watch_logs_destination_configuration(
                                tokens,
                            )?
                            .ok_or_else(|| {
                        ...
                        "firehose" => Some(crate::types::DestinationConfiguration::Firehose(
                            crate::protocol_serde::shape_firehose_destination_configuration::de_firehose_destination_configuration(tokens)?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'firehose' cannot be null")
                                })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
...
pub fn ser_destination_configuration(
    ...
    match input {
        ...
        crate::types::DestinationConfiguration::CloudWatchLogs(inner) => {
            ...
            crate::protocol_serde::shape_cloud_watch_logs_destination_configuration::ser_cloud_watch_logs_destination_configuration(
                &mut object_2,
                inner,
            )?;
            object_2.finish();
