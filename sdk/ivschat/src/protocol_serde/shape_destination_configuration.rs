                        ...
                        variant = match key.as_ref() {
                            ...
                            "cloudWatchLogs" => {
                                Some(crate::types::DestinationConfiguration::CloudWatchLogs(
                                    crate::protocol_serde::shape_cloud_watch_logs_destination_configuration::de_cloud_watch_logs_destination_configuration(tokens, _value)?
                            ...
                            "firehose" => {
                                Some(crate::types::DestinationConfiguration::Firehose(
                                    crate::protocol_serde::shape_firehose_destination_configuration::de_firehose_destination_configuration(tokens, _value)?
