...
impl super::Client {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::get_room::builders::GetRoomFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_room::builders::GetRoomFluentBuilder::set_identifier): <p>Identifier of the room for which the configuration is to be retrieved. Currently this must be an ARN.</p>
