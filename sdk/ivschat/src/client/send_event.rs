...
impl super::Client {
    ...
    ///   - [`room_identifier(impl Into<String>)`](crate::operation::send_event::builders::SendEventFluentBuilder::room_identifier) / [`set_room_identifier(impl Into<String>)`](crate::operation::send_event::builders::SendEventFluentBuilder::set_room_identifier):<br>required: **true**<br><p>Identifier of the room to which the event will be sent. Currently this must be an ARN.</p><br>
    ///   - [`event_name(impl Into<String>)`](crate::operation::send_event::builders::SendEventFluentBuilder::event_name) / [`set_event_name(impl Into<String>)`](crate::operation::send_event::builders::SendEventFluentBuilder::set_event_name):<br>required: **true**<br><p>Application-defined name of the event to send to clients.</p><br>
