...
impl super::Client {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::get_logging_configuration::builders::GetLoggingConfigurationFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_logging_configuration::builders::GetLoggingConfigurationFluentBuilder::set_identifier): <p>Identifier of the logging configuration to be retrieved.</p>
