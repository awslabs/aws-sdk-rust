...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::delete_room::builders::DeleteRoomFluentBuilder::identifier) / [`set_identifier(impl Into<String>)`](crate::operation::delete_room::builders::DeleteRoomFluentBuilder::set_identifier):<br>required: **true**<br><p>Identifier of the room to be deleted. Currently this must be an ARN.</p><br>
