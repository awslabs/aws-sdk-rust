...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_rooms::builders::ListRoomsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_rooms::builders::ListRoomsFluentBuilder::set_max_results):<br>required: **false**<br><p>Maximum number of rooms to return. Default: 50.</p><br>
