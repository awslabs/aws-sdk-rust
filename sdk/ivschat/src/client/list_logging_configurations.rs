...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_logging_configurations::builders::ListLoggingConfigurationsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_logging_configurations::builders::ListLoggingConfigurationsFluentBuilder::set_max_results):<br>required: **false**<br><p>Maximum number of logging configurations to return. Default: 50.</p><br>
