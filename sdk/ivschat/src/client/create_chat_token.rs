...
impl super::Client {
    ...
    ///   - [`attributes(impl Into<String>, impl Into<String>)`](crate::operation::create_chat_token::builders::CreateChatTokenFluentBuilder::attributes) / [`set_attributes(Option<HashMap<String, String>>)`](crate::operation::create_chat_token::builders::CreateChatTokenFluentBuilder::set_attributes): <p>Application-provided attributes to encode into the token and attach to a chat session. Map keys and values can contain UTF-8 encoded text. The maximum length of this field is 1 KB total.</p>
