...
impl super::Client {
    ...
    ///   - [`logging_configuration_identifiers(impl Into<String>)`](crate::operation::update_room::builders::UpdateRoomFluentBuilder::logging_configuration_identifiers) / [`set_logging_configuration_identifiers(Option<Vec<String>>)`](crate::operation::update_room::builders::UpdateRoomFluentBuilder::set_logging_configuration_identifiers): <p>Array of logging-configuration identifiers attached to the room.</p>
