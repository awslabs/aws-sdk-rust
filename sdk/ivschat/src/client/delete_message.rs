...
impl super::Client {
    ...
    ///   - [`room_identifier(impl Into<String>)`](crate::operation::delete_message::builders::DeleteMessageFluentBuilder::room_identifier) / [`set_room_identifier(impl Into<String>)`](crate::operation::delete_message::builders::DeleteMessageFluentBuilder::set_room_identifier):<br>required: **true**<br><p>Identifier of the room where the message should be deleted. Currently this must be an ARN. </p><br>
    ///   - [`id(impl Into<String>)`](crate::operation::delete_message::builders::DeleteMessageFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::delete_message::builders::DeleteMessageFluentBuilder::set_id):<br>required: **true**<br><p>ID of the message to be deleted. This is the <code>Id</code> field in the received message (see <a href="https://docs.aws.amazon.com/ivs/latest/chatmsgapireference/actions-message-subscribe.html"> Message (Subscribe)</a> in the Chat Messaging API).</p><br>
