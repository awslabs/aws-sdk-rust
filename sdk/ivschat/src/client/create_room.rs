...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_room::builders::CreateRoomFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_room::builders::CreateRoomFluentBuilder::set_name): <p>Room name. The value does not need to be unique.</p>
