...
impl super::Client {
    ...
    ///   - [`room_identifier(impl Into<String>)`](crate::operation::disconnect_user::builders::DisconnectUserFluentBuilder::room_identifier) / [`set_room_identifier(impl Into<String>)`](crate::operation::disconnect_user::builders::DisconnectUserFluentBuilder::set_room_identifier):<br>required: **true**<br><p>Identifier of the room from which the user's clients should be disconnected. Currently this must be an ARN.</p><br>
    ///   - [`user_id(impl Into<String>)`](crate::operation::disconnect_user::builders::DisconnectUserFluentBuilder::user_id) / [`set_user_id(impl Into<String>)`](crate::operation::disconnect_user::builders::DisconnectUserFluentBuilder::set_user_id):<br>required: **true**<br><p>ID of the user (connection) to disconnect from the room.</p><br>
