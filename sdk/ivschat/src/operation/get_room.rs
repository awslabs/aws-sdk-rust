...
impl GetRoomInput {
    /// Consumes the builder and constructs an Operation<[`GetRoom`](crate::operation::get_room::GetRoom)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_room::GetRoom, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_room::ser_get_room_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_room::GetRoom::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRoom {
    type Output = ::std::result::Result<crate::operation::get_room::GetRoomOutput, crate::operation::get_room::GetRoomError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_room::de_get_room_http_response_with_props(status, headers, body)
        }
    }
}
