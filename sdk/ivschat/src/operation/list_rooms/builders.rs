...
pub use crate::operation::list_rooms::_list_rooms_output::ListRoomsOutputBuilder;

pub use crate::operation::list_rooms::_list_rooms_input::ListRoomsInputBuilder;

impl crate::operation::list_rooms::builders::ListRoomsInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::list_rooms::ListRoomsOutput, crate::operation::list_rooms::ListRoomsError>
    for ListRoomsFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::list_rooms::ListRoomsOutput, crate::operation::list_rooms::ListRoomsError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl ListRoomsFluentBuilder {
    /// Creates a new `ListRoomsFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_rooms::ListRooms::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_rooms::ListRooms::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_rooms::paginator::ListRoomsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
