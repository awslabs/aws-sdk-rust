...
impl ListRoomsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_rooms::ListRooms, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_rooms::ser_list_rooms_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRooms {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_rooms::de_list_rooms_http_response_with_props(status, headers, body)
        }
    }
}
