...
impl UpdateRoomInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_room::UpdateRoom, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_room::ser_update_room_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_room::de_update_room_http_response_with_props(status, headers, body)
        }
    }
}
