...
impl  ListLoggingConfigurationsOutput  {
    ...
    pub fn logging_configurations(&self) -> & [crate::types::LoggingConfigurationSummary] {
        use std::ops::Deref; self.logging_configurations.deref()
    }
    /// <p>If there are more logging configurations than <code>maxResults</code>, use <code>nextToken</code> in the request to get the next set.</p>
...
impl ListLoggingConfigurationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_logging_configurations::ListLoggingConfigurationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_logging_configurations::ListLoggingConfigurationsOutput {
                logging_configurations: self.logging_configurations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("logging_configurations", "logging_configurations was not specified but it is required when building ListLoggingConfigurationsOutput")
                    )?
                ,
