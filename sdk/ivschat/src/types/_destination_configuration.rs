...
impl DestinationConfiguration {
    ...
    pub fn as_cloud_watch_logs(&self) -> ::std::result::Result<&crate::types::CloudWatchLogsDestinationConfiguration, &Self> {
        if let DestinationConfiguration::CloudWatchLogs(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_firehose(&self) -> ::std::result::Result<&crate::types::FirehoseDestinationConfiguration, &Self> {
        if let DestinationConfiguration::Firehose(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_s3(&self) -> ::std::result::Result<&crate::types::S3DestinationConfiguration, &Self> {
        if let DestinationConfiguration::S3(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
