...
pub fn ser_update_network_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_network_settings::UpdateNetworkSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
