...
pub fn de_list_user_access_logging_settings_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsOutput, crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_user_access_logging_settings_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsOutput, crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsError> {
    Ok({
        #[allow(unused_mut)]
