...
> {
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::operation::associate_trust_store::AssociateTrustStoreError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::associate_trust_store::AssociateTrustStoreError::unhandled(
