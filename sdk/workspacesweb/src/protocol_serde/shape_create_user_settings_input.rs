...
pub fn ser_create_user_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUserSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
