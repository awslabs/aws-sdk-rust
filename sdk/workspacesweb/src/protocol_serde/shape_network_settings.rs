...
pub(crate) fn de_network_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NetworkSettings>, aws_smithy_json::deserialize::error::DeserializeError>
