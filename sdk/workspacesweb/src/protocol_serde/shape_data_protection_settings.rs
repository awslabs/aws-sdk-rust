...
pub(crate) fn de_data_protection_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DataProtectionSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DataProtectionSettingsBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "inlineRedactionConfiguration" => {
                            builder = builder.set_inline_redaction_configuration(
                                crate::protocol_serde::shape_inline_redaction_configuration::de_inline_redaction_configuration(tokens, _value)?,
                            );
                        }
            ...
            Ok(Some(
                crate::serde_util::data_protection_settings_correct_errors(builder)
                    .build()
