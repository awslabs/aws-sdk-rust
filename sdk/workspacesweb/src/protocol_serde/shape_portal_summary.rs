...
) -> Result<Option<crate::types::PortalSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "rendererType" => {
                            builder = builder.set_renderer_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RendererType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "browserType" => {
                        ...
                        "portalStatus" => {
                            builder = builder.set_portal_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::PortalStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "portalEndpoint" => {
            ...
            Ok(Some(crate::serde_util::portal_summary_correct_errors(builder).build().map_err(
