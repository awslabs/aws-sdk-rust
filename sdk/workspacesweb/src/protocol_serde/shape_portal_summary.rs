...
pub(crate) fn de_portal_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PortalSummary>, aws_smithy_json::deserialize::error::DeserializeError>
