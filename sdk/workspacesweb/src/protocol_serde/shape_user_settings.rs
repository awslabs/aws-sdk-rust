...
pub(crate) fn de_user_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UserSettings>, aws_smithy_json::deserialize::error::DeserializeError>
