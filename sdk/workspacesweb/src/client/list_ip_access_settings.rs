...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_ip_access_settings::builders::ListIpAccessSettingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_ip_access_settings::builders::ListIpAccessSettingsFluentBuilder::set_next_token): <p>The pagination token used to retrieve the next page of results for this operation.</p>
    ///   - [`max_results(i32)`](crate::operation::list_ip_access_settings::builders::ListIpAccessSettingsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_ip_access_settings::builders::ListIpAccessSettingsFluentBuilder::set_max_results): <p>The maximum number of results to be included in the next page.</p>
