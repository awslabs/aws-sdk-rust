...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_ip_access_settings::builders::ListIpAccessSettingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_ip_access_settings::builders::ListIpAccessSettingsFluentBuilder::set_next_token): <p>The pagination token used to retrieve the next page of results for this operation.</p>
