...
impl super::Client {
    ...
    ///   - [`network_settings_arn(impl ::std::convert::Into<String>)`](crate::operation::get_network_settings::builders::GetNetworkSettingsFluentBuilder::network_settings_arn) / [`set_network_settings_arn(Option<String>)`](crate::operation::get_network_settings::builders::GetNetworkSettingsFluentBuilder::set_network_settings_arn): <p>The ARN of the network settings.</p>
