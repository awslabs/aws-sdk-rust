...
impl super::Client {
    ...
    ///   - [`user_access_logging_settings_arn(impl Into<String>)`](crate::operation::get_user_access_logging_settings::builders::GetUserAccessLoggingSettingsFluentBuilder::user_access_logging_settings_arn) / [`set_user_access_logging_settings_arn(Option<String>)`](crate::operation::get_user_access_logging_settings::builders::GetUserAccessLoggingSettingsFluentBuilder::set_user_access_logging_settings_arn):<br>required: **true**<br><p>The ARN of the user access logging settings.</p><br>
