...
impl super::Client {
    ...
    pub fn delete_user_access_logging_settings(
        &self,
    ) -> crate::operation::delete_user_access_logging_settings::builders::DeleteUserAccessLoggingSettingsFluentBuilder {
