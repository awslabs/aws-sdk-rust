...
impl super::Client {
    ...
    ///   - [`portal_arn(String)`](crate::operation::associate_user_settings::AssociateUserSettingsOutput::portal_arn): <p>The ARN of the web portal.</p>
    ///   - [`user_settings_arn(String)`](crate::operation::associate_user_settings::AssociateUserSettingsOutput::user_settings_arn): <p>The ARN of the user settings.</p>
