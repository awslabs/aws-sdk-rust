...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_trust_store::builders::CreateTrustStoreFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_trust_store::builders::CreateTrustStoreFluentBuilder::set_tags): <p>The tags to add to the trust store. A tag is a key-value pair.</p>
