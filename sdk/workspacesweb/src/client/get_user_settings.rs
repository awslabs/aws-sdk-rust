...
impl super::Client {
    ...
    ///   - [`user_settings_arn(impl Into<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::user_settings_arn) / [`set_user_settings_arn(Option<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::set_user_settings_arn):<br>required: **true**<br><p>The ARN of the user settings.</p><br>
