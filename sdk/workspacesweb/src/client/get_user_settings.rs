...
impl super::Client {
    ...
    ///   - [`user_settings_arn(impl ::std::convert::Into<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::user_settings_arn) / [`set_user_settings_arn(Option<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::set_user_settings_arn): <p>The ARN of the user settings.</p>
