...
impl super::Client {
    ...
    ///   - [`ip_access_settings_arn(impl Into<String>)`](crate::operation::get_ip_access_settings::builders::GetIpAccessSettingsFluentBuilder::ip_access_settings_arn) / [`set_ip_access_settings_arn(Option<String>)`](crate::operation::get_ip_access_settings::builders::GetIpAccessSettingsFluentBuilder::set_ip_access_settings_arn): <p>The ARN of the IP access settings.</p>
