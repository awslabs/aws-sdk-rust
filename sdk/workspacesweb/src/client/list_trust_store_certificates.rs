...
impl super::Client {
    ...
    ///   - [`trust_store_arn(impl ::std::convert::Into<String>)`](crate::operation::list_trust_store_certificates::builders::ListTrustStoreCertificatesFluentBuilder::trust_store_arn) / [`set_trust_store_arn(Option<String>)`](crate::operation::list_trust_store_certificates::builders::ListTrustStoreCertificatesFluentBuilder::set_trust_store_arn): <p>The ARN of the trust store</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_trust_store_certificates::builders::ListTrustStoreCertificatesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_trust_store_certificates::builders::ListTrustStoreCertificatesFluentBuilder::set_next_token): <p>The pagination token used to retrieve the next page of results for this operation.</p>
