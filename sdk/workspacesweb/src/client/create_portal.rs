...
impl super::Client {
    ...
    ///   - [`customer_managed_key(impl Into<String>)`](crate::operation::create_portal::builders::CreatePortalFluentBuilder::customer_managed_key) / [`set_customer_managed_key(Option<String>)`](crate::operation::create_portal::builders::CreatePortalFluentBuilder::set_customer_managed_key): <p>The customer managed key of the web portal.</p>
    ...
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_portal::builders::CreatePortalFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_portal::builders::CreatePortalFluentBuilder::set_client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token returns the result from the original successful request. </p>  <p>If you do not specify a client token, one is automatically generated by the AWS SDK.</p>
