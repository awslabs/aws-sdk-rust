...
impl super::Client {
    ...
    ///   - [`identity_provider_arn(impl Into<String>)`](crate::operation::delete_identity_provider::builders::DeleteIdentityProviderFluentBuilder::identity_provider_arn) / [`set_identity_provider_arn(Option<String>)`](crate::operation::delete_identity_provider::builders::DeleteIdentityProviderFluentBuilder::set_identity_provider_arn):<br>required: **true**<br><p>The ARN of the identity provider.</p><br>
