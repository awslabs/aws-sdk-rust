...
impl ListTrustStoresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_trust_stores::ListTrustStores,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_trust_stores::ListTrustStores::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrustStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_trust_stores::de_list_trust_stores_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_trust_stores::ListTrustStoresError
{
