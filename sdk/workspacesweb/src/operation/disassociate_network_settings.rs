...
impl DisassociateNetworkSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateNetworkSettings`](crate::operation::disassociate_network_settings::DisassociateNetworkSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_network_settings::DisassociateNetworkSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_network_settings::DisassociateNetworkSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_network_settings::DisassociateNetworkSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateNetworkSettings {
                type Output = std::result::Result<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsOutput, crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError>;
