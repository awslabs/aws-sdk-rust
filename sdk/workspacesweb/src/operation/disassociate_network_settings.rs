...
/// Orchestration and serialization glue logic for `DisassociateNetworkSettings`.
...
impl DisassociateNetworkSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_network_settings::DisassociateNetworkSettingsInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateNetworkSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateNetworkSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateNetworkSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateNetworkSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateNetworkSettings")
...
.with_interceptor(DisassociateNetworkSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError>::new());
...
#[derive(Debug)]
            struct DisassociateNetworkSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateNetworkSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_network_settings::de_disassociate_network_settings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_network_settings::de_disassociate_network_settings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateNetworkSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateNetworkSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_network_settings::DisassociateNetworkSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_network_settings::DisassociateNetworkSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/portals/{portalArn}/networkSettings", portalArn = portal_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DisassociateNetworkSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateNetworkSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateNetworkSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateNetworkSettingsInput>()
                        .ok_or("failed to downcast to DisassociateNetworkSettingsInput")?;
...
pub enum DisassociateNetworkSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateNetworkSettingsError) for what information is available for the error.")]
...
impl DisassociateNetworkSettingsError {
    /// Creates the `DisassociateNetworkSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateNetworkSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateNetworkSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError {
...
mod _disassociate_network_settings_output;
