...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateNetworkSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_network_settings::de_disassociate_network_settings_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DisassociateNetworkSettingsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disassociate_network_settings::DisassociateNetworkSettingsError
{
