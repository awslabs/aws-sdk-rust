...
/// Orchestration and serialization glue logic for `DisassociateTrustStore`.
...
impl DisassociateTrustStore {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_trust_store::DisassociateTrustStoreInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_trust_store::DisassociateTrustStoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_trust_store::DisassociateTrustStoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_trust_store::DisassociateTrustStoreError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_trust_store::DisassociateTrustStoreOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateTrustStore {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateTrustStore");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateTrustStoreRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateTrustStoreResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateTrustStore")
...
.with_interceptor(DisassociateTrustStoreEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_trust_store::DisassociateTrustStoreError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_trust_store::DisassociateTrustStoreError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_trust_store::DisassociateTrustStoreError>::new());
...
#[derive(Debug)]
            struct DisassociateTrustStoreResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateTrustStoreResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_trust_store::de_disassociate_trust_store_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DisassociateTrustStoreRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateTrustStoreRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_trust_store::DisassociateTrustStoreInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_trust_store::DisassociateTrustStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/portals/{portalArn}/trustStores", portalArn = portal_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DisassociateTrustStoreEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateTrustStoreEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateTrustStoreEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateTrustStoreInput>()
                        .ok_or("failed to downcast to DisassociateTrustStoreInput")?;
...
pub enum DisassociateTrustStoreError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateTrustStoreError) for what information is available for the error.")]
...
impl DisassociateTrustStoreError {
    /// Creates the `DisassociateTrustStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateTrustStoreError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateTrustStoreError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_trust_store::DisassociateTrustStoreError {
...
mod _disassociate_trust_store_output;
