...
impl DisassociateTrustStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disassociate_trust_store::DisassociateTrustStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateTrustStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_trust_store::de_disassociate_trust_store_http_response_with_props(status, headers, body)
        }
    }
}
