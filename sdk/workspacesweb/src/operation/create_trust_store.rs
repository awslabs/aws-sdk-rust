...
impl CreateTrustStoreInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_trust_store::CreateTrustStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrustStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_trust_store::de_create_trust_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_trust_store::CreateTrustStoreError
{
