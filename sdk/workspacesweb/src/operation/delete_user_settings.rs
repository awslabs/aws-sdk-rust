...
impl DeleteUserSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_user_settings::DeleteUserSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_user_settings::de_delete_user_settings_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_user_settings::DeleteUserSettingsError
{
