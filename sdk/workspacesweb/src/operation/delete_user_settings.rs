...
/// Orchestration and serialization glue logic for `DeleteUserSettings`.
...
impl DeleteUserSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_user_settings::DeleteUserSettingsInput,
                    ) -> ::std::result::Result<crate::operation::delete_user_settings::DeleteUserSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_user_settings::DeleteUserSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_user_settings::DeleteUserSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_user_settings::DeleteUserSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteUserSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteUserSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteUserSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteUserSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteUserSettings")
...
.with_interceptor(DeleteUserSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_user_settings::DeleteUserSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_user_settings::DeleteUserSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_user_settings::DeleteUserSettingsError>::new());
...
#[derive(Debug)]
            struct DeleteUserSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_user_settings::de_delete_user_settings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_user_settings::de_delete_user_settings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteUserSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_user_settings::DeleteUserSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_user_settings::DeleteUserSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.user_settings_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("user_settings_arn", "cannot be empty or unset"))?;
    let user_settings_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
    if user_settings_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("user_settings_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/userSettings/{userSettingsArn}", userSettingsArn = user_settings_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteUserSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteUserSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteUserSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteUserSettingsInput>()
                        .ok_or("failed to downcast to DeleteUserSettingsInput")?;
...
pub enum DeleteUserSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteUserSettingsError) for what information is available for the error.")]
...
impl DeleteUserSettingsError {
    /// Creates the `DeleteUserSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteUserSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteUserSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_user_settings::DeleteUserSettingsError {
...
mod _delete_user_settings_output;
