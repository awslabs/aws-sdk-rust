...
impl CreateUserAccessLoggingSettingsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_user_access_logging_settings::CreateUserAccessLoggingSettingsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_user_access_logging_settings::CreateUserAccessLoggingSettingsOutput {
                user_access_logging_settings_arn: self.user_access_logging_settings_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("user_access_logging_settings_arn", "user_access_logging_settings_arn was not specified but it is required when building CreateUserAccessLoggingSettingsOutput")
                    )?
                ,
