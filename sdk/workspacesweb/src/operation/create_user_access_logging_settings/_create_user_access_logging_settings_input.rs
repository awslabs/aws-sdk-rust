...
impl CreateUserAccessLoggingSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_user_access_logging_settings::CreateUserAccessLoggingSettingsInput, ::aws_smithy_types::error::operation::BuildError> {
