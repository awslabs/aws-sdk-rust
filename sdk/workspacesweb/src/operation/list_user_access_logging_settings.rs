...
impl ListUserAccessLoggingSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUserAccessLoggingSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_user_access_logging_settings::de_list_user_access_logging_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
