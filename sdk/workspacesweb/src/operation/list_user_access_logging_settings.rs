    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListUserAccessLoggingSettingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListUserAccessLoggingSettingsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListUserAccessLoggingSettingsEndpointParamsInterceptor {
