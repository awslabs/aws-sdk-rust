...
impl crate::operation::list_trust_store_certificates::builders::ListTrustStoreCertificatesInputBuilder {
...
impl ListTrustStoreCertificatesFluentBuilder {
    /// Creates a new `ListTrustStoreCertificatesFluentBuilder`.
