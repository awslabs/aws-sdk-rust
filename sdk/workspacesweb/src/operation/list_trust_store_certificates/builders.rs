...
pub use crate::operation::list_trust_store_certificates::_list_trust_store_certificates_output::ListTrustStoreCertificatesOutputBuilder;
...
impl ListTrustStoreCertificatesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_trust_store_certificates::ListTrustStoreCertificates::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesOutput, crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_trust_store_certificates::paginator::ListTrustStoreCertificatesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
