...
impl CreateNetworkSettingsInput {
    /// Consumes the builder and constructs an Operation<[`CreateNetworkSettings`](crate::operation::create_network_settings::CreateNetworkSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_network_settings::CreateNetworkSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_network_settings::CreateNetworkSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_network_settings::CreateNetworkSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNetworkSettings {
                type Output = std::result::Result<crate::operation::create_network_settings::CreateNetworkSettingsOutput, crate::operation::create_network_settings::CreateNetworkSettingsError>;
