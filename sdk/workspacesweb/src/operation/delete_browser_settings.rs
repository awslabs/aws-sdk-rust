...
impl DeleteBrowserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBrowserSettings`](crate::operation::delete_browser_settings::DeleteBrowserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_browser_settings::DeleteBrowserSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_browser_settings::DeleteBrowserSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.browser_settings_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("browser_settings_arn", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_browser_settings::DeleteBrowserSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBrowserSettings {
                type Output = std::result::Result<crate::operation::delete_browser_settings::DeleteBrowserSettingsOutput, crate::operation::delete_browser_settings::DeleteBrowserSettingsError>;
