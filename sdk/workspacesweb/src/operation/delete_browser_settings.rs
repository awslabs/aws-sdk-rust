...
/// Orchestration and serialization glue logic for `DeleteBrowserSettings`.
...
impl DeleteBrowserSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_browser_settings::DeleteBrowserSettingsInput,
                    ) -> ::std::result::Result<crate::operation::delete_browser_settings::DeleteBrowserSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_browser_settings::DeleteBrowserSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_browser_settings::DeleteBrowserSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_browser_settings::DeleteBrowserSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBrowserSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteBrowserSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteBrowserSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteBrowserSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteBrowserSettings")
...
.with_interceptor(DeleteBrowserSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_browser_settings::DeleteBrowserSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_browser_settings::DeleteBrowserSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_browser_settings::DeleteBrowserSettingsError>::new());
...
#[derive(Debug)]
            struct DeleteBrowserSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBrowserSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_browser_settings::de_delete_browser_settings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_browser_settings::de_delete_browser_settings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteBrowserSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBrowserSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_browser_settings::DeleteBrowserSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_browser_settings::DeleteBrowserSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.browser_settings_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("browser_settings_arn", "cannot be empty or unset"))?;
    let browser_settings_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
    ...
    ::std::write!(output, "/browserSettings/{browserSettingsArn}", browserSettingsArn = browser_settings_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteBrowserSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteBrowserSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteBrowserSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteBrowserSettingsInput>()
                        .ok_or("failed to downcast to DeleteBrowserSettingsInput")?;
...
pub enum DeleteBrowserSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteBrowserSettingsError) for what information is available for the error.")]
...
impl DeleteBrowserSettingsError {
    /// Creates the `DeleteBrowserSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteBrowserSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteBrowserSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_browser_settings::DeleteBrowserSettingsError {
...
mod _delete_browser_settings_output;
