...
impl UpdateNetworkSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_network_settings::UpdateNetworkSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_network_settings::UpdateNetworkSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_network_settings::UpdateNetworkSettingsOutput, crate::operation::update_network_settings::UpdateNetworkSettingsError, Self> {
