...
impl UpdateTrustStoreInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_trust_store::UpdateTrustStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrustStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_trust_store::de_update_trust_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_trust_store::UpdateTrustStoreError
{
