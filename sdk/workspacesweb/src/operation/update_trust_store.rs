...
impl UpdateTrustStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_trust_store::ser_update_trust_store_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrustStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_trust_store::de_update_trust_store_http_response_with_props(status, headers, body)
        }
    }
}
