...
impl UpdateTrustStoreInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTrustStore`](crate::operation::update_trust_store::UpdateTrustStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_trust_store::UpdateTrustStore, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_trust_store::UpdateTrustStoreInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_trust_store::UpdateTrustStore::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTrustStore {
                type Output = std::result::Result<crate::operation::update_trust_store::UpdateTrustStoreOutput, crate::operation::update_trust_store::UpdateTrustStoreError>;
