...
impl ListTrustStoreCertificatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_trust_store_certificates::ListTrustStoreCertificates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrustStoreCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_trust_store_certificates::de_list_trust_store_certificates_http_response_with_props(
                status, headers, body,
            )
        }
    }
