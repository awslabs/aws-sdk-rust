...
impl AssociateUserAccessLoggingSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateUserAccessLoggingSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_user_access_logging_settings::de_associate_user_access_logging_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
