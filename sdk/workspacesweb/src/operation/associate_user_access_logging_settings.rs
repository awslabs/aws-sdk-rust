...
impl AssociateUserAccessLoggingSettingsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
