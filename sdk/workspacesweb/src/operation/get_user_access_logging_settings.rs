...
impl GetUserAccessLoggingSettingsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettings::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetUserAccessLoggingSettings {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_user_access_logging_settings::de_get_user_access_logging_settings_http_error(response)
        } else {
            crate::protocol_serde::shape_get_user_access_logging_settings::de_get_user_access_logging_settings_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsError
{
