...
impl crate::operation::update_user_access_logging_settings::builders::UpdateUserAccessLoggingSettingsInputBuilder {
...
impl UpdateUserAccessLoggingSettingsFluentBuilder {
    /// Creates a new `UpdateUserAccessLoggingSettingsFluentBuilder`.
