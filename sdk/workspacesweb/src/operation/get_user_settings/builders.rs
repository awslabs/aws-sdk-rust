...
impl GetUserSettingsFluentBuilder  {
    /// Creates a new `GetUserSettings`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_user_settings::GetUserSettings, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_user_settings::GetUserSettingsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_user_settings::GetUserSettingsOutput, aws_smithy_http::result::SdkError<crate::operation::get_user_settings::GetUserSettingsError>>
                     {
