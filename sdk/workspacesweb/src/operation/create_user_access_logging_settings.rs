...
impl CreateUserAccessLoggingSettings {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_user_access_logging_settings::CreateUserAccessLoggingSettingsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateUserAccessLoggingSettingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateUserAccessLoggingSettingsRequestSerializer {
