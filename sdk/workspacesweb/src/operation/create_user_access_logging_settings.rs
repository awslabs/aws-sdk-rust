...
impl CreateUserAccessLoggingSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_user_access_logging_settings::CreateUserAccessLoggingSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUserAccessLoggingSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_user_access_logging_settings::de_create_user_access_logging_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
