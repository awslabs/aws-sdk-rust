...
impl AssociateBrowserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`AssociateBrowserSettings`](crate::operation::associate_browser_settings::AssociateBrowserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_browser_settings::AssociateBrowserSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_browser_settings::AssociateBrowserSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::associate_browser_settings::AssociateBrowserSettingsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_browser_settings::AssociateBrowserSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateBrowserSettings {
                type Output = std::result::Result<crate::operation::associate_browser_settings::AssociateBrowserSettingsOutput, crate::operation::associate_browser_settings::AssociateBrowserSettingsError>;
