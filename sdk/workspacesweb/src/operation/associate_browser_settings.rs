    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_browser_settings::AssociateBrowserSettingsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_browser_settings::AssociateBrowserSettingsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AssociateBrowserSettingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AssociateBrowserSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::associate_browser_settings::AssociateBrowserSettingsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("portal_arn", "cannot be empty or unset"))?;
            ...
            fn uri_query(
                ...
                let inner_2 = inner_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("browser_settings_arn", "cannot be empty or unset")
                })?;
                if inner_2.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field(
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AssociateBrowserSettingsEndpointParamsInterceptor {
