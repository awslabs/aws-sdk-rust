...
impl GetIdentityProviderInput {
    /// Consumes the builder and constructs an Operation<[`GetIdentityProvider`](crate::operation::get_identity_provider::GetIdentityProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_identity_provider::GetIdentityProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_identity_provider::GetIdentityProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.identity_provider_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("identity_provider_arn", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_identity_provider::GetIdentityProvider::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetIdentityProvider {
                type Output = std::result::Result<crate::operation::get_identity_provider::GetIdentityProviderOutput, crate::operation::get_identity_provider::GetIdentityProviderError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_identity_provider::de_get_identity_provider_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_identity_provider::de_get_identity_provider_http_response(response)
                     }
                }
            }
