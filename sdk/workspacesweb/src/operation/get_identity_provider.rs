...
impl GetIdentityProvider {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_identity_provider::GetIdentityProviderInput,
                    ) -> ::std::result::Result<crate::operation::get_identity_provider::GetIdentityProviderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_identity_provider::GetIdentityProviderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_identity_provider::GetIdentityProviderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_identity_provider::GetIdentityProviderOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIdentityProvider {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetIdentityProvider");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetIdentityProviderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetIdentityProviderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIdentityProvider")
...
.with_interceptor(GetIdentityProviderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_identity_provider::GetIdentityProviderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_identity_provider::GetIdentityProviderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_identity_provider::GetIdentityProviderError>::new());
...
#[derive(Debug)]
            struct GetIdentityProviderResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetIdentityProviderResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_identity_provider::de_get_identity_provider_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetIdentityProviderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetIdentityProviderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_identity_provider::GetIdentityProviderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_identity_provider::GetIdentityProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.identity_provider_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("identity_provider_arn", "cannot be empty or unset"))?;
    let identity_provider_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
    if identity_provider_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("identity_provider_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/identityProviders/{identityProviderArn}", identityProviderArn = identity_provider_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetIdentityProviderEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetIdentityProviderEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetIdentityProviderEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetIdentityProviderInput>()
                        .ok_or("failed to downcast to GetIdentityProviderInput")?;
...
pub enum GetIdentityProviderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetIdentityProviderError) for what information is available for the error.")]
...
impl GetIdentityProviderError {
    /// Creates the `GetIdentityProviderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetIdentityProviderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetIdentityProviderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_identity_provider::GetIdentityProviderError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_identity_provider::_get_identity_provider_output::GetIdentityProviderOutput;

pub use crate::operation::get_identity_provider::_get_identity_provider_input::GetIdentityProviderInput;

mod _get_identity_provider_input;

mod _get_identity_provider_output;
