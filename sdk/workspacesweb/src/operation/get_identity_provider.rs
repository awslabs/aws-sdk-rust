...
impl GetIdentityProviderInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_identity_provider::GetIdentityProvider::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetIdentityProvider {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_identity_provider::de_get_identity_provider_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_identity_provider::GetIdentityProviderError
{
