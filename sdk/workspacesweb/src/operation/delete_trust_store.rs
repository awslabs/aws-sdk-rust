...
impl DeleteTrustStoreInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_trust_store::DeleteTrustStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrustStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_trust_store::de_delete_trust_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_trust_store::DeleteTrustStoreError
{
