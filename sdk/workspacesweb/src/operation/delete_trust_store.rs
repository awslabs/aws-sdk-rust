...
impl DeleteTrustStoreInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_trust_store::DeleteTrustStore,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrustStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_trust_store::de_delete_trust_store_http_response_with_props(status, headers, body)
        }
    }
}
