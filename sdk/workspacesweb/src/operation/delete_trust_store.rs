...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTrustStore {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_trust_store::de_delete_trust_store_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_trust_store::de_delete_trust_store_http_response(response)
                     }
                }
            }
