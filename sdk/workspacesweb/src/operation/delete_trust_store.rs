...
impl DeleteTrustStoreInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTrustStore`](crate::operation::delete_trust_store::DeleteTrustStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_trust_store::DeleteTrustStore, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_trust_store::DeleteTrustStoreInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.trust_store_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("trust_store_arn", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_trust_store::DeleteTrustStore::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTrustStore {
                type Output = std::result::Result<crate::operation::delete_trust_store::DeleteTrustStoreOutput, crate::operation::delete_trust_store::DeleteTrustStoreError>;
