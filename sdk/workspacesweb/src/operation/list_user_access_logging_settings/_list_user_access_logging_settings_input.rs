...
impl ListUserAccessLoggingSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsInput, ::aws_smithy_types::error::operation::BuildError> {
