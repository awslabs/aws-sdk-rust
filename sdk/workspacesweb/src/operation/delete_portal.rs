...
impl DeletePortalInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_portal::DeletePortal,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/portals/{portalArn}", portalArn = portal_arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_portal::DeletePortal::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePortal {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_portal::de_delete_portal_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_portal::de_delete_portal_http_response_with_props(
                status, headers, body,
            )
        }
    }
