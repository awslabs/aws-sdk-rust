...
impl UpdateUserAccessLoggingSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserAccessLoggingSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_user_access_logging_settings::de_update_user_access_logging_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
