...
/// Orchestration and serialization glue logic for `GetNetworkSettings`.
...
impl GetNetworkSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_network_settings::GetNetworkSettingsInput,
                    ) -> ::std::result::Result<crate::operation::get_network_settings::GetNetworkSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_network_settings::GetNetworkSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_network_settings::GetNetworkSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_network_settings::GetNetworkSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetNetworkSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetNetworkSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetNetworkSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetNetworkSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetNetworkSettings")
...
.with_interceptor(GetNetworkSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_network_settings::GetNetworkSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_network_settings::GetNetworkSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_network_settings::GetNetworkSettingsError>::new());
...
#[derive(Debug)]
            struct GetNetworkSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetNetworkSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_network_settings::de_get_network_settings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_network_settings::de_get_network_settings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetNetworkSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetNetworkSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_network_settings::GetNetworkSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_network_settings::GetNetworkSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.network_settings_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("network_settings_arn", "cannot be empty or unset"))?;
    let network_settings_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
    if network_settings_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("network_settings_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/networkSettings/{networkSettingsArn}", networkSettingsArn = network_settings_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetNetworkSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetNetworkSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetNetworkSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetNetworkSettingsInput>()
                        .ok_or("failed to downcast to GetNetworkSettingsInput")?;
...
pub enum GetNetworkSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetNetworkSettingsError) for what information is available for the error.")]
...
impl GetNetworkSettingsError {
    /// Creates the `GetNetworkSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetNetworkSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetNetworkSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_network_settings::GetNetworkSettingsError {
...
mod _get_network_settings_output;
