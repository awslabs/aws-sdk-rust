...
impl GetNetworkSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_network_settings::GetNetworkSettings,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNetworkSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_network_settings::de_get_network_settings_http_response_with_props(status, headers, body)
        }
    }
}
