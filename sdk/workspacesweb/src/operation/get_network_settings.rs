...
impl GetNetworkSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_network_settings::GetNetworkSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNetworkSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_network_settings::de_get_network_settings_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_network_settings::GetNetworkSettingsError
{
