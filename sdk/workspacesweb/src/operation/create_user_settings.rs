...
impl aws_smithy_http::response::ParseStrictResponse for CreateUserSettings {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_user_settings::de_create_user_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_user_settings::de_create_user_settings_http_response(response)
                     }
                }
            }
