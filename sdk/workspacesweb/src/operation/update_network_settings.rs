...
impl UpdateNetworkSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNetworkSettings`](crate::operation::update_network_settings::UpdateNetworkSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_network_settings::UpdateNetworkSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_network_settings::UpdateNetworkSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_network_settings::UpdateNetworkSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateNetworkSettings {
                type Output = std::result::Result<crate::operation::update_network_settings::UpdateNetworkSettingsOutput, crate::operation::update_network_settings::UpdateNetworkSettingsError>;
