...
impl DeleteUserAccessLoggingSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_user_access_logging_settings::DeleteUserAccessLoggingSettings,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserAccessLoggingSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_user_access_logging_settings::de_delete_user_access_logging_settings_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_user_access_logging_settings::DeleteUserAccessLoggingSettingsError
{
