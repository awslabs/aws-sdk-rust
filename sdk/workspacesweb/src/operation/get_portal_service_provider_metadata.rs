...
/// Orchestration and serialization glue logic for `GetPortalServiceProviderMetadata`.
...
impl GetPortalServiceProviderMetadata {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataInput,
                    ) -> ::std::result::Result<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPortalServiceProviderMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPortalServiceProviderMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPortalServiceProviderMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPortalServiceProviderMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPortalServiceProviderMetadata")
...
.with_interceptor(GetPortalServiceProviderMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_portal_service_provider_metadata::de_get_portal_service_provider_metadata_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPortalServiceProviderMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/portalIdp/{portalArn}", portalArn = portal_arn).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPortalServiceProviderMetadataEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPortalServiceProviderMetadataInput>()
                        .ok_or("failed to downcast to GetPortalServiceProviderMetadataInput")?;
...
pub enum GetPortalServiceProviderMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPortalServiceProviderMetadataError) for what information is available for the error.")]
...
impl GetPortalServiceProviderMetadataError {
    /// Creates the `GetPortalServiceProviderMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPortalServiceProviderMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPortalServiceProviderMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError {
...
mod _get_portal_service_provider_metadata_output;
