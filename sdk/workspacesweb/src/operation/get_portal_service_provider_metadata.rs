...
impl GetPortalServiceProviderMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetPortalServiceProviderMetadata`](crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadata, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        assert_ne!(
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/portalIdp/{portalArn}", portalArn = portal_arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPortalServiceProviderMetadata {
    type Output = ::std::result::Result<crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataOutput, crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadataError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_portal_service_provider_metadata::de_get_portal_service_provider_metadata_http_response_with_props(status, headers, body)
        }
    }
}
