...
impl GetPortalServiceProviderMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_portal_service_provider_metadata::GetPortalServiceProviderMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPortalServiceProviderMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_portal_service_provider_metadata::de_get_portal_service_provider_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
