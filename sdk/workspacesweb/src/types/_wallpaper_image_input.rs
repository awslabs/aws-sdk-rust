...
impl WallpaperImageInput {
    /// Tries to convert the enum instance into [`Blob`](crate::types::WallpaperImageInput::Blob), extracting the inner [`Blob`](::aws_smithy_types::Blob).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_blob(&self) -> ::std::result::Result<&::aws_smithy_types::Blob, &Self> {
        if let WallpaperImageInput::Blob(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`Blob`](crate::types::WallpaperImageInput::Blob).
    pub fn is_blob(&self) -> bool {
        self.as_blob().is_ok()
    }
    /// Tries to convert the enum instance into [`S3Uri`](crate::types::WallpaperImageInput::S3Uri), extracting the inner [`String`](::std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_s3_uri(&self) -> ::std::result::Result<&::std::string::String, &Self> {
        if let WallpaperImageInput::S3Uri(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`S3Uri`](crate::types::WallpaperImageInput::S3Uri).
