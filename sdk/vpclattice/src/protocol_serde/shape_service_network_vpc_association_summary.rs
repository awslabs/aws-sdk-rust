...
pub(crate) fn de_service_network_vpc_association_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ServiceNetworkVpcAssociationSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
