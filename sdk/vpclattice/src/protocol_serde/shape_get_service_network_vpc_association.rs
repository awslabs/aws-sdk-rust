            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_service_network_vpc_association_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationOutput, crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError> {
    Ok({
        #[allow(unused_mut)]
