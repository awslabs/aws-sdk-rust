...
pub(crate) fn de_service_network_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ServiceNetworkSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
