...
pub fn de_delete_service_network_service_association_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::unhandled,
                        )?;
        ...
        "ConflictException" => {
            crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
        ...
        "ThrottlingException" => {
            crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_service_network_service_association_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_service_network_service_association::de_delete_service_network_service_association(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationError::unhandled)?;
...
pub(crate) fn de_delete_service_network_service_association(
    _value: &[u8],
    mut builder: crate::operation::delete_service_network_service_association::builders::DeleteServiceNetworkServiceAssociationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::delete_service_network_service_association::builders::DeleteServiceNetworkServiceAssociationOutputBuilder,
