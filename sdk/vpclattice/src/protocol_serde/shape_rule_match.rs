...
pub(crate) fn de_rule_match<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::RuleMatch>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "httpMatch" => Some(crate::types::RuleMatch::HttpMatch(
                            crate::protocol_serde::shape_http_match::de_http_match(tokens, _value, depth + 1)?.ok_or_else(|| {
