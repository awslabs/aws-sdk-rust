...
pub(crate) fn de_path_match<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::PathMatch>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "match" => {
                                builder = builder.set_match(
                                    crate::protocol_serde::shape_path_match_type::de_path_match_type(tokens)?
                                );
                            }
                            "caseSensitive" => {
