                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "dnsResource" => Some(crate::types::ResourceConfigurationDefinition::DnsResource(
                            crate::protocol_serde::shape_dns_resource::de_dns_resource(tokens, _value)?.ok_or_else(|| {
                        ...
                        "ipResource" => Some(crate::types::ResourceConfigurationDefinition::IpResource(
                            crate::protocol_serde::shape_ip_resource::de_ip_resource(tokens, _value)?.ok_or_else(|| {
                        ...
                        "arnResource" => Some(crate::types::ResourceConfigurationDefinition::ArnResource(
                            crate::protocol_serde::shape_arn_resource::de_arn_resource(tokens, _value)?.ok_or_else(|| {
