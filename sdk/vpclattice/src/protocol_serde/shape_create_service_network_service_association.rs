...
pub fn de_create_service_network_service_association_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
        ...
        "ResourceNotFoundException" => {
            crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::ServiceQuotaExceededException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_service_network_service_association_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_service_network_service_association::de_create_service_network_service_association(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationError::unhandled)?;
...
pub fn ser_create_service_network_service_association_input(
    ...
    crate::protocol_serde::shape_create_service_network_service_association_input::ser_create_service_network_service_association_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_create_service_network_service_association(
    _value: &[u8],
    mut builder: crate::operation::create_service_network_service_association::builders::CreateServiceNetworkServiceAssociationOutputBuilder,
) -> ::std::result::Result<
    crate::operation::create_service_network_service_association::builders::CreateServiceNetworkServiceAssociationOutputBuilder,
