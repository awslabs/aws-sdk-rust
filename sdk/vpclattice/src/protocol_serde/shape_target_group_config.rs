...
pub(crate) fn de_target_group_config<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TargetGroupConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "healthCheck" => {
                            builder =
                                builder.set_health_check(crate::protocol_serde::shape_health_check_config::de_health_check_config(tokens, _value)?);
                        }
