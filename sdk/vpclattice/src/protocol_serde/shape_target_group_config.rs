...
pub(crate) fn de_target_group_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::TargetGroupConfig>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "protocolVersion" => {
                                builder = builder.set_protocol_version(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::TargetGroupProtocolVersion::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
