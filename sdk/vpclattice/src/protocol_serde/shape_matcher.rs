...
pub fn ser_matcher(object_11: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Matcher) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
