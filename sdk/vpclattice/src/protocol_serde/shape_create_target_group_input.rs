...
pub fn ser_create_target_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_target_group::CreateTargetGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
