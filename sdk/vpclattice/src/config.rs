...
impl Builder {
    ...
    /// use aws_sdk_vpclattice::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_vpclattice::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
