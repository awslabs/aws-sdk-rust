...
impl super::Client {
    ...
    ///   - [`resource_identifier(impl ::std::convert::Into<String>)`](crate::operation::list_access_log_subscriptions::builders::ListAccessLogSubscriptionsFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::list_access_log_subscriptions::builders::ListAccessLogSubscriptionsFluentBuilder::set_resource_identifier): <p>The ID or Amazon Resource Name (ARN) of the service network or service.</p>
