...
impl super::Client {
    ...
    ///   - [`service_identifier(impl ::std::convert::Into<String>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::service_identifier) / [`set_service_identifier(Option<String>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::set_service_identifier): <p>The ID or Amazon Resource Name (ARN) of the service.</p>
    ///   - [`listener_identifier(impl ::std::convert::Into<String>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::listener_identifier) / [`set_listener_identifier(Option<String>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::set_listener_identifier): <p>The ID or Amazon Resource Name (ARN) of the listener.</p>
    ///   - [`rules(Vec<RuleUpdate>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::rules) / [`set_rules(Option<Vec<RuleUpdate>>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::set_rules): <p>The rules for the specified listener.</p>
