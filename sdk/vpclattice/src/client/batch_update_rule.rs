...
impl super::Client {
    ...
    ///   - [`rules(RuleUpdate)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::rules) / [`set_rules(Option<Vec<RuleUpdate>>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::set_rules): <p>The rules for the specified listener.</p>
