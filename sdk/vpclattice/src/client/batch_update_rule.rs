...
impl super::Client {
    ...
    ///   - [`rules(RuleUpdate)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::rules) / [`set_rules(Vec<RuleUpdate>)`](crate::operation::batch_update_rule::builders::BatchUpdateRuleFluentBuilder::set_rules):<br>required: **true**<br><p>The rules for the specified listener.</p><br>
