...
impl super::Client {
    ...
    ///   - [`service_identifier(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::service_identifier) / [`set_service_identifier(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::set_service_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the service.</p><br>
    ///   - [`listener_identifier(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::listener_identifier) / [`set_listener_identifier(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::set_listener_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the listener.</p><br>
    ///   - [`rule_identifier(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::rule_identifier) / [`set_rule_identifier(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::set_rule_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the listener rule.</p><br>
