...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_target_group::builders::CreateTargetGroupFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_target_group::builders::CreateTargetGroupFluentBuilder::set_name):<br>required: **true**<br><p>The name of the target group. The name must be unique within the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.</p><br>
    ///   - [`r#type(TargetGroupType)`](crate::operation::create_target_group::builders::CreateTargetGroupFluentBuilder::type) / [`set_type(TargetGroupType)`](crate::operation::create_target_group::builders::CreateTargetGroupFluentBuilder::set_type):<br>required: **true**<br><p>The type of target group.</p><br>
