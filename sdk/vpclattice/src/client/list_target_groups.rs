...
impl super::Client {
    ...
    ///   - [`vpc_identifier(impl Into<String>)`](crate::operation::list_target_groups::builders::ListTargetGroupsFluentBuilder::vpc_identifier) / [`set_vpc_identifier(Option<String>)`](crate::operation::list_target_groups::builders::ListTargetGroupsFluentBuilder::set_vpc_identifier):<br>required: **false**<br><p>The ID or ARN of the VPC.</p><br>
