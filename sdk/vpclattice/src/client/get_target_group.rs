...
impl super::Client {
    ...
    ///   - [`created_at(Option<DateTime>)`](crate::operation::get_target_group::GetTargetGroupOutput::created_at): <p>The date and time that the target group was created, in ISO-8601 format.</p>
    ///   - [`last_updated_at(Option<DateTime>)`](crate::operation::get_target_group::GetTargetGroupOutput::last_updated_at): <p>The date and time that the target group was last updated, in ISO-8601 format.</p>
