...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_service_network_resource_association::builders::CreateServiceNetworkResourceAssociationFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_service_network_resource_association::builders::CreateServiceNetworkResourceAssociationFluentBuilder::set_tags):<br>required: **false**<br><p>A key-value pair to associate with a resource.</p><br>
