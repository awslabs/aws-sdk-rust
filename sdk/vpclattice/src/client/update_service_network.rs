...
impl super::Client {
    ...
    ///   - [`service_network_identifier(impl ::std::convert::Into<String>)`](crate::operation::update_service_network::builders::UpdateServiceNetworkFluentBuilder::service_network_identifier) / [`set_service_network_identifier(Option<String>)`](crate::operation::update_service_network::builders::UpdateServiceNetworkFluentBuilder::set_service_network_identifier): <p>The ID or Amazon Resource Name (ARN) of the service network.</p>
    ///   - [`auth_type(AuthType)`](crate::operation::update_service_network::builders::UpdateServiceNetworkFluentBuilder::auth_type) / [`set_auth_type(Option<AuthType>)`](crate::operation::update_service_network::builders::UpdateServiceNetworkFluentBuilder::set_auth_type): <p>The type of IAM policy.</p>  <ul>   <li> <p> <code>NONE</code>: The resource does not use an IAM policy. This is the default.</p> </li>   <li> <p> <code>AWS_IAM</code>: The resource uses an IAM policy. When this type is used, auth is enabled and an auth policy is required.</p> </li>  </ul>
    ...
    pub fn update_service_network(
        &self,
    ) -> crate::operation::update_service_network::builders::UpdateServiceNetworkFluentBuilder {
        crate::operation::update_service_network::builders::UpdateServiceNetworkFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
