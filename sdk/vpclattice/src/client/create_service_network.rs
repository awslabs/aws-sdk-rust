...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_service_network::builders::CreateServiceNetworkFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_service_network::builders::CreateServiceNetworkFluentBuilder::set_name):<br>required: **true**<br><p>The name of the service network. The name must be unique to the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.</p><br>
