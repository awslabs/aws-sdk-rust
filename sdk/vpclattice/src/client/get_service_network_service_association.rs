...
impl super::Client {
    ...
    ///   - [`service_network_service_association_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_service_network_service_association::builders::GetServiceNetworkServiceAssociationFluentBuilder::service_network_service_association_identifier) / [`set_service_network_service_association_identifier(Option<String>)`](crate::operation::get_service_network_service_association::builders::GetServiceNetworkServiceAssociationFluentBuilder::set_service_network_service_association_identifier): <p>The ID or Amazon Resource Name (ARN) of the association.</p>
