...
impl super::Client {
    ...
    ///   - [`service_identifier(impl Into<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::service_identifier) / [`set_service_identifier(Option<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_service_identifier):<br>required: **true**<br><p>The ID or ARN of the service.</p><br>
    ...
    ///   - [`idle_timeout_seconds(i32)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::idle_timeout_seconds) / [`set_idle_timeout_seconds(Option<i32>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_idle_timeout_seconds):<br>required: **false**<br><p>The amount of time, in seconds, that a connection can remain idle (no data sent) before VPC Lattice closes it. The valid range is 60 to 600 seconds. If you don't specify a value, the default is 60 seconds. This setting does not change the maximum connection duration of 10 minutes; connections are still closed when they reach that limit.</p><br>
    ...
    ///   - [`idle_timeout_seconds(Option<i32>)`](crate::operation::update_service::UpdateServiceOutput::idle_timeout_seconds): <p>The amount of time, in seconds, that a connection can remain idle before VPC Lattice closes it.</p>
