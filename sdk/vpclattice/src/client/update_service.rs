...
impl super::Client {
    ...
    ///   - [`service_identifier(impl Into<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::service_identifier) / [`set_service_identifier(impl Into<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_service_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the service.</p><br>
