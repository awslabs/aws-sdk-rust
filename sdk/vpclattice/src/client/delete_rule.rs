...
impl super::Client {
    ...
    ///   - [`rule_identifier(impl Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::rule_identifier) / [`set_rule_identifier(impl Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::set_rule_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the rule.</p><br>
