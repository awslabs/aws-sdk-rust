...
impl super::Client {
    ...
    ///   - [`target_group_identifier(impl ::std::convert::Into<String>)`](crate::operation::update_target_group::builders::UpdateTargetGroupFluentBuilder::target_group_identifier) / [`set_target_group_identifier(Option<String>)`](crate::operation::update_target_group::builders::UpdateTargetGroupFluentBuilder::set_target_group_identifier): <p>The ID or Amazon Resource Name (ARN) of the target group.</p>
    ///   - [`health_check(HealthCheckConfig)`](crate::operation::update_target_group::builders::UpdateTargetGroupFluentBuilder::health_check) / [`set_health_check(Option<HealthCheckConfig>)`](crate::operation::update_target_group::builders::UpdateTargetGroupFluentBuilder::set_health_check): <p>The health check configuration.</p>
