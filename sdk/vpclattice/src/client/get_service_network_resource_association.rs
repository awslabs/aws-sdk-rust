...
impl super::Client {
    ...
    ///   - [`private_dns_entry(Option<DnsEntry>)`](crate::operation::get_service_network_resource_association::GetServiceNetworkResourceAssociationOutput::private_dns_entry): <p>The private DNS entry for the service. This entry includes only the domain name.</p>
