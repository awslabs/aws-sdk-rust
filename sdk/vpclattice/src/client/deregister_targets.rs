...
impl super::Client {
    ...
    ///   - [`target_group_identifier(impl Into<String>)`](crate::operation::deregister_targets::builders::DeregisterTargetsFluentBuilder::target_group_identifier) / [`set_target_group_identifier(impl Into<String>)`](crate::operation::deregister_targets::builders::DeregisterTargetsFluentBuilder::set_target_group_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the target group.</p><br>
    ///   - [`targets(Target)`](crate::operation::deregister_targets::builders::DeregisterTargetsFluentBuilder::targets) / [`set_targets(Vec<Target>)`](crate::operation::deregister_targets::builders::DeregisterTargetsFluentBuilder::set_targets):<br>required: **true**<br><p>The targets to deregister.</p><br>
