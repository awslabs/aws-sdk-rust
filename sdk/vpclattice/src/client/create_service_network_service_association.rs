...
impl super::Client {
    ...
    ///   - [`status(Option<ServiceNetworkServiceAssociationStatus>)`](crate::operation::create_service_network_service_association::CreateServiceNetworkServiceAssociationOutput::status): <p>The operation's status.</p>
