...
impl super::Client {
    ...
    ///   - [`service_network_identifier(impl Into<String>)`](crate::operation::list_service_network_vpc_associations::builders::ListServiceNetworkVpcAssociationsFluentBuilder::service_network_identifier) / [`set_service_network_identifier(Option<String>)`](crate::operation::list_service_network_vpc_associations::builders::ListServiceNetworkVpcAssociationsFluentBuilder::set_service_network_identifier): <p>The ID or Amazon Resource Name (ARN) of the service network.</p>
    ///   - [`vpc_identifier(impl Into<String>)`](crate::operation::list_service_network_vpc_associations::builders::ListServiceNetworkVpcAssociationsFluentBuilder::vpc_identifier) / [`set_vpc_identifier(Option<String>)`](crate::operation::list_service_network_vpc_associations::builders::ListServiceNetworkVpcAssociationsFluentBuilder::set_vpc_identifier): <p>The ID or Amazon Resource Name (ARN) of the VPC.</p>
