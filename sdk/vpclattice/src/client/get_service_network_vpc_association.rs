...
impl super::Client {
    ...
    ///   - [`id(Option<String>)`](crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationOutput::id): <p>The ID of the association.</p>
    ...
    ///   - [`created_at(Option<DateTime>)`](crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationOutput::created_at): <p>The date and time that the association was created, in ISO-8601 format.</p>
