...
impl super::Client {
    ...
    pub fn delete_service_network(
        &self,
    ) -> crate::operation::delete_service_network::builders::DeleteServiceNetworkFluentBuilder {
        crate::operation::delete_service_network::builders::DeleteServiceNetworkFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
