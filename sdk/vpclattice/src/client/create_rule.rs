...
impl super::Client {
    ...
    ///   - [`service_identifier(impl Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::service_identifier) / [`set_service_identifier(impl Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_service_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the service.</p><br>
    ///   - [`listener_identifier(impl Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::listener_identifier) / [`set_listener_identifier(impl Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_listener_identifier):<br>required: **true**<br><p>The ID or Amazon Resource Name (ARN) of the listener.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_name):<br>required: **true**<br><p>The name of the rule. The name must be unique within the listener. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.</p><br>
