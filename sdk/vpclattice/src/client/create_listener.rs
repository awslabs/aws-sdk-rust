...
impl super::Client {
    ...
    ///   - [`protocol(ListenerProtocol)`](crate::operation::create_listener::builders::CreateListenerFluentBuilder::protocol) / [`set_protocol(Option<ListenerProtocol>)`](crate::operation::create_listener::builders::CreateListenerFluentBuilder::set_protocol):<br>required: **true**<br><p>The listener protocol.</p><br>
    ///   - [`port(i32)`](crate::operation::create_listener::builders::CreateListenerFluentBuilder::port) / [`set_port(Option<i32>)`](crate::operation::create_listener::builders::CreateListenerFluentBuilder::set_port):<br>required: **false**<br><p>The listener port. You can specify a value from 1 to 65535. For HTTP, the default is 80. For HTTPS, the default is 443.</p><br>
    ///   - [`default_action(RuleAction)`](crate::operation::create_listener::builders::CreateListenerFluentBuilder::default_action) / [`set_default_action(Option<RuleAction>)`](crate::operation::create_listener::builders::CreateListenerFluentBuilder::set_default_action):<br>required: **true**<br><p>The action for the default rule. Each listener has a default rule. The default rule is used if no other rules match.</p><br>
