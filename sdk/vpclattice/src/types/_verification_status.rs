...
impl ::std::convert::From<&str> for VerificationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "VERIFICATION_TIMED_OUT" => VerificationStatus::VerificationTimedOut,
...
impl VerificationStatus {
    ...
    pub const fn values() -> &'static [&'static str] {
        &["PENDING", "VERIFICATION_TIMED_OUT", "VERIFIED"]
    }
}
...
impl ::std::fmt::Display for VerificationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            VerificationStatus::VerificationTimedOut => write!(f, "VERIFICATION_TIMED_OUT"),
