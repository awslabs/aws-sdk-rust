...
impl RuleAction {
    ...
    pub fn as_fixed_response(&self) -> ::std::result::Result<&crate::types::FixedResponseAction, &Self> {
        if let RuleAction::FixedResponse(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_forward(&self) -> ::std::result::Result<&crate::types::ForwardAction, &Self> {
        if let RuleAction::Forward(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
