...
#[derive(Debug)]
    ...
    ::std::write!(output, "/services/{serviceIdentifier}/listeners/{listenerIdentifier}", serviceIdentifier = service_identifier, listenerIdentifier = listener_identifier).expect("formatting should succeed");
