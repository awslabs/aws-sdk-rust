...
impl ListServiceNetworksFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_service_networks::paginator::ListServiceNetworksPaginator {
        crate::operation::list_service_networks::paginator::ListServiceNetworksPaginator::new(
            self.handle,
            self.inner,
        )
    }
