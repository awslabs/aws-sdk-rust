...
impl ::aws_http::request_id::RequestId for ListServiceNetworksOutput {
...
impl ListServiceNetworksOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_service_networks::ListServiceNetworksOutput, ::aws_smithy_http::operation::error::BuildError>
    {
