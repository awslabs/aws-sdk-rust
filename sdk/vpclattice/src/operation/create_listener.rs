...
impl CreateListenerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_listener::CreateListener, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_listener::ser_create_listener_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateListener {
    type Output =
        ::std::result::Result<crate::operation::create_listener::CreateListenerOutput, crate::operation::create_listener::CreateListenerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_listener::de_create_listener_http_response_with_props(status, headers, body)
        }
    }
}
