...
impl crate::operation::list_service_network_service_associations::builders::ListServiceNetworkServiceAssociationsInputBuilder {
...
impl ListServiceNetworkServiceAssociationsFluentBuilder {
    /// Creates a new `ListServiceNetworkServiceAssociationsFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_service_network_service_associations::builders::ListServiceNetworkServiceAssociationsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::list_service_network_service_associations::ListServiceNetworkServiceAssociations::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::list_service_network_service_associations::ListServiceNetworkServiceAssociations::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_service_network_service_associations::paginator::ListServiceNetworkServiceAssociationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_service_network_service_associations::paginator::ListServiceNetworkServiceAssociationsPaginator {
        crate::operation::list_service_network_service_associations::paginator::ListServiceNetworkServiceAssociationsPaginator::new(
            self.handle,
            self.inner,
        )
    }
