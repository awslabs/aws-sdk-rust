...
impl ListListenersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_listeners::ListListeners,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_listeners::ListListeners::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListListeners {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_listeners::de_list_listeners_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_listeners::de_list_listeners_http_response_with_props(
                status, headers, body,
            )
        }
    }
