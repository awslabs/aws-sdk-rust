...
impl DeleteServiceNetworkServiceAssociationInputBuilder {
    ...
    /// - [`service_network_service_association_identifier`](crate::operation::delete_service_network_service_association::builders::DeleteServiceNetworkServiceAssociationInputBuilder::service_network_service_association_identifier)
    pub fn build(
        self,
    ) -> ::std::result::Result<
        ...
        ::std::result::Result::Ok(
            crate::operation::delete_service_network_service_association::DeleteServiceNetworkServiceAssociationInput {
                service_network_service_association_identifier: self.service_network_service_association_identifier
                    .ok_or_else(||
                        ::aws_smithy_http::operation::error::BuildError::missing_field("service_network_service_association_identifier", "service_network_service_association_identifier was not specified but it is required when building DeleteServiceNetworkServiceAssociationInput")
                    )?
                ,
            }
        )
