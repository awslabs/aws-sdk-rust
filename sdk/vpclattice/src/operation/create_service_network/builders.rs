...
impl CreateServiceNetworkFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_service_network::CreateServiceNetworkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_service_network::CreateServiceNetworkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_service_network::CreateServiceNetworkOutput, crate::operation::create_service_network::CreateServiceNetworkError, Self> {
