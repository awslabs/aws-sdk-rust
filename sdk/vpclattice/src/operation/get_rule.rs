    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let rule_identifier = ::aws_smithy_http::label::fmt_string(
                    input_3,
                    ::aws_smithy_http::label::EncodingStrategy::Default,
                );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_rule::GetRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_rule::de_get_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
