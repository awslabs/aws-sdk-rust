...
impl crate::operation::batch_update_rule::builders::BatchUpdateRuleInputBuilder {
...
/// <p><b>Required permissions:</b> <code>vpc-lattice:UpdateRule</code></p>
/// <p>For more information, see <a href="https://docs.aws.amazon.com/vpc-lattice/latest/ug/security_iam_service-with-iam.html">How Amazon VPC Lattice works with IAM</a> in the <i>Amazon VPC Lattice User Guide</i>.</p>
...
impl BatchUpdateRuleFluentBuilder {
    /// Creates a new `BatchUpdateRuleFluentBuilder`.
