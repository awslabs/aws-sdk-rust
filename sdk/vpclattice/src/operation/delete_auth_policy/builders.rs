...
impl DeleteAuthPolicyFluentBuilder  {
    /// Creates a new `DeleteAuthPolicy`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_auth_policy::DeleteAuthPolicyOutput, aws_smithy_http::result::SdkError<crate::operation::delete_auth_policy::DeleteAuthPolicyError>>
                     {
