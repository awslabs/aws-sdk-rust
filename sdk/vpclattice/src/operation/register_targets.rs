...
impl RegisterTargetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_targets::RegisterTargets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_targets::ser_register_targets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterTargets {
    type Output =
        ::std::result::Result<crate::operation::register_targets::RegisterTargetsOutput, crate::operation::register_targets::RegisterTargetsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_targets::de_register_targets_http_response_with_props(status, headers, body)
        }
    }
}
