...
impl RegisterTargetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_targets::RegisterTargets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_targets::de_register_targets_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_targets::RegisterTargetsError
{
