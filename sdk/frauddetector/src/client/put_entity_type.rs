...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::put_entity_type::builders::PutEntityTypeFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::put_entity_type::builders::PutEntityTypeFluentBuilder::set_tags): <p>A collection of key and value pairs.</p>
