...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_outcome::builders::DeleteOutcomeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_outcome::builders::DeleteOutcomeFluentBuilder::set_name):<br>required: **true**<br><p>The name of the outcome to delete.</p><br>
