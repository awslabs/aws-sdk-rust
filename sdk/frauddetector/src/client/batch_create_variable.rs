...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::batch_create_variable::builders::BatchCreateVariableFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::batch_create_variable::builders::BatchCreateVariableFluentBuilder::set_tags):<br>required: **false**<br><p>A collection of key and value pairs.</p><br>
