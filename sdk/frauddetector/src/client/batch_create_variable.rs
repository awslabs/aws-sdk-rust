...
impl super::Client {
    ...
    ///   - [`variable_entries(VariableEntry)`](crate::operation::batch_create_variable::builders::BatchCreateVariableFluentBuilder::variable_entries) / [`set_variable_entries(Option<Vec<VariableEntry>>)`](crate::operation::batch_create_variable::builders::BatchCreateVariableFluentBuilder::set_variable_entries): <p>The list of variables for the batch create variable request.</p>
    ///   - [`tags(Tag)`](crate::operation::batch_create_variable::builders::BatchCreateVariableFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::batch_create_variable::builders::BatchCreateVariableFluentBuilder::set_tags): <p>A collection of key and value pairs.</p>
