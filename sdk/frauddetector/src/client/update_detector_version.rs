...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::update_detector_version::builders::UpdateDetectorVersionFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::update_detector_version::builders::UpdateDetectorVersionFluentBuilder::set_detector_id): <p>The parent detector ID for the detector version you want to update.</p>
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::update_detector_version::builders::UpdateDetectorVersionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_detector_version::builders::UpdateDetectorVersionFluentBuilder::set_description): <p>The detector version description. </p>
