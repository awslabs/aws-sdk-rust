...
impl super::Client {
    ...
    ///   - [`detector_id(impl Into<String>)`](crate::operation::delete_detector::builders::DeleteDetectorFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::delete_detector::builders::DeleteDetectorFluentBuilder::set_detector_id):<br>required: **true**<br><p>The ID of the detector to delete.</p><br>
