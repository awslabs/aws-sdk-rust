...
impl super::Client {
    ...
    ///   - [`detector_id(impl ::std::convert::Into<String>)`](crate::operation::update_detector_version_status::builders::UpdateDetectorVersionStatusFluentBuilder::detector_id) / [`set_detector_id(Option<String>)`](crate::operation::update_detector_version_status::builders::UpdateDetectorVersionStatusFluentBuilder::set_detector_id): <p>The detector ID. </p>
    ///   - [`detector_version_id(impl ::std::convert::Into<String>)`](crate::operation::update_detector_version_status::builders::UpdateDetectorVersionStatusFluentBuilder::detector_version_id) / [`set_detector_version_id(Option<String>)`](crate::operation::update_detector_version_status::builders::UpdateDetectorVersionStatusFluentBuilder::set_detector_version_id): <p>The detector version ID. </p>
