...
impl super::Client {
    ...
    pub fn put_kms_encryption_key(
        &self,
    ) -> crate::operation::put_kms_encryption_key::builders::PutKMSEncryptionKeyFluentBuilder {
        crate::operation::put_kms_encryption_key::builders::PutKMSEncryptionKeyFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
