...
impl super::Client {
    ...
    ///   - [`event_type_name(impl Into<String>)`](crate::operation::delete_events_by_event_type::builders::DeleteEventsByEventTypeFluentBuilder::event_type_name) / [`set_event_type_name(Option<String>)`](crate::operation::delete_events_by_event_type::builders::DeleteEventsByEventTypeFluentBuilder::set_event_type_name):<br>required: **true**<br><p>The name of the event type.</p><br>
