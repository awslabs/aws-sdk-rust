...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::delete_batch_prediction_job::builders::DeleteBatchPredictionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::delete_batch_prediction_job::builders::DeleteBatchPredictionJobFluentBuilder::set_job_id): <p>The ID of the batch prediction job to delete.</p>
