...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_label::builders::DeleteLabelFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_label::builders::DeleteLabelFluentBuilder::set_name):<br>required: **true**<br><p>The name of the label to delete.</p><br>
