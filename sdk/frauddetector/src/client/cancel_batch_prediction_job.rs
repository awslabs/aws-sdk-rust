...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::cancel_batch_prediction_job::builders::CancelBatchPredictionJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::cancel_batch_prediction_job::builders::CancelBatchPredictionJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The ID of the batch prediction job to cancel.</p><br>
