...
impl super::Client {
    ...
    ///   - [`model_id(impl ::std::convert::Into<String>)`](crate::operation::describe_model_versions::builders::DescribeModelVersionsFluentBuilder::model_id) / [`set_model_id(Option<String>)`](crate::operation::describe_model_versions::builders::DescribeModelVersionsFluentBuilder::set_model_id): <p>The model ID.</p>
    ///   - [`model_version_number(impl ::std::convert::Into<String>)`](crate::operation::describe_model_versions::builders::DescribeModelVersionsFluentBuilder::model_version_number) / [`set_model_version_number(Option<String>)`](crate::operation::describe_model_versions::builders::DescribeModelVersionsFluentBuilder::set_model_version_number): <p>The model version number.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_model_versions::builders::DescribeModelVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_model_versions::builders::DescribeModelVersionsFluentBuilder::set_next_token): <p>The next token from the previous results.</p>
