...
impl super::Client {
    ...
    ///   - [`model_id(impl ::std::convert::Into<String>)`](crate::operation::create_model_version::builders::CreateModelVersionFluentBuilder::model_id) / [`set_model_id(Option<String>)`](crate::operation::create_model_version::builders::CreateModelVersionFluentBuilder::set_model_id): <p>The model ID. </p>
