...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_model_version::builders::CreateModelVersionFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_model_version::builders::CreateModelVersionFluentBuilder::set_tags): <p>A collection of key and value pairs.</p>
