...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::get_batch_prediction_jobs::builders::GetBatchPredictionJobsFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_batch_prediction_jobs::builders::GetBatchPredictionJobsFluentBuilder::set_job_id): <p>The batch prediction job for which to get the details.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_batch_prediction_jobs::builders::GetBatchPredictionJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_batch_prediction_jobs::builders::GetBatchPredictionJobsFluentBuilder::set_next_token): <p>The next token from the previous request.</p>
