...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_entity_types::builders::GetEntityTypesFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_entity_types::builders::GetEntityTypesFluentBuilder::set_name): <p>The name.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_entity_types::builders::GetEntityTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_entity_types::builders::GetEntityTypesFluentBuilder::set_next_token): <p>The next token for the subsequent request.</p>
