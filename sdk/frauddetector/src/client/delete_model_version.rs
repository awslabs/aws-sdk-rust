...
impl super::Client {
    ...
    ///   - [`model_id(impl ::std::convert::Into<String>)`](crate::operation::delete_model_version::builders::DeleteModelVersionFluentBuilder::model_id) / [`set_model_id(Option<String>)`](crate::operation::delete_model_version::builders::DeleteModelVersionFluentBuilder::set_model_id): <p>The model ID of the model version to delete.</p>
