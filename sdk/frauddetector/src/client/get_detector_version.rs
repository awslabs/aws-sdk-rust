...
impl super::Client {
    ...
    pub fn get_detector_version(
        &self,
    ) -> crate::operation::get_detector_version::builders::GetDetectorVersionFluentBuilder {
        crate::operation::get_detector_version::builders::GetDetectorVersionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
