...
impl super::Client {
    ...
    ///   - [`event_variables(impl Into<String>)`](crate::operation::put_event_type::builders::PutEventTypeFluentBuilder::event_variables) / [`set_event_variables(Option<Vec<String>>)`](crate::operation::put_event_type::builders::PutEventTypeFluentBuilder::set_event_variables): <p>The event type variables.</p>
    ///   - [`labels(impl Into<String>)`](crate::operation::put_event_type::builders::PutEventTypeFluentBuilder::labels) / [`set_labels(Option<Vec<String>>)`](crate::operation::put_event_type::builders::PutEventTypeFluentBuilder::set_labels): <p>The event type labels.</p>
    ...
    ///   - [`tags(Tag)`](crate::operation::put_event_type::builders::PutEventTypeFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::put_event_type::builders::PutEventTypeFluentBuilder::set_tags): <p>A collection of key and value pairs.</p>
