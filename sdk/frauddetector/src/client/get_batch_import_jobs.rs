...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::get_batch_import_jobs::builders::GetBatchImportJobsFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_batch_import_jobs::builders::GetBatchImportJobsFluentBuilder::set_job_id): <p>The ID of the batch import job to get.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_batch_import_jobs::builders::GetBatchImportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_batch_import_jobs::builders::GetBatchImportJobsFluentBuilder::set_next_token): <p>The next token from the previous request.</p>
