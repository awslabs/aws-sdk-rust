...
impl crate::operation::get_event_prediction_metadata::builders::GetEventPredictionMetadataInputBuilder {
...
impl GetEventPredictionMetadataFluentBuilder {
    /// Creates a new `GetEventPredictionMetadataFluentBuilder`.
