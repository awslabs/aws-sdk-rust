...
impl BatchGetVariableInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_get_variable::BatchGetVariable,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_variable::ser_batch_get_variable_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetVariable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_variable::de_batch_get_variable_http_response_with_props(status, headers, body)
        }
    }
}
