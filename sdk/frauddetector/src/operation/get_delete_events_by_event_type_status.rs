...
impl GetDeleteEventsByEventTypeStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_delete_events_by_event_type_status::GetDeleteEventsByEventTypeStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDeleteEventsByEventTypeStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_delete_events_by_event_type_status::de_get_delete_events_by_event_type_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
