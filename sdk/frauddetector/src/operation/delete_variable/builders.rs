...
impl DeleteVariableFluentBuilder  {
    /// Creates a new `DeleteVariable`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_variable::DeleteVariableOutput, aws_smithy_http::result::SdkError<crate::operation::delete_variable::DeleteVariableError>>
                     {
