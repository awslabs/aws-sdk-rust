...
impl UpdateRuleVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_rule_version::ser_update_rule_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRuleVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_rule_version::de_update_rule_version_http_response_with_props(status, headers, body)
        }
    }
}
