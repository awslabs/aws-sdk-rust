...
impl GetDetectorVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_detector_version::ser_get_detector_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDetectorVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_detector_version::de_get_detector_version_http_response_with_props(status, headers, body)
        }
    }
}
