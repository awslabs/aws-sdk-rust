...
impl PutExternalModelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_external_model::ser_put_external_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutExternalModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_external_model::de_put_external_model_http_response_with_props(status, headers, body)
        }
    }
}
