...
impl GetRulesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_rules::GetRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_rules::GetRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
