...
impl UpdateEventLabelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_event_label::ser_update_event_label_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEventLabel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_event_label::de_update_event_label_http_response_with_props(status, headers, body)
        }
    }
}
