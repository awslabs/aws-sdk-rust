...
impl crate::operation::get_delete_events_by_event_type_status::builders::GetDeleteEventsByEventTypeStatusInputBuilder {
...
impl GetDeleteEventsByEventTypeStatusFluentBuilder {
    /// Creates a new `GetDeleteEventsByEventTypeStatusFluentBuilder`.
