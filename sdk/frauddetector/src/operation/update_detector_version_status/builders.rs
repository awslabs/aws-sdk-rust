...
impl UpdateDetectorVersionStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_detector_version_status::UpdateDetectorVersionStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_detector_version_status::UpdateDetectorVersionStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_detector_version_status::UpdateDetectorVersionStatusOutput, crate::operation::update_detector_version_status::UpdateDetectorVersionStatusError, Self> {
