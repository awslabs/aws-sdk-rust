...
impl GetEventPredictionMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_event_prediction_metadata::GetEventPredictionMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEventPredictionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_event_prediction_metadata::de_get_event_prediction_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
