...
impl GetKmsEncryptionKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_kms_encryption_key::GetKMSEncryptionKey,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKMSEncryptionKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_kms_encryption_key::de_get_kms_encryption_key_http_response_with_props(status, headers, body)
        }
    }
}
