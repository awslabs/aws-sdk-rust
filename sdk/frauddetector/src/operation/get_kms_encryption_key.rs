...
/// Orchestration and serialization glue logic for `GetKMSEncryptionKey`.
...
impl GetKMSEncryptionKey {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_kms_encryption_key::GetKmsEncryptionKeyInput,
                    ) -> ::std::result::Result<crate::operation::get_kms_encryption_key::GetKmsEncryptionKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_kms_encryption_key::GetKmsEncryptionKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetKMSEncryptionKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetKMSEncryptionKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetKMSEncryptionKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetKMSEncryptionKeyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetKMSEncryptionKey")
...
.with_interceptor(GetKMSEncryptionKeyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_kms_encryption_key::de_get_kms_encryption_key_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_kms_encryption_key::de_get_kms_encryption_key_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetKMSEncryptionKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_kms_encryption_key::GetKmsEncryptionKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_kms_encryption_key::GetKmsEncryptionKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_kms_encryption_key::ser_get_kms_encryption_key_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetKMSEncryptionKeyEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetKmsEncryptionKeyInput>()
                        .ok_or("failed to downcast to GetKmsEncryptionKeyInput")?;
...
pub enum GetKMSEncryptionKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetKMSEncryptionKeyError) for what information is available for the error.")]
...
impl GetKMSEncryptionKeyError {
    /// Creates the `GetKMSEncryptionKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetKMSEncryptionKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetKMSEncryptionKeyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError {
...
mod _get_kms_encryption_key_output;
