...
impl CancelBatchPredictionJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_batch_prediction_job::CancelBatchPredictionJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelBatchPredictionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_batch_prediction_job::de_cancel_batch_prediction_job_http_response_with_props(status, headers, body)
        }
    }
}
