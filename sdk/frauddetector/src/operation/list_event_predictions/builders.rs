...
impl ListEventPredictionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_event_predictions::ListEventPredictionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_event_predictions::ListEventPredictionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_event_predictions::ListEventPredictionsOutput, crate::operation::list_event_predictions::ListEventPredictionsError, Self> {
