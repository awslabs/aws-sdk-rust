...
impl DeleteOutcomeFluentBuilder  {
    /// Creates a new `DeleteOutcome`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_outcome::DeleteOutcomeOutput, aws_smithy_http::result::SdkError<crate::operation::delete_outcome::DeleteOutcomeError>>
                     {
