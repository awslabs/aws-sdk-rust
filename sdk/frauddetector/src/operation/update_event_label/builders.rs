...
impl UpdateEventLabelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_event_label::UpdateEventLabelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_event_label::UpdateEventLabelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_event_label::UpdateEventLabelOutput, crate::operation::update_event_label::UpdateEventLabelError, Self> {
