...
impl CreateBatchPredictionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_batch_prediction_job::CreateBatchPredictionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_batch_prediction_job::CreateBatchPredictionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_batch_prediction_job::CreateBatchPredictionJobOutput, crate::operation::create_batch_prediction_job::CreateBatchPredictionJobError, Self> {
