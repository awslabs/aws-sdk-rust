...
pub fn ser_update_detector_version_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDetectorVersionStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
