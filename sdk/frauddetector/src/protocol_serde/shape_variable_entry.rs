...
pub fn ser_variable_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VariableEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
