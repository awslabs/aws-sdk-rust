...
pub fn ser_create_detector_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDetectorVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
