...
pub fn ser_get_event_prediction_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetEventPredictionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
