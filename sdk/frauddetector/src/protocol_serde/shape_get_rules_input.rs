...
pub fn ser_get_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetRulesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
