...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_kms_encryption_key::de_get_kms_encryption_key(_response_body, output)
            .map_err(crate::operation::get_kms_encryption_key::GetKMSEncryptionKeyError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "kmsKey" => {
                    builder = builder.set_kms_key(crate::protocol_serde::shape_kms_key::de_kms_key(tokens, _value, depth + 1)?);
                }
