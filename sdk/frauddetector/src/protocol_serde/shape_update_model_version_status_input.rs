...
pub fn ser_update_model_version_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateModelVersionStatusInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
