...
pub fn ser_get_detectors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetDetectorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
