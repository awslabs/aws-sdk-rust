...
pub(crate) fn de_batch_prediction<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchPrediction>, aws_smithy_json::deserialize::error::DeserializeError>
