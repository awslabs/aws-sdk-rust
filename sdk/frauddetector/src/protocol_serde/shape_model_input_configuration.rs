...
) -> ::std::result::Result<Option<crate::types::ModelInputConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "format" => {
                            builder = builder.set_format(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ModelInputDataFormat::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "useEventVariables" => {
                            builder = builder.set_use_event_variables(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "jsonInputTemplate" => {
