...
pub fn ser_model_input_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ModelInputConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_model_input_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ModelInputConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
