...
pub(crate) fn de_detector_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Detector>>, aws_smithy_json::deserialize::error::DeserializeError>
