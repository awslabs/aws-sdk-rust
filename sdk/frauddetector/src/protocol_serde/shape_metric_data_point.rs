...
pub(crate) fn de_metric_data_point<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::MetricDataPoint>, aws_smithy_json::deserialize::error::DeserializeError>
