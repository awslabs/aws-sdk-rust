...
pub fn ser_delete_model_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteModelVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
