...
pub fn ser_delete_model_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_model_version::DeleteModelVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
