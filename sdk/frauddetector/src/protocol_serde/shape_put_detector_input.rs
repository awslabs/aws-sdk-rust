...
pub fn ser_put_detector_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::put_detector::PutDetectorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
