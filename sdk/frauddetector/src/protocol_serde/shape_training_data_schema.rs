...
pub(crate) fn de_training_data_schema<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TrainingDataSchema>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::training_data_schema_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
