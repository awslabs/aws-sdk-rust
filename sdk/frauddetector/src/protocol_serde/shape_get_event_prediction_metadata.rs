...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_event_prediction_metadata::GetEventPredictionMetadataError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_event_prediction_metadata::de_get_event_prediction_metadata(_response_body, output)
            .map_err(crate::operation::get_event_prediction_metadata::GetEventPredictionMetadataError::unhandled)?;
...
pub(crate) fn de_get_event_prediction_metadata(
    value: &[u8],
    mut builder: crate::operation::get_event_prediction_metadata::builders::GetEventPredictionMetadataOutputBuilder,
) -> Result<
    crate::operation::get_event_prediction_metadata::builders::GetEventPredictionMetadataOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "rules" => {
                    builder = builder.set_rules(crate::protocol_serde::shape_evaluated_rule_list::de_evaluated_rule_list(tokens)?);
                }
                "ruleExecutionMode" => {
                    builder = builder.set_rule_execution_mode(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::RuleExecutionMode::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "outcomes" => {
