...
pub fn ser_get_model_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_model_version::GetModelVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
