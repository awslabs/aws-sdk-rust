...
pub fn ser_list_event_predictions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEventPredictionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
