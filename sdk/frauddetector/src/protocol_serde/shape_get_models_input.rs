...
pub fn ser_get_models_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_models::GetModelsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
