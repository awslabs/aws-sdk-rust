...
pub fn ser_update_detector_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDetectorVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
