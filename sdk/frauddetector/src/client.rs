...
impl Client  {
    ...
    pub fn get_delete_events_by_event_type_status(&self) -> fluent_builders::GetDeleteEventsByEventTypeStatus {
    ...
    pub fn update_detector_version_metadata(&self) -> fluent_builders::UpdateDetectorVersionMetadata {
