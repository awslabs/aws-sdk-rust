...
impl UntagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ssmquicksetup", "UntagResource", input, runtime_plugins, stop_point).await
    }
