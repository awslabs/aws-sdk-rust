...
pub struct StopReplicationTaskOutput  {
    ...
    #[doc(hidden)]pub replication_task: std::option::Option<crate::model::ReplicationTask>,
}
...
pub struct StartReplicationTaskAssessmentRunOutput  {
    ...
    #[doc(hidden)]pub replication_task_assessment_run: std::option::Option<crate::model::ReplicationTaskAssessmentRun>,
}
...
impl  std::fmt::Debug for StartReplicationTaskAssessmentRunOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("replication_task_assessment_run", &self.replication_task_assessment_run);
        formatter.finish()
    }
}
...
pub struct RunFleetAdvisorLsaAnalysisOutput  {
    ...
    #[doc(hidden)]pub lsa_analysis_id: std::option::Option<std::string::String>,
...
pub struct RefreshSchemasOutput  {
    ...
    #[doc(hidden)]pub refresh_schemas_status: std::option::Option<crate::model::RefreshSchemasStatus>,
}
...
pub struct RebootReplicationInstanceOutput  {
    ...
    #[doc(hidden)]pub replication_instance: std::option::Option<crate::model::ReplicationInstance>,
}
...
pub struct ModifyReplicationSubnetGroupOutput  {
    ...
    #[doc(hidden)]pub replication_subnet_group: std::option::Option<crate::model::ReplicationSubnetGroup>,
}
...
pub struct DescribeTableStatisticsOutput  {
    ...
    #[doc(hidden)]pub table_statistics: std::option::Option<std::vec::Vec<crate::model::TableStatistics>>,
...
pub struct DescribeReplicationTasksOutput  {
    ...
    #[doc(hidden)]pub replication_tasks: std::option::Option<std::vec::Vec<crate::model::ReplicationTask>>,
}
...
pub struct DescribeReplicationTaskIndividualAssessmentsOutput  {
    ...
    #[doc(hidden)]pub replication_task_individual_assessments: std::option::Option<std::vec::Vec<crate::model::ReplicationTaskIndividualAssessment>>,
}
...
impl  std::fmt::Debug for DescribeReplicationTaskIndividualAssessmentsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("marker", &self.marker);
        formatter.field("replication_task_individual_assessments", &self.replication_task_individual_assessments);
        formatter.finish()
    }
}
...
pub struct DescribeReplicationTaskAssessmentRunsOutput  {
    ...
    #[doc(hidden)]pub replication_task_assessment_runs: std::option::Option<std::vec::Vec<crate::model::ReplicationTaskAssessmentRun>>,
}
...
impl  std::fmt::Debug for DescribeReplicationTaskAssessmentRunsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("marker", &self.marker);
        formatter.field("replication_task_assessment_runs", &self.replication_task_assessment_runs);
        formatter.finish()
    }
}
...
pub struct DescribeReplicationTaskAssessmentResultsOutput  {
    ...
    #[doc(hidden)]pub replication_task_assessment_results: std::option::Option<std::vec::Vec<crate::model::ReplicationTaskAssessmentResult>>,
}
...
impl  std::fmt::Debug for DescribeReplicationTaskAssessmentResultsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("replication_task_assessment_results", &self.replication_task_assessment_results);
        formatter.finish()
    }
}
...
pub struct DescribeReplicationSubnetGroupsOutput  {
    ...
    #[doc(hidden)]pub replication_subnet_groups: std::option::Option<std::vec::Vec<crate::model::ReplicationSubnetGroup>>,
}
...
pub struct DescribeReplicationInstanceTaskLogsOutput  {
    ...
    #[doc(hidden)]pub replication_instance_task_logs: std::option::Option<std::vec::Vec<crate::model::ReplicationInstanceTaskLog>>,
    /// <p> An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeReplicationInstanceTaskLogsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("replication_instance_task_logs", &self.replication_instance_task_logs);
        formatter.field("marker", &self.marker);
        formatter.finish()
    }
}
...
pub struct DescribeReplicationInstancesOutput  {
    ...
    #[doc(hidden)]pub replication_instances: std::option::Option<std::vec::Vec<crate::model::ReplicationInstance>>,
}
...
pub struct DescribeOrderableReplicationInstancesOutput  {
    ...
    #[doc(hidden)]pub orderable_replication_instances: std::option::Option<std::vec::Vec<crate::model::OrderableReplicationInstance>>,
    /// <p> An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>. </p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeOrderableReplicationInstancesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("orderable_replication_instances", &self.orderable_replication_instances);
        formatter.field("marker", &self.marker);
        formatter.finish()
    }
}
...
pub struct DescribeFleetAdvisorSchemasOutput  {
    ...
    #[doc(hidden)]pub fleet_advisor_schemas: std::option::Option<std::vec::Vec<crate::model::SchemaResponse>>,
...
pub struct DescribeFleetAdvisorSchemaObjectSummaryOutput  {
    ...
    #[doc(hidden)]pub fleet_advisor_schema_objects: std::option::Option<std::vec::Vec<crate::model::FleetAdvisorSchemaObjectResponse>>,
    /// <p>If <code>NextToken</code> is returned, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeFleetAdvisorSchemaObjectSummaryOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("fleet_advisor_schema_objects", &self.fleet_advisor_schema_objects);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct DescribeFleetAdvisorLsaAnalysisOutput  {
    ...
    #[doc(hidden)]pub analysis: std::option::Option<std::vec::Vec<crate::model::FleetAdvisorLsaAnalysisResponse>>,
    /// <p>If <code>NextToken</code> is returned, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeFleetAdvisorDatabasesOutput  {
    ...
    #[doc(hidden)]pub databases: std::option::Option<std::vec::Vec<crate::model::DatabaseResponse>>,
    /// <p>If <code>NextToken</code> is returned, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeFleetAdvisorCollectorsOutput  {
    ...
    #[doc(hidden)]pub collectors: std::option::Option<std::vec::Vec<crate::model::CollectorResponse>>,
    /// <p>If <code>NextToken</code> is returned, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeEventCategoriesOutput  {
    ...
    #[doc(hidden)]pub event_category_group_list: std::option::Option<std::vec::Vec<crate::model::EventCategoryGroup>>,
}
...
pub struct DescribeEndpointTypesOutput  {
    ...
    #[doc(hidden)]pub supported_endpoint_types: std::option::Option<std::vec::Vec<crate::model::SupportedEndpointType>>,
}
...
pub struct DescribeEndpointSettingsOutput  {
    ...
    #[doc(hidden)]pub endpoint_settings: std::option::Option<std::vec::Vec<crate::model::EndpointSetting>>,
}
...
pub struct DescribeApplicableIndividualAssessmentsOutput  {
    ...
    #[doc(hidden)]pub individual_assessment_names: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for DescribeApplicableIndividualAssessmentsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("individual_assessment_names", &self.individual_assessment_names);
        formatter.field("marker", &self.marker);
        formatter.finish()
    }
}
...
pub struct DescribeAccountAttributesOutput  {
    ...
    /// </note>
    #[doc(hidden)]pub unique_account_identifier: std::option::Option<std::string::String>,
}
