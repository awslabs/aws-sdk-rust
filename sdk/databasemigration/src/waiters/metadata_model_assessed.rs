...
///
/// Fluent builder for the `metadata_model_assessed` waiter.
///
...
pub struct MetadataModelAssessedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_metadata_model_assessments::builders::DescribeMetadataModelAssessmentsInputBuilder,
}
impl MetadataModelAssessedFluentBuilder {
    /// Creates a new `MetadataModelAssessedFluentBuilder`.
    ...
    /// Access the DescribeMetadataModelAssessments as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_metadata_model_assessments::builders::DescribeMetadataModelAssessmentsInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        crate::waiters::metadata_model_assessed::MetadataModelAssessedFinalPoll,
        crate::waiters::metadata_model_assessed::WaitUntilMetadataModelAssessedError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessments::operation_runtime_plugins(
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_metadata_model_assessments_6268be19bb3c45d7d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Requests[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_metadata_model_assessments_dee355b6d23c355e3(result) {
        ...
        let operation = move || {
            ...
            async move {
                crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessments::orchestrate(&runtime_plugins, input).await
            }
        };
...
/// Successful return type for the `metadata_model_assessed` waiter.
pub type MetadataModelAssessedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsOutput,
...
/// Error type for the `metadata_model_assessed` waiter.
pub type WaitUntilMetadataModelAssessedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsOutput,
    crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsError,
>;
