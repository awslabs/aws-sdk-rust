...
///
/// Fluent builder for the `extension_pack_associated` waiter.
///
...
pub struct ExtensionPackAssociatedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_extension_pack_associations::builders::DescribeExtensionPackAssociationsInputBuilder,
}
impl ExtensionPackAssociatedFluentBuilder {
    /// Creates a new `ExtensionPackAssociatedFluentBuilder`.
    ...
    /// Access the DescribeExtensionPackAssociations as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_extension_pack_associations::builders::DescribeExtensionPackAssociationsInputBuilder {
        &self.inner
    }
    ...
    pub async fn wait(
        ...
        crate::waiters::extension_pack_associated::ExtensionPackAssociatedFinalPoll,
        crate::waiters::extension_pack_associated::WaitUntilExtensionPackAssociatedError,
    > {
        let input = self
            .inner
            .build()
            .map_err(::aws_smithy_runtime_api::client::waiters::error::WaiterError::construction_failure)?;
        let runtime_plugins = crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociations::operation_runtime_plugins(
        ...
        >| {
            // Matches: {"output":{"path":"Requests[].Status","expected":"SUCCESS","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_extension_pack_associations_6268be19bb3c45d7d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Requests[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_extension_pack_associations_dee355b6d23c355e3(result) {
        ...
        let operation = move || {
            ...
            async move {
                crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociations::orchestrate(&runtime_plugins, input).await
            }
        };
...
/// Successful return type for the `extension_pack_associated` waiter.
pub type ExtensionPackAssociatedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsOutput,
...
/// Error type for the `extension_pack_associated` waiter.
pub type WaitUntilExtensionPackAssociatedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsOutput,
    crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsError,
>;
