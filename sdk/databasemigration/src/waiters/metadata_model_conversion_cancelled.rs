...
///
/// Fluent builder for the `metadata_model_conversion_cancelled` waiter.
///
...
pub struct MetadataModelConversionCancelledFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_metadata_model_conversions::builders::DescribeMetadataModelConversionsInputBuilder,
}
impl MetadataModelConversionCancelledFluentBuilder {
    /// Creates a new `MetadataModelConversionCancelledFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::metadata_model_conversion_cancelled::MetadataModelConversionCancelledFinalPoll,
        crate::waiters::metadata_model_conversion_cancelled::WaitUntilMetadataModelConversionCancelledError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"Requests[].Status","expected":"CANCELED","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_metadata_model_conversions_abe953e6fa890a7bc(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Requests[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_metadata_model_conversions_dee355b6d23c355e3(result) {
...
/// Successful return type for the `metadata_model_conversion_cancelled` waiter.
pub type MetadataModelConversionCancelledFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsOutput,
...
/// Error type for the `metadata_model_conversion_cancelled` waiter.
pub type WaitUntilMetadataModelConversionCancelledError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsOutput,
    crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsError,
>;
