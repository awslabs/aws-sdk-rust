...
///
/// Fluent builder for the `metadata_model_created` waiter.
///
...
pub struct MetadataModelCreatedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_metadata_model_creations::builders::DescribeMetadataModelCreationsInputBuilder,
}
impl MetadataModelCreatedFluentBuilder {
    /// Creates a new `MetadataModelCreatedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::metadata_model_created::MetadataModelCreatedFinalPoll,
        crate::waiters::metadata_model_created::WaitUntilMetadataModelCreatedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_metadata_model_creations_6268be19bb3c45d7d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Requests[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_metadata_model_creations_dee355b6d23c355e3(result) {
        ...
        let operation = move || {
            ...
            async move { crate::operation::describe_metadata_model_creations::DescribeMetadataModelCreations::orchestrate(&runtime_plugins, input).await }
        };
...
/// Successful return type for the `metadata_model_created` waiter.
pub type MetadataModelCreatedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_metadata_model_creations::DescribeMetadataModelCreationsOutput,
...
/// Error type for the `metadata_model_created` waiter.
pub type WaitUntilMetadataModelCreatedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_metadata_model_creations::DescribeMetadataModelCreationsOutput,
    crate::operation::describe_metadata_model_creations::DescribeMetadataModelCreationsError,
>;
