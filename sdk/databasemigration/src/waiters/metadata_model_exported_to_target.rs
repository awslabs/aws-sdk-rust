...
///
/// Fluent builder for the `metadata_model_exported_to_target` waiter.
///
...
pub struct MetadataModelExportedToTargetFluentBuilder {
...
impl MetadataModelExportedToTargetFluentBuilder {
    /// Creates a new `MetadataModelExportedToTargetFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::metadata_model_exported_to_target::MetadataModelExportedToTargetFinalPoll,
        crate::waiters::metadata_model_exported_to_target::WaitUntilMetadataModelExportedToTargetError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_metadata_model_exports_to_target_6268be19bb3c45d7d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Requests[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_metadata_model_exports_to_target_dee355b6d23c355e3(result) {
        ...
        let operation = move || {
            ...
            async move {
                crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTarget::orchestrate(
                    &runtime_plugins,
                    input,
                )
                .await
...
/// Successful return type for the `metadata_model_exported_to_target` waiter.
pub type MetadataModelExportedToTargetFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetOutput,
...
/// Error type for the `metadata_model_exported_to_target` waiter.
pub type WaitUntilMetadataModelExportedToTargetError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetOutput,
    crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetError,
>;
