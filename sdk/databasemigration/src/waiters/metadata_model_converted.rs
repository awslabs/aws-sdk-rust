...
///
/// Fluent builder for the `metadata_model_converted` waiter.
///
...
pub struct MetadataModelConvertedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_metadata_model_conversions::builders::DescribeMetadataModelConversionsInputBuilder,
}
impl MetadataModelConvertedFluentBuilder {
    /// Creates a new `MetadataModelConvertedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::metadata_model_converted::MetadataModelConvertedFinalPoll,
        crate::waiters::metadata_model_converted::WaitUntilMetadataModelConvertedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_metadata_model_conversions_6268be19bb3c45d7d(result) {
...
/// Successful return type for the `metadata_model_converted` waiter.
pub type MetadataModelConvertedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsOutput,
...
/// Error type for the `metadata_model_converted` waiter.
pub type WaitUntilMetadataModelConvertedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsOutput,
    crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsError,
>;
