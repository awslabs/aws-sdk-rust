...
///
/// Fluent builder for the `metadata_model_exported_as_script` waiter.
///
...
pub struct MetadataModelExportedAsScriptFluentBuilder {
...
impl MetadataModelExportedAsScriptFluentBuilder {
    /// Creates a new `MetadataModelExportedAsScriptFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::metadata_model_exported_as_script::MetadataModelExportedAsScriptFinalPoll,
        crate::waiters::metadata_model_exported_as_script::WaitUntilMetadataModelExportedAsScriptError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_metadata_model_exports_as_script_6268be19bb3c45d7d(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Requests[].Status","expected":"FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_metadata_model_exports_as_script_dee355b6d23c355e3(result) {
        ...
        let operation = move || {
            ...
            async move {
                crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScript::orchestrate(
                    &runtime_plugins,
                    input,
                )
                .await
...
/// Successful return type for the `metadata_model_exported_as_script` waiter.
pub type MetadataModelExportedAsScriptFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptOutput,
...
/// Error type for the `metadata_model_exported_as_script` waiter.
pub type WaitUntilMetadataModelExportedAsScriptError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptOutput,
    crate::operation::describe_metadata_model_exports_as_script::DescribeMetadataModelExportsAsScriptError,
>;
