...
impl super::Client {
    ...
    ///   - [`replication_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_replication_instance::builders::DeleteReplicationInstanceFluentBuilder::replication_instance_arn) / [`set_replication_instance_arn(Option<String>)`](crate::operation::delete_replication_instance::builders::DeleteReplicationInstanceFluentBuilder::set_replication_instance_arn): <p>The Amazon Resource Name (ARN) of the replication instance to be deleted.</p>
