...
impl super::Client {
    ...
    ///   - [`certificate_arn(impl Into<String>)`](crate::operation::delete_certificate::builders::DeleteCertificateFluentBuilder::certificate_arn) / [`set_certificate_arn(Option<String>)`](crate::operation::delete_certificate::builders::DeleteCertificateFluentBuilder::set_certificate_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the certificate.</p><br>
