...
impl super::Client {
    ...
    ///   - [`filters(Vec<Filter>)`](crate::operation::describe_recommendations::builders::DescribeRecommendationsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_recommendations::builders::DescribeRecommendationsFluentBuilder::set_filters): <p>Filters applied to the target engine recommendations described in the form of key-value pairs.</p>
    ///   - [`max_records(i32)`](crate::operation::describe_recommendations::builders::DescribeRecommendationsFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_recommendations::builders::DescribeRecommendationsFluentBuilder::set_max_records): <p>The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, Fleet Advisor includes a pagination token in the response so that you can retrieve the remaining results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_recommendations::builders::DescribeRecommendationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_recommendations::builders::DescribeRecommendationsFluentBuilder::set_next_token): <p>Specifies the unique pagination token that makes it possible to display the next page of results. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>.</p>  <p>If <code>NextToken</code> is returned by a previous response, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged.</p>
