...
impl super::Client  {
    ...
    pub fn describe_replication_task_assessment_results(&self) -> crate::client::fluent_builders::DescribeReplicationTaskAssessmentResults {
                                crate::client::fluent_builders::DescribeReplicationTaskAssessmentResults::new(self.handle.clone())
                            }
}
