...
impl super::Client {
    ...
    ///   - [`replication_task_arn(impl Into<String>)`](crate::operation::stop_replication_task::builders::StopReplicationTaskFluentBuilder::replication_task_arn) / [`set_replication_task_arn(Option<String>)`](crate::operation::stop_replication_task::builders::StopReplicationTaskFluentBuilder::set_replication_task_arn):<br>required: **true**<br><p>The Amazon Resource Name(ARN) of the replication task to be stopped.</p><br>
