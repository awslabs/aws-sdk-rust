...
impl super::Client {
    ...
    ///   - [`data(StartRecommendationsRequestEntry)`](crate::operation::batch_start_recommendations::builders::BatchStartRecommendationsFluentBuilder::data) / [`set_data(Option<Vec::<StartRecommendationsRequestEntry>>)`](crate::operation::batch_start_recommendations::builders::BatchStartRecommendationsFluentBuilder::set_data):<br>required: **false**<br><p>Provides information about source databases to analyze. After this analysis, Fleet Advisor recommends target engines for each source database.</p><br>
