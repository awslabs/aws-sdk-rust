...
impl super::Client {
    ...
    pub fn describe_table_statistics(
        &self,
    ) -> crate::operation::describe_table_statistics::builders::DescribeTableStatisticsFluentBuilder
    {
