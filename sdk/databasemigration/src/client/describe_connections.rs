...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_connections::builders::DescribeConnectionsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_connections::builders::DescribeConnectionsFluentBuilder::set_filters): <p>The filters applied to the connection.</p>  <p>Valid filter names: endpoint-arn | replication-instance-arn</p>
