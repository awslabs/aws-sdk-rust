...
impl super::Client {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::set_marker): <p> An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>. </p>
