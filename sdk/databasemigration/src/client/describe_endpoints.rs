...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_endpoints::builders::DescribeEndpointsFluentBuilder::set_filters): <p>Filters applied to the endpoints.</p>  <p>Valid filter names: endpoint-arn | endpoint-type | endpoint-id | engine-name</p>
