...
impl super::Client {
    ...
    ///   - [`endpoint_arn(impl ::std::convert::Into<String>)`](crate::operation::refresh_schemas::builders::RefreshSchemasFluentBuilder::endpoint_arn) / [`set_endpoint_arn(Option<String>)`](crate::operation::refresh_schemas::builders::RefreshSchemasFluentBuilder::set_endpoint_arn): <p>The Amazon Resource Name (ARN) string that uniquely identifies the endpoint.</p>
    ///   - [`replication_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::refresh_schemas::builders::RefreshSchemasFluentBuilder::replication_instance_arn) / [`set_replication_instance_arn(Option<String>)`](crate::operation::refresh_schemas::builders::RefreshSchemasFluentBuilder::set_replication_instance_arn): <p>The Amazon Resource Name (ARN) of the replication instance.</p>
