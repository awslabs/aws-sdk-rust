...
impl super::Client {
    ...
    ///   - [`replication_instance_arn(impl Into<String>)`](crate::operation::describe_pending_maintenance_actions::builders::DescribePendingMaintenanceActionsFluentBuilder::replication_instance_arn) / [`set_replication_instance_arn(Option<String>)`](crate::operation::describe_pending_maintenance_actions::builders::DescribePendingMaintenanceActionsFluentBuilder::set_replication_instance_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the replication instance.</p><br>
    ///   - [`filters(Filter)`](crate::operation::describe_pending_maintenance_actions::builders::DescribePendingMaintenanceActionsFluentBuilder::filters) / [`set_filters(Option<Vec::<Filter>>)`](crate::operation::describe_pending_maintenance_actions::builders::DescribePendingMaintenanceActionsFluentBuilder::set_filters):<br>required: **false**<br><p></p><br>
    ...
    ///   - [`max_records(i32)`](crate::operation::describe_pending_maintenance_actions::builders::DescribePendingMaintenanceActionsFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_pending_maintenance_actions::builders::DescribePendingMaintenanceActionsFluentBuilder::set_max_records):<br>required: **false**<br><p>The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a pagination token called a marker is included in the response so that the remaining results can be retrieved.</p> <p>Default: 100</p> <p>Constraints: Minimum 20, maximum 100.</p><br>
