...
impl super::Client  {
    ...
    pub fn describe_fleet_advisor_schema_object_summary(&self) -> crate::client::fluent_builders::DescribeFleetAdvisorSchemaObjectSummary {
                                crate::client::fluent_builders::DescribeFleetAdvisorSchemaObjectSummary::new(self.handle.clone())
                            }
}
