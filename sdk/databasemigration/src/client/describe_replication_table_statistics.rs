...
impl super::Client {
    ...
    ///   - [`replication_config_arn(impl Into<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::replication_config_arn) / [`set_replication_config_arn(Option<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_replication_config_arn): <p>The replication config to describe.</p>
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_marker): <p>An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>. </p>
    ///   - [`filters(Filter)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_filters): <p>Filters applied to the replication table statistics.</p>
