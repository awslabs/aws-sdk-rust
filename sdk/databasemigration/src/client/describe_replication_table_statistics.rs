...
impl super::Client {
    ...
    ///   - [`replication_config_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::replication_config_arn) / [`set_replication_config_arn(Option<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_replication_config_arn): <p>The replication config to describe.</p>
    ///   - [`max_records(i32)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_max_records): <p>The maximum number of records to include in the response. If more records exist than the specified <code>MaxRecords</code> value, a pagination token called a marker is included in the response so that the remaining results can be retrieved. </p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_marker): <p>An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>. </p>
    ///   - [`filters(Vec<Filter>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_replication_table_statistics::builders::DescribeReplicationTableStatisticsFluentBuilder::set_filters): <p>Filters applied to the replication table statistics.</p>
