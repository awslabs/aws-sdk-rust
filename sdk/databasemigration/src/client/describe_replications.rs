...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_replications::builders::DescribeReplicationsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_replications::builders::DescribeReplicationsFluentBuilder::set_filters): <p>Filters applied to the replications.</p>
    ...
    ///   - [`marker(impl Into<String>)`](crate::operation::describe_replications::builders::DescribeReplicationsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_replications::builders::DescribeReplicationsFluentBuilder::set_marker): <p>An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by <code>MaxRecords</code>. </p>
