...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_replications::builders::DescribeReplicationsFluentBuilder::filters) / [`set_filters(Option<Vec::<Filter>>)`](crate::operation::describe_replications::builders::DescribeReplicationsFluentBuilder::set_filters):<br>required: **false**<br><p>Filters applied to the replications.</p> <p>Valid filter names: <code>replication-config-arn</code> | <code>replication-config-id</code></p><br>
