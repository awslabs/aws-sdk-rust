...
impl super::Client {
    ...
    ///   - [`engine(impl Into<String>)`](crate::operation::create_data_provider::builders::CreateDataProviderFluentBuilder::engine) / [`set_engine(Option<String>)`](crate::operation::create_data_provider::builders::CreateDataProviderFluentBuilder::set_engine):<br>required: **true**<br><p>The type of database engine for the data provider. Valid values include <code>"aurora"</code>, <code>"aurora-postgresql"</code>, <code>"mysql"</code>, <code>"oracle"</code>, <code>"postgres"</code>, <code>"sqlserver"</code>, <code>redshift</code>, <code>mariadb</code>, <code>mongodb</code>, <code>db2</code>, <code>db2-zos</code> and <code>docdb</code>. A value of <code>"aurora"</code> represents Amazon Aurora MySQL-Compatible Edition.</p><br>
    ///   - [`r#virtual(bool)`](crate::operation::create_data_provider::builders::CreateDataProviderFluentBuilder::virtual) / [`set_virtual(Option<bool>)`](crate::operation::create_data_provider::builders::CreateDataProviderFluentBuilder::set_virtual):<br>required: **false**<br><p>Indicates whether the data provider is virtual.</p><br>
