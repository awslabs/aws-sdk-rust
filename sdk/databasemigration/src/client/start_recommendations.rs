...
impl super::Client {
    ...
    ///   - [`database_id(impl ::std::convert::Into<String>)`](crate::operation::start_recommendations::builders::StartRecommendationsFluentBuilder::database_id) / [`set_database_id(Option<String>)`](crate::operation::start_recommendations::builders::StartRecommendationsFluentBuilder::set_database_id): <p>The identifier of the source database to analyze and provide recommendations for.</p>
