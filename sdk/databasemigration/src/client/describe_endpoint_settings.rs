...
impl super::Client {
    ...
    ///   - [`engine_name(impl ::std::convert::Into<String>)`](crate::operation::describe_endpoint_settings::builders::DescribeEndpointSettingsFluentBuilder::engine_name) / [`set_engine_name(Option<String>)`](crate::operation::describe_endpoint_settings::builders::DescribeEndpointSettingsFluentBuilder::set_engine_name): <p>The database engine used for your source or target endpoint.</p>
