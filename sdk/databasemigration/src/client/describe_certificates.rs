...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_certificates::builders::DescribeCertificatesFluentBuilder::set_filters): <p>Filters applied to the certificates described in the form of key-value pairs. Valid values are <code>certificate-arn</code> and <code>certificate-id</code>.</p>
