...
impl super::Client  {
    ...
    pub fn describe_orderable_replication_instances(&self) -> crate::client::fluent_builders::DescribeOrderableReplicationInstances {
                                crate::client::fluent_builders::DescribeOrderableReplicationInstances::new(self.handle.clone())
                            }
}
