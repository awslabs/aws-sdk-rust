...
impl super::Client {
    ...
    ///   - [`start_replication_type(impl Into<String>)`](crate::operation::start_replication::builders::StartReplicationFluentBuilder::start_replication_type) / [`set_start_replication_type(Option<String>)`](crate::operation::start_replication::builders::StartReplicationFluentBuilder::set_start_replication_type):<br>required: **true**<br><p>The replication type.</p><br>
