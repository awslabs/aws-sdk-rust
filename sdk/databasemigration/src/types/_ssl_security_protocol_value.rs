...
impl ::std::convert::From<&str> for SslSecurityProtocolValue {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SslSecurityProtocolValue::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SslSecurityProtocolValue {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SslSecurityProtocolValue::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SslSecurityProtocolValue {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
