...
impl RunFleetAdvisorLsaAnalysisInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysis::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RunFleetAdvisorLsaAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_run_fleet_advisor_lsa_analysis::de_run_fleet_advisor_lsa_analysis_http_response_with_props(
                status, headers, body,
            )
        }
    }
