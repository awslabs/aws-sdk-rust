...
/// Orchestration and serialization glue logic for `RunFleetAdvisorLsaAnalysis`.
...
impl RunFleetAdvisorLsaAnalysis {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisInput,
                    ) -> ::std::result::Result<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RunFleetAdvisorLsaAnalysis {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RunFleetAdvisorLsaAnalysis");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RunFleetAdvisorLsaAnalysisRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RunFleetAdvisorLsaAnalysisResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RunFleetAdvisorLsaAnalysis")
...
.with_interceptor(RunFleetAdvisorLsaAnalysisEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError>::new());
...
#[derive(Debug)]
            struct RunFleetAdvisorLsaAnalysisResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RunFleetAdvisorLsaAnalysisResponseDeserializer {
...
#[derive(Debug)]
            struct RunFleetAdvisorLsaAnalysisRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RunFleetAdvisorLsaAnalysisRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_run_fleet_advisor_lsa_analysis::ser_run_fleet_advisor_lsa_analysis_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct RunFleetAdvisorLsaAnalysisEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RunFleetAdvisorLsaAnalysisEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RunFleetAdvisorLsaAnalysisEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RunFleetAdvisorLsaAnalysisInput>()
                        .ok_or("failed to downcast to RunFleetAdvisorLsaAnalysisInput")?;
...
pub enum RunFleetAdvisorLsaAnalysisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RunFleetAdvisorLsaAnalysisError) for what information is available for the error.")]
...
impl RunFleetAdvisorLsaAnalysisError {
    /// Creates the `RunFleetAdvisorLsaAnalysisError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RunFleetAdvisorLsaAnalysisError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RunFleetAdvisorLsaAnalysisError {
...
impl ::aws_types::request_id::RequestId for crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError {
...
mod _run_fleet_advisor_lsa_analysis_output;
