...
impl RunFleetAdvisorLsaAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`RunFleetAdvisorLsaAnalysis`](crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_run_fleet_advisor_lsa_analysis::ser_run_fleet_advisor_lsa_analysis_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysis::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RunFleetAdvisorLsaAnalysis", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for RunFleetAdvisorLsaAnalysis {
                type Output = std::result::Result<crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisOutput, crate::operation::run_fleet_advisor_lsa_analysis::RunFleetAdvisorLsaAnalysisError>;
