...
/// Orchestration and serialization glue logic for `DescribeRefreshSchemasStatus`.
...
impl DescribeRefreshSchemasStatus {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusInput,
                    ) -> ::std::result::Result<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeRefreshSchemasStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeRefreshSchemasStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeRefreshSchemasStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeRefreshSchemasStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeRefreshSchemasStatus")
...
.with_interceptor(DescribeRefreshSchemasStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError>::new());
...
#[derive(Debug)]
            struct DescribeRefreshSchemasStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeRefreshSchemasStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_refresh_schemas_status::de_describe_refresh_schemas_status_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_refresh_schemas_status::de_describe_refresh_schemas_status_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeRefreshSchemasStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeRefreshSchemasStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_refresh_schemas_status::ser_describe_refresh_schemas_status_input(&input)?);
...
#[derive(Debug)]
            struct DescribeRefreshSchemasStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeRefreshSchemasStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeRefreshSchemasStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeRefreshSchemasStatusInput>()
                        .ok_or("failed to downcast to DescribeRefreshSchemasStatusInput")?;
...
pub enum DescribeRefreshSchemasStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeRefreshSchemasStatusError) for what information is available for the error.")]
...
impl DescribeRefreshSchemasStatusError {
    /// Creates the `DescribeRefreshSchemasStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeRefreshSchemasStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeRefreshSchemasStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError {
...
mod _describe_refresh_schemas_status_output;
