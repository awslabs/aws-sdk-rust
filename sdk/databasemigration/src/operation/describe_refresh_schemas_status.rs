...
impl DescribeRefreshSchemasStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRefreshSchemasStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_refresh_schemas_status::de_describe_refresh_schemas_status_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeRefreshSchemasStatusError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_refresh_schemas_status::DescribeRefreshSchemasStatusError
{
