...
impl MoveReplicationTaskInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_move_replication_task::ser_move_replication_task_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::move_replication_task::MoveReplicationTask::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::move_replication_task::MoveReplicationTaskError
{
