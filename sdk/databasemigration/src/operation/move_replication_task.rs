...
impl MoveReplicationTask {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::move_replication_task::MoveReplicationTaskError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::move_replication_task::MoveReplicationTaskOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.MoveReplicationTask",
            "rpc.service" = "Database Migration Service",
            "rpc.method" = "MoveReplicationTask",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MoveReplicationTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            MoveReplicationTaskRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            MoveReplicationTaskResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("MoveReplicationTask")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MoveReplicationTask")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                MoveReplicationTaskTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct MoveReplicationTaskTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MoveReplicationTaskTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<MoveReplicationTaskInput>() else {
        ...
        if requested.should_capture("TargetReplicationInstanceArn") {
            if let ::std::option::Option::Some(value) = input.target_replication_instance_arn.as_deref() {
                captured.insert("TargetReplicationInstanceArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MoveReplicationTaskResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_move_replication_task::de_move_replication_task_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_move_replication_task::de_move_replication_task_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MoveReplicationTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::move_replication_task::MoveReplicationTaskInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::move_replication_task::MoveReplicationTaskInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_move_replication_task::ser_move_replication_task_input(
            &input,
        )?);
