...
impl MoveReplicationTaskInput {
    /// Consumes the builder and constructs an Operation<[`MoveReplicationTask`](crate::operation::move_replication_task::MoveReplicationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::move_replication_task::MoveReplicationTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::move_replication_task::MoveReplicationTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_move_replication_task::ser_move_replication_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::move_replication_task::MoveReplicationTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("MoveReplicationTask", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for MoveReplicationTask {
                type Output = std::result::Result<crate::operation::move_replication_task::MoveReplicationTaskOutput, crate::operation::move_replication_task::MoveReplicationTaskError>;
