...
impl MoveReplicationTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::move_replication_task::MoveReplicationTask::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("MoveReplicationTask", "databasemigrationservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for MoveReplicationTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_move_replication_task::de_move_replication_task_http_response_with_props(status, headers, body)
        }
    }
}
