...
impl DescribeTableStatisticsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTableStatistics`](crate::operation::describe_table_statistics::DescribeTableStatistics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_table_statistics::DescribeTableStatistics, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_table_statistics::DescribeTableStatisticsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_table_statistics::ser_describe_table_statistics_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_table_statistics::DescribeTableStatistics::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeTableStatistics", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTableStatistics {
                type Output = std::result::Result<crate::operation::describe_table_statistics::DescribeTableStatisticsOutput, crate::operation::describe_table_statistics::DescribeTableStatisticsError>;
