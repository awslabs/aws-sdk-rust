...
impl DeleteReplicationSubnetGroupFluentBuilder  {
    /// Creates a new `DeleteReplicationSubnetGroup`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_replication_subnet_group::DeleteReplicationSubnetGroupOutput, aws_smithy_http::result::SdkError<crate::operation::delete_replication_subnet_group::DeleteReplicationSubnetGroupError>>
                     {
