...
impl DescribeMetadataModelImportsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_metadata_model_imports::DescribeMetadataModelImportsInput, ::aws_smithy_types::error::operation::BuildError> {
