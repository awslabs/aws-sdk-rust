...
impl DescribeReplicationInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_replication_instances::DescribeReplicationInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplicationInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_instances::de_describe_replication_instances_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeReplicationInstancesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_replication_instances::DescribeReplicationInstancesError
{
