...
/// Orchestration and serialization glue logic for `CreateReplicationSubnetGroup`.
...
impl CreateReplicationSubnetGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateReplicationSubnetGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateReplicationSubnetGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateReplicationSubnetGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateReplicationSubnetGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateReplicationSubnetGroup")
...
.with_interceptor(CreateReplicationSubnetGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError>::new());
...
#[derive(Debug)]
            struct CreateReplicationSubnetGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateReplicationSubnetGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_replication_subnet_group::de_create_replication_subnet_group_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateReplicationSubnetGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateReplicationSubnetGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_replication_subnet_group::ser_create_replication_subnet_group_input(&input)?);
...
#[derive(Debug)]
            struct CreateReplicationSubnetGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateReplicationSubnetGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateReplicationSubnetGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateReplicationSubnetGroupInput>()
                        .ok_or("failed to downcast to CreateReplicationSubnetGroupInput")?;
...
pub enum CreateReplicationSubnetGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateReplicationSubnetGroupError) for what information is available for the error.")]
...
impl CreateReplicationSubnetGroupError {
    /// Creates the `CreateReplicationSubnetGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateReplicationSubnetGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateReplicationSubnetGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError {
...
mod _create_replication_subnet_group_output;
