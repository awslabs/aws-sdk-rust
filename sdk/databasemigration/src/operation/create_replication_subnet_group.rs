...
impl CreateReplicationSubnetGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateReplicationSubnetGroup`](crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_replication_subnet_group::ser_create_replication_subnet_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateReplicationSubnetGroup", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReplicationSubnetGroup {
                type Output = std::result::Result<crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupOutput, crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError>;
