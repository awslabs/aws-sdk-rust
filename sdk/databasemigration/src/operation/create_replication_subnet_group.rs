...
impl CreateReplicationSubnetGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateReplicationSubnetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_replication_subnet_group::de_create_replication_subnet_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateReplicationSubnetGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError
{
