    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDataProvider")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DeleteDataProviderEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeleteDataProviderResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeleteDataProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_data_provider::ser_delete_data_provider_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteDataProviderEndpointParamsInterceptor {
...
pub type DeleteDataProviderErrorKind = DeleteDataProviderError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteDataProviderError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_data_provider::DeleteDataProviderError {
...
impl DeleteDataProviderError {
    ...
    /// Creates the `DeleteDataProviderError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
