...
impl ModifyReplicationConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_replication_config::ModifyReplicationConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_replication_config::ModifyReplicationConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_replication_config::ModifyReplicationConfigOutput, crate::operation::modify_replication_config::ModifyReplicationConfigError, Self> {
