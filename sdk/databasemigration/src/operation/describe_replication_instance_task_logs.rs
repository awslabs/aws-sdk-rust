...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReplicationInstanceTaskLogs {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_instance_task_logs::de_describe_replication_instance_task_logs_http_response_with_props(status, headers, body)
        }
    }
}
