...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplicationTaskAssessmentRuns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_task_assessment_runs::de_describe_replication_task_assessment_runs_http_response_with_props(status, headers, body)
        }
    }
}
