...
impl DescribeEndpointSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_endpoint_settings::DescribeEndpointSettingsInput, ::aws_smithy_types::error::operation::BuildError> {
