...
impl RefreshSchemas {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::refresh_schemas::RefreshSchemasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::refresh_schemas::RefreshSchemasOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.RefreshSchemas",
            "rpc.service" = "Database Migration Service",
            "rpc.method" = "RefreshSchemas",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RefreshSchemas {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RefreshSchemasRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RefreshSchemasResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RefreshSchemas")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RefreshSchemas")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RefreshSchemasTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RefreshSchemasTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RefreshSchemasTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RefreshSchemasInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RefreshSchemasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_refresh_schemas::de_refresh_schemas_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_refresh_schemas::de_refresh_schemas_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RefreshSchemasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::refresh_schemas::RefreshSchemasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::refresh_schemas::RefreshSchemasInput,
