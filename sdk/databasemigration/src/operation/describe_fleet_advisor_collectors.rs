...
impl DescribeFleetAdvisorCollectorsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectors::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetAdvisorCollectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_advisor_collectors::de_describe_fleet_advisor_collectors_http_response_with_props(
                status, headers, body,
            )
        }
    }
