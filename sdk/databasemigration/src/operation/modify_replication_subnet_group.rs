...
impl ModifyReplicationSubnetGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyReplicationSubnetGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_replication_subnet_group::de_modify_replication_subnet_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ModifyReplicationSubnetGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError
{
