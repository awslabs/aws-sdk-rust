...
impl ModifyReplicationSubnetGroup {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.ModifyReplicationSubnetGroup",
            "rpc.service" = "Database Migration Service",
            "rpc.method" = "ModifyReplicationSubnetGroup",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyReplicationSubnetGroup {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyReplicationSubnetGroupRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyReplicationSubnetGroupResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyReplicationSubnetGroup")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyReplicationSubnetGroup")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyReplicationSubnetGroupTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyReplicationSubnetGroupTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyReplicationSubnetGroupTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyReplicationSubnetGroupInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("ReplicationSubnetGroupIdentifier") {
            if let ::std::option::Option::Some(value) = input.replication_subnet_group_identifier.as_deref() {
                captured.insert("ReplicationSubnetGroupIdentifier", value);
            }
        }
        if requested.should_capture("ReplicationSubnetGroupDescription") {
            if let ::std::option::Option::Some(value) = input.replication_subnet_group_description.as_deref() {
                captured.insert("ReplicationSubnetGroupDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyReplicationSubnetGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_replication_subnet_group::ser_modify_replication_subnet_group_input(&input)?,
        );
