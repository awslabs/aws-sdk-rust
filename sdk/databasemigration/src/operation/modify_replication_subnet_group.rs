...
impl ModifyReplicationSubnetGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyReplicationSubnetGroup`](crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_replication_subnet_group::ser_modify_replication_subnet_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyReplicationSubnetGroup", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyReplicationSubnetGroup {
                type Output = std::result::Result<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupOutput, crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError>;
