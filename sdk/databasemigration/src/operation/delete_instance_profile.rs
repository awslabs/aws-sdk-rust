...
impl DeleteInstanceProfile {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.DeleteInstanceProfile",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonDMSv20160101.DeleteInstanceProfile",
            );
            builder
        };
...
impl DeleteInstanceProfileError {
    ...
    /// Returns `true` if the error kind is `DeleteInstanceProfileError::AccessDeniedFault`.
    pub fn is_access_denied_fault(&self) -> bool {
        matches!(self, Self::AccessDeniedFault(_))
    }
    /// Returns `true` if the error kind is `DeleteInstanceProfileError::FailedDependencyFault`.
    pub fn is_failed_dependency_fault(&self) -> bool {
        matches!(self, Self::FailedDependencyFault(_))
    }
    /// Returns `true` if the error kind is `DeleteInstanceProfileError::InvalidResourceStateFault`.
    pub fn is_invalid_resource_state_fault(&self) -> bool {
        matches!(self, Self::InvalidResourceStateFault(_))
    }
    /// Returns `true` if the error kind is `DeleteInstanceProfileError::ResourceNotFoundFault`.
