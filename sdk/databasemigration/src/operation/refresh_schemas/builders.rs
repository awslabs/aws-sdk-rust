...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::refresh_schemas::RefreshSchemasOutput,
                    crate::operation::refresh_schemas::RefreshSchemasError,
                > for RefreshSchemasFluentBuilder
            {
                fn send(
                    self,
...
impl RefreshSchemasFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::refresh_schemas::builders::RefreshSchemasInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::refresh_schemas::RefreshSchemasOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::refresh_schemas::RefreshSchemasError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::refresh_schemas::RefreshSchemas::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::refresh_schemas::RefreshSchemas::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::refresh_schemas::RefreshSchemasOutput, crate::operation::refresh_schemas::RefreshSchemasError, Self> {
