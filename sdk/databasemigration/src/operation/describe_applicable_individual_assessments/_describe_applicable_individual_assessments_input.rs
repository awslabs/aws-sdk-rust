...
impl DescribeApplicableIndividualAssessmentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_applicable_individual_assessments::DescribeApplicableIndividualAssessmentsInput, ::aws_smithy_types::error::operation::BuildError> {
