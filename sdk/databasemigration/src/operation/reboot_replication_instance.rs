...
impl RebootReplicationInstanceInput {
    /// Consumes the builder and constructs an Operation<[`RebootReplicationInstance`](crate::operation::reboot_replication_instance::RebootReplicationInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reboot_replication_instance::RebootReplicationInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_replication_instance::RebootReplicationInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_replication_instance::ser_reboot_replication_instance_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_replication_instance::RebootReplicationInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RebootReplicationInstance", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for RebootReplicationInstance {
                type Output = std::result::Result<crate::operation::reboot_replication_instance::RebootReplicationInstanceOutput, crate::operation::reboot_replication_instance::RebootReplicationInstanceError>;
