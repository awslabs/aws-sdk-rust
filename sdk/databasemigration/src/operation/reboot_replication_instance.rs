...
impl RebootReplicationInstanceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_replication_instance::RebootReplicationInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootReplicationInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reboot_replication_instance::de_reboot_replication_instance_http_response_with_props(status, headers, body)
        }
    }
}
