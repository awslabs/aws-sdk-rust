...
impl RebootReplicationInstance {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::reboot_replication_instance::RebootReplicationInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reboot_replication_instance::RebootReplicationInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::reboot_replication_instance::RebootReplicationInstanceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::reboot_replication_instance::RebootReplicationInstanceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RebootReplicationInstance {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RebootReplicationInstance");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RebootReplicationInstanceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RebootReplicationInstanceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RebootReplicationInstance")
...
.with_interceptor(RebootReplicationInstanceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::reboot_replication_instance::RebootReplicationInstanceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::reboot_replication_instance::RebootReplicationInstanceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::reboot_replication_instance::RebootReplicationInstanceError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_reboot_replication_instance::de_reboot_replication_instance_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_reboot_replication_instance::de_reboot_replication_instance_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RebootReplicationInstanceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::reboot_replication_instance::RebootReplicationInstanceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::reboot_replication_instance::RebootReplicationInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_reboot_replication_instance::ser_reboot_replication_instance_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RebootReplicationInstanceEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RebootReplicationInstanceInput>()
                        .ok_or("failed to downcast to RebootReplicationInstanceInput")?;
...
pub enum RebootReplicationInstanceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RebootReplicationInstanceError) for what information is available for the error.")]
...
impl RebootReplicationInstanceError {
    /// Creates the `RebootReplicationInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RebootReplicationInstanceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RebootReplicationInstanceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::reboot_replication_instance::RebootReplicationInstanceError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::reboot_replication_instance::_reboot_replication_instance_output::RebootReplicationInstanceOutput;

pub use crate::operation::reboot_replication_instance::_reboot_replication_instance_input::RebootReplicationInstanceInput;

mod _reboot_replication_instance_input;

mod _reboot_replication_instance_output;
