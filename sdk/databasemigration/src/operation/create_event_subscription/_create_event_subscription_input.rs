...
impl CreateEventSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_event_subscription::CreateEventSubscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
