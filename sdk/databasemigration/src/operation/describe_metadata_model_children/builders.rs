...
pub use crate::operation::describe_metadata_model_children::_describe_metadata_model_children_input::DescribeMetadataModelChildrenInputBuilder;

pub use crate::operation::describe_metadata_model_children::_describe_metadata_model_children_output::DescribeMetadataModelChildrenOutputBuilder;

impl crate::operation::describe_metadata_model_children::builders::DescribeMetadataModelChildrenInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.describe_metadata_model_children();
...
pub struct DescribeMetadataModelChildrenFluentBuilder {
    ...
    inner: crate::operation::describe_metadata_model_children::builders::DescribeMetadataModelChildrenInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::describe_metadata_model_children::DescribeMetadataModelChildrenOutput,
        crate::operation::describe_metadata_model_children::DescribeMetadataModelChildrenError,
    > for DescribeMetadataModelChildrenFluentBuilder
{
    fn send(
        self,
...
impl DescribeMetadataModelChildrenFluentBuilder {
    /// Creates a new `DescribeMetadataModelChildrenFluentBuilder`.
    ...
    /// Access the DescribeMetadataModelChildren as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_metadata_model_children::builders::DescribeMetadataModelChildrenInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::describe_metadata_model_children::DescribeMetadataModelChildren::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::describe_metadata_model_children::paginator::DescribeMetadataModelChildrenPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
