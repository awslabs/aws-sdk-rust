...
impl ReloadTablesInput {
    /// Consumes the builder and constructs an Operation<[`ReloadTables`](crate::operation::reload_tables::ReloadTables)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reload_tables::ReloadTables, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reload_tables::ReloadTablesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reload_tables::ser_reload_tables_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reload_tables::ReloadTables::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ReloadTables", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ReloadTables {
                type Output = std::result::Result<crate::operation::reload_tables::ReloadTablesOutput, crate::operation::reload_tables::ReloadTablesError>;
