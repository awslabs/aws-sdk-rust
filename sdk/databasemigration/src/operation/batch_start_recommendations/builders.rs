...
impl BatchStartRecommendationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_start_recommendations::BatchStartRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_start_recommendations::BatchStartRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_start_recommendations::BatchStartRecommendationsOutput, crate::operation::batch_start_recommendations::BatchStartRecommendationsError, Self> {
