...
impl BatchStartRecommendationsOutput {
    ...
    pub fn error_entries(
        &self,
    ) -> ::std::option::Option<&[crate::types::BatchStartRecommendationsErrorEntry]> {
...
impl BatchStartRecommendationsOutputBuilder {
    ...
    pub fn error_entries(
        mut self,
        input: crate::types::BatchStartRecommendationsErrorEntry,
    ) -> Self {
    ...
    pub fn set_error_entries(
        ...
        input: ::std::option::Option<
            ::std::vec::Vec<crate::types::BatchStartRecommendationsErrorEntry>,
        >,
    ) -> Self {
