...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetAdvisorSchemaObjectSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_advisor_schema_object_summary::de_describe_fleet_advisor_schema_object_summary_http_response_with_props(status, headers, body)
        }
    }
}
