    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDataProvider")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ModifyDataProviderEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ModifyDataProviderResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ModifyDataProviderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_data_provider::ser_modify_data_provider_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyDataProviderEndpointParamsInterceptor {
...
pub type ModifyDataProviderErrorKind = ModifyDataProviderError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyDataProviderError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_data_provider::ModifyDataProviderError {
...
impl ModifyDataProviderError {
    ...
    /// Creates the `ModifyDataProviderError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
