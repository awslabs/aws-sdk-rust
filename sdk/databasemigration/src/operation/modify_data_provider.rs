...
/// Orchestration and serialization glue logic for `ModifyDataProvider`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ModifyDataProvider;
impl ModifyDataProvider {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_data_provider::ModifyDataProviderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_data_provider::ModifyDataProviderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_data_provider::ModifyDataProviderError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_data_provider::ModifyDataProviderOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyDataProvider {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyDataProvider");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyDataProviderRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyDataProviderResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDataProvider")
...
.with_interceptor(ModifyDataProviderEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_data_provider::ModifyDataProviderError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_data_provider::ModifyDataProviderError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_data_provider::ModifyDataProviderError>::new());
...
#[derive(Debug)]
            struct ModifyDataProviderResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyDataProviderResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_data_provider::de_modify_data_provider_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_data_provider::de_modify_data_provider_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyDataProviderRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyDataProviderRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_data_provider::ModifyDataProviderInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_data_provider::ModifyDataProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                        ...
                        "AmazonDMSv20160101.ModifyDataProvider"
                    );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_data_provider::ser_modify_data_provider_input(&input)?);
...
#[derive(Debug)]
            struct ModifyDataProviderEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDataProviderEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyDataProviderEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyDataProviderInput>()
                        .ok_or("failed to downcast to ModifyDataProviderInput")?;
...
/// Error type for the `ModifyDataProviderError` operation.
#[non_exhaustive]
...
pub enum ModifyDataProviderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyDataProviderError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ModifyDataProviderError {
    /// Creates the `ModifyDataProviderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyDataProviderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ModifyDataProviderError::ResourceNotFoundFault`.
    pub fn is_resource_not_found_fault(&self) -> bool {
        matches!(self, Self::ResourceNotFoundFault(_))
    }
}
impl ::std::error::Error for ModifyDataProviderError {
...
impl ::std::fmt::Display for ModifyDataProviderError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ModifyDataProviderError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyDataProviderError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyDataProviderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_data_provider::ModifyDataProviderError {
...
mod _modify_data_provider_output;
