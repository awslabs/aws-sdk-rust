...
impl StartReplicationTaskAssessmentRun {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRunError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRunOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.StartReplicationTaskAssessmentRun",
            "rpc.service" = "Database Migration Service",
            "rpc.method" = "StartReplicationTaskAssessmentRun",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartReplicationTaskAssessmentRun {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartReplicationTaskAssessmentRun");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartReplicationTaskAssessmentRunRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartReplicationTaskAssessmentRunResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartReplicationTaskAssessmentRun")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartReplicationTaskAssessmentRun")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartReplicationTaskAssessmentRunTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartReplicationTaskAssessmentRunEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct StartReplicationTaskAssessmentRunTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartReplicationTaskAssessmentRunTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartReplicationTaskAssessmentRunInput>() else {
        ...
        if requested.should_capture("ResultLocationBucket") {
            if let ::std::option::Option::Some(value) = input.result_location_bucket.as_deref() {
                captured.insert("ResultLocationBucket", value);
            }
        }
        if requested.should_capture("ResultLocationFolder") {
            if let ::std::option::Option::Some(value) = input.result_location_folder.as_deref() {
                captured.insert("ResultLocationFolder", value);
            }
        }
        if requested.should_capture("ResultEncryptionMode") {
            if let ::std::option::Option::Some(value) = input.result_encryption_mode.as_deref() {
                captured.insert("ResultEncryptionMode", value);
            }
        }
        if requested.should_capture("ResultKmsKeyArn") {
            if let ::std::option::Option::Some(value) = input.result_kms_key_arn.as_deref() {
                captured.insert("ResultKmsKeyArn", value);
            }
        }
...
#[derive(Debug)]
struct StartReplicationTaskAssessmentRunResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartReplicationTaskAssessmentRunResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_replication_task_assessment_run::de_start_replication_task_assessment_run_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_replication_task_assessment_run::de_start_replication_task_assessment_run_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct StartReplicationTaskAssessmentRunRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartReplicationTaskAssessmentRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRunInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRunInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_replication_task_assessment_run::ser_start_replication_task_assessment_run_input(&input)?,
        );
...
#[derive(Debug)]
struct StartReplicationTaskAssessmentRunEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartReplicationTaskAssessmentRunEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "StartReplicationTaskAssessmentRunEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartReplicationTaskAssessmentRunInput>()
            .ok_or("failed to downcast to StartReplicationTaskAssessmentRunInput")?;
...
pub enum StartReplicationTaskAssessmentRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartReplicationTaskAssessmentRunError) for what information is available for the error.")]
...
impl StartReplicationTaskAssessmentRunError {
    ...
    /// Creates the `StartReplicationTaskAssessmentRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::KmsFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for StartReplicationTaskAssessmentRunError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::KmsFault(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartReplicationTaskAssessmentRunError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::KmsFault(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartReplicationTaskAssessmentRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRunError {
