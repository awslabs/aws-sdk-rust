...
impl StartReplicationTaskAssessmentRunInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRun::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReplicationTaskAssessmentRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_replication_task_assessment_run::de_start_replication_task_assessment_run_http_response_with_props(
                status, headers, body,
            )
        }
    }
