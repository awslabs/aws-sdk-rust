...
impl DescribeEventsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_events::ser_describe_events_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_events::DescribeEvents::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEvents", "databasemigrationservice"));
