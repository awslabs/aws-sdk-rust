...
impl DescribeMigrationProjectsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_migration_projects::DescribeMigrationProjectsInput, ::aws_smithy_types::error::operation::BuildError> {
