...
impl StartReplicationTaskInput {
    /// Consumes the builder and constructs an Operation<[`StartReplicationTask`](crate::operation::start_replication_task::StartReplicationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_replication_task::StartReplicationTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_replication_task::StartReplicationTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_replication_task::ser_start_replication_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_replication_task::StartReplicationTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartReplicationTask", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartReplicationTask {
                type Output = std::result::Result<crate::operation::start_replication_task::StartReplicationTaskOutput, crate::operation::start_replication_task::StartReplicationTaskError>;
