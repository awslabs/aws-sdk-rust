...
impl StartReplicationTaskInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_replication_task::ser_start_replication_task_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_replication_task::StartReplicationTask::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_replication_task::StartReplicationTaskError
{
