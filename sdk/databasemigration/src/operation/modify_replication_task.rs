...
impl ModifyReplicationTask {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_replication_task::ModifyReplicationTaskError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_replication_task::ModifyReplicationTaskOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.ModifyReplicationTask",
            "rpc.service" = "Database Migration Service",
            "rpc.method" = "ModifyReplicationTask",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyReplicationTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyReplicationTaskRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyReplicationTaskResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyReplicationTask")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyReplicationTask")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyReplicationTaskTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyReplicationTaskTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyReplicationTaskTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyReplicationTaskInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyReplicationTaskResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_replication_task::de_modify_replication_task_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_modify_replication_task::de_modify_replication_task_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyReplicationTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_replication_task::ModifyReplicationTaskInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::modify_replication_task::ModifyReplicationTaskInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_replication_task::ser_modify_replication_task_input(
            &input,
        )?);
