...
impl ModifyReplicationTaskInput {
    /// Consumes the builder and constructs an Operation<[`ModifyReplicationTask`](crate::operation::modify_replication_task::ModifyReplicationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_replication_task::ModifyReplicationTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_replication_task::ModifyReplicationTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_replication_task::ser_modify_replication_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_replication_task::ModifyReplicationTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyReplicationTask", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyReplicationTask {
                type Output = std::result::Result<crate::operation::modify_replication_task::ModifyReplicationTaskOutput, crate::operation::modify_replication_task::ModifyReplicationTaskError>;
