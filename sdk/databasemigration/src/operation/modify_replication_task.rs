...
impl ModifyReplicationTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::modify_replication_task::ModifyReplicationTask,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyReplicationTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_replication_task::de_modify_replication_task_http_response_with_props(status, headers, body)
        }
    }
}
