...
impl DescribeMetadataModelAssessmentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_metadata_model_assessments::DescribeMetadataModelAssessmentsInput, ::aws_smithy_types::error::operation::BuildError> {
