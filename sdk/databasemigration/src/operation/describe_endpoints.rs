...
impl DescribeEndpointsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_endpoints::DescribeEndpoints::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DescribeEndpoints", "databasemigrationservice"),
        );
