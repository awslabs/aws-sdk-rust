...
impl DeleteReplicationTaskInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReplicationTask`](crate::operation::delete_replication_task::DeleteReplicationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_replication_task::DeleteReplicationTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_replication_task::DeleteReplicationTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_replication_task::ser_delete_replication_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_replication_task::DeleteReplicationTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteReplicationTask", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteReplicationTask {
                type Output = std::result::Result<crate::operation::delete_replication_task::DeleteReplicationTaskOutput, crate::operation::delete_replication_task::DeleteReplicationTaskError>;
