...
impl DescribeFleetAdvisorLsaAnalysisInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysisInput, ::aws_smithy_types::error::operation::BuildError> {
