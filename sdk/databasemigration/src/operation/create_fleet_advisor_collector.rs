...
impl CreateFleetAdvisorCollectorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollector::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFleetAdvisorCollector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_fleet_advisor_collector::de_create_fleet_advisor_collector_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateFleetAdvisorCollectorError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError
{
