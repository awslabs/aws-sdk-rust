...
impl CreateFleetAdvisorCollectorInput {
    /// Consumes the builder and constructs an Operation<[`CreateFleetAdvisorCollector`](crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollector)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollector, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_fleet_advisor_collector::ser_create_fleet_advisor_collector_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollector::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateFleetAdvisorCollector", "databasemigrationservice"));
