...
/// Orchestration and serialization glue logic for `CreateFleetAdvisorCollector`.
...
impl CreateFleetAdvisorCollector {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFleetAdvisorCollector {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateFleetAdvisorCollector");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateFleetAdvisorCollectorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateFleetAdvisorCollectorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateFleetAdvisorCollector")
...
.with_interceptor(CreateFleetAdvisorCollectorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError>::new());
...
#[derive(Debug)]
            struct CreateFleetAdvisorCollectorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFleetAdvisorCollectorResponseDeserializer {
...
#[derive(Debug)]
            struct CreateFleetAdvisorCollectorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateFleetAdvisorCollectorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_fleet_advisor_collector::ser_create_fleet_advisor_collector_input(&input)?);
...
#[derive(Debug)]
            struct CreateFleetAdvisorCollectorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFleetAdvisorCollectorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateFleetAdvisorCollectorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateFleetAdvisorCollectorInput>()
                        .ok_or("failed to downcast to CreateFleetAdvisorCollectorInput")?;
...
pub enum CreateFleetAdvisorCollectorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateFleetAdvisorCollectorError) for what information is available for the error.")]
...
impl CreateFleetAdvisorCollectorError {
    /// Creates the `CreateFleetAdvisorCollectorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFleetAdvisorCollectorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateFleetAdvisorCollectorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorError {
...
mod _create_fleet_advisor_collector_output;
