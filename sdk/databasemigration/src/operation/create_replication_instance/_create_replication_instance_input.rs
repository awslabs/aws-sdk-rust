...
impl CreateReplicationInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_replication_instance::CreateReplicationInstanceInput, ::aws_smithy_types::error::operation::BuildError> {
