...
impl ApplyPendingMaintenanceActionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::apply_pending_maintenance_action::ApplyPendingMaintenanceAction::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApplyPendingMaintenanceAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_apply_pending_maintenance_action::de_apply_pending_maintenance_action_http_response_with_props(
                status, headers, body,
            )
        }
    }
