...
impl DescribeMetadataModelConversionsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::describe_metadata_model_conversions::DescribeMetadataModelConversionsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::describe_metadata_model_conversions::paginator::DescribeMetadataModelConversionsPaginator::send) which returns a `Stream`.
