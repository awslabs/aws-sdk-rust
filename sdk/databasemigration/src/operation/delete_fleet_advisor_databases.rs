...
impl DeleteFleetAdvisorDatabasesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabases::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFleetAdvisorDatabases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_fleet_advisor_databases::de_delete_fleet_advisor_databases_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteFleetAdvisorDatabasesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError
{
