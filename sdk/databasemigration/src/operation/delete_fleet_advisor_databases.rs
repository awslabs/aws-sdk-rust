...
impl DeleteFleetAdvisorDatabases {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesInput,
                    ) -> ::std::result::Result<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFleetAdvisorDatabases {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFleetAdvisorDatabases");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFleetAdvisorDatabasesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFleetAdvisorDatabasesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFleetAdvisorDatabases")
...
.with_interceptor(DeleteFleetAdvisorDatabasesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError>::new());
...
#[derive(Debug)]
            struct DeleteFleetAdvisorDatabasesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFleetAdvisorDatabasesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_fleet_advisor_databases::de_delete_fleet_advisor_databases_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteFleetAdvisorDatabasesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFleetAdvisorDatabasesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_fleet_advisor_databases::ser_delete_fleet_advisor_databases_input(&input)?);
...
#[derive(Debug)]
            struct DeleteFleetAdvisorDatabasesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFleetAdvisorDatabasesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFleetAdvisorDatabasesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFleetAdvisorDatabasesInput>()
                        .ok_or("failed to downcast to DeleteFleetAdvisorDatabasesInput")?;
...
pub enum DeleteFleetAdvisorDatabasesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFleetAdvisorDatabasesError) for what information is available for the error.")]
...
impl DeleteFleetAdvisorDatabasesError {
    /// Creates the `DeleteFleetAdvisorDatabasesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFleetAdvisorDatabasesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFleetAdvisorDatabasesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_fleet_advisor_databases::_delete_fleet_advisor_databases_output::DeleteFleetAdvisorDatabasesOutput;

pub use crate::operation::delete_fleet_advisor_databases::_delete_fleet_advisor_databases_input::DeleteFleetAdvisorDatabasesInput;

mod _delete_fleet_advisor_databases_input;

mod _delete_fleet_advisor_databases_output;
