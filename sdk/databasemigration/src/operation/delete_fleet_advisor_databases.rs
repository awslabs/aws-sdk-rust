...
impl DeleteFleetAdvisorDatabasesInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFleetAdvisorDatabases`](crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabases)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabases, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_fleet_advisor_databases::ser_delete_fleet_advisor_databases_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabases::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteFleetAdvisorDatabases", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFleetAdvisorDatabases {
                type Output = std::result::Result<crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesOutput, crate::operation::delete_fleet_advisor_databases::DeleteFleetAdvisorDatabasesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_fleet_advisor_databases::de_delete_fleet_advisor_databases_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_fleet_advisor_databases::de_delete_fleet_advisor_databases_http_response(response)
                     }
                }
            }
