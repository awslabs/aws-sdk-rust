...
impl CreateEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_endpoint::CreateEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_endpoint::ser_create_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_endpoint::de_create_endpoint_http_response_with_props(status, headers, body)
        }
    }
