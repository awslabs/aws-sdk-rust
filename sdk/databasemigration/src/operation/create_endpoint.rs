...
impl CreateEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_endpoint::CreateEndpointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_endpoint::CreateEndpointOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.CreateEndpoint",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateEndpointRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateEndpointResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateEndpoint")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateEndpointTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateEndpointTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateEndpointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateEndpointInput>() else {
        ...
        if requested.should_capture("EngineName") {
            if let ::std::option::Option::Some(value) = input.engine_name.as_deref() {
                captured.insert("EngineName", value);
            }
        }
        ...
        if requested.should_capture("ExtraConnectionAttributes") {
            if let ::std::option::Option::Some(value) = input.extra_connection_attributes.as_deref() {
                captured.insert("ExtraConnectionAttributes", value);
            }
        }
        ...
        if requested.should_capture("ExternalTableDefinition") {
            if let ::std::option::Option::Some(value) = input.external_table_definition.as_deref() {
                captured.insert("ExternalTableDefinition", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEndpointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_endpoint::de_create_endpoint_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_endpoint::de_create_endpoint_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_endpoint::CreateEndpointInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_endpoint::CreateEndpointInput,
...
impl ::aws_types::request_id::RequestId for crate::operation::create_endpoint::CreateEndpointError {
