...
impl DescribeFleetAdvisorLsaAnalysisInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysis::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetAdvisorLsaAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_advisor_lsa_analysis::de_describe_fleet_advisor_lsa_analysis_http_response_with_props(
                status, headers, body,
            )
        }
    }
