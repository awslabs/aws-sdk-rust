...
/// Orchestration and serialization glue logic for `DeleteReplicationTaskAssessmentRun`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteReplicationTaskAssessmentRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteReplicationTaskAssessmentRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteReplicationTaskAssessmentRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteReplicationTaskAssessmentRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteReplicationTaskAssessmentRun")
...
.with_interceptor(DeleteReplicationTaskAssessmentRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunError>::new());
...
#[derive(Debug)]
            struct DeleteReplicationTaskAssessmentRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteReplicationTaskAssessmentRunResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_replication_task_assessment_run::de_delete_replication_task_assessment_run_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_replication_task_assessment_run::de_delete_replication_task_assessment_run_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteReplicationTaskAssessmentRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteReplicationTaskAssessmentRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_replication_task_assessment_run::ser_delete_replication_task_assessment_run_input(&input)?);
...
#[derive(Debug)]
            struct DeleteReplicationTaskAssessmentRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteReplicationTaskAssessmentRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteReplicationTaskAssessmentRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteReplicationTaskAssessmentRunInput>()
                        .ok_or("failed to downcast to DeleteReplicationTaskAssessmentRunInput")?;
...
pub enum DeleteReplicationTaskAssessmentRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteReplicationTaskAssessmentRunError) for what information is available for the error.")]
...
impl DeleteReplicationTaskAssessmentRunError {
    /// Creates the `DeleteReplicationTaskAssessmentRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteReplicationTaskAssessmentRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteReplicationTaskAssessmentRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_replication_task_assessment_run::_delete_replication_task_assessment_run_output::DeleteReplicationTaskAssessmentRunOutput;

pub use crate::operation::delete_replication_task_assessment_run::_delete_replication_task_assessment_run_input::DeleteReplicationTaskAssessmentRunInput;

mod _delete_replication_task_assessment_run_input;

mod _delete_replication_task_assessment_run_output;
