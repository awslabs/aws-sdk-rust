...
impl DeleteReplicationTaskAssessmentRunInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReplicationTaskAssessmentRun`](crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_replication_task_assessment_run::ser_delete_replication_task_assessment_run_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteReplicationTaskAssessmentRun", "databasemigrationservice"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReplicationTaskAssessmentRun {
    type Output = ::std::result::Result<crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunOutput, crate::operation::delete_replication_task_assessment_run::DeleteReplicationTaskAssessmentRunError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_replication_task_assessment_run::de_delete_replication_task_assessment_run_http_response_with_props(status, headers, body)
        }
    }
}
