...
impl DescribeInstanceProfilesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_instance_profiles::DescribeInstanceProfilesInput, ::aws_smithy_types::error::operation::BuildError> {
