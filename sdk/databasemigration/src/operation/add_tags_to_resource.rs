...
impl AddTagsToResourceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_tags_to_resource::AddTagsToResource::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("AddTagsToResource", "databasemigrationservice"),
            );
