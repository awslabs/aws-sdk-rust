...
impl StartReplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_replication::StartReplication::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("StartReplication", "databasemigrationservice"),
        );
