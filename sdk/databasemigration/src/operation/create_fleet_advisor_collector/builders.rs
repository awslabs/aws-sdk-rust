...
impl crate::operation::create_fleet_advisor_collector::builders::CreateFleetAdvisorCollectorInputBuilder {
...
impl CreateFleetAdvisorCollectorFluentBuilder {
    /// Creates a new `CreateFleetAdvisorCollectorFluentBuilder`.
