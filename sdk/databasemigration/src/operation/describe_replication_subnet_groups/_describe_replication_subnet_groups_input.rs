...
impl DescribeReplicationSubnetGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
