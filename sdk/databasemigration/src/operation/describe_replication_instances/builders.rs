...
impl DescribeReplicationInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_replication_instances::DescribeReplicationInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_replication_instances::DescribeReplicationInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_replication_instances::DescribeReplicationInstancesOutput, crate::operation::describe_replication_instances::DescribeReplicationInstancesError, Self> {
