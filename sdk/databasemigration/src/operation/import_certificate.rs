...
impl ImportCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_certificate::ImportCertificate::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("ImportCertificate", "databasemigrationservice"),
        );
