...
impl DescribeExtensionPackAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
