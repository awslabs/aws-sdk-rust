...
impl DescribeExtensionPackAssociationsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::describe_extension_pack_associations::DescribeExtensionPackAssociationsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::describe_extension_pack_associations::paginator::DescribeExtensionPackAssociationsPaginator::send) which returns a `Stream`.
