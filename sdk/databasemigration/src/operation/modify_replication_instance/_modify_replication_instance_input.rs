...
impl ModifyReplicationInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_replication_instance::ModifyReplicationInstanceInput, ::aws_smithy_types::error::operation::BuildError> {
