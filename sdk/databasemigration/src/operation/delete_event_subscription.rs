...
impl DeleteEventSubscription {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.DeleteEventSubscription",
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteEventSubscriptionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_event_subscription::ser_delete_event_subscription_input(&input)?,
        );
...
impl DeleteEventSubscriptionError {
    ...
    /// Returns `true` if the error kind is `DeleteEventSubscriptionError::AccessDeniedFault`.
