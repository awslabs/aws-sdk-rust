...
impl ModifyReplicationConfigInput {
    /// Consumes the builder and constructs an Operation<[`ModifyReplicationConfig`](crate::operation::modify_replication_config::ModifyReplicationConfig)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_replication_config::ser_modify_replication_config_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_replication_config::ModifyReplicationConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyReplicationConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_replication_config::de_modify_replication_config_http_response_with_props(status, headers, body)
        }
    }
}
