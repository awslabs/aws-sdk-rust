...
impl ModifyReplicationConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_replication_config::ModifyReplicationConfig::new(),
        )
...
/// `ParseStrictResponse` impl for `ModifyReplicationConfig`.
...
impl ::aws_http::request_id::RequestId
    for crate::operation::modify_replication_config::ModifyReplicationConfigError
{
