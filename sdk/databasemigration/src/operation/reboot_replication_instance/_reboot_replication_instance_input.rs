...
impl RebootReplicationInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reboot_replication_instance::RebootReplicationInstanceInput, ::aws_smithy_types::error::operation::BuildError> {
