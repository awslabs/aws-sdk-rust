    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroupsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeReplicationSubnetGroupsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeReplicationSubnetGroupsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeReplicationSubnetGroupsEndpointParamsInterceptor {
