...
impl DescribeReplicationSubnetGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_replication_subnet_groups::DescribeReplicationSubnetGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplicationSubnetGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_subnet_groups::de_describe_replication_subnet_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
