...
impl CreateReplicationConfigInput {
    /// Consumes the builder and constructs an Operation<[`CreateReplicationConfig`](crate::operation::create_replication_config::CreateReplicationConfig)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_replication_config::ser_create_replication_config_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_replication_config::CreateReplicationConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateReplicationConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_replication_config::de_create_replication_config_http_response_with_props(status, headers, body)
        }
    }
}
