...
/// Orchestration and serialization glue logic for `DeleteFleetAdvisorCollector`.
...
impl DeleteFleetAdvisorCollector {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFleetAdvisorCollector {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFleetAdvisorCollector");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFleetAdvisorCollectorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFleetAdvisorCollectorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFleetAdvisorCollector")
...
.with_interceptor(DeleteFleetAdvisorCollectorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError>::new());
...
#[derive(Debug)]
            struct DeleteFleetAdvisorCollectorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFleetAdvisorCollectorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_fleet_advisor_collector::de_delete_fleet_advisor_collector_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_fleet_advisor_collector::de_delete_fleet_advisor_collector_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFleetAdvisorCollectorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFleetAdvisorCollectorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_fleet_advisor_collector::ser_delete_fleet_advisor_collector_input(&input)?);
...
#[derive(Debug)]
            struct DeleteFleetAdvisorCollectorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFleetAdvisorCollectorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFleetAdvisorCollectorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFleetAdvisorCollectorInput>()
                        .ok_or("failed to downcast to DeleteFleetAdvisorCollectorInput")?;
...
pub enum DeleteFleetAdvisorCollectorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFleetAdvisorCollectorError) for what information is available for the error.")]
...
impl DeleteFleetAdvisorCollectorError {
    /// Creates the `DeleteFleetAdvisorCollectorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFleetAdvisorCollectorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CollectorNotFoundFault(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFleetAdvisorCollectorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError {
...
mod _delete_fleet_advisor_collector_output;
