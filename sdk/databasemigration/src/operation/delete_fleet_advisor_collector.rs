...
impl DeleteFleetAdvisorCollectorInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFleetAdvisorCollector`](crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollector)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollector, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollector::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFleetAdvisorCollector {
                type Output = std::result::Result<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorOutput, crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError>;
