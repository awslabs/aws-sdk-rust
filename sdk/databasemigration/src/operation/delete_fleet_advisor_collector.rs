...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFleetAdvisorCollector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_fleet_advisor_collector::de_delete_fleet_advisor_collector_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteFleetAdvisorCollectorError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError
{
