...
impl DeleteFleetAdvisorCollectorInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollector::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFleetAdvisorCollector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_fleet_advisor_collector::de_delete_fleet_advisor_collector_http_response_with_props(
                status, headers, body,
            )
        }
    }
