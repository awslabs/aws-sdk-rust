...
impl UpdateSubscriptionsToEventBridgeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridge::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSubscriptionsToEventBridge {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_subscriptions_to_event_bridge::de_update_subscriptions_to_event_bridge_http_response_with_props(
                status, headers, body,
            )
        }
    }
