...
impl StartRecommendationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_recommendations::ser_start_recommendations_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_recommendations::StartRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_recommendations::de_start_recommendations_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_recommendations::StartRecommendationsError
{
