...
#[non_exhaustive]
pub struct StartRecommendations;
impl StartRecommendations {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_recommendations::StartRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_recommendations::StartRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_recommendations::StartRecommendationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_recommendations::StartRecommendationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartRecommendations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartRecommendations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartRecommendationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartRecommendationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartRecommendations")
...
.with_interceptor(StartRecommendationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_recommendations::StartRecommendationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_recommendations::StartRecommendationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_recommendations::StartRecommendationsError>::new());
...
#[derive(Debug)]
            struct StartRecommendationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartRecommendationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_recommendations::de_start_recommendations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_recommendations::de_start_recommendations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartRecommendationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartRecommendationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_recommendations::StartRecommendationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_recommendations::StartRecommendationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_recommendations::ser_start_recommendations_input(&input)?);
...
#[derive(Debug)]
            struct StartRecommendationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartRecommendationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartRecommendationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartRecommendationsInput>()
                        .ok_or("failed to downcast to StartRecommendationsInput")?;
...
/// Error type for the `StartRecommendationsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartRecommendationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartRecommendationsError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartRecommendationsError {
    /// Creates the `StartRecommendationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartRecommendationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartRecommendationsError::AccessDeniedFault`.
    pub fn is_access_denied_fault(&self) -> bool {
        matches!(self, Self::AccessDeniedFault(_))
    }
    /// Returns `true` if the error kind is `StartRecommendationsError::InvalidResourceStateFault`.
    pub fn is_invalid_resource_state_fault(&self) -> bool {
        matches!(self, Self::InvalidResourceStateFault(_))
    }
    /// Returns `true` if the error kind is `StartRecommendationsError::ResourceNotFoundFault`.
    pub fn is_resource_not_found_fault(&self) -> bool {
        matches!(self, Self::ResourceNotFoundFault(_))
    }
}
impl ::std::error::Error for StartRecommendationsError {
...
impl ::std::fmt::Display for StartRecommendationsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartRecommendationsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartRecommendationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartRecommendationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_recommendations::StartRecommendationsError {
...
mod _start_recommendations_output;
