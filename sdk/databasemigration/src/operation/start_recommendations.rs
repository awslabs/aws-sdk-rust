    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_recommendations::StartRecommendationsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_recommendations::StartRecommendationsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartRecommendationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartRecommendationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_recommendations::StartRecommendationsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_recommendations::ser_start_recommendations_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartRecommendationsEndpointParamsInterceptor {
...
pub type StartRecommendationsErrorKind = StartRecommendationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartRecommendationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_recommendations::StartRecommendationsError {
...
impl StartRecommendationsError {
    ...
    /// Creates the `StartRecommendationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
