...
impl StopReplicationTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_replication_task::StopReplicationTask::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("StopReplicationTask", "databasemigrationservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopReplicationTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_replication_task::de_stop_replication_task_http_response_with_props(status, headers, body)
        }
    }
}
