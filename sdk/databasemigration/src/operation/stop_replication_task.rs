...
impl StopReplicationTaskInput {
    /// Consumes the builder and constructs an Operation<[`StopReplicationTask`](crate::operation::stop_replication_task::StopReplicationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_replication_task::StopReplicationTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_replication_task::StopReplicationTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_replication_task::ser_stop_replication_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_replication_task::StopReplicationTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopReplicationTask", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopReplicationTask {
                type Output = std::result::Result<crate::operation::stop_replication_task::StopReplicationTaskOutput, crate::operation::stop_replication_task::StopReplicationTaskError>;
