...
impl StopReplicationTaskInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_replication_task::ser_stop_replication_task_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_replication_task::StopReplicationTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopReplicationTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_replication_task::de_stop_replication_task_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::stop_replication_task::StopReplicationTaskError
{
