...
impl DescribeFleetAdvisorDatabases {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeFleetAdvisorDatabases {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeFleetAdvisorDatabases");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeFleetAdvisorDatabasesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeFleetAdvisorDatabasesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeFleetAdvisorDatabases")
...
.with_interceptor(DescribeFleetAdvisorDatabasesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError>::new());
...
#[derive(Debug)]
            struct DescribeFleetAdvisorDatabasesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeFleetAdvisorDatabasesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_describe_fleet_advisor_databases::de_describe_fleet_advisor_databases_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeFleetAdvisorDatabasesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeFleetAdvisorDatabasesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_fleet_advisor_databases::ser_describe_fleet_advisor_databases_input(&input)?);
...
#[derive(Debug)]
            struct DescribeFleetAdvisorDatabasesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeFleetAdvisorDatabasesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeFleetAdvisorDatabasesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeFleetAdvisorDatabasesInput>()
                        .ok_or("failed to downcast to DescribeFleetAdvisorDatabasesInput")?;
...
pub enum DescribeFleetAdvisorDatabasesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeFleetAdvisorDatabasesError) for what information is available for the error.")]
...
impl DescribeFleetAdvisorDatabasesError {
    /// Creates the `DescribeFleetAdvisorDatabasesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFleetAdvisorDatabasesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeFleetAdvisorDatabasesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError {
