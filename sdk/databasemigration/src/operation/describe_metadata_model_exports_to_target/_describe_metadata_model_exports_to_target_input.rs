...
impl DescribeMetadataModelExportsToTargetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_metadata_model_exports_to_target::DescribeMetadataModelExportsToTargetInput, ::aws_smithy_types::error::operation::BuildError> {
