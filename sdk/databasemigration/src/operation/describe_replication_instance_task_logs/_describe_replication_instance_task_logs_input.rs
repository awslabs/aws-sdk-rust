...
impl DescribeReplicationInstanceTaskLogsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_replication_instance_task_logs::DescribeReplicationInstanceTaskLogsInput, ::aws_smithy_types::error::operation::BuildError> {
