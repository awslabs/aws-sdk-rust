...
impl ModifyDataProviderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::modify_data_provider::ModifyDataProviderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_data_provider::ModifyDataProviderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::modify_data_provider::ModifyDataProviderOutput, crate::operation::modify_data_provider::ModifyDataProviderError, Self> {
