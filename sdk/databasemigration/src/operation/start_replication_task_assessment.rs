...
/// Orchestration and serialization glue logic for `StartReplicationTaskAssessment`.
...
impl StartReplicationTaskAssessment {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartReplicationTaskAssessment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartReplicationTaskAssessment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartReplicationTaskAssessmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartReplicationTaskAssessmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartReplicationTaskAssessment")
...
.with_interceptor(StartReplicationTaskAssessmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError>::new());
...
#[derive(Debug)]
            struct StartReplicationTaskAssessmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartReplicationTaskAssessmentResponseDeserializer {
...
#[derive(Debug)]
            struct StartReplicationTaskAssessmentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartReplicationTaskAssessmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_replication_task_assessment::ser_start_replication_task_assessment_input(&input)?);
...
#[derive(Debug)]
            struct StartReplicationTaskAssessmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartReplicationTaskAssessmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartReplicationTaskAssessmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartReplicationTaskAssessmentInput>()
                        .ok_or("failed to downcast to StartReplicationTaskAssessmentInput")?;
...
pub enum StartReplicationTaskAssessmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartReplicationTaskAssessmentError) for what information is available for the error.")]
...
impl StartReplicationTaskAssessmentError {
    /// Creates the `StartReplicationTaskAssessmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartReplicationTaskAssessmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartReplicationTaskAssessmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError {
...
mod _start_replication_task_assessment_output;
