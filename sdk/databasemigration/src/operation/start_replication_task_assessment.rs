...
impl StartReplicationTaskAssessmentInput {
    /// Consumes the builder and constructs an Operation<[`StartReplicationTaskAssessment`](crate::operation::start_replication_task_assessment::StartReplicationTaskAssessment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_replication_task_assessment::ser_start_replication_task_assessment_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_replication_task_assessment::StartReplicationTaskAssessment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartReplicationTaskAssessment", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartReplicationTaskAssessment {
                type Output = std::result::Result<crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentOutput, crate::operation::start_replication_task_assessment::StartReplicationTaskAssessmentError>;
