...
impl StartMetadataModelAssessmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_metadata_model_assessment::StartMetadataModelAssessmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_metadata_model_assessment::StartMetadataModelAssessmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_metadata_model_assessment::StartMetadataModelAssessmentOutput, crate::operation::start_metadata_model_assessment::StartMetadataModelAssessmentError, Self> {
