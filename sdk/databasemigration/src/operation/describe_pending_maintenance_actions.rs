...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_pending_maintenance_actions::ser_describe_pending_maintenance_actions_input(&input)?);
