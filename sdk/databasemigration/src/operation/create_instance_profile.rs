...
impl CreateInstanceProfile {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Database Migration Service.CreateInstanceProfile",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AmazonDMSv20160101.CreateInstanceProfile",
            );
            builder
        };
...
impl CreateInstanceProfileError {
    ...
    /// Returns `true` if the error kind is `CreateInstanceProfileError::AccessDeniedFault`.
    pub fn is_access_denied_fault(&self) -> bool {
        matches!(self, Self::AccessDeniedFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::FailedDependencyFault`.
    pub fn is_failed_dependency_fault(&self) -> bool {
        matches!(self, Self::FailedDependencyFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::InvalidResourceStateFault`.
    pub fn is_invalid_resource_state_fault(&self) -> bool {
        matches!(self, Self::InvalidResourceStateFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::KmsKeyNotAccessibleFault`.
    pub fn is_kms_key_not_accessible_fault(&self) -> bool {
        matches!(self, Self::KmsKeyNotAccessibleFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::ResourceAlreadyExistsFault`.
    pub fn is_resource_already_exists_fault(&self) -> bool {
        matches!(self, Self::ResourceAlreadyExistsFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::ResourceNotFoundFault`.
    pub fn is_resource_not_found_fault(&self) -> bool {
        matches!(self, Self::ResourceNotFoundFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::ResourceQuotaExceededFault`.
    pub fn is_resource_quota_exceeded_fault(&self) -> bool {
        matches!(self, Self::ResourceQuotaExceededFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::S3AccessDeniedFault`.
    pub fn is_s3_access_denied_fault(&self) -> bool {
        matches!(self, Self::S3AccessDeniedFault(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileError::S3ResourceNotFoundFault`.
