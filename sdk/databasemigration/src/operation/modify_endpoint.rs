...
impl ModifyEndpointInput {
    /// Consumes the builder and constructs an Operation<[`ModifyEndpoint`](crate::operation::modify_endpoint::ModifyEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_endpoint::ModifyEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_endpoint::ModifyEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_endpoint::ser_modify_endpoint_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_endpoint::ModifyEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyEndpoint", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyEndpoint {
                type Output = std::result::Result<crate::operation::modify_endpoint::ModifyEndpointOutput, crate::operation::modify_endpoint::ModifyEndpointError>;
