...
impl ModifyEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_endpoint::ModifyEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_endpoint::ser_modify_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_endpoint::de_modify_endpoint_http_response_with_props(status, headers, body)
        }
    }
