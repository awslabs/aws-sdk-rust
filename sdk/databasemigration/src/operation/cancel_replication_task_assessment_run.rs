...
impl CancelReplicationTaskAssessmentRunInput {
    /// Consumes the builder and constructs an Operation<[`CancelReplicationTaskAssessmentRun`](crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_replication_task_assessment_run::ser_cancel_replication_task_assessment_run_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelReplicationTaskAssessmentRun", "databasemigrationservice"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelReplicationTaskAssessmentRun {
    type Output = ::std::result::Result<crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunOutput, crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_replication_task_assessment_run::de_cancel_replication_task_assessment_run_http_response_with_props(status, headers, body)
        }
    }
}
