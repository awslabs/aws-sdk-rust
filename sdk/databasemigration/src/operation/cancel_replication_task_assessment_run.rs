...
impl CancelReplicationTaskAssessmentRunInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRun::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelReplicationTaskAssessmentRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_replication_task_assessment_run::de_cancel_replication_task_assessment_run_http_response_with_props(
                status, headers, body,
            )
        }
    }
