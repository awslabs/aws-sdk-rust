...
impl DeleteFleetAdvisorCollectorFluentBuilder  {
    /// Creates a new `DeleteFleetAdvisorCollector`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorOutput, aws_smithy_http::result::SdkError<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorError>>
                     {
