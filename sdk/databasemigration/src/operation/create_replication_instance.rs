...
impl CreateReplicationInstanceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_replication_instance::CreateReplicationInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateReplicationInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_replication_instance::de_create_replication_instance_http_response_with_props(status, headers, body)
        }
    }
}
