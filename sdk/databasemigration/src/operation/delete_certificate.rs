...
impl DeleteCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_certificate::DeleteCertificate::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DeleteCertificate", "databasemigrationservice"),
        );
