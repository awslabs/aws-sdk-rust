...
impl DescribeReplicationTaskIndividualAssessmentsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReplicationTaskIndividualAssessments`](crate::operation::describe_replication_task_individual_assessments::DescribeReplicationTaskIndividualAssessments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_replication_task_individual_assessments::DescribeReplicationTaskIndividualAssessments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        assert_ne!(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_replication_task_individual_assessments::ser_describe_replication_task_individual_assessments_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_replication_task_individual_assessments::DescribeReplicationTaskIndividualAssessments::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeReplicationTaskIndividualAssessments", "databasemigrationservice"));
...
{
    type Output = ::std::result::Result<crate::operation::describe_replication_task_individual_assessments::DescribeReplicationTaskIndividualAssessmentsOutput, crate::operation::describe_replication_task_individual_assessments::DescribeReplicationTaskIndividualAssessmentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_task_individual_assessments::de_describe_replication_task_individual_assessments_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_replication_task_individual_assessments::DescribeReplicationTaskIndividualAssessmentsError {
