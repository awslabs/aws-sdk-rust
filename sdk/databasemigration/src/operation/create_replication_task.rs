...
/// Orchestration and serialization glue logic for `CreateReplicationTask`.
...
impl CreateReplicationTask {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_replication_task::CreateReplicationTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_replication_task::CreateReplicationTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_replication_task::CreateReplicationTaskError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_replication_task::CreateReplicationTaskOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateReplicationTask {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateReplicationTask");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateReplicationTaskRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateReplicationTaskResponseDeserializer));
...
.with_interceptor(CreateReplicationTaskEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_replication_task::CreateReplicationTaskError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_replication_task::CreateReplicationTaskError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_replication_task::CreateReplicationTaskError>::new());
...
#[derive(Debug)]
            struct CreateReplicationTaskRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateReplicationTaskRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_replication_task::CreateReplicationTaskInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_replication_task::CreateReplicationTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_replication_task::ser_create_replication_task_input(&input)?);
...
#[derive(Debug)]
            struct CreateReplicationTaskEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateReplicationTaskEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateReplicationTaskEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateReplicationTaskInput>()
                        .ok_or("failed to downcast to CreateReplicationTaskInput")?;
...
pub enum CreateReplicationTaskError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateReplicationTaskError) for what information is available for the error.")]
...
impl CreateReplicationTaskError {
    /// Creates the `CreateReplicationTaskError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateReplicationTaskError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateReplicationTaskError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_replication_task::CreateReplicationTaskError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_replication_task::_create_replication_task_output::CreateReplicationTaskOutput;

pub use crate::operation::create_replication_task::_create_replication_task_input::CreateReplicationTaskInput;

mod _create_replication_task_input;

mod _create_replication_task_output;
