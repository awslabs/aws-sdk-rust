...
impl CreateReplicationTaskInput {
    /// Consumes the builder and constructs an Operation<[`CreateReplicationTask`](crate::operation::create_replication_task::CreateReplicationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_replication_task::CreateReplicationTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_replication_task::CreateReplicationTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_replication_task::ser_create_replication_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_replication_task::CreateReplicationTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateReplicationTask", "databasemigrationservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReplicationTask {
                type Output = std::result::Result<crate::operation::create_replication_task::CreateReplicationTaskOutput, crate::operation::create_replication_task::CreateReplicationTaskError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_replication_task::de_create_replication_task_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_replication_task::de_create_replication_task_http_response(response)
                     }
                }
            }
