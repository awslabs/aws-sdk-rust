...
pub fn serialize_structure_crate_input_apply_pending_maintenance_action_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ApplyPendingMaintenanceActionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_cancel_replication_task_assessment_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CancelReplicationTaskAssessmentRunInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_event_subscription_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEventSubscriptionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_fleet_advisor_collector_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFleetAdvisorCollectorInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_replication_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReplicationInstanceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_replication_subnet_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReplicationSubnetGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_103) = &input.replication_subnet_group_identifier {
        object.key("ReplicationSubnetGroupIdentifier").string(var_103.as_str());
    }
    if let Some(var_104) = &input.replication_subnet_group_description {
        object.key("ReplicationSubnetGroupDescription").string(var_104.as_str());
    }
...
pub fn serialize_structure_crate_input_create_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReplicationTaskInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_112) = &input.replication_task_identifier {
        object.key("ReplicationTaskIdentifier").string(var_112.as_str());
    }
    ...
    if let Some(var_115) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_115.as_str());
    }
    ...
    if let Some(var_118) = &input.replication_task_settings {
        object.key("ReplicationTaskSettings").string(var_118.as_str());
    }
    if let Some(var_119) = &input.cdc_start_time {
        object.key("CdcStartTime").date_time(var_119, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_delete_connection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteConnectionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_130) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_130.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_delete_event_subscription_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteEventSubscriptionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_fleet_advisor_collector_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteFleetAdvisorCollectorInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_fleet_advisor_databases_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteFleetAdvisorDatabasesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_replication_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteReplicationInstanceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_137) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_137.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_delete_replication_subnet_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteReplicationSubnetGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_138) = &input.replication_subnet_group_identifier {
        object.key("ReplicationSubnetGroupIdentifier").string(var_138.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_delete_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteReplicationTaskInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_delete_replication_task_assessment_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteReplicationTaskAssessmentRunInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_140) = &input.replication_task_assessment_run_arn {
        object.key("ReplicationTaskAssessmentRunArn").string(var_140.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_describe_applicable_individual_assessments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeApplicableIndividualAssessmentsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_142) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_142.as_str());
    }
    ...
    if let Some(var_146) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_146).into()));
    }
...
pub fn serialize_structure_crate_input_describe_certificates_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeCertificatesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_152) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_152).into()));
    }
...
pub fn serialize_structure_crate_input_describe_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeConnectionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_158) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_158).into()));
    }
...
pub fn serialize_structure_crate_input_describe_endpoints_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEndpointsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_164) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_164).into()));
    }
...
pub fn serialize_structure_crate_input_describe_endpoint_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEndpointSettingsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_166) = &input.engine_name {
        object.key("EngineName").string(var_166.as_str());
    }
    if let Some(var_167) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_167).into()));
    }
...
pub fn serialize_structure_crate_input_describe_endpoint_types_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEndpointTypesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_173) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_173).into()));
    }
...
pub fn serialize_structure_crate_input_describe_event_categories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEventCategoriesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEventsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_182) = &input.start_time {
        object.key("StartTime").date_time(var_182, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_183) = &input.end_time {
        object.key("EndTime").date_time(var_183, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_184) = &input.duration {
        object.key("Duration").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_184).into()));
    }
    ...
    if let Some(var_192) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_192).into()));
    }
...
pub fn serialize_structure_crate_input_describe_event_subscriptions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEventSubscriptionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_199) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_199).into()));
    }
...
pub fn serialize_structure_crate_input_describe_fleet_advisor_collectors_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetAdvisorCollectorsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_205) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_205).into()));
    }
...
pub fn serialize_structure_crate_input_describe_fleet_advisor_databases_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetAdvisorDatabasesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_211) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_211).into()));
    }
...
pub fn serialize_structure_crate_input_describe_fleet_advisor_lsa_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetAdvisorLsaAnalysisInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_213) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_213).into()));
    }
...
pub fn serialize_structure_crate_input_describe_fleet_advisor_schema_object_summary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetAdvisorSchemaObjectSummaryInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_219) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_219).into()));
    }
...
pub fn serialize_structure_crate_input_describe_fleet_advisor_schemas_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetAdvisorSchemasInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_225) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_225).into()));
    }
...
pub fn serialize_structure_crate_input_describe_orderable_replication_instances_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeOrderableReplicationInstancesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_227) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_227).into()));
    }
...
pub fn serialize_structure_crate_input_describe_pending_maintenance_actions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePendingMaintenanceActionsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_229) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_229.as_str());
    }
    ...
    if let Some(var_235) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_235).into()));
    }
    Ok(())
}

pub fn serialize_structure_crate_input_describe_refresh_schemas_status_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeRefreshSchemasStatusInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_describe_replication_instances_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationInstancesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_241) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_241).into()));
    }
...
pub fn serialize_structure_crate_input_describe_replication_instance_task_logs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationInstanceTaskLogsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_243) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_243.as_str());
    }
    if let Some(var_244) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_244).into()));
    }
...
pub fn serialize_structure_crate_input_describe_replication_subnet_groups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationSubnetGroupsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_250) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_250).into()));
    }
...
pub fn serialize_structure_crate_input_describe_replication_task_assessment_results_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationTaskAssessmentResultsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_253) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_253).into()));
    }
...
pub fn serialize_structure_crate_input_describe_replication_task_assessment_runs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationTaskAssessmentRunsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_259) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_259).into()));
    }
...
pub fn serialize_structure_crate_input_describe_replication_task_individual_assessments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationTaskIndividualAssessmentsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_265) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_265).into()));
    }
...
pub fn serialize_structure_crate_input_describe_replication_tasks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeReplicationTasksInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_271) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_271).into()));
    }
...
pub fn serialize_structure_crate_input_describe_schemas_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSchemasInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_274) = &input.endpoint_arn {
        object.key("EndpointArn").string(var_274.as_str());
    }
    if let Some(var_275) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_275).into()));
    }
...
pub fn serialize_structure_crate_input_describe_table_statistics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeTableStatisticsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_278) = &input.max_records {
        object.key("MaxRecords").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_278).into()));
    }
...
pub fn serialize_structure_crate_input_import_certificate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportCertificateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_286) = &input.certificate_wallet {
        object.key("CertificateWallet").string_unchecked(&aws_smithy_types::base64::encode(var_286));
    }
...
pub fn serialize_structure_crate_input_modify_endpoint_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyEndpointInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_302) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_302).into()));
    }
    ...
    if let Some(var_304) = &input.extra_connection_attributes {
        object.key("ExtraConnectionAttributes").string(var_304.as_str());
    }
    ...
    if let Some(var_308) = &input.external_table_definition {
        object.key("ExternalTableDefinition").string(var_308.as_str());
    }
    if let Some(var_309) = &input.dynamo_db_settings {
        let mut object_310 = object.key("DynamoDbSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_dynamo_db_settings(&mut object_310, var_309)?;
        object_310.finish();
    }
    ...
    if let Some(var_313) = &input.dms_transfer_settings {
        ...
        crate::json_ser::serialize_structure_crate_model_dms_transfer_settings(&mut object_314, var_313)?;
        object_314.finish();
    }
    if let Some(var_315) = &input.mongo_db_settings {
        let mut object_316 = object.key("MongoDbSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_mongo_db_settings(&mut object_316, var_315)?;
        object_316.finish();
    }
    if let Some(var_317) = &input.kinesis_settings {
        let mut object_318 = object.key("KinesisSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_kinesis_settings(&mut object_318, var_317)?;
        object_318.finish();
    }
    ...
    if let Some(var_321) = &input.elasticsearch_settings {
        ...
        crate::json_ser::serialize_structure_crate_model_elasticsearch_settings(&mut object_322, var_321)?;
        object_322.finish();
    }
    if let Some(var_323) = &input.neptune_settings {
        let mut object_324 = object.key("NeptuneSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_neptune_settings(&mut object_324, var_323)?;
        object_324.finish();
    }
    if let Some(var_325) = &input.redshift_settings {
        let mut object_326 = object.key("RedshiftSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_redshift_settings(&mut object_326, var_325)?;
        object_326.finish();
    }
    if let Some(var_327) = &input.postgre_sql_settings {
        let mut object_328 = object.key("PostgreSQLSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_postgre_sql_settings(&mut object_328, var_327)?;
        object_328.finish();
    }
    ...
    if let Some(var_335) = &input.microsoft_sql_server_settings {
        ...
        crate::json_ser::serialize_structure_crate_model_microsoft_sql_server_settings(&mut object_336, var_335)?;
        object_336.finish();
    }
    if let Some(var_337) = &input.ibm_db2_settings {
        let mut object_338 = object.key("IBMDb2Settings").start_object();
        crate::json_ser::serialize_structure_crate_model_ibm_db2_settings(&mut object_338, var_337)?;
        object_338.finish();
    }
    ...
    if let Some(var_344) = &input.gcp_my_sql_settings {
        ...
        crate::json_ser::serialize_structure_crate_model_gcp_my_sql_settings(&mut object_345, var_344)?;
        object_345.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_input_modify_event_subscription_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyEventSubscriptionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_modify_replication_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyReplicationInstanceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_353) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_353.as_str());
    }
    if let Some(var_354) = &input.allocated_storage {
        object.key("AllocatedStorage").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_354).into()));
    }
    ...
    if let Some(var_355) = &input.replication_instance_class {
        object.key("ReplicationInstanceClass").string(var_355.as_str());
    }
    ...
    if let Some(var_359) = &input.preferred_maintenance_window {
        object.key("PreferredMaintenanceWindow").string(var_359.as_str());
    }
    ...
    if let Some(var_363) = &input.replication_instance_identifier {
        object.key("ReplicationInstanceIdentifier").string(var_363.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_modify_replication_subnet_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyReplicationSubnetGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_364) = &input.replication_subnet_group_identifier {
        object.key("ReplicationSubnetGroupIdentifier").string(var_364.as_str());
    }
    if let Some(var_365) = &input.replication_subnet_group_description {
        object.key("ReplicationSubnetGroupDescription").string(var_365.as_str());
    }
...
pub fn serialize_structure_crate_input_modify_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyReplicationTaskInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_370) = &input.replication_task_identifier {
        object.key("ReplicationTaskIdentifier").string(var_370.as_str());
    }
    ...
    if let Some(var_373) = &input.replication_task_settings {
        object.key("ReplicationTaskSettings").string(var_373.as_str());
    }
    if let Some(var_374) = &input.cdc_start_time {
        object.key("CdcStartTime").date_time(var_374, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_move_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MoveReplicationTaskInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_379) = &input.target_replication_instance_arn {
        object.key("TargetReplicationInstanceArn").string(var_379.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_reboot_replication_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RebootReplicationInstanceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_380) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_380.as_str());
    }
...
pub fn serialize_structure_crate_input_refresh_schemas_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RefreshSchemasInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_384) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_384.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_input_reload_tables_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ReloadTablesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_388 in var_386 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_table_to_reload(&mut object_389, item_388)?;
                object_389.finish();
            }
        }
        array_387.finish();
...
pub fn serialize_structure_crate_input_start_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartReplicationTaskInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_396) = &input.start_replication_task_type {
        object.key("StartReplicationTaskType").string(var_396.as_str());
    }
    if let Some(var_397) = &input.cdc_start_time {
        object.key("CdcStartTime").date_time(var_397, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_input_start_replication_task_assessment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartReplicationTaskAssessmentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_replication_task_assessment_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartReplicationTaskAssessmentRunInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_stop_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopReplicationTaskInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_test_connection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::TestConnectionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_415) = &input.replication_instance_arn {
        object.key("ReplicationInstanceArn").string(var_415.as_str());
    }
...
pub fn serialize_structure_crate_input_update_subscriptions_to_event_bridge_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSubscriptionsToEventBridgeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_dynamo_db_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DynamoDbSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_s3_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3Settings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_423) = &input.external_table_definition {
        object.key("ExternalTableDefinition").string(var_423.as_str());
    }
    ...
    if let Some(var_430) = &input.server_side_encryption_kms_key_id {
        object.key("ServerSideEncryptionKmsKeyId").string(var_430.as_str());
    }
    ...
    if let Some(var_433) = &input.dict_page_size_limit {
        object.key("DictPageSizeLimit").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_433).into()));
    }
    if let Some(var_434) = &input.row_group_length {
        object.key("RowGroupLength").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_434).into()));
    }
    if let Some(var_435) = &input.data_page_size {
        object.key("DataPageSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_435).into()));
    }
    ...
    if let Some(var_441) = &input.parquet_timestamp_in_millisecond {
        object.key("ParquetTimestampInMillisecond").boolean(*var_441);
    }
    ...
    if let Some(var_445) = &input.date_partition_delimiter {
        object.key("DatePartitionDelimiter").string(var_445.as_str());
    }
    ...
    if let Some(var_450) = &input.use_task_start_time_for_full_load_timestamp {
        object.key("UseTaskStartTimeForFullLoadTimestamp").boolean(*var_450);
    }
    ...
    if let Some(var_453) = &input.cdc_max_batch_interval {
        object.key("CdcMaxBatchInterval").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_453).into()));
    }
    if let Some(var_454) = &input.cdc_min_file_size {
        object.key("CdcMinFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_454).into()));
    }
    ...
    if let Some(var_456) = &input.ignore_header_rows {
        object.key("IgnoreHeaderRows").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_456).into()));
    }
    if let Some(var_457) = &input.max_file_size {
        object.key("MaxFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_457).into()));
    }
...
pub fn serialize_structure_crate_model_dms_transfer_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DmsTransferSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_mongo_db_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MongoDbSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_467) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_467).into()));
    }
    ...
    if let Some(var_476) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_476.as_str());
    }
    if let Some(var_477) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_477.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_kinesis_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KinesisSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_kafka_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KafkaSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_496) = &input.message_max_bytes {
        object.key("MessageMaxBytes").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_496).into()));
    }
    ...
    if let Some(var_499) = &input.ssl_client_certificate_arn {
        object.key("SslClientCertificateArn").string(var_499.as_str());
    }
...
pub fn serialize_structure_crate_model_elasticsearch_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ElasticsearchSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_508) = &input.full_load_error_percentage {
        object.key("FullLoadErrorPercentage").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_508).into()));
    }
    if let Some(var_509) = &input.error_retry_duration {
        object.key("ErrorRetryDuration").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_509).into()));
    }
...
pub fn serialize_structure_crate_model_neptune_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NeptuneSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_514) = &input.error_retry_duration {
        object.key("ErrorRetryDuration").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_514).into()));
    }
    if let Some(var_515) = &input.max_file_size {
        object.key("MaxFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_515).into()));
    }
    if let Some(var_516) = &input.max_retry_count {
        object.key("MaxRetryCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_516).into()));
    }
...
pub fn serialize_structure_crate_model_redshift_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedshiftSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_524) = &input.connection_timeout {
        object.key("ConnectionTimeout").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_524).into()));
    }
    ...
    if let Some(var_530) = &input.file_transfer_upload_streams {
        object.key("FileTransferUploadStreams").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_530).into()));
    }
    if let Some(var_531) = &input.load_timeout {
        object.key("LoadTimeout").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_531).into()));
    }
    if let Some(var_532) = &input.max_file_size {
        object.key("MaxFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_532).into()));
    }
    if let Some(var_533) = &input.password {
        object.key("Password").string(var_533.as_str());
    }
    if let Some(var_534) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_534).into()));
    }
    ...
    if let Some(var_540) = &input.server_side_encryption_kms_key_id {
        object.key("ServerSideEncryptionKmsKeyId").string(var_540.as_str());
    }
    ...
    if let Some(var_545) = &input.write_buffer_size {
        object.key("WriteBufferSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_545).into()));
    }
    if let Some(var_546) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_546.as_str());
    }
    if let Some(var_547) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_547.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_postgre_sql_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PostgreSqlSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_550) = &input.max_file_size {
        object.key("MaxFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_550).into()));
    }
    ...
    if let Some(var_553) = &input.execute_timeout {
        object.key("ExecuteTimeout").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_553).into()));
    }
    ...
    if let Some(var_557) = &input.heartbeat_frequency {
        object.key("HeartbeatFrequency").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_557).into()));
    }
    if let Some(var_558) = &input.password {
        object.key("Password").string(var_558.as_str());
    }
    if let Some(var_559) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_559).into()));
    }
    ...
    if let Some(var_564) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_564.as_str());
    }
    if let Some(var_565) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_565.as_str());
    }
...
pub fn serialize_structure_crate_model_my_sql_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MySqlSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_568) = &input.clean_source_metadata_on_mismatch {
        object.key("CleanSourceMetadataOnMismatch").boolean(*var_568);
    }
    ...
    if let Some(var_570) = &input.events_poll_interval {
        object.key("EventsPollInterval").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_570).into()));
    }
    ...
    if let Some(var_572) = &input.max_file_size {
        object.key("MaxFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_572).into()));
    }
    if let Some(var_573) = &input.parallel_load_threads {
        object.key("ParallelLoadThreads").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_573).into()));
    }
    if let Some(var_574) = &input.password {
        object.key("Password").string(var_574.as_str());
    }
    if let Some(var_575) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_575).into()));
    }
    ...
    if let Some(var_579) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_579.as_str());
    }
    if let Some(var_580) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_580.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_oracle_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OracleSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_582) = &input.archived_log_dest_id {
        object.key("ArchivedLogDestId").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_582).into()));
    }
    if let Some(var_583) = &input.additional_archived_log_dest_id {
        object.key("AdditionalArchivedLogDestId").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_583).into()));
    }
    if let Some(var_584) = &input.extra_archived_log_dest_ids {
        ...
        for item_586 in var_584 {
             {
                array_585.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*item_586).into()));
            }
        }
        array_585.finish();
    }
    ...
    if let Some(var_588) = &input.parallel_asm_read_threads {
        object.key("ParallelAsmReadThreads").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_588).into()));
    }
    if let Some(var_589) = &input.read_ahead_blocks {
        object.key("ReadAheadBlocks").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_589).into()));
    }
    ...
    if let Some(var_605) = &input.number_datatype_scale {
        object.key("NumberDatatypeScale").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_605).into()));
    }
    if let Some(var_606) = &input.password {
        object.key("Password").string(var_606.as_str());
    }
    if let Some(var_607) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_607).into()));
    }
    ...
    if let Some(var_609) = &input.retry_interval {
        object.key("RetryInterval").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_609).into()));
    }
    ...
    if let Some(var_611) = &input.security_db_encryption_name {
        object.key("SecurityDbEncryptionName").string(var_611.as_str());
    }
    ...
    if let Some(var_613) = &input.spatial_data_option_to_geo_json_function_name {
        object.key("SpatialDataOptionToGeoJsonFunctionName").string(var_613.as_str());
    }
    if let Some(var_614) = &input.standby_delay_time {
        object.key("StandbyDelayTime").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_614).into()));
    }
    ...
    if let Some(var_619) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_619.as_str());
    }
    if let Some(var_620) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_620.as_str());
    }
    if let Some(var_621) = &input.secrets_manager_oracle_asm_access_role_arn {
        object.key("SecretsManagerOracleAsmAccessRoleArn").string(var_621.as_str());
    }
    if let Some(var_622) = &input.secrets_manager_oracle_asm_secret_id {
        object.key("SecretsManagerOracleAsmSecretId").string(var_622.as_str());
    }
...
pub fn serialize_structure_crate_model_sybase_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SybaseSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_626) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_626).into()));
    }
    ...
    if let Some(var_629) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_629.as_str());
    }
    if let Some(var_630) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_630.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_microsoft_sql_server_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MicrosoftSqlServerSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_631) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_631).into()));
    }
    if let Some(var_632) = &input.bcp_packet_size {
        object.key("BcpPacketSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_632).into()));
    }
    ...
    if let Some(var_634) = &input.control_tables_file_group {
        object.key("ControlTablesFileGroup").string(var_634.as_str());
    }
    ...
    if let Some(var_643) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_643.as_str());
    }
    if let Some(var_644) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_644.as_str());
    }
...
pub fn serialize_structure_crate_model_ibm_db2_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IbmDb2Settings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_648) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_648).into()));
    }
    ...
    if let Some(var_652) = &input.max_k_bytes_per_read {
        object.key("MaxKBytesPerRead").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_652).into()));
    }
    ...
    if let Some(var_654) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_654.as_str());
    }
    if let Some(var_655) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_655.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_doc_db_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DocDbSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_659) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_659).into()));
    }
    ...
    if let Some(var_663) = &input.docs_to_investigate {
        object.key("DocsToInvestigate").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_663).into()));
    }
    ...
    if let Some(var_665) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_665.as_str());
    }
    if let Some(var_666) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_666.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_redis_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedisSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_gcp_my_sql_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GcpMySqlSettings) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_674) = &input.clean_source_metadata_on_mismatch {
        object.key("CleanSourceMetadataOnMismatch").boolean(*var_674);
    }
    ...
    if let Some(var_676) = &input.events_poll_interval {
        object.key("EventsPollInterval").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_676).into()));
    }
    ...
    if let Some(var_678) = &input.max_file_size {
        object.key("MaxFileSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_678).into()));
    }
    if let Some(var_679) = &input.parallel_load_threads {
        object.key("ParallelLoadThreads").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_679).into()));
    }
    if let Some(var_680) = &input.password {
        object.key("Password").string(var_680.as_str());
    }
    if let Some(var_681) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_681).into()));
    }
    ...
    if let Some(var_685) = &input.secrets_manager_access_role_arn {
        object.key("SecretsManagerAccessRoleArn").string(var_685.as_str());
    }
    if let Some(var_686) = &input.secrets_manager_secret_id {
        object.key("SecretsManagerSecretId").string(var_686.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_to_reload(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableToReload) -> Result<(), aws_smithy_http::operation::SerializationError> {
