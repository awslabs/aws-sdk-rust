...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_replication_task_assessment_results_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub fn ser_describe_replication_task_assessment_results_input(
    ...
    crate::protocol_serde::shape_describe_replication_task_assessment_results_input::ser_describe_replication_task_assessment_results_input_input(
        &mut object,
        input,
    )?;
    object.finish();
