...
pub fn ser_describe_replication_task_assessment_results_input(
    ...
    crate::protocol_serde::shape_describe_replication_task_assessment_results_input::ser_describe_replication_task_assessment_results_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_describe_replication_task_assessment_results_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_replication_task_assessment_results::DescribeReplicationTaskAssessmentResultsError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_replication_task_assessment_results::DescribeReplicationTaskAssessmentResultsError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::describe_replication_task_assessment_results::DescribeReplicationTaskAssessmentResultsError::ResourceNotFoundFault({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found_fault::de_resource_not_found_fault_json_err(_response_body, output)
                        .map_err(
                            crate::operation::describe_replication_task_assessment_results::DescribeReplicationTaskAssessmentResultsError::unhandled,
                        )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_replication_task_assessment_results_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_replication_task_assessment_results::de_describe_replication_task_assessment_results(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_replication_task_assessment_results::DescribeReplicationTaskAssessmentResultsError::unhandled)?;
