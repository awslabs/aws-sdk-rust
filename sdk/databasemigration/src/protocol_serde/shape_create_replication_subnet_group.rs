...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceAlreadyExistsFault" => {
            crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError::ResourceAlreadyExistsFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceQuotaExceededFault" => {
            crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError::ResourceQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_replication_subnet_group::de_create_replication_subnet_group(_response_body, output)
            .map_err(crate::operation::create_replication_subnet_group::CreateReplicationSubnetGroupError::unhandled)?;
...
pub(crate) fn de_create_replication_subnet_group(
    value: &[u8],
    mut builder: crate::operation::create_replication_subnet_group::builders::CreateReplicationSubnetGroupOutputBuilder,
) -> Result<
    crate::operation::create_replication_subnet_group::builders::CreateReplicationSubnetGroupOutputBuilder,
