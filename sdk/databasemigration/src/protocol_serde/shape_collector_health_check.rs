...
pub(crate) fn de_collector_health_check<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CollectorHealthCheck>, aws_smithy_json::deserialize::error::DeserializeError>
