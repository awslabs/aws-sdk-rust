...
pub fn ser_describe_applicable_individual_assessments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeApplicableIndividualAssessmentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
