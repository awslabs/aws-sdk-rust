...
pub(crate) fn de_replication_task<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicationTask>, aws_smithy_json::deserialize::error::DeserializeError>
