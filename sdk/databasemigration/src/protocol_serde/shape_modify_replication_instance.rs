...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_replication_instance::ModifyReplicationInstanceError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::modify_replication_instance::ModifyReplicationInstanceError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InsufficientResourceCapacityFault" => {
            crate::operation::modify_replication_instance::ModifyReplicationInstanceError::InsufficientResourceCapacityFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UpgradeDependencyFailureFault" => {
            crate::operation::modify_replication_instance::ModifyReplicationInstanceError::UpgradeDependencyFailureFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::UpgradeDependencyFailureFaultBuilder::default();
                    output = crate::protocol_serde::shape_upgrade_dependency_failure_fault::de_upgrade_dependency_failure_fault_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::modify_replication_instance::ModifyReplicationInstanceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_replication_instance_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_replication_instance::de_modify_replication_instance(_response_body, output)
            .map_err(crate::operation::modify_replication_instance::ModifyReplicationInstanceError::unhandled)?;
...
pub(crate) fn de_modify_replication_instance(
    value: &[u8],
    mut builder: crate::operation::modify_replication_instance::builders::ModifyReplicationInstanceOutputBuilder,
) -> Result<
    crate::operation::modify_replication_instance::builders::ModifyReplicationInstanceOutputBuilder,
