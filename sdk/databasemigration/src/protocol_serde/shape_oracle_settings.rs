...
pub fn ser_oracle_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OracleSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_oracle_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OracleSettings>, aws_smithy_json::deserialize::error::DeserializeError>
