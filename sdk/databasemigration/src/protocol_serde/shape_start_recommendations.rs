...
pub fn de_start_recommendations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::start_recommendations::StartRecommendationsOutput, crate::operation::start_recommendations::StartRecommendationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::start_recommendations::StartRecommendationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_recommendations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::start_recommendations::StartRecommendationsOutput, crate::operation::start_recommendations::StartRecommendationsError> {
    Ok({
        #[allow(unused_mut)]
