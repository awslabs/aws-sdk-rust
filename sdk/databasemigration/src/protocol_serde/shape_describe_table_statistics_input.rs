...
pub fn ser_describe_table_statistics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeTableStatisticsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
