...
> {
    ...
    Err(match error_code {
        "InvalidResourceStateFault" => {
            crate::operation::delete_certificate::DeleteCertificateError::InvalidResourceStateFault(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ResourceNotFoundFault" => {
            crate::operation::delete_certificate::DeleteCertificateError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_certificate::de_delete_certificate(
            _response_body,
            output,
        )
        .map_err(crate::operation::delete_certificate::DeleteCertificateError::unhandled)?;
