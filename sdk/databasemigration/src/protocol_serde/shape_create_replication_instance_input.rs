...
pub fn ser_create_replication_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReplicationInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
