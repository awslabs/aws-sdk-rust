...
pub fn ser_microsoft_sql_server_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MicrosoftSqlServerSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_microsoft_sql_server_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MicrosoftSqlServerSettings>, aws_smithy_json::deserialize::error::DeserializeError>
