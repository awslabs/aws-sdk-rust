...
pub fn ser_modify_replication_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyReplicationInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
