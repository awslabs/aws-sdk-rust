...
pub fn ser_describe_event_categories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeEventCategoriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
