...
pub(crate) fn de_replication_task_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ReplicationTask>>, aws_smithy_json::deserialize::error::DeserializeError>
