...
pub fn ser_delete_endpoint_input(
    ...
    crate::protocol_serde::shape_delete_endpoint_input::ser_delete_endpoint_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        "InvalidResourceStateFault" => {
            crate::operation::delete_endpoint::DeleteEndpointError::InvalidResourceStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundFault" => {
            crate::operation::delete_endpoint::DeleteEndpointError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_endpoint::de_delete_endpoint(
...
pub(crate) fn de_delete_endpoint(
    value: &[u8],
