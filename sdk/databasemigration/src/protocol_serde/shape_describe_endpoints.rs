...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_endpoints_input::ser_describe_endpoints_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_endpoints::DescribeEndpointsError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "ResourceNotFoundFault" => {
            crate::operation::describe_endpoints::DescribeEndpointsError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_endpoints_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_endpoints::de_describe_endpoints(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_endpoints::DescribeEndpointsError::unhandled)?;
