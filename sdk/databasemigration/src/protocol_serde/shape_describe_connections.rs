    ...
    Err(match error_code {
        "ResourceNotFoundFault" => crate::error::DescribeConnectionsError::ResourceNotFoundFault({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_resource_not_found_fault::de_resource_not_found_fault_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeConnectionsError::unhandled)?;
