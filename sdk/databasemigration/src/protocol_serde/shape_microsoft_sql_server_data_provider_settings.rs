...
pub(crate) fn de_microsoft_sql_server_data_provider_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MicrosoftSqlServerDataProviderSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
