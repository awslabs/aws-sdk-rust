...
pub fn ser_describe_certificates_input(input: &crate::input::DescribeCertificatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_not_found_fault::de_resource_not_found_fault_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeCertificatesError::unhandled)?;
...
pub(crate) fn de_describe_certificates(value: &[u8], mut builder: crate::output::describe_certificates_output::Builder) -> Result<crate::output::describe_certificates_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
