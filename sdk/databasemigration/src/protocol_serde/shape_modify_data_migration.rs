...
pub fn de_modify_data_migration_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_data_migration::ModifyDataMigrationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::modify_data_migration::ModifyDataMigrationError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "FailedDependencyFault" => crate::operation::modify_data_migration::ModifyDataMigrationError::FailedDependencyFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidResourceStateFault" => crate::operation::modify_data_migration::ModifyDataMigrationError::InvalidResourceStateFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundFault" => crate::operation::modify_data_migration::ModifyDataMigrationError::ResourceNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::modify_data_migration::ModifyDataMigrationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_data_migration_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_data_migration::builders::ModifyDataMigrationOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_data_migration::de_modify_data_migration(_response_body, output)
            .map_err(crate::operation::modify_data_migration::ModifyDataMigrationError::unhandled)?;
