...
pub fn ser_start_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartReplicationTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
