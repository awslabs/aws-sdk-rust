...
pub fn ser_postgre_sql_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PostgreSqlSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_postgre_sql_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PostgreSqlSettings>, aws_smithy_json::deserialize::error::DeserializeError>
