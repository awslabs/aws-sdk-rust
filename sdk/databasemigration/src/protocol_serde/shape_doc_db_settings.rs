...
pub fn ser_doc_db_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DocDbSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_doc_db_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DocDbSettings>, aws_smithy_json::deserialize::error::DeserializeError>
