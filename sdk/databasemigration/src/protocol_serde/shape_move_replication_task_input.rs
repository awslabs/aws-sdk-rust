...
pub fn ser_move_replication_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::MoveReplicationTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
