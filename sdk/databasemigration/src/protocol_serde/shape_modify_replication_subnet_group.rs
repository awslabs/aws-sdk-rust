...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceQuotaExceededFault" => {
            crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError::ResourceQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "SubnetAlreadyInUse" => crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError::SubnetAlreadyInUse({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_subnet_already_in_use::de_subnet_already_in_use_json_err(_response_body, output)
                    .map_err(crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_replication_subnet_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_replication_subnet_group::de_modify_replication_subnet_group(_response_body, output)
            .map_err(crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError::unhandled)?;
...
pub(crate) fn de_modify_replication_subnet_group(
    value: &[u8],
    mut builder: crate::operation::modify_replication_subnet_group::builders::ModifyReplicationSubnetGroupOutputBuilder,
) -> Result<
    crate::operation::modify_replication_subnet_group::builders::ModifyReplicationSubnetGroupOutputBuilder,
