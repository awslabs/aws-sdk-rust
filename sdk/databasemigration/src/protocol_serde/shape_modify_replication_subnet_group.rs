...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_replication_subnet_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupOutput, crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_modify_replication_subnet_group_input(input: &crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_modify_replication_subnet_group_input::ser_modify_replication_subnet_group_input_input(&mut object, input)?;
    object.finish();
