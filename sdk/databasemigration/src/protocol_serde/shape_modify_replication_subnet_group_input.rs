...
pub fn ser_modify_replication_subnet_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyReplicationSubnetGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
