                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "AssessmentProgress" => {
                                builder = builder.set_assessment_progress(
                                    crate::protocol_serde::shape_replication_task_assessment_run_progress::de_replication_task_assessment_run_progress(tokens, _value, depth + 1)?
                                );
                            }
                            "LastFailureMessage" => {
                            ...
                            "ResultStatistic" => {
                                builder = builder.set_result_statistic(
                                    crate::protocol_serde::shape_replication_task_assessment_run_result_statistic::de_replication_task_assessment_run_result_statistic(tokens, _value, depth + 1)?
                                );
                            }
