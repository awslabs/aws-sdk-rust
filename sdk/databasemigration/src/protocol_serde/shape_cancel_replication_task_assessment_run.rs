...
pub fn de_cancel_replication_task_assessment_run_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedFault" => {
            crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunError::AccessDeniedFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidResourceStateFault" => {
            crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunError::InvalidResourceStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundFault" => {
            crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_replication_task_assessment_run_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_cancel_replication_task_assessment_run::de_cancel_replication_task_assessment_run(_response_body, output)
                .map_err(crate::operation::cancel_replication_task_assessment_run::CancelReplicationTaskAssessmentRunError::unhandled)?;
