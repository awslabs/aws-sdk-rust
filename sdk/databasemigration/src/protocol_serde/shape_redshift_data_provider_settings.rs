...
pub(crate) fn de_redshift_data_provider_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RedshiftDataProviderSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
