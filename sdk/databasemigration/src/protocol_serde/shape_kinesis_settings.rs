...
pub fn ser_kinesis_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KinesisSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_kinesis_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KinesisSettings>, aws_smithy_json::deserialize::error::DeserializeError>
