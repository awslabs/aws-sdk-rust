...
pub(crate) fn de_replication_instance<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicationInstance>, aws_smithy_json::deserialize::error::DeserializeError>
