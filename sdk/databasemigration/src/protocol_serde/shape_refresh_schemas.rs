...
pub fn de_refresh_schemas_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::refresh_schemas::RefreshSchemasOutput, crate::operation::refresh_schemas::RefreshSchemasError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_refresh_schemas_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::refresh_schemas::RefreshSchemasOutput, crate::operation::refresh_schemas::RefreshSchemasError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_refresh_schemas_input(input: &crate::operation::refresh_schemas::RefreshSchemasInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
