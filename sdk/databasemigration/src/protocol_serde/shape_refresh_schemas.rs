...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::refresh_schemas::RefreshSchemasError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "InvalidResourceStateFault" => {
            crate::operation::refresh_schemas::RefreshSchemasError::InvalidResourceStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "KMSKeyNotAccessibleFault" => {
            crate::operation::refresh_schemas::RefreshSchemasError::KmsKeyNotAccessibleFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundFault" => {
            crate::operation::refresh_schemas::RefreshSchemasError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceQuotaExceededFault" => {
            crate::operation::refresh_schemas::RefreshSchemasError::ResourceQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
