...
pub fn de_refresh_schemas_http_error(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::refresh_schemas::RefreshSchemasOutput, crate::operation::refresh_schemas::RefreshSchemasError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::refresh_schemas::RefreshSchemasError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_refresh_schemas_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::refresh_schemas::RefreshSchemasOutput, crate::operation::refresh_schemas::RefreshSchemasError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_refresh_schemas::de_refresh_schemas(_response_body, output)
            .map_err(crate::operation::refresh_schemas::RefreshSchemasError::unhandled)?;
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "RefreshSchemasStatus" => {
                    builder =
                        builder.set_refresh_schemas_status(crate::protocol_serde::shape_refresh_schemas_status::de_refresh_schemas_status(tokens)?);
                }
