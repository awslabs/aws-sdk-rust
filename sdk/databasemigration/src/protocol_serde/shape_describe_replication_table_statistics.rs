...
pub fn de_describe_replication_table_statistics_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_replication_table_statistics::DescribeReplicationTableStatisticsError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidResourceStateFault" => {
            crate::operation::describe_replication_table_statistics::DescribeReplicationTableStatisticsError::InvalidResourceStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundFault" => {
            crate::operation::describe_replication_table_statistics::DescribeReplicationTableStatisticsError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_replication_table_statistics_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_replication_table_statistics::de_describe_replication_table_statistics(_response_body, output)
            .map_err(crate::operation::describe_replication_table_statistics::DescribeReplicationTableStatisticsError::unhandled)?;
...
pub fn ser_describe_replication_table_statistics_input(
    ...
    crate::protocol_serde::shape_describe_replication_table_statistics_input::ser_describe_replication_table_statistics_input_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ReplicationTableStatistics" => {
                    builder = builder.set_replication_table_statistics(
                        crate::protocol_serde::shape_replication_table_statistics_list::de_replication_table_statistics_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
