                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DataMigrationSettings" => {
                                builder = builder.set_data_migration_settings(
                                    crate::protocol_serde::shape_data_migration_settings::de_data_migration_settings(tokens, _value, depth + 1)?,
                                );
                            }
                            "SourceDataSettings" => {
                                builder = builder.set_source_data_settings(
                                    crate::protocol_serde::shape_source_data_settings::de_source_data_settings(tokens, _value, depth + 1)?,
                                );
                            }
                            "TargetDataSettings" => {
                                builder = builder.set_target_data_settings(
                                    crate::protocol_serde::shape_target_data_settings::de_target_data_settings(tokens, _value, depth + 1)?,
                                );
                            }
                            "DataMigrationStatistics" => {
                                builder = builder.set_data_migration_statistics(
                                    crate::protocol_serde::shape_data_migration_statistics::de_data_migration_statistics(tokens, _value, depth + 1)?,
                                );
                            }
                            "DataMigrationStatus" => {
                            ...
                            "PublicIpAddresses" => {
                                builder = builder.set_public_ip_addresses(
                                    crate::protocol_serde::shape_public_ip_address_list::de_public_ip_address_list(tokens, _value, depth + 1)?,
                                );
                            }
                            "DataMigrationCidrBlocks" => {
                                builder = builder.set_data_migration_cidr_blocks(
                                    crate::protocol_serde::shape_data_migration_cidr_block::de_data_migration_cidr_block(tokens, _value, depth + 1)?,
                                );
                            }
                            "LastFailureMessage" => {
