...
pub(crate) fn de_redis_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::RedisSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SslSecurityProtocol" => {
                            builder = builder.set_ssl_security_protocol(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::SslSecurityProtocolValue::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "AuthType" => {
                            builder = builder.set_auth_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RedisAuthTypeValue::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "AuthUserName" => {
