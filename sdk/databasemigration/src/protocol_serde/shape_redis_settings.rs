...
pub fn ser_redis_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedisSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_redis_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RedisSettings>, aws_smithy_json::deserialize::error::DeserializeError>
