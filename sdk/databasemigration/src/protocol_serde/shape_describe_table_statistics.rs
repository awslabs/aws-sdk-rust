...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_table_statistics::DescribeTableStatisticsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_table_statistics::de_describe_table_statistics(_response_body, output)
            .map_err(crate::operation::describe_table_statistics::DescribeTableStatisticsError::unhandled)?;
