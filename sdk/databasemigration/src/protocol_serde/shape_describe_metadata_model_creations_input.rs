...
pub fn ser_describe_metadata_model_creations_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::describe_metadata_model_creations::DescribeMetadataModelCreationsInput,
    ...
    if let Some(var_7) = &input.migration_project_identifier {
        object.key("MigrationProjectIdentifier").string(var_7.as_str());
    }
    Ok(())
}
