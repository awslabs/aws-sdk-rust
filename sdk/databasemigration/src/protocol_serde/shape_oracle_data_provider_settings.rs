...
pub(crate) fn de_oracle_data_provider_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::OracleDataProviderSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
