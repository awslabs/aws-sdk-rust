...
pub fn ser_data_provider_settings(object_5: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DataProviderSettings) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::DataProviderSettings::MicrosoftSqlServerSettings(inner) => {
             {
                ...
                crate::protocol_serde::shape_microsoft_sql_server_data_provider_settings::ser_microsoft_sql_server_data_provider_settings(&mut object_5, inner)?;
                object_5.finish();
            }
        },
        ...
        crate::types::DataProviderSettings::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("DataProviderSettings"))
    }
    Ok(())
}

pub(crate) fn de_data_provider_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataProviderSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        variant = match key.as_ref() {
                            "RedshiftSettings" => {
                                Some(crate::types::DataProviderSettings::RedshiftSettings(
                                    crate::protocol_serde::shape_redshift_data_provider_settings::de_redshift_data_provider_settings(tokens)?
                            ...
                            "DocDbSettings" => {
                                Some(crate::types::DataProviderSettings::DocDbSettings(
                                    crate::protocol_serde::shape_doc_db_data_provider_settings::de_doc_db_data_provider_settings(tokens)?
                            ...
                            "MariaDbSettings" => {
                                Some(crate::types::DataProviderSettings::MariaDbSettings(
                                    crate::protocol_serde::shape_maria_db_data_provider_settings::de_maria_db_data_provider_settings(tokens)?
                            ...
                            "MongoDbSettings" => {
                                Some(crate::types::DataProviderSettings::MongoDbSettings(
                                    crate::protocol_serde::shape_mongo_db_data_provider_settings::de_mongo_db_data_provider_settings(tokens)?
