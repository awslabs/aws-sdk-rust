...
pub fn ser_data_provider_settings(
    ...
    match input {
        crate::types::DataProviderSettings::RedshiftSettings(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_6.key("RedshiftSettings").start_object();
        ...
        crate::types::DataProviderSettings::PostgreSqlSettings(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_6.key("PostgreSqlSettings").start_object();
        ...
        crate::types::DataProviderSettings::MySqlSettings(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_6.key("MySqlSettings").start_object();
        ...
        crate::types::DataProviderSettings::OracleSettings(inner) => {
            #[allow(unused_mut)]
            let mut object_4 = object_6.key("OracleSettings").start_object();
