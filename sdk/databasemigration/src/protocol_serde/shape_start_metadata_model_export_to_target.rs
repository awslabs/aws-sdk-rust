...
pub fn de_start_metadata_model_export_to_target_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidResourceStateFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::InvalidResourceStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "KMSKeyNotAccessibleFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::KmsKeyNotAccessibleFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceAlreadyExistsFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::ResourceAlreadyExistsFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceQuotaExceededFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::ResourceQuotaExceededFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "S3AccessDeniedFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::S3AccessDeniedFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "S3ResourceNotFoundFault" => {
            crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::S3ResourceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_metadata_model_export_to_target_http_response(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_metadata_model_export_to_target::de_start_metadata_model_export_to_target(_response_body, output)
            .map_err(crate::operation::start_metadata_model_export_to_target::StartMetadataModelExportToTargetError::unhandled)?;
...
pub fn ser_start_metadata_model_export_to_target_input(
    ...
    crate::protocol_serde::shape_start_metadata_model_export_to_target_input::ser_start_metadata_model_export_to_target_input(&mut object, input)?;
    object.finish();
