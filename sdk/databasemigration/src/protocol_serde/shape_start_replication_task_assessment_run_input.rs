...
pub fn ser_start_replication_task_assessment_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartReplicationTaskAssessmentRunInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
