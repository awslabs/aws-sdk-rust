...
) -> ::std::result::Result<Option<crate::types::KafkaSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SecurityProtocol" => {
                            builder = builder.set_security_protocol(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::KafkaSecurityProtocol::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "SaslMechanism" => {
                            builder = builder.set_sasl_mechanism(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::KafkaSaslMechanism::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "SslEndpointIdentificationAlgorithm" => {
                            builder = builder.set_ssl_endpoint_identification_algorithm(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::KafkaSslEndpointIdentificationAlgorithm::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
