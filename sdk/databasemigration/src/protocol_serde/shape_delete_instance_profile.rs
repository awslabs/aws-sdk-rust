...
pub fn de_delete_instance_profile_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "FailedDependencyFault" => crate::operation::delete_instance_profile::DeleteInstanceProfileError::FailedDependencyFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_instance_profile::de_delete_instance_profile(_response_body, output)
            .map_err(crate::operation::delete_instance_profile::DeleteInstanceProfileError::unhandled)?;
...
pub(crate) fn de_delete_instance_profile(
    _value: &[u8],
    mut builder: crate::operation::delete_instance_profile::builders::DeleteInstanceProfileOutputBuilder,
) -> ::std::result::Result<
