...
pub fn ser_redshift_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RedshiftSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_redshift_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RedshiftSettings>, aws_smithy_json::deserialize::error::DeserializeError>
