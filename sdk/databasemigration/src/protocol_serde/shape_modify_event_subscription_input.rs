...
pub fn ser_modify_event_subscription_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyEventSubscriptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
