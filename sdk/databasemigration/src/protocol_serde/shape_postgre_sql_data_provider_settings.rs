...
pub(crate) fn de_postgre_sql_data_provider_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::PostgreSqlDataProviderSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
