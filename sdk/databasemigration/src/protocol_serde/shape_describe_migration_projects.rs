...
pub fn de_describe_migration_projects_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_migration_projects::DescribeMigrationProjectsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_migration_projects::DescribeMigrationProjectsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "FailedDependencyFault" => crate::operation::describe_migration_projects::DescribeMigrationProjectsError::FailedDependencyFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_migration_projects_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_migration_projects::de_describe_migration_projects(_response_body, output)
            .map_err(crate::operation::describe_migration_projects::DescribeMigrationProjectsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "MigrationProjects" => {
                    builder = builder.set_migration_projects(crate::protocol_serde::shape_migration_project_list::de_migration_project_list(tokens)?);
                }
