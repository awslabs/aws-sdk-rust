...
impl JoinStorageSessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_join_storage_session::ser_join_storage_session_input(&self)?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::join_storage_session::JoinStorageSession::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("JoinStorageSession", "kinesisvideowebrtcstorage"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for JoinStorageSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_join_storage_session::de_join_storage_session_http_response_with_props(status, headers, body)
        }
    }
}
