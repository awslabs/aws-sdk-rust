...
impl JoinStorageSessionInput {
    /// Consumes the builder and constructs an Operation<[`JoinStorageSession`](crate::operation::join_storage_session::JoinStorageSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::join_storage_session::JoinStorageSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::join_storage_session::JoinStorageSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::join_storage_session::JoinStorageSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for JoinStorageSession {
                type Output = std::result::Result<crate::operation::join_storage_session::JoinStorageSessionOutput, crate::operation::join_storage_session::JoinStorageSessionError>;
