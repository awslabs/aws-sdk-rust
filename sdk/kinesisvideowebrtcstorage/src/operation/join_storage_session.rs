...
/// Orchestration and serialization glue logic for `JoinStorageSession`.
...
impl JoinStorageSession {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::join_storage_session::JoinStorageSessionInput,
                    ) -> ::std::result::Result<crate::operation::join_storage_session::JoinStorageSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::join_storage_session::JoinStorageSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::join_storage_session::JoinStorageSessionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::join_storage_session::JoinStorageSessionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for JoinStorageSession {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("JoinStorageSession");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(JoinStorageSessionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(JoinStorageSessionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("JoinStorageSession")
...
.with_interceptor(JoinStorageSessionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::join_storage_session::JoinStorageSessionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::join_storage_session::JoinStorageSessionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::join_storage_session::JoinStorageSessionError>::new());
...
#[derive(Debug)]
            struct JoinStorageSessionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for JoinStorageSessionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_join_storage_session::de_join_storage_session_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct JoinStorageSessionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for JoinStorageSessionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::join_storage_session::JoinStorageSessionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::join_storage_session::JoinStorageSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/joinStorageSession").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_join_storage_session::ser_join_storage_session_input(&input)?);
...
#[derive(Debug)]
            struct JoinStorageSessionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for JoinStorageSessionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "JoinStorageSessionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<JoinStorageSessionInput>()
                        .ok_or("failed to downcast to JoinStorageSessionInput")?;
...
pub enum JoinStorageSessionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-JoinStorageSessionError) for what information is available for the error.")]
...
impl JoinStorageSessionError {
    /// Creates the `JoinStorageSessionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `JoinStorageSessionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for JoinStorageSessionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::join_storage_session::JoinStorageSessionError {
...
mod _join_storage_session_output;
