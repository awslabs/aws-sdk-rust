...
impl JoinStorageSessionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::join_storage_session::JoinStorageSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::join_storage_session::JoinStorageSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::join_storage_session::JoinStorageSessionOutput, crate::operation::join_storage_session::JoinStorageSessionError, Self> {
