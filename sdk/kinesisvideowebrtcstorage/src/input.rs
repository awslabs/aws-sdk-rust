...
impl JoinStorageSessionInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::JoinStorageSession,
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::input::JoinStorageSessionInput,
                output: &mut String,
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::operation_ser::serialize_operation_crate_operation_join_storage_session(&self)?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::JoinStorageSession::new(),
        )
...
pub mod join_storage_session_input {
    ...
    impl Builder {
        ...
        pub fn build(
            ...
            aws_smithy_http::operation::error::BuildError,
        > {
            Ok(crate::input::JoinStorageSessionInput {
