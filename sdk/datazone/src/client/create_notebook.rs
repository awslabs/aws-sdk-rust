...
impl super::Client {
    ...
    ///   - [`r#type(NotebookType)`](crate::operation::create_notebook::builders::CreateNotebookFluentBuilder::type) / [`set_type(Option<NotebookType>)`](crate::operation::create_notebook::builders::CreateNotebookFluentBuilder::set_type):<br>required: **false**<br><p>The type of the notebook.</p><br>
    ...
    ///   - [`r#type(Option<NotebookType>)`](crate::operation::create_notebook::CreateNotebookOutput::type): <p>The type of the notebook.</p>
