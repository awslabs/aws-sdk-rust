...
impl super::Client {
    ...
    ///   - [`skip_deletion_check(bool)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::skip_deletion_check) / [`set_skip_deletion_check(Option<bool>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::set_skip_deletion_check):<br>required: **false**<br>Optional flag to delete all child entities within the domain<br>
