...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_domain_identifier): <p>The identifier of the Amazon DataZone domain in which a user profile is updated.</p>
    ///   - [`user_identifier(impl Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::user_identifier) / [`set_user_identifier(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_user_identifier): <p>The identifier of the user whose user profile is to be updated.</p>
    ///   - [`r#type(UserProfileType)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::type) / [`set_type(Option<UserProfileType>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_type): <p>The type of the user profile that are to be updated.</p>
    ///   - [`status(UserProfileStatus)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::status) / [`set_status(Option<UserProfileStatus>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_status): <p>The status of the user profile that are to be updated.</p>
