...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::revoke_subscription::builders::RevokeSubscriptionFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::revoke_subscription::builders::RevokeSubscriptionFluentBuilder::set_domain_identifier): <p>The identifier of the Amazon DataZone domain where you want to revoke a subscription.</p>
    ///   - [`identifier(impl Into<String>)`](crate::operation::revoke_subscription::builders::RevokeSubscriptionFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::revoke_subscription::builders::RevokeSubscriptionFluentBuilder::set_identifier): <p>The identifier of the revoked subscription.</p>
    ///   - [`retain_permissions(bool)`](crate::operation::revoke_subscription::builders::RevokeSubscriptionFluentBuilder::retain_permissions) / [`set_retain_permissions(Option<bool>)`](crate::operation::revoke_subscription::builders::RevokeSubscriptionFluentBuilder::set_retain_permissions): <p>Specifies whether permissions are retained when the subscription is revoked.</p>
    ...
    ///   - [`id(Option<String>)`](crate::operation::revoke_subscription::RevokeSubscriptionOutput::id): <p>The identifier of the revoked subscription.</p>
    ///   - [`created_by(Option<String>)`](crate::operation::revoke_subscription::RevokeSubscriptionOutput::created_by): <p>The identifier of the user who revoked the subscription.</p>
    ...
    ///   - [`domain_id(Option<String>)`](crate::operation::revoke_subscription::RevokeSubscriptionOutput::domain_id): <p>The identifier of the Amazon DataZone domain where you want to revoke a subscription.</p>
    ///   - [`status(Option<SubscriptionStatus>)`](crate::operation::revoke_subscription::RevokeSubscriptionOutput::status): <p>The status of the revoked subscription.</p>
    ///   - [`created_at(Option<DateTime>)`](crate::operation::revoke_subscription::RevokeSubscriptionOutput::created_at): <p>The timestamp of when the subscription was revoked.</p>
    ///   - [`updated_at(Option<DateTime>)`](crate::operation::revoke_subscription::RevokeSubscriptionOutput::updated_at): <p>The timestamp of when the subscription was revoked.</p>
