...
impl super::Client {
    ...
    ///   - [`r#type(NotebookType)`](crate::operation::update_notebook::builders::UpdateNotebookFluentBuilder::type) / [`set_type(Option<NotebookType>)`](crate::operation::update_notebook::builders::UpdateNotebookFluentBuilder::set_type):<br>required: **false**<br><p>The updated type of the notebook.</p><br>
    ...
    ///   - [`r#type(Option<NotebookType>)`](crate::operation::update_notebook::UpdateNotebookOutput::type): <p>The type of the notebook.</p>
