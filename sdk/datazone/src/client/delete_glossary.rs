...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::delete_glossary::builders::DeleteGlossaryFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::delete_glossary::builders::DeleteGlossaryFluentBuilder::set_domain_identifier): <p>The ID of the Amazon DataZone domain in which the business glossary is deleted.</p>
    ///   - [`identifier(impl Into<String>)`](crate::operation::delete_glossary::builders::DeleteGlossaryFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::delete_glossary::builders::DeleteGlossaryFluentBuilder::set_identifier): <p>The ID of the business glossary that is deleted.</p>
