...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::accept_predictions::builders::AcceptPredictionsFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::accept_predictions::builders::AcceptPredictionsFluentBuilder::set_identifier): <p></p>
    ///   - [`revision(impl Into<String>)`](crate::operation::accept_predictions::builders::AcceptPredictionsFluentBuilder::revision) / [`set_revision(Option<String>)`](crate::operation::accept_predictions::builders::AcceptPredictionsFluentBuilder::set_revision): <p></p>
    ...
    ///   - [`accept_choices(AcceptChoice)`](crate::operation::accept_predictions::builders::AcceptPredictionsFluentBuilder::accept_choices) / [`set_accept_choices(Option<Vec<AcceptChoice>>)`](crate::operation::accept_predictions::builders::AcceptPredictionsFluentBuilder::set_accept_choices): <p></p>
    ...
    ///   - [`domain_id(Option<String>)`](crate::operation::accept_predictions::AcceptPredictionsOutput::domain_id): <p></p>
    ///   - [`asset_id(Option<String>)`](crate::operation::accept_predictions::AcceptPredictionsOutput::asset_id): <p></p>
    ///   - [`revision(Option<String>)`](crate::operation::accept_predictions::AcceptPredictionsOutput::revision): <p></p>
