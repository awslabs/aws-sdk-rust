...
impl super::Client {
    ...
    ///   - [`project_identifier(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::project_identifier) / [`set_project_identifier(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_project_identifier): <p>The identifier of the Amazon DataZone project in which this environment is created.</p>
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_domain_identifier): <p>The identifier of the Amazon DataZone domain in which the environment is created.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_description): <p>The description of the Amazon DataZone environment.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_name): <p>The name of the Amazon DataZone environment.</p>
    ///   - [`environment_profile_identifier(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::environment_profile_identifier) / [`set_environment_profile_identifier(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_environment_profile_identifier): <p>The identifier of the environment profile that is used to create this Amazon DataZone environment.</p>
    ///   - [`user_parameters(EnvironmentParameter)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::user_parameters) / [`set_user_parameters(Option<Vec<EnvironmentParameter>>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_user_parameters): <p>The user parameters of this Amazon DataZone environment.</p>
    ...
    ///   - [`project_id(Option<String>)`](crate::operation::create_environment::CreateEnvironmentOutput::project_id): <p>The ID of the Amazon DataZone project in which this environment is created.</p>
    ...
    ///   - [`domain_id(Option<String>)`](crate::operation::create_environment::CreateEnvironmentOutput::domain_id): <p>The identifier of the Amazon DataZone domain in which the environment is created.</p>
    ///   - [`created_by(Option<String>)`](crate::operation::create_environment::CreateEnvironmentOutput::created_by): <p>The Amazon DataZone user who created this environment.</p>
    ...
    ///   - [`name(Option<String>)`](crate::operation::create_environment::CreateEnvironmentOutput::name): <p>The name of this environment.</p>
    ...
    ///   - [`environment_profile_id(Option<String>)`](crate::operation::create_environment::CreateEnvironmentOutput::environment_profile_id): <p>The ID of the environment profile with which this Amazon DataZone environment was created.</p>
    ...
    ///   - [`provider(Option<String>)`](crate::operation::create_environment::CreateEnvironmentOutput::provider): <p>The provider of this Amazon DataZone environment.</p>
