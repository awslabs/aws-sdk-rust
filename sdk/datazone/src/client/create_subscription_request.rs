...
impl super::Client {
    ...
    ///   - [`id(Option<String>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::id): <p>The ID of the subscription request.</p>
    ///   - [`created_by(Option<String>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::created_by): <p>The Amazon DataZone user who created the subscription request.</p>
    ...
    ///   - [`domain_id(Option<String>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::domain_id): <p>The ID of the Amazon DataZone domain in whcih the subscription request is created.</p>
    ///   - [`status(Option<SubscriptionRequestStatus>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::status): <p>The status of the subscription request.</p>
    ///   - [`created_at(Option<DateTime>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::created_at): <p>A timestamp of when the subscription request is created.</p>
    ///   - [`updated_at(Option<DateTime>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::updated_at): <p>The timestamp of when the subscription request was updated.</p>
    ///   - [`request_reason(Option<String>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::request_reason): <p>The reason for the subscription request.</p>
    ///   - [`subscribed_principals(Option<Vec<SubscribedPrincipal>>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::subscribed_principals): <p>The subscribed principals of the subscription request.</p>
    ///   - [`subscribed_listings(Option<Vec<SubscribedListing>>)`](crate::operation::create_subscription_request::CreateSubscriptionRequestOutput::subscribed_listings): <p></p>
