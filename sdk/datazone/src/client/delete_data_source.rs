...
impl super::Client {
    ...
    ///   - [`self_grant_status(Option<SelfGrantStatusOutput>)`](crate::operation::delete_data_source::DeleteDataSourceOutput::self_grant_status): <p>Specifies the status of the self-granting functionality.</p>
    ///   - [`retain_permissions_on_revoke_failure(Option<bool>)`](crate::operation::delete_data_source::DeleteDataSourceOutput::retain_permissions_on_revoke_failure): <p>Specifies that the granted permissions are retained in case of a self-subscribe functionality failure for a data source.</p>
