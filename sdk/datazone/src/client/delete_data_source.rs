...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::set_domain_identifier): <p>The ID of the Amazon DataZone domain in which the data source is deleted.</p>
    ///   - [`identifier(impl Into<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::set_identifier): <p>The identifier of the data source that is deleted.</p>
    ...
    ///   - [`id(Option<String>)`](crate::operation::delete_data_source::DeleteDataSourceOutput::id): <p>The ID of the data source that is deleted.</p>
    ...
    ///   - [`name(Option<String>)`](crate::operation::delete_data_source::DeleteDataSourceOutput::name): <p>The name of the data source that is deleted.</p>
    ...
    ///   - [`domain_id(Option<String>)`](crate::operation::delete_data_source::DeleteDataSourceOutput::domain_id): <p>The ID of the Amazon DataZone domain in which the data source is deleted.</p>
    ///   - [`project_id(Option<String>)`](crate::operation::delete_data_source::DeleteDataSourceOutput::project_id): <p>The ID of the project in which this data source exists and from which it's deleted.</p>
