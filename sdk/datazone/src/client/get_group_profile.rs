...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::get_group_profile::builders::GetGroupProfileFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::get_group_profile::builders::GetGroupProfileFluentBuilder::set_domain_identifier): <p>The identifier of the Amazon DataZone domain in which the group profile exists.</p>
    ///   - [`group_identifier(impl Into<String>)`](crate::operation::get_group_profile::builders::GetGroupProfileFluentBuilder::group_identifier) / [`set_group_identifier(Option<String>)`](crate::operation::get_group_profile::builders::GetGroupProfileFluentBuilder::set_group_identifier): <p>The identifier of the group profile.</p>
