...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_domain_identifier): <p>The identifier of the domain in which the environment is to be updated.</p>
    ///   - [`identifier(impl Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_identifier): <p>The identifier of the environment that is to be updated.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_name): <p>The name to be updated as part of the <code>UpdateEnvironment</code> action.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_description): <p>The description to be updated as part of the <code>UpdateEnvironment</code> action.</p>
    ///   - [`glossary_terms(impl Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::glossary_terms) / [`set_glossary_terms(Option<Vec<String>>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_glossary_terms): <p>The glossary terms to be updated as part of the <code>UpdateEnvironment</code> action.</p>
    /// - On success, responds with [`UpdateEnvironmentOutput`](crate::operation::update_environment::UpdateEnvironmentOutput) with field(s):
    ///   - [`project_id(Option<String>)`](crate::operation::update_environment::UpdateEnvironmentOutput::project_id): <p>The project identifier of the environment.</p>
    ...
    ///   - [`domain_id(Option<String>)`](crate::operation::update_environment::UpdateEnvironmentOutput::domain_id): <p>The identifier of the domain in which the environment is to be updated.</p>
    ///   - [`created_by(Option<String>)`](crate::operation::update_environment::UpdateEnvironmentOutput::created_by): <p>The Amazon DataZone user who created the environment.</p>
    ...
    ///   - [`name(Option<String>)`](crate::operation::update_environment::UpdateEnvironmentOutput::name): <p>The name to be updated as part of the <code>UpdateEnvironment</code> action.</p>
    ...
    ///   - [`environment_profile_id(Option<String>)`](crate::operation::update_environment::UpdateEnvironmentOutput::environment_profile_id): <p>The profile identifier of the environment.</p>
    ...
    ///   - [`provider(Option<String>)`](crate::operation::update_environment::UpdateEnvironmentOutput::provider): <p>The provider identifier of the environment.</p>
