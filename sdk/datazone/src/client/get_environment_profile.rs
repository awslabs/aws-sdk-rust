...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::get_environment_profile::builders::GetEnvironmentProfileFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::get_environment_profile::builders::GetEnvironmentProfileFluentBuilder::set_domain_identifier): <p>The ID of the Amazon DataZone domain in which this environment profile exists.</p>
    ///   - [`identifier(impl Into<String>)`](crate::operation::get_environment_profile::builders::GetEnvironmentProfileFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_environment_profile::builders::GetEnvironmentProfileFluentBuilder::set_identifier): <p>The ID of the environment profile.</p>
    ...
    ///   - [`id(Option<String>)`](crate::operation::get_environment_profile::GetEnvironmentProfileOutput::id): <p>The ID of the environment profile.</p>
    ///   - [`domain_id(Option<String>)`](crate::operation::get_environment_profile::GetEnvironmentProfileOutput::domain_id): <p>The ID of the Amazon DataZone domain in which this environment profile exists.</p>
    ...
    ///   - [`created_by(Option<String>)`](crate::operation::get_environment_profile::GetEnvironmentProfileOutput::created_by): <p>The Amazon DataZone user who created this environment profile.</p>
    ...
    ///   - [`name(Option<String>)`](crate::operation::get_environment_profile::GetEnvironmentProfileOutput::name): <p>The name of the environment profile.</p>
    ...
    ///   - [`environment_blueprint_id(Option<String>)`](crate::operation::get_environment_profile::GetEnvironmentProfileOutput::environment_blueprint_id): <p>The ID of the blueprint with which this environment profile is created.</p>
