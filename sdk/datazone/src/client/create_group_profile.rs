...
impl super::Client {
    ...
    ///   - [`domain_identifier(impl Into<String>)`](crate::operation::create_group_profile::builders::CreateGroupProfileFluentBuilder::domain_identifier) / [`set_domain_identifier(Option<String>)`](crate::operation::create_group_profile::builders::CreateGroupProfileFluentBuilder::set_domain_identifier): <p>The identifier of the Amazon DataZone domain in which the group profile is created.</p>
    ///   - [`group_identifier(impl Into<String>)`](crate::operation::create_group_profile::builders::CreateGroupProfileFluentBuilder::group_identifier) / [`set_group_identifier(Option<String>)`](crate::operation::create_group_profile::builders::CreateGroupProfileFluentBuilder::set_group_identifier): <p>The identifier of the group for which the group profile is created.</p>
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_group_profile::builders::CreateGroupProfileFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_group_profile::builders::CreateGroupProfileFluentBuilder::set_client_token): <p> A unique, case-sensitive identifier that is provided to ensure the idempotency of the request.</p>
