...
impl super::Client {
    ...
    ///   - [`usage_restrictions(GlossaryUsageRestriction)`](crate::operation::create_glossary::builders::CreateGlossaryFluentBuilder::usage_restrictions) / [`set_usage_restrictions(Option<Vec::<GlossaryUsageRestriction>>)`](crate::operation::create_glossary::builders::CreateGlossaryFluentBuilder::set_usage_restrictions):<br>required: **false**<br><p>The usage restriction of the restricted glossary.</p><br>
    ...
    ///   - [`usage_restrictions(Option<Vec::<GlossaryUsageRestriction>>)`](crate::operation::create_glossary::CreateGlossaryOutput::usage_restrictions): <p>The usage restriction of the restricted glossary.</p>
