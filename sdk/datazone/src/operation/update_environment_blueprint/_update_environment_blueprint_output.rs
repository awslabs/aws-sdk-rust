...
pub struct UpdateEnvironmentBlueprintOutput {
...
impl ::std::fmt::Debug for UpdateEnvironmentBlueprintOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateEnvironmentBlueprintOutput");
...
impl ::aws_types::request_id::RequestId for UpdateEnvironmentBlueprintOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateEnvironmentBlueprintOutput {
    /// Creates a new builder-style object to manufacture [`UpdateEnvironmentBlueprintOutput`](crate::operation::update_environment_blueprint::UpdateEnvironmentBlueprintOutput).
    pub fn builder() -> crate::operation::update_environment_blueprint::builders::UpdateEnvironmentBlueprintOutputBuilder {
        crate::operation::update_environment_blueprint::builders::UpdateEnvironmentBlueprintOutputBuilder::default()
    }
}

/// A builder for [`UpdateEnvironmentBlueprintOutput`](crate::operation::update_environment_blueprint::UpdateEnvironmentBlueprintOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct UpdateEnvironmentBlueprintOutputBuilder {
...
impl UpdateEnvironmentBlueprintOutputBuilder {
    /// <p>The identifier of the blueprint to be updated.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateEnvironmentBlueprintOutput`](crate::operation::update_environment_blueprint::UpdateEnvironmentBlueprintOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::update_environment_blueprint::builders::UpdateEnvironmentBlueprintOutputBuilder::id)
    /// - [`name`](crate::operation::update_environment_blueprint::builders::UpdateEnvironmentBlueprintOutputBuilder::name)
    /// - [`provider`](crate::operation::update_environment_blueprint::builders::UpdateEnvironmentBlueprintOutputBuilder::provider)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::update_environment_blueprint::UpdateEnvironmentBlueprintOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building UpdateEnvironmentBlueprintOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateEnvironmentBlueprintOutput",
                )
            })?,
            ...
            provider: self.provider.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "provider",
                    "provider was not specified but it is required when building UpdateEnvironmentBlueprintOutput",
                )
            })?,
...
impl ::std::fmt::Debug for UpdateEnvironmentBlueprintOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateEnvironmentBlueprintOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("name", &self.name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("provider", &self.provider);
