...
impl ListProjects {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DataZone", "ListProjects", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListProjects {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListProjects", "DataZone"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListProjectsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("projectCategory") {
            if let ::std::option::Option::Some(value) = input.project_category.as_deref() {
                captured.insert("projectCategory", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v2/domains/{domainIdentifier}/projects", domainIdentifier = domain_identifier)
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.user_identifier {
                    {
                        query.push_kv("userIdentifier", &::aws_smithy_http::query::fmt_string(inner_2));
                    }
                }
                if let ::std::option::Option::Some(inner_3) = &_input.group_identifier {
                    {
                        query.push_kv("groupIdentifier", &::aws_smithy_http::query::fmt_string(inner_3));
                    }
                }
