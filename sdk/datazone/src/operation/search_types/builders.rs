...
impl crate::operation::search_types::builders::SearchTypesInputBuilder {
...
/// <li>
/// <p>--search-scope must be one of the valid values including: ASSET_TYPE, GLOSSARY_TERM_TYPE, DATA_PRODUCT_TYPE.</p></li>
/// <li>
/// <p>The --managed flag must be present without a value.</p></li>
/// <li>
/// <p>The user must have permissions for form or asset types in the domain.</p></li>
/// <li>
/// <p>If using --filters, ensure that the JSON is valid.</p></li>
/// <li>
/// <p>Filters contain correct structure (attribute, value, operator).</p></li>
/// </ul>
...
impl SearchTypesFluentBuilder {
    /// Creates a new `SearchTypesFluentBuilder`.
