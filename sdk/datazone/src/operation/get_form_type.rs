    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFormType")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetFormTypeEndpointParamsInterceptor) as _),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetFormTypeResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetFormTypeRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetFormTypeEndpointParamsInterceptor {
...
pub type GetFormTypeErrorKind = GetFormTypeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetFormTypeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_form_type::GetFormTypeError {
...
impl GetFormTypeError {
    ...
    /// Creates the `GetFormTypeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
