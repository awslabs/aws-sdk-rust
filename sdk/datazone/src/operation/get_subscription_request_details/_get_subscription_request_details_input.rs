...
impl GetSubscriptionRequestDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_subscription_request_details::GetSubscriptionRequestDetailsInput, ::aws_smithy_types::error::operation::BuildError> {
