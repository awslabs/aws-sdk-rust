...
impl CreateProject {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DataZone", "CreateProject", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateProject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateProject", "DataZone"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateProjectTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("projectProfileId") {
            if let ::std::option::Option::Some(value) = input.project_profile_id.as_deref() {
                captured.insert("projectProfileId", value);
            }
        }
        ...
        if requested.should_capture("projectExecutionRole") {
            if let ::std::option::Option::Some(value) = input.project_execution_role.as_deref() {
                captured.insert("projectExecutionRole", value);
            }
        }
