...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v2/domains/{domainIdentifier}/projects/{identifier}", domainIdentifier = domain_identifier, identifier = identifier).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::delete_project::DeleteProjectInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
