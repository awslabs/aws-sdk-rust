...
impl ::aws_http::request_id::RequestId for GetEnvironmentProfileOutput {
...
impl GetEnvironmentProfileOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::get_environment_profile::GetEnvironmentProfileOutput {
