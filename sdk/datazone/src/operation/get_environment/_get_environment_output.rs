...
impl GetEnvironmentOutputBuilder {
    ...
    pub fn set_environment_actions(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::ConfigurableEnvironmentAction>>) -> Self {
        self.environment_actions = input; self
    }
    /// <p>The actions of the environment.</p>
    ...
    pub fn set_last_deployment(mut self, input: ::std::option::Option<crate::types::Deployment>) -> Self {
        self.last_deployment = input; self
    }
    /// <p>The details of the last deployment of the environment.</p>
        ...
        ::std::result::Result::Ok(
            crate::operation::get_environment::GetEnvironmentOutput {
                project_id: self.project_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("project_id", "project_id was not specified but it is required when building GetEnvironmentOutput")
                    )?
                ,
                id: self.id
                ,
                domain_id: self.domain_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domain_id", "domain_id was not specified but it is required when building GetEnvironmentOutput")
                    )?
                ,
                created_by: self.created_by
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building GetEnvironmentOutput")
                    )?
                ,
                ...
                environment_profile_id: self.environment_profile_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("environment_profile_id", "environment_profile_id was not specified but it is required when building GetEnvironmentOutput")
                    )?
                ,
                ...
                provider: self.provider
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("provider", "provider was not specified but it is required when building GetEnvironmentOutput")
                    )?
                ,
