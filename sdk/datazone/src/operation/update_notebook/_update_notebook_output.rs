...
impl ::std::fmt::Debug for UpdateNotebookOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateNotebookOutput");
...
impl UpdateNotebookOutputBuilder {
    ...
    /// - [`id`](crate::operation::update_notebook::builders::UpdateNotebookOutputBuilder::id)
    /// - [`name`](crate::operation::update_notebook::builders::UpdateNotebookOutputBuilder::name)
    /// - [`owning_project_id`](crate::operation::update_notebook::builders::UpdateNotebookOutputBuilder::owning_project_id)
    /// - [`domain_id`](crate::operation::update_notebook::builders::UpdateNotebookOutputBuilder::domain_id)
    /// - [`cell_order`](crate::operation::update_notebook::builders::UpdateNotebookOutputBuilder::cell_order)
    /// - [`status`](crate::operation::update_notebook::builders::UpdateNotebookOutputBuilder::status)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_notebook::UpdateNotebookOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_notebook::UpdateNotebookOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building UpdateNotebookOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateNotebookOutput",
                )
            })?,
            owning_project_id: self.owning_project_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "owning_project_id",
                    "owning_project_id was not specified but it is required when building UpdateNotebookOutput",
                )
            })?,
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building UpdateNotebookOutput",
                )
            })?,
            cell_order: self.cell_order.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "cell_order",
                    "cell_order was not specified but it is required when building UpdateNotebookOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building UpdateNotebookOutput",
                )
            })?,
...
impl ::std::fmt::Debug for UpdateNotebookOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("UpdateNotebookOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("name", &"*** Sensitive Data Redacted ***");
        formatter.field("owning_project_id", &self.owning_project_id);
        formatter.field("domain_id", &self.domain_id);
