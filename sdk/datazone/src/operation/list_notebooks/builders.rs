...
pub use crate::operation::list_notebooks::_list_notebooks_input::ListNotebooksInputBuilder;

pub use crate::operation::list_notebooks::_list_notebooks_output::ListNotebooksOutputBuilder;

impl crate::operation::list_notebooks::builders::ListNotebooksInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_notebooks();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `ListNotebooks`.
///
...
pub struct ListNotebooksFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_notebooks::builders::ListNotebooksInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_notebooks::ListNotebooksOutput,
        crate::operation::list_notebooks::ListNotebooksError,
    > for ListNotebooksFluentBuilder
{
    fn send(
        self,
...
impl ListNotebooksFluentBuilder {
    /// Creates a new `ListNotebooksFluentBuilder`.
    ...
    /// Access the ListNotebooks as a reference.
    pub fn as_input(&self) -> &crate::operation::list_notebooks::builders::ListNotebooksInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_notebooks::ListNotebooks::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_notebooks::paginator::ListNotebooksPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_notebooks::paginator::ListNotebooksPaginator {
        crate::operation::list_notebooks::paginator::ListNotebooksPaginator::new(self.handle, self.inner)
    }
