...
pub struct CreateEnvironmentBlueprintOutput {
...
impl CreateEnvironmentBlueprintOutput {
    /// <p>The ID of this Amazon DataZone blueprint.</p>
    pub fn id(&self) -> &str {
        use std::ops::Deref;
        self.id.deref()
...
impl ::std::fmt::Debug for CreateEnvironmentBlueprintOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateEnvironmentBlueprintOutput");
...
impl ::aws_types::request_id::RequestId for CreateEnvironmentBlueprintOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateEnvironmentBlueprintOutput {
    /// Creates a new builder-style object to manufacture [`CreateEnvironmentBlueprintOutput`](crate::operation::create_environment_blueprint::CreateEnvironmentBlueprintOutput).
    pub fn builder() -> crate::operation::create_environment_blueprint::builders::CreateEnvironmentBlueprintOutputBuilder {
        crate::operation::create_environment_blueprint::builders::CreateEnvironmentBlueprintOutputBuilder::default()
    }
}

/// A builder for [`CreateEnvironmentBlueprintOutput`](crate::operation::create_environment_blueprint::CreateEnvironmentBlueprintOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct CreateEnvironmentBlueprintOutputBuilder {
...
impl CreateEnvironmentBlueprintOutputBuilder {
    /// <p>The ID of this Amazon DataZone blueprint.</p>
    ...
    /// Consumes the builder and constructs a [`CreateEnvironmentBlueprintOutput`](crate::operation::create_environment_blueprint::CreateEnvironmentBlueprintOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::create_environment_blueprint::builders::CreateEnvironmentBlueprintOutputBuilder::id)
    /// - [`name`](crate::operation::create_environment_blueprint::builders::CreateEnvironmentBlueprintOutputBuilder::name)
    /// - [`provider`](crate::operation::create_environment_blueprint::builders::CreateEnvironmentBlueprintOutputBuilder::provider)
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::operation::create_environment_blueprint::CreateEnvironmentBlueprintOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateEnvironmentBlueprintOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreateEnvironmentBlueprintOutput",
                )
            })?,
            ...
            provider: self.provider.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "provider",
                    "provider was not specified but it is required when building CreateEnvironmentBlueprintOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreateEnvironmentBlueprintOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateEnvironmentBlueprintOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("name", &self.name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
        formatter.field("provider", &self.provider);
