...
impl AcceptSubscriptionRequestOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_subscription_request::AcceptSubscriptionRequestOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::accept_subscription_request::AcceptSubscriptionRequestOutput {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                created_by: self.created_by
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_by", "created_by was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                ...
                domain_id: self.domain_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domain_id", "domain_id was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                updated_at: self.updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("updated_at", "updated_at was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                request_reason: self.request_reason
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("request_reason", "request_reason was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                subscribed_principals: self.subscribed_principals
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("subscribed_principals", "subscribed_principals was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
                subscribed_listings: self.subscribed_listings
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("subscribed_listings", "subscribed_listings was not specified but it is required when building AcceptSubscriptionRequestOutput")
                    )?
                ,
