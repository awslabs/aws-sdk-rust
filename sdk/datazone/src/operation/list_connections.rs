...
impl ListConnections {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("datazone", "ListConnections", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_7) = &_input.environment_identifier {
                    {
...
impl ListConnectionsError {
    ...
    /// Returns `true` if the error kind is `ListConnectionsError::InternalServerException`.
    ...
    /// Returns `true` if the error kind is `ListConnectionsError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
    /// Returns `true` if the error kind is `ListConnectionsError::UnauthorizedException`.
