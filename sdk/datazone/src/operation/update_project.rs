...
impl UpdateProject {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DataZone", "UpdateProject", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateProject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateProject", "DataZone"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateProjectTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("domainUnitId") {
            if let ::std::option::Option::Some(value) = input.domain_unit_id.as_deref() {
                captured.insert("domainUnitId", value);
            }
        }
        if requested.should_capture("projectProfileVersion") {
            if let ::std::option::Option::Some(value) = input.project_profile_version.as_deref() {
                captured.insert("projectProfileVersion", value);
            }
        }
...
impl UpdateProjectError {
    ...
    /// Returns `true` if the error kind is `UpdateProjectError::InternalServerException`.
