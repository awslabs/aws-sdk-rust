...
pub struct CreateDataProductOutput {
...
impl ::std::fmt::Debug for CreateDataProductOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateDataProductOutput");
...
impl ::aws_types::request_id::RequestId for CreateDataProductOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateDataProductOutput {
    /// Creates a new builder-style object to manufacture [`CreateDataProductOutput`](crate::operation::create_data_product::CreateDataProductOutput).
    pub fn builder() -> crate::operation::create_data_product::builders::CreateDataProductOutputBuilder {
        crate::operation::create_data_product::builders::CreateDataProductOutputBuilder::default()
    }
}

/// A builder for [`CreateDataProductOutput`](crate::operation::create_data_product::CreateDataProductOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct CreateDataProductOutputBuilder {
...
impl CreateDataProductOutputBuilder {
    /// <p>The ID of the domain where the data product lives.</p>
    ...
    /// Consumes the builder and constructs a [`CreateDataProductOutput`](crate::operation::create_data_product::CreateDataProductOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`domain_id`](crate::operation::create_data_product::builders::CreateDataProductOutputBuilder::domain_id)
    /// - [`id`](crate::operation::create_data_product::builders::CreateDataProductOutputBuilder::id)
    /// - [`revision`](crate::operation::create_data_product::builders::CreateDataProductOutputBuilder::revision)
    /// - [`owning_project_id`](crate::operation::create_data_product::builders::CreateDataProductOutputBuilder::owning_project_id)
    /// - [`name`](crate::operation::create_data_product::builders::CreateDataProductOutputBuilder::name)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_data_product::CreateDataProductOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_data_product::CreateDataProductOutput {
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building CreateDataProductOutput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building CreateDataProductOutput",
                )
            })?,
            revision: self.revision.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "revision",
                    "revision was not specified but it is required when building CreateDataProductOutput",
                )
            })?,
            owning_project_id: self.owning_project_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "owning_project_id",
                    "owning_project_id was not specified but it is required when building CreateDataProductOutput",
                )
            })?,
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building CreateDataProductOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreateDataProductOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateDataProductOutputBuilder");
        formatter.field("domain_id", &self.domain_id);
        formatter.field("id", &self.id);
        formatter.field("revision", &self.revision);
        formatter.field("owning_project_id", &self.owning_project_id);
