...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v2/domains/{domainIdentifier}/environments/{identifier}", domainIdentifier = domain_identifier, identifier = identifier).expect("formatting should succeed");
