...
pub use crate::operation::update_asset_filter::_update_asset_filter_output::UpdateAssetFilterOutputBuilder;

pub use crate::operation::update_asset_filter::_update_asset_filter_input::UpdateAssetFilterInputBuilder;

impl crate::operation::update_asset_filter::builders::UpdateAssetFilterInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::update_asset_filter::UpdateAssetFilterOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::update_asset_filter::UpdateAssetFilterError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.update_asset_filter();
...
pub struct UpdateAssetFilterFluentBuilder {
    ...
    inner: crate::operation::update_asset_filter::builders::UpdateAssetFilterInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::update_asset_filter::UpdateAssetFilterOutput,
        crate::operation::update_asset_filter::UpdateAssetFilterError,
    > for UpdateAssetFilterFluentBuilder
{
    fn send(
        self,
...
impl UpdateAssetFilterFluentBuilder {
    /// Creates a new `UpdateAssetFilterFluentBuilder`.
    ...
    /// Access the UpdateAssetFilter as a reference.
    pub fn as_input(&self) -> &crate::operation::update_asset_filter::builders::UpdateAssetFilterInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_asset_filter::UpdateAssetFilter::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_asset_filter::UpdateAssetFilter::orchestrate(&runtime_plugins, input).await
    }
