...
pub use crate::operation::associate_governed_terms::_associate_governed_terms_output::AssociateGovernedTermsOutputBuilder;

pub use crate::operation::associate_governed_terms::_associate_governed_terms_input::AssociateGovernedTermsInputBuilder;

impl crate::operation::associate_governed_terms::builders::AssociateGovernedTermsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.associate_governed_terms();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `AssociateGovernedTerms`.
///
/// <p>Associates governed terms with an asset.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct AssociateGovernedTermsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::associate_governed_terms::builders::AssociateGovernedTermsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::associate_governed_terms::AssociateGovernedTermsOutput,
        crate::operation::associate_governed_terms::AssociateGovernedTermsError,
    > for AssociateGovernedTermsFluentBuilder
{
    fn send(
        self,
...
impl AssociateGovernedTermsFluentBuilder {
    /// Creates a new `AssociateGovernedTermsFluentBuilder`.
    ...
    /// Access the AssociateGovernedTerms as a reference.
    pub fn as_input(&self) -> &crate::operation::associate_governed_terms::builders::AssociateGovernedTermsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::associate_governed_terms::AssociateGovernedTerms::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::associate_governed_terms::AssociateGovernedTerms::orchestrate(&runtime_plugins, input).await
    }
