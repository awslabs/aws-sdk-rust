...
impl ListSubscriptionRequestsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_subscription_requests::paginator::ListSubscriptionRequestsPaginator::send) which returns a `Stream`.
