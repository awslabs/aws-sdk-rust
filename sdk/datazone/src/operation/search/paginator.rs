...
impl SearchPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::search::Search::operation_runtime_plugins(handle.runtime_plugins.clone(), &handle.conf, ::std::option::Option::None);
...
impl SearchPaginatorItems {
    ...
    pub fn send(
        ...
        ::std::result::Result<
            crate::types::SearchInventoryResultItem,
            ::aws_smithy_runtime_api::client::result::SdkError<
                crate::operation::search::SearchError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_search_output_output_items(page).unwrap_or_default().into_iter())
    }
}
