...
impl GetProject {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("datazone", "GetProject", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetProject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetProject", "datazone"));
...
impl GetProjectError {
    ...
    /// Returns `true` if the error kind is `GetProjectError::InternalServerException`.
    ...
    /// Returns `true` if the error kind is `GetProjectError::UnauthorizedException`.
