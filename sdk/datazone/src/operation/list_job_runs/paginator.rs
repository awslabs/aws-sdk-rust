...
/// Paginator for [`ListJobRuns`](crate::operation::list_job_runs::ListJobRuns)
pub struct ListJobRunsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_job_runs::builders::ListJobRunsInputBuilder,
...
impl ListJobRunsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_job_runs::paginator::ListJobRunsPaginatorItems {
        crate::operation::list_job_runs::paginator::ListJobRunsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_job_runs::ListJobRuns::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_job_runs_output_output_next_token(resp);
...
impl ListJobRunsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_job_runs_output_output_items(page).unwrap_or_default().into_iter())
    }
}
