...
pub use crate::operation::create_asset_filter::_create_asset_filter_input::CreateAssetFilterInputBuilder;

pub use crate::operation::create_asset_filter::_create_asset_filter_output::CreateAssetFilterOutputBuilder;

impl crate::operation::create_asset_filter::builders::CreateAssetFilterInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::create_asset_filter::CreateAssetFilterOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::create_asset_filter::CreateAssetFilterError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.create_asset_filter();
...
pub struct CreateAssetFilterFluentBuilder {
    ...
    inner: crate::operation::create_asset_filter::builders::CreateAssetFilterInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_asset_filter::CreateAssetFilterOutput,
        crate::operation::create_asset_filter::CreateAssetFilterError,
    > for CreateAssetFilterFluentBuilder
{
    fn send(
        self,
...
impl CreateAssetFilterFluentBuilder {
    /// Creates a new `CreateAssetFilterFluentBuilder`.
    ...
    /// Access the CreateAssetFilter as a reference.
    pub fn as_input(&self) -> &crate::operation::create_asset_filter::builders::CreateAssetFilterInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_asset_filter::CreateAssetFilter::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_asset_filter::CreateAssetFilter::orchestrate(&runtime_plugins, input).await
    }
