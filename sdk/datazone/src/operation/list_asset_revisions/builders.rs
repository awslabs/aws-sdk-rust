...
impl ListAssetRevisionsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_asset_revisions::ListAssetRevisionsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_asset_revisions::paginator::ListAssetRevisionsPaginator::send) which returns a `Stream`.
