...
pub use crate::operation::search_user_profiles::_search_user_profiles_output::SearchUserProfilesOutputBuilder;

pub use crate::operation::search_user_profiles::_search_user_profiles_input::SearchUserProfilesInputBuilder;
...
impl SearchUserProfilesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.search_user_profiles();
...
pub struct SearchUserProfilesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::search_user_profiles::builders::SearchUserProfilesInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::search_user_profiles::SearchUserProfilesOutput,
                    crate::operation::search_user_profiles::SearchUserProfilesError,
                > for SearchUserProfilesFluentBuilder
            {
                fn send(
                    self,
...
impl SearchUserProfilesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::search_user_profiles::builders::SearchUserProfilesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_user_profiles::SearchUserProfilesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_user_profiles::SearchUserProfilesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::search_user_profiles::SearchUserProfiles::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::search_user_profiles::SearchUserProfiles::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_user_profiles::SearchUserProfilesOutput, crate::operation::search_user_profiles::SearchUserProfilesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::search_user_profiles::paginator::SearchUserProfilesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::search_user_profiles::paginator::SearchUserProfilesPaginator {
                                crate::operation::search_user_profiles::paginator::SearchUserProfilesPaginator::new(self.handle, self.inner)
                            }
