...
pub use crate::operation::list_entity_owners::_list_entity_owners_output::ListEntityOwnersOutputBuilder;

pub use crate::operation::list_entity_owners::_list_entity_owners_input::ListEntityOwnersInputBuilder;

impl crate::operation::list_entity_owners::builders::ListEntityOwnersInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::list_entity_owners::ListEntityOwnersOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::list_entity_owners::ListEntityOwnersError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.list_entity_owners();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `ListEntityOwners`.
///
/// <p>Lists the entity (domain units) owners.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct ListEntityOwnersFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_entity_owners::builders::ListEntityOwnersInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_entity_owners::ListEntityOwnersOutput,
        crate::operation::list_entity_owners::ListEntityOwnersError,
    > for ListEntityOwnersFluentBuilder
{
    fn send(
        self,
...
impl ListEntityOwnersFluentBuilder {
    /// Creates a new `ListEntityOwnersFluentBuilder`.
    ...
    /// Access the ListEntityOwners as a reference.
    pub fn as_input(&self) -> &crate::operation::list_entity_owners::builders::ListEntityOwnersInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_entity_owners::ListEntityOwners::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_entity_owners::ListEntityOwners::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_entity_owners::paginator::ListEntityOwnersPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_entity_owners::paginator::ListEntityOwnersPaginator {
        crate::operation::list_entity_owners::paginator::ListEntityOwnersPaginator::new(self.handle, self.inner)
    }
