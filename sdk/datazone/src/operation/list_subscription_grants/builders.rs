...
impl ListSubscriptionGrantsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_subscription_grants::paginator::ListSubscriptionGrantsPaginator::send) which returns a `Stream`.
