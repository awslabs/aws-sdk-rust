...
pub struct GetNotebookRunOutput {
...
impl ::std::fmt::Debug for GetNotebookRunOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetNotebookRunOutput");
...
impl ::aws_types::request_id::RequestId for GetNotebookRunOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetNotebookRunOutput {
    /// Creates a new builder-style object to manufacture [`GetNotebookRunOutput`](crate::operation::get_notebook_run::GetNotebookRunOutput).
    pub fn builder() -> crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder {
        crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder::default()
    }
}

/// A builder for [`GetNotebookRunOutput`](crate::operation::get_notebook_run::GetNotebookRunOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct GetNotebookRunOutputBuilder {
...
impl GetNotebookRunOutputBuilder {
    /// <p>The identifier of the notebook run.</p>
    ...
    /// Consumes the builder and constructs a [`GetNotebookRunOutput`](crate::operation::get_notebook_run::GetNotebookRunOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder::id)
    /// - [`domain_id`](crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder::domain_id)
    /// - [`owning_project_id`](crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder::owning_project_id)
    /// - [`notebook_id`](crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder::notebook_id)
    /// - [`status`](crate::operation::get_notebook_run::builders::GetNotebookRunOutputBuilder::status)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_notebook_run::GetNotebookRunOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_notebook_run::GetNotebookRunOutput {
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetNotebookRunOutput",
                )
            })?,
            domain_id: self.domain_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "domain_id",
                    "domain_id was not specified but it is required when building GetNotebookRunOutput",
                )
            })?,
            owning_project_id: self.owning_project_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "owning_project_id",
                    "owning_project_id was not specified but it is required when building GetNotebookRunOutput",
                )
            })?,
            notebook_id: self.notebook_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "notebook_id",
                    "notebook_id was not specified but it is required when building GetNotebookRunOutput",
                )
            })?,
            ...
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building GetNotebookRunOutput",
                )
            })?,
...
impl ::std::fmt::Debug for GetNotebookRunOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("GetNotebookRunOutputBuilder");
        formatter.field("id", &self.id);
        formatter.field("domain_id", &self.domain_id);
        formatter.field("owning_project_id", &self.owning_project_id);
        formatter.field("notebook_id", &self.notebook_id);
