...
/// Paginator for [`ListPolicyGrants`](crate::operation::list_policy_grants::ListPolicyGrants)
pub struct ListPolicyGrantsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_policy_grants::builders::ListPolicyGrantsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListPolicyGrantsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `grant_list`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_policy_grants::paginator::ListPolicyGrantsPaginatorItems {
        crate::operation::list_policy_grants::paginator::ListPolicyGrantsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_policy_grants::ListPolicyGrants::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_policy_grants_output_output_next_token(resp);
...
/// Flattened paginator for `ListPolicyGrantsPaginator`
///
/// This is created with [`.items()`](ListPolicyGrantsPaginator::items)
pub struct ListPolicyGrantsPaginatorItems(ListPolicyGrantsPaginator);

impl ListPolicyGrantsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_policy_grants_output_output_grant_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
