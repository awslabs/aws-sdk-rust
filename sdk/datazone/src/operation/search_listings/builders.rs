...
impl SearchListingsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::search_listings::SearchListingsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::search_listings::paginator::SearchListingsPaginator::send) which returns a `Stream`.
