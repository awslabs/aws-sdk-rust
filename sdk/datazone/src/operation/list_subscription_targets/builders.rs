...
impl ListSubscriptionTargetsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_subscription_targets::paginator::ListSubscriptionTargetsPaginator::send) which returns a `Stream`.
