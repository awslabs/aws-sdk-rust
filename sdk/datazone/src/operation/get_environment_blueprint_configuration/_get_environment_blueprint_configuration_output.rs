...
impl GetEnvironmentBlueprintConfigurationOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_environment_blueprint_configuration::GetEnvironmentBlueprintConfigurationOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_environment_blueprint_configuration::GetEnvironmentBlueprintConfigurationOutput {
                domain_id: self.domain_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domain_id", "domain_id was not specified but it is required when building GetEnvironmentBlueprintConfigurationOutput")
                    )?
                ,
                environment_blueprint_id: self.environment_blueprint_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("environment_blueprint_id", "environment_blueprint_id was not specified but it is required when building GetEnvironmentBlueprintConfigurationOutput")
                    )?
                ,
