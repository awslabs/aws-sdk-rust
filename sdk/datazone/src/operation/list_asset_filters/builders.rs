...
pub use crate::operation::list_asset_filters::_list_asset_filters_output::ListAssetFiltersOutputBuilder;

pub use crate::operation::list_asset_filters::_list_asset_filters_input::ListAssetFiltersInputBuilder;

impl crate::operation::list_asset_filters::builders::ListAssetFiltersInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::list_asset_filters::ListAssetFiltersOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::list_asset_filters::ListAssetFiltersError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.list_asset_filters();
...
pub struct ListAssetFiltersFluentBuilder {
    ...
    inner: crate::operation::list_asset_filters::builders::ListAssetFiltersInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_asset_filters::ListAssetFiltersOutput,
        crate::operation::list_asset_filters::ListAssetFiltersError,
    > for ListAssetFiltersFluentBuilder
{
    fn send(
        self,
...
impl ListAssetFiltersFluentBuilder {
    /// Creates a new `ListAssetFiltersFluentBuilder`.
    ...
    /// Access the ListAssetFilters as a reference.
    pub fn as_input(&self) -> &crate::operation::list_asset_filters::builders::ListAssetFiltersInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_asset_filters::ListAssetFilters::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_asset_filters::ListAssetFilters::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_asset_filters::paginator::ListAssetFiltersPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_asset_filters::paginator::ListAssetFiltersPaginator {
        crate::operation::list_asset_filters::paginator::ListAssetFiltersPaginator::new(self.handle, self.inner)
    }
