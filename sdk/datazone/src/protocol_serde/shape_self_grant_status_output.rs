...
) -> Result<Option<crate::types::SelfGrantStatusOutput>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "glueSelfGrantStatus" => Some(crate::types::SelfGrantStatusOutput::GlueSelfGrantStatus(
                            crate::protocol_serde::shape_glue_self_grant_status_output::de_glue_self_grant_status_output(tokens)?.ok_or_else(
                        ...
                        "redshiftSelfGrantStatus" => Some(crate::types::SelfGrantStatusOutput::RedshiftSelfGrantStatus(
                            crate::protocol_serde::shape_redshift_self_grant_status_output::de_redshift_self_grant_status_output(tokens)?
                                .ok_or_else(|| {
