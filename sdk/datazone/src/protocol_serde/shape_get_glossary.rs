...
pub fn de_get_glossary_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_glossary_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_glossary::GetGlossaryError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_glossary::builders::GetGlossaryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
