...
pub fn de_create_listing_change_set_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_listing_change_set::CreateListingChangeSetError::unhandled(
                generic,
            ))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_listing_change_set_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::create_listing_change_set_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_listing_change_set::CreateListingChangeSetError::unhandled)?
    })
}
...
pub(crate) fn de_create_listing_change_set(
    value: &[u8],
