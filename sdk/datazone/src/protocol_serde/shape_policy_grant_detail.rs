                    ...
                    variant = match key.as_ref() {
                            "createDomainUnit" => {
                                Some(crate::types::PolicyGrantDetail::CreateDomainUnit(
                                    crate::protocol_serde::shape_create_domain_unit_policy_grant_detail::de_create_domain_unit_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "overrideDomainUnitOwners" => {
                                Some(crate::types::PolicyGrantDetail::OverrideDomainUnitOwners(
                                    crate::protocol_serde::shape_override_domain_unit_owners_policy_grant_detail::de_override_domain_unit_owners_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "addToProjectMemberPool" => {
                                Some(crate::types::PolicyGrantDetail::AddToProjectMemberPool(
                                    crate::protocol_serde::shape_add_to_project_member_pool_policy_grant_detail::de_add_to_project_member_pool_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "overrideProjectOwners" => {
                                Some(crate::types::PolicyGrantDetail::OverrideProjectOwners(
                                    crate::protocol_serde::shape_override_project_owners_policy_grant_detail::de_override_project_owners_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "createGlossary" => {
                                Some(crate::types::PolicyGrantDetail::CreateGlossary(
                                    crate::protocol_serde::shape_create_glossary_policy_grant_detail::de_create_glossary_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "createFormType" => {
                                Some(crate::types::PolicyGrantDetail::CreateFormType(
                                    crate::protocol_serde::shape_create_form_type_policy_grant_detail::de_create_form_type_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "createAssetType" => {
                                Some(crate::types::PolicyGrantDetail::CreateAssetType(
                                    crate::protocol_serde::shape_create_asset_type_policy_grant_detail::de_create_asset_type_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "createProject" => {
                                Some(crate::types::PolicyGrantDetail::CreateProject(
                                    crate::protocol_serde::shape_create_project_policy_grant_detail::de_create_project_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "createEnvironmentProfile" => {
                                Some(crate::types::PolicyGrantDetail::CreateEnvironmentProfile(
                                    crate::protocol_serde::shape_create_environment_profile_policy_grant_detail::de_create_environment_profile_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "delegateCreateEnvironmentProfile" => {
                                Some(crate::types::PolicyGrantDetail::DelegateCreateEnvironmentProfile(
                                    crate::protocol_serde::shape_unit::de_unit(tokens, _value, depth + 1)?
                            ...
                            "createProjectFromProjectProfile" => {
                                Some(crate::types::PolicyGrantDetail::CreateProjectFromProjectProfile(
                                    crate::protocol_serde::shape_create_project_from_project_profile_policy_grant_detail::de_create_project_from_project_profile_policy_grant_detail(tokens, _value, depth + 1)?
                            ...
                            "useAssetType" => {
                                Some(crate::types::PolicyGrantDetail::UseAssetType(
                                    crate::protocol_serde::shape_use_asset_type_policy_grant_detail::de_use_asset_type_policy_grant_detail(tokens, _value, depth + 1)?
