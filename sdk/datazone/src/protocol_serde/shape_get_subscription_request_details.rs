...
pub fn de_get_subscription_request_details_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::get_subscription_request_details::GetSubscriptionRequestDetailsError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_subscription_request_details::GetSubscriptionRequestDetailsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_subscription_request_details_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::get_subscription_request_details_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_subscription_request_details::GetSubscriptionRequestDetailsError::unhandled)?
    })
}
