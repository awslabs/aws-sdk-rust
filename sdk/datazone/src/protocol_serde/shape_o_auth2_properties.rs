                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "authorizationCodeProperties" => {
                            builder = builder.set_authorization_code_properties(
                                crate::protocol_serde::shape_authorization_code_properties::de_authorization_code_properties(tokens, _value)?,
                            );
                        }
                        "oAuth2Credentials" => {
                            builder = builder.set_o_auth2_credentials(
                                crate::protocol_serde::shape_glue_o_auth2_credentials::de_glue_o_auth2_credentials(tokens, _value)?,
                            );
                        }
