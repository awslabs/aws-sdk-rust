                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "metadataFormEnforcementDetail" => Some(crate::types::RuleDetail::MetadataFormEnforcementDetail(
                            crate::protocol_serde::shape_metadata_form_enforcement_detail::de_metadata_form_enforcement_detail(tokens, _value)?
                                .ok_or_else(|| {
                        ...
                        "glossaryTermEnforcementDetail" => Some(crate::types::RuleDetail::GlossaryTermEnforcementDetail(
                            crate::protocol_serde::shape_glossary_term_enforcement_detail::de_glossary_term_enforcement_detail(tokens, _value)?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom(
