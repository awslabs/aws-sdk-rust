...
pub fn ser_connection_properties_input(
    ...
    match input {
        crate::types::ConnectionPropertiesInput::AthenaProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_8.key("athenaProperties").start_object();
        ...
        crate::types::ConnectionPropertiesInput::GlueProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_8.key("glueProperties").start_object();
        ...
        crate::types::ConnectionPropertiesInput::HyperPodProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_8.key("hyperPodProperties").start_object();
        ...
        crate::types::ConnectionPropertiesInput::IamProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_4 = object_8.key("iamProperties").start_object();
        ...
        crate::types::ConnectionPropertiesInput::RedshiftProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_5 = object_8.key("redshiftProperties").start_object();
        ...
        crate::types::ConnectionPropertiesInput::SparkEmrProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_6 = object_8.key("sparkEmrProperties").start_object();
        ...
        crate::types::ConnectionPropertiesInput::SparkGlueProperties(inner) => {
            #[allow(unused_mut)]
            let mut object_7 = object_8.key("sparkGlueProperties").start_object();
