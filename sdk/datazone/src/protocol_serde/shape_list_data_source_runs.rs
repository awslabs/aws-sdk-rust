...
pub fn de_list_data_source_runs_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_data_source_runs_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_list_data_source_runs(
    value: &[u8],
    mut builder: crate::operation::list_data_source_runs::builders::ListDataSourceRunsOutputBuilder,
) -> Result<crate::operation::list_data_source_runs::builders::ListDataSourceRunsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "items" => {
                    builder = builder.set_items(crate::protocol_serde::shape_data_source_run_summaries::de_data_source_run_summaries(
                        tokens,
                    )?);
                }
                "nextToken" => {
