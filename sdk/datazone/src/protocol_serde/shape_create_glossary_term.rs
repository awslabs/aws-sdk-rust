...
> {
    Ok({
        ...
        crate::serde_util::create_glossary_term_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_glossary_term::CreateGlossaryTermError::unhandled)?
    })
}
...
pub fn ser_create_glossary_term_input(
    ...
    crate::protocol_serde::shape_create_glossary_term_input::ser_create_glossary_term_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::create_glossary_term::builders::CreateGlossaryTermOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
