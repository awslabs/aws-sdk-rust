...
pub fn ser_group_policy_grant_principal(
    ...
    match input {
        ...
        crate::types::GroupPolicyGrantPrincipal::Unknown => {
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "groupIdentifier" => Some(crate::types::GroupPolicyGrantPrincipal::GroupIdentifier(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                                .transpose()?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'groupIdentifier' cannot be null")
                                })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::GroupPolicyGrantPrincipal::Unknown)
                        }
                    };
                }
                other => {
