...
) -> Result<Option<crate::types::SearchResultItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "assetListing" => Some(crate::types::SearchResultItem::AssetListing(
                            crate::protocol_serde::shape_asset_listing_item::de_asset_listing_item(tokens)?.ok_or_else(|| {
                        ...
                        "dataProductListing" => Some(crate::types::SearchResultItem::DataProductListing(
                            crate::protocol_serde::shape_data_product_listing_item::de_data_product_listing_item(tokens)?.ok_or_else(|| {
