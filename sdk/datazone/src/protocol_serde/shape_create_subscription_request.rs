...
pub fn de_create_subscription_request_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_subscription_request::CreateSubscriptionRequestError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_subscription_request::CreateSubscriptionRequestError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_subscription_request_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::create_subscription_request_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_subscription_request::CreateSubscriptionRequestError::unhandled)?
    })
}

pub fn ser_create_subscription_request_input(
...
pub(crate) fn de_create_subscription_request(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::SubscriptionRequestStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "subscribedListings" => {
