...
pub(crate) fn de_member_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MemberDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            "user" => {
                                Some(crate::types::MemberDetails::User(
                            ...
                            "group" => {
                                Some(crate::types::MemberDetails::Group(
