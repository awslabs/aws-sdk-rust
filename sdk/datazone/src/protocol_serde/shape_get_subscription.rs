...
pub fn de_get_subscription_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_subscription::de_get_subscription(_response_body, output)
            .map_err(crate::operation::get_subscription::GetSubscriptionError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_subscription_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_subscription::GetSubscriptionError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_subscription::builders::GetSubscriptionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
