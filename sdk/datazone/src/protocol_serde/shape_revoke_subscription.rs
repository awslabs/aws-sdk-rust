...
pub fn de_revoke_subscription_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_revoke_subscription_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::revoke_subscription::builders::RevokeSubscriptionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
