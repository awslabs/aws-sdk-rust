                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "user" => Some(crate::types::OwnerPropertiesOutput::User(
                            crate::protocol_serde::shape_owner_user_properties_output::de_owner_user_properties_output(tokens, _value)?
                        ...
                        "group" => Some(crate::types::OwnerPropertiesOutput::Group(
                            crate::protocol_serde::shape_owner_group_properties_output::de_owner_group_properties_output(tokens, _value)?
