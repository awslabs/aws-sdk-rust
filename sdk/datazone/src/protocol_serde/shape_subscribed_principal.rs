                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "project" => Some(crate::types::SubscribedPrincipal::Project(
                            crate::protocol_serde::shape_subscribed_project::de_subscribed_project(tokens, _value)?.ok_or_else(|| {
                        ...
                        "user" => Some(crate::types::SubscribedPrincipal::User(
                            crate::protocol_serde::shape_subscribed_user::de_subscribed_user(tokens, _value)?
                        ...
                        "group" => Some(crate::types::SubscribedPrincipal::Group(
                            crate::protocol_serde::shape_subscribed_group::de_subscribed_group(tokens, _value)?
                        ...
                        "iam" => Some(crate::types::SubscribedPrincipal::Iam(
                            crate::protocol_serde::shape_subscribed_iam_principal::de_subscribed_iam_principal(tokens, _value)?
