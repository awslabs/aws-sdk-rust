...
///     ConnectionStatus::CreateFailed => { /* ... */ },
///     ConnectionStatus::Creating => { /* ... */ },
///     ConnectionStatus::Deleted => { /* ... */ },
///     ConnectionStatus::DeleteFailed => { /* ... */ },
///     ConnectionStatus::Deleting => { /* ... */ },
///     ConnectionStatus::Ready => { /* ... */ },
///     ConnectionStatus::UpdateFailed => { /* ... */ },
...
impl ::std::convert::From<&str> for ConnectionStatus {
    fn from(s: &str) -> Self {
        match s {
            "CREATE_FAILED" => ConnectionStatus::CreateFailed,
            "CREATING" => ConnectionStatus::Creating,
            "DELETED" => ConnectionStatus::Deleted,
            "DELETE_FAILED" => ConnectionStatus::DeleteFailed,
            "DELETING" => ConnectionStatus::Deleting,
            "READY" => ConnectionStatus::Ready,
            "UPDATE_FAILED" => ConnectionStatus::UpdateFailed,
            "UPDATING" => ConnectionStatus::Updating,
            other => ConnectionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectionStatus::from(s))
    }
}
impl ConnectionStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConnectionStatus::CreateFailed => "CREATE_FAILED",
            ConnectionStatus::Creating => "CREATING",
            ConnectionStatus::Deleted => "DELETED",
            ConnectionStatus::DeleteFailed => "DELETE_FAILED",
            ConnectionStatus::Deleting => "DELETING",
            ConnectionStatus::Ready => "READY",
            ConnectionStatus::UpdateFailed => "UPDATE_FAILED",
...
impl ::std::fmt::Display for ConnectionStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ConnectionStatus::CreateFailed => write!(f, "CREATE_FAILED"),
            ConnectionStatus::Creating => write!(f, "CREATING"),
            ConnectionStatus::Deleted => write!(f, "DELETED"),
            ConnectionStatus::DeleteFailed => write!(f, "DELETE_FAILED"),
            ConnectionStatus::Deleting => write!(f, "DELETING"),
            ConnectionStatus::Ready => write!(f, "READY"),
            ConnectionStatus::UpdateFailed => write!(f, "UPDATE_FAILED"),
            ConnectionStatus::Updating => write!(f, "UPDATING"),
