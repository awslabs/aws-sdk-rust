...
pub enum ConnectionPropertiesPatch {
    ...
    LakehouseProperties(crate::types::LakehousePropertiesPatch),
    ...
    SnowflakeProperties(crate::types::SnowflakePropertiesPatch),
...
impl ConnectionPropertiesPatch {
    /// Tries to convert the enum instance into [`AmazonQProperties`](crate::types::ConnectionPropertiesPatch::AmazonQProperties), extracting the inner [`AmazonQPropertiesPatch`](crate::types::AmazonQPropertiesPatch).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_amazon_q_properties(&self) -> ::std::result::Result<&crate::types::AmazonQPropertiesPatch, &Self> {
        if let ConnectionPropertiesPatch::AmazonQProperties(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`AmazonQProperties`](crate::types::ConnectionPropertiesPatch::AmazonQProperties).
    ...
    /// Tries to convert the enum instance into [`LakehouseProperties`](crate::types::ConnectionPropertiesPatch::LakehouseProperties), extracting the inner [`LakehousePropertiesPatch`](crate::types::LakehousePropertiesPatch).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_lakehouse_properties(&self) -> ::std::result::Result<&crate::types::LakehousePropertiesPatch, &Self> {
        if let ConnectionPropertiesPatch::LakehouseProperties(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`LakehouseProperties`](crate::types::ConnectionPropertiesPatch::LakehouseProperties).
    ...
    /// Tries to convert the enum instance into [`SnowflakeProperties`](crate::types::ConnectionPropertiesPatch::SnowflakeProperties), extracting the inner [`SnowflakePropertiesPatch`](crate::types::SnowflakePropertiesPatch).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_snowflake_properties(&self) -> ::std::result::Result<&crate::types::SnowflakePropertiesPatch, &Self> {
        if let ConnectionPropertiesPatch::SnowflakeProperties(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`SnowflakeProperties`](crate::types::ConnectionPropertiesPatch::SnowflakeProperties).
