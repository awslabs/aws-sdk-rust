...
pub struct AmazonQPropertiesInput {
...
impl AmazonQPropertiesInput {
    /// Creates a new builder-style object to manufacture [`AmazonQPropertiesInput`](crate::types::AmazonQPropertiesInput).
    pub fn builder() -> crate::types::builders::AmazonQPropertiesInputBuilder {
        crate::types::builders::AmazonQPropertiesInputBuilder::default()
    }
}

/// A builder for [`AmazonQPropertiesInput`](crate::types::AmazonQPropertiesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AmazonQPropertiesInputBuilder {
    pub(crate) is_enabled: ::std::option::Option<bool>,
    pub(crate) profile_arn: ::std::option::Option<::std::string::String>,
    pub(crate) auth_mode: ::std::option::Option<::std::string::String>,
}
impl AmazonQPropertiesInputBuilder {
    /// <p>Specifies whether Amazon Q is enabled for the connection.</p>
    ...
    /// Consumes the builder and constructs a [`AmazonQPropertiesInput`](crate::types::AmazonQPropertiesInput).
    /// This method will fail if any of the following fields are not set:
    /// - [`is_enabled`](crate::types::builders::AmazonQPropertiesInputBuilder::is_enabled)
    pub fn build(self) -> ::std::result::Result<crate::types::AmazonQPropertiesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::AmazonQPropertiesInput {
            is_enabled: self.is_enabled.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "is_enabled",
                    "is_enabled was not specified but it is required when building AmazonQPropertiesInput",
                )
            })?,
