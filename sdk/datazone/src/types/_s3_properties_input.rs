...
impl S3PropertiesInput {
    /// Creates a new builder-style object to manufacture [`S3PropertiesInput`](crate::types::S3PropertiesInput).
    pub fn builder() -> crate::types::builders::S3PropertiesInputBuilder {
        crate::types::builders::S3PropertiesInputBuilder::default()
    }
}

/// A builder for [`S3PropertiesInput`](crate::types::S3PropertiesInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct S3PropertiesInputBuilder {
    pub(crate) s3_uri: ::std::option::Option<::std::string::String>,
    pub(crate) s3_access_grant_location_id: ::std::option::Option<::std::string::String>,
}
impl S3PropertiesInputBuilder {
    /// <p>The Amazon S3 URI that's part of the Amazon S3 properties of a connection.</p>
    ...
    /// Consumes the builder and constructs a [`S3PropertiesInput`](crate::types::S3PropertiesInput).
    /// This method will fail if any of the following fields are not set:
    /// - [`s3_uri`](crate::types::builders::S3PropertiesInputBuilder::s3_uri)
    pub fn build(self) -> ::std::result::Result<crate::types::S3PropertiesInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::S3PropertiesInput {
            s3_uri: self.s3_uri.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "s3_uri",
                    "s3_uri was not specified but it is required when building S3PropertiesInput",
                )
            })?,
