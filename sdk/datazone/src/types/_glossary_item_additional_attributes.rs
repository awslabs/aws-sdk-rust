...
pub struct GlossaryItemAdditionalAttributes {
...
impl GlossaryItemAdditionalAttributes {
    /// <p>List of rationales indicating why this item was matched by search.</p>
    ///
...
impl GlossaryItemAdditionalAttributes {
    /// Creates a new builder-style object to manufacture [`GlossaryItemAdditionalAttributes`](crate::types::GlossaryItemAdditionalAttributes).
    pub fn builder() -> crate::types::builders::GlossaryItemAdditionalAttributesBuilder {
        crate::types::builders::GlossaryItemAdditionalAttributesBuilder::default()
    }
}

/// A builder for [`GlossaryItemAdditionalAttributes`](crate::types::GlossaryItemAdditionalAttributes).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GlossaryItemAdditionalAttributesBuilder {
    pub(crate) match_rationale: ::std::option::Option<::std::vec::Vec<crate::types::MatchRationaleItem>>,
}
impl GlossaryItemAdditionalAttributesBuilder {
    ...
    /// Consumes the builder and constructs a [`GlossaryItemAdditionalAttributes`](crate::types::GlossaryItemAdditionalAttributes).
    pub fn build(self) -> crate::types::GlossaryItemAdditionalAttributes {
        crate::types::GlossaryItemAdditionalAttributes {
