...
pub struct AmazonQPropertiesOutput {
...
impl AmazonQPropertiesOutput {
    /// Creates a new builder-style object to manufacture [`AmazonQPropertiesOutput`](crate::types::AmazonQPropertiesOutput).
    pub fn builder() -> crate::types::builders::AmazonQPropertiesOutputBuilder {
        crate::types::builders::AmazonQPropertiesOutputBuilder::default()
    }
}

/// A builder for [`AmazonQPropertiesOutput`](crate::types::AmazonQPropertiesOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AmazonQPropertiesOutputBuilder {
    pub(crate) is_enabled: ::std::option::Option<bool>,
    pub(crate) profile_arn: ::std::option::Option<::std::string::String>,
    pub(crate) auth_mode: ::std::option::Option<::std::string::String>,
}
impl AmazonQPropertiesOutputBuilder {
    /// <p>Specifies whether Amazon Q is enabled for the connection.</p>
    ...
    /// Consumes the builder and constructs a [`AmazonQPropertiesOutput`](crate::types::AmazonQPropertiesOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`is_enabled`](crate::types::builders::AmazonQPropertiesOutputBuilder::is_enabled)
    pub fn build(self) -> ::std::result::Result<crate::types::AmazonQPropertiesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::AmazonQPropertiesOutput {
            is_enabled: self.is_enabled.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "is_enabled",
                    "is_enabled was not specified but it is required when building AmazonQPropertiesOutput",
                )
            })?,
