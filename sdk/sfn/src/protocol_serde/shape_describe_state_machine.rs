...
pub fn de_describe_state_machine_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_state_machine::DescribeStateMachineError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "KmsAccessDeniedException" => crate::operation::describe_state_machine::DescribeStateMachineError::KmsAccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KmsInvalidStateException" => crate::operation::describe_state_machine::DescribeStateMachineError::KmsInvalidStateException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "KmsThrottlingException" => crate::operation::describe_state_machine::DescribeStateMachineError::KmsThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_state_machine_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_state_machine::de_describe_state_machine(_response_body, output)
            .map_err(crate::operation::describe_state_machine::DescribeStateMachineError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_state_machine_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_state_machine::DescribeStateMachineError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::StateMachineStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "definition" => {
                ...
                "type" => {
                    builder = builder.set_type(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::StateMachineType::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "creationDate" => {
                ...
                "variableReferences" => {
                    builder = builder.set_variable_references(crate::protocol_serde::shape_variable_references::de_variable_references(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
