...
pub fn ser_list_map_runs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListMapRunsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
