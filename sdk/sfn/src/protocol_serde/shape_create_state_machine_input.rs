...
pub fn ser_create_state_machine_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStateMachineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
