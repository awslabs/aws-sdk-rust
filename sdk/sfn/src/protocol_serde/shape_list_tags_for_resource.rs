...
> {
    ...
    Err(match error_code {
        "InvalidArn" => {
            crate::operation::list_tags_for_resource::ListTagsForResourceError::InvalidArn({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFound" => {
            crate::operation::list_tags_for_resource::ListTagsForResourceError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
