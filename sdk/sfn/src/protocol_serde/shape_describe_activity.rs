...
pub fn de_describe_activity_http_response(
    ...
    Ok({
        ...
        crate::serde_util::describe_activity_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_activity::DescribeActivityError::unhandled)?
    })
}
...
) -> Result<crate::operation::describe_activity::builders::DescribeActivityOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
