...
pub fn ser_describe_activity_input(
    ...
    crate::protocol_serde::shape_describe_activity_input::ser_describe_activity_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_activity::DescribeActivityError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_activity_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_activity::de_describe_activity(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_activity::DescribeActivityError::unhandled)?;
