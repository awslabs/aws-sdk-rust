...
> {
    Ok({
        ...
        crate::serde_util::describe_state_machine_for_execution_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_state_machine_for_execution::DescribeStateMachineForExecutionError::unhandled)?
    })
}
...
pub fn ser_describe_state_machine_for_execution_input(
    ...
    crate::protocol_serde::shape_describe_state_machine_for_execution_input::ser_describe_state_machine_for_execution_input_input(
        &mut object,
        input,
    )?;
    object.finish();
