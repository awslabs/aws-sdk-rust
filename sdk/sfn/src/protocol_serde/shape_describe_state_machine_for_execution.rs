...
> {
    ...
    Err(match error_code {
        "ExecutionDoesNotExist" => {
            crate::operation::describe_state_machine_for_execution::DescribeStateMachineForExecutionError::ExecutionDoesNotExist({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_state_machine_for_execution::de_describe_state_machine_for_execution(_response_body, output)
            .map_err(crate::operation::describe_state_machine_for_execution::DescribeStateMachineForExecutionError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_state_machine_for_execution_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_state_machine_for_execution::DescribeStateMachineForExecutionError::unhandled)?
    })
}
...
pub(crate) fn de_describe_state_machine_for_execution(
    value: &[u8],
