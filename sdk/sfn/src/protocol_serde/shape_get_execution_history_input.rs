...
pub fn ser_get_execution_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetExecutionHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
