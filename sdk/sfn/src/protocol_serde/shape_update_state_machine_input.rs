...
pub fn ser_update_state_machine_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateStateMachineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
