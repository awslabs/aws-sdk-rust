...
pub fn de_redrive_execution_http_response(
    ...
    Ok({
        ...
        crate::serde_util::redrive_execution_output_correct_errors(output)
            .build()
            .map_err(crate::operation::redrive_execution::RedriveExecutionError::unhandled)?
    })
}
...
pub fn ser_redrive_execution_input(
    ...
    crate::protocol_serde::shape_redrive_execution_input::ser_redrive_execution_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::redrive_execution::builders::RedriveExecutionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
