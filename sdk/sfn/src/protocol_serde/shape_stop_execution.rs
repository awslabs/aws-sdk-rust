...
pub fn de_stop_execution_http_response(
    ...
    Ok({
        ...
        crate::serde_util::stop_execution_output_correct_errors(output)
            .build()
            .map_err(crate::operation::stop_execution::StopExecutionError::unhandled)?
    })
}
...
) -> Result<crate::operation::stop_execution::builders::StopExecutionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
