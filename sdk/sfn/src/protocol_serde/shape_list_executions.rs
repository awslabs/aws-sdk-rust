...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFound" => {
            crate::operation::list_executions::ListExecutionsError::ResourceNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "StateMachineDoesNotExist" => {
            crate::operation::list_executions::ListExecutionsError::StateMachineDoesNotExist({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "StateMachineTypeNotSupported" => {
            crate::operation::list_executions::ListExecutionsError::StateMachineTypeNotSupported({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
