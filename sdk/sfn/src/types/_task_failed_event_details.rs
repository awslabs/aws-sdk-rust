...
impl TaskFailedEventDetailsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::TaskFailedEventDetails, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::TaskFailedEventDetails {
                resource_type: self.resource_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_type", "resource_type was not specified but it is required when building TaskFailedEventDetails")
                    )?
                ,
                resource: self.resource
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource", "resource was not specified but it is required when building TaskFailedEventDetails")
                    )?
                ,
                error: self.error
                ,
