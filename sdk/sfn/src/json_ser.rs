...
pub fn serialize_structure_create_activity_input(
...
pub fn serialize_structure_create_state_machine_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_10) = &input.logging_configuration {
        ...
        crate::json_ser::serialize_structure_logging_configuration(&mut object_11, var_10);
        object_11.finish();
    }
    ...
    if let Some(var_16) = &input.tracing_configuration {
        ...
        crate::json_ser::serialize_structure_tracing_configuration(&mut object_17, var_16);
        object_17.finish();
    }
}

pub fn serialize_structure_delete_activity_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_state_machine_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_activity_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_state_machine_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_state_machine_for_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_activity_task_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_execution_history_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_activities_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_executions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_state_machines_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_send_task_failure_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_send_task_heartbeat_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_send_task_success_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_sync_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_execution_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_state_machine_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_64) = &input.logging_configuration {
        ...
        crate::json_ser::serialize_structure_logging_configuration(&mut object_65, var_64);
        object_65.finish();
    }
    if let Some(var_66) = &input.tracing_configuration {
        let mut object_67 = object.key("tracingConfiguration").start_object();
        crate::json_ser::serialize_structure_tracing_configuration(&mut object_67, var_66);
        object_67.finish();
    }
}
        ...
        for item_73 in var_71 {
            {
                ...
                crate::json_ser::serialize_structure_log_destination(&mut object_74, item_73);
                object_74.finish();
            }
        }
        array_72.finish();
...
pub fn serialize_structure_tracing_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_log_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_75) = &input.cloud_watch_logs_log_group {
        ...
        crate::json_ser::serialize_structure_cloud_watch_logs_log_group(&mut object_76, var_75);
        object_76.finish();
    }
}

pub fn serialize_structure_cloud_watch_logs_log_group(
    object: &mut smithy_json::serialize::JsonObjectWriter,
