...
impl super::Client {
    ...
    ///   - [`activity_arn(impl Into<String>)`](crate::operation::describe_activity::builders::DescribeActivityFluentBuilder::activity_arn) / [`set_activity_arn(Option<String>)`](crate::operation::describe_activity::builders::DescribeActivityFluentBuilder::set_activity_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the activity to describe.</p><br>
