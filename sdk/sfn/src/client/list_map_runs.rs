...
impl super::Client {
    ...
    ///   - [`execution_arn(impl ::std::convert::Into<String>)`](crate::operation::list_map_runs::builders::ListMapRunsFluentBuilder::execution_arn) / [`set_execution_arn(Option<String>)`](crate::operation::list_map_runs::builders::ListMapRunsFluentBuilder::set_execution_arn): <p>The Amazon Resource Name (ARN) of the execution for which the Map Runs must be listed.</p>
    ///   - [`max_results(i32)`](crate::operation::list_map_runs::builders::ListMapRunsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_map_runs::builders::ListMapRunsFluentBuilder::set_max_results): <p>The maximum number of results that are returned per call. You can use <code>nextToken</code> to obtain further pages of results. The default is 100 and the maximum allowed page size is 1000. A value of 0 uses the default.</p>  <p>This is only an upper limit. The actual number of results returned per call might be fewer than the specified maximum.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_map_runs::builders::ListMapRunsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_map_runs::builders::ListMapRunsFluentBuilder::set_next_token): <p>If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an <i>HTTP 400 InvalidToken</i> error.</p>
