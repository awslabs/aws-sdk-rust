...
impl super::Client {
    ...
    ///   - [`activity_arn(impl ::std::convert::Into<String>)`](crate::operation::get_activity_task::builders::GetActivityTaskFluentBuilder::activity_arn) / [`set_activity_arn(Option<String>)`](crate::operation::get_activity_task::builders::GetActivityTaskFluentBuilder::set_activity_arn): <p>The Amazon Resource Name (ARN) of the activity to retrieve tasks from (assigned when you create the task using <code>CreateActivity</code>.)</p>
    ///   - [`worker_name(impl ::std::convert::Into<String>)`](crate::operation::get_activity_task::builders::GetActivityTaskFluentBuilder::worker_name) / [`set_worker_name(Option<String>)`](crate::operation::get_activity_task::builders::GetActivityTaskFluentBuilder::set_worker_name): <p>You can provide an arbitrary name in order to identify the worker that the task is assigned to. This name is used when it is logged in the execution history.</p>
