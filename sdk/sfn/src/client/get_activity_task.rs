...
impl super::Client {
    ...
    ///   - [`worker_name(impl Into<String>)`](crate::operation::get_activity_task::builders::GetActivityTaskFluentBuilder::worker_name) / [`set_worker_name(Option<String>)`](crate::operation::get_activity_task::builders::GetActivityTaskFluentBuilder::set_worker_name):<br>required: **false**<br><p>You can provide an arbitrary name in order to identify the worker that the task is assigned to. This name is used when it is logged in the execution history.</p><br>
