...
impl super::Client {
    ...
    ///   - [`activity_arn(impl Into<String>)`](crate::operation::delete_activity::builders::DeleteActivityFluentBuilder::activity_arn) / [`set_activity_arn(Option<String>)`](crate::operation::delete_activity::builders::DeleteActivityFluentBuilder::set_activity_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the activity to delete.</p><br>
