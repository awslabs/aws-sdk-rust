...
impl super::Client {
    ...
    ///   - [`state_machine_arn(impl ::std::convert::Into<String>)`](crate::operation::publish_state_machine_version::builders::PublishStateMachineVersionFluentBuilder::state_machine_arn) / [`set_state_machine_arn(Option<String>)`](crate::operation::publish_state_machine_version::builders::PublishStateMachineVersionFluentBuilder::set_state_machine_arn): <p>The Amazon Resource Name (ARN) of the state machine.</p>
    ///   - [`revision_id(impl ::std::convert::Into<String>)`](crate::operation::publish_state_machine_version::builders::PublishStateMachineVersionFluentBuilder::revision_id) / [`set_revision_id(Option<String>)`](crate::operation::publish_state_machine_version::builders::PublishStateMachineVersionFluentBuilder::set_revision_id): <p>Only publish the state machine version if the current state machine's revision ID matches the specified ID.</p>  <p>Use this option to avoid publishing a version if the state machine changed since you last updated it. If the specified revision ID doesn't match the state machine's current revision ID, the API returns <code>ConflictException</code>.</p> <note>   <p>To specify an initial revision ID for a state machine with no revision ID assigned, specify the string <code>INITIAL</code> for the <code>revisionId</code> parameter. For example, you can specify a <code>revisionID</code> of <code>INITIAL</code> when you create a state machine using the <code>CreateStateMachine</code> API action.</p>  </note>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::publish_state_machine_version::builders::PublishStateMachineVersionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::publish_state_machine_version::builders::PublishStateMachineVersionFluentBuilder::set_description): <p>An optional description of the state machine version.</p>
