...
impl super::Client {
    ...
    ///   - [`publish(bool)`](crate::operation::update_state_machine::builders::UpdateStateMachineFluentBuilder::publish) / [`set_publish(Option<bool>)`](crate::operation::update_state_machine::builders::UpdateStateMachineFluentBuilder::set_publish): <p>Specifies whether the state machine version is published. The default is <code>false</code>. To publish a version after updating the state machine, set <code>publish</code> to <code>true</code>.</p>
    ///   - [`version_description(impl ::std::convert::Into<String>)`](crate::operation::update_state_machine::builders::UpdateStateMachineFluentBuilder::version_description) / [`set_version_description(Option<String>)`](crate::operation::update_state_machine::builders::UpdateStateMachineFluentBuilder::set_version_description): <p>An optional description of the state machine version to publish.</p>  <p>You can only specify the <code>versionDescription</code> parameter if you've set <code>publish</code> to <code>true</code>.</p>
