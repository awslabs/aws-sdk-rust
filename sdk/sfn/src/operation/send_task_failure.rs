...
impl SendTaskFailureInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_task_failure::SendTaskFailure, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_task_failure::ser_send_task_failure_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendTaskFailure {
    type Output =
        ::std::result::Result<crate::operation::send_task_failure::SendTaskFailureOutput, crate::operation::send_task_failure::SendTaskFailureError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_task_failure::de_send_task_failure_http_response_with_props(status, headers, body)
        }
    }
}
