...
impl SendTaskFailureInput {
    /// Consumes the builder and constructs an Operation<[`SendTaskFailure`](crate::operation::send_task_failure::SendTaskFailure)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_task_failure::SendTaskFailure, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_task_failure::SendTaskFailureInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_send_task_failure::ser_send_task_failure_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_task_failure::SendTaskFailure::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SendTaskFailure", "sfn"));
...
impl aws_smithy_http::response::ParseStrictResponse for SendTaskFailure {
                type Output = std::result::Result<crate::operation::send_task_failure::SendTaskFailureOutput, crate::operation::send_task_failure::SendTaskFailureError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_send_task_failure::de_send_task_failure_http_error(response)
                     } else {
                        crate::protocol_serde::shape_send_task_failure::de_send_task_failure_http_response(response)
                     }
                }
            }
