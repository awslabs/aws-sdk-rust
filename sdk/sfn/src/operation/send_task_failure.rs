...
impl SendTaskFailureInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::send_task_failure::SendTaskFailure,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_task_failure::SendTaskFailure::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for SendTaskFailure {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_send_task_failure::de_send_task_failure_http_error(
                status, headers, body,
            )
        } else {
