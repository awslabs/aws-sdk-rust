...
impl DeleteActivityInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_activity::DeleteActivity::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteActivity {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_activity::de_delete_activity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_activity::de_delete_activity_http_response(
                status, headers, body,
            )
        }
    }
