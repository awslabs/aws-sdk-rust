...
impl DeleteStateMachineAliasInput {
    /// Consumes the builder and constructs an Operation<[`DeleteStateMachineAlias`](crate::operation::delete_state_machine_alias::DeleteStateMachineAlias)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_state_machine_alias::ser_delete_state_machine_alias_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_state_machine_alias::DeleteStateMachineAlias::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteStateMachineAlias", "sfn"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStateMachineAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_state_machine_alias::de_delete_state_machine_alias_http_response_with_props(status, headers, body)
        }
    }
}
