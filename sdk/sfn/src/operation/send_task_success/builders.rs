...
impl SendTaskSuccessInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.send_task_success();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::send_task_success::SendTaskSuccessOutput,
                    crate::operation::send_task_success::SendTaskSuccessError,
                > for SendTaskSuccessFluentBuilder
            {
                fn send(
                    self,
...
impl SendTaskSuccessFluentBuilder {
    ...
    /// Access the SendTaskSuccess as a reference.
    pub fn as_input(&self) -> &crate::operation::send_task_success::builders::SendTaskSuccessInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::send_task_success::SendTaskSuccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_task_success::SendTaskSuccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::send_task_success::SendTaskSuccess::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::send_task_success::SendTaskSuccess::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::send_task_success::SendTaskSuccessOutput, crate::operation::send_task_success::SendTaskSuccessError, Self> {
