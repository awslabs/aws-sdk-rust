...
impl SendTaskSuccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_task_success::SendTaskSuccess, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_task_success::ser_send_task_success_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendTaskSuccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_task_success::de_send_task_success_http_response_with_props(status, headers, body)
        }
    }
}
