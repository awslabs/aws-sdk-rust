...
impl GetExecutionHistoryInput {
    /// Consumes the builder and constructs an Operation<[`GetExecutionHistory`](crate::operation::get_execution_history::GetExecutionHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_execution_history::GetExecutionHistory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_execution_history::GetExecutionHistoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_execution_history::ser_get_execution_history_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_execution_history::GetExecutionHistory::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetExecutionHistory", "sfn"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetExecutionHistory {
                type Output = std::result::Result<crate::operation::get_execution_history::GetExecutionHistoryOutput, crate::operation::get_execution_history::GetExecutionHistoryError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_execution_history::de_get_execution_history_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_execution_history::de_get_execution_history_http_response(response)
                     }
                }
            }
