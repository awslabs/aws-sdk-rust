...
impl GetExecutionHistoryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_execution_history::ser_get_execution_history_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_execution_history::GetExecutionHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetExecutionHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_execution_history::de_get_execution_history_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_execution_history::GetExecutionHistoryError
{
