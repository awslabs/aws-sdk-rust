...
/// Orchestration and serialization glue logic for `TestState`.
...
impl TestState {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::test_state::TestStateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_state::TestStateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::test_state::TestStateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::test_state::TestStateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TestState {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TestState");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TestStateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TestStateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TestState")
...
.with_interceptor(TestStateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::test_state::TestStateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::test_state::TestStateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::test_state::TestStateError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_test_state::de_test_state_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_test_state::de_test_state_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct TestStateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TestStateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::test_state::TestStateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::test_state::TestStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_test_state::ser_test_state_input(&input)?);
...
#[derive(Debug)]
            struct TestStateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TestStateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TestStateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TestStateInput>()
                        .ok_or("failed to downcast to TestStateInput")?;
...
/// Error type for the `TestStateError` operation.
#[non_exhaustive]
...
pub enum TestStateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TestStateError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl TestStateError {
    /// Creates the `TestStateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TestStateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `TestStateError::InvalidArn`.
    pub fn is_invalid_arn(&self) -> bool {
        matches!(self, Self::InvalidArn(_))
    }
    /// Returns `true` if the error kind is `TestStateError::InvalidDefinition`.
    pub fn is_invalid_definition(&self) -> bool {
        matches!(self, Self::InvalidDefinition(_))
    }
    /// Returns `true` if the error kind is `TestStateError::InvalidExecutionInput`.
    pub fn is_invalid_execution_input(&self) -> bool {
        matches!(self, Self::InvalidExecutionInput(_))
    }
    /// Returns `true` if the error kind is `TestStateError::ValidationException`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for TestStateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for TestStateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TestStateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::test_state::TestStateError {
