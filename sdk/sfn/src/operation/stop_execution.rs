...
impl StopExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_execution::StopExecution, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_execution::ser_stop_execution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_execution::de_stop_execution_http_response_with_props(status, headers, body)
        }
    }
}
