...
impl ListStateMachinesInput {
    /// Consumes the builder and constructs an Operation<[`ListStateMachines`](crate::operation::list_state_machines::ListStateMachines)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_state_machines::ListStateMachines, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_state_machines::ListStateMachinesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_state_machines::ser_list_state_machines_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_state_machines::ListStateMachines::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListStateMachines", "sfn"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListStateMachines`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListStateMachines {
                type Output = std::result::Result<crate::operation::list_state_machines::ListStateMachinesOutput, crate::operation::list_state_machines::ListStateMachinesError>;
