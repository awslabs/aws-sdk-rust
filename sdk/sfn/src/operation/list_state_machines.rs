...
impl ListStateMachinesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_state_machines::ser_list_state_machines_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStateMachines {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_state_machines::de_list_state_machines_http_response_with_props(status, headers, body)
        }
    }
}
