...
impl UpdateMapRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_map_run::UpdateMapRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_map_run::ser_update_map_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMapRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_map_run::de_update_map_run_http_response_with_props(status, headers, body)
        }
    }
}
