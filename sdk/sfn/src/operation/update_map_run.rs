...
impl UpdateMapRunInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_map_run::UpdateMapRun::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMapRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_map_run::de_update_map_run_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_map_run::de_update_map_run_http_response_with_props(
                status, headers, body,
            )
        }
    }
