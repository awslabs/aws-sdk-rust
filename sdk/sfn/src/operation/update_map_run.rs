...
impl UpdateMapRunInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMapRun`](crate::operation::update_map_run::UpdateMapRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_map_run::UpdateMapRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_map_run::UpdateMapRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_map_run::ser_update_map_run_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_map_run::UpdateMapRun::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateMapRun", "sfn"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateMapRun`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMapRun {
                type Output = std::result::Result<crate::operation::update_map_run::UpdateMapRunOutput, crate::operation::update_map_run::UpdateMapRunError>;
