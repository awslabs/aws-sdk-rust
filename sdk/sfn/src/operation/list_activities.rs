...
impl ListActivitiesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_activities::ListActivities, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_activities::ser_list_activities_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListActivities {
    type Output =
        ::std::result::Result<crate::operation::list_activities::ListActivitiesOutput, crate::operation::list_activities::ListActivitiesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_activities::de_list_activities_http_response_with_props(status, headers, body)
        }
    }
}
