...
impl DescribeActivityInput {
    /// Consumes the builder and constructs an Operation<[`DescribeActivity`](crate::operation::describe_activity::DescribeActivity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_activity::DescribeActivity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_activity::DescribeActivityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_activity::ser_describe_activity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_activity::DescribeActivity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeActivity", "sfn"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeActivity {
                type Output = std::result::Result<crate::operation::describe_activity::DescribeActivityOutput, crate::operation::describe_activity::DescribeActivityError>;
