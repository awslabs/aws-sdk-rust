...
impl DescribeActivityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_activity::DescribeActivity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_activity::ser_describe_activity_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeActivity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_activity::de_describe_activity_http_response_with_props(status, headers, body)
        }
    }
}
