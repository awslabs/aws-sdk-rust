...
impl DescribeStateMachineForExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_state_machine_for_execution::DescribeStateMachineForExecution,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_state_machine_for_execution::DescribeStateMachineForExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStateMachineForExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_state_machine_for_execution::de_describe_state_machine_for_execution_http_response_with_props(
                status, headers, body,
            )
        }
    }
