...
impl StartExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_execution::StartExecution, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_execution::ser_start_execution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_execution::de_start_execution_http_response_with_props(status, headers, body)
        }
    }
}
