...
impl CreateActivityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_activity::CreateActivity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_activity::ser_create_activity_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateActivity {
    type Output =
        ::std::result::Result<crate::operation::create_activity::CreateActivityOutput, crate::operation::create_activity::CreateActivityError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_activity::de_create_activity_http_response_with_props(status, headers, body)
        }
    }
}
