...
impl CreateStateMachineAliasInput {
    /// Consumes the builder and constructs an Operation<[`CreateStateMachineAlias`](crate::operation::create_state_machine_alias::CreateStateMachineAlias)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_state_machine_alias::ser_create_state_machine_alias_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_state_machine_alias::CreateStateMachineAlias::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStateMachineAlias", "sfn"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStateMachineAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_state_machine_alias::de_create_state_machine_alias_http_response_with_props(status, headers, body)
        }
    }
}
