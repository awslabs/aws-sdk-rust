    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_state_machine_alias::CreateStateMachineAliasError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_state_machine_alias::CreateStateMachineAliasOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateStateMachineAliasResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateStateMachineAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_state_machine_alias::CreateStateMachineAliasInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateStateMachineAliasEndpointParamsInterceptor {
...
pub type CreateStateMachineAliasErrorKind = CreateStateMachineAliasError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateStateMachineAliasError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_state_machine_alias::CreateStateMachineAliasError {
...
impl CreateStateMachineAliasError {
    ...
    /// Creates the `CreateStateMachineAliasError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
