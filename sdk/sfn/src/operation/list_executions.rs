...
impl ListExecutionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_executions::ser_list_executions_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_executions::ListExecutions::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListExecutions", "sfn"));
