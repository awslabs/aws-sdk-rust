...
impl  ListStateMachinesOutput  {
    ...
    pub fn state_machines(&self) -> & [crate::types::StateMachineListItem] {
        use std::ops::Deref; self.state_machines.deref()
    }
    /// <p>If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an <i>HTTP 400 InvalidToken</i> error.</p>
...
impl ListStateMachinesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_state_machines::ListStateMachinesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_state_machines::ListStateMachinesOutput {
                state_machines: self.state_machines
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("state_machines", "state_machines was not specified but it is required when building ListStateMachinesOutput")
                    )?
                ,
