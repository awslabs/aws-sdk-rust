...
impl ListMapRunsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_map_runs::ListMapRuns::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMapRuns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_map_runs::de_list_map_runs_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_map_runs::de_list_map_runs_http_response_with_props(
                status, headers, body,
            )
        }
    }
