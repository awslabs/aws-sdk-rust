...
impl ListStateMachineAliases {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_state_machine_aliases::ListStateMachineAliasesError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_state_machine_aliases::ListStateMachineAliasesOutput>::assume_from(
                output,
            )
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("sfn", "ListStateMachineAliases", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListStateMachineAliases {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListStateMachineAliases", "sfn"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListStateMachineAliasesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListStateMachineAliasesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_state_machine_aliases::ListStateMachineAliasesInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_state_machine_aliases::ListStateMachineAliasesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_state_machine_aliases::ser_list_state_machine_aliases_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListStateMachineAliasesEndpointParamsInterceptor {
...
pub type ListStateMachineAliasesErrorKind = ListStateMachineAliasesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListStateMachineAliasesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_state_machine_aliases::ListStateMachineAliasesError {
...
impl ListStateMachineAliasesError {
    ...
    /// Creates the `ListStateMachineAliasesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
