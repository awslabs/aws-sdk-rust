...
impl ListStateMachineAliasesInput {
    /// Consumes the builder and constructs an Operation<[`ListStateMachineAliases`](crate::operation::list_state_machine_aliases::ListStateMachineAliases)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_state_machine_aliases::ser_list_state_machine_aliases_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_state_machine_aliases::ListStateMachineAliases::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListStateMachineAliases", "sfn"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStateMachineAliases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_state_machine_aliases::de_list_state_machine_aliases_http_response_with_props(status, headers, body)
        }
    }
}
