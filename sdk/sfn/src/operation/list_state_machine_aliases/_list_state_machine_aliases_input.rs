...
impl ListStateMachineAliasesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_state_machine_aliases::ListStateMachineAliasesInput, ::aws_smithy_types::error::operation::BuildError> {
