...
impl DescribeMapRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_map_run::DescribeMapRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_map_run::ser_describe_map_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMapRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_map_run::de_describe_map_run_http_response_with_props(status, headers, body)
        }
    }
}
