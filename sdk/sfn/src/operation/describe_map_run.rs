...
impl DescribeMapRunInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMapRun`](crate::operation::describe_map_run::DescribeMapRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_map_run::DescribeMapRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_map_run::DescribeMapRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_map_run::ser_describe_map_run_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_map_run::DescribeMapRun::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeMapRun", "sfn"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMapRun {
                type Output = std::result::Result<crate::operation::describe_map_run::DescribeMapRunOutput, crate::operation::describe_map_run::DescribeMapRunError>;
