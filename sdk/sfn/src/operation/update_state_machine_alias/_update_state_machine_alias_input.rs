...
impl UpdateStateMachineAliasInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_state_machine_alias::UpdateStateMachineAliasInput, ::aws_smithy_types::error::operation::BuildError> {
