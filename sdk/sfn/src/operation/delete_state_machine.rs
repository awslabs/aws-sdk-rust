...
impl DeleteStateMachineInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_state_machine::ser_delete_state_machine_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_state_machine::DeleteStateMachine::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStateMachine {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_state_machine::de_delete_state_machine_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_state_machine::DeleteStateMachineError
{
