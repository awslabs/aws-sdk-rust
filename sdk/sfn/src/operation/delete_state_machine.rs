...
impl DeleteStateMachineInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_state_machine::ser_delete_state_machine_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStateMachine {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_state_machine::de_delete_state_machine_http_response_with_props(status, headers, body)
        }
    }
}
