...
/// Orchestration and serialization glue logic for `DeleteStateMachine`.
...
impl DeleteStateMachine {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_state_machine::DeleteStateMachineInput,
                    ) -> ::std::result::Result<crate::operation::delete_state_machine::DeleteStateMachineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_state_machine::DeleteStateMachineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_state_machine::DeleteStateMachineError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_state_machine::DeleteStateMachineOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteStateMachine {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteStateMachine");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteStateMachineRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteStateMachineResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteStateMachine")
...
.with_interceptor(DeleteStateMachineEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_state_machine::DeleteStateMachineError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_state_machine::DeleteStateMachineError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_state_machine::DeleteStateMachineError>::new());
...
#[derive(Debug)]
            struct DeleteStateMachineResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteStateMachineResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_state_machine::de_delete_state_machine_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_state_machine::de_delete_state_machine_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteStateMachineRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteStateMachineRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_state_machine::DeleteStateMachineInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_state_machine::DeleteStateMachineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_state_machine::ser_delete_state_machine_input(&input)?);
...
#[derive(Debug)]
            struct DeleteStateMachineEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteStateMachineEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteStateMachineEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteStateMachineInput>()
                        .ok_or("failed to downcast to DeleteStateMachineInput")?;
...
pub enum DeleteStateMachineError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteStateMachineError) for what information is available for the error.")]
...
impl DeleteStateMachineError {
    /// Creates the `DeleteStateMachineError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteStateMachineError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteStateMachineError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_state_machine::DeleteStateMachineError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_state_machine::_delete_state_machine_output::DeleteStateMachineOutput;

pub use crate::operation::delete_state_machine::_delete_state_machine_input::DeleteStateMachineInput;

mod _delete_state_machine_input;

mod _delete_state_machine_output;
