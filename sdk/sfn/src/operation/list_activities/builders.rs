...
impl ListActivitiesFluentBuilder  {
    /// Creates a new `ListActivities`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_activities::ListActivitiesOutput, aws_smithy_http::result::SdkError<crate::operation::list_activities::ListActivitiesError>>
                     {
