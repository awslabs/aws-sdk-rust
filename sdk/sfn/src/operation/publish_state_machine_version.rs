...
impl PublishStateMachineVersionInput {
    /// Consumes the builder and constructs an Operation<[`PublishStateMachineVersion`](crate::operation::publish_state_machine_version::PublishStateMachineVersion)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_publish_state_machine_version::ser_publish_state_machine_version_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::publish_state_machine_version::PublishStateMachineVersion::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("PublishStateMachineVersion", "sfn"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishStateMachineVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_publish_state_machine_version::de_publish_state_machine_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
