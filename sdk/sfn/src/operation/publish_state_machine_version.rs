...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishStateMachineVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_publish_state_machine_version::de_publish_state_machine_version_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::publish_state_machine_version::PublishStateMachineVersionError
{
