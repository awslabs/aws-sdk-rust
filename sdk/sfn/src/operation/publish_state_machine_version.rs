    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::publish_state_machine_version::PublishStateMachineVersionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::publish_state_machine_version::PublishStateMachineVersionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PublishStateMachineVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PublishStateMachineVersion", "sfn"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PublishStateMachineVersion")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PublishStateMachineVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PublishStateMachineVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::publish_state_machine_version::PublishStateMachineVersionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PublishStateMachineVersionEndpointParamsInterceptor {
...
pub type PublishStateMachineVersionErrorKind = PublishStateMachineVersionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for PublishStateMachineVersionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::publish_state_machine_version::PublishStateMachineVersionError {
...
impl PublishStateMachineVersionError {
    ...
    /// Creates the `PublishStateMachineVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
