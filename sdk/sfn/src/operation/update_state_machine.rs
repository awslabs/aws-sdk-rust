...
impl UpdateStateMachineInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_state_machine::UpdateStateMachine, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_state_machine::UpdateStateMachineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_state_machine::ser_update_state_machine_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_state_machine::UpdateStateMachine::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateStateMachine", "sfn"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateStateMachine {
                type Output = std::result::Result<crate::operation::update_state_machine::UpdateStateMachineOutput, crate::operation::update_state_machine::UpdateStateMachineError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_state_machine::de_update_state_machine_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_state_machine::de_update_state_machine_http_response(response)
                     }
                }
            }
