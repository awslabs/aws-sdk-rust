...
impl SendTaskHeartbeatInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_task_heartbeat::ser_send_task_heartbeat_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendTaskHeartbeat {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_task_heartbeat::de_send_task_heartbeat_http_response_with_props(status, headers, body)
        }
    }
}
