...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartSyncExecution {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartSyncExecution", "sfn"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartSyncExecutionEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let endpoint_prefix = ::aws_smithy_http::endpoint::EndpointPrefix::new("sync-").map_err(|err| {
