...
impl StartSyncExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_sync_execution::ser_start_sync_execution_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_sync_execution::StartSyncExecution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSyncExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_sync_execution::de_start_sync_execution_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_sync_execution::StartSyncExecutionError
{
