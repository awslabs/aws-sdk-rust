...
impl DescribeStateMachineInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_state_machine::ser_describe_state_machine_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_state_machine::DescribeStateMachine::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_state_machine::DescribeStateMachineError
{
