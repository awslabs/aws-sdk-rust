...
pub struct StartSyncExecutionOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::SyncExecutionStatus>,
    ...
    #[doc(hidden)]pub input_details: std::option::Option<crate::model::CloudWatchEventsExecutionDataDetails>,
    ...
    /// <p>Provides details about execution input or output.</p>
    #[doc(hidden)]pub output_details: std::option::Option<crate::model::CloudWatchEventsExecutionDataDetails>,
    ...
    #[doc(hidden)]pub billing_details: std::option::Option<crate::model::BillingDetails>,
}
...
pub struct ListStateMachinesOutput  {
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub state_machines: std::option::Option<std::vec::Vec<crate::model::StateMachineListItem>>,
...
pub struct ListExecutionsOutput  {
    ...
    #[doc(hidden)]pub executions: std::option::Option<std::vec::Vec<crate::model::ExecutionListItem>>,
    /// <p>If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an <i>HTTP 400 InvalidToken</i> error.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListActivitiesOutput  {
    ...
    #[doc(hidden)]pub activities: std::option::Option<std::vec::Vec<crate::model::ActivityListItem>>,
    /// <p>If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an <i>HTTP 400 InvalidToken</i> error.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetExecutionHistoryOutput  {
    ...
    #[doc(hidden)]pub events: std::option::Option<std::vec::Vec<crate::model::HistoryEvent>>,
    /// <p>If <code>nextToken</code> is returned, there are more results available. The value of <code>nextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. Using an expired pagination token will return an <i>HTTP 400 InvalidToken</i> error.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetActivityTaskOutput  {
    ...
    #[doc(hidden)]pub task_token: std::option::Option<std::string::String>,
...
pub struct DescribeStateMachineForExecutionOutput  {
    ...
    #[doc(hidden)]pub tracing_configuration: std::option::Option<crate::model::TracingConfiguration>,
}
...
pub struct DescribeStateMachineOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::StateMachineStatus>,
    /// <p>The Amazon States Language definition of the state machine. See <a href="https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html">Amazon States Language</a>.</p>
    #[doc(hidden)]pub definition: std::option::Option<std::string::String>,
