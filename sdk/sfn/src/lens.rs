...
pub(crate) fn reflens_get_execution_history_output_output_next_token(
...
pub(crate) fn reflens_list_activities_output_output_next_token(
...
pub(crate) fn reflens_list_map_runs_output_output_next_token(
...
pub(crate) fn reflens_list_state_machines_output_output_next_token(
...
pub(crate) fn lens_get_execution_history_output_output_events(
    input: crate::operation::get_execution_history::GetExecutionHistoryOutput,
...
pub(crate) fn lens_list_activities_output_output_activities(
    input: crate::operation::list_activities::ListActivitiesOutput,
...
pub(crate) fn lens_list_map_runs_output_output_map_runs(
    input: crate::operation::list_map_runs::ListMapRunsOutput,
...
pub(crate) fn lens_list_state_machines_output_output_state_machines(
    input: crate::operation::list_state_machines::ListStateMachinesOutput,
