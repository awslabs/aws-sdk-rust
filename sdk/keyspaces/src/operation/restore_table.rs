...
impl RestoreTableInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::restore_table::RestoreTable, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_restore_table::ser_restore_table_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_table::de_restore_table_http_response_with_props(status, headers, body)
        }
    }
}
