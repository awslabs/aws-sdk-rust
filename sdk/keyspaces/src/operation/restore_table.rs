...
impl RestoreTableInput {
    /// Consumes the builder and constructs an Operation<[`RestoreTable`](crate::operation::restore_table::RestoreTable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_table::RestoreTable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_table::RestoreTableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_table::RestoreTable::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreTable {
                type Output = std::result::Result<crate::operation::restore_table::RestoreTableOutput, crate::operation::restore_table::RestoreTableError>;
