...
impl RestoreTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_table::RestoreTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_restore_table::de_restore_table_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_restore_table::de_restore_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
