...
impl CreateKeyspaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_keyspace::CreateKeyspace,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_keyspace::CreateKeyspace::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateKeyspace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_keyspace::de_create_keyspace_http_error(
                status, headers, body,
            )
        } else {
