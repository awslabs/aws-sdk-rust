...
impl CreateKeyspaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_keyspace::CreateKeyspace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_keyspace::ser_create_keyspace_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateKeyspace {
    type Output =
        ::std::result::Result<crate::operation::create_keyspace::CreateKeyspaceOutput, crate::operation::create_keyspace::CreateKeyspaceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_keyspace::de_create_keyspace_http_response_with_props(status, headers, body)
        }
    }
}
