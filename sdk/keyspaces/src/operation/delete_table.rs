...
impl DeleteTableInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_table::DeleteTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_table::de_delete_table_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_table::de_delete_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
