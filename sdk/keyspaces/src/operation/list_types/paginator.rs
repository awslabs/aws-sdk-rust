...
/// Paginator for [`ListTypes`](crate::operation::list_types::ListTypes)
pub struct ListTypesPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_types::builders::ListTypesInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListTypesPaginator {
    /// Create a new paginator-wrapper
    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_types::builders::ListTypesInputBuilder) -> Self {
        Self {
            handle,
            builder,
    ...
    pub fn items(self) -> crate::operation::list_types::paginator::ListTypesPaginatorItems {
        crate::operation::list_types::paginator::ListTypesPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_types::ListTypes::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_types_output_output_next_token(resp);
...
impl ListTypesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_types_output_output_types(page).unwrap_or_default().into_iter())
    }
}
