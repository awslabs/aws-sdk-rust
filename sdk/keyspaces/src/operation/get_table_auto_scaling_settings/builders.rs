...
impl GetTableAutoScalingSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsOutput, crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError, Self> {
