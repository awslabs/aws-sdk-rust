...
impl ListKeyspacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_keyspaces::ListKeyspaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_keyspaces::ser_list_keyspaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListKeyspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_keyspaces::de_list_keyspaces_http_response_with_props(status, headers, body)
        }
    }
}
