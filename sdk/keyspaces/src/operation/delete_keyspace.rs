...
impl DeleteKeyspaceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteKeyspace`](crate::operation::delete_keyspace::DeleteKeyspace)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_keyspace::DeleteKeyspace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_keyspace::ser_delete_keyspace_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_keyspace::DeleteKeyspace::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteKeyspace {
    type Output =
        ::std::result::Result<crate::operation::delete_keyspace::DeleteKeyspaceOutput, crate::operation::delete_keyspace::DeleteKeyspaceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_keyspace::de_delete_keyspace_http_response_with_props(status, headers, body)
        }
    }
}
