...
impl DeleteKeyspaceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_keyspace::DeleteKeyspace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_keyspace::DeleteKeyspaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteKeyspace {
                type Output = std::result::Result<crate::operation::delete_keyspace::DeleteKeyspaceOutput, crate::operation::delete_keyspace::DeleteKeyspaceError>;
