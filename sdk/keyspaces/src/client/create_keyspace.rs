...
impl super::Client {
    ...
    ///   - [`keyspace_name(impl Into<String>)`](crate::operation::create_keyspace::builders::CreateKeyspaceFluentBuilder::keyspace_name) / [`set_keyspace_name(impl Into<String>)`](crate::operation::create_keyspace::builders::CreateKeyspaceFluentBuilder::set_keyspace_name):<br>required: **true**<br><p>The name of the keyspace to be created.</p><br>
