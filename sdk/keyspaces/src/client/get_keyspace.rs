...
impl super::Client {
    ...
    ///   - [`replication_group_statuses(Option<Vec::<ReplicationGroupStatus>>)`](crate::operation::get_keyspace::GetKeyspaceOutput::replication_group_statuses): <p>A list of all Regions the keyspace is replicated in after the update keyspace operation and their status.</p>
