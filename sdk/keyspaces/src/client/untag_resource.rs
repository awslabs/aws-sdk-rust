...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::untag_resource::builders::UntagResourceFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::untag_resource::builders::UntagResourceFluentBuilder::set_tags): <p>A list of existing tags to be removed from the Amazon Keyspaces resource.</p>
