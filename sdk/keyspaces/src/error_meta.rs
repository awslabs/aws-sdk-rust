...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
...
impl From<crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError> for Error {
    fn from(err: crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError) -> Self {
        match err {
            crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError::InternalServerException(inner) => Error::InternalServerException(inner),
            crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
            crate::operation::get_table_auto_scaling_settings::GetTableAutoScalingSettingsError::ValidationException(inner) => Error::ValidationException(inner),
