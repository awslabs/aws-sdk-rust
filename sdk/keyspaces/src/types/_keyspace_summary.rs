...
impl KeyspaceSummaryBuilder {
    ...
    pub fn set_replication_regions(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.replication_regions = input; self
    }
    /// <p>If the <code>replicationStrategy</code> of the keyspace is <code>MULTI_REGION</code>, a list of replication Regions is returned.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::KeyspaceSummary {
                keyspace_name: self.keyspace_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("keyspace_name", "keyspace_name was not specified but it is required when building KeyspaceSummary")
                    )?
                ,
                resource_arn: self.resource_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_arn", "resource_arn was not specified but it is required when building KeyspaceSummary")
                    )?
                ,
                replication_strategy: self.replication_strategy
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("replication_strategy", "replication_strategy was not specified but it is required when building KeyspaceSummary")
                    )?
                ,
