...
pub struct RestoreTableOutput  {
    ...
    #[doc(hidden)]pub restored_table_arn: std::option::Option<std::string::String>,
}
...
pub struct ListTablesOutput  {
    ...
    #[doc(hidden)]pub tables: std::option::Option<std::vec::Vec<crate::model::TableSummary>>,
}
...
pub struct ListKeyspacesOutput  {
    ...
    #[doc(hidden)]pub keyspaces: std::option::Option<std::vec::Vec<crate::model::KeyspaceSummary>>,
}
...
pub struct GetTableOutput  {
    ...
    #[doc(hidden)]pub creation_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The current status of the specified table.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::TableStatus>,
    ...
    #[doc(hidden)]pub capacity_specification: std::option::Option<crate::model::CapacitySpecificationSummary>,
    ...
    #[doc(hidden)]pub point_in_time_recovery: std::option::Option<crate::model::PointInTimeRecoverySummary>,
