...
pub fn ser_list_tables_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTablesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
