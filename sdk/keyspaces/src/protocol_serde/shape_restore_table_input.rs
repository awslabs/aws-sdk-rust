...
pub fn ser_restore_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RestoreTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
