...
pub fn ser_update_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
