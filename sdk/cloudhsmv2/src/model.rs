...
pub struct Backup  {
    ...
    #[doc(hidden)]pub backup_state: std::option::Option<crate::model::BackupState>,
    ...
    #[doc(hidden)]pub copy_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub source_backup: std::option::Option<std::string::String>,
    /// <p>The identifier (ID) of the cluster containing the source backup from which the new backup was copied.</p>
    #[doc(hidden)]pub source_cluster: std::option::Option<std::string::String>,
    /// <p>The date and time when the backup will be permanently deleted.</p>
    #[doc(hidden)]pub delete_timestamp: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct Cluster  {
    ...
    #[doc(hidden)]pub hsms: std::option::Option<std::vec::Vec<crate::model::Hsm>>,
    ...
    #[doc(hidden)]pub pre_co_password: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub subnet_mapping: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub certificates: std::option::Option<crate::model::Certificates>,
...
pub struct Certificates  {
    ...
    #[doc(hidden)]pub cluster_csr: std::option::Option<std::string::String>,
    /// <p>The HSM certificate issued (signed) by the HSM hardware.</p>
    #[doc(hidden)]pub hsm_certificate: std::option::Option<std::string::String>,
    /// <p>The HSM hardware certificate issued (signed) by AWS CloudHSM.</p>
    #[doc(hidden)]pub aws_hardware_certificate: std::option::Option<std::string::String>,
    /// <p>The HSM hardware certificate issued (signed) by the hardware manufacturer.</p>
    #[doc(hidden)]pub manufacturer_hardware_certificate: std::option::Option<std::string::String>,
    /// <p>The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.</p>
    #[doc(hidden)]pub cluster_certificate: std::option::Option<std::string::String>,
}
impl Certificates {
    /// <p>The cluster's certificate signing request (CSR). The CSR exists only when the cluster's state is <code>UNINITIALIZED</code>.</p>
...
impl  std::fmt::Debug for Certificates  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("manufacturer_hardware_certificate", &self.manufacturer_hardware_certificate);
...
pub struct Hsm  {
    ...
    /// <p>The HSM's state.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::HsmState>,
...
pub struct BackupRetentionPolicy  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::BackupRetentionType>,
