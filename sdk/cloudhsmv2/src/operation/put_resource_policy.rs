...
impl PutResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "PutResourcePolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudHSM V2.PutResourcePolicy",
                "rpc.service" = "CloudHSM V2",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutResourcePolicy")
                .build()
...
#[derive(Debug)]
struct PutResourcePolicyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutResourcePolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutResourcePolicyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutResourcePolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_resource_policy::de_put_resource_policy_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_resource_policy::de_put_resource_policy_http_response(status, headers, body, _cfg)
        };
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "BaldrApiService.PutResourcePolicy",
            );
            builder
        };
...
impl PutResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `PutResourcePolicyError::CloudHsmAccessDeniedException`.
    pub fn is_cloud_hsm_access_denied_exception(&self) -> bool {
        matches!(self, Self::CloudHsmAccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::CloudHsmInternalFailureException`.
    pub fn is_cloud_hsm_internal_failure_exception(&self) -> bool {
        matches!(self, Self::CloudHsmInternalFailureException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::CloudHsmInvalidRequestException`.
    pub fn is_cloud_hsm_invalid_request_exception(&self) -> bool {
        matches!(self, Self::CloudHsmInvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::CloudHsmResourceNotFoundException`.
    pub fn is_cloud_hsm_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::CloudHsmResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::CloudHsmServiceException`.
