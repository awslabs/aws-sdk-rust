...
impl CopyBackupToRegionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_backup_to_region::CopyBackupToRegion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyBackupToRegion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_copy_backup_to_region::de_copy_backup_to_region_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::copy_backup_to_region::CopyBackupToRegionError
{
