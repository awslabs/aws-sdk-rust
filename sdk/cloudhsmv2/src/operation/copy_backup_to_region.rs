...
impl CopyBackupToRegion {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::copy_backup_to_region::CopyBackupToRegionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::copy_backup_to_region::CopyBackupToRegionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "CopyBackupToRegion", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudHSM V2.CopyBackupToRegion",
                "rpc.service" = "CloudHSM V2",
                "rpc.method" = "CopyBackupToRegion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CopyBackupToRegion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CopyBackupToRegionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CopyBackupToRegionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CopyBackupToRegion")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyBackupToRegion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CopyBackupToRegionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CopyBackupToRegionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopyBackupToRegionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CopyBackupToRegionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyBackupToRegionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_copy_backup_to_region::de_copy_backup_to_region_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_copy_backup_to_region::de_copy_backup_to_region_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyBackupToRegionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::copy_backup_to_region::CopyBackupToRegionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::copy_backup_to_region::CopyBackupToRegionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_copy_backup_to_region::ser_copy_backup_to_region_input(
            &input,
        )?);
