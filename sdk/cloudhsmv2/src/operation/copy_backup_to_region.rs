...
impl CopyBackupToRegionInput {
    /// Consumes the builder and constructs an Operation<[`CopyBackupToRegion`](crate::operation::copy_backup_to_region::CopyBackupToRegion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::copy_backup_to_region::CopyBackupToRegion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_backup_to_region::CopyBackupToRegionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::copy_backup_to_region::CopyBackupToRegion::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CopyBackupToRegion {
                type Output = std::result::Result<crate::operation::copy_backup_to_region::CopyBackupToRegionOutput, crate::operation::copy_backup_to_region::CopyBackupToRegionError>;
