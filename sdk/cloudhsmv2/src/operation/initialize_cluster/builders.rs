...
impl InitializeClusterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::initialize_cluster::InitializeClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::initialize_cluster::InitializeClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::initialize_cluster::InitializeClusterOutput, crate::operation::initialize_cluster::InitializeClusterError, Self> {
