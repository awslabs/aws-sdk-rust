...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::restore_backup::RestoreBackupOutput,
                    crate::operation::restore_backup::RestoreBackupError,
                > for RestoreBackupFluentBuilder
            {
                fn send(
                    self,
...
impl RestoreBackupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::restore_backup::RestoreBackupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_backup::RestoreBackupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::restore_backup::RestoreBackup::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::restore_backup::RestoreBackup::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::restore_backup::RestoreBackupOutput, crate::operation::restore_backup::RestoreBackupError, Self> {
