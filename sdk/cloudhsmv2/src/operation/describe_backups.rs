...
impl DescribeBackupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_backups::DescribeBackups, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_backups::ser_describe_backups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBackups {
    type Output =
        ::std::result::Result<crate::operation::describe_backups::DescribeBackupsOutput, crate::operation::describe_backups::DescribeBackupsError>;
