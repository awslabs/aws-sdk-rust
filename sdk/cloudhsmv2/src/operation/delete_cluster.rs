...
impl DeleteCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "DeleteCluster", input, runtime_plugins, stop_point).await
    }
