...
impl CreateHsmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_hsm::CreateHsm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_hsm::ser_create_hsm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHsm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_hsm::de_create_hsm_http_response_with_props(status, headers, body)
        }
    }
}
