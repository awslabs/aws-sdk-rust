...
impl DeleteHsm {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "DeleteHsm", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudHSM V2.DeleteHsm",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteHsm {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DeleteHsm", "CloudHSM V2"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteHsmTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("HsmId") {
            if let ::std::option::Option::Some(value) = input.hsm_id.as_deref() {
                captured.insert("HsmId", value);
            }
        }
        if requested.should_capture("EniId") {
            if let ::std::option::Option::Some(value) = input.eni_id.as_deref() {
                captured.insert("EniId", value);
            }
        }
