...
impl InitializeClusterInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::initialize_cluster::InitializeCluster::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for InitializeCluster {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_initialize_cluster::de_initialize_cluster_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_initialize_cluster::de_initialize_cluster_http_response(
                status, headers, body,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::initialize_cluster::InitializeClusterError
{
