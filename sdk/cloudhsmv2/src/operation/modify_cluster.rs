...
impl ModifyClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_cluster::ModifyCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_cluster::ser_modify_cluster_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_cluster::de_modify_cluster_http_response_with_props(status, headers, body)
        }
    }
}
