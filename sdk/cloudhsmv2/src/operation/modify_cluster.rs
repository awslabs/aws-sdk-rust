...
impl ModifyCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "ModifyCluster", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudHSM V2.ModifyCluster",
                "rpc.service" = "CloudHSM V2",
                "rpc.method" = "ModifyCluster",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("HsmType") {
            if let ::std::option::Option::Some(value) = input.hsm_type.as_deref() {
                captured.insert("HsmType", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyClusterResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_cluster::de_modify_cluster_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_modify_cluster::de_modify_cluster_http_response(status, headers, body, _cfg)
        };
