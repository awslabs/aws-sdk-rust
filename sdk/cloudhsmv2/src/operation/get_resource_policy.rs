...
impl GetResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "GetResourcePolicy", input, runtime_plugins, stop_point)
            .await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "BaldrApiService.GetResourcePolicy",
            );
            builder
        };
...
impl GetResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `GetResourcePolicyError::CloudHsmAccessDeniedException`.
    pub fn is_cloud_hsm_access_denied_exception(&self) -> bool {
        matches!(self, Self::CloudHsmAccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::CloudHsmInternalFailureException`.
    pub fn is_cloud_hsm_internal_failure_exception(&self) -> bool {
        matches!(self, Self::CloudHsmInternalFailureException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::CloudHsmInvalidRequestException`.
    pub fn is_cloud_hsm_invalid_request_exception(&self) -> bool {
        matches!(self, Self::CloudHsmInvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::CloudHsmResourceNotFoundException`.
    pub fn is_cloud_hsm_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::CloudHsmResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::CloudHsmServiceException`.
