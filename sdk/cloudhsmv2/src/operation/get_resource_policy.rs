...
impl GetResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudhsmv2", "GetResourcePolicy", input, runtime_plugins, stop_point)
            .await
    }
