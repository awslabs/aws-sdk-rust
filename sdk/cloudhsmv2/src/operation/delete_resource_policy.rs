...
impl DeleteResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM V2", "DeleteResourcePolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudHSM V2.DeleteResourcePolicy",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "BaldrApiService.DeleteResourcePolicy",
            );
            builder
        };
...
impl DeleteResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::CloudHsmAccessDeniedException`.
    pub fn is_cloud_hsm_access_denied_exception(&self) -> bool {
        matches!(self, Self::CloudHsmAccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::CloudHsmInternalFailureException`.
    pub fn is_cloud_hsm_internal_failure_exception(&self) -> bool {
        matches!(self, Self::CloudHsmInternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::CloudHsmInvalidRequestException`.
    pub fn is_cloud_hsm_invalid_request_exception(&self) -> bool {
        matches!(self, Self::CloudHsmInvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::CloudHsmResourceNotFoundException`.
    pub fn is_cloud_hsm_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::CloudHsmResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::CloudHsmServiceException`.
