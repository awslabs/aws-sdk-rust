...
pub fn serialize_operation_copy_backup_to_region(
    input: &crate::input::CopyBackupToRegionInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_copy_backup_to_region_input(&mut object, input);
    object.finish();
...
pub fn serialize_operation_initialize_cluster(
    input: &crate::input::InitializeClusterInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_initialize_cluster_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_modify_backup_attributes(
    input: &crate::input::ModifyBackupAttributesInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_modify_backup_attributes_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_restore_backup(
    input: &crate::input::RestoreBackupInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_restore_backup_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
