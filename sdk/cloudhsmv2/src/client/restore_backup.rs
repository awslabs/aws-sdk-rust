...
impl super::Client {
    ...
    ///   - [`backup_id(impl Into<String>)`](crate::operation::restore_backup::builders::RestoreBackupFluentBuilder::backup_id) / [`set_backup_id(Option<String>)`](crate::operation::restore_backup::builders::RestoreBackupFluentBuilder::set_backup_id):<br>required: **true**<br><p>The ID of the backup to be restored. To find the ID of a backup, use the <code>DescribeBackups</code> operation.</p><br>
