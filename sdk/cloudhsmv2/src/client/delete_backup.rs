...
impl super::Client {
    ...
    ///   - [`backup_id(impl Into<String>)`](crate::operation::delete_backup::builders::DeleteBackupFluentBuilder::backup_id) / [`set_backup_id(Option<String>)`](crate::operation::delete_backup::builders::DeleteBackupFluentBuilder::set_backup_id):<br>required: **true**<br><p>The ID of the backup to be deleted. To find the ID of a backup, use the <code>DescribeBackups</code> operation.</p><br>
