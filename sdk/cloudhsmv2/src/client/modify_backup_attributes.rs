...
impl super::Client {
    ...
    ///   - [`backup_id(impl Into<String>)`](crate::operation::modify_backup_attributes::builders::ModifyBackupAttributesFluentBuilder::backup_id) / [`set_backup_id(Option<String>)`](crate::operation::modify_backup_attributes::builders::ModifyBackupAttributesFluentBuilder::set_backup_id):<br>required: **true**<br><p>The identifier (ID) of the backup to modify. To find the ID of a backup, use the <code>DescribeBackups</code> operation.</p><br>
