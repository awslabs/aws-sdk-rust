...
impl super::Client {
    ...
    ///   - [`destination_region(impl ::std::convert::Into<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::destination_region) / [`set_destination_region(Option<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::set_destination_region): <p>The AWS region that will contain your copied CloudHSM cluster backup.</p>
    ///   - [`backup_id(impl ::std::convert::Into<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::backup_id) / [`set_backup_id(Option<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::set_backup_id): <p>The ID of the backup that will be copied to the destination region. </p>
