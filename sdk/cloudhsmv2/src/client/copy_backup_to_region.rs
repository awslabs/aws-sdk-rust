...
impl super::Client {
    ...
    ///   - [`destination_region(impl Into<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::destination_region) / [`set_destination_region(Option<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::set_destination_region):<br>required: **true**<br><p>The AWS region that will contain your copied CloudHSM cluster backup.</p><br>
    ///   - [`backup_id(impl Into<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::backup_id) / [`set_backup_id(Option<String>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::set_backup_id):<br>required: **true**<br><p>The ID of the backup that will be copied to the destination region.</p><br>
    ///   - [`tag_list(Tag)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::tag_list) / [`set_tag_list(Option<Vec::<Tag>>)`](crate::operation::copy_backup_to_region::builders::CopyBackupToRegionFluentBuilder::set_tag_list):<br>required: **false**<br><p>Tags to apply to the destination backup during creation. If you specify tags, only these tags will be applied to the destination backup. If you do not specify tags, the service copies tags from the source backup to the destination backup.</p><br>
