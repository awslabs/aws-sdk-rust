            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Hsms" => {
                            builder = builder.set_hsms(crate::protocol_serde::shape_hsms::de_hsms(tokens)?);
                        }
                        "HsmType" => {
                        ...
                        "SubnetMapping" => {
                            builder =
                                builder.set_subnet_mapping(crate::protocol_serde::shape_external_subnet_mapping::de_external_subnet_mapping(tokens)?);
                        }
                        "VpcId" => {
