...
impl ServiceQuotaExceededExceptionBuilder {
    ...
    /// - [`error`](crate::types::error::builders::ServiceQuotaExceededExceptionBuilder::error)
        ...
        ::std::result::Result::Ok(crate::types::error::ServiceQuotaExceededException {
            error: self.error.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "error",
                    "error was not specified but it is required when building ServiceQuotaExceededException",
                )
            })?,
