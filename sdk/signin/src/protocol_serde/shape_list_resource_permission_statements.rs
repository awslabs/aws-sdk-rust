...
pub fn de_list_resource_permission_statements_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsError" => {
            crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::TooManyRequestsError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::list_resource_permission_statements::ListResourcePermissionStatementsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_resource_permission_statements_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_list_resource_permission_statements(
    _value: &[u8],
