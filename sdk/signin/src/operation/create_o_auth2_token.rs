...
impl CreateOAuth2Token {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_o_auth2_token::CreateOAuth2TokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_o_auth2_token::CreateOAuth2TokenOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Signin", "CreateOAuth2Token", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Signin.CreateOAuth2Token",
                "rpc.service" = "Signin",
                "rpc.method" = "CreateOAuth2Token",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateOAuth2Token {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateOAuth2Token");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateOAuth2TokenRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateOAuth2TokenResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateOAuth2Token")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateOAuth2Token")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateOAuth2TokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_o_auth2_token::de_create_o_auth2_token_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_o_auth2_token::de_create_o_auth2_token_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateOAuth2TokenEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateOAuth2TokenInput>()
            .ok_or("failed to downcast to CreateOAuth2TokenInput")?;
        ...
        let params = crate::config::endpoint::Params::builder()
            ...
            .set_is_control_plane(Some(false))
            .build()
            .map_err(|err| {
...
/// Error type for the `CreateOAuth2TokenError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateOAuth2TokenError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateOAuth2TokenError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateOAuth2TokenError {
    /// Creates the `CreateOAuth2TokenError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateOAuth2TokenError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateOAuth2TokenError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateOAuth2TokenError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `CreateOAuth2TokenError::TooManyRequestsError`.
    pub fn is_too_many_requests_error(&self) -> bool {
        matches!(self, Self::TooManyRequestsError(_))
    }
    /// Returns `true` if the error kind is `CreateOAuth2TokenError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for CreateOAuth2TokenError {
...
impl ::std::fmt::Display for CreateOAuth2TokenError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateOAuth2TokenError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateOAuth2TokenError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateOAuth2TokenError {
