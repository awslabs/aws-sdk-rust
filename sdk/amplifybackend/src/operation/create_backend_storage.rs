...
/// Orchestration and serialization glue logic for `CreateBackendStorage`.
...
impl CreateBackendStorage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_backend_storage::CreateBackendStorageInput,
                    ) -> ::std::result::Result<crate::operation::create_backend_storage::CreateBackendStorageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_backend_storage::CreateBackendStorageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_backend_storage::CreateBackendStorageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_backend_storage::CreateBackendStorageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateBackendStorage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateBackendStorage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateBackendStorageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateBackendStorageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateBackendStorage")
...
.with_interceptor(CreateBackendStorageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_backend_storage::CreateBackendStorageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_backend_storage::CreateBackendStorageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_backend_storage::CreateBackendStorageError>::new());
...
#[derive(Debug)]
            struct CreateBackendStorageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBackendStorageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_backend_storage::de_create_backend_storage_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_backend_storage::de_create_backend_storage_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateBackendStorageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBackendStorageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_backend_storage::CreateBackendStorageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_backend_storage::CreateBackendStorageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backend/{AppId}/storage", AppId = app_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_backend_storage::ser_create_backend_storage_input(&input)?);
...
#[derive(Debug)]
            struct CreateBackendStorageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateBackendStorageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateBackendStorageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateBackendStorageInput>()
                        .ok_or("failed to downcast to CreateBackendStorageInput")?;
...
pub enum CreateBackendStorageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateBackendStorageError) for what information is available for the error.")]
...
impl CreateBackendStorageError {
    /// Creates the `CreateBackendStorageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateBackendStorageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateBackendStorageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_backend_storage::CreateBackendStorageError {
...
mod _create_backend_storage_output;
