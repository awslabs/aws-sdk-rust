...
impl GetBackendApiInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backend_api::GetBackendAPI::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetBackendAPI {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_backend_api::de_get_backend_api_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_backend_api::de_get_backend_api_http_response(
                status, headers, body,
            )
        }
    }
