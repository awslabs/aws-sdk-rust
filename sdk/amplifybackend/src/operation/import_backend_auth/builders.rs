...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::import_backend_auth::ImportBackendAuthOutput,
                    crate::operation::import_backend_auth::ImportBackendAuthError,
                > for ImportBackendAuthFluentBuilder
            {
                fn send(
                    self,
...
impl ImportBackendAuthFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::import_backend_auth::ImportBackendAuthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_backend_auth::ImportBackendAuthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::import_backend_auth::ImportBackendAuth::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::import_backend_auth::ImportBackendAuth::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::import_backend_auth::ImportBackendAuthOutput, crate::operation::import_backend_auth::ImportBackendAuthError, Self> {
    ...
    pub fn get_native_client_id(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_native_client_id()
    }
