    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/backend/{AppId}/remove", AppId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_all_backends::RemoveAllBackends::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_all_backends::RemoveAllBackendsError
{
