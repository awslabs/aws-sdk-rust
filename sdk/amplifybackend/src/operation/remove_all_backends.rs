...
impl RemoveAllBackendsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::remove_all_backends::RemoveAllBackends,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_all_backends::ser_remove_all_backends_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveAllBackends {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_all_backends::de_remove_all_backends_http_response_with_props(status, headers, body)
        }
    }
}
