...
impl RemoveAllBackendsInput {
    /// Consumes the builder and constructs an Operation<[`RemoveAllBackends`](crate::operation::remove_all_backends::RemoveAllBackends)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_all_backends::RemoveAllBackends, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_all_backends::RemoveAllBackendsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/remove", AppId = app_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_all_backends::RemoveAllBackends::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RemoveAllBackends", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveAllBackends {
                type Output = std::result::Result<crate::operation::remove_all_backends::RemoveAllBackendsOutput, crate::operation::remove_all_backends::RemoveAllBackendsError>;
