...
impl GetBackendJobInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_backend_job::GetBackendJob,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backend_job::GetBackendJob::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetBackendJob {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_backend_job::de_get_backend_job_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_backend_job::de_get_backend_job_http_response(
                status, headers, body,
            )
        }
    }
