...
impl UpdateBackendConfigInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBackendConfig`](crate::operation::update_backend_config::UpdateBackendConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_backend_config::UpdateBackendConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_backend_config::UpdateBackendConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/config/update", AppId = app_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_backend_config::ser_update_backend_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_backend_config::UpdateBackendConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateBackendConfig", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBackendConfig {
                type Output = std::result::Result<crate::operation::update_backend_config::UpdateBackendConfigOutput, crate::operation::update_backend_config::UpdateBackendConfigError>;
