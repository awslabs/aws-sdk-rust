    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/backend/{AppId}/config/update", AppId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_backend_config::UpdateBackendConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_backend_config::UpdateBackendConfigError
{
