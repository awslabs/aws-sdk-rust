...
impl ImportBackendStorageInput {
    /// Consumes the builder and constructs an Operation<[`ImportBackendStorage`](crate::operation::import_backend_storage::ImportBackendStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::import_backend_storage::ImportBackendStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_backend_storage::ImportBackendStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/storage/{BackendEnvironmentName}/import", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_backend_storage::ser_import_backend_storage_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::import_backend_storage::ImportBackendStorage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ImportBackendStorage", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for ImportBackendStorage {
                type Output = std::result::Result<crate::operation::import_backend_storage::ImportBackendStorageOutput, crate::operation::import_backend_storage::ImportBackendStorageError>;
