...
pub use crate::operation::delete_backend_auth::_delete_backend_auth_output::DeleteBackendAuthOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_backend_auth::DeleteBackendAuthOutput,
                    crate::operation::delete_backend_auth::DeleteBackendAuthError,
                > for DeleteBackendAuthFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteBackendAuthFluentBuilder {
    ...
    /// Access the DeleteBackendAuth as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_backend_auth::builders::DeleteBackendAuthInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_backend_auth::DeleteBackendAuthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_backend_auth::DeleteBackendAuthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_backend_auth::DeleteBackendAuth::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_backend_auth::DeleteBackendAuth::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_backend_auth::DeleteBackendAuthOutput, crate::operation::delete_backend_auth::DeleteBackendAuthError, Self> {
