...
impl DeleteBackendAuthFluentBuilder  {
    /// Creates a new `DeleteBackendAuth`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_backend_auth::DeleteBackendAuthOutput, aws_smithy_http::result::SdkError<crate::operation::delete_backend_auth::DeleteBackendAuthError>>
                     {
