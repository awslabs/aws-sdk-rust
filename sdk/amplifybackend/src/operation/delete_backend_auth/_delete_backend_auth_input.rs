...
impl DeleteBackendAuthInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_backend_auth::DeleteBackendAuthInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::delete_backend_auth::DeleteBackendAuthInput {
                app_id: self.app_id
                ,
