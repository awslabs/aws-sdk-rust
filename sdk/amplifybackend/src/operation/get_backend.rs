    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/backend/{AppId}/details", AppId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backend::GetBackend::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackend {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_backend::de_get_backend_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_backend::de_get_backend_http_response_with_props(
                status, headers, body,
            )
        }
    }
