...
impl CreateBackendInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackend`](crate::operation::create_backend::CreateBackend)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_backend::CreateBackend, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_backend::ser_create_backend_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_backend::CreateBackend::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateBackend", "amplifybackend"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackend {
    type Output = ::std::result::Result<crate::operation::create_backend::CreateBackendOutput, crate::operation::create_backend::CreateBackendError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_backend::de_create_backend_http_response_with_props(status, headers, body)
        }
    }
}
