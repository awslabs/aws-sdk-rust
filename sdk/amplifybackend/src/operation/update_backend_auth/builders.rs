...
impl UpdateBackendAuthFluentBuilder  {
    /// Creates a new `UpdateBackendAuth`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_backend_auth::UpdateBackendAuth, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::update_backend_auth::UpdateBackendAuthError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_backend_auth::UpdateBackendAuthOutput, aws_smithy_http::result::SdkError<crate::operation::update_backend_auth::UpdateBackendAuthError>>
                     {
