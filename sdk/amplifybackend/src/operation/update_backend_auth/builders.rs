...
pub use crate::operation::update_backend_auth::_update_backend_auth_output::UpdateBackendAuthOutputBuilder;
...
pub struct UpdateBackendAuthFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::update_backend_auth::builders::UpdateBackendAuthInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_backend_auth::UpdateBackendAuthOutput,
                    crate::operation::update_backend_auth::UpdateBackendAuthError,
                > for UpdateBackendAuthFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateBackendAuthFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::update_backend_auth::builders::UpdateBackendAuthInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_backend_auth::UpdateBackendAuthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_backend_auth::UpdateBackendAuthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_backend_auth::UpdateBackendAuth::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_backend_auth::UpdateBackendAuth::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_backend_auth::UpdateBackendAuthOutput, crate::operation::update_backend_auth::UpdateBackendAuthError, Self> {
