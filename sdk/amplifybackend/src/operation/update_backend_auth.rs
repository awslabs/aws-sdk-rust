...
impl UpdateBackendAuthInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBackendAuth`](crate::operation::update_backend_auth::UpdateBackendAuth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_backend_auth::UpdateBackendAuth, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_backend_auth::UpdateBackendAuthInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_backend_auth::UpdateBackendAuth::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBackendAuth {
                type Output = std::result::Result<crate::operation::update_backend_auth::UpdateBackendAuthOutput, crate::operation::update_backend_auth::UpdateBackendAuthError>;
