...
impl UpdateBackendAuthInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_backend_auth::ser_update_backend_auth_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBackendAuth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_backend_auth::de_update_backend_auth_http_response_with_props(status, headers, body)
        }
    }
}
