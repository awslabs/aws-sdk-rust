...
impl CreateBackendConfigInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackendConfig`](crate::operation::create_backend_config::CreateBackendConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_backend_config::CreateBackendConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_backend_config::CreateBackendConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/config", AppId = app_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_backend_config::ser_create_backend_config_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_backend_config::CreateBackendConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateBackendConfig", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBackendConfig {
                type Output = std::result::Result<crate::operation::create_backend_config::CreateBackendConfigOutput, crate::operation::create_backend_config::CreateBackendConfigError>;
