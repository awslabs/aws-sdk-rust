...
impl GenerateBackendApiModelsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::generate_backend_api_models::GenerateBackendApiModelsInput, ::aws_smithy_types::error::operation::BuildError> {
