...
impl GenerateBackendAPIModelsFluentBuilder  {
    /// Creates a new `GenerateBackendAPIModels`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::generate_backend_api_models::GenerateBackendAPIModels, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput, aws_smithy_http::result::SdkError<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>>
                     {
