...
impl GenerateBackendAPIModelsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput, crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError, Self> {
