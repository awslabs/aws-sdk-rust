...
impl ListS3BucketsInput {
    /// Consumes the builder and constructs an Operation<[`ListS3Buckets`](crate::operation::list_s3_buckets::ListS3Buckets)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_s3_buckets::ListS3Buckets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_s3_buckets::ser_list_s3_buckets_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_s3_buckets::ListS3Buckets::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListS3Buckets", "amplifybackend"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListS3Buckets {
    type Output =
        ::std::result::Result<crate::operation::list_s3_buckets::ListS3BucketsOutput, crate::operation::list_s3_buckets::ListS3BucketsError>;
