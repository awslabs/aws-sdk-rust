...
impl ListS3BucketsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_s3_buckets::ListS3Buckets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_s3_buckets::ListS3BucketsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for ListS3Buckets {
                type Output = std::result::Result<crate::operation::list_s3_buckets::ListS3BucketsOutput, crate::operation::list_s3_buckets::ListS3BucketsError>;
