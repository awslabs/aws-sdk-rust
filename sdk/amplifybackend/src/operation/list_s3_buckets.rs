...
impl ListS3BucketsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_s3_buckets::ListS3Buckets,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_s3_buckets::ListS3Buckets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListS3Buckets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_s3_buckets::de_list_s3_buckets_http_error(
                status, headers, body,
            )
        } else {
