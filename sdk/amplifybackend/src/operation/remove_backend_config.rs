...
impl RemoveBackendConfigInput {
    /// Consumes the builder and constructs an Operation<[`RemoveBackendConfig`](crate::operation::remove_backend_config::RemoveBackendConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_backend_config::RemoveBackendConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_backend_config::RemoveBackendConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_backend_config::RemoveBackendConfig::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveBackendConfig {
                type Output = std::result::Result<crate::operation::remove_backend_config::RemoveBackendConfigOutput, crate::operation::remove_backend_config::RemoveBackendConfigError>;
