    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/backend/{AppId}/config/remove", AppId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_backend_config::RemoveBackendConfig::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_backend_config::RemoveBackendConfigError
{
