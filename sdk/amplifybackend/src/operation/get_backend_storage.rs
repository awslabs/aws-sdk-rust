...
impl GetBackendStorageInput {
    /// Consumes the builder and constructs an Operation<[`GetBackendStorage`](crate::operation::get_backend_storage::GetBackendStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_backend_storage::GetBackendStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backend_storage::GetBackendStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/storage/{BackendEnvironmentName}/details", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_backend_storage::GetBackendStorage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBackendStorage", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBackendStorage {
                type Output = std::result::Result<crate::operation::get_backend_storage::GetBackendStorageOutput, crate::operation::get_backend_storage::GetBackendStorageError>;
