...
impl GetBackendStorageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_backend_storage::GetBackendStorage,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_backend_storage::ser_get_backend_storage_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackendStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_backend_storage::de_get_backend_storage_http_response_with_props(status, headers, body)
        }
    }
}
