...
impl DeleteBackendApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_backend_api::DeleteBackendAPI,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_backend_api::ser_delete_backend_api_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackendAPI {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_backend_api::de_delete_backend_api_http_response_with_props(status, headers, body)
        }
    }
}
