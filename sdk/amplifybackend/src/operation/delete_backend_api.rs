...
impl DeleteBackendApiInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackendAPI`](crate::operation::delete_backend_api::DeleteBackendAPI)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_backend_api::DeleteBackendAPI, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_backend_api::DeleteBackendApiInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("backend_environment_name", "cannot be empty or unset"))?;
                ...
                if backend_environment_name.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("backend_environment_name", "cannot be empty or unset"))
                            }
                write!(output, "/backend/{AppId}/api/{BackendEnvironmentName}/remove", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backend_api::DeleteBackendAPI::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBackendAPI", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBackendAPI {
                type Output = std::result::Result<crate::operation::delete_backend_api::DeleteBackendApiOutput, crate::operation::delete_backend_api::DeleteBackendAPIError>;
