...
impl DeleteBackendStorageInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackendStorage`](crate::operation::delete_backend_storage::DeleteBackendStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_backend_storage::DeleteBackendStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_backend_storage::DeleteBackendStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/storage/{BackendEnvironmentName}/remove", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_backend_storage::ser_delete_backend_storage_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backend_storage::DeleteBackendStorage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBackendStorage", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBackendStorage {
                type Output = std::result::Result<crate::operation::delete_backend_storage::DeleteBackendStorageOutput, crate::operation::delete_backend_storage::DeleteBackendStorageError>;
