...
impl GetTokenInput {
    /// Consumes the builder and constructs an Operation<[`GetToken`](crate::operation::get_token::GetToken)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_token::GetToken, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_token::GetTokenInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/challenge/{SessionId}", AppId = app_id, SessionId = session_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_token::GetToken::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetToken", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetToken {
                type Output = std::result::Result<crate::operation::get_token::GetTokenOutput, crate::operation::get_token::GetTokenError>;
