    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/backend/{AppId}/auth", AppId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_backend_auth::CreateBackendAuth::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_backend_auth::CreateBackendAuthError
{
