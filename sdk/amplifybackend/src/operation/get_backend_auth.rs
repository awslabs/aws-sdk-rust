...
impl GetBackendAuthInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_backend_auth::GetBackendAuth,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backend_auth::GetBackendAuth::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackendAuth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_backend_auth::de_get_backend_auth_http_error(
                status, headers, body,
            )
        } else {
