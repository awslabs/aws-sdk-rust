...
/// Orchestration and serialization glue logic for `GetBackendAuth`.
...
impl GetBackendAuth {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_backend_auth::GetBackendAuthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_backend_auth::GetBackendAuthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_backend_auth::GetBackendAuthError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_backend_auth::GetBackendAuthOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBackendAuth {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBackendAuth");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBackendAuthRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBackendAuthResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBackendAuth")
...
.with_interceptor(GetBackendAuthEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_backend_auth::GetBackendAuthError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_backend_auth::GetBackendAuthError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_backend_auth::GetBackendAuthError>::new());
...
#[derive(Debug)]
            struct GetBackendAuthResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBackendAuthResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_backend_auth::de_get_backend_auth_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_backend_auth::de_get_backend_auth_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBackendAuthRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBackendAuthRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_backend_auth::GetBackendAuthInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_backend_auth::GetBackendAuthInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backend/{AppId}/auth/{BackendEnvironmentName}/details", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_backend_auth::ser_get_backend_auth_input(&input)?);
...
#[derive(Debug)]
            struct GetBackendAuthEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBackendAuthEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBackendAuthEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBackendAuthInput>()
                        .ok_or("failed to downcast to GetBackendAuthInput")?;
...
pub enum GetBackendAuthError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBackendAuthError) for what information is available for the error.")]
...
impl GetBackendAuthError {
    /// Creates the `GetBackendAuthError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBackendAuthError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBackendAuthError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_backend_auth::GetBackendAuthError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_backend_auth::_get_backend_auth_output::GetBackendAuthOutput;

pub use crate::operation::get_backend_auth::_get_backend_auth_input::GetBackendAuthInput;

mod _get_backend_auth_input;

mod _get_backend_auth_output;
