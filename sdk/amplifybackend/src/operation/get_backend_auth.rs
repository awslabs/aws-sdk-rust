...
impl GetBackendAuthInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_backend_auth::GetBackendAuth, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_backend_auth::ser_get_backend_auth_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackendAuth {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_backend_auth::de_get_backend_auth_http_response_with_props(status, headers, body)
        }
    }
}
