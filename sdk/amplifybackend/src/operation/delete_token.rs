...
impl DeleteTokenInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_token::DeleteToken::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_token::de_delete_token_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_token::de_delete_token_http_response_with_props(
                status, headers, body,
            )
        }
    }
