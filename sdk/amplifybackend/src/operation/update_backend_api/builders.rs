...
impl UpdateBackendApiInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.update_backend_api();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_backend_api::UpdateBackendApiOutput,
                    crate::operation::update_backend_api::UpdateBackendAPIError,
                > for UpdateBackendAPIFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateBackendAPIFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::update_backend_api::builders::UpdateBackendApiInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_backend_api::UpdateBackendApiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_backend_api::UpdateBackendAPIError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_backend_api::UpdateBackendAPI::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_backend_api::UpdateBackendAPI::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_backend_api::UpdateBackendApiOutput, crate::operation::update_backend_api::UpdateBackendAPIError, Self> {
