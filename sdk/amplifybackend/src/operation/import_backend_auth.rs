...
impl ImportBackendAuth {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::import_backend_auth::ImportBackendAuthInput,
                    ) -> ::std::result::Result<crate::operation::import_backend_auth::ImportBackendAuthOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_backend_auth::ImportBackendAuthError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::import_backend_auth::ImportBackendAuthError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::import_backend_auth::ImportBackendAuthOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportBackendAuth {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ImportBackendAuth");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ImportBackendAuthRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ImportBackendAuthResponseDeserializer));
...
.with_interceptor(ImportBackendAuthEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::import_backend_auth::ImportBackendAuthError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::import_backend_auth::ImportBackendAuthError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::import_backend_auth::ImportBackendAuthError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_import_backend_auth::de_import_backend_auth_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_import_backend_auth::de_import_backend_auth_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ImportBackendAuthRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportBackendAuthRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::import_backend_auth::ImportBackendAuthInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::import_backend_auth::ImportBackendAuthInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backend/{AppId}/auth/{BackendEnvironmentName}/import", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_backend_auth::ser_import_backend_auth_input(&input)?);
...
#[derive(Debug)]
            struct ImportBackendAuthEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportBackendAuthEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ImportBackendAuthEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ImportBackendAuthInput>()
                        .ok_or("failed to downcast to ImportBackendAuthInput")?;
...
pub enum ImportBackendAuthError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ImportBackendAuthError) for what information is available for the error.")]
...
impl ImportBackendAuthError {
    /// Creates the `ImportBackendAuthError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ImportBackendAuthError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ImportBackendAuthError {
...
impl ::aws_types::request_id::RequestId for crate::operation::import_backend_auth::ImportBackendAuthError {
...
mod _import_backend_auth_output;
