...
impl ImportBackendAuthInput {
    /// Consumes the builder and constructs an Operation<[`ImportBackendAuth`](crate::operation::import_backend_auth::ImportBackendAuth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::import_backend_auth::ImportBackendAuth, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_backend_auth::ImportBackendAuthInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/auth/{BackendEnvironmentName}/import", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::import_backend_auth::ImportBackendAuth::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ImportBackendAuth", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for ImportBackendAuth {
                type Output = std::result::Result<crate::operation::import_backend_auth::ImportBackendAuthOutput, crate::operation::import_backend_auth::ImportBackendAuthError>;
