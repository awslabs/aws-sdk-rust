...
/// Orchestration and serialization glue logic for `GenerateBackendAPIModels`.
...
impl GenerateBackendAPIModels {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateBackendAPIModels {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateBackendAPIModels");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GenerateBackendAPIModelsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GenerateBackendAPIModelsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateBackendAPIModels")
...
.with_interceptor(GenerateBackendAPIModelsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>::new());
...
#[derive(Debug)]
            struct GenerateBackendAPIModelsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateBackendAPIModelsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_generate_backend_api_models::de_generate_backend_api_models_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_generate_backend_api_models::de_generate_backend_api_models_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GenerateBackendAPIModelsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateBackendAPIModelsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::generate_backend_api_models::GenerateBackendApiModelsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::generate_backend_api_models::GenerateBackendApiModelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backend/{AppId}/api/{BackendEnvironmentName}/generateModels", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_generate_backend_api_models::ser_generate_backend_api_models_input(&input)?);
...
#[derive(Debug)]
            struct GenerateBackendAPIModelsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateBackendAPIModelsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GenerateBackendAPIModelsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GenerateBackendApiModelsInput>()
                        .ok_or("failed to downcast to GenerateBackendApiModelsInput")?;
...
pub enum GenerateBackendAPIModelsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateBackendAPIModelsError) for what information is available for the error.")]
...
impl GenerateBackendAPIModelsError {
    /// Creates the `GenerateBackendAPIModelsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GenerateBackendAPIModelsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateBackendAPIModelsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError {
...
mod _generate_backend_api_models_output;
