...
impl GenerateBackendApiModelsInput {
    /// Consumes the builder and constructs an Operation<[`GenerateBackendAPIModels`](crate::operation::generate_backend_api_models::GenerateBackendAPIModels)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_backend_api_models::GenerateBackendAPIModels, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_backend_api_models::GenerateBackendApiModelsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/backend/{AppId}/api/{BackendEnvironmentName}/generateModels", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_backend_api_models::GenerateBackendAPIModels::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GenerateBackendAPIModels", "amplifybackend"));
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateBackendAPIModels {
                type Output = std::result::Result<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput, crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>;
