...
impl GenerateBackendAPIModels {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_backend_api_models::GenerateBackendAPIModelsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_backend_api_models::GenerateBackendApiModelsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GenerateBackendAPIModels",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateBackendAPIModels {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateBackendAPIModelsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GenerateBackendAPIModelsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GenerateBackendAPIModels")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateBackendAPIModels")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GenerateBackendAPIModelsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GenerateBackendAPIModelsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateBackendAPIModelsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GenerateBackendApiModelsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateBackendAPIModelsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_generate_backend_api_models::de_generate_backend_api_models_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_generate_backend_api_models::de_generate_backend_api_models_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateBackendAPIModelsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::generate_backend_api_models::GenerateBackendApiModelsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::generate_backend_api_models::GenerateBackendApiModelsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_backend_api_models::ser_generate_backend_api_models_input(&input)?,
        );
