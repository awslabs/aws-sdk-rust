...
impl GenerateBackendApiModelsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::generate_backend_api_models::GenerateBackendAPIModels,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_backend_api_models::GenerateBackendAPIModels::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateBackendAPIModels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_backend_api_models::de_generate_backend_api_models_http_response_with_props(status, headers, body)
        }
    }
}
