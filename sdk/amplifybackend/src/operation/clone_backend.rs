...
impl CloneBackendInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::clone_backend::CloneBackend::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CloneBackend {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_clone_backend::de_clone_backend_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_clone_backend::de_clone_backend_http_response_with_props(
                status, headers, body,
            )
        }
    }
