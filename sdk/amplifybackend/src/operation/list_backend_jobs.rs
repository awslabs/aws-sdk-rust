...
impl ListBackendJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListBackendJobs`](crate::operation::list_backend_jobs::ListBackendJobs)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_backend_jobs::ListBackendJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_backend_jobs::ser_list_backend_jobs_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_backend_jobs::ListBackendJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBackendJobs {
    type Output =
        ::std::result::Result<crate::operation::list_backend_jobs::ListBackendJobsOutput, crate::operation::list_backend_jobs::ListBackendJobsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_backend_jobs::de_list_backend_jobs_http_response_with_props(status, headers, body)
        }
    }
}
