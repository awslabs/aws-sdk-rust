...
impl ListBackendJobsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_backend_jobs::ListBackendJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_backend_jobs::ListBackendJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for ListBackendJobs {
                type Output = std::result::Result<crate::operation::list_backend_jobs::ListBackendJobsOutput, crate::operation::list_backend_jobs::ListBackendJobsError>;
