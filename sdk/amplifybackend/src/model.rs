...
pub struct UpdateBackendStorageResourceConfig  {
    ...
    #[doc(hidden)]pub permissions: std::option::Option<crate::model::BackendStoragePermissions>,
    /// <p>The name of the storage service.</p>
    #[doc(hidden)]pub service_name: std::option::Option<crate::model::ServiceName>,
}
...
pub struct BackendStoragePermissions  {
    ...
    #[doc(hidden)]pub authenticated: std::option::Option<std::vec::Vec<crate::model::AuthenticatedElement>>,
    /// <p>Lists all unauthenticated user read, write, and delete permissions for your S3 bucket.</p>
    #[doc(hidden)]pub un_authenticated: std::option::Option<std::vec::Vec<crate::model::UnAuthenticatedElement>>,
}
...
pub struct LoginAuthConfigReqObj  {
    ...
    #[doc(hidden)]pub aws_cognito_identity_pool_id: std::option::Option<std::string::String>,
    /// <p>The AWS Region for the Amplify Admin UI login.</p>
    #[doc(hidden)]pub aws_cognito_region: std::option::Option<std::string::String>,
    /// <p>The Amazon Cognito user pool ID used for Amplify Admin UI login authentication.</p>
    #[doc(hidden)]pub aws_user_pools_id: std::option::Option<std::string::String>,
    /// <p>The web client ID for the Amazon Cognito user pools.</p>
    #[doc(hidden)]pub aws_user_pools_web_client_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for LoginAuthConfigReqObj  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("aws_cognito_identity_pool_id", &self.aws_cognito_identity_pool_id);
        formatter.field("aws_cognito_region", &self.aws_cognito_region);
        formatter.field("aws_user_pools_id", &self.aws_user_pools_id);
        formatter.field("aws_user_pools_web_client_id", &self.aws_user_pools_web_client_id);
        formatter.finish()
    }
}
...
pub struct UpdateBackendAuthResourceConfig  {
    ...
    #[doc(hidden)]pub auth_resources: std::option::Option<crate::model::AuthResources>,
    ...
    #[doc(hidden)]pub identity_pool_configs: std::option::Option<crate::model::UpdateBackendAuthIdentityPoolConfig>,
    /// <p>Defines the service name to use when configuring an authentication resource in your Amplify project.</p>
    ...
    #[doc(hidden)]pub user_pool_configs: std::option::Option<crate::model::UpdateBackendAuthUserPoolConfig>,
}
...
pub struct UpdateBackendAuthUserPoolConfig  {
    ...
    #[doc(hidden)]pub forgot_password: std::option::Option<crate::model::UpdateBackendAuthForgotPasswordConfig>,
    ...
    #[doc(hidden)]pub mfa: std::option::Option<crate::model::UpdateBackendAuthMfaConfig>,
    /// <p>Describes the OAuth policy and rules for your Amazon Cognito user pool, configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub o_auth: std::option::Option<crate::model::UpdateBackendAuthOAuthConfig>,
    /// <p>Describes the password policy for your Amazon Cognito user pool, configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub password_policy: std::option::Option<crate::model::UpdateBackendAuthPasswordPolicyConfig>,
    ...
    #[doc(hidden)]pub verification_message: std::option::Option<crate::model::UpdateBackendAuthVerificationMessageConfig>,
}
...
pub struct UpdateBackendAuthVerificationMessageConfig  {
    ...
    #[doc(hidden)]pub delivery_method: std::option::Option<crate::model::DeliveryMethod>,
    /// <p>The settings for the email message.</p>
    #[doc(hidden)]pub email_settings: std::option::Option<crate::model::EmailSettings>,
    /// <p>The settings for the SMS message.</p>
    #[doc(hidden)]pub sms_settings: std::option::Option<crate::model::SmsSettings>,
}
...
pub struct SmsSettings  {
    ...
    #[doc(hidden)]pub sms_message: std::option::Option<std::string::String>,
}
impl SmsSettings {
    /// <p>The contents of the SMS message.</p>
...
pub struct EmailSettings  {
    ...
    #[doc(hidden)]pub email_message: std::option::Option<std::string::String>,
    /// <p>The contents of the subject line of the email message.</p>
    #[doc(hidden)]pub email_subject: std::option::Option<std::string::String>,
}
impl EmailSettings {
    /// <p>The contents of the email message.</p>
...
pub struct UpdateBackendAuthPasswordPolicyConfig  {
    ...
    #[doc(hidden)]pub additional_constraints: std::option::Option<std::vec::Vec<crate::model::AdditionalConstraintsElement>>,
    ...
    #[doc(hidden)]pub minimum_length: f64,
}
...
pub struct UpdateBackendAuthOAuthConfig  {
    ...
    #[doc(hidden)]pub domain_prefix: std::option::Option<std::string::String>,
    /// <p>The OAuth grant type to allow app users to authenticate from your Amplify app.</p>
    #[doc(hidden)]pub o_auth_grant_type: std::option::Option<crate::model::OAuthGrantType>,
    /// <p>The list of OAuth-related flows that can allow users to authenticate from your Amplify app.</p>
    #[doc(hidden)]pub o_auth_scopes: std::option::Option<std::vec::Vec<crate::model::OAuthScopesElement>>,
    /// <p>Redirect URLs that OAuth uses when a user signs in to an Amplify app.</p>
    #[doc(hidden)]pub redirect_sign_in_ur_is: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Redirect URLs that OAuth uses when a user signs out of an Amplify app.</p>
    #[doc(hidden)]pub redirect_sign_out_ur_is: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Describes third-party social federation configurations for allowing your users to sign in with OAuth.</p>
    #[doc(hidden)]pub social_provider_settings: std::option::Option<crate::model::SocialProviderSettings>,
}
...
pub struct SocialProviderSettings  {
    ...
    #[doc(hidden)]pub facebook: std::option::Option<crate::model::BackendAuthSocialProviderConfig>,
    /// <p>Describes third-party social federation configurations for allowing your app users to sign in using OAuth.</p>
    #[doc(hidden)]pub google: std::option::Option<crate::model::BackendAuthSocialProviderConfig>,
    /// <p>Describes third-party social federation configurations for allowing your app users to sign in using OAuth.</p>
    #[doc(hidden)]pub login_with_amazon: std::option::Option<crate::model::BackendAuthSocialProviderConfig>,
    /// <p>Describes Apple social federation configurations for allowing your app users to sign in using OAuth.</p>
    #[doc(hidden)]pub sign_in_with_apple: std::option::Option<crate::model::BackendAuthAppleProviderConfig>,
}
...
pub struct UpdateBackendAuthMfaConfig  {
    ...
    #[doc(hidden)]pub mfa_mode: std::option::Option<crate::model::MfaMode>,
...
pub struct Settings  {
    ...
    #[doc(hidden)]pub mfa_types: std::option::Option<std::vec::Vec<crate::model::MfaTypesElement>>,
...
pub struct UpdateBackendAuthIdentityPoolConfig  {
    ...
    #[doc(hidden)]pub unauthenticated_login: bool,
}
...
pub struct BackendApiResourceConfig  {
    ...
    #[doc(hidden)]pub additional_auth_types: std::option::Option<std::vec::Vec<crate::model::BackendApiAuthType>>,
    /// <p>The API name used to interact with the data model, configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub api_name: std::option::Option<std::string::String>,
    /// <p>The conflict resolution strategy for your data stored in the data models.</p>
    #[doc(hidden)]pub conflict_resolution: std::option::Option<crate::model::BackendApiConflictResolution>,
    /// <p>The default authentication type for interacting with the configured data models in your Amplify project.</p>
    #[doc(hidden)]pub default_auth_type: std::option::Option<crate::model::BackendApiAuthType>,
    ...
    #[doc(hidden)]pub transform_schema: std::option::Option<std::string::String>,
}
...
pub struct BackendApiAuthType  {
    ...
    #[doc(hidden)]pub mode: std::option::Option<crate::model::Mode>,
    /// <p>Describes settings for the authentication mode.</p>
    #[doc(hidden)]pub settings: std::option::Option<crate::model::BackendApiAppSyncAuthSettings>,
}
...
pub struct BackendApiAppSyncAuthSettings  {
    ...
    #[doc(hidden)]pub cognito_user_pool_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub expiration_time: f64,
    /// <p>The expiry time for the OpenID authentication mechanism.</p>
    #[doc(hidden)]pub open_id_auth_ttl: std::option::Option<std::string::String>,
    /// <p>The clientID for openID, if openID was used as an authentication setting to access your data models.</p>
    #[doc(hidden)]pub open_id_client_id: std::option::Option<std::string::String>,
    /// <p>The expiry time for the OpenID authentication mechanism.</p>
    #[doc(hidden)]pub open_id_iat_ttl: std::option::Option<std::string::String>,
    /// <p>The openID issuer URL, if openID was used as an authentication setting to access your data models.</p>
    #[doc(hidden)]pub open_id_issue_url: std::option::Option<std::string::String>,
    /// <p>The OpenID provider name, if OpenID was used as an authentication mechanism to access your data models.</p>
    #[doc(hidden)]pub open_id_provider_name: std::option::Option<std::string::String>,
}
...
pub struct BackendApiConflictResolution  {
    ...
    #[doc(hidden)]pub resolution_strategy: std::option::Option<crate::model::ResolutionStrategy>,
}
...
pub struct BackendJobRespObj  {
    ...
    #[doc(hidden)]pub backend_environment_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub update_time: std::option::Option<std::string::String>,
}
...
pub struct CreateBackendAuthResourceConfig  {
    ...
    #[doc(hidden)]pub auth_resources: std::option::Option<crate::model::AuthResources>,
    /// <p>Describes the authorization configuration for the Amazon Cognito identity pool, provisioned as a part of your auth resource in the Amplify project.</p>
    #[doc(hidden)]pub identity_pool_configs: std::option::Option<crate::model::CreateBackendAuthIdentityPoolConfig>,
    /// <p>Defines the service name to use when configuring an authentication resource in your Amplify project.</p>
    #[doc(hidden)]pub service: std::option::Option<crate::model::Service>,
    ...
    #[doc(hidden)]pub user_pool_configs: std::option::Option<crate::model::CreateBackendAuthUserPoolConfig>,
}
...
pub struct CreateBackendAuthUserPoolConfig  {
    ...
    #[doc(hidden)]pub forgot_password: std::option::Option<crate::model::CreateBackendAuthForgotPasswordConfig>,
    /// <p>Describes whether to apply multi-factor authentication policies for your Amazon Cognito user pool configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub mfa: std::option::Option<crate::model::CreateBackendAuthMfaConfig>,
    /// <p>Describes the OAuth policy and rules for your Amazon Cognito user pool, configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub o_auth: std::option::Option<crate::model::CreateBackendAuthOAuthConfig>,
    /// <p>Describes the password policy for your Amazon Cognito user pool, configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub password_policy: std::option::Option<crate::model::CreateBackendAuthPasswordPolicyConfig>,
    /// <p>The required attributes to sign up new users in the user pool.</p>
    #[doc(hidden)]pub required_sign_up_attributes: std::option::Option<std::vec::Vec<crate::model::RequiredSignUpAttributesElement>>,
    ...
    #[doc(hidden)]pub sign_in_method: std::option::Option<crate::model::SignInMethod>,
    /// <p>The Amazon Cognito user pool name.</p>
    #[doc(hidden)]pub user_pool_name: std::option::Option<std::string::String>,
    /// <p>Describes the email or SMS verification message for your Amazon Cognito user pool, configured as a part of your Amplify project.</p>
    #[doc(hidden)]pub verification_message: std::option::Option<crate::model::CreateBackendAuthVerificationMessageConfig>,
}
...
impl  std::fmt::Debug for CreateBackendAuthUserPoolConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("o_auth", &self.o_auth);
        formatter.field("password_policy", &self.password_policy);
        formatter.field("required_sign_up_attributes", &self.required_sign_up_attributes);
