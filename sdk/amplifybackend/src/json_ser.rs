...
pub fn serialize_structure_clone_backend_input(
...
pub fn serialize_structure_create_backend_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_5) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_resource_config(&mut object_6, var_5);
        object_6.finish();
    }
...
pub fn serialize_structure_create_backend_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_9) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_backend_api_resource_config(&mut object_10, var_9);
        object_10.finish();
    }
...
pub fn serialize_structure_create_backend_auth_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_13) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_create_backend_auth_resource_config(
            &mut object_14,
            var_13,
        );
        object_14.finish();
...
pub fn serialize_structure_create_backend_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_backend_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_17) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_backend_api_resource_config(&mut object_18, var_17);
        object_18.finish();
    }
...
pub fn serialize_structure_delete_backend_auth_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_generate_backend_api_models_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_backend_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_backend_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_23) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_backend_api_resource_config(&mut object_24, var_23);
        object_24.finish();
    }
...
pub fn serialize_structure_get_backend_api_models_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_backend_auth_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_import_backend_auth_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_backend_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_remove_all_backends_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_backend_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_36) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_backend_api_resource_config(&mut object_37, var_36);
        object_37.finish();
    }
...
pub fn serialize_structure_update_backend_auth_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_39) = &input.resource_config {
        ...
        crate::json_ser::serialize_structure_update_backend_auth_resource_config(
            &mut object_40,
            var_39,
        );
        object_40.finish();
...
pub fn serialize_structure_update_backend_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_42) = &input.login_auth_config {
        ...
        crate::json_ser::serialize_structure_login_auth_config_req_obj(&mut object_43, var_42);
        object_43.finish();
    }
}

pub fn serialize_structure_update_backend_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_backend_api_resource_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_48 in var_46 {
            {
                ...
                crate::json_ser::serialize_structure_backend_api_auth_type(&mut object_49, item_48);
                object_49.finish();
            }
        }
        array_47.finish();
    ...
    if let Some(var_51) = &input.conflict_resolution {
        ...
        crate::json_ser::serialize_structure_backend_api_conflict_resolution(
            &mut object_52,
            var_51,
        );
        object_52.finish();
    ...
    if let Some(var_53) = &input.default_auth_type {
        ...
        crate::json_ser::serialize_structure_backend_api_auth_type(&mut object_54, var_53);
        object_54.finish();
    }
...
pub fn serialize_structure_create_backend_auth_resource_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_58) = &input.identity_pool_configs {
        ...
        crate::json_ser::serialize_structure_create_backend_auth_identity_pool_config(
            &mut object_59,
            var_58,
        );
        object_59.finish();
    ...
    if let Some(var_61) = &input.user_pool_configs {
        ...
        crate::json_ser::serialize_structure_create_backend_auth_user_pool_config(
            &mut object_62,
            var_61,
        );
        object_62.finish();
...
pub fn serialize_structure_update_backend_auth_resource_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_64) = &input.identity_pool_configs {
        ...
        crate::json_ser::serialize_structure_update_backend_auth_identity_pool_config(
            &mut object_65,
            var_64,
        );
        object_65.finish();
    ...
    if let Some(var_67) = &input.user_pool_configs {
        ...
        crate::json_ser::serialize_structure_update_backend_auth_user_pool_config(
            &mut object_68,
            var_67,
        );
        object_68.finish();
...
pub fn serialize_structure_login_auth_config_req_obj(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_backend_api_auth_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_74) = &input.settings {
        ...
        crate::json_ser::serialize_structure_backend_api_app_sync_auth_settings(
            &mut object_75,
            var_74,
        );
        object_75.finish();
...
pub fn serialize_structure_backend_api_conflict_resolution(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_backend_auth_identity_pool_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_backend_auth_user_pool_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_78) = &input.forgot_password {
        ...
        crate::json_ser::serialize_structure_create_backend_auth_forgot_password_config(
            &mut object_79,
            var_78,
        );
        object_79.finish();
    ...
    if let Some(var_80) = &input.mfa {
        ...
        crate::json_ser::serialize_structure_create_backend_auth_mfa_config(&mut object_81, var_80);
        object_81.finish();
    }
    if let Some(var_82) = &input.o_auth {
        let mut object_83 = object.key("oAuth").start_object();
        crate::json_ser::serialize_structure_create_backend_auth_o_auth_config(
            &mut object_83,
            var_82,
        );
        object_83.finish();
    ...
    if let Some(var_84) = &input.password_policy {
        ...
        crate::json_ser::serialize_structure_create_backend_auth_password_policy_config(
            &mut object_85,
            var_84,
        );
        object_85.finish();
...
pub fn serialize_structure_update_backend_auth_identity_pool_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_backend_auth_user_pool_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_91) = &input.forgot_password {
        ...
        crate::json_ser::serialize_structure_update_backend_auth_forgot_password_config(
            &mut object_92,
            var_91,
        );
        object_92.finish();
    ...
    if let Some(var_93) = &input.mfa {
        ...
        crate::json_ser::serialize_structure_update_backend_auth_mfa_config(&mut object_94, var_93);
        object_94.finish();
    }
    if let Some(var_95) = &input.o_auth {
        let mut object_96 = object.key("oAuth").start_object();
        crate::json_ser::serialize_structure_update_backend_auth_o_auth_config(
            &mut object_96,
            var_95,
        );
        object_96.finish();
    ...
    if let Some(var_97) = &input.password_policy {
        ...
        crate::json_ser::serialize_structure_update_backend_auth_password_policy_config(
            &mut object_98,
            var_97,
        );
        object_98.finish();
...
pub fn serialize_structure_backend_api_app_sync_auth_settings(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_backend_auth_forgot_password_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_107) = &input.email_settings {
        ...
        crate::json_ser::serialize_structure_email_settings(&mut object_108, var_107);
        object_108.finish();
    }
    if let Some(var_109) = &input.sms_settings {
        let mut object_110 = object.key("smsSettings").start_object();
        crate::json_ser::serialize_structure_sms_settings(&mut object_110, var_109);
        object_110.finish();
    }
}

pub fn serialize_structure_create_backend_auth_mfa_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_112) = &input.settings {
        ...
        crate::json_ser::serialize_structure_settings(&mut object_113, var_112);
        object_113.finish();
    }
}

pub fn serialize_structure_create_backend_auth_o_auth_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_125) = &input.social_provider_settings {
        ...
        crate::json_ser::serialize_structure_social_provider_settings(&mut object_126, var_125);
        object_126.finish();
    }
}

pub fn serialize_structure_create_backend_auth_password_policy_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_backend_auth_forgot_password_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_131) = &input.email_settings {
        ...
        crate::json_ser::serialize_structure_email_settings(&mut object_132, var_131);
        object_132.finish();
    }
    if let Some(var_133) = &input.sms_settings {
        let mut object_134 = object.key("smsSettings").start_object();
        crate::json_ser::serialize_structure_sms_settings(&mut object_134, var_133);
        object_134.finish();
    }
}

pub fn serialize_structure_update_backend_auth_mfa_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_136) = &input.settings {
        ...
        crate::json_ser::serialize_structure_settings(&mut object_137, var_136);
        object_137.finish();
    }
}

pub fn serialize_structure_update_backend_auth_o_auth_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_149) = &input.social_provider_settings {
        ...
        crate::json_ser::serialize_structure_social_provider_settings(&mut object_150, var_149);
        object_150.finish();
    }
}

pub fn serialize_structure_update_backend_auth_password_policy_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_email_settings(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_sms_settings(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_social_provider_settings(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_161) = &input.facebook {
        ...
        crate::json_ser::serialize_structure_backend_auth_social_provider_config(
            &mut object_162,
            var_161,
        );
        object_162.finish();
