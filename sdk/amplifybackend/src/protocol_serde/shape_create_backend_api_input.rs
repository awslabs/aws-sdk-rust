...
pub fn ser_create_backend_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_backend_api::CreateBackendApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
