...
pub fn ser_create_backend_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBackendApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
