...
pub(crate) fn de_list_of_backend_api_auth_type<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::BackendApiAuthType>>, aws_smithy_json::deserialize::error::DeserializeError>
