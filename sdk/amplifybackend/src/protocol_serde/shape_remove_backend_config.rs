...
pub fn de_remove_backend_config_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RemoveBackendConfigOutput, crate::error::RemoveBackendConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::RemoveBackendConfigError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_backend_config_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RemoveBackendConfigOutput, crate::error::RemoveBackendConfigError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::remove_backend_config_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_remove_backend_config::de_remove_backend_config(response.body().as_ref(), output).map_err(crate::error::RemoveBackendConfigError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_remove_backend_config(value: &[u8], mut builder: crate::output::remove_backend_config_output::Builder) -> Result<crate::output::remove_backend_config_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
