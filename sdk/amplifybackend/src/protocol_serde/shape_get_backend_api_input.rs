...
pub fn ser_get_backend_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetBackendApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
