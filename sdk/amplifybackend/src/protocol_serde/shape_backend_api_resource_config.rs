                        ...
                        match key.to_unescaped()?.as_ref() {
                            "additionalAuthTypes" => {
                                builder = builder.set_additional_auth_types(
                                    crate::protocol_serde::shape_list_of_backend_api_auth_type::de_list_of_backend_api_auth_type(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "conflictResolution" => {
                                builder = builder.set_conflict_resolution(
                                    crate::protocol_serde::shape_backend_api_conflict_resolution::de_backend_api_conflict_resolution(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "defaultAuthType" => {
                                builder = builder.set_default_auth_type(
                                    crate::protocol_serde::shape_backend_api_auth_type::de_backend_api_auth_type(tokens, _value, depth + 1)?,
                                );
                            }
                            "service" => {
