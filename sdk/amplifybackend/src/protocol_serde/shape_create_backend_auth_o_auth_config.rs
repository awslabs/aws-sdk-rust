...
pub fn ser_create_backend_auth_o_auth_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateBackendAuthOAuthConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_create_backend_auth_o_auth_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CreateBackendAuthOAuthConfig>, aws_smithy_json::deserialize::error::DeserializeError>
