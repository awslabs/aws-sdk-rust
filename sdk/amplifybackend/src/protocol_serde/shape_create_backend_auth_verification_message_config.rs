...
pub(crate) fn de_create_backend_auth_verification_message_config<'a, I>(
    ...
    Option<crate::types::CreateBackendAuthVerificationMessageConfig>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "deliveryMethod" => {
                                builder = builder.set_delivery_method(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::DeliveryMethod::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            "emailSettings" => {
                                builder = builder.set_email_settings(
                                    crate::protocol_serde::shape_email_settings::de_email_settings(
                                        tokens,
                                    )?,
                                );
                            }
                            "smsSettings" => {
                                builder = builder.set_sms_settings(
                                    crate::protocol_serde::shape_sms_settings::de_sms_settings(
                                        tokens,
                                    )?,
                                );
                            }
