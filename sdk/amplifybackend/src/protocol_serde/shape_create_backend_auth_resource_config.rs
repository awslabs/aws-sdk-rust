...
pub fn ser_create_backend_auth_resource_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CreateBackendAuthResourceConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2) = &input.identity_pool_configs {
        ...
        crate::protocol_serde::shape_create_backend_auth_identity_pool_config::ser_create_backend_auth_identity_pool_config(&mut object_3, var_2)?;
        object_3.finish();
    }
    ...
    if let Some(var_5) = &input.user_pool_configs {
        ...
        crate::protocol_serde::shape_create_backend_auth_user_pool_config::ser_create_backend_auth_user_pool_config(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}

pub(crate) fn de_create_backend_auth_resource_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::CreateBackendAuthResourceConfig>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_auth_resources(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AuthResources::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "service" => {
                                builder = builder.set_service(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::Service::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
