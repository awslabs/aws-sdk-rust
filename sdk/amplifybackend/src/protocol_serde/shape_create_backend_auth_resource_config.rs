...
pub fn ser_create_backend_auth_resource_config(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::CreateBackendAuthResourceConfig,
...
pub(crate) fn de_create_backend_auth_resource_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CreateBackendAuthResourceConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::create_backend_auth_resource_config_correct_errors(builder).build()))
        }
        _ => {
