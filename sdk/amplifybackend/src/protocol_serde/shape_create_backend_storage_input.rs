...
pub fn ser_create_backend_storage_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_backend_storage::CreateBackendStorageInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
