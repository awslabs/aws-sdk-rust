...
pub fn ser_update_backend_auth_forgot_password_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateBackendAuthForgotPasswordConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
