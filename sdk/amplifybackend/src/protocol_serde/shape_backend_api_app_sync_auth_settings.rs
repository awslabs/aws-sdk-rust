...
pub(crate) fn de_backend_api_app_sync_auth_settings<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::BackendApiAppSyncAuthSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
