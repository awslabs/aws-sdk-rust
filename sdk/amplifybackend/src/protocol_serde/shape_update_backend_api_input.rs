...
pub fn ser_update_backend_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateBackendApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
