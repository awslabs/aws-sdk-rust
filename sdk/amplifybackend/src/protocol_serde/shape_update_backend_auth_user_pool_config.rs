...
pub fn ser_update_backend_auth_user_pool_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateBackendAuthUserPoolConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
