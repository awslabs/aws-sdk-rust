...
pub fn ser_create_backend_auth_forgot_password_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CreateBackendAuthForgotPasswordConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
