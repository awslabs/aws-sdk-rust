...
pub fn ser_create_backend_auth_forgot_password_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateBackendAuthForgotPasswordConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_create_backend_auth_forgot_password_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CreateBackendAuthForgotPasswordConfig>, aws_smithy_json::deserialize::error::DeserializeError>
