...
pub fn ser_create_backend_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBackendInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
