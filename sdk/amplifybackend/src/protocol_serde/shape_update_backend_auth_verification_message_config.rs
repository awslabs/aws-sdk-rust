...
pub fn ser_update_backend_auth_verification_message_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateBackendAuthVerificationMessageConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
