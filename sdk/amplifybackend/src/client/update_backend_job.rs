...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::set_app_id): <p>The app ID.</p>
    ///   - [`backend_environment_name(impl ::std::convert::Into<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::backend_environment_name) / [`set_backend_environment_name(Option<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::set_backend_environment_name): <p>The name of the backend environment.</p>
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::set_job_id): <p>The ID for the job.</p>
    ///   - [`operation(impl ::std::convert::Into<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::operation) / [`set_operation(Option<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::set_operation): <p>Filters the list of response objects to include only those with the specified operation name.</p>
    ///   - [`status(impl ::std::convert::Into<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::status) / [`set_status(Option<String>)`](crate::operation::update_backend_job::builders::UpdateBackendJobFluentBuilder::set_status): <p>Filters the list of response objects to include only those with the specified status.</p>
