...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::delete_token::builders::DeleteTokenFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::delete_token::builders::DeleteTokenFluentBuilder::set_app_id): <p>The app ID.</p>
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::delete_token::builders::DeleteTokenFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::delete_token::builders::DeleteTokenFluentBuilder::set_session_id): <p>The session ID.</p>
