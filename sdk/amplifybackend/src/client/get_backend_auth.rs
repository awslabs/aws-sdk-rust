...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::set_app_id):<br>required: **true**<br><p>The app ID.</p><br>
    ...
    ///   - [`resource_name(impl Into<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::set_resource_name):<br>required: **true**<br><p>The name of this resource.</p><br>
