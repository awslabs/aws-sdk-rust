...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::get_backend_api_models::builders::GetBackendAPIModelsFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::get_backend_api_models::builders::GetBackendAPIModelsFluentBuilder::set_app_id):<br>required: **true**<br><p>The app ID.</p><br>
    ///   - [`backend_environment_name(impl Into<String>)`](crate::operation::get_backend_api_models::builders::GetBackendAPIModelsFluentBuilder::backend_environment_name) / [`set_backend_environment_name(Option<String>)`](crate::operation::get_backend_api_models::builders::GetBackendAPIModelsFluentBuilder::set_backend_environment_name):<br>required: **true**<br><p>The name of the backend environment.</p><br>
    ///   - [`resource_name(impl Into<String>)`](crate::operation::get_backend_api_models::builders::GetBackendAPIModelsFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::get_backend_api_models::builders::GetBackendAPIModelsFluentBuilder::set_resource_name):<br>required: **true**<br><p>The name of this resource.</p><br>
