...
pub(crate) fn reflens_structure_crate_output_list_cluster_snapshots_output_next_token(
    input: &crate::output::ListClusterSnapshotsOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
...
pub(crate) fn lens_structure_crate_output_list_clusters_output_clusters(
    input: crate::output::ListClustersOutput,
) -> std::option::Option<std::vec::Vec<crate::model::ClusterInList>> {
...
pub(crate) fn lens_structure_crate_output_list_cluster_snapshots_output_snapshots(
    input: crate::output::ListClusterSnapshotsOutput,
