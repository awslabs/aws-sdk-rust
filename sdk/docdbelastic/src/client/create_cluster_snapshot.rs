...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::cluster_arn) / [`set_cluster_arn(impl Into<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The arn of the Elastic DocumentDB cluster that the snapshot will be taken from.</p><br>
    ///   - [`snapshot_name(impl Into<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(impl Into<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::set_snapshot_name):<br>required: **true**<br><p>The name of the Elastic DocumentDB snapshot.</p><br>
