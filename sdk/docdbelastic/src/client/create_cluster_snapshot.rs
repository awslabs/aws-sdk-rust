...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl ::std::convert::Into<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::set_cluster_arn): <p>The arn of the Elastic DocumentDB cluster that the snapshot will be taken from.</p>
    ///   - [`snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(Option<String>)`](crate::operation::create_cluster_snapshot::builders::CreateClusterSnapshotFluentBuilder::set_snapshot_name): <p>The name of the Elastic DocumentDB snapshot.</p>
