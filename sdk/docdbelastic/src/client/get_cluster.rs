...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::get_cluster::builders::GetClusterFluentBuilder::cluster_arn) / [`set_cluster_arn(impl Into<String>)`](crate::operation::get_cluster::builders::GetClusterFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The arn of the Elastic DocumentDB cluster.</p><br>
