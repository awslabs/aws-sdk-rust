...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::cluster_arn) / [`set_cluster_arn(impl Into<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The arn of the Elastic DocumentDB cluster that is to be deleted.</p><br>
