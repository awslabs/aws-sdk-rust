...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::set_cluster_arn):<br>required: **true**<br><p>The ARN identifier of the elastic cluster that is to be deleted.</p><br>
                            /// - On success, responds with [`DeleteClusterOutput`](crate::operation::delete_cluster::DeleteClusterOutput) with field(s):
    ///   - [`cluster(Option<Cluster>)`](crate::operation::delete_cluster::DeleteClusterOutput::cluster): <p>Returns information about the newly deleted elastic cluster.</p>
