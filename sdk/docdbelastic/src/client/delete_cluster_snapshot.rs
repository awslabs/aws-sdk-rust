...
impl super::Client {
    ...
    ///   - [`snapshot_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_cluster_snapshot::builders::DeleteClusterSnapshotFluentBuilder::snapshot_arn) / [`set_snapshot_arn(Option<String>)`](crate::operation::delete_cluster_snapshot::builders::DeleteClusterSnapshotFluentBuilder::set_snapshot_arn): <p>The arn of the Elastic DocumentDB snapshot that is to be deleted.</p>
