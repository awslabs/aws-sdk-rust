...
impl super::Client {
    ...
    ///   - [`cluster_arn(impl Into<String>)`](crate::operation::list_cluster_snapshots::builders::ListClusterSnapshotsFluentBuilder::cluster_arn) / [`set_cluster_arn(Option<String>)`](crate::operation::list_cluster_snapshots::builders::ListClusterSnapshotsFluentBuilder::set_cluster_arn):<br>required: **false**<br><p>The arn of the Elastic DocumentDB cluster.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_cluster_snapshots::builders::ListClusterSnapshotsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_cluster_snapshots::builders::ListClusterSnapshotsFluentBuilder::set_next_token):<br>required: **false**<br><p>The nextToken which is used the get the next page of data.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_cluster_snapshots::builders::ListClusterSnapshotsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_cluster_snapshots::builders::ListClusterSnapshotsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of entries to recieve in the response.</p><br>
