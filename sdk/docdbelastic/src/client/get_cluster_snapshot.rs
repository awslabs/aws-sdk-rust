...
impl super::Client {
    ...
    ///   - [`snapshot_arn(impl ::std::convert::Into<String>)`](crate::operation::get_cluster_snapshot::builders::GetClusterSnapshotFluentBuilder::snapshot_arn) / [`set_snapshot_arn(Option<String>)`](crate::operation::get_cluster_snapshot::builders::GetClusterSnapshotFluentBuilder::set_snapshot_arn): <p>The arn of the Elastic DocumentDB snapshot.</p>
