...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError> for Error {
    fn from(err: crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError) -> Self {
        match err {
            ...
            crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError::InternalServerException(inner) => Error::InternalServerException(inner),
            crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cluster_snapshot::CreateClusterSnapshotError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cluster_snapshot::CreateClusterSnapshotError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cluster_snapshot::DeleteClusterSnapshotError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_cluster_snapshot::DeleteClusterSnapshotError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cluster::GetClusterError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cluster_snapshot::GetClusterSnapshotError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_cluster_snapshots::ListClusterSnapshotsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_cluster::StartClusterError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_cluster::StopClusterError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_cluster::UpdateClusterError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
