...
pub fn serialize_operation_crate_operation_create_cluster_snapshot(
    ...
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_create_cluster_snapshot_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn serialize_operation_crate_operation_restore_cluster_from_snapshot(
    input: &crate::input::RestoreClusterFromSnapshotInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_restore_cluster_from_snapshot_input(
        &mut object,
        input,
    )?;
    object.finish();
