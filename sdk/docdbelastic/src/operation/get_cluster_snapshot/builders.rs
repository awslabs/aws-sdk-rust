...
impl GetClusterSnapshotFluentBuilder  {
    /// Creates a new `GetClusterSnapshot`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_cluster_snapshot::GetClusterSnapshotOutput, aws_smithy_http::result::SdkError<crate::operation::get_cluster_snapshot::GetClusterSnapshotError>>
                     {
