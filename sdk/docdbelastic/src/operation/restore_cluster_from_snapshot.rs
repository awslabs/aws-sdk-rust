...
/// Orchestration and serialization glue logic for `RestoreClusterFromSnapshot`.
...
impl RestoreClusterFromSnapshot {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreClusterFromSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RestoreClusterFromSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RestoreClusterFromSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RestoreClusterFromSnapshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreClusterFromSnapshot")
...
.with_interceptor(RestoreClusterFromSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError>::new());
...
#[derive(Debug)]
            struct RestoreClusterFromSnapshotResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreClusterFromSnapshotResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_restore_cluster_from_snapshot::de_restore_cluster_from_snapshot_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_restore_cluster_from_snapshot::de_restore_cluster_from_snapshot_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RestoreClusterFromSnapshotRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreClusterFromSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.snapshot_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("snapshot_arn", "cannot be empty or unset"))?;
    let snapshot_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if snapshot_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("snapshot_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/cluster-snapshot/{snapshotArn}/restore", snapshotArn = snapshot_arn).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_restore_cluster_from_snapshot::ser_restore_cluster_from_snapshot_input(&input)?);
...
#[derive(Debug)]
            struct RestoreClusterFromSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreClusterFromSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RestoreClusterFromSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RestoreClusterFromSnapshotInput>()
                        .ok_or("failed to downcast to RestoreClusterFromSnapshotInput")?;
...
pub enum RestoreClusterFromSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RestoreClusterFromSnapshotError) for what information is available for the error.")]
...
impl RestoreClusterFromSnapshotError {
    /// Creates the `RestoreClusterFromSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreClusterFromSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RestoreClusterFromSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::restore_cluster_from_snapshot::_restore_cluster_from_snapshot_output::RestoreClusterFromSnapshotOutput;

pub use crate::operation::restore_cluster_from_snapshot::_restore_cluster_from_snapshot_input::RestoreClusterFromSnapshotInput;

mod _restore_cluster_from_snapshot_input;

mod _restore_cluster_from_snapshot_output;
