...
impl RestoreClusterFromSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`RestoreClusterFromSnapshot`](crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.snapshot_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("snapshot_arn", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshot::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreClusterFromSnapshot {
                type Output = std::result::Result<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotOutput, crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotError>;
