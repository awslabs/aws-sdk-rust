...
impl CreateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DocDB Elastic", "CreateCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("adminUserName") {
            if let ::std::option::Option::Some(value) = input.admin_user_name.as_deref() {
                captured.insert("adminUserName", value);
            }
        }
