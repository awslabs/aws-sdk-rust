...
impl ListClusterSnapshotsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_cluster_snapshots::ListClusterSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_cluster_snapshots::ListClusterSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/cluster-snapshots").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_cluster_snapshots::ListClusterSnapshotsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.cluster_arn {
                     {
...
impl aws_smithy_http::response::ParseStrictResponse for ListClusterSnapshots {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_cluster_snapshots::de_list_cluster_snapshots_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_cluster_snapshots::de_list_cluster_snapshots_http_response(response)
                     }
                }
            }
