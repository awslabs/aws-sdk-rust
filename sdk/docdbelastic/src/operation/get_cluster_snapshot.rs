...
impl GetClusterSnapshot {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_cluster_snapshot::GetClusterSnapshotInput,
                    ) -> ::std::result::Result<crate::operation::get_cluster_snapshot::GetClusterSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cluster_snapshot::GetClusterSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_cluster_snapshot::GetClusterSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_cluster_snapshot::GetClusterSnapshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetClusterSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetClusterSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetClusterSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetClusterSnapshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetClusterSnapshot")
...
.with_interceptor(GetClusterSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_cluster_snapshot::GetClusterSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_cluster_snapshot::GetClusterSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_cluster_snapshot::GetClusterSnapshotError>::new());
...
#[derive(Debug)]
            struct GetClusterSnapshotResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetClusterSnapshotResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_cluster_snapshot::de_get_cluster_snapshot_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetClusterSnapshotRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetClusterSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_cluster_snapshot::GetClusterSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_cluster_snapshot::GetClusterSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/cluster-snapshot/{snapshotArn}", snapshotArn = snapshot_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetClusterSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetClusterSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetClusterSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetClusterSnapshotInput>()
                        .ok_or("failed to downcast to GetClusterSnapshotInput")?;
...
pub enum GetClusterSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetClusterSnapshotError) for what information is available for the error.")]
...
impl GetClusterSnapshotError {
    /// Creates the `GetClusterSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetClusterSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetClusterSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_cluster_snapshot::GetClusterSnapshotError {
...
mod _get_cluster_snapshot_output;
