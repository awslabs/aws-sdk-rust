...
impl GetClusterSnapshotInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cluster_snapshot::GetClusterSnapshot::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetClusterSnapshot {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_cluster_snapshot::de_get_cluster_snapshot_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_cluster_snapshot::GetClusterSnapshotError
{
