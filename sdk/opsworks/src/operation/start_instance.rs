...
impl StartInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_instance::StartInstance,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_instance::StartInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_instance::de_start_instance_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_instance::de_start_instance_http_response_with_props(
                status, headers, body,
            )
        }
    }
