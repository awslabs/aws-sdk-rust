...
impl StartInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_instance::StartInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_instance::ser_start_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_instance::de_start_instance_http_response_with_props(status, headers, body)
        }
    }
}
