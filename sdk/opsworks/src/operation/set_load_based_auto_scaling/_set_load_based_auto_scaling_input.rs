...
impl SetLoadBasedAutoScalingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_load_based_auto_scaling::SetLoadBasedAutoScalingInput, ::aws_smithy_types::error::operation::BuildError> {
