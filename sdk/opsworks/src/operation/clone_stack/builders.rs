...
impl CloneStackFluentBuilder  {
    /// Creates a new `CloneStack`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::clone_stack::CloneStack, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::clone_stack::CloneStackError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::clone_stack::CloneStackOutput, aws_smithy_http::result::SdkError<crate::operation::clone_stack::CloneStackError>>
                     {
