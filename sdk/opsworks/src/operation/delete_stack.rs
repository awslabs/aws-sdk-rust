...
impl DeleteStackInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_stack::DeleteStack::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_stack::de_delete_stack_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_stack::de_delete_stack_http_response_with_props(
                status, headers, body,
            )
        }
    }
