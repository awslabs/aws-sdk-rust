...
impl CreateStackInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_stack::ser_create_stack_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_stack::CreateStack::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStack", "opsworks"));
