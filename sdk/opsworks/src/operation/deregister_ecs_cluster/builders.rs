...
impl DeregisterEcsClusterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deregister_ecs_cluster::DeregisterEcsClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_ecs_cluster::DeregisterEcsClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deregister_ecs_cluster::DeregisterEcsClusterOutput, crate::operation::deregister_ecs_cluster::DeregisterEcsClusterError, Self> {
