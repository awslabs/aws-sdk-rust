...
impl RegisterInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_instance::RegisterInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_instance::ser_register_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_instance::de_register_instance_http_response_with_props(status, headers, body)
        }
    }
}
