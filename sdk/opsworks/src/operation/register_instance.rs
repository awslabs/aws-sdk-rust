...
impl RegisterInstanceInput {
    /// Consumes the builder and constructs an Operation<[`RegisterInstance`](crate::operation::register_instance::RegisterInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_instance::RegisterInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_instance::RegisterInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_instance::ser_register_instance_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_instance::RegisterInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterInstance", "opsworks"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterInstance {
                type Output = std::result::Result<crate::operation::register_instance::RegisterInstanceOutput, crate::operation::register_instance::RegisterInstanceError>;
