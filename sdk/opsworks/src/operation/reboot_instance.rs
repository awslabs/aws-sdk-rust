...
impl RebootInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reboot_instance::RebootInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reboot_instance::ser_reboot_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reboot_instance::de_reboot_instance_http_response_with_props(status, headers, body)
        }
    }
}
