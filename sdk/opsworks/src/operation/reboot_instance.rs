...
impl RebootInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reboot_instance::RebootInstance,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reboot_instance::RebootInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reboot_instance::de_reboot_instance_http_error(
                status, headers, body,
            )
        } else {
