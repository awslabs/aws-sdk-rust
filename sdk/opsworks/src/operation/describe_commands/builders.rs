...
impl DescribeCommandsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_commands::DescribeCommandsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_commands::DescribeCommandsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_commands::DescribeCommandsOutput, crate::operation::describe_commands::DescribeCommandsError, Self> {
