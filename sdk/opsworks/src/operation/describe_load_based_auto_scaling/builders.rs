...
impl DescribeLoadBasedAutoScalingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_load_based_auto_scaling::DescribeLoadBasedAutoScalingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_load_based_auto_scaling::DescribeLoadBasedAutoScalingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_load_based_auto_scaling::DescribeLoadBasedAutoScalingOutput, crate::operation::describe_load_based_auto_scaling::DescribeLoadBasedAutoScalingError, Self> {
