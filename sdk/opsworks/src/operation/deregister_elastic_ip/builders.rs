...
impl DeregisterElasticIpFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deregister_elastic_ip::DeregisterElasticIpOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_elastic_ip::DeregisterElasticIpError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deregister_elastic_ip::DeregisterElasticIpOutput, crate::operation::deregister_elastic_ip::DeregisterElasticIpError, Self> {
