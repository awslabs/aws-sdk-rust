...
impl DescribeRdsDbInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_rds_db_instances::DescribeRdsDbInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_rds_db_instances::DescribeRdsDbInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_rds_db_instances::DescribeRdsDbInstancesOutput, crate::operation::describe_rds_db_instances::DescribeRdsDbInstancesError, Self> {
