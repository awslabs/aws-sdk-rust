...
impl DescribeElasticLoadBalancersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_elastic_load_balancers::DescribeElasticLoadBalancersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_elastic_load_balancers::DescribeElasticLoadBalancersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_elastic_load_balancers::DescribeElasticLoadBalancersOutput, crate::operation::describe_elastic_load_balancers::DescribeElasticLoadBalancersError, Self> {
