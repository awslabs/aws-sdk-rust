...
impl DescribeRaidArraysFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_raid_arrays::DescribeRaidArraysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_raid_arrays::DescribeRaidArraysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_raid_arrays::DescribeRaidArraysOutput, crate::operation::describe_raid_arrays::DescribeRaidArraysError, Self> {
