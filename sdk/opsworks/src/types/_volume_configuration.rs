        ...
        ::std::result::Result::Ok(
            crate::types::VolumeConfiguration {
                mount_point: self.mount_point
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("mount_point", "mount_point was not specified but it is required when building VolumeConfiguration")
                    )?
                ,
                ...
                number_of_disks: self.number_of_disks
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("number_of_disks", "number_of_disks was not specified but it is required when building VolumeConfiguration")
                    )?
                ,
                size: self.size
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("size", "size was not specified but it is required when building VolumeConfiguration")
                    )?
                ,
