...
impl ::std::convert::From<&str> for AppAttributesKeys {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AppAttributesKeys::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AppAttributesKeys {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AppAttributesKeys::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AppAttributesKeys {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
