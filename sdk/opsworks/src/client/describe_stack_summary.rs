...
impl super::Client {
    ...
    ///   - [`stack_id(impl Into<String>)`](crate::operation::describe_stack_summary::builders::DescribeStackSummaryFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::describe_stack_summary::builders::DescribeStackSummaryFluentBuilder::set_stack_id):<br>required: **true**<br><p>The stack ID.</p><br>
