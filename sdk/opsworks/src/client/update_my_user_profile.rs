...
impl super::Client {
    ...
    ///   - [`ssh_public_key(impl Into<String>)`](crate::operation::update_my_user_profile::builders::UpdateMyUserProfileFluentBuilder::ssh_public_key) / [`set_ssh_public_key(Option<String>)`](crate::operation::update_my_user_profile::builders::UpdateMyUserProfileFluentBuilder::set_ssh_public_key):<br>required: **false**<br><p>The user's SSH public key.</p><br>
