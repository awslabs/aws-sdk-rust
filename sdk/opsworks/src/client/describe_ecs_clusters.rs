...
impl super::Client {
    ...
    ///   - [`ecs_cluster_arns(Vec<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::ecs_cluster_arns) / [`set_ecs_cluster_arns(Option<Vec<String>>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::set_ecs_cluster_arns): <p>A list of ARNs, one for each cluster to be described.</p>
    ///   - [`stack_id(impl ::std::convert::Into<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::set_stack_id): <p>A stack ID. <code>DescribeEcsClusters</code> returns a description of the cluster that is registered with the stack.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::set_next_token): <p>If the previous paginated request did not return all of the remaining results, the response object's<code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>DescribeEcsClusters</code> again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::set_max_results): <p>To receive a paginated response, use this parameter to specify the maximum number of results to be returned with a single call. If the number of available results exceeds this maximum, the response includes a <code>NextToken</code> value that you can assign to the <code>NextToken</code> request parameter to get the next set of results.</p>
