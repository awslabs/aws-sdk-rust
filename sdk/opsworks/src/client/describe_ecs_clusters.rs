...
impl super::Client {
    ...
    ///   - [`stack_id(impl Into<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::set_stack_id): <p>A stack ID. <code>DescribeEcsClusters</code> returns a description of the cluster that is registered with the stack.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_ecs_clusters::builders::DescribeEcsClustersFluentBuilder::set_next_token): <p>If the previous paginated request did not return all of the remaining results, the response object's<code>NextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>DescribeEcsClusters</code> again and assign that token to the request object's <code>NextToken</code> parameter. If there are no remaining results, the previous response object's <code>NextToken</code> parameter is set to <code>null</code>.</p>
