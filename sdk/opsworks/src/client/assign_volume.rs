...
impl super::Client {
    ...
    ///   - [`volume_id(impl ::std::convert::Into<String>)`](crate::operation::assign_volume::builders::AssignVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::assign_volume::builders::AssignVolumeFluentBuilder::set_volume_id): <p>The volume ID.</p>
