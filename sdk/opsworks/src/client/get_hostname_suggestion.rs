...
impl super::Client {
    ...
    ///   - [`layer_id(impl Into<String>)`](crate::operation::get_hostname_suggestion::builders::GetHostnameSuggestionFluentBuilder::layer_id) / [`set_layer_id(Option<String>)`](crate::operation::get_hostname_suggestion::builders::GetHostnameSuggestionFluentBuilder::set_layer_id):<br>required: **true**<br><p>The layer ID.</p><br>
