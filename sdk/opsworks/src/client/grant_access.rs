...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::grant_access::builders::GrantAccessFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::grant_access::builders::GrantAccessFluentBuilder::set_instance_id):<br>required: **true**<br><p>The instance's OpsWorks Stacks ID.</p><br>
    ///   - [`valid_for_in_minutes(i32)`](crate::operation::grant_access::builders::GrantAccessFluentBuilder::valid_for_in_minutes) / [`set_valid_for_in_minutes(Option<i32>)`](crate::operation::grant_access::builders::GrantAccessFluentBuilder::set_valid_for_in_minutes):<br>required: **false**<br><p>The length of time (in minutes) that the grant is valid. When the grant expires at the end of this period, the user will no longer be able to use the credentials to log in. If the user is logged in at the time, they are logged out.</p><br>
