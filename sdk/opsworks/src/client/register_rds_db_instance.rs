...
impl super::Client {
    ...
    ///   - [`stack_id(impl ::std::convert::Into<String>)`](crate::operation::register_rds_db_instance::builders::RegisterRdsDbInstanceFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::register_rds_db_instance::builders::RegisterRdsDbInstanceFluentBuilder::set_stack_id): <p>The stack ID.</p>
    ///   - [`rds_db_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::register_rds_db_instance::builders::RegisterRdsDbInstanceFluentBuilder::rds_db_instance_arn) / [`set_rds_db_instance_arn(Option<String>)`](crate::operation::register_rds_db_instance::builders::RegisterRdsDbInstanceFluentBuilder::set_rds_db_instance_arn): <p>The Amazon RDS instance's ARN.</p>
    ///   - [`db_user(impl ::std::convert::Into<String>)`](crate::operation::register_rds_db_instance::builders::RegisterRdsDbInstanceFluentBuilder::db_user) / [`set_db_user(Option<String>)`](crate::operation::register_rds_db_instance::builders::RegisterRdsDbInstanceFluentBuilder::set_db_user): <p>The database's master user name.</p>
