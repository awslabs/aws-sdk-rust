...
impl super::Client {
    ...
    ///   - [`stack_id(impl Into<String>)`](crate::operation::stop_stack::builders::StopStackFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::stop_stack::builders::StopStackFluentBuilder::set_stack_id):<br>required: **true**<br><p>The stack ID.</p><br>
