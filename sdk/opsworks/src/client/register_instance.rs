...
impl super::Client {
    ...
    ///   - [`hostname(impl Into<String>)`](crate::operation::register_instance::builders::RegisterInstanceFluentBuilder::hostname) / [`set_hostname(Option<String>)`](crate::operation::register_instance::builders::RegisterInstanceFluentBuilder::set_hostname):<br>required: **false**<br><p>The instance's host name. The following are character limits for instance host names.</p> <ul>  <li>   <p>Linux-based instances: 63 characters</p></li>  <li>   <p>Windows-based instances: 15 characters</p></li> </ul><br>
    ...
    ///   - [`instance_id(Option<String>)`](crate::operation::register_instance::RegisterInstanceOutput::instance_id): <p>The registered instance's OpsWorks Stacks ID.</p>
