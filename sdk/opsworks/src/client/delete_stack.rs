...
impl super::Client {
    ...
    ///   - [`stack_id(impl Into<String>)`](crate::operation::delete_stack::builders::DeleteStackFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::delete_stack::builders::DeleteStackFluentBuilder::set_stack_id):<br>required: **true**<br><p>The stack ID.</p><br>
