...
impl super::Client {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::assign_instance::builders::AssignInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::assign_instance::builders::AssignInstanceFluentBuilder::set_instance_id): <p>The instance ID.</p>
