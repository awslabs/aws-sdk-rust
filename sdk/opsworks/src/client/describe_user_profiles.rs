...
impl super::Client {
    ...
    ///   - [`iam_user_arns(impl Into<String>)`](crate::operation::describe_user_profiles::builders::DescribeUserProfilesFluentBuilder::iam_user_arns) / [`set_iam_user_arns(Option<Vec::<String>>)`](crate::operation::describe_user_profiles::builders::DescribeUserProfilesFluentBuilder::set_iam_user_arns):<br>required: **false**<br><p>An array of IAM or federated user ARNs that identify the users to be described.</p><br>
