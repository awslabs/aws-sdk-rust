...
impl super::Client {
    ...
    ///   - [`ec2_volume_id(impl Into<String>)`](crate::operation::register_volume::builders::RegisterVolumeFluentBuilder::ec2_volume_id) / [`set_ec2_volume_id(Option<String>)`](crate::operation::register_volume::builders::RegisterVolumeFluentBuilder::set_ec2_volume_id):<br>required: **false**<br><p>The Amazon EBS volume ID.</p><br>
    ///   - [`stack_id(impl Into<String>)`](crate::operation::register_volume::builders::RegisterVolumeFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::register_volume::builders::RegisterVolumeFluentBuilder::set_stack_id):<br>required: **true**<br><p>The stack ID.</p><br>
