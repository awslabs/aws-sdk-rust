...
impl super::Client {
    ...
    ///   - [`instance_id(impl Into<String>)`](crate::operation::unassign_instance::builders::UnassignInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::unassign_instance::builders::UnassignInstanceFluentBuilder::set_instance_id):<br>required: **true**<br><p>The instance ID.</p><br>
