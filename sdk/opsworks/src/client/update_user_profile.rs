...
impl super::Client {
    ...
    ///   - [`iam_user_arn(impl ::std::convert::Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::iam_user_arn) / [`set_iam_user_arn(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_iam_user_arn): <p>The user IAM ARN. This can also be a federated user's ARN.</p>
    ///   - [`ssh_username(impl ::std::convert::Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::ssh_username) / [`set_ssh_username(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_ssh_username): <p>The user's SSH user name. The allowable characters are [a-z], [A-Z], [0-9], '-', and '_'. If the specified name includes other punctuation marks, AWS OpsWorks Stacks removes them. For example, <code>my.name</code> will be changed to <code>myname</code>. If you do not specify an SSH user name, AWS OpsWorks Stacks generates one from the IAM user name. </p>
    ///   - [`ssh_public_key(impl ::std::convert::Into<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::ssh_public_key) / [`set_ssh_public_key(Option<String>)`](crate::operation::update_user_profile::builders::UpdateUserProfileFluentBuilder::set_ssh_public_key): <p>The user's new SSH public key.</p>
