...
impl super::Client {
    ...
    ///   - [`stack_id(impl Into<String>)`](crate::operation::describe_permissions::builders::DescribePermissionsFluentBuilder::stack_id) / [`set_stack_id(Option<String>)`](crate::operation::describe_permissions::builders::DescribePermissionsFluentBuilder::set_stack_id):<br>required: **false**<br><p>The stack ID.</p><br>
