...
impl super::Client {
    ...
    ///   - [`agent_installer_url(Option<String>)`](crate::operation::describe_stack_provisioning_parameters::DescribeStackProvisioningParametersOutput::agent_installer_url): <p>The OpsWorks Stacks agent installer's URL.</p>
