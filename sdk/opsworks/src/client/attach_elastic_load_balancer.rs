...
impl super::Client {
    ...
    ///   - [`elastic_load_balancer_name(impl ::std::convert::Into<String>)`](crate::operation::attach_elastic_load_balancer::builders::AttachElasticLoadBalancerFluentBuilder::elastic_load_balancer_name) / [`set_elastic_load_balancer_name(Option<String>)`](crate::operation::attach_elastic_load_balancer::builders::AttachElasticLoadBalancerFluentBuilder::set_elastic_load_balancer_name): <p>The Elastic Load Balancing instance's name.</p>
