...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::delete_app::builders::DeleteAppFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::delete_app::builders::DeleteAppFluentBuilder::set_app_id): <p>The app ID.</p>
