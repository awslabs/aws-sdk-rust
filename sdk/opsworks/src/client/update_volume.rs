...
impl super::Client {
    ...
    ///   - [`volume_id(impl ::std::convert::Into<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::set_volume_id): <p>The volume ID.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::set_name): <p>The new name.</p>
