...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::set_name):<br>required: **false**<br><p>The new name. Volume names can be a maximum of 128 characters.</p><br>
