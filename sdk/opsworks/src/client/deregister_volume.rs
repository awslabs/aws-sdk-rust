...
impl super::Client {
    ...
    ///   - [`volume_id(impl Into<String>)`](crate::operation::deregister_volume::builders::DeregisterVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::deregister_volume::builders::DeregisterVolumeFluentBuilder::set_volume_id):<br>required: **true**<br><p>The AWS OpsWorks Stacks volume ID, which is the GUID that AWS OpsWorks Stacks assigned to the instance when you registered the volume with the stack, not the Amazon EC2 volume ID.</p><br>
