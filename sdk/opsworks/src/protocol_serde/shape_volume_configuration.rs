...
pub fn ser_volume_configuration(
    ...
    if let Some(var_1) = &input.raid_level {
        object.key("RaidLevel").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
     {
        object.key("NumberOfDisks").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.number_of_disks).into()));
    }
     {
...
pub(crate) fn de_volume_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VolumeConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::volume_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
