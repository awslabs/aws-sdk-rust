...
pub fn ser_create_layer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLayerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
