...
pub(crate) fn de_operating_systems<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::OperatingSystem>>, aws_smithy_json::deserialize::error::DeserializeError>
