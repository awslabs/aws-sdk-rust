...
pub(crate) fn de_commands<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Command>>, aws_smithy_json::deserialize::error::DeserializeError>
