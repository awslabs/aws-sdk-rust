...
pub fn ser_update_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
