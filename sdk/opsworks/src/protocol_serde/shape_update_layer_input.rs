...
pub fn ser_update_layer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLayerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
