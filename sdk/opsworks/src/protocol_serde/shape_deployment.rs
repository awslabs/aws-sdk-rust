            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Command" => {
                            builder = builder.set_command(crate::protocol_serde::shape_deployment_command::de_deployment_command(tokens)?);
                        }
                        "Status" => {
                        ...
                        "InstanceIds" => {
                            builder = builder.set_instance_ids(crate::protocol_serde::shape_strings::de_strings(tokens)?);
                        }
