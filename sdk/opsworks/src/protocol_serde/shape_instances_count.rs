...
pub(crate) fn de_instances_count<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstancesCount>, aws_smithy_json::deserialize::error::DeserializeError>
