                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AutoScalingType" => {
                            builder = builder.set_auto_scaling_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AutoScalingType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "AvailabilityZone" => {
                        ...
                        "BlockDeviceMappings" => {
                            builder = builder
                                .set_block_device_mappings(crate::protocol_serde::shape_block_device_mappings::de_block_device_mappings(tokens)?);
                        }
                        "CreatedAt" => {
                        ...
                        "InstallUpdatesOnBoot" => {
                            builder = builder.set_install_updates_on_boot(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "InstanceId" => {
                        ...
                        "LayerIds" => {
                            builder = builder.set_layer_ids(crate::protocol_serde::shape_strings::de_strings(tokens)?);
                        }
                        "Os" => {
                        ...
                        "ReportedOs" => {
                            builder = builder.set_reported_os(crate::protocol_serde::shape_reported_os::de_reported_os(tokens)?);
                        }
                        "RootDeviceType" => {
                            builder = builder.set_root_device_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RootDeviceType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "RootDeviceVolumeId" => {
                        ...
                        "VirtualizationType" => {
                            builder = builder.set_virtualization_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::VirtualizationType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
