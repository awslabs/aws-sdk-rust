...
pub(crate) fn de_rds_db_instance<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::RdsDbInstance>, aws_smithy_json::deserialize::error::DeserializeError>
