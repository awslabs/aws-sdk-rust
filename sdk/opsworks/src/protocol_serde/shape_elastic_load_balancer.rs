...
pub(crate) fn de_elastic_load_balancer<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ElasticLoadBalancer>, aws_smithy_json::deserialize::error::DeserializeError>
