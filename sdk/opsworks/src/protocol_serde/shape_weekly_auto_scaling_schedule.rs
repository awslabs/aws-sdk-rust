...
pub fn ser_weekly_auto_scaling_schedule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WeeklyAutoScalingSchedule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_weekly_auto_scaling_schedule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WeeklyAutoScalingSchedule>, aws_smithy_json::deserialize::error::DeserializeError>
