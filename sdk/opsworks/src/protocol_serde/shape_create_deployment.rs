...
> {
    ...
    Err(match error_code {
        "ResourceNotFoundException" => {
            crate::operation::create_deployment::CreateDeploymentError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ValidationException" => {
            crate::operation::create_deployment::CreateDeploymentError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
