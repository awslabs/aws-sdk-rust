...
pub fn ser_set_load_based_auto_scaling_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetLoadBasedAutoScalingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
