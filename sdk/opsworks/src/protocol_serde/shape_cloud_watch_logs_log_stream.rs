...
pub fn ser_cloud_watch_logs_log_stream(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CloudWatchLogsLogStream) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cloud_watch_logs_log_stream<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CloudWatchLogsLogStream>, aws_smithy_json::deserialize::error::DeserializeError>
