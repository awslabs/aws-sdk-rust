...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_topic_refresh_schedules::builders::ListTopicRefreshSchedulesFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_topic_refresh_schedules::builders::ListTopicRefreshSchedulesFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the topic whose refresh schedule you want described.</p>
    ///   - [`topic_id(impl ::std::convert::Into<String>)`](crate::operation::list_topic_refresh_schedules::builders::ListTopicRefreshSchedulesFluentBuilder::topic_id) / [`set_topic_id(Option<String>)`](crate::operation::list_topic_refresh_schedules::builders::ListTopicRefreshSchedulesFluentBuilder::set_topic_id): <p>The ID for the topic that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
