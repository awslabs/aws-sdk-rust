...
impl super::Client {
    ...
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::update_refresh_schedule::builders::UpdateRefreshScheduleFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::update_refresh_schedule::builders::UpdateRefreshScheduleFluentBuilder::set_data_set_id): <p>The ID of the dataset.</p>
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::update_refresh_schedule::builders::UpdateRefreshScheduleFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_refresh_schedule::builders::UpdateRefreshScheduleFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
