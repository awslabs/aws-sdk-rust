...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the topic whose refresh schedule you want to update.</p>
    ...
    ///   - [`dataset_id(impl Into<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::dataset_id) / [`set_dataset_id(Option<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::set_dataset_id): <p>The ID of the dataset.</p>
