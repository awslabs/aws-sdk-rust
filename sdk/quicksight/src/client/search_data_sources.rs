...
impl super::Client {
    ...
    ///   - [`filters(DataSourceSearchFilter)`](crate::operation::search_data_sources::builders::SearchDataSourcesFluentBuilder::filters) / [`set_filters(Option<Vec<DataSourceSearchFilter>>)`](crate::operation::search_data_sources::builders::SearchDataSourcesFluentBuilder::set_filters): <p>The filters to apply to the search.</p>
