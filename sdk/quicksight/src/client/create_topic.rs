...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::set_tags): <p>Contains a map of the key-value pairs for the resource tag or tags that are assigned to the dataset.</p>
