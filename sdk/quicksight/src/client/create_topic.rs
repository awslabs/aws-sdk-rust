...
impl super::Client {
    ...
    ///   - [`folder_arns(impl Into<String>)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::folder_arns) / [`set_folder_arns(Option<Vec::<String>>)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::set_folder_arns):<br>required: **false**<br><p>The Folder ARN of the folder that you want the topic to reside in.</p><br>
    ///   - [`custom_instructions(CustomInstructions)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::custom_instructions) / [`set_custom_instructions(Option<CustomInstructions>)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::set_custom_instructions):<br>required: **false**<br><p>Custom instructions for the topic.</p><br>
