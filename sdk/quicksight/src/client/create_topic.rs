...
impl super::Client {
    ...
    ///   - [`topic_id(impl Into<String>)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::topic_id) / [`set_topic_id(Option<String>)`](crate::operation::create_topic::builders::CreateTopicFluentBuilder::set_topic_id): <p>The ID for the topic that you want to create. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
