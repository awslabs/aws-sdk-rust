...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::create_folder::builders::CreateFolderFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::create_folder::builders::CreateFolderFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account where you want to create the folder.</p>
    ///   - [`folder_id(impl ::std::convert::Into<String>)`](crate::operation::create_folder::builders::CreateFolderFluentBuilder::folder_id) / [`set_folder_id(Option<String>)`](crate::operation::create_folder::builders::CreateFolderFluentBuilder::set_folder_id): <p>The ID of the folder.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_folder::builders::CreateFolderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_folder::builders::CreateFolderFluentBuilder::set_name): <p>The name of the folder.</p>
