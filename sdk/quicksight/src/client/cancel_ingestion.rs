...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::cancel_ingestion::builders::CancelIngestionFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::cancel_ingestion::builders::CancelIngestionFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The Amazon Web Services account ID.</p><br>
    ///   - [`data_set_id(impl Into<String>)`](crate::operation::cancel_ingestion::builders::CancelIngestionFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::cancel_ingestion::builders::CancelIngestionFluentBuilder::set_data_set_id):<br>required: **true**<br><p>The ID of the dataset used in the ingestion.</p><br>
    ///   - [`ingestion_id(impl Into<String>)`](crate::operation::cancel_ingestion::builders::CancelIngestionFluentBuilder::ingestion_id) / [`set_ingestion_id(Option<String>)`](crate::operation::cancel_ingestion::builders::CancelIngestionFluentBuilder::set_ingestion_id):<br>required: **true**<br><p>An ID for the ingestion.</p><br>
