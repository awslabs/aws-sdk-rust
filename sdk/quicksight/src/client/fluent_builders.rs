...
impl DescribeAccountSubscription {
    ...
    pub async fn customize(
        ...
        crate::operation::customize::CustomizableOperation<
            crate::operation::DescribeAccountSubscription,
            aws_http::retry::AwsResponseRetryClassifier,
        >,
...
impl GenerateEmbedUrlForRegisteredUser {
    ...
    pub fn set_experience_configuration(
        mut self,
        input: std::option::Option<crate::model::RegisteredUserEmbeddingExperienceConfiguration>,
    ) -> Self {
        self.inner = self.inner.set_experience_configuration(input);
        self
    }
...
impl UpdatePublicSharingSettings {
    ...
    pub async fn customize(
        ...
        crate::operation::customize::CustomizableOperation<
            crate::operation::UpdatePublicSharingSettings,
            aws_http::retry::AwsResponseRetryClassifier,
        >,
