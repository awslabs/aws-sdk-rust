...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account that you want to create the Amazon QuickSight namespace in.</p>
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_namespace): <p>The name that you want to use to describe the new namespace.</p>
