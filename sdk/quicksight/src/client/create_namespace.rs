...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_tags): <p>The tags that you want to associate with the namespace that you're creating.</p>
