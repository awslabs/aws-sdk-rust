...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID for the Amazon Web Services account that you want to create the QuickSight namespace in.</p><br>
    ///   - [`namespace(impl Into<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_namespace):<br>required: **true**<br><p>The name that you want to use to describe the new namespace.</p><br>
    ///   - [`identity_store(IdentityStore)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::identity_store) / [`set_identity_store(Option<IdentityStore>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_identity_store):<br>required: **true**<br><p>Specifies the type of your user identity directory. Currently, this supports users with an identity type of <code>QUICKSIGHT</code>.</p><br>
    ///   - [`tags(Tag)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_namespace::builders::CreateNamespaceFluentBuilder::set_tags):<br>required: **false**<br><p>The tags that you want to associate with the namespace that you're creating.</p><br>
    /// - On success, responds with [`CreateNamespaceOutput`](crate::operation::create_namespace::CreateNamespaceOutput) with field(s):
    ///   - [`arn(Option<String>)`](crate::operation::create_namespace::CreateNamespaceOutput::arn): <p>The ARN of the QuickSight namespace you created.</p>
