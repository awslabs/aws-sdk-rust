...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::update_folder::builders::UpdateFolderFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_folder::builders::UpdateFolderFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID for the Amazon Web Services account that contains the folder to update.</p><br>
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_folder::builders::UpdateFolderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_folder::builders::UpdateFolderFluentBuilder::set_name):<br>required: **true**<br><p>The name of the folder.</p><br>
