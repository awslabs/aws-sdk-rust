...
impl super::Client {
    ...
    ///   - [`user_name(impl Into<String>)`](crate::operation::describe_user::builders::DescribeUserFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::describe_user::builders::DescribeUserFluentBuilder::set_user_name):<br>required: **true**<br><p>The name of the user that you want to describe.</p><br>
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::describe_user::builders::DescribeUserFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::describe_user::builders::DescribeUserFluentBuilder::set_namespace):<br>required: **true**<br><p>The namespace. Currently, you should set this to <code>default</code>.</p><br>
