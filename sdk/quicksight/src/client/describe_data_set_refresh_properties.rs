...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::describe_data_set_refresh_properties::builders::DescribeDataSetRefreshPropertiesFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_data_set_refresh_properties::builders::DescribeDataSetRefreshPropertiesFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
    ///   - [`data_set_id(impl Into<String>)`](crate::operation::describe_data_set_refresh_properties::builders::DescribeDataSetRefreshPropertiesFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::describe_data_set_refresh_properties::builders::DescribeDataSetRefreshPropertiesFluentBuilder::set_data_set_id): <p>The ID of the dataset.</p>
