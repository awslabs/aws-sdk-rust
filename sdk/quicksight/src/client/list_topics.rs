...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::list_topics::builders::ListTopicsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_topics::builders::ListTopicsFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the topics that you want to list.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_topics::builders::ListTopicsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_topics::builders::ListTopicsFluentBuilder::set_next_token): <p>The token for the next set of results, or null if there are no more results.</p>
