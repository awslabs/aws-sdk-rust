...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::delete_account_customization::builders::DeleteAccountCustomizationFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_account_customization::builders::DeleteAccountCustomizationFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID for the Amazon Web Services account that you want to delete Quick Sight customizations from.</p><br>
    ///   - [`namespace(impl Into<String>)`](crate::operation::delete_account_customization::builders::DeleteAccountCustomizationFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::delete_account_customization::builders::DeleteAccountCustomizationFluentBuilder::set_namespace):<br>required: **false**<br><p>The Quick Sight namespace that you're deleting the customizations from.</p><br>
