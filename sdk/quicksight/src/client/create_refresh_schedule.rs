...
impl super::Client {
    ...
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::create_refresh_schedule::builders::CreateRefreshScheduleFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::create_refresh_schedule::builders::CreateRefreshScheduleFluentBuilder::set_data_set_id): <p>The ID of the dataset.</p>
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::create_refresh_schedule::builders::CreateRefreshScheduleFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::create_refresh_schedule::builders::CreateRefreshScheduleFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
