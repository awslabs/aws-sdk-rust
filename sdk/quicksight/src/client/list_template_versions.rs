...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID of the Amazon Web Services account that contains the templates that you're listing.</p><br>
    ///   - [`template_id(impl Into<String>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::template_id) / [`set_template_id(Option<String>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::set_template_id):<br>required: **true**<br><p>The ID for the template.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of results, or null if there are no more results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_template_versions::builders::ListTemplateVersionsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to be returned per request.</p><br>
