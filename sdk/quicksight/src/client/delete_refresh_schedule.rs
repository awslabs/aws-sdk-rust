...
impl super::Client {
    ...
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::delete_refresh_schedule::builders::DeleteRefreshScheduleFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::delete_refresh_schedule::builders::DeleteRefreshScheduleFluentBuilder::set_data_set_id): <p>The ID of the dataset.</p>
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::delete_refresh_schedule::builders::DeleteRefreshScheduleFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_refresh_schedule::builders::DeleteRefreshScheduleFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
    ///   - [`schedule_id(impl ::std::convert::Into<String>)`](crate::operation::delete_refresh_schedule::builders::DeleteRefreshScheduleFluentBuilder::schedule_id) / [`set_schedule_id(Option<String>)`](crate::operation::delete_refresh_schedule::builders::DeleteRefreshScheduleFluentBuilder::set_schedule_id): <p>The ID of the refresh schedule.</p>
