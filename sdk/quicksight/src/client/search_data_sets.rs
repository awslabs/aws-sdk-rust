...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::search_data_sets::builders::SearchDataSetsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::search_data_sets::builders::SearchDataSetsFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_data_sets::builders::SearchDataSetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_data_sets::builders::SearchDataSetsFluentBuilder::set_next_token): <p>A pagination token that can be used in a subsequent request.</p>
