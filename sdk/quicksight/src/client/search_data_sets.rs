...
impl super::Client {
    ...
    ///   - [`filters(DataSetSearchFilter)`](crate::operation::search_data_sets::builders::SearchDataSetsFluentBuilder::filters) / [`set_filters(Option<Vec<DataSetSearchFilter>>)`](crate::operation::search_data_sets::builders::SearchDataSetsFluentBuilder::set_filters): <p>The filters to apply to the search.</p>
