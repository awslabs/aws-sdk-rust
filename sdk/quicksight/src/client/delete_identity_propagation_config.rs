...
impl super::Client {
    ...
    pub fn delete_identity_propagation_config(&self) -> crate::operation::delete_identity_propagation_config::builders::DeleteIdentityPropagationConfigFluentBuilder {
