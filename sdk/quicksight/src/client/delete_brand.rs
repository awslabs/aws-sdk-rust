...
impl super::Client {
    ...
    ///   - [`brand_id(impl Into<String>)`](crate::operation::delete_brand::builders::DeleteBrandFluentBuilder::brand_id) / [`set_brand_id(Option<String>)`](crate::operation::delete_brand::builders::DeleteBrandFluentBuilder::set_brand_id):<br>required: **true**<br><p>The ID of the Quick brand.</p><br>
