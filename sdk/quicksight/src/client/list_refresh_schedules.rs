...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_refresh_schedules::builders::ListRefreshSchedulesFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_refresh_schedules::builders::ListRefreshSchedulesFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::list_refresh_schedules::builders::ListRefreshSchedulesFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::list_refresh_schedules::builders::ListRefreshSchedulesFluentBuilder::set_data_set_id): <p>The ID of the dataset.</p>
    ...
    pub fn list_refresh_schedules(
        &self,
    ) -> crate::operation::list_refresh_schedules::builders::ListRefreshSchedulesFluentBuilder {
        crate::operation::list_refresh_schedules::builders::ListRefreshSchedulesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
