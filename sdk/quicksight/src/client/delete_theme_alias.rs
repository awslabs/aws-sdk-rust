...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::delete_theme_alias::builders::DeleteThemeAliasFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_theme_alias::builders::DeleteThemeAliasFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the theme alias to delete.</p>
    ///   - [`theme_id(impl ::std::convert::Into<String>)`](crate::operation::delete_theme_alias::builders::DeleteThemeAliasFluentBuilder::theme_id) / [`set_theme_id(Option<String>)`](crate::operation::delete_theme_alias::builders::DeleteThemeAliasFluentBuilder::set_theme_id): <p>The ID for the theme that the specified alias is for.</p>
    ///   - [`alias_name(impl ::std::convert::Into<String>)`](crate::operation::delete_theme_alias::builders::DeleteThemeAliasFluentBuilder::alias_name) / [`set_alias_name(Option<String>)`](crate::operation::delete_theme_alias::builders::DeleteThemeAliasFluentBuilder::set_alias_name): <p>The unique name for the theme alias to delete.</p>
