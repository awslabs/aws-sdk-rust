...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleFluentBuilder::set_data_set_id): <p>The ID of the dataset.</p>
    ///   - [`schedule_id(impl ::std::convert::Into<String>)`](crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleFluentBuilder::schedule_id) / [`set_schedule_id(Option<String>)`](crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleFluentBuilder::set_schedule_id): <p>The ID of the refresh schedule.</p>
