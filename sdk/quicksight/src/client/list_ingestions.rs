...
impl super::Client {
    ...
    ///   - [`data_set_id(impl ::std::convert::Into<String>)`](crate::operation::list_ingestions::builders::ListIngestionsFluentBuilder::data_set_id) / [`set_data_set_id(Option<String>)`](crate::operation::list_ingestions::builders::ListIngestionsFluentBuilder::set_data_set_id): <p>The ID of the dataset used in the ingestion.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_ingestions::builders::ListIngestionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_ingestions::builders::ListIngestionsFluentBuilder::set_next_token): <p>The token for the next set of results, or null if there are no more results.</p>
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_ingestions::builders::ListIngestionsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_ingestions::builders::ListIngestionsFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
