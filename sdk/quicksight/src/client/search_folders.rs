...
impl super::Client {
    ...
    ///   - [`filters(FolderSearchFilter)`](crate::operation::search_folders::builders::SearchFoldersFluentBuilder::filters) / [`set_filters(Option<Vec<FolderSearchFilter>>)`](crate::operation::search_folders::builders::SearchFoldersFluentBuilder::set_filters): <p>The filters to apply to the search. Currently, you can search only by the parent folder ARN. For example, <code>"Filters": [ { "Name": "PARENT_FOLDER_ARN", "Operator": "StringEquals", "Value": "arn:aws:quicksight:us-east-1:1:folder/folderId" } ]</code>.</p>
