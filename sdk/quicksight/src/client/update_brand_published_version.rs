...
impl super::Client {
    ...
    ///   - [`brand_id(impl Into<String>)`](crate::operation::update_brand_published_version::builders::UpdateBrandPublishedVersionFluentBuilder::brand_id) / [`set_brand_id(Option<String>)`](crate::operation::update_brand_published_version::builders::UpdateBrandPublishedVersionFluentBuilder::set_brand_id):<br>required: **true**<br><p>The ID of the Quick Suite brand.</p><br>
