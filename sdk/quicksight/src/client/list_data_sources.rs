...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::set_next_token): <p>The token for the next set of results, or null if there are no more results.</p>
