...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_analysis_definition::builders::DescribeAnalysisDefinitionFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_analysis_definition::builders::DescribeAnalysisDefinitionFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the analysis. You must be using the Amazon Web Services account that the analysis is in.</p>
    ///   - [`analysis_id(impl ::std::convert::Into<String>)`](crate::operation::describe_analysis_definition::builders::DescribeAnalysisDefinitionFluentBuilder::analysis_id) / [`set_analysis_id(Option<String>)`](crate::operation::describe_analysis_definition::builders::DescribeAnalysisDefinitionFluentBuilder::set_analysis_id): <p>The ID of the analysis that you're describing. The ID is part of the URL of the analysis.</p>
