...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::delete_theme::builders::DeleteThemeFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_theme::builders::DeleteThemeFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the theme that you're deleting.</p>
    ///   - [`theme_id(impl ::std::convert::Into<String>)`](crate::operation::delete_theme::builders::DeleteThemeFluentBuilder::theme_id) / [`set_theme_id(Option<String>)`](crate::operation::delete_theme::builders::DeleteThemeFluentBuilder::set_theme_id): <p>An ID for the theme that you want to delete.</p>
