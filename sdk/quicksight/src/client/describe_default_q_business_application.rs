...
impl super::Client {
    ...
    ///   - [`application_id(Option<String>)`](crate::operation::describe_default_q_business_application::DescribeDefaultQBusinessApplicationOutput::application_id): <p>The ID of the Amazon Q Business application that is linked to the QuickSight account.</p>
