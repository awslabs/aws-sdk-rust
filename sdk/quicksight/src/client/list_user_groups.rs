...
impl super::Client {
    ...
    ///   - [`user_name(impl Into<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::set_user_name):<br>required: **true**<br><p>The Amazon Quick Sight user name that you want to list group memberships for.</p><br>
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The Amazon Web Services account ID that the user is in. Currently, you use the ID for the Amazon Web Services account that contains your Amazon Quick Sight account.</p><br>
