...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_topic_permissions::builders::DescribeTopicPermissionsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_topic_permissions::builders::DescribeTopicPermissionsFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the topic that you want described.</p>
    ///   - [`topic_id(impl ::std::convert::Into<String>)`](crate::operation::describe_topic_permissions::builders::DescribeTopicPermissionsFluentBuilder::topic_id) / [`set_topic_id(Option<String>)`](crate::operation::describe_topic_permissions::builders::DescribeTopicPermissionsFluentBuilder::set_topic_id): <p>The ID of the topic that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
