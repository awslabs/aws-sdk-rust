...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID of the Amazon Web Services account that contains the theme.</p><br>
    ///   - [`theme_id(impl Into<String>)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::theme_id) / [`set_theme_id(Option<String>)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::set_theme_id):<br>required: **true**<br><p>The ID for the theme.</p><br>
    ///   - [`grant_permissions(ResourcePermission)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::grant_permissions) / [`set_grant_permissions(Option<Vec::<ResourcePermission>>)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::set_grant_permissions):<br>required: **false**<br><p>A list of resource permissions to be granted for the theme.</p><br>
    ///   - [`revoke_permissions(ResourcePermission)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::revoke_permissions) / [`set_revoke_permissions(Option<Vec::<ResourcePermission>>)`](crate::operation::update_theme_permissions::builders::UpdateThemePermissionsFluentBuilder::set_revoke_permissions):<br>required: **false**<br><p>A list of resource permissions to be revoked from the theme.</p><br>
