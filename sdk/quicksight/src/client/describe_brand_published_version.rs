...
impl super::Client {
    ...
    ///   - [`brand_id(impl Into<String>)`](crate::operation::describe_brand_published_version::builders::DescribeBrandPublishedVersionFluentBuilder::brand_id) / [`set_brand_id(Option<String>)`](crate::operation::describe_brand_published_version::builders::DescribeBrandPublishedVersionFluentBuilder::set_brand_id):<br>required: **true**<br><p>The ID of the Quick brand.</p><br>
