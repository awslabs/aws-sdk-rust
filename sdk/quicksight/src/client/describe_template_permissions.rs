...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_template_permissions::builders::DescribeTemplatePermissionsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_template_permissions::builders::DescribeTemplatePermissionsFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the template that you're describing.</p>
    ///   - [`template_id(impl ::std::convert::Into<String>)`](crate::operation::describe_template_permissions::builders::DescribeTemplatePermissionsFluentBuilder::template_id) / [`set_template_id(Option<String>)`](crate::operation::describe_template_permissions::builders::DescribeTemplatePermissionsFluentBuilder::set_template_id): <p>The ID for the template.</p>
