...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the template that you're updating.</p>
    ///   - [`template_id(impl Into<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::template_id) / [`set_template_id(Option<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::set_template_id): <p>The ID for the template.</p>
    ...
    ///   - [`version_description(impl Into<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::version_description) / [`set_version_description(Option<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::set_version_description): <p>A description of the current template version that is being updated. Every time you call <code>UpdateTemplate</code>, you create a new version of the template. Each version of the template maintains a description of the version in the <code>VersionDescription</code> field.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_template::builders::UpdateTemplateFluentBuilder::set_name): <p>The name for the template.</p>
