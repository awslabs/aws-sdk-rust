...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::delete_topic::builders::DeleteTopicFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_topic::builders::DeleteTopicFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the topic that you want to delete.</p>
    ///   - [`topic_id(impl Into<String>)`](crate::operation::delete_topic::builders::DeleteTopicFluentBuilder::topic_id) / [`set_topic_id(Option<String>)`](crate::operation::delete_topic::builders::DeleteTopicFluentBuilder::set_topic_id): <p>The ID of the topic that you want to delete. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
