...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::list_theme_aliases::builders::ListThemeAliasesFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_theme_aliases::builders::ListThemeAliasesFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID of the Amazon Web Services account that contains the theme aliases that you're listing.</p><br>
    ///   - [`theme_id(impl Into<String>)`](crate::operation::list_theme_aliases::builders::ListThemeAliasesFluentBuilder::theme_id) / [`set_theme_id(Option<String>)`](crate::operation::list_theme_aliases::builders::ListThemeAliasesFluentBuilder::set_theme_id):<br>required: **true**<br><p>The ID for the theme.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_theme_aliases::builders::ListThemeAliasesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_theme_aliases::builders::ListThemeAliasesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to be returned per request.</p><br>
