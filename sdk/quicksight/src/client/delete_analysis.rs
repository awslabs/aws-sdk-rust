...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::delete_analysis::builders::DeleteAnalysisFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_analysis::builders::DeleteAnalysisFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account where you want to delete an analysis.</p>
    ///   - [`analysis_id(impl ::std::convert::Into<String>)`](crate::operation::delete_analysis::builders::DeleteAnalysisFluentBuilder::analysis_id) / [`set_analysis_id(Option<String>)`](crate::operation::delete_analysis::builders::DeleteAnalysisFluentBuilder::set_analysis_id): <p>The ID of the analysis that you're deleting.</p>
