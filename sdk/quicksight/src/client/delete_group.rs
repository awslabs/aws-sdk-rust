...
impl super::Client {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_namespace):<br>required: **true**<br><p>The namespace of the group that you want to delete.</p><br>
