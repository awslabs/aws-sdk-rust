...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_dashboard::builders::DescribeDashboardFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_dashboard::builders::DescribeDashboardFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the dashboard that you're describing.</p>
    ///   - [`dashboard_id(impl ::std::convert::Into<String>)`](crate::operation::describe_dashboard::builders::DescribeDashboardFluentBuilder::dashboard_id) / [`set_dashboard_id(Option<String>)`](crate::operation::describe_dashboard::builders::DescribeDashboardFluentBuilder::set_dashboard_id): <p>The ID for the dashboard.</p>
    ...
    ///   - [`alias_name(impl ::std::convert::Into<String>)`](crate::operation::describe_dashboard::builders::DescribeDashboardFluentBuilder::alias_name) / [`set_alias_name(Option<String>)`](crate::operation::describe_dashboard::builders::DescribeDashboardFluentBuilder::set_alias_name): <p>The alias name.</p>
