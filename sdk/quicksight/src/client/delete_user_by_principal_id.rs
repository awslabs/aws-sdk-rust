...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::delete_user_by_principal_id::builders::DeleteUserByPrincipalIdFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_user_by_principal_id::builders::DeleteUserByPrincipalIdFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID for the Amazon Web Services account that the user is in. Currently, you use the ID for the Amazon Web Services account that contains your Amazon Quick Sight account.</p><br>
