...
impl super::Client {
    ...
    ///   - [`key_registration(Option<Vec::<RegisteredCustomerManagedKey>>)`](crate::operation::describe_key_registration::DescribeKeyRegistrationOutput::key_registration): <p>A list of <code>RegisteredCustomerManagedKey</code> objects in a Quick Sight account.</p>
    ///   - [`q_data_key(Option<QDataKey>)`](crate::operation::describe_key_registration::DescribeKeyRegistrationOutput::q_data_key): <p>A list of <code>QDataKey</code> objects in a Quick Sight account.</p>
