...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::update_quick_sight_q_search_configuration::builders::UpdateQuickSightQSearchConfigurationFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_quick_sight_q_search_configuration::builders::UpdateQuickSightQSearchConfigurationFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID of the Amazon Web Services account that contains the Quick Sight Q Search configuration that you want to update.</p><br>
    ///   - [`q_search_status(QSearchStatus)`](crate::operation::update_quick_sight_q_search_configuration::builders::UpdateQuickSightQSearchConfigurationFluentBuilder::q_search_status) / [`set_q_search_status(Option<QSearchStatus>)`](crate::operation::update_quick_sight_q_search_configuration::builders::UpdateQuickSightQSearchConfigurationFluentBuilder::set_q_search_status):<br>required: **true**<br><p>The status of the Quick Sight Q Search configuration that the user wants to update.</p><br>
    ...
    ///   - [`q_search_status(Option<QSearchStatus>)`](crate::operation::update_quick_sight_q_search_configuration::UpdateQuickSightQSearchConfigurationOutput::q_search_status): <p>The status of the Quick Sight Q Search configuration.</p>
