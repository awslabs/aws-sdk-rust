...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the theme that you're updating.</p>
    ///   - [`theme_id(impl ::std::convert::Into<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::theme_id) / [`set_theme_id(Option<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::set_theme_id): <p>The ID for the theme.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::set_name): <p>The name for the theme.</p>
    ///   - [`base_theme_id(impl ::std::convert::Into<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::base_theme_id) / [`set_base_theme_id(Option<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::set_base_theme_id): <p>The theme ID, defined by Amazon QuickSight, that a custom theme inherits from. All themes initially inherit from a default Amazon QuickSight theme.</p>
    ///   - [`version_description(impl ::std::convert::Into<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::version_description) / [`set_version_description(Option<String>)`](crate::operation::update_theme::builders::UpdateThemeFluentBuilder::set_version_description): <p>A description of the theme version that you're updating Every time that you call <code>UpdateTheme</code>, you create a new version of the theme. Each version of the theme maintains a description of the version in <code>VersionDescription</code>.</p>
