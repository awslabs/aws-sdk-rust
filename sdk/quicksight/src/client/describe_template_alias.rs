...
impl super::Client {
    ...
    ///   - [`aws_account_id(impl Into<String>)`](crate::operation::describe_template_alias::builders::DescribeTemplateAliasFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_template_alias::builders::DescribeTemplateAliasFluentBuilder::set_aws_account_id):<br>required: **true**<br><p>The ID of the Amazon Web Services account that contains the template alias that you're describing.</p><br>
    ///   - [`template_id(impl Into<String>)`](crate::operation::describe_template_alias::builders::DescribeTemplateAliasFluentBuilder::template_id) / [`set_template_id(Option<String>)`](crate::operation::describe_template_alias::builders::DescribeTemplateAliasFluentBuilder::set_template_id):<br>required: **true**<br><p>The ID for the template.</p><br>
    ///   - [`alias_name(impl Into<String>)`](crate::operation::describe_template_alias::builders::DescribeTemplateAliasFluentBuilder::alias_name) / [`set_alias_name(Option<String>)`](crate::operation::describe_template_alias::builders::DescribeTemplateAliasFluentBuilder::set_alias_name):<br>required: **true**<br><p>The name of the template alias that you want to describe. If you name a specific alias, you describe the version that the alias points to. You can specify the latest version of the template by providing the keyword <code>$LATEST</code> in the <code>AliasName</code> parameter. The keyword <code>$PUBLISHED</code> doesn't apply to templates.</p><br>
