        ...
        for item_1645 in var_1643 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_table_inline_visualization(&mut object_1646, item_1645)?;
                object_1646.finish();
            }
        }
        array_1644.finish();
        ...
        for item_1657 in var_1655 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_visual_custom_action_operation(&mut object_1658, item_1657)?;
                object_1658.finish();
            }
        }
        array_1656.finish();
...
pub fn serialize_structure_crate_model_pivot_table_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1659) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_pivot_table_field_wells(&mut object_1660, var_1659)?;
        object_1660.finish();
    }
    if let Some(var_1661) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1662 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_table_sort_configuration(&mut object_1662, var_1661)?;
        object_1662.finish();
    }
    if let Some(var_1663) = &input.table_options {
        #[allow(unused_mut)]
        let mut object_1664 = object.key("TableOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_table_options(&mut object_1664, var_1663)?;
        object_1664.finish();
    }
    if let Some(var_1665) = &input.total_options {
        #[allow(unused_mut)]
        let mut object_1666 = object.key("TotalOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_table_total_options(&mut object_1666, var_1665)?;
        object_1666.finish();
    }
    if let Some(var_1667) = &input.field_options {
        #[allow(unused_mut)]
        let mut object_1668 = object.key("FieldOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_table_field_options(&mut object_1668, var_1667)?;
        object_1668.finish();
    }
    if let Some(var_1669) = &input.paginated_report_options {
        #[allow(unused_mut)]
        let mut object_1670 = object.key("PaginatedReportOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_table_paginated_report_options(&mut object_1670, var_1669)?;
        object_1670.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_bar_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BarChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1675) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_bar_chart_field_wells(&mut object_1676, var_1675)?;
        object_1676.finish();
    }
    if let Some(var_1677) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1678 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_bar_chart_sort_configuration(&mut object_1678, var_1677)?;
        object_1678.finish();
    }
    ...
    if let Some(var_1681) = &input.visual_palette {
        ...
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1682, var_1681)?;
        object_1682.finish();
    }
    if let Some(var_1683) = &input.small_multiples_options {
        #[allow(unused_mut)]
        let mut object_1684 = object.key("SmallMultiplesOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_small_multiples_options(&mut object_1684, var_1683)?;
        object_1684.finish();
    }
    ...
    if let Some(var_1689) = &input.value_axis {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1690, var_1689)?;
        object_1690.finish();
    }
    if let Some(var_1691) = &input.value_label_options {
        #[allow(unused_mut)]
        let mut object_1692 = object.key("ValueLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1692, var_1691)?;
        object_1692.finish();
    }
    if let Some(var_1693) = &input.color_label_options {
        #[allow(unused_mut)]
        let mut object_1694 = object.key("ColorLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1694, var_1693)?;
        object_1694.finish();
    }
    if let Some(var_1695) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1696 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1696, var_1695)?;
        object_1696.finish();
    }
    if let Some(var_1697) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1698 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1698, var_1697)?;
        object_1698.finish();
    }
    if let Some(var_1699) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1700 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1700, var_1699)?;
        object_1700.finish();
    }
        ...
        for item_1703 in var_1701 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference_line(&mut object_1704, item_1703)?;
                object_1704.finish();
            }
        }
        array_1702.finish();
        ...
        for item_1707 in var_1705 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_contribution_analysis_default(&mut object_1708, item_1707)?;
                object_1708.finish();
            }
        }
        array_1706.finish();
...
pub fn serialize_structure_crate_model_column_hierarchy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ColumnHierarchy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1709) = &input.explicit_hierarchy {
        ...
        crate::json_ser::serialize_structure_crate_model_explicit_hierarchy(&mut object_1710, var_1709)?;
        object_1710.finish();
    }
    if let Some(var_1711) = &input.date_time_hierarchy {
        #[allow(unused_mut)]
        let mut object_1712 = object.key("DateTimeHierarchy").start_object();
        crate::json_ser::serialize_structure_crate_model_date_time_hierarchy(&mut object_1712, var_1711)?;
        object_1712.finish();
    }
    if let Some(var_1713) = &input.predefined_hierarchy {
        #[allow(unused_mut)]
        let mut object_1714 = object.key("PredefinedHierarchy").start_object();
        crate::json_ser::serialize_structure_crate_model_predefined_hierarchy(&mut object_1714, var_1713)?;
        object_1714.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_kpi_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KpiConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1715) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_kpi_field_wells(&mut object_1716, var_1715)?;
        object_1716.finish();
    }
    if let Some(var_1717) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1718 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_kpi_sort_configuration(&mut object_1718, var_1717)?;
        object_1718.finish();
    }
        ...
        for item_1723 in var_1721 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_kpi_conditional_formatting_option(&mut object_1724, item_1723)?;
                object_1724.finish();
            }
        }
        array_1722.finish();
...
pub fn serialize_structure_crate_model_pie_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PieChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1725) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_pie_chart_field_wells(&mut object_1726, var_1725)?;
        object_1726.finish();
    }
    if let Some(var_1727) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1728 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_pie_chart_sort_configuration(&mut object_1728, var_1727)?;
        object_1728.finish();
    }
    ...
    if let Some(var_1731) = &input.small_multiples_options {
        ...
        crate::json_ser::serialize_structure_crate_model_small_multiples_options(&mut object_1732, var_1731)?;
        object_1732.finish();
    }
    if let Some(var_1733) = &input.category_label_options {
        #[allow(unused_mut)]
        let mut object_1734 = object.key("CategoryLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1734, var_1733)?;
        object_1734.finish();
    }
    if let Some(var_1735) = &input.value_label_options {
        #[allow(unused_mut)]
        let mut object_1736 = object.key("ValueLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1736, var_1735)?;
        object_1736.finish();
    }
    if let Some(var_1737) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1738 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1738, var_1737)?;
        object_1738.finish();
    }
    if let Some(var_1739) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1740 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1740, var_1739)?;
        object_1740.finish();
    }
    if let Some(var_1741) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1742 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1742, var_1741)?;
        object_1742.finish();
    }
    if let Some(var_1743) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1744 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1744, var_1743)?;
        object_1744.finish();
    }
        ...
        for item_1747 in var_1745 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_contribution_analysis_default(&mut object_1748, item_1747)?;
                object_1748.finish();
            }
        }
        array_1746.finish();
...
pub fn serialize_structure_crate_model_gauge_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GaugeChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1749) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_gauge_chart_field_wells(&mut object_1750, var_1749)?;
        object_1750.finish();
    }
    if let Some(var_1751) = &input.gauge_chart_options {
        #[allow(unused_mut)]
        let mut object_1752 = object.key("GaugeChartOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_gauge_chart_options(&mut object_1752, var_1751)?;
        object_1752.finish();
    }
    if let Some(var_1753) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1754 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1754, var_1753)?;
        object_1754.finish();
    }
    if let Some(var_1755) = &input.tooltip_options {
        #[allow(unused_mut)]
        let mut object_1756 = object.key("TooltipOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1756, var_1755)?;
        object_1756.finish();
    }
    if let Some(var_1757) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1758 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1758, var_1757)?;
        object_1758.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_line_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1763) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_line_chart_field_wells(&mut object_1764, var_1763)?;
        object_1764.finish();
    }
    if let Some(var_1765) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1766 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_line_chart_sort_configuration(&mut object_1766, var_1765)?;
        object_1766.finish();
    }
        ...
        for item_1769 in var_1767 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_forecast_configuration(&mut object_1770, item_1769)?;
                object_1770.finish();
            }
        }
        array_1768.finish();
    ...
    if let Some(var_1772) = &input.small_multiples_options {
        ...
        crate::json_ser::serialize_structure_crate_model_small_multiples_options(&mut object_1773, var_1772)?;
        object_1773.finish();
    }
    if let Some(var_1774) = &input.x_axis_display_options {
        #[allow(unused_mut)]
        let mut object_1775 = object.key("XAxisDisplayOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1775, var_1774)?;
        object_1775.finish();
    }
    ...
    if let Some(var_1782) = &input.secondary_y_axis_display_options {
        ...
        crate::json_ser::serialize_structure_crate_model_line_series_axis_display_options(&mut object_1783, var_1782)?;
        object_1783.finish();
    }
    if let Some(var_1784) = &input.secondary_y_axis_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1785, var_1784)?;
        object_1785.finish();
    }
    if let Some(var_1786) = &input.default_series_settings {
        #[allow(unused_mut)]
        let mut object_1787 = object.key("DefaultSeriesSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_line_chart_default_series_settings(&mut object_1787, var_1786)?;
        object_1787.finish();
    }
        ...
        for item_1790 in var_1788 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_series_item(&mut object_1791, item_1790)?;
                object_1791.finish();
            }
        }
        array_1789.finish();
    ...
    if let Some(var_1792) = &input.legend {
        ...
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1793, var_1792)?;
        object_1793.finish();
    }
    if let Some(var_1794) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1795 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1795, var_1794)?;
        object_1795.finish();
    }
        ...
        for item_1798 in var_1796 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference_line(&mut object_1799, item_1798)?;
                object_1799.finish();
            }
        }
        array_1797.finish();
    ...
    if let Some(var_1800) = &input.tooltip {
        ...
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1801, var_1800)?;
        object_1801.finish();
    }
        ...
        for item_1804 in var_1802 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_contribution_analysis_default(&mut object_1805, item_1804)?;
                object_1805.finish();
            }
        }
        array_1803.finish();
    ...
    if let Some(var_1806) = &input.visual_palette {
        ...
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1807, var_1806)?;
        object_1807.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_heat_map_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HeatMapConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1808) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_heat_map_field_wells(&mut object_1809, var_1808)?;
        object_1809.finish();
    }
    if let Some(var_1810) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1811 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_heat_map_sort_configuration(&mut object_1811, var_1810)?;
        object_1811.finish();
    }
    if let Some(var_1812) = &input.row_label_options {
        #[allow(unused_mut)]
        let mut object_1813 = object.key("RowLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1813, var_1812)?;
        object_1813.finish();
    }
    if let Some(var_1814) = &input.column_label_options {
        #[allow(unused_mut)]
        let mut object_1815 = object.key("ColumnLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1815, var_1814)?;
        object_1815.finish();
    }
    ...
    if let Some(var_1818) = &input.legend {
        ...
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1819, var_1818)?;
        object_1819.finish();
    }
    if let Some(var_1820) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1821 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1821, var_1820)?;
        object_1821.finish();
    }
    if let Some(var_1822) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1823 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1823, var_1822)?;
        object_1823.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_tree_map_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TreeMapConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1824) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_tree_map_field_wells(&mut object_1825, var_1824)?;
        object_1825.finish();
    }
    if let Some(var_1826) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1827 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_tree_map_sort_configuration(&mut object_1827, var_1826)?;
        object_1827.finish();
    }
    ...
    if let Some(var_1830) = &input.size_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1831, var_1830)?;
        object_1831.finish();
    }
    if let Some(var_1832) = &input.color_label_options {
        #[allow(unused_mut)]
        let mut object_1833 = object.key("ColorLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1833, var_1832)?;
        object_1833.finish();
    }
    ...
    if let Some(var_1836) = &input.legend {
        ...
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1837, var_1836)?;
        object_1837.finish();
    }
    if let Some(var_1838) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1839 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1839, var_1838)?;
        object_1839.finish();
    }
    if let Some(var_1840) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1841 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1841, var_1840)?;
        object_1841.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_geospatial_map_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeospatialMapConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1842) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_geospatial_map_field_wells(&mut object_1843, var_1842)?;
        object_1843.finish();
    }
    if let Some(var_1844) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1845 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1845, var_1844)?;
        object_1845.finish();
    }
    if let Some(var_1846) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1847 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1847, var_1846)?;
        object_1847.finish();
    }
    if let Some(var_1848) = &input.window_options {
        #[allow(unused_mut)]
        let mut object_1849 = object.key("WindowOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_geospatial_window_options(&mut object_1849, var_1848)?;
        object_1849.finish();
    }
    if let Some(var_1850) = &input.map_style_options {
        #[allow(unused_mut)]
        let mut object_1851 = object.key("MapStyleOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_geospatial_map_style_options(&mut object_1851, var_1850)?;
        object_1851.finish();
    }
    if let Some(var_1852) = &input.point_style_options {
        #[allow(unused_mut)]
        let mut object_1853 = object.key("PointStyleOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_geospatial_point_style_options(&mut object_1853, var_1852)?;
        object_1853.finish();
    }
    if let Some(var_1854) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1855 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1855, var_1854)?;
        object_1855.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_filled_map_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilledMapConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1856) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_filled_map_field_wells(&mut object_1857, var_1856)?;
        object_1857.finish();
    }
    if let Some(var_1858) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1859 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_filled_map_sort_configuration(&mut object_1859, var_1858)?;
        object_1859.finish();
    }
    if let Some(var_1860) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1861 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1861, var_1860)?;
        object_1861.finish();
    }
    if let Some(var_1862) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1863 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1863, var_1862)?;
        object_1863.finish();
    }
    if let Some(var_1864) = &input.window_options {
        #[allow(unused_mut)]
        let mut object_1865 = object.key("WindowOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_geospatial_window_options(&mut object_1865, var_1864)?;
        object_1865.finish();
    }
    if let Some(var_1866) = &input.map_style_options {
        #[allow(unused_mut)]
        let mut object_1867 = object.key("MapStyleOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_geospatial_map_style_options(&mut object_1867, var_1866)?;
        object_1867.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_funnel_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunnelChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1872) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_funnel_chart_field_wells(&mut object_1873, var_1872)?;
        object_1873.finish();
    }
    if let Some(var_1874) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1875 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_funnel_chart_sort_configuration(&mut object_1875, var_1874)?;
        object_1875.finish();
    }
    if let Some(var_1876) = &input.category_label_options {
        #[allow(unused_mut)]
        let mut object_1877 = object.key("CategoryLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1877, var_1876)?;
        object_1877.finish();
    }
    if let Some(var_1878) = &input.value_label_options {
        #[allow(unused_mut)]
        let mut object_1879 = object.key("ValueLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1879, var_1878)?;
        object_1879.finish();
    }
    if let Some(var_1880) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1881 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1881, var_1880)?;
        object_1881.finish();
    }
    if let Some(var_1882) = &input.data_label_options {
        #[allow(unused_mut)]
        let mut object_1883 = object.key("DataLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_funnel_chart_data_label_options(&mut object_1883, var_1882)?;
        object_1883.finish();
    }
    if let Some(var_1884) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1885 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1885, var_1884)?;
        object_1885.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_scatter_plot_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScatterPlotConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1886) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_scatter_plot_field_wells(&mut object_1887, var_1886)?;
        object_1887.finish();
    }
    ...
    if let Some(var_1892) = &input.y_axis_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1893, var_1892)?;
        object_1893.finish();
    }
    if let Some(var_1894) = &input.y_axis_display_options {
        #[allow(unused_mut)]
        let mut object_1895 = object.key("YAxisDisplayOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1895, var_1894)?;
        object_1895.finish();
    }
    if let Some(var_1896) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1897 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1897, var_1896)?;
        object_1897.finish();
    }
    if let Some(var_1898) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1899 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1899, var_1898)?;
        object_1899.finish();
    }
    if let Some(var_1900) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1901 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1901, var_1900)?;
        object_1901.finish();
    }
    if let Some(var_1902) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1903 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1903, var_1902)?;
        object_1903.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_combo_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComboChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1904) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_combo_chart_field_wells(&mut object_1905, var_1904)?;
        object_1905.finish();
    }
    if let Some(var_1906) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1907 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_combo_chart_sort_configuration(&mut object_1907, var_1906)?;
        object_1907.finish();
    }
    ...
    if let Some(var_1917) = &input.secondary_y_axis_display_options {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1918, var_1917)?;
        object_1918.finish();
    }
    if let Some(var_1919) = &input.secondary_y_axis_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1920, var_1919)?;
        object_1920.finish();
    }
    if let Some(var_1921) = &input.color_label_options {
        #[allow(unused_mut)]
        let mut object_1922 = object.key("ColorLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1922, var_1921)?;
        object_1922.finish();
    }
    if let Some(var_1923) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1924 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1924, var_1923)?;
        object_1924.finish();
    }
    if let Some(var_1925) = &input.bar_data_labels {
        #[allow(unused_mut)]
        let mut object_1926 = object.key("BarDataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1926, var_1925)?;
        object_1926.finish();
    }
    if let Some(var_1927) = &input.line_data_labels {
        #[allow(unused_mut)]
        let mut object_1928 = object.key("LineDataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1928, var_1927)?;
        object_1928.finish();
    }
    if let Some(var_1929) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1930 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1930, var_1929)?;
        object_1930.finish();
    }
        ...
        for item_1933 in var_1931 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference_line(&mut object_1934, item_1933)?;
                object_1934.finish();
            }
        }
        array_1932.finish();
    ...
    if let Some(var_1935) = &input.visual_palette {
        ...
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1936, var_1935)?;
        object_1936.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_box_plot_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BoxPlotChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1937) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_box_plot_field_wells(&mut object_1938, var_1937)?;
        object_1938.finish();
    }
    if let Some(var_1939) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1940 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_box_plot_sort_configuration(&mut object_1940, var_1939)?;
        object_1940.finish();
    }
    if let Some(var_1941) = &input.box_plot_options {
        #[allow(unused_mut)]
        let mut object_1942 = object.key("BoxPlotOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_box_plot_options(&mut object_1942, var_1941)?;
        object_1942.finish();
    }
    ...
    if let Some(var_1947) = &input.primary_y_axis_display_options {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1948, var_1947)?;
        object_1948.finish();
    }
    if let Some(var_1949) = &input.primary_y_axis_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1950, var_1949)?;
        object_1950.finish();
    }
    if let Some(var_1951) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1952 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1952, var_1951)?;
        object_1952.finish();
    }
    if let Some(var_1953) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1954 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1954, var_1953)?;
        object_1954.finish();
    }
        ...
        for item_1957 in var_1955 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_reference_line(&mut object_1958, item_1957)?;
                object_1958.finish();
            }
        }
        array_1956.finish();
    ...
    if let Some(var_1959) = &input.visual_palette {
        ...
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1960, var_1959)?;
        object_1960.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_waterfall_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WaterfallChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1961) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_waterfall_chart_field_wells(&mut object_1962, var_1961)?;
        object_1962.finish();
    }
    if let Some(var_1963) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_1964 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_waterfall_chart_sort_configuration(&mut object_1964, var_1963)?;
        object_1964.finish();
    }
    if let Some(var_1965) = &input.waterfall_chart_options {
        #[allow(unused_mut)]
        let mut object_1966 = object.key("WaterfallChartOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_waterfall_chart_options(&mut object_1966, var_1965)?;
        object_1966.finish();
    }
    ...
    if let Some(var_1971) = &input.primary_y_axis_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1972, var_1971)?;
        object_1972.finish();
    }
    if let Some(var_1973) = &input.primary_y_axis_display_options {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1974, var_1973)?;
        object_1974.finish();
    }
    if let Some(var_1975) = &input.legend {
        #[allow(unused_mut)]
        let mut object_1976 = object.key("Legend").start_object();
        crate::json_ser::serialize_structure_crate_model_legend_options(&mut object_1976, var_1975)?;
        object_1976.finish();
    }
    if let Some(var_1977) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1978 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1978, var_1977)?;
        object_1978.finish();
    }
    if let Some(var_1979) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1980 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1980, var_1979)?;
        object_1980.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_histogram_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HistogramConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1981) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_histogram_field_wells(&mut object_1982, var_1981)?;
        object_1982.finish();
    }
    ...
    if let Some(var_1985) = &input.x_axis_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_1986, var_1985)?;
        object_1986.finish();
    }
    if let Some(var_1987) = &input.y_axis_display_options {
        #[allow(unused_mut)]
        let mut object_1988 = object.key("YAxisDisplayOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_1988, var_1987)?;
        object_1988.finish();
    }
    if let Some(var_1989) = &input.bin_options {
        #[allow(unused_mut)]
        let mut object_1990 = object.key("BinOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_histogram_bin_options(&mut object_1990, var_1989)?;
        object_1990.finish();
    }
    if let Some(var_1991) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_1992 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_1992, var_1991)?;
        object_1992.finish();
    }
    if let Some(var_1993) = &input.tooltip {
        #[allow(unused_mut)]
        let mut object_1994 = object.key("Tooltip").start_object();
        crate::json_ser::serialize_structure_crate_model_tooltip_options(&mut object_1994, var_1993)?;
        object_1994.finish();
    }
    if let Some(var_1995) = &input.visual_palette {
        #[allow(unused_mut)]
        let mut object_1996 = object.key("VisualPalette").start_object();
        crate::json_ser::serialize_structure_crate_model_visual_palette(&mut object_1996, var_1995)?;
        object_1996.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_word_cloud_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WordCloudChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1997) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_word_cloud_field_wells(&mut object_1998, var_1997)?;
        object_1998.finish();
    }
    if let Some(var_1999) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_2000 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_word_cloud_sort_configuration(&mut object_2000, var_1999)?;
        object_2000.finish();
    }
    if let Some(var_2001) = &input.category_label_options {
        #[allow(unused_mut)]
        let mut object_2002 = object.key("CategoryLabelOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_chart_axis_label_options(&mut object_2002, var_2001)?;
        object_2002.finish();
    }
    if let Some(var_2003) = &input.word_cloud_options {
        #[allow(unused_mut)]
        let mut object_2004 = object.key("WordCloudOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_word_cloud_options(&mut object_2004, var_2003)?;
        object_2004.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_insight_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InsightConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2007 in var_2005 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_computation(&mut object_2008, item_2007)?;
                object_2008.finish();
            }
        }
        array_2006.finish();
    ...
    if let Some(var_2009) = &input.custom_narrative {
        ...
        crate::json_ser::serialize_structure_crate_model_custom_narrative_options(&mut object_2010, var_2009)?;
        object_2010.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_sankey_diagram_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SankeyDiagramChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2011) = &input.field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_sankey_diagram_field_wells(&mut object_2012, var_2011)?;
        object_2012.finish();
    }
    if let Some(var_2013) = &input.sort_configuration {
        #[allow(unused_mut)]
        let mut object_2014 = object.key("SortConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_sankey_diagram_sort_configuration(&mut object_2014, var_2013)?;
        object_2014.finish();
    }
    if let Some(var_2015) = &input.data_labels {
        #[allow(unused_mut)]
        let mut object_2016 = object.key("DataLabels").start_object();
        crate::json_ser::serialize_structure_crate_model_data_label_options(&mut object_2016, var_2015)?;
        object_2016.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_grid_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GridLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2022 in var_2020 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_grid_layout_element(&mut object_2023, item_2022)?;
                object_2023.finish();
            }
        }
        array_2021.finish();
    ...
    if let Some(var_2024) = &input.canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_grid_layout_canvas_size_options(&mut object_2025, var_2024)?;
        object_2025.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_free_form_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FreeFormLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2028 in var_2026 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_free_form_layout_element(&mut object_2029, item_2028)?;
                object_2029.finish();
            }
        }
        array_2027.finish();
    ...
    if let Some(var_2030) = &input.canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_free_form_layout_canvas_size_options(&mut object_2031, var_2030)?;
        object_2031.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_section_based_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SectionBasedLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2038 in var_2036 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_body_section_configuration(&mut object_2039, item_2038)?;
                object_2039.finish();
            }
        }
        array_2037.finish();
    ...
    if let Some(var_2044) = &input.canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_section_based_layout_canvas_size_options(&mut object_2045, var_2044)?;
        object_2045.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_dynamic_default_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DynamicDefaultValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2048) = &input.group_name_column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2049, var_2048)?;
        object_2049.finish();
    }
    if let Some(var_2050) = &input.default_value_column {
        #[allow(unused_mut)]
        let mut object_2051 = object.key("DefaultValueColumn").start_object();
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2051, var_2050)?;
        object_2051.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_category_filter_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CategoryFilterConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2054) = &input.filter_list_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_filter_list_configuration(&mut object_2055, var_2054)?;
        object_2055.finish();
    }
    if let Some(var_2056) = &input.custom_filter_list_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_custom_filter_list_configuration(&mut object_2057, var_2056)?;
        object_2057.finish();
    }
    if let Some(var_2058) = &input.custom_filter_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_custom_filter_configuration(&mut object_2059, var_2058)?;
        object_2059.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numeric_range_filter_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericRangeFilterValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2060) = &input.static_value {
        object.key("StaticValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2060).into()));
    }
...
pub fn serialize_structure_crate_model_aggregation_function(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AggregationFunction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2062) = &input.numerical_aggregation_function {
        ...
        crate::json_ser::serialize_structure_crate_model_numerical_aggregation_function(&mut object_2063, var_2062)?;
        object_2063.finish();
    }
    if let Some(var_2064) = &input.categorical_aggregation_function {
        object.key("CategoricalAggregationFunction").string(var_2064.as_str());
    }
    if let Some(var_2065) = &input.date_aggregation_function {
        object.key("DateAggregationFunction").string(var_2065.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_time_range_filter_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimeRangeFilterValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2066) = &input.static_value {
        object.key("StaticValue").date_time(var_2066, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_2067) = &input.rolling_date {
        #[allow(unused_mut)]
        let mut object_2068 = object.key("RollingDate").start_object();
        crate::json_ser::serialize_structure_crate_model_rolling_date_configuration(&mut object_2068, var_2067)?;
        object_2068.finish();
    }
...
pub fn serialize_structure_crate_model_exclude_period_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExcludePeriodConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2070) = &input.amount {
        object.key("Amount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2070).into()));
    }
...
pub fn serialize_structure_crate_model_aggregation_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AggregationSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2075) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2076, var_2075)?;
        object_2076.finish();
    }
    ...
    if let Some(var_2078) = &input.aggregation_function {
        ...
        crate::json_ser::serialize_structure_crate_model_aggregation_function(&mut object_2079, var_2078)?;
        object_2079.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numeric_format_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericFormatConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2086) = &input.number_display_format_configuration {
        #[allow(unused_mut)]
        let mut object_2087 = object.key("NumberDisplayFormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_number_display_format_configuration(&mut object_2087, var_2086)?;
        object_2087.finish();
    }
    if let Some(var_2088) = &input.currency_display_format_configuration {
        #[allow(unused_mut)]
        let mut object_2089 = object.key("CurrencyDisplayFormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_currency_display_format_configuration(&mut object_2089, var_2088)?;
        object_2089.finish();
    }
    if let Some(var_2090) = &input.percentage_display_format_configuration {
        #[allow(unused_mut)]
        let mut object_2091 = object.key("PercentageDisplayFormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_percentage_display_format_configuration(&mut object_2091, var_2090)?;
        object_2091.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_default_grid_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DefaultGridLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2092) = &input.canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_grid_layout_canvas_size_options(&mut object_2093, var_2092)?;
        object_2093.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_default_free_form_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DefaultFreeFormLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2094) = &input.canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_free_form_layout_canvas_size_options(&mut object_2095, var_2094)?;
        object_2095.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_default_section_based_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DefaultSectionBasedLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2096) = &input.canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_section_based_layout_canvas_size_options(&mut object_2097, var_2096)?;
        object_2097.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_label_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LabelOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2100) = &input.font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2101, var_2100)?;
        object_2101.finish();
    }
...
pub fn serialize_structure_crate_model_cascading_control_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CascadingControlSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2106) = &input.column_to_match {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2107, var_2106)?;
        object_2107.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2113) = &input.table_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_table_aggregated_field_wells(&mut object_2114, var_2113)?;
        object_2114.finish();
    }
    if let Some(var_2115) = &input.table_unaggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_table_unaggregated_field_wells(&mut object_2116, var_2115)?;
        object_2116.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2119 in var_2117 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2120, item_2119)?;
                object_2120.finish();
            }
        }
        array_2118.finish();
    ...
    if let Some(var_2121) = &input.pagination_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_pagination_configuration(&mut object_2122, var_2121)?;
        object_2122.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2124) = &input.header_style {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2125, var_2124)?;
        object_2125.finish();
    }
    if let Some(var_2126) = &input.cell_style {
        #[allow(unused_mut)]
        let mut object_2127 = object.key("CellStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2127, var_2126)?;
        object_2127.finish();
    }
    if let Some(var_2128) = &input.row_alternate_color_options {
        ...
        crate::json_ser::serialize_structure_crate_model_row_alternate_color_options(&mut object_2129, var_2128)?;
        object_2129.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_total_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TotalOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2134) = &input.total_cell_style {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2135, var_2134)?;
        object_2135.finish();
    }
    Ok(())
}
        ...
        for item_2138 in var_2136 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_table_field_option(&mut object_2139, item_2138)?;
                object_2139.finish();
            }
        }
        array_2137.finish();
...
pub fn serialize_structure_crate_model_table_paginated_report_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TablePaginatedReportOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2143) = &input.vertical_overflow_visibility {
        object.key("VerticalOverflowVisibility").string(var_2143.as_str());
    }
    if let Some(var_2144) = &input.overflow_column_header_visibility {
        object.key("OverflowColumnHeaderVisibility").string(var_2144.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_table_inline_visualization(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableInlineVisualization) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2145) = &input.data_bars {
        #[allow(unused_mut)]
        let mut object_2146 = object.key("DataBars").start_object();
        crate::json_ser::serialize_structure_crate_model_data_bars_options(&mut object_2146, var_2145)?;
        object_2146.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_conditional_formatting_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableConditionalFormattingOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2147) = &input.cell {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_conditional_formatting(&mut object_2148, var_2147)?;
        object_2148.finish();
    }
    if let Some(var_2149) = &input.row {
        #[allow(unused_mut)]
        let mut object_2150 = object.key("Row").start_object();
        crate::json_ser::serialize_structure_crate_model_table_row_conditional_formatting(&mut object_2150, var_2149)?;
        object_2150.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_visual_custom_action_operation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VisualCustomActionOperation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2151) = &input.filter_operation {
        ...
        crate::json_ser::serialize_structure_crate_model_custom_action_filter_operation(&mut object_2152, var_2151)?;
        object_2152.finish();
    }
    if let Some(var_2153) = &input.navigation_operation {
        #[allow(unused_mut)]
        let mut object_2154 = object.key("NavigationOperation").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_action_navigation_operation(&mut object_2154, var_2153)?;
        object_2154.finish();
    }
    if let Some(var_2155) = &input.url_operation {
        #[allow(unused_mut)]
        let mut object_2156 = object.key("URLOperation").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_action_url_operation(&mut object_2156, var_2155)?;
        object_2156.finish();
    }
    if let Some(var_2157) = &input.set_parameters_operation {
        #[allow(unused_mut)]
        let mut object_2158 = object.key("SetParametersOperation").start_object();
        crate::json_ser::serialize_structure_crate_model_custom_action_set_parameters_operation(&mut object_2158, var_2157)?;
        object_2158.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pivot_table_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2159) = &input.pivot_table_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_pivot_table_aggregated_field_wells(&mut object_2160, var_2159)?;
        object_2160.finish();
    }
    Ok(())
}
        ...
        for item_2163 in var_2161 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_pivot_field_sort_options(&mut object_2164, item_2163)?;
                object_2164.finish();
            }
        }
        array_2162.finish();
...
pub fn serialize_structure_crate_model_pivot_table_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2166) = &input.single_metric_visibility {
        object.key("SingleMetricVisibility").string(var_2166.as_str());
    }
    if let Some(var_2167) = &input.column_names_visibility {
        object.key("ColumnNamesVisibility").string(var_2167.as_str());
    }
    if let Some(var_2168) = &input.toggle_buttons_visibility {
        object.key("ToggleButtonsVisibility").string(var_2168.as_str());
    }
    ...
    if let Some(var_2171) = &input.row_header_style {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2172, var_2171)?;
        object_2172.finish();
    }
    if let Some(var_2173) = &input.cell_style {
        #[allow(unused_mut)]
        let mut object_2174 = object.key("CellStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2174, var_2173)?;
        object_2174.finish();
    }
    if let Some(var_2175) = &input.row_field_names_style {
        #[allow(unused_mut)]
        let mut object_2176 = object.key("RowFieldNamesStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2176, var_2175)?;
        object_2176.finish();
    }
    if let Some(var_2177) = &input.row_alternate_color_options {
        ...
        crate::json_ser::serialize_structure_crate_model_row_alternate_color_options(&mut object_2178, var_2177)?;
        object_2178.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pivot_table_total_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableTotalOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2179) = &input.row_subtotal_options {
        ...
        crate::json_ser::serialize_structure_crate_model_subtotal_options(&mut object_2180, var_2179)?;
        object_2180.finish();
    }
    if let Some(var_2181) = &input.column_subtotal_options {
        #[allow(unused_mut)]
        let mut object_2182 = object.key("ColumnSubtotalOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_subtotal_options(&mut object_2182, var_2181)?;
        object_2182.finish();
    }
    if let Some(var_2183) = &input.row_total_options {
        #[allow(unused_mut)]
        let mut object_2184 = object.key("RowTotalOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_total_options(&mut object_2184, var_2183)?;
        object_2184.finish();
    }
    if let Some(var_2185) = &input.column_total_options {
        #[allow(unused_mut)]
        let mut object_2186 = object.key("ColumnTotalOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_total_options(&mut object_2186, var_2185)?;
        object_2186.finish();
    }
    Ok(())
}
        ...
        for item_2189 in var_2187 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_pivot_table_field_option(&mut object_2190, item_2189)?;
                object_2190.finish();
            }
        }
        array_2188.finish();
        ...
        for item_2193 in var_2191 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_pivot_table_data_path_option(&mut object_2194, item_2193)?;
                object_2194.finish();
            }
        }
        array_2192.finish();
...
pub fn serialize_structure_crate_model_pivot_table_paginated_report_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTablePaginatedReportOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2195) = &input.vertical_overflow_visibility {
        object.key("VerticalOverflowVisibility").string(var_2195.as_str());
    }
    if let Some(var_2196) = &input.overflow_column_header_visibility {
        object.key("OverflowColumnHeaderVisibility").string(var_2196.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pivot_table_conditional_formatting_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableConditionalFormattingOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2197) = &input.cell {
        ...
        crate::json_ser::serialize_structure_crate_model_pivot_table_cell_conditional_formatting(&mut object_2198, var_2197)?;
        object_2198.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_bar_chart_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BarChartFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2199) = &input.bar_chart_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_bar_chart_aggregated_field_wells(&mut object_2200, var_2199)?;
        object_2200.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_bar_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BarChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2215 in var_2213 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2216, item_2215)?;
                object_2216.finish();
            }
        }
        array_2214.finish();
    ...
    if let Some(var_2217) = &input.small_multiples_limit_configuration {
        #[allow(unused_mut)]
        let mut object_2218 = object.key("SmallMultiplesLimitConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2218, var_2217)?;
        object_2218.finish();
    }
    Ok(())
}
        ...
        for item_2222 in var_2220 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_path_color(&mut object_2223, item_2222)?;
                object_2223.finish();
            }
        }
        array_2221.finish();
...
pub fn serialize_structure_crate_model_small_multiples_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SmallMultiplesOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2224) = &input.max_visible_rows {
        object.key("MaxVisibleRows").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2224).into()));
    }
    if let Some(var_2225) = &input.max_visible_columns {
        object.key("MaxVisibleColumns").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2225).into()));
    }
    if let Some(var_2226) = &input.panel_configuration {
        #[allow(unused_mut)]
        let mut object_2227 = object.key("PanelConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_panel_configuration(&mut object_2227, var_2226)?;
        object_2227.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_display_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisDisplayOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2228) = &input.tick_label_options {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_tick_label_options(&mut object_2229, var_2228)?;
        object_2229.finish();
    }
    ...
    if let Some(var_2232) = &input.data_options {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_data_options(&mut object_2233, var_2232)?;
        object_2233.finish();
    }
    if let Some(var_2234) = &input.scrollbar_options {
        #[allow(unused_mut)]
        let mut object_2235 = object.key("ScrollbarOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_scroll_bar_options(&mut object_2235, var_2234)?;
        object_2235.finish();
    }
        ...
        for item_2241 in var_2239 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_axis_label_options(&mut object_2242, item_2241)?;
                object_2242.finish();
            }
        }
        array_2240.finish();
...
pub fn serialize_structure_crate_model_data_label_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataLabelOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2250) = &input.category_label_visibility {
        object.key("CategoryLabelVisibility").string(var_2250.as_str());
    }
    if let Some(var_2251) = &input.measure_label_visibility {
        object.key("MeasureLabelVisibility").string(var_2251.as_str());
    }
        ...
        for item_2254 in var_2252 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_label_type(&mut object_2255, item_2254)?;
                object_2255.finish();
            }
        }
        array_2253.finish();
    ...
    if let Some(var_2258) = &input.label_font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2259, var_2258)?;
        object_2259.finish();
    }
...
pub fn serialize_structure_crate_model_tooltip_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TooltipOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2264) = &input.field_based_tooltip {
        ...
        crate::json_ser::serialize_structure_crate_model_field_based_tooltip(&mut object_2265, var_2264)?;
        object_2265.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_reference_line(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceLine) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2267) = &input.data_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_reference_line_data_configuration(&mut object_2268, var_2267)?;
        object_2268.finish();
    }
    if let Some(var_2269) = &input.style_configuration {
        #[allow(unused_mut)]
        let mut object_2270 = object.key("StyleConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_reference_line_style_configuration(&mut object_2270, var_2269)?;
        object_2270.finish();
    }
    if let Some(var_2271) = &input.label_configuration {
        #[allow(unused_mut)]
        let mut object_2272 = object.key("LabelConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_reference_line_label_configuration(&mut object_2272, var_2271)?;
        object_2272.finish();
    }
    Ok(())
}
        ...
        for item_2276 in var_2274 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2277, item_2276)?;
                object_2277.finish();
            }
        }
        array_2275.finish();
        ...
        for item_2281 in var_2279 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2282, item_2281)?;
                object_2282.finish();
            }
        }
        array_2280.finish();
        ...
        for item_2285 in var_2283 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_drill_down_filter(&mut object_2286, item_2285)?;
                object_2286.finish();
            }
        }
        array_2284.finish();
        ...
        for item_2290 in var_2288 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_drill_down_filter(&mut object_2291, item_2290)?;
                object_2291.finish();
            }
        }
        array_2289.finish();
        ...
        for item_2295 in var_2293 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_2296, item_2295)?;
                object_2296.finish();
            }
        }
        array_2294.finish();
        ...
        for item_2299 in var_2297 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_drill_down_filter(&mut object_2300, item_2299)?;
                object_2300.finish();
            }
        }
        array_2298.finish();
        ...
        for item_2303 in var_2301 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2304, item_2303)?;
                object_2304.finish();
            }
        }
        array_2302.finish();
        ...
        for item_2307 in var_2305 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2308, item_2307)?;
                object_2308.finish();
            }
        }
        array_2306.finish();
        ...
        for item_2311 in var_2309 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2312, item_2311)?;
                object_2312.finish();
            }
        }
        array_2310.finish();
        ...
        for item_2315 in var_2313 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2316, item_2315)?;
                object_2316.finish();
            }
        }
        array_2314.finish();
...
pub fn serialize_structure_crate_model_kpi_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KpiOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2317) = &input.progress_bar {
        ...
        crate::json_ser::serialize_structure_crate_model_progress_bar_options(&mut object_2318, var_2317)?;
        object_2318.finish();
    }
    if let Some(var_2319) = &input.trend_arrows {
        #[allow(unused_mut)]
        let mut object_2320 = object.key("TrendArrows").start_object();
        crate::json_ser::serialize_structure_crate_model_trend_arrow_options(&mut object_2320, var_2319)?;
        object_2320.finish();
    }
    if let Some(var_2321) = &input.secondary_value {
        #[allow(unused_mut)]
        let mut object_2322 = object.key("SecondaryValue").start_object();
        crate::json_ser::serialize_structure_crate_model_secondary_value_options(&mut object_2322, var_2321)?;
        object_2322.finish();
    }
    if let Some(var_2323) = &input.comparison {
        #[allow(unused_mut)]
        let mut object_2324 = object.key("Comparison").start_object();
        crate::json_ser::serialize_structure_crate_model_comparison_configuration(&mut object_2324, var_2323)?;
        object_2324.finish();
    }
    if let Some(var_2325) = &input.primary_value_display_type {
        object.key("PrimaryValueDisplayType").string(var_2325.as_str());
    }
    if let Some(var_2326) = &input.primary_value_font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2327, var_2326)?;
        object_2327.finish();
    }
    if let Some(var_2328) = &input.secondary_value_font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2329, var_2328)?;
        object_2329.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_kpi_conditional_formatting_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KpiConditionalFormattingOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2330) = &input.primary_value {
        ...
        crate::json_ser::serialize_structure_crate_model_kpi_primary_value_conditional_formatting(&mut object_2331, var_2330)?;
        object_2331.finish();
    }
    if let Some(var_2332) = &input.progress_bar {
        #[allow(unused_mut)]
        let mut object_2333 = object.key("ProgressBar").start_object();
        crate::json_ser::serialize_structure_crate_model_kpi_progress_bar_conditional_formatting(&mut object_2333, var_2332)?;
        object_2333.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pie_chart_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PieChartFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2334) = &input.pie_chart_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_pie_chart_aggregated_field_wells(&mut object_2335, var_2334)?;
        object_2335.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pie_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PieChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2344 in var_2342 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2345, item_2344)?;
                object_2345.finish();
            }
        }
        array_2343.finish();
    ...
    if let Some(var_2346) = &input.small_multiples_limit_configuration {
        #[allow(unused_mut)]
        let mut object_2347 = object.key("SmallMultiplesLimitConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2347, var_2346)?;
        object_2347.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_donut_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DonutOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2350) = &input.donut_center_options {
        ...
        crate::json_ser::serialize_structure_crate_model_donut_center_options(&mut object_2351, var_2350)?;
        object_2351.finish();
    }
    Ok(())
}
        ...
        for item_2354 in var_2352 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2355, item_2354)?;
                object_2355.finish();
            }
        }
        array_2353.finish();
        ...
        for item_2358 in var_2356 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2359, item_2358)?;
                object_2359.finish();
            }
        }
        array_2357.finish();
...
pub fn serialize_structure_crate_model_gauge_chart_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GaugeChartOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2360) = &input.primary_value_display_type {
        object.key("PrimaryValueDisplayType").string(var_2360.as_str());
    }
    if let Some(var_2361) = &input.comparison {
        #[allow(unused_mut)]
        let mut object_2362 = object.key("Comparison").start_object();
        crate::json_ser::serialize_structure_crate_model_comparison_configuration(&mut object_2362, var_2361)?;
        object_2362.finish();
    }
    if let Some(var_2363) = &input.arc_axis {
        #[allow(unused_mut)]
        let mut object_2364 = object.key("ArcAxis").start_object();
        crate::json_ser::serialize_structure_crate_model_arc_axis_configuration(&mut object_2364, var_2363)?;
        object_2364.finish();
    }
    if let Some(var_2365) = &input.arc {
        #[allow(unused_mut)]
        let mut object_2366 = object.key("Arc").start_object();
        crate::json_ser::serialize_structure_crate_model_arc_configuration(&mut object_2366, var_2365)?;
        object_2366.finish();
    }
    if let Some(var_2367) = &input.primary_value_font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2368, var_2367)?;
        object_2368.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_gauge_chart_conditional_formatting_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GaugeChartConditionalFormattingOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2371) = &input.arc {
        ...
        crate::json_ser::serialize_structure_crate_model_gauge_chart_arc_conditional_formatting(&mut object_2372, var_2371)?;
        object_2372.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_line_chart_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineChartFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2373) = &input.line_chart_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_line_chart_aggregated_field_wells(&mut object_2374, var_2373)?;
        object_2374.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_line_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2377 in var_2375 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2378, item_2377)?;
                object_2378.finish();
            }
        }
        array_2376.finish();
    ...
    if let Some(var_2379) = &input.category_items_limit_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2380, var_2379)?;
        object_2380.finish();
    }
        ...
        for item_2385 in var_2383 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2386, item_2385)?;
                object_2386.finish();
            }
        }
        array_2384.finish();
    ...
    if let Some(var_2387) = &input.small_multiples_limit_configuration {
        #[allow(unused_mut)]
        let mut object_2388 = object.key("SmallMultiplesLimitConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2388, var_2387)?;
        object_2388.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_forecast_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ForecastConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2389) = &input.forecast_properties {
        ...
        crate::json_ser::serialize_structure_crate_model_time_based_forecast_properties(&mut object_2390, var_2389)?;
        object_2390.finish();
    }
    if let Some(var_2391) = &input.scenario {
        #[allow(unused_mut)]
        let mut object_2392 = object.key("Scenario").start_object();
        crate::json_ser::serialize_structure_crate_model_forecast_scenario(&mut object_2392, var_2391)?;
        object_2392.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_line_series_axis_display_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineSeriesAxisDisplayOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2393) = &input.axis_options {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_options(&mut object_2394, var_2393)?;
        object_2394.finish();
    }
        ...
        for item_2397 in var_2395 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_missing_data_configuration(&mut object_2398, item_2397)?;
                object_2398.finish();
            }
        }
        array_2396.finish();
...
pub fn serialize_structure_crate_model_line_chart_default_series_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineChartDefaultSeriesSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2400) = &input.line_style_settings {
        ...
        crate::json_ser::serialize_structure_crate_model_line_chart_line_style_settings(&mut object_2401, var_2400)?;
        object_2401.finish();
    }
    if let Some(var_2402) = &input.marker_style_settings {
        #[allow(unused_mut)]
        let mut object_2403 = object.key("MarkerStyleSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_line_chart_marker_style_settings(&mut object_2403, var_2402)?;
        object_2403.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_series_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SeriesItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2404) = &input.field_series_item {
        ...
        crate::json_ser::serialize_structure_crate_model_field_series_item(&mut object_2405, var_2404)?;
        object_2405.finish();
    }
    if let Some(var_2406) = &input.data_field_series_item {
        #[allow(unused_mut)]
        let mut object_2407 = object.key("DataFieldSeriesItem").start_object();
        crate::json_ser::serialize_structure_crate_model_data_field_series_item(&mut object_2407, var_2406)?;
        object_2407.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_heat_map_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HeatMapFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2408) = &input.heat_map_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_heat_map_aggregated_field_wells(&mut object_2409, var_2408)?;
        object_2409.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_heat_map_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HeatMapSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2412 in var_2410 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2413, item_2412)?;
                object_2413.finish();
            }
        }
        array_2411.finish();
        ...
        for item_2416 in var_2414 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2417, item_2416)?;
                object_2417.finish();
            }
        }
        array_2415.finish();
    ...
    if let Some(var_2418) = &input.heat_map_row_items_limit_configuration {
        #[allow(unused_mut)]
        let mut object_2419 = object.key("HeatMapRowItemsLimitConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2419, var_2418)?;
        object_2419.finish();
    }
    if let Some(var_2420) = &input.heat_map_column_items_limit_configuration {
        #[allow(unused_mut)]
        let mut object_2421 = object.key("HeatMapColumnItemsLimitConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2421, var_2420)?;
        object_2421.finish();
    }
    Ok(())
}
        ...
        for item_2424 in var_2422 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_color(&mut object_2425, item_2424)?;
                object_2425.finish();
            }
        }
        array_2423.finish();
...
pub fn serialize_structure_crate_model_tree_map_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TreeMapFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2429) = &input.tree_map_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_tree_map_aggregated_field_wells(&mut object_2430, var_2429)?;
        object_2430.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_tree_map_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TreeMapSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2433 in var_2431 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2434, item_2433)?;
                object_2434.finish();
            }
        }
        array_2432.finish();
    ...
    if let Some(var_2435) = &input.tree_map_group_items_limit_configuration {
        #[allow(unused_mut)]
        let mut object_2436 = object.key("TreeMapGroupItemsLimitConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2436, var_2435)?;
        object_2436.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_geospatial_map_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeospatialMapFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2437) = &input.geospatial_map_aggregated_field_wells {
        #[allow(unused_mut)]
        let mut object_2438 = object.key("GeospatialMapAggregatedFieldWells").start_object();
        crate::json_ser::serialize_structure_crate_model_geospatial_map_aggregated_field_wells(&mut object_2438, var_2437)?;
        object_2438.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_geospatial_window_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeospatialWindowOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2439) = &input.bounds {
        ...
        crate::json_ser::serialize_structure_crate_model_geospatial_coordinate_bounds(&mut object_2440, var_2439)?;
        object_2440.finish();
    }
...
pub fn serialize_structure_crate_model_geospatial_point_style_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeospatialPointStyleOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2444) = &input.cluster_marker_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_cluster_marker_configuration(&mut object_2445, var_2444)?;
        object_2445.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_filled_map_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilledMapFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2446) = &input.filled_map_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_filled_map_aggregated_field_wells(&mut object_2447, var_2446)?;
        object_2447.finish();
    }
    Ok(())
}
        ...
        for item_2450 in var_2448 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2451, item_2450)?;
                object_2451.finish();
            }
        }
        array_2449.finish();
...
pub fn serialize_structure_crate_model_filled_map_conditional_formatting_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilledMapConditionalFormattingOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2452) = &input.shape {
        ...
        crate::json_ser::serialize_structure_crate_model_filled_map_shape_conditional_formatting(&mut object_2453, var_2452)?;
        object_2453.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_funnel_chart_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunnelChartFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2454) = &input.funnel_chart_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_funnel_chart_aggregated_field_wells(&mut object_2455, var_2454)?;
        object_2455.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_funnel_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunnelChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2458 in var_2456 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2459, item_2458)?;
                object_2459.finish();
            }
        }
        array_2457.finish();
    ...
    if let Some(var_2460) = &input.category_items_limit {
        ...
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2461, var_2460)?;
        object_2461.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_funnel_chart_data_label_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FunnelChartDataLabelOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2463) = &input.category_label_visibility {
        object.key("CategoryLabelVisibility").string(var_2463.as_str());
    }
    if let Some(var_2464) = &input.measure_label_visibility {
        object.key("MeasureLabelVisibility").string(var_2464.as_str());
    }
    ...
    if let Some(var_2466) = &input.label_font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2467, var_2466)?;
        object_2467.finish();
    }
    ...
    if let Some(var_2469) = &input.measure_data_label_style {
        object.key("MeasureDataLabelStyle").string(var_2469.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_scatter_plot_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScatterPlotFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2470) = &input.scatter_plot_categorically_aggregated_field_wells {
        #[allow(unused_mut)]
        let mut object_2471 = object.key("ScatterPlotCategoricallyAggregatedFieldWells").start_object();
    ...
    if let Some(var_2472) = &input.scatter_plot_unaggregated_field_wells {
        #[allow(unused_mut)]
        let mut object_2473 = object.key("ScatterPlotUnaggregatedFieldWells").start_object();
        crate::json_ser::serialize_structure_crate_model_scatter_plot_unaggregated_field_wells(&mut object_2473, var_2472)?;
        object_2473.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_combo_chart_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComboChartFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2474) = &input.combo_chart_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_combo_chart_aggregated_field_wells(&mut object_2475, var_2474)?;
        object_2475.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_combo_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComboChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2484 in var_2482 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2485, item_2484)?;
                object_2485.finish();
            }
        }
        array_2483.finish();
    ...
    if let Some(var_2486) = &input.color_items_limit {
        ...
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2487, var_2486)?;
        object_2487.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_box_plot_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BoxPlotFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2488) = &input.box_plot_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_box_plot_aggregated_field_wells(&mut object_2489, var_2488)?;
        object_2489.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_box_plot_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BoxPlotSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2492 in var_2490 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2493, item_2492)?;
                object_2493.finish();
            }
        }
        array_2491.finish();
    ...
    if let Some(var_2494) = &input.pagination_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_pagination_configuration(&mut object_2495, var_2494)?;
        object_2495.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_box_plot_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BoxPlotOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2496) = &input.style_options {
        ...
        crate::json_ser::serialize_structure_crate_model_box_plot_style_options(&mut object_2497, var_2496)?;
        object_2497.finish();
    }
    ...
    if let Some(var_2499) = &input.all_data_points_visibility {
        object.key("AllDataPointsVisibility").string(var_2499.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_waterfall_chart_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WaterfallChartFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2500) = &input.waterfall_chart_aggregated_field_wells {
        #[allow(unused_mut)]
        let mut object_2501 = object.key("WaterfallChartAggregatedFieldWells").start_object();
        crate::json_ser::serialize_structure_crate_model_waterfall_chart_aggregated_field_wells(&mut object_2501, var_2500)?;
        object_2501.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_waterfall_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WaterfallChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2504 in var_2502 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2505, item_2504)?;
                object_2505.finish();
            }
        }
        array_2503.finish();
    ...
    if let Some(var_2506) = &input.breakdown_items_limit {
        ...
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2507, var_2506)?;
        object_2507.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_histogram_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HistogramFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2509) = &input.histogram_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_histogram_aggregated_field_wells(&mut object_2510, var_2509)?;
        object_2510.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_histogram_bin_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HistogramBinOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2512) = &input.bin_count {
        ...
        crate::json_ser::serialize_structure_crate_model_bin_count_options(&mut object_2513, var_2512)?;
        object_2513.finish();
    }
    if let Some(var_2514) = &input.bin_width {
        #[allow(unused_mut)]
        let mut object_2515 = object.key("BinWidth").start_object();
        crate::json_ser::serialize_structure_crate_model_bin_width_options(&mut object_2515, var_2514)?;
        object_2515.finish();
    }
    if let Some(var_2516) = &input.start_value {
        object.key("StartValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2516).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_word_cloud_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WordCloudFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2517) = &input.word_cloud_aggregated_field_wells {
        ...
        crate::json_ser::serialize_structure_crate_model_word_cloud_aggregated_field_wells(&mut object_2518, var_2517)?;
        object_2518.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_word_cloud_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WordCloudSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2519) = &input.category_items_limit {
        ...
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2520, var_2519)?;
        object_2520.finish();
    }
        ...
        for item_2523 in var_2521 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2524, item_2523)?;
                object_2524.finish();
            }
        }
        array_2522.finish();
...
pub fn serialize_structure_crate_model_word_cloud_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WordCloudOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2530) = &input.maximum_string_length {
        object.key("MaximumStringLength").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2530).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Computation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2531) = &input.top_bottom_ranked {
        ...
        crate::json_ser::serialize_structure_crate_model_top_bottom_ranked_computation(&mut object_2532, var_2531)?;
        object_2532.finish();
    }
    if let Some(var_2533) = &input.top_bottom_movers {
        #[allow(unused_mut)]
        let mut object_2534 = object.key("TopBottomMovers").start_object();
        crate::json_ser::serialize_structure_crate_model_top_bottom_movers_computation(&mut object_2534, var_2533)?;
        object_2534.finish();
    }
    if let Some(var_2535) = &input.total_aggregation {
        #[allow(unused_mut)]
        let mut object_2536 = object.key("TotalAggregation").start_object();
        crate::json_ser::serialize_structure_crate_model_total_aggregation_computation(&mut object_2536, var_2535)?;
        object_2536.finish();
    }
    if let Some(var_2537) = &input.maximum_minimum {
        #[allow(unused_mut)]
        let mut object_2538 = object.key("MaximumMinimum").start_object();
        crate::json_ser::serialize_structure_crate_model_maximum_minimum_computation(&mut object_2538, var_2537)?;
        object_2538.finish();
    }
    if let Some(var_2539) = &input.metric_comparison {
        #[allow(unused_mut)]
        let mut object_2540 = object.key("MetricComparison").start_object();
        crate::json_ser::serialize_structure_crate_model_metric_comparison_computation(&mut object_2540, var_2539)?;
        object_2540.finish();
    }
    if let Some(var_2541) = &input.period_over_period {
        #[allow(unused_mut)]
        let mut object_2542 = object.key("PeriodOverPeriod").start_object();
        crate::json_ser::serialize_structure_crate_model_period_over_period_computation(&mut object_2542, var_2541)?;
        object_2542.finish();
    }
    if let Some(var_2543) = &input.period_to_date {
        #[allow(unused_mut)]
        let mut object_2544 = object.key("PeriodToDate").start_object();
        crate::json_ser::serialize_structure_crate_model_period_to_date_computation(&mut object_2544, var_2543)?;
        object_2544.finish();
    }
    if let Some(var_2545) = &input.growth_rate {
        #[allow(unused_mut)]
        let mut object_2546 = object.key("GrowthRate").start_object();
        crate::json_ser::serialize_structure_crate_model_growth_rate_computation(&mut object_2546, var_2545)?;
        object_2546.finish();
    }
    if let Some(var_2547) = &input.unique_values {
        #[allow(unused_mut)]
        let mut object_2548 = object.key("UniqueValues").start_object();
        crate::json_ser::serialize_structure_crate_model_unique_values_computation(&mut object_2548, var_2547)?;
        object_2548.finish();
    }
    if let Some(var_2549) = &input.forecast {
        #[allow(unused_mut)]
        let mut object_2550 = object.key("Forecast").start_object();
        crate::json_ser::serialize_structure_crate_model_forecast_computation(&mut object_2550, var_2549)?;
        object_2550.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_sankey_diagram_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SankeyDiagramFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2552) = &input.sankey_diagram_aggregated_field_wells {
        #[allow(unused_mut)]
        let mut object_2553 = object.key("SankeyDiagramAggregatedFieldWells").start_object();
        crate::json_ser::serialize_structure_crate_model_sankey_diagram_aggregated_field_wells(&mut object_2553, var_2552)?;
        object_2553.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_sankey_diagram_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SankeyDiagramSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2556 in var_2554 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_field_sort_options(&mut object_2557, item_2556)?;
                object_2557.finish();
            }
        }
        array_2555.finish();
    ...
    if let Some(var_2558) = &input.source_items_limit {
        ...
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2559, var_2558)?;
        object_2559.finish();
    }
    if let Some(var_2560) = &input.destination_items_limit {
        #[allow(unused_mut)]
        let mut object_2561 = object.key("DestinationItemsLimit").start_object();
        crate::json_ser::serialize_structure_crate_model_items_limit_configuration(&mut object_2561, var_2560)?;
        object_2561.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_grid_layout_element(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GridLayoutElement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2564) = &input.column_index {
        object.key("ColumnIndex").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2564).into()));
    }
    if let Some(var_2565) = &input.column_span {
        object.key("ColumnSpan").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2565).into()));
    }
    if let Some(var_2566) = &input.row_index {
        object.key("RowIndex").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2566).into()));
    }
    if let Some(var_2567) = &input.row_span {
        object.key("RowSpan").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2567).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_grid_layout_canvas_size_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GridLayoutCanvasSizeOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2568) = &input.screen_canvas_size_options {
        ...
        crate::json_ser::serialize_structure_crate_model_grid_layout_screen_canvas_size_options(&mut object_2569, var_2568)?;
        object_2569.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_free_form_layout_element(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FreeFormLayoutElement) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_2579 in var_2577 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_sheet_element_rendering_rule(&mut object_2580, item_2579)?;
                object_2580.finish();
            }
        }
        array_2578.finish();
    ...
    if let Some(var_2581) = &input.border_style {
        ...
        crate::json_ser::serialize_structure_crate_model_free_form_layout_element_border_style(&mut object_2582, var_2581)?;
        object_2582.finish();
    }
    if let Some(var_2583) = &input.selected_border_style {
        #[allow(unused_mut)]
        let mut object_2584 = object.key("SelectedBorderStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_free_form_layout_element_border_style(&mut object_2584, var_2583)?;
        object_2584.finish();
    }
    if let Some(var_2585) = &input.background_style {
        #[allow(unused_mut)]
        let mut object_2586 = object.key("BackgroundStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_free_form_layout_element_background_style(&mut object_2586, var_2585)?;
        object_2586.finish();
    }
    if let Some(var_2587) = &input.loading_animation {
        #[allow(unused_mut)]
        let mut object_2588 = object.key("LoadingAnimation").start_object();
        crate::json_ser::serialize_structure_crate_model_loading_animation(&mut object_2588, var_2587)?;
        object_2588.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_header_footer_section_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HeaderFooterSectionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2592) = &input.layout {
        ...
        crate::json_ser::serialize_structure_crate_model_section_layout_configuration(&mut object_2593, var_2592)?;
        object_2593.finish();
    }
...
pub fn serialize_structure_crate_model_body_section_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BodySectionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2597) = &input.content {
        ...
        crate::json_ser::serialize_structure_crate_model_body_section_content(&mut object_2598, var_2597)?;
        object_2598.finish();
    }
    ...
    if let Some(var_2601) = &input.page_break_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_section_page_break_configuration(&mut object_2602, var_2601)?;
        object_2602.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numerical_aggregation_function(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericalAggregationFunction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2621) = &input.simple_numerical_aggregation {
        object.key("SimpleNumericalAggregation").string(var_2621.as_str());
    }
    if let Some(var_2622) = &input.percentile_aggregation {
        #[allow(unused_mut)]
        let mut object_2623 = object.key("PercentileAggregation").start_object();
        crate::json_ser::serialize_structure_crate_model_percentile_aggregation(&mut object_2623, var_2622)?;
        object_2623.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_number_display_format_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumberDisplayFormatConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2626) = &input.separator_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_numeric_separator_configuration(&mut object_2627, var_2626)?;
        object_2627.finish();
    }
    if let Some(var_2628) = &input.decimal_places_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_decimal_places_configuration(&mut object_2629, var_2628)?;
        object_2629.finish();
    }
    ...
    if let Some(var_2631) = &input.negative_value_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_negative_value_configuration(&mut object_2632, var_2631)?;
        object_2632.finish();
    }
    if let Some(var_2633) = &input.null_value_format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_null_value_format_configuration(&mut object_2634, var_2633)?;
        object_2634.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_currency_display_format_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CurrencyDisplayFormatConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2637) = &input.separator_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_numeric_separator_configuration(&mut object_2638, var_2637)?;
        object_2638.finish();
    }
    ...
    if let Some(var_2640) = &input.decimal_places_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_decimal_places_configuration(&mut object_2641, var_2640)?;
        object_2641.finish();
    }
    ...
    if let Some(var_2643) = &input.negative_value_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_negative_value_configuration(&mut object_2644, var_2643)?;
        object_2644.finish();
    }
    if let Some(var_2645) = &input.null_value_format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_null_value_format_configuration(&mut object_2646, var_2645)?;
        object_2646.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_percentage_display_format_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PercentageDisplayFormatConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2649) = &input.separator_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_numeric_separator_configuration(&mut object_2650, var_2649)?;
        object_2650.finish();
    }
    if let Some(var_2651) = &input.decimal_places_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_decimal_places_configuration(&mut object_2652, var_2651)?;
        object_2652.finish();
    }
    if let Some(var_2653) = &input.negative_value_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_negative_value_configuration(&mut object_2654, var_2653)?;
        object_2654.finish();
    }
    if let Some(var_2655) = &input.null_value_format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_null_value_format_configuration(&mut object_2656, var_2655)?;
        object_2656.finish();
    }
    Ok(())
}
        ...
        for item_2666 in var_2664 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2667, item_2666)?;
                object_2667.finish();
            }
        }
        array_2665.finish();
        ...
        for item_2670 in var_2668 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2671, item_2670)?;
                object_2671.finish();
            }
        }
        array_2669.finish();
        ...
        for item_2674 in var_2672 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_unaggregated_field(&mut object_2675, item_2674)?;
                object_2675.finish();
            }
        }
        array_2673.finish();
...
pub fn serialize_structure_crate_model_pagination_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PaginationConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2680) = &input.page_size {
        object.key("PageSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2680).into()));
    }
    if let Some(var_2681) = &input.page_number {
        object.key("PageNumber").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2681).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_cell_style(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableCellStyle) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2683) = &input.font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2684, var_2683)?;
        object_2684.finish();
    }
    ...
    if let Some(var_2686) = &input.horizontal_text_alignment {
        object.key("HorizontalTextAlignment").string(var_2686.as_str());
    }
    if let Some(var_2687) = &input.vertical_text_alignment {
        object.key("VerticalTextAlignment").string(var_2687.as_str());
    }
    ...
    if let Some(var_2689) = &input.height {
        object.key("Height").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2689).into()));
    }
    if let Some(var_2690) = &input.border {
        #[allow(unused_mut)]
        let mut object_2691 = object.key("Border").start_object();
        crate::json_ser::serialize_structure_crate_model_global_table_border_options(&mut object_2691, var_2690)?;
        object_2691.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2700) = &input.url_styling {
        ...
        crate::json_ser::serialize_structure_crate_model_table_field_url_configuration(&mut object_2701, var_2700)?;
        object_2701.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_data_bars_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataBarsOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_table_cell_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableCellConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2706) = &input.text_format {
        ...
        crate::json_ser::serialize_structure_crate_model_text_conditional_format(&mut object_2707, var_2706)?;
        object_2707.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_row_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableRowConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2708) = &input.background_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_2709, var_2708)?;
        object_2709.finish();
    }
    if let Some(var_2710) = &input.text_color {
        #[allow(unused_mut)]
        let mut object_2711 = object.key("TextColor").start_object();
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_2711, var_2710)?;
        object_2711.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_custom_action_navigation_operation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomActionNavigationOperation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2716) = &input.local_navigation_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_local_navigation_configuration(&mut object_2717, var_2716)?;
        object_2717.finish();
    }
    Ok(())
}
        ...
        for item_2722 in var_2720 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_set_parameter_value_configuration(&mut object_2723, item_2722)?;
                object_2723.finish();
            }
        }
        array_2721.finish();
        ...
        for item_2726 in var_2724 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2727, item_2726)?;
                object_2727.finish();
            }
        }
        array_2725.finish();
        ...
        for item_2730 in var_2728 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2731, item_2730)?;
                object_2731.finish();
            }
        }
        array_2729.finish();
        ...
        for item_2734 in var_2732 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2735, item_2734)?;
                object_2735.finish();
            }
        }
        array_2733.finish();
...
pub fn serialize_structure_crate_model_pivot_field_sort_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotFieldSortOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2737) = &input.sort_by {
        ...
        crate::json_ser::serialize_structure_crate_model_pivot_table_sort_by(&mut object_2738, var_2737)?;
        object_2738.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_subtotal_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SubtotalOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2746) = &input.total_cell_style {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2747, var_2746)?;
        object_2747.finish();
    }
    if let Some(var_2748) = &input.value_cell_style {
        #[allow(unused_mut)]
        let mut object_2749 = object.key("ValueCellStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2749, var_2748)?;
        object_2749.finish();
    }
    if let Some(var_2750) = &input.metric_header_cell_style {
        #[allow(unused_mut)]
        let mut object_2751 = object.key("MetricHeaderCellStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2751, var_2750)?;
        object_2751.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pivot_total_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTotalOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2756) = &input.total_cell_style {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2757, var_2756)?;
        object_2757.finish();
    }
    if let Some(var_2758) = &input.value_cell_style {
        #[allow(unused_mut)]
        let mut object_2759 = object.key("ValueCellStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2759, var_2758)?;
        object_2759.finish();
    }
    if let Some(var_2760) = &input.metric_header_cell_style {
        #[allow(unused_mut)]
        let mut object_2761 = object.key("MetricHeaderCellStyle").start_object();
        crate::json_ser::serialize_structure_crate_model_table_cell_style(&mut object_2761, var_2760)?;
        object_2761.finish();
    }
    Ok(())
}
        ...
        for item_2767 in var_2765 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_path_value(&mut object_2768, item_2767)?;
                object_2768.finish();
            }
        }
        array_2766.finish();
...
pub fn serialize_structure_crate_model_pivot_table_cell_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableCellConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2771) = &input.text_format {
        ...
        crate::json_ser::serialize_structure_crate_model_text_conditional_format(&mut object_2772, var_2771)?;
        object_2772.finish();
    }
    if let Some(var_2773) = &input.scope {
        #[allow(unused_mut)]
        let mut object_2774 = object.key("Scope").start_object();
        crate::json_ser::serialize_structure_crate_model_pivot_table_conditional_formatting_scope(&mut object_2774, var_2773)?;
        object_2774.finish();
    }
    Ok(())
}
        ...
        for item_2777 in var_2775 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2778, item_2777)?;
                object_2778.finish();
            }
        }
        array_2776.finish();
        ...
        for item_2781 in var_2779 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2782, item_2781)?;
                object_2782.finish();
            }
        }
        array_2780.finish();
        ...
        for item_2785 in var_2783 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2786, item_2785)?;
                object_2786.finish();
            }
        }
        array_2784.finish();
        ...
        for item_2789 in var_2787 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2790, item_2789)?;
                object_2790.finish();
            }
        }
        array_2788.finish();
...
pub fn serialize_structure_crate_model_items_limit_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ItemsLimitConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2791) = &input.items_limit {
        object.key("ItemsLimit").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2791).into()));
    }
...
pub fn serialize_structure_crate_model_data_path_color(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataPathColor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2793) = &input.element {
        ...
        crate::json_ser::serialize_structure_crate_model_data_path_value(&mut object_2794, var_2793)?;
        object_2794.finish();
    }
...
pub fn serialize_structure_crate_model_panel_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PanelConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2797) = &input.title {
        ...
        crate::json_ser::serialize_structure_crate_model_panel_title_options(&mut object_2798, var_2797)?;
        object_2798.finish();
    }
...
pub fn serialize_structure_crate_model_axis_tick_label_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisTickLabelOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2809) = &input.rotation_angle {
        object.key("RotationAngle").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2809).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_data_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisDataOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2810) = &input.numeric_axis_options {
        ...
        crate::json_ser::serialize_structure_crate_model_numeric_axis_options(&mut object_2811, var_2810)?;
        object_2811.finish();
    }
    if let Some(var_2812) = &input.date_axis_options {
        #[allow(unused_mut)]
        let mut object_2813 = object.key("DateAxisOptions").start_object();
        crate::json_ser::serialize_structure_crate_model_date_axis_options(&mut object_2813, var_2812)?;
        object_2813.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_scroll_bar_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScrollBarOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2815) = &input.visible_range {
        ...
        crate::json_ser::serialize_structure_crate_model_visible_range_options(&mut object_2816, var_2815)?;
        object_2816.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_label_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisLabelOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2817) = &input.font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2818, var_2817)?;
        object_2818.finish();
    }
    ...
    if let Some(var_2820) = &input.apply_to {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_label_reference_options(&mut object_2821, var_2820)?;
        object_2821.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_data_label_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataLabelType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2822) = &input.field_label_type {
        ...
        crate::json_ser::serialize_structure_crate_model_field_label_type(&mut object_2823, var_2822)?;
        object_2823.finish();
    }
    if let Some(var_2824) = &input.data_path_label_type {
        #[allow(unused_mut)]
        let mut object_2825 = object.key("DataPathLabelType").start_object();
        crate::json_ser::serialize_structure_crate_model_data_path_label_type(&mut object_2825, var_2824)?;
        object_2825.finish();
    }
    if let Some(var_2826) = &input.range_ends_label_type {
        #[allow(unused_mut)]
        let mut object_2827 = object.key("RangeEndsLabelType").start_object();
        crate::json_ser::serialize_structure_crate_model_range_ends_label_type(&mut object_2827, var_2826)?;
        object_2827.finish();
    }
    if let Some(var_2828) = &input.minimum_label_type {
        #[allow(unused_mut)]
        let mut object_2829 = object.key("MinimumLabelType").start_object();
        crate::json_ser::serialize_structure_crate_model_minimum_label_type(&mut object_2829, var_2828)?;
        object_2829.finish();
    }
    if let Some(var_2830) = &input.maximum_label_type {
        #[allow(unused_mut)]
        let mut object_2831 = object.key("MaximumLabelType").start_object();
        crate::json_ser::serialize_structure_crate_model_maximum_label_type(&mut object_2831, var_2830)?;
        object_2831.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_field_based_tooltip(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldBasedTooltip) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2832) = &input.aggregation_visibility {
        object.key("AggregationVisibility").string(var_2832.as_str());
    }
        ...
        for item_2836 in var_2834 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_tooltip_item(&mut object_2837, item_2836)?;
                object_2837.finish();
            }
        }
        array_2835.finish();
...
pub fn serialize_structure_crate_model_reference_line_data_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceLineDataConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2838) = &input.static_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_reference_line_static_data_configuration(&mut object_2839, var_2838)?;
        object_2839.finish();
    }
    if let Some(var_2840) = &input.dynamic_configuration {
        #[allow(unused_mut)]
        let mut object_2841 = object.key("DynamicConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_reference_line_dynamic_data_configuration(&mut object_2841, var_2840)?;
        object_2841.finish();
    }
...
pub fn serialize_structure_crate_model_reference_line_label_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceLineLabelConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2845) = &input.value_label_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_reference_line_value_label_configuration(&mut object_2846, var_2845)?;
        object_2846.finish();
    }
    if let Some(var_2847) = &input.custom_label_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_reference_line_custom_label_configuration(&mut object_2848, var_2847)?;
        object_2848.finish();
    }
    if let Some(var_2849) = &input.font_configuration {
        #[allow(unused_mut)]
        let mut object_2850 = object.key("FontConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_2850, var_2849)?;
        object_2850.finish();
    }
...
pub fn serialize_structure_crate_model_drill_down_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DrillDownFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2854) = &input.numeric_equality_filter {
        ...
        crate::json_ser::serialize_structure_crate_model_numeric_equality_drill_down_filter(&mut object_2855, var_2854)?;
        object_2855.finish();
    }
    if let Some(var_2856) = &input.category_filter {
        #[allow(unused_mut)]
        let mut object_2857 = object.key("CategoryFilter").start_object();
        crate::json_ser::serialize_structure_crate_model_category_drill_down_filter(&mut object_2857, var_2856)?;
        object_2857.finish();
    }
    if let Some(var_2858) = &input.time_range_filter {
        #[allow(unused_mut)]
        let mut object_2859 = object.key("TimeRangeFilter").start_object();
        crate::json_ser::serialize_structure_crate_model_time_range_drill_down_filter(&mut object_2859, var_2858)?;
        object_2859.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2860) = &input.numerical_measure_field {
        ...
        crate::json_ser::serialize_structure_crate_model_numerical_measure_field(&mut object_2861, var_2860)?;
        object_2861.finish();
    }
    if let Some(var_2862) = &input.categorical_measure_field {
        #[allow(unused_mut)]
        let mut object_2863 = object.key("CategoricalMeasureField").start_object();
        crate::json_ser::serialize_structure_crate_model_categorical_measure_field(&mut object_2863, var_2862)?;
        object_2863.finish();
    }
    if let Some(var_2864) = &input.date_measure_field {
        #[allow(unused_mut)]
        let mut object_2865 = object.key("DateMeasureField").start_object();
        crate::json_ser::serialize_structure_crate_model_date_measure_field(&mut object_2865, var_2864)?;
        object_2865.finish();
    }
    if let Some(var_2866) = &input.calculated_measure_field {
        #[allow(unused_mut)]
        let mut object_2867 = object.key("CalculatedMeasureField").start_object();
        crate::json_ser::serialize_structure_crate_model_calculated_measure_field(&mut object_2867, var_2866)?;
        object_2867.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_dimension_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DimensionField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2868) = &input.numerical_dimension_field {
        ...
        crate::json_ser::serialize_structure_crate_model_numerical_dimension_field(&mut object_2869, var_2868)?;
        object_2869.finish();
    }
    if let Some(var_2870) = &input.categorical_dimension_field {
        ...
        crate::json_ser::serialize_structure_crate_model_categorical_dimension_field(&mut object_2871, var_2870)?;
        object_2871.finish();
    }
    if let Some(var_2872) = &input.date_dimension_field {
        #[allow(unused_mut)]
        let mut object_2873 = object.key("DateDimensionField").start_object();
        crate::json_ser::serialize_structure_crate_model_date_dimension_field(&mut object_2873, var_2872)?;
        object_2873.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_comparison_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComparisonConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2878) = &input.comparison_format {
        ...
        crate::json_ser::serialize_structure_crate_model_comparison_format_configuration(&mut object_2879, var_2878)?;
        object_2879.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_kpi_primary_value_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KpiPrimaryValueConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2880) = &input.text_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_2881, var_2880)?;
        object_2881.finish();
    }
    if let Some(var_2882) = &input.icon {
        #[allow(unused_mut)]
        let mut object_2883 = object.key("Icon").start_object();
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_icon(&mut object_2883, var_2882)?;
        object_2883.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_kpi_progress_bar_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KpiProgressBarConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2884) = &input.foreground_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_2885, var_2884)?;
        object_2885.finish();
    }
    Ok(())
}
        ...
        for item_2888 in var_2886 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2889, item_2888)?;
                object_2889.finish();
            }
        }
        array_2887.finish();
        ...
        for item_2892 in var_2890 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2893, item_2892)?;
                object_2893.finish();
            }
        }
        array_2891.finish();
        ...
        for item_2896 in var_2894 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2897, item_2896)?;
                object_2897.finish();
            }
        }
        array_2895.finish();
...
pub fn serialize_structure_crate_model_arc_axis_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ArcAxisConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2900) = &input.range {
        ...
        crate::json_ser::serialize_structure_crate_model_arc_axis_display_range(&mut object_2901, var_2900)?;
        object_2901.finish();
    }
...
pub fn serialize_structure_crate_model_arc_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ArcConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2902) = &input.arc_angle {
        object.key("ArcAngle").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2902).into()));
    }
...
pub fn serialize_structure_crate_model_gauge_chart_primary_value_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GaugeChartPrimaryValueConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2904) = &input.text_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_2905, var_2904)?;
        object_2905.finish();
    }
    if let Some(var_2906) = &input.icon {
        #[allow(unused_mut)]
        let mut object_2907 = object.key("Icon").start_object();
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_icon(&mut object_2907, var_2906)?;
        object_2907.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_gauge_chart_arc_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GaugeChartArcConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2908) = &input.foreground_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_2909, var_2908)?;
        object_2909.finish();
    }
    Ok(())
}
        ...
        for item_2912 in var_2910 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2913, item_2912)?;
                object_2913.finish();
            }
        }
        array_2911.finish();
        ...
        for item_2916 in var_2914 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2917, item_2916)?;
                object_2917.finish();
            }
        }
        array_2915.finish();
        ...
        for item_2920 in var_2918 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2921, item_2920)?;
                object_2921.finish();
            }
        }
        array_2919.finish();
        ...
        for item_2924 in var_2922 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2925, item_2924)?;
                object_2925.finish();
            }
        }
        array_2923.finish();
...
pub fn serialize_structure_crate_model_time_based_forecast_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimeBasedForecastProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2926) = &input.periods_forward {
        object.key("PeriodsForward").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2926).into()));
    }
    if let Some(var_2927) = &input.periods_backward {
        object.key("PeriodsBackward").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2927).into()));
    }
    if let Some(var_2928) = &input.upper_boundary {
        object.key("UpperBoundary").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2928).into()));
    }
    if let Some(var_2929) = &input.lower_boundary {
        object.key("LowerBoundary").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2929).into()));
    }
    if let Some(var_2930) = &input.prediction_interval {
        object.key("PredictionInterval").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2930).into()));
    }
    if let Some(var_2931) = &input.seasonality {
        object.key("Seasonality").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_2931).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_forecast_scenario(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ForecastScenario) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2932) = &input.what_if_point_scenario {
        ...
        crate::json_ser::serialize_structure_crate_model_what_if_point_scenario(&mut object_2933, var_2932)?;
        object_2933.finish();
    }
    if let Some(var_2934) = &input.what_if_range_scenario {
        #[allow(unused_mut)]
        let mut object_2935 = object.key("WhatIfRangeScenario").start_object();
        crate::json_ser::serialize_structure_crate_model_what_if_range_scenario(&mut object_2935, var_2934)?;
        object_2935.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_field_series_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FieldSeriesItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2947) = &input.settings {
        ...
        crate::json_ser::serialize_structure_crate_model_line_chart_series_settings(&mut object_2948, var_2947)?;
        object_2948.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_data_field_series_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataFieldSeriesItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2952) = &input.settings {
        ...
        crate::json_ser::serialize_structure_crate_model_line_chart_series_settings(&mut object_2953, var_2952)?;
        object_2953.finish();
    }
    Ok(())
}
        ...
        for item_2956 in var_2954 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2957, item_2956)?;
                object_2957.finish();
            }
        }
        array_2955.finish();
        ...
        for item_2960 in var_2958 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2961, item_2960)?;
                object_2961.finish();
            }
        }
        array_2959.finish();
        ...
        for item_2964 in var_2962 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2965, item_2964)?;
                object_2965.finish();
            }
        }
        array_2963.finish();
...
pub fn serialize_structure_crate_model_data_color(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataColor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_2967) = &input.data_value {
        object.key("DataValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2967).into()));
    }
    Ok(())
}
        ...
        for item_2970 in var_2968 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2971, item_2970)?;
                object_2971.finish();
            }
        }
        array_2969.finish();
        ...
        for item_2974 in var_2972 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2975, item_2974)?;
                object_2975.finish();
            }
        }
        array_2973.finish();
        ...
        for item_2978 in var_2976 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2979, item_2978)?;
                object_2979.finish();
            }
        }
        array_2977.finish();
        ...
        for item_2982 in var_2980 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2983, item_2982)?;
                object_2983.finish();
            }
        }
        array_2981.finish();
        ...
        for item_2986 in var_2984 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_2987, item_2986)?;
                object_2987.finish();
            }
        }
        array_2985.finish();
        ...
        for item_2990 in var_2988 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_2991, item_2990)?;
                object_2991.finish();
            }
        }
        array_2989.finish();
...
pub fn serialize_structure_crate_model_geospatial_coordinate_bounds(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GeospatialCoordinateBounds) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2992) = &input.north {
        object.key("North").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2992).into()));
    }
    if let Some(var_2993) = &input.south {
        object.key("South").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2993).into()));
    }
    if let Some(var_2994) = &input.west {
        object.key("West").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2994).into()));
    }
    if let Some(var_2995) = &input.east {
        object.key("East").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_2995).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_cluster_marker_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClusterMarkerConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_2996) = &input.cluster_marker {
        ...
        crate::json_ser::serialize_structure_crate_model_cluster_marker(&mut object_2997, var_2996)?;
        object_2997.finish();
    }
    Ok(())
}
        ...
        for item_3000 in var_2998 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3001, item_3000)?;
                object_3001.finish();
            }
        }
        array_2999.finish();
        ...
        for item_3004 in var_3002 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3005, item_3004)?;
                object_3005.finish();
            }
        }
        array_3003.finish();
...
pub fn serialize_structure_crate_model_filled_map_shape_conditional_formatting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilledMapShapeConditionalFormatting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3007) = &input.format {
        ...
        crate::json_ser::serialize_structure_crate_model_shape_conditional_format(&mut object_3008, var_3007)?;
        object_3008.finish();
    }
    Ok(())
}
        ...
        for item_3011 in var_3009 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3012, item_3011)?;
                object_3012.finish();
            }
        }
        array_3010.finish();
        ...
        for item_3015 in var_3013 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3016, item_3015)?;
                object_3016.finish();
            }
        }
        array_3014.finish();
        ...
        for item_3019 in var_3017 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3020, item_3019)?;
                object_3020.finish();
            }
        }
        array_3018.finish();
        ...
        for item_3023 in var_3021 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3024, item_3023)?;
                object_3024.finish();
            }
        }
        array_3022.finish();
        ...
        for item_3027 in var_3025 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3028, item_3027)?;
                object_3028.finish();
            }
        }
        array_3026.finish();
        ...
        for item_3031 in var_3029 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3032, item_3031)?;
                object_3032.finish();
            }
        }
        array_3030.finish();
        ...
        for item_3035 in var_3033 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3036, item_3035)?;
                object_3036.finish();
            }
        }
        array_3034.finish();
        ...
        for item_3039 in var_3037 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3040, item_3039)?;
                object_3040.finish();
            }
        }
        array_3038.finish();
        ...
        for item_3043 in var_3041 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3044, item_3043)?;
                object_3044.finish();
            }
        }
        array_3042.finish();
        ...
        for item_3047 in var_3045 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3048, item_3047)?;
                object_3048.finish();
            }
        }
        array_3046.finish();
        ...
        for item_3051 in var_3049 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3052, item_3051)?;
                object_3052.finish();
            }
        }
        array_3050.finish();
        ...
        for item_3055 in var_3053 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3056, item_3055)?;
                object_3056.finish();
            }
        }
        array_3054.finish();
        ...
        for item_3059 in var_3057 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3060, item_3059)?;
                object_3060.finish();
            }
        }
        array_3058.finish();
        ...
        for item_3072 in var_3070 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3073, item_3072)?;
                object_3073.finish();
            }
        }
        array_3071.finish();
        ...
        for item_3076 in var_3074 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3077, item_3076)?;
                object_3077.finish();
            }
        }
        array_3075.finish();
        ...
        for item_3080 in var_3078 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3081, item_3080)?;
                object_3081.finish();
            }
        }
        array_3079.finish();
        ...
        for item_3084 in var_3082 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3085, item_3084)?;
                object_3085.finish();
            }
        }
        array_3083.finish();
...
pub fn serialize_structure_crate_model_bin_count_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BinCountOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3086) = &input.value {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3086).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_bin_width_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BinWidthOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3087) = &input.value {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3087).into()));
    }
    if let Some(var_3088) = &input.bin_count_limit {
        object.key("BinCountLimit").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3088).into()));
    }
    Ok(())
}
        ...
        for item_3091 in var_3089 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3092, item_3091)?;
                object_3092.finish();
            }
        }
        array_3090.finish();
        ...
        for item_3095 in var_3093 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3096, item_3095)?;
                object_3096.finish();
            }
        }
        array_3094.finish();
...
pub fn serialize_structure_crate_model_top_bottom_movers_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TopBottomMoversComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3106) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3107, var_3106)?;
        object_3107.finish();
    }
    if let Some(var_3108) = &input.category {
        #[allow(unused_mut)]
        let mut object_3109 = object.key("Category").start_object();
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3109, var_3108)?;
        object_3109.finish();
    }
...
pub fn serialize_structure_crate_model_maximum_minimum_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MaximumMinimumComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3120) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3121, var_3120)?;
        object_3121.finish();
    }
...
pub fn serialize_structure_crate_model_metric_comparison_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricComparisonComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3127) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3128, var_3127)?;
        object_3128.finish();
    }
...
pub fn serialize_structure_crate_model_period_over_period_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PeriodOverPeriodComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3135) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3136, var_3135)?;
        object_3136.finish();
    }
...
pub fn serialize_structure_crate_model_period_to_date_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PeriodToDateComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3141) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3142, var_3141)?;
        object_3142.finish();
    }
    ...
    if let Some(var_3145) = &input.period_time_granularity {
        object.key("PeriodTimeGranularity").string(var_3145.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_growth_rate_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GrowthRateComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3148) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3149, var_3148)?;
        object_3149.finish();
    }
...
pub fn serialize_structure_crate_model_unique_values_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UniqueValuesComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3154) = &input.category {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3155, var_3154)?;
        object_3155.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_forecast_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ForecastComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3158) = &input.time {
        ...
        crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3159, var_3158)?;
        object_3159.finish();
    }
    ...
    if let Some(var_3162) = &input.periods_forward {
        object.key("PeriodsForward").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3162).into()));
    }
    if let Some(var_3163) = &input.periods_backward {
        object.key("PeriodsBackward").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3163).into()));
    }
    if let Some(var_3164) = &input.upper_boundary {
        object.key("UpperBoundary").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3164).into()));
    }
    if let Some(var_3165) = &input.lower_boundary {
        object.key("LowerBoundary").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3165).into()));
    }
    if let Some(var_3166) = &input.prediction_interval {
        object.key("PredictionInterval").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3166).into()));
    }
    ...
    if let Some(var_3168) = &input.custom_seasonality_value {
        object.key("CustomSeasonalityValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3168).into()));
    }
    Ok(())
}
        ...
        for item_3171 in var_3169 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3172, item_3171)?;
                object_3172.finish();
            }
        }
        array_3170.finish();
        ...
        for item_3175 in var_3173 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension_field(&mut object_3176, item_3175)?;
                object_3176.finish();
            }
        }
        array_3174.finish();
        ...
        for item_3179 in var_3177 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_measure_field(&mut object_3180, item_3179)?;
                object_3180.finish();
            }
        }
        array_3178.finish();
...
pub fn serialize_structure_crate_model_sheet_element_rendering_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SheetElementRenderingRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3184) = &input.configuration_overrides {
        ...
        crate::json_ser::serialize_structure_crate_model_sheet_element_configuration_overrides(&mut object_3185, var_3184)?;
        object_3185.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_free_form_layout_screen_canvas_size_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FreeFormLayoutScreenCanvasSizeOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3191) = &input.optimized_view_port_width {
        object.key("OptimizedViewPortWidth").string(var_3191.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_section_layout_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SectionLayoutConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3192) = &input.free_form_layout {
        ...
        crate::json_ser::serialize_structure_crate_model_free_form_section_layout_configuration(&mut object_3193, var_3192)?;
        object_3193.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_body_section_content(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BodySectionContent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3197) = &input.layout {
        ...
        crate::json_ser::serialize_structure_crate_model_section_layout_configuration(&mut object_3198, var_3197)?;
        object_3198.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_section_page_break_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SectionPageBreakConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3199) = &input.after {
        ...
        crate::json_ser::serialize_structure_crate_model_section_after_page_break(&mut object_3200, var_3199)?;
        object_3200.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_percentile_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PercentileAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3205) = &input.percentile_value {
        object.key("PercentileValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3205).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numeric_separator_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericSeparatorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3207) = &input.thousands_separator {
        ...
        crate::json_ser::serialize_structure_crate_model_thousand_separator_options(&mut object_3208, var_3207)?;
        object_3208.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_decimal_places_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DecimalPlacesConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3209) = &input.decimal_places {
        object.key("DecimalPlaces").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3209).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_unaggregated_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UnaggregatedField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3214) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3215, var_3214)?;
        object_3215.finish();
    }
    if let Some(var_3216) = &input.format_configuration {
        #[allow(unused_mut)]
        let mut object_3217 = object.key("FormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_format_configuration(&mut object_3217, var_3216)?;
        object_3217.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_column_sort(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ColumnSort) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3220) = &input.sort_by {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3221, var_3220)?;
        object_3221.finish();
    }
    ...
    if let Some(var_3223) = &input.aggregation_function {
        ...
        crate::json_ser::serialize_structure_crate_model_aggregation_function(&mut object_3224, var_3223)?;
        object_3224.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_global_table_border_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GlobalTableBorderOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3225) = &input.uniform_border {
        ...
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3226, var_3225)?;
        object_3226.finish();
    }
    if let Some(var_3227) = &input.side_specific_border {
        #[allow(unused_mut)]
        let mut object_3228 = object.key("SideSpecificBorder").start_object();
        crate::json_ser::serialize_structure_crate_model_table_side_border_options(&mut object_3228, var_3227)?;
        object_3228.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_url_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldUrlConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3229) = &input.link_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_table_field_link_configuration(&mut object_3230, var_3229)?;
        object_3230.finish();
    }
    if let Some(var_3231) = &input.image_configuration {
        #[allow(unused_mut)]
        let mut object_3232 = object.key("ImageConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_table_field_image_configuration(&mut object_3232, var_3231)?;
        object_3232.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_text_conditional_format(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TextConditionalFormat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3233) = &input.background_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_3234, var_3233)?;
        object_3234.finish();
    }
    if let Some(var_3235) = &input.text_color {
        #[allow(unused_mut)]
        let mut object_3236 = object.key("TextColor").start_object();
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_3236, var_3235)?;
        object_3236.finish();
    }
    if let Some(var_3237) = &input.icon {
        #[allow(unused_mut)]
        let mut object_3238 = object.key("Icon").start_object();
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_icon(&mut object_3238, var_3237)?;
        object_3238.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_conditional_formatting_color(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConditionalFormattingColor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3239) = &input.solid {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_solid_color(&mut object_3240, var_3239)?;
        object_3240.finish();
    }
    if let Some(var_3241) = &input.gradient {
        #[allow(unused_mut)]
        let mut object_3242 = object.key("Gradient").start_object();
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_gradient_color(&mut object_3242, var_3241)?;
        object_3242.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_filter_operation_target_visuals_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilterOperationTargetVisualsConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3247) = &input.same_sheet_target_visual_configuration {
        #[allow(unused_mut)]
        let mut object_3248 = object.key("SameSheetTargetVisualConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_same_sheet_target_visual_configuration(&mut object_3248, var_3247)?;
        object_3248.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_set_parameter_value_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SetParameterValueConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3250) = &input.destination_parameter_name {
        object.key("DestinationParameterName").string(var_3250.as_str());
    }
    if let Some(var_3251) = &input.value {
        #[allow(unused_mut)]
        let mut object_3252 = object.key("Value").start_object();
        crate::json_ser::serialize_structure_crate_model_destination_parameter_value_configuration(&mut object_3252, var_3251)?;
        object_3252.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_pivot_table_sort_by(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PivotTableSortBy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3257) = &input.data_path {
        ...
        crate::json_ser::serialize_structure_crate_model_data_path_sort(&mut object_3258, var_3257)?;
        object_3258.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_panel_title_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PanelTitleOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3264) = &input.font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_3265, var_3264)?;
        object_3265.finish();
    }
    if let Some(var_3266) = &input.horizontal_text_alignment {
        object.key("HorizontalTextAlignment").string(var_3266.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numeric_axis_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericAxisOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3269) = &input.range {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_range(&mut object_3270, var_3269)?;
        object_3270.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_date_axis_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DateAxisOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3271) = &input.missing_date_visibility {
        object.key("MissingDateVisibility").string(var_3271.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_visible_range_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VisibleRangeOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3272) = &input.percent_range {
        ...
        crate::json_ser::serialize_structure_crate_model_percent_visible_range(&mut object_3273, var_3272)?;
        object_3273.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_label_reference_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisLabelReferenceOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3275) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3276, var_3275)?;
        object_3276.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_tooltip_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TooltipItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3285) = &input.field_tooltip_item {
        ...
        crate::json_ser::serialize_structure_crate_model_field_tooltip_item(&mut object_3286, var_3285)?;
        object_3286.finish();
    }
    if let Some(var_3287) = &input.column_tooltip_item {
        #[allow(unused_mut)]
        let mut object_3288 = object.key("ColumnTooltipItem").start_object();
        crate::json_ser::serialize_structure_crate_model_column_tooltip_item(&mut object_3288, var_3287)?;
        object_3288.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_reference_line_dynamic_data_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceLineDynamicDataConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3289) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3290, var_3289)?;
        object_3290.finish();
    }
    if let Some(var_3291) = &input.measure_aggregation_function {
        ...
        crate::json_ser::serialize_structure_crate_model_aggregation_function(&mut object_3292, var_3291)?;
        object_3292.finish();
    }
    if let Some(var_3293) = &input.calculation {
        #[allow(unused_mut)]
        let mut object_3294 = object.key("Calculation").start_object();
        crate::json_ser::serialize_structure_crate_model_numerical_aggregation_function(&mut object_3294, var_3293)?;
        object_3294.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_reference_line_value_label_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReferenceLineValueLabelConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3296) = &input.format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_numeric_format_configuration(&mut object_3297, var_3296)?;
        object_3297.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numeric_equality_drill_down_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericEqualityDrillDownFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3299) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3300, var_3299)?;
        object_3300.finish();
    }
     {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((input.value).into()));
...
pub fn serialize_structure_crate_model_category_drill_down_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CategoryDrillDownFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3301) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3302, var_3301)?;
        object_3302.finish();
    }
...
pub fn serialize_structure_crate_model_time_range_drill_down_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimeRangeDrillDownFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3306) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3307, var_3306)?;
        object_3307.finish();
    }
    if let Some(var_3308) = &input.range_minimum {
        object.key("RangeMinimum").date_time(var_3308, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_3309) = &input.range_maximum {
        object.key("RangeMaximum").date_time(var_3309, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub fn serialize_structure_crate_model_numerical_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericalMeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3312) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3313, var_3312)?;
        object_3313.finish();
    }
    if let Some(var_3314) = &input.aggregation_function {
        #[allow(unused_mut)]
        let mut object_3315 = object.key("AggregationFunction").start_object();
        crate::json_ser::serialize_structure_crate_model_numerical_aggregation_function(&mut object_3315, var_3314)?;
        object_3315.finish();
    }
    if let Some(var_3316) = &input.format_configuration {
        #[allow(unused_mut)]
        let mut object_3317 = object.key("FormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_number_format_configuration(&mut object_3317, var_3316)?;
        object_3317.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_categorical_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CategoricalMeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3319) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3320, var_3319)?;
        object_3320.finish();
    }
    ...
    if let Some(var_3322) = &input.format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_string_format_configuration(&mut object_3323, var_3322)?;
        object_3323.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_date_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DateMeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3325) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3326, var_3325)?;
        object_3326.finish();
    }
    ...
    if let Some(var_3328) = &input.format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_date_time_format_configuration(&mut object_3329, var_3328)?;
        object_3329.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_numerical_dimension_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NumericalDimensionField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3333) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3334, var_3333)?;
        object_3334.finish();
    }
    ...
    if let Some(var_3336) = &input.format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_number_format_configuration(&mut object_3337, var_3336)?;
        object_3337.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_categorical_dimension_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CategoricalDimensionField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3339) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3340, var_3339)?;
        object_3340.finish();
    }
    ...
    if let Some(var_3342) = &input.format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_string_format_configuration(&mut object_3343, var_3342)?;
        object_3343.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_date_dimension_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DateDimensionField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3345) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3346, var_3345)?;
        object_3346.finish();
    }
    ...
    if let Some(var_3349) = &input.format_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_date_time_format_configuration(&mut object_3350, var_3349)?;
        object_3350.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_comparison_format_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComparisonFormatConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3351) = &input.number_display_format_configuration {
        #[allow(unused_mut)]
        let mut object_3352 = object.key("NumberDisplayFormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_number_display_format_configuration(&mut object_3352, var_3351)?;
        object_3352.finish();
    }
    if let Some(var_3353) = &input.percentage_display_format_configuration {
        #[allow(unused_mut)]
        let mut object_3354 = object.key("PercentageDisplayFormatConfiguration").start_object();
        crate::json_ser::serialize_structure_crate_model_percentage_display_format_configuration(&mut object_3354, var_3353)?;
        object_3354.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_conditional_formatting_icon(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConditionalFormattingIcon) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3355) = &input.icon_set {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_icon_set(&mut object_3356, var_3355)?;
        object_3356.finish();
    }
...
pub fn serialize_structure_crate_model_arc_axis_display_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ArcAxisDisplayRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3359) = &input.min {
        object.key("Min").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3359).into()));
    }
    if let Some(var_3360) = &input.max {
        object.key("Max").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3360).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_what_if_point_scenario(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WhatIfPointScenario) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3361) = &input.date {
        object.key("Date").date_time(var_3361, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
     {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((input.value).into()));
    }
...
pub fn serialize_structure_crate_model_what_if_range_scenario(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WhatIfRangeScenario) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3362) = &input.start_date {
        object.key("StartDate").date_time(var_3362, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_3363) = &input.end_date {
        object.key("EndDate").date_time(var_3363, aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
     {
        object.key("Value").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((input.value).into()));
    }
...
pub fn serialize_structure_crate_model_line_chart_series_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineChartSeriesSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3364) = &input.line_style_settings {
        ...
        crate::json_ser::serialize_structure_crate_model_line_chart_line_style_settings(&mut object_3365, var_3364)?;
        object_3365.finish();
    }
    if let Some(var_3366) = &input.marker_style_settings {
        #[allow(unused_mut)]
        let mut object_3367 = object.key("MarkerStyleSettings").start_object();
        crate::json_ser::serialize_structure_crate_model_line_chart_marker_style_settings(&mut object_3367, var_3366)?;
        object_3367.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_cluster_marker(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClusterMarker) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3368) = &input.simple_cluster_marker {
        ...
        crate::json_ser::serialize_structure_crate_model_simple_cluster_marker(&mut object_3369, var_3368)?;
        object_3369.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_shape_conditional_format(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ShapeConditionalFormat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3370) = &input.background_color {
        ...
        crate::json_ser::serialize_structure_crate_model_conditional_formatting_color(&mut object_3371, var_3370)?;
        object_3371.finish();
    }
    Ok(())
}
        ...
        for item_3375 in var_3373 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_free_form_layout_element(&mut object_3376, item_3375)?;
                object_3376.finish();
            }
        }
        array_3374.finish();
...
pub fn serialize_structure_crate_model_table_border_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableBorderOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3385) = &input.thickness {
        object.key("Thickness").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3385).into()));
    }
...
pub fn serialize_structure_crate_model_table_side_border_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableSideBorderOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3387) = &input.inner_vertical {
        ...
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3388, var_3387)?;
        object_3388.finish();
    }
    if let Some(var_3389) = &input.inner_horizontal {
        #[allow(unused_mut)]
        let mut object_3390 = object.key("InnerHorizontal").start_object();
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3390, var_3389)?;
        object_3390.finish();
    }
    if let Some(var_3391) = &input.left {
        #[allow(unused_mut)]
        let mut object_3392 = object.key("Left").start_object();
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3392, var_3391)?;
        object_3392.finish();
    }
    if let Some(var_3393) = &input.right {
        #[allow(unused_mut)]
        let mut object_3394 = object.key("Right").start_object();
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3394, var_3393)?;
        object_3394.finish();
    }
    if let Some(var_3395) = &input.top {
        #[allow(unused_mut)]
        let mut object_3396 = object.key("Top").start_object();
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3396, var_3395)?;
        object_3396.finish();
    }
    if let Some(var_3397) = &input.bottom {
        #[allow(unused_mut)]
        let mut object_3398 = object.key("Bottom").start_object();
        crate::json_ser::serialize_structure_crate_model_table_border_options(&mut object_3398, var_3397)?;
        object_3398.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_link_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldLinkConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3400) = &input.content {
        ...
        crate::json_ser::serialize_structure_crate_model_table_field_link_content_configuration(&mut object_3401, var_3400)?;
        object_3401.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_image_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldImageConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3402) = &input.sizing_options {
        ...
        crate::json_ser::serialize_structure_crate_model_table_cell_image_sizing_configuration(&mut object_3403, var_3402)?;
        object_3403.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_conditional_formatting_gradient_color(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConditionalFormattingGradientColor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3407) = &input.color {
        ...
        crate::json_ser::serialize_structure_crate_model_gradient_color(&mut object_3408, var_3407)?;
        object_3408.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_destination_parameter_value_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DestinationParameterValueConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3413) = &input.custom_values_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_custom_values_configuration(&mut object_3414, var_3413)?;
        object_3414.finish();
    }
    if let Some(var_3415) = &input.select_all_value_options {
        object.key("SelectAllValueOptions").string(var_3415.as_str());
    }
        ...
        for item_3421 in var_3419 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_data_path_value(&mut object_3422, item_3421)?;
                object_3422.finish();
            }
        }
        array_3420.finish();
...
pub fn serialize_structure_crate_model_axis_scale(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisScale) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3423) = &input.linear {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_linear_scale(&mut object_3424, var_3423)?;
        object_3424.finish();
    }
    if let Some(var_3425) = &input.logarithmic {
        #[allow(unused_mut)]
        let mut object_3426 = object.key("Logarithmic").start_object();
        crate::json_ser::serialize_structure_crate_model_axis_logarithmic_scale(&mut object_3426, var_3425)?;
        object_3426.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_display_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisDisplayRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3427) = &input.min_max {
        ...
        crate::json_ser::serialize_structure_crate_model_axis_display_min_max_range(&mut object_3428, var_3427)?;
        object_3428.finish();
    }
    if let Some(var_3429) = &input.data_driven {
        #[allow(unused_mut)]
        let mut object_3430 = object.key("DataDriven").start_object();
        crate::json_ser::serialize_structure_crate_model_axis_display_data_driven_range(&mut object_3430, var_3429)?;
        object_3430.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_percent_visible_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PercentVisibleRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3431) = &input.from {
        object.key("From").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3431).into()));
    }
    if let Some(var_3432) = &input.to {
        object.key("To").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3432).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_column_tooltip_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ColumnTooltipItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3436) = &input.column {
        ...
        crate::json_ser::serialize_structure_crate_model_column_identifier(&mut object_3437, var_3436)?;
        object_3437.finish();
    }
    ...
    if let Some(var_3440) = &input.aggregation {
        ...
        crate::json_ser::serialize_structure_crate_model_aggregation_function(&mut object_3441, var_3440)?;
        object_3441.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_link_content_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldLinkContentConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3451) = &input.custom_text_content {
        ...
        crate::json_ser::serialize_structure_crate_model_table_field_custom_text_content(&mut object_3452, var_3451)?;
        object_3452.finish();
    }
    if let Some(var_3453) = &input.custom_icon_content {
        #[allow(unused_mut)]
        let mut object_3454 = object.key("CustomIconContent").start_object();
        crate::json_ser::serialize_structure_crate_model_table_field_custom_icon_content(&mut object_3454, var_3453)?;
        object_3454.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_cell_image_sizing_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableCellImageSizingConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3455) = &input.table_cell_image_scaling_configuration {
        object.key("TableCellImageScalingConfiguration").string(var_3455.as_str());
    }
    Ok(())
}
        ...
        for item_3458 in var_3456 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_gradient_stop(&mut object_3459, item_3458)?;
                object_3459.finish();
            }
        }
        array_3457.finish();
...
pub fn serialize_structure_crate_model_custom_values_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomValuesConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3461) = &input.custom_values {
        ...
        crate::json_ser::serialize_structure_crate_model_custom_parameter_values(&mut object_3462, var_3461)?;
        object_3462.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_linear_scale(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisLinearScale) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3463) = &input.step_count {
        object.key("StepCount").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_3463).into()));
    }
    if let Some(var_3464) = &input.step_size {
        object.key("StepSize").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3464).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_logarithmic_scale(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisLogarithmicScale) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3465) = &input.base {
        object.key("Base").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3465).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_axis_display_min_max_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AxisDisplayMinMaxRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_3466) = &input.minimum {
        object.key("Minimum").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3466).into()));
    }
    if let Some(var_3467) = &input.maximum {
        object.key("Maximum").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3467).into()));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_table_field_custom_text_content(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableFieldCustomTextContent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3472) = &input.font_configuration {
        ...
        crate::json_ser::serialize_structure_crate_model_font_configuration(&mut object_3473, var_3472)?;
        object_3473.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_gradient_stop(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GradientStop) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3475) = &input.data_value {
        object.key("DataValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_3475).into()));
    }
...
pub fn serialize_structure_crate_model_custom_parameter_values(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomParameterValues) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3480) = &input.integer_values {
        ...
        for item_3482 in var_3480 {
             {
                array_3481.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*item_3482).into()));
            }
        }
        array_3481.finish();
    }
    if let Some(var_3483) = &input.decimal_values {
        ...
        for item_3485 in var_3483 {
             {
                array_3484.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*item_3485).into()));
            }
        }
        array_3484.finish();
    }
    if let Some(var_3486) = &input.date_time_values {
        ...
        for item_3488 in var_3486 {
             {
                array_3487.value().date_time(item_3488, aws_smithy_types::date_time::Format::EpochSeconds)?;
            }
        }
        array_3487.finish();
    }
