...
impl CreateDataSource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("quicksight", "CreateDataSource", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/data-sources", AwsAccountId = aws_account_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl CreateDataSourceError {
    ...
    /// Returns `true` if the error kind is `CreateDataSourceError::CustomerManagedKeyUnavailableException`.
    ...
    /// Returns `true` if the error kind is `CreateDataSourceError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `CreateDataSourceError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateDataSourceError::ResourceExistsException`.
