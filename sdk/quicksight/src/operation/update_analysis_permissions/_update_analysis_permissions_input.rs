...
impl UpdateAnalysisPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_analysis_permissions::UpdateAnalysisPermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
