...
impl UpdateTopicPermissionsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTopicPermissions`](crate::operation::update_topic_permissions::UpdateTopicPermissions)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_topic_permissions::UpdateTopicPermissions::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateTopicPermissions", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTopicPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_topic_permissions::de_update_topic_permissions_http_response_with_props(status, headers, body)
        }
    }
}
