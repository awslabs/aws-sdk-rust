    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_topic_permissions::UpdateTopicPermissionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_topic_permissions::UpdateTopicPermissionsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateTopicPermissions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateTopicPermissions", "quicksight"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateTopicPermissions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateTopicPermissionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateTopicPermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_topic_permissions::UpdateTopicPermissionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_topic_permissions::ser_update_topic_permissions_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateTopicPermissionsEndpointParamsInterceptor {
...
pub type UpdateTopicPermissionsErrorKind = UpdateTopicPermissionsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateTopicPermissionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_topic_permissions::UpdateTopicPermissionsError {
...
impl UpdateTopicPermissionsError {
    ...
    /// Creates the `UpdateTopicPermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
