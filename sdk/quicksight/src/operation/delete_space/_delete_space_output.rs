...
impl DeleteSpaceOutputBuilder {
    ...
    /// - [`space_id`](crate::operation::delete_space::builders::DeleteSpaceOutputBuilder::space_id)
        ...
        ::std::result::Result::Ok(crate::operation::delete_space::DeleteSpaceOutput {
            space_id: self.space_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "space_id",
                    "space_id was not specified but it is required when building DeleteSpaceOutput",
                )
            })?,
