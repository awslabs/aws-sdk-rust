...
impl UpdateAccountSettings {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("QuickSight", "UpdateAccountSettings", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAccountSettingsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("DefaultNamespace") {
            if let ::std::option::Option::Some(value) = input.default_namespace.as_deref() {
                captured.insert("DefaultNamespace", value);
            }
        }
        if requested.should_capture("NotificationEmail") {
            if let ::std::option::Option::Some(value) = input.notification_email.as_deref() {
                captured.insert("NotificationEmail", value);
            }
        }
...
impl UpdateAccountSettingsError {
    ...
    /// Returns `true` if the error kind is `UpdateAccountSettingsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccountSettingsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccountSettingsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccountSettingsError::ResourceUnavailableException`.
