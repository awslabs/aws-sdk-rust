...
impl DescribeDataSetFluentBuilder  {
    /// Creates a new `DescribeDataSet`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_data_set::DescribeDataSet, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_data_set::DescribeDataSetError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_data_set::DescribeDataSetOutput, aws_smithy_http::result::SdkError<crate::operation::describe_data_set::DescribeDataSetError>>
                     {
