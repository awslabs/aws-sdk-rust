...
impl ListAssetBundleExportJobsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_asset_bundle_export_jobs::ListAssetBundleExportJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssetBundleExportJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_asset_bundle_export_jobs::de_list_asset_bundle_export_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
