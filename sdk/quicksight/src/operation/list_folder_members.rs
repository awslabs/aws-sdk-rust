...
impl ListFolderMembersInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_folder_members::ListFolderMembers::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListFolderMembers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_folder_members::de_list_folder_members_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_folder_members::ListFolderMembersError
{
