...
impl DescribeAccountSubscriptionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_account_subscription::DescribeAccountSubscription::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeAccountSubscriptionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_account_subscription::DescribeAccountSubscriptionError
{
