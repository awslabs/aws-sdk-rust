...
impl SearchDataSetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_data_sets::SearchDataSets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_data_sets::ser_search_data_sets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchDataSets {
    type Output =
        ::std::result::Result<crate::operation::search_data_sets::SearchDataSetsOutput, crate::operation::search_data_sets::SearchDataSetsError>;
