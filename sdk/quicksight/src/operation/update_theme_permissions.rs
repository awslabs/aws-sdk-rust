    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_theme_permissions::UpdateThemePermissionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_theme_permissions::UpdateThemePermissionsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateThemePermissionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateThemePermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_theme_permissions::UpdateThemePermissionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_theme_permissions::ser_update_theme_permissions_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateThemePermissionsEndpointParamsInterceptor {
...
pub type UpdateThemePermissionsErrorKind = UpdateThemePermissionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_theme_permissions::UpdateThemePermissionsError {
...
impl UpdateThemePermissionsError {
    ...
    /// Creates the `UpdateThemePermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
