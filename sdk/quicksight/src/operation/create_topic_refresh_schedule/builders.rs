...
impl crate::operation::create_topic_refresh_schedule::builders::CreateTopicRefreshScheduleInputBuilder {
...
impl CreateTopicRefreshScheduleFluentBuilder {
    /// Creates a new `CreateTopicRefreshScheduleFluentBuilder`.
