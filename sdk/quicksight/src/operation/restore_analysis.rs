...
impl RestoreAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`RestoreAnalysis`](crate::operation::restore_analysis::RestoreAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_analysis::RestoreAnalysis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_analysis::RestoreAnalysisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/restore/analyses/{AnalysisId}", AwsAccountId = aws_account_id, AnalysisId = analysis_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_analysis::RestoreAnalysis::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RestoreAnalysis", "quicksight"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `RestoreAnalysis`.
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreAnalysis {
                type Output = std::result::Result<crate::operation::restore_analysis::RestoreAnalysisOutput, crate::operation::restore_analysis::RestoreAnalysisError>;
