...
impl RestoreAnalysisInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::restore_analysis::RestoreAnalysis, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreAnalysis {
    type Output =
        ::std::result::Result<crate::operation::restore_analysis::RestoreAnalysisOutput, crate::operation::restore_analysis::RestoreAnalysisError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_analysis::de_restore_analysis_http_response_with_props(status, headers, body)
        }
    }
}
