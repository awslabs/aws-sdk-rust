...
impl StartDashboardSnapshotJobInput {
    /// Consumes the builder and constructs an Operation<[`StartDashboardSnapshotJob`](crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJob)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_dashboard_snapshot_job::ser_start_dashboard_snapshot_job_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJob::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("StartDashboardSnapshotJob", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDashboardSnapshotJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_dashboard_snapshot_job::de_start_dashboard_snapshot_job_http_response_with_props(status, headers, body)
        }
    }
}
