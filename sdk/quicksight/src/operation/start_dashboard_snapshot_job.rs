...
impl StartDashboardSnapshotJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJobError
{
