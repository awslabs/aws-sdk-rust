    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJobError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJobOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartDashboardSnapshotJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartDashboardSnapshotJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_dashboard_snapshot_job::StartDashboardSnapshotJobInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartDashboardSnapshotJobEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartDashboardSnapshotJobError {
