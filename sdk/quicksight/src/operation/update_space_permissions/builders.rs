...
pub use crate::operation::update_space_permissions::_update_space_permissions_input::UpdateSpacePermissionsInputBuilder;

pub use crate::operation::update_space_permissions::_update_space_permissions_output::UpdateSpacePermissionsOutputBuilder;

impl crate::operation::update_space_permissions::builders::UpdateSpacePermissionsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.update_space_permissions();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `UpdateSpacePermissions`.
///
/// <p>Updates the permissions for an Amazon QuickSight space.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct UpdateSpacePermissionsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::update_space_permissions::builders::UpdateSpacePermissionsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::update_space_permissions::UpdateSpacePermissionsOutput,
        crate::operation::update_space_permissions::UpdateSpacePermissionsError,
    > for UpdateSpacePermissionsFluentBuilder
{
    fn send(
        self,
...
impl UpdateSpacePermissionsFluentBuilder {
    /// Creates a new `UpdateSpacePermissionsFluentBuilder`.
    ...
    /// Access the UpdateSpacePermissions as a reference.
    pub fn as_input(&self) -> &crate::operation::update_space_permissions::builders::UpdateSpacePermissionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_space_permissions::UpdateSpacePermissions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_space_permissions::UpdateSpacePermissions::orchestrate(&runtime_plugins, input).await
    }
