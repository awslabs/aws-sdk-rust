...
impl DescribeDataSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_data_set::DescribeDataSetInput,
                    ) -> ::std::result::Result<crate::operation::describe_data_set::DescribeDataSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_data_set::DescribeDataSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_data_set::DescribeDataSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_data_set::DescribeDataSetOutput>().expect("correct output type"))
                    }
...
.with_interceptor(DescribeDataSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_data_set::DescribeDataSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_data_set::DescribeDataSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_data_set::DescribeDataSetError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_data_set::de_describe_data_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_data_set::de_describe_data_set_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDataSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_data_set::DescribeDataSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_data_set::DescribeDataSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AwsAccountId}/data-sets/{DataSetId}", AwsAccountId = aws_account_id, DataSetId = data_set_id).expect("formatting should succeed");
...
impl DescribeDataSetError {
    ...
    /// Returns `true` if the error kind is `DescribeDataSetError::InvalidParameterValueException`.
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_data_set::DescribeDataSetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_data_set::_describe_data_set_output::DescribeDataSetOutput;

pub use crate::operation::describe_data_set::_describe_data_set_input::DescribeDataSetInput;

mod _describe_data_set_input;

mod _describe_data_set_output;
