...
impl DescribeDataSetInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::describe_data_set::DescribeDataSet,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_data_set::DescribeDataSet::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDataSet {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_data_set::de_describe_data_set_http_error(
                status, headers, body,
            )
        } else {
