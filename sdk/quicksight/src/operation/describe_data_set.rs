...
impl DescribeDataSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_data_set::DescribeDataSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::operation::describe_data_set::DescribeDataSetInput,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataSet {
    type Output =
        ::std::result::Result<crate::operation::describe_data_set::DescribeDataSetOutput, crate::operation::describe_data_set::DescribeDataSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_set::de_describe_data_set_http_response_with_props(status, headers, body)
        }
    }
