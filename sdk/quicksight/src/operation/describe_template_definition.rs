    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_template_definition::DescribeTemplateDefinitionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_template_definition::DescribeTemplateDefinitionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTemplateDefinition {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTemplateDefinition")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeTemplateDefinitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeTemplateDefinitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_template_definition::DescribeTemplateDefinitionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeTemplateDefinitionEndpointParamsInterceptor {
...
pub type DescribeTemplateDefinitionErrorKind = DescribeTemplateDefinitionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_template_definition::DescribeTemplateDefinitionError {
...
impl DescribeTemplateDefinitionError {
    ...
    /// Creates the `DescribeTemplateDefinitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
