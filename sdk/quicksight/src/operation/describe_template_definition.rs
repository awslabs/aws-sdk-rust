...
impl DescribeTemplateDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_template_definition::DescribeTemplateDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTemplateDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_template_definition::de_describe_template_definition_http_response_with_props(status, headers, body)
        }
    }
