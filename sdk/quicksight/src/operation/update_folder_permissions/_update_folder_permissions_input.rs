...
impl UpdateFolderPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_folder_permissions::UpdateFolderPermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
