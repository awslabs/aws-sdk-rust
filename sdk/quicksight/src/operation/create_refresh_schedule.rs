    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_refresh_schedule::CreateRefreshScheduleError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_refresh_schedule::CreateRefreshScheduleOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateRefreshScheduleResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateRefreshScheduleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_refresh_schedule::CreateRefreshScheduleInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_refresh_schedule::ser_create_refresh_schedule_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateRefreshScheduleEndpointParamsInterceptor {
...
pub type CreateRefreshScheduleErrorKind = CreateRefreshScheduleError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateRefreshScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_refresh_schedule::CreateRefreshScheduleError {
...
impl CreateRefreshScheduleError {
    ...
    /// Creates the `CreateRefreshScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
