    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_data_source_permissions::DescribeDataSourcePermissionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_data_source_permissions::DescribeDataSourcePermissionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDataSourcePermissionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDataSourcePermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("data_source_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDataSourcePermissionsEndpointParamsInterceptor {
...
pub type DescribeDataSourcePermissionsErrorKind = DescribeDataSourcePermissionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_data_source_permissions::DescribeDataSourcePermissionsError {
...
impl DescribeDataSourcePermissionsError {
    ...
    /// Creates the `DescribeDataSourcePermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
