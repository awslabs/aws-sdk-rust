...
impl DescribeDataSourcePermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_data_source_permissions::DescribeDataSourcePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataSourcePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_source_permissions::de_describe_data_source_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
