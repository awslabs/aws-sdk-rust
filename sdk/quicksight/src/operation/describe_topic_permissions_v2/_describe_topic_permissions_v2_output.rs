...
pub struct DescribeTopicPermissionsV2Output {
...
impl DescribeTopicPermissionsV2Output {
    /// <p>The ID of the topic that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
...
impl ::aws_types::request_id::RequestId for DescribeTopicPermissionsV2Output {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeTopicPermissionsV2Output {
    /// Creates a new builder-style object to manufacture [`DescribeTopicPermissionsV2Output`](crate::operation::describe_topic_permissions_v2::DescribeTopicPermissionsV2Output).
    pub fn builder() -> crate::operation::describe_topic_permissions_v2::builders::DescribeTopicPermissionsV2OutputBuilder {
        crate::operation::describe_topic_permissions_v2::builders::DescribeTopicPermissionsV2OutputBuilder::default()
    }
}

/// A builder for [`DescribeTopicPermissionsV2Output`](crate::operation::describe_topic_permissions_v2::DescribeTopicPermissionsV2Output).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeTopicPermissionsV2OutputBuilder {
...
impl DescribeTopicPermissionsV2OutputBuilder {
    /// <p>The ID of the topic that you want to describe. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeTopicPermissionsV2Output`](crate::operation::describe_topic_permissions_v2::DescribeTopicPermissionsV2Output).
    pub fn build(self) -> crate::operation::describe_topic_permissions_v2::DescribeTopicPermissionsV2Output {
