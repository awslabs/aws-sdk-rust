    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAnalysisDefinition {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAnalysisDefinition")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeAnalysisDefinitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeAnalysisDefinitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeAnalysisDefinitionEndpointParamsInterceptor {
...
pub type DescribeAnalysisDefinitionErrorKind = DescribeAnalysisDefinitionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionError {
...
impl DescribeAnalysisDefinitionError {
    ...
    /// Creates the `DescribeAnalysisDefinitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
