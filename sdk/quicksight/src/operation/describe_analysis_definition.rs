...
impl DescribeAnalysisDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_analysis_definition::DescribeAnalysisDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAnalysisDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_analysis_definition::de_describe_analysis_definition_http_response_with_props(status, headers, body)
        }
    }
