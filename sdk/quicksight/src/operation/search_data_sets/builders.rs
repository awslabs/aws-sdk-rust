...
pub use crate::operation::search_data_sets::_search_data_sets_output::SearchDataSetsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::search_data_sets::SearchDataSetsOutput,
                    crate::operation::search_data_sets::SearchDataSetsError,
                > for SearchDataSetsFluentBuilder
            {
                fn send(
                    self,
...
impl SearchDataSetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_data_sets::SearchDataSetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_data_sets::SearchDataSetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::search_data_sets::SearchDataSets::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_data_sets::SearchDataSetsOutput, crate::operation::search_data_sets::SearchDataSetsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::search_data_sets::paginator::SearchDataSetsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
