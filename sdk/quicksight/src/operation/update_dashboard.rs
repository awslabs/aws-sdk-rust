...
impl UpdateDashboardInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_dashboard::UpdateDashboard, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_dashboard::UpdateDashboard::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateDashboard", "quicksight"));
...
impl UpdateDashboardError {
    ...
    /// Returns `true` if the error kind is `UpdateDashboardError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `UpdateDashboardError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `UpdateDashboardError::LimitExceededException`.
    ...
    /// Returns `true` if the error kind is `UpdateDashboardError::UnsupportedUserEditionException`.
