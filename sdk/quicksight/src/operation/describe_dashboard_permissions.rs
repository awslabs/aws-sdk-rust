...
impl DescribeDashboardPermissionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDashboardPermissions`](crate::operation::describe_dashboard_permissions::DescribeDashboardPermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_dashboard_permissions::DescribeDashboardPermissions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_dashboard_permissions::DescribeDashboardPermissions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDashboardPermissions", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDashboardPermissions {
                type Output = std::result::Result<crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsOutput, crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsError>;
