    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDashboardPermissions {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDashboardPermissions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDashboardPermissionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDashboardPermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDashboardPermissionsEndpointParamsInterceptor {
...
pub type DescribeDashboardPermissionsErrorKind = DescribeDashboardPermissionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsError {
...
impl DescribeDashboardPermissionsError {
    ...
    /// Creates the `DescribeDashboardPermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
