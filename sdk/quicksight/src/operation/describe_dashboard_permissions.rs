...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDashboardPermissions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_dashboard_permissions::de_describe_dashboard_permissions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsError
{
