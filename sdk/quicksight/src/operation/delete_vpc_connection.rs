...
impl DeleteVpcConnectionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVPCConnection`](crate::operation::delete_vpc_connection::DeleteVPCConnection)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vpc_connection::DeleteVPCConnection::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVPCConnection", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVPCConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_connection::de_delete_vpc_connection_http_response_with_props(status, headers, body)
        }
    }
}
