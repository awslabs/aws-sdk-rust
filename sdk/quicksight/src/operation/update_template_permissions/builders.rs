...
impl UpdateTemplatePermissionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_template_permissions::UpdateTemplatePermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_template_permissions::UpdateTemplatePermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_template_permissions::UpdateTemplatePermissionsOutput, crate::operation::update_template_permissions::UpdateTemplatePermissionsError, Self> {
