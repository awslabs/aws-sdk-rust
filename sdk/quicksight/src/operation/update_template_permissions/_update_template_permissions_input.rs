...
impl UpdateTemplatePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_template_permissions::UpdateTemplatePermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
