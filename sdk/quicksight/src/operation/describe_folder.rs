...
impl DescribeFolderInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_folder::DescribeFolder::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFolder {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_folder::de_describe_folder_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_folder::de_describe_folder_http_response(
                status, headers, body,
            )
        }
    }
