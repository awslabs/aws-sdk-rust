...
impl CreateTopicInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_topic::ser_create_topic_input(&self)?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_topic::CreateTopic::new(),
        )
...
/// `ParseStrictResponse` impl for `CreateTopic`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateTopic {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_topic::de_create_topic_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_topic::de_create_topic_http_response_with_props(
                status, headers, body,
            )
        }
    }
