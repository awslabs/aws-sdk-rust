...
impl CreateTopicInput {
    /// Consumes the builder and constructs an Operation<[`CreateTopic`](crate::operation::create_topic::CreateTopic)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_topic::CreateTopic, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_topic::ser_create_topic_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_topic::CreateTopic::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateTopic", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTopic {
    type Output = ::std::result::Result<crate::operation::create_topic::CreateTopicOutput, crate::operation::create_topic::CreateTopicError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_topic::de_create_topic_http_response_with_props(status, headers, body)
        }
    }
}
