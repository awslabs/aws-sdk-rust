...
impl ListIamPolicyAssignmentsForUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_iam_policy_assignments_for_user::ListIAMPolicyAssignmentsForUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIAMPolicyAssignmentsForUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_iam_policy_assignments_for_user::de_list_iam_policy_assignments_for_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
