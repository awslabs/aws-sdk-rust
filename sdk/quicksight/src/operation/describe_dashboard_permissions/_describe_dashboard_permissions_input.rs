...
impl DescribeDashboardPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_dashboard_permissions::DescribeDashboardPermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
