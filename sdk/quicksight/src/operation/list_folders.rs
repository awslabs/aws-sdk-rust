...
impl ListFoldersInput {
    /// Consumes the builder and constructs an Operation<[`ListFolders`](crate::operation::list_folders::ListFolders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_folders::ListFolders, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_folders::ListFoldersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/folders", AwsAccountId = aws_account_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_folders::ListFoldersInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_folders::ListFolders::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListFolders", "quicksight"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListFolders`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListFolders {
                type Output = std::result::Result<crate::operation::list_folders::ListFoldersOutput, crate::operation::list_folders::ListFoldersError>;
