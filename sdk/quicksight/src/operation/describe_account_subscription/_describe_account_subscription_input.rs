...
impl DescribeAccountSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_account_subscription::DescribeAccountSubscriptionInput, ::aws_smithy_types::error::operation::BuildError> {
