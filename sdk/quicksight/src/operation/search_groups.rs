...
impl SearchGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_groups::SearchGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_groups::de_search_groups_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_groups::de_search_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
