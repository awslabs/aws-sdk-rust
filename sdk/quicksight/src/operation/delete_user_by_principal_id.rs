...
impl DeleteUserByPrincipalIdInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserByPrincipalId`](crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalId, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/user-principals/{PrincipalId}", AwsAccountId = aws_account_id, Namespace = namespace, PrincipalId = principal_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalId::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteUserByPrincipalId", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUserByPrincipalId {
                type Output = std::result::Result<crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdOutput, crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_user_by_principal_id::de_delete_user_by_principal_id_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_user_by_principal_id::de_delete_user_by_principal_id_http_response(response)
                     }
                }
            }
