...
impl CreateDataSet {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("QuickSight", "CreateDataSet", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDataSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_data_set::de_create_data_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_data_set::de_create_data_set_http_response(status, headers, body, _cfg)
        };
