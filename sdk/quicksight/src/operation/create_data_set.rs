...
impl CreateDataSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateDataSet`](crate::operation::create_data_set::CreateDataSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_data_set::CreateDataSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_data_set::CreateDataSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/data-sets", AwsAccountId = aws_account_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_data_set::ser_create_data_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_set::CreateDataSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDataSet", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDataSet {
                type Output = std::result::Result<crate::operation::create_data_set::CreateDataSetOutput, crate::operation::create_data_set::CreateDataSetError>;
...
impl aws_http::request_id::RequestId for crate::operation::create_data_set::CreateDataSetError {
