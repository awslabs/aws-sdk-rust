...
impl CreateDataSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_data_set::CreateDataSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_data_set::CreateDataSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_data_set::CreateDataSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_data_set::CreateDataSetOutput>().expect("correct output type"))
                    }
...
.with_interceptor(CreateDataSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_data_set::CreateDataSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_data_set::CreateDataSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_data_set::CreateDataSetError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_data_set::de_create_data_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_data_set::de_create_data_set_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDataSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_data_set::CreateDataSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_data_set::CreateDataSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AwsAccountId}/data-sets", AwsAccountId = aws_account_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_data_set::ser_create_data_set_input(&input)?);
...
impl CreateDataSetError {
    ...
    /// Returns `true` if the error kind is `CreateDataSetError::ResourceExistsException`.
    ...
    /// Returns `true` if the error kind is `CreateDataSetError::UnsupportedUserEditionException`.
...
impl ::aws_types::request_id::RequestId for crate::operation::create_data_set::CreateDataSetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_data_set::_create_data_set_output::CreateDataSetOutput;

pub use crate::operation::create_data_set::_create_data_set_input::CreateDataSetInput;

mod _create_data_set_input;

mod _create_data_set_output;
