...
impl CreateDataSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_data_set::CreateDataSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_data_set::ser_create_data_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_data_set::de_create_data_set_http_response_with_props(status, headers, body)
        }
    }
}
