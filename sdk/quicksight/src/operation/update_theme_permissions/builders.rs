...
impl UpdateThemePermissionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_theme_permissions::UpdateThemePermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_theme_permissions::UpdateThemePermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_theme_permissions::UpdateThemePermissionsOutput, crate::operation::update_theme_permissions::UpdateThemePermissionsError, Self> {
