...
impl SearchFoldersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::search_folders::SearchFolders,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_folders::SearchFolders::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchFolders {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_folders::de_search_folders_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_folders::de_search_folders_http_response_with_props(
                status, headers, body,
            )
        }
    }
