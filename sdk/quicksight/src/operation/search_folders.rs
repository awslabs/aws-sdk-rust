...
impl SearchFoldersInput {
    /// Consumes the builder and constructs an Operation<[`SearchFolders`](crate::operation::search_folders::SearchFolders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::search_folders::SearchFolders, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_folders::SearchFoldersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/search/folders", AwsAccountId = aws_account_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_folders::ser_search_folders_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::search_folders::SearchFolders::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SearchFolders", "quicksight"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SearchFolders`.
...
impl aws_smithy_http::response::ParseStrictResponse for SearchFolders {
                type Output = std::result::Result<crate::operation::search_folders::SearchFoldersOutput, crate::operation::search_folders::SearchFoldersError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_search_folders::de_search_folders_http_error(response)
                     } else {
                        crate::protocol_serde::shape_search_folders::de_search_folders_http_response(response)
                     }
                }
            }
