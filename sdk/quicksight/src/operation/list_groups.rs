    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_groups::ListGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_groups::ListGroupsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups", AwsAccountId = aws_account_id, Namespace = namespace).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_groups::ListGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListGroups", "quicksight"));
...
impl ListGroupsError {
    ...
    /// Returns `true` if the error kind is `ListGroupsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListGroupsError::InvalidNextTokenException`.
    pub fn is_invalid_next_token_exception(&self) -> bool {
        matches!(self, Self::InvalidNextTokenException(_))
    }
    /// Returns `true` if the error kind is `ListGroupsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `ListGroupsError::PreconditionNotMetException`.
    ...
    /// Returns `true` if the error kind is `ListGroupsError::ResourceUnavailableException`.
