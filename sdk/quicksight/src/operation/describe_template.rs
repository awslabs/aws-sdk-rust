...
pub type DescribeTemplateErrorKind = DescribeTemplateError;
...
impl DescribeTemplateError {
    ...
    /// Creates the `DescribeTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
