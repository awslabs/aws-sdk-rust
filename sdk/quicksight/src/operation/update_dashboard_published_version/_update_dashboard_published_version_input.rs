...
impl UpdateDashboardPublishedVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_dashboard_published_version::UpdateDashboardPublishedVersionInput, ::aws_smithy_types::error::operation::BuildError> {
