...
impl ListIamPolicyAssignmentsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignments::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIAMPolicyAssignments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_iam_policy_assignments::de_list_iam_policy_assignments_http_response_with_props(status, headers, body)
        }
    }
}
