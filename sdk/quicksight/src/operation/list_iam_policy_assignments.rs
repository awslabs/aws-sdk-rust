...
impl ListIAMPolicyAssignments {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_iam_policy_assignments::ListIamPolicyAssignmentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignmentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignmentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_iam_policy_assignments::ListIamPolicyAssignmentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListIAMPolicyAssignments {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListIAMPolicyAssignments");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListIAMPolicyAssignmentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListIAMPolicyAssignmentsResponseDeserializer));
...
.with_interceptor(ListIAMPolicyAssignmentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignmentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignmentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignmentsError>::new());
...
#[derive(Debug)]
            struct ListIAMPolicyAssignmentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListIAMPolicyAssignmentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_iam_policy_assignments::de_list_iam_policy_assignments_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListIAMPolicyAssignmentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListIAMPolicyAssignmentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_iam_policy_assignments::ListIamPolicyAssignmentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_iam_policy_assignments::ListIamPolicyAssignmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/v2/iam-policy-assignments", AwsAccountId = aws_account_id, Namespace = namespace).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_iam_policy_assignments::ListIamPolicyAssignmentsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListIAMPolicyAssignmentsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListIamPolicyAssignmentsInput>()
                        .ok_or("failed to downcast to ListIamPolicyAssignmentsInput")?;
...
pub enum ListIAMPolicyAssignmentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListIAMPolicyAssignmentsError) for what information is available for the error.")]
...
impl ListIAMPolicyAssignmentsError {
    /// Creates the `ListIAMPolicyAssignmentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListIAMPolicyAssignmentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListIAMPolicyAssignmentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_iam_policy_assignments::ListIAMPolicyAssignmentsError {
