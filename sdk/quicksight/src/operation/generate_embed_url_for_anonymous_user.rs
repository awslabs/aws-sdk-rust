...
impl GenerateEmbedUrlForAnonymousUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateEmbedUrlForAnonymousUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::de_generate_embed_url_for_anonymous_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
