...
impl GenerateEmbedUrlForAnonymousUser {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GenerateEmbedUrlForAnonymousUser",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateEmbedUrlForAnonymousUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateEmbedUrlForAnonymousUserRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GenerateEmbedUrlForAnonymousUserResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GenerateEmbedUrlForAnonymousUser")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateEmbedUrlForAnonymousUser")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GenerateEmbedUrlForAnonymousUserTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GenerateEmbedUrlForAnonymousUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateEmbedUrlForAnonymousUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GenerateEmbedUrlForAnonymousUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateEmbedUrlForAnonymousUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::de_generate_embed_url_for_anonymous_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::de_generate_embed_url_for_anonymous_user_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateEmbedUrlForAnonymousUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserInput,
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/embed-url/anonymous-user", AwsAccountId = aws_account_id)
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::ser_generate_embed_url_for_anonymous_user_input(&input)?,
        );
