...
impl ListUsers {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("quicksight", "ListUsers", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListUsers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListUsers", "quicksight"));
...
impl ListUsersError {
    ...
    /// Returns `true` if the error kind is `ListUsersError::InternalFailureException`.
    ...
    /// Returns `true` if the error kind is `ListUsersError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `ListUsersError::PreconditionNotMetException`.
    ...
    /// Returns `true` if the error kind is `ListUsersError::ResourceUnavailableException`.
