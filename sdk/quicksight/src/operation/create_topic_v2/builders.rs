...
pub use crate::operation::create_topic_v2::_create_topic_v2_input::CreateTopicV2InputBuilder;

pub use crate::operation::create_topic_v2::_create_topic_v2_output::CreateTopicV2OutputBuilder;

impl crate::operation::create_topic_v2::builders::CreateTopicV2InputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.create_topic_v2();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `CreateTopicV2`.
///
/// <p>Creates a new Q topic.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct CreateTopicV2FluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::create_topic_v2::builders::CreateTopicV2InputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_topic_v2::CreateTopicV2Output,
        crate::operation::create_topic_v2::CreateTopicV2Error,
    > for CreateTopicV2FluentBuilder
{
    fn send(
        self,
...
impl CreateTopicV2FluentBuilder {
    /// Creates a new `CreateTopicV2FluentBuilder`.
    ...
    /// Access the CreateTopicV2 as a reference.
    pub fn as_input(&self) -> &crate::operation::create_topic_v2::builders::CreateTopicV2InputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_topic_v2::CreateTopicV2::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_topic_v2::CreateTopicV2::orchestrate(&runtime_plugins, input).await
    }
