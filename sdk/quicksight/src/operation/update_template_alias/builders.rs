...
impl UpdateTemplateAliasFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_template_alias::UpdateTemplateAliasOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_template_alias::UpdateTemplateAliasError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_template_alias::UpdateTemplateAliasOutput, crate::operation::update_template_alias::UpdateTemplateAliasError, Self> {
