...
impl ListDashboards {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("quicksight", "ListDashboards", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDashboards {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListDashboards", "quicksight"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/dashboards", AwsAccountId = aws_account_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_dashboards::ListDashboardsInput,
...
impl ListDashboardsError {
    ...
    /// Returns `true` if the error kind is `ListDashboardsError::InvalidNextTokenException`.
    ...
    /// Returns `true` if the error kind is `ListDashboardsError::UnsupportedUserEditionException`.
