...
impl GenerateEmbedUrlForAnonymousUserInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
