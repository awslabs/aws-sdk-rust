...
impl CreateDashboardInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_dashboard::CreateDashboard, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_dashboard::CreateDashboardInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/dashboards/{DashboardId}", AwsAccountId = aws_account_id, DashboardId = dashboard_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_dashboard::CreateDashboard::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDashboard", "quicksight"));
...
impl CreateDashboardError {
    ...
    /// Returns `true` if the error kind is `CreateDashboardError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `CreateDashboardError::InvalidParameterValueException`.
    ...
    /// Returns `true` if the error kind is `CreateDashboardError::ResourceExistsException`.
    ...
    /// Returns `true` if the error kind is `CreateDashboardError::UnsupportedUserEditionException`.
