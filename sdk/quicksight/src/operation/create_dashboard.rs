...
impl CreateDashboard {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("QuickSight", "CreateDashboard", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDashboardTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("VersionDescription") {
            if let ::std::option::Option::Some(value) = input.version_description.as_deref() {
                captured.insert("VersionDescription", value);
            }
        }
