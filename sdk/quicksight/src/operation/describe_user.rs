...
impl DescribeUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_user::DescribeUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_user::DescribeUser::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeUser", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_user::de_describe_user_http_response_with_props(status, headers, body)
        }
    }
}
