...
impl DeleteUserByPrincipalIdFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdOutput, crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdError, Self> {
