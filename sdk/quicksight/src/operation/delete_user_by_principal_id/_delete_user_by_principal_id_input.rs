...
impl DeleteUserByPrincipalIdInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_user_by_principal_id::DeleteUserByPrincipalIdInput, ::aws_smithy_types::error::operation::BuildError> {
