...
impl DeleteDataSetInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::delete_data_set::DeleteDataSet,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_data_set::DeleteDataSet::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDataSet {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_data_set::de_delete_data_set_http_error(
                status, headers, body,
            )
        } else {
