...
impl DeleteDataSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDataSet`](crate::operation::delete_data_set::DeleteDataSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_data_set::DeleteDataSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_data_set::DeleteDataSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_data_set::DeleteDataSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDataSet", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDataSet {
                type Output = std::result::Result<crate::operation::delete_data_set::DeleteDataSetOutput, crate::operation::delete_data_set::DeleteDataSetError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_data_set::DeleteDataSetError {
