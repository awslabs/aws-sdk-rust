...
impl DeleteDataSet {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_data_set::DeleteDataSetInput,
                    ) -> ::std::result::Result<crate::operation::delete_data_set::DeleteDataSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_data_set::DeleteDataSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_data_set::DeleteDataSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_data_set::DeleteDataSetOutput>().expect("correct output type"))
                    }
...
.with_interceptor(DeleteDataSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_data_set::DeleteDataSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_data_set::DeleteDataSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_data_set::DeleteDataSetError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_data_set::de_delete_data_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_data_set::de_delete_data_set_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDataSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_data_set::DeleteDataSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_data_set::DeleteDataSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl DeleteDataSetError {
    ...
    /// Returns `true` if the error kind is `DeleteDataSetError::InvalidParameterValueException`.
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_data_set::DeleteDataSetError {
