...
/// Orchestration and serialization glue logic for `UpdateIAMPolicyAssignment`.
...
impl UpdateIAMPolicyAssignment {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateIAMPolicyAssignment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateIAMPolicyAssignment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateIAMPolicyAssignmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateIAMPolicyAssignmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateIAMPolicyAssignment")
...
.with_interceptor(UpdateIAMPolicyAssignmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError>::new());
...
#[derive(Debug)]
            struct UpdateIAMPolicyAssignmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateIAMPolicyAssignmentResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateIAMPolicyAssignmentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateIAMPolicyAssignmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/iam-policy-assignments/{AssignmentName}", AwsAccountId = aws_account_id, Namespace = namespace, AssignmentName = assignment_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_iam_policy_assignment::ser_update_iam_policy_assignment_input(&input)?);
...
#[derive(Debug)]
            struct UpdateIAMPolicyAssignmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateIAMPolicyAssignmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateIAMPolicyAssignmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateIamPolicyAssignmentInput>()
                        .ok_or("failed to downcast to UpdateIamPolicyAssignmentInput")?;
...
/// Error type for the `UpdateIAMPolicyAssignmentError` operation.
#[non_exhaustive]
...
pub enum UpdateIAMPolicyAssignmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateIAMPolicyAssignmentError) for what information is available for the error.")]
...
impl UpdateIAMPolicyAssignmentError {
    /// Creates the `UpdateIAMPolicyAssignmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateIAMPolicyAssignmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::ConcurrentUpdatingException`.
    pub fn is_concurrent_updating_exception(&self) -> bool {
        matches!(self, Self::ConcurrentUpdatingException(_))
    }
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateIAMPolicyAssignmentError::ThrottlingException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateIAMPolicyAssignmentError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateIAMPolicyAssignmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError {
...
mod _update_iam_policy_assignment_output;
