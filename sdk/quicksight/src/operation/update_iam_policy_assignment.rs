    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateIAMPolicyAssignment {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateIAMPolicyAssignment", "quicksight"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateIAMPolicyAssignment")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateIAMPolicyAssignmentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateIAMPolicyAssignmentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateIAMPolicyAssignmentEndpointParamsInterceptor {
...
pub type UpdateIAMPolicyAssignmentErrorKind = UpdateIAMPolicyAssignmentError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError {
...
impl UpdateIAMPolicyAssignmentError {
    ...
    /// Creates the `UpdateIAMPolicyAssignmentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
