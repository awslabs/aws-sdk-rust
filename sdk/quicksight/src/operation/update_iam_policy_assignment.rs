...
impl UpdateIamPolicyAssignmentInput {
    /// Consumes the builder and constructs an Operation<[`UpdateIAMPolicyAssignment`](crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_iam_policy_assignment::ser_update_iam_policy_assignment_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateIAMPolicyAssignment", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateIAMPolicyAssignment {
                type Output = std::result::Result<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentOutput, crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError>;
