...
impl CreateAnalysisInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_analysis::CreateAnalysis, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_analysis::ser_create_analysis_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_analysis::de_create_analysis_http_response_with_props(status, headers, body)
        }
    }
}
