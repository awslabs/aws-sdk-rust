...
impl ListVpcConnectionsInput {
    /// Consumes the builder and constructs an Operation<[`ListVPCConnections`](crate::operation::list_vpc_connections::ListVPCConnections)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_vpc_connections::ListVPCConnections::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVPCConnections", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVPCConnections {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_vpc_connections::de_list_vpc_connections_http_response_with_props(status, headers, body)
        }
    }
}
