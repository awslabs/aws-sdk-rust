...
impl CreateFolderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_folder::CreateFolder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFolder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_folder::de_create_folder_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_folder::de_create_folder_http_response_with_props(
                status, headers, body,
            )
        }
    }
