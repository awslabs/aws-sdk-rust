...
impl UpdateAnalysisInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_analysis::UpdateAnalysis, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_analysis::ser_update_analysis_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAnalysis {
    type Output =
        ::std::result::Result<crate::operation::update_analysis::UpdateAnalysisOutput, crate::operation::update_analysis::UpdateAnalysisError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_analysis::de_update_analysis_http_response_with_props(status, headers, body)
        }
    }
}
