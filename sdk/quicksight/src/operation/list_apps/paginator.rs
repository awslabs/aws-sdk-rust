...
impl ListAppsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `app_summary_list`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_apps::paginator::ListAppsPaginatorItems {
        crate::operation::list_apps::paginator::ListAppsPaginatorItems(self)
    }
...
impl ListAppsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_apps_output_output_app_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
