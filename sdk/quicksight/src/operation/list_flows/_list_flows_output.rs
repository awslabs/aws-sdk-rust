...
pub struct ListFlowsOutput {
    ...
    pub flow_summary_list: ::std::option::Option<::std::vec::Vec<crate::types::FlowSummary>>,
...
impl ListFlowsOutput {
    /// <p>A structure that contains all of the flows in your Amazon Web Services account. This structure provides basic information about the flows.</p>
    ///
    /// If no value was sent for this field, a default will be set. If you want to determine if no value was sent, use `.flow_summary_list.is_none()`.
    pub fn flow_summary_list(&self) -> &[crate::types::FlowSummary] {
        self.flow_summary_list.as_deref().unwrap_or_default()
    }
    /// <p>The token for the next set of results, or null if there are no more results.</p>
...
impl ListFlowsOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::list_flows::ListFlowsOutput {
        crate::operation::list_flows::ListFlowsOutput {
            flow_summary_list: self.flow_summary_list,
