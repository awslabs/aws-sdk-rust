...
impl UpdateIAMPolicyAssignmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentOutput, crate::operation::update_iam_policy_assignment::UpdateIAMPolicyAssignmentError, Self> {
