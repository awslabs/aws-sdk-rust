...
impl SearchAnalysesInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::search_analyses::SearchAnalyses,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_analyses::SearchAnalyses::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for SearchAnalyses {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_analyses::de_search_analyses_http_error(
                status, headers, body,
            )
        } else {
