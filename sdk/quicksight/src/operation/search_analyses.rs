...
impl SearchAnalysesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_analyses::SearchAnalyses, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_analyses::ser_search_analyses_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchAnalyses {
    type Output =
        ::std::result::Result<crate::operation::search_analyses::SearchAnalysesOutput, crate::operation::search_analyses::SearchAnalysesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_analyses::de_search_analyses_http_response_with_props(status, headers, body)
        }
    }
}
