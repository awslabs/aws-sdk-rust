...
impl DeleteTemplateAlias {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_template_alias::DeleteTemplateAliasInput,
                    ) -> ::std::result::Result<crate::operation::delete_template_alias::DeleteTemplateAliasOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_template_alias::DeleteTemplateAliasError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_template_alias::DeleteTemplateAliasError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_template_alias::DeleteTemplateAliasOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTemplateAlias {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteTemplateAlias");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteTemplateAliasRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteTemplateAliasResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTemplateAlias")
...
.with_interceptor(DeleteTemplateAliasEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_template_alias::DeleteTemplateAliasError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_template_alias::DeleteTemplateAliasError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_template_alias::DeleteTemplateAliasError>::new());
...
#[derive(Debug)]
            struct DeleteTemplateAliasResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTemplateAliasResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_template_alias::de_delete_template_alias_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_template_alias::de_delete_template_alias_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteTemplateAliasRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTemplateAliasRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_template_alias::DeleteTemplateAliasInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_template_alias::DeleteTemplateAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteTemplateAliasEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTemplateAliasEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteTemplateAliasEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteTemplateAliasInput>()
                        .ok_or("failed to downcast to DeleteTemplateAliasInput")?;
...
/// Error type for the `DeleteTemplateAliasError` operation.
#[non_exhaustive]
...
pub enum DeleteTemplateAliasError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteTemplateAliasError) for what information is available for the error.")]
...
impl DeleteTemplateAliasError {
    /// Creates the `DeleteTemplateAliasError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteTemplateAliasError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteTemplateAliasError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteTemplateAliasError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteTemplateAliasError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteTemplateAliasError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `DeleteTemplateAliasError::UnsupportedUserEditionException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteTemplateAliasError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteTemplateAliasError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_template_alias::DeleteTemplateAliasError {
...
mod _delete_template_alias_output;
