...
impl CreateNamespaceInput {
    /// Consumes the builder and constructs an Operation<[`CreateNamespace`](crate::operation::create_namespace::CreateNamespace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_namespace::CreateNamespace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_namespace::CreateNamespaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}", AwsAccountId = aws_account_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_namespace::ser_create_namespace_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_namespace::CreateNamespace::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateNamespace", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNamespace {
                type Output = std::result::Result<crate::operation::create_namespace::CreateNamespaceOutput, crate::operation::create_namespace::CreateNamespaceError>;
