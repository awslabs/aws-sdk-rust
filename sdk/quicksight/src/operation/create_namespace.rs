...
impl CreateNamespaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_namespace::CreateNamespace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_namespace::ser_create_namespace_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNamespace {
    type Output =
        ::std::result::Result<crate::operation::create_namespace::CreateNamespaceOutput, crate::operation::create_namespace::CreateNamespaceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_namespace::de_create_namespace_http_response_with_props(status, headers, body)
        }
    }
}
