...
impl DescribeAssetBundleExportJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_asset_bundle_export_job::DescribeAssetBundleExportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_asset_bundle_export_job::DescribeAssetBundleExportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_asset_bundle_export_job::DescribeAssetBundleExportJobOutput, crate::operation::describe_asset_bundle_export_job::DescribeAssetBundleExportJobError, Self> {
