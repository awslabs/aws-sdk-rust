...
impl DescribeFolderPermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_folder_permissions::DescribeFolderPermissions,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_folder_permissions::DescribeFolderPermissions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFolderPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_folder_permissions::de_describe_folder_permissions_http_response_with_props(status, headers, body)
        }
    }
}
