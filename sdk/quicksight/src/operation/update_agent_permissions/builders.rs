...
pub use crate::operation::update_agent_permissions::_update_agent_permissions_input::UpdateAgentPermissionsInputBuilder;

pub use crate::operation::update_agent_permissions::_update_agent_permissions_output::UpdateAgentPermissionsOutputBuilder;

impl crate::operation::update_agent_permissions::builders::UpdateAgentPermissionsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.update_agent_permissions();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `UpdateAgentPermissions`.
///
/// <p>Updates the resource permissions for an agent.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct UpdateAgentPermissionsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::update_agent_permissions::builders::UpdateAgentPermissionsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::update_agent_permissions::UpdateAgentPermissionsOutput,
        crate::operation::update_agent_permissions::UpdateAgentPermissionsError,
    > for UpdateAgentPermissionsFluentBuilder
{
    fn send(
        self,
...
impl UpdateAgentPermissionsFluentBuilder {
    /// Creates a new `UpdateAgentPermissionsFluentBuilder`.
    ...
    /// Access the UpdateAgentPermissions as a reference.
    pub fn as_input(&self) -> &crate::operation::update_agent_permissions::builders::UpdateAgentPermissionsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_agent_permissions::UpdateAgentPermissions::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_agent_permissions::UpdateAgentPermissions::orchestrate(&runtime_plugins, input).await
    }
