...
impl UpdatePublicSharingSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_public_sharing_settings::UpdatePublicSharingSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_public_sharing_settings::UpdatePublicSharingSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_public_sharing_settings::UpdatePublicSharingSettingsOutput, crate::operation::update_public_sharing_settings::UpdatePublicSharingSettingsError, Self> {
