...
impl ListUsersPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::User, ::aws_smithy_http::result::SdkError<crate::operation::list_users::ListUsersError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_users_output_user_list(page).unwrap_or_default().into_iter())
    }
}
