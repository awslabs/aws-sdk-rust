...
pub use crate::operation::update_topic_refresh_schedule::_update_topic_refresh_schedule_output::UpdateTopicRefreshScheduleOutputBuilder;

pub use crate::operation::update_topic_refresh_schedule::_update_topic_refresh_schedule_input::UpdateTopicRefreshScheduleInputBuilder;
...
impl UpdateTopicRefreshScheduleInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.update_topic_refresh_schedule();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
}
/// Fluent builder constructing a request to `UpdateTopicRefreshSchedule`.
/// 
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleOutput,
                    crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleError,
                > for UpdateTopicRefreshScheduleFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateTopicRefreshScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshSchedule::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshSchedule::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleOutput, crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleError, Self> {
