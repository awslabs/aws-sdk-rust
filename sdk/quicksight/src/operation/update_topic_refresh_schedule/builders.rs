...
impl crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleInputBuilder {
...
impl UpdateTopicRefreshScheduleFluentBuilder {
    /// Creates a new `UpdateTopicRefreshScheduleFluentBuilder`.
