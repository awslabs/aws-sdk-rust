...
impl DescribeDashboardSnapshotJobResultInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_dashboard_snapshot_job_result::DescribeDashboardSnapshotJobResultInput, ::aws_smithy_types::error::operation::BuildError> {
