...
impl UpdateDataSourcePermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_data_source_permissions::UpdateDataSourcePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataSourcePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_data_source_permissions::de_update_data_source_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
