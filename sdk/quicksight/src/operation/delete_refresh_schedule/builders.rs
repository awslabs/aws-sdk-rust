...
impl DeleteRefreshScheduleFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_refresh_schedule::DeleteRefreshScheduleOutput, aws_smithy_http::result::SdkError<crate::operation::delete_refresh_schedule::DeleteRefreshScheduleError>>
                     {
