...
pub type ListDashboardVersionsErrorKind = ListDashboardVersionsError;
...
impl ListDashboardVersionsError {
    ...
    /// Creates the `ListDashboardVersionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
