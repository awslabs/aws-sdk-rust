...
impl ListDashboardVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListDashboardVersions`](crate::operation::list_dashboard_versions::ListDashboardVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_dashboard_versions::ListDashboardVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_dashboard_versions::ListDashboardVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/dashboards/{DashboardId}/versions", AwsAccountId = aws_account_id, DashboardId = dashboard_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_dashboard_versions::ListDashboardVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_dashboard_versions::ListDashboardVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDashboardVersions", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListDashboardVersions {
                type Output = std::result::Result<crate::operation::list_dashboard_versions::ListDashboardVersionsOutput, crate::operation::list_dashboard_versions::ListDashboardVersionsError>;
