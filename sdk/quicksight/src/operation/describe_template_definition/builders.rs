...
impl DescribeTemplateDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_template_definition::DescribeTemplateDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_template_definition::DescribeTemplateDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_template_definition::DescribeTemplateDefinitionOutput, crate::operation::describe_template_definition::DescribeTemplateDefinitionError, Self> {
