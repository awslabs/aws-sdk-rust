...
impl DescribeTemplateDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_template_definition::DescribeTemplateDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
