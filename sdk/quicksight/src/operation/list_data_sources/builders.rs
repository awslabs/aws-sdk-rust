...
impl ListDataSourcesFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_data_sources::builders::ListDataSourcesInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_data_sources::paginator::ListDataSourcesPaginator {
        crate::operation::list_data_sources::paginator::ListDataSourcesPaginator::new(
            self.handle,
            self.inner,
        )
    }
