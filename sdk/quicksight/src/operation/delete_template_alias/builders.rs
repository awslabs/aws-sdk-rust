...
impl DeleteTemplateAliasFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_template_alias::DeleteTemplateAliasOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_template_alias::DeleteTemplateAliasError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_template_alias::DeleteTemplateAliasOutput, crate::operation::delete_template_alias::DeleteTemplateAliasError, Self> {
