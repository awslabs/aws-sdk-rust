...
impl UpdateDataSetPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_data_set_permissions::UpdateDataSetPermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
