...
impl UpdateDataSetPermissionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_data_set_permissions::UpdateDataSetPermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_data_set_permissions::UpdateDataSetPermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_data_set_permissions::UpdateDataSetPermissionsOutput, crate::operation::update_data_set_permissions::UpdateDataSetPermissionsError, Self> {
