...
/// Orchestration and serialization glue logic for `DeleteIAMPolicyAssignment`.
...
impl DeleteIAMPolicyAssignment {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_iam_policy_assignment::DeleteIamPolicyAssignmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_iam_policy_assignment::DeleteIamPolicyAssignmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteIAMPolicyAssignment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteIAMPolicyAssignment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteIAMPolicyAssignmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteIAMPolicyAssignmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteIAMPolicyAssignment")
...
.with_interceptor(DeleteIAMPolicyAssignmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignmentError>::new());
...
#[derive(Debug)]
            struct DeleteIAMPolicyAssignmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteIAMPolicyAssignmentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_iam_policy_assignment::de_delete_iam_policy_assignment_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteIAMPolicyAssignmentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteIAMPolicyAssignmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_iam_policy_assignment::DeleteIamPolicyAssignmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_iam_policy_assignment::DeleteIamPolicyAssignmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("assignment_name", "cannot be empty or unset"))?;
    ...
    if assignment_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("assignment_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/accounts/{AwsAccountId}/namespace/{Namespace}/iam-policy-assignments/{AssignmentName}", AwsAccountId = aws_account_id, Namespace = namespace, AssignmentName = assignment_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteIAMPolicyAssignmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteIAMPolicyAssignmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteIAMPolicyAssignmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteIamPolicyAssignmentInput>()
                        .ok_or("failed to downcast to DeleteIamPolicyAssignmentInput")?;
...
pub enum DeleteIAMPolicyAssignmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteIAMPolicyAssignmentError) for what information is available for the error.")]
...
impl DeleteIAMPolicyAssignmentError {
    /// Creates the `DeleteIAMPolicyAssignmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteIAMPolicyAssignmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ConcurrentUpdatingException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::ConcurrentUpdatingException`.
    pub fn is_concurrent_updating_exception(&self) -> bool {
        matches!(self, Self::ConcurrentUpdatingException(_))
    }
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteIAMPolicyAssignmentError::ThrottlingException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteIAMPolicyAssignmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignmentError {
...
mod _delete_iam_policy_assignment_output;
