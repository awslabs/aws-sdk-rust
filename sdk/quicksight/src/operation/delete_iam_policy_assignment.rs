...
impl DeleteIamPolicyAssignmentInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIAMPolicyAssignment`](crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignment)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_iam_policy_assignment::DeleteIAMPolicyAssignment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIAMPolicyAssignment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_iam_policy_assignment::de_delete_iam_policy_assignment_http_response_with_props(status, headers, body)
        }
    }
}
