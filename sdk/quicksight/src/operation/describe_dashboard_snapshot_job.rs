    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_dashboard_snapshot_job::DescribeDashboardSnapshotJobError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_dashboard_snapshot_job::DescribeDashboardSnapshotJobOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDashboardSnapshotJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeDashboardSnapshotJob", "quicksight"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDashboardSnapshotJob")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDashboardSnapshotJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDashboardSnapshotJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_dashboard_snapshot_job::DescribeDashboardSnapshotJobInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDashboardSnapshotJobEndpointParamsInterceptor {
...
pub type DescribeDashboardSnapshotJobErrorKind = DescribeDashboardSnapshotJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeDashboardSnapshotJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_dashboard_snapshot_job::DescribeDashboardSnapshotJobError {
...
impl DescribeDashboardSnapshotJobError {
    ...
    /// Creates the `DescribeDashboardSnapshotJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
