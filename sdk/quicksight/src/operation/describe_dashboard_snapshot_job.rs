...
impl DescribeDashboardSnapshotJobInput {
    ...
    > {
        ...
        .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDashboardSnapshotJob", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDashboardSnapshotJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_dashboard_snapshot_job::de_describe_dashboard_snapshot_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
