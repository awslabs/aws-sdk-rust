...
impl DescribeFolderResolvedPermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_folder_resolved_permissions::DescribeFolderResolvedPermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFolderResolvedPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_folder_resolved_permissions::de_describe_folder_resolved_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
