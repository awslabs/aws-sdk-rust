...
pub type DescribeFolderResolvedPermissionsErrorKind = DescribeFolderResolvedPermissionsError;
...
impl DescribeFolderResolvedPermissionsError {
    ...
    /// Creates the `DescribeFolderResolvedPermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
