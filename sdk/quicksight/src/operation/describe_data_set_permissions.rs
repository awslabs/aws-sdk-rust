    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_data_set_permissions::DescribeDataSetPermissionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_data_set_permissions::DescribeDataSetPermissionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDataSetPermissions {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDataSetPermissions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDataSetPermissionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDataSetPermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_data_set_permissions::DescribeDataSetPermissionsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDataSetPermissionsEndpointParamsInterceptor {
...
pub type DescribeDataSetPermissionsErrorKind = DescribeDataSetPermissionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_data_set_permissions::DescribeDataSetPermissionsError {
...
impl DescribeDataSetPermissionsError {
    ...
    /// Creates the `DescribeDataSetPermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
