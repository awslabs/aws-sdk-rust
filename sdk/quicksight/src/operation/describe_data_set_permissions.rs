...
impl DescribeDataSetPermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_data_set_permissions::DescribeDataSetPermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataSetPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_set_permissions::de_describe_data_set_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
