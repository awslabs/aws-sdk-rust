...
impl UpdateDashboardPermissionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_dashboard_permissions::UpdateDashboardPermissions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDashboardPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_dashboard_permissions::de_update_dashboard_permissions_http_response_with_props(status, headers, body)
        }
    }
}
