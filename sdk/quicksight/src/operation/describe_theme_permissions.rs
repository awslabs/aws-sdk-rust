...
impl DescribeThemePermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_theme_permissions::DescribeThemePermissions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeThemePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_theme_permissions::de_describe_theme_permissions_http_response_with_props(status, headers, body)
        }
    }
}
