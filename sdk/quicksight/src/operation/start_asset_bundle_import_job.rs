...
impl StartAssetBundleImportJobInput {
    /// Consumes the builder and constructs an Operation<[`StartAssetBundleImportJob`](crate::operation::start_asset_bundle_import_job::StartAssetBundleImportJob)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_asset_bundle_import_job::ser_start_asset_bundle_import_job_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_asset_bundle_import_job::StartAssetBundleImportJob::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("StartAssetBundleImportJob", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAssetBundleImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_asset_bundle_import_job::de_start_asset_bundle_import_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
