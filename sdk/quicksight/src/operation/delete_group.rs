...
impl DeleteGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_group::DeleteGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_group::de_delete_group_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_group::de_delete_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
