...
impl DeleteGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGroup`](crate::operation::delete_group::DeleteGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_group::DeleteGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_group::DeleteGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups/{GroupName}", AwsAccountId = aws_account_id, Namespace = namespace, GroupName = group_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_group::DeleteGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteGroup", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteGroup {
                type Output = std::result::Result<crate::operation::delete_group::DeleteGroupOutput, crate::operation::delete_group::DeleteGroupError>;
