...
impl RegisterUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_user::RegisterUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_user::ser_register_user_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_user::de_register_user_http_response_with_props(status, headers, body)
        }
    }
}
