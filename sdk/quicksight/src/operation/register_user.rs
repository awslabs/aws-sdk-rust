...
impl RegisterUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_user::RegisterUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_user::de_register_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_user::de_register_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
