...
impl DescribeTemplatePermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_template_permissions::DescribeTemplatePermissions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_template_permissions::DescribeTemplatePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTemplatePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_template_permissions::de_describe_template_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
