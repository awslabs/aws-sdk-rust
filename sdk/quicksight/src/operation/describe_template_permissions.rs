    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_template_permissions::DescribeTemplatePermissionsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_template_permissions::DescribeTemplatePermissionsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTemplatePermissions {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTemplatePermissions")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeTemplatePermissionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeTemplatePermissionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_template_permissions::DescribeTemplatePermissionsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeTemplatePermissionsEndpointParamsInterceptor {
...
pub type DescribeTemplatePermissionsErrorKind = DescribeTemplatePermissionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_template_permissions::DescribeTemplatePermissionsError {
...
impl DescribeTemplatePermissionsError {
    ...
    /// Creates the `DescribeTemplatePermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
