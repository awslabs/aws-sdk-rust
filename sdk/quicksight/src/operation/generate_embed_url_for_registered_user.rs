    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateEmbedUrlForRegisteredUser {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateEmbedUrlForRegisteredUser");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GenerateEmbedUrlForRegisteredUserRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GenerateEmbedUrlForRegisteredUserResponseDeserializer));
...
.with_interceptor(GenerateEmbedUrlForRegisteredUserEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError>::new());
...
#[derive(Debug)]
            struct GenerateEmbedUrlForRegisteredUserResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateEmbedUrlForRegisteredUserResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_generate_embed_url_for_registered_user::de_generate_embed_url_for_registered_user_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GenerateEmbedUrlForRegisteredUserRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateEmbedUrlForRegisteredUserRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AwsAccountId}/embed-url/registered-user", AwsAccountId = aws_account_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_generate_embed_url_for_registered_user::ser_generate_embed_url_for_registered_user_input(&input)?);
...
#[derive(Debug)]
            struct GenerateEmbedUrlForRegisteredUserEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateEmbedUrlForRegisteredUserEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GenerateEmbedUrlForRegisteredUserEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GenerateEmbedUrlForRegisteredUserInput>()
                        .ok_or("failed to downcast to GenerateEmbedUrlForRegisteredUserInput")?;
...
/// Error type for the `GenerateEmbedUrlForRegisteredUserError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GenerateEmbedUrlForRegisteredUserError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateEmbedUrlForRegisteredUserError) for what information is available for the error.")]
...
impl GenerateEmbedUrlForRegisteredUserError {
    /// Creates the `GenerateEmbedUrlForRegisteredUserError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GenerateEmbedUrlForRegisteredUserError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::QuickSightUserNotFoundException`.
    pub fn is_quick_sight_user_not_found_exception(&self) -> bool {
        matches!(self, Self::QuickSightUserNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::SessionLifetimeInMinutesInvalidException`.
    ...
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::UnsupportedPricingPlanException`.
    pub fn is_unsupported_pricing_plan_exception(&self) -> bool {
        matches!(self, Self::UnsupportedPricingPlanException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForRegisteredUserError::UnsupportedUserEditionException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GenerateEmbedUrlForRegisteredUserError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateEmbedUrlForRegisteredUserError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError {
...
mod _generate_embed_url_for_registered_user_output;
