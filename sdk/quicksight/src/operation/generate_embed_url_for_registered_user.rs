...
impl GenerateEmbedUrlForRegisteredUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateEmbedUrlForRegisteredUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_embed_url_for_registered_user::de_generate_embed_url_for_registered_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
