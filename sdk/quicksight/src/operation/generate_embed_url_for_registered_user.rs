...
impl GenerateEmbedUrlForRegisteredUser {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GenerateEmbedUrlForRegisteredUser",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateEmbedUrlForRegisteredUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GenerateEmbedUrlForRegisteredUserRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GenerateEmbedUrlForRegisteredUserResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GenerateEmbedUrlForRegisteredUser")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateEmbedUrlForRegisteredUser")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GenerateEmbedUrlForRegisteredUserTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GenerateEmbedUrlForRegisteredUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateEmbedUrlForRegisteredUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GenerateEmbedUrlForRegisteredUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateEmbedUrlForRegisteredUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_generate_embed_url_for_registered_user::de_generate_embed_url_for_registered_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_generate_embed_url_for_registered_user::de_generate_embed_url_for_registered_user_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateEmbedUrlForRegisteredUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_generate_embed_url_for_registered_user::ser_generate_embed_url_for_registered_user_input(&input)?,
        );
