...
impl GenerateEmbedUrlForRegisteredUserInput {
    /// Consumes the builder and constructs an Operation<[`GenerateEmbedUrlForRegisteredUser`](crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/embed-url/registered-user", AwsAccountId = aws_account_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_embed_url_for_registered_user::ser_generate_embed_url_for_registered_user_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUser::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GenerateEmbedUrlForRegisteredUser", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateEmbedUrlForRegisteredUser {
                type Output = std::result::Result<crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserOutput, crate::operation::generate_embed_url_for_registered_user::GenerateEmbedUrlForRegisteredUserError>;
