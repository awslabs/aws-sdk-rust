...
impl CreateFolderMembership {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_folder_membership::CreateFolderMembershipInput,
                    ) -> ::std::result::Result<crate::operation::create_folder_membership::CreateFolderMembershipOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_folder_membership::CreateFolderMembershipError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_folder_membership::CreateFolderMembershipError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_folder_membership::CreateFolderMembershipOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFolderMembership {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateFolderMembership");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateFolderMembershipRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateFolderMembershipResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateFolderMembership")
...
.with_interceptor(CreateFolderMembershipEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_folder_membership::CreateFolderMembershipError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_folder_membership::CreateFolderMembershipError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_folder_membership::CreateFolderMembershipError>::new());
...
#[derive(Debug)]
            struct CreateFolderMembershipResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFolderMembershipResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_folder_membership::de_create_folder_membership_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateFolderMembershipRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateFolderMembershipRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_folder_membership::CreateFolderMembershipInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_folder_membership::CreateFolderMembershipInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_3 = &_input.member_type;
    let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("member_type", "cannot be empty or unset"))?;
    ...
    if member_type.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("member_type", "cannot be empty or unset"))
                }
    let input_4 = &_input.member_id;
    let input_4 = input_4.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("member_id", "cannot be empty or unset"))?;
    let member_id = ::aws_smithy_http::label::fmt_string(input_4, ::aws_smithy_http::label::EncodingStrategy::Default);
    ...
    ::std::write!(output, "/accounts/{AwsAccountId}/folders/{FolderId}/members/{MemberType}/{MemberId}", AwsAccountId = aws_account_id, FolderId = folder_id, MemberType = member_type, MemberId = member_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct CreateFolderMembershipEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFolderMembershipEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateFolderMembershipEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateFolderMembershipInput>()
                        .ok_or("failed to downcast to CreateFolderMembershipInput")?;
...
/// Error type for the `CreateFolderMembershipError` operation.
#[non_exhaustive]
...
pub enum CreateFolderMembershipError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateFolderMembershipError) for what information is available for the error.")]
...
impl CreateFolderMembershipError {
    /// Creates the `CreateFolderMembershipError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFolderMembershipError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateFolderMembershipError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `CreateFolderMembershipError::UnsupportedUserEditionException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFolderMembershipError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateFolderMembershipError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_folder_membership::CreateFolderMembershipError {
...
mod _create_folder_membership_output;
