...
///
/// <p>Assigns one or more tags (key-value pairs) to the specified Amazon Quick Sight resource.</p>
...
/// <p>You can associate as many as 50 tags with a resource. Amazon Quick Sight supports tagging on data set, data source, dashboard, template, topic, and user.</p>
...
/// <ul>
/// <li>
/// <p>Tags are used to track costs for users in Amazon Quick Sight. You can't tag other resources that Amazon Quick Sight costs are based on, such as storage capacoty (SPICE), session usage, alert consumption, or reporting units.</p></li>
/// <li>
/// <p>Amazon Quick Sight doesn't currently support the tag editor for Resource Groups.</p></li>
/// </ul>
