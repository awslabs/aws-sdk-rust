...
/// <p>You can associate as many as 50 tags with a resource. QuickSight supports tagging on data set, data source, dashboard, template, topic, and user.</p>
/// <p>Tagging for QuickSight works in a similar way to tagging for other Amazon Web Services services, except for the following:</p>
/// <ul>
/// <li>
/// <p>Tags are used to track costs for users in QuickSight. You can't tag other resources that QuickSight costs are based on, such as storage capacoty (SPICE), session usage, alert consumption, or reporting units.</p></li>
/// <li>
/// <p>QuickSight doesn't currently support the tag editor for Resource Groups.</p></li>
/// </ul>
