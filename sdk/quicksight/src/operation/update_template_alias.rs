...
impl UpdateTemplateAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_template_alias::UpdateTemplateAlias,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTemplateAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_template_alias::de_update_template_alias_http_response_with_props(status, headers, body)
        }
    }
}
