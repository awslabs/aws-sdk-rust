...
impl DeleteDashboardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_dashboard::DeleteDashboard::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_dashboard::de_delete_dashboard_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_dashboard::DeleteDashboardError
{
