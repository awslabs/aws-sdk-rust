...
impl UpdatePublicSharingSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_public_sharing_settings::UpdatePublicSharingSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePublicSharingSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_public_sharing_settings::de_update_public_sharing_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
