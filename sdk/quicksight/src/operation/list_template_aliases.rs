...
impl ListTemplateAliasesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_template_aliases::ListTemplateAliases::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTemplateAliases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_template_aliases::de_list_template_aliases_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_template_aliases::ListTemplateAliasesError
{
