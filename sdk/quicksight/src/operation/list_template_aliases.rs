...
impl ListTemplateAliasesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_template_aliases::ListTemplateAliases,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTemplateAliases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_template_aliases::de_list_template_aliases_http_response_with_props(status, headers, body)
        }
    }
}
