    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_dashboards::SearchDashboardsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_dashboards::SearchDashboardsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchDashboards {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchDashboards")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(SearchDashboardsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SearchDashboardsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SearchDashboardsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::search_dashboards::SearchDashboardsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_dashboards::ser_search_dashboards_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SearchDashboardsEndpointParamsInterceptor {
...
pub type SearchDashboardsErrorKind = SearchDashboardsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::search_dashboards::SearchDashboardsError {
...
impl SearchDashboardsError {
    ...
    /// Creates the `SearchDashboardsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
