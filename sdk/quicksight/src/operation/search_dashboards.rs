...
impl SearchDashboardsInput {
    /// Consumes the builder and constructs an Operation<[`SearchDashboards`](crate::operation::search_dashboards::SearchDashboards)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::search_dashboards::SearchDashboards, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_dashboards::SearchDashboardsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AwsAccountId}/search/dashboards", AwsAccountId = aws_account_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_dashboards::ser_search_dashboards_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::search_dashboards::SearchDashboards::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SearchDashboards", "quicksight"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SearchDashboards`.
...
impl aws_smithy_http::response::ParseStrictResponse for SearchDashboards {
                type Output = std::result::Result<crate::operation::search_dashboards::SearchDashboardsOutput, crate::operation::search_dashboards::SearchDashboardsError>;
