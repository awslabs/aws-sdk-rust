...
impl DescribeThemeAliasFluentBuilder  {
    /// Creates a new `DescribeThemeAlias`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_theme_alias::DescribeThemeAlias, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_theme_alias::DescribeThemeAliasError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_theme_alias::DescribeThemeAliasOutput, aws_smithy_http::result::SdkError<crate::operation::describe_theme_alias::DescribeThemeAliasError>>
                     {
