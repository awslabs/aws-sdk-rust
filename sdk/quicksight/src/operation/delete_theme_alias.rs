...
impl DeleteThemeAliasInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_theme_alias::DeleteThemeAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteThemeAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_theme_alias::de_delete_theme_alias_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_theme_alias::DeleteThemeAliasError
{
