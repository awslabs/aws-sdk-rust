...
impl DescribeVpcConnectionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVPCConnection`](crate::operation::describe_vpc_connection::DescribeVPCConnection)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_vpc_connection::DescribeVPCConnection::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeVPCConnection", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVPCConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vpc_connection::de_describe_vpc_connection_http_response_with_props(status, headers, body)
        }
    }
}
