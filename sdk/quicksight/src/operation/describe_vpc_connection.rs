    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_connection::DescribeVPCConnectionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_connection::DescribeVpcConnectionOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeVPCConnectionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeVPCConnectionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_vpc_connection::DescribeVpcConnectionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeVPCConnectionEndpointParamsInterceptor {
...
pub type DescribeVPCConnectionErrorKind = DescribeVPCConnectionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeVPCConnectionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_vpc_connection::DescribeVPCConnectionError {
...
impl DescribeVPCConnectionError {
    ...
    /// Creates the `DescribeVPCConnectionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
