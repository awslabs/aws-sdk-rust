...
impl UpdateDashboardLinksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_dashboard_links::UpdateDashboardLinksInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_dashboard_links::UpdateDashboardLinksInput {
