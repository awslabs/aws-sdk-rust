...
impl DeleteAnalysisInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_analysis::DeleteAnalysis::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAnalysis {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_analysis::de_delete_analysis_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_analysis::de_delete_analysis_http_response(
                status, headers, body,
            )
        }
    }
