...
impl UpdateThemeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTheme`](crate::operation::update_theme::UpdateTheme)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_theme::UpdateTheme, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_theme::UpdateThemeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_theme::ser_update_theme_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_theme::UpdateTheme::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateTheme", "quicksight"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTheme {
                type Output = std::result::Result<crate::operation::update_theme::UpdateThemeOutput, crate::operation::update_theme::UpdateThemeError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_theme::de_update_theme_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_theme::de_update_theme_http_response(response)
                     }
                }
            }
