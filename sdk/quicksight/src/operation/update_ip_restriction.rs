...
impl UpdateIpRestrictionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_ip_restriction::ser_update_ip_restriction_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_ip_restriction::UpdateIpRestriction::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIpRestriction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_ip_restriction::de_update_ip_restriction_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_ip_restriction::UpdateIpRestrictionError
{
