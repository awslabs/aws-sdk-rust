    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_ip_restriction::UpdateIpRestrictionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_ip_restriction::UpdateIpRestrictionOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateIpRestriction")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(UpdateIpRestrictionEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateIpRestrictionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateIpRestrictionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_ip_restriction::UpdateIpRestrictionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_ip_restriction::ser_update_ip_restriction_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateIpRestrictionEndpointParamsInterceptor {
...
pub type UpdateIpRestrictionErrorKind = UpdateIpRestrictionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_ip_restriction::UpdateIpRestrictionError {
...
impl UpdateIpRestrictionError {
    ...
    /// Creates the `UpdateIpRestrictionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
