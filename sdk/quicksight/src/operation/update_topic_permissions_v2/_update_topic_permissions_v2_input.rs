...
pub struct UpdateTopicPermissionsV2Input {
...
impl UpdateTopicPermissionsV2Input {
    /// <p>The ID of the Amazon Web Services account that contains the topic that you want to update the permissions for.</p>
...
impl UpdateTopicPermissionsV2Input {
    /// Creates a new builder-style object to manufacture [`UpdateTopicPermissionsV2Input`](crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Input).
    pub fn builder() -> crate::operation::update_topic_permissions_v2::builders::UpdateTopicPermissionsV2InputBuilder {
        crate::operation::update_topic_permissions_v2::builders::UpdateTopicPermissionsV2InputBuilder::default()
    }
}

/// A builder for [`UpdateTopicPermissionsV2Input`](crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Input).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateTopicPermissionsV2InputBuilder {
...
impl UpdateTopicPermissionsV2InputBuilder {
    /// <p>The ID of the Amazon Web Services account that contains the topic that you want to update the permissions for.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateTopicPermissionsV2Input`](crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Input).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Input,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Input {
