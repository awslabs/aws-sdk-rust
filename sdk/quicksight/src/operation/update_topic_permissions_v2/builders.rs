...
pub use crate::operation::update_topic_permissions_v2::_update_topic_permissions_v2_input::UpdateTopicPermissionsV2InputBuilder;

pub use crate::operation::update_topic_permissions_v2::_update_topic_permissions_v2_output::UpdateTopicPermissionsV2OutputBuilder;

impl crate::operation::update_topic_permissions_v2::builders::UpdateTopicPermissionsV2InputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Output,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Error,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.update_topic_permissions_v2();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `UpdateTopicPermissionsV2`.
///
/// <p>Updates the permissions of a topic.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct UpdateTopicPermissionsV2FluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::update_topic_permissions_v2::builders::UpdateTopicPermissionsV2InputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Output,
        crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2Error,
    > for UpdateTopicPermissionsV2FluentBuilder
{
    fn send(
        self,
...
impl UpdateTopicPermissionsV2FluentBuilder {
    /// Creates a new `UpdateTopicPermissionsV2FluentBuilder`.
    ...
    /// Access the UpdateTopicPermissionsV2 as a reference.
    pub fn as_input(&self) -> &crate::operation::update_topic_permissions_v2::builders::UpdateTopicPermissionsV2InputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_topic_permissions_v2::UpdateTopicPermissionsV2::orchestrate(&runtime_plugins, input).await
    }
