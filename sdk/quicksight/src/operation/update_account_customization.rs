    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_account_customization::UpdateAccountCustomizationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_account_customization::UpdateAccountCustomizationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateAccountCustomization {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateAccountCustomization", "quicksight"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateAccountCustomization")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateAccountCustomizationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateAccountCustomizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_account_customization::UpdateAccountCustomizationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateAccountCustomizationEndpointParamsInterceptor {
...
pub type UpdateAccountCustomizationErrorKind = UpdateAccountCustomizationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_account_customization::UpdateAccountCustomizationError {
...
impl UpdateAccountCustomizationError {
    ...
    /// Creates the `UpdateAccountCustomizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
