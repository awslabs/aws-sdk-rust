...
impl UpdateAccountCustomizationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_account_customization::UpdateAccountCustomization::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccountCustomization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_account_customization::de_update_account_customization_http_response_with_props(status, headers, body)
        }
    }
}
