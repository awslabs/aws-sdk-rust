...
impl CreateTemplateAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_template_alias::CreateTemplateAlias,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTemplateAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_template_alias::de_create_template_alias_http_response_with_props(status, headers, body)
        }
    }
}
