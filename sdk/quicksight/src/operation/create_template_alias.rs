...
impl CreateTemplateAliasInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_template_alias::ser_create_template_alias_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_template_alias::CreateTemplateAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTemplateAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_template_alias::de_create_template_alias_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_template_alias::CreateTemplateAliasError
{
