    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_template_alias::CreateTemplateAliasError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_template_alias::CreateTemplateAliasOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTemplateAlias")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreateTemplateAliasEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateTemplateAliasResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateTemplateAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_template_alias::CreateTemplateAliasInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_template_alias::ser_create_template_alias_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateTemplateAliasEndpointParamsInterceptor {
...
pub type CreateTemplateAliasErrorKind = CreateTemplateAliasError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_template_alias::CreateTemplateAliasError {
...
impl CreateTemplateAliasError {
    ...
    /// Creates the `CreateTemplateAliasError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
