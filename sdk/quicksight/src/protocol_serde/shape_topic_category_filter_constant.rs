...
pub(crate) fn de_topic_category_filter_constant<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TopicCategoryFilterConstant>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CollectiveConstant" => {
                                builder = builder.set_collective_constant(
                                    crate::protocol_serde::shape_collective_constant::de_collective_constant(tokens)?
                                );
                            }
