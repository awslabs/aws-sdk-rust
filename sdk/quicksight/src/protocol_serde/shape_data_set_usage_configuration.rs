...
pub fn ser_data_set_usage_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataSetUsageConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_data_set_usage_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataSetUsageConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
