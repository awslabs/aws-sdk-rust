...
pub fn ser_geospatial_gradient_color(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::GeospatialGradientColor,
) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    {
        let mut array_1 = object.key("StepColors").start_array();
        for item_2 in &input.step_colors {
            {
                #[allow(unused_mut)]
                let mut object_3 = array_1.value().start_object();
                crate::protocol_serde::shape_geospatial_gradient_step_color::ser_geospatial_gradient_step_color(&mut object_3, item_2)?;
                object_3.finish();
            }
        }
        array_1.finish();
...
) -> Result<Option<crate::types::GeospatialGradientColor>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::GeospatialGradientColorBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::geospatial_gradient_color_correct_errors(builder)
                    .build()
