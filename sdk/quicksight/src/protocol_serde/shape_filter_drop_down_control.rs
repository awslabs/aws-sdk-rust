...
pub fn ser_filter_drop_down_control(
    ...
    if let Some(var_9) = &input.control_sort_configurations {
        let mut array_10 = object.key("ControlSortConfigurations").start_array();
        for item_11 in var_9 {
            {
                #[allow(unused_mut)]
                let mut object_12 = array_10.value().start_object();
                crate::protocol_serde::shape_control_sort_configuration::ser_control_sort_configuration(&mut object_12, item_11)?;
                object_12.finish();
            }
        }
        array_10.finish();
    }
    if let Some(var_13) = &input.control_title_format_text {
        #[allow(unused_mut)]
        let mut object_14 = object.key("ControlTitleFormatText").start_object();
        crate::protocol_serde::shape_control_title_format_text::ser_control_title_format_text(&mut object_14, var_13)?;
        object_14.finish();
    }
    Ok(())
}

pub(crate) fn de_filter_drop_down_control<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::FilterDropDownControl>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::FilterDropDownControlBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DisplayOptions" => {
                            builder = builder.set_display_options(
                                crate::protocol_serde::shape_drop_down_control_display_options::de_drop_down_control_display_options(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
