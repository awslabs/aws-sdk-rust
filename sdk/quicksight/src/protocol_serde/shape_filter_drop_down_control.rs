...
pub fn ser_filter_drop_down_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::FilterDropDownControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_filter_drop_down_control<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::FilterDropDownControl>, aws_smithy_json::deserialize::error::DeserializeError>
