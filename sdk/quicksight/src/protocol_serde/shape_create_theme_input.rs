...
pub fn ser_create_theme_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateThemeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
