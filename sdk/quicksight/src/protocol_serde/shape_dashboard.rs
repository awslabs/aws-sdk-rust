...
) -> Result<Option<crate::types::Dashboard>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Version" => {
                            builder = builder.set_version(crate::protocol_serde::shape_dashboard_version::de_dashboard_version(tokens)?);
                        }
                        "CreatedTime" => {
                        ...
                        "LastPublishedTime" => {
                            builder = builder.set_last_published_time(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
