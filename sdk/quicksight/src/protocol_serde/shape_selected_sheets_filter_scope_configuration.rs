...
pub(crate) fn de_selected_sheets_filter_scope_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SelectedSheetsFilterScopeConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "SheetVisualScopingConfigurations" => {
                            builder = builder.set_sheet_visual_scoping_configurations(
                                crate::protocol_serde::shape_sheet_visual_scoping_configurations::de_sheet_visual_scoping_configurations(
                                    tokens, _value,
                                )?,
                            );
                        }
