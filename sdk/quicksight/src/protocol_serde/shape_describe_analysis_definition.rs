...
pub fn de_describe_analysis_definition_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionOutput, crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_analysis_definition_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionOutput, crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionError> {
    Ok({
        #[allow(unused_mut)]
