...
pub fn de_describe_analysis_definition_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeAnalysisDefinitionOutput, crate::error::DescribeAnalysisDefinitionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeAnalysisDefinitionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_analysis_definition_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeAnalysisDefinitionOutput, crate::error::DescribeAnalysisDefinitionError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_analysis_definition(value: &[u8], mut builder: crate::output::describe_analysis_definition_output::Builder) -> Result<crate::output::describe_analysis_definition_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
