...
pub fn ser_filter_control(
    ...
    if let Some(var_3) = &input.list {
        ...
        crate::protocol_serde::shape_filter_list_control::ser_filter_list_control(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_5) = &input.dropdown {
        ...
        crate::protocol_serde::shape_filter_drop_down_control::ser_filter_drop_down_control(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
    ...
    if let Some(var_7) = &input.text_field {
        ...
        crate::protocol_serde::shape_filter_text_field_control::ser_filter_text_field_control(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
    ...
    if let Some(var_9) = &input.text_area {
        ...
        crate::protocol_serde::shape_filter_text_area_control::ser_filter_text_area_control(
            &mut object_10,
            var_9,
        )?;
        object_10.finish();
    ...
    if let Some(var_11) = &input.slider {
        ...
        crate::protocol_serde::shape_filter_slider_control::ser_filter_slider_control(
            &mut object_12,
            var_11,
        )?;
        object_12.finish();
...
pub(crate) fn de_filter_control<'a, I>(
    ...
    Option<crate::model::FilterControl>,
    ...
    >,
{
    match tokens.next().transpose()? {
        ...
        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::filter_control::Builder::default();
            loop {
                match tokens.next().transpose()? {
