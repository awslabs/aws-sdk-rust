...
pub fn ser_dashboard_source_template(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DashboardSourceTemplate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
