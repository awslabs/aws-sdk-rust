...
pub fn ser_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_measure_field<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MeasureField>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::measure_field::Builder::default();
            loop {
                match tokens.next().transpose()? {
