...
pub(crate) fn de_free_form_section_layout_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::FreeFormSectionLayoutConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
