...
pub fn ser_template_version_definition(
    ...
    if let Some(var_4) = &input.topic_configurations {
        let mut array_5 = object.key("TopicConfigurations").start_array();
        for item_6 in var_4 {
            {
                #[allow(unused_mut)]
                let mut object_7 = array_5.value().start_object();
                crate::protocol_serde::shape_topic_configuration::ser_topic_configuration(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
...
pub(crate) fn de_template_version_definition<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::TemplateVersionDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(
                crate::serde_util::template_version_definition_correct_errors(builder)
                    .build()
