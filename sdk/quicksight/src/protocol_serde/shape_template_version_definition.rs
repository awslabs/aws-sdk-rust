        ...
        for item_2 in &input.data_set_configurations {
             {
                ...
                crate::protocol_serde::shape_data_set_configuration::ser_data_set_configuration(&mut object_3, item_2)?;
                object_3.finish();
            }
        }
        array_1.finish();
...
pub(crate) fn de_template_version_definition<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TemplateVersionDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::template_version_definition_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
