...
pub fn de_create_group_membership_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_group_membership::CreateGroupMembershipOutput, crate::operation::create_group_membership::CreateGroupMembershipError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_group_membership::CreateGroupMembershipError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_group_membership_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_group_membership::CreateGroupMembershipOutput, crate::operation::create_group_membership::CreateGroupMembershipError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_group_membership::builders::CreateGroupMembershipOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_group_membership::de_create_group_membership(response.body().as_ref(), output).map_err(crate::operation::create_group_membership::CreateGroupMembershipError::unhandled)?;
