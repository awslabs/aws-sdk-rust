...
pub fn de_create_group_membership_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateGroupMembershipOutput, crate::error::CreateGroupMembershipError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateGroupMembershipError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_group_membership_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateGroupMembershipOutput, crate::error::CreateGroupMembershipError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_group_membership_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_group_membership::de_create_group_membership(response.body().as_ref(), output).map_err(crate::error::CreateGroupMembershipError::unhandled)?;
...
pub(crate) fn de_create_group_membership(value: &[u8], mut builder: crate::output::create_group_membership_output::Builder) -> Result<crate::output::create_group_membership_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
