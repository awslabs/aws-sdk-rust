...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_group_membership::de_create_group_membership(_response_body, output)
            .map_err(crate::operation::create_group_membership::CreateGroupMembershipError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "GroupMember" => {
                    builder = builder.set_group_member(crate::protocol_serde::shape_group_member::de_group_member(tokens)?);
                }
                "RequestId" => {
