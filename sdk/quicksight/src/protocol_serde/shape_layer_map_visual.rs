...
pub fn ser_layer_map_visual(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::LayerMapVisual,
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_geospatial_layer_map_configuration::ser_geospatial_layer_map_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    {
...
) -> Result<Option<crate::types::LayerMapVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::LayerMapVisualBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder.set_chart_configuration(
                                crate::protocol_serde::shape_geospatial_layer_map_configuration::de_geospatial_layer_map_configuration(tokens)?,
                            );
                        }
                        "DataSetIdentifier" => {
            ...
            Ok(Some(crate::serde_util::layer_map_visual_correct_errors(builder).build().map_err(
