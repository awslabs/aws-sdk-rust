...
pub fn ser_ui_color_palette(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UiColorPalette) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_ui_color_palette<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UiColorPalette>, aws_smithy_json::deserialize::error::DeserializeError>
