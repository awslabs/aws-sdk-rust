...
pub(crate) fn de_category_drill_down_filter<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::CategoryDrillDownFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "CategoryValues" => {
                            builder = builder.set_category_values(crate::protocol_serde::shape_category_value_list::de_category_value_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
