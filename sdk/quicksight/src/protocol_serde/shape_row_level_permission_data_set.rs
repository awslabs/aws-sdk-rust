...
pub(crate) fn de_row_level_permission_data_set<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::RowLevelPermissionDataSet>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PermissionPolicy" => {
                            builder = builder.set_permission_policy(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RowLevelPermissionPolicy::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "FormatVersion" => {
                            builder = builder.set_format_version(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RowLevelPermissionFormatVersion::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Status" => {
