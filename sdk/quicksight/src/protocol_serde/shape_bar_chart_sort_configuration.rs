...
pub(crate) fn de_bar_chart_sort_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::BarChartSortConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
