...
pub(crate) fn de_word_cloud_visual<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::WordCloudVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder.set_chart_configuration(
                                crate::protocol_serde::shape_word_cloud_chart_configuration::de_word_cloud_chart_configuration(tokens, _value)?,
                            );
                        }
                        "Actions" => {
