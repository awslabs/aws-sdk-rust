...
pub fn ser_analysis_source_entity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnalysisSourceEntity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
