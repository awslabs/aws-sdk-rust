...
pub fn ser_filter_relative_date_time_control(
    ...
    if let Some(var_1) = &input.display_options {
        ...
        crate::protocol_serde::shape_relative_date_time_control_display_options::ser_relative_date_time_control_display_options(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
...
pub(crate) fn de_filter_relative_date_time_control<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FilterRelativeDateTimeControl>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::filter_relative_date_time_control_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
