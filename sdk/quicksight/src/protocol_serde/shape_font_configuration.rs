...
pub(crate) fn de_font_configuration<'a, I>(
    ...
    Option<crate::model::FontConfiguration>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "FontDecoration" => {
                                builder = builder.set_font_decoration(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::model::FontDecoration::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            ...
                            "FontWeight" => {
                                builder = builder.set_font_weight(
                                    crate::protocol_serde::shape_font_weight::de_font_weight(
                                        tokens,
                                    )?,
                                );
                            }
                            "FontStyle" => {
                                builder = builder.set_font_style(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::model::FontStyle::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
