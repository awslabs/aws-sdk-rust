            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "FontSize" => {
                            builder = builder.set_font_size(crate::protocol_serde::shape_font_size::de_font_size(tokens, _value, depth + 1)?);
                        }
                        "FontDecoration" => {
                        ...
                        "FontWeight" => {
                            builder = builder.set_font_weight(crate::protocol_serde::shape_font_weight::de_font_weight(tokens, _value, depth + 1)?);
                        }
                        "FontStyle" => {
