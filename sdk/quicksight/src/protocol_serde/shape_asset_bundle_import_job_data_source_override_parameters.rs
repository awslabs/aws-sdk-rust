...
pub fn ser_asset_bundle_import_job_data_source_override_parameters(
    ...
    if let Some(var_9) = &input.credentials {
        ...
        crate::protocol_serde::shape_asset_bundle_import_job_data_source_credentials::ser_asset_bundle_import_job_data_source_credentials(&mut object_10, var_9)?;
        object_10.finish();
    }
    Ok(())
}
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SslProperties" => {
                                builder = builder.set_ssl_properties(
                                    crate::protocol_serde::shape_ssl_properties::de_ssl_properties(
                                        tokens,
                                    )?,
                                );
                            }
