                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DataSourceParameters" => {
                            builder = builder.set_data_source_parameters(
                                crate::protocol_serde::shape_data_source_parameters::de_data_source_parameters(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "SslProperties" => {
                            builder = builder.set_ssl_properties(crate::protocol_serde::shape_ssl_properties::de_ssl_properties(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "Credentials" => {
                            builder = builder.set_credentials(
                                    crate::protocol_serde::shape_asset_bundle_import_job_data_source_credentials::de_asset_bundle_import_job_data_source_credentials(tokens, _value, depth + 1)?
                                );
                        }
