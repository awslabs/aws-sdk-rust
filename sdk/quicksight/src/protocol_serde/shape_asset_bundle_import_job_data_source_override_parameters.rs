...
pub fn ser_asset_bundle_import_job_data_source_override_parameters(
    ...
    if let Some(var_8) = &input.credentials {
        ...
        crate::protocol_serde::shape_asset_bundle_import_job_data_source_credentials::ser_asset_bundle_import_job_data_source_credentials(&mut object_9, var_8)?;
        object_9.finish();
    }
    Ok(())
}

pub(crate) fn de_asset_bundle_import_job_data_source_override_parameters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AssetBundleImportJobDataSourceOverrideParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SslProperties" => {
                                builder = builder.set_ssl_properties(
                                    crate::protocol_serde::shape_ssl_properties::de_ssl_properties(tokens)?
                                );
                            }
                            "Credentials" => {
            ...
            Ok(Some(crate::serde_util::asset_bundle_import_job_data_source_override_parameters_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
