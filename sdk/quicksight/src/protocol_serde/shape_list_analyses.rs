...
pub fn de_list_analyses_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListAnalysesOutput, crate::error::ListAnalysesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListAnalysesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_analyses_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListAnalysesOutput, crate::error::ListAnalysesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_analyses_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_analyses::de_list_analyses(response.body().as_ref(), output).map_err(crate::error::ListAnalysesError::unhandled)?;
...
pub(crate) fn de_list_analyses(value: &[u8], mut builder: crate::output::list_analyses_output::Builder) -> Result<crate::output::list_analyses_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
