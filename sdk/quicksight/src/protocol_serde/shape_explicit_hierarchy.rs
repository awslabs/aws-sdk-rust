...
pub(crate) fn de_explicit_hierarchy<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ExplicitHierarchy>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Columns" => {
                                builder = builder.set_columns(
                                    crate::protocol_serde::shape_explicit_hierarchy_column_list::de_explicit_hierarchy_column_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "DrillDownFilters" => {
                                builder = builder.set_drill_down_filters(
                                    crate::protocol_serde::shape_drill_down_filter_list::de_drill_down_filter_list(tokens, _value, depth + 1)?,
                                );
                            }
