...
pub(crate) fn de_combo_chart_sort_configuration<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ComboChartSortConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ColorSort" => {
                            builder = builder.set_color_sort(crate::protocol_serde::shape_field_sort_options_list::de_field_sort_options_list(
                                tokens, _value,
                            )?);
                        }
                        "ColorItemsLimit" => {
