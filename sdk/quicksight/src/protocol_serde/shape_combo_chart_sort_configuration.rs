...
pub fn ser_combo_chart_sort_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ComboChartSortConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_combo_chart_sort_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ComboChartSortConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
