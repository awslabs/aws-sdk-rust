                        ...
                        "SelectedPointStyle" => {
                            builder = builder.set_selected_point_style(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::GeospatialSelectedPointStyle::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ClusterMarkerConfiguration" => {
                            builder = builder.set_cluster_marker_configuration(
                                crate::protocol_serde::shape_cluster_marker_configuration::de_cluster_marker_configuration(tokens, _value)?,
                            );
                        }
                        "HeatmapConfiguration" => {
                            builder = builder.set_heatmap_configuration(
                                crate::protocol_serde::shape_geospatial_heatmap_configuration::de_geospatial_heatmap_configuration(tokens, _value)?,
                            );
                        }
