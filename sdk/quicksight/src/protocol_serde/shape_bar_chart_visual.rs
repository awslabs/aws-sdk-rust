...
pub fn ser_bar_chart_visual(
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_bar_chart_configuration::ser_bar_chart_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
...
pub(crate) fn de_bar_chart_visual<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::BarChartVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder
                                .set_chart_configuration(crate::protocol_serde::shape_bar_chart_configuration::de_bar_chart_configuration(tokens)?);
                        }
                        "Actions" => {
            ...
            Ok(Some(crate::serde_util::bar_chart_visual_correct_errors(builder).build().map_err(
