...
pub fn ser_bar_chart_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BarChartVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
