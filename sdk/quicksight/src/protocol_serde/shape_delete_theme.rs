...
pub fn de_delete_theme_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteThemeOutput, crate::error::DeleteThemeError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_theme::de_delete_theme(response.body().as_ref(), output).map_err(crate::error::DeleteThemeError::unhandled)?;
...
pub(crate) fn de_delete_theme(value: &[u8], mut builder: crate::output::delete_theme_output::Builder) -> Result<crate::output::delete_theme_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
