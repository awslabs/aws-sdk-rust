...
pub fn ser_top_bottom_ranked_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::TopBottomRankedComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
