...
) -> Result<Option<crate::types::PivotTotalOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Placement" => {
                            builder = builder.set_placement(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TableTotalsPlacement::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ScrollStatus" => {
                            builder = builder.set_scroll_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TableTotalsScrollStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CustomLabel" => {
