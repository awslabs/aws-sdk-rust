...
pub fn ser_parameter_slider_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParameterSliderControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_parameter_slider_control<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ParameterSliderControl>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::parameter_slider_control::Builder::default();
            loop {
                match tokens.next().transpose()? {
