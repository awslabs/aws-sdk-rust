...
pub fn ser_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Visual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_visual<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Visual>, aws_smithy_json::deserialize::error::DeserializeError>
