...
pub fn ser_line_chart_aggregated_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineChartAggregatedFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_line_chart_aggregated_field_wells<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LineChartAggregatedFieldWells>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::line_chart_aggregated_field_wells::Builder::default();
            loop {
                match tokens.next().transpose()? {
