        ...
        for item_4 in var_2 {
            {
                ...
                crate::protocol_serde::shape_visual_custom_action::ser_visual_custom_action(&mut object_5, item_4)?;
                object_5.finish();
            }
        }
        array_3.finish();
...
pub(crate) fn de_empty_visual<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::EmptyVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
