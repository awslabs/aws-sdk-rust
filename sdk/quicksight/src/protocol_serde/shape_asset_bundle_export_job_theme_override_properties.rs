                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Properties" => {
                            builder = builder.set_properties(
                                    crate::protocol_serde::shape_asset_bundle_export_job_theme_property_to_override_list::de_asset_bundle_export_job_theme_property_to_override_list(tokens, _value)?
                                );
                        }
