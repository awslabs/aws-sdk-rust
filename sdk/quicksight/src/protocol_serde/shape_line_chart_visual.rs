...
pub fn ser_line_chart_visual(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::LineChartVisual,
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_line_chart_configuration::ser_line_chart_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
...
pub(crate) fn de_line_chart_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LineChartVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::LineChartVisualBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ChartConfiguration" => {
                                builder = builder.set_chart_configuration(
                                    crate::protocol_serde::shape_line_chart_configuration::de_line_chart_configuration(tokens)?
                                );
                            }
                            "Actions" => {
            ...
            Ok(Some(crate::serde_util::line_chart_visual_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
