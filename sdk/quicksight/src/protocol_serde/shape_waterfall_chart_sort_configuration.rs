...
pub(crate) fn de_waterfall_chart_sort_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::WaterfallChartSortConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
