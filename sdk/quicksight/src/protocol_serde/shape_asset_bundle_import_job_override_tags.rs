                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "VPCConnections" => {
                            builder = builder.set_vpc_connections(
                                    crate::protocol_serde::shape_asset_bundle_import_job_vpc_connection_override_tags_list::de_asset_bundle_import_job_vpc_connection_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "DataSources" => {
                            builder = builder.set_data_sources(
                                    crate::protocol_serde::shape_asset_bundle_import_job_data_source_override_tags_list::de_asset_bundle_import_job_data_source_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "DataSets" => {
                            builder = builder.set_data_sets(
                                    crate::protocol_serde::shape_asset_bundle_import_job_data_set_override_tags_list::de_asset_bundle_import_job_data_set_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "Themes" => {
                            builder = builder.set_themes(
                                    crate::protocol_serde::shape_asset_bundle_import_job_theme_override_tags_list::de_asset_bundle_import_job_theme_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "Analyses" => {
                            builder = builder.set_analyses(
                                    crate::protocol_serde::shape_asset_bundle_import_job_analysis_override_tags_list::de_asset_bundle_import_job_analysis_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "Dashboards" => {
                            builder = builder.set_dashboards(
                                    crate::protocol_serde::shape_asset_bundle_import_job_dashboard_override_tags_list::de_asset_bundle_import_job_dashboard_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "Folders" => {
                            builder = builder.set_folders(
                                    crate::protocol_serde::shape_asset_bundle_import_job_folder_override_tags_list::de_asset_bundle_import_job_folder_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
                        "TopicsV2" => {
                            builder = builder.set_topics_v2(
                                    crate::protocol_serde::shape_asset_bundle_import_job_topic_v2_override_tags_list::de_asset_bundle_import_job_topic_v2_override_tags_list(tokens, _value, depth + 1)?
                                );
                        }
...
pub fn ser_asset_bundle_import_job_override_tags(
    ...
    if let Some(var_29) = &input.topics_v2 {
        let mut array_30 = object.key("TopicsV2").start_array();
        for item_31 in var_29 {
            {
                #[allow(unused_mut)]
                let mut object_32 = array_30.value().start_object();
                crate::protocol_serde::shape_asset_bundle_import_job_topic_v2_override_tags::ser_asset_bundle_import_job_topic_v2_override_tags(
                    &mut object_32,
                    item_31,
                )?;
                object_32.finish();
