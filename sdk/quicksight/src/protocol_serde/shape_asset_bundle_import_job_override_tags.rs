                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "VPCConnections" => {
                            builder = builder.set_vpc_connections(
                                    crate::protocol_serde::shape_asset_bundle_import_job_vpc_connection_override_tags_list::de_asset_bundle_import_job_vpc_connection_override_tags_list(tokens, _value)?
                                );
                        }
                        "DataSources" => {
                            builder = builder.set_data_sources(
                                    crate::protocol_serde::shape_asset_bundle_import_job_data_source_override_tags_list::de_asset_bundle_import_job_data_source_override_tags_list(tokens, _value)?
                                );
                        }
                        "DataSets" => {
                            builder = builder.set_data_sets(
                                    crate::protocol_serde::shape_asset_bundle_import_job_data_set_override_tags_list::de_asset_bundle_import_job_data_set_override_tags_list(tokens, _value)?
                                );
                        }
                        "Themes" => {
                            builder = builder.set_themes(
                                    crate::protocol_serde::shape_asset_bundle_import_job_theme_override_tags_list::de_asset_bundle_import_job_theme_override_tags_list(tokens, _value)?
                                );
                        }
                        "Analyses" => {
                            builder = builder.set_analyses(
                                    crate::protocol_serde::shape_asset_bundle_import_job_analysis_override_tags_list::de_asset_bundle_import_job_analysis_override_tags_list(tokens, _value)?
                                );
                        }
                        "Dashboards" => {
                            builder = builder.set_dashboards(
                                    crate::protocol_serde::shape_asset_bundle_import_job_dashboard_override_tags_list::de_asset_bundle_import_job_dashboard_override_tags_list(tokens, _value)?
                                );
                        }
                        "Folders" => {
                            builder = builder.set_folders(
                                    crate::protocol_serde::shape_asset_bundle_import_job_folder_override_tags_list::de_asset_bundle_import_job_folder_override_tags_list(tokens, _value)?
                                );
                        }
