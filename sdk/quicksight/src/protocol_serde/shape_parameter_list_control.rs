...
pub(crate) fn de_parameter_list_control<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ParameterListControl>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SelectableValues" => {
                            builder = builder.set_selectable_values(
                                crate::protocol_serde::shape_parameter_selectable_values::de_parameter_selectable_values(tokens, _value, depth + 1)?,
                            );
                        }
            ...
            Ok(Some(crate::serde_util::parameter_list_control_correct_errors(builder).build().map_err(
