...
pub fn ser_parameter_list_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ParameterListControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
