...
pub(crate) fn de_decimal_default_values<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DecimalDefaultValues>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
