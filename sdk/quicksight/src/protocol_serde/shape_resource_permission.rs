...
pub(crate) fn de_resource_permission<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ResourcePermission>, aws_smithy_json::deserialize::error::DeserializeError>
