...
pub fn ser_dashboard_version_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DashboardVersionDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
