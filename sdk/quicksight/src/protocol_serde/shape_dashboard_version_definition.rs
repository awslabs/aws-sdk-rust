...
pub fn ser_dashboard_version_definition(
    ...
    if let Some(var_32) = &input.static_files {
        let mut array_33 = object.key("StaticFiles").start_array();
        for item_34 in var_32 {
            {
                #[allow(unused_mut)]
                let mut object_35 = array_33.value().start_object();
                crate::protocol_serde::shape_static_file::ser_static_file(&mut object_35, item_34)?;
                object_35.finish();
            }
        }
        array_33.finish();
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(
                crate::serde_util::dashboard_version_definition_correct_errors(builder)
                    .build()
