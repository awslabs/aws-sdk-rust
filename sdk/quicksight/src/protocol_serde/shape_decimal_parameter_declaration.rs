...
pub fn ser_decimal_parameter_declaration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DecimalParameterDeclaration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
