...
pub fn ser_decimal_parameter_declaration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DecimalParameterDeclaration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3) = &input.default_values {
        ...
        crate::protocol_serde::shape_decimal_default_values::ser_decimal_default_values(&mut object_4, var_3)?;
        object_4.finish();
    }
...
pub(crate) fn de_decimal_parameter_declaration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DecimalParameterDeclaration>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::decimal_parameter_declaration::Builder::default();
            loop {
                match tokens.next().transpose()? {
