...
> {
    ...
    Err(match error_code {
        ...
        "SessionLifetimeInMinutesInvalidException" => {
            crate::operation::get_session_embed_url::GetSessionEmbedUrlError::SessionLifetimeInMinutesInvalidException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_session_embed_url::de_get_session_embed_url(_response_body, output)
            .map_err(crate::operation::get_session_embed_url::GetSessionEmbedUrlError::unhandled)?;
...
) -> Result<crate::operation::get_session_embed_url::builders::GetSessionEmbedUrlOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
