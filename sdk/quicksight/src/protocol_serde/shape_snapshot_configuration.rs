...
pub(crate) fn de_snapshot_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SnapshotConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "FileGroups" => {
                                builder = builder.set_file_groups(
                                    crate::protocol_serde::shape_snapshot_file_group_list::de_snapshot_file_group_list(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::snapshot_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
