...
pub fn ser_word_cloud_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::WordCloudChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_3) = &input.sort_configuration {
        ...
        crate::protocol_serde::shape_word_cloud_sort_configuration::ser_word_cloud_sort_configuration(&mut object_4, var_3)?;
        object_4.finish();
    }
...
pub(crate) fn de_word_cloud_chart_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::WordCloudChartConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::WordCloudChartConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
