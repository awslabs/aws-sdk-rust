    ...
    Err(match error_code {
        ...
        "DomainNotWhitelistedException" => crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlError::DomainNotWhitelistedException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_domain_not_whitelisted_exception::de_domain_not_whitelisted_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlError::unhandled)?;
        ...
        "IdentityTypeNotSupportedException" => {
            crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlError::IdentityTypeNotSupportedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::IdentityTypeNotSupportedExceptionBuilder::default();
                    output = crate::protocol_serde::shape_identity_type_not_supported_exception::de_identity_type_not_supported_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlError::unhandled)?;
        ...
        "SessionLifetimeInMinutesInvalidException" => {
            crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlError::SessionLifetimeInMinutesInvalidException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_dashboard_embed_url::de_get_dashboard_embed_url(_response_body, output)
            .map_err(crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlError::unhandled)?;
