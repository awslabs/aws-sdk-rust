                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SortConfiguration" => {
                            builder = builder.set_sort_configuration(
                                crate::protocol_serde::shape_funnel_chart_sort_configuration::de_funnel_chart_sort_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "DataLabelOptions" => {
                            builder = builder.set_data_label_options(
                                crate::protocol_serde::shape_funnel_chart_data_label_options::de_funnel_chart_data_label_options(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
