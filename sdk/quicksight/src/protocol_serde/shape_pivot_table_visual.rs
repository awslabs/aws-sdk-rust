...
pub(crate) fn de_pivot_table_visual<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::PivotTableVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder.set_chart_configuration(
                                crate::protocol_serde::shape_pivot_table_configuration::de_pivot_table_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "ConditionalFormatting" => {
                            builder = builder.set_conditional_formatting(
                                crate::protocol_serde::shape_pivot_table_conditional_formatting::de_pivot_table_conditional_formatting(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(crate::serde_util::pivot_table_visual_correct_errors(builder).build().map_err(
