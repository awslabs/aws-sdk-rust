...
pub fn ser_pivot_table_visual(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::PivotTableVisual,
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_pivot_table_configuration::ser_pivot_table_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.conditional_formatting {
        #[allow(unused_mut)]
        let mut object_8 = object.key("ConditionalFormatting").start_object();
        crate::protocol_serde::shape_pivot_table_conditional_formatting::ser_pivot_table_conditional_formatting(&mut object_8, var_7)?;
        object_8.finish();
    }
...
pub(crate) fn de_pivot_table_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PivotTableVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::PivotTableVisualBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ChartConfiguration" => {
                                builder = builder.set_chart_configuration(
                                    crate::protocol_serde::shape_pivot_table_configuration::de_pivot_table_configuration(tokens)?
                                );
                            }
                            "ConditionalFormatting" => {
                                builder = builder.set_conditional_formatting(
                                    crate::protocol_serde::shape_pivot_table_conditional_formatting::de_pivot_table_conditional_formatting(tokens)?
                                );
                            }
                            "Actions" => {
            ...
            Ok(Some(crate::serde_util::pivot_table_visual_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
