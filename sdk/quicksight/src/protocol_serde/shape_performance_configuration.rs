        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_unique_key::ser_unique_key(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "UniqueKeys" => {
                            builder = builder.set_unique_keys(crate::protocol_serde::shape_unique_key_list::de_unique_key_list(tokens, _value)?);
                        }
