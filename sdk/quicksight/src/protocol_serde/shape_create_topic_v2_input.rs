...
pub fn ser_create_topic_v2_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::create_topic_v2::CreateTopicV2Input,
    ...
    if let Some(var_10) = &input.topic {
        ...
        crate::protocol_serde::shape_topic_v2_details::ser_topic_v2_details(&mut object_11, var_10)?;
        object_11.finish();
    }
