...
) -> Result<Option<crate::types::ForecastComputation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Seasonality" => {
                            builder = builder.set_seasonality(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ForecastComputationSeasonality::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
