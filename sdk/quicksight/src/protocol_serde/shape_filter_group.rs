                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ScopeConfiguration" => {
                            builder = builder.set_scope_configuration(
                                crate::protocol_serde::shape_filter_scope_configuration::de_filter_scope_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "Status" => {
                        ...
                        "CrossDataset" => {
                            builder = builder.set_cross_dataset(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::CrossDatasetTypes::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
