...
pub fn ser_oracle_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OracleParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_oracle_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::OracleParameters>, aws_smithy_json::deserialize::error::DeserializeError>
