...
pub fn ser_gauge_chart_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GaugeChartOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_gauge_chart_options<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GaugeChartOptions>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::gauge_chart_options::Builder::default();
            loop {
                match tokens.next().transpose()? {
                                ...
                                builder = builder.set_primary_value_display_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::PrimaryValueDisplayType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
