...
pub fn ser_column_tooltip_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ColumnTooltipItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_column_tooltip_item<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ColumnTooltipItem>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::column_tooltip_item::Builder::default();
            loop {
                match tokens.next().transpose()? {
