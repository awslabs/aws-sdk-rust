...
pub fn ser_default_filter_control_configuration(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::DefaultFilterControlConfiguration,
) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    {
        object.key("Title").string(input.title.as_str());
    }
    if let Some(var_1) = &input.control_options {
        #[allow(unused_mut)]
        let mut object_2 = object.key("ControlOptions").start_object();
...
) -> Result<Option<crate::types::DefaultFilterControlConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DefaultFilterControlConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
