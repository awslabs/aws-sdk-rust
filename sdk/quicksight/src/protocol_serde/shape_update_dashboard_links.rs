...
pub fn de_update_dashboard_links_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_dashboard_links_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_dashboard_links::de_update_dashboard_links(_response_body, output)
            .map_err(crate::operation::update_dashboard_links::UpdateDashboardLinksError::unhandled)?;
