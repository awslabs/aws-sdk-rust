...
pub(crate) fn de_axis_label_reference_options<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AxisLabelReferenceOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(
                crate::serde_util::axis_label_reference_options_correct_errors(builder)
                    .build()
