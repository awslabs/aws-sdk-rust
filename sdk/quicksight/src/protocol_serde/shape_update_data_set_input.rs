...
pub fn ser_update_data_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDataSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
