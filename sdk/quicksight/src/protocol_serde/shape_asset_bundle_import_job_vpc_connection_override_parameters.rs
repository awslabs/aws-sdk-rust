...
pub(crate) fn de_asset_bundle_import_job_vpc_connection_override_parameters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AssetBundleImportJobVpcConnectionOverrideParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DnsResolvers" => {
                                builder = builder.set_dns_resolvers(
                                    crate::protocol_serde::shape_dns_resolver_list::de_dns_resolver_list(tokens)?
                                );
                            }
                            "RoleArn" => {
            ...
            Ok(Some(crate::serde_util::asset_bundle_import_job_vpc_connection_override_parameters_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
