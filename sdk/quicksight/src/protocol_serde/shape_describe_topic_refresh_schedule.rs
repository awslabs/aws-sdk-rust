...
pub fn de_describe_topic_refresh_schedule_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleOutput, crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_topic_refresh_schedule_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleOutput, crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleError> {
    Ok({
        #[allow(unused_mut)]
