...
pub fn ser_period_over_period_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PeriodOverPeriodComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
