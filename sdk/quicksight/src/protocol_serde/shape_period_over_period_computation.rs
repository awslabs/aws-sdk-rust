...
pub fn ser_period_over_period_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PeriodOverPeriodComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_period_over_period_computation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PeriodOverPeriodComputation>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::period_over_period_computation::Builder::default();
            loop {
                match tokens.next().transpose()? {
