...
pub fn ser_scatter_plot_unaggregated_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScatterPlotUnaggregatedFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_scatter_plot_unaggregated_field_wells<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ScatterPlotUnaggregatedFieldWells>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::scatter_plot_unaggregated_field_wells::Builder::default();
            loop {
                match tokens.next().transpose()? {
