...
pub fn de_cancel_ingestion_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CancelIngestionOutput, crate::error::CancelIngestionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CancelIngestionError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalFailureException" => crate::error::CancelIngestionError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => crate::error::CancelIngestionError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::CancelIngestionError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_ingestion_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CancelIngestionOutput, crate::error::CancelIngestionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::cancel_ingestion_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_cancel_ingestion::de_cancel_ingestion(response.body().as_ref(), output).map_err(crate::error::CancelIngestionError::unhandled)?;
...
pub(crate) fn de_cancel_ingestion(value: &[u8], mut builder: crate::output::cancel_ingestion_output::Builder) -> Result<crate::output::cancel_ingestion_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
