...
pub fn ser_kpi_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::KpiVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
