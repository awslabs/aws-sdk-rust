    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder.set_chart_configuration(crate::protocol_serde::shape_kpi_configuration::de_kpi_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ConditionalFormatting" => {
                            builder = builder.set_conditional_formatting(
                                crate::protocol_serde::shape_kpi_conditional_formatting::de_kpi_conditional_formatting(tokens, _value, depth + 1)?,
                            );
                        }
                        "Actions" => {
            ...
            Ok(Some(crate::serde_util::kpi_visual_correct_errors(builder).build().map_err(|err| {
