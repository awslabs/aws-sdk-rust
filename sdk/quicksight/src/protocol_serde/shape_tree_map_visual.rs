...
pub fn ser_tree_map_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::TreeMapVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_6) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_tree_map_configuration::ser_tree_map_configuration(&mut object_7, var_6)?;
        object_7.finish();
    }
