...
pub fn ser_tree_map_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TreeMapVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_tree_map_visual<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TreeMapVisual>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::tree_map_visual::Builder::default();
            loop {
                match tokens.next().transpose()? {
