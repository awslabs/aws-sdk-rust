...
pub fn ser_free_form_layout_element(
    ...
    if let Some(var_10) = &input.background_style {
        ...
        crate::protocol_serde::shape_free_form_layout_element_background_style::ser_free_form_layout_element_background_style(&mut object_11, var_10)?;
        object_11.finish();
    }
...
pub(crate) fn de_free_form_layout_element<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FreeFormLayoutElement>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::free_form_layout_element_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
