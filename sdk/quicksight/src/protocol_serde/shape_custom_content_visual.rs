...
pub fn ser_custom_content_visual(
    ...
    if let Some(var_5) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_custom_content_configuration::ser_custom_content_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
...
pub(crate) fn de_custom_content_visual<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::CustomContentVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder.set_chart_configuration(
                                crate::protocol_serde::shape_custom_content_configuration::de_custom_content_configuration(tokens, _value)?,
                            );
                        }
                        "Actions" => {
            ...
            Ok(Some(crate::serde_util::custom_content_visual_correct_errors(builder).build().map_err(
