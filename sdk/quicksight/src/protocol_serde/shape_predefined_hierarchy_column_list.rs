...
pub(crate) fn de_predefined_hierarchy_column_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::ColumnIdentifier>>, aws_smithy_json::deserialize::error::DeserializeError>
