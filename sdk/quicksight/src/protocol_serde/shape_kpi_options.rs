                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "TrendArrows" => {
                                builder = builder.set_trend_arrows(crate::protocol_serde::shape_trend_arrow_options::de_trend_arrow_options(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "SecondaryValue" => {
                                builder = builder.set_secondary_value(
                                    crate::protocol_serde::shape_secondary_value_options::de_secondary_value_options(tokens, _value, depth + 1)?,
                                );
                            }
                            "Comparison" => {
                            ...
                            "VisualLayoutOptions" => {
                                builder = builder.set_visual_layout_options(
                                    crate::protocol_serde::shape_kpi_visual_layout_options::de_kpi_visual_layout_options(tokens, _value, depth + 1)?,
                                );
                            }
