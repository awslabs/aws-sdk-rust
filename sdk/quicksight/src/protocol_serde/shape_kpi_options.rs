...
pub fn ser_kpi_options(
    ...
    if let Some(var_1) = &input.progress_bar {
        ...
        crate::protocol_serde::shape_progress_bar_options::ser_progress_bar_options(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.trend_arrows {
        ...
        crate::protocol_serde::shape_trend_arrow_options::ser_trend_arrow_options(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
    ...
    if let Some(var_5) = &input.secondary_value {
        ...
        crate::protocol_serde::shape_secondary_value_options::ser_secondary_value_options(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
...
) -> Result<Option<crate::model::KpiOptions>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
