...
pub fn ser_radar_chart_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RadarChartConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_8) = &input.start_angle {
        object.key("StartAngle").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::Float((*var_8).into()));
    }
...
pub(crate) fn de_radar_chart_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::RadarChartConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "FieldWells" => {
                                builder = builder.set_field_wells(
                                    crate::protocol_serde::shape_radar_chart_field_wells::de_radar_chart_field_wells(tokens)?
                                );
                            }
                            "SortConfiguration" => {
                                ...
                                builder = builder.set_shape(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RadarChartShape::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "ColorAxis" => {
                                builder = builder.set_color_axis(
                                    crate::protocol_serde::shape_axis_display_options::de_axis_display_options(tokens)?
                                );
                            }
                            "ColorLabelOptions" => {
