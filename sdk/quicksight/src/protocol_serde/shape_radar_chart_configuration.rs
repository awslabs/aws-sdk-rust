                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SortConfiguration" => {
                            builder = builder.set_sort_configuration(
                                crate::protocol_serde::shape_radar_chart_sort_configuration::de_radar_chart_sort_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "BaseSeriesSettings" => {
                            builder = builder.set_base_series_settings(
                                crate::protocol_serde::shape_radar_chart_series_settings::de_radar_chart_series_settings(tokens, _value, depth + 1)?,
                            );
                        }
                        "StartAngle" => {
