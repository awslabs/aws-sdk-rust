...
pub fn ser_radar_chart_configuration(
    ...
    if let Some(var_1) = &input.field_wells {
        ...
        crate::protocol_serde::shape_radar_chart_field_wells::ser_radar_chart_field_wells(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_6) = &input.base_series_settings {
        ...
        crate::protocol_serde::shape_radar_chart_series_settings::ser_radar_chart_series_settings(
            &mut object_7,
            var_6,
        )?;
        object_7.finish();
    ...
    if let Some(var_11) = &input.alternate_band_colors_visibility {
        object
            .key("AlternateBandColorsVisibility")
...
pub(crate) fn de_radar_chart_configuration<'a, I>(
    ...
    Option<crate::types::RadarChartConfiguration>,
