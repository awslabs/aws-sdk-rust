...
pub(crate) fn de_pivot_table_dimension_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::DimensionField>>, aws_smithy_json::deserialize::error::DeserializeError>
