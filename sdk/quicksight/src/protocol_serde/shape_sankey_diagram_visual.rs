...
pub fn ser_sankey_diagram_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SankeyDiagramVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
