...
pub fn ser_plugin_visual(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::PluginVisual,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    {
        object.key("VisualId").string(input.visual_id.as_str());
    }
    {
        object.key("PluginArn").string(input.plugin_arn.as_str());
    }
...
pub(crate) fn de_plugin_visual<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::PluginVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::PluginVisualBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder = builder.set_chart_configuration(
                                crate::protocol_serde::shape_plugin_visual_configuration::de_plugin_visual_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "Actions" => {
            ...
            Ok(Some(crate::serde_util::plugin_visual_correct_errors(builder).build().map_err(|err| {
