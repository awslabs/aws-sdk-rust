...
pub fn ser_insight_visual(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::InsightVisual,
    ...
    if let Some(var_5) = &input.insight_configuration {
        #[allow(unused_mut)]
        let mut object_6 = object.key("InsightConfiguration").start_object();
        crate::protocol_serde::shape_insight_configuration::ser_insight_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
...
pub(crate) fn de_insight_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::InsightVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::insight_visual_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
