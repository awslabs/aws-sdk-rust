...
pub fn ser_box_plot_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BoxPlotVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
