...
pub fn ser_pie_chart_aggregated_field_wells(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PieChartAggregatedFieldWells) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_9) = &input.small_multiples {
        let mut array_10 = object.key("SmallMultiples").start_array();
...
pub(crate) fn de_pie_chart_aggregated_field_wells<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::PieChartAggregatedFieldWells>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::PieChartAggregatedFieldWellsBuilder::default();
            loop {
                match tokens.next().transpose()? {
