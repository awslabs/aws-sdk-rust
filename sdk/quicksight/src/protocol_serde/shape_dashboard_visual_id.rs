...
pub fn ser_dashboard_visual_id(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashboardVisualId) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
