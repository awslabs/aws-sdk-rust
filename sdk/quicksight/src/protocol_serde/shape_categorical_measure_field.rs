...
pub fn ser_categorical_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CategoricalMeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_4) = &input.aggregation_function {
        object.key("AggregationFunction").string(var_4.as_str());
    }
...
pub(crate) fn de_categorical_measure_field<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CategoricalMeasureField>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::categorical_measure_field::Builder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "AggregationFunction" => {
                                builder = builder.set_aggregation_function(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::CategoricalAggregationFunction::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
