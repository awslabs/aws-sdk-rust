...
pub fn ser_categorical_measure_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CategoricalMeasureField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
