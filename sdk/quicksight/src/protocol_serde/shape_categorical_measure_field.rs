...
pub fn ser_categorical_measure_field(
    ...
    if let Some(var_5) = &input.format_configuration {
        ...
        crate::protocol_serde::shape_string_format_configuration::ser_string_format_configuration(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
...
pub(crate) fn de_categorical_measure_field<'a, I>(
    ...
    Option<crate::model::CategoricalMeasureField>,
                                ...
                                builder = builder.set_aggregation_function(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped().map(|u| {
                                            crate::model::CategoricalAggregationFunction::from(
                                                u.as_ref(),
                                            )
                                        })
                                    })
