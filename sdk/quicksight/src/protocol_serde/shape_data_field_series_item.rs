...
pub fn ser_data_field_series_item(
...
pub(crate) fn de_data_field_series_item<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataFieldSeriesItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::data_field_series_item_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
