            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ImageStaticFile" => {
                            builder = builder.set_image_static_file(crate::protocol_serde::shape_image_static_file::de_image_static_file(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "SpatialStaticFile" => {
                            builder = builder.set_spatial_static_file(crate::protocol_serde::shape_spatial_static_file::de_spatial_static_file(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
