...
pub(crate) fn de_total_aggregation_computation<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::TotalAggregationComputation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
