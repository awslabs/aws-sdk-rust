...
pub fn ser_visual_custom_action_operation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VisualCustomActionOperation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_visual_custom_action_operation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VisualCustomActionOperation>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::visual_custom_action_operation::Builder::default();
            loop {
                match tokens.next().transpose()? {
