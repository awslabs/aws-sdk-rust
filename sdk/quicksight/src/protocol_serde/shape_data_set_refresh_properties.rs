...
pub(crate) fn de_data_set_refresh_properties<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DataSetRefreshProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "RefreshConfiguration" => {
                            builder = builder.set_refresh_configuration(
                                crate::protocol_serde::shape_refresh_configuration::de_refresh_configuration(tokens, _value)?,
                            );
                        }
                        "FailureConfiguration" => {
                            builder = builder.set_failure_configuration(
                                crate::protocol_serde::shape_refresh_failure_configuration::de_refresh_failure_configuration(tokens, _value)?,
                            );
                        }
