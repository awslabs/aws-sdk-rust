                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "RefreshConfiguration" => {
                            builder = builder.set_refresh_configuration(
                                crate::protocol_serde::shape_refresh_configuration::de_refresh_configuration(tokens, _value, depth + 1)?,
                            );
                        }
                        "FailureConfiguration" => {
                            builder = builder.set_failure_configuration(
                                crate::protocol_serde::shape_refresh_failure_configuration::de_refresh_failure_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
