...
pub fn ser_filter_list_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilterListControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_4) = &input.display_options {
        ...
        crate::protocol_serde::shape_list_control_display_options::ser_list_control_display_options(&mut object_5, var_4)?;
        object_5.finish();
    }
...
pub(crate) fn de_filter_list_control<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FilterListControl>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::filter_list_control::Builder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Type" => {
                                builder = builder.set_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::SheetControlListType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
