...
pub fn ser_filter_list_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::FilterListControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
