...
pub fn de_describe_folder_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeFolderOutput, crate::error::DescribeFolderError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeFolderError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalFailureException" => crate::error::DescribeFolderError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => crate::error::DescribeFolderError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::DescribeFolderError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnsupportedUserEditionException" => crate::error::DescribeFolderError::UnsupportedUserEditionException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_folder_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeFolderOutput, crate::error::DescribeFolderError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_folder_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_folder::de_describe_folder(response.body().as_ref(), output).map_err(crate::error::DescribeFolderError::unhandled)?;
...
pub(crate) fn de_describe_folder(value: &[u8], mut builder: crate::output::describe_folder_output::Builder) -> Result<crate::output::describe_folder_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
