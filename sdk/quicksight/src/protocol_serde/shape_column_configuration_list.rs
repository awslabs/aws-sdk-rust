...
pub(crate) fn de_column_configuration_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ColumnConfiguration>>, aws_smithy_json::deserialize::error::DeserializeError>
