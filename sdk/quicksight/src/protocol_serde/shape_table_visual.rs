...
pub fn ser_table_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::TableVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
