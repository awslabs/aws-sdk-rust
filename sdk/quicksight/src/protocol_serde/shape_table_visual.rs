...
pub fn ser_table_visual(
    ...
    if let Some(var_13) = &input.visual_content_alt_text {
        object.key("VisualContentAltText").string(var_13.as_str());
    }
    Ok(())
}
...
) -> Result<Option<crate::types::TableVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ChartConfiguration" => {
                            builder =
                                builder.set_chart_configuration(crate::protocol_serde::shape_table_configuration::de_table_configuration(tokens)?);
                        }
