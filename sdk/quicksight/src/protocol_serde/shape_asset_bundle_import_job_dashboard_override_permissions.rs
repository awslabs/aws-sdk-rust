...
pub fn ser_asset_bundle_import_job_dashboard_override_permissions(
    ...
    if let Some(var_5) = &input.link_sharing_configuration {
        ...
        crate::protocol_serde::shape_asset_bundle_resource_link_sharing_configuration::ser_asset_bundle_resource_link_sharing_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    Ok(())
}

pub(crate) fn de_asset_bundle_import_job_dashboard_override_permissions<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AssetBundleImportJobDashboardOverridePermissions>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::asset_bundle_import_job_dashboard_override_permissions_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
