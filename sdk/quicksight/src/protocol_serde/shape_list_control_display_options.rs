...
pub fn ser_list_control_display_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListControlDisplayOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_list_control_display_options<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ListControlDisplayOptions>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::list_control_display_options::Builder::default();
            loop {
                match tokens.next().transpose()? {
