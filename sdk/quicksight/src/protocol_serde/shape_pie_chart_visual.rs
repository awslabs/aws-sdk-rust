...
pub fn ser_pie_chart_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PieChartVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
