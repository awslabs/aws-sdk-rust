...
pub fn de_list_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListGroupsOutput, crate::error::ListGroupsError> {
    ...
    Err(match error_code {
        ...
        "InvalidParameterValueException" => crate::error::ListGroupsError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "PreconditionNotMetException" => crate::error::ListGroupsError::PreconditionNotMetException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceUnavailableException" => crate::error::ListGroupsError::ResourceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
