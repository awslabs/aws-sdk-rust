...
pub fn ser_physical_table(
    ...
    match input {
        ...
        crate::types::PhysicalTable::Unknown => {
            return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("PhysicalTable"))
        }
    }
    Ok(())
}
...
) -> Result<Option<crate::types::PhysicalTable>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
