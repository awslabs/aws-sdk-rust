...
pub fn ser_combo_chart_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ComboChartVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_6) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_combo_chart_configuration::ser_combo_chart_configuration(&mut object_7, var_6)?;
        object_7.finish();
    }
