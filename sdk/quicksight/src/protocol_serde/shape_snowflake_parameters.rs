...
pub fn ser_snowflake_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SnowflakeParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_snowflake_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::SnowflakeParameters>, aws_smithy_json::deserialize::error::DeserializeError>
