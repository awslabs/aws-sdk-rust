...
pub fn ser_pie_chart_configuration(
    ...
    if let Some(var_1) = &input.field_wells {
        ...
        crate::protocol_serde::shape_pie_chart_field_wells::ser_pie_chart_field_wells(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
...
pub(crate) fn de_pie_chart_configuration<'a, I>(
    ...
    Option<crate::model::PieChartConfiguration>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DonutOptions" => {
                                builder = builder.set_donut_options(
                                    crate::protocol_serde::shape_donut_options::de_donut_options(
                                        tokens,
                                    )?,
                                );
                            }
