...
pub fn ser_file_source(
    ...
    {
        object.key("SheetIndex").number(
            #[allow(clippy::useless_conversion)]
            ::aws_smithy_types::Number::NegInt((input.sheet_index).into()),
        );
    }
    {
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "UploadSettings" => {
                            builder = builder.set_upload_settings(crate::protocol_serde::shape_upload_settings::de_upload_settings(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "SheetIndex" => {
                            builder = builder.set_sheet_index(
            ...
            Ok(Some(crate::serde_util::file_source_correct_errors(builder).build().map_err(|err| {
