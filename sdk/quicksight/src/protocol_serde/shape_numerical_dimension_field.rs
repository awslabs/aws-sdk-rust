...
pub fn ser_numerical_dimension_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::NumericalDimensionField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
