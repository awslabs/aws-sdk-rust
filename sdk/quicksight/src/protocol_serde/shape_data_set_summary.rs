...
pub(crate) fn de_data_set_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataSetSummary>, aws_smithy_json::deserialize::error::DeserializeError>
