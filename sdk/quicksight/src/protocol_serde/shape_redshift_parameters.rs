...
pub fn ser_redshift_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RedshiftParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
