...
pub(crate) fn de_topic_column<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::TopicColumn>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ColumnSynonyms" => {
                            builder = builder.set_column_synonyms(crate::protocol_serde::shape_synonyms::de_synonyms(tokens, _value, depth + 1)?);
                        }
                        "ColumnDataRole" => {
