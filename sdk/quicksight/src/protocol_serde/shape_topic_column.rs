...
pub(crate) fn de_topic_column<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TopicColumn>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ColumnDataRole" => {
                                builder = builder.set_column_data_role(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ColumnDataRole::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "SemanticType" => {
                                builder = builder.set_semantic_type(
                                    crate::protocol_serde::shape_semantic_type::de_semantic_type(tokens)?
                                );
                            }
                            "TimeGranularity" => {
                            ...
                            "NonAdditive" => {
                                builder = builder.set_non_additive(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::topic_column_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
