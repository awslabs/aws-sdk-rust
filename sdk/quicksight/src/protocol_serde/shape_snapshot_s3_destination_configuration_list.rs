...
pub(crate) fn de_snapshot_s3_destination_configuration_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::SnapshotS3DestinationConfiguration>>, ::aws_smithy_json::deserialize::error::DeserializeError>
