...
pub fn ser_update_analysis_permissions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAnalysisPermissionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
