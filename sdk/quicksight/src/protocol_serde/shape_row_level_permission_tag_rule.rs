...
pub(crate) fn de_row_level_permission_tag_rule<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::RowLevelPermissionTagRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
