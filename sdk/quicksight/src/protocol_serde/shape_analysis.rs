...
) -> ::std::result::Result<Option<crate::types::Analysis>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DataSetArns" => {
                            builder = builder.set_data_set_arns(crate::protocol_serde::shape_data_set_arns_list::de_data_set_arns_list(tokens)?);
                        }
                        "ThemeArn" => {
