...
pub fn ser_table_cell_style(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableCellStyle) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_table_cell_style<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TableCellStyle>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::table_cell_style::Builder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "TextWrap" => {
                                builder = builder.set_text_wrap(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::TextWrap::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "HorizontalTextAlignment" => {
                                builder = builder.set_horizontal_text_alignment(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::HorizontalTextAlignment::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "VerticalTextAlignment" => {
                                builder = builder.set_vertical_text_alignment(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::VerticalTextAlignment::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
