...
pub fn ser_tree_map_configuration(
    ...
    if let Some(var_1) = &input.field_wells {
        ...
        crate::protocol_serde::shape_tree_map_field_wells::ser_tree_map_field_wells(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.sort_configuration {
        ...
        crate::protocol_serde::shape_tree_map_sort_configuration::ser_tree_map_sort_configuration(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
...
pub(crate) fn de_tree_map_configuration<'a, I>(
    ...
    Option<crate::model::TreeMapConfiguration>,
