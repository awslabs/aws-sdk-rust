                        ...
                        match key.to_unescaped()?.as_ref() {
                            "ValueLabelConfiguration" => {
                                builder = builder.set_value_label_configuration(
                                    crate::protocol_serde::shape_reference_line_value_label_configuration::de_reference_line_value_label_configuration(tokens, _value, depth + 1)?
                                );
                            }
                            "CustomLabelConfiguration" => {
                                builder = builder.set_custom_label_configuration(
                                    crate::protocol_serde::shape_reference_line_custom_label_configuration::de_reference_line_custom_label_configuration(tokens, _value, depth + 1)?
                                );
                            }
                            "FontConfiguration" => {
