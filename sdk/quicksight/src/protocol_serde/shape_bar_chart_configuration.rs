                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SortConfiguration" => {
                            builder = builder.set_sort_configuration(
                                crate::protocol_serde::shape_bar_chart_sort_configuration::de_bar_chart_sort_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "DefaultSeriesSettings" => {
                            builder = builder.set_default_series_settings(
                                crate::protocol_serde::shape_bar_chart_default_series_settings::de_bar_chart_default_series_settings(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
