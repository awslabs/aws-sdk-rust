                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Category" => {
                            builder = builder.set_category(
                                crate::protocol_serde::shape_funnel_chart_dimension_field_list::de_funnel_chart_dimension_field_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "Values" => {
                            builder = builder.set_values(
                                crate::protocol_serde::shape_funnel_chart_measure_field_list::de_funnel_chart_measure_field_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
