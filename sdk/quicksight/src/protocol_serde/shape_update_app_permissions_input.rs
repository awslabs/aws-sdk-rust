...
pub fn ser_update_app_permissions_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::update_app_permissions::UpdateAppPermissionsInput,
    ...
    if let Some(var_9) = &input.visibility {
        object.key("Visibility").string(var_9.as_str());
    }
    Ok(())
}
