            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "BarValues" => {
                            builder = builder.set_bar_values(crate::protocol_serde::shape_measure_field_list::de_measure_field_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "LineValues" => {
                            builder = builder.set_line_values(crate::protocol_serde::shape_measure_field_list::de_measure_field_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
