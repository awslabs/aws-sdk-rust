        ...
        for item_7 in var_5 {
             {
                ...
                crate::protocol_serde::shape_pivot_table_conditional_formatting_scope::ser_pivot_table_conditional_formatting_scope(&mut object_8, item_7)?;
                object_8.finish();
            }
        }
        array_6.finish();
...
pub(crate) fn de_pivot_table_cell_conditional_formatting<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PivotTableCellConditionalFormatting>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::pivot_table_cell_conditional_formatting_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
