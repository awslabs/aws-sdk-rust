...
pub fn ser_predefined_hierarchy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PredefinedHierarchy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
