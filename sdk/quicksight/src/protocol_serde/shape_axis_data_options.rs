...
pub fn ser_axis_data_options(
    ...
    if let Some(var_1) = &input.numeric_axis_options {
        ...
        crate::protocol_serde::shape_numeric_axis_options::ser_numeric_axis_options(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.date_axis_options {
        ...
        crate::protocol_serde::shape_date_axis_options::ser_date_axis_options(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
...
pub(crate) fn de_axis_data_options<'a, I>(
    ...
    Option<crate::types::AxisDataOptions>,
