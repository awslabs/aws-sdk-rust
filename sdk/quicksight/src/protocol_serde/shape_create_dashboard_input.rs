...
pub fn ser_create_dashboard_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDashboardInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
