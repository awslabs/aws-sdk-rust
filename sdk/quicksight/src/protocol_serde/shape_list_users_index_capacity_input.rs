...
pub fn ser_list_users_index_capacity_input_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_user_index_capacity_filter::ser_user_index_capacity_filter(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
