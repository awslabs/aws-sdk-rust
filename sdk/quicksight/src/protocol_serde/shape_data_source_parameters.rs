...
pub fn ser_data_source_parameters(object_5: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DataSourceParameters) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::DataSourceParameters::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("DataSourceParameters"))
    }
    Ok(())
}
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            ...
                            "StarburstParameters" => {
                                Some(crate::types::DataSourceParameters::StarburstParameters(
                                    crate::protocol_serde::shape_starburst_parameters::de_starburst_parameters(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'StarburstParameters' cannot be null"))?
                                ))
                            }
                            "TrinoParameters" => {
                                Some(crate::types::DataSourceParameters::TrinoParameters(
                                    crate::protocol_serde::shape_trino_parameters::de_trino_parameters(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'TrinoParameters' cannot be null"))?
                                ))
                            }
                            "BigQueryParameters" => {
                                Some(crate::types::DataSourceParameters::BigQueryParameters(
                                    crate::protocol_serde::shape_big_query_parameters::de_big_query_parameters(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'BigQueryParameters' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
