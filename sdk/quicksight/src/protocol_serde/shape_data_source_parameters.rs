...
pub fn ser_data_source_parameters(object_5: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataSourceParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_data_source_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataSourceParameters>, aws_smithy_json::deserialize::error::DeserializeError>
                    ...
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.to_unescaped()?.as_ref() {
                            ...
                            "DatabricksParameters" => {
                                Some(crate::model::DataSourceParameters::DatabricksParameters(
