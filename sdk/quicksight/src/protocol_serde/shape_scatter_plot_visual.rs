...
pub fn ser_scatter_plot_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScatterPlotVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_scatter_plot_visual<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ScatterPlotVisual>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::scatter_plot_visual::Builder::default();
            loop {
                match tokens.next().transpose()? {
