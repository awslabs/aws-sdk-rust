...
pub fn ser_scatter_plot_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ScatterPlotVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
