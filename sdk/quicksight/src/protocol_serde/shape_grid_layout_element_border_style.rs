...
pub fn ser_grid_layout_element_border_style(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::GridLayoutElementBorderStyle,
...
pub(crate) fn de_grid_layout_element_border_style<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::GridLayoutElementBorderStyle>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::GridLayoutElementBorderStyleBuilder::default();
            loop {
                match tokens.next().transpose()? {
