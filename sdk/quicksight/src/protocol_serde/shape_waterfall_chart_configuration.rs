                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "FieldWells" => {
                            builder = builder.set_field_wells(
                                crate::protocol_serde::shape_waterfall_chart_field_wells::de_waterfall_chart_field_wells(tokens, _value, depth + 1)?,
                            );
                        }
                        "SortConfiguration" => {
                        ...
                        "WaterfallChartOptions" => {
                            builder = builder.set_waterfall_chart_options(
                                crate::protocol_serde::shape_waterfall_chart_options::de_waterfall_chart_options(tokens, _value, depth + 1)?,
                            );
                        }
