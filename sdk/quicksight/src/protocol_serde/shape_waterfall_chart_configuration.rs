...
pub fn ser_waterfall_chart_configuration(
    ...
    if let Some(var_1) = &input.field_wells {
        ...
        crate::protocol_serde::shape_waterfall_chart_field_wells::ser_waterfall_chart_field_wells(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_5) = &input.waterfall_chart_options {
        ...
        crate::protocol_serde::shape_waterfall_chart_options::ser_waterfall_chart_options(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
...
pub(crate) fn de_waterfall_chart_configuration<'a, I>(
    ...
    Option<crate::model::WaterfallChartConfiguration>,
