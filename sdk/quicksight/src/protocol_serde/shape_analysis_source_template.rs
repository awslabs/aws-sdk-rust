...
pub fn ser_analysis_source_template(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnalysisSourceTemplate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
