...
pub fn ser_create_data_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDataSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
