...
pub fn ser_create_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAnalysisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
