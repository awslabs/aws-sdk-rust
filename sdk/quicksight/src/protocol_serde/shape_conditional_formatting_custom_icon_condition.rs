...
pub fn ser_conditional_formatting_custom_icon_condition(
    ...
    if let Some(var_1) = &input.icon_options {
        ...
        crate::protocol_serde::shape_conditional_formatting_custom_icon_options::ser_conditional_formatting_custom_icon_options(&mut object_2, var_1)?;
        object_2.finish();
    }
    ...
    if let Some(var_4) = &input.display_configuration {
        ...
        crate::protocol_serde::shape_conditional_formatting_icon_display_configuration::ser_conditional_formatting_icon_display_configuration(&mut object_5, var_4)?;
        object_5.finish();
    }
    Ok(())
}
...
pub(crate) fn de_conditional_formatting_custom_icon_condition<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ConditionalFormattingCustomIconCondition>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::conditional_formatting_custom_icon_condition_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
