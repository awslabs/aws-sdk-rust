...
pub fn ser_top_bottom_movers_computation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TopBottomMoversComputation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_top_bottom_movers_computation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TopBottomMoversComputation>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::top_bottom_movers_computation::Builder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SortOrder" => {
                                builder = builder.set_sort_order(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::TopBottomSortOrder::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "Type" => {
                                builder = builder.set_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::TopBottomComputationType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
