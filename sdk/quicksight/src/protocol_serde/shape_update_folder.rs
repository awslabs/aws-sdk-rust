...
pub fn de_update_folder_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_update_folder::de_update_folder(_response_body, output)
            .map_err(crate::operation::update_folder::UpdateFolderError::unhandled)?;
...
) -> Result<crate::operation::update_folder::builders::UpdateFolderOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
