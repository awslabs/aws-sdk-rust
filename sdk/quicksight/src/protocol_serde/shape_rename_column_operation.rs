...
pub(crate) fn de_rename_column_operation<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::RenameColumnOperation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
