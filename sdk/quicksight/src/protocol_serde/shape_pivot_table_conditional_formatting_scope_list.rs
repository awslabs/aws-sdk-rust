...
pub(crate) fn de_pivot_table_conditional_formatting_scope_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::PivotTableConditionalFormattingScope>>, ::aws_smithy_json::deserialize::error::DeserializeError>
