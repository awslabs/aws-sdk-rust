...
pub(crate) fn de_funnel_chart_dimension_field_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DimensionField>>, aws_smithy_json::deserialize::error::DeserializeError>
