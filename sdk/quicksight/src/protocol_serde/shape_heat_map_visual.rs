...
pub(crate) fn de_heat_map_visual<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::HeatMapVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ChartConfiguration" => {
                                builder = builder.set_chart_configuration(
                                    crate::protocol_serde::shape_heat_map_configuration::de_heat_map_configuration(tokens, _value, depth + 1)?,
                                );
                            }
                            "ColumnHierarchies" => {
            ...
            Ok(Some(crate::serde_util::heat_map_visual_correct_errors(builder).build().map_err(
