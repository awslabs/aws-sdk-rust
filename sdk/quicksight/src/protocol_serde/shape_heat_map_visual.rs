...
pub fn ser_heat_map_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::HeatMapVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_8) = &input.column_hierarchies {
        let mut array_9 = object.key("ColumnHierarchies").start_array();
