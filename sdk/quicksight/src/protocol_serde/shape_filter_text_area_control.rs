...
pub fn ser_filter_text_area_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FilterTextAreaControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_filter_text_area_control<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FilterTextAreaControl>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::filter_text_area_control::Builder::default();
            loop {
                match tokens.next().transpose()? {
