...
pub fn ser_filter_text_area_control(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::FilterTextAreaControl,
...
pub(crate) fn de_filter_text_area_control<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FilterTextAreaControl>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::FilterTextAreaControlBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(crate::serde_util::filter_text_area_control_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
