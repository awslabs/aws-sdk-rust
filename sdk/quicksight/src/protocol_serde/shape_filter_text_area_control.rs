...
pub fn ser_filter_text_area_control(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::FilterTextAreaControl) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
