                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "DimensionConfigurations" => {
                            builder = builder.set_dimension_configurations(
                                    crate::protocol_serde::shape_body_section_repeat_dimension_configuration_list::de_body_section_repeat_dimension_configuration_list(tokens, _value, depth + 1)?
                                );
                        }
                        "PageBreakConfiguration" => {
                            builder = builder.set_page_break_configuration(
                                    crate::protocol_serde::shape_body_section_repeat_page_break_configuration::de_body_section_repeat_page_break_configuration(tokens, _value, depth + 1)?
                                );
                        }
                        "NonRepeatingVisuals" => {
                            builder = builder.set_non_repeating_visuals(
                                crate::protocol_serde::shape_non_repeating_visuals_list::de_non_repeating_visuals_list(tokens, _value, depth + 1)?,
                            );
                        }
