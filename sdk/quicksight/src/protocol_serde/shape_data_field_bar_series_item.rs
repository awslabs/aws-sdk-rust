...
pub fn ser_data_field_bar_series_item(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::DataFieldBarSeriesItem,
    ...
    if let Some(var_2) = &input.settings {
        ...
        crate::protocol_serde::shape_bar_chart_series_settings::ser_bar_chart_series_settings(&mut object_3, var_2)?;
        object_3.finish();
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DataFieldBarSeriesItemBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::data_field_bar_series_item_correct_errors(builder)
                    .build()
