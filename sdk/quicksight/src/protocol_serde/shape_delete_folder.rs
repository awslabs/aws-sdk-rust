...
pub fn de_delete_folder_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteFolderOutput, crate::error::DeleteFolderError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_folder::de_delete_folder(response.body().as_ref(), output).map_err(crate::error::DeleteFolderError::unhandled)?;
...
pub(crate) fn de_delete_folder(value: &[u8], mut builder: crate::output::delete_folder_output::Builder) -> Result<crate::output::delete_folder_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
