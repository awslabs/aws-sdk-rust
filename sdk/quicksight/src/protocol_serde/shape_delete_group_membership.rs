...
pub fn de_delete_group_membership_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_group_membership::DeleteGroupMembershipOutput, crate::operation::delete_group_membership::DeleteGroupMembershipError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_group_membership::DeleteGroupMembershipError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_group_membership_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_group_membership::DeleteGroupMembershipOutput, crate::operation::delete_group_membership::DeleteGroupMembershipError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_group_membership::builders::DeleteGroupMembershipOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_group_membership::de_delete_group_membership(response.body().as_ref(), output).map_err(crate::operation::delete_group_membership::DeleteGroupMembershipError::unhandled)?;
