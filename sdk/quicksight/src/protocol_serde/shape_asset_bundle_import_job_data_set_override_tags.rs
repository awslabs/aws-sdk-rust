...
pub(crate) fn de_asset_bundle_import_job_data_set_override_tags<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AssetBundleImportJobDataSetOverrideTags>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::asset_bundle_import_job_data_set_override_tags_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
