...
pub(crate) fn de_topic_relative_date_filter<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::TopicRelativeDateFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Constant" => {
                            builder = builder.set_constant(
                                crate::protocol_serde::shape_topic_singular_filter_constant::de_topic_singular_filter_constant(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
