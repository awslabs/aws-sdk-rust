...
pub(crate) fn de_topic_relative_date_filter<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TopicRelativeDateFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "RelativeDateFilterFunction" => {
                                builder = builder.set_relative_date_filter_function(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::TopicRelativeDateFilterFunction::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
