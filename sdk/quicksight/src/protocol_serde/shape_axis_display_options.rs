...
pub fn ser_axis_display_options(
    ...
    if let Some(var_1) = &input.tick_label_options {
        ...
        crate::protocol_serde::shape_axis_tick_label_options::ser_axis_tick_label_options(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_5) = &input.data_options {
        ...
        crate::protocol_serde::shape_axis_data_options::ser_axis_data_options(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
    ...
    if let Some(var_7) = &input.scrollbar_options {
        ...
        crate::protocol_serde::shape_scroll_bar_options::ser_scroll_bar_options(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
...
pub(crate) fn de_axis_display_options<'a, I>(
    ...
    Option<crate::model::AxisDisplayOptions>,
