            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "FieldWells" => {
                            builder = builder.set_field_wells(crate::protocol_serde::shape_kpi_field_wells::de_kpi_field_wells(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "KPIOptions" => {
                            builder = builder.set_kpi_options(crate::protocol_serde::shape_kpi_options::de_kpi_options(tokens, _value, depth + 1)?);
                        }
                        "Interactions" => {
