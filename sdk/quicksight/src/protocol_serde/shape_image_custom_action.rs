...
) -> Result<Option<crate::types::ImageCustomAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ActionOperations" => {
                            builder = builder.set_action_operations(
                                crate::protocol_serde::shape_image_custom_action_operation_list::de_image_custom_action_operation_list(tokens)?,
                            );
                        }
