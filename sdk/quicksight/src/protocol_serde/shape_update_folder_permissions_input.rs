...
pub fn ser_update_folder_permissions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_folder_permissions::UpdateFolderPermissionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
