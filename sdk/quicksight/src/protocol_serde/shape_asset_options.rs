            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ExcludedDataSetArns" => {
                            builder = builder.set_excluded_data_set_arns(crate::protocol_serde::shape_data_set_arns_list::de_data_set_arns_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "CustomActionDefaults" => {
                            builder = builder.set_custom_action_defaults(
                                crate::protocol_serde::shape_visual_custom_action_defaults::de_visual_custom_action_defaults(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
