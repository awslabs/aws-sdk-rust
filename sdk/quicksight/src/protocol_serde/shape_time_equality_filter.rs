...
pub fn ser_time_equality_filter(
    ...
    if let Some(var_3) = &input.value {
        object.key("Value").date_time(var_3, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
...
pub(crate) fn de_time_equality_filter<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TimeEqualityFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::time_equality_filter_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
