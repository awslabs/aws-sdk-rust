...
pub fn ser_analysis_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AnalysisDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
