...
pub(crate) fn de_analysis_definition<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AnalysisDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Options" => {
                                builder = builder.set_options(
                                    crate::protocol_serde::shape_asset_options::de_asset_options(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::analysis_definition_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
