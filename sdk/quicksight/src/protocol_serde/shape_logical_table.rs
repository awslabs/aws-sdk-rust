...
pub fn ser_logical_table(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogicalTable) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_logical_table<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LogicalTable>, aws_smithy_json::deserialize::error::DeserializeError>
