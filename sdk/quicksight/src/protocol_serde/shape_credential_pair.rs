...
pub fn ser_credential_pair(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CredentialPair) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
