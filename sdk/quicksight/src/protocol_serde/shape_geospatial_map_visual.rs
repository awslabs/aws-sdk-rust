...
pub(crate) fn de_geospatial_map_visual<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::GeospatialMapVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ChartConfiguration" => {
                                builder = builder.set_chart_configuration(
                                    crate::protocol_serde::shape_geospatial_map_configuration::de_geospatial_map_configuration(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "GeocodingPreferences" => {
                                builder = builder.set_geocoding_preferences(
                                    crate::protocol_serde::shape_geocode_preference_list::de_geocode_preference_list(tokens, _value, depth + 1)?,
                                );
                            }
            ...
            Ok(Some(crate::serde_util::geospatial_map_visual_correct_errors(builder).build().map_err(
