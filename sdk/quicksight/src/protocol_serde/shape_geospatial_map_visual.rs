...
pub fn ser_geospatial_map_visual(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GeospatialMapVisual) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_6) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_geospatial_map_configuration::ser_geospatial_map_configuration(&mut object_7, var_6)?;
        object_7.finish();
    }
