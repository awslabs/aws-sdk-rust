                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Cell" => {
                            builder = builder.set_cell(
                                crate::protocol_serde::shape_table_cell_conditional_formatting::de_table_cell_conditional_formatting(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "Row" => {
                            builder = builder.set_row(
                                crate::protocol_serde::shape_table_row_conditional_formatting::de_table_row_conditional_formatting(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
