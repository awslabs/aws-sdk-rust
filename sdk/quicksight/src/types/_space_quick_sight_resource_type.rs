...
/// When writing a match expression against `SpaceQuickSightResourceType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `spacequicksightresourcetype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `SpaceQuickSightResourceType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `SpaceQuickSightResourceType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `SpaceQuickSightResourceType::NewFeature` is defined.
/// Specifically, when `spacequicksightresourcetype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `SpaceQuickSightResourceType::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum SpaceQuickSightResourceType {
    #[allow(missing_docs)] // documentation missing in model
    ActionConnector,
    #[allow(missing_docs)] // documentation missing in model
    Dashboard,
...
impl ::std::convert::From<&str> for SpaceQuickSightResourceType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for SpaceQuickSightResourceType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SpaceQuickSightResourceType::from(s))
    }
}
impl SpaceQuickSightResourceType {
...
impl ::std::fmt::Display for SpaceQuickSightResourceType {
