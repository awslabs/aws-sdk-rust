...
impl HistogramVisualBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::HistogramVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::HistogramVisual {
                visual_id: self.visual_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("visual_id", "visual_id was not specified but it is required when building HistogramVisual")
                    )?
                ,
                title: self.title
                ,
