...
///
/// <p>The visibility of an app. Valid values are:</p>
/// <ul>
/// <li>
/// <p>
/// <code>PRIVATE</code> – The app is reachable only by authorized Amazon QuickSight principals.</p>
/// </li>
/// <li>
/// <p>
/// <code>PUBLIC</code> – The published app is reachable by anyone on the internet without signing in.</p>
/// </li>
/// </ul>
#[non_exhaustive]
#[derive(
...
impl ::std::fmt::Display for AppVisibility {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            AppVisibility::Private => write!(f, "PRIVATE"),
            AppVisibility::Public => write!(f, "PUBLIC"),
