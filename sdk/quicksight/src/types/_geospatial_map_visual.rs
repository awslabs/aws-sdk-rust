...
impl GeospatialMapVisualBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::GeospatialMapVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::GeospatialMapVisual {
                visual_id: self.visual_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("visual_id", "visual_id was not specified but it is required when building GeospatialMapVisual")
                    )?
                ,
                title: self.title
                ,
