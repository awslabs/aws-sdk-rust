...
impl ::std::convert::From<&str> for TableCellImageScalingConfiguration {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => TableCellImageScalingConfiguration::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for TableCellImageScalingConfiguration {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(TableCellImageScalingConfiguration::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for TableCellImageScalingConfiguration {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
