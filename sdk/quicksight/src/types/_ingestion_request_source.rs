...
impl ::std::convert::From<&str> for IngestionRequestSource {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IngestionRequestSource::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IngestionRequestSource {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IngestionRequestSource::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for IngestionRequestSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
