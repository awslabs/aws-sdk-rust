...
impl BarChartVisual {
    ...
    pub fn chart_configuration(
        &self,
    ) -> ::std::option::Option<&crate::types::BarChartConfiguration> {
...
impl BarChartVisualBuilder {
    ...
    pub fn set_chart_configuration(
        mut self,
        input: ::std::option::Option<crate::types::BarChartConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> crate::types::BarChartVisual {
        crate::types::BarChartVisual {
