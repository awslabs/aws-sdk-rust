...
impl AssetBundleExportJobAnalysisOverridePropertiesBuilder {
    ...
    /// <p>A list of <code>Analysis</code> resource properties to generate variables for in the returned CloudFormation template.</p>
    pub fn set_properties(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::AssetBundleExportJobAnalysisPropertyToOverride>>) -> Self {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AssetBundleExportJobAnalysisOverrideProperties, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AssetBundleExportJobAnalysisOverrideProperties {
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building AssetBundleExportJobAnalysisOverrideProperties")
                    )?
                ,
                properties: self.properties
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("properties", "properties was not specified but it is required when building AssetBundleExportJobAnalysisOverrideProperties")
                    )?
                ,
            }
        )
