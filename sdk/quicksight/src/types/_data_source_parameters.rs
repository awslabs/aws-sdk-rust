...
/// <p>The parameters that Quick Sight uses to connect to your underlying data source. This is a variant type structure. For this structure to be valid, only one of the attributes can be non-null.</p>
#[non_exhaustive]
...
pub enum DataSourceParameters {
    ...
    ConfluenceParameters(crate::types::ConfluenceParameters),
    /// <p>The parameters for custom connectors.</p>
    CustomConnectionParameters(crate::types::CustomConnectionParameters),
    ...
    QBusinessParameters(crate::types::QBusinessParameters),
    ...
    WebCrawlerParameters(crate::types::WebCrawlerParameters),
...
impl DataSourceParameters {
    ...
    /// Tries to convert the enum instance into [`ConfluenceParameters`](crate::types::DataSourceParameters::ConfluenceParameters), extracting the inner [`ConfluenceParameters`](crate::types::ConfluenceParameters).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_confluence_parameters(&self) -> ::std::result::Result<&crate::types::ConfluenceParameters, &Self> {
        if let DataSourceParameters::ConfluenceParameters(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`ConfluenceParameters`](crate::types::DataSourceParameters::ConfluenceParameters).
    pub fn is_confluence_parameters(&self) -> bool {
        self.as_confluence_parameters().is_ok()
    }
    /// Tries to convert the enum instance into [`CustomConnectionParameters`](crate::types::DataSourceParameters::CustomConnectionParameters), extracting the inner [`CustomConnectionParameters`](crate::types::CustomConnectionParameters).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_custom_connection_parameters(&self) -> ::std::result::Result<&crate::types::CustomConnectionParameters, &Self> {
        if let DataSourceParameters::CustomConnectionParameters(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`CustomConnectionParameters`](crate::types::DataSourceParameters::CustomConnectionParameters).
    pub fn is_custom_connection_parameters(&self) -> bool {
        self.as_custom_connection_parameters().is_ok()
    }
    ...
    /// Tries to convert the enum instance into [`QBusinessParameters`](crate::types::DataSourceParameters::QBusinessParameters), extracting the inner [`QBusinessParameters`](crate::types::QBusinessParameters).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_q_business_parameters(&self) -> ::std::result::Result<&crate::types::QBusinessParameters, &Self> {
        if let DataSourceParameters::QBusinessParameters(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`QBusinessParameters`](crate::types::DataSourceParameters::QBusinessParameters).
    pub fn is_q_business_parameters(&self) -> bool {
        self.as_q_business_parameters().is_ok()
    }
    ...
    /// Tries to convert the enum instance into [`S3KnowledgeBaseParameters`](crate::types::DataSourceParameters::S3KnowledgeBaseParameters), extracting the inner [`S3KnowledgeBaseParameters`](crate::types::S3KnowledgeBaseParameters).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_s3_knowledge_base_parameters(&self) -> ::std::result::Result<&crate::types::S3KnowledgeBaseParameters, &Self> {
        if let DataSourceParameters::S3KnowledgeBaseParameters(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`S3KnowledgeBaseParameters`](crate::types::DataSourceParameters::S3KnowledgeBaseParameters).
    pub fn is_s3_knowledge_base_parameters(&self) -> bool {
        self.as_s3_knowledge_base_parameters().is_ok()
    }
    ...
    /// Tries to convert the enum instance into [`WebCrawlerParameters`](crate::types::DataSourceParameters::WebCrawlerParameters), extracting the inner [`WebCrawlerParameters`](crate::types::WebCrawlerParameters).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_web_crawler_parameters(&self) -> ::std::result::Result<&crate::types::WebCrawlerParameters, &Self> {
        if let DataSourceParameters::WebCrawlerParameters(val) = &self {
            ::std::result::Result::Ok(val)
        } else {
            ::std::result::Result::Err(self)
        }
    }
    /// Returns true if this is a [`WebCrawlerParameters`](crate::types::DataSourceParameters::WebCrawlerParameters).
    pub fn is_web_crawler_parameters(&self) -> bool {
        self.as_web_crawler_parameters().is_ok()
    }
