...
impl ::std::convert::From<&str> for DayOfTheWeek {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DayOfTheWeek::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DayOfTheWeek {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DayOfTheWeek::from(s))
    }
}
impl DayOfTheWeek {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DayOfTheWeek::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for DayOfTheWeek {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for DayOfTheWeek {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DayOfTheWeek::Friday => write!(f, "FRIDAY"),
            DayOfTheWeek::Monday => write!(f, "MONDAY"),
            DayOfTheWeek::Saturday => write!(f, "SATURDAY"),
            DayOfTheWeek::Sunday => write!(f, "SUNDAY"),
            DayOfTheWeek::Thursday => write!(f, "THURSDAY"),
            DayOfTheWeek::Tuesday => write!(f, "TUESDAY"),
            DayOfTheWeek::Wednesday => write!(f, "WEDNESDAY"),
            DayOfTheWeek::Unknown(value) => write!(f, "{value}"),
        }
    }
}
