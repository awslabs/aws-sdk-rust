...
impl BoxPlotVisual {
    ...
    pub fn chart_configuration(
        &self,
    ) -> ::std::option::Option<&crate::types::BoxPlotChartConfiguration> {
...
impl BoxPlotVisualBuilder {
    ...
    pub fn set_chart_configuration(
        mut self,
        input: ::std::option::Option<crate::types::BoxPlotChartConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> crate::types::BoxPlotVisual {
        crate::types::BoxPlotVisual {
