...
impl TreeMapVisual {
    ...
    pub fn chart_configuration(
        &self,
    ) -> ::std::option::Option<&crate::types::TreeMapConfiguration> {
...
impl TreeMapVisualBuilder {
    ...
    pub fn set_chart_configuration(
        mut self,
        input: ::std::option::Option<crate::types::TreeMapConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> crate::types::TreeMapVisual {
        crate::types::TreeMapVisual {
