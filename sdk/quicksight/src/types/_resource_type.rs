...
/// match resourcetype {
///     ResourceType::AgentHours => { /* ... */ },
///     ResourceType::IndexStorage => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceType {
    fn from(s: &str) -> Self {
        match s {
            "AGENT_HOURS" => ResourceType::AgentHours,
            "INDEX_STORAGE" => ResourceType::IndexStorage,
...
impl ResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceType::AgentHours => "AGENT_HOURS",
            ResourceType::IndexStorage => "INDEX_STORAGE",
            ResourceType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["AGENT_HOURS", "INDEX_STORAGE"]
    }
}
...
impl ::std::fmt::Display for ResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ResourceType::AgentHours => write!(f, "AGENT_HOURS"),
            ResourceType::IndexStorage => write!(f, "INDEX_STORAGE"),
