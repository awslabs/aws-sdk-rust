...
impl ScatterPlotVisual {
    ...
    pub fn chart_configuration(
        &self,
    ) -> ::std::option::Option<&crate::types::ScatterPlotConfiguration> {
...
impl ScatterPlotVisualBuilder {
    ...
    pub fn set_chart_configuration(
        mut self,
        input: ::std::option::Option<crate::types::ScatterPlotConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> crate::types::ScatterPlotVisual {
        crate::types::ScatterPlotVisual {
