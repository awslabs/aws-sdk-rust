...
pub struct GridLayoutScreenCanvasSizeOptions {
    ...
    /// <ul>
    /// <li>
    /// <p><code>FIXED</code>: A fixed width will be used when optimizing the layout. In the Quick Sight console, this option is called <code>Classic</code>.</p></li>
    /// <li>
    /// <p><code>RESPONSIVE</code>: The width of the canvas will be responsive and optimized to the view port. In the Quick Sight console, this option is called <code>Tiled</code>.</p></li>
    /// </ul>
