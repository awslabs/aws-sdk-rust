...
impl ::std::convert::From<&str> for NumericEqualityMatchOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => NumericEqualityMatchOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for NumericEqualityMatchOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(NumericEqualityMatchOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for NumericEqualityMatchOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
