...
impl AssetBundleImportJobDataSetOverridePermissionsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AssetBundleImportJobDataSetOverridePermissions, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AssetBundleImportJobDataSetOverridePermissions {
                data_set_ids: self.data_set_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("data_set_ids", "data_set_ids was not specified but it is required when building AssetBundleImportJobDataSetOverridePermissions")
                    )?
                ,
