...
pub struct HeatMapVisual  {
    ...
    pub chart_configuration: ::std::option::Option<crate::types::HeatMapConfiguration>,
...
impl  HeatMapVisual  {
    ...
    /// <p>The configuration of a heat map.</p>
    pub fn chart_configuration(&self) -> ::std::option::Option<& crate::types::HeatMapConfiguration> {
...
impl HeatMapVisual {
    /// Creates a new builder-style object to manufacture [`HeatMapVisual`](crate::types::HeatMapVisual).
    pub fn builder() -> crate::types::builders::HeatMapVisualBuilder {
        crate::types::builders::HeatMapVisualBuilder::default()
    }
}

/// A builder for [`HeatMapVisual`](crate::types::HeatMapVisual).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct HeatMapVisualBuilder {
    ...
    pub(crate) chart_configuration: ::std::option::Option<crate::types::HeatMapConfiguration>,
...
impl HeatMapVisualBuilder {
    ...
    /// <p>The configuration of a heat map.</p>
    pub fn chart_configuration(mut self, input: crate::types::HeatMapConfiguration) -> Self {
        self.chart_configuration = ::std::option::Option::Some(input);
        self
    }
    /// <p>The configuration of a heat map.</p>
    pub fn set_chart_configuration(mut self, input: ::std::option::Option<crate::types::HeatMapConfiguration>) -> Self {
        self.chart_configuration = input; self
    }
    /// <p>The configuration of a heat map.</p>
    pub fn get_chart_configuration(&self) -> &::std::option::Option<crate::types::HeatMapConfiguration> {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::HeatMapVisual, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::HeatMapVisual {
                visual_id: self.visual_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("visual_id", "visual_id was not specified but it is required when building HeatMapVisual")
                    )?
                ,
                title: self.title
                ,
