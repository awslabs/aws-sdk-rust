...
impl ValidationStrategyBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ValidationStrategy, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ValidationStrategy {
                mode: self.mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("mode", "mode was not specified but it is required when building ValidationStrategy")
                    )?
                ,
            }
        )
