...
impl AssetBundleExportJobDashboardOverridePropertiesBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AssetBundleExportJobDashboardOverrideProperties, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AssetBundleExportJobDashboardOverrideProperties {
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building AssetBundleExportJobDashboardOverrideProperties")
                    )?
                ,
                properties: self.properties
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("properties", "properties was not specified but it is required when building AssetBundleExportJobDashboardOverrideProperties")
                    )?
                ,
            }
        )
