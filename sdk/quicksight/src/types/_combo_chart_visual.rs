...
impl ComboChartVisual {
    ...
    pub fn chart_configuration(
        &self,
    ) -> ::std::option::Option<&crate::types::ComboChartConfiguration> {
...
impl ComboChartVisualBuilder {
    ...
    pub fn set_chart_configuration(
        mut self,
        input: ::std::option::Option<crate::types::ComboChartConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> crate::types::ComboChartVisual {
        crate::types::ComboChartVisual {
