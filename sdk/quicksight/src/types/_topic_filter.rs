...
impl TopicFilterBuilder {
    /// <p>A description of the filter used to select items for a topic.</p>
    pub fn filter_description(mut self, input: impl Into<std::string::String>) -> Self {
        self.filter_description = Some(input.into());
        self
    }
    /// <p>A description of the filter used to select items for a topic.</p>
    ...
    ///
    /// <p>The other names or aliases for the filter.</p>
    pub fn filter_synonyms(mut self, input: impl Into<std::string::String>) -> Self {
        let mut v = self.filter_synonyms.unwrap_or_default();
        v.push(input.into());
        self.filter_synonyms = Some(v);
        self
    }
    /// <p>The other names or aliases for the filter.</p>
    ...
    /// <p>The name of the field that the filter operates on.</p>
    pub fn operand_field_name(mut self, input: impl Into<std::string::String>) -> Self {
        self.operand_field_name = Some(input.into());
        self
    }
    /// <p>The name of the field that the filter operates on.</p>
    ...
    pub fn relative_date_filter(mut self, input: crate::types::TopicRelativeDateFilter) -> Self {
        self.relative_date_filter = Some(input);
        self
    }
    /// <p>The relative date filter.</p>
