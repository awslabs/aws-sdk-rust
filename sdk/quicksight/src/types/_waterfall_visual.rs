...
impl WaterfallVisual {
    ...
    pub fn chart_configuration(
        &self,
    ) -> ::std::option::Option<&crate::types::WaterfallChartConfiguration> {
...
impl WaterfallVisualBuilder {
    ...
    pub fn set_chart_configuration(
        mut self,
        input: ::std::option::Option<crate::types::WaterfallChartConfiguration>,
    ) -> Self {
    ...
    pub fn build(self) -> crate::types::WaterfallVisual {
        crate::types::WaterfallVisual {
