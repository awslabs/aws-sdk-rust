...
impl TopicCalculatedFieldBuilder {
    /// <p>The calculated field name.</p>
    pub fn calculated_field_name(mut self, input: impl Into<std::string::String>) -> Self {
        self.calculated_field_name = Some(input.into());
        self
    }
    /// <p>The calculated field name.</p>
    pub fn set_calculated_field_name(
        mut self,
    ...
    /// <p>The calculated field description.</p>
    pub fn calculated_field_description(mut self, input: impl Into<std::string::String>) -> Self {
        self.calculated_field_description = Some(input.into());
        self
    }
    /// <p>The calculated field description.</p>
    pub fn set_calculated_field_description(
        mut self,
        input: std::option::Option<std::string::String>,
    ) -> Self {
    ...
    ///
    /// <p>The other names or aliases for the calculated field.</p>
    pub fn calculated_field_synonyms(mut self, input: impl Into<std::string::String>) -> Self {
        let mut v = self.calculated_field_synonyms.unwrap_or_default();
        v.push(input.into());
        self.calculated_field_synonyms = Some(v);
        self
    }
    /// <p>The other names or aliases for the calculated field.</p>
    pub fn set_calculated_field_synonyms(
        mut self,
