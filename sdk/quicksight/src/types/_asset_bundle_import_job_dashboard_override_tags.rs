...
impl AssetBundleImportJobDashboardOverrideTagsBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AssetBundleImportJobDashboardOverrideTags, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AssetBundleImportJobDashboardOverrideTags {
                dashboard_ids: self.dashboard_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_ids", "dashboard_ids was not specified but it is required when building AssetBundleImportJobDashboardOverrideTags")
                    )?
                ,
                tags: self.tags
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("tags", "tags was not specified but it is required when building AssetBundleImportJobDashboardOverrideTags")
                    )?
                ,
            }
        )
