...
impl  ProjectOperation  {
    ...
    pub fn projected_columns(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.projected_columns.deref()
    }
}
impl ProjectOperation {
        ...
        ::std::result::Result::Ok(
            crate::types::ProjectOperation {
                projected_columns: self.projected_columns
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("projected_columns", "projected_columns was not specified but it is required when building ProjectOperation")
                    )?
                ,
            }
        )
