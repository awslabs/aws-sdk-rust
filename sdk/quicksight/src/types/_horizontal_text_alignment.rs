...
impl ::std::convert::From<&str> for HorizontalTextAlignment {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => HorizontalTextAlignment::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for HorizontalTextAlignment {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(HorizontalTextAlignment::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for HorizontalTextAlignment {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
