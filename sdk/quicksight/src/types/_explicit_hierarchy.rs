        ...
        ::std::result::Result::Ok(
            crate::types::ExplicitHierarchy {
                hierarchy_id: self.hierarchy_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("hierarchy_id", "hierarchy_id was not specified but it is required when building ExplicitHierarchy")
                    )?
                ,
                columns: self.columns
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("columns", "columns was not specified but it is required when building ExplicitHierarchy")
                    )?
                ,
