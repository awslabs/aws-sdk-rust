...
pub fn serialize_operation_crate_operation_create_account_subscription(
    input: &crate::input::CreateAccountSubscriptionInput,
) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_crate_input_create_account_subscription_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn serialize_operation_crate_operation_search_data_sets(
...
pub fn serialize_operation_crate_operation_search_data_sources(
