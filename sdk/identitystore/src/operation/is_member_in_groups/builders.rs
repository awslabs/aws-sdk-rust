...
impl IsMemberInGroupsFluentBuilder  {
    /// Creates a new `IsMemberInGroups`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::is_member_in_groups::IsMemberInGroupsOutput, aws_smithy_http::result::SdkError<crate::operation::is_member_in_groups::IsMemberInGroupsError>>
                     {
