...
impl IsMemberInGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::is_member_in_groups::IsMemberInGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::is_member_in_groups::IsMemberInGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::is_member_in_groups::IsMemberInGroupsOutput, crate::operation::is_member_in_groups::IsMemberInGroupsError, Self> {
