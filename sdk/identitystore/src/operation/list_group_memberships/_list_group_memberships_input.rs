...
impl ListGroupMembershipsInputBuilder {
    ...
    /// - [`identity_store_id`](crate::operation::list_group_memberships::builders::ListGroupMembershipsInputBuilder::identity_store_id)
    /// - [`group_id`](crate::operation::list_group_memberships::builders::ListGroupMembershipsInputBuilder::group_id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_group_memberships::ListGroupMembershipsInput {
            identity_store_id: self.identity_store_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "identity_store_id",
                    "identity_store_id was not specified but it is required when building ListGroupMembershipsInput",
                )
            })?,
            group_id: self.group_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "group_id",
                    "group_id was not specified but it is required when building ListGroupMembershipsInput",
                )
            })?,
