...
impl ListGroupMembershipsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_group_memberships::ListGroupMembershipsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_group_memberships::ListGroupMembershipsOutput {
                group_memberships: self.group_memberships
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("group_memberships", "group_memberships was not specified but it is required when building ListGroupMembershipsOutput")
                    )?
                ,
