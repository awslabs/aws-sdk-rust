...
impl UpdateUser {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("identitystore", "UpdateUser", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "identitystore.UpdateUser",
                "rpc.service" = "identitystore",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("IdentityStoreId") {
            if let ::std::option::Option::Some(value) = input.identity_store_id.as_deref() {
                captured.insert("IdentityStoreId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_user::de_update_user_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_user::de_update_user_http_response(status, headers, body, _cfg)
        };
