...
impl GetGroupMembershipIdFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_group_membership_id::GetGroupMembershipIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_group_membership_id::GetGroupMembershipIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_group_membership_id::GetGroupMembershipIdOutput, crate::operation::get_group_membership_id::GetGroupMembershipIdError, Self> {
