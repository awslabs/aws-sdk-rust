...
impl GetGroupIdFluentBuilder  {
    /// Creates a new `GetGroupId`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_group_id::GetGroupIdOutput, aws_smithy_http::result::SdkError<crate::operation::get_group_id::GetGroupIdError>>
                     {
