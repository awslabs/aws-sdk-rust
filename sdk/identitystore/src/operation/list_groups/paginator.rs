...
impl ListGroupsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Group, ::aws_smithy_http::result::SdkError<crate::operation::list_groups::ListGroupsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_groups_output_groups(page).unwrap_or_default().into_iter())
    }
}
