...
impl GetGroupIdInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_group_id::GetGroupId, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_group_id::ser_get_group_id_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupId {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_group_id::de_get_group_id_http_response_with_props(status, headers, body)
        }
    }
}
