...
impl ListGroupMembershipsForMemberInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_group_memberships_for_member::ListGroupMembershipsForMember::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroupMembershipsForMember {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_group_memberships_for_member::de_list_group_memberships_for_member_http_response_with_props(
                status, headers, body,
            )
        }
    }
