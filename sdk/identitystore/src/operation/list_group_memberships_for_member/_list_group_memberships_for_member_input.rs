...
impl ListGroupMembershipsForMemberInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_group_memberships_for_member::ListGroupMembershipsForMemberInput, ::aws_smithy_types::error::operation::BuildError> {
