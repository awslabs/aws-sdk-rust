...
impl ListGroupMembershipsForMemberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_group_memberships_for_member::ListGroupMembershipsForMemberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_group_memberships_for_member::ListGroupMembershipsForMemberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_group_memberships_for_member::ListGroupMembershipsForMemberOutput, crate::operation::list_group_memberships_for_member::ListGroupMembershipsForMemberError, Self> {
