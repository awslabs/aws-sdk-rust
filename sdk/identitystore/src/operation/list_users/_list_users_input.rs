...
impl ListUsersInputBuilder {
    ...
    /// - [`identity_store_id`](crate::operation::list_users::builders::ListUsersInputBuilder::identity_store_id)
        ...
        ::std::result::Result::Ok(crate::operation::list_users::ListUsersInput {
            identity_store_id: self.identity_store_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "identity_store_id",
                    "identity_store_id was not specified but it is required when building ListUsersInput",
                )
            })?,
