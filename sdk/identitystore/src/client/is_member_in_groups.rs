...
impl super::Client {
    ...
    ///   - [`group_ids(impl Into<String>)`](crate::operation::is_member_in_groups::builders::IsMemberInGroupsFluentBuilder::group_ids) / [`set_group_ids(Option<Vec<String>>)`](crate::operation::is_member_in_groups::builders::IsMemberInGroupsFluentBuilder::set_group_ids): <p>A list of identifiers for groups in the identity store.</p>
