...
impl super::Client {
    ...
    ///   - [`identity_store_id(impl Into<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::identity_store_id) / [`set_identity_store_id(impl Into<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::set_identity_store_id):<br>required: **true**<br><p>The globally unique identifier for the identity store.</p><br>
    ///   - [`group_id(impl Into<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::group_id) / [`set_group_id(impl Into<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::set_group_id):<br>required: **true**<br><p>The identifier for a group in the identity store.</p><br>
