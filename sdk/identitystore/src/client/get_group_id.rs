...
impl super::Client {
    ...
    ///   - [`identity_store_id(impl ::std::convert::Into<String>)`](crate::operation::get_group_id::builders::GetGroupIdFluentBuilder::identity_store_id) / [`set_identity_store_id(Option<String>)`](crate::operation::get_group_id::builders::GetGroupIdFluentBuilder::set_identity_store_id): <p>The globally unique identifier for the identity store.</p>
