...
impl super::Client {
    ...
    ///   - [`identity_store_id(impl Into<String>)`](crate::operation::get_group_id::builders::GetGroupIdFluentBuilder::identity_store_id) / [`set_identity_store_id(impl Into<String>)`](crate::operation::get_group_id::builders::GetGroupIdFluentBuilder::set_identity_store_id):<br>required: **true**<br><p>The globally unique identifier for the identity store.</p><br>
