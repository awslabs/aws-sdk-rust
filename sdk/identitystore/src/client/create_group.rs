...
impl super::Client  {
    ...
    ///   - [`display_name(impl Into<String>)`](crate::operation::create_group::builders::CreateGroupFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::create_group::builders::CreateGroupFluentBuilder::set_display_name): <p>A string containing the name of the group. This value is commonly displayed when the group is referenced. "Administrator" and "AWSAdministrators" are reserved names and can't be used for users or groups.</p>
