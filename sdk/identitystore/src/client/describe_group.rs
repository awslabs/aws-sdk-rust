...
impl super::Client {
    ...
    ///   - [`identity_store_id(impl Into<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::identity_store_id) / [`set_identity_store_id(Option<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::set_identity_store_id):<br>required: **true**<br><p>The globally unique identifier for the identity store, such as <code>d-1234567890</code>. In this example, <code>d-</code> is a fixed prefix, and <code>1234567890</code> is a randomly generated string that contains numbers and lower case letters. This value is generated at the time that a new identity store is created.</p><br>
    ///   - [`group_id(impl Into<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::describe_group::builders::DescribeGroupFluentBuilder::set_group_id):<br>required: **true**<br><p>The identifier for a group in the identity store.</p><br>
