...
impl super::Client {
    ...
    ///   - [`identity_store_id(impl ::std::convert::Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::identity_store_id) / [`set_identity_store_id(Option<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_identity_store_id): <p>The globally unique identifier for the identity store.</p>
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_group_id): <p>The identifier for a group in the identity store.</p>
