...
impl super::Client {
    ...
    ///   - [`identity_store_id(impl Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::identity_store_id) / [`set_identity_store_id(impl Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_identity_store_id):<br>required: **true**<br><p>The globally unique identifier for the identity store.</p><br>
    ///   - [`group_id(impl Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::group_id) / [`set_group_id(impl Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_group_id):<br>required: **true**<br><p>The identifier for a group in the identity store.</p><br>
