...
pub struct Address  {
    ...
    #[doc(hidden)]pub street_address: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub formatted: std::option::Option<std::string::String>,
...
pub struct Name  {
    ...
    #[doc(hidden)]pub family_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub honorific_prefix: std::option::Option<std::string::String>,
    /// <p>The honorific suffix of the user. For example, "M.D."</p>
    #[doc(hidden)]pub honorific_suffix: std::option::Option<std::string::String>,
}
impl Name {
    /// <p>A string containing a formatted version of the name for display.</p>
    pub fn formatted(&self) -> std::option::Option<& str> {
...
pub struct Filter  {
    ...
    #[doc(hidden)]pub attribute_path: std::option::Option<std::string::String>,
...
pub struct AttributeOperation  {
    ...
    #[doc(hidden)]pub attribute_value: std::option::Option<aws_smithy_types::Document>,
}
...
impl MemberId {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`UserId`](crate::model::MemberId::UserId), extracting the inner [`String`](std::string::String).
...
pub struct GroupMembershipExistenceResult  {
    ...
    #[doc(hidden)]pub membership_exists: bool,
}
