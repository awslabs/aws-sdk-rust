...
pub fn ser_get_group_id_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetGroupIdInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
