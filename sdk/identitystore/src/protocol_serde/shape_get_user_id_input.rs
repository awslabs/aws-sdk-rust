...
pub fn ser_get_user_id_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetUserIdInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
