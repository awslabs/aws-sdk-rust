...
pub fn ser_is_member_in_groups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::IsMemberInGroupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
