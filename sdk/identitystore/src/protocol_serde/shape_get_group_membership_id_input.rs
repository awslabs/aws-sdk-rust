...
pub fn ser_get_group_membership_id_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_group_membership_id::GetGroupMembershipIdInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
