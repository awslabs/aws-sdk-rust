...
pub fn ser_delete_group_membership_input(
    ...
    crate::protocol_serde::shape_delete_group_membership_input::ser_delete_group_membership_input(
        &mut object,
        input,
    )?;
    object.finish();
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_group_membership::DeleteGroupMembershipError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_validation_exception::de_validation_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_group_membership::DeleteGroupMembershipError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_server_exception::de_internal_server_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::delete_group_membership::DeleteGroupMembershipError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
