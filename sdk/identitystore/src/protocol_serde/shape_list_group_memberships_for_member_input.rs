...
pub fn ser_list_group_memberships_for_member_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListGroupMembershipsForMemberInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
