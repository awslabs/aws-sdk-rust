...
pub fn ser_alternate_identifier(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AlternateIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
