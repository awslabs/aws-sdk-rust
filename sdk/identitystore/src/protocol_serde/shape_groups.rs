...
pub(crate) fn de_groups<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Group>>, aws_smithy_json::deserialize::error::DeserializeError>
