...
///     ResourceNotFoundExceptionReason::KmsKeyNotFound => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceNotFoundExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "KMS_KEY_NOT_FOUND" => ResourceNotFoundExceptionReason::KmsKeyNotFound,
...
impl ResourceNotFoundExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ResourceNotFoundExceptionReason::KmsKeyNotFound => "KMS_KEY_NOT_FOUND",
...
impl ::std::fmt::Display for ResourceNotFoundExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ResourceNotFoundExceptionReason::KmsKeyNotFound => write!(f, "KMS_KEY_NOT_FOUND"),
