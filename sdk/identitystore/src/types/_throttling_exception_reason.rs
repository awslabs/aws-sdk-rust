...
///     ThrottlingExceptionReason::KmsThrottling => { /* ... */ },
...
impl ::std::convert::From<&str> for ThrottlingExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            "KMS_THROTTLING" => ThrottlingExceptionReason::KmsThrottling,
...
impl ThrottlingExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ThrottlingExceptionReason::KmsThrottling => "KMS_THROTTLING",
...
impl ::std::fmt::Display for ThrottlingExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ThrottlingExceptionReason::KmsThrottling => write!(f, "KMS_THROTTLING"),
