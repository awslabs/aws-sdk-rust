...
pub struct DescribeUserOutput  {
    ...
    #[doc(hidden)]pub external_ids: std::option::Option<std::vec::Vec<crate::model::ExternalId>>,
...
pub struct ListGroupMembershipsOutput  {
    ...
    #[doc(hidden)]pub group_memberships: std::option::Option<std::vec::Vec<crate::model::GroupMembership>>,
...
impl  std::fmt::Debug for ListGroupMembershipsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("group_memberships", &self.group_memberships);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for ListGroupMembershipsForMemberOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("ListGroupMembershipsForMemberOutput");
        formatter.field("group_memberships", &self.group_memberships);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
...
pub struct IsMemberInGroupsOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::GroupMembershipExistenceResult>>,
}
...
impl  std::fmt::Debug for IsMemberInGroupsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("IsMemberInGroupsOutput");
...
impl  std::fmt::Debug for GetUserIdOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetUserIdOutput");
        formatter.field("user_id", &self.user_id);
        formatter.field("identity_store_id", &self.identity_store_id);
        formatter.finish()
    }
...
impl  std::fmt::Debug for GetGroupMembershipIdOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetGroupMembershipIdOutput");
        formatter.field("membership_id", &self.membership_id);
        formatter.field("identity_store_id", &self.identity_store_id);
        formatter.finish()
    }
...
impl  std::fmt::Debug for GetGroupIdOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("GetGroupIdOutput");
        formatter.field("group_id", &self.group_id);
        formatter.field("identity_store_id", &self.identity_store_id);
        formatter.finish()
    }
