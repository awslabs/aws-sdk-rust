...
impl GetShardIterator {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("KeyspacesStreams", "GetShardIterator", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "KeyspacesStreams.GetShardIterator",
                "rpc.service" = "KeyspacesStreams",
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetShardIteratorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("sequenceNumber") {
            if let ::std::option::Option::Some(value) = input.sequence_number.as_deref() {
                captured.insert("sequenceNumber", value);
            }
        }
...
impl GetShardIteratorError {
    ...
    /// Returns `true` if the error kind is `GetShardIteratorError::InternalServerException`.
    ...
    /// Returns `true` if the error kind is `GetShardIteratorError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GetShardIteratorError::ValidationException`.
