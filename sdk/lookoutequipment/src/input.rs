...
impl CreateInferenceSchedulerInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_create_inference_scheduler(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
pub mod create_model_input {
    ...
    pub struct Builder {
        ...
        pub(crate) client_token: std::option::Option<std::string::String>,
        pub(crate) training_data_start_time: std::option::Option<smithy_types::Instant>,
        pub(crate) training_data_end_time: std::option::Option<smithy_types::Instant>,
        pub(crate) evaluation_data_start_time: std::option::Option<smithy_types::Instant>,
        pub(crate) evaluation_data_end_time: std::option::Option<smithy_types::Instant>,
        pub(crate) role_arn: std::option::Option<std::string::String>,
...
impl DeleteInferenceSchedulerInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_delete_inference_scheduler(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
impl DescribeDataIngestionJobInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_describe_data_ingestion_job(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
impl DescribeInferenceSchedulerInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_describe_inference_scheduler(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
pub mod list_inference_executions_input {
    ...
    pub struct Builder {
        ...
        pub(crate) max_results: std::option::Option<i32>,
        pub(crate) inference_scheduler_name: std::option::Option<std::string::String>,
        pub(crate) data_start_time_after: std::option::Option<smithy_types::Instant>,
        pub(crate) data_end_time_before: std::option::Option<smithy_types::Instant>,
...
impl ListInferenceExecutionsInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_list_inference_executions(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
impl ListInferenceSchedulersInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_list_inference_schedulers(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
impl StartInferenceSchedulerInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_start_inference_scheduler(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
impl UpdateInferenceSchedulerInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_update_inference_scheduler(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            let mut request = smithy_http::operation::Request::from_parts(
...
pub struct ListInferenceExecutionsInput {
    ...
    /// <p>The time reference in the inferenced dataset after which Amazon Lookout for Equipment started the
    /// inference execution. </p>
    pub data_start_time_after: std::option::Option<smithy_types::Instant>,
    /// <p>The time reference in the inferenced dataset before which Amazon Lookout for Equipment stopped the
    /// inference execution. </p>
    pub data_end_time_before: std::option::Option<smithy_types::Instant>,
    /// <p>The status of the inference execution. </p>
...
pub struct CreateModelInput {
    ...
    /// <p>Indicates the time reference in the dataset that should be used to begin the subset of
    /// training data for the ML model. </p>
    pub training_data_start_time: std::option::Option<smithy_types::Instant>,
    /// <p>Indicates the time reference in the dataset that should be used to end the subset of
    /// training data for the ML model. </p>
    pub training_data_end_time: std::option::Option<smithy_types::Instant>,
    /// <p>Indicates the time reference in the dataset that should be used to begin the subset of
    /// evaluation data for the ML model. </p>
    pub evaluation_data_start_time: std::option::Option<smithy_types::Instant>,
    /// <p> Indicates the time reference in the dataset that should be used to end the subset of
    /// evaluation data for the ML model. </p>
    pub evaluation_data_end_time: std::option::Option<smithy_types::Instant>,
    /// <p> The Amazon Resource Name (ARN) of a role with permission to access the data source
    /// being used to create the ML model. </p>
    pub role_arn: std::option::Option<std::string::String>,
    /// <p>The configuration is the <code>TargetSamplingRate</code>, which is the sampling rate of
