...
pub fn serialize_operation_create_inference_scheduler(
    input: &crate::input::CreateInferenceSchedulerInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_create_inference_scheduler_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_delete_inference_scheduler(
    input: &crate::input::DeleteInferenceSchedulerInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_delete_inference_scheduler_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_describe_data_ingestion_job(
    input: &crate::input::DescribeDataIngestionJobInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_describe_data_ingestion_job_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_describe_inference_scheduler(
    input: &crate::input::DescribeInferenceSchedulerInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_describe_inference_scheduler_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_list_data_ingestion_jobs(
    input: &crate::input::ListDataIngestionJobsInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_list_data_ingestion_jobs_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_list_inference_executions(
    input: &crate::input::ListInferenceExecutionsInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_list_inference_executions_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_list_inference_schedulers(
    input: &crate::input::ListInferenceSchedulersInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_list_inference_schedulers_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_start_data_ingestion_job(
    input: &crate::input::StartDataIngestionJobInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_start_data_ingestion_job_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_start_inference_scheduler(
    input: &crate::input::StartInferenceSchedulerInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_start_inference_scheduler_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_stop_inference_scheduler(
    input: &crate::input::StopInferenceSchedulerInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_stop_inference_scheduler_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_update_inference_scheduler(
    input: &crate::input::UpdateInferenceSchedulerInput,
) -> Result<smithy_http::body::SdkBody, smithy_types::Error> {
    let mut out = String::new();
    let mut object = smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::json_ser::serialize_structure_update_inference_scheduler_input(&mut object, input);
    object.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}
