    ...
    pub fn build(self) -> ::std::result::Result<crate::types::InferenceS3OutputConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::InferenceS3OutputConfiguration {
                bucket: self.bucket
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("bucket", "bucket was not specified but it is required when building InferenceS3OutputConfiguration")
                    )?
                ,
                prefix: self.prefix
                ,
