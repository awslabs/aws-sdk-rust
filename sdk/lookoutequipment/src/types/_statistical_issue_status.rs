...
impl ::std::convert::From<&str> for StatisticalIssueStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StatisticalIssueStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StatisticalIssueStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StatisticalIssueStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StatisticalIssueStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
