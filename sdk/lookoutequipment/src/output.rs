...
pub struct DescribeModelOutput {
    ...
    pub training_execution_start_time: std::option::Option<smithy_types::Instant>,
    /// <p>Indicates the time at which the training of the ML model was completed. </p>
    pub training_execution_end_time: std::option::Option<smithy_types::Instant>,
...
pub mod describe_model_output {
    ...
    pub struct Builder {
        ...
        pub(crate) training_execution_start_time: std::option::Option<smithy_types::Instant>,
        pub(crate) training_execution_end_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>Indicates the time at which the training of the ML model began. </p>
        pub fn training_execution_start_time(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// <p>Indicates the time at which the training of the ML model was completed. </p>
        pub fn training_execution_end_time(mut self, input: smithy_types::Instant) -> Self {
