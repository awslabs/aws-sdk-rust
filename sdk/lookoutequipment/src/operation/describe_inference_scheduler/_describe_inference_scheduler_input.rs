...
impl DescribeInferenceSchedulerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_inference_scheduler::DescribeInferenceSchedulerInput, ::aws_smithy_types::error::operation::BuildError> {
