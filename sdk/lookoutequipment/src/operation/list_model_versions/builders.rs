...
impl ListModelVersionsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_model_versions::ListModelVersionsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_model_versions::paginator::ListModelVersionsPaginator::send) which returns a `Stream`.
