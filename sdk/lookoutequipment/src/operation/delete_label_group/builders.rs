...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_label_group::DeleteLabelGroupOutput,
                    crate::operation::delete_label_group::DeleteLabelGroupError,
                > for DeleteLabelGroupFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteLabelGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_label_group::DeleteLabelGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_label_group::DeleteLabelGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_label_group::DeleteLabelGroupOutput, crate::operation::delete_label_group::DeleteLabelGroupError, Self> {
