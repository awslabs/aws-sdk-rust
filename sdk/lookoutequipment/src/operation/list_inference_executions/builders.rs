...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_inference_executions::ListInferenceExecutionsOutput,
                    crate::operation::list_inference_executions::ListInferenceExecutionsError,
                > for ListInferenceExecutionsFluentBuilder
            {
                fn send(
                    self,
...
impl ListInferenceExecutionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_inference_executions::ListInferenceExecutionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_inference_executions::ListInferenceExecutionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_inference_executions::ListInferenceExecutions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_inference_executions::ListInferenceExecutionsOutput, crate::operation::list_inference_executions::ListInferenceExecutionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_inference_executions::paginator::ListInferenceExecutionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
