...
impl DescribeLabelGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_label_group::ser_describe_label_group_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_label_group::DescribeLabelGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLabelGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_label_group::de_describe_label_group_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_label_group::DescribeLabelGroupError
{
