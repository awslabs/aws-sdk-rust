...
impl ListInferenceEventsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_inference_events::ListInferenceEventsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_inference_events::ListInferenceEventsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_inference_events::ListInferenceEventsOutput, crate::operation::list_inference_events::ListInferenceEventsError, Self> {
