...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeResourcePolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeResourcePolicy", "lookoutequipment"));
...
impl DescribeResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DescribeResourcePolicyError::ValidationException`.
