...
impl StartInferenceSchedulerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_inference_scheduler::StartInferenceSchedulerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_inference_scheduler::StartInferenceSchedulerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_inference_scheduler::StartInferenceSchedulerOutput, crate::operation::start_inference_scheduler::StartInferenceSchedulerError, Self> {
