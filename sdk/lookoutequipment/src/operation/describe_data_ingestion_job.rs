...
impl DescribeDataIngestionJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_data_ingestion_job::DescribeDataIngestionJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataIngestionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_ingestion_job::de_describe_data_ingestion_job_http_response_with_props(status, headers, body)
        }
    }
}
