...
impl DeleteInferenceSchedulerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerOutput, crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerError, Self> {
