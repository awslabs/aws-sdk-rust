...
impl DeleteLabelGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_label_group::DeleteLabelGroup,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_label_group::ser_delete_label_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLabelGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_label_group::de_delete_label_group_http_response_with_props(status, headers, body)
        }
    }
}
