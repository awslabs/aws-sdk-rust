...
impl DescribeLabelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_label::DescribeLabel,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_label::DescribeLabel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLabel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_label::de_describe_label_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_label::de_describe_label_http_response_with_props(
                status, headers, body,
            )
        }
    }
