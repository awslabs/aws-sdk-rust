...
impl UpdateRetrainingSchedulerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_retraining_scheduler::UpdateRetrainingSchedulerInput, ::aws_smithy_types::error::operation::BuildError> {
