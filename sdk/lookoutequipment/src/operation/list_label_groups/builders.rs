...
impl ListLabelGroupsFluentBuilder  {
    /// Creates a new `ListLabelGroups`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_label_groups::ListLabelGroupsOutput, aws_smithy_http::result::SdkError<crate::operation::list_label_groups::ListLabelGroupsError>>
                     {
