...
impl CreateModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_model::CreateModel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_model::ser_create_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_model::de_create_model_http_response_with_props(status, headers, body)
        }
    }
}
