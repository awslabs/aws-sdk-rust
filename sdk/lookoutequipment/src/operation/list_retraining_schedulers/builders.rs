...
impl ListRetrainingSchedulersFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_retraining_schedulers::paginator::ListRetrainingSchedulersPaginator::send) which returns a `Stream`.
