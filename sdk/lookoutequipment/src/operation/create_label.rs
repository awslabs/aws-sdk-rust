...
impl CreateLabelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_label::CreateLabel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLabel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_label::de_create_label_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_label::de_create_label_http_response_with_props(
                status, headers, body,
            )
        }
    }
