...
impl CreateLabelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_label::CreateLabel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_label::ser_create_label_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLabel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_label::de_create_label_http_response_with_props(status, headers, body)
        }
    }
}
