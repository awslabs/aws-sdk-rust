...
pub(crate) fn de_inference_scheduler_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InferenceSchedulerSummary>, aws_smithy_json::deserialize::error::DeserializeError>
