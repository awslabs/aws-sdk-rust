...
pub(crate) fn de_data_ingestion_job_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataIngestionJobSummary>, aws_smithy_json::deserialize::error::DeserializeError>
