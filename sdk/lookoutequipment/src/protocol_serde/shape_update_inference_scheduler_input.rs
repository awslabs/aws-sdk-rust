...
pub fn ser_update_inference_scheduler_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateInferenceSchedulerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
