...
pub fn ser_list_inference_schedulers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListInferenceSchedulersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
