...
pub(crate) fn de_inference_execution_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InferenceExecutionSummary>, aws_smithy_json::deserialize::error::DeserializeError>
