...
pub(crate) fn de_sensor_statistics_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SensorStatisticsSummary>, aws_smithy_json::deserialize::error::DeserializeError>
