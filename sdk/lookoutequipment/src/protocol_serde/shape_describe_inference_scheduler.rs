...
> {
    ...
    .map_err(
        crate::operation::describe_inference_scheduler::DescribeInferenceSchedulerError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_inference_scheduler_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "DataUploadFrequency" => {
                        builder = builder.set_data_upload_frequency(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::DataUploadFrequency::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
                    ...
                    "LatestInferenceResult" => {
                        builder = builder.set_latest_inference_result(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::LatestInferenceResult::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
