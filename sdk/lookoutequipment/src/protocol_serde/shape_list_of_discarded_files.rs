...
pub(crate) fn de_list_of_discarded_files<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::S3Object>>, aws_smithy_json::deserialize::error::DeserializeError>
