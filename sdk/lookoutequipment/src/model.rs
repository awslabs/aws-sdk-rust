...
pub struct InferenceOutputConfiguration  {
    ...
    #[doc(hidden)]pub s3_output_configuration: std::option::Option<crate::model::InferenceS3OutputConfiguration>,
...
pub struct InferenceInputConfiguration  {
    /// <p> Specifies configuration information for the input data for the inference, including Amazon S3 location of input data.</p>
    #[doc(hidden)]pub s3_input_configuration: std::option::Option<crate::model::InferenceS3InputConfiguration>,
    /// <p>Indicates the difference between your time zone and Coordinated Universal Time (UTC).</p>
    #[doc(hidden)]pub input_time_zone_offset: std::option::Option<std::string::String>,
    /// <p>Specifies configuration information for the input data for the inference, including timestamp format and delimiter. </p>
    #[doc(hidden)]pub inference_input_name_configuration: std::option::Option<crate::model::InferenceInputNameConfiguration>,
}
...
impl  std::fmt::Debug for InferenceInputConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("inference_input_name_configuration", &self.inference_input_name_configuration);
        formatter.finish()
    }
}
...
pub struct InferenceInputNameConfiguration  {
    ...
    #[doc(hidden)]pub component_timestamp_delimiter: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for InferenceInputNameConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("component_timestamp_delimiter", &self.component_timestamp_delimiter);
        formatter.finish()
    }
}
...
pub struct IngestionInputConfiguration  {
    ...
    #[doc(hidden)]pub s3_input_configuration: std::option::Option<crate::model::IngestionS3InputConfiguration>,
}
...
pub struct IngestionS3InputConfiguration  {
    ...
    #[doc(hidden)]pub key_pattern: std::option::Option<std::string::String>,
}
...
pub struct SensorStatisticsSummary  {
    ...
    #[doc(hidden)]pub sensor_name: std::option::Option<std::string::String>,
    /// <p> Parameter that indicates whether data exists for the sensor that the statistics belong to. </p>
    #[doc(hidden)]pub data_exists: bool,
    ...
    #[doc(hidden)]pub missing_values: std::option::Option<crate::model::CountPercent>,
    ...
    #[doc(hidden)]pub invalid_values: std::option::Option<crate::model::CountPercent>,
    ...
    #[doc(hidden)]pub invalid_date_entries: std::option::Option<crate::model::CountPercent>,
    ...
    #[doc(hidden)]pub duplicate_timestamps: std::option::Option<crate::model::CountPercent>,
    /// <p> Parameter that describes potential risk about whether data associated with the sensor is categorical. </p>
    #[doc(hidden)]pub categorical_values: std::option::Option<crate::model::CategoricalValues>,
    ...
    #[doc(hidden)]pub multiple_operating_modes: std::option::Option<crate::model::MultipleOperatingModes>,
    ...
    #[doc(hidden)]pub large_timestamp_gaps: std::option::Option<crate::model::LargeTimestampGaps>,
    /// <p> Parameter that describes potential risk about whether data associated with the sensor is mostly monotonic. </p>
    #[doc(hidden)]pub monotonic_values: std::option::Option<crate::model::MonotonicValues>,
    ...
    #[doc(hidden)]pub data_start_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub data_end_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct MonotonicValues  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::StatisticalIssueStatus>,
    /// <p> Indicates the monotonicity of values. Can be INCREASING, DECREASING, or STATIC. </p>
    #[doc(hidden)]pub monotonicity: std::option::Option<crate::model::Monotonicity>,
}
...
pub struct LargeTimestampGaps  {
    ...
    #[doc(hidden)]pub number_of_large_timestamp_gaps: std::option::Option<i32>,
    /// <p> Indicates the size of the largest timestamp gap, in days. </p>
    #[doc(hidden)]pub max_timestamp_gap_in_days: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for LargeTimestampGaps  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("status", &self.status);
        formatter.field("number_of_large_timestamp_gaps", &self.number_of_large_timestamp_gaps);
...
pub struct CategoricalValues  {
    ...
    #[doc(hidden)]pub number_of_category: std::option::Option<i32>,
}
...
pub struct ModelSummary  {
    ...
    #[doc(hidden)]pub model_arn: std::option::Option<std::string::String>,
...
pub struct LabelSummary  {
    ...
    #[doc(hidden)]pub label_group_arn: std::option::Option<std::string::String>,
...
pub struct InferenceSchedulerSummary  {
    ...
    #[doc(hidden)]pub inference_scheduler_arn: std::option::Option<std::string::String>,
    /// <p>Indicates the status of the inference scheduler. </p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::InferenceSchedulerStatus>,
    ...
    #[doc(hidden)]pub latest_inference_result: std::option::Option<crate::model::LatestInferenceResult>,
}
...
pub struct InferenceExecutionSummary  {
    ...
    #[doc(hidden)]pub scheduled_start_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// <p> </p>
    #[doc(hidden)]pub customer_result_object: std::option::Option<crate::model::S3Object>,
    ...
    #[doc(hidden)]pub failed_reason: std::option::Option<std::string::String>,
}
...
pub struct InferenceEventSummary  {
    ...
    #[doc(hidden)]pub diagnostics: std::option::Option<std::string::String>,
    /// <p> Indicates the size of an inference event in seconds. </p>
    #[doc(hidden)]pub event_duration_in_seconds: std::option::Option<i64>,
}
...
pub struct DataPreProcessingConfiguration  {
    ...
    /// <p>When providing a value for the <code>TargetSamplingRate</code>, you must attach the prefix "PT" to the rate you want. The value for a 1 second rate is therefore <i>PT1S</i>, the value for a 15 minute rate is <i>PT15M</i>, and the value for a 1 hour rate is <i>PT1H</i> </p>
    #[doc(hidden)]pub target_sampling_rate: std::option::Option<crate::model::TargetSamplingRate>,
}
...
pub struct LabelsInputConfiguration  {
    ...
    #[doc(hidden)]pub s3_input_configuration: std::option::Option<crate::model::LabelsS3InputConfiguration>,
...
pub struct IngestedFilesSummary  {
    ...
    #[doc(hidden)]pub total_number_of_files: std::option::Option<i32>,
    /// <p>Indicates the number of files that were successfully ingested.</p>
    #[doc(hidden)]pub ingested_number_of_files: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub discarded_files: std::option::Option<std::vec::Vec<crate::model::S3Object>>,
}
...
pub struct DataQualitySummary  {
    ...
    #[doc(hidden)]pub insufficient_sensor_data: std::option::Option<crate::model::InsufficientSensorData>,
    /// <p> Parameter that gives information about data that is missing over all the sensors in the input data. </p>
    #[doc(hidden)]pub missing_sensor_data: std::option::Option<crate::model::MissingSensorData>,
    /// <p> Parameter that gives information about data that is invalid over all the sensors in the input data. </p>
    #[doc(hidden)]pub invalid_sensor_data: std::option::Option<crate::model::InvalidSensorData>,
    /// <p> Parameter that gives information about unsupported timestamps in the input data. </p>
    #[doc(hidden)]pub unsupported_timestamps: std::option::Option<crate::model::UnsupportedTimestamps>,
    /// <p> Parameter that gives information about duplicate timestamps in the input data. </p>
    #[doc(hidden)]pub duplicate_timestamps: std::option::Option<crate::model::DuplicateTimestamps>,
}
...
pub struct DuplicateTimestamps  {
    ...
    #[doc(hidden)]pub total_number_of_duplicate_timestamps: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for DuplicateTimestamps  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_number_of_duplicate_timestamps", &self.total_number_of_duplicate_timestamps);
        formatter.finish()
    }
}
...
pub struct UnsupportedTimestamps  {
    ...
    #[doc(hidden)]pub total_number_of_unsupported_timestamps: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for UnsupportedTimestamps  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_number_of_unsupported_timestamps", &self.total_number_of_unsupported_timestamps);
        formatter.finish()
    }
}
...
pub struct InvalidSensorData  {
    ...
    #[doc(hidden)]pub affected_sensor_count: std::option::Option<i32>,
    /// <p> Indicates the total number of invalid values across all the sensors. </p>
    #[doc(hidden)]pub total_number_of_invalid_values: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for InvalidSensorData  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_number_of_invalid_values", &self.total_number_of_invalid_values);
        formatter.finish()
    }
}
...
pub struct MissingSensorData  {
    ...
    #[doc(hidden)]pub total_number_of_missing_values: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for MissingSensorData  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("affected_sensor_count", &self.affected_sensor_count);
        formatter.field("total_number_of_missing_values", &self.total_number_of_missing_values);
        formatter.finish()
    }
}
...
pub struct InsufficientSensorData  {
    ...
    #[doc(hidden)]pub missing_complete_sensor_data: std::option::Option<crate::model::MissingCompleteSensorData>,
    ...
    #[doc(hidden)]pub sensors_with_short_date_range: std::option::Option<crate::model::SensorsWithShortDateRange>,
}
...
impl  std::fmt::Debug for InsufficientSensorData  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("missing_complete_sensor_data", &self.missing_complete_sensor_data);
        formatter.field("sensors_with_short_date_range", &self.sensors_with_short_date_range);
        formatter.finish()
    }
}
...
pub struct DatasetSchema  {
    /// <p> </p>
    #[doc(hidden)]pub inline_data_schema: std::option::Option<std::string::String>,
}
impl DatasetSchema {
    /// <p> </p>
