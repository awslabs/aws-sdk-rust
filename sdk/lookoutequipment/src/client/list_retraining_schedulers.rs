...
impl super::Client {
    ...
    ///   - [`model_name_begins_with(impl Into<String>)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::model_name_begins_with) / [`set_model_name_begins_with(Option<String>)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::set_model_name_begins_with): <p>Specify this field to only list retraining schedulers whose machine learning models begin with the value you specify. </p>
    ///   - [`status(RetrainingSchedulerStatus)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::status) / [`set_status(Option<RetrainingSchedulerStatus>)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::set_status): <p>Specify this field to only list retraining schedulers whose status matches the value you specify. </p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::set_next_token): <p>If the number of results exceeds the maximum, a pagination token is returned. Use the token in the request to show the next page of retraining schedulers.</p>
    ///   - [`max_results(i32)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_retraining_schedulers::builders::ListRetrainingSchedulersFluentBuilder::set_max_results): <p>Specifies the maximum number of retraining schedulers to list. </p>
