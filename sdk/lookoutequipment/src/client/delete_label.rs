...
impl super::Client {
    ...
    ///   - [`label_group_name(impl Into<String>)`](crate::operation::delete_label::builders::DeleteLabelFluentBuilder::label_group_name) / [`set_label_group_name(Option<String>)`](crate::operation::delete_label::builders::DeleteLabelFluentBuilder::set_label_group_name):<br>required: **true**<br><p>The name of the label group that contains the label that you want to delete. Data in this field will be retained for service usage. Follow best practices for the security of your data.</p><br>
    ///   - [`label_id(impl Into<String>)`](crate::operation::delete_label::builders::DeleteLabelFluentBuilder::label_id) / [`set_label_id(Option<String>)`](crate::operation::delete_label::builders::DeleteLabelFluentBuilder::set_label_id):<br>required: **true**<br><p>The ID of the label that you want to delete.</p><br>
