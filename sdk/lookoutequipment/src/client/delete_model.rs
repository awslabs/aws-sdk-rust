...
impl super::Client {
    ...
    ///   - [`model_name(impl Into<String>)`](crate::operation::delete_model::builders::DeleteModelFluentBuilder::model_name) / [`set_model_name(Option<String>)`](crate::operation::delete_model::builders::DeleteModelFluentBuilder::set_model_name): <p>The name of the machine learning model to be deleted. </p>
