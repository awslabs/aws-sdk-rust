...
impl super::Client {
    ...
    ///   - [`label_group_name(impl ::std::convert::Into<String>)`](crate::operation::update_label_group::builders::UpdateLabelGroupFluentBuilder::label_group_name) / [`set_label_group_name(Option<String>)`](crate::operation::update_label_group::builders::UpdateLabelGroupFluentBuilder::set_label_group_name): <p> The name of the label group to be updated. </p>
