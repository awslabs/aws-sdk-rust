...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_label_groups::builders::ListLabelGroupsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_label_groups::builders::ListLabelGroupsFluentBuilder::set_max_results):<br>required: **false**<br><p>Specifies the maximum number of label groups to list.</p><br>
