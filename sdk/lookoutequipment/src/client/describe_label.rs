...
impl super::Client {
    ...
    ///   - [`label_group_name(impl Into<String>)`](crate::operation::describe_label::builders::DescribeLabelFluentBuilder::label_group_name) / [`set_label_group_name(Option<String>)`](crate::operation::describe_label::builders::DescribeLabelFluentBuilder::set_label_group_name):<br>required: **true**<br><p>Returns the name of the group containing the label.</p><br>
    ///   - [`label_id(impl Into<String>)`](crate::operation::describe_label::builders::DescribeLabelFluentBuilder::label_id) / [`set_label_id(Option<String>)`](crate::operation::describe_label::builders::DescribeLabelFluentBuilder::set_label_id):<br>required: **true**<br><p>Returns the ID of the label.</p><br>
