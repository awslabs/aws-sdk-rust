...
impl super::Client {
    ...
    ///   - [`label_group_name(impl Into<String>)`](crate::operation::list_labels::builders::ListLabelsFluentBuilder::label_group_name) / [`set_label_group_name(Option<String>)`](crate::operation::list_labels::builders::ListLabelsFluentBuilder::set_label_group_name):<br>required: **true**<br><p>Retruns the name of the label group.</p><br>
    ...
    ///   - [`fault_code(impl Into<String>)`](crate::operation::list_labels::builders::ListLabelsFluentBuilder::fault_code) / [`set_fault_code(Option<String>)`](crate::operation::list_labels::builders::ListLabelsFluentBuilder::set_fault_code):<br>required: **false**<br><p>Returns labels with a particular fault code.</p><br>
