...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_models::builders::ListModelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_models::builders::ListModelsFluentBuilder::set_next_token):<br>required: **false**<br><p>An opaque pagination token indicating where to continue the listing of machine learning models.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_models::builders::ListModelsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_models::builders::ListModelsFluentBuilder::set_max_results):<br>required: **false**<br><p>Specifies the maximum number of machine learning models to list.</p><br>
    ///   - [`status(ModelStatus)`](crate::operation::list_models::builders::ListModelsFluentBuilder::status) / [`set_status(Option<ModelStatus>)`](crate::operation::list_models::builders::ListModelsFluentBuilder::set_status):<br>required: **false**<br><p>The status of the machine learning model.</p><br>
    ///   - [`model_name_begins_with(impl Into<String>)`](crate::operation::list_models::builders::ListModelsFluentBuilder::model_name_begins_with) / [`set_model_name_begins_with(Option<String>)`](crate::operation::list_models::builders::ListModelsFluentBuilder::set_model_name_begins_with):<br>required: **false**<br><p>The beginning of the name of the machine learning models being listed.</p><br>
