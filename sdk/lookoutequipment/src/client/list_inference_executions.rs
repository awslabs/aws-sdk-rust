...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_next_token): <p>An opaque pagination token indicating where to continue the listing of inference executions.</p>
    ...
    ///   - [`inference_scheduler_name(impl Into<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::inference_scheduler_name) / [`set_inference_scheduler_name(Option<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_inference_scheduler_name): <p>The name of the inference scheduler for the inference execution listed. </p>
