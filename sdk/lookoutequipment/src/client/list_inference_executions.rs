...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_next_token): <p>An opaque pagination token indicating where to continue the listing of inference executions.</p>
    ///   - [`max_results(i32)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_max_results): <p>Specifies the maximum number of inference executions to list. </p>
    ///   - [`inference_scheduler_name(impl ::std::convert::Into<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::inference_scheduler_name) / [`set_inference_scheduler_name(Option<String>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_inference_scheduler_name): <p>The name of the inference scheduler for the inference execution listed. </p>
    ///   - [`data_start_time_after(DateTime)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::data_start_time_after) / [`set_data_start_time_after(Option<DateTime>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_data_start_time_after): <p>The time reference in the inferenced dataset after which Amazon Lookout for Equipment started the inference execution. </p>
    ///   - [`data_end_time_before(DateTime)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::data_end_time_before) / [`set_data_end_time_before(Option<DateTime>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_data_end_time_before): <p>The time reference in the inferenced dataset before which Amazon Lookout for Equipment stopped the inference execution. </p>
    ///   - [`status(InferenceExecutionStatus)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::status) / [`set_status(Option<InferenceExecutionStatus>)`](crate::operation::list_inference_executions::builders::ListInferenceExecutionsFluentBuilder::set_status): <p>The status of the inference execution. </p>
