...
impl CreateLoadBalancerPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLoadBalancerPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_load_balancer_policy::de_create_load_balancer_policy_http_response_with_props(status, headers, body)
        }
    }
}
