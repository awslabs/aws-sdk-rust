...
impl CreateLoadBalancerPolicyInput {
    /// Consumes the builder and constructs an Operation<[`CreateLoadBalancerPolicy`](crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_load_balancer_policy_input::ser_create_load_balancer_policy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateLoadBalancerPolicy {
                type Output = std::result::Result<crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyOutput, crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyError>;
