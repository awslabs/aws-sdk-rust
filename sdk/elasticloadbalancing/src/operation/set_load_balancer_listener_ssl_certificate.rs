...
impl SetLoadBalancerListenerSSLCertificate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_load_balancer_listener_ssl_certificate::SetLoadBalancerListenerSSLCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_load_balancer_listener_ssl_certificate::SetLoadBalancerListenerSslCertificateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing.SetLoadBalancerListenerSSLCertificate",
            "rpc.service" = "Elastic Load Balancing",
            "rpc.method" = "SetLoadBalancerListenerSSLCertificate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetLoadBalancerListenerSSLCertificate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetLoadBalancerListenerSSLCertificateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetLoadBalancerListenerSSLCertificateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetLoadBalancerListenerSSLCertificate")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetLoadBalancerListenerSSLCertificate")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetLoadBalancerListenerSSLCertificateTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetLoadBalancerListenerSSLCertificateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetLoadBalancerListenerSSLCertificateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetLoadBalancerListenerSslCertificateInput>() else {
        ...
        if requested.should_capture("SSLCertificateId") {
            if let ::std::option::Option::Some(value) = input.ssl_certificate_id.as_deref() {
                captured.insert("SSLCertificateId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetLoadBalancerListenerSSLCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_load_balancer_listener_ssl_certificate::de_set_load_balancer_listener_ssl_certificate_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_set_load_balancer_listener_ssl_certificate::de_set_load_balancer_listener_ssl_certificate_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetLoadBalancerListenerSSLCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_load_balancer_listener_ssl_certificate::SetLoadBalancerListenerSslCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::set_load_balancer_listener_ssl_certificate::SetLoadBalancerListenerSslCertificateInput,
