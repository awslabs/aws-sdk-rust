...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetLoadBalancerListenerSSLCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_load_balancer_listener_ssl_certificate_input::ser_set_load_balancer_listener_ssl_certificate_input_input(&input)?);
