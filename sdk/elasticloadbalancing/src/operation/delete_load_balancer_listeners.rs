...
impl DeleteLoadBalancerListenersInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLoadBalancerListeners`](crate::operation::delete_load_balancer_listeners::DeleteLoadBalancerListeners)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_load_balancer_listeners::DeleteLoadBalancerListeners, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_load_balancer_listeners::DeleteLoadBalancerListenersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_load_balancer_listeners_input::ser_delete_load_balancer_listeners_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_load_balancer_listeners::DeleteLoadBalancerListeners::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLoadBalancerListeners {
                type Output = std::result::Result<crate::operation::delete_load_balancer_listeners::DeleteLoadBalancerListenersOutput, crate::operation::delete_load_balancer_listeners::DeleteLoadBalancerListenersError>;
