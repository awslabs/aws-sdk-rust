...
impl DeregisterInstancesFromLoadBalancerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterInstancesFromLoadBalancer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_instances_from_load_balancer::de_deregister_instances_from_load_balancer_http_response_with_props(
                status, headers, body,
            )
        }
    }
