...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetLoadBalancerPoliciesForBackendServerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_load_balancer_policies_for_backend_server_input::ser_set_load_balancer_policies_for_backend_server_input_input(&input)?);
