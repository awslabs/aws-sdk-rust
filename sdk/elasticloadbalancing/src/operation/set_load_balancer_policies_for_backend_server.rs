...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for SetLoadBalancerPoliciesForBackendServerResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for SetLoadBalancerPoliciesForBackendServerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_load_balancer_policies_for_backend_server_input::ser_set_load_balancer_policies_for_backend_server_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetLoadBalancerPoliciesForBackendServerEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for SetLoadBalancerPoliciesForBackendServerError {
