...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::configure_health_check::ConfigureHealthCheckOutput,
                    crate::operation::configure_health_check::ConfigureHealthCheckError,
                > for ConfigureHealthCheckFluentBuilder
            {
                fn send(
                    self,
...
impl ConfigureHealthCheckFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::configure_health_check::ConfigureHealthCheckOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::configure_health_check::ConfigureHealthCheckError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::configure_health_check::ConfigureHealthCheck::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::configure_health_check::ConfigureHealthCheck::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::configure_health_check::ConfigureHealthCheckOutput, crate::operation::configure_health_check::ConfigureHealthCheckError, Self> {
