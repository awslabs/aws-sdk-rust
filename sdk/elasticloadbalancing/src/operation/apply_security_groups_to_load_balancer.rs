...
impl ApplySecurityGroupsToLoadBalancerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancer,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApplySecurityGroupsToLoadBalancer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_apply_security_groups_to_load_balancer::de_apply_security_groups_to_load_balancer_http_response_with_props(
                status, headers, body,
            )
        }
    }
