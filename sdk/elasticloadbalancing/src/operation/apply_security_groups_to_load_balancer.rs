...
impl ApplySecurityGroupsToLoadBalancerInput {
    /// Consumes the builder and constructs an Operation<[`ApplySecurityGroupsToLoadBalancer`](crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_apply_security_groups_to_load_balancer_input::ser_apply_security_groups_to_load_balancer_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancer::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ApplySecurityGroupsToLoadBalancer {
                type Output = std::result::Result<crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancerOutput, crate::operation::apply_security_groups_to_load_balancer::ApplySecurityGroupsToLoadBalancerError>;
