...
impl SetLoadBalancerPoliciesOfListener {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing.SetLoadBalancerPoliciesOfListener",
            "rpc.service" = "Elastic Load Balancing",
            "rpc.method" = "SetLoadBalancerPoliciesOfListener",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetLoadBalancerPoliciesOfListener {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetLoadBalancerPoliciesOfListenerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetLoadBalancerPoliciesOfListenerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetLoadBalancerPoliciesOfListener")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetLoadBalancerPoliciesOfListener")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetLoadBalancerPoliciesOfListenerTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetLoadBalancerPoliciesOfListenerTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetLoadBalancerPoliciesOfListenerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetLoadBalancerPoliciesOfListenerInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetLoadBalancerPoliciesOfListenerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_load_balancer_policies_of_listener::de_set_load_balancer_policies_of_listener_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_set_load_balancer_policies_of_listener::de_set_load_balancer_policies_of_listener_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetLoadBalancerPoliciesOfListenerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerInput,
