...
impl DescribeLoadBalancerPolicyTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoadBalancerPolicyTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_load_balancer_policy_types::de_describe_load_balancer_policy_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
