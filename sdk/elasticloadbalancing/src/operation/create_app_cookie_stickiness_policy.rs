...
impl CreateAppCookieStickinessPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAppCookieStickinessPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_app_cookie_stickiness_policy::de_create_app_cookie_stickiness_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
