...
impl crate::operation::create_lb_cookie_stickiness_policy::builders::CreateLbCookieStickinessPolicyInputBuilder {
...
impl CreateLBCookieStickinessPolicyFluentBuilder {
    /// Creates a new `CreateLBCookieStickinessPolicyFluentBuilder`.
