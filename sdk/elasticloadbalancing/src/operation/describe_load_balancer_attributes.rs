...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoadBalancerAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_load_balancer_attributes::de_describe_load_balancer_attributes_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_load_balancer_attributes::DescribeLoadBalancerAttributesError
{
