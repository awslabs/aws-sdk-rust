...
impl DescribeLoadBalancerAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_load_balancer_attributes::DescribeLoadBalancerAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoadBalancerAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_load_balancer_attributes::de_describe_load_balancer_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
