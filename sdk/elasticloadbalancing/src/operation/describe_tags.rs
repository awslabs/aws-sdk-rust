...
impl DescribeTagsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_tags::DescribeTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_tags::de_describe_tags_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_tags::de_describe_tags_http_response_with_props(
                status, headers, body,
            )
        }
    }
