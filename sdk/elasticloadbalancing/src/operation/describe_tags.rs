...
impl DescribeTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_tags::DescribeTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_tags_input::ser_describe_tags_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_tags::de_describe_tags_http_response_with_props(status, headers, body)
        }
    }
}
