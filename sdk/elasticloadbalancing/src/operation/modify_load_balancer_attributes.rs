    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyLoadBalancerAttributesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyLoadBalancerAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_load_balancer_attributes_input::ser_modify_load_balancer_attributes_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyLoadBalancerAttributesEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError {
