...
impl ModifyLoadBalancerAttributesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyLoadBalancerAttributes`](crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyLoadBalancerAttributes {
                type Output = std::result::Result<crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesOutput, crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError>;
