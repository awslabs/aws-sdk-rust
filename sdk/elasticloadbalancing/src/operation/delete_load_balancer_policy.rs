...
impl DeleteLoadBalancerPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLoadBalancerPolicy`](crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_load_balancer_policy_input::ser_delete_load_balancer_policy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLoadBalancerPolicy {
                type Output = std::result::Result<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError>;
