...
/// Orchestration and serialization glue logic for `DeleteLoadBalancerPolicy`.
...
impl DeleteLoadBalancerPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyInput,
                    ) -> ::std::result::Result<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLoadBalancerPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteLoadBalancerPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteLoadBalancerPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteLoadBalancerPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteLoadBalancerPolicy")
...
.with_interceptor(DeleteLoadBalancerPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteLoadBalancerPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_load_balancer_policy::de_delete_load_balancer_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_load_balancer_policy::de_delete_load_balancer_policy_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLoadBalancerPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_load_balancer_policy_input::ser_delete_load_balancer_policy_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DeleteLoadBalancerPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteLoadBalancerPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteLoadBalancerPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteLoadBalancerPolicyInput>()
                        .ok_or("failed to downcast to DeleteLoadBalancerPolicyInput")?;
...
pub enum DeleteLoadBalancerPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteLoadBalancerPolicyError) for what information is available for the error.")]
...
impl DeleteLoadBalancerPolicyError {
    /// Creates the `DeleteLoadBalancerPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteLoadBalancerPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteLoadBalancerPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_load_balancer_policy::_delete_load_balancer_policy_output::DeleteLoadBalancerPolicyOutput;

pub use crate::operation::delete_load_balancer_policy::_delete_load_balancer_policy_input::DeleteLoadBalancerPolicyInput;

mod _delete_load_balancer_policy_input;

mod _delete_load_balancer_policy_output;
