...
impl DeleteLoadBalancerPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicy,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoadBalancerPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_load_balancer_policy::de_delete_load_balancer_policy_http_response_with_props(status, headers, body)
        }
    }
}
