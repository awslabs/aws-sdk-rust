...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DisableAvailabilityZonesForLoadBalancerResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DisableAvailabilityZonesForLoadBalancerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disable_availability_zones_for_load_balancer_input::ser_disable_availability_zones_for_load_balancer_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisableAvailabilityZonesForLoadBalancerEndpointParamsInterceptor {
