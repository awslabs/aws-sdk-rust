...
impl RegisterInstancesWithLoadBalancer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerInput,
                    ) -> ::std::result::Result<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterInstancesWithLoadBalancer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterInstancesWithLoadBalancer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterInstancesWithLoadBalancerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterInstancesWithLoadBalancerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterInstancesWithLoadBalancer")
...
.with_interceptor(RegisterInstancesWithLoadBalancerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerError>::new());
...
#[derive(Debug)]
            struct RegisterInstancesWithLoadBalancerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterInstancesWithLoadBalancerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_instances_with_load_balancer::de_register_instances_with_load_balancer_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RegisterInstancesWithLoadBalancerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterInstancesWithLoadBalancerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_instances_with_load_balancer_input::ser_register_instances_with_load_balancer_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RegisterInstancesWithLoadBalancerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterInstancesWithLoadBalancerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterInstancesWithLoadBalancerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterInstancesWithLoadBalancerInput>()
                        .ok_or("failed to downcast to RegisterInstancesWithLoadBalancerInput")?;
...
pub enum RegisterInstancesWithLoadBalancerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterInstancesWithLoadBalancerError) for what information is available for the error.")]
...
impl RegisterInstancesWithLoadBalancerError {
    /// Creates the `RegisterInstancesWithLoadBalancerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterInstancesWithLoadBalancerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterInstancesWithLoadBalancerError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterInstancesWithLoadBalancerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_instances_with_load_balancer::RegisterInstancesWithLoadBalancerError {
...
mod _register_instances_with_load_balancer_output;
