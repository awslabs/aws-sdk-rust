...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterInstancesWithLoadBalancer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_instances_with_load_balancer::de_register_instances_with_load_balancer_http_response_with_props(status, headers, body)
        }
    }
}
