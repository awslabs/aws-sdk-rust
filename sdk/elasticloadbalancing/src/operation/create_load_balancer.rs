...
impl CreateLoadBalancer {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_load_balancer::CreateLoadBalancerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_load_balancer::CreateLoadBalancerOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing.CreateLoadBalancer",
            "rpc.service" = "Elastic Load Balancing",
            "rpc.method" = "CreateLoadBalancer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLoadBalancer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateLoadBalancerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateLoadBalancerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateLoadBalancer")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLoadBalancer")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateLoadBalancerTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateLoadBalancerTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLoadBalancerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateLoadBalancerInput>() else {
        ...
        if requested.should_capture("Scheme") {
            if let ::std::option::Option::Some(value) = input.scheme.as_deref() {
                captured.insert("Scheme", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLoadBalancerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_load_balancer::de_create_load_balancer_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_load_balancer::de_create_load_balancer_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLoadBalancerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_load_balancer::CreateLoadBalancerInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_load_balancer_input::ser_create_load_balancer_input_input_input(&input)?,
        );
...
impl ::std::error::Error for CreateLoadBalancerError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::DuplicateAccessPointNameException(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::InvalidSchemeException(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidSecurityGroupException(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::TooManyAccessPointsException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateLoadBalancerError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DuplicateAccessPointNameException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::InvalidSchemeException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidSecurityGroupException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::TooManyAccessPointsException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
