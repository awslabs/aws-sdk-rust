...
impl AttachLoadBalancerToSubnetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnets,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancerToSubnets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_load_balancer_to_subnets::de_attach_load_balancer_to_subnets_http_response_with_props(
                status, headers, body,
            )
        }
    }
