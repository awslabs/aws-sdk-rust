...
impl AttachLoadBalancerToSubnetsInput {
    /// Consumes the builder and constructs an Operation<[`AttachLoadBalancerToSubnets`](crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_load_balancer_to_subnets_input::ser_attach_load_balancer_to_subnets_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancerToSubnets {
                type Output = std::result::Result<crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsOutput, crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsError>;
