...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancerToSubnets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_load_balancer_to_subnets::de_attach_load_balancer_to_subnets_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AttachLoadBalancerToSubnetsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsError
{
