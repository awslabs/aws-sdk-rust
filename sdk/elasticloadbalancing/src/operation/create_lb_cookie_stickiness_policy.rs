...
impl aws_smithy_http::response::ParseStrictResponse for CreateLBCookieStickinessPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_lb_cookie_stickiness_policy::de_create_lb_cookie_stickiness_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError
{
