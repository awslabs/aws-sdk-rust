...
impl CreateLBCookieStickinessPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLBCookieStickinessPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLBCookieStickinessPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLBCookieStickinessPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLBCookieStickinessPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLBCookieStickinessPolicy")
...
.with_interceptor(CreateLBCookieStickinessPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError>::new());
...
#[derive(Debug)]
            struct CreateLBCookieStickinessPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLBCookieStickinessPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_lb_cookie_stickiness_policy::de_create_lb_cookie_stickiness_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_lb_cookie_stickiness_policy::de_create_lb_cookie_stickiness_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLBCookieStickinessPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLBCookieStickinessPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_lb_cookie_stickiness_policy_input::ser_create_lb_cookie_stickiness_policy_input_input_input(&input)?);
...
#[derive(Debug)]
            struct CreateLBCookieStickinessPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLBCookieStickinessPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLBCookieStickinessPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLbCookieStickinessPolicyInput>()
                        .ok_or("failed to downcast to CreateLbCookieStickinessPolicyInput")?;
...
pub enum CreateLBCookieStickinessPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLBCookieStickinessPolicyError) for what information is available for the error.")]
...
impl CreateLBCookieStickinessPolicyError {
    /// Creates the `CreateLBCookieStickinessPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLBCookieStickinessPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateLBCookieStickinessPolicyError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLBCookieStickinessPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError {
...
mod _create_lb_cookie_stickiness_policy_output;
