...
impl CreateLbCookieStickinessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`CreateLBCookieStickinessPolicy`](crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_lb_cookie_stickiness_policy_input::ser_create_lb_cookie_stickiness_policy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateLBCookieStickinessPolicy {
                type Output = std::result::Result<crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyOutput, crate::operation::create_lb_cookie_stickiness_policy::CreateLBCookieStickinessPolicyError>;
