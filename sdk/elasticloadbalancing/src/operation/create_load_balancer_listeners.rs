...
impl CreateLoadBalancerListeners {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elastic Load Balancing.CreateLoadBalancerListeners",
            "rpc.service" = "Elastic Load Balancing",
            "rpc.method" = "CreateLoadBalancerListeners",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLoadBalancerListeners {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateLoadBalancerListenersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateLoadBalancerListenersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateLoadBalancerListeners")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLoadBalancerListeners")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateLoadBalancerListenersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateLoadBalancerListenersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLoadBalancerListenersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateLoadBalancerListenersInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLoadBalancerListenersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_load_balancer_listeners::de_create_load_balancer_listeners_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_load_balancer_listeners::de_create_load_balancer_listeners_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLoadBalancerListenersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_load_balancer_listeners_input::ser_create_load_balancer_listeners_input_input_input(&input)?,
        );
