...
#[allow(unused_mut)]
pub fn ser_cross_zone_load_balancing(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::CrossZoneLoadBalancing) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_cross_zone_load_balancing(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CrossZoneLoadBalancing, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
