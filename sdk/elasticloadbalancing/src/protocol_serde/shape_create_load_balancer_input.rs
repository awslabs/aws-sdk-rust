...
pub fn ser_create_load_balancer_input_input_input(input: &crate::operation::create_load_balancer::CreateLoadBalancerInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
