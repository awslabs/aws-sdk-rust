...
pub fn de_delete_load_balancer_policy_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_load_balancer_policy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError> {
    Ok({
        #[allow(unused_mut)]
