...
pub fn de_delete_load_balancer_policy_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError> {
    #[allow(unused_mut)]
