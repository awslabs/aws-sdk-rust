    ...
    Err(match error_code {
        ...
        "DependencyThrottle" => crate::operation::describe_load_balancers::DescribeLoadBalancersError::DependencyThrottleException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_dependency_throttle_exception::de_dependency_throttle_exception_xml_err(_response_body, output)
                    .map_err(crate::operation::describe_load_balancers::DescribeLoadBalancersError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("LoadBalancerDescriptions") /* LoadBalancerDescriptions com.amazonaws.elasticloadbalancing.synthetic#DescribeLoadBalancersOutput$LoadBalancerDescriptions */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_load_balancer_descriptions::de_load_balancer_descriptions(&mut tag, depth + 1)
                        ?
                    )
                ;
