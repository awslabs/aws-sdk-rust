...
#[allow(unused_mut)]
pub fn de_invalid_end_point_exception_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::InvalidEndPointExceptionBuilder,
) -> std::result::Result<crate::types::error::builders::InvalidEndPointExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
