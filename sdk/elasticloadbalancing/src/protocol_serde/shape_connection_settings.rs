...
#[allow(unused_mut)]
pub fn ser_connection_settings(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ConnectionSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_connection_settings(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConnectionSettings, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
