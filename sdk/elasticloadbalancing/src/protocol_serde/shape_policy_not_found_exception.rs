...
#[allow(unused_mut)]
pub fn de_policy_not_found_exception_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::PolicyNotFoundExceptionBuilder,
) -> std::result::Result<crate::types::error::builders::PolicyNotFoundExceptionBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
