...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_load_balancer_to_subnets_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsOutput, crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsError> {
    Ok({
        #[allow(unused_mut)]
