...
#[allow(unused_mut)]
pub fn ser_connection_draining(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ConnectionDraining) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_connection_draining(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ConnectionDraining, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::connection_draining_correct_errors(builder).build())
}
