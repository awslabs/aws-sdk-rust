...
#[allow(unused_mut)]
pub fn ser_connection_draining(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ConnectionDraining) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_connection_draining(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConnectionDraining, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
