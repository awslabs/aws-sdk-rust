...
pub fn de_deregister_instances_from_load_balancer_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidInstance" => {
            crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerError::InvalidEndPointException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidEndPointExceptionBuilder::default();
                    output = crate::protocol_serde::shape_invalid_end_point_exception::de_invalid_end_point_exception_xml_err(_response_body, output)
                        .map_err(crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_instances_from_load_balancer_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_deregister_instances_from_load_balancer::de_deregister_instances_from_load_balancer(_response_body, output)
                .map_err(crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DeregisterInstancesFromLoadBalancerResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DeregisterInstancesFromLoadBalancerResult got {start_el:?}"
            )));
        }
