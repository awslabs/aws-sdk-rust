...
#[allow(clippy::unnecessary_wraps)]
pub fn de_configure_health_check_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_configure_health_check::de_configure_health_check(_response_body, output)
            .map_err(crate::operation::configure_health_check::ConfigureHealthCheckError::unhandled)?;
...
) -> Result<crate::operation::configure_health_check::builders::ConfigureHealthCheckOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
