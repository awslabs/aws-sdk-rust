...
pub fn de_lb_cookie_stickiness_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LbCookieStickinessPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
