...
#[allow(unused_mut)]
pub fn ser_access_log(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::AccessLog) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_access_log(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessLog, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
