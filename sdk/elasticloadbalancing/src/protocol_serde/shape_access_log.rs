...
#[allow(unused_mut)]
pub fn ser_access_log(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AccessLog) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
