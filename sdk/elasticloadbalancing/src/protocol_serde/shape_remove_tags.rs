...
> {
    ...
    Err(match error_code {
        "LoadBalancerNotFound" => {
            crate::operation::remove_tags::RemoveTagsError::AccessPointNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_access_point_not_found_exception::de_access_point_not_found_exception_xml_err(response.body().as_ref(), output).map_err(crate::operation::remove_tags::RemoveTagsError::unhandled)?;
