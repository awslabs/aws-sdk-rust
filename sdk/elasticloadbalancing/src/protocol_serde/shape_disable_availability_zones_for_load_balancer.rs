...
pub fn de_disable_availability_zones_for_load_balancer_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_availability_zones_for_load_balancer_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disable_availability_zones_for_load_balancer::de_disable_availability_zones_for_load_balancer(
            _response_body,
            output,
        )
        .map_err(crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DisableAvailabilityZonesForLoadBalancerResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DisableAvailabilityZonesForLoadBalancerResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DisableAvailabilityZonesForLoadBalancerResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DisableAvailabilityZonesForLoadBalancerResult got {start_el:?}"
            )));
        }
