...
pub fn de_source_security_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SourceSecurityGroup, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
