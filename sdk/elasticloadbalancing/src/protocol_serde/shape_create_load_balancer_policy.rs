...
pub fn de_create_load_balancer_policy_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyOutput, crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_load_balancer_policy_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyOutput, crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyError> {
    Ok({
        #[allow(unused_mut)]
