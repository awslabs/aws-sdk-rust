...
#[allow(unused_mut)]
pub fn ser_load_balancer_attributes(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::LoadBalancerAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_load_balancer_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoadBalancerAttributes, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
