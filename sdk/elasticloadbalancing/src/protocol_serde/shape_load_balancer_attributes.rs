...
#[allow(unused_mut)]
pub fn ser_load_balancer_attributes(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LoadBalancerAttributes) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
