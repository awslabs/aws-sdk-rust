...
pub fn de_policy_type_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyTypeDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
