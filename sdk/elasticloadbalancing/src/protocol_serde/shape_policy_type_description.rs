...
pub fn de_policy_type_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PolicyTypeDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::PolicyTypeDescription::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("PolicyTypeName") /* PolicyTypeName com.amazonaws.elasticloadbalancing#PolicyTypeDescription$PolicyTypeName */ =>  {
                ...
                ;
                builder = builder.set_policy_type_name(var_1);
            }
            ,
            ...
            s if s.matches("PolicyAttributeTypeDescriptions") /* PolicyAttributeTypeDescriptions com.amazonaws.elasticloadbalancing#PolicyTypeDescription$PolicyAttributeTypeDescriptions */ =>  {
                let var_3 =
                    Some(
                        crate::protocol_serde::shape_policy_attribute_type_descriptions::de_policy_attribute_type_descriptions(&mut tag)
                        ?
                    )
                ;
                builder = builder.set_policy_attribute_type_descriptions(var_3);
            }
            ,
            _ => {}
        }
