...
#[allow(unused_mut)]
pub fn ser_health_check(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::HealthCheck) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_health_check(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::HealthCheck, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
