...
pub fn de_policy_attribute_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PolicyAttributeDescription>, aws_smithy_xml::decode::XmlDecodeError> {
