...
pub fn de_policy_attribute_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyAttributeDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
