...
pub fn de_policy_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
