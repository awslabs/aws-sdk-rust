...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError::unhandled)?;
    ...
    Err(match error_code {
        "LoadBalancerNotFound" => {
            crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError::AccessPointNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidConfigurationRequest" => {
            crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError::InvalidConfigurationRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LoadBalancerAttributeNotFound" => {
            crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError::LoadBalancerAttributeNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_load_balancer_attributes::de_modify_load_balancer_attributes(_response_body, output)
            .map_err(crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ModifyLoadBalancerAttributesResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyLoadBalancerAttributesResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyLoadBalancerAttributesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyLoadBalancerAttributesResult got {start_el:?}"
            )));
        }
