...
pub fn de_app_cookie_stickiness_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AppCookieStickinessPolicy, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
