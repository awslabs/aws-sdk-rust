...
pub fn de_backend_server_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BackendServerDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
