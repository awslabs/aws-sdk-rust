...
pub fn ser_describe_tags_input_input_input(input: &crate::operation::describe_tags::DescribeTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
