...
pub fn ser_create_load_balancer_policy_input_input_input(input: &crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
