...
pub fn ser_create_load_balancer_policy_input_input(input: &crate::input::CreateLoadBalancerPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
