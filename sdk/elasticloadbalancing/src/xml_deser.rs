...
#[allow(unused_mut)]pub fn deser_structure_crate_error_access_point_not_found_exception_xml_err(inp: &[u8], mut builder: crate::error::access_point_not_found_exception::Builder) -> Result<crate::error::access_point_not_found_exception::Builder, aws_smithy_xml::decode::XmlError> {
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_apply_security_groups_to_load_balancer(inp: &[u8], mut builder: crate::output::apply_security_groups_to_load_balancer_output::Builder) -> Result<crate::output::apply_security_groups_to_load_balancer_output::Builder, aws_smithy_xml::decode::XmlError> {
    ...
    if !(start_el.matches("ApplySecurityGroupsToLoadBalancerResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected ApplySecurityGroupsToLoadBalancerResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ApplySecurityGroupsToLoadBalancerResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected ApplySecurityGroupsToLoadBalancerResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected ApplySecurityGroupsToLoadBalancerResult tag"))
                    };
    Ok(builder)
}
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_attach_load_balancer_to_subnets(inp: &[u8], mut builder: crate::output::attach_load_balancer_to_subnets_output::Builder) -> Result<crate::output::attach_load_balancer_to_subnets_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("AttachLoadBalancerToSubnetsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected AttachLoadBalancerToSubnetsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("AttachLoadBalancerToSubnetsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected AttachLoadBalancerToSubnetsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected AttachLoadBalancerToSubnetsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_configure_health_check(inp: &[u8], mut builder: crate::output::configure_health_check_output::Builder) -> Result<crate::output::configure_health_check_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("ConfigureHealthCheckResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected ConfigureHealthCheckResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ConfigureHealthCheckResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected ConfigureHealthCheckResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected ConfigureHealthCheckResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_duplicate_policy_name_exception_xml_err(inp: &[u8], mut builder: crate::error::duplicate_policy_name_exception::Builder) -> Result<crate::error::duplicate_policy_name_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_too_many_policies_exception_xml_err(inp: &[u8], mut builder: crate::error::too_many_policies_exception::Builder) -> Result<crate::error::too_many_policies_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_duplicate_access_point_name_exception_xml_err(inp: &[u8], mut builder: crate::error::duplicate_access_point_name_exception::Builder) -> Result<crate::error::duplicate_access_point_name_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_too_many_access_points_exception_xml_err(inp: &[u8], mut builder: crate::error::too_many_access_points_exception::Builder) -> Result<crate::error::too_many_access_points_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_policy_type_not_found_exception_xml_err(inp: &[u8], mut builder: crate::error::policy_type_not_found_exception::Builder) -> Result<crate::error::policy_type_not_found_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_invalid_end_point_exception_xml_err(inp: &[u8], mut builder: crate::error::invalid_end_point_exception::Builder) -> Result<crate::error::invalid_end_point_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_deregister_instances_from_load_balancer(inp: &[u8], mut builder: crate::output::deregister_instances_from_load_balancer_output::Builder) -> Result<crate::output::deregister_instances_from_load_balancer_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DeregisterInstancesFromLoadBalancerResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DeregisterInstancesFromLoadBalancerResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DeregisterInstancesFromLoadBalancerResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DeregisterInstancesFromLoadBalancerResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DeregisterInstancesFromLoadBalancerResult tag"))
                    };
    Ok(builder)
}
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_instance_health(inp: &[u8], mut builder: crate::output::describe_instance_health_output::Builder) -> Result<crate::output::describe_instance_health_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeInstanceHealthResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeInstanceHealthResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeInstanceHealthResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeInstanceHealthResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeInstanceHealthResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_load_balancer_attribute_not_found_exception_xml_err(inp: &[u8], mut builder: crate::error::load_balancer_attribute_not_found_exception::Builder) -> Result<crate::error::load_balancer_attribute_not_found_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_policy_not_found_exception_xml_err(inp: &[u8], mut builder: crate::error::policy_not_found_exception::Builder) -> Result<crate::error::policy_not_found_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_load_balancer_policies(inp: &[u8], mut builder: crate::output::describe_load_balancer_policies_output::Builder) -> Result<crate::output::describe_load_balancer_policies_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeLoadBalancerPoliciesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeLoadBalancerPoliciesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeLoadBalancerPoliciesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeLoadBalancerPoliciesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeLoadBalancerPoliciesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_load_balancer_policy_types(inp: &[u8], mut builder: crate::output::describe_load_balancer_policy_types_output::Builder) -> Result<crate::output::describe_load_balancer_policy_types_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeLoadBalancerPolicyTypesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeLoadBalancerPolicyTypesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeLoadBalancerPolicyTypesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeLoadBalancerPolicyTypesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeLoadBalancerPolicyTypesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_dependency_throttle_exception_xml_err(inp: &[u8], mut builder: crate::error::dependency_throttle_exception::Builder) -> Result<crate::error::dependency_throttle_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_detach_load_balancer_from_subnets(inp: &[u8], mut builder: crate::output::detach_load_balancer_from_subnets_output::Builder) -> Result<crate::output::detach_load_balancer_from_subnets_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DetachLoadBalancerFromSubnetsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DetachLoadBalancerFromSubnetsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DetachLoadBalancerFromSubnetsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DetachLoadBalancerFromSubnetsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DetachLoadBalancerFromSubnetsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_disable_availability_zones_for_load_balancer(inp: &[u8], mut builder: crate::output::disable_availability_zones_for_load_balancer_output::Builder) -> Result<crate::output::disable_availability_zones_for_load_balancer_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DisableAvailabilityZonesForLoadBalancerResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DisableAvailabilityZonesForLoadBalancerResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DisableAvailabilityZonesForLoadBalancerResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DisableAvailabilityZonesForLoadBalancerResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DisableAvailabilityZonesForLoadBalancerResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_enable_availability_zones_for_load_balancer(inp: &[u8], mut builder: crate::output::enable_availability_zones_for_load_balancer_output::Builder) -> Result<crate::output::enable_availability_zones_for_load_balancer_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("EnableAvailabilityZonesForLoadBalancerResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected EnableAvailabilityZonesForLoadBalancerResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("EnableAvailabilityZonesForLoadBalancerResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected EnableAvailabilityZonesForLoadBalancerResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected EnableAvailabilityZonesForLoadBalancerResult tag"))
                    };
    Ok(builder)
}
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_register_instances_with_load_balancer(inp: &[u8], mut builder: crate::output::register_instances_with_load_balancer_output::Builder) -> Result<crate::output::register_instances_with_load_balancer_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("RegisterInstancesWithLoadBalancerResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected RegisterInstancesWithLoadBalancerResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("RegisterInstancesWithLoadBalancerResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected RegisterInstancesWithLoadBalancerResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected RegisterInstancesWithLoadBalancerResult tag"))
                    };
    Ok(builder)
}
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_security_groups(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_subnets(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_instances(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Instance>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_limits(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Limit>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_instance_states(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::InstanceState>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_load_balancer_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoadBalancerAttributes, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_policy_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PolicyDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_policy_type_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PolicyTypeDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_load_balancer_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::LoadBalancerDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_tag_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::TagDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_availability_zones(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_cross_zone_load_balancing(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CrossZoneLoadBalancing, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_access_log(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessLog, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_connection_draining(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConnectionDraining, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_connection_settings(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConnectionSettings, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_additional_attributes(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::AdditionalAttribute>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_policy_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyDescription, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_policy_type_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyTypeDescription, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_additional_attribute(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AdditionalAttribute, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_policy_attribute_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PolicyAttributeDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_policy_attribute_type_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PolicyAttributeTypeDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_listener_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ListenerDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_policies(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Policies, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_backend_server_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::BackendServerDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_source_security_group(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SourceSecurityGroup, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_tag_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Tag>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_policy_attribute_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyAttributeDescription, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_policy_attribute_type_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyAttributeTypeDescription, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_listener_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ListenerDescription, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_app_cookie_stickiness_policies(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::AppCookieStickinessPolicy>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_lb_cookie_stickiness_policies(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::LbCookieStickinessPolicy>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_elasticloadbalancing_policy_names(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_backend_server_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::BackendServerDescription, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_app_cookie_stickiness_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AppCookieStickinessPolicy, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_lb_cookie_stickiness_policy(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LbCookieStickinessPolicy, aws_smithy_xml::decode::XmlError> {
