...
impl super::Client  {
    ...
    pub fn set_load_balancer_policies_for_backend_server(&self) -> crate::client::fluent_builders::SetLoadBalancerPoliciesForBackendServer {
                                crate::client::fluent_builders::SetLoadBalancerPoliciesForBackendServer::new(self.handle.clone())
                            }
}
