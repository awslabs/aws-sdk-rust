...
impl super::Client  {
    ...
    pub fn set_load_balancer_listener_ssl_certificate(&self) -> crate::client::fluent_builders::SetLoadBalancerListenerSSLCertificate {
                                crate::client::fluent_builders::SetLoadBalancerListenerSSLCertificate::new(self.handle.clone())
                            }
}
