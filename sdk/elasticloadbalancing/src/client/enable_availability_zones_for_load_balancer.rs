...
impl super::Client  {
    ...
    pub fn enable_availability_zones_for_load_balancer(&self) -> crate::client::fluent_builders::EnableAvailabilityZonesForLoadBalancer {
                                crate::client::fluent_builders::EnableAvailabilityZonesForLoadBalancer::new(self.handle.clone())
                            }
}
