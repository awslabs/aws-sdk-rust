...
impl super::Client {
    ...
    ///   - [`load_balancer_name(impl Into<String>)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::load_balancer_name) / [`set_load_balancer_name(Option<String>)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::set_load_balancer_name):<br>required: **true**<br><p>The name of the load balancer.</p><br>
    ///   - [`instances(Instance)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::instances) / [`set_instances(Option<Vec::<Instance>>)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::set_instances):<br>required: **true**<br><p>The IDs of the instances.</p><br>
