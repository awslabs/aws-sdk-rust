...
impl super::Client {
    ...
    ///   - [`instances(Instance)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::instances) / [`set_instances(Option<Vec<Instance>>)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::set_instances): <p>The IDs of the instances.</p>
