...
impl super::Client {
    ...
    ///   - [`load_balancer_name(impl ::std::convert::Into<String>)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::load_balancer_name) / [`set_load_balancer_name(Option<String>)`](crate::operation::register_instances_with_load_balancer::builders::RegisterInstancesWithLoadBalancerFluentBuilder::set_load_balancer_name): <p>The name of the load balancer.</p>
