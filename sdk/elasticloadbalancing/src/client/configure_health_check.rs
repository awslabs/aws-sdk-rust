...
impl super::Client {
    ...
    ///   - [`load_balancer_name(impl Into<String>)`](crate::operation::configure_health_check::builders::ConfigureHealthCheckFluentBuilder::load_balancer_name) / [`set_load_balancer_name(Option<String>)`](crate::operation::configure_health_check::builders::ConfigureHealthCheckFluentBuilder::set_load_balancer_name):<br>required: **true**<br><p>The name of the load balancer.</p><br>
    ///   - [`health_check(HealthCheck)`](crate::operation::configure_health_check::builders::ConfigureHealthCheckFluentBuilder::health_check) / [`set_health_check(Option<HealthCheck>)`](crate::operation::configure_health_check::builders::ConfigureHealthCheckFluentBuilder::set_health_check):<br>required: **true**<br><p>The configuration information.</p><br>
