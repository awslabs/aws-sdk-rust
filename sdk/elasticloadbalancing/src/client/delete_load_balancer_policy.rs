...
impl super::Client {
    ...
    ///   - [`load_balancer_name(impl Into<String>)`](crate::operation::delete_load_balancer_policy::builders::DeleteLoadBalancerPolicyFluentBuilder::load_balancer_name) / [`set_load_balancer_name(Option<String>)`](crate::operation::delete_load_balancer_policy::builders::DeleteLoadBalancerPolicyFluentBuilder::set_load_balancer_name):<br>required: **true**<br><p>The name of the load balancer.</p><br>
    ///   - [`policy_name(impl Into<String>)`](crate::operation::delete_load_balancer_policy::builders::DeleteLoadBalancerPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::delete_load_balancer_policy::builders::DeleteLoadBalancerPolicyFluentBuilder::set_policy_name):<br>required: **true**<br><p>The name of the policy.</p><br>
