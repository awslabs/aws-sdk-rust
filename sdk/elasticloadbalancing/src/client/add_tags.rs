...
impl super::Client {
    ...
    ///   - [`load_balancer_names(impl Into<String>)`](crate::operation::add_tags::builders::AddTagsFluentBuilder::load_balancer_names) / [`set_load_balancer_names(Option<Vec<String>>)`](crate::operation::add_tags::builders::AddTagsFluentBuilder::set_load_balancer_names): <p>The name of the load balancer. You can specify one load balancer only.</p>
