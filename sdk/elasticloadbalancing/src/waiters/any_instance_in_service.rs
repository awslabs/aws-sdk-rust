...
///
/// Fluent builder for the `any_instance_in_service` waiter.
///
...
pub struct AnyInstanceInServiceFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_instance_health::builders::DescribeInstanceHealthInputBuilder,
}
impl AnyInstanceInServiceFluentBuilder {
    /// Creates a new `AnyInstanceInServiceFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::any_instance_in_service::AnyInstanceInServiceFinalPoll,
        crate::waiters::any_instance_in_service::WaitUntilAnyInstanceInServiceError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"InstanceStates[].State","expected":"InService","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_instance_health_b3a4522e5b7688145(result) {
...
/// Successful return type for the `any_instance_in_service` waiter.
pub type AnyInstanceInServiceFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_instance_health::DescribeInstanceHealthOutput,
...
/// Error type for the `any_instance_in_service` waiter.
pub type WaitUntilAnyInstanceInServiceError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_instance_health::DescribeInstanceHealthOutput,
    crate::operation::describe_instance_health::DescribeInstanceHealthError,
>;
