...
impl aws_http::request_id::RequestId for crate::error::SetLoadBalancerPoliciesForBackendServerError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
...
impl aws_http::request_id::RequestId for crate::error::DisableAvailabilityZonesForLoadBalancerError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
