...
impl aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationSettings {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_settings::de_describe_configuration_settings_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_configuration_settings::DescribeConfigurationSettingsError
{
