...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DescribeEnvironmentManagedActionHistoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DescribeEnvironmentManagedActionHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_environment_managed_action_history_input::ser_describe_environment_managed_action_history_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeEnvironmentManagedActionHistoryEndpointParamsInterceptor {
