...
impl CheckDnsAvailabilityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::check_dns_availability::CheckDNSAvailability,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckDNSAvailability {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_check_dns_availability::de_check_dns_availability_http_response_with_props(status, headers, body)
        }
    }
}
