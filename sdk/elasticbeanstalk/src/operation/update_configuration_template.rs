...
impl UpdateConfigurationTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_configuration_template::UpdateConfigurationTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConfigurationTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_configuration_template::de_update_configuration_template_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateConfigurationTemplateError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_configuration_template::UpdateConfigurationTemplateError
{
