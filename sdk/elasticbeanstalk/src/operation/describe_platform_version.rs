...
impl DescribePlatformVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_platform_version::DescribePlatformVersion,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePlatformVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_platform_version::de_describe_platform_version_http_response_with_props(status, headers, body)
        }
    }
}
