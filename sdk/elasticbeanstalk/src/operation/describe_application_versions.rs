...
impl DescribeApplicationVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_application_versions::DescribeApplicationVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApplicationVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_application_versions::de_describe_application_versions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeApplicationVersionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_application_versions::DescribeApplicationVersionsError
{
