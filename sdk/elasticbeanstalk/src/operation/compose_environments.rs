...
/// Orchestration and serialization glue logic for `ComposeEnvironments`.
...
impl ComposeEnvironments {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::compose_environments::ComposeEnvironmentsInput,
                    ) -> ::std::result::Result<crate::operation::compose_environments::ComposeEnvironmentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::compose_environments::ComposeEnvironmentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::compose_environments::ComposeEnvironmentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::compose_environments::ComposeEnvironmentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ComposeEnvironments {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ComposeEnvironments");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ComposeEnvironmentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ComposeEnvironmentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ComposeEnvironments")
...
.with_interceptor(ComposeEnvironmentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::compose_environments::ComposeEnvironmentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::compose_environments::ComposeEnvironmentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::compose_environments::ComposeEnvironmentsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ComposeEnvironmentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_compose_environments::de_compose_environments_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_compose_environments::de_compose_environments_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ComposeEnvironmentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::compose_environments::ComposeEnvironmentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::compose_environments::ComposeEnvironmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_compose_environments_input::ser_compose_environments_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ComposeEnvironmentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ComposeEnvironmentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ComposeEnvironmentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ComposeEnvironmentsInput>()
                        .ok_or("failed to downcast to ComposeEnvironmentsInput")?;
...
pub enum ComposeEnvironmentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ComposeEnvironmentsError) for what information is available for the error.")]
...
impl ComposeEnvironmentsError {
    /// Creates the `ComposeEnvironmentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ComposeEnvironmentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TooManyEnvironmentsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ComposeEnvironmentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::compose_environments::ComposeEnvironmentsError {
...
mod _compose_environments_output;
