...
impl ComposeEnvironmentsInput {
    /// Consumes the builder and constructs an Operation<[`ComposeEnvironments`](crate::operation::compose_environments::ComposeEnvironments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::compose_environments::ComposeEnvironments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::compose_environments::ComposeEnvironmentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::compose_environments::ComposeEnvironments::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ComposeEnvironments", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ComposeEnvironments`.
...
impl aws_smithy_http::response::ParseStrictResponse for ComposeEnvironments {
                type Output = std::result::Result<crate::operation::compose_environments::ComposeEnvironmentsOutput, crate::operation::compose_environments::ComposeEnvironmentsError>;
