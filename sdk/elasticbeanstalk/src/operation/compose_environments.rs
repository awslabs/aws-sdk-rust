...
impl ComposeEnvironmentsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::compose_environments::ComposeEnvironments::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ComposeEnvironments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_compose_environments::de_compose_environments_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::compose_environments::ComposeEnvironmentsError
{
