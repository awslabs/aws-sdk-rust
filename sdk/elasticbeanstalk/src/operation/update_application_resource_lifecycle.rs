...
impl UpdateApplicationResourceLifecycleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateApplicationResourceLifecycle`](crate::operation::update_application_resource_lifecycle::UpdateApplicationResourceLifecycle)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_application_resource_lifecycle::UpdateApplicationResourceLifecycle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_application_resource_lifecycle::UpdateApplicationResourceLifecycleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_application_resource_lifecycle::UpdateApplicationResourceLifecycle::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateApplicationResourceLifecycle", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateApplicationResourceLifecycle`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateApplicationResourceLifecycle {
                type Output = std::result::Result<crate::operation::update_application_resource_lifecycle::UpdateApplicationResourceLifecycleOutput, crate::operation::update_application_resource_lifecycle::UpdateApplicationResourceLifecycleError>;
