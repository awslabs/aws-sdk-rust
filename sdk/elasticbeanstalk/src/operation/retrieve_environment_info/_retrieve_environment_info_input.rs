...
impl RetrieveEnvironmentInfoInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoInput, ::aws_smithy_types::error::operation::BuildError> {
