...
impl ListAvailableSolutionStacksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_available_solution_stacks::ListAvailableSolutionStacks::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListAvailableSolutionStacksError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksError
{
