...
impl CreateStorageLocationInput {
    /// Consumes the builder and constructs an Operation<[`CreateStorageLocation`](crate::operation::create_storage_location::CreateStorageLocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_storage_location::CreateStorageLocation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_storage_location::CreateStorageLocationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_storage_location::CreateStorageLocation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateStorageLocation", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateStorageLocation`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateStorageLocation {
                type Output = std::result::Result<crate::operation::create_storage_location::CreateStorageLocationOutput, crate::operation::create_storage_location::CreateStorageLocationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_storage_location::de_create_storage_location_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_storage_location::de_create_storage_location_http_response(response)
                     }
                }
            }
