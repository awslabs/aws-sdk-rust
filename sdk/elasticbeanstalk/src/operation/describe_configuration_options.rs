...
impl DescribeConfigurationOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_configuration_options::DescribeConfigurationOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConfigurationOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_configuration_options::de_describe_configuration_options_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeConfigurationOptionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_configuration_options::DescribeConfigurationOptionsError
{
