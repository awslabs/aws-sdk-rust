...
impl RebuildEnvironmentInput {
    /// Consumes the builder and constructs an Operation<[`RebuildEnvironment`](crate::operation::rebuild_environment::RebuildEnvironment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::rebuild_environment::RebuildEnvironment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rebuild_environment::RebuildEnvironmentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::rebuild_environment::RebuildEnvironment::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RebuildEnvironment {
                type Output = std::result::Result<crate::operation::rebuild_environment::RebuildEnvironmentOutput, crate::operation::rebuild_environment::RebuildEnvironmentError>;
