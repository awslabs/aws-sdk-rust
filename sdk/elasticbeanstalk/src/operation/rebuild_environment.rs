...
impl RebuildEnvironmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rebuild_environment::RebuildEnvironment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebuildEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_rebuild_environment::de_rebuild_environment_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::rebuild_environment::RebuildEnvironmentError
{
