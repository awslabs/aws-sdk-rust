...
impl DescribeEventsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_events::DescribeEvents, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEvents {
    type Output =
        ::std::result::Result<crate::operation::describe_events::DescribeEventsOutput, crate::operation::describe_events::DescribeEventsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_events::de_describe_events_http_response_with_props(status, headers, body)
        }
    }
}
