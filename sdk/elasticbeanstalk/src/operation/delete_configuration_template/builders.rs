...
impl crate::operation::delete_configuration_template::builders::DeleteConfigurationTemplateInputBuilder {
...
impl DeleteConfigurationTemplateFluentBuilder {
    /// Creates a new `DeleteConfigurationTemplateFluentBuilder`.
