...
impl DeletePlatformVersionInput {
    /// Consumes the builder and constructs an Operation<[`DeletePlatformVersion`](crate::operation::delete_platform_version::DeletePlatformVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_platform_version::DeletePlatformVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_platform_version::DeletePlatformVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_platform_version::DeletePlatformVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeletePlatformVersion", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeletePlatformVersion`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePlatformVersion {
                type Output = std::result::Result<crate::operation::delete_platform_version::DeletePlatformVersionOutput, crate::operation::delete_platform_version::DeletePlatformVersionError>;
