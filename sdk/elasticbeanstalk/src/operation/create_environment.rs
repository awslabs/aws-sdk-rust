...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateEnvironment {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateEnvironment", "elasticbeanstalk"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CreateEnvironmentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_environment_input::ser_create_environment_input_input(
            &input,
        )?);
