...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_application_version_input::ser_create_application_version_input_input_input(&input)?);
