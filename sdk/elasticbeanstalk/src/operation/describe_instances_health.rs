...
impl DescribeInstancesHealthInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInstancesHealth`](crate::operation::describe_instances_health::DescribeInstancesHealth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_instances_health::DescribeInstancesHealth, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_instances_health::DescribeInstancesHealthInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_instances_health::DescribeInstancesHealth::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeInstancesHealth", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeInstancesHealth`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeInstancesHealth {
                type Output = std::result::Result<crate::operation::describe_instances_health::DescribeInstancesHealthOutput, crate::operation::describe_instances_health::DescribeInstancesHealthError>;
