...
impl AbortEnvironmentUpdateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::abort_environment_update::AbortEnvironmentUpdate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AbortEnvironmentUpdate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_abort_environment_update::de_abort_environment_update_http_response_with_props(status, headers, body)
        }
    }
}
