...
impl AbortEnvironmentUpdateInput {
    /// Consumes the builder and constructs an Operation<[`AbortEnvironmentUpdate`](crate::operation::abort_environment_update::AbortEnvironmentUpdate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::abort_environment_update::AbortEnvironmentUpdate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::abort_environment_update::AbortEnvironmentUpdateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::abort_environment_update::AbortEnvironmentUpdate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AbortEnvironmentUpdate", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `AbortEnvironmentUpdate`.
...
impl aws_smithy_http::response::ParseStrictResponse for AbortEnvironmentUpdate {
                type Output = std::result::Result<crate::operation::abort_environment_update::AbortEnvironmentUpdateOutput, crate::operation::abort_environment_update::AbortEnvironmentUpdateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_abort_environment_update::de_abort_environment_update_http_error(response)
                     } else {
                        crate::protocol_serde::shape_abort_environment_update::de_abort_environment_update_http_response(response)
                     }
                }
            }
