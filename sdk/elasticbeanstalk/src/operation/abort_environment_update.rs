...
/// Orchestration and serialization glue logic for `AbortEnvironmentUpdate`.
...
impl AbortEnvironmentUpdate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::abort_environment_update::AbortEnvironmentUpdateInput,
                    ) -> ::std::result::Result<crate::operation::abort_environment_update::AbortEnvironmentUpdateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::abort_environment_update::AbortEnvironmentUpdateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::abort_environment_update::AbortEnvironmentUpdateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::abort_environment_update::AbortEnvironmentUpdateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AbortEnvironmentUpdate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AbortEnvironmentUpdate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AbortEnvironmentUpdateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AbortEnvironmentUpdateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AbortEnvironmentUpdate")
...
.with_interceptor(AbortEnvironmentUpdateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::abort_environment_update::AbortEnvironmentUpdateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::abort_environment_update::AbortEnvironmentUpdateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::abort_environment_update::AbortEnvironmentUpdateError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AbortEnvironmentUpdateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_abort_environment_update::de_abort_environment_update_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AbortEnvironmentUpdateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::abort_environment_update::AbortEnvironmentUpdateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::abort_environment_update::AbortEnvironmentUpdateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_abort_environment_update_input::ser_abort_environment_update_input_input_input(&input)?);
...
#[derive(Debug)]
            struct AbortEnvironmentUpdateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AbortEnvironmentUpdateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AbortEnvironmentUpdateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AbortEnvironmentUpdateInput>()
                        .ok_or("failed to downcast to AbortEnvironmentUpdateInput")?;
...
pub enum AbortEnvironmentUpdateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AbortEnvironmentUpdateError) for what information is available for the error.")]
...
impl AbortEnvironmentUpdateError {
    /// Creates the `AbortEnvironmentUpdateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AbortEnvironmentUpdateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AbortEnvironmentUpdateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::abort_environment_update::AbortEnvironmentUpdateError {
...
mod _abort_environment_update_output;
