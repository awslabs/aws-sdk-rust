...
/// Orchestration and serialization glue logic for `SwapEnvironmentCNAMEs`.
...
impl SwapEnvironmentCNAMEs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsInput,
                    ) -> ::std::result::Result<crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SwapEnvironmentCNAMEs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SwapEnvironmentCNAMEs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SwapEnvironmentCNAMEsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SwapEnvironmentCNAMEsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SwapEnvironmentCNAMEs")
...
.with_interceptor(SwapEnvironmentCNAMEsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SwapEnvironmentCNAMEsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_swap_environment_cnames::de_swap_environment_cnames_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_swap_environment_cnames::de_swap_environment_cnames_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SwapEnvironmentCNAMEsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_swap_environment_cnames_input::ser_swap_environment_cnames_input_input_input(&input)?);
...
#[derive(Debug)]
            struct SwapEnvironmentCNAMEsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SwapEnvironmentCNAMEsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SwapEnvironmentCNAMEsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SwapEnvironmentCnamEsInput>()
                        .ok_or("failed to downcast to SwapEnvironmentCnamEsInput")?;
...
pub enum SwapEnvironmentCNAMEsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SwapEnvironmentCNAMEsError) for what information is available for the error.")]
...
impl SwapEnvironmentCNAMEsError {
    /// Creates the `SwapEnvironmentCNAMEsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SwapEnvironmentCNAMEsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SwapEnvironmentCNAMEsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError {
...
mod _swap_environment_cnames_output;
