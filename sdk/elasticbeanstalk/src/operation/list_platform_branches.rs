...
impl ListPlatformBranchesInput {
    /// Consumes the builder and constructs an Operation<[`ListPlatformBranches`](crate::operation::list_platform_branches::ListPlatformBranches)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_platform_branches::ListPlatformBranches, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_platform_branches::ListPlatformBranchesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_platform_branches::ListPlatformBranches::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListPlatformBranches", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListPlatformBranches`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListPlatformBranches {
                type Output = std::result::Result<crate::operation::list_platform_branches::ListPlatformBranchesOutput, crate::operation::list_platform_branches::ListPlatformBranchesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_platform_branches::de_list_platform_branches_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_platform_branches::de_list_platform_branches_http_response(response)
                     }
                }
            }
