...
impl DescribeEnvironmentManagedActionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_environment_managed_actions::DescribeEnvironmentManagedActions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEnvironmentManagedActions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_environment_managed_actions::de_describe_environment_managed_actions_http_response_with_props(
                status, headers, body,
            )
        }
    }
