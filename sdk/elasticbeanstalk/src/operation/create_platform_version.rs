...
impl CreatePlatformVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreatePlatformVersion`](crate::operation::create_platform_version::CreatePlatformVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_platform_version::CreatePlatformVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_platform_version::CreatePlatformVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_platform_version::CreatePlatformVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePlatformVersion", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreatePlatformVersion`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePlatformVersion {
                type Output = std::result::Result<crate::operation::create_platform_version::CreatePlatformVersionOutput, crate::operation::create_platform_version::CreatePlatformVersionError>;
