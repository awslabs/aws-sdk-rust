...
impl ValidateConfigurationSettingsInput {
    /// Consumes the builder and constructs an Operation<[`ValidateConfigurationSettings`](crate::operation::validate_configuration_settings::ValidateConfigurationSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_configuration_settings::ValidateConfigurationSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_configuration_settings::ValidateConfigurationSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_configuration_settings::ValidateConfigurationSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ValidateConfigurationSettings {
                type Output = std::result::Result<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsOutput, crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_validate_configuration_settings::de_validate_configuration_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_validate_configuration_settings::de_validate_configuration_settings_http_response(response)
                     }
                }
            }
