...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidateConfigurationSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_configuration_settings::de_validate_configuration_settings_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError
{
