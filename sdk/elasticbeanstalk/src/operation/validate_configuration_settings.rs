...
impl ValidateConfigurationSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::validate_configuration_settings::ValidateConfigurationSettingsInput,
                    ) -> ::std::result::Result<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ValidateConfigurationSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ValidateConfigurationSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ValidateConfigurationSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ValidateConfigurationSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ValidateConfigurationSettings")
...
.with_interceptor(ValidateConfigurationSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ValidateConfigurationSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_validate_configuration_settings::de_validate_configuration_settings_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ValidateConfigurationSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::validate_configuration_settings::ValidateConfigurationSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::validate_configuration_settings::ValidateConfigurationSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_validate_configuration_settings_input::ser_validate_configuration_settings_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ValidateConfigurationSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ValidateConfigurationSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ValidateConfigurationSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ValidateConfigurationSettingsInput>()
                        .ok_or("failed to downcast to ValidateConfigurationSettingsInput")?;
...
pub enum ValidateConfigurationSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ValidateConfigurationSettingsError) for what information is available for the error.")]
...
impl ValidateConfigurationSettingsError {
    /// Creates the `ValidateConfigurationSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ValidateConfigurationSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::TooManyBucketsException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ValidateConfigurationSettingsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ValidateConfigurationSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError {
...
mod _validate_configuration_settings_output;
