...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksOutput,
                    crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksError,
                > for ListAvailableSolutionStacksFluentBuilder
            {
                fn send(
                    self,
...
impl ListAvailableSolutionStacksFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_available_solution_stacks::ListAvailableSolutionStacks::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksOutput, crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksError, Self> {
