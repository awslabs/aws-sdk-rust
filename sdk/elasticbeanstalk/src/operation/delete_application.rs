...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteApplication {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteApplication", "elasticbeanstalk"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeleteApplicationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_application_input::ser_delete_application_input_input(
            &input,
        )?);
