...
impl CreateConfigurationTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_configuration_template::CreateConfigurationTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
