...
impl ApplyEnvironmentManagedActionInput {
    /// Consumes the builder and constructs an Operation<[`ApplyEnvironmentManagedAction`](crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedAction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedAction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ApplyEnvironmentManagedAction", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ApplyEnvironmentManagedAction`.
...
impl aws_smithy_http::response::ParseStrictResponse for ApplyEnvironmentManagedAction {
                type Output = std::result::Result<crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionOutput, crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_apply_environment_managed_action::de_apply_environment_managed_action_http_error(response)
                     } else {
                        crate::protocol_serde::shape_apply_environment_managed_action::de_apply_environment_managed_action_http_response(response)
                     }
                }
            }
