...
impl ::aws_smithy_http::response::ParseStrictResponse for ApplyEnvironmentManagedAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_apply_environment_managed_action::de_apply_environment_managed_action_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionError
{
