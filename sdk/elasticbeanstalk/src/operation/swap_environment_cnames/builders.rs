...
impl SwapEnvironmentCNAMEsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::swap_environment_cnames::SwapEnvironmentCnamEsOutput, crate::operation::swap_environment_cnames::SwapEnvironmentCNAMEsError, Self> {
