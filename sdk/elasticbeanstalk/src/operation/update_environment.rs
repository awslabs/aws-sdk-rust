...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateEnvironment {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateEnvironment", "elasticbeanstalk"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for UpdateEnvironmentRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_environment_input::ser_update_environment_input_input(
            &input,
        )?);
