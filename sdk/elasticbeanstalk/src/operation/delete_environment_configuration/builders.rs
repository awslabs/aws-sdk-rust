...
impl DeleteEnvironmentConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_environment_configuration::DeleteEnvironmentConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_environment_configuration::DeleteEnvironmentConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_environment_configuration::DeleteEnvironmentConfigurationOutput, crate::operation::delete_environment_configuration::DeleteEnvironmentConfigurationError, Self> {
