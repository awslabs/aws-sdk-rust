...
impl DescribeAccountAttributesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_account_attributes::DescribeAccountAttributes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_account_attributes::de_describe_account_attributes_http_response_with_props(status, headers, body)
        }
    }
}
