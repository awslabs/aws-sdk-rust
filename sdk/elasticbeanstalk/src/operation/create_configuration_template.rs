...
impl CreateConfigurationTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreateConfigurationTemplate`](crate::operation::create_configuration_template::CreateConfigurationTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_configuration_template::CreateConfigurationTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_configuration_template::CreateConfigurationTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_configuration_template::CreateConfigurationTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateConfigurationTemplate", "elasticbeanstalk"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateConfigurationTemplate`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateConfigurationTemplate {
                type Output = std::result::Result<crate::operation::create_configuration_template::CreateConfigurationTemplateOutput, crate::operation::create_configuration_template::CreateConfigurationTemplateError>;
