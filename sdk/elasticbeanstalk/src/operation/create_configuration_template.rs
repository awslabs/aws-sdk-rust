...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConfigurationTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_configuration_template::de_create_configuration_template_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateConfigurationTemplateError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_configuration_template::CreateConfigurationTemplateError
{
