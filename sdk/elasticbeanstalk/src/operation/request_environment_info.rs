...
impl RequestEnvironmentInfo {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::request_environment_info::RequestEnvironmentInfoInput,
                    ) -> ::std::result::Result<crate::operation::request_environment_info::RequestEnvironmentInfoOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_environment_info::RequestEnvironmentInfoError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::request_environment_info::RequestEnvironmentInfoError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::request_environment_info::RequestEnvironmentInfoOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RequestEnvironmentInfo {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RequestEnvironmentInfo");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RequestEnvironmentInfoRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RequestEnvironmentInfoResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RequestEnvironmentInfo")
...
.with_interceptor(RequestEnvironmentInfoEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::request_environment_info::RequestEnvironmentInfoError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::request_environment_info::RequestEnvironmentInfoError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::request_environment_info::RequestEnvironmentInfoError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RequestEnvironmentInfoResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_request_environment_info::de_request_environment_info_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_request_environment_info::de_request_environment_info_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RequestEnvironmentInfoRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::request_environment_info::RequestEnvironmentInfoInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::request_environment_info::RequestEnvironmentInfoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_request_environment_info_input::ser_request_environment_info_input_input_input(&input)?);
...
#[derive(Debug)]
            struct RequestEnvironmentInfoEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RequestEnvironmentInfoEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RequestEnvironmentInfoEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RequestEnvironmentInfoInput>()
                        .ok_or("failed to downcast to RequestEnvironmentInfoInput")?;
...
pub enum RequestEnvironmentInfoError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RequestEnvironmentInfoError) for what information is available for the error.")]
...
impl RequestEnvironmentInfoError {
    /// Creates the `RequestEnvironmentInfoError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RequestEnvironmentInfoError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RequestEnvironmentInfoError {
...
impl ::aws_types::request_id::RequestId for crate::operation::request_environment_info::RequestEnvironmentInfoError {
...
mod _request_environment_info_output;
