...
impl RequestEnvironmentInfoInput {
    /// Consumes the builder and constructs an Operation<[`RequestEnvironmentInfo`](crate::operation::request_environment_info::RequestEnvironmentInfo)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::request_environment_info::RequestEnvironmentInfo, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_environment_info::RequestEnvironmentInfoInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::request_environment_info::RequestEnvironmentInfo::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RequestEnvironmentInfo {
                type Output = std::result::Result<crate::operation::request_environment_info::RequestEnvironmentInfoOutput, crate::operation::request_environment_info::RequestEnvironmentInfoError>;
