...
pub fn serialize_operation_abort_environment_update(
...
pub fn serialize_operation_apply_environment_managed_action(
...
pub fn serialize_operation_associate_environment_operations_role(
...
pub fn serialize_operation_check_dns_availability(
...
pub fn serialize_operation_compose_environments(
...
pub fn serialize_operation_create_application(
    ...
    if let Some(var_31) = &input.resource_lifecycle_config {
        crate::query_ser::serialize_structure_application_resource_lifecycle_config(
            scope_30, var_31,
        );
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_33) = &input.tags {
        ...
        for item_34 in var_33 {
            ...
            crate::query_ser::serialize_structure_tag(entry_36, item_34);
        }
        list_35.finish();
    }
    writer.finish();
...
pub fn serialize_operation_create_application_version(
    ...
    if let Some(var_44) = &input.source_build_information {
        crate::query_ser::serialize_structure_source_build_information(scope_43, var_44);
    }
    #[allow(unused_mut)]
    let mut scope_45 = writer.prefix("SourceBundle");
    if let Some(var_46) = &input.source_bundle {
        crate::query_ser::serialize_structure_s3_location(scope_45, var_46);
    }
    #[allow(unused_mut)]
    let mut scope_47 = writer.prefix("BuildConfiguration");
    if let Some(var_48) = &input.build_configuration {
        crate::query_ser::serialize_structure_build_configuration(scope_47, var_48);
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_create_configuration_template(
    ...
    if let Some(var_67) = &input.source_configuration {
        crate::query_ser::serialize_structure_source_configuration(scope_66, var_67);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_73) = &input.option_settings {
        ...
        for item_74 in var_73 {
            ...
            crate::query_ser::serialize_structure_configuration_option_setting(entry_76, item_74);
        }
        list_75.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_78) = &input.tags {
        ...
        for item_79 in var_78 {
            ...
            crate::query_ser::serialize_structure_tag(entry_81, item_79);
        }
        list_80.finish();
    }
    writer.finish();
...
pub fn serialize_operation_create_environment(
    ...
    if let Some(var_93) = &input.tier {
        crate::query_ser::serialize_structure_environment_tier(scope_92, var_93);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_95) = &input.tags {
        ...
        for item_96 in var_95 {
            ...
            crate::query_ser::serialize_structure_tag(entry_98, item_96);
        }
        list_97.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_108) = &input.option_settings {
        ...
        for item_109 in var_108 {
            ...
            crate::query_ser::serialize_structure_configuration_option_setting(entry_111, item_109);
        }
        list_110.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_113) = &input.options_to_remove {
        ...
        for item_114 in var_113 {
            ...
            crate::query_ser::serialize_structure_option_specification(entry_116, item_114);
        }
        list_115.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_create_platform_version(
    ...
    if let Some(var_124) = &input.platform_definition_bundle {
        crate::query_ser::serialize_structure_s3_location(scope_123, var_124);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_128) = &input.option_settings {
        ...
        for item_129 in var_128 {
            ...
            crate::query_ser::serialize_structure_configuration_option_setting(entry_131, item_129);
        }
        list_130.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_133) = &input.tags {
        ...
        for item_134 in var_133 {
            ...
            crate::query_ser::serialize_structure_tag(entry_136, item_134);
        }
        list_135.finish();
    }
    writer.finish();
...
pub fn serialize_operation_create_storage_location(
...
pub fn serialize_operation_delete_application_version(
...
pub fn serialize_operation_delete_configuration_template(
...
pub fn serialize_operation_delete_environment_configuration(
...
pub fn serialize_operation_delete_platform_version(
...
pub fn serialize_operation_describe_applications(
...
pub fn serialize_operation_describe_application_versions(
...
pub fn serialize_operation_describe_configuration_options(
    ...
    if let Some(var_184) = &input.options {
        ...
        for item_185 in var_184 {
            ...
            crate::query_ser::serialize_structure_option_specification(entry_187, item_185);
        }
        list_186.finish();
    }
    writer.finish();
...
pub fn serialize_operation_describe_configuration_settings(
...
pub fn serialize_operation_describe_environment_health(
...
pub fn serialize_operation_describe_environment_managed_action_history(
...
pub fn serialize_operation_describe_environment_managed_actions(
...
pub fn serialize_operation_describe_environment_resources(
...
pub fn serialize_operation_describe_instances_health(
...
pub fn serialize_operation_describe_platform_version(
...
pub fn serialize_operation_disassociate_environment_operations_role(
...
pub fn serialize_operation_list_available_solution_stacks(
...
pub fn serialize_operation_list_platform_branches(
    ...
    if let Some(var_283) = &input.filters {
        ...
        for item_284 in var_283 {
            ...
            crate::query_ser::serialize_structure_search_filter(entry_286, item_284);
        }
        list_285.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_list_platform_versions(
    ...
    if let Some(var_292) = &input.filters {
        ...
        for item_293 in var_292 {
            ...
            crate::query_ser::serialize_structure_platform_filter(entry_295, item_293);
        }
        list_294.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_rebuild_environment(
...
pub fn serialize_operation_request_environment_info(
...
pub fn serialize_operation_restart_app_server(
...
pub fn serialize_operation_retrieve_environment_info(
...
pub fn serialize_operation_swap_environment_cnam_es(
...
pub fn serialize_operation_terminate_environment(
...
pub fn serialize_operation_update_application_resource_lifecycle(
...
pub fn serialize_operation_update_application_version(
...
pub fn serialize_operation_update_configuration_template(
    ...
    if let Some(var_359) = &input.option_settings {
        ...
        for item_360 in var_359 {
            ...
            crate::query_ser::serialize_structure_configuration_option_setting(entry_362, item_360);
        }
        list_361.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_364) = &input.options_to_remove {
        ...
        for item_365 in var_364 {
            ...
            crate::query_ser::serialize_structure_option_specification(entry_367, item_365);
        }
        list_366.finish();
    }
    writer.finish();
...
pub fn serialize_operation_update_environment(
    ...
    if let Some(var_379) = &input.tier {
        crate::query_ser::serialize_structure_environment_tier(scope_378, var_379);
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_389) = &input.option_settings {
        ...
        for item_390 in var_389 {
            ...
            crate::query_ser::serialize_structure_configuration_option_setting(entry_392, item_390);
        }
        list_391.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_394) = &input.options_to_remove {
        ...
        for item_395 in var_394 {
            ...
            crate::query_ser::serialize_structure_option_specification(entry_397, item_395);
        }
        list_396.finish();
    }
    writer.finish();
...
pub fn serialize_operation_update_tags_for_resource(
    ...
    if let Some(var_401) = &input.tags_to_add {
        ...
        for item_402 in var_401 {
            ...
            crate::query_ser::serialize_structure_tag(entry_404, item_402);
        }
        list_403.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_validate_configuration_settings(
    ...
    if let Some(var_417) = &input.option_settings {
        ...
        for item_418 in var_417 {
            ...
            crate::query_ser::serialize_structure_configuration_option_setting(entry_420, item_418);
        }
        list_419.finish();
    }
    writer.finish();
