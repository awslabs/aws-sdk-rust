...
pub(crate) fn reflens_describe_environment_managed_action_history_output_next_token(
...
pub(crate) fn reflens_list_platform_branches_output_next_token(
    input: &crate::operation::list_platform_branches::ListPlatformBranchesOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_platform_versions_output_next_token(
...
pub(crate) fn lens_describe_environment_managed_action_history_output_managed_action_history_items(
    input: crate::operation::describe_environment_managed_action_history::DescribeEnvironmentManagedActionHistoryOutput,
...
pub(crate) fn lens_list_platform_versions_output_platform_summary_list(
    input: crate::operation::list_platform_versions::ListPlatformVersionsOutput,
