...
impl super::Client {
    ...
    ///   - [`environment_id(impl Into<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::set_environment_id):<br>required: **false**<br><p>The ID of the data's environment.</p> <p>If no such environment is found, returns an <code>InvalidParameterValue</code> error.</p> <p>Condition: You must specify either this or an EnvironmentName, or both. If you do not specify either, AWS Elastic Beanstalk returns <code>MissingRequiredParameter</code> error.</p><br>
    ///   - [`environment_name(impl Into<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::set_environment_name):<br>required: **false**<br><p>The name of the data's environment.</p> <p>If no such environment is found, returns an <code>InvalidParameterValue</code> error.</p> <p>Condition: You must specify either this or an EnvironmentId, or both. If you do not specify either, AWS Elastic Beanstalk returns <code>MissingRequiredParameter</code> error.</p><br>
    ///   - [`info_type(EnvironmentInfoType)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::info_type) / [`set_info_type(Option<EnvironmentInfoType>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::set_info_type):<br>required: **true**<br><p>The type of information to retrieve.</p><br>
