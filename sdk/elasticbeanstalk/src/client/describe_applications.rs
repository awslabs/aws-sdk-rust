...
impl super::Client {
    ...
    ///   - [`application_names(impl Into<String>)`](crate::operation::describe_applications::builders::DescribeApplicationsFluentBuilder::application_names) / [`set_application_names(Option<Vec::<String>>)`](crate::operation::describe_applications::builders::DescribeApplicationsFluentBuilder::set_application_names):<br>required: **false**<br><p>If specified, AWS Elastic Beanstalk restricts the returned descriptions to only include those with the specified names.</p><br>
