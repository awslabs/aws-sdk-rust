...
impl super::Client {
    ...
    ///   - [`environment_id(impl Into<String>)`](crate::operation::describe_environment_resources::builders::DescribeEnvironmentResourcesFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::describe_environment_resources::builders::DescribeEnvironmentResourcesFluentBuilder::set_environment_id):<br>required: **false**<br><p>The ID of the environment to retrieve Amazon Web Services resource usage data.</p> <p>Condition: You must specify either this or an EnvironmentName, or both. If you do not specify either, Elastic Beanstalk returns <code>MissingRequiredParameter</code> error.</p><br>
    ///   - [`environment_name(impl Into<String>)`](crate::operation::describe_environment_resources::builders::DescribeEnvironmentResourcesFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::describe_environment_resources::builders::DescribeEnvironmentResourcesFluentBuilder::set_environment_name):<br>required: **false**<br><p>The name of the environment to retrieve Amazon Web Services resource usage data.</p> <p>Condition: You must specify either this or an EnvironmentId, or both. If you do not specify either, Elastic Beanstalk returns <code>MissingRequiredParameter</code> error.</p><br>
