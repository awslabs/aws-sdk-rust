...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::delete_configuration_template::builders::DeleteConfigurationTemplateFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::delete_configuration_template::builders::DeleteConfigurationTemplateFluentBuilder::set_template_name):<br>required: **true**<br><p>The name of the configuration template to delete.</p><br>
