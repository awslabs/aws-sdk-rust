...
impl super::Client {
    ...
    ///   - [`application_name(impl Into<String>)`](crate::operation::delete_application_version::builders::DeleteApplicationVersionFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::delete_application_version::builders::DeleteApplicationVersionFluentBuilder::set_application_name):<br>required: **true**<br><p>The name of the application to which the version belongs.</p><br>
