...
impl super::Client {
    ...
    ///   - [`application_name(impl Into<String>)`](crate::operation::compose_environments::builders::ComposeEnvironmentsFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::compose_environments::builders::ComposeEnvironmentsFluentBuilder::set_application_name):<br>required: **false**<br><p>The name of the application to which the specified source bundles belong.</p><br>
    ///   - [`group_name(impl Into<String>)`](crate::operation::compose_environments::builders::ComposeEnvironmentsFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::compose_environments::builders::ComposeEnvironmentsFluentBuilder::set_group_name):<br>required: **false**<br><p>The name of the group to which the target environments belong. Specify a group name only if the environment name defined in each target environment's manifest ends with a + (plus) character. See <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-cfg-manifest.html">Environment Manifest (env.yaml)</a> for details.</p><br>
    ///   - [`version_labels(impl Into<String>)`](crate::operation::compose_environments::builders::ComposeEnvironmentsFluentBuilder::version_labels) / [`set_version_labels(Option<Vec::<String>>)`](crate::operation::compose_environments::builders::ComposeEnvironmentsFluentBuilder::set_version_labels):<br>required: **false**<br><p>A list of version labels, specifying one or more application source bundles that belong to the target application. Each source bundle must include an environment manifest that specifies the name of the environment and the name of the solution stack to use, and optionally can specify environment links to create.</p><br>
