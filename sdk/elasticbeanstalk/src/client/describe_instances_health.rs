...
impl super::Client {
    ...
    ///   - [`attribute_names(InstancesHealthAttribute)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::attribute_names) / [`set_attribute_names(Option<Vec<InstancesHealthAttribute>>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::set_attribute_names): <p>Specifies the response elements you wish to receive. To retrieve all attributes, set to <code>All</code>. If no attribute names are specified, returns a list of instances.</p>
