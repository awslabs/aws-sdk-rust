...
impl super::Client {
    ...
    ///   - [`platform_arn(impl Into<String>)`](crate::operation::describe_platform_version::builders::DescribePlatformVersionFluentBuilder::platform_arn) / [`set_platform_arn(Option<String>)`](crate::operation::describe_platform_version::builders::DescribePlatformVersionFluentBuilder::set_platform_arn):<br>required: **false**<br><p>The ARN of the platform version.</p><br>
