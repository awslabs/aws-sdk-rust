...
impl super::Client {
    ...
    ///   - [`template_name(impl Into<String>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::set_template_name): <p>The name of the configuration template whose configuration options you want to describe.</p>
    ...
    ///   - [`solution_stack_name(impl Into<String>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::solution_stack_name) / [`set_solution_stack_name(Option<String>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::set_solution_stack_name): <p>The name of the solution stack whose configuration options you want to describe.</p>
    ///   - [`platform_arn(impl Into<String>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::platform_arn) / [`set_platform_arn(Option<String>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::set_platform_arn): <p>The ARN of the custom platform.</p>
    ///   - [`options(OptionSpecification)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::options) / [`set_options(Option<Vec<OptionSpecification>>)`](crate::operation::describe_configuration_options::builders::DescribeConfigurationOptionsFluentBuilder::set_options): <p>If specified, restricts the descriptions to only the specified options.</p>
