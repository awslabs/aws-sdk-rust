...
impl super::Client {
    ...
    ///   - [`filters(PlatformFilter)`](crate::operation::list_platform_versions::builders::ListPlatformVersionsFluentBuilder::filters) / [`set_filters(Option<Vec<PlatformFilter>>)`](crate::operation::list_platform_versions::builders::ListPlatformVersionsFluentBuilder::set_filters): <p>Criteria for restricting the resulting list of platform versions. The filter is interpreted as a logical conjunction (AND) of the separate <code>PlatformFilter</code> terms.</p>
