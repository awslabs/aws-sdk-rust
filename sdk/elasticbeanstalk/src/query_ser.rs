...
#[allow(unused_mut)]
pub fn serialize_structure_application_resource_lifecycle_config(
    ...
    if let Some(var_4) = &input.version_lifecycle_config {
        crate::query_ser::serialize_structure_application_version_lifecycle_config(scope_3, var_4);
    }
}
...
#[allow(unused_mut)]
pub fn serialize_structure_source_build_information(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_build_configuration(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_source_configuration(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_configuration_option_setting(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_environment_tier(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_option_specification(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_search_filter(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_platform_filter(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_application_version_lifecycle_config(
    mut writer: smithy_query::QueryValueWriter,
    ...
    if let Some(var_72) = &input.max_count_rule {
        crate::query_ser::serialize_structure_max_count_rule(scope_71, var_72);
    }
    #[allow(unused_mut)]
    let mut scope_73 = writer.prefix("MaxAgeRule");
    if let Some(var_74) = &input.max_age_rule {
        crate::query_ser::serialize_structure_max_age_rule(scope_73, var_74);
    }
}

#[allow(unused_mut)]
pub fn serialize_structure_max_count_rule(
    mut writer: smithy_query::QueryValueWriter,
...
#[allow(unused_mut)]
pub fn serialize_structure_max_age_rule(
    mut writer: smithy_query::QueryValueWriter,
