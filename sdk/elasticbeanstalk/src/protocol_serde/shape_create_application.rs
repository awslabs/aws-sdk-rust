...
pub fn de_create_application_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateApplicationOutput, crate::error::CreateApplicationError> {
    ...
    Err(match error_code {
        "TooManyApplicationsException" => crate::error::CreateApplicationError::TooManyApplicationsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_too_many_applications_exception::de_too_many_applications_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::CreateApplicationError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_application(inp: &[u8], mut builder: crate::output::create_application_output::Builder) -> Result<crate::output::create_application_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
