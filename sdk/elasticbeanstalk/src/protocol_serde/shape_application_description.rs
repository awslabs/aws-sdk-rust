...
pub fn de_application_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ApplicationDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
