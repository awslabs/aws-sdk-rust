...
pub fn de_delete_configuration_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_configuration_template::DeleteConfigurationTemplateOutput, crate::operation::delete_configuration_template::DeleteConfigurationTemplateError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_configuration_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_configuration_template::DeleteConfigurationTemplateOutput, crate::operation::delete_configuration_template::DeleteConfigurationTemplateError> {
    Ok({
        #[allow(unused_mut)]
