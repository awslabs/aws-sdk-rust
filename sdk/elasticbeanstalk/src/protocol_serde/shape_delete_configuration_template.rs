...
pub fn de_delete_configuration_template_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_configuration_template::DeleteConfigurationTemplateOutput, crate::operation::delete_configuration_template::DeleteConfigurationTemplateError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_configuration_template_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_configuration_template::DeleteConfigurationTemplateOutput, crate::operation::delete_configuration_template::DeleteConfigurationTemplateError> {
    Ok({
        #[allow(unused_mut)]
