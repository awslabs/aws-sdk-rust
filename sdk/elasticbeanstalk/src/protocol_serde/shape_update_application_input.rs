...
pub fn ser_update_application_input_input_input(input: &crate::operation::update_application::UpdateApplicationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
