...
pub fn de_configuration_option_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConfigurationOptionDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("ValueType") /* ValueType com.amazonaws.elasticbeanstalk#ConfigurationOptionDescription$ValueType */ =>  {
                let var_6 =
                    Some(
                        Result::<crate::model::ConfigurationOptionValueType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
