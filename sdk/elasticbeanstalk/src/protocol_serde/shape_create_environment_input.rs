...
pub fn ser_create_environment_input_input_input(input: &crate::operation::create_environment::CreateEnvironmentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
