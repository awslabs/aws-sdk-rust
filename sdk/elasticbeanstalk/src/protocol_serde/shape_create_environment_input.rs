...
pub fn ser_create_environment_input_input(input: &crate::input::CreateEnvironmentInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
