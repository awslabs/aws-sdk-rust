...
pub fn de_delete_platform_version_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_platform_version::DeletePlatformVersionOutput, crate::operation::delete_platform_version::DeletePlatformVersionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_platform_version_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_platform_version::DeletePlatformVersionOutput, crate::operation::delete_platform_version::DeletePlatformVersionError> {
    Ok({
        #[allow(unused_mut)]
