...
pub fn de_delete_platform_version_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_platform_version::DeletePlatformVersionOutput, crate::operation::delete_platform_version::DeletePlatformVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_platform_version::DeletePlatformVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_platform_version_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_platform_version::DeletePlatformVersionOutput, crate::operation::delete_platform_version::DeletePlatformVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_platform_version::builders::DeletePlatformVersionOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_platform_version::de_delete_platform_version(_response_body, output).map_err(crate::operation::delete_platform_version::DeletePlatformVersionError::unhandled)?;
