...
pub fn de_environment_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EnvironmentDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
