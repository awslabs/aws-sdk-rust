...
pub fn ser_create_configuration_template_input_input_input(input: &crate::operation::create_configuration_template::CreateConfigurationTemplateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
