...
pub fn ser_create_configuration_template_input_input(input: &crate::input::CreateConfigurationTemplateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
