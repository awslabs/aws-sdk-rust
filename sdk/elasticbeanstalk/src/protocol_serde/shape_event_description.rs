...
pub fn de_event_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EventDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Severity") /* Severity com.amazonaws.elasticbeanstalk#EventDescription$Severity */ =>  {
                let var_9 =
                    Some(
                        Result::<crate::model::EventSeverity, aws_smithy_xml::decode::XmlDecodeError>::Ok(
