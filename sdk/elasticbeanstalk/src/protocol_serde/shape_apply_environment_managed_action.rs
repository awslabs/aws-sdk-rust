...
pub fn de_apply_environment_managed_action_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionOutput, crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionError> {
    #[allow(unused_mut)]
