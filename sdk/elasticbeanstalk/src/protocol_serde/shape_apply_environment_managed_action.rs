...
pub fn de_apply_environment_managed_action_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionOutput, crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_apply_environment_managed_action_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionOutput, crate::operation::apply_environment_managed_action::ApplyEnvironmentManagedActionError> {
    Ok({
        #[allow(unused_mut)]
