...
pub fn ser_restart_app_server_input_input(input: &crate::operation::restart_app_server::RestartAppServerInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
