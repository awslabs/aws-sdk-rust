...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_platform_version_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_platform_version::CreatePlatformVersionOutput, crate::operation::create_platform_version::CreatePlatformVersionError> {
    Ok({
        #[allow(unused_mut)]
