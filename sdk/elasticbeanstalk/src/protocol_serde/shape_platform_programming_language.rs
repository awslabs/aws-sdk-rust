...
pub fn de_platform_programming_language(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PlatformProgrammingLanguage, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
