...
#[allow(unused_mut)]
pub fn ser_environment_tier(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::EnvironmentTier) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
