...
#[allow(unused_mut)]
pub fn ser_environment_tier(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::EnvironmentTier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_environment_tier(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EnvironmentTier, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
