...
pub fn ser_list_platform_versions_input_input_input(input: &crate::operation::list_platform_versions::ListPlatformVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
