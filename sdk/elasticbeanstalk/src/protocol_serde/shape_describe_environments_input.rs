...
pub fn ser_describe_environments_input_input(input: &crate::input::DescribeEnvironmentsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
