...
pub fn ser_describe_environments_input_input_input(input: &crate::operation::describe_environments::DescribeEnvironmentsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
