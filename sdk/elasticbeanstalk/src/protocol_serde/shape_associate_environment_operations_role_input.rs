...
pub fn ser_associate_environment_operations_role_input_input(input: &crate::input::AssociateEnvironmentOperationsRoleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
