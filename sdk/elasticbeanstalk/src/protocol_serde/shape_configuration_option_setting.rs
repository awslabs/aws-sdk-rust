...
#[allow(unused_mut)]
pub fn ser_configuration_option_setting(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ConfigurationOptionSetting) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
