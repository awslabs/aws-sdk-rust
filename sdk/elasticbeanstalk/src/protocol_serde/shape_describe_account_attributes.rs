...
> {
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => {
            crate::operation::describe_account_attributes::DescribeAccountAttributesError::InsufficientPrivilegesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("ResourceQuotas") /* ResourceQuotas com.amazonaws.elasticbeanstalk.synthetic#DescribeAccountAttributesOutput$ResourceQuotas */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_resource_quotas::de_resource_quotas(&mut tag, depth + 1)
                        ?
                    )
                ;
