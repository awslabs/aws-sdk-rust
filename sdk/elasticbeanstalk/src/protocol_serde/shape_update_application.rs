...
#[allow(unused_mut)]
pub fn de_update_application(inp: &[u8], mut builder: crate::output::update_application_output::Builder) -> Result<crate::output::update_application_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
