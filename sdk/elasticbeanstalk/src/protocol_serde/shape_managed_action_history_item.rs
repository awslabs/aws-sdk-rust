...
pub fn de_managed_action_history_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ManagedActionHistoryItem, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("FailureType") /* FailureType com.amazonaws.elasticbeanstalk#ManagedActionHistoryItem$FailureType */ =>  {
                let var_4 =
                    Some(
                        Result::<crate::model::FailureType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
            ...
            s if s.matches("Status") /* Status com.amazonaws.elasticbeanstalk#ManagedActionHistoryItem$Status */ =>  {
                let var_5 =
                    Some(
                        Result::<crate::model::ActionHistoryStatus, aws_smithy_xml::decode::XmlDecodeError>::Ok(
