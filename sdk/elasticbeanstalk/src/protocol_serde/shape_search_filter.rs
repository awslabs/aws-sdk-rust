...
#[allow(unused_mut)]
pub fn ser_search_filter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SearchFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
