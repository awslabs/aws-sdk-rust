...
#[allow(unused_mut)]
pub fn ser_search_filter(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SearchFilter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
