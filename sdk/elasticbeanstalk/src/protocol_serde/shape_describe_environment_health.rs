...
pub fn de_describe_environment_health_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_environment_health::DescribeEnvironmentHealthError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_environment_health_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    Ok({
        #[allow(unused_mut)]
