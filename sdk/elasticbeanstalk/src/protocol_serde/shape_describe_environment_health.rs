...
pub fn de_describe_environment_health_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_environment_health_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    Ok({
        #[allow(unused_mut)]
