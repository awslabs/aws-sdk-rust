...
pub fn de_describe_environment_health_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_environment_health::DescribeEnvironmentHealthError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_elastic_beanstalk_service_exception::de_elastic_beanstalk_service_exception_xml_err(_response_body, output).map_err(crate::operation::describe_environment_health::DescribeEnvironmentHealthError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_request_exception::de_invalid_request_exception_xml_err(_response_body, output).map_err(crate::operation::describe_environment_health::DescribeEnvironmentHealthError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_environment_health_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_environment_health::builders::DescribeEnvironmentHealthOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_environment_health::de_describe_environment_health(_response_body, output).map_err(crate::operation::describe_environment_health::DescribeEnvironmentHealthError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_describe_environment_health(inp: &[u8], mut builder: crate::operation::describe_environment_health::builders::DescribeEnvironmentHealthOutputBuilder) -> Result<crate::operation::describe_environment_health::builders::DescribeEnvironmentHealthOutputBuilder, aws_smithy_xml::decode::XmlDecodeError> {
