...
pub fn de_environment_resource_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EnvironmentResourceDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
