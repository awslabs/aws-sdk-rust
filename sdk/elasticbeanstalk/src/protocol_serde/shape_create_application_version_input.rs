...
pub fn ser_create_application_version_input_input_input(input: &crate::operation::create_application_version::CreateApplicationVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
