...
pub fn ser_create_application_version_input_input(
    ...
    if let Some(var_8) = &input.source_build_information {
        crate::protocol_serde::shape_source_build_information::ser_source_build_information(
            scope_7, var_8,
        )?;
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_12) = &input.build_configuration {
        crate::protocol_serde::shape_build_configuration::ser_build_configuration(
            scope_11, var_12,
        )?;
    }
    #[allow(unused_mut)]
