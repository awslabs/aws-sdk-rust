...
pub fn ser_create_application_version_input_input(input: &crate::input::CreateApplicationVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
