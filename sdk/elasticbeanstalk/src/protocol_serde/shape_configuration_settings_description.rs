...
pub fn de_configuration_settings_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ConfigurationSettingsDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
