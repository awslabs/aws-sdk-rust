...
pub fn ser_describe_application_versions_input_input(input: &crate::input::DescribeApplicationVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
