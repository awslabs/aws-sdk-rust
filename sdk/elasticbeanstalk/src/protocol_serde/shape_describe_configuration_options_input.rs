...
pub fn ser_describe_configuration_options_input_input_input(input: &crate::operation::describe_configuration_options::DescribeConfigurationOptionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
