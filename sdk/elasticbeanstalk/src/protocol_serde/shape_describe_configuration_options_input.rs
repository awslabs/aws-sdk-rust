...
pub fn ser_describe_configuration_options_input_input(input: &crate::input::DescribeConfigurationOptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
