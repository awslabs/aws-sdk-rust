...
#[allow(unused_mut)]
pub fn ser_max_count_rule(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MaxCountRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_max_count_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MaxCountRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
