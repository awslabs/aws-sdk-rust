...
pub fn ser_update_environment_input_input_input(input: &crate::operation::update_environment::UpdateEnvironmentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
