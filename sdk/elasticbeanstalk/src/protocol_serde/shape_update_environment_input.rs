...
pub fn ser_update_environment_input_input(input: &crate::input::UpdateEnvironmentInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
