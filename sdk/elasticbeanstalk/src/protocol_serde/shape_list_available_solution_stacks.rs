...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_available_solution_stacks::de_list_available_solution_stacks(_response_body, output)
            .map_err(crate::operation::list_available_solution_stacks::ListAvailableSolutionStacksError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ListAvailableSolutionStacksResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ListAvailableSolutionStacksResult got {start_el:?}"
            )));
        }
