...
pub fn de_platform_branch_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PlatformBranchSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
