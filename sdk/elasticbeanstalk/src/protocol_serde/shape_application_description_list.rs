...
pub fn de_application_description_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::ApplicationDescription>, aws_smithy_xml::decode::XmlDecodeError> {
