...
pub fn de_application_version_description_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ApplicationVersionDescription>, aws_smithy_xml::decode::XmlDecodeError> {
