...
pub fn de_create_storage_location_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_storage_location::CreateStorageLocationOutput, crate::operation::create_storage_location::CreateStorageLocationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_storage_location::CreateStorageLocationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_storage_location_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_storage_location::CreateStorageLocationOutput, crate::operation::create_storage_location::CreateStorageLocationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_storage_location::builders::CreateStorageLocationOutputBuilder::default();
        output = crate::protocol_serde::shape_create_storage_location::de_create_storage_location(_response_body, output).map_err(crate::operation::create_storage_location::CreateStorageLocationError::unhandled)?;
