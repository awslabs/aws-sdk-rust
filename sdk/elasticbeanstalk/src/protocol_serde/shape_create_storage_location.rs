...
pub fn de_create_storage_location_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_storage_location::CreateStorageLocationOutput, crate::operation::create_storage_location::CreateStorageLocationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_storage_location_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_storage_location::CreateStorageLocationOutput, crate::operation::create_storage_location::CreateStorageLocationError> {
    Ok({
        #[allow(unused_mut)]
