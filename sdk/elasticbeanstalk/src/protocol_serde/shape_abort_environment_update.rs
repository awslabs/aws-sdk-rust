...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::abort_environment_update::AbortEnvironmentUpdateError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => {
            crate::operation::abort_environment_update::AbortEnvironmentUpdateError::InsufficientPrivilegesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
