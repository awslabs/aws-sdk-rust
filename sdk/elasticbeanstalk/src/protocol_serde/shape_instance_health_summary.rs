...
pub fn de_instance_health_summary(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InstanceHealthSummary, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
