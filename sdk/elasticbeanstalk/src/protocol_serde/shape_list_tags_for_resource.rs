...
pub fn de_list_tags_for_resource_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListTagsForResourceOutput, crate::error::ListTagsForResourceError> {
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => crate::error::ListTagsForResourceError::InsufficientPrivilegesException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceTypeNotSupportedException" => crate::error::ListTagsForResourceError::ResourceTypeNotSupportedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
