...
#[allow(unused_mut)]
pub fn ser_max_age_rule(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MaxAgeRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_max_age_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MaxAgeRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
