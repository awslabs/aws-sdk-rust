...
pub fn de_environment_info_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EnvironmentInfoDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("InfoType") /* InfoType com.amazonaws.elasticbeanstalk#EnvironmentInfoDescription$InfoType */ =>  {
                let var_1 =
                    Some(
                        Result::<crate::model::EnvironmentInfoType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
