...
#[allow(unused_mut)]
pub fn ser_application_version_lifecycle_config(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ApplicationVersionLifecycleConfig) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
