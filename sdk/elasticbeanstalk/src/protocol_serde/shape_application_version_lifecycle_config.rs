...
#[allow(unused_mut)]
pub fn ser_application_version_lifecycle_config(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ApplicationVersionLifecycleConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_application_version_lifecycle_config(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ApplicationVersionLifecycleConfig, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
