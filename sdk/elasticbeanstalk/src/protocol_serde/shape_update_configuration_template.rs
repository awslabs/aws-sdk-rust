...
pub fn de_update_configuration_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateConfigurationTemplateOutput, crate::error::UpdateConfigurationTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateConfigurationTemplateError::unhandled)?;
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => crate::error::UpdateConfigurationTemplateError::InsufficientPrivilegesException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_insufficient_privileges_exception::de_insufficient_privileges_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::UpdateConfigurationTemplateError::unhandled)?;
        ...
        "TooManyBucketsException" => crate::error::UpdateConfigurationTemplateError::TooManyBucketsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_too_many_buckets_exception::de_too_many_buckets_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::UpdateConfigurationTemplateError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_configuration_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateConfigurationTemplateOutput, crate::error::UpdateConfigurationTemplateError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::update_configuration_template_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_configuration_template::de_update_configuration_template(response.body().as_ref(), output).map_err(crate::error::UpdateConfigurationTemplateError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_update_configuration_template(inp: &[u8], mut builder: crate::output::update_configuration_template_output::Builder) -> Result<crate::output::update_configuration_template_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
