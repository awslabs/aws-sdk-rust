...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_configuration_template::UpdateConfigurationTemplateError::unhandled)?;
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => {
            crate::operation::update_configuration_template::UpdateConfigurationTemplateError::InsufficientPrivilegesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_configuration_template::de_update_configuration_template(_response_body, output)
            .map_err(crate::operation::update_configuration_template::UpdateConfigurationTemplateError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("UpdateConfigurationTemplateResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected UpdateConfigurationTemplateResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("UpdateConfigurationTemplateResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected UpdateConfigurationTemplateResult got {start_el:?}"
            )));
        }
