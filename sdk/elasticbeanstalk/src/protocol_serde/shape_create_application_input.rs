...
pub fn ser_create_application_input_input_input(input: &crate::operation::create_application::CreateApplicationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
