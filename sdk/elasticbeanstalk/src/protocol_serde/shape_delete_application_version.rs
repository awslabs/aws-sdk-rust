...
pub fn de_delete_application_version_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_application_version::DeleteApplicationVersionOutput, crate::operation::delete_application_version::DeleteApplicationVersionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_application_version_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_application_version::DeleteApplicationVersionOutput, crate::operation::delete_application_version::DeleteApplicationVersionError> {
    Ok({
        #[allow(unused_mut)]
