...
pub fn de_option_restriction_regex(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OptionRestrictionRegex, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
