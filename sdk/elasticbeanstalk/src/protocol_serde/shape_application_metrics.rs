...
pub fn de_application_metrics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ApplicationMetrics, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
