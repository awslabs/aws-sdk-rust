...
pub fn de_update_tags_for_resource_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_tags_for_resource::UpdateTagsForResourceOutput, crate::operation::update_tags_for_resource::UpdateTagsForResourceError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_tags_for_resource_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_tags_for_resource::UpdateTagsForResourceOutput, crate::operation::update_tags_for_resource::UpdateTagsForResourceError> {
    Ok({
        #[allow(unused_mut)]
