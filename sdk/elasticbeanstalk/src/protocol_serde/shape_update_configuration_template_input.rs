...
pub fn ser_update_configuration_template_input_input_input(input: &crate::operation::update_configuration_template::UpdateConfigurationTemplateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
