...
#[allow(unused_mut)]
pub fn ser_source_build_information(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SourceBuildInformation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_source_build_information(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SourceBuildInformation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
