...
pub fn de_rebuild_environment_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::rebuild_environment::RebuildEnvironmentOutput, crate::operation::rebuild_environment::RebuildEnvironmentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::rebuild_environment::RebuildEnvironmentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_rebuild_environment_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::rebuild_environment::RebuildEnvironmentOutput, crate::operation::rebuild_environment::RebuildEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
