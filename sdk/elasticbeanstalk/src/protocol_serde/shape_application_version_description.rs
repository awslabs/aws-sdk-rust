...
pub fn de_application_version_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ApplicationVersionDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Status") /* Status com.amazonaws.elasticbeanstalk#ApplicationVersionDescription$Status */ =>  {
                let var_10 =
                    Some(
                        Result::<crate::model::ApplicationVersionStatus, aws_smithy_xml::decode::XmlDecodeError>::Ok(
