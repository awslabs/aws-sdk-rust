...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_configuration_settings::DescribeConfigurationSettingsError::unhandled)?;
    ...
    Err(match error_code {
        "TooManyBucketsException" => {
            crate::operation::describe_configuration_settings::DescribeConfigurationSettingsError::TooManyBucketsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_configuration_settings::de_describe_configuration_settings(_response_body, output)
            .map_err(crate::operation::describe_configuration_settings::DescribeConfigurationSettingsError::unhandled)?;
...
pub fn de_describe_configuration_settings(
    inp: &[u8],
    mut builder: crate::operation::describe_configuration_settings::builders::DescribeConfigurationSettingsOutputBuilder,
) -> std::result::Result<
    crate::operation::describe_configuration_settings::builders::DescribeConfigurationSettingsOutputBuilder,
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeConfigurationSettingsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeConfigurationSettingsResult got {start_el:?}"
            )));
        }
