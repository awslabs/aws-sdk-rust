...
pub fn de_terminate_environment_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::TerminateEnvironmentOutput, crate::error::TerminateEnvironmentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::TerminateEnvironmentError::unhandled)?;
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => crate::error::TerminateEnvironmentError::InsufficientPrivilegesException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_terminate_environment_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::TerminateEnvironmentOutput, crate::error::TerminateEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::terminate_environment_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_terminate_environment::de_terminate_environment(response.body().as_ref(), output).map_err(crate::error::TerminateEnvironmentError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_terminate_environment(inp: &[u8], mut builder: crate::output::terminate_environment_output::Builder) -> Result<crate::output::terminate_environment_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
