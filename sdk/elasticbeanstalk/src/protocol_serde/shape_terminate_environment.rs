...
pub fn de_terminate_environment_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::terminate_environment::TerminateEnvironmentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_terminate_environment_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::terminate_environment::builders::TerminateEnvironmentOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_terminate_environment::de_terminate_environment(response.body().as_ref(), output).map_err(crate::operation::terminate_environment::TerminateEnvironmentError::unhandled)?;
