...
pub fn de_terminate_environment_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_terminate_environment_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
