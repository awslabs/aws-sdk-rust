...
pub fn de_terminate_environment_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::terminate_environment::TerminateEnvironmentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_terminate_environment_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::terminate_environment::builders::TerminateEnvironmentOutputBuilder::default();
        output = crate::protocol_serde::shape_terminate_environment::de_terminate_environment(_response_body, output).map_err(crate::operation::terminate_environment::TerminateEnvironmentError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_terminate_environment(inp: &[u8], mut builder: crate::operation::terminate_environment::builders::TerminateEnvironmentOutputBuilder) -> Result<crate::operation::terminate_environment::builders::TerminateEnvironmentOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("TerminateEnvironmentResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected TerminateEnvironmentResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("TerminateEnvironmentResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected TerminateEnvironmentResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected TerminateEnvironmentResult tag"))
                    };
    Ok(builder)
}
