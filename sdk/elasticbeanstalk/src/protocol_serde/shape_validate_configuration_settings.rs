...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError::unhandled)?;
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => {
            crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError::InsufficientPrivilegesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyBucketsException" => {
            crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError::TooManyBucketsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_validate_configuration_settings::de_validate_configuration_settings(_response_body, output)
            .map_err(crate::operation::validate_configuration_settings::ValidateConfigurationSettingsError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("ValidateConfigurationSettingsResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ValidateConfigurationSettingsResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ValidateConfigurationSettingsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ValidateConfigurationSettingsResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("Messages") /* Messages com.amazonaws.elasticbeanstalk.synthetic#ValidateConfigurationSettingsOutput$Messages */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_validation_messages_list::de_validation_messages_list(&mut tag, depth + 1)
                        ?
                    )
                ;
