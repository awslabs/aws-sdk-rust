...
pub fn de_validation_message(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ValidationMessage, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Severity") /* Severity com.amazonaws.elasticbeanstalk#ValidationMessage$Severity */ =>  {
                let var_2 =
                    Some(
                        Result::<crate::model::ValidationSeverity, aws_smithy_xml::decode::XmlDecodeError>::Ok(
