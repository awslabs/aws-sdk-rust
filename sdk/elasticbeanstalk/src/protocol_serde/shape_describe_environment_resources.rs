...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_environment_resources::DescribeEnvironmentResourcesError::unhandled)?;
    ...
    Err(match error_code {
        "InsufficientPrivilegesException" => {
            crate::operation::describe_environment_resources::DescribeEnvironmentResourcesError::InsufficientPrivilegesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_environment_resources::de_describe_environment_resources(_response_body, output)
            .map_err(crate::operation::describe_environment_resources::DescribeEnvironmentResourcesError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeEnvironmentResourcesResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeEnvironmentResourcesResult got {start_el:?}"
            )));
        }
