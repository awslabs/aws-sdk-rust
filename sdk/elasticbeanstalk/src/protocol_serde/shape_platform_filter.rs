...
#[allow(unused_mut)]
pub fn ser_platform_filter(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::PlatformFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
