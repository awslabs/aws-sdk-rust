...
#[allow(unused_mut)]
pub fn ser_platform_filter(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::PlatformFilter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
