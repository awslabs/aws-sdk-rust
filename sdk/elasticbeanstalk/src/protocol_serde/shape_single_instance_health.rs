...
pub fn de_single_instance_health(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SingleInstanceHealth, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
