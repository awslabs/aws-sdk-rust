...
pub fn de_platform_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PlatformDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("PlatformStatus") /* PlatformStatus com.amazonaws.elasticbeanstalk#PlatformDescription$PlatformStatus */ =>  {
                let var_6 =
                    Some(
                        Result::<crate::model::PlatformStatus, aws_smithy_xml::decode::XmlDecodeError>::Ok(
