...
pub fn de_platform_framework(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PlatformFramework, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::PlatformFramework::builder();
