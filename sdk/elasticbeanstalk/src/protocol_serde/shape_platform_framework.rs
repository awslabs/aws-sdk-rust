...
pub fn de_platform_framework(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PlatformFramework, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
