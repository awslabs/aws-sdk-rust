...
pub fn ser_create_platform_version_input_input_input(input: &crate::operation::create_platform_version::CreatePlatformVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
