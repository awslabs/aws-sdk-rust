...
pub fn ser_update_application_version_input_input(input: &crate::operation::update_application_version::UpdateApplicationVersionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
