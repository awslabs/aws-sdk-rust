...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_platform_version::DescribePlatformVersionError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_platform_version::DescribePlatformVersionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "ElasticBeanstalkServiceException" => {
            crate::operation::describe_platform_version::DescribePlatformVersionError::ElasticBeanstalkServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InsufficientPrivilegesException" => {
            crate::operation::describe_platform_version::DescribePlatformVersionError::InsufficientPrivilegesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_platform_version::de_describe_platform_version(_response_body, output)
            .map_err(crate::operation::describe_platform_version::DescribePlatformVersionError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribePlatformVersionResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribePlatformVersionResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribePlatformVersionResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribePlatformVersionResult got {start_el:?}"
            )));
        }
        while let Some(mut tag) = result_tag.next_tag() {
            ...
            s if s.matches("PlatformDescription") /* PlatformDescription com.amazonaws.elasticbeanstalk.synthetic#DescribePlatformVersionOutput$PlatformDescription */ =>  {
                let var_1 =
                    Some(
                        crate::protocol_serde::shape_platform_description::de_platform_description(&mut tag, depth + 1)
                        ?
                    )
                ;
