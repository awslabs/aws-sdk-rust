...
///
/// Fluent builder for the `environment_updated` waiter.
///
...
pub struct EnvironmentUpdatedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_environments::builders::DescribeEnvironmentsInputBuilder,
}
impl EnvironmentUpdatedFluentBuilder {
    /// Creates a new `EnvironmentUpdatedFluentBuilder`.
    ...
    /// Wait for `environment_updated`
    pub async fn wait(
        self,
        max_wait: ::std::time::Duration,
    ) -> ::std::result::Result<
        crate::waiters::environment_updated::EnvironmentUpdatedFinalPoll,
        crate::waiters::environment_updated::WaitUntilEnvironmentUpdatedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            // Matches: {"output":{"path":"Environments[].Status","expected":"Updating","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_environments_360c965395e4199b1(result) {
...
/// Successful return type for the `environment_updated` waiter.
pub type EnvironmentUpdatedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_environments::DescribeEnvironmentsOutput,
...
/// Error type for the `environment_updated` waiter.
pub type WaitUntilEnvironmentUpdatedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_environments::DescribeEnvironmentsOutput,
    crate::operation::describe_environments::DescribeEnvironmentsError,
>;
