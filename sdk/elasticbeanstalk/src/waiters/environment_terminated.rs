...
///
/// Fluent builder for the `environment_terminated` waiter.
///
...
pub struct EnvironmentTerminatedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_environments::builders::DescribeEnvironmentsInputBuilder,
}
impl EnvironmentTerminatedFluentBuilder {
    /// Creates a new `EnvironmentTerminatedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::environment_terminated::EnvironmentTerminatedFinalPoll,
        crate::waiters::environment_terminated::WaitUntilEnvironmentTerminatedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"Environments[].Status","expected":"Terminated","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_environments_ed794ae98072768c5(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Environments[].Status","expected":"Terminating","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_environments_0f48372938831eb5d(result) {
...
/// Successful return type for the `environment_terminated` waiter.
pub type EnvironmentTerminatedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_environments::DescribeEnvironmentsOutput,
...
/// Error type for the `environment_terminated` waiter.
pub type WaitUntilEnvironmentTerminatedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_environments::DescribeEnvironmentsOutput,
    crate::operation::describe_environments::DescribeEnvironmentsError,
>;
