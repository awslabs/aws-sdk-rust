...
/// <p>The Elastic Beanstalk quota information for a single resource type in an Amazon Web Services account. It reflects the resource's limits for this account.</p>
#[non_exhaustive]
