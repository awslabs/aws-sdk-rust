...
impl super::Client {
    ...
    ///   - [`connection_arn(impl Into<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::connection_arn) / [`set_connection_arn(Option<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::set_connection_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the connection to be deleted.</p><note>  <p>The ARN is never reused if the connection is deleted.</p> </note><br>
