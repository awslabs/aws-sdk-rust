...
impl crate::operation::update_host::builders::UpdateHostInputBuilder {
...
impl UpdateHostFluentBuilder {
    /// Creates a new `UpdateHostFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_host::UpdateHost::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_host::UpdateHost::orchestrate(&runtime_plugins, input).await
    }
