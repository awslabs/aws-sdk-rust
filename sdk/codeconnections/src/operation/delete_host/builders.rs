...
impl crate::operation::delete_host::builders::DeleteHostInputBuilder {
...
impl DeleteHostFluentBuilder {
    /// Creates a new `DeleteHostFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_host::DeleteHost::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_host::DeleteHost::orchestrate(&runtime_plugins, input).await
    }
