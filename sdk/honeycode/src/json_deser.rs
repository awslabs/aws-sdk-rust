...
pub fn deser_structure_crate_error_automation_execution_exceptionjson_err(
    input: &[u8],
...
pub fn deser_structure_crate_error_automation_execution_timeout_exceptionjson_err(
    input: &[u8],
