...
pub(crate) fn reflens_list_table_columns_output_output_next_token(
...
pub(crate) fn reflens_list_table_rows_output_output_next_token(
...
pub(crate) fn reflens_query_table_rows_output_output_next_token(
...
pub(crate) fn lens_list_table_columns_output_output_table_columns(
    input: crate::operation::list_table_columns::ListTableColumnsOutput,
...
pub(crate) fn lens_list_table_rows_output_output_rows(
    input: crate::operation::list_table_rows::ListTableRowsOutput,
...
pub(crate) fn lens_query_table_rows_output_output_rows(
    input: crate::operation::query_table_rows::QueryTableRowsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::TableRow>> {
    let input = input.rows;
    ::std::option::Option::Some(input)
