...
impl BatchDeleteTableRowsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_delete_table_rows::BatchDeleteTableRowsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_delete_table_rows::BatchDeleteTableRowsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_delete_table_rows::BatchDeleteTableRowsOutput, crate::operation::batch_delete_table_rows::BatchDeleteTableRowsError, Self> {
