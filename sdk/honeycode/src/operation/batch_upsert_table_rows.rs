...
impl BatchUpsertTableRowsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_upsert_table_rows::BatchUpsertTableRows,
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUpsertTableRows {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_upsert_table_rows::de_batch_upsert_table_rows_http_response_with_props(status, headers, body)
        }
    }
}
