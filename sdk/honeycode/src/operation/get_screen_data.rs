...
impl GetScreenDataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_screen_data::GetScreenData, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_screen_data::ser_get_screen_data_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetScreenData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_screen_data::de_get_screen_data_http_response_with_props(status, headers, body)
        }
    }
