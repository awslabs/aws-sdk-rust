...
impl DescribeTableDataImportJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_table_data_import_job::DescribeTableDataImportJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTableDataImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_table_data_import_job::de_describe_table_data_import_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
