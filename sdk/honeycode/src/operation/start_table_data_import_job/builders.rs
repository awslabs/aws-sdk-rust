...
impl StartTableDataImportJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_table_data_import_job::StartTableDataImportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_table_data_import_job::StartTableDataImportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_table_data_import_job::StartTableDataImportJobOutput, crate::operation::start_table_data_import_job::StartTableDataImportJobError, Self> {
