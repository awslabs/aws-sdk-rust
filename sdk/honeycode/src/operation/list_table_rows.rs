...
impl ListTableRowsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_table_rows::ListTableRows, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_table_rows::ser_list_table_rows_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTableRows {
    type Output =
        ::std::result::Result<crate::operation::list_table_rows::ListTableRowsOutput, crate::operation::list_table_rows::ListTableRowsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_table_rows::de_list_table_rows_http_response_with_props(status, headers, body)
        }
    }
