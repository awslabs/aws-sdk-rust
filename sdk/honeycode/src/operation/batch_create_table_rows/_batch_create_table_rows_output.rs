...
impl BatchCreateTableRowsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_create_table_rows::BatchCreateTableRowsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::batch_create_table_rows::BatchCreateTableRowsOutput {
                ...
                created_rows: self.created_rows
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_rows", "created_rows was not specified but it is required when building BatchCreateTableRowsOutput")
                    )?
                ,
