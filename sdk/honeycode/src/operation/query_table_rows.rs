...
impl QueryTableRowsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::query_table_rows::QueryTableRows, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_query_table_rows::ser_query_table_rows_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryTableRows {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query_table_rows::de_query_table_rows_http_response_with_props(status, headers, body)
        }
    }
