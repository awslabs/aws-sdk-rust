...
pub struct StartTableDataImportJobOutput  {
    ...
    #[doc(hidden)]pub job_status: std::option::Option<crate::model::TableDataImportJobStatus>,
}
...
pub struct QueryTableRowsOutput  {
    ...
    #[doc(hidden)]pub column_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p> The list of rows in the table that match the query filter. </p>
    #[doc(hidden)]pub rows: std::option::Option<std::vec::Vec<crate::model::TableRow>>,
    ...
    #[doc(hidden)]pub workbook_cursor: i64,
}
...
pub struct ListTablesOutput  {
    ...
    #[doc(hidden)]pub tables: std::option::Option<std::vec::Vec<crate::model::Table>>,
    /// <p> Provides the pagination token to load the next page if there are more results matching the request. If a pagination token is not present in the response, it means that all data matching the request has been loaded. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p> Indicates the cursor of the workbook at which the data returned by this request is read. Workbook cursor keeps increasing with every update and the increments are not sequential. </p>
    #[doc(hidden)]pub workbook_cursor: i64,
...
pub struct ListTableRowsOutput  {
    ...
    #[doc(hidden)]pub row_ids_not_found: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p> Provides the pagination token to load the next page if there are more results matching the request. If a pagination token is not present in the response, it means that all data matching the request has been loaded. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p> Indicates the cursor of the workbook at which the data returned by this request is read. Workbook cursor keeps increasing with every update and the increments are not sequential. </p>
    #[doc(hidden)]pub workbook_cursor: i64,
...
pub struct ListTableColumnsOutput  {
    ...
    #[doc(hidden)]pub table_columns: std::option::Option<std::vec::Vec<crate::model::TableColumn>>,
    /// <p> Provides the pagination token to load the next page if there are more results matching the request. If a pagination token is not present in the response, it means that all data matching the request has been loaded. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p> Indicates the cursor of the workbook at which the data returned by this request is read. Workbook cursor keeps increasing with every update and the increments are not sequential. </p>
    #[doc(hidden)]pub workbook_cursor: i64,
...
pub struct GetScreenDataOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::collections::HashMap<std::string::String, crate::model::ResultSet>>,
...
pub struct DescribeTableDataImportJobOutput  {
    ...
    #[doc(hidden)]pub job_metadata: std::option::Option<crate::model::TableDataImportJobMetadata>,
...
pub struct BatchUpsertTableRowsOutput  {
    ...
    #[doc(hidden)]pub rows: std::option::Option<std::collections::HashMap<std::string::String, crate::model::UpsertRowsResult>>,
    ...
    #[doc(hidden)]pub failed_batch_items: std::option::Option<std::vec::Vec<crate::model::FailedBatchItem>>,
}
...
pub struct BatchCreateTableRowsOutput  {
    ...
    #[doc(hidden)]pub created_rows: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
