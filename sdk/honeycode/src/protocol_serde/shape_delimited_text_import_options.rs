...
pub(crate) fn de_delimited_text_import_options<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> Result<Option<crate::types::DelimitedTextImportOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "hasHeaderRow" => {
                            builder = builder.set_has_header_row(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "ignoreEmptyRows" => {
                            builder = builder.set_ignore_empty_rows(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "dataCharacterEncoding" => {
                            builder = builder.set_data_character_encoding(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ImportDataCharacterEncoding::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
