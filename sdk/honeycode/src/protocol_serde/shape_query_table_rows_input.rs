...
pub fn ser_query_table_rows_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QueryTableRowsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
