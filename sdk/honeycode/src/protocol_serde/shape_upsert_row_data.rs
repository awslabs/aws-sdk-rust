...
pub fn ser_upsert_row_data(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpsertRowData) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
