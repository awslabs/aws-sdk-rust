...
impl Builder {
    ...
    /// use aws_sdk_honeycode::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("honeycode"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("honeycode"));
        layer
        ...
        Config {
            config: ::aws_smithy_types::config_bag::Layer::from(layer.clone())
                .with_name("aws_sdk_honeycode::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_honeycode::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
