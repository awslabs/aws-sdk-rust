...
impl super::Client {
    ...
    ///   - [`workbook_id(impl ::std::convert::Into<String>)`](crate::operation::query_table_rows::builders::QueryTableRowsFluentBuilder::workbook_id) / [`set_workbook_id(Option<String>)`](crate::operation::query_table_rows::builders::QueryTableRowsFluentBuilder::set_workbook_id): <p>The ID of the workbook whose table rows are being queried.</p>  <p> If a workbook with the specified id could not be found, this API throws ResourceNotFoundException. </p>
    ///   - [`table_id(impl ::std::convert::Into<String>)`](crate::operation::query_table_rows::builders::QueryTableRowsFluentBuilder::table_id) / [`set_table_id(Option<String>)`](crate::operation::query_table_rows::builders::QueryTableRowsFluentBuilder::set_table_id): <p>The ID of the table whose rows are being queried.</p>  <p> If a table with the specified id could not be found, this API throws ResourceNotFoundException. </p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::query_table_rows::builders::QueryTableRowsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::query_table_rows::builders::QueryTableRowsFluentBuilder::set_next_token): <p> This parameter is optional. If a nextToken is not specified, the API returns the first page of data. </p>  <p> Pagination tokens expire after 1 hour. If you use a token that was returned more than an hour back, the API will throw ValidationException. </p>
