...
impl super::Client {
    ...
    ///   - [`workbook_id(impl Into<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::workbook_id) / [`set_workbook_id(Option<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::set_workbook_id): <p>The ID of the workbook where the rows are being deleted.</p>  <p> If a workbook with the specified id could not be found, this API throws ResourceNotFoundException. </p>
    ///   - [`table_id(impl Into<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::table_id) / [`set_table_id(Option<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::set_table_id): <p>The ID of the table where the rows are being deleted.</p>  <p> If a table with the specified id could not be found, this API throws ResourceNotFoundException. </p>
