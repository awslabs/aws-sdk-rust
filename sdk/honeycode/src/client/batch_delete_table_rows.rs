...
impl super::Client {
    ...
    ///   - [`workbook_id(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::workbook_id) / [`set_workbook_id(Option<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::set_workbook_id): <p>The ID of the workbook where the rows are being deleted.</p>  <p> If a workbook with the specified id could not be found, this API throws ResourceNotFoundException. </p>
    ///   - [`table_id(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::table_id) / [`set_table_id(Option<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::set_table_id): <p>The ID of the table where the rows are being deleted.</p>  <p> If a table with the specified id could not be found, this API throws ResourceNotFoundException. </p>
    ///   - [`row_ids(Vec<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::row_ids) / [`set_row_ids(Option<Vec<String>>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::set_row_ids): <p> The list of row ids to delete from the table. You need to specify at least one row id in this list. </p>  <p> Note that if one of the row ids provided in the request does not exist in the table, then the request fails and no rows are deleted from the table. </p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::batch_delete_table_rows::builders::BatchDeleteTableRowsFluentBuilder::set_client_request_token): <p> The request token for performing the delete action. Request tokens help to identify duplicate requests. If a call times out or fails due to a transient error like a failed network connection, you can retry the call with the same request token. The service ensures that if the first call using that request token is successfully performed, the second call will not perform the action again. </p>  <p> Note that request tokens are valid only for a few minutes. You cannot use request tokens to dedupe requests spanning hours or days. </p>
