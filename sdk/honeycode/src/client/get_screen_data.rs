...
impl super::Client {
    ...
    ///   - [`workbook_id(impl ::std::convert::Into<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::workbook_id) / [`set_workbook_id(Option<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::set_workbook_id): <p>The ID of the workbook that contains the screen.</p>
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::set_app_id): <p>The ID of the app that contains the screen.</p>
    ///   - [`screen_id(impl ::std::convert::Into<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::screen_id) / [`set_screen_id(Option<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::set_screen_id): <p>The ID of the screen.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_screen_data::builders::GetScreenDataFluentBuilder::set_next_token): <p> This parameter is optional. If a nextToken is not specified, the API returns the first page of data. </p>  <p> Pagination tokens expire after 1 hour. If you use a token that was returned more than an hour back, the API will throw ValidationException. </p>
