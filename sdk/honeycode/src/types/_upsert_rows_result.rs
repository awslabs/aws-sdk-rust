...
impl  UpsertRowsResult  {
    ...
    pub fn row_ids(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.row_ids.deref()
    }
    /// <p>The result of the upsert action.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::UpsertRowsResult {
                row_ids: self.row_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("row_ids", "row_ids was not specified but it is required when building UpsertRowsResult")
                    )?
                ,
                upsert_action: self.upsert_action
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("upsert_action", "upsert_action was not specified but it is required when building UpsertRowsResult")
                    )?
                ,
            }
        )
