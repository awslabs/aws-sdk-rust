...
impl ::std::convert::From<&str> for UpsertAction {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => UpsertAction::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for UpsertAction {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(UpsertAction::from(s))
    }
}
impl UpsertAction {
...
impl ::std::convert::AsRef<str> for UpsertAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
