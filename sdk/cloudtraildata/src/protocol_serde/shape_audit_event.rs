...
pub fn ser_audit_event(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AuditEvent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
