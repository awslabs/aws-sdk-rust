...
pub fn ser_put_audit_events_input(
    ...
    crate::protocol_serde::shape_put_audit_events_input::ser_put_audit_events_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_audit_events::PutAuditEventsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ChannelInsufficientPermission" => {
            crate::operation::put_audit_events::PutAuditEventsError::ChannelInsufficientPermission(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ChannelNotFound" => {
            crate::operation::put_audit_events::PutAuditEventsError::ChannelNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ChannelUnsupportedSchema" => {
            crate::operation::put_audit_events::PutAuditEventsError::ChannelUnsupportedSchema({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "DuplicatedAuditEventId" => {
            crate::operation::put_audit_events::PutAuditEventsError::DuplicatedAuditEventId({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidChannelARN" => {
            crate::operation::put_audit_events::PutAuditEventsError::InvalidChannelArn({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnsupportedOperationException" => {
            crate::operation::put_audit_events::PutAuditEventsError::UnsupportedOperationException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_audit_events::de_put_audit_events(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_audit_events::PutAuditEventsError::unhandled)?;
