...
pub(crate) fn put_audit_events_output_output_correct_errors(
...
pub(crate) fn audit_event_result_entry_correct_errors(
    mut builder: crate::types::builders::AuditEventResultEntryBuilder,
) -> crate::types::builders::AuditEventResultEntryBuilder {
...
pub(crate) fn result_error_entry_correct_errors(
    mut builder: crate::types::builders::ResultErrorEntryBuilder,
) -> crate::types::builders::ResultErrorEntryBuilder {
    if builder.id.is_none() {
        builder.id = Some(Default::default())
    }
