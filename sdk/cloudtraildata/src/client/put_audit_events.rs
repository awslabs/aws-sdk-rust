...
impl super::Client {
    ...
    ///   - [`audit_events(AuditEvent)`](crate::operation::put_audit_events::builders::PutAuditEventsFluentBuilder::audit_events) / [`set_audit_events(Vec<AuditEvent>)`](crate::operation::put_audit_events::builders::PutAuditEventsFluentBuilder::set_audit_events):<br>required: **true**<br><p>The JSON payload of events that you want to ingest. You can also point to the JSON event payload in a file.</p><br>
    ///   - [`channel_arn(impl Into<String>)`](crate::operation::put_audit_events::builders::PutAuditEventsFluentBuilder::channel_arn) / [`set_channel_arn(impl Into<String>)`](crate::operation::put_audit_events::builders::PutAuditEventsFluentBuilder::set_channel_arn):<br>required: **true**<br><p>The ARN or ID (the ARN suffix) of a channel.</p><br>
