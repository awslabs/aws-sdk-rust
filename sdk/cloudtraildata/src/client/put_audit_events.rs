...
impl super::Client {
    ...
    ///   - [`audit_events(AuditEvent)`](crate::operation::put_audit_events::builders::PutAuditEventsFluentBuilder::audit_events) / [`set_audit_events(Option<Vec<AuditEvent>>)`](crate::operation::put_audit_events::builders::PutAuditEventsFluentBuilder::set_audit_events): <p>The JSON payload of events that you want to ingest. You can also point to the JSON event payload in a file.</p>
