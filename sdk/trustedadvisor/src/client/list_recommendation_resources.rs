...
impl super::Client {
    ...
    ///   - [`exclusion_status(ExclusionStatus)`](crate::operation::list_recommendation_resources::builders::ListRecommendationResourcesFluentBuilder::exclusion_status) / [`set_exclusion_status(Option<ExclusionStatus>)`](crate::operation::list_recommendation_resources::builders::ListRecommendationResourcesFluentBuilder::set_exclusion_status):<br>required: **false**<br><p>The exclusion status of the resource</p><br>
