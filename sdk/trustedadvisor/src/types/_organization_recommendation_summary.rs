    ...
    pub fn build(self) -> ::std::result::Result<crate::types::OrganizationRecommendationSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::OrganizationRecommendationSummary {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
                r#type: self.r#type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "r#type was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
                ...
                pillars: self.pillars
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pillars", "pillars was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
                source: self.source
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("source", "source was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
                ...
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
                ...
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building OrganizationRecommendationSummary")
                    )?
                ,
            }
        )
