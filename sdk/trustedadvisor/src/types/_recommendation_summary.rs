...
impl RecommendationSummaryBuilder {
    ...
    pub fn set_resources_aggregates(mut self, input: ::std::option::Option<crate::types::RecommendationResourcesAggregates>) -> Self {
        self.resources_aggregates = input; self
    }
    /// <p>An aggregation of all resources</p>
    ...
    pub fn set_pillar_specific_aggregates(mut self, input: ::std::option::Option<crate::types::RecommendationPillarSpecificAggregates>) -> Self {
        self.pillar_specific_aggregates = input; self
    }
    /// <p>The pillar aggregations for cost savings</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::RecommendationSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::RecommendationSummary {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building RecommendationSummary")
                    )?
                ,
                r#type: self.r#type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "r#type was not specified but it is required when building RecommendationSummary")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building RecommendationSummary")
                    )?
                ,
                ...
                pillars: self.pillars
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pillars", "pillars was not specified but it is required when building RecommendationSummary")
                    )?
                ,
                source: self.source
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("source", "source was not specified but it is required when building RecommendationSummary")
                    )?
                ,
                ...
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building RecommendationSummary")
                    )?
                ,
                ...
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building RecommendationSummary")
                    )?
                ,
            }
        )
