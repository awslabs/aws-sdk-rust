...
impl OrganizationRecommendationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::OrganizationRecommendation, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::OrganizationRecommendation {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                r#type: self.r#type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "r#type was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                ...
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                ...
                pillars: self.pillars
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pillars", "pillars was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                source: self.source
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("source", "source was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                ...
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                ...
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
                description: self.description
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building OrganizationRecommendation")
                    )?
                ,
