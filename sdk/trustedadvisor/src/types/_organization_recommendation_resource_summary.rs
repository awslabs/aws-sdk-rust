...
impl OrganizationRecommendationResourceSummaryBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::OrganizationRecommendationResourceSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::OrganizationRecommendationResourceSummary {
                id: self.id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("id", "id was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                aws_resource_id: self.aws_resource_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("aws_resource_id", "aws_resource_id was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                region_code: self.region_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("region_code", "region_code was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                metadata: self.metadata
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("metadata", "metadata was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                last_updated_at: self.last_updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_updated_at", "last_updated_at was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
                ...
                recommendation_arn: self.recommendation_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("recommendation_arn", "recommendation_arn was not specified but it is required when building OrganizationRecommendationResourceSummary")
                    )?
                ,
            }
        )
