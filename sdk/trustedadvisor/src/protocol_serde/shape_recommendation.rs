...
pub(crate) fn de_recommendation<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Recommendation>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "lifecycleStage" => {
                                builder = builder.set_lifecycle_stage(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RecommendationLifecycleStage::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "source" => {
                                builder = builder.set_source(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RecommendationSource::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "updateReasonCode" => {
                                builder = builder.set_update_reason_code(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::UpdateRecommendationLifecycleStageReasonCode::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "resolvedAt" => {
                                builder = builder.set_resolved_at(
                                    ::aws_smithy_json::deserialize::token::expect_timestamp_or_null(tokens.next(), ::aws_smithy_types::date_time::Format::DateTimeWithOffset)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::recommendation_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
