...
pub(crate) fn de_recommendation_summary<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RecommendationSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::recommendation_summary_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
