...
pub fn de_list_organization_recommendation_resources_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesError::unhandled,
                        )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_organization_recommendation_resources_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_organization_recommendation_resources::de_list_organization_recommendation_resources(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_organization_recommendation_resources_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesError::unhandled)?
    })
}

pub(crate) fn de_list_organization_recommendation_resources(
    _value: &[u8],
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "organizationRecommendationResourceSummaries" => {
                    builder = builder.set_organization_recommendation_resource_summaries(
                            crate::protocol_serde::shape_organization_recommendation_resource_summary_list::de_organization_recommendation_resource_summary_list(tokens, _value, depth + 1)?
                        );
                }
