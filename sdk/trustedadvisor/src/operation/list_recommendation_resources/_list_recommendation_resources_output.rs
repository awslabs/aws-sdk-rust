...
impl  ListRecommendationResourcesOutput  {
    ...
    pub fn recommendation_resource_summaries(&self) -> & [crate::types::RecommendationResourceSummary] {
        use std::ops::Deref; self.recommendation_resource_summaries.deref()
    }
}
...
impl ListRecommendationResourcesOutputBuilder {
    ...
    /// <p>A list of Recommendation Resources</p>
    pub fn set_recommendation_resource_summaries(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::RecommendationResourceSummary>>) -> Self {
        self.recommendation_resource_summaries = input; self
    }
    /// <p>A list of Recommendation Resources</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_recommendation_resources::ListRecommendationResourcesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_recommendation_resources::ListRecommendationResourcesOutput {
                next_token: self.next_token
                ,
                recommendation_resource_summaries: self.recommendation_resource_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("recommendation_resource_summaries", "recommendation_resource_summaries was not specified but it is required when building ListRecommendationResourcesOutput")
                    )?
                ,
