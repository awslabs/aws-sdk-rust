...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v1/recommendations").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_recommendations::ListRecommendationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_9) = &_input.after_last_updated_at {
         {
            query.push_kv("afterLastUpdatedAt", &::aws_smithy_http::query::fmt_timestamp(inner_9, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    if let ::std::option::Option::Some(inner_10) = &_input.before_last_updated_at {
         {
            query.push_kv("beforeLastUpdatedAt", &::aws_smithy_http::query::fmt_timestamp(inner_10, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    ::std::result::Result::Ok(())
}
