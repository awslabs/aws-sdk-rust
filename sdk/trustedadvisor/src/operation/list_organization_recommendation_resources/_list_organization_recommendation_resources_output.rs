...
impl  ListOrganizationRecommendationResourcesOutput  {
    ...
    pub fn organization_recommendation_resource_summaries(&self) -> & [crate::types::OrganizationRecommendationResourceSummary] {
        use std::ops::Deref; self.organization_recommendation_resource_summaries.deref()
    }
}
...
pub struct ListOrganizationRecommendationResourcesOutputBuilder {
    ...
    pub(crate) organization_recommendation_resource_summaries: ::std::option::Option<::std::vec::Vec::<crate::types::OrganizationRecommendationResourceSummary>>,
    _request_id: Option<String>,
}
impl ListOrganizationRecommendationResourcesOutputBuilder {
    ...
    /// <p>A list of Recommendation Resources</p>
    pub fn set_organization_recommendation_resource_summaries(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::OrganizationRecommendationResourceSummary>>) -> Self {
        self.organization_recommendation_resource_summaries = input; self
    }
    /// <p>A list of Recommendation Resources</p>
    pub fn get_organization_recommendation_resource_summaries(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::OrganizationRecommendationResourceSummary>> {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_organization_recommendation_resources::ListOrganizationRecommendationResourcesOutput, ::aws_smithy_types::error::operation::BuildError> {
