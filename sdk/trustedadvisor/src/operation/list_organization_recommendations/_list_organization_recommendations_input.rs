...
impl ListOrganizationRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_organization_recommendations::ListOrganizationRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
