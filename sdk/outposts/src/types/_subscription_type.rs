...
///     SubscriptionType::CapacityIncrease => { /* ... */ },
...
impl ::std::convert::From<&str> for SubscriptionType {
    fn from(s: &str) -> Self {
        match s {
            "CAPACITY_INCREASE" => SubscriptionType::CapacityIncrease,
            "ORIGINAL" => SubscriptionType::Original,
...
impl SubscriptionType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SubscriptionType::CapacityIncrease => "CAPACITY_INCREASE",
            SubscriptionType::Original => "ORIGINAL",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CAPACITY_INCREASE", "ORIGINAL", "RENEWAL"]
    }
}
