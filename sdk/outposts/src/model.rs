...
pub struct Site  {
    ...
    #[doc(hidden)]pub site_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub operating_address_country_code: std::option::Option<std::string::String>,
    /// <p> State or region where the hardware is installed and powered on. </p>
    #[doc(hidden)]pub operating_address_state_or_region: std::option::Option<std::string::String>,
    /// <p> City where the hardware is installed and powered on. </p>
    #[doc(hidden)]pub operating_address_city: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for Site  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("operating_address_country_code", &self.operating_address_country_code);
        formatter.field("operating_address_state_or_region", &self.operating_address_state_or_region);
...
pub struct Address  {
    ...
    #[doc(hidden)]pub contact_name: std::option::Option<std::string::String>,
    /// <p>The phone number of the contact.</p>
    #[doc(hidden)]pub contact_phone_number: std::option::Option<std::string::String>,
...
pub struct Outpost  {
    ...
    #[doc(hidden)]pub life_cycle_status: std::option::Option<std::string::String>,
...
pub struct OrderSummary  {
    ...
    #[doc(hidden)]pub order_type: std::option::Option<crate::model::OrderType>,
    ...
    /// </note>
    #[doc(hidden)]pub status: std::option::Option<crate::model::OrderStatus>,
    /// <p> The status of all line items in the order. </p>
    #[doc(hidden)]pub line_item_counts_by_status: std::option::Option<std::collections::HashMap<crate::model::LineItemStatus, i32>>,
    /// <p> Submission date for the order. </p>
    #[doc(hidden)]pub order_submission_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p> Fulfilment date for the order. </p>
    #[doc(hidden)]pub order_fulfilled_date: std::option::Option<aws_smithy_types::DateTime>,
}
impl OrderSummary {
    /// <p> The ID of the Outpost. </p>
    pub fn outpost_id(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for OrderSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("line_item_counts_by_status", &self.line_item_counts_by_status);
...
pub struct CatalogItem  {
    ...
    #[doc(hidden)]pub item_status: std::option::Option<crate::model::CatalogItemStatus>,
    /// <p> Information about the EC2 capacity of an item. </p>
    #[doc(hidden)]pub ec2_capacities: std::option::Option<std::vec::Vec<crate::model::Ec2Capacity>>,
    /// <p> Information about the power draw of an item. </p>
    #[doc(hidden)]pub power_kva: std::option::Option<f32>,
    /// <p> The weight of the item in pounds. </p>
    #[doc(hidden)]pub weight_lbs: std::option::Option<i32>,
    /// <p> The uplink speed this catalog item requires for the connection to the Region. </p>
    #[doc(hidden)]pub supported_uplink_gbps: std::option::Option<std::vec::Vec<i32>>,
    /// <p> The supported storage options for the catalog item. </p>
    #[doc(hidden)]pub supported_storage: std::option::Option<std::vec::Vec<crate::model::SupportedStorageEnum>>,
}
impl CatalogItem {
    /// <p> The ID of the catalog item. </p>
...
pub struct Ec2Capacity  {
    ...
    #[doc(hidden)]pub max_size: std::option::Option<std::string::String>,
    /// <p> The quantity of the EC2 capacity. </p>
    #[doc(hidden)]pub quantity: std::option::Option<std::string::String>,
}
impl Ec2Capacity {
    /// <p> The family of the EC2 capacity. </p>
...
pub struct AssetInfo  {
    ...
    #[doc(hidden)]pub rack_id: std::option::Option<std::string::String>,
    /// <p> The type of the asset. </p>
    #[doc(hidden)]pub asset_type: std::option::Option<crate::model::AssetType>,
    /// <p> Information about compute hardware assets. </p>
    #[doc(hidden)]pub compute_attributes: std::option::Option<crate::model::ComputeAttributes>,
    /// <p> The position of an asset in a rack. </p>
    #[doc(hidden)]pub asset_location: std::option::Option<crate::model::AssetLocation>,
}
impl AssetInfo {
    /// <p> The ID of the asset. </p>
...
pub struct AssetLocation  {
    ...
    #[doc(hidden)]pub rack_elevation: std::option::Option<f32>,
}
impl AssetLocation {
    /// <p> The position of an asset in a rack measured in rack units. </p>
...
pub struct ComputeAttributes  {
    ...
    #[doc(hidden)]pub host_id: std::option::Option<std::string::String>,
}
...
pub struct Order  {
    ...
    #[doc(hidden)]pub line_items: std::option::Option<std::vec::Vec<crate::model::LineItem>>,
...
pub struct LineItem  {
    ...
    #[doc(hidden)]pub line_item_id: std::option::Option<std::string::String>,
    /// <p>The quantity of the line item.</p>
    #[doc(hidden)]pub quantity: i32,
    /// <p>The status of the line item.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::LineItemStatus>,
    /// <p> Information about a line item shipment. </p>
    #[doc(hidden)]pub shipment_information: std::option::Option<crate::model::ShipmentInformation>,
    /// <p> Information about assets. </p>
    #[doc(hidden)]pub asset_information_list: std::option::Option<std::vec::Vec<crate::model::LineItemAssetInformation>>,
}
impl LineItem {
    /// <p> The ID of the catalog item. </p>
    pub fn catalog_item_id(&self) -> std::option::Option<& str> {
...
pub struct LineItemAssetInformation  {
    ...
    #[doc(hidden)]pub mac_address_list: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct ShipmentInformation  {
    ...
    #[doc(hidden)]pub shipment_tracking_number: std::option::Option<std::string::String>,
    /// <p> The carrier of the shipment. </p>
    #[doc(hidden)]pub shipment_carrier: std::option::Option<crate::model::ShipmentCarrier>,
}
...
pub struct ConnectionDetails  {
    ...
    #[doc(hidden)]pub server_public_key: std::option::Option<std::string::String>,
    /// <p> The endpoint for the server. </p>
    #[doc(hidden)]pub server_endpoint: std::option::Option<std::string::String>,
    /// <p> The client tunnel address. </p>
    #[doc(hidden)]pub client_tunnel_address: std::option::Option<std::string::String>,
    /// <p> The server tunnel address. </p>
    #[doc(hidden)]pub server_tunnel_address: std::option::Option<std::string::String>,
    /// <p> The allowed IP addresses. </p>
    #[doc(hidden)]pub allowed_ips: std::option::Option<std::vec::Vec<std::string::String>>,
}
