...
impl ListCatalogItemsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_catalog_items::ListCatalogItems::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListCatalogItems {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_catalog_items::de_list_catalog_items_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_catalog_items::ListCatalogItemsError
{
