...
impl CreateOrderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_order::CreateOrder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOrder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_order::de_create_order_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_order::de_create_order_http_response_with_props(
                status, headers, body,
            )
        }
    }
