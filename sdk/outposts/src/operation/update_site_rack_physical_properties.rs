...
impl UpdateSiteRackPhysicalPropertiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_site_rack_physical_properties::UpdateSiteRackPhysicalProperties::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSiteRackPhysicalProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_site_rack_physical_properties::de_update_site_rack_physical_properties_http_response_with_props(
                status, headers, body,
            )
        }
    }
