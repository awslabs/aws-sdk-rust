...
impl CreateOutpostInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_outpost::CreateOutpost, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_outpost::ser_create_outpost_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOutpost {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_outpost::de_create_outpost_http_response_with_props(status, headers, body)
        }
    }
}
