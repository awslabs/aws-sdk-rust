...
impl CreateOutpostInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_outpost::CreateOutpost::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOutpost {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_outpost::de_create_outpost_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_outpost::de_create_outpost_http_response_with_props(
                status, headers, body,
            )
        }
    }
