...
impl UpdateSiteAddressInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_site_address::ser_update_site_address_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSiteAddress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_site_address::de_update_site_address_http_response_with_props(status, headers, body)
        }
    }
}
