...
impl DeleteOutpostFluentBuilder  {
    /// Creates a new `DeleteOutpost`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_outpost::DeleteOutpostOutput, aws_smithy_http::result::SdkError<crate::operation::delete_outpost::DeleteOutpostError>>
                     {
