...
pub use crate::operation::delete_outpost::_delete_outpost_output::DeleteOutpostOutputBuilder;

pub use crate::operation::delete_outpost::_delete_outpost_input::DeleteOutpostInputBuilder;
...
impl DeleteOutpostInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_outpost();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_outpost::DeleteOutpostOutput,
                    crate::operation::delete_outpost::DeleteOutpostError,
                > for DeleteOutpostFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteOutpostFluentBuilder {
    ...
    /// Access the DeleteOutpost as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_outpost::builders::DeleteOutpostInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_outpost::DeleteOutpostOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_outpost::DeleteOutpostError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_outpost::DeleteOutpostOutput, crate::operation::delete_outpost::DeleteOutpostError, Self> {
