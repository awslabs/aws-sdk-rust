...
impl ListOrdersPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::OrderSummary, ::aws_smithy_http::result::SdkError<crate::operation::list_orders::ListOrdersError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_orders_output_orders(page).unwrap_or_default().into_iter())
    }
}
