...
impl ListOutpostsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Outpost, ::aws_smithy_http::result::SdkError<crate::operation::list_outposts::ListOutpostsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_outposts_output_outposts(page).unwrap_or_default().into_iter())
    }
}
