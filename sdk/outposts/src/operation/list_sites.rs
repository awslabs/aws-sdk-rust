    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                if let ::std::option::Option::Some(inner_3) =
                    &_input.operating_address_country_code_filter
                {
                    {
                ...
                if let ::std::option::Option::Some(inner_5) =
                    &_input.operating_address_state_or_region_filter
                {
                    {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_sites::ListSites::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSites {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sites::de_list_sites_http_response_with_props(
                status, headers, body,
            )
        }
    }
