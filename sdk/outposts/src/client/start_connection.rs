...
impl super::Client {
    ...
    ///   - [`device_serial_number(impl ::std::convert::Into<String>)`](crate::operation::start_connection::builders::StartConnectionFluentBuilder::device_serial_number) / [`set_device_serial_number(Option<String>)`](crate::operation::start_connection::builders::StartConnectionFluentBuilder::set_device_serial_number): <p> The serial number of the dongle. </p>
    ///   - [`asset_id(impl ::std::convert::Into<String>)`](crate::operation::start_connection::builders::StartConnectionFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::start_connection::builders::StartConnectionFluentBuilder::set_asset_id): <p> The ID of the Outpost server. </p>
    ///   - [`client_public_key(impl ::std::convert::Into<String>)`](crate::operation::start_connection::builders::StartConnectionFluentBuilder::client_public_key) / [`set_client_public_key(Option<String>)`](crate::operation::start_connection::builders::StartConnectionFluentBuilder::set_client_public_key): <p> The public key of the client. </p>
