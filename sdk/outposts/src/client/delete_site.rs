...
impl super::Client {
    ...
    ///   - [`site_id(impl ::std::convert::Into<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::site_id) / [`set_site_id(Option<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::set_site_id): <p> The ID or the Amazon Resource Name (ARN) of the site. </p>
