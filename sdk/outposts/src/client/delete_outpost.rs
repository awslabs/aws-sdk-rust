...
impl super::Client {
    ...
    ///   - [`outpost_id(impl Into<String>)`](crate::operation::delete_outpost::builders::DeleteOutpostFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::delete_outpost::builders::DeleteOutpostFluentBuilder::set_outpost_id):<br>required: **true**<br><p>The ID or ARN of the Outpost.</p><br>
