...
impl super::Client {
    ...
    ///   - [`availability_zone_filter(impl Into<String>)`](crate::operation::list_outposts::builders::ListOutpostsFluentBuilder::availability_zone_filter) / [`set_availability_zone_filter(Option<Vec<String>>)`](crate::operation::list_outposts::builders::ListOutpostsFluentBuilder::set_availability_zone_filter): <p>Filters the results by Availability Zone (for example, <code>us-east-1a</code>).</p>
