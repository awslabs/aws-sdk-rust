...
impl super::Client {
    ...
    ///   - [`outpost_id(impl Into<String>)`](crate::operation::get_outpost_instance_types::builders::GetOutpostInstanceTypesFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::get_outpost_instance_types::builders::GetOutpostInstanceTypesFluentBuilder::set_outpost_id):<br>required: **true**<br><p>The ID or the Amazon Resource Name (ARN) of the Outpost.</p><br>
