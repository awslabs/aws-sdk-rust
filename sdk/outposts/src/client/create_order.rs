...
impl super::Client {
    ...
    ///   - [`quote_identifier(impl Into<String>)`](crate::operation::create_order::builders::CreateOrderFluentBuilder::quote_identifier) / [`set_quote_identifier(Option<String>)`](crate::operation::create_order::builders::CreateOrderFluentBuilder::set_quote_identifier):<br>required: **false**<br><p>The ID of the quote to use for the order.</p><br>
    ///   - [`quote_option_identifier(impl Into<String>)`](crate::operation::create_order::builders::CreateOrderFluentBuilder::quote_option_identifier) / [`set_quote_option_identifier(Option<String>)`](crate::operation::create_order::builders::CreateOrderFluentBuilder::set_quote_option_identifier):<br>required: **false**<br><p>The ID of the quote option to use for the order.</p><br>
    ///   - [`line_items(LineItemRequest)`](crate::operation::create_order::builders::CreateOrderFluentBuilder::line_items) / [`set_line_items(Option<Vec::<LineItemRequest>>)`](crate::operation::create_order::builders::CreateOrderFluentBuilder::set_line_items):<br>required: **false**<br><p>The line items that make up the order.</p><br>
