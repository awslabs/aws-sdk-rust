...
impl super::Client {
    ...
    ///   - [`ec2_family_filter(impl Into<String>)`](crate::operation::list_catalog_items::builders::ListCatalogItemsFluentBuilder::ec2_family_filter) / [`set_ec2_family_filter(Option<Vec<String>>)`](crate::operation::list_catalog_items::builders::ListCatalogItemsFluentBuilder::set_ec2_family_filter): <p>Filters the results by EC2 family (for example, M5).</p>
