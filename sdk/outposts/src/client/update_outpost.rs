...
impl super::Client {
    ...
    ///   - [`outpost_id(impl Into<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::set_outpost_id):<br>required: **true**<br><p>The ID or ARN of the Outpost.</p><br>
