...
impl super::Client {
    ...
    ///   - [`outpost_id(impl ::std::convert::Into<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::set_outpost_id): <p> The ID or the Amazon Resource Name (ARN) of the Outpost. </p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::set_name): <p>The name of the Outpost.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_outpost::builders::UpdateOutpostFluentBuilder::set_description): <p>The description of the Outpost.</p>
