...
impl super::Client {
    ...
    ///   - [`instances_to_exclude(Option<InstancesToExclude>)`](crate::operation::get_capacity_task::GetCapacityTaskOutput::instances_to_exclude): <p>Instances that the user specified they cannot stop in order to free up the capacity needed to run the capacity task.</p>
