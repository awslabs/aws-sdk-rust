...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::set_tags): <p>The tags to apply to the Outpost.</p>
