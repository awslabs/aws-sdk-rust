...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::set_name): <p>The name of the Outpost.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::set_description): <p>The description of the Outpost.</p>
    ///   - [`site_id(impl ::std::convert::Into<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::site_id) / [`set_site_id(Option<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::set_site_id): <p> The ID or the Amazon Resource Name (ARN) of the site. </p>
    ///   - [`availability_zone(impl ::std::convert::Into<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::availability_zone) / [`set_availability_zone(Option<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::set_availability_zone): <p>The Availability Zone.</p>
    ///   - [`availability_zone_id(impl ::std::convert::Into<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::availability_zone_id) / [`set_availability_zone_id(Option<String>)`](crate::operation::create_outpost::builders::CreateOutpostFluentBuilder::set_availability_zone_id): <p>The ID of the Availability Zone.</p>
