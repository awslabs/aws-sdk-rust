...
impl super::Client {
    ...
    ///   - [`outpost_id(impl ::std::convert::Into<String>)`](crate::operation::get_outpost::builders::GetOutpostFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::get_outpost::builders::GetOutpostFluentBuilder::set_outpost_id): <p> The ID or the Amazon Resource Name (ARN) of the Outpost. </p>
