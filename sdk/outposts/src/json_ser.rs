...
pub fn serialize_structure_crate_input_create_order_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOrderInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_1) = &input.line_items {
        let mut array_2 = object.key("LineItems").start_array();
        for item_3 in var_1 {
             {
                let mut object_4 = array_2.value().start_object();
                crate::json_ser::serialize_structure_crate_model_line_item_request(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
...
pub fn serialize_structure_crate_input_create_outpost_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOutpostInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_site_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSiteInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_23) = &input.rack_physical_properties {
        ...
        crate::json_ser::serialize_structure_crate_model_rack_physical_properties(&mut object_24, var_23)?;
        object_24.finish();
    }
...
pub fn serialize_structure_crate_input_start_connection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartConnectionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_outpost_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateOutpostInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_site_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSiteInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_site_address_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSiteAddressInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_site_rack_physical_properties_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSiteRackPhysicalPropertiesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_48) = &input.maximum_supported_weight_lbs {
        object.key("MaximumSupportedWeightLbs").string(var_48.as_str());
    }
...
pub fn serialize_structure_crate_model_line_item_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineItemRequest) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_rack_physical_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RackPhysicalProperties) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_76) = &input.maximum_supported_weight_lbs {
        object.key("MaximumSupportedWeightLbs").string(var_76.as_str());
    }
    Ok(())
}
