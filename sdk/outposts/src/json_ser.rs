...
pub fn serialize_structure_crate_input_create_order_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOrderInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_create_outpost_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOutpostInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_start_connection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartConnectionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_outpost_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateOutpostInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_site_address_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSiteAddressInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_update_site_rack_physical_properties_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSiteRackPhysicalPropertiesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_line_item_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineItemRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_rack_physical_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RackPhysicalProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
