...
pub fn parse_create_outpost_error(
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::error::CreateOutpostError {
            meta: generic,
        ...
        "ServiceQuotaExceededException" => crate::error::CreateOutpostError {
            ...
            kind: crate::error::CreateOutpostErrorKind::ServiceQuotaExceededException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::json_deser::deser_structure_service_quota_exceeded_exceptionjson_err(response.body().as_ref(), output).map_err(crate::error::CreateOutpostError::unhandled)?;
                    output.build()
                };
                if (&tmp.message).is_none() {
                    tmp.message = _error_message;
...
pub fn parse_create_outpost_response(
    ...
    Ok({
        ...
        let _ = response;
        output =
            crate::json_deser::deser_operation_create_outpost(response.body().as_ref(), output)
                .map_err(crate::error::CreateOutpostError::unhandled)?;
        output.build()
    })
}
...
pub fn parse_delete_outpost_error(
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::error::DeleteOutpostError {
            meta: generic,
...
pub fn parse_get_outpost_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::json_deser::deser_operation_get_outpost(response.body().as_ref(), output)
            .map_err(crate::error::GetOutpostError::unhandled)?;
        output.build()
    })
}
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::json_deser::deser_operation_get_outpost_instance_types(
            response.body().as_ref(),
            output,
        )
        .map_err(crate::error::GetOutpostInstanceTypesError::unhandled)?;
...
pub fn parse_list_outposts_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::json_deser::deser_operation_list_outposts(response.body().as_ref(), output)
            .map_err(crate::error::ListOutpostsError::unhandled)?;
        output.build()
    })
}
...
pub fn parse_list_sites_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::json_deser::deser_operation_list_sites(response.body().as_ref(), output)
            .map_err(crate::error::ListSitesError::unhandled)?;
        output.build()
    })
}
