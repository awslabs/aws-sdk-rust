...
pub fn de_list_orders_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListOrdersOutput, crate::error::ListOrdersError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListOrdersError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_orders_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListOrdersOutput, crate::error::ListOrdersError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_orders_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_orders::de_list_orders(response.body().as_ref(), output).map_err(crate::error::ListOrdersError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_orders(value: &[u8], mut builder: crate::output::list_orders_output::Builder) -> Result<crate::output::list_orders_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
