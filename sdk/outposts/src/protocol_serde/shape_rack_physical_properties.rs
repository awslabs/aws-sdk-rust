...
pub fn ser_rack_physical_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RackPhysicalProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_rack_physical_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RackPhysicalProperties>, aws_smithy_json::deserialize::error::DeserializeError>
