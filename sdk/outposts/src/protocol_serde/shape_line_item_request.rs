...
pub fn ser_line_item_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LineItemRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
