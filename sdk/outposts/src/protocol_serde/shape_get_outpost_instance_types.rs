...
pub fn de_get_outpost_instance_types_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_outpost_instance_types::GetOutpostInstanceTypesOutput, crate::operation::get_outpost_instance_types::GetOutpostInstanceTypesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_outpost_instance_types::GetOutpostInstanceTypesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_outpost_instance_types_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_outpost_instance_types::GetOutpostInstanceTypesOutput, crate::operation::get_outpost_instance_types::GetOutpostInstanceTypesError> {
    Ok({
        #[allow(unused_mut)]
