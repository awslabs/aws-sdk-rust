...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::recognize_text::RecognizeTextError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::recognize_utterance::RecognizeUtteranceError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_conversation::StartConversationError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::types::error::StartConversationRequestEventStreamError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::types::error::StartConversationResponseEventStreamError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::types::error::StartConversationResponseEventStreamError> for Error {
    fn from(err: crate::types::error::StartConversationResponseEventStreamError) -> Self {
        match err {
            ...
            crate::types::error::StartConversationResponseEventStreamError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            ...
            crate::types::error::StartConversationResponseEventStreamError::DependencyFailedException(inner) => Error::DependencyFailedException(inner),
