...
> {
    ...
    Ok({
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_recognize_utterance_output::de_content_type_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled(
        ...
        output = output.set_input_mode(
            match crate::protocol_serde::shape_recognize_utterance_output::de_input_mode_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("x-amz-lex-input-mode")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
        ...
        output = output.set_input_transcript(
            match crate::protocol_serde::shape_recognize_utterance_output::de_input_transcript_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_interpretations(
            match crate::protocol_serde::shape_recognize_utterance_output::de_interpretations_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("x-amz-lex-interpretations")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
        ...
        output = output.set_messages(
            match crate::protocol_serde::shape_recognize_utterance_output::de_messages_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_recognized_bot_member(
            match crate::protocol_serde::shape_recognize_utterance_output::de_recognized_bot_member_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
                        .get_all_bytes("x-amz-lex-recognized-bot-member")
                        .any(|value| std::str::from_utf8(value).is_err());
                    if has_unreadable_value
                        && _cfg.load::<::aws_smithy_runtime_api::http::NonUtf8HeaderHandling>()
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
        ...
        output = output.set_request_attributes(
            match crate::protocol_serde::shape_recognize_utterance_output::de_request_attributes_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_session_id(
            match crate::protocol_serde::shape_recognize_utterance_output::de_session_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_session_state(
            match crate::protocol_serde::shape_recognize_utterance_output::de_session_state_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
