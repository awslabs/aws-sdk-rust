...
pub fn de_recognize_utterance_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::recognize_utterance::RecognizeUtteranceOutput, crate::operation::recognize_utterance::RecognizeUtteranceError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_recognize_utterance_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::recognize_utterance::RecognizeUtteranceOutput, crate::operation::recognize_utterance::RecognizeUtteranceError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::bad_gateway_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::dependency_failed_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::conflict_exception_correct_errors(output).build().map_err(crate::operation::recognize_utterance::RecognizeUtteranceError::unhandled)?
                }
            ;
            tmp
        }),
        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("session_state", format!(
    ...
    if let ::std::option::Option::Some(inner_5) = &input.request_content_type {
        let formatted_6 = inner_5.as_str();
                        if !formatted_6.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("request_content_type", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
