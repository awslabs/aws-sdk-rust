...
pub(crate) fn de_intent_result_event_payload(
    input: &[u8],
) -> Result<crate::types::IntentResultEvent, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::IntentResultEvent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
