                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "slotElicitationStyle" => {
                            builder = builder.set_slot_elicitation_style(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::StyleType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "subSlotToElicit" => {
                            builder = builder.set_sub_slot_to_elicit(crate::protocol_serde::shape_elicit_sub_slot::de_elicit_sub_slot(tokens)?);
                        }
