...
pub fn ser_recognize_text_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RecognizeTextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
