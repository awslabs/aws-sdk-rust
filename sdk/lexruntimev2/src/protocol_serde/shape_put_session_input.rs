...
pub fn ser_put_session_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutSessionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
