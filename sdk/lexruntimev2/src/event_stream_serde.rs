                    ...
                    "PlaybackInterruptionEvent" =>  {
                        let parsed =
                            crate::protocol_serde::shape_playback_interruption_event::de_playback_interruption_event_payload(&message.payload()[..])
                                            .map_err(|err| {
                                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall PlaybackInterruptionEvent: {}", err))
                                            })?
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::PlaybackInterruptionEvent(parsed)))
                    }
                    "TranscriptEvent" =>  {
                        let parsed =
                        ...
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::TranscriptEvent(parsed)))
                    }
                    "IntentResultEvent" =>  {
                        let parsed =
                            crate::protocol_serde::shape_intent_result_event::de_intent_result_event_payload(&message.payload()[..])
                                            .map_err(|err| {
                                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall IntentResultEvent: {}", err))
                                            })?
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::IntentResultEvent(parsed)))
                    }
                    "TextResponseEvent" =>  {
                        let parsed =
                            crate::protocol_serde::shape_text_response_event::de_text_response_event_payload(&message.payload()[..])
                                            .map_err(|err| {
                                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall TextResponseEvent: {}", err))
                                            })?
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::TextResponseEvent(parsed)))
                    }
                    "AudioResponseEvent" =>  {
                        let parsed =
                            crate::protocol_serde::shape_audio_response_event::de_audio_response_event_payload(&message.payload()[..])
                                            .map_err(|err| {
                                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall AudioResponseEvent: {}", err))
                                            })?
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::AudioResponseEvent(parsed)))
                    }
                    "HeartbeatEvent" =>  {
                        let parsed =
                            crate::protocol_serde::shape_heartbeat_event::de_heartbeat_event_payload(&message.payload()[..])
                                            .map_err(|err| {
                                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall HeartbeatEvent: {}", err))
                                            })?
                        ;
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::HeartbeatEvent(parsed)))
                    }
                    _unknown_variant =>  {
                        Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(crate::types::StartConversationResponseEventStream::Unknown))
                    }
                }
            }
            "exception" =>  {
                let generic = match crate::protocol_serde::parse_event_stream_error_metadata(message.payload()) {
                                        ...
                                        Err(err) => return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(crate::types::error::StartConversationResponseEventStreamError::unhandled(err))),
                                    };
                match response_headers.smithy_type.as_str() {
                "AccessDeniedException" =>  {
                    let mut builder = crate::types::error::builders::AccessDeniedExceptionBuilder::default();
                    builder = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(&message.payload()[..], builder)
                                                            .map_err(|err| {
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::AccessDeniedException(
                                                                crate::serde_util::access_denied_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                "ResourceNotFoundException" =>  {
                    let mut builder = crate::types::error::builders::ResourceNotFoundExceptionBuilder::default();
                    builder = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_json_err(&message.payload()[..], builder)
                                                            .map_err(|err| {
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::ResourceNotFoundException(
                                                                crate::serde_util::resource_not_found_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                "ValidationException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_validation_exception::de_validation_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::ValidationException(
                                                                crate::serde_util::validation_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                "ThrottlingException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::ThrottlingException(
                                                                crate::serde_util::throttling_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                    ...
                    builder = crate::protocol_serde::shape_internal_server_exception::de_internal_server_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::InternalServerException(
                                                                crate::serde_util::internal_server_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                "ConflictException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::ConflictException(
                                                                crate::serde_util::conflict_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                "DependencyFailedException" =>  {
                    let mut builder = crate::types::error::builders::DependencyFailedExceptionBuilder::default();
                    builder = crate::protocol_serde::shape_dependency_failed_exception::de_dependency_failed_exception_json_err(&message.payload()[..], builder)
                                                            .map_err(|err| {
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::DependencyFailedException(
                                                                crate::serde_util::dependency_failed_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                "BadGatewayException" =>  {
                    let mut builder = crate::types::error::builders::BadGatewayExceptionBuilder::default();
                    builder = crate::protocol_serde::shape_bad_gateway_exception::de_bad_gateway_exception_json_err(&message.payload()[..], builder)
                                                            .map_err(|err| {
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::StartConversationResponseEventStreamError::BadGatewayException(
                                                                crate::serde_util::bad_gateway_exception_correct_errors(builder).build().map_err(|err|::aws_smithy_eventstream::error::Error::unmarshalling(format!("{}", err)))?
                                                            )
                                                        ))
                }
                _ => {}
                }
                Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(crate::types::error::StartConversationResponseEventStreamError::generic(generic)))
            }
            value =>  {
