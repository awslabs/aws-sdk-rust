...
pub struct Interpretation  {
    ...
    #[doc(hidden)]pub nlu_confidence: std::option::Option<crate::model::ConfidenceScore>,
    ...
    #[doc(hidden)]pub intent: std::option::Option<crate::model::Intent>,
}
impl Interpretation {
    /// <p>Determines the threshold where Amazon Lex V2 will insert the <code>AMAZON.FallbackIntent</code>, <code>AMAZON.KendraSearchIntent</code>, or both when returning alternative intents in a response. <code>AMAZON.FallbackIntent</code> and <code>AMAZON.KendraSearchIntent</code> are only inserted if they are configured for the bot.</p>
...
pub struct Intent  {
    ...
    #[doc(hidden)]pub slots: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Slot>>,
    /// <p>Contains fulfillment information for the intent. </p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::IntentState>,
    /// <p>Contains information about whether fulfillment of the intent has been confirmed.</p>
    #[doc(hidden)]pub confirmation_state: std::option::Option<crate::model::ConfirmationState>,
}
impl Intent {
    /// <p>The name of the intent.</p>
...
pub struct Slot  {
    ...
    #[doc(hidden)]pub value: std::option::Option<crate::model::Value>,
    ...
    #[doc(hidden)]pub shape: std::option::Option<crate::model::Shape>,
    ...
    #[doc(hidden)]pub values: std::option::Option<std::vec::Vec<crate::model::Slot>>,
    /// <p>The constituent sub slots of a composite slot.</p>
    #[doc(hidden)]pub sub_slots: std::option::Option<std::collections::HashMap<std::string::String, crate::model::Slot>>,
}
impl Slot {
    /// <p>The current value of the slot.</p>
...
pub struct Value  {
    ...
    #[doc(hidden)]pub original_value: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub resolved_values: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Value {
    /// <p>The text of the utterance from the user that was entered for the slot.</p>
...
pub struct SessionState  {
    ...
    #[doc(hidden)]pub originating_request_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub runtime_hints: std::option::Option<crate::model::RuntimeHints>,
}
impl SessionState {
    /// <p>The next step that Amazon Lex V2 should take in the conversation with a user.</p>
...
pub struct RuntimeHints  {
    ...
    #[doc(hidden)]pub slot_hints: std::option::Option<std::collections::HashMap<std::string::String, std::collections::HashMap<std::string::String, crate::model::RuntimeHintDetails>>>,
}
impl RuntimeHints {
    /// <p>A list of the slots in the intent that should have runtime hints added, and the phrases that should be added for each slot.</p> 
    /// <p>The first level of the <code>slotHints</code> map is the name of the intent. The second level is the name of the slot within the intent. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/using-hints.html">Using hints to improve accuracy</a>.</p> 
...
pub struct RuntimeHintDetails  {
    ...
    #[doc(hidden)]pub runtime_hint_values: std::option::Option<std::vec::Vec<crate::model::RuntimeHintValue>>,
    ...
    #[doc(hidden)]pub sub_slot_hints: std::option::Option<std::collections::HashMap<std::string::String, crate::model::RuntimeHintDetails>>,
}
...
pub struct ActiveContext  {
    ...
    #[doc(hidden)]pub context_attributes: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl ActiveContext {
    /// <p>The name of the context.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct DialogAction  {
    ...
    #[doc(hidden)]pub slot_elicitation_style: std::option::Option<crate::model::StyleType>,
    ...
    #[doc(hidden)]pub sub_slot_to_elicit: std::option::Option<crate::model::ElicitSubSlot>,
}
impl DialogAction {
    /// <p>The next action that the bot should take in its interaction with the user. The possible values are:</p> 
    /// <ul> 
...
pub struct ElicitSubSlot  {
    ...
    #[doc(hidden)]pub sub_slot_to_elicit: std::option::Option<std::boxed::Box<crate::model::ElicitSubSlot>>,
}
impl ElicitSubSlot {
    /// <p>The name of the slot that should be elicited from the user.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct Message  {
    ...
    #[doc(hidden)]pub content_type: std::option::Option<crate::model::MessageContentType>,
