...
impl PutSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_session::PutSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseHttpResponse for PutSession {
    ...
    fn parse_unloaded(
        ...
        ::std::option::Option::Some(
            crate::protocol_serde::shape_put_session::de_put_session_op_response(response),
        )
    }
    fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        // if streaming, we only hit this case if its an error
        crate::protocol_serde::shape_put_session::de_put_session_http_error(
