...
impl StartConversation {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lex Runtime V2", "StartConversation", input, runtime_plugins, stop_point)
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartConversation")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartConversation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartConversationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartConversationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartConversationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartConversationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartConversationResponseDeserializer {
    fn deserialize_streaming_with_config(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_start_conversation::de_start_conversation_http_response(response, _cfg),
        ))
    }
    ...
    fn deserialize_nonstreaming_with_config(
        ...
        crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_start_conversation::de_start_conversation_http_error(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartConversationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from({
            ...
            ::aws_smithy_types::body::SdkBody::from_body_1_x(::http_body_util::StreamBody::new(input.request_event_stream.into_body_stream(
                marshaller,
                error_marshaller,
                signer,
            )))
