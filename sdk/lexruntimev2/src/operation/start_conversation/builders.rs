...
impl StartConversationFluentBuilder {
    ...
    > {
        ...
        let mut output = crate::operation::start_conversation::StartConversation::orchestrate(&runtime_plugins, input).await?;
        ...
        let message = output.response_event_stream.try_recv_initial_response().await.map_err(response_error)?;
