...
impl RecognizeUtteranceInput {
    /// Consumes the builder and constructs an Operation<[`RecognizeUtterance`](crate::operation::recognize_utterance::RecognizeUtterance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::recognize_utterance::RecognizeUtterance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::recognize_utterance::RecognizeUtteranceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseHttpResponse for RecognizeUtterance {
                type Output = std::result::Result<crate::operation::recognize_utterance::RecognizeUtteranceOutput, crate::operation::recognize_utterance::RecognizeUtteranceError>;
                fn parse_unloaded(&self, response: &mut aws_smithy_http::operation::Response) -> Option<Self::Output> {
                    ...
                    Some(crate::protocol_serde::shape_recognize_utterance::de_recognize_utterance_http_response_(response))
                }
                fn parse_loaded(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_recognize_utterance::de_recognize_utterance_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
