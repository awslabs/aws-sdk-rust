...
impl crate::operation::recognize_utterance::builders::RecognizeUtteranceInputBuilder {
...
/// <ul>
/// <li>
/// <p>inputTranscript</p></li>
/// <li>
/// <p>interpretations</p></li>
/// <li>
/// <p>messages</p></li>
/// <li>
/// <p>requestAttributes</p></li>
...
impl RecognizeUtteranceFluentBuilder {
    /// Creates a new `RecognizeUtteranceFluentBuilder`.
