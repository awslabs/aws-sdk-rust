...
#[non_exhaustive]pub struct RecognizeUtteranceOutput  {
    ...
    #[doc(hidden)]pub input_mode: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub messages: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub interpretations: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub input_transcript: std::option::Option<std::string::String>,
...
pub struct RecognizeTextOutput  {
    ...
    #[doc(hidden)]pub interpretations: std::option::Option<std::vec::Vec<crate::model::Interpretation>>,
    /// <p>The attributes sent in the request.</p>
...
pub mod recognize_text_output {
    ...
    pub struct Builder {
        ...
        pub(crate) interpretations: std::option::Option<std::vec::Vec<crate::model::Interpretation>>,
    ...
    impl Builder {
        ...
        /// <p>A list of intents that Amazon Lex V2 determined might satisfy the user's utterance. </p> 
        /// <p>Each interpretation includes the intent, a score that indicates now confident Amazon Lex V2 is that the interpretation is the correct one, and an optional sentiment response that indicates the sentiment expressed in the utterance.</p>
        pub fn set_interpretations(mut self, input: std::option::Option<std::vec::Vec<crate::model::Interpretation>>) -> Self {
            self.interpretations = input; self
        }
