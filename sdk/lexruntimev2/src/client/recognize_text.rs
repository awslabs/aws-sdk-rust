...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::set_bot_id): <p>The identifier of the bot that processes the request.</p>
    ///   - [`bot_alias_id(impl ::std::convert::Into<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::bot_alias_id) / [`set_bot_alias_id(Option<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::set_bot_alias_id): <p>The alias identifier in use for the bot that processes the request.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::set_locale_id): <p>The locale where the session is in use.</p>
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::set_session_id): <p>The identifier of the user session that is having the conversation.</p>
    ///   - [`text(impl ::std::convert::Into<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::recognize_text::builders::RecognizeTextFluentBuilder::set_text): <p>The text that the user entered. Amazon Lex V2 interprets this text.</p>
