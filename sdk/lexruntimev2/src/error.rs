...
impl smithy_types::retry::ProvideErrorKind for RecognizeTextError {
    fn code(&self) -> Option<&str> {
...
impl RecognizeTextError {
    pub fn new(kind: RecognizeTextErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for RecognizeUtteranceError {
    fn code(&self) -> Option<&str> {
...
impl RecognizeUtteranceError {
    pub fn new(kind: RecognizeUtteranceErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
