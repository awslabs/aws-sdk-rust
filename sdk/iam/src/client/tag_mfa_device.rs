...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::tag_mfa_device::builders::TagMFADeviceFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::tag_mfa_device::builders::TagMFADeviceFluentBuilder::set_tags): <p>The list of tags that you want to attach to the IAM virtual MFA device. Each tag consists of a key name and an associated value.</p>
