...
impl super::Client {
    ...
    ///   - [`serial_number(impl ::std::convert::Into<String>)`](crate::operation::tag_mfa_device::builders::TagMFADeviceFluentBuilder::serial_number) / [`set_serial_number(Option<String>)`](crate::operation::tag_mfa_device::builders::TagMFADeviceFluentBuilder::set_serial_number): <p>The unique identifier for the IAM virtual MFA device to which you want to add tags. For virtual MFA devices, the serial number is the same as the ARN.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
