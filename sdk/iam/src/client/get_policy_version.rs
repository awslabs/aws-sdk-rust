...
impl super::Client {
    ...
    ///   - [`policy_arn(impl ::std::convert::Into<String>)`](crate::operation::get_policy_version::builders::GetPolicyVersionFluentBuilder::policy_arn) / [`set_policy_arn(Option<String>)`](crate::operation::get_policy_version::builders::GetPolicyVersionFluentBuilder::set_policy_arn): <p>The Amazon Resource Name (ARN) of the managed policy that you want information about.</p>  <p>For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.</p>
    ///   - [`version_id(impl ::std::convert::Into<String>)`](crate::operation::get_policy_version::builders::GetPolicyVersionFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::get_policy_version::builders::GetPolicyVersionFluentBuilder::set_version_id): <p>Identifies the policy version to retrieve.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that consists of the lowercase letter 'v' followed by one or two digits, and optionally followed by a period '.' and a string of letters and digits.</p>
