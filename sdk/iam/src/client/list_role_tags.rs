...
impl super::Client {
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::set_role_name): <p>The name of the IAM role for which you want to see the list of tags.</p>  <p>This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that consist of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_role_tags::builders::ListRoleTagsFluentBuilder::set_marker): <p>Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the <code>Marker</code> element in the response that you received to indicate where the next call should start.</p>
