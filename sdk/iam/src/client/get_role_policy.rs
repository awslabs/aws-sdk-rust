...
impl super::Client {
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::get_role_policy::builders::GetRolePolicyFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::get_role_policy::builders::GetRolePolicyFluentBuilder::set_role_name): <p>The name of the role associated with the policy.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::get_role_policy::builders::GetRolePolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::get_role_policy::builders::GetRolePolicyFluentBuilder::set_policy_name): <p>The name of the policy document to get.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
