...
impl super::Client {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::create_access_key::builders::CreateAccessKeyFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::create_access_key::builders::CreateAccessKeyFluentBuilder::set_user_name): <p>The name of the IAM user that the new key will belong to.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
