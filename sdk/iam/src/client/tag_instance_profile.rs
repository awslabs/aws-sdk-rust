...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::tag_instance_profile::builders::TagInstanceProfileFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::tag_instance_profile::builders::TagInstanceProfileFluentBuilder::set_tags): <p>The list of tags that you want to attach to the IAM instance profile. Each tag consists of a key name and an associated value.</p>
