...
impl super::Client {
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::update_role::builders::UpdateRoleFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::update_role::builders::UpdateRoleFluentBuilder::set_role_name): <p>The name of the role that you want to modify.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_role::builders::UpdateRoleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_role::builders::UpdateRoleFluentBuilder::set_description): <p>The new description that you want to apply to the specified role.</p>
