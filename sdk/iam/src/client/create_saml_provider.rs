...
impl super::Client {
    /// Constructs a fluent builder for the [`CreateSAMLProvider`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`saml_metadata_document(impl ::std::convert::Into<String>)`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder::saml_metadata_document) / [`set_saml_metadata_document(Option<String>)`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder::set_saml_metadata_document): <p>An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document includes the issuer's name, expiration information, and keys that can be used to validate the SAML authentication response (assertions) that are received from the IdP. You must generate the metadata document using the identity management software that is used as your organization's IdP.</p>  <p>For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_saml.html">About SAML 2.0-based federation</a> in the <i>IAM User Guide</i> </p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder::set_name): <p>The name of the provider to create.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_saml_provider::builders::CreateSAMLProviderFluentBuilder::set_tags): <p>A list of tags that you want to attach to the new IAM SAML provider. Each tag consists of a key name and an associated value. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p> <note>   <p>If any one of the tags is invalid or if you exceed the allowed maximum number of tags, then the entire request fails and the resource is not created.</p>  </note>
    /// - On success, responds with [`CreateSamlProviderOutput`](crate::operation::create_saml_provider::CreateSamlProviderOutput) with field(s):
