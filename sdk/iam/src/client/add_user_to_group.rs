...
impl super::Client {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::add_user_to_group::builders::AddUserToGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::add_user_to_group::builders::AddUserToGroupFluentBuilder::set_group_name): <p>The name of the group to update.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
