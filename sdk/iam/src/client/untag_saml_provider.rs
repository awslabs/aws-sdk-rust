...
impl super::Client {
    ...
    ///   - [`saml_provider_arn(impl ::std::convert::Into<String>)`](crate::operation::untag_saml_provider::builders::UntagSAMLProviderFluentBuilder::saml_provider_arn) / [`set_saml_provider_arn(Option<String>)`](crate::operation::untag_saml_provider::builders::UntagSAMLProviderFluentBuilder::set_saml_provider_arn): <p>The ARN of the SAML identity provider in IAM from which you want to remove tags.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
