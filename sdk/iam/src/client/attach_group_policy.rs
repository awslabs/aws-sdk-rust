...
impl super::Client {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::attach_group_policy::builders::AttachGroupPolicyFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::attach_group_policy::builders::AttachGroupPolicyFluentBuilder::set_group_name): <p>The name (friendly name, not ARN) of the group to attach the policy to.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
