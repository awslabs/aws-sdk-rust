...
impl super::Client {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::update_access_key::builders::UpdateAccessKeyFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::update_access_key::builders::UpdateAccessKeyFluentBuilder::set_user_name): <p>The name of the user whose key you want to update.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`access_key_id(impl ::std::convert::Into<String>)`](crate::operation::update_access_key::builders::UpdateAccessKeyFluentBuilder::access_key_id) / [`set_access_key_id(Option<String>)`](crate::operation::update_access_key::builders::UpdateAccessKeyFluentBuilder::set_access_key_id): <p>The access key ID of the secret access key you want to update.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
