...
impl super::Client {
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::attach_role_policy::builders::AttachRolePolicyFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::attach_role_policy::builders::AttachRolePolicyFluentBuilder::set_role_name): <p>The name (friendly name, not ARN) of the role to attach the policy to.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
