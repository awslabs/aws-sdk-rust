...
impl super::Client {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::put_user_policy::builders::PutUserPolicyFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::put_user_policy::builders::PutUserPolicyFluentBuilder::set_user_name): <p>The name of the user to associate the policy with.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::put_user_policy::builders::PutUserPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::put_user_policy::builders::PutUserPolicyFluentBuilder::set_policy_name): <p>The name of the policy document.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
