...
impl super::Client {
    ...
    ///   - [`policy_arn(impl ::std::convert::Into<String>)`](crate::operation::tag_policy::builders::TagPolicyFluentBuilder::policy_arn) / [`set_policy_arn(Option<String>)`](crate::operation::tag_policy::builders::TagPolicyFluentBuilder::set_policy_arn): <p>The ARN of the IAM customer managed policy to which you want to add tags.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
