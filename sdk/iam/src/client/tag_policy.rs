...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::tag_policy::builders::TagPolicyFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::tag_policy::builders::TagPolicyFluentBuilder::set_tags): <p>The list of tags that you want to attach to the IAM customer managed policy. Each tag consists of a key name and an associated value.</p>
