...
impl super::Client {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::remove_user_from_group::builders::RemoveUserFromGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::remove_user_from_group::builders::RemoveUserFromGroupFluentBuilder::set_group_name): <p>The name of the group to update.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
