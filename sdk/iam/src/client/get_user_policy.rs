...
impl super::Client {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::get_user_policy::builders::GetUserPolicyFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::get_user_policy::builders::GetUserPolicyFluentBuilder::set_user_name): <p>The name of the user who the policy is associated with.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::get_user_policy::builders::GetUserPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::get_user_policy::builders::GetUserPolicyFluentBuilder::set_policy_name): <p>The name of the policy document to get.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
