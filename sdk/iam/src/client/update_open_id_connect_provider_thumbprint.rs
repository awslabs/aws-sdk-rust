...
impl super::Client  {
    ...
    pub fn update_open_id_connect_provider_thumbprint(&self) -> crate::client::fluent_builders::UpdateOpenIDConnectProviderThumbprint {
                                crate::client::fluent_builders::UpdateOpenIDConnectProviderThumbprint::new(self.handle.clone())
                            }
}
