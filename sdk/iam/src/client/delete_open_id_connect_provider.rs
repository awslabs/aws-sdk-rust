...
impl super::Client {
    ...
    ///   - [`open_id_connect_provider_arn(impl Into<String>)`](crate::operation::delete_open_id_connect_provider::builders::DeleteOpenIDConnectProviderFluentBuilder::open_id_connect_provider_arn) / [`set_open_id_connect_provider_arn(Option<String>)`](crate::operation::delete_open_id_connect_provider::builders::DeleteOpenIDConnectProviderFluentBuilder::set_open_id_connect_provider_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the IAM OpenID Connect provider resource object to delete. You can get a list of OpenID Connect provider resource ARNs by using the <code>ListOpenIDConnectProviders</code> operation.</p><br>
