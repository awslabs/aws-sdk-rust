...
impl super::Client {
    ...
    ///   - [`user_name(impl Into<String>)`](crate::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::set_user_name): <p>The friendly name identifying the user.</p>
