...
impl super::Client {
    ...
    ///   - [`serial_number(impl ::std::convert::Into<String>)`](crate::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::serial_number) / [`set_serial_number(Option<String>)`](crate::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::set_serial_number): <p>Serial number that uniquely identifies the MFA device. For this API, we only accept FIDO security key <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html">ARNs</a>.</p>
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::get_mfa_device::builders::GetMFADeviceFluentBuilder::set_user_name): <p>The friendly name identifying the user.</p>
    ...
    ///   - [`serial_number(Option<String>)`](crate::operation::get_mfa_device::GetMfaDeviceOutput::serial_number): <p>Serial number that uniquely identifies the MFA device. For this API, we only accept FIDO security key <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html">ARNs</a>.</p>
