...
impl  Role  {
    ...
    pub fn role_id(&self) -> & str {
        use std::ops::Deref; self.role_id.deref()
    }
    /// <p>The Amazon Resource Name (ARN) specifying the role. For more information about ARNs and how to use them in policies, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i> guide.</p>
    pub fn arn(&self) -> & str {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::Role, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::Role {
                path: self.path
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("path", "path was not specified but it is required when building Role")
                    )?
                ,
                role_name: self.role_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_name", "role_name was not specified but it is required when building Role")
                    )?
                ,
                role_id: self.role_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_id", "role_id was not specified but it is required when building Role")
                    )?
                ,
                arn: self.arn
                    .ok_or_else(||
                ...
                create_date: self.create_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("create_date", "create_date was not specified but it is required when building Role")
                    )?
                ,
