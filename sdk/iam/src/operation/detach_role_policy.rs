...
impl DetachRolePolicyInput {
    /// Consumes the builder and constructs an Operation<[`DetachRolePolicy`](crate::operation::detach_role_policy::DetachRolePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_role_policy::DetachRolePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_role_policy::DetachRolePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_role_policy::DetachRolePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachRolePolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DetachRolePolicy {
                type Output = std::result::Result<crate::operation::detach_role_policy::DetachRolePolicyOutput, crate::operation::detach_role_policy::DetachRolePolicyError>;
