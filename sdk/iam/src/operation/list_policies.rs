...
impl ListPoliciesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_policies_input::ser_list_policies_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_policies::ListPolicies::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPolicies", "iam"));
