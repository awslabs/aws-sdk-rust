...
impl TagRoleInput {
    /// Consumes the builder and constructs an Operation<[`TagRole`](crate::operation::tag_role::TagRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_role::TagRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_role::TagRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_role::TagRole::new())
...
impl aws_smithy_http::response::ParseStrictResponse for TagRole {
                type Output = std::result::Result<crate::operation::tag_role::TagRoleOutput, crate::operation::tag_role::TagRoleError>;
