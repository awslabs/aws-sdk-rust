...
/// Paginator for [`ListVirtualMFADevices`](crate::operation::list_virtual_mfa_devices::ListVirtualMFADevices)
            ...
            impl ListVirtualMfaDevicesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesOutput, aws_smithy_http::result::SdkError<crate::operation::list_virtual_mfa_devices::ListVirtualMFADevicesError>>> + Unpin
                 {
...
/// Flattened paginator for `ListVirtualMfaDevicesPaginator`
                ...
                impl  ListVirtualMfaDevicesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::VirtualMfaDevice, aws_smithy_http::result::SdkError<crate::operation::list_virtual_mfa_devices::ListVirtualMFADevicesError>>> + Unpin
                     {
