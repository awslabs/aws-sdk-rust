...
impl AddUserToGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_user_to_group::AddUserToGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_user_to_group::AddUserToGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_user_to_group::AddUserToGroupOutput, crate::operation::add_user_to_group::AddUserToGroupError, Self> {
