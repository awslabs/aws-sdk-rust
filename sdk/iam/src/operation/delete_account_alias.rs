...
impl DeleteAccountAlias {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("iam", "DeleteAccountAlias", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAccountAlias {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteAccountAlias", "iam"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAccountAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_account_alias_input::ser_delete_account_alias_input_input(&input)?,
        );
