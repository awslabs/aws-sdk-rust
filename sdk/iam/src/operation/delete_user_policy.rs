...
impl DeleteUserPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_user_policy::DeleteUserPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_user_policy::de_delete_user_policy_http_response_with_props(status, headers, body)
        }
    }
}
