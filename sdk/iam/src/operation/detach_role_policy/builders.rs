...
impl DetachRolePolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detach_role_policy::DetachRolePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_role_policy::DetachRolePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detach_role_policy::DetachRolePolicyOutput, crate::operation::detach_role_policy::DetachRolePolicyError, Self> {
