...
impl RemoveClientIdFromOpenIdConnectProviderInput {
    /// Consumes the builder and constructs an Operation<[`RemoveClientIDFromOpenIDConnectProvider`](crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RemoveClientIDFromOpenIDConnectProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveClientIDFromOpenIDConnectProvider {
                type Output = std::result::Result<crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderOutput, crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProviderError>;
...
/// Do not use this.
            ...
            pub type RemoveClientIDFromOpenIDConnectProviderErrorKind = RemoveClientIDFromOpenIDConnectProviderError;
...
impl aws_smithy_http::result::CreateUnhandledError for RemoveClientIDFromOpenIDConnectProviderError {
...
impl aws_http::request_id::RequestId for crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIDFromOpenIDConnectProviderError {
