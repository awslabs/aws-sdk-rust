...
impl ListAttachedRolePoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_attached_role_policies::ListAttachedRolePoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_attached_role_policies::ListAttachedRolePoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_attached_role_policies::ListAttachedRolePoliciesOutput, crate::operation::list_attached_role_policies::ListAttachedRolePoliciesError, Self> {
