...
impl ListAttachedRolePoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_attached_role_policies::ListAttachedRolePoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
