...
impl ListAccessKeysInput {
    /// Consumes the builder and constructs an Operation<[`ListAccessKeys`](crate::operation::list_access_keys::ListAccessKeys)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_access_keys::ListAccessKeys, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_access_keys::ListAccessKeysInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_access_keys_input::ser_list_access_keys_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_access_keys::ListAccessKeys::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAccessKeys", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessKeys {
                type Output = std::result::Result<crate::operation::list_access_keys::ListAccessKeysOutput, crate::operation::list_access_keys::ListAccessKeysError>;
