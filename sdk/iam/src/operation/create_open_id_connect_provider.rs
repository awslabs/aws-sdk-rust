...
impl CreateOpenIdConnectProviderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_open_id_connect_provider::CreateOpenIDConnectProvider::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOpenIDConnectProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_open_id_connect_provider::de_create_open_id_connect_provider_http_response_with_props(
                status, headers, body,
            )
        }
    }
