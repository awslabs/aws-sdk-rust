...
impl GetAccountAuthorizationDetailsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_account_authorization_details::GetAccountAuthorizationDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountAuthorizationDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_account_authorization_details::de_get_account_authorization_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
