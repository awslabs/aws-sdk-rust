...
impl GetAccountAuthorizationDetailsInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountAuthorizationDetails`](crate::operation::get_account_authorization_details::GetAccountAuthorizationDetails)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_account_authorization_details::GetAccountAuthorizationDetails, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_account_authorization_details::GetAccountAuthorizationDetailsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_authorization_details::GetAccountAuthorizationDetails::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAccountAuthorizationDetails", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccountAuthorizationDetails {
                type Output = std::result::Result<crate::operation::get_account_authorization_details::GetAccountAuthorizationDetailsOutput, crate::operation::get_account_authorization_details::GetAccountAuthorizationDetailsError>;
