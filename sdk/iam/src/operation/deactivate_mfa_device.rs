...
impl DeactivateMfaDeviceInput {
    /// Consumes the builder and constructs an Operation<[`DeactivateMFADevice`](crate::operation::deactivate_mfa_device::DeactivateMFADevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deactivate_mfa_device::DeactivateMFADevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deactivate_mfa_device::DeactivateMfaDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deactivate_mfa_device::DeactivateMFADevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeactivateMFADevice", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeactivateMFADevice {
                type Output = std::result::Result<crate::operation::deactivate_mfa_device::DeactivateMfaDeviceOutput, crate::operation::deactivate_mfa_device::DeactivateMFADeviceError>;
