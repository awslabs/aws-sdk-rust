    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::deactivate_mfa_device::DeactivateMFADeviceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::deactivate_mfa_device::DeactivateMfaDeviceOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeactivateMFADeviceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::deactivate_mfa_device::DeactivateMfaDeviceInput>()
            .expect("correct type");
