...
impl GetServiceLastAccessedDetailsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_service_last_accessed_details::GetServiceLastAccessedDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceLastAccessedDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_last_accessed_details::de_get_service_last_accessed_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
