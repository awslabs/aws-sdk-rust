...
impl EnableMfaDeviceInput {
    /// Consumes the builder and constructs an Operation<[`EnableMFADevice`](crate::operation::enable_mfa_device::EnableMFADevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_mfa_device::EnableMFADevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_mfa_device::EnableMfaDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_mfa_device::EnableMFADevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EnableMFADevice", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for EnableMFADevice {
                type Output = std::result::Result<crate::operation::enable_mfa_device::EnableMfaDeviceOutput, crate::operation::enable_mfa_device::EnableMFADeviceError>;
