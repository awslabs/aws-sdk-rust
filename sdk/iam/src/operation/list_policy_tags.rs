...
impl ListPolicyTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_policy_tags::ListPolicyTags, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyTags {
    type Output =
        ::std::result::Result<crate::operation::list_policy_tags::ListPolicyTagsOutput, crate::operation::list_policy_tags::ListPolicyTagsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_policy_tags::de_list_policy_tags_http_response_with_props(status, headers, body)
        }
    }
}
