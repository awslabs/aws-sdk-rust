...
impl ListPolicyTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_policy_tags::ListPolicyTags,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_policy_tags::ListPolicyTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_policy_tags::de_list_policy_tags_http_error(
                status, headers, body,
            )
        } else {
