...
impl AttachGroupPolicyFluentBuilder  {
    /// Creates a new `AttachGroupPolicy`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::attach_group_policy::AttachGroupPolicy, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::attach_group_policy::AttachGroupPolicyError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::attach_group_policy::AttachGroupPolicyOutput, aws_smithy_http::result::SdkError<crate::operation::attach_group_policy::AttachGroupPolicyError>>
                     {
