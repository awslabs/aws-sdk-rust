...
impl DeleteServiceLinkedRoleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_service_linked_role::DeleteServiceLinkedRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_service_linked_role::DeleteServiceLinkedRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_service_linked_role::DeleteServiceLinkedRoleOutput, crate::operation::delete_service_linked_role::DeleteServiceLinkedRoleError, Self> {
