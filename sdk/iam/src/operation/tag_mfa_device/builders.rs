...
impl TagMFADeviceFluentBuilder  {
    /// Creates a new `TagMFADevice`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::tag_mfa_device::TagMFADevice, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::tag_mfa_device::TagMFADeviceError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::tag_mfa_device::TagMfaDeviceOutput, aws_smithy_http::result::SdkError<crate::operation::tag_mfa_device::TagMFADeviceError>>
                     {
