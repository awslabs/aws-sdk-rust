...
impl ListOpenIdConnectProviderTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListOpenIDConnectProviderTags`](crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTags, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTags::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListOpenIDConnectProviderTags", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListOpenIDConnectProviderTags {
                type Output = std::result::Result<crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsOutput, crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTagsError>;
