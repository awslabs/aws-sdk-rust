...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOpenIDConnectProviderTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_open_id_connect_provider_tags::de_list_open_id_connect_provider_tags_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTagsError
{
