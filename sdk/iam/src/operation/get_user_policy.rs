...
impl GetUserPolicyInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_user_policy::GetUserPolicy,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_user_policy::GetUserPolicy::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetUserPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_user_policy::de_get_user_policy_http_error(
                status, headers, body,
            )
        } else {
