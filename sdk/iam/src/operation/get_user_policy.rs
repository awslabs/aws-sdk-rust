...
impl GetUserPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetUserPolicy`](crate::operation::get_user_policy::GetUserPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_user_policy::GetUserPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_user_policy::GetUserPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_user_policy_input::ser_get_user_policy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_user_policy::GetUserPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetUserPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetUserPolicy {
                type Output = std::result::Result<crate::operation::get_user_policy::GetUserPolicyOutput, crate::operation::get_user_policy::GetUserPolicyError>;
