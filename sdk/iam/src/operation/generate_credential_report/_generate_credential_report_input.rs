...
impl GenerateCredentialReportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::generate_credential_report::GenerateCredentialReportInput, ::aws_smithy_types::error::operation::BuildError> {
