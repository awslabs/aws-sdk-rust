...
impl GetOrganizationsAccessReportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_organizations_access_report::GetOrganizationsAccessReport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOrganizationsAccessReport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_organizations_access_report::de_get_organizations_access_report_http_response_with_props(
                status, headers, body,
            )
        }
    }
