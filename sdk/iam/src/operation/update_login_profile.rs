...
impl UpdateLoginProfileInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLoginProfile`](crate::operation::update_login_profile::UpdateLoginProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_login_profile::UpdateLoginProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_login_profile::UpdateLoginProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_login_profile::UpdateLoginProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateLoginProfile", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateLoginProfile {
                type Output = std::result::Result<crate::operation::update_login_profile::UpdateLoginProfileOutput, crate::operation::update_login_profile::UpdateLoginProfileError>;
