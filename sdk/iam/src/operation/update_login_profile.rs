...
impl UpdateLoginProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_login_profile::UpdateLoginProfile,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLoginProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_login_profile::de_update_login_profile_http_response_with_props(status, headers, body)
        }
    }
}
