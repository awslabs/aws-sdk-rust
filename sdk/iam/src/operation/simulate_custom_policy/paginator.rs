...
/// Paginator for [`SimulateCustomPolicy`](crate::operation::simulate_custom_policy::SimulateCustomPolicy)
                ...
                impl SimulateCustomPolicyPaginator {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::simulate_custom_policy::SimulateCustomPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::simulate_custom_policy::SimulateCustomPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ...
                            loop {
                                ...
                                let done = match resp {
                                    ::std::result::Result::Ok(ref resp) => {
                                        let new_token = crate::lens::reflens_simulate_custom_policy_output_output_marker(resp);
...
/// Flattened paginator for `SimulateCustomPolicyPaginator`
                    ...
                    impl SimulateCustomPolicyPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::EvaluationResult, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::simulate_custom_policy::SimulateCustomPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_simulate_custom_policy_output_output_evaluation_results(page).unwrap_or_default().into_iter())
                        }
                    }
