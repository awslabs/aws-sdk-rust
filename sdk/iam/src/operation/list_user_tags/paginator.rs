...
impl ListUserTagsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Tag, ::aws_smithy_http::result::SdkError<crate::operation::list_user_tags::ListUserTagsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_user_tags_output_tags(page).unwrap_or_default().into_iter())
    }
}
