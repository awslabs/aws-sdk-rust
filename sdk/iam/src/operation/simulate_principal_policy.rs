...
impl SimulatePrincipalPolicyInput {
    /// Consumes the builder and constructs an Operation<[`SimulatePrincipalPolicy`](crate::operation::simulate_principal_policy::SimulatePrincipalPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::simulate_principal_policy::SimulatePrincipalPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::simulate_principal_policy::SimulatePrincipalPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::simulate_principal_policy::SimulatePrincipalPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SimulatePrincipalPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for SimulatePrincipalPolicy {
                type Output = std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError>;
