...
impl UploadSSHPublicKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::upload_ssh_public_key::UploadSshPublicKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::upload_ssh_public_key::UploadSshPublicKeyOutput, crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError, Self> {
