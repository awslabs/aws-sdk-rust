...
impl UploadSigningCertificateInput {
    /// Consumes the builder and constructs an Operation<[`UploadSigningCertificate`](crate::operation::upload_signing_certificate::UploadSigningCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::upload_signing_certificate::UploadSigningCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_signing_certificate::UploadSigningCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::upload_signing_certificate::UploadSigningCertificate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UploadSigningCertificate", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UploadSigningCertificate {
                type Output = std::result::Result<crate::operation::upload_signing_certificate::UploadSigningCertificateOutput, crate::operation::upload_signing_certificate::UploadSigningCertificateError>;
