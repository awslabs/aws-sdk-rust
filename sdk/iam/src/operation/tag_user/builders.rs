...
impl TagUserFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::tag_user::TagUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_user::TagUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
