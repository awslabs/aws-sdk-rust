...
impl AttachUserPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::attach_user_policy::AttachUserPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachUserPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_user_policy::de_attach_user_policy_http_response_with_props(status, headers, body)
        }
    }
}
