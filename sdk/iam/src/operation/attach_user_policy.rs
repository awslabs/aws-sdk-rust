...
impl AttachUserPolicyInput {
    /// Consumes the builder and constructs an Operation<[`AttachUserPolicy`](crate::operation::attach_user_policy::AttachUserPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_user_policy::AttachUserPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_user_policy::AttachUserPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::attach_user_policy::AttachUserPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AttachUserPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for AttachUserPolicy {
                type Output = std::result::Result<crate::operation::attach_user_policy::AttachUserPolicyOutput, crate::operation::attach_user_policy::AttachUserPolicyError>;
