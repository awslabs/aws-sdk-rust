...
impl UpdateAccessKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_access_key::UpdateAccessKey, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccessKey {
    type Output =
        ::std::result::Result<crate::operation::update_access_key::UpdateAccessKeyOutput, crate::operation::update_access_key::UpdateAccessKeyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_access_key::de_update_access_key_http_response_with_props(status, headers, body)
        }
    }
}
