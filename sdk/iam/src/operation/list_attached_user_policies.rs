...
impl ListAttachedUserPoliciesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_attached_user_policies::ListAttachedUserPolicies::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttachedUserPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_attached_user_policies::de_list_attached_user_policies_http_response_with_props(status, headers, body)
        }
    }
}
