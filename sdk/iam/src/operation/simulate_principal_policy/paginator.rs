...
/// Paginator for [`SimulatePrincipalPolicy`](crate::operation::simulate_principal_policy::SimulatePrincipalPolicy)
            ...
            impl SimulatePrincipalPolicyPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, aws_smithy_http::result::SdkError<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError>>> + Unpin
                 {
...
/// Flattened paginator for `SimulatePrincipalPolicyPaginator`
                ...
                impl  SimulatePrincipalPolicyPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::EvaluationResult, aws_smithy_http::result::SdkError<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError>>> + Unpin
                     {
