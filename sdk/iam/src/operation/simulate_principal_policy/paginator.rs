...
/// Paginator for [`SimulatePrincipalPolicy`](crate::operation::simulate_principal_policy::SimulatePrincipalPolicy)
                ...
                impl SimulatePrincipalPolicyPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::simulate_principal_policy::builders::SimulatePrincipalPolicyInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::simulate_principal_policy::SimulatePrincipalPolicy::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `SimulatePrincipalPolicyPaginator`
                    ...
                    impl SimulatePrincipalPolicyPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::EvaluationResult, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_simulate_principal_policy_output_output_evaluation_results(page).unwrap_or_default().into_iter())
                        }
                    }
