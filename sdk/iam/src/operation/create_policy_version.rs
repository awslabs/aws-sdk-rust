...
impl CreatePolicyVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreatePolicyVersion`](crate::operation::create_policy_version::CreatePolicyVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_policy_version::CreatePolicyVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_policy_version::CreatePolicyVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_policy_version::CreatePolicyVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePolicyVersion", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePolicyVersion {
                type Output = std::result::Result<crate::operation::create_policy_version::CreatePolicyVersionOutput, crate::operation::create_policy_version::CreatePolicyVersionError>;
