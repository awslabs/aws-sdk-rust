...
impl TagPolicyInput {
    /// Consumes the builder and constructs an Operation<[`TagPolicy`](crate::operation::tag_policy::TagPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_policy::TagPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_policy::TagPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_policy::TagPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagPolicy {
                type Output = std::result::Result<crate::operation::tag_policy::TagPolicyOutput, crate::operation::tag_policy::TagPolicyError>;
