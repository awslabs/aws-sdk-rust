...
impl DeleteGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_group_input::ser_delete_group_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_group::DeleteGroup::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteGroup", "iam"));
