...
impl UpdateServiceSpecificCredentialInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_service_specific_credential::UpdateServiceSpecificCredential::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateServiceSpecificCredential {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_service_specific_credential::de_update_service_specific_credential_http_response_with_props(
                status, headers, body,
            )
        }
    }
