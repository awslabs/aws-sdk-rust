...
impl ListRolePoliciesFluentBuilder  {
    /// Creates a new `ListRolePolicies`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_role_policies::ListRolePolicies, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_role_policies::ListRolePoliciesError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_role_policies::ListRolePoliciesOutput, aws_smithy_http::result::SdkError<crate::operation::list_role_policies::ListRolePoliciesError>>
                     {
