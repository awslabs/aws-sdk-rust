...
impl DeleteOpenIdConnectProviderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOpenIDConnectProvider`](crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteOpenIDConnectProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteOpenIDConnectProvider {
                type Output = std::result::Result<crate::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderOutput, crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProviderError>;
