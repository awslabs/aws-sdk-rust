...
impl DeleteOpenIdConnectProviderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProvider::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOpenIDConnectProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_open_id_connect_provider::de_delete_open_id_connect_provider_http_response_with_props(
                status, headers, body,
            )
        }
    }
