...
impl DeleteRolePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_role_policy::DeleteRolePolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRolePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_role_policy::de_delete_role_policy_http_response_with_props(status, headers, body)
        }
    }
}
