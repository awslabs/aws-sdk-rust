...
impl DeleteRolePolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRolePolicy`](crate::operation::delete_role_policy::DeleteRolePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_role_policy::DeleteRolePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_role_policy::DeleteRolePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_role_policy::DeleteRolePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteRolePolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRolePolicy {
                type Output = std::result::Result<crate::operation::delete_role_policy::DeleteRolePolicyOutput, crate::operation::delete_role_policy::DeleteRolePolicyError>;
