...
impl TagUserInput {
    /// Consumes the builder and constructs an Operation<[`TagUser`](crate::operation::tag_user::TagUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_user::TagUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_user::TagUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_user::TagUser::new())
...
impl aws_smithy_http::response::ParseStrictResponse for TagUser {
                type Output = std::result::Result<crate::operation::tag_user::TagUserOutput, crate::operation::tag_user::TagUserError>;
