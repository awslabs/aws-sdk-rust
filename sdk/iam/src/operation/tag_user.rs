...
impl TagUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_user::TagUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_user_input::ser_tag_user_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_tag_user::de_tag_user_http_response_with_props(status, headers, body)
        }
    }
}
