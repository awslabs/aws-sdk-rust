...
impl TagOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput, ::aws_smithy_types::error::operation::BuildError> {
