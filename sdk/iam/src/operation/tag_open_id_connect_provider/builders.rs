...
impl TagOpenIDConnectProviderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderOutput, crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError, Self> {
