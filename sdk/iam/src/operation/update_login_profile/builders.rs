...
impl UpdateLoginProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_login_profile::UpdateLoginProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_login_profile::UpdateLoginProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_login_profile::UpdateLoginProfileOutput, crate::operation::update_login_profile::UpdateLoginProfileError, Self> {
