...
impl PutRolePermissionsBoundaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_role_permissions_boundary::PutRolePermissionsBoundary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRolePermissionsBoundary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_role_permissions_boundary::de_put_role_permissions_boundary_http_response_with_props(
                status, headers, body,
            )
        }
    }
