...
impl ListRolesFluentBuilder  {
    /// Creates a new `ListRoles`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_roles::ListRoles, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_roles::ListRolesError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_roles::ListRolesOutput, aws_smithy_http::result::SdkError<crate::operation::list_roles::ListRolesError>>
                     {
    ...
    /// Create a paginator for this request
                        ///
                        /// Paginators are used by calling [`send().await`](crate::operation::list_roles::paginator::ListRolesPaginator::send) which returns a `Stream`.
