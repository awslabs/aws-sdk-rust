...
impl ListRolesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Role, ::aws_smithy_http::result::SdkError<crate::operation::list_roles::ListRolesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_roles_output_roles(page).unwrap_or_default().into_iter())
    }
}
