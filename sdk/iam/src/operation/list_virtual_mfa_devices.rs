...
impl ListVirtualMfaDevicesInput {
    /// Consumes the builder and constructs an Operation<[`ListVirtualMFADevices`](crate::operation::list_virtual_mfa_devices::ListVirtualMFADevices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_virtual_mfa_devices::ListVirtualMFADevices, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_virtual_mfa_devices::ListVirtualMFADevices::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListVirtualMFADevices", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListVirtualMFADevices {
                type Output = std::result::Result<crate::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesOutput, crate::operation::list_virtual_mfa_devices::ListVirtualMFADevicesError>;
