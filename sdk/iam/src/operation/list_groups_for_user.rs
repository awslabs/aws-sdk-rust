...
impl ListGroupsForUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_groups_for_user::ListGroupsForUser,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroupsForUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_groups_for_user::de_list_groups_for_user_http_response_with_props(status, headers, body)
        }
    }
}
