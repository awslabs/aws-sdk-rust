...
impl ListGroupsForUserInput {
    /// Consumes the builder and constructs an Operation<[`ListGroupsForUser`](crate::operation::list_groups_for_user::ListGroupsForUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_groups_for_user::ListGroupsForUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_groups_for_user::ListGroupsForUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_groups_for_user::ListGroupsForUser::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListGroupsForUser", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListGroupsForUser {
                type Output = std::result::Result<crate::operation::list_groups_for_user::ListGroupsForUserOutput, crate::operation::list_groups_for_user::ListGroupsForUserError>;
