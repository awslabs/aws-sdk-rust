...
/// Orchestration and serialization glue logic for `ListGroupsForUser`.
...
impl ListGroupsForUser {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_groups_for_user::ListGroupsForUserInput,
                    ) -> ::std::result::Result<crate::operation::list_groups_for_user::ListGroupsForUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_groups_for_user::ListGroupsForUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_groups_for_user::ListGroupsForUserError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_groups_for_user::ListGroupsForUserOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListGroupsForUser {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListGroupsForUser");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListGroupsForUserRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListGroupsForUserResponseDeserializer));
...
.with_interceptor(ListGroupsForUserEndpointParamsInterceptor)
...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_groups_for_user::ListGroupsForUserError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGroupsForUserResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_groups_for_user::de_list_groups_for_user_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_groups_for_user::de_list_groups_for_user_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGroupsForUserRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_groups_for_user::ListGroupsForUserInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_groups_for_user::ListGroupsForUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_groups_for_user_input::ser_list_groups_for_user_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ListGroupsForUserEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListGroupsForUserEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListGroupsForUserInput>()
...
pub enum ListGroupsForUserError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListGroupsForUserError) for what information is available for the error.")]
...
impl ListGroupsForUserError {
    /// Creates the `ListGroupsForUserError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListGroupsForUserError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListGroupsForUserError {
...
pub use crate::operation::list_groups_for_user::_list_groups_for_user_output::ListGroupsForUserOutput;

pub use crate::operation::list_groups_for_user::_list_groups_for_user_input::ListGroupsForUserInput;

mod _list_groups_for_user_input;

mod _list_groups_for_user_output;
