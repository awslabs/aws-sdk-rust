...
impl GetServerCertificateInput {
    /// Consumes the builder and constructs an Operation<[`GetServerCertificate`](crate::operation::get_server_certificate::GetServerCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_server_certificate::GetServerCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_server_certificate::GetServerCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_server_certificate::GetServerCertificate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetServerCertificate", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetServerCertificate {
                type Output = std::result::Result<crate::operation::get_server_certificate::GetServerCertificateOutput, crate::operation::get_server_certificate::GetServerCertificateError>;
