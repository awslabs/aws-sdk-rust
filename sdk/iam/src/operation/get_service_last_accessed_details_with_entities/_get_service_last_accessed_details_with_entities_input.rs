...
impl GetServiceLastAccessedDetailsWithEntitiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_service_last_accessed_details_with_entities::GetServiceLastAccessedDetailsWithEntitiesInput, ::aws_smithy_types::error::operation::BuildError> {
