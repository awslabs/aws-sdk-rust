...
impl ChangePasswordInput {
    /// Consumes the builder and constructs an Operation<[`ChangePassword`](crate::operation::change_password::ChangePassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::change_password::ChangePassword, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::change_password::ChangePasswordInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_change_password_input::ser_change_password_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::change_password::ChangePassword::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ChangePassword", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ChangePassword {
                type Output = std::result::Result<crate::operation::change_password::ChangePasswordOutput, crate::operation::change_password::ChangePasswordError>;
