...
impl CreatePolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_policy_input::ser_create_policy_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_policy::CreatePolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePolicy", "iam"));
