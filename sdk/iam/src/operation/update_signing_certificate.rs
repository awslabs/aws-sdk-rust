...
impl UpdateSigningCertificateInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSigningCertificate`](crate::operation::update_signing_certificate::UpdateSigningCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_signing_certificate::UpdateSigningCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_signing_certificate::UpdateSigningCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_signing_certificate::UpdateSigningCertificate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSigningCertificate", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSigningCertificate {
                type Output = std::result::Result<crate::operation::update_signing_certificate::UpdateSigningCertificateOutput, crate::operation::update_signing_certificate::UpdateSigningCertificateError>;
