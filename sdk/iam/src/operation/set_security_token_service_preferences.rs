...
impl ::aws_smithy_http::response::ParseStrictResponse for SetSecurityTokenServicePreferences {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_security_token_service_preferences::de_set_security_token_service_preferences_http_response_with_props(status, headers, body)
        }
    }
}
