...
impl DeleteUserPermissionsBoundaryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserPermissionsBoundary`](crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundary::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteUserPermissionsBoundary", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUserPermissionsBoundary {
                type Output = std::result::Result<crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundaryOutput, crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundaryError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_user_permissions_boundary::DeleteUserPermissionsBoundaryError {
