...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRoleDescriptionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_role_description::de_update_role_description_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_role_description::de_update_role_description_http_response(status, headers, body, _cfg)
        };
