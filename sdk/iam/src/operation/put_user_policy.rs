...
impl PutUserPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutUserPolicy`](crate::operation::put_user_policy::PutUserPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_user_policy::PutUserPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_user_policy::PutUserPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_user_policy_input::ser_put_user_policy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_user_policy::PutUserPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutUserPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutUserPolicy {
                type Output = std::result::Result<crate::operation::put_user_policy::PutUserPolicyOutput, crate::operation::put_user_policy::PutUserPolicyError>;
