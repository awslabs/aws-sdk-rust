...
impl TagInstanceProfileInput {
    /// Consumes the builder and constructs an Operation<[`TagInstanceProfile`](crate::operation::tag_instance_profile::TagInstanceProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_instance_profile::TagInstanceProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_instance_profile::TagInstanceProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_instance_profile::TagInstanceProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagInstanceProfile", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagInstanceProfile {
                type Output = std::result::Result<crate::operation::tag_instance_profile::TagInstanceProfileOutput, crate::operation::tag_instance_profile::TagInstanceProfileError>;
