...
impl TagInstanceProfileFluentBuilder  {
    /// Creates a new `TagInstanceProfile`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::tag_instance_profile::TagInstanceProfileOutput, aws_smithy_http::result::SdkError<crate::operation::tag_instance_profile::TagInstanceProfileError>>
                     {
