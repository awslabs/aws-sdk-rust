...
impl TagMfaDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_mfa_device::TagMFADevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_mfa_device_input::ser_tag_mfa_device_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagMFADevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_tag_mfa_device::de_tag_mfa_device_http_response_with_props(status, headers, body)
        }
    }
}
