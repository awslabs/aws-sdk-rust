...
impl TagMfaDeviceInput {
    /// Consumes the builder and constructs an Operation<[`TagMFADevice`](crate::operation::tag_mfa_device::TagMFADevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_mfa_device::TagMFADevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_mfa_device::TagMfaDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_tag_mfa_device_input::ser_tag_mfa_device_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_mfa_device::TagMFADevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagMFADevice", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagMFADevice {
                type Output = std::result::Result<crate::operation::tag_mfa_device::TagMfaDeviceOutput, crate::operation::tag_mfa_device::TagMFADeviceError>;
