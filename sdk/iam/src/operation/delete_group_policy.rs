...
impl DeleteGroupPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGroupPolicy`](crate::operation::delete_group_policy::DeleteGroupPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_group_policy::DeleteGroupPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_group_policy::DeleteGroupPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_group_policy::DeleteGroupPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteGroupPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteGroupPolicy {
                type Output = std::result::Result<crate::operation::delete_group_policy::DeleteGroupPolicyOutput, crate::operation::delete_group_policy::DeleteGroupPolicyError>;
