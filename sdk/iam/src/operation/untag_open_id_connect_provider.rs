...
impl UntagOpenIdConnectProviderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_open_id_connect_provider::UntagOpenIDConnectProvider::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagOpenIDConnectProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_open_id_connect_provider::de_untag_open_id_connect_provider_http_response_with_props(
                status, headers, body,
            )
        }
    }
