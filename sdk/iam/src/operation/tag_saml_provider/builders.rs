...
impl TagSAMLProviderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::tag_saml_provider::TagSamlProviderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_saml_provider::TagSAMLProviderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::tag_saml_provider::TagSamlProviderOutput, crate::operation::tag_saml_provider::TagSAMLProviderError, Self> {
