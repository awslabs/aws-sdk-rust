...
impl SetDefaultPolicyVersionInput {
    /// Consumes the builder and constructs an Operation<[`SetDefaultPolicyVersion`](crate::operation::set_default_policy_version::SetDefaultPolicyVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_default_policy_version::SetDefaultPolicyVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_default_policy_version::SetDefaultPolicyVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_default_policy_version::SetDefaultPolicyVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetDefaultPolicyVersion", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetDefaultPolicyVersion {
                type Output = std::result::Result<crate::operation::set_default_policy_version::SetDefaultPolicyVersionOutput, crate::operation::set_default_policy_version::SetDefaultPolicyVersionError>;
