...
impl UpdateAssumeRolePolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAssumeRolePolicy`](crate::operation::update_assume_role_policy::UpdateAssumeRolePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_assume_role_policy::UpdateAssumeRolePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_assume_role_policy::UpdateAssumeRolePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateAssumeRolePolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAssumeRolePolicy {
                type Output = std::result::Result<crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyOutput, crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError>;
