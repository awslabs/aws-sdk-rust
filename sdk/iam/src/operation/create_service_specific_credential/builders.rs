...
/// <p>For more information about service-specific credentials, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_bedrock.html">Service-specific credentials for IAM users</a> in the <i>IAM User Guide</i>.</p>
...
impl CreateServiceSpecificCredentialFluentBuilder {
    ...
    pub fn credential_age_days(mut self, input: i32) -> Self {
        self.inner = self.inner.credential_age_days(input);
        self
    }
    /// <p>The number of days until the service specific credential expires. This field is only valid for Bedrock API keys and must be a positive integer. When not specified, the credential will not expire.</p>
    pub fn set_credential_age_days(mut self, input: ::std::option::Option<i32>) -> Self {
        self.inner = self.inner.set_credential_age_days(input);
        self
    }
    /// <p>The number of days until the service specific credential expires. This field is only valid for Bedrock API keys and must be a positive integer. When not specified, the credential will not expire.</p>
    pub fn get_credential_age_days(&self) -> &::std::option::Option<i32> {
        self.inner.get_credential_age_days()
    }
}
