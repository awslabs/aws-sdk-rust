...
impl AddRoleToInstanceProfileInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddRoleToInstanceProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_role_to_instance_profile::de_add_role_to_instance_profile_http_response_with_props(status, headers, body)
        }
    }
}
