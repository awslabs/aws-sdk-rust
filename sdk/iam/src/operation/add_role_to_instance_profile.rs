...
impl AddRoleToInstanceProfileInput {
    /// Consumes the builder and constructs an Operation<[`AddRoleToInstanceProfile`](crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddRoleToInstanceProfile", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for AddRoleToInstanceProfile {
                type Output = std::result::Result<crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileOutput, crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileError>;
