...
impl ListInstanceProfilesForRoleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInstanceProfilesForRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_instance_profiles_for_role::de_list_instance_profiles_for_role_http_response_with_props(
                status, headers, body,
            )
        }
    }
