...
impl ListInstanceProfilesForRoleInput {
    /// Consumes the builder and constructs an Operation<[`ListInstanceProfilesForRole`](crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRole::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListInstanceProfilesForRole", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListInstanceProfilesForRole {
                type Output = std::result::Result<crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleOutput, crate::operation::list_instance_profiles_for_role::ListInstanceProfilesForRoleError>;
