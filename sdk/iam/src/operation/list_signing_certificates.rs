...
impl ListSigningCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`ListSigningCertificates`](crate::operation::list_signing_certificates::ListSigningCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_signing_certificates::ListSigningCertificates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_signing_certificates::ListSigningCertificatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_signing_certificates::ListSigningCertificates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSigningCertificates", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListSigningCertificates {
                type Output = std::result::Result<crate::operation::list_signing_certificates::ListSigningCertificatesOutput, crate::operation::list_signing_certificates::ListSigningCertificatesError>;
