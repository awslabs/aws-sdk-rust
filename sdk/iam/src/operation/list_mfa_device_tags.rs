...
impl ListMfaDeviceTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListMFADeviceTags`](crate::operation::list_mfa_device_tags::ListMFADeviceTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_mfa_device_tags::ListMFADeviceTags, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_mfa_device_tags::ListMfaDeviceTagsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_mfa_device_tags::ListMFADeviceTags::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListMFADeviceTags", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListMFADeviceTags {
                type Output = std::result::Result<crate::operation::list_mfa_device_tags::ListMfaDeviceTagsOutput, crate::operation::list_mfa_device_tags::ListMFADeviceTagsError>;
