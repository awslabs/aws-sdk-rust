...
impl RemoveUserFromGroupInput {
    /// Consumes the builder and constructs an Operation<[`RemoveUserFromGroup`](crate::operation::remove_user_from_group::RemoveUserFromGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_user_from_group::RemoveUserFromGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_user_from_group::RemoveUserFromGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_user_from_group::RemoveUserFromGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RemoveUserFromGroup", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveUserFromGroup {
                type Output = std::result::Result<crate::operation::remove_user_from_group::RemoveUserFromGroupOutput, crate::operation::remove_user_from_group::RemoveUserFromGroupError>;
