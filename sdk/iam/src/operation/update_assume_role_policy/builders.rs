...
impl UpdateAssumeRolePolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyOutput, crate::operation::update_assume_role_policy::UpdateAssumeRolePolicyError, Self> {
