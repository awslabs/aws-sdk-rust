...
impl TagRoleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::tag_role::TagRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::tag_role::TagRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
