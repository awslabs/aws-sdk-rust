...
impl TagRoleInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::tag_role::TagRoleError, ::aws_smithy_http::operation::Response>,
    > {
...
impl TagRoleFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::tag_role::TagRoleOutput, ::aws_smithy_http::result::SdkError<crate::operation::tag_role::TagRoleError>>
    {
        let op = self
            .inner
            .build()
