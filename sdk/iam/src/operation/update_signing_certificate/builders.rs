...
impl UpdateSigningCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_signing_certificate::UpdateSigningCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_signing_certificate::UpdateSigningCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_signing_certificate::UpdateSigningCertificateOutput, crate::operation::update_signing_certificate::UpdateSigningCertificateError, Self> {
