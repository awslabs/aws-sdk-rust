...
impl GetServiceLastAccessedDetailsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
