...
impl GetServiceLastAccessedDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_service_last_accessed_details::GetServiceLastAccessedDetailsInput, ::aws_smithy_types::error::operation::BuildError> {
