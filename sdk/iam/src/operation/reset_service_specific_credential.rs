...
impl ResetServiceSpecificCredentialInput {
    /// Consumes the builder and constructs an Operation<[`ResetServiceSpecificCredential`](crate::operation::reset_service_specific_credential::ResetServiceSpecificCredential)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_service_specific_credential::ResetServiceSpecificCredential, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_service_specific_credential::ResetServiceSpecificCredentialInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_service_specific_credential::ResetServiceSpecificCredential::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResetServiceSpecificCredential", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResetServiceSpecificCredential {
                type Output = std::result::Result<crate::operation::reset_service_specific_credential::ResetServiceSpecificCredentialOutput, crate::operation::reset_service_specific_credential::ResetServiceSpecificCredentialError>;
...
impl aws_http::request_id::RequestId for crate::operation::reset_service_specific_credential::ResetServiceSpecificCredentialError {
