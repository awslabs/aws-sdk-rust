...
impl ResetServiceSpecificCredentialInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reset_service_specific_credential::ResetServiceSpecificCredential::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetServiceSpecificCredential {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reset_service_specific_credential::de_reset_service_specific_credential_http_response_with_props(
                status, headers, body,
            )
        }
    }
