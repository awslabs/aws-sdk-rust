...
impl UntagMfaDeviceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::untag_mfa_device::UntagMFADevice, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagMFADevice {
    type Output =
        ::std::result::Result<crate::operation::untag_mfa_device::UntagMfaDeviceOutput, crate::operation::untag_mfa_device::UntagMFADeviceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_mfa_device::de_untag_mfa_device_http_response_with_props(status, headers, body)
        }
    }
}
