...
impl UpdateOpenIdConnectProviderThumbprintInput {
    /// Consumes the builder and constructs an Operation<[`UpdateOpenIDConnectProviderThumbprint`](crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIDConnectProviderThumbprint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIDConnectProviderThumbprint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIdConnectProviderThumbprintInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIDConnectProviderThumbprint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateOpenIDConnectProviderThumbprint", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateOpenIDConnectProviderThumbprint {
                type Output = std::result::Result<crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIdConnectProviderThumbprintOutput, crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIDConnectProviderThumbprintError>;
...
/// Do not use this.
            ...
            pub type UpdateOpenIDConnectProviderThumbprintErrorKind = UpdateOpenIDConnectProviderThumbprintError;
...
impl aws_http::request_id::RequestId for crate::operation::update_open_id_connect_provider_thumbprint::UpdateOpenIDConnectProviderThumbprintError {
