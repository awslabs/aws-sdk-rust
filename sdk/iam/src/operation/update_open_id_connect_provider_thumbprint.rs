...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateOpenIDConnectProviderThumbprintRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_open_id_connect_provider_thumbprint_input::ser_update_open_id_connect_provider_thumbprint_input_input(&input)?);
