...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateOpenIDConnectProviderThumbprint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_open_id_connect_provider_thumbprint::de_update_open_id_connect_provider_thumbprint_http_response_with_props(status, headers, body)
        }
    }
}
