...
impl DeleteServerCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_server_certificate::DeleteServerCertificateInput, ::aws_smithy_types::error::operation::BuildError> {
