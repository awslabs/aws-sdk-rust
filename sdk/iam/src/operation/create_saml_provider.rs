...
impl CreateSamlProviderInput {
    /// Consumes the builder and constructs an Operation<[`CreateSAMLProvider`](crate::operation::create_saml_provider::CreateSAMLProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_saml_provider::CreateSAMLProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_saml_provider::CreateSamlProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_saml_provider::CreateSAMLProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSAMLProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSAMLProvider {
                type Output = std::result::Result<crate::operation::create_saml_provider::CreateSamlProviderOutput, crate::operation::create_saml_provider::CreateSAMLProviderError>;
