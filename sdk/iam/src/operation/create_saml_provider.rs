...
impl CreateSamlProviderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_saml_provider::CreateSAMLProvider,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSAMLProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_saml_provider::de_create_saml_provider_http_response_with_props(status, headers, body)
        }
    }
}
