...
impl GetAccountSummaryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_account_summary::GetAccountSummary,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountSummary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_account_summary::de_get_account_summary_http_response_with_props(status, headers, body)
        }
    }
}
