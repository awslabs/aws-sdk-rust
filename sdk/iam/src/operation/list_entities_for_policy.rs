...
impl ListEntitiesForPolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_entities_for_policy::ListEntitiesForPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_entities_for_policy::ListEntitiesForPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_entities_for_policy::ListEntitiesForPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListEntitiesForPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListEntitiesForPolicy {
                type Output = std::result::Result<crate::operation::list_entities_for_policy::ListEntitiesForPolicyOutput, crate::operation::list_entities_for_policy::ListEntitiesForPolicyError>;
