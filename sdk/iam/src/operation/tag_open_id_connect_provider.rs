...
impl TagOpenIdConnectProviderInput {
    /// Consumes the builder and constructs an Operation<[`TagOpenIDConnectProvider`](crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagOpenIDConnectProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagOpenIDConnectProvider {
                type Output = std::result::Result<crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderOutput, crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError>;
