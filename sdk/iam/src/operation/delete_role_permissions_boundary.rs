...
impl DeleteRolePermissionsBoundaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRolePermissionsBoundary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_role_permissions_boundary::de_delete_role_permissions_boundary_http_response_with_props(
                status, headers, body,
            )
        }
    }
