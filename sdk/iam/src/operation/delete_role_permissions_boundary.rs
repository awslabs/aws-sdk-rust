...
impl DeleteRolePermissionsBoundaryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRolePermissionsBoundary`](crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundaryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundary::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteRolePermissionsBoundary", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRolePermissionsBoundary {
                type Output = std::result::Result<crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundaryOutput, crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundaryError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_role_permissions_boundary::DeleteRolePermissionsBoundaryError {
