...
impl TagSamlProviderInput {
    /// Consumes the builder and constructs an Operation<[`TagSAMLProvider`](crate::operation::tag_saml_provider::TagSAMLProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_saml_provider::TagSAMLProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_saml_provider::TagSamlProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_saml_provider::TagSAMLProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagSAMLProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagSAMLProvider {
                type Output = std::result::Result<crate::operation::tag_saml_provider::TagSamlProviderOutput, crate::operation::tag_saml_provider::TagSAMLProviderError>;
