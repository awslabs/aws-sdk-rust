...
impl UntagPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::untag_policy::UntagPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_untag_policy_input::ser_untag_policy_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_policy::de_untag_policy_http_response_with_props(status, headers, body)
        }
    }
}
