...
impl UntagPolicyInput {
    /// Consumes the builder and constructs an Operation<[`UntagPolicy`](crate::operation::untag_policy::UntagPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::untag_policy::UntagPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_policy::UntagPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::untag_policy::UntagPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UntagPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UntagPolicy {
                type Output = std::result::Result<crate::operation::untag_policy::UntagPolicyOutput, crate::operation::untag_policy::UntagPolicyError>;
