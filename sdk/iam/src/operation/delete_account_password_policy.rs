...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccountPasswordPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_account_password_policy::de_delete_account_password_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteAccountPasswordPolicyError
{
