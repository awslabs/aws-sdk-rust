...
impl AttachGroupPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::attach_group_policy::AttachGroupPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachGroupPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_group_policy::de_attach_group_policy_http_response_with_props(status, headers, body)
        }
    }
}
