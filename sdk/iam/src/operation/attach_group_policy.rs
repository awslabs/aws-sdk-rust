...
impl AttachGroupPolicyInput {
    /// Consumes the builder and constructs an Operation<[`AttachGroupPolicy`](crate::operation::attach_group_policy::AttachGroupPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_group_policy::AttachGroupPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_group_policy::AttachGroupPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::attach_group_policy::AttachGroupPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AttachGroupPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for AttachGroupPolicy {
                type Output = std::result::Result<crate::operation::attach_group_policy::AttachGroupPolicyOutput, crate::operation::attach_group_policy::AttachGroupPolicyError>;
