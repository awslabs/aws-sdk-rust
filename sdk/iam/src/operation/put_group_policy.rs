...
impl PutGroupPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_group_policy::PutGroupPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutGroupPolicy {
    type Output =
        ::std::result::Result<crate::operation::put_group_policy::PutGroupPolicyOutput, crate::operation::put_group_policy::PutGroupPolicyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_group_policy::de_put_group_policy_http_response_with_props(status, headers, body)
        }
    }
}
