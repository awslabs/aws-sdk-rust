...
impl ListPoliciesGrantingServiceAccessInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_policies_granting_service_access::ListPoliciesGrantingServiceAccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPoliciesGrantingServiceAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_policies_granting_service_access::de_list_policies_granting_service_access_http_response_with_props(
                status, headers, body,
            )
        }
    }
