...
impl ListInstanceProfileTagsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_instance_profile_tags::ListInstanceProfileTagsInput, ::aws_smithy_types::error::operation::BuildError> {
