...
impl GetUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_user::GetUser, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_user_input::ser_get_user_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_user::de_get_user_http_response_with_props(status, headers, body)
        }
    }
}
