...
impl DeleteGroupPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_group_policy::DeleteGroupPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_group_policy::DeleteGroupPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_group_policy::DeleteGroupPolicyOutput, crate::operation::delete_group_policy::DeleteGroupPolicyError, Self> {
