...
impl GetSamlProviderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_saml_provider::GetSAMLProvider, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSAMLProvider {
    type Output =
        ::std::result::Result<crate::operation::get_saml_provider::GetSamlProviderOutput, crate::operation::get_saml_provider::GetSAMLProviderError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_saml_provider::de_get_saml_provider_http_response_with_props(status, headers, body)
        }
    }
}
