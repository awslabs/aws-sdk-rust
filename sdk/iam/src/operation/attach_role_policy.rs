...
impl AttachRolePolicyInput {
    /// Consumes the builder and constructs an Operation<[`AttachRolePolicy`](crate::operation::attach_role_policy::AttachRolePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_role_policy::AttachRolePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_role_policy::AttachRolePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::attach_role_policy::AttachRolePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AttachRolePolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for AttachRolePolicy {
                type Output = std::result::Result<crate::operation::attach_role_policy::AttachRolePolicyOutput, crate::operation::attach_role_policy::AttachRolePolicyError>;
