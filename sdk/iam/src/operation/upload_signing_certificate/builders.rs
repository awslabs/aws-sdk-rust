...
impl UploadSigningCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::upload_signing_certificate::UploadSigningCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upload_signing_certificate::UploadSigningCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::upload_signing_certificate::UploadSigningCertificateOutput, crate::operation::upload_signing_certificate::UploadSigningCertificateError, Self> {
