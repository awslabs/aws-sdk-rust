...
impl GetOrganizationsAccessReportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_organizations_access_report::GetOrganizationsAccessReportInput, ::aws_smithy_types::error::operation::BuildError> {
