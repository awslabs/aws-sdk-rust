...
impl ListUserPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListUserPolicies`](crate::operation::list_user_policies::ListUserPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_user_policies::ListUserPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_user_policies::ListUserPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_policies::ListUserPolicies::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListUserPolicies", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListUserPolicies {
                type Output = std::result::Result<crate::operation::list_user_policies::ListUserPoliciesOutput, crate::operation::list_user_policies::ListUserPoliciesError>;
