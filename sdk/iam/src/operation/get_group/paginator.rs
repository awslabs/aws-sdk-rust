...
impl GetGroupPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::User, ::aws_smithy_http::result::SdkError<crate::operation::get_group::GetGroupError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_group_output_users(page).unwrap_or_default().into_iter())
    }
}
