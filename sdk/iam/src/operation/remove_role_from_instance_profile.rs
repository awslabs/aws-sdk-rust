...
impl RemoveRoleFromInstanceProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_role_from_instance_profile::RemoveRoleFromInstanceProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveRoleFromInstanceProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_role_from_instance_profile::de_remove_role_from_instance_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
