...
impl ListAttachedGroupPoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_attached_group_policies::ListAttachedGroupPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
