...
impl UpdateGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_group::UpdateGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_group_input::ser_update_group_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_group::de_update_group_http_response_with_props(status, headers, body)
        }
    }
}
