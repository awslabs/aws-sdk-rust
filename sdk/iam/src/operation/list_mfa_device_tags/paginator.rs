                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_mfa_device_tags_output_marker(resp);
...
impl ListMfaDeviceTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_mfa_device_tags_output_tags(page).unwrap_or_default().into_iter())
    }
}
