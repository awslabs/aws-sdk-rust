...
impl DetachGroupPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DetachGroupPolicy`](crate::operation::detach_group_policy::DetachGroupPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_group_policy::DetachGroupPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_group_policy::DetachGroupPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_group_policy::DetachGroupPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachGroupPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DetachGroupPolicy {
                type Output = std::result::Result<crate::operation::detach_group_policy::DetachGroupPolicyOutput, crate::operation::detach_group_policy::DetachGroupPolicyError>;
