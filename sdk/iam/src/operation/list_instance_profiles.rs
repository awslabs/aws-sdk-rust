...
impl ListInstanceProfilesInput {
    /// Consumes the builder and constructs an Operation<[`ListInstanceProfiles`](crate::operation::list_instance_profiles::ListInstanceProfiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_instance_profiles::ListInstanceProfiles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_instance_profiles::ListInstanceProfilesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_instance_profiles::ListInstanceProfiles::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListInstanceProfiles", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListInstanceProfiles {
                type Output = std::result::Result<crate::operation::list_instance_profiles::ListInstanceProfilesOutput, crate::operation::list_instance_profiles::ListInstanceProfilesError>;
