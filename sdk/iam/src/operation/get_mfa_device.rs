...
impl GetMfaDeviceInput {
    /// Consumes the builder and constructs an Operation<[`GetMFADevice`](crate::operation::get_mfa_device::GetMFADevice)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_mfa_device::GetMFADevice, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_mfa_device_input::ser_get_mfa_device_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_mfa_device::GetMFADevice::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMFADevice", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMFADevice {
    type Output = ::std::result::Result<crate::operation::get_mfa_device::GetMfaDeviceOutput, crate::operation::get_mfa_device::GetMFADeviceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_mfa_device::de_get_mfa_device_http_response_with_props(status, headers, body)
        }
    }
}
