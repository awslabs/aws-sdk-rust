...
impl ListSAMLProviderTagsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_saml_provider_tags::ListSamlProviderTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_saml_provider_tags::ListSamlProviderTagsOutput, crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError, Self> {
    ...
    /// Create a paginator for this request
                            ...
                            pub fn into_paginator(self) -> crate::operation::list_saml_provider_tags::paginator::ListSamlProviderTagsPaginator {
                                crate::operation::list_saml_provider_tags::paginator::ListSamlProviderTagsPaginator::new(self.handle, self.inner)
                            }
