...
/// Paginator for [`ListSAMLProviderTags`](crate::operation::list_saml_provider_tags::ListSAMLProviderTags)
                ...
                impl ListSamlProviderTagsPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_saml_provider_tags::builders::ListSamlProviderTagsInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::list_saml_provider_tags::ListSamlProviderTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::list_saml_provider_tags::ListSAMLProviderTags::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `ListSamlProviderTagsPaginator`
                    ...
                    impl ListSamlProviderTagsPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::Tag, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_saml_provider_tags_output_output_tags(page).unwrap_or_default().into_iter())
                        }
                    }
