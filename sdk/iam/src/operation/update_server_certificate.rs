...
impl UpdateServerCertificateInput {
    /// Consumes the builder and constructs an Operation<[`UpdateServerCertificate`](crate::operation::update_server_certificate::UpdateServerCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_server_certificate::UpdateServerCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_server_certificate::UpdateServerCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_server_certificate::UpdateServerCertificate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateServerCertificate", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateServerCertificate {
                type Output = std::result::Result<crate::operation::update_server_certificate::UpdateServerCertificateOutput, crate::operation::update_server_certificate::UpdateServerCertificateError>;
