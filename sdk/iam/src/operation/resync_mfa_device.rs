...
impl ResyncMfaDeviceInput {
    /// Consumes the builder and constructs an Operation<[`ResyncMFADevice`](crate::operation::resync_mfa_device::ResyncMFADevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::resync_mfa_device::ResyncMFADevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resync_mfa_device::ResyncMfaDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::resync_mfa_device::ResyncMFADevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResyncMFADevice", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResyncMFADevice {
                type Output = std::result::Result<crate::operation::resync_mfa_device::ResyncMfaDeviceOutput, crate::operation::resync_mfa_device::ResyncMFADeviceError>;
