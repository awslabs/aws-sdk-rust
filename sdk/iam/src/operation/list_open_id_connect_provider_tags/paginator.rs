...
/// Paginator for [`ListOpenIDConnectProviderTags`](crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTags)
                ...
                impl ListOpenIdConnectProviderTagsPaginator {
                    ...
                    pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_open_id_connect_provider_tags::builders::ListOpenIdConnectProviderTagsInputBuilder) -> Self {
                        Self {
                            handle,
                            builder,
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                        ...
                        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(move |tx| ::std::boxed::Box::pin(async move {
                            ...
                            loop {
                                let resp = crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTags::orchestrate(&runtime_plugins, input.clone()).await;
...
/// Flattened paginator for `ListOpenIdConnectProviderTagsPaginator`
                    ...
                    impl ListOpenIdConnectProviderTagsPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::Tag, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_open_id_connect_provider_tags::ListOpenIDConnectProviderTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_open_id_connect_provider_tags_output_output_tags(page).unwrap_or_default().into_iter())
                        }
                    }
