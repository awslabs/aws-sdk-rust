...
impl ListOpenIdConnectProviderTagsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput, ::aws_smithy_types::error::operation::BuildError> {
