...
impl ListOpenIdConnectProviderTagsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_open_id_connect_provider_tags::ListOpenIdConnectProviderTagsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
