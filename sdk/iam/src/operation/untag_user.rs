...
impl UntagUserInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::untag_user::UntagUser,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_user::UntagUser::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UntagUser {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_user::de_untag_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
