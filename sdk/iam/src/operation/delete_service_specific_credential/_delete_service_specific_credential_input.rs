...
impl DeleteServiceSpecificCredentialInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialInput, ::aws_smithy_types::error::operation::BuildError> {
