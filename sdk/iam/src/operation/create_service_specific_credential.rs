...
impl CreateServiceSpecificCredentialInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_service_specific_credential::CreateServiceSpecificCredential::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateServiceSpecificCredential {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_service_specific_credential::de_create_service_specific_credential_http_response_with_props(
                status, headers, body,
            )
        }
    }
