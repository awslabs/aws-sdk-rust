...
impl CreateServiceSpecificCredentialInput {
    /// Consumes the builder and constructs an Operation<[`CreateServiceSpecificCredential`](crate::operation::create_service_specific_credential::CreateServiceSpecificCredential)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_service_specific_credential::CreateServiceSpecificCredential, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_service_specific_credential::CreateServiceSpecificCredentialInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_service_specific_credential::CreateServiceSpecificCredential::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateServiceSpecificCredential", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateServiceSpecificCredential {
                type Output = std::result::Result<crate::operation::create_service_specific_credential::CreateServiceSpecificCredentialOutput, crate::operation::create_service_specific_credential::CreateServiceSpecificCredentialError>;
...
impl aws_http::request_id::RequestId for crate::operation::create_service_specific_credential::CreateServiceSpecificCredentialError {
