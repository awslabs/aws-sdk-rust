...
impl ListAttachedGroupPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListAttachedGroupPolicies`](crate::operation::list_attached_group_policies::ListAttachedGroupPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_attached_group_policies::ListAttachedGroupPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_attached_group_policies::ListAttachedGroupPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_attached_group_policies::ListAttachedGroupPolicies::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAttachedGroupPolicies", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttachedGroupPolicies {
                type Output = std::result::Result<crate::operation::list_attached_group_policies::ListAttachedGroupPoliciesOutput, crate::operation::list_attached_group_policies::ListAttachedGroupPoliciesError>;
