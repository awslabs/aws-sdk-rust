...
impl ListAttachedGroupPoliciesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_attached_group_policies::ListAttachedGroupPolicies,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_attached_group_policies::ListAttachedGroupPolicies::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttachedGroupPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_attached_group_policies::de_list_attached_group_policies_http_response_with_props(status, headers, body)
        }
    }
}
