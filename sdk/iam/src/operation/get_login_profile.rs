...
impl GetLoginProfileInput {
    /// Consumes the builder and constructs an Operation<[`GetLoginProfile`](crate::operation::get_login_profile::GetLoginProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_login_profile::GetLoginProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_login_profile::GetLoginProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_login_profile::GetLoginProfile::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetLoginProfile", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetLoginProfile {
                type Output = std::result::Result<crate::operation::get_login_profile::GetLoginProfileOutput, crate::operation::get_login_profile::GetLoginProfileError>;
