...
impl GetLoginProfileInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_login_profile::GetLoginProfile, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoginProfile {
    type Output =
        ::std::result::Result<crate::operation::get_login_profile::GetLoginProfileOutput, crate::operation::get_login_profile::GetLoginProfileError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_login_profile::de_get_login_profile_http_response_with_props(status, headers, body)
        }
    }
}
