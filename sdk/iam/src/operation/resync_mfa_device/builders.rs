...
impl ResyncMFADeviceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::resync_mfa_device::ResyncMfaDeviceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resync_mfa_device::ResyncMFADeviceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::resync_mfa_device::ResyncMfaDeviceOutput, crate::operation::resync_mfa_device::ResyncMFADeviceError, Self> {
