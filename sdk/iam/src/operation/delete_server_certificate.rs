...
impl DeleteServerCertificateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteServerCertificate`](crate::operation::delete_server_certificate::DeleteServerCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_server_certificate::DeleteServerCertificate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_server_certificate::DeleteServerCertificateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_server_certificate::DeleteServerCertificate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteServerCertificate", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteServerCertificate {
                type Output = std::result::Result<crate::operation::delete_server_certificate::DeleteServerCertificateOutput, crate::operation::delete_server_certificate::DeleteServerCertificateError>;
