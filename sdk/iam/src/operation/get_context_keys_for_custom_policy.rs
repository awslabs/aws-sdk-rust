...
impl GetContextKeysForCustomPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContextKeysForCustomPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_context_keys_for_custom_policy::de_get_context_keys_for_custom_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
