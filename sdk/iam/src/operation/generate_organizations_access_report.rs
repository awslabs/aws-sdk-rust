...
impl GenerateOrganizationsAccessReportInput {
    /// Consumes the builder and constructs an Operation<[`GenerateOrganizationsAccessReport`](crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReport::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GenerateOrganizationsAccessReport", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateOrganizationsAccessReport {
                type Output = std::result::Result<crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportOutput, crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReportError>;
