...
impl GenerateOrganizationsAccessReportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_organizations_access_report::GenerateOrganizationsAccessReport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateOrganizationsAccessReport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_organizations_access_report::de_generate_organizations_access_report_http_response_with_props(
                status, headers, body,
            )
        }
    }
