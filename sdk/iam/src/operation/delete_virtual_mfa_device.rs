...
impl DeleteVirtualMfaDeviceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVirtualMFADevice`](crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADevice, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADevice::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteVirtualMFADevice", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVirtualMFADevice {
                type Output = std::result::Result<crate::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceOutput, crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError>;
