...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetServiceLastAccessedDetailsWithEntitiesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetServiceLastAccessedDetailsWithEntitiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_last_accessed_details_with_entities_input::ser_get_service_last_accessed_details_with_entities_input_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetServiceLastAccessedDetailsWithEntitiesEndpointParamsInterceptor {
