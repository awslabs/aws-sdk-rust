...
impl CreateAccountAliasInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccountAlias`](crate::operation::create_account_alias::CreateAccountAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_account_alias::CreateAccountAlias, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_account_alias::CreateAccountAliasInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_account_alias::CreateAccountAlias::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateAccountAlias", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAccountAlias {
                type Output = std::result::Result<crate::operation::create_account_alias::CreateAccountAliasOutput, crate::operation::create_account_alias::CreateAccountAliasError>;
