...
impl UpdateAccountPasswordPolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAccountPasswordPolicy`](crate::operation::update_account_password_policy::UpdateAccountPasswordPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_account_password_policy::UpdateAccountPasswordPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_account_password_policy::UpdateAccountPasswordPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_account_password_policy::UpdateAccountPasswordPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateAccountPasswordPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAccountPasswordPolicy {
                type Output = std::result::Result<crate::operation::update_account_password_policy::UpdateAccountPasswordPolicyOutput, crate::operation::update_account_password_policy::UpdateAccountPasswordPolicyError>;
