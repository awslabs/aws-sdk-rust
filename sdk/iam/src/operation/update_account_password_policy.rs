...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccountPasswordPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_account_password_policy::de_update_account_password_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateAccountPasswordPolicyError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_account_password_policy::UpdateAccountPasswordPolicyError
{
