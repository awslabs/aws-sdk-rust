    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_saml_providers::ListSAMLProvidersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_saml_providers::ListSamlProvidersOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListSAMLProvidersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_saml_providers::ListSamlProvidersInput>()
            .expect("correct type");
