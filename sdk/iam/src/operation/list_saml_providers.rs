...
impl ListSamlProvidersInput {
    /// Consumes the builder and constructs an Operation<[`ListSAMLProviders`](crate::operation::list_saml_providers::ListSAMLProviders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_saml_providers::ListSAMLProviders, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_saml_providers::ListSamlProvidersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_saml_providers::ListSAMLProviders::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSAMLProviders", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListSAMLProviders {
                type Output = std::result::Result<crate::operation::list_saml_providers::ListSamlProvidersOutput, crate::operation::list_saml_providers::ListSAMLProvidersError>;
