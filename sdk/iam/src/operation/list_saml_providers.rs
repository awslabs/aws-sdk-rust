...
impl ListSamlProvidersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_saml_providers::ListSAMLProviders,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSAMLProviders {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_saml_providers::de_list_saml_providers_http_response_with_props(status, headers, body)
        }
    }
}
