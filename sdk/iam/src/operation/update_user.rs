...
impl UpdateUserInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_user_input::ser_update_user_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user::UpdateUser::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateUser", "iam"));
