...
impl ListRoleTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListRoleTags`](crate::operation::list_role_tags::ListRoleTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_role_tags::ListRoleTags, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_role_tags::ListRoleTagsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_role_tags_input::ser_list_role_tags_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_role_tags::ListRoleTags::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListRoleTags", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListRoleTags {
                type Output = std::result::Result<crate::operation::list_role_tags::ListRoleTagsOutput, crate::operation::list_role_tags::ListRoleTagsError>;
