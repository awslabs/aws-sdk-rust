...
impl GetCredentialReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_credential_report::GetCredentialReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_credential_report::GetCredentialReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_credential_report::GetCredentialReportOutput, crate::operation::get_credential_report::GetCredentialReportError, Self> {
