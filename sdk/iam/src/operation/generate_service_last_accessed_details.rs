...
impl GenerateServiceLastAccessedDetailsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetails,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_service_last_accessed_details::GenerateServiceLastAccessedDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateServiceLastAccessedDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_service_last_accessed_details::de_generate_service_last_accessed_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
