...
impl DeleteServiceSpecificCredentialInput {
    /// Consumes the builder and constructs an Operation<[`DeleteServiceSpecificCredential`](crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredential)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredential, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredential::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteServiceSpecificCredential", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteServiceSpecificCredential {
                type Output = std::result::Result<crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialOutput, crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredentialError>;
