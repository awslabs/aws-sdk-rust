...
impl DeleteServiceSpecificCredentialInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredential,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_service_specific_credential::DeleteServiceSpecificCredential::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteServiceSpecificCredential {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_service_specific_credential::de_delete_service_specific_credential_http_response_with_props(
                status, headers, body,
            )
        }
    }
