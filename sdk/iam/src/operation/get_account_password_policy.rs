    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_account_password_policy::GetAccountPasswordPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_account_password_policy::GetAccountPasswordPolicyOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetAccountPasswordPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_account_password_policy::GetAccountPasswordPolicyInput>()
            .expect("correct type");
