...
impl GetAccountPasswordPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountPasswordPolicy`](crate::operation::get_account_password_policy::GetAccountPasswordPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_account_password_policy::GetAccountPasswordPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_account_password_policy::GetAccountPasswordPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_password_policy::GetAccountPasswordPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAccountPasswordPolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccountPasswordPolicy {
                type Output = std::result::Result<crate::operation::get_account_password_policy::GetAccountPasswordPolicyOutput, crate::operation::get_account_password_policy::GetAccountPasswordPolicyError>;
