...
impl GetAccountPasswordPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_password_policy::GetAccountPasswordPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountPasswordPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_account_password_policy::de_get_account_password_policy_http_response_with_props(status, headers, body)
        }
    }
}
