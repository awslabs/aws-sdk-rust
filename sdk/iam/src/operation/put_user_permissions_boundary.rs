...
impl PutUserPermissionsBoundaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutUserPermissionsBoundary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_user_permissions_boundary::de_put_user_permissions_boundary_http_response_with_props(
                status, headers, body,
            )
        }
    }
