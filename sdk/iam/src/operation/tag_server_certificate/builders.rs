...
impl TagServerCertificateFluentBuilder  {
    /// Creates a new `TagServerCertificate`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::tag_server_certificate::TagServerCertificateOutput, aws_smithy_http::result::SdkError<crate::operation::tag_server_certificate::TagServerCertificateError>>
                     {
