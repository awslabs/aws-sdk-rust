...
impl ListAttachedUserPoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_attached_user_policies::ListAttachedUserPoliciesInput, ::aws_smithy_types::error::operation::BuildError> {
