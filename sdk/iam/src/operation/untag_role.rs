...
impl UntagRoleInput {
    /// Consumes the builder and constructs an Operation<[`UntagRole`](crate::operation::untag_role::UntagRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::untag_role::UntagRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_role::UntagRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::untag_role::UntagRole::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UntagRole", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UntagRole {
                type Output = std::result::Result<crate::operation::untag_role::UntagRoleOutput, crate::operation::untag_role::UntagRoleError>;
