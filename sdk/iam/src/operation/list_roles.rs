...
impl ListRolesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_roles::ListRoles,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_roles::ListRoles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRoles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_roles::de_list_roles_http_response_with_props(
                status, headers, body,
            )
        }
    }
