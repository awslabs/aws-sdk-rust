...
impl GetOpenIdConnectProviderInput {
    /// Consumes the builder and constructs an Operation<[`GetOpenIDConnectProvider`](crate::operation::get_open_id_connect_provider::GetOpenIDConnectProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_open_id_connect_provider::GetOpenIDConnectProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_open_id_connect_provider::GetOpenIDConnectProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetOpenIDConnectProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetOpenIDConnectProvider {
                type Output = std::result::Result<crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput, crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError>;
