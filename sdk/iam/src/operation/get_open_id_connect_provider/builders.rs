...
impl GetOpenIDConnectProviderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput, crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError, Self> {
