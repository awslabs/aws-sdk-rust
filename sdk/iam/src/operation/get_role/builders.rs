...
impl GetRoleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_role::GetRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_role::GetRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
