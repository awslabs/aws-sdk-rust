...
impl GetRoleInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_role::GetRoleError, ::aws_smithy_http::operation::Response>,
    > {
...
impl GetRoleFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::get_role::GetRoleOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_role::GetRoleError>>
    {
        let op = self
            .inner
            .build()
