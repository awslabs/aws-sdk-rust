...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContextKeysForPrincipalPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_context_keys_for_principal_policy::de_get_context_keys_for_principal_policy_http_response_with_props(status, headers, body)
        }
    }
}
