...
impl UntagSamlProviderInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::untag_saml_provider::UntagSAMLProvider,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagSAMLProvider {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag_saml_provider::de_untag_saml_provider_http_response_with_props(status, headers, body)
        }
    }
}
