...
impl UntagSamlProviderInput {
    /// Consumes the builder and constructs an Operation<[`UntagSAMLProvider`](crate::operation::untag_saml_provider::UntagSAMLProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::untag_saml_provider::UntagSAMLProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_saml_provider::UntagSamlProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::untag_saml_provider::UntagSAMLProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UntagSAMLProvider", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for UntagSAMLProvider {
                type Output = std::result::Result<crate::operation::untag_saml_provider::UntagSamlProviderOutput, crate::operation::untag_saml_provider::UntagSAMLProviderError>;
