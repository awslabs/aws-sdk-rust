...
impl GetRolePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_role_policy::GetRolePolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRolePolicy {
    type Output =
        ::std::result::Result<crate::operation::get_role_policy::GetRolePolicyOutput, crate::operation::get_role_policy::GetRolePolicyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_role_policy::de_get_role_policy_http_response_with_props(status, headers, body)
        }
    }
}
