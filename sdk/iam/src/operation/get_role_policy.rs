...
impl GetRolePolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetRolePolicy`](crate::operation::get_role_policy::GetRolePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_role_policy::GetRolePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_role_policy::GetRolePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_role_policy_input::ser_get_role_policy_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_role_policy::GetRolePolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRolePolicy", "iam"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRolePolicy {
                type Output = std::result::Result<crate::operation::get_role_policy::GetRolePolicyOutput, crate::operation::get_role_policy::GetRolePolicyError>;
