...
impl ListGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListGroups`](crate::operation::list_groups::ListGroups)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_groups::ListGroups, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_groups_input::ser_list_groups_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_groups::ListGroups::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListGroups", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroups {
    type Output = ::std::result::Result<crate::operation::list_groups::ListGroupsOutput, crate::operation::list_groups::ListGroupsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_groups::de_list_groups_http_response_with_props(status, headers, body)
        }
    }
}
