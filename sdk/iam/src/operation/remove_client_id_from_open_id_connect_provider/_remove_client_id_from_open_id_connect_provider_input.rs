...
impl RemoveClientIdFromOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_client_id_from_open_id_connect_provider::RemoveClientIdFromOpenIdConnectProviderInput, ::aws_smithy_types::error::operation::BuildError> {
