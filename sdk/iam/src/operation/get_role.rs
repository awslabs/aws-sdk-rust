...
impl GetRoleInput {
    /// Consumes the builder and constructs an Operation<[`GetRole`](crate::operation::get_role::GetRole)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_role::GetRole, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_role_input::ser_get_role_input_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_role::GetRole::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRole {
    type Output = ::std::result::Result<crate::operation::get_role::GetRoleOutput, crate::operation::get_role::GetRoleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_role::de_get_role_http_response_with_props(status, headers, body)
        }
    }
}
