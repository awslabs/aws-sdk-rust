...
impl std::fmt::Display for DuplicateSshPublicKeyException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "DuplicateSshPublicKeyException [DuplicateSSHPublicKeyException]")?;
...
impl std::fmt::Display for AddClientIDToOpenIDConnectProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            AddClientIDToOpenIDConnectProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl AddClientIDToOpenIDConnectProviderError {
    /// Creates a new `AddClientIDToOpenIDConnectProviderError`.
                    pub fn new(kind: AddClientIDToOpenIDConnectProviderErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, AddClientIDToOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `AddClientIDToOpenIDConnectProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, AddClientIDToOpenIDConnectProviderErrorKind::LimitExceededException(_))
    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, AddClientIDToOpenIDConnectProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `AddClientIDToOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, AddClientIDToOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for AddRoleToInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            AddRoleToInstanceProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            AddRoleToInstanceProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AddRoleToInstanceProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            AddRoleToInstanceProfileErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AddRoleToInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl AddRoleToInstanceProfileError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, AddRoleToInstanceProfileErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `AddRoleToInstanceProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, AddRoleToInstanceProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `AddRoleToInstanceProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, AddRoleToInstanceProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `AddRoleToInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, AddRoleToInstanceProfileErrorKind::ServiceFailureException(_))
    }
    ...
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, AddRoleToInstanceProfileErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for AddUserToGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            AddUserToGroupErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            AddUserToGroupErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AddUserToGroupErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            AddUserToGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl AddUserToGroupError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, AddUserToGroupErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `AddUserToGroupErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, AddUserToGroupErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `AddUserToGroupErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, AddUserToGroupErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for AttachGroupPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            AttachGroupPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            AttachGroupPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            AttachGroupPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AttachGroupPolicyErrorKind::PolicyNotAttachableException(_inner) =>
            _inner.fmt(f)
            ,
            AttachGroupPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            AttachGroupPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl AttachGroupPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, AttachGroupPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `AttachGroupPolicyErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, AttachGroupPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `AttachGroupPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, AttachGroupPolicyErrorKind::NoSuchEntityException(_))
    }
    ...
    pub fn is_policy_not_attachable_exception(&self) -> bool {
        matches!(&self.kind, AttachGroupPolicyErrorKind::PolicyNotAttachableException(_))
    }
    /// Returns `true` if the error kind is `AttachGroupPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, AttachGroupPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for AttachRolePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            AttachRolePolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            AttachRolePolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            AttachRolePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AttachRolePolicyErrorKind::PolicyNotAttachableException(_inner) =>
            _inner.fmt(f)
            ,
            AttachRolePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            AttachRolePolicyErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AttachRolePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for AttachUserPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            AttachUserPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            AttachUserPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            AttachUserPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            AttachUserPolicyErrorKind::PolicyNotAttachableException(_inner) =>
            _inner.fmt(f)
            ,
            AttachUserPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            AttachUserPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl AttachUserPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, AttachUserPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `AttachUserPolicyErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, AttachUserPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `AttachUserPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, AttachUserPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `AttachUserPolicyErrorKind::PolicyNotAttachableException`.
    pub fn is_policy_not_attachable_exception(&self) -> bool {
        matches!(&self.kind, AttachUserPolicyErrorKind::PolicyNotAttachableException(_))
    }
    /// Returns `true` if the error kind is `AttachUserPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, AttachUserPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ChangePasswordError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            ChangePasswordErrorKind::InvalidUserTypeException(_inner) =>
            _inner.fmt(f)
            ,
            ChangePasswordErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            ChangePasswordErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ChangePasswordErrorKind::PasswordPolicyViolationException(_inner) =>
            _inner.fmt(f)
            ,
            ChangePasswordErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ChangePasswordErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ChangePasswordError {
    ...
    pub fn is_entity_temporarily_unmodifiable_exception(&self) -> bool {
        matches!(&self.kind, ChangePasswordErrorKind::EntityTemporarilyUnmodifiableException(_))
    }
    ...
    pub fn is_invalid_user_type_exception(&self) -> bool {
        matches!(&self.kind, ChangePasswordErrorKind::InvalidUserTypeException(_))
    }
    /// Returns `true` if the error kind is `ChangePasswordErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, ChangePasswordErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `ChangePasswordErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ChangePasswordErrorKind::NoSuchEntityException(_))
    }
    ...
    pub fn is_password_policy_violation_exception(&self) -> bool {
        matches!(&self.kind, ChangePasswordErrorKind::PasswordPolicyViolationException(_))
    }
    /// Returns `true` if the error kind is `ChangePasswordErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ChangePasswordErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateAccessKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateAccessKeyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAccessKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAccessKeyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAccessKeyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateAccessKeyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateAccessKeyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateAccessKeyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, CreateAccessKeyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `CreateAccessKeyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateAccessKeyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateAccountAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateAccountAliasErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAccountAliasErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAccountAliasErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAccountAliasErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateAccountAliasError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateAccountAliasErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountAliasErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateAccountAliasErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountAliasErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateAccountAliasErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateGroupErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGroupErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGroupErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGroupErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateGroupError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateGroupErrorKind::EntityAlreadyExistsException(_))
    }
...
impl std::fmt::Display for CreateInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateInstanceProfileErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInstanceProfileErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInstanceProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInstanceProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateInstanceProfileError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreateInstanceProfileErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateInstanceProfileErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, CreateInstanceProfileErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateInstanceProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateInstanceProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateLoginProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateLoginProfileErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLoginProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLoginProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLoginProfileErrorKind::PasswordPolicyViolationException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLoginProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLoginProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateLoginProfileError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateLoginProfileErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateLoginProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateLoginProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateLoginProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, CreateLoginProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `CreateLoginProfileErrorKind::PasswordPolicyViolationException`.
    pub fn is_password_policy_violation_exception(&self) -> bool {
        matches!(&self.kind, CreateLoginProfileErrorKind::PasswordPolicyViolationException(_))
    }
    /// Returns `true` if the error kind is `CreateLoginProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateLoginProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateOpenIDConnectProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateOpenIDConnectProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateOpenIDConnectProviderErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateOpenIDConnectProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateOpenIDConnectProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateOpenIDConnectProviderError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreateOpenIDConnectProviderErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateOpenIDConnectProviderErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateOpenIDConnectProviderErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateOpenIDConnectProviderErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, CreateOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateOpenIDConnectProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateOpenIDConnectProviderErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreatePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreatePolicyErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreatePolicyError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyErrorKind::EntityAlreadyExistsException(_))
    }
    ...
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyErrorKind::MalformedPolicyDocumentException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreatePolicyVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreatePolicyVersionErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyVersionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyVersionErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyVersionErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyVersionErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePolicyVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreatePolicyVersionError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyVersionErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyVersionErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyVersionErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyVersionErrorKind::MalformedPolicyDocumentException`.
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyVersionErrorKind::MalformedPolicyDocumentException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyVersionErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyVersionErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyVersionErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreatePolicyVersionErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateRoleErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRoleErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRoleErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRoleErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRoleErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateRoleError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreateRoleErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateRoleErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateRoleErrorKind::EntityAlreadyExistsException(_))
    }
    ...
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, CreateRoleErrorKind::MalformedPolicyDocumentException(_))
    }
...
impl std::fmt::Display for CreateSAMLProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateSAMLProviderErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSAMLProviderErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSAMLProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSAMLProviderErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSAMLProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSAMLProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateSAMLProviderError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreateSAMLProviderErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateSAMLProviderErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateSAMLProviderErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateSAMLProviderErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, CreateSAMLProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateSAMLProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateSAMLProviderErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateSAMLProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateSAMLProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateServiceLinkedRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateServiceLinkedRoleErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateServiceLinkedRoleErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateServiceLinkedRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            CreateServiceLinkedRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateServiceLinkedRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateServiceLinkedRoleError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceLinkedRoleErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateServiceLinkedRoleErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceLinkedRoleErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateServiceLinkedRoleErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceLinkedRoleErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `CreateServiceLinkedRoleErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceLinkedRoleErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for CreateServiceSpecificCredentialError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateServiceSpecificCredentialErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateServiceSpecificCredentialError {
    /// Creates a new `CreateServiceSpecificCredentialError`.
                    pub fn new(kind: CreateServiceSpecificCredentialErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceSpecificCredentialErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateServiceSpecificCredentialErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceSpecificCredentialErrorKind::NoSuchEntityException(_))
    }
    ...
    pub fn is_service_not_supported_exception(&self) -> bool {
        matches!(&self.kind, CreateServiceSpecificCredentialErrorKind::ServiceNotSupportedException(_))
    }
}
...
impl std::fmt::Display for CreateUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateUserErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            CreateUserErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateUserErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateUserErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            CreateUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateUserError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreateUserErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateUserErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateUserErrorKind::EntityAlreadyExistsException(_))
    }
...
impl std::fmt::Display for CreateVirtualMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateVirtualMFADeviceErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVirtualMFADeviceErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVirtualMFADeviceErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVirtualMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVirtualMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateVirtualMFADeviceError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, CreateVirtualMFADeviceErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateVirtualMFADeviceErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, CreateVirtualMFADeviceErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateVirtualMFADeviceErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, CreateVirtualMFADeviceErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateVirtualMFADeviceErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateVirtualMFADeviceErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateVirtualMFADeviceErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, CreateVirtualMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeactivateMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DeactivateMFADeviceErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeactivateMFADeviceErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeactivateMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeactivateMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeactivateMFADeviceError {
    ...
    pub fn is_entity_temporarily_unmodifiable_exception(&self) -> bool {
        matches!(&self.kind, DeactivateMFADeviceErrorKind::EntityTemporarilyUnmodifiableException(_))
    }
    /// Returns `true` if the error kind is `DeactivateMFADeviceErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeactivateMFADeviceErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeactivateMFADeviceErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeactivateMFADeviceErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeactivateMFADeviceErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeactivateMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteAccessKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteAccessKeyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccessKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccessKeyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccessKeyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteAccessKeyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccessKeyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccessKeyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccessKeyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccessKeyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccessKeyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteAccountAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteAccountAliasErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccountAliasErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccountAliasErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteAccountAliasError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccountAliasErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountAliasErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccountAliasErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountAliasErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccountAliasErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteAccountPasswordPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteAccountPasswordPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccountPasswordPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccountPasswordPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAccountPasswordPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteAccountPasswordPolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccountPasswordPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountPasswordPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccountPasswordPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountPasswordPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteAccountPasswordPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteGroupErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGroupErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGroupErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGroupErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for DeleteGroupPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteGroupPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGroupPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGroupPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGroupPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteGroupPolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteGroupPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteGroupPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteGroupPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteGroupPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteGroupPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteInstanceProfileErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInstanceProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInstanceProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInstanceProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteInstanceProfileError {
    ...
    pub fn is_delete_conflict_exception(&self) -> bool {
        matches!(&self.kind, DeleteInstanceProfileErrorKind::DeleteConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteInstanceProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteInstanceProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteInstanceProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteInstanceProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteInstanceProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteLoginProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DeleteLoginProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteLoginProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteLoginProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteLoginProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteLoginProfileError {
    ...
    pub fn is_entity_temporarily_unmodifiable_exception(&self) -> bool {
        matches!(&self.kind, DeleteLoginProfileErrorKind::EntityTemporarilyUnmodifiableException(_))
    }
    /// Returns `true` if the error kind is `DeleteLoginProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteLoginProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteLoginProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteLoginProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteLoginProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteLoginProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteOpenIDConnectProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteOpenIDConnectProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteOpenIDConnectProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteOpenIDConnectProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteOpenIDConnectProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteOpenIDConnectProviderError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, DeleteOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteOpenIDConnectProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteOpenIDConnectProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeletePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeletePolicyErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeletePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeletePolicyError {
    ...
    pub fn is_delete_conflict_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyErrorKind::DeleteConflictException(_))
    }
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeletePolicyVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeletePolicyVersionErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePolicyVersionErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePolicyVersionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePolicyVersionErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePolicyVersionErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePolicyVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeletePolicyVersionError {
    ...
    pub fn is_delete_conflict_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyVersionErrorKind::DeleteConflictException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyVersionErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyVersionErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyVersionErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyVersionErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyVersionErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyVersionErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyVersionErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeletePolicyVersionErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteRoleErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRoleErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRoleErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRoleErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteRoleError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, DeleteRoleErrorKind::ConcurrentModificationException(_))
    }
    ...
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteRoleErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for DeleteRolePermissionsBoundaryError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteRolePermissionsBoundaryErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeleteRolePermissionsBoundaryErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteRolePermissionsBoundaryError {
    /// Creates a new `DeleteRolePermissionsBoundaryError`.
                    pub fn new(kind: DeleteRolePermissionsBoundaryErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePermissionsBoundaryErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteRolePermissionsBoundaryErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePermissionsBoundaryErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteRolePermissionsBoundaryErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePermissionsBoundaryErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for DeleteRolePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteRolePolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRolePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRolePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRolePolicyErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRolePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteRolePolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteRolePolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteRolePolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePolicyErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteRolePolicyErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteRolePolicyErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for DeleteSAMLProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteSAMLProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSAMLProviderErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSAMLProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSAMLProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSAMLProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteSAMLProviderError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, DeleteSAMLProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteSAMLProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteSAMLProviderErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteSAMLProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteSAMLProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteSAMLProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteSAMLProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteServerCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteServerCertificateErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServerCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServerCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServerCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServerCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteServerCertificateError {
    ...
    pub fn is_delete_conflict_exception(&self) -> bool {
        matches!(&self.kind, DeleteServerCertificateErrorKind::DeleteConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteServerCertificateErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteServerCertificateErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteServerCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteServerCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteServerCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteServerCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteServiceLinkedRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteServiceLinkedRoleErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServiceLinkedRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServiceLinkedRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteServiceLinkedRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteServiceLinkedRoleError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteServiceLinkedRoleErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteServiceLinkedRoleErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteServiceLinkedRoleErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteServiceLinkedRoleErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteServiceLinkedRoleErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteServiceSpecificCredentialError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DeleteServiceSpecificCredentialErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteServiceSpecificCredentialError {
    /// Creates a new `DeleteServiceSpecificCredentialError`.
                    pub fn new(kind: DeleteServiceSpecificCredentialErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteServiceSpecificCredentialErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for DeleteSigningCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteSigningCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSigningCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSigningCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSigningCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteSigningCertificateError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteSigningCertificateErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteSigningCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteSigningCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteSigningCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteSigningCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteSSHPublicKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteSSHPublicKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteSSHPublicKeyError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteSSHPublicKeyErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for DeleteUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteUserErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteUserError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, DeleteUserErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for DeleteUserPermissionsBoundaryError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteUserPermissionsBoundaryErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserPermissionsBoundaryErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserPermissionsBoundaryErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteUserPermissionsBoundaryError {
    /// Creates a new `DeleteUserPermissionsBoundaryError`.
                    pub fn new(kind: DeleteUserPermissionsBoundaryErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteUserPermissionsBoundaryErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserPermissionsBoundaryErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteUserPermissionsBoundaryErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteUserPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteUserPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteUserPolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteUserPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteUserPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteUserPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DeleteVirtualMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteVirtualMFADeviceErrorKind::DeleteConflictException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVirtualMFADeviceErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVirtualMFADeviceErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVirtualMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVirtualMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteVirtualMFADeviceError {
    ...
    pub fn is_delete_conflict_exception(&self) -> bool {
        matches!(&self.kind, DeleteVirtualMFADeviceErrorKind::DeleteConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteVirtualMFADeviceErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DeleteVirtualMFADeviceErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DeleteVirtualMFADeviceErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DeleteVirtualMFADeviceErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DeleteVirtualMFADeviceErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DeleteVirtualMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DetachGroupPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DetachGroupPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            DetachGroupPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DetachGroupPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DetachGroupPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DetachGroupPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DetachGroupPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, DetachGroupPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DetachGroupPolicyErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DetachGroupPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DetachGroupPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DetachGroupPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DetachGroupPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DetachGroupPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for DetachRolePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DetachRolePolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            DetachRolePolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DetachRolePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DetachRolePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DetachRolePolicyErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DetachRolePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DetachRolePolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, DetachRolePolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DetachRolePolicyErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DetachRolePolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DetachRolePolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DetachRolePolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DetachRolePolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DetachRolePolicyErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `DetachRolePolicyErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, DetachRolePolicyErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for DetachUserPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DetachUserPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            DetachUserPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            DetachUserPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            DetachUserPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            DetachUserPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DetachUserPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, DetachUserPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DetachUserPolicyErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, DetachUserPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `DetachUserPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, DetachUserPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `DetachUserPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, DetachUserPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for EnableMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            EnableMFADeviceErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            EnableMFADeviceErrorKind::EntityTemporarilyUnmodifiableException(_inner) =>
            _inner.fmt(f)
            ,
            EnableMFADeviceErrorKind::InvalidAuthenticationCodeException(_inner) =>
            _inner.fmt(f)
            ,
            EnableMFADeviceErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            EnableMFADeviceErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            EnableMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            EnableMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl EnableMFADeviceError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, EnableMFADeviceErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `EnableMFADeviceErrorKind::EntityTemporarilyUnmodifiableException`.
    pub fn is_entity_temporarily_unmodifiable_exception(&self) -> bool {
        matches!(&self.kind, EnableMFADeviceErrorKind::EntityTemporarilyUnmodifiableException(_))
    }
    ...
    pub fn is_invalid_authentication_code_exception(&self) -> bool {
        matches!(&self.kind, EnableMFADeviceErrorKind::InvalidAuthenticationCodeException(_))
    }
    /// Returns `true` if the error kind is `EnableMFADeviceErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, EnableMFADeviceErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `EnableMFADeviceErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, EnableMFADeviceErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `EnableMFADeviceErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, EnableMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GenerateCredentialReportError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GenerateCredentialReportErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            GenerateCredentialReportErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GenerateCredentialReportErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GenerateCredentialReportError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, GenerateCredentialReportErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `GenerateCredentialReportErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GenerateCredentialReportErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GenerateOrganizationsAccessReportError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GenerateOrganizationsAccessReportErrorKind::ReportGenerationLimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            GenerateOrganizationsAccessReportErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GenerateOrganizationsAccessReportError {
    /// Creates a new `GenerateOrganizationsAccessReportError`.
                    pub fn new(kind: GenerateOrganizationsAccessReportErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_report_generation_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, GenerateOrganizationsAccessReportErrorKind::ReportGenerationLimitExceededException(_))
    }
}
...
impl std::fmt::Display for GenerateServiceLastAccessedDetailsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GenerateServiceLastAccessedDetailsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GenerateServiceLastAccessedDetailsError {
    /// Creates a new `GenerateServiceLastAccessedDetailsError`.
                    pub fn new(kind: GenerateServiceLastAccessedDetailsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GenerateServiceLastAccessedDetailsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GenerateServiceLastAccessedDetailsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GenerateServiceLastAccessedDetailsErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for GetAccessKeyLastUsedError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetAccessKeyLastUsedErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetAccessKeyLastUsedErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetAccessKeyLastUsedError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetAccessKeyLastUsedErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for GetAccountAuthorizationDetailsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GetAccountAuthorizationDetailsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetAccountAuthorizationDetailsError {
    /// Creates a new `GetAccountAuthorizationDetailsError`.
                    pub fn new(kind: GetAccountAuthorizationDetailsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetAccountAuthorizationDetailsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetAccountPasswordPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetAccountPasswordPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetAccountPasswordPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetAccountPasswordPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetAccountPasswordPolicyError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetAccountPasswordPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetAccountPasswordPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetAccountPasswordPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetAccountSummaryError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetAccountSummaryErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetAccountSummaryErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetAccountSummaryError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetAccountSummaryErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetContextKeysForCustomPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetContextKeysForCustomPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetContextKeysForCustomPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetContextKeysForCustomPolicyError {
    /// Creates a new `GetContextKeysForCustomPolicyError`.
                    pub fn new(kind: GetContextKeysForCustomPolicyErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetContextKeysForCustomPolicyErrorKind::InvalidInputException(_))
    }
}
...
impl std::fmt::Display for GetContextKeysForPrincipalPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GetContextKeysForPrincipalPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetContextKeysForPrincipalPolicyError {
    /// Creates a new `GetContextKeysForPrincipalPolicyError`.
                    pub fn new(kind: GetContextKeysForPrincipalPolicyErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetContextKeysForPrincipalPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetContextKeysForPrincipalPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetContextKeysForPrincipalPolicyErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for GetCredentialReportError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCredentialReportErrorKind::CredentialReportExpiredException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            GetCredentialReportErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetCredentialReportErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetCredentialReportError {
    ...
    pub fn is_credential_report_expired_exception(&self) -> bool {
        matches!(&self.kind, GetCredentialReportErrorKind::CredentialReportExpiredException(_))
    }
    ...
    pub fn is_credential_report_not_present_exception(&self) -> bool {
        matches!(&self.kind, GetCredentialReportErrorKind::CredentialReportNotPresentException(_))
    }
    ...
    pub fn is_credential_report_not_ready_exception(&self) -> bool {
        matches!(&self.kind, GetCredentialReportErrorKind::CredentialReportNotReadyException(_))
    }
    /// Returns `true` if the error kind is `GetCredentialReportErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetCredentialReportErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetGroupErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetGroupErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for GetGroupPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetGroupPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetGroupPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetGroupPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetGroupPolicyError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetGroupPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetGroupPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetGroupPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetInstanceProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetInstanceProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetInstanceProfileError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetInstanceProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetInstanceProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetLoginProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetLoginProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetLoginProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetLoginProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetLoginProfileError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetLoginProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetLoginProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetLoginProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetOpenIDConnectProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetOpenIDConnectProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetOpenIDConnectProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetOpenIDConnectProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetOpenIDConnectProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetOpenIDConnectProviderError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetOpenIDConnectProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetOpenIDConnectProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetOrganizationsAccessReportError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetOrganizationsAccessReportErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetOrganizationsAccessReportErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetOrganizationsAccessReportError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetOrganizationsAccessReportErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for GetPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for GetPolicyVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetPolicyVersionErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetPolicyVersionErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetPolicyVersionErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetPolicyVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetPolicyVersionError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetPolicyVersionErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyVersionErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetPolicyVersionErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyVersionErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetPolicyVersionErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetRolePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetRolePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetRolePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetRolePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetRolePolicyError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetRolePolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetSAMLProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSAMLProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetSAMLProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetSAMLProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetSAMLProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSAMLProviderError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetSAMLProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetSAMLProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetSAMLProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetSAMLProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetSAMLProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetServerCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetServerCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetServerCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetServerCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetServerCertificateError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetServerCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetServerCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetServerCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetServiceLastAccessedDetailsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetServiceLastAccessedDetailsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetServiceLastAccessedDetailsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetServiceLastAccessedDetailsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetServiceLastAccessedDetailsError {
    /// Creates a new `GetServiceLastAccessedDetailsError`.
                    pub fn new(kind: GetServiceLastAccessedDetailsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLastAccessedDetailsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetServiceLastAccessedDetailsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLastAccessedDetailsErrorKind::NoSuchEntityException(_))
    }
}
...
impl GetServiceLastAccessedDetailsWithEntitiesError {
    /// Creates a new `GetServiceLastAccessedDetailsWithEntitiesError`.
                    pub fn new(kind: GetServiceLastAccessedDetailsWithEntitiesErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLastAccessedDetailsWithEntitiesErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetServiceLastAccessedDetailsWithEntitiesErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLastAccessedDetailsWithEntitiesErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for GetServiceLinkedRoleDeletionStatusError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GetServiceLinkedRoleDeletionStatusErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetServiceLinkedRoleDeletionStatusError {
    /// Creates a new `GetServiceLinkedRoleDeletionStatusError`.
                    pub fn new(kind: GetServiceLinkedRoleDeletionStatusErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLinkedRoleDeletionStatusErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetServiceLinkedRoleDeletionStatusErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLinkedRoleDeletionStatusErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `GetServiceLinkedRoleDeletionStatusErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetServiceLinkedRoleDeletionStatusErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for GetSSHPublicKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSSHPublicKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetSSHPublicKeyErrorKind::UnrecognizedPublicKeyEncodingException(_inner) =>
            _inner.fmt(f)
            ,
            GetSSHPublicKeyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSSHPublicKeyError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, GetSSHPublicKeyErrorKind::NoSuchEntityException(_))
    }
    ...
    pub fn is_unrecognized_public_key_encoding_exception(&self) -> bool {
        matches!(&self.kind, GetSSHPublicKeyErrorKind::UnrecognizedPublicKeyEncodingException(_))
    }
}
...
impl std::fmt::Display for GetUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetUserPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetUserPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetUserPolicyError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, GetUserPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListAccessKeysError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListAccessKeysErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListAccessKeysErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListAccessKeysErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListAccessKeysError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListAccessKeysErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListAccessKeysErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListAccessKeysErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListAccountAliasesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListAccountAliasesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListAccountAliasesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListAccountAliasesError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListAccountAliasesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListAttachedGroupPoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListAttachedGroupPoliciesErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedGroupPoliciesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedGroupPoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedGroupPoliciesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListAttachedGroupPoliciesError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedGroupPoliciesErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListAttachedGroupPoliciesErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedGroupPoliciesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListAttachedGroupPoliciesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedGroupPoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListAttachedRolePoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListAttachedRolePoliciesErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedRolePoliciesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedRolePoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedRolePoliciesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListAttachedRolePoliciesError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedRolePoliciesErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListAttachedRolePoliciesErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedRolePoliciesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListAttachedRolePoliciesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedRolePoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListAttachedUserPoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListAttachedUserPoliciesErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedUserPoliciesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedUserPoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListAttachedUserPoliciesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListAttachedUserPoliciesError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedUserPoliciesErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListAttachedUserPoliciesErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedUserPoliciesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListAttachedUserPoliciesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListAttachedUserPoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListEntitiesForPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListEntitiesForPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListEntitiesForPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListEntitiesForPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListEntitiesForPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListEntitiesForPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListEntitiesForPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListEntitiesForPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListEntitiesForPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListEntitiesForPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListEntitiesForPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListGroupPoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListGroupPoliciesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListGroupPoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListGroupPoliciesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListGroupPoliciesError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListGroupPoliciesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListGroupPoliciesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListGroupPoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListGroupsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListGroupsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for ListGroupsForUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListGroupsForUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListGroupsForUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListGroupsForUserErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListGroupsForUserError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListGroupsForUserErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListGroupsForUserErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListGroupsForUserErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListInstanceProfilesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListInstanceProfilesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListInstanceProfilesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListInstanceProfilesError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListInstanceProfilesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListInstanceProfilesForRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListInstanceProfilesForRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListInstanceProfilesForRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListInstanceProfilesForRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListInstanceProfilesForRoleError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListInstanceProfilesForRoleErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListInstanceProfilesForRoleErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListInstanceProfilesForRoleErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListInstanceProfileTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListInstanceProfileTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListInstanceProfileTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListInstanceProfileTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListInstanceProfileTagsError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListInstanceProfileTagsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListInstanceProfileTagsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListInstanceProfileTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListMFADevicesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListMFADevicesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListMFADevicesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListMFADevicesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListMFADevicesError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListMFADevicesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListMFADevicesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListMFADevicesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListMFADeviceTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListMFADeviceTagsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListMFADeviceTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListMFADeviceTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListMFADeviceTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListMFADeviceTagsError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListMFADeviceTagsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListMFADeviceTagsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListMFADeviceTagsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListMFADeviceTagsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListMFADeviceTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListOpenIDConnectProvidersError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListOpenIDConnectProvidersErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListOpenIDConnectProvidersErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListOpenIDConnectProvidersError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListOpenIDConnectProvidersErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListOpenIDConnectProviderTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListOpenIDConnectProviderTagsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListOpenIDConnectProviderTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListOpenIDConnectProviderTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListOpenIDConnectProviderTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListOpenIDConnectProviderTagsError {
    /// Creates a new `ListOpenIDConnectProviderTagsError`.
                    pub fn new(kind: ListOpenIDConnectProviderTagsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListOpenIDConnectProviderTagsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListOpenIDConnectProviderTagsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListOpenIDConnectProviderTagsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListOpenIDConnectProviderTagsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListOpenIDConnectProviderTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListPoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListPoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ListPoliciesError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListPoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListPoliciesGrantingServiceAccessError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            ListPoliciesGrantingServiceAccessErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListPoliciesGrantingServiceAccessError {
    /// Creates a new `ListPoliciesGrantingServiceAccessError`.
                    pub fn new(kind: ListPoliciesGrantingServiceAccessErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListPoliciesGrantingServiceAccessErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListPoliciesGrantingServiceAccessErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListPoliciesGrantingServiceAccessErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for ListPolicyTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListPolicyTagsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListPolicyTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListPolicyTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListPolicyTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListPolicyTagsError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListPolicyTagsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListPolicyTagsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListPolicyTagsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListPolicyTagsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListPolicyTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListPolicyVersionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListPolicyVersionsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListPolicyVersionsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListPolicyVersionsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListPolicyVersionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListPolicyVersionsError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListPolicyVersionsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListPolicyVersionsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListPolicyVersionsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListPolicyVersionsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListPolicyVersionsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListRolePoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListRolePoliciesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListRolePoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListRolePoliciesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListRolePoliciesError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListRolePoliciesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListRolePoliciesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListRolePoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListRolesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListRolesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListRolesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for ListRoleTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListRoleTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListRoleTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListRoleTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListRoleTagsError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListRoleTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListSAMLProvidersError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListSAMLProvidersErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListSAMLProvidersErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListSAMLProvidersError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListSAMLProvidersErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListSAMLProviderTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListSAMLProviderTagsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            ListSAMLProviderTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListSAMLProviderTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListSAMLProviderTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListSAMLProviderTagsError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, ListSAMLProviderTagsErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListSAMLProviderTagsErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListSAMLProviderTagsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListSAMLProviderTagsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListSAMLProviderTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListServerCertificatesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListServerCertificatesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListServerCertificatesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListServerCertificatesError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListServerCertificatesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListServerCertificateTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListServerCertificateTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListServerCertificateTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListServerCertificateTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListServerCertificateTagsError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListServerCertificateTagsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListServerCertificateTagsErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListServerCertificateTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListServiceSpecificCredentialsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListServiceSpecificCredentialsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListServiceSpecificCredentialsErrorKind::ServiceNotSupportedException(_inner) =>
            _inner.fmt(f)
            ,
            ListServiceSpecificCredentialsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListServiceSpecificCredentialsError {
    /// Creates a new `ListServiceSpecificCredentialsError`.
                    pub fn new(kind: ListServiceSpecificCredentialsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListServiceSpecificCredentialsErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListServiceSpecificCredentialsErrorKind::ServiceNotSupportedException`.
    pub fn is_service_not_supported_exception(&self) -> bool {
        matches!(&self.kind, ListServiceSpecificCredentialsErrorKind::ServiceNotSupportedException(_))
    }
}
...
impl std::fmt::Display for ListSigningCertificatesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListSigningCertificatesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListSigningCertificatesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListSigningCertificatesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListSigningCertificatesError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListSigningCertificatesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListSigningCertificatesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListSigningCertificatesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListSSHPublicKeysError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListSSHPublicKeysErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListSSHPublicKeysErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListSSHPublicKeysError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListSSHPublicKeysErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for ListUserPoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListUserPoliciesErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListUserPoliciesErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListUserPoliciesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListUserPoliciesError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ListUserPoliciesErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ListUserPoliciesErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListUserPoliciesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListUsersError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListUsersErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for ListUserTagsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListUserTagsErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ListUserTagsErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ListUserTagsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListUserTagsError {
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ListUserTagsErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ListVirtualMFADevicesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListVirtualMFADevicesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for PutGroupPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutGroupPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            PutGroupPolicyErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            PutGroupPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutGroupPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            PutGroupPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PutGroupPolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, PutGroupPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `PutGroupPolicyErrorKind::MalformedPolicyDocumentException`.
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, PutGroupPolicyErrorKind::MalformedPolicyDocumentException(_))
    }
    /// Returns `true` if the error kind is `PutGroupPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, PutGroupPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `PutGroupPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, PutGroupPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for PutRolePermissionsBoundaryError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutRolePermissionsBoundaryErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePermissionsBoundaryErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePermissionsBoundaryErrorKind::PolicyNotAttachableException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePermissionsBoundaryErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePermissionsBoundaryErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePermissionsBoundaryErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PutRolePermissionsBoundaryError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, PutRolePermissionsBoundaryErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `PutRolePermissionsBoundaryErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, PutRolePermissionsBoundaryErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `PutRolePermissionsBoundaryErrorKind::PolicyNotAttachableException`.
    pub fn is_policy_not_attachable_exception(&self) -> bool {
        matches!(&self.kind, PutRolePermissionsBoundaryErrorKind::PolicyNotAttachableException(_))
    }
    /// Returns `true` if the error kind is `PutRolePermissionsBoundaryErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, PutRolePermissionsBoundaryErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `PutRolePermissionsBoundaryErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, PutRolePermissionsBoundaryErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for PutRolePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutRolePolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePolicyErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePolicyErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutRolePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PutRolePolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, PutRolePolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `PutRolePolicyErrorKind::MalformedPolicyDocumentException`.
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, PutRolePolicyErrorKind::MalformedPolicyDocumentException(_))
    }
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, PutRolePolicyErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `PutRolePolicyErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, PutRolePolicyErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for PutUserPermissionsBoundaryError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutUserPermissionsBoundaryErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPermissionsBoundaryErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPermissionsBoundaryErrorKind::PolicyNotAttachableException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPermissionsBoundaryErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPermissionsBoundaryErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PutUserPermissionsBoundaryError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, PutUserPermissionsBoundaryErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `PutUserPermissionsBoundaryErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, PutUserPermissionsBoundaryErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `PutUserPermissionsBoundaryErrorKind::PolicyNotAttachableException`.
    pub fn is_policy_not_attachable_exception(&self) -> bool {
        matches!(&self.kind, PutUserPermissionsBoundaryErrorKind::PolicyNotAttachableException(_))
    }
    /// Returns `true` if the error kind is `PutUserPermissionsBoundaryErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, PutUserPermissionsBoundaryErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for PutUserPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutUserPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPolicyErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            PutUserPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PutUserPolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, PutUserPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `PutUserPolicyErrorKind::MalformedPolicyDocumentException`.
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, PutUserPolicyErrorKind::MalformedPolicyDocumentException(_))
    }
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, PutUserPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl RemoveClientIDFromOpenIDConnectProviderError {
    /// Creates a new `RemoveClientIDFromOpenIDConnectProviderError`.
                    pub fn new(kind: RemoveClientIDFromOpenIDConnectProviderErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, RemoveClientIDFromOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `RemoveClientIDFromOpenIDConnectProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, RemoveClientIDFromOpenIDConnectProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `RemoveClientIDFromOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, RemoveClientIDFromOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for RemoveRoleFromInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            RemoveRoleFromInstanceProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveRoleFromInstanceProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            RemoveRoleFromInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl RemoveRoleFromInstanceProfileError {
    /// Creates a new `RemoveRoleFromInstanceProfileError`.
                    pub fn new(kind: RemoveRoleFromInstanceProfileErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, RemoveRoleFromInstanceProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `RemoveRoleFromInstanceProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, RemoveRoleFromInstanceProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `RemoveRoleFromInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, RemoveRoleFromInstanceProfileErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `RemoveRoleFromInstanceProfileErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, RemoveRoleFromInstanceProfileErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for RemoveUserFromGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            RemoveUserFromGroupErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveUserFromGroupErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveUserFromGroupErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveUserFromGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl RemoveUserFromGroupError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, RemoveUserFromGroupErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `RemoveUserFromGroupErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, RemoveUserFromGroupErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `RemoveUserFromGroupErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, RemoveUserFromGroupErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for ResetServiceSpecificCredentialError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ResetServiceSpecificCredentialErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ResetServiceSpecificCredentialErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ResetServiceSpecificCredentialError {
    /// Creates a new `ResetServiceSpecificCredentialError`.
                    pub fn new(kind: ResetServiceSpecificCredentialErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ResetServiceSpecificCredentialErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for ResyncMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ResyncMFADeviceErrorKind::InvalidAuthenticationCodeException(_inner) =>
            _inner.fmt(f)
            ,
            ResyncMFADeviceErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            ResyncMFADeviceErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            ResyncMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            ResyncMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ResyncMFADeviceError {
    ...
    pub fn is_invalid_authentication_code_exception(&self) -> bool {
        matches!(&self.kind, ResyncMFADeviceErrorKind::InvalidAuthenticationCodeException(_))
    }
    /// Returns `true` if the error kind is `ResyncMFADeviceErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, ResyncMFADeviceErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `ResyncMFADeviceErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, ResyncMFADeviceErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `ResyncMFADeviceErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, ResyncMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for SetDefaultPolicyVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SetDefaultPolicyVersionErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            SetDefaultPolicyVersionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            SetDefaultPolicyVersionErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            SetDefaultPolicyVersionErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            SetDefaultPolicyVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SetDefaultPolicyVersionError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, SetDefaultPolicyVersionErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPolicyVersionErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, SetDefaultPolicyVersionErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPolicyVersionErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, SetDefaultPolicyVersionErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPolicyVersionErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, SetDefaultPolicyVersionErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for SetSecurityTokenServicePreferencesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            SetSecurityTokenServicePreferencesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SetSecurityTokenServicePreferencesError {
    /// Creates a new `SetSecurityTokenServicePreferencesError`.
                    pub fn new(kind: SetSecurityTokenServicePreferencesErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, SetSecurityTokenServicePreferencesErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for SimulateCustomPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SimulateCustomPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            SimulateCustomPolicyErrorKind::PolicyEvaluationException(_inner) =>
            _inner.fmt(f)
            ,
            SimulateCustomPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SimulateCustomPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, SimulateCustomPolicyErrorKind::InvalidInputException(_))
    }
    ...
    pub fn is_policy_evaluation_exception(&self) -> bool {
        matches!(&self.kind, SimulateCustomPolicyErrorKind::PolicyEvaluationException(_))
    }
}
...
impl std::fmt::Display for SimulatePrincipalPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SimulatePrincipalPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            SimulatePrincipalPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            SimulatePrincipalPolicyErrorKind::PolicyEvaluationException(_inner) =>
            _inner.fmt(f)
            ,
            SimulatePrincipalPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SimulatePrincipalPolicyError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, SimulatePrincipalPolicyErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `SimulatePrincipalPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, SimulatePrincipalPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `SimulatePrincipalPolicyErrorKind::PolicyEvaluationException`.
    pub fn is_policy_evaluation_exception(&self) -> bool {
        matches!(&self.kind, SimulatePrincipalPolicyErrorKind::PolicyEvaluationException(_))
    }
}
...
impl std::fmt::Display for TagInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagInstanceProfileErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagInstanceProfileErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagInstanceProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagInstanceProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagInstanceProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagInstanceProfileError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagInstanceProfileErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `TagInstanceProfileErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, TagInstanceProfileErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `TagInstanceProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, TagInstanceProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `TagInstanceProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, TagInstanceProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `TagInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, TagInstanceProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for TagMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagMFADeviceErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagMFADeviceErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagMFADeviceErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagMFADeviceErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagMFADeviceError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagMFADeviceErrorKind::ConcurrentModificationException(_))
    }
    ...
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, TagMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for TagOpenIDConnectProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            TagOpenIDConnectProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagOpenIDConnectProviderErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagOpenIDConnectProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagOpenIDConnectProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagOpenIDConnectProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagOpenIDConnectProviderError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagOpenIDConnectProviderErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `TagOpenIDConnectProviderErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, TagOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `TagOpenIDConnectProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, TagOpenIDConnectProviderErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `TagOpenIDConnectProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, TagOpenIDConnectProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `TagOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, TagOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for TagPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagPolicyErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagPolicyError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagPolicyErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for TagRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagRoleErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagRoleErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagRoleErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagRoleError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagRoleErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for TagSAMLProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagSAMLProviderErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagSAMLProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagSAMLProviderErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagSAMLProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagSAMLProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagSAMLProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagSAMLProviderError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagSAMLProviderErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `TagSAMLProviderErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, TagSAMLProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `TagSAMLProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, TagSAMLProviderErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `TagSAMLProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, TagSAMLProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `TagSAMLProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, TagSAMLProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for TagServerCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagServerCertificateErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagServerCertificateErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagServerCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagServerCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagServerCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagServerCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagServerCertificateError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagServerCertificateErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `TagServerCertificateErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, TagServerCertificateErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `TagServerCertificateErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, TagServerCertificateErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `TagServerCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, TagServerCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `TagServerCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, TagServerCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for TagUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            TagUserErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            TagUserErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            TagUserErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            TagUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            TagUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            TagUserErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl TagUserError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, TagUserErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for UntagInstanceProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UntagInstanceProfileErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UntagInstanceProfileErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UntagInstanceProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagInstanceProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagInstanceProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagInstanceProfileError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagInstanceProfileErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UntagInstanceProfileErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UntagInstanceProfileErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UntagInstanceProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UntagInstanceProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UntagInstanceProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UntagInstanceProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UntagMFADeviceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UntagMFADeviceErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UntagMFADeviceErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UntagMFADeviceErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagMFADeviceErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagMFADeviceErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagMFADeviceError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagMFADeviceErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UntagMFADeviceErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UntagMFADeviceErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UntagMFADeviceErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UntagMFADeviceErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UntagMFADeviceErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UntagMFADeviceErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UntagOpenIDConnectProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UntagOpenIDConnectProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UntagOpenIDConnectProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagOpenIDConnectProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagOpenIDConnectProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagOpenIDConnectProviderError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagOpenIDConnectProviderErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UntagOpenIDConnectProviderErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UntagOpenIDConnectProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UntagOpenIDConnectProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UntagOpenIDConnectProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UntagOpenIDConnectProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UntagOpenIDConnectProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UntagPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UntagPolicyErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UntagPolicyErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UntagPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagPolicyError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagPolicyErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for UntagRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UntagRoleErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UntagRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagRoleError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagRoleErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for UntagSAMLProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UntagSAMLProviderErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UntagSAMLProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UntagSAMLProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagSAMLProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagSAMLProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagSAMLProviderError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagSAMLProviderErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UntagSAMLProviderErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UntagSAMLProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UntagSAMLProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UntagSAMLProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UntagSAMLProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UntagSAMLProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UntagServerCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UntagServerCertificateErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UntagServerCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagServerCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagServerCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagServerCertificateError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagServerCertificateErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UntagServerCertificateErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UntagServerCertificateErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UntagServerCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UntagServerCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UntagServerCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UntagServerCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UntagUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UntagUserErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UntagUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UntagUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UntagUserErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UntagUserError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UntagUserErrorKind::ConcurrentModificationException(_))
    }
...
impl std::fmt::Display for UpdateAccessKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateAccessKeyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccessKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccessKeyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccessKeyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateAccessKeyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccessKeyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccessKeyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccessKeyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccessKeyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccessKeyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UpdateAccountPasswordPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateAccountPasswordPolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccountPasswordPolicyErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccountPasswordPolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccountPasswordPolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAccountPasswordPolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateAccountPasswordPolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccountPasswordPolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccountPasswordPolicyErrorKind::MalformedPolicyDocumentException`.
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccountPasswordPolicyErrorKind::MalformedPolicyDocumentException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccountPasswordPolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccountPasswordPolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateAccountPasswordPolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateAccountPasswordPolicyErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UpdateAssumeRolePolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateAssumeRolePolicyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAssumeRolePolicyErrorKind::MalformedPolicyDocumentException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAssumeRolePolicyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAssumeRolePolicyErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAssumeRolePolicyErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAssumeRolePolicyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateAssumeRolePolicyError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateAssumeRolePolicyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateAssumeRolePolicyErrorKind::MalformedPolicyDocumentException`.
    pub fn is_malformed_policy_document_exception(&self) -> bool {
        matches!(&self.kind, UpdateAssumeRolePolicyErrorKind::MalformedPolicyDocumentException(_))
    }
    /// Returns `true` if the error kind is `UpdateAssumeRolePolicyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateAssumeRolePolicyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateAssumeRolePolicyErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateAssumeRolePolicyErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateAssumeRolePolicyErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateAssumeRolePolicyErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for UpdateGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateGroupErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGroupErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGroupErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGroupErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl UpdateGroupError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, UpdateGroupErrorKind::EntityAlreadyExistsException(_))
    }
...
impl std::fmt::Display for UpdateLoginProfileError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UpdateLoginProfileErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateLoginProfileErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateLoginProfileErrorKind::PasswordPolicyViolationException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateLoginProfileErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateLoginProfileErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateLoginProfileError {
    ...
    pub fn is_entity_temporarily_unmodifiable_exception(&self) -> bool {
        matches!(&self.kind, UpdateLoginProfileErrorKind::EntityTemporarilyUnmodifiableException(_))
    }
    /// Returns `true` if the error kind is `UpdateLoginProfileErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateLoginProfileErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateLoginProfileErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateLoginProfileErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateLoginProfileErrorKind::PasswordPolicyViolationException`.
    pub fn is_password_policy_violation_exception(&self) -> bool {
        matches!(&self.kind, UpdateLoginProfileErrorKind::PasswordPolicyViolationException(_))
    }
    /// Returns `true` if the error kind is `UpdateLoginProfileErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateLoginProfileErrorKind::ServiceFailureException(_))
    }
}
...
impl UpdateOpenIDConnectProviderThumbprintError {
    /// Creates a new `UpdateOpenIDConnectProviderThumbprintError`.
                    pub fn new(kind: UpdateOpenIDConnectProviderThumbprintErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UpdateOpenIDConnectProviderThumbprintErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateOpenIDConnectProviderThumbprintErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateOpenIDConnectProviderThumbprintErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateOpenIDConnectProviderThumbprintErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateOpenIDConnectProviderThumbprintErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UpdateRoleError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateRoleErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRoleErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRoleErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRoleErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateRoleError {
    ...
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateRoleErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for UpdateRoleDescriptionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateRoleDescriptionErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRoleDescriptionErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRoleDescriptionErrorKind::UnmodifiableEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRoleDescriptionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateRoleDescriptionError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateRoleDescriptionErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateRoleDescriptionErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateRoleDescriptionErrorKind::ServiceFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateRoleDescriptionErrorKind::UnmodifiableEntityException`.
    pub fn is_unmodifiable_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateRoleDescriptionErrorKind::UnmodifiableEntityException(_))
    }
}
...
impl std::fmt::Display for UpdateSAMLProviderError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateSAMLProviderErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSAMLProviderErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSAMLProviderErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSAMLProviderErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSAMLProviderErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateSAMLProviderError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UpdateSAMLProviderErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateSAMLProviderErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateSAMLProviderErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateSAMLProviderErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateSAMLProviderErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateSAMLProviderErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateSAMLProviderErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UpdateServerCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateServerCertificateErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateServerCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateServerCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateServerCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateServerCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateServerCertificateError {
    ...
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, UpdateServerCertificateErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `UpdateServerCertificateErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateServerCertificateErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateServerCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateServerCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateServerCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateServerCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UpdateServiceSpecificCredentialError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UpdateServiceSpecificCredentialErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateServiceSpecificCredentialError {
    /// Creates a new `UpdateServiceSpecificCredentialError`.
                    pub fn new(kind: UpdateServiceSpecificCredentialErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateServiceSpecificCredentialErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for UpdateSigningCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateSigningCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSigningCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSigningCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSigningCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateSigningCertificateError {
    ...
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UpdateSigningCertificateErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateSigningCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateSigningCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UpdateSigningCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UpdateSigningCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UpdateSSHPublicKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateSSHPublicKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSSHPublicKeyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateSSHPublicKeyError {
    ...
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UpdateSSHPublicKeyErrorKind::NoSuchEntityException(_))
    }
}
...
impl std::fmt::Display for UpdateUserError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateUserErrorKind::ConcurrentModificationException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateUserErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateUserErrorKind::EntityTemporarilyUnmodifiableException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateUserErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateUserErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateUserErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
...
impl UpdateUserError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UpdateUserErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, UpdateUserErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserErrorKind::EntityTemporarilyUnmodifiableException`.
    pub fn is_entity_temporarily_unmodifiable_exception(&self) -> bool {
        matches!(&self.kind, UpdateUserErrorKind::EntityTemporarilyUnmodifiableException(_))
    }
...
impl std::fmt::Display for UploadServerCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::EntityAlreadyExistsException(_inner) =>
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::KeyPairMismatchException(_inner) =>
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::MalformedCertificateException(_inner) =>
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UploadServerCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UploadServerCertificateError {
    ...
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UploadServerCertificateErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::EntityAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `UploadServerCertificateErrorKind::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::InvalidInputException(_))
    }
    ...
    pub fn is_key_pair_mismatch_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::KeyPairMismatchException(_))
    }
    /// Returns `true` if the error kind is `UploadServerCertificateErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::LimitExceededException(_))
    }
    ...
    pub fn is_malformed_certificate_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::MalformedCertificateException(_))
    }
    /// Returns `true` if the error kind is `UploadServerCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UploadServerCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UploadSigningCertificateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UploadSigningCertificateErrorKind::InvalidCertificateException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSigningCertificateErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSigningCertificateErrorKind::MalformedCertificateException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSigningCertificateErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSigningCertificateErrorKind::ServiceFailureException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSigningCertificateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UploadSigningCertificateError {
    ...
    pub fn is_duplicate_certificate_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::DuplicateCertificateException(_))
    }
    /// Returns `true` if the error kind is `UploadSigningCertificateErrorKind::EntityAlreadyExistsException`.
    pub fn is_entity_already_exists_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::EntityAlreadyExistsException(_))
    }
    ...
    pub fn is_invalid_certificate_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::InvalidCertificateException(_))
    }
    /// Returns `true` if the error kind is `UploadSigningCertificateErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UploadSigningCertificateErrorKind::MalformedCertificateException`.
    pub fn is_malformed_certificate_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::MalformedCertificateException(_))
    }
    /// Returns `true` if the error kind is `UploadSigningCertificateErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UploadSigningCertificateErrorKind::ServiceFailureException`.
    pub fn is_service_failure_exception(&self) -> bool {
        matches!(&self.kind, UploadSigningCertificateErrorKind::ServiceFailureException(_))
    }
}
...
impl std::fmt::Display for UploadSSHPublicKeyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UploadSSHPublicKeyErrorKind::DuplicateSshPublicKeyException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSSHPublicKeyErrorKind::InvalidPublicKeyException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSSHPublicKeyErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSSHPublicKeyErrorKind::NoSuchEntityException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSSHPublicKeyErrorKind::UnrecognizedPublicKeyEncodingException(_inner) =>
            _inner.fmt(f)
            ,
            UploadSSHPublicKeyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UploadSSHPublicKeyError {
    ...
    pub fn is_duplicate_ssh_public_key_exception(&self) -> bool {
        matches!(&self.kind, UploadSSHPublicKeyErrorKind::DuplicateSshPublicKeyException(_))
    }
    ...
    pub fn is_invalid_public_key_exception(&self) -> bool {
        matches!(&self.kind, UploadSSHPublicKeyErrorKind::InvalidPublicKeyException(_))
    }
    /// Returns `true` if the error kind is `UploadSSHPublicKeyErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, UploadSSHPublicKeyErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UploadSSHPublicKeyErrorKind::NoSuchEntityException`.
    pub fn is_no_such_entity_exception(&self) -> bool {
        matches!(&self.kind, UploadSSHPublicKeyErrorKind::NoSuchEntityException(_))
    }
    /// Returns `true` if the error kind is `UploadSSHPublicKeyErrorKind::UnrecognizedPublicKeyEncodingException`.
    pub fn is_unrecognized_public_key_encoding_exception(&self) -> bool {
        matches!(&self.kind, UploadSSHPublicKeyErrorKind::UnrecognizedPublicKeyEncodingException(_))
    }
}
