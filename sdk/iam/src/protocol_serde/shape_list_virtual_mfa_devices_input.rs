...
pub fn ser_list_virtual_mfa_devices_input_input_input(input: &crate::operation::list_virtual_mfa_devices::ListVirtualMfaDevicesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
