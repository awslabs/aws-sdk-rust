...
pub fn ser_list_access_keys_input_input_input(input: &crate::operation::list_access_keys::ListAccessKeysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
