...
pub fn ser_upload_server_certificate_input_input(input: &crate::input::UploadServerCertificateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
