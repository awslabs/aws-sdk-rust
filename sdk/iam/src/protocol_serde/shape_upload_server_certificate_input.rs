...
pub fn ser_upload_server_certificate_input_input_input(input: &crate::operation::upload_server_certificate::UploadServerCertificateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
