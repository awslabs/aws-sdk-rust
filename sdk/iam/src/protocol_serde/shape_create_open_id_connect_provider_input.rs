...
pub fn ser_create_open_id_connect_provider_input_input(input: &crate::input::CreateOpenIdConnectProviderInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
