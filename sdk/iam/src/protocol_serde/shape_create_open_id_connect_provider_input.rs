...
pub fn ser_create_open_id_connect_provider_input_input_input(input: &crate::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
