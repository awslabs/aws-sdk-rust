...
pub fn ser_create_role_input_input(input: &crate::input::CreateRoleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
