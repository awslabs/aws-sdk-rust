...
pub fn ser_create_role_input_input_input(input: &crate::operation::create_role::CreateRoleInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
