...
pub fn ser_update_saml_provider_input_input_input(input: &crate::operation::update_saml_provider::UpdateSamlProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
