...
pub fn de_permissions_boundary_decision_detail(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PermissionsBoundaryDecisionDetail, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
