...
pub fn de_tag_open_id_connect_provider_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderOutput, crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_tag_open_id_connect_provider_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::tag_open_id_connect_provider::TagOpenIdConnectProviderOutput, crate::operation::tag_open_id_connect_provider::TagOpenIDConnectProviderError> {
    Ok({
        #[allow(unused_mut)]
