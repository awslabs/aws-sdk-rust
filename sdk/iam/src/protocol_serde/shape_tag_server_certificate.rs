...
pub fn de_tag_server_certificate_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::tag_server_certificate::TagServerCertificateOutput, crate::operation::tag_server_certificate::TagServerCertificateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::tag_server_certificate::TagServerCertificateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_tag_server_certificate_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::tag_server_certificate::TagServerCertificateOutput, crate::operation::tag_server_certificate::TagServerCertificateError> {
    Ok({
        #[allow(unused_mut)]
