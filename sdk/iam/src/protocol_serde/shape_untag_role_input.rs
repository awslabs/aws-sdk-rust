...
pub fn ser_untag_role_input_input_input(input: &crate::operation::untag_role::UntagRoleInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
