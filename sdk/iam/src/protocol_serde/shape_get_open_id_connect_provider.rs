...
pub fn de_get_open_id_connect_provider_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput, crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_open_id_connect_provider_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderOutput, crate::operation::get_open_id_connect_provider::GetOpenIDConnectProviderError> {
    Ok({
        #[allow(unused_mut)]
