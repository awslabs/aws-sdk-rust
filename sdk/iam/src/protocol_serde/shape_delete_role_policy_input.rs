...
pub fn ser_delete_role_policy_input_input_input(input: &crate::operation::delete_role_policy::DeleteRolePolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
