...
pub fn ser_delete_role_policy_input_input(input: &crate::operation::delete_role_policy::DeleteRolePolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
