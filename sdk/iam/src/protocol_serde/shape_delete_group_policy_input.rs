...
pub fn ser_delete_group_policy_input_input(input: &crate::operation::delete_group_policy::DeleteGroupPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
