...
pub fn ser_get_user_policy_input_input_input(input: &crate::operation::get_user_policy::GetUserPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
