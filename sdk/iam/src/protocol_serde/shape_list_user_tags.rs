...
pub fn de_list_user_tags_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListUserTagsOutput, crate::error::ListUserTagsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListUserTagsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_user_tags_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListUserTagsOutput, crate::error::ListUserTagsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_user_tags_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_user_tags::de_list_user_tags(response.body().as_ref(), output).map_err(crate::error::ListUserTagsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_user_tags(inp: &[u8], mut builder: crate::output::list_user_tags_output::Builder) -> Result<crate::output::list_user_tags_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
