...
pub fn de_list_user_tags_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_user_tags::ListUserTagsOutput, crate::operation::list_user_tags::ListUserTagsError> {
    #[allow(unused_mut)]
...
pub fn de_list_user_tags_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_user_tags_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_user_tags::ListUserTagsError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_user_tags::builders::ListUserTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
