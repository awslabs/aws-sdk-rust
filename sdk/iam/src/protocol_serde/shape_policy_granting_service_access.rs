...
pub fn de_policy_granting_service_access(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PolicyGrantingServiceAccess, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("PolicyType") /* PolicyType com.amazonaws.iam#PolicyGrantingServiceAccess$PolicyType */ =>  {
                let var_2 =
                    Some(
                        Result::<crate::model::PolicyType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
            ...
            s if s.matches("EntityType") /* EntityType com.amazonaws.iam#PolicyGrantingServiceAccess$EntityType */ =>  {
                let var_4 =
                    Some(
                        Result::<crate::model::PolicyOwnerEntityType, aws_smithy_xml::decode::XmlDecodeError>::Ok(
