...
pub fn ser_list_roles_input_input_input(input: &crate::operation::list_roles::ListRolesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
