...
pub fn de_managed_policy_detail(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ManagedPolicyDetail, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
