...
pub fn ser_list_user_policies_input_input(input: &crate::input::ListUserPoliciesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
