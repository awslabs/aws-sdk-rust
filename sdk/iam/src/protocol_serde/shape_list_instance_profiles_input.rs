...
pub fn ser_list_instance_profiles_input_input(input: &crate::operation::list_instance_profiles::ListInstanceProfilesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
