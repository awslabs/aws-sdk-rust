...
pub fn ser_list_group_policies_input_input(input: &crate::input::ListGroupPoliciesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
