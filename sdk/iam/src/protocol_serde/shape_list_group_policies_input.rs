...
pub fn ser_list_group_policies_input_input_input(input: &crate::operation::list_group_policies::ListGroupPoliciesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
