...
pub fn de_eval_decision_details_type(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>, aws_smithy_xml::decode::XmlDecodeError> {
...
pub fn de_eval_decision_details_type_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder, out: &mut std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>) -> Result<(), aws_smithy_xml::decode::XmlDecodeError> {
