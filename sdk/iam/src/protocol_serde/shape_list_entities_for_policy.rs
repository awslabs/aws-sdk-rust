...
pub fn de_list_entities_for_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListEntitiesForPolicyOutput, crate::error::ListEntitiesForPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListEntitiesForPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_entities_for_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListEntitiesForPolicyOutput, crate::error::ListEntitiesForPolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_entities_for_policy_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_entities_for_policy::de_list_entities_for_policy(response.body().as_ref(), output).map_err(crate::error::ListEntitiesForPolicyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_entities_for_policy(inp: &[u8], mut builder: crate::output::list_entities_for_policy_output::Builder) -> Result<crate::output::list_entities_for_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
