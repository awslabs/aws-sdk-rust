...
pub fn ser_list_policy_versions_input_input_input(input: &crate::operation::list_policy_versions::ListPolicyVersionsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
