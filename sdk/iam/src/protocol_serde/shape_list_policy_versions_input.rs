...
pub fn ser_list_policy_versions_input_input(input: &crate::operation::list_policy_versions::ListPolicyVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
