...
pub fn ser_list_policy_versions_input_input(input: &crate::input::ListPolicyVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
