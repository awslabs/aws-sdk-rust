...
pub fn ser_update_role_input_input(input: &crate::input::UpdateRoleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
