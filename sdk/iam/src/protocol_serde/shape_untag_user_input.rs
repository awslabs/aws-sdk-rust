...
pub fn ser_untag_user_input_input(input: &crate::input::UntagUserInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
