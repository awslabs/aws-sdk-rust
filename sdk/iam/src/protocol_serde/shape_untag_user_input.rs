...
pub fn ser_untag_user_input_input(input: &crate::operation::untag_user::UntagUserInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
