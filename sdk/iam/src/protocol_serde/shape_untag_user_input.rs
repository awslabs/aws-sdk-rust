...
pub fn ser_untag_user_input_input_input(input: &crate::operation::untag_user::UntagUserInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
