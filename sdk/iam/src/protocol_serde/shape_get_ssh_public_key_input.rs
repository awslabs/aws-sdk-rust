...
pub fn ser_get_ssh_public_key_input_input_input(input: &crate::operation::get_ssh_public_key::GetSshPublicKeyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
