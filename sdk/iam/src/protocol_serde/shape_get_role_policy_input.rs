...
pub fn ser_get_role_policy_input_input_input(input: &crate::operation::get_role_policy::GetRolePolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
