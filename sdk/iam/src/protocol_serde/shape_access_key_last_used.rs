...
pub fn de_access_key_last_used(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessKeyLastUsed, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
