...
pub fn ser_list_users_input_input_input(input: &crate::operation::list_users::ListUsersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
