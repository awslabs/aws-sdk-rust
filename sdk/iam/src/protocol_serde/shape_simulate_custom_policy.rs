...
pub fn de_simulate_custom_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SimulateCustomPolicyOutput, crate::error::SimulateCustomPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::SimulateCustomPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_simulate_custom_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SimulateCustomPolicyOutput, crate::error::SimulateCustomPolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::simulate_custom_policy_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_simulate_custom_policy::de_simulate_custom_policy(response.body().as_ref(), output).map_err(crate::error::SimulateCustomPolicyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_simulate_custom_policy(inp: &[u8], mut builder: crate::output::simulate_custom_policy_output::Builder) -> Result<crate::output::simulate_custom_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
