...
pub fn de_delete_open_id_connect_provider_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderOutput, crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProviderError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_open_id_connect_provider_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_open_id_connect_provider::DeleteOpenIdConnectProviderOutput, crate::operation::delete_open_id_connect_provider::DeleteOpenIDConnectProviderError> {
    Ok({
        #[allow(unused_mut)]
