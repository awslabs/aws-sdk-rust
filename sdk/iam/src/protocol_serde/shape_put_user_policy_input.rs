...
pub fn ser_put_user_policy_input_input(input: &crate::operation::put_user_policy::PutUserPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
