...
pub fn ser_put_user_policy_input_input_input(input: &crate::operation::put_user_policy::PutUserPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
