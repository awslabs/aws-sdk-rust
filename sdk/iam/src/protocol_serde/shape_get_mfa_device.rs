...
pub fn de_get_mfa_device_http_error(
...
> {
    ...
    .map_err(crate::operation::get_mfa_device::GetMFADeviceError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_mfa_device::GetMFADeviceError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "NoSuchEntity" => {
            crate::operation::get_mfa_device::GetMFADeviceError::NoSuchEntityException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceFailure" => {
            crate::operation::get_mfa_device::GetMFADeviceError::ServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_mfa_device_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_mfa_device::de_get_mfa_device(_response_body, output)
                .map_err(crate::operation::get_mfa_device::GetMFADeviceError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("GetMFADeviceResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetMFADeviceResponse got {:?}",
            start_el
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetMFADeviceResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetMFADeviceResult got {:?}",
                start_el
            )));
        }
        ...
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(
            "expected GetMFADeviceResult tag",
        ));
    };
    Ok(builder)
}
