...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_key_last_used_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_access_key_last_used::de_get_access_key_last_used(_response_body, output)
            .map_err(crate::operation::get_access_key_last_used::GetAccessKeyLastUsedError::unhandled)?;
...
) -> Result<crate::operation::get_access_key_last_used::builders::GetAccessKeyLastUsedOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
