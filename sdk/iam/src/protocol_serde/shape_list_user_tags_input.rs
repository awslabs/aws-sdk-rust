...
pub fn ser_list_user_tags_input_input(input: &crate::input::ListUserTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
