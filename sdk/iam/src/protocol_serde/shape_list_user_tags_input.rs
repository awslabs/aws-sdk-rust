...
pub fn ser_list_user_tags_input_input_input(input: &crate::operation::list_user_tags::ListUserTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
