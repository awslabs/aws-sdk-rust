...
pub fn ser_tag_server_certificate_input_input_input(input: &crate::operation::tag_server_certificate::TagServerCertificateInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
