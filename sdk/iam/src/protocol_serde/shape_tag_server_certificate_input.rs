...
pub fn ser_tag_server_certificate_input_input(input: &crate::operation::tag_server_certificate::TagServerCertificateInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
