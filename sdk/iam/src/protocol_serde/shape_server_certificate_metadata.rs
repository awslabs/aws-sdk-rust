...
pub fn de_server_certificate_metadata(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServerCertificateMetadata, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
