...
pub fn de_simulate_principal_policy_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_simulate_principal_policy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError> {
    Ok({
        #[allow(unused_mut)]
