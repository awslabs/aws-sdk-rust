...
pub fn de_simulate_principal_policy_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_simulate_principal_policy_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError> {
    Ok({
        #[allow(unused_mut)]
