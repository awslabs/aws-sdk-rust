...
pub fn de_access_key_metadata(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessKeyMetadata, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
