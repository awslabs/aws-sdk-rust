...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_saml_provider_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_saml_provider::GetSamlProviderOutput, crate::operation::get_saml_provider::GetSAMLProviderError> {
...
) -> Result<crate::operation::get_saml_provider::builders::GetSamlProviderOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
