...
pub fn de_get_saml_provider_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_saml_provider::GetSamlProviderOutput, crate::operation::get_saml_provider::GetSAMLProviderError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_saml_provider::GetSAMLProviderError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_saml_provider_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_saml_provider::GetSamlProviderOutput, crate::operation::get_saml_provider::GetSAMLProviderError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_saml_provider::builders::GetSamlProviderOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_saml_provider::de_get_saml_provider(response.body().as_ref(), output).map_err(crate::operation::get_saml_provider::GetSAMLProviderError::unhandled)?;
