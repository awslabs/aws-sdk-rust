...
pub fn de_get_saml_provider_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSamlProviderOutput, crate::error::GetSAMLProviderError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetSAMLProviderError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_saml_provider_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetSamlProviderOutput, crate::error::GetSAMLProviderError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_saml_provider_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_saml_provider::de_get_saml_provider(response.body().as_ref(), output).map_err(crate::error::GetSAMLProviderError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_saml_provider(inp: &[u8], mut builder: crate::output::get_saml_provider_output::Builder) -> Result<crate::output::get_saml_provider_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
