...
pub fn ser_get_policy_version_input_input_input(input: &crate::operation::get_policy_version::GetPolicyVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
