...
#[allow(unused_mut)]
pub fn de_get_policy(inp: &[u8], mut builder: crate::output::get_policy_output::Builder) -> Result<crate::output::get_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
