...
pub fn de_remove_user_from_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::remove_user_from_group::RemoveUserFromGroupOutput, crate::operation::remove_user_from_group::RemoveUserFromGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::remove_user_from_group::RemoveUserFromGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_user_from_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::remove_user_from_group::RemoveUserFromGroupOutput, crate::operation::remove_user_from_group::RemoveUserFromGroupError> {
    Ok({
        #[allow(unused_mut)]
