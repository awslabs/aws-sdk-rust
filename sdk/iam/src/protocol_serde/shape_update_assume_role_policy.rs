...
pub fn de_update_assume_role_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateAssumeRolePolicyOutput, crate::error::UpdateAssumeRolePolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateAssumeRolePolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_assume_role_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateAssumeRolePolicyOutput, crate::error::UpdateAssumeRolePolicyError> {
    Ok({
        #[allow(unused_mut)]
