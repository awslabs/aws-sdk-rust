...
pub fn de_create_role_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_role_output_correct_errors(output).build()
    })
}
...
) -> Result<crate::operation::create_role::builders::CreateRoleOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
