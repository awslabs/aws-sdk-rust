...
pub fn de_service_specific_credential(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServiceSpecificCredential, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
