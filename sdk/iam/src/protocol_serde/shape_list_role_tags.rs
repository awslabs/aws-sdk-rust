...
pub fn de_list_role_tags_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRoleTagsOutput, crate::error::ListRoleTagsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListRoleTagsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_role_tags_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRoleTagsOutput, crate::error::ListRoleTagsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_role_tags_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_role_tags::de_list_role_tags(response.body().as_ref(), output).map_err(crate::error::ListRoleTagsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_role_tags(inp: &[u8], mut builder: crate::output::list_role_tags_output::Builder) -> Result<crate::output::list_role_tags_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
