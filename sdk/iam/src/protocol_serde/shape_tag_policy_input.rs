...
pub fn ser_tag_policy_input_input(input: &crate::input::TagPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
