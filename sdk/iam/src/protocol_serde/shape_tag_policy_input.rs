...
pub fn ser_tag_policy_input_input_input(input: &crate::operation::tag_policy::TagPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
