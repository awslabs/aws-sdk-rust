    ...
    Err(match error_code {
        "NoSuchEntity" => crate::error::DeleteSSHPublicKeyError::NoSuchEntityException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_no_such_entity_exception::de_no_such_entity_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::DeleteSSHPublicKeyError::unhandled)?;
