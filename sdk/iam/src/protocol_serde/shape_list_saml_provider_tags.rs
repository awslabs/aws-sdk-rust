...
> {
    Ok({
        ...
        crate::serde_util::list_saml_provider_tags_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_saml_provider_tags::builders::ListSamlProviderTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
