...
pub fn de_list_saml_provider_tags_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_saml_provider_tags::ListSamlProviderTagsOutput, crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_saml_provider_tags_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_saml_provider_tags::ListSamlProviderTagsOutput, crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_saml_provider_tags::builders::ListSamlProviderTagsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_saml_provider_tags::de_list_saml_provider_tags(response.body().as_ref(), output).map_err(crate::operation::list_saml_provider_tags::ListSAMLProviderTagsError::unhandled)?;
