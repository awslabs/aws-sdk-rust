...
pub fn ser_list_server_certificate_tags_input_input(input: &crate::operation::list_server_certificate_tags::ListServerCertificateTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
