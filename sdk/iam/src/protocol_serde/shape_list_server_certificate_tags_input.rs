...
pub fn ser_list_server_certificate_tags_input_input_input(input: &crate::operation::list_server_certificate_tags::ListServerCertificateTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
