...
pub fn ser_put_role_policy_input_input_input(input: &crate::operation::put_role_policy::PutRolePolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
