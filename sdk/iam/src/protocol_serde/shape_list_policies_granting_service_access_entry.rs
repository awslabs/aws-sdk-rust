...
pub fn de_list_policies_granting_service_access_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ListPoliciesGrantingServiceAccessEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
