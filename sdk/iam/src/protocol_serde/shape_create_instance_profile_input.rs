...
pub fn ser_create_instance_profile_input_input(input: &crate::input::CreateInstanceProfileInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
