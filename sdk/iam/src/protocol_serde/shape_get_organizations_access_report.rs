...
pub fn de_get_organizations_access_report_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_organizations_access_report::GetOrganizationsAccessReportOutput, crate::operation::get_organizations_access_report::GetOrganizationsAccessReportError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_organizations_access_report_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_organizations_access_report::GetOrganizationsAccessReportOutput, crate::operation::get_organizations_access_report::GetOrganizationsAccessReportError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::get_organizations_access_report_output_output_correct_errors(output).build().map_err(crate::operation::get_organizations_access_report::GetOrganizationsAccessReportError::unhandled)?
    })
}
