...
pub fn ser_create_policy_input_input_input(input: &crate::operation::create_policy::CreatePolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
