...
pub fn de_list_mfa_devices_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_mfa_devices::ListMfaDevicesOutput, crate::operation::list_mfa_devices::ListMFADevicesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_mfa_devices_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_mfa_devices::ListMfaDevicesOutput, crate::operation::list_mfa_devices::ListMFADevicesError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::list_mfa_devices_output_output_correct_errors(output).build().map_err(crate::operation::list_mfa_devices::ListMFADevicesError::unhandled)?
    })
}
