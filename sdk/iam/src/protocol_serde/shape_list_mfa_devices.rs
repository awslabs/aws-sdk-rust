...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_mfa_devices_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_mfa_devices::ListMfaDevicesOutput, crate::operation::list_mfa_devices::ListMFADevicesError> {
    Ok({
        #[allow(unused_mut)]
