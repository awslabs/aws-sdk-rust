...
pub fn ser_list_role_tags_input_input(input: &crate::operation::list_role_tags::ListRoleTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
