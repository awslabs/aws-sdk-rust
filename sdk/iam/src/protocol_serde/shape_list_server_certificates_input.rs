...
pub fn ser_list_server_certificates_input_input(input: &crate::input::ListServerCertificatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
