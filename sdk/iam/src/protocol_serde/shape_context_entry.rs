...
#[allow(unused_mut)]
pub fn ser_context_entry(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::ContextEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
