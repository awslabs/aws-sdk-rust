...
#[allow(unused_mut)]
pub fn ser_context_entry(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::ContextEntry) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
