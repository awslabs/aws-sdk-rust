...
pub fn ser_simulate_principal_policy_input_input(input: &crate::input::SimulatePrincipalPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
