...
pub fn ser_list_policy_tags_input_input_input(input: &crate::operation::list_policy_tags::ListPolicyTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
