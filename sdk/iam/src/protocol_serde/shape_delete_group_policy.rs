...
pub fn de_delete_group_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_group_policy::DeleteGroupPolicyOutput, crate::operation::delete_group_policy::DeleteGroupPolicyError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_group_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_group_policy::DeleteGroupPolicyOutput, crate::operation::delete_group_policy::DeleteGroupPolicyError>
