...
pub fn ser_list_open_id_connect_provider_tags_input_input(input: &crate::input::ListOpenIdConnectProviderTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
