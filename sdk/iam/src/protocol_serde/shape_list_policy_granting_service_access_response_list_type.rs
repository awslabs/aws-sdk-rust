...
pub fn de_list_policy_granting_service_access_response_list_type(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ListPoliciesGrantingServiceAccessEntry>, aws_smithy_xml::decode::XmlDecodeError> {
