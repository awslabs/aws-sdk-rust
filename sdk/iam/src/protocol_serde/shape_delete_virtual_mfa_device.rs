...
pub fn de_delete_virtual_mfa_device_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceOutput, crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_virtual_mfa_device_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_virtual_mfa_device::DeleteVirtualMfaDeviceOutput, crate::operation::delete_virtual_mfa_device::DeleteVirtualMFADeviceError> {
    Ok({
        #[allow(unused_mut)]
