...
pub fn de_list_user_policies_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_user_policies::ListUserPoliciesOutput, crate::operation::list_user_policies::ListUserPoliciesError> {
    #[allow(unused_mut)]
...
pub fn de_list_user_policies_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_user_policies_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_user_policies::ListUserPoliciesError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_user_policies::builders::ListUserPoliciesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
