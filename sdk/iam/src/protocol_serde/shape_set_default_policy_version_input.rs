...
pub fn ser_set_default_policy_version_input_input_input(input: &crate::operation::set_default_policy_version::SetDefaultPolicyVersionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
