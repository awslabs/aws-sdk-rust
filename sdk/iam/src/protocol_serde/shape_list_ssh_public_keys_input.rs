...
pub fn ser_list_ssh_public_keys_input_input_input(input: &crate::operation::list_ssh_public_keys::ListSshPublicKeysInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
