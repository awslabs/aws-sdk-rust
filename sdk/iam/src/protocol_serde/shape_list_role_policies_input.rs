...
pub fn ser_list_role_policies_input_input(input: &crate::operation::list_role_policies::ListRolePoliciesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
