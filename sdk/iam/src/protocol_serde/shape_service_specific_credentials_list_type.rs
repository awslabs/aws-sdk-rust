...
pub fn de_service_specific_credentials_list_type(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::ServiceSpecificCredentialMetadata>, aws_smithy_xml::decode::XmlDecodeError> {
