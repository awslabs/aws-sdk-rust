...
pub fn ser_tag_role_input_input_input(input: &crate::operation::tag_role::TagRoleInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
