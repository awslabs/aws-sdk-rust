...
pub fn ser_enable_mfa_device_input_input(input: &crate::operation::enable_mfa_device::EnableMfaDeviceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
