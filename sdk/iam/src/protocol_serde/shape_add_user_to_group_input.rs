...
pub fn ser_add_user_to_group_input_input(input: &crate::operation::add_user_to_group::AddUserToGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
