...
pub fn ser_list_attached_user_policies_input_input_input(input: &crate::operation::list_attached_user_policies::ListAttachedUserPoliciesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
