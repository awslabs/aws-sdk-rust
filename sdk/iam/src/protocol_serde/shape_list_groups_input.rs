...
pub fn ser_list_groups_input_input_input(input: &crate::operation::list_groups::ListGroupsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
