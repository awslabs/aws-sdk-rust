...
pub fn ser_list_groups_input_input(input: &crate::input::ListGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
