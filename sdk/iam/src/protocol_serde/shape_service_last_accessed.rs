...
pub fn de_service_last_accessed(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServiceLastAccessed, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
