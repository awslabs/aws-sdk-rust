...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_attached_user_policies::ListAttachedUserPoliciesError::unhandled(
                generic,
            ))
        }
    };
...
) -> Result<crate::operation::list_attached_user_policies::builders::ListAttachedUserPoliciesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
