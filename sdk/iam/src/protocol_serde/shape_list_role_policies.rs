...
pub fn de_list_role_policies_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_role_policies::ListRolePoliciesOutput, crate::operation::list_role_policies::ListRolePoliciesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_role_policies_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_role_policies::ListRolePoliciesOutput, crate::operation::list_role_policies::ListRolePoliciesError> {
...
) -> Result<crate::operation::list_role_policies::builders::ListRolePoliciesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
