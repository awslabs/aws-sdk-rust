...
pub fn de_tracked_action_last_accessed(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TrackedActionLastAccessed, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
