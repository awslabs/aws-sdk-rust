...
pub fn ser_list_attached_role_policies_input_input(input: &crate::input::ListAttachedRolePoliciesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
