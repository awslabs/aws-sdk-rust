...
pub fn de_update_signing_certificate_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_signing_certificate::UpdateSigningCertificateOutput, crate::operation::update_signing_certificate::UpdateSigningCertificateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::update_signing_certificate::UpdateSigningCertificateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_signing_certificate_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_signing_certificate::UpdateSigningCertificateOutput, crate::operation::update_signing_certificate::UpdateSigningCertificateError> {
    Ok({
        #[allow(unused_mut)]
