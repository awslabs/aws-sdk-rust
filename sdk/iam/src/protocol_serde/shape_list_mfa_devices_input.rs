...
pub fn ser_list_mfa_devices_input_input(input: &crate::operation::list_mfa_devices::ListMfaDevicesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
