...
pub fn ser_create_saml_provider_input_input(input: &crate::input::CreateSamlProviderInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
