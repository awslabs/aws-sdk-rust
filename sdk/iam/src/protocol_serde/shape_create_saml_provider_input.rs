...
pub fn ser_create_saml_provider_input_input_input(input: &crate::operation::create_saml_provider::CreateSamlProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
