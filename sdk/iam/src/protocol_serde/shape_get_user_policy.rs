...
pub fn de_get_user_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetUserPolicyOutput, crate::error::GetUserPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetUserPolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_user_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetUserPolicyOutput, crate::error::GetUserPolicyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_user_policy_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_user_policy::de_get_user_policy(response.body().as_ref(), output).map_err(crate::error::GetUserPolicyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_user_policy(inp: &[u8], mut builder: crate::output::get_user_policy_output::Builder) -> Result<crate::output::get_user_policy_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
