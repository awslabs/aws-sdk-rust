...
pub fn de_get_user_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_user_policy::GetUserPolicyOutput, crate::operation::get_user_policy::GetUserPolicyError> {
    #[allow(unused_mut)]
...
pub fn de_get_user_policy(
    ...
    if !(start_el.matches("GetUserPolicyResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected GetUserPolicyResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("GetUserPolicyResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected GetUserPolicyResult got {start_el:?}"
            )));
        }
