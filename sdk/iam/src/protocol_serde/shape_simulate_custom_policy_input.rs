...
pub fn ser_simulate_custom_policy_input_input(input: &crate::input::SimulateCustomPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
