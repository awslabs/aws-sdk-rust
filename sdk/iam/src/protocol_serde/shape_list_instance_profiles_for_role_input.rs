...
pub fn ser_list_instance_profiles_for_role_input_input(input: &crate::input::ListInstanceProfilesForRoleInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
