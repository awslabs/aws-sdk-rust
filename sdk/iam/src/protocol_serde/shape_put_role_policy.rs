...
pub fn de_put_role_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_role_policy::PutRolePolicyOutput, crate::operation::put_role_policy::PutRolePolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_role_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_role_policy::PutRolePolicyOutput, crate::operation::put_role_policy::PutRolePolicyError> {
