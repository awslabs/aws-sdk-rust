...
pub fn ser_get_group_policy_input_input(input: &crate::operation::get_group_policy::GetGroupPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
