...
pub fn ser_get_group_policy_input_input_input(input: &crate::operation::get_group_policy::GetGroupPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
