...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_account_password_policy::GetAccountPasswordPolicyError::unhandled(
                generic,
            ))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_account_password_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::get_account_password_policy::builders::GetAccountPasswordPolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
