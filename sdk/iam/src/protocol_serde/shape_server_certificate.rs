...
pub fn de_server_certificate(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServerCertificate, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
