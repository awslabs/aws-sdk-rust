...
pub fn de_create_access_key_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateAccessKeyOutput, crate::error::CreateAccessKeyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CreateAccessKeyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_access_key_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateAccessKeyOutput, crate::error::CreateAccessKeyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::create_access_key_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_access_key::de_create_access_key(response.body().as_ref(), output).map_err(crate::error::CreateAccessKeyError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_access_key(inp: &[u8], mut builder: crate::output::create_access_key_output::Builder) -> Result<crate::output::create_access_key_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
