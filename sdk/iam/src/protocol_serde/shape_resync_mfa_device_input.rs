...
pub fn ser_resync_mfa_device_input_input(input: &crate::input::ResyncMfaDeviceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
