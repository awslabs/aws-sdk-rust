...
pub fn ser_resync_mfa_device_input_input_input(input: &crate::operation::resync_mfa_device::ResyncMfaDeviceInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
