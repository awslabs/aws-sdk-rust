...
pub fn ser_list_instance_profile_tags_input_input(input: &crate::input::ListInstanceProfileTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
