...
pub fn ser_list_instance_profile_tags_input_input_input(input: &crate::operation::list_instance_profile_tags::ListInstanceProfileTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
