...
pub fn ser_tag_saml_provider_input_input_input(input: &crate::operation::tag_saml_provider::TagSamlProviderInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
