...
pub fn ser_delete_user_policy_input_input(input: &crate::input::DeleteUserPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
