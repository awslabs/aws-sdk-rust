...
pub fn de_list_instance_profile_tags_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_instance_profile_tags::ListInstanceProfileTagsOutput, crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_instance_profile_tags_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_instance_profile_tags::ListInstanceProfileTagsOutput, crate::operation::list_instance_profile_tags::ListInstanceProfileTagsError> {
    Ok({
        #[allow(unused_mut)]
