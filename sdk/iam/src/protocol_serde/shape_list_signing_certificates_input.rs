...
pub fn ser_list_signing_certificates_input_input(input: &crate::input::ListSigningCertificatesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
