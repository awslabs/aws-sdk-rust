...
pub fn de_service_specific_credential_metadata(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ServiceSpecificCredentialMetadata, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::ServiceSpecificCredentialMetadata::builder();
    ...
    Ok(crate::serde_util::service_specific_credential_metadata_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
