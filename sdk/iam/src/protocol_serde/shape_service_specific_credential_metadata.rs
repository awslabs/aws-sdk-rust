...
pub fn de_service_specific_credential_metadata(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServiceSpecificCredentialMetadata, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
