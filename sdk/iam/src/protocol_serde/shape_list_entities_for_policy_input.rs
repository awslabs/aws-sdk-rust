...
pub fn ser_list_entities_for_policy_input_input_input(input: &crate::operation::list_entities_for_policy::ListEntitiesForPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
