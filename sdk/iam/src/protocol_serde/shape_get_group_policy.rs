...
pub fn de_get_group_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_group_policy::GetGroupPolicyOutput, crate::operation::get_group_policy::GetGroupPolicyError> {
    #[allow(unused_mut)]
...
pub fn de_get_group_policy_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_group_policy_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_group_policy::GetGroupPolicyError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_group_policy::builders::GetGroupPolicyOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
