...
pub fn de_list_policy_tags_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_policy_tags_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_policy_tags::ListPolicyTagsError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_policy_tags::builders::ListPolicyTagsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
