...
pub fn de_generate_credential_report_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::generate_credential_report::GenerateCredentialReportOutput, crate::operation::generate_credential_report::GenerateCredentialReportError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_generate_credential_report_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::generate_credential_report::GenerateCredentialReportOutput, crate::operation::generate_credential_report::GenerateCredentialReportError> {
    Ok({
        #[allow(unused_mut)]
