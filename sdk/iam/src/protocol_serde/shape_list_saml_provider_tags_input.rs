...
pub fn ser_list_saml_provider_tags_input_input_input(input: &crate::operation::list_saml_provider_tags::ListSamlProviderTagsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
