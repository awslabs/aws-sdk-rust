...
pub fn ser_list_saml_provider_tags_input_input(input: &crate::input::ListSamlProviderTagsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
