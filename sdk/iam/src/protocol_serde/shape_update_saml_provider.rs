...
pub fn de_update_saml_provider_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_saml_provider::UpdateSamlProviderOutput, crate::operation::update_saml_provider::UpdateSAMLProviderError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::update_saml_provider::UpdateSAMLProviderError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_saml_provider_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_saml_provider::UpdateSamlProviderOutput, crate::operation::update_saml_provider::UpdateSAMLProviderError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_saml_provider::builders::UpdateSamlProviderOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_saml_provider::de_update_saml_provider(response.body().as_ref(), output).map_err(crate::operation::update_saml_provider::UpdateSAMLProviderError::unhandled)?;
