...
pub fn de_attach_role_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::attach_role_policy::AttachRolePolicyOutput, crate::operation::attach_role_policy::AttachRolePolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::attach_role_policy::AttachRolePolicyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_role_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::attach_role_policy::AttachRolePolicyOutput, crate::operation::attach_role_policy::AttachRolePolicyError> {
    Ok({
        #[allow(unused_mut)]
