...
pub fn de_attach_role_policy_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::attach_role_policy::AttachRolePolicyOutput, crate::operation::attach_role_policy::AttachRolePolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_role_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::attach_role_policy::AttachRolePolicyOutput, crate::operation::attach_role_policy::AttachRolePolicyError> {
