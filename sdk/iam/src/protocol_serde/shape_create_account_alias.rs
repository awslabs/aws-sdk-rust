...
pub fn de_create_account_alias_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_account_alias::CreateAccountAliasOutput, crate::operation::create_account_alias::CreateAccountAliasError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_account_alias_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_account_alias::CreateAccountAliasOutput, crate::operation::create_account_alias::CreateAccountAliasError> {
    Ok({
        #[allow(unused_mut)]
