...
pub fn ser_list_groups_for_user_input_input(input: &crate::input::ListGroupsForUserInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
