...
pub fn ser_get_group_input_input(input: &crate::input::GetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
