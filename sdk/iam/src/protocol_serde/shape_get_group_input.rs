...
pub fn ser_get_group_input_input_input(input: &crate::operation::get_group::GetGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
