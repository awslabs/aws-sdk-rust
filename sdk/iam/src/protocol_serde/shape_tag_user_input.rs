...
pub fn ser_tag_user_input_input_input(input: &crate::operation::tag_user::TagUserInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
