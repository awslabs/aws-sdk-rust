...
pub fn de_saml_provider_list_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SamlProviderListEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
