...
pub fn ser_put_group_policy_input_input(input: &crate::input::PutGroupPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
