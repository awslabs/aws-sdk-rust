...
pub fn ser_put_group_policy_input_input_input(input: &crate::operation::put_group_policy::PutGroupPolicyInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
