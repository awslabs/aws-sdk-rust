...
pub fn ser_untag_policy_input_input(input: &crate::operation::untag_policy::UntagPolicyInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
