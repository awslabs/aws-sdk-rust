...
pub struct SshPublicKey  {
    ...
    #[doc(hidden)]pub upload_date: std::option::Option<aws_smithy_types::DateTime>,
}
impl SshPublicKey {
    /// <p>The name of the IAM user associated with the SSH public key.</p>
...
pub struct SigningCertificate  {
    ...
    #[doc(hidden)]pub certificate_body: std::option::Option<std::string::String>,
...
pub struct ServerCertificateMetadata  {
    ...
    #[doc(hidden)]pub server_certificate_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub server_certificate_id: std::option::Option<std::string::String>,
...
pub struct Role  {
    ...
    #[doc(hidden)]pub role_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub assume_role_policy_document: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub max_session_duration: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub permissions_boundary: std::option::Option<crate::model::AttachedPermissionsBoundary>,
    ...
    #[doc(hidden)]pub role_last_used: std::option::Option<crate::model::RoleLastUsed>,
}
impl Role {
    /// <p> The path to the role. For more information about paths, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i>. </p>
    pub fn path(&self) -> std::option::Option<& str> {
    ...
    /// <p>The ARN of the policy used to set the permissions boundary for the role.</p> 
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    pub fn permissions_boundary(&self) -> std::option::Option<& crate::model::AttachedPermissionsBoundary> {
...
impl  std::fmt::Debug for Role  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("assume_role_policy_document", &self.assume_role_policy_document);
...
pub mod role {
    ...
    pub struct Builder {
        ...
        pub(crate) permissions_boundary: std::option::Option<crate::model::AttachedPermissionsBoundary>,
    ...
    impl Builder {
        ...
        /// <p>The ARN of the policy used to set the permissions boundary for the role.</p> 
        /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
        pub fn permissions_boundary(mut self, input: crate::model::AttachedPermissionsBoundary) -> Self {
            self.permissions_boundary = Some(input);
            self
        }
        /// <p>The ARN of the policy used to set the permissions boundary for the role.</p> 
        /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
        pub fn set_permissions_boundary(mut self, input: std::option::Option<crate::model::AttachedPermissionsBoundary>) -> Self {
        ...
        /// <p>Contains information about the last time that an IAM role was used. This includes the date and time and the Region in which the role was last used. Activity is only reported for the trailing 400 days. This period can be shorter if your Region began supporting these features within the last year. The role might have been used more than 400 days ago. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#access-advisor_tracking-period">Regions where data is tracked</a> in the <i>IAM User Guide</i>.</p>
        pub fn set_role_last_used(mut self, input: std::option::Option<crate::model::RoleLastUsed>) -> Self {
...
pub struct RoleLastUsed  {
    ...
    #[doc(hidden)]pub last_used_date: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct AttachedPermissionsBoundary  {
    ...
    #[doc(hidden)]pub permissions_boundary_type: std::option::Option<crate::model::PermissionsBoundaryAttachmentType>,
    /// <p> The ARN of the policy used to set the permissions boundary for the user or role.</p>
    #[doc(hidden)]pub permissions_boundary_arn: std::option::Option<std::string::String>,
}
impl AttachedPermissionsBoundary {
    /// <p> The permissions boundary usage type that indicates what type of IAM resource is used as the permissions boundary for an entity. This data type can only have a value of <code>Policy</code>.</p>
    pub fn permissions_boundary_type(&self) -> std::option::Option<& crate::model::PermissionsBoundaryAttachmentType> {
...
pub mod attached_permissions_boundary {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) permissions_boundary_type: std::option::Option<crate::model::PermissionsBoundaryAttachmentType>,
        pub(crate) permissions_boundary_arn: std::option::Option<std::string::String>,
    }
    impl Builder {
        /// <p> The permissions boundary usage type that indicates what type of IAM resource is used as the permissions boundary for an entity. This data type can only have a value of <code>Policy</code>.</p>
        pub fn permissions_boundary_type(mut self, input: crate::model::PermissionsBoundaryAttachmentType) -> Self {
            self.permissions_boundary_type = Some(input);
            self
        }
        /// <p> The permissions boundary usage type that indicates what type of IAM resource is used as the permissions boundary for an entity. This data type can only have a value of <code>Policy</code>.</p>
        pub fn set_permissions_boundary_type(mut self, input: std::option::Option<crate::model::PermissionsBoundaryAttachmentType>) -> Self {
...
pub struct EvaluationResult  {
    ...
    #[doc(hidden)]pub eval_action_name: std::option::Option<std::string::String>,
    /// <p>The ARN of the resource that the indicated API operation was tested on.</p>
    #[doc(hidden)]pub eval_resource_name: std::option::Option<std::string::String>,
    /// <p>The result of the simulation.</p>
    #[doc(hidden)]pub eval_decision: std::option::Option<crate::model::PolicyEvaluationDecisionType>,
    ...
    #[doc(hidden)]pub matched_statements: std::option::Option<std::vec::Vec<crate::model::Statement>>,
    ...
    #[doc(hidden)]pub missing_context_values: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub organizations_decision_detail: std::option::Option<crate::model::OrganizationsDecisionDetail>,
    ...
    #[doc(hidden)]pub permissions_boundary_decision_detail: std::option::Option<crate::model::PermissionsBoundaryDecisionDetail>,
    ...
    #[doc(hidden)]pub eval_decision_details: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>>,
    /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
    #[doc(hidden)]pub resource_specific_results: std::option::Option<std::vec::Vec<crate::model::ResourceSpecificResult>>,
}
impl EvaluationResult {
    ...
    /// <p>The result of the simulation.</p>
    pub fn eval_decision(&self) -> std::option::Option<& crate::model::PolicyEvaluationDecisionType> {
    ...
    /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
    pub fn organizations_decision_detail(&self) -> std::option::Option<& crate::model::OrganizationsDecisionDetail> {
        self.organizations_decision_detail.as_ref()
    }
    /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
    pub fn permissions_boundary_decision_detail(&self) -> std::option::Option<& crate::model::PermissionsBoundaryDecisionDetail> {
    ...
    /// <p>When you make a cross-account request, Amazon Web Services evaluates the request in the trusting account and the trusted account. The request is allowed only if both evaluations return <code>true</code>. For more information about how policies are evaluated, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html#policy-eval-basics">Evaluating policies within a single account</a>.</p> 
    /// <p>If an Organizations SCP included in the evaluation denies access, the simulation ends. In this case, policy evaluation does not proceed any further and this parameter is not returned.</p>
    pub fn eval_decision_details(&self) -> std::option::Option<& std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>> {
        self.eval_decision_details.as_ref()
    }
    /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
    pub fn resource_specific_results(&self) -> std::option::Option<& [crate::model::ResourceSpecificResult]> {
...
impl  std::fmt::Debug for EvaluationResult  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("organizations_decision_detail", &self.organizations_decision_detail);
        formatter.field("permissions_boundary_decision_detail", &self.permissions_boundary_decision_detail);
...
pub mod evaluation_result {
    ...
    pub struct Builder {
        ...
        pub(crate) organizations_decision_detail: std::option::Option<crate::model::OrganizationsDecisionDetail>,
        pub(crate) permissions_boundary_decision_detail: std::option::Option<crate::model::PermissionsBoundaryDecisionDetail>,
        pub(crate) eval_decision_details: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>>,
        pub(crate) resource_specific_results: std::option::Option<std::vec::Vec<crate::model::ResourceSpecificResult>>,
    }
    impl Builder {
        /// <p>The name of the API operation tested on the indicated resource.</p>
        ...
        /// <p>The result of the simulation.</p>
        pub fn set_eval_decision(mut self, input: std::option::Option<crate::model::PolicyEvaluationDecisionType>) -> Self {
        ...
        /// <p>A list of the statements in the input policies that determine the result for this scenario. Remember that even if multiple statements allow the operation on the resource, if only one statement denies that operation, then the explicit deny overrides any allow. In addition, the deny statement is the only entry included in the result.</p>
        pub fn set_matched_statements(mut self, input: std::option::Option<std::vec::Vec<crate::model::Statement>>) -> Self {
        ...
        /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
        pub fn organizations_decision_detail(mut self, input: crate::model::OrganizationsDecisionDetail) -> Self {
            self.organizations_decision_detail = Some(input);
            self
        }
        /// <p>A structure that details how Organizations and its service control policies affect the results of the simulation. Only applies if the simulated user's account is part of an organization.</p>
        pub fn set_organizations_decision_detail(mut self, input: std::option::Option<crate::model::OrganizationsDecisionDetail>) -> Self {
            self.organizations_decision_detail = input; self
        }
        /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
        pub fn permissions_boundary_decision_detail(mut self, input: crate::model::PermissionsBoundaryDecisionDetail) -> Self {
            self.permissions_boundary_decision_detail = Some(input);
            self
        }
        /// <p>Contains information about the effect that a permissions boundary has on a policy simulation when the boundary is applied to an IAM entity.</p>
        pub fn set_permissions_boundary_decision_detail(mut self, input: std::option::Option<crate::model::PermissionsBoundaryDecisionDetail>) -> Self {
        ...
        /// <p>When you make a cross-account request, Amazon Web Services evaluates the request in the trusting account and the trusted account. The request is allowed only if both evaluations return <code>true</code>. For more information about how policies are evaluated, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html#policy-eval-basics">Evaluating policies within a single account</a>.</p> 
        /// <p>If an Organizations SCP included in the evaluation denies access, the simulation ends. In this case, policy evaluation does not proceed any further and this parameter is not returned.</p>
        pub fn eval_decision_details(mut self, k: impl Into<std::string::String>, v: crate::model::PolicyEvaluationDecisionType) -> Self {
        ...
        /// <p>When you make a cross-account request, Amazon Web Services evaluates the request in the trusting account and the trusted account. The request is allowed only if both evaluations return <code>true</code>. For more information about how policies are evaluated, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html#policy-eval-basics">Evaluating policies within a single account</a>.</p> 
        /// <p>If an Organizations SCP included in the evaluation denies access, the simulation ends. In this case, policy evaluation does not proceed any further and this parameter is not returned.</p>
        pub fn set_eval_decision_details(mut self, input: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>>) -> Self {
        ...
        ///
        /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
        pub fn resource_specific_results(mut self, input: crate::model::ResourceSpecificResult) -> Self {
        ...
        /// <p>The individual results of the simulation of the API operation specified in EvalActionName on each resource.</p>
        pub fn set_resource_specific_results(mut self, input: std::option::Option<std::vec::Vec<crate::model::ResourceSpecificResult>>) -> Self {
...
pub struct ResourceSpecificResult  {
    ...
    #[doc(hidden)]pub eval_resource_decision: std::option::Option<crate::model::PolicyEvaluationDecisionType>,
...
impl ResourceSpecificResult {
    ...
    /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
    pub fn eval_resource_decision(&self) -> std::option::Option<& crate::model::PolicyEvaluationDecisionType> {
...
pub mod resource_specific_result {
    ...
    pub struct Builder {
        pub(crate) eval_resource_name: std::option::Option<std::string::String>,
        pub(crate) eval_resource_decision: std::option::Option<crate::model::PolicyEvaluationDecisionType>,
        pub(crate) matched_statements: std::option::Option<std::vec::Vec<crate::model::Statement>>,
        pub(crate) missing_context_values: std::option::Option<std::vec::Vec<std::string::String>>,
        pub(crate) eval_decision_details: std::option::Option<std::collections::HashMap<std::string::String, crate::model::PolicyEvaluationDecisionType>>,
        pub(crate) permissions_boundary_decision_detail: std::option::Option<crate::model::PermissionsBoundaryDecisionDetail>,
    ...
    impl Builder {
        ...
        /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
        pub fn eval_resource_decision(mut self, input: crate::model::PolicyEvaluationDecisionType) -> Self {
            self.eval_resource_decision = Some(input);
            self
        }
        /// <p>The result of the simulation of the simulated API operation on the resource specified in <code>EvalResourceName</code>.</p>
        pub fn set_eval_resource_decision(mut self, input: std::option::Option<crate::model::PolicyEvaluationDecisionType>) -> Self {
...
pub struct PermissionsBoundaryDecisionDetail  {
    ...
    #[doc(hidden)]pub allowed_by_permissions_boundary: bool,
}
...
impl  std::fmt::Debug for PermissionsBoundaryDecisionDetail  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("allowed_by_permissions_boundary", &self.allowed_by_permissions_boundary);
        formatter.finish()
    }
}
...
pub struct Statement  {
    ...
    #[doc(hidden)]pub source_policy_id: std::option::Option<std::string::String>,
    /// <p>The type of the policy.</p>
    #[doc(hidden)]pub source_policy_type: std::option::Option<crate::model::PolicySourceType>,
    /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
    #[doc(hidden)]pub start_position: std::option::Option<crate::model::Position>,
    /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
    #[doc(hidden)]pub end_position: std::option::Option<crate::model::Position>,
}
impl Statement {
    /// <p>The identifier of the policy that was provided as an input.</p>
...
pub mod statement {
    ...
    impl Builder {
        ...
        /// <p>The type of the policy.</p>
        pub fn set_source_policy_type(mut self, input: std::option::Option<crate::model::PolicySourceType>) -> Self {
        ...
        /// <p>The row and column of the beginning of the <code>Statement</code> in an IAM policy.</p>
        pub fn set_start_position(mut self, input: std::option::Option<crate::model::Position>) -> Self {
        ...
        /// <p>The row and column of the end of a <code>Statement</code> in an IAM policy.</p>
        pub fn set_end_position(mut self, input: std::option::Option<crate::model::Position>) -> Self {
...
pub struct Position  {
    ...
    #[doc(hidden)]pub line: i32,
    /// <p>The column in the line containing the specified position in the document.</p>
    #[doc(hidden)]pub column: i32,
}
impl Position {
    /// <p>The line containing the specified position in the document.</p>
...
pub struct OrganizationsDecisionDetail  {
    ...
    #[doc(hidden)]pub allowed_by_organizations: bool,
}
...
pub struct ContextEntry  {
    ...
    #[doc(hidden)]pub context_key_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub context_key_values: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The data type of the value (or values) specified in the <code>ContextKeyValues</code> parameter.</p>
    #[doc(hidden)]pub context_key_type: std::option::Option<crate::model::ContextKeyTypeEnum>,
}
impl ContextEntry {
    /// <p>The full name of a condition context key, including the service prefix. For example, <code>aws:SourceIp</code> or <code>s3:VersionId</code>.</p>
...
pub mod context_entry {
    ...
    impl Builder {
        ...
        /// <p>The data type of the value (or values) specified in the <code>ContextKeyValues</code> parameter.</p>
        pub fn set_context_key_type(mut self, input: std::option::Option<crate::model::ContextKeyTypeEnum>) -> Self {
...
pub struct ServiceSpecificCredential  {
    ...
    #[doc(hidden)]pub service_user_name: std::option::Option<std::string::String>,
    /// <p>The generated password for the service-specific credential.</p>
    #[doc(hidden)]pub service_password: std::option::Option<std::string::String>,
    /// <p>The unique identifier for the service-specific credential.</p>
    #[doc(hidden)]pub service_specific_credential_id: std::option::Option<std::string::String>,
...
pub struct VirtualMfaDevice  {
    ...
    #[doc(hidden)]pub base32_string_seed: std::option::Option<aws_smithy_types::Blob>,
    ...
    #[doc(hidden)]pub qr_code_png: std::option::Option<aws_smithy_types::Blob>,
    ...
    #[doc(hidden)]pub enable_date: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct User  {
    ...
    #[doc(hidden)]pub password_last_used: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    #[doc(hidden)]pub permissions_boundary: std::option::Option<crate::model::AttachedPermissionsBoundary>,
...
pub struct ListPoliciesGrantingServiceAccessEntry  {
    ...
    #[doc(hidden)]pub service_namespace: std::option::Option<std::string::String>,
    /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
    #[doc(hidden)]pub policies: std::option::Option<std::vec::Vec<crate::model::PolicyGrantingServiceAccess>>,
}
...
pub mod list_policies_granting_service_access_entry {
    ...
    pub struct Builder {
        ...
        pub(crate) policies: std::option::Option<std::vec::Vec<crate::model::PolicyGrantingServiceAccess>>,
    }
    impl Builder {
        /// <p>The namespace of the service that was accessed.</p> 
        /// <p>To learn the service namespace of a service, see <a href="https://docs.aws.amazon.com/service-authorization/latest/reference/reference_policies_actions-resources-contextkeys.html">Actions, resources, and condition keys for Amazon Web Services services</a> in the <i>Service Authorization Reference</i>. Choose the name of the service to view details for that service. In the first paragraph, find the service prefix. For example, <code>(service prefix: a4b)</code>. For more information about service namespaces, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#genref-aws-service-namespaces">Amazon Web Services service namespaces</a> in the&nbsp;<i>Amazon Web Services General Reference</i>.</p>
        ...
        /// <p>The&nbsp;<code>PoliciesGrantingServiceAccess</code> object that contains details about the policy.</p>
        pub fn set_policies(mut self, input: std::option::Option<std::vec::Vec<crate::model::PolicyGrantingServiceAccess>>) -> Self {
...
pub struct PolicyGrantingServiceAccess  {
    ...
    #[doc(hidden)]pub entity_type: std::option::Option<crate::model::PolicyOwnerEntityType>,
...
pub mod policy_granting_service_access {
    ...
    impl Builder {
        ...
        /// <p>The type of entity (user or role) that used the policy to access the service to which the inline policy is attached.</p> 
        /// <p>This field is null for managed policies. For more information about these policy types, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html">Managed policies and inline policies</a> in the <i>IAM User Guide</i>.</p>
        pub fn set_entity_type(mut self, input: std::option::Option<crate::model::PolicyOwnerEntityType>) -> Self {
...
impl  std::fmt::Debug for Policy  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("permissions_boundary_usage_count", &self.permissions_boundary_usage_count);
...
pub struct InstanceProfile  {
    ...
    #[doc(hidden)]pub instance_profile_id: std::option::Option<std::string::String>,
...
pub struct DeletionTaskFailureReasonType  {
    ...
    #[doc(hidden)]pub role_usage_list: std::option::Option<std::vec::Vec<crate::model::RoleUsageType>>,
}
...
pub mod deletion_task_failure_reason_type {
    ...
    impl Builder {
        ...
        /// <p>A list of objects that contains details about the service-linked role deletion failure, if that information is returned by the service. If the service-linked role has active sessions or if any resources that were used by the role have not been deleted from the linked service, the role can't be deleted. This parameter includes a list of the resources that are associated with the role and the Region in which the resources are being used.</p>
        pub fn set_role_usage_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::RoleUsageType>>) -> Self {
...
pub struct EntityDetails  {
    ...
    #[doc(hidden)]pub entity_info: std::option::Option<crate::model::EntityInfo>,
    ...
    #[doc(hidden)]pub last_authenticated: std::option::Option<aws_smithy_types::DateTime>,
}
impl EntityDetails {
    /// <p>The&nbsp;<code>EntityInfo</code> object that contains details about the entity (user or role).</p>
...
pub mod entity_details {
    ...
    impl Builder {
        ...
        /// <p>The&nbsp;<code>EntityInfo</code> object that contains details about the entity (user or role).</p>
        pub fn set_entity_info(mut self, input: std::option::Option<crate::model::EntityInfo>) -> Self {
...
pub struct EntityInfo  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::PolicyOwnerEntityType>,
...
pub mod entity_info {
    ...
    impl Builder {
        ...
        /// <p>The type of entity (user or role).</p>
        pub fn set_type(mut self, input: std::option::Option<crate::model::PolicyOwnerEntityType>) -> Self {
...
pub struct ServiceLastAccessed  {
    ...
    /// <p>This field is null if no IAM entities attempted to access the service within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>.</p>
    #[doc(hidden)]pub last_authenticated_entity: std::option::Option<std::string::String>,
    ...
    /// <p>This field is null if no IAM entities attempted to access the service within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>.</p>
    #[doc(hidden)]pub last_authenticated_region: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub total_authenticated_entities: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub tracked_actions_last_accessed: std::option::Option<std::vec::Vec<crate::model::TrackedActionLastAccessed>>,
}
impl ServiceLastAccessed {
    ...
    /// <p>An object that contains details about the most recent attempt to access a tracked action within the service.</p> 
    /// <p>This field is null if there no tracked actions or if the principal did not use the tracked actions within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>. This field is also null if the report was generated at the service level and not the action level. For more information, see the <code>Granularity</code> field in <code>GenerateServiceLastAccessedDetails</code>.</p>
    pub fn tracked_actions_last_accessed(&self) -> std::option::Option<& [crate::model::TrackedActionLastAccessed]> {
...
impl  std::fmt::Debug for ServiceLastAccessed  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("total_authenticated_entities", &self.total_authenticated_entities);
        formatter.field("tracked_actions_last_accessed", &self.tracked_actions_last_accessed);
        formatter.finish()
    }
}
...
pub mod service_last_accessed {
    ...
    pub struct Builder {
        ...
        pub(crate) tracked_actions_last_accessed: std::option::Option<std::vec::Vec<crate::model::TrackedActionLastAccessed>>,
    }
    impl Builder {
        /// <p>The name of the service in which access was attempted.</p>
        pub fn service_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>An object that contains details about the most recent attempt to access a tracked action within the service.</p> 
        /// <p>This field is null if there no tracked actions or if the principal did not use the tracked actions within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>. This field is also null if the report was generated at the service level and not the action level. For more information, see the <code>Granularity</code> field in <code>GenerateServiceLastAccessedDetails</code>.</p>
        pub fn tracked_actions_last_accessed(mut self, input: crate::model::TrackedActionLastAccessed) -> Self {
        ...
        /// <p>An object that contains details about the most recent attempt to access a tracked action within the service.</p> 
        /// <p>This field is null if there no tracked actions or if the principal did not use the tracked actions within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>. This field is also null if the report was generated at the service level and not the action level. For more information, see the <code>Granularity</code> field in <code>GenerateServiceLastAccessedDetails</code>.</p>
        pub fn set_tracked_actions_last_accessed(mut self, input: std::option::Option<std::vec::Vec<crate::model::TrackedActionLastAccessed>>) -> Self {
...
pub struct TrackedActionLastAccessed  {
    ...
    /// <p>The Amazon Resource Name (ARN). ARNs are unique identifiers for Amazon Web Services resources.</p> 
    /// <p>For more information about ARNs, go to <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i>. </p>
    #[doc(hidden)]pub last_accessed_entity: std::option::Option<std::string::String>,
    ...
    /// <p>This field is null if no IAM entities attempted to access the service within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>.</p>
    #[doc(hidden)]pub last_accessed_region: std::option::Option<std::string::String>,
}
...
pub struct AccessDetail  {
    ...
    #[doc(hidden)]pub entity_path: std::option::Option<std::string::String>,
    ...
    /// <p>This field is null if no principals in the reported Organizations entity attempted to access the service within the <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_access-advisor.html#service-last-accessed-reporting-period">reporting period</a>.</p>
    #[doc(hidden)]pub last_authenticated_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct LoginProfile  {
    ...
    #[doc(hidden)]pub password_reset_required: bool,
}
impl LoginProfile {
    /// <p>The name of the user, which can be used for signing in to the Amazon Web Services Management Console.</p>
    pub fn user_name(&self) -> std::option::Option<& str> {
...
pub struct PasswordPolicy  {
    ...
    #[doc(hidden)]pub allow_users_to_change_password: bool,
    ...
    #[doc(hidden)]pub expire_passwords: bool,
    /// <p>The number of days that an IAM user password is valid.</p>
    #[doc(hidden)]pub max_password_age: std::option::Option<i32>,
    /// <p>Specifies the number of previous passwords that IAM users are prevented from reusing.</p>
    #[doc(hidden)]pub password_reuse_prevention: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub hard_expiry: std::option::Option<bool>,
}
impl PasswordPolicy {
    /// <p>Minimum length to require for IAM user passwords.</p>
...
impl  std::fmt::Debug for PasswordPolicy  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("require_uppercase_characters", &self.require_uppercase_characters);
        formatter.field("require_lowercase_characters", &self.require_lowercase_characters);
        formatter.field("allow_users_to_change_password", &self.allow_users_to_change_password);
...
pub struct ManagedPolicyDetail  {
    ...
    #[doc(hidden)]pub policy_version_list: std::option::Option<std::vec::Vec<crate::model::PolicyVersion>>,
}
...
pub mod managed_policy_detail {
    ...
    pub struct Builder {
        ...
        pub(crate) create_date: std::option::Option<aws_smithy_types::DateTime>,
        pub(crate) update_date: std::option::Option<aws_smithy_types::DateTime>,
        pub(crate) policy_version_list: std::option::Option<std::vec::Vec<crate::model::PolicyVersion>>,
    }
    impl Builder {
        /// <p>The friendly name (not ARN) identifying the policy.</p>
        pub fn policy_name(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>A list containing information about the versions of the policy.</p>
        pub fn set_policy_version_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::PolicyVersion>>) -> Self {
...
pub struct RoleDetail  {
    ...
    #[doc(hidden)]pub instance_profile_list: std::option::Option<std::vec::Vec<crate::model::InstanceProfile>>,
    /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
    #[doc(hidden)]pub role_policy_list: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>,
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
    #[doc(hidden)]pub attached_managed_policies: std::option::Option<std::vec::Vec<crate::model::AttachedPolicy>>,
    /// <p>The ARN of the policy used to set the permissions boundary for the role.</p> 
    /// <p>For more information about permissions boundaries, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html">Permissions boundaries for IAM identities </a> in the <i>IAM User Guide</i>.</p>
    #[doc(hidden)]pub permissions_boundary: std::option::Option<crate::model::AttachedPermissionsBoundary>,
    /// <p>A list of tags that are attached to the role. For more information about tagging, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html">Tagging IAM resources</a> in the <i>IAM User Guide</i>.</p>
...
impl RoleDetail {
    ...
    /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
    pub fn attached_managed_policies(&self) -> std::option::Option<& [crate::model::AttachedPolicy]> {
...
pub mod role_detail {
    ...
    pub struct Builder {
        ...
        pub(crate) create_date: std::option::Option<aws_smithy_types::DateTime>,
        pub(crate) assume_role_policy_document: std::option::Option<std::string::String>,
        pub(crate) instance_profile_list: std::option::Option<std::vec::Vec<crate::model::InstanceProfile>>,
        pub(crate) role_policy_list: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>,
        pub(crate) attached_managed_policies: std::option::Option<std::vec::Vec<crate::model::AttachedPolicy>>,
        pub(crate) permissions_boundary: std::option::Option<crate::model::AttachedPermissionsBoundary>,
        pub(crate) tags: std::option::Option<std::vec::Vec<crate::model::Tag>>,
        pub(crate) role_last_used: std::option::Option<crate::model::RoleLastUsed>,
    }
    impl Builder {
        ...
        /// <p>A list of instance profiles that contain this role.</p>
        pub fn set_instance_profile_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::InstanceProfile>>) -> Self {
        ...
        /// <p>A list of inline policies embedded in the role. These policies are the role's access (permissions) policies.</p>
        pub fn set_role_policy_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>) -> Self {
        ...
        /// <p>A list of managed policies attached to the role. These policies are the role's access (permissions) policies.</p>
        pub fn set_attached_managed_policies(mut self, input: std::option::Option<std::vec::Vec<crate::model::AttachedPolicy>>) -> Self {
...
pub struct GroupDetail  {
    ...
    #[doc(hidden)]pub group_policy_list: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>,
...
pub mod group_detail {
    ...
    pub struct Builder {
        ...
        pub(crate) arn: std::option::Option<std::string::String>,
        pub(crate) create_date: std::option::Option<aws_smithy_types::DateTime>,
        pub(crate) group_policy_list: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>,
        pub(crate) attached_managed_policies: std::option::Option<std::vec::Vec<crate::model::AttachedPolicy>>,
    }
    impl Builder {
        /// <p>The path to the group. For more information about paths, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html">IAM identifiers</a> in the <i>IAM User Guide</i>.</p>
        ...
        /// <p>A list of the inline policies embedded in the group.</p>
        pub fn set_group_policy_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>) -> Self {
...
pub struct UserDetail  {
    ...
    #[doc(hidden)]pub user_policy_list: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>,
    /// <p>A list of IAM groups that the user is in.</p>
    #[doc(hidden)]pub group_list: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub mod user_detail {
    ...
    impl Builder {
        ...
        /// <p>A list of the inline policies embedded in the user.</p>
        pub fn set_user_policy_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::PolicyDetail>>) -> Self {
