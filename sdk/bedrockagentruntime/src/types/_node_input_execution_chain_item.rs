...
pub struct NodeInputExecutionChainItem {
...
impl NodeInputExecutionChainItem {
    /// <p>The name of the node in the execution chain.</p>
...
impl NodeInputExecutionChainItem {
    /// Creates a new builder-style object to manufacture [`NodeInputExecutionChainItem`](crate::types::NodeInputExecutionChainItem).
    pub fn builder() -> crate::types::builders::NodeInputExecutionChainItemBuilder {
        crate::types::builders::NodeInputExecutionChainItemBuilder::default()
    }
}

/// A builder for [`NodeInputExecutionChainItem`](crate::types::NodeInputExecutionChainItem).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct NodeInputExecutionChainItemBuilder {
...
impl NodeInputExecutionChainItemBuilder {
    /// <p>The name of the node in the execution chain.</p>
    ...
    /// Consumes the builder and constructs a [`NodeInputExecutionChainItem`](crate::types::NodeInputExecutionChainItem).
    /// This method will fail if any of the following fields are not set:
    /// - [`node_name`](crate::types::builders::NodeInputExecutionChainItemBuilder::node_name)
    /// - [`r#type`](crate::types::builders::NodeInputExecutionChainItemBuilder::type)
    pub fn build(self) -> ::std::result::Result<crate::types::NodeInputExecutionChainItem, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::NodeInputExecutionChainItem {
            node_name: self.node_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "node_name",
                    "node_name was not specified but it is required when building NodeInputExecutionChainItem",
                )
            })?,
            index: self.index,
            r#type: self.r#type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "r#type",
                    "r#type was not specified but it is required when building NodeInputExecutionChainItem",
                )
            })?,
        })
    }
