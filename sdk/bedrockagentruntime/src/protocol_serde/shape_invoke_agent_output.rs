...
pub(crate) fn de_content_type_header(
    ...
    let headers = header_map.get_all_bytes("x-amzn-bedrock-agent-content-type");
...
pub(crate) fn de_memory_id_header(
    ...
    let headers = header_map.get_all_bytes("x-amz-bedrock-agent-memory-id");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
...
pub(crate) fn de_session_id_header(
    ...
    let headers = header_map.get_all_bytes("x-amz-bedrock-agent-session-id");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
