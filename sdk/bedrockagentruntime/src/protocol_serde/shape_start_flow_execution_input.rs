...
pub fn ser_start_flow_execution_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::start_flow_execution::StartFlowExecutionInput,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.flow_execution_name {
        object.key("flowExecutionName").string(var_1.as_str());
    }
