...
) -> Result<Option<crate::types::RoutingClassifierTrace>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "invocationInput" => Some(crate::types::RoutingClassifierTrace::InvocationInput(
                            crate::protocol_serde::shape_invocation_input::de_invocation_input(tokens)?.ok_or_else(|| {
                        ...
                        "observation" => Some(crate::types::RoutingClassifierTrace::Observation(
                            crate::protocol_serde::shape_observation::de_observation(tokens)?.ok_or_else(|| {
