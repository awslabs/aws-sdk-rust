...
) -> Result<Option<crate::types::OrchestrationTrace>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "rationale" => Some(crate::types::OrchestrationTrace::Rationale(
                            crate::protocol_serde::shape_rationale::de_rationale(tokens)?.ok_or_else(|| {
