...
pub fn ser_managed_search_bedrock_reranking_configuration(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::ManagedSearchBedrockRerankingConfiguration,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.model_configuration {
        #[allow(unused_mut)]
        let mut object_2 = object.key("modelConfiguration").start_object();
        crate::protocol_serde::shape_managed_search_bedrock_reranking_model_configuration::ser_managed_search_bedrock_reranking_model_configuration(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
