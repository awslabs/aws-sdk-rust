...
pub fn ser_bedrock_session_content_block(
    object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::BedrockSessionContentBlock,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::BedrockSessionContentBlock::Text(inner) => {
            object_3.key("text").string(inner.as_str());
        }
        crate::types::BedrockSessionContentBlock::Image(inner) => {
            #[allow(unused_mut)]
        ...
        crate::types::BedrockSessionContentBlock::Unknown => {
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "text" => Some(crate::types::BedrockSessionContentBlock::Text(
                        ...
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::BedrockSessionContentBlock::Unknown)
                        }
                    };
                }
                other => {
