...
pub(crate) fn check_ingested_document_acl_output_output_correct_errors(
    mut builder: crate::operation::check_ingested_document_acl::builders::CheckIngestedDocumentAclOutputBuilder,
) -> crate::operation::check_ingested_document_acl::builders::CheckIngestedDocumentAclOutputBuilder {
    if builder.has_access.is_none() {
        builder.has_access = Some(Default::default())
    }
    builder
}
...
pub(crate) fn get_ingested_document_acl_output_output_correct_errors(
    mut builder: crate::operation::get_ingested_document_acl::builders::GetIngestedDocumentAclOutputBuilder,
) -> crate::operation::get_ingested_document_acl::builders::GetIngestedDocumentAclOutputBuilder {
    if builder.document_acl.is_none() {
        builder.document_acl = {
            let builder = crate::types::builders::DocumentAclBuilder::default();
            Some(builder.build())
        }
    }
    builder
...
pub(crate) fn document_acl_group_correct_errors(
    mut builder: crate::types::builders::DocumentAclGroupBuilder,
) -> crate::types::builders::DocumentAclGroupBuilder {
    if builder.id.is_none() {
        builder.id = Some(Default::default())
    }
    if builder.r#type.is_none() {
        builder.r#type = "no value was set".parse::<crate::types::DocumentAclMembershipType>().ok()
    }
    builder
}

pub(crate) fn document_acl_user_correct_errors(
    mut builder: crate::types::builders::DocumentAclUserBuilder,
) -> crate::types::builders::DocumentAclUserBuilder {
    if builder.id.is_none() {
        builder.id = Some(Default::default())
    }
    if builder.r#type.is_none() {
