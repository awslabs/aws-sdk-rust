...
pub use crate::operation::retrieve_and_generate::_retrieve_and_generate_output::RetrieveAndGenerateOutputBuilder;

pub use crate::operation::retrieve_and_generate::_retrieve_and_generate_input::RetrieveAndGenerateInputBuilder;
...
impl RetrieveAndGenerateInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.retrieve_and_generate();
...
pub struct RetrieveAndGenerateFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::retrieve_and_generate::RetrieveAndGenerateOutput,
                    crate::operation::retrieve_and_generate::RetrieveAndGenerateError,
                > for RetrieveAndGenerateFluentBuilder
            {
                fn send(
                    self,
...
impl RetrieveAndGenerateFluentBuilder {
    ...
    /// Access the RetrieveAndGenerate as a reference.
    pub fn as_input(&self) -> &crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::retrieve_and_generate::RetrieveAndGenerateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_and_generate::RetrieveAndGenerateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::retrieve_and_generate::RetrieveAndGenerate::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::retrieve_and_generate::RetrieveAndGenerate::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::retrieve_and_generate::RetrieveAndGenerateOutput, crate::operation::retrieve_and_generate::RetrieveAndGenerateError, Self> {
