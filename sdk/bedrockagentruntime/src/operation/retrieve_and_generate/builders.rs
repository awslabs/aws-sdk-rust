...
impl crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateInputBuilder {
...
impl RetrieveAndGenerateFluentBuilder {
    /// Creates a new `RetrieveAndGenerateFluentBuilder`.
