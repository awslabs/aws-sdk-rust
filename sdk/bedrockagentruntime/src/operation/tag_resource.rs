...
impl TagResource {
    ...
    > {
        ...
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            ...
            .instrument(::tracing::debug_span!(
                "bedrockagentruntime.TagResource",
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("bedrockagentruntime", "TagResource", input, runtime_plugins, stop_point)
            .await
    }
