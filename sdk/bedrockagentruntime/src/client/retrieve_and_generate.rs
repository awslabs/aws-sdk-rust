...
impl super::Client {
    ...
    ///   - [`input(RetrieveAndGenerateInput)`](crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateFluentBuilder::input) / [`set_input(Option<RetrieveAndGenerateInput>)`](crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateFluentBuilder::set_input):<br>required: **true**<br><p>Contains the query made to the knowledge base.</p><br>
    ///   - [`retrieve_and_generate_configuration(RetrieveAndGenerateConfiguration)`](crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateFluentBuilder::retrieve_and_generate_configuration) / [`set_retrieve_and_generate_configuration(Option<RetrieveAndGenerateConfiguration>)`](crate::operation::retrieve_and_generate::builders::RetrieveAndGenerateFluentBuilder::set_retrieve_and_generate_configuration):<br>required: **false**<br><p>Contains details about the resource being queried and the foundation model used for generation.</p><br>
