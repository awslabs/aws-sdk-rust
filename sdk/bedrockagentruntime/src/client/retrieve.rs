...
impl super::Client {
    ...
    ///   - [`user_context(UserContext)`](crate::operation::retrieve::builders::RetrieveFluentBuilder::user_context) / [`set_user_context(Option<UserContext>)`](crate::operation::retrieve::builders::RetrieveFluentBuilder::set_user_context):<br>required: **false**<br><p>Contains information about the user making the request. Use this to pass user identity information for access control filtering, so that retrieval results only include documents the user is authorized to access.</p><br>
    ...
    ///   - [`guardrail_action(Option<GuadrailAction>)`](crate::operation::retrieve::RetrieveOutput::guardrail_action): <p>Specifies if there is a guardrail intervention in the response.</p>
