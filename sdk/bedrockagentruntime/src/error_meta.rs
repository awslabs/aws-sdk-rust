...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::invoke_agent::InvokeAgentError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::retrieve_and_generate::RetrieveAndGenerateError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl From<crate::operation::retrieve_and_generate::RetrieveAndGenerateError> for Error {
    fn from(err: crate::operation::retrieve_and_generate::RetrieveAndGenerateError) -> Self {
        match err {
            ...
            crate::operation::retrieve_and_generate::RetrieveAndGenerateError::DependencyFailedException(inner) => Error::DependencyFailedException(inner),
            crate::operation::retrieve_and_generate::RetrieveAndGenerateError::ValidationException(inner) => Error::ValidationException(inner),
            crate::operation::retrieve_and_generate::RetrieveAndGenerateError::InternalServerException(inner) => Error::InternalServerException(inner),
            crate::operation::retrieve_and_generate::RetrieveAndGenerateError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            ...
            crate::operation::retrieve_and_generate::RetrieveAndGenerateError::ServiceQuotaExceededException(inner) => Error::ServiceQuotaExceededException(inner),
