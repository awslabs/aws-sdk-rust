...
#[non_exhaustive]
#[derive(Debug)]
pub struct AgenticRetrieveStreamResponseOutputUnmarshaller;

impl AgenticRetrieveStreamResponseOutputUnmarshaller {
    pub fn new() -> Self {
        AgenticRetrieveStreamResponseOutputUnmarshaller
    }
}
impl ::aws_smithy_eventstream::frame::UnmarshallMessage for AgenticRetrieveStreamResponseOutputUnmarshaller {
    type Output = crate::types::AgenticRetrieveStreamResponseOutput;
    type Error = crate::types::error::AgenticRetrieveStreamResponseOutputError;
    fn unmarshall(
        &self,
    ...
    ) -> std::result::Result<::aws_smithy_eventstream::frame::UnmarshalledMessage<Self::Output, Self::Error>, ::aws_smithy_eventstream::error::Error>
    {
        ...
        match response_headers.message_type.as_str() {
            "event" => match response_headers.smithy_type.as_str() {
                "result" => {
                    let parsed =
                        crate::protocol_serde::shape_agentic_retrieve_result_event::de_agentic_retrieve_result_event_payload(&message.payload()[..])
                            .map_err(|err| ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall Result: {err}")))?;
                    Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(
                        crate::types::AgenticRetrieveStreamResponseOutput::Result(parsed),
                    ))
                }
                "traceEvent" => {
                    let parsed =
                        crate::protocol_serde::shape_agentic_retrieve_trace_event::de_agentic_retrieve_trace_event_payload(&message.payload()[..])
                            .map_err(|err| {
                                ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall TraceEvent: {err}"))
                            })?;
                    Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(
                        crate::types::AgenticRetrieveStreamResponseOutput::TraceEvent(parsed),
                    ))
                }
                "responseEvent" => {
                    let parsed = crate::protocol_serde::shape_agentic_retrieve_response_event::de_agentic_retrieve_response_event_payload(
                        &message.payload()[..],
                    )
                    .map_err(|err| ::aws_smithy_eventstream::error::Error::unmarshalling(format!("failed to unmarshall ResponseEvent: {err}")))?;
                    Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(
                        crate::types::AgenticRetrieveStreamResponseOutput::ResponseEvent(parsed),
                    ))
                }
                _unknown_variant => Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Event(
                    crate::types::AgenticRetrieveStreamResponseOutput::Unknown,
                )),
            },
            "exception" => {
                let generic = match crate::protocol_serde::parse_event_stream_error_metadata(message.payload()) {
                    ...
                    Err(err) => {
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::unhandled(err),
                        ))
                    }
                };
                match response_headers.smithy_type.as_str() {
                    "internalServerException" => {
                        ...
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::InternalServerException(builder.build()),
                        ));
                    }
                    "validationException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::ValidationException(builder.build()),
                        ));
                    }
                    "resourceNotFoundException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::ResourceNotFoundException(builder.build()),
                        ));
                    }
                    "serviceQuotaExceededException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::ServiceQuotaExceededException(builder.build()),
                        ));
                    }
                    "throttlingException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::ThrottlingException(builder.build()),
                        ));
                    }
                    "accessDeniedException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::AccessDeniedException(builder.build()),
                        ));
                    }
                    "conflictException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::ConflictException(builder.build()),
                        ));
                    }
                    "dependencyFailedException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::DependencyFailedException(builder.build()),
                        ));
                    }
                    "badGatewayException" => {
                        ...
                        builder.set_meta(Some(generic));
                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                            crate::types::error::AgenticRetrieveStreamResponseOutputError::BadGatewayException(builder.build()),
                        ));
                    }
                    _ => {}
                }
                Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                    crate::types::error::AgenticRetrieveStreamResponseOutputError::generic(generic),
                ))
            }
            value => {
