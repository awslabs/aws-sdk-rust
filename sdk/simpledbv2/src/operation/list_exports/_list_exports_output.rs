...
pub struct ListExportsOutput {
    ...
    pub export_summaries: ::std::vec::Vec<crate::types::ExportSummary>,
...
impl ListExportsOutputBuilder {
    ...
    /// - [`export_summaries`](crate::operation::list_exports::builders::ListExportsOutputBuilder::export_summaries)
    pub fn build(self) -> ::std::result::Result<crate::operation::list_exports::ListExportsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::list_exports::ListExportsOutput {
            export_summaries: self.export_summaries.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "export_summaries",
                    "export_summaries was not specified but it is required when building ListExportsOutput",
                )
            })?,
