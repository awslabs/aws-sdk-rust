...
impl ListExportsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `export_summaries`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_exports::paginator::ListExportsPaginatorItems {
        crate::operation::list_exports::paginator::ListExportsPaginatorItems(self)
    }
...
pub struct ListExportsPaginatorItems(ListExportsPaginator);

impl ListExportsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_exports_output_output_export_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
