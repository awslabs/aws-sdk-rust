...
/// For example, the [`GetExport`](crate::operation::get_export) operation has
...
pub trait Waiters {
    ...
    fn wait_until_export_succeeded(&self) -> crate::waiters::export_succeeded::ExportSucceededFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_export_succeeded(&self) -> crate::waiters::export_succeeded::ExportSucceededFluentBuilder {
        crate::waiters::export_succeeded::ExportSucceededFluentBuilder::new(self.handle.clone())
    }
}
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_simpledbv2::Error> {
/// # let client: aws_sdk_simpledbv2::Client = unimplemented!();
