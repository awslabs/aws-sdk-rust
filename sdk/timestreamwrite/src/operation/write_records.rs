...
impl WriteRecords {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::write_records::WriteRecordsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::write_records::WriteRecordsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Timestream Write", "WriteRecords", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Timestream Write.WriteRecords",
                "rpc.service" = "Timestream Write",
                "rpc.method" = "WriteRecords",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("WriteRecords")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                WriteRecordsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct WriteRecordsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for WriteRecordsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<WriteRecordsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for WriteRecordsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_write_records::de_write_records_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_write_records::de_write_records_http_response(status, headers, body, _cfg)
        };
