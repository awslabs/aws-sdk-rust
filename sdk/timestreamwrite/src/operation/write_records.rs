...
impl WriteRecordsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::write_records::WriteRecords::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for WriteRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_write_records::de_write_records_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_write_records::de_write_records_http_response_with_props(
                status, headers, body,
            )
        }
    }
