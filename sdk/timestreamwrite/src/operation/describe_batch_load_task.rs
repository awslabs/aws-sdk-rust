...
impl DescribeBatchLoadTaskInput {
    /// Consumes the builder and constructs an Operation<[`DescribeBatchLoadTask`](crate::operation::describe_batch_load_task::DescribeBatchLoadTask)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_batch_load_task::DescribeBatchLoadTask,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_batch_load_task::DescribeBatchLoadTask::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeBatchLoadTask", "timestreamwrite"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBatchLoadTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_batch_load_task::de_describe_batch_load_task_http_response_with_props(status, headers, body)
        }
    }
}
