    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_batch_load_task::DescribeBatchLoadTaskError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_batch_load_task::DescribeBatchLoadTaskOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBatchLoadTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeBatchLoadTask", "timestreamwrite"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBatchLoadTask")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeBatchLoadTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeBatchLoadTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_batch_load_task::DescribeBatchLoadTaskInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_batch_load_task::ser_describe_batch_load_task_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeBatchLoadTaskEndpointParamsInterceptor {
...
pub type DescribeBatchLoadTaskErrorKind = DescribeBatchLoadTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeBatchLoadTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_batch_load_task::DescribeBatchLoadTaskError {
...
impl DescribeBatchLoadTaskError {
    ...
    /// Creates the `DescribeBatchLoadTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
