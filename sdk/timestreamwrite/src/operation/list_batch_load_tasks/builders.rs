...
impl ListBatchLoadTasksFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_batch_load_tasks::paginator::ListBatchLoadTasksPaginator {
        crate::operation::list_batch_load_tasks::paginator::ListBatchLoadTasksPaginator::new(
            self.handle,
            self.inner,
        )
    }
