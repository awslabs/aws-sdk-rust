...
impl CreateDatabaseInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_database::ser_create_database_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_database::CreateDatabase::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatabase {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_database::de_create_database_http_error(
                status, headers, body,
            )
        } else {
