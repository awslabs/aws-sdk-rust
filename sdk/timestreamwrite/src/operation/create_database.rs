...
impl CreateDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`CreateDatabase`](crate::operation::create_database::CreateDatabase)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_database::CreateDatabase, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_database::ser_create_database_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_database::CreateDatabase::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDatabase", "timestreamwrite"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatabase {
    type Output =
        ::std::result::Result<crate::operation::create_database::CreateDatabaseOutput, crate::operation::create_database::CreateDatabaseError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_database::de_create_database_http_response_with_props(status, headers, body)
        }
    }
}
