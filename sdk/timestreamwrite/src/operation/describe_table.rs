...
impl DescribeTableInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_table::ser_describe_table_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_table::DescribeTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_table::de_describe_table_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_table::de_describe_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
