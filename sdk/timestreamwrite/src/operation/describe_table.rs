...
impl DescribeTableInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTable`](crate::operation::describe_table::DescribeTable)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_table::DescribeTable, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_table::ser_describe_table_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_table::DescribeTable::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTable", "timestreamwrite"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTable {
    type Output = ::std::result::Result<crate::operation::describe_table::DescribeTableOutput, crate::operation::describe_table::DescribeTableError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_table::de_describe_table_http_response_with_props(status, headers, body)
        }
    }
}
