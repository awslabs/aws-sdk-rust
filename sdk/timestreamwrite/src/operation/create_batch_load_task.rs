...
impl CreateBatchLoadTask {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_batch_load_task::CreateBatchLoadTaskError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_batch_load_task::CreateBatchLoadTaskOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Timestream Write.CreateBatchLoadTask",
            "rpc.service" = "Timestream Write",
            "rpc.method" = "CreateBatchLoadTask",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateBatchLoadTask")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateBatchLoadTask")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateBatchLoadTaskTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateBatchLoadTaskTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateBatchLoadTaskTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateBatchLoadTaskInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("TargetDatabaseName") {
            if let ::std::option::Option::Some(value) = input.target_database_name.as_deref() {
                captured.insert("TargetDatabaseName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBatchLoadTaskResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_batch_load_task::de_create_batch_load_task_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_batch_load_task::de_create_batch_load_task_http_response(status, headers, body, _cfg)
        };
