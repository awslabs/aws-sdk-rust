...
impl CreateBatchLoadTaskInput {
    /// Consumes the builder and constructs an Operation<[`CreateBatchLoadTask`](crate::operation::create_batch_load_task::CreateBatchLoadTask)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_batch_load_task::CreateBatchLoadTask::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateBatchLoadTask", "timestreamwrite"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBatchLoadTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_batch_load_task::de_create_batch_load_task_http_response_with_props(status, headers, body)
        }
    }
}
