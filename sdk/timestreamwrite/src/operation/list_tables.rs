...
impl ListTablesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_tables::ser_list_tables_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_tables::ListTables::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTables", "timestreamwrite"));
