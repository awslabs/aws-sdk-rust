    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::resume_batch_load_task::ResumeBatchLoadTaskError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::resume_batch_load_task::ResumeBatchLoadTaskOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResumeBatchLoadTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ResumeBatchLoadTask", "timestreamwrite"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResumeBatchLoadTask")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ResumeBatchLoadTaskEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ResumeBatchLoadTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ResumeBatchLoadTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::resume_batch_load_task::ResumeBatchLoadTaskInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resume_batch_load_task::ser_resume_batch_load_task_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ResumeBatchLoadTaskEndpointParamsInterceptor {
...
pub type ResumeBatchLoadTaskErrorKind = ResumeBatchLoadTaskError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResumeBatchLoadTaskError {
...
impl ::aws_http::request_id::RequestId for crate::operation::resume_batch_load_task::ResumeBatchLoadTaskError {
...
impl ResumeBatchLoadTaskError {
    ...
    /// Creates the `ResumeBatchLoadTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
