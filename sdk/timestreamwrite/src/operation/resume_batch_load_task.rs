...
impl ResumeBatchLoadTaskInput {
    /// Consumes the builder and constructs an Operation<[`ResumeBatchLoadTask`](crate::operation::resume_batch_load_task::ResumeBatchLoadTask)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resume_batch_load_task::ResumeBatchLoadTask::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResumeBatchLoadTask", "timestreamwrite"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeBatchLoadTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resume_batch_load_task::de_resume_batch_load_task_http_response_with_props(status, headers, body)
        }
    }
}
