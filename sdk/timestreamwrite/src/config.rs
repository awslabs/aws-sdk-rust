...
/// Configuration for a aws_sdk_timestreamwrite service client.
///
...
impl Builder {
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_timestreamwrite::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_timestreamwrite::Config::builder();
    ...
    /// impl aws_sdk_timestreamwrite::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_timestreamwrite::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_timestreamwrite::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_timestreamwrite::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::Config;
    /// use aws_sdk_timestreamwrite::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_timestreamwrite::config::Config;
    /// use aws_sdk_timestreamwrite::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `timestreamwrite`
    /// (or `timestreamwrite-<region>` if a region is configured).
    /// All Timestream Write clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::Config;
    /// use aws_sdk_timestreamwrite::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::Config;
    /// use aws_sdk_timestreamwrite::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_timestreamwrite::config::IdentityCache;
    ///
    /// let config = aws_sdk_timestreamwrite::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_timestreamwrite::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("timestream"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_timestreamwrite::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_timestreamwrite::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
