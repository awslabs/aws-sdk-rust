...
pub fn ser_describe_database_input(
    ...
    crate::protocol_serde::shape_describe_database_input::ser_describe_database_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::describe_database::builders::DescribeDatabaseOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
