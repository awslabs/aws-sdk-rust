...
) -> Result<crate::operation::list_tables::builders::ListTablesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Tables" => {
                    builder = builder.set_tables(crate::protocol_serde::shape_table_list::de_table_list(tokens)?);
                }
                "NextToken" => {
