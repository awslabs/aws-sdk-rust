...
pub(crate) fn de_batch_load_progress_report<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::BatchLoadProgressReport>, ::aws_smithy_json::deserialize::error::DeserializeError>
