...
pub(crate) fn de_data_model_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataModelConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "DataModel" => {
                                builder = builder.set_data_model(
                                    crate::protocol_serde::shape_data_model::de_data_model(tokens)?
                                );
                            }
