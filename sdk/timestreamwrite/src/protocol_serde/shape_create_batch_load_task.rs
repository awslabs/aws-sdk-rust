...
> {
    Ok({
        ...
        crate::serde_util::create_batch_load_task_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_batch_load_task::CreateBatchLoadTaskError::unhandled)?
    })
}
...
pub fn ser_create_batch_load_task_input(
    ...
    crate::protocol_serde::shape_create_batch_load_task_input::ser_create_batch_load_task_input(&mut object, input)?;
    object.finish();
