...
pub(crate) fn de_data_model<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataModel>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DimensionMappings" => {
                                builder = builder.set_dimension_mappings(
                                    crate::protocol_serde::shape_dimension_mappings::de_dimension_mappings(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::data_model_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
