...
pub(crate) fn de_data_model_s3_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataModelS3Configuration>, ::aws_smithy_json::deserialize::error::DeserializeError>
