...
pub fn de_write_records_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::write_records::WriteRecordsOutput, crate::operation::write_records::WriteRecordsError> {
    #[allow(unused_mut)]
...
pub fn de_write_records_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_write_records::de_write_records(_response_body, output)
            .map_err(crate::operation::write_records::WriteRecordsError::unhandled)?;
...
) -> Result<crate::operation::write_records::builders::WriteRecordsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "RecordsIngested" => {
                    builder = builder.set_records_ingested(crate::protocol_serde::shape_records_ingested::de_records_ingested(tokens)?);
                }
