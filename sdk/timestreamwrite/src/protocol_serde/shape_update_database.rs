...
pub fn de_update_database_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_update_database::de_update_database(_response_body, output)
            .map_err(crate::operation::update_database::UpdateDatabaseError::unhandled)?;
...
) -> Result<crate::operation::update_database::builders::UpdateDatabaseOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
