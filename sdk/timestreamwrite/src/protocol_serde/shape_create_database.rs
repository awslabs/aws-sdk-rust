...
pub fn de_create_database_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_database::de_create_database(_response_body, output)
            .map_err(crate::operation::create_database::CreateDatabaseError::unhandled)?;
...
) -> Result<crate::operation::create_database::builders::CreateDatabaseOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
