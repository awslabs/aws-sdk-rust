...
pub fn ser_list_batch_load_tasks_input(
    ...
    crate::protocol_serde::shape_list_batch_load_tasks_input::ser_list_batch_load_tasks_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::list_batch_load_tasks::builders::ListBatchLoadTasksOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "BatchLoadTasks" => {
                    builder = builder.set_batch_load_tasks(crate::protocol_serde::shape_batch_load_task_list::de_batch_load_task_list(tokens)?);
                }
