...
impl super::Client {
    ...
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::describe_table::builders::DescribeTableFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::describe_table::builders::DescribeTableFluentBuilder::set_database_name): <p>The name of the Timestream database.</p>
    ///   - [`table_name(impl ::std::convert::Into<String>)`](crate::operation::describe_table::builders::DescribeTableFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::describe_table::builders::DescribeTableFluentBuilder::set_table_name): <p>The name of the Timestream table.</p>
