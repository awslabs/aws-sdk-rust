...
impl super::Client {
    ...
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::set_database_name): <p> The name of the database. </p>
    ///   - [`kms_key_id(impl ::std::convert::Into<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::kms_key_id) / [`set_kms_key_id(Option<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::set_kms_key_id): <p> The identifier of the new KMS key (<code>KmsKeyId</code>) to be used to encrypt the data stored in the database. If the <code>KmsKeyId</code> currently registered with the database is the same as the <code>KmsKeyId</code> in the request, there will not be any update. </p>  <p>You can specify the <code>KmsKeyId</code> using any of the following:</p>  <ul>   <li> <p>Key ID: <code>1234abcd-12ab-34cd-56ef-1234567890ab</code> </p> </li>   <li> <p>Key ARN: <code>arn:aws:kms:us-east-1:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</code> </p> </li>   <li> <p>Alias name: <code>alias/ExampleAlias</code> </p> </li>   <li> <p>Alias ARN: <code>arn:aws:kms:us-east-1:111122223333:alias/ExampleAlias</code> </p> </li>  </ul>
