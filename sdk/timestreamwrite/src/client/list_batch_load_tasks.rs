...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_batch_load_tasks::builders::ListBatchLoadTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_batch_load_tasks::builders::ListBatchLoadTasksFluentBuilder::set_next_token): <p>A token to specify where to start paginating. This is the NextToken from a previously truncated response.</p>
