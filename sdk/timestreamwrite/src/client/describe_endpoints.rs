...
impl super::Client {
    ...
    ///   - [`endpoints(Option<Vec<Endpoint>>)`](crate::operation::describe_endpoints::DescribeEndpointsOutput::endpoints): <p>An <code>Endpoints</code> object is returned when a <code>DescribeEndpoints</code> request is made.</p>
