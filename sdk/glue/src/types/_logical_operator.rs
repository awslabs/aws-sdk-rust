...
impl ::std::convert::From<&str> for LogicalOperator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LogicalOperator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LogicalOperator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LogicalOperator::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LogicalOperator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
