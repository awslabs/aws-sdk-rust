...
pub struct DataQualityRulesetEvaluationRun {
...
impl DataQualityRulesetEvaluationRun {
    /// <p>The unique run identifier associated with this run.</p>
...
impl DataQualityRulesetEvaluationRun {
    /// Creates a new builder-style object to manufacture [`DataQualityRulesetEvaluationRun`](crate::types::DataQualityRulesetEvaluationRun).
    pub fn builder() -> crate::types::builders::DataQualityRulesetEvaluationRunBuilder {
        crate::types::builders::DataQualityRulesetEvaluationRunBuilder::default()
    }
}

/// A builder for [`DataQualityRulesetEvaluationRun`](crate::types::DataQualityRulesetEvaluationRun).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DataQualityRulesetEvaluationRunBuilder {
...
impl DataQualityRulesetEvaluationRunBuilder {
    /// <p>The unique run identifier associated with this run.</p>
    ...
    /// Consumes the builder and constructs a [`DataQualityRulesetEvaluationRun`](crate::types::DataQualityRulesetEvaluationRun).
    pub fn build(self) -> crate::types::DataQualityRulesetEvaluationRun {
        crate::types::DataQualityRulesetEvaluationRun {
            run_id: self.run_id,
