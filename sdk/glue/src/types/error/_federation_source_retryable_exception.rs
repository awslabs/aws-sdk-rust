...
impl std::fmt::Display for FederationSourceRetryableException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "FederationSourceRetryableException")?;
...
impl aws_http::request_id::RequestId for crate::types::error::FederationSourceRetryableException {
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for FederationSourceRetryableException
{
