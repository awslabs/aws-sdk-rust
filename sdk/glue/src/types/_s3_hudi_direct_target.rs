    ...
    pub fn build(self) -> ::std::result::Result<crate::types::S3HudiDirectTarget, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::S3HudiDirectTarget {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building S3HudiDirectTarget")
                    )?
                ,
                inputs: self.inputs
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("inputs", "inputs was not specified but it is required when building S3HudiDirectTarget")
                    )?
                ,
                path: self.path
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("path", "path was not specified but it is required when building S3HudiDirectTarget")
                    )?
                ,
                compression: self.compression
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("compression", "compression was not specified but it is required when building S3HudiDirectTarget")
                    )?
                ,
                ...
                format: self.format
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("format", "format was not specified but it is required when building S3HudiDirectTarget")
                    )?
                ,
                additional_options: self.additional_options
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("additional_options", "additional_options was not specified but it is required when building S3HudiDirectTarget")
                    )?
                ,
