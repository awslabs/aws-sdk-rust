...
///     ExportStatus::Disabling => { /* ... */ },
///     ExportStatus::Enabled => { /* ... */ },
///     ExportStatus::Enabling => { /* ... */ },
///     ExportStatus::Failed => { /* ... */ },
...
impl ::std::convert::From<&str> for ExportStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "DISABLING" => ExportStatus::Disabling,
            "ENABLED" => ExportStatus::Enabled,
            "ENABLING" => ExportStatus::Enabling,
...
impl ExportStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ExportStatus::Disabled => "DISABLED",
            ExportStatus::Disabling => "DISABLING",
            ExportStatus::Enabled => "ENABLED",
            ExportStatus::Enabling => "ENABLING",
...
impl ::std::fmt::Display for ExportStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ExportStatus::Disabled => write!(f, "DISABLED"),
            ExportStatus::Disabling => write!(f, "DISABLING"),
            ExportStatus::Enabled => write!(f, "ENABLED"),
            ExportStatus::Enabling => write!(f, "ENABLING"),
