...
impl super::Client {
    ...
    ///   - [`catalog_id(impl Into<String>)`](crate::operation::update_user_defined_function::builders::UpdateUserDefinedFunctionFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::update_user_defined_function::builders::UpdateUserDefinedFunctionFluentBuilder::set_catalog_id):<br>required: **false**<br><p>The ID of the Data Catalog where the function to be updated is located. If none is provided, the Amazon Web Services account ID is used by default.</p><br>
    ///   - [`database_name(impl Into<String>)`](crate::operation::update_user_defined_function::builders::UpdateUserDefinedFunctionFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::update_user_defined_function::builders::UpdateUserDefinedFunctionFluentBuilder::set_database_name):<br>required: **true**<br><p>The name of the catalog database where the function to be updated is located.</p><br>
    ///   - [`function_name(impl Into<String>)`](crate::operation::update_user_defined_function::builders::UpdateUserDefinedFunctionFluentBuilder::function_name) / [`set_function_name(Option<String>)`](crate::operation::update_user_defined_function::builders::UpdateUserDefinedFunctionFluentBuilder::set_function_name):<br>required: **true**<br><p>The name of the function.</p><br>
