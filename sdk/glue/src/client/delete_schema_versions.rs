...
impl super::Client {
    ...
    ///   - [`versions(impl ::std::convert::Into<String>)`](crate::operation::delete_schema_versions::builders::DeleteSchemaVersionsFluentBuilder::versions) / [`set_versions(Option<String>)`](crate::operation::delete_schema_versions::builders::DeleteSchemaVersionsFluentBuilder::set_versions): <p>A version range may be supplied which may be of the format:</p>  <ul>   <li> <p>a single version number, 5</p> </li>   <li> <p>a range, 5-8 : deletes versions 5, 6, 7, 8</p> </li>  </ul>
