...
impl super::Client {
    ...
    ///   - [`node_ids(impl Into<String>)`](crate::operation::resume_workflow_run::builders::ResumeWorkflowRunFluentBuilder::node_ids) / [`set_node_ids(Option<Vec<String>>)`](crate::operation::resume_workflow_run::builders::ResumeWorkflowRunFluentBuilder::set_node_ids): <p>A list of the node IDs for the nodes you want to restart. The nodes that are to be restarted must have a run attempt in the original run.</p>
