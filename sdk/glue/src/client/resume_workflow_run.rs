...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::resume_workflow_run::builders::ResumeWorkflowRunFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::resume_workflow_run::builders::ResumeWorkflowRunFluentBuilder::set_name): <p>The name of the workflow to resume.</p>
    ///   - [`run_id(impl ::std::convert::Into<String>)`](crate::operation::resume_workflow_run::builders::ResumeWorkflowRunFluentBuilder::run_id) / [`set_run_id(Option<String>)`](crate::operation::resume_workflow_run::builders::ResumeWorkflowRunFluentBuilder::set_run_id): <p>The ID of the workflow run to resume.</p>
