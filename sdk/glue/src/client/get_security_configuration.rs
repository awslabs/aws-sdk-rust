...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_security_configuration::builders::GetSecurityConfigurationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_security_configuration::builders::GetSecurityConfigurationFluentBuilder::set_name):<br>required: **true**<br><p>The name of the security configuration to retrieve.</p><br>
