...
impl super::Client {
    ...
    ///   - [`run_properties(impl Into<String>, impl Into<String>)`](crate::operation::put_workflow_run_properties::builders::PutWorkflowRunPropertiesFluentBuilder::run_properties) / [`set_run_properties(Option<HashMap::<String, String>>)`](crate::operation::put_workflow_run_properties::builders::PutWorkflowRunPropertiesFluentBuilder::set_run_properties):<br>required: **true**<br><p>The properties to put for the specified run.</p> <p>Run properties may be logged. Do not pass plaintext secrets as properties. Retrieve secrets from a Glue Connection, Amazon Web Services Secrets Manager or other secret management mechanism if you intend to use them within the workflow run.</p><br>
