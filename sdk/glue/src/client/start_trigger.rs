...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::start_trigger::builders::StartTriggerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::start_trigger::builders::StartTriggerFluentBuilder::set_name): <p>The name of the trigger to start.</p>
