...
impl super::Client {
    ...
    pub fn batch_get_crawlers(
        &self,
    ) -> crate::operation::batch_get_crawlers::builders::BatchGetCrawlersFluentBuilder {
        crate::operation::batch_get_crawlers::builders::BatchGetCrawlersFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
