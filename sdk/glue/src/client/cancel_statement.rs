...
impl super::Client {
    ...
    ///   - [`session_id(impl ::std::convert::Into<String>)`](crate::operation::cancel_statement::builders::CancelStatementFluentBuilder::session_id) / [`set_session_id(Option<String>)`](crate::operation::cancel_statement::builders::CancelStatementFluentBuilder::set_session_id): <p>The Session ID of the statement to be cancelled.</p>
