...
impl super::Client {
    ...
    ///   - [`role(impl ::std::convert::Into<String>)`](crate::operation::start_data_quality_rule_recommendation_run::builders::StartDataQualityRuleRecommendationRunFluentBuilder::role) / [`set_role(Option<String>)`](crate::operation::start_data_quality_rule_recommendation_run::builders::StartDataQualityRuleRecommendationRunFluentBuilder::set_role): <p>An IAM role supplied to encrypt the results of the run.</p>
