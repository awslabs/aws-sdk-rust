...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_classifier::builders::GetClassifierFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_classifier::builders::GetClassifierFluentBuilder::set_name):<br>required: **true**<br><p>Name of the classifier to retrieve.</p><br>
