...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog in which the metadata database resides. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_database::builders::UpdateDatabaseFluentBuilder::set_name): <p>The name of the database to update in the catalog. For Hive compatibility, this is folded to lowercase.</p>
