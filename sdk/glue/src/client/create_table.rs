...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_table::builders::CreateTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_table::builders::CreateTableFluentBuilder::set_name):<br>required: **false**<br><p>The unique identifier for the table within the specified database that will be created in the Glue Data Catalog.</p><br>
    ///   - [`table_input(TableInput)`](crate::operation::create_table::builders::CreateTableFluentBuilder::table_input) / [`set_table_input(Option<TableInput>)`](crate::operation::create_table::builders::CreateTableFluentBuilder::set_table_input):<br>required: **false**<br><p>The <code>TableInput</code> object that defines the metadata table to create in the catalog.</p><br>
