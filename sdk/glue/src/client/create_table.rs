...
impl super::Client {
    ...
    ///   - [`transaction_id(impl ::std::convert::Into<String>)`](crate::operation::create_table::builders::CreateTableFluentBuilder::transaction_id) / [`set_transaction_id(Option<String>)`](crate::operation::create_table::builders::CreateTableFluentBuilder::set_transaction_id): <p>The ID of the transaction.</p>
