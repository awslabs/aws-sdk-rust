...
impl super::Client  {
    ...
    pub fn start_data_quality_ruleset_evaluation_run(&self) -> crate::client::fluent_builders::StartDataQualityRulesetEvaluationRun {
                                crate::client::fluent_builders::StartDataQualityRulesetEvaluationRun::new(self.handle.clone())
                            }
}
