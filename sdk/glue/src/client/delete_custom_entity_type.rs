...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_custom_entity_type::builders::DeleteCustomEntityTypeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_custom_entity_type::builders::DeleteCustomEntityTypeFluentBuilder::set_name):<br>required: **true**<br><p>The name of the custom pattern that you want to delete.</p><br>
