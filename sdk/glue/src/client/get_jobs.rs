...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_jobs::builders::GetJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_jobs::builders::GetJobsFluentBuilder::set_next_token): <p>A continuation token, if this is a continuation call.</p>
