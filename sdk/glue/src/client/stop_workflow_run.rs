...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::stop_workflow_run::builders::StopWorkflowRunFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::stop_workflow_run::builders::StopWorkflowRunFluentBuilder::set_name):<br>required: **true**<br><p>The name of the workflow to stop.</p><br>
    ///   - [`run_id(impl Into<String>)`](crate::operation::stop_workflow_run::builders::StopWorkflowRunFluentBuilder::run_id) / [`set_run_id(Option<String>)`](crate::operation::stop_workflow_run::builders::StopWorkflowRunFluentBuilder::set_run_id):<br>required: **true**<br><p>The ID of the workflow run to stop.</p><br>
