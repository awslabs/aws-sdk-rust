...
impl super::Client {
    ...
    ///   - [`mapping(MappingEntry)`](crate::operation::get_plan::builders::GetPlanFluentBuilder::mapping) / [`set_mapping(Option<Vec<MappingEntry>>)`](crate::operation::get_plan::builders::GetPlanFluentBuilder::set_mapping): <p>The list of mappings from a source table to target tables.</p>
    ...
    ///   - [`sinks(CatalogEntry)`](crate::operation::get_plan::builders::GetPlanFluentBuilder::sinks) / [`set_sinks(Option<Vec<CatalogEntry>>)`](crate::operation::get_plan::builders::GetPlanFluentBuilder::set_sinks): <p>The target tables.</p>
