...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_tables::builders::GetTablesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_tables::builders::GetTablesFluentBuilder::set_next_token):<br>required: **false**<br><p>A continuation token, included if this is a continuation call.</p><br>
