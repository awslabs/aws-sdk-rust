...
impl super::Client {
    ...
    ///   - [`transaction_id(impl ::std::convert::Into<String>)`](crate::operation::get_tables::builders::GetTablesFluentBuilder::transaction_id) / [`set_transaction_id(Option<String>)`](crate::operation::get_tables::builders::GetTablesFluentBuilder::set_transaction_id): <p>The transaction ID at which to read the table contents.</p>
