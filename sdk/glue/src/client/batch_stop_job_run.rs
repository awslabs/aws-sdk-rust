...
impl super::Client {
    ...
    ///   - [`job_run_ids(impl Into<String>)`](crate::operation::batch_stop_job_run::builders::BatchStopJobRunFluentBuilder::job_run_ids) / [`set_job_run_ids(Option<Vec<String>>)`](crate::operation::batch_stop_job_run::builders::BatchStopJobRunFluentBuilder::set_job_run_ids): <p>A list of the <code>JobRunIds</code> that should be stopped for that job definition.</p>
