...
impl super::Client {
    ...
    pub fn stop_crawler_schedule(
        &self,
    ) -> crate::operation::stop_crawler_schedule::builders::StopCrawlerScheduleFluentBuilder {
        crate::operation::stop_crawler_schedule::builders::StopCrawlerScheduleFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
