...
impl super::Client {
    ...
    ///   - [`catalog_id(impl Into<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_catalog_id):<br>required: **false**<br><p>The ID of the Data Catalog in which the connections reside. If none is provided, the Amazon Web Services account ID is used by default.</p><br>
    ///   - [`filter(GetConnectionsFilter)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::filter) / [`set_filter(Option<GetConnectionsFilter>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_filter):<br>required: **false**<br><p>A filter that controls which connections are returned.</p><br>
    ///   - [`hide_password(bool)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::hide_password) / [`set_hide_password(Option<bool>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_hide_password):<br>required: **false**<br><p>Allows you to retrieve the connection metadata without returning the password. For instance, the Glue console uses this flag to retrieve the connection, and does not display the password. Set this parameter when the caller might not have permission to use the KMS key to decrypt the password, but it does have permission to access the rest of the connection properties.</p><br>
