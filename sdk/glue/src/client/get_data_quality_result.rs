...
impl super::Client {
    ...
    pub fn get_data_quality_result(
        &self,
    ) -> crate::operation::get_data_quality_result::builders::GetDataQualityResultFluentBuilder
    {
        crate::operation::get_data_quality_result::builders::GetDataQualityResultFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
