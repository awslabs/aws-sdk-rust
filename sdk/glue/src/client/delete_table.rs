...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::delete_table::builders::DeleteTableFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::delete_table::builders::DeleteTableFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog where the table resides. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_table::builders::DeleteTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_table::builders::DeleteTableFluentBuilder::set_name): <p>The name of the table to be deleted. For Hive compatibility, this name is entirely lowercase.</p>
