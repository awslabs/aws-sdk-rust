...
impl super::Client {
    ...
    ///   - [`schema_definition(impl ::std::convert::Into<String>)`](crate::operation::check_schema_version_validity::builders::CheckSchemaVersionValidityFluentBuilder::schema_definition) / [`set_schema_definition(Option<String>)`](crate::operation::check_schema_version_validity::builders::CheckSchemaVersionValidityFluentBuilder::set_schema_definition): <p>The definition of the schema that has to be validated.</p>
