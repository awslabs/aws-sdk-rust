...
impl super::Client {
    ...
    pub fn import_catalog_to_glue(
        &self,
    ) -> crate::operation::import_catalog_to_glue::builders::ImportCatalogToGlueFluentBuilder {
        crate::operation::import_catalog_to_glue::builders::ImportCatalogToGlueFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
