...
impl super::Client {
    ...
    ///   - [`table_name(impl Into<String>)`](crate::operation::stop_materialized_view_refresh_task_run::builders::StopMaterializedViewRefreshTaskRunFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::stop_materialized_view_refresh_task_run::builders::StopMaterializedViewRefreshTaskRunFluentBuilder::set_table_name):<br>required: **true**<br><p>The name of the materialized view.</p><br>
