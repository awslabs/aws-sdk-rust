...
impl super::Client {
    ...
    ///   - [`transform_id(impl Into<String>)`](crate::operation::get_ml_task_run::builders::GetMLTaskRunFluentBuilder::transform_id) / [`set_transform_id(Option<String>)`](crate::operation::get_ml_task_run::builders::GetMLTaskRunFluentBuilder::set_transform_id):<br>required: **true**<br><p>The unique identifier of the machine learning transform.</p><br>
    ///   - [`task_run_id(impl Into<String>)`](crate::operation::get_ml_task_run::builders::GetMLTaskRunFluentBuilder::task_run_id) / [`set_task_run_id(Option<String>)`](crate::operation::get_ml_task_run::builders::GetMLTaskRunFluentBuilder::set_task_run_id):<br>required: **true**<br><p>The unique identifier of the task run.</p><br>
