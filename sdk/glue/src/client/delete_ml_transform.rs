...
impl super::Client {
    ...
    ///   - [`transform_id(impl Into<String>)`](crate::operation::delete_ml_transform::builders::DeleteMLTransformFluentBuilder::transform_id) / [`set_transform_id(Option<String>)`](crate::operation::delete_ml_transform::builders::DeleteMLTransformFluentBuilder::set_transform_id):<br>required: **true**<br><p>The unique identifier of the transform to delete.</p><br>
