...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_connection::builders::BatchDeleteConnectionFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::batch_delete_connection::builders::BatchDeleteConnectionFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog in which the connections reside. If none is provided, the Amazon Web Services account ID is used by default.</p>
