...
impl super::Client {
    ...
    ///   - [`connection_name_list(impl Into<String>)`](crate::operation::batch_delete_connection::builders::BatchDeleteConnectionFluentBuilder::connection_name_list) / [`set_connection_name_list(Option<Vec<String>>)`](crate::operation::batch_delete_connection::builders::BatchDeleteConnectionFluentBuilder::set_connection_name_list): <p>A list of names of the connections to delete.</p>
