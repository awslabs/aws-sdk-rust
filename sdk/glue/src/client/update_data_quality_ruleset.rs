...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_data_quality_ruleset::builders::UpdateDataQualityRulesetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_data_quality_ruleset::builders::UpdateDataQualityRulesetFluentBuilder::set_name):<br>required: **true**<br><p>The name of the data quality ruleset.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_data_quality_ruleset::builders::UpdateDataQualityRulesetFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_data_quality_ruleset::builders::UpdateDataQualityRulesetFluentBuilder::set_description):<br>required: **false**<br><p>A description of the ruleset.</p><br>
    ///   - [`ruleset(impl Into<String>)`](crate::operation::update_data_quality_ruleset::builders::UpdateDataQualityRulesetFluentBuilder::ruleset) / [`set_ruleset(Option<String>)`](crate::operation::update_data_quality_ruleset::builders::UpdateDataQualityRulesetFluentBuilder::set_ruleset):<br>required: **false**<br><p>A Data Quality Definition Language (DQDL) ruleset. For more information, see the Glue developer guide.</p><br>
