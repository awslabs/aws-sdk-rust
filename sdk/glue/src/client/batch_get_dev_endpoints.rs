...
impl super::Client {
    ...
    ///   - [`dev_endpoint_names(impl Into<String>)`](crate::operation::batch_get_dev_endpoints::builders::BatchGetDevEndpointsFluentBuilder::dev_endpoint_names) / [`set_dev_endpoint_names(Option<Vec::<String>>)`](crate::operation::batch_get_dev_endpoints::builders::BatchGetDevEndpointsFluentBuilder::set_dev_endpoint_names):<br>required: **true**<br><p>The list of <code>DevEndpoint</code> names, which might be the names returned from the <code>ListDevEndpoint</code> operation.</p><br>
