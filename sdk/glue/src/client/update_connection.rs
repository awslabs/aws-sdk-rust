...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::update_connection::builders::UpdateConnectionFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::update_connection::builders::UpdateConnectionFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog in which the connection resides. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_connection::builders::UpdateConnectionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_connection::builders::UpdateConnectionFluentBuilder::set_name): <p>The name of the connection definition to update.</p>
