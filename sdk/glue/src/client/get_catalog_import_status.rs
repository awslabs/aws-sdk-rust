...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::get_catalog_import_status::builders::GetCatalogImportStatusFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_catalog_import_status::builders::GetCatalogImportStatusFluentBuilder::set_catalog_id): <p>The ID of the catalog to migrate. Currently, this should be the Amazon Web Services account ID.</p>
