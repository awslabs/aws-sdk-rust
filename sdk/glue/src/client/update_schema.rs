...
impl super::Client {
    ...
    ///   - [`compatibility(Compatibility)`](crate::operation::update_schema::builders::UpdateSchemaFluentBuilder::compatibility) / [`set_compatibility(Option<Compatibility>)`](crate::operation::update_schema::builders::UpdateSchemaFluentBuilder::set_compatibility):<br>required: **false**<br><p>The new compatibility setting for the schema.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_schema::builders::UpdateSchemaFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_schema::builders::UpdateSchemaFluentBuilder::set_description):<br>required: **false**<br><p>The new description for the schema.</p><br>
