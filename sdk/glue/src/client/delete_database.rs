...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_database::builders::DeleteDatabaseFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_database::builders::DeleteDatabaseFluentBuilder::set_name):<br>required: **true**<br><p>The name of the database to delete. For Hive compatibility, this must be all lowercase.</p><br>
