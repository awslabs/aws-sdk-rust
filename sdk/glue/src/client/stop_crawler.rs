...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::stop_crawler::builders::StopCrawlerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::stop_crawler::builders::StopCrawlerFluentBuilder::set_name):<br>required: **true**<br><p>Name of the crawler to stop.</p><br>
