...
impl super::Client {
    ...
    ///   - [`audit_context(AuditContext)`](crate::operation::get_table_versions::builders::GetTableVersionsFluentBuilder::audit_context) / [`set_audit_context(Option<AuditContext>)`](crate::operation::get_table_versions::builders::GetTableVersionsFluentBuilder::set_audit_context):<br>required: **false**<br><p>A structure containing the Lake Formation audit context.</p><br>
