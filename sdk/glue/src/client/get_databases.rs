...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::get_databases::builders::GetDatabasesFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_databases::builders::GetDatabasesFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog from which to retrieve <code>Databases</code>. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_databases::builders::GetDatabasesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_databases::builders::GetDatabasesFluentBuilder::set_next_token): <p>A continuation token, if this is a continuation call.</p>
