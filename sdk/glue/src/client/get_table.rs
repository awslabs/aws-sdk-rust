...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog where the table resides. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_database_name): <p>The name of the database in the catalog in which the table resides. For Hive compatibility, this name is entirely lowercase.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_name): <p>The name of the table for which to retrieve the definition. For Hive compatibility, this name is entirely lowercase.</p>
    ///   - [`transaction_id(impl ::std::convert::Into<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::transaction_id) / [`set_transaction_id(Option<String>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_transaction_id): <p>The transaction ID at which to read the table contents. </p>
