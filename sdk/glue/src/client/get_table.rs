...
impl super::Client {
    ...
    ///   - [`audit_context(AuditContext)`](crate::operation::get_table::builders::GetTableFluentBuilder::audit_context) / [`set_audit_context(Option<AuditContext>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_audit_context):<br>required: **false**<br><p>A structure containing the Lake Formation <a href="https://docs.aws.amazon.com/glue/latest/webapi/API_AuditContext.html">audit context</a>.</p><br>
    ///   - [`include_status_details(bool)`](crate::operation::get_table::builders::GetTableFluentBuilder::include_status_details) / [`set_include_status_details(Option<bool>)`](crate::operation::get_table::builders::GetTableFluentBuilder::set_include_status_details):<br>required: **false**<br><p>Specifies whether to include status details related to a request to create or update an Glue Data Catalog view.</p><br>
