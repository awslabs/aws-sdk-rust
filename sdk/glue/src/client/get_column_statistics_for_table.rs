...
impl super::Client {
    ...
    ///   - [`column_names(impl Into<String>)`](crate::operation::get_column_statistics_for_table::builders::GetColumnStatisticsForTableFluentBuilder::column_names) / [`set_column_names(Option<Vec<String>>)`](crate::operation::get_column_statistics_for_table::builders::GetColumnStatisticsForTableFluentBuilder::set_column_names): <p>A list of the column names.</p>
