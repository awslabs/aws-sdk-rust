...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::list_triggers::builders::ListTriggersFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::list_triggers::builders::ListTriggersFluentBuilder::set_tags): <p>Specifies to return only these tagged resources.</p>
