...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::list_data_quality_rule_recommendation_runs::builders::ListDataQualityRuleRecommendationRunsFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::list_data_quality_rule_recommendation_runs::builders::ListDataQualityRuleRecommendationRunsFluentBuilder::set_tags):<br>required: **false**<br><p>A list of key-value pair tags to filter recommendation runs.</p><br>
