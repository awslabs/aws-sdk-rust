...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_data_quality_ruleset::builders::DeleteDataQualityRulesetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_data_quality_ruleset::builders::DeleteDataQualityRulesetFluentBuilder::set_name):<br>required: **true**<br><p>A name for the data quality ruleset.</p><br>
