...
impl super::Client {
    ...
    ///   - [`audit_context(AuditContext)`](crate::operation::get_table_version::builders::GetTableVersionFluentBuilder::audit_context) / [`set_audit_context(Option<AuditContext>)`](crate::operation::get_table_version::builders::GetTableVersionFluentBuilder::set_audit_context):<br>required: **false**<br><p>A structure containing the Lake Formation audit context.</p><br>
