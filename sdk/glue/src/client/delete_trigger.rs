...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_trigger::builders::DeleteTriggerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_trigger::builders::DeleteTriggerFluentBuilder::set_name):<br>required: **true**<br><p>The name of the trigger to delete.</p><br>
