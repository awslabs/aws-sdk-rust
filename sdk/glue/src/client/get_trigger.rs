...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_trigger::builders::GetTriggerFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_trigger::builders::GetTriggerFluentBuilder::set_name): <p>The name of the trigger to retrieve.</p>
