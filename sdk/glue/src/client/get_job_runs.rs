...
impl super::Client {
    ...
    ///   - [`job_name(impl ::std::convert::Into<String>)`](crate::operation::get_job_runs::builders::GetJobRunsFluentBuilder::job_name) / [`set_job_name(Option<String>)`](crate::operation::get_job_runs::builders::GetJobRunsFluentBuilder::set_job_name): <p>The name of the job definition for which to retrieve all job runs.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_job_runs::builders::GetJobRunsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_job_runs::builders::GetJobRunsFluentBuilder::set_next_token): <p>A continuation token, if this is a continuation call.</p>
