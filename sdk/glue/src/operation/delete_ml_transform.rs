...
impl DeleteMlTransformInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_ml_transform::ser_delete_ml_transform_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMLTransform {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_ml_transform::de_delete_ml_transform_http_response_with_props(status, headers, body)
        }
    }
}
