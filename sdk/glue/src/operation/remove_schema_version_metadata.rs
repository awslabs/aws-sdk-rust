...
/// Orchestration and serialization glue logic for `RemoveSchemaVersionMetadata`.
...
impl RemoveSchemaVersionMetadata {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveSchemaVersionMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveSchemaVersionMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveSchemaVersionMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveSchemaVersionMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveSchemaVersionMetadata")
...
.with_interceptor(RemoveSchemaVersionMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError>::new());
...
#[derive(Debug)]
            struct RemoveSchemaVersionMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveSchemaVersionMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_schema_version_metadata::de_remove_schema_version_metadata_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RemoveSchemaVersionMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveSchemaVersionMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_schema_version_metadata::ser_remove_schema_version_metadata_input(&input)?);
...
#[derive(Debug)]
            struct RemoveSchemaVersionMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveSchemaVersionMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveSchemaVersionMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveSchemaVersionMetadataInput>()
                        .ok_or("failed to downcast to RemoveSchemaVersionMetadataInput")?;
...
/// Error type for the `RemoveSchemaVersionMetadataError` operation.
#[non_exhaustive]
...
pub enum RemoveSchemaVersionMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveSchemaVersionMetadataError) for what information is available for the error.")]
...
impl RemoveSchemaVersionMetadataError {
    /// Creates the `RemoveSchemaVersionMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveSchemaVersionMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `RemoveSchemaVersionMetadataError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `RemoveSchemaVersionMetadataError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `RemoveSchemaVersionMetadataError::InvalidInputException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RemoveSchemaVersionMetadataError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveSchemaVersionMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError {
...
mod _remove_schema_version_metadata_output;
