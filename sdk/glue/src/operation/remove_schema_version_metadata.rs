    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveSchemaVersionMetadata {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveSchemaVersionMetadata")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RemoveSchemaVersionMetadataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RemoveSchemaVersionMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RemoveSchemaVersionMetadataEndpointParamsInterceptor {
...
pub type RemoveSchemaVersionMetadataErrorKind = RemoveSchemaVersionMetadataError;
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError {
...
impl RemoveSchemaVersionMetadataError {
    ...
    /// Creates the `RemoveSchemaVersionMetadataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
