...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveSchemaVersionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_schema_version_metadata::de_remove_schema_version_metadata_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RemoveSchemaVersionMetadataError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_schema_version_metadata::RemoveSchemaVersionMetadataError
{
