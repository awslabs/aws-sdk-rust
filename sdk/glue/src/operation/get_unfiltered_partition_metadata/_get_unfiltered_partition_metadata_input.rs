...
impl GetUnfilteredPartitionMetadataInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
