...
impl StopTriggerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_trigger::StopTrigger, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_trigger::ser_stop_trigger_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_trigger::de_stop_trigger_http_response_with_props(status, headers, body)
        }
    }
}
