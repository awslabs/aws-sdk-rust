...
impl StopTriggerInput {
    /// Consumes the builder and constructs an Operation<[`StopTrigger`](crate::operation::stop_trigger::StopTrigger)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_trigger::StopTrigger, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_trigger::StopTriggerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_trigger::ser_stop_trigger_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_trigger::StopTrigger::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopTrigger", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopTrigger {
                type Output = std::result::Result<crate::operation::stop_trigger::StopTriggerOutput, crate::operation::stop_trigger::StopTriggerError>;
