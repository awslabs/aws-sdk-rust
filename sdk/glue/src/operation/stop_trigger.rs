...
impl StopTriggerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_trigger::StopTrigger,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_trigger::StopTrigger::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_trigger::de_stop_trigger_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_trigger::de_stop_trigger_http_response_with_props(
                status, headers, body,
            )
        }
    }
