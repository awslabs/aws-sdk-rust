...
impl GetCrawlerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_crawler::GetCrawler::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCrawler {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_crawler::de_get_crawler_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_crawler::de_get_crawler_http_response_with_props(
                status, headers, body,
            )
        }
    }
