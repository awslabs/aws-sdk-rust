...
impl BatchDeleteConnectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_delete_connection::BatchDeleteConnection,
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_connection::de_batch_delete_connection_http_response_with_props(status, headers, body)
        }
    }
}
