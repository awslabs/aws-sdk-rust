...
impl StartMLLabelingSetGenerationTaskRun {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_ml_labeling_set_generation_task_run::StartMlLabelingSetGenerationTaskRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_ml_labeling_set_generation_task_run::StartMLLabelingSetGenerationTaskRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_ml_labeling_set_generation_task_run::StartMLLabelingSetGenerationTaskRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_ml_labeling_set_generation_task_run::StartMlLabelingSetGenerationTaskRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMLLabelingSetGenerationTaskRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartMLLabelingSetGenerationTaskRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartMLLabelingSetGenerationTaskRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartMLLabelingSetGenerationTaskRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartMLLabelingSetGenerationTaskRun")
...
.with_interceptor(StartMLLabelingSetGenerationTaskRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_ml_labeling_set_generation_task_run::StartMLLabelingSetGenerationTaskRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_ml_labeling_set_generation_task_run::StartMLLabelingSetGenerationTaskRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_ml_labeling_set_generation_task_run::StartMLLabelingSetGenerationTaskRunError>::new());
...
#[derive(Debug)]
            struct StartMLLabelingSetGenerationTaskRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartMLLabelingSetGenerationTaskRunResponseDeserializer {
...
#[derive(Debug)]
            struct StartMLLabelingSetGenerationTaskRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartMLLabelingSetGenerationTaskRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_ml_labeling_set_generation_task_run::StartMlLabelingSetGenerationTaskRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_ml_labeling_set_generation_task_run::StartMlLabelingSetGenerationTaskRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_ml_labeling_set_generation_task_run::ser_start_ml_labeling_set_generation_task_run_input(&input)?);
...
#[derive(Debug)]
            struct StartMLLabelingSetGenerationTaskRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMLLabelingSetGenerationTaskRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartMLLabelingSetGenerationTaskRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartMlLabelingSetGenerationTaskRunInput>()
                        .ok_or("failed to downcast to StartMlLabelingSetGenerationTaskRunInput")?;
...
/// Error type for the `StartMLLabelingSetGenerationTaskRunError` operation.
#[non_exhaustive]
...
pub enum StartMLLabelingSetGenerationTaskRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartMLLabelingSetGenerationTaskRunError) for what information is available for the error.")]
...
impl StartMLLabelingSetGenerationTaskRunError {
    /// Creates the `StartMLLabelingSetGenerationTaskRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartMLLabelingSetGenerationTaskRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartMLLabelingSetGenerationTaskRunError::ConcurrentRunsExceededException`.
    pub fn is_concurrent_runs_exceeded_exception(&self) -> bool {
        matches!(self, Self::ConcurrentRunsExceededException(_))
    }
    /// Returns `true` if the error kind is `StartMLLabelingSetGenerationTaskRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartMLLabelingSetGenerationTaskRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartMLLabelingSetGenerationTaskRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `StartMLLabelingSetGenerationTaskRunError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartMLLabelingSetGenerationTaskRunError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartMLLabelingSetGenerationTaskRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_ml_labeling_set_generation_task_run::StartMLLabelingSetGenerationTaskRunError {
...
mod _start_ml_labeling_set_generation_task_run_output;
