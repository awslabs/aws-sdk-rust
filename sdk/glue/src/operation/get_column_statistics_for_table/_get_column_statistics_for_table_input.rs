...
impl GetColumnStatisticsForTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableInput, ::aws_smithy_types::error::operation::BuildError> {
