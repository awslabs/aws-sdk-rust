...
impl crate::operation::get_column_statistics_for_table::builders::GetColumnStatisticsForTableInputBuilder {
...
impl GetColumnStatisticsForTableFluentBuilder {
    /// Creates a new `GetColumnStatisticsForTableFluentBuilder`.
