...
impl GetSchemaVersionsDiffFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffOutput, crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError, Self> {
