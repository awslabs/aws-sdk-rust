...
/// Orchestration and serialization glue logic for `BatchCreatePartition`.
...
impl BatchCreatePartition {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_create_partition::BatchCreatePartitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_create_partition::BatchCreatePartitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_create_partition::BatchCreatePartitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_create_partition::BatchCreatePartitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchCreatePartition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchCreatePartition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchCreatePartitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchCreatePartitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchCreatePartition")
...
.with_interceptor(BatchCreatePartitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_create_partition::BatchCreatePartitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_create_partition::BatchCreatePartitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_create_partition::BatchCreatePartitionError>::new());
...
#[derive(Debug)]
            struct BatchCreatePartitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchCreatePartitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_create_partition::de_batch_create_partition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_create_partition::de_batch_create_partition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchCreatePartitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchCreatePartitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_create_partition::BatchCreatePartitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_create_partition::BatchCreatePartitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_create_partition::ser_batch_create_partition_input(&input)?);
...
#[derive(Debug)]
            struct BatchCreatePartitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchCreatePartitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchCreatePartitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchCreatePartitionInput>()
                        .ok_or("failed to downcast to BatchCreatePartitionInput")?;
...
/// Error type for the `BatchCreatePartitionError` operation.
#[non_exhaustive]
...
pub enum BatchCreatePartitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchCreatePartitionError) for what information is available for the error.")]
...
impl BatchCreatePartitionError {
    /// Creates the `BatchCreatePartitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchCreatePartitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `BatchCreatePartitionError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `BatchCreatePartitionError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `BatchCreatePartitionError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `BatchCreatePartitionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `BatchCreatePartitionError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `BatchCreatePartitionError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `BatchCreatePartitionError::ResourceNumberLimitExceededException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for BatchCreatePartitionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchCreatePartitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_create_partition::BatchCreatePartitionError {
...
mod _batch_create_partition_output;
