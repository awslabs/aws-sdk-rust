...
pub type BatchCreatePartitionErrorKind = BatchCreatePartitionError;
...
impl BatchCreatePartitionError {
    ...
    /// Creates the `BatchCreatePartitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
