...
impl BatchCreatePartitionInput {
    /// Consumes the builder and constructs an Operation<[`BatchCreatePartition`](crate::operation::batch_create_partition::BatchCreatePartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_create_partition::BatchCreatePartition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_create_partition::BatchCreatePartitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_create_partition::ser_batch_create_partition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_create_partition::BatchCreatePartition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchCreatePartition", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchCreatePartition {
                type Output = std::result::Result<crate::operation::batch_create_partition::BatchCreatePartitionOutput, crate::operation::batch_create_partition::BatchCreatePartitionError>;
