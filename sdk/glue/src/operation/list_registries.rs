...
impl ListRegistriesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_registries::ListRegistries::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListRegistries {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_registries::de_list_registries_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_registries::de_list_registries_http_response(
                status, headers, body,
            )
        }
    }
