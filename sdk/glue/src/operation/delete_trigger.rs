...
impl DeleteTriggerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_trigger::DeleteTrigger::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_trigger::de_delete_trigger_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_trigger::de_delete_trigger_http_response_with_props(
                status, headers, body,
            )
        }
    }
