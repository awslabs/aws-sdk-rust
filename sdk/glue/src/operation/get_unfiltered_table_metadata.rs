...
impl GetUnfilteredTableMetadata {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "GetUnfilteredTableMetadata", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.GetUnfilteredTableMetadata",
                "rpc.service" = "Glue",
                "rpc.method" = "GetUnfilteredTableMetadata",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUnfilteredTableMetadata {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetUnfilteredTableMetadataRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetUnfilteredTableMetadataResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetUnfilteredTableMetadata")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetUnfilteredTableMetadata")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetUnfilteredTableMetadataTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetUnfilteredTableMetadataTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUnfilteredTableMetadataTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetUnfilteredTableMetadataInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("Region") {
            if let ::std::option::Option::Some(value) = input.region.as_deref() {
                captured.insert("Region", value);
            }
        }
        ...
        if requested.should_capture("ParentResourceArn") {
            if let ::std::option::Option::Some(value) = input.parent_resource_arn.as_deref() {
                captured.insert("ParentResourceArn", value);
            }
        }
        if requested.should_capture("RootResourceArn") {
            if let ::std::option::Option::Some(value) = input.root_resource_arn.as_deref() {
                captured.insert("RootResourceArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUnfilteredTableMetadataResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_unfiltered_table_metadata::de_get_unfiltered_table_metadata_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_unfiltered_table_metadata::de_get_unfiltered_table_metadata_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUnfilteredTableMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_unfiltered_table_metadata::ser_get_unfiltered_table_metadata_input(&input)?,
        );
...
impl ::std::error::Error for GetUnfilteredTableMetadataError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::PermissionTypeMismatchException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for GetUnfilteredTableMetadataError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::PermissionTypeMismatchException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetUnfilteredTableMetadataError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PermissionTypeMismatchException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
