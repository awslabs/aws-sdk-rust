...
/// Orchestration and serialization glue logic for `GetUnfilteredTableMetadata`.
...
impl GetUnfilteredTableMetadata {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUnfilteredTableMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetUnfilteredTableMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetUnfilteredTableMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetUnfilteredTableMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetUnfilteredTableMetadata")
...
.with_interceptor(GetUnfilteredTableMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError>::new());
...
#[derive(Debug)]
            struct GetUnfilteredTableMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUnfilteredTableMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_unfiltered_table_metadata::de_get_unfiltered_table_metadata_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_unfiltered_table_metadata::de_get_unfiltered_table_metadata_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetUnfilteredTableMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUnfilteredTableMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_unfiltered_table_metadata::ser_get_unfiltered_table_metadata_input(&input)?);
...
#[derive(Debug)]
            struct GetUnfilteredTableMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUnfilteredTableMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetUnfilteredTableMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetUnfilteredTableMetadataInput>()
                        .ok_or("failed to downcast to GetUnfilteredTableMetadataInput")?;
...
/// Error type for the `GetUnfilteredTableMetadataError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetUnfilteredTableMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetUnfilteredTableMetadataError) for what information is available for the error.")]
...
impl GetUnfilteredTableMetadataError {
    /// Creates the `GetUnfilteredTableMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetUnfilteredTableMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::FederationSourceException`.
    pub fn is_federation_source_exception(&self) -> bool {
        matches!(self, Self::FederationSourceException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::FederationSourceRetryableException`.
    pub fn is_federation_source_retryable_exception(&self) -> bool {
        matches!(self, Self::FederationSourceRetryableException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredTableMetadataError::PermissionTypeMismatchException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetUnfilteredTableMetadataError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetUnfilteredTableMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError {
...
mod _get_unfiltered_table_metadata_output;
