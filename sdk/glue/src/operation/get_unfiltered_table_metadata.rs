    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetUnfilteredTableMetadataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetUnfilteredTableMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetUnfilteredTableMetadataEndpointParamsInterceptor {
...
pub type GetUnfilteredTableMetadataErrorKind = GetUnfilteredTableMetadataError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataError {
...
impl GetUnfilteredTableMetadataError {
    ...
    /// Creates the `GetUnfilteredTableMetadataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
