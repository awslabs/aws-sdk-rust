...
impl GetUnfilteredTableMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUnfilteredTableMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_unfiltered_table_metadata::de_get_unfiltered_table_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
