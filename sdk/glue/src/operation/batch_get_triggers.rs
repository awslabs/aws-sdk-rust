...
impl BatchGetTriggersInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_triggers::ser_batch_get_triggers_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetTriggers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_triggers::de_batch_get_triggers_http_response_with_props(status, headers, body)
        }
    }
}
