...
impl SearchTablesInput {
    /// Consumes the builder and constructs an Operation<[`SearchTables`](crate::operation::search_tables::SearchTables)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::search_tables::SearchTables, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_tables::SearchTablesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_tables::ser_search_tables_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::search_tables::SearchTables::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SearchTables", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for SearchTables {
                type Output = std::result::Result<crate::operation::search_tables::SearchTablesOutput, crate::operation::search_tables::SearchTablesError>;
