...
impl GetPartitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_partition::GetPartition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_partition::GetPartition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPartition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_partition::de_get_partition_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_partition::de_get_partition_http_response_with_props(
                status, headers, body,
            )
        }
    }
