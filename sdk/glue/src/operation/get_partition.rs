...
impl GetPartitionInput {
    /// Consumes the builder and constructs an Operation<[`GetPartition`](crate::operation::get_partition::GetPartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_partition::GetPartition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_partition::GetPartitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_partition::ser_get_partition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_partition::GetPartition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPartition", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPartition {
                type Output = std::result::Result<crate::operation::get_partition::GetPartitionOutput, crate::operation::get_partition::GetPartitionError>;
