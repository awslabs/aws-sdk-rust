...
impl GetDatabasesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_databases::GetDatabases, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_databases::ser_get_databases_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatabases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_databases::de_get_databases_http_response_with_props(status, headers, body)
        }
    }
}
