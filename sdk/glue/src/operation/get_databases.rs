...
impl GetDatabasesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_databases::GetDatabases::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDatabases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_databases::de_get_databases_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_databases::de_get_databases_http_response_with_props(
                status, headers, body,
            )
        }
    }
