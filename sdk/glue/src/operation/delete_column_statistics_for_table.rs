...
impl DeleteColumnStatisticsForTableInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTable,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteColumnStatisticsForTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_column_statistics_for_table::de_delete_column_statistics_for_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
