...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteColumnStatisticsForTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_column_statistics_for_table::de_delete_column_statistics_for_table_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteColumnStatisticsForTableError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTableError
{
