...
impl UpdateJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_job::UpdateJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_job::ser_update_job_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_job::UpdateJob::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateJob", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_job::de_update_job_http_response_with_props(status, headers, body)
        }
    }
}
