...
impl StartColumnStatisticsTaskRunFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_column_statistics_task_run::StartColumnStatisticsTaskRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_column_statistics_task_run::StartColumnStatisticsTaskRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_column_statistics_task_run::StartColumnStatisticsTaskRunOutput, crate::operation::start_column_statistics_task_run::StartColumnStatisticsTaskRunError, Self> {
