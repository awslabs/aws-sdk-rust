...
impl UpdateClassifierInput {
    /// Consumes the builder and constructs an Operation<[`UpdateClassifier`](crate::operation::update_classifier::UpdateClassifier)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_classifier::UpdateClassifier, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_classifier::UpdateClassifierInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_classifier::ser_update_classifier_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_classifier::UpdateClassifier::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateClassifier", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateClassifier {
                type Output = std::result::Result<crate::operation::update_classifier::UpdateClassifierOutput, crate::operation::update_classifier::UpdateClassifierError>;
