...
impl BatchStopJobRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_stop_job_run::BatchStopJobRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_stop_job_run::ser_batch_stop_job_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchStopJobRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_stop_job_run::de_batch_stop_job_run_http_response_with_props(status, headers, body)
        }
    }
}
