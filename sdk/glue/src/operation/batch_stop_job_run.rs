    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_stop_job_run::BatchStopJobRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_stop_job_run::BatchStopJobRunOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchStopJobRun {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchStopJobRun")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(BatchStopJobRunEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchStopJobRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchStopJobRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_stop_job_run::BatchStopJobRunInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_stop_job_run::ser_batch_stop_job_run_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchStopJobRunEndpointParamsInterceptor {
...
pub type BatchStopJobRunErrorKind = BatchStopJobRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_stop_job_run::BatchStopJobRunError {
...
impl BatchStopJobRunError {
    ...
    /// Creates the `BatchStopJobRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
