...
impl GetUserDefinedFunctionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_user_defined_functions::GetUserDefinedFunctionsInput, ::aws_smithy_types::error::operation::BuildError> {
