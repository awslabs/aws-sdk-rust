...
impl GetClassifierInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_classifier::GetClassifier, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_classifier::ser_get_classifier_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClassifier {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_classifier::de_get_classifier_http_response_with_props(status, headers, body)
        }
    }
}
