    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_ml_transforms::ListMLTransformsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_ml_transforms::ListMlTransformsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMLTransforms {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMLTransforms")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListMLTransformsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListMLTransformsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListMLTransformsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_ml_transforms::ListMlTransformsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_ml_transforms::ser_list_ml_transforms_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListMLTransformsEndpointParamsInterceptor {
...
pub type ListMLTransformsErrorKind = ListMLTransformsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_ml_transforms::ListMLTransformsError {
...
impl ListMLTransformsError {
    ...
    /// Creates the `ListMLTransformsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
