...
impl CancelMlTaskRunInput {
    /// Consumes the builder and constructs an Operation<[`CancelMLTaskRun`](crate::operation::cancel_ml_task_run::CancelMLTaskRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_ml_task_run::CancelMLTaskRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_ml_task_run::CancelMlTaskRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_ml_task_run::ser_cancel_ml_task_run_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_ml_task_run::CancelMLTaskRun::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelMLTaskRun", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for CancelMLTaskRun {
                type Output = std::result::Result<crate::operation::cancel_ml_task_run::CancelMlTaskRunOutput, crate::operation::cancel_ml_task_run::CancelMLTaskRunError>;
