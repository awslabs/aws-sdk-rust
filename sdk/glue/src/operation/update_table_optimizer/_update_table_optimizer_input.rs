...
impl UpdateTableOptimizerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_table_optimizer::UpdateTableOptimizerInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::update_table_optimizer::UpdateTableOptimizerInput {
