...
/// Orchestration and serialization glue logic for `DeleteDataQualityRuleset`.
...
impl DeleteDataQualityRuleset {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDataQualityRuleset {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteDataQualityRuleset");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteDataQualityRulesetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteDataQualityRulesetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteDataQualityRuleset")
...
.with_interceptor(DeleteDataQualityRulesetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetError>::new());
...
#[derive(Debug)]
            struct DeleteDataQualityRulesetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteDataQualityRulesetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_data_quality_ruleset::de_delete_data_quality_ruleset_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_data_quality_ruleset::de_delete_data_quality_ruleset_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteDataQualityRulesetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteDataQualityRulesetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_data_quality_ruleset::ser_delete_data_quality_ruleset_input(&input)?);
...
#[derive(Debug)]
            struct DeleteDataQualityRulesetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteDataQualityRulesetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteDataQualityRulesetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteDataQualityRulesetInput>()
                        .ok_or("failed to downcast to DeleteDataQualityRulesetInput")?;
...
/// Error type for the `DeleteDataQualityRulesetError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteDataQualityRulesetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteDataQualityRulesetError) for what information is available for the error.")]
...
impl DeleteDataQualityRulesetError {
    /// Creates the `DeleteDataQualityRulesetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDataQualityRulesetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteDataQualityRulesetError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteDataQualityRulesetError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteDataQualityRulesetError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteDataQualityRulesetError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteDataQualityRulesetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteDataQualityRulesetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetError {
...
mod _delete_data_quality_ruleset_output;
