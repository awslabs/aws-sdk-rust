...
impl GetColumnStatisticsForPartitionInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
