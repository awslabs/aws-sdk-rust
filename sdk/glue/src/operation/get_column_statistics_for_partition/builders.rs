...
impl GetColumnStatisticsForPartitionFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError>>
                         {
        let op = self
            .inner
            .build()
