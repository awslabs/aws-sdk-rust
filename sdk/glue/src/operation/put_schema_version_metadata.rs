...
impl PutSchemaVersionMetadataInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_schema_version_metadata::PutSchemaVersionMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSchemaVersionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_schema_version_metadata::de_put_schema_version_metadata_http_response_with_props(status, headers, body)
        }
    }
}
