...
/// Orchestration and serialization glue logic for `PutSchemaVersionMetadata`.
...
impl PutSchemaVersionMetadata {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutSchemaVersionMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutSchemaVersionMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutSchemaVersionMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutSchemaVersionMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutSchemaVersionMetadata")
...
.with_interceptor(PutSchemaVersionMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataError>::new());
...
#[derive(Debug)]
            struct PutSchemaVersionMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutSchemaVersionMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_schema_version_metadata::de_put_schema_version_metadata_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_schema_version_metadata::de_put_schema_version_metadata_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutSchemaVersionMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutSchemaVersionMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_schema_version_metadata::ser_put_schema_version_metadata_input(&input)?);
...
#[derive(Debug)]
            struct PutSchemaVersionMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutSchemaVersionMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutSchemaVersionMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutSchemaVersionMetadataInput>()
                        .ok_or("failed to downcast to PutSchemaVersionMetadataInput")?;
...
/// Error type for the `PutSchemaVersionMetadataError` operation.
#[non_exhaustive]
...
pub enum PutSchemaVersionMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutSchemaVersionMetadataError) for what information is available for the error.")]
...
impl PutSchemaVersionMetadataError {
    /// Creates the `PutSchemaVersionMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutSchemaVersionMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `PutSchemaVersionMetadataError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `PutSchemaVersionMetadataError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `PutSchemaVersionMetadataError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `PutSchemaVersionMetadataError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `PutSchemaVersionMetadataError::ResourceNumberLimitExceededException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutSchemaVersionMetadataError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutSchemaVersionMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataError {
...
mod _put_schema_version_metadata_output;
