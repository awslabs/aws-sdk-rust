...
impl CreateUserDefinedFunctionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_user_defined_function::CreateUserDefinedFunction::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUserDefinedFunction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_user_defined_function::de_create_user_defined_function_http_response_with_props(status, headers, body)
        }
    }
}
