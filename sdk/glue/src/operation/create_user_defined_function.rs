    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_user_defined_function::CreateUserDefinedFunctionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_user_defined_function::CreateUserDefinedFunctionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateUserDefinedFunction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateUserDefinedFunction", "glue"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateUserDefinedFunction")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateUserDefinedFunctionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateUserDefinedFunctionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_user_defined_function::CreateUserDefinedFunctionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateUserDefinedFunctionEndpointParamsInterceptor {
...
pub type CreateUserDefinedFunctionErrorKind = CreateUserDefinedFunctionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_user_defined_function::CreateUserDefinedFunctionError {
...
impl CreateUserDefinedFunctionError {
    ...
    /// Creates the `CreateUserDefinedFunctionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
