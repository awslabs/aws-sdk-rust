...
impl GetJobRunsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_job_runs::GetJobRuns, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_job_runs::ser_get_job_runs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJobRuns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_job_runs::de_get_job_runs_http_response_with_props(status, headers, body)
        }
    }
}
