    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutDataCatalogEncryptionSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutDataCatalogEncryptionSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutDataCatalogEncryptionSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutDataCatalogEncryptionSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutDataCatalogEncryptionSettings")
...
.with_interceptor(PutDataCatalogEncryptionSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsError>::new());
...
#[derive(Debug)]
            struct PutDataCatalogEncryptionSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutDataCatalogEncryptionSettingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_data_catalog_encryption_settings::de_put_data_catalog_encryption_settings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_data_catalog_encryption_settings::de_put_data_catalog_encryption_settings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutDataCatalogEncryptionSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutDataCatalogEncryptionSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_data_catalog_encryption_settings::ser_put_data_catalog_encryption_settings_input(&input)?);
...
#[derive(Debug)]
            struct PutDataCatalogEncryptionSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutDataCatalogEncryptionSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutDataCatalogEncryptionSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutDataCatalogEncryptionSettingsInput>()
                        .ok_or("failed to downcast to PutDataCatalogEncryptionSettingsInput")?;
...
/// Error type for the `PutDataCatalogEncryptionSettingsError` operation.
#[non_exhaustive]
...
pub enum PutDataCatalogEncryptionSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutDataCatalogEncryptionSettingsError) for what information is available for the error.")]
...
impl PutDataCatalogEncryptionSettingsError {
    /// Creates the `PutDataCatalogEncryptionSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutDataCatalogEncryptionSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `PutDataCatalogEncryptionSettingsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `PutDataCatalogEncryptionSettingsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `PutDataCatalogEncryptionSettingsError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutDataCatalogEncryptionSettingsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutDataCatalogEncryptionSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettingsError {
...
mod _put_data_catalog_encryption_settings_output;
