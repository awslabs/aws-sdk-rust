...
impl PutDataCatalogEncryptionSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettings,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_data_catalog_encryption_settings::PutDataCatalogEncryptionSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDataCatalogEncryptionSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_data_catalog_encryption_settings::de_put_data_catalog_encryption_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
