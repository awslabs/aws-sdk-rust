...
impl DeleteUserDefinedFunctionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserDefinedFunction`](crate::operation::delete_user_defined_function::DeleteUserDefinedFunction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_user_defined_function::DeleteUserDefinedFunction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_user_defined_function::ser_delete_user_defined_function_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_defined_function::DeleteUserDefinedFunction::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteUserDefinedFunction", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteUserDefinedFunction {
                type Output = std::result::Result<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionOutput, crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError>;
