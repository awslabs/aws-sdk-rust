    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteUserDefinedFunction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteUserDefinedFunction", "glue"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteUserDefinedFunction")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteUserDefinedFunctionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteUserDefinedFunctionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteUserDefinedFunctionEndpointParamsInterceptor {
...
pub type DeleteUserDefinedFunctionErrorKind = DeleteUserDefinedFunctionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError {
...
impl DeleteUserDefinedFunctionError {
    ...
    /// Creates the `DeleteUserDefinedFunctionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
