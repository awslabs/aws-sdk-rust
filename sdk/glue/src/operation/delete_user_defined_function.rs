...
/// Orchestration and serialization glue logic for `DeleteUserDefinedFunction`.
...
impl DeleteUserDefinedFunction {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionInput,
                    ) -> ::std::result::Result<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteUserDefinedFunction {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteUserDefinedFunction");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteUserDefinedFunctionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteUserDefinedFunctionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteUserDefinedFunction")
...
.with_interceptor(DeleteUserDefinedFunctionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError>::new());
...
#[derive(Debug)]
            struct DeleteUserDefinedFunctionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteUserDefinedFunctionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_user_defined_function::de_delete_user_defined_function_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteUserDefinedFunctionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteUserDefinedFunctionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_user_defined_function::ser_delete_user_defined_function_input(&input)?);
...
#[derive(Debug)]
            struct DeleteUserDefinedFunctionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteUserDefinedFunctionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteUserDefinedFunctionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteUserDefinedFunctionInput>()
                        .ok_or("failed to downcast to DeleteUserDefinedFunctionInput")?;
...
/// Error type for the `DeleteUserDefinedFunctionError` operation.
#[non_exhaustive]
...
pub enum DeleteUserDefinedFunctionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteUserDefinedFunctionError) for what information is available for the error.")]
...
impl DeleteUserDefinedFunctionError {
    /// Creates the `DeleteUserDefinedFunctionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteUserDefinedFunctionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteUserDefinedFunctionError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserDefinedFunctionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserDefinedFunctionError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserDefinedFunctionError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteUserDefinedFunctionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteUserDefinedFunctionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionError {
...
mod _delete_user_defined_function_output;
