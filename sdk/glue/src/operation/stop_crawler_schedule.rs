...
/// Orchestration and serialization glue logic for `StopCrawlerSchedule`.
...
impl StopCrawlerSchedule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_crawler_schedule::StopCrawlerScheduleInput,
                    ) -> ::std::result::Result<crate::operation::stop_crawler_schedule::StopCrawlerScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_crawler_schedule::StopCrawlerScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_crawler_schedule::StopCrawlerScheduleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_crawler_schedule::StopCrawlerScheduleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopCrawlerSchedule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopCrawlerSchedule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopCrawlerScheduleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopCrawlerScheduleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopCrawlerSchedule")
...
.with_interceptor(StopCrawlerScheduleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_crawler_schedule::StopCrawlerScheduleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_crawler_schedule::StopCrawlerScheduleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_crawler_schedule::StopCrawlerScheduleError>::new());
...
#[derive(Debug)]
            struct StopCrawlerScheduleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopCrawlerScheduleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_crawler_schedule::de_stop_crawler_schedule_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StopCrawlerScheduleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopCrawlerScheduleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_crawler_schedule::StopCrawlerScheduleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_crawler_schedule::StopCrawlerScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_crawler_schedule::ser_stop_crawler_schedule_input(&input)?);
...
#[derive(Debug)]
            struct StopCrawlerScheduleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopCrawlerScheduleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopCrawlerScheduleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopCrawlerScheduleInput>()
                        .ok_or("failed to downcast to StopCrawlerScheduleInput")?;
...
/// Error type for the `StopCrawlerScheduleError` operation.
#[non_exhaustive]
...
pub enum StopCrawlerScheduleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopCrawlerScheduleError) for what information is available for the error.")]
...
impl StopCrawlerScheduleError {
    /// Creates the `StopCrawlerScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopCrawlerScheduleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::SchedulerNotRunningException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::SchedulerTransitioningException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::Unhandled(e) => &e.meta,
        }
    }
    /// Returns `true` if the error kind is `StopCrawlerScheduleError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StopCrawlerScheduleError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `StopCrawlerScheduleError::SchedulerNotRunningException`.
    pub fn is_scheduler_not_running_exception(&self) -> bool {
        matches!(self, Self::SchedulerNotRunningException(_))
    }
    /// Returns `true` if the error kind is `StopCrawlerScheduleError::SchedulerTransitioningException`.
...
impl ::std::error::Error for StopCrawlerScheduleError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::SchedulerNotRunningException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopCrawlerScheduleError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopCrawlerScheduleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_crawler_schedule::StopCrawlerScheduleError {
...
mod _stop_crawler_schedule_output;
