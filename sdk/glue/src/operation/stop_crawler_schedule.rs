...
impl StopCrawlerScheduleInput {
    /// Consumes the builder and constructs an Operation<[`StopCrawlerSchedule`](crate::operation::stop_crawler_schedule::StopCrawlerSchedule)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_crawler_schedule::StopCrawlerSchedule::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopCrawlerSchedule", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopCrawlerSchedule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_crawler_schedule::de_stop_crawler_schedule_http_response_with_props(status, headers, body)
        }
    }
}
