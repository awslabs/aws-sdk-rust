...
impl StopCrawlerScheduleInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_crawler_schedule::StopCrawlerSchedule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_crawler_schedule::StopCrawlerScheduleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_crawler_schedule::ser_stop_crawler_schedule_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for StopCrawlerSchedule {
                type Output = std::result::Result<crate::operation::stop_crawler_schedule::StopCrawlerScheduleOutput, crate::operation::stop_crawler_schedule::StopCrawlerScheduleError>;
