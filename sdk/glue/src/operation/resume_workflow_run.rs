...
impl ResumeWorkflowRunInput {
    /// Consumes the builder and constructs an Operation<[`ResumeWorkflowRun`](crate::operation::resume_workflow_run::ResumeWorkflowRun)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resume_workflow_run::ser_resume_workflow_run_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resume_workflow_run::ResumeWorkflowRun::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResumeWorkflowRun", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeWorkflowRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_resume_workflow_run::de_resume_workflow_run_http_response_with_props(status, headers, body)
        }
    }
}
