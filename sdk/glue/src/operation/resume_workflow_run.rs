...
/// Orchestration and serialization glue logic for `ResumeWorkflowRun`.
...
impl ResumeWorkflowRun {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::resume_workflow_run::ResumeWorkflowRunInput,
                    ) -> ::std::result::Result<crate::operation::resume_workflow_run::ResumeWorkflowRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resume_workflow_run::ResumeWorkflowRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::resume_workflow_run::ResumeWorkflowRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::resume_workflow_run::ResumeWorkflowRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResumeWorkflowRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ResumeWorkflowRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ResumeWorkflowRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ResumeWorkflowRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResumeWorkflowRun")
...
.with_interceptor(ResumeWorkflowRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::resume_workflow_run::ResumeWorkflowRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::resume_workflow_run::ResumeWorkflowRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::resume_workflow_run::ResumeWorkflowRunError>::new());
...
#[derive(Debug)]
            struct ResumeWorkflowRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResumeWorkflowRunResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_resume_workflow_run::de_resume_workflow_run_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_resume_workflow_run::de_resume_workflow_run_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ResumeWorkflowRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResumeWorkflowRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::resume_workflow_run::ResumeWorkflowRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::resume_workflow_run::ResumeWorkflowRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_resume_workflow_run::ser_resume_workflow_run_input(&input)?);
...
#[derive(Debug)]
            struct ResumeWorkflowRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResumeWorkflowRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ResumeWorkflowRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ResumeWorkflowRunInput>()
                        .ok_or("failed to downcast to ResumeWorkflowRunInput")?;
...
/// Error type for the `ResumeWorkflowRunError` operation.
#[non_exhaustive]
...
pub enum ResumeWorkflowRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ResumeWorkflowRunError) for what information is available for the error.")]
...
impl ResumeWorkflowRunError {
    /// Creates the `ResumeWorkflowRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResumeWorkflowRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ConcurrentRunsExceededException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::EntityNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::IllegalWorkflowStateException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `ResumeWorkflowRunError::ConcurrentRunsExceededException`.
    pub fn is_concurrent_runs_exceeded_exception(&self) -> bool {
        matches!(self, Self::ConcurrentRunsExceededException(_))
    }
    /// Returns `true` if the error kind is `ResumeWorkflowRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ResumeWorkflowRunError::IllegalWorkflowStateException`.
    pub fn is_illegal_workflow_state_exception(&self) -> bool {
        matches!(self, Self::IllegalWorkflowStateException(_))
    }
    /// Returns `true` if the error kind is `ResumeWorkflowRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ResumeWorkflowRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ResumeWorkflowRunError::OperationTimeoutException`.
...
impl ::std::error::Error for ResumeWorkflowRunError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::ConcurrentRunsExceededException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::EntityNotFoundException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
            Self::IllegalWorkflowStateException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ResumeWorkflowRunError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ResumeWorkflowRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::resume_workflow_run::ResumeWorkflowRunError {
...
mod _resume_workflow_run_output;
