    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::resume_workflow_run::ResumeWorkflowRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::resume_workflow_run::ResumeWorkflowRunOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResumeWorkflowRun")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ResumeWorkflowRunEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ResumeWorkflowRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ResumeWorkflowRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::resume_workflow_run::ResumeWorkflowRunInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_resume_workflow_run::ser_resume_workflow_run_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ResumeWorkflowRunEndpointParamsInterceptor {
...
pub type ResumeWorkflowRunErrorKind = ResumeWorkflowRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::resume_workflow_run::ResumeWorkflowRunError {
...
impl ResumeWorkflowRunError {
    ...
    /// Creates the `ResumeWorkflowRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            Self::ConcurrentRunsExceededException(e) => e.meta(),
            Self::EntityNotFoundException(e) => e.meta(),
            Self::IllegalWorkflowStateException(e) => e.meta(),
