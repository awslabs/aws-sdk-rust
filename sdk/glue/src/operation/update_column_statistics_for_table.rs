...
impl UpdateColumnStatisticsForTableInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_column_statistics_for_table::UpdateColumnStatisticsForTable,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_column_statistics_for_table::UpdateColumnStatisticsForTable::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateColumnStatisticsForTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_column_statistics_for_table::de_update_column_statistics_for_table_http_response_with_props(
                status, headers, body,
            )
        }
    }
