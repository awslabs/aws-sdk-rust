...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateColumnStatisticsForTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_column_statistics_for_table::de_update_column_statistics_for_table_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateColumnStatisticsForTableError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_column_statistics_for_table::UpdateColumnStatisticsForTableError
{
