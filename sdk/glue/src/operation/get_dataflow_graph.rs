...
impl GetDataflowGraphInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_dataflow_graph::ser_get_dataflow_graph_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataflowGraph {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_dataflow_graph::de_get_dataflow_graph_http_response_with_props(status, headers, body)
        }
    }
}
