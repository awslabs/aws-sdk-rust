    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_dataflow_graph::GetDataflowGraphError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_dataflow_graph::GetDataflowGraphOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDataflowGraph {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDataflowGraph")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetDataflowGraphEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetDataflowGraphResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetDataflowGraphRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_dataflow_graph::GetDataflowGraphInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_dataflow_graph::ser_get_dataflow_graph_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetDataflowGraphEndpointParamsInterceptor {
...
pub type GetDataflowGraphErrorKind = GetDataflowGraphError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_dataflow_graph::GetDataflowGraphError {
...
impl GetDataflowGraphError {
    ...
    /// Creates the `GetDataflowGraphError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
