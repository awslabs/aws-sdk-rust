    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetSchemaByDefinitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetSchemaByDefinitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_schema_by_definition::ser_get_schema_by_definition_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetSchemaByDefinitionEndpointParamsInterceptor {
...
pub type GetSchemaByDefinitionErrorKind = GetSchemaByDefinitionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_schema_by_definition::GetSchemaByDefinitionError {
...
impl GetSchemaByDefinitionError {
    ...
    /// Creates the `GetSchemaByDefinitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
