...
impl GetSchemaByDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_schema_by_definition::GetSchemaByDefinition,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSchemaByDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_schema_by_definition::de_get_schema_by_definition_http_response_with_props(status, headers, body)
        }
    }
}
