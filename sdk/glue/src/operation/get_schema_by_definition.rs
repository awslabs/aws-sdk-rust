...
/// Orchestration and serialization glue logic for `GetSchemaByDefinition`.
...
impl GetSchemaByDefinition {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_schema_by_definition::GetSchemaByDefinitionInput,
                    ) -> ::std::result::Result<crate::operation::get_schema_by_definition::GetSchemaByDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSchemaByDefinition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSchemaByDefinition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSchemaByDefinitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSchemaByDefinitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSchemaByDefinition")
...
.with_interceptor(GetSchemaByDefinitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError>::new());
...
#[derive(Debug)]
            struct GetSchemaByDefinitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSchemaByDefinitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_schema_by_definition::de_get_schema_by_definition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_schema_by_definition::de_get_schema_by_definition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetSchemaByDefinitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSchemaByDefinitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_schema_by_definition::GetSchemaByDefinitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_schema_by_definition::GetSchemaByDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_schema_by_definition::ser_get_schema_by_definition_input(&input)?);
...
#[derive(Debug)]
            struct GetSchemaByDefinitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSchemaByDefinitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSchemaByDefinitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSchemaByDefinitionInput>()
                        .ok_or("failed to downcast to GetSchemaByDefinitionInput")?;
...
/// Error type for the `GetSchemaByDefinitionError` operation.
#[non_exhaustive]
...
pub enum GetSchemaByDefinitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSchemaByDefinitionError) for what information is available for the error.")]
...
impl GetSchemaByDefinitionError {
    /// Creates the `GetSchemaByDefinitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSchemaByDefinitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetSchemaByDefinitionError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaByDefinitionError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaByDefinitionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaByDefinitionError::InvalidInputException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSchemaByDefinitionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSchemaByDefinitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_schema_by_definition::GetSchemaByDefinitionError {
...
mod _get_schema_by_definition_output;
