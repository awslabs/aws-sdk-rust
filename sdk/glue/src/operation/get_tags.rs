...
impl GetTagsInput {
    /// Consumes the builder and constructs an Operation<[`GetTags`](crate::operation::get_tags::GetTags)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_tags::GetTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_tags::ser_get_tags_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_tags::GetTags::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTags {
    type Output = ::std::result::Result<crate::operation::get_tags::GetTagsOutput, crate::operation::get_tags::GetTagsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_tags::de_get_tags_http_response_with_props(status, headers, body)
        }
    }
}
