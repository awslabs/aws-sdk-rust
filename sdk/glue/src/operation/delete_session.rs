...
impl DeleteSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_session::DeleteSession, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_session::ser_delete_session_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_session::DeleteSession::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteSession", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_session::de_delete_session_http_response_with_props(status, headers, body)
        }
    }
}
