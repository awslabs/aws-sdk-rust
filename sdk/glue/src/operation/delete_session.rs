...
impl DeleteSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_session::DeleteSession,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_session::DeleteSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_session::de_delete_session_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_session::de_delete_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
