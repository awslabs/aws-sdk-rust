...
impl GetDataCatalogEncryptionSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataCatalogEncryptionSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_data_catalog_encryption_settings::de_get_data_catalog_encryption_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
