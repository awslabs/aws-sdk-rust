...
/// Orchestration and serialization glue logic for `UpdateColumnStatisticsForPartition`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateColumnStatisticsForPartition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateColumnStatisticsForPartition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateColumnStatisticsForPartitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateColumnStatisticsForPartitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateColumnStatisticsForPartition")
...
.with_interceptor(UpdateColumnStatisticsForPartitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionError>::new());
...
#[derive(Debug)]
            struct UpdateColumnStatisticsForPartitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateColumnStatisticsForPartitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_column_statistics_for_partition::de_update_column_statistics_for_partition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_column_statistics_for_partition::de_update_column_statistics_for_partition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateColumnStatisticsForPartitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateColumnStatisticsForPartitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_column_statistics_for_partition::ser_update_column_statistics_for_partition_input(&input)?);
...
#[derive(Debug)]
            struct UpdateColumnStatisticsForPartitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateColumnStatisticsForPartitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateColumnStatisticsForPartitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateColumnStatisticsForPartitionInput>()
                        .ok_or("failed to downcast to UpdateColumnStatisticsForPartitionInput")?;
...
/// Error type for the `UpdateColumnStatisticsForPartitionError` operation.
#[non_exhaustive]
...
pub enum UpdateColumnStatisticsForPartitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateColumnStatisticsForPartitionError) for what information is available for the error.")]
...
impl UpdateColumnStatisticsForPartitionError {
    /// Creates the `UpdateColumnStatisticsForPartitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateColumnStatisticsForPartitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateColumnStatisticsForPartitionError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateColumnStatisticsForPartitionError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `UpdateColumnStatisticsForPartitionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateColumnStatisticsForPartitionError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateColumnStatisticsForPartitionError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateColumnStatisticsForPartitionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateColumnStatisticsForPartitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartitionError {
...
mod _update_column_statistics_for_partition_output;
