...
impl UpdateColumnStatisticsForPartitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_column_statistics_for_partition::UpdateColumnStatisticsForPartition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateColumnStatisticsForPartition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_column_statistics_for_partition::de_update_column_statistics_for_partition_http_response_with_props(
                status, headers, body,
            )
        }
    }
