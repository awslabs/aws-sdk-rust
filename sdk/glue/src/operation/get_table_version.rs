...
impl GetTableVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_table_version::GetTableVersion, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_table_version::ser_get_table_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTableVersion {
    type Output =
        ::std::result::Result<crate::operation::get_table_version::GetTableVersionOutput, crate::operation::get_table_version::GetTableVersionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_table_version::de_get_table_version_http_response_with_props(status, headers, body)
        }
    }
}
