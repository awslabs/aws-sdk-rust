...
impl PutSchemaVersionMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_schema_version_metadata::PutSchemaVersionMetadataInput, ::aws_smithy_types::error::operation::BuildError> {
