...
impl DeleteDataQualityRulesetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_data_quality_ruleset::DeleteDataQualityRulesetInput, ::aws_smithy_types::error::operation::BuildError> {
