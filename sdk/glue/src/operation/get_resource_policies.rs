...
impl GetResourcePoliciesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_resource_policies::ser_get_resource_policies_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource_policies::GetResourcePolicies::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_resource_policies::GetResourcePoliciesError
{
