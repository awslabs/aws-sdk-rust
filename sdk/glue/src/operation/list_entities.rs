...
/// Orchestration and serialization glue logic for `ListEntities`.
...
impl ListEntities {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_entities::ListEntitiesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_entities::ListEntitiesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "ListEntities", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.ListEntities",
                "rpc.service" = "Glue",
                "rpc.method" = "ListEntities",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEntities {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEntities");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListEntitiesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListEntitiesResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListEntities", "Glue"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEntities")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListEntitiesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListEntitiesEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct ListEntitiesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEntitiesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListEntitiesInput>() else {
        ...
        if requested.should_capture("ParentEntityName") {
            if let ::std::option::Option::Some(value) = input.parent_entity_name.as_deref() {
                captured.insert("ParentEntityName", value);
            }
        }
...
#[derive(Debug)]
struct ListEntitiesResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEntitiesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_entities::de_list_entities_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_entities::de_list_entities_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ListEntitiesRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEntitiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_entities::ListEntitiesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_entities::ListEntitiesInput,
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "AWSGlue.ListEntities",
            );
            builder
        };
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_entities::ser_list_entities_input(&input)?);
...
#[derive(Debug)]
struct ListEntitiesEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEntitiesEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ListEntitiesEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListEntitiesInput>()
            .ok_or("failed to downcast to ListEntitiesInput")?;
...
pub enum ListEntitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEntitiesError) for what information is available for the error.")]
...
impl ListEntitiesError {
    ...
    /// Creates the `ListEntitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListEntitiesError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListEntitiesError::FederationSourceException`.
    pub fn is_federation_source_exception(&self) -> bool {
        matches!(self, Self::FederationSourceException(_))
    }
    /// Returns `true` if the error kind is `ListEntitiesError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `ListEntitiesError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListEntitiesError::OperationTimeoutException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEntitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_entities::ListEntitiesError {
