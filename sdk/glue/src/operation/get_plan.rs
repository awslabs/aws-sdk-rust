...
impl GetPlanInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_plan::GetPlan, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_plan::ser_get_plan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_plan::de_get_plan_http_response_with_props(status, headers, body)
        }
    }
}
