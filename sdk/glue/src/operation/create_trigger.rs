...
impl CreateTriggerInput {
    /// Consumes the builder and constructs an Operation<[`CreateTrigger`](crate::operation::create_trigger::CreateTrigger)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_trigger::CreateTrigger, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_trigger::CreateTriggerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_trigger::ser_create_trigger_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_trigger::CreateTrigger::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateTrigger", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateTrigger {
                type Output = std::result::Result<crate::operation::create_trigger::CreateTriggerOutput, crate::operation::create_trigger::CreateTriggerError>;
