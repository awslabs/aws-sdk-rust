...
impl CreateTriggerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_trigger::CreateTrigger, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_trigger::ser_create_trigger_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_trigger::de_create_trigger_http_response_with_props(status, headers, body)
        }
    }
}
