...
impl BatchGetCustomEntityTypes {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("glue", "BatchGetCustomEntityTypes", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetCustomEntityTypes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            BatchGetCustomEntityTypesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            BatchGetCustomEntityTypesResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("BatchGetCustomEntityTypes", "glue"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchGetCustomEntityTypes")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchGetCustomEntityTypesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchGetCustomEntityTypesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_custom_entity_types::ser_batch_get_custom_entity_types_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchGetCustomEntityTypesEndpointParamsInterceptor {
...
pub type BatchGetCustomEntityTypesErrorKind = BatchGetCustomEntityTypesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypesError {
...
impl BatchGetCustomEntityTypesError {
    ...
    /// Creates the `BatchGetCustomEntityTypesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
