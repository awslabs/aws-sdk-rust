...
impl BatchGetCustomEntityTypesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetCustomEntityTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_custom_entity_types::de_batch_get_custom_entity_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
