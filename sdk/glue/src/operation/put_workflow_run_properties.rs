...
pub type PutWorkflowRunPropertiesErrorKind = PutWorkflowRunPropertiesError;
...
impl PutWorkflowRunPropertiesError {
    ...
    /// Creates the `PutWorkflowRunPropertiesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
