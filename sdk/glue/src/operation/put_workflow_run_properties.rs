...
impl PutWorkflowRunPropertiesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_workflow_run_properties::PutWorkflowRunProperties::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutWorkflowRunProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_workflow_run_properties::de_put_workflow_run_properties_http_response_with_props(status, headers, body)
        }
    }
}
