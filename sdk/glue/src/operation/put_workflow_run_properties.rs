...
impl PutWorkflowRunProperties {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "PutWorkflowRunProperties", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.PutWorkflowRunProperties",
                "rpc.service" = "Glue",
                "rpc.method" = "PutWorkflowRunProperties",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutWorkflowRunProperties {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutWorkflowRunPropertiesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutWorkflowRunPropertiesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutWorkflowRunProperties")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutWorkflowRunProperties")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutWorkflowRunPropertiesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutWorkflowRunPropertiesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutWorkflowRunPropertiesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutWorkflowRunPropertiesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutWorkflowRunPropertiesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_workflow_run_properties::de_put_workflow_run_properties_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_workflow_run_properties::de_put_workflow_run_properties_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutWorkflowRunPropertiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_workflow_run_properties::ser_put_workflow_run_properties_input(&input)?,
        );
