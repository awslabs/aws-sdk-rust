...
/// Orchestration and serialization glue logic for `PutWorkflowRunProperties`.
...
impl PutWorkflowRunProperties {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput,
                    ) -> ::std::result::Result<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutWorkflowRunProperties {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutWorkflowRunProperties");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutWorkflowRunPropertiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutWorkflowRunPropertiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutWorkflowRunProperties")
...
.with_interceptor(PutWorkflowRunPropertiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError>::new());
...
#[derive(Debug)]
            struct PutWorkflowRunPropertiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutWorkflowRunPropertiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_workflow_run_properties::de_put_workflow_run_properties_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutWorkflowRunPropertiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutWorkflowRunPropertiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_workflow_run_properties::ser_put_workflow_run_properties_input(&input)?);
...
#[derive(Debug)]
            struct PutWorkflowRunPropertiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutWorkflowRunPropertiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutWorkflowRunPropertiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutWorkflowRunPropertiesInput>()
                        .ok_or("failed to downcast to PutWorkflowRunPropertiesInput")?;
...
/// Error type for the `PutWorkflowRunPropertiesError` operation.
#[non_exhaustive]
...
pub enum PutWorkflowRunPropertiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutWorkflowRunPropertiesError) for what information is available for the error.")]
...
impl PutWorkflowRunPropertiesError {
    /// Creates the `PutWorkflowRunPropertiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutWorkflowRunPropertiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `PutWorkflowRunPropertiesError::ResourceNumberLimitExceededException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutWorkflowRunPropertiesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutWorkflowRunPropertiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError {
...
mod _put_workflow_run_properties_output;
