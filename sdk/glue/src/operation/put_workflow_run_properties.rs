...
impl PutWorkflowRunPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`PutWorkflowRunProperties`](crate::operation::put_workflow_run_properties::PutWorkflowRunProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_workflow_run_properties::PutWorkflowRunProperties, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_workflow_run_properties::ser_put_workflow_run_properties_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_workflow_run_properties::PutWorkflowRunProperties::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutWorkflowRunProperties", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutWorkflowRunProperties {
                type Output = std::result::Result<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesOutput, crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesError>;
