...
impl CreateCustomEntityType {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_custom_entity_type::CreateCustomEntityTypeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_custom_entity_type::CreateCustomEntityTypeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "CreateCustomEntityType", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.CreateCustomEntityType",
                "rpc.service" = "Glue",
                "rpc.method" = "CreateCustomEntityType",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCustomEntityType {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateCustomEntityTypeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateCustomEntityTypeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateCustomEntityType")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCustomEntityType")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateCustomEntityTypeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateCustomEntityTypeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCustomEntityTypeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateCustomEntityTypeInput>() else {
        ...
        if requested.should_capture("RegexString") {
            if let ::std::option::Option::Some(value) = input.regex_string.as_deref() {
                captured.insert("RegexString", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCustomEntityTypeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_custom_entity_type::de_create_custom_entity_type_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_custom_entity_type::de_create_custom_entity_type_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCustomEntityTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_custom_entity_type::CreateCustomEntityTypeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_custom_entity_type::CreateCustomEntityTypeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_custom_entity_type::ser_create_custom_entity_type_input(&input)?,
        );
