...
impl GetBlueprintInput {
    /// Consumes the builder and constructs an Operation<[`GetBlueprint`](crate::operation::get_blueprint::GetBlueprint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_blueprint::GetBlueprint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_blueprint::GetBlueprintInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_blueprint::ser_get_blueprint_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_blueprint::GetBlueprint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBlueprint", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBlueprint {
                type Output = std::result::Result<crate::operation::get_blueprint::GetBlueprintOutput, crate::operation::get_blueprint::GetBlueprintError>;
