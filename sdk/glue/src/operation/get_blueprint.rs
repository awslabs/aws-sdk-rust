...
impl GetBlueprintInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_blueprint::GetBlueprint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_blueprint::ser_get_blueprint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlueprint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_blueprint::de_get_blueprint_http_response_with_props(status, headers, body)
        }
    }
}
