...
impl GetJobBookmarkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_job_bookmark::GetJobBookmark,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_job_bookmark::GetJobBookmark::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJobBookmark {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_job_bookmark::de_get_job_bookmark_http_error(
                status, headers, body,
            )
        } else {
