    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_job_bookmark::GetJobBookmarkError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_job_bookmark::GetJobBookmarkOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetJobBookmark {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetJobBookmark")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetJobBookmarkEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetJobBookmarkResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetJobBookmarkRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_job_bookmark::GetJobBookmarkInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_job_bookmark::ser_get_job_bookmark_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetJobBookmarkEndpointParamsInterceptor {
...
pub type GetJobBookmarkErrorKind = GetJobBookmarkError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_job_bookmark::GetJobBookmarkError {
...
impl GetJobBookmarkError {
    ...
    /// Creates the `GetJobBookmarkError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
