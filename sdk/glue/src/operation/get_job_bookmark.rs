...
/// Orchestration and serialization glue logic for `GetJobBookmark`.
...
impl GetJobBookmark {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_job_bookmark::GetJobBookmarkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_job_bookmark::GetJobBookmarkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_job_bookmark::GetJobBookmarkError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_job_bookmark::GetJobBookmarkOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetJobBookmark {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetJobBookmark");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetJobBookmarkRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetJobBookmarkResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetJobBookmark")
...
.with_interceptor(GetJobBookmarkEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_job_bookmark::GetJobBookmarkError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_job_bookmark::GetJobBookmarkError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_job_bookmark::GetJobBookmarkError>::new());
...
#[derive(Debug)]
            struct GetJobBookmarkResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetJobBookmarkResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_job_bookmark::de_get_job_bookmark_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetJobBookmarkRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetJobBookmarkRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_job_bookmark::GetJobBookmarkInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_job_bookmark::GetJobBookmarkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_job_bookmark::ser_get_job_bookmark_input(&input)?);
...
#[derive(Debug)]
            struct GetJobBookmarkEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetJobBookmarkEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetJobBookmarkEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetJobBookmarkInput>()
                        .ok_or("failed to downcast to GetJobBookmarkInput")?;
...
/// Error type for the `GetJobBookmarkError` operation.
#[non_exhaustive]
...
pub enum GetJobBookmarkError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetJobBookmarkError) for what information is available for the error.")]
...
impl GetJobBookmarkError {
    /// Creates the `GetJobBookmarkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetJobBookmarkError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetJobBookmarkError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetJobBookmarkError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetJobBookmarkError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetJobBookmarkError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `GetJobBookmarkError::ValidationException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetJobBookmarkError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetJobBookmarkError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_job_bookmark::GetJobBookmarkError {
