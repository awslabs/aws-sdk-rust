...
impl GetJobBookmarkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_job_bookmark::GetJobBookmark, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_job_bookmark::ser_get_job_bookmark_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJobBookmark {
    type Output =
        ::std::result::Result<crate::operation::get_job_bookmark::GetJobBookmarkOutput, crate::operation::get_job_bookmark::GetJobBookmarkError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_job_bookmark::de_get_job_bookmark_http_response_with_props(status, headers, body)
        }
    }
}
