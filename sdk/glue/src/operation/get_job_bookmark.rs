...
impl GetJobBookmarkInput {
    /// Consumes the builder and constructs an Operation<[`GetJobBookmark`](crate::operation::get_job_bookmark::GetJobBookmark)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_job_bookmark::GetJobBookmark, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_job_bookmark::GetJobBookmarkInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_job_bookmark::ser_get_job_bookmark_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_job_bookmark::GetJobBookmark::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetJobBookmark", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetJobBookmark {
                type Output = std::result::Result<crate::operation::get_job_bookmark::GetJobBookmarkOutput, crate::operation::get_job_bookmark::GetJobBookmarkError>;
