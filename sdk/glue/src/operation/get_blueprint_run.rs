...
impl GetBlueprintRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_blueprint_run::GetBlueprintRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_blueprint_run::ser_get_blueprint_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlueprintRun {
    type Output =
        ::std::result::Result<crate::operation::get_blueprint_run::GetBlueprintRunOutput, crate::operation::get_blueprint_run::GetBlueprintRunError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_blueprint_run::de_get_blueprint_run_http_response_with_props(status, headers, body)
        }
    }
}
