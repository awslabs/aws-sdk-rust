...
/// Orchestration and serialization glue logic for `GetBlueprintRun`.
...
impl GetBlueprintRun {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_blueprint_run::GetBlueprintRunInput,
                    ) -> ::std::result::Result<crate::operation::get_blueprint_run::GetBlueprintRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_blueprint_run::GetBlueprintRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_blueprint_run::GetBlueprintRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_blueprint_run::GetBlueprintRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBlueprintRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBlueprintRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBlueprintRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBlueprintRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBlueprintRun")
...
.with_interceptor(GetBlueprintRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_blueprint_run::GetBlueprintRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_blueprint_run::GetBlueprintRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_blueprint_run::GetBlueprintRunError>::new());
...
#[derive(Debug)]
            struct GetBlueprintRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBlueprintRunResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_blueprint_run::de_get_blueprint_run_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_blueprint_run::de_get_blueprint_run_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBlueprintRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBlueprintRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_blueprint_run::GetBlueprintRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_blueprint_run::GetBlueprintRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_blueprint_run::ser_get_blueprint_run_input(&input)?);
...
#[derive(Debug)]
            struct GetBlueprintRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBlueprintRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBlueprintRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBlueprintRunInput>()
                        .ok_or("failed to downcast to GetBlueprintRunInput")?;
...
/// Error type for the `GetBlueprintRunError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetBlueprintRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBlueprintRunError) for what information is available for the error.")]
...
impl GetBlueprintRunError {
    /// Creates the `GetBlueprintRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBlueprintRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetBlueprintRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetBlueprintRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetBlueprintRunError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetBlueprintRunError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBlueprintRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_blueprint_run::GetBlueprintRunError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_blueprint_run::_get_blueprint_run_output::GetBlueprintRunOutput;

pub use crate::operation::get_blueprint_run::_get_blueprint_run_input::GetBlueprintRunInput;

mod _get_blueprint_run_input;

mod _get_blueprint_run_output;
