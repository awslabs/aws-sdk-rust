    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_blueprint_run::GetBlueprintRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_blueprint_run::GetBlueprintRunOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBlueprintRun {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBlueprintRun")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetBlueprintRunEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetBlueprintRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetBlueprintRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_blueprint_run::GetBlueprintRunInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_blueprint_run::ser_get_blueprint_run_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetBlueprintRunEndpointParamsInterceptor {
...
pub type GetBlueprintRunErrorKind = GetBlueprintRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_blueprint_run::GetBlueprintRunError {
...
impl GetBlueprintRunError {
    ...
    /// Creates the `GetBlueprintRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
