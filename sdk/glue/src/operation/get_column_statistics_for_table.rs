...
/// Orchestration and serialization glue logic for `GetColumnStatisticsForTable`.
...
impl GetColumnStatisticsForTable {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableInput,
                    ) -> ::std::result::Result<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetColumnStatisticsForTable {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetColumnStatisticsForTable");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetColumnStatisticsForTableRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetColumnStatisticsForTableResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetColumnStatisticsForTable")
...
.with_interceptor(GetColumnStatisticsForTableEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError>::new());
...
#[derive(Debug)]
            struct GetColumnStatisticsForTableResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetColumnStatisticsForTableResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_column_statistics_for_table::de_get_column_statistics_for_table_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_column_statistics_for_table::de_get_column_statistics_for_table_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetColumnStatisticsForTableRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetColumnStatisticsForTableRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_column_statistics_for_table::ser_get_column_statistics_for_table_input(&input)?);
...
#[derive(Debug)]
            struct GetColumnStatisticsForTableEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetColumnStatisticsForTableEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetColumnStatisticsForTableEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetColumnStatisticsForTableInput>()
                        .ok_or("failed to downcast to GetColumnStatisticsForTableInput")?;
...
/// Error type for the `GetColumnStatisticsForTableError` operation.
#[non_exhaustive]
...
pub enum GetColumnStatisticsForTableError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetColumnStatisticsForTableError) for what information is available for the error.")]
...
impl GetColumnStatisticsForTableError {
    /// Creates the `GetColumnStatisticsForTableError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetColumnStatisticsForTableError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetColumnStatisticsForTableError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForTableError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForTableError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForTableError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForTableError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetColumnStatisticsForTableError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetColumnStatisticsForTableError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError {
...
mod _get_column_statistics_for_table_output;
