    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetColumnStatisticsForTable {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetColumnStatisticsForTable")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetColumnStatisticsForTableResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetColumnStatisticsForTableRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetColumnStatisticsForTableEndpointParamsInterceptor {
...
pub type GetColumnStatisticsForTableErrorKind = GetColumnStatisticsForTableError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError {
...
impl GetColumnStatisticsForTableError {
    ...
    /// Creates the `GetColumnStatisticsForTableError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
