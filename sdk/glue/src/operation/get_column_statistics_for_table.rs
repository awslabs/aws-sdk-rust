...
impl ::aws_smithy_http::response::ParseStrictResponse for GetColumnStatisticsForTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_column_statistics_for_table::de_get_column_statistics_for_table_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetColumnStatisticsForTableError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableError
{
