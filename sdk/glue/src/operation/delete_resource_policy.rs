...
impl DeleteResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "DeleteResourcePolicy", input, runtime_plugins, stop_point)
...
impl DeleteResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::ConditionCheckFailureException`.
    pub fn is_condition_check_failure_exception(&self) -> bool {
        matches!(self, Self::ConditionCheckFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::EntityNotFoundException`.
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::OperationTimeoutException`.
