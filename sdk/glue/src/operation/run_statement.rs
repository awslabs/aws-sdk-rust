...
impl RunStatementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::run_statement::RunStatement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RunStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_run_statement::de_run_statement_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_run_statement::de_run_statement_http_response_with_props(
                status, headers, body,
            )
        }
    }
