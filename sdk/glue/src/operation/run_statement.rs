...
impl RunStatementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::run_statement::RunStatement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_run_statement::ser_run_statement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RunStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_run_statement::de_run_statement_http_response_with_props(status, headers, body)
        }
    }
}
