...
impl RunStatementInput {
    /// Consumes the builder and constructs an Operation<[`RunStatement`](crate::operation::run_statement::RunStatement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::run_statement::RunStatement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::run_statement::RunStatementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_run_statement::ser_run_statement_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::run_statement::RunStatement::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RunStatement", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for RunStatement {
                type Output = std::result::Result<crate::operation::run_statement::RunStatementOutput, crate::operation::run_statement::RunStatementError>;
