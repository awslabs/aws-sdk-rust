...
impl GetUserDefinedFunctionsInput {
    /// Consumes the builder and constructs an Operation<[`GetUserDefinedFunctions`](crate::operation::get_user_defined_functions::GetUserDefinedFunctions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_user_defined_functions::GetUserDefinedFunctions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_user_defined_functions::GetUserDefinedFunctionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_user_defined_functions::ser_get_user_defined_functions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_user_defined_functions::GetUserDefinedFunctions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetUserDefinedFunctions", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetUserDefinedFunctions {
                type Output = std::result::Result<crate::operation::get_user_defined_functions::GetUserDefinedFunctionsOutput, crate::operation::get_user_defined_functions::GetUserDefinedFunctionsError>;
