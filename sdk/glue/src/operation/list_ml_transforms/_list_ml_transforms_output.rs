...
impl  ListMlTransformsOutput  {
    ...
    pub fn transform_ids(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.transform_ids.deref()
    }
    /// <p>A continuation token, if the returned list does not contain the last metric available.</p>
...
impl ListMlTransformsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_ml_transforms::ListMlTransformsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_ml_transforms::ListMlTransformsOutput {
                transform_ids: self.transform_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("transform_ids", "transform_ids was not specified but it is required when building ListMlTransformsOutput")
                    )?
                ,
