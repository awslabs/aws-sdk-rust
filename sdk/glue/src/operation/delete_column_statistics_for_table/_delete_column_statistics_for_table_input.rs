...
impl DeleteColumnStatisticsForTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTableInput, ::aws_smithy_types::error::operation::BuildError> {
