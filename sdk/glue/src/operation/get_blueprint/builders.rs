...
impl GetBlueprintFluentBuilder  {
    /// Creates a new `GetBlueprint`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_blueprint::GetBlueprint, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_blueprint::GetBlueprintError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_blueprint::GetBlueprintOutput, aws_smithy_http::result::SdkError<crate::operation::get_blueprint::GetBlueprintError>>
                     {
