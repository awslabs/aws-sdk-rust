...
impl CreateCrawlerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_crawler::CreateCrawler::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCrawler {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_crawler::de_create_crawler_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_crawler::de_create_crawler_http_response_with_props(
                status, headers, body,
            )
        }
    }
