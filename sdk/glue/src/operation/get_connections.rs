...
impl GetConnectionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_connections::GetConnections, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_connections::ser_get_connections_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConnections {
    type Output =
        ::std::result::Result<crate::operation::get_connections::GetConnectionsOutput, crate::operation::get_connections::GetConnectionsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_connections::de_get_connections_http_response_with_props(status, headers, body)
        }
    }
}
