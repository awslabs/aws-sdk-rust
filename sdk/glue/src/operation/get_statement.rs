...
impl GetStatementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_statement::GetStatement,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_statement::GetStatement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_statement::de_get_statement_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_statement::de_get_statement_http_response_with_props(
                status, headers, body,
            )
        }
    }
