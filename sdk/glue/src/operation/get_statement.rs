...
impl GetStatementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_statement::GetStatement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_statement::ser_get_statement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_statement::de_get_statement_http_response_with_props(status, headers, body)
        }
    }
}
