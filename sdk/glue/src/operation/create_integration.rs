...
impl CreateIntegration {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "CreateIntegration", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateIntegration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateIntegration", "Glue"));
...
impl CreateIntegrationError {
    ...
    /// Returns `true` if the error kind is `CreateIntegrationError::EntityNotFoundException`.
    ...
    /// Returns `true` if the error kind is `CreateIntegrationError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateIntegrationError::InvalidInputException`.
    ...
    /// Returns `true` if the error kind is `CreateIntegrationError::ResourceNumberLimitExceededException`.
