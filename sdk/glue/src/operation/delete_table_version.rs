...
impl DeleteTableVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_table_version::ser_delete_table_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTableVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_table_version::de_delete_table_version_http_response_with_props(status, headers, body)
        }
    }
}
