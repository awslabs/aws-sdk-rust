...
impl GetTablesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_tables::GetTables, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_tables::ser_get_tables_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTables {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_tables::de_get_tables_http_response_with_props(status, headers, body)
        }
    }
}
