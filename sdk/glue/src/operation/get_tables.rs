...
impl GetTablesInput {
    /// Consumes the builder and constructs an Operation<[`GetTables`](crate::operation::get_tables::GetTables)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_tables::GetTables, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_tables::GetTablesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_tables::ser_get_tables_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_tables::GetTables::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTables", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetTables {
                type Output = std::result::Result<crate::operation::get_tables::GetTablesOutput, crate::operation::get_tables::GetTablesError>;
