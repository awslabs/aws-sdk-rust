...
impl DeleteSecurityConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_security_configuration::DeleteSecurityConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSecurityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_security_configuration::de_delete_security_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
