...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSecurityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_security_configuration::de_delete_security_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteSecurityConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_security_configuration::DeleteSecurityConfigurationError
{
