...
impl GetRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_registry::GetRegistry, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_registry::ser_get_registry_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRegistry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_registry::de_get_registry_http_response_with_props(status, headers, body)
        }
    }
}
