...
impl GetRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_registry::GetRegistry,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_registry::GetRegistry::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRegistry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_registry::de_get_registry_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_registry::de_get_registry_http_response_with_props(
                status, headers, body,
            )
        }
    }
