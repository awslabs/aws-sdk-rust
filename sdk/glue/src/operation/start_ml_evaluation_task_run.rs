    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_ml_evaluation_task_run::StartMLEvaluationTaskRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_ml_evaluation_task_run::StartMlEvaluationTaskRunOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartMLEvaluationTaskRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartMLEvaluationTaskRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_ml_evaluation_task_run::StartMlEvaluationTaskRunInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartMLEvaluationTaskRunEndpointParamsInterceptor {
...
pub type StartMLEvaluationTaskRunErrorKind = StartMLEvaluationTaskRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::start_ml_evaluation_task_run::StartMLEvaluationTaskRunError {
...
impl StartMLEvaluationTaskRunError {
    ...
    /// Creates the `StartMLEvaluationTaskRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::MlTransformNotReadyException(e) => e.meta(),
