...
/// Orchestration and serialization glue logic for `DeleteCustomEntityType`.
...
impl DeleteCustomEntityType {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeInput,
                    ) -> ::std::result::Result<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteCustomEntityType {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteCustomEntityType");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteCustomEntityTypeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteCustomEntityTypeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteCustomEntityType")
...
.with_interceptor(DeleteCustomEntityTypeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeError>::new());
...
#[derive(Debug)]
            struct DeleteCustomEntityTypeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteCustomEntityTypeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_custom_entity_type::de_delete_custom_entity_type_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_custom_entity_type::de_delete_custom_entity_type_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteCustomEntityTypeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteCustomEntityTypeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_custom_entity_type::ser_delete_custom_entity_type_input(&input)?);
...
#[derive(Debug)]
            struct DeleteCustomEntityTypeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteCustomEntityTypeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteCustomEntityTypeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteCustomEntityTypeInput>()
                        .ok_or("failed to downcast to DeleteCustomEntityTypeInput")?;
...
/// Error type for the `DeleteCustomEntityTypeError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteCustomEntityTypeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteCustomEntityTypeError) for what information is available for the error.")]
...
impl DeleteCustomEntityTypeError {
    /// Creates the `DeleteCustomEntityTypeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteCustomEntityTypeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteCustomEntityTypeError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomEntityTypeError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomEntityTypeError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomEntityTypeError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteCustomEntityTypeError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteCustomEntityTypeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteCustomEntityTypeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_custom_entity_type::DeleteCustomEntityTypeError {
...
mod _delete_custom_entity_type_output;
