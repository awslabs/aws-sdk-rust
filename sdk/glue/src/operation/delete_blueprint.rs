...
impl DeleteBlueprintInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_blueprint::DeleteBlueprint, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_blueprint::ser_delete_blueprint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBlueprint {
    type Output =
        ::std::result::Result<crate::operation::delete_blueprint::DeleteBlueprintOutput, crate::operation::delete_blueprint::DeleteBlueprintError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_blueprint::de_delete_blueprint_http_response_with_props(status, headers, body)
        }
    }
}
