...
/// Orchestration and serialization glue logic for `CreateDataQualityRuleset`.
...
impl CreateDataQualityRuleset {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDataQualityRuleset {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateDataQualityRuleset");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateDataQualityRulesetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateDataQualityRulesetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDataQualityRuleset")
...
.with_interceptor(CreateDataQualityRulesetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetError>::new());
...
#[derive(Debug)]
            struct CreateDataQualityRulesetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDataQualityRulesetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_data_quality_ruleset::de_create_data_quality_ruleset_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_data_quality_ruleset::de_create_data_quality_ruleset_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateDataQualityRulesetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDataQualityRulesetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_data_quality_ruleset::ser_create_data_quality_ruleset_input(&input)?);
...
#[derive(Debug)]
            struct CreateDataQualityRulesetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDataQualityRulesetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateDataQualityRulesetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateDataQualityRulesetInput>()
                        .ok_or("failed to downcast to CreateDataQualityRulesetInput")?;
...
/// Error type for the `CreateDataQualityRulesetError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateDataQualityRulesetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateDataQualityRulesetError) for what information is available for the error.")]
...
impl CreateDataQualityRulesetError {
    /// Creates the `CreateDataQualityRulesetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDataQualityRulesetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateDataQualityRulesetError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateDataQualityRulesetError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateDataQualityRulesetError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateDataQualityRulesetError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CreateDataQualityRulesetError::ResourceNumberLimitExceededException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateDataQualityRulesetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateDataQualityRulesetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_data_quality_ruleset::CreateDataQualityRulesetError {
...
mod _create_data_quality_ruleset_output;
