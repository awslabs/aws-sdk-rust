    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_defined_function::UpdateUserDefinedFunctionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_defined_function::UpdateUserDefinedFunctionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateUserDefinedFunction {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateUserDefinedFunction", "glue"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateUserDefinedFunction")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateUserDefinedFunctionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateUserDefinedFunctionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_user_defined_function::UpdateUserDefinedFunctionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateUserDefinedFunctionEndpointParamsInterceptor {
...
pub type UpdateUserDefinedFunctionErrorKind = UpdateUserDefinedFunctionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_defined_function::UpdateUserDefinedFunctionError {
...
impl UpdateUserDefinedFunctionError {
    ...
    /// Creates the `UpdateUserDefinedFunctionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
