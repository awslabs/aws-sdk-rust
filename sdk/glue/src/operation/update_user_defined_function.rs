...
impl UpdateUserDefinedFunctionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_defined_function::UpdateUserDefinedFunction::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserDefinedFunction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_user_defined_function::de_update_user_defined_function_http_response_with_props(status, headers, body)
        }
    }
}
