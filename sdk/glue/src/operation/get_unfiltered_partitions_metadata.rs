...
impl GetUnfilteredPartitionsMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUnfilteredPartitionsMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_unfiltered_partitions_metadata::de_get_unfiltered_partitions_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
