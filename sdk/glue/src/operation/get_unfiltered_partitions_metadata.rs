...
impl GetUnfilteredPartitionsMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetUnfilteredPartitionsMetadata`](crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_unfiltered_partitions_metadata::ser_get_unfiltered_partitions_metadata_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadata::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetUnfilteredPartitionsMetadata", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetUnfilteredPartitionsMetadata {
                type Output = std::result::Result<crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadataOutput, crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadataError>;
