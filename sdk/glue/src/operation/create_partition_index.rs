...
impl CreatePartitionIndexInput {
    /// Consumes the builder and constructs an Operation<[`CreatePartitionIndex`](crate::operation::create_partition_index::CreatePartitionIndex)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_partition_index::CreatePartitionIndex, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_partition_index::CreatePartitionIndexInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_partition_index::ser_create_partition_index_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_partition_index::CreatePartitionIndex::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePartitionIndex", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePartitionIndex {
                type Output = std::result::Result<crate::operation::create_partition_index::CreatePartitionIndexOutput, crate::operation::create_partition_index::CreatePartitionIndexError>;
