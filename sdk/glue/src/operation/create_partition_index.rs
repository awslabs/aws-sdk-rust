...
impl CreatePartitionIndexInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_partition_index::ser_create_partition_index_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_partition_index::CreatePartitionIndex::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_partition_index::CreatePartitionIndexError
{
