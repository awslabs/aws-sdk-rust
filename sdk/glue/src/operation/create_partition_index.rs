...
pub type CreatePartitionIndexErrorKind = CreatePartitionIndexError;
...
impl CreatePartitionIndexError {
    ...
    /// Creates the `CreatePartitionIndexError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
