...
impl BatchUpdatePartitionInput {
    /// Consumes the builder and constructs an Operation<[`BatchUpdatePartition`](crate::operation::batch_update_partition::BatchUpdatePartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_update_partition::BatchUpdatePartition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_update_partition::BatchUpdatePartitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_partition::ser_batch_update_partition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_update_partition::BatchUpdatePartition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchUpdatePartition", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchUpdatePartition {
                type Output = std::result::Result<crate::operation::batch_update_partition::BatchUpdatePartitionOutput, crate::operation::batch_update_partition::BatchUpdatePartitionError>;
