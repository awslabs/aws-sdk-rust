...
pub type BatchUpdatePartitionErrorKind = BatchUpdatePartitionError;
...
impl BatchUpdatePartitionError {
    ...
    /// Creates the `BatchUpdatePartitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
