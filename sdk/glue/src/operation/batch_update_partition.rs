...
impl BatchUpdatePartitionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_partition::ser_batch_update_partition_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_update_partition::BatchUpdatePartition::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_update_partition::BatchUpdatePartitionError
{
