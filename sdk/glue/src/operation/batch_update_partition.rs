...
impl BatchUpdatePartition {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_update_partition::BatchUpdatePartitionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_update_partition::BatchUpdatePartitionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "BatchUpdatePartition", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.BatchUpdatePartition",
                "rpc.service" = "Glue",
                "rpc.method" = "BatchUpdatePartition",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchUpdatePartition {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchUpdatePartitionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchUpdatePartitionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchUpdatePartition")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchUpdatePartition")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                BatchUpdatePartitionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct BatchUpdatePartitionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchUpdatePartitionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<BatchUpdatePartitionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchUpdatePartitionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_update_partition::de_batch_update_partition_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_update_partition::de_batch_update_partition_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchUpdatePartitionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_update_partition::BatchUpdatePartitionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_update_partition::BatchUpdatePartitionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_update_partition::ser_batch_update_partition_input(
            &input,
        )?);
