...
impl PutResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "PutResourcePolicy", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutResourcePolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PutResourcePolicy", "Glue"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutResourcePolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("PolicyInJson") {
            if let ::std::option::Option::Some(value) = input.policy_in_json.as_deref() {
                captured.insert("PolicyInJson", value);
            }
        }
        ...
        if requested.should_capture("PolicyHashCondition") {
            if let ::std::option::Option::Some(value) = input.policy_hash_condition.as_deref() {
                captured.insert("PolicyHashCondition", value);
            }
        }
...
impl PutResourcePolicyError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ConditionCheckFailureException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `PutResourcePolicyError::ConditionCheckFailureException`.
    pub fn is_condition_check_failure_exception(&self) -> bool {
        matches!(self, Self::ConditionCheckFailureException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `PutResourcePolicyError::InternalServiceException`.
    ...
    /// Returns `true` if the error kind is `PutResourcePolicyError::OperationTimeoutException`.
...
impl ::std::error::Error for PutResourcePolicyError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::ConditionCheckFailureException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for PutResourcePolicyError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            Self::ConditionCheckFailureException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutResourcePolicyError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ConditionCheckFailureException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
