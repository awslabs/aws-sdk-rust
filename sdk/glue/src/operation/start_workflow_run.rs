...
impl StartWorkflowRunInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_workflow_run::ser_start_workflow_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartWorkflowRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_workflow_run::de_start_workflow_run_http_response_with_props(status, headers, body)
        }
    }
}
