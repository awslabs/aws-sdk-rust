...
impl StartWorkflowRunInput {
    /// Consumes the builder and constructs an Operation<[`StartWorkflowRun`](crate::operation::start_workflow_run::StartWorkflowRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_workflow_run::StartWorkflowRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_workflow_run::StartWorkflowRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_workflow_run::ser_start_workflow_run_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_workflow_run::StartWorkflowRun::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartWorkflowRun", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartWorkflowRun {
                type Output = std::result::Result<crate::operation::start_workflow_run::StartWorkflowRunOutput, crate::operation::start_workflow_run::StartWorkflowRunError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_workflow_run::de_start_workflow_run_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_workflow_run::de_start_workflow_run_http_response(response)
                     }
                }
            }
