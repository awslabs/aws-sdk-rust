...
impl DeleteIntegration {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "DeleteIntegration", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteIntegration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DeleteIntegration", "Glue"));
...
impl DeleteIntegrationError {
    ...
    /// Returns `true` if the error kind is `DeleteIntegrationError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteIntegrationError::IntegrationConflictOperationFault`.
    pub fn is_integration_conflict_operation_fault(&self) -> bool {
        matches!(self, Self::IntegrationConflictOperationFault(_))
    }
    /// Returns `true` if the error kind is `DeleteIntegrationError::IntegrationNotFoundFault`.
    ...
    /// Returns `true` if the error kind is `DeleteIntegrationError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteIntegrationError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteIntegrationError::InvalidIntegrationStateFault`.
    pub fn is_invalid_integration_state_fault(&self) -> bool {
        matches!(self, Self::InvalidIntegrationStateFault(_))
    }
    /// Returns `true` if the error kind is `DeleteIntegrationError::InvalidStateException`.
