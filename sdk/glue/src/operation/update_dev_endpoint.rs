...
impl UpdateDevEndpointInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_dev_endpoint::ser_update_dev_endpoint_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDevEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_dev_endpoint::de_update_dev_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
