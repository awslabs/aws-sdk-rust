...
impl GetBlueprintRunsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_blueprint_runs::ser_get_blueprint_runs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlueprintRuns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_blueprint_runs::de_get_blueprint_runs_http_response_with_props(status, headers, body)
        }
    }
}
