    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_blueprint_runs::GetBlueprintRunsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_blueprint_runs::GetBlueprintRunsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBlueprintRuns {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBlueprintRuns")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetBlueprintRunsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetBlueprintRunsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetBlueprintRunsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_blueprint_runs::GetBlueprintRunsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_blueprint_runs::ser_get_blueprint_runs_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetBlueprintRunsEndpointParamsInterceptor {
...
pub type GetBlueprintRunsErrorKind = GetBlueprintRunsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_blueprint_runs::GetBlueprintRunsError {
...
impl GetBlueprintRunsError {
    ...
    /// Creates the `GetBlueprintRunsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
