...
impl GetSchemaByDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_schema_by_definition::GetSchemaByDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_schema_by_definition::GetSchemaByDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_schema_by_definition::GetSchemaByDefinitionOutput, crate::operation::get_schema_by_definition::GetSchemaByDefinitionError, Self> {
