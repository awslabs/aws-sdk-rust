...
impl DescribeEntity {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "DescribeEntity", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeEntity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DescribeEntity", "Glue"));
...
impl DescribeEntityError {
    ...
    /// Returns `true` if the error kind is `DescribeEntityError::FederationSourceException`.
    pub fn is_federation_source_exception(&self) -> bool {
        matches!(self, Self::FederationSourceException(_))
    }
    /// Returns `true` if the error kind is `DescribeEntityError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `DescribeEntityError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DescribeEntityError::OperationTimeoutException`.
