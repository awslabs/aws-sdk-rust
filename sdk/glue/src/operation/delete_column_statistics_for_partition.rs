...
impl DeleteColumnStatisticsForPartitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_column_statistics_for_partition::DeleteColumnStatisticsForPartition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteColumnStatisticsForPartition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_column_statistics_for_partition::de_delete_column_statistics_for_partition_http_response_with_props(
                status, headers, body,
            )
        }
    }
