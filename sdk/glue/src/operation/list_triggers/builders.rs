...
impl ListTriggersFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        crate::client::customize::CustomizableOperation<
            crate::operation::list_triggers::ListTriggers,
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_triggers::paginator::ListTriggersPaginator {
        crate::operation::list_triggers::paginator::ListTriggersPaginator::new(
            self.handle,
            self.inner,
        )
    }
