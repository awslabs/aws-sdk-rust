...
impl CheckSchemaVersionValidity {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CheckSchemaVersionValidity {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CheckSchemaVersionValidity");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CheckSchemaVersionValidityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CheckSchemaVersionValidityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CheckSchemaVersionValidity")
...
.with_interceptor(CheckSchemaVersionValidityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError>::new());
...
#[derive(Debug)]
            struct CheckSchemaVersionValidityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CheckSchemaVersionValidityResponseDeserializer {
...
#[derive(Debug)]
            struct CheckSchemaVersionValidityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CheckSchemaVersionValidityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::check_schema_version_validity::CheckSchemaVersionValidityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_check_schema_version_validity::ser_check_schema_version_validity_input(&input)?);
...
#[derive(Debug)]
            struct CheckSchemaVersionValidityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CheckSchemaVersionValidityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CheckSchemaVersionValidityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CheckSchemaVersionValidityInput>()
                        .ok_or("failed to downcast to CheckSchemaVersionValidityInput")?;
...
pub enum CheckSchemaVersionValidityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CheckSchemaVersionValidityError) for what information is available for the error.")]
...
impl CheckSchemaVersionValidityError {
    /// Creates the `CheckSchemaVersionValidityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CheckSchemaVersionValidityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CheckSchemaVersionValidityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError {
