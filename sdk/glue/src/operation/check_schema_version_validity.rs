...
impl CheckSchemaVersionValidityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::check_schema_version_validity::CheckSchemaVersionValidity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckSchemaVersionValidity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_check_schema_version_validity::de_check_schema_version_validity_http_response_with_props(
                status, headers, body,
            )
        }
    }
