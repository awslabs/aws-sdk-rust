...
impl RegisterSchemaVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_schema_version::RegisterSchemaVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_schema_version::RegisterSchemaVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_schema_version::RegisterSchemaVersionOutput, crate::operation::register_schema_version::RegisterSchemaVersionError, Self> {
