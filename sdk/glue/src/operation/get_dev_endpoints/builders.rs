...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_dev_endpoints::GetDevEndpointsOutput,
                    crate::operation::get_dev_endpoints::GetDevEndpointsError,
                > for GetDevEndpointsFluentBuilder
            {
                fn send(
                    self,
...
impl GetDevEndpointsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_dev_endpoints::GetDevEndpointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_dev_endpoints::GetDevEndpointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::get_dev_endpoints::GetDevEndpoints::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_dev_endpoints::GetDevEndpointsOutput, crate::operation::get_dev_endpoints::GetDevEndpointsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::get_dev_endpoints::paginator::GetDevEndpointsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
