...
impl ListDataQualityRuleRecommendationRunsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_data_quality_rule_recommendation_runs::ListDataQualityRuleRecommendationRunsInput, ::aws_smithy_types::error::operation::BuildError> {
