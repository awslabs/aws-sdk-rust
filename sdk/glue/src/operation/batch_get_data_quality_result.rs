...
impl BatchGetDataQualityResultInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_data_quality_result::BatchGetDataQualityResult::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetDataQualityResult {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_data_quality_result::de_batch_get_data_quality_result_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_get_data_quality_result::BatchGetDataQualityResultError
{
