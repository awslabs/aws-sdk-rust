...
impl BatchGetDataQualityResult {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_data_quality_result::BatchGetDataQualityResultError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_data_quality_result::BatchGetDataQualityResultOutput>::assume_from(output).expect("correct output type").unwrap())
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("glue", "BatchGetDataQualityResult", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetDataQualityResult {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            BatchGetDataQualityResultRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            BatchGetDataQualityResultResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("BatchGetDataQualityResult", "glue"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchGetDataQualityResult")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchGetDataQualityResultResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchGetDataQualityResultRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_data_quality_result::BatchGetDataQualityResultInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::batch_get_data_quality_result::BatchGetDataQualityResultInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_data_quality_result::ser_batch_get_data_quality_result_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchGetDataQualityResultEndpointParamsInterceptor {
...
pub type BatchGetDataQualityResultErrorKind = BatchGetDataQualityResultError;
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_data_quality_result::BatchGetDataQualityResultError {
...
impl BatchGetDataQualityResultError {
    ...
    /// Creates the `BatchGetDataQualityResultError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
