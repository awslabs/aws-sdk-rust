...
impl UpdateTriggerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_trigger::UpdateTrigger, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_trigger::ser_update_trigger_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_trigger::de_update_trigger_http_response_with_props(status, headers, body)
        }
    }
}
