...
impl ListTriggersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_triggers::ListTriggers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_triggers::ser_list_triggers_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTriggers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_triggers::de_list_triggers_http_response_with_props(status, headers, body)
        }
    }
}
