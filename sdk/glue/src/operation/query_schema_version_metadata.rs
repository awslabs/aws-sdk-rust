...
impl ::aws_smithy_http::response::ParseStrictResponse for QuerySchemaVersionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query_schema_version_metadata::de_query_schema_version_metadata_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError
{
