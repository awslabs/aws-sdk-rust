    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for QuerySchemaVersionMetadata {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("QuerySchemaVersionMetadata", "glue"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("QuerySchemaVersionMetadata")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for QuerySchemaVersionMetadataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for QuerySchemaVersionMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for QuerySchemaVersionMetadataEndpointParamsInterceptor {
...
pub type QuerySchemaVersionMetadataErrorKind = QuerySchemaVersionMetadataError;
...
impl ::aws_http::request_id::RequestId for crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError {
...
impl QuerySchemaVersionMetadataError {
    ...
    /// Creates the `QuerySchemaVersionMetadataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
