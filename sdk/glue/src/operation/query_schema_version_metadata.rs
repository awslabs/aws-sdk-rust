...
/// Orchestration and serialization glue logic for `QuerySchemaVersionMetadata`.
...
impl QuerySchemaVersionMetadata {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for QuerySchemaVersionMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("QuerySchemaVersionMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(QuerySchemaVersionMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(QuerySchemaVersionMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("QuerySchemaVersionMetadata")
...
.with_interceptor(QuerySchemaVersionMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError>::new());
...
#[derive(Debug)]
            struct QuerySchemaVersionMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for QuerySchemaVersionMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_query_schema_version_metadata::de_query_schema_version_metadata_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct QuerySchemaVersionMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for QuerySchemaVersionMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_query_schema_version_metadata::ser_query_schema_version_metadata_input(&input)?);
...
#[derive(Debug)]
            struct QuerySchemaVersionMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for QuerySchemaVersionMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "QuerySchemaVersionMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<QuerySchemaVersionMetadataInput>()
                        .ok_or("failed to downcast to QuerySchemaVersionMetadataInput")?;
...
/// Error type for the `QuerySchemaVersionMetadataError` operation.
#[non_exhaustive]
...
pub enum QuerySchemaVersionMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-QuerySchemaVersionMetadataError) for what information is available for the error.")]
...
impl QuerySchemaVersionMetadataError {
    /// Creates the `QuerySchemaVersionMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `QuerySchemaVersionMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `QuerySchemaVersionMetadataError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `QuerySchemaVersionMetadataError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `QuerySchemaVersionMetadataError::InvalidInputException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for QuerySchemaVersionMetadataError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for QuerySchemaVersionMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataError {
...
mod _query_schema_version_metadata_output;
