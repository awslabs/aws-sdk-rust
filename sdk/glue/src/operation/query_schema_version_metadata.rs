...
impl QuerySchemaVersionMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for QuerySchemaVersionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query_schema_version_metadata::de_query_schema_version_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
