...
impl UpdateCrawlerScheduleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_crawler_schedule::UpdateCrawlerScheduleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_crawler_schedule::UpdateCrawlerScheduleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_crawler_schedule::UpdateCrawlerScheduleOutput, crate::operation::update_crawler_schedule::UpdateCrawlerScheduleError, Self> {
