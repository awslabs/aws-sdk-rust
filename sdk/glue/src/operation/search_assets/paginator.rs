...
/// Paginator for [`SearchAssets`](crate::operation::search_assets::SearchAssets)
pub struct SearchAssetsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::search_assets::builders::SearchAssetsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl SearchAssetsPaginator {
    ...
    pub fn items(self) -> crate::operation::search_assets::paginator::SearchAssetsPaginatorItems {
        crate::operation::search_assets::paginator::SearchAssetsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::search_assets::SearchAssets::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_search_assets_output_output_next_token(resp);
...
/// Flattened paginator for `SearchAssetsPaginator`
///
/// This is created with [`.items()`](SearchAssetsPaginator::items)
pub struct SearchAssetsPaginatorItems(SearchAssetsPaginator);

impl SearchAssetsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_search_assets_output_output_items(page).unwrap_or_default().into_iter())
    }
}
