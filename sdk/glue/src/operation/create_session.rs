...
impl CreateSessionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_session::CreateSession::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSession {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_session::de_create_session_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_session::de_create_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
...
impl std::error::Error for CreateSessionError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::ResourceNumberLimitExceededException(_inner) => Some(_inner),
