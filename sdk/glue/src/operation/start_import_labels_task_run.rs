    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartImportLabelsTaskRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartImportLabelsTaskRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartImportLabelsTaskRunEndpointParamsInterceptor {
...
pub type StartImportLabelsTaskRunErrorKind = StartImportLabelsTaskRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError {
...
impl StartImportLabelsTaskRunError {
    ...
    /// Creates the `StartImportLabelsTaskRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
