...
/// Orchestration and serialization glue logic for `StartImportLabelsTaskRun`.
...
impl StartImportLabelsTaskRun {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartImportLabelsTaskRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartImportLabelsTaskRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartImportLabelsTaskRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartImportLabelsTaskRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartImportLabelsTaskRun")
...
.with_interceptor(StartImportLabelsTaskRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError>::new());
...
#[derive(Debug)]
            struct StartImportLabelsTaskRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartImportLabelsTaskRunResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_import_labels_task_run::de_start_import_labels_task_run_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_import_labels_task_run::de_start_import_labels_task_run_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartImportLabelsTaskRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartImportLabelsTaskRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_import_labels_task_run::ser_start_import_labels_task_run_input(&input)?);
...
#[derive(Debug)]
            struct StartImportLabelsTaskRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartImportLabelsTaskRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartImportLabelsTaskRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartImportLabelsTaskRunInput>()
                        .ok_or("failed to downcast to StartImportLabelsTaskRunInput")?;
...
/// Error type for the `StartImportLabelsTaskRunError` operation.
#[non_exhaustive]
...
pub enum StartImportLabelsTaskRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartImportLabelsTaskRunError) for what information is available for the error.")]
...
impl StartImportLabelsTaskRunError {
    /// Creates the `StartImportLabelsTaskRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartImportLabelsTaskRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartImportLabelsTaskRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartImportLabelsTaskRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartImportLabelsTaskRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `StartImportLabelsTaskRunError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `StartImportLabelsTaskRunError::ResourceNumberLimitExceededException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartImportLabelsTaskRunError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartImportLabelsTaskRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_import_labels_task_run::StartImportLabelsTaskRunError {
...
mod _start_import_labels_task_run_output;
