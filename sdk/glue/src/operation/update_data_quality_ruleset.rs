...
/// Orchestration and serialization glue logic for `UpdateDataQualityRuleset`.
...
impl UpdateDataQualityRuleset {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDataQualityRuleset {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDataQualityRuleset");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateDataQualityRulesetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateDataQualityRulesetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDataQualityRuleset")
...
.with_interceptor(UpdateDataQualityRulesetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError>::new());
...
#[derive(Debug)]
            struct UpdateDataQualityRulesetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDataQualityRulesetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_data_quality_ruleset::de_update_data_quality_ruleset_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_data_quality_ruleset::de_update_data_quality_ruleset_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateDataQualityRulesetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDataQualityRulesetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_data_quality_ruleset::ser_update_data_quality_ruleset_input(&input)?);
...
#[derive(Debug)]
            struct UpdateDataQualityRulesetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDataQualityRulesetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateDataQualityRulesetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateDataQualityRulesetInput>()
                        .ok_or("failed to downcast to UpdateDataQualityRulesetInput")?;
...
/// Error type for the `UpdateDataQualityRulesetError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateDataQualityRulesetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDataQualityRulesetError) for what information is available for the error.")]
...
impl UpdateDataQualityRulesetError {
    /// Creates the `UpdateDataQualityRulesetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDataQualityRulesetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `UpdateDataQualityRulesetError::ResourceNumberLimitExceededException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateDataQualityRulesetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDataQualityRulesetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError {
...
mod _update_data_quality_ruleset_output;
