...
pub type UpdateDataQualityRulesetErrorKind = UpdateDataQualityRulesetError;
...
impl UpdateDataQualityRulesetError {
    ...
    /// Creates the `UpdateDataQualityRulesetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
