...
impl UpdateDataQualityRulesetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDataQualityRuleset`](crate::operation::update_data_quality_ruleset::UpdateDataQualityRuleset)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_data_quality_ruleset::UpdateDataQualityRuleset, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_data_quality_ruleset::ser_update_data_quality_ruleset_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_data_quality_ruleset::UpdateDataQualityRuleset::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateDataQualityRuleset", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDataQualityRuleset {
                type Output = std::result::Result<crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetOutput, crate::operation::update_data_quality_ruleset::UpdateDataQualityRulesetError>;
