...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::update_source_control_from_job::UpdateSourceControlFromJobOutput,
                    crate::operation::update_source_control_from_job::UpdateSourceControlFromJobError,
                > for UpdateSourceControlFromJobFluentBuilder
            {
                fn send(
                    self,
...
impl UpdateSourceControlFromJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_source_control_from_job::UpdateSourceControlFromJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_source_control_from_job::UpdateSourceControlFromJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::update_source_control_from_job::UpdateSourceControlFromJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::update_source_control_from_job::UpdateSourceControlFromJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_source_control_from_job::UpdateSourceControlFromJobOutput, crate::operation::update_source_control_from_job::UpdateSourceControlFromJobError, Self> {
