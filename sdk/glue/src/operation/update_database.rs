...
impl UpdateDatabaseInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_database::UpdateDatabase::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDatabase {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_database::de_update_database_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_database::de_update_database_http_response(
                status, headers, body,
            )
        }
    }
