...
impl BatchDeleteTableInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeleteTable`](crate::operation::batch_delete_table::BatchDeleteTable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_delete_table::BatchDeleteTable, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_table::BatchDeleteTableInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_delete_table::ser_batch_delete_table_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_table::BatchDeleteTable::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchDeleteTable", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDeleteTable {
                type Output = std::result::Result<crate::operation::batch_delete_table::BatchDeleteTableOutput, crate::operation::batch_delete_table::BatchDeleteTableError>;
