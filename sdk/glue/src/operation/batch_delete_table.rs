...
impl BatchDeleteTableInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_delete_table::ser_batch_delete_table_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteTable {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_table::de_batch_delete_table_http_response_with_props(status, headers, body)
        }
    }
}
