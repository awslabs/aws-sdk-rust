...
impl GetClassifiersInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_classifiers::GetClassifiers::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetClassifiers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_classifiers::de_get_classifiers_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_classifiers::de_get_classifiers_http_response(
                status, headers, body,
            )
        }
    }
