...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobFromSourceControl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_job_from_source_control::de_update_job_from_source_control_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_job_from_source_control::UpdateJobFromSourceControlError
{
