...
impl DeleteSecurityConfigurationFluentBuilder  {
    /// Creates a new `DeleteSecurityConfiguration`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_security_configuration::DeleteSecurityConfigurationOutput, aws_smithy_http::result::SdkError<crate::operation::delete_security_configuration::DeleteSecurityConfigurationError>>
                     {
