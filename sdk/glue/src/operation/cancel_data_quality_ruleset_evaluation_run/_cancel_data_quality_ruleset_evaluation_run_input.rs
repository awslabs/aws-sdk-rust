...
impl CancelDataQualityRulesetEvaluationRunInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_data_quality_ruleset_evaluation_run::CancelDataQualityRulesetEvaluationRunInput, ::aws_smithy_types::error::operation::BuildError> {
