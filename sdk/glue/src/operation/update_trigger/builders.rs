...
impl UpdateTriggerFluentBuilder  {
    /// Creates a new `UpdateTrigger`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_trigger::UpdateTriggerOutput, aws_smithy_http::result::SdkError<crate::operation::update_trigger::UpdateTriggerError>>
                     {
