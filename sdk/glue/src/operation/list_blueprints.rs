...
impl ListBlueprintsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_blueprints::ListBlueprints::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListBlueprints {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_blueprints::de_list_blueprints_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_blueprints::de_list_blueprints_http_response(
                status, headers, body,
            )
        }
    }
