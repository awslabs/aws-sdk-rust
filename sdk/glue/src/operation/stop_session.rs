...
impl StopSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_session::StopSession,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_session::StopSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_session::de_stop_session_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_session::de_stop_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
