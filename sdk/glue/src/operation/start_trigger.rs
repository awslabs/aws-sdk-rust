...
impl StartTriggerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_trigger::StartTrigger, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_trigger::ser_start_trigger_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_trigger::de_start_trigger_http_response_with_props(status, headers, body)
        }
    }
}
