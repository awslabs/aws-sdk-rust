...
impl CreateClassifierInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_classifier::CreateClassifier, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_classifier::ser_create_classifier_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClassifier {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_classifier::de_create_classifier_http_response_with_props(status, headers, body)
        }
    }
}
