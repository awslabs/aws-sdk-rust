...
impl GetMlTransformInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_ml_transform::GetMLTransform, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_ml_transform::ser_get_ml_transform_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMLTransform {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ml_transform::de_get_ml_transform_http_response_with_props(status, headers, body)
        }
    }
}
