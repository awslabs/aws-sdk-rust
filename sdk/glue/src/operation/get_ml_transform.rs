    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ml_transform::GetMLTransformError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ml_transform::GetMlTransformOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMLTransform {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMLTransform")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetMLTransformEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetMLTransformResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetMLTransformRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_ml_transform::GetMlTransformInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_ml_transform::ser_get_ml_transform_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetMLTransformEndpointParamsInterceptor {
...
pub type GetMLTransformErrorKind = GetMLTransformError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ml_transform::GetMLTransformError {
...
impl GetMLTransformError {
    ...
    /// Creates the `GetMLTransformError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
