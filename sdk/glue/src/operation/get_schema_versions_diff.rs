...
impl GetSchemaVersionsDiff {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSchemaVersionsDiff {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSchemaVersionsDiff");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSchemaVersionsDiffRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSchemaVersionsDiffResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSchemaVersionsDiff")
...
.with_interceptor(GetSchemaVersionsDiffEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError>::new());
...
#[derive(Debug)]
            struct GetSchemaVersionsDiffResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSchemaVersionsDiffResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_schema_versions_diff::de_get_schema_versions_diff_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetSchemaVersionsDiffRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSchemaVersionsDiffRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_schema_versions_diff::ser_get_schema_versions_diff_input(&input)?);
...
#[derive(Debug)]
            struct GetSchemaVersionsDiffEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSchemaVersionsDiffEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSchemaVersionsDiffEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSchemaVersionsDiffInput>()
                        .ok_or("failed to downcast to GetSchemaVersionsDiffInput")?;
...
pub enum GetSchemaVersionsDiffError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSchemaVersionsDiffError) for what information is available for the error.")]
...
impl GetSchemaVersionsDiffError {
    /// Creates the `GetSchemaVersionsDiffError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSchemaVersionsDiffError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSchemaVersionsDiffError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError {
