...
impl StopCrawlerFluentBuilder  {
    /// Creates a new `StopCrawler`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::stop_crawler::StopCrawler, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::stop_crawler::StopCrawlerError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::stop_crawler::StopCrawlerOutput, aws_smithy_http::result::SdkError<crate::operation::stop_crawler::StopCrawlerError>>
                     {
