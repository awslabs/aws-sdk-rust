...
impl GetMappingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_mapping::GetMapping, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_mapping::ser_get_mapping_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_mapping::de_get_mapping_http_response_with_props(status, headers, body)
        }
    }
}
