...
impl CreatePartitionInput {
    /// Consumes the builder and constructs an Operation<[`CreatePartition`](crate::operation::create_partition::CreatePartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_partition::CreatePartition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_partition::CreatePartitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_partition::ser_create_partition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_partition::CreatePartition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePartition", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePartition {
                type Output = std::result::Result<crate::operation::create_partition::CreatePartitionOutput, crate::operation::create_partition::CreatePartitionError>;
