...
impl CreatePartitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_partition::CreatePartition, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_partition::ser_create_partition_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePartition {
    type Output =
        ::std::result::Result<crate::operation::create_partition::CreatePartitionOutput, crate::operation::create_partition::CreatePartitionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_partition::de_create_partition_http_response_with_props(status, headers, body)
        }
    }
}
