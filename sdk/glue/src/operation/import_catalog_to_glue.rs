    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportCatalogToGlue")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ImportCatalogToGlueEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ImportCatalogToGlueResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ImportCatalogToGlueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_catalog_to_glue::ser_import_catalog_to_glue_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ImportCatalogToGlueEndpointParamsInterceptor {
...
pub type ImportCatalogToGlueErrorKind = ImportCatalogToGlueError;
...
impl ::aws_http::request_id::RequestId for crate::operation::import_catalog_to_glue::ImportCatalogToGlueError {
...
impl ImportCatalogToGlueError {
    ...
    /// Creates the `ImportCatalogToGlueError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
