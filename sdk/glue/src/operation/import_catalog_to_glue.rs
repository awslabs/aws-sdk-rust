...
/// Orchestration and serialization glue logic for `ImportCatalogToGlue`.
...
impl ImportCatalogToGlue {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::import_catalog_to_glue::ImportCatalogToGlueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::import_catalog_to_glue::ImportCatalogToGlueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ImportCatalogToGlue {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ImportCatalogToGlue");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ImportCatalogToGlueRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ImportCatalogToGlueResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ImportCatalogToGlue")
...
.with_interceptor(ImportCatalogToGlueEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueError>::new());
...
#[derive(Debug)]
            struct ImportCatalogToGlueResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ImportCatalogToGlueResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_import_catalog_to_glue::de_import_catalog_to_glue_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ImportCatalogToGlueRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportCatalogToGlueRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::import_catalog_to_glue::ImportCatalogToGlueInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::import_catalog_to_glue::ImportCatalogToGlueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_catalog_to_glue::ser_import_catalog_to_glue_input(&input)?);
...
#[derive(Debug)]
            struct ImportCatalogToGlueEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportCatalogToGlueEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ImportCatalogToGlueEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ImportCatalogToGlueInput>()
                        .ok_or("failed to downcast to ImportCatalogToGlueInput")?;
...
/// Error type for the `ImportCatalogToGlueError` operation.
#[non_exhaustive]
...
pub enum ImportCatalogToGlueError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ImportCatalogToGlueError) for what information is available for the error.")]
...
impl ImportCatalogToGlueError {
    /// Creates the `ImportCatalogToGlueError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ImportCatalogToGlueError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ImportCatalogToGlueError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ImportCatalogToGlueError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ImportCatalogToGlueError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ImportCatalogToGlueError {
...
impl ::aws_types::request_id::RequestId for crate::operation::import_catalog_to_glue::ImportCatalogToGlueError {
...
mod _import_catalog_to_glue_output;
