...
impl ImportCatalogToGlueInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::import_catalog_to_glue::ImportCatalogToGlue,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportCatalogToGlue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_catalog_to_glue::de_import_catalog_to_glue_http_response_with_props(status, headers, body)
        }
    }
}
