...
impl ImportCatalogToGlueInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_catalog_to_glue::ser_import_catalog_to_glue_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_catalog_to_glue::ImportCatalogToGlue::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::import_catalog_to_glue::ImportCatalogToGlueError
{
