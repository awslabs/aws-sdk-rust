    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_dev_endpoint::GetDevEndpointError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_dev_endpoint::GetDevEndpointOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDevEndpoint {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDevEndpoint")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetDevEndpointEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetDevEndpointResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetDevEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_dev_endpoint::GetDevEndpointInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_dev_endpoint::ser_get_dev_endpoint_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetDevEndpointEndpointParamsInterceptor {
...
pub type GetDevEndpointErrorKind = GetDevEndpointError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_dev_endpoint::GetDevEndpointError {
...
impl GetDevEndpointError {
    ...
    /// Creates the `GetDevEndpointError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
