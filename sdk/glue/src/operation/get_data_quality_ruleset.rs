    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_data_quality_ruleset::GetDataQualityRulesetError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_data_quality_ruleset::GetDataQualityRulesetOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetDataQualityRulesetResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetDataQualityRulesetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_data_quality_ruleset::GetDataQualityRulesetInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_data_quality_ruleset::ser_get_data_quality_ruleset_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetDataQualityRulesetEndpointParamsInterceptor {
...
pub type GetDataQualityRulesetErrorKind = GetDataQualityRulesetError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_data_quality_ruleset::GetDataQualityRulesetError {
...
impl GetDataQualityRulesetError {
    ...
    /// Creates the `GetDataQualityRulesetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
