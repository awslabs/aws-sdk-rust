...
impl GetWorkflowRunPropertiesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_workflow_run_properties::GetWorkflowRunProperties,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_workflow_run_properties::GetWorkflowRunProperties::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkflowRunProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_workflow_run_properties::de_get_workflow_run_properties_http_response_with_props(status, headers, body)
        }
    }
}
