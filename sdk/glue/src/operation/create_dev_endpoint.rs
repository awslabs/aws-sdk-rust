...
impl CreateDevEndpointInput {
    /// Consumes the builder and constructs an Operation<[`CreateDevEndpoint`](crate::operation::create_dev_endpoint::CreateDevEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_dev_endpoint::CreateDevEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_dev_endpoint::CreateDevEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_dev_endpoint::ser_create_dev_endpoint_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_dev_endpoint::CreateDevEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDevEndpoint", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDevEndpoint {
                type Output = std::result::Result<crate::operation::create_dev_endpoint::CreateDevEndpointOutput, crate::operation::create_dev_endpoint::CreateDevEndpointError>;
