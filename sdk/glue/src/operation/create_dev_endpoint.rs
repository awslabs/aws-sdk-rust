...
impl CreateDevEndpoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_dev_endpoint::CreateDevEndpointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_dev_endpoint::CreateDevEndpointOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "CreateDevEndpoint", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.CreateDevEndpoint",
                "rpc.service" = "Glue",
                "rpc.method" = "CreateDevEndpoint",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDevEndpoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateDevEndpointRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateDevEndpointResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateDevEndpoint")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateDevEndpoint", "Glue"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDevEndpoint")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateDevEndpointTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateDevEndpointTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDevEndpointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateDevEndpointInput>() else {
        ...
        if requested.should_capture("ExtraPythonLibsS3Path") {
            if let ::std::option::Option::Some(value) = input.extra_python_libs_s3_path.as_deref() {
                captured.insert("ExtraPythonLibsS3Path", value);
            }
        }
        if requested.should_capture("ExtraJarsS3Path") {
            if let ::std::option::Option::Some(value) = input.extra_jars_s3_path.as_deref() {
                captured.insert("ExtraJarsS3Path", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDevEndpointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_dev_endpoint::de_create_dev_endpoint_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_dev_endpoint::de_create_dev_endpoint_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDevEndpointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_dev_endpoint::CreateDevEndpointInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_dev_endpoint::CreateDevEndpointInput,
