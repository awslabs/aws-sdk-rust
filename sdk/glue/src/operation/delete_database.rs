...
impl DeleteDatabaseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_database::DeleteDatabase, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_database::ser_delete_database_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDatabase {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_database::de_delete_database_http_response_with_props(status, headers, body)
        }
    }
}
