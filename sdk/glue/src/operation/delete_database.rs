...
impl DeleteDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDatabase`](crate::operation::delete_database::DeleteDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_database::DeleteDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_database::DeleteDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_database::ser_delete_database_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_database::DeleteDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDatabase", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDatabase {
                type Output = std::result::Result<crate::operation::delete_database::DeleteDatabaseOutput, crate::operation::delete_database::DeleteDatabaseError>;
