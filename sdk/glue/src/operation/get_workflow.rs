...
impl GetWorkflowInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_workflow::ser_get_workflow_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_workflow::GetWorkflow::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetWorkflow", "glue"));
