...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetColumnStatisticsForPartition {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetColumnStatisticsForPartition", "glue"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetColumnStatisticsForPartitionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetColumnStatisticsForPartitionRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetColumnStatisticsForPartitionEndpointParamsInterceptor {
