    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_export_labels_task_run::StartExportLabelsTaskRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_export_labels_task_run::StartExportLabelsTaskRunOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartExportLabelsTaskRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartExportLabelsTaskRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_export_labels_task_run::StartExportLabelsTaskRunInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartExportLabelsTaskRunEndpointParamsInterceptor {
...
pub type StartExportLabelsTaskRunErrorKind = StartExportLabelsTaskRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::start_export_labels_task_run::StartExportLabelsTaskRunError {
...
impl StartExportLabelsTaskRunError {
    ...
    /// Creates the `StartExportLabelsTaskRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
