...
impl GetJobRunInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_job_run::ser_get_job_run_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_job_run::GetJobRun::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetJobRun", "glue"));
