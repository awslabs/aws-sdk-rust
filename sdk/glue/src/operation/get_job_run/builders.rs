...
impl crate::operation::get_job_run::builders::GetJobRunInputBuilder {
    ...
    > for GetJobRunFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_job_run::GetJobRunOutput, crate::operation::get_job_run::GetJobRunError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetJobRunFluentBuilder {
    /// Creates a new `GetJobRunFluentBuilder`.
