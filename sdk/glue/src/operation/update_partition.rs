...
impl UpdatePartitionInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePartition`](crate::operation::update_partition::UpdatePartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_partition::UpdatePartition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_partition::UpdatePartitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_partition::ser_update_partition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_partition::UpdatePartition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdatePartition", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdatePartition {
                type Output = std::result::Result<crate::operation::update_partition::UpdatePartitionOutput, crate::operation::update_partition::UpdatePartitionError>;
