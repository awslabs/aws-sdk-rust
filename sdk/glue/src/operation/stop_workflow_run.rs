...
/// Orchestration and serialization glue logic for `StopWorkflowRun`.
...
impl StopWorkflowRun {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::stop_workflow_run::StopWorkflowRunInput,
                    ) -> ::std::result::Result<crate::operation::stop_workflow_run::StopWorkflowRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_workflow_run::StopWorkflowRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_workflow_run::StopWorkflowRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_workflow_run::StopWorkflowRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopWorkflowRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopWorkflowRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopWorkflowRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopWorkflowRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopWorkflowRun")
...
.with_interceptor(StopWorkflowRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_workflow_run::StopWorkflowRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_workflow_run::StopWorkflowRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_workflow_run::StopWorkflowRunError>::new());
...
#[derive(Debug)]
            struct StopWorkflowRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopWorkflowRunResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_workflow_run::de_stop_workflow_run_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_workflow_run::de_stop_workflow_run_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopWorkflowRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopWorkflowRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_workflow_run::StopWorkflowRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_workflow_run::StopWorkflowRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_workflow_run::ser_stop_workflow_run_input(&input)?);
...
#[derive(Debug)]
            struct StopWorkflowRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopWorkflowRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopWorkflowRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopWorkflowRunInput>()
                        .ok_or("failed to downcast to StopWorkflowRunInput")?;
...
/// Error type for the `StopWorkflowRunError` operation.
#[non_exhaustive]
...
pub enum StopWorkflowRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopWorkflowRunError) for what information is available for the error.")]
...
impl StopWorkflowRunError {
    /// Creates the `StopWorkflowRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopWorkflowRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StopWorkflowRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StopWorkflowRunError::IllegalWorkflowStateException`.
    pub fn is_illegal_workflow_state_exception(&self) -> bool {
        matches!(self, Self::IllegalWorkflowStateException(_))
    }
    /// Returns `true` if the error kind is `StopWorkflowRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StopWorkflowRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `StopWorkflowRunError::OperationTimeoutException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopWorkflowRunError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopWorkflowRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_workflow_run::StopWorkflowRunError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::stop_workflow_run::_stop_workflow_run_output::StopWorkflowRunOutput;

pub use crate::operation::stop_workflow_run::_stop_workflow_run_input::StopWorkflowRunInput;

mod _stop_workflow_run_input;

mod _stop_workflow_run_output;
