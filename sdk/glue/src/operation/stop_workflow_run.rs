    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_workflow_run::StopWorkflowRunError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_workflow_run::StopWorkflowRunOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopWorkflowRun {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopWorkflowRun")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(StopWorkflowRunEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopWorkflowRunResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopWorkflowRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_workflow_run::StopWorkflowRunInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_workflow_run::ser_stop_workflow_run_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopWorkflowRunEndpointParamsInterceptor {
...
pub type StopWorkflowRunErrorKind = StopWorkflowRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_workflow_run::StopWorkflowRunError {
...
impl StopWorkflowRunError {
    ...
    /// Creates the `StopWorkflowRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
