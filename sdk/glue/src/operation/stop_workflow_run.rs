...
impl StopWorkflowRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_workflow_run::StopWorkflowRun, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_workflow_run::ser_stop_workflow_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopWorkflowRun {
    type Output =
        ::std::result::Result<crate::operation::stop_workflow_run::StopWorkflowRunOutput, crate::operation::stop_workflow_run::StopWorkflowRunError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_workflow_run::de_stop_workflow_run_http_response_with_props(status, headers, body)
        }
    }
}
