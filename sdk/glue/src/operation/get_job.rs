...
impl GetJob {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("glue", "GetJob", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetJob", "glue"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder =
                _header_serialization_settings.set_default_header(builder, ::http::header::HeaderName::from_static("x-amz-target"), "AWSGlue.GetJob");
            builder
        };
...
impl GetJobError {
    ...
    /// Returns `true` if the error kind is `GetJobError::EntityNotFoundException`.
    ...
    /// Returns `true` if the error kind is `GetJobError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetJobError::OperationTimeoutException`.
