...
impl BatchGetJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_jobs::BatchGetJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_get_jobs::de_batch_get_jobs_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_batch_get_jobs::de_batch_get_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
