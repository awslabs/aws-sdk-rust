...
impl GetUnfilteredPartitionMetadata {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetUnfilteredPartitionMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetUnfilteredPartitionMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetUnfilteredPartitionMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetUnfilteredPartitionMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetUnfilteredPartitionMetadata")
...
.with_interceptor(GetUnfilteredPartitionMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError>::new());
...
#[derive(Debug)]
            struct GetUnfilteredPartitionMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetUnfilteredPartitionMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_unfiltered_partition_metadata::de_get_unfiltered_partition_metadata_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_unfiltered_partition_metadata::de_get_unfiltered_partition_metadata_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetUnfilteredPartitionMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetUnfilteredPartitionMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_unfiltered_partition_metadata::ser_get_unfiltered_partition_metadata_input(&input)?);
...
#[derive(Debug)]
            struct GetUnfilteredPartitionMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetUnfilteredPartitionMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetUnfilteredPartitionMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetUnfilteredPartitionMetadataInput>()
                        .ok_or("failed to downcast to GetUnfilteredPartitionMetadataInput")?;
...
/// Error type for the `GetUnfilteredPartitionMetadataError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetUnfilteredPartitionMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetUnfilteredPartitionMetadataError) for what information is available for the error.")]
...
impl GetUnfilteredPartitionMetadataError {
    /// Creates the `GetUnfilteredPartitionMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetUnfilteredPartitionMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::FederationSourceException`.
    pub fn is_federation_source_exception(&self) -> bool {
        matches!(self, Self::FederationSourceException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::FederationSourceRetryableException`.
    pub fn is_federation_source_retryable_exception(&self) -> bool {
        matches!(self, Self::FederationSourceRetryableException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `GetUnfilteredPartitionMetadataError::PermissionTypeMismatchException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetUnfilteredPartitionMetadataError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetUnfilteredPartitionMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_unfiltered_partition_metadata::_get_unfiltered_partition_metadata_output::GetUnfilteredPartitionMetadataOutput;

pub use crate::operation::get_unfiltered_partition_metadata::_get_unfiltered_partition_metadata_input::GetUnfilteredPartitionMetadataInput;

mod _get_unfiltered_partition_metadata_input;

mod _get_unfiltered_partition_metadata_output;
