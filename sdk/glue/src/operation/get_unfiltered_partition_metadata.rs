...
impl GetUnfilteredPartitionMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadata,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUnfilteredPartitionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_unfiltered_partition_metadata::de_get_unfiltered_partition_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
