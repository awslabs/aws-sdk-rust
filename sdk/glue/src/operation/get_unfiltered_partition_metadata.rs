...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUnfilteredPartitionMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_unfiltered_partition_metadata::de_get_unfiltered_partition_metadata_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetUnfilteredPartitionMetadataError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_unfiltered_partition_metadata::GetUnfilteredPartitionMetadataError
{
