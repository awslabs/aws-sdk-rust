...
impl GetSecurityConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_security_configuration::GetSecurityConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
