...
impl GetTriggerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_trigger::GetTrigger, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_trigger::ser_get_trigger_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTrigger {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_trigger::de_get_trigger_http_response_with_props(status, headers, body)
        }
    }
}
