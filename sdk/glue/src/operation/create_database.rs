...
impl CreateDatabaseInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_database::CreateDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_database::CreateDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_database::CreateDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDatabase", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDatabase {
                type Output = std::result::Result<crate::operation::create_database::CreateDatabaseOutput, crate::operation::create_database::CreateDatabaseError>;
...
impl CreateDatabaseError {
    ...
    /// Returns `true` if the error kind is `CreateDatabaseError::AlreadyExistsException`.
    ...
    /// Returns `true` if the error kind is `CreateDatabaseError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateDatabaseError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateDatabaseError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CreateDatabaseError::ResourceNumberLimitExceededException`.
