...
impl BatchGetPartitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_get_partition::BatchGetPartition,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_get_partition::ser_batch_get_partition_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetPartition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_partition::de_batch_get_partition_http_response_with_props(status, headers, body)
        }
    }
}
