...
impl StartBlueprintRun {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::start_blueprint_run::StartBlueprintRunInput,
                    ) -> ::std::result::Result<crate::operation::start_blueprint_run::StartBlueprintRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_blueprint_run::StartBlueprintRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_blueprint_run::StartBlueprintRunError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_blueprint_run::StartBlueprintRunOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartBlueprintRun {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartBlueprintRun");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartBlueprintRunRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartBlueprintRunResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartBlueprintRun")
...
.with_interceptor(StartBlueprintRunEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_blueprint_run::StartBlueprintRunError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_blueprint_run::StartBlueprintRunError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_blueprint_run::StartBlueprintRunError>::new());
...
#[derive(Debug)]
            struct StartBlueprintRunResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartBlueprintRunResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_blueprint_run::de_start_blueprint_run_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_blueprint_run::de_start_blueprint_run_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartBlueprintRunRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartBlueprintRunRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_blueprint_run::StartBlueprintRunInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_blueprint_run::StartBlueprintRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_blueprint_run::ser_start_blueprint_run_input(&input)?);
...
#[derive(Debug)]
            struct StartBlueprintRunEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartBlueprintRunEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartBlueprintRunEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartBlueprintRunInput>()
                        .ok_or("failed to downcast to StartBlueprintRunInput")?;
...
/// Error type for the `StartBlueprintRunError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartBlueprintRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartBlueprintRunError) for what information is available for the error.")]
...
impl StartBlueprintRunError {
    /// Creates the `StartBlueprintRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartBlueprintRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::IllegalBlueprintStateException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `StartBlueprintRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartBlueprintRunError::IllegalBlueprintStateException`.
    pub fn is_illegal_blueprint_state_exception(&self) -> bool {
        matches!(self, Self::IllegalBlueprintStateException(_))
    }
    /// Returns `true` if the error kind is `StartBlueprintRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartBlueprintRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `StartBlueprintRunError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `StartBlueprintRunError::ResourceNumberLimitExceededException`.
...
impl ::std::error::Error for StartBlueprintRunError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ,
            Self::IllegalBlueprintStateException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartBlueprintRunError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartBlueprintRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_blueprint_run::StartBlueprintRunError {
...
mod _start_blueprint_run_output;
