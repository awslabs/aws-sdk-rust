...
impl StartBlueprintRunInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_blueprint_run::StartBlueprintRun,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_blueprint_run::ser_start_blueprint_run_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartBlueprintRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_blueprint_run::de_start_blueprint_run_http_response_with_props(status, headers, body)
        }
    }
}
