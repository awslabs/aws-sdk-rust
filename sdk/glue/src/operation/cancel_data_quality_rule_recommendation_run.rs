...
impl CancelDataQualityRuleRecommendationRunInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_data_quality_rule_recommendation_run::CancelDataQualityRuleRecommendationRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_data_quality_rule_recommendation_run::CancelDataQualityRuleRecommendationRunInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
