...
impl GetPartitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_partitions::GetPartitions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_partitions::ser_get_partitions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPartitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_partitions::de_get_partitions_http_response_with_props(status, headers, body)
        }
    }
}
