...
impl GetPartitionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_partitions::GetPartitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPartitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_partitions::de_get_partitions_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_partitions::de_get_partitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
