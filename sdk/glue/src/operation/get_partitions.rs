...
impl GetPartitionsInput {
    /// Consumes the builder and constructs an Operation<[`GetPartitions`](crate::operation::get_partitions::GetPartitions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_partitions::GetPartitions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_partitions::GetPartitionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_partitions::ser_get_partitions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_partitions::GetPartitions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPartitions", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPartitions {
                type Output = std::result::Result<crate::operation::get_partitions::GetPartitionsOutput, crate::operation::get_partitions::GetPartitionsError>;
