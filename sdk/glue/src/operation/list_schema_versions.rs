...
impl ListSchemaVersionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_schema_versions::ser_list_schema_versions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSchemaVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_schema_versions::de_list_schema_versions_http_response_with_props(status, headers, body)
        }
    }
}
