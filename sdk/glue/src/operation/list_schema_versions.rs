...
impl ListSchemaVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListSchemaVersions`](crate::operation::list_schema_versions::ListSchemaVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_schema_versions::ListSchemaVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_schema_versions::ListSchemaVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_schema_versions::ser_list_schema_versions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_schema_versions::ListSchemaVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSchemaVersions", "glue"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListSchemaVersions {
                type Output = std::result::Result<crate::operation::list_schema_versions::ListSchemaVersionsOutput, crate::operation::list_schema_versions::ListSchemaVersionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_schema_versions::de_list_schema_versions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_schema_versions::de_list_schema_versions_http_response(response)
                     }
                }
            }
