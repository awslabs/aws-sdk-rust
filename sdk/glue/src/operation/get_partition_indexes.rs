...
impl GetPartitionIndexesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_partition_indexes::ser_get_partition_indexes_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_partition_indexes::GetPartitionIndexes::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_partition_indexes::GetPartitionIndexesError
{
