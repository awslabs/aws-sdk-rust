...
impl CancelStatementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_statement::CancelStatement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelStatement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_cancel_statement::de_cancel_statement_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_statement::CancelStatementError
{
