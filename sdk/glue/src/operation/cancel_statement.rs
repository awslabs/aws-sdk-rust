...
impl CancelStatementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_statement::CancelStatement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_statement::ser_cancel_statement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelStatement {
    type Output =
        ::std::result::Result<crate::operation::cancel_statement::CancelStatementOutput, crate::operation::cancel_statement::CancelStatementError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_statement::de_cancel_statement_http_response_with_props(status, headers, body)
        }
    }
}
