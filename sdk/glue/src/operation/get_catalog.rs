...
/// Orchestration and serialization glue logic for `GetCatalog`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetCatalog;
impl GetCatalog {
    /// Creates a new `GetCatalog`
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::get_catalog::GetCatalogInput,
    ) -> ::std::result::Result<
        crate::operation::get_catalog::GetCatalogOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::get_catalog::GetCatalogError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_catalog::GetCatalogError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_catalog::GetCatalogOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Glue", "GetCatalog", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Glue.GetCatalog",
                "rpc.service" = "Glue",
                "rpc.method" = "GetCatalog",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCatalog {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCatalog");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetCatalogRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetCatalogResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetCatalog")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetCatalog", "Glue"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCatalog")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetCatalogTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetCatalogEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct GetCatalogTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCatalogTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetCatalogInput>() else {
...
#[derive(Debug)]
struct GetCatalogResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCatalogResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_catalog::de_get_catalog_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_catalog::de_get_catalog_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetCatalogRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCatalogRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<crate::operation::get_catalog::GetCatalogInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_catalog::GetCatalogInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_catalog::ser_get_catalog_input(&input)?);
...
#[derive(Debug)]
struct GetCatalogEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCatalogEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetCatalogEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetCatalogInput>()
            .ok_or("failed to downcast to GetCatalogInput")?;
...
/// Error type for the `GetCatalogError` operation.
#[non_exhaustive]
...
pub enum GetCatalogError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCatalogError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetCatalogError {
    /// Creates the `GetCatalogError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetCatalogError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetCatalogError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::FederationSourceException`.
    pub fn is_federation_source_exception(&self) -> bool {
        matches!(self, Self::FederationSourceException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::FederationSourceRetryableException`.
    pub fn is_federation_source_retryable_exception(&self) -> bool {
        matches!(self, Self::FederationSourceRetryableException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
}
impl ::std::error::Error for GetCatalogError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetCatalogError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCatalogError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCatalogError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_catalog::GetCatalogError {
