...
pub use crate::operation::describe_inbound_integrations::_describe_inbound_integrations_output::DescribeInboundIntegrationsOutputBuilder;

pub use crate::operation::describe_inbound_integrations::_describe_inbound_integrations_input::DescribeInboundIntegrationsInputBuilder;

impl crate::operation::describe_inbound_integrations::builders::DescribeInboundIntegrationsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.describe_inbound_integrations();
...
pub struct DescribeInboundIntegrationsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_inbound_integrations::builders::DescribeInboundIntegrationsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::describe_inbound_integrations::DescribeInboundIntegrationsOutput,
        crate::operation::describe_inbound_integrations::DescribeInboundIntegrationsError,
    > for DescribeInboundIntegrationsFluentBuilder
{
    fn send(
        self,
...
impl DescribeInboundIntegrationsFluentBuilder {
    /// Creates a new `DescribeInboundIntegrationsFluentBuilder`.
    ...
    pub fn as_input(&self) -> &crate::operation::describe_inbound_integrations::builders::DescribeInboundIntegrationsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::describe_inbound_integrations::DescribeInboundIntegrations::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::describe_inbound_integrations::DescribeInboundIntegrations::orchestrate(&runtime_plugins, input).await
    }
