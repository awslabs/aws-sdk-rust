...
impl GetTriggersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_triggers::GetTriggers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_triggers::ser_get_triggers_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTriggers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_triggers::de_get_triggers_http_response_with_props(status, headers, body)
        }
    }
}
