...
impl DeletePartitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_partition::DeletePartition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePartition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_partition::de_delete_partition_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_partition::DeletePartitionError
{
