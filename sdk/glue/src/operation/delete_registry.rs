...
impl DeleteRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_registry::DeleteRegistry, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_registry::ser_delete_registry_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRegistry {
    type Output =
        ::std::result::Result<crate::operation::delete_registry::DeleteRegistryOutput, crate::operation::delete_registry::DeleteRegistryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_registry::de_delete_registry_http_response_with_props(status, headers, body)
        }
    }
}
