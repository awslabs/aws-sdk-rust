...
impl DeleteRegistryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_registry::DeleteRegistry,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_registry::DeleteRegistry::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRegistry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_registry::de_delete_registry_http_error(
                status, headers, body,
            )
        } else {
