...
impl StartCrawlerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_crawler::StartCrawler::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartCrawler {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_crawler::de_start_crawler_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_crawler::de_start_crawler_http_response_with_props(
                status, headers, body,
            )
        }
    }
