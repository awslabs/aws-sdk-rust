...
impl StartCrawlerInput {
    /// Consumes the builder and constructs an Operation<[`StartCrawler`](crate::operation::start_crawler::StartCrawler)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_crawler::StartCrawler, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_crawler::ser_start_crawler_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_crawler::StartCrawler::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartCrawler", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartCrawler {
    type Output = ::std::result::Result<crate::operation::start_crawler::StartCrawlerOutput, crate::operation::start_crawler::StartCrawlerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_crawler::de_start_crawler_http_response_with_props(status, headers, body)
        }
    }
}
