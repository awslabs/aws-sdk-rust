...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSecurityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_security_configuration::de_create_security_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateSecurityConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_security_configuration::CreateSecurityConfigurationError
{
