...
pub fn ser_list_crawls_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCrawlsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
