...
pub fn ser_get_column_statistics_for_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_column_statistics_for_table::GetColumnStatisticsForTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
