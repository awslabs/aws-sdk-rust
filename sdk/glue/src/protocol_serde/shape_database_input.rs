...
pub fn ser_database_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatabaseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
