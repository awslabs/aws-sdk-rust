...
pub fn ser_segment(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Segment) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
