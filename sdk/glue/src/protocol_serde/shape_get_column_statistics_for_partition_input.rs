...
pub fn ser_get_column_statistics_for_partition_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionInput,
