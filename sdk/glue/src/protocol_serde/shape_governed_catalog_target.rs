...
pub fn ser_governed_catalog_target(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GovernedCatalogTarget) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_governed_catalog_target<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::GovernedCatalogTarget>, aws_smithy_json::deserialize::error::DeserializeError>
