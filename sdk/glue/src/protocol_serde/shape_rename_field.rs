...
pub fn ser_rename_field(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::RenameField) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
