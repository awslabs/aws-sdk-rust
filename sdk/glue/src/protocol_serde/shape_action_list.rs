...
pub(crate) fn de_action_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Action>>, ::aws_smithy_json::deserialize::error::DeserializeError>
