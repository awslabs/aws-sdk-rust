...
pub fn de_update_asset_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_asset::UpdateAssetOutput, crate::operation::update_asset::UpdateAssetError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "ConcurrentModificationException" => crate::operation::update_asset::UpdateAssetError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "EntityNotFoundException" => crate::operation::update_asset::UpdateAssetError::EntityNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServiceException" => crate::operation::update_asset::UpdateAssetError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidInputException" => crate::operation::update_asset::UpdateAssetError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_asset_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_asset::UpdateAssetOutput, crate::operation::update_asset::UpdateAssetError> {
    Ok({
        ...
        crate::serde_util::update_asset_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::update_asset::UpdateAssetError::unhandled)?
    })
}
...
pub fn ser_update_asset_input(
    ...
    crate::protocol_serde::shape_update_asset_input::ser_update_asset_input_input(&mut object, input)?;
    object.finish();
...
) -> ::std::result::Result<crate::operation::update_asset::builders::UpdateAssetOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
