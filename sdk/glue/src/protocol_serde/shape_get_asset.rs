...
pub fn de_get_asset_http_error(
    ...
    Err(match error_code {
        ...
        "EntityNotFoundException" => crate::operation::get_asset::GetAssetError::EntityNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServiceException" => crate::operation::get_asset::GetAssetError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidInputException" => crate::operation::get_asset::GetAssetError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_get_asset_input(
    input: &crate::operation::get_asset::GetAssetInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_get_asset_input::ser_get_asset_input_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "AssetTypeId" => {
                    builder = builder.set_asset_type_id(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                            .transpose()?,
                    );
                ...
                "Forms" => {
                    builder = builder.set_forms(crate::protocol_serde::shape_asset_form_map::de_asset_form_map(tokens, _value, depth + 1)?);
                }
                "Attachments" => {
                    builder = builder.set_attachments(crate::protocol_serde::shape_asset_form_map::de_asset_form_map(tokens, _value, depth + 1)?);
                }
                "IterableForms" => {
                    builder = builder.set_iterable_forms(crate::protocol_serde::shape_iterable_form_map::de_iterable_form_map(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
