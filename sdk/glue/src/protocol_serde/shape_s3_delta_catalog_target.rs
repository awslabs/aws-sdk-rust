...
pub fn ser_s3_delta_catalog_target(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3DeltaCatalogTarget) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_16) = &input.schema_change_policy {
        #[allow(unused_mut)]
        let mut object_17 = object.key("SchemaChangePolicy").start_object();
        crate::protocol_serde::shape_catalog_schema_change_policy::ser_catalog_schema_change_policy(&mut object_17, var_16)?;
        object_17.finish();
    }
    Ok(())
}

pub(crate) fn de_s3_delta_catalog_target<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::S3DeltaCatalogTarget>, aws_smithy_json::deserialize::error::DeserializeError>
