...
pub fn ser_update_csv_classifier_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateCsvClassifierRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
