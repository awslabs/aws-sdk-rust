...
pub(crate) fn de_catalog_kinesis_source<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::CatalogKinesisSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(crate::serde_util::catalog_kinesis_source_correct_errors(builder).build().map_err(
