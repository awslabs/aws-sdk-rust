...
pub fn ser_job_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
