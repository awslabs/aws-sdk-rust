...
pub fn ser_update_crawler_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCrawlerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
