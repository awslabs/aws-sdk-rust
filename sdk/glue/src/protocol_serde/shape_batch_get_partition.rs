...
pub fn de_batch_get_partition_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::batch_get_partition::BatchGetPartitionOutput, crate::operation::batch_get_partition::BatchGetPartitionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::batch_get_partition::BatchGetPartitionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_partition_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::batch_get_partition::BatchGetPartitionOutput, crate::operation::batch_get_partition::BatchGetPartitionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::batch_get_partition::builders::BatchGetPartitionOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_batch_get_partition::de_batch_get_partition(response.body().as_ref(), output).map_err(crate::operation::batch_get_partition::BatchGetPartitionError::unhandled)?;
