...
pub fn de_batch_get_partition_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::batch_get_partition::BatchGetPartitionOutput, crate::operation::batch_get_partition::BatchGetPartitionError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::batch_get_partition::BatchGetPartitionOutput, crate::operation::batch_get_partition::BatchGetPartitionError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_partition::de_batch_get_partition(_response_body, output)
            .map_err(crate::operation::batch_get_partition::BatchGetPartitionError::unhandled)?;
...
) -> Result<crate::operation::batch_get_partition::builders::BatchGetPartitionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
