                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TransformStatusType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CreatedOn" => {
                        ...
                        "TransformEncryption" => {
                            builder =
                                builder.set_transform_encryption(crate::protocol_serde::shape_transform_encryption::de_transform_encryption(tokens)?);
                        }
