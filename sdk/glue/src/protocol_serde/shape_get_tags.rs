...
pub fn de_get_tags_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_tags::GetTagsOutput, crate::operation::get_tags::GetTagsError> {
    ...
    Err(match error_code {
        "EntityNotFoundException" => crate::operation::get_tags::GetTagsError::EntityNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServiceException" => crate::operation::get_tags::GetTagsError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidInputException" => crate::operation::get_tags::GetTagsError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "OperationTimeoutException" => crate::operation::get_tags::GetTagsError::OperationTimeoutException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
