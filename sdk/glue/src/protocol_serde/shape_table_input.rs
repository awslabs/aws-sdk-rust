...
pub fn ser_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
