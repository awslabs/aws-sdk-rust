...
pub fn ser_table_input(
    ...
    if let Some(var_3) = &input.last_access_time {
        object.key("LastAccessTime").date_time(var_3, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_4) = &input.last_analyzed_time {
        object.key("LastAnalyzedTime").date_time(var_4, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
