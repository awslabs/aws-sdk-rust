...
) -> std::result::Result<crate::operation::create_dev_endpoint::CreateDevEndpointOutput, crate::operation::create_dev_endpoint::CreateDevEndpointError>
{
    ...
    Err(match error_code {
        ...
        "IdempotentParameterMismatchException" => {
            crate::operation::create_dev_endpoint::CreateDevEndpointError::IdempotentParameterMismatchException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNumberLimitExceededException" => {
            crate::operation::create_dev_endpoint::CreateDevEndpointError::ResourceNumberLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::create_dev_endpoint::CreateDevEndpointOutput, crate::operation::create_dev_endpoint::CreateDevEndpointError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_create_dev_endpoint::de_create_dev_endpoint(_response_body, output)
            .map_err(crate::operation::create_dev_endpoint::CreateDevEndpointError::unhandled)?;
...
) -> Result<crate::operation::create_dev_endpoint::builders::CreateDevEndpointOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Arguments" => {
                    builder = builder.set_arguments(crate::protocol_serde::shape_map_value::de_map_value(tokens)?);
                }
