...
pub fn ser_get_partition_indexes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPartitionIndexesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
