    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SchemaChangePolicy" => {
                            builder = builder.set_schema_change_policy(
                                crate::protocol_serde::shape_direct_schema_change_policy::de_direct_schema_change_policy(tokens, _value, depth + 1)?,
                            );
                        }
                        "AutoDataQuality" => {
                            builder = builder.set_auto_data_quality(crate::protocol_serde::shape_auto_data_quality::de_auto_data_quality(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
            ...
            Ok(Some(crate::serde_util::s3_direct_target_correct_errors(builder).build().map_err(
