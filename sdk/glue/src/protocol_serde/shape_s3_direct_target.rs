...
pub fn ser_s3_direct_target(
    ...
    if let Some(var_13) = &input.schema_change_policy {
        ...
        crate::protocol_serde::shape_direct_schema_change_policy::ser_direct_schema_change_policy(
            &mut object_14,
            var_13,
        )?;
        object_14.finish();
...
pub(crate) fn de_s3_direct_target<'a, I>(
    ...
    Option<crate::types::S3DirectTarget>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Format" => {
                                builder = builder.set_format(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::TargetFormat::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
