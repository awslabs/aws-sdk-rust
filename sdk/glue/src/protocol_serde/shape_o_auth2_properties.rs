                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "OAuth2ClientApplication" => {
                            builder = builder.set_o_auth2_client_application(
                                crate::protocol_serde::shape_o_auth2_client_application::de_o_auth2_client_application(tokens, _value, depth + 1)?,
                            );
                        }
                        "TokenUrl" => {
                        ...
                        "TokenUrlParametersMap" => {
                            builder = builder.set_token_url_parameters_map(
                                crate::protocol_serde::shape_token_url_parameters_map::de_token_url_parameters_map(tokens, _value, depth + 1)?,
                            );
                        }
