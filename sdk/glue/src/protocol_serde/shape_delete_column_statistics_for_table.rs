...
pub fn de_delete_column_statistics_for_table_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTableOutput, crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTableError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_column_statistics_for_table_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTableOutput, crate::operation::delete_column_statistics_for_table::DeleteColumnStatisticsForTableError> {
    Ok({
        #[allow(unused_mut)]
