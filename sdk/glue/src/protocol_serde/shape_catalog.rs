...
) -> Result<Option<crate::types::Catalog>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TargetRedshiftCatalog" => {
                            builder = builder.set_target_redshift_catalog(
                                crate::protocol_serde::shape_target_redshift_catalog::de_target_redshift_catalog(tokens)?,
                            );
                        }
                        "FederatedCatalog" => {
                            builder = builder.set_federated_catalog(crate::protocol_serde::shape_federated_catalog::de_federated_catalog(tokens)?);
                        }
                        "CatalogProperties" => {
                            builder = builder.set_catalog_properties(
                                crate::protocol_serde::shape_catalog_properties_output::de_catalog_properties_output(tokens)?,
                            );
                        }
