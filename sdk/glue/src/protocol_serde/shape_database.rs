    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TargetDatabase" => {
                            builder = builder.set_target_database(crate::protocol_serde::shape_database_identifier::de_database_identifier(tokens)?);
                        }
                        "CatalogId" => {
                        ...
                        "FederatedDatabase" => {
                            builder = builder.set_federated_database(crate::protocol_serde::shape_federated_database::de_federated_database(tokens)?);
                        }
            ...
            Ok(Some(crate::serde_util::database_correct_errors(builder).build().map_err(|err| {
