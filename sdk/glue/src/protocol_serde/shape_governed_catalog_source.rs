...
pub fn ser_governed_catalog_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GovernedCatalogSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
