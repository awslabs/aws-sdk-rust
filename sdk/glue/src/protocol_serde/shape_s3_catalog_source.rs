...
pub fn ser_s3_catalog_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3CatalogSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
