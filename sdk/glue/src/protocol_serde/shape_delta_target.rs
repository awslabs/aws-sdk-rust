...
pub fn ser_delta_target(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::DeltaTarget,
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "DeltaTables" => {
                            builder = builder.set_delta_tables(crate::protocol_serde::shape_path_list::de_path_list(tokens, _value, depth + 1)?);
                        }
                        "ConnectionName" => {
                        ...
                        "WriteManifest" => {
                            builder = builder.set_write_manifest(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "CreateNativeDeltaTable" => {
                            builder =
                                builder.set_create_native_delta_table(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
