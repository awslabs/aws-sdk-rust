...
pub fn ser_update_database_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDatabaseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
