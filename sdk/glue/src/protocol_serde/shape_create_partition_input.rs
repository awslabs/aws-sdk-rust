...
pub fn ser_create_partition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePartitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
