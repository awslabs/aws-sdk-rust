...
pub fn ser_direct_jdbc_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DirectJdbcSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
