...
pub fn ser_get_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetConnectionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
