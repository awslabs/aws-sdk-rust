...
pub fn ser_put_schema_version_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutSchemaVersionMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
