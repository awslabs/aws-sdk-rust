...
pub(crate) fn de_amazon_redshift_node_data<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AmazonRedshiftNodeData>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CatalogDatabase" => {
                                builder = builder.set_catalog_database(
                                    crate::protocol_serde::shape_option::de_option(tokens)?
                                );
                            }
                            "CatalogTable" => {
                                builder = builder.set_catalog_table(
                                    crate::protocol_serde::shape_option::de_option(tokens)?
                                );
                            }
                            ...
                            "TableSchema" => {
                                builder = builder.set_table_schema(
