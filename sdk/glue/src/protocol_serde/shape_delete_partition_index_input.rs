...
pub fn ser_delete_partition_index_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeletePartitionIndexInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
