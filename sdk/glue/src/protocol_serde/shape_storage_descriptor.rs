...
pub(crate) fn de_storage_descriptor<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StorageDescriptor>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_storage_descriptor(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StorageDescriptor) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
