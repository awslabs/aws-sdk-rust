...
pub fn ser_get_job_run_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_job_run::GetJobRunInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
