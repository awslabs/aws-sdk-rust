...
pub fn ser_s3_hudi_source(
    ...
    if let Some(var_3) = &input.additional_hudi_options {
        #[allow(unused_mut)]
        let mut object_4 = object.key("AdditionalHudiOptions").start_object();
...
pub(crate) fn de_s3_hudi_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3HudiSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::s3_hudi_source_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
