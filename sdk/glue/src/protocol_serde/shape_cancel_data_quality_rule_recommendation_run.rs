...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_data_quality_rule_recommendation_run::CancelDataQualityRuleRecommendationRunError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::cancel_data_quality_rule_recommendation_run::CancelDataQualityRuleRecommendationRunError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::cancel_data_quality_rule_recommendation_run::CancelDataQualityRuleRecommendationRunError::EntityNotFoundException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_entity_not_found_exception::de_entity_not_found_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::cancel_data_quality_rule_recommendation_run::CancelDataQualityRuleRecommendationRunError::unhandled,
                        )?;
...
pub fn ser_cancel_data_quality_rule_recommendation_run_input(
    ...
    crate::protocol_serde::shape_cancel_data_quality_rule_recommendation_run_input::ser_cancel_data_quality_rule_recommendation_run_input_input(
        &mut object,
        input,
    )?;
    object.finish();
