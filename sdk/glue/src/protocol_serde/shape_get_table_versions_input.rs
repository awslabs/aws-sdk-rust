...
pub fn ser_get_table_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_table_versions::GetTableVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
