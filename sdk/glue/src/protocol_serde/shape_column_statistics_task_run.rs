...
pub(crate) fn de_column_statistics_task_run<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ColumnStatisticsTaskRun>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ColumnNameList" => {
                                builder = builder.set_column_name_list(
                            ...
                            "Status" => {
                                builder = builder.set_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ColumnStatisticsState::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
