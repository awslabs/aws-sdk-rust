...
pub fn ser_table_optimizer_vpc_configuration(
    ...
    match input {
        ...
        crate::types::TableOptimizerVpcConfiguration::Unknown => {
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "glueConnectionName" => Some(crate::types::TableOptimizerVpcConfiguration::GlueConnectionName(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                                .transpose()?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'glueConnectionName' cannot be null")
                                })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::TableOptimizerVpcConfiguration::Unknown)
                        }
                    };
                }
                other => {
