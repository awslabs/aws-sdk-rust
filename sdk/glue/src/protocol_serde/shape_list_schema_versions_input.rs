...
pub fn ser_list_schema_versions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSchemaVersionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
