...
pub fn ser_delete_partition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_partition::DeletePartitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
