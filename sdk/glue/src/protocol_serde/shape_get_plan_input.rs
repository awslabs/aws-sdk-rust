...
pub fn ser_get_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
