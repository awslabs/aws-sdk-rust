...
pub fn ser_create_crawler_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCrawlerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
