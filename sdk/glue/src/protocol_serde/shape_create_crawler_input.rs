...
pub fn ser_create_crawler_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_crawler::CreateCrawlerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
