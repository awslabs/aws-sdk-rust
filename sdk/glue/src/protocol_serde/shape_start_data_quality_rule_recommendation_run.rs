...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_data_quality_rule_recommendation_run::StartDataQualityRuleRecommendationRunError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::start_data_quality_rule_recommendation_run::StartDataQualityRuleRecommendationRunError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ConflictException" => {
            crate::operation::start_data_quality_rule_recommendation_run::StartDataQualityRuleRecommendationRunError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(
                        crate::operation::start_data_quality_rule_recommendation_run::StartDataQualityRuleRecommendationRunError::unhandled,
                    )?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_data_quality_rule_recommendation_run::de_start_data_quality_rule_recommendation_run(
            _response_body,
            output,
        )
        .map_err(crate::operation::start_data_quality_rule_recommendation_run::StartDataQualityRuleRecommendationRunError::unhandled)?;
...
pub fn ser_start_data_quality_rule_recommendation_run_input(
    ...
    crate::protocol_serde::shape_start_data_quality_rule_recommendation_run_input::ser_start_data_quality_rule_recommendation_run_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_start_data_quality_rule_recommendation_run(
    value: &[u8],
    mut builder: crate::operation::start_data_quality_rule_recommendation_run::builders::StartDataQualityRuleRecommendationRunOutputBuilder,
) -> Result<
    crate::operation::start_data_quality_rule_recommendation_run::builders::StartDataQualityRuleRecommendationRunOutputBuilder,
