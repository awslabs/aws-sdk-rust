                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ConnectorDataSource" => {
                                builder = builder.set_connector_data_source(
                                    crate::protocol_serde::shape_connector_data_source::de_connector_data_source(tokens)?
                                );
                            }
                            "ConnectorDataTarget" => {
                                builder = builder.set_connector_data_target(
                                    crate::protocol_serde::shape_connector_data_target::de_connector_data_target(tokens)?
                                );
                            }
