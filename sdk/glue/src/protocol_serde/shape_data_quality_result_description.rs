...
pub(crate) fn de_data_quality_result_description<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DataQualityResultDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
