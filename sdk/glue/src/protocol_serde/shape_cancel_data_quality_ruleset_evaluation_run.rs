...
pub fn ser_cancel_data_quality_ruleset_evaluation_run_input(
    ...
    crate::protocol_serde::shape_cancel_data_quality_ruleset_evaluation_run_input::ser_cancel_data_quality_ruleset_evaluation_run_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_data_quality_ruleset_evaluation_run::CancelDataQualityRulesetEvaluationRunError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::cancel_data_quality_ruleset_evaluation_run::CancelDataQualityRulesetEvaluationRunError::unhandled(generic))
        }
    };
            ...
            crate::operation::cancel_data_quality_ruleset_evaluation_run::CancelDataQualityRulesetEvaluationRunError::EntityNotFoundException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_entity_not_found_exception::de_entity_not_found_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::cancel_data_quality_ruleset_evaluation_run::CancelDataQualityRulesetEvaluationRunError::unhandled,
                        )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_data_quality_ruleset_evaluation_run_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
