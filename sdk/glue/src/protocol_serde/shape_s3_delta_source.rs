...
pub fn ser_s3_delta_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3DeltaSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
