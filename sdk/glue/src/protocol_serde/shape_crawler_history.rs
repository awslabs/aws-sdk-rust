...
pub(crate) fn de_crawler_history<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::CrawlerHistory>, aws_smithy_json::deserialize::error::DeserializeError>
