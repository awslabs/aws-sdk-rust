...
pub(crate) fn de_crawler_history<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::CrawlerHistory>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "State" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::CrawlerHistoryState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "StartTime" => {
                        ...
                        "DPUHour" => {
                            builder = builder
                                .set_dpu_hour(::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?.map(|v| v.to_f64_lossy()));
                        }
