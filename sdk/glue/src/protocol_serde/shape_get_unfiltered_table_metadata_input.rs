...
pub fn ser_get_unfiltered_table_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetUnfilteredTableMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
