...
pub fn ser_s3_json_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3JsonSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
