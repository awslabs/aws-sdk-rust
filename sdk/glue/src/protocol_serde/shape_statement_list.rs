...
pub(crate) fn de_statement_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Statement>>, aws_smithy_json::deserialize::error::DeserializeError>
