...
pub fn ser_create_csv_classifier_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateCsvClassifierRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
