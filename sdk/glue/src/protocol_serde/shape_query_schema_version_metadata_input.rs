...
pub fn ser_query_schema_version_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::QuerySchemaVersionMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
