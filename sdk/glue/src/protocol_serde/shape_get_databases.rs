...
pub fn de_get_databases_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_databases::GetDatabasesOutput, crate::operation::get_databases::GetDatabasesError> {
    #[allow(unused_mut)]
...
pub fn de_get_databases_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_databases_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_databases::GetDatabasesError::unhandled)?
    })
}
...
) -> Result<crate::operation::get_databases::builders::GetDatabasesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
