...
pub fn ser_property_predicate(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PropertyPredicate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
