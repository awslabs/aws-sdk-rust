...
pub fn ser_get_partitions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPartitionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
