...
pub fn ser_get_table_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_table_version::GetTableVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
