...
pub fn ser_aggregate(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Aggregate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
