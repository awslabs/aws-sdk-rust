...
pub fn ser_search_tables_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchTablesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
