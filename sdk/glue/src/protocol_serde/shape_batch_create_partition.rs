...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNumberLimitExceededException" => {
            crate::operation::batch_create_partition::BatchCreatePartitionError::ResourceNumberLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_create_partition::de_batch_create_partition(_response_body, output)
            .map_err(crate::operation::batch_create_partition::BatchCreatePartitionError::unhandled)?;
