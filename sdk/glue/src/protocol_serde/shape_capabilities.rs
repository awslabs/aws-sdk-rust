                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SupportedDataOperations" => {
                            builder =
                                builder.set_supported_data_operations(crate::protocol_serde::shape_data_operations::de_data_operations(tokens)?);
                        }
                        "SupportedComputeEnvironments" => {
                            builder = builder.set_supported_compute_environments(
                                crate::protocol_serde::shape_compute_environments::de_compute_environments(tokens)?,
                            );
                        }
