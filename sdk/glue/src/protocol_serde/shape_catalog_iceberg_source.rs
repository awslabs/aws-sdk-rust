...
pub fn ser_catalog_iceberg_source(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CatalogIcebergSource,
    ...
    if let Some(var_1) = &input.additional_iceberg_options {
        #[allow(unused_mut)]
        let mut object_2 = object.key("AdditionalIcebergOptions").start_object();
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::CatalogIcebergSourceBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(crate::serde_util::catalog_iceberg_source_correct_errors(builder).build().map_err(
