...
pub fn ser_delete_table_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteTableVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
