...
pub fn ser_delete_table_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_table_version::DeleteTableVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
