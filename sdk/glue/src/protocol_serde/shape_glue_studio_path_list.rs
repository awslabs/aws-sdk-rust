...
pub(crate) fn de_glue_studio_path_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<std::vec::Vec<std::string::String>>>, aws_smithy_json::deserialize::error::DeserializeError>
