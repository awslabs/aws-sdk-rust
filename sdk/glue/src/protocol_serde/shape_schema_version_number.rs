...
pub fn ser_schema_version_number(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SchemaVersionNumber) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
