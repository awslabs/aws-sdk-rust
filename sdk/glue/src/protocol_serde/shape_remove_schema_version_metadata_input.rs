...
pub fn ser_remove_schema_version_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RemoveSchemaVersionMetadataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
