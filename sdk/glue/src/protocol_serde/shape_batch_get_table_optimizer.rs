    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "TableOptimizers" => {
                    builder = builder.set_table_optimizers(crate::protocol_serde::shape_batch_table_optimizers::de_batch_table_optimizers(
                        tokens, _value,
                    )?);
                }
                "Failures" => {
                    builder = builder.set_failures(
                        crate::protocol_serde::shape_batch_get_table_optimizer_errors::de_batch_get_table_optimizer_errors(tokens, _value)?,
                    );
                }
