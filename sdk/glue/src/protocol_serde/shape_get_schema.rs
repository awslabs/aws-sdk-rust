...
pub fn de_get_schema_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_schema::GetSchemaOutput, crate::operation::get_schema::GetSchemaError> {
    #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::get_schema::builders::GetSchemaOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
