...
pub fn de_get_ml_transform_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_ml_transform::GetMlTransformOutput, crate::operation::get_ml_transform::GetMLTransformError> {
    #[allow(unused_mut)]
...
pub fn de_get_ml_transform_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_ml_transform::de_get_ml_transform(_response_body, output)
            .map_err(crate::operation::get_ml_transform::GetMLTransformError::unhandled)?;
...
) -> Result<crate::operation::get_ml_transform::builders::GetMlTransformOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "MaxCapacity" => {
                    builder = builder
                        .set_max_capacity(::aws_smithy_json::deserialize::token::expect_number_or_null(tokens.next())?.map(|v| v.to_f64_lossy()));
                }
                "WorkerType" => {
