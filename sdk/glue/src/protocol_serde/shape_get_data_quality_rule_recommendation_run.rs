...
pub fn ser_get_data_quality_rule_recommendation_run_input(
    ...
    crate::protocol_serde::shape_get_data_quality_rule_recommendation_run_input::ser_get_data_quality_rule_recommendation_run_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_data_quality_rule_recommendation_run::GetDataQualityRuleRecommendationRunError::unhandled)?;
    ...
    Err(match error_code {
        "EntityNotFoundException" => {
            crate::operation::get_data_quality_rule_recommendation_run::GetDataQualityRuleRecommendationRunError::EntityNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServiceException" => {
            crate::operation::get_data_quality_rule_recommendation_run::GetDataQualityRuleRecommendationRunError::InternalServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidInputException" => {
            crate::operation::get_data_quality_rule_recommendation_run::GetDataQualityRuleRecommendationRunError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_operation_timeout_exception::de_operation_timeout_exception_json_err(_response_body, output)
                            .map_err(
                                crate::operation::get_data_quality_rule_recommendation_run::GetDataQualityRuleRecommendationRunError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_data_quality_rule_recommendation_run_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_data_quality_rule_recommendation_run::de_get_data_quality_rule_recommendation_run(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_data_quality_rule_recommendation_run::GetDataQualityRuleRecommendationRunError::unhandled)?;
