...
pub fn ser_list_crawlers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListCrawlersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
