...
pub fn ser_get_user_defined_functions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetUserDefinedFunctionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
