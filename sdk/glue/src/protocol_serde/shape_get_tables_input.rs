...
pub fn ser_get_tables_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTablesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
