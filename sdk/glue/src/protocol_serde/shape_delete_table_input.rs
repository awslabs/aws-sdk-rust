...
pub fn ser_delete_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
