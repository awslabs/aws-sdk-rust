...
pub fn ser_batch_get_partition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::batch_get_partition::BatchGetPartitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_4) = &input.partitions_to_get {
        let mut array_5 = object.key("PartitionsToGet").start_array();
        for item_6 in var_4 {
             {
                #[allow(unused_mut)]
