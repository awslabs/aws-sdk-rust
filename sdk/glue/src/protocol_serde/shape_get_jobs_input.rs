...
pub fn ser_get_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
