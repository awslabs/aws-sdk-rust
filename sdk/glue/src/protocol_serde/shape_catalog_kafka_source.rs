...
pub fn ser_catalog_kafka_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CatalogKafkaSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
