...
) -> Result<Option<crate::model::S3CsvSource>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Separator" => {
                                builder = builder.set_separator(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::model::Separator::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            ...
                            "QuoteChar" => {
                                builder = builder.set_quote_char(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::model::QuoteChar::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
