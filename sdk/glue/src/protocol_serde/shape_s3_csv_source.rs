...
pub fn ser_s3_csv_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3CsvSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_s3_csv_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::S3CsvSource>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Separator" => {
                                builder = builder.set_separator(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::Separator::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "QuoteChar" => {
                                builder = builder.set_quote_char(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::QuoteChar::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
