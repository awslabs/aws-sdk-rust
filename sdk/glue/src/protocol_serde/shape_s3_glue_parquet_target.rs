...
pub fn ser_s3_glue_parquet_target(
                         object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                         input: &crate::types::S3GlueParquetTarget,
...
pub(crate) fn de_s3_glue_parquet_target<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3GlueParquetTarget>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::s3_glue_parquet_target_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
