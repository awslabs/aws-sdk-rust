...
pub fn de_get_glossary_http_error(
    ...
    Err(match error_code {
        ...
        "EntityNotFoundException" => crate::operation::get_glossary::GetGlossaryError::EntityNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServiceException" => crate::operation::get_glossary::GetGlossaryError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_get_glossary_input(
    input: &crate::operation::get_glossary::GetGlossaryInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_get_glossary_input::ser_get_glossary_input_input(&mut object, input)?;
    object.finish();
