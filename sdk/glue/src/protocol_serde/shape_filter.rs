...
pub(crate) fn de_filter<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Filter>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "LogicalOperator" => {
                                builder = builder.set_logical_operator(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::FilterLogicalOperator::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
