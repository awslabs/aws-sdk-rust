...
pub(crate) fn de_schema_reference<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::SchemaReference>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "SchemaId" => {
                            builder = builder.set_schema_id(crate::protocol_serde::shape_schema_id::de_schema_id(tokens, _value, depth + 1)?);
                        }
                        "SchemaVersionId" => {
