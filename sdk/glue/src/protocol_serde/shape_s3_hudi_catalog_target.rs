...
pub fn ser_s3_hudi_catalog_target(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::S3HudiCatalogTarget) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
