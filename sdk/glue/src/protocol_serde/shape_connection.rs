            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SparkProperties" => {
                            builder =
                                builder.set_spark_properties(crate::protocol_serde::shape_property_map::de_property_map(tokens, _value, depth + 1)?);
                        }
                        "AthenaProperties" => {
                            builder =
                                builder.set_athena_properties(crate::protocol_serde::shape_property_map::de_property_map(tokens, _value, depth + 1)?);
                        }
                        "PythonProperties" => {
                            builder =
                                builder.set_python_properties(crate::protocol_serde::shape_property_map::de_property_map(tokens, _value, depth + 1)?);
                        }
                        "PhysicalConnectionRequirements" => {
                            builder = builder.set_physical_connection_requirements(
                                crate::protocol_serde::shape_physical_connection_requirements::de_physical_connection_requirements(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "CompatibleComputeEnvironments" => {
                            builder = builder.set_compatible_compute_environments(
                                crate::protocol_serde::shape_compute_environment_list::de_compute_environment_list(tokens, _value, depth + 1)?,
                            );
                        }
