...
//! ```
//!
use aws_sdk_glue::{config, Client};
/// Smoke tests for the `get_catalog_import_status` operation
#[::tokio::test]
async fn test_get_catalog_import_status_success() {
    ...
    let res = client.get_catalog_import_status().send().await;
