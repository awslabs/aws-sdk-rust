...
impl ::std::convert::From<&str> for FacetAttributeType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FacetAttributeType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FacetAttributeType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FacetAttributeType::from(s))
    }
}
