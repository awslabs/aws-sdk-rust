...
impl ListDirectoriesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_directories::ListDirectories, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_directories::ser_list_directories_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDirectories {
    type Output =
        ::std::result::Result<crate::operation::list_directories::ListDirectoriesOutput, crate::operation::list_directories::ListDirectoriesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_directories::de_list_directories_http_response_with_props(status, headers, body)
        }
    }
}
