...
impl ListDirectoriesInput {
    /// Consumes the builder and constructs an Operation<[`ListDirectories`](crate::operation::list_directories::ListDirectories)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_directories::ListDirectories, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_directories::ListDirectoriesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/directory/list").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_directories::ser_list_directories_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_directories::ListDirectories::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDirectories", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListDirectories {
                type Output = std::result::Result<crate::operation::list_directories::ListDirectoriesOutput, crate::operation::list_directories::ListDirectoriesError>;
