...
impl EnableDirectoryOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_directory::EnableDirectoryOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::enable_directory::EnableDirectoryOutput {
                directory_arn: self.directory_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("directory_arn", "directory_arn was not specified but it is required when building EnableDirectoryOutput")
                    )?
                ,
