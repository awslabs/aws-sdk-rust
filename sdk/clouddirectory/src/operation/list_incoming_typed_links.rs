...
/// Orchestration and serialization glue logic for `ListIncomingTypedLinks`.
...
impl ListIncomingTypedLinks {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListIncomingTypedLinks {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListIncomingTypedLinks");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListIncomingTypedLinksRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListIncomingTypedLinksResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListIncomingTypedLinks")
...
.with_interceptor(ListIncomingTypedLinksEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError>::new());
...
#[derive(Debug)]
            struct ListIncomingTypedLinksResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListIncomingTypedLinksResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_incoming_typed_links::de_list_incoming_typed_links_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListIncomingTypedLinksRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListIncomingTypedLinksRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_incoming_typed_links::ListIncomingTypedLinksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/incoming").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_incoming_typed_links::ser_list_incoming_typed_links_input(&input)?);
...
#[derive(Debug)]
            struct ListIncomingTypedLinksEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListIncomingTypedLinksEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListIncomingTypedLinksEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListIncomingTypedLinksInput>()
                        .ok_or("failed to downcast to ListIncomingTypedLinksInput")?;
...
pub enum ListIncomingTypedLinksError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListIncomingTypedLinksError) for what information is available for the error.")]
...
impl ListIncomingTypedLinksError {
    /// Creates the `ListIncomingTypedLinksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListIncomingTypedLinksError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListIncomingTypedLinksError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError {
...
mod _list_incoming_typed_links_output;
