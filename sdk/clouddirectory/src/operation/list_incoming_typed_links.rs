...
impl ListIncomingTypedLinks {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListIncomingTypedLinks",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListIncomingTypedLinks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListIncomingTypedLinksRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListIncomingTypedLinksResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListIncomingTypedLinks")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListIncomingTypedLinks")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListIncomingTypedLinksTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListIncomingTypedLinksTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListIncomingTypedLinksTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListIncomingTypedLinksInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListIncomingTypedLinksResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_incoming_typed_links::de_list_incoming_typed_links_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_incoming_typed_links::de_list_incoming_typed_links_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListIncomingTypedLinksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_incoming_typed_links::ListIncomingTypedLinksInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_incoming_typed_links::ser_list_incoming_typed_links_input(&input)?,
        );
