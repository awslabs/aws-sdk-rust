...
impl ListIncomingTypedLinksInput {
    /// Consumes the builder and constructs an Operation<[`ListIncomingTypedLinks`](crate::operation::list_incoming_typed_links::ListIncomingTypedLinks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_incoming_typed_links::ListIncomingTypedLinks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_incoming_typed_links::ListIncomingTypedLinksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_incoming_typed_links::ListIncomingTypedLinks::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListIncomingTypedLinks {
                type Output = std::result::Result<crate::operation::list_incoming_typed_links::ListIncomingTypedLinksOutput, crate::operation::list_incoming_typed_links::ListIncomingTypedLinksError>;
