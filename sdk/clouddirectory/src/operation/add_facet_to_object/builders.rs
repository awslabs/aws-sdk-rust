...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::add_facet_to_object::AddFacetToObjectOutput,
                    crate::operation::add_facet_to_object::AddFacetToObjectError,
                > for AddFacetToObjectFluentBuilder
            {
                fn send(
                    self,
...
impl AddFacetToObjectFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_facet_to_object::AddFacetToObjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_facet_to_object::AddFacetToObjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::add_facet_to_object::AddFacetToObject::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::add_facet_to_object::AddFacetToObject::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_facet_to_object::AddFacetToObjectOutput, crate::operation::add_facet_to_object::AddFacetToObjectError, Self> {
