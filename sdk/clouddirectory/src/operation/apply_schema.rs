    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/apply")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::apply_schema::ApplySchema::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApplySchema {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_apply_schema::de_apply_schema_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_apply_schema::de_apply_schema_http_response_with_props(
                status, headers, body,
            )
        }
    }
