...
impl TagResourceInput {
    /// Consumes the builder and constructs an Operation<[`TagResource`](crate::operation::tag_resource::TagResource)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_resource::TagResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_resource::ser_tag_resource_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::tag_resource::TagResource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("TagResource", "clouddirectory"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagResource {
    type Output = ::std::result::Result<crate::operation::tag_resource::TagResourceOutput, crate::operation::tag_resource::TagResourceError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_tag_resource::de_tag_resource_http_response_with_props(status, headers, body)
        }
    }
}
