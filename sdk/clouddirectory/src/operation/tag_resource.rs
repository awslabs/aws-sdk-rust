    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/tags/add")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::tag_resource::TagResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_tag_resource::de_tag_resource_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_tag_resource::de_tag_resource_http_response_with_props(
                status, headers, body,
            )
        }
    }
