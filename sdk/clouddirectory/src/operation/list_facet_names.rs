    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/facet/list")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_facet_names::ListFacetNames::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFacetNames {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_facet_names::de_list_facet_names_http_error(
                status, headers, body,
            )
        } else {
