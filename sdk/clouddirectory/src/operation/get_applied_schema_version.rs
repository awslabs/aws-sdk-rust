...
impl GetAppliedSchemaVersionInput {
    /// Consumes the builder and constructs an Operation<[`GetAppliedSchemaVersion`](crate::operation::get_applied_schema_version::GetAppliedSchemaVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_applied_schema_version::GetAppliedSchemaVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_applied_schema_version::GetAppliedSchemaVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/schema/getappliedschema").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_applied_schema_version::ser_get_applied_schema_version_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_applied_schema_version::GetAppliedSchemaVersion::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAppliedSchemaVersion", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAppliedSchemaVersion {
                type Output = std::result::Result<crate::operation::get_applied_schema_version::GetAppliedSchemaVersionOutput, crate::operation::get_applied_schema_version::GetAppliedSchemaVersionError>;
