...
impl GetAppliedSchemaVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_applied_schema_version::GetAppliedSchemaVersion,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppliedSchemaVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_applied_schema_version::de_get_applied_schema_version_http_response_with_props(status, headers, body)
        }
    }
}
