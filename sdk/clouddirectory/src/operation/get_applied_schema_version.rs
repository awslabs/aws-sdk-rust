...
impl GetAppliedSchemaVersion {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::get_applied_schema_version::GetAppliedSchemaVersionError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_applied_schema_version::GetAppliedSchemaVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_applied_schema_version::GetAppliedSchemaVersionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetAppliedSchemaVersion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAppliedSchemaVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetAppliedSchemaVersionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetAppliedSchemaVersionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetAppliedSchemaVersion")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAppliedSchemaVersion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetAppliedSchemaVersionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetAppliedSchemaVersionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAppliedSchemaVersionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetAppliedSchemaVersionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAppliedSchemaVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_applied_schema_version::de_get_applied_schema_version_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_applied_schema_version::de_get_applied_schema_version_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAppliedSchemaVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_applied_schema_version::GetAppliedSchemaVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_applied_schema_version::GetAppliedSchemaVersionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_applied_schema_version::ser_get_applied_schema_version_input(&input)?,
        );
