    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/policy/lookup")
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_lookup_policy::ser_lookup_policy_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::lookup_policy::LookupPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for LookupPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_lookup_policy::de_lookup_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_lookup_policy::de_lookup_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
