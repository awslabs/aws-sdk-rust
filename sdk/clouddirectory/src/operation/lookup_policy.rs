...
impl LookupPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::lookup_policy::LookupPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_lookup_policy::ser_lookup_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for LookupPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_lookup_policy::de_lookup_policy_http_response_with_props(status, headers, body)
        }
    }
}
