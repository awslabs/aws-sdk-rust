...
impl LookupPolicyInput {
    /// Consumes the builder and constructs an Operation<[`LookupPolicy`](crate::operation::lookup_policy::LookupPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::lookup_policy::LookupPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::lookup_policy::LookupPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/amazonclouddirectory/2017-01-11/policy/lookup").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_lookup_policy::ser_lookup_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::lookup_policy::LookupPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("LookupPolicy", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for LookupPolicy {
                type Output = std::result::Result<crate::operation::lookup_policy::LookupPolicyOutput, crate::operation::lookup_policy::LookupPolicyError>;
