...
impl DeleteFacetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_facet::DeleteFacet,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/facet/delete")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_facet::DeleteFacet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFacet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_facet::de_delete_facet_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_facet::de_delete_facet_http_response_with_props(
                status, headers, body,
            )
        }
    }
