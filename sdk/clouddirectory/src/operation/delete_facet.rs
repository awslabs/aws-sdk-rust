...
impl DeleteFacetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFacet`](crate::operation::delete_facet::DeleteFacet)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_facet::DeleteFacet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_facet::ser_delete_facet_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_facet::DeleteFacet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFacet {
    type Output = ::std::result::Result<crate::operation::delete_facet::DeleteFacetOutput, crate::operation::delete_facet::DeleteFacetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_facet::de_delete_facet_http_response_with_props(status, headers, body)
        }
    }
}
