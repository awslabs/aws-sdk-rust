...
impl ListOutgoingTypedLinks {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_outgoing_typed_links::ListOutgoingTypedLinksError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_outgoing_typed_links::ListOutgoingTypedLinksOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListOutgoingTypedLinks",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListOutgoingTypedLinks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListOutgoingTypedLinksRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListOutgoingTypedLinksResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListOutgoingTypedLinks")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListOutgoingTypedLinks")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListOutgoingTypedLinksTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListOutgoingTypedLinksTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListOutgoingTypedLinksTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListOutgoingTypedLinksInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListOutgoingTypedLinksResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_outgoing_typed_links::de_list_outgoing_typed_links_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_outgoing_typed_links::de_list_outgoing_typed_links_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListOutgoingTypedLinksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_outgoing_typed_links::ListOutgoingTypedLinksInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_outgoing_typed_links::ListOutgoingTypedLinksInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_outgoing_typed_links::ser_list_outgoing_typed_links_input(&input)?,
        );
