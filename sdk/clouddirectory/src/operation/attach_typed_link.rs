    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/attach")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_typed_link::AttachTypedLink::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::attach_typed_link::AttachTypedLinkError
{
