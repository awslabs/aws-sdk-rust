...
impl ListPublishedSchemaArnsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsInput, ::aws_smithy_types::error::operation::BuildError> {
