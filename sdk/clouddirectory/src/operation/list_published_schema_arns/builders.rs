...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_published_schema_arns::ListPublishedSchemaArnsOutput,
                    crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError,
                > for ListPublishedSchemaArnsFluentBuilder
            {
                fn send(
                    self,
...
impl ListPublishedSchemaArnsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_published_schema_arns::ListPublishedSchemaArns::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsOutput, crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_published_schema_arns::paginator::ListPublishedSchemaArnsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
