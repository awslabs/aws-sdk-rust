...
/// Orchestration and serialization glue logic for `ListObjectChildren`.
...
impl ListObjectChildren {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_object_children::ListObjectChildrenInput,
                    ) -> ::std::result::Result<crate::operation::list_object_children::ListObjectChildrenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_object_children::ListObjectChildrenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_object_children::ListObjectChildrenError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_object_children::ListObjectChildrenOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListObjectChildren {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListObjectChildren");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListObjectChildrenRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListObjectChildrenResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListObjectChildren")
...
.with_interceptor(ListObjectChildrenEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_object_children::ListObjectChildrenError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_object_children::ListObjectChildrenError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_object_children::ListObjectChildrenError>::new());
...
#[derive(Debug)]
            struct ListObjectChildrenResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListObjectChildrenResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_object_children::de_list_object_children_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_object_children::de_list_object_children_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListObjectChildrenRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListObjectChildrenRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_object_children::ListObjectChildrenInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_object_children::ListObjectChildrenInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/children").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_list_object_children::ser_list_object_children_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_object_children::ser_list_object_children_input(&input)?);
...
#[derive(Debug)]
            struct ListObjectChildrenEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListObjectChildrenEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListObjectChildrenEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListObjectChildrenInput>()
                        .ok_or("failed to downcast to ListObjectChildrenInput")?;
...
pub enum ListObjectChildrenError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListObjectChildrenError) for what information is available for the error.")]
...
impl ListObjectChildrenError {
    /// Creates the `ListObjectChildrenError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListObjectChildrenError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NotNodeException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListObjectChildrenError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_object_children::ListObjectChildrenError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_object_children::_list_object_children_output::ListObjectChildrenOutput;

pub use crate::operation::list_object_children::_list_object_children_input::ListObjectChildrenInput;

mod _list_object_children_input;

mod _list_object_children_output;
