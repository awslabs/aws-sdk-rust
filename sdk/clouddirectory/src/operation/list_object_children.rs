...
impl ListObjectChildrenInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_object_children::ListObjectChildren,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_object_children::ser_list_object_children_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListObjectChildren {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_object_children::de_list_object_children_http_response_with_props(status, headers, body)
        }
    }
}
