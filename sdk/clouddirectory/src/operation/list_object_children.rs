...
impl ListObjectChildrenInput {
    /// Consumes the builder and constructs an Operation<[`ListObjectChildren`](crate::operation::list_object_children::ListObjectChildren)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_object_children::ListObjectChildren, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_object_children::ListObjectChildrenInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/amazonclouddirectory/2017-01-11/object/children").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_object_children::ser_list_object_children_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_object_children::ListObjectChildren::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListObjectChildren", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListObjectChildren {
                type Output = std::result::Result<crate::operation::list_object_children::ListObjectChildrenOutput, crate::operation::list_object_children::ListObjectChildrenError>;
