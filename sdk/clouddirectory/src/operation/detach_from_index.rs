    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/index/detach")
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_detach_from_index::ser_detach_from_index_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detach_from_index::DetachFromIndex::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::detach_from_index::DetachFromIndexError
{
