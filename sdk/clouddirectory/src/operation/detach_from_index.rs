...
impl DetachFromIndexInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_from_index::DetachFromIndex, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_from_index::DetachFromIndexInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/index/detach").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_from_index::ser_detach_from_index_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for DetachFromIndex {
                type Output = std::result::Result<crate::operation::detach_from_index::DetachFromIndexOutput, crate::operation::detach_from_index::DetachFromIndexError>;
