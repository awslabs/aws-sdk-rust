...
impl DetachFromIndexInput {
    /// Consumes the builder and constructs an Operation<[`DetachFromIndex`](crate::operation::detach_from_index::DetachFromIndex)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detach_from_index::DetachFromIndex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_from_index::ser_detach_from_index_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_from_index::DetachFromIndex::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachFromIndex", "clouddirectory"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachFromIndex {
    type Output =
        ::std::result::Result<crate::operation::detach_from_index::DetachFromIndexOutput, crate::operation::detach_from_index::DetachFromIndexError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_from_index::de_detach_from_index_http_response_with_props(status, headers, body)
        }
    }
}
