...
impl ListAttachedIndicesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_attached_indices();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_attached_indices::ListAttachedIndicesOutput,
                    crate::operation::list_attached_indices::ListAttachedIndicesError,
                > for ListAttachedIndicesFluentBuilder
            {
                fn send(
                    self,
...
impl ListAttachedIndicesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_attached_indices::ListAttachedIndicesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_attached_indices::ListAttachedIndicesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_attached_indices::ListAttachedIndices::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_attached_indices::ListAttachedIndicesOutput, crate::operation::list_attached_indices::ListAttachedIndicesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_attached_indices::paginator::ListAttachedIndicesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
