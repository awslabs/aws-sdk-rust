...
/// Orchestration and serialization glue logic for `ListDevelopmentSchemaArns`.
...
impl ListDevelopmentSchemaArns {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDevelopmentSchemaArns {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDevelopmentSchemaArns");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDevelopmentSchemaArnsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDevelopmentSchemaArnsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDevelopmentSchemaArns")
...
.with_interceptor(ListDevelopmentSchemaArnsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError>::new());
...
#[derive(Debug)]
            struct ListDevelopmentSchemaArnsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDevelopmentSchemaArnsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_development_schema_arns::de_list_development_schema_arns_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_development_schema_arns::de_list_development_schema_arns_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDevelopmentSchemaArnsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDevelopmentSchemaArnsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/development").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_development_schema_arns::ser_list_development_schema_arns_input(&input)?);
...
#[derive(Debug)]
            struct ListDevelopmentSchemaArnsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDevelopmentSchemaArnsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDevelopmentSchemaArnsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDevelopmentSchemaArnsInput>()
                        .ok_or("failed to downcast to ListDevelopmentSchemaArnsInput")?;
...
pub enum ListDevelopmentSchemaArnsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDevelopmentSchemaArnsError) for what information is available for the error.")]
...
impl ListDevelopmentSchemaArnsError {
    /// Creates the `ListDevelopmentSchemaArnsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDevelopmentSchemaArnsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDevelopmentSchemaArnsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError {
...
mod _list_development_schema_arns_output;
