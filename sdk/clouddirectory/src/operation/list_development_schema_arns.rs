...
impl ListDevelopmentSchemaArnsInput {
    /// Consumes the builder and constructs an Operation<[`ListDevelopmentSchemaArns`](crate::operation::list_development_schema_arns::ListDevelopmentSchemaArns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArns, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_development_schema_arns::ListDevelopmentSchemaArns::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListDevelopmentSchemaArns {
                type Output = std::result::Result<crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsOutput, crate::operation::list_development_schema_arns::ListDevelopmentSchemaArnsError>;
