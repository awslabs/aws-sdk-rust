    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/directory/create")
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_create_directory::ser_create_directory_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_directory::CreateDirectory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_directory::de_create_directory_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_directory::CreateDirectoryError
{
