...
impl CreateDirectoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_directory::CreateDirectory, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_directory::ser_create_directory_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_directory::de_create_directory_http_response_with_props(status, headers, body)
        }
    }
}
