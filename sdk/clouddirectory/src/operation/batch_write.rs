...
impl BatchWriteInput {
    /// Consumes the builder and constructs an Operation<[`BatchWrite`](crate::operation::batch_write::BatchWrite)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_write::BatchWrite, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_write::ser_batch_write_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_write::BatchWrite::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchWrite {
    type Output = ::std::result::Result<crate::operation::batch_write::BatchWriteOutput, crate::operation::batch_write::BatchWriteError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_write::de_batch_write_http_response_with_props(status, headers, body)
        }
    }
}
