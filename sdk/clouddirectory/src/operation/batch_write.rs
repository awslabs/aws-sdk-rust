    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/batchwrite")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_write::BatchWrite::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchWrite {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_batch_write::de_batch_write_http_error(
                status, headers, body,
            )
        } else {
