...
impl GetTypedLinkFacetInformationInput {
    /// Consumes the builder and constructs an Operation<[`GetTypedLinkFacetInformation`](crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/get").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_typed_link_facet_information::ser_get_typed_link_facet_information_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTypedLinkFacetInformation", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetTypedLinkFacetInformation {
                type Output = std::result::Result<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationOutput, crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError>;
