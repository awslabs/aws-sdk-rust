...
impl GetTypedLinkFacetInformationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTypedLinkFacetInformation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_typed_link_facet_information::de_get_typed_link_facet_information_http_response_with_props(
                status, headers, body,
            )
        }
    }
