...
impl GetTypedLinkFacetInformation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetTypedLinkFacetInformation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTypedLinkFacetInformation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetTypedLinkFacetInformationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetTypedLinkFacetInformationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetTypedLinkFacetInformation")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTypedLinkFacetInformation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetTypedLinkFacetInformationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetTypedLinkFacetInformationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTypedLinkFacetInformationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetTypedLinkFacetInformationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTypedLinkFacetInformationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_typed_link_facet_information::de_get_typed_link_facet_information_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_typed_link_facet_information::de_get_typed_link_facet_information_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTypedLinkFacetInformationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationInput,
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_get_typed_link_facet_information::ser_get_typed_link_facet_information_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_typed_link_facet_information::ser_get_typed_link_facet_information_input(&input)?,
        );
