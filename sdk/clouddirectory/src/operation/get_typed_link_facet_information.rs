...
impl GetTypedLinkFacetInformation {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetTypedLinkFacetInformation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetTypedLinkFacetInformation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetTypedLinkFacetInformationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetTypedLinkFacetInformationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetTypedLinkFacetInformation")
...
.with_interceptor(GetTypedLinkFacetInformationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError>::new());
...
#[derive(Debug)]
            struct GetTypedLinkFacetInformationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetTypedLinkFacetInformationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_typed_link_facet_information::de_get_typed_link_facet_information_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetTypedLinkFacetInformationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetTypedLinkFacetInformationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/get").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_get_typed_link_facet_information::ser_get_typed_link_facet_information_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_typed_link_facet_information::ser_get_typed_link_facet_information_input(&input)?);
...
#[derive(Debug)]
            struct GetTypedLinkFacetInformationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetTypedLinkFacetInformationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetTypedLinkFacetInformationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetTypedLinkFacetInformationInput>()
                        .ok_or("failed to downcast to GetTypedLinkFacetInformationInput")?;
...
pub enum GetTypedLinkFacetInformationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetTypedLinkFacetInformationError) for what information is available for the error.")]
...
impl GetTypedLinkFacetInformationError {
    /// Creates the `GetTypedLinkFacetInformationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetTypedLinkFacetInformationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetTypedLinkFacetInformationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationError {
...
mod _get_typed_link_facet_information_output;
