...
impl DisableDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`DisableDirectory`](crate::operation::disable_directory::DisableDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_directory::DisableDirectory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_directory::DisableDirectoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_directory::DisableDirectory::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisableDirectory {
                type Output = std::result::Result<crate::operation::disable_directory::DisableDirectoryOutput, crate::operation::disable_directory::DisableDirectoryError>;
