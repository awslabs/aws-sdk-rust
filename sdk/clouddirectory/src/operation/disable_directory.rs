...
impl DisableDirectoryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disable_directory::DisableDirectory,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/directory/disable")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_directory::DisableDirectory::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disable_directory::DisableDirectoryError
{
