...
impl ListTypedLinkFacetNames {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTypedLinkFacetNames {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListTypedLinkFacetNames");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListTypedLinkFacetNamesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListTypedLinkFacetNamesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTypedLinkFacetNames")
...
.with_interceptor(ListTypedLinkFacetNamesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError>::new());
...
#[derive(Debug)]
            struct ListTypedLinkFacetNamesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTypedLinkFacetNamesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_typed_link_facet_names::de_list_typed_link_facet_names_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListTypedLinkFacetNamesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTypedLinkFacetNamesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/list").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_list_typed_link_facet_names::ser_list_typed_link_facet_names_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_typed_link_facet_names::ser_list_typed_link_facet_names_input(&input)?);
...
#[derive(Debug)]
            struct ListTypedLinkFacetNamesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTypedLinkFacetNamesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListTypedLinkFacetNamesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListTypedLinkFacetNamesInput>()
                        .ok_or("failed to downcast to ListTypedLinkFacetNamesInput")?;
...
pub enum ListTypedLinkFacetNamesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListTypedLinkFacetNamesError) for what information is available for the error.")]
...
impl ListTypedLinkFacetNamesError {
    /// Creates the `ListTypedLinkFacetNamesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListTypedLinkFacetNamesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListTypedLinkFacetNamesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError {
...
mod _list_typed_link_facet_names_output;
