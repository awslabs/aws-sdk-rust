...
impl ListTypedLinkFacetNamesInput {
    /// Consumes the builder and constructs an Operation<[`ListTypedLinkFacetNames`](crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNames)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNames, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/list").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_typed_link_facet_names::ser_list_typed_link_facet_names_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNames::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTypedLinkFacetNames", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListTypedLinkFacetNames {
                type Output = std::result::Result<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesOutput, crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError>;
