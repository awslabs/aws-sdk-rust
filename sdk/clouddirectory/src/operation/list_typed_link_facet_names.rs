...
impl ListTypedLinkFacetNames {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListTypedLinkFacetNames",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTypedLinkFacetNames {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListTypedLinkFacetNamesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListTypedLinkFacetNamesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListTypedLinkFacetNames")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTypedLinkFacetNames")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListTypedLinkFacetNamesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListTypedLinkFacetNamesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTypedLinkFacetNamesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListTypedLinkFacetNamesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTypedLinkFacetNamesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_typed_link_facet_names::de_list_typed_link_facet_names_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_typed_link_facet_names::de_list_typed_link_facet_names_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTypedLinkFacetNamesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_typed_link_facet_names::ListTypedLinkFacetNamesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_typed_link_facet_names::ser_list_typed_link_facet_names_input(&input)?,
        );
