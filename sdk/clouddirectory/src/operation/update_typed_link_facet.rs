    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_typed_link_facet::UpdateTypedLinkFacet::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_typed_link_facet::UpdateTypedLinkFacetError
{
