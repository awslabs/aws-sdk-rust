    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/facet")
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_get_facet::ser_get_facet_headers(input, builder)?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_facet::GetFacet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFacet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_facet::de_get_facet_http_response_with_props(
                status, headers, body,
            )
        }
    }
