...
impl GetFacetInput {
    /// Consumes the builder and constructs an Operation<[`GetFacet`](crate::operation::get_facet::GetFacet)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_facet::GetFacet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_facet::ser_get_facet_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_facet::GetFacet::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetFacet", "clouddirectory"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFacet {
    type Output = ::std::result::Result<crate::operation::get_facet::GetFacetOutput, crate::operation::get_facet::GetFacetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_facet::de_get_facet_http_response_with_props(status, headers, body)
        }
    }
}
