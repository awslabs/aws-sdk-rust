...
pub use crate::operation::batch_write::_batch_write_output::BatchWriteOutputBuilder;
...
impl BatchWriteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_write::BatchWriteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_write::BatchWriteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::batch_write::BatchWrite::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_write::BatchWriteOutput, crate::operation::batch_write::BatchWriteError, Self> {
