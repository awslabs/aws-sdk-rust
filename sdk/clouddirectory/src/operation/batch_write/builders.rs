...
impl BatchWriteFluentBuilder  {
    /// Creates a new `BatchWrite`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        ...
                        aws_smithy_http::result::SdkError<crate::operation::batch_write::BatchWriteError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::batch_write::BatchWriteOutput, aws_smithy_http::result::SdkError<crate::operation::batch_write::BatchWriteError>>
                     {
