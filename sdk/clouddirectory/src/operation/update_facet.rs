...
impl UpdateFacetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFacet`](crate::operation::update_facet::UpdateFacet)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_facet::UpdateFacet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_facet::ser_update_facet_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_facet::UpdateFacet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFacet {
    type Output = ::std::result::Result<crate::operation::update_facet::UpdateFacetOutput, crate::operation::update_facet::UpdateFacetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_facet::de_update_facet_http_response_with_props(status, headers, body)
        }
    }
}
