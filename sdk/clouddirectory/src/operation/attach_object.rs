...
impl AttachObjectInput {
    /// Consumes the builder and constructs an Operation<[`AttachObject`](crate::operation::attach_object::AttachObject)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::attach_object::AttachObject, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_attach_object::ser_attach_object_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_object::AttachObject::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachObject {
    type Output = ::std::result::Result<crate::operation::attach_object::AttachObjectOutput, crate::operation::attach_object::AttachObjectError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_object::de_attach_object_http_response_with_props(status, headers, body)
        }
    }
}
