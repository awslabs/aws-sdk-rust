...
impl CreateFacetInput {
    /// Consumes the builder and constructs an Operation<[`CreateFacet`](crate::operation::create_facet::CreateFacet)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_facet::CreateFacet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_facet::ser_create_facet_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_facet::CreateFacet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFacet {
    type Output = ::std::result::Result<crate::operation::create_facet::CreateFacetOutput, crate::operation::create_facet::CreateFacetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_facet::de_create_facet_http_response_with_props(status, headers, body)
        }
    }
}
