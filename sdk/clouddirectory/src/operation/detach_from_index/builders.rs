...
pub use crate::operation::detach_from_index::_detach_from_index_output::DetachFromIndexOutputBuilder;
...
pub struct DetachFromIndexFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::detach_from_index::builders::DetachFromIndexInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::detach_from_index::DetachFromIndexOutput,
                    crate::operation::detach_from_index::DetachFromIndexError,
                > for DetachFromIndexFluentBuilder
            {
                fn send(
                    self,
...
impl DetachFromIndexFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::detach_from_index::builders::DetachFromIndexInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detach_from_index::DetachFromIndexOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_from_index::DetachFromIndexError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::detach_from_index::DetachFromIndex::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::detach_from_index::DetachFromIndex::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detach_from_index::DetachFromIndexOutput, crate::operation::detach_from_index::DetachFromIndexError, Self> {
