...
impl DetachFromIndexFluentBuilder  {
    /// Creates a new `DetachFromIndex`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::detach_from_index::DetachFromIndex, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::detach_from_index::DetachFromIndexError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::detach_from_index::DetachFromIndexOutput, aws_smithy_http::result::SdkError<crate::operation::detach_from_index::DetachFromIndexError>>
                     {
