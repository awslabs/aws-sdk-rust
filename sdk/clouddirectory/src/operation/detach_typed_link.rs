...
impl DetachTypedLinkInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_typed_link::DetachTypedLink, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_typed_link::DetachTypedLinkInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/amazonclouddirectory/2017-01-11/typedlink/detach").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_typed_link::ser_detach_typed_link_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for DetachTypedLink {
                type Output = std::result::Result<crate::operation::detach_typed_link::DetachTypedLinkOutput, crate::operation::detach_typed_link::DetachTypedLinkError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_detach_typed_link::de_detach_typed_link_http_error(response)
                     } else {
                        crate::protocol_serde::shape_detach_typed_link::de_detach_typed_link_http_response(response)
                     }
                }
            }
