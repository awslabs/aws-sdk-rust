    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/detach")
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_detach_typed_link::ser_detach_typed_link_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detach_typed_link::DetachTypedLink::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::detach_typed_link::DetachTypedLinkError
{
