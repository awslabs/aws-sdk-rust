...
impl DetachTypedLink {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::detach_typed_link::DetachTypedLinkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_typed_link::DetachTypedLinkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detach_typed_link::DetachTypedLinkError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detach_typed_link::DetachTypedLinkOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachTypedLink {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetachTypedLink");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetachTypedLinkRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetachTypedLinkResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachTypedLink")
...
.with_interceptor(DetachTypedLinkEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detach_typed_link::DetachTypedLinkError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detach_typed_link::DetachTypedLinkError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detach_typed_link::DetachTypedLinkError>::new());
...
#[derive(Debug)]
            struct DetachTypedLinkResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachTypedLinkResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detach_typed_link::de_detach_typed_link_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DetachTypedLinkRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachTypedLinkRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detach_typed_link::DetachTypedLinkInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detach_typed_link::DetachTypedLinkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/detach").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_detach_typed_link::ser_detach_typed_link_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detach_typed_link::ser_detach_typed_link_input(&input)?);
...
#[derive(Debug)]
            struct DetachTypedLinkEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetachTypedLinkEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetachTypedLinkEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetachTypedLinkInput>()
                        .ok_or("failed to downcast to DetachTypedLinkInput")?;
...
pub enum DetachTypedLinkError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetachTypedLinkError) for what information is available for the error.")]
...
impl DetachTypedLinkError {
    /// Creates the `DetachTypedLinkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetachTypedLinkError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::FacetValidationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetachTypedLinkError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detach_typed_link::DetachTypedLinkError {
