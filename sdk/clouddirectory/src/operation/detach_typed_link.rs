...
impl DetachTypedLinkInput {
    /// Consumes the builder and constructs an Operation<[`DetachTypedLink`](crate::operation::detach_typed_link::DetachTypedLink)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detach_typed_link::DetachTypedLink, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_typed_link::ser_detach_typed_link_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_typed_link::DetachTypedLink::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachTypedLink", "clouddirectory"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachTypedLink {
    type Output =
        ::std::result::Result<crate::operation::detach_typed_link::DetachTypedLinkOutput, crate::operation::detach_typed_link::DetachTypedLinkError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_typed_link::de_detach_typed_link_http_response_with_props(status, headers, body)
        }
    }
}
