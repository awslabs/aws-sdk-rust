    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/create")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_schema::CreateSchema::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSchema {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_schema::de_create_schema_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_schema::de_create_schema_http_response_with_props(
                status, headers, body,
            )
        }
    }
