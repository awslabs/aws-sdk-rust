...
impl CreateSchemaInput {
    /// Consumes the builder and constructs an Operation<[`CreateSchema`](crate::operation::create_schema::CreateSchema)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_schema::CreateSchema, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_schema::ser_create_schema_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_schema::CreateSchema::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSchema {
    type Output = ::std::result::Result<crate::operation::create_schema::CreateSchemaOutput, crate::operation::create_schema::CreateSchemaError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_schema::de_create_schema_http_response_with_props(status, headers, body)
        }
    }
}
