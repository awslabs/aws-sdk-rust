...
impl ListPolicyAttachmentsFluentBuilder  {
    /// Creates a new `ListPolicyAttachments`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_policy_attachments::ListPolicyAttachmentsOutput, aws_smithy_http::result::SdkError<crate::operation::list_policy_attachments::ListPolicyAttachmentsError>>
                     {
