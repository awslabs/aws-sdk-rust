    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/update")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_object_attributes::UpdateObjectAttributes::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_object_attributes::UpdateObjectAttributesError
{
