...
impl RemoveFacetFromObject {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::remove_facet_from_object::RemoveFacetFromObjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_facet_from_object::RemoveFacetFromObjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveFacetFromObject {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveFacetFromObject");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveFacetFromObjectRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveFacetFromObjectResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveFacetFromObject")
...
.with_interceptor(RemoveFacetFromObjectEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectError>::new());
...
#[derive(Debug)]
            struct RemoveFacetFromObjectResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveFacetFromObjectResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_facet_from_object::de_remove_facet_from_object_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_remove_facet_from_object::de_remove_facet_from_object_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RemoveFacetFromObjectRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveFacetFromObjectRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_facet_from_object::RemoveFacetFromObjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_facet_from_object::ser_remove_facet_from_object_input(&input)?);
...
#[derive(Debug)]
            struct RemoveFacetFromObjectEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveFacetFromObjectEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveFacetFromObjectEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveFacetFromObjectInput>()
                        .ok_or("failed to downcast to RemoveFacetFromObjectInput")?;
...
pub enum RemoveFacetFromObjectError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveFacetFromObjectError) for what information is available for the error.")]
...
impl RemoveFacetFromObjectError {
    /// Creates the `RemoveFacetFromObjectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveFacetFromObjectError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveFacetFromObjectError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_facet_from_object::RemoveFacetFromObjectError {
...
mod _remove_facet_from_object_output;
