...
impl RemoveFacetFromObject {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RemoveFacetFromObject",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveFacetFromObject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RemoveFacetFromObjectRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RemoveFacetFromObjectResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RemoveFacetFromObject")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveFacetFromObject")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RemoveFacetFromObjectTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RemoveFacetFromObjectTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveFacetFromObjectTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RemoveFacetFromObjectInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveFacetFromObjectResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_remove_facet_from_object::de_remove_facet_from_object_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_remove_facet_from_object::de_remove_facet_from_object_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveFacetFromObjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::remove_facet_from_object::RemoveFacetFromObjectInput>()
            .expect("correct type");
