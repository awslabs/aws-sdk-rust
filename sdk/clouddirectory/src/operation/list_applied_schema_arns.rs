...
/// Orchestration and serialization glue logic for `ListAppliedSchemaArns`.
...
impl ListAppliedSchemaArns {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAppliedSchemaArns {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAppliedSchemaArns");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAppliedSchemaArnsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAppliedSchemaArnsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAppliedSchemaArns")
...
.with_interceptor(ListAppliedSchemaArnsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError>::new());
...
#[derive(Debug)]
            struct ListAppliedSchemaArnsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAppliedSchemaArnsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_applied_schema_arns::de_list_applied_schema_arns_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_applied_schema_arns::de_list_applied_schema_arns_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAppliedSchemaArnsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAppliedSchemaArnsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/applied").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_applied_schema_arns::ser_list_applied_schema_arns_input(&input)?);
...
#[derive(Debug)]
            struct ListAppliedSchemaArnsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAppliedSchemaArnsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAppliedSchemaArnsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAppliedSchemaArnsInput>()
                        .ok_or("failed to downcast to ListAppliedSchemaArnsInput")?;
...
pub enum ListAppliedSchemaArnsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAppliedSchemaArnsError) for what information is available for the error.")]
...
impl ListAppliedSchemaArnsError {
    /// Creates the `ListAppliedSchemaArnsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAppliedSchemaArnsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAppliedSchemaArnsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError {
...
mod _list_applied_schema_arns_output;
