...
impl ListAppliedSchemaArnsInput {
    /// Consumes the builder and constructs an Operation<[`ListAppliedSchemaArns`](crate::operation::list_applied_schema_arns::ListAppliedSchemaArns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_applied_schema_arns::ListAppliedSchemaArns, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/schema/applied").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_applied_schema_arns::ser_list_applied_schema_arns_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_applied_schema_arns::ListAppliedSchemaArns::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAppliedSchemaArns", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAppliedSchemaArns {
                type Output = std::result::Result<crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsOutput, crate::operation::list_applied_schema_arns::ListAppliedSchemaArnsError>;
