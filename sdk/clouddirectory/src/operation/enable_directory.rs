...
impl EnableDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`EnableDirectory`](crate::operation::enable_directory::EnableDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_directory::EnableDirectory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_directory::EnableDirectoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/directory/enable").expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_directory::EnableDirectory::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EnableDirectory", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for EnableDirectory {
                type Output = std::result::Result<crate::operation::enable_directory::EnableDirectoryOutput, crate::operation::enable_directory::EnableDirectoryError>;
