    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/directory/enable")
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_enable_directory::ser_enable_directory_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_directory::EnableDirectory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_directory::de_enable_directory_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::enable_directory::EnableDirectoryError
{
