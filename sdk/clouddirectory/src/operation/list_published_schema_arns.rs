...
/// Orchestration and serialization glue logic for `ListPublishedSchemaArns`.
...
impl ListPublishedSchemaArns {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_published_schema_arns::ListPublishedSchemaArnsInput,
                    ) -> ::std::result::Result<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListPublishedSchemaArns {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListPublishedSchemaArns");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListPublishedSchemaArnsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListPublishedSchemaArnsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListPublishedSchemaArns")
...
.with_interceptor(ListPublishedSchemaArnsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError>::new());
...
#[derive(Debug)]
            struct ListPublishedSchemaArnsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListPublishedSchemaArnsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_published_schema_arns::de_list_published_schema_arns_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_published_schema_arns::de_list_published_schema_arns_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListPublishedSchemaArnsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListPublishedSchemaArnsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_published_schema_arns::ListPublishedSchemaArnsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/published").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_published_schema_arns::ser_list_published_schema_arns_input(&input)?);
...
#[derive(Debug)]
            struct ListPublishedSchemaArnsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListPublishedSchemaArnsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListPublishedSchemaArnsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListPublishedSchemaArnsInput>()
                        .ok_or("failed to downcast to ListPublishedSchemaArnsInput")?;
...
pub enum ListPublishedSchemaArnsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListPublishedSchemaArnsError) for what information is available for the error.")]
...
impl ListPublishedSchemaArnsError {
    /// Creates the `ListPublishedSchemaArnsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListPublishedSchemaArnsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListPublishedSchemaArnsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError {
...
mod _list_published_schema_arns_output;
