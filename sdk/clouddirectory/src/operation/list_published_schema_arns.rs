...
impl ListPublishedSchemaArnsInput {
    /// Consumes the builder and constructs an Operation<[`ListPublishedSchemaArns`](crate::operation::list_published_schema_arns::ListPublishedSchemaArns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_published_schema_arns::ListPublishedSchemaArns, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_published_schema_arns::ListPublishedSchemaArnsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/schema/published").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_published_schema_arns::ser_list_published_schema_arns_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_published_schema_arns::ListPublishedSchemaArns::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListPublishedSchemaArns", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListPublishedSchemaArns {
                type Output = std::result::Result<crate::operation::list_published_schema_arns::ListPublishedSchemaArnsOutput, crate::operation::list_published_schema_arns::ListPublishedSchemaArnsError>;
