...
impl GetFacetFluentBuilder  {
    /// Creates a new `GetFacet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_facet::GetFacetOutput, aws_smithy_http::result::SdkError<crate::operation::get_facet::GetFacetError>>
                     {
