...
impl DetachObjectInput {
    /// Consumes the builder and constructs an Operation<[`DetachObject`](crate::operation::detach_object::DetachObject)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detach_object::DetachObject, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_object::ser_detach_object_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_object::DetachObject::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachObject {
    type Output = ::std::result::Result<crate::operation::detach_object::DetachObjectOutput, crate::operation::detach_object::DetachObjectError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_object::de_detach_object_http_response_with_props(status, headers, body)
        }
    }
}
