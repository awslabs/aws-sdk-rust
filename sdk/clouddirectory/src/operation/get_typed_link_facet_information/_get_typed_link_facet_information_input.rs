...
impl GetTypedLinkFacetInformationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_typed_link_facet_information::GetTypedLinkFacetInformationInput, ::aws_smithy_types::error::operation::BuildError> {
