...
impl crate::operation::list_index::builders::ListIndexInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::list_index::ListIndexOutput, crate::operation::list_index::ListIndexError>
    for ListIndexFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::list_index::ListIndexOutput, crate::operation::list_index::ListIndexError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl ListIndexFluentBuilder {
    /// Creates a new `ListIndexFluentBuilder`.
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_index::paginator::ListIndexPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
