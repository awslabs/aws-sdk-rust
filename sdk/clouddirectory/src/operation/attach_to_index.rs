    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/index/attach")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_to_index::AttachToIndex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachToIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_attach_to_index::de_attach_to_index_http_error(
                status, headers, body,
            )
        } else {
