...
impl ListObjectParentPathsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_object_parent_paths::ListObjectParentPaths,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListObjectParentPaths {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_object_parent_paths::de_list_object_parent_paths_http_response_with_props(status, headers, body)
        }
    }
}
