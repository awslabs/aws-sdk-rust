...
impl ListObjectParentPathsInput {
    /// Consumes the builder and constructs an Operation<[`ListObjectParentPaths`](crate::operation::list_object_parent_paths::ListObjectParentPaths)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_object_parent_paths::ListObjectParentPaths, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_object_parent_paths::ListObjectParentPathsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/object/parentpaths").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_object_parent_paths::ser_list_object_parent_paths_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_object_parent_paths::ListObjectParentPaths::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListObjectParentPaths", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListObjectParentPaths {
                type Output = std::result::Result<crate::operation::list_object_parent_paths::ListObjectParentPathsOutput, crate::operation::list_object_parent_paths::ListObjectParentPathsError>;
