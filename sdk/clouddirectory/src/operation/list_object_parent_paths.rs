...
/// Orchestration and serialization glue logic for `ListObjectParentPaths`.
...
impl ListObjectParentPaths {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_object_parent_paths::ListObjectParentPathsInput,
                    ) -> ::std::result::Result<crate::operation::list_object_parent_paths::ListObjectParentPathsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_object_parent_paths::ListObjectParentPathsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_object_parent_paths::ListObjectParentPathsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_object_parent_paths::ListObjectParentPathsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListObjectParentPaths {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListObjectParentPaths");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListObjectParentPathsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListObjectParentPathsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListObjectParentPaths")
...
.with_interceptor(ListObjectParentPathsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_object_parent_paths::ListObjectParentPathsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_object_parent_paths::ListObjectParentPathsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_object_parent_paths::ListObjectParentPathsError>::new());
...
#[derive(Debug)]
            struct ListObjectParentPathsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListObjectParentPathsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_object_parent_paths::de_list_object_parent_paths_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_object_parent_paths::de_list_object_parent_paths_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListObjectParentPathsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListObjectParentPathsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_object_parent_paths::ListObjectParentPathsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_object_parent_paths::ListObjectParentPathsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/parentpaths").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_list_object_parent_paths::ser_list_object_parent_paths_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_object_parent_paths::ser_list_object_parent_paths_input(&input)?);
...
#[derive(Debug)]
            struct ListObjectParentPathsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListObjectParentPathsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListObjectParentPathsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListObjectParentPathsInput>()
                        .ok_or("failed to downcast to ListObjectParentPathsInput")?;
...
pub enum ListObjectParentPathsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListObjectParentPathsError) for what information is available for the error.")]
...
impl ListObjectParentPathsError {
    /// Creates the `ListObjectParentPathsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListObjectParentPathsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::DirectoryNotEnabledException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListObjectParentPathsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_object_parent_paths::ListObjectParentPathsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_object_parent_paths::_list_object_parent_paths_output::ListObjectParentPathsOutput;

pub use crate::operation::list_object_parent_paths::_list_object_parent_paths_input::ListObjectParentPathsInput;

mod _list_object_parent_paths_input;

mod _list_object_parent_paths_output;
