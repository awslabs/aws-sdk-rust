    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/managed")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_managed_schema_arns::ListManagedSchemaArns::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_managed_schema_arns::ListManagedSchemaArnsError
{
