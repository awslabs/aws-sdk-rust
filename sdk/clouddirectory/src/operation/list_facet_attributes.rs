    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/facet/attributes")
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_facet_attributes::ser_list_facet_attributes_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_facet_attributes::ListFacetAttributes::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_facet_attributes::ListFacetAttributesError
{
