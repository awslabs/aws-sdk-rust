...
impl PutSchemaFromJson {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_schema_from_json::PutSchemaFromJsonInput,
                    ) -> ::std::result::Result<crate::operation::put_schema_from_json::PutSchemaFromJsonOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_schema_from_json::PutSchemaFromJsonError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_schema_from_json::PutSchemaFromJsonError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_schema_from_json::PutSchemaFromJsonOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutSchemaFromJson {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutSchemaFromJson");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutSchemaFromJsonRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutSchemaFromJsonResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutSchemaFromJson")
...
.with_interceptor(PutSchemaFromJsonEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_schema_from_json::PutSchemaFromJsonError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_schema_from_json::PutSchemaFromJsonError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_schema_from_json::PutSchemaFromJsonError>::new());
...
#[derive(Debug)]
            struct PutSchemaFromJsonResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutSchemaFromJsonResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_schema_from_json::de_put_schema_from_json_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutSchemaFromJsonRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutSchemaFromJsonRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_schema_from_json::PutSchemaFromJsonInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_schema_from_json::PutSchemaFromJsonInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/json").expect("formatting should succeed");
...
fn update_http_builder(
    ...
    let builder = crate::protocol_serde::shape_put_schema_from_json::ser_put_schema_from_json_headers(input, builder)?;
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_schema_from_json::ser_put_schema_from_json_input(&input)?);
...
#[derive(Debug)]
            struct PutSchemaFromJsonEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutSchemaFromJsonEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutSchemaFromJsonEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutSchemaFromJsonInput>()
                        .ok_or("failed to downcast to PutSchemaFromJsonInput")?;
...
pub enum PutSchemaFromJsonError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutSchemaFromJsonError) for what information is available for the error.")]
...
impl PutSchemaFromJsonError {
    /// Creates the `PutSchemaFromJsonError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutSchemaFromJsonError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidRuleException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidSchemaDocException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutSchemaFromJsonError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_schema_from_json::PutSchemaFromJsonError {
...
mod _put_schema_from_json_output;
