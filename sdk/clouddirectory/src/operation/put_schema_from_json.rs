    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/json")
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_schema_from_json::ser_put_schema_from_json_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_schema_from_json::PutSchemaFromJson::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_schema_from_json::PutSchemaFromJsonError
{
