...
impl PutSchemaFromJsonInput {
    /// Consumes the builder and constructs an Operation<[`PutSchemaFromJson`](crate::operation::put_schema_from_json::PutSchemaFromJson)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_schema_from_json::PutSchemaFromJson, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_schema_from_json::PutSchemaFromJsonInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/amazonclouddirectory/2017-01-11/schema/json").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_schema_from_json::ser_put_schema_from_json_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_schema_from_json::PutSchemaFromJson::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutSchemaFromJson", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutSchemaFromJson {
                type Output = std::result::Result<crate::operation::put_schema_from_json::PutSchemaFromJsonOutput, crate::operation::put_schema_from_json::PutSchemaFromJsonError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_schema_from_json::de_put_schema_from_json_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_schema_from_json::de_put_schema_from_json_http_response(response)
                     }
                }
            }
