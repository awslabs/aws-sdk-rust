    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/batchread")
            ...
            > {
                ...
                let builder = crate::protocol_serde::shape_batch_read::ser_batch_read_headers(
                    input, builder,
                )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_read::BatchRead::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchRead {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_read::de_batch_read_http_response_with_props(
                status, headers, body,
            )
        }
    }
