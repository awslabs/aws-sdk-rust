...
impl BatchReadInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::batch_read::BatchRead, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_read::ser_batch_read_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchRead {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_read::de_batch_read_http_response_with_props(status, headers, body)
        }
    }
}
