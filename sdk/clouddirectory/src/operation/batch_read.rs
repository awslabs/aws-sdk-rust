...
impl BatchReadInput {
    /// Consumes the builder and constructs an Operation<[`BatchRead`](crate::operation::batch_read::BatchRead)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_read::BatchRead, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_read::BatchReadInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/amazonclouddirectory/2017-01-11/batchread").expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_read::ser_batch_read_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_read::BatchRead::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchRead", "clouddirectory"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchRead {
                type Output = std::result::Result<crate::operation::batch_read::BatchReadOutput, crate::operation::batch_read::BatchReadError>;
