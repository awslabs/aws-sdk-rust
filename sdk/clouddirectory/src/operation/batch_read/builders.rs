...
impl crate::client::customize::internal::CustomizableSend<crate::operation::batch_read::BatchReadOutput, crate::operation::batch_read::BatchReadError>
    for BatchReadFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::batch_read::BatchReadOutput, crate::operation::batch_read::BatchReadError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl BatchReadFluentBuilder {
    /// Creates a new `BatchReadFluentBuilder`.
