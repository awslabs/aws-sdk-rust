    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/parent")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_object_parents::ListObjectParents::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_object_parents::ListObjectParentsError
{
