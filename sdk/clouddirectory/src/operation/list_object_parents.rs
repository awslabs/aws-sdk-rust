...
impl ListObjectParentsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_object_parents::ListObjectParents,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_object_parents::ser_list_object_parents_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListObjectParents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_object_parents::de_list_object_parents_http_response_with_props(status, headers, body)
        }
    }
}
