...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetObjectAttributes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetObjectAttributes", "clouddirectory"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetObjectAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_object_attributes::ser_get_object_attributes_input(
            &input,
        )?);
