...
impl ListTypedLinkFacetAttributes {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListTypedLinkFacetAttributes",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTypedLinkFacetAttributes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListTypedLinkFacetAttributesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListTypedLinkFacetAttributesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListTypedLinkFacetAttributes")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTypedLinkFacetAttributes")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListTypedLinkFacetAttributesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListTypedLinkFacetAttributesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTypedLinkFacetAttributesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListTypedLinkFacetAttributesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTypedLinkFacetAttributesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_typed_link_facet_attributes::de_list_typed_link_facet_attributes_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_typed_link_facet_attributes::de_list_typed_link_facet_attributes_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListTypedLinkFacetAttributesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesInput,
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_list_typed_link_facet_attributes::ser_list_typed_link_facet_attributes_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_typed_link_facet_attributes::ser_list_typed_link_facet_attributes_input(&input)?,
        );
