...
impl DisableDirectoryFluentBuilder  {
    /// Creates a new `DisableDirectory`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::disable_directory::DisableDirectoryOutput, aws_smithy_http::result::SdkError<crate::operation::disable_directory::DisableDirectoryError>>
                     {
