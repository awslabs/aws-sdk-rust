...
impl UpdateSchemaInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_schema::UpdateSchema, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_schema::UpdateSchemaInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/amazonclouddirectory/2017-01-11/schema/update").expect("formatting should succeed");
                Ok(())
            }
            ...
            fn update_http_builder(
                ...
                let builder = crate::protocol_serde::shape_update_schema::ser_update_schema_headers(input, builder)?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_schema::UpdateSchema::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSchema", "clouddirectory"));
