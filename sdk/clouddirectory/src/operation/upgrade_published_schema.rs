...
impl UpgradePublishedSchema {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpgradePublishedSchema",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpgradePublishedSchema {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpgradePublishedSchemaRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpgradePublishedSchemaResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpgradePublishedSchema")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpgradePublishedSchema")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpgradePublishedSchemaTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpgradePublishedSchemaTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpgradePublishedSchemaTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpgradePublishedSchemaInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpgradePublishedSchemaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_upgrade_published_schema::de_upgrade_published_schema_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_upgrade_published_schema::de_upgrade_published_schema_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpgradePublishedSchemaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::upgrade_published_schema::UpgradePublishedSchemaInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::upgrade_published_schema::UpgradePublishedSchemaInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_upgrade_published_schema::ser_upgrade_published_schema_input(&input)?,
        );
