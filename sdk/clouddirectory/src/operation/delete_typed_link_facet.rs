...
impl DeleteTypedLinkFacet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTypedLinkFacet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteTypedLinkFacet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteTypedLinkFacetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteTypedLinkFacetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTypedLinkFacet")
...
.with_interceptor(DeleteTypedLinkFacetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError>::new());
...
#[derive(Debug)]
            struct DeleteTypedLinkFacetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteTypedLinkFacetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_typed_link_facet::de_delete_typed_link_facet_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_typed_link_facet::de_delete_typed_link_facet_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteTypedLinkFacetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteTypedLinkFacetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/delete").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_typed_link_facet::ser_delete_typed_link_facet_input(&input)?);
...
#[derive(Debug)]
            struct DeleteTypedLinkFacetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteTypedLinkFacetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteTypedLinkFacetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteTypedLinkFacetInput>()
                        .ok_or("failed to downcast to DeleteTypedLinkFacetInput")?;
...
pub enum DeleteTypedLinkFacetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteTypedLinkFacetError) for what information is available for the error.")]
...
impl DeleteTypedLinkFacetError {
    /// Creates the `DeleteTypedLinkFacetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteTypedLinkFacetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteTypedLinkFacetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_typed_link_facet::_delete_typed_link_facet_output::DeleteTypedLinkFacetOutput;

pub use crate::operation::delete_typed_link_facet::_delete_typed_link_facet_input::DeleteTypedLinkFacetInput;

mod _delete_typed_link_facet_input;

mod _delete_typed_link_facet_output;
