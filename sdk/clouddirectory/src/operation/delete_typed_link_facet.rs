...
impl DeleteTypedLinkFacetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTypedLinkFacet`](crate::operation::delete_typed_link_facet::DeleteTypedLinkFacet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_typed_link_facet::DeleteTypedLinkFacet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteTypedLinkFacet {
                type Output = std::result::Result<crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetOutput, crate::operation::delete_typed_link_facet::DeleteTypedLinkFacetError>;
