    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/facets")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_facet_to_object::AddFacetToObject::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::add_facet_to_object::AddFacetToObjectError
{
