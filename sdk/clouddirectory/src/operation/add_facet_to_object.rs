...
impl AddFacetToObjectInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_facet_to_object::ser_add_facet_to_object_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddFacetToObject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_facet_to_object::de_add_facet_to_object_http_response_with_props(status, headers, body)
        }
    }
}
