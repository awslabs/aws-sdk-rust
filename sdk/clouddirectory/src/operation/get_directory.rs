...
impl GetDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`GetDirectory`](crate::operation::get_directory::GetDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_directory::GetDirectory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_directory::GetDirectoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_directory::GetDirectory::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDirectory {
                type Output = std::result::Result<crate::operation::get_directory::GetDirectoryOutput, crate::operation::get_directory::GetDirectoryError>;
