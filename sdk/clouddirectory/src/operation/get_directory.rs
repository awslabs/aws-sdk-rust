    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/directory/get")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_directory::GetDirectory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_directory::de_get_directory_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_directory::de_get_directory_http_response_with_props(
                status, headers, body,
            )
        }
    }
