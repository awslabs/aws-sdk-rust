...
impl ListIndexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_index::ListIndex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_index::ser_list_index_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_index::de_list_index_http_response_with_props(status, headers, body)
        }
    }
}
