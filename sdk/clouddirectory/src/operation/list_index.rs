    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/index/targets")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_index::ListIndex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_index::de_list_index_http_response_with_props(
                status, headers, body,
            )
        }
    }
