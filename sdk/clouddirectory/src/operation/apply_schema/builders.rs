...
impl ApplySchemaFluentBuilder  {
    /// Creates a new `ApplySchema`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::apply_schema::ApplySchemaOutput, aws_smithy_http::result::SdkError<crate::operation::apply_schema::ApplySchemaError>>
                     {
