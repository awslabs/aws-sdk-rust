...
impl Client  {
    ...
    pub fn get_typed_link_facet_information(&self) -> fluent_builders::GetTypedLinkFacetInformation {
    ...
    pub fn list_typed_link_facet_attributes(&self) -> fluent_builders::ListTypedLinkFacetAttributes {
