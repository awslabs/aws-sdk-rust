...
impl super::Client {
    ...
    ///   - [`parent_reference(ObjectReference)`](crate::operation::detach_object::builders::DetachObjectFluentBuilder::parent_reference) / [`set_parent_reference(Option<ObjectReference>)`](crate::operation::detach_object::builders::DetachObjectFluentBuilder::set_parent_reference):<br>required: **true**<br><p>The parent reference from which the object with the specified link name is detached.</p><br>
    ///   - [`link_name(impl Into<String>)`](crate::operation::detach_object::builders::DetachObjectFluentBuilder::link_name) / [`set_link_name(Option<String>)`](crate::operation::detach_object::builders::DetachObjectFluentBuilder::set_link_name):<br>required: **true**<br><p>The link name associated with the object that needs to be detached.</p><br>
