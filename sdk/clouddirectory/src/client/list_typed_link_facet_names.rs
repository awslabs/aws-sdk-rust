...
impl super::Client {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::list_typed_link_facet_names::builders::ListTypedLinkFacetNamesFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::list_typed_link_facet_names::builders::ListTypedLinkFacetNamesFluentBuilder::set_schema_arn): <p>The Amazon Resource Name (ARN) that is associated with the schema. For more information, see <code>arns</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_typed_link_facet_names::builders::ListTypedLinkFacetNamesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_typed_link_facet_names::builders::ListTypedLinkFacetNamesFluentBuilder::set_next_token): <p>The pagination token.</p>
