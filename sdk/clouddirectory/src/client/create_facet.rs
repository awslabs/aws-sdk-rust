...
impl super::Client {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::create_facet::builders::CreateFacetFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::create_facet::builders::CreateFacetFluentBuilder::set_schema_arn): <p>The schema ARN in which the new <code>Facet</code> will be created. For more information, see <code>arns</code>.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_facet::builders::CreateFacetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_facet::builders::CreateFacetFluentBuilder::set_name): <p>The name of the <code>Facet</code>, which is unique for a given schema.</p>
