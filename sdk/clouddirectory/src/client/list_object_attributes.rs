...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_object_attributes::builders::ListObjectAttributesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_object_attributes::builders::ListObjectAttributesFluentBuilder::set_next_token): <p>The pagination token.</p>
