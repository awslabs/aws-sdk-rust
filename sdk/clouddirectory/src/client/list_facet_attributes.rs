...
impl super::Client {
    ...
    ///   - [`schema_arn(impl Into<String>)`](crate::operation::list_facet_attributes::builders::ListFacetAttributesFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::list_facet_attributes::builders::ListFacetAttributesFluentBuilder::set_schema_arn):<br>required: **true**<br><p>The ARN of the schema where the facet resides.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::list_facet_attributes::builders::ListFacetAttributesFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::list_facet_attributes::builders::ListFacetAttributesFluentBuilder::set_name):<br>required: **true**<br><p>The name of the facet whose attributes will be retrieved.</p><br>
