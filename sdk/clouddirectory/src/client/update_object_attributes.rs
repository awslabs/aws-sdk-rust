...
impl super::Client {
    ...
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::update_object_attributes::builders::UpdateObjectAttributesFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::update_object_attributes::builders::UpdateObjectAttributesFluentBuilder::set_directory_arn): <p>The Amazon Resource Name (ARN) that is associated with the <code>Directory</code> where the object resides. For more information, see <code>arns</code>.</p>
