...
impl super::Client {
    ...
    ///   - [`attribute_updates(ObjectAttributeUpdate)`](crate::operation::update_object_attributes::builders::UpdateObjectAttributesFluentBuilder::attribute_updates) / [`set_attribute_updates(Option<Vec<ObjectAttributeUpdate>>)`](crate::operation::update_object_attributes::builders::UpdateObjectAttributesFluentBuilder::set_attribute_updates): <p>The attributes update structure.</p>
