...
impl super::Client {
    ...
    ///   - [`schema_arn(impl Into<String>)`](crate::operation::list_published_schema_arns::builders::ListPublishedSchemaArnsFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::list_published_schema_arns::builders::ListPublishedSchemaArnsFluentBuilder::set_schema_arn):<br>required: **false**<br><p>The response for <code>ListPublishedSchemaArns</code> when this parameter is used will list all minor version ARNs for a major version.</p><br>
