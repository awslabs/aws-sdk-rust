...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_development_schema_arns::builders::ListDevelopmentSchemaArnsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_development_schema_arns::builders::ListDevelopmentSchemaArnsFluentBuilder::set_next_token):<br>required: **false**<br><p>The pagination token.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_development_schema_arns::builders::ListDevelopmentSchemaArnsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_development_schema_arns::builders::ListDevelopmentSchemaArnsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to retrieve.</p><br>
