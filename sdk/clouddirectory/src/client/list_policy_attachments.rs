...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_policy_attachments::builders::ListPolicyAttachmentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_policy_attachments::builders::ListPolicyAttachmentsFluentBuilder::set_next_token): <p>The pagination token.</p>
