...
impl super::Client {
    ...
    ///   - [`schema_arn(impl Into<String>)`](crate::operation::get_applied_schema_version::builders::GetAppliedSchemaVersionFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::get_applied_schema_version::builders::GetAppliedSchemaVersionFluentBuilder::set_schema_arn):<br>required: **true**<br><p>The ARN of the applied schema.</p><br>
