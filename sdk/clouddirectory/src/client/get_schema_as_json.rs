...
impl super::Client {
    ...
    ///   - [`schema_arn(impl Into<String>)`](crate::operation::get_schema_as_json::builders::GetSchemaAsJsonFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::get_schema_as_json::builders::GetSchemaAsJsonFluentBuilder::set_schema_arn):<br>required: **true**<br><p>The ARN of the schema to retrieve.</p><br>
