...
impl super::Client {
    ...
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::detach_typed_link::builders::DetachTypedLinkFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::detach_typed_link::builders::DetachTypedLinkFluentBuilder::set_directory_arn): <p>The Amazon Resource Name (ARN) of the directory where you want to detach the typed link.</p>
