...
impl super::Client {
    ...
    ///   - [`link_name(impl ::std::convert::Into<String>)`](crate::operation::create_object::builders::CreateObjectFluentBuilder::link_name) / [`set_link_name(Option<String>)`](crate::operation::create_object::builders::CreateObjectFluentBuilder::set_link_name): <p>The name of link that is used to attach this object to a parent.</p>
