...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::set_name): <p>The name of the <code>Directory</code>. Should be unique per account, per region.</p>
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::create_directory::builders::CreateDirectoryFluentBuilder::set_schema_arn): <p>The Amazon Resource Name (ARN) of the published schema that will be copied into the data <code>Directory</code>. For more information, see <code>arns</code>.</p>
