...
impl super::Client {
    ...
    ///   - [`attribute_updates(LinkAttributeUpdate)`](crate::operation::update_link_attributes::builders::UpdateLinkAttributesFluentBuilder::attribute_updates) / [`set_attribute_updates(Option<Vec<LinkAttributeUpdate>>)`](crate::operation::update_link_attributes::builders::UpdateLinkAttributesFluentBuilder::set_attribute_updates): <p>The attributes update structure.</p>
