...
impl super::Client {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::put_schema_from_json::builders::PutSchemaFromJsonFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::put_schema_from_json::builders::PutSchemaFromJsonFluentBuilder::set_schema_arn): <p>The ARN of the schema to update.</p>
    ///   - [`document(impl ::std::convert::Into<String>)`](crate::operation::put_schema_from_json::builders::PutSchemaFromJsonFluentBuilder::document) / [`set_document(Option<String>)`](crate::operation::put_schema_from_json::builders::PutSchemaFromJsonFluentBuilder::set_document): <p>The replacement JSON schema.</p>
