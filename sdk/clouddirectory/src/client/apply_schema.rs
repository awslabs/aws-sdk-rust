...
impl super::Client {
    ...
    ///   - [`published_schema_arn(impl ::std::convert::Into<String>)`](crate::operation::apply_schema::builders::ApplySchemaFluentBuilder::published_schema_arn) / [`set_published_schema_arn(Option<String>)`](crate::operation::apply_schema::builders::ApplySchemaFluentBuilder::set_published_schema_arn): <p>Published schema Amazon Resource Name (ARN) that needs to be copied. For more information, see <code>arns</code>.</p>
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::apply_schema::builders::ApplySchemaFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::apply_schema::builders::ApplySchemaFluentBuilder::set_directory_arn): <p>The Amazon Resource Name (ARN) that is associated with the <code>Directory</code> into which the schema is copied. For more information, see <code>arns</code>.</p>
