...
impl super::Client {
    ...
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::list_attached_indices::builders::ListAttachedIndicesFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::list_attached_indices::builders::ListAttachedIndicesFluentBuilder::set_directory_arn): <p>The ARN of the directory.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_attached_indices::builders::ListAttachedIndicesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_attached_indices::builders::ListAttachedIndicesFluentBuilder::set_next_token): <p>The pagination token.</p>
