...
impl super::Client {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::list_facet_names::builders::ListFacetNamesFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::list_facet_names::builders::ListFacetNamesFluentBuilder::set_schema_arn): <p>The Amazon Resource Name (ARN) to retrieve facet names from.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_facet_names::builders::ListFacetNamesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_facet_names::builders::ListFacetNamesFluentBuilder::set_next_token): <p>The pagination token.</p>
