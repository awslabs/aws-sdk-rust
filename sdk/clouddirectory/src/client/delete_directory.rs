...
impl super::Client {
    ...
    ///   - [`directory_arn(impl Into<String>)`](crate::operation::delete_directory::builders::DeleteDirectoryFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::delete_directory::builders::DeleteDirectoryFluentBuilder::set_directory_arn):<br>required: **true**<br><p>The ARN of the directory to delete.</p><br>
                            /// - On success, responds with [`DeleteDirectoryOutput`](crate::operation::delete_directory::DeleteDirectoryOutput) with field(s):
    ///   - [`directory_arn(String)`](crate::operation::delete_directory::DeleteDirectoryOutput::directory_arn): <p>The ARN of the deleted directory.</p>
