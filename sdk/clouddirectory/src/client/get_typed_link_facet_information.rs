...
impl super::Client {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::get_typed_link_facet_information::builders::GetTypedLinkFacetInformationFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::get_typed_link_facet_information::builders::GetTypedLinkFacetInformationFluentBuilder::set_schema_arn): <p>The Amazon Resource Name (ARN) that is associated with the schema. For more information, see <code>arns</code>.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_typed_link_facet_information::builders::GetTypedLinkFacetInformationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_typed_link_facet_information::builders::GetTypedLinkFacetInformationFluentBuilder::set_name): <p>The unique name of the typed link facet.</p>
