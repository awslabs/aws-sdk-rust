...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_typed_link_facet_information::builders::GetTypedLinkFacetInformationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_typed_link_facet_information::builders::GetTypedLinkFacetInformationFluentBuilder::set_name):<br>required: **true**<br><p>The unique name of the typed link facet.</p><br>
