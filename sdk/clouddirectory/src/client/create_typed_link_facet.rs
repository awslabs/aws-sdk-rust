...
impl super::Client {
    ...
    ///   - [`schema_arn(impl Into<String>)`](crate::operation::create_typed_link_facet::builders::CreateTypedLinkFacetFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::create_typed_link_facet::builders::CreateTypedLinkFacetFluentBuilder::set_schema_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) that is associated with the schema. For more information, see <code>arns</code>.</p><br>
    ///   - [`facet(TypedLinkFacet)`](crate::operation::create_typed_link_facet::builders::CreateTypedLinkFacetFluentBuilder::facet) / [`set_facet(Option<TypedLinkFacet>)`](crate::operation::create_typed_link_facet::builders::CreateTypedLinkFacetFluentBuilder::set_facet):<br>required: **true**<br><p><code>Facet</code> structure that is associated with the typed link facet.</p><br>
