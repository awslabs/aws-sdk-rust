...
impl super::Client {
    ...
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::list_object_policies::builders::ListObjectPoliciesFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::list_object_policies::builders::ListObjectPoliciesFluentBuilder::set_directory_arn): <p>The Amazon Resource Name (ARN) that is associated with the <code>Directory</code> where objects reside. For more information, see <code>arns</code>.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_object_policies::builders::ListObjectPoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_object_policies::builders::ListObjectPoliciesFluentBuilder::set_next_token): <p>The pagination token.</p>
