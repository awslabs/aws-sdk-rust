...
pub fn ser_batch_attach_typed_link(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchAttachTypedLink) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
