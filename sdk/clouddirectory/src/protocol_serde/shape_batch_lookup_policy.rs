...
pub fn ser_batch_lookup_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchLookupPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
