...
pub fn ser_batch_lookup_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BatchLookupPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
