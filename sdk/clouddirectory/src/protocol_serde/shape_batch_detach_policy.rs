...
pub fn ser_batch_detach_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BatchDetachPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
