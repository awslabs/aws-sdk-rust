...
pub fn ser_typed_link_facet(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TypedLinkFacet) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
