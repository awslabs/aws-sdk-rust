...
) -> Result<Option<crate::types::BatchReadSuccessfulResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ListIndex" => {
                            builder = builder.set_list_index(crate::protocol_serde::shape_batch_list_index_response::de_batch_list_index_response(
                                tokens,
                            )?);
                        }
                        "ListOutgoingTypedLinks" => {
                            builder = builder.set_list_outgoing_typed_links(
                                crate::protocol_serde::shape_batch_list_outgoing_typed_links_response::de_batch_list_outgoing_typed_links_response(
                                    tokens,
                                )?,
                            );
                        }
                        "ListIncomingTypedLinks" => {
                            builder = builder.set_list_incoming_typed_links(
                                crate::protocol_serde::shape_batch_list_incoming_typed_links_response::de_batch_list_incoming_typed_links_response(
                                    tokens,
                                )?,
                            );
                        }
