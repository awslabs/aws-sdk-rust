...
pub(crate) fn de_batch_read_successful_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchReadSuccessfulResponse>, aws_smithy_json::deserialize::error::DeserializeError>
