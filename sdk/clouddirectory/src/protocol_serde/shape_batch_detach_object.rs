...
pub fn ser_batch_detach_object(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchDetachObject) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
