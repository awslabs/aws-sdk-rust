...
pub fn ser_list_directories_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListDirectoriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
