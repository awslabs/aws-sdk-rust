...
pub fn ser_batch_list_index(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListIndex) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
