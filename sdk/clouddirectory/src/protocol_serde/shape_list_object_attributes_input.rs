...
pub fn ser_list_object_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListObjectAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
