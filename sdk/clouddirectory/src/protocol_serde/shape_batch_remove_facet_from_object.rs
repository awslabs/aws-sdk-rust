...
pub fn ser_batch_remove_facet_from_object(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BatchRemoveFacetFromObject) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
