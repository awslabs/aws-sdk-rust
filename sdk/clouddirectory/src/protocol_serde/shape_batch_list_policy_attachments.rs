...
pub fn ser_batch_list_policy_attachments(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListPolicyAttachments) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
