...
pub fn ser_list_object_parents_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListObjectParentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
