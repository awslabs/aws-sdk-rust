...
pub fn ser_list_object_parents_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_object_parents::ListObjectParentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.include_all_links_to_each_parent {
        object.key("IncludeAllLinksToEachParent").boolean(input.include_all_links_to_each_parent);
    }
