...
) -> Result<Option<crate::types::TypedLinkSpecifier>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SourceObjectReference" => {
                            builder =
                                builder.set_source_object_reference(crate::protocol_serde::shape_object_reference::de_object_reference(tokens)?);
                        }
                        "TargetObjectReference" => {
                            builder =
                                builder.set_target_object_reference(crate::protocol_serde::shape_object_reference::de_object_reference(tokens)?);
                        }
