...
pub(crate) fn de_typed_link_specifier<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TypedLinkSpecifier>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_typed_link_specifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TypedLinkSpecifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
