    ...
    Err(match error_code {
        ...
        "UnsupportedIndexTypeException" => crate::operation::create_index::CreateIndexError::UnsupportedIndexTypeException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_unsupported_index_type_exception::de_unsupported_index_type_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_index::CreateIndexError::unhandled)?;
...
) -> Result<crate::operation::create_index::builders::CreateIndexOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
