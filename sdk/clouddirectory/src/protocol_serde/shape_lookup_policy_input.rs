...
pub fn ser_lookup_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::LookupPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
