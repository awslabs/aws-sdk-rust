...
pub fn ser_link_attribute_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LinkAttributeUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
