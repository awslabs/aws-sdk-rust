...
pub fn ser_typed_link_facet_attribute_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TypedLinkFacetAttributeUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
