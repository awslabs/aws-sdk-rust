...
pub fn ser_upgrade_published_schema_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpgradePublishedSchemaInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
