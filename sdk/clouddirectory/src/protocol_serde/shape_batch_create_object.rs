...
pub fn ser_batch_create_object(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchCreateObject) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
