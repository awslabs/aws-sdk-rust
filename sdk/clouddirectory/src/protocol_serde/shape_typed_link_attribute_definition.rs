...
pub(crate) fn de_typed_link_attribute_definition<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::TypedLinkAttributeDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Rules" => {
                            builder = builder.set_rules(crate::protocol_serde::shape_rule_map::de_rule_map(tokens, _value, depth + 1)?);
                        }
                        "RequiredBehavior" => {
