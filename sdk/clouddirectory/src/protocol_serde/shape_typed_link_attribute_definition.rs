...
pub(crate) fn de_typed_link_attribute_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TypedLinkAttributeDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_typed_link_attribute_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TypedLinkAttributeDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
