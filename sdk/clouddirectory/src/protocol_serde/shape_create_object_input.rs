...
pub fn ser_create_object_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateObjectInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
