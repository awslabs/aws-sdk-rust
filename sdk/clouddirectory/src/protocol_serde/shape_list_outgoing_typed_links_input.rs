...
pub fn ser_list_outgoing_typed_links_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListOutgoingTypedLinksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
