...
pub fn ser_batch_read_operation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchReadOperation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
