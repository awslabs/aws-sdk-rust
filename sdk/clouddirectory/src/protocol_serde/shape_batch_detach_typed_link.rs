...
pub fn ser_batch_detach_typed_link(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchDetachTypedLink) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
