...
pub fn ser_batch_list_incoming_typed_links(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListIncomingTypedLinks) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
