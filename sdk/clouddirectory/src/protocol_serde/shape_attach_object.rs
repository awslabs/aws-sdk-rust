...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_object_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_object::AttachObjectOutput, crate::operation::attach_object::AttachObjectError> {
    Ok({
        #[allow(unused_mut)]
