...
pub fn de_attach_object_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_object::AttachObjectOutput, crate::operation::attach_object::AttachObjectError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_object_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_object::AttachObjectOutput, crate::operation::attach_object::AttachObjectError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_attach_object_input(input: &crate::operation::attach_object::AttachObjectInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_attach_object_input::ser_attach_object_input_input(&mut object, input)?;
    object.finish();
