...
pub fn ser_batch_write_operation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchWriteOperation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
