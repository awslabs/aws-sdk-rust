...
pub(crate) fn de_batch_write_operation_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchWriteOperationResponse>, aws_smithy_json::deserialize::error::DeserializeError>
