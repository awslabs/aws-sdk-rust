...
pub fn ser_batch_list_attached_indices(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListAttachedIndices) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
