...
pub fn ser_typed_attribute_value_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TypedAttributeValueRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
