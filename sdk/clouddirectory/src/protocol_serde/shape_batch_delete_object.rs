...
pub fn ser_batch_delete_object(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BatchDeleteObject) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
