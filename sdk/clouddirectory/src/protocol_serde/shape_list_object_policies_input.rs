...
pub fn ser_list_object_policies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListObjectPoliciesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
