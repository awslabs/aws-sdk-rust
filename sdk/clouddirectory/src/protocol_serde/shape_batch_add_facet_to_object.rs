...
pub fn ser_batch_add_facet_to_object(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchAddFacetToObject) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
