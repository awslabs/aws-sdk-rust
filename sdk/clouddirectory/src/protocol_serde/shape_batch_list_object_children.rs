...
pub fn ser_batch_list_object_children(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListObjectChildren) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
