...
pub fn ser_add_facet_to_object_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddFacetToObjectInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
