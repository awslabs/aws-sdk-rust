...
pub fn ser_list_object_parent_paths_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_object_parent_paths::ListObjectParentPathsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
