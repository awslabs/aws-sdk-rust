...
pub fn ser_typed_link_attribute_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TypedLinkAttributeRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
