...
pub fn ser_detach_typed_link_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DetachTypedLinkInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
