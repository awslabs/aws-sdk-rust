...
pub fn ser_batch_list_object_policies(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListObjectPolicies) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
