...
pub fn ser_update_object_attributes_input(input: &crate::operation::update_object_attributes::UpdateObjectAttributesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
