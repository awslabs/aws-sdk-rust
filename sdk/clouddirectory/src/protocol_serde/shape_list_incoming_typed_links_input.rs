...
pub fn ser_list_incoming_typed_links_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_incoming_typed_links::ListIncomingTypedLinksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
