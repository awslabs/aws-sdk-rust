...
pub fn ser_batch_get_object_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchGetObjectAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
