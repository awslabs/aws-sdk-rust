...
pub fn ser_batch_list_outgoing_typed_links(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BatchListOutgoingTypedLinks) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
