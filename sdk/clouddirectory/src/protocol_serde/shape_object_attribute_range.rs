...
pub fn ser_object_attribute_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ObjectAttributeRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
