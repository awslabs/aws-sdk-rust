...
pub fn ser_batch_list_object_parents(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchListObjectParents) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
