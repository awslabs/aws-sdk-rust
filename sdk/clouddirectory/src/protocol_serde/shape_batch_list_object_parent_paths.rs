...
pub fn ser_batch_list_object_parent_paths(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BatchListObjectParentPaths) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
