...
pub fn ser_list_object_children_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_object_children::ListObjectChildrenInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
