...
pub fn ser_batch_create_index(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchCreateIndex) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
