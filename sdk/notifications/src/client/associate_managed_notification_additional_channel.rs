...
impl super::Client {
    ...
    ///   - [`is_sensitive_events_subscribed(bool)`](crate::operation::associate_managed_notification_additional_channel::builders::AssociateManagedNotificationAdditionalChannelFluentBuilder::is_sensitive_events_subscribed) / [`set_is_sensitive_events_subscribed(Option<bool>)`](crate::operation::associate_managed_notification_additional_channel::builders::AssociateManagedNotificationAdditionalChannelFluentBuilder::set_is_sensitive_events_subscribed):<br>required: **false**<br><p>Specifies whether this channel is subscribed to sensitive events. The <code>notifications:SubscribeSensitiveEvents</code> permission controls access to sensitive events. Defaults to false.</p><br>
