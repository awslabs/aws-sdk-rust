...
impl super::Client {
    ...
    ///   - [`notification_hubs(Vec::<NotificationHubOverview>)`](crate::operation::list_notification_hubs::ListNotificationHubsOutput::notification_hubs): <p>The NotificationHubs in the account.</p>
