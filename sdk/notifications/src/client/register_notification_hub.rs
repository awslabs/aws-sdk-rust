...
impl super::Client {
    ...
    ///   - [`status_summary(Option<NotificationHubStatusSummary>)`](crate::operation::register_notification_hub::RegisterNotificationHubOutput::status_summary): <p>Provides additional information about the current <code>NotificationHub</code> status information.</p>
