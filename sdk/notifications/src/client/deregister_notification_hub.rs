...
impl super::Client {
    ...
    ///   - [`notification_hub_region(String)`](crate::operation::deregister_notification_hub::DeregisterNotificationHubOutput::notification_hub_region): <p>The <code>NotificationHub</code> Region.</p>
    ///   - [`status_summary(Option<NotificationHubStatusSummary>)`](crate::operation::deregister_notification_hub::DeregisterNotificationHubOutput::status_summary): <p><code>NotificationHub</code> status information.</p>
