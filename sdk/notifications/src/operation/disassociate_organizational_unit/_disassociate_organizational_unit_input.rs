...
pub struct DisassociateOrganizationalUnitInput {
...
impl DisassociateOrganizationalUnitInput {
    /// <p>The unique identifier of the organizational unit to disassociate.</p>
...
impl DisassociateOrganizationalUnitInput {
    /// Creates a new builder-style object to manufacture [`DisassociateOrganizationalUnitInput`](crate::operation::disassociate_organizational_unit::DisassociateOrganizationalUnitInput).
    pub fn builder() -> crate::operation::disassociate_organizational_unit::builders::DisassociateOrganizationalUnitInputBuilder {
        crate::operation::disassociate_organizational_unit::builders::DisassociateOrganizationalUnitInputBuilder::default()
    }
}

/// A builder for [`DisassociateOrganizationalUnitInput`](crate::operation::disassociate_organizational_unit::DisassociateOrganizationalUnitInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DisassociateOrganizationalUnitInputBuilder {
...
impl DisassociateOrganizationalUnitInputBuilder {
    /// <p>The unique identifier of the organizational unit to disassociate.</p>
    ...
    /// Consumes the builder and constructs a [`DisassociateOrganizationalUnitInput`](crate::operation::disassociate_organizational_unit::DisassociateOrganizationalUnitInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::disassociate_organizational_unit::DisassociateOrganizationalUnitInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::disassociate_organizational_unit::DisassociateOrganizationalUnitInput {
