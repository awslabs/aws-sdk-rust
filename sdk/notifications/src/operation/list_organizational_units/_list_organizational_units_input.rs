...
pub struct ListOrganizationalUnitsInput {
...
impl ListOrganizationalUnitsInput {
    /// <p>The Amazon Resource Name (ARN) of the notification configuration used to filter the organizational units.</p>
...
impl ListOrganizationalUnitsInput {
    /// Creates a new builder-style object to manufacture [`ListOrganizationalUnitsInput`](crate::operation::list_organizational_units::ListOrganizationalUnitsInput).
    pub fn builder() -> crate::operation::list_organizational_units::builders::ListOrganizationalUnitsInputBuilder {
        crate::operation::list_organizational_units::builders::ListOrganizationalUnitsInputBuilder::default()
    }
}

/// A builder for [`ListOrganizationalUnitsInput`](crate::operation::list_organizational_units::ListOrganizationalUnitsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListOrganizationalUnitsInputBuilder {
    pub(crate) notification_configuration_arn: ::std::option::Option<::std::string::String>,
    pub(crate) max_results: ::std::option::Option<i32>,
    pub(crate) next_token: ::std::option::Option<::std::string::String>,
}
impl ListOrganizationalUnitsInputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the notification configuration used to filter the organizational units.</p>
    ...
    /// Consumes the builder and constructs a [`ListOrganizationalUnitsInput`](crate::operation::list_organizational_units::ListOrganizationalUnitsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::list_organizational_units::ListOrganizationalUnitsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::list_organizational_units::ListOrganizationalUnitsInput {
