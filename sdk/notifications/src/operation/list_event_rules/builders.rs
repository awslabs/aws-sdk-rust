...
pub use crate::operation::list_event_rules::_list_event_rules_output::ListEventRulesOutputBuilder;

pub use crate::operation::list_event_rules::_list_event_rules_input::ListEventRulesInputBuilder;

impl crate::operation::list_event_rules::builders::ListEventRulesInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_event_rules();
...
pub struct ListEventRulesFluentBuilder {
    ...
    inner: crate::operation::list_event_rules::builders::ListEventRulesInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_event_rules::ListEventRulesOutput,
        crate::operation::list_event_rules::ListEventRulesError,
    > for ListEventRulesFluentBuilder
{
    fn send(
        self,
...
impl ListEventRulesFluentBuilder {
    /// Creates a new `ListEventRulesFluentBuilder`.
    ...
    /// Access the ListEventRules as a reference.
    pub fn as_input(&self) -> &crate::operation::list_event_rules::builders::ListEventRulesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_event_rules::ListEventRules::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_event_rules::paginator::ListEventRulesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
