...
impl crate::operation::get_notification_configuration::builders::GetNotificationConfigurationInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_notification_configuration();
...
impl GetNotificationConfigurationFluentBuilder {
    /// Creates a new `GetNotificationConfigurationFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_notification_configuration::GetNotificationConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_notification_configuration::GetNotificationConfiguration::orchestrate(&runtime_plugins, input).await
    }
