...
pub fn de_apns_voip_channel_response_payload(input: &[u8]) -> Result<crate::model::ApnsVoipChannelResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_apns_voip_channel_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ApnsVoipChannelResponse>, aws_smithy_json::deserialize::error::DeserializeError>
