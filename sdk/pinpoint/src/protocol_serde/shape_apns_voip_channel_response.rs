...
pub(crate) fn de_apns_voip_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::ApnsVoipChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::ApnsVoipChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
