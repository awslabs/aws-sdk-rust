...
pub(crate) fn de_number_validate_response_payload(
    input: &[u8],
) -> Result<crate::types::NumberValidateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::NumberValidateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
