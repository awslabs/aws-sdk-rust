...
pub fn de_number_validate_response_payload(input: &[u8]) -> Result<crate::model::NumberValidateResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_number_validate_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NumberValidateResponse>, aws_smithy_json::deserialize::error::DeserializeError>
