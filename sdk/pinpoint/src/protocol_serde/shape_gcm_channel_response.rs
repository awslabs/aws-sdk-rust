...
pub(crate) fn de_gcm_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::GcmChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::GcmChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
