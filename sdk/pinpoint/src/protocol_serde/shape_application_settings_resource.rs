...
pub(crate) fn de_application_settings_resource_payload(
    ...
    let result = crate::protocol_serde::shape_application_settings_resource::de_application_settings_resource(tokens)?
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "CampaignHook" => {
                            builder = builder.set_campaign_hook(crate::protocol_serde::shape_campaign_hook::de_campaign_hook(tokens)?);
                        }
                        "LastModifiedDate" => {
