...
pub(crate) fn de_application_settings_resource_payload(
    input: &[u8],
) -> Result<crate::types::ApplicationSettingsResource, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::ApplicationSettingsResource>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
