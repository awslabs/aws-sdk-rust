...
pub(crate) fn de_application_settings_resource_payload(input: &[u8]) -> Result<crate::types::ApplicationSettingsResource, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_application_settings_resource<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ApplicationSettingsResource>, ::aws_smithy_json::deserialize::error::DeserializeError>
