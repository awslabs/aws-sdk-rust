...
pub fn de_get_voice_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_voice_template::GetVoiceTemplateOutput, crate::operation::get_voice_template::GetVoiceTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_voice_template::GetVoiceTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_voice_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_voice_template::GetVoiceTemplateOutput, crate::operation::get_voice_template::GetVoiceTemplateError> {
    Ok({
        #[allow(unused_mut)]
