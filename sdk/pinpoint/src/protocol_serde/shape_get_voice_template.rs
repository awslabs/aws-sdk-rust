...
pub fn de_get_voice_template_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_voice_template::GetVoiceTemplateOutput, crate::operation::get_voice_template::GetVoiceTemplateError> {
    #[allow(unused_mut)]
...
pub fn de_get_voice_template_http_response(
    ...
    Ok({
        ...
        output = output
            .set_voice_template_response(crate::protocol_serde::shape_get_voice_template_output::de_voice_template_response_payload(_response_body)?);
