...
pub fn ser_endpoint_batch_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EndpointBatchItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
