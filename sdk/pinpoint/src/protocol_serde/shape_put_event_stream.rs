...
pub fn de_put_event_stream_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_event_stream::PutEventStreamOutput, crate::operation::put_event_stream::PutEventStreamError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_event_stream_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_event_stream::PutEventStreamOutput, crate::operation::put_event_stream::PutEventStreamError> {
    Ok({
        #[allow(unused_mut)]
