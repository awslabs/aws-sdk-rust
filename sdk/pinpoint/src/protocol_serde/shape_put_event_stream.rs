...
pub fn de_put_event_stream_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_event_stream::PutEventStreamOutput, crate::operation::put_event_stream::PutEventStreamError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::put_event_stream::PutEventStreamError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_event_stream_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_event_stream::PutEventStreamOutput, crate::operation::put_event_stream::PutEventStreamError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_event_stream(
            crate::protocol_serde::shape_put_event_stream_output::de_event_stream_payload(_response_body)?
        );
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::put_event_stream_output_output_correct_errors(output).build()
    })
}
