...
pub fn ser_custom_message_activity(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomMessageActivity) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_custom_message_activity<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CustomMessageActivity>, aws_smithy_json::deserialize::error::DeserializeError>
