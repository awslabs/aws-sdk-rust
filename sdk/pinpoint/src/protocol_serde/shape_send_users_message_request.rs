...
pub fn ser_send_users_message_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SendUsersMessageRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
