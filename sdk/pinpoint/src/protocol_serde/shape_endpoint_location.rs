...
pub fn ser_endpoint_location(
    ...
    if let Some(var_3) = &input.latitude {
        object.key("Latitude").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_3).into()));
    }
    if let Some(var_4) = &input.longitude {
        object.key("Longitude").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_4).into()));
    }
