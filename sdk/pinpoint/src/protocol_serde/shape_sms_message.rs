...
pub fn ser_sms_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SmsMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
