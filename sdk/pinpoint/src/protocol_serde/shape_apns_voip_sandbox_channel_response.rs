...
pub(crate) fn de_apns_voip_sandbox_channel_response_payload(
    _value: &[u8],
) -> ::std::result::Result<crate::types::ApnsVoipSandboxChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(_value)).peekable();
    let tokens = &mut tokens_owned;
    #[allow(unused_variables)]
    let depth = 0u32;
    let result = crate::protocol_serde::shape_apns_voip_sandbox_channel_response::de_apns_voip_sandbox_channel_response(tokens, _value, depth + 1)?
...
pub(crate) fn de_apns_voip_sandbox_channel_response<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ApnsVoipSandboxChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            Ok(Some(
                crate::serde_util::apns_voip_sandbox_channel_response_correct_errors(builder).build(),
            ))
        }
