...
pub(crate) fn de_in_app_template_response_payload(
    input: &[u8],
) -> Result<crate::types::InAppTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::InAppTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
