...
pub fn de_get_export_job_http_response(
    ...
    Ok({
        ...
        output = output.set_export_job_response(crate::protocol_serde::shape_get_export_job_output::de_export_job_response_payload(
            _response_body,
        )?);
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_export_job_output_output_correct_errors(output).build()
    })
}
