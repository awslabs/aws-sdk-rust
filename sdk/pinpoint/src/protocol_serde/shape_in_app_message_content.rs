...
pub fn ser_in_app_message_content(
    ...
    if let Some(var_2) = &input.body_config {
        ...
        crate::protocol_serde::shape_in_app_message_body_config::ser_in_app_message_body_config(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
    ...
    if let Some(var_7) = &input.primary_btn {
        ...
        crate::protocol_serde::shape_in_app_message_button::ser_in_app_message_button(
            &mut object_8,
            var_7,
        )?;
        object_8.finish();
...
pub(crate) fn de_in_app_message_content<'a, I>(
    ...
    Option<crate::types::InAppMessageContent>,
