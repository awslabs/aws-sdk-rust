...
pub fn ser_in_app_message_content(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InAppMessageContent) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_in_app_message_content<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InAppMessageContent>, aws_smithy_json::deserialize::error::DeserializeError>
