...
pub fn ser_import_job_request_http_payload(
    payload: &::std::option::Option<crate::types::ImportJobRequest>,
    ...
    Ok(crate::protocol_serde::shape_create_import_job_input::ser_import_job_request_payload(
        payload,
    )?)
}

pub fn ser_import_job_request_payload(
