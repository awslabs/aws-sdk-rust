...
pub fn ser_send_otp_message_request_parameters(
    ...
    if let Some(var_1) = &input.allowed_attempts {
        object.key("AllowedAttempts").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_4) = &input.code_length {
        object.key("CodeLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    ...
    if let Some(var_11) = &input.validity_period {
        object.key("ValidityPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    Ok(())
}
