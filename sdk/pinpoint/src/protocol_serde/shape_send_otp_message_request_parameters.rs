...
pub fn ser_send_otp_message_request_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SendOtpMessageRequestParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
