...
pub(crate) fn de_in_app_message_body_config<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::InAppMessageBodyConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
