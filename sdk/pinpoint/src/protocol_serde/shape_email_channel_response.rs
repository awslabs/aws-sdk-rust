...
pub(crate) fn de_email_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::EmailChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::EmailChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
