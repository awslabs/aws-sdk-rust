...
pub fn ser_closed_days(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClosedDays) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_closed_days<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ClosedDays>, aws_smithy_json::deserialize::error::DeserializeError>
