...
pub(crate) fn de_in_app_campaign_schedule<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::InAppCampaignSchedule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
