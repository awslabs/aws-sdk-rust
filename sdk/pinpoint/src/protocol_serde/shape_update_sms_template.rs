...
pub fn de_update_sms_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_sms_template::UpdateSmsTemplateOutput, crate::operation::update_sms_template::UpdateSmsTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::update_sms_template::UpdateSmsTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_sms_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::update_sms_template::UpdateSmsTemplateOutput, crate::operation::update_sms_template::UpdateSmsTemplateError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_message_body(
            crate::protocol_serde::shape_update_sms_template_output::de_message_body_payload(response.body().as_ref())?
        );
