...
pub fn de_update_sms_template_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_sms_template::UpdateSmsTemplateOutput, crate::operation::update_sms_template::UpdateSmsTemplateError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::update_sms_template::UpdateSmsTemplateOutput, crate::operation::update_sms_template::UpdateSmsTemplateError>
{
    Ok({
        ...
        output = output.set_message_body(crate::protocol_serde::shape_update_sms_template_output::de_message_body_payload(
            _response_body,
        )?);
