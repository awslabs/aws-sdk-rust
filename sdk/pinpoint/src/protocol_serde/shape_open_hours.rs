...
pub fn ser_open_hours(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpenHours) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_open_hours<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OpenHours>, aws_smithy_json::deserialize::error::DeserializeError>
