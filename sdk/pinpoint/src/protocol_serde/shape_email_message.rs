...
pub fn ser_email_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EmailMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
