...
pub fn de_campaign_response_payload(input: &[u8]) -> Result<crate::model::CampaignResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_campaign_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CampaignResponse>, aws_smithy_json::deserialize::error::DeserializeError>
