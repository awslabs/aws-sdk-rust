            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Behavior" => {
                            builder = builder.set_behavior(crate::protocol_serde::shape_segment_behaviors::de_segment_behaviors(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "Location" => {
                            builder = builder.set_location(crate::protocol_serde::shape_segment_location::de_segment_location(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "UserAttributes" => {
                            builder = builder.set_user_attributes(
                                crate::protocol_serde::shape_map_of_attribute_dimension::de_map_of_attribute_dimension(tokens, _value, depth + 1)?,
                            );
                        }
