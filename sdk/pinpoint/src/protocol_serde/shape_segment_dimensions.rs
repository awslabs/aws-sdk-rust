...
pub fn ser_segment_dimensions(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SegmentDimensions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_segment_dimensions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SegmentDimensions>, aws_smithy_json::deserialize::error::DeserializeError>
