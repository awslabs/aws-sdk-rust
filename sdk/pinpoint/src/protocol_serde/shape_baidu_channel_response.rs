...
pub(crate) fn de_baidu_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::BaiduChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::BaiduChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
