...
pub fn de_baidu_channel_response_payload(input: &[u8]) -> Result<crate::model::BaiduChannelResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_baidu_channel_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BaiduChannelResponse>, aws_smithy_json::deserialize::error::DeserializeError>
