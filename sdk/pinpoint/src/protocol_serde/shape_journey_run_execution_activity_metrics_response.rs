...
pub(crate) fn de_journey_run_execution_activity_metrics_response_payload(
    input: &[u8],
) -> Result<crate::types::JourneyRunExecutionActivityMetricsResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::JourneyRunExecutionActivityMetricsResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
