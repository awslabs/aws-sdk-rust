...
pub(crate) fn de_voice_channel_response_payload(input: &[u8]) -> Result<crate::types::VoiceChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_voice_channel_response<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VoiceChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
