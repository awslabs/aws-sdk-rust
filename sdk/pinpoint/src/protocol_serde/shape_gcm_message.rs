...
pub fn ser_gcm_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GcmMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
