...
pub fn ser_gcm_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GcmMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
