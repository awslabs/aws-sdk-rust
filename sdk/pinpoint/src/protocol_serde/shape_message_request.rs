...
pub fn ser_message_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MessageRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
