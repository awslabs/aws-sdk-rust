...
pub(crate) fn de_channel_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ChannelResponse>, aws_smithy_json::deserialize::error::DeserializeError>
