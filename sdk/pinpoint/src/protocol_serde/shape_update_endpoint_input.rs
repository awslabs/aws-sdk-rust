...
pub fn ser_endpoint_request_http_payload(
    payload: &::std::option::Option<crate::types::EndpointRequest>,
    ...
    Ok(crate::protocol_serde::shape_update_endpoint_input::ser_endpoint_request_payload(payload)?)
}
