...
pub(crate) fn de_sms_template_response_payload(
    input: &[u8],
) -> Result<crate::types::SmsTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::SmsTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
