...
pub fn ser_baidu_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BaiduMessage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
