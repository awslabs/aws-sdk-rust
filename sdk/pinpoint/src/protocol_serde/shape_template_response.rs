...
pub(crate) fn de_template_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TemplateResponse>, aws_smithy_json::deserialize::error::DeserializeError>
