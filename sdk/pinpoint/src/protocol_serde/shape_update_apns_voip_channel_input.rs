...
pub fn ser_apns_voip_channel_request_http_payload(
    payload: &::std::option::Option<crate::types::ApnsVoipChannelRequest>,
    ...
    Ok(crate::protocol_serde::shape_update_apns_voip_channel_input::ser_apns_voip_channel_request_payload(payload)?)
}

pub fn ser_apns_voip_channel_request_payload(
