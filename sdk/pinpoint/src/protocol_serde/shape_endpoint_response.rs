            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Demographic" => {
                            builder = builder.set_demographic(crate::protocol_serde::shape_endpoint_demographic::de_endpoint_demographic(tokens)?);
                        }
                        "EffectiveDate" => {
                        ...
                        "User" => {
                            builder = builder.set_user(crate::protocol_serde::shape_endpoint_user::de_endpoint_user(tokens)?);
                        }
