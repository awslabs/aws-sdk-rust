...
pub fn ser_write_treatment_resource(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WriteTreatmentResource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
