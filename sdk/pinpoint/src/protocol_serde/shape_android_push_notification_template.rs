...
pub(crate) fn de_android_push_notification_template<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AndroidPushNotificationTemplate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
