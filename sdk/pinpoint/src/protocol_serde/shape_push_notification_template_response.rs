...
pub fn de_push_notification_template_response_payload(input: &[u8]) -> Result<crate::model::PushNotificationTemplateResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_push_notification_template_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PushNotificationTemplateResponse>, aws_smithy_json::deserialize::error::DeserializeError>
