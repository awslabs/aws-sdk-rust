...
pub(crate) fn de_push_notification_template_response_payload(
    input: &[u8],
) -> Result<crate::types::PushNotificationTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
    let tokens = &mut tokens_owned;
    let result = crate::protocol_serde::shape_push_notification_template_response::de_push_notification_template_response(tokens)?
...
) -> Result<Option<crate::types::PushNotificationTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "APNS" => {
                            builder = builder
                                .set_apns(crate::protocol_serde::shape_apns_push_notification_template::de_apns_push_notification_template(tokens)?);
                        }
                        "Arn" => {
            ...
            Ok(Some(
                crate::serde_util::push_notification_template_response_correct_errors(builder).build(),
            ))
        }
