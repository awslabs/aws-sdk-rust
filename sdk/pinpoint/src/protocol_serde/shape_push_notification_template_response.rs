...
pub(crate) fn de_push_notification_template_response_payload(input: &[u8]) -> Result<crate::types::PushNotificationTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_push_notification_template_response<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PushNotificationTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::push_notification_template_response_correct_errors(builder).build()))
        }
        _ => {
