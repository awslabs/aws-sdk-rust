...
pub fn ser_message_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MessageConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_message_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MessageConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
