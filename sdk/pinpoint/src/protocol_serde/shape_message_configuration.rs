                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            "ADMMessage" => {
                                builder = builder.set_adm_message(crate::protocol_serde::shape_message::de_message(tokens, _value, depth + 1)?);
                            }
                            "APNSMessage" => {
                                builder = builder.set_apns_message(crate::protocol_serde::shape_message::de_message(tokens, _value, depth + 1)?);
                            }
                            "BaiduMessage" => {
                                builder = builder.set_baidu_message(crate::protocol_serde::shape_message::de_message(tokens, _value, depth + 1)?);
                            }
                            "CustomMessage" => {
                                builder = builder.set_custom_message(
                                    crate::protocol_serde::shape_campaign_custom_message::de_campaign_custom_message(tokens, _value, depth + 1)?,
                                );
                            }
                            "DefaultMessage" => {
                                builder = builder.set_default_message(crate::protocol_serde::shape_message::de_message(tokens, _value, depth + 1)?);
                            }
                            "EmailMessage" => {
                                builder = builder.set_email_message(crate::protocol_serde::shape_campaign_email_message::de_campaign_email_message(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "GCMMessage" => {
                                builder = builder.set_gcm_message(crate::protocol_serde::shape_message::de_message(tokens, _value, depth + 1)?);
                            }
                            "SMSMessage" => {
                                builder = builder.set_sms_message(crate::protocol_serde::shape_campaign_sms_message::de_campaign_sms_message(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "InAppMessage" => {
                                builder = builder.set_in_app_message(
                                    crate::protocol_serde::shape_campaign_in_app_message::de_campaign_in_app_message(tokens, _value, depth + 1)?,
                                );
                            }
