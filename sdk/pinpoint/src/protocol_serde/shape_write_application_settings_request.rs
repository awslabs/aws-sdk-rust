...
pub fn ser_write_application_settings_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WriteApplicationSettingsRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
