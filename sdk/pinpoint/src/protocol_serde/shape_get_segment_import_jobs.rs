...
pub fn de_get_segment_import_jobs_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_segment_import_jobs::GetSegmentImportJobsOutput, crate::operation::get_segment_import_jobs::GetSegmentImportJobsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_segment_import_jobs::GetSegmentImportJobsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_segment_import_jobs_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_segment_import_jobs::GetSegmentImportJobsOutput, crate::operation::get_segment_import_jobs::GetSegmentImportJobsError> {
    Ok({
        #[allow(unused_mut)]
