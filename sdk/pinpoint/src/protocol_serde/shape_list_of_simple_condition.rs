...
pub(crate) fn de_list_of_simple_condition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::SimpleCondition>>, aws_smithy_json::deserialize::error::DeserializeError>
