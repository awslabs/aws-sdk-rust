...
pub(crate) fn de_tags_model_payload(
    _value: &[u8],
) -> ::std::result::Result<crate::types::TagsModel, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(_value)).peekable();
    let tokens = &mut tokens_owned;
    #[allow(unused_variables)]
    let depth = 0u32;
    let result = crate::protocol_serde::shape_tags_model::de_tags_model(tokens, _value, depth + 1)?
...
pub(crate) fn de_tags_model<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::TagsModel>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
