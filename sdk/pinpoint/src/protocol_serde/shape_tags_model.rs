...
pub(crate) fn de_tags_model_payload(input: &[u8]) -> Result<crate::types::TagsModel, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    let result = crate::protocol_serde::shape_tags_model::de_tags_model(tokens)?
...
pub(crate) fn de_tags_model<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> Result<Option<crate::types::TagsModel>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
