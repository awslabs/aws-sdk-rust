...
pub fn ser_events_batch(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EventsBatch) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
