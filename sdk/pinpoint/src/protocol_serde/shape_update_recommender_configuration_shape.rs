...
pub fn ser_update_recommender_configuration_shape(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateRecommenderConfigurationShape) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
