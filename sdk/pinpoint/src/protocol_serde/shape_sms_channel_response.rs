...
pub(crate) fn de_sms_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::SmsChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::SmsChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
