...
pub fn ser_message(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Message) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_message<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Message>, aws_smithy_json::deserialize::error::DeserializeError>
