...
pub fn ser_tags_model_http_payload(
    payload: &::std::option::Option<crate::types::TagsModel>,
    ...
    Ok(crate::protocol_serde::shape_tag_resource_input::ser_tags_model_payload(payload)?)
}
