...
pub(crate) fn de_email_template_response_payload(
    input: &[u8],
) -> Result<crate::types::EmailTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::EmailTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
