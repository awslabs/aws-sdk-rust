...
pub(crate) fn de_custom_delivery_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::CustomDeliveryConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
