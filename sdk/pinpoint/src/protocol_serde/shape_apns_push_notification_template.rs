...
pub(crate) fn de_apns_push_notification_template<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ApnsPushNotificationTemplate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
