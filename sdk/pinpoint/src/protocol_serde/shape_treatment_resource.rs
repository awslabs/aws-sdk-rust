...
pub(crate) fn de_treatment_resource<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TreatmentResource>, aws_smithy_json::deserialize::error::DeserializeError>
