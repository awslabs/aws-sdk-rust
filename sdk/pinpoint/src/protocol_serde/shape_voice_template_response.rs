...
pub(crate) fn de_voice_template_response_payload(
    input: &[u8],
) -> Result<crate::types::VoiceTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::VoiceTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
