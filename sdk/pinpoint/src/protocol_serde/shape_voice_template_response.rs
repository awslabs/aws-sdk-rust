...
pub(crate) fn de_voice_template_response_payload(input: &[u8]) -> Result<crate::types::VoiceTemplateResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_voice_template_response<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VoiceTemplateResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::voice_template_response_correct_errors(builder).build()))
        }
        _ => {
