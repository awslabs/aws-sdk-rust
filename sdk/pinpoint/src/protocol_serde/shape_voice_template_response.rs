...
pub fn de_voice_template_response_payload(input: &[u8]) -> Result<crate::model::VoiceTemplateResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_voice_template_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VoiceTemplateResponse>, aws_smithy_json::deserialize::error::DeserializeError>
