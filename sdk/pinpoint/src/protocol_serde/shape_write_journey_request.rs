...
pub fn ser_write_journey_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WriteJourneyRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
