...
pub(crate) fn de_apns_sandbox_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::ApnsSandboxChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::ApnsSandboxChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
