...
pub(crate) fn de_adm_channel_response_payload(
    input: &[u8],
) -> Result<crate::types::AdmChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::AdmChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
