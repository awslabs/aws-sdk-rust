...
pub fn de_adm_channel_response_payload(input: &[u8]) -> Result<crate::model::AdmChannelResponse, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_adm_channel_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AdmChannelResponse>, aws_smithy_json::deserialize::error::DeserializeError>
