...
pub fn de_get_event_stream_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetEventStreamOutput, crate::error::GetEventStreamError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetEventStreamError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_event_stream_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetEventStreamOutput, crate::error::GetEventStreamError> {
    Ok({
        #[allow(unused_mut)]
