...
pub fn de_get_event_stream_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_event_stream::GetEventStreamOutput, crate::operation::get_event_stream::GetEventStreamError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_event_stream::GetEventStreamError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_event_stream_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_event_stream::GetEventStreamOutput, crate::operation::get_event_stream::GetEventStreamError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_event_stream(
            crate::protocol_serde::shape_get_event_stream_output::de_event_stream_payload(response.body().as_ref())?
        );
