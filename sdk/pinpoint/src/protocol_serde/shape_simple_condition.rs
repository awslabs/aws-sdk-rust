...
pub fn ser_simple_condition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SimpleCondition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_simple_condition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SimpleCondition>, aws_smithy_json::deserialize::error::DeserializeError>
