...
pub fn ser_create_recommender_configuration_shape(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CreateRecommenderConfigurationShape) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
