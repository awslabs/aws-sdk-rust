...
pub fn ser_apns_sandbox_channel_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ApnsSandboxChannelRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
