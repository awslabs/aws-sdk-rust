...
pub fn ser_push_notification_template_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PushNotificationTemplateRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
