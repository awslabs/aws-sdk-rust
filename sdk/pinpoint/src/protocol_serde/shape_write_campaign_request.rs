...
pub fn ser_write_campaign_request(
    ...
    if let Some(var_8) = &input.holdout_percent {
        object.key("HoldoutPercent").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    ...
    if let Some(var_20) = &input.segment_version {
        object.key("SegmentVersion").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    ...
    if let Some(var_29) = &input.priority {
        object.key("Priority").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_29).into()));
    }
    Ok(())
}
