...
pub fn ser_write_campaign_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WriteCampaignRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
