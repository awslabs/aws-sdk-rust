...
pub fn ser_apns_voip_sandbox_channel_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ApnsVoipSandboxChannelRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
