...
impl super::Client {
    ...
    ///   - [`journey_id(impl Into<String>)`](crate::operation::get_journey_runs::builders::GetJourneyRunsFluentBuilder::journey_id) / [`set_journey_id(Option<String>)`](crate::operation::get_journey_runs::builders::GetJourneyRunsFluentBuilder::set_journey_id): <p>The unique identifier for the journey.</p>
    ///   - [`page_size(impl Into<String>)`](crate::operation::get_journey_runs::builders::GetJourneyRunsFluentBuilder::page_size) / [`set_page_size(Option<String>)`](crate::operation::get_journey_runs::builders::GetJourneyRunsFluentBuilder::set_page_size): <p>The maximum number of items to include in each page of a paginated response. This parameter is not supported for application, campaign, and journey metrics.</p>
    ///   - [`token(impl Into<String>)`](crate::operation::get_journey_runs::builders::GetJourneyRunsFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::get_journey_runs::builders::GetJourneyRunsFluentBuilder::set_token): <p>The NextToken string that specifies which page of results to return in a paginated response.</p>
