...
impl super::Client {
    ...
    pub fn delete_apns_voip_channel(
        &self,
    ) -> crate::operation::delete_apns_voip_channel::builders::DeleteApnsVoipChannelFluentBuilder
    {
