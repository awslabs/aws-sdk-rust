...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_import_job::builders::GetImportJobFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_import_job::builders::GetImportJobFluentBuilder::set_application_id): <p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p>
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::get_import_job::builders::GetImportJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_import_job::builders::GetImportJobFluentBuilder::set_job_id): <p>The unique identifier for the job.</p>
