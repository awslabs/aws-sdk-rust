...
impl super::Client {
    ...
    ///   - [`create_recommender_configuration(CreateRecommenderConfigurationShape)`](crate::operation::create_recommender_configuration::builders::CreateRecommenderConfigurationFluentBuilder::create_recommender_configuration) / [`set_create_recommender_configuration(Option<CreateRecommenderConfigurationShape>)`](crate::operation::create_recommender_configuration::builders::CreateRecommenderConfigurationFluentBuilder::set_create_recommender_configuration):<br>required: **true**<br><p>Specifies Amazon Pinpoint configuration settings for retrieving and processing recommendation data from a recommender model.</p><br>
