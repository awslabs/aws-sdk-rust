...
impl super::Client {
    ...
    ///   - [`token(impl Into<String>)`](crate::operation::get_campaigns::builders::GetCampaignsFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::get_campaigns::builders::GetCampaignsFluentBuilder::set_token):<br>required: **false**<br><p>The NextToken string that specifies which page of results to return in a paginated response.</p><br>
