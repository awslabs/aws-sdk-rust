...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_export_job::builders::GetExportJobFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_export_job::builders::GetExportJobFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p><br>
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_export_job::builders::GetExportJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_export_job::builders::GetExportJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The unique identifier for the job.</p><br>
