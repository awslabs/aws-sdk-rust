...
impl super::Client {
    ...
    ///   - [`prefix(impl Into<String>)`](crate::operation::list_templates::builders::ListTemplatesFluentBuilder::prefix) / [`set_prefix(Option<String>)`](crate::operation::list_templates::builders::ListTemplatesFluentBuilder::set_prefix):<br>required: **false**<br><p>The substring to match in the names of the message templates to include in the results. If you specify this value, Amazon Pinpoint returns only those templates whose names begin with the value that you specify.</p><br>
    ///   - [`template_type(impl Into<String>)`](crate::operation::list_templates::builders::ListTemplatesFluentBuilder::template_type) / [`set_template_type(Option<String>)`](crate::operation::list_templates::builders::ListTemplatesFluentBuilder::set_template_type):<br>required: **false**<br><p>The type of message template to include in the results. Valid values are: EMAIL, PUSH, SMS, and VOICE. To include all types of templates in the results, don't include this parameter in your request.</p><br>
