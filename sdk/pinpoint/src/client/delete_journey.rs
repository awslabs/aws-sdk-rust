...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::delete_journey::builders::DeleteJourneyFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::delete_journey::builders::DeleteJourneyFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p><br>
    ///   - [`journey_id(impl Into<String>)`](crate::operation::delete_journey::builders::DeleteJourneyFluentBuilder::journey_id) / [`set_journey_id(Option<String>)`](crate::operation::delete_journey::builders::DeleteJourneyFluentBuilder::set_journey_id):<br>required: **true**<br><p>The unique identifier for the journey.</p><br>
