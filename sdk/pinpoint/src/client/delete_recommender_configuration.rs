...
impl super::Client {
    ...
    ///   - [`recommender_id(impl Into<String>)`](crate::operation::delete_recommender_configuration::builders::DeleteRecommenderConfigurationFluentBuilder::recommender_id) / [`set_recommender_id(Option<String>)`](crate::operation::delete_recommender_configuration::builders::DeleteRecommenderConfigurationFluentBuilder::set_recommender_id):<br>required: **true**<br><p>The unique identifier for the recommender model configuration. This identifier is displayed as the <b>Recommender ID</b> on the Amazon Pinpoint console.</p><br>
