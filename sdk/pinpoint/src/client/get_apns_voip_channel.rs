...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_apns_voip_channel::builders::GetApnsVoipChannelFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_apns_voip_channel::builders::GetApnsVoipChannelFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p><br>
