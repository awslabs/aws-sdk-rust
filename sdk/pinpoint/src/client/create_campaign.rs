...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::create_campaign::builders::CreateCampaignFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::create_campaign::builders::CreateCampaignFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p><br>
    ///   - [`write_campaign_request(WriteCampaignRequest)`](crate::operation::create_campaign::builders::CreateCampaignFluentBuilder::write_campaign_request) / [`set_write_campaign_request(Option<WriteCampaignRequest>)`](crate::operation::create_campaign::builders::CreateCampaignFluentBuilder::set_write_campaign_request):<br>required: **true**<br><p>Specifies the configuration and other settings for a campaign.</p><br>
