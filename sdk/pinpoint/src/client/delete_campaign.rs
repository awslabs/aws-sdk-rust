...
impl super::Client {
    ...
    ///   - [`campaign_id(impl Into<String>)`](crate::operation::delete_campaign::builders::DeleteCampaignFluentBuilder::campaign_id) / [`set_campaign_id(Option<String>)`](crate::operation::delete_campaign::builders::DeleteCampaignFluentBuilder::set_campaign_id):<br>required: **true**<br><p>The unique identifier for the campaign.</p><br>
