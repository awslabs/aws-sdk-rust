...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::get_user_endpoints::builders::GetUserEndpointsFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::get_user_endpoints::builders::GetUserEndpointsFluentBuilder::set_user_id):<br>required: **true**<br><p>The unique identifier for the user.</p><br>
