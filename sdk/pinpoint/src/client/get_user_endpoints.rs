...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_user_endpoints::builders::GetUserEndpointsFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_user_endpoints::builders::GetUserEndpointsFluentBuilder::set_application_id): <p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p>
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::get_user_endpoints::builders::GetUserEndpointsFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::get_user_endpoints::builders::GetUserEndpointsFluentBuilder::set_user_id): <p>The unique identifier for the user.</p>
