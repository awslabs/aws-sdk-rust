...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p><br>
    ///   - [`segment_id(impl Into<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::segment_id) / [`set_segment_id(Option<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::set_segment_id):<br>required: **true**<br><p>The unique identifier for the segment.</p><br>
