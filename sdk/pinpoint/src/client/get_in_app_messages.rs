...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_in_app_messages::builders::GetInAppMessagesFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_in_app_messages::builders::GetInAppMessagesFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p><br>
    ///   - [`endpoint_id(impl Into<String>)`](crate::operation::get_in_app_messages::builders::GetInAppMessagesFluentBuilder::endpoint_id) / [`set_endpoint_id(Option<String>)`](crate::operation::get_in_app_messages::builders::GetInAppMessagesFluentBuilder::set_endpoint_id):<br>required: **true**<br><p>The unique identifier for the endpoint.</p><br>
