...
impl super::Client {
    ...
    ///   - [`page_size(impl Into<String>)`](crate::operation::get_recommender_configurations::builders::GetRecommenderConfigurationsFluentBuilder::page_size) / [`set_page_size(Option<String>)`](crate::operation::get_recommender_configurations::builders::GetRecommenderConfigurationsFluentBuilder::set_page_size):<br>required: **false**<br><p>The maximum number of items to include in each page of a paginated response. This parameter is not supported for application, campaign, and journey metrics.</p><br>
    ...
    pub fn get_recommender_configurations(
        &self,
    ) -> crate::operation::get_recommender_configurations::builders::GetRecommenderConfigurationsFluentBuilder {
