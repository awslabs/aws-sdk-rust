...
impl super::Client {
    ...
    ///   - [`page_size(impl Into<String>)`](crate::operation::get_segment_import_jobs::builders::GetSegmentImportJobsFluentBuilder::page_size) / [`set_page_size(Option<String>)`](crate::operation::get_segment_import_jobs::builders::GetSegmentImportJobsFluentBuilder::set_page_size):<br>required: **false**<br><p>The maximum number of items to include in each page of a paginated response. This parameter is not supported for application, campaign, and journey metrics.</p><br>
    ///   - [`segment_id(impl Into<String>)`](crate::operation::get_segment_import_jobs::builders::GetSegmentImportJobsFluentBuilder::segment_id) / [`set_segment_id(Option<String>)`](crate::operation::get_segment_import_jobs::builders::GetSegmentImportJobsFluentBuilder::set_segment_id):<br>required: **true**<br><p>The unique identifier for the segment.</p><br>
