...
impl super::Client {
    ...
    ///   - [`template_name(impl ::std::convert::Into<String>)`](crate::operation::create_voice_template::builders::CreateVoiceTemplateFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::create_voice_template::builders::CreateVoiceTemplateFluentBuilder::set_template_name): <p>The name of the message template. A template name must start with an alphanumeric character and can contain a maximum of 128 characters. The characters can be alphanumeric characters, underscores (_), or hyphens (-). Template names are case sensitive.</p>
