...
impl super::Client {
    ...
    ///   - [`page_size(impl Into<String>)`](crate::operation::list_journeys::builders::ListJourneysFluentBuilder::page_size) / [`set_page_size(Option<String>)`](crate::operation::list_journeys::builders::ListJourneysFluentBuilder::set_page_size):<br>required: **false**<br><p>The maximum number of items to include in each page of a paginated response. This parameter is not supported for application, campaign, and journey metrics.</p><br>
    ///   - [`token(impl Into<String>)`](crate::operation::list_journeys::builders::ListJourneysFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::list_journeys::builders::ListJourneysFluentBuilder::set_token):<br>required: **false**<br><p>The NextToken string that specifies which page of results to return in a paginated response.</p><br>
