...
impl std::fmt::Display for CreateAppError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateAppErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAppErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAppErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAppErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAppErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAppErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAppErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateAppError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateAppErrorKind::InternalServerErrorException(_))
    }
...
impl std::fmt::Display for CreateCampaignError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateCampaignErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateCampaignErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateCampaignErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateCampaignErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateCampaignErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateCampaignErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            CreateCampaignErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateCampaignError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateCampaignErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateCampaignErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateCampaignErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, CreateCampaignErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `CreateCampaignErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateCampaignErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateEmailTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateEmailTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateEmailTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateEmailTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateEmailTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateEmailTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateEmailTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateEmailTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, CreateEmailTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateEmailTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, CreateEmailTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateEmailTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateEmailTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateEmailTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateEmailTemplateErrorKind::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreateEmailTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateEmailTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateExportJobError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateExportJobErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateExportJobErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateExportJobError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateExportJobErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateExportJobErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateExportJobErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, CreateExportJobErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `CreateExportJobErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateExportJobErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateImportJobError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateImportJobErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateImportJobErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateImportJobError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateImportJobErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateImportJobErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateImportJobErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, CreateImportJobErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `CreateImportJobErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateImportJobErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateInAppTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateInAppTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInAppTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInAppTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInAppTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInAppTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateInAppTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateInAppTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, CreateInAppTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, CreateInAppTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateInAppTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateInAppTemplateErrorKind::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateInAppTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateJourneyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateJourneyErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateJourneyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateJourneyError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateJourneyErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateJourneyErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateJourneyErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, CreateJourneyErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `CreateJourneyErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateJourneyErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreatePushTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreatePushTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePushTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePushTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePushTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePushTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePushTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreatePushTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, CreatePushTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, CreatePushTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreatePushTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreatePushTemplateErrorKind::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreatePushTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateRecommenderConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateRecommenderConfigurationErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateRecommenderConfigurationErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            CreateRecommenderConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            CreateRecommenderConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateRecommenderConfigurationError {
    /// Creates a new `CreateRecommenderConfigurationError`.
                    pub fn new(kind: CreateRecommenderConfigurationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
...
impl std::fmt::Display for CreateSegmentError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateSegmentErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSegmentErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateSegmentError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateSegmentErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateSegmentErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateSegmentErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, CreateSegmentErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `CreateSegmentErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateSegmentErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateSmsTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateSmsTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSmsTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSmsTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSmsTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSmsTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateSmsTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateSmsTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, CreateSmsTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateSmsTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, CreateSmsTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateSmsTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateSmsTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateSmsTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateSmsTemplateErrorKind::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreateSmsTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateSmsTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for CreateVoiceTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateVoiceTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVoiceTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVoiceTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVoiceTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVoiceTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVoiceTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateVoiceTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, CreateVoiceTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, CreateVoiceTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, CreateVoiceTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, CreateVoiceTemplateErrorKind::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, CreateVoiceTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteAdmChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteAdmChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAdmChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteAdmChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteAdmChannelErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteAdmChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteAdmChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteAdmChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteAdmChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteAdmChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteAdmChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteApnsChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteApnsChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteApnsChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteApnsChannelErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsChannelErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, DeleteApnsChannelErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsChannelErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteApnsChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteApnsChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteApnsChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteApnsChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteApnsSandboxChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteApnsSandboxChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsSandboxChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteApnsVoipChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteApnsVoipChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteApnsVoipSandboxChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteApnsVoipSandboxChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteApnsVoipSandboxChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeleteApnsVoipSandboxChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeleteApnsVoipSandboxChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteAppError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteAppErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAppErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAppErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAppErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAppErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAppErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAppErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteAppError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteAppErrorKind::InternalServerErrorException(_))
    }
...
impl std::fmt::Display for DeleteBaiduChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteBaiduChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBaiduChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteCampaignError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteCampaignErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteCampaignErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteCampaignErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteCampaignErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteCampaignErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteCampaignErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteCampaignErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteCampaignError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteCampaignErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteCampaignErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteCampaignErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteCampaignErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteCampaignErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteCampaignErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteEmailChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteEmailChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteEmailTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteEmailTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEmailTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteEndpointError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteEndpointErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEndpointErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEndpointErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEndpointErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEndpointErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEndpointErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEndpointErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteEndpointError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteEndpointErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteEndpointErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteEndpointErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteEndpointErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteEndpointErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteEndpointErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteEventStreamError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteEventStreamErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteEventStreamErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteEventStreamError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteEventStreamErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, DeleteEventStreamErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteEventStreamErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteEventStreamErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteEventStreamErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteEventStreamErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteGcmChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteGcmChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGcmChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteGcmChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteGcmChannelErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteGcmChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteGcmChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteGcmChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteGcmChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteGcmChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteGcmChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteInAppTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteInAppTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteInAppTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteJourneyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteJourneyErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteJourneyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteJourneyError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteJourneyErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteJourneyErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteJourneyErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteJourneyErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeletePushTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeletePushTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeletePushTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteRecommenderConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteRecommenderConfigurationErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteRecommenderConfigurationErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeleteRecommenderConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeleteRecommenderConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteRecommenderConfigurationError {
    /// Creates a new `DeleteRecommenderConfigurationError`.
                    pub fn new(kind: DeleteRecommenderConfigurationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
...
impl std::fmt::Display for DeleteSegmentError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteSegmentErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSegmentErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteSegmentError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteSegmentErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteSegmentErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteSegmentErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteSegmentErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteSegmentErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteSegmentErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteSmsChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteSmsChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteSmsChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsChannelErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteSmsChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteSmsChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteSmsTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteSmsTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteSmsTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteSmsTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteSmsTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteSmsTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteSmsTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteSmsTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, DeleteSmsTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for DeleteUserEndpointsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteUserEndpointsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteUserEndpointsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteVoiceChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteVoiceChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for DeleteVoiceTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteVoiceTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVoiceTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetAdmChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetAdmChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetAdmChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetAdmChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetAdmChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetAdmChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetAdmChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetAdmChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetAdmChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetAdmChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetApnsChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetApnsChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetApnsChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetApnsChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetApnsChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetApnsChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetApnsChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetApnsChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetApnsChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetApnsSandboxChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetApnsSandboxChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsSandboxChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetApnsVoipChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetApnsVoipChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetApnsVoipSandboxChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetApnsVoipSandboxChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetApnsVoipSandboxChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetAppError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetAppErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for GetApplicationDateRangeKpiError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetApplicationDateRangeKpiErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationDateRangeKpiErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetApplicationSettingsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetApplicationSettingsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetApplicationSettingsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetAppsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetAppsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetAppsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetAppsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetAppsErrorKind::InternalServerErrorException(_))
    }
...
impl std::fmt::Display for GetBaiduChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetBaiduChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetBaiduChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetBaiduChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetBaiduChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetBaiduChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetBaiduChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetBaiduChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetBaiduChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetBaiduChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetCampaignError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCampaignErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl GetCampaignError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetCampaignActivitiesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCampaignActivitiesErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignActivitiesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetCampaignDateRangeKpiError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCampaignDateRangeKpiErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignDateRangeKpiErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetCampaignsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCampaignsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetCampaignsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignsErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignsErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignsErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignsErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignsErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetCampaignsErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetCampaignVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCampaignVersionErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetCampaignVersionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetCampaignVersionsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetCampaignVersionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetChannelsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetChannelsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetChannelsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetChannelsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetChannelsErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetChannelsErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetChannelsErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetChannelsErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetChannelsErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetChannelsErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetEmailChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetEmailChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetEmailChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetEmailChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetEmailChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetEmailChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetEmailChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetEmailChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetEmailChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetEmailTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetEmailTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetEmailTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetEmailTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetEmailTemplateErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetEmailTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetEmailTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetEmailTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetEmailTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetEmailTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetEmailTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetEndpointError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetEndpointErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetEndpointErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetEndpointError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetEndpointErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetEndpointErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetEndpointErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetEndpointErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetEndpointErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetEndpointErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetEventStreamError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetEventStreamErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetEventStreamErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetEventStreamError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetEventStreamErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetEventStreamErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetEventStreamErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetEventStreamErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetExportJobError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetExportJobErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetExportJobError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetExportJobErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetExportJobErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetExportJobsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetExportJobsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetExportJobsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetExportJobsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobsErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetExportJobsErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobsErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobsErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetExportJobsErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetExportJobsErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetGcmChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetGcmChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetGcmChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetGcmChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetGcmChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetGcmChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetGcmChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetGcmChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetGcmChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetGcmChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetImportJobError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetImportJobErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetImportJobError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetImportJobErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetImportJobErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetImportJobsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetImportJobsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetImportJobsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetImportJobsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobsErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetImportJobsErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobsErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobsErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetImportJobsErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetImportJobsErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetInAppMessagesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetInAppMessagesErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppMessagesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetInAppMessagesError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetInAppMessagesErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetInAppMessagesErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetInAppMessagesErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetInAppMessagesErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetInAppMessagesErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetInAppMessagesErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetInAppMessagesErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetInAppTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetInAppTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetInAppTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetInAppTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetInAppTemplateErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetInAppTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetInAppTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetInAppTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetInAppTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetInAppTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetInAppTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetJourneyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetJourneyErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetJourneyError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetJourneyErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetJourneyErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetJourneyErrorKind::MethodNotAllowedException(_))
    }
...
impl std::fmt::Display for GetJourneyDateRangeKpiError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetJourneyDateRangeKpiErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyDateRangeKpiErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetJourneyExecutionActivityMetricsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GetJourneyExecutionActivityMetricsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            GetJourneyExecutionActivityMetricsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetJourneyExecutionActivityMetricsError {
    /// Creates a new `GetJourneyExecutionActivityMetricsError`.
                    pub fn new(kind: GetJourneyExecutionActivityMetricsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
...
impl std::fmt::Display for GetJourneyExecutionMetricsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetJourneyExecutionMetricsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetJourneyExecutionMetricsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetPushTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetPushTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetPushTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetPushTemplateError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetPushTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetPushTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetPushTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetPushTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetPushTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetPushTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetRecommenderConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetRecommenderConfigurationErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetRecommenderConfigurationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetRecommenderConfigurationsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            GetRecommenderConfigurationsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetSegmentError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSegmentErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSegmentError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentErrorKind::MethodNotAllowedException(_))
    }
...
impl std::fmt::Display for GetSegmentExportJobsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSegmentExportJobsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentExportJobsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetSegmentImportJobsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSegmentImportJobsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentImportJobsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetSegmentsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSegmentsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSegmentsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentsErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentsErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentsErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentsErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentsErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentsErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetSegmentVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSegmentVersionErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSegmentVersionError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentVersionErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentVersionErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentVersionErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentVersionErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentVersionErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentVersionErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentVersionErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentVersionErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetSegmentVersionErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetSegmentVersionErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetSegmentVersionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSegmentVersionsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSegmentVersionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for GetSmsChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSmsChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSmsChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetSmsChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetSmsChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetSmsChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetSmsChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetSmsChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetSmsChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetSmsTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetSmsTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetSmsTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetSmsTemplateError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetSmsTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetSmsTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetSmsTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetSmsTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetSmsTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetSmsTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetUserEndpointsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetUserEndpointsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetUserEndpointsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetUserEndpointsError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetUserEndpointsErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetUserEndpointsErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetUserEndpointsErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetUserEndpointsErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetUserEndpointsErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetUserEndpointsErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetUserEndpointsErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetVoiceChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetVoiceChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetVoiceChannelError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for GetVoiceTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetVoiceTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            GetVoiceTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetVoiceTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceTemplateErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, GetVoiceTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for ListJourneysError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListJourneysErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            ListJourneysErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListJourneysError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, ListJourneysErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `ListJourneysErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, ListJourneysErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, ListJourneysErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `ListJourneysErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, ListJourneysErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for ListTemplatesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListTemplatesErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplatesErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplatesErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplatesErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplatesErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ListTemplatesError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, ListTemplatesErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `ListTemplatesErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, ListTemplatesErrorKind::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `ListTemplatesErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, ListTemplatesErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for ListTemplateVersionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListTemplateVersionsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            ListTemplateVersionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for PhoneNumberValidateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PhoneNumberValidateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            PhoneNumberValidateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for PutEventsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutEventsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl PutEventsError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, PutEventsErrorKind::InternalServerErrorException(_))
    }
...
impl std::fmt::Display for PutEventStreamError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            PutEventStreamErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            PutEventStreamErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl PutEventStreamError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, PutEventStreamErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, PutEventStreamErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, PutEventStreamErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, PutEventStreamErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for RemoveAttributesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            RemoveAttributesErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            RemoveAttributesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl RemoveAttributesError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, RemoveAttributesErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, RemoveAttributesErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, RemoveAttributesErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, RemoveAttributesErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, RemoveAttributesErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for SendMessagesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SendMessagesErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            SendMessagesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SendMessagesError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, SendMessagesErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `SendMessagesErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, SendMessagesErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, SendMessagesErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `SendMessagesErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, SendMessagesErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for SendOTPMessageError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SendOTPMessageErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            SendOTPMessageErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SendOTPMessageError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, SendOTPMessageErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, SendOTPMessageErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, SendOTPMessageErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, SendOTPMessageErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for SendUsersMessagesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SendUsersMessagesErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            SendUsersMessagesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SendUsersMessagesError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, SendUsersMessagesErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, SendUsersMessagesErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, SendUsersMessagesErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, SendUsersMessagesErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, SendUsersMessagesErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, SendUsersMessagesErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateAdmChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateAdmChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAdmChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateAdmChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateAdmChannelErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateAdmChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateAdmChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateAdmChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateAdmChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateAdmChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateAdmChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateApnsChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateApnsChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateApnsChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateApnsChannelErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsChannelErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, UpdateApnsChannelErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsChannelErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateApnsChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateApnsChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateApnsChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateApnsChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateApnsSandboxChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateApnsSandboxChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsSandboxChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateApnsVoipChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateApnsVoipChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateApnsVoipSandboxChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateApnsVoipSandboxChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApnsVoipSandboxChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            UpdateApnsVoipSandboxChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            UpdateApnsVoipSandboxChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateApplicationSettingsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateApplicationSettingsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApplicationSettingsErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApplicationSettingsErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApplicationSettingsErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApplicationSettingsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApplicationSettingsErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateApplicationSettingsErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for UpdateBaiduChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateBaiduChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBaiduChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateCampaignError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateCampaignErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateCampaignErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateCampaignErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateCampaignErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateCampaignErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateCampaignErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateCampaignErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
...
impl UpdateCampaignError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateCampaignErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateCampaignErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateCampaignErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateCampaignErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateCampaignErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateCampaignErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateEmailChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateEmailChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateEmailTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateEmailTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEmailTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateEndpointError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateEndpointErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateEndpointError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateEndpointErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateEndpointErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateEndpointErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateEndpointErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateEndpointsBatchError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateEndpointsBatchErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateEndpointsBatchErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateGcmChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateGcmChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGcmChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateGcmChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateGcmChannelErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateGcmChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateGcmChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateGcmChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateGcmChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateInAppTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateInAppTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateInAppTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateJourneyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateJourneyErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateJourneyError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateJourneyErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateJourneyErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateJourneyErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateJourneyErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateJourneyErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateJourneyErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateJourneyStateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateJourneyStateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateJourneyStateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdatePushTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdatePushTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdatePushTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateRecommenderConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateRecommenderConfigurationErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRecommenderConfigurationErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            UpdateRecommenderConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            UpdateRecommenderConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateRecommenderConfigurationError {
    /// Creates a new `UpdateRecommenderConfigurationError`.
                    pub fn new(kind: UpdateRecommenderConfigurationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
...
impl std::fmt::Display for UpdateSegmentError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateSegmentErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSegmentErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateSegmentError {
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateSegmentErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateSegmentErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateSegmentErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateSegmentErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateSegmentErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateSegmentErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateSmsChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateSmsChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateSmsChannelError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsChannelErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsChannelErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsChannelErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsChannelErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsChannelErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateSmsTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateSmsTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateSmsTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateSmsTemplateError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsTemplateErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateErrorKind::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsTemplateErrorKind::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateErrorKind::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsTemplateErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsTemplateErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsTemplateErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, UpdateSmsTemplateErrorKind::TooManyRequestsException(_))
    }
}
...
impl std::fmt::Display for UpdateTemplateActiveVersionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateTemplateActiveVersionErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateTemplateActiveVersionErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            UpdateTemplateActiveVersionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateTemplateActiveVersionErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateTemplateActiveVersionErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateTemplateActiveVersionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateVoiceChannelError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateVoiceChannelErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceChannelErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateVoiceTemplateError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateVoiceTemplateErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateVoiceTemplateErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for VerifyOTPMessageError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            VerifyOTPMessageErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::ForbiddenException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::InternalServerErrorException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::MethodNotAllowedException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::PayloadTooLargeException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::TooManyRequestsException(_inner) =>
            _inner.fmt(f)
            ,
            VerifyOTPMessageErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl VerifyOTPMessageError {
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, VerifyOTPMessageErrorKind::BadRequestException(_))
    }
    ...
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(&self.kind, VerifyOTPMessageErrorKind::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageErrorKind::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(&self.kind, VerifyOTPMessageErrorKind::MethodNotAllowedException(_))
    }
    ...
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(&self.kind, VerifyOTPMessageErrorKind::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageErrorKind::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(&self.kind, VerifyOTPMessageErrorKind::TooManyRequestsException(_))
    }
}
