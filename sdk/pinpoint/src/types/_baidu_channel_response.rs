...
impl BaiduChannelResponse {
    /// Creates a new builder-style object to manufacture [`BaiduChannelResponse`](crate::types::BaiduChannelResponse).
    pub fn builder() -> crate::types::builders::BaiduChannelResponseBuilder {
        crate::types::builders::BaiduChannelResponseBuilder::default()
    }
}
...
impl BaiduChannelResponseBuilder {
    /// <p>The unique identifier for the application that the Baidu channel applies to.</p>
