...
pub fn serialize_structure_create_application_request(
...
pub fn serialize_structure_write_campaign_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_8 in var_6 {
            {
                ...
                crate::json_ser::serialize_structure_write_treatment_resource(
                    &mut object_9,
                    item_8,
                );
                object_9.finish();
    ...
    if let Some(var_10) = &input.custom_delivery_configuration {
        ...
        crate::json_ser::serialize_structure_custom_delivery_configuration(&mut object_11, var_10);
        object_11.finish();
    }
    ...
    if let Some(var_13) = &input.hook {
        ...
        crate::json_ser::serialize_structure_campaign_hook(&mut object_14, var_13);
        object_14.finish();
    }
    if input.is_paused {
    ...
    if let Some(var_15) = &input.limits {
        ...
        crate::json_ser::serialize_structure_campaign_limits(&mut object_16, var_15);
        object_16.finish();
    }
    if let Some(var_17) = &input.message_configuration {
        let mut object_18 = object.key("MessageConfiguration").start_object();
        crate::json_ser::serialize_structure_message_configuration(&mut object_18, var_17);
        object_18.finish();
    }
    ...
    if let Some(var_20) = &input.schedule {
        ...
        crate::json_ser::serialize_structure_schedule(&mut object_21, var_20);
        object_21.finish();
    }
    ...
    if let Some(var_27) = &input.template_configuration {
        ...
        crate::json_ser::serialize_structure_template_configuration(&mut object_28, var_27);
        object_28.finish();
    }
...
pub fn serialize_structure_email_template_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_export_job_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_import_job_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_write_journey_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_52, value_53) in var_50 {
            {
                ...
                crate::json_ser::serialize_structure_activity(&mut object_54, value_53);
                object_54.finish();
            }
        }
        object_51.finish();
    ...
    if let Some(var_57) = &input.limits {
        ...
        crate::json_ser::serialize_structure_journey_limits(&mut object_58, var_57);
        object_58.finish();
    }
    if input.local_time {
    ...
    if let Some(var_60) = &input.quiet_time {
        ...
        crate::json_ser::serialize_structure_quiet_time(&mut object_61, var_60);
        object_61.finish();
    }
    ...
    if let Some(var_63) = &input.schedule {
        ...
        crate::json_ser::serialize_structure_journey_schedule(&mut object_64, var_63);
        object_64.finish();
    }
    ...
    if let Some(var_66) = &input.start_condition {
        ...
        crate::json_ser::serialize_structure_start_condition(&mut object_67, var_66);
        object_67.finish();
    }
...
pub fn serialize_structure_push_notification_template_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_69) = &input.adm {
        ...
        crate::json_ser::serialize_structure_android_push_notification_template(
            &mut object_70,
            var_69,
        );
        object_70.finish();
    ...
    if let Some(var_71) = &input.apns {
        ...
        crate::json_ser::serialize_structure_apns_push_notification_template(
            &mut object_72,
            var_71,
        );
        object_72.finish();
    ...
    if let Some(var_75) = &input.default_value {
        ...
        crate::json_ser::serialize_structure_default_push_notification_template(
            &mut object_76,
            var_75,
        );
        object_76.finish();
...
pub fn serialize_structure_create_recommender_configuration_shape(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_write_segment_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_97) = &input.dimensions {
        ...
        crate::json_ser::serialize_structure_segment_dimensions(&mut object_98, var_97);
        object_98.finish();
    }
    ...
    if let Some(var_100) = &input.segment_groups {
        ...
        crate::json_ser::serialize_structure_segment_group_list(&mut object_101, var_100);
        object_101.finish();
    }
...
pub fn serialize_structure_sms_template_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_voice_template_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_number_validate_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_events_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_127, value_128) in var_125 {
            {
                ...
                crate::json_ser::serialize_structure_events_batch(&mut object_129, value_128);
                object_129.finish();
            }
        }
        object_126.finish();
...
pub fn serialize_structure_write_event_stream(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_attributes_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_message_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_137, value_138) in var_135 {
            {
                ...
                crate::json_ser::serialize_structure_address_configuration(
                    &mut object_139,
                    value_138,
                );
                object_139.finish();
        ...
        for (key_146, value_147) in var_144 {
            {
                ...
                crate::json_ser::serialize_structure_endpoint_send_configuration(
                    &mut object_148,
                    value_147,
                );
                object_148.finish();
    ...
    if let Some(var_149) = &input.message_configuration {
        ...
        crate::json_ser::serialize_structure_direct_message_configuration(&mut object_150, var_149);
        object_150.finish();
    }
    if let Some(var_151) = &input.template_configuration {
        let mut object_152 = object.key("TemplateConfiguration").start_object();
        crate::json_ser::serialize_structure_template_configuration(&mut object_152, var_151);
        object_152.finish();
    }
...
pub fn serialize_structure_send_users_message_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_158) = &input.message_configuration {
        ...
        crate::json_ser::serialize_structure_direct_message_configuration(&mut object_159, var_158);
        object_159.finish();
    }
    if let Some(var_160) = &input.template_configuration {
        let mut object_161 = object.key("TemplateConfiguration").start_object();
        crate::json_ser::serialize_structure_template_configuration(&mut object_161, var_160);
        object_161.finish();
    }
...
pub fn serialize_structure_tags_model(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_adm_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_apns_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_apns_sandbox_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_apns_voip_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_apns_voip_sandbox_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_write_application_settings_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_202) = &input.campaign_hook {
        ...
        crate::json_ser::serialize_structure_campaign_hook(&mut object_203, var_202);
        object_203.finish();
    }
    ...
    if let Some(var_204) = &input.limits {
        ...
        crate::json_ser::serialize_structure_campaign_limits(&mut object_205, var_204);
        object_205.finish();
    }
    if let Some(var_206) = &input.quiet_time {
        let mut object_207 = object.key("QuietTime").start_object();
        crate::json_ser::serialize_structure_quiet_time(&mut object_207, var_206);
        object_207.finish();
    }
}

pub fn serialize_structure_baidu_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_email_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_endpoint_request(
    ...
    if let Some(var_222) = &input.demographic {
        ...
        crate::json_ser::serialize_structure_endpoint_demographic(&mut object_223, var_222);
        object_223.finish();
    }
    ...
    if let Some(var_226) = &input.location {
        ...
        crate::json_ser::serialize_structure_endpoint_location(&mut object_227, var_226);
        object_227.finish();
    }
    ...
    if let Some(var_234) = &input.user {
        ...
        crate::json_ser::serialize_structure_endpoint_user(&mut object_235, var_234);
        object_235.finish();
    }
}

pub fn serialize_structure_endpoint_batch_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_238 in var_236 {
            {
                ...
                crate::json_ser::serialize_structure_endpoint_batch_item(&mut object_239, item_238);
                object_239.finish();
            }
        }
        array_237.finish();
...
pub fn serialize_structure_gcm_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_journey_state_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_recommender_configuration_shape(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_sms_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_template_active_version_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_voice_channel_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_write_treatment_resource(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_256) = &input.custom_delivery_configuration {
        ...
        crate::json_ser::serialize_structure_custom_delivery_configuration(
            &mut object_257,
            var_256,
        );
        object_257.finish();
    ...
    if let Some(var_258) = &input.message_configuration {
        ...
        crate::json_ser::serialize_structure_message_configuration(&mut object_259, var_258);
        object_259.finish();
    }
    if let Some(var_260) = &input.schedule {
        let mut object_261 = object.key("Schedule").start_object();
        crate::json_ser::serialize_structure_schedule(&mut object_261, var_260);
        object_261.finish();
    }
    {
    ...
    if let Some(var_262) = &input.template_configuration {
        ...
        crate::json_ser::serialize_structure_template_configuration(&mut object_263, var_262);
        object_263.finish();
    }
...
pub fn serialize_structure_custom_delivery_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_campaign_hook(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_campaign_limits(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_message_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_schedule(
    ...
    if let Some(var_290) = &input.event_filter {
        ...
        crate::json_ser::serialize_structure_campaign_event_filter(&mut object_291, var_290);
        object_291.finish();
    }
    ...
    if let Some(var_293) = &input.quiet_time {
        ...
        crate::json_ser::serialize_structure_quiet_time(&mut object_294, var_293);
        object_294.finish();
    }
...
pub fn serialize_structure_template_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_activity(
    ...
    if let Some(var_310) = &input.email {
        ...
        crate::json_ser::serialize_structure_email_message_activity(&mut object_311, var_310);
        object_311.finish();
    }
    if let Some(var_312) = &input.holdout {
        let mut object_313 = object.key("Holdout").start_object();
        crate::json_ser::serialize_structure_holdout_activity(&mut object_313, var_312);
        object_313.finish();
    }
    if let Some(var_314) = &input.multi_condition {
        let mut object_315 = object.key("MultiCondition").start_object();
        crate::json_ser::serialize_structure_multi_conditional_split_activity(
            &mut object_315,
            var_314,
        );
        object_315.finish();
    ...
    if let Some(var_316) = &input.push {
        ...
        crate::json_ser::serialize_structure_push_message_activity(&mut object_317, var_316);
        object_317.finish();
    }
    if let Some(var_318) = &input.random_split {
        let mut object_319 = object.key("RandomSplit").start_object();
        crate::json_ser::serialize_structure_random_split_activity(&mut object_319, var_318);
        object_319.finish();
    }
    if let Some(var_320) = &input.sms {
        let mut object_321 = object.key("SMS").start_object();
        crate::json_ser::serialize_structure_sms_message_activity(&mut object_321, var_320);
        object_321.finish();
    }
    if let Some(var_322) = &input.wait {
        let mut object_323 = object.key("Wait").start_object();
        crate::json_ser::serialize_structure_wait_activity(&mut object_323, var_322);
        object_323.finish();
    }
}

pub fn serialize_structure_journey_limits(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_quiet_time(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_journey_schedule(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_condition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_331) = &input.event_start_condition {
        ...
        crate::json_ser::serialize_structure_event_start_condition(&mut object_332, var_331);
        object_332.finish();
    }
    if let Some(var_333) = &input.segment_start_condition {
        let mut object_334 = object.key("SegmentStartCondition").start_object();
        crate::json_ser::serialize_structure_segment_condition(&mut object_334, var_333);
        object_334.finish();
    }
}

pub fn serialize_structure_android_push_notification_template(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_apns_push_notification_template(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_default_push_notification_template(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_segment_dimensions(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_358, value_359) in var_356 {
            {
                ...
                crate::json_ser::serialize_structure_attribute_dimension(
                    &mut object_360,
                    value_359,
                );
                object_360.finish();
    ...
    if let Some(var_361) = &input.behavior {
        ...
        crate::json_ser::serialize_structure_segment_behaviors(&mut object_362, var_361);
        object_362.finish();
    }
    if let Some(var_363) = &input.demographic {
        let mut object_364 = object.key("Demographic").start_object();
        crate::json_ser::serialize_structure_segment_demographics(&mut object_364, var_363);
        object_364.finish();
    }
    if let Some(var_365) = &input.location {
        let mut object_366 = object.key("Location").start_object();
        crate::json_ser::serialize_structure_segment_location(&mut object_366, var_365);
        object_366.finish();
    }
        ...
        for (key_369, value_370) in var_367 {
            {
                ...
                crate::json_ser::serialize_structure_metric_dimension(&mut object_371, value_370);
                object_371.finish();
            }
        }
        object_368.finish();
...
pub fn serialize_structure_segment_group_list(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_379 in var_377 {
            {
                ...
                crate::json_ser::serialize_structure_segment_group(&mut object_380, item_379);
                object_380.finish();
            }
        }
        array_378.finish();
        ...
        for (key_386, value_387) in var_384 {
            {
                ...
                crate::json_ser::serialize_structure_event(&mut object_388, value_387);
                object_388.finish();
            }
        }
        object_385.finish();
...
pub fn serialize_structure_address_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_endpoint_send_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_direct_message_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_424) = &input.default_push_notification_message {
        ...
        crate::json_ser::serialize_structure_default_push_notification_message(
            &mut object_425,
            var_424,
        );
        object_425.finish();
    ...
    if let Some(var_426) = &input.email_message {
        ...
        crate::json_ser::serialize_structure_email_message(&mut object_427, var_426);
        object_427.finish();
    }
    if let Some(var_428) = &input.gcm_message {
        let mut object_429 = object.key("GCMMessage").start_object();
        crate::json_ser::serialize_structure_gcm_message(&mut object_429, var_428);
        object_429.finish();
    }
    if let Some(var_430) = &input.sms_message {
        let mut object_431 = object.key("SMSMessage").start_object();
        crate::json_ser::serialize_structure_sms_message(&mut object_431, var_430);
        object_431.finish();
    }
    if let Some(var_432) = &input.voice_message {
        let mut object_433 = object.key("VoiceMessage").start_object();
        crate::json_ser::serialize_structure_voice_message(&mut object_433, var_432);
        object_433.finish();
    }
}

pub fn serialize_structure_endpoint_demographic(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_endpoint_location(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_endpoint_user(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_endpoint_batch_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_461) = &input.demographic {
        ...
        crate::json_ser::serialize_structure_endpoint_demographic(&mut object_462, var_461);
        object_462.finish();
    }
    ...
    if let Some(var_466) = &input.location {
        ...
        crate::json_ser::serialize_structure_endpoint_location(&mut object_467, var_466);
        object_467.finish();
    }
    ...
    if let Some(var_474) = &input.user {
        ...
        crate::json_ser::serialize_structure_endpoint_user(&mut object_475, var_474);
        object_475.finish();
    }
}
...
pub fn serialize_structure_campaign_custom_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_campaign_email_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_campaign_sms_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_campaign_event_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_497) = &input.dimensions {
        ...
        crate::json_ser::serialize_structure_event_dimensions(&mut object_498, var_497);
        object_498.finish();
    }
...
pub fn serialize_structure_custom_message_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_506) = &input.message_config {
        ...
        crate::json_ser::serialize_structure_journey_custom_message(&mut object_507, var_506);
        object_507.finish();
    }
...
pub fn serialize_structure_conditional_split_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_511) = &input.condition {
        ...
        crate::json_ser::serialize_structure_condition(&mut object_512, var_511);
        object_512.finish();
    }
    if let Some(var_513) = &input.evaluation_wait_time {
        let mut object_514 = object.key("EvaluationWaitTime").start_object();
        crate::json_ser::serialize_structure_wait_time(&mut object_514, var_513);
        object_514.finish();
    }
...
pub fn serialize_structure_email_message_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_517) = &input.message_config {
        ...
        crate::json_ser::serialize_structure_journey_email_message(&mut object_518, var_517);
        object_518.finish();
    }
...
pub fn serialize_structure_holdout_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_multi_conditional_split_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_525 in var_523 {
            {
                ...
                crate::json_ser::serialize_structure_multi_conditional_branch(
                    &mut object_526,
                    item_525,
                );
                object_526.finish();
    ...
    if let Some(var_528) = &input.evaluation_wait_time {
        ...
        crate::json_ser::serialize_structure_wait_time(&mut object_529, var_528);
        object_529.finish();
    }
}

pub fn serialize_structure_push_message_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_530) = &input.message_config {
        ...
        crate::json_ser::serialize_structure_journey_push_message(&mut object_531, var_530);
        object_531.finish();
    }
...
pub fn serialize_structure_random_split_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_537 in var_535 {
            {
                ...
                crate::json_ser::serialize_structure_random_split_entry(&mut object_538, item_537);
                object_538.finish();
            }
        }
        array_536.finish();
...
pub fn serialize_structure_sms_message_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_539) = &input.message_config {
        ...
        crate::json_ser::serialize_structure_journey_sms_message(&mut object_540, var_539);
        object_540.finish();
    }
...
pub fn serialize_structure_wait_activity(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_545) = &input.wait_time {
        ...
        crate::json_ser::serialize_structure_wait_time(&mut object_546, var_545);
        object_546.finish();
    }
}

pub fn serialize_structure_event_start_condition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_547) = &input.event_filter {
        ...
        crate::json_ser::serialize_structure_event_filter(&mut object_548, var_547);
        object_548.finish();
    }
...
pub fn serialize_structure_segment_condition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_attribute_dimension(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_segment_behaviors(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SegmentBehaviors,
) {
    if let Some(var_555) = &input.recency {
        let mut object_556 = object.key("Recency").start_object();
        crate::json_ser::serialize_structure_recency_dimension(&mut object_556, var_555);
        object_556.finish();
    }
}

pub fn serialize_structure_segment_demographics(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_557) = &input.app_version {
        ...
        crate::json_ser::serialize_structure_set_dimension(&mut object_558, var_557);
        object_558.finish();
    }
    if let Some(var_559) = &input.channel {
        let mut object_560 = object.key("Channel").start_object();
        crate::json_ser::serialize_structure_set_dimension(&mut object_560, var_559);
        object_560.finish();
    }
    if let Some(var_561) = &input.device_type {
        let mut object_562 = object.key("DeviceType").start_object();
        crate::json_ser::serialize_structure_set_dimension(&mut object_562, var_561);
        object_562.finish();
    }
    if let Some(var_563) = &input.make {
        let mut object_564 = object.key("Make").start_object();
        crate::json_ser::serialize_structure_set_dimension(&mut object_564, var_563);
        object_564.finish();
    }
    if let Some(var_565) = &input.model {
        let mut object_566 = object.key("Model").start_object();
        crate::json_ser::serialize_structure_set_dimension(&mut object_566, var_565);
        object_566.finish();
    }
    if let Some(var_567) = &input.platform {
        let mut object_568 = object.key("Platform").start_object();
        crate::json_ser::serialize_structure_set_dimension(&mut object_568, var_567);
        object_568.finish();
    }
}

pub fn serialize_structure_segment_location(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SegmentLocation,
) {
    if let Some(var_569) = &input.country {
        let mut object_570 = object.key("Country").start_object();
        crate::json_ser::serialize_structure_set_dimension(&mut object_570, var_569);
        object_570.finish();
    }
    if let Some(var_571) = &input.gps_point {
        let mut object_572 = object.key("GPSPoint").start_object();
        crate::json_ser::serialize_structure_gps_point_dimension(&mut object_572, var_571);
        object_572.finish();
    }
}
...
pub fn serialize_structure_segment_group(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_576 in var_574 {
            {
                ...
                crate::json_ser::serialize_structure_segment_dimensions(&mut object_577, item_576);
                object_577.finish();
            }
        }
        array_575.finish();
        ...
        for item_580 in var_578 {
            {
                ...
                crate::json_ser::serialize_structure_segment_reference(&mut object_581, item_580);
                object_581.finish();
            }
        }
        array_579.finish();
...
pub fn serialize_structure_public_endpoint(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_592) = &input.demographic {
        ...
        crate::json_ser::serialize_structure_endpoint_demographic(&mut object_593, var_592);
        object_593.finish();
    }
    ...
    if let Some(var_596) = &input.location {
        ...
        crate::json_ser::serialize_structure_endpoint_location(&mut object_597, var_596);
        object_597.finish();
    }
    ...
    if let Some(var_604) = &input.user {
        ...
        crate::json_ser::serialize_structure_endpoint_user(&mut object_605, var_604);
        object_605.finish();
    }
}
...
pub fn serialize_structure_event(
    ...
    if let Some(var_620) = &input.session {
        ...
        crate::json_ser::serialize_structure_session(&mut object_621, var_620);
        object_621.finish();
    }
...
pub fn serialize_structure_adm_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_apns_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_baidu_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_default_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_default_push_notification_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_email_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_713) = &input.raw_email {
        ...
        crate::json_ser::serialize_structure_raw_email(&mut object_714, var_713);
        object_714.finish();
    }
    ...
    if let Some(var_718) = &input.simple_email {
        ...
        crate::json_ser::serialize_structure_simple_email(&mut object_719, var_718);
        object_719.finish();
    }
...
pub fn serialize_structure_gcm_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_sms_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_voice_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_event_dimensions(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_778) = &input.event_type {
        ...
        crate::json_ser::serialize_structure_set_dimension(&mut object_779, var_778);
        object_779.finish();
    }
        ...
        for (key_782, value_783) in var_780 {
            {
                ...
                crate::json_ser::serialize_structure_metric_dimension(&mut object_784, value_783);
                object_784.finish();
            }
        }
        object_781.finish();
...
pub fn serialize_structure_journey_custom_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_788 in var_786 {
            {
                ...
                crate::json_ser::serialize_structure_simple_condition(&mut object_789, item_788);
                object_789.finish();
            }
        }
        array_787.finish();
...
pub fn serialize_structure_wait_time(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_journey_email_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_multi_conditional_branch(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_794) = &input.condition {
        ...
        crate::json_ser::serialize_structure_simple_condition(&mut object_795, var_794);
        object_795.finish();
    }
...
pub fn serialize_structure_journey_push_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_random_split_entry(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_journey_sms_message(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_event_filter(
    ...
    if let Some(var_804) = &input.dimensions {
        ...
        crate::json_ser::serialize_structure_event_dimensions(&mut object_805, var_804);
        object_805.finish();
    }
...
pub fn serialize_structure_recency_dimension(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_set_dimension(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_gps_point_dimension(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_813) = &input.coordinates {
        ...
        crate::json_ser::serialize_structure_gps_coordinates(&mut object_814, var_813);
        object_814.finish();
    }
...
pub fn serialize_structure_segment_reference(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_session(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_raw_email(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_simple_email(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SimpleEmail,
) {
    if let Some(var_820) = &input.html_part {
        let mut object_821 = object.key("HtmlPart").start_object();
        crate::json_ser::serialize_structure_simple_email_part(&mut object_821, var_820);
        object_821.finish();
    }
    if let Some(var_822) = &input.subject {
        let mut object_823 = object.key("Subject").start_object();
        crate::json_ser::serialize_structure_simple_email_part(&mut object_823, var_822);
        object_823.finish();
    }
    if let Some(var_824) = &input.text_part {
        let mut object_825 = object.key("TextPart").start_object();
        crate::json_ser::serialize_structure_simple_email_part(&mut object_825, var_824);
        object_825.finish();
    }
}

pub fn serialize_structure_simple_condition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_826) = &input.event_condition {
        ...
        crate::json_ser::serialize_structure_event_condition(&mut object_827, var_826);
        object_827.finish();
    }
    if let Some(var_828) = &input.segment_condition {
        let mut object_829 = object.key("SegmentCondition").start_object();
        crate::json_ser::serialize_structure_segment_condition(&mut object_829, var_828);
        object_829.finish();
    }
    if let Some(var_830) = &input.segment_dimensions {
        let mut object_831 = object.key("segmentDimensions").start_object();
        crate::json_ser::serialize_structure_segment_dimensions(&mut object_831, var_830);
        object_831.finish();
    }
}

pub fn serialize_structure_gps_coordinates(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_simple_email_part(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_event_condition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_834) = &input.dimensions {
        ...
        crate::json_ser::serialize_structure_event_dimensions(&mut object_835, var_834);
        object_835.finish();
    }
