...
if (region) == ("us-east-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://pinpoint.us-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-west-2") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://pinpoint.us-west-2.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-gov-west-1") {
                                return Ok(aws_smithy_types::endpoint::Endpoint::builder().url("https://pinpoint.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
