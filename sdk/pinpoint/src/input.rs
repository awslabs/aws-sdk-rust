...
impl DeleteEmailTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_1) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_1));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl DeletePushTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_2) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_2));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl DeleteSmsTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_3) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_3));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl DeleteVoiceTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_4) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_4));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetApplicationDateRangeKpiInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_5) = &self.end_time {
            query.push_kv(
                "end-time",
        ...
        if let Some(inner_6) = &self.next_token {
            query.push_kv("next-token", &smithy_http::query::fmt_string(&inner_6));
        }
        if let Some(inner_7) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_7));
        }
        if let Some(inner_8) = &self.start_time {
            query.push_kv(
                "start-time",
                &smithy_http::query::fmt_timestamp(
                    inner_8,
...
impl GetAppsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_9) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_9));
        }
        if let Some(inner_10) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_10));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetCampaignActivitiesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_11) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_11));
        }
        if let Some(inner_12) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_12));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetCampaignDateRangeKpiInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_15) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_15));
        }
        if let Some(inner_16) = &self.start_time {
            query.push_kv(
                "start-time",
                &smithy_http::query::fmt_timestamp(
                    inner_16,
...
impl GetCampaignsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_17) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_17));
        }
        if let Some(inner_18) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_18));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetCampaignVersionsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_19) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_19));
        }
        if let Some(inner_20) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_20));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetExportJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_22) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_22));
        }
        if let Some(inner_23) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_23));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetImportJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_24) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_24));
        }
        if let Some(inner_25) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_25));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetJourneyDateRangeKpiInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_26) = &self.end_time {
            query.push_kv(
                "end-time",
                &smithy_http::query::fmt_timestamp(
                    inner_26,
        ...
        if let Some(inner_28) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_28));
        }
        if let Some(inner_29) = &self.start_time {
            query.push_kv(
                "start-time",
                &smithy_http::query::fmt_timestamp(
                    inner_29,
...
impl GetJourneyExecutionActivityMetricsInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let journey_activity_id = {
            let input = &self.journey_activity_id;
            let input = input
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_31) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_31));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetJourneyExecutionMetricsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_33) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_33));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetPushTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_34) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_34));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetRecommenderConfigurationsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_35) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_35));
        }
        if let Some(inner_36) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_36));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetSegmentExportJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_37) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_37));
        }
        if let Some(inner_38) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_38));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetSegmentImportJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_39) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_39));
        }
        if let Some(inner_40) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_40));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetSegmentsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_41) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_41));
        }
        if let Some(inner_42) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_42));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetSegmentVersionsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_43) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_43));
        }
        if let Some(inner_44) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_44));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetSmsTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_45) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_45));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetVoiceTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_46) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_46));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListJourneysInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_47) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_47));
        }
        if let Some(inner_48) = &self.token {
            query.push_kv("token", &smithy_http::query::fmt_string(&inner_48));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListTemplatesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_49) = &self.next_token {
            query.push_kv("next-token", &smithy_http::query::fmt_string(&inner_49));
        }
        if let Some(inner_50) = &self.page_size {
            query.push_kv("page-size", &smithy_http::query::fmt_string(&inner_50));
        }
        if let Some(inner_51) = &self.prefix {
            query.push_kv("prefix", &smithy_http::query::fmt_string(&inner_51));
        }
        if let Some(inner_52) = &self.template_type {
            query.push_kv("template-type", &smithy_http::query::fmt_string(&inner_52));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListTemplateVersionsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_53) = &self.next_token {
            query.push_kv("next-token", &smithy_http::query::fmt_string(&inner_53));
        }
...
impl UpdateEmailTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if self.create_new_version {
            query.push_kv(
                "create-new-version",
                &smithy_http::query::fmt_default(&&self.create_new_version),
            );
        }
        if let Some(inner_57) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_57));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl UpdatePushTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_58) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_58));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl UpdateSmsTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_59) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_59));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl UpdateVoiceTemplateInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_60) = &self.version {
            query.push_kv("version", &smithy_http::query::fmt_string(&inner_60));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
