...
#[derive(Debug)]
    ...
    ::std::write!(output, "/v1/apps/{ApplicationId}/endpoints/{EndpointId}", ApplicationId = application_id, EndpointId = endpoint_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_endpoint_input::ser_endpoint_request_http_payload(& input.endpoint_request)?);
