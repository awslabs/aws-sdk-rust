...
impl GetPushTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetPushTemplate`](crate::operation::get_push_template::GetPushTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_push_template::GetPushTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_push_template::GetPushTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/templates/{TemplateName}/push", TemplateName = template_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_push_template::GetPushTemplateInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
...
/// `ParseStrictResponse` impl for `GetPushTemplate`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetPushTemplate {
                type Output = std::result::Result<crate::operation::get_push_template::GetPushTemplateOutput, crate::operation::get_push_template::GetPushTemplateError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_push_template::de_get_push_template_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_push_template::de_get_push_template_http_response(response)
                     }
                }
            }
