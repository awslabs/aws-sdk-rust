...
impl GetEmailChannelFluentBuilder  {
    /// Creates a new `GetEmailChannel`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_email_channel::GetEmailChannelOutput, aws_smithy_http::result::SdkError<crate::operation::get_email_channel::GetEmailChannelError>>
                     {
