...
impl CreateEmailTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreateEmailTemplate`](crate::operation::create_email_template::CreateEmailTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_email_template::CreateEmailTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_email_template::CreateEmailTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_email_template::CreateEmailTemplate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateEmailTemplate", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateEmailTemplate {
                type Output = std::result::Result<crate::operation::create_email_template::CreateEmailTemplateOutput, crate::operation::create_email_template::CreateEmailTemplateError>;
