    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_apns_voip_channel::UpdateApnsVoipChannelError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_apns_voip_channel::UpdateApnsVoipChannelOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateApnsVoipChannelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateApnsVoipChannelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_apns_voip_channel::UpdateApnsVoipChannelInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateApnsVoipChannelEndpointParamsInterceptor {
...
pub type UpdateApnsVoipChannelErrorKind = UpdateApnsVoipChannelError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateApnsVoipChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_apns_voip_channel::UpdateApnsVoipChannelError {
...
impl UpdateApnsVoipChannelError {
    ...
    /// Creates the `UpdateApnsVoipChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
