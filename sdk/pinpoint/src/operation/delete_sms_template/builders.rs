...
impl DeleteSmsTemplateFluentBuilder  {
    /// Creates a new `DeleteSmsTemplate`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_sms_template::DeleteSmsTemplateOutput, aws_smithy_http::result::SdkError<crate::operation::delete_sms_template::DeleteSmsTemplateError>>
                     {
