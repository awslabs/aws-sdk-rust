...
impl UpdateEmailChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_email_channel::UpdateEmailChannel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEmailChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_email_channel::de_update_email_channel_http_response_with_props(status, headers, body)
        }
    }
}
