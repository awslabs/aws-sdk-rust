...
impl UpdateEmailChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateEmailChannel`](crate::operation::update_email_channel::UpdateEmailChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_email_channel::UpdateEmailChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_email_channel::UpdateEmailChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_email_channel::UpdateEmailChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateEmailChannel", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateEmailChannel`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateEmailChannel {
                type Output = std::result::Result<crate::operation::update_email_channel::UpdateEmailChannelOutput, crate::operation::update_email_channel::UpdateEmailChannelError>;
