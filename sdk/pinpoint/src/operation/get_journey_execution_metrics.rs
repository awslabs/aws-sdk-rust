...
impl GetJourneyExecutionMetricsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetrics,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetrics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJourneyExecutionMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_journey_execution_metrics::de_get_journey_execution_metrics_http_response_with_props(
                status, headers, body,
            )
        }
    }
