    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetricsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetricsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetJourneyExecutionMetricsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetJourneyExecutionMetricsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetricsInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("journey_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetJourneyExecutionMetricsEndpointParamsInterceptor {
...
pub type GetJourneyExecutionMetricsErrorKind = GetJourneyExecutionMetricsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetJourneyExecutionMetricsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetricsError {
...
impl GetJourneyExecutionMetricsError {
    ...
    /// Creates the `GetJourneyExecutionMetricsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
