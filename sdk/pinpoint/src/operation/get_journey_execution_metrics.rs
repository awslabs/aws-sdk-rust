...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJourneyExecutionMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_journey_execution_metrics::de_get_journey_execution_metrics_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetricsError
{
