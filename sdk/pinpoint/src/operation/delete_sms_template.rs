...
impl DeleteSmsTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_sms_template::DeleteSmsTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSmsTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_sms_template::de_delete_sms_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_sms_template::DeleteSmsTemplateError
{
