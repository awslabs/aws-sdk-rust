...
impl GetUserEndpointsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_user_endpoints::GetUserEndpoints::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUserEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_user_endpoints::de_get_user_endpoints_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_user_endpoints::GetUserEndpointsError
{
