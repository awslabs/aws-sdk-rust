...
impl GetApnsVoipSandboxChannelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_apns_voip_sandbox_channel::GetApnsVoipSandboxChannelInput, ::aws_smithy_types::error::operation::BuildError> {
