...
impl UpdateSmsChannelInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_sms_channel::UpdateSmsChannel::new(),
        )
...
/// `ParseStrictResponse` impl for `UpdateSmsChannel`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSmsChannel {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_sms_channel::de_update_sms_channel_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_update_sms_channel::de_update_sms_channel_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::update_sms_channel::UpdateSmsChannelError
{
