...
impl GetJourneyRunsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_journey_runs::GetJourneyRuns::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetJourneyRuns {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_journey_runs::de_get_journey_runs_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_journey_runs::de_get_journey_runs_http_response(
                status, headers, body,
            )
        }
    }
