...
impl RemoveAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_attributes::RemoveAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_attributes::RemoveAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_attributes::RemoveAttributesOutput, crate::operation::remove_attributes::RemoveAttributesError, Self> {
