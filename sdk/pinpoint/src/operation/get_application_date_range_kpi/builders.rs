...
impl crate::operation::get_application_date_range_kpi::builders::GetApplicationDateRangeKpiInputBuilder {
...
impl GetApplicationDateRangeKpiFluentBuilder {
    /// Creates a new `GetApplicationDateRangeKpiFluentBuilder`.
