...
pub use crate::operation::get_application_date_range_kpi::_get_application_date_range_kpi_output::GetApplicationDateRangeKpiOutputBuilder;

pub use crate::operation::get_application_date_range_kpi::_get_application_date_range_kpi_input::GetApplicationDateRangeKpiInputBuilder;
...
impl GetApplicationDateRangeKpiInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.get_application_date_range_kpi();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiOutput,
                    crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError,
                > for GetApplicationDateRangeKpiFluentBuilder
            {
                fn send(
                    self,
...
impl GetApplicationDateRangeKpiFluentBuilder {
    ...
    /// Access the GetApplicationDateRangeKpi as a reference.
    pub fn as_input(&self) -> &crate::operation::get_application_date_range_kpi::builders::GetApplicationDateRangeKpiInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpi::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpi::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiOutput, crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError, Self> {
