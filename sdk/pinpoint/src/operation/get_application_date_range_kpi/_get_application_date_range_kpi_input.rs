...
impl GetApplicationDateRangeKpiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput, ::aws_smithy_types::error::operation::BuildError> {
