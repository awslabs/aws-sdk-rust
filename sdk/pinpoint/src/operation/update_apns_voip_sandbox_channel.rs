...
impl UpdateApnsVoipSandboxChannelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApnsVoipSandboxChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_apns_voip_sandbox_channel::de_update_apns_voip_sandbox_channel_http_response_with_props(
                status, headers, body,
            )
        }
    }
