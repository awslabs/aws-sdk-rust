...
impl GetJourneyRunExecutionMetricsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_journey_run_execution_metrics::GetJourneyRunExecutionMetricsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
