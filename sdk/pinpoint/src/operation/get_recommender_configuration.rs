    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_recommender_configuration::GetRecommenderConfigurationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_recommender_configuration::GetRecommenderConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRecommenderConfiguration {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRecommenderConfiguration")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetRecommenderConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetRecommenderConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_recommender_configuration::GetRecommenderConfigurationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetRecommenderConfigurationEndpointParamsInterceptor {
...
pub type GetRecommenderConfigurationErrorKind = GetRecommenderConfigurationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_recommender_configuration::GetRecommenderConfigurationError {
...
impl GetRecommenderConfigurationError {
    ...
    /// Creates the `GetRecommenderConfigurationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
