...
impl VerifyOTPMessage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::verify_otp_message::VerifyOtpMessageInput,
                    ) -> ::std::result::Result<crate::operation::verify_otp_message::VerifyOtpMessageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::verify_otp_message::VerifyOTPMessageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::verify_otp_message::VerifyOTPMessageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::verify_otp_message::VerifyOtpMessageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for VerifyOTPMessage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("VerifyOTPMessage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(VerifyOTPMessageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(VerifyOTPMessageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("VerifyOTPMessage")
...
.with_interceptor(VerifyOTPMessageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::verify_otp_message::VerifyOTPMessageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::verify_otp_message::VerifyOTPMessageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::verify_otp_message::VerifyOTPMessageError>::new());
...
#[derive(Debug)]
            struct VerifyOTPMessageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for VerifyOTPMessageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_verify_otp_message::de_verify_otp_message_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct VerifyOTPMessageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for VerifyOTPMessageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::verify_otp_message::VerifyOtpMessageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::verify_otp_message::VerifyOtpMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v1/apps/{ApplicationId}/verify-otp", ApplicationId = application_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_verify_otp_message_input::ser_verify_otp_message_request_parameters_http_payload(& input.verify_otp_message_request_parameters)?);
...
#[derive(Debug)]
            struct VerifyOTPMessageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for VerifyOTPMessageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "VerifyOTPMessageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<VerifyOtpMessageInput>()
                        .ok_or("failed to downcast to VerifyOtpMessageInput")?;
...
/// Error type for the `VerifyOTPMessageError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum VerifyOTPMessageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-VerifyOTPMessageError) for what information is available for the error.")]
...
impl VerifyOTPMessageError {
    /// Creates the `VerifyOTPMessageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `VerifyOTPMessageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `VerifyOTPMessageError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `VerifyOTPMessageError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for VerifyOTPMessageError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for VerifyOTPMessageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::verify_otp_message::VerifyOTPMessageError {
...
mod _verify_otp_message_output;
