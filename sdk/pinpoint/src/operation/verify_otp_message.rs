...
impl VerifyOtpMessageInput {
    /// Consumes the builder and constructs an Operation<[`VerifyOTPMessage`](crate::operation::verify_otp_message::VerifyOTPMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::verify_otp_message::VerifyOTPMessage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_otp_message::VerifyOtpMessageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/verify-otp", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::verify_otp_message::VerifyOTPMessage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("VerifyOTPMessage", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for VerifyOTPMessage {
                type Output = std::result::Result<crate::operation::verify_otp_message::VerifyOtpMessageOutput, crate::operation::verify_otp_message::VerifyOTPMessageError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_verify_otp_message::de_verify_otp_message_http_error(response)
                     } else {
                        crate::protocol_serde::shape_verify_otp_message::de_verify_otp_message_http_response(response)
                     }
                }
            }
