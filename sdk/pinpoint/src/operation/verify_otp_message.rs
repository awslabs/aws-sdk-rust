...
impl VerifyOtpMessageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::verify_otp_message::VerifyOTPMessage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifyOTPMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_verify_otp_message::de_verify_otp_message_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::verify_otp_message::VerifyOTPMessageError
{
