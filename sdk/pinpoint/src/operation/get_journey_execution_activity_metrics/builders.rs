...
impl crate::operation::get_journey_execution_activity_metrics::builders::GetJourneyExecutionActivityMetricsInputBuilder {
...
impl GetJourneyExecutionActivityMetricsFluentBuilder {
    /// Creates a new `GetJourneyExecutionActivityMetricsFluentBuilder`.
