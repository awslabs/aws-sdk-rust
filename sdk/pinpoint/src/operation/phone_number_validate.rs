...
/// Orchestration and serialization glue logic for `PhoneNumberValidate`.
...
impl PhoneNumberValidate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::phone_number_validate::PhoneNumberValidateInput,
                    ) -> ::std::result::Result<crate::operation::phone_number_validate::PhoneNumberValidateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::phone_number_validate::PhoneNumberValidateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::phone_number_validate::PhoneNumberValidateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::phone_number_validate::PhoneNumberValidateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PhoneNumberValidate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PhoneNumberValidate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PhoneNumberValidateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PhoneNumberValidateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PhoneNumberValidate")
...
.with_interceptor(PhoneNumberValidateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::phone_number_validate::PhoneNumberValidateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::phone_number_validate::PhoneNumberValidateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::phone_number_validate::PhoneNumberValidateError>::new());
...
#[derive(Debug)]
            struct PhoneNumberValidateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PhoneNumberValidateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_phone_number_validate::de_phone_number_validate_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_phone_number_validate::de_phone_number_validate_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PhoneNumberValidateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PhoneNumberValidateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::phone_number_validate::PhoneNumberValidateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::phone_number_validate::PhoneNumberValidateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/phone/number/validate").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_phone_number_validate_input::ser_number_validate_request_http_payload(& input.number_validate_request)?);
...
#[derive(Debug)]
            struct PhoneNumberValidateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PhoneNumberValidateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PhoneNumberValidateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PhoneNumberValidateInput>()
                        .ok_or("failed to downcast to PhoneNumberValidateInput")?;
...
/// Error type for the `PhoneNumberValidateError` operation.
#[non_exhaustive]
...
pub enum PhoneNumberValidateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PhoneNumberValidateError) for what information is available for the error.")]
...
impl PhoneNumberValidateError {
    /// Creates the `PhoneNumberValidateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PhoneNumberValidateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `PhoneNumberValidateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `PhoneNumberValidateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `PhoneNumberValidateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `PhoneNumberValidateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `PhoneNumberValidateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `PhoneNumberValidateError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `PhoneNumberValidateError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PhoneNumberValidateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PhoneNumberValidateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::phone_number_validate::PhoneNumberValidateError {
...
mod _phone_number_validate_output;
