    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::phone_number_validate::PhoneNumberValidateError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::phone_number_validate::PhoneNumberValidateOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PhoneNumberValidate")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(PhoneNumberValidateEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PhoneNumberValidateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PhoneNumberValidateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::phone_number_validate::PhoneNumberValidateInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PhoneNumberValidateEndpointParamsInterceptor {
...
pub type PhoneNumberValidateErrorKind = PhoneNumberValidateError;
...
impl ::aws_http::request_id::RequestId for crate::operation::phone_number_validate::PhoneNumberValidateError {
...
impl PhoneNumberValidateError {
    ...
    /// Creates the `PhoneNumberValidateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
