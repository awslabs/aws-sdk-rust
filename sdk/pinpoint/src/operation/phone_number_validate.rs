    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/phone/number/validate")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::phone_number_validate::PhoneNumberValidate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PhoneNumberValidate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_phone_number_validate::de_phone_number_validate_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::phone_number_validate::PhoneNumberValidateError
{
