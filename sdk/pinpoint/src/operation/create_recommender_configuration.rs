...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRecommenderConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_recommender_configuration::de_create_recommender_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateRecommenderConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_recommender_configuration::CreateRecommenderConfigurationError
{
