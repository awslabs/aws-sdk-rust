...
impl UpdateInAppTemplateFluentBuilder  {
    /// Creates a new `UpdateInAppTemplate`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_in_app_template::UpdateInAppTemplateOutput, aws_smithy_http::result::SdkError<crate::operation::update_in_app_template::UpdateInAppTemplateError>>
                     {
