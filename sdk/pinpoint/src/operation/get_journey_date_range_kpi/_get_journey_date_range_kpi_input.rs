...
impl GetJourneyDateRangeKpiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_journey_date_range_kpi::GetJourneyDateRangeKpiInput, ::aws_smithy_types::error::operation::BuildError> {
