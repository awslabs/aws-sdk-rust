...
impl GetBaiduChannelFluentBuilder  {
    /// Creates a new `GetBaiduChannel`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_baidu_channel::GetBaiduChannelOutput, aws_smithy_http::result::SdkError<crate::operation::get_baidu_channel::GetBaiduChannelError>>
                     {
