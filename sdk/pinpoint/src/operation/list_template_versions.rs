...
pub type ListTemplateVersionsErrorKind = ListTemplateVersionsError;
...
impl ListTemplateVersionsError {
    ...
    /// Creates the `ListTemplateVersionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
