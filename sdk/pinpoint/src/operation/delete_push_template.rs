...
impl DeletePushTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_push_template::DeletePushTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePushTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_push_template::de_delete_push_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_push_template::DeletePushTemplateError
{
