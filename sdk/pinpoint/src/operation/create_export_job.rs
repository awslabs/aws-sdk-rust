...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_export_job_input::ser_export_job_request_http_payload(& input.export_job_request)?);
