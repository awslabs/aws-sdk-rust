...
pub type GetSegmentExportJobsErrorKind = GetSegmentExportJobsError;
...
impl GetSegmentExportJobsError {
    ...
    /// Creates the `GetSegmentExportJobsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
