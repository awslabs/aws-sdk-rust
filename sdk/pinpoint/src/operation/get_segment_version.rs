...
impl GetSegmentVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_segment_version::GetSegmentVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSegmentVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_segment_version::de_get_segment_version_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_segment_version::GetSegmentVersionError
{
