...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_app_input::ser_create_application_request_http_payload(& input.create_application_request)?);
