...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApplicationDateRangeKpi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_application_date_range_kpi::de_get_application_date_range_kpi_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError
{
