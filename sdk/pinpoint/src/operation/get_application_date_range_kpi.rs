...
impl GetApplicationDateRangeKpiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpi,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApplicationDateRangeKpi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_application_date_range_kpi::de_get_application_date_range_kpi_http_response_with_props(
                status, headers, body,
            )
        }
    }
