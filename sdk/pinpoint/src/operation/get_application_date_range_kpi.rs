...
/// Orchestration and serialization glue logic for `GetApplicationDateRangeKpi`.
...
impl GetApplicationDateRangeKpi {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput,
                    ) -> ::std::result::Result<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetApplicationDateRangeKpi {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetApplicationDateRangeKpi");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetApplicationDateRangeKpiRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetApplicationDateRangeKpiResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetApplicationDateRangeKpi")
...
.with_interceptor(GetApplicationDateRangeKpiEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_application_date_range_kpi::de_get_application_date_range_kpi_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetApplicationDateRangeKpiRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.kpi_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("kpi_name", "cannot be empty or unset"))?;
    let kpi_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    ...
    ::std::write!(output, "/v1/apps/{ApplicationId}/kpis/daterange/{KpiName}", ApplicationId = application_id, KpiName = kpi_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_3) = &_input.end_time {
         {
            query.push_kv("end-time", &::aws_smithy_http::query::fmt_timestamp(inner_3, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    ...
    if let ::std::option::Option::Some(inner_6) = &_input.start_time {
         {
            query.push_kv("start-time", &::aws_smithy_http::query::fmt_timestamp(inner_6, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    ::std::result::Result::Ok(())
}
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetApplicationDateRangeKpiEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetApplicationDateRangeKpiInput>()
                        .ok_or("failed to downcast to GetApplicationDateRangeKpiInput")?;
...
/// Error type for the `GetApplicationDateRangeKpiError` operation.
#[non_exhaustive]
...
pub enum GetApplicationDateRangeKpiError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetApplicationDateRangeKpiError) for what information is available for the error.")]
...
impl GetApplicationDateRangeKpiError {
    /// Creates the `GetApplicationDateRangeKpiError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetApplicationDateRangeKpiError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetApplicationDateRangeKpiError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetApplicationDateRangeKpiError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetApplicationDateRangeKpiError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError {
...
mod _get_application_date_range_kpi_output;
