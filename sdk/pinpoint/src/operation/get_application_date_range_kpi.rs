...
impl GetApplicationDateRangeKpi {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetApplicationDateRangeKpi",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetApplicationDateRangeKpi {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetApplicationDateRangeKpiRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetApplicationDateRangeKpiResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetApplicationDateRangeKpi")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetApplicationDateRangeKpi")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetApplicationDateRangeKpiTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetApplicationDateRangeKpiTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetApplicationDateRangeKpiTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetApplicationDateRangeKpiInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetApplicationDateRangeKpiResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_application_date_range_kpi::de_get_application_date_range_kpi_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_application_date_range_kpi::de_get_application_date_range_kpi_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetApplicationDateRangeKpiRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_application_date_range_kpi::GetApplicationDateRangeKpiInput,
