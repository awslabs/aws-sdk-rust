...
impl UpdateVoiceTemplateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_voice_template::UpdateVoiceTemplate::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVoiceTemplate {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::protocol_serde::shape_update_voice_template::de_update_voice_template_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::update_voice_template::UpdateVoiceTemplateError
{
