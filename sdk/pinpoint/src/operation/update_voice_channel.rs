...
impl UpdateVoiceChannelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_voice_channel::UpdateVoiceChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVoiceChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_voice_channel::de_update_voice_channel_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_voice_channel::UpdateVoiceChannelError
{
