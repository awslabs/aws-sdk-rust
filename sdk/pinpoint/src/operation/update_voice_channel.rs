...
impl UpdateVoiceChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVoiceChannel`](crate::operation::update_voice_channel::UpdateVoiceChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_voice_channel::UpdateVoiceChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_voice_channel::UpdateVoiceChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/channels/voice", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_voice_channel::UpdateVoiceChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateVoiceChannel", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateVoiceChannel`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVoiceChannel {
                type Output = std::result::Result<crate::operation::update_voice_channel::UpdateVoiceChannelOutput, crate::operation::update_voice_channel::UpdateVoiceChannelError>;
