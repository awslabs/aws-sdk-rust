...
pub use crate::operation::delete_push_template::_delete_push_template_output::DeletePushTemplateOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_push_template::DeletePushTemplateOutput,
                    crate::operation::delete_push_template::DeletePushTemplateError,
                > for DeletePushTemplateFluentBuilder
            {
                fn send(
                    self,
...
impl DeletePushTemplateFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_push_template::builders::DeletePushTemplateInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_push_template::DeletePushTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_push_template::DeletePushTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_push_template::DeletePushTemplate::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_push_template::DeletePushTemplate::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_push_template::DeletePushTemplateOutput, crate::operation::delete_push_template::DeletePushTemplateError, Self> {
