...
impl DeletePushTemplateFluentBuilder  {
    /// Creates a new `DeletePushTemplate`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_push_template::DeletePushTemplateOutput, aws_smithy_http::result::SdkError<crate::operation::delete_push_template::DeletePushTemplateError>>
                     {
