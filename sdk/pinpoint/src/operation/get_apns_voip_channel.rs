...
impl GetApnsVoipChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_apns_voip_channel::GetApnsVoipChannel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApnsVoipChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_apns_voip_channel::de_get_apns_voip_channel_http_response_with_props(status, headers, body)
        }
    }
}
