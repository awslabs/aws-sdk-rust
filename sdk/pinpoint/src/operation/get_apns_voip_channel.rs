    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_apns_voip_channel::GetApnsVoipChannelError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_apns_voip_channel::GetApnsVoipChannelOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetApnsVoipChannel")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetApnsVoipChannelEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetApnsVoipChannelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetApnsVoipChannelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_apns_voip_channel::GetApnsVoipChannelInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetApnsVoipChannelEndpointParamsInterceptor {
...
pub type GetApnsVoipChannelErrorKind = GetApnsVoipChannelError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetApnsVoipChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_apns_voip_channel::GetApnsVoipChannelError {
...
impl GetApnsVoipChannelError {
    ...
    /// Creates the `GetApnsVoipChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
