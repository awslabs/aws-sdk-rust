...
impl GetApnsVoipChannelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_apns_voip_channel::GetApnsVoipChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApnsVoipChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_apns_voip_channel::de_get_apns_voip_channel_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_apns_voip_channel::GetApnsVoipChannelError
{
