...
impl UpdateCampaignInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_campaign::UpdateCampaign, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCampaign {
    type Output =
        ::std::result::Result<crate::operation::update_campaign::UpdateCampaignOutput, crate::operation::update_campaign::UpdateCampaignError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_campaign::de_update_campaign_http_response_with_props(status, headers, body)
        }
    }
}
