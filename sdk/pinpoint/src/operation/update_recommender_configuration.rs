...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRecommenderConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_recommender_configuration::de_update_recommender_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateRecommenderConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_recommender_configuration::UpdateRecommenderConfigurationError
{
