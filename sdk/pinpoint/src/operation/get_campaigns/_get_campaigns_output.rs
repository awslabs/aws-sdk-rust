...
impl ::aws_types::request_id::RequestId for GetCampaignsOutput {
                                    fn request_id(&self) -> Option<&str> {
                                        self._request_id.as_deref()
                                    }
                                }
impl GetCampaignsOutput {
    /// Creates a new builder-style object to manufacture [`GetCampaignsOutput`](crate::operation::get_campaigns::GetCampaignsOutput).
    pub fn builder() -> crate::operation::get_campaigns::builders::GetCampaignsOutputBuilder {
        crate::operation::get_campaigns::builders::GetCampaignsOutputBuilder::default()
    }
}

/// A builder for [`GetCampaignsOutput`](crate::operation::get_campaigns::GetCampaignsOutput).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct GetCampaignsOutputBuilder {
    pub(crate) campaigns_response: ::std::option::Option<crate::types::CampaignsResponse>,
    _request_id: Option<String>,
}
impl GetCampaignsOutputBuilder {
    /// <p>Provides information about the configuration and other settings for all the campaigns that are associated with an application.</p>
    ...
    pub fn set_campaigns_response(mut self, input: ::std::option::Option<crate::types::CampaignsResponse>) -> Self {
        self.campaigns_response = input; self
    }
    /// <p>Provides information about the configuration and other settings for all the campaigns that are associated with an application.</p>
    ...
    /// Consumes the builder and constructs a [`GetCampaignsOutput`](crate::operation::get_campaigns::GetCampaignsOutput).
    pub fn build(self) -> crate::operation::get_campaigns::GetCampaignsOutput {
