...
impl GetExportJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_export_jobs::GetExportJobs,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_export_jobs::GetExportJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetExportJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_export_jobs::de_get_export_jobs_http_error(
                status, headers, body,
            )
        } else {
