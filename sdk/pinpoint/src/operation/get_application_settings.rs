...
pub type GetApplicationSettingsErrorKind = GetApplicationSettingsError;
...
impl GetApplicationSettingsError {
    ...
    /// Creates the `GetApplicationSettingsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
