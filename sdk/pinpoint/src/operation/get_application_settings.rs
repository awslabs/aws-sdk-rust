...
impl GetApplicationSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetApplicationSettings`](crate::operation::get_application_settings::GetApplicationSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_application_settings::GetApplicationSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_application_settings::GetApplicationSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/settings", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_application_settings::GetApplicationSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetApplicationSettings", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetApplicationSettings {
                type Output = std::result::Result<crate::operation::get_application_settings::GetApplicationSettingsOutput, crate::operation::get_application_settings::GetApplicationSettingsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_application_settings::de_get_application_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_application_settings::de_get_application_settings_http_response(response)
                     }
                }
            }
