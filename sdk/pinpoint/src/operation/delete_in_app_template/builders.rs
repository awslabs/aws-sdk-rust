...
impl DeleteInAppTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_in_app_template::DeleteInAppTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_in_app_template::DeleteInAppTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_in_app_template::DeleteInAppTemplateOutput, crate::operation::delete_in_app_template::DeleteInAppTemplateError, Self> {
