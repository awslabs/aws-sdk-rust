...
impl GetInAppTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_in_app_template::GetInAppTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInAppTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_in_app_template::de_get_in_app_template_http_response_with_props(status, headers, body)
        }
    }
}
