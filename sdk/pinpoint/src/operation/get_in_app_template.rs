...
impl GetInAppTemplateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_in_app_template::GetInAppTemplate::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetInAppTemplate {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_in_app_template::de_get_in_app_template_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_in_app_template::GetInAppTemplateError
{
