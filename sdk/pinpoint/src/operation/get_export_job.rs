...
impl GetExportJobInput {
    /// Consumes the builder and constructs an Operation<[`GetExportJob`](crate::operation::get_export_job::GetExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_export_job::GetExportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_export_job::GetExportJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/jobs/export/{JobId}", ApplicationId = application_id, JobId = job_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_export_job::GetExportJob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetExportJob", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetExportJob`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetExportJob {
                type Output = std::result::Result<crate::operation::get_export_job::GetExportJobOutput, crate::operation::get_export_job::GetExportJobError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_export_job::de_get_export_job_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_export_job::de_get_export_job_http_response(response)
                     }
                }
            }
