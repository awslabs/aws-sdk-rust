...
impl UpdateTemplateActiveVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_template_active_version::UpdateTemplateActiveVersion::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateTemplateActiveVersionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_template_active_version::UpdateTemplateActiveVersionError
{
