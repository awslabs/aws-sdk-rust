...
impl GetSegmentVersionsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_segment_versions::GetSegmentVersions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetSegmentVersions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_segment_versions::de_get_segment_versions_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_segment_versions::GetSegmentVersionsError
{
