...
impl DeleteEmailChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_email_channel::DeleteEmailChannel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEmailChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_email_channel::de_delete_email_channel_http_response_with_props(status, headers, body)
        }
    }
}
