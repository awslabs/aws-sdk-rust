...
impl DeleteEmailChannelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteEmailChannel`](crate::operation::delete_email_channel::DeleteEmailChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_email_channel::DeleteEmailChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_email_channel::DeleteEmailChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/channels/email", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_email_channel::DeleteEmailChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteEmailChannel", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEmailChannel {
                type Output = std::result::Result<crate::operation::delete_email_channel::DeleteEmailChannelOutput, crate::operation::delete_email_channel::DeleteEmailChannelError>;
