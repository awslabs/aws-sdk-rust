...
impl CreatePushTemplateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_push_template::CreatePushTemplate::new(),
        )
...
/// `ParseStrictResponse` impl for `CreatePushTemplate`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePushTemplate {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_push_template::de_create_push_template_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_push_template::de_create_push_template_http_response(
                status, headers, body,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::create_push_template::CreatePushTemplateError
{
