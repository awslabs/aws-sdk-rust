...
impl CreateJourneyInput {
    /// Consumes the builder and constructs an Operation<[`CreateJourney`](crate::operation::create_journey::CreateJourney)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_journey::CreateJourney, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_journey::CreateJourneyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_journey::CreateJourney::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateJourney", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateJourney`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateJourney {
                type Output = std::result::Result<crate::operation::create_journey::CreateJourneyOutput, crate::operation::create_journey::CreateJourneyError>;
