...
impl GetCampaignsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_campaigns::GetCampaigns::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCampaigns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_campaigns::de_get_campaigns_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_campaigns::de_get_campaigns_http_response_with_props(
                status, headers, body,
            )
        }
    }
