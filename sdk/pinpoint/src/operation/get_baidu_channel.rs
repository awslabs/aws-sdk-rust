...
impl GetBaiduChannelInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_baidu_channel::GetBaiduChannel,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_baidu_channel::GetBaiduChannel::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetBaiduChannel {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_baidu_channel::de_get_baidu_channel_http_error(
                status, headers, body,
            )
        } else {
