...
impl GetBaiduChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_baidu_channel::GetBaiduChannel, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBaiduChannel {
    type Output =
        ::std::result::Result<crate::operation::get_baidu_channel::GetBaiduChannelOutput, crate::operation::get_baidu_channel::GetBaiduChannelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_baidu_channel::de_get_baidu_channel_http_response_with_props(status, headers, body)
        }
    }
}
