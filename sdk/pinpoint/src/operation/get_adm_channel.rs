...
impl GetAdmChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_adm_channel::GetAdmChannel, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAdmChannel {
    type Output =
        ::std::result::Result<crate::operation::get_adm_channel::GetAdmChannelOutput, crate::operation::get_adm_channel::GetAdmChannelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_adm_channel::de_get_adm_channel_http_response_with_props(status, headers, body)
        }
    }
}
