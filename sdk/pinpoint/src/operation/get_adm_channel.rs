...
impl GetAdmChannelInput {
    /// Consumes the builder and constructs an Operation<[`GetAdmChannel`](crate::operation::get_adm_channel::GetAdmChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_adm_channel::GetAdmChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_adm_channel::GetAdmChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_adm_channel::GetAdmChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAdmChannel", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetAdmChannel`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetAdmChannel {
                type Output = std::result::Result<crate::operation::get_adm_channel::GetAdmChannelOutput, crate::operation::get_adm_channel::GetAdmChannelError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_adm_channel::de_get_adm_channel_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_adm_channel::de_get_adm_channel_http_response(response)
                     }
                }
            }
