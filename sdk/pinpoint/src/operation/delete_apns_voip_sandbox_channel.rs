    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_apns_voip_sandbox_channel::DeleteApnsVoipSandboxChannelError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_apns_voip_sandbox_channel::DeleteApnsVoipSandboxChannelOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteApnsVoipSandboxChannel {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteApnsVoipSandboxChannel")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteApnsVoipSandboxChannelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteApnsVoipSandboxChannelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_apns_voip_sandbox_channel::DeleteApnsVoipSandboxChannelInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteApnsVoipSandboxChannelEndpointParamsInterceptor {
...
pub type DeleteApnsVoipSandboxChannelErrorKind = DeleteApnsVoipSandboxChannelError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_apns_voip_sandbox_channel::DeleteApnsVoipSandboxChannelError {
...
impl DeleteApnsVoipSandboxChannelError {
    ...
    /// Creates the `DeleteApnsVoipSandboxChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
