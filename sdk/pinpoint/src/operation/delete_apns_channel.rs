...
impl DeleteApnsChannelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteApnsChannel`](crate::operation::delete_apns_channel::DeleteApnsChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_apns_channel::DeleteApnsChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_apns_channel::DeleteApnsChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/channels/apns", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_apns_channel::DeleteApnsChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteApnsChannel", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteApnsChannel`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteApnsChannel {
                type Output = std::result::Result<crate::operation::delete_apns_channel::DeleteApnsChannelOutput, crate::operation::delete_apns_channel::DeleteApnsChannelError>;
