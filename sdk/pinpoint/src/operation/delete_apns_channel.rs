    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_apns_channel::DeleteApnsChannelError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_apns_channel::DeleteApnsChannelOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteApnsChannel")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DeleteApnsChannelEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteApnsChannelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteApnsChannelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_apns_channel::DeleteApnsChannelInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteApnsChannelEndpointParamsInterceptor {
...
pub type DeleteApnsChannelErrorKind = DeleteApnsChannelError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteApnsChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_apns_channel::DeleteApnsChannelError {
...
impl DeleteApnsChannelError {
    ...
    /// Creates the `DeleteApnsChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
