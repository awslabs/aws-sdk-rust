...
impl GetSmsChannelInput {
    /// Consumes the builder and constructs an Operation<[`GetSmsChannel`](crate::operation::get_sms_channel::GetSmsChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_sms_channel::GetSmsChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_sms_channel::GetSmsChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/channels/sms", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_sms_channel::GetSmsChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSmsChannel", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetSmsChannel {
                type Output = std::result::Result<crate::operation::get_sms_channel::GetSmsChannelOutput, crate::operation::get_sms_channel::GetSmsChannelError>;
