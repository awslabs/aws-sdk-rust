...
impl DeleteEventStreamInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_event_stream::DeleteEventStream, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_event_stream::DeleteEventStreamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_event_stream::DeleteEventStream::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteEventStream", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEventStream {
                type Output = std::result::Result<crate::operation::delete_event_stream::DeleteEventStreamOutput, crate::operation::delete_event_stream::DeleteEventStreamError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_event_stream::de_delete_event_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_event_stream::de_delete_event_stream_http_response(response)
                     }
                }
            }
...
impl DeleteEventStreamError {
    ...
    /// Returns `true` if the error kind is `DeleteEventStreamError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteEventStreamError::TooManyRequestsException`.
