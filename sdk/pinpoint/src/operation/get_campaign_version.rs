...
impl GetCampaignVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_campaign_version::GetCampaignVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCampaignVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_campaign_version::de_get_campaign_version_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_campaign_version::GetCampaignVersionError
{
