...
impl GetCampaignDateRangeKpiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_campaign_date_range_kpi::GetCampaignDateRangeKpiInput, ::aws_smithy_types::error::operation::BuildError> {
