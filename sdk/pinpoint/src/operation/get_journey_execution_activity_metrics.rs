...
impl GetJourneyExecutionActivityMetricsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_journey_execution_activity_metrics::GetJourneyExecutionActivityMetrics,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_journey_execution_activity_metrics::GetJourneyExecutionActivityMetrics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJourneyExecutionActivityMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_journey_execution_activity_metrics::de_get_journey_execution_activity_metrics_http_response_with_props(
                status, headers, body,
            )
        }
    }
