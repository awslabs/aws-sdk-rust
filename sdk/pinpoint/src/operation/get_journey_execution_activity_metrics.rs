...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetJourneyExecutionActivityMetricsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetJourneyExecutionActivityMetricsRequestSerializer {
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("journey_activity_id", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetJourneyExecutionActivityMetricsEndpointParamsInterceptor {
