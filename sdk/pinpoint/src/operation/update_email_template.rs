...
impl UpdateEmailTemplate {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("pinpoint", "UpdateEmailTemplate", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateEmailTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateEmailTemplate", "pinpoint"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateEmailTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_email_template_input::ser_email_template_request_http_payload(&input.email_template_request)?,
        );
