...
impl UpdatePushTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_push_template::UpdatePushTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePushTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_update_push_template::de_update_push_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_push_template::UpdatePushTemplateError
{
