...
impl GetSegmentImportJobsFluentBuilder  {
    /// Creates a new `GetSegmentImportJobs`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_segment_import_jobs::GetSegmentImportJobsOutput, aws_smithy_http::result::SdkError<crate::operation::get_segment_import_jobs::GetSegmentImportJobsError>>
                     {
