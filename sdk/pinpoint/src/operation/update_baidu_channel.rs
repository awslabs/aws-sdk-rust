...
impl UpdateBaiduChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBaiduChannel`](crate::operation::update_baidu_channel::UpdateBaiduChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_baidu_channel::UpdateBaiduChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_baidu_channel::UpdateBaiduChannelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/channels/baidu", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_baidu_channel::UpdateBaiduChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateBaiduChannel", "pinpoint"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateBaiduChannel`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBaiduChannel {
                type Output = std::result::Result<crate::operation::update_baidu_channel::UpdateBaiduChannelOutput, crate::operation::update_baidu_channel::UpdateBaiduChannelError>;
