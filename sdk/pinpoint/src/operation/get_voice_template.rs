...
impl GetVoiceTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_voice_template::GetVoiceTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_voice_template::de_get_voice_template_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_voice_template::GetVoiceTemplateError
{
