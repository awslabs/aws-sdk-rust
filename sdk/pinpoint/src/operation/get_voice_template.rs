...
impl GetVoiceTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_voice_template::GetVoiceTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_voice_template::de_get_voice_template_http_response_with_props(status, headers, body)
        }
    }
}
