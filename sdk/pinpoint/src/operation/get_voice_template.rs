...
/// Orchestration and serialization glue logic for `GetVoiceTemplate`.
...
impl GetVoiceTemplate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_voice_template::GetVoiceTemplateInput,
                    ) -> ::std::result::Result<crate::operation::get_voice_template::GetVoiceTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_voice_template::GetVoiceTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_voice_template::GetVoiceTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_voice_template::GetVoiceTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVoiceTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetVoiceTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetVoiceTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetVoiceTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVoiceTemplate")
...
.with_interceptor(GetVoiceTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_voice_template::GetVoiceTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_voice_template::GetVoiceTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_voice_template::GetVoiceTemplateError>::new());
...
#[derive(Debug)]
            struct GetVoiceTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVoiceTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_voice_template::de_get_voice_template_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_voice_template::de_get_voice_template_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetVoiceTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetVoiceTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_voice_template::GetVoiceTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_voice_template::GetVoiceTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v1/templates/{TemplateName}/voice", TemplateName = template_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_voice_template::GetVoiceTemplateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetVoiceTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVoiceTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetVoiceTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetVoiceTemplateInput>()
                        .ok_or("failed to downcast to GetVoiceTemplateInput")?;
...
/// Error type for the `GetVoiceTemplateError` operation.
#[non_exhaustive]
...
pub enum GetVoiceTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetVoiceTemplateError) for what information is available for the error.")]
...
impl GetVoiceTemplateError {
    /// Creates the `GetVoiceTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetVoiceTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetVoiceTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetVoiceTemplateError::TooManyRequestsException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetVoiceTemplateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetVoiceTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_voice_template::GetVoiceTemplateError {
...
mod _get_voice_template_output;
