...
impl UpdateApplicationSettingsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_application_settings::UpdateApplicationSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApplicationSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_application_settings::de_update_application_settings_http_response_with_props(status, headers, body)
        }
    }
}
