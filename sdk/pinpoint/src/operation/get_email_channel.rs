...
impl GetEmailChannelInput {
    /// Consumes the builder and constructs an Operation<[`GetEmailChannel`](crate::operation::get_email_channel::GetEmailChannel)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_email_channel::GetEmailChannel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_email_channel::GetEmailChannel::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetEmailChannel", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEmailChannel {
    type Output =
        ::std::result::Result<crate::operation::get_email_channel::GetEmailChannelOutput, crate::operation::get_email_channel::GetEmailChannelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_email_channel::de_get_email_channel_http_response_with_props(status, headers, body)
        }
    }
}
