...
impl GetAdmChannelFluentBuilder  {
    /// Creates a new `GetAdmChannel`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_adm_channel::GetAdmChannelOutput, aws_smithy_http::result::SdkError<crate::operation::get_adm_channel::GetAdmChannelError>>
                     {
