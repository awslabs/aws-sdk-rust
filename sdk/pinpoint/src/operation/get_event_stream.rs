...
impl GetEventStreamInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_event_stream::GetEventStream, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_event_stream::GetEventStreamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/v1/apps/{ApplicationId}/eventstream", ApplicationId = application_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_event_stream::GetEventStream::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetEventStream", "pinpoint"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetEventStream {
                type Output = std::result::Result<crate::operation::get_event_stream::GetEventStreamOutput, crate::operation::get_event_stream::GetEventStreamError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_event_stream::de_get_event_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_event_stream::de_get_event_stream_http_response(response)
                     }
                }
            }
...
impl GetEventStreamError {
    ...
    /// Returns `true` if the error kind is `GetEventStreamError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetEventStreamError::TooManyRequestsException`.
