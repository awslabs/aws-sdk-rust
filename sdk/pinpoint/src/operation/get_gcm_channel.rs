...
impl GetGcmChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_gcm_channel::GetGcmChannel,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_gcm_channel::GetGcmChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGcmChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_gcm_channel::de_get_gcm_channel_http_error(
                status, headers, body,
            )
        } else {
