...
impl GetSegmentsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_segments::GetSegmentsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
            crate::operation::get_segments::GetSegmentsInput {
