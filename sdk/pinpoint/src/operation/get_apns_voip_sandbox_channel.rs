...
impl GetApnsVoipSandboxChannelInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_apns_voip_sandbox_channel::GetApnsVoipSandboxChannel::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApnsVoipSandboxChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_apns_voip_sandbox_channel::de_get_apns_voip_sandbox_channel_http_response_with_props(
                status, headers, body,
            )
        }
    }
