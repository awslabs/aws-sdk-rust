    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "deletedResources" => {
                    builder = builder.set_deleted_resources(crate::protocol_serde::shape_resources::de_resources(tokens)?);
                }
                "orphanedResources" => {
                    builder = builder.set_orphaned_resources(crate::protocol_serde::shape_resources::de_resources(tokens)?);
                }
