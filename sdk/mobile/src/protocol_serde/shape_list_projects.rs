...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::list_projects::ListProjectsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "TooManyRequestsException" => {
            crate::operation::list_projects::ListProjectsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnauthorizedException" => {
            crate::operation::list_projects::ListProjectsError::UnauthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "projects" => {
                        builder = builder.set_projects(
                            crate::protocol_serde::shape_project_summaries::de_project_summaries(
                                tokens,
                            )?,
                        );
                    }
