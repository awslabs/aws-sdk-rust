...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_bundles::builders::ListBundlesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_bundles::builders::ListBundlesFluentBuilder::set_next_token): <p> Pagination token. Set to null to start listing bundles from start. If non-null pagination token is returned in a result, then pass its value in here in another request to list more bundles. </p>
