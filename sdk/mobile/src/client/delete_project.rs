...
impl super::Client {
    ...
    ///   - [`project_id(impl ::std::convert::Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::project_id) / [`set_project_id(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_project_id): <p> Unique project identifier. </p>
