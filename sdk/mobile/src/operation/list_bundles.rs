...
impl ListBundlesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_bundles::ListBundles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBundles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_bundles::de_list_bundles_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_bundles::de_list_bundles_http_response_with_props(
                status, headers, body,
            )
        }
    }
