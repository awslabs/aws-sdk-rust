...
impl ExportProjectInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::export_project::ExportProject,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/exports/{projectId}", projectId = project_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_project::ExportProject::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportProject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_export_project::de_export_project_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_export_project::de_export_project_http_response_with_props(
                status, headers, body,
            )
        }
    }
