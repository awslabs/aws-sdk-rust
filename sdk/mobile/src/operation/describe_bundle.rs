...
impl DescribeBundleInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_bundle::DescribeBundle::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeBundle {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_bundle::de_describe_bundle_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_bundle::de_describe_bundle_http_response(
                status, headers, body,
            )
        }
    }
