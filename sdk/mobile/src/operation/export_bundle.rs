...
/// Orchestration and serialization glue logic for `ExportBundle`.
...
impl ExportBundle {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::export_bundle::ExportBundleInput,
                    ) -> ::std::result::Result<crate::operation::export_bundle::ExportBundleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_bundle::ExportBundleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::export_bundle::ExportBundleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::export_bundle::ExportBundleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportBundle {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportBundle");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExportBundleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExportBundleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportBundle")
...
.with_interceptor(ExportBundleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::export_bundle::ExportBundleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::export_bundle::ExportBundleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::export_bundle::ExportBundleError>::new());
...
#[derive(Debug)]
            struct ExportBundleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExportBundleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_export_bundle::de_export_bundle_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_export_bundle::de_export_bundle_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ExportBundleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportBundleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::export_bundle::ExportBundleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::export_bundle::ExportBundleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.bundle_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("bundle_id", "cannot be empty or unset"))?;
    let bundle_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if bundle_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("bundle_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/bundles/{bundleId}", bundleId = bundle_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::export_bundle::ExportBundleInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_2) = &_input.project_id {
         {
            query.push_kv("projectId", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
    if let ::std::option::Option::Some(inner_3) = &_input.platform {
         {
            query.push_kv("platform", &::aws_smithy_http::query::fmt_string(inner_3));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ExportBundleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExportBundleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExportBundleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExportBundleInput>()
                        .ok_or("failed to downcast to ExportBundleInput")?;
...
pub enum ExportBundleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExportBundleError) for what information is available for the error.")]
...
impl ExportBundleError {
    /// Creates the `ExportBundleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExportBundleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExportBundleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::export_bundle::ExportBundleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::export_bundle::_export_bundle_output::ExportBundleOutput;

pub use crate::operation::export_bundle::_export_bundle_input::ExportBundleInput;

mod _export_bundle_input;

mod _export_bundle_output;
