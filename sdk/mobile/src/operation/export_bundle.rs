    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bundles/{bundleId}", bundleId = bundle_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_bundle::ExportBundle::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportBundle {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_export_bundle::de_export_bundle_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_export_bundle::de_export_bundle_http_response_with_props(
                status, headers, body,
            )
        }
    }
