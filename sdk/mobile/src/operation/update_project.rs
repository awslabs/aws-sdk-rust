    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_project::UpdateProjectError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_project::UpdateProjectOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateProject {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateProject", "mobile"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateProjectRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_project_input::ser_contents_http_payload(
            input.contents,
        )?);
