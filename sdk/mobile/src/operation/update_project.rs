...
impl UpdateProjectInput {
    ...
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_project::UpdateProject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_project::UpdateProjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/update").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::update_project::UpdateProjectInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_project_input::ser_contents_http_payload( self.contents)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_project::UpdateProject::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateProject {
                type Output = std::result::Result<crate::operation::update_project::UpdateProjectOutput, crate::operation::update_project::UpdateProjectError>;
