...
pub struct UpdateProjectOutput  {
    ...
    #[doc(hidden)]pub details: std::option::Option<crate::model::ProjectDetails>,
}
...
pub struct ListBundlesOutput  {
    ...
    #[doc(hidden)]pub bundle_list: std::option::Option<std::vec::Vec<crate::model::BundleDetails>>,
...
pub struct ExportProjectOutput  {
    ...
    #[doc(hidden)]pub share_url: std::option::Option<std::string::String>,
...
pub struct DescribeBundleOutput  {
    ...
    #[doc(hidden)]pub details: std::option::Option<crate::model::BundleDetails>,
}
...
pub struct DeleteProjectOutput  {
    ...
    #[doc(hidden)]pub deleted_resources: std::option::Option<std::vec::Vec<crate::model::Resource>>,
    /// <p> Resources which were not deleted, due to a risk of losing potentially important data or files. </p>
    #[doc(hidden)]pub orphaned_resources: std::option::Option<std::vec::Vec<crate::model::Resource>>,
}
