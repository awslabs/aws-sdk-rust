...
pub struct ProjectDetails  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::ProjectState>,
...
pub struct BundleDetails  {
    ...
    #[doc(hidden)]pub icon_url: std::option::Option<std::string::String>,
    /// <p> Developer desktop or mobile app or website platforms. </p>
    #[doc(hidden)]pub available_platforms: std::option::Option<std::vec::Vec<crate::model::Platform>>,
}
impl BundleDetails {
    /// <p> Unique bundle identifier. </p>
