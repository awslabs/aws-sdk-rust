...
impl DeleteOriginEndpointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOriginEndpoint`](crate::operation::delete_origin_endpoint::DeleteOriginEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_origin_endpoint::DeleteOriginEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_origin_endpoint::DeleteOriginEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_origin_endpoint::DeleteOriginEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteOriginEndpoint", "mediapackage"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteOriginEndpoint {
                type Output = std::result::Result<crate::operation::delete_origin_endpoint::DeleteOriginEndpointOutput, crate::operation::delete_origin_endpoint::DeleteOriginEndpointError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 202 {
                        crate::protocol_serde::shape_delete_origin_endpoint::de_delete_origin_endpoint_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_origin_endpoint::de_delete_origin_endpoint_http_response(response)
                     }
                }
            }
