...
/// Orchestration and serialization glue logic for `DeleteOriginEndpoint`.
...
impl DeleteOriginEndpoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_origin_endpoint::DeleteOriginEndpointInput,
                    ) -> ::std::result::Result<crate::operation::delete_origin_endpoint::DeleteOriginEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_origin_endpoint::DeleteOriginEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_origin_endpoint::DeleteOriginEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_origin_endpoint::DeleteOriginEndpointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteOriginEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteOriginEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteOriginEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteOriginEndpointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteOriginEndpoint")
...
.with_interceptor(DeleteOriginEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_origin_endpoint::DeleteOriginEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_origin_endpoint::DeleteOriginEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_origin_endpoint::DeleteOriginEndpointError>::new());
...
#[derive(Debug)]
            struct DeleteOriginEndpointResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteOriginEndpointResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteOriginEndpointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteOriginEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_origin_endpoint::DeleteOriginEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_origin_endpoint::DeleteOriginEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/origin_endpoints/{Id}", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteOriginEndpointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteOriginEndpointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteOriginEndpointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteOriginEndpointInput>()
                        .ok_or("failed to downcast to DeleteOriginEndpointInput")?;
...
pub enum DeleteOriginEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteOriginEndpointError) for what information is available for the error.")]
...
impl DeleteOriginEndpointError {
    /// Creates the `DeleteOriginEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteOriginEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteOriginEndpointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_origin_endpoint::DeleteOriginEndpointError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_origin_endpoint::_delete_origin_endpoint_output::DeleteOriginEndpointOutput;

pub use crate::operation::delete_origin_endpoint::_delete_origin_endpoint_input::DeleteOriginEndpointInput;

mod _delete_origin_endpoint_input;

mod _delete_origin_endpoint_output;
