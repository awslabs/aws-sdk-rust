...
impl ConfigureLogsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::configure_logs::ConfigureLogs,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/channels/{Id}/configure_logs", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::configure_logs::ConfigureLogs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfigureLogs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_configure_logs::de_configure_logs_http_error(
                status, headers, body,
            )
        } else {
