...
impl ConfigureLogsInput {
    /// Consumes the builder and constructs an Operation<[`ConfigureLogs`](crate::operation::configure_logs::ConfigureLogs)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::configure_logs::ConfigureLogs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_configure_logs::ser_configure_logs_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::configure_logs::ConfigureLogs::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ConfigureLogs", "mediapackage"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfigureLogs {
    type Output = ::std::result::Result<crate::operation::configure_logs::ConfigureLogsOutput, crate::operation::configure_logs::ConfigureLogsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_configure_logs::de_configure_logs_http_response_with_props(status, headers, body)
        }
    }
}
