...
impl RotateIngestEndpointCredentials {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RotateIngestEndpointCredentials",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RotateIngestEndpointCredentials {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RotateIngestEndpointCredentialsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RotateIngestEndpointCredentialsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RotateIngestEndpointCredentials")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RotateIngestEndpointCredentials")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RotateIngestEndpointCredentialsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RotateIngestEndpointCredentialsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RotateIngestEndpointCredentialsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RotateIngestEndpointCredentialsInput>() else {
        ...
        if requested.should_capture("IngestEndpointId") {
            if let ::std::option::Option::Some(value) = input.ingest_endpoint_id.as_deref() {
                captured.insert("IngestEndpointId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RotateIngestEndpointCredentialsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_rotate_ingest_endpoint_credentials::de_rotate_ingest_endpoint_credentials_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_rotate_ingest_endpoint_credentials::de_rotate_ingest_endpoint_credentials_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateIngestEndpointCredentialsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsInput,
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field("ingest_endpoint_id", "cannot be empty or unset")
                })?;
