...
impl RotateIngestEndpointCredentialsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentials::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RotateIngestEndpointCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_rotate_ingest_endpoint_credentials::de_rotate_ingest_endpoint_credentials_http_response_with_props(
                status, headers, body,
            )
        }
    }
