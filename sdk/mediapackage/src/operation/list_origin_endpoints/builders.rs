...
impl ListOriginEndpointsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_origin_endpoints::paginator::ListOriginEndpointsPaginator {
        crate::operation::list_origin_endpoints::paginator::ListOriginEndpointsPaginator::new(
            self.handle,
            self.inner,
        )
    }
