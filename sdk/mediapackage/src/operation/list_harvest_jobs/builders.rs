...
impl ListHarvestJobsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_harvest_jobs::builders::ListHarvestJobsInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_harvest_jobs::paginator::ListHarvestJobsPaginator {
        crate::operation::list_harvest_jobs::paginator::ListHarvestJobsPaginator::new(
            self.handle,
            self.inner,
        )
    }
