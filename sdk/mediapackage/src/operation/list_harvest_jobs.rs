...
impl ListHarvestJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListHarvestJobs`](crate::operation::list_harvest_jobs::ListHarvestJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_harvest_jobs::ListHarvestJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_harvest_jobs::ListHarvestJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/harvest_jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_harvest_jobs::ListHarvestJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.include_channel_id {
                     {
                        query.push_kv("includeChannelId", &aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
                if let Some(inner_2) = &_input.include_status {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_harvest_jobs::ListHarvestJobs::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListHarvestJobs", "mediapackage"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListHarvestJobs {
                type Output = std::result::Result<crate::operation::list_harvest_jobs::ListHarvestJobsOutput, crate::operation::list_harvest_jobs::ListHarvestJobsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_harvest_jobs::de_list_harvest_jobs_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_harvest_jobs::de_list_harvest_jobs_http_response(response)
                     }
                }
            }
