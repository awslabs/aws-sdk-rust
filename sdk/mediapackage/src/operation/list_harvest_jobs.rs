...
impl ListHarvestJobs {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_harvest_jobs::ListHarvestJobsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_harvest_jobs::ListHarvestJobsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaPackage", "ListHarvestJobs", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "MediaPackage.ListHarvestJobs",
                "rpc.service" = "MediaPackage",
                "rpc.method" = "ListHarvestJobs",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListHarvestJobs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListHarvestJobsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListHarvestJobsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListHarvestJobs")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListHarvestJobs")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListHarvestJobsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListHarvestJobsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListHarvestJobsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListHarvestJobsInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("IncludeChannelId") {
            if let ::std::option::Option::Some(value) = input.include_channel_id.as_deref() {
                captured.insert("IncludeChannelId", value);
            }
        }
        if requested.should_capture("IncludeStatus") {
            if let ::std::option::Option::Some(value) = input.include_status.as_deref() {
                captured.insert("IncludeStatus", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListHarvestJobsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_harvest_jobs::de_list_harvest_jobs_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_harvest_jobs::de_list_harvest_jobs_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListHarvestJobsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_harvest_jobs::ListHarvestJobsInput>()
            .expect("correct type");
