...
impl ListHarvestJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_harvest_jobs::ListHarvestJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHarvestJobs {
    type Output =
        ::std::result::Result<crate::operation::list_harvest_jobs::ListHarvestJobsOutput, crate::operation::list_harvest_jobs::ListHarvestJobsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_harvest_jobs::de_list_harvest_jobs_http_response_with_props(status, headers, body)
        }
    }
}
