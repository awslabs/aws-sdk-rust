...
/// Orchestration and serialization glue logic for `ListHarvestJobs`.
...
impl ListHarvestJobs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_harvest_jobs::ListHarvestJobsInput,
                    ) -> ::std::result::Result<crate::operation::list_harvest_jobs::ListHarvestJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_harvest_jobs::ListHarvestJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_harvest_jobs::ListHarvestJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_harvest_jobs::ListHarvestJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListHarvestJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListHarvestJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListHarvestJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListHarvestJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListHarvestJobs")
...
.with_interceptor(ListHarvestJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_harvest_jobs::ListHarvestJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_harvest_jobs::ListHarvestJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_harvest_jobs::ListHarvestJobsError>::new());
...
#[derive(Debug)]
            struct ListHarvestJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListHarvestJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_harvest_jobs::de_list_harvest_jobs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListHarvestJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListHarvestJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_harvest_jobs::ListHarvestJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_harvest_jobs::ListHarvestJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/harvest_jobs").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_harvest_jobs::ListHarvestJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.include_channel_id {
         {
            query.push_kv("includeChannelId", &::aws_smithy_http::query::fmt_string(inner_1));
        }
    }
    if let ::std::option::Option::Some(inner_2) = &_input.include_status {
         {
            query.push_kv("includeStatus", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
...
#[derive(Debug)]
            struct ListHarvestJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListHarvestJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListHarvestJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListHarvestJobsInput>()
                        .ok_or("failed to downcast to ListHarvestJobsInput")?;
...
pub enum ListHarvestJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListHarvestJobsError) for what information is available for the error.")]
...
impl ListHarvestJobsError {
    /// Creates the `ListHarvestJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListHarvestJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListHarvestJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_harvest_jobs::ListHarvestJobsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_harvest_jobs::_list_harvest_jobs_output::ListHarvestJobsOutput;

pub use crate::operation::list_harvest_jobs::_list_harvest_jobs_input::ListHarvestJobsInput;

mod _list_harvest_jobs_input;

mod _list_harvest_jobs_output;
