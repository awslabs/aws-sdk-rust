...
impl CreateHarvestJobInput {
    /// Consumes the builder and constructs an Operation<[`CreateHarvestJob`](crate::operation::create_harvest_job::CreateHarvestJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_harvest_job::CreateHarvestJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_harvest_job::CreateHarvestJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_harvest_job::CreateHarvestJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateHarvestJob {
                type Output = std::result::Result<crate::operation::create_harvest_job::CreateHarvestJobOutput, crate::operation::create_harvest_job::CreateHarvestJobError>;
