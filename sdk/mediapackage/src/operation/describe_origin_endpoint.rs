...
impl DescribeOriginEndpointInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_origin_endpoint::DescribeOriginEndpoint,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOriginEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_origin_endpoint::de_describe_origin_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
