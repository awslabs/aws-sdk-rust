...
impl ListOriginEndpointsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_origin_endpoints::ListOriginEndpoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::list_origin_endpoints::ListOriginEndpointsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_1) = &_input.channel_id {
                     {
                        query.push_kv("channelId", &aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
...
impl aws_smithy_http::response::ParseStrictResponse for ListOriginEndpoints {
                type Output = std::result::Result<crate::operation::list_origin_endpoints::ListOriginEndpointsOutput, crate::operation::list_origin_endpoints::ListOriginEndpointsError>;
