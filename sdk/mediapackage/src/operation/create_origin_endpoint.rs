...
impl CreateOriginEndpoint {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaPackage", "CreateOriginEndpoint", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateOriginEndpointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ManifestName") {
            if let ::std::option::Option::Some(value) = input.manifest_name.as_deref() {
                captured.insert("ManifestName", value);
            }
        }
