...
impl crate::operation::rotate_ingest_endpoint_credentials::builders::RotateIngestEndpointCredentialsInputBuilder {
...
impl RotateIngestEndpointCredentialsFluentBuilder {
    /// Creates a new `RotateIngestEndpointCredentialsFluentBuilder`.
