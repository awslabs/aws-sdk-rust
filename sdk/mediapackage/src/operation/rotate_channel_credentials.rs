    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/channels/{Id}/credentials", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rotate_channel_credentials::RotateChannelCredentials::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::rotate_channel_credentials::RotateChannelCredentialsError
{
