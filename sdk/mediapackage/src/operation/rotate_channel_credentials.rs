...
impl RotateChannelCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`RotateChannelCredentials`](crate::operation::rotate_channel_credentials::RotateChannelCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::rotate_channel_credentials::RotateChannelCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rotate_channel_credentials::RotateChannelCredentialsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::rotate_channel_credentials::RotateChannelCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RotateChannelCredentials", "mediapackage"));
...
impl aws_smithy_http::response::ParseStrictResponse for RotateChannelCredentials {
                type Output = std::result::Result<crate::operation::rotate_channel_credentials::RotateChannelCredentialsOutput, crate::operation::rotate_channel_credentials::RotateChannelCredentialsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_rotate_channel_credentials::de_rotate_channel_credentials_http_error(response)
                     } else {
                        crate::protocol_serde::shape_rotate_channel_credentials::de_rotate_channel_credentials_http_response(response)
                     }
                }
            }
