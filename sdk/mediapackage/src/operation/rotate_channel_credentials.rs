...
impl RotateChannelCredentials {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::rotate_channel_credentials::RotateChannelCredentialsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::rotate_channel_credentials::RotateChannelCredentialsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RotateChannelCredentials",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RotateChannelCredentials {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RotateChannelCredentialsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RotateChannelCredentialsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RotateChannelCredentials")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RotateChannelCredentials")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RotateChannelCredentialsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RotateChannelCredentialsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RotateChannelCredentialsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RotateChannelCredentialsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RotateChannelCredentialsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_rotate_channel_credentials::de_rotate_channel_credentials_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_rotate_channel_credentials::de_rotate_channel_credentials_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RotateChannelCredentialsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::rotate_channel_credentials::RotateChannelCredentialsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::rotate_channel_credentials::RotateChannelCredentialsInput,
