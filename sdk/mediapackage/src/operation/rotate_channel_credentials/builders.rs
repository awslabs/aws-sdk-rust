...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::rotate_channel_credentials::RotateChannelCredentialsOutput,
                    crate::operation::rotate_channel_credentials::RotateChannelCredentialsError,
                > for RotateChannelCredentialsFluentBuilder
            {
                fn send(
                    self,
...
impl RotateChannelCredentialsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::rotate_channel_credentials::RotateChannelCredentialsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rotate_channel_credentials::RotateChannelCredentialsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::rotate_channel_credentials::RotateChannelCredentials::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::rotate_channel_credentials::RotateChannelCredentials::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::rotate_channel_credentials::RotateChannelCredentialsOutput, crate::operation::rotate_channel_credentials::RotateChannelCredentialsError, Self> {
