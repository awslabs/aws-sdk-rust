...
impl ::std::convert::From<&str> for CmafEncryptionMethod {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CmafEncryptionMethod::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
...
impl ::std::fmt::Display for CmafEncryptionMethod {
