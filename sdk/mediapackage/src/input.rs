...
impl CreateOriginEndpointInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_origin_endpoint::ser_create_origin_endpoint_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateOriginEndpointInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_origin_endpoint::ser_update_origin_endpoint_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
pub mod list_harvest_jobs_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::ListHarvestJobsInput, aws_smithy_http::operation::error::BuildError>
        {
