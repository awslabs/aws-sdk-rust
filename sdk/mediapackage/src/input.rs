...
pub mod configure_logs_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ConfigureLogsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ConfigureLogsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ConfigureLogs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ConfigureLogsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
impl CreateChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::CreateChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateChannel", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod create_harvest_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateHarvestJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateHarvestJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateHarvestJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::CreateHarvestJobInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::CreateHarvestJob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateHarvestJob", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod create_origin_endpoint_input {
    ...
    pub struct Builder {
        ...
        pub(crate) cmaf_package: std::option::Option<crate::model::CmafPackageCreateOrUpdateParameters>,
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateOriginEndpointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateOriginEndpointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateOriginEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::CreateOriginEndpointInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::CreateOriginEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateOriginEndpoint", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
impl DeleteChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::DeleteChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteChannel", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod delete_origin_endpoint_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteOriginEndpointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteOriginEndpointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteOriginEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DeleteOriginEndpointInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::DeleteOriginEndpoint::new())
...
pub mod describe_harvest_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeHarvestJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeHarvestJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeHarvestJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeHarvestJobInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::DescribeHarvestJob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeHarvestJob", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod describe_origin_endpoint_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeOriginEndpointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeOriginEndpointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeOriginEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeOriginEndpointInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::DescribeOriginEndpoint::new())
...
pub mod list_harvest_jobs_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListHarvestJobsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListHarvestJobsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListHarvestJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListHarvestJobsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/harvest_jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListHarvestJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_8) = &_input.include_channel_id {
                    query.push_kv("includeChannelId", &aws_smithy_http::query::fmt_string(&inner_8));
                }
                if let Some(inner_9) = &_input.include_status {
                    query.push_kv("includeStatus", &aws_smithy_http::query::fmt_string(&inner_9));
                }
                if _input.max_results != 0 {
                    query.push_kv("maxResults", aws_smithy_types::primitive::Encoder::from(_input.max_results).encode());
                }
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ListHarvestJobs::new())
...
pub mod list_origin_endpoints_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListOriginEndpointsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListOriginEndpointsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListOriginEndpoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListOriginEndpointsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/origin_endpoints").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListOriginEndpointsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ListOriginEndpoints::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListOriginEndpoints", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod rotate_channel_credentials_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RotateChannelCredentialsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl RotateChannelCredentialsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RotateChannelCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::RotateChannelCredentialsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::RotateChannelCredentials::new())
...
pub mod rotate_ingest_endpoint_credentials_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::RotateIngestEndpointCredentialsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl RotateIngestEndpointCredentialsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::RotateIngestEndpointCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::RotateIngestEndpointCredentialsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let input_16 = input_16.as_ref().ok_or(aws_smithy_http::operation::BuildError::MissingField { field: "ingest_endpoint_id", details: "cannot be empty or unset" })?;
                let ingest_endpoint_id = aws_smithy_http::label::fmt_string(input_16, aws_smithy_http::label::EncodingStrategy::Default);
                if ingest_endpoint_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "ingest_endpoint_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/channels/{Id}/ingest_endpoints/{IngestEndpointId}/credentials", Id = id, IngestEndpointId = ingest_endpoint_id).expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::RotateIngestEndpointCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RotateIngestEndpointCredentials", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
impl TagResourceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::TagResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::TagResource::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagResource", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
impl UntagResourceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UntagResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::UntagResource::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UntagResource", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
impl UpdateChannelInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateChannel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::UpdateChannel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateChannel", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod update_origin_endpoint_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateOriginEndpointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateOriginEndpointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateOriginEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateOriginEndpointInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::UpdateOriginEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateOriginEndpoint", "mediapackage"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub struct UpdateOriginEndpointInput  {
    /// CDN Authorization credentials
    #[doc(hidden)]pub authorization: std::option::Option<crate::model::Authorization>,
    /// A Common Media Application Format (CMAF) packaging configuration.
    #[doc(hidden)]pub cmaf_package: std::option::Option<crate::model::CmafPackageCreateOrUpdateParameters>,
    /// A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
    #[doc(hidden)]pub dash_package: std::option::Option<crate::model::DashPackage>,
    /// A short text description of the OriginEndpoint.
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// An HTTP Live Streaming (HLS) packaging configuration.
    #[doc(hidden)]pub hls_package: std::option::Option<crate::model::HlsPackage>,
    /// The ID of the OriginEndpoint to update.
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// A short string that will be appended to the end of the Endpoint URL.
    #[doc(hidden)]pub manifest_name: std::option::Option<std::string::String>,
    /// A Microsoft Smooth Streaming (MSS) packaging configuration.
    #[doc(hidden)]pub mss_package: std::option::Option<crate::model::MssPackage>,
    /// Control whether origination of video is allowed for this OriginEndpoint. If set to ALLOW, the OriginEndpoint may by requested, pursuant to any other form of access control. If set to DENY, the OriginEndpoint may not be requested. This can be helpful for Live to VOD harvesting, or for temporarily disabling origination
    #[doc(hidden)]pub origination: std::option::Option<crate::model::Origination>,
    /// Maximum duration (in seconds) of content to retain for startover playback. If not specified, startover playback will be disabled for the OriginEndpoint.
    #[doc(hidden)]pub startover_window_seconds: i32,
    /// Amount of delay (in seconds) to enforce on the playback of live content. If not specified, there will be no time delay in effect for the OriginEndpoint.
    #[doc(hidden)]pub time_delay_seconds: i32,
    /// A list of source IP CIDR blocks that will be allowed to access the OriginEndpoint.
    #[doc(hidden)]pub whitelist: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl UpdateOriginEndpointInput {
    /// CDN Authorization credentials
    ...
    /// A Common Media Application Format (CMAF) packaging configuration.
    pub fn cmaf_package(&self) -> std::option::Option<& crate::model::CmafPackageCreateOrUpdateParameters> {
...
pub struct RotateIngestEndpointCredentialsInput  {
    ...
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// The id of the IngestEndpoint whose credentials should be rotated
    #[doc(hidden)]pub ingest_endpoint_id: std::option::Option<std::string::String>,
}
impl RotateIngestEndpointCredentialsInput {
    /// The ID of the channel the IngestEndpoint is on.
    pub fn id(&self) -> std::option::Option<& str> {
...
pub struct ListHarvestJobsInput  {
    /// When specified, the request will return only HarvestJobs associated with the given Channel ID.
    #[doc(hidden)]pub include_channel_id: std::option::Option<std::string::String>,
    /// When specified, the request will return only HarvestJobs in the given status.
    #[doc(hidden)]pub include_status: std::option::Option<std::string::String>,
    /// The upper bound on the number of records to return.
    #[doc(hidden)]pub max_results: i32,
    /// A token used to resume pagination from the end of a previous request.
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
...
pub struct CreateHarvestJobInput  {
    ...
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// The ID of the OriginEndpoint that the HarvestJob will harvest from. This cannot be changed after the HarvestJob is submitted.
    #[doc(hidden)]pub origin_endpoint_id: std::option::Option<std::string::String>,
    /// Configuration parameters for where in an S3 bucket to place the harvested content
...
pub struct ConfigureLogsInput  {
    /// Configure egress access logging.
    #[doc(hidden)]pub egress_access_logs: std::option::Option<crate::model::EgressAccessLogs>,
    /// The ID of the channel to log subscription.
    #[doc(hidden)]pub id: std::option::Option<std::string::String>,
    /// Configure ingress access logging.
    #[doc(hidden)]pub ingress_access_logs: std::option::Option<crate::model::IngressAccessLogs>,
}
impl ConfigureLogsInput {
    /// Configure egress access logging.
