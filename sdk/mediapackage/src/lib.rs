...
//!
//! # Examples
//! Examples can be found [here](https://github.com/awslabs/aws-sdk-rust/tree/main/examples/mediapackage).
...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("mediapackage", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Elemental MediaPackage.
pub mod client;
