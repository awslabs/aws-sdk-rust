...
/// Paginator for [`ListHarvestJobs`](crate::operation::ListHarvestJobs)
            ...
            impl ListHarvestJobsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_harvest_jobs_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListHarvestJobsOutput, aws_smithy_http::result::SdkError<crate::error::ListHarvestJobsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListOriginEndpoints`](crate::operation::ListOriginEndpoints)
            ...
            impl ListOriginEndpointsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_origin_endpoints_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListOriginEndpointsOutput, aws_smithy_http::result::SdkError<crate::error::ListOriginEndpointsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `ListChannelsPaginator`
                ...
                impl  ListChannelsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Channel, aws_smithy_http::result::SdkError<crate::error::ListChannelsError>>> + Unpin
                     {
...
/// Flattened paginator for `ListHarvestJobsPaginator`
                ...
                impl  ListHarvestJobsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::HarvestJob, aws_smithy_http::result::SdkError<crate::error::ListHarvestJobsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_harvest_jobs_output_harvest_jobs(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListOriginEndpointsPaginator`
                ...
                impl  ListOriginEndpointsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::OriginEndpoint, aws_smithy_http::result::SdkError<crate::error::ListOriginEndpointsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_origin_endpoints_output_origin_endpoints(page).unwrap_or_default().into_iter())
                    }
                }
