...
pub fn serialize_structure_crate_input_configure_logs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConfigureLogsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_channel_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateChannelInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_harvest_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateHarvestJobInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_origin_endpoint_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateOriginEndpointInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_channel_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateChannelInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_origin_endpoint_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateOriginEndpointInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_egress_access_logs(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EgressAccessLogs) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_ingress_access_logs(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IngressAccessLogs) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_s3_destination(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3Destination) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_authorization(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Authorization) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_cmaf_package_create_or_update_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CmafPackageCreateOrUpdateParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_dash_package(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashPackage) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_hls_package(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsPackage) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_mss_package(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MssPackage) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_cmaf_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CmafEncryption) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_hls_manifest_create_or_update_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsManifestCreateOrUpdateParameters) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_stream_selection(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StreamSelection) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_dash_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashEncryption) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if input.key_rotation_interval_seconds != 0 {
        object.key("keyRotationIntervalSeconds").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((input.key_rotation_interval_seconds).into()));
    }
...
pub fn serialize_structure_crate_model_hls_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsEncryption) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_mss_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MssEncryption) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_encryption_contract_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EncryptionContractConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
