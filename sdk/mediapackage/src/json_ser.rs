...
pub fn serialize_structure_configure_logs_input(
    ...
    if let Some(var_1) = &input.egress_access_logs {
        ...
        crate::json_ser::serialize_structure_egress_access_logs(&mut object_2, var_1);
        object_2.finish();
    }
    if let Some(var_3) = &input.ingress_access_logs {
        let mut object_4 = object.key("ingressAccessLogs").start_object();
        crate::json_ser::serialize_structure_ingress_access_logs(&mut object_4, var_3);
        object_4.finish();
    }
}
...
pub fn serialize_structure_create_harvest_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_14) = &input.s3_destination {
        ...
        crate::json_ser::serialize_structure_s3_destination(&mut object_15, var_14);
        object_15.finish();
    }
...
pub fn serialize_structure_create_origin_endpoint_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_17) = &input.authorization {
        ...
        crate::json_ser::serialize_structure_authorization(&mut object_18, var_17);
        object_18.finish();
    }
    ...
    if let Some(var_20) = &input.cmaf_package {
        ...
        crate::json_ser::serialize_structure_cmaf_package_create_or_update_parameters(
            &mut object_21,
            var_20,
        );
        object_21.finish();
    ...
    if let Some(var_22) = &input.dash_package {
        ...
        crate::json_ser::serialize_structure_dash_package(&mut object_23, var_22);
        object_23.finish();
    }
    ...
    if let Some(var_25) = &input.hls_package {
        ...
        crate::json_ser::serialize_structure_hls_package(&mut object_26, var_25);
        object_26.finish();
    }
    ...
    if let Some(var_29) = &input.mss_package {
        ...
        crate::json_ser::serialize_structure_mss_package(&mut object_30, var_29);
        object_30.finish();
    }
    ...
    if input.startover_window_seconds != 0 {
        object.key("startoverWindowSeconds").number(
            ...
            smithy_types::Number::NegInt((input.startover_window_seconds).into()),
        );
    }
    ...
    if input.time_delay_seconds != 0 {
        object.key("timeDelaySeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.time_delay_seconds).into()),
        );
    }
...
pub fn serialize_structure_update_origin_endpoint_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_44) = &input.authorization {
        ...
        crate::json_ser::serialize_structure_authorization(&mut object_45, var_44);
        object_45.finish();
    }
    ...
    if let Some(var_48) = &input.dash_package {
        ...
        crate::json_ser::serialize_structure_dash_package(&mut object_49, var_48);
        object_49.finish();
    }
    ...
    if let Some(var_51) = &input.hls_package {
        ...
        crate::json_ser::serialize_structure_hls_package(&mut object_52, var_51);
        object_52.finish();
    }
    ...
    if let Some(var_54) = &input.mss_package {
        ...
        crate::json_ser::serialize_structure_mss_package(&mut object_55, var_54);
        object_55.finish();
    }
...
pub fn serialize_structure_egress_access_logs(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_ingress_access_logs(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_authorization(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cmaf_package_create_or_update_parameters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_67) = &input.encryption {
        ...
        crate::json_ser::serialize_structure_cmaf_encryption(&mut object_68, var_67);
        object_68.finish();
    }
        ...
        for item_71 in var_69 {
            {
                ...
                crate::json_ser::serialize_structure_hls_manifest_create_or_update_parameters(
                    &mut object_72,
                    item_71,
                );
                object_72.finish();
    ...
    if input.segment_duration_seconds != 0 {
        object.key("segmentDurationSeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.segment_duration_seconds).into()),
        );
    }
    ...
    if let Some(var_74) = &input.stream_selection {
        ...
        crate::json_ser::serialize_structure_stream_selection(&mut object_75, var_74);
        object_75.finish();
    }
}

pub fn serialize_structure_dash_package(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_80) = &input.encryption {
        ...
        crate::json_ser::serialize_structure_dash_encryption(&mut object_81, var_80);
        object_81.finish();
    }
    ...
    if let Some(var_88) = &input.stream_selection {
        ...
        crate::json_ser::serialize_structure_stream_selection(&mut object_89, var_88);
        object_89.finish();
    }
...
pub fn serialize_structure_hls_package(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_97) = &input.encryption {
        ...
        crate::json_ser::serialize_structure_hls_encryption(&mut object_98, var_97);
        object_98.finish();
    }
    ...
    if input.playlist_window_seconds != 0 {
        object.key("playlistWindowSeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.playlist_window_seconds).into()),
        );
    }
    if input.program_date_time_interval_seconds != 0 {
        object.key("programDateTimeIntervalSeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.program_date_time_interval_seconds).into()),
        );
    }
    if input.segment_duration_seconds != 0 {
        object.key("segmentDurationSeconds").number(
    ...
    if let Some(var_100) = &input.stream_selection {
        ...
        crate::json_ser::serialize_structure_stream_selection(&mut object_101, var_100);
        object_101.finish();
    }
...
pub fn serialize_structure_mss_package(
    ...
    if let Some(var_104) = &input.stream_selection {
        ...
        crate::json_ser::serialize_structure_stream_selection(&mut object_105, var_104);
        object_105.finish();
    }
}

pub fn serialize_structure_cmaf_encryption(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.key_rotation_interval_seconds != 0 {
        object.key("keyRotationIntervalSeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.key_rotation_interval_seconds).into()),
        );
    }
    if let Some(var_107) = &input.speke_key_provider {
        let mut object_108 = object.key("spekeKeyProvider").start_object();
        crate::json_ser::serialize_structure_speke_key_provider(&mut object_108, var_107);
        object_108.finish();
    }
}

pub fn serialize_structure_hls_manifest_create_or_update_parameters(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stream_selection(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.max_video_bits_per_second != 0 {
        object.key("maxVideoBitsPerSecond").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.max_video_bits_per_second).into()),
        );
    }
    if input.min_video_bits_per_second != 0 {
        object.key("minVideoBitsPerSecond").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.min_video_bits_per_second).into()),
        );
    }
...
pub fn serialize_structure_dash_encryption(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_118) = &input.speke_key_provider {
        ...
        crate::json_ser::serialize_structure_speke_key_provider(&mut object_119, var_118);
        object_119.finish();
    }
}

pub fn serialize_structure_hls_encryption(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_122) = &input.speke_key_provider {
        ...
        crate::json_ser::serialize_structure_speke_key_provider(&mut object_123, var_122);
        object_123.finish();
    }
}

pub fn serialize_structure_mss_encryption(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_124) = &input.speke_key_provider {
        ...
        crate::json_ser::serialize_structure_speke_key_provider(&mut object_125, var_124);
        object_125.finish();
    }
}
...
pub fn serialize_structure_speke_key_provider(
    ...
    if let Some(var_127) = &input.encryption_contract_configuration {
        ...
        crate::json_ser::serialize_structure_encryption_contract_configuration(
            &mut object_128,
            var_127,
        );
        object_128.finish();
...
pub fn serialize_structure_encryption_contract_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
