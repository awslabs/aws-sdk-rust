...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_channel::builders::DescribeChannelFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_channel::builders::DescribeChannelFluentBuilder::set_id):<br>required: **true**<br>The ID of a Channel.<br>
