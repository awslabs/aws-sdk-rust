...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_channel::builders::DeleteChannelFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_channel::builders::DeleteChannelFluentBuilder::set_id):<br>required: **true**<br>The ID of the Channel to delete.<br>
