...
impl super::Client {
    ...
    ///   - [`channel_id(impl ::std::convert::Into<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::channel_id) / [`set_channel_id(Option<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::set_channel_id): When specified, the request will return only OriginEndpoints associated with the given Channel ID.
    ///   - [`max_results(i32)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::set_max_results): The upper bound on the number of records to return.
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::set_next_token): A token used to resume pagination from the end of a previous request.
