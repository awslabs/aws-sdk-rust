...
impl Client  {
    ...
    pub fn describe_origin_endpoint(&self) -> crate::client::fluent_builders::DescribeOriginEndpoint {
    ...
    pub fn rotate_channel_credentials(&self) -> crate::client::fluent_builders::RotateChannelCredentials {
