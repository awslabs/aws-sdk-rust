...
/// For example, the [`ConfigureLogs`](crate::operation::configure_logs) operation has
/// a [`Client::configure_logs`], function which returns a builder for that operation.
...
/// 
/// ```no_run
/// # async fn wrapper() -> Result<(), aws_sdk_mediapackage::Error> {
...
mod describe_harvest_job;

mod describe_origin_endpoint;
...
mod rotate_channel_credentials;

mod rotate_ingest_endpoint_credentials;
