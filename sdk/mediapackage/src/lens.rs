...
pub(crate) fn reflens_list_harvest_jobs_output_next_token(
...
pub(crate) fn lens_list_channels_output_channels(
    input: crate::operation::list_channels::ListChannelsOutput,
...
pub(crate) fn lens_list_harvest_jobs_output_harvest_jobs(
    input: crate::operation::list_harvest_jobs::ListHarvestJobsOutput,
...
pub(crate) fn lens_list_origin_endpoints_output_origin_endpoints(
    input: crate::operation::list_origin_endpoints::ListOriginEndpointsOutput,
