...
pub fn de_delete_channel_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_channel::DeleteChannelOutput, crate::operation::delete_channel::DeleteChannelError> {
    ...
    Err(match error_code {
        ...
        "UnprocessableEntityException" => crate::operation::delete_channel::DeleteChannelError::UnprocessableEntityException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::UnprocessableEntityExceptionBuilder::default();
                    output = crate::protocol_serde::shape_unprocessable_entity_exception::de_unprocessable_entity_exception_json_err(_response_body, output).map_err(crate::operation::delete_channel::DeleteChannelError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
