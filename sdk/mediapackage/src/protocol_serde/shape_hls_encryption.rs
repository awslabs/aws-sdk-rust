...
pub(crate) fn de_hls_encryption<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HlsEncryption>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_hls_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsEncryption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
