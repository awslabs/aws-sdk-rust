...
pub(crate) fn de_cmaf_encryption<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CmafEncryption>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::cmaf_encryption_correct_errors(builder).build()))
        }
        _ => {
...
pub fn ser_cmaf_encryption(
    ...
    if let Some(var_3) = &input.key_rotation_interval_seconds {
        object.key("keyRotationIntervalSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    if let Some(var_4) = &input.speke_key_provider {
        #[allow(unused_mut)]
        let mut object_5 = object.key("spekeKeyProvider").start_object();
        crate::protocol_serde::shape_speke_key_provider::ser_speke_key_provider(&mut object_5, var_4)?;
        object_5.finish();
    }
    Ok(())
}
