...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_origin_endpoint::DescribeOriginEndpointError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_origin_endpoint::de_describe_origin_endpoint(_response_body, output)
            .map_err(crate::operation::describe_origin_endpoint::DescribeOriginEndpointError::unhandled)?;
