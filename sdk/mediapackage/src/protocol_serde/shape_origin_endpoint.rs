...
pub(crate) fn de_origin_endpoint<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OriginEndpoint>, aws_smithy_json::deserialize::error::DeserializeError>
