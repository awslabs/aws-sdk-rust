...
pub(crate) fn de_cmaf_package<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CmafPackage>, aws_smithy_json::deserialize::error::DeserializeError>
