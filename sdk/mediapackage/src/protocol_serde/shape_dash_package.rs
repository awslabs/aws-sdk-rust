...
pub fn ser_dash_package(
    ...
    if let Some(var_9) = &input.manifest_window_seconds {
        object.key("manifestWindowSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.min_buffer_time_seconds {
        object.key("minBufferTimeSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    if let Some(var_11) = &input.min_update_period_seconds {
        object.key("minUpdatePeriodSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    ...
    if let Some(var_16) = &input.segment_duration_seconds {
        object.key("segmentDurationSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    ...
    if let Some(var_18) = &input.stream_selection {
        ...
        crate::protocol_serde::shape_stream_selection::ser_stream_selection(&mut object_19, var_18)?;
        object_19.finish();
    }
    if let Some(var_20) = &input.suggested_presentation_delay_seconds {
        object.key("suggestedPresentationDelaySeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
