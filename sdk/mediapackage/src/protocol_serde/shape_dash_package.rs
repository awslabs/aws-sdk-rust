            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "adTriggers" => {
                            builder = builder.set_ad_triggers(crate::protocol_serde::shape_ad_triggers::de_ad_triggers(tokens)?);
                        }
                        "adsOnDeliveryRestrictions" => {
                            builder = builder.set_ads_on_delivery_restrictions(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AdsOnDeliveryRestrictions::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "encryption" => {
                        ...
                        "manifestLayout" => {
                            builder = builder.set_manifest_layout(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ManifestLayout::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "profile" => {
                            builder = builder.set_profile(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::Profile::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "utcTiming" => {
                            builder = builder.set_utc_timing(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::UtcTiming::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "utcTimingUri" => {
