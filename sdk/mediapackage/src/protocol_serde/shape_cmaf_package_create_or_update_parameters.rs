...
pub fn ser_cmaf_package_create_or_update_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CmafPackageCreateOrUpdateParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
