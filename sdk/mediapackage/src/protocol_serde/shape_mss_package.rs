...
pub(crate) fn de_mss_package<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MssPackage>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_mss_package(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MssPackage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
