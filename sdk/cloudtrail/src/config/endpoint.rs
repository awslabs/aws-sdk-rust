...
/// Endpoint resolver trait specific to AWS CloudTrail
                ...
                ref_val if ref_val >= 100_000_000 => {
                    return match (ref_val - 100_000_000) as usize {
                        ...
                        6 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://cloudtrail.us-gov-east-1.amazonaws.com".to_string())
                                .build(),
                        ),
                        7 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://cloudtrail.us-gov-west-1.amazonaws.com".to_string())
                                .build(),
                        ),
                        8 => {
                            let region = params.region.as_deref().unwrap_or_default();
