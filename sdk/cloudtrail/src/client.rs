...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_cloudtrail::Error> {
/// # let client: aws_sdk_cloudtrail::Client = unimplemented!();
...
mod deregister_organization_delegated_admin;
