...
impl GetInsightSelectorsInput {
    /// Consumes the builder and constructs an Operation<[`GetInsightSelectors`](crate::operation::get_insight_selectors::GetInsightSelectors)>
    #[allow(unused_mut)]
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInsightSelectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_insight_selectors::de_get_insight_selectors_http_response_with_props(status, headers, body)
        }
    }
}
