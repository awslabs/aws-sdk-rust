...
impl StopImportInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_import::StopImport::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StopImport {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_import::de_stop_import_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_import::de_stop_import_http_response_with_props(
                status, headers, body,
            )
        }
    }
