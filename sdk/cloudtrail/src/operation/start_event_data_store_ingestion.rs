    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartEventDataStoreIngestion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartEventDataStoreIngestion", "cloudtrail"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartEventDataStoreIngestion")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartEventDataStoreIngestionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartEventDataStoreIngestionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartEventDataStoreIngestionEndpointParamsInterceptor {
...
pub type StartEventDataStoreIngestionErrorKind = StartEventDataStoreIngestionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartEventDataStoreIngestionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionError {
...
impl StartEventDataStoreIngestionError {
    ...
    /// Creates the `StartEventDataStoreIngestionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
