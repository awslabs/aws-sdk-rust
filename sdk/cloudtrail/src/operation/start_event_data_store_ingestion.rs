...
/// `ParseStrictResponse` impl for `StartEventDataStoreIngestion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEventDataStoreIngestion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_event_data_store_ingestion::de_start_event_data_store_ingestion_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for StartEventDataStoreIngestionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionError
{
