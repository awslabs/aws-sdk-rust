...
impl StartEventDataStoreIngestionInput {
    /// Consumes the builder and constructs an Operation<[`StartEventDataStoreIngestion`](crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestion)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestion,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_event_data_store_ingestion::ser_start_event_data_store_ingestion_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestion::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("StartEventDataStoreIngestion", "cloudtrail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEventDataStoreIngestion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_event_data_store_ingestion::de_start_event_data_store_ingestion_http_response_with_props(
                status, headers, body,
            )
        }
    }
