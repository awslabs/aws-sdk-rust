...
impl CreateDashboard {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudtrail", "CreateDashboard", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "CloudTrail_20131101.CreateDashboard",
            );
            builder
        };
...
impl CreateDashboardError {
    ...
    /// Returns `true` if the error kind is `CreateDashboardError::UnsupportedOperationException`.
