...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartImportError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::AccountHasOngoingImportException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::InvalidImportSourceException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
...
impl ::std::error::Error for StartImportError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::AccountHasOngoingImportException(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::InvalidImportSourceException(_inner) => ::std::option::Option::Some(_inner),
