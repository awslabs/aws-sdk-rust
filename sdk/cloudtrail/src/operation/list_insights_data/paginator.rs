...
/// Paginator for [`ListInsightsData`](crate::operation::list_insights_data::ListInsightsData)
pub struct ListInsightsDataPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_insights_data::builders::ListInsightsDataInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListInsightsDataPaginator {
    ...
    pub fn items(self) -> crate::operation::list_insights_data::paginator::ListInsightsDataPaginatorItems {
        crate::operation::list_insights_data::paginator::ListInsightsDataPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_insights_data::ListInsightsData::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_insights_data_output_output_next_token(resp);
...
/// Flattened paginator for `ListInsightsDataPaginator`
///
/// This is created with [`.items()`](ListInsightsDataPaginator::items)
pub struct ListInsightsDataPaginatorItems(ListInsightsDataPaginator);

impl ListInsightsDataPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_insights_data_output_output_events(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
