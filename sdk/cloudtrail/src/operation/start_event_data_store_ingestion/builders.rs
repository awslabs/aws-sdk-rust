...
impl crate::operation::start_event_data_store_ingestion::builders::StartEventDataStoreIngestionInputBuilder {
...
impl StartEventDataStoreIngestionFluentBuilder {
    /// Creates a new `StartEventDataStoreIngestionFluentBuilder`.
