...
impl StartQuery {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudTrail", "StartQuery", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartQuery {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("StartQuery", "CloudTrail"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartQueryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("QueryStatement") {
            if let ::std::option::Option::Some(value) = input.query_statement.as_deref() {
                captured.insert("QueryStatement", value);
            }
        }
        if requested.should_capture("DeliveryS3Uri") {
            if let ::std::option::Option::Some(value) = input.delivery_s3_uri.as_deref() {
                captured.insert("DeliveryS3Uri", value);
            }
        }
