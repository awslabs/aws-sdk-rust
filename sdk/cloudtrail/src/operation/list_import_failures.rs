...
impl ListImportFailuresInput {
    /// Consumes the builder and constructs an Operation<[`ListImportFailures`](crate::operation::list_import_failures::ListImportFailures)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_import_failures::ListImportFailures, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_import_failures::ListImportFailuresInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_import_failures::ser_list_import_failures_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_import_failures::ListImportFailures::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListImportFailures {
                type Output = std::result::Result<crate::operation::list_import_failures::ListImportFailuresOutput, crate::operation::list_import_failures::ListImportFailuresError>;
