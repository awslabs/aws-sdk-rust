...
impl ListImportFailuresInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_import_failures::ser_list_import_failures_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_import_failures::ListImportFailures::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImportFailures {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_import_failures::de_list_import_failures_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_import_failures::ListImportFailuresError
{
