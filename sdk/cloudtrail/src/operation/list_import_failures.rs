...
impl ListImportFailuresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_import_failures::ListImportFailures,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_import_failures::ser_list_import_failures_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImportFailures {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_import_failures::de_list_import_failures_http_response_with_props(status, headers, body)
        }
    }
}
