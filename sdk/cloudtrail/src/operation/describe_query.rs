...
impl DescribeQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_query::DescribeQuery,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_query::DescribeQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_query::de_describe_query_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_query::de_describe_query_http_response_with_props(
                status, headers, body,
            )
        }
    }
