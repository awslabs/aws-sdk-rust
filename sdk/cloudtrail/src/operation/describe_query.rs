...
impl DescribeQuery {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudTrail", "DescribeQuery", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudTrail.DescribeQuery",
                "rpc.service" = "CloudTrail",
                "rpc.method" = "DescribeQuery",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeQuery")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribeQueryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeQueryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeQueryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeQueryInput>() else {
        ...
        if requested.should_capture("QueryAlias") {
            if let ::std::option::Option::Some(value) = input.query_alias.as_deref() {
                captured.insert("QueryAlias", value);
            }
        }
        if requested.should_capture("RefreshId") {
            if let ::std::option::Option::Some(value) = input.refresh_id.as_deref() {
                captured.insert("RefreshId", value);
            }
        }
        if requested.should_capture("EventDataStoreOwnerAccountId") {
            if let ::std::option::Option::Some(value) = input.event_data_store_owner_account_id.as_deref() {
                captured.insert("EventDataStoreOwnerAccountId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeQueryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_query::de_describe_query_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_query::de_describe_query_http_response(status, headers, body, _cfg)
        };
