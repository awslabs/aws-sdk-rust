...
impl DescribeQueryInput {
    /// Consumes the builder and constructs an Operation<[`DescribeQuery`](crate::operation::describe_query::DescribeQuery)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_query::DescribeQuery, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_query::ser_describe_query_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_query::DescribeQuery::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeQuery {
    type Output = ::std::result::Result<crate::operation::describe_query::DescribeQueryOutput, crate::operation::describe_query::DescribeQueryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_query::de_describe_query_http_response_with_props(status, headers, body)
        }
    }
}
