...
impl DeleteEventDataStoreInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_event_data_store::DeleteEventDataStore, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_event_data_store::DeleteEventDataStoreInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_event_data_store::DeleteEventDataStore::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEventDataStore {
                type Output = std::result::Result<crate::operation::delete_event_data_store::DeleteEventDataStoreOutput, crate::operation::delete_event_data_store::DeleteEventDataStoreError>;
