...
impl ListEventDataStoresInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_event_data_stores::ser_list_event_data_stores_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_event_data_stores::ListEventDataStores::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_event_data_stores::ListEventDataStoresError
{
