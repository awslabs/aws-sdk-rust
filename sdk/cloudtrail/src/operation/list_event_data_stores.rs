...
impl ListEventDataStoresInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_event_data_stores::ListEventDataStores,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEventDataStores {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_event_data_stores::de_list_event_data_stores_http_response_with_props(status, headers, body)
        }
    }
}
