...
/// Orchestration and serialization glue logic for `ListEventDataStores`.
...
impl ListEventDataStores {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_event_data_stores::ListEventDataStoresInput,
                    ) -> ::std::result::Result<crate::operation::list_event_data_stores::ListEventDataStoresOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_event_data_stores::ListEventDataStoresError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_event_data_stores::ListEventDataStoresError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_event_data_stores::ListEventDataStoresOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEventDataStores {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEventDataStores");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEventDataStoresRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEventDataStoresResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEventDataStores")
...
.with_interceptor(ListEventDataStoresEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_event_data_stores::ListEventDataStoresError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_event_data_stores::ListEventDataStoresError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_event_data_stores::ListEventDataStoresError>::new());
...
#[derive(Debug)]
            struct ListEventDataStoresResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEventDataStoresResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_event_data_stores::de_list_event_data_stores_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_event_data_stores::de_list_event_data_stores_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListEventDataStoresRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEventDataStoresRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_event_data_stores::ListEventDataStoresInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_event_data_stores::ListEventDataStoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_event_data_stores::ser_list_event_data_stores_input(&input)?);
...
#[derive(Debug)]
            struct ListEventDataStoresEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEventDataStoresEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEventDataStoresEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEventDataStoresInput>()
                        .ok_or("failed to downcast to ListEventDataStoresInput")?;
...
pub enum ListEventDataStoresError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEventDataStoresError) for what information is available for the error.")]
...
impl ListEventDataStoresError {
    /// Creates the `ListEventDataStoresError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEventDataStoresError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEventDataStoresError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_event_data_stores::ListEventDataStoresError {
...
mod _list_event_data_stores_output;
