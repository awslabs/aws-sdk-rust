...
impl UpdateChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateChannel`](crate::operation::update_channel::UpdateChannel)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_channel::UpdateChannel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_channel::ser_update_channel_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_channel::UpdateChannel::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateChannel", "cloudtrail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateChannel {
    type Output = ::std::result::Result<crate::operation::update_channel::UpdateChannelOutput, crate::operation::update_channel::UpdateChannelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_channel::de_update_channel_http_response_with_props(status, headers, body)
        }
    }
}
