...
impl PutEventSelectorsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_event_selectors::PutEventSelectors::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutEventSelectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_event_selectors::de_put_event_selectors_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_event_selectors::PutEventSelectorsError
{
