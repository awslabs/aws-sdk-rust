...
impl GetEventSelectorsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_event_selectors::GetEventSelectorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_event_selectors::GetEventSelectorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_event_selectors::GetEventSelectorsOutput, crate::operation::get_event_selectors::GetEventSelectorsError, Self> {
