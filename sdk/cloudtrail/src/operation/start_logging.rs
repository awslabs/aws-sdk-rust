...
impl ::aws_smithy_http::response::ParseStrictResponse for StartLogging {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_logging::de_start_logging_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_logging::de_start_logging_http_response_with_props(
                status, headers, body,
            )
        }
    }
