...
impl GetEventDataStoreInput {
    /// Consumes the builder and constructs an Operation<[`GetEventDataStore`](crate::operation::get_event_data_store::GetEventDataStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_event_data_store::GetEventDataStore, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_event_data_store::GetEventDataStoreInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_event_data_store::ser_get_event_data_store_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_event_data_store::GetEventDataStore::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetEventDataStore {
                type Output = std::result::Result<crate::operation::get_event_data_store::GetEventDataStoreOutput, crate::operation::get_event_data_store::GetEventDataStoreError>;
