...
impl GetEventDataStoreInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_event_data_store::ser_get_event_data_store_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_event_data_store::GetEventDataStore::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEventDataStore {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_event_data_store::de_get_event_data_store_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_event_data_store::GetEventDataStoreError
{
