...
impl LookupEventsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::lookup_events::LookupEventsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::lookup_events::LookupEventsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::lookup_events::LookupEventsOutput, crate::operation::lookup_events::LookupEventsError, Self> {
