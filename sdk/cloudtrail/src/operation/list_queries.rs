...
impl ListQueriesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_queries::ListQueries,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_queries::ListQueries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQueries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_queries::de_list_queries_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_queries::de_list_queries_http_response_with_props(
                status, headers, body,
            )
        }
    }
