...
impl ListQueriesInput {
    /// Consumes the builder and constructs an Operation<[`ListQueries`](crate::operation::list_queries::ListQueries)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_queries::ListQueries, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_queries::ser_list_queries_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_queries::ListQueries::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQueries {
    type Output = ::std::result::Result<crate::operation::list_queries::ListQueriesOutput, crate::operation::list_queries::ListQueriesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_queries::de_list_queries_http_response_with_props(status, headers, body)
        }
    }
}
