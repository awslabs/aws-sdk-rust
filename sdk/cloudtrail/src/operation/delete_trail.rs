...
impl DeleteTrailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_trail::DeleteTrail, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_trail::ser_delete_trail_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_trail::de_delete_trail_http_response_with_props(status, headers, body)
        }
    }
}
