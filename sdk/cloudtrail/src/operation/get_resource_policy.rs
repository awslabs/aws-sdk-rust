...
impl GetResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudtrail", "GetResourcePolicy", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetResourcePolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetResourcePolicy", "cloudtrail"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            builder = _header_serialization_settings.set_default_header(
                ...
                "CloudTrail_20131101.GetResourcePolicy",
            );
            builder
        };
...
impl GetResourcePolicyError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::ResourceArnNotValidException(e) => e.meta(),
    ...
    /// Returns `true` if the error kind is `GetResourcePolicyError::OperationNotPermittedException`.
    pub fn is_operation_not_permitted_exception(&self) -> bool {
        matches!(self, Self::OperationNotPermittedException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::ResourceArnNotValidException`.
    pub fn is_resource_arn_not_valid_exception(&self) -> bool {
        matches!(self, Self::ResourceArnNotValidException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::ResourcePolicyNotFoundException`.
    pub fn is_resource_policy_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourcePolicyNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::ResourceTypeNotSupportedException`.
    pub fn is_resource_type_not_supported_exception(&self) -> bool {
        matches!(self, Self::ResourceTypeNotSupportedException(_))
    }
    /// Returns `true` if the error kind is `GetResourcePolicyError::UnsupportedOperationException`.
