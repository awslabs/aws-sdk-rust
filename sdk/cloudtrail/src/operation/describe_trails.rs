...
impl DescribeTrailsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_trails::DescribeTrails::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTrails {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_trails::de_describe_trails_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_trails::de_describe_trails_http_response(
                status, headers, body,
            )
        }
    }
