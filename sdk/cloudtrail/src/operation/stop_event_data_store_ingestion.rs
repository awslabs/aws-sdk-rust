...
impl StopEventDataStoreIngestion {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StopEventDataStoreIngestion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopEventDataStoreIngestion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopEventDataStoreIngestionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StopEventDataStoreIngestionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StopEventDataStoreIngestion")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopEventDataStoreIngestion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StopEventDataStoreIngestionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StopEventDataStoreIngestionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopEventDataStoreIngestionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopEventDataStoreIngestionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopEventDataStoreIngestionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_event_data_store_ingestion::de_stop_event_data_store_ingestion_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_stop_event_data_store_ingestion::de_stop_event_data_store_ingestion_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopEventDataStoreIngestionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_stop_event_data_store_ingestion::ser_stop_event_data_store_ingestion_input(&input)?,
        );
