...
impl crate::operation::stop_event_data_store_ingestion::builders::StopEventDataStoreIngestionInputBuilder {
...
impl StopEventDataStoreIngestionFluentBuilder {
    /// Creates a new `StopEventDataStoreIngestionFluentBuilder`.
