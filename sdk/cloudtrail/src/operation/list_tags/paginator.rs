...
/// Flattened paginator for `ListTagsPaginator`
                ...
                impl  ListTagsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::ResourceTag, aws_smithy_http::result::SdkError<crate::operation::list_tags::ListTagsError>>> + Unpin
                     {
