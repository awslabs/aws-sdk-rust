...
pub use crate::operation::get_event_configuration::_get_event_configuration_input::GetEventConfigurationInputBuilder;

pub use crate::operation::get_event_configuration::_get_event_configuration_output::GetEventConfigurationOutputBuilder;

impl crate::operation::get_event_configuration::builders::GetEventConfigurationInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_event_configuration();
...
pub struct GetEventConfigurationFluentBuilder {
    ...
    inner: crate::operation::get_event_configuration::builders::GetEventConfigurationInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_event_configuration::GetEventConfigurationOutput,
        crate::operation::get_event_configuration::GetEventConfigurationError,
    > for GetEventConfigurationFluentBuilder
{
    fn send(
        self,
...
impl GetEventConfigurationFluentBuilder {
    /// Creates a new `GetEventConfigurationFluentBuilder`.
    ...
    /// Access the GetEventConfiguration as a reference.
    pub fn as_input(&self) -> &crate::operation::get_event_configuration::builders::GetEventConfigurationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_event_configuration::GetEventConfiguration::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_event_configuration::GetEventConfiguration::orchestrate(&runtime_plugins, input).await
    }
