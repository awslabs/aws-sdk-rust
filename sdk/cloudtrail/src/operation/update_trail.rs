...
impl UpdateTrailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_trail::UpdateTrail, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_trail::ser_update_trail_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTrail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_trail::de_update_trail_http_response_with_props(status, headers, body)
        }
    }
}
