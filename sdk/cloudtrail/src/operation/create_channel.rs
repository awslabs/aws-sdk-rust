...
impl CreateChannelInput {
    /// Consumes the builder and constructs an Operation<[`CreateChannel`](crate::operation::create_channel::CreateChannel)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_channel::CreateChannel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_channel::ser_create_channel_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_channel::CreateChannel::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateChannel", "cloudtrail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateChannel {
    type Output = ::std::result::Result<crate::operation::create_channel::CreateChannelOutput, crate::operation::create_channel::CreateChannelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_channel::de_create_channel_http_response_with_props(status, headers, body)
        }
    }
}
