...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterOrganizationDelegatedAdmin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_organization_delegated_admin::de_register_organization_delegated_admin_http_response_with_props(status, headers, body)
        }
    }
}
