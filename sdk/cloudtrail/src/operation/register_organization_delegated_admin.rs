...
impl RegisterOrganizationDelegatedAdminInput {
    /// Consumes the builder and constructs an Operation<[`RegisterOrganizationDelegatedAdmin`](crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdmin)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdmin::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterOrganizationDelegatedAdmin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_organization_delegated_admin::de_register_organization_delegated_admin_http_response_with_props(
                status, headers, body,
            )
        }
    }
