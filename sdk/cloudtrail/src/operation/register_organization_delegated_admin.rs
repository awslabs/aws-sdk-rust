...
/// Orchestration and serialization glue logic for `RegisterOrganizationDelegatedAdmin`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterOrganizationDelegatedAdmin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterOrganizationDelegatedAdmin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterOrganizationDelegatedAdminRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterOrganizationDelegatedAdminResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterOrganizationDelegatedAdmin")
...
.with_interceptor(RegisterOrganizationDelegatedAdminEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError>::new());
...
#[derive(Debug)]
            struct RegisterOrganizationDelegatedAdminResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterOrganizationDelegatedAdminResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_organization_delegated_admin::de_register_organization_delegated_admin_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_register_organization_delegated_admin::de_register_organization_delegated_admin_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RegisterOrganizationDelegatedAdminRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterOrganizationDelegatedAdminRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_organization_delegated_admin::ser_register_organization_delegated_admin_input(&input)?);
...
#[derive(Debug)]
            struct RegisterOrganizationDelegatedAdminEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterOrganizationDelegatedAdminEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterOrganizationDelegatedAdminEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterOrganizationDelegatedAdminInput>()
                        .ok_or("failed to downcast to RegisterOrganizationDelegatedAdminInput")?;
...
pub enum RegisterOrganizationDelegatedAdminError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterOrganizationDelegatedAdminError) for what information is available for the error.")]
...
impl RegisterOrganizationDelegatedAdminError {
    /// Creates the `RegisterOrganizationDelegatedAdminError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterOrganizationDelegatedAdminError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AccountRegisteredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::CannotDelegateManagementAccountException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterOrganizationDelegatedAdminError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError {
...
mod _register_organization_delegated_admin_output;
