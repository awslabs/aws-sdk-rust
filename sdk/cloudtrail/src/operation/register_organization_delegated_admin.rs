...
impl RegisterOrganizationDelegatedAdmin {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RegisterOrganizationDelegatedAdmin",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterOrganizationDelegatedAdmin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterOrganizationDelegatedAdminRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterOrganizationDelegatedAdminResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterOrganizationDelegatedAdmin")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterOrganizationDelegatedAdmin")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterOrganizationDelegatedAdminTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RegisterOrganizationDelegatedAdminTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterOrganizationDelegatedAdminTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterOrganizationDelegatedAdminInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterOrganizationDelegatedAdminResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_organization_delegated_admin::de_register_organization_delegated_admin_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_organization_delegated_admin::de_register_organization_delegated_admin_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterOrganizationDelegatedAdminRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_register_organization_delegated_admin::ser_register_organization_delegated_admin_input(&input)?,
        );
...
impl ::std::error::Error for RegisterOrganizationDelegatedAdminError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::AccountRegisteredException(_inner) => ::std::option::Option::Some(_inner),
            Self::CannotDelegateManagementAccountException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterOrganizationDelegatedAdminError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AccountRegisteredException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::CannotDelegateManagementAccountException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::DelegatedAdminAccountLimitExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
