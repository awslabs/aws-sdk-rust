...
impl GetEventSelectorsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_event_selectors::ser_get_event_selectors_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEventSelectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_event_selectors::de_get_event_selectors_http_response_with_props(status, headers, body)
        }
    }
}
