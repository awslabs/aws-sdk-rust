...
impl GetEventSelectorsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_event_selectors::GetEventSelectors::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEventSelectors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_event_selectors::de_get_event_selectors_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_event_selectors::GetEventSelectorsError
{
