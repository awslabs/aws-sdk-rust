...
impl LookupEventsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::lookup_events::LookupEvents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for LookupEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_lookup_events::de_lookup_events_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_lookup_events::de_lookup_events_http_response_with_props(
                status, headers, body,
            )
        }
    }
