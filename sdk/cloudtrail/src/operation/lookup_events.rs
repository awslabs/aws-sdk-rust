...
impl LookupEventsInput {
    /// Consumes the builder and constructs an Operation<[`LookupEvents`](crate::operation::lookup_events::LookupEvents)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::lookup_events::LookupEvents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_lookup_events::ser_lookup_events_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::lookup_events::LookupEvents::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for LookupEvents {
    type Output = ::std::result::Result<crate::operation::lookup_events::LookupEventsOutput, crate::operation::lookup_events::LookupEventsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_lookup_events::de_lookup_events_http_response_with_props(status, headers, body)
        }
    }
}
