...
impl GetTrailStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_trail_status::GetTrailStatus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_trail_status::ser_get_trail_status_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTrailStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_trail_status::de_get_trail_status_http_response_with_props(status, headers, body)
        }
    }
}
