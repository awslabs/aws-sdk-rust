...
impl UpdateTrailInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_trail::UpdateTrailInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
            crate::operation::update_trail::UpdateTrailInput {
                name: self.name
                ,
