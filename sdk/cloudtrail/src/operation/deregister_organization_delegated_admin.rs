...
impl DeregisterOrganizationDelegatedAdminInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdmin,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdmin::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterOrganizationDelegatedAdmin {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_organization_delegated_admin::de_deregister_organization_delegated_admin_http_response_with_props(
                status, headers, body,
            )
        }
    }
