...
impl DeregisterOrganizationDelegatedAdmin {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdminError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdminOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DeregisterOrganizationDelegatedAdmin",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterOrganizationDelegatedAdmin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeregisterOrganizationDelegatedAdminRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeregisterOrganizationDelegatedAdminResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeregisterOrganizationDelegatedAdmin")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterOrganizationDelegatedAdmin")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeregisterOrganizationDelegatedAdminTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeregisterOrganizationDelegatedAdminTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterOrganizationDelegatedAdminTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeregisterOrganizationDelegatedAdminInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("DelegatedAdminAccountId") {
            if let ::std::option::Option::Some(value) = input.delegated_admin_account_id.as_deref() {
                captured.insert("DelegatedAdminAccountId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterOrganizationDelegatedAdminResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_deregister_organization_delegated_admin::de_deregister_organization_delegated_admin_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_deregister_organization_delegated_admin::de_deregister_organization_delegated_admin_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterOrganizationDelegatedAdminRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdminInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdminInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_organization_delegated_admin::ser_deregister_organization_delegated_admin_input(&input)?,
        );
