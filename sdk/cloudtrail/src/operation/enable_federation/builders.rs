...
impl EnableFederationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_federation::EnableFederationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_federation::EnableFederationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_federation::EnableFederationOutput, crate::operation::enable_federation::EnableFederationError, Self> {
