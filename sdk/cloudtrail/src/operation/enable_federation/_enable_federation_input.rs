...
impl EnableFederationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_federation::EnableFederationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::enable_federation::EnableFederationInput {
