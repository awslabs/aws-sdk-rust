...
impl ListTrailsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_trails::ListTrails, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_trails::ser_list_trails_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_trails::de_list_trails_http_response_with_props(status, headers, body)
        }
    }
}
