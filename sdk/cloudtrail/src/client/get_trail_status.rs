...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::get_trail_status::builders::GetTrailStatusFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_trail_status::builders::GetTrailStatusFluentBuilder::set_name): <p>Specifies the name or the CloudTrail ARN of the trail for which you are requesting status. To get the status of a shadow trail (a replication of the trail in another region), you must specify its ARN. The following is the format of a trail ARN.</p>  <p> <code>arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail</code> </p>
