...
impl super::Client {
    ...
    ///   - [`tags_list(Tag)`](crate::operation::remove_tags::builders::RemoveTagsFluentBuilder::tags_list) / [`set_tags_list(Option<Vec<Tag>>)`](crate::operation::remove_tags::builders::RemoveTagsFluentBuilder::set_tags_list): <p>Specifies a list of tags to be removed.</p>
