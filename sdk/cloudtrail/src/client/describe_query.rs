...
impl super::Client {
    ...
    ///   - [`refresh_id(impl Into<String>)`](crate::operation::describe_query::builders::DescribeQueryFluentBuilder::refresh_id) / [`set_refresh_id(Option<String>)`](crate::operation::describe_query::builders::DescribeQueryFluentBuilder::set_refresh_id):<br>required: **false**<br><p>The ID of the dashboard refresh.</p><br>
    ///   - [`event_data_store_owner_account_id(impl Into<String>)`](crate::operation::describe_query::builders::DescribeQueryFluentBuilder::event_data_store_owner_account_id) / [`set_event_data_store_owner_account_id(Option<String>)`](crate::operation::describe_query::builders::DescribeQueryFluentBuilder::set_event_data_store_owner_account_id):<br>required: **false**<br><p>The account ID of the event data store owner.</p><br>
    ...
    ///   - [`event_data_store_owner_account_id(Option<String>)`](crate::operation::describe_query::DescribeQueryOutput::event_data_store_owner_account_id): <p>The account ID of the event data store owner.</p>
