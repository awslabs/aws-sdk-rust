...
impl super::Client {
    ...
    ///   - [`query_alias(impl ::std::convert::Into<String>)`](crate::operation::describe_query::builders::DescribeQueryFluentBuilder::query_alias) / [`set_query_alias(Option<String>)`](crate::operation::describe_query::builders::DescribeQueryFluentBuilder::set_query_alias): <p> The alias that identifies a query template. </p>
