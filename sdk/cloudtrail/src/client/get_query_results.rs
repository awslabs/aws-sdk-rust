...
impl super::Client {
    ...
    ///   - [`event_data_store_owner_account_id(impl Into<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::event_data_store_owner_account_id) / [`set_event_data_store_owner_account_id(Option<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::set_event_data_store_owner_account_id):<br>required: **false**<br><p>The account ID of the event data store owner.</p><br>
