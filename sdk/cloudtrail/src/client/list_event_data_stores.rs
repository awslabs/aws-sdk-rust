...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_event_data_stores::builders::ListEventDataStoresFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_event_data_stores::builders::ListEventDataStoresFluentBuilder::set_next_token):<br>required: **false**<br><p>A token you can use to get the next page of event data store results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_event_data_stores::builders::ListEventDataStoresFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_event_data_stores::builders::ListEventDataStoresFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of event data stores to display on a single page.</p><br>
