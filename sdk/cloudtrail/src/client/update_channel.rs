...
impl super::Client {
    ...
    ///   - [`channel(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::channel) / [`set_channel(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_channel): <p>The ARN or ID (the ARN suffix) of the channel that you want to update.</p>
    ///   - [`destinations(Destination)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::destinations) / [`set_destinations(Option<Vec<Destination>>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_destinations): <p>The ARNs of event data stores that you want to log events arriving through the channel.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_channel::builders::UpdateChannelFluentBuilder::set_name): <p> Changes the name of the channel. </p>
