...
impl super::Client {
    ...
    ///   - [`event_data_store_owner_account_id(impl Into<String>)`](crate::operation::start_query::builders::StartQueryFluentBuilder::event_data_store_owner_account_id) / [`set_event_data_store_owner_account_id(Option<String>)`](crate::operation::start_query::builders::StartQueryFluentBuilder::set_event_data_store_owner_account_id):<br>required: **false**<br><p>The account ID of the event data store owner.</p><br>
    ...
    ///   - [`event_data_store_owner_account_id(Option<String>)`](crate::operation::start_query::StartQueryOutput::event_data_store_owner_account_id): <p>The account ID of the event data store owner.</p>
