...
impl super::Client {
    ...
    ///   - [`billing_mode(Option<BillingMode>)`](crate::operation::restore_event_data_store::RestoreEventDataStoreOutput::billing_mode): <p>The billing mode for the event data store.</p>
