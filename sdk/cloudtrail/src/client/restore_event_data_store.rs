...
impl super::Client {
    ...
    ///   - [`event_data_store(impl ::std::convert::Into<String>)`](crate::operation::restore_event_data_store::builders::RestoreEventDataStoreFluentBuilder::event_data_store) / [`set_event_data_store(Option<String>)`](crate::operation::restore_event_data_store::builders::RestoreEventDataStoreFluentBuilder::set_event_data_store): <p>The ARN (or the ID suffix of the ARN) of the event data store that you want to restore.</p>
