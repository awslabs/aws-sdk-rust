...
impl super::Client  {
    ...
    pub fn restore_event_data_store(&self) -> crate::client::fluent_builders::RestoreEventDataStore {
                                crate::client::fluent_builders::RestoreEventDataStore::new(self.handle.clone())
                            }
}
