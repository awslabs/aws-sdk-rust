...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_public_keys::builders::ListPublicKeysFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_public_keys::builders::ListPublicKeysFluentBuilder::set_next_token): <p>Reserved for future use.</p>
