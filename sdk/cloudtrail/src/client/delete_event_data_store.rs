...
impl super::Client {
    ...
    ///   - [`event_data_store(impl Into<String>)`](crate::operation::delete_event_data_store::builders::DeleteEventDataStoreFluentBuilder::event_data_store) / [`set_event_data_store(Option<String>)`](crate::operation::delete_event_data_store::builders::DeleteEventDataStoreFluentBuilder::set_event_data_store):<br>required: **true**<br><p>The ARN (or the ID suffix of the ARN) of the event data store to delete.</p><br>
