...
impl super::Client {
    ...
    ///   - [`tags_list(Tag)`](crate::operation::add_tags::builders::AddTagsFluentBuilder::tags_list) / [`set_tags_list(Option<Vec<Tag>>)`](crate::operation::add_tags::builders::AddTagsFluentBuilder::set_tags_list): <p>Contains a list of tags, up to a limit of 50</p>
