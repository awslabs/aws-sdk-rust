...
impl super::Client {
    ...
    ///   - [`destinations(Vec<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::destinations) / [`set_destinations(Option<Vec<String>>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_destinations): <p> The ARN of the destination event data store. Use this parameter for a new import. </p>
    ///   - [`import_source(ImportSource)`](crate::operation::start_import::builders::StartImportFluentBuilder::import_source) / [`set_import_source(Option<ImportSource>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_import_source): <p> The source S3 bucket for the import. Use this parameter for a new import. </p>
    ///   - [`start_event_time(DateTime)`](crate::operation::start_import::builders::StartImportFluentBuilder::start_event_time) / [`set_start_event_time(Option<DateTime>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_start_event_time): <p> Use with <code>EndEventTime</code> to bound a <code>StartImport</code> request, and limit imported trail events to only those events logged within a specified time period. When you specify a time range, CloudTrail checks the prefix and log file names to verify the names contain a date between the specified <code>StartEventTime</code> and <code>EndEventTime</code> before attempting to import events. </p>
    ///   - [`end_event_time(DateTime)`](crate::operation::start_import::builders::StartImportFluentBuilder::end_event_time) / [`set_end_event_time(Option<DateTime>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_end_event_time): <p> Use with <code>StartEventTime</code> to bound a <code>StartImport</code> request, and limit imported trail events to only those events logged within a specified time period. When you specify a time range, CloudTrail checks the prefix and log file names to verify the names contain a date between the specified <code>StartEventTime</code> and <code>EndEventTime</code> before attempting to import events. </p>
    ///   - [`import_id(impl ::std::convert::Into<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::import_id) / [`set_import_id(Option<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_import_id): <p> The ID of the import. Use this parameter when you are retrying an import. </p>
