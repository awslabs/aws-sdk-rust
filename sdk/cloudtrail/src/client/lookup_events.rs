...
impl super::Client {
    ...
    ///   - [`lookup_attributes(Vec<LookupAttribute>)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::lookup_attributes) / [`set_lookup_attributes(Option<Vec<LookupAttribute>>)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::set_lookup_attributes): <p>Contains a list of lookup attributes. Currently the list can contain only one item.</p>
    ...
    ///   - [`event_category(EventCategory)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::event_category) / [`set_event_category(Option<EventCategory>)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::set_event_category): <p>Specifies the event category. If you do not specify an event category, events of the category are not returned in the response. For example, if you do not specify <code>insight</code> as the value of <code>EventCategory</code>, no Insights events are returned.</p>
    ///   - [`max_results(i32)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::set_max_results): <p>The number of events to return. Possible values are 1 through 50. The default is 50.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::lookup_events::builders::LookupEventsFluentBuilder::set_next_token): <p>The token to use to get the next page of results after a previous API call. This token must be passed in with the same parameters that were specified in the original call. For example, if the original call specified an AttributeKey of 'Username' with a value of 'root', the call with NextToken should include those same parameters.</p>
