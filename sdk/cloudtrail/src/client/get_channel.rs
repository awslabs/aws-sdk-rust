...
impl super::Client {
    ...
    ///   - [`channel(impl ::std::convert::Into<String>)`](crate::operation::get_channel::builders::GetChannelFluentBuilder::channel) / [`set_channel(Option<String>)`](crate::operation::get_channel::builders::GetChannelFluentBuilder::set_channel): <p>The ARN or <code>UUID</code> of a channel.</p>
