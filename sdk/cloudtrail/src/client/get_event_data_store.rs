...
impl super::Client {
    ...
    ///   - [`event_data_store(impl ::std::convert::Into<String>)`](crate::operation::get_event_data_store::builders::GetEventDataStoreFluentBuilder::event_data_store) / [`set_event_data_store(Option<String>)`](crate::operation::get_event_data_store::builders::GetEventDataStoreFluentBuilder::set_event_data_store): <p>The ARN (or ID suffix of the ARN) of the event data store about which you want information.</p>
