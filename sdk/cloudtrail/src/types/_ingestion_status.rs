...
impl IngestionStatusBuilder {
    ...
    /// <p>The event ID of the most recent successful ingestion of events.</p>
    pub fn latest_ingestion_success_event_id(mut self, input: impl Into<std::string::String>) -> Self {
    ...
    /// <p>The event ID of the most recent attempt to ingest events.</p>
    pub fn latest_ingestion_attempt_event_id(mut self, input: impl Into<std::string::String>) -> Self {
