...
pub fn serialize_structure_create_trail_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_trail_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_trails_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_event_selectors_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_insight_selectors_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_trail_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_trail_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_public_keys_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_trails_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_lookup_events_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_40 in var_38 {
            {
                ...
                crate::json_ser::serialize_structure_lookup_attribute(&mut object_41, item_40);
                object_41.finish();
            }
        }
        array_39.finish();
...
pub fn serialize_structure_put_event_selectors_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_50 in var_48 {
            {
                ...
                crate::json_ser::serialize_structure_event_selector(&mut object_51, item_50);
                object_51.finish();
            }
        }
        array_49.finish();
        ...
        for item_54 in var_52 {
            {
                ...
                crate::json_ser::serialize_structure_advanced_event_selector(
                    &mut object_55,
                    item_54,
                );
                object_55.finish();
...
pub fn serialize_structure_put_insight_selectors_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_59 in var_57 {
            {
                ...
                crate::json_ser::serialize_structure_insight_selector(&mut object_60, item_59);
                object_60.finish();
            }
        }
        array_58.finish();
...
pub fn serialize_structure_start_logging_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_logging_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_trail_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_lookup_attribute(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_event_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_87 in var_85 {
            {
                ...
                crate::json_ser::serialize_structure_data_resource(&mut object_88, item_87);
                object_88.finish();
            }
        }
        array_86.finish();
...
pub fn serialize_structure_advanced_event_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_95 in var_93 {
            {
                ...
                crate::json_ser::serialize_structure_advanced_field_selector(
                    &mut object_96,
                    item_95,
                );
                object_96.finish();
...
pub fn serialize_structure_insight_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_data_resource(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_advanced_field_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
