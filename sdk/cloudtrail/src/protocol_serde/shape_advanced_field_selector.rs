...
pub fn ser_advanced_field_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AdvancedFieldSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_advanced_field_selector<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AdvancedFieldSelector>, aws_smithy_json::deserialize::error::DeserializeError>
