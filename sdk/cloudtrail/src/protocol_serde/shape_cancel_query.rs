    ...
    Err(match error_code {
        ...
        "InactiveQueryException" => crate::operation::cancel_query::CancelQueryError::InactiveQueryException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_inactive_query_exception::de_inactive_query_exception_json_err(_response_body, output)
                    .map_err(crate::operation::cancel_query::CancelQueryError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "QueryIdNotFoundException" => crate::operation::cancel_query::CancelQueryError::QueryIdNotFoundException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_query_id_not_found_exception::de_query_id_not_found_exception_json_err(_response_body, output)
                    .map_err(crate::operation::cancel_query::CancelQueryError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
...
) -> Result<crate::operation::cancel_query::builders::CancelQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
