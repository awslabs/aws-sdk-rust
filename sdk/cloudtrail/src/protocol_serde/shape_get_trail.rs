...
pub fn de_get_trail_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_trail::GetTrailOutput, crate::operation::get_trail::GetTrailError> {
    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Trail" => {
                    builder = builder.set_trail(crate::protocol_serde::shape_trail::de_trail(tokens)?);
                }
