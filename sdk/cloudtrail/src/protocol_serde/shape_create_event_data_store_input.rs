...
pub fn ser_create_event_data_store_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEventDataStoreInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
