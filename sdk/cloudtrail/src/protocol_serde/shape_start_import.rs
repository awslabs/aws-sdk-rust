    ...
    Err(match error_code {
        "AccountHasOngoingImportException" => crate::operation::start_import::StartImportError::AccountHasOngoingImportException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_account_has_ongoing_import_exception::de_account_has_ongoing_import_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::start_import::StartImportError::unhandled)?;
        ...
        "InvalidImportSourceException" => crate::operation::start_import::StartImportError::InvalidImportSourceException({
            ...
            let mut tmp = {
                ...
                output =
                    crate::protocol_serde::shape_invalid_import_source_exception::de_invalid_import_source_exception_json_err(_response_body, output)
                        .map_err(crate::operation::start_import::StartImportError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
