...
pub fn de_put_event_selectors_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_event_selectors::PutEventSelectorsOutput, crate::operation::put_event_selectors::PutEventSelectorsError>
{
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::put_event_selectors::PutEventSelectorsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InsufficientDependencyServiceAccessPermissionException" => {
            crate::operation::put_event_selectors::PutEventSelectorsError::InsufficientDependencyServiceAccessPermissionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoManagementAccountSLRExistsException" => {
            crate::operation::put_event_selectors::PutEventSelectorsError::NoManagementAccountSlrExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotOrganizationMasterAccountException" => {
            crate::operation::put_event_selectors::PutEventSelectorsError::NotOrganizationMasterAccountException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::put_event_selectors::PutEventSelectorsOutput, crate::operation::put_event_selectors::PutEventSelectorsError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_put_event_selectors::de_put_event_selectors(_response_body, output)
            .map_err(crate::operation::put_event_selectors::PutEventSelectorsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "EventSelectors" => {
                    builder = builder.set_event_selectors(crate::protocol_serde::shape_event_selectors::de_event_selectors(tokens)?);
                }
