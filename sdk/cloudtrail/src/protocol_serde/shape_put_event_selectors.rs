...
pub fn de_put_event_selectors_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_event_selectors::PutEventSelectorsOutput, crate::operation::put_event_selectors::PutEventSelectorsError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::operation::put_event_selectors::PutEventSelectorsError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ConflictExceptionBuilder::default();
                    output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(crate::operation::put_event_selectors::PutEventSelectorsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "ThrottlingException" => crate::operation::put_event_selectors::PutEventSelectorsError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ThrottlingExceptionBuilder::default();
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(_response_body, output).map_err(crate::operation::put_event_selectors::PutEventSelectorsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_event_selectors_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_event_selectors::PutEventSelectorsOutput, crate::operation::put_event_selectors::PutEventSelectorsError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_put_event_selectors_input(input: &crate::operation::put_event_selectors::PutEventSelectorsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
