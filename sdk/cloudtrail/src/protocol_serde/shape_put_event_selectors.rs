...
pub fn ser_put_event_selectors_input(
    ...
    crate::protocol_serde::shape_put_event_selectors_input::ser_put_event_selectors_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_put_event_selectors_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_event_selectors_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<crate::output::PutEventSelectorsOutput, crate::error::PutEventSelectorsError>
{
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_put_event_selectors::de_put_event_selectors(
...
pub(crate) fn de_put_event_selectors(
    ...
    crate::output::put_event_selectors_output::Builder,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "EventSelectors" => {
                        builder = builder.set_event_selectors(
                            crate::protocol_serde::shape_event_selectors::de_event_selectors(
                                tokens,
                            )?,
                        );
                    }
