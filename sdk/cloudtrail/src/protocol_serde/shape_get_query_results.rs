...
pub fn de_get_query_results_http_error(
    ...
    Err(match error_code {
        ...
        "InsufficientEncryptionPolicyException" => {
            crate::operation::get_query_results::GetQueryResultsError::InsufficientEncryptionPolicyException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoManagementAccountSLRExistsException" => {
            crate::operation::get_query_results::GetQueryResultsError::NoManagementAccountSlrExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_query_results_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_query_results::GetQueryResultsOutput, crate::operation::get_query_results::GetQueryResultsError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "QueryStatistics" => {
                    builder = builder.set_query_statistics(crate::protocol_serde::shape_query_statistics::de_query_statistics(tokens)?);
                }
                "QueryResultRows" => {
                    builder = builder.set_query_result_rows(crate::protocol_serde::shape_query_result_rows::de_query_result_rows(tokens)?);
                }
                "NextToken" => {
