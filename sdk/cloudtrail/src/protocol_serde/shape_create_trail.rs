...
pub fn ser_create_trail_input(input: &crate::operation::create_trail::CreateTrailInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
