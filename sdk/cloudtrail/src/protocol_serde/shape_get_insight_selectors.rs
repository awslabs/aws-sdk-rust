...
pub fn ser_get_insight_selectors_input(
    ...
    crate::protocol_serde::shape_get_insight_selectors_input::ser_get_insight_selectors_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_insight_selectors::GetInsightSelectorsError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_get_insight_selectors::de_get_insight_selectors(
