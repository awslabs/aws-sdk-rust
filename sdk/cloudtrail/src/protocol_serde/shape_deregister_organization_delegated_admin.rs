...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_organization_delegated_admin_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdminOutput, crate::operation::deregister_organization_delegated_admin::DeregisterOrganizationDelegatedAdminError>{
    Ok({
        #[allow(unused_mut)]
