...
pub fn de_get_import_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_import::GetImportOutput, crate::operation::get_import::GetImportError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::get_import::builders::GetImportOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
