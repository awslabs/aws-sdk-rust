...
pub(crate) fn de_event_data_store<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EventDataStore>, aws_smithy_json::deserialize::error::DeserializeError>
