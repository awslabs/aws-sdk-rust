...
pub fn ser_create_trail_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTrailInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
