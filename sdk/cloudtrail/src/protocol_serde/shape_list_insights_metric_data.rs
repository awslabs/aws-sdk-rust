...
pub fn de_list_insights_metric_data_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_insights_metric_data::ListInsightsMetricDataError::unhandled(
                generic,
            ))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_insights_metric_data_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_insights_metric_data::de_list_insights_metric_data(_response_body, output)
            .map_err(crate::operation::list_insights_metric_data::ListInsightsMetricDataError::unhandled)?;
...
pub fn ser_list_insights_metric_data_input(
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Timestamps" => {
                    builder = builder.set_timestamps(crate::protocol_serde::shape_timestamps::de_timestamps(tokens, _value, depth + 1)?);
                }
                "Values" => {
