...
pub(crate) fn de_advanced_event_selector<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AdvancedEventSelector>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "FieldSelectors" => {
                            builder = builder.set_field_selectors(
                                crate::protocol_serde::shape_advanced_field_selectors::de_advanced_field_selectors(tokens, _value, depth + 1)?,
                            );
                        }
