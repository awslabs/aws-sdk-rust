    ...
    Err(match error_code {
        ...
        "MaxConcurrentQueriesException" => crate::operation::start_query::StartQueryError::MaxConcurrentQueriesException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_max_concurrent_queries_exception::de_max_concurrent_queries_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::start_query::StartQueryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_query_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::start_query::StartQueryOutput, crate::operation::start_query::StartQueryError> {
...
) -> Result<crate::operation::start_query::builders::StartQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
