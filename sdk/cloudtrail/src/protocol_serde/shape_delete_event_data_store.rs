...
pub fn de_delete_event_data_store_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_event_data_store::DeleteEventDataStoreOutput, crate::operation::delete_event_data_store::DeleteEventDataStoreError> {
    ...
    Err(match error_code {
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(crate::operation::delete_event_data_store::DeleteEventDataStoreError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "EventDataStoreFederationEnabledException" => crate::operation::delete_event_data_store::DeleteEventDataStoreError::EventDataStoreFederationEnabledException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
