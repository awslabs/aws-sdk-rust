...
pub fn de_update_trail_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_trail::UpdateTrailOutput, crate::operation::update_trail::UpdateTrailError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cloud_trail_access_not_enabled_exception::de_cloud_trail_access_not_enabled_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cloud_trail_arn_invalid_exception::de_cloud_trail_arn_invalid_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_insufficient_encryption_policy_exception::de_insufficient_encryption_policy_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_insufficient_s3_bucket_policy_exception::de_insufficient_s3_bucket_policy_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_insufficient_sns_topic_policy_exception::de_insufficient_sns_topic_policy_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_event_selectors_exception::de_invalid_event_selectors_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_home_region_exception::de_invalid_home_region_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_kms_key_id_exception::de_invalid_kms_key_id_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_combination_exception::de_invalid_parameter_combination_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_exception::de_invalid_parameter_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_s3_bucket_name_exception::de_invalid_s3_bucket_name_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_s3_prefix_exception::de_invalid_s3_prefix_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_sns_topic_name_exception::de_invalid_sns_topic_name_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_trail_name_exception::de_invalid_trail_name_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_kms_exception::de_kms_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_kms_key_disabled_exception::de_kms_key_disabled_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_kms_key_not_found_exception::de_kms_key_not_found_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_operation_not_permitted_exception::de_operation_not_permitted_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_organizations_not_in_use_exception::de_organizations_not_in_use_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_s3_bucket_does_not_exist_exception::de_s3_bucket_does_not_exist_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_trail_not_found_exception::de_trail_not_found_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_trail_not_provided_exception::de_trail_not_provided_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unsupported_operation_exception::de_unsupported_operation_exception_json_err(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_trail_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_trail::UpdateTrailOutput, crate::operation::update_trail::UpdateTrailError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_trail::builders::UpdateTrailOutputBuilder::default();
        output = crate::protocol_serde::shape_update_trail::de_update_trail(_response_body, output).map_err(crate::operation::update_trail::UpdateTrailError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        output.build()
    })
}

pub fn ser_update_trail_input(input: &crate::operation::update_trail::UpdateTrailInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_trail_input::ser_update_trail_input_input(&mut object, input)?;
    object.finish();
