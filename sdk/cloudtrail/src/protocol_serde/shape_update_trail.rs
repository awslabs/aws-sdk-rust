...
pub fn de_update_trail_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_trail::UpdateTrailOutput, crate::operation::update_trail::UpdateTrailError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_trail_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_trail::UpdateTrailOutput, crate::operation::update_trail::UpdateTrailError> {
    Ok({
        #[allow(unused_mut)]
