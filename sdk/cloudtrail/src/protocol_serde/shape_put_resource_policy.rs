    ...
    Err(match error_code {
        ...
        "ResourceARNNotValidException" => crate::operation::put_resource_policy::PutResourcePolicyError::ResourceArnNotValidException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_resource_arn_not_valid_exception::de_resource_arn_not_valid_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
        ...
        "ResourcePolicyNotValidException" => crate::operation::put_resource_policy::PutResourcePolicyError::ResourcePolicyNotValidException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_resource_policy_not_valid_exception::de_resource_policy_not_valid_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_resource_policy::PutResourcePolicyError::unhandled)?;
