...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_organization_delegated_admin_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminOutput, crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_register_organization_delegated_admin_input(input: &crate::operation::register_organization_delegated_admin::RegisterOrganizationDelegatedAdminInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_register_organization_delegated_admin_input::ser_register_organization_delegated_admin_input_input(&mut object, input)?;
    object.finish();
