...
impl super::Client {
    ...
    ///   - [`agent_space_id(impl Into<String>)`](crate::operation::create_chat::builders::CreateChatFluentBuilder::agent_space_id) / [`set_agent_space_id(Option<String>)`](crate::operation::create_chat::builders::CreateChatFluentBuilder::set_agent_space_id):<br>required: **true**<br><p>The unique identifier for the agent space where the chat will be created.</p><br>
