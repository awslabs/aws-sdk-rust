...
///     RecommendationStatus::UpdateInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for RecommendationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "UPDATE_IN_PROGRESS" => RecommendationStatus::UpdateInProgress,
...
impl RecommendationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            RecommendationStatus::UpdateInProgress => "UPDATE_IN_PROGRESS",
...
impl ::std::fmt::Display for RecommendationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            RecommendationStatus::Closed => write!(f, "CLOSED"),
            ...
            RecommendationStatus::UpdateInProgress => write!(f, "UPDATE_IN_PROGRESS"),
