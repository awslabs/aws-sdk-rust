...
/// Paginator for [`ListTriggers`](crate::operation::list_triggers::ListTriggers)
pub struct ListTriggersPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_triggers::builders::ListTriggersInputBuilder,
...
impl ListTriggersPaginator {
    ...
    pub fn items(self) -> crate::operation::list_triggers::paginator::ListTriggersPaginatorItems {
        crate::operation::list_triggers::paginator::ListTriggersPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_triggers::ListTriggers::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_triggers_output_output_next_token(resp);
...
/// Flattened paginator for `ListTriggersPaginator`
///
/// This is created with [`.items()`](ListTriggersPaginator::items)
pub struct ListTriggersPaginatorItems(ListTriggersPaginator);

impl ListTriggersPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_triggers_output_output_items(page).unwrap_or_default().into_iter())
    }
}
