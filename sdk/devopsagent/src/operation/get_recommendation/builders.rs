...
pub use crate::operation::get_recommendation::_get_recommendation_input::GetRecommendationInputBuilder;

pub use crate::operation::get_recommendation::_get_recommendation_output::GetRecommendationOutputBuilder;

impl crate::operation::get_recommendation::builders::GetRecommendationInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_recommendation();
...
pub struct GetRecommendationFluentBuilder {
    ...
    inner: crate::operation::get_recommendation::builders::GetRecommendationInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_recommendation::GetRecommendationOutput,
        crate::operation::get_recommendation::GetRecommendationError,
    > for GetRecommendationFluentBuilder
{
    fn send(
        self,
...
impl GetRecommendationFluentBuilder {
    /// Creates a new `GetRecommendationFluentBuilder`.
    ...
    /// Access the GetRecommendation as a reference.
    pub fn as_input(&self) -> &crate::operation::get_recommendation::builders::GetRecommendationInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_recommendation::GetRecommendation::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_recommendation::GetRecommendation::orchestrate(&runtime_plugins, input).await
    }
