...
pub struct CreateAssetFileInput {
...
impl CreateAssetFileInput {
    /// Creates a new builder-style object to manufacture [`CreateAssetFileInput`](crate::operation::create_asset_file::CreateAssetFileInput).
    pub fn builder() -> crate::operation::create_asset_file::builders::CreateAssetFileInputBuilder {
        crate::operation::create_asset_file::builders::CreateAssetFileInputBuilder::default()
    }
}

/// A builder for [`CreateAssetFileInput`](crate::operation::create_asset_file::CreateAssetFileInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateAssetFileInputBuilder {
...
impl CreateAssetFileInputBuilder {
    /// <p>The unique identifier for the agent space containing the asset</p>
    ...
    /// Consumes the builder and constructs a [`CreateAssetFileInput`](crate::operation::create_asset_file::CreateAssetFileInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_asset_file::CreateAssetFileInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_asset_file::CreateAssetFileInput {
