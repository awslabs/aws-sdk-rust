...
impl ListServices {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("DevOps Agent", "ListServices", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "DevOps Agent.ListServices",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v1/services/list").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_services::ListServicesInput,
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.filter_service_type {
                    {
                        query.push_kv("filterServiceType", &::aws_smithy_http::query::fmt_string(inner_3.as_str()));
                    }
                }
                ::std::result::Result::Ok(())
            }
...
impl ListServicesError {
    ...
    /// Returns `true` if the error kind is `ListServicesError::ContentSizeExceededException`.
