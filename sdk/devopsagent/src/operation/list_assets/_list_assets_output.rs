...
pub struct ListAssetsOutput {
    ...
    pub items: ::std::vec::Vec<crate::types::Asset>,
...
impl ListAssetsOutput {
    /// <p>The list of assets for the agent space</p>
    pub fn items(&self) -> &[crate::types::Asset] {
        use std::ops::Deref;
        self.items.deref()
    }
    /// <p>Pagination token to retrieve the next page of results. Absent when there are no more results.</p>
...
pub struct ListAssetsOutputBuilder {
    pub(crate) items: ::std::option::Option<::std::vec::Vec<crate::types::Asset>>,
...
impl ListAssetsOutputBuilder {
    ...
    ///
    /// <p>The list of assets for the agent space</p>
    pub fn items(mut self, input: crate::types::Asset) -> Self {
    ...
    /// <p>The list of assets for the agent space</p>
    pub fn set_items(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::Asset>>) -> Self {
        self.items = input;
        self
    }
    /// <p>The list of assets for the agent space</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Asset>> {
        &self.items
    }
    /// <p>Pagination token to retrieve the next page of results. Absent when there are no more results.</p>
    ...
    /// - [`items`](crate::operation::list_assets::builders::ListAssetsOutputBuilder::items)
        ...
        ::std::result::Result::Ok(crate::operation::list_assets::ListAssetsOutput {
            items: self.items.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "items",
                    "items was not specified but it is required when building ListAssetsOutput",
                )
            })?,
