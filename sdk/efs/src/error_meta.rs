        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::CreateFileSystemErrorKind::InsufficientThroughputCapacity(
                        inner,
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::CreateMountTargetErrorKind::NetworkInterfaceLimitExceeded(
                        inner,
                    ...
                    crate::error::CreateMountTargetErrorKind::UnsupportedAvailabilityZone(
                        inner,
                    ) => Error::UnsupportedAvailabilityZone(inner),
    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::DescribeAccountPreferencesErrorKind::InternalServerError(
                        inner,
                    ) => Error::InternalServerError(inner),
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    ...
                    crate::error::UpdateFileSystemErrorKind::InsufficientThroughputCapacity(
                        inner,
                    ) => Error::InsufficientThroughputCapacity(inner),
