...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_file_system_policy_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyOutput, crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError> {
    Ok({
        #[allow(unused_mut)]
