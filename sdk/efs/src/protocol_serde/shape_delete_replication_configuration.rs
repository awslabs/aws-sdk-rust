...
pub fn de_delete_replication_configuration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteReplicationConfigurationOutput, crate::error::DeleteReplicationConfigurationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteReplicationConfigurationError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_request::de_bad_request_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteReplicationConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_replication_configuration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteReplicationConfigurationOutput, crate::error::DeleteReplicationConfigurationError> {
    Ok({
        #[allow(unused_mut)]
