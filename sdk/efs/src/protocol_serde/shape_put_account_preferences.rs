...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_account_preferences::de_put_account_preferences(_response_body, output)
            .map_err(crate::operation::put_account_preferences::PutAccountPreferencesError::unhandled)?;
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ResourceIdPreference" => {
                    builder =
                        builder.set_resource_id_preference(crate::protocol_serde::shape_resource_id_preference::de_resource_id_preference(tokens)?);
                }
