...
pub fn ser_create_access_point_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAccessPointInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
