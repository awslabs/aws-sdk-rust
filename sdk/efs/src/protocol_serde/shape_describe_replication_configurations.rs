...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerError" => {
            crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReplicationNotFound" => {
            crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsError::ReplicationNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_replication_configurations::de_describe_replication_configurations(_response_body, output)
            .map_err(crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsError::unhandled)?;
...
pub(crate) fn de_describe_replication_configurations(
    value: &[u8],
    mut builder: crate::operation::describe_replication_configurations::builders::DescribeReplicationConfigurationsOutputBuilder,
) -> Result<
    crate::operation::describe_replication_configurations::builders::DescribeReplicationConfigurationsOutputBuilder,
