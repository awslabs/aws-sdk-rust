...
pub fn ser_create_mount_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateMountTargetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
