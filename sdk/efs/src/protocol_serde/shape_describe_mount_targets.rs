...
pub fn de_describe_mount_targets_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeMountTargetsOutput, crate::error::DescribeMountTargetsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeMountTargetsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_request::de_bad_request_json_err(response.body().as_ref(), output).map_err(crate::error::DescribeMountTargetsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_mount_targets_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeMountTargetsOutput, crate::error::DescribeMountTargetsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_mount_targets_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_mount_targets::de_describe_mount_targets(response.body().as_ref(), output).map_err(crate::error::DescribeMountTargetsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_mount_targets(value: &[u8], mut builder: crate::output::describe_mount_targets_output::Builder) -> Result<crate::output::describe_mount_targets_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
