...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_lifecycle_configuration::DescribeLifecycleConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_lifecycle_configuration_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_lifecycle_configuration::de_describe_lifecycle_configuration(_response_body, output)
            .map_err(crate::operation::describe_lifecycle_configuration::DescribeLifecycleConfigurationError::unhandled)?;
...
pub(crate) fn de_describe_lifecycle_configuration(
    value: &[u8],
    mut builder: crate::operation::describe_lifecycle_configuration::builders::DescribeLifecycleConfigurationOutputBuilder,
) -> Result<
    crate::operation::describe_lifecycle_configuration::builders::DescribeLifecycleConfigurationOutputBuilder,
