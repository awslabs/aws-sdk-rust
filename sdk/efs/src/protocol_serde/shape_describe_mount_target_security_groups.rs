...
pub fn de_describe_mount_target_security_groups_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "IncorrectMountTargetState" => {
            crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError::IncorrectMountTargetState({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerError" => {
            crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MountTargetNotFound" => {
            crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError::MountTargetNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_mount_target_security_groups_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::describe_mount_target_security_groups_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError::unhandled)?
    })
}

pub(crate) fn de_describe_mount_target_security_groups(
    value: &[u8],
