    ...
    Err(match error_code {
        "AccessPointNotFound" => crate::operation::untag_resource::UntagResourceError::AccessPointNotFound({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_access_point_not_found::de_access_point_not_found_json_err(_response_body, output)
                    .map_err(crate::operation::untag_resource::UntagResourceError::unhandled)?;
                let output = output.meta(generic);
                crate::serde_util::access_point_not_found_correct_errors(output)
                    .build()
                    .map_err(crate::operation::untag_resource::UntagResourceError::unhandled)?
            };
