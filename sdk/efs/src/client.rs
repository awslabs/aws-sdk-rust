...
pub mod fluent_builders {
    ...
    #[deprecated(note = "Use TagResource.")]#[derive(std::clone::Clone, std::fmt::Debug, )]
    ...
    #[deprecated(note = "Use UntagResource.")]#[derive(std::clone::Clone, std::fmt::Debug, )]
    ...
    #[deprecated(note = "Use ListTagsForResource.")]#[derive(std::clone::Clone, std::fmt::Debug, )]
