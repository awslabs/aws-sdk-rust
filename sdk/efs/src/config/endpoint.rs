...
pub use ::aws_smithy_http::endpoint::ResolveEndpoint;
pub use ::aws_smithy_http::endpoint::SharedEndpointResolver;
...
impl ::aws_smithy_http::endpoint::ResolveEndpoint<crate::config::endpoint::Params> for DefaultResolver {
