...
pub struct UpdateFileSystemOutput  {
    ...
    #[doc(hidden)]pub file_system_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub life_cycle_state: std::option::Option<crate::model::LifeCycleState>,
    ...
    #[doc(hidden)]pub number_of_mount_targets: i32,
    ...
    #[doc(hidden)]pub size_in_bytes: std::option::Option<crate::model::FileSystemSize>,
    ...
    #[doc(hidden)]pub availability_zone_id: std::option::Option<std::string::String>,
...
pub struct PutAccountPreferencesOutput  {
    ...
    #[doc(hidden)]pub resource_id_preference: std::option::Option<crate::model::ResourceIdPreference>,
}
...
pub struct DescribeReplicationConfigurationsOutput  {
    ...
    #[doc(hidden)]pub replications: std::option::Option<std::vec::Vec<crate::model::ReplicationConfigurationDescription>>,
...
pub struct DescribeMountTargetsOutput  {
    ...
    #[doc(hidden)]pub mount_targets: std::option::Option<std::vec::Vec<crate::model::MountTargetDescription>>,
...
pub struct DescribeFileSystemsOutput  {
    ...
    #[doc(hidden)]pub file_systems: std::option::Option<std::vec::Vec<crate::model::FileSystemDescription>>,
...
pub struct DescribeAccessPointsOutput  {
    ...
    #[doc(hidden)]pub access_points: std::option::Option<std::vec::Vec<crate::model::AccessPointDescription>>,
...
pub struct CreateReplicationConfigurationOutput  {
    ...
    #[doc(hidden)]pub source_file_system_region: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the current source file system in the replication configuration.</p>
    #[doc(hidden)]pub source_file_system_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the original source Amazon EFS file system in the replication configuration.</p>
    #[doc(hidden)]pub original_source_file_system_arn: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for CreateReplicationConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("original_source_file_system_arn", &self.original_source_file_system_arn);
        formatter.field("creation_time", &self.creation_time);
