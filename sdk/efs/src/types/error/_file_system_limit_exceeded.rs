...
impl FileSystemLimitExceededBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::error::FileSystemLimitExceeded, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::error::FileSystemLimitExceeded {
                error_code: self.error_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("error_code", "error_code was not specified but it is required when building FileSystemLimitExceeded")
                    )?
                ,
