        ...
        ::std::result::Result::Ok(
            crate::types::error::AccessPointNotFound {
                error_code: self.error_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("error_code", "error_code was not specified but it is required when building AccessPointNotFound")
                    )?
                ,
