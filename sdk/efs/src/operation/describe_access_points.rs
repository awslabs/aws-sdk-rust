...
impl DescribeAccessPointsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAccessPoints`](crate::operation::describe_access_points::DescribeAccessPoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_access_points::DescribeAccessPoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_access_points::DescribeAccessPointsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2015-02-01/access-points").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_access_points::DescribeAccessPointsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.access_point_id {
                     {
                        query.push_kv("AccessPointId", &aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                if let Some(inner_4) = &_input.file_system_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_access_points::DescribeAccessPoints::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAccessPoints {
                type Output = std::result::Result<crate::operation::describe_access_points::DescribeAccessPointsOutput, crate::operation::describe_access_points::DescribeAccessPointsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_access_points::de_describe_access_points_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_access_points::de_describe_access_points_http_response(response)
                     }
                }
            }
