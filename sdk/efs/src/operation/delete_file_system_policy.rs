...
/// Orchestration and serialization glue logic for `DeleteFileSystemPolicy`.
...
impl DeleteFileSystemPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_file_system_policy::DeleteFileSystemPolicyInput,
                    ) -> ::std::result::Result<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFileSystemPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFileSystemPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFileSystemPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFileSystemPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFileSystemPolicy")
...
.with_interceptor(DeleteFileSystemPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError>::new());
...
#[derive(Debug)]
            struct DeleteFileSystemPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFileSystemPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_file_system_policy::de_delete_file_system_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_file_system_policy::de_delete_file_system_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFileSystemPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFileSystemPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_file_system_policy::DeleteFileSystemPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2015-02-01/file-systems/{FileSystemId}/policy", FileSystemId = file_system_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteFileSystemPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFileSystemPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFileSystemPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFileSystemPolicyInput>()
                        .ok_or("failed to downcast to DeleteFileSystemPolicyInput")?;
...
pub enum DeleteFileSystemPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFileSystemPolicyError) for what information is available for the error.")]
...
impl DeleteFileSystemPolicyError {
    /// Creates the `DeleteFileSystemPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFileSystemPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFileSystemPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError {
...
mod _delete_file_system_policy_output;
