...
impl DeleteFileSystemPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFileSystemPolicy`](crate::operation::delete_file_system_policy::DeleteFileSystemPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_file_system_policy::DeleteFileSystemPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_file_system_policy::DeleteFileSystemPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_file_system_policy::DeleteFileSystemPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFileSystemPolicy {
                type Output = std::result::Result<crate::operation::delete_file_system_policy::DeleteFileSystemPolicyOutput, crate::operation::delete_file_system_policy::DeleteFileSystemPolicyError>;
