...
impl CreateReplicationConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_replication_configuration::CreateReplicationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateReplicationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_replication_configuration::de_create_replication_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
