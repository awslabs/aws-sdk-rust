...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReplicationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_replication_configuration::de_delete_replication_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_replication_configuration::DeleteReplicationConfigurationError
{
