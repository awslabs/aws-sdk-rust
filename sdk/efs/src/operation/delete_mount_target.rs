...
impl DeleteMountTargetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_mount_target::DeleteMountTarget::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMountTarget {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_mount_target::de_delete_mount_target_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_mount_target::DeleteMountTargetError
{
