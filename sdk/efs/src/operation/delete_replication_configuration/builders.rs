...
impl DeleteReplicationConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_replication_configuration::DeleteReplicationConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_replication_configuration::DeleteReplicationConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_replication_configuration::DeleteReplicationConfigurationOutput, crate::operation::delete_replication_configuration::DeleteReplicationConfigurationError, Self> {
