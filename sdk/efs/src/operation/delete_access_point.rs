...
#[derive(Debug)]
    ...
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("access_point_id", "cannot be empty or unset"))?;
    ...
    if access_point_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("access_point_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/2015-02-01/access-points/{AccessPointId}", AccessPointId = access_point_id).expect("formatting should succeed");
