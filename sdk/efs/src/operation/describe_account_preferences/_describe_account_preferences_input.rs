...
impl DescribeAccountPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_account_preferences::DescribeAccountPreferencesInput, ::aws_smithy_types::error::operation::BuildError> {
