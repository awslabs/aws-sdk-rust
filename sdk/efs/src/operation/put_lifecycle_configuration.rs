...
impl PutLifecycleConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_lifecycle_configuration::PutLifecycleConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutLifecycleConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_lifecycle_configuration::de_put_lifecycle_configuration_http_response_with_props(status, headers, body)
        }
    }
}
