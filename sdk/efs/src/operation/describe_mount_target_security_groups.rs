...
impl DescribeMountTargetSecurityGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMountTargetSecurityGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_mount_target_security_groups::de_describe_mount_target_security_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
