...
impl DescribeMountTargetSecurityGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsInput,
                    ) -> ::std::result::Result<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeMountTargetSecurityGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeMountTargetSecurityGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeMountTargetSecurityGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeMountTargetSecurityGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeMountTargetSecurityGroups")
...
.with_interceptor(DescribeMountTargetSecurityGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_mount_target_security_groups::de_describe_mount_target_security_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_mount_target_security_groups::de_describe_mount_target_security_groups_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeMountTargetSecurityGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.mount_target_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("mount_target_id", "cannot be empty or unset"))?;
    let mount_target_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if mount_target_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("mount_target_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/2015-02-01/mount-targets/{MountTargetId}/security-groups", MountTargetId = mount_target_id).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeMountTargetSecurityGroupsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeMountTargetSecurityGroupsInput>()
                        .ok_or("failed to downcast to DescribeMountTargetSecurityGroupsInput")?;
...
pub enum DescribeMountTargetSecurityGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeMountTargetSecurityGroupsError) for what information is available for the error.")]
...
impl DescribeMountTargetSecurityGroupsError {
    /// Creates the `DescribeMountTargetSecurityGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeMountTargetSecurityGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::IncorrectMountTargetState(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InternalServerError(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::MountTargetNotFound(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeMountTargetSecurityGroupsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeMountTargetSecurityGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_mount_target_security_groups::DescribeMountTargetSecurityGroupsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_mount_target_security_groups::_describe_mount_target_security_groups_output::DescribeMountTargetSecurityGroupsOutput;

pub use crate::operation::describe_mount_target_security_groups::_describe_mount_target_security_groups_input::DescribeMountTargetSecurityGroupsInput;

mod _describe_mount_target_security_groups_input;

mod _describe_mount_target_security_groups_output;
