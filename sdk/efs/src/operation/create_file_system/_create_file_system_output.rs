...
impl CreateFileSystemOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_file_system::CreateFileSystemOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_file_system::CreateFileSystemOutput {
                owner_id: self.owner_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("owner_id", "owner_id was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
                creation_token: self.creation_token
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_token", "creation_token was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
                file_system_id: self.file_system_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("file_system_id", "file_system_id was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
                ...
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
                life_cycle_state: self.life_cycle_state
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("life_cycle_state", "life_cycle_state was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
                name: self.name
                ,
                ...
                performance_mode: self.performance_mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("performance_mode", "performance_mode was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
                ...
                tags: self.tags
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("tags", "tags was not specified but it is required when building CreateFileSystemOutput")
                    )?
                ,
