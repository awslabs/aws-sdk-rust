...
impl DescribeReplicationConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_replication_configurations::DescribeReplicationConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplicationConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replication_configurations::de_describe_replication_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
