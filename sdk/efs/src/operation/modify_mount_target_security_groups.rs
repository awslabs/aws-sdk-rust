...
impl ModifyMountTargetSecurityGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyMountTargetSecurityGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_modify_mount_target_security_groups::de_modify_mount_target_security_groups_http_response_with_props(
                status, headers, body,
            )
        }
    }
