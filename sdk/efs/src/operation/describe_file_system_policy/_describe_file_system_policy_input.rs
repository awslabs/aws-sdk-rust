...
impl DescribeFileSystemPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_file_system_policy::DescribeFileSystemPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
