...
impl CreateFileSystemInput {
    ...
    > {
        ...
        if self.creation_token.is_none() {
            self.creation_token = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_file_system::ser_create_file_system_input(&self)?);
