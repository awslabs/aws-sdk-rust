...
impl CreateFileSystem {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EFS", "CreateFileSystem", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFileSystem {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateFileSystem", "EFS"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFileSystemTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("CreationToken") {
            if let ::std::option::Option::Some(value) = input.creation_token.as_deref() {
                captured.insert("CreationToken", value);
            }
        }
        ...
        if requested.should_capture("AvailabilityZoneName") {
            if let ::std::option::Option::Some(value) = input.availability_zone_name.as_deref() {
                captured.insert("AvailabilityZoneName", value);
            }
        }
