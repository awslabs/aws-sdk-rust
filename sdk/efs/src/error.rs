...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyMountTargetSecurityGroupsError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BadRequest(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeReplicationConfigurationsError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::BadRequest(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
