...
impl super::Client {
    ...
    ///   - [`subnet_id(impl Into<String>)`](crate::operation::create_mount_target::builders::CreateMountTargetFluentBuilder::subnet_id) / [`set_subnet_id(Option<String>)`](crate::operation::create_mount_target::builders::CreateMountTargetFluentBuilder::set_subnet_id):<br>required: **true**<br><p>The ID of the subnet to add the mount target in. For file systems that use One Zone storage classes, use the subnet that is associated with the file system's Availability Zone.</p><br>
