...
impl super::Client {
    ...
    ///   - [`max_items(i32)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::max_items) / [`set_max_items(Option<i32>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_max_items):<br>required: **false**<br><p>(Optional) The maximum number of file system tags to return in the response. Currently, this number is automatically set to 100, and other values are ignored. The response is paginated at 100 per page if you have more than 100 tags.</p><br>
    ///   - [`marker(impl Into<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_marker):<br>required: **false**<br><p>(Optional) An opaque pagination token returned from a previous <code>DescribeTags</code> operation (String). If present, it specifies to continue the list from where the previous call left off.</p><br>
