...
impl super::Client {
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::describe_replication_configurations::builders::DescribeReplicationConfigurationsFluentBuilder::into_paginator).
    ///
