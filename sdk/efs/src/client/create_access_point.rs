...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_access_point::builders::CreateAccessPointFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_access_point::builders::CreateAccessPointFluentBuilder::set_client_token): <p>A string of up to 64 ASCII characters that Amazon EFS uses to ensure idempotent creation.</p>
