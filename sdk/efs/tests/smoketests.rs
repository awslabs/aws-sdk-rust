...
//! ```
//!
use aws_sdk_efs::{config, Client};
/// Smoke tests for the `describe_file_systems` operation
#[::tokio::test]
async fn test_describe_file_systems_success() {
    ...
    let res = client.describe_file_systems().send().await;
