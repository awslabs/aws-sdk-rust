...
impl StartAudienceGenerationJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_audience_generation_job::StartAudienceGenerationJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_audience_generation_job::StartAudienceGenerationJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_audience_generation_job::StartAudienceGenerationJobOutput, crate::operation::start_audience_generation_job::StartAudienceGenerationJobError, Self> {
