...
pub use crate::operation::cancel_trained_model::_cancel_trained_model_output::CancelTrainedModelOutputBuilder;

pub use crate::operation::cancel_trained_model::_cancel_trained_model_input::CancelTrainedModelInputBuilder;

impl crate::operation::cancel_trained_model::builders::CancelTrainedModelInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.cancel_trained_model();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `CancelTrainedModel`.
///
/// <p>Submits a request to cancel the trained model job.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct CancelTrainedModelFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::cancel_trained_model::builders::CancelTrainedModelInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::cancel_trained_model::CancelTrainedModelOutput,
        crate::operation::cancel_trained_model::CancelTrainedModelError,
    > for CancelTrainedModelFluentBuilder
{
    fn send(
        self,
...
impl CancelTrainedModelFluentBuilder {
    /// Creates a new `CancelTrainedModelFluentBuilder`.
    ...
    /// Access the CancelTrainedModel as a reference.
    pub fn as_input(&self) -> &crate::operation::cancel_trained_model::builders::CancelTrainedModelInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::cancel_trained_model::CancelTrainedModel::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::cancel_trained_model::CancelTrainedModel::orchestrate(&runtime_plugins, input).await
    }
