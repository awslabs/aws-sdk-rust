...
impl CreateTrainingDatasetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_training_dataset::CreateTrainingDatasetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_training_dataset::CreateTrainingDatasetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_training_dataset::CreateTrainingDatasetOutput, crate::operation::create_training_dataset::CreateTrainingDatasetError, Self> {
