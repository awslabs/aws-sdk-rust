...
impl CreateAudienceModelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_audience_model::CreateAudienceModelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_audience_model::CreateAudienceModelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_audience_model::CreateAudienceModelOutput, crate::operation::create_audience_model::CreateAudienceModelError, Self> {
