...
impl UpdateConfiguredAudienceModelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_configured_audience_model::UpdateConfiguredAudienceModelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_configured_audience_model::UpdateConfiguredAudienceModelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_configured_audience_model::UpdateConfiguredAudienceModelOutput, crate::operation::update_configured_audience_model::UpdateConfiguredAudienceModelError, Self> {
