...
impl CreateConfiguredAudienceModelOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_configured_audience_model::CreateConfiguredAudienceModelOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_configured_audience_model::CreateConfiguredAudienceModelOutput {
                configured_audience_model_arn: self.configured_audience_model_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("configured_audience_model_arn", "configured_audience_model_arn was not specified but it is required when building CreateConfiguredAudienceModelOutput")
                    )?
                ,
