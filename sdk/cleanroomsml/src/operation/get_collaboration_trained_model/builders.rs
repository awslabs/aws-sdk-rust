...
pub use crate::operation::get_collaboration_trained_model::_get_collaboration_trained_model_output::GetCollaborationTrainedModelOutputBuilder;

pub use crate::operation::get_collaboration_trained_model::_get_collaboration_trained_model_input::GetCollaborationTrainedModelInputBuilder;

impl crate::operation::get_collaboration_trained_model::builders::GetCollaborationTrainedModelInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_collaboration_trained_model();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `GetCollaborationTrainedModel`.
///
/// <p>Returns information about a trained model in a collaboration.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct GetCollaborationTrainedModelFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_collaboration_trained_model::builders::GetCollaborationTrainedModelInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_collaboration_trained_model::GetCollaborationTrainedModelOutput,
        crate::operation::get_collaboration_trained_model::GetCollaborationTrainedModelError,
    > for GetCollaborationTrainedModelFluentBuilder
{
    fn send(
        self,
...
impl GetCollaborationTrainedModelFluentBuilder {
    /// Creates a new `GetCollaborationTrainedModelFluentBuilder`.
    ...
    /// Access the GetCollaborationTrainedModel as a reference.
    pub fn as_input(&self) -> &crate::operation::get_collaboration_trained_model::builders::GetCollaborationTrainedModelInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_collaboration_trained_model::GetCollaborationTrainedModel::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_collaboration_trained_model::GetCollaborationTrainedModel::orchestrate(&runtime_plugins, input).await
    }
