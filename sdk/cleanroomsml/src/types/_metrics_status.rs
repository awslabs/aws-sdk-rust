...
/// match metricsstatus {
///     MetricsStatus::PublishFailed => { /* ... */ },
///     MetricsStatus::PublishSucceeded => { /* ... */ },
...
impl ::std::convert::From<&str> for MetricsStatus {
    fn from(s: &str) -> Self {
        match s {
            "PUBLISH_FAILED" => MetricsStatus::PublishFailed,
            "PUBLISH_SUCCEEDED" => MetricsStatus::PublishSucceeded,
            other => MetricsStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MetricsStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MetricsStatus::from(s))
    }
}
impl MetricsStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            MetricsStatus::PublishFailed => "PUBLISH_FAILED",
            MetricsStatus::PublishSucceeded => "PUBLISH_SUCCEEDED",
...
impl ::std::convert::AsRef<str> for MetricsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
