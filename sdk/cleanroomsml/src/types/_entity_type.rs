...
/// match entitytype {
///     EntityType::AllPersonallyIdentifiableInformation => { /* ... */ },
///     EntityType::Custom => { /* ... */ },
///     EntityType::Numbers => { /* ... */ },
...
impl ::std::convert::From<&str> for EntityType {
    fn from(s: &str) -> Self {
        match s {
            "ALL_PERSONALLY_IDENTIFIABLE_INFORMATION" => EntityType::AllPersonallyIdentifiableInformation,
...
impl EntityType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EntityType::AllPersonallyIdentifiableInformation => "ALL_PERSONALLY_IDENTIFIABLE_INFORMATION",
            EntityType::Custom => "CUSTOM",
            EntityType::Numbers => "NUMBERS",
            EntityType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["ALL_PERSONALLY_IDENTIFIABLE_INFORMATION", "CUSTOM", "NUMBERS"]
    }
}
