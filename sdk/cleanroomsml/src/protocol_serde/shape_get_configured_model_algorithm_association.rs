...
pub fn de_get_configured_model_algorithm_association_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::unhandled,
                        )?;
        ...
        "ThrottlingException" => {
            crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_configured_model_algorithm_association_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_configured_model_algorithm_association::de_get_configured_model_algorithm_association(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_configured_model_algorithm_association_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_configured_model_algorithm_association::GetConfiguredModelAlgorithmAssociationError::unhandled)?
    })
}

pub(crate) fn de_get_configured_model_algorithm_association(
    value: &[u8],
