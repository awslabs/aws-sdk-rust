...
pub fn de_list_configured_model_algorithm_associations_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_configured_model_algorithm_associations::ListConfiguredModelAlgorithmAssociationsError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_configured_model_algorithm_associations::ListConfiguredModelAlgorithmAssociationsError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        ...
        _ => crate::operation::list_configured_model_algorithm_associations::ListConfiguredModelAlgorithmAssociationsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_configured_model_algorithm_associations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_configured_model_algorithm_associations::de_list_configured_model_algorithm_associations(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_configured_model_algorithm_associations::ListConfiguredModelAlgorithmAssociationsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_configured_model_algorithm_associations_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_configured_model_algorithm_associations::ListConfiguredModelAlgorithmAssociationsError::unhandled)?
    })
}
