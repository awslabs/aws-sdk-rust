            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "allowedAccountIds" => {
                            builder = builder.set_allowed_account_ids(crate::protocol_serde::shape_account_id_list::de_account_id_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "logRedactionConfiguration" => {
                            builder = builder.set_log_redaction_configuration(
                                crate::protocol_serde::shape_log_redaction_configuration::de_log_redaction_configuration(tokens, _value, depth + 1)?,
                            );
                        }
