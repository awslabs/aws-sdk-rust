    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::TrainedModelInferenceMaxOutputSizeBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "unit" => {
                            builder = builder.set_unit(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::TrainedModelInferenceMaxOutputSizeUnitType::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
            ...
            Ok(Some(
                crate::serde_util::trained_model_inference_max_output_size_correct_errors(builder)
                    .build()
