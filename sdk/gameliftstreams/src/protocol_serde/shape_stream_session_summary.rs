...
pub(crate) fn de_stream_session_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::StreamSessionSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ExportFilesMetadata" => {
                            builder = builder.set_export_files_metadata(
                                crate::protocol_serde::shape_export_files_metadata::de_export_files_metadata(tokens, _value, depth + 1)?,
                            );
                        }
                        "Location" => {
