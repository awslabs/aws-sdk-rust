...
///
/// Fluent builder for the `application_ready` waiter.
///
...
pub struct ApplicationReadyFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_application::builders::GetApplicationInputBuilder,
}
impl ApplicationReadyFluentBuilder {
    /// Creates a new `ApplicationReadyFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::application_ready::ApplicationReadyFinalPoll,
        crate::waiters::application_ready::WaitUntilApplicationReadyError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_get_application_52f7492eac96eefbe(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"Status","expected":"ERROR","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_application_bd8922a7d94e1a858(result) {
...
/// Successful return type for the `application_ready` waiter.
pub type ApplicationReadyFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::get_application::GetApplicationOutput,
...
/// Error type for the `application_ready` waiter.
pub type WaitUntilApplicationReadyError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_application::GetApplicationOutput,
    crate::operation::get_application::GetApplicationError,
>;
