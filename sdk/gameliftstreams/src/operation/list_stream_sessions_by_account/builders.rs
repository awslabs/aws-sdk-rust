...
pub use crate::operation::list_stream_sessions_by_account::_list_stream_sessions_by_account_output::ListStreamSessionsByAccountOutputBuilder;

pub use crate::operation::list_stream_sessions_by_account::_list_stream_sessions_by_account_input::ListStreamSessionsByAccountInputBuilder;

impl crate::operation::list_stream_sessions_by_account::builders::ListStreamSessionsByAccountInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_stream_sessions_by_account();
...
pub struct ListStreamSessionsByAccountFluentBuilder {
    ...
    inner: crate::operation::list_stream_sessions_by_account::builders::ListStreamSessionsByAccountInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_stream_sessions_by_account::ListStreamSessionsByAccountOutput,
        crate::operation::list_stream_sessions_by_account::ListStreamSessionsByAccountError,
    > for ListStreamSessionsByAccountFluentBuilder
{
    fn send(
        self,
...
impl ListStreamSessionsByAccountFluentBuilder {
    /// Creates a new `ListStreamSessionsByAccountFluentBuilder`.
    ...
    /// Access the ListStreamSessionsByAccount as a reference.
    pub fn as_input(&self) -> &crate::operation::list_stream_sessions_by_account::builders::ListStreamSessionsByAccountInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_stream_sessions_by_account::ListStreamSessionsByAccount::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::list_stream_sessions_by_account::ListStreamSessionsByAccount::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_stream_sessions_by_account::paginator::ListStreamSessionsByAccountPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_stream_sessions_by_account::paginator::ListStreamSessionsByAccountPaginator {
        crate::operation::list_stream_sessions_by_account::paginator::ListStreamSessionsByAccountPaginator::new(self.handle, self.inner)
    }
