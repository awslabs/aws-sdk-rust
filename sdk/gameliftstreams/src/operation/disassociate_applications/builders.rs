...
/// <p>You can only disassociate an application if it's not a default application of the stream group. Check <code>DefaultApplicationIdentifier</code> by calling <code>GetStreamGroup</code>.</p>
