...
impl CreateApplication {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLiftStreams", "CreateApplication", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateApplicationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ExecutablePath") {
            if let ::std::option::Option::Some(value) = input.executable_path.as_deref() {
                captured.insert("ExecutablePath", value);
            }
        }
        if requested.should_capture("ApplicationSourceUri") {
            if let ::std::option::Option::Some(value) = input.application_source_uri.as_deref() {
                captured.insert("ApplicationSourceUri", value);
            }
        }
