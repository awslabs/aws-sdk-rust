...
pub struct CreateStreamUrlOutput {
...
impl ::std::fmt::Debug for CreateStreamUrlOutput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateStreamUrlOutput");
...
impl ::aws_types::request_id::RequestId for CreateStreamUrlOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateStreamUrlOutput {
    /// Creates a new builder-style object to manufacture [`CreateStreamUrlOutput`](crate::operation::create_stream_url::CreateStreamUrlOutput).
    pub fn builder() -> crate::operation::create_stream_url::builders::CreateStreamUrlOutputBuilder {
        crate::operation::create_stream_url::builders::CreateStreamUrlOutputBuilder::default()
    }
}

/// A builder for [`CreateStreamUrlOutput`](crate::operation::create_stream_url::CreateStreamUrlOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default)]
#[non_exhaustive]
pub struct CreateStreamUrlOutputBuilder {
...
impl CreateStreamUrlOutputBuilder {
    /// <p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html">Amazon Resource Name (ARN)</a> that uniquely identifies the stream URL across all Amazon Web Services Regions. Format is <code>arn:aws:gameliftstreams:\[AWS Region\]:\[AWS account\]:streamurl/\[stream group resource ID\]/\[stream URL resource ID\]</code>.</p>
    ...
    /// Consumes the builder and constructs a [`CreateStreamUrlOutput`](crate::operation::create_stream_url::CreateStreamUrlOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`arn`](crate::operation::create_stream_url::builders::CreateStreamUrlOutputBuilder::arn)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_stream_url::CreateStreamUrlOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_stream_url::CreateStreamUrlOutput {
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building CreateStreamUrlOutput",
                )
            })?,
...
impl ::std::fmt::Debug for CreateStreamUrlOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreateStreamUrlOutputBuilder");
        formatter.field("arn", &self.arn);
        formatter.field("stream_url_id", &self.stream_url_id);
        formatter.field("stream_url", &"*** Sensitive Data Redacted ***");
        formatter.field("status", &self.status);
