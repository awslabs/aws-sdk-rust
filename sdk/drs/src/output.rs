...
pub struct UpdateLaunchConfigurationOutput  {
    ...
    #[doc(hidden)]pub ec2_launch_template_id: std::option::Option<std::string::String>,
...
pub struct RetryDataReplicationOutput  {
    ...
    #[doc(hidden)]pub last_launch_result: std::option::Option<crate::model::LastLaunchResult>,
    /// <p>The Data Replication Info of the Source Server.</p>
    #[doc(hidden)]pub data_replication_info: std::option::Option<crate::model::DataReplicationInfo>,
    /// <p>The lifecycle information of this Source Server.</p>
    #[doc(hidden)]pub life_cycle: std::option::Option<crate::model::LifeCycle>,
    /// <p>The source properties of the Source Server.</p>
    #[doc(hidden)]pub source_properties: std::option::Option<crate::model::SourceProperties>,
    /// <p>The staging area of the source server.</p>
    #[doc(hidden)]pub staging_area: std::option::Option<crate::model::StagingArea>,
}
...
pub struct DescribeRecoverySnapshotsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::RecoverySnapshot>>,
...
pub struct StartRecoveryOutput  {
    ...
    #[doc(hidden)]pub job: std::option::Option<crate::model::Job>,
}
...
pub struct DescribeSourceServersOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::SourceServer>>,
...
pub struct DescribeReplicationConfigurationTemplatesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ReplicationConfigurationTemplate>>,
...
pub struct DescribeRecoveryInstancesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::RecoveryInstance>>,
}
...
pub struct DescribeJobLogItemsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::JobLog>>,
...
pub struct DescribeJobsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::Job>>,
...
pub struct ListStagingAccountsOutput  {
    ...
    #[doc(hidden)]pub accounts: std::option::Option<std::vec::Vec<crate::model::Account>>,
...
pub struct ListExtensibleSourceServersOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::StagingSourceServer>>,
...
pub struct CreateExtendedSourceServerOutput  {
    ...
    #[doc(hidden)]pub source_server: std::option::Option<crate::model::SourceServer>,
}
