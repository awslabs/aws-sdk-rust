...
impl super::Client {
    ...
    ///   - [`source_server_id(impl Into<String>)`](crate::operation::delete_source_server::builders::DeleteSourceServerFluentBuilder::source_server_id) / [`set_source_server_id(Option<String>)`](crate::operation::delete_source_server::builders::DeleteSourceServerFluentBuilder::set_source_server_id):<br>required: **true**<br><p>The ID of the Source Server to be deleted.</p><br>
