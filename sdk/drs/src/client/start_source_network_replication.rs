...
impl super::Client {
    ...
    ///   - [`source_network_id(impl ::std::convert::Into<String>)`](crate::operation::start_source_network_replication::builders::StartSourceNetworkReplicationFluentBuilder::source_network_id) / [`set_source_network_id(Option<String>)`](crate::operation::start_source_network_replication::builders::StartSourceNetworkReplicationFluentBuilder::set_source_network_id): <p>ID of the Source Network to replicate.</p>
