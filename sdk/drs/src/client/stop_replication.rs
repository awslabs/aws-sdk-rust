...
impl super::Client {
    ...
    ///   - [`source_server_id(impl Into<String>)`](crate::operation::stop_replication::builders::StopReplicationFluentBuilder::source_server_id) / [`set_source_server_id(impl Into<String>)`](crate::operation::stop_replication::builders::StopReplicationFluentBuilder::set_source_server_id):<br>required: **true**<br><p>The ID of the Source Server to stop replication for.</p><br>
