...
impl super::Client {
    ...
    ///   - [`cfn_stack_name(impl Into<String>)`](crate::operation::associate_source_network_stack::builders::AssociateSourceNetworkStackFluentBuilder::cfn_stack_name) / [`set_cfn_stack_name(Option<String>)`](crate::operation::associate_source_network_stack::builders::AssociateSourceNetworkStackFluentBuilder::set_cfn_stack_name): <p>CloudFormation template to associate with a Source Network.</p>
