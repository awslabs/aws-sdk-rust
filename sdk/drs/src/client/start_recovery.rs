...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::start_recovery::builders::StartRecoveryFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::start_recovery::builders::StartRecoveryFluentBuilder::set_tags): <p>The tags to be associated with the Recovery Job.</p>
