...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::job_id) / [`set_job_id(impl Into<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::set_job_id):<br>required: **true**<br><p>The ID of the Job for which Job log items will be retrieved.</p><br>
    ///   - [`max_results(i32)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::set_max_results):<br>required: **false**<br><p>Maximum number of Job log items to retrieve.</p><br>
