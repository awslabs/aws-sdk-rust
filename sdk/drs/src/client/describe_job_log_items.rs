...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::set_job_id): <p>The ID of the Job for which Job log items will be retrieved.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_job_log_items::builders::DescribeJobLogItemsFluentBuilder::set_next_token): <p>The token of the next Job log items to retrieve.</p>
