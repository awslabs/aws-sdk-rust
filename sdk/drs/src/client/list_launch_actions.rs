...
impl super::Client {
    ...
    ///   - [`resource_id(impl Into<String>)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::set_resource_id): <p>Launch configuration template Id or Source Server Id</p>
    ///   - [`filters(LaunchActionsRequestFilters)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::filters) / [`set_filters(Option<LaunchActionsRequestFilters>)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::set_filters): <p>Filters to apply when listing resource launch actions.</p>
    ///   - [`max_results(i32)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::set_max_results): <p>Maximum amount of items to return when listing resource launch actions.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_launch_actions::builders::ListLaunchActionsFluentBuilder::set_next_token): <p>Next token to use when listing resource launch actions.</p>
