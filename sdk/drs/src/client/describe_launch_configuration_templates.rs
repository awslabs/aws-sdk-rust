...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_launch_configuration_templates::builders::DescribeLaunchConfigurationTemplatesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_launch_configuration_templates::builders::DescribeLaunchConfigurationTemplatesFluentBuilder::set_next_token): <p>The token of the next Launch Configuration Template to retrieve.</p>
