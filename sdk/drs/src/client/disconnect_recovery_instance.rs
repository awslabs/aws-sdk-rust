...
impl super::Client {
    ...
    ///   - [`recovery_instance_id(impl Into<String>)`](crate::operation::disconnect_recovery_instance::builders::DisconnectRecoveryInstanceFluentBuilder::recovery_instance_id) / [`set_recovery_instance_id(Option<String>)`](crate::operation::disconnect_recovery_instance::builders::DisconnectRecoveryInstanceFluentBuilder::set_recovery_instance_id):<br>required: **true**<br><p>The ID of the Recovery Instance to disconnect.</p><br>
