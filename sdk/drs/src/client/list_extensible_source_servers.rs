...
impl super::Client {
    ...
    ///   - [`staging_account_id(impl Into<String>)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::staging_account_id) / [`set_staging_account_id(impl Into<String>)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::set_staging_account_id):<br>required: **true**<br><p>The Id of the staging Account to retrieve extensible source servers from.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of extensible source servers to retrieve.</p><br>
