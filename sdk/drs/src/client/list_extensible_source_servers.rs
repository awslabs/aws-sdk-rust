...
impl super::Client {
    ...
    ///   - [`staging_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::staging_account_id) / [`set_staging_account_id(Option<String>)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::set_staging_account_id): <p>The Id of the staging Account to retrieve extensible source servers from.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_extensible_source_servers::builders::ListExtensibleSourceServersFluentBuilder::set_next_token): <p>The token of the next extensible source server to retrieve.</p>
