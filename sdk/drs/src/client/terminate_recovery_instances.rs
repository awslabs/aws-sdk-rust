...
impl super::Client {
    ...
    ///   - [`recovery_instance_i_ds(impl Into<String>)`](crate::operation::terminate_recovery_instances::builders::TerminateRecoveryInstancesFluentBuilder::recovery_instance_i_ds) / [`set_recovery_instance_i_ds(Vec<String>)`](crate::operation::terminate_recovery_instances::builders::TerminateRecoveryInstancesFluentBuilder::set_recovery_instance_i_ds):<br>required: **true**<br><p>The IDs of the Recovery Instances that should be terminated.</p><br>
