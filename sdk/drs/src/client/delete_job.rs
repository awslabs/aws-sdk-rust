...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::delete_job::builders::DeleteJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::delete_job::builders::DeleteJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The ID of the Job to be deleted.</p><br>
