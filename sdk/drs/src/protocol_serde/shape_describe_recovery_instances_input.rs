...
pub fn ser_describe_recovery_instances_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_recovery_instances::DescribeRecoveryInstancesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
