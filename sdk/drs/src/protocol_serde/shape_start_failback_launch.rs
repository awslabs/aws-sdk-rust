                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::start_failback_launch::StartFailbackLaunchError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_failback_launch::de_start_failback_launch(_response_body, output)
            .map_err(crate::operation::start_failback_launch::StartFailbackLaunchError::unhandled)?;
