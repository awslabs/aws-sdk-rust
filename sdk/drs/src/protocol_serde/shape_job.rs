                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "participatingServers" => {
                            builder = builder.set_participating_servers(
                                crate::protocol_serde::shape_participating_servers::de_participating_servers(tokens, _value)?,
                            );
                        }
                        "tags" => {
                        ...
                        "participatingResources" => {
                            builder = builder.set_participating_resources(
                                crate::protocol_serde::shape_participating_resources::de_participating_resources(tokens, _value)?,
                            );
                        }
