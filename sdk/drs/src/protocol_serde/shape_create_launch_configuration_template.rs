...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::create_launch_configuration_template::CreateLaunchConfigurationTemplateError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = output.set_retry_after_seconds(
                        crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                            crate::operation::create_launch_configuration_template::CreateLaunchConfigurationTemplateError::unhandled(
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_launch_configuration_template::CreateLaunchConfigurationTemplateError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::create_launch_configuration_template::CreateLaunchConfigurationTemplateError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "launchConfigurationTemplate" => {
                    builder = builder.set_launch_configuration_template(
                        crate::protocol_serde::shape_launch_configuration_template::de_launch_configuration_template(tokens, _value)?,
                    );
                }
