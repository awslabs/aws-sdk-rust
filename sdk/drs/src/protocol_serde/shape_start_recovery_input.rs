...
pub fn ser_start_recovery_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartRecoveryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
