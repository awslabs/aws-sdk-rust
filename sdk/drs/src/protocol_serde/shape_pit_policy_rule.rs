...
pub(crate) fn de_pit_policy_rule<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::PitPolicyRule>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        "units" => {
                            builder = builder.set_units(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::PitPolicyRuleUnits::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "interval" => {
            ...
            Ok(Some(crate::serde_util::pit_policy_rule_correct_errors(builder).build().map_err(
