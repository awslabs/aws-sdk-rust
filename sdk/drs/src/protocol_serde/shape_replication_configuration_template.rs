...
pub(crate) fn de_replication_configuration_template<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReplicationConfigurationTemplate>, aws_smithy_json::deserialize::error::DeserializeError>
