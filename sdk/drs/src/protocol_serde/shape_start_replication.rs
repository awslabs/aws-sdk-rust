...
pub fn de_start_replication_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::start_replication::StartReplicationOutput, crate::operation::start_replication::StartReplicationError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::start_replication::StartReplicationError::unhandled(
...
pub fn de_start_replication_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_start_replication::de_start_replication(_response_body, output)
            .map_err(crate::operation::start_replication::StartReplicationError::unhandled)?;
...
) -> Result<crate::operation::start_replication::builders::StartReplicationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
