                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::describe_job_log_items::DescribeJobLogItemsError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_job_log_items::de_describe_job_log_items(_response_body, output)
            .map_err(crate::operation::describe_job_log_items::DescribeJobLogItemsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "items" => {
                    builder = builder.set_items(crate::protocol_serde::shape_job_logs::de_job_logs(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
