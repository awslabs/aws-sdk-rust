...
impl UpdateReplicationConfigurationTemplateOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_replication_configuration_template::UpdateReplicationConfigurationTemplateOutput, ::aws_smithy_types::error::operation::BuildError> {
