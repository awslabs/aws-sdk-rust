...
impl TerminateRecoveryInstancesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_recovery_instances::TerminateRecoveryInstances::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateRecoveryInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_terminate_recovery_instances::de_terminate_recovery_instances_http_response_with_props(status, headers, body)
        }
    }
