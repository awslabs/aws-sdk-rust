...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_recovery_instance::DeleteRecoveryInstanceOutput,
                    crate::operation::delete_recovery_instance::DeleteRecoveryInstanceError,
                > for DeleteRecoveryInstanceFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteRecoveryInstanceFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_recovery_instance::builders::DeleteRecoveryInstanceInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_recovery_instance::DeleteRecoveryInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_recovery_instance::DeleteRecoveryInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_recovery_instance::DeleteRecoveryInstance::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_recovery_instance::DeleteRecoveryInstance::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_recovery_instance::DeleteRecoveryInstanceOutput, crate::operation::delete_recovery_instance::DeleteRecoveryInstanceError, Self> {
