...
impl CreateReplicationConfigurationTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_replication_configuration_template::CreateReplicationConfigurationTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
