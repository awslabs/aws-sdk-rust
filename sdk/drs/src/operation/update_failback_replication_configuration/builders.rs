...
impl UpdateFailbackReplicationConfigurationFluentBuilder {
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::update_failback_replication_configuration::UpdateFailbackReplicationConfigurationOutput, ::aws_smithy_http::result::SdkError<crate::operation::update_failback_replication_configuration::UpdateFailbackReplicationConfigurationError>>
                         {
        let op = self
            .inner
            .build()
