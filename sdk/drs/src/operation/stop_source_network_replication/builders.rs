...
impl crate::operation::stop_source_network_replication::builders::StopSourceNetworkReplicationInputBuilder {
...
impl StopSourceNetworkReplicationFluentBuilder {
    /// Creates a new `StopSourceNetworkReplicationFluentBuilder`.
