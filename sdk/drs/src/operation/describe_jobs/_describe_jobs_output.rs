...
pub struct DescribeJobsOutput {
    ...
    pub items: ::std::option::Option<::std::vec::Vec<crate::types::Job>>,
...
impl DescribeJobsOutputBuilder {
    ...
    ///
    /// <p>An array of Jobs.</p>
    pub fn items(mut self, input: crate::types::Job) -> Self {
    ...
    /// <p>An array of Jobs.</p>
    pub fn get_items(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::Job>> {
        &self.items
    }
    /// <p>The token of the next Job to retrieve.</p>
