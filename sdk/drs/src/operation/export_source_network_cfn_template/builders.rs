...
impl ExportSourceNetworkCfnTemplateInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateOutput, ::aws_smithy_http::result::SdkError<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateError, ::aws_smithy_http::operation::Response>>
...
impl ExportSourceNetworkCfnTemplateFluentBuilder {
    ...
    #[doc(hidden)]
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplate, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateError>
    >{
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateOutput, ::aws_smithy_http::result::SdkError<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateError>>
                         {
        let op = self
            .inner
            .build()
    ...
    /// set when configuring the client.
                            pub async fn send(self) -> ::std::result::Result<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateOutput, ::aws_smithy_http::result::SdkError<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateError>>
                             {
