...
pub struct PitPolicyRule  {
    ...
    #[doc(hidden)]pub rule_id: i64,
    /// <p>The units used to measure the interval and retentionDuration.</p>
    #[doc(hidden)]pub units: std::option::Option<crate::model::PitPolicyRuleUnits>,
    ...
    #[doc(hidden)]pub retention_duration: i32,
...
pub struct ReplicationConfigurationReplicatedDisk  {
    ...
    #[doc(hidden)]pub optimized_staging_disk_type: std::option::Option<crate::model::ReplicationConfigurationReplicatedDiskStagingDiskType>,
}
...
impl  std::fmt::Debug for ReplicationConfigurationReplicatedDisk  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("optimized_staging_disk_type", &self.optimized_staging_disk_type);
        formatter.finish()
    }
}
...
pub struct StagingArea  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ExtensionStatus>,
    ...
    #[doc(hidden)]pub staging_source_server_arn: std::option::Option<std::string::String>,
...
pub struct LifeCycle  {
    ...
    #[doc(hidden)]pub last_launch: std::option::Option<crate::model::LifeCycleLastLaunch>,
}
impl LifeCycle {
    /// <p>The date and time of when the Source Server was added to the service.</p>
...
pub struct LifeCycleLastLaunch  {
    ...
    #[doc(hidden)]pub initiated: std::option::Option<crate::model::LifeCycleLastLaunchInitiated>,
}
...
pub struct LifeCycleLastLaunchInitiated  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::LastLaunchType>,
}
...
pub struct RecoverySnapshot  {
    ...
    #[doc(hidden)]pub expected_timestamp: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ebs_snapshots: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct DescribeRecoverySnapshotsRequestFilters  {
    ...
    #[doc(hidden)]pub from_date_time: std::option::Option<std::string::String>,
    /// <p>The end date in a date range query.</p>
    #[doc(hidden)]pub to_date_time: std::option::Option<std::string::String>,
}
...
pub struct StartRecoveryRequestSourceServer  {
    ...
    #[doc(hidden)]pub recovery_snapshot_id: std::option::Option<std::string::String>,
}
...
pub struct DescribeSourceServersRequestFilters  {
    ...
    #[doc(hidden)]pub hardware_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub staging_account_i_ds: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct RecoveryInstance  {
    ...
    #[doc(hidden)]pub ec2_instance_state: std::option::Option<crate::model::Ec2InstanceState>,
    ...
    #[doc(hidden)]pub failback: std::option::Option<crate::model::RecoveryInstanceFailback>,
    /// <p>The Data Replication Info of the Recovery Instance.</p>
    #[doc(hidden)]pub data_replication_info: std::option::Option<crate::model::RecoveryInstanceDataReplicationInfo>,
    /// <p>Properties of the Recovery Instance machine.</p>
    #[doc(hidden)]pub recovery_instance_properties: std::option::Option<crate::model::RecoveryInstanceProperties>,
    /// <p>The date and time of the Point in Time (PIT) snapshot that this Recovery Instance was launched from.</p>
    #[doc(hidden)]pub point_in_time_snapshot_date_time: std::option::Option<std::string::String>,
...
pub struct RecoveryInstanceProperties  {
    ...
    #[doc(hidden)]pub network_interfaces: std::option::Option<std::vec::Vec<crate::model::NetworkInterface>>,
    /// <p>An array of disks.</p>
    #[doc(hidden)]pub disks: std::option::Option<std::vec::Vec<crate::model::RecoveryInstanceDisk>>,
    /// <p>An array of CPUs.</p>
    #[doc(hidden)]pub cpus: std::option::Option<std::vec::Vec<crate::model::Cpu>>,
    /// <p>The amount of RAM in bytes.</p>
    #[doc(hidden)]pub ram_bytes: i64,
...
pub struct RecoveryInstanceDisk  {
    ...
    #[doc(hidden)]pub internal_device_name: std::option::Option<std::string::String>,
    /// <p>The amount of storage on the disk in bytes.</p>
    #[doc(hidden)]pub bytes: i64,
    /// <p>The EBS Volume ID of this disk.</p>
    #[doc(hidden)]pub ebs_volume_id: std::option::Option<std::string::String>,
}
...
pub struct RecoveryInstanceDataReplicationInfo  {
    ...
    #[doc(hidden)]pub eta_date_time: std::option::Option<std::string::String>,
    /// <p>The disks that should be replicated.</p>
    #[doc(hidden)]pub replicated_disks: std::option::Option<std::vec::Vec<crate::model::RecoveryInstanceDataReplicationInfoReplicatedDisk>>,
    /// <p>The state of the data replication.</p>
    #[doc(hidden)]pub data_replication_state: std::option::Option<crate::model::RecoveryInstanceDataReplicationState>,
    /// <p>Information about whether the data replication has been initiated.</p>
    #[doc(hidden)]pub data_replication_initiation: std::option::Option<crate::model::RecoveryInstanceDataReplicationInitiation>,
    /// <p>Information about Data Replication</p>
    #[doc(hidden)]pub data_replication_error: std::option::Option<crate::model::RecoveryInstanceDataReplicationError>,
}
...
pub struct RecoveryInstanceDataReplicationError  {
    /// <p>Error in data replication.</p>
    #[doc(hidden)]pub error: std::option::Option<crate::model::FailbackReplicationError>,
    /// <p>Error in data replication.</p>
    #[doc(hidden)]pub raw_error: std::option::Option<std::string::String>,
}
...
impl FailbackReplicationError {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "AGENT_NOT_SEEN", "FAILBACK_CLIENT_NOT_SEEN", "FAILED_TO_CONFIGURE_REPLICATION_SOFTWARE", "FAILED_TO_DOWNLOAD_REPLICATION_SOFTWARE_TO_FAILBACK_CLIENT", "FAILED_TO_ESTABLISH_AGENT_REPLICATOR_SOFTWARE_COMMUNICATION", "FAILED_TO_ESTABLISH_RECOVERY_INSTANCE_COMMUNICATION", "FAILED_TO_PAIR_AGENT_WITH_REPLICATION_SOFTWARE", "NOT_CONVERGING", "UNSTABLE_NETWORK"
        ]
    }
}
...
pub struct RecoveryInstanceDataReplicationInitiation  {
    ...
    #[doc(hidden)]pub start_date_time: std::option::Option<std::string::String>,
    /// <p>The steps of the current attempt to initiate data replication.</p>
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::RecoveryInstanceDataReplicationInitiationStep>>,
}
...
pub struct RecoveryInstanceDataReplicationInitiationStep  {
    /// <p>The name of the step.</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::RecoveryInstanceDataReplicationInitiationStepName>,
    /// <p>The status of the step.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::RecoveryInstanceDataReplicationInitiationStepStatus>,
}
...
impl RecoveryInstanceDataReplicationInitiationStepName {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "COMPLETE_VOLUME_MAPPING", "CONFIGURE_REPLICATION_SOFTWARE", "DOWNLOAD_REPLICATION_SOFTWARE_TO_FAILBACK_CLIENT", "ESTABLISH_AGENT_REPLICATOR_SOFTWARE_COMMUNICATION", "ESTABLISH_RECOVERY_INSTANCE_COMMUNICATION", "LINK_FAILBACK_CLIENT_WITH_RECOVERY_INSTANCE", "PAIR_AGENT_WITH_REPLICATION_SOFTWARE"
        ]
    }
}
...
pub struct RecoveryInstanceFailback  {
    ...
    #[doc(hidden)]pub failback_client_id: std::option::Option<std::string::String>,
    /// <p>The Job ID of the last failback log for this Recovery Instance.</p>
    #[doc(hidden)]pub failback_job_id: std::option::Option<std::string::String>,
    /// <p>The date and time that the failback initiation started.</p>
    #[doc(hidden)]pub failback_initiation_time: std::option::Option<std::string::String>,
    /// <p>The state of the failback process that this Recovery Instance is in.</p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::FailbackState>,
    /// <p>The date and time the agent on the Recovery Instance was last seen by the service.</p>
    #[doc(hidden)]pub agent_last_seen_by_service_date_time: std::option::Option<std::string::String>,
    /// <p>The date and time that the failback client was last seen by the service.</p>
    #[doc(hidden)]pub failback_client_last_seen_by_service_date_time: std::option::Option<std::string::String>,
    /// <p>Whether we are failing back to the original Source Server for this Recovery Instance.</p>
    #[doc(hidden)]pub failback_to_original_server: std::option::Option<bool>,
...
impl  std::fmt::Debug for RecoveryInstanceFailback  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("agent_last_seen_by_service_date_time", &self.agent_last_seen_by_service_date_time);
        formatter.field("failback_client_last_seen_by_service_date_time", &self.failback_client_last_seen_by_service_date_time);
...
impl FailbackState {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "FAILBACK_COMPLETED", "FAILBACK_ERROR", "FAILBACK_IN_PROGRESS", "FAILBACK_NOT_STARTED", "FAILBACK_READY_FOR_LAUNCH"
        ]
    }
}
...
pub struct JobLogEventData  {
    ...
    #[doc(hidden)]pub conversion_properties: std::option::Option<crate::model::ConversionProperties>,
}
...
pub struct ConversionProperties  {
    ...
    #[doc(hidden)]pub volume_to_conversion_map: std::option::Option<std::collections::HashMap<std::string::String, std::collections::HashMap<std::string::String, std::string::String>>>,
    /// <p>The root volume name of a conversion job</p>
    #[doc(hidden)]pub root_volume_name: std::option::Option<std::string::String>,
    /// <p>Whether the volume being converted uses UEFI or not</p>
    #[doc(hidden)]pub force_uefi: std::option::Option<bool>,
    /// <p>The timestamp of when the snapshot being converted was taken</p>
    #[doc(hidden)]pub data_timestamp: std::option::Option<std::string::String>,
    /// <p>A mapping between the volumes and their sizes</p>
    #[doc(hidden)]pub volume_to_volume_size: std::option::Option<std::collections::HashMap<std::string::String, i64>>,
}
