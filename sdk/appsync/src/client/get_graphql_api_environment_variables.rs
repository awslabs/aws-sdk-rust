...
impl super::Client {
    ...
    pub fn get_graphql_api_environment_variables(&self) -> crate::operation::get_graphql_api_environment_variables::builders::GetGraphqlApiEnvironmentVariablesFluentBuilder {
