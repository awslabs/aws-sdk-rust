...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::update_domain_name::builders::UpdateDomainNameFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::update_domain_name::builders::UpdateDomainNameFluentBuilder::set_domain_name):<br>required: **true**<br><p>The domain name.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::update_domain_name::builders::UpdateDomainNameFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_domain_name::builders::UpdateDomainNameFluentBuilder::set_description):<br>required: **false**<br><p>A description of the <code>DomainName</code>.</p><br>
