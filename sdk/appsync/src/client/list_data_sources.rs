...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::set_api_id): <p>The API ID.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which you can use to return the next set of items in the list.</p>
    ///   - [`max_results(i32)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::set_max_results): <p>The maximum number of results that you want the request to return.</p>
