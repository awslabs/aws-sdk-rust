...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::get_data_source::builders::GetDataSourceFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::get_data_source::builders::GetDataSourceFluentBuilder::set_api_id):<br>required: **true**<br><p>The API ID.</p><br>
