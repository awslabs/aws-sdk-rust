...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::set_api_id): <p>The API ID.</p>
    ///   - [`function_id(impl ::std::convert::Into<String>)`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::function_id) / [`set_function_id(Option<String>)`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::set_function_id): <p>The function ID.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which you can use to return the next set of items in the list.</p>
    ...
    pub fn list_resolvers_by_function(
        &self,
    ) -> crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder
    {
