...
impl super::Client {
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_resolvers_by_function::builders::ListResolversByFunctionFluentBuilder::into_paginator).
    ///
