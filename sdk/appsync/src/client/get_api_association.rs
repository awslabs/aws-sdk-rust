...
impl super::Client {
    ...
    pub fn get_api_association(
        &self,
    ) -> crate::operation::get_api_association::builders::GetApiAssociationFluentBuilder {
        crate::operation::get_api_association::builders::GetApiAssociationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
