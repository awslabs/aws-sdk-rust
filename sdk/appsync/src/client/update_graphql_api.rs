...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::update_graphql_api::builders::UpdateGraphqlApiFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::update_graphql_api::builders::UpdateGraphqlApiFluentBuilder::set_api_id): <p>The API ID.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_graphql_api::builders::UpdateGraphqlApiFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_graphql_api::builders::UpdateGraphqlApiFluentBuilder::set_name): <p>The new name for the <code>GraphqlApi</code> object.</p>
