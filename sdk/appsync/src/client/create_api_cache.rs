...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::create_api_cache::builders::CreateApiCacheFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::create_api_cache::builders::CreateApiCacheFluentBuilder::set_api_id): <p>The GraphQL API ID.</p>
    ///   - [`ttl(i64)`](crate::operation::create_api_cache::builders::CreateApiCacheFluentBuilder::ttl) / [`set_ttl(Option<i64>)`](crate::operation::create_api_cache::builders::CreateApiCacheFluentBuilder::set_ttl): <p>TTL in seconds for cache entries.</p>  <p>Valid values are 1–3,600 seconds.</p>
