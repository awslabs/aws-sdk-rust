...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::delete_api::builders::DeleteApiFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_api::builders::DeleteApiFluentBuilder::set_api_id):<br>required: **true**<br><p>The <code>Api</code> ID.</p><br>
