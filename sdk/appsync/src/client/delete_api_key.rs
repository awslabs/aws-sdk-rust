...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::delete_api_key::builders::DeleteApiKeyFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_api_key::builders::DeleteApiKeyFluentBuilder::set_api_id):<br>required: **true**<br><p>The API ID.</p><br>
    ///   - [`id(impl Into<String>)`](crate::operation::delete_api_key::builders::DeleteApiKeyFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_api_key::builders::DeleteApiKeyFluentBuilder::set_id):<br>required: **true**<br><p>The ID for the API key.</p><br>
