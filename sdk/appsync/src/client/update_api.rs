...
impl super::Client {
    ...
    ///   - [`event_config(EventConfig)`](crate::operation::update_api::builders::UpdateApiFluentBuilder::event_config) / [`set_event_config(Option<EventConfig>)`](crate::operation::update_api::builders::UpdateApiFluentBuilder::set_event_config):<br>required: **true**<br><p>The new event configuration. This includes the default authorization configuration for connecting, publishing, and subscribing to an Event API.</p><br>
