...
impl super::Client {
    ...
    /// This operation supports pagination; See [`into_paginator()`](crate::operation::list_domain_names::builders::ListDomainNamesFluentBuilder::into_paginator).
    ///
    /// - The fluent builder is configurable:
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_domain_names::builders::ListDomainNamesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_domain_names::builders::ListDomainNamesFluentBuilder::set_next_token):<br>required: **false**<br><p>An identifier that was returned from the previous call to this operation, which you can use to return the next set of items in the list.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_domain_names::builders::ListDomainNamesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_domain_names::builders::ListDomainNamesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results that you want the request to return.</p><br>
