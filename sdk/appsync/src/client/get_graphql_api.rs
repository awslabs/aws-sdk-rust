...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::get_graphql_api::builders::GetGraphqlApiFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::get_graphql_api::builders::GetGraphqlApiFluentBuilder::set_api_id):<br>required: **true**<br><p>The API ID for the GraphQL API.</p><br>
