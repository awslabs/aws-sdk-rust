...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_graphql_apis::builders::ListGraphqlApisFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_graphql_apis::builders::ListGraphqlApisFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which you can use to return the next set of items in the list.</p>
    ...
    ///   - [`api_type(GraphQlApiType)`](crate::operation::list_graphql_apis::builders::ListGraphqlApisFluentBuilder::api_type) / [`set_api_type(Option<GraphQlApiType>)`](crate::operation::list_graphql_apis::builders::ListGraphqlApisFluentBuilder::set_api_type): <p>The value that indicates whether the GraphQL API is a standard API (<code>GRAPHQL</code>) or merged API (<code>MERGED</code>).</p>
    ///   - [`owner(Ownership)`](crate::operation::list_graphql_apis::builders::ListGraphqlApisFluentBuilder::owner) / [`set_owner(Option<Ownership>)`](crate::operation::list_graphql_apis::builders::ListGraphqlApisFluentBuilder::set_owner): <p>The account owner of the GraphQL API.</p>
