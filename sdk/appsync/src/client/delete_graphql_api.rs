...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::delete_graphql_api::builders::DeleteGraphqlApiFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_graphql_api::builders::DeleteGraphqlApiFluentBuilder::set_api_id):<br>required: **true**<br><p>The API ID.</p><br>
