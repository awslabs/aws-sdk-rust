...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::get_function::builders::GetFunctionFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::get_function::builders::GetFunctionFluentBuilder::set_api_id): <p>The GraphQL API ID.</p>
    ///   - [`function_id(impl ::std::convert::Into<String>)`](crate::operation::get_function::builders::GetFunctionFluentBuilder::function_id) / [`set_function_id(Option<String>)`](crate::operation::get_function::builders::GetFunctionFluentBuilder::set_function_id): <p>The <code>Function</code> ID.</p>
