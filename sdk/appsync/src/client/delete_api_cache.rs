...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::delete_api_cache::builders::DeleteApiCacheFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_api_cache::builders::DeleteApiCacheFluentBuilder::set_api_id):<br>required: **true**<br><p>The API ID.</p><br>
