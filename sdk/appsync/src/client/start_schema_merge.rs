...
impl super::Client {
    ...
    ///   - [`association_id(impl Into<String>)`](crate::operation::start_schema_merge::builders::StartSchemaMergeFluentBuilder::association_id) / [`set_association_id(Option<String>)`](crate::operation::start_schema_merge::builders::StartSchemaMergeFluentBuilder::set_association_id): <p>The ID generated by the AppSync service for the source API association.</p>
    ///   - [`merged_api_identifier(impl Into<String>)`](crate::operation::start_schema_merge::builders::StartSchemaMergeFluentBuilder::merged_api_identifier) / [`set_merged_api_identifier(Option<String>)`](crate::operation::start_schema_merge::builders::StartSchemaMergeFluentBuilder::set_merged_api_identifier): <p>The identifier of the AppSync Merged API. This is generated by the AppSync service. In most cases, Merged APIs (especially in your account) only require the API ID value or ARN of the merged API. However, Merged APIs in other accounts (cross-account use cases) strictly require the full resource ARN of the merged API.</p>
