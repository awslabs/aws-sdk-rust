...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::create_data_source::builders::CreateDataSourceFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::create_data_source::builders::CreateDataSourceFluentBuilder::set_api_id): <p>The API ID for the GraphQL API for the <code>DataSource</code>.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::create_data_source::builders::CreateDataSourceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_data_source::builders::CreateDataSourceFluentBuilder::set_name): <p>A user-supplied name for the <code>DataSource</code>.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::create_data_source::builders::CreateDataSourceFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_data_source::builders::CreateDataSourceFluentBuilder::set_description): <p>A description of the <code>DataSource</code>.</p>
