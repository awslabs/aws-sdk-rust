...
impl GetSourceApiAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_source_api_association::GetSourceApiAssociationInput, ::aws_smithy_types::error::operation::BuildError> {
