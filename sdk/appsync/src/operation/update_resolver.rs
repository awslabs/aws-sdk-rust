...
impl UpdateResolverInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_resolver::UpdateResolver::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateResolver {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_resolver::de_update_resolver_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_resolver::de_update_resolver_http_response(
                status, headers, body,
            )
        }
    }
