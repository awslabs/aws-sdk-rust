...
impl DisassociateApiFluentBuilder  {
    /// Creates a new `DisassociateApi`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::disassociate_api::DisassociateApiOutput, aws_smithy_http::result::SdkError<crate::operation::disassociate_api::DisassociateApiError>>
                     {
