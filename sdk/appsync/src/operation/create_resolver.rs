...
impl CreateResolverInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_resolver::CreateResolver,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_resolver::CreateResolver::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResolver {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_resolver::de_create_resolver_http_error(
                status, headers, body,
            )
        } else {
