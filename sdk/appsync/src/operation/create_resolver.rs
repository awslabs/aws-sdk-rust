...
impl CreateResolverInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_resolver::CreateResolver, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_resolver::ser_create_resolver_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResolver {
    type Output =
        ::std::result::Result<crate::operation::create_resolver::CreateResolverOutput, crate::operation::create_resolver::CreateResolverError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_resolver::de_create_resolver_http_response_with_props(status, headers, body)
        }
    }
}
