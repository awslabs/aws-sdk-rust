...
/// Paginator for [`ListResolvers`](crate::operation::list_resolvers::ListResolvers)
pub struct ListResolversPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_resolvers::builders::ListResolversInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListResolversPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `resolvers`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_resolvers::paginator::ListResolversPaginatorItems {
        crate::operation::list_resolvers::paginator::ListResolversPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_resolvers::ListResolvers::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_resolvers_output_output_next_token(resp);
...
/// Flattened paginator for `ListResolversPaginator`
///
/// This is created with [`.items()`](ListResolversPaginator::items)
pub struct ListResolversPaginatorItems(ListResolversPaginator);

impl ListResolversPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_resolvers_output_output_resolvers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
