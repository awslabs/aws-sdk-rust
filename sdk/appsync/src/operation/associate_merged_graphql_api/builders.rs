...
impl AssociateMergedGraphqlApiFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_merged_graphql_api::AssociateMergedGraphqlApiOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_merged_graphql_api::AssociateMergedGraphqlApiError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_merged_graphql_api::AssociateMergedGraphqlApiOutput, crate::operation::associate_merged_graphql_api::AssociateMergedGraphqlApiError, Self> {
