...
impl GetApiCacheInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_api_cache::GetApiCache,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_api_cache::GetApiCache::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetApiCache {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_api_cache::de_get_api_cache_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_api_cache::de_get_api_cache_http_response_with_props(
                status, headers, body,
            )
        }
    }
