...
impl ListDomainNamesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_domain_names::ListDomainNames, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDomainNames {
    type Output =
        ::std::result::Result<crate::operation::list_domain_names::ListDomainNamesOutput, crate::operation::list_domain_names::ListDomainNamesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_domain_names::de_list_domain_names_http_response_with_props(status, headers, body)
        }
    }
}
