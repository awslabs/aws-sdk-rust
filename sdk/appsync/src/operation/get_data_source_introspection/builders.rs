...
impl GetDataSourceIntrospectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_data_source_introspection::GetDataSourceIntrospectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_data_source_introspection::GetDataSourceIntrospectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_data_source_introspection::GetDataSourceIntrospectionOutput, crate::operation::get_data_source_introspection::GetDataSourceIntrospectionError, Self> {
