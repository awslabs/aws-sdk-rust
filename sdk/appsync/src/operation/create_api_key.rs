...
impl CreateApiKeyInput {
    /// Consumes the builder and constructs an Operation<[`CreateApiKey`](crate::operation::create_api_key::CreateApiKey)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_api_key::CreateApiKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_api_key::ser_create_api_key_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_api_key::CreateApiKey::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApiKey {
    type Output = ::std::result::Result<crate::operation::create_api_key::CreateApiKeyOutput, crate::operation::create_api_key::CreateApiKeyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_api_key::de_create_api_key_http_response_with_props(status, headers, body)
        }
    }
}
