    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/apis/{apiId}/apikeys", apiId = api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_api_key::CreateApiKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApiKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_api_key::de_create_api_key_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_api_key::de_create_api_key_http_response_with_props(
                status, headers, body,
            )
        }
    }
