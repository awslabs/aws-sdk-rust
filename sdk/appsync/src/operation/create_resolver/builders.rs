...
impl CreateResolverFluentBuilder  {
    /// Creates a new `CreateResolver`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::create_resolver::CreateResolver, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::create_resolver::CreateResolverError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::create_resolver::CreateResolverOutput, aws_smithy_http::result::SdkError<crate::operation::create_resolver::CreateResolverError>>
                     {
