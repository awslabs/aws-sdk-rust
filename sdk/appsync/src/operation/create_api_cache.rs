...
impl CreateApiCacheInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_api_cache::CreateApiCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_api_cache::ser_create_api_cache_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApiCache {
    type Output =
        ::std::result::Result<crate::operation::create_api_cache::CreateApiCacheOutput, crate::operation::create_api_cache::CreateApiCacheError>;
