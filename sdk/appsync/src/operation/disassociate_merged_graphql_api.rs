    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApiError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApiOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateMergedGraphqlApi {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DisassociateMergedGraphqlApi", "appsync"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateMergedGraphqlApi")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DisassociateMergedGraphqlApiResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DisassociateMergedGraphqlApiRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApiInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("source_api_identifier", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisassociateMergedGraphqlApiEndpointParamsInterceptor {
...
pub type DisassociateMergedGraphqlApiErrorKind = DisassociateMergedGraphqlApiError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisassociateMergedGraphqlApiError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApiError {
...
impl DisassociateMergedGraphqlApiError {
    ...
    /// Creates the `DisassociateMergedGraphqlApiError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
