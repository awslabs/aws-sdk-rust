...
impl DisassociateMergedGraphqlApiInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateMergedGraphqlApi`](crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApi)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApi::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateMergedGraphqlApi", "appsync"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateMergedGraphqlApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_merged_graphql_api::de_disassociate_merged_graphql_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
