...
impl StartSchemaCreationInput {
    /// Consumes the builder and constructs an Operation<[`StartSchemaCreation`](crate::operation::start_schema_creation::StartSchemaCreation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_schema_creation::StartSchemaCreation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_schema_creation::StartSchemaCreationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_schema_creation::ser_start_schema_creation_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_schema_creation::StartSchemaCreation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartSchemaCreation {
                type Output = std::result::Result<crate::operation::start_schema_creation::StartSchemaCreationOutput, crate::operation::start_schema_creation::StartSchemaCreationError>;
