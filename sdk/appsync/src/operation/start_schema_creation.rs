...
impl StartSchemaCreationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_schema_creation::ser_start_schema_creation_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_schema_creation::StartSchemaCreation::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_schema_creation::StartSchemaCreationError
{
