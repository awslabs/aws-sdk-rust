...
impl ListApiKeysInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_api_keys::ListApiKeys::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListApiKeys {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_api_keys::de_list_api_keys_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_api_keys::de_list_api_keys_http_response_with_props(
                status, headers, body,
            )
        }
    }
