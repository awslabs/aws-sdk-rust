...
impl ListTypesByAssociationFluentBuilder {
    /// Creates a new `ListTypesByAssociationFluentBuilder`.
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_types_by_association::paginator::ListTypesByAssociationPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_types_by_association::paginator::ListTypesByAssociationPaginator {
        crate::operation::list_types_by_association::paginator::ListTypesByAssociationPaginator::new(self.handle, self.inner)
    }
