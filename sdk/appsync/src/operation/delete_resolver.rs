...
impl DeleteResolverInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_resolver::DeleteResolver, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResolver {
    type Output =
        ::std::result::Result<crate::operation::delete_resolver::DeleteResolverOutput, crate::operation::delete_resolver::DeleteResolverError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_resolver::de_delete_resolver_http_response_with_props(status, headers, body)
        }
    }
}
