...
impl DeleteResolver {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_resolver::DeleteResolverInput,
                    ) -> ::std::result::Result<crate::operation::delete_resolver::DeleteResolverOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_resolver::DeleteResolverError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_resolver::DeleteResolverError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_resolver::DeleteResolverOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteResolver {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteResolver");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteResolverRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteResolverResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteResolver")
...
.with_interceptor(DeleteResolverEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_resolver::DeleteResolverError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_resolver::DeleteResolverError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_resolver::DeleteResolverError>::new());
...
#[derive(Debug)]
            struct DeleteResolverResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteResolverResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_resolver::de_delete_resolver_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteResolverRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteResolverRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_resolver::DeleteResolverInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_resolver::DeleteResolverInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_3 = &_input.field_name;
    let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("field_name", "cannot be empty or unset"))?;
    let field_name = ::aws_smithy_http::label::fmt_string(input_3, ::aws_smithy_http::label::EncodingStrategy::Default);
    if field_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("field_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v1/apis/{apiId}/types/{typeName}/resolvers/{fieldName}", apiId = api_id, typeName = type_name, fieldName = field_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteResolverEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteResolverEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteResolverEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteResolverInput>()
                        .ok_or("failed to downcast to DeleteResolverInput")?;
...
pub enum DeleteResolverError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteResolverError) for what information is available for the error.")]
...
impl DeleteResolverError {
    /// Creates the `DeleteResolverError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteResolverError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteResolverError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_resolver::DeleteResolverError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_resolver::_delete_resolver_output::DeleteResolverOutput;

pub use crate::operation::delete_resolver::_delete_resolver_input::DeleteResolverInput;

mod _delete_resolver_input;

mod _delete_resolver_output;
