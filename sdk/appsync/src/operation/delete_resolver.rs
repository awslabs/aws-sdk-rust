...
impl DeleteResolverInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::delete_resolver::DeleteResolver,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_resolver::DeleteResolver::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteResolver {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_resolver::de_delete_resolver_http_error(
                status, headers, body,
            )
        } else {
