...
/// Orchestration and serialization glue logic for `ListGraphqlApis`.
...
impl ListGraphqlApis {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_graphql_apis::ListGraphqlApisInput,
                    ) -> ::std::result::Result<crate::operation::list_graphql_apis::ListGraphqlApisOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_graphql_apis::ListGraphqlApisError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_graphql_apis::ListGraphqlApisError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_graphql_apis::ListGraphqlApisOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListGraphqlApis {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListGraphqlApis");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListGraphqlApisRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListGraphqlApisResponseDeserializer));
...
.with_interceptor(ListGraphqlApisEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_graphql_apis::ListGraphqlApisError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_graphql_apis::ListGraphqlApisError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_graphql_apis::ListGraphqlApisError>::new());
...
#[derive(Debug)]
            struct ListGraphqlApisResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGraphqlApisResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_graphql_apis::de_list_graphql_apis_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_graphql_apis::de_list_graphql_apis_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListGraphqlApisRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGraphqlApisRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_graphql_apis::ListGraphqlApisInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_graphql_apis::ListGraphqlApisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/apis").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_graphql_apis::ListGraphqlApisInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListGraphqlApisEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListGraphqlApisInput>()
                        .ok_or("failed to downcast to ListGraphqlApisInput")?;
...
pub enum ListGraphqlApisError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListGraphqlApisError) for what information is available for the error.")]
...
impl ListGraphqlApisError {
    /// Creates the `ListGraphqlApisError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListGraphqlApisError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListGraphqlApisError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_graphql_apis::ListGraphqlApisError {
