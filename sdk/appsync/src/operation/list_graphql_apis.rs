...
impl ListGraphqlApisInput {
    /// Consumes the builder and constructs an Operation<[`ListGraphqlApis`](crate::operation::list_graphql_apis::ListGraphqlApis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_graphql_apis::ListGraphqlApis, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_graphql_apis::ListGraphqlApisInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/v1/apis").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_graphql_apis::ListGraphqlApisInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_graphql_apis::ListGraphqlApis::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListGraphqlApis {
                type Output = std::result::Result<crate::operation::list_graphql_apis::ListGraphqlApisOutput, crate::operation::list_graphql_apis::ListGraphqlApisError>;
