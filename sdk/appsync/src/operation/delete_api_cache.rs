    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/apis/{apiId}/ApiCaches", apiId = api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_api_cache::DeleteApiCache::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApiCache {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_api_cache::de_delete_api_cache_http_error(
                status, headers, body,
            )
        } else {
