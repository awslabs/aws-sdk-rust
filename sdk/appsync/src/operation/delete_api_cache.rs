...
impl DeleteApiCacheInput {
    /// Consumes the builder and constructs an Operation<[`DeleteApiCache`](crate::operation::delete_api_cache::DeleteApiCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_api_cache::DeleteApiCache, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_api_cache::DeleteApiCacheInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_api_cache::DeleteApiCache::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteApiCache {
                type Output = std::result::Result<crate::operation::delete_api_cache::DeleteApiCacheOutput, crate::operation::delete_api_cache::DeleteApiCacheError>;
