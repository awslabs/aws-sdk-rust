...
impl GetIntrospectionSchema {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_introspection_schema::GetIntrospectionSchemaError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_introspection_schema::GetIntrospectionSchemaOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppSync", "GetIntrospectionSchema", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "AppSync.GetIntrospectionSchema",
                "rpc.service" = "AppSync",
                "rpc.method" = "GetIntrospectionSchema",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetIntrospectionSchema {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetIntrospectionSchemaRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetIntrospectionSchemaResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetIntrospectionSchema")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetIntrospectionSchema")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetIntrospectionSchemaTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetIntrospectionSchemaTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetIntrospectionSchemaTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetIntrospectionSchemaInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetIntrospectionSchemaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_introspection_schema::de_get_introspection_schema_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_introspection_schema::de_get_introspection_schema_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetIntrospectionSchemaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_introspection_schema::GetIntrospectionSchemaInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_introspection_schema::GetIntrospectionSchemaInput,
...
impl ::std::error::Error for GetIntrospectionSchemaError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::GraphQlSchemaException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetIntrospectionSchemaError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::GraphQlSchemaException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
