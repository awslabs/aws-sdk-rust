...
impl CreateGraphqlApiInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_graphql_api::CreateGraphqlApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGraphqlApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_graphql_api::de_create_graphql_api_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_graphql_api::CreateGraphqlApiError
{
