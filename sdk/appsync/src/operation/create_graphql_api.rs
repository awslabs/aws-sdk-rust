...
impl CreateGraphqlApiInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_graphql_api::ser_create_graphql_api_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGraphqlApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_graphql_api::de_create_graphql_api_http_response_with_props(status, headers, body)
        }
    }
}
