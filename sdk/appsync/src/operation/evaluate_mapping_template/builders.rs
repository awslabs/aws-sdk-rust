...
impl EvaluateMappingTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateOutput, crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError, Self> {
