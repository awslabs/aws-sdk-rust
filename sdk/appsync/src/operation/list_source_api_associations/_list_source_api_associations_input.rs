...
impl ListSourceApiAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_source_api_associations::ListSourceApiAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
