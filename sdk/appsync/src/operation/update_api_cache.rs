...
impl UpdateApiCacheInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_api_cache::UpdateApiCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_api_cache::ser_update_api_cache_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApiCache {
    type Output =
        ::std::result::Result<crate::operation::update_api_cache::UpdateApiCacheOutput, crate::operation::update_api_cache::UpdateApiCacheError>;
