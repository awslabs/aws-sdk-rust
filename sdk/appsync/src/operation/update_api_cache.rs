    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/apis/{apiId}/ApiCaches/update", apiId = api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_api_cache::UpdateApiCache::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApiCache {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_api_cache::de_update_api_cache_http_error(
                status, headers, body,
            )
        } else {
