...
impl UpdateApiCacheInput {
    /// Consumes the builder and constructs an Operation<[`UpdateApiCache`](crate::operation::update_api_cache::UpdateApiCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_api_cache::UpdateApiCache, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_api_cache::UpdateApiCacheInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_api_cache::ser_update_api_cache_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_api_cache::UpdateApiCache::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateApiCache", "appsync"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateApiCache`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateApiCache {
                type Output = std::result::Result<crate::operation::update_api_cache::UpdateApiCacheOutput, crate::operation::update_api_cache::UpdateApiCacheError>;
