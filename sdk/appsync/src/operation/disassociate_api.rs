...
impl DisassociateApiInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateApi`](crate::operation::disassociate_api::DisassociateApi)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_api::DisassociateApi, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_api::DisassociateApiInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_api::DisassociateApi::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateApi {
                type Output = std::result::Result<crate::operation::disassociate_api::DisassociateApiOutput, crate::operation::disassociate_api::DisassociateApiError>;
