...
impl ListTypesByAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_types_by_association::ListTypesByAssociation::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTypesByAssociation", "appsync"));
