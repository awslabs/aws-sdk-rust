    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_types_by_association::ListTypesByAssociationError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_types_by_association::ListTypesByAssociationOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListTypesByAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListTypesByAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_types_by_association::ListTypesByAssociationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListTypesByAssociationEndpointParamsInterceptor {
...
pub type ListTypesByAssociationErrorKind = ListTypesByAssociationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListTypesByAssociationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_types_by_association::ListTypesByAssociationError {
...
impl ListTypesByAssociationError {
    ...
    /// Creates the `ListTypesByAssociationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
