...
impl ListResolversByFunctionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resolvers_by_function::ListResolversByFunctionInput, ::aws_smithy_types::error::operation::BuildError> {
