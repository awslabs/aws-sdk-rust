...
pub use crate::operation::list_resolvers_by_function::_list_resolvers_by_function_output::ListResolversByFunctionOutputBuilder;

pub use crate::operation::list_resolvers_by_function::_list_resolvers_by_function_input::ListResolversByFunctionInputBuilder;
...
impl ListResolversByFunctionInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_resolvers_by_function();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_resolvers_by_function::ListResolversByFunctionOutput,
                    crate::operation::list_resolvers_by_function::ListResolversByFunctionError,
                > for ListResolversByFunctionFluentBuilder
            {
                fn send(
                    self,
...
impl ListResolversByFunctionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_resolvers_by_function::ListResolversByFunctionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resolvers_by_function::ListResolversByFunctionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_resolvers_by_function::ListResolversByFunction::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_resolvers_by_function::ListResolversByFunctionOutput, crate::operation::list_resolvers_by_function::ListResolversByFunctionError, Self> {
