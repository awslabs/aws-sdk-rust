...
impl GetSchemaCreationStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetSchemaCreationStatus`](crate::operation::get_schema_creation_status::GetSchemaCreationStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_schema_creation_status::GetSchemaCreationStatus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_schema_creation_status::GetSchemaCreationStatusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_schema_creation_status::GetSchemaCreationStatus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSchemaCreationStatus", "appsync"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetSchemaCreationStatus`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetSchemaCreationStatus {
                type Output = std::result::Result<crate::operation::get_schema_creation_status::GetSchemaCreationStatusOutput, crate::operation::get_schema_creation_status::GetSchemaCreationStatusError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_schema_creation_status::de_get_schema_creation_status_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_schema_creation_status::de_get_schema_creation_status_http_response(response)
                     }
                }
            }
