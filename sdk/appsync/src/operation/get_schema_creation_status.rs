    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/apis/{apiId}/schemacreation", apiId = api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_schema_creation_status::GetSchemaCreationStatus::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_schema_creation_status::GetSchemaCreationStatusError
{
