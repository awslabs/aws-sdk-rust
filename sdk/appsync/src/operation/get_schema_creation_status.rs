...
/// Orchestration and serialization glue logic for `GetSchemaCreationStatus`.
...
impl GetSchemaCreationStatus {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_schema_creation_status::GetSchemaCreationStatusInput,
                    ) -> ::std::result::Result<crate::operation::get_schema_creation_status::GetSchemaCreationStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_schema_creation_status::GetSchemaCreationStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_schema_creation_status::GetSchemaCreationStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_schema_creation_status::GetSchemaCreationStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSchemaCreationStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSchemaCreationStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSchemaCreationStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSchemaCreationStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSchemaCreationStatus")
...
.with_interceptor(GetSchemaCreationStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_schema_creation_status::GetSchemaCreationStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_schema_creation_status::GetSchemaCreationStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_schema_creation_status::GetSchemaCreationStatusError>::new());
...
#[derive(Debug)]
            struct GetSchemaCreationStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSchemaCreationStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_schema_creation_status::de_get_schema_creation_status_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetSchemaCreationStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSchemaCreationStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_schema_creation_status::GetSchemaCreationStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_schema_creation_status::GetSchemaCreationStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v1/apis/{apiId}/schemacreation", apiId = api_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetSchemaCreationStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSchemaCreationStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSchemaCreationStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSchemaCreationStatusInput>()
                        .ok_or("failed to downcast to GetSchemaCreationStatusInput")?;
...
pub enum GetSchemaCreationStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSchemaCreationStatusError) for what information is available for the error.")]
...
impl GetSchemaCreationStatusError {
    /// Creates the `GetSchemaCreationStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSchemaCreationStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSchemaCreationStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_schema_creation_status::GetSchemaCreationStatusError {
...
mod _get_schema_creation_status_output;
