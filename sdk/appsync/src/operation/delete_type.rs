...
impl DeleteTypeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_type::DeleteType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_type::de_delete_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_type::de_delete_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
