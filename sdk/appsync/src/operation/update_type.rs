...
impl UpdateTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_type::UpdateType,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_type::UpdateType::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_type::de_update_type_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_type::de_update_type_http_response_with_props(
                status, headers, body,
            )
        }
    }
