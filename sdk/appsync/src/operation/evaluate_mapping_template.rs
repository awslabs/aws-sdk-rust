...
/// Orchestration and serialization glue logic for `EvaluateMappingTemplate`.
...
impl EvaluateMappingTemplate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EvaluateMappingTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EvaluateMappingTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EvaluateMappingTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EvaluateMappingTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EvaluateMappingTemplate")
...
.with_interceptor(EvaluateMappingTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError>::new());
...
#[derive(Debug)]
            struct EvaluateMappingTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EvaluateMappingTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_evaluate_mapping_template::de_evaluate_mapping_template_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct EvaluateMappingTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EvaluateMappingTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::evaluate_mapping_template::EvaluateMappingTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/dataplane-evaluatetemplate").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_evaluate_mapping_template::ser_evaluate_mapping_template_input(&input)?);
...
#[derive(Debug)]
            struct EvaluateMappingTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EvaluateMappingTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EvaluateMappingTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EvaluateMappingTemplateInput>()
                        .ok_or("failed to downcast to EvaluateMappingTemplateInput")?;
...
pub enum EvaluateMappingTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EvaluateMappingTemplateError) for what information is available for the error.")]
...
impl EvaluateMappingTemplateError {
    /// Creates the `EvaluateMappingTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EvaluateMappingTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EvaluateMappingTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError {
...
mod _evaluate_mapping_template_output;
