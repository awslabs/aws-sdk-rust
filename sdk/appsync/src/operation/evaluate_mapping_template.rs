...
impl EvaluateMappingTemplateInput {
    /// Consumes the builder and constructs an Operation<[`EvaluateMappingTemplate`](crate::operation::evaluate_mapping_template::EvaluateMappingTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::evaluate_mapping_template::EvaluateMappingTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::evaluate_mapping_template::EvaluateMappingTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_evaluate_mapping_template::ser_evaluate_mapping_template_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::evaluate_mapping_template::EvaluateMappingTemplate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EvaluateMappingTemplate {
                type Output = std::result::Result<crate::operation::evaluate_mapping_template::EvaluateMappingTemplateOutput, crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError>;
