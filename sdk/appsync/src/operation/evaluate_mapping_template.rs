    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/dataplane-evaluatetemplate")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::evaluate_mapping_template::EvaluateMappingTemplate::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::evaluate_mapping_template::EvaluateMappingTemplateError
{
