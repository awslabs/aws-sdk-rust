...
impl FlushApiCacheInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::flush_api_cache::FlushApiCache::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for FlushApiCache {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_flush_api_cache::de_flush_api_cache_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_flush_api_cache::de_flush_api_cache_http_response(
                status, headers, body,
            )
        }
    }
