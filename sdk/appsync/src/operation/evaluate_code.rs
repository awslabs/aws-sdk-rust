...
impl EvaluateCodeInput {
    /// Consumes the builder and constructs an Operation<[`EvaluateCode`](crate::operation::evaluate_code::EvaluateCode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::evaluate_code::EvaluateCode, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::evaluate_code::EvaluateCodeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_evaluate_code::ser_evaluate_code_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::evaluate_code::EvaluateCode::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EvaluateCode {
                type Output = std::result::Result<crate::operation::evaluate_code::EvaluateCodeOutput, crate::operation::evaluate_code::EvaluateCodeError>;
