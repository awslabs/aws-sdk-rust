...
impl EvaluateCodeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::evaluate_code::EvaluateCode, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_evaluate_code::ser_evaluate_code_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for EvaluateCode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_evaluate_code::de_evaluate_code_http_response_with_props(status, headers, body)
        }
    }
}
