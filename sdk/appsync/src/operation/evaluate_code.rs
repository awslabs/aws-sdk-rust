    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/dataplane-evaluatecode")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::evaluate_code::EvaluateCode::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EvaluateCode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_evaluate_code::de_evaluate_code_http_error(
                status, headers, body,
            )
        } else {
