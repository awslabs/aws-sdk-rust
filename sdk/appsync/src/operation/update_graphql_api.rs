...
impl UpdateGraphqlApi {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_graphql_api::UpdateGraphqlApiError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_graphql_api::UpdateGraphqlApiOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppSync", "UpdateGraphqlApi", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "AppSync.UpdateGraphqlApi",
                "rpc.service" = "AppSync",
                "rpc.method" = "UpdateGraphqlApi",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateGraphqlApi {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateGraphqlApiRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateGraphqlApiResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateGraphqlApi")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateGraphqlApi")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateGraphqlApiTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateGraphqlApiTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateGraphqlApiTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateGraphqlApiInput>() else {
        ...
        if requested.should_capture("mergedApiExecutionRoleArn") {
            if let ::std::option::Option::Some(value) = input.merged_api_execution_role_arn.as_deref() {
                captured.insert("mergedApiExecutionRoleArn", value);
            }
        }
        if requested.should_capture("ownerContact") {
            if let ::std::option::Option::Some(value) = input.owner_contact.as_deref() {
                captured.insert("ownerContact", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateGraphqlApiResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_graphql_api::de_update_graphql_api_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_graphql_api::de_update_graphql_api_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateGraphqlApiRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_graphql_api::UpdateGraphqlApiInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_graphql_api::UpdateGraphqlApiInput,
