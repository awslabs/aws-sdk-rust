...
impl UpdateGraphqlApiInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGraphqlApi`](crate::operation::update_graphql_api::UpdateGraphqlApi)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_graphql_api::UpdateGraphqlApi, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_graphql_api::UpdateGraphqlApiInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_graphql_api::ser_update_graphql_api_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_graphql_api::UpdateGraphqlApi::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateGraphqlApi", "appsync"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateGraphqlApi`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGraphqlApi {
                type Output = std::result::Result<crate::operation::update_graphql_api::UpdateGraphqlApiOutput, crate::operation::update_graphql_api::UpdateGraphqlApiError>;
