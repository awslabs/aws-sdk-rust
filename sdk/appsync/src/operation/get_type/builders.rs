...
impl GetTypeInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_type::GetTypeError, ::aws_smithy_http::operation::Response>,
    > {
...
impl GetTypeFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::get_type::GetTypeOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_type::GetTypeError>>
    {
        let op = self
            .inner
            .build()
