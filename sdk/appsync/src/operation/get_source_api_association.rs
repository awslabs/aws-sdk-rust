    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_source_api_association::GetSourceApiAssociationError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_source_api_association::GetSourceApiAssociationOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSourceApiAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetSourceApiAssociation", "appsync"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSourceApiAssociation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetSourceApiAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetSourceApiAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_source_api_association::GetSourceApiAssociationInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("merged_api_identifier", "cannot be empty or unset")
                })?;
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("association_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetSourceApiAssociationEndpointParamsInterceptor {
...
pub type GetSourceApiAssociationErrorKind = GetSourceApiAssociationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetSourceApiAssociationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_source_api_association::GetSourceApiAssociationError {
...
impl GetSourceApiAssociationError {
    ...
    /// Creates the `GetSourceApiAssociationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
