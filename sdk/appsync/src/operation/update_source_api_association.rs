    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_source_api_association::UpdateSourceApiAssociationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_source_api_association::UpdateSourceApiAssociationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSourceApiAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateSourceApiAssociation", "appsync"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSourceApiAssociation")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateSourceApiAssociationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateSourceApiAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_source_api_association::UpdateSourceApiAssociationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateSourceApiAssociationEndpointParamsInterceptor {
...
pub type UpdateSourceApiAssociationErrorKind = UpdateSourceApiAssociationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateSourceApiAssociationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_source_api_association::UpdateSourceApiAssociationError {
...
impl UpdateSourceApiAssociationError {
    ...
    /// Creates the `UpdateSourceApiAssociationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
