...
impl UpdateSourceApiAssociationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSourceApiAssociation`](crate::operation::update_source_api_association::UpdateSourceApiAssociation)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_source_api_association::ser_update_source_api_association_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_source_api_association::UpdateSourceApiAssociation::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSourceApiAssociation", "appsync"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSourceApiAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_source_api_association::de_update_source_api_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
