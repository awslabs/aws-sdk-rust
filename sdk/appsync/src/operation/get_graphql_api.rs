...
impl GetGraphqlApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_graphql_api::GetGraphqlApi,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_graphql_api::GetGraphqlApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGraphqlApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_graphql_api::de_get_graphql_api_http_error(
                status, headers, body,
            )
        } else {
