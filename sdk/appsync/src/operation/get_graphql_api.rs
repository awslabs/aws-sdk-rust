...
impl GetGraphqlApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_graphql_api::GetGraphqlApi, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGraphqlApi {
    type Output =
        ::std::result::Result<crate::operation::get_graphql_api::GetGraphqlApiOutput, crate::operation::get_graphql_api::GetGraphqlApiError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_graphql_api::de_get_graphql_api_http_response_with_props(status, headers, body)
        }
    }
}
