...
/// Paginator for [`ListFunctions`](crate::operation::list_functions::ListFunctions)
pub struct ListFunctionsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_functions::builders::ListFunctionsInputBuilder,
...
impl ListFunctionsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_functions::paginator::ListFunctionsPaginatorItems {
        crate::operation::list_functions::paginator::ListFunctionsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_functions::ListFunctions::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_functions_output_output_next_token(resp);
...
impl ListFunctionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_functions_output_output_functions(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
