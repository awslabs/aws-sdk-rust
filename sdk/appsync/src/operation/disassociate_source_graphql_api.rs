    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disassociate_source_graphql_api::DisassociateSourceGraphqlApiError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disassociate_source_graphql_api::DisassociateSourceGraphqlApiOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateSourceGraphqlApi {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DisassociateSourceGraphqlApi", "appsync"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateSourceGraphqlApi")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DisassociateSourceGraphqlApiResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DisassociateSourceGraphqlApiRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::disassociate_source_graphql_api::DisassociateSourceGraphqlApiInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DisassociateSourceGraphqlApiEndpointParamsInterceptor {
...
pub type DisassociateSourceGraphqlApiErrorKind = DisassociateSourceGraphqlApiError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisassociateSourceGraphqlApiError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_source_graphql_api::DisassociateSourceGraphqlApiError {
...
impl DisassociateSourceGraphqlApiError {
    ...
    /// Creates the `DisassociateSourceGraphqlApiError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
