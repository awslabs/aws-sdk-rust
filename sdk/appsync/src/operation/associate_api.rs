...
impl AssociateApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_api::AssociateApi,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_api::AssociateApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_api::de_associate_api_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_api::de_associate_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
