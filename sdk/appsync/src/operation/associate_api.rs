...
impl AssociateApiInput {
    /// Consumes the builder and constructs an Operation<[`AssociateApi`](crate::operation::associate_api::AssociateApi)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_api::AssociateApi, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_api::AssociateApiInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_api::ser_associate_api_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_api::AssociateApi::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AssociateApi", "appsync"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `AssociateApi`.
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateApi {
                type Output = std::result::Result<crate::operation::associate_api::AssociateApiOutput, crate::operation::associate_api::AssociateApiError>;
