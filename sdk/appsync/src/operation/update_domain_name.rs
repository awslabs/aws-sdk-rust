...
impl UpdateDomainNameInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_domain_name::ser_update_domain_name_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainName {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_domain_name::de_update_domain_name_http_response_with_props(status, headers, body)
        }
    }
}
