...
impl UpdateDomainNameInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDomainName`](crate::operation::update_domain_name::UpdateDomainName)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_domain_name::UpdateDomainName, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_domain_name::UpdateDomainNameInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_domain_name::ser_update_domain_name_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_domain_name::UpdateDomainName::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDomainName {
                type Output = std::result::Result<crate::operation::update_domain_name::UpdateDomainNameOutput, crate::operation::update_domain_name::UpdateDomainNameError>;
