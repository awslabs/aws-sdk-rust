...
impl UpdateApi {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("appsync", "UpdateApi", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateApi {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateApi", "appsync"));
...
impl UpdateApiError {
    ...
    /// Returns `true` if the error kind is `UpdateApiError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `UpdateApiError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UpdateApiError::InternalFailureException`.
    ...
    /// Returns `true` if the error kind is `UpdateApiError::UnauthorizedException`.
