...
impl ListResolversByFunctionInput {
    /// Consumes the builder and constructs an Operation<[`ListResolversByFunction`](crate::operation::list_resolvers_by_function::ListResolversByFunction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_resolvers_by_function::ListResolversByFunction, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resolvers_by_function::ListResolversByFunctionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_resolvers_by_function::ListResolversByFunctionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_resolvers_by_function::ListResolversByFunction::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListResolversByFunction {
                type Output = std::result::Result<crate::operation::list_resolvers_by_function::ListResolversByFunctionOutput, crate::operation::list_resolvers_by_function::ListResolversByFunctionError>;
