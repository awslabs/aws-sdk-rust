...
pub struct Type  {
    ...
    #[doc(hidden)]pub definition: std::option::Option<std::string::String>,
    /// <p>The type format: SDL or JSON.</p>
    #[doc(hidden)]pub format: std::option::Option<crate::model::TypeDefinitionFormat>,
}
impl Type {
    /// <p>The type name.</p>
...
pub struct Resolver  {
    ...
    #[doc(hidden)]pub data_source_name: std::option::Option<std::string::String>,
    /// <p>The resolver Amazon Resource Name (ARN).</p>
    #[doc(hidden)]pub resolver_arn: std::option::Option<std::string::String>,
    /// <p>The request mapping template.</p>
    #[doc(hidden)]pub request_mapping_template: std::option::Option<std::string::String>,
    /// <p>The response mapping template.</p>
    #[doc(hidden)]pub response_mapping_template: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub kind: std::option::Option<crate::model::ResolverKind>,
    /// <p>The <code>PipelineConfig</code>.</p>
    #[doc(hidden)]pub pipeline_config: std::option::Option<crate::model::PipelineConfig>,
    /// <p>The <code>SyncConfig</code> for a resolver attached to a versioned data source.</p>
    #[doc(hidden)]pub sync_config: std::option::Option<crate::model::SyncConfig>,
    /// <p>The caching configuration for the resolver.</p>
    #[doc(hidden)]pub caching_config: std::option::Option<crate::model::CachingConfig>,
    /// <p>The maximum batching size for a resolver.</p>
    #[doc(hidden)]pub max_batch_size: i32,
}
impl Resolver {
    /// <p>The resolver type name.</p>
...
pub struct CachingConfig  {
    ...
    #[doc(hidden)]pub caching_keys: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl CachingConfig {
    /// <p>The TTL in seconds for a resolver that has caching activated.</p> 
    /// <p>Valid values are 1–3,600 seconds.</p>
...
pub struct SyncConfig  {
    ...
    /// </ul>
    #[doc(hidden)]pub conflict_handler: std::option::Option<crate::model::ConflictHandlerType>,
    ...
    /// </ul>
    #[doc(hidden)]pub conflict_detection: std::option::Option<crate::model::ConflictDetectionType>,
    /// <p>The <code>LambdaConflictHandlerConfig</code> when configuring <code>LAMBDA</code> as the Conflict Handler.</p>
    #[doc(hidden)]pub lambda_conflict_handler_config: std::option::Option<crate::model::LambdaConflictHandlerConfig>,
}
impl SyncConfig {
    /// <p>The Conflict Resolution strategy to perform in the event of a conflict.</p> 
    /// <ul> 
...
impl  std::fmt::Debug for SyncConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("lambda_conflict_handler_config", &self.lambda_conflict_handler_config);
        formatter.finish()
    }
}
...
pub struct LambdaConflictHandlerConfig  {
    ...
    #[doc(hidden)]pub lambda_conflict_handler_arn: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for LambdaConflictHandlerConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("lambda_conflict_handler_arn", &self.lambda_conflict_handler_arn);
        formatter.finish()
    }
}
...
pub struct PipelineConfig  {
    ...
    #[doc(hidden)]pub functions: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl PipelineConfig {
    /// <p>A list of <code>Function</code> objects.</p>
...
pub struct GraphqlApi  {
    ...
    #[doc(hidden)]pub log_config: std::option::Option<crate::model::LogConfig>,
    /// <p>The Amazon Cognito user pool configuration.</p>
    #[doc(hidden)]pub user_pool_config: std::option::Option<crate::model::UserPoolConfig>,
    /// <p>The OpenID Connect configuration.</p>
    #[doc(hidden)]pub open_id_connect_config: std::option::Option<crate::model::OpenIdConnectConfig>,
    /// <p>The Amazon Resource Name (ARN).</p>
    #[doc(hidden)]pub arn: std::option::Option<std::string::String>,
    /// <p>The URIs.</p>
    #[doc(hidden)]pub uris: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The tags.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>A list of additional authentication providers for the <code>GraphqlApi</code> API.</p>
    #[doc(hidden)]pub additional_authentication_providers: std::option::Option<std::vec::Vec<crate::model::AdditionalAuthenticationProvider>>,
    /// <p>A flag indicating whether to use X-Ray tracing for this <code>GraphqlApi</code>.</p>
    #[doc(hidden)]pub xray_enabled: bool,
    /// <p>The ARN of the WAF access control list (ACL) associated with this <code>GraphqlApi</code>, if one exists.</p>
    #[doc(hidden)]pub waf_web_acl_arn: std::option::Option<std::string::String>,
    /// <p>Configuration for Lambda function authorization.</p>
    #[doc(hidden)]pub lambda_authorizer_config: std::option::Option<crate::model::LambdaAuthorizerConfig>,
}
impl GraphqlApi {
    /// <p>The API name.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for GraphqlApi  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("additional_authentication_providers", &self.additional_authentication_providers);
...
pub struct AdditionalAuthenticationProvider  {
    ...
    #[doc(hidden)]pub open_id_connect_config: std::option::Option<crate::model::OpenIdConnectConfig>,
    /// <p>The Amazon Cognito user pool configuration.</p>
    #[doc(hidden)]pub user_pool_config: std::option::Option<crate::model::CognitoUserPoolConfig>,
    /// <p>Configuration for Lambda function authorization.</p>
    #[doc(hidden)]pub lambda_authorizer_config: std::option::Option<crate::model::LambdaAuthorizerConfig>,
}
...
pub struct CognitoUserPoolConfig  {
    ...
    #[doc(hidden)]pub user_pool_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub app_id_client_regex: std::option::Option<std::string::String>,
}
...
pub struct LogConfig  {
    ...
    /// </ul> </li> 
    /// </ul>
    #[doc(hidden)]pub field_log_level: std::option::Option<crate::model::FieldLogLevel>,
    ...
    #[doc(hidden)]pub exclude_verbose_content: bool,
}
impl LogConfig {
    /// <p>The field logging level. Values can be NONE, ERROR, or ALL.</p> 
    /// <ul> 
...
pub struct FunctionConfiguration  {
    ...
    #[doc(hidden)]pub function_id: std::option::Option<std::string::String>,
...
pub struct DomainNameConfig  {
    ...
    #[doc(hidden)]pub appsync_domain_name: std::option::Option<std::string::String>,
...
pub struct DataSource  {
    ...
    #[doc(hidden)]pub data_source_arn: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::DataSourceType>,
    ...
    #[doc(hidden)]pub dynamodb_config: std::option::Option<crate::model::DynamodbDataSourceConfig>,
    /// <p>Lambda settings.</p>
    #[doc(hidden)]pub lambda_config: std::option::Option<crate::model::LambdaDataSourceConfig>,
    /// <p>Amazon OpenSearch Service settings.</p>
    #[doc(hidden)]pub elasticsearch_config: std::option::Option<crate::model::ElasticsearchDataSourceConfig>,
    /// <p>Amazon OpenSearch Service settings.</p>
    #[doc(hidden)]pub open_search_service_config: std::option::Option<crate::model::OpenSearchServiceDataSourceConfig>,
    /// <p>HTTP endpoint settings.</p>
    #[doc(hidden)]pub http_config: std::option::Option<crate::model::HttpDataSourceConfig>,
    /// <p>Relational database settings.</p>
    #[doc(hidden)]pub relational_database_config: std::option::Option<crate::model::RelationalDatabaseDataSourceConfig>,
}
impl DataSource {
    /// <p>The data source Amazon Resource Name (ARN).</p>
...
impl  std::fmt::Debug for DataSource  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("open_search_service_config", &self.open_search_service_config);
        formatter.field("http_config", &self.http_config);
        formatter.field("relational_database_config", &self.relational_database_config);
        formatter.finish()
    }
}
...
pub struct RelationalDatabaseDataSourceConfig  {
    ...
    /// </ul>
    #[doc(hidden)]pub relational_database_source_type: std::option::Option<crate::model::RelationalDatabaseSourceType>,
    /// <p>Amazon RDS HTTP endpoint settings.</p>
    #[doc(hidden)]pub rds_http_endpoint_config: std::option::Option<crate::model::RdsHttpEndpointConfig>,
}
...
impl  std::fmt::Debug for RelationalDatabaseDataSourceConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("relational_database_source_type", &self.relational_database_source_type);
...
pub struct RdsHttpEndpointConfig  {
    ...
    #[doc(hidden)]pub aws_secret_store_arn: std::option::Option<std::string::String>,
}
...
pub struct HttpDataSourceConfig  {
    ...
    #[doc(hidden)]pub authorization_config: std::option::Option<crate::model::AuthorizationConfig>,
}
...
pub struct AuthorizationConfig  {
    ...
    #[doc(hidden)]pub aws_iam_config: std::option::Option<crate::model::AwsIamConfig>,
}
...
pub struct AwsIamConfig  {
    ...
    #[doc(hidden)]pub signing_region: std::option::Option<std::string::String>,
    /// <p>The signing service name for IAM authorization.</p>
    #[doc(hidden)]pub signing_service_name: std::option::Option<std::string::String>,
}
impl AwsIamConfig {
    /// <p>The signing Amazon Web Services Region for IAM authorization.</p>
...
pub struct DynamodbDataSourceConfig  {
    ...
    #[doc(hidden)]pub use_caller_credentials: bool,
    /// <p>The <code>DeltaSyncConfig</code> for a versioned data source.</p>
    #[doc(hidden)]pub delta_sync_config: std::option::Option<crate::model::DeltaSyncConfig>,
    /// <p>Set to TRUE to use Conflict Detection and Resolution with this data source.</p>
    #[doc(hidden)]pub versioned: bool,
}
...
pub struct DeltaSyncConfig  {
    ...
    #[doc(hidden)]pub base_table_ttl: i64,
    /// <p>The Delta Sync table name.</p>
    #[doc(hidden)]pub delta_sync_table_name: std::option::Option<std::string::String>,
    /// <p>The number of minutes that a Delta Sync log entry is stored in the Delta Sync table.</p>
    #[doc(hidden)]pub delta_sync_table_ttl: i64,
}
...
pub struct ApiCache  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ApiCacheType>,
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ApiCacheStatus>,
}
impl ApiCache {
    /// <p>TTL in seconds for cache entries.</p> 
    /// <p>Valid values are 1–3,600 seconds.</p>
...
impl  std::fmt::Debug for ApiCache  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("transit_encryption_enabled", &self.transit_encryption_enabled);
        formatter.field("at_rest_encryption_enabled", &self.at_rest_encryption_enabled);
        formatter.field("r#type", &self.r#type);
...
pub struct ApiAssociation  {
    ...
    /// </ul>
    #[doc(hidden)]pub association_status: std::option::Option<crate::model::AssociationStatus>,
    /// <p>Details about the last deployment status.</p>
    #[doc(hidden)]pub deployment_detail: std::option::Option<std::string::String>,
}
impl ApiAssociation {
    /// <p>The domain name.</p>
    pub fn domain_name(&self) -> std::option::Option<& str> {
