...
pub fn serialize_structure_crate_input_associate_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateApiInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_api_cache_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateApiCacheInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_api_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateApiKeyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_function_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFunctionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_29) = &input.response_mapping_template {
        object.key("responseMappingTemplate").string(var_29.as_str());
    }
...
pub fn serialize_structure_crate_input_create_graphql_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGraphqlApiInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_32) = &input.additional_authentication_providers {
        let mut array_33 = object.key("additionalAuthenticationProviders").start_array();
    ...
    if let Some(var_37) = &input.lambda_authorizer_config {
        ...
        crate::json_ser::serialize_structure_crate_model_lambda_authorizer_config(&mut object_38, var_37)?;
        object_38.finish();
    }
    ...
    if let Some(var_42) = &input.open_id_connect_config {
        ...
        crate::json_ser::serialize_structure_crate_model_open_id_connect_config(&mut object_43, var_42)?;
        object_43.finish();
    }
...
pub fn serialize_structure_crate_input_create_resolver_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateResolverInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_58) = &input.response_mapping_template {
        object.key("responseMappingTemplate").string(var_58.as_str());
    }
...
pub fn serialize_structure_crate_input_create_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTypeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_evaluate_mapping_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EvaluateMappingTemplateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_schema_creation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartSchemaCreationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_65) = &input.definition {
        object.key("definition").string_unchecked(&aws_smithy_types::base64::encode(var_65));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_api_cache_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateApiCacheInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_api_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateApiKeyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_data_source_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDataSourceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_74) = &input.dynamodb_config {
        ...
        crate::json_ser::serialize_structure_crate_model_dynamodb_data_source_config(&mut object_75, var_74)?;
        object_75.finish();
    }
    if let Some(var_76) = &input.elasticsearch_config {
        let mut object_77 = object.key("elasticsearchConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_elasticsearch_data_source_config(&mut object_77, var_76)?;
        object_77.finish();
    }
    if let Some(var_78) = &input.http_config {
        let mut object_79 = object.key("httpConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_http_data_source_config(&mut object_79, var_78)?;
        object_79.finish();
    }
    if let Some(var_80) = &input.lambda_config {
        let mut object_81 = object.key("lambdaConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_lambda_data_source_config(&mut object_81, var_80)?;
        object_81.finish();
    }
    if let Some(var_82) = &input.open_search_service_config {
        let mut object_83 = object.key("openSearchServiceConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_open_search_service_data_source_config(&mut object_83, var_82)?;
        object_83.finish();
    }
    if let Some(var_84) = &input.relational_database_config {
        let mut object_85 = object.key("relationalDatabaseConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_relational_database_data_source_config(&mut object_85, var_84)?;
        object_85.finish();
    }
...
pub fn serialize_structure_crate_input_update_function_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFunctionInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_94) = &input.response_mapping_template {
        object.key("responseMappingTemplate").string(var_94.as_str());
    }
...
pub fn serialize_structure_crate_input_update_graphql_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGraphqlApiInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_97) = &input.additional_authentication_providers {
        let mut array_98 = object.key("additionalAuthenticationProviders").start_array();
    ...
    if let Some(var_102) = &input.lambda_authorizer_config {
        ...
        crate::json_ser::serialize_structure_crate_model_lambda_authorizer_config(&mut object_103, var_102)?;
        object_103.finish();
    }
    ...
    if let Some(var_107) = &input.open_id_connect_config {
        ...
        crate::json_ser::serialize_structure_crate_model_open_id_connect_config(&mut object_108, var_107)?;
        object_108.finish();
    }
    if let Some(var_109) = &input.user_pool_config {
        let mut object_110 = object.key("userPoolConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_user_pool_config(&mut object_110, var_109)?;
        object_110.finish();
    }
    if input.xray_enabled {
        object.key("xrayEnabled").boolean(input.xray_enabled);
...
pub fn serialize_structure_crate_input_update_resolver_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateResolverInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_117) = &input.request_mapping_template {
        object.key("requestMappingTemplate").string(var_117.as_str());
    }
    if let Some(var_118) = &input.response_mapping_template {
        object.key("responseMappingTemplate").string(var_118.as_str());
    }
...
pub fn serialize_structure_crate_input_update_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTypeInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_dynamodb_data_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DynamodbDataSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_125) = &input.delta_sync_config {
        ...
        crate::json_ser::serialize_structure_crate_model_delta_sync_config(&mut object_126, var_125)?;
        object_126.finish();
    }
    if input.versioned {
...
pub fn serialize_structure_crate_model_elasticsearch_data_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ElasticsearchDataSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_http_data_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HttpDataSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_130) = &input.authorization_config {
        ...
        crate::json_ser::serialize_structure_crate_model_authorization_config(&mut object_131, var_130)?;
        object_131.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_lambda_data_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaDataSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_open_search_service_data_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpenSearchServiceDataSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_relational_database_data_source_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RelationalDatabaseDataSourceConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_135) = &input.relational_database_source_type {
        object.key("relationalDatabaseSourceType").string(var_135.as_str());
    }
    if let Some(var_136) = &input.rds_http_endpoint_config {
        let mut object_137 = object.key("rdsHttpEndpointConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_rds_http_endpoint_config(&mut object_137, var_136)?;
        object_137.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_sync_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SyncConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_140) = &input.lambda_conflict_handler_config {
        ...
        crate::json_ser::serialize_structure_crate_model_lambda_conflict_handler_config(&mut object_141, var_140)?;
        object_141.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_additional_authentication_provider(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AdditionalAuthenticationProvider) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_143) = &input.open_id_connect_config {
        ...
        crate::json_ser::serialize_structure_crate_model_open_id_connect_config(&mut object_144, var_143)?;
        object_144.finish();
    }
    if let Some(var_145) = &input.user_pool_config {
        let mut object_146 = object.key("userPoolConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_cognito_user_pool_config(&mut object_146, var_145)?;
        object_146.finish();
    }
    if let Some(var_147) = &input.lambda_authorizer_config {
        let mut object_148 = object.key("lambdaAuthorizerConfig").start_object();
        crate::json_ser::serialize_structure_crate_model_lambda_authorizer_config(&mut object_148, var_147)?;
        object_148.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_lambda_authorizer_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaAuthorizerConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_150) = &input.identity_validation_expression {
        object.key("identityValidationExpression").string(var_150.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_log_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_open_id_connect_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OpenIdConnectConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_user_pool_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UserPoolConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_caching_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CachingConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
     {
        object.key("ttl").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((input.ttl).into()));
    }
...
pub fn serialize_structure_crate_model_pipeline_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipelineConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_delta_sync_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeltaSyncConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_authorization_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AuthorizationConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_rds_http_endpoint_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RdsHttpEndpointConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_lambda_conflict_handler_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LambdaConflictHandlerConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_174) = &input.lambda_conflict_handler_arn {
        object.key("lambdaConflictHandlerArn").string(var_174.as_str());
    }
    Ok(())
}

pub fn serialize_structure_crate_model_cognito_user_pool_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CognitoUserPoolConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_aws_iam_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsIamConfig) -> Result<(), aws_smithy_http::operation::SerializationError> {
