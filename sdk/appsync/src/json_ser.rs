...
pub fn serialize_structure_crate_input_evaluate_code_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_crate_input_start_schema_creation_input(
    ...
    if let Some(var_76) = &input.definition {
        object
            .key("definition")
            .string_unchecked(&aws_smithy_types::base64::encode(var_76));
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_function_input(
    ...
    if let Some(var_107) = &input.runtime {
        ...
        crate::json_ser::serialize_structure_crate_model_app_sync_runtime(
            &mut object_108,
            var_107,
        )?;
        object_108.finish();
...
pub fn serialize_structure_crate_model_app_sync_runtime(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::AppSyncRuntime,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
